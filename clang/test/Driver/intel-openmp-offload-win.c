...
// CHK-COMMANDS: clang-offload-bundler{{.*}} "-type=o" "-targets=openmp-spir64" "-inputs={{.*}}libomp-spirvdevicertl.obj" "-outputs=[[RTLTGT:.+\.o]]" "-unbundle" "-allow-missing-bundles"  
// CHK-COMMANDS: clang-offload-bundler{{.*}} "-type=o" "-targets=openmp-spir64" "-inputs={{.*}}libomp-itt-user-wrappers.obj" "-outputs=[[ITT1TGT:.+\.o]]" "-unbundle" "-allow-missing-bundles" 
// CHK-COMMANDS: clang-offload-bundler{{.*}} "-type=o" "-targets=openmp-spir64" "-inputs={{.*}}libomp-itt-compiler-wrappers.obj" "-outputs=[[ITT2TGT:.+\.o]]" "-unbundle" "-allow-missing-bundles"
// CHK-COMMANDS: clang-offload-bundler{{.*}} "-type=o" "-targets=openmp-spir64" "-inputs={{.*}}libomp-itt-stubs.obj" "-outputs=[[ITT3TGT:.+\.o]]" "-unbundle" "-allow-missing-bundles"
...
// CHK-UBJOBS: "{{.*}}clang-offload-bundler" "-type=o" "-targets=openmp-spir64" "-inputs={{.*}}libomp-itt-stubs.obj" "-outputs=[[ITT3TGT:.+\.o]]" "-unbundle" "-allow-missing-bundles"

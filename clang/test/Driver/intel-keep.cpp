...
// RUN: %clang_cl -save-temps /Q_keep -Qiopenmp -Qopenmp-targets=spir64 -target x86_64-pc-windows-msvc %s -###
...
// RUN: ls clang*.preprocessor.x86_64.arg
// RUN: ls clang-offload-bundler.clang-offload-unbundler.x86_64.arg

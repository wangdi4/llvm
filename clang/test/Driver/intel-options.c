...
// RUN: %clang -### --intel -g %s 2>&1 | FileCheck -DOPTNAME=-g -check-prefix=WARN-DEBUG-O0 %s
// RUN: %clang -### --intel -debug %s 2>&1 | FileCheck -DOPTNAME=-debug -check-prefix=WARN-DEBUG-O0 %s
// RUN: %clang -### --intel -debug=all %s 2>&1 | FileCheck -DOPTNAME=-debug -check-prefix=WARN-DEBUG-O0 %s
// RUN: %clang_cl -### --intel /Z7 %s 2>&1 | FileCheck -DOPTNAME=/Z7 -check-prefix=WARN-DEBUG-Od %s
// RUN: %clang -### --intel -g -O2 %s 2>&1 | FileCheck -DOPTNAME=-g -check-prefix=NO-WARN-DEBUG-O0 %s
// RUN: %clang -### --intel -debug -O2 %s 2>&1 | FileCheck -DOPTNAME=-debug -check-prefix=NO-WARN-DEBUG-O0 %s
// RUN: %clang -### --intel -debug=all -O2 %s 2>&1 | FileCheck -DOPTNAME=-debug -check-prefix=NO-WARN-DEBUG-O0 %s
// RUN: %clang_cl -### --intel /Z7 -O2 %s 2>&1 | FileCheck -DOPTNAME=/Z7 -check-prefix=NO-WARN-DEBUG-Od %s

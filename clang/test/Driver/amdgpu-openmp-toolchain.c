...
<<<<<<< HEAD
// INTEL_CUSTOMIZATION
// RUN:   %clang -### --target=x86_64-unknown-linux-gnu -fopenmp -fopenmp-targets=amdgcn-amd-amdhsa -fopenmp-new-driver \
...
>>>>>>> 2f79bb10461d114783a1548201928549ace09755
// RUN:   | FileCheck %s
...
// INTEL_CUSTOMIZATION
// RUN:   %clang -ccc-print-phases --target=x86_64-unknown-linux-gnu -fopenmp -fopenmp-targets=amdgcn-amd-amdhsa -Xopenmp-target=amdgcn-amd-amdhsa -march=gfx906 -fopenmp-new-driver  %s 2>&1 \
...
// INTEL_CUSTOMIZATION
// RUN:   %clang -### --target=x86_64-unknown-linux-gnu -ccc-print-bindings -fopenmp -fopenmp-targets=amdgcn-amd-amdhsa -Xopenmp-target=amdgcn-amd-amdhsa -march=gfx803 -nogpulib -fopenmp-new-driver %s 2>&1 | FileCheck %s --check-prefix=CHECK-BINDINGS
// RUN:   %clang -### --target=x86_64-unknown-linux-gnu -ccc-print-bindings -fopenmp -fopenmp-targets=amdgcn-amd-amdhsa --offload-arch=gfx803 -nogpulib -fopenmp-new-driver %s 2>&1 | FileCheck %s --check-prefix=CHECK-BINDINGS
// end INTEL_CUSTOMIZATION
...
// INTEL_CUSTOMIZATION
// RUN:   %clang -### --target=x86_64-unknown-linux-gnu -ccc-print-bindings -save-temps -fopenmp -fopenmp-targets=amdgcn-amd-amdhsa -Xopenmp-target=amdgcn-amd-amdhsa -march=gfx803 -nogpulib -fopenmp-new-driver %s 2>&1 | FileCheck %s --check-prefix=CHECK-BINDINGS-TEMPS
// RUN:   %clang -### --target=x86_64-unknown-linux-gnu -ccc-print-bindings -save-temps -fopenmp -fopenmp-targets=amdgcn-amd-amdhsa --offload-arch=gfx803 -nogpulib -fopenmp-new-driver %s 2>&1 | FileCheck %s --check-prefix=CHECK-BINDINGS-TEMPS
// end INTEL_CUSTOMIZATION
...
// INTEL_CUSTOMIZATION
// RUN:   -nogpulib -fopenmp-new-driver  %s 2>&1 | FileCheck %s --check-prefix=CHECK-TARGET-ID
// end INTEL_CUSTOMIZATION

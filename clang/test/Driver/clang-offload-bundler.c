...
// Check archive mode.
// RUN: clang-offload-bundler -type=a -targets=openmp-powerpc64le-ibm-linux-gnu,openmp-x86_64-pc-linux-gnu -output=%t.tgt1.a -output=%t.tgt2.a -input=%t.a -unbundle

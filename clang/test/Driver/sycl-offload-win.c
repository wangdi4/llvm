...
// FOFFLOAD_STATIC_LIB_SRC: 11: linker, {0, 9}, image, (host-sycl)
...
// FOFFLOAD_STATIC_LIB_SRC: 15: linker, {5, 12, 14}, ir, (device-sycl)
...
// FOFFLOAD_STATIC_LIB_SRC: 21: offload, "host-sycl (x86_64-pc-windows-msvc)" {10}, "device-sycl (spir64-unknown-unknown-sycldevice)" {20}, image

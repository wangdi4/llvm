...
// COM: CHECK-CPU-SAME:,+SPV_INTEL_optimization_hints,+SPV_INTEL_float_controls2 ;INTEL
// CHECK-CPU-SAME:,+SPV_INTEL_float_controls2
// CHECK-CPU-SAME:,+SPV_INTEL_vector_compute,+SPV_INTEL_fast_composite
// CHECK-CPU-SAME:,+SPV_INTEL_joint_matrix ;INTEL
...
// CHECK-CPU-SAME:,+SPV_INTEL_global_variable_decorations
...
// CHECK-CPU-SAME:,+SPV_INTEL_task_sequence ;INTEL
// CHECK-CPU-SAME:,+SPV_INTEL_optnone ;INTEL

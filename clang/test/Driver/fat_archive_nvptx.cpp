...
// INTEL_CUSTOMIZATION
// RUN: %clang -O2 -target x86_64-unknown-linux-gnu -### -fopenmp -fno-openmp-new-driver -fopenmp-targets=nvptx64-nvidia-cuda %s -L%S/Inputs/openmp_static_device_link -lFatArchive 2>&1 | FileCheck %s

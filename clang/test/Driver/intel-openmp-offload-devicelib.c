...
// CHK-PHASES: 19: input, "{{.*libomp-fallback-complex.o.*}}", object, (host-openmp)
// CHK-PHASES: 20: clang-offload-unbundler, {19}, object, (host-openmp)
// CHK-PHASES: 21: input, "{{.*libomp-fallback-complex-fp64.o.*}}", object, (host-openmp)
// CHK-PHASES: 22: clang-offload-unbundler, {21}, object, (host-openmp)
// CHK-PHASES: 23: input, "{{.*libomp-fallback-cmath.o.*}}", object, (host-openmp)
// CHK-PHASES: 24: clang-offload-unbundler, {23}, object, (host-openmp)
// CHK-PHASES: 25: input, "{{.*libomp-fallback-cmath-fp64.o.*}}", object, (host-openmp)
// CHK-PHASES: 26: clang-offload-unbundler, {25}, object, (host-openmp)
// CHK-PHASES: 27: input, "{{.*libomp-itt-user-wrappers.o.*}}", object, (host-openmp)
// CHK-PHASES: 28: clang-offload-unbundler, {27}, object, (host-openmp)
// CHK-PHASES: 29: input, "{{.*libomp-itt-compiler-wrappers.o.*}}", object, (host-openmp)
// CHK-PHASES: 30: clang-offload-unbundler, {29}, object, (host-openmp)
// CHK-PHASES: 31: input, "{{.*libomp-itt-stubs.o.*}}", object, (host-openmp)
...
// CHK-PHASES: 36: offload, "host-openmp (x86_64-unknown-linux-gnu)" {2}, "device-openmp (spir64)" {35}, ir

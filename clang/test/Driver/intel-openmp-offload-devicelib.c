...
// CHK-PHASES: 12: input, "{{.*libomp-glibc.o.*}}", object
// CHK-PHASES: 13: clang-offload-unbundler, {12}, object
// CHK-PHASES: 14: input, "{{.*libomp-complex.o.*}}", object
// CHK-PHASES: 15: clang-offload-unbundler, {14}, object
// CHK-PHASES: 16: input, "{{.*libomp-complex-fp64.o.*}}", object
// CHK-PHASES: 17: clang-offload-unbundler, {16}, object
// CHK-PHASES: 18: input, "{{.*libomp-cmath.o.*}}", object
// CHK-PHASES: 19: clang-offload-unbundler, {18}, object
// CHK-PHASES: 20: input, "{{.*libomp-cmath-fp64.o.*}}", object
// CHK-PHASES: 21: clang-offload-unbundler, {20}, object
// CHK-PHASES: 22: input, "{{.*libomp-fallback-cassert.o.*}}", object
// CHK-PHASES: 23: clang-offload-unbundler, {22}, object
// CHK-PHASES: 24: input, "{{.*libomp-fallback-cstring.o.*}}", object
// CHK-PHASES: 25: clang-offload-unbundler, {24}, object
// CHK-PHASES: 26: input, "{{.*libomp-fallback-complex.o.*}}", object
// CHK-PHASES: 27: clang-offload-unbundler, {26}, object
// CHK-PHASES: 28: input, "{{.*libomp-fallback-complex-fp64.o.*}}", object
// CHK-PHASES: 29: clang-offload-unbundler, {28}, object
// CHK-PHASES: 30: input, "{{.*libomp-fallback-cmath.o.*}}", object
// CHK-PHASES: 31: clang-offload-unbundler, {30}, object
// CHK-PHASES: 32: input, "{{.*libomp-fallback-cmath-fp64.o.*}}", object
// CHK-PHASES: 33: clang-offload-unbundler, {32}, object
// CHK-PHASES: 34: input, "{{.*libomp-itt-user-wrappers.o.*}}", object
// CHK-PHASES: 35: clang-offload-unbundler, {34}, object
// CHK-PHASES: 36: input, "{{.*libomp-itt-compiler-wrappers.o.*}}", object
// CHK-PHASES: 37: clang-offload-unbundler, {36}, object
// CHK-PHASES: 38: input, "{{.*libomp-itt-stubs.o.*}}", object
...
// CHK-PHASES-LIBC: 8: offload, "host-openmp (x86_64-unknown-linux-gnu)" {2}, "device-openmp (spir64)" {7}, ir
// CHK-PHASES-LIBC: 9: backend, {8}, ir, (device-openmp)
// CHK-PHASES-LIBC: 10: input, "{{.*libomp-spirvdevicertl.o.*}}", object
// CHK-PHASES-LIBC: 11: clang-offload-unbundler, {10}, object
// CHK-PHASES-LIBC: 12: input, "{{.*libomp-glibc.o.*}}", object
// CHK-PHASES-LIBC: 13: clang-offload-unbundler, {12}, object
// CHK-PHASES-LIBC: 14: input, "{{.*libomp-fallback-cassert.o.*}}", object
// CHK-PHASES-LIBC: 15: clang-offload-unbundler, {14}, object
// CHK-PHASES-LIBC: 16: input, "{{.*libomp-fallback-cstring.o.*}}", object
// CHK-PHASES-LIBC: 17: clang-offload-unbundler, {16}, object
// CHK-PHASES-LIBC: 18: input, "{{.*libomp-itt-user-wrappers.o.*}}", object
// CHK-PHASES-LIBC: 19: clang-offload-unbundler, {18}, object
// CHK-PHASES-LIBC: 20: input, "{{.*libomp-itt-compiler-wrappers.o.*}}", object
// CHK-PHASES-LIBC: 21: clang-offload-unbundler, {20}, object
// CHK-PHASES-LIBC: 22: input, "{{.*libomp-itt-stubs.o.*}}", object
...
// RUN: %clang -fiopenmp -fopenmp-targets=spir64 -device-math-lib=fp32 -### %s 2>&1 \

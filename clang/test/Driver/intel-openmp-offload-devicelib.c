...
// CHK-PHASES: 7: input, {{.*libomp-complex.o.*}}, object, (host-openmp)
// CHK-PHASES: 8: clang-offload-unbundler, {7}, object, (host-openmp)
// CHK-PHASES: 9: input, {{.*libomp-complex-fp64.o.*}}, object, (host-openmp)
// CHK-PHASES: 10: clang-offload-unbundler, {9}, object, (host-openmp)
// CHK-PHASES: 11: input, {{.*libomp-cmath.o.*}}, object, (host-openmp)
// CHK-PHASES: 12: clang-offload-unbundler, {11}, object, (host-openmp)
// CHK-PHASES: 13: input, {{.*libomp-cmath-fp64.o.*}}, object, (host-openmp)
// CHK-PHASES: 14: clang-offload-unbundler, {13}, object, (host-openmp)
// CHK-PHASES: 15: input, {{.*libomp-fallback-complex.o.*}}, object, (host-openmp)
// CHK-PHASES: 16: clang-offload-unbundler, {15}, object, (host-openmp)
// CHK-PHASES: 17: input, {{.*libomp-fallback-complex-fp64.o.*}}, object, (host-openmp)
// CHK-PHASES: 18: clang-offload-unbundler, {17}, object, (host-openmp)
// CHK-PHASES: 19: input, {{.*libomp-fallback-cmath.o.*}}, object, (host-openmp)
// CHK-PHASES: 20: clang-offload-unbundler, {19}, object, (host-openmp)
// CHK-PHASES: 21: input, {{.*libomp-fallback-cmath-fp64.o.*}}, object, (host-openmp)
// CHK-PHASES: 22: clang-offload-unbundler, {21}, object, (host-openmp)
// CHK-PHASES: 23: input, {{.*libomp-itt-user-wrappers.o.*}}, object, (host-openmp)
// CHK-PHASES: 24: clang-offload-unbundler, {23}, object, (host-openmp)
// CHK-PHASES: 25: input, {{.*libomp-itt-compiler-wrappers.o.*}}, object, (host-openmp)
// CHK-PHASES: 26: clang-offload-unbundler, {25}, object, (host-openmp)
// CHK-PHASES: 27: input, {{.*libomp-itt-stubs.o.*}}, object, (host-openmp)
...
// CHK-PHASES: 32: offload, "host-openmp (x86_64-unknown-linux-gnu)" {2}, "device-openmp (spir64)" {31}, ir
...
// CHK-PHASES-DEF: 32: offload, "host-openmp (x86_64-unknown-linux-gnu)" {2}, "device-openmp (spir64)" {31}, ir
...
// CHK-PHASES-LIBC: 11: input, {{.*libomp-itt-user-wrappers.o.*}}, object, (host-openmp)
// CHK-PHASES-LIBC: 12: clang-offload-unbundler, {11}, object, (host-openmp)
// CHK-PHASES-LIBC: 13: input, {{.*libomp-itt-compiler-wrappers.o.*}}, object, (host-openmp)
// CHK-PHASES-LIBC: 14: clang-offload-unbundler, {13}, object, (host-openmp)
// CHK-PHASES-LIBC: 15: input, {{.*libomp-itt-stubs.o.*}}, object, (host-openmp)
...
// CHK-PHASES-LIBC: 20: offload, "host-openmp (x86_64-unknown-linux-gnu)" {2}, "device-openmp (spir64)" {19}, ir

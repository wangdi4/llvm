...
// CHK-PHASES: 19: input, "{{.*libomp-fallback-cstring.obj*}}", object, (host-openmp)
// CHK-PHASES: 20: clang-offload-unbundler, {19}, object, (host-openmp)
// CHK-PHASES: 21: input, "{{.*libomp-fallback-complex.obj.*}}", object, (host-openmp)
// CHK-PHASES: 22: clang-offload-unbundler, {21}, object, (host-openmp)
// CHK-PHASES: 23: input, "{{.*libomp-fallback-complex-fp64.obj.*}}", object, (host-openmp)
// CHK-PHASES: 24: clang-offload-unbundler, {23}, object, (host-openmp)
// CHK-PHASES: 25: input, "{{.*libomp-fallback-cmath.obj.*}}", object, (host-openmp)
// CHK-PHASES: 26: clang-offload-unbundler, {25}, object, (host-openmp)
// CHK-PHASES: 27: input, "{{.*libomp-fallback-cmath-fp64.obj.*}}", object, (host-openmp)
// CHK-PHASES: 28: clang-offload-unbundler, {27}, object, (host-openmp)
// CHK-PHASES: 29: input, "{{.*libomp-itt-user-wrappers.obj.*}}", object, (host-openmp)
// CHK-PHASES: 30: clang-offload-unbundler, {29}, object, (host-openmp)
// CHK-PHASES: 31: input, "{{.*libomp-itt-compiler-wrappers.obj.*}}", object, (host-openmp)
// CHK-PHASES: 32: clang-offload-unbundler, {31}, object, (host-openmp)
// CHK-PHASES: 33: input, "{{.*libomp-itt-stubs.obj.*}}", object, (host-openmp)
...
// CHK-PHASES: 38: offload, "host-openmp (x86_64-pc-windows-msvc)" {2}, "device-openmp (spir64)" {37}, ir
...
// CHK-PHASES-LIBC: 11: input, "{{.*libomp-fallback-cstring.obj.*}}", object, (host-openmp)
// CHK-PHASES-LIBC: 12: clang-offload-unbundler, {11}, object, (host-openmp)
// CHK-PHASES-LIBC: 13: input, {{.*libomp-itt-user-wrappers.obj.*}}, object, (host-openmp)
// CHK-PHASES-LIBC: 14: clang-offload-unbundler, {13}, object, (host-openmp)
// CHK-PHASES-LIBC: 15: input, {{.*libomp-itt-compiler-wrappers.obj.*}}, object, (host-openmp)
// CHK-PHASES-LIBC: 16: clang-offload-unbundler, {15}, object, (host-openmp)
// CHK-PHASES-LIBC: 17: input, {{.*libomp-itt-stubs.obj.*}}, object, (host-openmp)
...
// CHK-PHASES-LIBC: 22: offload, "host-openmp (x86_64-pc-windows-msvc)" {2}, "device-openmp (spir64)" {21}, ir

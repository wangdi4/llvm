...
int *v __attribute__((__alloc_size__(1))); // expected-warning{{'__alloc_size__' attribute only applies to functions and methods}}
...
int *f5(int a) __attribute__((__alloc_size__(1.5))); // expected-error{{'alloc_size' attribute requires integer constant}}

// Check that function's parameter specified by attribute's argument has an integer type.
int *f6(float a) __attribute__((__alloc_size__(1))); // expected-warning{{'__alloc_size__' attribute requires an integer function parameter}} \
                                                     // expected-note{{parameter's index specified here}}
int *f7(int a, unsigned b, double c) __attribute__((__alloc_size__(1, 3))); // expected-warning{{'__alloc_size__' attribute requires an integer function parameter}} \
                                                                            // expected-note{{parameter's index specified here}}

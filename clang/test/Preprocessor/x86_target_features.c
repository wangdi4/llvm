...
// RUN: %clang -target i386-unknown-linux-gnu -march=i386 -mkeylocker -x c -E -dM -o - %s | FileCheck  -check-prefix=KEYLOCKER %s
// KEYLOCKER: #define __KL__ 1

// RUN: %clang -target i386-unknown-linux-gnu -march=i386 -mno-keylocker -x c -E -dM -o - %s | FileCheck  -check-prefix=NOKEYLOCKER %s
...
// RUN: %clang -target i386-unknown-linux-gnu -march=i386 -mwidekl -mno-keylocker -x c -E -dM -o - %s | FileCheck  -check-prefix=NOKEYLOCKERW2 %s

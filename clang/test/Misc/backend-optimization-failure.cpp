// INTEL - added -mllvm -enable-lv RUN: %clang_cc1 -triple x86_64-unknown-unknown %s -O3 -mllvm -enable-lv -emit-llvm -debug-info-kind=line-tables-only -S -verify -o /dev/null

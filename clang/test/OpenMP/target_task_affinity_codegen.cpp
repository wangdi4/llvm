...
// INTEL RUN: %clang_cc1 -mllvm -xmain-enable-gep0-removal -DCK1 -verify -fopenmp -x c++ -triple i386-unknown-unknown -fopenmp-targets=i386-pc-linux-gnu -emit-llvm %s -o - | FileCheck %s --check-prefix=CHECK3
// RUN: %clang_cc1 -DCK1 -fopenmp -x c++ -std=c++11 -triple i386-unknown-unknown -fopenmp-targets=i386-pc-linux-gnu -emit-pch -o %t %s
// INTEL RUN: %clang_cc1 -mllvm -xmain-enable-gep0-removal -DCK1 -fopenmp -x c++ -triple i386-unknown-unknown -fopenmp-targets=i386-pc-linux-gnu -std=c++11 -include-pch %t -verify %s -emit-llvm -o - | FileCheck %s --check-prefix=CHECK3
...
// INTEL RUN: %clang_cc1 -mllvm -xmain-enable-gep0-removal -DCK1 -verify -fopenmp -x c++ -triple powerpc64le-unknown-unknown -fopenmp-targets=powerpc64le-ibm-linux-gnu -emit-llvm %s -fopenmp-is-device -fopenmp-host-ir-file-path %t-ppc-host.bc -o - | FileCheck %s --check-prefix=CHECK9
...
// INTEL RUN: %clang_cc1 -mllvm -xmain-enable-gep0-removal -DCK1 -fopenmp -x c++ -triple powerpc64le-unknown-unknown -fopenmp-targets=powerpc64le-ibm-linux-gnu -std=c++11 -fopenmp-is-device -fopenmp-host-ir-file-path %t-ppc-host.bc -include-pch %t -verify %s -emit-llvm -o - | FileCheck %s --check-prefix=CHECK9
...
// INTEL RUN: %clang_cc1 -mllvm -xmain-enable-gep0-removal -DCK1 -verify -fopenmp -x c++ -triple i386-unknown-unknown -fopenmp-targets=i386-pc-linux-gnu -emit-llvm %s -fopenmp-is-device -fopenmp-host-ir-file-path %t-x86-host.bc -o - | FileCheck %s --check-prefix=CHECK11
...
// INTEL RUN: %clang_cc1 -mllvm -xmain-enable-gep0-removal -DCK1 -fopenmp -x c++ -triple i386-unknown-unknown -fopenmp-targets=i386-pc-linux-gnu -std=c++11 -fopenmp-is-device -fopenmp-host-ir-file-path %t-x86-host.bc -include-pch %t -verify %s -emit-llvm -o - | FileCheck %s --check-prefix=CHECK11
...
// CHECK1-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[A]], align 8
...
// CHECK1-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[TMP8]], align 8
// CHECK1-NEXT:    store ptr [[TMP13]], ptr [[A4]], align 8
// CHECK1-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[B]], align 8
// CHECK1-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[A4]], align 8
// CHECK1-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[B]], align 8
...
// CHECK3-NEXT:    [[TMP7:%.*]] = load ptr, ptr [[A]], align 4
...
// CHECK3-NEXT:    [[TMP13:%.*]] = load ptr, ptr [[TMP8]], align 4
// CHECK3-NEXT:    store ptr [[TMP13]], ptr [[A4]], align 4
// CHECK3-NEXT:    [[TMP14:%.*]] = load ptr, ptr [[B]], align 4
// CHECK3-NEXT:    [[TMP15:%.*]] = load ptr, ptr [[A4]], align 4
// CHECK3-NEXT:    [[TMP16:%.*]] = load ptr, ptr [[B]], align 4

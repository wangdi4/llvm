...
// RUN: %clang_cc1 -no-opaque-pointers -emit-llvm -o - -fexceptions -fopenmp -fintel-compatibility -fopenmp-late-outline -triple x86_64-unknown-linux-gnu %s | FileCheck %s

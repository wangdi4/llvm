...
void foo(int n) {
  ...
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP1]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP2]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP3]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP4]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP5]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP6]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP7]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP8]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP9]]
  // CHECK-SAME: "QUAL.OMP.SHARED:TYPED"(ptr [[VLATEMP10]]

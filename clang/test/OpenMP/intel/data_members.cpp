...
//RUN: %clang_cc1 -emit-llvm -o - %s -std=c++14 -fopenmp -fintel-compatibility -fopenmp-late-outline -fopenmp-typed-clauses -triple x86_64-pc-windows-msvc | FileCheck %s
//RUN: %clang_cc1 -emit-llvm -o - %s -std=c++14 -fopenmp -fintel-compatibility -fopenmp-late-outline -fopenmp-typed-clauses -triple i386-pc-windows-msvc | FileCheck %s

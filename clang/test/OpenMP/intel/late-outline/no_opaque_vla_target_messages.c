// INTEL_COLLAB
//RUN: %clang_cc1 -no-opaque-pointers -triple x86_64-unknown-linux-gnu -emit-llvm-bc \
...
//RUN: %clang_cc1 -no-opaque-pointers -triple spir64 -emit-llvm -disable-llvm-passes   \

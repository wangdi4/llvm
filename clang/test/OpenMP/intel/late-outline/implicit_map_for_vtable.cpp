...
//HOST: [[VT2:%vtable2]] = load ptr, ptr [[d]]
//HOST: [[VT3:%vtable3]] = load ptr, ptr [[d]]
//HOST: [[ADD:%add.ptr]] = getelementptr inbounds i8, ptr [[d]]
//HOST: [[VT4:%vtable4]] = load ptr, ptr [[ADD]]
//HOST: [[TV:%[0-9]+]] = call token{{.*}}region.entry{{.*}}DIR.OMP.TARGET
...
//HOST: [[VT7:%vtable7]] = load ptr, ptr [[d]]
//HOST: [[VT8:%vtable8]] = load ptr, ptr [[d]]
//HOST: [[ADD1:%add.ptr9]] = getelementptr inbounds i8, ptr [[d]]
//HOST: [[VT10:%vtable10]] = load ptr, ptr [[ADD1]]
//HOST: [[DIV:%[0-9]+]] = sdiv
//HOST: [[TV:%[0-9]+]] = call token{{.*}}region.entry{{.*}}DIR.OMP.TARGET
...
//HOST-SAME:  "QUAL.OMP.MAP.TO:CHAIN"(ptr %X, ptr %vtable18, i32 8, i64 281474976710673, ptr null, ptr null)
//region.exit(token [[TV]]) [ "DIR.OMP.END.TARGET.UPDATE"()]
//HOST: ret i32

//HOST: !omp_offload.info = !{!0, !1, !2, !3, !4, !5, !6}
//HOST: !4 = !{i32 1, !"_ZTV4Base", i32 0, i32 4, ptr @_ZTV4Base}
//HOST: !5 = !{i32 1, !"_ZTV1D", i32 0, i32 6, ptr @_ZTV1D}
//HOST: !6 = !{i32 1, !"_ZTV7Derived", i32 0, i32 5, ptr @_ZTV7Derived}
...
//TARG: [[VT:%vtable]] = load ptr addrspace(4), ptr addrspace(4) [[XA]]
...
//TARG: [[VT1:%vtable1]] = load ptr addrspace(4), ptr addrspace(4) [[dobja]]
//TARG: [[TV:%[0-9]+]] = call token{{.*}}region.entry{{.*}}DIR.OMP.TARGET
//TARG-SAME: "QUAL.OMP.MAP.TO:CHAIN"(ptr addrspace(4) [[dobja]], ptr addrspace(4) [[VT1]], i32 8, i64 281474976710673, ptr null, ptr null)
//TARG: region.exit(token [[TV]]) [ "DIR.OMP.END.TARGET"() ]
//TARG: [[VT2:%vtable2]] = load ptr addrspace(4), ptr addrspace(4) [[da]]
//TARG: [[VT3:%vtable3]] = load ptr addrspace(4), ptr addrspace(4) [[da]]
//TARG: [[ADD:%add.ptr]] = getelementptr inbounds i8, ptr addrspace(4) [[da]]
//TARG: [[VT4:%vtable4]] = load ptr addrspace(4), ptr addrspace(4) [[ADD]]
//TARG: [[TV:%[0-9]+]] = call token{{.*}}region.entry{{.*}}DIR.OMP.TARGET
...
//TARG: !4 = !{i32 1, !"_ZTV4Base", i32 0, i32 4, ptr addrspace(1) @_ZTV4Base}
//TARG: !5 = !{i32 1, !"_ZTV1D", i32 0, i32 6, ptr addrspace(1) @_ZTV1D}
//TARG: !6 = !{i32 1, !"_ZTV7Derived", i32 0, i32 5, ptr addrspace(1) @_ZTV7Derived}

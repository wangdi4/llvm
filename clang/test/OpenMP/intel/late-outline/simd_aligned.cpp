...
int bar(int M, float *FP) {
  ...
  //
  // CHECK: DIR.OMP.SIMD
  // CHECK-SAME: "QUAL.OMP.ALIGNED:PTR_TO_PTR"(ptr [[FPLOC]], i32 32)
  // CHECK-SAME: "QUAL.OMP.ALIGNED:PTR_TO_PTR"(ptr [[FPADDR]], i32 32)
  // CHECK-SAME: "QUAL.OMP.ALIGNED"(ptr [[ARR]], i32 32)
  // CHECK-SAME: "QUAL.OMP.ALIGNED"(ptr [[VLA]], i32 32)
  // CHECK-SAME: "QUAL.OMP.ALIGNED:PTR_TO_PTR"(ptr [[LFPR]], i32 32)
  // CHECK-SAME: "QUAL.OMP.ALIGNED"(ptr [[LARR]], i32 32)
  // CHECK: DIR.OMP.END.SIMD

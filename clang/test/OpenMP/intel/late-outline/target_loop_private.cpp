...
void foo()
{
  ...
  int i;
  //HOST: [[J:%j.*]] = alloca i32,
  //TARG:  [[J:%[a-z.0-9]+]] = addrspacecast i32* %j to i32 addrspace(4)*
  int j;
  ...
  //HOST: "DIR.OMP.TARGET"(){{.*}}"QUAL.OMP.PRIVATE"(i32* [[J]]),
  //HOST: "DIR.OMP.TEAMS"(){{.*}}"QUAL.OMP.PRIVATE"(i32* [[J]]),
  //HOST: "DIR.OMP.DISTRIBUTE.PARLOOP"(){{.*}}"QUAL.OMP.PRIVATE"(i32* [[J]]),
  //HOST: "DIR.OMP.END.TARGET"()
  //TARG: "DIR.OMP.TARGET"(){{.*}}"QUAL.OMP.PRIVATE"(i32 addrspace(4)* [[J]]),
  //TARG: "DIR.OMP.TEAMS"(){{.*}}"QUAL.OMP.PRIVATE"(i32 addrspace(4)* [[J]]),
  //TARG: "DIR.OMP.DISTRIBUTE.PARLOOP"()
  //TARG-SAME: "QUAL.OMP.PRIVATE"(i32 addrspace(4)* [[J]]),
  ...
  //HOST: "DIR.OMP.TARGET"(){{.*}}"QUAL.OMP.FIRSTPRIVATE"(i32* [[J]]),
  //HOST: "DIR.OMP.END.TARGET"()
  //TARG: "DIR.OMP.TARGET"()
  //TARG-SAME: "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* [[J]]),
  //TARG: "DIR.OMP.END.TARGET"()
  #pragma omp target
  {
    #pragma omp teams

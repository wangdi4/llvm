...
// CHECK-NEXT:    call void @_ZZ13lambda_maskediiENKUlvE_clEv(%class.anon* nonnull align 4 dereferenceable(8) [[L]])
...
// CHECK-NEXT:    call void @_ZZ13lambda_maskediiENKUlvE0_clEv(%class.anon.0* nonnull align 4 dereferenceable(8) [[L1]])
...
// CHECK-NEXT:    call void @_ZZ13lambda_maskediiENKUliE_clEi(%class.anon.1* nonnull align 4 dereferenceable(8) [[L2]], i32 [[TMP12]])
// CHECK-NEXT:    ret void
//

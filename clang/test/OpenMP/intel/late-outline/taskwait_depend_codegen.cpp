...
// RUN: -fopenmp-new-depend-ir | FileCheck --check-prefix=CHECK-NEW %s
...
// RUN: %clang_cc1 -fopenmp -fopenmp-late-outline \
// RUN: -triple x86_64-unknown-linux-gnu -fopenmp-version=51 \
// RUN: -fopenmp-new-depend-ir -emit-pch %s -o %t

// RUN: %clang_cc1 -fopenmp -fopenmp-late-outline \
// RUN: -triple x86_64-unknown-linux-gnu -fopenmp-version=51 \
// RUN: -include-pch %t -fopenmp-new-depend-ir -emit-llvm %s -o - | \

...
// CHECK-NEW-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.FIRSTPRIVATE"(ptr [[VAR]]), "QUAL.OMP.FIRSTPRIVATE"(ptr [[ARR]]), "QUAL.OMP.PRIVATE"(ptr [[DOTDEP_ARR_ADDR]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR]]), "QUAL.OMP.PRIVATE"(ptr [[DOTDEP_ARR_ADDR1]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR2]]), "QUAL.OMP.PRIVATE"(ptr [[DOTDEP_ARR_ADDR3]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR4]]), "QUAL.OMP.PRIVATE"(ptr [[DOTDEP_ARR_ADDR5]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR6]]), "QUAL.OMP.PRIVATE"(ptr [[DOTDEP_ARR_ADDR7]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR9]]), "QUAL.OMP.PRIVATE"(ptr [[DOTDEP_ARR_ADDR10]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR11]]), "QUAL.OMP.PRIVATE"(ptr [[DOTDEP_ARR_ADDR12]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR13]]) ]
...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.FIRSTPRIVATE"(ptr [[VAR]]), "QUAL.OMP.FIRSTPRIVATE"(ptr [[ARR]]) ]

// RUN: %clang_cc1 -triple x86_64-unknown-linux-gnu -fopenmp -fopenmp-late-outline -fopenmp-typed-clauses -fopenmp-late-outline -fopenmp-targets=x86_64 %s -emit-llvm -o - | FileCheck %s

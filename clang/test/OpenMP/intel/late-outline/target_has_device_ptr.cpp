...
// CHECK-SAME:    "QUAL.OMP.HAS_DEVICE_ADDR"(ptr [[X]])
...
// CHECK:         "DIR.OMP.TARGET"(),
// CHECK-SAME:    "QUAL.OMP.HAS_DEVICE_ADDR"(ptr [[MAP]]),
// CHECK:         "DIR.OMP.SIMD"(),
// CHECK:         omp.loop.exit:
...
// CHECK:      [[DEVPTR:%devPtr]] = getelementptr inbounds %struct.SomeKernel, ptr [[THIS1]], i32 0, i32 1
// CHECK:      "DIR.OMP.TARGET"()
// CHECK-SAME: "QUAL.OMP.HAS_DEVICE_ADDR"(ptr [[DEVPTR]])
// CHECK:      "DIR.OMP.END.TARGET"()

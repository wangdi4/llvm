// INTEL_COLLAB
// RUN: %clang_cc1 -opaque-pointers -emit-llvm -o - -std=c11 -fopenmp -fopenmp-late-outline -fopenmp-typed-clauses \
...
// CHECK-SAME: "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr [[DOTOMP_IV]]
// CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr [[DOTOMP_LB]]
// CHECK-SAME: "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr [[DOTOMP_UB]]
...
// CHECK: "DIR.OMP.TASKLOOP"(),
// CHECK-SAME: "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr [[DOTOMP_IV15]]
// CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr [[DOTOMP_LB16]]
// CHECK-SAME: "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr [[DOTOMP_UB17]]
// CHECK-SAME: "QUAL.OMP.PRIVATE:TYPED"(ptr [[I22]]
// CHECK: "DIR.OMP.END.TASKLOOP"()
 #pragma omp taskloop
 for (int i=0; i<N; i++)
   foo();

...
void foo_target_teams(long long int n)
{
  ...
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[N_ADDR]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[N_ADDR]])
  ...
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[TMP]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.THREAD_LIMIT"(ptr [[TMP]])
  #pragma omp target
...
void foo_target_teams_combined(long long int n)
{
  ...
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[CAP3]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.THREAD_LIMIT"(ptr [[CAP3]])
...
void bar()
{
  ...
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[TMP1]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.THREAD_LIMIT"(ptr [[TMP1]])
  #pragma omp target
  ...
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[TMP2]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.THREAD_LIMIT"(ptr [[TMP2]])
  #pragma omp target
  ...
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[TMP3]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.THREAD_LIMIT"(ptr [[TMP3]])
  #pragma omp target
  ...
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[TMP4]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.THREAD_LIMIT"(ptr [[TMP4]])
  #pragma omp target
  ...
  local++;
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[CAP1]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[LOCAL]])
  ...
  local++;
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[CAP2]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.THREAD_LIMIT"(ptr [[CAP2]])
  ...
  local++;
  //CHECK: "DIR.OMP.TARGET"()
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[CAP4]])
  //CHECK: "DIR.OMP.TEAMS"()
  //CHECK-SAME: "QUAL.OMP.NUM_TEAMS"(ptr [[LOCAL]])
  //CHECK-SAME: "QUAL.OMP.THREAD_LIMIT"(ptr [[CAP4]])
...
void barfoo()
{
  ...
  //CHECK-SAME: "QUAL.OMP.PRIVATE"(ptr [[T]])
  //CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(ptr [[CAP1]])

...
//
// RUN: %clang_cc1 -opaque-pointers -fopenmp -fopenmp-late-outline -fopenmp-typed-clauses -DMULTI_DATA \
// RUN: -triple x86_64-unknown-linux-gnu -emit-pch %s -o %t
...
// CHECK-32-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH]], ptr null, i32 1, i32 1) ]
...
// CHECK-32-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH1]], ptr null, i32 1, i32 2), "QUAL.OMP.IF"(i1 [[CMP]]) ]
...
// CHECK-32-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.IF"(i1 [[CMP2]]), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH3]], ptr null, i32 1, i32 3) ]
...
// CHECK-32-NEXT:    [[TMP7:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH5]], ptr null, i32 1, i32 1), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH6]], ptr null, i32 2, i32 5) ]
...
// CHECK-32-NEXT:    [[TMP9:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH7]], ptr null, i32 1, i32 1), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH8]], ptr null, i32 2, i32 4), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH9]], ptr null, i32 3, i32 10) ]
...
// CHECK-32-NEXT:    [[TMP11:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH10]], ptr null, i32 1, i32 2), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH11]], ptr null, i32 3, i32 20), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH12]], ptr null, i32 2, i32 10) ]
...
// CHECK-32-NEXT:    [[TMP18:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH17]], ptr null, i32 1, i32 100), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH18]], ptr null, i32 4, i32 200) ]
...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH]], ptr null, i32 1, i64 1) ]
...
// CHECK-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH1]], ptr null, i32 1, i64 2), "QUAL.OMP.IF"(i1 [[CMP]]) ]
...
// CHECK-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.IF"(i1 [[CMP2]]), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH3]], ptr null, i32 1, i64 3) ]
...
// CHECK-NEXT:    [[TMP7:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH5]], ptr null, i32 1, i64 1), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH6]], ptr null, i32 2, i64 5) ]
...
// CHECK-NEXT:    [[TMP9:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH7]], ptr null, i32 1, i64 1), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH8]], ptr null, i32 2, i64 4), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH9]], ptr null, i32 3, i64 10) ]
...
// CHECK-NEXT:    [[TMP11:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH10]], ptr null, i32 1, i64 2), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH11]], ptr null, i32 3, i64 20), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH12]], ptr null, i32 2, i64 10) ]
...
// CHECK-NEXT:    [[TMP18:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH18]], ptr null, i32 1, i64 100), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH19]], ptr null, i32 4, i64 200) ]
...
// CHECK-32-NEXT:    store ptr [[ARRAYIDX]], ptr [[DOTTMP_PREFETCH1]], align 4
// CHECK-32-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH]], ptr null, i32 1, i32 100), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH1]], ptr null, i32 4, i32 5) ]
...
// CHECK-NEXT:    store ptr [[ARRAYIDX]], ptr [[DOTTMP_PREFETCH1]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH]], ptr null, i32 1, i64 100), "QUAL.OMP.DATA:TYPED"(ptr [[DOTTMP_PREFETCH1]], ptr null, i32 4, i64 5) ]

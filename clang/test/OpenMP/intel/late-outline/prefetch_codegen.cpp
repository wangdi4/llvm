...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA"([10 x i32]** [[DOTTMP_PREFETCH]], i32 1, i32 1) ]
...
// CHECK-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA"(i32** [[DOTTMP_PREFETCH1]], i32 1, i32 2), "QUAL.OMP.IF"(i1 [[CMP]]) ]
...
// CHECK-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.IF"(i1 [[CMP2]]), "QUAL.OMP.DATA"(i32** [[DOTTMP_PREFETCH3]], i32 1, i32 3) ]
...
// CHECK-NEXT:    [[TMP7:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA"([10 x i32]** [[DOTTMP_PREFETCH5]], i32 1, i32 1), "QUAL.OMP.DATA"([10 x i32]** [[DOTTMP_PREFETCH6]], i32 2, i32 5) ]
...
// CHECK-NEXT:    [[TMP9:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA"([10 x i32]** [[DOTTMP_PREFETCH7]], i32 1, i32 1), "QUAL.OMP.DATA"([10 x i32]** [[DOTTMP_PREFETCH8]], i32 2, i32 4), "QUAL.OMP.DATA"(i32** [[DOTTMP_PREFETCH9]], i32 3, i32 10) ]
...
// CHECK-NEXT:    [[TMP11:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA"(%struct.foobar** [[DOTTMP_PREFETCH10]], i32 1, i32 2), "QUAL.OMP.DATA"([10 x double]** [[DOTTMP_PREFETCH11]], i32 3, i32 20), "QUAL.OMP.DATA"(double** [[DOTTMP_PREFETCH12]], i32 2, i32 10) ]
...
// CHECK-NEXT:    [[TMP18:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA"(i32** [[DOTTMP_PREFETCH18]], i32 1, i32 100), "QUAL.OMP.DATA"(i32** [[DOTTMP_PREFETCH19]], i32 4, i32 200) ]
...
// CHECK-NEXT:    store i32* [[ARRAYIDX]], i32** [[DOTTMP_PREFETCH1]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PREFETCH"(), "QUAL.OMP.DATA"(i32** [[DOTTMP_PREFETCH]], i32 1, i32 100), "QUAL.OMP.DATA"(i32** [[DOTTMP_PREFETCH1]], i32 4, i32 5) ]
...
// CHECK-NEXT:    [[CALL:%.*]] = call double @_Z3runIdLj10EET_v()

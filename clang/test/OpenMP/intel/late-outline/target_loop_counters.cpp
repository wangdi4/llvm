...
void foo()
{
  ...
  //HOST: "DIR.OMP.TARGET"(){{.*}}"QUAL.OMP.PRIVATE:TYPED"(ptr [[I]]
  //HOST: "DIR.OMP.TEAMS"(){{.*}}"QUAL.OMP.PRIVATE:TYPED"(ptr [[I]]
  //HOST: "DIR.OMP.DISTRIBUTE.PARLOOP"(){{.*}}"QUAL.OMP.PRIVATE:TYPED"(ptr [[I]]
  //HOST: "DIR.OMP.END.TARGET"()

  //TARG: "DIR.OMP.TARGET"()
  //TARG-SAME: "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) [[I]]
  //TARG: "DIR.OMP.TEAMS"()
  //TARG-SAME: "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) [[I]]
  ...
  //HOST: "DIR.OMP.TARGET"(){{.*}}"QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr [[I]]
  //HOST: "DIR.OMP.END.TARGET"()
  //TARG: "DIR.OMP.TARGET"()
  //TARG-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) [[I]]
  //TARG: "DIR.OMP.END.TARGET"()
  #pragma omp target
  {
    #pragma omp teams

...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.IF"(i32 0), "QUAL.OMP.TARGET.TASK"(), "QUAL.OMP.INREDUCTION.ADD:TYPED"(ptr [[Y]]
...
// CHECK-SAME:    "QUAL.OMP.INREDUCTION.ADD:TYPED"(ptr [[Y]]
...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.SHARED:TYPED"(ptr [[Y]], i16 0, i32 1), "QUAL.OMP.SHARED:TYPED"(ptr [[X]], i32 0, i32 1), "QUAL.OMP.SHARED:TYPED"(ptr [[Z]], i32 0, i32 1), "QUAL.OMP.SHARED:TYPED"(ptr [[M]], i32 0, i32 1) ]
// CHECK-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.MASTER"() ]
// CHECK-NEXT:    fence acquire
// CHECK-NEXT:    [[TMP2:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.TASKGROUP"(), "QUAL.OMP.REDUCTION.ADD:TYPED"(ptr [[Y]]
// CHECK-NEXT:    [[TMP3:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.TARGET.TASK"(), "QUAL.OMP.INREDUCTION.ADD:TYPED"(ptr [[X]], i32 0, i32 1), "QUAL.OMP.INREDUCTION.ADD:TYPED"(ptr [[Y]], i16 0, i32 1), "QUAL.OMP.INREDUCTION.ADD:TYPED"(ptr [[Z]], i32 0, i32 1), "QUAL.OMP.SHARED:TYPED"(ptr [[M]], i32 0, i32 1) ]
...
// CHECK-NEXT:    [[TMP8:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.INREDUCTION.ADD:TYPED"(ptr [[Y]]
...
// CHECK-NEXT:    [[Y:%.*]] = alloca i16, align 2
// CHECK-NEXT:    store i16 2, ptr [[Y]], align 2
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.SECTIONS"(), "QUAL.OMP.REDUCTION.SUB:TYPED"(ptr [[Y]], i16 0, i32 1) ]
// CHECK-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.SECTION"() ]
// CHECK-NEXT:    [[TMP2:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.IF"(i32 0), "QUAL.OMP.TARGET.TASK"(), "QUAL.OMP.INREDUCTION.SUB:TYPED"(ptr [[Y]], i16 0, i32 1) ]
...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.SHARED:TYPED"(ptr [[Y]], i16 0, i32 1), "QUAL.OMP.SHARED:TYPED"(ptr [[Z]], i32 0, i32 1) ]
// CHECK-NEXT:    [[TMP1:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.MASTER"() ]
// CHECK-NEXT:    fence acquire
// CHECK-NEXT:    [[TMP2:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.IF"(i32 0), "QUAL.OMP.TARGET.TASK"(), "QUAL.OMP.INREDUCTION.MUL:TYPED"(ptr [[Y]], i16 0, i32 1), "QUAL.OMP.INREDUCTION.ADD:TYPED"(ptr [[Z]], i32 0, i32 1) ]

// INTEL_COLLAB
// RUN: %clang_cc1 -no-opaque-pointers -verify -fopenmp -fopenmp-late-outline %s
//
// RUN: %clang_cc1 -no-opaque-pointers -verify -Wopenmp-allocate -fopenmp -fopenmp-late-outline %s
//
// RUN: %clang_cc1 -no-opaque-pointers -verify -Wno-openmp-allocate -DNOWARNING -fopenmp \

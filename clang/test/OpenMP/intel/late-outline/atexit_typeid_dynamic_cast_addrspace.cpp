...
//CHECK: call spir_func noundef i8 addrspace(4)* @_ZNKSt9type_info4nameEv(%"class.std::type_info" addrspace(4)* noundef addrspacecast (%"class.std::type_info"* bitcast ({ i8 addrspace(4)*, i8 addrspace(4)*, i32, i32, i8 addrspace(4)*, i64 }* @_ZTI7Derived to %"class.std::type_info"*) to %"class.std::type_info" addrspace(4)*))
//CHECK: define linkonce_odr hidden spir_func void @_ZTv0_n24_N7DerivedD0Ev(%struct.Derived addrspace(4)* noundef %this)

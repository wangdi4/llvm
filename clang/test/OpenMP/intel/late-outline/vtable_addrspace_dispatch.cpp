...
// CHECK: [[ZTV1C:@_ZTV1C]] = linkonce_odr hidden unnamed_addr constant { [4 x i8 addrspace(4)*] } { [4 x i8 addrspace(4)*] [i8 addrspace(4)* null, i8 addrspace(4)* addrspacecast (i8* bitcast ({ i8 addrspace(4)*, i8 addrspace(4)* }* @_ZTI1C to i8*) to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast (i32 (%struct.C addrspace(4)*, i32)* @_ZN1C3fooEi to i8*) to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast (i32 (%struct.C addrspace(4)*, i32 addrspace(4)*)* @_ZN1C3fooEPi to i8*) to i8 addrspace(4)*)] }
// CHECK: [[ZTV1B:@_ZTV1B]] = linkonce_odr hidden unnamed_addr constant { [5 x i8 addrspace(4)*], [6 x i8 addrspace(4)*] } { [5 x i8 addrspace(4)*] [i8 addrspace(4)* inttoptr (i64 8 to i8 addrspace(4)*), i8 addrspace(4)* null, i8 addrspace(4)* addrspacecast (i8* bitcast ({ i8 addrspace(4)*, i8 addrspace(4)*, i32, i32, i8 addrspace(4)*, i64, i8 addrspace(4)*, i64 }* @_ZTI1B to i8*) to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast (i32 (%struct.B addrspace(4)*, i32)* @_ZN1B3fooEi to i8*) to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast (i32 (%struct.B addrspace(4)*, i32 addrspace(4)*)* @_ZN1B3fooEPi to i8*) to i8 addrspace(4)*)], [6 x i8 addrspace(4)*] [i8 addrspace(4)* inttoptr (i64 -8 to i8 addrspace(4)*), i8 addrspace(4)* inttoptr (i64 -8 to i8 addrspace(4)*), i8 addrspace(4)* inttoptr (i64 -8 to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast ({ i8 addrspace(4)*, i8 addrspace(4)*, i32, i32, i8 addrspace(4)*, i64, i8 addrspace(4)*, i64 }* @_ZTI1B to i8*) to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast (i32 (%struct.B addrspace(4)*, i32 addrspace(4)*)* @_ZTv0_n24_N1B3fooEPi to i8*) to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast (i32 (%struct.B addrspace(4)*, i32)* @_ZTv0_n32_N1B3fooEi to i8*) to i8 addrspace(4)*)] }
// CHECK: [[ZTV1A:@_ZTV1A]] = linkonce_odr hidden unnamed_addr constant { [4 x i8 addrspace(4)*] } { [4 x i8 addrspace(4)*] [i8 addrspace(4)* null, i8 addrspace(4)* addrspacecast (i8* bitcast ({ i8 addrspace(4)*, i8 addrspace(4)* }* @_ZTI1A to i8*) to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast (i32 (%struct.A addrspace(4)*, i32 addrspace(4)*)* @_ZN1A3fooEPi to i8*) to i8 addrspace(4)*), i8 addrspace(4)* addrspacecast (i8* bitcast (i32 (%struct.A addrspace(4)*, i32)* @_ZN1A3fooEi to i8*) to i8 addrspace(4)*)] }
struct A
{
...
// CHECK: store i32 (...)* addrspace(4)* addrspacecast (i32 (...)** bitcast (i8 addrspace(4)** getelementptr inbounds ({ [5 x i8 addrspace(4)*], [6 x i8 addrspace(4)*] }, { [5 x i8 addrspace(4)*], [6 x i8 addrspace(4)*] }* [[ZTV1B]], i32 0, inrange i32 0, i32 3) to i32 (...)**) to i32 (...)* addrspace(4)*), i32 (...)* addrspace(4)* addrspace(4)* [[L4]]
...
// CHECK: store i32 (...)* addrspace(4)* addrspacecast (i32 (...)** bitcast (i8 addrspace(4)** getelementptr inbounds ({ [5 x i8 addrspace(4)*], [6 x i8 addrspace(4)*] }, { [5 x i8 addrspace(4)*], [6 x i8 addrspace(4)*] }* [[ZTV1B]], i32 0, inrange i32 1, i32 4) to i32 (...)**) to i32 (...)* addrspace(4)*), i32 (...)* addrspace(4)* addrspace(4)* [[L6]]
// CHECK: ret void

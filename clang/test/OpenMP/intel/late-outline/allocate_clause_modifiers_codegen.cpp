...
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.ALLOCATE"(i64 1, i8* [[FOO]]), "QUAL.OMP.PRIVATE"(i8* [[FOO]]), "QUAL.OMP.SHARED"(i32* [[BAR]]), "QUAL.OMP.SHARED"(i64* [[MYALLOC]]) ]
// CHECK-NEXT:    [[TMP1:%.*]] = load i64, i64* [[MYALLOC]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.ALLOCATE"(i64 1, i8* [[FOO]], i64 [[TMP1]]), "QUAL.OMP.ALLOCATE"(i64 4, i32* [[BAR]], i64 [[TMP1]]), "QUAL.OMP.PRIVATE"(i8* [[FOO]]), "QUAL.OMP.PRIVATE"(i32* [[BAR]]), "QUAL.OMP.SHARED"(i64* [[MYALLOC]]) ]
// CHECK-NEXT:    [[TMP3:%.*]] = load i64, i64* [[MYALLOC]], align 8
// CHECK-NEXT:    [[TMP4:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.ALLOCATE"(i64 2, i8* [[FOO]], i64 [[TMP3]]), "QUAL.OMP.ALLOCATE"(i64 4, i32* [[BAR]], i64 [[TMP3]]), "QUAL.OMP.PRIVATE"(i8* [[FOO]]), "QUAL.OMP.PRIVATE"(i32* [[BAR]]) ]
// CHECK-NEXT:    [[TMP5:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.ALLOCATE"(i64 8, i8* [[FOO]], i64 7), "QUAL.OMP.ALLOCATE"(i64 8, i32* [[BAR]], i64 7), "QUAL.OMP.PRIVATE"(i8* [[FOO]]), "QUAL.OMP.PRIVATE"(i32* [[BAR]]) ]
// CHECK-NEXT:    [[TMP6:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.ALLOCATE"(i64 16, i8* [[FOO]]), "QUAL.OMP.PRIVATE"(i8* [[FOO]]) ]
...
// CHECK-NEXT:    store double [[PARAM:%.*]], double* [[PARAM_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.ALLOCATE"(i64 8, [10 x double]* [[FOO]], i64 2), "QUAL.OMP.ALLOCATE"(i64 8, double* [[PARAM_ADDR]], i64 2), "QUAL.OMP.PRIVATE"([10 x double]* [[FOO]]), "QUAL.OMP.PRIVATE"(double* [[PARAM_ADDR]]) ]
// CHECK-NEXT:    call void @llvm.directive.region.exit(token [[TMP0]]) [ "DIR.OMP.END.PARALLEL"() ]
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x double], [10 x double]* [[FOO]], i64 0, i64 0

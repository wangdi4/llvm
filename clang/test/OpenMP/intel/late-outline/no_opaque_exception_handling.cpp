// INTEL_COLLAB
//
// RUN: %clang_cc1 -no-opaque-pointers -emit-llvm -o - %s -std=c++14 -disable-llvm-passes \
...
// RUN: %clang_cc1 -no-opaque-pointers -emit-llvm -o - %s -std=c++14 -disable-llvm-passes -O2 \
// RUN:  -fexceptions -fcxx-exceptions \
// RUN:  -fopenmp -fintel-compatibility -fopenmp-late-outline \
// RUN:  -triple x86_64-unknown-linux-gnu \
...
// RUN: %clang_cc1 -no-opaque-pointers -triple x86_64-pc-linux-gnu -fopenmp \
// RUN: -fexceptions -fcxx-exceptions \
// RUN: -fopenmp-late-outline -fopenmp-targets=x86_64-pc-linux-gnu \
...
// RUN: %clang_cc1 -no-opaque-pointers -triple x86_64-pc-windows-msvc19.29.30133 -fopenmp \

...
// CHECK: %call2 = call i32 @_ZN2A1cv2B1Ev(%struct.A1* noundef  %ref.tmp
...
// CHECK: call void @_ZN2B2C1E2A2(%struct.B2* noundef %3, i64 %9, i32 %11)
// CHECK: ret void

// CHECK: define internal void @.[[I3]](%struct.B3* noalias noundef %0, %struct.B3* noalias noundef %1)
// CHECK:call void @_ZN2A3D1Ev(%struct.A3* noundef  %ref.tmp)
// CHECK-NEXT ret void
...
// CHECK-NEXT: call void @_ZN2A4D1Ev(%struct.A4* noundef  %agg.tmp)
// CHECK-NEXT: ret void

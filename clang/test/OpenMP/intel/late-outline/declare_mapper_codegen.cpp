...
///==========================================================================///
// RUN: %clang_cc1 -verify -fopenmp -fopenmp-late-outline -fopenmp-targets=powerpc64le-ibm-linux-gnu -x c++ -triple powerpc64le-unknown-unknown -emit-llvm -femit-all-decls -disable-llvm-passes %s -o - | FileCheck --check-prefix CK0 --check-prefix CK0-64 --check-prefix CK0-NO-DB %s
...
// RUN: %clang_cc1 -fopenmp -fopenmp-late-outline -fopenmp-targets=powerpc64le-ibm-linux-gnu -x c++ -triple powerpc64le-unknown-unknown -std=c++11 -femit-all-decls -disable-llvm-passes -include-pch %t -verify %s -emit-llvm -o - | FileCheck --check-prefix CK0 --check-prefix CK0-64 --check-prefix CK0-NO-DB %s
// RUN: %clang_cc1  -verify -fopenmp -fopenmp-late-outline -fopenmp-targets=i386-pc-linux-gnu -x c++ -triple i386-unknown-unknown -emit-llvm -femit-all-decls -disable-llvm-passes %s -o - | FileCheck --check-prefix CK0 --check-prefix CK0-32 --check-prefix CK0-NO-DB %s
...
// RUN: %clang_cc1  -fopenmp -fopenmp-late-outline -fopenmp-targets=i386-pc-linux-gnu -x c++ -triple i386-unknown-unknown -std=c++11 -femit-all-decls -disable-llvm-passes -include-pch %t -verify %s -emit-llvm -o - | FileCheck --check-prefix CK0 --check-prefix CK0-32 --check-prefix CK0-NO-DB %s

// RUN: %clang_cc1 -verify -debug-info-kind=limited -fopenmp -fopenmp-late-outline -fopenmp-targets=powerpc64le-ibm-linux-gnu -x c++ -triple powerpc64le-unknown-unknown -emit-llvm -femit-all-decls -disable-llvm-passes %s -o - | FileCheck --check-prefix CK0 --check-prefix CK0-64 --check-prefix CK0-DB %s
...
// RUN: %clang_cc1 -debug-info-kind=limited -fopenmp -fopenmp-late-outline -fopenmp-targets=powerpc64le-ibm-linux-gnu -x c++ -triple powerpc64le-unknown-unknown -std=c++11 -femit-all-decls -disable-llvm-passes -include-pch %t -verify %s -emit-llvm -o - | FileCheck --check-prefix CK0 --check-prefix CK0-64 --check-prefix CK0-DB %s
// RUN: %clang_cc1  -verify -debug-info-kind=limited -fopenmp -fopenmp-late-outline -fopenmp-targets=i386-pc-linux-gnu -x c++ -triple i386-unknown-unknown -emit-llvm -femit-all-decls -disable-llvm-passes %s -o - | FileCheck --check-prefix CK0 --check-prefix CK0-DB --check-prefix CK0-32  %s

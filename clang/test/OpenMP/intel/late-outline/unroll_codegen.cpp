...
// CHECK-NEXT:    [[TMP21:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(), "QUAL.OMP.COLLAPSE"(i32 2), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLLED_IV_J]]), "QUAL.OMP.NORMALIZED.IV"(ptr [[DOTOMP_IV]]), "QUAL.OMP.FIRSTPRIVATE"(ptr [[DOTOMP_LB]]), "QUAL.OMP.NORMALIZED.UB"(ptr [[DOTOMP_UB]]), "QUAL.OMP.PRIVATE"(ptr [[I]]), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLL_INNER_IV_J]]) ]
...
// CHECK-NEXT:    [[TMP11:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLLED_IV_I]]), "QUAL.OMP.NORMALIZED.IV"(ptr [[DOTOMP_IV]]), "QUAL.OMP.FIRSTPRIVATE"(ptr [[DOTOMP_LB]]), "QUAL.OMP.NORMALIZED.UB"(ptr [[DOTOMP_UB]]), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLL_INNER_IV_I]]) ]
...
// CHECK-NEXT:    [[TMP12:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLLED_IV_I]]), "QUAL.OMP.SHARED"(ptr [[START_ADDR]]), "QUAL.OMP.SHARED"(ptr [[END_ADDR]]), "QUAL.OMP.SHARED"(ptr [[STEP_ADDR]]), "QUAL.OMP.SHARED"(ptr [[DOTCAPTURE_EXPR_26]]), "QUAL.OMP.NORMALIZED.IV"(ptr [[DOTOMP_IV]]), "QUAL.OMP.FIRSTPRIVATE"(ptr [[DOTOMP_LB]]), "QUAL.OMP.NORMALIZED.UB"(ptr [[DOTOMP_UB]]), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLL_INNER_IV_I]]), "QUAL.OMP.SHARED"(ptr [[I]]), "QUAL.OMP.SHARED"(ptr [[DOTCAPTURE_EXPR_23]]), "QUAL.OMP.SHARED"(ptr [[DOTCAPTURE_EXPR_25]]) ]
...
// CHECK-NEXT:    [[TMP14:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(), "QUAL.OMP.PRIVATE"(ptr [[DOTFLOOR_0_IV__UNROLLED_IV_I]]), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLLED_IV_I]]), "QUAL.OMP.PRIVATE"(ptr [[DOTCAPTURE_EXPR_36]]), "QUAL.OMP.PRIVATE"(ptr [[DOTCAPTURE_EXPR_38]]), "QUAL.OMP.NORMALIZED.IV"(ptr [[DOTOMP_IV]]), "QUAL.OMP.FIRSTPRIVATE"(ptr [[DOTOMP_LB]]), "QUAL.OMP.NORMALIZED.UB"(ptr [[DOTOMP_UB]]), "QUAL.OMP.PRIVATE"(ptr [[DOTTILE_0_IV__UNROLLED_IV_I]]), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLL_INNER_IV_I]]), "QUAL.OMP.PRIVATE"(ptr [[I]]), "QUAL.OMP.PRIVATE"(ptr [[DOTCAPTURE_EXPR_33]]), "QUAL.OMP.PRIVATE"(ptr [[DOTCAPTURE_EXPR_35]]) ]
...
// CHECK-NEXT:    store i32 [[TMP13]], ptr [[DOTOMP_UB]], align 4
// CHECK-NEXT:    [[TMP14:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLLED_IV__UNROLLED_IV_I]]), "QUAL.OMP.NORMALIZED.IV"(ptr [[DOTOMP_IV]]), "QUAL.OMP.FIRSTPRIVATE"(ptr [[DOTOMP_LB]]), "QUAL.OMP.NORMALIZED.UB"(ptr [[DOTOMP_UB]]), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLL_INNER_IV__UNROLLED_IV_I]]), "QUAL.OMP.PRIVATE"(ptr [[DOTUNROLL_INNER_IV_I]]) ]
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, ptr [[DOTOMP_LB]], align 4
// CHECK-NEXT:    store i32 [[TMP15]], ptr [[DOTOMP_IV]], align 4
// CHECK-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK:       omp.inner.for.cond:

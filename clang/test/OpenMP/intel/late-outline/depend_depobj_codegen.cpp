...
// CHECK-NEXT:    br label [[IF_END]]
// CHECK:       if.end:
// CHECK-NEXT:    [[TMP32:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.SHARED"(ptr [[AAA]]), "QUAL.OMP.SHARED"(ptr [[BBB]]), "QUAL.OMP.SHARED"(ptr [[CCC]]), "QUAL.OMP.SHARED"(ptr [[DDD]]), "QUAL.OMP.SHARED"(ptr [[EEE]]), "QUAL.OMP.SHARED"(ptr [[OBJ1]]), "QUAL.OMP.PRIVATE"(ptr [[B]]), "QUAL.OMP.PRIVATE"(ptr [[C]]), "QUAL.OMP.PRIVATE"(ptr [[DEPOBJ_SIZE_ADDR]]), "QUAL.OMP.PRIVATE"(ptr [[SAVED_STACK]]), "QUAL.OMP.PRIVATE"(ptr [[__VLA_EXPR0]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR]]), "QUAL.OMP.PRIVATE"(ptr [[DEPOBJ_SIZE_ADDR7]]), "QUAL.OMP.PRIVATE"(ptr [[SAVED_STACK8]]), "QUAL.OMP.PRIVATE"(ptr [[__VLA_EXPR1]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR10]]), "QUAL.OMP.PRIVATE"(ptr [[DOTDEP_ARR_ADDR11]]), "QUAL.OMP.PRIVATE"(ptr [[DEP_COUNTER_ADDR17]]) ]

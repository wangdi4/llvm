...
//CHECK: @0 = private unnamed_addr constant {{.*}}error_codegen.cpp;main;54;1;;\00", align 1
...
//CHECK: @2 = private unnamed_addr constant {{.*}}error_codegen.cpp;main;56;1;;\00", align 1
...
//CHECK: @4 = private unnamed_addr constant {{.*}}error_codegen.cpp;tmain;31;1;;\00", align 1
...
//CHECK: @6 = private unnamed_addr constant {{.*}}error_codegen.cpp;tmain;34;1;;\00", align 1
//CHECK: @7 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 {{.*}}, ptr @6 }, align 8
//CHECK: @8 = private unnamed_addr constant {{.*}}error_codegen.cpp;tmain;40;1;;\00", align 1
...
// SIMD:    call void @__kmpc_error(ptr @1, i32 2, ptr @.str)
// CHECK:    call void @__kmpc_error(ptr @3, i32 1, ptr @.str.1)
// SIMD:    call void @__kmpc_error(ptr @3, i32 1, ptr @.str.1)
//
...
//SIMD: call void @__kmpc_error(ptr @5, i32 2, ptr @.str.2)
//SIMD: call void @__kmpc_error(ptr @7, i32 1, ptr @.str.3)
//SIMD: call void @__kmpc_error(ptr @9, i32 2, ptr @.str)
//CHECK: ret i32 10

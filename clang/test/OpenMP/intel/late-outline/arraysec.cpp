...
//CHECK-SAME: i64 add (i64 sdiv exact (i64 sub (i64 ptrtoint (ptr getelementptr inbounds (i32, ptr getelementptr inbounds ([3 x [4 x [5 x i32]]], ptr {{.*}}y_Array, i64 0, i64 1, i64 3), i64 4) to i64), i64 ptrtoint (ptr getelementptr inbounds ([3 x [4 x [5 x i32]]], ptr {{.*}}y_Array, i64 0, i64 1) to i64)), i64 4), i64 1),
//CHECK-SAME: i64 sdiv exact (i64 sub (i64 ptrtoint (ptr getelementptr inbounds ([3 x [4 x [5 x i32]]], ptr {{.*}}y_Array, i64 0, i64 1) to i64), i64 ptrtoint (ptr {{.*}}y_Array to i64)), i64 4)),
...
//CHECK-SAME: i64 sdiv exact (i64 sub (i64 ptrtoint (ptr getelementptr inbounds ([4 x i32], ptr{{.*}}y_Sub, i64 0, i64 1) to i64), i64 ptrtoint (ptr {{.*}}y_Sub to i64)), i64 4)
...
//CHECK-SAME: i64 sdiv exact (i64 sub (i64 ptrtoint (ptr getelementptr inbounds ([4 x [8 x i32]], ptr {{.*}}y_TwoSub, i64 0, i64 2, i64 4) to i64), i64 ptrtoint (ptr {{.*}}y_TwoSub to i64)), i64 4)

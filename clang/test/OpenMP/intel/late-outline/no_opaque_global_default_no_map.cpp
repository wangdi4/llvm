...
//CHECK-SAME: "QUAL.OMP.LIVEIN"(i32* [[GLOBSIX]])
//CHECK-SAME: "QUAL.OMP.PRIVATE"(i32* [[CE1]])
//CHECK-SAME: "QUAL.OMP.PRIVATE"(i32* [[IV]])
//CHECK-SAME: "QUAL.OMP.PRIVATE"(i32* [[LB]])
//CHECK-SAME: "QUAL.OMP.PRIVATE"(i32* [[UB]])
//CHECK: "DIR.OMP.PARALLEL.LOOP"
//CHECK: "DIR.OMP.END.PARALLEL.LOOP"
//CHECK: "DIR.OMP.END.TARGET"
//FPRIVATE: "DIR.OMP.TARGET"
//FPRIVATE-SAME: "QUAL.OMP.FIRSTPRIVATE"(i32* [[GLOBSIX]])
//FPRIVATE-SAME: "QUAL.OMP.PRIVATE"(i32* [[CE1]])
//FPRIVATE-SAME: "QUAL.OMP.PRIVATE"(i32* [[IV]])
//FPRIVATE-SAME: "QUAL.OMP.PRIVATE"(i32* [[LB]])
//FPRIVATE-SAME: "QUAL.OMP.PRIVATE"(i32* [[UB]])
//FPRIVATE: "DIR.OMP.PARALLEL.LOOP"
//FPRIVATE: "DIR.OMP.END.PARALLEL.LOOP"
//FPRIVATE-CHECK: "DIR.OMP.TARGET"
//FPRIVATE-CHECK-SAME: "QUAL.OMP.LIVEIN"(i32* [[GLOBSIX]])
//FPRIVATE-CHECK-SAME: "QUAL.OMP.PRIVATE"(i32* [[IV]])
//FPRIVATE-CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(i32* [[LB]])
//FPRIVATE-CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(i32* [[UB]])
//FPRIVATE-CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE"(i32* [[CE]])

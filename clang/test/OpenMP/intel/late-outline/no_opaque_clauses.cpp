...
// RUN: %clang_cc1 -no-opaque-pointers -disable-llvm-passes -emit-llvm -o - \
...
void bar7(float *A, int N, int S)
{
  ...
  //CHECK: [[TMP63:%.*]] = load i32, i32* [[N_ADDR:%N.addr]]
  //CHECK-NEXT: store i32 [[TMP63]], i32* [[DOTCAPTURE_EXPR_22:%.capture_expr.22]]
  //CHECK-NEXT:    [[TMP64:%.*]] = load i32, i32* [[S_ADDR:%S.addr]], align 4
  //CHECK-NEXT:    store i32 [[TMP64]], i32* [[DOTNEW_STEP23:%.new_step23]], align 4
  //CHECK-NEXT:    [[TMP65:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_22]], align 4
  //CHECK-NEXT:    [[TMP66:%.*]] = load i32, i32* [[DOTNEW_STEP23]], align 4
  //CHECK-NEXT:    [[SUB98:%.*]] = sub nsw i32 0, [[TMP66]]
  //CHECK-NEXT:    [[ADD99:%.*]] = add nsw i32 [[SUB98]], 1
  //CHECK-NEXT:    [[SUB100:%.*]] = sub nsw i32 [[TMP65]], [[ADD99]]
  //CHECK-NEXT:    [[TMP67:%.*]] = load i32, i32* [[DOTNEW_STEP23]], align 4
  //CHECK-NEXT:    [[DIV101:%.*]] = sdiv i32 [[SUB100]], [[TMP67]]
  //CHECK-NEXT:    [[SUB102:%.*]] = sub nsw i32 [[DIV101]], 1
  //CHECK-NEXT:    store i32 [[SUB102]], i32* [[DOTCAPTURE_EXPR_24:%.capture_expr.24]], align 4
  ...
  //CHECK-NEXT:    [[TMP69:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_24]], align 4
  //CHECK-NEXT:    store i32 [[TMP69]], i32* [[DOTOMP_UB106:%.*]], align 4
  //CHECK-NEXT:    [[TMP70:%.*]] = load i32, i32* [[DOTNEW_STEP23]], align 4
  // non-constant step
  //CHECK: "DIR.OMP.SIMD"
  //CHECK-SAME: "QUAL.OMP.LINEAR:IV"(i32* [[I]], i32 [[TMP70]])
  //CHECK: call void {{.*}}call_bar7
  //CHECK: load i32, i32* [[DOTOMP_IV105:%.*]], align 4
  //CHECK-NEXT: add nsw i32 {{.*}}1{{$}}
  //CHECK-NEXT: store i32 {{.*}}[[DOTOMP_IV105]]
  //CHECK-NEXT: [[L1:%[0-9]+]] = load i32, i32* [[I]]
  //CHECK-NEXT: [[L2:%[0-9]+]] = load i32, i32* [[DOTNEW_STEP23]]

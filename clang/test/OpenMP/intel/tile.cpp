...
// RUN: %clang_cc1 -verify -triple x86_64-pc-linux-gnu -fopenmp -fopenmp-version=51 \
...
// CHECK-NEXT:    store i32 [[TMP1]], i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK-NEXT:    [[TMP2:%.*]] = load i32, i32* [[STEP_ADDR]], align 4
// CHECK-NEXT:    store i32 [[TMP2]], i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_0]], align 4
// CHECK-NEXT:    [[SUB:%.*]] = sub i32 [[TMP3]], [[TMP4]]
// CHECK-NEXT:    [[SUB1:%.*]] = sub i32 [[SUB]], 1
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK-NEXT:    [[ADD:%.*]] = add i32 [[SUB1]], [[TMP5]]
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK-NEXT:    [[DIV:%.*]] = udiv i32 [[ADD]], [[TMP6]]
// CHECK-NEXT:    [[SUB2:%.*]] = sub i32 [[DIV]], 1
// CHECK-NEXT:    store i32 [[SUB2]], i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK-NEXT:    store i32 0, i32* [[DOTFLOOR_0_IV_I]], align 4
// CHECK-NEXT:    br label [[FOR_COND:%.*]]
// CHECK:       for.cond:
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, i32* [[DOTFLOOR_0_IV_I]], align 4
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK-NEXT:    [[ADD3:%.*]] = add i32 [[TMP8]], 1
// CHECK-NEXT:    [[CMP:%.*]] = icmp ult i32 [[TMP7]], [[ADD3]]
// CHECK-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END15:%.*]]
// CHECK:       for.body:
// CHECK-NEXT:    [[TMP9:%.*]] = load i32, i32* [[DOTFLOOR_0_IV_I]], align 4
// CHECK-NEXT:    store i32 [[TMP9]], i32* [[DOTTILE_0_IV_I]], align 4
// CHECK-NEXT:    br label [[FOR_COND4:%.*]]
// CHECK:       for.cond4:
// CHECK-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTTILE_0_IV_I]], align 4
// CHECK-NEXT:    [[TMP11:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK-NEXT:    [[ADD5:%.*]] = add i32 [[TMP11]], 1
// CHECK-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTFLOOR_0_IV_I]], align 4
...
// CHECK:       cond.true:
// CHECK-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_3]], align 4
// CHECK-NEXT:    [[ADD8:%.*]] = add i32 [[TMP13]], 1
// CHECK-NEXT:    br label [[COND_END:%.*]]
// CHECK:       cond.false:
// CHECK-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTFLOOR_0_IV_I]], align 4
...
// CHECK:       for.body11:
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_0]], align 4
// CHECK-NEXT:    [[TMP16:%.*]] = load i32, i32* [[DOTTILE_0_IV_I]], align 4
// CHECK-NEXT:    [[TMP17:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
...
// CHECK:       for.inc13:
// CHECK-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTFLOOR_0_IV_I]], align 4
// CHECK-NEXT:    [[ADD14:%.*]] = add nsw i32 [[TMP20]], 5
// CHECK-NEXT:    store i32 [[ADD14]], i32* [[DOTFLOOR_0_IV_I]], align 4
...
// CHECK-NEXT:    store i32 [[ADD9]], i32* [[I]], align 4
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, i32* [[DOTFLOOR_1_IV_J]], align 4
// CHECK-NEXT:    store i32 [[TMP7]], i32* [[DOTTILE_1_IV_J]], align 4
// CHECK-NEXT:    br label [[FOR_COND10:%.*]]
// CHECK:       for.cond10:
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, i32* [[DOTTILE_1_IV_J]], align 4
...
// CHECK:       cond.false14:
// CHECK-NEXT:    [[TMP10:%.*]] = load i32, i32* [[DOTFLOOR_1_IV_J]], align 4
...
// CHECK:       for.body19:
// CHECK-NEXT:    [[TMP11:%.*]] = load i32, i32* [[DOTTILE_1_IV_J]], align 4
...
// CHECK:       for.inc23:
// CHECK-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTTILE_0_IV_I]], align 4
// CHECK-NEXT:    [[INC24:%.*]] = add nsw i32 [[TMP15]], 1
// CHECK-NEXT:    store i32 [[INC24]], i32* [[DOTTILE_0_IV_I]], align 4
...
// CHECK-NEXT:    store i32 [[ADD27]], i32* [[DOTFLOOR_1_IV_J]], align 4
// CHECK-NEXT:    br label [[FOR_COND1]], !llvm.loop [[LOOP8:![0-9]+]]
// CHECK:       for.end28:
// CHECK-NEXT:    br label [[FOR_INC29:%.*]]
// CHECK:       for.inc29:
// CHECK-NEXT:    [[TMP17:%.*]] = load i32, i32* [[DOTFLOOR_0_IV_I]], align 4
// CHECK-NEXT:    [[ADD30:%.*]] = add nsw i32 [[TMP17]], 4
// CHECK-NEXT:    store i32 [[ADD30]], i32* [[DOTFLOOR_0_IV_I]], align 4
...
// CHECK-NEXT:    store i32 1, i32* [[DOTOMP_UB]], align 4
// CHECK-NEXT:    [[TMP0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.PRIVATE"(i32* [[DOTFLOOR_0_IV_I]]), "QUAL.OMP.PRIVATE"(i32* [[DOTFLOOR_1_IV_J]]), "QUAL.OMP.NORMALIZED.IV"(i32* [[DOTOMP_IV]]), "QUAL.OMP.FIRSTPRIVATE"(i32* [[DOTOMP_LB]]), "QUAL.OMP.NORMALIZED.UB"(i32* [[DOTOMP_UB]]), "QUAL.OMP.PRIVATE"(i32* [[DOTTILE_0_IV_I]]), "QUAL.OMP.PRIVATE"(i32* [[I]]), "QUAL.OMP.PRIVATE"(i32* [[DOTTILE_1_IV_J]]), "QUAL.OMP.PRIVATE"(i32* [[J]]) ]
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, i32* [[DOTOMP_LB]], align 4
// CHECK-NEXT:    store i32 [[TMP1]], i32* [[DOTOMP_IV]], align 4
...
// CHECK-NEXT:    store i32 [[ADD]], i32* [[DOTFLOOR_0_IV_I]], align 4
// CHECK-NEXT:    store i32 0, i32* [[DOTFLOOR_1_IV_J]], align 4
// CHECK-NEXT:    br label [[FOR_COND:%.*]]
// CHECK:       for.cond:
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, i32* [[DOTFLOOR_1_IV_J]], align 4
// CHECK-NEXT:    [[CMP1:%.*]] = icmp slt i32 [[TMP5]], 4
// CHECK-NEXT:    br i1 [[CMP1]], label [[FOR_BODY:%.*]], label [[FOR_END28:%.*]]
// CHECK:       for.body:
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, i32* [[DOTFLOOR_0_IV_I]], align 4
// CHECK-NEXT:    store i32 [[TMP6]], i32* [[DOTTILE_0_IV_I]], align 4
// CHECK-NEXT:    br label [[FOR_COND2:%.*]]
// CHECK:       for.cond2:
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, i32* [[DOTTILE_0_IV_I]], align 4
// CHECK-NEXT:    [[TMP8:%.*]] = load i32, i32* [[DOTFLOOR_0_IV_I]], align 4
...
// CHECK-NEXT:    store i32 [[ADD9]], i32* [[I]], align 4
// CHECK-NEXT:    [[TMP11:%.*]] = load i32, i32* [[DOTFLOOR_1_IV_J]], align 4
// CHECK-NEXT:    store i32 [[TMP11]], i32* [[DOTTILE_1_IV_J]], align 4
// CHECK-NEXT:    br label [[FOR_COND10:%.*]]
// CHECK:       for.cond10:
// CHECK-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTTILE_1_IV_J]], align 4
// CHECK-NEXT:    [[TMP13:%.*]] = load i32, i32* [[DOTFLOOR_1_IV_J]], align 4
...
// CHECK-NEXT:    br label [[FOR_INC26:%.*]]
// CHECK:       for.inc26:
// CHECK-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTFLOOR_1_IV_J]], align 4
...
// CHECK-NEXT:    [[TMP21:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK-NEXT:    [[ADD29:%.*]] = add nsw i32 [[TMP21]], 1
// CHECK-NEXT:    store i32 [[ADD29]], i32* [[DOTOMP_IV]], align 4
// CHECK-NEXT:    br label [[OMP_INNER_FOR_COND]]

...
// RUN: %clang_cc1 -emit-llvm -o - -fopenmp -fintel-compatibility -fopenmp-late-outline -fopenmp-threadprivate-legacy -triple x86_64-unknown-linux-gnu %s| FileCheck %s -check-prefix CHECK-TPL

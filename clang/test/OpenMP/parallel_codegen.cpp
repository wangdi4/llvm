...
// INTEL CHECK4-NEXT:    call void @llvm.dbg.value(metadata ptr %loadgep_vla, metadata [[DBG35:![0-9]+]], metadata !DIExpression(DW_OP_deref)), !dbg [[DBG36:![0-9]+]]
...
// INTEL CHECK4-NEXT:    call void @llvm.dbg.value(metadata ptr %loadgep_argc.addr, metadata [[DBG60:![0-9]+]], metadata !DIExpression(DW_OP_deref)), !dbg [[DBG61:![0-9]+]]
// CHECK4-NEXT:    [[TID_ADDR_LOCAL:%.*]] = alloca i32, align 4
// CHECK4-NEXT:    [[TMP1:%.*]] = load i32, ptr [[TID_ADDR]], align 4
// CHECK4-NEXT:    store i32 [[TMP1]], ptr [[TID_ADDR_LOCAL]], align 4
// CHECK4-NEXT:    [[TID:%.*]] = load i32, ptr [[TID_ADDR_LOCAL]], align 4

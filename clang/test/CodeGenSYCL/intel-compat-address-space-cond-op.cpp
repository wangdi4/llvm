...
// RUN: %clang_cc1 -fintel-compatibility -x c++ -triple spir64-unknown-linux -disable-llvm-passes -fsycl-is-device -emit-llvm %s -o - | FileCheck %s

// This test is cloned from the test address-space-cond-op.cpp, and uses the -fintel-compatibility flag in addition.
...
// INTEL_CUSTOMIZATION
// CHECK-NEXT:    [[RHS_IND_ADDR:%.*]] = alloca ptr addrspace(4), align 8
...
// INTEL_CUSTOMIZATION
// CHECK-NEXT:    [[RHS_IND_ADDR_ASCAST:%.*]] = addrspacecast ptr [[RHS_IND_ADDR]] to ptr addrspace(4)
// end INTEL_CUSTOMIZATION
...
// INTEL_CUSTOMIZATION
// CHECK-NEXT:    store ptr addrspace(4) [[RHS_IND_ADDR:%.*]], ptr addrspace(4) [[RHS_IND_ADDR_ASCAST]], align 8
// end INTEL_CUSTOMIZATION

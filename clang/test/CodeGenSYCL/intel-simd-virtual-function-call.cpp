...
//CHECK: define linkonce_odr spir_func noundef i32 @_ZN1B3fooEi(%class.B addrspace(4)* noundef align 8 dereferenceable_or_null(8) %this, i32  noundef %X) unnamed_addr #[[ATT4:[0-9]+]]
//CHECK: define dso_local spir_func noundef i32 @_ZN1A3fooEi(%class.A addrspace(4)* noundef align 8 dereferenceable_or_null(8) %this, i32 noundef %X) unnamed_addr #[[ATT5:[0-9]+]]
void test()
{
  B bA;
  A* a = &bA;

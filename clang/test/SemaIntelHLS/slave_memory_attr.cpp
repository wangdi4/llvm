...
// expected-error@+3{{attribute only applies to slave memory arguments, non-static field members, local variables and static variables}}
__attribute__((ihc_component))
void bar0a(
...
// expected-error@+4{{attribute only applies to slave memory arguments, non-static field members, local variables and static variables}}
// expected-error@+3{{attribute only applies to slave memory arguments, non-static field members, local variables and static variables}}
__attribute__((ihc_component))
void bar6a(
...
// expected-error@+5{{attribute only applies to slave memory arguments, non-static field members, local variables and static variables}}
// expected-error@+5{{attribute only applies to slave memory arguments, non-static field members, local variables and static variables}}
// expected-error@+5{{attribute only applies to slave memory arguments, non-static field members, local variables and static variables}}
__attribute__((ihc_component))
void bar11(

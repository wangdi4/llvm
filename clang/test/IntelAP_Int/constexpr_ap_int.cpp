...
// RUN: %clang -cc1 -O3 -disable-llvm-passes -triple spir64-unknown-windows-sycldevice -fsycl -fsycl-is-device -std=c++17 %s -emit-llvm -o - | FileCheck %s
...
// RUN: %clang -cc1 -O3 -disable-llvm-passes -triple spir64-unknown-linux-sycldevice -fsycl -fsycl-is-device -std=c++17 %s -emit-llvm -o - | FileCheck %s

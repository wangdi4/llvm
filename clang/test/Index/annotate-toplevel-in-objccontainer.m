...
// INTEL RUN: c-index-test -test-annotate-tokens=%s:5:1:7:1 %s -include-pch %t.h.pch \
...
// INTEL RUN: c-index-test -test-annotate-tokens=%s:14:1:16:1 %s -include-pch %t.h.pch \
...
// INTEL RUN: c-index-test -test-annotate-tokens=%s.h:7:1:9:1 %s -include-pch %t.h.pch \

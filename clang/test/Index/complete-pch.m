...
// INTEL RUN: c-index-test -code-completion-at=%s:10:7 -include-pch %t.h.pch %s | FileCheck -check-prefix=CHECK-CC1 %s
...
// INTEL RUN: c-index-test -code-completion-at=%s:11:6 -include-pch %t.h.pch %s | FileCheck -check-prefix=CHECK-CC2 %s

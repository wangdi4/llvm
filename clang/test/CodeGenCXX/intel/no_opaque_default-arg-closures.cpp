// RUN: %clang_cc1 -triple x86_64-windows-msvc -fms-extensions -fintel-compatibility -fintel-compatibility-enable=InstantiateDefaultArgs -emit-llvm -no-opaque-pointers -o - %s | FileCheck %s

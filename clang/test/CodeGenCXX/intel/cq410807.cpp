...
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 {{%.*}}, i8* align 8 bitcast (%"struct.cq410807::A::B"* @__const._ZN8cq4108071A1gEv.b to i8*), i64 16, i1 false)
    B b2 = {&A::f};
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 {{%.*}}, i8* align 8 bitcast (%"struct.cq410807::A::B"* @__const._ZN8cq4108071A1gEv.b2 to i8*), i64 16, i1 false)
    B b3 = {(TAmtd)f}; // expected-warning {{must explicitly qualify name of member function when taking its address}}
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 {{%.*}}, i8* align 8 bitcast (%"struct.cq410807::A::B"* @__const._ZN8cq4108071A1gEv.b3 to i8*), i64 16, i1 false)
  }
};

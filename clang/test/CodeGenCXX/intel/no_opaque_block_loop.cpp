// RUN: %clang_cc1 -fintel-compatibility -emit-llvm -no-opaque-pointers -o - %s | FileCheck %s -check-prefix=CHECK-REGION
// RUN: %clang_cc1 -fintel-compatibility -emit-llvm -no-opaque-pointers -triple i686-windows -o - %s | FileCheck %s -check-prefix=CHECK-REGION
// RUN: %clang_cc1 -fintel-compatibility -emit-llvm -no-opaque-pointers -triple x86_64-windows-msvc -o - %s | FileCheck %s -check-prefix=CHECK-REGION
// RUN: %clang_cc1 -fintel-compatibility -emit-llvm -no-opaque-pointers -triple i686-unknown-windows-msvc -o - %s | FileCheck %s -check-prefix=CHECK-REGION
// RUN: %clang_cc1 -fintel-compatibility-enable=PragmaBlockLoop -fintel-compatibility-enable=PragmaBlockLoop -emit-llvm -no-opaque-pointers -o - %s | FileCheck %s -check-prefix=CHECK-REGION

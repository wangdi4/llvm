...
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr null)
...
// CHECK: DIR.PRAGMA.PREFETCH_LOOP
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 0)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %foo1.addr)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %foo2.addr)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK: "DIR.PRAGMA.END.PREFETCH_LOOP"
...
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %foo3.addr)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK: "DIR.PRAGMA.END.PREFETCH_LOOP"
...
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 0)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %foo4.addr)
// CHECK: "DIR.PRAGMA.END.PREFETCH_LOOP"
...
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %foo5)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %foo6)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %foo1.addr)
...
// CHECK: DIR.PRAGMA.PREFETCH_LOOP
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %j)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 10)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %k)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 2)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 99)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %arrayidx)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr %bar3)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK: "DIR.PRAGMA.END.PREFETCH_LOOP"
  int index = 1;
...
#pragma prefetch bar1.j:1:10, bar2.k:2:99, foo1[index], bar3
  ...
  int *ptr = &p;
  int **pptr = &ptr;
// CHECK: [[LD1:%[0-9]*]] = load ptr, ptr %pptr, align 8
// CHECK-NEXT: [[LD2:%[0-9]*]] = load ptr, ptr %pptr, align 8
// CHECK-NEXT: [[LD3:%[0-9]*]] = load ptr, ptr %pptr, align 8
//
// CHECK: DIR.PRAGMA.PREFETCH_LOOP
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 0)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr [[LD1]])
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr [[LD2]])
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr [[LD3]])
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 2)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 10)
...
// CHECK: DIR.PRAGMA.PREFETCH_LOOP
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr @_Z{{[A-Z,a-z,0-9]+}})
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr @_Z{{[A-Z,a-z,0-9]+}})
...
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.ENABLE"(i32 1)
// CHECK-SAME: "QUAL.PRAGMA.VAR"(ptr @_ZN1B1jE)
// CHECK-SAME: "QUAL.PRAGMA.HINT"(i32 -1)
// CHECK-SAME: "QUAL.PRAGMA.DISTANCE"(i32 -1)
// CHECK: DIR.PRAGMA.END.PREFETCH_LOOP
#pragma prefetch A::i

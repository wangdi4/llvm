// RUN: %clang_cc1 -std=c++11 -fintel-ms-compatibility -triple x86_64-pc-win32 -O0 -fexceptions -fcxx-exceptions %s -emit-llvm -o - | FileCheck --check-prefix=CHECK_INTEL %s

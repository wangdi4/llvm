...
void test_throw() {
  ...
  // CHECK_INVOKE: define void @{{.*}}spawn_helper_invoke{{.*}}test_throw
...
void test_nothrow() {
  ...
  // CHECK_INVOKE: define void @{{.*}}spawn_helper_invoke{{.*}}test_nothrow
...
void test_nothrow_spec() {
  ...
  // CHECK_INVOKE: define {{.*}}@{{.*}}spawn_helper_invoke{{.*}}test_nothrow_spec
  // CHECK_INVOKE: call {{.*}}__cilk_spawn_helper
  // CHECK_INVOKE: ret void
}
...
void test_nothrow_attr() {
  ...
  // CHECK_INVOKE: define {{.*}}@{{.*}}spawn_helper_invoke{{.*}}test_nothrow_attr
  // CHECK_INVOKE: call {{.*}}__cilk_spawn_helper
  // CHECK_INVOKE: ret void
}

// debug-info-thunk-flag.cpp
//
// Validate we emit a "DIFlagThunk" flag on DISubprogram entries for thunks.
// This flag is used for emitting S_THUNK32 symbols in the debug information.
//
// NOTE:
...
//
// NOTE:
// The FileCheck directives below use CHECK-DAG because the thunks are not
// typically emitted in source order.
//
//
// RUN: %clang_cc1 %s -triple=x86_64-pc-windows-msvc -emit-llvm -debug-info-kind=limited -o %t
// RUN: FileCheck %s < %t
//

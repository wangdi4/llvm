...
__kernel void k1(read_only pipe int p1) {
  // expected-warning@+1{{implicit declaration of function 'get_pipe_num_packets' is invalid in OpenCL}}
  uint num_packets = get_pipe_num_packets(p1);
  // expected-warning@+1{{implicit declaration of function 'get_pipe_max_packets' is invalid in OpenCL}}
  uint max_packets = get_pipe_max_packets(p1);
}

__kernel void k2(read_only pipe int p1, write_only pipe int p2) {
  // expected-warning@+1{{implicit declaration of function 'reserve_read_pipe' is invalid in OpenCL}}
  reserve_id_t r1 = reserve_read_pipe(p1, 10);
  // expected-warning@+1{{implicit declaration of function 'reserve_write_pipe' is invalid in OpenCL}}
  reserve_id_t r2 = reserve_write_pipe(p2, 10);

  int data = 10;
  // expected-warning@+1{{implicit declaration of function 'is_valid_reserve_id' is invalid in OpenCL}}
  ...
  // expected-warning@+1{{implicit declaration of function 'commit_read_pipe' is invalid in OpenCL}}
  commit_read_pipe(p1, r1);
  // expected-warning@+1{{implicit declaration of function 'commit_write_pipe' is invalid in OpenCL}}
  commit_write_pipe(p2, r2);
}

__kernel void k3(read_only pipe int p1, write_only pipe int p2) {
  // expected-warning@+1{{implicit declaration of function 'work_group_reserve_read_pipe' is invalid in OpenCL}}
  reserve_id_t r1 = work_group_reserve_read_pipe(p1, 10);
  // expected-warning@+1{{implicit declaration of function 'work_group_reserve_write_pipe' is invalid in OpenCL}}
  reserve_id_t r2 = work_group_reserve_write_pipe(p2, 10);

  // expected-warning@+1{{implicit declaration of function 'work_group_commit_read_pipe' is invalid in OpenCL}}
  work_group_commit_read_pipe(p1, r1);
  // expected-warning@+1{{implicit declaration of function 'work_group_commit_write_pipe' is invalid in OpenCL}}

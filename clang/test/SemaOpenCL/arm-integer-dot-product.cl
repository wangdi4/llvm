...
void test_negative() {
    ...
    // expected-note@opencl-c-common.h:* {{candidate function not viable}}
    // expected-note@opencl-c-common.h:* {{candidate unavailable as it requires OpenCL extension 'cl_arm_integer_dot_product_int8' to be enabled}}
    ...
    // expected-note@opencl-c-common.h:* {{candidate function not viable}}
    // expected-note@opencl-c-common.h:* {{candidate function not viable}}
    // expected-note@opencl-c-common.h:* {{candidate unavailable as it requires OpenCL extension 'cl_arm_integer_dot_product_accumulate_int8' to be enabled}}
    ...
    // expected-note@opencl-c-common.h:* {{candidate function not viable}}
    // expected-note@opencl-c-common.h:* {{candidate function not viable}}
    // expected-note@opencl-c-common.h:* {{candidate unavailable as it requires OpenCL extension 'cl_arm_integer_dot_product_accumulate_int16' to be enabled}}
    ...
    // expected-note@opencl-c-common.h:* {{candidate function not viable}}
    // expected-note@opencl-c-common.h:* {{candidate unavailable as it requires OpenCL extension 'cl_arm_integer_dot_product_accumulate_saturate_int8' to be enabled}}

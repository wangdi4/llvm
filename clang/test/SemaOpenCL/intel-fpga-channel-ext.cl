...
channel int rgb;    // expected-error{{use of type 'channel int' requires cl_intel_channels extension to be enabled}}
channel int arr[5]; // expected-error{{use of type 'channel int [5]' requires cl_intel_channels extension to be enabled}}
channel int rgba  __attribute__((depth(3)));   // expected-error{{use of type 'channel int' requires cl_intel_channels extension to be enabled}}

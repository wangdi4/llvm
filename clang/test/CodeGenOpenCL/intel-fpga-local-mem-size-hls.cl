...
// SPIR: define spir_kernel void @foo2(i32 addrspace(3)* nocapture %ip) local_unnamed_addr #0 !local_mem_size ![[LMS64:[0-9]+]]
// X86: define spir_kernel void @foo2(i32* nocapture %ip) local_unnamed_addr #0 !local_mem_size ![[LMS64:[0-9]+]]
__kernel void foo2(__local __attribute__((local_mem_size(64))) int ip[]) {}

// SPIR: define spir_kernel void @foo3(i32 addrspace(3)* nocapture %ip) local_unnamed_addr #0 !local_mem_size ![[LMS128:[0-9]+]]
// X86: define spir_kernel void @foo3(i32* nocapture %ip) local_unnamed_addr #0 !local_mem_size ![[LMS128:[0-9]+]]

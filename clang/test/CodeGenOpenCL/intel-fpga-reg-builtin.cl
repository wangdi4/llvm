...
// CHECK: call void @llvm.memcpy.p0i8.p2i8.i32(i8* %[[IBC1]], i8 addrspace(2)* bitcast (%struct.st addrspace(2)* @foo.i to i8 addrspace(2)*)
// CHECK: %[[ATBC:[0-9]+]] = bitcast %struct.st* %agg-temp to i8*
// CHECK: %[[IBC2:[0-9]+]] = bitcast %struct.st* %i to i8*
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* %[[ATBC]], i8* %[[IBC2]], i32 8, i32 4, i1 false)
...
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* %[[AT3BC]], i8* %[[IIBC]], i32 8, i32 4, i1 false)
...
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* %[[IIIBC]], i8* %[[TMP2BC]], i32 8, i32 4, i1 false)
...
// CHECK: call void @llvm.memcpy.p0i8.p2i8.i32(i8* %[[U1INIT]], i8 addrspace(2)* bitcast (%union.un addrspace(2)* @foo.u1 to i8 addrspace(2)*)
  union un u2, *u3;
  u2 = __builtin_fpga_reg(u1);
// CHECK: %[[U1TMP:[0-9]+]] = bitcast %union.un* %agg-temp5 to i8*
// CHECK: %[[U1BC:[0-9]+]] = bitcast %union.un* %u1 to i8*
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* %[[U1TMP]], i8* %[[U1BC]], i32 4, i32 4, i1 false)
// CHECK: call void @llvm.fpga.reg.struct.p0s_union.uns(%union.un* %tmp4, %union.un* %agg-temp5)
// CHECK: %[[U2BC:[0-9]+]] = bitcast %union.un* %u2 to i8*
// CHECK: %[[RETBC:[0-9]+]] = bitcast %union.un* %tmp4 to i8*
// CHECK: call void @llvm.memcpy.p0i8.p0i8.i32(i8* %[[U2BC]], i8* %[[RETBC]], i32 4, i32 4, i1 false)

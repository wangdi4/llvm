...
// RUN: %clang_cc1 -x cl -cl-std=CL2.0 -triple x86_64-unknown-windows-pc -emit-llvm -no-opaque-pointers -fopencl-force-vector-abi %s -o - | FileCheck %s --check-prefix CHECKWIN

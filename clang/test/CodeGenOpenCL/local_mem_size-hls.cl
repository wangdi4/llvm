...
// SPIR: define spir_func void @foo(i32 addrspace(3)* nocapture %ip) local_unnamed_addr #0 !local_mem_size ![[LMS:[0-9]+]]
// X86: define void @foo(i32* nocapture %ip) local_unnamed_addr #0 !local_mem_size ![[LMS:[0-9]+]]

//RUN: %clang_cc1 -triple spir64-unknown-unknown-intelfpga -O0 -cl-std=CL2.0 -emit-llvm -no-opaque-pointers -o - %s | FileCheck --check-prefixes=CHECK,SPIR %s
//RUN: %clang_cc1 -triple spir64-unknown-unknown-intelfpga -O0 -cl-std=CL1.2 -emit-llvm -no-opaque-pointers -o - %s | FileCheck --check-prefixes=CHECK,BOTH %s
//RUN: %clang_cc1 -triple x86_64-unknown-unknown-intelfpga -O0 -cl-std=CL2.0 -emit-llvm -no-opaque-pointers -o - %s | FileCheck --check-prefixes=CHECK,BOTH %s
//RUN: %clang_cc1 -triple x86_64-unknown-unknown-intelfpga -O0 -cl-std=CL1.2 -emit-llvm -no-opaque-pointers -o - %s | FileCheck --check-prefixes=CHECK,BOTH %s

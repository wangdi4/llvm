...
// RUN: %clang_cc1 -x cl -cl-std=CL2.0 -triple spir64-unknown-unknown-intelfpga -emit-llvm %s -o - | FileCheck %s --check-prefix CHECKSPIR64
// RUN: %clang_cc1 -x cl -triple spir-unknown-unknown-intelfpga -emit-llvm %s -o - | FileCheck %s --check-prefix CHECK32
// RUN: %clang_cc1 -x cl -triple spir64-unknown-unknown-intelfpga -emit-llvm %s -o - | FileCheck %s --check-prefix CHECKSPIR64
...
// CHECK32:     call spir_func i32 @get_compute_id(i32 0)
// CHECKSPIR64: call spir_func i64 @get_compute_id(i32 0)
// CHECK64:     call i64 @get_compute_id(i32 0)
}

// CHECK32:     declare spir_func i32 @get_compute_id(i32)
// CHECKSPIR64: declare spir_func i64 @get_compute_id(i32)

...
// RUN: %clang_cc1 -x cl -cl-std=CL2.0 -triple x86_64-pc-windows-intelfpga -emit-llvm -fopencl-force-vector-abi %s -o - | FileCheck %s --check-prefix CHECKWIN
...
// CHECKWIN: declare dso_local void @"?write_channel_intel@@$$J0YAXU?$ocl_channel@J@__clang@@J@Z"(%opencl.channel_t*, i64)
// CHECKWIN: declare dso_local void @"?write_channel_intel@@$$J0YAXU?$ocl_channel@Ust@@@__clang@@Ust@@@Z"(%opencl.channel_t*, %struct.st*)
// CHECKWIN: declare dso_local void @"?write_channel_intel@@$$J0YAXU?$ocl_channel@T?$__vector@M$03@__clang@@@__clang@@T?$__vector@M$03@2@@Z"(%opencl.channel_t*, <4 x float>)
//
...
// CHECKWIN: declare dso_local zeroext i1 @"?write_channel_nb_intel@@$$J0YA_NU?$ocl_channel@J@__clang@@J@Z"(%opencl.channel_t*, i64)
// CHECKWIN: declare dso_local zeroext i1 @"?write_channel_nb_intel@@$$J0YA_NU?$ocl_channel@Ust@@@__clang@@Ust@@@Z"(%opencl.channel_t*, %struct.st*)
// CHECKWIN: declare dso_local zeroext i1 @"?write_channel_nb_intel@@$$J0YA_NU?$ocl_channel@T?$__vector@M$03@__clang@@@__clang@@T?$__vector@M$03@2@@Z"(%opencl.channel_t*, <4 x float>)
...
// CL12: declare void @_Z21read_channel_nb_intel11ocl_channel2stPb(%struct.st* sret(%struct.st){{( align 4)?}}, %opencl.channel_t {{.*}}*, i8*)
...
// CL20: declare void @_Z21read_channel_nb_intel11ocl_channel2stPU3AS4b(%struct.st* sret(%struct.st){{( align 4)?}}, %opencl.channel_t {{.*}}*, i8 addrspace(4)*)
...
// CHECKWIN: declare dso_local void @"?read_channel_nb_intel@@$$J0YA?AUst@@U?$ocl_channel@Ust@@@__clang@@PEAU?$_ASCLgeneric@$$CA_N@3@@Z"(%struct.st* sret(%struct.st){{( align 4)?}}, %opencl.channel_t*, i8*)
...
// CL12-NOT: declare void @_Z21read_channel_nb_intel11ocl_channel2stPU3AS4b(%struct.st* sret(%struct.st), %opencl.channel_t {{.*}}*, i8 addrspace(4)*)
...
// CHECK-NOT: declare void @_Z21read_channel_nb_intel11ocl_channel2stPb(%struct.st* sret(%struct.st){{( align 4)?}}, %opencl.channel_t {{.*}}*, i8*)
...
// CHECK-NOT: declare void @_Z21read_channel_nb_intel11ocl_channel2stPU3AS3b(%struct.st* sret(%struct.st), %opencl.channel_t {{.*}}*, i8 addrspace(3)*)
...
// CHECK-NOT: declare void @_Z21read_channel_nb_intel11ocl_channel2stPU3AS1b(%struct.st* sret(%struct.st), %opencl.channel_t {{.*}}*, i8 addrspace(1)*)

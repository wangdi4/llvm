...
// if INTEL_CUSTOMIZATION
// NOCPU-SAME: (<{ i32, i32, ptr, ptr addrspace(1), i8 }> [[TMP0:%.*]]) #[[ATTR5:[0-9]+]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// NOCPU-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// NOCPU-SAME: (<{ i32, i32, ptr, ptr addrspace(1), ptr addrspace(1), i64, i8 }> [[TMP0:%.*]]) #[[ATTR5]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// NOCPU-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// NOCPU-SAME: (<{ i32, i32, ptr, ptr addrspace(1), ptr addrspace(1), i64, i8 }> [[TMP0:%.*]], ptr addrspace(3) [[TMP1:%.*]]) #[[ATTR5]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// NOCPU-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// NOCPU-SAME: (<{ i32, i32, ptr, i64, ptr addrspace(1) }> [[TMP0:%.*]]) #[[ATTR5]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// NOCPU-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// NOCPU-SAME: (ptr addrspace(1) noundef align 4 [[I:%.*]]) #[[ATTR6:[0-9]+]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} !kernel_arg_host_accessible !{{[0-9]+}} !kernel_arg_pipe_depth !{{[0-9]+}} !kernel_arg_pipe_io !{{[0-9]+}} !kernel_arg_buffer_location !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// NOCPU-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// NOCPU-SAME: ({ i32, i32, ptr } [[TMP0:%.*]]) #[[ATTR5]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// NOCPU-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// GFX900-SAME: (ptr addrspace(1) noundef align 1 [[A:%.*]], i8 noundef [[B:%.*]], ptr addrspace(1) noundef align 8 [[C:%.*]], i64 noundef [[D:%.*]]) #[[ATTR2:[0-9]+]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} !kernel_arg_host_accessible !{{[0-9]+}} !kernel_arg_pipe_depth !{{[0-9]+}} !kernel_arg_pipe_io !{{[0-9]+}} !kernel_arg_buffer_location !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// GFX900-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// GFX900-SAME: (<{ i32, i32, ptr, ptr addrspace(1), i8 }> [[TMP0:%.*]]) #[[ATTR6:[0-9]+]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// GFX900-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// GFX900-SAME: (<{ i32, i32, ptr, ptr addrspace(1), ptr addrspace(1), i64, i8 }> [[TMP0:%.*]]) #[[ATTR6]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// GFX900-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// GFX900-SAME: (<{ i32, i32, ptr, ptr addrspace(1), ptr addrspace(1), i64, i8 }> [[TMP0:%.*]], ptr addrspace(3) [[TMP1:%.*]]) #[[ATTR6]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// GFX900-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// GFX900-SAME: (<{ i32, i32, ptr, i64, ptr addrspace(1) }> [[TMP0:%.*]]) #[[ATTR6]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// GFX900-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// GFX900-SAME: (ptr addrspace(1) noundef align 4 [[I:%.*]]) #[[ATTR2]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} !kernel_arg_host_accessible !{{[0-9]+}} !kernel_arg_pipe_depth !{{[0-9]+}} !kernel_arg_pipe_io !{{[0-9]+}} !kernel_arg_buffer_location !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// GFX900-NEXT:  entry:
...
// if INTEL_CUSTOMIZATION
// GFX900-SAME: ({ i32, i32, ptr } [[TMP0:%.*]]) #[[ATTR6]] !kernel_arg_addr_space !{{[0-9]+}} !kernel_arg_access_qual !{{[0-9]+}} !kernel_arg_type !{{[0-9]+}} !kernel_arg_base_type !{{[0-9]+}} !kernel_arg_type_qual !{{[0-9]+}} {
// endif INTEL_CUSTOMIZATION
// GFX900-NEXT:  entry:
...
// NOCPU: !1 = !{i32 2, i32 0}
// NOCPU: !2 = !{i32 1, i32 0, i32 1, i32 0}
// NOCPU: !3 = !{!"none", !"none", !"none", !"none"}
// NOCPU: !4 = !{!"char*", !"char", !"long*", !"long"}
// NOCPU: !5 = !{!"", !"", !"", !""}
// NOCPU: !8 = !{i32 0}
// NOCPU: !9 = !{!"none"}
...
// if INTEL_CUSTOMIZATION
// wchar_size is not added to llvm.module.flags
// GFX900: !1 = !{i32 2, i32 0}
// GFX900: !2 = !{!3, !3, i64 0}
// GFX900: !3 = !{!"long", !4, i64 0}
// GFX900: !4 = !{!"omnipotent char", !5, i64 0}
// GFX900: !5 = !{!"Simple C/C++ TBAA"}
// GFX900: !6 = !{!7, !7, i64 0}
// GFX900: !7 = !{!"any pointer", !4, i64 0}
// GFX900: !8 = !{i32 1, i32 0, i32 1, i32 0}
// GFX900: !9 = !{!"none", !"none", !"none", !"none"}
// GFX900: !10 = !{!"char*", !"char", !"long*", !"long"}
// GFX900: !11 = !{!"", !"", !"", !""}
// GFX900: !14 = !{!4, !4, i64 0}
// GFX900: !15 = !{!16, !16, i64 0}
// GFX900: !16 = !{!"int", !4, i64 0}
// GFX900: !17 = !{!18, !18, i64 0}
// GFX900: !18 = !{!"queue_t", !4, i64 0}

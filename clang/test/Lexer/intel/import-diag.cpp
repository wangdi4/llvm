...
//RUN: not %clang_cc1 -fintel-compatibility -fms-compatibility -Imystuff -show-import-processing %s > %t-check.txt 2>&1
...
//RUN: not %clang_cc1 -fintel-compatibility -fms-compatibility -internal-isystem "d:\foo\bar\something/include" -show-import-processing %s > %t-nobase.txt 2>&1
...
//RUN: not %clang_cc1 -fintel-compatibility -fms-compatibility -header-base-path "d:\\foo\\bar\\" -internal-isystem "d:\\foo\\bar\\something/include" -show-import-processing %s > %t-base.txt 2>&1

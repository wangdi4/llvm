...
// RUN: %clang_cc1 -flax-vector-conversions=none -ffreestanding %s -triple=x86_64-unknown-unknown -target-feature +avx512dotprod -target-feature +avx512fp16 -emit-llvm -o - -Wall -Werror | FileCheck %s

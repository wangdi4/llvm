...
// CHECK-NOT: tune-cpu
// INTEL_CUSTOMIZATION
// CHECK: #2 = {{.*}}"target-cpu"="i686" "target-features"="+cx8,+x87,-aes,{{.*}}-avx,-avx2{{.*}}-avx512bitalg,-avx512bw,-avx512cd,{{.*}}-avx512dq,-avx512er,-avx512f{{.*}}-avx512ifma,{{.*}}-avx512pf,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,{{.*}}-avx512vpopcntdq{{.*}},-f16c,-fma,-fma4,-gfni{{.*}}-pclmul,-sha,-sse2,-sse3,-sse4.1,-sse4.2,-sse4a,-ssse3,-vaes,-vpclmulqdq,-xop" "tune-cpu"="i686"
// CHECK: #3 = {{.*}}"target-cpu"="i686" "target-features"="+cx8,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87" "tune-cpu"="i686"
// CHECK: #4 = {{.*}}"target-cpu"="i686" "target-features"="+cx8,+x87,{{.*}}-avx,-avx2{{.*}}-avx512bitalg,-avx512bw,-avx512cd,{{.*}}-avx512dq,-avx512er,-avx512f{{.*}}-avx512ifma,{{.*}}-avx512pf,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,{{.*}}-avx512vpopcntdq{{.*}},-f16c,-fma,-fma4,-sse4.1,-sse4.2,-vaes,-vpclmulqdq,-xop" "tune-cpu"="i686"

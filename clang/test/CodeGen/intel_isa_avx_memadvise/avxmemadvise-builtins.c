...
// RUN: %clang_cc1 -ffreestanding %s -triple=x86_64-apple-darwin -target-feature +avxmemadvise -emit-llvm -o - -Wall -Werror | FileCheck %s
...
void test_mm256_vmovadvisew_store_epi8(char *a, __m256i m) {

...
__m128 test_mm_svml_floor_ps(__m128 A) {
  ...
  // CHECK-NOSSE41: call svml_cc <4 x float> @__svml_floorf4(<4 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m128 test_mm_trunc_ps(__m128 A) {
  ...
  // CHECK-NOSSE41: call svml_cc <4 x float> @__svml_truncf4(<4 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m128d test_mm_svml_floor_pd(__m128d A) {
  ...
  // CHECK-NOSSE41: call svml_cc <2 x double> @__svml_floor2(<2 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m128d test_mm_trunc_pd(__m128d A) {
  ...
  // CHECK-NOSSE41: call svml_cc <2 x double> @__svml_trunc2(<2 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m128i test_mm_idivrem_epi32(__m128i *A, __m128i B, __m128i C) {
  ...
  // CHECK: [[DIVIDEND:%.*]] = bitcast <2 x i64> %{{.*}} to <4 x i32>
  // CHECK: [[DIVISOR:%.*]] = bitcast <2 x i64> %{{.*}} to <4 x i32>
  // CHECK: [[RESULT:%.*]] = call svml_cc { <4 x i32>, <4 x i32> } @__svml_idivrem4(<4 x i32> [[DIVIDEND]], <4 x i32> [[DIVISOR]]) #[[ATTR_USE_SVML]]
...
__m128i test_mm_udivrem_epi32(__m128i *A, __m128i B, __m128i C) {
  ...
  // CHECK: [[DIVIDEND:%.*]] = bitcast <2 x i64> %{{.*}} to <4 x i32>
  // CHECK: [[DIVISOR:%.*]] = bitcast <2 x i64> %{{.*}} to <4 x i32>
  // CHECK: [[RESULT:%.*]] = call svml_cc { <4 x i32>, <4 x i32> } @__svml_udivrem4(<4 x i32> [[DIVIDEND]], <4 x i32> [[DIVISOR]]) #[[ATTR_USE_SVML]]
  // CHECK: [[REMAINDER:%.*]] = extractvalue { <4 x i32>, <4 x i32> } [[RESULT]], 1
  // CHECK: [[REMAINDER_CAST:%.*]] = bitcast <4 x i32> [[REMAINDER]] to <2 x i64>
  // CHECK: store <2 x i64> [[REMAINDER_CAST]], ptr %{{.*}}
  // CHECK: [[QUOTIENT:%.*]] = extractvalue { <4 x i32>, <4 x i32> } [[RESULT]], 0
...
__m256i test_mm256_idivrem_epi32(__m256i *A, __m256i B, __m256i C) {
  ...
  // CHECK-AVX2: [[DIVIDEND:%.*]] = bitcast <4 x i64> %{{.*}} to <8 x i32>
  // CHECK-AVX2: [[DIVISOR:%.*]] = bitcast <4 x i64> %{{.*}} to <8 x i32>
  // CHECK-AVX2: [[RESULT:%.*]] = call svml_cc { <8 x i32>, <8 x i32> } @__svml_idivrem8(<8 x i32> [[DIVIDEND]], <8 x i32> [[DIVISOR]]) #[[ATTR_USE_SVML]]
...
__m256i test_mm256_udivrem_epi32(__m256i *A, __m256i B, __m256i C) {
  ...
  // CHECK-AVX2: [[DIVIDEND:%.*]] = bitcast <4 x i64> %{{.*}} to <8 x i32>
  // CHECK-AVX2: [[DIVISOR:%.*]] = bitcast <4 x i64> %{{.*}} to <8 x i32>
  // CHECK-AVX2: [[RESULT:%.*]] = call svml_cc { <8 x i32>, <8 x i32> } @__svml_udivrem8(<8 x i32> [[DIVIDEND]], <8 x i32> [[DIVISOR]]) #[[ATTR_USE_SVML]]
  // CHECK-AVX2: [[REMAINDER:%.*]] = extractvalue { <8 x i32>, <8 x i32> } [[RESULT]], 1
  // CHECK-AVX2: [[REMAINDER_CAST:%.*]] = bitcast <8 x i32> [[REMAINDER]] to <4 x i64>
  // CHECK-AVX2: store <4 x i64> [[REMAINDER_CAST]], ptr %{{.*}}
  // CHECK-AVX2: [[QUOTIENT:%.*]] = extractvalue { <8 x i32>, <8 x i32> } [[RESULT]], 0
...
__m512 test_mm512_cbrt_ps(__m512 A) {
  ...
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cbrtf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_cbrt_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cbrtf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cbrt_ps(A, B, C);
}

__m512 test_mm512_exp_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_exp_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_expf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_exp_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_expf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_exp_ps(A, B, C);
}

__m512 test_mm512_exp10_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_exp10_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_exp10f16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_exp10_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_exp10f16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_exp10_ps(A, B, C);
}

__m512 test_mm512_exp2_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_exp2_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_exp2f16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_exp2_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_exp2f16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_exp2_ps(A, B, C);
}

__m512 test_mm512_expm1_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_expm1_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_expm1f16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_expm1_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_expm1f16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_expm1_ps(A, B, C);
}

__m512 test_mm512_hypot_ps(__m512 A, __m512 B) {
  // CHECK-AVX512F-LABEL: test_mm512_hypot_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_hypotf16(<16 x float> %{{.*}}, <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_hypot_ps(__m512 A, __mmask16 B, __m512 C, __m512 D) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_hypotf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}, <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_hypot_ps(A, B, C, D);
}

__m512 test_mm512_invsqrt_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_invsqrt_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_invsqrtf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_invsqrt_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_invsqrtf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_invsqrt_ps(A, B, C);
}

__m512 test_mm512_log_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_log_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_logf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_log_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_logf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_log_ps(A, B, C);
}

__m512 test_mm512_log10_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_log10_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_log10f16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_log10_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_log10f16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_log10_ps(A, B, C);
}

__m512 test_mm512_log1p_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_log1p_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_log1pf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_log1p_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_log1pf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_log1p_ps(A, B, C);
}

__m512 test_mm512_log2_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_log2_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_log2f16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_log2_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_log2f16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_log2_ps(A, B, C);
}

__m512 test_mm512_logb_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_logb_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_logbf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_logb_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_logbf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_logb_ps(A, B, C);
}

__m512 test_mm512_pow_ps(__m512 A, __m512 B) {
  // CHECK-AVX512F-LABEL: test_mm512_pow_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_powf16(<16 x float> %{{.*}}, <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_pow_ps(__m512 A, __mmask16 B, __m512 C, __m512 D) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_powf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}, <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_acos_ps(__m512 A) {
  ...
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_acosf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_acos_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_acosf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_acos_ps(A, B, C);
}

__m512 test_mm512_acosh_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_acosh_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_acoshf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_acosh_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_acoshf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_acosh_ps(A, B, C);
}

__m512 test_mm512_asin_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_asin_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_asinf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_asin_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_asinf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_asin_ps(A, B, C);
}

__m512 test_mm512_asinh_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_asinh_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_asinhf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_asinh_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_asinhf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_asinh_ps(A, B, C);
}

__m512 test_mm512_atan_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_atan_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_atanf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_atan_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_atanf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_atan_ps(A, B, C);
}

__m512 test_mm512_atan2_ps(__m512 A, __m512 B) {
  // CHECK-AVX512F-LABEL: test_mm512_atan2_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_atan2f16(<16 x float> %{{.*}}, <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_atan2_ps(__m512 A, __mmask16 B, __m512 C, __m512 D) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_atan2f16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}, <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_atan2_ps(A, B, C, D);
}

__m512 test_mm512_atanh_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_atanh_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_atanhf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_atanh_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_atanhf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_atanh_ps(A, B, C);
}

__m512 test_mm512_cos_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_cos_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cosf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_cos_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cosf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cos_ps(A, B, C);
}

__m512 test_mm512_cosd_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_cosd_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cosdf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_cosd_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cosdf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cosd_ps(A, B, C);
}

__m512 test_mm512_cosh_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_cosh_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_coshf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_cosh_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_coshf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cosh_ps(A, B, C);
}

__m512 test_mm512_sin_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_sin_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_sinf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_sin_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_sinf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_sin_ps(A, B, C);
}

__m512 test_mm512_sincos_ps(__m512 *A, __m512 B) {
  // CHECK-AVX512F-LABEL: test_mm512_sincos_ps
  // CHECK-AVX512F: [[RESULT:%.*]] = call svml_cc { <16 x float>, <16 x float> } @__svml_sincosf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_sincos_ps(__m512 *A, __m512 B, __m512 C, __mmask16 D, __m512 E) {
  ...
  // CHECK-AVX512F: [[RESULT:%.*]] = call svml_cc { <16 x float>, <16 x float> } @__svml_sincosf16_mask({ <16 x float>, <16 x float> } [[SRC]], <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  // CHECK-AVX512F: [[COS:%.*]] = extractvalue { <16 x float>, <16 x float> } [[RESULT]], 1
  // CHECK-AVX512F: store <16 x float> [[COS]], ptr %{{.*}}
  // CHECK-AVX512F: [[SIN:%.*]] = extractvalue { <16 x float>, <16 x float> } [[RESULT]], 0
  // CHECK-AVX512F: ret <16 x float> [[SIN]]
...
__m512 test_mm512_sind_ps(__m512 A) {
  ...
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_sindf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_sind_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_sindf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_sind_ps(A, B, C);
}

__m512 test_mm512_sinh_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_sinh_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_sinhf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_sinh_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_sinhf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_sinh_ps(A, B, C);
}

__m512 test_mm512_tan_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_tan_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_tanf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_tan_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_tanf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_tan_ps(A, B, C);
}

__m512 test_mm512_tand_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_tand_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_tandf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_tand_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_tandf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_tand_ps(A, B, C);
}

__m512 test_mm512_tanh_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_tanh_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_tanhf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_tanh_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_tanhf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_tanh_ps(A, B, C);
}

__m512 test_mm512_cdfnorm_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_cdfnorm_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cdfnormf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_cdfnorm_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cdfnormf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cdfnorm_ps(A, B, C);
}

__m512 test_mm512_cdfnorminv_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_cdfnorminv_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cdfnorminvf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_cdfnorminv_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_cdfnorminvf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cdfnorminv_ps(A, B, C);
}

__m512 test_mm512_erf_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_erf_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_erff16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_erf_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_erff16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_erf_ps(A, B, C);
}

__m512 test_mm512_erfc_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_erfc_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_erfcf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_erfc_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_erfcf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_erfc_ps(A, B, C);
}

__m512 test_mm512_erfcinv_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_erfcinv_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_erfcinvf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_erfcinv_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_erfcinvf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_erfcinv_ps(A, B, C);
}

__m512 test_mm512_erfinv_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_erfinv_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_erfinvf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_erfinv_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_erfinvf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_erfinv_ps(A, B, C);
}

__m512 test_mm512_nearbyint_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_nearbyint_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_nearbyintf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_nearbyint_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_nearbyintf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_nearbyint_ps(A, B, C);
}

__m512 test_mm512_rint_ps(__m512 A) {
  // CHECK-AVX512F-LABEL: test_mm512_rint_ps
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_rintf16(<16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512 test_mm512_mask_rint_ps(__m512 A, __mmask16 B, __m512 C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i16 %{{.*}} to <16 x i1>
  // CHECK-AVX512F: call svml_cc <16 x float> @__svml_rintf16_mask(<16 x float> %{{.*}}, <16 x i1> [[MASK]], <16 x float> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_cbrt_pd(__m512d A) {
  ...
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cbrt8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_cbrt_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cbrt8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cbrt_pd(A, B, C);
}

__m512d test_mm512_exp_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_exp_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_exp8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_exp_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_exp8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_exp_pd(A, B, C);
}

__m512d test_mm512_exp10_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_exp10_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_exp108(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_exp10_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_exp108_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_exp10_pd(A, B, C);
}

__m512d test_mm512_exp2_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_exp2_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_exp28(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_exp2_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_exp28_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_exp2_pd(A, B, C);
}

__m512d test_mm512_expm1_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_expm1_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_expm18(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_expm1_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_expm18_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_expm1_pd(A, B, C);
}

__m512d test_mm512_hypot_pd(__m512d A, __m512d B) {
  // CHECK-AVX512F-LABEL: test_mm512_hypot_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_hypot8(<8 x double> %{{.*}}, <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_hypot_pd(__m512d A, __mmask8 B, __m512d C, __m512d D) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_hypot8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}, <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_hypot_pd(A, B, C, D);
}

__m512d test_mm512_invsqrt_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_invsqrt_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_invsqrt8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_invsqrt_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_invsqrt8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_invsqrt_pd(A, B, C);
}

__m512d test_mm512_log_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_log_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_log8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_log_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_log8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_log_pd(A, B, C);
}

__m512d test_mm512_log10_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_log10_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_log108(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_log10_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_log108_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_log10_pd(A, B, C);
}

__m512d test_mm512_log1p_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_log1p_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_log1p8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_log1p_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_log1p8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_log1p_pd(A, B, C);
}

__m512d test_mm512_log2_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_log2_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_log28(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_log2_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_log28_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_log2_pd(A, B, C);
}

__m512d test_mm512_logb_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_logb_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_logb8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_logb_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_logb8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_logb_pd(A, B, C);
}

__m512d test_mm512_pow_pd(__m512d A, __m512d B) {
  // CHECK-AVX512F-LABEL: test_mm512_pow_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_pow8(<8 x double> %{{.*}}, <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_pow_pd(__m512d A, __mmask8 B, __m512d C, __m512d D) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_pow8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}, <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_acos_pd(__m512d A) {
  ...
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_acos8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_acos_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_acos8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_acos_pd(A, B, C);
}

__m512d test_mm512_acosh_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_acosh_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_acosh8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_acosh_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_acosh8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_acosh_pd(A, B, C);
}

__m512d test_mm512_asin_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_asin_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_asin8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_asin_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_asin8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_asin_pd(A, B, C);
}

__m512d test_mm512_asinh_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_asinh_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_asinh8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_asinh_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_asinh8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_asinh_pd(A, B, C);
}

__m512d test_mm512_atan_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_atan_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_atan8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_atan_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_atan8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_atan_pd(A, B, C);
}

__m512d test_mm512_atan2_pd(__m512d A, __m512d B) {
  // CHECK-AVX512F-LABEL: test_mm512_atan2_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_atan28(<8 x double> %{{.*}}, <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_atan2_pd(__m512d A, __mmask8 B, __m512d C, __m512d D) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_atan28_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}, <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_atan2_pd(A, B, C, D);
}

__m512d test_mm512_atanh_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_atanh_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_atanh8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_atanh_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_atanh8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_atanh_pd(A, B, C);
}

__m512d test_mm512_cos_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_cos_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cos8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_cos_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cos8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cos_pd(A, B, C);
}

__m512d test_mm512_cosd_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_cosd_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cosd8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_cosd_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cosd8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cosd_pd(A, B, C);
}

__m512d test_mm512_cosh_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_cosh_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cosh8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_cosh_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cosh8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cosh_pd(A, B, C);
}

__m512d test_mm512_sin_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_sin_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_sin8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_sin_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_sin8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_sin_pd(A, B, C);
}

__m512d test_mm512_sincos_pd(__m512d *A, __m512d B) {
  // CHECK-AVX512F-LABEL: test_mm512_sincos_pd
  // CHECK-AVX512F: [[RESULT:%.*]] = call svml_cc { <8 x double>, <8 x double> } @__svml_sincos8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_sincos_pd(__m512d *A, __m512d B, __m512d C, __mmask8 D, __m512d E) {
  ...
  // CHECK-AVX512F: [[RESULT:%.*]] = call svml_cc { <8 x double>, <8 x double> } @__svml_sincos8_mask({ <8 x double>, <8 x double> } [[SRC]], <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  // CHECK-AVX512F: [[COS:%.*]] = extractvalue { <8 x double>, <8 x double> } [[RESULT]], 1
  // CHECK-AVX512F: store <8 x double> [[COS]], ptr %{{.*}}
  // CHECK-AVX512F: [[SIN:%.*]] = extractvalue { <8 x double>, <8 x double> } [[RESULT]], 0
  // CHECK-AVX512F: ret <8 x double> [[SIN]]
...
__m512d test_mm512_sind_pd(__m512d A) {
  ...
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_sind8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_sind_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_sind8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_sind_pd(A, B, C);
}

__m512d test_mm512_sinh_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_sinh_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_sinh8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_sinh_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_sinh8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_sinh_pd(A, B, C);
}

__m512d test_mm512_tan_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_tan_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_tan8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_tan_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_tan8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_tan_pd(A, B, C);
}

__m512d test_mm512_tand_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_tand_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_tand8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_tand_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_tand8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_tand_pd(A, B, C);
}

__m512d test_mm512_tanh_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_tanh_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_tanh8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_tanh_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_tanh8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_tanh_pd(A, B, C);
}

__m512d test_mm512_cdfnorm_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_cdfnorm_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cdfnorm8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_cdfnorm_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cdfnorm8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_cdfnorminv_pd(__m512d A) {
  ...
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cdfnorminv8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_cdfnorminv_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_cdfnorminv8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_cdfnorminv_pd(A, B, C);
}

__m512d test_mm512_erf_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_erf_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_erf8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_erf_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_erf8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_erf_pd(A, B, C);
}

__m512d test_mm512_erfc_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_erfc_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_erfc8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_erfc_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_erfc8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_erfc_pd(A, B, C);
}

__m512d test_mm512_erfcinv_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_erfcinv_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_erfcinv8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_erfcinv_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_erfcinv8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_erfcinv_pd(A, B, C);
}

__m512d test_mm512_erfinv_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_erfinv_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_erfinv8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_erfinv_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_erfinv8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_erfinv_pd(A, B, C);
}

__m512d test_mm512_nearbyint_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_nearbyint_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_nearbyint8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_nearbyint_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_nearbyint8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_nearbyint_pd(A, B, C);
}

__m512d test_mm512_rint_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_rint_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_rint8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_rint_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_rint8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
  return _mm512_mask_rint_pd(A, B, C);
}

__m512d test_mm512_svml_round_pd(__m512d A) {
  // CHECK-AVX512F-LABEL: test_mm512_svml_round_pd
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_round8(<8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512d test_mm512_mask_svml_round_pd(__m512d A, __mmask8 B, __m512d C) {
  ...
  // CHECK-AVX512F: [[MASK:%.*]] = bitcast i8 %{{.*}} to <8 x i1>
  // CHECK-AVX512F: call svml_cc <8 x double> @__svml_round8_mask(<8 x double> %{{.*}}, <8 x i1> [[MASK]], <8 x double> %{{.*}}) #[[ATTR_USE_SVML]]
...
__m512i test_mm512_mask_div_epi32(__m512i A, __mmask16 B, __m512i C, __m512i D) {
  ...
  // CHECK-AVX512F: [[DIVIDEND:%.*]] = bitcast <8 x i64> %{{.*}} to <16 x i32>
  // CHECK-AVX512F: [[DIVISOR:%.*]] = bitcast <8 x i64> %{{.*}} to <16 x i32>
  // CHECK-AVX512F: [[RESULT:%.*]] = call svml_cc <16 x i32> @__svml_idiv16_mask(<16 x i32> [[SRC]], <16 x i1> [[MASK]], <16 x i32> [[DIVIDEND]], <16 x i32> [[DIVISOR]]) #[[ATTR_USE_SVML]]
  // CHECK-AVX512F: bitcast <16 x i32> [[RESULT]] to <8 x i64>
...
__m512i test_mm512_mask_div_epu32(__m512i A, __mmask16 B, __m512i C, __m512i D) {
  ...
  // CHECK-AVX512F: [[DIVIDEND:%.*]] = bitcast <8 x i64> %{{.*}} to <16 x i32>
  // CHECK-AVX512F: [[DIVISOR:%.*]] = bitcast <8 x i64> %{{.*}} to <16 x i32>
  // CHECK-AVX512F: [[RESULT:%.*]] = call svml_cc <16 x i32> @__svml_udiv16_mask(<16 x i32> [[SRC]], <16 x i1> [[MASK]], <16 x i32> [[DIVIDEND]], <16 x i32> [[DIVISOR]]) #[[ATTR_USE_SVML]]
  // CHECK-AVX512F: bitcast <16 x i32> [[RESULT]] to <8 x i64>
...
__m512i test_mm512_mask_rem_epi32(__m512i A, __mmask16 B, __m512i C, __m512i D) {
  ...
  // CHECK-AVX512F: [[DIVIDEND:%.*]] = bitcast <8 x i64> %{{.*}} to <16 x i32>
  // CHECK-AVX512F: [[DIVISOR:%.*]] = bitcast <8 x i64> %{{.*}} to <16 x i32>
  // CHECK-AVX512F: [[RESULT:%.*]] = call svml_cc <16 x i32> @__svml_irem16_mask(<16 x i32> [[SRC]], <16 x i1> [[MASK]], <16 x i32> [[DIVIDEND]], <16 x i32> [[DIVISOR]]) #[[ATTR_USE_SVML]]
  // CHECK-AVX512F: bitcast <16 x i32> [[RESULT]] to <8 x i64>
...
__m512i test_mm512_mask_rem_epu32(__m512i A, __mmask16 B, __m512i C, __m512i D) {
  ...
  // CHECK-AVX512F: [[DIVIDEND:%.*]] = bitcast <8 x i64> %{{.*}} to <16 x i32>
  // CHECK-AVX512F: [[DIVISOR:%.*]] = bitcast <8 x i64> %{{.*}} to <16 x i32>
  // CHECK-AVX512F: [[RESULT:%.*]] = call svml_cc <16 x i32> @__svml_urem16_mask(<16 x i32> [[SRC]], <16 x i1> [[MASK]], <16 x i32> [[DIVIDEND]], <16 x i32> [[DIVISOR]]) #[[ATTR_USE_SVML]]
  // CHECK-AVX512F: bitcast <16 x i32> [[RESULT]] to <8 x i64>
...
// CHECK: attributes #[[ATTR_USE_SVML]] = {{.*}}"imf-use-svml"="true"

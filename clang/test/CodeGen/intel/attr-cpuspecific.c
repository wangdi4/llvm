...
// LINUX: [[INIT_CMP]]:
// LINUX-NEXT: %[[FEAT_INIT:.+]] = load i64, ptr @__intel_cpu_feature_indicator_x, align 8
...
// //
// LINUX: [[REST]]
// LINUX: %[[FEAT_INIT:.+]] = load i64, ptr @__intel_cpu_feature_indicator_x, align 8
...
// WINDOWS: [[INIT_CMP]]:
// WINDOWS-NEXT: %[[FEAT_INIT:.+]] = load i64, ptr @__intel_cpu_feature_indicator_x, align 8
...
// WINDOWS: [[REST]]
// WINDOWS: %[[FEAT_INIT:.+]] = load i64, ptr @__intel_cpu_feature_indicator_x, align 8
...
// LINUX: ptr @DispatchFirst.O
// LINUX: ptr @DispatchFirst.B

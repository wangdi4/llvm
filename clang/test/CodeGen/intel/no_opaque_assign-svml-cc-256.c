// RUN: %clang_cc1 -triple x86_64-unknown-linux-gnu -target-feature +avx2 -fms-compatibility -emit-llvm -no-opaque-pointers -o - %s | FileCheck %s
...
// RUN: %clang_cc1 -triple x86_64-unknown-windows -target-feature +avx2 -fms-compatibility -emit-llvm -no-opaque-pointers -o - %s | FileCheck %s
...
// RUN: %clang_cc1 -triple i686-pc-linux -target-feature +avx2 -fms-compatibility -emit-llvm -no-opaque-pointers -o - %s | FileCheck %s
...
// RUN: %clang_cc1 -triple i686-pc-win32 -target-feature +avx2 -fms-compatibility -emit-llvm -no-opaque-pointers -o - %s | FileCheck %s

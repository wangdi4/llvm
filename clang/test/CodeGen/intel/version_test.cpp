...
int foo()
{
  ...
  static_assert(intel_llvm == 20240100, "INTEL LLVM COMPILER version is incorrect");
  static_assert(intel_clang == 20240100, "INTEL CLANG COMPILER version is incorrect");

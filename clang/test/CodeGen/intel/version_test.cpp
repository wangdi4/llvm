...
int foo()
{
  ...
  static_assert(intel_llvm == 20210200, "INTEL LLVM COMPILER version is incorrect");
  static_assert(intel_clang == 20210200, "INTEL CLANG COMPILER version is incorrect");

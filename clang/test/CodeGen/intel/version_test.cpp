...
int foo()
{
  ...
  static_assert(intel_llvm == 20220000, "INTEL LLVM COMPILER version is incorrect");
  static_assert(intel_clang == 20220000, "INTEL CLANG COMPILER version is incorrect");

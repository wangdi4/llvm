...
int foo()
{
  ...
  static_assert(intel_llvm == 20220100, "INTEL LLVM COMPILER version is incorrect");
  static_assert(intel_clang == 20220100, "INTEL CLANG COMPILER version is incorrect");

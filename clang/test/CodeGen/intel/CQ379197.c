...
//; INTEL - This test is marked XFAIL due to DPD200417025
// XFAIL: *
//; END INTEL
...
// CHECK: load i32, i32* %.atomictmp, align 4
// CHECK: cmpxchg weak i32* @a, i32 %0, i32 %{{[0-9]*}} monotonic monotonic
...
// CHECK: load i32, i32* %.atomictmp7, align 4

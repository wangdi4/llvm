...
// CHECK: [[TBAA_struct]] = !{i64 0, i64 4, [[TAG_float:!.*]], i64 4, i64 4, [[TAG_float]]}
// CHECK: [[TAG_float]] = !{!"float", !{{.*}}, i64 0}
// CHECK-NOT: [[TAG_c]] = !{!"_Complex@_ZTSf", [[TAG_float]], i64 0, [[TAG_float]], i64 4}
// CHECK: [[TAG_float_field:!.*]] = !{[[TAG_float]], [[TAG_float]], i64 0}

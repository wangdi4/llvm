...
c::~c() {}
// CHECK: define {{.*}}void @_ZN1cD2Ev(%class._ZTS1c.c* {{[^,]*}}"intel_dtrans_func_index"="1" %this){{.+}} !intel.dtrans.func.type ![[C_DTOR_MD:[0-9]+]]
...
// CHECK: define {{.*}}void @_ZN2NS1f1eERKNS_1bEbb(%"class._ZTSN2NS1fE.NS::f"* {{[^,]*}}"intel_dtrans_func_index"="1" %this, %"class._ZTSN2NS1bE.NS::b"* noundef nonnull align 1 "intel_dtrans_func_index"="2" %0, i1 noundef zeroext %1, i1 noundef zeroext %2){{.*}}!intel.dtrans.func.type ![[E_MD:[0-9]+]]

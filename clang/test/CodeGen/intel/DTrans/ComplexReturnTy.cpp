...
// CHECK: declare !intel.dtrans.func.type ![[G:[0-9]+]] noundef <2 x float> @_ZN3Foo1gEv(%struct._ZTS3Foo.Foo* {{[^,]*}}"intel_dtrans_func_index"="1")
// CHECK: declare !intel.dtrans.func.type ![[G2:[0-9]+]] noundef "intel_dtrans_func_index"="1" { float, float }* @_ZN3Foo2g2Ev(%struct._ZTS3Foo.Foo* {{[^,]*}}"intel_dtrans_func_index"="2")

...
// RUN: %clang_cc1 -disable-llvm-passes -O2 -triple x86_64-windows-pc -emit-dtrans-info -fintel-compatibility -emit-llvm %s -o - | FileCheck %s --check-prefixes=CHECK,PTR
...
// RUN: %clang_cc1 -disable-llvm-passes -O2 -triple x86_64-windows-pc -emit-dtrans-info -fintel-compatibility -emit-llvm -mllvm -opaque-pointers %s -o - | FileCheck %s --check-prefixes=CHECK,OPQ

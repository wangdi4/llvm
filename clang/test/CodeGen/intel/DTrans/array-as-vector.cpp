...
template class Function< 2 ,  float >;

// VTable and type-info for the Function class.
// CHECK: @_ZTV8FunctionILi2EfE = {{.*}}{ [4 x ptr] }{{.*}} !intel_dtrans_type ![[FUNCTION_VTBL:[0-9]+]]
// CHECK: @_ZTI8FunctionILi2EfE = {{.*}}{ ptr, ptr }{{.*}} !intel_dtrans_type ![[FUNCTION_TYPE_INFO:[0-9]+]]

// Function::vector_gradient function.
// CHECK: define {{.*}}void @_ZNK8FunctionILi2EfE15vector_gradientEv(ptr{{.*}} "intel_dtrans_func_index"="1" %this) {{.*}}!intel.dtrans.func.type ![[VEC_GRAD_MD:[0-9]+]]
...
// CHECK: declare !intel.dtrans.func.type ![[GRAD_MD:[0-9]+]] <2 x float> @_ZNK8FunctionILi2EfE8gradientEv
...
// CHECK: ![[FUNCTION]] = !{!"S", %class._ZTS8FunctionILi2EfE.Function zeroinitializer, i32 1, ![[VTBL_PTR_PTR:[0-9]+]]}
// CHECK: ![[VTBL_PTR_PTR]] = !{![[VTBL_TY:[0-9]+]], i32 2}
// CHECK: ![[VTBL_TY]] = !{!"F", i1 true, i32 0, ![[INT:[0-9]+]]}
// CHECK: ![[INT]] = !{i32 0, i32 0}

// Tensor<1> 
// CHECK: ![[TENSOR1]] = !{!"S", %class._ZTS6TensorILi1ELi2EfE.Tensor zeroinitializer, i32 1, ![[ARR_OF_TENSOR_ZERO:[0-9]+]]}
// CHECK: ![[ARR_OF_TENSOR_ZERO]] = !{!"A", i32 2, ![[TENSOR0_REF:[0-9]+]]}
// CHECK: ![[TENSOR0_REF]] = !{%class._ZTS6TensorILi0ELi2EfE.Tensor zeroinitializer, i32 0}

// Tensor<0>
// CHECK: ![[TENSOR0]] = !{!"S", %class._ZTS6TensorILi0ELi2EfE.Tensor zeroinitializer, i32 1, ![[FLOAT:[0-9]+]]}
// CHECK: ![[FLOAT]] = !{float 0{{.*}}, i32 0}

// CHECK: ![[VEC_GRAD_MD]] = distinct !{![[FUNCTION_PTR]]}
// CHECK: ![[FUNCTION_PTR]] = !{%class._ZTS8FunctionILi2EfE.Function zeroinitializer, i32 1}

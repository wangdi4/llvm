...
// RUN: %clang_cc1 -disable-llvm-passes -O2 -triple x86_64-linux-gnu -fwhole-program-vtables -fexceptions -fcxx-exceptions -emit-dtrans-info -fintel-compatibility -emit-llvm -opaque-pointers %s -o - | FileCheck %s
  class bad_alloc
  {
  public:
    bad_alloc() throw() { }
...
// CHECK: @_ZTVN10__cxxabiv117__class_type_infoE = external global ptr, !intel_dtrans_type ![[CHAR_PTR:[0-9]+]]
// CHECK: @_ZTI9bad_alloc = external constant ptr, !intel_dtrans_type ![[CHAR_PTR]]

...
// e::e(int,int)
// CHECK: declare !intel.dtrans.func.type ![[E_CTOR:[0-9]+]] void @_ZN1eC1Eii(%class._ZTS1e.e* nonnull align 1 dereferenceable(1) "intel_dtrans_func_index"="1", i32, i32)
// e::g()
// CHECK: declare !intel.dtrans.func.type ![[G:[0-9]+]] "intel_dtrans_func_index"="1" { i32, i32* } @_ZN1e1gEv(%class._ZTS1e.e* nonnull align 1 dereferenceable(1) "intel_dtrans_func_index"="2")

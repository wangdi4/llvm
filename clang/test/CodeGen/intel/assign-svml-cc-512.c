...
// CHECK: define dso_local svml_unified_cc_512 <16 x float> @__svml_sinf16_mask_z0(<16 x float> %{{.*}}, i16 zeroext %{{.*}}, <16 x float> %{{.*}})
...
// CHECK: define dso_local svml_unified_cc_512 <16 x float> @__svml_sinf16_mask_chosen_core_func_init_internal(<16 x float> %{{.*}}, i16 zeroext %{{.*}}, <16 x float> %{{.*}})
__attribute__((intel_ocl_bicc))
__m512 __svml_sinf16_mask_chosen_core_func_init_internal(__m512 r, __mmask16 mask, __m512 a) {
// CHECK: call <16 x float> (<16 x float>, i16, <16 x float>)** @__svml_sinf16_mask_chosen_core_func_get_ptr_internal()
  core_func_ptr *func_ptr = __svml_sinf16_mask_chosen_core_func_get_ptr_internal();
// CHECK: call svml_unified_cc_512 <16 x float> %{{.*}}(<16 x float> %{{.*}}, i16 zeroext %{{.*}}, <16 x float> %{{.*}})
...
// CHECK: define hidden <16 x float> (<16 x float>, i16, <16 x float>)** @__svml_sinf16_mask_chosen_core_func_get_ptr_internal()
core_func_ptr *__svml_sinf16_mask_chosen_core_func_get_ptr_internal(void) {
  return &__svml_sinf16_mask_chosen_core_func;
}

// CHECK: define dso_local svml_unified_cc_512 <16 x float> @__svml_sinf16_mask(<16 x float> %{{.*}}, i16 zeroext %{{.*}}, <16 x float> %{{.*}})
__attribute__((intel_ocl_bicc))

...
// CHECK: define dso_local svml_unified_cc_512 <16 x float> @__svml_sinf16_mask_z0(<16 x float> %{{.*}}, <16 x i1> %{{.*}}, <16 x float> %{{.*}})
...
// CHECK: define dso_local svml_unified_cc_512 <16 x float> @__svml_sinf16_mask_chosen_core_func_init_internal(<16 x float> %{{.*}}, <16 x i1> %{{.*}}, <16 x float> %{{.*}})
__attribute__((intel_ocl_bicc))
...
// CHECK: call svml_unified_cc_512 <16 x float> {{.*}}(<16 x float> %{{.*}}, <16 x i1> %{{.*}}, <16 x float> %{{.*}})
...
// CHECK: define dso_local svml_unified_cc_512 <16 x float> @__svml_sinf16_mask(<16 x float> %{{.*}}, <16 x i1> %{{.*}}, <16 x float> %{{.*}})
__attribute__((intel_ocl_bicc))
__m512 __svml_sinf16_mask(__m512 r, __mmask16 mask, __m512 a) {
  return (__svml_sinf16_mask_chosen_core_func)(r, mask, a);
}

// CHECK: define dso_local svml_unified_cc_512 <8 x double> @__svml_pow3o28_mask_l0(<8 x double> %{{.*}}, <16 x i1> %{{.*}}, <8 x double> %{{.*}})
__attribute__((intel_ocl_bicc))
__m512d __svml_pow3o28_mask_l0(__m512d r, __mmask16 mask, __m512d a) {
    return a;
}

// CHECK: define dso_local svml_unified_cc_512 %struct.__m512x2_t @__svml_sincospif16_mask_z0(<16 x float> %{{.*}}, <16 x float> %{{.*}}, <16 x i1> %{{.*}}, <16 x float> %{{.*}})
__attribute__((intel_ocl_bicc))
__m512x2 __svml_sincospif16_mask_z0(__m512x2 r, __mmask16 mask, __m512 a) {
  return r;
}

// CHECK: define dso_local svml_unified_cc_512 %struct.__m512x2_t @__svml_cdivf16_mask_l0(<16 x float> %{{.*}}, <16 x float> %{{.*}}, <16 x i1> %{{.*}}, <16 x float> %{{.*}}, <16 x float> %{{.*}}, <16 x float> %{{.*}}, <16 x float> %{{.*}})
__attribute__((intel_ocl_bicc))

...
// CHECK: call i32 (i8*, i8*, ...) @sprintf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* [[BUF]], i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* [[FMT]], i64 0, i64 0), i32 [[A_VAL]])

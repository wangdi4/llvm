...
void test_amx(void *data) {
  ...
  //X86_64: call void @llvm.x86.tileloadd64(i8 4, i8* %{{.*}}, i64 8)
  //X86_64: call void @llvm.x86.tileloaddt164(i8 0, i8* %{{.*}}, i64 1)
  //X86_64: call void @llvm.x86.tilestored64(i8 0, i8* %{{.*}}, i64 1)

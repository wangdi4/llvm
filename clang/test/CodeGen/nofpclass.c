...
// INTEL: add gep0 removal option to match llorg opts.
// RUN: %clang_cc1 -mllvm -xmain-enable-gep0-removal -x cl -triple x86_64-unknown-unknown -target-feature +avx -fenable-matrix -cl-finite-math-only -emit-llvm -o - %s | FileCheck -check-prefixes=CLFINITEONLY %s

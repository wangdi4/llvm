...
// RUN: %clang_cc1 -no-opaque-pointers %s -ffreestanding -triple=x86_64-unknown-unknown -target-feature +cmpccxadd \
...
int test_cmpbexadd32(void *__A, int __B, int __C) {
  ...
  // CHECK: call i32 @llvm.x86.cmpccxadd32(i8* %{{.*}}, i32 %{{.*}}, i32 %{{.*}}, i32 0)
...
long long test_cmplxadd64(void *__A, long long __B, long long __C) {
  ...
  // CHECK: call i64 @llvm.x86.cmpccxadd64(i8* %{{.*}}, i64 %{{.*}}, i64 %{{.*}}, i32 3)
...
int test_cmpnbexadd32(void *__A, int __B, int __C) {
  ...
  // CHECK: call i32 @llvm.x86.cmpccxadd32(i8* %{{.*}}, i32 %{{.*}}, i32 %{{.*}}, i32 4)
...
long long test_cmpnbexadd64(void *__A, long long __B, long long __C) {
  ...
  // CHECK: call i64 @llvm.x86.cmpccxadd64(i8* %{{.*}}, i64 %{{.*}}, i64 %{{.*}}, i32 4)
...
int test_cmpnbxadd32(void *__A, int __B, int __C) {
  ...
  // CHECK: call i32 @llvm.x86.cmpccxadd32(i8* %{{.*}}, i32 %{{.*}}, i32 %{{.*}}, i32 5)
...
long long test_cmpnbxadd64(void *__A, long long __B, long long __C) {
  ...
  // CHECK: call i64 @llvm.x86.cmpccxadd64(i8* %{{.*}}, i64 %{{.*}}, i64 %{{.*}}, i32 5)
...
int test_cmpnlexadd32(void *__A, int __B, int __C) {
  ...
  // CHECK: call i32 @llvm.x86.cmpccxadd32(i8* %{{.*}}, i32 %{{.*}}, i32 %{{.*}}, i32 6)
...
long long test_cmpnlexadd64(void *__A, long long __B, long long __C) {
  ...
  // CHECK: call i64 @llvm.x86.cmpccxadd64(i8* %{{.*}}, i64 %{{.*}}, i64 %{{.*}}, i32 6)
...
int test_cmpnlxadd32(void *__A, int __B, int __C) {
  ...
  // CHECK: call i32 @llvm.x86.cmpccxadd32(i8* %{{.*}}, i32 %{{.*}}, i32 %{{.*}}, i32 7)
...
long long test_cmpzxadd64(void *__A, long long __B, long long __C) {
  ...
  // CHECK: call i64 @llvm.x86.cmpccxadd64(i8* %{{.*}}, i64 %{{.*}}, i64 %{{.*}}, i32 15)

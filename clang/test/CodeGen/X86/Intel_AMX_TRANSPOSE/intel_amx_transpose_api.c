...
void test_tile_t2rpntlvwz0(__tile1024i dst0, __tile1024i dst1) {
  ...
  //CHECK-NEXT: {{%.*}} = call <256 x i32> @llvm.x86.cast.tile.to.vector.v256i32(x86_amx {{%.*}})
  //CHECK-NEXT: store <256 x i32> {{%.*}}, ptr {{%.*}}
  __tile_t2rpntlvwz0(&dst0, &dst1, buf, STRIDE);
}

void test_tile_t2rpntlvwz0t1(__tile1024i dst0, __tile1024i dst1) {
  ...
  //CHECK-NEXT: {{%.*}} = call <256 x i32> @llvm.x86.cast.tile.to.vector.v256i32(x86_amx {{%.*}})
  //CHECK-NEXT: store <256 x i32> {{%.*}}, ptr {{%.*}}
  __tile_t2rpntlvwz0t1(&dst0, &dst1, buf, STRIDE);
}

void test_tile_t2rpntlvwz1(__tile1024i dst0, __tile1024i dst1) {
  ...
  //CHECK-NEXT: {{%.*}} = call <256 x i32> @llvm.x86.cast.tile.to.vector.v256i32(x86_amx {{%.*}})
  //CHECK-NEXT: store <256 x i32> {{%.*}}, ptr {{%.*}}
  __tile_t2rpntlvwz1(&dst0, &dst1, buf, STRIDE);
}

void test_tile_t2rpntlvwz1t1(__tile1024i dst0, __tile1024i dst1) {
  ...
  //CHECK-NEXT: {{%.*}} = call <256 x i32> @llvm.x86.cast.tile.to.vector.v256i32(x86_amx {{%.*}})
  //CHECK-NEXT: store <256 x i32> {{%.*}}, ptr {{%.*}}
  __tile_t2rpntlvwz1t1(&dst0, &dst1, buf, STRIDE);
}

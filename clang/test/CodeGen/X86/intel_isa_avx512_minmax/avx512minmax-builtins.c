...
__m512bh test_mm512_minmaxne_pbf16(__m512bh __A, __m512bh __B) {
  // CHECK-LABEL: @test_mm512_minmaxne_pbf16(
  // CHECK: call <32 x i16> @llvm.x86.avx512minmax.vminmaxnepbf16512(
  return _mm512_minmaxne_pbf16(__A, __B, 127);
}

__m512bh test_mm512_mask_minmaxne_pbf16(__m512bh __A, __mmask32 __B, __m512bh __C, __m512bh __D) {
  // CHECK-LABEL: @test_mm512_mask_minmaxne_pbf16(
  // CHECK: call <32 x i16> @llvm.x86.avx512minmax.mask.vminmaxnepbf16512(
  return _mm512_mask_minmaxne_pbf16(__A, __B, __C, __D, 127);
}

__m512bh test_mm512_maskz_minmaxne_pbf16(__mmask32 __A, __m512bh __B, __m512bh __C) {
  // CHECK-LABEL: @test_mm512_maskz_minmaxne_pbf16(
  // CHECK: call <32 x i16> @llvm.x86.avx512minmax.mask.vminmaxnepbf16512(
  return _mm512_maskz_minmaxne_pbf16(__A, __B, __C, 127);
}

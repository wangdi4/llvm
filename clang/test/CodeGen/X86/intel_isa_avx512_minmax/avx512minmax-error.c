...
// RUN: %clang_cc1 %s -ffreestanding -triple=x86_64-unknown-unknown -target-feature +avx512f -target-feature +avx512minmax -target-feature +avx512vl \
...
__m128bh test_mm_minmaxne_pbf16(__m128bh __A, __m128bh __B) {
  return _mm_minmaxne_pbf16(__A, __B, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}

__m128bh test_mm_mask_minmaxne_pbf16(__m128bh __A, __mmask8 __B, __m128bh __C, __m128bh __D) {
  return _mm_mask_minmaxne_pbf16(__A, __B, __C, __D, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}

__m256bh test_mm256_minmaxne_pbf16(__m256bh __A, __m256bh __B) {
  return _mm256_minmaxne_pbf16(__A, __B, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}

__m256bh test_mm256_mask_minmaxne_pbf16(__m256bh __A, __mmask16 __B, __m256bh __C, __m256bh __D) {
  return _mm256_mask_minmaxne_pbf16(__A, __B, __C, __D, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}
...
__m512bh test_mm512_minmaxne_pbf16(__m512bh __A, __m512bh __B) {
  return _mm512_minmaxne_pbf16(__A, __B, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}

__m512bh test_mm512_mask_minmaxne_pbf16(__m512bh __A, __mmask32 __B, __m512bh __C, __m512bh __D) {
  return _mm512_mask_minmaxne_pbf16(__A, __B, __C, __D, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}

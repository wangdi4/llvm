...
__m128d test_mm_minmaxsd_sd(__m128d __A, __m128d __B) {
  return _mm_minmaxsd_sd(__A, __B, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}

__m128h test_mm_minmaxsh_sh(__m128h __A, __m128h __B) {
  return _mm_minmaxsh_sh(__A, __B, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}

__m128 test_mm_minmaxss_ss(__m128 __A, __m128 __B) {
  return _mm_minmaxss_ss(__A, __B, 256); // expected-error {{argument value 256 is outside the valid range [0, 255]}}
}

__m512d test_mm512_minmaxpd_round_pd(__m512d __A, __m512d __B) {
  return _mm512_minmaxpd_round_pd(__A, __B, 127, 11); // expected-error {{invalid rounding argument}}
}

__m512h test_mm512_minmaxph_round_ph(__m512h __A, __m512h __B) {
  return _mm512_minmaxph_round_ph(__A, __B, 127, 11); // expected-error {{invalid rounding argument}}
}

__m512 test_mm512_minmaxps_round_ps(__m512 __A, __m512 __B) {
  return _mm512_minmaxps_round_ps(__A, __B, 127, 11); // expected-error {{invalid rounding argument}}
}

__m128d test_mm_minmaxsd_round_sd(__m128d __A, __m128d __B) {
  return _mm_minmaxsd_round_sd(__A, __B, 127, 11); // expected-error {{invalid rounding argument}}
}

__m128h test_mm_minmaxsh_round_sh(__m128h __A, __m128h __B) {
  return _mm_minmaxsh_round_sh(__A, __B, 127, 11); // expected-error {{invalid rounding argument}}
}

__m128 test_mm_minmaxss_round_ss(__m128 __A, __m128 __B) {
  return _mm_minmaxss_round_ss(__A, __B, 127, 11); // expected-error {{invalid rounding argument}}
}

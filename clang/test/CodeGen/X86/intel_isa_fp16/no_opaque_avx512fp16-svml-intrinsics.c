// RUN: %clang_cc1 -ffreestanding %s -triple=x86_64-unknown-linux-gnu -target-feature +avx512fp16 -emit-llvm -no-opaque-pointers -o - -Wall -Werror | FileCheck %s --check-prefix=CHECK-AVX512FP16

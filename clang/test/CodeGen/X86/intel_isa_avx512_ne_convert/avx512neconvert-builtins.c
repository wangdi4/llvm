...
__m512 test_mm512_bcstnebf16_ps(const __bf16 * __A) {
  ...
  // CHECK: call <16 x float> @llvm.x86.vbcstnebf162ps512(ptr %{{.*}})
...
__m512 test_mm512_mask_bcstnebf16_ps(__m512 __W, __mmask16 __A, const __bf16 * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.mask.vbcstnebf162ps512(<16 x float> %{{.*}}, i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_bcstnesh_ps(const _Float16 * __A) {
  ...
  // CHECK: call <16 x float> @llvm.x86.vbcstnesh2ps512(ptr %{{.*}})
...
__m512 test_mm512_mask_bcstnesh_ps(__m512 __W, __mmask16 __A, const _Float16 * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.mask.vbcstnesh2ps512(<16 x float> %{{.*}}, i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_maskz_bcstnesh_ps(__mmask16 __A, const _Float16 * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.maskz.vbcstnesh2ps512(i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_cvtneebf16_ps(const __m512bh * __A) {
  ...
  // CHECK: call <16 x float> @llvm.x86.vcvtneebf162ps512(ptr %{{.*}})
...
__m512 test_mm512_mask_cvtneebf16_ps(__m512 __W, __mmask16 __A, const __m512bh * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.mask.vcvtneebf162ps512(<16 x float> %{{.*}}, i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_maskz_cvtneebf16_ps(__mmask16 __A, const __m512bh * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.maskz.vcvtneebf162ps512(i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_cvtneeph_ps(const __m512h * __A) {
  ...
  // CHECK: call <16 x float> @llvm.x86.vcvtneeph2ps512(ptr %{{.*}})
...
__m512 test_mm512_mask_cvtneeph_ps(__m512 __W, __mmask16 __A, const __m512h * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.mask.vcvtneeph2ps512(<16 x float> %{{.*}}, i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_maskz_cvtneeph_ps(__mmask16 __A, const __m512h * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.maskz.vcvtneeph2ps512(i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_cvtneobf16_ps(const __m512bh * __A) {
  ...
  // CHECK: call <16 x float> @llvm.x86.vcvtneobf162ps512(ptr %{{.*}})
...
__m512 test_mm512_mask_cvtneobf16_ps(__m512 __W, __mmask16 __A, const __m512bh * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.mask.vcvtneobf162ps512(<16 x float> %{{.*}}, i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_maskz_cvtneobf16_ps(__mmask16 __A, const __m512bh * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.maskz.vcvtneobf162ps512(i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_cvtneoph_ps(const __m512h * __A) {
  ...
  // CHECK: call <16 x float> @llvm.x86.vcvtneoph2ps512(ptr %{{.*}})
...
__m512 test_mm512_mask_cvtneoph_ps(__m512 __W, __mmask16 __A, const __m512h * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.mask.vcvtneoph2ps512(<16 x float> %{{.*}}, i16 %{{.*}}, ptr %{{.*}})
...
__m512 test_mm512_maskz_cvtneoph_ps(__mmask16 __A, const __m512h * __B) {
  ...
  // CHECK: call <16 x float> @llvm.x86.avx512.maskz.vcvtneoph2ps512(i16 %{{.*}}, ptr %{{.*}})

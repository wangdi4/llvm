...
// RUN: %clang_cc1 %s -ffreestanding -triple=x86_64-unknown-unknown -target-feature +avx512fp16 -target-feature +avx512neconvert -target-feature +avx512vl \
...
__m128 test_mm_mask_bcstnebf16_ps(__m128 __W, __mmask8 __A, const __bf16 * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.mask.vbcstnebf162ps128(<4 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_maskz_bcstnebf16_ps(__mmask8 __A, const __bf16 * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.maskz.vbcstnebf162ps128(i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_mask_bcstnebf16_ps(__m256 __W, __mmask8 __A, const __bf16 * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.mask.vbcstnebf162ps256(<8 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_maskz_bcstnebf16_ps(__mmask8 __A, const __bf16 * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.maskz.vbcstnebf162ps256(i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_mask_bcstnesh_ps(__m128 __W, __mmask8 __A, const _Float16 * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.mask.vbcstnesh2ps128(<4 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_maskz_bcstnesh_ps(__mmask8 __A, const _Float16 * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.maskz.vbcstnesh2ps128(i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_mask_bcstnesh_ps(__m256 __W, __mmask8 __A, const _Float16 * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.mask.vbcstnesh2ps256(<8 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_maskz_bcstnesh_ps(__mmask8 __A, const _Float16 * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.maskz.vbcstnesh2ps256(i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_mask_cvtneebf16_ps(__m128 __W, __mmask8 __A, const __m128bh * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.mask.vcvtneebf162ps128(<4 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_maskz_cvtneebf16_ps(__mmask8 __A, const __m128bh * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.maskz.vcvtneebf162ps128(i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_mask_cvtneebf16_ps(__m256 __W, __mmask8 __A, const __m256bh * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.mask.vcvtneebf162ps256(<8 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_maskz_cvtneebf16_ps(__mmask8 __A, const __m256bh * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.maskz.vcvtneebf162ps256(i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_mask_cvtneeph_ps(__m128 __W, __mmask8 __A, const __m128h * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.mask.vcvtneeph2ps128(<4 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_maskz_cvtneeph_ps(__mmask8 __A, const __m128h * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.maskz.vcvtneeph2ps128(i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_mask_cvtneeph_ps(__m256 __W, __mmask8 __A, const __m256h * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.mask.vcvtneeph2ps256(<8 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_maskz_cvtneeph_ps(__mmask8 __A, const __m256h * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.maskz.vcvtneeph2ps256(i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_mask_cvtneobf16_ps(__m128 __W, __mmask8 __A, const __m128bh * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.mask.vcvtneobf162ps128(<4 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_maskz_cvtneobf16_ps(__mmask8 __A, const __m128bh * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.maskz.vcvtneobf162ps128(i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_mask_cvtneobf16_ps(__m256 __W, __mmask8 __A, const __m256bh * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.mask.vcvtneobf162ps256(<8 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_maskz_cvtneobf16_ps(__mmask8 __A, const __m256bh * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.maskz.vcvtneobf162ps256(i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_mask_cvtneoph_ps(__m128 __W, __mmask8 __A, const __m128h * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.mask.vcvtneoph2ps128(<4 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m128 test_mm_maskz_cvtneoph_ps(__mmask8 __A, const __m128h * __B) {
  ...
  // CHECK: call <4 x float> @llvm.x86.avx512.maskz.vcvtneoph2ps128(i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_mask_cvtneoph_ps(__m256 __W, __mmask8 __A, const __m256h * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.mask.vcvtneoph2ps256(<8 x float> %{{.*}}, i8 %{{.*}}, ptr %{{.*}})
...
__m256 test_mm256_maskz_cvtneoph_ps(__mmask8 __A, const __m256h * __B) {
  ...
  // CHECK: call <8 x float> @llvm.x86.avx512.maskz.vcvtneoph2ps256(i8 %{{.*}}, ptr %{{.*}})

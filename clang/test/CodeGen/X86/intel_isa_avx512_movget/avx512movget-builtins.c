...
// RUN: %clang_cc1 %s -ffreestanding -triple=x86_64-unknown-unknown -target-feature +avx512f -target-feature +avx512movget \
...
__m512i test_mm512_vmovget_epi32(const __m512i *__A) {
  ...
  // CHECK: call <16 x i32> @llvm.x86.vmovget512(ptr %{{.*}})

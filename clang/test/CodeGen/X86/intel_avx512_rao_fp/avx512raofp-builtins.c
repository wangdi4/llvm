...
// RUN: %clang_cc1 %s -ffreestanding -triple=x86_64-unknown-unknown -target-feature +avx512f -target-feature +avx512fp16 -target-feature +avx512raofp \
...
void test_mm512_vaadd_pbh(__m512bh *__A, __m512bh __B) {
  ...
  // CHECK: call void @llvm.x86.vaaddpbf16512(ptr %{{.*}}, <32 x i16> %{{.*}})

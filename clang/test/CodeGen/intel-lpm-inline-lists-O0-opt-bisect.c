...
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fcoroutines-ts 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=address 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=hwaddress 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=memory 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=thread 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=local-bounds 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=dataflow 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize-coverage-trace-pc-guard 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu -O0 %s -fexperimental-new-pass-manager -mdebug-pass Structure -emit-llvm -o /dev/null -fmemory-profile 2>&1 | FileCheck %s --check-prefix=NEWPM

// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fcoroutines-ts 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=address 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=hwaddress 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=memory 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=thread 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=local-bounds 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize=dataflow 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fsanitize-coverage-trace-pc-guard 2>&1 | FileCheck %s --check-prefix=NEWPM
// RUN: %clang_cc1 -triple x86_64-linux-gnu %s -fexperimental-new-pass-manager -mllvm -opt-bisect-limit=0 -mdebug-pass Structure -emit-llvm -o /dev/null -fmemory-profile 2>&1 | FileCheck %s --check-prefix=NEWPM

// RUN: %clang_cc1  -ax=broadwell,skylake-avx512 -triple x86_64-linux-gnu -emit-llvm -no-opaque-pointers -o - %s -fopenmp -fintel-openmp-region -disable-llvm-passes | FileCheck %s

...
//X64-NEXT:   store i32 %zc, i32* %zc.addr, align 4
//X64-NEXT:   store i8* %lock, i8** %lock.addr, align 8
//X64-NEXT:   %0 = load i32, i32* %zc.addr, align 4
...
//X64-NEXT:   %1 = load i8*, i8** %lock.addr, align 8
//X64-NEXT:   call void @llvm.notify.nzc(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* %1)
//X64-NEXT:   br label %if.end

//X64:      if.else:                                          ; preds = %entry
//X64-NEXT:   fence syncscope("singlethread") seq_cst
//X64-NEXT:   %2 = load i8*, i8** %lock.addr, align 8
//X64-NEXT:   %add.ptr = getelementptr i8, i8* %2, i64 4
//X64-NEXT:   call void @llvm.notify.nzc(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0), i8* %add.ptr)
//X64-NEXT:   br label %if.end

//X64:      if.end:                                           ; preds = %if.else, %if.then
//X64-NEXT:   %3 = load i8*, i8** %lock.addr, align 8
//X64-NEXT:   %4 = load i32, i32* %zc.addr, align 4
//X64-NEXT:   %idx.ext = sext i32 %4 to i64
//X64-NEXT:   %add.ptr1 = getelementptr i8, i8* %3, i64 %idx.ext
//X64-NEXT:   call void @llvm.notify.zc(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* %add.ptr1)
//X64-NEXT:   %5 = load i32, i32* @foo.lock2, align 4
//X64-NEXT:   %6 = load i32, i32* @foo.lock3, align 4
//X64-NEXT:   %add = add nsw i32 %5, %6
//X64-NEXT:   store i32 %add, i32* @foo.lock2, align 4
//X64-NEXT:   fence syncscope("singlethread") seq_cst
...
//X86-NEXT:   store i32 %zc, i32* %zc.addr, align 4
//X86-NEXT:   store i8* %lock, i8** %lock.addr, align 4
//X86-NEXT:   %0 = load i32, i32* %zc.addr, align 4
...
//X86-NEXT:   %1 = load i8*, i8** %lock.addr, align 4
//X86-NEXT:   call void @llvm.notify.nzc(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i8* %1)
//X86-NEXT:   br label %if.end

//X86:      if.else:                                          ; preds = %entry
//X86-NEXT:   fence syncscope("singlethread") seq_cst
//X86-NEXT:   %2 = load i8*, i8** %lock.addr, align 4
//X86-NEXT:   %add.ptr = getelementptr i8, i8* %2, i32 4
//X86-NEXT:   call void @llvm.notify.nzc(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i8* %add.ptr)
//X86-NEXT:   br label %if.end

//X86:      if.end:                                           ; preds = %if.else, %if.then
//X86-NEXT:   %3 = load i8*, i8** %lock.addr, align 4
//X86-NEXT:   %4 = load i32, i32* %zc.addr, align 4
//X86-NEXT:   %add.ptr1 = getelementptr i8, i8* %3, i32 %4
//X86-NEXT:   call void @llvm.notify.zc(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i8* %add.ptr1)
//X86-NEXT:   %5 = load i32, i32* @foo.lock2, align 4
//X86-NEXT:   %6 = load i32, i32* @foo.lock3, align 4
//X86-NEXT:   %add = add nsw i32 %5, %6
//X86-NEXT:   store i32 %add, i32* @foo.lock2, align 4
//X86-NEXT:   fence syncscope("singlethread") seq_cst

...
__m512h test_m512_mask_vcvt2ps2ph_ph( __m512h __W, __mmask16 __U, __m512 __A, __m512 __B) {
  return _m512_mask_vcvt2ps2ph_ph(__W, __U, __A, __B);
}

// CHECK-LABEL: @test_mm512_mask_vcvt2ps2ph_round_ph(
// CHECK:    call <32 x half> @llvm.x86.avx512.mask.vcvt2ps2ph.512
__m512h test_mm512_mask_vcvt2ps2ph_round_ph(__m512h __W, __mmask16 __U, __m512 __A, __m512 __B) {
...
__m512h test_m512_mask_vcvtbf162ph_ph(__m512h __W, __mmask16 __U, __m512i __A) {
  return _m512_mask_vcvtbf162ph_ph(__W, __U, __A);
}

// CHECK-LABEL: @test_mm512_mask_vcvtbf162ph_round_ph(
// CHECK:    call <32 x half> @llvm.x86.avx512.mask.vcvtbf162ph.512
__m512h test_mm512_mask_vcvtbf162ph_round_ph(__m512h __W, __mmask16 __U, __m512i __A) {
...
__m512i test_m512_mask_vcvtneph2bf16_ph(__m512i __W, __mmask16 __U, __m512h __A) {

...
// RUN: %clang_cc1 -ffreestanding %s -triple=x86_64-unknown-unknown -target-feature +avx512vl -target-feature +avx512convert -target-feature +avx512fp16 -emit-llvm -o - -Wall -Werror | FileCheck %s

#include <immintrin.h>

// CHECK-LABEL: @test_m128_mask_vcvt2ps2ph_ph(
// CHECK:    call <8 x half> @llvm.x86.avx512.mask.vcvt2ps2ph.128
__m128h test_m128_mask_vcvt2ps2ph_ph( __m128h __W, __mmask16 __U, __m128 __A, __m128 __B) {
...
__m128h test_m128_mask_vcvtbf162ph_ph(__m128h __W, __mmask16 __U, __m128i __A) {
...
__m128i test_m128_mask_vcvtneph2bf16_ph(__m128i __W, __mmask16 __U, __m128h __A) {

...
#if INTEL_CUSTOMIZATION
  /// Indicates if Intel compatibility check usage should emit diagnostic.
  bool ShowIntelCompatUsed = false;
  bool ShowIntelCompatUnused = false;
  /// Indicates if OpenMP target simd enabled.
  bool OpenMPTargetSimd = false;
#endif // INTEL_CUSTOMIZATION

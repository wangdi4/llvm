...
private:
  ...
  OptReportHandler SyclOptReport; // INTEL
...
public:
  ...
  OptReportHandler &getSYCLOptReport() { return SyclOptReport; }
  const OptReportHandler &getSYCLOptReport() const { return SyclOptReport; }
#endif // INTEL_CUSTOMIZATION

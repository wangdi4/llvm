...
class LLVM_LIBRARY_VISIBILITY X86TargetInfo : public TargetInfo {
  ...
  bool HasAVXMOVRS = false;
  bool HasAVX512MOVRS = false;
...
// end AUTO GENERATED BY TOOL
  ...
  bool HasAMXAVX512TILE16MOV = false;

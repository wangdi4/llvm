...
Value *CodeGenFunction::EmitCSABuiltinExpr(unsigned BuiltinID,
  ...
  case CSA::BI__builtin_csa_directive: {
    ...
    Function *Callee = CGM.getIntrinsic(Intrinsic::csa_directive,
                                        X->getType());
  ...
  case CSA::BI__builtin_csa_spmd: {
    Value *X = EmitScalarExpr(E->getArg(0));
    Value *Y = EmitScalarExpr(E->getArg(1));
    Function *Callee = CGM.getIntrinsic(Intrinsic::csa_spmd,
                                        {X->getType(), Y->getType()});
  ...
  case CSA::BI__builtin_csa_pipeline_loop: {
    Value *X = EmitScalarExpr(E->getArg(0));
    Function *Callee = CGM.getIntrinsic(Intrinsic::csa_pipeline_loop,
                                        X->getType());
    return Builder.CreateCall(Callee, X);
  }
  case CSA::BI__builtin_csa_local_cache: {
    Value *X = EmitScalarExpr(E->getArg(0));
    Function *Callee = CGM.getIntrinsic(Intrinsic::csa_local_cache,
                                        X->getType());
    return Builder.CreateCall(Callee, X);
  }
  ...
  case CSA::BI__builtin_csa_lic_preload: {
    ...
    Function *Callee = CGM.getIntrinsic(Intrinsic::csa_lic_preload,
                                        {OverloadTy});
    return Builder.CreateCall(Callee, {X, Y});
  }

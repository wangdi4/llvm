...
>>>>>>> e259432b502856ee6f9206b2eb94ead57790c61d
  // All the inputs are encoded as commands.
  C.addCommand(std::make_unique<Command>(
      JA, *this, ResponseFileSupport::None(),
      TCArgs.MakeArgString(getToolChain().GetProgramPath(getShortName())),
...
void SYCLPostLink::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  TC.TranslateTargetOpt(JA.getOffloadingDeviceKind(), TCArgs, CmdArgs, options::OPT_Xdevice_post_link,
...
#if INTEL_CUSTOMIZATION
  TC.TranslateTargetOpt(JA.getOffloadingDeviceKind(),
                        TCArgs, CmdArgs, options::OPT_Xspirv_to_ir_wrapper,
#endif // INTEL_CUSTOMIZATION

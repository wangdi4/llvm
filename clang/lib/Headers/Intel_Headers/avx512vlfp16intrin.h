...
_mm256_mask_conj_pch(__m256h __W, __mmask8 __U, __m256h __A) {
  return (__m256h)__builtin_ia32_selectps_256((__mmask8)__U,
                                              (__v8sf)_mm256_conj_pch(__A),
                                              (__v8sf)__W);
}
...
_mm_mask_conj_pch(__m128h __W, __mmask8 __U, __m128h __A) {
  return (__m128h)__builtin_ia32_selectps_128((__mmask8)__U,
                                              (__v4sf)_mm_conj_pch(__A),
                                              (__v4sf)__W);
}
...
_mm256_rcp_ph(__m256h __A) {
  return (__m256h) __builtin_ia32_rcpph256_mask ((__v16hf) __A,
...
_mm_rcp_ph(__m128h __A) {
  return (__m128h) __builtin_ia32_rcpph128_mask ((__v8hf) __A,
            (__v8hf) _mm_undefined_ph (),
            (__mmask8) -1);
}

static __inline__ __m128h __DEFAULT_FN_ATTRS128
_mm_mask_rcp_ph(__m128h __W, __mmask8 __U, __m128h __A) {
  return (__m128h) __builtin_ia32_rcpph128_mask ((__v8hf) __A,
            (__v8hf) __W,
            (__mmask8) __U);
}
...
static __inline__ __m128h __DEFAULT_FN_ATTRS128
_mm_maskz_rcp_ph(__mmask8 __U, __m128h __A) {
  return (__m128h) __builtin_ia32_rcpph128_mask ((__v8hf) __A,
            (__v8hf) _mm_setzero_ph (),
            (__mmask8) __U);
}
...
_mm256_rsqrt_ph(__m256h __A) {
  return (__m256h) __builtin_ia32_rsqrtph256_mask ((__v16hf) __A,
            (__v16hf) _mm256_undefined_ph (),
            (__mmask16) -1);
}
...
_mm_rsqrt_ph(__m128h __A) {
  return (__m128h) __builtin_ia32_rsqrtph128_mask ((__v8hf) __A,
            (__v8hf) _mm_undefined_ph (),
            (__mmask8) -1);
}

static __inline__ __m128h __DEFAULT_FN_ATTRS128
_mm_mask_rsqrt_ph(__m128h __W, __mmask8 __U, __m128h __A) {
  return (__m128h) __builtin_ia32_rsqrtph128_mask ((__v8hf) __A,
            (__v8hf) __W,
            (__mmask8) __U);
}
...
#define _mm_getmant_ph(A, B, C) \
  (__m128h)__builtin_ia32_getmantph128_mask((__v8hf)(__m128h)(A), \
                                           (int)(((C)<<2) | (B)), \
                                           (__v8hf)_mm_setzero_ph(), \
                                           (__mmask8)-1)
...
#define _mm256_getmant_ph(A, B, C)  \
  (__m256h)__builtin_ia32_getmantph256_mask((__v16hf)(__m256h)(A), \
                                           (int)(((C)<<2) | (B)), \
                                           (__v16hf)_mm256_setzero_ph(), \
                                           (__mmask16)-1)
...
_mm_scalef_ph (__m128h __A, __m128h __B) {
  return (__m128h) __builtin_ia32_scalefph128_mask ((__v8hf) __A,
               (__v8hf) __B,
               (__v8hf)
               _mm_setzero_ph (),
               (__mmask8) -1);
...
_mm256_scalef_ph (__m256h __A, __m256h __B) {
  return (__m256h) __builtin_ia32_scalefph256_mask ((__v16hf) __A,
               (__v16hf) __B,
               (__v16hf)
               _mm256_setzero_ph (),
               (__mmask16) -1);
...
static __inline__ __m256h __DEFAULT_FN_ATTRS256
_mm256_mask_scalef_ph (__m256h __W, __mmask16 __U, __m256h __A,
           __m256h __B) {
  return (__m256h) __builtin_ia32_scalefph256_mask ((__v16hf) __A,
               (__v16hf) __B,
               (__v16hf) __W,
...
#define _mm_roundscale_ph(A, imm)  \
  (__m128h)__builtin_ia32_rndscaleph_128_mask((__v8hf)(__m128h)(A), \
                                              (int)(imm), \
                                              (__v8hf)_mm_setzero_ph(), \
                                              (__mmask8)-1)
...
#define _mm256_roundscale_ph(A, imm)  \
  (__m256h)__builtin_ia32_rndscaleph_256_mask((__v16hf)(__m256h)(A), \
                                              (int)(imm), \
                                              (__v16hf)_mm256_setzero_ph(), \
                                              (__mmask16)-1)
...
#define _mm_reduce_ph(A, imm)  \
  (__m128h)__builtin_ia32_reduceph128_mask((__v8hf)(__m128h)(A), \
                                              (int)(imm), \
                                              (__v8hf)_mm_setzero_ph(), \
                                              (__mmask8)-1)
...
#define _mm256_reduce_ph(A, imm)  \
  (__m256h)__builtin_ia32_reduceph256_mask((__v16hf)(__m256h)(A), \
                                              (int)(imm), \
                                              (__v16hf)_mm256_setzero_ph(), \
                                              (__mmask16)-1)
...
static __inline__ __m128h __DEFAULT_FN_ATTRS128
_mm_mask_sqrt_ph(__m128h __W, __mmask8 __U, __m128h __A) {
  return (__m128h)__builtin_ia32_selectph_128((__mmask8)__U,
                                             (__v8hf)_mm_sqrt_ph(__A),
                                             (__v8hf)__W);
}

static __inline__ __m128h __DEFAULT_FN_ATTRS128
_mm_maskz_sqrt_ph(__mmask8 __U, __m128h __A) {
  return (__m128h)__builtin_ia32_selectph_128((__mmask8)__U,
                                             (__v8hf)_mm_sqrt_ph(__A),
                                             (__v8hf)_mm_setzero_ph());
}
...
#define _mm_mask_fpclass_ph_mask(U, A, imm) \
  (__mmask8)__builtin_ia32_fpclassph128_mask((__v8hf)(__m128h)(A), (int)(imm), \
                                             (__mmask8)(U))
...
#define _mm256_mask_fpclass_ph_mask(U, A, imm) \
  (__mmask16)__builtin_ia32_fpclassph256_mask((__v16hf)(__m256h)(A), (int)(imm), \
                                             (__mmask16)(U))
...
static __inline__ __m128h __DEFAULT_FN_ATTRS128
_mm_mask_cvtpd_ph(__m128h __W, __mmask8 __U, __m128d __A) {
  return (__m128h)__builtin_ia32_vcvtpd2ph128_mask(
      (__v2df)__A, (__v8hf)__W, (__mmask8)__U);
}
...
static __inline__ __m128d __DEFAULT_FN_ATTRS128
_mm_mask_cvtph_pd(__m128d __W, __mmask8 __U, __m128h __A) {
  return (__m128d)__builtin_ia32_vcvtph2pd128_mask(
      (__v8hf)__A, (__v2df)__W, (__mmask8)__U);
}
...
static __inline__ __m128 __DEFAULT_FN_ATTRS128
_mm_mask_cvtxph_ps(__m128 __W, __mmask8 __U, __m128h __A) {
...
static __inline__ __m128h __DEFAULT_FN_ATTRS128
_mm_mask_cvtxps_ph(__m128h __W, __mmask8 __U, __m128 __A) {
...
{
  return (__m128h) __builtin_ia32_vfcmulcph128_mask ((__v4sf) __A,
                                                    (__v4sf) __B,
...
{
  return (__m256h) __builtin_ia32_vfcmulcph256_mask ((__v8sf) __A,
                                                    (__v8sf) __B,
                                                    (__v8sf) _mm256_undefined_ph (),
                                                    (__mmask8) -1);
}
...
{
  return (__m128h) __builtin_ia32_vfcmaddcph128_mask ((__v4sf) __A,
                                                    (__v4sf) __B,
                                                    (__v4sf) __C,
                                                    (__mmask8) -1);
}
...
{
  return (__m128h) __builtin_ia32_vfcmaddcph128_maskz ((__v4sf) __A,
                                                    (__v4sf) __B,
                                                    (__v4sf) __C,
                                                    (__mmask8) __U);
}
...
{
  return (__m256h) __builtin_ia32_vfcmaddcph256_maskz ((__v8sf) __A,
                                                    (__v8sf) __B,
                                                    (__v8sf) __C,
                                                    (__mmask8) __U);
}
...
{
  return (__m128h) __builtin_ia32_vfmulcph128_mask ((__v4sf) __A,
                                                    (__v4sf) __B,
                                                    (__v4sf) _mm_undefined_ph (),
                                                    (__mmask8) -1);
}
...
static __inline__ __m128h __DEFAULT_FN_ATTRS128
_mm_mask_fmul_pch(__m128h __W, __mmask8 __U, __m128h __A, __m128h __B)
{
  return (__m128h) __builtin_ia32_vfmulcph128_mask ((__v4sf) __A,
                                                    (__v4sf) __B,
                                                    (__v4sf) __W,
...
{
  return (__m256h) __builtin_ia32_vfmulcph256_mask ((__v8sf) __A,
                                                   (__v8sf) __B,
                                                   (__v8sf) _mm256_undefined_ph (),
                                                   (__mmask8) -1);
}
...
{
  return (__m128h) __builtin_ia32_vfmaddcph128_mask ((__v4sf) __A,
                                                    (__v4sf) __B,
                                                    (__v4sf) __C,
                                                    (__mmask8) -1);
}
...
{
  return (__m128h) __builtin_ia32_vfmaddcph128_maskz ((__v4sf) __A,
                                                   (__v4sf) __B,
                                                   (__v4sf) __C,
                                                   (__mmask8) __U);
}
...
{
  return (__m256h) __builtin_ia32_vfmaddcph256_mask ((__v8sf) __A,
                                                   (__v8sf) __B,
                                                   (__v8sf) __C,
                                                   (__mmask8) -1);
}
...
{
  return (__m256h) __builtin_ia32_vfmaddcph256_maskz ((__v8sf) __A,
                                                   (__v8sf) __B,
                                                   (__v8sf) __C,
                                                   (__mmask8) __U);
}

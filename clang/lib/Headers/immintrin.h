...
#define CPU_FEATURE_BIT_POS(Bit) (1ULL << (Bit) % 64)

#define _FEATURE_GENERIC_IA32        CPU_FEATURE_BIT_POS(0)
#define _FEATURE_FPU                 CPU_FEATURE_BIT_POS(1)
#define _FEATURE_CMOV                CPU_FEATURE_BIT_POS(2)
#define _FEATURE_MMX                 CPU_FEATURE_BIT_POS(3)
#define _FEATURE_FXSAVE              CPU_FEATURE_BIT_POS(4)
#define _FEATURE_SSE                 CPU_FEATURE_BIT_POS(5)
#define _FEATURE_SSE2                CPU_FEATURE_BIT_POS(6)
#define _FEATURE_SSE3                CPU_FEATURE_BIT_POS(7)
#define _FEATURE_SSSE3               CPU_FEATURE_BIT_POS(8)
#define _FEATURE_SSE4_1              CPU_FEATURE_BIT_POS(9)
#define _FEATURE_SSE4_2              CPU_FEATURE_BIT_POS(10)
#define _FEATURE_MOVBE               CPU_FEATURE_BIT_POS(11)
#define _FEATURE_POPCNT              CPU_FEATURE_BIT_POS(12)
#define _FEATURE_PCLMULQDQ           CPU_FEATURE_BIT_POS(13)
#define _FEATURE_AES                 CPU_FEATURE_BIT_POS(14)
#define _FEATURE_F16C                CPU_FEATURE_BIT_POS(15)
#define _FEATURE_AVX                 CPU_FEATURE_BIT_POS(16)
#define _FEATURE_RDRND               CPU_FEATURE_BIT_POS(17)
#define _FEATURE_FMA                 CPU_FEATURE_BIT_POS(18)
#define _FEATURE_BMI                 CPU_FEATURE_BIT_POS(19)
#define _FEATURE_LZCNT               CPU_FEATURE_BIT_POS(20)
#define _FEATURE_HLE                 CPU_FEATURE_BIT_POS(21)
#define _FEATURE_RTM                 CPU_FEATURE_BIT_POS(22)
#define _FEATURE_AVX2                CPU_FEATURE_BIT_POS(23)
#define _FEATURE_AVX512DQ            CPU_FEATURE_BIT_POS(24)
#define _FEATURE_PTWRITE             CPU_FEATURE_BIT_POS(25)
#define _FEATURE_AVX512F             CPU_FEATURE_BIT_POS(27)
#define _FEATURE_ADX                 CPU_FEATURE_BIT_POS(28)
#define _FEATURE_RDSEED              CPU_FEATURE_BIT_POS(29)
#define _FEATURE_AVX512IFMA52        CPU_FEATURE_BIT_POS(30)
#define _FEATURE_AVX512ER            CPU_FEATURE_BIT_POS(32)
#define _FEATURE_AVX512PF            CPU_FEATURE_BIT_POS(33)
#define _FEATURE_AVX512CD            CPU_FEATURE_BIT_POS(34)
#define _FEATURE_SHA                 CPU_FEATURE_BIT_POS(35)
#define _FEATURE_MPX                 CPU_FEATURE_BIT_POS(36)
#define _FEATURE_AVX512BW            CPU_FEATURE_BIT_POS(37)
#define _FEATURE_AVX512VL            CPU_FEATURE_BIT_POS(38)
#define _FEATURE_AVX512VBMI          CPU_FEATURE_BIT_POS(39)
#define _FEATURE_AVX512_4FMAPS       CPU_FEATURE_BIT_POS(40)
#define _FEATURE_AVX512_4VNNIW       CPU_FEATURE_BIT_POS(41)
#define _FEATURE_AVX512_VPOPCNTDQ    CPU_FEATURE_BIT_POS(42)
#define _FEATURE_AVX512_BITALG       CPU_FEATURE_BIT_POS(43)
#define _FEATURE_AVX512_VBMI2        CPU_FEATURE_BIT_POS(44)
#define _FEATURE_GFNI                CPU_FEATURE_BIT_POS(45)
#define _FEATURE_VAES                CPU_FEATURE_BIT_POS(46)
#define _FEATURE_VPCLMULQDQ          CPU_FEATURE_BIT_POS(47)
#define _FEATURE_AVX512_VNNI         CPU_FEATURE_BIT_POS(48)
#define _FEATURE_CLWB                CPU_FEATURE_BIT_POS(49)
#define _FEATURE_RDPID               CPU_FEATURE_BIT_POS(50)
#define _FEATURE_IBT                 CPU_FEATURE_BIT_POS(51)
#define _FEATURE_SHSTK               CPU_FEATURE_BIT_POS(52)
#define _FEATURE_SGX                 CPU_FEATURE_BIT_POS(53)
#define _FEATURE_WBNOINVD            CPU_FEATURE_BIT_POS(54)
#define _FEATURE_PCONFIG             CPU_FEATURE_BIT_POS(55)
#define _FEATURE_AXV512_VP2INTERSECT CPU_FEATURE_BIT_POS(56)
...
#define _FEATURE_CLDEMOTE            CPU_FEATURE_BIT_POS(64)
#define _FEATURE_MOVDIRI             CPU_FEATURE_BIT_POS(65)
#define _FEATURE_MOVDIR64B           CPU_FEATURE_BIT_POS(66)
#define _FEATURE_WAITPKG             CPU_FEATURE_BIT_POS(67)
#define _FEATURE_AVX512_Bf16         CPU_FEATURE_BIT_POS(68)
#define _FEATURE_ENQCMD              CPU_FEATURE_BIT_POS(69)
#define _FEATURE_AVX_VNNI            CPU_FEATURE_BIT_POS(70)
#define _FEATURE_AMX_TILE            CPU_FEATURE_BIT_POS(71)
#define _FEATURE_AMX_INT8            CPU_FEATURE_BIT_POS(72)

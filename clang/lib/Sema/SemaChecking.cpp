...
bool Sema::CheckX86BuiltinRoundingOrSAE(unsigned BuiltinID, CallExpr *TheCall) {
  ...
  case X86::BI__builtin_ia32_vcvtne2ps2ph256_round:
...
bool Sema::CheckX86BuiltinTileArguments(unsigned BuiltinID, CallExpr *TheCall) {
  ...
  case X86::BI__builtin_ia32_ttdpbf8ps:
  case X86::BI__builtin_ia32_ttdpbhf8ps:
  case X86::BI__builtin_ia32_ttdphbf8ps:
  case X86::BI__builtin_ia32_ttdphf8ps:
    return CheckX86BuiltinTileRangeAndDuplicate(TheCall, {0, 1, 2});
#endif // INTEL_FEATURE_ISA_AMX_FP8_FUTURE
#if INTEL_FEATURE_ISA_AMX_MOVRS
  case X86::BI__builtin_ia32_tmovadvise_load:
    return CheckX86BuiltinTileArgumentsRange(TheCall, 0);
  ...
  case X86::BI__builtin_ia32_t2rpntlvwz0advisee:
  case X86::BI__builtin_ia32_t2rpntlvwz1advisee:
  ...
  case X86::BI__builtin_ia32_tcvt2ps2ph:
    return CheckX86BuiltinTileArgumentsRange(TheCall, {2, 3}, 0, 31);
  case X86::BI__builtin_ia32_amxconvert_tcvtd2ps:
  case X86::BI__builtin_ia32_amxconvert_tcvtps2bf16:
  case X86::BI__builtin_ia32_tcvtps2ph:
    return CheckX86BuiltinTileArgumentsRange(TheCall, 2, 0, 31);
  ...
  case X86::BI__builtin_ia32_tloadtransposed:
  case X86::BI__builtin_ia32_tloadtransposedt1:
  case X86::BI__builtin_ia32_trpntlvwz0:
  case X86::BI__builtin_ia32_trpntlvwz0t1:
  case X86::BI__builtin_ia32_trpntlvwz1:
  case X86::BI__builtin_ia32_trpntlvwz1t1:
    return CheckX86BuiltinTileArgumentsRange(TheCall, 0);
  case X86::BI__builtin_ia32_tstoretransposed:
    return CheckX86BuiltinTileArgumentsRange(TheCall, 2);
...
bool Sema::CheckX86BuiltinFunctionCall(const TargetInfo &TI, unsigned BuiltinID,
...
#if INTEL_CUSTOMIZATION
#if INTEL_FEATURE_ISA_AVX256P
  // FIXME: We may use it later.
  // case X86::BI__builtin_ia32_vcvtps2ph256_round_mask:
  case X86::BI__builtin_ia32_vreducepd256_round_mask:
  case X86::BI__builtin_ia32_vreduceps256_round_mask:
  case X86::BI__builtin_ia32_vreduceph256_round_mask:
  case X86::BI__builtin_ia32_vrndscalepd256_round_mask:
  ...
  case X86::BI__builtin_ia32_dvpsrrsuqw:
  case X86::BI__builtin_ia32_dvpslrsuqw:
  case X86::BI__builtin_ia32_dvpsrarsqw:
  case X86::BI__builtin_ia32_dvpslrsqw:
  case X86::BI__builtin_ia32_dvpsrrsuqd:
  case X86::BI__builtin_ia32_dvpslrsuqd:
  case X86::BI__builtin_ia32_dvpsrarsqd:
  case X86::BI__builtin_ia32_dvpslrsqd:
  ...
  case X86::BI__builtin_ia32_dvpmuluwdq:
  case X86::BI__builtin_ia32_dvpmulwdq:
  case X86::BI__builtin_ia32_dvpcaddrotsraw:
...
<<<<<<< HEAD
  ...
  case X86::BI__builtin_ia32_dvpdpbwuuds:
  case X86::BI__builtin_ia32_dvpdpbwssd:
  case X86::BI__builtin_ia32_dvpdpbwssds:
  case X86::BI__builtin_ia32_dvpdpbwsud:
  case X86::BI__builtin_ia32_dvpdpbwsuds:
  case X86::BI__builtin_ia32_dvpdpbwusd:
  case X86::BI__builtin_ia32_dvpdpbwusds:
  case X86::BI__builtin_ia32_dvpdpwduuq:
  case X86::BI__builtin_ia32_dvpdpwdssq:
  case X86::BI__builtin_ia32_dvpcr2bfrsdre:
  case X86::BI__builtin_ia32_dvpcr2bfrsdimm:
#endif // INTEL_FEATURE_ISA_DSPV1
#endif // INTEL_CUSTOMIZATION
=======
  case X86::BI__builtin_ia32_vsm3rnds2:
>>>>>>> c6f66de21af060ead6e5402858351e9e869dc15f
    i = 3; l = 0; u = 255;
    break;
  case X86::BI__builtin_ia32_gatherpfdpd:
  case X86::BI__builtin_ia32_gatherpfdps:
...
bool Sema::CheckHLSBuiltinFunctionCall(unsigned BuiltinID, CallExpr *TheCall) {
  ...
  case Builtin::BI__builtin_intel_hls_outstream_write: {
    ...
    if (!Pointer || !Pointer->getPointeeType()->isObjectType() ||
      ...
      return Diag(PointerArg->getBeginLoc(), diag::err_hls_builtin_arg_mismatch)
             << 0;

    // Second parameter is a unique identifier for this stream.
    Expr *BufferId = TheCall->getArg(1);
    if (!BufferId->getType()->isIntegerType())
      return Diag(BufferId->getBeginLoc(), diag::err_hls_builtin_arg_mismatch)
             << 1;
    ...
    for (int I = 5; I < 9; ++I) {
      ...
      if (!BoolArg->getType()->isBooleanType())
        return Diag(BoolArg->getBeginLoc(), diag::err_hls_builtin_arg_mismatch)
               << 4;
    }
  ...
  case Builtin::BI__builtin_intel_hls_mm_host_load: {
    ...
    if (!Size->getType()->isIntegerType())
      return Diag(Size->getBeginLoc(), diag::err_hls_builtin_arg_mismatch) << 1;

    // use_socket, boolean.
    Expr *UseSocket = TheCall->getArg(2);
    if (!UseSocket->getType()->isBooleanType())
      return Diag(UseSocket->getBeginLoc(), diag::err_hls_builtin_arg_mismatch)
             << 4;
    ...
    if (SemaBuiltinConstantArg(TheCall, 6, Result))
      return true;
    if (Result.isNegative())
      return Diag(TheCall->getArg(6)->getBeginLoc(),
                  diag::err_hls_builtin_arg_mismatch)
             << 2;
    ...
    if (Result < 1 || Result > 1024)
      return Diag(TheCall->getArg(7)->getBeginLoc(),
                  diag::err_hls_builtin_arg_mismatch)
             << 8;
    ...
    if (SemaBuiltinConstantArg(TheCall, 8, Result))
      return true;
    if (Result.isNegative())
      return Diag(TheCall->getArg(8)->getBeginLoc(),
                  diag::err_hls_builtin_arg_mismatch)
             << 2;
    ...
    if (!WaitRequest->getType()->isBooleanType())
      return Diag(WaitRequest->getBeginLoc(),
                  diag::err_hls_builtin_arg_mismatch)
             << 4;
...
bool Sema::SemaBuiltinVAArgPackChecks(CallExpr *TheCall, unsigned BuiltinID) {
  ...
  if (const FunctionDecl *FD = getCurFunctionDecl()) {
    ...
    if (!FD->isInlined() || !FD->isInlineSpecified() ||
      ...
      return Diag(Fn->getBeginLoc(), diag::err_va_arg_pack_invalid_usage)

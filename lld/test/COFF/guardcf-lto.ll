...
; RUN: lld-link -mllvm:-opaque-pointers -def:%t.def -out:%t.lib -machine:x64
...
; RUN: lld-link -mllvm:-opaque-pointers -entry:main -guard:cf -dll %t.bc %t.lib %t.ldcfg.obj -out:%t2.dll

...
; INTEL_CUSTOMIZATION
; RUN: lld-link -out:%t-lib.dll -dll -entry:DllMainCRTStartup %t-lib.obj /opt:opaque-pointers -lldmingw -implib:%t-lib.lib
; end INTEL_CUSTOMIZATION

; RUN: llvm-as -o %t.obj %s
; INTEL_CUSTOMIZATION
; RUN: lld-link -lldmingw -out:%t.exe -entry:entry /opt:opaque-pointers %t.obj %t-lib.lib
; end INTEL_CUSTOMIZATION

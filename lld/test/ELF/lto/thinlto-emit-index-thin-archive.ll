...
; INTEL_CUSTOMIZATION
; RUN: ld.lld -plugin-opt=opaque-pointers --thinlto-emit-index-files ./dir2/lib.a ./dir1/main.o -o c --save-temps
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; RUN: ld.lld -plugin-opt=opaque-pointers --thinlto-emit-index-files --whole-archive ./dir2/lib.a ./dir1/main.o -o d
; end INTEL_CUSTOMIZATION
; RUN: ls ./dir2 | FileCheck %s --check-prefix CHECK-UNUSED

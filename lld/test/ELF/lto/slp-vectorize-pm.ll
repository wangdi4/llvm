...
; This should fail when TODO above is resolved, just remove NOT then. ; INTEL
; CHECK-O2-LPV-NOT: = !{!"llvm.loop.isvectorized", i32 1} ;INTEL
; CHECK-O3-LPV-NOT: = !{!"llvm.loop.isvectorized", i32 1} ;INTEL

...
namespace __imf_impl_asin_d_ha {
namespace {
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c12 = {0x3fa07520c559a401UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c11 = {0xbf90fb17f2824aa0UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c10 = {0x3f943f44bc0c21f0UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c9 = {0x3f7a58339bb6f20cUL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c8 = {0x3f88f8dc2a3c76d7UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c7 = {0x3f8c6dbbcba98e67UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c6 = {0x3f91c6dcf536c796UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c5 = {0x3f96e89cebdf209cUL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c4 = {0x3f9f1c72e13ad6d3UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c3 = {0x3fa6db6db3b44600UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c2 = {0x3fb333333337e0deUL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c1 = {0x3fc555555555529cUL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_c0 = {0x3c70d208999dc313UL};
// 2.0
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_two = {0x4000000000000000UL};
// pi/2
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_pi2h = {0x3ff921fb54442d18UL};
static const union {
  uint64_t w;
  uint32_t w32[2];
  int32_t s32[2];
  double f;
} __dasin_ha_pi2l = {0x3c91a62633145c07UL};
static const union {
  uint32_t w;
  float f;
} __dasin_ha_small_float = {0x01800000u};
inline int __devicelib_imf_internal_dasin(const double *pxin, double *pres) {
  int nRet = 0;
  double xin = *pxin;
  union {
    uint64_t w;
  ...
  // double asin(double xin)
  {
    ...
    E = __fma(RS2.f, Sh, 0.5);
    // Sh+Sh*E accurate to ~46 bits
    Sh = __fma(Sh, E, Sh);
    // pi/2_high - 2*Sh
    High.f = __fma(-(Sh), __dasin_ha_two.f, __dasin_ha_pi2h.f);
    //  Shh2 = (-2*Sh)_high
    ...
    Low.f = __fma(-(E), RS.f, __dasin_ha_pi2l.f);
    // Shh2 = Shh2 - E*RS.f ~ -2*sqrt((1-|x|)/2)
    Shh2.f = __fma(-(E), RS.f, Shh2.f);
    // polynomial
    poly = __fma(__dasin_ha_c12.f, R, __dasin_ha_c11.f);
    poly = __fma(poly, R, __dasin_ha_c10.f);
    poly = __fma(poly, R, __dasin_ha_c9.f);
    poly = __fma(poly, R, __dasin_ha_c8.f);
    poly = __fma(poly, R, __dasin_ha_c7.f);
    poly = __fma(poly, R, __dasin_ha_c6.f);
    poly = __fma(poly, R, __dasin_ha_c5.f);
    poly = __fma(poly, R, __dasin_ha_c4.f);
    poly = __fma(poly, R, __dasin_ha_c3.f);
    poly = __fma(poly, R, __dasin_ha_c2.f);
    poly = __fma(poly, R, __dasin_ha_c1.f);
    poly = __fma(poly, R, __dasin_ha_c0.f);
    // R0 = sel_mask? Shh2 : xa.f
    // R0.w = ((Shh2.w - xa.w) & sel_mask) + xa.w;
    R0.f = (xa.f <= 0.5) ? xa.f : Shh2.f;
    // High = sel_mask ? High : xa.w
    // High.w = ((High.w - xa.w) & sel_mask) + xa.w;
    High.f = (xa.f <= 0.5) ? xa.f : High.f;
    // Low = 0 for sel-mask=0
    // Low.w &= sel_mask;
...
DEVICE_EXTERN_C_INLINE double __devicelib_imf_asin(double x) {
  using namespace __imf_impl_asin_d_ha;
  double r;
  __devicelib_imf_internal_dasin(&x, &r);
  return r;
}

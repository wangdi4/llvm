...
typedef struct {
  ...
  VUINT64 MaxNorm;
  VUINT64 IndexMask;
} __devicelib_imf_internal_dln_data_avx512_t;
static const __devicelib_imf_internal_dln_data_avx512_t
    __devicelib_imf_internal_dln_data_avx512 = {
        {0x0000000000000000uL, 0xbfaf0a30c0120000uL, 0xbfbe27076e2b0000uL,
         0xbfc5ff3070a78000uL, 0xbfcc8ff7c79a8000uL, 0xbfd1675cababc000uL,
         0xbfd4618bc21c4000uL, 0xbfd739d7f6bbc000uL, 0x3fd269621134c000uL,
         0x3fcf991c6cb38000uL, 0x3fca93ed3c8b0000uL, 0x3fc5bf406b540000uL,
         0x3fc1178e82280000uL, 0x3fb9335e5d590000uL, 0x3fb08598b59e0000uL,
         0x3fa0415d89e80000uL},
        {0x0000000000000000uL, 0x3d53ab33d066d1d2uL, 0x3d2a342c2af0003cuL,
         0xbd43d3c873e20a07uL, 0xbd4a21ac25d81ef3uL, 0x3d59f1fc63382a8fuL,
         0xbd5ec27d0b7b37b3uL, 0xbd50069ce24c53fbuL, 0x3d5b92783beb7677uL,
         0x3d59bcbecca0cdf3uL, 0xbd530e486a0ac42duL, 0x3d5ed8fdc149767euL,
         0xbd4b8421cc74be04uL, 0x3d52622b8757a8fbuL, 0x3d4d034451fecdfbuL,
         0xbd577771fd187145uL}
        /*== One ==*/
        ,
        ...
        /*== poly_coeff9 ==*/
        ,
        0x3fbC81CD309D7C70uL
        /*== poly_coeff8 ==*/
        ,
        0xbfc007357E93AF62uL
        /*== poly_coeff7 ==*/
        ,
        0x3fc249229CEE81EFuL
        /*== poly_coeff6 ==*/
        ,
        0xbfc55553FB28DB06uL
        /*== poly_coeff5 ==*/
        ,
        0x3fc9999999CC9F5CuL
        /*== poly_coeff4 ==*/
        ,
        0xbfd00000000C05BDuL
        /*== poly_coeff3 ==*/
        ,
        0x3fd5555555555466uL
        /*== poly_coeff2 ==*/
        ,
        0xbfdFFFFFFFFFFFC6uL
        /*== L2H = log(2)_high ==*/
        ,
        ...
        /*== IndexMask ==*/
        ,
        0x0000000000000078uL}; /*dLn_Table*/
//#else  // #if (_CPF_ == _uisa_) && !defined(__LEGACY_LOG)
/* ========================================================================*/
/* ============================ NEW LN ====================================*/
/* ========================================================================*/
typedef struct {
  ...
  VUINT64 dOnes[2];
  VUINT64 dZeros[2];
} __devicelib_imf_internal_dln_data_t;
static const __devicelib_imf_internal_dln_data_t
    __devicelib_imf_internal_dln_data = {
        {/*
...
static const _iml_dp_union_t __dln_ha_CoutTab[210] = {
...
//
*/
inline int __devicelib_imf_internal_dln(const double *a, double *r) {
  double x, y, u;
  double dbP;
  double dbAbsU;
  ...
  if (((((_iml_dp_union_t *)&a[0])->bits.exponent) != 0x7FF)) {
    ...
    */
    ...
    if ((((_iml_dp_union_t *)&x)->bits.exponent) == 0) {
      /* Here if argument is denormalized or [+/-]0 */
      /* Scale x and properly adjust iN */
      x *= ((const double *)__dln_ha_CoutTab)[200];
      iN -= 60;
    }
    /* Starting from this point x is finite normalized number */
    if (x > ((const double *)__dln_ha_CoutTab)[201]) {
      /* Here if x is positive finite normalized number */
      /* Get absolute value of u=x-1 */
      u = (x - 1.0);
      dbAbsU = u;
      (((_iml_dp_union_t *)&dbAbsU)->bits.sign = 0);
      /* Check if a[0] falls into "Near 1" range */
      if (dbAbsU > ((const double *)__dln_ha_CoutTab)[199]) {
        /* 6) "Main" path */
        /* a) Range reduction */
        /* Get N taking into account denormalized arguments */
        iN += (((_iml_dp_union_t *)&x)->bits.exponent) - 0x3FF;
        dbN = (double)iN;
        /*
        //                      Compute N*Ln2Hi and N*Ln2Lo. Notice that N*Ln2Hi
        //                        is error-free for any N
        */
        dbNLn2Hi = (dbN * ((const double *)__dln_ha_CoutTab)[195]);
        dbNLn2Lo = (dbN * ((const double *)__dln_ha_CoutTab)[196]);
        /* Get y */
        y = x;
        (((_iml_dp_union_t *)&y)->bits.exponent = 0x3FF);
        /* Obtain j */
        dbTmp = (y + ((const double *)__dln_ha_CoutTab)[197]);
        j = (((_iml_dp_union_t *)&dbTmp)->bits.lo_significand) &
            ((1 << (6 + 1)) - 1);
        /* Get table values of RcprY, LnRcprYHi, LnRcprYLo */
        dbRcprY = ((const double *)__dln_ha_CoutTab)[3 * (j)];
        dbLnRcprYHi = ((const double *)__dln_ha_CoutTab)[3 * (j) + 1];
        dbLnRcprYLo = ((const double *)__dln_ha_CoutTab)[3 * (j) + 2];
        /* Calculate WHi and WLo */
        dbWHi = (dbNLn2Hi + dbLnRcprYHi);
        dbWLo = (dbNLn2Lo + dbLnRcprYLo);
        /* Get YHi and YLo */
        dbTmp = (y + ((const double *)__dln_ha_CoutTab)[198]);
        dbYHi = (dbTmp - ((const double *)__dln_ha_CoutTab)[198]);
        dbYLo = (y - dbYHi);
        /* Get UHi, ULo and U */
        ...
        u = (dbUHi + dbULo);
        /* b) Approximation */
        dbP = (((((((const double *)__dln_ha_CoutTab)[209] * u +
                   ((const double *)__dln_ha_CoutTab)[208]) *
                      u +
                  ((const double *)__dln_ha_CoutTab)[207]) *
                     u +
                 ((const double *)__dln_ha_CoutTab)[206]) *
                    u +
                ((const double *)__dln_ha_CoutTab)[205]) *
                   u +
               ((const double *)__dln_ha_CoutTab)[204]) *
                  u +
              ((const double *)__dln_ha_CoutTab)[203];
        dbP = (dbP * u * u);
        /* c) Reconstruction */
        dbResHi = (dbWHi + dbUHi);
      ...
      if (x == ((const double *)__dln_ha_CoutTab)[201]) {
        ...
        r[0] = -((const double *)__dln_ha_CoutTab)[202] /
               ((const double *)__dln_ha_CoutTab)[201];
        nRet = 2;
      } else {
        /* Path 4). Here if argument is negative number */
        r[0] = ((const double *)__dln_ha_CoutTab)[201] /
               ((const double *)__dln_ha_CoutTab)[201];
        nRet = 1;
      }
    }
    ...
    if (((((_iml_dp_union_t *)&a[0])->bits.sign) == 1) &&
        (((((_iml_dp_union_t *)&a[0])->bits.hi_significand) == 0) &&
...
DEVICE_EXTERN_C_INLINE double __devicelib_imf_log(double x) {
  using namespace __imf_impl_ln_d_ha;
  double r;
  VUINT32 vm;
  double va1;
  double vr1;
  va1 = x;
  {
    ...
    float SglRcp;
    float SMant;
    ExpMask = as_double(__devicelib_imf_internal_dln_data.ExpMask);
    Two10 = as_double(__devicelib_imf_internal_dln_data.Two10);
    /* preserve mantissa, set input exponent to 2^(-10) */
    Mantissa = as_double((as_ulong(va1) & as_ulong(ExpMask)));
    Mantissa = as_double((as_ulong(Mantissa) | as_ulong(Two10)));
    MinNorm = as_double(__devicelib_imf_internal_dln_data.MinNorm);
    MaxNorm = as_double(__devicelib_imf_internal_dln_data.MaxNorm);
    ...
    BrMask1 = as_double((VUINT64)((va1 < MinNorm) ? 0xffffffffffffffff : 0x0));
    BrMask2 =
        as_double((VUINT64)(((!(va1 <= MaxNorm)) ? 0xffffffffffffffff : 0x0)));
    /* round reciprocal to nearest integer, will have 1+9 mantissa bits */
    SglRcp = __rint(SglRcp);
    ...
    vm = 0;
    vm = BrMask;
    One = as_double(__devicelib_imf_internal_dln_data.One);
    R = __fma(Mantissa, DblRcp, -(One));
    Index = as_ulong(DblRcp);
    /* calculate index for table lookup */
    Index = ((VUINT64)(Index) >> (52 - 9 - 4));
    THL[0] = as_double(
        ((const VUINT64 *)((const char *)(&__devicelib_imf_internal_dln_data
                                               .Log_HA_table[0]) -
                           0x810000))[Index >> 3]);
    THL[1] = as_double(
        ((const VUINT64 *)((const char *)(&__devicelib_imf_internal_dln_data
                                               .Log_HA_table[0]) -
                           0x810000))[(Index >> 3) + 1]);
    L2H = as_double(__devicelib_imf_internal_dln_data.L2H);
    L2L = as_double(__devicelib_imf_internal_dln_data.L2L);
    /* exponent*log(2.0) */
    Kh = (FpExpon * L2H);
    Kl = (FpExpon * L2L);
    poly_coeff[4] = as_double(__devicelib_imf_internal_dln_data.poly_coeff[0]);
    poly_coeff[3] = as_double(__devicelib_imf_internal_dln_data.poly_coeff[1]);
    poly_coeff[2] = as_double(__devicelib_imf_internal_dln_data.poly_coeff[2]);
    poly_coeff[1] = as_double(__devicelib_imf_internal_dln_data.poly_coeff[3]);
  ...
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_dln(&__cout_a1, &__cout_r1);

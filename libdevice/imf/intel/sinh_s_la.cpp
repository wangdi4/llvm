...
typedef struct {
  ...
  VUINT32 _sPC6;
  VUINT32 _iHalf;
} __devicelib_imf_internal_ssinh_data_t;
static const __devicelib_imf_internal_ssinh_data_t
    __devicelib_imf_internal_ssinh_data = {
        ...
        0x48c00001u, /* 1.5*2^18 _sShifterP1_int */
        0x0000001fu, /* _iIndexMask_int */
        0x42aeac4fu, /* _iDomainRange_int */
        0x3F800000u, /* _sPC1_int */
        0x3f000044u, /* _sPC2_int */
        0x3e2aaab5u, /* _sPC3_int */
        0x3FB8AA3Bu,
        /* _sInvLn2  */ // k=0
        0x3F317000u,    /* _sLn2hi   */
        0x3805FDF4u,    /* _sLn2lo   */
...
inline int __devicelib_imf_internal_ssinh(const float *a, float *r) {
  int nRet = 0;
  float x = __fabs(*a);
  union {
    uint32_t w;
  ...
  S.f = __fma(x, __ssinh_la_L2E.f, __ssinh_la_Shifter.f);
  N = S.f - __ssinh_la_Shifter.f;
  R = __fma(-(N), __ssinh_la_L2H.f, x);
  R = __fma(-(N), __ssinh_la_L2L.f, R);
  ...
  // polynomial
  poly = __fma(R, __ssinh_la_c5.f, __ssinh_la_c4.f);
  poly = __fma(R, poly, __ssinh_la_c3.f);
  poly = __fma(R, poly, __ssinh_la_c2.f);
  poly = __fma(R, poly, __ssinh_la_c1.f);
...
DEVICE_EXTERN_C_INLINE float __devicelib_imf_sinhf(float a) {
  using namespace __imf_impl_sinh_s_la;
  VUINT32 vm;
  float va1;
  float vr1;
  float r;
  ...
  ;
  {
    ...
    sInvLn2 = as_float(__devicelib_imf_internal_ssinh_data._sInvLn2);
    sShifter = as_float(__devicelib_imf_internal_ssinh_data._sShifter);
    sPC[0] = as_float(__devicelib_imf_internal_ssinh_data._sPC1);
    sPC[1] = as_float(__devicelib_imf_internal_ssinh_data._sPC2);
    sPC[2] = as_float(__devicelib_imf_internal_ssinh_data._sPC3);
    sPC[3] = as_float(__devicelib_imf_internal_ssinh_data._sPC4);
    sPC[4] = as_float(__devicelib_imf_internal_ssinh_data._sPC5);
    sPC[5] = as_float(__devicelib_imf_internal_ssinh_data._sPC6);
    sXSign = as_float(__devicelib_imf_internal_ssinh_data._sSign);
    iHalf = (__devicelib_imf_internal_ssinh_data._iHalf);
    iDomainRange = (__devicelib_imf_internal_ssinh_data._iDomainRange);
    ...
    // sN = sM - RShifter
    sN = (sM - sShifter);
    sOut = as_float(__devicelib_imf_internal_ssinh_data._sLn2hi);
    sG1 = as_float(__devicelib_imf_internal_ssinh_data._sLn2lo);
    // sR = sX - sN*Log2_hi
  ...
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_ssinh(&__cout_a1, &__cout_r1);

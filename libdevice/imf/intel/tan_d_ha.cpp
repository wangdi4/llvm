...
namespace __imf_impl_tan_d_ha {
namespace {
typedef struct {
  VUINT64 _dPtable[2048][3];
} __dtan_ha_ReductionTab_t;
static const __dtan_ha_ReductionTab_t
    __devicelib_imf_internal_dtan_reduction_data = {
        {
            /*            P_hi                          P_med P_lo         */
   ...
   /* Table parameters */
typedef struct {
  VUINT64 _dInvPI_uisa;
  VUINT64 _dPI1_uisa;
  VUINT64 _dPI2_uisa;
  VUINT64 _dPI3_uisa;
  VUINT64 _dPI2_ha_uisa;
  VUINT64 _dPI3_ha_uisa;
  VUINT64 Th_tbl_uisa[16];
  VUINT64 Tl_tbl_uisa[16];
  VUINT64 _dPC3_uisa;
  VUINT64 _dPC5_uisa;
  VUINT64 _dPC7_uisa;
  VUINT64 _dPC9_uisa;
  ...
  VUINT64 _lIndexMask;
  VUINT64 _dPIu;
  VUINT64 _dCoeffs[256][13];
  VUINT64 _dReductionRangeVal;
} __devicelib_imf_internal_dtan_data_t;
static const __devicelib_imf_internal_dtan_data_t
    __devicelib_imf_internal_dtan_data = {
        /* UISA */
                              ...
                              /* _dCoeffs */
        {
            ...
            // Breakpoint B = 64 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 65 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 66 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 67 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 68 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 69 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 70 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 71 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 72 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 73 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 74 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 75 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 76 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 77 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 78 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 79 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 80 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 81 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 82 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 83 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 84 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 85 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 86 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 87 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 88 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 89 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 90 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 91 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 92 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 93 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 94 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 95 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 96 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 97 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 98 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 99 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 100 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 101 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 102 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 103 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 104 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 105 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 106 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 107 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 108 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 109 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 110 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 111 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 112 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 113 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 114 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 115 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 116 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 117 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 118 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 119 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 120 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 121 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 122 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 123 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 124 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 125 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 126 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 127 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 128 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 129 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 130 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 131 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 132 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 133 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 134 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 135 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 136 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 137 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 138 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 139 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 140 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 141 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 142 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 143 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 144 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 145 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 146 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 147 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 148 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 149 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 150 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 151 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 152 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 153 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 154 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 155 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 156 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 157 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 158 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 159 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 160 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 161 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 162 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 163 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 164 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 165 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 166 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 167 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 168 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 169 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 170 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 171 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 172 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 173 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 174 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 175 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 176 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 177 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 178 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 179 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 180 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 181 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 182 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 183 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 184 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 185 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 186 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 187 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 188 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 189 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 190 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
            ...
            // Breakpoint B = 191 * pi/256, function tan(B + x) - 1/(pi/2 - (B +
            // x))
            {
        ...
        //      here N = [x*PIu].
        //
        //      N * mantissa(PioHi) < 2^(53) + 1 ==> N*(0x1921FB544>>2) < 2^53 +
        1
        //      ==> N < (2^53+1) / 0x6487ED51 ==> N < 5340353.71 ==> N <=
        5340353
...
static const _iml_dp_union_t __dtan_ha_Tab[2] = {
    0x00000000, 0x00000000, /* ZERO = 0.0 */
    0x00000000, 0x7FF00000, /* INF = 0x7ff00000 00000000 */
};
inline int __devicelib_imf_internal_dtan(const double *a, double *r) {
  int nRet = 0;
  double x, absx;
  /* Get absolute value of argument */
  absx = (*a);
  (((_iml_dp_union_t *)&absx)->bits.sign = 0);
  if (!(((((_iml_dp_union_t *)&(*a))->bits.exponent) !=
         0x7FF))) /********* |(*a)| = Inf,NaN *************/
  {
    if ((((_iml_dp_union_t *)&(absx))->hex[0] ==
         ((const _iml_dp_union_t *)&(((const double *)__dtan_ha_Tab)[1]))
             ->hex[0]) &&
             ...
             ->hex[1])) /****** |(*a)|=Inf (path 1) ***********/
    {
      ...
      (*r) = (*a) * ((const double *)__dtan_ha_Tab)[0];
...
DEVICE_EXTERN_C_INLINE double __devicelib_imf_tan(double x) {
  using namespace __imf_impl_tan_d_ha;
  double r;
  VUINT32 vm;
  double va1;
  double vr1;
  va1 = x;
  {
    ...
    double dAE;
    vm = 0;
    dAbsMask = as_double(__devicelib_imf_internal_dtan_data._dAbsMask);
    dAbsX = as_double((as_ulong(va1) & as_ulong(dAbsMask)));
    /* Large values check */
    dReductionRangeVal =
        as_double(__devicelib_imf_internal_dtan_data._dReductionRangeVal);
    {
      VUINT64 lReductionRangeMask;
      dReductionRangeMask = as_double((VUINT64)(
    ...
    }
    {
      /* Main path */
      // start arg. reduction
      dInvPI = as_double(__devicelib_imf_internal_dtan_data._dInvPI_uisa);
      dRShifter = as_double(__devicelib_imf_internal_dtan_data._dRShift);
      // Y = x + BIG_VALUE
      dY = __fma(va1, dInvPI, dRShifter);
      // N = y - BIG_VALUE
      dN = (dY - dRShifter);
      dPI1 = as_double(__devicelib_imf_internal_dtan_data._dPI1_uisa);
      dPI2 = as_double(__devicelib_imf_internal_dtan_data._dPI2_ha_uisa);
      dPI3 = as_double(__devicelib_imf_internal_dtan_data._dPI3_ha_uisa);
      // Rh = x - N*Pi1
      dRh = __fma(-(dN), dPI1, va1);
      // Rm = Rh - N*Pi2
      dRm = __fma(-(dN), dPI2, dRh);
      // R = Rm - N*Pi3
      dR = __fma(-(dN), dPI3, dRm);
      // Calculate the lower part dRl
      dNP2 = (dRh - dRm);
      dNP3 = (dR - dRm);
      dRl = __fma(-(dN), dPI2, dNP2);
      dRl3 = __fma(dN, dPI3, dNP3);
      dRl = (dRl - dRl3);
    }
    if (__builtin_expect((mReductionRangeMask) != 0, 0)) {
      ...
      dRangeVal = as_double(__devicelib_imf_internal_dtan_data._dRangeVal);
      dX = as_double((as_ulong(dRangeVal) & as_ulong(dAbsX)));
      dRangeMask =
          as_double((VUINT64)((dX == dRangeVal) ? 0xffffffffffffffff : 0x0));
      ...
      //
      {
        ...
        dShifter = as_double(0x42A8000000000000uLL);
        ...
        d2pi_lead = as_double(0x401921fb54442d18uLL);
        d2pi_trail = as_double(0x3cb1a62633145c07uLL);
        dRedHi = (dRHi * d2pi_lead);
        dRedLo = __fma(dRHi, d2pi_lead, -(dRedHi));
        dRedLo = __fma(dRHi, d2pi_trail, dRedLo);
        dRedLo = __fma(dRLo, d2pi_lead, dRedLo);
        ...
        dAbsMask = as_double(0x7FFFFFFFFFFFFFFFuLL);
        dMinInput = as_double(0x3EB0000000000000uLL);
        dAbs = as_double((as_ulong(va1) & as_ulong(dAbsMask)));
        dMultiplex =
            as_double((VUINT64)((dAbs > dMinInput) ? 0xffffffffffffffff : 0x0));
        dNotMultiplex = as_double(
            (VUINT64)((dAbs <= dMinInput) ? 0xffffffffffffffff : 0x0));
        dMultiplexedInput =
      ...
      iIndex = (((VUINT32)lIndex & (VUINT32)-1));
      iRound = 0x8u;
      lSign = as_ulong(dZ);
      iSign = ((VUINT32)((VUINT64)lSign >> 32));
      iSign = ((VUINT32)(iSign) >> (31));
      iRound = (iRound - iSign);
      iRound = (iIndex + iRound);
      iRound = ((VUINT32)(iRound) >> (4));
      lRound = ((VUINT64)(VUINT32)iRound);
      dYLarge = as_double(lRound);
      iRound = ((VUINT32)(iRound) << (4));
      iIndex = (iIndex - iRound);
      dN = ((double)((VINT32)(iIndex)));
      dPI1 = as_double(0x3f8921fb54442d18uLL);
      dPI2 = as_double(0x3c21a62633145c07uLL);
      dRLarge = __fma(dN, dPI1, dZ);
      dRlLarge = __fma(-(dN), dPI1, dRLarge);
      dRlLarge = (dZ - dRlLarge);
      dRlLarge = __fma(dN, dPI2, dRlLarge);
    ...
    };
    {
      ...
      VUINT64 _t_index;
      lIndex = as_ulong(dY);
      _t_emask = 0x0000000000000078uLL;
      _t_index = ((VUINT64)(lIndex) << (3));
      lIndex = (_t_index & _t_emask);
    };
    dTh = as_double(((
        const VUINT64 *)((const double *)(&__devicelib_imf_internal_dtan_data
    ...
    // R2 = R*R
    dR2 = (dR * dR);
    dPC[4] = as_double(__devicelib_imf_internal_dtan_data._dPC11_uisa);
    dPC[3] = as_double(__devicelib_imf_internal_dtan_data._dPC9_uisa);
    // Start polynomial computation
    dPoly = __fma(dPC[4], dR2, dPC[3]);
    dPC[2] = as_double(__devicelib_imf_internal_dtan_data._dPC7_uisa);
    dPoly = __fma(dPoly, dR2, dPC[2]);
    dPC[1] = as_double(__devicelib_imf_internal_dtan_data._dPC5_uisa);
    dPoly = __fma(dPoly, dR2, dPC[1]);
    dPC[0] = as_double(__devicelib_imf_internal_dtan_data._dPC3_uisa);
    dPoly = __fma(dPoly, dR2, dPC[0]);
    dPoly = (dPoly * dR);
    dPoly = __fma(-(dPoly), dR2, -(dRl));
    dP = (dR - dPoly);
    dPlow = (dR - dP);
    dPlow = (dPlow - dPoly);
    // Compute Numerator:
    ...
    dOne = as_double(__devicelib_imf_internal_dtan_data._dOne_uisa);
    dDenominator = __fma(-(dTh), dP, dOne);
    dDlow = (dDenominator - dOne);
    dDlow = __fma(dTh, dP, dDlow);
    dDlow = __fma(dTh, dPlow, dDlow);
    dDlow = __fma(dTl, dP, dDlow);
    ...
    dShifter = as_double(0x4138000000000000uLL);
    // Shift exponent field right
    dExp = (dExp + dShifter);
    // Represent exponent as 64-bit integer
    lExp = as_ulong(dExp);
    lBias_d = 0x3ff0000000000000uLL;
    // Shift exponent field left
    lExp = ((VUINT64)(lExp) << (20));
    // Subtract bias
    lExp = (lBias_d - lExp);
    ...
    dE = __fma(-(dRcp), dDenominator, dOne);
    dE = __fma(dRcp, dDlow, dE);
    dRcp = __fma(dRcp, dE, dRcp);
    dQuotient = (dRcp * dNumerator);
    // One NR iteration to refine dQuotient
    dAE = __fma(dDenominator, dQuotient, -(dNumerator));
    dAE = __fma(-(dDlow), dQuotient, dAE);
    dAE = (dAE - dNlow);
    vr1 = __fma(-(dAE), dRcp, dQuotient);
  }
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_dtan(&__cout_a1, &__cout_r1);

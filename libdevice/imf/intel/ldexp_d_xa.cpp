...
namespace __imf_impl_ldexp_d_xa {
namespace {
typedef struct {
  VUINT32 _iExpMask;
  VUINT32 _iMaxExp;
  ...
  VUINT32 _iPosMaxN;
  VUINT32 _iNegMaxN;
} __devicelib_imf_internal_dldexp_data_t;
static const __devicelib_imf_internal_dldexp_data_t
    __devicelib_imf_internal_dldexp_data = {
...
inline int __devicelib_imf_internal_dldexp(const double *a1, const int *a2,
                                           double *r1) {
  int nRet = 0;
  double arg;
  int exp;
...
DEVICE_EXTERN_C_INLINE double __devicelib_imf_ldexp(double x, int32_t y) {
  using namespace __imf_impl_ldexp_d_xa;
  double r;
  VUINT32 vm;
  double va1;
  VUINT32 va2;
  ...
  va2 = y;
  {
    ...
    VUINT32 iCmpMask2;
    VUINT32 iCmpMask3;
    iMaxExp = (__devicelib_imf_internal_dldexp_data._iMaxExp);
    iExpMask = (__devicelib_imf_internal_dldexp_data._iExpMask);
    iZero = (__devicelib_imf_internal_dldexp_data._iZero);
    iPosMaxN = (__devicelib_imf_internal_dldexp_data._iPosMaxN);
    iNegMaxN = (__devicelib_imf_internal_dldexp_data._iNegMaxN);
    lX = as_ulong(va1);
    iN = va2;
  ...
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_dldexp(&__cout_a1, &__cout_a2, &__cout_r1);

...
namespace __imf_impl_acosh_d_la {
namespace {
typedef struct {
  ...
  VUINT64 One;
  VUINT64 AbsMask;
  VUINT64 SmallThreshold;
  VUINT64 Threshold;
  VUINT64 LargeThreshold;
  VUINT64 ca2;
  VUINT64 ca1;
  VUINT64 c4s;
  VUINT64 c3s;
  ...
  VUINT64 L2H;
  VUINT64 L2L;
} __devicelib_imf_internal_dacosh_data_avx512_t;
static const __devicelib_imf_internal_dacosh_data_avx512_t
    __devicelib_imf_internal_dacosh_data_avx512 = {
        {/*== Log_tbl_H ==*/
         ...
         0xbfd4618bc21c4000uL, 0xbfd739d7f6bbc000uL, 0xbfd9f323ecbf8000uL,
         0xbfdc8ff7c79a8000uL, 0xbfdf128f5faf0000uL, 0xbfe0be72e4252000uL,
         0xbfe1e85f5e704000uL, 0xbfe307d7334f2000uL, 0xbfe41d8fe8468000uL,
         0xbfe52a2d265bc000uL},
        {/*== Log_tbl_L ==*/
         ...
         0xbd5ec27d0b7b37b3uL, 0xbd50069ce24c53fbuL, 0xbd584bf2b68d766fuL,
         0xbd5a21ac25d81ef3uL, 0xbd3bb2cd720ec44cuL, 0xbd55056d312f7668uL,
         0xbd1a07bd8b34be7cuL, 0x3d5e83c094debc15uL, 0x3d5aa33736867a17uL,
         0xbd46abb9df22bc57uL}
        /*== One ==*/
        ,
        ...
        /*== SmallThreshold ==*/
        ,
        0x3ef0000000000000uL
        /*== Threshold ==*/
        ,
        0x5fe0000000000000uL
        /*== LargeThreshold ==*/
        ,
        0x7fefffffffffffffuL
        /*== ca2 ==*/
        ,
        0x3fb333220eaf02e7uL
        /*== ca1 ==*/
        ,
        0xbfc5555555521e7euL
        /*== c4s ==*/
        ,
        0x3fd1800001943612uL
        /*== c3s ==*/
        ,
        0x3fd40000013b0000uL
        /*== c2s ==*/
        ,
        ...
        /*== L2L = log(2)_low ==*/
        ,
        0x3d7cf79abc9e0000uL}; /*dLn_Table*/
/* ========================================================================*/
/* ============================ NEW LN ====================================*/
/* ========================================================================*/
typedef struct {
...
static const __devicelib_imf_internal_dacosh_data_t
    __devicelib_imf_internal_dacosh_data = {
        /* Log_HA_table */
...
static const _iml_dp_union_t __dacosh_la_CoutTab[4] = {
...
inline int __devicelib_imf_internal_dacosh(const double *a, double *r) {
  int nRet = 0;
  double yM;
  double purex, y, yN;
  ...
  purex = (*a);
  {
    ...
    // If x = 1, return +0
    if ((((_iml_dp_union_t *)&(purex))->hex[0] ==
         ((const _iml_dp_union_t *)&(((const double *)__dacosh_la_CoutTab)[0]))
             ->hex[0]) &&
        (((_iml_dp_union_t *)&(purex))->hex[1] ==
         ((const _iml_dp_union_t *)&(((const double *)__dacosh_la_CoutTab)[0]))
             ->hex[1])) {
      (*r) = ((const double *)__dacosh_la_CoutTab)[1];
      return nRet;
    }
    // If x = +inf, return +inf
    if ((((_iml_dp_union_t *)&(purex))->hex[0] ==
         ((const _iml_dp_union_t *)&(((const double *)__dacosh_la_CoutTab)[2]))
             ->hex[0]) &&
        (((_iml_dp_union_t *)&(purex))->hex[1] ==
         ((const _iml_dp_union_t *)&(((const double *)__dacosh_la_CoutTab)[2]))
             ->hex[1])) {
    ...
    {
      (*r) = ((const double *)__dacosh_la_CoutTab)[2] *
             ((const double *)__dacosh_la_CoutTab)[1];
      nRet = 1;
      return nRet;
    }
  }
...
DEVICE_EXTERN_C_INLINE double __devicelib_imf_acosh(double x) {
  using namespace __imf_impl_acosh_d_la;
  double r;
  VUINT32 vm;
  double va1;
  double vr1;
  va1 = x;
  {
    ...
    One = as_double(__devicelib_imf_internal_dacosh_data.One);
    SgnMask = as_double(__devicelib_imf_internal_dacosh_data.SgnMask);
    XThreshold = as_double(__devicelib_imf_internal_dacosh_data.XThreshold);
    XhMask = as_double(__devicelib_imf_internal_dacosh_data.XhMask);
    dLargestFinite =
        as_double(__devicelib_imf_internal_dacosh_data.dLargestFinite);
    dInfinityMask = as_double(
        (VUINT64)(((!(va1 <= dLargestFinite)) ? 0xffffffffffffffff : 0x0)));
    dTooSmallMask =
        as_double((VUINT64)(((!(va1 > One)) ? 0xffffffffffffffff : 0x0)));
    dSpecialMask =
    ...
    dBigThreshold =
        as_double(__devicelib_imf_internal_dacosh_data.dBigThreshold);
    dModerateMask =
        as_double((VUINT64)((va1 < dBigThreshold) ? 0xffffffffffffffff : 0x0));
    // dU is needed later on
    dU = (va1 - One);
    dTmp5 = __fma(va1, va1, -(One));
    // do the same thing but with NR iteration
    // Finally, express Y + W = U * V accurately where Y has <= 29 bits
    dTopMask29 = as_double(__devicelib_imf_internal_dacosh_data.dTopMask29);
    ...
    dZ = ((double)(1.0f / __sqrt((float)(dY))));
    dTopMask12 = as_double(__devicelib_imf_internal_dacosh_data.dTopMask12);
    ...
    // C4 = 35/128
    // C5 = 63/256
    dC5 = as_double(__devicelib_imf_internal_dacosh_data.dC5);
    dC4 = as_double(__devicelib_imf_internal_dacosh_data.dC4);
    dPol4 = __fma(dC5, dE, dC4);
    dC3 = as_double(__devicelib_imf_internal_dacosh_data.dC3);
    dPol3 = __fma(dPol4, dE, dC3);
    dC2 = as_double(__devicelib_imf_internal_dacosh_data.dC2);
    dPol2 = __fma(dPol3, dE, dC2);
    dC1 = as_double(__devicelib_imf_internal_dacosh_data.dC1);
    dPol1 = __fma(dPol2, dE, dC1);
    dCorr = (dPol1 * dE);
    // For low-accuracy versions, the computation can be done
    // just as U + ((S + T) + (S + T) * Corr)
    dTmpf1 = (dS + dT);
    dTmpf2 = __fma(dTmpf1, dCorr, dTmpf1);
    dH = (dU + dTmpf2);
    ...
    // case.
    XScale = as_double(__devicelib_imf_internal_dacosh_data.XScale);
    XScale = (va1 * XScale);
    ...
    ExpMask = as_double(__devicelib_imf_internal_dacosh_data.ExpMask);
    Two10 = as_double(__devicelib_imf_internal_dacosh_data.Two10);
    /* preserve mantissa, set input exponent to 2^(-10) */
    Mantissa = as_double((as_ulong(X) & as_ulong(ExpMask)));
    Mantissa = as_double((as_ulong(Mantissa) | as_ulong(Two10)));
    MinLog1p = as_double(__devicelib_imf_internal_dacosh_data.MinLog1p);
    MaxLog1p = as_double(__devicelib_imf_internal_dacosh_data.MaxLog1p);
    ExpMask0 = (__devicelib_imf_internal_dacosh_data.ExpMask0);
    ExpMask2 = (__devicelib_imf_internal_dacosh_data.ExpMask2);
    ...
    dThirtyOne = as_double(__devicelib_imf_internal_dacosh_data.dThirtyOne);
    ...
    /* table lookup */
    Index = ((VUINT64)(Index) >> (52 - 9 - 3));
    T = as_double(
        ((const VUINT64 *)((const char *)(&__devicelib_imf_internal_dacosh_data
                                               .Log_LA_table[0]) -
                           0x408000))[Index >> 3]);
    /* K = exponent*log(2.0) */
    Threshold = as_double(__devicelib_imf_internal_dacosh_data.Threshold);
    Bias = as_double(__devicelib_imf_internal_dacosh_data.Bias);
    Bias1 = as_double(__devicelib_imf_internal_dacosh_data.Bias1);
    L2 = as_double(__devicelib_imf_internal_dacosh_data.L2);
    BMask =
        as_double((VUINT64)((Threshold < DblRcp) ? 0xffffffffffffffff : 0x0));
    ...
    /* polynomial: */
    poly_coeff[4] =
        as_double(__devicelib_imf_internal_dacosh_data.poly_coeff[0]);
    poly_coeff[3] =
        as_double(__devicelib_imf_internal_dacosh_data.poly_coeff[1]);
    poly_coeff[2] =
        as_double(__devicelib_imf_internal_dacosh_data.poly_coeff[2]);
    poly_coeff[1] =
        as_double(__devicelib_imf_internal_dacosh_data.poly_coeff[3]);
    // P34 = C4*R + C3
  ...
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_dacosh(&__cout_a1, &__cout_r1);

...
namespace __imf_impl_ldexp_s_xa {
namespace {
typedef struct {
  VUINT32 _iExpMask;
  VUINT32 _iMaxExp;
  ...
  VUINT32 _iPosMaxN;
  VUINT32 _iNegMaxN;
} __devicelib_imf_internal_sldexp_data_t;
static const __devicelib_imf_internal_sldexp_data_t
    __devicelib_imf_internal_sldexp_data = {
...
inline int __devicelib_imf_internal_sldexp(const float *a1, const int *a2,
                                           float *r1) {
  int nRet = 0;
  float arg;
  int exp;
...
DEVICE_EXTERN_C_INLINE float __devicelib_imf_ldexpf(float a, int32_t b) {
  using namespace __imf_impl_ldexp_s_xa;
  VUINT32 vm;
  float va1;
  VUINT32 va2;
  float vr1;
  ...
  va2 = b;
  {
    ...
    VUINT32 iCmpMask2;
    VUINT32 iCmpMask3;
    iMaxExp = (__devicelib_imf_internal_sldexp_data._iMaxExp);
    iExpMask = (__devicelib_imf_internal_sldexp_data._iExpMask);
    iZero = (__devicelib_imf_internal_sldexp_data._iZero);
    iPosMaxN = (__devicelib_imf_internal_sldexp_data._iPosMaxN);
    iNegMaxN = (__devicelib_imf_internal_sldexp_data._iNegMaxN);
    iX = as_uint(va1);
    iN = va2;
    iExp = (iExpMask & iX);
  ...
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_sldexp(&__cout_a1, &__cout_a2, &__cout_r1);

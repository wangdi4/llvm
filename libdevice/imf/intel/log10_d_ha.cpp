...
namespace __imf_impl_log10_d_ha {
namespace {
typedef struct {
  ...
  VUINT64 poly_coeff3;
  VUINT64 poly_coeff2;
  VUINT64 poly_coeff0l;
  VUINT64 poly_coeff0h;
  VUINT64 L2H;
  VUINT64 L2L;
  VUINT64 MinNorm;
  VUINT64 MaxNorm;
  VUINT64 IndexMask;
} __devicelib_imf_internal_dlog10_data_avx512_t;
static const __devicelib_imf_internal_dlog10_data_avx512_t
    __devicelib_imf_internal_dlog10_data_avx512 = {
        {0x0000000000000000uL, 0xbf9af5f92b000000uL, 0xbfaa30a9d60a0000uL,
         0xbfb31b3055c40000uL, 0xbfb8cf1838860000uL, 0xbfbe3bc1ab0e0000uL,
         0xbfc1b3e71ec98000uL, 0xbfc42c7e7fe40000uL, 0x3fbffbfc2bbc0000uL,
         0x3fbb721cd1710000uL, 0x3fb715d0ce360000uL, 0x3fb2e3a740b80000uL,
         0x3fadb11ed7660000uL, 0x3fa5e3966b7e0000uL, 0x3f9cb38fccd80000uL,
         0x3f8c3d0837780000uL},
        {0x0000000000000000uL, 0xbd4cc1f4dbc14db5uL, 0x3d20163d7e67d282uL,
         0xbd5c46006d082e6duL, 0xbd520326ca2c7e5fuL, 0xbd39fe3d562a53f0uL,
         0x3d5842a222666db0uL, 0x3d1ff1d22abd8abeuL, 0x3d5e00dd60df12c3uL,
         0x3d55f8a57d982e77uL, 0x3d5ebeeb67bf155auL, 0xbd5ffc5aef53f2eduL,
         0x3d557e865b878377uL, 0x3d5252a37739a5f7uL, 0x3d47fb6d2d6528c7uL,
         0x3d2310272fe17537uL}
        /*== One ==*/
        ,
        ...
        /*== poly_coeff9 ==*/
        ,
        0x3fa8c2d828480370uL
        /*== poly_coeff8 ==*/
        ,
        0xbfabd80d96029814uL
        /*== poly_coeff7 ==*/
        ,
        0x3fafc3f6f38b58a2uL
        /*== poly_coeff6 ==*/
        ,
        0xbfb287a63464dc80uL
        /*== poly_coeff5 ==*/
        ,
        0x3fb63c62777f27d9uL
        /*== poly_coeff4 ==*/
        ,
        0xbfbbcb7b153c06a3uL
        /*== poly_coeff3 ==*/
        ,
        0x3fc287a7636f428cuL
        /*== poly_coeff2 ==*/
        ,
        0xbfcbcb7b1526e4dbuL
        /*== poly_coeff0l ==*/
        ,
        0x3c69a5fdaaf11825uL
        /*== poly_coeff0h ==*/
        ,
        0x3fdbcb7b1526e50euL
        /*== L2H ==*/
        ,
        0x3fd34413509f0000uL
        /*== L2L ==*/
        ,
        0x3d7e7fbcc47c4acduL
        /*== MinNorm ==*/
        ,
...
typedef struct {
  VUINT64 Log_HA_table[(1 << 9) + 2];
  VUINT64 Log_LA_table[(1 << 9) + 1];
  VUINT64 ha_poly_coeff[6];
  VUINT64 poly_coeff[5];
  VUINT64 ExpMask;
  VUINT64 Two10;
  VUINT64 MinNorm;
  VUINT64 MaxNorm;
  ...
  VUINT64 dOnes[2];
  VUINT64 dZeros[2];
} __devicelib_imf_internal_dlog10_data_t;
static const __devicelib_imf_internal_dlog10_data_t
    __devicelib_imf_internal_dlog10_data = {
        /* Log_HA_table */
...
static const _iml_dp_union_t __dlog10_ha_CoutTab[212] = {
...
inline int __devicelib_imf_internal_dlog10(const double *a, double *r) {
  double x, y, u, q;
  double dbP;
  double dbAbsU;
  ...
  if (((((_iml_dp_union_t *)&(*a))->bits.exponent) != 0x7FF)) {
    ...
    */
    ...
    if ((((_iml_dp_union_t *)&x)->bits.exponent) == 0) {
      ...
      x = (x * ((const double *)__dlog10_ha_CoutTab)[200]);
      iN = (iN - 60);
    }
    /* Starting from this point x is finite normalized number */
    if (x > ((const double *)__dlog10_ha_CoutTab)[201]) {
      ...
      if (dbAbsU > ((const double *)__dlog10_ha_CoutTab)[199]) {
        /* 6) "Main" path */
        /* a) Range reduction */
        /* Get N taking into account denormalized arguments */
        iN = (iN + (((_iml_dp_union_t *)&x)->bits.exponent) - 0x3FF);
        dbN = (double)iN;
        /*
        //                      Compute N*Lg2Hi and N*Lg2Lo. Notice that N*Lg2Hi
        //                        is error-free for any N
        */
        dbNLg2Hi = (dbN * ((const double *)__dlog10_ha_CoutTab)[195]);
        dbNLg2Lo = (dbN * ((const double *)__dlog10_ha_CoutTab)[196]);
        /* Get y */
        y = x;
        (((_iml_dp_union_t *)&y)->bits.exponent = 0x3FF);
        /* Obtain j */
        dbTmp = (y + ((const double *)__dlog10_ha_CoutTab)[197]);
        j = ((((_iml_dp_union_t *)&dbTmp)->bits.lo_significand) &
             ((1 << (6 + 1)) - 1));
        /* Get table values of B, LgRcprYHi, LgRcprYLo */
        dbB = ((const double *)__dlog10_ha_CoutTab)[3 * (j)];
        dbLgRcprYHi = ((const double *)__dlog10_ha_CoutTab)[3 * (j) + 1];
        dbLgRcprYLo = ((const double *)__dlog10_ha_CoutTab)[3 * (j) + 2];
        /* Calculate WHi and WLo */
        dbWHi = (dbNLg2Hi + dbLgRcprYHi);
        dbWLo = (dbNLg2Lo + dbLgRcprYLo);
        /* Get YHi and YLo */
        dbTmp = (y + ((const double *)__dlog10_ha_CoutTab)[198]);
        dbYHi = (dbTmp - ((const double *)__dlog10_ha_CoutTab)[198]);
        dbYLo = (y - dbYHi);
        /* Get QHi, QLo and q */
        dbQHi = ((dbB * dbYHi) - ((const double *)__dlog10_ha_CoutTab)[203]);
        dbQLo = (dbB * dbYLo);
        q = (dbQHi + dbQLo);
        /* b) Approximation */
        dbP = (((((((((const double *)__dlog10_ha_CoutTab)[211] * q +
                     ((const double *)__dlog10_ha_CoutTab)[210]) *
                        q +
                    ((const double *)__dlog10_ha_CoutTab)[209]) *
                       q +
                   ((const double *)__dlog10_ha_CoutTab)[208]) *
                      q +
                  ((const double *)__dlog10_ha_CoutTab)[207]) *
                     q +
                 ((const double *)__dlog10_ha_CoutTab)[206]) *
                    q +
                ((const double *)__dlog10_ha_CoutTab)[205]) *
                   q +
               ((const double *)__dlog10_ha_CoutTab)[204]);
        /* c) Reconstruction */
        dbResHi = (dbWHi + dbQHi);
        ...
        /* Calculate q */
        q = (u * ((const double *)__dlog10_ha_CoutTab)[203]);
        dbP = (((((((((const double *)__dlog10_ha_CoutTab)[211] * q +
                     ((const double *)__dlog10_ha_CoutTab)[210]) *
                        q +
                    ((const double *)__dlog10_ha_CoutTab)[209]) *
      ...
      if (x == ((const double *)__dlog10_ha_CoutTab)[201]) {
        ...
        (*r) = -((const double *)__dlog10_ha_CoutTab)[202] /
               ((const double *)__dlog10_ha_CoutTab)[201];
        nRet = 2;
      } else {
        /* Path 4). Here if argument is negative number */
        (*r) = ((const double *)__dlog10_ha_CoutTab)[201] /
               ((const double *)__dlog10_ha_CoutTab)[201];
        nRet = 1;
      }
    }
    ...
    if (((((_iml_dp_union_t *)&(*a))->bits.sign) == 1) &&
        (((((_iml_dp_union_t *)&(*a))->bits.hi_significand) == 0) &&
...
DEVICE_EXTERN_C_INLINE double __devicelib_imf_log10(double x) {
  using namespace __imf_impl_log10_d_ha;
  double r;
  VUINT32 vm;
  double va1;
  double vr1;
  va1 = x;
  {
    ...
    double P12;
    double dS;
    ExpMask = as_double(__devicelib_imf_internal_dlog10_data.ExpMask);
    Two10 = as_double(__devicelib_imf_internal_dlog10_data.Two10);
    /* preserve mantissa, set input exponent to 2^(-10) */
    Mantissa = as_double((as_ulong(va1) & as_ulong(ExpMask)));
    Mantissa = as_double((as_ulong(Mantissa) | as_ulong(Two10)));
    MinNorm = as_double(__devicelib_imf_internal_dlog10_data.MinNorm);
    MaxNorm = as_double(__devicelib_imf_internal_dlog10_data.MaxNorm);
    ...
    CLH = as_double(__devicelib_imf_internal_dlog10_data.CLH);
    DblRcp = (DblRcp * CLH);
    ...
    vm = BrMask;
    /* argument reduction */
    HalfMask = as_double(__devicelib_imf_internal_dlog10_data.HalfMask);
    dR = __fma(Mantissa, DblRcp, -(CLH));
    ;
    /* prepare lookup index */
    Index = as_ulong(DblRcp);
    /* get T as table lookup */
    Index = ((VUINT64)(Index) >> (52 - 8 - 4));
    THL[0] = as_double(
        ((const VUINT64 *)((const char *)(&__devicelib_imf_internal_dlog10_data
                                               .Log_HA_table[0]) -
                           0x406bc0))[Index >> 3]);
    THL[1] = as_double(
        ((const VUINT64 *)((const char *)(&__devicelib_imf_internal_dlog10_data
    ...
    L2H = as_double(__devicelib_imf_internal_dlog10_data.L2H);
    L2L = as_double(__devicelib_imf_internal_dlog10_data.L2L);
    Kh = __fma(FpExpon, L2H, THL[0]);
    Kl = __fma(FpExpon, L2L, THL[1]);
    /* compute polynomial */
    poly_coeff[6] =
        as_double(__devicelib_imf_internal_dlog10_data.ha_poly_coeff[0]);
    poly_coeff[5] =
        as_double(__devicelib_imf_internal_dlog10_data.ha_poly_coeff[1]);
    poly_coeff[4] =
        as_double(__devicelib_imf_internal_dlog10_data.ha_poly_coeff[2]);
    poly_coeff[3] =
        as_double(__devicelib_imf_internal_dlog10_data.ha_poly_coeff[3]);
    poly_coeff[2] =
        as_double(__devicelib_imf_internal_dlog10_data.ha_poly_coeff[4]);
    poly_coeff[1] =
        as_double(__devicelib_imf_internal_dlog10_data.ha_poly_coeff[5]);
    P56 = __fma(poly_coeff[6], dR, poly_coeff[5]);
    P34 = __fma(poly_coeff[4], dR, poly_coeff[3]);
    R2 = (dR * dR);
    P12 = __fma(poly_coeff[2], dR, poly_coeff[1]);
    dS = (Kh + dR);
    dP = __fma(P56, R2, P34);
    Rh = (dS - Kh);
    dP = __fma(dP, R2, P12);
  ...
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_dlog10(&__cout_a1, &__cout_r1);
...
double __svml_device_log10(double x) { return __devicelib_imf_log10(x); }

...
namespace __imf_impl_asinh_d_la {
namespace {
typedef struct {
  ...
  VUINT64 L2H;
  VUINT64 L2L;
} __devicelib_imf_internal_dasinh_data_avx512_t;
static const __devicelib_imf_internal_dasinh_data_avx512_t
    __devicelib_imf_internal_dasinh_data_avx512 = {
        {/*== Log_tbl_H ==*/
...
typedef struct {
  ...
  VUINT64 dOnes[2];
  VUINT64 dZeros[2];
} __devicelib_imf_internal_dasinh_data_t;
static const __devicelib_imf_internal_dasinh_data_t
    __devicelib_imf_internal_dasinh_data = {
        /* Log_HA_table */
...
static const _iml_dp_union_t __dasinh_la_CoutTab[4] = {
...
inline int __devicelib_imf_internal_dasinh(const double *a, double *r) {
  int nRet = 0;
  double yM;
  double purex, y, yN;
...
DEVICE_EXTERN_C_INLINE double __devicelib_imf_asinh(double x) {
  using namespace __imf_impl_asinh_d_la;
  double r;
  VUINT32 vm;
  double va1;
  double vr1;
  va1 = x;
  {
    ...
    One = as_double(__devicelib_imf_internal_dasinh_data.One);
    SgnMask = as_double(__devicelib_imf_internal_dasinh_data.SgnMask);
    XThreshold = as_double(__devicelib_imf_internal_dasinh_data.XThreshold);
    XhMask = as_double(__devicelib_imf_internal_dasinh_data.XhMask);
    ...
    dLargestFinite =
        as_double(__devicelib_imf_internal_dasinh_data.dLargestFinite);
    dSpecialMask = as_double(
        (VUINT64)(((!(dInput <= dLargestFinite)) ? 0xffffffffffffffff : 0x0)));
    ...
    dBigThreshold =
        as_double(__devicelib_imf_internal_dasinh_data.dBigThreshold);
    dModerateMask = as_double(
        (VUINT64)((dInput < dBigThreshold) ? 0xffffffffffffffff : 0x0));
    // No need to split X when FMA is available in hardware.
    dX2Hi = (va1 * va1);
    dX2Lo = __fma(va1, va1, -(dX2Hi));
    ...
    dTmp3 = (dTmp2 + dX2Hi);
    dTmp3 = (dTmp3 + dX2Lo);
    dTopMask29 = as_double(__devicelib_imf_internal_dasinh_data.dTopMask29);
    ...
    dTopMask12 = as_double(__devicelib_imf_internal_dasinh_data.dTopMask12);
    ...
    // C4 = 35/128
    // C5 = 63/256
    dC5 = as_double(__devicelib_imf_internal_dasinh_data.dC5);
    dC4 = as_double(__devicelib_imf_internal_dasinh_data.dC4);
    dPol4 = __fma(dC5, dE, dC4);
    dC3 = as_double(__devicelib_imf_internal_dasinh_data.dC3);
    dPol3 = __fma(dPol4, dE, dC3);
    dC2 = as_double(__devicelib_imf_internal_dasinh_data.dC2);
    dPol2 = __fma(dPol3, dE, dC2);
    dC1 = as_double(__devicelib_imf_internal_dasinh_data.dHalf);
    ...
    dX46 = __fma(dX2over2, dX4over4,
                                  -(dX4over4)); // dX46 = -X^4/4 + X^6/8
    ...
    dLittleThreshold =
        as_double(__devicelib_imf_internal_dasinh_data.dLittleThreshold);
    dLittleMask = as_double(
        (VUINT64)((dInput <= dLittleThreshold) ? 0xffffffffffffffff : 0x0));
    ...
    // case.
    XScale = as_double(__devicelib_imf_internal_dasinh_data.XScale);
    ...
    ExpMask = as_double(__devicelib_imf_internal_dasinh_data.ExpMask);
    Two10 = as_double(__devicelib_imf_internal_dasinh_data.Two10);
    /* preserve mantissa, set input exponent to 2^(-10) */
    Mantissa = as_double((as_ulong(X) & as_ulong(ExpMask)));
    Mantissa = as_double((as_ulong(Mantissa) | as_ulong(Two10)));
    MinLog1p = as_double(__devicelib_imf_internal_dasinh_data.MinLog1p);
    MaxLog1p = as_double(__devicelib_imf_internal_dasinh_data.MaxLog1p);
    ExpMask0 = (__devicelib_imf_internal_dasinh_data.ExpMask0);
    ExpMask2 = (__devicelib_imf_internal_dasinh_data.ExpMask2);
    ...
    dThirtyOne = as_double(__devicelib_imf_internal_dasinh_data.dThirtyOne);
    ...
    T = as_double(
        ((const VUINT64 *)((const char *)(&__devicelib_imf_internal_dasinh_data
                                               .Log_LA_table[0]) -
                           0x408000))[Index >> 3]);
    /* K = exponent*log(2.0) */
    Threshold = as_double(__devicelib_imf_internal_dasinh_data.Threshold);
    Bias = as_double(__devicelib_imf_internal_dasinh_data.Bias);
    Bias1 = as_double(__devicelib_imf_internal_dasinh_data.Bias1);
    L2 = as_double(__devicelib_imf_internal_dasinh_data.L2);
    BMask =
    ...
    /* polynomial: */
    poly_coeff[4] =
        as_double(__devicelib_imf_internal_dasinh_data.poly_coeff[0]);
    poly_coeff[3] =
        as_double(__devicelib_imf_internal_dasinh_data.poly_coeff[1]);
    poly_coeff[2] =
        as_double(__devicelib_imf_internal_dasinh_data.poly_coeff[2]);
    poly_coeff[1] =
        as_double(__devicelib_imf_internal_dasinh_data.poly_coeff[3]);
    // P34 = C4*R + C3
    ...
    dSign = as_double(__devicelib_imf_internal_dasinh_data.dSign);
    // Sign = x & Sign
  ...
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_dasinh(&__cout_a1, &__cout_r1);

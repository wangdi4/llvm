...
namespace __imf_impl_atanh_d_ha {
namespace {
typedef struct {
  VUINT64 Log_tbl_H[16];
  VUINT64 Log_tbl_L[16];
  VUINT64 One;
  VUINT64 AbsMask;
  VUINT64 AddB5;
  VUINT64 RcpBitMask;
  ...
  VUINT64 L2L;
  VUINT64 Half;
} __devicelib_imf_internal_datanh_data_avx512_t;
static const __devicelib_imf_internal_datanh_data_avx512_t
    __devicelib_imf_internal_datanh_data_avx512 = {
        {0x0000000000000000uL, 0x3faf0a30c0120000uL, 0x3fbe27076e2b0000uL,
         0x3fc5ff3070a78000uL, 0x3fcc8ff7c79a8000uL, 0x3fd1675cababc000uL,
         0x3fd4618bc21c4000uL, 0x3fd739d7f6bbc000uL, 0x3fd9f323ecbf8000uL,
         0x3fdc8ff7c79a8000uL, 0x3fdf128f5faf0000uL, 0x3fe0be72e4252000uL,
         0x3fe1e85f5e704000uL, 0x3fe307d7334f2000uL, 0x3fe41d8fe8468000uL,
         0x3fe52a2d265bc000uL},
        {0x0000000000000000uL, 0xbd53ab33d066d1d2uL, 0xbd2a342c2af0003cuL,
         0x3d43d3c873e20a07uL, 0x3d4a21ac25d81ef3uL, 0xbd59f1fc63382a8fuL,
         0x3d5ec27d0b7b37b3uL, 0x3d50069ce24c53fbuL, 0x3d584bf2b68d766fuL,
         0x3d5a21ac25d81ef3uL, 0x3d3bb2cd720ec44cuL, 0x3d55056d312f7668uL,
         0x3d1a07bd8b34be7cuL, 0xbd5e83c094debc15uL, 0xbd5aa33736867a17uL,
         0x3d46abb9df22bc57uL}
        /*== One ==*/
        ,
        ...
        /*== poly_coeff9 ==*/
        ,
        0xbfb9a9b040214368uL
        /*== poly_coeff8 ==*/
        ,
        0x3fbc80666e249778uL
        /*== poly_coeff7 ==*/
        ,
        0xbfbffffb8a054bc9uL
        /*== poly_coeff6 ==*/
        ,
        0x3fc24922f71256f1uL
        /*== poly_coeff5 ==*/
        ,
        0xbfc55555559ba736uL
        /*== poly_coeff4 ==*/
        ,
        0x3fc9999999be77afuL
        /*== poly_coeff3 ==*/
        ,
        0xbfcffffffffffc65uL
        /*== poly_coeff2 ==*/
        ,
        0x3fd55555555554c1uL
        /*== poly_coeff1 ==*/
        ,
        ...
        /*== L2L = log(2)_low ==*/
        ,
        0x3d7cf79abc9e0000uL
        /*== Half ==*/
        ,
        0x3fe0000000000000uL}; /*dLn_Table*/
/* ========================================================================*/
/* ============================ NEW LN ====================================*/
/* ========================================================================*/
typedef struct {
  VUINT64 Log_HA_table[(1 << 10) + 2];
  VUINT64 Log_LA_table[(1 << 9) + 1];
  VUINT64 poly_coeff[4];
  VUINT64 ExpMask;
  VUINT64 Two10;
  VUINT64 MinLog1p;
  VUINT64 MaxLog1p;
  ...
  VUINT64 ExpMask2;
  VUINT64 L2;
  VUINT64 dBigThreshold;
  VUINT64 dC2;
  VUINT64 dC3;
  VUINT64 dC4;
  VUINT64 dC5;
  VUINT64 dHalf;
  VUINT64 dLargestFinite;
  VUINT64 dLittleThreshold;
  VUINT64 dSign;
  VUINT64 dThirtyOne;
  VUINT64 dTopMask12;
  VUINT64 dTopMask26;
  ...
  VUINT64 dOnes[2];
  VUINT64 dZeros[2];
} __devicelib_imf_internal_datanh_data_t;
static const __devicelib_imf_internal_datanh_data_t
    __devicelib_imf_internal_datanh_data = {
        /* Log_HA_table */
        ...
        ,
        {
            0x3fc9999CACDB4D0AuL /* coeff4 */
            ,
            0xbfd0000148058EE1uL /* coeff3 */
            ,
            0x3fd55555555543C5uL /* coeff2 */
            ,
            0xbfdFFFFFFFFFF81FuL /* coeff1 */
        }
        /*== ExpMask ==*/
        ,
        ...
        /*== XThreshold ==*/
        ,
        0x3e00000000000000uL
        /*== XhRnd ==*/
        //,VHEX_BROADCAST( L, 0000000000000200 )
        /*== XhMask ==*/
        ,
        ...
        /*== ExpMask2 ==*/
        ,
        0x7f40000000000000uL
        /*== L2L ==*/
        ,
        0x3fe62E42FEFA39EFuL
        /*== dBigThreshold ==*/
        ,
        0x41D0000000000000uL
        /*== dC2 ==*/
        ,
        0x3FD8000000000000uL
        /*== dC3 ==*/
        ,
        0x3FD4000000000000uL
        /*== dC4 ==*/
        ,
        0x3FD1800000000000uL
        /*== dC5 ==*/
        ,
        0x3FCF800000000000uL
        /*== dHalf ==*/
        ,
        ...
        /*== dLittleThreshold ==*/
        ,
        0x3F60000000000000uL
        /*== dSign ==*/
        ,
        0x8000000000000000uL
        /*== dThirtyOne ==*/
        ,
        0x403F000000000000uL
        /*== dTopMask12 ==*/
        ,
        ...
        /*== XScale ==*/
        ,
        0x3E10000000000000uL
        /*== dTinyRange ==*/
        ,
        0x0350000000000000uL
        /* scalar part follow */
        /*== dInfs = DP infinity, +/- ==*/
        ,
...
static const _iml_dp_union_t __datanh_ha_CoutTab[4] = {
    /* Other simple constants */
    0x00000000, 0x3FF00000, /* ONE = 1.0 */
    0x00000000, 0x00000000, /* ZERO = 0.0 */
    0x00000000, 0x7FF00000, /* PINF = 0x7ff00000 00000000 */
    0x00000000, 0xFFF00000  /* NINF = 0xfff00000 00000000 */
};
...
inline int __devicelib_imf_internal_datanh(const double *a, double *r) {
  int nRet = 0;
  double yM;
  double absx, y, yN;
  ...
  absx = (*a);
  (((_iml_dp_union_t *)&absx)->bits.sign = 0);
  {
    // First deal with NaN inputs: return a NaN and set necessary flags
    if (((((_iml_dp_union_t *)&*a)->bits.exponent) == 0x7FF) &&
        (((((_iml_dp_union_t *)&*a)->bits.hi_significand) != 0x0) ||
         ((((_iml_dp_union_t *)&*a)->bits.lo_significand) != 0x0))) {
      (*r) = (*a) * (*a);
      return nRet;
    }
    // For input of +/- 1, return appropriately signed infinity
    if ((((_iml_dp_union_t *)&(absx))->hex[0] ==
         ((const _iml_dp_union_t *)&(((const double *)__datanh_ha_CoutTab)[0]))
             ->hex[0]) &&
        (((_iml_dp_union_t *)&(absx))->hex[1] ==
         ((const _iml_dp_union_t *)&(((const double *)__datanh_ha_CoutTab)[0]))
             ->hex[1])) {
      (*r) = (*a) / (((const double *)__datanh_ha_CoutTab)[1]);
      nRet = 2;
      return nRet;
    }
    // Otherwise it's |x| > 1 (including infinity), so return NaN + invalid
    {
      (*r) = ((const double *)__datanh_ha_CoutTab)[2] *
             (((const double *)__datanh_ha_CoutTab)[1]);
      nRet = 1;
      return nRet;
    }
  }
...
DEVICE_EXTERN_C_INLINE double __devicelib_imf_atanh(double x) {
  using namespace __imf_impl_atanh_d_ha;
  double r;
  VUINT32 vm;
  double va1;
  double vr1;
  va1 = x;
  {
    ...
    One = as_double(__devicelib_imf_internal_datanh_data.One);
    SgnMask = as_double(__devicelib_imf_internal_datanh_data.SgnMask);
    XThreshold = as_double(__devicelib_imf_internal_datanh_data.XThreshold);
    XhMask = as_double(__devicelib_imf_internal_datanh_data.XhMask);
    ...
    dSpecialMask =
        as_double((VUINT64)(((!(dInput < One)) ? 0xffffffffffffffff : 0x0)));
    lSpecialMask = as_ulong(dSpecialMask);
    vm = 0;
    vm = lSpecialMask;
    dTinyRange = as_double(__devicelib_imf_internal_datanh_data.TinyRange);
    dTinyMask =
        as_double((VUINT64)((dInput < dTinyRange) ? 0xffffffffffffffff : 0x0));
    dTinyRes = __fma(va1, va1, va1);
    // Record the sign for eventual reincorporation.
    dSign = as_double(__devicelib_imf_internal_datanh_data.dSign);
    ...
    dUTmp = (One - dU);
    dUTmp = (dUTmp - dInput);
    dTopMask41 = as_double(__devicelib_imf_internal_datanh_data.dTopMask41);
    dZ = ((double)(1.0f / ((float)(dU))));
    dTopMask12 = as_double(__devicelib_imf_internal_datanh_data.dTopMask12);
    dR = as_double((as_ulong(dZ) & as_ulong(dTopMask12)));
    // No need to split dU when FMA is available
    dE = __fma(-(dR), dU, One);
    dE = __fma(-(dR), dUTmp, dE);
    ...
    dE2 = __fma(dE, dE, One);
    dEE2 = __fma(dE, dE, dE);
    dE25 = __fma(dEE2, dE2, One);
    dD = (dE * dE25);
    // Compute R * (VHi + VLo) * (1 + E + E^2 + E^3 + E^4 + E^5)
    //       = R *  (VHi + VLo) * (1 + D)
    //       = QHi + (QHi * D + QLo + QLo * D)
    dTmp1 = (dD * dQHi);
    dTmp2 = __fma(dD, dQLo, dQLo);
    dTmp3 = (dTmp1 + dTmp2);
    ...
    XMask =
        as_double((VUINT64)((Xabs < XThreshold) ? 0xffffffffffffffff : 0x0));
    XhMask = as_double((as_ulong(XhMask) | as_ulong(XMask)));
    X = (A + B);
    X = as_double((as_ulong(X) & as_ulong(XhMask)));
    Xl = (A - X);
    Xl = (Xl + B);
    ExpMask = as_double(__devicelib_imf_internal_datanh_data.ExpMask);
    Two10 = as_double(__devicelib_imf_internal_datanh_data.Two10);
    /* preserve mantissa, set input exponent to 2^(-10) */
    Mantissa = as_double((as_ulong(X) & as_ulong(ExpMask)));
    Mantissa = as_double((as_ulong(Mantissa) | as_ulong(Two10)));
    MinLog1p = as_double(__devicelib_imf_internal_datanh_data.MinLog1p);
    MaxLog1p = as_double(__devicelib_imf_internal_datanh_data.MaxLog1p);
    ExpMask0 = (__devicelib_imf_internal_datanh_data.ExpMask0);
    ExpMask2 = (__devicelib_imf_internal_datanh_data.ExpMask2);
    ...
    ExpX = (ExpMask2 - ExpX);
    /* exponent bits */
    Expon = ((VUINT64)(Expon) >> (52 - 32));
    IExpon = ((VUINT32)((VUINT64)Expon >> 32));
    /* round reciprocal to nearest integer, will have 1+9 mantissa bits */
    DblRcp = __rint(DblRcp);
    /* scale DblRcp */
    FpExpX = as_double(ExpX);
    DblRcp1 = (FpExpX * DblRcp);
    /* biased exponent in DP format */
    FpExpon = ((double)((VINT32)(IExpon)));
    /* prepare table index */
    Index = as_ulong(DblRcp);
    /* table lookup */
    Index = ((VUINT64)(Index) >> (52 - 9 - 4));
    THL[0] = as_double(
        ((const VUINT64 *)((const char *)(&__devicelib_imf_internal_datanh_data
                                               .Log_HA_table[0]) -
                           0x810000))[Index >> 3]);
    THL[1] = as_double(
        ((const VUINT64 *)((const char *)(&__devicelib_imf_internal_datanh_data
                           ...
                           0x810000))[(Index >> 3) + 1]);
    /* exponent*log(2.0) */
    L2H = as_double(__devicelib_imf_internal_datanh_data.L2H);
    L2L = as_double(__devicelib_imf_internal_datanh_data.L2L);
    Kh = __fma(FpExpon, L2H, THL[0]);
    Kl = __fma(FpExpon, L2L, THL[1]);
    /* argument reduction */
    Rh = __fma(X, DblRcp1, -(One));
    Rl = (Xl * DblRcp1);
    R = (Rh + Rl);
    Rlh = (R - Rh);
    Rl = (Rl - Rlh);
    Rl = __fma(dL, DblRcp1, Rl);
    /* polynomial */
    poly_coeff[4] =
        as_double(__devicelib_imf_internal_datanh_data.poly_coeff[0]);
    poly_coeff[3] =
        as_double(__devicelib_imf_internal_datanh_data.poly_coeff[1]);
    poly_coeff[2] =
        as_double(__devicelib_imf_internal_datanh_data.poly_coeff[2]);
    poly_coeff[1] =
        as_double(__devicelib_imf_internal_datanh_data.poly_coeff[3]);
    // P34 = C4*R + C3
    P34 = __fma(poly_coeff[4], R, poly_coeff[3]);
    // P12 = C2*R + C1
    P12 = __fma(poly_coeff[2], R, poly_coeff[1]);
    // R2 = R*R
    R2 = (R * R);
    // P = P34*R2 + P12
    P = __fma(P34, R2, P12);
    ...
    dHalf = as_double(__devicelib_imf_internal_datanh_data.dHalf);
    // Half = Half^Sign
    dHalf = as_double((as_ulong(dHalf) ^ as_ulong(dSign)));
    // Result = Result*Half
    vr1 = (dHalf * dResult);
    // Blend main path result and tiny arguments path result
    vr1 = as_double((((~as_ulong(dTinyMask)) & as_ulong(vr1)) |
                     (as_ulong(dTinyMask) & as_ulong(dTinyRes))));
  }
  if (__builtin_expect((vm) != 0, 0)) {
    ...
    __devicelib_imf_internal_datanh(&__cout_a1, &__cout_r1);

...
//                        while the tests are run with non-conformant behaviour
//                        of default_selector.
// RUN: %CPU_RUN_PLACEHOLDER env SYCL_BE=%sycl_be ./app.exe
// RUN: %GPU_RUN_PLACEHOLDER env SYCL_BE=%sycl_be ./app.exe

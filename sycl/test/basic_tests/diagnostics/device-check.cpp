...
// RUN: %CPU_RUN_PLACEHOLDER env SYCL_DEVICE_TYPE=cpu %t.out
// RUN: %GPU_RUN_PLACEHOLDER env SYCL_DEVICE_TYPE=gpu %t.out
// RUN: %ACC_RUN_PLACEHOLDER env SYCL_DEVICE_TYPE=acc %t.out

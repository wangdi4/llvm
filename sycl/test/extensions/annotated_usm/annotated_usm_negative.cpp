...
void testInvalidRuntimeProperty(sycl::queue &q) {
  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_base.hpp:* {{static assertion failed due to requirement {{.+}}: Input property list contains invalid item.}}
...
void testConfilictingUsmKind(sycl::queue &q) {
  ...
  properties InP{usm_kind<alloc::host>};

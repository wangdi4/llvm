<<<<<<< HEAD
// RUN: %clangxx -I %sycl_include -S -emit-llvm -fsycl-device-only -Wno-sycl-strict %s -o - | FileCheck %s
//
=======
...
void ap_float_add(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i14 @_Z{{[0-9]+}}__spirv_ArbitraryFloatAddINTEL{{.*}}(i13 signext %{{[0-9]}}, i32 7, i15 signext %{{[0-9]}}, i32 8, i32 9, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int EB, int MB, int Eout, int Mout>
void ap_float_sub(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> sub_res =
      __spirv_ArbitraryFloatSubINTEL<1 + EA + MA, 1 + EB + MB, 1 + Eout + Mout>(
          A, MA, B, MB, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i13 @_Z{{[0-9]+}}__spirv_ArbitraryFloatSubINTEL{{.*}}(i9 signext %{{[0-9]}}, i32 4, i11 signext %{{[0-9]}}, i32 5, i32 6, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int EB, int MB, int Eout, int Mout>
void ap_float_mul(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> mul_res =
      __spirv_ArbitraryFloatMulINTEL<1 + EA + MA, 1 + EB + MB, 1 + Eout + Mout>(
          A, MA, B, MB, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i51 @_Z{{[0-9]+}}__spirv_ArbitraryFloatMulINTEL{{.*}}(i51 %{{[0-9]}}, i32 34, i51 %{{[0-9]}}, i32 34, i32 34, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int EB, int MB, int Eout, int Mout>
void ap_float_div(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> div_res =
      __spirv_ArbitraryFloatDivINTEL<1 + EA + MA, 1 + EB + MB, 1 + Eout + Mout>(
          A, MA, B, MB, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i18 @_Z{{[0-9]+}}__spirv_ArbitraryFloatDivINTEL{{.*}}(i16 signext %{{[0-9]}}, i32 11, i16 signext %{{[0-9]}}, i32 11, i32 12, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
=======
...
template <int EA, int MA, int Eout, int Mout>
void ap_float_recip(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
  // CHECK: %{{.*}} = call spir_func zeroext i1 @_Z{{[0-9]+}}__spirv_ArbitraryFloatEQINTEL{{.*}}(i20 signext %{{[0-9]+}}, i32 12, i15 signext %{{[0-9]+}}, i32 7)
}
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> recip_res =
      __spirv_ArbitraryFloatRecipINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i39 @_Z{{[0-9]+}}__spirv_ArbitraryFloatRecipINTEL{{.*}}(i39 %{{[0-9]}}, i32 29, i32 29, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_rsqrt(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> rsqrt_res =
      __spirv_ArbitraryFloatRSqrtINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i34 @_Z{{[0-9]+}}__spirv_ArbitraryFloatRSqrtINTEL{{.*}}(i32 %{{[0-9]}}, i32 19, i32 20, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_cbrt(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> cbrt_res =
      __spirv_ArbitraryFloatCbrtINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i2 @_Z{{[0-9]+}}__spirv_ArbitraryFloatCbrtINTEL{{.*}}(i2 signext %{{[0-9]}}, i32 1, i32 1, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int EB, int MB, int Eout, int Mout>
void ap_float_hypot(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> hypot_res =
      __spirv_ArbitraryFloatHypotINTEL<1 + EA + MA, 1 + EB + MB, 1 + Eout + Mout>(
          A, MA, B, MB, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i42 @_Z{{[0-9]+}}__spirv_ArbitraryFloatHypotINTEL{{.*}}(i41 %{{[0-9]}}, i32 20, i43 %{{[0-9]}}, i32 21, i32 22, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_sqrt(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> sqrt_res =
      __spirv_ArbitraryFloatSqrtINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i17 @_Z{{[0-9]+}}__spirv_ArbitraryFloatSqrtINTEL{{.*}}(i15 signext %{{[0-9]}}, i32 7, i32 8, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_log(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> log_res =
      __spirv_ArbitraryFloatLogINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i50 @_Z{{[0-9]+}}__spirv_ArbitraryFloatLogINTEL{{.*}}(i50 %{{[0-9]}}, i32 19, i32 30, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_log2(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> log2_res =
      __spirv_ArbitraryFloatLog2INTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i38 @_Z{{[0-9]+}}__spirv_ArbitraryFloatLog2INTEL{{.*}}(i38 %{{[0-9]}}, i32 20, i32 19, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_log10(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> log10_res =
      __spirv_ArbitraryFloatLog10INTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i10 @_Z{{[0-9]+}}__spirv_ArbitraryFloatLog10INTEL{{.*}}(i8 signext %{{[0-9]}}, i32 3, i32 5, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_log1p(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> log1p_res =
      __spirv_ArbitraryFloatLog1pINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i49 @_Z{{[0-9]+}}__spirv_ArbitraryFloatLog1pINTEL{{.*}}(i48 %{{[0-9]}}, i32 30, i32 30, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_exp(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> exp_res =
      __spirv_ArbitraryFloatExpINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i42 @_Z{{[0-9]+}}__spirv_ArbitraryFloatExpINTEL{{.*}}(i42 %{{[0-9]}}, i32 25, i32 25, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_exp2(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> exp2_res =
      __spirv_ArbitraryFloatExp2INTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i5 @_Z{{[0-9]+}}__spirv_ArbitraryFloatExp2INTEL{{.*}}(i3 signext %{{[0-9]}}, i32 1, i32 2, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_exp10(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> exp10_res =
      __spirv_ArbitraryFloatExp10INTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i25 @_Z{{[0-9]+}}__spirv_ArbitraryFloatExp10INTEL{{.*}}(i25 signext %{{[0-9]}}, i32 16, i32 16, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_expm1(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> expm1_res =
      __spirv_ArbitraryFloatExpm1INTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i62 @_Z{{[0-9]+}}__spirv_ArbitraryFloatExpm1INTEL{{.*}}(i64 %{{[0-9]}}, i32 42, i32 41, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_sin(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> sin_res =
      __spirv_ArbitraryFloatSinINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i34 @_Z{{[0-9]+}}__spirv_ArbitraryFloatSinINTEL{{.*}}(i30 signext %{{[0-9]}}, i32 15, i32 17, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_cos(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> cos_res =
      __spirv_ArbitraryFloatCosINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i4 @_Z{{[0-9]+}}__spirv_ArbitraryFloatCosINTEL{{.*}}(i4 signext %{{[0-9]}}, i32 2, i32 1, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_sincos(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<2 * (1 + Eout + Mout)> sincos_res =
      __spirv_ArbitraryFloatSinCosINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i62 @_Z{{[0-9]+}}__spirv_ArbitraryFloatSinCosINTEL{{.*}}(i27 signext %{{[0-9]}}, i32 18, i32 20, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_sinpi(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> sinpi_res =
      __spirv_ArbitraryFloatSinPiINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i13 @_Z{{[0-9]+}}__spirv_ArbitraryFloatSinPiINTEL{{.*}}(i10 signext %{{[0-9]}}, i32 6, i32 6, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_cospi(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> cospi_res =
      __spirv_ArbitraryFloatCosPiINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i59 @_Z{{[0-9]+}}__spirv_ArbitraryFloatCosPiINTEL{{.*}}(i59 %{{[0-9]}}, i32 40, i32 40, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_sincospi(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<2 * (1 + Eout + Mout)> sincos_res =
      __spirv_ArbitraryFloatSinCosPiINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i64 @_Z{{[0-9]+}}__spirv_ArbitraryFloatSinCosPiINTEL{{.*}}(i30 signext %{{[0-9]}}, i32 20, i32 20, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_asin(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> asin_res =
      __spirv_ArbitraryFloatASinINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i11 @_Z{{[0-9]+}}__spirv_ArbitraryFloatASinINTEL{{.*}}(i7 signext %{{[0-9]}}, i32 4, i32 8, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_asinpi(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> asinpi_res =
      __spirv_ArbitraryFloatASinPiINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i35 @_Z{{[0-9]+}}__spirv_ArbitraryFloatASinPiINTEL{{.*}}(i35 %{{[0-9]}}, i32 23, i32 23, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_acos(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> acos_res =
      __spirv_ArbitraryFloatACosINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i14 @_Z{{[0-9]+}}__spirv_ArbitraryFloatACosINTEL{{.*}}(i14 signext %{{[0-9]}}, i32 9, i32 10, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_acospi(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> acospi_res =
      __spirv_ArbitraryFloatACosPiINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i8 @_Z{{[0-9]+}}__spirv_ArbitraryFloatACosPiINTEL{{.*}}(i8 signext %{{[0-9]}}, i32 5, i32 4, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_atan(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> atan_res =
      __spirv_ArbitraryFloatATanINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i44 @_Z{{[0-9]+}}__spirv_ArbitraryFloatATanINTEL{{.*}}(i44 %{{[0-9]}}, i32 31, i32 31, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_atapin(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> atanpi_res =
      __spirv_ArbitraryFloatATanPiINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i34 @_Z{{[0-9]+}}__spirv_ArbitraryFloatATanPiINTEL{{.*}}(i40 %{{[0-9]}}, i32 38, i32 32, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int EB, int MB, int Eout, int Mout>
void ap_float_atan2(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> atan2_res =
      __spirv_ArbitraryFloatATan2INTEL<1 + EA + MA, 1 + EB + MB, 1 + Eout + Mout>(
          A, MA, B, MB, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i27 @_Z{{[0-9]+}}__spirv_ArbitraryFloatATan2INTEL{{.*}}(i24 signext %{{[0-9]}}, i32 16, i25 signext %{{[0-9]}}, i32 17, i32 18, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int EB, int MB, int Eout, int Mout>
void ap_float_pow(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> pow_res =
      __spirv_ArbitraryFloatPowINTEL<1 + EA + MA, 1 + EB + MB, 1 + Eout + Mout>(
          A, MA, B, MB, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i21 @_Z{{[0-9]+}}__spirv_ArbitraryFloatPowINTEL{{.*}}(i17 signext %{{[0-9]}}, i32 8, i19 signext %{{[0-9]}}, i32 9, i32 10, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int EB, int MB, int Eout, int Mout>
void ap_float_powr(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
>>>>>>> 0a8e7d30b111069b3a9117fc9708f43de3837f04
  ...
  ap_int<1 + Eout + Mout> powr_res =
      __spirv_ArbitraryFloatPowRINTEL<1 + EA + MA, 1 + EB + MB, 1 + Eout + Mout>(
          A, MA, B, MB, Mout, Subnorm, RndMode, RndAcc);
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func i56 @_Z{{[0-9]+}}__spirv_ArbitraryFloatPowRINTEL{{.*}}(i54 %{{[0-9]}}, i32 35, i55 %{{[0-9]}}, i32 35, i32 35, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int WB, int Eout, int Mout>
void ap_float_pown(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
=======
...
<<<<<<< HEAD
  // CHECK: %{{.*}} = call spir_func signext i15 @_Z{{[0-9]+}}__spirv_ArbitraryFloatPowNINTEL{{.*}}(i12 signext %{{[0-9]}}, i32 7, i10 signext %{{[0-9]}}, i32 9, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Eout, int Mout>
void ap_float_cast(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
  ap_int<1 + EA + MA> A;
  ap_int<1 + Eout + Mout> float_cast_res =
      __spirv_ArbitraryFloatCastINTEL<1 + EA + MA, 1 + Eout + Mout>(
          A, MA, Mout, Subnorm, RndMode, RndAcc);
  // CHECK: %{{.*}} = call spir_func i40 @_Z{{[0-9]+}}__spirv_ArbitraryFloatCastINTEL{{.*}}(i40 %{{[0-9]}}, i32 28, i32 30, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int WA, int Eout, int Mout>
void ap_float_cast_from_int(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
  ap_int<WA> A;
  ap_int<1 + Eout + Mout> cast_from_int_res =
      __spirv_ArbitraryFloatCastFromIntINTEL<WA, 1 + Eout + Mout>(
          A, Mout, Subnorm, RndMode, RndAcc);
  // CHECK: %{{.*}} = call spir_func signext i25 @_Z{{[0-9]+}}__spirv_ArbitraryFloatCastFromIntINTEL{{.*}}(i43 %{{[0-9]}}, i32 16, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
}

template <int EA, int MA, int Wout>
void ap_float_cast_to_int(int32_t Subnorm, int32_t RndMode, int32_t RndAcc) {
  ap_int<1 + EA + MA> A;
  ap_int<Wout> cast_to_int_res =
      __spirv_ArbitraryFloatCastToIntINTEL<1 + EA + MA, Wout>(
          A, MA, Subnorm, RndMode, RndAcc);
  // CHECK: %{{.*}} = call spir_func signext i30 @_Z{{[0-9]+}}__spirv_ArbitraryFloatCastToIntINTEL{{.*}}(i23 signext %{{[0-9]}}, i32 15, i32 %{{[0-9]}}, i32 %{{[0-9]}}, i32 %{{[0-9]}})
=======
...
<<<<<<< HEAD
    int32_t Subnorm = 0, RndMode = 2, RndAcc = 1;
    ap_float_add<5, 7, 6, 8, 4, 9>(Subnorm, RndMode, RndAcc);
    ap_float_sub<4, 4, 5, 5, 6, 6>(Subnorm, RndMode, RndAcc);
    ap_float_mul<16, 34, 16, 34, 16, 34>(Subnorm, RndMode, RndAcc);
    ap_float_div<4, 11, 4, 11, 5, 12>(Subnorm, RndMode, RndAcc);
=======
...
<<<<<<< HEAD
    ap_float_recip<9, 29, 9, 29>(Subnorm, RndMode, RndAcc);
    ap_float_rsqrt<12, 19, 13, 20>(Subnorm, RndMode, RndAcc);
    ap_float_cbrt<0, 1, 0, 1>(Subnorm, RndMode, RndAcc);
    ap_float_hypot<20, 20, 21, 21, 19, 22>(Subnorm, RndMode, RndAcc);
    ap_float_sqrt<7, 7, 8, 8>(Subnorm, RndMode, RndAcc);
    ap_float_log<30, 19, 19, 30>(Subnorm, RndMode, RndAcc);
    ap_float_log2<17, 20, 18, 19>(Subnorm, RndMode, RndAcc);
    ap_float_log10<4, 3, 4, 5>(Subnorm, RndMode, RndAcc);
    ap_float_log1p<17, 30, 18, 30>(Subnorm, RndMode, RndAcc);
    ap_float_exp<16, 25, 16, 25>(Subnorm, RndMode, RndAcc);
    ap_float_exp2<1, 1, 2, 2>(Subnorm, RndMode, RndAcc);
    ap_float_exp10<8, 16, 8, 16>(Subnorm, RndMode, RndAcc);
    ap_float_expm1<21, 42, 20, 41>(Subnorm, RndMode, RndAcc);
    ap_float_sin<14, 15, 16, 17>(Subnorm, RndMode, RndAcc);
    ap_float_cos<1, 2, 2, 1>(Subnorm, RndMode, RndAcc);
    ap_float_sincos<8, 18, 10, 20>(Subnorm, RndMode, RndAcc);
    ap_float_sinpi<3, 6, 6, 6>(Subnorm, RndMode, RndAcc);
    ap_float_cospi<18, 40, 18, 40>(Subnorm, RndMode, RndAcc);
    ap_float_sincospi<9, 20, 11, 20>(Subnorm, RndMode, RndAcc);
    ap_float_asin<2, 4, 2, 8>(Subnorm, RndMode, RndAcc);
    ap_float_asinpi<11, 23, 11, 23>(Subnorm, RndMode, RndAcc);
    ap_float_acos<4, 9, 3, 10>(Subnorm, RndMode, RndAcc);
    ap_float_acospi<2, 5, 3, 4>(Subnorm, RndMode, RndAcc);
    ap_float_atan<12, 31, 12, 31>(Subnorm, RndMode, RndAcc);
    ap_float_atapin<1, 38, 1, 32>(Subnorm, RndMode, RndAcc);
    ap_float_atan2<7, 16, 7, 17, 8, 18>(Subnorm, RndMode, RndAcc);
    ap_float_pow<8, 8, 9, 9, 10, 10>(Subnorm, RndMode, RndAcc);
    ap_float_powr<18, 35, 19, 35, 20, 35>(Subnorm, RndMode, RndAcc);
    ap_float_pown<4, 7, 10, 5, 9>(Subnorm, RndMode, RndAcc);
    ap_float_cast<11, 28, 9, 30>(Subnorm, RndMode, RndAcc);
    ap_float_cast_from_int<43, 8, 16>(Subnorm, RndMode, RndAcc);
    ap_float_cast_to_int<7, 15, 30>(Subnorm, RndMode, RndAcc);
=======

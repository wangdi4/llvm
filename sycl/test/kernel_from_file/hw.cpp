...
// RUN: %CPU_RUN_PLACEHOLDER env SYCL_BE=%sycl_be SYCL_USE_KERNEL_SPV=%t.spv %t.out 2>&1 %CPU_CHECK_PLACEHOLDER
// RUN: %GPU_RUN_PLACEHOLDER env SYCL_BE=%sycl_be SYCL_USE_KERNEL_SPV=%t.spv %t.out 2>&1 %GPU_CHECK_PLACEHOLDER
// RUN: %ACC_RUN_PLACEHOLDER env SYCL_BE=%sycl_be SYCL_USE_KERNEL_SPV=%t.spv %t.out 2>&1 %ACC_CHECK_PLACEHOLDER
// CHECK: Passed

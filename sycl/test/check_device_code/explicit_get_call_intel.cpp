...
// CHECK-COUNT-2: call spir_func i32 @_Z28__spirv_TaskSequenceGetINTEL{{.*}}([[TaskSequence]] addrspace(4)*{{.*}}, i32 (i32 addrspace(4)*, i32 addrspace(4)*, i32)*{{.*}}[[Function]], i64{{.*}}, i32 2)
...
int main () {
  ...
  myQueue.submit([&](cl::sycl::handler& cgh) {
    cl::sycl::buffer<int, 1> result_sycl(&result, cl::sycl::range<1>(1));
    auto result_acc =
        result_sycl.get_access<cl::sycl::access::mode::write>(cgh);

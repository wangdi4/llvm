...
extern SYCL_EXTERNAL float __imf_frexpf (float x, int32_t* z);
extern SYCL_EXTERNAL int32_t __imf_ilogbf (float x);
extern SYCL_EXTERNAL float __imf_rcbrtf (float x);
extern SYCL_EXTERNAL float __imf_ldexpf (float x, int32_t y);
...
extern SYCL_EXTERNAL float __imf_remquof (float x, float y, int32_t* z);

...
#define VALIDATE_PROPERTIES(t)                                                 \
  static_assert(detail::ValidAllocPropertyList<t, propertyListA>::value,               \
...
std::enable_if_t<detail::CheckTAndPropLists<void, propertyListA, propertyListB>::value,
...
aligned_alloc_annotated(size_t alignment, size_t numBytes,
  ...
  constexpr size_t alignFromPropList = detail::GetAlignFromPropList<propertyListA>::value;
...
template <typename T, typename propertyListA = detail::empty_properties_t,
          typename propertyListB =
              typename detail::GetCompileTimeProperties<propertyListA>::type>
std::enable_if_t<detail::CheckTAndPropLists<T, propertyListA, propertyListB>::value,

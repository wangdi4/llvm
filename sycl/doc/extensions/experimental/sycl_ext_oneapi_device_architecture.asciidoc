...
|`intel_cpu_dmr`
|-
|Intel Xeon processor codenamed Diamond Rapids. The utility of this
enumeration is currently limited. See the section "Limitations with
the experimental version" for details.
endif::[]
endif::[]
...
ifdef::INTEL_CUSTOMIZATION[]
ifdef::INTEL_FEATURE_CPU_DMR[]
The architecture enumerations `intel_cpu_spr`, `intel_cpu_gnr` and
`intel_cpu_dmr` do not currently work with any of the APIs described
in this extension.
endif::[]
ifndef::INTEL_FEATURE_CPU_DMR[]

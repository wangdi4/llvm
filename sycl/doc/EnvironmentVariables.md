...
| SYCL_BE | PI_OPENCL, PI_LEVEL0, PI_CUDA | When SYCL RT is built with PI, this controls which plugin is used by the default device selector. Default value is PI_LEVEL0. |

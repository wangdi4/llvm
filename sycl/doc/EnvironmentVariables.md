...
| SYCL_CACHE_PERSISTENT | Integer | Controls persistent device compiled code cache - setting to '1' turns it on, to '0' - off. When on, SYCL runtime will try to cache and reuse JIT-compiled binaries. Default is off. |

...
class PrintedTraceParser(object):
    ...
    def __init__(self, parsedRawData):
        defineCounters = ("Command type",
						  ...
						  "COI enqueue to COI running",
						  "COI running to COI completed",
						  "COI completed to COI notification",
                          "COI enqueue to COI notification",
                          "R.T. execution after notification",
						  "OpenCL running to completed",
        ...
        self._countersToFunc = {defineCounters[0] : (self.__simple, 1, "command_type"),
                                ...
                                defineCounters[2] : (self.__delta_with_freq_dev, 1, "build_program_time_start", "build_program_time_end"),
                                defineCounters[3] : (self.__delta_with_freq_dev, 1, "build_serialize_time_start", "build_serialize_time_end"),
                                defineCounters[4] : (self.__delta_with_freq_dev, 1, "build_deserialize_time_start", "build_deserialize_time_end"),
                                defineCounters[5] : (self.__simple, 1, "num_of_buffer_operations"),
                                defineCounters[6] : (self.__simple, 1, "buffer_operation_overall_size"),
                                defineCounters[7] : (self.__simple, 1, "num_of_buffer_sent_to_device"),
                                defineCounters[8] : (self.__simple, 1, "buffers_size_sent_to_device"),
                                defineCounters[9] : (self.__simple, 1, "kernel_name"),
                                defineCounters[10] : (self.__simple, 3, "global_work_size"),
                                defineCounters[11] : (self.__simple, 3, "work_group_size"),
                                defineCounters[12] : (self.__delta_with_freq_dev, 1, "command_host_time_start", "coi_enqueue_command_time_start"),
                                defineCounters[13] : (self.__delta_with_freq_dev, 1, "coi_enqueue_command_time_start", "coi_execution_time_start"),
                                defineCounters[14] : (self.__delta_with_freq_dev, 1, "coi_execution_time_start", "coi_execution_time_end"),
                                defineCounters[15] : (self.__delta_with_freq_dev, 1, "coi_execution_time_end", "coi_notify_command_time_end"),
                                defineCounters[16] : (self.__delta_with_freq_dev, 1, "coi_enqueue_command_time_start", "coi_notify_command_time_end"),
                                defineCounters[17] : (self.__delta_with_freq_dev, 1, "coi_notify_command_time_end", "command_host_time_end"),
                                defineCounters[18] : (self.__delta_with_freq_dev, 1, "opencl_running_time_start", "opencl_running_time_end"),
                                defineCounters[19] : (self.__delta_with_freq_dev, 1, "command_host_time_start", "command_host_time_end"),
                                defineCounters[20] : (self.__delta_with_freq_dev, 1, "cmd_run_in_device_time_start", "tbb_exe_in_device_time_start"),
                                defineCounters[21] : (self.__delta_with_freq_dev, 1, "tbb_exe_in_device_time_end", "cmd_run_in_device_time_end"),
                                defineCounters[22] : (self.__delta_with_freq_dev, 1, "tbb_exe_in_device_time_start", "tbb_exe_in_device_time_end"),
                                defineCounters[23] : (self.__delta_with_freq_dev, 1, "cmd_run_in_device_time_start", "cmd_run_in_device_time_end"),
                                defineCounters[24] : (self.__delta, 1, "COI enqueue to COI notification", "Device - NDRange overall time"),
                                defineCounters[25] : (self.__simple, parsedRawData.getNumOfInstances("thread_num_of_invocations"), "thread_num_of_invocations"),
                                defineCounters[26] : (self.__simple, parsedRawData.getNumOfInstances("thread_num_wg_exe"), "thread_num_wg_exe"),
                                defineCounters[27] : (self.__dev_by_freq, parsedRawData.getNumOfInstances("thread_overall_time"), "thread_overall_time")}

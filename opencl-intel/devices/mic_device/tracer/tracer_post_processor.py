...
class PrintedTraceParser(object):
    ...
    def __init__(self, parsedRawData):
        ...
        self._countersToFunc = {defineCounters[0] : (self.__simple, 1, "command_type"),
                                ...
                                defineCounters[12] : (self.__delta_with_freq_dev, 1, "command_host_time_start", "coi_execute_command_time_start"),
                                defineCounters[13] : (self.__delta_with_freq_dev, 1, "coi_execute_command_time_start", "coi_execute_command_time_end"),
                                defineCounters[14] : (self.__delta_with_freq_dev, 1, "coi_execute_command_time_end", "command_host_time_end"),
                                defineCounters[15] : (self.__delta_with_freq_dev, 1, "command_host_time_start", "command_host_time_end"),
                                defineCounters[16] : (self.__delta_with_freq_dev, 1, "cmd_run_in_device_time_start", "tbb_exe_in_device_time_start"),
                                defineCounters[17] : (self.__delta_with_freq_dev, 1, "tbb_exe_in_device_time_end", "cmd_run_in_device_time_end"),
                                defineCounters[18] : (self.__delta_with_freq_dev, 1, "tbb_exe_in_device_time_start", "tbb_exe_in_device_time_end"),
                                defineCounters[19] : (self.__delta_with_freq_dev, 1, "cmd_run_in_device_time_start", "cmd_run_in_device_time_end"),
                                defineCounters[20] : (self.__delta, 1, "COI enqueue to COI notification", "Device - NDRange overall time"),
                                defineCounters[21] : (self.__simple, parsedRawData.getNumOfInstances("thread_num_of_invocations"), "thread_num_of_invocations"),
                                defineCounters[22] : (self.__simple, parsedRawData.getNumOfInstances("thread_num_wg_exe"), "thread_num_wg_exe"),
                                defineCounters[23] : (self.__dev_by_freq, parsedRawData.getNumOfInstances("thread_overall_time"), "thread_overall_time")}

...
public:
    ...
    // Device entry points
    cl_dev_err_code
    clDevSetDefaultCommandList(cl_dev_cmd_list IN list) override;
    ...
    cl_dev_err_code
    clDevCreateMemoryObject(cl_dev_subdevice_id IN node_id,
    ...
    cl_dev_err_code clDevGetProgramBinary(cl_dev_program IN prog,
                                          size_t IN size, void *OUT binary,
    ...
    cl_dev_err_code clDevGetSupportedBinaries(size_t IN count,
                                              ...
                                              size_t *OUT sizeRet) override;
    cl_dev_err_code clDevGetKernelId(cl_dev_program IN prog,
                                     const char *IN name,

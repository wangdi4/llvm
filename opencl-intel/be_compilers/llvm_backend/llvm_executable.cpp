								  ...
								  const size_t* IN pItemsToProcess)
{
	...
	*pWGid = pGroupId;
	...
	__m128i xmmGlobalOffset = _mm_lddqu_si128((__m128i*)m_pBinary->m_WorkInfo.GlobalOffset);
	xmmGroupId = _mm_mullo_epi32(xmmGroupId, xmmGroupSize);
	xmmGroupId = _mm_add_epi32(xmmGroupId, xmmGlobalOffset);
											 ...
											 const size_t* IN pItemsToProcess)
{
	...
	*pWGid = pGroupId;
	...
	case 2:
		...
		xmmGlobalOffset = _mm_loadl_epi64((__m128i*)m_pBinary->m_WorkInfo.GlobalOffset);
		xmmGroupId = _mm_mullo_epi32(xmmGroupId, xmmGroupSize);
		xmmGroupId = _mm_add_epi32(xmmGroupId, xmmGlobalOffset);
	...
	case 3:
		...
		xmmGlobalOffset = _mm_lddqu_si128((__m128i*)m_pBinary->m_WorkInfo.GlobalOffset);
		xmmGroupId = _mm_mullo_epi32(xmmGroupId, xmmGroupSize);
		xmmGroupId = _mm_add_epi32(xmmGroupId, xmmGlobalOffset);
		_mm_store_si128((__m128i*)m_pBaseGlobalId, xmmGroupId);
#else

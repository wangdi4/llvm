...
Arena::CreateMaybeMessage<::google::protobuf::EnumValueDescriptorProto>(
    Arena *);
template <>
...
public:
  ...
  void
  unsafe_arena_set_allocated_options(::google::protobuf::FileOptions *options);
...
public:
  ...
  void
  unsafe_arena_set_allocated_options(::google::protobuf::FieldOptions *options);
...
public:
  ...
  void
  unsafe_arena_set_allocated_options(::google::protobuf::OneofOptions *options);
...
public:
  ...
  void
  unsafe_arena_set_allocated_options(::google::protobuf::EnumOptions *options);
...
public:
  ...
  PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    future release.")
  void
  unsafe_arena_set_allocated_aggregate_value(::std::string *aggregate_value);
...
inline const ::std::string &
EnumDescriptorProto::reserved_name(int index) const {
...
inline void
FileOptions::set_php_metadata_namespace(const ::std::string &value) {
...
inline void
FileOptions::set_allocated_ruby_package(::std::string *ruby_package) {

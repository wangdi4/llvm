...
#pragma warning(disable : 4995)  //warning C4995: 'strcpy': name was marked as #pragma deprecated
        ...
        #include "tal_api.h"
            ...
            #undef UNUSED_TAL_FUNCTION_ARGS
                ...
                typedef struct 
                {
					...
					#ifdef TAL_DISABLE
						#define TAL_FUNCTION_BODY(fname, ...) { UNUSED_TAL_FUNCTION_ARGS (__VA_ARGS__);} ;
					#else //TAL_DISABLE
						#define TAL_FUNCTION_BODY(fname, ...)  \
							{ \
                ...
                #define TAL_FUNCTION_PARAMS TAL_FUNCTION_ARG_TRACE, TAL_FUNCTION_ARG_LVL, TAL_LOG_CAT_ALL

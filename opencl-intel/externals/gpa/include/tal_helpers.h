...
TAL_INLINE TAL_UINT64       TAL_GetCurrentTime()
{
	...
	return TAL_GetCurrentTime_Internal();
		...
		#pragma warning(disable : 4995) // 'XXX' was name was marked as #pragma deprecated
...
//inline TAL_UINT32 TAL_AtomicExchange(volatile TAL_UINT32* addr, TAL_UINT32 val) {
//	return TAL_AtomicExchange((volatile TAL_UINT32*)addr, val);	
//}
...
//inline TAL_UINT32 TAL_AtomicCompareAndSwap(volatile TAL_UINT32* addr, TAL_UINT32 newval, TAL_UINT32 refvalue) {
//	return TAL_AtomicCompareAndSwap((volatile TAL_INT32*)addr, newval, refvalue);	
//}

#ifndef TAL_DOXYGEN
#if TAL_PLATFORM == TAL_PLATFORM_WINDOWS
	#if defined(TAL_32) && !defined(_MANAGED) /* The asm really pisses off the clr compiler */ 
		// (Vista32)
		...
		// (Vista32)
		TAL_INLINE TAL_UINT32 TAL_AtomicCompareAndSwap( TAL_UINT32 volatile* in_pDestination, 
									TAL_UINT32           in_exchange, 
									TAL_UINT32           in_comperand )
		{
			TAL_UINT32 result;
			__asm {
				mov         ecx,dword ptr [in_pDestination]
		...
		// (Vista32)
		TAL_INLINE TAL_UINT32 TAL_AtomicExchangeAdd( TAL_UINT32 volatile* in_pDestination, 
								TAL_UINT32           in_value )
		{
			TAL_UINT32 result;
			__asm {
							 ...
							 TAL_UINT32           in_exchange )
		{
			return _InterlockedExchange(
				(long*)in_pDestination, in_exchange);
		}
									...
									TAL_UINT32           in_comperand )
		{
			return _InterlockedCompareExchange(
				(long*)in_pDestination, in_exchange, in_comperand);
		}
	#endif // TAL_64
...
#ifndef TAL_DOXYGEN
template <class T>
TAL_INLINE T TAL_Pad(T val, T pad) 
{
	return ((val + pad - 1) / pad) * pad;
}

template <class T, class U>
TAL_INLINE  T TAL_PadPtr(T* ptr, U pad) 
{
#ifdef TAL_64

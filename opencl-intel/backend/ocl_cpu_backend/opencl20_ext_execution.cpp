...
extern "C" LLVM_BACKEND_API 
  queue_t ocl20_get_default_queue(IDeviceCommandManager*);
...
ocl20_enqueue_kernel_basic(queue_t queue, kernel_enqueue_flags_t flags,
                           ...
                           IDeviceCommandManager *, const IBlockToKernelMapper*, void *RuntimeHandle);
...
extern "C" LLVM_BACKEND_API int ocl20_enqueue_kernel_localmem(
    ...
    IDeviceCommandManager *DCM, const IBlockToKernelMapper *, void *RuntimeHandle);
...
///  int retain_event (
///     clk_event_tevent)
extern "C" LLVM_BACKEND_API void ocl20_retain_event(clk_event_t event,
                                                    IDeviceCommandManager *);

/// @brief callback for
///  int release_event (
///     clk_event_tevent)
extern "C" LLVM_BACKEND_API void ocl20_release_event(clk_event_t event,
                                                     IDeviceCommandManager *);

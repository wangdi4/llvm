...
void RegisterCPUBIFunctions(void)
{
    ...
    REGISTER_BI_FUNCTION("__set_work_dimension",__set_work_dimension)
    REGISTER_BI_FUNCTION("__set_global_work_offset",__set_global_work_offset)
    REGISTER_BI_FUNCTION("__set_global_work_size",__set_global_work_size)
    REGISTER_BI_FUNCTION("__set_local_work_size",__set_local_work_size)
    REGISTER_BI_FUNCTION("__get_work_dimension",__get_work_dimension)
    REGISTER_BI_FUNCTION("__get_global_work_offset",__get_global_work_offset)
    REGISTER_BI_FUNCTION("__get_global_work_size",__get_global_work_size)
    REGISTER_BI_FUNCTION("__get_local_work_size",__get_local_work_size)
}

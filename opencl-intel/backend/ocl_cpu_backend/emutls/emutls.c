...
// 2. Renaming the __emutls_get_address function to __opencl_emutls_get_address
// to avoid potential name conflicts with other implementations on the host
// side.
// Original file path: compiler-rt/lib/builtins/emutls.c
...
void *__opencl_emutls_get_address(__emutls_control *control) {

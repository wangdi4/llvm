...
Value* Predicator::getPhiCond(PHINode* phi, bool& switchValuesOrder) {
  ...
  bool firstToFirst = (succ0 == phi->getIncomingBlock(0)) || (m_DT->dominates(succ0, phi->getIncomingBlock(0))) ||
    (succ0 == BB && phi->getIncomingBlock(0) == idomBB);
  bool firstToSecond = (succ0 == phi->getIncomingBlock(1)) || (m_DT->dominates(succ0, phi->getIncomingBlock(1))) ||
    (succ0 == BB && phi->getIncomingBlock(1) == idomBB);
  bool secondToFirst = (succ1 == phi->getIncomingBlock(0)) || (m_DT->dominates(succ1, phi->getIncomingBlock(0))) ||
    (succ1 == BB && phi->getIncomingBlock(0) == idomBB);
  bool secondToSecond = (succ1 == phi->getIncomingBlock(1)) || (m_DT->dominates(succ1, phi->getIncomingBlock(1))) ||

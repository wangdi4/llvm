...
void PrintfAdder::addDebugPrintImpl(Function *F, debug_print_args& print_args, Instruction *loc) {  
  ...
  GlobalVariable * newGV = new GlobalVariable(*currentModule, arrayType, true, GlobalValue::InternalLinkage, strVal, "ptrstr", 0, GlobalVariable::NotThreadLocal, strAddrSpace);

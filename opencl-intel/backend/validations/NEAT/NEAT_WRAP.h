...
#define VSTORE_HALF_RT_1(__str)                                                       \
    static void vstore ##__str##_f(const NEATValue& data, size_t offset, uint16_t* p);\
    static void vstore ##__str##_d(const NEATValue& data, size_t offset, uint16_t* p);
...
#define VSTORE_HALF_RT_N(__str, n)                                                                   \
    static void vstore ## __str ## _ ## n ## _f (const NEATVector& data, size_t offset, uint16_t* p);\
    static void vstore ## __str ##_ ## n ## _d (const NEATVector& data, size_t offset, uint16_t* p);
...
#define NEAT_THREEARG_H(_fname)  \
    ...
    static NEATValue _fname ## _d ( const NEATValue& a, const NEATValue& b, const NEATValue& c );\
    static NEATVector _fname ## _f ( const NEATVector& a, const NEATVector& b, const NEATVector& c );\
    static NEATVector _fname ## _d ( const NEATVector& a, const NEATVector& b, const NEATVector& c );
    ...
    static NEATValue remquo_f ( const NEATValue& a, const NEATValue& b, int32_t *quo );
    static NEATValue remquo_d ( const NEATValue& a, const NEATValue& b, int32_t *quo );
    static NEATVector remquo_f ( const NEATVector& a, const NEATVector& b, std::vector<int32_t>& quo );
    static NEATVector remquo_d ( const NEATVector& a, const NEATVector& b, std::vector<int32_t>& quo );

    static NEATValue fcmp_f ( const NEATValue& a, const NEATValue& b, Validation::CmpType comparison );
    static NEATValue fcmp_d ( const NEATValue& a, const NEATValue& b, Validation::CmpType comparison );
    static NEATVector fcmp_f ( const NEATVector& a, const NEATVector& b, Validation::CmpType comparison );
    static NEATVector fcmp_d ( const NEATVector& a, const NEATVector& b, Validation::CmpType comparison );
    ...
    static NEATVector lgamma_r_f(const NEATVector& vec, std::vector<int32_t>& signp);
    static NEATVector lgamma_r_d(const NEATVector& vec, std::vector<int32_t>& signp);
    ...
    static NEATVector clamp_f(const NEATVector& a, const NEATValue& in_min, const NEATValue& in_max);
    static NEATVector clamp_d(const NEATVector& a, const NEATValue& in_min, const NEATValue& in_max);
    ...
    static NEATValue select_fd (const bool& cond, const NEATValue& a, const NEATValue& b);
    static NEATVector select_fd (const bool& cond, const NEATVector& a, const NEATVector& b);
    static NEATVector select_fd (const std::vector<bool>& cond, const NEATVector& a, const NEATVector& b);

    // these functions are used to support OpenCL built-in 'select'    
    static NEATValue select_f (const NEATValue& a, const NEATValue& b, const int64_t& c);
    static NEATValue select_d (const NEATValue& a, const NEATValue& b, const int64_t& c);
    static NEATVector select_f(const NEATVector& a, const NEATVector& b, const std::vector<int64_t>& c);
    static NEATVector select_d(const NEATVector& a, const NEATVector& b, const std::vector<int64_t>& c);
    ...
    NEAT_THREEARG_H(mix)
    static NEATVector mix_f(const NEATVector& x, const NEATVector& y, const NEATValue& a);
    static NEATVector mix_d(const NEATVector& x, const NEATVector& y, const NEATValue& a);
    ...
    static NEATVector smoothstep_f(const NEATValue& edge0, const NEATValue& edge1, const NEATVector& vec);
    static NEATVector smoothstep_d(const NEATValue& edge0, const NEATValue& edge1, const NEATVector& vec);
...
#undef CONVERT_DOUBLE_N
    ...
    static NEATVector read_imagef_src_noneat_f(void *imageData, Conformance::image_descriptor *imageInfo,

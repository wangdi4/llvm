...
BufferModel::BufferModel(QObject *parent)
    : QAbstractTableModel(parent), m_pBuf(NULL) {}
...
void BufferModel::setViewForTable(int i) { this->m_tableMode = i; }

void BufferModel::setViewForValue(int i) { this->m_valueMode = i; }

 ...
 * @TODO - add functionality for save|load run aptions (set of arguments for
 * SATest.exe)
 */
class AppSettings {
public:
  ...
  /**
   * @brief saveEnvVars - save specific enviroment variables created by user
   * created in EditVariableDialog
   * @param vars
   */
  ...
  /**
   * @brief setWorkDir - set working directory for SATest.exe selected by user
   * in EditPathDialog
   * @param path
   */
  ...
  /**
   * @brief setSATestPath - set path to SATest.exe selected by user in
   * EditPathDialog
   * @param path
   */

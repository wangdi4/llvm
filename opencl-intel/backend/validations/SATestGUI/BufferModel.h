 ...
 * @detailed need for deduplicate data in memory - table in BufferTab get data
 * from Buffer object directly
 */
...
public:
  ...
  /**
   * @brief setViewForTable - set variant of representation for table (dec, hex,
   * float hex)
   */
  void setViewForTable(int);
  /**
   * @brief setViewForValue - set variant of representation for value-line (dec,
   * hex, float hex)
   */

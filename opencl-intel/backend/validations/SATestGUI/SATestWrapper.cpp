...
SATestWrapper::SATestWrapper() {
  ...
  connect(satest, SIGNAL(finished(int, QProcess::ExitStatus)), this,
          SIGNAL(finished(int, QProcess::ExitStatus)));
}

SATestWrapper::~SATestWrapper() { delete (satest); }
...
QString SATestWrapper::stdErr() { return stdErrText; }

void SATestWrapper::setConfig(ConfigManager *cfg) { this->config = cfg; }

void SATestWrapper::setLogger(QTextEdit *edit) { this->log = edit; }

QString SATestWrapper::stdOut() { return stdOutText; }

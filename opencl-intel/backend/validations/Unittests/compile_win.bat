...
"@ICC_CPU_CL_NATIVE@" /nologo /c /I ../../plugin_manager /I ../../llvm/utils/unittest/googletest/include /I ../Common /I ../DataManager /I ../Comparator /I ../NEAT /I ../REFALU /I ../DataGenerator /I ../OCLBuiltins /I ../OpenCLKernelArgumentsParser /I ../../external/tinyxml /I ../PlugInNEAT /I ../ImathLibd /I ../../../cl_api /I ../../llvm/include /DWIN32 /D_WINDOWS /D_UNICODE /DUNICODE /EHsc /GS /fp:source /fp:strict /Qlong-double /Qpc80 /Qprec-div /W3 /Zi @BUILD_TYPE_ICC_COMPILER_FLAGS_Release@ /Fo%3 %2 >nul
goto fin

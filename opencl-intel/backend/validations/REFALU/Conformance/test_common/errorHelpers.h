...
// If USE_ATF is defined, all log_error and log_info calls can be routed to test
// library functions as described below. This is helpful for integration into an
...
#define log_perf(_number, _higherBetter, _numType, _format, ...)               \
  ATFLogPerformanceNumber(_number, _higherBetter, _numType, _format,           \
                          ##__VA_ARGS__)

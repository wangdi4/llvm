...
//     #define vlog_perf( _number, _higherIsBetter, _units, _nameFmt, ... )
//     ATFLogPerformanceNumber(_number, _higherIsBetter, _units, _nameFmt,
//     __VA_ARGS__ )
//
// #else
//
...
//     printf( "\t%8.2f", _number )
//
//     void _logPerf(double number, int higherIsBetter, const char *units, const
//     char *nameFormat, ...);
// #endif
...
#endif
    void
    memset_pattern4(void *dest, const void *src_pattern, size_t bytes);

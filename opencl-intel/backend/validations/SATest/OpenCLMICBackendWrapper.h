...
File Name:  OpenCLMICBackendWrapper.h

\*****************************************************************************/
#ifndef OPENCL_MIC_BACKEND_WRAPPER_H
#define OPENCL_MIC_BACKEND_WRAPPER_H
...
namespace Validation
{
  ...
  //  
  class OpenCLMICBackendWrapper
  {
  public:
    static void Init();
    static OpenCLMICBackendWrapper& GetInstance();
  ...
  private:
      ...
      static OpenCLMICBackendWrapper* s_instance;
  };
}

#endif // OPENCL_MIC_BACKEND_WRAPPER_H

; RUN: llc < %s -mcpu=corei7 -march=x86 -mattr=-sse -mtriple=i686-apple-darwin8.8.0 | grep mov | count 9
; RUN: llc < %s -mcpu=corei7 -march=x86 -mattr=+sse -mtriple=i686-apple-darwin8.8.0 | grep mov | count 3

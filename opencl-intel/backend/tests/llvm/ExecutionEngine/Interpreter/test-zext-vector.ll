...
define i32 @main()
{
    ...
    %tmp1 = zext <2 x i8> <i8 8, i8 -7> to <2 x i32>
...
; CHECK:  8 249
    ...
    %tmp2 = zext <3 x i32> <i32 18, i32 -170, i32 197> to <3 x i64>
...
; CHECK:  18 4294967126 197

    %tmp3 = zext <4 x i16> <i16 185, i16 -2710, i16 9718, i16 -412> to <4 x i64>

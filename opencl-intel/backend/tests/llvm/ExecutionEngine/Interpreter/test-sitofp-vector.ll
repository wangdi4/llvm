...
define i32 @main()
{
    ...
    %tmp1 = sitofp <2 x i32> <i32 8860, i32 -7001> to <2 x float>
...
; CHECK: 8860.000000 -7001.000000

    %tmp2 = sitofp <8 x i8> <i8 1, i8 -1, i8 120, i8 -120, i8 4, i8 -4, i8 19, i8 -19 > to <8 x double>
...
; CHECK: 1.000000 -1.000000 120.000000 -120.000000 4.000000 -4.000000 19.000000 -19.000000

    %tmp3 = sitofp <4 x i16> <i16 1000, i16 -1000, i16 127, i16 -127> to <4 x float>
...
; CHECK: 1000.000000 -1000.000000 127.000000 -127.000000

    %tmp4 = sitofp <3 x i64> <i64 1000001, i64 -1, i64 -1000001> to <3 x double>
...
; CHECK: 1000001.000000 -1.000000 -1000001.000000

...
define i32 @lshr_2()
{
       ...
       %res_i8 = lshr <2 x i8> < i8 -2, i8 5 >, < i8 2, i8 3 >
...
; CHECK: 63 0
       ...
       %res_i16 = lshr <2 x i16> < i16 -22, i16 33 >, < i16 2, i16 2 >
...
; CHECK: 16378 8
       ...
       %res_i32 = lshr <2 x i32> < i32 -444, i32 555 >, < i32 1, i32 3 >
...
; CHECK: 2147483426 69
       ...
       %res_i64 = lshr <2 x i64> < i64 -5655, i64 3467779 >, < i64 3, i64 5 >
...
define i32 @lshr_8_i8()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

       %res_i8 = lshr <8 x i8> < i8 126, i8 28, i8 34, i8 47, i8 56, i8 67, i8 78, i8 89>, < i8 1, i8 2, i8 3, i8 4, i8 5, i8 6, i8 7, i8 1>
...
define i32 @lshr_8_i16()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

       %res_i16 = lshr <8 x i16> < i16 1100, i16 -2257, i16 3378, i16 -44, i16 55, i16 -66, i16 9777, i16 8088>, < i16 1, i16 2, i16 3, i16 4, i16 5, i16 6, i16 7, i16 1>
...
; CHECK: 550 15819 422 4093 1 1022 76 4044

       ret i32 0
}

define i32 @lshr_8_i32()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

...
@r_int_4 = internal constant [22 x i8] c" %lld %lld %lld %lld\0A\00"
...
define i32 @main()
{
    ...
    %tmp1 = fptosi <2 x float> <float 8.0, float -7.0> to <2 x i32>
...
; CHECK: 8 -7
    ...
    %tmp2 = fptosi <3 x double> <double 18.0, double -17.0, double 0.197> to <3 x i16>
    %r2_1 = extractelement <3 x i16> %tmp2, i32 0
    %r2_2 = extractelement <3 x i16> %tmp2, i32 1
    %r2_3 = extractelement <3 x i16> %tmp2, i32 2
    %r3_1 = sext i16 %r2_1 to i32
    %r3_2 = sext i16 %r2_2 to i32
    %r3_3 = sext i16 %r2_3 to i32

    call i32 (i8*, ...)* @printf(i8* %ptr_1, i32 %r3_1)
    call i32 (i8*, ...)* @printf(i8* %ptr_2, i32 %r3_2, i32 %r3_3)
; CHECK: 18 -17 0

    %tmp3 = fptosi <8 x float> <float -0.75, float 202.0, float 33.5, float 1.55e+07, float -55.0, float 68.75, float -33.5, float 81.25> to <8 x i8>
    ...
    %r5_1 = sext i8 %r4_1 to i32
    %r5_2 = sext i8 %r4_2 to i32
    %r5_3 = sext i8 %r4_3 to i32
    %r5_4 = sext i8 %r4_4 to i32
    %r5_5 = sext i8 %r4_5 to i32
    %r5_6 = sext i8 %r4_6 to i32
    %r5_7 = sext i8 %r4_7 to i32
    %r5_8 = sext i8 %r4_8 to i32

    call i32 (i8*, ...)* @printf(i8* %ptr_8, i32 %r5_1, i32 %r5_2, i32 %r5_3, i32 %r5_4, i32 %r5_5, i32 %r5_6, i32 %r5_7, i32 %r5_8)
; CHECK: 0 -54 33 -32 -55 68 -33 81

    %tmp4 = fptosi <4 x double> <double 1.8e+5, double -2.7e+10, double 3.97e+18, double -4.1e+2> to <4 x i64>
...
; CHECK: 180000 -27000000000 3970000000000000000 -410

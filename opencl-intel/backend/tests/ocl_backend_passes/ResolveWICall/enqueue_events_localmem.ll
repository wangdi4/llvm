...
%call5 = call i32 (%opencl.queue_t*, i32, %opencl.ndrange_t*, i32, %opencl.clk_event_t**, %opencl.clk_event_t**, void (i8 addrspace(3)*, ...)*, i32, ...)* @_Z14enqueue_kernel9ocl_queuei11ocl_ndrangejPK13ocl_clk_eventP13ocl_clk_eventU13block_pointerFvPU3AS3vzEjz(%opencl.queue_t* %q, i32 0, %opencl.ndrange_t* %nd, i32 1, %opencl.clk_event_t** %evt0, %opencl.clk_event_t** %evt_ret, void (i8 addrspace(3)*, ...)* %b, i32 64, i32 1024, i32 128)
    ret void
}

; CHECK: declare i32 @ocl20_enqueue_kernel_events_localmem
declare i32 @_Z14enqueue_kernel9ocl_queuei11ocl_ndrangejPK13ocl_clk_eventP13ocl_clk_eventU13block_pointerFvPU3AS3vzEjz(%opencl.queue_t*, i32, %opencl.ndrange_t*, i32, %opencl.clk_event_t**, %opencl.clk_event_t**, void (i8 addrspace(3)*, ...)*, i32, ...)

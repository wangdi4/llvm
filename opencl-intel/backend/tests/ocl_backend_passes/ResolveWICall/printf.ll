...
; CHECK: %translated_opencl_printf_call = call i32 @opencl_printf(i8 addrspace(2)* addrspacecast (i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0) to i8 addrspace(2)*), i8* [[GEP1]], {}* %RuntimeInterface, {}* %RuntimeHandle)
; CHECK: ret void
  %call1 = tail call i32 (i8 addrspace(2)*, ...)* @printf(i8 addrspace(2)* addrspacecast (i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0) to i8 addrspace(2)*), i32 %iNumElements) #0
  ret void
}

...
entry:
  ...
  store i32 %iters, i32* %iters.addr, align 4, !tbaa !9
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %2 = load i32, i32* %iters.addr, align 4, !tbaa !9
...
for.body:                                         ; preds = %for.cond
  %4 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch1, align 4, !tbaa !13
  store i32 42, i32* %write.src
  %5 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)* addrspace(1)* @pipe.ch1
...
entry:
  %write.src = alloca i32
  call void @write_to_channel_in_loop(i32 64)
  %0 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch2, align 4, !tbaa !13
  store i32 42, i32* %write.src
  %1 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)* addrspace(1)* @pipe.ch2
...
define void @foo(i32 addrspace(1)* %iters) #2 !kernel_arg_addr_space !14 !kernel_arg_access_qual !15 !kernel_arg_type !16 !kernel_arg_base_type !16 !kernel_arg_type_qual !17 {
entry:
...
for.cond:                                         ; preds = %for.inc, %entry
  %1 = load i32, i32* %i, align 4, !tbaa !9
  %2 = load i32 addrspace(1)*, i32 addrspace(1)** %iters.addr, align 8, !tbaa !18
  %3 = load i32, i32 addrspace(1)* %2, align 4, !tbaa !9

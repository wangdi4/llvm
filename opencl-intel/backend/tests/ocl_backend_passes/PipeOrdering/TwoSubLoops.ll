...
for.body12:                                       ; preds = %for.cond6
  %22 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch, align 4, !tbaa !18
  store i32 42, i32* %write.src
  %23 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)* addrspace(1)* @pipe.ch
  %24 = bitcast %opencl.pipe_t addrspace(1)* %23 to %struct.__pipe_t addrspace(1)*
  %25 = addrspacecast i32* %write.src to i8 addrspace(4)*
  %26 = call i32 @__write_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %24, i8 addrspace(4)* %25)
  br label %for.inc13

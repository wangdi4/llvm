...
; CHECK-NOT: @_Z20get_global_linear_idv
; CHECK: @_Z13get_global_idj(i32 0)
; CHECK: @_Z13get_global_idj(i32 1)
; CHECK: @_Z13get_global_idj(i32 2)
; CHECK: @_Z15get_global_sizej(i32 0)
; CHECK: @_Z15get_global_sizej(i32 1)
; CHECK: ret

define spir_kernel void @check_get_global_linear_id(float addrspace(1)* %arr1, float addrspace(1)* %arr2) nounwind {
entry:
  ...
  %call = call spir_func i64 @_Z20get_global_linear_idv()
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*)* @check_get_global_linear_id, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5}

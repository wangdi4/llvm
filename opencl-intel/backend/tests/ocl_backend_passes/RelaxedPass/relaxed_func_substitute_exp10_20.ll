...
; CHECK:        entry:
; CHECK-NEXT:   %call01 = call float @_Z15native_rm_exp10f(float %f1)
; CHECK-NEXT:   %call02 = call <2 x float> @_Z15native_rm_exp10Dv2_f(<2 x float> %f2)
; CHECK-NEXT:   %call03 = call <3 x float> @_Z15native_rm_exp10Dv3_f(<3 x float> %f3)
; CHECK-NEXT:   %call04 = call <4 x float> @_Z15native_rm_exp10Dv4_f(<4 x float> %f4)
; CHECK-NEXT:   %call05 = call <8 x float> @_Z15native_rm_exp10Dv8_f(<8 x float> %f8)
; CHECK-NEXT:   %call06 = call <16 x float> @_Z15native_rm_exp10Dv16_f(<16 x float> %f16)
; CHECK-NEXT:   ret void

; CHECK:        declare float @_Z15native_rm_exp10f(float)
; CHECK:        declare <2 x float> @_Z15native_rm_exp10Dv2_f(<2 x float>)
; CHECK:        declare <3 x float> @_Z15native_rm_exp10Dv3_f(<3 x float>)
; CHECK:        declare <4 x float> @_Z15native_rm_exp10Dv4_f(<4 x float>)
; CHECK:        declare <8 x float> @_Z15native_rm_exp10Dv8_f(<8 x float>)
; CHECK:        declare <16 x float> @_Z15native_rm_exp10Dv16_f(<16 x float>)

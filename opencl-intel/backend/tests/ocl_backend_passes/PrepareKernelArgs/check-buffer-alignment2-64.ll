...
; CHECK64-NEXT: [[ARG1_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8* %pUniformArgs, i32 4
...
; CHECK64-NEXT: [[ARG2_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8* %pUniformArgs, i32 8
...
; CHECK64-NEXT: [[ARG3_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8* %pUniformArgs, i32 16
...
; CHECK64-NEXT: [[ARG4_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8* %pUniformArgs, i32 32
; CHECK64-NEXT: [[ARG4:%[a-zA-Z0-9]+]] = load i8* [[ARG4_BUFF_INDEX]], align 1

;; int* arg6 - alignment: 8 - in pUniformArgs 32+1=33 is aligned to 40
; CHECK64-NEXT: [[ARG5_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8* %pUniformArgs, i32 40

...
; CHECK-NEXT: call void @__t1_separated_args(i8 %explicit_0, i8 addrspace(3)* %pLocalMemBase, { i32, [3 x i32], [3 x i32], [3 x i32], [3 x i32], i32, {}*, [4 x i32]* }* %pWorkDim, i32* %pWGId, [4 x i32] %BaseGlbId, i8* %pSpecialBuf, i32* %pCurrWI, {}* %RuntimeContext)
; CHECK-NEXT: ret void

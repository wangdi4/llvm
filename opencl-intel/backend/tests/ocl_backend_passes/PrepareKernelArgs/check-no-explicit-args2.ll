...
;; call original func
; CHECK: call void @__t1_separated_args(i8 [[ARG0]], i8 addrspace(3)* [[IMPLCT_ARG0_TYPECAST]], { i32, [3 x i32], [3 x i32], [3 x i32], [3 x i32] }* [[IMPLCT_ARG1]], i32* [[IMPLCT_ARG2]], <{ [4 x i32] }>* [[IMPLCT_ARG3]], i32* [[IMPLCT_ARG4]], <{ [4 x i32] }>* [[IMPLCT_ARG5]], i32 [[IMPLCT_ARG6]], i8* [[IMPLCT_ARG7_BARRIER_BUFF]], i32* [[IMPLCT_ARG8_CURR_WORKITEM]], i8* [[IMPLCT_ARG9]])
; CHECK-NEXT: ret void

...
; CHECK: @t1
define void @t1(i8 %arg1, <2 x i8> %arg2, <2 x i8> %arg3, <3 x i8> %arg4, <16 x i8> %arg5, <4 x i8> %arg6, <8 x i8> %arg7 ) nounwind  !kernel_arg_addr_space !1 !kernel_arg_access_qual !2 !kernel_arg_type !3 !kernel_arg_type_qual !4 !kernel_arg_name !5 {
entry:
  ret void
}
...
; CHECK-NEXT: [[ARG2_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %pUniformArgs, i32 4
...
; CHECK-NEXT: [[ARG3_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %pUniformArgs, i32 8
...
; CHECK-NEXT: [[ARG4_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %pUniformArgs, i32 16
...
; CHECK-NEXT: [[ARG5_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %pUniformArgs, i32 32
...
; CHECK-NEXT: [[ARG6_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %pUniformArgs, i32 40
...
!3 = !{!"char", !"char2", !"char2", !"char3", !"char16", !"char4", !"char8"}
!4 = !{!"", !"", !"", !"", !"", !"", !""}

...
; CHECK: @t1
define void @t1(i16 %arg1) nounwind {
entry:
  ret void
}

;; new func
;;short arg1 - expected alignment: 2
...
;;implicit args
;; call original func
; CHECK: call void @__t1_separated_args(i16 %explicit_0, [[IMPLICIT_ARGS:[a-zA-Z0-9]+]]
; CHECK-NEXT: ret void
...
!0 = metadata !{void (i16)* @t1, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5}
!1 = metadata !{metadata !"kernel_arg_addr_space",i32 0}
!2 = metadata !{metadata !"kernel_arg_access_qual", metadata !"none"}
!3 = metadata !{metadata !"kernel_arg_type", metadata !"short"}

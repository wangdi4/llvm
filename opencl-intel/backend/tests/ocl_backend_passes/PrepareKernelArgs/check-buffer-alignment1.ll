...
; CHECK: @t1
define void @t1(i8 %arg1, <2 x i8> %arg2, double %arg3, <8 x float> %arg4, <16 x i64> %arg5 ) nounwind {
entry:
  ret void
}
...
;; double arg3 - alignment: 8 - in pBuffer 2+2=4 is aligned to 8
...
; CHECK-NEXT: [[ARG2:%[a-zA-Z0-9]+]] = load double* [[ARG2_TYPECAST]], align 8

;; float8 arg4 - alignment: 32 - in pBuffer 8+8=16 is aligned to 32
; CHECK-NEXT: [[ARG3_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8* %pBuffer, i32 32
; CHECK-NEXT: [[ARG3_TYPECAST:%[a-zA-Z0-9]+]] = bitcast i8* [[ARG3_BUFF_INDEX]] to <8 x float>*
; CHECK-NEXT: [[ARG3:%[a-zA-Z0-9]+]] = load <8 x float>* [[ARG3_TYPECAST]], align 32

;; long16 arg5 - alignment: 128 - in pBuffer 32+32=64 is aligned to 128
...
;;implicit args
;; call original func
; CHECK: call void @__t1_separated_args(i8 [[ARG0]], <2 x i8> [[ARG1]], double [[ARG2]], <8 x float> [[ARG3]], <16 x i64> [[ARG4]], [[IMPLICIT_ARGS:[a-zA-Z0-9]+]]
; CHECK-NEXT: ret void
...
!0 = metadata !{void (i8, <2 x i8>, double, <8 x float>, <16 x i64>)* @t1, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5}
!1 = metadata !{metadata !"kernel_arg_addr_space", i32 0, i32 0, i32 0, i32 0, i32 0}
!2 = metadata !{metadata !"kernel_arg_access_qual", metadata !"none", metadata !"none", metadata !"none", metadata !"none", metadata !"none"}
!3 = metadata !{metadata !"kernel_arg_type", metadata !"char", metadata !"char2", metadata !"double", metadata !"float8", metadata !"long16"}
!4 = metadata !{metadata !"kernel_arg_type_qual", metadata !"", metadata !"", metadata !"", metadata !"", metadata !""}
!5 = metadata !{metadata !"kernel_arg_name", metadata !"arg1", metadata !"arg2", metadata !"arg3", metadata !"arg4", metadata !"arg5"}

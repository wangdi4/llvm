...
; CHECK: define void @__A_separated_args(i32 addrspace(1)* nocapture %out, i32 %b, i32 addrspace(1)* nocapture %a, i8 addrspace(3)* %pLocalMemBase, { i64, [3 x i64], [3 x i64], [3 x i64], [3 x i64], i64, {}*, [4 x i64]* }* %pWorkDim, i64* %pWGId, [4 x i64] %BaseGlbIds, i8* %pSpecialBuf, i64* %pCurrWI, {}* %RuntimeContext)  {
...
!0 = metadata !{void (i32 addrspace(1)*, i32, i32 addrspace(1)*, i8 addrspace(3)*, { i64, [3 x i64], [3 x i64], [3 x i64], [3 x i64], i64, {}*, [4 x i64]* }*, i64*, [4 x i64], i8*, i64*, {}*)* @A, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5}
...
!12 = metadata !{}
!13 = metadata !{void (i32 addrspace(1)*, i32, i32 addrspace(1)*, i8 addrspace(3)*, { i64, [3 x i64], [3 x i64], [3 x i64], [3 x i64], i64, {}*, [4 x i64]* }*, i64*, [4 x i64], i8*, i64*, {}*)* @A, metadata !14}

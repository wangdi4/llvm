...
; CHECK: @t1
define void @t1(float %arg1) nounwind {
entry:
  ret void
}
...
;;implicit args
;; call original func
; CHECK: call void @__t1_separated_args(float [[ARG0]], [[IMPLICIT_ARGS:[a-zA-Z0-9]+]]
; CHECK-NEXT: ret void
...
!0 = metadata !{void (float)* @t1, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5}

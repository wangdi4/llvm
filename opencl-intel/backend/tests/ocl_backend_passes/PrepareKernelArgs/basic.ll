...
; CHECK:     %3 = addrspacecast i8* %2 to i32 addrspace(1)**
...
!0 = metadata !{void (i32 addrspace(1)*, i32 addrspace(1)*, i32)* @A, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5}
...
!12 = metadata !{}
!13 = metadata !{void (i32 addrspace(1)*, i32 addrspace(1)*, i32)* @A, metadata !14}

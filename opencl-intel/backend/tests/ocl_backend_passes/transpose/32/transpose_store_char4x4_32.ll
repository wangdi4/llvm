...
entry:
   call void @__ocl_transpose_store_char4x4(<4 x i8>* %pStoreAdd, <4 x i8> %xIn, <4 x i8> %yIn, <4 x i8> %zIn, <4 x i8> %wIn) nounwind
...
declare void @__ocl_transpose_store_char4x4(<4 x i8>* %pStoreAdd, <4 x i8> %xIn, <4 x i8> %yIn, <4 x i8> %zIn, <4 x i8> %wIn) nounwind
...
;CHECK:	.type	    [[TRANSPOSE:[_a-z]+]]_store_char4x4,@function

...
; CHECK-AVX:     vpunpcklwd	%x[[MM1]], %x[[MM2]], %x[[MM1]]
; CHECK-AVX:     vpunpckhwd	%x[[MM0]], %x[[MM1]], %x[[MM5:mm[0-7]{1}]]
; CHECK-AVX:     vpunpckhwd	%x[[MM4]], %x[[MM3]], %x[[MM2]]
; CHECK-AVX:     vpunpcklwd	%x[[MM4]], %x[[MM3]], %x[[MM3]]
; CHECK-AVX:     vpunpckhwd	%x[[MM2]], %x[[MM3]], %x[[MM4]]
; CHECK-AVX:     vinsertf128	$1, %x[[MM5]], %y[[MM4]], %y[[MM4]]
; CHECK-AVX:     vextractf128	$1, %y[[MM4]], %x[[MM5]]
; CHECK-AVX:     vunpckhps	%x[[MM5]], %x[[MM4]], %x[[MM6:mm[0-7]{1}]]
; CHECK-AVX:     vunpcklps	%x[[MM5]], %x[[MM4]], %x[[MM4]]
; CHECK-AVX:     vinsertf128	$1, %x[[MM6]], %y[[MM4]], %y[[MM4]]
; CHECK-AVX:     vextractf128	$1, %y[[MM4]], %x[[MM5]]
; CHECK-AVX:     vpaddw	%x[[MM5]], %x[[MM4]], %x[[MM4]]
; CHECK-AVX:     vpunpcklwd	%x[[MM0]], %x[[MM1]], %x[[MM0]]
; CHECK-AVX:     vpunpcklwd	%x[[MM2]], %x[[MM3]], %x[[MM1]]
; CHECK-AVX:     vinsertf128	$1, %x[[MM0]], %y[[MM1]], %y[[MM0]]
; CHECK-AVX:     vextractf128	$1, %y[[MM0]], %x[[MM1]]
; CHECK-AVX:     vunpckhps	%x[[MM1]], %x[[MM0]], %x[[MM2]]
; CHECK-AVX:     vunpcklps	%x[[MM1]], %x[[MM0]], %x[[MM0]]
; CHECK-AVX:     vinsertf128	$1, %x[[MM2]], %y[[MM0]], %y[[MM0]]
; CHECK-AVX:     vextractf128	$1, %y[[MM0]], %x[[MM1]]

; XFAIL: x86_64
; RUN: oclopt -runtimelib=clbltfng9.rtl,clbltfnshared.rtl  -builtin-import -builtin-call-to-inst  -instcombine -inline -scalarrepl -S %s -o %t1.ll
; RUN: llc < %t1.ll -mattr=+avx -mtriple=i686-pc-Win32 | FileCheck %s -check-prefix=CHECK
; RUN: oclopt -runtimelib=clbltfns9.rtl,clbltfnshared.rtl  -builtin-import -builtin-call-to-inst  -instcombine -inline -scalarrepl -S %s -o %t2.ll

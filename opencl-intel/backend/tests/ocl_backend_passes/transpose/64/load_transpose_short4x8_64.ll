...
; CHECK-AVX:     vextractf128	$1, %y[[MM3:mm[0-7]{1}]], %x[[MM1:mm[0-7]{1}]]
; CHECK-AVX:     vextractf128	$1, %y[[MM2:mm[0-7]{1}]], %x[[MM4:mm[0-7]{1}]]
; CHECK-AVX:     vpunpckhwd	%x[[MM1]], %x[[MM4]], %x[[MM0:mm[0-7]{1}]]
; CHECK-AVX:     vpunpcklwd	%x[[MM1]], %x[[MM4]], %x[[MM1]]
; CHECK-AVX:     vpunpckhwd	%x[[MM0]], %x[[MM1]], %x[[MM6:mm[0-7]{1}]]
; CHECK-AVX:     vpunpckhwd	%x[[MM3]], %x[[MM2]], %x[[MM4]]
; CHECK-AVX:     vpunpcklwd	%x[[MM3]], %x[[MM2]], %x[[MM5:mm[0-7]{1}]]
; CHECK-AVX:     vpunpckhwd	%x[[MM4]], %x[[MM5]], %x[[MM2]]
; CHECK-AVX:     vinsertf128	$1, %x[[MM6]], %y[[MM2]], %y[[MM2]]
; CHECK-AVX:     vextractf128	$1, %y[[MM2]], %x[[MM3]]
; CHECK-AVX:     vpunpcklwd	%x[[MM0]], %x[[MM1]], %x[[MM0]]
; CHECK-AVX:     vpunpcklwd	%x[[MM4]], %x[[MM5]], %x[[MM1]]
; CHECK-AVX:     vinsertf128	$1, %x[[MM0]], %y[[MM1]], %y[[MM0]]
; CHECK-AVX:     vextractf128	$1, %y[[MM0]], %x[[MM1]]
; CHECK-AVX:     vunpckhps	%x[[MM3]], %x[[MM2]], %x[[MM4]]
; CHECK-AVX:     vunpcklps	%x[[MM3]], %x[[MM2]], %x[[MM2]]
; CHECK-AVX:     vinsertf128	$1, %x[[MM4]], %y[[MM2]], %y[[MM2]]
; CHECK-AVX:     vextractf128	$1, %y[[MM2]], %x[[MM3]]
; CHECK-AVX:     vpaddw	%x[[MM3]], %x[[MM2]], %x[[MM2]]
; CHECK-AVX:     vunpckhps	%x[[MM1]], %x[[MM0]], %x[[MM3]]
; CHECK-AVX:     vunpcklps	%x[[MM1]], %x[[MM0]], %x[[MM0]]
; CHECK-AVX:     vinsertf128	$1, %x[[MM3]], %y[[MM0]], %y[[MM0]]
; CHECK-AVX:     vextractf128	$1, %y[[MM0]], %x[[MM1]]
; CHECK-AVX:     vpaddw	%x[[MM1]], %x[[MM0]], %x[[MM0]]
; CHECK-AVX:     vpaddw	%x[[MM2]], %x[[MM0]], %x[[MM0]]
; CHECK-AVX:     .size	[[FOO]]

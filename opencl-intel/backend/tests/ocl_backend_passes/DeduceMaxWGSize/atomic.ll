...
!0 = metadata !{void (i32 addrspace(1)*, i32)* @A, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5, metadata !6}
...
!9 = metadata !{}
!10 = metadata !{void (i32 addrspace(1)*, i32)* @A, metadata !11}
...
!18 = metadata !{metadata !"vectorized_kernel", void (i32 addrspace(1)*, i32)* @__Vectorized_.A}
...
!22 = metadata !{void (i32 addrspace(1)*, i32)* @__Vectorized_.A, metadata !23}
...
!28 = metadata !{metadata !"scalarized_kernel", void (i32 addrspace(1)*, i32)* @A}

...
!0 = !{void (i32 addrspace(1)*, i32 addrspace(1)*)* @D}
!1 = !{i32 1, i32 1}
!2 = !{!"none", !"none"}
!3 = !{!"int*", !"int*"}
!4 = !{!"", !""}
...
!16 = !{i1 false}
!17 = !{i1 true}
!18 = !{void (i32 addrspace(1)*, i32 addrspace(1)*)* @__Vectorized_.D}
!19 = !{i32 1}
!24 = !{i32 14}
!27 = !{i32 8}
!28 = !{void (i32 addrspace(1)*, i32 addrspace(1)*)* @D}

...
; CHECK: %lid0 = call spir_func i64 @_Z12get_local_idj(i32 0)
; CHECK: %lid1 = call spir_func i64 @_Z12get_local_idj(i32 1)
; CHECK: %lid2 = call spir_func i64 @_Z12get_local_idj(i32 2)
; CHECK: %linid = zext i32 %0 to i64
; CHECK: %lid0.res = urem i64 %linid, %lsz0
; CHECK: %lid1.op = udiv i64 %linid, %lsz0
; CHECK: %lid1.res = urem i64 %lid1.op, %lsz1
; CHECK: %lid2.op = sub i64 %lid1.op, %lid1.res
; CHECK: %lid2.res = udiv i64 %lid2.op, %lsz1
; CHECK: %CallWGBroadCast = call i32 @_Z20work_group_broadcastimmm(i32 %0, i64 %lid0.res, i64 %lid1.res, i64 %lid2.res)
; CHECK: ret i32 %0
...
entry:
  ...
  %arrayidx4 = getelementptr inbounds i32 addrspace(1)* %5, i64 %idxprom3
...
; CHECK: declare spir_func i64 @_Z12get_local_idj(i32)

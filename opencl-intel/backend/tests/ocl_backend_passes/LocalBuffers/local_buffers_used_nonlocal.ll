...
entry:
  %dummyInt = load i32 addrspace(1)* @foo.localInt, align 4
...
entry:
  %dummyLong16 = load <16 x i64> addrspace(1)* @bar.localLong16, align 128
...
; CHECK-NEXT:   entry:
; CHECK-NEXT:   %dummyInt = load i32 addrspace(1)* @foo.localInt, align 4
...
; CHECK-NEXT:   entry:
; CHECK-NEXT:   %dummyLong16 = load <16 x i64> addrspace(1)* @bar.localLong16, align 128

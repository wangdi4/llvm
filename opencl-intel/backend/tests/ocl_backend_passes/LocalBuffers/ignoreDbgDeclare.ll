...
!12 = metadata !{i32 786478, i32 0, metadata !6, metadata !"mykernel", metadata !"mykernel", metadata !"", metadata !6, i32 4, metadata !13, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, void (i8 addrspace(3)*)* @mykernel, null, null, metadata !1, i32 4} ; [ DW_TAG_subprogram ] [line 4] [def] [mykernel]
...
!21 = metadata !{void (i8 addrspace(3)*)* @mykernel, metadata !22, metadata !23, metadata !24, metadata !25, metadata !26}

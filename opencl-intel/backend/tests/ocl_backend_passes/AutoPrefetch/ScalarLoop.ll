...
scalar_kernel_entry.i:                            ; preds = %scalar_kernel_entry.i, %scalarIf.i
  ...
  %24 = getelementptr inbounds float addrspace(1)* %1, i64 %23
  %25 = load float addrspace(1)* %24, align 4
  %26 = getelementptr inbounds float addrspace(1)* %4, i64 %23
  %27 = load float addrspace(1)* %26, align 4
  %28 = fmul float %27, %10
  %29 = fadd float %25, %28
  %30 = getelementptr inbounds float addrspace(1)* %7, i64 %23

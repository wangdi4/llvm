...
; }
; ----------------------------------------------------
; RUN: opt -runtimelib=/data/asachkov/fpga_opencl/src/backend/tests/vectorizer/Full/runtime.bc -channel-pipe-transformation -verify %s -S | /data/asachkov/fpga_opencl/llvm/build/RH64/Debug/bin/FileCheck %s

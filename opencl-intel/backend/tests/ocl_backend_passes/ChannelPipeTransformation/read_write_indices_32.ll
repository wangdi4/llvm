...
entry:
  ...
  %1 = getelementptr inbounds %struct.st, %struct.st* %s, i32 0, i32 0
  store i32 100, i32* %1, align 4
  %2 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* getelementptr inbounds ([5 x %opencl.channel_t addrspace(1)*], [5 x %opencl.channel_t addrspace(1)*] addrspace(1)* @bar_arr, i32 0, i32 4), align 4, !tbaa !19
  tail call void @_Z20write_channel_altera11ocl_channelii(%opencl.channel_t addrspace(1)* %2, i32 42) #3
  %3 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* getelementptr inbounds ([5 x [4 x %opencl.channel_t addrspace(1)*]], [5 x [4 x %opencl.channel_t addrspace(1)*]] addrspace(1)* @far_arr, i32 0, i32 4, i32 3), align 4, !tbaa !19
  tail call void @_Z20write_channel_altera11ocl_channelff(%opencl.channel_t addrspace(1)* %3, float 0x40091EB860000000) #3
  %4 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* getelementptr inbounds ([5 x [4 x [3 x %opencl.channel_t addrspace(1)*]]], [5 x [4 x [3 x %opencl.channel_t addrspace(1)*]]] addrspace(1)* @star_arr, i32 0, i32 4, i32 3, i32 2), align 4, !tbaa !19
  call void @_Z20write_channel_altera11ocl_channel2stS_(%opencl.channel_t addrspace(1)* %4, %struct.st* byval nonnull align 4 %s) #3
  %5 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* getelementptr inbounds ([6 x [5 x [4 x [3 x %opencl.channel_t addrspace(1)*]]]], [6 x [5 x [4 x [3 x %opencl.channel_t addrspace(1)*]]]] addrspace(1)* @lar_arr, i32 0, i32 4, i32 3, i32 2, i32 1), align 8, !tbaa !19
  call void @_Z20write_channel_altera11ocl_channelll(%opencl.channel_t addrspace(1)* %5, i64 500) #3
  %6 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* getelementptr inbounds ([5 x %opencl.channel_t addrspace(1)*], [5 x %opencl.channel_t addrspace(1)*] addrspace(1)* @bar_arr, i32 0, i32 4), align 4, !tbaa !19
  %call = call i32 @_Z19read_channel_altera11ocl_channeli(%opencl.channel_t addrspace(1)* %6) #3
  %7 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* getelementptr inbounds ([5 x [4 x %opencl.channel_t addrspace(1)*]], [5 x [4 x %opencl.channel_t addrspace(1)*]] addrspace(1)* @far_arr, i32 0, i32 4, i32 3), align 4, !tbaa !19
  %call23 = call float @_Z19read_channel_altera11ocl_channelf(%opencl.channel_t addrspace(1)* %7) #3
  %8 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* getelementptr inbounds ([5 x [4 x [3 x %opencl.channel_t addrspace(1)*]]], [5 x [4 x [3 x %opencl.channel_t addrspace(1)*]]] addrspace(1)* @star_arr, i32 0, i32 4, i32 3, i32 2), align 4, !tbaa !19
  call void @_Z19read_channel_altera11ocl_channel2st(%struct.st* nonnull sret %tmp, %opencl.channel_t addrspace(1)* %8) #3
  %9 = getelementptr inbounds %struct.st, %struct.st* %tmp, i32 0, i32 0
  %10 = load i32, i32* %9, align 4, !tbaa !22
  store i32 %10, i32* %1, align 4, !tbaa !22
  %11 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* getelementptr inbounds ([6 x [5 x [4 x [3 x %opencl.channel_t addrspace(1)*]]]], [6 x [5 x [4 x [3 x %opencl.channel_t addrspace(1)*]]]] addrspace(1)* @lar_arr, i32 0, i32 4, i32 3, i32 2, i32 1), align 8, !tbaa !19
  %call36 = call i64 @_Z19read_channel_altera11ocl_channell(%opencl.channel_t addrspace(1)* %11) #3

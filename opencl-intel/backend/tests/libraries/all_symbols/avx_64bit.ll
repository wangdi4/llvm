; REQUIRES: 64bit
; RUN: llvm-nm %libdir/clbltfne9.rtl --defined-only --no-demangle | FileCheck %s -check-prefix=TOTAL-FUNC
; RUN: llvm-nm %libdir/clbltfne9.rtl --defined-only --no-demangle | FileCheck %s -check-prefix=TOTAL-GLOB

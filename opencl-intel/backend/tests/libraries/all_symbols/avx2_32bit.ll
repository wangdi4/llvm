; REQUIRES: 32bit
; RUN: llvm-nm %libdir/clbltfns9.rtl --defined-only --no-demangle | FileCheck %s -check-prefix=TOTAL-FUNC
; RUN: llvm-nm %libdir/clbltfns9.rtl --defined-only --no-demangle | FileCheck %s -check-prefix=TOTAL-GLOB
; RUN: llvm-nm %libdir/clbltfns9.rtl --defined-only --no-demangle | FileCheck %s

; REQUIRES: 64bit
; RUN: llvm-nm %libdir/clbltfnl9.rtl --defined-only --no-demangle | FileCheck %s -check-prefix=TOTAL-FUNC
; RUN: llvm-nm %libdir/clbltfnl9.rtl --defined-only --no-demangle | FileCheck %s -check-prefix=TOTAL-GLOB
; RUN: llvm-nm %libdir/clbltfnl9.rtl --defined-only --no-demangle | FileCheck %s

; TOTAL-FUNC-COUNT-12393: ---------------- T

; REQUIRES: 64bit
; RUN: llvm-nm %libdir/clbltfnh8.rtl --defined-only --no-demangle | FileCheck %s -check-prefix=TOTAL-FUNC
; RUN: llvm-nm %libdir/clbltfnh8.rtl --defined-only --no-demangle | FileCheck %s -check-prefix=TOTAL-GLOB

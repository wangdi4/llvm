...
; CHECK-DAG: attributes [[ATTR_1024]] = { nounwind readnone willreturn "min-legal-vector-width"="1024" }
; CHECK-DAG: attributes [[ATTR_NONE]] = { nounwind readnone willreturn }
; CHECK-DAG: attributes [[ATTR_128]] = { nounwind readnone willreturn "min-legal-vector-width"="128" }
; CHECK-DAG: attributes [[ATTR_2048]] = { nounwind readnone willreturn "min-legal-vector-width"="2048" }
; CHECK-DAG: attributes [[ATTR_192]] = { nounwind readnone willreturn "min-legal-vector-width"="192" }
; CHECK-DAG: attributes [[ATTR_256]] = { nounwind readnone willreturn "min-legal-vector-width"="256" }
; CHECK-DAG: attributes [[ATTR_4096]] = { nounwind readnone willreturn "min-legal-vector-width"="4096" }
; CHECK-DAG: attributes [[ATTR_512]] = { nounwind readnone willreturn "min-legal-vector-width"="512" }

...
void evaluateRay(__global float4* inputImage, __global float4* output, int in_RayNum, int2 imgSize, uint blend)
{
...
__kernel void main_kernel(__global float4* inputImage, __global float4* output, const int width, const int height)
{

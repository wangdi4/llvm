...
!0 = !{void (float addrspace(1)*, float addrspace(1)*, i32)* @bitcast, !1, !1, !"", !"float __attribute__((address_space(1))) *, float __attribute__((address_space(1))) *, uint const", !"opencl_bitcast_locals_anchor"}
!1 = !{i32 0, i32 0, i32 0}

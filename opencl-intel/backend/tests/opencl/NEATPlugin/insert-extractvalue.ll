...
; RUN: llvm-as %s -o insert-extractvalue.ll.bin
; RUN111: SATest -OCL -REF -config=%s.cfg -neat=1 -basedir=.
; RUN111: NEATChecker -r %s -a insert-extractvalue.ll.neat -t 0
; TODO enable when memcpy will be implemented in NEAT
; XFAIL111:

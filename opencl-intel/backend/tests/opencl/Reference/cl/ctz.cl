...
{
    size_t offset = get_global_id(0);
    int4 a4 = (int4)( a[4*offset], a[4*offset + 1],
        a[4*offset + 2], a[4*offset + 3]);
    long4 b4 = (long4)( b[4*offset], b[4*offset + 1],
        b[4*offset + 2], b[4*offset + 3]);
    int4 ctz4int = ctz(a4);
...
{
    size_t offset = get_global_id(0);
    int8 a8 = (int8)( a[8*offset], a[8*offset + 1], a[8*offset + 2], a[8*offset + 3],
        a[8*offset + 4], a[8*offset + 5], a[8*offset + 6], a[8*offset + 7]);
    long8 b8 = (long8)( b[8*offset], b[8*offset + 1], b[8*offset + 2], b[8*offset + 3],
        b[8*offset + 4], b[8*offset + 5], b[8*offset + 6], b[8*offset + 7]);
    int8 ctz8int = ctz(a8);

__kernel void sample_kernel_1D(__global int4 *input,
...
__kernel void sample_kernel_1Darr(__global int4 *input,
...
__kernel void sample_kernel_2D(__global int4 *input,
...
__kernel void sample_kernel_2Darr(__global int4 *input,

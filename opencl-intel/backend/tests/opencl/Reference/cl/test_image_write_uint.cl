__kernel void sample_kernel_1D(__global uint4 *input,
...
__kernel void sample_kernel_1Darr(__global uint4 *input,
...
__kernel void sample_kernel_2D(__global uint4 *input,
...
__kernel void sample_kernel_2Darr(__global uint4 *input,

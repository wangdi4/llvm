...
define dso_local spir_kernel void @testKernel(i32 addrspace(1)* noundef %input, i32 addrspace(1)* noundef %results) #0 !kernel_arg_addr_space !2 !kernel_arg_access_qual !3 !kernel_arg_type !4 !kernel_arg_base_type !4 !kernel_arg_type_qual !5 !kernel_arg_name !6 !kernel_arg_host_accessible !7 !kernel_arg_pipe_depth !8 !kernel_arg_pipe_io !5 !kernel_arg_buffer_location !5 {
entry:
  ...
  %1 = load i32, i32 addrspace(1)* %input, align 4, !tbaa !9
...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load i32, i32 addrspace(1)* %arrayidx8, align 4, !tbaa !9
...
if.then10:                                        ; preds = %for.body
  ...
  %3 = load i32, i32 addrspace(1)* %arrayidx12, align 4, !tbaa !9
  br label %if.end
...
if.end14:                                         ; preds = %if.end13, %if.then
  ...
  store i32 %cond, i32 addrspace(1)* %arrayidx16, align 4, !tbaa !9
  ret void
}

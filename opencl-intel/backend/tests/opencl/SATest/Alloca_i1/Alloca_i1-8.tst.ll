...
entry:
  ...
  store ptr addrspace(1) %x, ptr %x.addr, align 8, !tbaa !6
  %0 = load ptr addrspace(1), ptr %x.addr, align 8, !tbaa !6
  store i1 0, ptr addrspace(1) %0, align 1, !tbaa !10
  ret void
}

; Function Attrs: convergent nounwind
define spir_kernel void @set_false(ptr addrspace(1) %data) #0 !kernel_arg_addr_space !12 !kernel_arg_access_qual !13 !kernel_arg_type !14 !kernel_arg_base_type !14 !kernel_arg_type_qual !15 !kernel_arg_host_accessible !16 !kernel_arg_pipe_depth !17 !kernel_arg_pipe_io !15 !kernel_arg_buffer_location !15 !kernel_arg_name !18 {
entry:
  %data.addr = alloca ptr addrspace(1), align 8
  store ptr addrspace(1) %data, ptr %data.addr, align 8, !tbaa !6
  %0 = load ptr addrspace(1), ptr %data.addr, align 8, !tbaa !6

...
define void @helper(i1 addrspace(1)* %x) #0 {
entry:
  %x.addr = alloca i1 addrspace(1)*, align 8
  store i1 addrspace(1)* %x, i1 addrspace(1)** %x.addr, align 8, !tbaa !6
  %0 = load i1 addrspace(1)*, i1 addrspace(1)** %x.addr, align 8, !tbaa !6
  store i1 0, i1 addrspace(1)* %0, align 1, !tbaa !10
  ret void
}
...
entry:
  ...
  call void @helper(i1 addrspace(1)* %0) #1
  ret void
}

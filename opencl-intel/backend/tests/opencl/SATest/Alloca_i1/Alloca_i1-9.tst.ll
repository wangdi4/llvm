...
for.body:                                         ; preds = %for.cond
  %3 = load i1 addrspace(1)*, i1 addrspace(1)** %data.addr, align 8, !tbaa !13
  %4 = load i32, i32* %i, align 4, !tbaa !17
  %idx.ext = sext i32 %4 to i64
  %add.ptr = getelementptr inbounds i1, i1 addrspace(1)* %3, i64 %idx.ext
  %5 = load i1, i1 addrspace(1)* %add.ptr, align 8, !tbaa !19
  %cmp1 = icmp ne i1 %5, 0
  br i1 %cmp1, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %6 = load i1 addrspace(1)*, i1 addrspace(1)** %data.addr, align 8, !tbaa !13
  %7 = load i32, i32* %i, align 4, !tbaa !17
  %idx.ext2 = sext i32 %7 to i64
  %add.ptr3 = getelementptr inbounds i1, i1 addrspace(1)* %6, i64 %idx.ext2
  %8 = load i1, i1 addrspace(1)* %add.ptr3, align 8, !tbaa !19
  %call = call i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([3 x i8], [3 x i8] addrspace(2)* @.str, i32 0, i32 0), i1 %8) #4
  %9 = load i1 addrspace(1)*, i1 addrspace(1)** %data.addr, align 8, !tbaa !13
  %10 = load i32, i32* %i, align 4, !tbaa !17
  %idx.ext4 = sext i32 %10 to i64
  %add.ptr5 = getelementptr inbounds i1, i1 addrspace(1)* %9, i64 %idx.ext4
  store i1 0, i1 addrspace(1)* %add.ptr5, align 8, !tbaa !19
  br label %if.end

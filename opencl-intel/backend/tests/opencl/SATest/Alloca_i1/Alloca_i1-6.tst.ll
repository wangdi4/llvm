...
define spir_kernel void @set_false(i1 addrspace(1)* %data) #0 !kernel_arg_addr_space !6 !kernel_arg_access_qual !7 !kernel_arg_type !8 !kernel_arg_base_type !8 !kernel_arg_type_qual !9 !kernel_arg_host_accessible !10 !kernel_arg_pipe_depth !11 !kernel_arg_pipe_io !9 !kernel_arg_buffer_location !9 !kernel_arg_name !12 {
entry:
  %data.addr = alloca i1 addrspace(1)*, align 8
  %tmp = alloca [3 x i1], align 1
  %i = alloca i32, align 4
  store i1 addrspace(1)* %data, i1 addrspace(1)** %data.addr, align 8, !tbaa !13
  %0 = bitcast [3 x i1]* %tmp to i8*
  call void @llvm.lifetime.start.p0i8(i64 3, i8* %0) #3
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [3 x i1], [3 x i1]* %tmp, i64 0, i64 %idxprom
  store i1 0, i1* %arrayidx, align 1, !tbaa !19
  %5 = load i1 addrspace(1)*, i1 addrspace(1)** %data.addr, align 8, !tbaa !13
  %6 = load i32, i32* %i, align 4, !tbaa !17
  %idxprom1 = sext i32 %6 to i64
  %arrayidx2 = getelementptr inbounds i1, i1 addrspace(1)* %5, i64 %idxprom1
  %7 = load i1, i1 addrspace(1)* %arrayidx2, align 1, !tbaa !19
  %conv = zext i1 %7 to i32
  %cmp3 = icmp ne i32 %conv, 0
  br i1 %cmp3, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %8 = load i1 addrspace(1)*, i1 addrspace(1)** %data.addr, align 8, !tbaa !13
  %9 = load i32, i32* %i, align 4, !tbaa !17
  %idxprom5 = sext i32 %9 to i64
  %arrayidx6 = getelementptr inbounds i1, i1 addrspace(1)* %8, i64 %idxprom5
  %10 = load i1, i1 addrspace(1)* %arrayidx6, align 1, !tbaa !19
  %call = call i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([3 x i8], [3 x i8] addrspace(2)* @.str, i32 0, i32 0), i1 %10) #4
  %arrayidx9 = getelementptr inbounds [3 x i1], [3 x i1]* %tmp, i64 0, i64 0
  %11 = load i1, i1* %arrayidx9, align 1, !tbaa !19
  %12 = load i1 addrspace(1)*, i1 addrspace(1)** %data.addr, align 8, !tbaa !13
  %13 = load i32, i32* %i, align 4, !tbaa !17
  %idxprom11 = sext i32 %13 to i64
  %arrayidx12 = getelementptr inbounds i1, i1 addrspace(1)* %12, i64 %idxprom11
  store i1 %10, i1 addrspace(1)* %arrayidx12, align 1, !tbaa !19
  br label %if.end
...
for.end:                                          ; preds = %for.cond.cleanup
  %15 = bitcast [3 x i1]* %tmp to i8*
  call void @llvm.lifetime.end.p0i8(i64 3, i8* %15) #3
  ret void
}

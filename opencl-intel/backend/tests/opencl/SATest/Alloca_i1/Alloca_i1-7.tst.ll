...
entry:
  ...
  store i1 %data, ptr %data.addr, align 32, !tbaa !12
  store i1 0, ptr %data.addr, align 32, !tbaa !12
  %0 = load i1, ptr %data.addr, align 32, !tbaa !12
  %call = call i32 (ptr addrspace(2), ...) @printf(ptr addrspace(2) getelementptr inbounds ([3 x i8], ptr addrspace(2) @.str, i32 0, i32 0), i1 %0) #2
  ret void
}

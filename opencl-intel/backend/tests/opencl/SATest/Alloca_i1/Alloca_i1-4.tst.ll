...
define spir_kernel void @set_false(ptr addrspace(1) %data) #0 !kernel_arg_addr_space !6 !kernel_arg_access_qual !7 !kernel_arg_type !8 !kernel_arg_base_type !8 !kernel_arg_type_qual !9 !kernel_arg_host_accessible !10 !kernel_arg_name !11 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds i1, ptr addrspace(1) %3, i64 %idxprom
  store i1 0, ptr addrspace(1) %arrayidx, align 1, !tbaa !18
  br label %for.inc

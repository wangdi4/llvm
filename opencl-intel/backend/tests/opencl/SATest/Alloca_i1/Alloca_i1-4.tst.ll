...
for.body:                                         ; preds = %for.cond
  %3 = load i1 addrspace(1)*, i1 addrspace(1)** %data.addr, align 8, !tbaa !12
  %4 = load i32, i32* %i, align 4, !tbaa !16
  %idxprom = sext i32 %4 to i64
  %arrayidx = getelementptr inbounds i1, i1 addrspace(1)* %3, i64 %idxprom
  store i1 0, i1 addrspace(1)* %arrayidx, align 1, !tbaa !18
  br label %for.inc

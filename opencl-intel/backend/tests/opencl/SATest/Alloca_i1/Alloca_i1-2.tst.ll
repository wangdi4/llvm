...
entry:
  ...
  store i1 %x, ptr %x.addr, align 1, !tbaa !5
  store i1 0, ptr %x.addr, align 1, !tbaa !5
  ret void
}
...
entry:
  ...
  store i1 %data, ptr %data.addr, align 1, !tbaa !5
  %0 = load i1, ptr %data.addr, align 1, !tbaa !5

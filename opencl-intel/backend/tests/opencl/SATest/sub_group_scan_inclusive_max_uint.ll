...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx5 = getelementptr inbounds i32, i32 addrspace(1)* %input, i64 %idxprom4
  %2 = load i32, i32 addrspace(1)* %arrayidx5, align 4, !tbaa !10
...
if.then:                                          ; preds = %for.body
  ...
  %3 = load i32, i32 addrspace(1)* %arrayidx8, align 4, !tbaa !10
  br label %if.end
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  store i32 %cond, i32 addrspace(1)* %arrayidx10, align 4, !tbaa !10
  ret void
}

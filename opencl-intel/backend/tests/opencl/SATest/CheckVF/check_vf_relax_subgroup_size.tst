...
; LOG: Error in kernel <test> _Z13sub_group_alli with vectorization factor 128 is unimplemented!
; LOG: Error in kernel <test> _Z14work_group_alli with vectorization factor 128 is unimplemented!
; LOG: CompilerException Checking vectorization factor failed
; LOG-NOT: Error in kernel <test_1>
; LOG_2-NOT: Error in kernel <test_2>
; LOG_2-NOT: Error in kernel <test_3>
; LOG_2-NOT: Error in kernel <test_4>
; LOG_2-NOT: Error in kernel <test_5>

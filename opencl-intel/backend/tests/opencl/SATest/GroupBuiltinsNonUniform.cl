// Check results for non-uniform work_group add/min/max builtin
...
GroupBuiltinAdd(__global int *wg_reduce_add_i, __global float *wg_reduce_add_f,
                __global double *wg_reduce_add_d,
                __global uint *wg_reduce_add_ui, __global long *wg_reduce_add_l,
...
__attribute__((intel_reqd_sub_group_size(SUB_GROUP_SIZE))) __kernel void
GroupBuiltinMax(__global int *wg_reduce_min_i, __global float *wg_reduce_min_f,
                __global double *wg_reduce_min_d,
                __global uint *wg_reduce_min_ui, __global long *wg_reduce_min_l,
...
GroupBuiltinMin(__global int *wg_reduce_max_i, __global float *wg_reduce_max_f,
                __global double *wg_reduce_max_d,
                __global uint *wg_reduce_max_ui, __global long *wg_reduce_max_l,

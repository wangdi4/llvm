...
entry:
  ...
  store ptr addrspace(1) %input, ptr %input.addr, align 4
  store ptr addrspace(1) %output, ptr %output.addr, align 4
  ...
  %tmp1 = load ptr addrspace(1), ptr %input.addr, align 4
  %arrayidx = getelementptr inbounds float, ptr addrspace(1) %tmp1, i32 %tmp
  %tmp2 = load float, ptr addrspace(1) %arrayidx
  %add = fadd float %tmp2, 1.000000e+000
  %tmp3 = load i32, ptr %tid, align 4
  %tmp4 = load ptr addrspace(1), ptr %output.addr, align 4
  %arrayidx5 = getelementptr inbounds float, ptr addrspace(1) %tmp4, i32 %tmp3
  store float %add, ptr addrspace(1) %arrayidx5
  %tmp6 = load i32, ptr %tid, align 4
  %tmp7 = load ptr addrspace(1), ptr %output.addr, align 4
  %arrayidx8 = getelementptr inbounds float, ptr addrspace(1) %tmp7, i32 %tmp6
  %tmp9 = load float, ptr addrspace(1) %arrayidx8
  %div = fdiv float %tmp9, 5.000000e+000
  %tmp10 = load i32, ptr %tid, align 4
  %tmp11 = load ptr addrspace(1), ptr %output.addr, align 4
  %arrayidx12 = getelementptr inbounds float, ptr addrspace(1) %tmp11, i32 %tmp10
  store float %div, ptr addrspace(1) %arrayidx12
  %tmp13 = load i32, ptr %tid, align 4
  %tmp14 = load ptr addrspace(1), ptr %output.addr, align 4
  %arrayidx15 = getelementptr inbounds float, ptr addrspace(1) %tmp14, i32 %tmp13
  %tmp16 = load float, ptr addrspace(1) %arrayidx15
  %sub = fsub float 2.000000e+000, %tmp16
  %tmp17 = load i32, ptr %tid, align 4
  %tmp18 = load ptr addrspace(1), ptr %output.addr, align 4
  %arrayidx19 = getelementptr inbounds float, ptr addrspace(1) %tmp18, i32 %tmp17
  store float %sub, ptr addrspace(1) %arrayidx19
  %tmp20 = load i32, ptr %tid, align 4
  %tmp21 = load ptr addrspace(1), ptr %output.addr, align 4
  %arrayidx22 = getelementptr inbounds float, ptr addrspace(1) %tmp21, i32 %tmp20
  %tmp23 = load float, ptr addrspace(1) %arrayidx22
  %tmp24 = load i32, ptr %tid, align 4
  %tmp25 = load ptr addrspace(1), ptr %input.addr, align 4
  %arrayidx26 = getelementptr inbounds float, ptr addrspace(1) %tmp25, i32 %tmp24
  %tmp27 = load float, ptr addrspace(1) %arrayidx26
  %mul = fmul float %tmp23, %tmp27
  %tmp28 = load i32, ptr %tid, align 4
  %tmp29 = load ptr addrspace(1), ptr %output.addr, align 4

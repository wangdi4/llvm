...
; CHECK-DAG: @pWorkDim = linkonce_odr thread_local global {{.*}} undef, align 8
; CHECK-DAG: @pWGId = linkonce_odr thread_local global {{i64\*|ptr}} undef, align 8
; CHECK-DAG: @BaseGlbId = linkonce_odr thread_local global [4 x i64] undef, align 16
; CHECK-DAG: @pSpecialBuf = linkonce_odr thread_local global {{i8\*|ptr}} undef, align 8
; CHECK-DAG: @RuntimeHandle = linkonce_odr thread_local global {{\{\}\*|ptr}} undef, align 8

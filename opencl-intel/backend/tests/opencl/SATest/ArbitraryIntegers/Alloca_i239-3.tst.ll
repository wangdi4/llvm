...
entry:
  ...
  store i239 %data, i239* %data.addr, align 32, !tbaa !12
  store i239 0, i239* %data.addr, align 32, !tbaa !12
  %0 = load i239, i239* %data.addr, align 32, !tbaa !12
  %call = call i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* getelementptr inbounds ([3 x i8], [3 x i8] addrspace(2)* @.str, i32 0, i32 0), i239 %0) #2
  ret void
}

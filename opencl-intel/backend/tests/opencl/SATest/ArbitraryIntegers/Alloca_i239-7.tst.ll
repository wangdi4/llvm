...
define spir_kernel void @do_nothing(ptr addrspace(1) %data) #0 !kernel_arg_addr_space !6 !kernel_arg_access_qual !7 !kernel_arg_type !8 !kernel_arg_base_type !8 !kernel_arg_type_qual !9 !kernel_arg_host_accessible !10 !kernel_arg_name !11 {
entry:
  ...
  %0 = bitcast ptr %set to ptr
  call void @llvm.lifetime.start.p0i8(i64 3, ptr %0) #2
  %1 = bitcast ptr %set to ptr
  call void @llvm.lifetime.end.p0i8(i64 3, ptr %1) #2
  ret void
}

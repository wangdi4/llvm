...
entry:
  ...
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %tmp1, i32 %tmp
  ...
  %arrayidx5 = getelementptr inbounds float, float addrspace(1)* %tmp4, i32 %tmp3
  store float %add, float addrspace(1)* %arrayidx5
  %tmp6 = load i32* %tid, align 4
  %tmp7 = load float addrspace(1)** %output.addr, align 4
  %arrayidx8 = getelementptr inbounds float, float addrspace(1)* %tmp7, i32 %tmp6
  ...
  %arrayidx12 = getelementptr inbounds float, float addrspace(1)* %tmp11, i32 %tmp10
  store float %div, float addrspace(1)* %arrayidx12
  %tmp13 = load i32* %tid, align 4
  %tmp14 = load float addrspace(1)** %output.addr, align 4
  %arrayidx15 = getelementptr inbounds float, float addrspace(1)* %tmp14, i32 %tmp13
  ...
  %arrayidx30 = getelementptr inbounds float, float addrspace(1)* %tmp29, i32 %tmp28

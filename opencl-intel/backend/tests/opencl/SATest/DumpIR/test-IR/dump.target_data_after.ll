...
; <label>:7                                       ; preds = %5
  ...
  store <4 x i32> %26, <4 x i32>* %25, align 16
  ...
  store <4 x i32> %41, <4 x i32>* %40, align 16
  ...
  store <4 x i32> %57, <4 x i32>* %56, align 16
...
; <label>:66                                      ; preds = %64
  ...
  %68 = load <4 x i32>* %67, align 16
  %69 = icmp slt <4 x i32> %iYes.0, %68
  %70 = sext <4 x i1> %69 to <4 x i32>
  %71 = add <4 x i32> %iHighCount.0, %70
...
; <label>:86                                      ; preds = %64
  %87 = sub <4 x i32> zeroinitializer, %iHighCount.0
...
; <label>:101                                     ; preds = %61
  ...
  store i32 %111, i32 addrspace(1)* %115, align 4
...
; <label>:73                                      ; preds = %40
  ...
  store i32 %iYes.0, i32* %74, align 4
...
; <label>:76                                      ; preds = %5
  ...
  store i32 %89, i32 addrspace(1)* %93, align 4

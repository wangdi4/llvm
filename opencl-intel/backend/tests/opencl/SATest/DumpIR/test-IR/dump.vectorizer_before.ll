...
entry:
  ...
  %cmp4 = icmp eq i32 %div11, 0
  br i1 %cmp4, label %for.end79, label %for.cond16.preheader.lr.ph
...
for.cond16.preheader:                             ; preds = %for.cond16.preheader.lr.ph, %for.inc76
  %i.06 = phi i32 [ 0, %for.cond16.preheader.lr.ph ], [ %inc77, %for.inc76 ]
  %index_y.05 = phi i32 [ %div14, %for.cond16.preheader.lr.ph ], [ %inc78.pre-phi, %for.inc76 ]
...
for.end79:                                        ; preds = %for.inc76, %entry
  ret void
}
...
for.body:                                         ; preds = %for.inc36, %for.body.lr.ph
  %lowRightCrd.033 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %lowRightCrd.1.lcssa, %for.inc36 ]
  %lowLeftCrd.032 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %lowLeftCrd.1.lcssa, %for.inc36 ]
  %lowCrd.031 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %lowCrd.1.lcssa, %for.inc36 ]
  %row.030 = phi i32 [ %mul, %for.body.lr.ph ], [ %add6, %for.inc36 ]
  %upRightCrd.029 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %upRightCrd.1.lcssa, %for.inc36 ]
  %upLeftCrd.028 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %upLeftCrd.1.lcssa, %for.inc36 ]
  %index.027 = phi i32 [ %mul3, %for.body.lr.ph ], [ %index.1.lcssa, %for.inc36 ]
  %upCrd.026 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %upCrd.1.lcssa, %for.inc36 ]
  %curCrd.025 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %curCrd.1.lcssa, %for.inc36 ]
  %curLeftCrd.024 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %curLeftCrd.1.lcssa, %for.inc36 ]
  %curRightCrd.023 = phi <2 x i32> [ undef, %for.body.lr.ph ], [ %curRightCrd.1.lcssa, %for.inc36 ]
  ...
  %8 = insertelement <2 x i32> %lowCrd.031, i32 %add6, i32 1
  %9 = insertelement <2 x i32> %lowLeftCrd.032, i32 %add6, i32 1
  %10 = insertelement <2 x i32> %lowRightCrd.033, i32 %add6, i32 1
  br i1 %cmp101, label %for.body11, label %for.inc36

for.body11:                                       ; preds = %for.body, %for.body11
  %col.012 = phi i32 [ %add13, %for.body11 ], [ 0, %for.body ]
  %lowRightCrd.111 = phi <2 x i32> [ %19, %for.body11 ], [ %10, %for.body ]
  %lowLeftCrd.110 = phi <2 x i32> [ %18, %for.body11 ], [ %9, %for.body ]
  %lowCrd.19 = phi <2 x i32> [ %17, %for.body11 ], [ %8, %for.body ]
  %upRightCrd.18 = phi <2 x i32> [ %16, %for.body11 ], [ %7, %for.body ]
  %upLeftCrd.17 = phi <2 x i32> [ %15, %for.body11 ], [ %6, %for.body ]
  %index.16 = phi i32 [ %inc, %for.body11 ], [ %index.027, %for.body ]
  %upCrd.15 = phi <2 x i32> [ %14, %for.body11 ], [ %5, %for.body ]
  %curCrd.14 = phi <2 x i32> [ %11, %for.body11 ], [ %2, %for.body ]
  %curLeftCrd.13 = phi <2 x i32> [ %12, %for.body11 ], [ %3, %for.body ]
  %curRightCrd.12 = phi <2 x i32> [ %13, %for.body11 ], [ %4, %for.body ]
  %11 = insertelement <2 x i32> %curCrd.14, i32 %col.012, i32 0
  %sub12 = add nsw i32 %col.012, -1
  %12 = insertelement <2 x i32> %curLeftCrd.13, i32 %sub12, i32 0
  %add13 = add nsw i32 %col.012, 1
  %13 = insertelement <2 x i32> %curRightCrd.12, i32 %add13, i32 0
  %14 = insertelement <2 x i32> %upCrd.15, i32 %col.012, i32 0
  %15 = insertelement <2 x i32> %upLeftCrd.17, i32 %sub12, i32 0
  %16 = insertelement <2 x i32> %upRightCrd.18, i32 %add13, i32 0
  %17 = insertelement <2 x i32> %lowCrd.19, i32 %col.012, i32 0
  %18 = insertelement <2 x i32> %lowLeftCrd.110, i32 %sub12, i32 0
  %19 = insertelement <2 x i32> %lowRightCrd.111, i32 %add13, i32 0
  %call18 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %11)
  %call19 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %12)
  %add20 = fadd <4 x float> %call18, %call19
  %call21 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %13)
  %add22 = fadd <4 x float> %add20, %call21
  %call23 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %14)
  %add24 = fadd <4 x float> %add22, %call23
  %call25 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %15)
  %add26 = fadd <4 x float> %add24, %call25
  %call27 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %16)
  %add28 = fadd <4 x float> %add26, %call27
  %call29 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %17)
  %add30 = fadd <4 x float> %add28, %call29
  %call31 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %18)
  %add32 = fadd <4 x float> %add30, %call31
  %call33 = tail call <4 x float> @evaluatePixel(%struct._image2d_t.0* %inputImage, <2 x i32> %19)
  ...
  br i1 %exitcond, label %for.cond9.for.inc36_crit_edge, label %for.body11

for.cond9.for.inc36_crit_edge:                    ; preds = %for.body11
  %20 = add i32 %1, %index.027
  br label %for.inc36

for.inc36:                                        ; preds = %for.cond9.for.inc36_crit_edge, %for.body
  %lowRightCrd.1.lcssa = phi <2 x i32> [ %19, %for.cond9.for.inc36_crit_edge ], [ %10, %for.body ]
  %lowLeftCrd.1.lcssa = phi <2 x i32> [ %18, %for.cond9.for.inc36_crit_edge ], [ %9, %for.body ]
  %lowCrd.1.lcssa = phi <2 x i32> [ %17, %for.cond9.for.inc36_crit_edge ], [ %8, %for.body ]
  %upRightCrd.1.lcssa = phi <2 x i32> [ %16, %for.cond9.for.inc36_crit_edge ], [ %7, %for.body ]
  %upLeftCrd.1.lcssa = phi <2 x i32> [ %15, %for.cond9.for.inc36_crit_edge ], [ %6, %for.body ]
  %index.1.lcssa = phi i32 [ %20, %for.cond9.for.inc36_crit_edge ], [ %index.027, %for.body ]
  %upCrd.1.lcssa = phi <2 x i32> [ %14, %for.cond9.for.inc36_crit_edge ], [ %5, %for.body ]
  %curCrd.1.lcssa = phi <2 x i32> [ %11, %for.cond9.for.inc36_crit_edge ], [ %2, %for.body ]
  %curLeftCrd.1.lcssa = phi <2 x i32> [ %12, %for.cond9.for.inc36_crit_edge ], [ %3, %for.body ]
  %curRightCrd.1.lcssa = phi <2 x i32> [ %13, %for.cond9.for.inc36_crit_edge ], [ %4, %for.body ]
...
for.end84:                                        ; preds = %for.body59, %for.cond57.preheader
  ...
  %inc95 = add i32 %topRowIndex.034, 2
  ...
  %arrayidx99 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %inc95
...
for.end141:                                       ; preds = %for.body116, %if.end17.for.cond114.preheader_crit_edge, %for.cond114.preheader
  %48 = or i32 %div8, %div6
  %brmerge = icmp eq i32 %48, 0
  br i1 %brmerge, label %if.then143, label %if.end156

if.then143:                                       ; preds = %for.end141
  %49 = load <4 x float> addrspace(1)* %input, align 16
  %add145 = fadd <4 x float> %49, zeroinitializer
  %arrayidx146 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 1
  %50 = load <4 x float> addrspace(1)* %arrayidx146, align 16
  %add147 = fadd <4 x float> %add145, %50
  %arrayidx148 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %width
  %51 = load <4 x float> addrspace(1)* %arrayidx148, align 16
  %add149 = fadd <4 x float> %add147, %51
  %add150 = add i32 %width, 1
  %arrayidx151 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add150
  %52 = load <4 x float> addrspace(1)* %arrayidx151, align 16
  %add152 = fadd <4 x float> %add149, %52
...
for.body163.lr.ph:                                ; preds = %for.cond160.preheader
  %add172 = add i32 %width, -1
  %add179 = add i32 %width, 1
  %53 = icmp ugt i32 %div6, 1
  %umax49 = select i1 %53, i32 %div6, i32 1
  %54 = add i32 %count_x.0, %umax49
  %55 = add i32 %54, %sub24
...
for.body163:                                      ; preds = %for.body163, %for.body163.lr.ph
  ...
  %56 = load <4 x float> addrspace(1)* %arrayidx165, align 16
  %add166 = fadd <4 x float> %56, zeroinitializer
  %arrayidx167 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %column159.017
  %57 = load <4 x float> addrspace(1)* %arrayidx167, align 16
  %add168 = fadd <4 x float> %add166, %57
  %add169 = add nsw i32 %column159.017, 1
  %arrayidx170 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add169
  %58 = load <4 x float> addrspace(1)* %arrayidx170, align 16
  %add171 = fadd <4 x float> %add168, %58
  %sub173 = add i32 %add172, %column159.017
  %arrayidx174 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub173
  %59 = load <4 x float> addrspace(1)* %arrayidx174, align 16
  %add175 = fadd <4 x float> %add171, %59
  %add176 = add i32 %column159.017, %width
  %arrayidx177 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add176
  %60 = load <4 x float> addrspace(1)* %arrayidx177, align 16
  %add178 = fadd <4 x float> %add175, %60
  %add180 = add i32 %add179, %column159.017
  %arrayidx181 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add180
  %61 = load <4 x float> addrspace(1)* %arrayidx181, align 16
  %add182 = fadd <4 x float> %add178, %61
...
if.then193:                                       ; preds = %if.end189
  ...
  %62 = load <4 x float> addrspace(1)* %arrayidx195, align 16
  %add196 = fadd <4 x float> %62, zeroinitializer
  %sub197 = add i32 %width, -1
  %arrayidx198 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub197
  %63 = load <4 x float> addrspace(1)* %arrayidx198, align 16
  %add199 = fadd <4 x float> %add196, %63
  %add200 = shl i32 %width, 1
  %sub201 = add i32 %add200, -2
  %arrayidx202 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub201
  %64 = load <4 x float> addrspace(1)* %arrayidx202, align 16
  %add203 = fadd <4 x float> %add199, %64
  %sub205 = add i32 %add200, -1
  %arrayidx206 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub205
  %65 = load <4 x float> addrspace(1)* %arrayidx206, align 16
  %add207 = fadd <4 x float> %add203, %65
...
if.end212:                                        ; preds = %if.end189, %if.end156, %if.then193
  br i1 %cmp22, label %for.cond216.preheader, label %if.end280
...
for.body219.lr.ph:                                ; preds = %for.cond216.preheader
  %66 = icmp ugt i32 %div8, 1
  %umax47 = select i1 %66, i32 %div8, i32 1
  %67 = add i32 %count_y.0, %umax47
  %68 = add i32 %67, %sub20
...
for.body219:                                      ; preds = %for.body219, %for.body219.lr.ph
  ...
  %69 = load <4 x float> addrspace(1)* %arrayidx222, align 16
  %add223 = fadd <4 x float> %69, zeroinitializer
  %mul224 = mul i32 %row215.015, %width
  %arrayidx225 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %mul224
  %70 = load <4 x float> addrspace(1)* %arrayidx225, align 16
  %add226 = fadd <4 x float> %add223, %70
  ...
  %71 = load <4 x float> addrspace(1)* %arrayidx229, align 16
  %add230 = fadd <4 x float> %add226, %71
  %add233 = add i32 %mul221, 1
  %arrayidx234 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add233
  %72 = load <4 x float> addrspace(1)* %arrayidx234, align 16
  %add235 = fadd <4 x float> %add230, %72
  %add237 = add i32 %mul224, 1
  %arrayidx238 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add237
  %73 = load <4 x float> addrspace(1)* %arrayidx238, align 16
  %add239 = fadd <4 x float> %add235, %73
  %add242 = add i32 %mul228, 1
  %arrayidx243 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add242
  %74 = load <4 x float> addrspace(1)* %arrayidx243, align 16
  %add244 = fadd <4 x float> %add239, %74
  ...
  %exitcond48 = icmp eq i32 %add227, %68
  br i1 %exitcond48, label %if.end252, label %for.body219

if.end252:                                        ; preds = %for.body219, %for.cond216.preheader
  br i1 %bottomEdge.0, label %if.end280.thread, label %if.end331

if.end280.thread:                                 ; preds = %if.end252
  ...
  %75 = load <4 x float> addrspace(1)* %arrayidx259, align 16
  %add260 = fadd <4 x float> %75, zeroinitializer
  %add263 = add i32 %mul258, 1
  %arrayidx264 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add263
  %76 = load <4 x float> addrspace(1)* %arrayidx264, align 16
  %add265 = fadd <4 x float> %add260, %76
  ...
  %77 = load <4 x float> addrspace(1)* %arrayidx268, align 16
  %add269 = fadd <4 x float> %add265, %77
  %add272 = add i32 %mul267, 1
  %arrayidx273 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add272
  %78 = load <4 x float> addrspace(1)* %arrayidx273, align 16
  %add274 = fadd <4 x float> %add269, %78
...
if.end280:                                        ; preds = %if.end212
  br i1 %bottomEdge.0, label %for.cond284.preheader, label %if.end331

for.cond284.preheader:                            ; preds = %if.end280.thread, %if.end280
...
for.body287.lr.ph:                                ; preds = %for.cond284.preheader
  ...
  %add301 = add i32 %mul289, 1
  %sub305 = add i32 %height, -1
  %mul306 = mul i32 %sub305, %width
  %add307 = add i32 %mul306, -1
  %add318 = add i32 %mul306, 1
  %79 = icmp ugt i32 %div6, 1
  %umax45 = select i1 %79, i32 %div6, i32 1
  %80 = add i32 %count_x.0, %umax45
  %81 = add i32 %80, %sub24
...
for.body287:                                      ; preds = %for.body287, %for.body287.lr.ph
  ...
  %sub291 = add i32 %add290, %column283.013
  %arrayidx292 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub291
  %82 = load <4 x float> addrspace(1)* %arrayidx292, align 16
  %add293 = fadd <4 x float> %82, zeroinitializer
  %add296 = add i32 %column283.013, %mul289
  %arrayidx297 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add296
  %83 = load <4 x float> addrspace(1)* %arrayidx297, align 16
  %add298 = fadd <4 x float> %add293, %83
  %add302 = add i32 %add301, %column283.013
  %arrayidx303 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add302
  %84 = load <4 x float> addrspace(1)* %arrayidx303, align 16
  %add304 = fadd <4 x float> %add298, %84
  %sub308 = add i32 %add307, %column283.013
  %arrayidx309 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub308
  %85 = load <4 x float> addrspace(1)* %arrayidx309, align 16
  %add310 = fadd <4 x float> %add304, %85
  %add313 = add i32 %column283.013, %mul306
  %arrayidx314 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add313
  %86 = load <4 x float> addrspace(1)* %arrayidx314, align 16
  %add315 = fadd <4 x float> %add310, %86
  %add319 = add i32 %add318, %column283.013
  %arrayidx320 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %add319
  %87 = load <4 x float> addrspace(1)* %arrayidx320, align 16
  %add321 = fadd <4 x float> %add315, %87
  %div323 = fdiv <4 x float> %add321, <float 9.000000e+00, float 9.000000e+00, float 9.000000e+00, float 9.000000e+00>
  %arrayidx327 = getelementptr inbounds <4 x float> addrspace(1)* %output, i32 %add313
  store <4 x float> %div323, <4 x float> addrspace(1)* %arrayidx327, align 16
  %inc329 = add nsw i32 %column283.013, 1
  %exitcond46 = icmp eq i32 %inc329, %81
  br i1 %exitcond46, label %if.end331, label %for.body287

if.end331:                                        ; preds = %if.end252, %for.cond284.preheader, %for.body287, %if.end280
...
for.body338.lr.ph:                                ; preds = %for.cond335.preheader
  %88 = icmp ugt i32 %div8, 1
  %umax = select i1 %88, i32 %div8, i32 1
  %89 = add i32 %count_y.0, %umax
  %90 = add i32 %89, %sub20
...
for.body338:                                      ; preds = %for.body338, %for.body338.lr.ph
  ...
  %91 = load <4 x float> addrspace(1)* %arrayidx341, align 16
  %add342 = fadd <4 x float> %91, zeroinitializer
  ...
  %92 = load <4 x float> addrspace(1)* %arrayidx346, align 16
  %add347 = fadd <4 x float> %add342, %92
  ...
  %93 = load <4 x float> addrspace(1)* %arrayidx351, align 16
  %add352 = fadd <4 x float> %add347, %93
  %sub354 = add i32 %mul339, -2
  %arrayidx355 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub354
  %94 = load <4 x float> addrspace(1)* %arrayidx355, align 16
  %add356 = fadd <4 x float> %add352, %94
  %sub359 = add i32 %mul344, -2
  %arrayidx360 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub359
  %95 = load <4 x float> addrspace(1)* %arrayidx360, align 16
  %add361 = fadd <4 x float> %add356, %95
  %sub364 = add i32 %mul349, -2
  %arrayidx365 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub364
  %96 = load <4 x float> addrspace(1)* %arrayidx365, align 16
  %add366 = fadd <4 x float> %add361, %96
  ...
  %exitcond = icmp eq i32 %add343, %90
...
if.then380:                                       ; preds = %if.end376
  ...
  %97 = load <4 x float> addrspace(1)* %arrayidx384, align 16
  %add385 = fadd <4 x float> %97, zeroinitializer
  %sub388 = add i32 %mul382, -1
  %arrayidx389 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub388
  %98 = load <4 x float> addrspace(1)* %arrayidx389, align 16
  %add390 = fadd <4 x float> %add385, %98
  ...
  %99 = load <4 x float> addrspace(1)* %arrayidx393, align 16
  %add394 = fadd <4 x float> %add390, %99
  %sub396 = add i32 %mul391, -1
  %arrayidx397 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %sub396
  %100 = load <4 x float> addrspace(1)* %arrayidx397, align 16
  %add398 = fadd <4 x float> %add394, %100
...
if.end404:                                        ; preds = %if.end331, %if.end376, %if.then380
  ret void
}

...
.preheader.lr.ph:
  %0 = tail call i32 @get_global_id(i32 0) nounwind readnone
  %1 = tail call i32 @get_global_size(i32 0) nounwind readnone
  %2 = tail call i32 @get_global_size(i32 1) nounwind readnone
  %3 = udiv i32 %width, %1
  %4 = udiv i32 %height, %2
  %5 = mul i32 %0, %width
  %6 = udiv i32 %5, %1
  %7 = tail call i32 @get_global_id(i32 1) nounwind readnone
  %8 = mul i32 %7, %height
  %9 = udiv i32 %8, %2
  %10 = icmp eq i32 %3, 0
  %11 = add i32 %width, -1
...
.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge
  %i.04 = phi i32 [ 0, %.preheader.lr.ph ], [ %77, %._crit_edge ]
  %index_y.03 = phi i32 [ %9, %.preheader.lr.ph ], [ %.pre-phi, %._crit_edge ]
  br i1 %10, label %.preheader._crit_edge, label %.lr.ph
...
.lr.ph:                                           ; preds = %.preheader
  %13 = mul i32 %index_y.03, %width
  %14 = add i32 %index_y.03, -1
  %15 = mul i32 %14, %width
  %16 = add i32 %index_y.03, 1
  %17 = mul i32 %16, %width
  %18 = icmp eq i32 %index_y.03, 0
  %19 = icmp ult i32 %index_y.03, %12
  br label %20

; <label>:20                                      ; preds = %.lr.ph, %71
  %index_x1.02 = phi i32 [ %6, %.lr.ph ], [ %75, %71 ]
  %j.01 = phi i32 [ 0, %.lr.ph ], [ %74, %71 ]
  %21 = add i32 %index_x1.02, %13
  %22 = add i32 %index_x1.02, %15
  %23 = add i32 %index_x1.02, %17
  %24 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %21
...
; <label>:27                                      ; preds = %20
  %28 = add i32 %21, -1
  %29 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %28
  %30 = load <4 x float> addrspace(1)* %29, align 16
  %31 = fadd <4 x float> %25, %30
  br label %32

; <label>:32                                      ; preds = %20, %27
  %colorAccumulator.0 = phi <4 x float> [ %31, %27 ], [ %25, %20 ]
  %33 = icmp ult i32 %index_x1.02, %11
  br i1 %33, label %34, label %39

; <label>:34                                      ; preds = %32
  %35 = add i32 %21, 1
  %36 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %35
  %37 = load <4 x float> addrspace(1)* %36, align 16
  %38 = fadd <4 x float> %colorAccumulator.0, %37
  br label %39

; <label>:39                                      ; preds = %34, %32
  %colorAccumulator.1 = phi <4 x float> [ %38, %34 ], [ %colorAccumulator.0, %32 ]
  br i1 %18, label %55, label %40

; <label>:40                                      ; preds = %39
  %41 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %22
  %42 = load <4 x float> addrspace(1)* %41, align 16
  %43 = fadd <4 x float> %colorAccumulator.1, %42
  br i1 %26, label %49, label %44

; <label>:44                                      ; preds = %40
  %45 = add i32 %22, -1
  %46 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %45
  %47 = load <4 x float> addrspace(1)* %46, align 16
  %48 = fadd <4 x float> %43, %47
  br label %49

; <label>:49                                      ; preds = %40, %44
  %colorAccumulator.2 = phi <4 x float> [ %48, %44 ], [ %43, %40 ]
  br i1 %33, label %50, label %55

; <label>:50                                      ; preds = %49
  %51 = add i32 %22, 1
  %52 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %51
  %53 = load <4 x float> addrspace(1)* %52, align 16
  %54 = fadd <4 x float> %colorAccumulator.2, %53
  br label %55

; <label>:55                                      ; preds = %39, %49, %50
  %colorAccumulator.3 = phi <4 x float> [ %54, %50 ], [ %colorAccumulator.2, %49 ], [ %colorAccumulator.1, %39 ]
  br i1 %19, label %56, label %71

; <label>:56                                      ; preds = %55
  %57 = getelementptr inbounds <4 x float> addrspace(1)* %input, i32 %23
  %58 = load <4 x float> addrspace(1)* %57, align 16
  %59 = fadd <4 x float> %colorAccumulator.3, %58
  br i1 %26, label %65, label %60
...
; <label>:65                                      ; preds = %56, %60
  %colorAccumulator.4 = phi <4 x float> [ %64, %60 ], [ %59, %56 ]
...
; <label>:66                                      ; preds = %65
  ...
  %70 = fadd <4 x float> %colorAccumulator.4, %69
  br label %71

; <label>:71                                      ; preds = %65, %66, %55
  %colorAccumulator.5 = phi <4 x float> [ %70, %66 ], [ %colorAccumulator.4, %65 ], [ %colorAccumulator.3, %55 ]
  %72 = fdiv <4 x float> %colorAccumulator.5, <float 9.000000e+00, float 9.000000e+00, float 9.000000e+00, float 9.000000e+00>
  %73 = getelementptr inbounds <4 x float> addrspace(1)* %output, i32 %21
  store <4 x float> %72, <4 x float> addrspace(1)* %73, align 16
  %74 = add i32 %j.01, 1
  %75 = add i32 %index_x1.02, 1
  %76 = icmp ult i32 %74, %3
  br i1 %76, label %20, label %._crit_edge

._crit_edge:                                      ; preds = %71, %.preheader._crit_edge
  %.pre-phi = phi i32 [ %.pre, %.preheader._crit_edge ], [ %16, %71 ]
  %77 = add i32 %i.04, 1
  %78 = icmp ult i32 %77, %4
  br i1 %78, label %.preheader, label %._crit_edge5
...
!18 = metadata !{metadata !"-cl-std=CL1.2", metadata !"-cl-kernel-arg-info"}

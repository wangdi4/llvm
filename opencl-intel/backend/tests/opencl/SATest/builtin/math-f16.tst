...
; CHECK32-VPLAN-NOT: call{{.*}} <32 x half> @_Z3madDv32_DhS_S_(<32 x half> {{.*}}, <32 x half> {{.*}}, <32 x half> {{.*}})
...
; CHECK64-VPLAN-NOT: call{{.*}} <64 x half> @_Z3madDv64_DhS_S_(<64 x half> {{.*}}, <64 x half> {{.*}}, <64 x half> {{.*}})

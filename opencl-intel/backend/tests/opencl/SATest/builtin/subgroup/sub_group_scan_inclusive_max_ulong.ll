; ModuleID = 'sub_group_scan_inclusive_max_ulong.ll'
source_filename = "sub_group_scan_inclusive_max_ulong.ll"
...
entry:
  ...
  %call2 = call spir_func i64 @_Z28sub_group_scan_inclusive_maxm(i64 noundef %0) #5
  %1 = load i64, ptr addrspace(1) %input, align 8, !tbaa !10
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %max_val.0 = phi i64 [ %1, %entry ], [ %max_val.1, %for.inc ]
...
if.end:                                           ; preds = %if.then, %for.body
  %max_val.1 = phi i64 [ %3, %if.then ], [ %max_val.0, %for.body ]
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.cleanup
  %cmp9 = icmp eq i64 %max_val.0, %call2
...
; Function Attrs: convergent
declare spir_func i64 @_Z28sub_group_scan_inclusive_maxm(i64 noundef) #3

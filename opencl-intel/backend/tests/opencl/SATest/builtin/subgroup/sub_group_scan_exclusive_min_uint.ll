...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load i32, ptr addrspace(1) %arrayidx8, align 4, !tbaa !10
...
if.then10:                                        ; preds = %for.body
  ...
  %3 = load i32, ptr addrspace(1) %arrayidx12, align 4, !tbaa !10
  br label %if.end
...
if.end14:                                         ; preds = %if.end13, %if.then
  ...
  store i32 %cond, ptr addrspace(1) %arrayidx16, align 4, !tbaa !10
  ret void
}

; ModuleID = 'sub_group_scan_inclusive_min_uint.ll'
source_filename = "sub_group_scan_inclusive_min_uint.ll"
...
entry:
  ...
  %call2 = call spir_func i32 @_Z28sub_group_scan_inclusive_minj(i32 noundef %0) #5
  %1 = load i32, ptr addrspace(1) %input, align 4, !tbaa !10
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %min_val.0 = phi i32 [ %1, %entry ], [ %min_val.1, %for.inc ]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx5 = getelementptr inbounds i32, ptr addrspace(1) %input, i64 %idxprom4
  %2 = load i32, ptr addrspace(1) %arrayidx5, align 4, !tbaa !10
  %cmp6 = icmp ugt i32 %min_val.0, %2
  br i1 %cmp6, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %idxprom7 = zext i32 %i.0 to i64
  %arrayidx8 = getelementptr inbounds i32, ptr addrspace(1) %input, i64 %idxprom7
  %3 = load i32, ptr addrspace(1) %arrayidx8, align 4, !tbaa !10
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %min_val.1 = phi i32 [ %3, %if.then ], [ %min_val.0, %for.body ]
  br label %for.inc
...
; Function Attrs: convergent
declare spir_func i32 @_Z28sub_group_scan_inclusive_minj(i32 noundef) #3

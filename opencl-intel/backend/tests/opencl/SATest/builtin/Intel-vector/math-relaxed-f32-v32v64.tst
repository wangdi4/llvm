...
; CHECK64-SVML: call{{.*}} <32 x float> @{{__ocl_svml_x0_|__ocl_svml_z0_|_Z6}}tan{{f32_rm|_rmDv32_f}}(<32 x float> {{.*}})
; CHECK64-SVML: call{{.*}} <32 x float> @{{__ocl_svml_x0_|__ocl_svml_z0_|_Z9}}sincos{{f32_rm|_rmDv32_fPS_}}(<32 x float> {{.*}}, <32 x float>{{.*}})
; CHECK64-SVML: call{{.*}} <32 x float> @{{__ocl_svml_x0_|__ocl_svml_z0_|_Z9}}sincos{{f32_rm|_rmDv32_fPS_}}(<32 x float> {{.*}}, <32 x float>{{.*}})
...
; CHECK64-SVML: call{{.*}} float @{{__ocl_svml_x0_|__ocl_svml_z0_|_Z9}}sincos{{f1_rm|_rmfPf}}(float {{.*}}, float{{.*}})

...
; CHECK32-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_sincosf1_rm(float {{.*}}, float {{.*}})
...
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 <32 x float> @__ocl_svml_{{[xz]}}0_sincosf32_rm(<32 x float> {{.*}}, <32 x float> {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_cosf1_rm(float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_expf1_rm(float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_exp2f1_rm(float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_exp10f1_rm(float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_logf1_rm(float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_log2f1_rm(float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_powf1_rm(float {{.*}}, float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_sinf1_rm(float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_tanf1_rm(float {{.*}})
; CHECK64-SVML: call{{.*}} intel_ocl_bicc_avx512 float @__ocl_svml_{{[xz]}}0_sincosf1_rm(float {{.*}}, float {{.*}})

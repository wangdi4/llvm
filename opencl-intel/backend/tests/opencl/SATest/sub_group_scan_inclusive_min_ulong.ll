...
define dso_local spir_kernel void @testKernel(i64 addrspace(1)* noundef %input, i32 addrspace(1)* noundef %results) #0 !kernel_arg_addr_space !3 !kernel_arg_access_qual !4 !kernel_arg_type !5 !kernel_arg_base_type !5 !kernel_arg_type_qual !6 !kernel_arg_name !7 !kernel_arg_host_accessible !8 !kernel_arg_pipe_depth !9 !kernel_arg_pipe_io !6 !kernel_arg_buffer_location !6 {
entry:
  ...
  %arrayidx = getelementptr inbounds i64, i64 addrspace(1)* %input, i64 %idxprom
  %0 = load i64, i64 addrspace(1)* %arrayidx, align 8, !tbaa !10
  %call2 = call spir_func i64 @_Z28sub_group_scan_inclusive_minm(i64 noundef %0) #5
  %1 = load i64, i64 addrspace(1)* %input, align 8, !tbaa !10
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx5 = getelementptr inbounds i64, i64 addrspace(1)* %input, i64 %idxprom4
  %2 = load i64, i64 addrspace(1)* %arrayidx5, align 8, !tbaa !10
  %cmp6 = icmp ugt i64 %min_val.0, %2
  br i1 %cmp6, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %idxprom7 = zext i32 %i.0 to i64
  %arrayidx8 = getelementptr inbounds i64, i64 addrspace(1)* %input, i64 %idxprom7
  %3 = load i64, i64 addrspace(1)* %arrayidx8, align 8, !tbaa !10
  br label %if.end
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  %arrayidx10 = getelementptr inbounds i32, i32 addrspace(1)* %results, i64 %call
  store i32 %cond, i32 addrspace(1)* %arrayidx10, align 4, !tbaa !14
  ret void
}

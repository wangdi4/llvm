...
R123_CUDA_DEVICE R123_STATIC_INLINE
threefry2_ctr_t threefry2_R(unsigned int Nrounds, threefry2_ctr_t in, threefry2_key_t k)
{
    threefry2_ctr_t X;
    uint_t ks[2+1];
    ...
    if(Nrounds>0){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_0_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>1){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_1_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>2){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_2_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>3){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_3_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>3){
        /* InjectKey(r=1) */
        X.v[0] += ks[1]; X.v[1] += ks[2];
        X.v[1] += 1;     /* X.v[2-1] += r  */
    }
    if(Nrounds>4){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_4_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>5){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_5_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>6){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_6_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>7){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_7_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>7){
        /* InjectKey(r=2) */
        X.v[0] += ks[2]; X.v[1] += ks[0];
        X.v[1] += 2;
    }
    if(Nrounds>8){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_0_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>9){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_1_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>10){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_2_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>11){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_3_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>11){
        /* InjectKey(r=3) */
        X.v[0] += ks[0]; X.v[1] += ks[1];
        X.v[1] += 3;
    }
    if(Nrounds>12){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_4_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>13){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_5_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>14){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_6_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>15){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_7_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>15){
        /* InjectKey(r=4) */
        X.v[0] += ks[1]; X.v[1] += ks[2];
        X.v[1] += 4;
    }
    if(Nrounds>16){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_0_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>17){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_1_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>18){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_2_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>19){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_3_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>19){
        /* InjectKey(r=4) */
        X.v[0] += ks[2]; X.v[1] += ks[0];
        X.v[1] += 5;
    }
    if(Nrounds>20){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_0_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>21){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_1_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>22){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_2_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>23){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_3_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>23){
        /* InjectKey(r=3) */
        X.v[0] += ks[0]; X.v[1] += ks[1];
        X.v[1] += 6;
    }
    if(Nrounds>24){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_4_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>25){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_5_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>26){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_6_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>27){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_7_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>27){
        /* InjectKey(r=4) */
        X.v[0] += ks[1]; X.v[1] += ks[2];
        X.v[1] += 7;
    }
    if(Nrounds>28){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_0_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>29){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_1_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>30){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_2_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>31){  X.v[0] += X.v[1]; X.v[1] = RotL(X.v[1],R_2_3_0); X.v[1] ^= X.v[0]; }
    if(Nrounds>31){
        /* InjectKey(r=4) */
        X.v[0] += ks[2]; X.v[1] += ks[0];
        X.v[1] += 8;
...
__kernel void randu(__global ty *output, unsigned numel, unsigned counter, unsigned lo, unsigned hi)
{
...
__kernel void randn(__global ty *output, unsigned numel, unsigned counter, unsigned lo, unsigned hi)
{
    unsigned tid = get_global_id(0);
    unsigned off = get_global_size(0);
...
__kernel void randi(__global unsigned *output,
                    unsigned numel, unsigned counter, unsigned lo, unsigned hi)
{
    unsigned tid = get_global_id(0);
    unsigned off = get_global_size(0);

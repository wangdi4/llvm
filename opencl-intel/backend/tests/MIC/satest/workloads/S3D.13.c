...
__kernel void ratxb_kernel(__global const real *T, __global const real *C,
  ...
  real CTB_11 = CTOT + 1.4e0 * C(1) + 1.44e1 * C(6) + C(10) + 7.5e-1 * C(11) +
                2.6e0 * C(12) + 2.e0 * C(16) + 2.e0 * C(14) + 2.e0 * C(15);
  ...
  real CTB_29 = CTOT + C(1) + 5.e0 * C(4) + 5.e0 * C(6) + C(10) +
                5.e-1 * C(11) + 2.5e0 * C(12) + 2.e0 * C(16) + 2.e0 * C(14) +
                2.e0 * C(15);
  real CTB_190 =
  ...
  FCENT = 6.63e-1 * EXP(DIV(-TEMP, 1.707e3)) +
          3.37e-1 * EXP(DIV(-TEMP, 3.2e3)) + EXP(DIV(-4.131e3, TEMP));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 2.18e-1 * EXP(DIV(-TEMP, 2.075e2)) +
          7.82e-1 * EXP(DIV(-TEMP, 2.663e3)) + EXP(DIV(-6.095e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 8.25e-1 * EXP(DIV(-TEMP, 1.3406e3)) +
          1.75e-1 * EXP(DIV(-TEMP, 6.e4)) + EXP(DIV(-1.01398e4, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 2.655e-1 * EXP(DIV(-TEMP, 1.8e2)) +
          7.345e-1 * EXP(DIV(-TEMP, 1.035e3)) + EXP(DIV(-5.417e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 2.47e-2 * EXP(DIV(-TEMP, 2.1e2)) +
          9.753e-1 * EXP(DIV(-TEMP, 9.84e2)) + EXP(DIV(-4.374e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 1.578e-1 * EXP(DIV(-TEMP, 1.25e2)) +
          8.422e-1 * EXP(DIV(-TEMP, 2.219e3)) + EXP(DIV(-6.882e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 9.8e-1 * EXP(DIV(-TEMP, 1.0966e3)) +
          2.e-2 * EXP(DIV(-TEMP, 1.0966e3)) + EXP(DIV(-6.8595e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));

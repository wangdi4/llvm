...
__kernel void ratx_kernel(__global const real *T, __global const real *C,
  ...
  FCENT = 2.654e-1 * EXP(DIV(-TEMP, 9.4e1)) +
          7.346e-1 * EXP(DIV(-TEMP, 1.756e3)) + EXP(DIV(-5.182e3, TEMP));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 4.243e-1 * EXP(DIV(-TEMP, 2.37e2)) +
          5.757e-1 * EXP(DIV(-TEMP, 1.652e3)) + EXP(DIV(-5.069e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 2.176e-1 * EXP(DIV(-TEMP, 2.71e2)) +
          7.824e-1 * EXP(DIV(-TEMP, 2.755e3)) + EXP(DIV(-6.57e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 4.093e-1 * EXP(DIV(-TEMP, 2.75e2)) +
          5.907e-1 * EXP(DIV(-TEMP, 1.226e3)) + EXP(DIV(-5.185e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 2.42e-1 * EXP(DIV(-TEMP, 9.4e1)) +
          7.58e-1 * EXP(DIV(-TEMP, 1.555e3)) + EXP(DIV(-4.2e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 2.17e-1 * EXP(DIV(-TEMP, 7.4e1)) +
          7.83e-1 * EXP(DIV(-TEMP, 2.941e3)) + EXP(DIV(-6.964e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 3.827e-1 * EXP(DIV(-TEMP, 1.3076e1)) +
          6.173e-1 * EXP(DIV(-TEMP, 2.078e3)) + EXP(DIV(-5.093e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  PCOR = DIV(PR, (1.0 + PR));
  PRLOG = LOG10(MAX(PR, SMALL));
  FCENT = 4.675e-1 * EXP(DIV(-TEMP, 1.51e2)) +
          5.325e-1 * EXP(DIV(-TEMP, 1.038e3)) + EXP(DIV(-4.97e3, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));
  ...
  FCENT = -9.816e-1 * EXP(DIV(-TEMP, 5.3837e3)) +
          1.9816e0 * EXP(DIV(-TEMP, 4.2932e0)) + EXP(DIV(7.95e-2, TEMP));
  FCLOG = LOG10(MAX(FCENT, SMALL));
  XN = 0.75 - 1.27 * FCLOG;
  CPRLOG = PRLOG - (0.4 + 0.67 * FCLOG);
  SQR = DIV(CPRLOG, (XN - 0.14 * CPRLOG));

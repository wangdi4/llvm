...
void BlackScholesVector (const __global vfloat* S, const __global vfloat* K, const __global vfloat* T, __global vfloat* vput, __global vfloat* vcall, tfloat r_val, tfloat sig_val)
{
...
__kernel  /*__attribute__((vec_type_hint(vfloat)))*/
void BlackScholes (const __global vfloat* S, const __global vfloat* K, const __global vfloat* T, __global vfloat* vput, __global vfloat* vcall, tfloat r, tfloat sig)
{
	vfloat a, b, c, y, z, e, vc, d1, d2, w1, w2;
#ifdef __DO_FLOAT__

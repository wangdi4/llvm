...
declare void @__k_original(i32 addrspace(1)* nocapture) nounwind
...
define void @__k_separated_args(i32 addrspace(1)* nocapture %p, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
entry:
  br label %SyncBB
...
SyncBB:                                           ; preds = %entry, %thenBB
  ...
  store i32 8, i32 addrspace(1)* %arrayidx, align 4
...
SyncBB.i:                                         ; preds = %thenBB.i, %entry
  ...
  store i32 8, i32 addrspace(1)* %arrayidx.i, align 4
...
!0 = metadata !{void (i32 addrspace(1)*, i8 addrspace(3)*, %struct.WorkDim*, i64*, %struct.PaddedDimId*, %struct.PaddedDimId*, i64*, i64, i8*, i64*)* @__k_separated_args, metadata !1, metadata !1, metadata !"", metadata !"int __attribute__((address_space(1))) *", metadata !"opencl_k_locals_anchor", metadata !2, metadata !3, metadata !4, metadata !5, metadata !"", void (i8*)* @k}

...
declare void @__stam_original(i32 addrspace(1)* nocapture) nounwind
...
define void @__stam_separated_args(i32 addrspace(1)* nocapture %p, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
entry:
  br label %SyncBB1
...
SyncBB1:                                          ; preds = %entry, %thenBB
  ...
  %4 = add i64 %1, %3
  %arrayidx = getelementptr inbounds i32 addrspace(1)* %p, i64 %4
...
SyncBB1.i:                                        ; preds = %thenBB.i, %entry
  ...
  %15 = add i64 %12, %14
  %arrayidx.i = getelementptr inbounds i32 addrspace(1)* %1, i64 %15
  %tmp1.i = load i32 addrspace(1)* %arrayidx.i, align 4
  %add.i = add nsw i32 %tmp1.i, 2
  store i32 %add.i, i32 addrspace(1)* %arrayidx.i, align 4
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %10
  br i1 %check.WI.iter.i, label %thenBB.i, label %__stam_separated_args.exit

thenBB.i:                                         ; preds = %SyncBB1.i
  %"CurrWI++.i" = add nuw i64 %CurrWI..0.i, 1
  br label %SyncBB1.i

__stam_separated_args.exit:                       ; preds = %SyncBB1.i
  ret void
}
...
!0 = metadata !{void (i32 addrspace(1)*, i8 addrspace(3)*, %struct.WorkDim*, i64*, %struct.PaddedDimId*, %struct.PaddedDimId*, i64*, i64, i8*, i64*)* @__stam_separated_args, metadata !1, metadata !1, metadata !"", metadata !"int __attribute__((address_space(1))) *", metadata !"opencl_stam_locals_anchor", metadata !2, metadata !3, metadata !4, metadata !5, metadata !"", void (i8*)* @stam}
!1 = metadata !{i32 0, i32 0, i32 0}
!2 = metadata !{i32 1}
!3 = metadata !{i32 3}
!4 = metadata !{metadata !"int*"}
!5 = metadata !{metadata !"p"}

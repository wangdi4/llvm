...
declare void @__memset_original(i8 addrspace(1)* nocapture, i8 zeroext) nounwind
...
define void @__memset_separated_args(i8 addrspace(1)* nocapture %buf1, i8 zeroext %val, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
entry:
  br label %SyncBB
...
SyncBB:                                           ; preds = %entry, %thenBB
  ...
  %4 = add i64 %1, %3
  %arrayidx = getelementptr inbounds i8 addrspace(1)* %buf1, i64 %4
...
SyncBB.i:                                         ; preds = %thenBB.i, %entry
  ...
  store i8 %3, i8 addrspace(1)* %arrayidx.i, align 1
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %12
  br i1 %check.WI.iter.i, label %thenBB.i, label %__memset_separated_args.exit

thenBB.i:                                         ; preds = %SyncBB.i
  %"CurrWI++.i" = add nuw i64 %CurrWI..0.i, 1
  br label %SyncBB.i

__memset_separated_args.exit:                     ; preds = %SyncBB.i
  ret void
}
...
!0 = metadata !{void (i8 addrspace(1)*, i8, i8 addrspace(3)*, %struct.WorkDim*, i64*, %struct.PaddedDimId*, %struct.PaddedDimId*, i64*, i64, i8*, i64*)* @__memset_separated_args, metadata !1, metadata !1, metadata !"", metadata !"uchar __attribute__((address_space(1))) *, uchar", metadata !"opencl_memset_locals_anchor", metadata !2, metadata !3, metadata !4, metadata !5, metadata !"", void (i8*)* @memset}
!1 = metadata !{i32 0, i32 0, i32 0}
!2 = metadata !{i32 1, i32 0}
!3 = metadata !{i32 3, i32 3}
!4 = metadata !{metadata !"uchar*", metadata !"uchar"}
!5 = metadata !{metadata !"buf1", metadata !"val"}

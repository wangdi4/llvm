; Note this test fails because llc have changed to contain switch lowering pass so the 
; generated code changed and dont match the described regex below. (note the orginal 
; status of the test was XFAIL in win32
; XFAIL: *
;

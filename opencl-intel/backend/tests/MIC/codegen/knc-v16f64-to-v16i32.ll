...
entry:
; KNF: cvt:
; KNF: vcvtpd2pi        $3, $2, {{%v[0-9]+}}, [[R1:%v[0-9]+]]
;
; KNC: cvt:
; KNC: vcvtfxpntpd2dq   $3, {{%zmm[0-1]}}, {{%zmm[0-9]+}}
; KNC: vcvtfxpntpd2dq   $3, {{%zmm[0-1]}}, {{%zmm[0-9]+}}
; KNC: vpermf32x4
...
entry:
; KNF: cvtm:
; KNF: vcvtpd2pi        $3, $2, ({{%r[a-z0-9]+}}), [[R1:%v[0-9]+]]
;
; KNC: cvtm:
; KNC: vcvtfxpntpd2dq   $3, 64([[R1:%r[a-z0-9]+]]), {{%zmm[0-9]+}}
; KNC: vcvtfxpntpd2dq   $3, ([[R1]]), {{%zmm[0-9]+}}
; KNC: vpermf32x4

...
;
; KNC: broadcastf64:
; KNC: vshuf128x32 $68, $0, %zmm0, %zmm0
...
;
; KNC: broadcastv16i32:
; KNC: vshuf128x32 $170, $85, %zmm0, %zmm0
...
;
; KNC: broadcastv8i64:
; KNC: vshuf128x32 $68, $255, %zmm0, %zmm0

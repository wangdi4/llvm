...
;
; KNC: movl $1, [[R1:%[a-z]+]]
; KNC: kmov [[R1]], [[R2:%k[0-9]+]]
; KNC: vpackstorelps {{%zmm[0-9]+}}, (%{{[a-z]+}}){[[R2]]}
...
; KNC: movl $1, [[R1:%[a-z]+]]
; KNC: kmov [[R1]], [[R2:%k[0-9]+]]
; KNC: vpackstorelpd {{%zmm[0-9]+}}, (%{{[a-z]+}}){[[R2]]}

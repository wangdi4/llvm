...
declare float @masked_load_align4_162(i1, float addrspace(1)*)

declare void @masked_store_align4_162(i1, float, float addrspace(1)*)

declare <16 x float> @masked_load_align4_163(<16 x i1>, <16 x float> addrspace(1)*)

declare void @masked_store_align4_163(<16 x i1>, <16 x float>, <16 x float> addrspace(1)*)

declare i64 @maskedf_54_get_local_size(i1, i32)

declare i64 @maskedf_55_get_group_id(i1, i32)

declare i64 @maskedf_56_get_local_size(i1, i32)

declare float @masked_load_align4_164(i1, float addrspace(1)*)

declare void @masked_store_align4_164(i1, float, float addrspace(3)*)

declare void @masked_store_align4_165(i1, float, float addrspace(3)*)

declare void @maskedf_57_barrier(i1, i64)

declare float @masked_load_align4_165(i1, float addrspace(3)*)

declare float @masked_load_align4_166(i1, float addrspace(3)*)

declare void @masked_store_align4_166(i1, float, float addrspace(3)*)

declare i64 @maskedf_58_get_group_id(i1, i32)

declare float @masked_load_align4_167(i1, float addrspace(3)*)

declare void @masked_store_align4_167(i1, float, float addrspace(1)*)

declare void @masked_store_align4_168(i1, float, float addrspace(3)*)

declare void @maskedf_59_barrier(i1, i64)

declare float @masked_load_align4_168(i1, float addrspace(3)*)

declare float @masked_load_align4_169(i1, float addrspace(3)*)

declare void @masked_store_align4_169(i1, float, float addrspace(3)*)

declare float @masked_load_align4_170(i1, float addrspace(3)*)

declare void @masked_store_align4_170(i1, float, float addrspace(3)*)

declare float @masked_load_align4_171(i1, float addrspace(3)*)

declare void @masked_store_align4_171(i1, float, float addrspace(1)*)

declare void @masked_store_align4_172(<16 x i1>, <16 x float>, <16 x float> addrspace(3)*)

declare void @masked_store_align4_173(<16 x i1>, <16 x float>, <16 x float> addrspace(3)*)

declare i1 @allOne_v16(<16 x i1>)

declare i1 @allZero_v16(<16 x i1>)

declare <16 x float> @masked_load_align4_179(<16 x i1>, <16 x float> addrspace(3)*)

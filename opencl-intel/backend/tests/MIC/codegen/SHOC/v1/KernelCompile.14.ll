...
SyncBB:                                           ; preds = %thenBB204, %thenBB, %FirstBB
  ...
  %currBarrier.3 = phi i32 [ 7, %FirstBB ], [ %currBarrier.2, %thenBB204 ], [ %currBarrier.1, %thenBB ]
  br i1 %0, label %4, label %11

; <label>:4                                       ; preds = %SyncBB
...
; <label>:11                                      ; preds = %4, %SyncBB
  %bIndex.0 = phi i32 [ %10, %4 ], [ %baseIndex, %SyncBB ]
...
"Barrier BB":                                     ; preds = %59, %bb.nph5
  ...
  br i1 %check.WI.iter, label %thenBB, label %SyncBB198

thenBB:                                           ; preds = %"Barrier BB"
  %"CurrWI++" = add nuw i64 %CurrWI..2, 1
  %"loadedCurrSB+Stride" = add nuw i64 %CurrSBIndex..2, 88
  %cond3 = icmp eq i32 %currBarrier.1, 7
  br i1 %cond3, label %SyncBB, label %SyncBB198

SyncBB198:                                        ; preds = %"Barrier BB", %thenBB, %thenBB204
...
; <label>:84                                      ; preds = %._crit_edge7, %65
  ...
  br i1 %check.WI.iter207, label %thenBB204, label %SyncBB199

thenBB204:                                        ; preds = %84
  %"CurrWI++208" = add nuw i64 %CurrWI..3, 1
  %"loadedCurrSB+Stride210" = add nuw i64 %CurrSBIndex..3, 88
  %cond2 = icmp eq i32 %currBarrier.2, 1
  br i1 %cond2, label %SyncBB198, label %SyncBB

SyncBB199:                                        ; preds = %thenBB220, %thenBB212, %84
...
bb.nph:                                           ; preds = %104, %SyncBB199
  %CurrWI..6 = phi i64 [ %CurrWI..5, %104 ], [ %CurrWI..4, %SyncBB199 ]
  %CurrSBIndex..6 = phi i64 [ %CurrSBIndex..5, %104 ], [ %CurrSBIndex..4, %SyncBB199 ]
  ...
  br i1 %check.WI.iter215, label %thenBB212, label %SyncBB200
...
SyncBB200:                                        ; preds = %bb.nph, %thenBB212, %thenBB220
...
._crit_edge:                                      ; preds = %104, %SyncBB199
  %CurrWI..7 = phi i64 [ %CurrWI..4, %SyncBB199 ], [ %CurrWI..5, %104 ]
  %CurrSBIndex..7 = phi i64 [ %CurrSBIndex..4, %SyncBB199 ], [ %CurrSBIndex..5, %104 ]
  %currBarrier.6 = phi i32 [ %currBarrier.7, %SyncBB199 ], [ %currBarrier.4, %104 ]
  %check.WI.iter223 = icmp ult i64 %CurrWI..7, %iterCount
  br i1 %check.WI.iter223, label %thenBB220, label %SyncBB201
...
SyncBB201:                                        ; preds = %._crit_edge, %thenBB228
...
SyncBB.i:                                         ; preds = %thenBB204.i, %thenBB.i, %entry
  ...
  %currBarrier.3.i = phi i32 [ 7, %entry ], [ %currBarrier.2.i, %thenBB204.i ], [ %currBarrier.1.i, %thenBB.i ]
  br i1 %38, label %42, label %49

; <label>:42                                      ; preds = %SyncBB.i
...
; <label>:49                                      ; preds = %42, %SyncBB.i
  %bIndex.0.i = phi i32 [ %48, %42 ], [ %16, %SyncBB.i ]
...
"Barrier BB.i":                                   ; preds = %97, %bb.nph5.i
  ...
  br i1 %check.WI.iter.i, label %thenBB.i, label %SyncBB198.i

thenBB.i:                                         ; preds = %"Barrier BB.i"
  %"CurrWI++.i" = add nuw i64 %CurrWI..2.i, 1
  %"loadedCurrSB+Stride.i" = add nuw i64 %CurrSBIndex..2.i, 88
  %cond3.i = icmp eq i32 %currBarrier.1.i, 7
  br i1 %cond3.i, label %SyncBB.i, label %SyncBB198.i

SyncBB198.i:                                      ; preds = %thenBB204.i, %thenBB.i, %"Barrier BB.i"
...
; <label>:122                                     ; preds = %._crit_edge7.i, %103
  ...
  br i1 %check.WI.iter207.i, label %thenBB204.i, label %SyncBB199.i
...
thenBB204.i:                                      ; preds = %122
  ...
  br i1 %cond2.i, label %SyncBB198.i, label %SyncBB.i

SyncBB199.i:                                      ; preds = %thenBB220.i, %thenBB212.i, %122
...
bb.nph.i:                                         ; preds = %142, %SyncBB199.i
  %CurrWI..6.i = phi i64 [ %CurrWI..5.i, %142 ], [ %CurrWI..4.i, %SyncBB199.i ]
  %CurrSBIndex..6.i = phi i64 [ %CurrSBIndex..5.i, %142 ], [ %CurrSBIndex..4.i, %SyncBB199.i ]
  ...
  br i1 %check.WI.iter215.i, label %thenBB212.i, label %SyncBB200.i
...
SyncBB200.i:                                      ; preds = %thenBB220.i, %thenBB212.i, %bb.nph.i
...
._crit_edge.i:                                    ; preds = %142, %SyncBB199.i
  %CurrWI..7.i = phi i64 [ %CurrWI..4.i, %SyncBB199.i ], [ %CurrWI..5.i, %142 ]
  %CurrSBIndex..7.i = phi i64 [ %CurrSBIndex..4.i, %SyncBB199.i ], [ %CurrSBIndex..5.i, %142 ]
  %currBarrier.6.i = phi i32 [ %currBarrier.7.i, %SyncBB199.i ], [ %currBarrier.4.i, %142 ]
  %check.WI.iter223.i = icmp ult i64 %CurrWI..7.i, %34
  br i1 %check.WI.iter223.i, label %thenBB220.i, label %SyncBB201.i
...
SyncBB201.i:                                      ; preds = %thenBB228.i, %._crit_edge.i

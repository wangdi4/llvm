...
UnifiedReturnBlock:                               ; preds = %SyncBB, %25
...
SyncBB201:                                        ; preds = %thenBB204, %thenBB, %FirstBB
...
; <label>:11                                      ; preds = %4, %SyncBB201
  %bIndex.0 = phi i32 [ %10, %4 ], [ %baseIndex, %SyncBB201 ]
...
thenBB:                                           ; preds = %"Barrier BB"
  ...
  br i1 %cond3, label %SyncBB201, label %SyncBB
...
SyncBB:                                           ; preds = %"Barrier BB", %thenBB, %thenBB204
  ...
  %currBarrier.0 = phi i32 [ %currBarrier.1, %thenBB ], [ %currBarrier.2, %thenBB204 ], [ 1, %"Barrier BB" ]
...
thenBB204:                                        ; preds = %84
  ...
  %cond2 = icmp eq i32 %currBarrier.2, 1
  br i1 %cond2, label %SyncBB, label %SyncBB201
...
SyncBB198:                                        ; preds = %thenBB220, %thenBB212, %84
  ...
  %currBarrier.7 = phi i32 [ 2, %84 ], [ %currBarrier.6, %thenBB220 ], [ %currBarrier.5, %thenBB212 ]
...
thenBB212:                                        ; preds = %bb.nph
  ...
  %cond1 = icmp eq i32 %currBarrier.5, 3
...
SyncBB199:                                        ; preds = %bb.nph, %thenBB212, %thenBB220
  ...
  %currBarrier.4 = phi i32 [ %currBarrier.6, %thenBB220 ], [ %currBarrier.5, %thenBB212 ], [ 3, %bb.nph ]
...
thenBB220:                                        ; preds = %._crit_edge
  ...
  %cond = icmp eq i32 %currBarrier.6, 3
...
UnifiedReturnBlock:                               ; preds = %SyncBB200, %112
  ...
  br i1 %check.WI.iter231, label %thenBB228, label %SyncBB202
...
SyncBB202:                                        ; preds = %UnifiedReturnBlock
  ret void
}
...
SyncBB201.i:                                      ; preds = %thenBB204.i, %thenBB.i, %entry
...
; <label>:49                                      ; preds = %42, %SyncBB201.i
  %bIndex.0.i = phi i32 [ %48, %42 ], [ %16, %SyncBB201.i ]
...
thenBB.i:                                         ; preds = %"Barrier BB.i"
  ...
  br i1 %cond3.i, label %SyncBB201.i, label %SyncBB.i
...
SyncBB.i:                                         ; preds = %thenBB204.i, %thenBB.i, %"Barrier BB.i"
  ...
  %currBarrier.0.i = phi i32 [ %currBarrier.1.i, %thenBB.i ], [ %currBarrier.2.i, %thenBB204.i ], [ 1, %"Barrier BB.i" ]
...
thenBB204.i:                                      ; preds = %122
  ...
  %cond2.i = icmp eq i32 %currBarrier.2.i, 1
  br i1 %cond2.i, label %SyncBB.i, label %SyncBB201.i
...
SyncBB198.i:                                      ; preds = %thenBB220.i, %thenBB212.i, %122
  ...
  %currBarrier.7.i = phi i32 [ 2, %122 ], [ %currBarrier.6.i, %thenBB220.i ], [ %currBarrier.5.i, %thenBB212.i ]
...
thenBB212.i:                                      ; preds = %bb.nph.i
  ...
  %cond1.i = icmp eq i32 %currBarrier.5.i, 3
...
SyncBB199.i:                                      ; preds = %thenBB220.i, %thenBB212.i, %bb.nph.i
  ...
  %currBarrier.4.i = phi i32 [ %currBarrier.6.i, %thenBB220.i ], [ %currBarrier.5.i, %thenBB212.i ], [ 3, %bb.nph.i ]
...
thenBB220.i:                                      ; preds = %._crit_edge.i
  ...
  %cond.i = icmp eq i32 %currBarrier.6.i, 3
...
thenBB.i:                                         ; preds = %SyncBB7.i
  %"CurrWI++.i" = add nuw i64 %CurrWI..0.i, 1
  %"loadedCurrSB+Stride.i" = add nuw i64 %CurrSBIndex..0.i, 88
  br label %SyncBB7.i

elseBB.i:                                         ; preds = %SyncBB7.i
  %43 = sext i32 %7 to i64
  br label %SyncBB.i

SyncBB.i:                                         ; preds = %thenBB10.i, %elseBB.i
...
UnifiedReturnBlock.i:                             ; preds = %54, %SyncBB.i

...
SyncBB198:                                        ; preds = %thenBB227, %thenBB212, %84
  %CurrWI..4 = phi i64 [ 0, %84 ], [ %"CurrWI++231", %thenBB227 ], [ %"CurrWI++216", %thenBB212 ]
  %CurrSBIndex..4 = phi i64 [ 0, %84 ], [ %"loadedCurrSB+Stride233", %thenBB227 ], [ %"loadedCurrSB+Stride218", %thenBB212 ]
  %currBarrier.7 = phi i32 [ 3, %84 ], [ %currBarrier.6, %thenBB227 ], [ %currBarrier.5, %thenBB212 ]
...
SyncBB199:                                        ; preds = %bb.nph, %thenBB212, %thenBB227
  %CurrWI..5 = phi i64 [ %"CurrWI++231", %thenBB227 ], [ %"CurrWI++216", %thenBB212 ], [ 0, %bb.nph ]
  %CurrSBIndex..5 = phi i64 [ %"loadedCurrSB+Stride233", %thenBB227 ], [ %"loadedCurrSB+Stride218", %thenBB212 ], [ 0, %bb.nph ]
  %currBarrier.4 = phi i32 [ %currBarrier.6, %thenBB227 ], [ %currBarrier.5, %thenBB212 ], [ 4, %bb.nph ]
...
._crit_edge:                                      ; preds = %104, %SyncBB198
  ...
  %check.WI.iter230 = icmp ult i64 %CurrWI..7, %iterCount
  br i1 %check.WI.iter230, label %thenBB227, label %SyncBB201

thenBB227:                                        ; preds = %._crit_edge
  %"CurrWI++231" = add nuw i64 %CurrWI..7, 1
  %"loadedCurrSB+Stride233" = add nuw i64 %CurrSBIndex..7, 88
  %cond = icmp eq i32 %currBarrier.6, 4
  br i1 %cond, label %SyncBB199, label %SyncBB198

SyncBB201:                                        ; preds = %._crit_edge, %thenBB220
  %CurrWI..8 = phi i64 [ %"CurrWI++224", %thenBB220 ], [ 0, %._crit_edge ]
  %CurrSBIndex..8 = phi i64 [ %"loadedCurrSB+Stride226", %thenBB220 ], [ 0, %._crit_edge ]
...
UnifiedReturnBlock:                               ; preds = %SyncBB201, %112
  %check.WI.iter223 = icmp ult i64 %CurrWI..8, %iterCount
  br i1 %check.WI.iter223, label %thenBB220, label %SyncBB200

thenBB220:                                        ; preds = %UnifiedReturnBlock
  %"CurrWI++224" = add nuw i64 %CurrWI..8, 1
  %"loadedCurrSB+Stride226" = add nuw i64 %CurrSBIndex..8, 88
  br label %SyncBB201

SyncBB200:                                        ; preds = %UnifiedReturnBlock
  ret void
}
...
SyncBB198.i:                                      ; preds = %thenBB227.i, %thenBB212.i, %122
  %CurrWI..4.i = phi i64 [ 0, %122 ], [ %"CurrWI++231.i", %thenBB227.i ], [ %"CurrWI++216.i", %thenBB212.i ]
  %CurrSBIndex..4.i = phi i64 [ 0, %122 ], [ %"loadedCurrSB+Stride233.i", %thenBB227.i ], [ %"loadedCurrSB+Stride218.i", %thenBB212.i ]
  %currBarrier.7.i = phi i32 [ 3, %122 ], [ %currBarrier.6.i, %thenBB227.i ], [ %currBarrier.5.i, %thenBB212.i ]
...
SyncBB199.i:                                      ; preds = %thenBB227.i, %thenBB212.i, %bb.nph.i
  %CurrWI..5.i = phi i64 [ %"CurrWI++231.i", %thenBB227.i ], [ %"CurrWI++216.i", %thenBB212.i ], [ 0, %bb.nph.i ]
  %CurrSBIndex..5.i = phi i64 [ %"loadedCurrSB+Stride233.i", %thenBB227.i ], [ %"loadedCurrSB+Stride218.i", %thenBB212.i ], [ 0, %bb.nph.i ]
  %currBarrier.4.i = phi i32 [ %currBarrier.6.i, %thenBB227.i ], [ %currBarrier.5.i, %thenBB212.i ], [ 4, %bb.nph.i ]
...
thenBB227.i:                                      ; preds = %._crit_edge.i
  ...
  %"loadedCurrSB+Stride233.i" = add nuw i64 %CurrSBIndex..7.i, 88
  %cond.i = icmp eq i32 %currBarrier.6.i, 4
  br i1 %cond.i, label %SyncBB199.i, label %SyncBB198.i

SyncBB201.i:                                      ; preds = %thenBB220.i, %._crit_edge.i
  %CurrWI..8.i = phi i64 [ %"CurrWI++224.i", %thenBB220.i ], [ 0, %._crit_edge.i ]
  %CurrSBIndex..8.i = phi i64 [ %"loadedCurrSB+Stride226.i", %thenBB220.i ], [ 0, %._crit_edge.i ]
...
UnifiedReturnBlock.i:                             ; preds = %150, %SyncBB201.i
  %check.WI.iter223.i = icmp ult i64 %CurrWI..8.i, %34
  br i1 %check.WI.iter223.i, label %thenBB220.i, label %__scan_separated_args.exit

thenBB220.i:                                      ; preds = %UnifiedReturnBlock.i
  %"CurrWI++224.i" = add nuw i64 %CurrWI..8.i, 1
  %"loadedCurrSB+Stride226.i" = add nuw i64 %CurrSBIndex..8.i, 88

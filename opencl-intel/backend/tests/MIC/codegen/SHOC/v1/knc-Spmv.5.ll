...
; <label>:0
  ...
  br label %SyncBB156.outer

SyncBB156.outer:                                  ; preds = %0, %thenBB182
  %CurrWI..4.ph = phi i64 [ %"CurrWI++186", %thenBB182 ], [ 0, %0 ]
  %CurrSBIndex..4.ph = phi i64 [ %"loadedCurrSB+Stride188", %thenBB182 ], [ 0, %0 ]
  %currBarrier.3.ph = phi i32 [ %currBarrier.2, %thenBB182 ], [ 9, %0 ]
  br label %SyncBB156

SyncBB156:                                        ; preds = %thenBB168, %SyncBB156.outer
  %CurrWI..4 = phi i64 [ %"CurrWI++172", %thenBB168 ], [ %CurrWI..4.ph, %SyncBB156.outer ]
  %CurrSBIndex..4 = phi i64 [ %"loadedCurrSB+Stride174", %thenBB168 ], [ %CurrSBIndex..4.ph, %SyncBB156.outer ]
...
SyncBB159:                                        ; preds = %82, %thenBB182
  %CurrWI..1 = phi i64 [ %"CurrWI++186", %thenBB182 ], [ 0, %82 ]
  %CurrSBIndex..1 = phi i64 [ %"loadedCurrSB+Stride188", %thenBB182 ], [ 0, %82 ]
  %currBarrier.0 = phi i32 [ %currBarrier.2, %thenBB182 ], [ 7, %82 ]
...
UnifiedReturnBlock:                               ; preds = %SyncBB159, %SyncBB156, %83
  %CurrWI..3 = phi i64 [ %CurrWI..1, %83 ], [ %CurrWI..1, %SyncBB159 ], [ %CurrWI..4, %SyncBB156 ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..1, %83 ], [ %CurrSBIndex..1, %SyncBB159 ], [ %CurrSBIndex..4, %SyncBB156 ]
  %currBarrier.2 = phi i32 [ %currBarrier.0, %83 ], [ %currBarrier.0, %SyncBB159 ], [ %currBarrier.3.ph, %SyncBB156 ]
  %check.WI.iter185 = icmp ult i64 %CurrWI..3, %iterCount
  br i1 %check.WI.iter185, label %thenBB182, label %SyncBB157

thenBB182:                                        ; preds = %UnifiedReturnBlock
  %"CurrWI++186" = add nuw i64 %CurrWI..3, 1
  %"loadedCurrSB+Stride188" = add nuw i64 %CurrSBIndex..3, 32
  %cond = icmp eq i32 %currBarrier.2, 9
  br i1 %cond, label %SyncBB156.outer, label %SyncBB159

SyncBB157:                                        ; preds = %UnifiedReturnBlock
  ret void
}
...
entry:
  ...
  br label %SyncBB156.outer.i

SyncBB156.outer.i:                                ; preds = %thenBB182.i, %entry
  %CurrWI..4.ph.i = phi i64 [ %"CurrWI++186.i", %thenBB182.i ], [ 0, %entry ]
  %CurrSBIndex..4.ph.i = phi i64 [ %"loadedCurrSB+Stride188.i", %thenBB182.i ], [ 0, %entry ]
  %currBarrier.3.ph.i = phi i32 [ %currBarrier.2.i, %thenBB182.i ], [ 9, %entry ]
  br label %SyncBB156.i

SyncBB156.i:                                      ; preds = %thenBB168.i, %SyncBB156.outer.i
  %CurrWI..4.i = phi i64 [ %"CurrWI++172.i", %thenBB168.i ], [ %CurrWI..4.ph.i, %SyncBB156.outer.i ]
  %CurrSBIndex..4.i = phi i64 [ %"loadedCurrSB+Stride174.i", %thenBB168.i ], [ %CurrSBIndex..4.ph.i, %SyncBB156.outer.i ]
...
SyncBB153.i:                                      ; preds = %thenBB189.i, %98
...
SyncBB159.i:                                      ; preds = %thenBB182.i, %116
  %CurrWI..1.i = phi i64 [ %"CurrWI++186.i", %thenBB182.i ], [ 0, %116 ]
  %CurrSBIndex..1.i = phi i64 [ %"loadedCurrSB+Stride188.i", %thenBB182.i ], [ 0, %116 ]
  %currBarrier.0.i = phi i32 [ %currBarrier.2.i, %thenBB182.i ], [ 7, %116 ]
...
UnifiedReturnBlock.i:                             ; preds = %117, %SyncBB159.i, %SyncBB156.i
  %CurrWI..3.i = phi i64 [ %CurrWI..1.i, %117 ], [ %CurrWI..1.i, %SyncBB159.i ], [ %CurrWI..4.i, %SyncBB156.i ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..1.i, %117 ], [ %CurrSBIndex..1.i, %SyncBB159.i ], [ %CurrSBIndex..4.i, %SyncBB156.i ]
  %currBarrier.2.i = phi i32 [ %currBarrier.0.i, %117 ], [ %currBarrier.0.i, %SyncBB159.i ], [ %currBarrier.3.ph.i, %SyncBB156.i ]
  %check.WI.iter185.i = icmp ult i64 %CurrWI..3.i, %31
  br i1 %check.WI.iter185.i, label %thenBB182.i, label %__spmv_csr_vector_kernel_separated_args.exit

thenBB182.i:                                      ; preds = %UnifiedReturnBlock.i
  %"CurrWI++186.i" = add nuw i64 %CurrWI..3.i, 1
  %"loadedCurrSB+Stride188.i" = add nuw i64 %CurrSBIndex..3.i, 32
  %cond.i = icmp eq i32 %currBarrier.2.i, 9
  br i1 %cond.i, label %SyncBB156.outer.i, label %SyncBB159.i

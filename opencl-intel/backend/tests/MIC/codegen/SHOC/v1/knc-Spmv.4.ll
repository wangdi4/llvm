...
UnifiedReturnBlock:                               ; preds = %SyncBB9, %._crit_edge
...
SyncBB156.outer:                                  ; preds = %0, %thenBB189
  %CurrWI..4.ph = phi i64 [ %"CurrWI++193", %thenBB189 ], [ 0, %0 ]
  %CurrSBIndex..4.ph = phi i64 [ %"loadedCurrSB+Stride195", %thenBB189 ], [ 0, %0 ]
  %currBarrier.3.ph = phi i32 [ %currBarrier.2, %thenBB189 ], [ 10, %0 ]
  br label %SyncBB156
...
SyncBB159:                                        ; preds = %82, %thenBB189
  %CurrWI..1 = phi i64 [ %"CurrWI++193", %thenBB189 ], [ 0, %82 ]
  %CurrSBIndex..1 = phi i64 [ %"loadedCurrSB+Stride195", %thenBB189 ], [ 0, %82 ]
  %currBarrier.0 = phi i32 [ %currBarrier.2, %thenBB189 ], [ 8, %82 ]
...
UnifiedReturnBlock:                               ; preds = %SyncBB159, %SyncBB156, %83
  ...
  %check.WI.iter192 = icmp ult i64 %CurrWI..3, %iterCount
  br i1 %check.WI.iter192, label %thenBB189, label %SyncBB158

thenBB189:                                        ; preds = %UnifiedReturnBlock
  %"CurrWI++193" = add nuw i64 %CurrWI..3, 1
  %"loadedCurrSB+Stride195" = add nuw i64 %CurrSBIndex..3, 32
...
UnifiedReturnBlock.i:                             ; preds = %._crit_edge.i, %SyncBB9.i
...
SyncBB156.outer.i:                                ; preds = %thenBB189.i, %entry
  %CurrWI..4.ph.i = phi i64 [ %"CurrWI++193.i", %thenBB189.i ], [ 0, %entry ]
  %CurrSBIndex..4.ph.i = phi i64 [ %"loadedCurrSB+Stride195.i", %thenBB189.i ], [ 0, %entry ]
  %currBarrier.3.ph.i = phi i32 [ %currBarrier.2.i, %thenBB189.i ], [ 10, %entry ]
...
SyncBB157.i:                                      ; preds = %thenBB196.i, %107
...
; <label>:116                                     ; preds = %109, %SyncBB157.i
...
SyncBB159.i:                                      ; preds = %thenBB189.i, %116
  %CurrWI..1.i = phi i64 [ %"CurrWI++193.i", %thenBB189.i ], [ 0, %116 ]
  %CurrSBIndex..1.i = phi i64 [ %"loadedCurrSB+Stride195.i", %thenBB189.i ], [ 0, %116 ]
  %currBarrier.0.i = phi i32 [ %currBarrier.2.i, %thenBB189.i ], [ 8, %116 ]
...
UnifiedReturnBlock.i:                             ; preds = %117, %SyncBB159.i, %SyncBB156.i
  ...
  %check.WI.iter192.i = icmp ult i64 %CurrWI..3.i, %31
  br i1 %check.WI.iter192.i, label %thenBB189.i, label %__spmv_csr_vector_kernel_separated_args.exit

thenBB189.i:                                      ; preds = %UnifiedReturnBlock.i
  %"CurrWI++193.i" = add nuw i64 %CurrWI..3.i, 1
  %"loadedCurrSB+Stride195.i" = add nuw i64 %CurrSBIndex..3.i, 32

...
; <label>:13                                      ; preds = %13, %SyncBB
  %s.03 = phi i32 [ %9, %SyncBB ], [ %79, %13 ]
  %j.02 = phi i32 [ 0, %SyncBB ], [ %77, %13 ]
...
._crit_edge:                                      ; preds = %89, %SyncBB23
  ...
  br i1 %check.WI.iter, label %thenBB, label %SyncBB22
...
SyncBB.i:                                         ; preds = %thenBB25.i, %entry
...
; <label>:33                                      ; preds = %33, %SyncBB.i
  %s.03.i = phi i32 [ %29, %SyncBB.i ], [ %99, %33 ]
  %j.02.i = phi i32 [ 0, %SyncBB.i ], [ %97, %33 ]

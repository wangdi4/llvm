...
.critedge.preheader:                              ; preds = %25, %SyncBB50
  %j.0.lcssa = phi i32 [ 0, %SyncBB50 ], [ %tmp31, %25 ]
  %24 = icmp slt i32 %j.0.lcssa, %17
  br i1 %24, label %bb.nph6, label %bb.nph

bb.nph9:                                          ; preds = %SyncBB50
  %tmp22 = sub i32 0, %17
  %tmp28 = add i32 %19, %18
...
bb.nph:                                           ; preds = %.critedge, %.critedge.preheader
  ...
  br i1 %check.WI.iter55, label %thenBB52, label %SyncBB49
...
; <label>:35                                      ; preds = %35, %SyncBB49
  %s.03 = phi i32 [ %loadedValue48, %SyncBB49 ], [ %133, %35 ]
  %sum.02 = phi float [ 0.000000e+00, %SyncBB49 ], [ %130, %35 ]
  %j.21 = phi i32 [ 0, %SyncBB49 ], [ %131, %35 ]
...
SyncBB50.i:                                       ; preds = %thenBB52.i, %entry
...
.critedge.preheader.i:                            ; preds = %53, %SyncBB50.i
  %j.0.lcssa.i = phi i32 [ 0, %SyncBB50.i ], [ %tmp31.i, %53 ]
  %52 = icmp slt i32 %j.0.lcssa.i, %45
  br i1 %52, label %bb.nph6.i, label %bb.nph.i

bb.nph9.i:                                        ; preds = %SyncBB50.i
...
bb.nph.i:                                         ; preds = %.critedge.i, %.critedge.preheader.i
  ...
  br i1 %check.WI.iter55.i, label %thenBB52.i, label %SyncBB49.i
...
SyncBB49.i:                                       ; preds = %thenBB.i, %bb.nph.i
...
; <label>:63                                      ; preds = %63, %SyncBB49.i
  %s.03.i = phi i32 [ %loadedValue48.i, %SyncBB49.i ], [ %161, %63 ]
  %sum.02.i = phi float [ 0.000000e+00, %SyncBB49.i ], [ %158, %63 ]
  %j.21.i = phi i32 [ 0, %SyncBB49.i ], [ %159, %63 ]

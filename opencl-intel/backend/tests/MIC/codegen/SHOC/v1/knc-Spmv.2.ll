...
; <label>:0
  ...
  br label %SyncBB157.outer

SyncBB157.outer:                                  ; preds = %0, %thenBB189
  %CurrWI..4.ph = phi i64 [ %"CurrWI++193", %thenBB189 ], [ 0, %0 ]
  %CurrSBIndex..4.ph = phi i64 [ %"loadedCurrSB+Stride195", %thenBB189 ], [ 0, %0 ]
  %currBarrier.3.ph = phi i32 [ %currBarrier.2, %thenBB189 ], [ 11, %0 ]
  br label %SyncBB157

SyncBB157:                                        ; preds = %thenBB168, %SyncBB157.outer
  %CurrWI..4 = phi i64 [ %"CurrWI++172", %thenBB168 ], [ %CurrWI..4.ph, %SyncBB157.outer ]
  %CurrSBIndex..4 = phi i64 [ %"loadedCurrSB+Stride174", %thenBB168 ], [ %CurrSBIndex..4.ph, %SyncBB157.outer ]
...
UnifiedReturnBlock:                               ; preds = %SyncBB159, %SyncBB157, %83
  %CurrWI..3 = phi i64 [ %CurrWI..1, %83 ], [ %CurrWI..1, %SyncBB159 ], [ %CurrWI..4, %SyncBB157 ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..1, %83 ], [ %CurrSBIndex..1, %SyncBB159 ], [ %CurrSBIndex..4, %SyncBB157 ]
  %currBarrier.2 = phi i32 [ %currBarrier.0, %83 ], [ %currBarrier.0, %SyncBB159 ], [ %currBarrier.3.ph, %SyncBB157 ]
...
thenBB189:                                        ; preds = %UnifiedReturnBlock
  ...
  br i1 %cond, label %SyncBB157.outer, label %SyncBB159
...
entry:
  ...
  br label %SyncBB157.outer.i

SyncBB157.outer.i:                                ; preds = %thenBB189.i, %entry
  ...
  %currBarrier.3.ph.i = phi i32 [ %currBarrier.2.i, %thenBB189.i ], [ 11, %entry ]
  br label %SyncBB157.i

SyncBB157.i:                                      ; preds = %thenBB168.i, %SyncBB157.outer.i
  %CurrWI..4.i = phi i64 [ %"CurrWI++172.i", %thenBB168.i ], [ %CurrWI..4.ph.i, %SyncBB157.outer.i ]
  %CurrSBIndex..4.i = phi i64 [ %"loadedCurrSB+Stride174.i", %thenBB168.i ], [ %CurrSBIndex..4.ph.i, %SyncBB157.outer.i ]
...
SyncBB156.i:                                      ; preds = %thenBB196.i, %107
...
UnifiedReturnBlock.i:                             ; preds = %117, %SyncBB159.i, %SyncBB157.i
  %CurrWI..3.i = phi i64 [ %CurrWI..1.i, %117 ], [ %CurrWI..1.i, %SyncBB159.i ], [ %CurrWI..4.i, %SyncBB157.i ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..1.i, %117 ], [ %CurrSBIndex..1.i, %SyncBB159.i ], [ %CurrSBIndex..4.i, %SyncBB157.i ]
  %currBarrier.2.i = phi i32 [ %currBarrier.0.i, %117 ], [ %currBarrier.0.i, %SyncBB159.i ], [ %currBarrier.3.ph.i, %SyncBB157.i ]
...
thenBB189.i:                                      ; preds = %UnifiedReturnBlock.i
  ...
  br i1 %cond.i, label %SyncBB157.outer.i, label %SyncBB159.i

...
SyncBB8:                                          ; preds = %thenBB10, %FirstBB
  %CurrSBIndex..1 = phi i64 [ 0, %FirstBB ], [ %"loadedCurrSB+Stride16", %thenBB10 ]
  %CurrWI..1 = phi i64 [ 0, %FirstBB ], [ %"CurrWI++14", %thenBB10 ]
  ...
  br i1 %check.WI.iter13, label %thenBB10, label %elseBB11

thenBB10:                                         ; preds = %SyncBB8
  %"CurrWI++14" = add nuw i64 %CurrWI..1, 1
  %"loadedCurrSB+Stride16" = add nuw i64 %CurrSBIndex..1, 88
  br label %SyncBB8

elseBB11:                                         ; preds = %SyncBB8
  %14 = sext i32 %n to i64
  br label %SyncBB7

SyncBB7:                                          ; preds = %thenBB, %elseBB11
  %CurrSBIndex..0 = phi i64 [ 0, %elseBB11 ], [ %"loadedCurrSB+Stride", %thenBB ]
  %CurrWI..0 = phi i64 [ 0, %elseBB11 ], [ %"CurrWI++", %thenBB ]
...
SyncBB202:                                        ; preds = %thenBB204, %thenBB, %FirstBB
  %CurrWI..0 = phi i64 [ 0, %FirstBB ], [ %"CurrWI++208", %thenBB204 ], [ %"CurrWI++", %thenBB ]
  %CurrSBIndex..0 = phi i64 [ 0, %FirstBB ], [ %"loadedCurrSB+Stride210", %thenBB204 ], [ %"loadedCurrSB+Stride", %thenBB ]
  %currBarrier.3 = phi i32 [ 8, %FirstBB ], [ %currBarrier.2, %thenBB204 ], [ %currBarrier.1, %thenBB ]
...
; <label>:11                                      ; preds = %4, %SyncBB202
  ...
  %"&(pSB[currWI].offset)" = add nuw i64 %CurrSBIndex..0, 8
  ...
  %"&(pSB[currWI].offset)29" = add nuw i64 %CurrSBIndex..0, 12
  ...
  %"&(pSB[currWI].offset)62" = add nuw i64 %CurrSBIndex..0, 24
  ...
  %"&(pSB[currWI].offset)71" = add nuw i64 %CurrSBIndex..0, 32
  ...
  %"&(pSB[currWI].offset)80" = add nuw i64 %CurrSBIndex..0, 40
...
; <label>:31                                      ; preds = %11
  %"&(pSB[currWI].offset)33" = add nuw i64 %CurrSBIndex..0, 12
...
; <label>:37                                      ; preds = %11
  %"&(pSB[currWI].offset)52" = add nuw i64 %CurrSBIndex..0, 16
...
bb.nph5:                                          ; preds = %40
  %"&(pSB[currWI].offset)10" = add nuw i64 %CurrSBIndex..0, 8
  ...
  %"&(pSB[currWI].offset)89" = add nuw i64 %CurrSBIndex..0, 44
...
"Barrier BB":                                     ; preds = %59, %bb.nph5
  %CurrWI..2 = phi i64 [ %CurrWI..0, %bb.nph5 ], [ %CurrWI..1, %59 ]
  %CurrSBIndex..2 = phi i64 [ %CurrSBIndex..0, %bb.nph5 ], [ %CurrSBIndex..1, %59 ]
  ...
  %"&(pSB[currWI].offset)112" = add nuw i64 %CurrSBIndex..2, 52
  ...
  %"&(pSB[currWI].offset)98" = add nuw i64 %CurrSBIndex..2, 48
...
thenBB:                                           ; preds = %"Barrier BB"
  ...
  %"loadedCurrSB+Stride" = add nuw i64 %CurrSBIndex..2, 88
  %cond3 = icmp eq i32 %currBarrier.1, 8
  br i1 %cond3, label %SyncBB202, label %SyncBB

SyncBB:                                           ; preds = %"Barrier BB", %thenBB, %thenBB204
  %CurrWI..1 = phi i64 [ %"CurrWI++", %thenBB ], [ %"CurrWI++208", %thenBB204 ], [ 0, %"Barrier BB" ]
  %CurrSBIndex..1 = phi i64 [ %"loadedCurrSB+Stride", %thenBB ], [ %"loadedCurrSB+Stride210", %thenBB204 ], [ 0, %"Barrier BB" ]
  %currBarrier.0 = phi i32 [ %currBarrier.1, %thenBB ], [ %currBarrier.2, %thenBB204 ], [ 2, %"Barrier BB" ]
  %"&(pSB[currWI].offset)19" = add nuw i64 %CurrSBIndex..1, 8
  ...
  %"&(pSB[currWI].offset)102" = add nuw i64 %CurrSBIndex..1, 48
...
; <label>:47                                      ; preds = %SyncBB
  %"&(pSB[currWI].offset)93" = add nuw i64 %CurrSBIndex..1, 44
  ...
  %"&(pSB[currWI].offset)121" = add nuw i64 %CurrSBIndex..1, 52
  ...
  %"&(pSB[currWI].offset)126" = add nuw i64 %CurrSBIndex..1, 52
  ...
  %50 = add i32 %49, %48
  %"&(pSB[currWI].offset)131" = add nuw i64 %CurrSBIndex..1, 52
...
; <label>:59                                      ; preds = %47, %SyncBB
  %"&(pSB[currWI].offset)116" = add nuw i64 %CurrSBIndex..1, 52
  ...
  %"&(pSB[currWI].offset)136" = add nuw i64 %CurrSBIndex..1, 56
  ...
  %"&(pSB[currWI].offset)107" = add nuw i64 %CurrSBIndex..1, 48
  ...
  %"&(pSB[currWI].offset)140" = add nuw i64 %CurrSBIndex..1, 60
...
._crit_edge6:                                     ; preds = %59, %40
  %CurrWI..3 = phi i64 [ %CurrWI..1, %59 ], [ %CurrWI..0, %40 ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..1, %59 ], [ %CurrSBIndex..0, %40 ]
  %currBarrier.2 = phi i32 [ %currBarrier.0, %59 ], [ %currBarrier.3, %40 ]
  %stride.0.lcssa = phi i32 [ %60, %59 ], [ 1, %40 ]
  %"&(pSB[currWI].offset)144" = add nuw i64 %CurrSBIndex..3, 64
...
; <label>:65                                      ; preds = %._crit_edge6, %63
  ...
  %67 = getelementptr %struct.PaddedDimId* %pLocalIds, i64 %CurrWI..3, i32 0, i64 0
...
thenBB204:                                        ; preds = %84
  ...
  br i1 %cond2, label %SyncBB, label %SyncBB202

SyncBB198:                                        ; preds = %thenBB220, %thenBB212, %84
  %CurrWI..4 = phi i64 [ 0, %84 ], [ %"CurrWI++224", %thenBB220 ], [ %"CurrWI++216", %thenBB212 ]
  %CurrSBIndex..4 = phi i64 [ 0, %84 ], [ %"loadedCurrSB+Stride226", %thenBB220 ], [ %"loadedCurrSB+Stride218", %thenBB212 ]
  %currBarrier.7 = phi i32 [ 3, %84 ], [ %currBarrier.6, %thenBB220 ], [ %currBarrier.5, %thenBB212 ]
  %85 = getelementptr %struct.WorkDim* %pWorkDim, i64 0, i32 3, i64 0
  %86 = load i64* %85, align 8
  %87 = icmp eq i64 %86, 0
  %"&(pSB[currWI].offset)148" = add nuw i64 %CurrSBIndex..4, 64
  br i1 %87, label %._crit_edge, label %bb.nph

bb.nph:                                           ; preds = %104, %SyncBB198
  %CurrWI..6 = phi i64 [ %CurrWI..5, %104 ], [ %CurrWI..4, %SyncBB198 ]
  %CurrSBIndex..6 = phi i64 [ %CurrSBIndex..5, %104 ], [ %CurrSBIndex..4, %SyncBB198 ]
  %currBarrier.5 = phi i32 [ %currBarrier.4, %104 ], [ %currBarrier.7, %SyncBB198 ]
  %d1.02 = phi i32 [ %105, %104 ], [ 1, %SyncBB198 ]
  %"&(pSB[currWI].offset)180.pn" = phi i64 [ %"&(pSB[currWI].offset)180", %104 ], [ %"&(pSB[currWI].offset)148", %SyncBB198 ]
  ...
  %"&(pSB[currWI].offset)167" = add nuw i64 %CurrSBIndex..6, 72
  ...
  %"&(pSB[currWI].offset)153" = add nuw i64 %CurrSBIndex..6, 68
  ...
  %"&(pSB[currWI].offset)176" = add nuw i64 %CurrSBIndex..6, 76
  ...
  %check.WI.iter215 = icmp ult i64 %CurrWI..6, %iterCount
  br i1 %check.WI.iter215, label %thenBB212, label %SyncBB199

thenBB212:                                        ; preds = %bb.nph
  %"CurrWI++216" = add nuw i64 %CurrWI..6, 1
  %"loadedCurrSB+Stride218" = add nuw i64 %CurrSBIndex..6, 88
  %cond1 = icmp eq i32 %currBarrier.5, 4
  br i1 %cond1, label %SyncBB199, label %SyncBB198

SyncBB199:                                        ; preds = %bb.nph, %thenBB212, %thenBB220
  %CurrWI..5 = phi i64 [ %"CurrWI++224", %thenBB220 ], [ %"CurrWI++216", %thenBB212 ], [ 0, %bb.nph ]
  %CurrSBIndex..5 = phi i64 [ %"loadedCurrSB+Stride226", %thenBB220 ], [ %"loadedCurrSB+Stride218", %thenBB212 ], [ 0, %bb.nph ]
  %currBarrier.4 = phi i32 [ %currBarrier.6, %thenBB220 ], [ %currBarrier.5, %thenBB212 ], [ 4, %bb.nph ]
  %"&(pSB[currWI].offset)24" = add nuw i64 %CurrSBIndex..5, 8
  ...
  %"&(pSB[currWI].offset)157" = add nuw i64 %CurrSBIndex..5, 68
...
; <label>:90                                      ; preds = %SyncBB199
  %"&(pSB[currWI].offset)171" = add nuw i64 %CurrSBIndex..5, 72
  ...
  %"&(pSB[currWI].offset)14" = add nuw i64 %CurrSBIndex..5, 8
  ...
  %"&(pSB[currWI].offset)190" = add nuw i64 %CurrSBIndex..5, 76
  ...
  %94 = add i32 %93, %92
  %"&(pSB[currWI].offset)185" = add nuw i64 %CurrSBIndex..5, 76
...
; <label>:104                                     ; preds = %90, %SyncBB199
  %"&(pSB[currWI].offset)162" = add nuw i64 %CurrSBIndex..5, 68
  ...
  %"&(pSB[currWI].offset)195" = add nuw i64 %CurrSBIndex..5, 80
  ...
  %"&(pSB[currWI].offset)180" = add nuw i64 %CurrSBIndex..5, 76
  br i1 %109, label %._crit_edge, label %bb.nph

._crit_edge:                                      ; preds = %104, %SyncBB198
  %CurrWI..7 = phi i64 [ %CurrWI..4, %SyncBB198 ], [ %CurrWI..5, %104 ]
  %CurrSBIndex..7 = phi i64 [ %CurrSBIndex..4, %SyncBB198 ], [ %CurrSBIndex..5, %104 ]
  %currBarrier.6 = phi i32 [ %currBarrier.7, %SyncBB198 ], [ %currBarrier.4, %104 ]
  %check.WI.iter223 = icmp ult i64 %CurrWI..7, %iterCount
  br i1 %check.WI.iter223, label %thenBB220, label %SyncBB200

thenBB220:                                        ; preds = %._crit_edge
  %"CurrWI++224" = add nuw i64 %CurrWI..7, 1
  %"loadedCurrSB+Stride226" = add nuw i64 %CurrSBIndex..7, 88
  %cond = icmp eq i32 %currBarrier.6, 4
  br i1 %cond, label %SyncBB199, label %SyncBB198

SyncBB200:                                        ; preds = %._crit_edge, %thenBB228
  %CurrWI..8 = phi i64 [ %"CurrWI++232", %thenBB228 ], [ 0, %._crit_edge ]
  %CurrSBIndex..8 = phi i64 [ %"loadedCurrSB+Stride234", %thenBB228 ], [ 0, %._crit_edge ]
  %"&(pSB[currWI].offset)75" = add nuw i64 %CurrSBIndex..8, 32
  ...
  %"&(pSB[currWI].offset)66" = add nuw i64 %CurrSBIndex..8, 24
  ...
  %"&(pSB[currWI].offset)84" = add nuw i64 %CurrSBIndex..8, 40
...
; <label>:112                                     ; preds = %SyncBB200
  %"&(pSB[currWI].offset)57" = add nuw i64 %CurrSBIndex..8, 16
  ...
  %"&(pSB[currWI].offset)38" = add nuw i64 %CurrSBIndex..8, 12
...
UnifiedReturnBlock:                               ; preds = %SyncBB200, %112
  %check.WI.iter231 = icmp ult i64 %CurrWI..8, %iterCount
  br i1 %check.WI.iter231, label %thenBB228, label %SyncBB201

thenBB228:                                        ; preds = %UnifiedReturnBlock
  %"CurrWI++232" = add nuw i64 %CurrWI..8, 1
  %"loadedCurrSB+Stride234" = add nuw i64 %CurrSBIndex..8, 88
  br label %SyncBB200

SyncBB201:                                        ; preds = %UnifiedReturnBlock
  ret void
}
...
SyncBB202.i:                                      ; preds = %thenBB204.i, %thenBB.i, %entry
  %CurrWI..0.i = phi i64 [ 0, %entry ], [ %"CurrWI++208.i", %thenBB204.i ], [ %"CurrWI++.i", %thenBB.i ]
  %CurrSBIndex..0.i = phi i64 [ 0, %entry ], [ %"loadedCurrSB+Stride210.i", %thenBB204.i ], [ %"loadedCurrSB+Stride.i", %thenBB.i ]
  %currBarrier.3.i = phi i32 [ 8, %entry ], [ %currBarrier.2.i, %thenBB204.i ], [ %currBarrier.1.i, %thenBB.i ]
...
; <label>:49                                      ; preds = %42, %SyncBB202.i
  ...
  %50 = getelementptr %struct.PaddedDimId* %31, i64 %CurrWI..0.i, i32 0, i64 0
  %51 = load i64* %50, align 8
  %52 = trunc i64 %51 to i32
  %"&(pSB[currWI].offset).i" = add nuw i64 %CurrSBIndex..0.i, 8
  ...
  %"&(pSB[currWI].offset)29.i" = add nuw i64 %CurrSBIndex..0.i, 12
  ...
  %"&(pSB[currWI].offset)62.i" = add nuw i64 %CurrSBIndex..0.i, 24
  ...
  %"&(pSB[currWI].offset)71.i" = add nuw i64 %CurrSBIndex..0.i, 32
  ...
  %"&(pSB[currWI].offset)80.i" = add nuw i64 %CurrSBIndex..0.i, 40
...
; <label>:69                                      ; preds = %49
  %"&(pSB[currWI].offset)33.i" = add nuw i64 %CurrSBIndex..0.i, 12
...
; <label>:75                                      ; preds = %49
  %"&(pSB[currWI].offset)52.i" = add nuw i64 %CurrSBIndex..0.i, 16
...
bb.nph5.i:                                        ; preds = %78
  %"&(pSB[currWI].offset)10.i" = add nuw i64 %CurrSBIndex..0.i, 8
  ...
  %"&(pSB[currWI].offset)89.i" = add nuw i64 %CurrSBIndex..0.i, 44
...
"Barrier BB.i":                                   ; preds = %97, %bb.nph5.i
  %CurrWI..2.i = phi i64 [ %CurrWI..0.i, %bb.nph5.i ], [ %CurrWI..1.i, %97 ]
  %CurrSBIndex..2.i = phi i64 [ %CurrSBIndex..0.i, %bb.nph5.i ], [ %CurrSBIndex..1.i, %97 ]
  ...
  %"&(pSB[currWI].offset)112.i" = add nuw i64 %CurrSBIndex..2.i, 52
  ...
  %"&(pSB[currWI].offset)98.i" = add nuw i64 %CurrSBIndex..2.i, 48
...
thenBB.i:                                         ; preds = %"Barrier BB.i"
  ...
  %"loadedCurrSB+Stride.i" = add nuw i64 %CurrSBIndex..2.i, 88
  %cond3.i = icmp eq i32 %currBarrier.1.i, 8
  br i1 %cond3.i, label %SyncBB202.i, label %SyncBB.i

SyncBB.i:                                         ; preds = %thenBB204.i, %thenBB.i, %"Barrier BB.i"
  %CurrWI..1.i = phi i64 [ %"CurrWI++.i", %thenBB.i ], [ %"CurrWI++208.i", %thenBB204.i ], [ 0, %"Barrier BB.i" ]
  %CurrSBIndex..1.i = phi i64 [ %"loadedCurrSB+Stride.i", %thenBB.i ], [ %"loadedCurrSB+Stride210.i", %thenBB204.i ], [ 0, %"Barrier BB.i" ]
  %currBarrier.0.i = phi i32 [ %currBarrier.1.i, %thenBB.i ], [ %currBarrier.2.i, %thenBB204.i ], [ 2, %"Barrier BB.i" ]
  %"&(pSB[currWI].offset)19.i" = add nuw i64 %CurrSBIndex..1.i, 8
  ...
  %"&(pSB[currWI].offset)102.i" = add nuw i64 %CurrSBIndex..1.i, 48
...
; <label>:85                                      ; preds = %SyncBB.i
  %"&(pSB[currWI].offset)93.i" = add nuw i64 %CurrSBIndex..1.i, 44
  ...
  %"&(pSB[currWI].offset)121.i" = add nuw i64 %CurrSBIndex..1.i, 52
  ...
  %"&(pSB[currWI].offset)126.i" = add nuw i64 %CurrSBIndex..1.i, 52
  ...
  %88 = add i32 %87, %86
  %"&(pSB[currWI].offset)131.i" = add nuw i64 %CurrSBIndex..1.i, 52
...
; <label>:97                                      ; preds = %85, %SyncBB.i
  %"&(pSB[currWI].offset)116.i" = add nuw i64 %CurrSBIndex..1.i, 52
  ...
  %"&(pSB[currWI].offset)136.i" = add nuw i64 %CurrSBIndex..1.i, 56
  ...
  %"&(pSB[currWI].offset)107.i" = add nuw i64 %CurrSBIndex..1.i, 48
  ...
  %"&(pSB[currWI].offset)140.i" = add nuw i64 %CurrSBIndex..1.i, 60
...
._crit_edge6.i:                                   ; preds = %97, %78
  %CurrWI..3.i = phi i64 [ %CurrWI..1.i, %97 ], [ %CurrWI..0.i, %78 ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..1.i, %97 ], [ %CurrSBIndex..0.i, %78 ]
  %currBarrier.2.i = phi i32 [ %currBarrier.0.i, %97 ], [ %currBarrier.3.i, %78 ]
  %stride.0.lcssa.i = phi i32 [ %98, %97 ], [ 1, %78 ]
  %"&(pSB[currWI].offset)144.i" = add nuw i64 %CurrSBIndex..3.i, 64
...
; <label>:103                                     ; preds = %101, %._crit_edge6.i
  ...
  %105 = getelementptr %struct.PaddedDimId* %31, i64 %CurrWI..3.i, i32 0, i64 0
...
thenBB204.i:                                      ; preds = %122
  ...
  br i1 %cond2.i, label %SyncBB.i, label %SyncBB202.i

SyncBB198.i:                                      ; preds = %thenBB220.i, %thenBB212.i, %122
  %CurrWI..4.i = phi i64 [ 0, %122 ], [ %"CurrWI++224.i", %thenBB220.i ], [ %"CurrWI++216.i", %thenBB212.i ]
  %CurrSBIndex..4.i = phi i64 [ 0, %122 ], [ %"loadedCurrSB+Stride226.i", %thenBB220.i ], [ %"loadedCurrSB+Stride218.i", %thenBB212.i ]
  %currBarrier.7.i = phi i32 [ 3, %122 ], [ %currBarrier.6.i, %thenBB220.i ], [ %currBarrier.5.i, %thenBB212.i ]
  %123 = getelementptr %struct.WorkDim* %25, i64 0, i32 3, i64 0
  %124 = load i64* %123, align 8
  %125 = icmp eq i64 %124, 0
  %"&(pSB[currWI].offset)148.i" = add nuw i64 %CurrSBIndex..4.i, 64
  br i1 %125, label %._crit_edge.i, label %bb.nph.i

bb.nph.i:                                         ; preds = %142, %SyncBB198.i
  %CurrWI..6.i = phi i64 [ %CurrWI..5.i, %142 ], [ %CurrWI..4.i, %SyncBB198.i ]
  %CurrSBIndex..6.i = phi i64 [ %CurrSBIndex..5.i, %142 ], [ %CurrSBIndex..4.i, %SyncBB198.i ]
  %currBarrier.5.i = phi i32 [ %currBarrier.4.i, %142 ], [ %currBarrier.7.i, %SyncBB198.i ]
  %d1.02.i = phi i32 [ %143, %142 ], [ 1, %SyncBB198.i ]
  %"&(pSB[currWI].offset)180.pn.i" = phi i64 [ %"&(pSB[currWI].offset)180.i", %142 ], [ %"&(pSB[currWI].offset)148.i", %SyncBB198.i ]
  ...
  %"&(pSB[currWI].offset)167.i" = add nuw i64 %CurrSBIndex..6.i, 72
  ...
  %"&(pSB[currWI].offset)153.i" = add nuw i64 %CurrSBIndex..6.i, 68
  ...
  %"&(pSB[currWI].offset)176.i" = add nuw i64 %CurrSBIndex..6.i, 76
  ...
  %check.WI.iter215.i = icmp ult i64 %CurrWI..6.i, %34
  br i1 %check.WI.iter215.i, label %thenBB212.i, label %SyncBB199.i

thenBB212.i:                                      ; preds = %bb.nph.i
  %"CurrWI++216.i" = add nuw i64 %CurrWI..6.i, 1
  %"loadedCurrSB+Stride218.i" = add nuw i64 %CurrSBIndex..6.i, 88
  %cond1.i = icmp eq i32 %currBarrier.5.i, 4
  br i1 %cond1.i, label %SyncBB199.i, label %SyncBB198.i

SyncBB199.i:                                      ; preds = %thenBB220.i, %thenBB212.i, %bb.nph.i
  %CurrWI..5.i = phi i64 [ %"CurrWI++224.i", %thenBB220.i ], [ %"CurrWI++216.i", %thenBB212.i ], [ 0, %bb.nph.i ]
  %CurrSBIndex..5.i = phi i64 [ %"loadedCurrSB+Stride226.i", %thenBB220.i ], [ %"loadedCurrSB+Stride218.i", %thenBB212.i ], [ 0, %bb.nph.i ]
  %currBarrier.4.i = phi i32 [ %currBarrier.6.i, %thenBB220.i ], [ %currBarrier.5.i, %thenBB212.i ], [ 4, %bb.nph.i ]
  %"&(pSB[currWI].offset)24.i" = add nuw i64 %CurrSBIndex..5.i, 8
  ...
  %"&(pSB[currWI].offset)157.i" = add nuw i64 %CurrSBIndex..5.i, 68
...
; <label>:128                                     ; preds = %SyncBB199.i
  %"&(pSB[currWI].offset)171.i" = add nuw i64 %CurrSBIndex..5.i, 72
  ...
  %"&(pSB[currWI].offset)14.i" = add nuw i64 %CurrSBIndex..5.i, 8
  ...
  %"&(pSB[currWI].offset)190.i" = add nuw i64 %CurrSBIndex..5.i, 76
  ...
  %132 = add i32 %131, %130
  %"&(pSB[currWI].offset)185.i" = add nuw i64 %CurrSBIndex..5.i, 76
...
; <label>:142                                     ; preds = %128, %SyncBB199.i
  %"&(pSB[currWI].offset)162.i" = add nuw i64 %CurrSBIndex..5.i, 68
  ...
  %"&(pSB[currWI].offset)195.i" = add nuw i64 %CurrSBIndex..5.i, 80
  ...
  %"&(pSB[currWI].offset)180.i" = add nuw i64 %CurrSBIndex..5.i, 76
  br i1 %147, label %._crit_edge.i, label %bb.nph.i

._crit_edge.i:                                    ; preds = %142, %SyncBB198.i
  %CurrWI..7.i = phi i64 [ %CurrWI..4.i, %SyncBB198.i ], [ %CurrWI..5.i, %142 ]
  %CurrSBIndex..7.i = phi i64 [ %CurrSBIndex..4.i, %SyncBB198.i ], [ %CurrSBIndex..5.i, %142 ]
  %currBarrier.6.i = phi i32 [ %currBarrier.7.i, %SyncBB198.i ], [ %currBarrier.4.i, %142 ]
  %check.WI.iter223.i = icmp ult i64 %CurrWI..7.i, %34
  br i1 %check.WI.iter223.i, label %thenBB220.i, label %SyncBB200.i

thenBB220.i:                                      ; preds = %._crit_edge.i
  %"CurrWI++224.i" = add nuw i64 %CurrWI..7.i, 1
  %"loadedCurrSB+Stride226.i" = add nuw i64 %CurrSBIndex..7.i, 88
  %cond.i = icmp eq i32 %currBarrier.6.i, 4
  br i1 %cond.i, label %SyncBB199.i, label %SyncBB198.i

SyncBB200.i:                                      ; preds = %thenBB228.i, %._crit_edge.i
  %CurrWI..8.i = phi i64 [ %"CurrWI++232.i", %thenBB228.i ], [ 0, %._crit_edge.i ]
  %CurrSBIndex..8.i = phi i64 [ %"loadedCurrSB+Stride234.i", %thenBB228.i ], [ 0, %._crit_edge.i ]
  %"&(pSB[currWI].offset)75.i" = add nuw i64 %CurrSBIndex..8.i, 32
  ...
  %"&(pSB[currWI].offset)66.i" = add nuw i64 %CurrSBIndex..8.i, 24
  ...
  %"&(pSB[currWI].offset)84.i" = add nuw i64 %CurrSBIndex..8.i, 40
...
; <label>:150                                     ; preds = %SyncBB200.i
  %"&(pSB[currWI].offset)57.i" = add nuw i64 %CurrSBIndex..8.i, 16
  ...
  %"&(pSB[currWI].offset)38.i" = add nuw i64 %CurrSBIndex..8.i, 12
...
UnifiedReturnBlock.i:                             ; preds = %150, %SyncBB200.i
  %check.WI.iter231.i = icmp ult i64 %CurrWI..8.i, %34
  br i1 %check.WI.iter231.i, label %thenBB228.i, label %__scan_separated_args.exit

thenBB228.i:                                      ; preds = %UnifiedReturnBlock.i
  %"CurrWI++232.i" = add nuw i64 %CurrWI..8.i, 1
  %"loadedCurrSB+Stride234.i" = add nuw i64 %CurrSBIndex..8.i, 88
  br label %SyncBB200.i
...
SyncBB8.i:                                        ; preds = %thenBB10.i, %entry
  %CurrSBIndex..1.i = phi i64 [ 0, %entry ], [ %"loadedCurrSB+Stride16.i", %thenBB10.i ]
  %CurrWI..1.i = phi i64 [ 0, %entry ], [ %"CurrWI++14.i", %thenBB10.i ]
  ...
  %37 = shl i64 %31, 1
  %38 = mul i64 %37, %36
  %39 = getelementptr %struct.PaddedDimId* %22, i64 %CurrWI..1.i, i32 0, i64 0
  ...
  br i1 %check.WI.iter13.i, label %thenBB10.i, label %elseBB11.i

thenBB10.i:                                       ; preds = %SyncBB8.i
  %"CurrWI++14.i" = add nuw i64 %CurrWI..1.i, 1
  %"loadedCurrSB+Stride16.i" = add nuw i64 %CurrSBIndex..1.i, 88
  br label %SyncBB8.i

elseBB11.i:                                       ; preds = %SyncBB8.i
  %43 = sext i32 %7 to i64
  br label %SyncBB7.i

SyncBB7.i:                                        ; preds = %thenBB.i, %elseBB11.i
  %CurrSBIndex..0.i = phi i64 [ 0, %elseBB11.i ], [ %"loadedCurrSB+Stride.i", %thenBB.i ]
  %CurrWI..0.i = phi i64 [ 0, %elseBB11.i ], [ %"CurrWI++.i", %thenBB.i ]
  %"&pSB[currWI].offset3.i" = getelementptr inbounds i8* %28, i64 %CurrSBIndex..0.i
  ...
  %48 = getelementptr %struct.PaddedDimId* %22, i64 %CurrWI..0.i, i32 0, i64 0

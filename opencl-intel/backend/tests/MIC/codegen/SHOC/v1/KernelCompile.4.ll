...
UnifiedReturnBlock:                               ; preds = %SyncBB8, %25
...
SyncBB7:                                          ; preds = %UnifiedReturnBlock
  ret void
}
...
SyncBB198:                                        ; preds = %"Barrier BB", %thenBB204, %thenBB211
  ...
  %currBarrier.0 = phi i32 [ %currBarrier.1, %thenBB204 ], [ %currBarrier.2, %thenBB211 ], [ 3, %"Barrier BB" ]
...
thenBB211:                                        ; preds = %84
  ...
  %cond2 = icmp eq i32 %currBarrier.2, 3
...
SyncBB199:                                        ; preds = %thenBB227, %thenBB219, %84
  ...
  %currBarrier.7 = phi i32 [ 4, %84 ], [ %currBarrier.6, %thenBB227 ], [ %currBarrier.5, %thenBB219 ]
...
thenBB219:                                        ; preds = %bb.nph
  ...
  %cond1 = icmp eq i32 %currBarrier.5, 5
...
SyncBB200:                                        ; preds = %bb.nph, %thenBB219, %thenBB227
  ...
  %currBarrier.4 = phi i32 [ %currBarrier.6, %thenBB227 ], [ %currBarrier.5, %thenBB219 ], [ 5, %bb.nph ]
...
thenBB227:                                        ; preds = %._crit_edge
  ...
  %cond = icmp eq i32 %currBarrier.6, 5
...
SyncBB.i:                                         ; preds = %thenBB10.i, %entry
...
UnifiedReturnBlock.i:                             ; preds = %54, %SyncBB8.i
...
SyncBB198.i:                                      ; preds = %thenBB211.i, %thenBB204.i, %"Barrier BB.i"
  ...
  %currBarrier.0.i = phi i32 [ %currBarrier.1.i, %thenBB204.i ], [ %currBarrier.2.i, %thenBB211.i ], [ 3, %"Barrier BB.i" ]
...
thenBB211.i:                                      ; preds = %122
  ...
  %cond2.i = icmp eq i32 %currBarrier.2.i, 3
...
SyncBB199.i:                                      ; preds = %thenBB227.i, %thenBB219.i, %122
  ...
  %currBarrier.7.i = phi i32 [ 4, %122 ], [ %currBarrier.6.i, %thenBB227.i ], [ %currBarrier.5.i, %thenBB219.i ]
...
thenBB219.i:                                      ; preds = %bb.nph.i
  ...
  %cond1.i = icmp eq i32 %currBarrier.5.i, 5
...
SyncBB200.i:                                      ; preds = %thenBB227.i, %thenBB219.i, %bb.nph.i
  ...
  %currBarrier.4.i = phi i32 [ %currBarrier.6.i, %thenBB227.i ], [ %currBarrier.5.i, %thenBB219.i ], [ 5, %bb.nph.i ]
...
thenBB227.i:                                      ; preds = %._crit_edge.i
  ...
  %cond.i = icmp eq i32 %currBarrier.6.i, 5

...
UnifiedReturnBlock:                               ; preds = %SyncBB, %25
  ...
  br i1 %check.WI.iter13, label %thenBB10, label %SyncBB7
...
SyncBB:                                           ; preds = %thenBB211, %thenBB204, %FirstBB
...
thenBB204:                                        ; preds = %"Barrier BB"
  ...
  br i1 %cond3, label %SyncBB, label %SyncBB199

SyncBB199:                                        ; preds = %"Barrier BB", %thenBB204, %thenBB211
...
; <label>:84                                      ; preds = %._crit_edge7, %65
  ...
  br i1 %check.WI.iter214, label %thenBB211, label %SyncBB200

thenBB211:                                        ; preds = %84
  %"CurrWI++215" = add nuw i64 %CurrWI..4, 1
  %"loadedCurrSB+Stride217" = add nuw i64 %CurrSBIndex..4, 88
  %cond2 = icmp eq i32 %currBarrier.2, 2
  br i1 %cond2, label %SyncBB199, label %SyncBB

SyncBB200:                                        ; preds = %thenBB227, %thenBB219, %84
...
bb.nph:                                           ; preds = %104, %SyncBB200
  %CurrWI..7 = phi i64 [ %CurrWI..6, %104 ], [ %CurrWI..5, %SyncBB200 ]
  %CurrSBIndex..7 = phi i64 [ %CurrSBIndex..6, %104 ], [ %CurrSBIndex..5, %SyncBB200 ]
  %currBarrier.5 = phi i32 [ %currBarrier.4, %104 ], [ %currBarrier.7, %SyncBB200 ]
  %d1.02 = phi i32 [ %105, %104 ], [ 1, %SyncBB200 ]
  %"&(pSB[currWI].offset)180.pn" = phi i64 [ %"&(pSB[currWI].offset)180", %104 ], [ %"&(pSB[currWI].offset)148", %SyncBB200 ]
  ...
  br i1 %check.WI.iter222, label %thenBB219, label %SyncBB201
...
thenBB219:                                        ; preds = %bb.nph
  ...
  br i1 %cond1, label %SyncBB201, label %SyncBB200

SyncBB201:                                        ; preds = %bb.nph, %thenBB219, %thenBB227
...
._crit_edge:                                      ; preds = %104, %SyncBB200
  %CurrWI..8 = phi i64 [ %CurrWI..5, %SyncBB200 ], [ %CurrWI..6, %104 ]
  %CurrSBIndex..8 = phi i64 [ %CurrSBIndex..5, %SyncBB200 ], [ %CurrSBIndex..6, %104 ]
  %currBarrier.6 = phi i32 [ %currBarrier.7, %SyncBB200 ], [ %currBarrier.4, %104 ]
  %check.WI.iter230 = icmp ult i64 %CurrWI..8, %iterCount
  br i1 %check.WI.iter230, label %thenBB227, label %SyncBB202
...
thenBB227:                                        ; preds = %._crit_edge
  ...
  br i1 %cond, label %SyncBB201, label %SyncBB200

SyncBB202:                                        ; preds = %._crit_edge, %thenBB
...
UnifiedReturnBlock:                               ; preds = %SyncBB202, %112
  %check.WI.iter = icmp ult i64 %CurrWI..0, %iterCount
...
SyncBB198:                                        ; preds = %UnifiedReturnBlock
  ret void
}
...
SyncBB.i:                                         ; preds = %thenBB211.i, %thenBB204.i, %entry
...
thenBB204.i:                                      ; preds = %"Barrier BB.i"
  ...
  br i1 %cond3.i, label %SyncBB.i, label %SyncBB199.i

SyncBB199.i:                                      ; preds = %thenBB211.i, %thenBB204.i, %"Barrier BB.i"
...
; <label>:122                                     ; preds = %._crit_edge7.i, %103
  ...
  br i1 %check.WI.iter214.i, label %thenBB211.i, label %SyncBB200.i
...
thenBB211.i:                                      ; preds = %122
  ...
  br i1 %cond2.i, label %SyncBB199.i, label %SyncBB.i

SyncBB200.i:                                      ; preds = %thenBB227.i, %thenBB219.i, %122
...
bb.nph.i:                                         ; preds = %142, %SyncBB200.i
  %CurrWI..7.i = phi i64 [ %CurrWI..6.i, %142 ], [ %CurrWI..5.i, %SyncBB200.i ]
  %CurrSBIndex..7.i = phi i64 [ %CurrSBIndex..6.i, %142 ], [ %CurrSBIndex..5.i, %SyncBB200.i ]
  %currBarrier.5.i = phi i32 [ %currBarrier.4.i, %142 ], [ %currBarrier.7.i, %SyncBB200.i ]
  %d1.02.i = phi i32 [ %143, %142 ], [ 1, %SyncBB200.i ]
  %"&(pSB[currWI].offset)180.pn.i" = phi i64 [ %"&(pSB[currWI].offset)180.i", %142 ], [ %"&(pSB[currWI].offset)148.i", %SyncBB200.i ]
  ...
  br i1 %check.WI.iter222.i, label %thenBB219.i, label %SyncBB201.i
...
thenBB219.i:                                      ; preds = %bb.nph.i
  ...
  br i1 %cond1.i, label %SyncBB201.i, label %SyncBB200.i

SyncBB201.i:                                      ; preds = %thenBB227.i, %thenBB219.i, %bb.nph.i
...
; <label>:142                                     ; preds = %128, %SyncBB201.i
...
._crit_edge.i:                                    ; preds = %142, %SyncBB200.i
  %CurrWI..8.i = phi i64 [ %CurrWI..5.i, %SyncBB200.i ], [ %CurrWI..6.i, %142 ]
  %CurrSBIndex..8.i = phi i64 [ %CurrSBIndex..5.i, %SyncBB200.i ], [ %CurrSBIndex..6.i, %142 ]
  %currBarrier.6.i = phi i32 [ %currBarrier.7.i, %SyncBB200.i ], [ %currBarrier.4.i, %142 ]
  %check.WI.iter230.i = icmp ult i64 %CurrWI..8.i, %34
  br i1 %check.WI.iter230.i, label %thenBB227.i, label %SyncBB202.i
...
thenBB227.i:                                      ; preds = %._crit_edge.i
  ...
  br i1 %cond.i, label %SyncBB201.i, label %SyncBB200.i

SyncBB202.i:                                      ; preds = %thenBB.i, %._crit_edge.i
...
UnifiedReturnBlock.i:                             ; preds = %150, %SyncBB202.i

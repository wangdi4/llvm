...
bb.nph:                                           ; preds = %SyncBB12, %bb.nph
  %j.05 = phi i32 [ %254, %bb.nph ], [ 0, %SyncBB12 ]
  %s4.04 = phi float [ %253, %bb.nph ], [ %13, %SyncBB12 ]
  %s3.03 = phi float [ %249, %bb.nph ], [ %12, %SyncBB12 ]
  %s2.02 = phi float [ %245, %bb.nph ], [ %13, %SyncBB12 ]
  %s.01 = phi float [ %241, %bb.nph ], [ %12, %SyncBB12 ]
...
._crit_edge:                                      ; preds = %bb.nph, %SyncBB12
  %s4.0.lcssa = phi float [ %13, %SyncBB12 ], [ %253, %bb.nph ]
  %s3.0.lcssa = phi float [ %12, %SyncBB12 ], [ %249, %bb.nph ]
  %s2.0.lcssa = phi float [ %13, %SyncBB12 ], [ %245, %bb.nph ]
  %s.0.lcssa = phi float [ %12, %SyncBB12 ], [ %241, %bb.nph ]
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB12.i
  %j.05.i = phi i32 [ %268, %bb.nph.i ], [ 0, %SyncBB12.i ]
  %s4.04.i = phi float [ %267, %bb.nph.i ], [ %27, %SyncBB12.i ]
  %s3.03.i = phi float [ %263, %bb.nph.i ], [ %26, %SyncBB12.i ]
  %s2.02.i = phi float [ %259, %bb.nph.i ], [ %27, %SyncBB12.i ]
  %s.01.i = phi float [ %255, %bb.nph.i ], [ %26, %SyncBB12.i ]
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB12.i
  %s4.0.lcssa.i = phi float [ %27, %SyncBB12.i ], [ %267, %bb.nph.i ]
  %s3.0.lcssa.i = phi float [ %26, %SyncBB12.i ], [ %263, %bb.nph.i ]
  %s2.0.lcssa.i = phi float [ %27, %SyncBB12.i ], [ %259, %bb.nph.i ]
  %s.0.lcssa.i = phi float [ %26, %SyncBB12.i ], [ %255, %bb.nph.i ]

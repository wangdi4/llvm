...
; <label>:0
  ...
  br label %SyncBB153.outer

SyncBB153.outer:                                  ; preds = %0, %thenBB196
  %CurrWI..4.ph = phi i64 [ %"CurrWI++200", %thenBB196 ], [ 0, %0 ]
  %CurrSBIndex..4.ph = phi i64 [ %"loadedCurrSB+Stride202", %thenBB196 ], [ 0, %0 ]
  %currBarrier.3.ph = phi i32 [ %currBarrier.2, %thenBB196 ], [ 9, %0 ]
  br label %SyncBB153

SyncBB153:                                        ; preds = %thenBB168, %SyncBB153.outer
  %CurrWI..4 = phi i64 [ %"CurrWI++172", %thenBB168 ], [ %CurrWI..4.ph, %SyncBB153.outer ]
  %CurrSBIndex..4 = phi i64 [ %"loadedCurrSB+Stride174", %thenBB168 ], [ %CurrSBIndex..4.ph, %SyncBB153.outer ]
...
SyncBB155:                                        ; preds = %._crit_edge, %thenBB175
...
UnifiedReturnBlock:                               ; preds = %SyncBB158, %SyncBB153, %83
  %CurrWI..3 = phi i64 [ %CurrWI..1, %83 ], [ %CurrWI..1, %SyncBB158 ], [ %CurrWI..4, %SyncBB153 ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..1, %83 ], [ %CurrSBIndex..1, %SyncBB158 ], [ %CurrSBIndex..4, %SyncBB153 ]
  %currBarrier.2 = phi i32 [ %currBarrier.0, %83 ], [ %currBarrier.0, %SyncBB158 ], [ %currBarrier.3.ph, %SyncBB153 ]
...
thenBB196:                                        ; preds = %UnifiedReturnBlock
  ...
  br i1 %cond, label %SyncBB153.outer, label %SyncBB158
...
UnifiedReturnBlock:                               ; preds = %SyncBB5, %._crit_edge
  %check.WI.iter = icmp ult i64 %CurrWI..0, %iterCount
  br i1 %check.WI.iter, label %thenBB, label %SyncBB
...
entry:
  ...
  br label %SyncBB153.outer.i

SyncBB153.outer.i:                                ; preds = %thenBB196.i, %entry
  ...
  %currBarrier.3.ph.i = phi i32 [ %currBarrier.2.i, %thenBB196.i ], [ 9, %entry ]
  br label %SyncBB153.i

SyncBB153.i:                                      ; preds = %thenBB168.i, %SyncBB153.outer.i
  %CurrWI..4.i = phi i64 [ %"CurrWI++172.i", %thenBB168.i ], [ %CurrWI..4.ph.i, %SyncBB153.outer.i ]
  %CurrSBIndex..4.i = phi i64 [ %"loadedCurrSB+Stride174.i", %thenBB168.i ], [ %CurrSBIndex..4.ph.i, %SyncBB153.outer.i ]
...
SyncBB155.i:                                      ; preds = %thenBB175.i, %._crit_edge.i
...
SyncBB154.i:                                      ; preds = %thenBB182.i, %98
...
; <label>:107                                     ; preds = %100, %SyncBB154.i
...
SyncBB157.i:                                      ; preds = %thenBB189.i, %107
...
UnifiedReturnBlock.i:                             ; preds = %117, %SyncBB158.i, %SyncBB153.i
  %CurrWI..3.i = phi i64 [ %CurrWI..1.i, %117 ], [ %CurrWI..1.i, %SyncBB158.i ], [ %CurrWI..4.i, %SyncBB153.i ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..1.i, %117 ], [ %CurrSBIndex..1.i, %SyncBB158.i ], [ %CurrSBIndex..4.i, %SyncBB153.i ]
  %currBarrier.2.i = phi i32 [ %currBarrier.0.i, %117 ], [ %currBarrier.0.i, %SyncBB158.i ], [ %currBarrier.3.ph.i, %SyncBB153.i ]
...
thenBB196.i:                                      ; preds = %UnifiedReturnBlock.i
  ...
  br i1 %cond.i, label %SyncBB153.outer.i, label %SyncBB158.i
...
UnifiedReturnBlock.i:                             ; preds = %._crit_edge.i, %SyncBB5.i
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %25

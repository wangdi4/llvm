...
bb.nph:                                           ; preds = %SyncBB24, %bb.nph
  ...
  %s8.08 = phi float [ %81, %bb.nph ], [ %9, %SyncBB24 ]
  %s7.07 = phi float [ %80, %bb.nph ], [ %8, %SyncBB24 ]
  %s6.06 = phi float [ %79, %bb.nph ], [ %9, %SyncBB24 ]
  %s.05 = phi float [ %74, %bb.nph ], [ %8, %SyncBB24 ]
  %s2.04 = phi float [ %75, %bb.nph ], [ %9, %SyncBB24 ]
  %s3.03 = phi float [ %76, %bb.nph ], [ %8, %SyncBB24 ]
  %s4.02 = phi float [ %77, %bb.nph ], [ %9, %SyncBB24 ]
  %s5.01 = phi float [ %78, %bb.nph ], [ %8, %SyncBB24 ]
...
._crit_edge:                                      ; preds = %bb.nph, %SyncBB24
  %s8.0.lcssa = phi float [ %9, %SyncBB24 ], [ %81, %bb.nph ]
  %s7.0.lcssa = phi float [ %8, %SyncBB24 ], [ %80, %bb.nph ]
  %s6.0.lcssa = phi float [ %9, %SyncBB24 ], [ %79, %bb.nph ]
  %s.0.lcssa = phi float [ %8, %SyncBB24 ], [ %74, %bb.nph ]
  %s2.0.lcssa = phi float [ %9, %SyncBB24 ], [ %75, %bb.nph ]
  %s3.0.lcssa = phi float [ %8, %SyncBB24 ], [ %76, %bb.nph ]
  %s4.0.lcssa = phi float [ %9, %SyncBB24 ], [ %77, %bb.nph ]
  %s5.0.lcssa = phi float [ %8, %SyncBB24 ], [ %78, %bb.nph ]
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB24.i
  ...
  %s8.08.i = phi float [ %95, %bb.nph.i ], [ %23, %SyncBB24.i ]
  %s7.07.i = phi float [ %94, %bb.nph.i ], [ %22, %SyncBB24.i ]
  %s6.06.i = phi float [ %93, %bb.nph.i ], [ %23, %SyncBB24.i ]
  %s.05.i = phi float [ %88, %bb.nph.i ], [ %22, %SyncBB24.i ]
  %s2.04.i = phi float [ %89, %bb.nph.i ], [ %23, %SyncBB24.i ]
  %s3.03.i = phi float [ %90, %bb.nph.i ], [ %22, %SyncBB24.i ]
  %s4.02.i = phi float [ %91, %bb.nph.i ], [ %23, %SyncBB24.i ]
  %s5.01.i = phi float [ %92, %bb.nph.i ], [ %22, %SyncBB24.i ]
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB24.i
  %s8.0.lcssa.i = phi float [ %23, %SyncBB24.i ], [ %95, %bb.nph.i ]
  %s7.0.lcssa.i = phi float [ %22, %SyncBB24.i ], [ %94, %bb.nph.i ]
  %s6.0.lcssa.i = phi float [ %23, %SyncBB24.i ], [ %93, %bb.nph.i ]
  %s.0.lcssa.i = phi float [ %22, %SyncBB24.i ], [ %88, %bb.nph.i ]
  %s2.0.lcssa.i = phi float [ %23, %SyncBB24.i ], [ %89, %bb.nph.i ]
  %s3.0.lcssa.i = phi float [ %22, %SyncBB24.i ], [ %90, %bb.nph.i ]
  %s4.0.lcssa.i = phi float [ %23, %SyncBB24.i ], [ %91, %bb.nph.i ]
  %s5.0.lcssa.i = phi float [ %22, %SyncBB24.i ], [ %92, %bb.nph.i ]

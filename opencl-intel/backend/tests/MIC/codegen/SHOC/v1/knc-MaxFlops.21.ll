...
bb.nph:                                           ; preds = %SyncBB, %bb.nph
  %s2.04 = phi double [ %s2.0, %bb.nph ], [ %s2.01, %SyncBB ]
  %j.03 = phi i32 [ %44, %bb.nph ], [ 0, %SyncBB ]
  %s.02 = phi double [ %43, %bb.nph ], [ %8, %SyncBB ]
...
._crit_edge:                                      ; preds = %bb.nph, %SyncBB
  %s2.0.lcssa = phi double [ %s2.01, %SyncBB ], [ %s2.0, %bb.nph ]
  %s.0.lcssa = phi double [ %8, %SyncBB ], [ %43, %bb.nph ]
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB.i
  %s2.04.i = phi double [ %s2.0.i, %bb.nph.i ], [ %s2.01.i, %SyncBB.i ]
  %j.03.i = phi i32 [ %58, %bb.nph.i ], [ 0, %SyncBB.i ]
  %s.02.i = phi double [ %57, %bb.nph.i ], [ %22, %SyncBB.i ]
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB.i
  %s2.0.lcssa.i = phi double [ %s2.01.i, %SyncBB.i ], [ %s2.0.i, %bb.nph.i ]
  %s.0.lcssa.i = phi double [ %22, %SyncBB.i ], [ %57, %bb.nph.i ]

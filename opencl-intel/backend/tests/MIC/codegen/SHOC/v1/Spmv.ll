...
; <label>:0
  ...
  br label %SyncBB154.outer

SyncBB154.outer:                                  ; preds = %0, %thenBB168
  %CurrWI..4.ph = phi i64 [ %"CurrWI++172", %thenBB168 ], [ 0, %0 ]
  %CurrSBIndex..4.ph = phi i64 [ %"loadedCurrSB+Stride174", %thenBB168 ], [ 0, %0 ]
  %currBarrier.3.ph = phi i32 [ %currBarrier.2, %thenBB168 ], [ 9, %0 ]
  br label %SyncBB154

SyncBB154:                                        ; preds = %thenBB175, %SyncBB154.outer
  %CurrWI..4 = phi i64 [ %"CurrWI++179", %thenBB175 ], [ %CurrWI..4.ph, %SyncBB154.outer ]
  %CurrSBIndex..4 = phi i64 [ %"loadedCurrSB+Stride181", %thenBB175 ], [ %CurrSBIndex..4.ph, %SyncBB154.outer ]
...
._crit_edge:                                      ; preds = %29, %19
  ...
  %check.WI.iter178 = icmp ult i64 %CurrWI..4, %iterCount
  br i1 %check.WI.iter178, label %thenBB175, label %SyncBB156

thenBB175:                                        ; preds = %._crit_edge
  %"CurrWI++179" = add nuw i64 %CurrWI..4, 1
  %"loadedCurrSB+Stride181" = add nuw i64 %CurrSBIndex..4, 32
  br label %SyncBB154
...
SyncBB159:                                        ; preds = %82, %thenBB168
  %CurrWI..1 = phi i64 [ %"CurrWI++172", %thenBB168 ], [ 0, %82 ]
  %CurrSBIndex..1 = phi i64 [ %"loadedCurrSB+Stride174", %thenBB168 ], [ 0, %82 ]
  %currBarrier.0 = phi i32 [ %currBarrier.2, %thenBB168 ], [ 7, %82 ]
...
UnifiedReturnBlock:                               ; preds = %SyncBB159, %SyncBB154, %83
  %CurrWI..3 = phi i64 [ %CurrWI..1, %83 ], [ %CurrWI..1, %SyncBB159 ], [ %CurrWI..4, %SyncBB154 ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..1, %83 ], [ %CurrSBIndex..1, %SyncBB159 ], [ %CurrSBIndex..4, %SyncBB154 ]
  %currBarrier.2 = phi i32 [ %currBarrier.0, %83 ], [ %currBarrier.0, %SyncBB159 ], [ %currBarrier.3.ph, %SyncBB154 ]
  %check.WI.iter171 = icmp ult i64 %CurrWI..3, %iterCount
  br i1 %check.WI.iter171, label %thenBB168, label %SyncBB155

thenBB168:                                        ; preds = %UnifiedReturnBlock
  %"CurrWI++172" = add nuw i64 %CurrWI..3, 1
  %"loadedCurrSB+Stride174" = add nuw i64 %CurrSBIndex..3, 32
  %cond = icmp eq i32 %currBarrier.2, 9
  br i1 %cond, label %SyncBB154.outer, label %SyncBB159

SyncBB155:                                        ; preds = %UnifiedReturnBlock
  ret void
}
...
entry:
  ...
  br label %SyncBB154.outer.i

SyncBB154.outer.i:                                ; preds = %thenBB168.i, %entry
  %CurrWI..4.ph.i = phi i64 [ %"CurrWI++172.i", %thenBB168.i ], [ 0, %entry ]
  %CurrSBIndex..4.ph.i = phi i64 [ %"loadedCurrSB+Stride174.i", %thenBB168.i ], [ 0, %entry ]
  %currBarrier.3.ph.i = phi i32 [ %currBarrier.2.i, %thenBB168.i ], [ 9, %entry ]
  br label %SyncBB154.i

SyncBB154.i:                                      ; preds = %thenBB175.i, %SyncBB154.outer.i
  %CurrWI..4.i = phi i64 [ %"CurrWI++179.i", %thenBB175.i ], [ %CurrWI..4.ph.i, %SyncBB154.outer.i ]
  %CurrSBIndex..4.i = phi i64 [ %"loadedCurrSB+Stride181.i", %thenBB175.i ], [ %CurrSBIndex..4.ph.i, %SyncBB154.outer.i ]
...
._crit_edge.i:                                    ; preds = %63, %53
  ...
  %check.WI.iter178.i = icmp ult i64 %CurrWI..4.i, %31
  br i1 %check.WI.iter178.i, label %thenBB175.i, label %SyncBB156.i

thenBB175.i:                                      ; preds = %._crit_edge.i
  %"CurrWI++179.i" = add nuw i64 %CurrWI..4.i, 1
  %"loadedCurrSB+Stride181.i" = add nuw i64 %CurrSBIndex..4.i, 32
  br label %SyncBB154.i
...
SyncBB159.i:                                      ; preds = %thenBB168.i, %116
  %CurrWI..1.i = phi i64 [ %"CurrWI++172.i", %thenBB168.i ], [ 0, %116 ]
  %CurrSBIndex..1.i = phi i64 [ %"loadedCurrSB+Stride174.i", %thenBB168.i ], [ 0, %116 ]
  %currBarrier.0.i = phi i32 [ %currBarrier.2.i, %thenBB168.i ], [ 7, %116 ]
...
UnifiedReturnBlock.i:                             ; preds = %117, %SyncBB159.i, %SyncBB154.i
  %CurrWI..3.i = phi i64 [ %CurrWI..1.i, %117 ], [ %CurrWI..1.i, %SyncBB159.i ], [ %CurrWI..4.i, %SyncBB154.i ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..1.i, %117 ], [ %CurrSBIndex..1.i, %SyncBB159.i ], [ %CurrSBIndex..4.i, %SyncBB154.i ]
  %currBarrier.2.i = phi i32 [ %currBarrier.0.i, %117 ], [ %currBarrier.0.i, %SyncBB159.i ], [ %currBarrier.3.ph.i, %SyncBB154.i ]
  %check.WI.iter171.i = icmp ult i64 %CurrWI..3.i, %31
  br i1 %check.WI.iter171.i, label %thenBB168.i, label %__spmv_csr_vector_kernel_separated_args.exit

thenBB168.i:                                      ; preds = %UnifiedReturnBlock.i
  %"CurrWI++172.i" = add nuw i64 %CurrWI..3.i, 1
  %"loadedCurrSB+Stride174.i" = add nuw i64 %CurrSBIndex..3.i, 32
  %cond.i = icmp eq i32 %currBarrier.2.i, 9
  br i1 %cond.i, label %SyncBB154.outer.i, label %SyncBB159.i

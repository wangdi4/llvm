...
declare void @__Add1_original(float addrspace(1)* nocapture, i32) nounwind
...
define void @__Add1_separated_args(float addrspace(1)* nocapture %data, i32 %nIters, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
FirstBB:
...
bb.nph:                                           ; preds = %SyncBB3, %bb.nph
  %j.02 = phi i32 [ %79, %bb.nph ], [ 0, %SyncBB3 ]
  %s.01 = phi float [ %78, %bb.nph ], [ %8, %SyncBB3 ]
  %9 = fsub float 1.000000e+01, %s.01
...
._crit_edge:                                      ; preds = %bb.nph, %SyncBB3
  %s.0.lcssa = phi float [ %8, %SyncBB3 ], [ %78, %bb.nph ]
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB3.i
  %j.02.i = phi i32 [ %93, %bb.nph.i ], [ 0, %SyncBB3.i ]
  %s.01.i = phi float [ %92, %bb.nph.i ], [ %22, %SyncBB3.i ]
  %23 = fsub float 1.000000e+01, %s.01.i
  %24 = fsub float 1.000000e+01, %23
  %25 = fsub float 1.000000e+01, %24
  %26 = fsub float 1.000000e+01, %25
  %27 = fsub float 1.000000e+01, %26
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB3.i
  %s.0.lcssa.i = phi float [ %22, %SyncBB3.i ], [ %92, %bb.nph.i ]
...
!0 = metadata !{void (float addrspace(1)*, i32, i8 addrspace(3)*, %struct.WorkDim*, i64*, %struct.PaddedDimId*, %struct.PaddedDimId*, i64*, i64, i8*, i64*)* @__Add1_separated_args, metadata !1, metadata !1, metadata !"", metadata !"float __attribute__((address_space(1))) *, int", metadata !"opencl_Add1_locals_anchor", void (i8*)* @Add1}

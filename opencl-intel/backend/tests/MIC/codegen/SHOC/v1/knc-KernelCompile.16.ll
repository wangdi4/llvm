...
SyncBB202:                                        ; preds = %thenBB211, %thenBB204, %FirstBB
  ...
  %currBarrier.3 = phi i32 [ 7, %FirstBB ], [ %currBarrier.2, %thenBB211 ], [ %currBarrier.1, %thenBB204 ]
...
SyncBB202.i:                                      ; preds = %thenBB211.i, %thenBB204.i, %entry
  ...
  %currBarrier.3.i = phi i32 [ 7, %entry ], [ %currBarrier.2.i, %thenBB211.i ], [ %currBarrier.1.i, %thenBB204.i ]

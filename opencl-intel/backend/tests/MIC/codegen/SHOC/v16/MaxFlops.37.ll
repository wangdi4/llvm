...
declare void @____Vectorized_.peak_original(double addrspace(1)* nocapture, double, double) nounwind
...
define void @____Vectorized_.peak_separated_args(double addrspace(1)* nocapture %target, double %val1, double %val2, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
bb.nph:
  %0 = fadd double %val1, %val2
  %1 = fadd double %0, %val1
  %2 = fadd double %1, %val1
...
; <label>:35                                      ; preds = %35, %SyncBB17
  %ctr.03 = phi i32 [ 0, %SyncBB17 ], [ %324, %35 ]
  %s5.02 = phi double [ %3, %SyncBB17 ], [ %323, %35 ]
  %s4.01 = phi double [ %2, %SyncBB17 ], [ %320, %35 ]
  %36 = fmul double %s4.01, %s4.01
  %37 = fadd double %36, %s4.01
  %38 = fmul double %37, %s5.02
  %39 = fmul double %s5.02, %s5.02
...
._crit_edge:                                      ; preds = %35
  ...
  %354 = fadd double %353, %28
  %355 = fadd double %354, %29
  %temp = insertelement <16 x double> undef, double %355, i32 0
  ...
  %356 = getelementptr inbounds double addrspace(1)* %target, i64 %extract
  %ptrTypeCast = bitcast double addrspace(1)* %356 to <16 x double> addrspace(1)*
  store <16 x double> %vector, <16 x double> addrspace(1)* %ptrTypeCast, align 8
  %check.WI.iter = icmp ult i64 %CurrWI..0, %iterCount
  br i1 %check.WI.iter, label %thenBB, label %SyncBB
...
; <label>:52                                      ; preds = %52, %SyncBB17.i
  %ctr.03.i = phi i32 [ 0, %SyncBB17.i ], [ %341, %52 ]
  %s5.02.i = phi double [ %20, %SyncBB17.i ], [ %340, %52 ]
  %s4.01.i = phi double [ %19, %SyncBB17.i ], [ %337, %52 ]
  %53 = fmul double %s4.01.i, %s4.01.i
  %54 = fadd double %53, %s4.01.i
  %55 = fmul double %54, %s5.02.i
  %56 = fmul double %s5.02.i, %s5.02.i
...
._crit_edge.i:                                    ; preds = %52
  ...
  %371 = fadd double %370, %45
  %372 = fadd double %371, %46
  %temp.i = insertelement <16 x double> undef, double %372, i32 0
  ...
  %373 = getelementptr inbounds double addrspace(1)* %1, i64 %extract.i
  %ptrTypeCast.i = bitcast double addrspace(1)* %373 to <16 x double> addrspace(1)*
  store <16 x double> %vector.i, <16 x double> addrspace(1)* %ptrTypeCast.i, align 8
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %16

...
; <label>:0
  ...
  br label %SyncBB158.outer

SyncBB158.outer:                                  ; preds = %0, %thenBB196
  %CurrWI..4.ph = phi i64 [ %"CurrWI++200", %thenBB196 ], [ 0, %0 ]
  %CurrSBIndex..4.ph = phi i64 [ %"loadedCurrSB+Stride202", %thenBB196 ], [ 0, %0 ]
  %currBarrier.3.ph = phi i32 [ %currBarrier.2, %thenBB196 ], [ 10, %0 ]
  br label %SyncBB158

SyncBB158:                                        ; preds = %thenBB168, %SyncBB158.outer
  %CurrWI..4 = phi i64 [ %"CurrWI++172", %thenBB168 ], [ %CurrWI..4.ph, %SyncBB158.outer ]
  %CurrSBIndex..4 = phi i64 [ %"loadedCurrSB+Stride174", %thenBB168 ], [ %CurrSBIndex..4.ph, %SyncBB158.outer ]
...
UnifiedReturnBlock:                               ; preds = %SyncBB157, %SyncBB158, %83
  %CurrWI..3 = phi i64 [ %CurrWI..1, %83 ], [ %CurrWI..1, %SyncBB157 ], [ %CurrWI..4, %SyncBB158 ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..1, %83 ], [ %CurrSBIndex..1, %SyncBB157 ], [ %CurrSBIndex..4, %SyncBB158 ]
  %currBarrier.2 = phi i32 [ %currBarrier.0, %83 ], [ %currBarrier.0, %SyncBB157 ], [ %currBarrier.3.ph, %SyncBB158 ]
...
thenBB196:                                        ; preds = %UnifiedReturnBlock
  ...
  %cond = icmp eq i32 %currBarrier.2, 10
  br i1 %cond, label %SyncBB158.outer, label %SyncBB157

SyncBB159:                                        ; preds = %UnifiedReturnBlock
  ret void
}
...
entry:
  ...
  br label %SyncBB158.outer.i

SyncBB158.outer.i:                                ; preds = %thenBB196.i, %entry
  ...
  %currBarrier.3.ph.i = phi i32 [ %currBarrier.2.i, %thenBB196.i ], [ 10, %entry ]
  br label %SyncBB158.i

SyncBB158.i:                                      ; preds = %thenBB168.i, %SyncBB158.outer.i
  %CurrWI..4.i = phi i64 [ %"CurrWI++172.i", %thenBB168.i ], [ %CurrWI..4.ph.i, %SyncBB158.outer.i ]
  %CurrSBIndex..4.i = phi i64 [ %"loadedCurrSB+Stride174.i", %thenBB168.i ], [ %CurrSBIndex..4.ph.i, %SyncBB158.outer.i ]
...
UnifiedReturnBlock.i:                             ; preds = %117, %SyncBB157.i, %SyncBB158.i
  %CurrWI..3.i = phi i64 [ %CurrWI..1.i, %117 ], [ %CurrWI..1.i, %SyncBB157.i ], [ %CurrWI..4.i, %SyncBB158.i ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..1.i, %117 ], [ %CurrSBIndex..1.i, %SyncBB157.i ], [ %CurrSBIndex..4.i, %SyncBB158.i ]
  %currBarrier.2.i = phi i32 [ %currBarrier.0.i, %117 ], [ %currBarrier.0.i, %SyncBB157.i ], [ %currBarrier.3.ph.i, %SyncBB158.i ]
...
thenBB196.i:                                      ; preds = %UnifiedReturnBlock.i
  ...
  br i1 %cond.i, label %SyncBB158.outer.i, label %SyncBB157.i

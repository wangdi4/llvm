...
declare void @__Add2_original(double addrspace(1)* nocapture, i32) nounwind

declare i64 @get_global_id(i32)

declare i64 @get_global_size(i32)

declare void @____Vectorized_.Add2_original(double addrspace(1)* nocapture, i32) nounwind
...
define void @__Add2_separated_args(double addrspace(1)* nocapture %data, i32 %nIters, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
FirstBB:
...
bb.nph:                                           ; preds = %SyncBB7, %bb.nph
  ...
  %j.03 = phi i32 [ %44, %bb.nph ], [ 0, %SyncBB7 ]
  %s.02 = phi double [ %43, %bb.nph ], [ %8, %SyncBB7 ]
  %9 = fsub double 1.000000e+01, %s.02
  ...
  %45 = fsub double 1.000000e+01, %s2.04
  ...
  %s2.0 = fsub double 1.000000e+01, %78
...
._crit_edge:                                      ; preds = %bb.nph, %SyncBB7
  ...
  %s.0.lcssa = phi double [ %8, %SyncBB7 ], [ %43, %bb.nph ]
  %79 = fadd double %s.0.lcssa, %s2.0.lcssa
  store double %79, double addrspace(1)* %7, align 8
...
define void @____Vectorized_.Add2_separated_args(double addrspace(1)* nocapture %data, i32 %nIters, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
FirstBB:
  %0 = icmp sgt i32 %nIters, 0
  br label %SyncBB23

SyncBB23:                                         ; preds = %thenBB, %FirstBB
  %CurrWI..0 = phi i64 [ 0, %FirstBB ], [ %"CurrWI++", %thenBB ]
  %1 = getelementptr %struct.PaddedDimId* %pLocalIds, i64 %CurrWI..0, i32 0, i64 0
  %2 = load i64* %1, align 8
  %3 = getelementptr %struct.PaddedDimId* %pBaseGlbId, i64 0, i32 0, i64 0
...
bb.nph:                                           ; preds = %SyncBB23, %bb.nph
  %vectorPHI = phi <16 x double> [ %s2.019, %bb.nph ], [ %s2.0117, %SyncBB23 ]
  %j.03 = phi i32 [ %43, %bb.nph ], [ 0, %SyncBB23 ]
  %vectorPHI18 = phi <16 x double> [ %42, %bb.nph ], [ %7, %SyncBB23 ]
  %8 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %vectorPHI18
  ...
  %44 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %vectorPHI
  ...
  %s2.019 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %77
  %exitcond = icmp eq i32 %43, %nIters
  br i1 %exitcond, label %._crit_edge, label %bb.nph

._crit_edge:                                      ; preds = %bb.nph, %SyncBB23
  %vectorPHI20 = phi <16 x double> [ %s2.0117, %SyncBB23 ], [ %s2.019, %bb.nph ]
  %vectorPHI21 = phi <16 x double> [ %7, %SyncBB23 ], [ %42, %bb.nph ]
  %78 = fadd <16 x double> %vectorPHI21, %vectorPHI20
  %ptrTypeCast22 = bitcast double addrspace(1)* %6 to <16 x double> addrspace(1)*
  store <16 x double> %78, <16 x double> addrspace(1)* %ptrTypeCast22, align 8
  %check.WI.iter = icmp ult i64 %CurrWI..0, %iterCount
  br i1 %check.WI.iter, label %thenBB, label %SyncBB
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB7.i
  ...
  %j.03.i = phi i32 [ %58, %bb.nph.i ], [ 0, %SyncBB7.i ]
  %s.02.i = phi double [ %57, %bb.nph.i ], [ %22, %SyncBB7.i ]
  %23 = fsub double 1.000000e+01, %s.02.i
  %24 = fsub double 1.000000e+01, %23
  %25 = fsub double 1.000000e+01, %24
  %26 = fsub double 1.000000e+01, %25
  %27 = fsub double 1.000000e+01, %26
  ...
  %59 = fsub double 1.000000e+01, %s2.04.i
  %60 = fsub double 1.000000e+01, %59
  %61 = fsub double 1.000000e+01, %60
  %62 = fsub double 1.000000e+01, %61
  %63 = fsub double 1.000000e+01, %62
  ...
  %s2.0.i = fsub double 1.000000e+01, %92
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB7.i
  ...
  %s.0.lcssa.i = phi double [ %22, %SyncBB7.i ], [ %57, %bb.nph.i ]
  %93 = fadd double %s.0.lcssa.i, %s2.0.lcssa.i
  store double %93, double addrspace(1)* %21, align 8
...
SyncBB23.i:                                       ; preds = %thenBB.i, %entry
  %CurrWI..0.i = phi i64 [ 0, %entry ], [ %"CurrWI++.i", %thenBB.i ]
  %15 = getelementptr %struct.PaddedDimId* %10, i64 %CurrWI..0.i, i32 0, i64 0
  %16 = load i64* %15, align 8
  %17 = getelementptr %struct.PaddedDimId* %7, i64 0, i32 0, i64 0
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB23.i
  %vectorPHI.i = phi <16 x double> [ %s2.019.i, %bb.nph.i ], [ %s2.0117.i, %SyncBB23.i ]
  %j.03.i = phi i32 [ %57, %bb.nph.i ], [ 0, %SyncBB23.i ]
  %vectorPHI18.i = phi <16 x double> [ %56, %bb.nph.i ], [ %21, %SyncBB23.i ]
  %22 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %vectorPHI18.i
  %23 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %22
  %24 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %23
  %25 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %24
  %26 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %25
  ...
  %58 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %vectorPHI.i
  %59 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %58
  %60 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %59
  %61 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %60
  %62 = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %61
  ...
  %s2.019.i = fsub <16 x double> <double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01, double 1.000000e+01>, %91
  %exitcond.i = icmp eq i32 %57, %4
  br i1 %exitcond.i, label %._crit_edge.i, label %bb.nph.i

._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB23.i
  %vectorPHI20.i = phi <16 x double> [ %s2.0117.i, %SyncBB23.i ], [ %s2.019.i, %bb.nph.i ]
  %vectorPHI21.i = phi <16 x double> [ %21, %SyncBB23.i ], [ %56, %bb.nph.i ]
  %92 = fadd <16 x double> %vectorPHI21.i, %vectorPHI20.i
  %ptrTypeCast22.i = bitcast double addrspace(1)* %20 to <16 x double> addrspace(1)*
  store <16 x double> %92, <16 x double> addrspace(1)* %ptrTypeCast22.i, align 8
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %13
...
!0 = metadata !{void (double addrspace(1)*, i32, i8 addrspace(3)*, %struct.WorkDim*, i64*, %struct.PaddedDimId*, %struct.PaddedDimId*, i64*, i64, i8*, i64*)* @__Add2_separated_args, metadata !1, metadata !1, metadata !"", metadata !"double __attribute__((address_space(1))) *, int", metadata !"opencl_Add2_locals_anchor", void (i8*)* @Add2}

...
declare void @____Vectorized_.Add4_original(float addrspace(1)* nocapture, i32) nounwind
...
bb.nph:                                           ; preds = %SyncBB, %bb.nph
  %j.05 = phi i32 [ %78, %bb.nph ], [ 0, %SyncBB ]
  %s4.04 = phi float [ %77, %bb.nph ], [ %9, %SyncBB ]
  %s3.03 = phi float [ %76, %bb.nph ], [ %8, %SyncBB ]
  %s2.02 = phi float [ %75, %bb.nph ], [ %9, %SyncBB ]
  %s.01 = phi float [ %74, %bb.nph ], [ %8, %SyncBB ]
...
define void @____Vectorized_.Add4_separated_args(float addrspace(1)* nocapture %data, i32 %nIters, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
FirstBB:
  %0 = icmp sgt i32 %nIters, 0
  br label %SyncBB25
...
bb.nph:                                           ; preds = %SyncBB25, %bb.nph
  %j.05 = phi i32 [ %77, %bb.nph ], [ 0, %SyncBB25 ]
  %vectorPHI = phi <16 x float> [ %76, %bb.nph ], [ %8, %SyncBB25 ]
  %vectorPHI17 = phi <16 x float> [ %75, %bb.nph ], [ %7, %SyncBB25 ]
  %vectorPHI18 = phi <16 x float> [ %74, %bb.nph ], [ %8, %SyncBB25 ]
  %vectorPHI19 = phi <16 x float> [ %73, %bb.nph ], [ %7, %SyncBB25 ]
  ...
  %77 = add nsw i32 %j.05, 1
  %exitcond = icmp eq i32 %77, %nIters
  br i1 %exitcond, label %._crit_edge, label %bb.nph

._crit_edge:                                      ; preds = %bb.nph, %SyncBB25
  %vectorPHI20 = phi <16 x float> [ %8, %SyncBB25 ], [ %76, %bb.nph ]
  %vectorPHI21 = phi <16 x float> [ %7, %SyncBB25 ], [ %75, %bb.nph ]
  %vectorPHI22 = phi <16 x float> [ %8, %SyncBB25 ], [ %74, %bb.nph ]
  %vectorPHI23 = phi <16 x float> [ %7, %SyncBB25 ], [ %73, %bb.nph ]
  %78 = fadd <16 x float> %vectorPHI23, %vectorPHI22
  %79 = fadd <16 x float> %78, %vectorPHI21
  %80 = fadd <16 x float> %79, %vectorPHI20
  %ptrTypeCast24 = bitcast float addrspace(1)* %6 to <16 x float> addrspace(1)*
  store <16 x float> %80, <16 x float> addrspace(1)* %ptrTypeCast24, align 4
  %check.WI.iter = icmp ult i64 %CurrWI..0, %iterCount
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB.i
  %j.05.i = phi i32 [ %92, %bb.nph.i ], [ 0, %SyncBB.i ]
  %s4.04.i = phi float [ %91, %bb.nph.i ], [ %23, %SyncBB.i ]
  %s3.03.i = phi float [ %90, %bb.nph.i ], [ %22, %SyncBB.i ]
  %s2.02.i = phi float [ %89, %bb.nph.i ], [ %23, %SyncBB.i ]
  %s.01.i = phi float [ %88, %bb.nph.i ], [ %22, %SyncBB.i ]
...
define void @__Vectorized_.Add4(i8* %pBuffer) {
entry:
  %0 = bitcast i8* %pBuffer to float addrspace(1)**
  %1 = load float addrspace(1)** %0, align 8
  %2 = getelementptr i8* %pBuffer, i64 8
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB25.i
  %j.05.i = phi i32 [ %91, %bb.nph.i ], [ 0, %SyncBB25.i ]
  %vectorPHI.i = phi <16 x float> [ %90, %bb.nph.i ], [ %22, %SyncBB25.i ]
  %vectorPHI17.i = phi <16 x float> [ %89, %bb.nph.i ], [ %21, %SyncBB25.i ]
  %vectorPHI18.i = phi <16 x float> [ %88, %bb.nph.i ], [ %22, %SyncBB25.i ]
  %vectorPHI19.i = phi <16 x float> [ %87, %bb.nph.i ], [ %21, %SyncBB25.i ]
  ...
  %91 = add nsw i32 %j.05.i, 1
  %exitcond.i = icmp eq i32 %91, %4
  br i1 %exitcond.i, label %._crit_edge.i, label %bb.nph.i

._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB25.i
  %vectorPHI20.i = phi <16 x float> [ %22, %SyncBB25.i ], [ %90, %bb.nph.i ]
  %vectorPHI21.i = phi <16 x float> [ %21, %SyncBB25.i ], [ %89, %bb.nph.i ]
  %vectorPHI22.i = phi <16 x float> [ %22, %SyncBB25.i ], [ %88, %bb.nph.i ]
  %vectorPHI23.i = phi <16 x float> [ %21, %SyncBB25.i ], [ %87, %bb.nph.i ]
  %92 = fadd <16 x float> %vectorPHI23.i, %vectorPHI22.i
  %93 = fadd <16 x float> %92, %vectorPHI21.i
  %94 = fadd <16 x float> %93, %vectorPHI20.i
  %ptrTypeCast24.i = bitcast float addrspace(1)* %20 to <16 x float> addrspace(1)*
  store <16 x float> %94, <16 x float> addrspace(1)* %ptrTypeCast24.i, align 4
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %13
  br i1 %check.WI.iter.i, label %thenBB.i, label %____Vectorized_.Add4_separated_args.exit

thenBB.i:                                         ; preds = %._crit_edge.i
  %"CurrWI++.i" = add nuw i64 %CurrWI..0.i, 1
  br label %SyncBB25.i

____Vectorized_.Add4_separated_args.exit:         ; preds = %._crit_edge.i
  ret void
}

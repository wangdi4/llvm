...
; <label>:13                                      ; preds = %13, %SyncBB23
  %s.03 = phi i32 [ %9, %SyncBB23 ], [ %79, %13 ]
  %j.02 = phi i32 [ 0, %SyncBB23 ], [ %77, %13 ]
...
._crit_edge:                                      ; preds = %89, %SyncBB
  ...
  br i1 %check.WI.iter28, label %thenBB25, label %SyncBB22
...
SyncBB323:                                        ; preds = %bb.nph4, %thenBB325
  %CurrSBIndex..1 = phi i64 [ %"loadedCurrSB+Stride331", %thenBB325 ], [ 0, %bb.nph4 ]
  %CurrWI..1 = phi i64 [ %"CurrWI++329", %thenBB325 ], [ 0, %bb.nph4 ]
  ...
  %"&(pSB[currWI].offset)" = add nuw i64 %CurrSBIndex..1, 64
  ...
  %8 = getelementptr %struct.PaddedDimId* %pLocalIds, i64 %CurrWI..1, i32 0, i64 0
  ...
  %"&(pSB[currWI].offset)312" = add nuw i64 %CurrSBIndex..1, 128
...
._crit_edge5:                                     ; preds = %15
  ...
  br i1 %check.WI.iter328, label %thenBB325, label %elseBB326

thenBB325:                                        ; preds = %._crit_edge5
  %"CurrWI++329" = add nuw i64 %CurrWI..1, 1
  %"loadedCurrSB+Stride331" = add nuw i64 %CurrSBIndex..1, 192
  br label %SyncBB323

elseBB326:                                        ; preds = %._crit_edge5
...
SyncBB322:                                        ; preds = %thenBB, %elseBB326
  %CurrSBIndex..0 = phi i64 [ 0, %elseBB326 ], [ %"loadedCurrSB+Stride", %thenBB ]
  %CurrWI..0 = phi i64 [ 0, %elseBB326 ], [ %"CurrWI++", %thenBB ]
  br i1 %822, label %bb.nph, label %._crit_edge

bb.nph:                                           ; preds = %SyncBB322
  %"&(pSB[currWI].offset)316" = add nuw i64 %CurrSBIndex..0, 128
  ...
  %"&(pSB[currWI].offset)308" = add nuw i64 %CurrSBIndex..0, 64
...
._crit_edge:                                      ; preds = %827, %SyncBB322
  %check.WI.iter = icmp ult i64 %CurrWI..0, %iterCount
...
; <label>:33                                      ; preds = %33, %SyncBB23.i
  %s.03.i = phi i32 [ %29, %SyncBB23.i ], [ %99, %33 ]
  %j.02.i = phi i32 [ 0, %SyncBB23.i ], [ %97, %33 ]
...
SyncBB323.i:                                      ; preds = %thenBB325.i, %entry
  %CurrSBIndex..1.i = phi i64 [ %"loadedCurrSB+Stride331.i", %thenBB325.i ], [ 0, %entry ]
  %CurrWI..1.i = phi i64 [ %"CurrWI++329.i", %thenBB325.i ], [ 0, %entry ]
  ...
  %"&(pSB[currWI].offset).i" = add nuw i64 %CurrSBIndex..1.i, 64
  ...
  %28 = getelementptr %struct.PaddedDimId* %13, i64 %CurrWI..1.i, i32 0, i64 0
  ...
  %"&(pSB[currWI].offset)312.i" = add nuw i64 %CurrSBIndex..1.i, 128
...
._crit_edge5.i:                                   ; preds = %35
  ...
  br i1 %check.WI.iter328.i, label %thenBB325.i, label %elseBB326.i

thenBB325.i:                                      ; preds = %._crit_edge5.i
  %"CurrWI++329.i" = add nuw i64 %CurrWI..1.i, 1
  %"loadedCurrSB+Stride331.i" = add nuw i64 %CurrSBIndex..1.i, 192
  br label %SyncBB323.i

elseBB326.i:                                      ; preds = %._crit_edge5.i
  %838 = trunc i64 %33 to i32
  %839 = icmp eq i32 %838, 0
  %840 = select i1 %839, i32 1, i32 %838
  %841 = sdiv i32 4096, %840
  %842 = icmp sgt i32 %841, 0
  br label %SyncBB322.i

SyncBB322.i:                                      ; preds = %thenBB.i, %elseBB326.i
  %CurrSBIndex..0.i = phi i64 [ 0, %elseBB326.i ], [ %"loadedCurrSB+Stride.i", %thenBB.i ]
  %CurrWI..0.i = phi i64 [ 0, %elseBB326.i ], [ %"CurrWI++.i", %thenBB.i ]
  br i1 %842, label %bb.nph.i, label %._crit_edge.i

bb.nph.i:                                         ; preds = %SyncBB322.i
  %"&(pSB[currWI].offset)316.i" = add nuw i64 %CurrSBIndex..0.i, 128
  ...
  %"&(pSB[currWI].offset)308.i" = add nuw i64 %CurrSBIndex..0.i, 64
...
._crit_edge.i:                                    ; preds = %847, %SyncBB322.i
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %16

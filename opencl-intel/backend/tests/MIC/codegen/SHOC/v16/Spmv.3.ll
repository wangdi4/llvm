...
define void @__spmv_csr_scalar_kernel_separated_args(float addrspace(1)* noalias nocapture %val, float addrspace(1)* noalias nocapture %vec, i32 addrspace(1)* noalias nocapture %cols, i32 addrspace(1)* noalias nocapture %rowDelimiters, i32 %dim, float addrspace(1)* noalias nocapture %out, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
; <label>:0
  br label %SyncBB
...
; <label>:17                                      ; preds = %17, %bb.nph
  ...
  %t.01 = phi float [ 0.000000e+00, %bb.nph ], [ %24, %17 ]
  ...
  %19 = load float addrspace(1)* %scevgep8, align 4
  %20 = sext i32 %18 to i64
  %21 = getelementptr inbounds float addrspace(1)* %vec, i64 %20
  %22 = load float addrspace(1)* %21, align 4
  %23 = fmul float %19, %22
  %24 = fadd float %t.01, %23
  %indvar.next = add i64 %indvar, 1
  %exitcond = icmp eq i64 %indvar.next, %tmp5
  br i1 %exitcond, label %._crit_edge, label %17

._crit_edge:                                      ; preds = %17, %8
  %t.0.lcssa = phi float [ 0.000000e+00, %8 ], [ %24, %17 ]
  %25 = getelementptr inbounds float addrspace(1)* %out, i64 %9
  store float %t.0.lcssa, float addrspace(1)* %25, align 4
...
define void @__spmv_csr_vector_kernel_separated_args(float addrspace(1)* noalias nocapture %val, float addrspace(1)* noalias nocapture %vec, i32 addrspace(1)* noalias nocapture %cols, i32 addrspace(1)* noalias nocapture %rowDelimiters, i32 %dim, float addrspace(1)* noalias nocapture %out, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
; <label>:0
  %1 = bitcast i8 addrspace(3)* %pLocalMem to [128 x float] addrspace(3)*
...
SyncBB158:                                        ; preds = %thenBB168, %SyncBB158.outer
  ...
  %17 = getelementptr inbounds [128 x float] addrspace(3)* %1, i64 0, i64 %16
  ...
  %CastToValueType74 = bitcast i8* %"&pSB[currWI].offset73" to float addrspace(3)**
  store float addrspace(3)* %17, float addrspace(3)** %CastToValueType74, align 8
  volatile store float 0.000000e+00, float addrspace(3)* %17, align 4
...
; <label>:29                                      ; preds = %29, %bb.nph
  ...
  %mySum.01 = phi float [ 0.000000e+00, %bb.nph ], [ %36, %29 ]
  %tmp = shl i64 %indvar, 5
  %tmp7 = add i64 %tmp6, %tmp
  %scevgep = getelementptr i32 addrspace(1)* %cols, i64 %tmp7
  %scevgep8 = getelementptr float addrspace(1)* %val, i64 %tmp7
  %30 = load i32 addrspace(1)* %scevgep, align 4
  %31 = load float addrspace(1)* %scevgep8, align 4
  %32 = sext i32 %30 to i64
  %33 = getelementptr inbounds float addrspace(1)* %vec, i64 %32
  %34 = load float addrspace(1)* %33, align 4
  %35 = fmul float %31, %34
  %36 = fadd float %mySum.01, %35
...
._crit_edge:                                      ; preds = %29, %19
  %mySum.0.lcssa = phi float [ 0.000000e+00, %19 ], [ %36, %29 ]
  ...
  %CastToValueType133 = bitcast i8* %"&pSB[currWI].offset132" to float addrspace(3)**
  %loadedValue134 = load float addrspace(3)** %CastToValueType133, align 8
  volatile store float %mySum.0.lcssa, float addrspace(3)* %loadedValue134, align 4
...
; <label>:39                                      ; preds = %SyncBB154
  ...
  %42 = getelementptr inbounds [128 x float] addrspace(3)* %1, i64 0, i64 %41
  %43 = volatile load float addrspace(3)* %42, align 4
  ...
  %CastToValueType123 = bitcast i8* %"&pSB[currWI].offset122" to float addrspace(3)**
  %loadedValue124 = load float addrspace(3)** %CastToValueType123, align 8
  %44 = volatile load float addrspace(3)* %loadedValue124, align 4
  %45 = fadd float %44, %43
  ...
  %CastToValueType128 = bitcast i8* %"&pSB[currWI].offset127" to float addrspace(3)**
  %loadedValue129 = load float addrspace(3)** %CastToValueType128, align 8
  volatile store float %45, float addrspace(3)* %loadedValue129, align 4
  br label %46
...
; <label>:48                                      ; preds = %SyncBB155
  ...
  %51 = getelementptr inbounds [128 x float] addrspace(3)* %1, i64 0, i64 %50
  %52 = volatile load float addrspace(3)* %51, align 4
  ...
  %CastToValueType113 = bitcast i8* %"&pSB[currWI].offset112" to float addrspace(3)**
  %loadedValue114 = load float addrspace(3)** %CastToValueType113, align 8
  %53 = volatile load float addrspace(3)* %loadedValue114, align 4
  %54 = fadd float %53, %52
  ...
  %CastToValueType118 = bitcast i8* %"&pSB[currWI].offset117" to float addrspace(3)**
  %loadedValue119 = load float addrspace(3)** %CastToValueType118, align 8
  volatile store float %54, float addrspace(3)* %loadedValue119, align 4
  br label %55
...
; <label>:57                                      ; preds = %SyncBB
  ...
  %60 = getelementptr inbounds [128 x float] addrspace(3)* %1, i64 0, i64 %59
  %61 = volatile load float addrspace(3)* %60, align 4
  ...
  %CastToValueType103 = bitcast i8* %"&pSB[currWI].offset102" to float addrspace(3)**
  %loadedValue104 = load float addrspace(3)** %CastToValueType103, align 8
  %62 = volatile load float addrspace(3)* %loadedValue104, align 4
  %63 = fadd float %62, %61
  ...
  %CastToValueType108 = bitcast i8* %"&pSB[currWI].offset107" to float addrspace(3)**
  %loadedValue109 = load float addrspace(3)** %CastToValueType108, align 8
  volatile store float %63, float addrspace(3)* %loadedValue109, align 4
  br label %64
...
; <label>:66                                      ; preds = %SyncBB153
  ...
  %69 = getelementptr inbounds [128 x float] addrspace(3)* %1, i64 0, i64 %68
  ...
  %71 = volatile load float addrspace(3)* %loadedValue94, align 4
  %72 = fadd float %71, %70
  ...
  %CastToValueType98 = bitcast i8* %"&pSB[currWI].offset97" to float addrspace(3)**
  %loadedValue99 = load float addrspace(3)** %CastToValueType98, align 8
  volatile store float %72, float addrspace(3)* %loadedValue99, align 4
  br label %73
...
; <label>:75                                      ; preds = %SyncBB156
  ...
  %78 = getelementptr inbounds [128 x float] addrspace(3)* %1, i64 0, i64 %77
  %79 = volatile load float addrspace(3)* %78, align 4
  ...
  %CastToValueType83 = bitcast i8* %"&pSB[currWI].offset82" to float addrspace(3)**
  %loadedValue84 = load float addrspace(3)** %CastToValueType83, align 8
  %80 = volatile load float addrspace(3)* %loadedValue84, align 4
  %81 = fadd float %80, %79
  ...
  %CastToValueType88 = bitcast i8* %"&pSB[currWI].offset87" to float addrspace(3)**
  %loadedValue89 = load float addrspace(3)** %CastToValueType88, align 8
  volatile store float %81, float addrspace(3)* %loadedValue89, align 4
  br label %82
...
; <label>:83                                      ; preds = %SyncBB157
  ...
  %CastToValueType78 = bitcast i8* %"&pSB[currWI].offset77" to float addrspace(3)**
  %loadedValue79 = load float addrspace(3)** %CastToValueType78, align 8
  %84 = volatile load float addrspace(3)* %loadedValue79, align 4
  ...
  %85 = getelementptr inbounds float addrspace(1)* %out, i64 %loadedValue143
  store float %84, float addrspace(1)* %85, align 4
  br label %UnifiedReturnBlock
...
define void @__spmv_ellpackr_kernel_separated_args(float addrspace(1)* noalias nocapture %val, float addrspace(1)* noalias nocapture %vec, i32 addrspace(1)* noalias nocapture %cols, i32 addrspace(1)* noalias nocapture %rowLengths, i32 %dim, float addrspace(1)* noalias nocapture %out, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
; <label>:0
  br label %SyncBB
...
bb.nph:                                           ; preds = %8, %bb.nph
  ...
  %result.01 = phi float [ %22, %bb.nph ], [ 0.000000e+00, %8 ]
  %tmp = mul i32 %i.02, %dim
  %tmp4 = add i32 %6, %tmp
  %13 = sext i32 %tmp4 to i64
  %14 = getelementptr inbounds float addrspace(1)* %val, i64 %13
  ...
  %19 = getelementptr inbounds float addrspace(1)* %vec, i64 %18
  %20 = load float addrspace(1)* %19, align 4
  %21 = fmul float %15, %20
  %22 = fadd float %result.01, %21
  %23 = add nsw i32 %i.02, 1
  %exitcond = icmp eq i32 %23, %11
  br i1 %exitcond, label %._crit_edge, label %bb.nph

._crit_edge:                                      ; preds = %bb.nph, %8
  %result.0.lcssa = phi float [ 0.000000e+00, %8 ], [ %22, %bb.nph ]
  %24 = getelementptr inbounds float addrspace(1)* %out, i64 %9
  store float %result.0.lcssa, float addrspace(1)* %24, align 4
  br label %UnifiedReturnBlock
...
SyncBB158.i:                                      ; preds = %thenBB168.i, %SyncBB158.outer.i
  ...
  %51 = getelementptr inbounds [128 x float] addrspace(3)* %35, i64 0, i64 %50
  ...
  store float addrspace(3)* %51, float addrspace(3)** %CastToValueType74.i, align 8
  volatile store float 0.000000e+00, float addrspace(3)* %51, align 4
...
._crit_edge.i:                                    ; preds = %63, %53
  %mySum.0.lcssa.i = phi float [ 0.000000e+00, %53 ], [ %70, %63 ]
  ...
  %CastToValueType133.i = bitcast i8* %"&pSB[currWI].offset132.i" to float addrspace(3)**
  %loadedValue134.i = load float addrspace(3)** %CastToValueType133.i, align 8
  volatile store float %mySum.0.lcssa.i, float addrspace(3)* %loadedValue134.i, align 4
...
; <label>:73                                      ; preds = %SyncBB154.i
  ...
  %76 = getelementptr inbounds [128 x float] addrspace(3)* %35, i64 0, i64 %75
  %77 = volatile load float addrspace(3)* %76, align 4
  ...
  %CastToValueType123.i = bitcast i8* %"&pSB[currWI].offset122.i" to float addrspace(3)**
  %loadedValue124.i = load float addrspace(3)** %CastToValueType123.i, align 8
  %78 = volatile load float addrspace(3)* %loadedValue124.i, align 4
  %79 = fadd float %78, %77
  ...
  %CastToValueType128.i = bitcast i8* %"&pSB[currWI].offset127.i" to float addrspace(3)**
  %loadedValue129.i = load float addrspace(3)** %CastToValueType128.i, align 8
  volatile store float %79, float addrspace(3)* %loadedValue129.i, align 4
  br label %80
...
; <label>:82                                      ; preds = %SyncBB155.i
  ...
  %85 = getelementptr inbounds [128 x float] addrspace(3)* %35, i64 0, i64 %84
  %86 = volatile load float addrspace(3)* %85, align 4
  ...
  %CastToValueType113.i = bitcast i8* %"&pSB[currWI].offset112.i" to float addrspace(3)**
  %loadedValue114.i = load float addrspace(3)** %CastToValueType113.i, align 8
  %87 = volatile load float addrspace(3)* %loadedValue114.i, align 4
  %88 = fadd float %87, %86
  ...
  %CastToValueType118.i = bitcast i8* %"&pSB[currWI].offset117.i" to float addrspace(3)**
  %loadedValue119.i = load float addrspace(3)** %CastToValueType118.i, align 8
  volatile store float %88, float addrspace(3)* %loadedValue119.i, align 4
  br label %89
...
; <label>:91                                      ; preds = %SyncBB.i
  ...
  %94 = getelementptr inbounds [128 x float] addrspace(3)* %35, i64 0, i64 %93
  ...
  %CastToValueType103.i = bitcast i8* %"&pSB[currWI].offset102.i" to float addrspace(3)**
  %loadedValue104.i = load float addrspace(3)** %CastToValueType103.i, align 8
  %96 = volatile load float addrspace(3)* %loadedValue104.i, align 4
  %97 = fadd float %96, %95
  ...
  %loadedValue109.i = load float addrspace(3)** %CastToValueType108.i, align 8
  volatile store float %97, float addrspace(3)* %loadedValue109.i, align 4
  br label %98
...
; <label>:100                                     ; preds = %SyncBB153.i
  ...
  %103 = getelementptr inbounds [128 x float] addrspace(3)* %35, i64 0, i64 %102
  %104 = volatile load float addrspace(3)* %103, align 4
  ...
  %105 = volatile load float addrspace(3)* %loadedValue94.i, align 4
  ...
  %CastToValueType98.i = bitcast i8* %"&pSB[currWI].offset97.i" to float addrspace(3)**
  %loadedValue99.i = load float addrspace(3)** %CastToValueType98.i, align 8
  volatile store float %106, float addrspace(3)* %loadedValue99.i, align 4
  br label %107
...
; <label>:109                                     ; preds = %SyncBB156.i
  ...
  %112 = getelementptr inbounds [128 x float] addrspace(3)* %35, i64 0, i64 %111
  %113 = volatile load float addrspace(3)* %112, align 4
  ...
  %CastToValueType83.i = bitcast i8* %"&pSB[currWI].offset82.i" to float addrspace(3)**
  %loadedValue84.i = load float addrspace(3)** %CastToValueType83.i, align 8
  %114 = volatile load float addrspace(3)* %loadedValue84.i, align 4
  ...
  %CastToValueType88.i = bitcast i8* %"&pSB[currWI].offset87.i" to float addrspace(3)**
  %loadedValue89.i = load float addrspace(3)** %CastToValueType88.i, align 8
  volatile store float %115, float addrspace(3)* %loadedValue89.i, align 4
  br label %116
...
; <label>:117                                     ; preds = %SyncBB157.i
  ...
  %CastToValueType78.i = bitcast i8* %"&pSB[currWI].offset77.i" to float addrspace(3)**
  %loadedValue79.i = load float addrspace(3)** %CastToValueType78.i, align 8
  %118 = volatile load float addrspace(3)* %loadedValue79.i, align 4
  ...
  %119 = getelementptr inbounds float addrspace(1)* %16, i64 %loadedValue143.i
...
; <label>:42                                      ; preds = %42, %bb.nph.i
  ...
  %t.01.i = phi float [ 0.000000e+00, %bb.nph.i ], [ %49, %42 ]
  %tmp7.i = add i64 %tmp6.i, %indvar.i
  %scevgep.i = getelementptr i32 addrspace(1)* %7, i64 %tmp7.i
  %scevgep8.i = getelementptr float addrspace(1)* %1, i64 %tmp7.i
  %43 = load i32 addrspace(1)* %scevgep.i, align 4
  %44 = load float addrspace(1)* %scevgep8.i, align 4
  %45 = sext i32 %43 to i64
  %46 = getelementptr inbounds float addrspace(1)* %4, i64 %45
  %47 = load float addrspace(1)* %46, align 4
  %48 = fmul float %44, %47
  %49 = fadd float %t.01.i, %48
  %indvar.next.i = add i64 %indvar.i, 1
  %exitcond.i = icmp eq i64 %indvar.next.i, %tmp5.i
  br i1 %exitcond.i, label %._crit_edge.i, label %42

._crit_edge.i:                                    ; preds = %42, %33
  %t.0.lcssa.i = phi float [ 0.000000e+00, %33 ], [ %49, %42 ]
  %50 = getelementptr inbounds float addrspace(1)* %16, i64 %34
  store float %t.0.lcssa.i, float addrspace(1)* %50, align 4
  br label %UnifiedReturnBlock.i
...
bb.nph.i:                                         ; preds = %bb.nph.i, %33
  ...
  %result.01.i = phi float [ %47, %bb.nph.i ], [ 0.000000e+00, %33 ]
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %33
  %result.0.lcssa.i = phi float [ 0.000000e+00, %33 ], [ %47, %bb.nph.i ]
  %49 = getelementptr inbounds float addrspace(1)* %16, i64 %34
  store float %result.0.lcssa.i, float addrspace(1)* %49, align 4
  br label %UnifiedReturnBlock.i
...
!0 = metadata !{void (float addrspace(1)*, float addrspace(1)*, i32 addrspace(1)*, i32 addrspace(1)*, i32, float addrspace(1)*, i8 addrspace(3)*, %struct.WorkDim*, i64*, %struct.PaddedDimId*, %struct.PaddedDimId*, i64*, i64, i8*, i64*)* @__spmv_csr_scalar_kernel_separated_args, metadata !1, metadata !1, metadata !"float4", metadata !"float const __attribute__((address_space(1))) *restrict, float const __attribute__((address_space(1))) *restrict, int const __attribute__((address_space(1))) *restrict, int const __attribute__((address_space(1))) *restrict, int const, float __attribute__((address_space(1))) *restrict", metadata !"opencl_spmv_csr_scalar_kernel_locals_anchor", void (i8*)* @spmv_csr_scalar_kernel}
!1 = metadata !{i32 0, i32 0, i32 0}
!2 = metadata !{void (float addrspace(1)*, float addrspace(1)*, i32 addrspace(1)*, i32 addrspace(1)*, i32, float addrspace(1)*, i8 addrspace(3)*, %struct.WorkDim*, i64*, %struct.PaddedDimId*, %struct.PaddedDimId*, i64*, i64, i8*, i64*)* @__spmv_csr_vector_kernel_separated_args, metadata !1, metadata !1, metadata !"float4", metadata !"float const __attribute__((address_space(1))) *restrict, float const __attribute__((address_space(1))) *restrict, int const __attribute__((address_space(1))) *restrict, int const __attribute__((address_space(1))) *restrict, int const, float __attribute__((address_space(1))) *restrict", metadata !"opencl_spmv_csr_vector_kernel_locals_anchor", void (i8*)* @spmv_csr_vector_kernel}
!3 = metadata !{void (float addrspace(1)*, float addrspace(1)*, i32 addrspace(1)*, i32 addrspace(1)*, i32, float addrspace(1)*, i8 addrspace(3)*, %struct.WorkDim*, i64*, %struct.PaddedDimId*, %struct.PaddedDimId*, i64*, i64, i8*, i64*)* @__spmv_ellpackr_kernel_separated_args, metadata !1, metadata !1, metadata !"float4", metadata !"float const __attribute__((address_space(1))) *restrict, float const __attribute__((address_space(1))) *restrict, int const __attribute__((address_space(1))) *restrict, int const __attribute__((address_space(1))) *restrict, int const, float __attribute__((address_space(1))) *restrict", metadata !"opencl_spmv_ellpackr_kernel_locals_anchor", void (i8*)* @spmv_ellpackr_kernel}

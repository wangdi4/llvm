...
; <label>:10                                      ; preds = %10, %SyncBB272
  %vectorPHI = phi <16 x i32> [ %8, %SyncBB272 ], [ %812, %10 ]
  %j.01 = phi i32 [ 0, %SyncBB272 ], [ %810, %10 ]
...
entry:
  ...
  br label %SyncBB272.i

SyncBB272.i:                                      ; preds = %thenBB.i, %entry
  %CurrWI..0.i = phi i64 [ 0, %entry ], [ %"CurrWI++.i", %thenBB.i ]
  %15 = getelementptr %struct.PaddedDimId* %10, i64 %CurrWI..0.i, i32 0, i64 0
  %16 = load i64* %15, align 8
  %17 = getelementptr %struct.PaddedDimId* %7, i64 0, i32 0, i64 0
...
; <label>:24                                      ; preds = %24, %SyncBB272.i
  %vectorPHI.i = phi <16 x i32> [ %22, %SyncBB272.i ], [ %826, %24 ]
  %j.01.i = phi i32 [ 0, %SyncBB272.i ], [ %824, %24 ]

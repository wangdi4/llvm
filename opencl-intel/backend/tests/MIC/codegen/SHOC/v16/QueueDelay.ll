...
declare void @____Vectorized_.one_original(i32 addrspace(1)* nocapture) nounwind readnone

declare void @____Vectorized_.two_original(i32 addrspace(1)* nocapture) nounwind readnone

declare void @____Vectorized_.three_original(i32 addrspace(1)* nocapture) nounwind readnone

declare void @____Vectorized_.four_original(i32 addrspace(1)* nocapture) nounwind readnone
...
define void @____Vectorized_.one_separated_args(i32 addrspace(1)* nocapture %a, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind readnone alwaysinline {
  ret void
}

define void @____Vectorized_.two_separated_args(i32 addrspace(1)* nocapture %b, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind readnone alwaysinline {
  ret void
}

define void @____Vectorized_.three_separated_args(i32 addrspace(1)* nocapture %c, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind readnone alwaysinline {
  ret void
}

define void @____Vectorized_.four_separated_args(i32 addrspace(1)* nocapture %d, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind readnone alwaysinline {
  ret void
}
...
define void @__Vectorized_.three(i8* %pBuffer) {
entry:
  ret void
}

define void @__Vectorized_.one(i8* %pBuffer) {
entry:
  ret void
}

define void @__Vectorized_.two(i8* %pBuffer) {
entry:
  ret void
}

define void @__Vectorized_.four(i8* %pBuffer) {
entry:
  ret void
}

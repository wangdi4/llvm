...
SyncBB154.outer:                                  ; preds = %0, %thenBB196
...
SyncBB154:                                        ; preds = %thenBB168, %SyncBB154.outer
  %CurrWI..4 = phi i64 [ %"CurrWI++172", %thenBB168 ], [ %CurrWI..4.ph, %SyncBB154.outer ]
  %CurrSBIndex..4 = phi i64 [ %"loadedCurrSB+Stride174", %thenBB168 ], [ %CurrSBIndex..4.ph, %SyncBB154.outer ]
...
SyncBB158:                                        ; preds = %82, %thenBB196
  ...
  %currBarrier.0 = phi i32 [ %currBarrier.2, %thenBB196 ], [ 6, %82 ]
...
UnifiedReturnBlock:                               ; preds = %SyncBB158, %SyncBB154, %83
  %CurrWI..3 = phi i64 [ %CurrWI..1, %83 ], [ %CurrWI..1, %SyncBB158 ], [ %CurrWI..4, %SyncBB154 ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..1, %83 ], [ %CurrSBIndex..1, %SyncBB158 ], [ %CurrSBIndex..4, %SyncBB154 ]
  %currBarrier.2 = phi i32 [ %currBarrier.0, %83 ], [ %currBarrier.0, %SyncBB158 ], [ %currBarrier.3.ph, %SyncBB154 ]
...
thenBB196:                                        ; preds = %UnifiedReturnBlock
  ...
  br i1 %cond, label %SyncBB154.outer, label %SyncBB158
...
SyncBB154.outer.i:                                ; preds = %thenBB196.i, %entry
...
SyncBB154.i:                                      ; preds = %thenBB168.i, %SyncBB154.outer.i
  %CurrWI..4.i = phi i64 [ %"CurrWI++172.i", %thenBB168.i ], [ %CurrWI..4.ph.i, %SyncBB154.outer.i ]
  %CurrSBIndex..4.i = phi i64 [ %"loadedCurrSB+Stride174.i", %thenBB168.i ], [ %CurrSBIndex..4.ph.i, %SyncBB154.outer.i ]
...
SyncBB158.i:                                      ; preds = %thenBB196.i, %116
  ...
  %currBarrier.0.i = phi i32 [ %currBarrier.2.i, %thenBB196.i ], [ 6, %116 ]
...
UnifiedReturnBlock.i:                             ; preds = %117, %SyncBB158.i, %SyncBB154.i
  %CurrWI..3.i = phi i64 [ %CurrWI..1.i, %117 ], [ %CurrWI..1.i, %SyncBB158.i ], [ %CurrWI..4.i, %SyncBB154.i ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..1.i, %117 ], [ %CurrSBIndex..1.i, %SyncBB158.i ], [ %CurrSBIndex..4.i, %SyncBB154.i ]
  %currBarrier.2.i = phi i32 [ %currBarrier.0.i, %117 ], [ %currBarrier.0.i, %SyncBB158.i ], [ %currBarrier.3.ph.i, %SyncBB154.i ]
...
thenBB196.i:                                      ; preds = %UnifiedReturnBlock.i
  ...
  br i1 %cond.i, label %SyncBB154.outer.i, label %SyncBB158.i

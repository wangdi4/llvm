...
declare void @____Vectorized_.MulMAdd8_original(double addrspace(1)* nocapture, i32) nounwind
...
bb.nph:                                           ; preds = %SyncBB, %bb.nph
  ...
  %s7.07 = phi double [ %150, %bb.nph ], [ %8, %SyncBB ]
  %s6.06 = phi double [ %147, %bb.nph ], [ %9, %SyncBB ]
  %s.05 = phi double [ %132, %bb.nph ], [ %8, %SyncBB ]
  %s2.04 = phi double [ %135, %bb.nph ], [ %9, %SyncBB ]
  %s3.03 = phi double [ %138, %bb.nph ], [ %8, %SyncBB ]
  %s4.02 = phi double [ %141, %bb.nph ], [ %9, %SyncBB ]
  %s5.01 = phi double [ %144, %bb.nph ], [ %8, %SyncBB ]
...
._crit_edge:                                      ; preds = %bb.nph, %SyncBB
  ...
  %s7.0.lcssa = phi double [ %8, %SyncBB ], [ %150, %bb.nph ]
  %s6.0.lcssa = phi double [ %9, %SyncBB ], [ %147, %bb.nph ]
  %s.0.lcssa = phi double [ %8, %SyncBB ], [ %132, %bb.nph ]
  %s2.0.lcssa = phi double [ %9, %SyncBB ], [ %135, %bb.nph ]
  %s3.0.lcssa = phi double [ %8, %SyncBB ], [ %138, %bb.nph ]
  %s4.0.lcssa = phi double [ %9, %SyncBB ], [ %141, %bb.nph ]
  %s5.0.lcssa = phi double [ %8, %SyncBB ], [ %144, %bb.nph ]
...
define void @____Vectorized_.MulMAdd8_separated_args(double addrspace(1)* nocapture %data, i32 %nIters, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
FirstBB:
  %0 = icmp sgt i32 %nIters, 0
  br label %SyncBB33
...
bb.nph:                                           ; preds = %SyncBB33, %bb.nph
  %j.09 = phi i32 [ %153, %bb.nph ], [ 0, %SyncBB33 ]
  %vectorPHI = phi <16 x double> [ %152, %bb.nph ], [ %8, %SyncBB33 ]
  %vectorPHI17 = phi <16 x double> [ %149, %bb.nph ], [ %7, %SyncBB33 ]
  %vectorPHI18 = phi <16 x double> [ %146, %bb.nph ], [ %8, %SyncBB33 ]
  %vectorPHI19 = phi <16 x double> [ %131, %bb.nph ], [ %7, %SyncBB33 ]
  %vectorPHI20 = phi <16 x double> [ %134, %bb.nph ], [ %8, %SyncBB33 ]
  %vectorPHI21 = phi <16 x double> [ %137, %bb.nph ], [ %7, %SyncBB33 ]
  %vectorPHI22 = phi <16 x double> [ %140, %bb.nph ], [ %8, %SyncBB33 ]
  %vectorPHI23 = phi <16 x double> [ %143, %bb.nph ], [ %7, %SyncBB33 ]
  ...
  %12 = fmul <16 x double> %vectorPHI20, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %14 = fmul <16 x double> %13, %vectorPHI20
  %15 = fmul <16 x double> %vectorPHI21, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %17 = fmul <16 x double> %16, %vectorPHI21
  %18 = fmul <16 x double> %vectorPHI22, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %23 = fmul <16 x double> %22, %vectorPHI23
  %24 = fmul <16 x double> %vectorPHI18, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %26 = fmul <16 x double> %25, %vectorPHI18
  %27 = fmul <16 x double> %vectorPHI17, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %29 = fmul <16 x double> %28, %vectorPHI17
  %30 = fmul <16 x double> %vectorPHI, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %32 = fmul <16 x double> %31, %vectorPHI
  %33 = fmul <16 x double> %11, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %35 = fmul <16 x double> %34, %11
  %36 = fmul <16 x double> %14, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %38 = fmul <16 x double> %37, %14
  %39 = fmul <16 x double> %17, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %41 = fmul <16 x double> %40, %17
  %42 = fmul <16 x double> %20, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %44 = fmul <16 x double> %43, %20
  %45 = fmul <16 x double> %23, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %47 = fmul <16 x double> %46, %23
  %48 = fmul <16 x double> %26, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %50 = fmul <16 x double> %49, %26
  %51 = fmul <16 x double> %29, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %53 = fmul <16 x double> %52, %29
  %54 = fmul <16 x double> %32, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %56 = fmul <16 x double> %55, %32
  %57 = fmul <16 x double> %35, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %59 = fmul <16 x double> %58, %35
  %60 = fmul <16 x double> %38, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %62 = fmul <16 x double> %61, %38
  %63 = fmul <16 x double> %41, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %65 = fmul <16 x double> %64, %41
  %66 = fmul <16 x double> %44, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %68 = fmul <16 x double> %67, %44
  %69 = fmul <16 x double> %47, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %71 = fmul <16 x double> %70, %47
  %72 = fmul <16 x double> %50, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %74 = fmul <16 x double> %73, %50
  %75 = fmul <16 x double> %53, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %77 = fmul <16 x double> %76, %53
  %78 = fmul <16 x double> %56, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %80 = fmul <16 x double> %79, %56
  %81 = fmul <16 x double> %59, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %83 = fmul <16 x double> %82, %59
  %84 = fmul <16 x double> %62, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %86 = fmul <16 x double> %85, %62
  %87 = fmul <16 x double> %65, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %89 = fmul <16 x double> %88, %65
  %90 = fmul <16 x double> %68, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %92 = fmul <16 x double> %91, %68
  %93 = fmul <16 x double> %71, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %95 = fmul <16 x double> %94, %71
  %96 = fmul <16 x double> %74, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %98 = fmul <16 x double> %97, %74
  %99 = fmul <16 x double> %77, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %104 = fmul <16 x double> %103, %80
  %105 = fmul <16 x double> %83, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %107 = fmul <16 x double> %106, %83
  %108 = fmul <16 x double> %86, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %110 = fmul <16 x double> %109, %86
  %111 = fmul <16 x double> %89, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %113 = fmul <16 x double> %112, %89
  %114 = fmul <16 x double> %92, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %116 = fmul <16 x double> %115, %92
  %117 = fmul <16 x double> %95, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %119 = fmul <16 x double> %118, %95
  %120 = fmul <16 x double> %98, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %122 = fmul <16 x double> %121, %98
  %123 = fmul <16 x double> %101, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %125 = fmul <16 x double> %124, %101
  %126 = fmul <16 x double> %104, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %128 = fmul <16 x double> %127, %104
  %129 = fmul <16 x double> %107, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %131 = fmul <16 x double> %130, %107
  %132 = fmul <16 x double> %110, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %134 = fmul <16 x double> %133, %110
  %135 = fmul <16 x double> %113, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %137 = fmul <16 x double> %136, %113
  %138 = fmul <16 x double> %116, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %140 = fmul <16 x double> %139, %116
  %141 = fmul <16 x double> %119, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %143 = fmul <16 x double> %142, %119
  %144 = fmul <16 x double> %122, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %146 = fmul <16 x double> %145, %122
  %147 = fmul <16 x double> %125, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %149 = fmul <16 x double> %148, %125
  %150 = fmul <16 x double> %128, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %152 = fmul <16 x double> %151, %128
  %153 = add nsw i32 %j.09, 1
  %exitcond = icmp eq i32 %153, %nIters
  br i1 %exitcond, label %._crit_edge, label %bb.nph

._crit_edge:                                      ; preds = %bb.nph, %SyncBB33
  %vectorPHI24 = phi <16 x double> [ %8, %SyncBB33 ], [ %152, %bb.nph ]
  %vectorPHI25 = phi <16 x double> [ %7, %SyncBB33 ], [ %149, %bb.nph ]
  %vectorPHI26 = phi <16 x double> [ %8, %SyncBB33 ], [ %146, %bb.nph ]
  %vectorPHI27 = phi <16 x double> [ %7, %SyncBB33 ], [ %131, %bb.nph ]
  %vectorPHI28 = phi <16 x double> [ %8, %SyncBB33 ], [ %134, %bb.nph ]
  %vectorPHI29 = phi <16 x double> [ %7, %SyncBB33 ], [ %137, %bb.nph ]
  %vectorPHI30 = phi <16 x double> [ %8, %SyncBB33 ], [ %140, %bb.nph ]
  %vectorPHI31 = phi <16 x double> [ %7, %SyncBB33 ], [ %143, %bb.nph ]
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB.i
  ...
  %s7.07.i = phi double [ %164, %bb.nph.i ], [ %22, %SyncBB.i ]
  %s6.06.i = phi double [ %161, %bb.nph.i ], [ %23, %SyncBB.i ]
  %s.05.i = phi double [ %146, %bb.nph.i ], [ %22, %SyncBB.i ]
  %s2.04.i = phi double [ %149, %bb.nph.i ], [ %23, %SyncBB.i ]
  %s3.03.i = phi double [ %152, %bb.nph.i ], [ %22, %SyncBB.i ]
  %s4.02.i = phi double [ %155, %bb.nph.i ], [ %23, %SyncBB.i ]
  %s5.01.i = phi double [ %158, %bb.nph.i ], [ %22, %SyncBB.i ]
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB.i
  ...
  %s7.0.lcssa.i = phi double [ %22, %SyncBB.i ], [ %164, %bb.nph.i ]
  %s6.0.lcssa.i = phi double [ %23, %SyncBB.i ], [ %161, %bb.nph.i ]
  %s.0.lcssa.i = phi double [ %22, %SyncBB.i ], [ %146, %bb.nph.i ]
  %s2.0.lcssa.i = phi double [ %23, %SyncBB.i ], [ %149, %bb.nph.i ]
  %s3.0.lcssa.i = phi double [ %22, %SyncBB.i ], [ %152, %bb.nph.i ]
  %s4.0.lcssa.i = phi double [ %23, %SyncBB.i ], [ %155, %bb.nph.i ]
  %s5.0.lcssa.i = phi double [ %22, %SyncBB.i ], [ %158, %bb.nph.i ]
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB33.i
  %j.09.i = phi i32 [ %167, %bb.nph.i ], [ 0, %SyncBB33.i ]
  %vectorPHI.i = phi <16 x double> [ %166, %bb.nph.i ], [ %22, %SyncBB33.i ]
  %vectorPHI17.i = phi <16 x double> [ %163, %bb.nph.i ], [ %21, %SyncBB33.i ]
  %vectorPHI18.i = phi <16 x double> [ %160, %bb.nph.i ], [ %22, %SyncBB33.i ]
  %vectorPHI19.i = phi <16 x double> [ %145, %bb.nph.i ], [ %21, %SyncBB33.i ]
  %vectorPHI20.i = phi <16 x double> [ %148, %bb.nph.i ], [ %22, %SyncBB33.i ]
  %vectorPHI21.i = phi <16 x double> [ %151, %bb.nph.i ], [ %21, %SyncBB33.i ]
  %vectorPHI22.i = phi <16 x double> [ %154, %bb.nph.i ], [ %22, %SyncBB33.i ]
  %vectorPHI23.i = phi <16 x double> [ %157, %bb.nph.i ], [ %21, %SyncBB33.i ]
  ...
  %26 = fmul <16 x double> %vectorPHI20.i, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %28 = fmul <16 x double> %27, %vectorPHI20.i
  %29 = fmul <16 x double> %vectorPHI21.i, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %31 = fmul <16 x double> %30, %vectorPHI21.i
  %32 = fmul <16 x double> %vectorPHI22.i, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %37 = fmul <16 x double> %36, %vectorPHI23.i
  %38 = fmul <16 x double> %vectorPHI18.i, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %40 = fmul <16 x double> %39, %vectorPHI18.i
  %41 = fmul <16 x double> %vectorPHI17.i, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %43 = fmul <16 x double> %42, %vectorPHI17.i
  %44 = fmul <16 x double> %vectorPHI.i, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %46 = fmul <16 x double> %45, %vectorPHI.i
  %47 = fmul <16 x double> %25, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %49 = fmul <16 x double> %48, %25
  %50 = fmul <16 x double> %28, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %52 = fmul <16 x double> %51, %28
  %53 = fmul <16 x double> %31, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %55 = fmul <16 x double> %54, %31
  %56 = fmul <16 x double> %34, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %58 = fmul <16 x double> %57, %34
  %59 = fmul <16 x double> %37, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %61 = fmul <16 x double> %60, %37
  %62 = fmul <16 x double> %40, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %64 = fmul <16 x double> %63, %40
  %65 = fmul <16 x double> %43, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %67 = fmul <16 x double> %66, %43
  %68 = fmul <16 x double> %46, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %70 = fmul <16 x double> %69, %46
  %71 = fmul <16 x double> %49, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %73 = fmul <16 x double> %72, %49
  %74 = fmul <16 x double> %52, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %76 = fmul <16 x double> %75, %52
  %77 = fmul <16 x double> %55, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %79 = fmul <16 x double> %78, %55
  %80 = fmul <16 x double> %58, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %82 = fmul <16 x double> %81, %58
  %83 = fmul <16 x double> %61, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %85 = fmul <16 x double> %84, %61
  %86 = fmul <16 x double> %64, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %88 = fmul <16 x double> %87, %64
  %89 = fmul <16 x double> %67, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %91 = fmul <16 x double> %90, %67
  %92 = fmul <16 x double> %70, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %94 = fmul <16 x double> %93, %70
  %95 = fmul <16 x double> %73, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %97 = fmul <16 x double> %96, %73
  %98 = fmul <16 x double> %76, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %100 = fmul <16 x double> %99, %76
  %101 = fmul <16 x double> %79, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %103 = fmul <16 x double> %102, %79
  %104 = fmul <16 x double> %82, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %106 = fmul <16 x double> %105, %82
  %107 = fmul <16 x double> %85, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %109 = fmul <16 x double> %108, %85
  %110 = fmul <16 x double> %88, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %112 = fmul <16 x double> %111, %88
  %113 = fmul <16 x double> %91, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %115 = fmul <16 x double> %114, %91
  %116 = fmul <16 x double> %94, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %118 = fmul <16 x double> %117, %94
  %119 = fmul <16 x double> %97, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %121 = fmul <16 x double> %120, %97
  %122 = fmul <16 x double> %100, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %124 = fmul <16 x double> %123, %100
  %125 = fmul <16 x double> %103, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %127 = fmul <16 x double> %126, %103
  %128 = fmul <16 x double> %106, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %130 = fmul <16 x double> %129, %106
  %131 = fmul <16 x double> %109, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %133 = fmul <16 x double> %132, %109
  %134 = fmul <16 x double> %112, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %136 = fmul <16 x double> %135, %112
  %137 = fmul <16 x double> %115, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %139 = fmul <16 x double> %138, %115
  %140 = fmul <16 x double> %118, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %142 = fmul <16 x double> %141, %118
  %143 = fmul <16 x double> %121, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %145 = fmul <16 x double> %144, %121
  %146 = fmul <16 x double> %124, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %148 = fmul <16 x double> %147, %124
  %149 = fmul <16 x double> %127, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %151 = fmul <16 x double> %150, %127
  %152 = fmul <16 x double> %130, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %154 = fmul <16 x double> %153, %130
  %155 = fmul <16 x double> %133, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %157 = fmul <16 x double> %156, %133
  %158 = fmul <16 x double> %136, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %160 = fmul <16 x double> %159, %136
  %161 = fmul <16 x double> %139, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %163 = fmul <16 x double> %162, %139
  %164 = fmul <16 x double> %142, <double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01, double 3.550000e-01>
  ...
  %166 = fmul <16 x double> %165, %142
  %167 = add nsw i32 %j.09.i, 1
  %exitcond.i = icmp eq i32 %167, %4
  br i1 %exitcond.i, label %._crit_edge.i, label %bb.nph.i

._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB33.i
  %vectorPHI24.i = phi <16 x double> [ %22, %SyncBB33.i ], [ %166, %bb.nph.i ]
  %vectorPHI25.i = phi <16 x double> [ %21, %SyncBB33.i ], [ %163, %bb.nph.i ]
  %vectorPHI26.i = phi <16 x double> [ %22, %SyncBB33.i ], [ %160, %bb.nph.i ]
  %vectorPHI27.i = phi <16 x double> [ %21, %SyncBB33.i ], [ %145, %bb.nph.i ]
  %vectorPHI28.i = phi <16 x double> [ %22, %SyncBB33.i ], [ %148, %bb.nph.i ]
  %vectorPHI29.i = phi <16 x double> [ %21, %SyncBB33.i ], [ %151, %bb.nph.i ]
  %vectorPHI30.i = phi <16 x double> [ %22, %SyncBB33.i ], [ %154, %bb.nph.i ]
  %vectorPHI31.i = phi <16 x double> [ %21, %SyncBB33.i ], [ %157, %bb.nph.i ]

...
SyncBB.outer:                                     ; preds = %0, %thenBB
  %CurrWI..0.ph = phi i64 [ %"CurrWI++", %thenBB ], [ 0, %0 ]
  %CurrSBIndex..0.ph = phi i64 [ %"loadedCurrSB+Stride", %thenBB ], [ 0, %0 ]
  %currBarrier.3.ph = phi i32 [ %currBarrier.2, %thenBB ], [ 9, %0 ]
  br label %SyncBB

SyncBB:                                           ; preds = %thenBB175, %SyncBB.outer
  %CurrWI..0 = phi i64 [ %"CurrWI++179", %thenBB175 ], [ %CurrWI..0.ph, %SyncBB.outer ]
  %CurrSBIndex..0 = phi i64 [ %"loadedCurrSB+Stride181", %thenBB175 ], [ %CurrSBIndex..0.ph, %SyncBB.outer ]
  ...
  %5 = and i32 %4, 31
  %"&(pSB[currWI].offset)38" = add nuw i64 %CurrSBIndex..0, 4
  ...
  %"&(pSB[currWI].offset)72" = add nuw i64 %CurrSBIndex..0, 8
...
; <label>:19                                      ; preds = %SyncBB
  %20 = sext i32 %15 to i64
  %"&(pSB[currWI].offset)136" = add nuw i64 %CurrSBIndex..0, 16
  ...
  %"&(pSB[currWI].offset)42" = add nuw i64 %CurrSBIndex..0, 4
...
._crit_edge:                                      ; preds = %29, %19
  ...
  %"&(pSB[currWI].offset)131" = add nuw i64 %CurrSBIndex..0, 8
  ...
  %check.WI.iter178 = icmp ult i64 %CurrWI..0, %iterCount
  br i1 %check.WI.iter178, label %thenBB175, label %SyncBB156

thenBB175:                                        ; preds = %._crit_edge
  %"CurrWI++179" = add nuw i64 %CurrWI..0, 1
  %"loadedCurrSB+Stride181" = add nuw i64 %CurrSBIndex..0, 32
  br label %SyncBB

SyncBB156:                                        ; preds = %._crit_edge, %thenBB182
  %CurrWI..6 = phi i64 [ %"CurrWI++186", %thenBB182 ], [ 0, %._crit_edge ]
  %CurrSBIndex..6 = phi i64 [ %"loadedCurrSB+Stride188", %thenBB182 ], [ 0, %._crit_edge ]
...
; <label>:46                                      ; preds = %39, %SyncBB156
  %check.WI.iter185 = icmp ult i64 %CurrWI..6, %iterCount
  br i1 %check.WI.iter185, label %thenBB182, label %SyncBB157

thenBB182:                                        ; preds = %46
  %"CurrWI++186" = add nuw i64 %CurrWI..6, 1
  %"loadedCurrSB+Stride188" = add nuw i64 %CurrSBIndex..6, 32
  br label %SyncBB156

SyncBB157:                                        ; preds = %46, %thenBB161
  %CurrWI..4 = phi i64 [ %"CurrWI++165", %thenBB161 ], [ 0, %46 ]
  %CurrSBIndex..4 = phi i64 [ %"loadedCurrSB+Stride167", %thenBB161 ], [ 0, %46 ]
  %"&(pSB[currWI].offset)622" = or i64 %CurrSBIndex..4, 4
...
; <label>:48                                      ; preds = %SyncBB157
  %"&pSB[currWI].offset29" = getelementptr inbounds i8* %pSpecialBuf, i64 %CurrSBIndex..4
  ...
  %"&(pSB[currWI].offset)11113" = or i64 %CurrSBIndex..4, 8
  ...
  %"&(pSB[currWI].offset)11614" = or i64 %CurrSBIndex..4, 8
...
; <label>:55                                      ; preds = %48, %SyncBB157
  %check.WI.iter164 = icmp ult i64 %CurrWI..4, %iterCount
  br i1 %check.WI.iter164, label %thenBB161, label %SyncBB154

thenBB161:                                        ; preds = %55
  %"CurrWI++165" = add nuw i64 %CurrWI..4, 1
  %"loadedCurrSB+Stride167" = add nuw i64 %CurrSBIndex..4, 32
  br label %SyncBB157

SyncBB154:                                        ; preds = %55, %thenBB168
  %CurrWI..5 = phi i64 [ %"CurrWI++172", %thenBB168 ], [ 0, %55 ]
  %CurrSBIndex..5 = phi i64 [ %"loadedCurrSB+Stride174", %thenBB168 ], [ 0, %55 ]
...
; <label>:64                                      ; preds = %57, %SyncBB154
  %check.WI.iter171 = icmp ult i64 %CurrWI..5, %iterCount
  br i1 %check.WI.iter171, label %thenBB168, label %SyncBB155

thenBB168:                                        ; preds = %64
  %"CurrWI++172" = add nuw i64 %CurrWI..5, 1
  %"loadedCurrSB+Stride174" = add nuw i64 %CurrSBIndex..5, 32
  br label %SyncBB154

SyncBB155:                                        ; preds = %64, %thenBB189
  %CurrWI..7 = phi i64 [ %"CurrWI++193", %thenBB189 ], [ 0, %64 ]
  %CurrSBIndex..7 = phi i64 [ %"loadedCurrSB+Stride195", %thenBB189 ], [ 0, %64 ]
...
; <label>:73                                      ; preds = %66, %SyncBB155
  %check.WI.iter192 = icmp ult i64 %CurrWI..7, %iterCount
  br i1 %check.WI.iter192, label %thenBB189, label %SyncBB158

thenBB189:                                        ; preds = %73
  %"CurrWI++193" = add nuw i64 %CurrWI..7, 1
  %"loadedCurrSB+Stride195" = add nuw i64 %CurrSBIndex..7, 32
  br label %SyncBB155

SyncBB158:                                        ; preds = %73, %thenBB196
  %CurrWI..8 = phi i64 [ %"CurrWI++200", %thenBB196 ], [ 0, %73 ]
  %CurrSBIndex..8 = phi i64 [ %"loadedCurrSB+Stride202", %thenBB196 ], [ 0, %73 ]
...
; <label>:82                                      ; preds = %75, %SyncBB158
  %check.WI.iter199 = icmp ult i64 %CurrWI..8, %iterCount
  br i1 %check.WI.iter199, label %thenBB196, label %SyncBB159

thenBB196:                                        ; preds = %82
  %"CurrWI++200" = add nuw i64 %CurrWI..8, 1
  %"loadedCurrSB+Stride202" = add nuw i64 %CurrSBIndex..8, 32
  br label %SyncBB158

SyncBB159:                                        ; preds = %82, %thenBB
  %CurrWI..1 = phi i64 [ %"CurrWI++", %thenBB ], [ 0, %82 ]
  %CurrSBIndex..1 = phi i64 [ %"loadedCurrSB+Stride", %thenBB ], [ 0, %82 ]
  %currBarrier.0 = phi i32 [ %currBarrier.2, %thenBB ], [ 7, %82 ]
...
UnifiedReturnBlock:                               ; preds = %SyncBB159, %SyncBB, %83
  %CurrWI..3 = phi i64 [ %CurrWI..1, %83 ], [ %CurrWI..1, %SyncBB159 ], [ %CurrWI..0, %SyncBB ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..1, %83 ], [ %CurrSBIndex..1, %SyncBB159 ], [ %CurrSBIndex..0, %SyncBB ]
  %currBarrier.2 = phi i32 [ %currBarrier.0, %83 ], [ %currBarrier.0, %SyncBB159 ], [ %currBarrier.3.ph, %SyncBB ]
  %check.WI.iter = icmp ult i64 %CurrWI..3, %iterCount
  br i1 %check.WI.iter, label %thenBB, label %SyncBB153

thenBB:                                           ; preds = %UnifiedReturnBlock
  %"CurrWI++" = add nuw i64 %CurrWI..3, 1
  %"loadedCurrSB+Stride" = add nuw i64 %CurrSBIndex..3, 32
  %cond = icmp eq i32 %currBarrier.2, 9
  br i1 %cond, label %SyncBB.outer, label %SyncBB159
...
SyncBB.outer.i:                                   ; preds = %thenBB.i, %entry
  %CurrWI..0.ph.i = phi i64 [ %"CurrWI++.i", %thenBB.i ], [ 0, %entry ]
  %CurrSBIndex..0.ph.i = phi i64 [ %"loadedCurrSB+Stride.i", %thenBB.i ], [ 0, %entry ]
  %currBarrier.3.ph.i = phi i32 [ %currBarrier.2.i, %thenBB.i ], [ 9, %entry ]
  br label %SyncBB.i

SyncBB.i:                                         ; preds = %thenBB175.i, %SyncBB.outer.i
  %CurrWI..0.i = phi i64 [ %"CurrWI++179.i", %thenBB175.i ], [ %CurrWI..0.ph.i, %SyncBB.outer.i ]
  %CurrSBIndex..0.i = phi i64 [ %"loadedCurrSB+Stride181.i", %thenBB175.i ], [ %CurrSBIndex..0.ph.i, %SyncBB.outer.i ]
  %36 = getelementptr %struct.PaddedDimId* %28, i64 %CurrWI..0.i, i32 0, i64 0
  ...
  %39 = and i32 %38, 31
  %"&(pSB[currWI].offset)38.i" = add nuw i64 %CurrSBIndex..0.i, 4
  ...
  %"&(pSB[currWI].offset)72.i" = add nuw i64 %CurrSBIndex..0.i, 8
...
; <label>:53                                      ; preds = %SyncBB.i
  %54 = sext i32 %49 to i64
  %"&(pSB[currWI].offset)136.i" = add nuw i64 %CurrSBIndex..0.i, 16
  ...
  %"&(pSB[currWI].offset)42.i" = add nuw i64 %CurrSBIndex..0.i, 4
...
._crit_edge.i:                                    ; preds = %63, %53
  ...
  %"&(pSB[currWI].offset)131.i" = add nuw i64 %CurrSBIndex..0.i, 8
  ...
  %check.WI.iter178.i = icmp ult i64 %CurrWI..0.i, %31
  br i1 %check.WI.iter178.i, label %thenBB175.i, label %SyncBB156.i

thenBB175.i:                                      ; preds = %._crit_edge.i
  %"CurrWI++179.i" = add nuw i64 %CurrWI..0.i, 1
  %"loadedCurrSB+Stride181.i" = add nuw i64 %CurrSBIndex..0.i, 32
  br label %SyncBB.i

SyncBB156.i:                                      ; preds = %thenBB182.i, %._crit_edge.i
  %CurrWI..6.i = phi i64 [ %"CurrWI++186.i", %thenBB182.i ], [ 0, %._crit_edge.i ]
  %CurrSBIndex..6.i = phi i64 [ %"loadedCurrSB+Stride188.i", %thenBB182.i ], [ 0, %._crit_edge.i ]
...
; <label>:80                                      ; preds = %73, %SyncBB156.i
  %check.WI.iter185.i = icmp ult i64 %CurrWI..6.i, %31
  br i1 %check.WI.iter185.i, label %thenBB182.i, label %SyncBB157.i

thenBB182.i:                                      ; preds = %80
  %"CurrWI++186.i" = add nuw i64 %CurrWI..6.i, 1
  %"loadedCurrSB+Stride188.i" = add nuw i64 %CurrSBIndex..6.i, 32
  br label %SyncBB156.i

SyncBB157.i:                                      ; preds = %thenBB161.i, %80
  %CurrWI..4.i = phi i64 [ %"CurrWI++165.i", %thenBB161.i ], [ 0, %80 ]
  %CurrSBIndex..4.i = phi i64 [ %"loadedCurrSB+Stride167.i", %thenBB161.i ], [ 0, %80 ]
  %"&(pSB[currWI].offset)622.i" = or i64 %CurrSBIndex..4.i, 4
...
; <label>:82                                      ; preds = %SyncBB157.i
  %"&pSB[currWI].offset29.i" = getelementptr inbounds i8* %34, i64 %CurrSBIndex..4.i
  ...
  %"&(pSB[currWI].offset)11113.i" = or i64 %CurrSBIndex..4.i, 8
  ...
  %"&(pSB[currWI].offset)11614.i" = or i64 %CurrSBIndex..4.i, 8
...
; <label>:89                                      ; preds = %82, %SyncBB157.i
  %check.WI.iter164.i = icmp ult i64 %CurrWI..4.i, %31
  br i1 %check.WI.iter164.i, label %thenBB161.i, label %SyncBB154.i

thenBB161.i:                                      ; preds = %89
  %"CurrWI++165.i" = add nuw i64 %CurrWI..4.i, 1
  %"loadedCurrSB+Stride167.i" = add nuw i64 %CurrSBIndex..4.i, 32
  br label %SyncBB157.i

SyncBB154.i:                                      ; preds = %thenBB168.i, %89
  %CurrWI..5.i = phi i64 [ %"CurrWI++172.i", %thenBB168.i ], [ 0, %89 ]
  %CurrSBIndex..5.i = phi i64 [ %"loadedCurrSB+Stride174.i", %thenBB168.i ], [ 0, %89 ]
...
; <label>:98                                      ; preds = %91, %SyncBB154.i
  %check.WI.iter171.i = icmp ult i64 %CurrWI..5.i, %31
  br i1 %check.WI.iter171.i, label %thenBB168.i, label %SyncBB155.i

thenBB168.i:                                      ; preds = %98
  %"CurrWI++172.i" = add nuw i64 %CurrWI..5.i, 1
  %"loadedCurrSB+Stride174.i" = add nuw i64 %CurrSBIndex..5.i, 32
  br label %SyncBB154.i

SyncBB155.i:                                      ; preds = %thenBB189.i, %98
  %CurrWI..7.i = phi i64 [ %"CurrWI++193.i", %thenBB189.i ], [ 0, %98 ]
  %CurrSBIndex..7.i = phi i64 [ %"loadedCurrSB+Stride195.i", %thenBB189.i ], [ 0, %98 ]
...
; <label>:107                                     ; preds = %100, %SyncBB155.i
  %check.WI.iter192.i = icmp ult i64 %CurrWI..7.i, %31
  br i1 %check.WI.iter192.i, label %thenBB189.i, label %SyncBB158.i

thenBB189.i:                                      ; preds = %107
  %"CurrWI++193.i" = add nuw i64 %CurrWI..7.i, 1
  %"loadedCurrSB+Stride195.i" = add nuw i64 %CurrSBIndex..7.i, 32
  br label %SyncBB155.i

SyncBB158.i:                                      ; preds = %thenBB196.i, %107
  %CurrWI..8.i = phi i64 [ %"CurrWI++200.i", %thenBB196.i ], [ 0, %107 ]
  %CurrSBIndex..8.i = phi i64 [ %"loadedCurrSB+Stride202.i", %thenBB196.i ], [ 0, %107 ]
...
; <label>:116                                     ; preds = %109, %SyncBB158.i
  %check.WI.iter199.i = icmp ult i64 %CurrWI..8.i, %31
  br i1 %check.WI.iter199.i, label %thenBB196.i, label %SyncBB159.i

thenBB196.i:                                      ; preds = %116
  %"CurrWI++200.i" = add nuw i64 %CurrWI..8.i, 1
  %"loadedCurrSB+Stride202.i" = add nuw i64 %CurrSBIndex..8.i, 32
  br label %SyncBB158.i

SyncBB159.i:                                      ; preds = %thenBB.i, %116
  %CurrWI..1.i = phi i64 [ %"CurrWI++.i", %thenBB.i ], [ 0, %116 ]
  %CurrSBIndex..1.i = phi i64 [ %"loadedCurrSB+Stride.i", %thenBB.i ], [ 0, %116 ]
  %currBarrier.0.i = phi i32 [ %currBarrier.2.i, %thenBB.i ], [ 7, %116 ]
...
UnifiedReturnBlock.i:                             ; preds = %117, %SyncBB159.i, %SyncBB.i
  %CurrWI..3.i = phi i64 [ %CurrWI..1.i, %117 ], [ %CurrWI..1.i, %SyncBB159.i ], [ %CurrWI..0.i, %SyncBB.i ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..1.i, %117 ], [ %CurrSBIndex..1.i, %SyncBB159.i ], [ %CurrSBIndex..0.i, %SyncBB.i ]
  %currBarrier.2.i = phi i32 [ %currBarrier.0.i, %117 ], [ %currBarrier.0.i, %SyncBB159.i ], [ %currBarrier.3.ph.i, %SyncBB.i ]
  %check.WI.iter.i = icmp ult i64 %CurrWI..3.i, %31
  br i1 %check.WI.iter.i, label %thenBB.i, label %__spmv_csr_vector_kernel_separated_args.exit

thenBB.i:                                         ; preds = %UnifiedReturnBlock.i
  %"CurrWI++.i" = add nuw i64 %CurrWI..3.i, 1
  %"loadedCurrSB+Stride.i" = add nuw i64 %CurrSBIndex..3.i, 32
  %cond.i = icmp eq i32 %currBarrier.2.i, 9
  br i1 %cond.i, label %SyncBB.outer.i, label %SyncBB159.i

...
declare void @____Vectorized_.Add1_original(float addrspace(1)* nocapture, i32) nounwind
...
bb.nph:                                           ; preds = %SyncBB, %bb.nph
  ...
  %s.01 = phi float [ %78, %bb.nph ], [ %8, %SyncBB ]
...
._crit_edge:                                      ; preds = %bb.nph, %SyncBB
  %s.0.lcssa = phi float [ %8, %SyncBB ], [ %78, %bb.nph ]
...
define void @____Vectorized_.Add1_separated_args(float addrspace(1)* nocapture %data, i32 %nIters, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
FirstBB:
  %0 = icmp sgt i32 %nIters, 0
  br label %SyncBB
...
bb.nph:                                           ; preds = %SyncBB, %bb.nph
  ...
  %vectorPHI = phi <16 x float> [ %77, %bb.nph ], [ %7, %SyncBB ]
...
._crit_edge:                                      ; preds = %bb.nph, %SyncBB
  %vectorPHI17 = phi <16 x float> [ %7, %SyncBB ], [ %77, %bb.nph ]
  %ptrTypeCast18 = bitcast float addrspace(1)* %6 to <16 x float> addrspace(1)*
  store <16 x float> %vectorPHI17, <16 x float> addrspace(1)* %ptrTypeCast18, align 4
  %check.WI.iter = icmp ult i64 %CurrWI..0, %iterCount
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB.i
  ...
  %s.01.i = phi float [ %92, %bb.nph.i ], [ %22, %SyncBB.i ]
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB.i
  %s.0.lcssa.i = phi float [ %22, %SyncBB.i ], [ %92, %bb.nph.i ]
...
bb.nph.i:                                         ; preds = %bb.nph.i, %SyncBB.i
  ...
  %vectorPHI.i = phi <16 x float> [ %91, %bb.nph.i ], [ %21, %SyncBB.i ]
...
._crit_edge.i:                                    ; preds = %bb.nph.i, %SyncBB.i
  %vectorPHI17.i = phi <16 x float> [ %21, %SyncBB.i ], [ %91, %bb.nph.i ]
  %ptrTypeCast18.i = bitcast float addrspace(1)* %20 to <16 x float> addrspace(1)*
  store <16 x float> %vectorPHI17.i, <16 x float> addrspace(1)* %ptrTypeCast18.i, align 4
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %13

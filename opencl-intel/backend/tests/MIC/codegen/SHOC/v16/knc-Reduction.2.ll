...
declare void @____Vectorized_.reduce_original(double addrspace(1)* nocapture, double addrspace(1)* nocapture, double addrspace(3)* nocapture, i32) nounwind

declare void @____Vectorized_.reduceNoLocal_original(double addrspace(1)* nocapture, double addrspace(1)* nocapture, i32) nounwind
...
declare double @masked_load1(i1, double addrspace(1)*)

declare void @masked_store0(i1, double, double addrspace(3)*)

declare double @masked_load2(i1, double addrspace(3)*)

declare double @masked_load3(i1, double addrspace(3)*)

declare void @masked_store1(i1, double, double addrspace(3)*)

declare void @maskedf_0_barrier(i1, i64)

declare double @masked_load4(i1, double addrspace(3)*)

declare i64 @maskedf_1_get_group_id(i1, i32)

declare void @masked_store2(i1, double, double addrspace(1)*)
...
declare void @masked_store3(<16 x i1>, <16 x double>, <16 x double> addrspace(3)*)
...
declare <16 x double> @masked_load8(<16 x i1>, <16 x double> addrspace(3)*)

declare void @masked_store4(<16 x i1>, <16 x double>, <16 x double> addrspace(3)*)
...
thenBB:                                           ; preds = %._crit_edge5
  ...
  %"loadedCurrSB+Stride" = add nuw i64 %CurrSBIndex..0, 5120
  br label %SyncBB74
...
thenBB76:                                         ; preds = %39
  ...
  %"loadedCurrSB+Stride82" = add nuw i64 %CurrSBIndex..3, 5120
...
UnifiedReturnBlock:                               ; preds = %._crit_edge, %42
  ...
  br i1 %check.WI.iter86, label %thenBB83, label %SyncBB73

thenBB83:                                         ; preds = %UnifiedReturnBlock
  %"CurrWI++87" = add nuw i64 %CurrWI..4, 1
  %"loadedCurrSB+Stride89" = add nuw i64 %CurrSBIndex..4, 5120
  %cond = icmp eq i32 %currBarrier.2, 1
  br i1 %cond, label %SyncBB72, label %SyncBB

SyncBB73:                                         ; preds = %UnifiedReturnBlock
  ret void
}
...
define void @____Vectorized_.reduce_separated_args(double addrspace(1)* nocapture %g_idata, double addrspace(1)* nocapture %g_odata, double addrspace(3)* nocapture %sdata, i32 %n, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
bb.nph4:
...
SyncBB2172:                                       ; preds = %thenBB, %bb.nph4
  ...
  %"&(pSB[currWI].offset)9" = or i64 %CurrSBIndex..0, 64
  ...
  %16 = getelementptr inbounds double addrspace(3)* %sdata, i64 %extract
  %"&(pSB[currWI].offset)99910" = or i64 %CurrSBIndex..0, 128
  %"&pSB[currWI].offset1000" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)99910"
  %CastToValueType1001 = bitcast i8* %"&pSB[currWI].offset1000" to double addrspace(3)**
  store double addrspace(3)* %16, double addrspace(3)** %CastToValueType1001, align 8
  %ptrTypeCast = bitcast double addrspace(3)* %16 to <16 x double> addrspace(3)*
...
.preheader:                                       ; preds = %SyncBB2172
  ...
  %"&(pSB[currWI].offset)101311" = or i64 %CurrSBIndex..0, 128
  %"&pSB[currWI].offset1014" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)101311"
  %CastToValueType1015 = bitcast i8* %"&pSB[currWI].offset1014" to double addrspace(3)**
  br label %18

; <label>:18                                      ; preds = %postload803, %.preheader
  %vectorPHI = phi <16 x i1> [ %loop_mask11206, %postload803 ], [ %negIncomingLoopMask112, %.preheader ]
  %vectorPHI114 = phi <16 x i1> [ %local_edge225, %postload803 ], [ %17, %.preheader ]
  %vectorPHI115 = phi <16 x double> [ %116, %postload803 ], [ zeroinitializer, %.preheader ]
  %indvar = phi i32 [ %indvar.next, %postload803 ], [ 0, %.preheader ]
  ...
  %21 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %20
  %22 = extractelement <16 x i32> %i.03119, i32 2
  %23 = zext i32 %22 to i64
  %24 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %23
  %25 = extractelement <16 x i32> %i.03119, i32 3
  %26 = zext i32 %25 to i64
  %27 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %26
  %28 = extractelement <16 x i32> %i.03119, i32 4
  %29 = zext i32 %28 to i64
  %30 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %29
  ...
  %36 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %35
  %37 = extractelement <16 x i32> %i.03119, i32 7
  %38 = zext i32 %37 to i64
  %39 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %38
  ...
  %45 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %44
  %46 = extractelement <16 x i32> %i.03119, i32 10
  %47 = zext i32 %46 to i64
  %48 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %47
  ...
  %54 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %53
  %55 = extractelement <16 x i32> %i.03119, i32 13
  %56 = zext i32 %55 to i64
  %57 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %56
  %58 = extractelement <16 x i32> %i.03119, i32 14
  %59 = zext i32 %58 to i64
  %60 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %59
  %61 = extractelement <16 x i32> %i.03119, i32 15
  %62 = zext i32 %61 to i64
  %63 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %62
  br i1 %extract137, label %preload614, label %postload615

preload614:                                       ; preds = %18
  %64 = extractelement <16 x i32> %i.03119, i32 0
  %65 = zext i32 %64 to i64
  %66 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %65
  %masked_load = load double addrspace(1)* %66, align 8
  br label %postload615

postload615:                                      ; preds = %preload614, %18
  %phi616 = phi double [ undef, %18 ], [ %masked_load, %preload614 ]
  br i1 %extract138, label %preload620, label %postload621

preload620:                                       ; preds = %postload615
  %masked_load348 = load double addrspace(1)* %21, align 8
  br label %postload621

postload621:                                      ; preds = %preload620, %postload615
  %phi622 = phi double [ undef, %postload615 ], [ %masked_load348, %preload620 ]
  br i1 %extract139, label %preload626, label %postload627

preload626:                                       ; preds = %postload621
  %masked_load349 = load double addrspace(1)* %24, align 8
  br label %postload627

postload627:                                      ; preds = %preload626, %postload621
  %phi628 = phi double [ undef, %postload621 ], [ %masked_load349, %preload626 ]
  br i1 %extract140, label %preload632, label %postload633

preload632:                                       ; preds = %postload627
  %masked_load350 = load double addrspace(1)* %27, align 8
  br label %postload633

postload633:                                      ; preds = %preload632, %postload627
  %phi634 = phi double [ undef, %postload627 ], [ %masked_load350, %preload632 ]
  br i1 %extract141, label %preload638, label %postload639

preload638:                                       ; preds = %postload633
  %masked_load351 = load double addrspace(1)* %30, align 8
  br label %postload639

postload639:                                      ; preds = %preload638, %postload633
  %phi640 = phi double [ undef, %postload633 ], [ %masked_load351, %preload638 ]
  br i1 %extract142, label %preload644, label %postload645

preload644:                                       ; preds = %postload639
  %masked_load352 = load double addrspace(1)* %33, align 8
  br label %postload645

postload645:                                      ; preds = %preload644, %postload639
  %phi646 = phi double [ undef, %postload639 ], [ %masked_load352, %preload644 ]
  br i1 %extract143, label %preload650, label %postload651

preload650:                                       ; preds = %postload645
  %masked_load353 = load double addrspace(1)* %36, align 8
  br label %postload651

postload651:                                      ; preds = %preload650, %postload645
  %phi652 = phi double [ undef, %postload645 ], [ %masked_load353, %preload650 ]
  br i1 %extract144, label %preload656, label %postload657

preload656:                                       ; preds = %postload651
  %masked_load354 = load double addrspace(1)* %39, align 8
  br label %postload657

postload657:                                      ; preds = %preload656, %postload651
  %phi658 = phi double [ undef, %postload651 ], [ %masked_load354, %preload656 ]
  br i1 %extract145, label %preload662, label %postload663

preload662:                                       ; preds = %postload657
  %masked_load355 = load double addrspace(1)* %42, align 8
  br label %postload663

postload663:                                      ; preds = %preload662, %postload657
  %phi664 = phi double [ undef, %postload657 ], [ %masked_load355, %preload662 ]
  br i1 %extract146, label %preload668, label %postload669

preload668:                                       ; preds = %postload663
  %masked_load356 = load double addrspace(1)* %45, align 8
  br label %postload669

postload669:                                      ; preds = %preload668, %postload663
  %phi670 = phi double [ undef, %postload663 ], [ %masked_load356, %preload668 ]
  br i1 %extract147, label %preload674, label %postload675

preload674:                                       ; preds = %postload669
  %masked_load357 = load double addrspace(1)* %48, align 8
  br label %postload675

postload675:                                      ; preds = %preload674, %postload669
  %phi676 = phi double [ undef, %postload669 ], [ %masked_load357, %preload674 ]
  br i1 %extract148, label %preload680, label %postload681

preload680:                                       ; preds = %postload675
  %masked_load358 = load double addrspace(1)* %51, align 8
  br label %postload681

postload681:                                      ; preds = %preload680, %postload675
  %phi682 = phi double [ undef, %postload675 ], [ %masked_load358, %preload680 ]
  br i1 %extract149, label %preload686, label %postload687

preload686:                                       ; preds = %postload681
  %masked_load359 = load double addrspace(1)* %54, align 8
  br label %postload687

postload687:                                      ; preds = %preload686, %postload681
  %phi688 = phi double [ undef, %postload681 ], [ %masked_load359, %preload686 ]
  br i1 %extract150, label %preload692, label %postload693

preload692:                                       ; preds = %postload687
  %masked_load360 = load double addrspace(1)* %57, align 8
  br label %postload693

postload693:                                      ; preds = %preload692, %postload687
  %phi694 = phi double [ undef, %postload687 ], [ %masked_load360, %preload692 ]
  br i1 %extract151, label %preload698, label %postload699

preload698:                                       ; preds = %postload693
  %masked_load361 = load double addrspace(1)* %60, align 8
  br label %postload699

postload699:                                      ; preds = %preload698, %postload693
  %phi700 = phi double [ undef, %postload693 ], [ %masked_load361, %preload698 ]
  br i1 %extract152, label %preload704, label %postload705

preload704:                                       ; preds = %postload699
  %masked_load362 = load double addrspace(1)* %63, align 8
  br label %postload705

postload705:                                      ; preds = %preload704, %postload699
  %phi706 = phi double [ undef, %postload699 ], [ %masked_load362, %preload704 ]
  %temp.vect169 = insertelement <16 x double> undef, double %phi616, i32 0
  %temp.vect170 = insertelement <16 x double> %temp.vect169, double %phi622, i32 1
  %temp.vect171 = insertelement <16 x double> %temp.vect170, double %phi628, i32 2
  %temp.vect172 = insertelement <16 x double> %temp.vect171, double %phi634, i32 3
  %temp.vect173 = insertelement <16 x double> %temp.vect172, double %phi640, i32 4
  %temp.vect174 = insertelement <16 x double> %temp.vect173, double %phi646, i32 5
  %temp.vect175 = insertelement <16 x double> %temp.vect174, double %phi652, i32 6
  %temp.vect176 = insertelement <16 x double> %temp.vect175, double %phi658, i32 7
  %temp.vect177 = insertelement <16 x double> %temp.vect176, double %phi664, i32 8
  %temp.vect178 = insertelement <16 x double> %temp.vect177, double %phi670, i32 9
  %temp.vect179 = insertelement <16 x double> %temp.vect178, double %phi676, i32 10
  %temp.vect180 = insertelement <16 x double> %temp.vect179, double %phi682, i32 11
  %temp.vect181 = insertelement <16 x double> %temp.vect180, double %phi688, i32 12
  %temp.vect182 = insertelement <16 x double> %temp.vect181, double %phi694, i32 13
  %temp.vect183 = insertelement <16 x double> %temp.vect182, double %phi700, i32 14
  %temp.vect184 = insertelement <16 x double> %temp.vect183, double %phi706, i32 15
  %67 = extractelement <16 x i32> %tmp16120, i32 1
  %68 = zext i32 %67 to i64
  %69 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %68
  %70 = extractelement <16 x i32> %tmp16120, i32 2
  %71 = zext i32 %70 to i64
  %72 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %71
  %73 = extractelement <16 x i32> %tmp16120, i32 3
  %74 = zext i32 %73 to i64
  %75 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %74
  %76 = extractelement <16 x i32> %tmp16120, i32 4
  %77 = zext i32 %76 to i64
  %78 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %77
  %79 = extractelement <16 x i32> %tmp16120, i32 5
  %80 = zext i32 %79 to i64
  %81 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %80
  %82 = extractelement <16 x i32> %tmp16120, i32 6
  %83 = zext i32 %82 to i64
  %84 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %83
  %85 = extractelement <16 x i32> %tmp16120, i32 7
  %86 = zext i32 %85 to i64
  %87 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %86
  %88 = extractelement <16 x i32> %tmp16120, i32 8
  %89 = zext i32 %88 to i64
  %90 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %89
  %91 = extractelement <16 x i32> %tmp16120, i32 9
  %92 = zext i32 %91 to i64
  %93 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %92
  %94 = extractelement <16 x i32> %tmp16120, i32 10
  %95 = zext i32 %94 to i64
  %96 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %95
  %97 = extractelement <16 x i32> %tmp16120, i32 11
  %98 = zext i32 %97 to i64
  %99 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %98
  %100 = extractelement <16 x i32> %tmp16120, i32 12
  %101 = zext i32 %100 to i64
  %102 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %101
  %103 = extractelement <16 x i32> %tmp16120, i32 13
  %104 = zext i32 %103 to i64
  %105 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %104
  %106 = extractelement <16 x i32> %tmp16120, i32 14
  %107 = zext i32 %106 to i64
  %108 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %107
  %109 = extractelement <16 x i32> %tmp16120, i32 15
  %110 = zext i32 %109 to i64
  %111 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %110
  br i1 %extract137, label %preload617, label %postload618

preload617:                                       ; preds = %postload705
  %112 = extractelement <16 x i32> %tmp16120, i32 0
  %113 = zext i32 %112 to i64
  %114 = getelementptr inbounds double addrspace(1)* %g_idata, i64 %113
  %masked_load363 = load double addrspace(1)* %114, align 8
  br label %postload618

postload618:                                      ; preds = %preload617, %postload705
  %phi619 = phi double [ undef, %postload705 ], [ %masked_load363, %preload617 ]
  br i1 %extract138, label %preload623, label %postload624

preload623:                                       ; preds = %postload618
  %masked_load364 = load double addrspace(1)* %69, align 8
  br label %postload624

postload624:                                      ; preds = %preload623, %postload618
  %phi625 = phi double [ undef, %postload618 ], [ %masked_load364, %preload623 ]
  br i1 %extract139, label %preload629, label %postload630

preload629:                                       ; preds = %postload624
  %masked_load365 = load double addrspace(1)* %72, align 8
  br label %postload630

postload630:                                      ; preds = %preload629, %postload624
  %phi631 = phi double [ undef, %postload624 ], [ %masked_load365, %preload629 ]
  br i1 %extract140, label %preload635, label %postload636

preload635:                                       ; preds = %postload630
  %masked_load366 = load double addrspace(1)* %75, align 8
  br label %postload636

postload636:                                      ; preds = %preload635, %postload630
  %phi637 = phi double [ undef, %postload630 ], [ %masked_load366, %preload635 ]
  br i1 %extract141, label %preload641, label %postload642

preload641:                                       ; preds = %postload636
  %masked_load367 = load double addrspace(1)* %78, align 8
  br label %postload642

postload642:                                      ; preds = %preload641, %postload636
  %phi643 = phi double [ undef, %postload636 ], [ %masked_load367, %preload641 ]
  br i1 %extract142, label %preload647, label %postload648

preload647:                                       ; preds = %postload642
  %masked_load368 = load double addrspace(1)* %81, align 8
  br label %postload648

postload648:                                      ; preds = %preload647, %postload642
  %phi649 = phi double [ undef, %postload642 ], [ %masked_load368, %preload647 ]
  br i1 %extract143, label %preload653, label %postload654

preload653:                                       ; preds = %postload648
  %masked_load369 = load double addrspace(1)* %84, align 8
  br label %postload654

postload654:                                      ; preds = %preload653, %postload648
  %phi655 = phi double [ undef, %postload648 ], [ %masked_load369, %preload653 ]
  br i1 %extract144, label %preload659, label %postload660

preload659:                                       ; preds = %postload654
  %masked_load370 = load double addrspace(1)* %87, align 8
  br label %postload660

postload660:                                      ; preds = %preload659, %postload654
  %phi661 = phi double [ undef, %postload654 ], [ %masked_load370, %preload659 ]
  br i1 %extract145, label %preload665, label %postload666

preload665:                                       ; preds = %postload660
  %masked_load371 = load double addrspace(1)* %90, align 8
  br label %postload666

postload666:                                      ; preds = %preload665, %postload660
  %phi667 = phi double [ undef, %postload660 ], [ %masked_load371, %preload665 ]
  br i1 %extract146, label %preload671, label %postload672

preload671:                                       ; preds = %postload666
  %masked_load372 = load double addrspace(1)* %93, align 8
  br label %postload672

postload672:                                      ; preds = %preload671, %postload666
  %phi673 = phi double [ undef, %postload666 ], [ %masked_load372, %preload671 ]
  br i1 %extract147, label %preload677, label %postload678

preload677:                                       ; preds = %postload672
  %masked_load373 = load double addrspace(1)* %96, align 8
  br label %postload678

postload678:                                      ; preds = %preload677, %postload672
  %phi679 = phi double [ undef, %postload672 ], [ %masked_load373, %preload677 ]
  br i1 %extract148, label %preload683, label %postload684

preload683:                                       ; preds = %postload678
  %masked_load374 = load double addrspace(1)* %99, align 8
  br label %postload684

postload684:                                      ; preds = %preload683, %postload678
  %phi685 = phi double [ undef, %postload678 ], [ %masked_load374, %preload683 ]
  br i1 %extract149, label %preload689, label %postload690

preload689:                                       ; preds = %postload684
  %masked_load375 = load double addrspace(1)* %102, align 8
  br label %postload690

postload690:                                      ; preds = %preload689, %postload684
  %phi691 = phi double [ undef, %postload684 ], [ %masked_load375, %preload689 ]
  br i1 %extract150, label %preload695, label %postload696

preload695:                                       ; preds = %postload690
  %masked_load376 = load double addrspace(1)* %105, align 8
  br label %postload696

postload696:                                      ; preds = %preload695, %postload690
  %phi697 = phi double [ undef, %postload690 ], [ %masked_load376, %preload695 ]
  br i1 %extract151, label %preload701, label %postload702

preload701:                                       ; preds = %postload696
  %masked_load377 = load double addrspace(1)* %108, align 8
  br label %postload702

postload702:                                      ; preds = %preload701, %postload696
  %phi703 = phi double [ undef, %postload696 ], [ %masked_load377, %preload701 ]
  br i1 %extract152, label %preload707, label %postload708

preload707:                                       ; preds = %postload702
  %masked_load378 = load double addrspace(1)* %111, align 8
  br label %postload708

postload708:                                      ; preds = %preload707, %postload702
  %phi709 = phi double [ undef, %postload702 ], [ %masked_load378, %preload707 ]
  %temp.vect185 = insertelement <16 x double> undef, double %phi619, i32 0
  %temp.vect186 = insertelement <16 x double> %temp.vect185, double %phi625, i32 1
  %temp.vect187 = insertelement <16 x double> %temp.vect186, double %phi631, i32 2
  %temp.vect188 = insertelement <16 x double> %temp.vect187, double %phi637, i32 3
  %temp.vect189 = insertelement <16 x double> %temp.vect188, double %phi643, i32 4
  %temp.vect190 = insertelement <16 x double> %temp.vect189, double %phi649, i32 5
  %temp.vect191 = insertelement <16 x double> %temp.vect190, double %phi655, i32 6
  %temp.vect192 = insertelement <16 x double> %temp.vect191, double %phi661, i32 7
  %temp.vect193 = insertelement <16 x double> %temp.vect192, double %phi667, i32 8
  %temp.vect194 = insertelement <16 x double> %temp.vect193, double %phi673, i32 9
  %temp.vect195 = insertelement <16 x double> %temp.vect194, double %phi679, i32 10
  %temp.vect196 = insertelement <16 x double> %temp.vect195, double %phi685, i32 11
  %temp.vect197 = insertelement <16 x double> %temp.vect196, double %phi691, i32 12
  %temp.vect198 = insertelement <16 x double> %temp.vect197, double %phi697, i32 13
  %temp.vect199 = insertelement <16 x double> %temp.vect198, double %phi703, i32 14
  %temp.vect200 = insertelement <16 x double> %temp.vect199, double %phi709, i32 15
  %115 = fadd <16 x double> %temp.vect184, %temp.vect200
  %116 = fadd <16 x double> %vectorPHI115, %115
  %loadedValue1016 = load double addrspace(3)** %CastToValueType1015, align 8
  %exmask = extractelement <16 x i1> %vectorPHI114, i32 0
  br i1 %exmask, label %preload710, label %postload711

preload710:                                       ; preds = %postload708
  %exData = extractelement <16 x double> %116, i32 0
  store double %exData, double addrspace(3)* %loadedValue1016, align 8
  br label %postload711

postload711:                                      ; preds = %preload710, %postload708
  %exmask381 = extractelement <16 x i1> %vectorPHI114, i32 1
  br i1 %exmask381, label %preload602, label %postload603

preload602:                                       ; preds = %postload711
  %117 = getelementptr double addrspace(3)* %loadedValue1016, i64 1
  %exData382 = extractelement <16 x double> %116, i32 1
  store double %exData382, double addrspace(3)* %117, align 8
  br label %postload603

postload603:                                      ; preds = %preload602, %postload711
  %exmask384 = extractelement <16 x i1> %vectorPHI114, i32 2
  br i1 %exmask384, label %preload599, label %postload600

preload599:                                       ; preds = %postload603
  %118 = getelementptr double addrspace(3)* %loadedValue1016, i64 2
  %exData385 = extractelement <16 x double> %116, i32 2
  store double %exData385, double addrspace(3)* %118, align 8
  br label %postload600

postload600:                                      ; preds = %preload599, %postload603
  %exmask387 = extractelement <16 x i1> %vectorPHI114, i32 3
  br i1 %exmask387, label %preload587, label %postload588

preload587:                                       ; preds = %postload600
  %119 = getelementptr double addrspace(3)* %loadedValue1016, i64 3
  %exData388 = extractelement <16 x double> %116, i32 3
  store double %exData388, double addrspace(3)* %119, align 8
  br label %postload588

postload588:                                      ; preds = %preload587, %postload600
  %exmask390 = extractelement <16 x i1> %vectorPHI114, i32 4
  br i1 %exmask390, label %preload575, label %postload576

preload575:                                       ; preds = %postload588
  %120 = getelementptr double addrspace(3)* %loadedValue1016, i64 4
  %exData391 = extractelement <16 x double> %116, i32 4
  store double %exData391, double addrspace(3)* %120, align 8
  br label %postload576

postload576:                                      ; preds = %preload575, %postload588
  %exmask393 = extractelement <16 x i1> %vectorPHI114, i32 5
  br i1 %exmask393, label %preload569, label %postload570

preload569:                                       ; preds = %postload576
  %121 = getelementptr double addrspace(3)* %loadedValue1016, i64 5
  %exData394 = extractelement <16 x double> %116, i32 5
  store double %exData394, double addrspace(3)* %121, align 8
  br label %postload570

postload570:                                      ; preds = %preload569, %postload576
  %exmask396 = extractelement <16 x i1> %vectorPHI114, i32 6
  br i1 %exmask396, label %preload581, label %postload582

preload581:                                       ; preds = %postload570
  %122 = getelementptr double addrspace(3)* %loadedValue1016, i64 6
  %exData397 = extractelement <16 x double> %116, i32 6
  store double %exData397, double addrspace(3)* %122, align 8
  br label %postload582

postload582:                                      ; preds = %preload581, %postload570
  %exmask399 = extractelement <16 x i1> %vectorPHI114, i32 7
  br i1 %exmask399, label %preload, label %postload

preload:                                          ; preds = %postload582
  %123 = getelementptr double addrspace(3)* %loadedValue1016, i64 7
  %exData400 = extractelement <16 x double> %116, i32 7
  store double %exData400, double addrspace(3)* %123, align 8
  br label %postload

postload:                                         ; preds = %preload, %postload582
  %exmask402 = extractelement <16 x i1> %vectorPHI114, i32 8
  br i1 %exmask402, label %preload572, label %postload573

preload572:                                       ; preds = %postload
  %124 = getelementptr double addrspace(3)* %loadedValue1016, i64 8
  %exData403 = extractelement <16 x double> %116, i32 8
  store double %exData403, double addrspace(3)* %124, align 8
  br label %postload573

postload573:                                      ; preds = %preload572, %postload
  %exmask405 = extractelement <16 x i1> %vectorPHI114, i32 9
  br i1 %exmask405, label %preload590, label %postload591

preload590:                                       ; preds = %postload573
  %125 = getelementptr double addrspace(3)* %loadedValue1016, i64 9
  %exData406 = extractelement <16 x double> %116, i32 9
  store double %exData406, double addrspace(3)* %125, align 8
  br label %postload591

postload591:                                      ; preds = %preload590, %postload573
  %exmask408 = extractelement <16 x i1> %vectorPHI114, i32 10
  br i1 %exmask408, label %preload605, label %postload606

preload605:                                       ; preds = %postload591
  %126 = getelementptr double addrspace(3)* %loadedValue1016, i64 10
  %exData409 = extractelement <16 x double> %116, i32 10
  store double %exData409, double addrspace(3)* %126, align 8
  br label %postload606

postload606:                                      ; preds = %preload605, %postload591
  %exmask411 = extractelement <16 x i1> %vectorPHI114, i32 11
  br i1 %exmask411, label %preload596, label %postload597

preload596:                                       ; preds = %postload606
  %127 = getelementptr double addrspace(3)* %loadedValue1016, i64 11
  %exData412 = extractelement <16 x double> %116, i32 11
  store double %exData412, double addrspace(3)* %127, align 8
  br label %postload597

postload597:                                      ; preds = %preload596, %postload606
  %exmask414 = extractelement <16 x i1> %vectorPHI114, i32 12
  br i1 %exmask414, label %preload578, label %postload579

preload578:                                       ; preds = %postload597
  %128 = getelementptr double addrspace(3)* %loadedValue1016, i64 12
  %exData415 = extractelement <16 x double> %116, i32 12
  store double %exData415, double addrspace(3)* %128, align 8
  br label %postload579

postload579:                                      ; preds = %preload578, %postload597
  %exmask417 = extractelement <16 x i1> %vectorPHI114, i32 13
  br i1 %exmask417, label %preload584, label %postload585

preload584:                                       ; preds = %postload579
  %129 = getelementptr double addrspace(3)* %loadedValue1016, i64 13
  %exData418 = extractelement <16 x double> %116, i32 13
  store double %exData418, double addrspace(3)* %129, align 8
  br label %postload585

postload585:                                      ; preds = %preload584, %postload579
  %exmask420 = extractelement <16 x i1> %vectorPHI114, i32 14
  br i1 %exmask420, label %preload593, label %postload594

preload593:                                       ; preds = %postload585
  %130 = getelementptr double addrspace(3)* %loadedValue1016, i64 14
  %exData421 = extractelement <16 x double> %116, i32 14
  store double %exData421, double addrspace(3)* %130, align 8
  br label %postload594

postload594:                                      ; preds = %preload593, %postload585
  %exmask423 = extractelement <16 x i1> %vectorPHI114, i32 15
  br i1 %exmask423, label %preload802, label %postload803

preload802:                                       ; preds = %postload594
  %131 = getelementptr double addrspace(3)* %loadedValue1016, i64 15
  %exData424 = extractelement <16 x double> %116, i32 15
  store double %exData424, double addrspace(3)* %131, align 8
  br label %postload803

postload803:                                      ; preds = %preload802, %postload594
...
._crit_edge5:                                     ; preds = %postload803, %SyncBB2172
  %check.WI.iter = icmp ult i64 %CurrWI..0, %iterCount
  br i1 %check.WI.iter, label %thenBB, label %elseBB
...
SyncBB:                                           ; preds = %thenBB2177, %thenBB2184, %thenBB2192, %elseBB
  %currBarrier.4 = phi i32 [ 2, %elseBB ], [ %currBarrier.3, %thenBB2184 ], [ %currBarrier.2, %thenBB2192 ], [ %currBarrier.3, %thenBB2177 ]
  %CurrSBIndex..1 = phi i64 [ 0, %elseBB ], [ %"loadedCurrSB+Stride2190", %thenBB2184 ], [ %"loadedCurrSB+Stride2198", %thenBB2192 ], [ %"loadedCurrSB+Stride2183", %thenBB2177 ]
  %CurrWI..1 = phi i64 [ 0, %elseBB ], [ %"CurrWI++2188", %thenBB2184 ], [ %"CurrWI++2196", %thenBB2192 ], [ %"CurrWI++2181", %thenBB2177 ]
  br i1 %Mneg13, label %._crit_edge, label %bb.nph

bb.nph:                                           ; preds = %postload801, %SyncBB
  %currBarrier.2 = phi i32 [ %currBarrier.1, %postload801 ], [ %currBarrier.4, %SyncBB ]
  %CurrSBIndex..4 = phi i64 [ %CurrSBIndex..3, %postload801 ], [ %CurrSBIndex..1, %SyncBB ]
  %CurrWI..4 = phi i64 [ %CurrWI..3, %postload801 ], [ %CurrWI..1, %SyncBB ]
  %vectorPHI243 = phi <16 x i1> [ %loop_mask24326, %postload801 ], [ %vector245, %SyncBB ]
  %vectorPHI246 = phi <16 x i1> [ %local_edge29330, %postload801 ], [ %vector248, %SyncBB ]
  %s.02 = phi i32 [ %s.0, %postload801 ], [ %s.01, %SyncBB ]
  ...
  %137 = getelementptr inbounds double addrspace(3)* %sdata, i64 %136
  ...
  %CastToValueType1365 = bitcast i8* %"&pSB[currWI].offset1364" to double addrspace(3)**
  store double addrspace(3)* %137, double addrspace(3)** %CastToValueType1365, align 8
  %138 = extractelement <16 x i32> %134, i32 2
  %139 = zext i32 %138 to i64
  %140 = getelementptr inbounds double addrspace(3)* %sdata, i64 %139
  ...
  %CastToValueType1374 = bitcast i8* %"&pSB[currWI].offset1373" to double addrspace(3)**
  store double addrspace(3)* %140, double addrspace(3)** %CastToValueType1374, align 8
  %141 = extractelement <16 x i32> %134, i32 3
  %142 = zext i32 %141 to i64
  %143 = getelementptr inbounds double addrspace(3)* %sdata, i64 %142
  ...
  %CastToValueType1383 = bitcast i8* %"&pSB[currWI].offset1382" to double addrspace(3)**
  store double addrspace(3)* %143, double addrspace(3)** %CastToValueType1383, align 8
  %144 = extractelement <16 x i32> %134, i32 4
  %145 = zext i32 %144 to i64
  %146 = getelementptr inbounds double addrspace(3)* %sdata, i64 %145
  ...
  %CastToValueType1392 = bitcast i8* %"&pSB[currWI].offset1391" to double addrspace(3)**
  store double addrspace(3)* %146, double addrspace(3)** %CastToValueType1392, align 8
  %147 = extractelement <16 x i32> %134, i32 5
  %148 = zext i32 %147 to i64
  %149 = getelementptr inbounds double addrspace(3)* %sdata, i64 %148
  ...
  %CastToValueType1401 = bitcast i8* %"&pSB[currWI].offset1400" to double addrspace(3)**
  store double addrspace(3)* %149, double addrspace(3)** %CastToValueType1401, align 8
  %150 = extractelement <16 x i32> %134, i32 6
  %151 = zext i32 %150 to i64
  %152 = getelementptr inbounds double addrspace(3)* %sdata, i64 %151
  ...
  %CastToValueType1410 = bitcast i8* %"&pSB[currWI].offset1409" to double addrspace(3)**
  store double addrspace(3)* %152, double addrspace(3)** %CastToValueType1410, align 8
  %153 = extractelement <16 x i32> %134, i32 7
  %154 = zext i32 %153 to i64
  %155 = getelementptr inbounds double addrspace(3)* %sdata, i64 %154
  ...
  %CastToValueType1419 = bitcast i8* %"&pSB[currWI].offset1418" to double addrspace(3)**
  store double addrspace(3)* %155, double addrspace(3)** %CastToValueType1419, align 8
  %156 = extractelement <16 x i32> %134, i32 8
  %157 = zext i32 %156 to i64
  %158 = getelementptr inbounds double addrspace(3)* %sdata, i64 %157
  ...
  %CastToValueType1428 = bitcast i8* %"&pSB[currWI].offset1427" to double addrspace(3)**
  store double addrspace(3)* %158, double addrspace(3)** %CastToValueType1428, align 8
  %159 = extractelement <16 x i32> %134, i32 9
  %160 = zext i32 %159 to i64
  %161 = getelementptr inbounds double addrspace(3)* %sdata, i64 %160
  ...
  %CastToValueType1437 = bitcast i8* %"&pSB[currWI].offset1436" to double addrspace(3)**
  store double addrspace(3)* %161, double addrspace(3)** %CastToValueType1437, align 8
  %162 = extractelement <16 x i32> %134, i32 10
  %163 = zext i32 %162 to i64
  %164 = getelementptr inbounds double addrspace(3)* %sdata, i64 %163
  ...
  %CastToValueType1446 = bitcast i8* %"&pSB[currWI].offset1445" to double addrspace(3)**
  store double addrspace(3)* %164, double addrspace(3)** %CastToValueType1446, align 8
  %165 = extractelement <16 x i32> %134, i32 11
  %166 = zext i32 %165 to i64
  %167 = getelementptr inbounds double addrspace(3)* %sdata, i64 %166
  ...
  %CastToValueType1455 = bitcast i8* %"&pSB[currWI].offset1454" to double addrspace(3)**
  store double addrspace(3)* %167, double addrspace(3)** %CastToValueType1455, align 8
  %168 = extractelement <16 x i32> %134, i32 12
  %169 = zext i32 %168 to i64
  %170 = getelementptr inbounds double addrspace(3)* %sdata, i64 %169
  ...
  %CastToValueType1464 = bitcast i8* %"&pSB[currWI].offset1463" to double addrspace(3)**
  store double addrspace(3)* %170, double addrspace(3)** %CastToValueType1464, align 8
  %171 = extractelement <16 x i32> %134, i32 13
  %172 = zext i32 %171 to i64
  %173 = getelementptr inbounds double addrspace(3)* %sdata, i64 %172
  ...
  %CastToValueType1473 = bitcast i8* %"&pSB[currWI].offset1472" to double addrspace(3)**
  store double addrspace(3)* %173, double addrspace(3)** %CastToValueType1473, align 8
  %174 = extractelement <16 x i32> %134, i32 14
  %175 = zext i32 %174 to i64
  %176 = getelementptr inbounds double addrspace(3)* %sdata, i64 %175
  ...
  %CastToValueType1482 = bitcast i8* %"&pSB[currWI].offset1481" to double addrspace(3)**
  store double addrspace(3)* %176, double addrspace(3)** %CastToValueType1482, align 8
  %177 = extractelement <16 x i32> %134, i32 15
  %178 = zext i32 %177 to i64
  %179 = getelementptr inbounds double addrspace(3)* %sdata, i64 %178
  ...
  %CastToValueType1491 = bitcast i8* %"&pSB[currWI].offset1490" to double addrspace(3)**
  store double addrspace(3)* %179, double addrspace(3)** %CastToValueType1491, align 8
  br i1 %extract270, label %preload752, label %postload753

preload752:                                       ; preds = %bb.nph
  ...
  %182 = getelementptr inbounds double addrspace(3)* %sdata, i64 %181
  %masked_load425 = load double addrspace(3)* %182, align 8
  ...
  %CastToValueType1500 = bitcast i8* %"&pSB[currWI].offset1499" to double*
  store double %masked_load425, double* %CastToValueType1500, align 8
  br label %postload753

postload753:                                      ; preds = %preload752, %bb.nph
  %phi754 = phi double [ undef, %bb.nph ], [ %masked_load425, %preload752 ]
  %"&(pSB[currWI].offset)1502" = add nuw i64 %CurrSBIndex..4, 448
  %"&pSB[currWI].offset1503" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1502"
  %CastToValueType1504 = bitcast i8* %"&pSB[currWI].offset1503" to double*
  store double %phi754, double* %CastToValueType1504, align 8
  ...
  br i1 %loadedValue1226, label %preload755, label %postload756
...
preload755:                                       ; preds = %postload753
  ...
  %CastToValueType1369 = bitcast i8* %"&pSB[currWI].offset1368" to double addrspace(3)**
  %loadedValue1370 = load double addrspace(3)** %CastToValueType1369, align 8
  %masked_load426 = load double addrspace(3)* %loadedValue1370, align 8
  %"&(pSB[currWI].offset)1511" = add nuw i64 %CurrSBIndex..4, 456
  %"&pSB[currWI].offset1512" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1511"
  %CastToValueType1513 = bitcast i8* %"&pSB[currWI].offset1512" to double*
  store double %masked_load426, double* %CastToValueType1513, align 8
  br label %postload756

postload756:                                      ; preds = %preload755, %postload753
  %phi757 = phi double [ undef, %postload753 ], [ %masked_load426, %preload755 ]
  %"&(pSB[currWI].offset)1515" = add nuw i64 %CurrSBIndex..4, 464
  %"&pSB[currWI].offset1516" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1515"
  %CastToValueType1517 = bitcast i8* %"&pSB[currWI].offset1516" to double*
  store double %phi757, double* %CastToValueType1517, align 8
  ...
  br i1 %loadedValue1235, label %preload758, label %postload759
...
preload758:                                       ; preds = %postload756
  ...
  %CastToValueType1378 = bitcast i8* %"&pSB[currWI].offset1377" to double addrspace(3)**
  %loadedValue1379 = load double addrspace(3)** %CastToValueType1378, align 8
  %masked_load427 = load double addrspace(3)* %loadedValue1379, align 8
  %"&(pSB[currWI].offset)1524" = add nuw i64 %CurrSBIndex..4, 472
  %"&pSB[currWI].offset1525" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1524"
  %CastToValueType1526 = bitcast i8* %"&pSB[currWI].offset1525" to double*
  store double %masked_load427, double* %CastToValueType1526, align 8
  br label %postload759

postload759:                                      ; preds = %preload758, %postload756
  %phi760 = phi double [ undef, %postload756 ], [ %masked_load427, %preload758 ]
  %"&(pSB[currWI].offset)1528" = add nuw i64 %CurrSBIndex..4, 480
  %"&pSB[currWI].offset1529" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1528"
  %CastToValueType1530 = bitcast i8* %"&pSB[currWI].offset1529" to double*
  store double %phi760, double* %CastToValueType1530, align 8
  ...
  br i1 %loadedValue1244, label %preload761, label %postload762
...
preload761:                                       ; preds = %postload759
  ...
  %CastToValueType1387 = bitcast i8* %"&pSB[currWI].offset1386" to double addrspace(3)**
  %loadedValue1388 = load double addrspace(3)** %CastToValueType1387, align 8
  %masked_load428 = load double addrspace(3)* %loadedValue1388, align 8
  %"&(pSB[currWI].offset)1537" = add nuw i64 %CurrSBIndex..4, 488
  %"&pSB[currWI].offset1538" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1537"
  %CastToValueType1539 = bitcast i8* %"&pSB[currWI].offset1538" to double*
  store double %masked_load428, double* %CastToValueType1539, align 8
  br label %postload762

postload762:                                      ; preds = %preload761, %postload759
  %phi763 = phi double [ undef, %postload759 ], [ %masked_load428, %preload761 ]
  %"&(pSB[currWI].offset)1541" = add nuw i64 %CurrSBIndex..4, 496
  %"&pSB[currWI].offset1542" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1541"
  %CastToValueType1543 = bitcast i8* %"&pSB[currWI].offset1542" to double*
  store double %phi763, double* %CastToValueType1543, align 8
  ...
  br i1 %loadedValue1253, label %preload764, label %postload765
...
preload764:                                       ; preds = %postload762
  ...
  %CastToValueType1396 = bitcast i8* %"&pSB[currWI].offset1395" to double addrspace(3)**
  %loadedValue1397 = load double addrspace(3)** %CastToValueType1396, align 8
  %masked_load429 = load double addrspace(3)* %loadedValue1397, align 8
  %"&(pSB[currWI].offset)1550" = add nuw i64 %CurrSBIndex..4, 504
  %"&pSB[currWI].offset1551" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1550"
  %CastToValueType1552 = bitcast i8* %"&pSB[currWI].offset1551" to double*
  store double %masked_load429, double* %CastToValueType1552, align 8
  br label %postload765

postload765:                                      ; preds = %preload764, %postload762
  %phi766 = phi double [ undef, %postload762 ], [ %masked_load429, %preload764 ]
  %"&(pSB[currWI].offset)1554" = add nuw i64 %CurrSBIndex..4, 512
  %"&pSB[currWI].offset1555" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1554"
  %CastToValueType1556 = bitcast i8* %"&pSB[currWI].offset1555" to double*
  store double %phi766, double* %CastToValueType1556, align 8
  ...
  br i1 %loadedValue1262, label %preload767, label %postload768
...
preload767:                                       ; preds = %postload765
  ...
  %CastToValueType1405 = bitcast i8* %"&pSB[currWI].offset1404" to double addrspace(3)**
  %loadedValue1406 = load double addrspace(3)** %CastToValueType1405, align 8
  %masked_load430 = load double addrspace(3)* %loadedValue1406, align 8
  %"&(pSB[currWI].offset)1563" = add nuw i64 %CurrSBIndex..4, 520
  %"&pSB[currWI].offset1564" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1563"
  %CastToValueType1565 = bitcast i8* %"&pSB[currWI].offset1564" to double*
  store double %masked_load430, double* %CastToValueType1565, align 8
  br label %postload768

postload768:                                      ; preds = %preload767, %postload765
  %phi769 = phi double [ undef, %postload765 ], [ %masked_load430, %preload767 ]
  %"&(pSB[currWI].offset)1567" = add nuw i64 %CurrSBIndex..4, 528
  %"&pSB[currWI].offset1568" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1567"
  %CastToValueType1569 = bitcast i8* %"&pSB[currWI].offset1568" to double*
  store double %phi769, double* %CastToValueType1569, align 8
  ...
  br i1 %loadedValue1271, label %preload770, label %postload771
...
preload770:                                       ; preds = %postload768
  ...
  %CastToValueType1414 = bitcast i8* %"&pSB[currWI].offset1413" to double addrspace(3)**
  %loadedValue1415 = load double addrspace(3)** %CastToValueType1414, align 8
  %masked_load431 = load double addrspace(3)* %loadedValue1415, align 8
  %"&(pSB[currWI].offset)1576" = add nuw i64 %CurrSBIndex..4, 536
  %"&pSB[currWI].offset1577" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1576"
  %CastToValueType1578 = bitcast i8* %"&pSB[currWI].offset1577" to double*
  store double %masked_load431, double* %CastToValueType1578, align 8
  br label %postload771

postload771:                                      ; preds = %preload770, %postload768
  %phi772 = phi double [ undef, %postload768 ], [ %masked_load431, %preload770 ]
  %"&(pSB[currWI].offset)1580" = add nuw i64 %CurrSBIndex..4, 544
  %"&pSB[currWI].offset1581" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1580"
  %CastToValueType1582 = bitcast i8* %"&pSB[currWI].offset1581" to double*
  store double %phi772, double* %CastToValueType1582, align 8
  ...
  br i1 %loadedValue1280, label %preload773, label %postload774
...
preload773:                                       ; preds = %postload771
  ...
  %CastToValueType1423 = bitcast i8* %"&pSB[currWI].offset1422" to double addrspace(3)**
  %loadedValue1424 = load double addrspace(3)** %CastToValueType1423, align 8
  %masked_load432 = load double addrspace(3)* %loadedValue1424, align 8
  %"&(pSB[currWI].offset)1589" = add nuw i64 %CurrSBIndex..4, 552
  %"&pSB[currWI].offset1590" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1589"
  %CastToValueType1591 = bitcast i8* %"&pSB[currWI].offset1590" to double*
  store double %masked_load432, double* %CastToValueType1591, align 8
  br label %postload774

postload774:                                      ; preds = %preload773, %postload771
  %phi775 = phi double [ undef, %postload771 ], [ %masked_load432, %preload773 ]
  %"&(pSB[currWI].offset)1593" = add nuw i64 %CurrSBIndex..4, 560
  %"&pSB[currWI].offset1594" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1593"
  %CastToValueType1595 = bitcast i8* %"&pSB[currWI].offset1594" to double*
  store double %phi775, double* %CastToValueType1595, align 8
  ...
  br i1 %loadedValue1289, label %preload776, label %postload777
...
preload776:                                       ; preds = %postload774
  ...
  %CastToValueType1432 = bitcast i8* %"&pSB[currWI].offset1431" to double addrspace(3)**
  %loadedValue1433 = load double addrspace(3)** %CastToValueType1432, align 8
  %masked_load433 = load double addrspace(3)* %loadedValue1433, align 8
  %"&(pSB[currWI].offset)1602" = add nuw i64 %CurrSBIndex..4, 568
  %"&pSB[currWI].offset1603" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1602"
  %CastToValueType1604 = bitcast i8* %"&pSB[currWI].offset1603" to double*
  store double %masked_load433, double* %CastToValueType1604, align 8
  br label %postload777

postload777:                                      ; preds = %preload776, %postload774
  %phi778 = phi double [ undef, %postload774 ], [ %masked_load433, %preload776 ]
  %"&(pSB[currWI].offset)1606" = add nuw i64 %CurrSBIndex..4, 576
  %"&pSB[currWI].offset1607" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1606"
  %CastToValueType1608 = bitcast i8* %"&pSB[currWI].offset1607" to double*
  store double %phi778, double* %CastToValueType1608, align 8
  ...
  br i1 %loadedValue1298, label %preload779, label %postload780
...
preload779:                                       ; preds = %postload777
  ...
  %CastToValueType1441 = bitcast i8* %"&pSB[currWI].offset1440" to double addrspace(3)**
  %loadedValue1442 = load double addrspace(3)** %CastToValueType1441, align 8
  %masked_load434 = load double addrspace(3)* %loadedValue1442, align 8
  %"&(pSB[currWI].offset)1615" = add nuw i64 %CurrSBIndex..4, 584
  %"&pSB[currWI].offset1616" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1615"
  %CastToValueType1617 = bitcast i8* %"&pSB[currWI].offset1616" to double*
  store double %masked_load434, double* %CastToValueType1617, align 8
  br label %postload780

postload780:                                      ; preds = %preload779, %postload777
  %phi781 = phi double [ undef, %postload777 ], [ %masked_load434, %preload779 ]
  %"&(pSB[currWI].offset)1619" = add nuw i64 %CurrSBIndex..4, 592
  %"&pSB[currWI].offset1620" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1619"
  %CastToValueType1621 = bitcast i8* %"&pSB[currWI].offset1620" to double*
  store double %phi781, double* %CastToValueType1621, align 8
  ...
  br i1 %loadedValue1307, label %preload782, label %postload783
...
preload782:                                       ; preds = %postload780
  ...
  %CastToValueType1450 = bitcast i8* %"&pSB[currWI].offset1449" to double addrspace(3)**
  %loadedValue1451 = load double addrspace(3)** %CastToValueType1450, align 8
  %masked_load435 = load double addrspace(3)* %loadedValue1451, align 8
  %"&(pSB[currWI].offset)1628" = add nuw i64 %CurrSBIndex..4, 600
  %"&pSB[currWI].offset1629" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1628"
  %CastToValueType1630 = bitcast i8* %"&pSB[currWI].offset1629" to double*
  store double %masked_load435, double* %CastToValueType1630, align 8
  br label %postload783

postload783:                                      ; preds = %preload782, %postload780
  %phi784 = phi double [ undef, %postload780 ], [ %masked_load435, %preload782 ]
  %"&(pSB[currWI].offset)1632" = add nuw i64 %CurrSBIndex..4, 608
  %"&pSB[currWI].offset1633" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1632"
  %CastToValueType1634 = bitcast i8* %"&pSB[currWI].offset1633" to double*
  store double %phi784, double* %CastToValueType1634, align 8
  ...
  br i1 %loadedValue1316, label %preload785, label %postload786
...
preload785:                                       ; preds = %postload783
  ...
  %CastToValueType1459 = bitcast i8* %"&pSB[currWI].offset1458" to double addrspace(3)**
  %loadedValue1460 = load double addrspace(3)** %CastToValueType1459, align 8
  %masked_load436 = load double addrspace(3)* %loadedValue1460, align 8
  %"&(pSB[currWI].offset)1641" = add nuw i64 %CurrSBIndex..4, 616
  %"&pSB[currWI].offset1642" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1641"
  %CastToValueType1643 = bitcast i8* %"&pSB[currWI].offset1642" to double*
  store double %masked_load436, double* %CastToValueType1643, align 8
  br label %postload786

postload786:                                      ; preds = %preload785, %postload783
  %phi787 = phi double [ undef, %postload783 ], [ %masked_load436, %preload785 ]
  %"&(pSB[currWI].offset)1645" = add nuw i64 %CurrSBIndex..4, 624
  %"&pSB[currWI].offset1646" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1645"
  %CastToValueType1647 = bitcast i8* %"&pSB[currWI].offset1646" to double*
  store double %phi787, double* %CastToValueType1647, align 8
  ...
  br i1 %loadedValue1325, label %preload788, label %postload789
...
preload788:                                       ; preds = %postload786
  ...
  %CastToValueType1468 = bitcast i8* %"&pSB[currWI].offset1467" to double addrspace(3)**
  %loadedValue1469 = load double addrspace(3)** %CastToValueType1468, align 8
  %masked_load437 = load double addrspace(3)* %loadedValue1469, align 8
  %"&(pSB[currWI].offset)1654" = add nuw i64 %CurrSBIndex..4, 632
  %"&pSB[currWI].offset1655" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1654"
  %CastToValueType1656 = bitcast i8* %"&pSB[currWI].offset1655" to double*
  store double %masked_load437, double* %CastToValueType1656, align 8
  br label %postload789

postload789:                                      ; preds = %preload788, %postload786
  %phi790 = phi double [ undef, %postload786 ], [ %masked_load437, %preload788 ]
  %"&(pSB[currWI].offset)1658" = add nuw i64 %CurrSBIndex..4, 640
  %"&pSB[currWI].offset1659" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1658"
  %CastToValueType1660 = bitcast i8* %"&pSB[currWI].offset1659" to double*
  store double %phi790, double* %CastToValueType1660, align 8
  ...
  br i1 %loadedValue1334, label %preload791, label %postload792
...
preload791:                                       ; preds = %postload789
  ...
  %CastToValueType1477 = bitcast i8* %"&pSB[currWI].offset1476" to double addrspace(3)**
  %loadedValue1478 = load double addrspace(3)** %CastToValueType1477, align 8
  %masked_load438 = load double addrspace(3)* %loadedValue1478, align 8
  %"&(pSB[currWI].offset)1667" = add nuw i64 %CurrSBIndex..4, 648
  %"&pSB[currWI].offset1668" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1667"
  %CastToValueType1669 = bitcast i8* %"&pSB[currWI].offset1668" to double*
  store double %masked_load438, double* %CastToValueType1669, align 8
  br label %postload792

postload792:                                      ; preds = %preload791, %postload789
  %phi793 = phi double [ undef, %postload789 ], [ %masked_load438, %preload791 ]
  %"&(pSB[currWI].offset)1671" = add nuw i64 %CurrSBIndex..4, 656
  %"&pSB[currWI].offset1672" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1671"
  %CastToValueType1673 = bitcast i8* %"&pSB[currWI].offset1672" to double*
  store double %phi793, double* %CastToValueType1673, align 8
  ...
  br i1 %loadedValue1343, label %preload794, label %postload795
...
preload794:                                       ; preds = %postload792
  ...
  %CastToValueType1486 = bitcast i8* %"&pSB[currWI].offset1485" to double addrspace(3)**
  %loadedValue1487 = load double addrspace(3)** %CastToValueType1486, align 8
  %masked_load439 = load double addrspace(3)* %loadedValue1487, align 8
  %"&(pSB[currWI].offset)1680" = add nuw i64 %CurrSBIndex..4, 664
  %"&pSB[currWI].offset1681" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1680"
  %CastToValueType1682 = bitcast i8* %"&pSB[currWI].offset1681" to double*
  store double %masked_load439, double* %CastToValueType1682, align 8
  br label %postload795

postload795:                                      ; preds = %preload794, %postload792
  %phi796 = phi double [ undef, %postload792 ], [ %masked_load439, %preload794 ]
  %"&(pSB[currWI].offset)1684" = add nuw i64 %CurrSBIndex..4, 672
  %"&pSB[currWI].offset1685" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1684"
  %CastToValueType1686 = bitcast i8* %"&pSB[currWI].offset1685" to double*
  store double %phi796, double* %CastToValueType1686, align 8
  ...
  br i1 %loadedValue1352, label %preload797, label %postload798

preload797:                                       ; preds = %postload795
  ...
  %CastToValueType1495 = bitcast i8* %"&pSB[currWI].offset1494" to double addrspace(3)**
  %loadedValue1496 = load double addrspace(3)** %CastToValueType1495, align 8
  %masked_load440 = load double addrspace(3)* %loadedValue1496, align 8
  %"&(pSB[currWI].offset)1693" = add nuw i64 %CurrSBIndex..4, 680
  %"&pSB[currWI].offset1694" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1693"
  %CastToValueType1695 = bitcast i8* %"&pSB[currWI].offset1694" to double*
  store double %masked_load440, double* %CastToValueType1695, align 8
  br label %postload798

postload798:                                      ; preds = %preload797, %postload795
  %phi799 = phi double [ undef, %postload795 ], [ %masked_load440, %preload797 ]
  %"&(pSB[currWI].offset)1506" = add nuw i64 %CurrSBIndex..4, 448
  %"&pSB[currWI].offset1507" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1506"
  %CastToValueType1508 = bitcast i8* %"&pSB[currWI].offset1507" to double*
  %loadedValue1509 = load double* %CastToValueType1508, align 8
  %temp.vect287 = insertelement <16 x double> undef, double %loadedValue1509, i32 0
  %"&(pSB[currWI].offset)1519" = add nuw i64 %CurrSBIndex..4, 464
  %"&pSB[currWI].offset1520" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1519"
  %CastToValueType1521 = bitcast i8* %"&pSB[currWI].offset1520" to double*
  %loadedValue1522 = load double* %CastToValueType1521, align 8
  %temp.vect288 = insertelement <16 x double> %temp.vect287, double %loadedValue1522, i32 1
  %"&(pSB[currWI].offset)1532" = add nuw i64 %CurrSBIndex..4, 480
  %"&pSB[currWI].offset1533" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1532"
  %CastToValueType1534 = bitcast i8* %"&pSB[currWI].offset1533" to double*
  %loadedValue1535 = load double* %CastToValueType1534, align 8
  %temp.vect289 = insertelement <16 x double> %temp.vect288, double %loadedValue1535, i32 2
  %"&(pSB[currWI].offset)1545" = add nuw i64 %CurrSBIndex..4, 496
  %"&pSB[currWI].offset1546" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1545"
  %CastToValueType1547 = bitcast i8* %"&pSB[currWI].offset1546" to double*
  %loadedValue1548 = load double* %CastToValueType1547, align 8
  %temp.vect290 = insertelement <16 x double> %temp.vect289, double %loadedValue1548, i32 3
  %"&(pSB[currWI].offset)1558" = add nuw i64 %CurrSBIndex..4, 512
  %"&pSB[currWI].offset1559" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1558"
  %CastToValueType1560 = bitcast i8* %"&pSB[currWI].offset1559" to double*
  %loadedValue1561 = load double* %CastToValueType1560, align 8
  %temp.vect291 = insertelement <16 x double> %temp.vect290, double %loadedValue1561, i32 4
  %"&(pSB[currWI].offset)1571" = add nuw i64 %CurrSBIndex..4, 528
  %"&pSB[currWI].offset1572" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1571"
  %CastToValueType1573 = bitcast i8* %"&pSB[currWI].offset1572" to double*
  %loadedValue1574 = load double* %CastToValueType1573, align 8
  %temp.vect292 = insertelement <16 x double> %temp.vect291, double %loadedValue1574, i32 5
  %"&(pSB[currWI].offset)1584" = add nuw i64 %CurrSBIndex..4, 544
  %"&pSB[currWI].offset1585" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1584"
  %CastToValueType1586 = bitcast i8* %"&pSB[currWI].offset1585" to double*
  %loadedValue1587 = load double* %CastToValueType1586, align 8
  %temp.vect293 = insertelement <16 x double> %temp.vect292, double %loadedValue1587, i32 6
  %"&(pSB[currWI].offset)1597" = add nuw i64 %CurrSBIndex..4, 560
  %"&pSB[currWI].offset1598" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1597"
  %CastToValueType1599 = bitcast i8* %"&pSB[currWI].offset1598" to double*
  %loadedValue1600 = load double* %CastToValueType1599, align 8
  %temp.vect294 = insertelement <16 x double> %temp.vect293, double %loadedValue1600, i32 7
  %"&(pSB[currWI].offset)1610" = add nuw i64 %CurrSBIndex..4, 576
  %"&pSB[currWI].offset1611" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1610"
  %CastToValueType1612 = bitcast i8* %"&pSB[currWI].offset1611" to double*
  %loadedValue1613 = load double* %CastToValueType1612, align 8
  %temp.vect295 = insertelement <16 x double> %temp.vect294, double %loadedValue1613, i32 8
  %"&(pSB[currWI].offset)1623" = add nuw i64 %CurrSBIndex..4, 592
  %"&pSB[currWI].offset1624" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1623"
  %CastToValueType1625 = bitcast i8* %"&pSB[currWI].offset1624" to double*
  %loadedValue1626 = load double* %CastToValueType1625, align 8
  %temp.vect296 = insertelement <16 x double> %temp.vect295, double %loadedValue1626, i32 9
  %"&(pSB[currWI].offset)1636" = add nuw i64 %CurrSBIndex..4, 608
  %"&pSB[currWI].offset1637" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1636"
  %CastToValueType1638 = bitcast i8* %"&pSB[currWI].offset1637" to double*
  %loadedValue1639 = load double* %CastToValueType1638, align 8
  %temp.vect297 = insertelement <16 x double> %temp.vect296, double %loadedValue1639, i32 10
  %"&(pSB[currWI].offset)1649" = add nuw i64 %CurrSBIndex..4, 624
  %"&pSB[currWI].offset1650" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1649"
  %CastToValueType1651 = bitcast i8* %"&pSB[currWI].offset1650" to double*
  %loadedValue1652 = load double* %CastToValueType1651, align 8
  %temp.vect298 = insertelement <16 x double> %temp.vect297, double %loadedValue1652, i32 11
  %"&(pSB[currWI].offset)1662" = add nuw i64 %CurrSBIndex..4, 640
  %"&pSB[currWI].offset1663" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1662"
  %CastToValueType1664 = bitcast i8* %"&pSB[currWI].offset1663" to double*
  %loadedValue1665 = load double* %CastToValueType1664, align 8
  %temp.vect299 = insertelement <16 x double> %temp.vect298, double %loadedValue1665, i32 12
  %"&(pSB[currWI].offset)1675" = add nuw i64 %CurrSBIndex..4, 656
  %"&pSB[currWI].offset1676" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1675"
  %CastToValueType1677 = bitcast i8* %"&pSB[currWI].offset1676" to double*
  %loadedValue1678 = load double* %CastToValueType1677, align 8
  %temp.vect300 = insertelement <16 x double> %temp.vect299, double %loadedValue1678, i32 13
  %"&(pSB[currWI].offset)1688" = add nuw i64 %CurrSBIndex..4, 672
  %"&pSB[currWI].offset1689" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1688"
  %CastToValueType1690 = bitcast i8* %"&pSB[currWI].offset1689" to double*
  %loadedValue1691 = load double* %CastToValueType1690, align 8
  %temp.vect301 = insertelement <16 x double> %temp.vect300, double %loadedValue1691, i32 14
  %temp.vect302 = insertelement <16 x double> %temp.vect301, double %phi799, i32 15
  %"&(pSB[currWI].offset)1697" = add nuw i64 %CurrSBIndex..4, 768
  ...
  store <16 x double> %temp.vect302, <16 x double>* %CastToValueType1699, align 128
  ...
  %CastToValueType1010 = bitcast i8* %"&pSB[currWI].offset1009" to double addrspace(3)**
  %loadedValue1011 = load double addrspace(3)** %CastToValueType1010, align 8
  %ptrTypeCast286 = bitcast double addrspace(3)* %loadedValue1011 to <16 x double> addrspace(3)*
  %"&(pSB[currWI].offset)1706" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1707" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1706"
  %CastToValueType1708 = bitcast i8* %"&pSB[currWI].offset1707" to <16 x double> addrspace(3)**
  store <16 x double> addrspace(3)* %ptrTypeCast286, <16 x double> addrspace(3)** %CastToValueType1708, align 8
  ...
  br i1 %exmask442, label %preload805, label %postload806

preload805:                                       ; preds = %postload798
  %"&(pSB[currWI].offset)1785" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1786" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1785"
  %CastToValueType1787 = bitcast i8* %"&pSB[currWI].offset1786" to <16 x double> addrspace(3)**
  %loadedValue1788 = load <16 x double> addrspace(3)** %CastToValueType1787, align 8
  %ptrTypeCast441 = getelementptr inbounds <16 x double> addrspace(3)* %loadedValue1788, i64 0, i64 0
  %vload443 = load double addrspace(3)* %ptrTypeCast441, align 8
  %"&(pSB[currWI].offset)1790" = add nuw i64 %CurrSBIndex..4, 904
  %"&pSB[currWI].offset1791" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1790"
  %CastToValueType1792 = bitcast i8* %"&pSB[currWI].offset1791" to double*
  store double %vload443, double* %CastToValueType1792, align 8
  br label %postload806

postload806:                                      ; preds = %preload805, %postload798
  %phi807 = phi double [ undef, %postload798 ], [ %vload443, %preload805 ]
  %vpack = insertelement <16 x double> undef, double %phi807, i32 0
  %"&(pSB[currWI].offset)1794" = add nuw i64 %CurrSBIndex..4, 1024
  %"&pSB[currWI].offset1795" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1794"
  %CastToValueType1796 = bitcast i8* %"&pSB[currWI].offset1795" to <16 x double>*
  store <16 x double> %vpack, <16 x double>* %CastToValueType1796, align 128
  ...
  br i1 %exmask445, label %preload608, label %postload609

preload608:                                       ; preds = %postload806
  %"&(pSB[currWI].offset)1780" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1781" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1780"
  %CastToValueType1782 = bitcast i8* %"&pSB[currWI].offset1781" to <16 x double> addrspace(3)**
  %loadedValue1783 = load <16 x double> addrspace(3)** %CastToValueType1782, align 8
  %vload444 = getelementptr <16 x double> addrspace(3)* %loadedValue1783, i64 0, i64 1
  %vload446 = load double addrspace(3)* %vload444, align 8
  %"&(pSB[currWI].offset)1803" = add nuw i64 %CurrSBIndex..4, 1152
  %"&pSB[currWI].offset1804" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1803"
  %CastToValueType1805 = bitcast i8* %"&pSB[currWI].offset1804" to double*
  store double %vload446, double* %CastToValueType1805, align 8
  br label %postload609

postload609:                                      ; preds = %preload608, %postload806
  %phi610 = phi double [ undef, %postload806 ], [ %vload446, %preload608 ]
  %"&(pSB[currWI].offset)1798" = add nuw i64 %CurrSBIndex..4, 1024
  %"&pSB[currWI].offset1799" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1798"
  %CastToValueType1800 = bitcast i8* %"&pSB[currWI].offset1799" to <16 x double>*
  %loadedValue1801 = load <16 x double>* %CastToValueType1800, align 128
  %vpack447 = insertelement <16 x double> %loadedValue1801, double %phi610, i32 1
  %"&(pSB[currWI].offset)1807" = add nuw i64 %CurrSBIndex..4, 1280
  %"&pSB[currWI].offset1808" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1807"
  %CastToValueType1809 = bitcast i8* %"&pSB[currWI].offset1808" to <16 x double>*
  store <16 x double> %vpack447, <16 x double>* %CastToValueType1809, align 128
  ...
  br i1 %exmask449, label %preload611, label %postload612

preload611:                                       ; preds = %postload609
  %"&(pSB[currWI].offset)1775" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1776" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1775"
  %CastToValueType1777 = bitcast i8* %"&pSB[currWI].offset1776" to <16 x double> addrspace(3)**
  %loadedValue1778 = load <16 x double> addrspace(3)** %CastToValueType1777, align 8
  %vload448 = getelementptr <16 x double> addrspace(3)* %loadedValue1778, i64 0, i64 2
  %vload450 = load double addrspace(3)* %vload448, align 8
  %"&(pSB[currWI].offset)1816" = add nuw i64 %CurrSBIndex..4, 1408
  %"&pSB[currWI].offset1817" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1816"
  %CastToValueType1818 = bitcast i8* %"&pSB[currWI].offset1817" to double*
  store double %vload450, double* %CastToValueType1818, align 8
  br label %postload612

postload612:                                      ; preds = %preload611, %postload609
  %phi613 = phi double [ undef, %postload609 ], [ %vload450, %preload611 ]
  %"&(pSB[currWI].offset)1811" = add nuw i64 %CurrSBIndex..4, 1280
  ...
  %vpack451 = insertelement <16 x double> %loadedValue1814, double %phi613, i32 2
  %"&(pSB[currWI].offset)1820" = add nuw i64 %CurrSBIndex..4, 1536
  %"&pSB[currWI].offset1821" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1820"
  %CastToValueType1822 = bitcast i8* %"&pSB[currWI].offset1821" to <16 x double>*
  store <16 x double> %vpack451, <16 x double>* %CastToValueType1822, align 128
  ...
  br i1 %exmask453, label %preload743, label %postload744

preload743:                                       ; preds = %postload612
  %"&(pSB[currWI].offset)1770" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1771" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1770"
  %CastToValueType1772 = bitcast i8* %"&pSB[currWI].offset1771" to <16 x double> addrspace(3)**
  %loadedValue1773 = load <16 x double> addrspace(3)** %CastToValueType1772, align 8
  %vload452 = getelementptr <16 x double> addrspace(3)* %loadedValue1773, i64 0, i64 3
  %vload454 = load double addrspace(3)* %vload452, align 8
  %"&(pSB[currWI].offset)1829" = add nuw i64 %CurrSBIndex..4, 1664
  %"&pSB[currWI].offset1830" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1829"
  %CastToValueType1831 = bitcast i8* %"&pSB[currWI].offset1830" to double*
  store double %vload454, double* %CastToValueType1831, align 8
  br label %postload744

postload744:                                      ; preds = %preload743, %postload612
  %phi745 = phi double [ undef, %postload612 ], [ %vload454, %preload743 ]
  %"&(pSB[currWI].offset)1824" = add nuw i64 %CurrSBIndex..4, 1536
  %"&pSB[currWI].offset1825" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1824"
  %CastToValueType1826 = bitcast i8* %"&pSB[currWI].offset1825" to <16 x double>*
  %loadedValue1827 = load <16 x double>* %CastToValueType1826, align 128
  %vpack455 = insertelement <16 x double> %loadedValue1827, double %phi745, i32 3
  %"&(pSB[currWI].offset)1833" = add nuw i64 %CurrSBIndex..4, 1792
  %"&pSB[currWI].offset1834" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1833"
  %CastToValueType1835 = bitcast i8* %"&pSB[currWI].offset1834" to <16 x double>*
  store <16 x double> %vpack455, <16 x double>* %CastToValueType1835, align 128
  ...
  br i1 %exmask457, label %preload746, label %postload747

preload746:                                       ; preds = %postload744
  %"&(pSB[currWI].offset)1765" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1766" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1765"
  %CastToValueType1767 = bitcast i8* %"&pSB[currWI].offset1766" to <16 x double> addrspace(3)**
  %loadedValue1768 = load <16 x double> addrspace(3)** %CastToValueType1767, align 8
  %vload456 = getelementptr <16 x double> addrspace(3)* %loadedValue1768, i64 0, i64 4
  %vload458 = load double addrspace(3)* %vload456, align 8
  %"&(pSB[currWI].offset)1842" = add nuw i64 %CurrSBIndex..4, 1920
  %"&pSB[currWI].offset1843" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1842"
  %CastToValueType1844 = bitcast i8* %"&pSB[currWI].offset1843" to double*
  store double %vload458, double* %CastToValueType1844, align 8
  br label %postload747

postload747:                                      ; preds = %preload746, %postload744
  %phi748 = phi double [ undef, %postload744 ], [ %vload458, %preload746 ]
  %"&(pSB[currWI].offset)1837" = add nuw i64 %CurrSBIndex..4, 1792
  %"&pSB[currWI].offset1838" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1837"
  %CastToValueType1839 = bitcast i8* %"&pSB[currWI].offset1838" to <16 x double>*
  %loadedValue1840 = load <16 x double>* %CastToValueType1839, align 128
  %vpack459 = insertelement <16 x double> %loadedValue1840, double %phi748, i32 4
  %"&(pSB[currWI].offset)1846" = add nuw i64 %CurrSBIndex..4, 2048
  ...
  store <16 x double> %vpack459, <16 x double>* %CastToValueType1848, align 128
  ...
  br i1 %exmask461, label %preload749, label %postload750

preload749:                                       ; preds = %postload747
  %"&(pSB[currWI].offset)1760" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1761" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1760"
  %CastToValueType1762 = bitcast i8* %"&pSB[currWI].offset1761" to <16 x double> addrspace(3)**
  %loadedValue1763 = load <16 x double> addrspace(3)** %CastToValueType1762, align 8
  %vload460 = getelementptr <16 x double> addrspace(3)* %loadedValue1763, i64 0, i64 5
  %vload462 = load double addrspace(3)* %vload460, align 8
  %"&(pSB[currWI].offset)1855" = add nuw i64 %CurrSBIndex..4, 2176
  %"&pSB[currWI].offset1856" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1855"
  %CastToValueType1857 = bitcast i8* %"&pSB[currWI].offset1856" to double*
  store double %vload462, double* %CastToValueType1857, align 8
  br label %postload750

postload750:                                      ; preds = %preload749, %postload747
  %phi751 = phi double [ undef, %postload747 ], [ %vload462, %preload749 ]
  %"&(pSB[currWI].offset)1850" = add nuw i64 %CurrSBIndex..4, 2048
  ...
  %vpack463 = insertelement <16 x double> %loadedValue1853, double %phi751, i32 5
  %"&(pSB[currWI].offset)1859" = add nuw i64 %CurrSBIndex..4, 2304
  ...
  store <16 x double> %vpack463, <16 x double>* %CastToValueType1861, align 128
  ...
  br i1 %exmask465, label %preload713, label %postload714

preload713:                                       ; preds = %postload750
  %"&(pSB[currWI].offset)1755" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1756" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1755"
  %CastToValueType1757 = bitcast i8* %"&pSB[currWI].offset1756" to <16 x double> addrspace(3)**
  %loadedValue1758 = load <16 x double> addrspace(3)** %CastToValueType1757, align 8
  %vload464 = getelementptr <16 x double> addrspace(3)* %loadedValue1758, i64 0, i64 6
  %vload466 = load double addrspace(3)* %vload464, align 8
  %"&(pSB[currWI].offset)1868" = add nuw i64 %CurrSBIndex..4, 2432
  %"&pSB[currWI].offset1869" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1868"
  %CastToValueType1870 = bitcast i8* %"&pSB[currWI].offset1869" to double*
  store double %vload466, double* %CastToValueType1870, align 8
  br label %postload714

postload714:                                      ; preds = %preload713, %postload750
  %phi715 = phi double [ undef, %postload750 ], [ %vload466, %preload713 ]
  %"&(pSB[currWI].offset)1863" = add nuw i64 %CurrSBIndex..4, 2304
  %"&pSB[currWI].offset1864" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1863"
  %CastToValueType1865 = bitcast i8* %"&pSB[currWI].offset1864" to <16 x double>*
  %loadedValue1866 = load <16 x double>* %CastToValueType1865, align 128
  %vpack467 = insertelement <16 x double> %loadedValue1866, double %phi715, i32 6
  %"&(pSB[currWI].offset)1872" = add nuw i64 %CurrSBIndex..4, 2560
  %"&pSB[currWI].offset1873" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1872"
  %CastToValueType1874 = bitcast i8* %"&pSB[currWI].offset1873" to <16 x double>*
  store <16 x double> %vpack467, <16 x double>* %CastToValueType1874, align 128
  ...
  br i1 %exmask469, label %preload716, label %postload717

preload716:                                       ; preds = %postload714
  %"&(pSB[currWI].offset)1750" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1751" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1750"
  %CastToValueType1752 = bitcast i8* %"&pSB[currWI].offset1751" to <16 x double> addrspace(3)**
  %loadedValue1753 = load <16 x double> addrspace(3)** %CastToValueType1752, align 8
  %vload468 = getelementptr <16 x double> addrspace(3)* %loadedValue1753, i64 0, i64 7
  %vload470 = load double addrspace(3)* %vload468, align 8
  %"&(pSB[currWI].offset)1881" = add nuw i64 %CurrSBIndex..4, 2688
  %"&pSB[currWI].offset1882" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1881"
  %CastToValueType1883 = bitcast i8* %"&pSB[currWI].offset1882" to double*
  store double %vload470, double* %CastToValueType1883, align 8
  br label %postload717

postload717:                                      ; preds = %preload716, %postload714
  %phi718 = phi double [ undef, %postload714 ], [ %vload470, %preload716 ]
  %"&(pSB[currWI].offset)1876" = add nuw i64 %CurrSBIndex..4, 2560
  %"&pSB[currWI].offset1877" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1876"
  %CastToValueType1878 = bitcast i8* %"&pSB[currWI].offset1877" to <16 x double>*
  %loadedValue1879 = load <16 x double>* %CastToValueType1878, align 128
  %vpack471 = insertelement <16 x double> %loadedValue1879, double %phi718, i32 7
  %"&(pSB[currWI].offset)1885" = add nuw i64 %CurrSBIndex..4, 2816
  ...
  store <16 x double> %vpack471, <16 x double>* %CastToValueType1887, align 128
  ...
  br i1 %exmask473, label %preload719, label %postload720

preload719:                                       ; preds = %postload717
  %"&(pSB[currWI].offset)1745" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1746" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1745"
  %CastToValueType1747 = bitcast i8* %"&pSB[currWI].offset1746" to <16 x double> addrspace(3)**
  %loadedValue1748 = load <16 x double> addrspace(3)** %CastToValueType1747, align 8
  %vload472 = getelementptr <16 x double> addrspace(3)* %loadedValue1748, i64 0, i64 8
  %vload474 = load double addrspace(3)* %vload472, align 8
  %"&(pSB[currWI].offset)1894" = add nuw i64 %CurrSBIndex..4, 2944
  %"&pSB[currWI].offset1895" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1894"
  %CastToValueType1896 = bitcast i8* %"&pSB[currWI].offset1895" to double*
  store double %vload474, double* %CastToValueType1896, align 8
  br label %postload720

postload720:                                      ; preds = %preload719, %postload717
  %phi721 = phi double [ undef, %postload717 ], [ %vload474, %preload719 ]
  %"&(pSB[currWI].offset)1889" = add nuw i64 %CurrSBIndex..4, 2816
  %"&pSB[currWI].offset1890" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1889"
  %CastToValueType1891 = bitcast i8* %"&pSB[currWI].offset1890" to <16 x double>*
  %loadedValue1892 = load <16 x double>* %CastToValueType1891, align 128
  %vpack475 = insertelement <16 x double> %loadedValue1892, double %phi721, i32 8
  %"&(pSB[currWI].offset)1898" = add nuw i64 %CurrSBIndex..4, 3072
  %"&pSB[currWI].offset1899" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1898"
  %CastToValueType1900 = bitcast i8* %"&pSB[currWI].offset1899" to <16 x double>*
  store <16 x double> %vpack475, <16 x double>* %CastToValueType1900, align 128
  ...
  br i1 %exmask477, label %preload722, label %postload723

preload722:                                       ; preds = %postload720
  %"&(pSB[currWI].offset)1740" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1741" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1740"
  %CastToValueType1742 = bitcast i8* %"&pSB[currWI].offset1741" to <16 x double> addrspace(3)**
  %loadedValue1743 = load <16 x double> addrspace(3)** %CastToValueType1742, align 8
  %vload476 = getelementptr <16 x double> addrspace(3)* %loadedValue1743, i64 0, i64 9
  %vload478 = load double addrspace(3)* %vload476, align 8
  %"&(pSB[currWI].offset)1907" = add nuw i64 %CurrSBIndex..4, 3200
  %"&pSB[currWI].offset1908" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1907"
  %CastToValueType1909 = bitcast i8* %"&pSB[currWI].offset1908" to double*
  store double %vload478, double* %CastToValueType1909, align 8
  br label %postload723

postload723:                                      ; preds = %preload722, %postload720
  %phi724 = phi double [ undef, %postload720 ], [ %vload478, %preload722 ]
  %"&(pSB[currWI].offset)1902" = add nuw i64 %CurrSBIndex..4, 3072
  %"&pSB[currWI].offset1903" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1902"
  %CastToValueType1904 = bitcast i8* %"&pSB[currWI].offset1903" to <16 x double>*
  %loadedValue1905 = load <16 x double>* %CastToValueType1904, align 128
  %vpack479 = insertelement <16 x double> %loadedValue1905, double %phi724, i32 9
  %"&(pSB[currWI].offset)1911" = add nuw i64 %CurrSBIndex..4, 3328
  %"&pSB[currWI].offset1912" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1911"
  %CastToValueType1913 = bitcast i8* %"&pSB[currWI].offset1912" to <16 x double>*
  store <16 x double> %vpack479, <16 x double>* %CastToValueType1913, align 128
  ...
  br i1 %exmask481, label %preload725, label %postload726

preload725:                                       ; preds = %postload723
  %"&(pSB[currWI].offset)1735" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1736" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1735"
  %CastToValueType1737 = bitcast i8* %"&pSB[currWI].offset1736" to <16 x double> addrspace(3)**
  %loadedValue1738 = load <16 x double> addrspace(3)** %CastToValueType1737, align 8
  %vload480 = getelementptr <16 x double> addrspace(3)* %loadedValue1738, i64 0, i64 10
  %vload482 = load double addrspace(3)* %vload480, align 8
  %"&(pSB[currWI].offset)1920" = add nuw i64 %CurrSBIndex..4, 3456
  %"&pSB[currWI].offset1921" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1920"
  %CastToValueType1922 = bitcast i8* %"&pSB[currWI].offset1921" to double*
  store double %vload482, double* %CastToValueType1922, align 8
  br label %postload726

postload726:                                      ; preds = %preload725, %postload723
  %phi727 = phi double [ undef, %postload723 ], [ %vload482, %preload725 ]
  %"&(pSB[currWI].offset)1915" = add nuw i64 %CurrSBIndex..4, 3328
  %"&pSB[currWI].offset1916" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1915"
  %CastToValueType1917 = bitcast i8* %"&pSB[currWI].offset1916" to <16 x double>*
  %loadedValue1918 = load <16 x double>* %CastToValueType1917, align 128
  %vpack483 = insertelement <16 x double> %loadedValue1918, double %phi727, i32 10
  %"&(pSB[currWI].offset)1924" = add nuw i64 %CurrSBIndex..4, 3584
  ...
  store <16 x double> %vpack483, <16 x double>* %CastToValueType1926, align 128
  ...
  br i1 %exmask485, label %preload728, label %postload729

preload728:                                       ; preds = %postload726
  %"&(pSB[currWI].offset)1730" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1731" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1730"
  %CastToValueType1732 = bitcast i8* %"&pSB[currWI].offset1731" to <16 x double> addrspace(3)**
  %loadedValue1733 = load <16 x double> addrspace(3)** %CastToValueType1732, align 8
  %vload484 = getelementptr <16 x double> addrspace(3)* %loadedValue1733, i64 0, i64 11
  %vload486 = load double addrspace(3)* %vload484, align 8
  %"&(pSB[currWI].offset)1933" = add nuw i64 %CurrSBIndex..4, 3712
  %"&pSB[currWI].offset1934" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1933"
  %CastToValueType1935 = bitcast i8* %"&pSB[currWI].offset1934" to double*
  store double %vload486, double* %CastToValueType1935, align 8
  br label %postload729

postload729:                                      ; preds = %preload728, %postload726
  %phi730 = phi double [ undef, %postload726 ], [ %vload486, %preload728 ]
  %"&(pSB[currWI].offset)1928" = add nuw i64 %CurrSBIndex..4, 3584
  %"&pSB[currWI].offset1929" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1928"
  %CastToValueType1930 = bitcast i8* %"&pSB[currWI].offset1929" to <16 x double>*
  %loadedValue1931 = load <16 x double>* %CastToValueType1930, align 128
  %vpack487 = insertelement <16 x double> %loadedValue1931, double %phi730, i32 11
  %"&(pSB[currWI].offset)1937" = add nuw i64 %CurrSBIndex..4, 3840
  ...
  store <16 x double> %vpack487, <16 x double>* %CastToValueType1939, align 128
  ...
  br i1 %exmask489, label %preload731, label %postload732

preload731:                                       ; preds = %postload729
  %"&(pSB[currWI].offset)1725" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1726" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1725"
  %CastToValueType1727 = bitcast i8* %"&pSB[currWI].offset1726" to <16 x double> addrspace(3)**
  %loadedValue1728 = load <16 x double> addrspace(3)** %CastToValueType1727, align 8
  %vload488 = getelementptr <16 x double> addrspace(3)* %loadedValue1728, i64 0, i64 12
  %vload490 = load double addrspace(3)* %vload488, align 8
  %"&(pSB[currWI].offset)1946" = add nuw i64 %CurrSBIndex..4, 3968
  ...
  store double %vload490, double* %CastToValueType1948, align 8
  br label %postload732

postload732:                                      ; preds = %preload731, %postload729
  %phi733 = phi double [ undef, %postload729 ], [ %vload490, %preload731 ]
  %"&(pSB[currWI].offset)1941" = add nuw i64 %CurrSBIndex..4, 3840
  %"&pSB[currWI].offset1942" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1941"
  %CastToValueType1943 = bitcast i8* %"&pSB[currWI].offset1942" to <16 x double>*
  %loadedValue1944 = load <16 x double>* %CastToValueType1943, align 128
  %vpack491 = insertelement <16 x double> %loadedValue1944, double %phi733, i32 12
  %"&(pSB[currWI].offset)1950" = add nuw i64 %CurrSBIndex..4, 4096
  %"&pSB[currWI].offset1951" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1950"
  %CastToValueType1952 = bitcast i8* %"&pSB[currWI].offset1951" to <16 x double>*
  store <16 x double> %vpack491, <16 x double>* %CastToValueType1952, align 128
  ...
  br i1 %exmask493, label %preload734, label %postload735

preload734:                                       ; preds = %postload732
  %"&(pSB[currWI].offset)1720" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1721" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1720"
  %CastToValueType1722 = bitcast i8* %"&pSB[currWI].offset1721" to <16 x double> addrspace(3)**
  %loadedValue1723 = load <16 x double> addrspace(3)** %CastToValueType1722, align 8
  %vload492 = getelementptr <16 x double> addrspace(3)* %loadedValue1723, i64 0, i64 13
  %vload494 = load double addrspace(3)* %vload492, align 8
  %"&(pSB[currWI].offset)1959" = add nuw i64 %CurrSBIndex..4, 4224
  %"&pSB[currWI].offset1960" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1959"
  %CastToValueType1961 = bitcast i8* %"&pSB[currWI].offset1960" to double*
  store double %vload494, double* %CastToValueType1961, align 8
  br label %postload735

postload735:                                      ; preds = %preload734, %postload732
  %phi736 = phi double [ undef, %postload732 ], [ %vload494, %preload734 ]
  %"&(pSB[currWI].offset)1954" = add nuw i64 %CurrSBIndex..4, 4096
  ...
  %vpack495 = insertelement <16 x double> %loadedValue1957, double %phi736, i32 13
  %"&(pSB[currWI].offset)1963" = add nuw i64 %CurrSBIndex..4, 4352
  %"&pSB[currWI].offset1964" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1963"
  %CastToValueType1965 = bitcast i8* %"&pSB[currWI].offset1964" to <16 x double>*
  store <16 x double> %vpack495, <16 x double>* %CastToValueType1965, align 128
  ...
  br i1 %exmask497, label %preload737, label %postload738

preload737:                                       ; preds = %postload735
  %"&(pSB[currWI].offset)1715" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1716" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1715"
  %CastToValueType1717 = bitcast i8* %"&pSB[currWI].offset1716" to <16 x double> addrspace(3)**
  %loadedValue1718 = load <16 x double> addrspace(3)** %CastToValueType1717, align 8
  %vload496 = getelementptr <16 x double> addrspace(3)* %loadedValue1718, i64 0, i64 14
  %vload498 = load double addrspace(3)* %vload496, align 8
  %"&(pSB[currWI].offset)1972" = add nuw i64 %CurrSBIndex..4, 4480
  %"&pSB[currWI].offset1973" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1972"
  %CastToValueType1974 = bitcast i8* %"&pSB[currWI].offset1973" to double*
  store double %vload498, double* %CastToValueType1974, align 8
  br label %postload738

postload738:                                      ; preds = %preload737, %postload735
  %phi739 = phi double [ undef, %postload735 ], [ %vload498, %preload737 ]
  %"&(pSB[currWI].offset)1967" = add nuw i64 %CurrSBIndex..4, 4352
  %"&pSB[currWI].offset1968" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1967"
  %CastToValueType1969 = bitcast i8* %"&pSB[currWI].offset1968" to <16 x double>*
  %loadedValue1970 = load <16 x double>* %CastToValueType1969, align 128
  %vpack499 = insertelement <16 x double> %loadedValue1970, double %phi739, i32 14
  %"&(pSB[currWI].offset)1976" = add nuw i64 %CurrSBIndex..4, 4608
  %"&pSB[currWI].offset1977" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1976"
  %CastToValueType1978 = bitcast i8* %"&pSB[currWI].offset1977" to <16 x double>*
  store <16 x double> %vpack499, <16 x double>* %CastToValueType1978, align 128
  ...
  br i1 %exmask501, label %preload740, label %postload741

preload740:                                       ; preds = %postload738
  %"&(pSB[currWI].offset)1710" = add nuw i64 %CurrSBIndex..4, 896
  %"&pSB[currWI].offset1711" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1710"
  %CastToValueType1712 = bitcast i8* %"&pSB[currWI].offset1711" to <16 x double> addrspace(3)**
  %loadedValue1713 = load <16 x double> addrspace(3)** %CastToValueType1712, align 8
  %vload500 = getelementptr <16 x double> addrspace(3)* %loadedValue1713, i64 0, i64 15
  %vload502 = load double addrspace(3)* %vload500, align 8
  %"&(pSB[currWI].offset)1985" = add nuw i64 %CurrSBIndex..4, 4736
  %"&pSB[currWI].offset1986" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1985"
  %CastToValueType1987 = bitcast i8* %"&pSB[currWI].offset1986" to double*
  store double %vload502, double* %CastToValueType1987, align 8
  br label %postload741

postload741:                                      ; preds = %preload740, %postload738
  %phi742 = phi double [ undef, %postload738 ], [ %vload502, %preload740 ]
  %"&(pSB[currWI].offset)1980" = add nuw i64 %CurrSBIndex..4, 4608
  %"&pSB[currWI].offset1981" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1980"
  %CastToValueType1982 = bitcast i8* %"&pSB[currWI].offset1981" to <16 x double>*
  %loadedValue1983 = load <16 x double>* %CastToValueType1982, align 128
  %vpack503 = insertelement <16 x double> %loadedValue1983, double %phi742, i32 15
  %"&(pSB[currWI].offset)1701" = add nuw i64 %CurrSBIndex..4, 768
  %"&pSB[currWI].offset1702" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1701"
  %CastToValueType1703 = bitcast i8* %"&pSB[currWI].offset1702" to <16 x double>*
  %loadedValue1704 = load <16 x double>* %CastToValueType1703, align 128
  %183 = fadd <16 x double> %vpack503, %loadedValue1704
  %"&(pSB[currWI].offset)1989" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset1990" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1989"
  %CastToValueType1991 = bitcast i8* %"&pSB[currWI].offset1990" to <16 x double>*
  store <16 x double> %183, <16 x double>* %CastToValueType1991, align 128
  ...
  %CastToValueType1005 = bitcast i8* %"&pSB[currWI].offset1004" to double addrspace(3)**
  %loadedValue1006 = load double addrspace(3)** %CastToValueType1005, align 8
  %ptrTypeCast303 = bitcast double addrspace(3)* %loadedValue1006 to <16 x double> addrspace(3)*
  %"&(pSB[currWI].offset)2073" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2074" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2073"
  %CastToValueType2075 = bitcast i8* %"&pSB[currWI].offset2074" to <16 x double> addrspace(3)**
  store <16 x double> addrspace(3)* %ptrTypeCast303, <16 x double> addrspace(3)** %CastToValueType2075, align 8
...
preload936:                                       ; preds = %postload741
  %"&(pSB[currWI].offset)2152" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2153" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2152"
  %CastToValueType2154 = bitcast i8* %"&pSB[currWI].offset2153" to <16 x double> addrspace(3)**
  %loadedValue2155 = load <16 x double> addrspace(3)** %CastToValueType2154, align 8
  %ptrTypeCast504 = getelementptr inbounds <16 x double> addrspace(3)* %loadedValue2155, i64 0, i64 0
  %"&(pSB[currWI].offset)2068" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2069" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2068"
  %CastToValueType2070 = bitcast i8* %"&pSB[currWI].offset2069" to <16 x double>*
  %loadedValue2071 = load <16 x double>* %CastToValueType2070, align 128
  %exData507 = extractelement <16 x double> %loadedValue2071, i32 0
  store double %exData507, double addrspace(3)* %ptrTypeCast504, align 8
  br label %postload937

postload937:                                      ; preds = %preload936, %postload741
...
preload939:                                       ; preds = %postload937
  %"&(pSB[currWI].offset)2147" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2148" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2147"
  %CastToValueType2149 = bitcast i8* %"&pSB[currWI].offset2148" to <16 x double> addrspace(3)**
  %loadedValue2150 = load <16 x double> addrspace(3)** %CastToValueType2149, align 8
  %vstore508 = getelementptr <16 x double> addrspace(3)* %loadedValue2150, i64 0, i64 1
  %"&(pSB[currWI].offset)2063" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2064" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2063"
  %CastToValueType2065 = bitcast i8* %"&pSB[currWI].offset2064" to <16 x double>*
  %loadedValue2066 = load <16 x double>* %CastToValueType2065, align 128
  %exData510 = extractelement <16 x double> %loadedValue2066, i32 1
  store double %exData510, double addrspace(3)* %vstore508, align 8
...
preload942:                                       ; preds = %postload940
  %"&(pSB[currWI].offset)2142" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2143" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2142"
  %CastToValueType2144 = bitcast i8* %"&pSB[currWI].offset2143" to <16 x double> addrspace(3)**
  %loadedValue2145 = load <16 x double> addrspace(3)** %CastToValueType2144, align 8
  %vstore511 = getelementptr <16 x double> addrspace(3)* %loadedValue2145, i64 0, i64 2
  %"&(pSB[currWI].offset)2058" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2059" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2058"
  %CastToValueType2060 = bitcast i8* %"&pSB[currWI].offset2059" to <16 x double>*
  %loadedValue2061 = load <16 x double>* %CastToValueType2060, align 128
  %exData513 = extractelement <16 x double> %loadedValue2061, i32 2
  store double %exData513, double addrspace(3)* %vstore511, align 8
...
preload945:                                       ; preds = %postload943
  %"&(pSB[currWI].offset)2137" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2138" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2137"
  %CastToValueType2139 = bitcast i8* %"&pSB[currWI].offset2138" to <16 x double> addrspace(3)**
  %loadedValue2140 = load <16 x double> addrspace(3)** %CastToValueType2139, align 8
  %vstore514 = getelementptr <16 x double> addrspace(3)* %loadedValue2140, i64 0, i64 3
  %"&(pSB[currWI].offset)2053" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2054" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2053"
  %CastToValueType2055 = bitcast i8* %"&pSB[currWI].offset2054" to <16 x double>*
  %loadedValue2056 = load <16 x double>* %CastToValueType2055, align 128
  %exData516 = extractelement <16 x double> %loadedValue2056, i32 3
  store double %exData516, double addrspace(3)* %vstore514, align 8
...
preload948:                                       ; preds = %postload946
  %"&(pSB[currWI].offset)2132" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2133" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2132"
  %CastToValueType2134 = bitcast i8* %"&pSB[currWI].offset2133" to <16 x double> addrspace(3)**
  %loadedValue2135 = load <16 x double> addrspace(3)** %CastToValueType2134, align 8
  %vstore517 = getelementptr <16 x double> addrspace(3)* %loadedValue2135, i64 0, i64 4
  %"&(pSB[currWI].offset)2048" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2049" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2048"
  %CastToValueType2050 = bitcast i8* %"&pSB[currWI].offset2049" to <16 x double>*
  %loadedValue2051 = load <16 x double>* %CastToValueType2050, align 128
  %exData519 = extractelement <16 x double> %loadedValue2051, i32 4
  store double %exData519, double addrspace(3)* %vstore517, align 8
...
preload951:                                       ; preds = %postload949
  %"&(pSB[currWI].offset)2127" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2128" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2127"
  %CastToValueType2129 = bitcast i8* %"&pSB[currWI].offset2128" to <16 x double> addrspace(3)**
  %loadedValue2130 = load <16 x double> addrspace(3)** %CastToValueType2129, align 8
  %vstore520 = getelementptr <16 x double> addrspace(3)* %loadedValue2130, i64 0, i64 5
  %"&(pSB[currWI].offset)2043" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2044" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2043"
  %CastToValueType2045 = bitcast i8* %"&pSB[currWI].offset2044" to <16 x double>*
  %loadedValue2046 = load <16 x double>* %CastToValueType2045, align 128
  %exData522 = extractelement <16 x double> %loadedValue2046, i32 5
  store double %exData522, double addrspace(3)* %vstore520, align 8
...
preload954:                                       ; preds = %postload952
  %"&(pSB[currWI].offset)2122" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2123" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2122"
  %CastToValueType2124 = bitcast i8* %"&pSB[currWI].offset2123" to <16 x double> addrspace(3)**
  %loadedValue2125 = load <16 x double> addrspace(3)** %CastToValueType2124, align 8
  %vstore523 = getelementptr <16 x double> addrspace(3)* %loadedValue2125, i64 0, i64 6
  %"&(pSB[currWI].offset)2038" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2039" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2038"
  %CastToValueType2040 = bitcast i8* %"&pSB[currWI].offset2039" to <16 x double>*
  %loadedValue2041 = load <16 x double>* %CastToValueType2040, align 128
  %exData525 = extractelement <16 x double> %loadedValue2041, i32 6
  store double %exData525, double addrspace(3)* %vstore523, align 8
...
preload957:                                       ; preds = %postload955
  %"&(pSB[currWI].offset)2117" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2118" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2117"
  %CastToValueType2119 = bitcast i8* %"&pSB[currWI].offset2118" to <16 x double> addrspace(3)**
  %loadedValue2120 = load <16 x double> addrspace(3)** %CastToValueType2119, align 8
  %vstore526 = getelementptr <16 x double> addrspace(3)* %loadedValue2120, i64 0, i64 7
  %"&(pSB[currWI].offset)2033" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2034" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2033"
  %CastToValueType2035 = bitcast i8* %"&pSB[currWI].offset2034" to <16 x double>*
  %loadedValue2036 = load <16 x double>* %CastToValueType2035, align 128
  %exData528 = extractelement <16 x double> %loadedValue2036, i32 7
  store double %exData528, double addrspace(3)* %vstore526, align 8
...
preload960:                                       ; preds = %postload958
  %"&(pSB[currWI].offset)2112" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2113" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2112"
  %CastToValueType2114 = bitcast i8* %"&pSB[currWI].offset2113" to <16 x double> addrspace(3)**
  %loadedValue2115 = load <16 x double> addrspace(3)** %CastToValueType2114, align 8
  %vstore529 = getelementptr <16 x double> addrspace(3)* %loadedValue2115, i64 0, i64 8
  %"&(pSB[currWI].offset)2028" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2029" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2028"
  %CastToValueType2030 = bitcast i8* %"&pSB[currWI].offset2029" to <16 x double>*
  %loadedValue2031 = load <16 x double>* %CastToValueType2030, align 128
  %exData531 = extractelement <16 x double> %loadedValue2031, i32 8
  store double %exData531, double addrspace(3)* %vstore529, align 8
...
preload963:                                       ; preds = %postload961
  %"&(pSB[currWI].offset)2107" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2108" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2107"
  %CastToValueType2109 = bitcast i8* %"&pSB[currWI].offset2108" to <16 x double> addrspace(3)**
  %loadedValue2110 = load <16 x double> addrspace(3)** %CastToValueType2109, align 8
  %vstore532 = getelementptr <16 x double> addrspace(3)* %loadedValue2110, i64 0, i64 9
  %"&(pSB[currWI].offset)2023" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2024" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2023"
  %CastToValueType2025 = bitcast i8* %"&pSB[currWI].offset2024" to <16 x double>*
  %loadedValue2026 = load <16 x double>* %CastToValueType2025, align 128
  %exData534 = extractelement <16 x double> %loadedValue2026, i32 9
  store double %exData534, double addrspace(3)* %vstore532, align 8
...
preload966:                                       ; preds = %postload964
  %"&(pSB[currWI].offset)2102" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2103" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2102"
  %CastToValueType2104 = bitcast i8* %"&pSB[currWI].offset2103" to <16 x double> addrspace(3)**
  %loadedValue2105 = load <16 x double> addrspace(3)** %CastToValueType2104, align 8
  %vstore535 = getelementptr <16 x double> addrspace(3)* %loadedValue2105, i64 0, i64 10
  %"&(pSB[currWI].offset)2018" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2019" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2018"
  %CastToValueType2020 = bitcast i8* %"&pSB[currWI].offset2019" to <16 x double>*
  %loadedValue2021 = load <16 x double>* %CastToValueType2020, align 128
  %exData537 = extractelement <16 x double> %loadedValue2021, i32 10
  store double %exData537, double addrspace(3)* %vstore535, align 8
...
preload969:                                       ; preds = %postload967
  %"&(pSB[currWI].offset)2097" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2098" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2097"
  %CastToValueType2099 = bitcast i8* %"&pSB[currWI].offset2098" to <16 x double> addrspace(3)**
  %loadedValue2100 = load <16 x double> addrspace(3)** %CastToValueType2099, align 8
  %vstore538 = getelementptr <16 x double> addrspace(3)* %loadedValue2100, i64 0, i64 11
  %"&(pSB[currWI].offset)2013" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2014" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2013"
  %CastToValueType2015 = bitcast i8* %"&pSB[currWI].offset2014" to <16 x double>*
  %loadedValue2016 = load <16 x double>* %CastToValueType2015, align 128
  %exData540 = extractelement <16 x double> %loadedValue2016, i32 11
  store double %exData540, double addrspace(3)* %vstore538, align 8
...
preload972:                                       ; preds = %postload970
  %"&(pSB[currWI].offset)2092" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2093" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2092"
  %CastToValueType2094 = bitcast i8* %"&pSB[currWI].offset2093" to <16 x double> addrspace(3)**
  %loadedValue2095 = load <16 x double> addrspace(3)** %CastToValueType2094, align 8
  %vstore541 = getelementptr <16 x double> addrspace(3)* %loadedValue2095, i64 0, i64 12
  %"&(pSB[currWI].offset)2008" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2009" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2008"
  %CastToValueType2010 = bitcast i8* %"&pSB[currWI].offset2009" to <16 x double>*
  %loadedValue2011 = load <16 x double>* %CastToValueType2010, align 128
  %exData543 = extractelement <16 x double> %loadedValue2011, i32 12
  store double %exData543, double addrspace(3)* %vstore541, align 8
...
preload975:                                       ; preds = %postload973
  %"&(pSB[currWI].offset)2087" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2088" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2087"
  %CastToValueType2089 = bitcast i8* %"&pSB[currWI].offset2088" to <16 x double> addrspace(3)**
  %loadedValue2090 = load <16 x double> addrspace(3)** %CastToValueType2089, align 8
  %vstore544 = getelementptr <16 x double> addrspace(3)* %loadedValue2090, i64 0, i64 13
  %"&(pSB[currWI].offset)2003" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset2004" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2003"
  %CastToValueType2005 = bitcast i8* %"&pSB[currWI].offset2004" to <16 x double>*
  %loadedValue2006 = load <16 x double>* %CastToValueType2005, align 128
  %exData546 = extractelement <16 x double> %loadedValue2006, i32 13
  store double %exData546, double addrspace(3)* %vstore544, align 8
...
preload978:                                       ; preds = %postload976
  %"&(pSB[currWI].offset)2082" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2083" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2082"
  %CastToValueType2084 = bitcast i8* %"&pSB[currWI].offset2083" to <16 x double> addrspace(3)**
  %loadedValue2085 = load <16 x double> addrspace(3)** %CastToValueType2084, align 8
  %vstore547 = getelementptr <16 x double> addrspace(3)* %loadedValue2085, i64 0, i64 14
  %"&(pSB[currWI].offset)1998" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset1999" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1998"
  %CastToValueType2000 = bitcast i8* %"&pSB[currWI].offset1999" to <16 x double>*
  %loadedValue2001 = load <16 x double>* %CastToValueType2000, align 128
  %exData549 = extractelement <16 x double> %loadedValue2001, i32 14
  store double %exData549, double addrspace(3)* %vstore547, align 8
...
preload981:                                       ; preds = %postload979
  %"&(pSB[currWI].offset)2077" = add nuw i64 %CurrSBIndex..4, 4992
  %"&pSB[currWI].offset2078" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)2077"
  %CastToValueType2079 = bitcast i8* %"&pSB[currWI].offset2078" to <16 x double> addrspace(3)**
  %loadedValue2080 = load <16 x double> addrspace(3)** %CastToValueType2079, align 8
  %vstore550 = getelementptr <16 x double> addrspace(3)* %loadedValue2080, i64 0, i64 15
  %"&(pSB[currWI].offset)1993" = add nuw i64 %CurrSBIndex..4, 4864
  %"&pSB[currWI].offset1994" = getelementptr inbounds i8* %pSpecialBuf, i64 %"&(pSB[currWI].offset)1993"
  %CastToValueType1995 = bitcast i8* %"&pSB[currWI].offset1994" to <16 x double>*
  %loadedValue1996 = load <16 x double>* %CastToValueType1995, align 128
  %exData552 = extractelement <16 x double> %loadedValue1996, i32 15
  store double %exData552, double addrspace(3)* %vstore550, align 8
...
postload982:                                      ; preds = %preload981, %postload979
  ...
  br i1 %extract306, label %preload800, label %postload801

preload800:                                       ; preds = %postload982
  %check.WI.iter2195 = icmp ult i64 %CurrWI..4, %iterCount
  br i1 %check.WI.iter2195, label %thenBB2192, label %postload801

thenBB2192:                                       ; preds = %preload800
  %"CurrWI++2196" = add nuw i64 %CurrWI..4, 1
  %"loadedCurrSB+Stride2198" = add nuw i64 %CurrSBIndex..4, 5120
  %cond13 = icmp eq i32 %currBarrier.2, 8
  br i1 %cond13, label %postload801, label %SyncBB

postload801:                                      ; preds = %thenBB2177, %thenBB2184, %thenBB2192, %preload800, %postload982
  %currBarrier.1 = phi i32 [ %currBarrier.2, %postload982 ], [ %currBarrier.3, %thenBB2184 ], [ %currBarrier.2, %thenBB2192 ], [ %currBarrier.3, %thenBB2177 ], [ 8, %preload800 ]
  %CurrSBIndex..3 = phi i64 [ %CurrSBIndex..4, %postload982 ], [ %"loadedCurrSB+Stride2190", %thenBB2184 ], [ %"loadedCurrSB+Stride2198", %thenBB2192 ], [ %"loadedCurrSB+Stride2183", %thenBB2177 ], [ 0, %preload800 ]
  %CurrWI..3 = phi i64 [ %CurrWI..4, %postload982 ], [ %"CurrWI++2188", %thenBB2184 ], [ %"CurrWI++2196", %thenBB2192 ], [ %"CurrWI++2181", %thenBB2177 ], [ 0, %preload800 ]
  ...
  %"&(pSB[currWI].offset)2157" = add nuw i64 %CurrSBIndex..3, 5000
  ...
  %"&(pSB[currWI].offset)2161" = add nuw i64 %CurrSBIndex..3, 5008
  ...
  %"&(pSB[currWI].offset)2165" = add nuw i64 %CurrSBIndex..3, 5024
...
._crit_edge:                                      ; preds = %postload801, %SyncBB
  %currBarrier.3 = phi i32 [ %currBarrier.4, %SyncBB ], [ %currBarrier.1, %postload801 ]
  %CurrSBIndex..5 = phi i64 [ %CurrSBIndex..1, %SyncBB ], [ %CurrSBIndex..3, %postload801 ]
  %CurrWI..5 = phi i64 [ %CurrWI..1, %SyncBB ], [ %CurrWI..3, %postload801 ]
...
postload932:                                      ; preds = %preload931, %postload924
  ...
  %202 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi821
  %203 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi829
  %204 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi837
  %205 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi845
  %206 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi853
  %207 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi861
  %208 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi869
  %209 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi877
  %210 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi885
  %211 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi893
  %212 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi901
  %213 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi909
  %214 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi917
  %215 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi925
  %216 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi933
  br i1 %extract332, label %preload814, label %postload815

preload814:                                       ; preds = %postload932
  %217 = getelementptr inbounds double addrspace(1)* %g_odata, i64 %phi813
  store double %phi810, double addrspace(1)* %217, align 8
...
preload822:                                       ; preds = %postload815
  store double %phi818, double addrspace(1)* %202, align 8
...
preload830:                                       ; preds = %postload823
  store double %phi826, double addrspace(1)* %203, align 8
...
preload838:                                       ; preds = %postload831
  store double %phi834, double addrspace(1)* %204, align 8
...
preload846:                                       ; preds = %postload839
  store double %phi842, double addrspace(1)* %205, align 8
...
preload854:                                       ; preds = %postload847
  store double %phi850, double addrspace(1)* %206, align 8
...
preload862:                                       ; preds = %postload855
  store double %phi858, double addrspace(1)* %207, align 8
...
preload870:                                       ; preds = %postload863
  store double %phi866, double addrspace(1)* %208, align 8
...
preload878:                                       ; preds = %postload871
  store double %phi874, double addrspace(1)* %209, align 8
...
preload886:                                       ; preds = %postload879
  store double %phi882, double addrspace(1)* %210, align 8
...
preload894:                                       ; preds = %postload887
  store double %phi890, double addrspace(1)* %211, align 8
...
preload902:                                       ; preds = %postload895
  store double %phi898, double addrspace(1)* %212, align 8
...
preload910:                                       ; preds = %postload903
  store double %phi906, double addrspace(1)* %213, align 8
...
preload918:                                       ; preds = %postload911
  store double %phi914, double addrspace(1)* %214, align 8
...
preload926:                                       ; preds = %postload919
  store double %phi922, double addrspace(1)* %215, align 8
...
preload934:                                       ; preds = %postload927
  store double %phi930, double addrspace(1)* %216, align 8
  %check.WI.iter2187 = icmp ult i64 %CurrWI..5, %iterCount
  br i1 %check.WI.iter2187, label %thenBB2184, label %SyncBB2174

thenBB2184:                                       ; preds = %preload934
  %"CurrWI++2188" = add nuw i64 %CurrWI..5, 1
  %"loadedCurrSB+Stride2190" = add nuw i64 %CurrSBIndex..5, 5120
  %cond12 = icmp eq i32 %currBarrier.3, 8
  br i1 %cond12, label %postload801, label %SyncBB

SyncBB2174:                                       ; preds = %UnifiedReturnBlock, %preload934
  ret void

UnifiedReturnBlock:                               ; preds = %postload927
  %check.WI.iter2180 = icmp ult i64 %CurrWI..5, %iterCount
  br i1 %check.WI.iter2180, label %thenBB2177, label %SyncBB2174

thenBB2177:                                       ; preds = %UnifiedReturnBlock
  %"CurrWI++2181" = add nuw i64 %CurrWI..5, 1
  %"loadedCurrSB+Stride2183" = add nuw i64 %CurrSBIndex..5, 5120
  %cond = icmp eq i32 %currBarrier.3, 8
  br i1 %cond, label %postload801, label %SyncBB
}

define void @____Vectorized_.reduceNoLocal_separated_args(double addrspace(1)* nocapture %g_idata, double addrspace(1)* nocapture %g_odata, i32 %n, i8 addrspace(3)* %pLocalMem, %struct.WorkDim* %pWorkDim, i64* %pWGId, %struct.PaddedDimId* %pBaseGlbId, %struct.PaddedDimId* %pLocalIds, i64* %contextpointer, i64 %iterCount, i8* %pSpecialBuf, i64* %pCurrWI) nounwind alwaysinline {
FirstBB:
  %0 = icmp eq i32 %n, 0
  %tmp = zext i32 %n to i64
  br label %SyncBB
...
thenBB.i:                                         ; preds = %._crit_edge5.i
  ...
  %"loadedCurrSB+Stride.i" = add nuw i64 %CurrSBIndex..0.i, 5120
  br label %SyncBB74.i
...
thenBB76.i:                                       ; preds = %64
  ...
  %"loadedCurrSB+Stride82.i" = add nuw i64 %CurrSBIndex..3.i, 5120
...
thenBB83.i:                                       ; preds = %UnifiedReturnBlock.i
  ...
  %"loadedCurrSB+Stride89.i" = add nuw i64 %CurrSBIndex..4.i, 5120
...
SyncBB2172.i:                                     ; preds = %thenBB.i, %entry
  ...
  %"&(pSB[currWI].offset)9.i" = or i64 %CurrSBIndex..0.i, 64
  ...
  %42 = getelementptr inbounds double addrspace(3)* %7, i64 %extract.i
  %"&(pSB[currWI].offset)99910.i" = or i64 %CurrSBIndex..0.i, 128
  %"&pSB[currWI].offset1000.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)99910.i"
  %CastToValueType1001.i = bitcast i8* %"&pSB[currWI].offset1000.i" to double addrspace(3)**
  store double addrspace(3)* %42, double addrspace(3)** %CastToValueType1001.i, align 8
  %ptrTypeCast.i = bitcast double addrspace(3)* %42 to <16 x double> addrspace(3)*
...
.preheader.i:                                     ; preds = %SyncBB2172.i
  ...
  %"&(pSB[currWI].offset)101311.i" = or i64 %CurrSBIndex..0.i, 128
  %"&pSB[currWI].offset1014.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)101311.i"
  %CastToValueType1015.i = bitcast i8* %"&pSB[currWI].offset1014.i" to double addrspace(3)**
  br label %44

; <label>:44                                      ; preds = %postload803.i, %.preheader.i
  %vectorPHI.i = phi <16 x i1> [ %loop_mask11206.i, %postload803.i ], [ %negIncomingLoopMask112.i, %.preheader.i ]
  %vectorPHI114.i = phi <16 x i1> [ %local_edge225.i, %postload803.i ], [ %43, %.preheader.i ]
  %vectorPHI115.i = phi <16 x double> [ %142, %postload803.i ], [ zeroinitializer, %.preheader.i ]
  %indvar.i = phi i32 [ %indvar.next.i, %postload803.i ], [ 0, %.preheader.i ]
  ...
  %56 = getelementptr inbounds double addrspace(1)* %1, i64 %55
  ...
  %62 = getelementptr inbounds double addrspace(1)* %1, i64 %61
  ...
  %74 = getelementptr inbounds double addrspace(1)* %1, i64 %73
  %75 = extractelement <16 x i32> %i.03119.i, i32 11
  %76 = zext i32 %75 to i64
  %77 = getelementptr inbounds double addrspace(1)* %1, i64 %76
  ...
  %86 = getelementptr inbounds double addrspace(1)* %1, i64 %85
  %87 = extractelement <16 x i32> %i.03119.i, i32 15
  %88 = zext i32 %87 to i64
  %89 = getelementptr inbounds double addrspace(1)* %1, i64 %88
  br i1 %extract137.i, label %preload614.i, label %postload615.i

preload614.i:                                     ; preds = %44
  %90 = extractelement <16 x i32> %i.03119.i, i32 0
  %91 = zext i32 %90 to i64
  %92 = getelementptr inbounds double addrspace(1)* %1, i64 %91
  %masked_load.i = load double addrspace(1)* %92, align 8
  br label %postload615.i

postload615.i:                                    ; preds = %preload614.i, %44
  %phi616.i = phi double [ undef, %44 ], [ %masked_load.i, %preload614.i ]
  br i1 %extract138.i, label %preload620.i, label %postload621.i

preload620.i:                                     ; preds = %postload615.i
  %masked_load348.i = load double addrspace(1)* %47, align 8
  br label %postload621.i

postload621.i:                                    ; preds = %preload620.i, %postload615.i
  %phi622.i = phi double [ undef, %postload615.i ], [ %masked_load348.i, %preload620.i ]
  br i1 %extract139.i, label %preload626.i, label %postload627.i

preload626.i:                                     ; preds = %postload621.i
  %masked_load349.i = load double addrspace(1)* %50, align 8
  br label %postload627.i

postload627.i:                                    ; preds = %preload626.i, %postload621.i
  %phi628.i = phi double [ undef, %postload621.i ], [ %masked_load349.i, %preload626.i ]
  br i1 %extract140.i, label %preload632.i, label %postload633.i

preload632.i:                                     ; preds = %postload627.i
  %masked_load350.i = load double addrspace(1)* %53, align 8
  br label %postload633.i

postload633.i:                                    ; preds = %preload632.i, %postload627.i
  %phi634.i = phi double [ undef, %postload627.i ], [ %masked_load350.i, %preload632.i ]
  br i1 %extract141.i, label %preload638.i, label %postload639.i

preload638.i:                                     ; preds = %postload633.i
  %masked_load351.i = load double addrspace(1)* %56, align 8
  br label %postload639.i

postload639.i:                                    ; preds = %preload638.i, %postload633.i
  %phi640.i = phi double [ undef, %postload633.i ], [ %masked_load351.i, %preload638.i ]
  br i1 %extract142.i, label %preload644.i, label %postload645.i

preload644.i:                                     ; preds = %postload639.i
  %masked_load352.i = load double addrspace(1)* %59, align 8
  br label %postload645.i

postload645.i:                                    ; preds = %preload644.i, %postload639.i
  %phi646.i = phi double [ undef, %postload639.i ], [ %masked_load352.i, %preload644.i ]
  br i1 %extract143.i, label %preload650.i, label %postload651.i

preload650.i:                                     ; preds = %postload645.i
  %masked_load353.i = load double addrspace(1)* %62, align 8
  br label %postload651.i

postload651.i:                                    ; preds = %preload650.i, %postload645.i
  %phi652.i = phi double [ undef, %postload645.i ], [ %masked_load353.i, %preload650.i ]
  br i1 %extract144.i, label %preload656.i, label %postload657.i

preload656.i:                                     ; preds = %postload651.i
  %masked_load354.i = load double addrspace(1)* %65, align 8
  br label %postload657.i

postload657.i:                                    ; preds = %preload656.i, %postload651.i
  %phi658.i = phi double [ undef, %postload651.i ], [ %masked_load354.i, %preload656.i ]
  br i1 %extract145.i, label %preload662.i, label %postload663.i

preload662.i:                                     ; preds = %postload657.i
  %masked_load355.i = load double addrspace(1)* %68, align 8
  br label %postload663.i

postload663.i:                                    ; preds = %preload662.i, %postload657.i
  %phi664.i = phi double [ undef, %postload657.i ], [ %masked_load355.i, %preload662.i ]
  br i1 %extract146.i, label %preload668.i, label %postload669.i

preload668.i:                                     ; preds = %postload663.i
  %masked_load356.i = load double addrspace(1)* %71, align 8
  br label %postload669.i

postload669.i:                                    ; preds = %preload668.i, %postload663.i
  %phi670.i = phi double [ undef, %postload663.i ], [ %masked_load356.i, %preload668.i ]
  br i1 %extract147.i, label %preload674.i, label %postload675.i

preload674.i:                                     ; preds = %postload669.i
  %masked_load357.i = load double addrspace(1)* %74, align 8
  br label %postload675.i

postload675.i:                                    ; preds = %preload674.i, %postload669.i
  %phi676.i = phi double [ undef, %postload669.i ], [ %masked_load357.i, %preload674.i ]
  br i1 %extract148.i, label %preload680.i, label %postload681.i

preload680.i:                                     ; preds = %postload675.i
  %masked_load358.i = load double addrspace(1)* %77, align 8
  br label %postload681.i

postload681.i:                                    ; preds = %preload680.i, %postload675.i
  %phi682.i = phi double [ undef, %postload675.i ], [ %masked_load358.i, %preload680.i ]
  br i1 %extract149.i, label %preload686.i, label %postload687.i

preload686.i:                                     ; preds = %postload681.i
  %masked_load359.i = load double addrspace(1)* %80, align 8
  br label %postload687.i

postload687.i:                                    ; preds = %preload686.i, %postload681.i
  %phi688.i = phi double [ undef, %postload681.i ], [ %masked_load359.i, %preload686.i ]
  br i1 %extract150.i, label %preload692.i, label %postload693.i

preload692.i:                                     ; preds = %postload687.i
  %masked_load360.i = load double addrspace(1)* %83, align 8
  br label %postload693.i

postload693.i:                                    ; preds = %preload692.i, %postload687.i
  %phi694.i = phi double [ undef, %postload687.i ], [ %masked_load360.i, %preload692.i ]
  br i1 %extract151.i, label %preload698.i, label %postload699.i

preload698.i:                                     ; preds = %postload693.i
  %masked_load361.i = load double addrspace(1)* %86, align 8
  br label %postload699.i

postload699.i:                                    ; preds = %preload698.i, %postload693.i
  %phi700.i = phi double [ undef, %postload693.i ], [ %masked_load361.i, %preload698.i ]
  br i1 %extract152.i, label %preload704.i, label %postload705.i

preload704.i:                                     ; preds = %postload699.i
  %masked_load362.i = load double addrspace(1)* %89, align 8
  br label %postload705.i

postload705.i:                                    ; preds = %preload704.i, %postload699.i
  %phi706.i = phi double [ undef, %postload699.i ], [ %masked_load362.i, %preload704.i ]
  %temp.vect169.i = insertelement <16 x double> undef, double %phi616.i, i32 0
  %temp.vect170.i = insertelement <16 x double> %temp.vect169.i, double %phi622.i, i32 1
  %temp.vect171.i = insertelement <16 x double> %temp.vect170.i, double %phi628.i, i32 2
  %temp.vect172.i = insertelement <16 x double> %temp.vect171.i, double %phi634.i, i32 3
  %temp.vect173.i = insertelement <16 x double> %temp.vect172.i, double %phi640.i, i32 4
  %temp.vect174.i = insertelement <16 x double> %temp.vect173.i, double %phi646.i, i32 5
  %temp.vect175.i = insertelement <16 x double> %temp.vect174.i, double %phi652.i, i32 6
  %temp.vect176.i = insertelement <16 x double> %temp.vect175.i, double %phi658.i, i32 7
  %temp.vect177.i = insertelement <16 x double> %temp.vect176.i, double %phi664.i, i32 8
  %temp.vect178.i = insertelement <16 x double> %temp.vect177.i, double %phi670.i, i32 9
  %temp.vect179.i = insertelement <16 x double> %temp.vect178.i, double %phi676.i, i32 10
  %temp.vect180.i = insertelement <16 x double> %temp.vect179.i, double %phi682.i, i32 11
  %temp.vect181.i = insertelement <16 x double> %temp.vect180.i, double %phi688.i, i32 12
  %temp.vect182.i = insertelement <16 x double> %temp.vect181.i, double %phi694.i, i32 13
  %temp.vect183.i = insertelement <16 x double> %temp.vect182.i, double %phi700.i, i32 14
  %temp.vect184.i = insertelement <16 x double> %temp.vect183.i, double %phi706.i, i32 15
  %93 = extractelement <16 x i32> %tmp16120.i, i32 1
  %94 = zext i32 %93 to i64
  %95 = getelementptr inbounds double addrspace(1)* %1, i64 %94
  ...
  %104 = getelementptr inbounds double addrspace(1)* %1, i64 %103
  %105 = extractelement <16 x i32> %tmp16120.i, i32 5
  %106 = zext i32 %105 to i64
  %107 = getelementptr inbounds double addrspace(1)* %1, i64 %106
  %108 = extractelement <16 x i32> %tmp16120.i, i32 6
  %109 = zext i32 %108 to i64
  %110 = getelementptr inbounds double addrspace(1)* %1, i64 %109
  %111 = extractelement <16 x i32> %tmp16120.i, i32 7
  %112 = zext i32 %111 to i64
  %113 = getelementptr inbounds double addrspace(1)* %1, i64 %112
  ...
  %122 = getelementptr inbounds double addrspace(1)* %1, i64 %121
  ...
  %128 = getelementptr inbounds double addrspace(1)* %1, i64 %127
  %129 = extractelement <16 x i32> %tmp16120.i, i32 13
  %130 = zext i32 %129 to i64
  %131 = getelementptr inbounds double addrspace(1)* %1, i64 %130
  ...
  br i1 %extract137.i, label %preload617.i, label %postload618.i

preload617.i:                                     ; preds = %postload705.i
  %138 = extractelement <16 x i32> %tmp16120.i, i32 0
  %139 = zext i32 %138 to i64
  %140 = getelementptr inbounds double addrspace(1)* %1, i64 %139
  %masked_load363.i = load double addrspace(1)* %140, align 8
  br label %postload618.i

postload618.i:                                    ; preds = %preload617.i, %postload705.i
  %phi619.i = phi double [ undef, %postload705.i ], [ %masked_load363.i, %preload617.i ]
  br i1 %extract138.i, label %preload623.i, label %postload624.i

preload623.i:                                     ; preds = %postload618.i
  %masked_load364.i = load double addrspace(1)* %95, align 8
  br label %postload624.i

postload624.i:                                    ; preds = %preload623.i, %postload618.i
  %phi625.i = phi double [ undef, %postload618.i ], [ %masked_load364.i, %preload623.i ]
  br i1 %extract139.i, label %preload629.i, label %postload630.i

preload629.i:                                     ; preds = %postload624.i
  %masked_load365.i = load double addrspace(1)* %98, align 8
  br label %postload630.i

postload630.i:                                    ; preds = %preload629.i, %postload624.i
  %phi631.i = phi double [ undef, %postload624.i ], [ %masked_load365.i, %preload629.i ]
  br i1 %extract140.i, label %preload635.i, label %postload636.i

preload635.i:                                     ; preds = %postload630.i
  %masked_load366.i = load double addrspace(1)* %101, align 8
  br label %postload636.i

postload636.i:                                    ; preds = %preload635.i, %postload630.i
  %phi637.i = phi double [ undef, %postload630.i ], [ %masked_load366.i, %preload635.i ]
  br i1 %extract141.i, label %preload641.i, label %postload642.i

preload641.i:                                     ; preds = %postload636.i
  %masked_load367.i = load double addrspace(1)* %104, align 8
  br label %postload642.i

postload642.i:                                    ; preds = %preload641.i, %postload636.i
  %phi643.i = phi double [ undef, %postload636.i ], [ %masked_load367.i, %preload641.i ]
  br i1 %extract142.i, label %preload647.i, label %postload648.i

preload647.i:                                     ; preds = %postload642.i
  %masked_load368.i = load double addrspace(1)* %107, align 8
  br label %postload648.i

postload648.i:                                    ; preds = %preload647.i, %postload642.i
  %phi649.i = phi double [ undef, %postload642.i ], [ %masked_load368.i, %preload647.i ]
  br i1 %extract143.i, label %preload653.i, label %postload654.i

preload653.i:                                     ; preds = %postload648.i
  %masked_load369.i = load double addrspace(1)* %110, align 8
  br label %postload654.i

postload654.i:                                    ; preds = %preload653.i, %postload648.i
  %phi655.i = phi double [ undef, %postload648.i ], [ %masked_load369.i, %preload653.i ]
  br i1 %extract144.i, label %preload659.i, label %postload660.i

preload659.i:                                     ; preds = %postload654.i
  %masked_load370.i = load double addrspace(1)* %113, align 8
  br label %postload660.i

postload660.i:                                    ; preds = %preload659.i, %postload654.i
  %phi661.i = phi double [ undef, %postload654.i ], [ %masked_load370.i, %preload659.i ]
  br i1 %extract145.i, label %preload665.i, label %postload666.i

preload665.i:                                     ; preds = %postload660.i
  %masked_load371.i = load double addrspace(1)* %116, align 8
  br label %postload666.i

postload666.i:                                    ; preds = %preload665.i, %postload660.i
  %phi667.i = phi double [ undef, %postload660.i ], [ %masked_load371.i, %preload665.i ]
  br i1 %extract146.i, label %preload671.i, label %postload672.i

preload671.i:                                     ; preds = %postload666.i
  %masked_load372.i = load double addrspace(1)* %119, align 8
  br label %postload672.i

postload672.i:                                    ; preds = %preload671.i, %postload666.i
  %phi673.i = phi double [ undef, %postload666.i ], [ %masked_load372.i, %preload671.i ]
  br i1 %extract147.i, label %preload677.i, label %postload678.i

preload677.i:                                     ; preds = %postload672.i
  %masked_load373.i = load double addrspace(1)* %122, align 8
  br label %postload678.i

postload678.i:                                    ; preds = %preload677.i, %postload672.i
  %phi679.i = phi double [ undef, %postload672.i ], [ %masked_load373.i, %preload677.i ]
  br i1 %extract148.i, label %preload683.i, label %postload684.i

preload683.i:                                     ; preds = %postload678.i
  %masked_load374.i = load double addrspace(1)* %125, align 8
  br label %postload684.i

postload684.i:                                    ; preds = %preload683.i, %postload678.i
  %phi685.i = phi double [ undef, %postload678.i ], [ %masked_load374.i, %preload683.i ]
  br i1 %extract149.i, label %preload689.i, label %postload690.i

preload689.i:                                     ; preds = %postload684.i
  %masked_load375.i = load double addrspace(1)* %128, align 8
  br label %postload690.i

postload690.i:                                    ; preds = %preload689.i, %postload684.i
  %phi691.i = phi double [ undef, %postload684.i ], [ %masked_load375.i, %preload689.i ]
  br i1 %extract150.i, label %preload695.i, label %postload696.i

preload695.i:                                     ; preds = %postload690.i
  %masked_load376.i = load double addrspace(1)* %131, align 8
  br label %postload696.i

postload696.i:                                    ; preds = %preload695.i, %postload690.i
  %phi697.i = phi double [ undef, %postload690.i ], [ %masked_load376.i, %preload695.i ]
  br i1 %extract151.i, label %preload701.i, label %postload702.i

preload701.i:                                     ; preds = %postload696.i
  %masked_load377.i = load double addrspace(1)* %134, align 8
  br label %postload702.i

postload702.i:                                    ; preds = %preload701.i, %postload696.i
  %phi703.i = phi double [ undef, %postload696.i ], [ %masked_load377.i, %preload701.i ]
  br i1 %extract152.i, label %preload707.i, label %postload708.i

preload707.i:                                     ; preds = %postload702.i
  %masked_load378.i = load double addrspace(1)* %137, align 8
  br label %postload708.i

postload708.i:                                    ; preds = %preload707.i, %postload702.i
  %phi709.i = phi double [ undef, %postload702.i ], [ %masked_load378.i, %preload707.i ]
  %temp.vect185.i = insertelement <16 x double> undef, double %phi619.i, i32 0
  %temp.vect186.i = insertelement <16 x double> %temp.vect185.i, double %phi625.i, i32 1
  %temp.vect187.i = insertelement <16 x double> %temp.vect186.i, double %phi631.i, i32 2
  %temp.vect188.i = insertelement <16 x double> %temp.vect187.i, double %phi637.i, i32 3
  %temp.vect189.i = insertelement <16 x double> %temp.vect188.i, double %phi643.i, i32 4
  %temp.vect190.i = insertelement <16 x double> %temp.vect189.i, double %phi649.i, i32 5
  %temp.vect191.i = insertelement <16 x double> %temp.vect190.i, double %phi655.i, i32 6
  %temp.vect192.i = insertelement <16 x double> %temp.vect191.i, double %phi661.i, i32 7
  %temp.vect193.i = insertelement <16 x double> %temp.vect192.i, double %phi667.i, i32 8
  %temp.vect194.i = insertelement <16 x double> %temp.vect193.i, double %phi673.i, i32 9
  %temp.vect195.i = insertelement <16 x double> %temp.vect194.i, double %phi679.i, i32 10
  %temp.vect196.i = insertelement <16 x double> %temp.vect195.i, double %phi685.i, i32 11
  %temp.vect197.i = insertelement <16 x double> %temp.vect196.i, double %phi691.i, i32 12
  %temp.vect198.i = insertelement <16 x double> %temp.vect197.i, double %phi697.i, i32 13
  %temp.vect199.i = insertelement <16 x double> %temp.vect198.i, double %phi703.i, i32 14
  %temp.vect200.i = insertelement <16 x double> %temp.vect199.i, double %phi709.i, i32 15
  %141 = fadd <16 x double> %temp.vect184.i, %temp.vect200.i
  %142 = fadd <16 x double> %vectorPHI115.i, %141
  %loadedValue1016.i = load double addrspace(3)** %CastToValueType1015.i, align 8
  %exmask.i = extractelement <16 x i1> %vectorPHI114.i, i32 0
  br i1 %exmask.i, label %preload710.i, label %postload711.i

preload710.i:                                     ; preds = %postload708.i
  %exData.i = extractelement <16 x double> %142, i32 0
  store double %exData.i, double addrspace(3)* %loadedValue1016.i, align 8
  br label %postload711.i

postload711.i:                                    ; preds = %preload710.i, %postload708.i
  %exmask381.i = extractelement <16 x i1> %vectorPHI114.i, i32 1
  br i1 %exmask381.i, label %preload602.i, label %postload603.i

preload602.i:                                     ; preds = %postload711.i
  %143 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 1
  %exData382.i = extractelement <16 x double> %142, i32 1
  store double %exData382.i, double addrspace(3)* %143, align 8
  br label %postload603.i

postload603.i:                                    ; preds = %preload602.i, %postload711.i
  %exmask384.i = extractelement <16 x i1> %vectorPHI114.i, i32 2
  br i1 %exmask384.i, label %preload599.i, label %postload600.i

preload599.i:                                     ; preds = %postload603.i
  %144 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 2
  %exData385.i = extractelement <16 x double> %142, i32 2
  store double %exData385.i, double addrspace(3)* %144, align 8
  br label %postload600.i

postload600.i:                                    ; preds = %preload599.i, %postload603.i
  %exmask387.i = extractelement <16 x i1> %vectorPHI114.i, i32 3
  br i1 %exmask387.i, label %preload587.i, label %postload588.i

preload587.i:                                     ; preds = %postload600.i
  %145 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 3
  %exData388.i = extractelement <16 x double> %142, i32 3
  store double %exData388.i, double addrspace(3)* %145, align 8
  br label %postload588.i

postload588.i:                                    ; preds = %preload587.i, %postload600.i
  %exmask390.i = extractelement <16 x i1> %vectorPHI114.i, i32 4
  br i1 %exmask390.i, label %preload575.i, label %postload576.i

preload575.i:                                     ; preds = %postload588.i
  %146 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 4
  %exData391.i = extractelement <16 x double> %142, i32 4
  store double %exData391.i, double addrspace(3)* %146, align 8
  br label %postload576.i

postload576.i:                                    ; preds = %preload575.i, %postload588.i
  %exmask393.i = extractelement <16 x i1> %vectorPHI114.i, i32 5
  br i1 %exmask393.i, label %preload569.i, label %postload570.i

preload569.i:                                     ; preds = %postload576.i
  %147 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 5
  %exData394.i = extractelement <16 x double> %142, i32 5
  store double %exData394.i, double addrspace(3)* %147, align 8
  br label %postload570.i

postload570.i:                                    ; preds = %preload569.i, %postload576.i
  %exmask396.i = extractelement <16 x i1> %vectorPHI114.i, i32 6
  br i1 %exmask396.i, label %preload581.i, label %postload582.i

preload581.i:                                     ; preds = %postload570.i
  %148 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 6
  %exData397.i = extractelement <16 x double> %142, i32 6
  store double %exData397.i, double addrspace(3)* %148, align 8
  br label %postload582.i

postload582.i:                                    ; preds = %preload581.i, %postload570.i
  %exmask399.i = extractelement <16 x i1> %vectorPHI114.i, i32 7
  br i1 %exmask399.i, label %preload.i, label %postload.i

preload.i:                                        ; preds = %postload582.i
  %149 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 7
  %exData400.i = extractelement <16 x double> %142, i32 7
  store double %exData400.i, double addrspace(3)* %149, align 8
  br label %postload.i

postload.i:                                       ; preds = %preload.i, %postload582.i
  %exmask402.i = extractelement <16 x i1> %vectorPHI114.i, i32 8
  br i1 %exmask402.i, label %preload572.i, label %postload573.i

preload572.i:                                     ; preds = %postload.i
  %150 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 8
  %exData403.i = extractelement <16 x double> %142, i32 8
  store double %exData403.i, double addrspace(3)* %150, align 8
  br label %postload573.i

postload573.i:                                    ; preds = %preload572.i, %postload.i
  %exmask405.i = extractelement <16 x i1> %vectorPHI114.i, i32 9
  br i1 %exmask405.i, label %preload590.i, label %postload591.i

preload590.i:                                     ; preds = %postload573.i
  %151 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 9
  %exData406.i = extractelement <16 x double> %142, i32 9
  store double %exData406.i, double addrspace(3)* %151, align 8
  br label %postload591.i

postload591.i:                                    ; preds = %preload590.i, %postload573.i
  %exmask408.i = extractelement <16 x i1> %vectorPHI114.i, i32 10
  br i1 %exmask408.i, label %preload605.i, label %postload606.i

preload605.i:                                     ; preds = %postload591.i
  %152 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 10
  %exData409.i = extractelement <16 x double> %142, i32 10
  store double %exData409.i, double addrspace(3)* %152, align 8
  br label %postload606.i

postload606.i:                                    ; preds = %preload605.i, %postload591.i
  %exmask411.i = extractelement <16 x i1> %vectorPHI114.i, i32 11
  br i1 %exmask411.i, label %preload596.i, label %postload597.i

preload596.i:                                     ; preds = %postload606.i
  %153 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 11
  %exData412.i = extractelement <16 x double> %142, i32 11
  store double %exData412.i, double addrspace(3)* %153, align 8
  br label %postload597.i

postload597.i:                                    ; preds = %preload596.i, %postload606.i
  %exmask414.i = extractelement <16 x i1> %vectorPHI114.i, i32 12
  br i1 %exmask414.i, label %preload578.i, label %postload579.i

preload578.i:                                     ; preds = %postload597.i
  %154 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 12
  %exData415.i = extractelement <16 x double> %142, i32 12
  store double %exData415.i, double addrspace(3)* %154, align 8
  br label %postload579.i

postload579.i:                                    ; preds = %preload578.i, %postload597.i
  %exmask417.i = extractelement <16 x i1> %vectorPHI114.i, i32 13
  br i1 %exmask417.i, label %preload584.i, label %postload585.i

preload584.i:                                     ; preds = %postload579.i
  %155 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 13
  %exData418.i = extractelement <16 x double> %142, i32 13
  store double %exData418.i, double addrspace(3)* %155, align 8
  br label %postload585.i

postload585.i:                                    ; preds = %preload584.i, %postload579.i
  %exmask420.i = extractelement <16 x i1> %vectorPHI114.i, i32 14
  br i1 %exmask420.i, label %preload593.i, label %postload594.i

preload593.i:                                     ; preds = %postload585.i
  %156 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 14
  %exData421.i = extractelement <16 x double> %142, i32 14
  store double %exData421.i, double addrspace(3)* %156, align 8
  br label %postload594.i

postload594.i:                                    ; preds = %preload593.i, %postload585.i
  %exmask423.i = extractelement <16 x i1> %vectorPHI114.i, i32 15
  br i1 %exmask423.i, label %preload802.i, label %postload803.i

preload802.i:                                     ; preds = %postload594.i
  %157 = getelementptr double addrspace(3)* %loadedValue1016.i, i64 15
  %exData424.i = extractelement <16 x double> %142, i32 15
  store double %exData424.i, double addrspace(3)* %157, align 8
  br label %postload803.i

postload803.i:                                    ; preds = %preload802.i, %postload594.i
...
._crit_edge5.i:                                   ; preds = %postload803.i, %SyncBB2172.i
  %check.WI.iter.i = icmp ult i64 %CurrWI..0.i, %22
  br i1 %check.WI.iter.i, label %thenBB.i, label %elseBB.i
...
SyncBB.i:                                         ; preds = %thenBB2177.i, %thenBB2184.i, %thenBB2192.i, %elseBB.i
  %currBarrier.4.i = phi i32 [ 2, %elseBB.i ], [ %currBarrier.3.i, %thenBB2184.i ], [ %currBarrier.2.i, %thenBB2192.i ], [ %currBarrier.3.i, %thenBB2177.i ]
  %CurrSBIndex..1.i = phi i64 [ 0, %elseBB.i ], [ %"loadedCurrSB+Stride2190.i", %thenBB2184.i ], [ %"loadedCurrSB+Stride2198.i", %thenBB2192.i ], [ %"loadedCurrSB+Stride2183.i", %thenBB2177.i ]
  %CurrWI..1.i = phi i64 [ 0, %elseBB.i ], [ %"CurrWI++2188.i", %thenBB2184.i ], [ %"CurrWI++2196.i", %thenBB2192.i ], [ %"CurrWI++2181.i", %thenBB2177.i ]
  br i1 %Mneg13.i, label %._crit_edge.i, label %bb.nph.i

bb.nph.i:                                         ; preds = %postload801.i, %SyncBB.i
  %currBarrier.2.i = phi i32 [ %currBarrier.1.i, %postload801.i ], [ %currBarrier.4.i, %SyncBB.i ]
  %CurrSBIndex..4.i = phi i64 [ %CurrSBIndex..3.i, %postload801.i ], [ %CurrSBIndex..1.i, %SyncBB.i ]
  %CurrWI..4.i = phi i64 [ %CurrWI..3.i, %postload801.i ], [ %CurrWI..1.i, %SyncBB.i ]
  %vectorPHI243.i = phi <16 x i1> [ %loop_mask24326.i, %postload801.i ], [ %vector245.i, %SyncBB.i ]
  %vectorPHI246.i = phi <16 x i1> [ %local_edge29330.i, %postload801.i ], [ %vector248.i, %SyncBB.i ]
  %s.02.i = phi i32 [ %s.0.i, %postload801.i ], [ %s.01.i, %SyncBB.i ]
  ...
  %163 = getelementptr inbounds double addrspace(3)* %7, i64 %162
  ...
  %CastToValueType1365.i = bitcast i8* %"&pSB[currWI].offset1364.i" to double addrspace(3)**
  store double addrspace(3)* %163, double addrspace(3)** %CastToValueType1365.i, align 8
  %164 = extractelement <16 x i32> %160, i32 2
  %165 = zext i32 %164 to i64
  %166 = getelementptr inbounds double addrspace(3)* %7, i64 %165
  ...
  %CastToValueType1374.i = bitcast i8* %"&pSB[currWI].offset1373.i" to double addrspace(3)**
  store double addrspace(3)* %166, double addrspace(3)** %CastToValueType1374.i, align 8
  %167 = extractelement <16 x i32> %160, i32 3
  %168 = zext i32 %167 to i64
  %169 = getelementptr inbounds double addrspace(3)* %7, i64 %168
  ...
  %CastToValueType1383.i = bitcast i8* %"&pSB[currWI].offset1382.i" to double addrspace(3)**
  store double addrspace(3)* %169, double addrspace(3)** %CastToValueType1383.i, align 8
  %170 = extractelement <16 x i32> %160, i32 4
  %171 = zext i32 %170 to i64
  %172 = getelementptr inbounds double addrspace(3)* %7, i64 %171
  ...
  %CastToValueType1392.i = bitcast i8* %"&pSB[currWI].offset1391.i" to double addrspace(3)**
  store double addrspace(3)* %172, double addrspace(3)** %CastToValueType1392.i, align 8
  %173 = extractelement <16 x i32> %160, i32 5
  %174 = zext i32 %173 to i64
  %175 = getelementptr inbounds double addrspace(3)* %7, i64 %174
  ...
  %CastToValueType1401.i = bitcast i8* %"&pSB[currWI].offset1400.i" to double addrspace(3)**
  store double addrspace(3)* %175, double addrspace(3)** %CastToValueType1401.i, align 8
  %176 = extractelement <16 x i32> %160, i32 6
  %177 = zext i32 %176 to i64
  %178 = getelementptr inbounds double addrspace(3)* %7, i64 %177
  ...
  %CastToValueType1410.i = bitcast i8* %"&pSB[currWI].offset1409.i" to double addrspace(3)**
  store double addrspace(3)* %178, double addrspace(3)** %CastToValueType1410.i, align 8
  %179 = extractelement <16 x i32> %160, i32 7
  %180 = zext i32 %179 to i64
  %181 = getelementptr inbounds double addrspace(3)* %7, i64 %180
  ...
  %CastToValueType1419.i = bitcast i8* %"&pSB[currWI].offset1418.i" to double addrspace(3)**
  store double addrspace(3)* %181, double addrspace(3)** %CastToValueType1419.i, align 8
  %182 = extractelement <16 x i32> %160, i32 8
  %183 = zext i32 %182 to i64
  %184 = getelementptr inbounds double addrspace(3)* %7, i64 %183
  ...
  %CastToValueType1428.i = bitcast i8* %"&pSB[currWI].offset1427.i" to double addrspace(3)**
  store double addrspace(3)* %184, double addrspace(3)** %CastToValueType1428.i, align 8
  %185 = extractelement <16 x i32> %160, i32 9
  %186 = zext i32 %185 to i64
  %187 = getelementptr inbounds double addrspace(3)* %7, i64 %186
  ...
  %CastToValueType1437.i = bitcast i8* %"&pSB[currWI].offset1436.i" to double addrspace(3)**
  store double addrspace(3)* %187, double addrspace(3)** %CastToValueType1437.i, align 8
  %188 = extractelement <16 x i32> %160, i32 10
  %189 = zext i32 %188 to i64
  %190 = getelementptr inbounds double addrspace(3)* %7, i64 %189
  ...
  %CastToValueType1446.i = bitcast i8* %"&pSB[currWI].offset1445.i" to double addrspace(3)**
  store double addrspace(3)* %190, double addrspace(3)** %CastToValueType1446.i, align 8
  %191 = extractelement <16 x i32> %160, i32 11
  %192 = zext i32 %191 to i64
  %193 = getelementptr inbounds double addrspace(3)* %7, i64 %192
  ...
  %CastToValueType1455.i = bitcast i8* %"&pSB[currWI].offset1454.i" to double addrspace(3)**
  store double addrspace(3)* %193, double addrspace(3)** %CastToValueType1455.i, align 8
  %194 = extractelement <16 x i32> %160, i32 12
  %195 = zext i32 %194 to i64
  %196 = getelementptr inbounds double addrspace(3)* %7, i64 %195
  ...
  %CastToValueType1464.i = bitcast i8* %"&pSB[currWI].offset1463.i" to double addrspace(3)**
  store double addrspace(3)* %196, double addrspace(3)** %CastToValueType1464.i, align 8
  %197 = extractelement <16 x i32> %160, i32 13
  %198 = zext i32 %197 to i64
  %199 = getelementptr inbounds double addrspace(3)* %7, i64 %198
  ...
  %CastToValueType1473.i = bitcast i8* %"&pSB[currWI].offset1472.i" to double addrspace(3)**
  store double addrspace(3)* %199, double addrspace(3)** %CastToValueType1473.i, align 8
  %200 = extractelement <16 x i32> %160, i32 14
  %201 = zext i32 %200 to i64
  %202 = getelementptr inbounds double addrspace(3)* %7, i64 %201
  ...
  %CastToValueType1482.i = bitcast i8* %"&pSB[currWI].offset1481.i" to double addrspace(3)**
  store double addrspace(3)* %202, double addrspace(3)** %CastToValueType1482.i, align 8
  %203 = extractelement <16 x i32> %160, i32 15
  %204 = zext i32 %203 to i64
  %205 = getelementptr inbounds double addrspace(3)* %7, i64 %204
  ...
  %CastToValueType1491.i = bitcast i8* %"&pSB[currWI].offset1490.i" to double addrspace(3)**
  store double addrspace(3)* %205, double addrspace(3)** %CastToValueType1491.i, align 8
  br i1 %extract270.i, label %preload752.i, label %postload753.i

preload752.i:                                     ; preds = %bb.nph.i
  ...
  %208 = getelementptr inbounds double addrspace(3)* %7, i64 %207
  %masked_load425.i = load double addrspace(3)* %208, align 8
  ...
  %CastToValueType1500.i = bitcast i8* %"&pSB[currWI].offset1499.i" to double*
  store double %masked_load425.i, double* %CastToValueType1500.i, align 8
  br label %postload753.i

postload753.i:                                    ; preds = %preload752.i, %bb.nph.i
  %phi754.i = phi double [ undef, %bb.nph.i ], [ %masked_load425.i, %preload752.i ]
  %"&(pSB[currWI].offset)1502.i" = add nuw i64 %CurrSBIndex..4.i, 448
  %"&pSB[currWI].offset1503.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1502.i"
  %CastToValueType1504.i = bitcast i8* %"&pSB[currWI].offset1503.i" to double*
  store double %phi754.i, double* %CastToValueType1504.i, align 8
  ...
  br i1 %loadedValue1226.i, label %preload755.i, label %postload756.i
...
preload755.i:                                     ; preds = %postload753.i
  ...
  %CastToValueType1369.i = bitcast i8* %"&pSB[currWI].offset1368.i" to double addrspace(3)**
  %loadedValue1370.i = load double addrspace(3)** %CastToValueType1369.i, align 8
  %masked_load426.i = load double addrspace(3)* %loadedValue1370.i, align 8
  %"&(pSB[currWI].offset)1511.i" = add nuw i64 %CurrSBIndex..4.i, 456
  %"&pSB[currWI].offset1512.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1511.i"
  %CastToValueType1513.i = bitcast i8* %"&pSB[currWI].offset1512.i" to double*
  store double %masked_load426.i, double* %CastToValueType1513.i, align 8
  br label %postload756.i

postload756.i:                                    ; preds = %preload755.i, %postload753.i
  %phi757.i = phi double [ undef, %postload753.i ], [ %masked_load426.i, %preload755.i ]
  %"&(pSB[currWI].offset)1515.i" = add nuw i64 %CurrSBIndex..4.i, 464
  %"&pSB[currWI].offset1516.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1515.i"
  %CastToValueType1517.i = bitcast i8* %"&pSB[currWI].offset1516.i" to double*
  store double %phi757.i, double* %CastToValueType1517.i, align 8
  ...
  br i1 %loadedValue1235.i, label %preload758.i, label %postload759.i
...
preload758.i:                                     ; preds = %postload756.i
  ...
  %CastToValueType1378.i = bitcast i8* %"&pSB[currWI].offset1377.i" to double addrspace(3)**
  %loadedValue1379.i = load double addrspace(3)** %CastToValueType1378.i, align 8
  %masked_load427.i = load double addrspace(3)* %loadedValue1379.i, align 8
  %"&(pSB[currWI].offset)1524.i" = add nuw i64 %CurrSBIndex..4.i, 472
  %"&pSB[currWI].offset1525.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1524.i"
  %CastToValueType1526.i = bitcast i8* %"&pSB[currWI].offset1525.i" to double*
  store double %masked_load427.i, double* %CastToValueType1526.i, align 8
  br label %postload759.i

postload759.i:                                    ; preds = %preload758.i, %postload756.i
  %phi760.i = phi double [ undef, %postload756.i ], [ %masked_load427.i, %preload758.i ]
  %"&(pSB[currWI].offset)1528.i" = add nuw i64 %CurrSBIndex..4.i, 480
  %"&pSB[currWI].offset1529.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1528.i"
  %CastToValueType1530.i = bitcast i8* %"&pSB[currWI].offset1529.i" to double*
  store double %phi760.i, double* %CastToValueType1530.i, align 8
  ...
  br i1 %loadedValue1244.i, label %preload761.i, label %postload762.i
...
preload761.i:                                     ; preds = %postload759.i
  ...
  %CastToValueType1387.i = bitcast i8* %"&pSB[currWI].offset1386.i" to double addrspace(3)**
  %loadedValue1388.i = load double addrspace(3)** %CastToValueType1387.i, align 8
  %masked_load428.i = load double addrspace(3)* %loadedValue1388.i, align 8
  %"&(pSB[currWI].offset)1537.i" = add nuw i64 %CurrSBIndex..4.i, 488
  %"&pSB[currWI].offset1538.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1537.i"
  %CastToValueType1539.i = bitcast i8* %"&pSB[currWI].offset1538.i" to double*
  store double %masked_load428.i, double* %CastToValueType1539.i, align 8
  br label %postload762.i

postload762.i:                                    ; preds = %preload761.i, %postload759.i
  %phi763.i = phi double [ undef, %postload759.i ], [ %masked_load428.i, %preload761.i ]
  %"&(pSB[currWI].offset)1541.i" = add nuw i64 %CurrSBIndex..4.i, 496
  %"&pSB[currWI].offset1542.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1541.i"
  %CastToValueType1543.i = bitcast i8* %"&pSB[currWI].offset1542.i" to double*
  store double %phi763.i, double* %CastToValueType1543.i, align 8
  ...
  br i1 %loadedValue1253.i, label %preload764.i, label %postload765.i
...
preload764.i:                                     ; preds = %postload762.i
  ...
  %CastToValueType1396.i = bitcast i8* %"&pSB[currWI].offset1395.i" to double addrspace(3)**
  %loadedValue1397.i = load double addrspace(3)** %CastToValueType1396.i, align 8
  %masked_load429.i = load double addrspace(3)* %loadedValue1397.i, align 8
  %"&(pSB[currWI].offset)1550.i" = add nuw i64 %CurrSBIndex..4.i, 504
  %"&pSB[currWI].offset1551.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1550.i"
  %CastToValueType1552.i = bitcast i8* %"&pSB[currWI].offset1551.i" to double*
  store double %masked_load429.i, double* %CastToValueType1552.i, align 8
  br label %postload765.i

postload765.i:                                    ; preds = %preload764.i, %postload762.i
  %phi766.i = phi double [ undef, %postload762.i ], [ %masked_load429.i, %preload764.i ]
  %"&(pSB[currWI].offset)1554.i" = add nuw i64 %CurrSBIndex..4.i, 512
  %"&pSB[currWI].offset1555.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1554.i"
  %CastToValueType1556.i = bitcast i8* %"&pSB[currWI].offset1555.i" to double*
  store double %phi766.i, double* %CastToValueType1556.i, align 8
  ...
  br i1 %loadedValue1262.i, label %preload767.i, label %postload768.i
...
preload767.i:                                     ; preds = %postload765.i
  ...
  %CastToValueType1405.i = bitcast i8* %"&pSB[currWI].offset1404.i" to double addrspace(3)**
  %loadedValue1406.i = load double addrspace(3)** %CastToValueType1405.i, align 8
  %masked_load430.i = load double addrspace(3)* %loadedValue1406.i, align 8
  %"&(pSB[currWI].offset)1563.i" = add nuw i64 %CurrSBIndex..4.i, 520
  %"&pSB[currWI].offset1564.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1563.i"
  %CastToValueType1565.i = bitcast i8* %"&pSB[currWI].offset1564.i" to double*
  store double %masked_load430.i, double* %CastToValueType1565.i, align 8
  br label %postload768.i

postload768.i:                                    ; preds = %preload767.i, %postload765.i
  %phi769.i = phi double [ undef, %postload765.i ], [ %masked_load430.i, %preload767.i ]
  %"&(pSB[currWI].offset)1567.i" = add nuw i64 %CurrSBIndex..4.i, 528
  %"&pSB[currWI].offset1568.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1567.i"
  %CastToValueType1569.i = bitcast i8* %"&pSB[currWI].offset1568.i" to double*
  store double %phi769.i, double* %CastToValueType1569.i, align 8
  ...
  br i1 %loadedValue1271.i, label %preload770.i, label %postload771.i
...
preload770.i:                                     ; preds = %postload768.i
  ...
  %CastToValueType1414.i = bitcast i8* %"&pSB[currWI].offset1413.i" to double addrspace(3)**
  %loadedValue1415.i = load double addrspace(3)** %CastToValueType1414.i, align 8
  %masked_load431.i = load double addrspace(3)* %loadedValue1415.i, align 8
  %"&(pSB[currWI].offset)1576.i" = add nuw i64 %CurrSBIndex..4.i, 536
  %"&pSB[currWI].offset1577.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1576.i"
  %CastToValueType1578.i = bitcast i8* %"&pSB[currWI].offset1577.i" to double*
  store double %masked_load431.i, double* %CastToValueType1578.i, align 8
  br label %postload771.i

postload771.i:                                    ; preds = %preload770.i, %postload768.i
  %phi772.i = phi double [ undef, %postload768.i ], [ %masked_load431.i, %preload770.i ]
  %"&(pSB[currWI].offset)1580.i" = add nuw i64 %CurrSBIndex..4.i, 544
  %"&pSB[currWI].offset1581.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1580.i"
  %CastToValueType1582.i = bitcast i8* %"&pSB[currWI].offset1581.i" to double*
  store double %phi772.i, double* %CastToValueType1582.i, align 8
  ...
  br i1 %loadedValue1280.i, label %preload773.i, label %postload774.i
...
preload773.i:                                     ; preds = %postload771.i
  ...
  %CastToValueType1423.i = bitcast i8* %"&pSB[currWI].offset1422.i" to double addrspace(3)**
  %loadedValue1424.i = load double addrspace(3)** %CastToValueType1423.i, align 8
  %masked_load432.i = load double addrspace(3)* %loadedValue1424.i, align 8
  %"&(pSB[currWI].offset)1589.i" = add nuw i64 %CurrSBIndex..4.i, 552
  %"&pSB[currWI].offset1590.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1589.i"
  %CastToValueType1591.i = bitcast i8* %"&pSB[currWI].offset1590.i" to double*
  store double %masked_load432.i, double* %CastToValueType1591.i, align 8
  br label %postload774.i

postload774.i:                                    ; preds = %preload773.i, %postload771.i
  %phi775.i = phi double [ undef, %postload771.i ], [ %masked_load432.i, %preload773.i ]
  %"&(pSB[currWI].offset)1593.i" = add nuw i64 %CurrSBIndex..4.i, 560
  %"&pSB[currWI].offset1594.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1593.i"
  %CastToValueType1595.i = bitcast i8* %"&pSB[currWI].offset1594.i" to double*
  store double %phi775.i, double* %CastToValueType1595.i, align 8
  ...
  br i1 %loadedValue1289.i, label %preload776.i, label %postload777.i
...
preload776.i:                                     ; preds = %postload774.i
  ...
  %CastToValueType1432.i = bitcast i8* %"&pSB[currWI].offset1431.i" to double addrspace(3)**
  %loadedValue1433.i = load double addrspace(3)** %CastToValueType1432.i, align 8
  %masked_load433.i = load double addrspace(3)* %loadedValue1433.i, align 8
  %"&(pSB[currWI].offset)1602.i" = add nuw i64 %CurrSBIndex..4.i, 568
  %"&pSB[currWI].offset1603.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1602.i"
  %CastToValueType1604.i = bitcast i8* %"&pSB[currWI].offset1603.i" to double*
  store double %masked_load433.i, double* %CastToValueType1604.i, align 8
  br label %postload777.i

postload777.i:                                    ; preds = %preload776.i, %postload774.i
  %phi778.i = phi double [ undef, %postload774.i ], [ %masked_load433.i, %preload776.i ]
  %"&(pSB[currWI].offset)1606.i" = add nuw i64 %CurrSBIndex..4.i, 576
  %"&pSB[currWI].offset1607.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1606.i"
  %CastToValueType1608.i = bitcast i8* %"&pSB[currWI].offset1607.i" to double*
  store double %phi778.i, double* %CastToValueType1608.i, align 8
  ...
  br i1 %loadedValue1298.i, label %preload779.i, label %postload780.i
...
preload779.i:                                     ; preds = %postload777.i
  ...
  %CastToValueType1441.i = bitcast i8* %"&pSB[currWI].offset1440.i" to double addrspace(3)**
  %loadedValue1442.i = load double addrspace(3)** %CastToValueType1441.i, align 8
  %masked_load434.i = load double addrspace(3)* %loadedValue1442.i, align 8
  %"&(pSB[currWI].offset)1615.i" = add nuw i64 %CurrSBIndex..4.i, 584
  %"&pSB[currWI].offset1616.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1615.i"
  %CastToValueType1617.i = bitcast i8* %"&pSB[currWI].offset1616.i" to double*
  store double %masked_load434.i, double* %CastToValueType1617.i, align 8
  br label %postload780.i

postload780.i:                                    ; preds = %preload779.i, %postload777.i
  %phi781.i = phi double [ undef, %postload777.i ], [ %masked_load434.i, %preload779.i ]
  %"&(pSB[currWI].offset)1619.i" = add nuw i64 %CurrSBIndex..4.i, 592
  %"&pSB[currWI].offset1620.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1619.i"
  %CastToValueType1621.i = bitcast i8* %"&pSB[currWI].offset1620.i" to double*
  store double %phi781.i, double* %CastToValueType1621.i, align 8
  ...
  br i1 %loadedValue1307.i, label %preload782.i, label %postload783.i
...
preload782.i:                                     ; preds = %postload780.i
  ...
  %CastToValueType1450.i = bitcast i8* %"&pSB[currWI].offset1449.i" to double addrspace(3)**
  %loadedValue1451.i = load double addrspace(3)** %CastToValueType1450.i, align 8
  %masked_load435.i = load double addrspace(3)* %loadedValue1451.i, align 8
  %"&(pSB[currWI].offset)1628.i" = add nuw i64 %CurrSBIndex..4.i, 600
  %"&pSB[currWI].offset1629.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1628.i"
  %CastToValueType1630.i = bitcast i8* %"&pSB[currWI].offset1629.i" to double*
  store double %masked_load435.i, double* %CastToValueType1630.i, align 8
  br label %postload783.i

postload783.i:                                    ; preds = %preload782.i, %postload780.i
  %phi784.i = phi double [ undef, %postload780.i ], [ %masked_load435.i, %preload782.i ]
  %"&(pSB[currWI].offset)1632.i" = add nuw i64 %CurrSBIndex..4.i, 608
  %"&pSB[currWI].offset1633.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1632.i"
  %CastToValueType1634.i = bitcast i8* %"&pSB[currWI].offset1633.i" to double*
  store double %phi784.i, double* %CastToValueType1634.i, align 8
  ...
  br i1 %loadedValue1316.i, label %preload785.i, label %postload786.i
...
preload785.i:                                     ; preds = %postload783.i
  ...
  %CastToValueType1459.i = bitcast i8* %"&pSB[currWI].offset1458.i" to double addrspace(3)**
  %loadedValue1460.i = load double addrspace(3)** %CastToValueType1459.i, align 8
  %masked_load436.i = load double addrspace(3)* %loadedValue1460.i, align 8
  %"&(pSB[currWI].offset)1641.i" = add nuw i64 %CurrSBIndex..4.i, 616
  %"&pSB[currWI].offset1642.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1641.i"
  %CastToValueType1643.i = bitcast i8* %"&pSB[currWI].offset1642.i" to double*
  store double %masked_load436.i, double* %CastToValueType1643.i, align 8
  br label %postload786.i

postload786.i:                                    ; preds = %preload785.i, %postload783.i
  %phi787.i = phi double [ undef, %postload783.i ], [ %masked_load436.i, %preload785.i ]
  %"&(pSB[currWI].offset)1645.i" = add nuw i64 %CurrSBIndex..4.i, 624
  %"&pSB[currWI].offset1646.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1645.i"
  %CastToValueType1647.i = bitcast i8* %"&pSB[currWI].offset1646.i" to double*
  store double %phi787.i, double* %CastToValueType1647.i, align 8
  ...
  br i1 %loadedValue1325.i, label %preload788.i, label %postload789.i
...
preload788.i:                                     ; preds = %postload786.i
  ...
  %CastToValueType1468.i = bitcast i8* %"&pSB[currWI].offset1467.i" to double addrspace(3)**
  %loadedValue1469.i = load double addrspace(3)** %CastToValueType1468.i, align 8
  %masked_load437.i = load double addrspace(3)* %loadedValue1469.i, align 8
  %"&(pSB[currWI].offset)1654.i" = add nuw i64 %CurrSBIndex..4.i, 632
  %"&pSB[currWI].offset1655.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1654.i"
  %CastToValueType1656.i = bitcast i8* %"&pSB[currWI].offset1655.i" to double*
  store double %masked_load437.i, double* %CastToValueType1656.i, align 8
  br label %postload789.i

postload789.i:                                    ; preds = %preload788.i, %postload786.i
  %phi790.i = phi double [ undef, %postload786.i ], [ %masked_load437.i, %preload788.i ]
  %"&(pSB[currWI].offset)1658.i" = add nuw i64 %CurrSBIndex..4.i, 640
  %"&pSB[currWI].offset1659.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1658.i"
  %CastToValueType1660.i = bitcast i8* %"&pSB[currWI].offset1659.i" to double*
  store double %phi790.i, double* %CastToValueType1660.i, align 8
  ...
  br i1 %loadedValue1334.i, label %preload791.i, label %postload792.i
...
preload791.i:                                     ; preds = %postload789.i
  ...
  %CastToValueType1477.i = bitcast i8* %"&pSB[currWI].offset1476.i" to double addrspace(3)**
  %loadedValue1478.i = load double addrspace(3)** %CastToValueType1477.i, align 8
  %masked_load438.i = load double addrspace(3)* %loadedValue1478.i, align 8
  %"&(pSB[currWI].offset)1667.i" = add nuw i64 %CurrSBIndex..4.i, 648
  %"&pSB[currWI].offset1668.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1667.i"
  %CastToValueType1669.i = bitcast i8* %"&pSB[currWI].offset1668.i" to double*
  store double %masked_load438.i, double* %CastToValueType1669.i, align 8
  br label %postload792.i

postload792.i:                                    ; preds = %preload791.i, %postload789.i
  %phi793.i = phi double [ undef, %postload789.i ], [ %masked_load438.i, %preload791.i ]
  %"&(pSB[currWI].offset)1671.i" = add nuw i64 %CurrSBIndex..4.i, 656
  %"&pSB[currWI].offset1672.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1671.i"
  %CastToValueType1673.i = bitcast i8* %"&pSB[currWI].offset1672.i" to double*
  store double %phi793.i, double* %CastToValueType1673.i, align 8
  ...
  br i1 %loadedValue1343.i, label %preload794.i, label %postload795.i
...
preload794.i:                                     ; preds = %postload792.i
  ...
  %CastToValueType1486.i = bitcast i8* %"&pSB[currWI].offset1485.i" to double addrspace(3)**
  %loadedValue1487.i = load double addrspace(3)** %CastToValueType1486.i, align 8
  %masked_load439.i = load double addrspace(3)* %loadedValue1487.i, align 8
  %"&(pSB[currWI].offset)1680.i" = add nuw i64 %CurrSBIndex..4.i, 664
  %"&pSB[currWI].offset1681.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1680.i"
  %CastToValueType1682.i = bitcast i8* %"&pSB[currWI].offset1681.i" to double*
  store double %masked_load439.i, double* %CastToValueType1682.i, align 8
  br label %postload795.i

postload795.i:                                    ; preds = %preload794.i, %postload792.i
  %phi796.i = phi double [ undef, %postload792.i ], [ %masked_load439.i, %preload794.i ]
  %"&(pSB[currWI].offset)1684.i" = add nuw i64 %CurrSBIndex..4.i, 672
  %"&pSB[currWI].offset1685.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1684.i"
  %CastToValueType1686.i = bitcast i8* %"&pSB[currWI].offset1685.i" to double*
  store double %phi796.i, double* %CastToValueType1686.i, align 8
  ...
  br i1 %loadedValue1352.i, label %preload797.i, label %postload798.i
...
preload797.i:                                     ; preds = %postload795.i
  ...
  %CastToValueType1495.i = bitcast i8* %"&pSB[currWI].offset1494.i" to double addrspace(3)**
  %loadedValue1496.i = load double addrspace(3)** %CastToValueType1495.i, align 8
  %masked_load440.i = load double addrspace(3)* %loadedValue1496.i, align 8
  %"&(pSB[currWI].offset)1693.i" = add nuw i64 %CurrSBIndex..4.i, 680
  %"&pSB[currWI].offset1694.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1693.i"
  %CastToValueType1695.i = bitcast i8* %"&pSB[currWI].offset1694.i" to double*
  store double %masked_load440.i, double* %CastToValueType1695.i, align 8
  br label %postload798.i

postload798.i:                                    ; preds = %preload797.i, %postload795.i
  %phi799.i = phi double [ undef, %postload795.i ], [ %masked_load440.i, %preload797.i ]
  %"&(pSB[currWI].offset)1506.i" = add nuw i64 %CurrSBIndex..4.i, 448
  %"&pSB[currWI].offset1507.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1506.i"
  %CastToValueType1508.i = bitcast i8* %"&pSB[currWI].offset1507.i" to double*
  %loadedValue1509.i = load double* %CastToValueType1508.i, align 8
  %temp.vect287.i = insertelement <16 x double> undef, double %loadedValue1509.i, i32 0
  %"&(pSB[currWI].offset)1519.i" = add nuw i64 %CurrSBIndex..4.i, 464
  %"&pSB[currWI].offset1520.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1519.i"
  %CastToValueType1521.i = bitcast i8* %"&pSB[currWI].offset1520.i" to double*
  %loadedValue1522.i = load double* %CastToValueType1521.i, align 8
  %temp.vect288.i = insertelement <16 x double> %temp.vect287.i, double %loadedValue1522.i, i32 1
  %"&(pSB[currWI].offset)1532.i" = add nuw i64 %CurrSBIndex..4.i, 480
  %"&pSB[currWI].offset1533.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1532.i"
  %CastToValueType1534.i = bitcast i8* %"&pSB[currWI].offset1533.i" to double*
  %loadedValue1535.i = load double* %CastToValueType1534.i, align 8
  %temp.vect289.i = insertelement <16 x double> %temp.vect288.i, double %loadedValue1535.i, i32 2
  %"&(pSB[currWI].offset)1545.i" = add nuw i64 %CurrSBIndex..4.i, 496
  %"&pSB[currWI].offset1546.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1545.i"
  %CastToValueType1547.i = bitcast i8* %"&pSB[currWI].offset1546.i" to double*
  %loadedValue1548.i = load double* %CastToValueType1547.i, align 8
  %temp.vect290.i = insertelement <16 x double> %temp.vect289.i, double %loadedValue1548.i, i32 3
  %"&(pSB[currWI].offset)1558.i" = add nuw i64 %CurrSBIndex..4.i, 512
  %"&pSB[currWI].offset1559.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1558.i"
  %CastToValueType1560.i = bitcast i8* %"&pSB[currWI].offset1559.i" to double*
  %loadedValue1561.i = load double* %CastToValueType1560.i, align 8
  %temp.vect291.i = insertelement <16 x double> %temp.vect290.i, double %loadedValue1561.i, i32 4
  %"&(pSB[currWI].offset)1571.i" = add nuw i64 %CurrSBIndex..4.i, 528
  %"&pSB[currWI].offset1572.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1571.i"
  %CastToValueType1573.i = bitcast i8* %"&pSB[currWI].offset1572.i" to double*
  %loadedValue1574.i = load double* %CastToValueType1573.i, align 8
  %temp.vect292.i = insertelement <16 x double> %temp.vect291.i, double %loadedValue1574.i, i32 5
  %"&(pSB[currWI].offset)1584.i" = add nuw i64 %CurrSBIndex..4.i, 544
  %"&pSB[currWI].offset1585.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1584.i"
  %CastToValueType1586.i = bitcast i8* %"&pSB[currWI].offset1585.i" to double*
  %loadedValue1587.i = load double* %CastToValueType1586.i, align 8
  %temp.vect293.i = insertelement <16 x double> %temp.vect292.i, double %loadedValue1587.i, i32 6
  %"&(pSB[currWI].offset)1597.i" = add nuw i64 %CurrSBIndex..4.i, 560
  %"&pSB[currWI].offset1598.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1597.i"
  %CastToValueType1599.i = bitcast i8* %"&pSB[currWI].offset1598.i" to double*
  %loadedValue1600.i = load double* %CastToValueType1599.i, align 8
  %temp.vect294.i = insertelement <16 x double> %temp.vect293.i, double %loadedValue1600.i, i32 7
  %"&(pSB[currWI].offset)1610.i" = add nuw i64 %CurrSBIndex..4.i, 576
  %"&pSB[currWI].offset1611.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1610.i"
  %CastToValueType1612.i = bitcast i8* %"&pSB[currWI].offset1611.i" to double*
  %loadedValue1613.i = load double* %CastToValueType1612.i, align 8
  %temp.vect295.i = insertelement <16 x double> %temp.vect294.i, double %loadedValue1613.i, i32 8
  %"&(pSB[currWI].offset)1623.i" = add nuw i64 %CurrSBIndex..4.i, 592
  %"&pSB[currWI].offset1624.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1623.i"
  %CastToValueType1625.i = bitcast i8* %"&pSB[currWI].offset1624.i" to double*
  %loadedValue1626.i = load double* %CastToValueType1625.i, align 8
  %temp.vect296.i = insertelement <16 x double> %temp.vect295.i, double %loadedValue1626.i, i32 9
  %"&(pSB[currWI].offset)1636.i" = add nuw i64 %CurrSBIndex..4.i, 608
  %"&pSB[currWI].offset1637.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1636.i"
  %CastToValueType1638.i = bitcast i8* %"&pSB[currWI].offset1637.i" to double*
  %loadedValue1639.i = load double* %CastToValueType1638.i, align 8
  %temp.vect297.i = insertelement <16 x double> %temp.vect296.i, double %loadedValue1639.i, i32 10
  %"&(pSB[currWI].offset)1649.i" = add nuw i64 %CurrSBIndex..4.i, 624
  %"&pSB[currWI].offset1650.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1649.i"
  %CastToValueType1651.i = bitcast i8* %"&pSB[currWI].offset1650.i" to double*
  %loadedValue1652.i = load double* %CastToValueType1651.i, align 8
  %temp.vect298.i = insertelement <16 x double> %temp.vect297.i, double %loadedValue1652.i, i32 11
  %"&(pSB[currWI].offset)1662.i" = add nuw i64 %CurrSBIndex..4.i, 640
  %"&pSB[currWI].offset1663.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1662.i"
  %CastToValueType1664.i = bitcast i8* %"&pSB[currWI].offset1663.i" to double*
  %loadedValue1665.i = load double* %CastToValueType1664.i, align 8
  %temp.vect299.i = insertelement <16 x double> %temp.vect298.i, double %loadedValue1665.i, i32 12
  %"&(pSB[currWI].offset)1675.i" = add nuw i64 %CurrSBIndex..4.i, 656
  %"&pSB[currWI].offset1676.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1675.i"
  %CastToValueType1677.i = bitcast i8* %"&pSB[currWI].offset1676.i" to double*
  %loadedValue1678.i = load double* %CastToValueType1677.i, align 8
  %temp.vect300.i = insertelement <16 x double> %temp.vect299.i, double %loadedValue1678.i, i32 13
  %"&(pSB[currWI].offset)1688.i" = add nuw i64 %CurrSBIndex..4.i, 672
  %"&pSB[currWI].offset1689.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1688.i"
  %CastToValueType1690.i = bitcast i8* %"&pSB[currWI].offset1689.i" to double*
  %loadedValue1691.i = load double* %CastToValueType1690.i, align 8
  %temp.vect301.i = insertelement <16 x double> %temp.vect300.i, double %loadedValue1691.i, i32 14
  %temp.vect302.i = insertelement <16 x double> %temp.vect301.i, double %phi799.i, i32 15
  %"&(pSB[currWI].offset)1697.i" = add nuw i64 %CurrSBIndex..4.i, 768
  ...
  store <16 x double> %temp.vect302.i, <16 x double>* %CastToValueType1699.i, align 128
  ...
  %CastToValueType1010.i = bitcast i8* %"&pSB[currWI].offset1009.i" to double addrspace(3)**
  %loadedValue1011.i = load double addrspace(3)** %CastToValueType1010.i, align 8
  %ptrTypeCast286.i = bitcast double addrspace(3)* %loadedValue1011.i to <16 x double> addrspace(3)*
  %"&(pSB[currWI].offset)1706.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1707.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1706.i"
  %CastToValueType1708.i = bitcast i8* %"&pSB[currWI].offset1707.i" to <16 x double> addrspace(3)**
  store <16 x double> addrspace(3)* %ptrTypeCast286.i, <16 x double> addrspace(3)** %CastToValueType1708.i, align 8
  ...
  br i1 %exmask442.i, label %preload805.i, label %postload806.i

preload805.i:                                     ; preds = %postload798.i
  %"&(pSB[currWI].offset)1785.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1786.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1785.i"
  %CastToValueType1787.i = bitcast i8* %"&pSB[currWI].offset1786.i" to <16 x double> addrspace(3)**
  %loadedValue1788.i = load <16 x double> addrspace(3)** %CastToValueType1787.i, align 8
  %ptrTypeCast441.i = getelementptr inbounds <16 x double> addrspace(3)* %loadedValue1788.i, i64 0, i64 0
  %vload443.i = load double addrspace(3)* %ptrTypeCast441.i, align 8
  %"&(pSB[currWI].offset)1790.i" = add nuw i64 %CurrSBIndex..4.i, 904
  %"&pSB[currWI].offset1791.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1790.i"
  %CastToValueType1792.i = bitcast i8* %"&pSB[currWI].offset1791.i" to double*
  store double %vload443.i, double* %CastToValueType1792.i, align 8
  br label %postload806.i

postload806.i:                                    ; preds = %preload805.i, %postload798.i
  %phi807.i = phi double [ undef, %postload798.i ], [ %vload443.i, %preload805.i ]
  %vpack.i = insertelement <16 x double> undef, double %phi807.i, i32 0
  %"&(pSB[currWI].offset)1794.i" = add nuw i64 %CurrSBIndex..4.i, 1024
  %"&pSB[currWI].offset1795.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1794.i"
  %CastToValueType1796.i = bitcast i8* %"&pSB[currWI].offset1795.i" to <16 x double>*
  store <16 x double> %vpack.i, <16 x double>* %CastToValueType1796.i, align 128
  ...
  br i1 %exmask445.i, label %preload608.i, label %postload609.i

preload608.i:                                     ; preds = %postload806.i
  %"&(pSB[currWI].offset)1780.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1781.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1780.i"
  %CastToValueType1782.i = bitcast i8* %"&pSB[currWI].offset1781.i" to <16 x double> addrspace(3)**
  %loadedValue1783.i = load <16 x double> addrspace(3)** %CastToValueType1782.i, align 8
  %vload444.i = getelementptr <16 x double> addrspace(3)* %loadedValue1783.i, i64 0, i64 1
  %vload446.i = load double addrspace(3)* %vload444.i, align 8
  %"&(pSB[currWI].offset)1803.i" = add nuw i64 %CurrSBIndex..4.i, 1152
  %"&pSB[currWI].offset1804.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1803.i"
  %CastToValueType1805.i = bitcast i8* %"&pSB[currWI].offset1804.i" to double*
  store double %vload446.i, double* %CastToValueType1805.i, align 8
  br label %postload609.i

postload609.i:                                    ; preds = %preload608.i, %postload806.i
  %phi610.i = phi double [ undef, %postload806.i ], [ %vload446.i, %preload608.i ]
  %"&(pSB[currWI].offset)1798.i" = add nuw i64 %CurrSBIndex..4.i, 1024
  %"&pSB[currWI].offset1799.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1798.i"
  %CastToValueType1800.i = bitcast i8* %"&pSB[currWI].offset1799.i" to <16 x double>*
  %loadedValue1801.i = load <16 x double>* %CastToValueType1800.i, align 128
  %vpack447.i = insertelement <16 x double> %loadedValue1801.i, double %phi610.i, i32 1
  %"&(pSB[currWI].offset)1807.i" = add nuw i64 %CurrSBIndex..4.i, 1280
  %"&pSB[currWI].offset1808.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1807.i"
  %CastToValueType1809.i = bitcast i8* %"&pSB[currWI].offset1808.i" to <16 x double>*
  store <16 x double> %vpack447.i, <16 x double>* %CastToValueType1809.i, align 128
  ...
  br i1 %exmask449.i, label %preload611.i, label %postload612.i

preload611.i:                                     ; preds = %postload609.i
  %"&(pSB[currWI].offset)1775.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1776.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1775.i"
  %CastToValueType1777.i = bitcast i8* %"&pSB[currWI].offset1776.i" to <16 x double> addrspace(3)**
  %loadedValue1778.i = load <16 x double> addrspace(3)** %CastToValueType1777.i, align 8
  %vload448.i = getelementptr <16 x double> addrspace(3)* %loadedValue1778.i, i64 0, i64 2
  %vload450.i = load double addrspace(3)* %vload448.i, align 8
  %"&(pSB[currWI].offset)1816.i" = add nuw i64 %CurrSBIndex..4.i, 1408
  %"&pSB[currWI].offset1817.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1816.i"
  %CastToValueType1818.i = bitcast i8* %"&pSB[currWI].offset1817.i" to double*
  store double %vload450.i, double* %CastToValueType1818.i, align 8
  br label %postload612.i

postload612.i:                                    ; preds = %preload611.i, %postload609.i
  %phi613.i = phi double [ undef, %postload609.i ], [ %vload450.i, %preload611.i ]
  %"&(pSB[currWI].offset)1811.i" = add nuw i64 %CurrSBIndex..4.i, 1280
  ...
  %vpack451.i = insertelement <16 x double> %loadedValue1814.i, double %phi613.i, i32 2
  %"&(pSB[currWI].offset)1820.i" = add nuw i64 %CurrSBIndex..4.i, 1536
  %"&pSB[currWI].offset1821.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1820.i"
  %CastToValueType1822.i = bitcast i8* %"&pSB[currWI].offset1821.i" to <16 x double>*
  store <16 x double> %vpack451.i, <16 x double>* %CastToValueType1822.i, align 128
  ...
  br i1 %exmask453.i, label %preload743.i, label %postload744.i

preload743.i:                                     ; preds = %postload612.i
  %"&(pSB[currWI].offset)1770.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1771.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1770.i"
  %CastToValueType1772.i = bitcast i8* %"&pSB[currWI].offset1771.i" to <16 x double> addrspace(3)**
  %loadedValue1773.i = load <16 x double> addrspace(3)** %CastToValueType1772.i, align 8
  %vload452.i = getelementptr <16 x double> addrspace(3)* %loadedValue1773.i, i64 0, i64 3
  %vload454.i = load double addrspace(3)* %vload452.i, align 8
  %"&(pSB[currWI].offset)1829.i" = add nuw i64 %CurrSBIndex..4.i, 1664
  %"&pSB[currWI].offset1830.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1829.i"
  %CastToValueType1831.i = bitcast i8* %"&pSB[currWI].offset1830.i" to double*
  store double %vload454.i, double* %CastToValueType1831.i, align 8
  br label %postload744.i

postload744.i:                                    ; preds = %preload743.i, %postload612.i
  %phi745.i = phi double [ undef, %postload612.i ], [ %vload454.i, %preload743.i ]
  %"&(pSB[currWI].offset)1824.i" = add nuw i64 %CurrSBIndex..4.i, 1536
  %"&pSB[currWI].offset1825.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1824.i"
  %CastToValueType1826.i = bitcast i8* %"&pSB[currWI].offset1825.i" to <16 x double>*
  %loadedValue1827.i = load <16 x double>* %CastToValueType1826.i, align 128
  %vpack455.i = insertelement <16 x double> %loadedValue1827.i, double %phi745.i, i32 3
  %"&(pSB[currWI].offset)1833.i" = add nuw i64 %CurrSBIndex..4.i, 1792
  %"&pSB[currWI].offset1834.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1833.i"
  %CastToValueType1835.i = bitcast i8* %"&pSB[currWI].offset1834.i" to <16 x double>*
  store <16 x double> %vpack455.i, <16 x double>* %CastToValueType1835.i, align 128
  ...
  br i1 %exmask457.i, label %preload746.i, label %postload747.i

preload746.i:                                     ; preds = %postload744.i
  %"&(pSB[currWI].offset)1765.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1766.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1765.i"
  %CastToValueType1767.i = bitcast i8* %"&pSB[currWI].offset1766.i" to <16 x double> addrspace(3)**
  %loadedValue1768.i = load <16 x double> addrspace(3)** %CastToValueType1767.i, align 8
  %vload456.i = getelementptr <16 x double> addrspace(3)* %loadedValue1768.i, i64 0, i64 4
  %vload458.i = load double addrspace(3)* %vload456.i, align 8
  %"&(pSB[currWI].offset)1842.i" = add nuw i64 %CurrSBIndex..4.i, 1920
  %"&pSB[currWI].offset1843.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1842.i"
  %CastToValueType1844.i = bitcast i8* %"&pSB[currWI].offset1843.i" to double*
  store double %vload458.i, double* %CastToValueType1844.i, align 8
  br label %postload747.i

postload747.i:                                    ; preds = %preload746.i, %postload744.i
  %phi748.i = phi double [ undef, %postload744.i ], [ %vload458.i, %preload746.i ]
  %"&(pSB[currWI].offset)1837.i" = add nuw i64 %CurrSBIndex..4.i, 1792
  %"&pSB[currWI].offset1838.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1837.i"
  %CastToValueType1839.i = bitcast i8* %"&pSB[currWI].offset1838.i" to <16 x double>*
  %loadedValue1840.i = load <16 x double>* %CastToValueType1839.i, align 128
  %vpack459.i = insertelement <16 x double> %loadedValue1840.i, double %phi748.i, i32 4
  %"&(pSB[currWI].offset)1846.i" = add nuw i64 %CurrSBIndex..4.i, 2048
  ...
  store <16 x double> %vpack459.i, <16 x double>* %CastToValueType1848.i, align 128
  ...
  br i1 %exmask461.i, label %preload749.i, label %postload750.i

preload749.i:                                     ; preds = %postload747.i
  %"&(pSB[currWI].offset)1760.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1761.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1760.i"
  %CastToValueType1762.i = bitcast i8* %"&pSB[currWI].offset1761.i" to <16 x double> addrspace(3)**
  %loadedValue1763.i = load <16 x double> addrspace(3)** %CastToValueType1762.i, align 8
  %vload460.i = getelementptr <16 x double> addrspace(3)* %loadedValue1763.i, i64 0, i64 5
  %vload462.i = load double addrspace(3)* %vload460.i, align 8
  %"&(pSB[currWI].offset)1855.i" = add nuw i64 %CurrSBIndex..4.i, 2176
  %"&pSB[currWI].offset1856.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1855.i"
  %CastToValueType1857.i = bitcast i8* %"&pSB[currWI].offset1856.i" to double*
  store double %vload462.i, double* %CastToValueType1857.i, align 8
  br label %postload750.i

postload750.i:                                    ; preds = %preload749.i, %postload747.i
  %phi751.i = phi double [ undef, %postload747.i ], [ %vload462.i, %preload749.i ]
  %"&(pSB[currWI].offset)1850.i" = add nuw i64 %CurrSBIndex..4.i, 2048
  ...
  %vpack463.i = insertelement <16 x double> %loadedValue1853.i, double %phi751.i, i32 5
  %"&(pSB[currWI].offset)1859.i" = add nuw i64 %CurrSBIndex..4.i, 2304
  ...
  store <16 x double> %vpack463.i, <16 x double>* %CastToValueType1861.i, align 128
  ...
  br i1 %exmask465.i, label %preload713.i, label %postload714.i

preload713.i:                                     ; preds = %postload750.i
  %"&(pSB[currWI].offset)1755.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1756.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1755.i"
  %CastToValueType1757.i = bitcast i8* %"&pSB[currWI].offset1756.i" to <16 x double> addrspace(3)**
  %loadedValue1758.i = load <16 x double> addrspace(3)** %CastToValueType1757.i, align 8
  %vload464.i = getelementptr <16 x double> addrspace(3)* %loadedValue1758.i, i64 0, i64 6
  %vload466.i = load double addrspace(3)* %vload464.i, align 8
  %"&(pSB[currWI].offset)1868.i" = add nuw i64 %CurrSBIndex..4.i, 2432
  %"&pSB[currWI].offset1869.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1868.i"
  %CastToValueType1870.i = bitcast i8* %"&pSB[currWI].offset1869.i" to double*
  store double %vload466.i, double* %CastToValueType1870.i, align 8
  br label %postload714.i

postload714.i:                                    ; preds = %preload713.i, %postload750.i
  %phi715.i = phi double [ undef, %postload750.i ], [ %vload466.i, %preload713.i ]
  %"&(pSB[currWI].offset)1863.i" = add nuw i64 %CurrSBIndex..4.i, 2304
  %"&pSB[currWI].offset1864.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1863.i"
  %CastToValueType1865.i = bitcast i8* %"&pSB[currWI].offset1864.i" to <16 x double>*
  %loadedValue1866.i = load <16 x double>* %CastToValueType1865.i, align 128
  %vpack467.i = insertelement <16 x double> %loadedValue1866.i, double %phi715.i, i32 6
  %"&(pSB[currWI].offset)1872.i" = add nuw i64 %CurrSBIndex..4.i, 2560
  %"&pSB[currWI].offset1873.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1872.i"
  %CastToValueType1874.i = bitcast i8* %"&pSB[currWI].offset1873.i" to <16 x double>*
  store <16 x double> %vpack467.i, <16 x double>* %CastToValueType1874.i, align 128
  ...
  br i1 %exmask469.i, label %preload716.i, label %postload717.i

preload716.i:                                     ; preds = %postload714.i
  %"&(pSB[currWI].offset)1750.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1751.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1750.i"
  %CastToValueType1752.i = bitcast i8* %"&pSB[currWI].offset1751.i" to <16 x double> addrspace(3)**
  %loadedValue1753.i = load <16 x double> addrspace(3)** %CastToValueType1752.i, align 8
  %vload468.i = getelementptr <16 x double> addrspace(3)* %loadedValue1753.i, i64 0, i64 7
  %vload470.i = load double addrspace(3)* %vload468.i, align 8
  %"&(pSB[currWI].offset)1881.i" = add nuw i64 %CurrSBIndex..4.i, 2688
  %"&pSB[currWI].offset1882.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1881.i"
  %CastToValueType1883.i = bitcast i8* %"&pSB[currWI].offset1882.i" to double*
  store double %vload470.i, double* %CastToValueType1883.i, align 8
  br label %postload717.i

postload717.i:                                    ; preds = %preload716.i, %postload714.i
  %phi718.i = phi double [ undef, %postload714.i ], [ %vload470.i, %preload716.i ]
  %"&(pSB[currWI].offset)1876.i" = add nuw i64 %CurrSBIndex..4.i, 2560
  %"&pSB[currWI].offset1877.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1876.i"
  %CastToValueType1878.i = bitcast i8* %"&pSB[currWI].offset1877.i" to <16 x double>*
  %loadedValue1879.i = load <16 x double>* %CastToValueType1878.i, align 128
  %vpack471.i = insertelement <16 x double> %loadedValue1879.i, double %phi718.i, i32 7
  %"&(pSB[currWI].offset)1885.i" = add nuw i64 %CurrSBIndex..4.i, 2816
  ...
  store <16 x double> %vpack471.i, <16 x double>* %CastToValueType1887.i, align 128
  ...
  br i1 %exmask473.i, label %preload719.i, label %postload720.i

preload719.i:                                     ; preds = %postload717.i
  %"&(pSB[currWI].offset)1745.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1746.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1745.i"
  %CastToValueType1747.i = bitcast i8* %"&pSB[currWI].offset1746.i" to <16 x double> addrspace(3)**
  %loadedValue1748.i = load <16 x double> addrspace(3)** %CastToValueType1747.i, align 8
  %vload472.i = getelementptr <16 x double> addrspace(3)* %loadedValue1748.i, i64 0, i64 8
  %vload474.i = load double addrspace(3)* %vload472.i, align 8
  %"&(pSB[currWI].offset)1894.i" = add nuw i64 %CurrSBIndex..4.i, 2944
  %"&pSB[currWI].offset1895.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1894.i"
  %CastToValueType1896.i = bitcast i8* %"&pSB[currWI].offset1895.i" to double*
  store double %vload474.i, double* %CastToValueType1896.i, align 8
  br label %postload720.i

postload720.i:                                    ; preds = %preload719.i, %postload717.i
  %phi721.i = phi double [ undef, %postload717.i ], [ %vload474.i, %preload719.i ]
  %"&(pSB[currWI].offset)1889.i" = add nuw i64 %CurrSBIndex..4.i, 2816
  %"&pSB[currWI].offset1890.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1889.i"
  %CastToValueType1891.i = bitcast i8* %"&pSB[currWI].offset1890.i" to <16 x double>*
  %loadedValue1892.i = load <16 x double>* %CastToValueType1891.i, align 128
  %vpack475.i = insertelement <16 x double> %loadedValue1892.i, double %phi721.i, i32 8
  %"&(pSB[currWI].offset)1898.i" = add nuw i64 %CurrSBIndex..4.i, 3072
  %"&pSB[currWI].offset1899.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1898.i"
  %CastToValueType1900.i = bitcast i8* %"&pSB[currWI].offset1899.i" to <16 x double>*
  store <16 x double> %vpack475.i, <16 x double>* %CastToValueType1900.i, align 128
  ...
  br i1 %exmask477.i, label %preload722.i, label %postload723.i

preload722.i:                                     ; preds = %postload720.i
  %"&(pSB[currWI].offset)1740.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1741.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1740.i"
  %CastToValueType1742.i = bitcast i8* %"&pSB[currWI].offset1741.i" to <16 x double> addrspace(3)**
  %loadedValue1743.i = load <16 x double> addrspace(3)** %CastToValueType1742.i, align 8
  %vload476.i = getelementptr <16 x double> addrspace(3)* %loadedValue1743.i, i64 0, i64 9
  %vload478.i = load double addrspace(3)* %vload476.i, align 8
  %"&(pSB[currWI].offset)1907.i" = add nuw i64 %CurrSBIndex..4.i, 3200
  %"&pSB[currWI].offset1908.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1907.i"
  %CastToValueType1909.i = bitcast i8* %"&pSB[currWI].offset1908.i" to double*
  store double %vload478.i, double* %CastToValueType1909.i, align 8
  br label %postload723.i

postload723.i:                                    ; preds = %preload722.i, %postload720.i
  %phi724.i = phi double [ undef, %postload720.i ], [ %vload478.i, %preload722.i ]
  %"&(pSB[currWI].offset)1902.i" = add nuw i64 %CurrSBIndex..4.i, 3072
  %"&pSB[currWI].offset1903.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1902.i"
  %CastToValueType1904.i = bitcast i8* %"&pSB[currWI].offset1903.i" to <16 x double>*
  %loadedValue1905.i = load <16 x double>* %CastToValueType1904.i, align 128
  %vpack479.i = insertelement <16 x double> %loadedValue1905.i, double %phi724.i, i32 9
  %"&(pSB[currWI].offset)1911.i" = add nuw i64 %CurrSBIndex..4.i, 3328
  %"&pSB[currWI].offset1912.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1911.i"
  %CastToValueType1913.i = bitcast i8* %"&pSB[currWI].offset1912.i" to <16 x double>*
  store <16 x double> %vpack479.i, <16 x double>* %CastToValueType1913.i, align 128
  ...
  br i1 %exmask481.i, label %preload725.i, label %postload726.i

preload725.i:                                     ; preds = %postload723.i
  %"&(pSB[currWI].offset)1735.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1736.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1735.i"
  %CastToValueType1737.i = bitcast i8* %"&pSB[currWI].offset1736.i" to <16 x double> addrspace(3)**
  %loadedValue1738.i = load <16 x double> addrspace(3)** %CastToValueType1737.i, align 8
  %vload480.i = getelementptr <16 x double> addrspace(3)* %loadedValue1738.i, i64 0, i64 10
  %vload482.i = load double addrspace(3)* %vload480.i, align 8
  %"&(pSB[currWI].offset)1920.i" = add nuw i64 %CurrSBIndex..4.i, 3456
  %"&pSB[currWI].offset1921.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1920.i"
  %CastToValueType1922.i = bitcast i8* %"&pSB[currWI].offset1921.i" to double*
  store double %vload482.i, double* %CastToValueType1922.i, align 8
  br label %postload726.i

postload726.i:                                    ; preds = %preload725.i, %postload723.i
  %phi727.i = phi double [ undef, %postload723.i ], [ %vload482.i, %preload725.i ]
  %"&(pSB[currWI].offset)1915.i" = add nuw i64 %CurrSBIndex..4.i, 3328
  %"&pSB[currWI].offset1916.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1915.i"
  %CastToValueType1917.i = bitcast i8* %"&pSB[currWI].offset1916.i" to <16 x double>*
  %loadedValue1918.i = load <16 x double>* %CastToValueType1917.i, align 128
  %vpack483.i = insertelement <16 x double> %loadedValue1918.i, double %phi727.i, i32 10
  %"&(pSB[currWI].offset)1924.i" = add nuw i64 %CurrSBIndex..4.i, 3584
  ...
  store <16 x double> %vpack483.i, <16 x double>* %CastToValueType1926.i, align 128
  ...
  br i1 %exmask485.i, label %preload728.i, label %postload729.i

preload728.i:                                     ; preds = %postload726.i
  %"&(pSB[currWI].offset)1730.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1731.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1730.i"
  %CastToValueType1732.i = bitcast i8* %"&pSB[currWI].offset1731.i" to <16 x double> addrspace(3)**
  %loadedValue1733.i = load <16 x double> addrspace(3)** %CastToValueType1732.i, align 8
  %vload484.i = getelementptr <16 x double> addrspace(3)* %loadedValue1733.i, i64 0, i64 11
  %vload486.i = load double addrspace(3)* %vload484.i, align 8
  %"&(pSB[currWI].offset)1933.i" = add nuw i64 %CurrSBIndex..4.i, 3712
  %"&pSB[currWI].offset1934.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1933.i"
  %CastToValueType1935.i = bitcast i8* %"&pSB[currWI].offset1934.i" to double*
  store double %vload486.i, double* %CastToValueType1935.i, align 8
  br label %postload729.i

postload729.i:                                    ; preds = %preload728.i, %postload726.i
  %phi730.i = phi double [ undef, %postload726.i ], [ %vload486.i, %preload728.i ]
  %"&(pSB[currWI].offset)1928.i" = add nuw i64 %CurrSBIndex..4.i, 3584
  %"&pSB[currWI].offset1929.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1928.i"
  %CastToValueType1930.i = bitcast i8* %"&pSB[currWI].offset1929.i" to <16 x double>*
  %loadedValue1931.i = load <16 x double>* %CastToValueType1930.i, align 128
  %vpack487.i = insertelement <16 x double> %loadedValue1931.i, double %phi730.i, i32 11
  %"&(pSB[currWI].offset)1937.i" = add nuw i64 %CurrSBIndex..4.i, 3840
  ...
  store <16 x double> %vpack487.i, <16 x double>* %CastToValueType1939.i, align 128
  ...
  br i1 %exmask489.i, label %preload731.i, label %postload732.i

preload731.i:                                     ; preds = %postload729.i
  %"&(pSB[currWI].offset)1725.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1726.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1725.i"
  %CastToValueType1727.i = bitcast i8* %"&pSB[currWI].offset1726.i" to <16 x double> addrspace(3)**
  %loadedValue1728.i = load <16 x double> addrspace(3)** %CastToValueType1727.i, align 8
  %vload488.i = getelementptr <16 x double> addrspace(3)* %loadedValue1728.i, i64 0, i64 12
  %vload490.i = load double addrspace(3)* %vload488.i, align 8
  %"&(pSB[currWI].offset)1946.i" = add nuw i64 %CurrSBIndex..4.i, 3968
  ...
  store double %vload490.i, double* %CastToValueType1948.i, align 8
  br label %postload732.i

postload732.i:                                    ; preds = %preload731.i, %postload729.i
  %phi733.i = phi double [ undef, %postload729.i ], [ %vload490.i, %preload731.i ]
  %"&(pSB[currWI].offset)1941.i" = add nuw i64 %CurrSBIndex..4.i, 3840
  %"&pSB[currWI].offset1942.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1941.i"
  %CastToValueType1943.i = bitcast i8* %"&pSB[currWI].offset1942.i" to <16 x double>*
  %loadedValue1944.i = load <16 x double>* %CastToValueType1943.i, align 128
  %vpack491.i = insertelement <16 x double> %loadedValue1944.i, double %phi733.i, i32 12
  %"&(pSB[currWI].offset)1950.i" = add nuw i64 %CurrSBIndex..4.i, 4096
  %"&pSB[currWI].offset1951.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1950.i"
  %CastToValueType1952.i = bitcast i8* %"&pSB[currWI].offset1951.i" to <16 x double>*
  store <16 x double> %vpack491.i, <16 x double>* %CastToValueType1952.i, align 128
  ...
  br i1 %exmask493.i, label %preload734.i, label %postload735.i

preload734.i:                                     ; preds = %postload732.i
  %"&(pSB[currWI].offset)1720.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1721.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1720.i"
  %CastToValueType1722.i = bitcast i8* %"&pSB[currWI].offset1721.i" to <16 x double> addrspace(3)**
  %loadedValue1723.i = load <16 x double> addrspace(3)** %CastToValueType1722.i, align 8
  %vload492.i = getelementptr <16 x double> addrspace(3)* %loadedValue1723.i, i64 0, i64 13
  %vload494.i = load double addrspace(3)* %vload492.i, align 8
  %"&(pSB[currWI].offset)1959.i" = add nuw i64 %CurrSBIndex..4.i, 4224
  %"&pSB[currWI].offset1960.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1959.i"
  %CastToValueType1961.i = bitcast i8* %"&pSB[currWI].offset1960.i" to double*
  store double %vload494.i, double* %CastToValueType1961.i, align 8
  br label %postload735.i

postload735.i:                                    ; preds = %preload734.i, %postload732.i
  %phi736.i = phi double [ undef, %postload732.i ], [ %vload494.i, %preload734.i ]
  %"&(pSB[currWI].offset)1954.i" = add nuw i64 %CurrSBIndex..4.i, 4096
  ...
  %vpack495.i = insertelement <16 x double> %loadedValue1957.i, double %phi736.i, i32 13
  %"&(pSB[currWI].offset)1963.i" = add nuw i64 %CurrSBIndex..4.i, 4352
  %"&pSB[currWI].offset1964.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1963.i"
  %CastToValueType1965.i = bitcast i8* %"&pSB[currWI].offset1964.i" to <16 x double>*
  store <16 x double> %vpack495.i, <16 x double>* %CastToValueType1965.i, align 128
  ...
  br i1 %exmask497.i, label %preload737.i, label %postload738.i

preload737.i:                                     ; preds = %postload735.i
  %"&(pSB[currWI].offset)1715.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1716.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1715.i"
  %CastToValueType1717.i = bitcast i8* %"&pSB[currWI].offset1716.i" to <16 x double> addrspace(3)**
  %loadedValue1718.i = load <16 x double> addrspace(3)** %CastToValueType1717.i, align 8
  %vload496.i = getelementptr <16 x double> addrspace(3)* %loadedValue1718.i, i64 0, i64 14
  %vload498.i = load double addrspace(3)* %vload496.i, align 8
  %"&(pSB[currWI].offset)1972.i" = add nuw i64 %CurrSBIndex..4.i, 4480
  %"&pSB[currWI].offset1973.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1972.i"
  %CastToValueType1974.i = bitcast i8* %"&pSB[currWI].offset1973.i" to double*
  store double %vload498.i, double* %CastToValueType1974.i, align 8
  br label %postload738.i

postload738.i:                                    ; preds = %preload737.i, %postload735.i
  %phi739.i = phi double [ undef, %postload735.i ], [ %vload498.i, %preload737.i ]
  %"&(pSB[currWI].offset)1967.i" = add nuw i64 %CurrSBIndex..4.i, 4352
  %"&pSB[currWI].offset1968.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1967.i"
  %CastToValueType1969.i = bitcast i8* %"&pSB[currWI].offset1968.i" to <16 x double>*
  %loadedValue1970.i = load <16 x double>* %CastToValueType1969.i, align 128
  %vpack499.i = insertelement <16 x double> %loadedValue1970.i, double %phi739.i, i32 14
  %"&(pSB[currWI].offset)1976.i" = add nuw i64 %CurrSBIndex..4.i, 4608
  %"&pSB[currWI].offset1977.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1976.i"
  %CastToValueType1978.i = bitcast i8* %"&pSB[currWI].offset1977.i" to <16 x double>*
  store <16 x double> %vpack499.i, <16 x double>* %CastToValueType1978.i, align 128
  ...
  br i1 %exmask501.i, label %preload740.i, label %postload741.i

preload740.i:                                     ; preds = %postload738.i
  %"&(pSB[currWI].offset)1710.i" = add nuw i64 %CurrSBIndex..4.i, 896
  %"&pSB[currWI].offset1711.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1710.i"
  %CastToValueType1712.i = bitcast i8* %"&pSB[currWI].offset1711.i" to <16 x double> addrspace(3)**
  %loadedValue1713.i = load <16 x double> addrspace(3)** %CastToValueType1712.i, align 8
  %vload500.i = getelementptr <16 x double> addrspace(3)* %loadedValue1713.i, i64 0, i64 15
  %vload502.i = load double addrspace(3)* %vload500.i, align 8
  %"&(pSB[currWI].offset)1985.i" = add nuw i64 %CurrSBIndex..4.i, 4736
  %"&pSB[currWI].offset1986.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1985.i"
  %CastToValueType1987.i = bitcast i8* %"&pSB[currWI].offset1986.i" to double*
  store double %vload502.i, double* %CastToValueType1987.i, align 8
  br label %postload741.i

postload741.i:                                    ; preds = %preload740.i, %postload738.i
  %phi742.i = phi double [ undef, %postload738.i ], [ %vload502.i, %preload740.i ]
  %"&(pSB[currWI].offset)1980.i" = add nuw i64 %CurrSBIndex..4.i, 4608
  %"&pSB[currWI].offset1981.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1980.i"
  %CastToValueType1982.i = bitcast i8* %"&pSB[currWI].offset1981.i" to <16 x double>*
  %loadedValue1983.i = load <16 x double>* %CastToValueType1982.i, align 128
  %vpack503.i = insertelement <16 x double> %loadedValue1983.i, double %phi742.i, i32 15
  %"&(pSB[currWI].offset)1701.i" = add nuw i64 %CurrSBIndex..4.i, 768
  %"&pSB[currWI].offset1702.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1701.i"
  %CastToValueType1703.i = bitcast i8* %"&pSB[currWI].offset1702.i" to <16 x double>*
  %loadedValue1704.i = load <16 x double>* %CastToValueType1703.i, align 128
  %209 = fadd <16 x double> %vpack503.i, %loadedValue1704.i
  %"&(pSB[currWI].offset)1989.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset1990.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1989.i"
  %CastToValueType1991.i = bitcast i8* %"&pSB[currWI].offset1990.i" to <16 x double>*
  store <16 x double> %209, <16 x double>* %CastToValueType1991.i, align 128
  ...
  %CastToValueType1005.i = bitcast i8* %"&pSB[currWI].offset1004.i" to double addrspace(3)**
  %loadedValue1006.i = load double addrspace(3)** %CastToValueType1005.i, align 8
  %ptrTypeCast303.i = bitcast double addrspace(3)* %loadedValue1006.i to <16 x double> addrspace(3)*
  %"&(pSB[currWI].offset)2073.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2074.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2073.i"
  %CastToValueType2075.i = bitcast i8* %"&pSB[currWI].offset2074.i" to <16 x double> addrspace(3)**
  store <16 x double> addrspace(3)* %ptrTypeCast303.i, <16 x double> addrspace(3)** %CastToValueType2075.i, align 8
...
preload936.i:                                     ; preds = %postload741.i
  %"&(pSB[currWI].offset)2152.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2153.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2152.i"
  %CastToValueType2154.i = bitcast i8* %"&pSB[currWI].offset2153.i" to <16 x double> addrspace(3)**
  %loadedValue2155.i = load <16 x double> addrspace(3)** %CastToValueType2154.i, align 8
  %ptrTypeCast504.i = getelementptr inbounds <16 x double> addrspace(3)* %loadedValue2155.i, i64 0, i64 0
  %"&(pSB[currWI].offset)2068.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2069.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2068.i"
  %CastToValueType2070.i = bitcast i8* %"&pSB[currWI].offset2069.i" to <16 x double>*
  %loadedValue2071.i = load <16 x double>* %CastToValueType2070.i, align 128
  %exData507.i = extractelement <16 x double> %loadedValue2071.i, i32 0
  store double %exData507.i, double addrspace(3)* %ptrTypeCast504.i, align 8
  br label %postload937.i

postload937.i:                                    ; preds = %preload936.i, %postload741.i
...
preload939.i:                                     ; preds = %postload937.i
  %"&(pSB[currWI].offset)2147.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2148.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2147.i"
  %CastToValueType2149.i = bitcast i8* %"&pSB[currWI].offset2148.i" to <16 x double> addrspace(3)**
  %loadedValue2150.i = load <16 x double> addrspace(3)** %CastToValueType2149.i, align 8
  %vstore508.i = getelementptr <16 x double> addrspace(3)* %loadedValue2150.i, i64 0, i64 1
  %"&(pSB[currWI].offset)2063.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2064.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2063.i"
  %CastToValueType2065.i = bitcast i8* %"&pSB[currWI].offset2064.i" to <16 x double>*
  %loadedValue2066.i = load <16 x double>* %CastToValueType2065.i, align 128
  %exData510.i = extractelement <16 x double> %loadedValue2066.i, i32 1
  store double %exData510.i, double addrspace(3)* %vstore508.i, align 8
...
preload942.i:                                     ; preds = %postload940.i
  %"&(pSB[currWI].offset)2142.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2143.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2142.i"
  %CastToValueType2144.i = bitcast i8* %"&pSB[currWI].offset2143.i" to <16 x double> addrspace(3)**
  %loadedValue2145.i = load <16 x double> addrspace(3)** %CastToValueType2144.i, align 8
  %vstore511.i = getelementptr <16 x double> addrspace(3)* %loadedValue2145.i, i64 0, i64 2
  %"&(pSB[currWI].offset)2058.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2059.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2058.i"
  %CastToValueType2060.i = bitcast i8* %"&pSB[currWI].offset2059.i" to <16 x double>*
  %loadedValue2061.i = load <16 x double>* %CastToValueType2060.i, align 128
  %exData513.i = extractelement <16 x double> %loadedValue2061.i, i32 2
  store double %exData513.i, double addrspace(3)* %vstore511.i, align 8
...
preload945.i:                                     ; preds = %postload943.i
  %"&(pSB[currWI].offset)2137.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2138.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2137.i"
  %CastToValueType2139.i = bitcast i8* %"&pSB[currWI].offset2138.i" to <16 x double> addrspace(3)**
  %loadedValue2140.i = load <16 x double> addrspace(3)** %CastToValueType2139.i, align 8
  %vstore514.i = getelementptr <16 x double> addrspace(3)* %loadedValue2140.i, i64 0, i64 3
  %"&(pSB[currWI].offset)2053.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2054.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2053.i"
  %CastToValueType2055.i = bitcast i8* %"&pSB[currWI].offset2054.i" to <16 x double>*
  %loadedValue2056.i = load <16 x double>* %CastToValueType2055.i, align 128
  %exData516.i = extractelement <16 x double> %loadedValue2056.i, i32 3
  store double %exData516.i, double addrspace(3)* %vstore514.i, align 8
...
preload948.i:                                     ; preds = %postload946.i
  %"&(pSB[currWI].offset)2132.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2133.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2132.i"
  %CastToValueType2134.i = bitcast i8* %"&pSB[currWI].offset2133.i" to <16 x double> addrspace(3)**
  %loadedValue2135.i = load <16 x double> addrspace(3)** %CastToValueType2134.i, align 8
  %vstore517.i = getelementptr <16 x double> addrspace(3)* %loadedValue2135.i, i64 0, i64 4
  %"&(pSB[currWI].offset)2048.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2049.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2048.i"
  %CastToValueType2050.i = bitcast i8* %"&pSB[currWI].offset2049.i" to <16 x double>*
  %loadedValue2051.i = load <16 x double>* %CastToValueType2050.i, align 128
  %exData519.i = extractelement <16 x double> %loadedValue2051.i, i32 4
  store double %exData519.i, double addrspace(3)* %vstore517.i, align 8
...
preload951.i:                                     ; preds = %postload949.i
  %"&(pSB[currWI].offset)2127.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2128.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2127.i"
  %CastToValueType2129.i = bitcast i8* %"&pSB[currWI].offset2128.i" to <16 x double> addrspace(3)**
  %loadedValue2130.i = load <16 x double> addrspace(3)** %CastToValueType2129.i, align 8
  %vstore520.i = getelementptr <16 x double> addrspace(3)* %loadedValue2130.i, i64 0, i64 5
  %"&(pSB[currWI].offset)2043.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2044.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2043.i"
  %CastToValueType2045.i = bitcast i8* %"&pSB[currWI].offset2044.i" to <16 x double>*
  %loadedValue2046.i = load <16 x double>* %CastToValueType2045.i, align 128
  %exData522.i = extractelement <16 x double> %loadedValue2046.i, i32 5
  store double %exData522.i, double addrspace(3)* %vstore520.i, align 8
...
preload954.i:                                     ; preds = %postload952.i
  %"&(pSB[currWI].offset)2122.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2123.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2122.i"
  %CastToValueType2124.i = bitcast i8* %"&pSB[currWI].offset2123.i" to <16 x double> addrspace(3)**
  %loadedValue2125.i = load <16 x double> addrspace(3)** %CastToValueType2124.i, align 8
  %vstore523.i = getelementptr <16 x double> addrspace(3)* %loadedValue2125.i, i64 0, i64 6
  %"&(pSB[currWI].offset)2038.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2039.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2038.i"
  %CastToValueType2040.i = bitcast i8* %"&pSB[currWI].offset2039.i" to <16 x double>*
  %loadedValue2041.i = load <16 x double>* %CastToValueType2040.i, align 128
  %exData525.i = extractelement <16 x double> %loadedValue2041.i, i32 6
  store double %exData525.i, double addrspace(3)* %vstore523.i, align 8
...
preload957.i:                                     ; preds = %postload955.i
  %"&(pSB[currWI].offset)2117.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2118.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2117.i"
  %CastToValueType2119.i = bitcast i8* %"&pSB[currWI].offset2118.i" to <16 x double> addrspace(3)**
  %loadedValue2120.i = load <16 x double> addrspace(3)** %CastToValueType2119.i, align 8
  %vstore526.i = getelementptr <16 x double> addrspace(3)* %loadedValue2120.i, i64 0, i64 7
  %"&(pSB[currWI].offset)2033.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2034.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2033.i"
  %CastToValueType2035.i = bitcast i8* %"&pSB[currWI].offset2034.i" to <16 x double>*
  %loadedValue2036.i = load <16 x double>* %CastToValueType2035.i, align 128
  %exData528.i = extractelement <16 x double> %loadedValue2036.i, i32 7
  store double %exData528.i, double addrspace(3)* %vstore526.i, align 8
...
preload960.i:                                     ; preds = %postload958.i
  %"&(pSB[currWI].offset)2112.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2113.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2112.i"
  %CastToValueType2114.i = bitcast i8* %"&pSB[currWI].offset2113.i" to <16 x double> addrspace(3)**
  %loadedValue2115.i = load <16 x double> addrspace(3)** %CastToValueType2114.i, align 8
  %vstore529.i = getelementptr <16 x double> addrspace(3)* %loadedValue2115.i, i64 0, i64 8
  %"&(pSB[currWI].offset)2028.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2029.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2028.i"
  %CastToValueType2030.i = bitcast i8* %"&pSB[currWI].offset2029.i" to <16 x double>*
  %loadedValue2031.i = load <16 x double>* %CastToValueType2030.i, align 128
  %exData531.i = extractelement <16 x double> %loadedValue2031.i, i32 8
  store double %exData531.i, double addrspace(3)* %vstore529.i, align 8
...
preload963.i:                                     ; preds = %postload961.i
  %"&(pSB[currWI].offset)2107.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2108.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2107.i"
  %CastToValueType2109.i = bitcast i8* %"&pSB[currWI].offset2108.i" to <16 x double> addrspace(3)**
  %loadedValue2110.i = load <16 x double> addrspace(3)** %CastToValueType2109.i, align 8
  %vstore532.i = getelementptr <16 x double> addrspace(3)* %loadedValue2110.i, i64 0, i64 9
  %"&(pSB[currWI].offset)2023.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2024.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2023.i"
  %CastToValueType2025.i = bitcast i8* %"&pSB[currWI].offset2024.i" to <16 x double>*
  %loadedValue2026.i = load <16 x double>* %CastToValueType2025.i, align 128
  %exData534.i = extractelement <16 x double> %loadedValue2026.i, i32 9
  store double %exData534.i, double addrspace(3)* %vstore532.i, align 8
...
preload966.i:                                     ; preds = %postload964.i
  %"&(pSB[currWI].offset)2102.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2103.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2102.i"
  %CastToValueType2104.i = bitcast i8* %"&pSB[currWI].offset2103.i" to <16 x double> addrspace(3)**
  %loadedValue2105.i = load <16 x double> addrspace(3)** %CastToValueType2104.i, align 8
  %vstore535.i = getelementptr <16 x double> addrspace(3)* %loadedValue2105.i, i64 0, i64 10
  %"&(pSB[currWI].offset)2018.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2019.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2018.i"
  %CastToValueType2020.i = bitcast i8* %"&pSB[currWI].offset2019.i" to <16 x double>*
  %loadedValue2021.i = load <16 x double>* %CastToValueType2020.i, align 128
  %exData537.i = extractelement <16 x double> %loadedValue2021.i, i32 10
  store double %exData537.i, double addrspace(3)* %vstore535.i, align 8
...
preload969.i:                                     ; preds = %postload967.i
  %"&(pSB[currWI].offset)2097.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2098.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2097.i"
  %CastToValueType2099.i = bitcast i8* %"&pSB[currWI].offset2098.i" to <16 x double> addrspace(3)**
  %loadedValue2100.i = load <16 x double> addrspace(3)** %CastToValueType2099.i, align 8
  %vstore538.i = getelementptr <16 x double> addrspace(3)* %loadedValue2100.i, i64 0, i64 11
  %"&(pSB[currWI].offset)2013.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2014.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2013.i"
  %CastToValueType2015.i = bitcast i8* %"&pSB[currWI].offset2014.i" to <16 x double>*
  %loadedValue2016.i = load <16 x double>* %CastToValueType2015.i, align 128
  %exData540.i = extractelement <16 x double> %loadedValue2016.i, i32 11
  store double %exData540.i, double addrspace(3)* %vstore538.i, align 8
...
preload972.i:                                     ; preds = %postload970.i
  %"&(pSB[currWI].offset)2092.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2093.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2092.i"
  %CastToValueType2094.i = bitcast i8* %"&pSB[currWI].offset2093.i" to <16 x double> addrspace(3)**
  %loadedValue2095.i = load <16 x double> addrspace(3)** %CastToValueType2094.i, align 8
  %vstore541.i = getelementptr <16 x double> addrspace(3)* %loadedValue2095.i, i64 0, i64 12
  %"&(pSB[currWI].offset)2008.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2009.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2008.i"
  %CastToValueType2010.i = bitcast i8* %"&pSB[currWI].offset2009.i" to <16 x double>*
  %loadedValue2011.i = load <16 x double>* %CastToValueType2010.i, align 128
  %exData543.i = extractelement <16 x double> %loadedValue2011.i, i32 12
  store double %exData543.i, double addrspace(3)* %vstore541.i, align 8
...
preload975.i:                                     ; preds = %postload973.i
  %"&(pSB[currWI].offset)2087.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2088.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2087.i"
  %CastToValueType2089.i = bitcast i8* %"&pSB[currWI].offset2088.i" to <16 x double> addrspace(3)**
  %loadedValue2090.i = load <16 x double> addrspace(3)** %CastToValueType2089.i, align 8
  %vstore544.i = getelementptr <16 x double> addrspace(3)* %loadedValue2090.i, i64 0, i64 13
  %"&(pSB[currWI].offset)2003.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset2004.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2003.i"
  %CastToValueType2005.i = bitcast i8* %"&pSB[currWI].offset2004.i" to <16 x double>*
  %loadedValue2006.i = load <16 x double>* %CastToValueType2005.i, align 128
  %exData546.i = extractelement <16 x double> %loadedValue2006.i, i32 13
  store double %exData546.i, double addrspace(3)* %vstore544.i, align 8
...
preload978.i:                                     ; preds = %postload976.i
  %"&(pSB[currWI].offset)2082.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2083.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2082.i"
  %CastToValueType2084.i = bitcast i8* %"&pSB[currWI].offset2083.i" to <16 x double> addrspace(3)**
  %loadedValue2085.i = load <16 x double> addrspace(3)** %CastToValueType2084.i, align 8
  %vstore547.i = getelementptr <16 x double> addrspace(3)* %loadedValue2085.i, i64 0, i64 14
  %"&(pSB[currWI].offset)1998.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset1999.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1998.i"
  %CastToValueType2000.i = bitcast i8* %"&pSB[currWI].offset1999.i" to <16 x double>*
  %loadedValue2001.i = load <16 x double>* %CastToValueType2000.i, align 128
  %exData549.i = extractelement <16 x double> %loadedValue2001.i, i32 14
  store double %exData549.i, double addrspace(3)* %vstore547.i, align 8
...
preload981.i:                                     ; preds = %postload979.i
  %"&(pSB[currWI].offset)2077.i" = add nuw i64 %CurrSBIndex..4.i, 4992
  %"&pSB[currWI].offset2078.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)2077.i"
  %CastToValueType2079.i = bitcast i8* %"&pSB[currWI].offset2078.i" to <16 x double> addrspace(3)**
  %loadedValue2080.i = load <16 x double> addrspace(3)** %CastToValueType2079.i, align 8
  %vstore550.i = getelementptr <16 x double> addrspace(3)* %loadedValue2080.i, i64 0, i64 15
  %"&(pSB[currWI].offset)1993.i" = add nuw i64 %CurrSBIndex..4.i, 4864
  %"&pSB[currWI].offset1994.i" = getelementptr inbounds i8* %25, i64 %"&(pSB[currWI].offset)1993.i"
  %CastToValueType1995.i = bitcast i8* %"&pSB[currWI].offset1994.i" to <16 x double>*
  %loadedValue1996.i = load <16 x double>* %CastToValueType1995.i, align 128
  %exData552.i = extractelement <16 x double> %loadedValue1996.i, i32 15
  store double %exData552.i, double addrspace(3)* %vstore550.i, align 8
...
postload982.i:                                    ; preds = %preload981.i, %postload979.i
  ...
  br i1 %extract306.i, label %preload800.i, label %postload801.i

preload800.i:                                     ; preds = %postload982.i
  %check.WI.iter2195.i = icmp ult i64 %CurrWI..4.i, %22
  br i1 %check.WI.iter2195.i, label %thenBB2192.i, label %postload801.i

thenBB2192.i:                                     ; preds = %preload800.i
  %"CurrWI++2196.i" = add nuw i64 %CurrWI..4.i, 1
  %"loadedCurrSB+Stride2198.i" = add nuw i64 %CurrSBIndex..4.i, 5120
  %cond13.i = icmp eq i32 %currBarrier.2.i, 8
  br i1 %cond13.i, label %postload801.i, label %SyncBB.i

postload801.i:                                    ; preds = %thenBB2177.i, %thenBB2184.i, %thenBB2192.i, %preload800.i, %postload982.i
  %currBarrier.1.i = phi i32 [ %currBarrier.2.i, %postload982.i ], [ %currBarrier.3.i, %thenBB2184.i ], [ %currBarrier.2.i, %thenBB2192.i ], [ %currBarrier.3.i, %thenBB2177.i ], [ 8, %preload800.i ]
  %CurrSBIndex..3.i = phi i64 [ %CurrSBIndex..4.i, %postload982.i ], [ %"loadedCurrSB+Stride2190.i", %thenBB2184.i ], [ %"loadedCurrSB+Stride2198.i", %thenBB2192.i ], [ %"loadedCurrSB+Stride2183.i", %thenBB2177.i ], [ 0, %preload800.i ]
  %CurrWI..3.i = phi i64 [ %CurrWI..4.i, %postload982.i ], [ %"CurrWI++2188.i", %thenBB2184.i ], [ %"CurrWI++2196.i", %thenBB2192.i ], [ %"CurrWI++2181.i", %thenBB2177.i ], [ 0, %preload800.i ]
  ...
  %"&(pSB[currWI].offset)2157.i" = add nuw i64 %CurrSBIndex..3.i, 5000
  ...
  %"&(pSB[currWI].offset)2161.i" = add nuw i64 %CurrSBIndex..3.i, 5008
  ...
  %"&(pSB[currWI].offset)2165.i" = add nuw i64 %CurrSBIndex..3.i, 5024
...
._crit_edge.i:                                    ; preds = %postload801.i, %SyncBB.i
  %currBarrier.3.i = phi i32 [ %currBarrier.4.i, %SyncBB.i ], [ %currBarrier.1.i, %postload801.i ]
  %CurrSBIndex..5.i = phi i64 [ %CurrSBIndex..1.i, %SyncBB.i ], [ %CurrSBIndex..3.i, %postload801.i ]
  %CurrWI..5.i = phi i64 [ %CurrWI..1.i, %SyncBB.i ], [ %CurrWI..3.i, %postload801.i ]
...
postload932.i:                                    ; preds = %preload931.i, %postload924.i
  ...
  %228 = getelementptr inbounds double addrspace(1)* %4, i64 %phi821.i
  %229 = getelementptr inbounds double addrspace(1)* %4, i64 %phi829.i
  %230 = getelementptr inbounds double addrspace(1)* %4, i64 %phi837.i
  %231 = getelementptr inbounds double addrspace(1)* %4, i64 %phi845.i
  %232 = getelementptr inbounds double addrspace(1)* %4, i64 %phi853.i
  %233 = getelementptr inbounds double addrspace(1)* %4, i64 %phi861.i
  %234 = getelementptr inbounds double addrspace(1)* %4, i64 %phi869.i
  %235 = getelementptr inbounds double addrspace(1)* %4, i64 %phi877.i
  %236 = getelementptr inbounds double addrspace(1)* %4, i64 %phi885.i
  %237 = getelementptr inbounds double addrspace(1)* %4, i64 %phi893.i
  %238 = getelementptr inbounds double addrspace(1)* %4, i64 %phi901.i
  %239 = getelementptr inbounds double addrspace(1)* %4, i64 %phi909.i
  %240 = getelementptr inbounds double addrspace(1)* %4, i64 %phi917.i
  %241 = getelementptr inbounds double addrspace(1)* %4, i64 %phi925.i
  %242 = getelementptr inbounds double addrspace(1)* %4, i64 %phi933.i
  br i1 %extract332.i, label %preload814.i, label %postload815.i

preload814.i:                                     ; preds = %postload932.i
  %243 = getelementptr inbounds double addrspace(1)* %4, i64 %phi813.i
  store double %phi810.i, double addrspace(1)* %243, align 8
...
preload822.i:                                     ; preds = %postload815.i
  store double %phi818.i, double addrspace(1)* %228, align 8
...
preload830.i:                                     ; preds = %postload823.i
  store double %phi826.i, double addrspace(1)* %229, align 8
...
preload838.i:                                     ; preds = %postload831.i
  store double %phi834.i, double addrspace(1)* %230, align 8
...
preload846.i:                                     ; preds = %postload839.i
  store double %phi842.i, double addrspace(1)* %231, align 8
...
preload854.i:                                     ; preds = %postload847.i
  store double %phi850.i, double addrspace(1)* %232, align 8
...
preload862.i:                                     ; preds = %postload855.i
  store double %phi858.i, double addrspace(1)* %233, align 8
...
preload870.i:                                     ; preds = %postload863.i
  store double %phi866.i, double addrspace(1)* %234, align 8
...
preload878.i:                                     ; preds = %postload871.i
  store double %phi874.i, double addrspace(1)* %235, align 8
...
preload886.i:                                     ; preds = %postload879.i
  store double %phi882.i, double addrspace(1)* %236, align 8
...
preload894.i:                                     ; preds = %postload887.i
  store double %phi890.i, double addrspace(1)* %237, align 8
...
preload902.i:                                     ; preds = %postload895.i
  store double %phi898.i, double addrspace(1)* %238, align 8
...
preload910.i:                                     ; preds = %postload903.i
  store double %phi906.i, double addrspace(1)* %239, align 8
...
preload918.i:                                     ; preds = %postload911.i
  store double %phi914.i, double addrspace(1)* %240, align 8
...
preload926.i:                                     ; preds = %postload919.i
  store double %phi922.i, double addrspace(1)* %241, align 8
...
preload934.i:                                     ; preds = %postload927.i
  store double %phi930.i, double addrspace(1)* %242, align 8
...
thenBB2184.i:                                     ; preds = %preload934.i
  %"CurrWI++2188.i" = add nuw i64 %CurrWI..5.i, 1
  %"loadedCurrSB+Stride2190.i" = add nuw i64 %CurrSBIndex..5.i, 5120
  %cond12.i = icmp eq i32 %currBarrier.3.i, 8
  br i1 %cond12.i, label %postload801.i, label %SyncBB.i
...
thenBB2177.i:                                     ; preds = %UnifiedReturnBlock.i
  %"CurrWI++2181.i" = add nuw i64 %CurrWI..5.i, 1
  %"loadedCurrSB+Stride2183.i" = add nuw i64 %CurrSBIndex..5.i, 5120
  %cond.i = icmp eq i32 %currBarrier.3.i, 8
  br i1 %cond.i, label %postload801.i, label %SyncBB.i

...
define void @test(i32 addrspace(1)* noalias %src) local_unnamed_addr #0 !dbg !9 !kernel_arg_addr_space !17 !kernel_arg_access_qual !18 !kernel_arg_type !19 !kernel_arg_base_type !19 !kernel_arg_type_qual !20 !kernel_arg_host_accessible !21 !kernel_arg_pipe_depth !22 !kernel_arg_pipe_io !20 !kernel_arg_buffer_location !20 !kernel_arg_name !23 !vectorized_kernel !24 !vectorized_masked_kernel !25 !kernel_has_sub_groups !26 !vectorized_width !17 !scalarized_kernel !27 !kernel_execution_length !28 !kernel_has_barrier !21 !kernel_has_global_sync !21 {
; CHECK: call i64 @_Z13get_global_idj(i32 0) #[[Attr:[0-9]+]], !dbg ![[DILoc:[0-9]+]]
entry:
  call void @llvm.dbg.value(metadata i32 addrspace(1)* %src, metadata !16, metadata !DIExpression()), !dbg !29
  ...
  %ptridx = getelementptr inbounds i32, i32 addrspace(1)* %src, i64 %call1, !dbg !31
  store i32 %subgroup.size, i32 addrspace(1)* %ptridx, align 4, !dbg !32, !tbaa !33
  ret void, !dbg !37
}
...
; Function Attrs: convergent norecurse nounwind
define void @_ZGVeN16u_test(i32 addrspace(1)* noalias %src) local_unnamed_addr #0 !dbg !38 !kernel_arg_addr_space !17 !kernel_arg_access_qual !18 !kernel_arg_type !19 !kernel_arg_base_type !19 !kernel_arg_type_qual !20 !kernel_arg_host_accessible !21 !kernel_arg_pipe_depth !22 !kernel_arg_pipe_io !20 !kernel_arg_buffer_location !20 !kernel_arg_name !23 !vectorized_kernel !27 !kernel_has_sub_groups !26 !ocl_recommended_vector_length !41 !vectorized_width !41 !vectorization_dimension !22 !scalarized_kernel !8 !can_unite_workgroups !21 !kernel_execution_length !42 !kernel_has_barrier !21 !kernel_has_global_sync !21 {
entry:
  ...
  %scalar.gep = getelementptr inbounds i32, i32 addrspace(1)* %src, i64 %call1, !dbg !45
  %5 = bitcast i32 addrspace(1)* %scalar.gep to <16 x i32> addrspace(1)*, !dbg !46
  store <16 x i32> %broadcast.splat3, <16 x i32> addrspace(1)* %5, align 4, !dbg !46
  ret void, !dbg !47
}
...
entry:
  ...
  %scalar.gep2 = getelementptr inbounds i32, i32 addrspace(1)* %src, i64 %call1, !dbg !54
  %6 = bitcast i32 addrspace(1)* %scalar.gep2 to <16 x i32> addrspace(1)*, !dbg !55
  call void @llvm.masked.store.v16i32.p1v16i32(<16 x i32> %broadcast.splat4, <16 x i32> addrspace(1)* %6, i32 4, <16 x i1> %5), !dbg !55
  ret void, !dbg !56
}
...
!22 = !{i32 0}
!23 = !{!"src"}
!24 = !{void (i32 addrspace(1)*)* @_ZGVeN16u_test}
!25 = !{void (i32 addrspace(1)*, <16 x i32>)* @_ZGVeM16u_test}
!26 = !{i1 true}
!27 = !{null}
!28 = !{i32 9}

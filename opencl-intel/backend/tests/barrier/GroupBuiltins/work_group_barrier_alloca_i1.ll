...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i1* %done) #3
  store i1 0, i1* %done, align 1, !tbaa !6
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %0 = load i1, i1* %done, align 1, !tbaa !6, !range !10
...
while.body:                                       ; preds = %while.cond
  store i1 1, i1* %done, align 1, !tbaa !6
  %call2 = call i32 bitcast (i32 ()* @work_group_barrier to i32 (i32, i32)*)(i32 1, i32 1) #4
  br label %while.cond

while.end:                                        ; preds = %while.cond
  call void @llvm.lifetime.end.p0i8(i64 1, i1* %done) #3
  ret void
}

; Function Attrs: argmemonly nounwind
declare void @llvm.lifetime.start.p0i8(i64, i1* nocapture) #1
...
; Function Attrs: argmemonly nounwind
declare void @llvm.lifetime.end.p0i8(i64, i1* nocapture) #1

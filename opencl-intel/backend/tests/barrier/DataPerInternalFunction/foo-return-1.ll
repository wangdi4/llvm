...
;;         c. In special buffer counters: ( 0, 0 )
...
;;         a. Offsets in special buffer: ( BAD_OFFSET, BAD_OFFSET )
...
; CHECK: call i32 @foo(i32 %x)
; CHECK: Offsets in special buffer: ( BAD_OFFSET, BAD_OFFSET )

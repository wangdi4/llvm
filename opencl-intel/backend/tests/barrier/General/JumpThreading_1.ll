...
; <label>:27                                      ; preds = %25
  ...
  %29 = getelementptr inbounds i32 addrspace(1)* %cols, i64 %28
  %30 = load i32 addrspace(1)* %29, align 4
  %31 = sext i32 %j.0 to i64
  %32 = getelementptr inbounds float addrspace(1)* %val, i64 %31
  %33 = load float addrspace(1)* %32, align 4
  %34 = sext i32 %30 to i64
  %35 = getelementptr inbounds float addrspace(1)* %vec, i64 %34

; RUN: %oclopt -ocl-syncfunctionattrs -jump-threading -S < %s -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
...
;; phi nodes
; DEBUGIFY: WARNING: Missing line 27
; DEBUGIFY: WARNING: Missing line 28

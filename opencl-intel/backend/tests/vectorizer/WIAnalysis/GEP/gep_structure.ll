...
!0 = metadata !{void (%struct.Node addrspace(1)*, i32 addrspace(1)*, i32)* @create_linked_lists, metadata !1, metadata !2, metadata !3, metadata !4, metadata !5, metadata !6}
!1 = metadata !{metadata !"kernel_arg_addr_space", i32 1, i32 1, i32 0}
!2 = metadata !{metadata !"kernel_arg_access_qual", metadata !"none", metadata !"none", metadata !"none"}
!3 = metadata !{metadata !"kernel_arg_type", metadata !"Node*", metadata !"int*", metadata !"int"}
!4 = metadata !{metadata !"kernel_arg_type_qual", metadata !"", metadata !"volatile", metadata !""}
!5 = metadata !{metadata !"kernel_arg_base_type", metadata !"struct Node*", metadata !"int*", metadata !"int"}
!6 = metadata !{metadata !"kernel_arg_name", metadata !"pNodes", metadata !"allocation_index", metadata !"list_length"}
!7 = metadata !{i32 1, i32 2}
!8 = metadata !{i32 2, i32 0}
!9 = metadata !{}
!10 = metadata !{metadata !"-cl-std=CL2.0"}
!11 = metadata !{void (%struct.Node addrspace(1)*, i32 addrspace(1)*, i32)* @create_linked_lists, metadata !12}
...
!15 = metadata !{metadata !"kernel_execution_length", null}
!16 = metadata !{metadata !"max_wg_dimensions", null}
!17 = metadata !{metadata !"kernel_has_barrier", null}
!18 = metadata !{metadata !"kernel_has_global_sync", null}
...
!27 = metadata !{metadata !"global_variable_total_size", null}

...
; RUN: %oclopt  -runtimelib %p/../Full/runtime.bc -runtime=ocl -print-wia-check -WIAnalysis %t.bc -S -o %t1.ll  -debug-only=dpcpp-kernel-work-item-analysis 2>&1 | FileCheck %s

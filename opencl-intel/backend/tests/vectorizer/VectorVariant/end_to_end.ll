; RUN: %oclopt %s -enable-direct-function-call-vectorization -vector-variant-lowering -sg-size-collector -sg-size-collector-indirect -ocl-vecclone -ocl-vector-variant-isa-encoding-override=AVX512Core -dpcpp-kernel-vector-variant-fillin -dpcpp-kernel-update-call-attrs -S | FileCheck %s

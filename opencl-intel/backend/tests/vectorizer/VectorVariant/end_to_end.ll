; RUN: %oclopt %s -enable-vector-variant-passes -sg-size-collector -sg-size-collector-indirect -vector-variant-lowering -vector-variant-isa-override=MIC -ocl-vecclone -ocl-vec-clone-isa-encoding-override=AVX512Core -vector-variant-fillin -update-call-attrs -S | FileCheck %s
...
; CHECK: attributes #[[ATTR0]] = { "vector-variants"="_ZGVbM4vv_XXX,_ZGVbN4vv_XXX" }

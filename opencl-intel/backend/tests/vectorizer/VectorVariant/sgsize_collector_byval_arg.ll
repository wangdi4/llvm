; RUN: %oclopt %s --ocl-vector-variant-isa-encoding-override=AVX512Core -enable-direct-function-call-vectorization -enable-direct-subgroup-function-call-vectorization -enable-byval-byref-function-call-vectorization -sg-size-collector -S | FileCheck %s

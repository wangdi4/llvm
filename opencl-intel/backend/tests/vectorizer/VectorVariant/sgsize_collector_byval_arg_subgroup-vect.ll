; RUN: %oclopt %s --ocl-vector-variant-isa-encoding-override=AVX512Core -enable-direct-subgroup-function-call-vectorization -sg-size-collector -enable-direct-function-call-vectorization -S | FileCheck %s

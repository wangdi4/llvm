...
define void @"_ZTSZZ4mainENK3$_0clERN2cl4sycl7handlerEE1K"(i64 addrspace(1)* %_arg_, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_1, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_2, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_3, %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)* %_arg_4, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_6, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_7, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_8, i64 addrspace(1)* %_arg_9, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_11, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_12, %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* byval(%"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range") %_arg_13) {
  ...
  %2 = trunc i64 %1 to i1
  br i1 %2, label %WGLoopsEntry, label %36
...
entryvector_func:                                 ; preds = %indirect.call.loop.exitvector_func, %dim_0_vector_pre_head
  ...
  %6 = getelementptr inbounds %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range", %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* %_arg_3, i64 0, i32 0, i32 0, i64 0
  %7 = load i64, i64* %6, align 8
  %add.ptr.i49vector_func = getelementptr inbounds i64, i64 addrspace(1)* %_arg_, i64 %7
  %8 = getelementptr inbounds %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range", %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* %_arg_13, i64 0, i32 0, i32 0, i64 0
  %9 = load i64, i64* %8, align 8
  %add.ptr.ivector_func = getelementptr inbounds i64, i64 addrspace(1)* %_arg_9, i64 %9
  %10 = getelementptr inbounds %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range", %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* %_arg_8, i64 0, i32 0, i32 0, i64 0
  %11 = load i64, i64* %10, align 8
  %add.ptr.i38vector_func = getelementptr inbounds %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned", %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)* %_arg_4, i64 %11
  ...
  %broadcast.splatinsert2vector_func = insertelement <8 x %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)*> undef, %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)* %add.ptr.i38vector_func, i32 0
  %broadcast.splat3vector_func = shufflevector <8 x %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)*> %broadcast.splatinsert2vector_func, <8 x %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)*> undef, <8 x i32> zeroinitializer
  ...
  %scalar.gepvector_func = getelementptr inbounds i64, i64 addrspace(1)* %add.ptr.i49vector_func, i64 %dim_0_vector_tid
  ...
  %mm_vectorGEP6vector_func = getelementptr inbounds %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned", <8 x %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)*> %broadcast.splat3vector_func, <8 x i64> %13, <8 x i32> zeroinitializer, <8 x i32> zeroinitializer, <8 x i64> zeroinitializer
...
vector.indirect.callvector_func:                  ; preds = %indirect.call.loop.entryvector_func
  %current.fptr.splatinsertvector_func = insertelement <8 x i32 (i32, i32)* addrspace(4)*> undef, i32 (i32, i32)* addrspace(4)* %current_fptrvector_func, i32 0
  %current.fptr.splatvector_func = shufflevector <8 x i32 (i32, i32)* addrspace(4)*> %current.fptr.splatinsertvector_func, <8 x i32 (i32, i32)* addrspace(4)*> undef, <8 x i32> zeroinitializer
  ...
  %19 = bitcast i32 (i32, i32)* addrspace(4)* %current_fptrvector_func to <8 x i32> (<8 x i32>, <8 x i32>, <8 x i32>) addrspace(4)* addrspace(4)* addrspace(4)*
  %20 = load <8 x i32> (<8 x i32>, <8 x i32>, <8 x i32>) addrspace(4)* addrspace(4)*, <8 x i32> (<8 x i32>, <8 x i32>, <8 x i32>) addrspace(4)* addrspace(4)* addrspace(4)* %19, align 8
  %21 = getelementptr <8 x i32> (<8 x i32>, <8 x i32>, <8 x i32>) addrspace(4)*, <8 x i32> (<8 x i32>, <8 x i32>, <8 x i32>) addrspace(4)* addrspace(4)* %20, i64 3
  %22 = load <8 x i32> (<8 x i32>, <8 x i32>, <8 x i32>) addrspace(4)*, <8 x i32> (<8 x i32>, <8 x i32>, <8 x i32>) addrspace(4)* addrspace(4)* %21, align 8
  %23 = call addrspace(4) <8 x i32> %22(<8 x i32> %15, <8 x i32> %17, <8 x i32> %vector_func_ptr_maskvector_func)
  %indirect_call_return_updatedvector_func = select <8 x i1> %func_ptr_maskvector_func, <8 x i32> %23, <8 x i32> %cur_indirect_call_returnvector_func
...
indirect.call.loop.exitvector_func:               ; preds = %indirect.call.loop.latchvector_func
  %24 = sext <8 x i32> %final_indirect_call_returnvector_func to <8 x i64>
  store <8 x i64> %24, <8 x i64> addrspace(1)* %14, align 8
...
scalarIf:                                         ; preds = %dim_0_vector_exit, %vect_if
  %25 = icmp ne i64 %scalar.size, 0
  br i1 %25, label %dim_0_pre_head, label %ret
...
scalar_kernel_entry:                              ; preds = %scalar_kernel_entry, %dim_0_pre_head
  ...
  %26 = getelementptr inbounds %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range", %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* %_arg_3, i64 0, i32 0, i32 0, i64 0
  %27 = load i64, i64* %26, align 8
  %add.ptr.i49 = getelementptr inbounds i64, i64 addrspace(1)* %_arg_, i64 %27
  %28 = getelementptr inbounds %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range", %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* %_arg_8, i64 0, i32 0, i32 0, i64 0
  %29 = load i64, i64* %28, align 8
  %add.ptr.i38 = getelementptr inbounds %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned", %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)* %_arg_4, i64 %29
  %30 = getelementptr inbounds %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range", %"class._ZTSN2cl4sycl5rangeILi1EEE.cl::sycl::range"* %_arg_13, i64 0, i32 0, i32 0, i64 0
  %31 = load i64, i64* %30, align 8
  %add.ptr.i = getelementptr inbounds i64, i64 addrspace(1)* %_arg_9, i64 %31
  %rem.i.i = and i64 %dim_0_tid, 1
  %ptridx.i16.i = getelementptr inbounds %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned", %"class._ZTSN2cl4sycl5intel18function_ref_tunedIFiiiENS1_8int_listIJLi4ELi8EEEEJFNS1_6maskedENS1_7varyingENS1_6linearEEFNS1_8unmaskedES7_S7_EEEE.cl::sycl::intel::function_ref_tuned" addrspace(1)* %add.ptr.i38, i64 %rem.i.i
  %ptridx.i24.i = getelementptr inbounds i64, i64 addrspace(1)* %add.ptr.i49, i64 %dim_0_tid
  %32 = load i64, i64 addrspace(1)* %ptridx.i24.i, align 8
  %conv.i = trunc i64 %32 to i32
  %ptridx.i20.i = getelementptr inbounds i64, i64 addrspace(1)* %add.ptr.i, i64 %dim_0_tid
  %33 = load i64, i64 addrspace(1)* %ptridx.i20.i, align 8
  %conv8.i = trunc i64 %33 to i32

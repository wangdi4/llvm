; RUN: %oclopt %s -enable-vector-variant-passes -instnamer -vector-variant-fillin -S | FileCheck %s
...
attributes #5 = { nounwind "vector-variant"="_ZGVbN8lu__Z3fooif" }
attributes #6 = { nounwind "vector-variant"="_ZGVbM8vv__Z3fooif" }

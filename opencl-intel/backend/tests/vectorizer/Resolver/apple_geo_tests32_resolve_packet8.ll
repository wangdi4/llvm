...
; RUN: opt -runtimelib %p/../Full/apple_only_dcls32.ll.bc -runtime=apple -CLBltnResolve %t.bc -S -o %t1.ll
...
entry:
  ...
  %12 = load <3 x float>, <3 x float>* %4
  %13 = load <3 x float>, <3 x float>* %5
  %14 = load <3 x float>, <3 x float>* %6
  %15 = load <3 x float>, <3 x float>* %7
  %16 = load <3 x float>, <3 x float>* %8
  %17 = load <3 x float>, <3 x float>* %9
  %18 = load <3 x float>, <3 x float>* %10
  %19 = load <3 x float>, <3 x float>* %11
  ...
  %52 = load <3 x float>, <3 x float>* %44
  %53 = load <3 x float>, <3 x float>* %45
  %54 = load <3 x float>, <3 x float>* %46
  %55 = load <3 x float>, <3 x float>* %47
  %56 = load <3 x float>, <3 x float>* %48
  %57 = load <3 x float>, <3 x float>* %49
  %58 = load <3 x float>, <3 x float>* %50
  %59 = load <3 x float>, <3 x float>* %51
...
entry:
  ...
  %12 = load <4 x float>, <4 x float>* %4
  %13 = load <4 x float>, <4 x float>* %5
  %14 = load <4 x float>, <4 x float>* %6
  %15 = load <4 x float>, <4 x float>* %7
  %16 = load <4 x float>, <4 x float>* %8
  %17 = load <4 x float>, <4 x float>* %9
  %18 = load <4 x float>, <4 x float>* %10
  %19 = load <4 x float>, <4 x float>* %11
  ...
  %28 = load <4 x float>, <4 x float>* %20
  %29 = load <4 x float>, <4 x float>* %21
  %30 = load <4 x float>, <4 x float>* %22
  %31 = load <4 x float>, <4 x float>* %23
  %32 = load <4 x float>, <4 x float>* %24
  %33 = load <4 x float>, <4 x float>* %25
  %34 = load <4 x float>, <4 x float>* %26
  %35 = load <4 x float>, <4 x float>* %27
...
entry:
  ...
  %12 = load <2 x float>, <2 x float>* %4
  %13 = load <2 x float>, <2 x float>* %5
  %14 = load <2 x float>, <2 x float>* %6
  %15 = load <2 x float>, <2 x float>* %7
  %16 = load <2 x float>, <2 x float>* %8
  %17 = load <2 x float>, <2 x float>* %9
  %18 = load <2 x float>, <2 x float>* %10
  %19 = load <2 x float>, <2 x float>* %11
  ...
  %44 = load <2 x float>, <2 x float>* %36
  %45 = load <2 x float>, <2 x float>* %37
  %46 = load <2 x float>, <2 x float>* %38
  %47 = load <2 x float>, <2 x float>* %39
  %48 = load <2 x float>, <2 x float>* %40
  %49 = load <2 x float>, <2 x float>* %41
  %50 = load <2 x float>, <2 x float>* %42
  %51 = load <2 x float>, <2 x float>* %43

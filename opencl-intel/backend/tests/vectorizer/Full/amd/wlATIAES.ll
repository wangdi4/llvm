...
entry:
	...
	%arraydecay = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx = getelementptr <4 x i8>, <4 x i8>* %arraydecay, i32 0		; <<4 x i8>*> [#uses=1]
	...
	%arraydecay13 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx14 = getelementptr <4 x i8>, <4 x i8>* %arraydecay13, i32 1		; <<4 x i8>*> [#uses=1]
	store <4 x i8> <i8 3, i8 0, i8 0, i8 0>, <4 x i8>* %.compoundliteral15
	%tmp16 = load <4 x i8>, <4 x i8>* %.compoundliteral15		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp16, <4 x i8>* %arrayidx14
	%arraydecay17 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx18 = getelementptr <4 x i8>, <4 x i8>* %arraydecay17, i32 2		; <<4 x i8>*> [#uses=1]
	store <4 x i8> <i8 1, i8 0, i8 0, i8 0>, <4 x i8>* %.compoundliteral19
	%tmp20 = load <4 x i8>, <4 x i8>* %.compoundliteral19		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp20, <4 x i8>* %arrayidx18
	%arraydecay21 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx22 = getelementptr <4 x i8>, <4 x i8>* %arraydecay21, i32 3		; <<4 x i8>*> [#uses=1]
	store <4 x i8> <i8 1, i8 0, i8 0, i8 0>, <4 x i8>* %.compoundliteral23
	%tmp24 = load <4 x i8>, <4 x i8>* %.compoundliteral23		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp24, <4 x i8>* %arrayidx22
	%tmp25 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp26 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx27 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp26, i32 %tmp25		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp28 = load i32, i32* %globalIndex		; <i32> [#uses=1]
	%tmp29 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx30 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp29, i32 %tmp28		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp31 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx30		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp31, <4 x i8> addrspace(3)* %arrayidx27
	%tmp32 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp33 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx34 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp33, i32 %tmp32		; <<4 x i8> addrspace(3)*> [#uses=2]
	%tmp35 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx34		; <<4 x i8>> [#uses=1]
	%tmp36 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp37 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %roundKey.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx38 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp37, i32 %tmp36		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp39 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx38		; <<4 x i8>> [#uses=1]
...
for.body:		; preds = %for.cond
	%tmp43 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp44 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx45 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp44, i32 %tmp43		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp46 = load i8 addrspace(1)*, i8 addrspace(1)** %SBox.addr		; <i8 addrspace(1)*> [#uses=1]
	%tmp47 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp48 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx49 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp48, i32 %tmp47		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp50 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx49		; <<4 x i8>> [#uses=1]
	...
	%arrayidx54 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp53, i32 %tmp52		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp55 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp56 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx57 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp56, i32 %tmp55		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp58 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx57		; <<4 x i8>> [#uses=1]
	%tmp59 = load i32, i32* %localIndex		; <i32> [#uses=1]
	...
	%arrayidx70 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp69, i32 0		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay77 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx78 = getelementptr <4 x i8>, <4 x i8>* %arraydecay77, i32 %rem		; <<4 x i8>*> [#uses=1]
...
if.then:		; preds = %for.body85
	%tmp89 = load i8, i8* %p		; <i8> [#uses=1]
	%conv90 = zext i8 %tmp89 to i32		; <i32> [#uses=1]
	%tmp91 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end:		; preds = %for.cond82
	...
	%arrayidx119 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp118, i32 0		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay129 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx130 = getelementptr <4 x i8>, <4 x i8>* %arraydecay129, i32 %rem128		; <<4 x i8>*> [#uses=1]
...
if.then145:		; preds = %for.body139
	%tmp146 = load i8, i8* %p		; <i8> [#uses=1]
	%conv147 = zext i8 %tmp146 to i32		; <i32> [#uses=1]
	%tmp148 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end180:		; preds = %for.cond135
	...
	%arrayidx183 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp182, i32 0		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay193 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx194 = getelementptr <4 x i8>, <4 x i8>* %arraydecay193, i32 %rem192		; <<4 x i8>*> [#uses=1]
...
if.then209:		; preds = %for.body203
	%tmp210 = load i8, i8* %p		; <i8> [#uses=1]
	%conv211 = zext i8 %tmp210 to i32		; <i32> [#uses=1]
	%tmp212 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end244:		; preds = %for.cond199
	...
	%arrayidx247 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp246, i32 0		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay257 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx258 = getelementptr <4 x i8>, <4 x i8>* %arraydecay257, i32 %rem256		; <<4 x i8>*> [#uses=1]
...
if.then273:		; preds = %for.body267
	%tmp274 = load i8, i8* %p		; <i8> [#uses=1]
	%conv275 = zext i8 %tmp274 to i32		; <i32> [#uses=1]
	%tmp276 = load i8, i8* %a		; <i8> [#uses=1]
...
for.body315:		; preds = %for.cond311
	...
	%arrayidx322 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp321, i32 %tmp320		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay334 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx335 = getelementptr <4 x i8>, <4 x i8>* %arraydecay334, i32 %rem333		; <<4 x i8>*> [#uses=1]
...
if.then350:		; preds = %for.body344
	%tmp351 = load i8, i8* %p		; <i8> [#uses=1]
	%conv352 = zext i8 %tmp351 to i32		; <i32> [#uses=1]
	%tmp353 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end385:		; preds = %for.cond340
	...
	%arrayidx389 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp388, i32 %tmp387		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay401 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx402 = getelementptr <4 x i8>, <4 x i8>* %arraydecay401, i32 %rem400		; <<4 x i8>*> [#uses=1]
...
if.then417:		; preds = %for.body411
	%tmp418 = load i8, i8* %p		; <i8> [#uses=1]
	%conv419 = zext i8 %tmp418 to i32		; <i32> [#uses=1]
	%tmp420 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end452:		; preds = %for.cond407
	...
	%arrayidx456 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp455, i32 %tmp454		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay468 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx469 = getelementptr <4 x i8>, <4 x i8>* %arraydecay468, i32 %rem467		; <<4 x i8>*> [#uses=1]
...
if.then484:		; preds = %for.body478
	%tmp485 = load i8, i8* %p		; <i8> [#uses=1]
	%conv486 = zext i8 %tmp485 to i32		; <i32> [#uses=1]
	%tmp487 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end519:		; preds = %for.cond474
	...
	%arrayidx523 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp522, i32 %tmp521		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay535 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx536 = getelementptr <4 x i8>, <4 x i8>* %arraydecay535, i32 %rem534		; <<4 x i8>*> [#uses=1]
...
if.then551:		; preds = %for.body545
	%tmp552 = load i8, i8* %p		; <i8> [#uses=1]
	%conv553 = zext i8 %tmp552 to i32		; <i32> [#uses=1]
	%tmp554 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end586:		; preds = %for.cond541
	...
	%tmp588 = load i8, i8* %x		; <i8> [#uses=1]
	%conv589 = zext i8 %tmp588 to i32		; <i32> [#uses=1]
	%tmp590 = load i8, i8* %x1		; <i8> [#uses=1]
	...
	%tmp594 = load i8, i8* %y		; <i8> [#uses=1]
	%conv595 = zext i8 %tmp594 to i32		; <i32> [#uses=1]
	%tmp596 = load i8, i8* %y1		; <i8> [#uses=1]
	...
	%tmp600 = load i8, i8* %z		; <i8> [#uses=1]
	%conv601 = zext i8 %tmp600 to i32		; <i32> [#uses=1]
	%tmp602 = load i8, i8* %z1		; <i8> [#uses=1]
	...
	%tmp606 = load i8, i8* %w		; <i8> [#uses=1]
	%conv607 = zext i8 %tmp606 to i32		; <i32> [#uses=1]
	%tmp608 = load i8, i8* %w1		; <i8> [#uses=1]
...
for.end615:		; preds = %for.cond311
	%tmp616 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp617 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block1.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx618 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp617, i32 %tmp616		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp620 = load i8, i8* %x		; <i8> [#uses=1]
	%0 = insertelement <4 x i8> undef, i8 %tmp620, i32 0		; <<4 x i8>> [#uses=1]
	%tmp621 = load i8, i8* %y		; <i8> [#uses=1]
	%1 = insertelement <4 x i8> %0, i8 %tmp621, i32 1		; <<4 x i8>> [#uses=1]
	%tmp622 = load i8, i8* %z		; <i8> [#uses=1]
	%2 = insertelement <4 x i8> %1, i8 %tmp622, i32 2		; <<4 x i8>> [#uses=1]
	%tmp623 = load i8, i8* %w		; <i8> [#uses=1]
	%3 = insertelement <4 x i8> %2, i8 %tmp623, i32 3		; <<4 x i8>> [#uses=1]
	store <4 x i8> %3, <4 x i8>* %.compoundliteral619
	%tmp624 = load <4 x i8>, <4 x i8>* %.compoundliteral619		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp624, <4 x i8> addrspace(3)* %arrayidx618
	call void @_Z7barrierm(i32 1)
	%tmp625 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp626 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx627 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp626, i32 %tmp625		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx630 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp629, i32 %tmp628		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx637 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp636, i32 %add635		; <<4 x i8> addrspace(1)*> [#uses=1]
...
for.inc640:		; preds = %for.end615
	%tmp641 = load i32, i32* %r		; <i32> [#uses=1]
...
for.end643:		; preds = %for.cond
	...
	%arrayidx646 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp645, i32 %tmp644		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx650 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp649, i32 %tmp648		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx655 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp654, i32 %tmp653		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx658 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp657, i32 %tmp656		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%tmp662 = load i32, i32* %globalIndex		; <i32> [#uses=1]
	%tmp663 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx664 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp663, i32 %tmp662		; <<4 x i8> addrspace(1)*> [#uses=1]
	...
	%arrayidx667 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp666, i32 %tmp665		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx674 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp673, i32 %add672		; <<4 x i8> addrspace(1)*> [#uses=1]
...
entry:
	...
	%arrayidx = getelementptr i8, i8 addrspace(1)* %tmp2, i32 %idxprom		; <i8 addrspace(1)*> [#uses=1]
	...
	%arrayidx8 = getelementptr i8, i8 addrspace(1)* %tmp6, i32 %idxprom7		; <i8 addrspace(1)*> [#uses=1]
	%tmp9 = load i8, i8 addrspace(1)* %arrayidx8		; <i8> [#uses=1]
	%1 = insertelement <4 x i8> %0, i8 %tmp9, i32 1		; <<4 x i8>> [#uses=1]
	%tmp10 = load <4 x i8>, <4 x i8>* %block.addr		; <<4 x i8>> [#uses=1]
	%tmp11 = extractelement <4 x i8> %tmp10, i32 2		; <i8> [#uses=1]
	%tmp12 = load i8 addrspace(1)*, i8 addrspace(1)** %SBox.addr		; <i8 addrspace(1)*> [#uses=1]
	%idxprom13 = zext i8 %tmp11 to i32		; <i32> [#uses=1]
	%arrayidx14 = getelementptr i8, i8 addrspace(1)* %tmp12, i32 %idxprom13		; <i8 addrspace(1)*> [#uses=1]
	%tmp15 = load i8, i8 addrspace(1)* %arrayidx14		; <i8> [#uses=1]
	%2 = insertelement <4 x i8> %1, i8 %tmp15, i32 2		; <<4 x i8>> [#uses=1]
	%tmp16 = load <4 x i8>, <4 x i8>* %block.addr		; <<4 x i8>> [#uses=1]
	%tmp17 = extractelement <4 x i8> %tmp16, i32 3		; <i8> [#uses=1]
	%tmp18 = load i8 addrspace(1)*, i8 addrspace(1)** %SBox.addr		; <i8 addrspace(1)*> [#uses=1]
	%idxprom19 = zext i8 %tmp17 to i32		; <i32> [#uses=1]
	%arrayidx20 = getelementptr i8, i8 addrspace(1)* %tmp18, i32 %idxprom19		; <i8 addrspace(1)*> [#uses=1]
	%tmp21 = load i8, i8 addrspace(1)* %arrayidx20		; <i8> [#uses=1]
	%3 = insertelement <4 x i8> %2, i8 %tmp21, i32 3		; <<4 x i8>> [#uses=1]
	store <4 x i8> %3, <4 x i8>* %.compoundliteral
	%tmp22 = load <4 x i8>, <4 x i8>* %.compoundliteral		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp22, <4 x i8>* %retval
	%4 = load <4 x i8>, <4 x i8>* %retval		; <<4 x i8>> [#uses=1]
	ret <4 x i8> %4
}
...
entry:
	...
	%arrayidx34 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp33, i32 %tmp32		; <<4 x i8> addrspace(3)*> [#uses=2]
	%tmp35 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx34		; <<4 x i8>> [#uses=1]
	%tmp36 = load i32, i32* %rounds.addr		; <i32> [#uses=1]
	%mul37 = mul i32 4, %tmp36		; <i32> [#uses=1]
	%tmp38 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%add39 = add i32 %mul37, %tmp38		; <i32> [#uses=1]
	%tmp40 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %roundKey.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx41 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp40, i32 %add39		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp42 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx41		; <<4 x i8>> [#uses=1]
...
for.body:		; preds = %for.cond
	...
	%arrayidx48 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp47, i32 %tmp46		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx51 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp50, i32 %tmp49		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp52 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx51		; <<4 x i8>> [#uses=1]
	%tmp53 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%call54 = call <4 x i8> @shiftRowsInv(<4 x i8> %tmp52, i32 %tmp53)		; <<4 x i8>> [#uses=1]
	store <4 x i8> %call54, <4 x i8> addrspace(3)* %arrayidx48
	%tmp55 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp56 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx57 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp56, i32 %tmp55		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp58 = load i8 addrspace(1)*, i8 addrspace(1)** %SBox.addr		; <i8 addrspace(1)*> [#uses=1]
	%tmp59 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp60 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx61 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp60, i32 %tmp59		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp62 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx61		; <<4 x i8>> [#uses=1]
	...
	%tmp65 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block1.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx66 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp65, i32 %tmp64		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp67 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp68 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx69 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp68, i32 %tmp67		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp70 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx69		; <<4 x i8>> [#uses=1]
	%tmp71 = load i32, i32* %r		; <i32> [#uses=1]
	%mul72 = mul i32 %tmp71, 4		; <i32> [#uses=1]
	%tmp73 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%add74 = add i32 %mul72, %tmp73		; <i32> [#uses=1]
	%tmp75 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %roundKey.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx76 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp75, i32 %add74		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp77 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx76		; <<4 x i8>> [#uses=1]
	...
	%arrayidx88 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp87, i32 0		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay96 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx97 = getelementptr <4 x i8>, <4 x i8>* %arraydecay96, i32 %rem		; <<4 x i8>*> [#uses=1]
...
if.then:		; preds = %for.body104
	%tmp108 = load i8, i8* %p		; <i8> [#uses=1]
	%conv109 = zext i8 %tmp108 to i32		; <i32> [#uses=1]
	%tmp110 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end:		; preds = %for.cond101
	...
	%arrayidx138 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp137, i32 0		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay148 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx149 = getelementptr <4 x i8>, <4 x i8>* %arraydecay148, i32 %rem147		; <<4 x i8>*> [#uses=1]
...
if.then164:		; preds = %for.body158
	%tmp165 = load i8, i8* %p		; <i8> [#uses=1]
	%conv166 = zext i8 %tmp165 to i32		; <i32> [#uses=1]
	%tmp167 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end199:		; preds = %for.cond154
	...
	%arrayidx202 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp201, i32 0		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay212 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx213 = getelementptr <4 x i8>, <4 x i8>* %arraydecay212, i32 %rem211		; <<4 x i8>*> [#uses=1]
...
if.then228:		; preds = %for.body222
	%tmp229 = load i8, i8* %p		; <i8> [#uses=1]
	%conv230 = zext i8 %tmp229 to i32		; <i32> [#uses=1]
	%tmp231 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end263:		; preds = %for.cond218
	...
	%arrayidx266 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp265, i32 0		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay276 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx277 = getelementptr <4 x i8>, <4 x i8>* %arraydecay276, i32 %rem275		; <<4 x i8>*> [#uses=1]
...
if.then292:		; preds = %for.body286
	%tmp293 = load i8, i8* %p		; <i8> [#uses=1]
	%conv294 = zext i8 %tmp293 to i32		; <i32> [#uses=1]
	%tmp295 = load i8, i8* %a		; <i8> [#uses=1]
...
for.body334:		; preds = %for.cond330
	...
	%arrayidx341 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp340, i32 %tmp339		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay353 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx354 = getelementptr <4 x i8>, <4 x i8>* %arraydecay353, i32 %rem352		; <<4 x i8>*> [#uses=1]
...
if.then369:		; preds = %for.body363
	%tmp370 = load i8, i8* %p		; <i8> [#uses=1]
	%conv371 = zext i8 %tmp370 to i32		; <i32> [#uses=1]
	%tmp372 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end404:		; preds = %for.cond359
	...
	%arrayidx408 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp407, i32 %tmp406		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay420 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx421 = getelementptr <4 x i8>, <4 x i8>* %arraydecay420, i32 %rem419		; <<4 x i8>*> [#uses=1]
...
if.then436:		; preds = %for.body430
	%tmp437 = load i8, i8* %p		; <i8> [#uses=1]
	%conv438 = zext i8 %tmp437 to i32		; <i32> [#uses=1]
	%tmp439 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end471:		; preds = %for.cond426
	...
	%arrayidx475 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp474, i32 %tmp473		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay487 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx488 = getelementptr <4 x i8>, <4 x i8>* %arraydecay487, i32 %rem486		; <<4 x i8>*> [#uses=1]
...
if.then503:		; preds = %for.body497
	%tmp504 = load i8, i8* %p		; <i8> [#uses=1]
	%conv505 = zext i8 %tmp504 to i32		; <i32> [#uses=1]
	%tmp506 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end538:		; preds = %for.cond493
	...
	%arrayidx542 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp541, i32 %tmp540		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arraydecay554 = getelementptr [4 x <4 x i8>], [4 x <4 x i8>]* %galiosCoeff, i32 0, i32 0		; <<4 x i8>*> [#uses=1]
	%arrayidx555 = getelementptr <4 x i8>, <4 x i8>* %arraydecay554, i32 %rem553		; <<4 x i8>*> [#uses=1]
...
if.then570:		; preds = %for.body564
	%tmp571 = load i8, i8* %p		; <i8> [#uses=1]
	%conv572 = zext i8 %tmp571 to i32		; <i32> [#uses=1]
	%tmp573 = load i8, i8* %a		; <i8> [#uses=1]
...
for.end605:		; preds = %for.cond560
	...
	%tmp607 = load i8, i8* %x		; <i8> [#uses=1]
	%conv608 = zext i8 %tmp607 to i32		; <i32> [#uses=1]
	%tmp609 = load i8, i8* %x1		; <i8> [#uses=1]
	...
	%tmp613 = load i8, i8* %y		; <i8> [#uses=1]
	%conv614 = zext i8 %tmp613 to i32		; <i32> [#uses=1]
	%tmp615 = load i8, i8* %y1		; <i8> [#uses=1]
	...
	%tmp619 = load i8, i8* %z		; <i8> [#uses=1]
	%conv620 = zext i8 %tmp619 to i32		; <i32> [#uses=1]
	%tmp621 = load i8, i8* %z1		; <i8> [#uses=1]
	...
	%tmp625 = load i8, i8* %w		; <i8> [#uses=1]
	%conv626 = zext i8 %tmp625 to i32		; <i32> [#uses=1]
	%tmp627 = load i8, i8* %w1		; <i8> [#uses=1]
...
for.end634:		; preds = %for.cond330
	%tmp635 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp636 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx637 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp636, i32 %tmp635		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp639 = load i8, i8* %x		; <i8> [#uses=1]
	%0 = insertelement <4 x i8> undef, i8 %tmp639, i32 0		; <<4 x i8>> [#uses=1]
	%tmp640 = load i8, i8* %y		; <i8> [#uses=1]
	%1 = insertelement <4 x i8> %0, i8 %tmp640, i32 1		; <<4 x i8>> [#uses=1]
	%tmp641 = load i8, i8* %z		; <i8> [#uses=1]
	%2 = insertelement <4 x i8> %1, i8 %tmp641, i32 2		; <<4 x i8>> [#uses=1]
	%tmp642 = load i8, i8* %w		; <i8> [#uses=1]
	%3 = insertelement <4 x i8> %2, i8 %tmp642, i32 3		; <<4 x i8>> [#uses=1]
	store <4 x i8> %3, <4 x i8>* %.compoundliteral638
	%tmp643 = load <4 x i8>, <4 x i8>* %.compoundliteral638		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp643, <4 x i8> addrspace(3)* %arrayidx637
	br label %for.inc644

for.inc644:		; preds = %for.end634
	%tmp645 = load i32, i32* %r		; <i32> [#uses=1]
	%dec = add i32 %tmp645, -1		; <i32> [#uses=1]
	store i32 %dec, i32* %r
	br label %for.cond

for.end646:		; preds = %for.cond
	%tmp647 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp648 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block0.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx649 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp648, i32 %tmp647		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx652 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp651, i32 %tmp650		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%arrayidx662 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp661, i32 %tmp660		; <<4 x i8> addrspace(3)*> [#uses=1]
	...
	%tmp665 = load i32, i32* %globalIndex		; <i32> [#uses=1]
	%tmp666 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx667 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp666, i32 %tmp665		; <<4 x i8> addrspace(1)*> [#uses=1]
	...
	%arrayidx670 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp669, i32 %tmp668		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp671 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx670		; <<4 x i8>> [#uses=1]
	%tmp672 = load i32, i32* %localIndex		; <i32> [#uses=1]
	%tmp673 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %roundKey.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx674 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp673, i32 %tmp672		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp675 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx674		; <<4 x i8>> [#uses=1]

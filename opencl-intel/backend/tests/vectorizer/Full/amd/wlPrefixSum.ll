...
entry:
	...
	%add.ptr = getelementptr i32, i32 addrspace(1)* %tmp, i32 %mul		; <i32 addrspace(1)*> [#uses=1]
	...
	%add.ptr8 = getelementptr i32, i32 addrspace(1)* %tmp4, i32 %mul7		; <i32 addrspace(1)*> [#uses=1]
...
for.body:		; preds = %for.cond
	...
	%arrayidx = getelementptr i32, i32 addrspace(1)* %tmp13, i32 %tmp12		; <i32 addrspace(1)*> [#uses=1]
	%tmp14 = load i32, i32* %i		; <i32> [#uses=1]
	%tmp15 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedInputArray		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx16 = getelementptr i32, i32 addrspace(1)* %tmp15, i32 %tmp14		; <i32 addrspace(1)*> [#uses=1]
...
for.body34:		; preds = %for.cond30
	...
	%tmp36 = load i32, i32* %offset		; <i32> [#uses=1]
	%add = add i32 %tmp35, %tmp36		; <i32> [#uses=1]
	%tmp37 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedOutputArray		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx38 = getelementptr i32, i32 addrspace(1)* %tmp37, i32 %add		; <i32 addrspace(1)*> [#uses=2]
	%tmp39 = load i32, i32 addrspace(1)* %arrayidx38		; <i32> [#uses=1]
	%tmp40 = load i32, i32* %index		; <i32> [#uses=1]
	%tmp41 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedOutputArray		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx42 = getelementptr i32, i32 addrspace(1)* %tmp41, i32 %tmp40		; <i32 addrspace(1)*> [#uses=1]
	...
	%tmp46 = load i32, i32* %offset		; <i32> [#uses=1]
...
for.end57:		; preds = %for.cond23
	...
	%tmp59 = load i32 addrspace(1)*, i32 addrspace(1)** %puiTmpArray.addr		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx60 = getelementptr i32, i32 addrspace(1)* %tmp59, i32 %tmp58		; <i32 addrspace(1)*> [#uses=1]
	%tmp61 = load i32, i32* %szElementsPerItem.addr		; <i32> [#uses=1]
	%sub62 = sub i32 %tmp61, 1		; <i32> [#uses=1]
	%tmp63 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedOutputArray		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx64 = getelementptr i32, i32 addrspace(1)* %tmp63, i32 %sub62		; <i32 addrspace(1)*> [#uses=1]
	%tmp65 = load i32, i32 addrspace(1)* %arrayidx64		; <i32> [#uses=1]
...
entry:
	...
	%add.ptr = getelementptr i32, i32 addrspace(1)* %tmp2, i32 %mul		; <i32 addrspace(1)*> [#uses=1]
	...
	%add.ptr8 = getelementptr i32, i32 addrspace(1)* %tmp6, i32 %tmp7		; <i32 addrspace(1)*> [#uses=1]
	...
	%tmp13 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedOutputArray		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx = getelementptr i32, i32 addrspace(1)* %tmp13, i32 %sub		; <i32 addrspace(1)*> [#uses=1]
...
for.body27:		; preds = %for.cond23
	...
	%arrayidx41 = getelementptr i32, i32 addrspace(1)* %tmp40, i32 %tmp39		; <i32 addrspace(1)*> [#uses=1]
	...
	%tmp44 = load i32, i32* %index		; <i32> [#uses=1]
	%tmp45 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedOutputArray		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx46 = getelementptr i32, i32 addrspace(1)* %tmp45, i32 %tmp44		; <i32 addrspace(1)*> [#uses=1]
	%tmp47 = load i32, i32* %nextValue		; <i32> [#uses=1]
	store i32 %tmp47, i32 addrspace(1)* %arrayidx46
	%tmp48 = load i32, i32* %index		; <i32> [#uses=1]
	%tmp49 = load i32, i32* %offset		; <i32> [#uses=1]
...
for.body61:		; preds = %for.cond57
	%tmp62 = load i32, i32* %i		; <i32> [#uses=1]
	%tmp63 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedOutputArray		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx64 = getelementptr i32, i32 addrspace(1)* %tmp63, i32 %tmp62		; <i32 addrspace(1)*> [#uses=2]
	%tmp65 = load i32, i32 addrspace(1)* %arrayidx64		; <i32> [#uses=1]
	%tmp66 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedValueToAddArray		; <i32 addrspace(1)*> [#uses=1]
	%arrayidx67 = getelementptr i32, i32 addrspace(1)* %tmp66, i32 0		; <i32 addrspace(1)*> [#uses=1]

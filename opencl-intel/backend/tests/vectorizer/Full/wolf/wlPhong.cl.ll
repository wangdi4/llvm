...
@opencl_metadata = appending global [1 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (float addrspace(1)*, float addrspace(1)*, float addrspace(1)*, float addrspace(1)*, float addrspace(1)*, float addrspace(1)*, i32, i8 addrspace(1)*, i32, i32)* @PHONG to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_PHONG_locals to i8*), i8* getelementptr inbounds ([344 x i8], [344 x i8]* @opencl_PHONG_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[1 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %tmp = load i32, i32* %m_num_total_f.addr            ; <i32> [#uses=1]
  %div = udiv i32 %tmp, 3                         ; <i32> [#uses=1]
  store i32 %div, i32* %num_pnt
  %tmp5 = load i32, i32* %num_pnt                      ; <i32> [#uses=1]
  %tmp6 = load i32, i32* %m_phongThread.addr           ; <i32> [#uses=2]
  ...
  %tmp9 = load float addrspace(1)*, float addrspace(1)** %ldir_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %tmp9, i32 0 ; <float addrspace(1)*> [#uses=1]
  %tmp10 = load float, float addrspace(1)* %arrayidx     ; <float> [#uses=1]
  %arraydecay = getelementptr inbounds [3 x float], [3 x float]* %_ldir, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx11 = getelementptr inbounds float, float* %arraydecay, i32 0 ; <float*> [#uses=1]
  store float %tmp10, float* %arrayidx11
  %tmp12 = load float addrspace(1)*, float addrspace(1)** %ldir_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx13 = getelementptr inbounds float, float addrspace(1)* %tmp12, i32 1 ; <float addrspace(1)*> [#uses=1]
  %tmp14 = load float, float addrspace(1)* %arrayidx13   ; <float> [#uses=1]
  %arraydecay15 = getelementptr inbounds [3 x float], [3 x float]* %_ldir, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx16 = getelementptr inbounds float, float* %arraydecay15, i32 1 ; <float*> [#uses=1]
  store float %tmp14, float* %arrayidx16
  %tmp17 = load float addrspace(1)*, float addrspace(1)** %ldir_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx18 = getelementptr inbounds float, float addrspace(1)* %tmp17, i32 2 ; <float addrspace(1)*> [#uses=1]
  %tmp19 = load float, float addrspace(1)* %arrayidx18   ; <float> [#uses=1]
  %arraydecay20 = getelementptr inbounds [3 x float], [3 x float]* %_ldir, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx21 = getelementptr inbounds float, float* %arraydecay20, i32 2 ; <float*> [#uses=1]
  store float %tmp19, float* %arrayidx21
  %tmp23 = load float addrspace(1)*, float addrspace(1)** %v_pnt_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx24 = getelementptr inbounds float, float addrspace(1)* %tmp23, i32 0 ; <float addrspace(1)*> [#uses=1]
  %tmp25 = load float, float addrspace(1)* %arrayidx24   ; <float> [#uses=1]
  %arraydecay26 = getelementptr inbounds [3 x float], [3 x float]* %_v_pnt, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx27 = getelementptr inbounds float, float* %arraydecay26, i32 0 ; <float*> [#uses=1]
  store float %tmp25, float* %arrayidx27
  %tmp28 = load float addrspace(1)*, float addrspace(1)** %v_pnt_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx29 = getelementptr inbounds float, float addrspace(1)* %tmp28, i32 1 ; <float addrspace(1)*> [#uses=1]
  %tmp30 = load float, float addrspace(1)* %arrayidx29   ; <float> [#uses=1]
  %arraydecay31 = getelementptr inbounds [3 x float], [3 x float]* %_v_pnt, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx32 = getelementptr inbounds float, float* %arraydecay31, i32 1 ; <float*> [#uses=1]
  store float %tmp30, float* %arrayidx32
  %tmp33 = load float addrspace(1)*, float addrspace(1)** %v_pnt_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx34 = getelementptr inbounds float, float addrspace(1)* %tmp33, i32 2 ; <float addrspace(1)*> [#uses=1]
  %tmp35 = load float, float addrspace(1)* %arrayidx34   ; <float> [#uses=1]
  %arraydecay36 = getelementptr inbounds [3 x float], [3 x float]* %_v_pnt, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx37 = getelementptr inbounds float, float* %arraydecay36, i32 2 ; <float*> [#uses=1]
  store float %tmp35, float* %arrayidx37
  store float 5.000000e-001, float* %specular
  %tmp40 = load i32, i32* %m_phongConst.addr           ; <i32> [#uses=1]
  %conv = zext i32 %tmp40 to i64                  ; <i64> [#uses=1]
  store i64 %conv, i64* %phongconst
  %arraydecay42 = getelementptr inbounds [3 x float], [3 x float]* %_ldir, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx43 = getelementptr inbounds float, float* %arraydecay42, i32 0 ; <float*> [#uses=1]
  %tmp44 = load float, float* %arrayidx43                ; <float> [#uses=1]
  %vecinit = insertelement <4 x float> undef, float %tmp44, i32 0 ; <<4 x float>> [#uses=1]
  %arraydecay45 = getelementptr inbounds [3 x float], [3 x float]* %_ldir, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx46 = getelementptr inbounds float, float* %arraydecay45, i32 1 ; <float*> [#uses=1]
  ...
  %arraydecay49 = getelementptr inbounds [3 x float], [3 x float]* %_ldir, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx50 = getelementptr inbounds float, float* %arraydecay49, i32 2 ; <float*> [#uses=1]
  %tmp51 = load float, float* %arrayidx50                ; <float> [#uses=1]
  ...
  %tmp54 = load <4 x float>, <4 x float>* %.compoundliteral    ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp54, <4 x float>* %_ldir_v4
  %arraydecay57 = getelementptr inbounds [3 x float], [3 x float]* %_v_pnt, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx58 = getelementptr inbounds float, float* %arraydecay57, i32 0 ; <float*> [#uses=1]
  %tmp59 = load float, float* %arrayidx58                ; <float> [#uses=1]
  %vecinit60 = insertelement <4 x float> undef, float %tmp59, i32 0 ; <<4 x float>> [#uses=1]
  %arraydecay61 = getelementptr inbounds [3 x float], [3 x float]* %_v_pnt, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx62 = getelementptr inbounds float, float* %arraydecay61, i32 1 ; <float*> [#uses=1]
  %tmp63 = load float, float* %arrayidx62                ; <float> [#uses=1]
  %vecinit64 = insertelement <4 x float> %vecinit60, float %tmp63, i32 1 ; <<4 x float>> [#uses=1]
  %arraydecay65 = getelementptr inbounds [3 x float], [3 x float]* %_v_pnt, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx66 = getelementptr inbounds float, float* %arraydecay65, i32 2 ; <float*> [#uses=1]
  %tmp67 = load float, float* %arrayidx66                ; <float> [#uses=1]
  ...
  %tmp70 = load <4 x float>, <4 x float>* %.compoundliteral56  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp70, <4 x float>* %_v_pnt_v4
  %tmp74 = load float addrspace(1)*, float addrspace(1)** %ambient.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx75 = getelementptr inbounds float, float addrspace(1)* %tmp74, i32 0 ; <float addrspace(1)*> [#uses=1]
  %tmp76 = load float, float addrspace(1)* %arrayidx75   ; <float> [#uses=1]
  %vecinit77 = insertelement <4 x float> undef, float %tmp76, i32 0 ; <<4 x float>> [#uses=1]
  %tmp78 = load float addrspace(1)*, float addrspace(1)** %ambient.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx79 = getelementptr inbounds float, float addrspace(1)* %tmp78, i32 1 ; <float addrspace(1)*> [#uses=1]
  %tmp80 = load float, float addrspace(1)* %arrayidx79   ; <float> [#uses=1]
  %vecinit81 = insertelement <4 x float> %vecinit77, float %tmp80, i32 1 ; <<4 x float>> [#uses=1]
  %tmp82 = load float addrspace(1)*, float addrspace(1)** %ambient.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx83 = getelementptr inbounds float, float addrspace(1)* %tmp82, i32 2 ; <float addrspace(1)*> [#uses=1]
  %tmp84 = load float, float addrspace(1)* %arrayidx83   ; <float> [#uses=1]
  ...
  %tmp87 = load <4 x float>, <4 x float>* %.compoundliteral73  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp87, <4 x float>* %ambient_v4
  %tmp90 = load float addrspace(1)*, float addrspace(1)** %diffuse.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx91 = getelementptr inbounds float, float addrspace(1)* %tmp90, i32 0 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp94 = load float addrspace(1)*, float addrspace(1)** %diffuse.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx95 = getelementptr inbounds float, float addrspace(1)* %tmp94, i32 1 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp98 = load float addrspace(1)*, float addrspace(1)** %diffuse.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx99 = getelementptr inbounds float, float addrspace(1)* %tmp98, i32 2 ; <float addrspace(1)*> [#uses=1]
  %tmp100 = load float, float addrspace(1)* %arrayidx99  ; <float> [#uses=1]
  ...
  %tmp103 = load <4 x float>, <4 x float>* %.compoundliteral89 ; <<4 x float>> [#uses=1]
...
for.cond:                                         ; preds = %for.inc242, %entry
  %tmp106 = load i32, i32* %offset                     ; <i32> [#uses=1]
  %tmp107 = load i32, i32* %chuckSize                  ; <i32> [#uses=1]
  %cmp108 = icmp slt i32 %tmp106, %tmp107         ; <i1> [#uses=1]
  br i1 %cmp108, label %for.body, label %for.end245

for.body:                                         ; preds = %for.cond
  %tmp111 = load i32, i32* %chuckSize                  ; <i32> [#uses=1]
  %tmp112 = load i32, i32* %globalIdx                  ; <i32> [#uses=1]
  %mul = mul i32 %tmp111, %tmp112                 ; <i32> [#uses=1]
  %tmp113 = load i32, i32* %offset                     ; <i32> [#uses=1]
  %add = add i32 %mul, %tmp113                    ; <i32> [#uses=1]
  %mul114 = mul i32 %add, 3                       ; <i32> [#uses=1]
  store i32 %mul114, i32* %indexPosition
  %tmp116 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %tmp117 = load float addrspace(1)*, float addrspace(1)** %norm_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx118 = getelementptr inbounds float, float addrspace(1)* %tmp117, i32 %tmp116 ; <float addrspace(1)*> [#uses=1]
  %tmp119 = load float, float addrspace(1)* %arrayidx118 ; <float> [#uses=1]
  %vecinit120 = insertelement <4 x float> undef, float %tmp119, i32 0 ; <<4 x float>> [#uses=1]
  %tmp121 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %add122 = add i32 %tmp121, 1                    ; <i32> [#uses=1]
  %tmp123 = load float addrspace(1)*, float addrspace(1)** %norm_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx124 = getelementptr inbounds float, float addrspace(1)* %tmp123, i32 %add122 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp127 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %add128 = add i32 %tmp127, 2                    ; <i32> [#uses=1]
  %tmp129 = load float addrspace(1)*, float addrspace(1)** %norm_org.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx130 = getelementptr inbounds float, float addrspace(1)* %tmp129, i32 %add128 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp134 = load <4 x float>, <4 x float>* %.compoundliteral115 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp134, <4 x float>* %_norm_v4
  %tmp140 = load <4 x float>, <4 x float>* %_norm_v4           ; <<4 x float>> [#uses=1]
  %tmp141 = load <4 x float>, <4 x float>* %_ldir_v4           ; <<4 x float>> [#uses=1]
  %call142 = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp140, <4 x float> %tmp141) ; <float> [#uses=1]
  store float %call142, float* %costheta
  %tmp144 = load float, float* %costheta                 ; <float> [#uses=1]
  ...
  %tmp147 = load <4 x float>, <4 x float>* %costheta_v4        ; <<4 x float>> [#uses=1]
  ...
  %tmp150 = load <4 x float>, <4 x float>* %dt_v4              ; <<4 x float>> [#uses=1]
  %tmp151 = load <4 x float>, <4 x float>* %_norm_v4           ; <<4 x float>> [#uses=1]
  %mul152 = fmul <4 x float> %tmp150, %tmp151     ; <<4 x float>> [#uses=1]
  %tmp153 = load <4 x float>, <4 x float>* %_ldir_v4           ; <<4 x float>> [#uses=1]
  %sub = fsub <4 x float> %mul152, %tmp153        ; <<4 x float>> [#uses=1]
  store <4 x float> %sub, <4 x float>* %R_v4
  %tmp154 = load <4 x float>, <4 x float>* %costheta_v4        ; <<4 x float>> [#uses=1]
  ...
  %tmp157 = load <4 x float>, <4 x float>* %ambient_v4         ; <<4 x float>> [#uses=1]
  %tmp158 = load <4 x float>, <4 x float>* %diffuse_v4         ; <<4 x float>> [#uses=1]
  %tmp159 = load <4 x float>, <4 x float>* %costheta_v4        ; <<4 x float>> [#uses=1]
  ...
  %tmp162 = load <4 x float>, <4 x float>* %R_v4               ; <<4 x float>> [#uses=1]
  %tmp163 = load <4 x float>, <4 x float>* %_v_pnt_v4          ; <<4 x float>> [#uses=1]
  %call164 = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp162, <4 x float> %tmp163) ; <float> [#uses=1]
  store float %call164, float* %cosalpha
  %tmp165 = load float, float* %cosalpha                 ; <float> [#uses=1]
...
if.then:                                          ; preds = %for.body
  %tmp169 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
...
if.end:                                           ; preds = %if.then172, %if.then
  %tmp173 = load float, float* %specular                 ; <float> [#uses=1]
...
if.end189:                                        ; preds = %if.then188, %for.end
  %tmp191 = load float, float* %specularN                ; <float> [#uses=1]
  ...
  %tmp194 = load <4 x float>, <4 x float>* %specularN_v4       ; <<4 x float>> [#uses=1]
  %tmp195 = load <4 x float>, <4 x float>* %intensity_v4       ; <<4 x float>> [#uses=1]
...
if.end197:                                        ; preds = %if.end189, %for.body
  %tmp198 = load <4 x float>, <4 x float>* %intensity_v4       ; <<4 x float>> [#uses=1]
  %tmp199 = extractelement <4 x float> %tmp198, i32 0 ; <float> [#uses=1]
  %tmp200 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %tmp201 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx202 = getelementptr inbounds float, float addrspace(1)* %tmp201, i32 %tmp200 ; <float addrspace(1)*> [#uses=1]
  store float %tmp199, float addrspace(1)* %arrayidx202
  %tmp203 = load <4 x float>, <4 x float>* %intensity_v4       ; <<4 x float>> [#uses=1]
  %tmp204 = extractelement <4 x float> %tmp203, i32 1 ; <float> [#uses=1]
  %tmp205 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %add206 = add i32 %tmp205, 1                    ; <i32> [#uses=1]
  %tmp207 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx208 = getelementptr inbounds float, float addrspace(1)* %tmp207, i32 %add206 ; <float addrspace(1)*> [#uses=1]
  store float %tmp204, float addrspace(1)* %arrayidx208
  %tmp209 = load <4 x float>, <4 x float>* %intensity_v4       ; <<4 x float>> [#uses=1]
  %tmp210 = extractelement <4 x float> %tmp209, i32 2 ; <float> [#uses=1]
  %tmp211 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %add212 = add i32 %tmp211, 2                    ; <i32> [#uses=1]
  %tmp213 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx214 = getelementptr inbounds float, float addrspace(1)* %tmp213, i32 %add212 ; <float addrspace(1)*> [#uses=1]
  store float %tmp210, float addrspace(1)* %arrayidx214
  %tmp216 = load <4 x float>, <4 x float>* %f255_v4            ; <<4 x float>> [#uses=1]
  %tmp217 = load <4 x float>, <4 x float>* %intensity_v4       ; <<4 x float>> [#uses=1]
  %tmp218 = load <4 x float>, <4 x float>* %f255_v4            ; <<4 x float>> [#uses=1]
  ...
  %tmp222 = load <4 x float>, <4 x float>* %tmp_v4             ; <<4 x float>> [#uses=1]
  %tmp223 = extractelement <4 x float> %tmp222, i32 0 ; <float> [#uses=1]
  %conv224 = fptoui float %tmp223 to i8           ; <i8> [#uses=1]
  %tmp225 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %tmp226 = load i8 addrspace(1)*, i8 addrspace(1)** %outRgb.addr   ; <i8 addrspace(1)*> [#uses=1]
  %arrayidx227 = getelementptr inbounds i8, i8 addrspace(1)* %tmp226, i32 %tmp225 ; <i8 addrspace(1)*> [#uses=1]
  store i8 %conv224, i8 addrspace(1)* %arrayidx227
  %tmp228 = load <4 x float>, <4 x float>* %tmp_v4             ; <<4 x float>> [#uses=1]
  %tmp229 = extractelement <4 x float> %tmp228, i32 1 ; <float> [#uses=1]
  %conv230 = fptoui float %tmp229 to i8           ; <i8> [#uses=1]
  %tmp231 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %add232 = add i32 %tmp231, 1                    ; <i32> [#uses=1]
  %tmp233 = load i8 addrspace(1)*, i8 addrspace(1)** %outRgb.addr   ; <i8 addrspace(1)*> [#uses=1]
  %arrayidx234 = getelementptr inbounds i8, i8 addrspace(1)* %tmp233, i32 %add232 ; <i8 addrspace(1)*> [#uses=1]
  store i8 %conv230, i8 addrspace(1)* %arrayidx234
  %tmp235 = load <4 x float>, <4 x float>* %tmp_v4             ; <<4 x float>> [#uses=1]
  %tmp236 = extractelement <4 x float> %tmp235, i32 2 ; <float> [#uses=1]
  %conv237 = fptoui float %tmp236 to i8           ; <i8> [#uses=1]
  %tmp238 = load i32, i32* %indexPosition              ; <i32> [#uses=1]
  %add239 = add i32 %tmp238, 2                    ; <i32> [#uses=1]
  %tmp240 = load i8 addrspace(1)*, i8 addrspace(1)** %outRgb.addr   ; <i8 addrspace(1)*> [#uses=1]
  %arrayidx241 = getelementptr inbounds i8, i8 addrspace(1)* %tmp240, i32 %add239 ; <i8 addrspace(1)*> [#uses=1]
  store i8 %conv237, i8 addrspace(1)* %arrayidx241
  br label %for.inc242

for.inc242:                                       ; preds = %if.end197
  %tmp243 = load i32, i32* %offset                     ; <i32> [#uses=1]

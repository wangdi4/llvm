...
entry:
  ...
  %tmp = load i32, i32* %numBodies.addr                ; <i32> [#uses=1]
  %tmp3 = load i32, i32* %localSize                    ; <i32> [#uses=2]
  ...
  %tmp6 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %pos.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp6, i32 %tmp5 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp7 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp7, <4 x float>* %myPos
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral
  %tmp9 = load <4 x float>, <4 x float>* %.compoundliteral     ; <<4 x float>> [#uses=1]
...
for.cond:                                         ; preds = %for.inc84, %entry
  ...
  %tmp12 = load i32, i32* %numTiles                    ; <i32> [#uses=1]
  %cmp13 = icmp ult i32 %tmp11, %tmp12            ; <i1> [#uses=1]
  br i1 %cmp13, label %for.body, label %for.end87

for.body:                                         ; preds = %for.cond
  %tmp15 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp16 = load i32, i32* %localSize                   ; <i32> [#uses=1]
  %mul = mul i32 %tmp15, %tmp16                   ; <i32> [#uses=1]
  %tmp17 = load i32, i32* %tid                         ; <i32> [#uses=1]
  %add = add i32 %mul, %tmp17                     ; <i32> [#uses=1]
  store i32 %add, i32* %idx
  %tmp18 = load i32, i32* %idx                         ; <i32> [#uses=1]
  %tmp19 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %pos.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp23 = load <4 x float> addrspace(3)*, <4 x float> addrspace(3)** %localPos.addr ; <<4 x float> addrspace(3)*> [#uses=1]
  %arrayidx24 = getelementptr inbounds <4 x float>, <4 x float> addrspace(3)* %tmp23, i32 %tmp22 ; <<4 x float> addrspace(3)*> [#uses=1]
...
for.cond26:                                       ; preds = %for.inc, %for.body
  ...
  %tmp28 = load i32, i32* %localSize                   ; <i32> [#uses=1]
  %cmp29 = icmp ult i32 %tmp27, %tmp28            ; <i1> [#uses=1]
  br i1 %cmp29, label %for.body30, label %for.end

for.body30:                                       ; preds = %for.cond26
  %tmp32 = load i32, i32* %j                           ; <i32> [#uses=1]
  %tmp33 = load <4 x float> addrspace(3)*, <4 x float> addrspace(3)** %localPos.addr ; <<4 x float> addrspace(3)*> [#uses=1]
  %arrayidx34 = getelementptr inbounds <4 x float>, <4 x float> addrspace(3)* %tmp33, i32 %tmp32 ; <<4 x float> addrspace(3)*> [#uses=1]
  %tmp35 = load <4 x float>, <4 x float> addrspace(3)* %arrayidx34 ; <<4 x float>> [#uses=1]
  %tmp36 = load <4 x float>, <4 x float>* %myPos               ; <<4 x float>> [#uses=1]
  %sub = fsub <4 x float> %tmp35, %tmp36          ; <<4 x float>> [#uses=1]
  store <4 x float> %sub, <4 x float>* %r
  %tmp38 = load <4 x float>, <4 x float>* %r                   ; <<4 x float>> [#uses=1]
  %tmp39 = extractelement <4 x float> %tmp38, i32 0 ; <float> [#uses=1]
  %tmp40 = load <4 x float>, <4 x float>* %r                   ; <<4 x float>> [#uses=1]
  %tmp41 = extractelement <4 x float> %tmp40, i32 0 ; <float> [#uses=1]
  %mul42 = fmul float %tmp39, %tmp41              ; <float> [#uses=1]
  %tmp43 = load <4 x float>, <4 x float>* %r                   ; <<4 x float>> [#uses=1]
  %tmp44 = extractelement <4 x float> %tmp43, i32 1 ; <float> [#uses=1]
  %tmp45 = load <4 x float>, <4 x float>* %r                   ; <<4 x float>> [#uses=1]
  ...
  %tmp49 = load <4 x float>, <4 x float>* %r                   ; <<4 x float>> [#uses=1]
  %tmp50 = extractelement <4 x float> %tmp49, i32 2 ; <float> [#uses=1]
  %tmp51 = load <4 x float>, <4 x float>* %r                   ; <<4 x float>> [#uses=1]
  ...
  %tmp56 = load float, float* %distSqr                   ; <float> [#uses=1]
  %tmp57 = load float, float* %epsSqr.addr               ; <float> [#uses=1]
  ...
  %tmp64 = load float, float* %invDist                   ; <float> [#uses=1]
  %tmp65 = load float, float* %invDist                   ; <float> [#uses=1]
  %mul66 = fmul float %tmp64, %tmp65              ; <float> [#uses=1]
  %tmp67 = load float, float* %invDist                   ; <float> [#uses=1]
  %mul68 = fmul float %mul66, %tmp67              ; <float> [#uses=1]
  store float %mul68, float* %invDistCube
  %tmp70 = load i32, i32* %j                           ; <i32> [#uses=1]
  %tmp71 = load <4 x float> addrspace(3)*, <4 x float> addrspace(3)** %localPos.addr ; <<4 x float> addrspace(3)*> [#uses=1]
  %arrayidx72 = getelementptr inbounds <4 x float>, <4 x float> addrspace(3)* %tmp71, i32 %tmp70 ; <<4 x float> addrspace(3)*> [#uses=1]
  %tmp73 = load <4 x float>, <4 x float> addrspace(3)* %arrayidx72 ; <<4 x float>> [#uses=1]
  %tmp74 = extractelement <4 x float> %tmp73, i32 3 ; <float> [#uses=1]
  %tmp75 = load float, float* %invDistCube               ; <float> [#uses=1]
  %mul76 = fmul float %tmp74, %tmp75              ; <float> [#uses=1]
  store float %mul76, float* %s
  %tmp77 = load float, float* %s                         ; <float> [#uses=1]
...
for.end87:                                        ; preds = %for.cond
  %tmp89 = load i32, i32* %gid                         ; <i32> [#uses=1]
  %tmp90 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %vel.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp94 = load <4 x float>, <4 x float>* %myPos               ; <<4 x float>> [#uses=1]
  %tmp95 = load <4 x float>, <4 x float>* %oldVel              ; <<4 x float>> [#uses=1]
  %tmp96 = load float, float* %deltaTime.addr            ; <float> [#uses=1]
  ...
  %tmp101 = load <4 x float>, <4 x float>* %acc                ; <<4 x float>> [#uses=1]
  ...
  %tmp103 = load float, float* %deltaTime.addr           ; <float> [#uses=1]
  ...
  %tmp107 = load float, float* %deltaTime.addr           ; <float> [#uses=1]
  ...
  %tmp112 = load <4 x float>, <4 x float>* %myPos              ; <<4 x float>> [#uses=1]
  %tmp113 = extractelement <4 x float> %tmp112, i32 3 ; <float> [#uses=1]
  %tmp114 = load <4 x float>, <4 x float>* %newPos             ; <<4 x float>> [#uses=1]
  %tmp115 = insertelement <4 x float> %tmp114, float %tmp113, i32 3 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp115, <4 x float>* %newPos
  %tmp117 = load <4 x float>, <4 x float>* %oldVel             ; <<4 x float>> [#uses=1]
  %tmp118 = load <4 x float>, <4 x float>* %acc                ; <<4 x float>> [#uses=1]
  %tmp119 = load float, float* %deltaTime.addr           ; <float> [#uses=1]
  ...
  %tmp124 = load <4 x float>, <4 x float>* %newPos             ; <<4 x float>> [#uses=1]
  %tmp125 = load i32, i32* %gid                        ; <i32> [#uses=1]
  %tmp126 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %updatedPos.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx127 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp126, i32 %tmp125 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp124, <4 x float> addrspace(1)* %arrayidx127
  %tmp128 = load <4 x float>, <4 x float>* %newVel             ; <<4 x float>> [#uses=1]
  %tmp129 = load i32, i32* %gid                        ; <i32> [#uses=1]
  %tmp130 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %updatedVel.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx131 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp130, i32 %tmp129 ; <<4 x float> addrspace(1)*> [#uses=1]
...
entry:
  ...
  %tmp = load i32, i32* %body_count.addr               ; <i32> [#uses=1]
  store i32 %tmp, i32* %inner_loop_count
  %tmp2 = load i32, i32* %body_count_per_group.addr    ; <i32> [#uses=1]
  store i32 %tmp2, i32* %outer_loop_count
  %tmp4 = load i32, i32* %index                        ; <i32> [#uses=1]
  %tmp5 = load i32, i32* %outer_loop_count             ; <i32> [#uses=1]
  %mul = mul i32 %tmp4, %tmp5                     ; <i32> [#uses=1]
  %tmp6 = load i32, i32* %start_index.addr             ; <i32> [#uses=1]
  %add = add nsw i32 %mul, %tmp6                  ; <i32> [#uses=1]
  store i32 %add, i32* %start
  %tmp8 = load i32, i32* %index                        ; <i32> [#uses=1]
  %tmp9 = load i32, i32* %body_count_per_group.addr    ; <i32> [#uses=1]
  %mul10 = mul i32 %tmp8, %tmp9                   ; <i32> [#uses=1]
  %tmp11 = load i32, i32* %start_index.addr            ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc212, %entry
  %tmp13 = load i32, i32* %l                           ; <i32> [#uses=1]
  %tmp14 = load i32, i32* %outer_loop_count            ; <i32> [#uses=1]
  %cmp = icmp slt i32 %tmp13, %tmp14              ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end215

for.body:                                         ; preds = %for.cond
  %tmp15 = load i32, i32* %l                           ; <i32> [#uses=1]
  %tmp16 = load i32, i32* %start                       ; <i32> [#uses=1]
  %add17 = add nsw i32 %tmp15, %tmp16             ; <i32> [#uses=1]
  store i32 %add17, i32* %k
  %tmp18 = load i32, i32* %k                           ; <i32> [#uses=1]
  %tmp19 = load float addrspace(1)*, float addrspace(1)** %input_position_x.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %tmp19, i32 %tmp18 ; <float addrspace(1)*> [#uses=1]
  %tmp20 = load float, float addrspace(1)* %arrayidx     ; <float> [#uses=1]
  store float %tmp20, float* %position_x
  %tmp21 = load i32, i32* %k                           ; <i32> [#uses=1]
  %tmp22 = load float addrspace(1)*, float addrspace(1)** %input_position_y.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx23 = getelementptr inbounds float, float addrspace(1)* %tmp22, i32 %tmp21 ; <float addrspace(1)*> [#uses=1]
  %tmp24 = load float, float addrspace(1)* %arrayidx23   ; <float> [#uses=1]
  store float %tmp24, float* %position_y
  %tmp25 = load i32, i32* %k                           ; <i32> [#uses=1]
  %tmp26 = load float addrspace(1)*, float addrspace(1)** %input_position_z.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx27 = getelementptr inbounds float, float addrspace(1)* %tmp26, i32 %tmp25 ; <float addrspace(1)*> [#uses=1]
  %tmp28 = load float, float addrspace(1)* %arrayidx27   ; <float> [#uses=1]
  store float %tmp28, float* %position_z
  %tmp29 = load i32, i32* %k                           ; <i32> [#uses=1]
  %tmp30 = load float addrspace(1)*, float addrspace(1)** %mass.addr   ; <float addrspace(1)*> [#uses=1]
  %arrayidx31 = getelementptr inbounds float, float addrspace(1)* %tmp30, i32 %tmp29 ; <float addrspace(1)*> [#uses=1]
  %tmp32 = load float, float addrspace(1)* %arrayidx31   ; <float> [#uses=1]
  store float %tmp32, float* %m
  %tmp34 = load float, float* %zero                      ; <float> [#uses=1]
  store float %tmp34, float* %final_ax
  %tmp36 = load float, float* %zero                      ; <float> [#uses=1]
  store float %tmp36, float* %final_ay
  %tmp38 = load float, float* %zero                      ; <float> [#uses=1]
  store float %tmp38, float* %final_az
  %tmp39 = load float, float* %position_x                ; <float> [#uses=1]
  store float %tmp39, float* %current_x1
  %tmp40 = load float, float* %position_y                ; <float> [#uses=1]
  store float %tmp40, float* %current_y1
  %tmp41 = load float, float* %position_z                ; <float> [#uses=1]
  store float %tmp41, float* %current_z1
  %tmp42 = load float, float* %m                         ; <float> [#uses=1]
  store float %tmp42, float* %current_mass1
  %tmp44 = load float, float* %zero                      ; <float> [#uses=1]
  store float %tmp44, float* %acceleration_x1
  %tmp46 = load float, float* %zero                      ; <float> [#uses=1]
  store float %tmp46, float* %acceleration_y1
  %tmp48 = load float, float* %zero                      ; <float> [#uses=1]
...
for.cond49:                                       ; preds = %for.inc, %for.body
  ...
  %tmp51 = load i32, i32* %inner_loop_count            ; <i32> [#uses=1]
...
for.body53:                                       ; preds = %for.cond49
  ...
  %tmp56 = load float addrspace(1)*, float addrspace(1)** %input_position_x.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx57 = getelementptr inbounds float, float addrspace(1)* %tmp56, i32 %tmp55 ; <float addrspace(1)*> [#uses=1]
  %tmp58 = load float, float addrspace(1)* %arrayidx57   ; <float> [#uses=1]
  %tmp59 = load float, float* %current_x1                ; <float> [#uses=1]
  %sub = fsub float %tmp58, %tmp59                ; <float> [#uses=1]
  store float %sub, float* %dx
  %tmp61 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp62 = load float addrspace(1)*, float addrspace(1)** %input_position_y.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx63 = getelementptr inbounds float, float addrspace(1)* %tmp62, i32 %tmp61 ; <float addrspace(1)*> [#uses=1]
  %tmp64 = load float, float addrspace(1)* %arrayidx63   ; <float> [#uses=1]
  %tmp65 = load float, float* %current_y1                ; <float> [#uses=1]
  %sub66 = fsub float %tmp64, %tmp65              ; <float> [#uses=1]
  store float %sub66, float* %dy
  %tmp68 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp69 = load float addrspace(1)*, float addrspace(1)** %input_position_z.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx70 = getelementptr inbounds float, float addrspace(1)* %tmp69, i32 %tmp68 ; <float addrspace(1)*> [#uses=1]
  %tmp71 = load float, float addrspace(1)* %arrayidx70   ; <float> [#uses=1]
  %tmp72 = load float, float* %current_z1                ; <float> [#uses=1]
  %sub73 = fsub float %tmp71, %tmp72              ; <float> [#uses=1]
  store float %sub73, float* %dz
  %tmp75 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp76 = load float addrspace(1)*, float addrspace(1)** %mass.addr   ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp80 = load float, float* %dx                        ; <float> [#uses=1]
  %tmp81 = load float, float* %dx                        ; <float> [#uses=1]
  %mul82 = fmul float %tmp80, %tmp81              ; <float> [#uses=1]
  %tmp83 = load float, float* %dy                        ; <float> [#uses=1]
  %tmp84 = load float, float* %dy                        ; <float> [#uses=1]
  %mul85 = fmul float %tmp83, %tmp84              ; <float> [#uses=1]
  %add86 = fadd float %mul82, %mul85              ; <float> [#uses=1]
  %tmp87 = load float, float* %dz                        ; <float> [#uses=1]
  %tmp88 = load float, float* %dz                        ; <float> [#uses=1]
  ...
  %tmp91 = load float, float* %softening_squared.addr    ; <float> [#uses=1]
  %tmp92 = load float, float* %distance_squared          ; <float> [#uses=1]
  %add93 = fadd float %tmp92, %tmp91              ; <float> [#uses=1]
  store float %add93, float* %distance_squared
  %tmp95 = load float, float* %distance_squared          ; <float> [#uses=1]
  %call96 = call float @_Z12native_rsqrtf(float %tmp95) ; <float> [#uses=1]
  store float %call96, float* %inverse_distance
  %tmp98 = load float, float* %mi                        ; <float> [#uses=1]
  %tmp99 = load float, float* %inverse_distance          ; <float> [#uses=1]
  %mul100 = fmul float %tmp98, %tmp99             ; <float> [#uses=1]
  %tmp101 = load float, float* %inverse_distance         ; <float> [#uses=1]
  %tmp102 = load float, float* %inverse_distance         ; <float> [#uses=1]
  %mul103 = fmul float %tmp101, %tmp102           ; <float> [#uses=1]
  %mul104 = fmul float %mul100, %mul103           ; <float> [#uses=1]
  store float %mul104, float* %s
  %tmp105 = load float, float* %dx                       ; <float> [#uses=1]
  %tmp106 = load float, float* %s                        ; <float> [#uses=1]
  %mul107 = fmul float %tmp105, %tmp106           ; <float> [#uses=1]
  %tmp108 = load float, float* %acceleration_x1          ; <float> [#uses=1]
  %add109 = fadd float %tmp108, %mul107           ; <float> [#uses=1]
  store float %add109, float* %acceleration_x1
  %tmp110 = load float, float* %dy                       ; <float> [#uses=1]
  %tmp111 = load float, float* %s                        ; <float> [#uses=1]
  %mul112 = fmul float %tmp110, %tmp111           ; <float> [#uses=1]
  %tmp113 = load float, float* %acceleration_y1          ; <float> [#uses=1]
  %add114 = fadd float %tmp113, %mul112           ; <float> [#uses=1]
  store float %add114, float* %acceleration_y1
  %tmp115 = load float, float* %dz                       ; <float> [#uses=1]
  %tmp116 = load float, float* %s                        ; <float> [#uses=1]
  %mul117 = fmul float %tmp115, %tmp116           ; <float> [#uses=1]
  %tmp118 = load float, float* %acceleration_z1          ; <float> [#uses=1]
...
for.end:                                          ; preds = %for.cond49
  %tmp121 = load float, float* %acceleration_x1          ; <float> [#uses=1]
  store float %tmp121, float* %final_ax
  %tmp122 = load float, float* %acceleration_y1          ; <float> [#uses=1]
  store float %tmp122, float* %final_ay
  %tmp123 = load float, float* %acceleration_z1          ; <float> [#uses=1]
  store float %tmp123, float* %final_az
  %tmp124 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp125 = load float addrspace(1)*, float addrspace(1)** %input_velocity_x.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx126 = getelementptr inbounds float, float addrspace(1)* %tmp125, i32 %tmp124 ; <float addrspace(1)*> [#uses=1]
  %tmp127 = load float, float addrspace(1)* %arrayidx126 ; <float> [#uses=1]
  store float %tmp127, float* %velocity_x
  %tmp128 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp129 = load float addrspace(1)*, float addrspace(1)** %input_velocity_y.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx130 = getelementptr inbounds float, float addrspace(1)* %tmp129, i32 %tmp128 ; <float addrspace(1)*> [#uses=1]
  %tmp131 = load float, float addrspace(1)* %arrayidx130 ; <float> [#uses=1]
  store float %tmp131, float* %velocity_y
  %tmp132 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp133 = load float addrspace(1)*, float addrspace(1)** %input_velocity_z.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx134 = getelementptr inbounds float, float addrspace(1)* %tmp133, i32 %tmp132 ; <float addrspace(1)*> [#uses=1]
  %tmp135 = load float, float addrspace(1)* %arrayidx134 ; <float> [#uses=1]
  store float %tmp135, float* %velocity_z
  %tmp136 = load float, float* %final_ax                 ; <float> [#uses=1]
  %tmp137 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  %mul138 = fmul float %tmp136, %tmp137           ; <float> [#uses=1]
  %tmp139 = load float, float* %velocity_x               ; <float> [#uses=1]
  %add140 = fadd float %tmp139, %mul138           ; <float> [#uses=1]
  store float %add140, float* %velocity_x
  %tmp141 = load float, float* %final_ay                 ; <float> [#uses=1]
  %tmp142 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  %mul143 = fmul float %tmp141, %tmp142           ; <float> [#uses=1]
  %tmp144 = load float, float* %velocity_y               ; <float> [#uses=1]
  %add145 = fadd float %tmp144, %mul143           ; <float> [#uses=1]
  store float %add145, float* %velocity_y
  %tmp146 = load float, float* %final_az                 ; <float> [#uses=1]
  %tmp147 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  %mul148 = fmul float %tmp146, %tmp147           ; <float> [#uses=1]
  %tmp149 = load float, float* %velocity_z               ; <float> [#uses=1]
  %add150 = fadd float %tmp149, %mul148           ; <float> [#uses=1]
  store float %add150, float* %velocity_z
  %tmp151 = load float, float* %damping.addr             ; <float> [#uses=1]
  %tmp152 = load float, float* %velocity_x               ; <float> [#uses=1]
  %mul153 = fmul float %tmp152, %tmp151           ; <float> [#uses=1]
  store float %mul153, float* %velocity_x
  %tmp154 = load float, float* %damping.addr             ; <float> [#uses=1]
  %tmp155 = load float, float* %velocity_y               ; <float> [#uses=1]
  %mul156 = fmul float %tmp155, %tmp154           ; <float> [#uses=1]
  store float %mul156, float* %velocity_y
  %tmp157 = load float, float* %damping.addr             ; <float> [#uses=1]
  %tmp158 = load float, float* %velocity_z               ; <float> [#uses=1]
  %mul159 = fmul float %tmp158, %tmp157           ; <float> [#uses=1]
  store float %mul159, float* %velocity_z
  %tmp160 = load float, float* %velocity_x               ; <float> [#uses=1]
  %tmp161 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  %mul162 = fmul float %tmp160, %tmp161           ; <float> [#uses=1]
  %tmp163 = load float, float* %position_x               ; <float> [#uses=1]
  %add164 = fadd float %tmp163, %mul162           ; <float> [#uses=1]
  store float %add164, float* %position_x
  %tmp165 = load float, float* %velocity_y               ; <float> [#uses=1]
  %tmp166 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  %mul167 = fmul float %tmp165, %tmp166           ; <float> [#uses=1]
  %tmp168 = load float, float* %position_y               ; <float> [#uses=1]
  %add169 = fadd float %tmp168, %mul167           ; <float> [#uses=1]
  store float %add169, float* %position_y
  %tmp170 = load float, float* %velocity_z               ; <float> [#uses=1]
  %tmp171 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  %mul172 = fmul float %tmp170, %tmp171           ; <float> [#uses=1]
  %tmp173 = load float, float* %position_z               ; <float> [#uses=1]
  %add174 = fadd float %tmp173, %mul172           ; <float> [#uses=1]
  store float %add174, float* %position_z
  %tmp175 = load float, float* %position_x               ; <float> [#uses=1]
  %tmp176 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp177 = load float addrspace(1)*, float addrspace(1)** %output_position_x.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx178 = getelementptr inbounds float, float addrspace(1)* %tmp177, i32 %tmp176 ; <float addrspace(1)*> [#uses=1]
  store float %tmp175, float addrspace(1)* %arrayidx178
  %tmp179 = load float, float* %position_y               ; <float> [#uses=1]
  %tmp180 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp181 = load float addrspace(1)*, float addrspace(1)** %output_position_y.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx182 = getelementptr inbounds float, float addrspace(1)* %tmp181, i32 %tmp180 ; <float addrspace(1)*> [#uses=1]
  store float %tmp179, float addrspace(1)* %arrayidx182
  %tmp183 = load float, float* %position_z               ; <float> [#uses=1]
  %tmp184 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp185 = load float addrspace(1)*, float addrspace(1)** %output_position_z.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx186 = getelementptr inbounds float, float addrspace(1)* %tmp185, i32 %tmp184 ; <float addrspace(1)*> [#uses=1]
  store float %tmp183, float addrspace(1)* %arrayidx186
  %tmp187 = load float, float* %velocity_x               ; <float> [#uses=1]
  %tmp188 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp189 = load float addrspace(1)*, float addrspace(1)** %output_velocity_x.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx190 = getelementptr inbounds float, float addrspace(1)* %tmp189, i32 %tmp188 ; <float addrspace(1)*> [#uses=1]
  store float %tmp187, float addrspace(1)* %arrayidx190
  %tmp191 = load float, float* %velocity_y               ; <float> [#uses=1]
  %tmp192 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp193 = load float addrspace(1)*, float addrspace(1)** %output_velocity_y.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx194 = getelementptr inbounds float, float addrspace(1)* %tmp193, i32 %tmp192 ; <float addrspace(1)*> [#uses=1]
  store float %tmp191, float addrspace(1)* %arrayidx194
  %tmp195 = load float, float* %velocity_z               ; <float> [#uses=1]
  %tmp196 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp197 = load float addrspace(1)*, float addrspace(1)** %output_velocity_z.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx198 = getelementptr inbounds float, float addrspace(1)* %tmp197, i32 %tmp196 ; <float addrspace(1)*> [#uses=1]
  store float %tmp195, float addrspace(1)* %arrayidx198
  %tmp199 = load float, float* %position_x               ; <float> [#uses=1]
  %vecinit = insertelement <4 x float> undef, float %tmp199, i32 0 ; <<4 x float>> [#uses=1]
  %tmp200 = load float, float* %position_y               ; <float> [#uses=1]
  %vecinit201 = insertelement <4 x float> %vecinit, float %tmp200, i32 1 ; <<4 x float>> [#uses=1]
  %tmp202 = load float, float* %position_z               ; <float> [#uses=1]
  %vecinit203 = insertelement <4 x float> %vecinit201, float %tmp202, i32 2 ; <<4 x float>> [#uses=1]
  %tmp204 = load float, float* %m                        ; <float> [#uses=1]
  ...
  %tmp206 = load <4 x float>, <4 x float>* %.compoundliteral   ; <<4 x float>> [#uses=1]
  %tmp207 = load i32, i32* %l                          ; <i32> [#uses=1]
  %tmp208 = load i32, i32* %offset                     ; <i32> [#uses=1]
  %add209 = add nsw i32 %tmp207, %tmp208          ; <i32> [#uses=1]
  %tmp210 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_position.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx211 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp210, i32 %add209 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp206, <4 x float> addrspace(1)* %arrayidx211
  br label %for.inc212

for.inc212:                                       ; preds = %for.end
  %tmp213 = load i32, i32* %l                          ; <i32> [#uses=1]
...
entry:
  ...
  %tmp6 = load i32, i32* %body_count.addr              ; <i32> [#uses=1]
  %shr = ashr i32 %tmp6, 2                        ; <i32> [#uses=1]
  store i32 %shr, i32* %inner_loop_count
  %tmp8 = load i32, i32* %body_count_per_group.addr    ; <i32> [#uses=1]
  %shr9 = ashr i32 %tmp8, 2                       ; <i32> [#uses=1]
  store i32 %shr9, i32* %outer_loop_count
  %tmp11 = load i32, i32* %index                       ; <i32> [#uses=1]
  %tmp12 = load i32, i32* %outer_loop_count            ; <i32> [#uses=1]
  %mul = mul i32 %tmp11, %tmp12                   ; <i32> [#uses=1]
  %tmp13 = load i32, i32* %start_index.addr            ; <i32> [#uses=1]
  %shr14 = ashr i32 %tmp13, 2                     ; <i32> [#uses=1]
  %add = add nsw i32 %mul, %shr14                 ; <i32> [#uses=1]
  store i32 %add, i32* %start
  %tmp16 = load i32, i32* %index                       ; <i32> [#uses=1]
  %tmp17 = load i32, i32* %body_count_per_group.addr   ; <i32> [#uses=1]
  %mul18 = mul i32 %tmp16, %tmp17                 ; <i32> [#uses=1]
  %tmp19 = load i32, i32* %start_index.addr            ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc695, %entry
  %tmp21 = load i32, i32* %l                           ; <i32> [#uses=1]
  %tmp22 = load i32, i32* %outer_loop_count            ; <i32> [#uses=1]
  %cmp = icmp slt i32 %tmp21, %tmp22              ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end698

for.body:                                         ; preds = %for.cond
  %tmp23 = load i32, i32* %l                           ; <i32> [#uses=1]
  %tmp24 = load i32, i32* %start                       ; <i32> [#uses=1]
  %add25 = add nsw i32 %tmp23, %tmp24             ; <i32> [#uses=1]
  store i32 %add25, i32* %k
  %tmp26 = load i32, i32* %k                           ; <i32> [#uses=1]
  %tmp27 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_x.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp29 = load i32, i32* %k                           ; <i32> [#uses=1]
  %tmp30 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_y.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx31 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp30, i32 %tmp29 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp32 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx31 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp32, <4 x float>* %position_y
  %tmp33 = load i32, i32* %k                           ; <i32> [#uses=1]
  %tmp34 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_z.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx35 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp34, i32 %tmp33 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp36 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx35 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp36, <4 x float>* %position_z
  %tmp37 = load i32, i32* %k                           ; <i32> [#uses=1]
  %tmp38 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %mass.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx39 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp38, i32 %tmp37 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp40 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx39 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp40, <4 x float>* %m
  %tmp42 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp42, <4 x float>* %final_ax
  %tmp44 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp44, <4 x float>* %final_ay
  %tmp46 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp46, <4 x float>* %final_az
  %tmp47 = load <4 x float>, <4 x float>* %position_x          ; <<4 x float>> [#uses=1]
  ...
  %tmp49 = load <4 x float>, <4 x float>* %position_y          ; <<4 x float>> [#uses=1]
  ...
  %tmp51 = load <4 x float>, <4 x float>* %position_z          ; <<4 x float>> [#uses=1]
  ...
  %tmp53 = load <4 x float>, <4 x float>* %m                   ; <<4 x float>> [#uses=1]
  ...
  %tmp55 = load <4 x float>, <4 x float>* %position_x          ; <<4 x float>> [#uses=1]
  ...
  %tmp57 = load <4 x float>, <4 x float>* %position_y          ; <<4 x float>> [#uses=1]
  ...
  %tmp59 = load <4 x float>, <4 x float>* %position_z          ; <<4 x float>> [#uses=1]
  ...
  %tmp61 = load <4 x float>, <4 x float>* %m                   ; <<4 x float>> [#uses=1]
  ...
  %tmp64 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp64, <4 x float>* %acceleration_x1
  %tmp66 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp66, <4 x float>* %acceleration_y1
  %tmp68 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
  ...
  %tmp72 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp72, <4 x float>* %acceleration_y2
  %tmp74 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
...
for.cond75:                                       ; preds = %for.inc, %for.body
  ...
  %tmp77 = load i32, i32* %inner_loop_count            ; <i32> [#uses=1]
...
for.body79:                                       ; preds = %for.cond75
  ...
  %tmp82 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_x.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx83 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp82, i32 %tmp81 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp84 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx83 ; <<4 x float>> [#uses=1]
  %tmp85 = load <4 x float>, <4 x float>* %current_x1          ; <<4 x float>> [#uses=1]
  %sub = fsub <4 x float> %tmp84, %tmp85          ; <<4 x float>> [#uses=1]
  store <4 x float> %sub, <4 x float>* %dx
  %tmp87 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp88 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_y.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx89 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp88, i32 %tmp87 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp90 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx89 ; <<4 x float>> [#uses=1]
  %tmp91 = load <4 x float>, <4 x float>* %current_y1          ; <<4 x float>> [#uses=1]
  %sub92 = fsub <4 x float> %tmp90, %tmp91        ; <<4 x float>> [#uses=1]
  store <4 x float> %sub92, <4 x float>* %dy
  %tmp94 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp95 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_z.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx96 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp95, i32 %tmp94 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp97 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx96 ; <<4 x float>> [#uses=1]
  %tmp98 = load <4 x float>, <4 x float>* %current_z1          ; <<4 x float>> [#uses=1]
  %sub99 = fsub <4 x float> %tmp97, %tmp98        ; <<4 x float>> [#uses=1]
  store <4 x float> %sub99, <4 x float>* %dz
  %tmp101 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp102 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %mass.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp106 = load <4 x float>, <4 x float>* %dx                 ; <<4 x float>> [#uses=1]
  %tmp107 = load <4 x float>, <4 x float>* %dx                 ; <<4 x float>> [#uses=1]
  %mul108 = fmul <4 x float> %tmp106, %tmp107     ; <<4 x float>> [#uses=1]
  %tmp109 = load <4 x float>, <4 x float>* %dy                 ; <<4 x float>> [#uses=1]
  %tmp110 = load <4 x float>, <4 x float>* %dy                 ; <<4 x float>> [#uses=1]
  %mul111 = fmul <4 x float> %tmp109, %tmp110     ; <<4 x float>> [#uses=1]
  %add112 = fadd <4 x float> %mul108, %mul111     ; <<4 x float>> [#uses=1]
  %tmp113 = load <4 x float>, <4 x float>* %dz                 ; <<4 x float>> [#uses=1]
  %tmp114 = load <4 x float>, <4 x float>* %dz                 ; <<4 x float>> [#uses=1]
  ...
  %tmp117 = load float, float* %softening_squared.addr   ; <float> [#uses=1]
  ...
  %tmp119 = load <4 x float>, <4 x float>* %distance_squared   ; <<4 x float>> [#uses=1]
  %add120 = fadd <4 x float> %tmp119, %splat      ; <<4 x float>> [#uses=1]
  store <4 x float> %add120, <4 x float>* %distance_squared
  %tmp122 = load <4 x float>, <4 x float>* %distance_squared   ; <<4 x float>> [#uses=1]
  %call123 = call <4 x float> @_Z12native_rsqrtU8__vector4f(<4 x float> %tmp122) ; <<4 x float>> [#uses=1]
  store <4 x float> %call123, <4 x float>* %inverse_distance
  %tmp125 = load <4 x float>, <4 x float>* %mi                 ; <<4 x float>> [#uses=1]
  %tmp126 = load <4 x float>, <4 x float>* %inverse_distance   ; <<4 x float>> [#uses=1]
  %mul127 = fmul <4 x float> %tmp125, %tmp126     ; <<4 x float>> [#uses=1]
  %tmp128 = load <4 x float>, <4 x float>* %inverse_distance   ; <<4 x float>> [#uses=1]
  %tmp129 = load <4 x float>, <4 x float>* %inverse_distance   ; <<4 x float>> [#uses=1]
  ...
  %tmp132 = load <4 x float>, <4 x float>* %dx                 ; <<4 x float>> [#uses=1]
  %tmp133 = load <4 x float>, <4 x float>* %s                  ; <<4 x float>> [#uses=1]
  %mul134 = fmul <4 x float> %tmp132, %tmp133     ; <<4 x float>> [#uses=1]
  %tmp135 = load <4 x float>, <4 x float>* %acceleration_x1    ; <<4 x float>> [#uses=1]
  %add136 = fadd <4 x float> %tmp135, %mul134     ; <<4 x float>> [#uses=1]
  store <4 x float> %add136, <4 x float>* %acceleration_x1
  %tmp137 = load <4 x float>, <4 x float>* %dy                 ; <<4 x float>> [#uses=1]
  %tmp138 = load <4 x float>, <4 x float>* %s                  ; <<4 x float>> [#uses=1]
  %mul139 = fmul <4 x float> %tmp137, %tmp138     ; <<4 x float>> [#uses=1]
  %tmp140 = load <4 x float>, <4 x float>* %acceleration_y1    ; <<4 x float>> [#uses=1]
  %add141 = fadd <4 x float> %tmp140, %mul139     ; <<4 x float>> [#uses=1]
  store <4 x float> %add141, <4 x float>* %acceleration_y1
  %tmp142 = load <4 x float>, <4 x float>* %dz                 ; <<4 x float>> [#uses=1]
  %tmp143 = load <4 x float>, <4 x float>* %s                  ; <<4 x float>> [#uses=1]
  %mul144 = fmul <4 x float> %tmp142, %tmp143     ; <<4 x float>> [#uses=1]
  %tmp145 = load <4 x float>, <4 x float>* %acceleration_z1    ; <<4 x float>> [#uses=1]
  ...
  %tmp148 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_x.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx149 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp148, i32 %tmp147 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp150 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx149 ; <<4 x float>> [#uses=1]
  %tmp151 = load <4 x float>, <4 x float>* %current_x2         ; <<4 x float>> [#uses=1]
  %sub152 = fsub <4 x float> %tmp150, %tmp151     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub152, <4 x float>* %dx
  %tmp153 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp154 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_y.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx155 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp154, i32 %tmp153 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp156 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx155 ; <<4 x float>> [#uses=1]
  %tmp157 = load <4 x float>, <4 x float>* %current_y2         ; <<4 x float>> [#uses=1]
  %sub158 = fsub <4 x float> %tmp156, %tmp157     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub158, <4 x float>* %dy
  %tmp159 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp160 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_z.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx161 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp160, i32 %tmp159 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp162 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx161 ; <<4 x float>> [#uses=1]
  %tmp163 = load <4 x float>, <4 x float>* %current_z2         ; <<4 x float>> [#uses=1]
  %sub164 = fsub <4 x float> %tmp162, %tmp163     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub164, <4 x float>* %dz
  %tmp165 = load <4 x float>, <4 x float>* %dx                 ; <<4 x float>> [#uses=1]
  %tmp166 = load <4 x float>, <4 x float>* %dx                 ; <<4 x float>> [#uses=1]
  %mul167 = fmul <4 x float> %tmp165, %tmp166     ; <<4 x float>> [#uses=1]
  %tmp168 = load <4 x float>, <4 x float>* %dy                 ; <<4 x float>> [#uses=1]
  %tmp169 = load <4 x float>, <4 x float>* %dy                 ; <<4 x float>> [#uses=1]
  %mul170 = fmul <4 x float> %tmp168, %tmp169     ; <<4 x float>> [#uses=1]
  %add171 = fadd <4 x float> %mul167, %mul170     ; <<4 x float>> [#uses=1]
  %tmp172 = load <4 x float>, <4 x float>* %dz                 ; <<4 x float>> [#uses=1]
  %tmp173 = load <4 x float>, <4 x float>* %dz                 ; <<4 x float>> [#uses=1]
  ...
  %tmp176 = load float, float* %softening_squared.addr   ; <float> [#uses=1]
  ...
  %tmp179 = load <4 x float>, <4 x float>* %distance_squared   ; <<4 x float>> [#uses=1]
  %add180 = fadd <4 x float> %tmp179, %splat178   ; <<4 x float>> [#uses=1]
  store <4 x float> %add180, <4 x float>* %distance_squared
  %tmp181 = load <4 x float>, <4 x float>* %distance_squared   ; <<4 x float>> [#uses=1]
  %call182 = call <4 x float> @_Z12native_rsqrtU8__vector4f(<4 x float> %tmp181) ; <<4 x float>> [#uses=1]
  store <4 x float> %call182, <4 x float>* %inverse_distance
  %tmp183 = load <4 x float>, <4 x float>* %mi                 ; <<4 x float>> [#uses=1]
  %tmp184 = load <4 x float>, <4 x float>* %inverse_distance   ; <<4 x float>> [#uses=1]
  %mul185 = fmul <4 x float> %tmp183, %tmp184     ; <<4 x float>> [#uses=1]
  %tmp186 = load <4 x float>, <4 x float>* %inverse_distance   ; <<4 x float>> [#uses=1]
  %tmp187 = load <4 x float>, <4 x float>* %inverse_distance   ; <<4 x float>> [#uses=1]
  ...
  %tmp190 = load <4 x float>, <4 x float>* %dx                 ; <<4 x float>> [#uses=1]
  %tmp191 = load <4 x float>, <4 x float>* %s                  ; <<4 x float>> [#uses=1]
  %mul192 = fmul <4 x float> %tmp190, %tmp191     ; <<4 x float>> [#uses=1]
  %tmp193 = load <4 x float>, <4 x float>* %acceleration_x2    ; <<4 x float>> [#uses=1]
  %add194 = fadd <4 x float> %tmp193, %mul192     ; <<4 x float>> [#uses=1]
  store <4 x float> %add194, <4 x float>* %acceleration_x2
  %tmp195 = load <4 x float>, <4 x float>* %dy                 ; <<4 x float>> [#uses=1]
  %tmp196 = load <4 x float>, <4 x float>* %s                  ; <<4 x float>> [#uses=1]
  %mul197 = fmul <4 x float> %tmp195, %tmp196     ; <<4 x float>> [#uses=1]
  %tmp198 = load <4 x float>, <4 x float>* %acceleration_y2    ; <<4 x float>> [#uses=1]
  %add199 = fadd <4 x float> %tmp198, %mul197     ; <<4 x float>> [#uses=1]
  store <4 x float> %add199, <4 x float>* %acceleration_y2
  %tmp200 = load <4 x float>, <4 x float>* %dz                 ; <<4 x float>> [#uses=1]
  %tmp201 = load <4 x float>, <4 x float>* %s                  ; <<4 x float>> [#uses=1]
  %mul202 = fmul <4 x float> %tmp200, %tmp201     ; <<4 x float>> [#uses=1]
  %tmp203 = load <4 x float>, <4 x float>* %acceleration_z2    ; <<4 x float>> [#uses=1]
...
for.end:                                          ; preds = %for.cond75
  ...
  %tmp286 = load <4 x float>, <4 x float>* %position_y         ; <<4 x float>> [#uses=1]
  ...
  %tmp288 = load <4 x float>, <4 x float>* %position_z         ; <<4 x float>> [#uses=1]
  ...
  %tmp290 = load <4 x float>, <4 x float>* %m                  ; <<4 x float>> [#uses=1]
  ...
  %tmp292 = load <4 x float>, <4 x float>* %position_x         ; <<4 x float>> [#uses=1]
  ...
  %tmp294 = load <4 x float>, <4 x float>* %position_y         ; <<4 x float>> [#uses=1]
  ...
  %tmp296 = load <4 x float>, <4 x float>* %position_z         ; <<4 x float>> [#uses=1]
  ...
  %tmp298 = load <4 x float>, <4 x float>* %m                  ; <<4 x float>> [#uses=1]
  ...
  %tmp300 = load <4 x float>, <4 x float>* %zero               ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp300, <4 x float>* %acceleration_x1
  %tmp301 = load <4 x float>, <4 x float>* %zero               ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp301, <4 x float>* %acceleration_y1
  %tmp302 = load <4 x float>, <4 x float>* %zero               ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp302, <4 x float>* %acceleration_z1
  %tmp303 = load <4 x float>, <4 x float>* %zero               ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp303, <4 x float>* %acceleration_x2
  %tmp304 = load <4 x float>, <4 x float>* %zero               ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp304, <4 x float>* %acceleration_y2
  %tmp305 = load <4 x float>, <4 x float>* %zero               ; <<4 x float>> [#uses=1]
...
for.cond306:                                      ; preds = %for.inc445, %for.end
  ...
  %tmp308 = load i32, i32* %inner_loop_count           ; <i32> [#uses=1]
  %cmp309 = icmp slt i32 %tmp307, %tmp308         ; <i1> [#uses=1]
  br i1 %cmp309, label %for.body310, label %for.end448

for.body310:                                      ; preds = %for.cond306
  %tmp313 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp314 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_x.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx315 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp314, i32 %tmp313 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp316 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx315 ; <<4 x float>> [#uses=1]
  %tmp317 = load <4 x float>, <4 x float>* %current_x1         ; <<4 x float>> [#uses=1]
  %sub318 = fsub <4 x float> %tmp316, %tmp317     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub318, <4 x float>* %dx312
  %tmp321 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp322 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_y.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx323 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp322, i32 %tmp321 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp324 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx323 ; <<4 x float>> [#uses=1]
  %tmp325 = load <4 x float>, <4 x float>* %current_y1         ; <<4 x float>> [#uses=1]
  %sub326 = fsub <4 x float> %tmp324, %tmp325     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub326, <4 x float>* %dy320
  %tmp329 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp330 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_z.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp333 = load <4 x float>, <4 x float>* %current_z1         ; <<4 x float>> [#uses=1]
  %sub334 = fsub <4 x float> %tmp332, %tmp333     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub334, <4 x float>* %dz328
  %tmp337 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp338 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %mass.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx339 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp338, i32 %tmp337 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp340 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx339 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp340, <4 x float>* %mi336
  %tmp343 = load <4 x float>, <4 x float>* %dx312              ; <<4 x float>> [#uses=1]
  %tmp344 = load <4 x float>, <4 x float>* %dx312              ; <<4 x float>> [#uses=1]
  %mul345 = fmul <4 x float> %tmp343, %tmp344     ; <<4 x float>> [#uses=1]
  %tmp346 = load <4 x float>, <4 x float>* %dy320              ; <<4 x float>> [#uses=1]
  %tmp347 = load <4 x float>, <4 x float>* %dy320              ; <<4 x float>> [#uses=1]
  %mul348 = fmul <4 x float> %tmp346, %tmp347     ; <<4 x float>> [#uses=1]
  %add349 = fadd <4 x float> %mul345, %mul348     ; <<4 x float>> [#uses=1]
  %tmp350 = load <4 x float>, <4 x float>* %dz328              ; <<4 x float>> [#uses=1]
  %tmp351 = load <4 x float>, <4 x float>* %dz328              ; <<4 x float>> [#uses=1]
  ...
  %tmp354 = load float, float* %softening_squared.addr   ; <float> [#uses=1]
  ...
  %tmp357 = load <4 x float>, <4 x float>* %distance_squared342 ; <<4 x float>> [#uses=1]
  %add358 = fadd <4 x float> %tmp357, %splat356   ; <<4 x float>> [#uses=1]
  store <4 x float> %add358, <4 x float>* %distance_squared342
  %tmp361 = load <4 x float>, <4 x float>* %distance_squared342 ; <<4 x float>> [#uses=1]
  %call362 = call <4 x float> @_Z12native_rsqrtU8__vector4f(<4 x float> %tmp361) ; <<4 x float>> [#uses=1]
  store <4 x float> %call362, <4 x float>* %inverse_distance360
  %tmp365 = load <4 x float>, <4 x float>* %mi336              ; <<4 x float>> [#uses=1]
  %tmp366 = load <4 x float>, <4 x float>* %inverse_distance360 ; <<4 x float>> [#uses=1]
  %mul367 = fmul <4 x float> %tmp365, %tmp366     ; <<4 x float>> [#uses=1]
  %tmp368 = load <4 x float>, <4 x float>* %inverse_distance360 ; <<4 x float>> [#uses=1]
  %tmp369 = load <4 x float>, <4 x float>* %inverse_distance360 ; <<4 x float>> [#uses=1]
  ...
  %tmp372 = load <4 x float>, <4 x float>* %dx312              ; <<4 x float>> [#uses=1]
  %tmp373 = load <4 x float>, <4 x float>* %s364               ; <<4 x float>> [#uses=1]
  %mul374 = fmul <4 x float> %tmp372, %tmp373     ; <<4 x float>> [#uses=1]
  %tmp375 = load <4 x float>, <4 x float>* %acceleration_x1    ; <<4 x float>> [#uses=1]
  %add376 = fadd <4 x float> %tmp375, %mul374     ; <<4 x float>> [#uses=1]
  store <4 x float> %add376, <4 x float>* %acceleration_x1
  %tmp377 = load <4 x float>, <4 x float>* %dy320              ; <<4 x float>> [#uses=1]
  %tmp378 = load <4 x float>, <4 x float>* %s364               ; <<4 x float>> [#uses=1]
  %mul379 = fmul <4 x float> %tmp377, %tmp378     ; <<4 x float>> [#uses=1]
  %tmp380 = load <4 x float>, <4 x float>* %acceleration_y1    ; <<4 x float>> [#uses=1]
  %add381 = fadd <4 x float> %tmp380, %mul379     ; <<4 x float>> [#uses=1]
  store <4 x float> %add381, <4 x float>* %acceleration_y1
  %tmp382 = load <4 x float>, <4 x float>* %dz328              ; <<4 x float>> [#uses=1]
  %tmp383 = load <4 x float>, <4 x float>* %s364               ; <<4 x float>> [#uses=1]
  %mul384 = fmul <4 x float> %tmp382, %tmp383     ; <<4 x float>> [#uses=1]
  %tmp385 = load <4 x float>, <4 x float>* %acceleration_z1    ; <<4 x float>> [#uses=1]
  %add386 = fadd <4 x float> %tmp385, %mul384     ; <<4 x float>> [#uses=1]
  store <4 x float> %add386, <4 x float>* %acceleration_z1
  %tmp387 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp388 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_x.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx389 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp388, i32 %tmp387 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp390 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx389 ; <<4 x float>> [#uses=1]
  %tmp391 = load <4 x float>, <4 x float>* %current_x2         ; <<4 x float>> [#uses=1]
  %sub392 = fsub <4 x float> %tmp390, %tmp391     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub392, <4 x float>* %dx312
  %tmp393 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp394 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_y.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx395 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp394, i32 %tmp393 ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp396 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx395 ; <<4 x float>> [#uses=1]
  %tmp397 = load <4 x float>, <4 x float>* %current_y2         ; <<4 x float>> [#uses=1]
  ...
  %tmp400 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %input_position_z.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp403 = load <4 x float>, <4 x float>* %current_z2         ; <<4 x float>> [#uses=1]
  %sub404 = fsub <4 x float> %tmp402, %tmp403     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub404, <4 x float>* %dz328
  %tmp405 = load <4 x float>, <4 x float>* %dx312              ; <<4 x float>> [#uses=1]
  %tmp406 = load <4 x float>, <4 x float>* %dx312              ; <<4 x float>> [#uses=1]
  %mul407 = fmul <4 x float> %tmp405, %tmp406     ; <<4 x float>> [#uses=1]
  %tmp408 = load <4 x float>, <4 x float>* %dy320              ; <<4 x float>> [#uses=1]
  %tmp409 = load <4 x float>, <4 x float>* %dy320              ; <<4 x float>> [#uses=1]
  %mul410 = fmul <4 x float> %tmp408, %tmp409     ; <<4 x float>> [#uses=1]
  %add411 = fadd <4 x float> %mul407, %mul410     ; <<4 x float>> [#uses=1]
  %tmp412 = load <4 x float>, <4 x float>* %dz328              ; <<4 x float>> [#uses=1]
  %tmp413 = load <4 x float>, <4 x float>* %dz328              ; <<4 x float>> [#uses=1]
  ...
  %tmp416 = load float, float* %softening_squared.addr   ; <float> [#uses=1]
  ...
  %tmp419 = load <4 x float>, <4 x float>* %distance_squared342 ; <<4 x float>> [#uses=1]
  %add420 = fadd <4 x float> %tmp419, %splat418   ; <<4 x float>> [#uses=1]
  store <4 x float> %add420, <4 x float>* %distance_squared342
  %tmp421 = load <4 x float>, <4 x float>* %distance_squared342 ; <<4 x float>> [#uses=1]
  %call422 = call <4 x float> @_Z12native_rsqrtU8__vector4f(<4 x float> %tmp421) ; <<4 x float>> [#uses=1]
  store <4 x float> %call422, <4 x float>* %inverse_distance360
  %tmp423 = load <4 x float>, <4 x float>* %mi336              ; <<4 x float>> [#uses=1]
  %tmp424 = load <4 x float>, <4 x float>* %inverse_distance360 ; <<4 x float>> [#uses=1]
  %mul425 = fmul <4 x float> %tmp423, %tmp424     ; <<4 x float>> [#uses=1]
  %tmp426 = load <4 x float>, <4 x float>* %inverse_distance360 ; <<4 x float>> [#uses=1]
  %tmp427 = load <4 x float>, <4 x float>* %inverse_distance360 ; <<4 x float>> [#uses=1]
  ...
  %tmp430 = load <4 x float>, <4 x float>* %dx312              ; <<4 x float>> [#uses=1]
  %tmp431 = load <4 x float>, <4 x float>* %s364               ; <<4 x float>> [#uses=1]
  %mul432 = fmul <4 x float> %tmp430, %tmp431     ; <<4 x float>> [#uses=1]
  %tmp433 = load <4 x float>, <4 x float>* %acceleration_x2    ; <<4 x float>> [#uses=1]
  %add434 = fadd <4 x float> %tmp433, %mul432     ; <<4 x float>> [#uses=1]
  store <4 x float> %add434, <4 x float>* %acceleration_x2
  %tmp435 = load <4 x float>, <4 x float>* %dy320              ; <<4 x float>> [#uses=1]
  %tmp436 = load <4 x float>, <4 x float>* %s364               ; <<4 x float>> [#uses=1]
  %mul437 = fmul <4 x float> %tmp435, %tmp436     ; <<4 x float>> [#uses=1]
  %tmp438 = load <4 x float>, <4 x float>* %acceleration_y2    ; <<4 x float>> [#uses=1]
  %add439 = fadd <4 x float> %tmp438, %mul437     ; <<4 x float>> [#uses=1]
  store <4 x float> %add439, <4 x float>* %acceleration_y2
  %tmp440 = load <4 x float>, <4 x float>* %dz328              ; <<4 x float>> [#uses=1]
  %tmp441 = load <4 x float>, <4 x float>* %s364               ; <<4 x float>> [#uses=1]
  %mul442 = fmul <4 x float> %tmp440, %tmp441     ; <<4 x float>> [#uses=1]
  %tmp443 = load <4 x float>, <4 x float>* %acceleration_z2    ; <<4 x float>> [#uses=1]
...
for.end448:                                       ; preds = %for.cond306
  ...
  %tmp544 = load <4 x float>, <4 x float>* %velocity_x         ; <<4 x float>> [#uses=1]
  %add545 = fadd <4 x float> %tmp544, %mul543     ; <<4 x float>> [#uses=1]
  store <4 x float> %add545, <4 x float>* %velocity_x
  %tmp546 = load <4 x float>, <4 x float>* %final_ay           ; <<4 x float>> [#uses=1]
  %tmp547 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  ...
  %tmp551 = load <4 x float>, <4 x float>* %velocity_y         ; <<4 x float>> [#uses=1]
  %add552 = fadd <4 x float> %tmp551, %mul550     ; <<4 x float>> [#uses=1]
  store <4 x float> %add552, <4 x float>* %velocity_y
  %tmp553 = load <4 x float>, <4 x float>* %final_az           ; <<4 x float>> [#uses=1]
  %tmp554 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  ...
  %tmp558 = load <4 x float>, <4 x float>* %velocity_z         ; <<4 x float>> [#uses=1]
  %add559 = fadd <4 x float> %tmp558, %mul557     ; <<4 x float>> [#uses=1]
  store <4 x float> %add559, <4 x float>* %velocity_z
  %tmp560 = load float, float* %damping.addr             ; <float> [#uses=1]
  ...
  %tmp563 = load <4 x float>, <4 x float>* %velocity_x         ; <<4 x float>> [#uses=1]
  %mul564 = fmul <4 x float> %tmp563, %splat562   ; <<4 x float>> [#uses=1]
  store <4 x float> %mul564, <4 x float>* %velocity_x
  %tmp565 = load float, float* %damping.addr             ; <float> [#uses=1]
  ...
  %tmp568 = load <4 x float>, <4 x float>* %velocity_y         ; <<4 x float>> [#uses=1]
  %mul569 = fmul <4 x float> %tmp568, %splat567   ; <<4 x float>> [#uses=1]
  store <4 x float> %mul569, <4 x float>* %velocity_y
  %tmp570 = load float, float* %damping.addr             ; <float> [#uses=1]
  ...
  %tmp573 = load <4 x float>, <4 x float>* %velocity_z         ; <<4 x float>> [#uses=1]
  %mul574 = fmul <4 x float> %tmp573, %splat572   ; <<4 x float>> [#uses=1]
  store <4 x float> %mul574, <4 x float>* %velocity_z
  %tmp575 = load <4 x float>, <4 x float>* %velocity_x         ; <<4 x float>> [#uses=1]
  %tmp576 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  ...
  %tmp580 = load <4 x float>, <4 x float>* %position_x         ; <<4 x float>> [#uses=1]
  %add581 = fadd <4 x float> %tmp580, %mul579     ; <<4 x float>> [#uses=1]
  store <4 x float> %add581, <4 x float>* %position_x
  %tmp582 = load <4 x float>, <4 x float>* %velocity_y         ; <<4 x float>> [#uses=1]
  %tmp583 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  ...
  %tmp587 = load <4 x float>, <4 x float>* %position_y         ; <<4 x float>> [#uses=1]
  %add588 = fadd <4 x float> %tmp587, %mul586     ; <<4 x float>> [#uses=1]
  store <4 x float> %add588, <4 x float>* %position_y
  %tmp589 = load <4 x float>, <4 x float>* %velocity_z         ; <<4 x float>> [#uses=1]
  %tmp590 = load float, float* %time_delta.addr          ; <float> [#uses=1]
  ...
  %tmp594 = load <4 x float>, <4 x float>* %position_z         ; <<4 x float>> [#uses=1]
  %add595 = fadd <4 x float> %tmp594, %mul593     ; <<4 x float>> [#uses=1]
  store <4 x float> %add595, <4 x float>* %position_z
  %tmp596 = load <4 x float>, <4 x float>* %position_x         ; <<4 x float>> [#uses=1]
  %tmp597 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp598 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_position_x.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx599 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp598, i32 %tmp597 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp596, <4 x float> addrspace(1)* %arrayidx599
  %tmp600 = load <4 x float>, <4 x float>* %position_y         ; <<4 x float>> [#uses=1]
  %tmp601 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp602 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_position_y.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx603 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp602, i32 %tmp601 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp600, <4 x float> addrspace(1)* %arrayidx603
  %tmp604 = load <4 x float>, <4 x float>* %position_z         ; <<4 x float>> [#uses=1]
  %tmp605 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp606 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_position_z.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx607 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp606, i32 %tmp605 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp604, <4 x float> addrspace(1)* %arrayidx607
  %tmp608 = load <4 x float>, <4 x float>* %velocity_x         ; <<4 x float>> [#uses=1]
  %tmp609 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp610 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_velocity_x.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx611 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp610, i32 %tmp609 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp608, <4 x float> addrspace(1)* %arrayidx611
  %tmp612 = load <4 x float>, <4 x float>* %velocity_y         ; <<4 x float>> [#uses=1]
  %tmp613 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp614 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_velocity_y.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx615 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp614, i32 %tmp613 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp612, <4 x float> addrspace(1)* %arrayidx615
  %tmp616 = load <4 x float>, <4 x float>* %velocity_z         ; <<4 x float>> [#uses=1]
  %tmp617 = load i32, i32* %k                          ; <i32> [#uses=1]
  %tmp618 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_velocity_z.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx619 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp618, i32 %tmp617 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp616, <4 x float> addrspace(1)* %arrayidx619
  %tmp621 = load <4 x float>, <4 x float>* %position_x         ; <<4 x float>> [#uses=3]
  ...
  %tmp623 = load <4 x float>, <4 x float>* %position_y         ; <<4 x float>> [#uses=2]
  ...
  %tmp625 = load <4 x float>, <4 x float>* %position_z         ; <<4 x float>> [#uses=1]
  ...
  %tmp627 = load <4 x float>, <4 x float>* %m                  ; <<4 x float>> [#uses=1]
  ...
  %tmp630 = load <4 x float>, <4 x float>* %.compoundliteral620 ; <<4 x float>> [#uses=1]
  %tmp631 = load i32, i32* %l                          ; <i32> [#uses=1]
  %mul632 = mul i32 4, %tmp631                    ; <i32> [#uses=1]
  %add633 = add nsw i32 %mul632, 0                ; <i32> [#uses=1]
  %tmp634 = load i32, i32* %offset                     ; <i32> [#uses=1]
  %add635 = add nsw i32 %add633, %tmp634          ; <i32> [#uses=1]
  %tmp636 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_position.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx637 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp636, i32 %add635 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp630, <4 x float> addrspace(1)* %arrayidx637
  %tmp639 = load <4 x float>, <4 x float>* %position_x         ; <<4 x float>> [#uses=3]
  ...
  %tmp641 = load <4 x float>, <4 x float>* %position_y         ; <<4 x float>> [#uses=2]
  ...
  %tmp643 = load <4 x float>, <4 x float>* %position_z         ; <<4 x float>> [#uses=1]
  ...
  %tmp646 = load <4 x float>, <4 x float>* %m                  ; <<4 x float>> [#uses=1]
  ...
  %tmp649 = load <4 x float>, <4 x float>* %.compoundliteral638 ; <<4 x float>> [#uses=1]
  %tmp650 = load i32, i32* %l                          ; <i32> [#uses=1]
  %mul651 = mul i32 4, %tmp650                    ; <i32> [#uses=1]
  %add652 = add nsw i32 %mul651, 1                ; <i32> [#uses=1]
  %tmp653 = load i32, i32* %offset                     ; <i32> [#uses=1]
  %add654 = add nsw i32 %add652, %tmp653          ; <i32> [#uses=1]
  %tmp655 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_position.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx656 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp655, i32 %add654 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp649, <4 x float> addrspace(1)* %arrayidx656
  %tmp658 = load <4 x float>, <4 x float>* %position_x         ; <<4 x float>> [#uses=3]
  ...
  %tmp660 = load <4 x float>, <4 x float>* %position_y         ; <<4 x float>> [#uses=2]
  ...
  %tmp662 = load <4 x float>, <4 x float>* %position_z         ; <<4 x float>> [#uses=1]
  ...
  %tmp665 = load <4 x float>, <4 x float>* %m                  ; <<4 x float>> [#uses=1]
  ...
  %tmp668 = load <4 x float>, <4 x float>* %.compoundliteral657 ; <<4 x float>> [#uses=1]
  %tmp669 = load i32, i32* %l                          ; <i32> [#uses=1]
  %mul670 = mul i32 4, %tmp669                    ; <i32> [#uses=1]
  %add671 = add nsw i32 %mul670, 2                ; <i32> [#uses=1]
  %tmp672 = load i32, i32* %offset                     ; <i32> [#uses=1]
  %add673 = add nsw i32 %add671, %tmp672          ; <i32> [#uses=1]
  %tmp674 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_position.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx675 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp674, i32 %add673 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp668, <4 x float> addrspace(1)* %arrayidx675
  %tmp677 = load <4 x float>, <4 x float>* %position_x         ; <<4 x float>> [#uses=3]
  ...
  %tmp679 = load <4 x float>, <4 x float>* %position_y         ; <<4 x float>> [#uses=2]
  ...
  %tmp681 = load <4 x float>, <4 x float>* %position_z         ; <<4 x float>> [#uses=1]
  ...
  %tmp684 = load <4 x float>, <4 x float>* %m                  ; <<4 x float>> [#uses=1]
  ...
  %tmp687 = load <4 x float>, <4 x float>* %.compoundliteral676 ; <<4 x float>> [#uses=1]
  %tmp688 = load i32, i32* %l                          ; <i32> [#uses=1]
  %mul689 = mul i32 4, %tmp688                    ; <i32> [#uses=1]
  %add690 = add nsw i32 %mul689, 3                ; <i32> [#uses=1]
  %tmp691 = load i32, i32* %offset                     ; <i32> [#uses=1]
  %add692 = add nsw i32 %add690, %tmp691          ; <i32> [#uses=1]
  %tmp693 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output_position.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx694 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp693, i32 %add692 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp687, <4 x float> addrspace(1)* %arrayidx694
  br label %for.inc695

for.inc695:                                       ; preds = %for.end448
  %tmp696 = load i32, i32* %l                          ; <i32> [#uses=1]
...
declare <4 x float> @_Z12native_rsqrtU8__vector4f(<4 x float>)

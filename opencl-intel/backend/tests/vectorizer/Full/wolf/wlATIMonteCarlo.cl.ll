...
for.end:                                          ; preds = %for.cond
  ...
  %call = call <4 x float> @_Z3logU8__vector4f(<4 x float> %tmp313) ; <<4 x float>> [#uses=1]
  %mul314 = fmul <4 x float> %splat312, %call     ; <<4 x float>> [#uses=1]
  %call315 = call <4 x float> @_Z4sqrtU8__vector4f(<4 x float> %mul314) ; <<4 x float>> [#uses=1]
  ...
  %call325 = call <4 x float> @_Z3cosU8__vector4f(<4 x float> %tmp324) ; <<4 x float>> [#uses=1]
  ...
  %call330 = call <4 x float> @_Z3sinU8__vector4f(<4 x float> %tmp329) ; <<4 x float>> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %call77 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add76) ; <<4 x float>> [#uses=1]
  ...
  %call85 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add84) ; <<4 x float>> [#uses=1]
  ...
  %call104 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %div) ; <<4 x float>> [#uses=1]
  ...
  %call119 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %div118) ; <<4 x float>> [#uses=1]

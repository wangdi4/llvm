...
if.end75:                                         ; preds = %if.end74, %if.then
  %tmp77 = load float, float* %opt_x0                    ; <float> [#uses=1]
  %tmp78 = load float, float* %opt_zoomInv               ; <float> [#uses=1]
  %sub = fsub float %tmp77, %tmp78                ; <float> [#uses=1]
  store float %sub, float* %x1
  %tmp80 = load float, float* %opt_x0                    ; <float> [#uses=1]
  %tmp81 = load float, float* %opt_zoomInv               ; <float> [#uses=1]
  %add82 = fadd float %tmp80, %tmp81              ; <float> [#uses=1]
  store float %add82, float* %x2
  %tmp84 = load float, float* %x2                        ; <float> [#uses=1]
  ...
  %tmp102 = load float, float* %opt_y0                   ; <float> [#uses=1]
  %tmp103 = load float, float* %spanY                    ; <float> [#uses=1]
  ...
  %tmp107 = load float, float* %opt_y0                   ; <float> [#uses=1]
  %tmp108 = load float, float* %spanY                    ; <float> [#uses=1]
...
if.end31:                                         ; preds = %if.end30, %if.then
  ...
  %tmp40 = load float, float* %x0                        ; <float> [#uses=1]
  %tmp41 = load float, float* %zoom                      ; <float> [#uses=3]
  ...
  store float %sub, float* %x1
  %tmp44 = load float, float* %x0                        ; <float> [#uses=1]
  %tmp45 = load float, float* %zoom                      ; <float> [#uses=3]
  ...
  %tmp51 = load float, float* %x2                        ; <float> [#uses=1]
  ...
  store float %mul, float* %spanY
  %tmp69 = load float, float* %y0                        ; <float> [#uses=1]
  %tmp70 = load float, float* %spanY                     ; <float> [#uses=1]
  %div71 = fdiv float %tmp70, 2.000000e+000       ; <float> [#uses=1]
  %sub72 = fsub float %tmp69, %div71              ; <float> [#uses=1]
  store float %sub72, float* %y1
  %tmp74 = load float, float* %y0                        ; <float> [#uses=1]
  %tmp75 = load float, float* %spanY                     ; <float> [#uses=1]
  ...
  %tmp92 = load float, float* %y1                        ; <float> [#uses=1]
  %add93 = fadd float %tmp92, %mul91              ; <float> [#uses=1]
  store float %add93, float* %y1
  %tmp95 = load float, float* %x1                        ; <float> [#uses=1]
  ...
  %tmp120 = load <2 x float>, <2 x float>* %xy1                ; <<2 x float>> [#uses=1]
  %tmp121 = load <2 x float>, <2 x float>* %outCrd.addr        ; <<2 x float>> [#uses=1]
  %tmp122 = load <2 x float>, <2 x float>* %spanXY             ; <<2 x float>> [#uses=1]
  ...
  %tmp126 = load <2 x float>, <2 x float>* %z                  ; <<2 x float>> [#uses=1]
...
while.body:                                       ; preds = %while.cond
  %tmp135 = load <2 x float>, <2 x float>* %z                  ; <<2 x float>> [#uses=1]
  %tmp136 = extractelement <2 x float> %tmp135, i32 0 ; <float> [#uses=1]
  %tmp137 = load <2 x float>, <2 x float>* %z                  ; <<2 x float>> [#uses=1]
  ...
  %tmp140 = load <2 x float>, <2 x float>* %z                  ; <<2 x float>> [#uses=1]
  %tmp141 = extractelement <2 x float> %tmp140, i32 1 ; <float> [#uses=1]
  %tmp142 = load <2 x float>, <2 x float>* %z                  ; <<2 x float>> [#uses=1]
  ...
  %tmp145 = load float, float* %aa                       ; <float> [#uses=1]
  %tmp146 = load float, float* %bb                       ; <float> [#uses=1]
...
if.then150:                                       ; preds = %while.body
  ...
  %tmp203 = load <4 x float>, <4 x float>* %.compoundliteral   ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp203, <4 x float>* %p
  %tmp204 = load <4 x float>, <4 x float>* %p                  ; <<4 x float>> [#uses=1]
  %tmp205 = insertelement <4 x float> %tmp204, float 1.000000e+000, i32 3 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp205, <4 x float>* %p
  %tmp206 = load <4 x float>, <4 x float>* %p                  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp206, <4 x float>* %dst
  br label %while.end

if.end207:                                        ; preds = %while.body
  %tmp208 = load <2 x float>, <2 x float>* %z                  ; <<2 x float>> [#uses=1]
  ...
  %tmp212 = load <2 x float>, <2 x float>* %z                  ; <<2 x float>> [#uses=1]
...
entry:
  ...
  %tmp8 = load <2 x float>, <2 x float>* %z                    ; <<2 x float>> [#uses=1]
...
while.body:                                       ; preds = %while.cond
  %tmp15 = load <2 x float>, <2 x float>* %z                   ; <<2 x float>> [#uses=1]
  %tmp16 = extractelement <2 x float> %tmp15, i32 0 ; <float> [#uses=1]
  %tmp17 = load <2 x float>, <2 x float>* %z                   ; <<2 x float>> [#uses=1]
  ...
  %tmp20 = load <2 x float>, <2 x float>* %z                   ; <<2 x float>> [#uses=1]
  %tmp21 = extractelement <2 x float> %tmp20, i32 1 ; <float> [#uses=1]
  %tmp22 = load <2 x float>, <2 x float>* %z                   ; <<2 x float>> [#uses=1]
  ...
  %tmp25 = load float, float* %aa                        ; <float> [#uses=1]
  %tmp26 = load float, float* %bb                        ; <float> [#uses=1]
...
if.then:                                          ; preds = %while.body
  ...
  %tmp66 = load <4 x float>, <4 x float>* %.compoundliteral    ; <<4 x float>> [#uses=1]
  ...
  %tmp69 = load <4 x float>, <4 x float>* %p                   ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp69, <4 x float>* %dst
  br label %while.end

if.end:                                           ; preds = %while.body
  %tmp70 = load <2 x float>, <2 x float>* %z                   ; <<2 x float>> [#uses=1]
  ...
  %tmp74 = load <2 x float>, <2 x float>* %z                   ; <<2 x float>> [#uses=1]
...
for.inc:                                          ; preds = %for.body32
  %tmp42 = load i32, i32* %col                         ; <i32> [#uses=1]

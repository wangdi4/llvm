...
@opencl_metadata = appending global [3 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (<2 x float>, float, i32, %struct.anon addrspace(1)*)* @evaluateDependents to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_evaluateDependents_locals to i8*), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @opencl_evaluateDependents_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (%struct._image2d_t*, <4 x float> addrspace(1)*, %struct.anon addrspace(2)*)* @bilateral2D_2D to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_bilateral2D_2D_locals to i8*), i8* getelementptr inbounds ([107 x i8], [107 x i8]* @opencl_bilateral2D_2D_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (%struct._image2d_t*, <4 x float> addrspace(1)*, i32, %struct.anon addrspace(2)*)* @bilateral2D to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_bilateral2D_locals to i8*), i8* getelementptr inbounds ([119 x i8], [119 x i8]* @opencl_bilateral2D_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[3 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %tmp3 = load <4 x float>, <4 x float>* %kZero                ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp3, <4 x float>* %dst
  store float 0.000000e+000, float* %scale
  %tmp7 = load %struct.anon addrspace(2)*, %struct.anon addrspace(2)** %pArgs.addr ; <%struct.anon addrspace(2)*> [#uses=1]
  %tmp8 = getelementptr inbounds %struct.anon, %struct.anon addrspace(2)* %tmp7, i32 0, i32 3 ; <i32 addrspace(2)*> [#uses=1]
  %tmp9 = load i32, i32 addrspace(2)* %tmp8            ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc100, %entry
  ...
  %tmp12 = getelementptr inbounds %struct.anon, %struct.anon addrspace(2)* %tmp11, i32 0, i32 3 ; <i32 addrspace(2)*> [#uses=1]
  %tmp13 = load i32, i32 addrspace(2)* %tmp12          ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp16 = getelementptr inbounds %struct.anon, %struct.anon addrspace(2)* %tmp15, i32 0, i32 4 ; <i32 addrspace(2)*> [#uses=1]
...
for.cond19:                                       ; preds = %for.inc, %for.body
  %tmp20 = load i32, i32* %y                           ; <i32> [#uses=1]
  %tmp21 = load %struct.anon addrspace(2)*, %struct.anon addrspace(2)** %pArgs.addr ; <%struct.anon addrspace(2)*> [#uses=1]
  %tmp22 = getelementptr inbounds %struct.anon, %struct.anon addrspace(2)* %tmp21, i32 0, i32 4 ; <i32 addrspace(2)*> [#uses=1]
  %tmp23 = load i32, i32 addrspace(2)* %tmp22          ; <i32> [#uses=1]
...
for.body25:                                       ; preds = %for.cond19
  ...
  %tmp28 = load i32, i32* %y                           ; <i32> [#uses=1]
  %vecinit29 = insertelement <2 x i32> %vecinit, i32 %tmp28, i32 1 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %vecinit29, <2 x i32>* %sCrd
  %tmp31 = load %struct._image2d_t*, %struct._image2d_t** %inputImage.addr ; <%struct._image2d_t*> [#uses=1]
  %tmp32 = load <2 x i32>, <2 x i32>* %outCrd.addr           ; <<2 x i32>> [#uses=1]
  %tmp33 = load <2 x i32>, <2 x i32>* %sCrd                  ; <<2 x i32>> [#uses=1]
  ...
  %tmp35 = load <4 x float>, <4 x float>* %origSrc             ; <<4 x float>> [#uses=1]
  %tmp36 = load <4 x float>, <4 x float>* %curVal              ; <<4 x float>> [#uses=1]
  ...
  %tmp39 = load i32, i32* %x                           ; <i32> [#uses=1]
  %tmp40 = load i32, i32* %x                           ; <i32> [#uses=1]
  %mul = mul i32 %tmp39, %tmp40                   ; <i32> [#uses=1]
  %tmp41 = load i32, i32* %y                           ; <i32> [#uses=1]
  %tmp42 = load i32, i32* %y                           ; <i32> [#uses=1]
  ...
  %tmp47 = getelementptr inbounds %struct.anon, %struct.anon addrspace(2)* %tmp46, i32 0, i32 1 ; <float addrspace(2)*> [#uses=1]
  ...
  %tmp52 = load %struct.anon addrspace(2)*, %struct.anon addrspace(2)** %pArgs.addr ; <%struct.anon addrspace(2)*> [#uses=1]
  %tmp53 = getelementptr inbounds %struct.anon, %struct.anon addrspace(2)* %tmp52, i32 0, i32 0 ; <i32 addrspace(2)*> [#uses=1]
  %tmp54 = load i32, i32 addrspace(2)* %tmp53          ; <i32> [#uses=1]
  %tobool = icmp ne i32 %tmp54, 0                 ; <i1> [#uses=1]
  br i1 %tobool, label %if.then, label %if.else

if.then:                                          ; preds = %for.body25
  %tmp55 = load <4 x float>, <4 x float>* %difference          ; <<4 x float>> [#uses=1]
  %tmp56 = insertelement <4 x float> %tmp55, float 0.000000e+000, i32 3 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp56, <4 x float>* %difference
  %tmp57 = load <4 x float>, <4 x float>* %difference          ; <<4 x float>> [#uses=1]
  %tmp58 = load <4 x float>, <4 x float>* %difference          ; <<4 x float>> [#uses=1]
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %tmp84 = load <4 x float>, <4 x float>* %curVal              ; <<4 x float>> [#uses=1]
  %tmp85 = load float, float* %wD                        ; <float> [#uses=1]
  ...
  %tmp88 = load float, float* %wR                        ; <float> [#uses=1]
  ...
  %tmp92 = load <4 x float>, <4 x float>* %dst                 ; <<4 x float>> [#uses=1]
  %add93 = fadd <4 x float> %tmp92, %mul91        ; <<4 x float>> [#uses=1]
  store <4 x float> %add93, <4 x float>* %dst
  %tmp94 = load float, float* %wD                        ; <float> [#uses=1]
  %tmp95 = load float, float* %wR                        ; <float> [#uses=1]
  %mul96 = fmul float %tmp94, %tmp95              ; <float> [#uses=1]
  %tmp97 = load float, float* %scale                     ; <float> [#uses=1]
  %add98 = fadd float %tmp97, %mul96              ; <float> [#uses=1]
  store float %add98, float* %scale
  br label %for.inc

for.inc:                                          ; preds = %if.end
  %tmp99 = load i32, i32* %y                           ; <i32> [#uses=1]
...
for.end103:                                       ; preds = %for.cond
  %tmp104 = load float, float* %scale                    ; <float> [#uses=1]
  ...
  %tmp107 = load <4 x float>, <4 x float>* %dst                ; <<4 x float>> [#uses=1]
  ...
  %tmp109 = load <4 x float>, <4 x float>* %dst                ; <<4 x float>> [#uses=1]
...
entry:
  ...
  %tmp6 = load <2 x i32>, <2 x i32>* %curCrd                 ; <<2 x i32>> [#uses=1]
  ...
  %tmp10 = load <2 x i32>, <2 x i32>* %curCrd                ; <<2 x i32>> [#uses=1]
  ...
  %tmp13 = load <2 x i32>, <2 x i32>* %curCrd                ; <<2 x i32>> [#uses=1]
  ...
  %tmp17 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %output.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp17, i32 %tmp16 ; <<4 x float> addrspace(1)*> [#uses=1]
...
cond.true:                                        ; preds = %entry
  %tmp10 = load i32, i32* %row                         ; <i32> [#uses=1]
  %tmp11 = load i32, i32* %rowCountPerGlobalID.addr    ; <i32> [#uses=1]
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %tmp17 = load <2 x i32>, <2 x i32>* %imgSize               ; <<2 x i32>> [#uses=1]
...
for.body33:                                       ; preds = %for.cond28
  %tmp34 = load i32, i32* %col                         ; <i32> [#uses=1]
  %tmp35 = load <2 x i32>, <2 x i32>* %curCrd                ; <<2 x i32>> [#uses=1]
  ...
  %tmp38 = load <2 x i32>, <2 x i32>* %curCrd                ; <<2 x i32>> [#uses=1]

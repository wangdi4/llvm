...
entry:
  ...
  %tmp6 = load i32, i32* %i.addr                       ; <i32> [#uses=1]
  ...
  %tmp27 = load <4 x i32>, <4 x i32>* %.compoundliteral14    ; <<4 x i32>> [#uses=1]
  %call28 = call <4 x float> @_Z14convert_float4U8__vector4i(<4 x i32> %tmp27) ; <<4 x float>> [#uses=3]
  ...
  %tmp32 = load <4 x float>, <4 x float>* %.compoundliteral31  ; <<4 x float>> [#uses=1]
  ...
  %tmp35 = load <4 x float>, <4 x float>* %.compoundliteral34  ; <<4 x float>> [#uses=1]
  ...
  %tmp38 = load <4 x float>, <4 x float>* %.compoundliteral37  ; <<4 x float>> [#uses=1]
  ...
  %tmp41 = load <4 x float>, <4 x float>* %.compoundliteral40  ; <<4 x float>> [#uses=1]
  ...
  %tmp44 = load <4 x float>, <4 x float>* %.compoundliteral43  ; <<4 x float>> [#uses=1]
  ...
  %tmp47 = load <4 x float>, <4 x float>* %.compoundliteral46  ; <<4 x float>> [#uses=1]
  ...
  %tmp50 = load <4 x float>, <4 x float>* %.compoundliteral49  ; <<4 x float>> [#uses=1]
  ...
  %tmp53 = load <4 x float>, <4 x float>* %.compoundliteral52  ; <<4 x float>> [#uses=1]
  ...
  %tmp56 = load <4 x float>, <4 x float>* %.compoundliteral55  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp56, <4 x float>* %c9
  %tmp58 = load i32, i32* %i.addr                      ; <i32> [#uses=1]
  store i32 %tmp58, i32* %pos
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %tmp59 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp60 = load i32, i32* %j.addr                      ; <i32> [#uses=1]
  %cmp61 = icmp ule i32 %tmp59, %tmp60            ; <i1> [#uses=1]
  br i1 %cmp61, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp65 = load <4 x float>, <4 x float>* %pos4pl1             ; <<4 x float>> [#uses=1]
  %tmp66 = load <4 x float>, <4 x float>* %pathNinv            ; <<4 x float>> [#uses=1]
  %mul = fmul <4 x float> %tmp65, %tmp66          ; <<4 x float>> [#uses=1]
  store <4 x float> %mul, <4 x float>* %p
  %tmp67 = load <4 x float>, <4 x float>* %p                   ; <<4 x float>> [#uses=1]
  %call68 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %tmp67) ; <<4 x float>> [#uses=1]
  ...
  %call69 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %neg) ; <<4 x float>> [#uses=1]
  store <4 x float> %call69, <4 x float>* %z
  %tmp70 = load <4 x float>, <4 x float>* %c1                  ; <<4 x float>> [#uses=1]
  %tmp71 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %tmp72 = load <4 x float>, <4 x float>* %c2                  ; <<4 x float>> [#uses=1]
  %tmp73 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %tmp74 = load <4 x float>, <4 x float>* %c3                  ; <<4 x float>> [#uses=1]
  %tmp75 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %tmp76 = load <4 x float>, <4 x float>* %c4                  ; <<4 x float>> [#uses=1]
  %tmp77 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %tmp78 = load <4 x float>, <4 x float>* %c5                  ; <<4 x float>> [#uses=1]
  %tmp79 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %tmp80 = load <4 x float>, <4 x float>* %c6                  ; <<4 x float>> [#uses=1]
  %tmp81 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %tmp82 = load <4 x float>, <4 x float>* %c7                  ; <<4 x float>> [#uses=1]
  %tmp83 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %tmp84 = load <4 x float>, <4 x float>* %c8                  ; <<4 x float>> [#uses=1]
  %tmp85 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %tmp86 = load <4 x float>, <4 x float>* %c9                  ; <<4 x float>> [#uses=1]
  ...
  %tmp103 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  ...
  %tmp105 = load i32, i32* %index                      ; <i32> [#uses=2]
  %inc = add nsw i32 %tmp105, 1                   ; <i32> [#uses=1]
  store i32 %inc, i32* %index
  %tmp106 = load <4 x float>*, <4 x float>** %pDist.addr        ; <<4 x float>*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float>* %tmp106, i32 %tmp105 ; <<4 x float>*> [#uses=1]
  store <4 x float> %neg104, <4 x float>* %arrayidx
  %tmp107 = load <4 x float>, <4 x float>* %pos4pl1            ; <<4 x float>> [#uses=1]
  ...
  %tmp109 = load <4 x float>, <4 x float>* %pos4pl1            ; <<4 x float>> [#uses=1]
  %tmp110 = load <4 x float>, <4 x float>* %pathNinv           ; <<4 x float>> [#uses=1]
  %mul111 = fmul <4 x float> %tmp109, %tmp110     ; <<4 x float>> [#uses=1]
  store <4 x float> %mul111, <4 x float>* %p
  %tmp112 = load <4 x float>, <4 x float>* %p                  ; <<4 x float>> [#uses=1]
  %call113 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %tmp112) ; <<4 x float>> [#uses=1]
  ...
  %call115 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %neg114) ; <<4 x float>> [#uses=1]
  store <4 x float> %call115, <4 x float>* %z
  %tmp116 = load <4 x float>, <4 x float>* %c1                 ; <<4 x float>> [#uses=1]
  %tmp117 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp118 = load <4 x float>, <4 x float>* %c2                 ; <<4 x float>> [#uses=1]
  %tmp119 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp120 = load <4 x float>, <4 x float>* %c3                 ; <<4 x float>> [#uses=1]
  %tmp121 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp122 = load <4 x float>, <4 x float>* %c4                 ; <<4 x float>> [#uses=1]
  %tmp123 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp124 = load <4 x float>, <4 x float>* %c5                 ; <<4 x float>> [#uses=1]
  %tmp125 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp126 = load <4 x float>, <4 x float>* %c6                 ; <<4 x float>> [#uses=1]
  %tmp127 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp128 = load <4 x float>, <4 x float>* %c7                 ; <<4 x float>> [#uses=1]
  %tmp129 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp130 = load <4 x float>, <4 x float>* %c8                 ; <<4 x float>> [#uses=1]
  %tmp131 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp132 = load <4 x float>, <4 x float>* %c9                 ; <<4 x float>> [#uses=1]
  ...
  %tmp149 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  ...
  %tmp151 = load i32, i32* %index                      ; <i32> [#uses=2]
  %inc152 = add nsw i32 %tmp151, 1                ; <i32> [#uses=1]
  store i32 %inc152, i32* %index
  %tmp153 = load <4 x float>*, <4 x float>** %pDist.addr        ; <<4 x float>*> [#uses=1]
  %arrayidx154 = getelementptr inbounds <4 x float>, <4 x float>* %tmp153, i32 %tmp151 ; <<4 x float>*> [#uses=1]
  store <4 x float> %neg150, <4 x float>* %arrayidx154
  %tmp155 = load <4 x float>, <4 x float>* %pos4pl1            ; <<4 x float>> [#uses=1]
...
for.inc:                                          ; preds = %for.body
  %tmp157 = load i32, i32* %pos                        ; <i32> [#uses=1]
...
entry:
  ...
  %tmp55 = load i32, i32* %i.addr                      ; <i32> [#uses=1]
  store i32 %tmp55, i32* %pos
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %tmp56 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp57 = load i32, i32* %j.addr                      ; <i32> [#uses=1]
  %cmp58 = icmp ule i32 %tmp56, %tmp57            ; <i1> [#uses=1]
  br i1 %cmp58, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp62 = load <4 x float>, <4 x float>* %pos4pl1             ; <<4 x float>> [#uses=1]
  %tmp63 = load <4 x float>, <4 x float>* %pathNinv            ; <<4 x float>> [#uses=1]
  %mul = fmul <4 x float> %tmp62, %tmp63          ; <<4 x float>> [#uses=1]
  store <4 x float> %mul, <4 x float>* %p
  %tmp64 = load <4 x float>, <4 x float>* %p                   ; <<4 x float>> [#uses=1]
  ...
  %tmp65 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
  %tmp66 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
  %mul67 = fmul <4 x float> %tmp65, %tmp66        ; <<4 x float>> [#uses=1]
  store <4 x float> %mul67, <4 x float>* %z
  %tmp68 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
  %tmp69 = load <4 x float>, <4 x float>* %a4                  ; <<4 x float>> [#uses=1]
  %tmp70 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %mul71 = fmul <4 x float> %tmp69, %tmp70        ; <<4 x float>> [#uses=1]
  %tmp72 = load <4 x float>, <4 x float>* %a3                  ; <<4 x float>> [#uses=1]
  %add73 = fadd <4 x float> %mul71, %tmp72        ; <<4 x float>> [#uses=1]
  %tmp74 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %mul75 = fmul <4 x float> %add73, %tmp74        ; <<4 x float>> [#uses=1]
  %tmp76 = load <4 x float>, <4 x float>* %a2                  ; <<4 x float>> [#uses=1]
  %add77 = fadd <4 x float> %mul75, %tmp76        ; <<4 x float>> [#uses=1]
  %tmp78 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %mul79 = fmul <4 x float> %add77, %tmp78        ; <<4 x float>> [#uses=1]
  %tmp80 = load <4 x float>, <4 x float>* %a1                  ; <<4 x float>> [#uses=1]
  %add81 = fadd <4 x float> %mul79, %tmp80        ; <<4 x float>> [#uses=1]
  %mul82 = fmul <4 x float> %tmp68, %add81        ; <<4 x float>> [#uses=1]
  %tmp83 = load <4 x float>, <4 x float>* %b4                  ; <<4 x float>> [#uses=1]
  %tmp84 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %mul85 = fmul <4 x float> %tmp83, %tmp84        ; <<4 x float>> [#uses=1]
  %tmp86 = load <4 x float>, <4 x float>* %b3                  ; <<4 x float>> [#uses=1]
  %add87 = fadd <4 x float> %mul85, %tmp86        ; <<4 x float>> [#uses=1]
  %tmp88 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %mul89 = fmul <4 x float> %add87, %tmp88        ; <<4 x float>> [#uses=1]
  %tmp90 = load <4 x float>, <4 x float>* %b2                  ; <<4 x float>> [#uses=1]
  %add91 = fadd <4 x float> %mul89, %tmp90        ; <<4 x float>> [#uses=1]
  %tmp92 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  %mul93 = fmul <4 x float> %add91, %tmp92        ; <<4 x float>> [#uses=1]
  %tmp94 = load <4 x float>, <4 x float>* %b1                  ; <<4 x float>> [#uses=1]
  %add95 = fadd <4 x float> %mul93, %tmp94        ; <<4 x float>> [#uses=1]
  %tmp96 = load <4 x float>, <4 x float>* %z                   ; <<4 x float>> [#uses=1]
  ...
  %tmp102 = load i32, i32* %index                      ; <i32> [#uses=2]
  %inc = add nsw i32 %tmp102, 1                   ; <i32> [#uses=1]
  store i32 %inc, i32* %index
  %tmp103 = load <4 x float>*, <4 x float>** %pDist.addr        ; <<4 x float>*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float>* %tmp103, i32 %tmp102 ; <<4 x float>*> [#uses=1]
  store <4 x float> %div101, <4 x float>* %arrayidx
  %tmp104 = load <4 x float>, <4 x float>* %pos4pl1            ; <<4 x float>> [#uses=1]
  ...
  %tmp106 = load <4 x float>, <4 x float>* %pos4pl1            ; <<4 x float>> [#uses=1]
  %tmp107 = load <4 x float>, <4 x float>* %pathNinv           ; <<4 x float>> [#uses=1]
  %mul108 = fmul <4 x float> %tmp106, %tmp107     ; <<4 x float>> [#uses=1]
  store <4 x float> %mul108, <4 x float>* %p
  %tmp109 = load <4 x float>, <4 x float>* %p                  ; <<4 x float>> [#uses=1]
  ...
  %tmp111 = load <4 x float>, <4 x float>* %y                  ; <<4 x float>> [#uses=1]
  %tmp112 = load <4 x float>, <4 x float>* %y                  ; <<4 x float>> [#uses=1]
  %mul113 = fmul <4 x float> %tmp111, %tmp112     ; <<4 x float>> [#uses=1]
  store <4 x float> %mul113, <4 x float>* %z
  %tmp114 = load <4 x float>, <4 x float>* %y                  ; <<4 x float>> [#uses=1]
  %tmp115 = load <4 x float>, <4 x float>* %a4                 ; <<4 x float>> [#uses=1]
  %tmp116 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %mul117 = fmul <4 x float> %tmp115, %tmp116     ; <<4 x float>> [#uses=1]
  %tmp118 = load <4 x float>, <4 x float>* %a3                 ; <<4 x float>> [#uses=1]
  %add119 = fadd <4 x float> %mul117, %tmp118     ; <<4 x float>> [#uses=1]
  %tmp120 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %mul121 = fmul <4 x float> %add119, %tmp120     ; <<4 x float>> [#uses=1]
  %tmp122 = load <4 x float>, <4 x float>* %a2                 ; <<4 x float>> [#uses=1]
  %add123 = fadd <4 x float> %mul121, %tmp122     ; <<4 x float>> [#uses=1]
  %tmp124 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %mul125 = fmul <4 x float> %add123, %tmp124     ; <<4 x float>> [#uses=1]
  %tmp126 = load <4 x float>, <4 x float>* %a1                 ; <<4 x float>> [#uses=1]
  %add127 = fadd <4 x float> %mul125, %tmp126     ; <<4 x float>> [#uses=1]
  %mul128 = fmul <4 x float> %tmp114, %add127     ; <<4 x float>> [#uses=1]
  %tmp129 = load <4 x float>, <4 x float>* %b4                 ; <<4 x float>> [#uses=1]
  %tmp130 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %mul131 = fmul <4 x float> %tmp129, %tmp130     ; <<4 x float>> [#uses=1]
  %tmp132 = load <4 x float>, <4 x float>* %b3                 ; <<4 x float>> [#uses=1]
  %add133 = fadd <4 x float> %mul131, %tmp132     ; <<4 x float>> [#uses=1]
  %tmp134 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %mul135 = fmul <4 x float> %add133, %tmp134     ; <<4 x float>> [#uses=1]
  %tmp136 = load <4 x float>, <4 x float>* %b2                 ; <<4 x float>> [#uses=1]
  %add137 = fadd <4 x float> %mul135, %tmp136     ; <<4 x float>> [#uses=1]
  %tmp138 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %mul139 = fmul <4 x float> %add137, %tmp138     ; <<4 x float>> [#uses=1]
  %tmp140 = load <4 x float>, <4 x float>* %b1                 ; <<4 x float>> [#uses=1]
  %add141 = fadd <4 x float> %mul139, %tmp140     ; <<4 x float>> [#uses=1]
  %tmp142 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  ...
  %tmp150 = load <4 x float>*, <4 x float>** %pDist.addr        ; <<4 x float>*> [#uses=1]
  %arrayidx151 = getelementptr inbounds <4 x float>, <4 x float>* %tmp150, i32 %tmp148 ; <<4 x float>*> [#uses=1]
  store <4 x float> %div147, <4 x float>* %arrayidx151
  %tmp152 = load <4 x float>, <4 x float>* %pos4pl1            ; <<4 x float>> [#uses=1]
...
for.inc:                                          ; preds = %for.body
  %tmp154 = load i32, i32* %pos                        ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %call68 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %sub) ; <<4 x float>> [#uses=1]
  %neg = fsub <4 x float> <float -0.000000e+000, float -0.000000e+000, float -0.000000e+000, float -0.000000e+000>, %call68 ; <<4 x float>> [#uses=1]
  %call69 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %neg) ; <<4 x float>> [#uses=1]
  store <4 x float> %call69, <4 x float>* %z
  %tmp70 = load <4 x float>, <4 x float>* %c1                  ; <<4 x float>> [#uses=1]
  ...
  %mul101 = fmul <4 x float> %tmp71, %add100      ; <<4 x float>> [#uses=1]
  %add102 = fadd <4 x float> %tmp70, %mul101      ; <<4 x float>> [#uses=1]
  %tmp103 = load i32, i32* %index                      ; <i32> [#uses=2]
  %inc = add nsw i32 %tmp103, 1                   ; <i32> [#uses=1]
  store i32 %inc, i32* %index
  %tmp104 = load <4 x float>*, <4 x float>** %pDist.addr        ; <<4 x float>*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float>* %tmp104, i32 %tmp103 ; <<4 x float>*> [#uses=1]
  store <4 x float> %add102, <4 x float>* %arrayidx
  %tmp105 = load <4 x float>, <4 x float>* %pos4pl1            ; <<4 x float>> [#uses=1]
  ...
  %tmp107 = load <4 x float>, <4 x float>* %pos4pl1            ; <<4 x float>> [#uses=1]
  %tmp108 = load <4 x float>, <4 x float>* %pathNinv           ; <<4 x float>> [#uses=1]
  %mul109 = fmul <4 x float> %tmp107, %tmp108     ; <<4 x float>> [#uses=1]
  store <4 x float> %mul109, <4 x float>* %p
  %tmp110 = load <4 x float>, <4 x float>* %p                  ; <<4 x float>> [#uses=1]
  ...
  %call112 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %sub111) ; <<4 x float>> [#uses=1]
  ...
  %call114 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %neg113) ; <<4 x float>> [#uses=1]
  store <4 x float> %call114, <4 x float>* %z
  %tmp115 = load <4 x float>, <4 x float>* %c1                 ; <<4 x float>> [#uses=1]
  %tmp116 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp117 = load <4 x float>, <4 x float>* %c2                 ; <<4 x float>> [#uses=1]
  %tmp118 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp119 = load <4 x float>, <4 x float>* %c3                 ; <<4 x float>> [#uses=1]
  %tmp120 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp121 = load <4 x float>, <4 x float>* %c4                 ; <<4 x float>> [#uses=1]
  %tmp122 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp123 = load <4 x float>, <4 x float>* %c5                 ; <<4 x float>> [#uses=1]
  %tmp124 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp125 = load <4 x float>, <4 x float>* %c6                 ; <<4 x float>> [#uses=1]
  %tmp126 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp127 = load <4 x float>, <4 x float>* %c7                 ; <<4 x float>> [#uses=1]
  %tmp128 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp129 = load <4 x float>, <4 x float>* %c8                 ; <<4 x float>> [#uses=1]
  %tmp130 = load <4 x float>, <4 x float>* %z                  ; <<4 x float>> [#uses=1]
  %tmp131 = load <4 x float>, <4 x float>* %c9                 ; <<4 x float>> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp3 = load <4 x float>*, <4 x float>** %input.addr          ; <<4 x float>*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float>* %tmp3, i32 %tmp2 ; <<4 x float>*> [#uses=1]
  %tmp4 = load <4 x float>, <4 x float>* %arrayidx             ; <<4 x float>> [#uses=1]
  %call = call <4 x float> @_Z3expU8__vector4f(<4 x float> %tmp4) ; <<4 x float>> [#uses=1]
  %tmp5 = load i32, i32* %i                            ; <i32> [#uses=1]
  %tmp6 = load <4 x float>*, <4 x float>** %output.addr         ; <<4 x float>*> [#uses=1]
  %arrayidx7 = getelementptr inbounds <4 x float>, <4 x float>* %tmp6, i32 %tmp5 ; <<4 x float>*> [#uses=1]
...
entry:
  ...
  %tmp2 = load %0 addrspace(1)*, %0 addrspace(1)** %pOptionData.addr ; <%0 addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds %0, %0 addrspace(1)* %tmp2, i32 %tmp ; <%0 addrspace(1)*> [#uses=1]
  %tmp3 = getelementptr inbounds %0, %0 addrspace(1)* %arrayidx, i32 0, i32 2 ; <float addrspace(1)*> [#uses=1]
  %tmp4 = load float, float addrspace(1)* %tmp3          ; <float> [#uses=1]
  store float %tmp4, float* %T
  %tmp6 = load i32, i32* %optionid                     ; <i32> [#uses=1]
  %tmp7 = load %0 addrspace(1)*, %0 addrspace(1)** %pOptionData.addr ; <%0 addrspace(1)*> [#uses=1]
  %arrayidx8 = getelementptr inbounds %0, %0 addrspace(1)* %tmp7, i32 %tmp6 ; <%0 addrspace(1)*> [#uses=1]
  %tmp9 = getelementptr inbounds %0, %0 addrspace(1)* %arrayidx8, i32 0, i32 3 ; <float addrspace(1)*> [#uses=1]
  %tmp10 = load float, float addrspace(1)* %tmp9         ; <float> [#uses=1]
  store float %tmp10, float* %R
  %tmp12 = load i32, i32* %optionid                    ; <i32> [#uses=1]
  %tmp13 = load %0 addrspace(1)*, %0 addrspace(1)** %pOptionData.addr ; <%0 addrspace(1)*> [#uses=1]
  %arrayidx14 = getelementptr inbounds %0, %0 addrspace(1)* %tmp13, i32 %tmp12 ; <%0 addrspace(1)*> [#uses=1]
  %tmp15 = getelementptr inbounds %0, %0 addrspace(1)* %arrayidx14, i32 0, i32 0 ; <float addrspace(1)*> [#uses=1]
  %tmp16 = load float, float addrspace(1)* %tmp15        ; <float> [#uses=1]
  store float %tmp16, float* %S
  %tmp18 = load i32, i32* %optionid                    ; <i32> [#uses=1]
  %tmp19 = load %0 addrspace(1)*, %0 addrspace(1)** %pOptionData.addr ; <%0 addrspace(1)*> [#uses=1]
  %arrayidx20 = getelementptr inbounds %0, %0 addrspace(1)* %tmp19, i32 %tmp18 ; <%0 addrspace(1)*> [#uses=1]
  %tmp21 = getelementptr inbounds %0, %0 addrspace(1)* %arrayidx20, i32 0, i32 1 ; <float addrspace(1)*> [#uses=1]
  %tmp22 = load float, float addrspace(1)* %tmp21        ; <float> [#uses=1]
  store float %tmp22, float* %X
  %tmp24 = load i32, i32* %optionid                    ; <i32> [#uses=1]
  %tmp25 = load %0 addrspace(1)*, %0 addrspace(1)** %pOptionData.addr ; <%0 addrspace(1)*> [#uses=1]
  %arrayidx26 = getelementptr inbounds %0, %0 addrspace(1)* %tmp25, i32 %tmp24 ; <%0 addrspace(1)*> [#uses=1]
  %tmp27 = getelementptr inbounds %0, %0 addrspace(1)* %arrayidx26, i32 0, i32 4 ; <float addrspace(1)*> [#uses=1]
  %tmp28 = load float, float addrspace(1)* %tmp27        ; <float> [#uses=1]
  store float %tmp28, float* %V
  %tmp30 = load float, float* %R                         ; <float> [#uses=1]
  ...
  %tmp33 = load float, float* %V                         ; <float> [#uses=1]
  ...
  %tmp36 = load float, float* %T                         ; <float> [#uses=1]
  ...
  %tmp41 = load float, float* %V                         ; <float> [#uses=1]
  %tmp42 = load float, float* %T                         ; <float> [#uses=1]
  ...
  %tmp46 = load <4 x float>, <4 x float>* %.compoundliteral    ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp46, <4 x float>* %sum
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral48
  %tmp49 = load <4 x float>, <4 x float>* %.compoundliteral48  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp49, <4 x float>* %sum2
  %tmp51 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
  ...
  %tmp57 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %tmp66 = load i32, i32* %boundary12                  ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  %arraydecay = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %tmp69 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp70 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %add71 = add nsw i32 %tmp70, 512                ; <i32> [#uses=1]
  %sub72 = sub i32 %add71, 1                      ; <i32> [#uses=1]
  %tmp73 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
  %tmp74 = load i32, i32* %threadId                    ; <i32> [#uses=1]
...
for.body80:                                       ; preds = %for.cond76
  ...
  %arraydecay82 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx83 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay82, i32 %shr ; <<4 x float>*> [#uses=1]
  %tmp84 = load <4 x float>, <4 x float>* %arrayidx83          ; <<4 x float>> [#uses=1]
  %tmp85 = load float, float* %VBySqrtT                  ; <float> [#uses=1]
  ...
  %tmp88 = load float, float* %MuByT                     ; <float> [#uses=1]
  ...
  %call92 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add91) ; <<4 x float>> [#uses=1]
  %tmp93 = load i32, i32* %i                           ; <i32> [#uses=1]
  %shr94 = ashr i32 %tmp93, 2                     ; <i32> [#uses=1]
  %arraydecay95 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx96 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay95, i32 %shr94 ; <<4 x float>*> [#uses=1]
  store <4 x float> %call92, <4 x float>* %arrayidx96
  %tmp97 = load i32, i32* %i                           ; <i32> [#uses=1]
  %add98 = add nsw i32 %tmp97, 4                  ; <i32> [#uses=1]
  store i32 %add98, i32* %i
  %tmp99 = load i32, i32* %i                           ; <i32> [#uses=1]
  %shr100 = ashr i32 %tmp99, 2                    ; <i32> [#uses=1]
  %arraydecay101 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx102 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay101, i32 %shr100 ; <<4 x float>*> [#uses=1]
  %tmp103 = load <4 x float>, <4 x float>* %arrayidx102        ; <<4 x float>> [#uses=1]
  %tmp104 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp108 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %call112 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add111) ; <<4 x float>> [#uses=1]
  %tmp113 = load i32, i32* %i                          ; <i32> [#uses=1]
  %shr114 = ashr i32 %tmp113, 2                   ; <i32> [#uses=1]
  %arraydecay115 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx116 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay115, i32 %shr114 ; <<4 x float>*> [#uses=1]
...
for.body125:                                      ; preds = %for.cond121
  ...
  %tmp130 = load i32, i32* %i120                       ; <i32> [#uses=1]
  %shr131 = ashr i32 %tmp130, 2                   ; <i32> [#uses=1]
  %arraydecay132 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx133 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay132, i32 %shr131 ; <<4 x float>*> [#uses=1]
  %tmp134 = load <4 x float>, <4 x float>* %arrayidx133        ; <<4 x float>> [#uses=1]
  %mul135 = fmul <4 x float> %splat129, %tmp134   ; <<4 x float>> [#uses=1]
  %tmp136 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp140 = load <4 x float>, <4 x float>* %callValue          ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral141
  %tmp142 = load <4 x float>, <4 x float>* %.compoundliteral141 ; <<4 x float>> [#uses=1]
  %call143 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp140, <4 x float> %tmp142) ; <<4 x float>> [#uses=1]
  store <4 x float> %call143, <4 x float>* %callValue
  %tmp144 = load <4 x float>, <4 x float>* %callValue          ; <<4 x float>> [#uses=1]
  %tmp145 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add146 = fadd <4 x float> %tmp145, %tmp144     ; <<4 x float>> [#uses=1]
  store <4 x float> %add146, <4 x float>* %sum
  %tmp147 = load <4 x float>, <4 x float>* %callValue          ; <<4 x float>> [#uses=1]
  %tmp148 = load <4 x float>, <4 x float>* %callValue          ; <<4 x float>> [#uses=1]
  %mul149 = fmul <4 x float> %tmp147, %tmp148     ; <<4 x float>> [#uses=1]
  %tmp150 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add151 = fadd <4 x float> %tmp150, %mul149     ; <<4 x float>> [#uses=1]
  store <4 x float> %add151, <4 x float>* %sum2
  %tmp152 = load i32, i32* %i120                       ; <i32> [#uses=1]
  %add153 = add nsw i32 %tmp152, 4                ; <i32> [#uses=1]
  store i32 %add153, i32* %i120
  %tmp154 = load float, float* %S                        ; <float> [#uses=1]
  ...
  %tmp157 = load i32, i32* %i120                       ; <i32> [#uses=1]
  %shr158 = ashr i32 %tmp157, 2                   ; <i32> [#uses=1]
  %arraydecay159 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx160 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay159, i32 %shr158 ; <<4 x float>*> [#uses=1]
  %tmp161 = load <4 x float>, <4 x float>* %arrayidx160        ; <<4 x float>> [#uses=1]
  %mul162 = fmul <4 x float> %splat156, %tmp161   ; <<4 x float>> [#uses=1]
  %tmp163 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp167 = load <4 x float>, <4 x float>* %callValue          ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral168
  %tmp169 = load <4 x float>, <4 x float>* %.compoundliteral168 ; <<4 x float>> [#uses=1]
  %call170 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp167, <4 x float> %tmp169) ; <<4 x float>> [#uses=1]
  store <4 x float> %call170, <4 x float>* %callValue
  %tmp171 = load <4 x float>, <4 x float>* %callValue          ; <<4 x float>> [#uses=1]
  %tmp172 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add173 = fadd <4 x float> %tmp172, %tmp171     ; <<4 x float>> [#uses=1]
  store <4 x float> %add173, <4 x float>* %sum
  %tmp174 = load <4 x float>, <4 x float>* %callValue          ; <<4 x float>> [#uses=1]
  %tmp175 = load <4 x float>, <4 x float>* %callValue          ; <<4 x float>> [#uses=1]
  %mul176 = fmul <4 x float> %tmp174, %tmp175     ; <<4 x float>> [#uses=1]
  %tmp177 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add178 = fadd <4 x float> %tmp177, %mul176     ; <<4 x float>> [#uses=1]
  store <4 x float> %add178, <4 x float>* %sum2
  %tmp179 = load i32, i32* %i120                       ; <i32> [#uses=1]
...
for.inc:                                          ; preds = %for.end181
  %tmp182 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %add183 = add nsw i32 %tmp182, 512              ; <i32> [#uses=1]
  store i32 %add183, i32* %pos
  br label %for.cond

for.end184:                                       ; preds = %for.cond
  %tmp185 = load i32, i32* %boundary12                 ; <i32> [#uses=1]
  %tmp186 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %sub187 = sub i32 %tmp185, %tmp186              ; <i32> [#uses=1]
  store i32 %sub187, i32* %n
  %tmp188 = load i32, i32* %n                          ; <i32> [#uses=1]
  %cmp189 = icmp sgt i32 %tmp188, 0               ; <i1> [#uses=1]
  br i1 %cmp189, label %if.then, label %if.end

if.then:                                          ; preds = %for.end184
  %arraydecay191 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %tmp192 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp193 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp194 = load i32, i32* %n                          ; <i32> [#uses=1]
  %add195 = add nsw i32 %tmp193, %tmp194          ; <i32> [#uses=1]
  %sub196 = sub i32 %add195, 1                    ; <i32> [#uses=1]
  %tmp197 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %tmp198 = load i32, i32* %threadId                   ; <i32> [#uses=1]
...
for.cond201:                                      ; preds = %for.inc224, %if.then
  %tmp202 = load i32, i32* %i200                       ; <i32> [#uses=1]
  %tmp203 = load i32, i32* %n                          ; <i32> [#uses=1]
  %cmp204 = icmp slt i32 %tmp202, %tmp203         ; <i1> [#uses=1]
  br i1 %cmp204, label %for.body206, label %for.end227

for.body206:                                      ; preds = %for.cond201
  %tmp207 = load i32, i32* %i200                       ; <i32> [#uses=1]
  %shr208 = ashr i32 %tmp207, 2                   ; <i32> [#uses=1]
  %arraydecay209 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx210 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay209, i32 %shr208 ; <<4 x float>*> [#uses=1]
  %tmp211 = load <4 x float>, <4 x float>* %arrayidx210        ; <<4 x float>> [#uses=1]
  %tmp212 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp216 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %tmp220 = load i32, i32* %i200                       ; <i32> [#uses=1]
  %shr221 = ashr i32 %tmp220, 2                   ; <i32> [#uses=1]
  %arraydecay222 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx223 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay222, i32 %shr221 ; <<4 x float>*> [#uses=1]
  store <4 x float> %add219, <4 x float>* %arrayidx223
  br label %for.inc224

for.inc224:                                       ; preds = %for.body206
  %tmp225 = load i32, i32* %i200                       ; <i32> [#uses=1]
  %add226 = add nsw i32 %tmp225, 4                ; <i32> [#uses=1]
  store i32 %add226, i32* %i200
  br label %for.cond201

for.end227:                                       ; preds = %for.cond201
  %tmp228 = load i32, i32* %n                          ; <i32> [#uses=1]
  %arraydecay229 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arraydecay230 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %tmp231 = load i32, i32* %threadId                   ; <i32> [#uses=1]
...
for.body239:                                      ; preds = %for.cond234
  ...
  %tmp245 = load i32, i32* %i233                       ; <i32> [#uses=1]
  %shr246 = ashr i32 %tmp245, 2                   ; <i32> [#uses=1]
  %arraydecay247 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx248 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay247, i32 %shr246 ; <<4 x float>*> [#uses=1]
  %tmp249 = load <4 x float>, <4 x float>* %arrayidx248        ; <<4 x float>> [#uses=1]
  %mul250 = fmul <4 x float> %splat244, %tmp249   ; <<4 x float>> [#uses=1]
  %tmp251 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp255 = load <4 x float>, <4 x float>* %callValue241       ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral256
  %tmp257 = load <4 x float>, <4 x float>* %.compoundliteral256 ; <<4 x float>> [#uses=1]
  %call258 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp255, <4 x float> %tmp257) ; <<4 x float>> [#uses=1]
  store <4 x float> %call258, <4 x float>* %callValue241
  %tmp259 = load <4 x float>, <4 x float>* %callValue241       ; <<4 x float>> [#uses=1]
  %tmp260 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add261 = fadd <4 x float> %tmp260, %tmp259     ; <<4 x float>> [#uses=1]
  store <4 x float> %add261, <4 x float>* %sum
  %tmp262 = load <4 x float>, <4 x float>* %callValue241       ; <<4 x float>> [#uses=1]
  %tmp263 = load <4 x float>, <4 x float>* %callValue241       ; <<4 x float>> [#uses=1]
  %mul264 = fmul <4 x float> %tmp262, %tmp263     ; <<4 x float>> [#uses=1]
  %tmp265 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add266 = fadd <4 x float> %tmp265, %mul264     ; <<4 x float>> [#uses=1]
  store <4 x float> %add266, <4 x float>* %sum2
  br label %for.inc267

for.inc267:                                       ; preds = %for.body239
  %tmp268 = load i32, i32* %i233                       ; <i32> [#uses=1]
  %add269 = add nsw i32 %tmp268, 4                ; <i32> [#uses=1]
  store i32 %add269, i32* %i233
  br label %for.cond234

for.end270:                                       ; preds = %for.cond234
  %tmp271 = load i32, i32* %n                          ; <i32> [#uses=1]
  %tmp272 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %add273 = add nsw i32 %tmp272, %tmp271          ; <i32> [#uses=1]
  store i32 %add273, i32* %pos
  br label %if.end

if.end:                                           ; preds = %for.end270, %for.end184
  %tmp274 = load i32, i32* %boundary12                 ; <i32> [#uses=1]
  store i32 %tmp274, i32* %pos
  br label %for.cond275

for.cond275:                                      ; preds = %for.inc439, %if.end
  %tmp276 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp277 = load i32, i32* %boundary23                 ; <i32> [#uses=1]
...
for.body282:                                      ; preds = %for.cond275
  %arraydecay283 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %tmp284 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp285 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %add286 = add nsw i32 %tmp285, 512              ; <i32> [#uses=1]
  %sub287 = sub i32 %add286, 1                    ; <i32> [#uses=1]
  %tmp288 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %tmp289 = load i32, i32* %threadId                   ; <i32> [#uses=1]
...
for.cond292:                                      ; preds = %for.body296, %for.body282
  %tmp293 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %cmp294 = icmp slt i32 %tmp293, 512             ; <i1> [#uses=1]
  br i1 %cmp294, label %for.body296, label %for.end377

for.body296:                                      ; preds = %for.cond292
  %tmp297 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %shr298 = ashr i32 %tmp297, 2                   ; <i32> [#uses=1]
  %arraydecay299 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx300 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay299, i32 %shr298 ; <<4 x float>*> [#uses=1]
  %tmp301 = load <4 x float>, <4 x float>* %arrayidx300        ; <<4 x float>> [#uses=1]
  %tmp302 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp306 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %call310 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add309) ; <<4 x float>> [#uses=1]
  %tmp311 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %shr312 = ashr i32 %tmp311, 2                   ; <i32> [#uses=1]
  %arraydecay313 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx314 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay313, i32 %shr312 ; <<4 x float>*> [#uses=1]
  store <4 x float> %call310, <4 x float>* %arrayidx314
  %tmp315 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %add316 = add nsw i32 %tmp315, 4                ; <i32> [#uses=1]
  store i32 %add316, i32* %i291
  %tmp317 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %shr318 = ashr i32 %tmp317, 2                   ; <i32> [#uses=1]
  %arraydecay319 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx320 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay319, i32 %shr318 ; <<4 x float>*> [#uses=1]
  %tmp321 = load <4 x float>, <4 x float>* %arrayidx320        ; <<4 x float>> [#uses=1]
  %tmp322 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp326 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %call330 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add329) ; <<4 x float>> [#uses=1]
  %tmp331 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %shr332 = ashr i32 %tmp331, 2                   ; <i32> [#uses=1]
  %arraydecay333 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx334 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay333, i32 %shr332 ; <<4 x float>*> [#uses=1]
  store <4 x float> %call330, <4 x float>* %arrayidx334
  %tmp335 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %add336 = add nsw i32 %tmp335, 4                ; <i32> [#uses=1]
  store i32 %add336, i32* %i291
  %tmp337 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %shr338 = ashr i32 %tmp337, 2                   ; <i32> [#uses=1]
  %arraydecay339 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx340 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay339, i32 %shr338 ; <<4 x float>*> [#uses=1]
  %tmp341 = load <4 x float>, <4 x float>* %arrayidx340        ; <<4 x float>> [#uses=1]
  %tmp342 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp346 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %call350 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add349) ; <<4 x float>> [#uses=1]
  %tmp351 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %shr352 = ashr i32 %tmp351, 2                   ; <i32> [#uses=1]
  %arraydecay353 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx354 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay353, i32 %shr352 ; <<4 x float>*> [#uses=1]
  store <4 x float> %call350, <4 x float>* %arrayidx354
  %tmp355 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %add356 = add nsw i32 %tmp355, 4                ; <i32> [#uses=1]
  store i32 %add356, i32* %i291
  %tmp357 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %shr358 = ashr i32 %tmp357, 2                   ; <i32> [#uses=1]
  %arraydecay359 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx360 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay359, i32 %shr358 ; <<4 x float>*> [#uses=1]
  %tmp361 = load <4 x float>, <4 x float>* %arrayidx360        ; <<4 x float>> [#uses=1]
  %tmp362 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp366 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %call370 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add369) ; <<4 x float>> [#uses=1]
  %tmp371 = load i32, i32* %i291                       ; <i32> [#uses=1]
  %shr372 = ashr i32 %tmp371, 2                   ; <i32> [#uses=1]
  %arraydecay373 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx374 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay373, i32 %shr372 ; <<4 x float>*> [#uses=1]
  store <4 x float> %call370, <4 x float>* %arrayidx374
  %tmp375 = load i32, i32* %i291                       ; <i32> [#uses=1]
...
for.body384:                                      ; preds = %for.cond380
  ...
  %tmp390 = load i32, i32* %i379                       ; <i32> [#uses=1]
  %arraydecay391 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx392 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay391, i32 %tmp390 ; <<4 x float>*> [#uses=1]
  %tmp393 = load <4 x float>, <4 x float>* %arrayidx392        ; <<4 x float>> [#uses=1]
  %mul394 = fmul <4 x float> %splat389, %tmp393   ; <<4 x float>> [#uses=1]
  %tmp395 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp399 = load <4 x float>, <4 x float>* %callValue386       ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral400
  %tmp401 = load <4 x float>, <4 x float>* %.compoundliteral400 ; <<4 x float>> [#uses=1]
  %call402 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp399, <4 x float> %tmp401) ; <<4 x float>> [#uses=1]
  store <4 x float> %call402, <4 x float>* %callValue386
  %tmp403 = load <4 x float>, <4 x float>* %callValue386       ; <<4 x float>> [#uses=1]
  %tmp404 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add405 = fadd <4 x float> %tmp404, %tmp403     ; <<4 x float>> [#uses=1]
  store <4 x float> %add405, <4 x float>* %sum
  %tmp406 = load <4 x float>, <4 x float>* %callValue386       ; <<4 x float>> [#uses=1]
  %tmp407 = load <4 x float>, <4 x float>* %callValue386       ; <<4 x float>> [#uses=1]
  %mul408 = fmul <4 x float> %tmp406, %tmp407     ; <<4 x float>> [#uses=1]
  %tmp409 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add410 = fadd <4 x float> %tmp409, %mul408     ; <<4 x float>> [#uses=1]
  store <4 x float> %add410, <4 x float>* %sum2
  %tmp411 = load i32, i32* %i379                       ; <i32> [#uses=1]
  %inc = add nsw i32 %tmp411, 1                   ; <i32> [#uses=1]
  store i32 %inc, i32* %i379
  %tmp412 = load float, float* %S                        ; <float> [#uses=1]
  ...
  %tmp415 = load i32, i32* %i379                       ; <i32> [#uses=1]
  %arraydecay416 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx417 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay416, i32 %tmp415 ; <<4 x float>*> [#uses=1]
  %tmp418 = load <4 x float>, <4 x float>* %arrayidx417        ; <<4 x float>> [#uses=1]
  %mul419 = fmul <4 x float> %splat414, %tmp418   ; <<4 x float>> [#uses=1]
  %tmp420 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp424 = load <4 x float>, <4 x float>* %callValue386       ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral425
  %tmp426 = load <4 x float>, <4 x float>* %.compoundliteral425 ; <<4 x float>> [#uses=1]
  %call427 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp424, <4 x float> %tmp426) ; <<4 x float>> [#uses=1]
  store <4 x float> %call427, <4 x float>* %callValue386
  %tmp428 = load <4 x float>, <4 x float>* %callValue386       ; <<4 x float>> [#uses=1]
  %tmp429 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add430 = fadd <4 x float> %tmp429, %tmp428     ; <<4 x float>> [#uses=1]
  store <4 x float> %add430, <4 x float>* %sum
  %tmp431 = load <4 x float>, <4 x float>* %callValue386       ; <<4 x float>> [#uses=1]
  %tmp432 = load <4 x float>, <4 x float>* %callValue386       ; <<4 x float>> [#uses=1]
  %mul433 = fmul <4 x float> %tmp431, %tmp432     ; <<4 x float>> [#uses=1]
  %tmp434 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add435 = fadd <4 x float> %tmp434, %mul433     ; <<4 x float>> [#uses=1]
  store <4 x float> %add435, <4 x float>* %sum2
  %tmp436 = load i32, i32* %i379                       ; <i32> [#uses=1]
...
for.inc439:                                       ; preds = %for.end438
  %tmp440 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %add441 = add nsw i32 %tmp440, 512              ; <i32> [#uses=1]
  store i32 %add441, i32* %pos
  br label %for.cond275

for.end442:                                       ; preds = %for.cond275
  %tmp443 = load i32, i32* %boundary23                 ; <i32> [#uses=1]
  %tmp444 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %sub445 = sub i32 %tmp443, %tmp444              ; <i32> [#uses=1]
  store i32 %sub445, i32* %n
  %tmp446 = load i32, i32* %n                          ; <i32> [#uses=1]
  %cmp447 = icmp sgt i32 %tmp446, 0               ; <i1> [#uses=1]
  br i1 %cmp447, label %if.then449, label %if.end530

if.then449:                                       ; preds = %for.end442
  %arraydecay450 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %tmp451 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp452 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp453 = load i32, i32* %n                          ; <i32> [#uses=1]
  %add454 = add nsw i32 %tmp452, %tmp453          ; <i32> [#uses=1]
  %sub455 = sub i32 %add454, 1                    ; <i32> [#uses=1]
  %tmp456 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %tmp457 = load i32, i32* %threadId                   ; <i32> [#uses=1]
...
for.cond460:                                      ; preds = %for.inc484, %if.then449
  %tmp461 = load i32, i32* %i459                       ; <i32> [#uses=1]
  %tmp462 = load i32, i32* %n                          ; <i32> [#uses=1]
  %cmp463 = icmp slt i32 %tmp461, %tmp462         ; <i1> [#uses=1]
  br i1 %cmp463, label %for.body465, label %for.end487

for.body465:                                      ; preds = %for.cond460
  %tmp466 = load i32, i32* %i459                       ; <i32> [#uses=1]
  %shr467 = ashr i32 %tmp466, 2                   ; <i32> [#uses=1]
  %arraydecay468 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx469 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay468, i32 %shr467 ; <<4 x float>*> [#uses=1]
  %tmp470 = load <4 x float>, <4 x float>* %arrayidx469        ; <<4 x float>> [#uses=1]
  %tmp471 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp475 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %call479 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add478) ; <<4 x float>> [#uses=1]
  %tmp480 = load i32, i32* %i459                       ; <i32> [#uses=1]
  %shr481 = ashr i32 %tmp480, 2                   ; <i32> [#uses=1]
  %arraydecay482 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx483 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay482, i32 %shr481 ; <<4 x float>*> [#uses=1]
  store <4 x float> %call479, <4 x float>* %arrayidx483
  br label %for.inc484

for.inc484:                                       ; preds = %for.body465
  %tmp485 = load i32, i32* %i459                       ; <i32> [#uses=1]
...
for.body495:                                      ; preds = %for.cond490
  ...
  %tmp501 = load i32, i32* %i489                       ; <i32> [#uses=1]
  %shr502 = ashr i32 %tmp501, 2                   ; <i32> [#uses=1]
  %arraydecay503 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx504 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay503, i32 %shr502 ; <<4 x float>*> [#uses=1]
  %tmp505 = load <4 x float>, <4 x float>* %arrayidx504        ; <<4 x float>> [#uses=1]
  %mul506 = fmul <4 x float> %splat500, %tmp505   ; <<4 x float>> [#uses=1]
  %tmp507 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp511 = load <4 x float>, <4 x float>* %callValue497       ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral512
  %tmp513 = load <4 x float>, <4 x float>* %.compoundliteral512 ; <<4 x float>> [#uses=1]
  %call514 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp511, <4 x float> %tmp513) ; <<4 x float>> [#uses=1]
  store <4 x float> %call514, <4 x float>* %callValue497
  %tmp515 = load <4 x float>, <4 x float>* %callValue497       ; <<4 x float>> [#uses=1]
  %tmp516 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add517 = fadd <4 x float> %tmp516, %tmp515     ; <<4 x float>> [#uses=1]
  store <4 x float> %add517, <4 x float>* %sum
  %tmp518 = load <4 x float>, <4 x float>* %callValue497       ; <<4 x float>> [#uses=1]
  %tmp519 = load <4 x float>, <4 x float>* %callValue497       ; <<4 x float>> [#uses=1]
  %mul520 = fmul <4 x float> %tmp518, %tmp519     ; <<4 x float>> [#uses=1]
  %tmp521 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add522 = fadd <4 x float> %tmp521, %mul520     ; <<4 x float>> [#uses=1]
  store <4 x float> %add522, <4 x float>* %sum2
  br label %for.inc523

for.inc523:                                       ; preds = %for.body495
  %tmp524 = load i32, i32* %i489                       ; <i32> [#uses=1]
  %add525 = add nsw i32 %tmp524, 4                ; <i32> [#uses=1]
  store i32 %add525, i32* %i489
  br label %for.cond490

for.end526:                                       ; preds = %for.cond490
  %tmp527 = load i32, i32* %n                          ; <i32> [#uses=1]
  %tmp528 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %add529 = add nsw i32 %tmp528, %tmp527          ; <i32> [#uses=1]
  store i32 %add529, i32* %pos
  br label %if.end530

if.end530:                                        ; preds = %for.end526, %for.end442
  %tmp531 = load i32, i32* %boundary23                 ; <i32> [#uses=1]
  store i32 %tmp531, i32* %pos
  br label %for.cond532

for.cond532:                                      ; preds = %for.inc660, %if.end530
  %tmp533 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp534 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
...
for.body539:                                      ; preds = %for.cond532
  %arraydecay540 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %tmp541 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp542 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %add543 = add nsw i32 %tmp542, 512              ; <i32> [#uses=1]
  %sub544 = sub i32 %add543, 1                    ; <i32> [#uses=1]
  %tmp545 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %tmp546 = load i32, i32* %threadId                   ; <i32> [#uses=1]
  %tmp547 = load i32, i32* %optionid                   ; <i32> [#uses=1]
...
for.cond550:                                      ; preds = %for.body554, %for.body539
  %tmp551 = load i32, i32* %i549                       ; <i32> [#uses=1]
  %cmp552 = icmp slt i32 %tmp551, 512             ; <i1> [#uses=1]
  br i1 %cmp552, label %for.body554, label %for.end595

for.body554:                                      ; preds = %for.cond550
  %tmp555 = load i32, i32* %i549                       ; <i32> [#uses=1]
  %shr556 = ashr i32 %tmp555, 2                   ; <i32> [#uses=1]
  %arraydecay557 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx558 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay557, i32 %shr556 ; <<4 x float>*> [#uses=1]
  %tmp559 = load <4 x float>, <4 x float>* %arrayidx558        ; <<4 x float>> [#uses=1]
  %tmp560 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp564 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %call568 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add567) ; <<4 x float>> [#uses=1]
  %tmp569 = load i32, i32* %i549                       ; <i32> [#uses=1]
  %shr570 = ashr i32 %tmp569, 2                   ; <i32> [#uses=1]
  %arraydecay571 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx572 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay571, i32 %shr570 ; <<4 x float>*> [#uses=1]
  store <4 x float> %call568, <4 x float>* %arrayidx572
  %tmp573 = load i32, i32* %i549                       ; <i32> [#uses=1]
  %add574 = add nsw i32 %tmp573, 4                ; <i32> [#uses=1]
  store i32 %add574, i32* %i549
  %tmp575 = load i32, i32* %i549                       ; <i32> [#uses=1]
  %shr576 = ashr i32 %tmp575, 2                   ; <i32> [#uses=1]
  %arraydecay577 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx578 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay577, i32 %shr576 ; <<4 x float>*> [#uses=1]
  %tmp579 = load <4 x float>, <4 x float>* %arrayidx578        ; <<4 x float>> [#uses=1]
  %tmp580 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp584 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %call588 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add587) ; <<4 x float>> [#uses=1]
  %tmp589 = load i32, i32* %i549                       ; <i32> [#uses=1]
  %shr590 = ashr i32 %tmp589, 2                   ; <i32> [#uses=1]
  %arraydecay591 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx592 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay591, i32 %shr590 ; <<4 x float>*> [#uses=1]
  store <4 x float> %call588, <4 x float>* %arrayidx592
  %tmp593 = load i32, i32* %i549                       ; <i32> [#uses=1]
...
for.body602:                                      ; preds = %for.cond598
  ...
  %tmp608 = load i32, i32* %i597                       ; <i32> [#uses=1]
  %shr609 = ashr i32 %tmp608, 2                   ; <i32> [#uses=1]
  %arraydecay610 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx611 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay610, i32 %shr609 ; <<4 x float>*> [#uses=1]
  %tmp612 = load <4 x float>, <4 x float>* %arrayidx611        ; <<4 x float>> [#uses=1]
  %mul613 = fmul <4 x float> %splat607, %tmp612   ; <<4 x float>> [#uses=1]
  %tmp614 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp618 = load <4 x float>, <4 x float>* %callValue604       ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral619
  %tmp620 = load <4 x float>, <4 x float>* %.compoundliteral619 ; <<4 x float>> [#uses=1]
  %call621 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp618, <4 x float> %tmp620) ; <<4 x float>> [#uses=1]
  store <4 x float> %call621, <4 x float>* %callValue604
  %tmp622 = load <4 x float>, <4 x float>* %callValue604       ; <<4 x float>> [#uses=1]
  %tmp623 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add624 = fadd <4 x float> %tmp623, %tmp622     ; <<4 x float>> [#uses=1]
  store <4 x float> %add624, <4 x float>* %sum
  %tmp625 = load <4 x float>, <4 x float>* %callValue604       ; <<4 x float>> [#uses=1]
  %tmp626 = load <4 x float>, <4 x float>* %callValue604       ; <<4 x float>> [#uses=1]
  %mul627 = fmul <4 x float> %tmp625, %tmp626     ; <<4 x float>> [#uses=1]
  %tmp628 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add629 = fadd <4 x float> %tmp628, %mul627     ; <<4 x float>> [#uses=1]
  store <4 x float> %add629, <4 x float>* %sum2
  %tmp630 = load i32, i32* %i597                       ; <i32> [#uses=1]
  %add631 = add nsw i32 %tmp630, 4                ; <i32> [#uses=1]
  store i32 %add631, i32* %i597
  %tmp632 = load float, float* %S                        ; <float> [#uses=1]
  ...
  %tmp635 = load i32, i32* %i597                       ; <i32> [#uses=1]
  %shr636 = ashr i32 %tmp635, 2                   ; <i32> [#uses=1]
  %arraydecay637 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx638 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay637, i32 %shr636 ; <<4 x float>*> [#uses=1]
  %tmp639 = load <4 x float>, <4 x float>* %arrayidx638        ; <<4 x float>> [#uses=1]
  %mul640 = fmul <4 x float> %splat634, %tmp639   ; <<4 x float>> [#uses=1]
  %tmp641 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp645 = load <4 x float>, <4 x float>* %callValue604       ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral646
  %tmp647 = load <4 x float>, <4 x float>* %.compoundliteral646 ; <<4 x float>> [#uses=1]
  %call648 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp645, <4 x float> %tmp647) ; <<4 x float>> [#uses=1]
  store <4 x float> %call648, <4 x float>* %callValue604
  %tmp649 = load <4 x float>, <4 x float>* %callValue604       ; <<4 x float>> [#uses=1]
  %tmp650 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add651 = fadd <4 x float> %tmp650, %tmp649     ; <<4 x float>> [#uses=1]
  store <4 x float> %add651, <4 x float>* %sum
  %tmp652 = load <4 x float>, <4 x float>* %callValue604       ; <<4 x float>> [#uses=1]
  %tmp653 = load <4 x float>, <4 x float>* %callValue604       ; <<4 x float>> [#uses=1]
  %mul654 = fmul <4 x float> %tmp652, %tmp653     ; <<4 x float>> [#uses=1]
  %tmp655 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add656 = fadd <4 x float> %tmp655, %mul654     ; <<4 x float>> [#uses=1]
  store <4 x float> %add656, <4 x float>* %sum2
  %tmp657 = load i32, i32* %i597                       ; <i32> [#uses=1]
...
for.inc660:                                       ; preds = %for.end659
  %tmp661 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %add662 = add nsw i32 %tmp661, 512              ; <i32> [#uses=1]
  store i32 %add662, i32* %pos
  br label %for.cond532

for.end663:                                       ; preds = %for.cond532
  %tmp664 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %tmp665 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %sub666 = sub i32 %tmp664, %tmp665              ; <i32> [#uses=1]
  store i32 %sub666, i32* %n
  %tmp667 = load i32, i32* %n                          ; <i32> [#uses=1]
  %cmp668 = icmp sgt i32 %tmp667, 0               ; <i1> [#uses=1]
  br i1 %cmp668, label %if.then670, label %if.end755

if.then670:                                       ; preds = %for.end663
  %arraydecay671 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %tmp672 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp673 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %tmp674 = load i32, i32* %n                          ; <i32> [#uses=1]
  %add675 = add nsw i32 %tmp673, %tmp674          ; <i32> [#uses=1]
  %sub676 = sub i32 %add675, 1                    ; <i32> [#uses=1]
  %tmp677 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %tmp678 = load i32, i32* %threadId                   ; <i32> [#uses=1]
  %tmp679 = load i32, i32* %optionid                   ; <i32> [#uses=1]
...
for.cond682:                                      ; preds = %for.inc705, %if.then670
  %tmp683 = load i32, i32* %i681                       ; <i32> [#uses=1]
  %tmp684 = load i32, i32* %n                          ; <i32> [#uses=1]
  %cmp685 = icmp slt i32 %tmp683, %tmp684         ; <i1> [#uses=1]
  br i1 %cmp685, label %for.body687, label %for.end708

for.body687:                                      ; preds = %for.cond682
  %tmp688 = load i32, i32* %i681                       ; <i32> [#uses=1]
  %shr689 = ashr i32 %tmp688, 2                   ; <i32> [#uses=1]
  %arraydecay690 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %sample, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx691 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay690, i32 %shr689 ; <<4 x float>*> [#uses=1]
  %tmp692 = load <4 x float>, <4 x float>* %arrayidx691        ; <<4 x float>> [#uses=1]
  %tmp693 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp697 = load float, float* %MuByT                    ; <float> [#uses=1]
  ...
  %tmp701 = load i32, i32* %i681                       ; <i32> [#uses=1]
  %shr702 = ashr i32 %tmp701, 2                   ; <i32> [#uses=1]
  %arraydecay703 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx704 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay703, i32 %shr702 ; <<4 x float>*> [#uses=1]
  store <4 x float> %add700, <4 x float>* %arrayidx704
  br label %for.inc705

for.inc705:                                       ; preds = %for.body687
  %tmp706 = load i32, i32* %i681                       ; <i32> [#uses=1]
  %add707 = add nsw i32 %tmp706, 4                ; <i32> [#uses=1]
  store i32 %add707, i32* %i681
  br label %for.cond682

for.end708:                                       ; preds = %for.cond682
  %tmp709 = load i32, i32* %n                          ; <i32> [#uses=1]
  %arraydecay710 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arraydecay711 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %tmp712 = load i32, i32* %threadId                   ; <i32> [#uses=1]
...
for.body720:                                      ; preds = %for.cond715
  ...
  %tmp726 = load i32, i32* %i714                       ; <i32> [#uses=1]
  %shr727 = ashr i32 %tmp726, 2                   ; <i32> [#uses=1]
  %arraydecay728 = getelementptr inbounds [128 x <4 x float>], [128 x <4 x float>]* %temp, i32 0, i32 0 ; <<4 x float>*> [#uses=1]
  %arrayidx729 = getelementptr inbounds <4 x float>, <4 x float>* %arraydecay728, i32 %shr727 ; <<4 x float>*> [#uses=1]
  %tmp730 = load <4 x float>, <4 x float>* %arrayidx729        ; <<4 x float>> [#uses=1]
  %mul731 = fmul <4 x float> %splat725, %tmp730   ; <<4 x float>> [#uses=1]
  %tmp732 = load float, float* %X                        ; <float> [#uses=1]
  ...
  %tmp736 = load <4 x float>, <4 x float>* %callValue722       ; <<4 x float>> [#uses=1]
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral737
  %tmp738 = load <4 x float>, <4 x float>* %.compoundliteral737 ; <<4 x float>> [#uses=1]
  %call739 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp736, <4 x float> %tmp738) ; <<4 x float>> [#uses=1]
  store <4 x float> %call739, <4 x float>* %callValue722
  %tmp740 = load <4 x float>, <4 x float>* %callValue722       ; <<4 x float>> [#uses=1]
  %tmp741 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %add742 = fadd <4 x float> %tmp741, %tmp740     ; <<4 x float>> [#uses=1]
  store <4 x float> %add742, <4 x float>* %sum
  %tmp743 = load <4 x float>, <4 x float>* %callValue722       ; <<4 x float>> [#uses=1]
  %tmp744 = load <4 x float>, <4 x float>* %callValue722       ; <<4 x float>> [#uses=1]
  %mul745 = fmul <4 x float> %tmp743, %tmp744     ; <<4 x float>> [#uses=1]
  %tmp746 = load <4 x float>, <4 x float>* %sum2               ; <<4 x float>> [#uses=1]
  %add747 = fadd <4 x float> %tmp746, %mul745     ; <<4 x float>> [#uses=1]
  store <4 x float> %add747, <4 x float>* %sum2
  br label %for.inc748

for.inc748:                                       ; preds = %for.body720
  %tmp749 = load i32, i32* %i714                       ; <i32> [#uses=1]
  %add750 = add nsw i32 %tmp749, 4                ; <i32> [#uses=1]
  store i32 %add750, i32* %i714
  br label %for.cond715

for.end751:                                       ; preds = %for.cond715
  %tmp752 = load i32, i32* %n                          ; <i32> [#uses=1]
  %tmp753 = load i32, i32* %pos                        ; <i32> [#uses=1]
  %add754 = add nsw i32 %tmp753, %tmp752          ; <i32> [#uses=1]
  store i32 %add754, i32* %pos
  br label %if.end755

if.end755:                                        ; preds = %for.end751, %for.end663
  %tmp757 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %tmp758 = extractelement <4 x float> %tmp757, i32 0 ; <float> [#uses=1]
  %tmp759 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %tmp760 = extractelement <4 x float> %tmp759, i32 1 ; <float> [#uses=1]
  %add761 = fadd float %tmp758, %tmp760           ; <float> [#uses=1]
  %tmp762 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  %tmp763 = extractelement <4 x float> %tmp762, i32 2 ; <float> [#uses=1]
  %add764 = fadd float %add761, %tmp763           ; <float> [#uses=1]
  %tmp765 = load <4 x float>, <4 x float>* %sum                ; <<4 x float>> [#uses=1]
  ...
  %tmp781 = load float, float* %R                        ; <float> [#uses=1]
  %neg = fsub float -0.000000e+000, %tmp781       ; <float> [#uses=1]
  %tmp782 = load float, float* %T                        ; <float> [#uses=1]
  ...
  %tmp785 = load float, float* %ExpRT                    ; <float> [#uses=1]
  %tmp786 = load float, float* %totalsum                 ; <float> [#uses=1]
  %mul787 = fmul float %tmp785, %tmp786           ; <float> [#uses=1]
  %tmp788 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  ...
  %tmp792 = load i32, i32* %optionid                   ; <i32> [#uses=1]
  %tmp793 = load %struct.anon addrspace(1)*, %struct.anon addrspace(1)** %pOptionValue.addr ; <%struct.anon addrspace(1)*> [#uses=1]
  %arrayidx794 = getelementptr inbounds %struct.anon, %struct.anon addrspace(1)* %tmp793, i32 %tmp792 ; <%struct.anon addrspace(1)*> [#uses=1]
  %tmp795 = getelementptr inbounds %struct.anon, %struct.anon addrspace(1)* %arrayidx794, i32 0, i32 0 ; <float addrspace(1)*> [#uses=1]
  store float %div791, float addrspace(1)* %tmp795
  %tmp797 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %conv798 = sitofp i32 %tmp797 to float          ; <float> [#uses=1]
  %tmp799 = load float, float* %totalsum2                ; <float> [#uses=1]
  %mul800 = fmul float %conv798, %tmp799          ; <float> [#uses=1]
  %tmp801 = load float, float* %totalsum                 ; <float> [#uses=1]
  %tmp802 = load float, float* %totalsum                 ; <float> [#uses=1]
  %mul803 = fmul float %tmp801, %tmp802           ; <float> [#uses=1]
  %sub804 = fsub float %mul800, %mul803           ; <float> [#uses=1]
  %tmp805 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %conv806 = sitofp i32 %tmp805 to float          ; <float> [#uses=1]
  %tmp807 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  ...
  %tmp829 = load i32, i32* %optionid                   ; <i32> [#uses=1]
  %tmp830 = load %struct.anon addrspace(1)*, %struct.anon addrspace(1)** %pOptionValue.addr ; <%struct.anon addrspace(1)*> [#uses=1]
  %arrayidx831 = getelementptr inbounds %struct.anon, %struct.anon addrspace(1)* %tmp830, i32 %tmp829 ; <%struct.anon addrspace(1)*> [#uses=1]
  %tmp832 = getelementptr inbounds %struct.anon, %struct.anon addrspace(1)* %arrayidx831, i32 0, i32 1 ; <float addrspace(1)*> [#uses=1]
...
declare <4 x float> @_Z3maxU8__vector4fS_(<4 x float>, <4 x float>)
...
entry:
  ...
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral
  %tmp42 = load <4 x float>, <4 x float>* %.compoundliteral    ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp42, <4 x float>* %zero4
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral44
  %tmp45 = load <4 x float>, <4 x float>* %.compoundliteral44  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp45, <4 x float>* %sum
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral47
  %tmp48 = load <4 x float>, <4 x float>* %.compoundliteral47  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp48, <4 x float>* %sum2
  store i32 0, i32* %pos
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %tmp49 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp50 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
  %sub51 = sub i32 %tmp50, 3                      ; <i32> [#uses=1]
  %cmp = icmp slt i32 %tmp49, %sub51              ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp53 = load float, float* %S                         ; <float> [#uses=1]
  ...
  %tmp55 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %shr = ashr i32 %tmp55, 2                       ; <i32> [#uses=1]
  %tmp56 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %pSamples.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx57 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp56, i32 %shr ; <<4 x float> addrspace(1)*> [#uses=1]
  %tmp58 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx57 ; <<4 x float>> [#uses=1]
  %tmp59 = load float, float* %VBySqrtT                  ; <float> [#uses=1]
  ...
  %tmp63 = load float, float* %MuByT                     ; <float> [#uses=1]
  ...
  %call66 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %add) ; <<4 x float>> [#uses=1]
  %mul67 = fmul <4 x float> %splat, %call66       ; <<4 x float>> [#uses=1]
  %tmp68 = load float, float* %X                         ; <float> [#uses=1]
  ...
  %tmp72 = load <4 x float>, <4 x float>* %callValue           ; <<4 x float>> [#uses=1]
  %tmp73 = load <4 x float>, <4 x float>* %zero4               ; <<4 x float>> [#uses=1]
  %call74 = call <4 x float> @_Z3maxU8__vector4fS_(<4 x float> %tmp72, <4 x float> %tmp73) ; <<4 x float>> [#uses=1]
  store <4 x float> %call74, <4 x float>* %callValue
  %tmp75 = load <4 x float>, <4 x float>* %callValue           ; <<4 x float>> [#uses=1]
  %tmp76 = load <4 x float>, <4 x float>* %sum                 ; <<4 x float>> [#uses=1]
  %add77 = fadd <4 x float> %tmp76, %tmp75        ; <<4 x float>> [#uses=1]
  store <4 x float> %add77, <4 x float>* %sum
  %tmp78 = load <4 x float>, <4 x float>* %callValue           ; <<4 x float>> [#uses=1]
  %tmp79 = load <4 x float>, <4 x float>* %callValue           ; <<4 x float>> [#uses=1]
  %mul80 = fmul <4 x float> %tmp78, %tmp79        ; <<4 x float>> [#uses=1]
  %tmp81 = load <4 x float>, <4 x float>* %sum2                ; <<4 x float>> [#uses=1]
  %add82 = fadd <4 x float> %tmp81, %mul80        ; <<4 x float>> [#uses=1]
  store <4 x float> %add82, <4 x float>* %sum2
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %tmp83 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %add84 = add nsw i32 %tmp83, 4                  ; <i32> [#uses=1]
  store i32 %add84, i32* %pos
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %tmp86 = load <4 x float>, <4 x float>* %sum                 ; <<4 x float>> [#uses=1]
  %tmp87 = extractelement <4 x float> %tmp86, i32 0 ; <float> [#uses=1]
  %tmp88 = load <4 x float>, <4 x float>* %sum                 ; <<4 x float>> [#uses=1]
  %tmp89 = extractelement <4 x float> %tmp88, i32 1 ; <float> [#uses=1]
  %add90 = fadd float %tmp87, %tmp89              ; <float> [#uses=1]
  %tmp91 = load <4 x float>, <4 x float>* %sum                 ; <<4 x float>> [#uses=1]
  %tmp92 = extractelement <4 x float> %tmp91, i32 2 ; <float> [#uses=1]
  %add93 = fadd float %add90, %tmp92              ; <float> [#uses=1]
  %tmp94 = load <4 x float>, <4 x float>* %sum                 ; <<4 x float>> [#uses=1]
  ...
  %tmp110 = load float, float* %R                        ; <float> [#uses=1]
  %neg = fsub float -0.000000e+000, %tmp110       ; <float> [#uses=1]
  %tmp111 = load float, float* %T                        ; <float> [#uses=1]
  ...
  %tmp114 = load float, float* %ExpRT                    ; <float> [#uses=1]
  %tmp115 = load float, float* %totalsum                 ; <float> [#uses=1]
  %mul116 = fmul float %tmp114, %tmp115           ; <float> [#uses=1]
  %tmp117 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  ...
  %tmp119 = load i32, i32* %optionid                   ; <i32> [#uses=1]
  %tmp120 = load %struct.anon addrspace(1)*, %struct.anon addrspace(1)** %pOptionValue.addr ; <%struct.anon addrspace(1)*> [#uses=1]
  %arrayidx121 = getelementptr inbounds %struct.anon, %struct.anon addrspace(1)* %tmp120, i32 %tmp119 ; <%struct.anon addrspace(1)*> [#uses=1]
  %tmp122 = getelementptr inbounds %struct.anon, %struct.anon addrspace(1)* %arrayidx121, i32 0, i32 0 ; <float addrspace(1)*> [#uses=1]
  store float %div, float addrspace(1)* %tmp122
  %tmp124 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %conv125 = sitofp i32 %tmp124 to float          ; <float> [#uses=1]
  %tmp126 = load float, float* %totalsum2                ; <float> [#uses=1]
  %mul127 = fmul float %conv125, %tmp126          ; <float> [#uses=1]
  %tmp128 = load float, float* %totalsum                 ; <float> [#uses=1]
  %tmp129 = load float, float* %totalsum                 ; <float> [#uses=1]
  %mul130 = fmul float %tmp128, %tmp129           ; <float> [#uses=1]
  %sub131 = fsub float %mul127, %mul130           ; <float> [#uses=1]
  %tmp132 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  ...
  %tmp156 = load i32, i32* %optionid                   ; <i32> [#uses=1]
  %tmp157 = load %struct.anon addrspace(1)*, %struct.anon addrspace(1)** %pOptionValue.addr ; <%struct.anon addrspace(1)*> [#uses=1]
  %arrayidx158 = getelementptr inbounds %struct.anon, %struct.anon addrspace(1)* %tmp157, i32 %tmp156 ; <%struct.anon addrspace(1)*> [#uses=1]
  %tmp159 = getelementptr inbounds %struct.anon, %struct.anon addrspace(1)* %arrayidx158, i32 0, i32 1 ; <float addrspace(1)*> [#uses=1]

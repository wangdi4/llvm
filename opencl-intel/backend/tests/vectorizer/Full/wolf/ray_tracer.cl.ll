...
entry:
  ...
  %tmp = load i32, i32* %numberOfSpheres.addr          ; <i32> [#uses=1]
  store i32 %tmp, i32 addrspace(1)* @g_numberOfSpheres
  %tmp1 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
  store i32 %tmp1, i32 addrspace(1)* @g_numberOfSphereParameters
  %tmp2 = load i32, i32* %maxRayShots.addr             ; <i32> [#uses=1]
  store i32 %tmp2, i32 addrspace(1)* @g_maxRayShots
  %tmp3 = load i32, i32* %renderWidth.addr             ; <i32> [#uses=1]
  %conv = sitofp i32 %tmp3 to float               ; <float> [#uses=1]
  store float %conv, float addrspace(1)* @g_renderWidth
  %tmp4 = load i32, i32* %renderHeight.addr            ; <i32> [#uses=1]
  %conv5 = sitofp i32 %tmp4 to float              ; <float> [#uses=1]
  store float %conv5, float addrspace(1)* @g_renderHeight
  %tmp6 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  store float addrspace(1)* %tmp6, float addrspace(1)** @g_pSphereArray
  %tmp7 = load float, float* %viewPlaneDistance.addr     ; <float> [#uses=1]
  store float %tmp7, float addrspace(1)* @g_viewPlaneDistance
  %tmp8 = load <4 x float>, <4 x float>* %lightPos.addr        ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp8, <4 x float> addrspace(1)* @g_lightPos
  %tmp9 = load <4 x float>, <4 x float>* %sphere0Position.addr ; <<4 x float>> [#uses=1]
  %tmp10 = extractelement <4 x float> %tmp9, i32 0 ; <float> [#uses=1]
  %tmp11 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %tmp11, i32 0 ; <float addrspace(1)*> [#uses=1]
  store float %tmp10, float addrspace(1)* %arrayidx
  %tmp12 = load <4 x float>, <4 x float>* %sphere0Position.addr ; <<4 x float>> [#uses=1]
  %tmp13 = extractelement <4 x float> %tmp12, i32 1 ; <float> [#uses=1]
  %tmp14 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx15 = getelementptr inbounds float, float addrspace(1)* %tmp14, i32 1 ; <float addrspace(1)*> [#uses=1]
  store float %tmp13, float addrspace(1)* %arrayidx15
  %tmp16 = load <4 x float>, <4 x float>* %sphere0Position.addr ; <<4 x float>> [#uses=1]
  %tmp17 = extractelement <4 x float> %tmp16, i32 2 ; <float> [#uses=1]
  %tmp18 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx19 = getelementptr inbounds float, float addrspace(1)* %tmp18, i32 2 ; <float addrspace(1)*> [#uses=1]
  store float %tmp17, float addrspace(1)* %arrayidx19
  %tmp20 = load <4 x float>, <4 x float>* %sphere0Position.addr ; <<4 x float>> [#uses=1]
  %tmp21 = extractelement <4 x float> %tmp20, i32 3 ; <float> [#uses=1]
  %tmp22 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx23 = getelementptr inbounds float, float addrspace(1)* %tmp22, i32 3 ; <float addrspace(1)*> [#uses=1]
  store float %tmp21, float addrspace(1)* %arrayidx23
  %tmp24 = load float, float* %sphere0Radius.addr        ; <float> [#uses=1]
  %tmp25 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx26 = getelementptr inbounds float, float addrspace(1)* %tmp25, i32 4 ; <float addrspace(1)*> [#uses=1]
  store float %tmp24, float addrspace(1)* %arrayidx26
  %tmp27 = load <4 x float>, <4 x float>* %sphere0Color.addr   ; <<4 x float>> [#uses=1]
  %tmp28 = extractelement <4 x float> %tmp27, i32 0 ; <float> [#uses=1]
  %tmp29 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx30 = getelementptr inbounds float, float addrspace(1)* %tmp29, i32 5 ; <float addrspace(1)*> [#uses=1]
  store float %tmp28, float addrspace(1)* %arrayidx30
  %tmp31 = load <4 x float>, <4 x float>* %sphere0Color.addr   ; <<4 x float>> [#uses=1]
  %tmp32 = extractelement <4 x float> %tmp31, i32 1 ; <float> [#uses=1]
  %tmp33 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx34 = getelementptr inbounds float, float addrspace(1)* %tmp33, i32 6 ; <float addrspace(1)*> [#uses=1]
  store float %tmp32, float addrspace(1)* %arrayidx34
  %tmp35 = load <4 x float>, <4 x float>* %sphere0Color.addr   ; <<4 x float>> [#uses=1]
  %tmp36 = extractelement <4 x float> %tmp35, i32 2 ; <float> [#uses=1]
  %tmp37 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx38 = getelementptr inbounds float, float addrspace(1)* %tmp37, i32 7 ; <float addrspace(1)*> [#uses=1]
  store float %tmp36, float addrspace(1)* %arrayidx38
  %tmp39 = load <4 x float>, <4 x float>* %sphere0Color.addr   ; <<4 x float>> [#uses=1]
  %tmp40 = extractelement <4 x float> %tmp39, i32 3 ; <float> [#uses=1]
  %tmp41 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx42 = getelementptr inbounds float, float addrspace(1)* %tmp41, i32 8 ; <float addrspace(1)*> [#uses=1]
  store float %tmp40, float addrspace(1)* %arrayidx42
  %tmp43 = load <4 x float>, <4 x float>* %sphere0Material.addr ; <<4 x float>> [#uses=1]
  %tmp44 = extractelement <4 x float> %tmp43, i32 0 ; <float> [#uses=1]
  %tmp45 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx46 = getelementptr inbounds float, float addrspace(1)* %tmp45, i32 9 ; <float addrspace(1)*> [#uses=1]
  store float %tmp44, float addrspace(1)* %arrayidx46
  %tmp47 = load <4 x float>, <4 x float>* %sphere0Material.addr ; <<4 x float>> [#uses=1]
  %tmp48 = extractelement <4 x float> %tmp47, i32 1 ; <float> [#uses=1]
  %tmp49 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx50 = getelementptr inbounds float, float addrspace(1)* %tmp49, i32 10 ; <float addrspace(1)*> [#uses=1]
  store float %tmp48, float addrspace(1)* %arrayidx50
  %tmp51 = load <4 x float>, <4 x float>* %sphere0Material.addr ; <<4 x float>> [#uses=1]
  %tmp52 = extractelement <4 x float> %tmp51, i32 2 ; <float> [#uses=1]
  %tmp53 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx54 = getelementptr inbounds float, float addrspace(1)* %tmp53, i32 11 ; <float addrspace(1)*> [#uses=1]
  store float %tmp52, float addrspace(1)* %arrayidx54
  %tmp55 = load <4 x float>, <4 x float>* %sphere0Material.addr ; <<4 x float>> [#uses=1]
  %tmp56 = extractelement <4 x float> %tmp55, i32 3 ; <float> [#uses=1]
  %tmp57 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx58 = getelementptr inbounds float, float addrspace(1)* %tmp57, i32 12 ; <float addrspace(1)*> [#uses=1]
  store float %tmp56, float addrspace(1)* %arrayidx58
  %tmp59 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx60 = getelementptr inbounds float, float addrspace(1)* %tmp59, i32 13 ; <float addrspace(1)*> [#uses=1]
  store float 0.000000e+000, float addrspace(1)* %arrayidx60
  %tmp61 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx62 = getelementptr inbounds float, float addrspace(1)* %tmp61, i32 14 ; <float addrspace(1)*> [#uses=1]
  store float -1.003000e+003, float addrspace(1)* %arrayidx62
  %tmp63 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx64 = getelementptr inbounds float, float addrspace(1)* %tmp63, i32 15 ; <float addrspace(1)*> [#uses=1]
  store float -8.000000e+000, float addrspace(1)* %arrayidx64
  %tmp65 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx66 = getelementptr inbounds float, float addrspace(1)* %tmp65, i32 16 ; <float addrspace(1)*> [#uses=1]
  store float 0.000000e+000, float addrspace(1)* %arrayidx66
  %tmp67 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx68 = getelementptr inbounds float, float addrspace(1)* %tmp67, i32 17 ; <float addrspace(1)*> [#uses=1]
  store float 1.000000e+003, float addrspace(1)* %arrayidx68
  %tmp69 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx70 = getelementptr inbounds float, float addrspace(1)* %tmp69, i32 18 ; <float addrspace(1)*> [#uses=1]
  store float 0x3FE3333340000000, float addrspace(1)* %arrayidx70
  %tmp71 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx72 = getelementptr inbounds float, float addrspace(1)* %tmp71, i32 19 ; <float addrspace(1)*> [#uses=1]
  store float 0x3FE3333340000000, float addrspace(1)* %arrayidx72
  %tmp73 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx74 = getelementptr inbounds float, float addrspace(1)* %tmp73, i32 20 ; <float addrspace(1)*> [#uses=1]
  store float 0x3FE3333340000000, float addrspace(1)* %arrayidx74
  %tmp75 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx76 = getelementptr inbounds float, float addrspace(1)* %tmp75, i32 21 ; <float addrspace(1)*> [#uses=1]
  store float 1.000000e+000, float addrspace(1)* %arrayidx76
  %tmp77 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx78 = getelementptr inbounds float, float addrspace(1)* %tmp77, i32 22 ; <float addrspace(1)*> [#uses=1]
  store float 0x3FB99999A0000000, float addrspace(1)* %arrayidx78
  %tmp79 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx80 = getelementptr inbounds float, float addrspace(1)* %tmp79, i32 23 ; <float addrspace(1)*> [#uses=1]
  store float 0x3FE99999A0000000, float addrspace(1)* %arrayidx80
  %tmp81 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx82 = getelementptr inbounds float, float addrspace(1)* %tmp81, i32 24 ; <float addrspace(1)*> [#uses=1]
  store float 5.000000e-001, float addrspace(1)* %arrayidx82
  %tmp83 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx84 = getelementptr inbounds float, float addrspace(1)* %tmp83, i32 25 ; <float addrspace(1)*> [#uses=1]
  store float 5.000000e-001, float addrspace(1)* %arrayidx84
  store i32 22, i32* %pbkVariable
  %tmp87 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %tmp89 = load i32, i32* %numberOfSpheres.addr        ; <i32> [#uses=1]
  %tmp90 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
  %mul91 = mul i32 %tmp89, %tmp90                 ; <i32> [#uses=1]
  %cmp = icmp ult i32 %tmp88, %mul91              ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp94 = load i32, i32* %pbkVariable                 ; <i32> [#uses=1]
  %conv95 = sitofp i32 %tmp94 to float            ; <float> [#uses=1]
  store float %conv95, float* %ifloat
  %tmp96 = load float, float* %ifloat                    ; <float> [#uses=1]
  ...
  %tmp99 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx100 = getelementptr inbounds float, float addrspace(1)* %tmp99, i32 %tmp98 ; <float addrspace(1)*> [#uses=1]
  store float %mul97, float addrspace(1)* %arrayidx100
  %tmp101 = load float, float* %ifloat                   ; <float> [#uses=1]
  ...
  %tmp106 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx107 = getelementptr inbounds float, float addrspace(1)* %tmp106, i32 %add ; <float addrspace(1)*> [#uses=1]
  store float %mul104, float addrspace(1)* %arrayidx107
  %tmp108 = load float, float* %ifloat                   ; <float> [#uses=1]
  ...
  %tmp115 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx116 = getelementptr inbounds float, float addrspace(1)* %tmp115, i32 %add114 ; <float addrspace(1)*> [#uses=1]
  store float %sub, float addrspace(1)* %arrayidx116
  %tmp117 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add118 = add nsw i32 %tmp117, 3                ; <i32> [#uses=1]
  %tmp119 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx120 = getelementptr inbounds float, float addrspace(1)* %tmp119, i32 %add118 ; <float addrspace(1)*> [#uses=1]
  store float 0.000000e+000, float addrspace(1)* %arrayidx120
  %tmp121 = load float, float* %ifloat                   ; <float> [#uses=1]
  ...
  %tmp130 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add131 = add nsw i32 %tmp130, 4                ; <i32> [#uses=1]
  %tmp132 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx133 = getelementptr inbounds float, float addrspace(1)* %tmp132, i32 %add131 ; <float addrspace(1)*> [#uses=1]
  store float %add129, float addrspace(1)* %arrayidx133
  %tmp134 = load float, float* %ifloat                   ; <float> [#uses=1]
  ...
  %tmp140 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add141 = add nsw i32 %tmp140, 5                ; <i32> [#uses=1]
  %tmp142 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx143 = getelementptr inbounds float, float addrspace(1)* %tmp142, i32 %add141 ; <float addrspace(1)*> [#uses=1]
  store float %add139, float addrspace(1)* %arrayidx143
  %tmp144 = load float, float* %ifloat                   ; <float> [#uses=1]
  ...
  %tmp150 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add151 = add nsw i32 %tmp150, 6                ; <i32> [#uses=1]
  %tmp152 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx153 = getelementptr inbounds float, float addrspace(1)* %tmp152, i32 %add151 ; <float addrspace(1)*> [#uses=1]
  store float %add149, float addrspace(1)* %arrayidx153
  %tmp154 = load float, float* %ifloat                   ; <float> [#uses=1]
  ...
  %tmp160 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add161 = add nsw i32 %tmp160, 7                ; <i32> [#uses=1]
  %tmp162 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx163 = getelementptr inbounds float, float addrspace(1)* %tmp162, i32 %add161 ; <float addrspace(1)*> [#uses=1]
  store float %add159, float addrspace(1)* %arrayidx163
  %tmp164 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add165 = add nsw i32 %tmp164, 8                ; <i32> [#uses=1]
  %tmp166 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx167 = getelementptr inbounds float, float addrspace(1)* %tmp166, i32 %add165 ; <float addrspace(1)*> [#uses=1]
  store float 1.000000e+000, float addrspace(1)* %arrayidx167
  %tmp168 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add169 = add nsw i32 %tmp168, 9                ; <i32> [#uses=1]
  %tmp170 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx171 = getelementptr inbounds float, float addrspace(1)* %tmp170, i32 %add169 ; <float addrspace(1)*> [#uses=1]
  store float 0x3FB99999A0000000, float addrspace(1)* %arrayidx171
  %tmp172 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add173 = add nsw i32 %tmp172, 10               ; <i32> [#uses=1]
  %tmp174 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx175 = getelementptr inbounds float, float addrspace(1)* %tmp174, i32 %add173 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp178 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx179 = getelementptr inbounds float, float addrspace(1)* %tmp178, i32 %add177 ; <float addrspace(1)*> [#uses=1]
  store float 1.000000e+000, float addrspace(1)* %arrayidx179
  %tmp180 = load float, float* %ifloat                   ; <float> [#uses=1]
  ...
  %tmp189 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx190 = getelementptr inbounds float, float addrspace(1)* %tmp189, i32 %add188 ; <float addrspace(1)*> [#uses=1]
  store float %call186, float addrspace(1)* %arrayidx190
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %tmp191 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
  %tmp192 = load i32, i32* %i                          ; <i32> [#uses=1]
  %add193 = add i32 %tmp192, %tmp191              ; <i32> [#uses=1]
  store i32 %add193, i32* %i
  %tmp194 = load i32, i32* %pbkVariable                ; <i32> [#uses=1]
...
entry:
  ...
  store i32 %numberOfSpheres, i32* %numberOfSpheres.addr
  store i32 %numberOfSphereParameters, i32* %numberOfSphereParameters.addr
  %tmp = load i32*, i32** %pHit.addr                    ; <i32*> [#uses=1]
  store i32 0, i32* %tmp
  %tmp1 = load float*, float** %pt.addr                   ; <float*> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %tmp4 = load i32, i32* %numberOfSpheres.addr         ; <i32> [#uses=1]
  %tmp5 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp7 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %tmp7, i32 %tmp6 ; <float addrspace(1)*> [#uses=1]
  %tmp8 = load float, float addrspace(1)* %arrayidx      ; <float> [#uses=1]
  ...
  %tmp10 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx11 = getelementptr inbounds float, float addrspace(1)* %tmp10, i32 %add ; <float addrspace(1)*> [#uses=1]
  %tmp12 = load float, float addrspace(1)* %arrayidx11   ; <float> [#uses=1]
  ...
  %tmp16 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx17 = getelementptr inbounds float, float addrspace(1)* %tmp16, i32 %add15 ; <float addrspace(1)*> [#uses=1]
  %tmp18 = load float, float addrspace(1)* %arrayidx17   ; <float> [#uses=1]
  ...
  %tmp26 = load <4 x float>, <4 x float>* %.compoundliteral    ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp26, <4 x float>* %spherePos
  %tmp27 = load i32, i32* %i                           ; <i32> [#uses=1]
  %add28 = add nsw i32 %tmp27, 4                  ; <i32> [#uses=1]
  %tmp29 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx30 = getelementptr inbounds float, float addrspace(1)* %tmp29, i32 %add28 ; <float addrspace(1)*> [#uses=1]
  %tmp31 = load float, float addrspace(1)* %arrayidx30   ; <float> [#uses=1]
  store float %tmp31, float* %sphereRadius
  %tmp32 = load <4 x float>, <4 x float>* %origin.addr         ; <<4 x float>> [#uses=1]
  %tmp33 = load <4 x float>, <4 x float>* %spherePos           ; <<4 x float>> [#uses=1]
  %sub = fsub <4 x float> %tmp32, %tmp33          ; <<4 x float>> [#uses=1]
  store <4 x float> %sub, <4 x float>* %sphereToOrigin
  %tmp34 = load <4 x float>, <4 x float>* %sphereToOrigin      ; <<4 x float>> [#uses=1]
  %tmp35 = load <4 x float>, <4 x float>* %dir.addr            ; <<4 x float>> [#uses=1]
  %call = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp34, <4 x float> %tmp35) ; <float> [#uses=1]
  store float %call, float* %B
  %tmp36 = load <4 x float>, <4 x float>* %sphereToOrigin      ; <<4 x float>> [#uses=1]
  %tmp37 = load <4 x float>, <4 x float>* %sphereToOrigin      ; <<4 x float>> [#uses=1]
  %call38 = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp36, <4 x float> %tmp37) ; <float> [#uses=1]
  %tmp39 = load float, float* %sphereRadius              ; <float> [#uses=1]
  %tmp40 = load float, float* %sphereRadius              ; <float> [#uses=1]
  %mul41 = fmul float %tmp39, %tmp40              ; <float> [#uses=1]
  %sub42 = fsub float %call38, %mul41             ; <float> [#uses=1]
  store float %sub42, float* %C
  %tmp43 = load float, float* %B                         ; <float> [#uses=1]
  %tmp44 = load float, float* %B                         ; <float> [#uses=1]
  %mul45 = fmul float %tmp43, %tmp44              ; <float> [#uses=1]
  %tmp46 = load float, float* %C                         ; <float> [#uses=1]
  %sub47 = fsub float %mul45, %tmp46              ; <float> [#uses=1]
  store float %sub47, float* %disc
  %tmp48 = load float, float* %disc                      ; <float> [#uses=1]
  %cmp49 = fcmp ogt float %tmp48, 0.000000e+000   ; <i1> [#uses=1]
  br i1 %cmp49, label %if.then, label %if.end68

if.then:                                          ; preds = %for.body
  %tmp50 = load float, float* %B                         ; <float> [#uses=1]
  %neg = fsub float -0.000000e+000, %tmp50        ; <float> [#uses=1]
  %tmp51 = load float, float* %disc                      ; <float> [#uses=1]
  %call52 = call float @_Z4sqrtf(float %tmp51)    ; <float> [#uses=1]
  %sub53 = fsub float %neg, %call52               ; <float> [#uses=1]
  store float %sub53, float* %curT
  %tmp54 = load float, float* %curT                      ; <float> [#uses=1]
...
land.lhs.true:                                    ; preds = %if.then
  %tmp57 = load float, float* %curT                      ; <float> [#uses=1]
  %tmp58 = load float*, float** %pt.addr                  ; <float*> [#uses=1]
  %tmp59 = load float, float* %tmp58                     ; <float> [#uses=1]
  %cmp60 = fcmp olt float %tmp57, %tmp59          ; <i1> [#uses=1]
  br i1 %cmp60, label %if.then62, label %if.end

if.then62:                                        ; preds = %land.lhs.true
  %tmp63 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp64 = load i32*, i32** %pSphereNum.addr            ; <i32*> [#uses=1]
  store i32 %tmp63, i32* %tmp64
  %tmp65 = load float, float* %curT                      ; <float> [#uses=1]
  %tmp66 = load float*, float** %pt.addr                  ; <float*> [#uses=1]
  store float %tmp65, float* %tmp66
  %tmp67 = load i32*, i32** %pHit.addr                  ; <i32*> [#uses=1]
...
for.inc:                                          ; preds = %if.end68
  %tmp69 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
...
for.end:                                          ; preds = %for.cond
  %tmp72 = load <4 x float>, <4 x float>* %origin.addr         ; <<4 x float>> [#uses=1]
  %tmp73 = load <4 x float>, <4 x float>* %dir.addr            ; <<4 x float>> [#uses=1]
  %tmp74 = load float*, float** %pt.addr                  ; <float*> [#uses=1]
  %tmp75 = load float, float* %tmp74                     ; <float> [#uses=1]
  ...
  %tmp79 = load <4 x float>*, <4 x float>** %pPos.addr          ; <<4 x float>*> [#uses=1]
...
entry:
  ...
  %tmp6 = load <2 x i32>, <2 x i32>* %pixel.addr             ; <<2 x i32>> [#uses=1]
  ...
  %tmp8 = load i32, i32* %renderWidth.addr             ; <i32> [#uses=1]
  ...
  %tmp10 = load <2 x i32>, <2 x i32>* %pixel.addr            ; <<2 x i32>> [#uses=1]
  ...
  %tmp14 = load i32, i32* %renderHeight.addr           ; <i32> [#uses=1]
  ...
  %tmp20 = load float, float* %viewPlaneDistance.addr    ; <float> [#uses=1]
  ...
  %tmp23 = load <4 x float>, <4 x float>* %.compoundliteral5   ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp23, <4 x float>* %dir
  %tmp43 = load i32, i32* %maxRayShots.addr            ; <i32> [#uses=1]
  ...
  %tmp46 = load <4 x float>, <4 x float>* %.compoundliteral45  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp46, <4 x float>* %colorScale
  br label %while.cond

while.cond:                                       ; preds = %if.end309, %entry
  %tmp52 = load i32, i32* %rayShots                    ; <i32> [#uses=1]
  %cmp53 = icmp sgt i32 %tmp52, 0                 ; <i1> [#uses=1]
  br i1 %cmp53, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %tmp55 = load <4 x float>, <4 x float>* %dir                 ; <<4 x float>> [#uses=1]
  %call = call <4 x float> @_Z9normalizeU8__vector4f(<4 x float> %tmp55) ; <<4 x float>> [#uses=1]
  store <4 x float> %call, <4 x float>* %dir
  %tmp56 = load <4 x float>, <4 x float>* %origin              ; <<4 x float>> [#uses=1]
  %tmp57 = load <4 x float>, <4 x float>* %dir                 ; <<4 x float>> [#uses=1]
  %tmp58 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %tmp59 = load i32, i32* %numberOfSpheres.addr        ; <i32> [#uses=1]
  %tmp60 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
  ...
  %tmp61 = load i32, i32* %hit                         ; <i32> [#uses=1]
  %cmp62 = icmp ne i32 %tmp61, 0                  ; <i1> [#uses=1]
  br i1 %cmp62, label %if.then, label %if.else308

if.then:                                          ; preds = %while.body
  %tmp65 = load i32, i32* %sphereNum                   ; <i32> [#uses=1]
  %tmp66 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %tmp66, i32 %tmp65 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp69 = load i32, i32* %sphereNum                   ; <i32> [#uses=1]
  %add70 = add nsw i32 %tmp69, 1                  ; <i32> [#uses=1]
  %tmp71 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx72 = getelementptr inbounds float, float addrspace(1)* %tmp71, i32 %add70 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp75 = load i32, i32* %sphereNum                   ; <i32> [#uses=1]
  %add76 = add nsw i32 %tmp75, 2                  ; <i32> [#uses=1]
  %tmp77 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx78 = getelementptr inbounds float, float addrspace(1)* %tmp77, i32 %add76 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp81 = load i32, i32* %sphereNum                   ; <i32> [#uses=1]
  %add82 = add nsw i32 %tmp81, 3                  ; <i32> [#uses=1]
  %tmp83 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx84 = getelementptr inbounds float, float addrspace(1)* %tmp83, i32 %add82 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp87 = load <4 x float>, <4 x float>* %.compoundliteral64  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp87, <4 x float>* %spherePos
  %tmp88 = load i32, i32* %sphereNum                   ; <i32> [#uses=1]
  %add89 = add nsw i32 %tmp88, 4                  ; <i32> [#uses=1]
  %tmp90 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx91 = getelementptr inbounds float, float addrspace(1)* %tmp90, i32 %add89 ; <float addrspace(1)*> [#uses=1]
  %tmp92 = load float, float addrspace(1)* %arrayidx91   ; <float> [#uses=1]
  store float %tmp92, float* %sphereRadius
  %tmp94 = load i32, i32* %sphereNum                   ; <i32> [#uses=1]
  %add95 = add nsw i32 %tmp94, 5                  ; <i32> [#uses=1]
  %tmp96 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx97 = getelementptr inbounds float, float addrspace(1)* %tmp96, i32 %add95 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp100 = load i32, i32* %sphereNum                  ; <i32> [#uses=1]
  %add101 = add nsw i32 %tmp100, 6                ; <i32> [#uses=1]
  %tmp102 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx103 = getelementptr inbounds float, float addrspace(1)* %tmp102, i32 %add101 ; <float addrspace(1)*> [#uses=1]
  %tmp104 = load float, float addrspace(1)* %arrayidx103 ; <float> [#uses=1]
  %vecinit105 = insertelement <4 x float> %vecinit99, float %tmp104, i32 1 ; <<4 x float>> [#uses=1]
  %tmp106 = load i32, i32* %sphereNum                  ; <i32> [#uses=1]
  %add107 = add nsw i32 %tmp106, 7                ; <i32> [#uses=1]
  %tmp108 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx109 = getelementptr inbounds float, float addrspace(1)* %tmp108, i32 %add107 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp112 = load i32, i32* %sphereNum                  ; <i32> [#uses=1]
  %add113 = add nsw i32 %tmp112, 8                ; <i32> [#uses=1]
  %tmp114 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx115 = getelementptr inbounds float, float addrspace(1)* %tmp114, i32 %add113 ; <float addrspace(1)*> [#uses=1]
  %tmp116 = load float, float addrspace(1)* %arrayidx115 ; <float> [#uses=1]
  ...
  %tmp118 = load <4 x float>, <4 x float>* %.compoundliteral93 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp118, <4 x float>* %sphereColor
  %tmp120 = load i32, i32* %sphereNum                  ; <i32> [#uses=1]
  %add121 = add nsw i32 %tmp120, 9                ; <i32> [#uses=1]
  %tmp122 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx123 = getelementptr inbounds float, float addrspace(1)* %tmp122, i32 %add121 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp126 = load i32, i32* %sphereNum                  ; <i32> [#uses=1]
  %add127 = add nsw i32 %tmp126, 10               ; <i32> [#uses=1]
  %tmp128 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx129 = getelementptr inbounds float, float addrspace(1)* %tmp128, i32 %add127 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp132 = load i32, i32* %sphereNum                  ; <i32> [#uses=1]
  %add133 = add nsw i32 %tmp132, 11               ; <i32> [#uses=1]
  %tmp134 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx135 = getelementptr inbounds float, float addrspace(1)* %tmp134, i32 %add133 ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp138 = load i32, i32* %sphereNum                  ; <i32> [#uses=1]
  %add139 = add nsw i32 %tmp138, 12               ; <i32> [#uses=1]
  %tmp140 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx141 = getelementptr inbounds float, float addrspace(1)* %tmp140, i32 %add139 ; <float addrspace(1)*> [#uses=1]
  %tmp142 = load float, float addrspace(1)* %arrayidx141 ; <float> [#uses=1]
  ...
  %tmp144 = load <4 x float>, <4 x float>* %.compoundliteral119 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp144, <4 x float>* %sphereMaterial
  %tmp145 = load <4 x float>, <4 x float>* %hitPoint           ; <<4 x float>> [#uses=1]
  %tmp146 = load <4 x float>, <4 x float>* %spherePos          ; <<4 x float>> [#uses=1]
  %sub147 = fsub <4 x float> %tmp145, %tmp146     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub147, <4 x float>* %sphereHit
  %tmp148 = load <4 x float>, <4 x float>* %sphereHit          ; <<4 x float>> [#uses=1]
  %tmp149 = load float, float* %sphereRadius             ; <float> [#uses=1]
  ...
  %tmp154 = load <4 x float>, <4 x float>* %lightPos.addr      ; <<4 x float>> [#uses=1]
  %tmp155 = load <4 x float>, <4 x float>* %hitPoint           ; <<4 x float>> [#uses=1]
  %sub156 = fsub <4 x float> %tmp154, %tmp155     ; <<4 x float>> [#uses=1]
  store <4 x float> %sub156, <4 x float>* %lightVector
  %tmp157 = load <4 x float>, <4 x float>* %lightVector        ; <<4 x float>> [#uses=1]
  %call158 = call float @_Z6lengthU8__vector4f(<4 x float> %tmp157) ; <float> [#uses=1]
  store float %call158, float* %lightVectorLen
  %tmp159 = load <4 x float>, <4 x float>* %lightVector        ; <<4 x float>> [#uses=1]
  %tmp160 = load float, float* %lightVectorLen           ; <float> [#uses=1]
  ...
  %tmp166 = load <4 x float>, <4 x float>* %hitPoint           ; <<4 x float>> [#uses=1]
  %tmp167 = load <4 x float>, <4 x float>* %l                  ; <<4 x float>> [#uses=1]
  %tmp168 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %tmp169 = load i32, i32* %numberOfSpheres.addr       ; <i32> [#uses=1]
  %tmp170 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
  ...
  %tmp171 = load i32, i32* %shadowTest                 ; <i32> [#uses=1]
...
if.else:                                          ; preds = %if.then
  %tmp175 = load float, float* %t                        ; <float> [#uses=1]
  %tmp176 = load float, float* %lightVectorLen           ; <float> [#uses=1]
...
if.end180:                                        ; preds = %if.end, %if.then174
  %tmp181 = load <4 x float>, <4 x float>* %l                  ; <<4 x float>> [#uses=1]
  %tmp182 = load <4 x float>, <4 x float>* %n                  ; <<4 x float>> [#uses=1]
  %call183 = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp181, <4 x float> %tmp182) ; <float> [#uses=1]
  store float %call183, float* %diffuse
  %tmp184 = load <4 x float>, <4 x float>* %l                  ; <<4 x float>> [#uses=1]
  %tmp185 = load float, float* %diffuse                  ; <float> [#uses=1]
  ...
  %tmp189 = load <4 x float>, <4 x float>* %n                  ; <<4 x float>> [#uses=1]
  ...
  %tmp192 = load <4 x float>, <4 x float>* %dir                ; <<4 x float>> [#uses=1]
  %tmp193 = load <4 x float>, <4 x float>* %lReflect           ; <<4 x float>> [#uses=1]
  %call194 = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp192, <4 x float> %tmp193) ; <float> [#uses=1]
  store float %call194, float* %specular
  %tmp195 = load float, float* %diffuse                  ; <float> [#uses=1]
  %call196 = call float @_Z3maxff(float %tmp195, float 0.000000e+000) ; <float> [#uses=1]
  store float %call196, float* %diffuse
  %tmp197 = load float, float* %specular                 ; <float> [#uses=1]
  ...
  %tmp201 = load i32, i32* %sphereNum                  ; <i32> [#uses=1]
...
if.then204:                                       ; preds = %if.end180
  ...
  %tmp206 = load <4 x float>, <4 x float>* %.compoundliteral205 ; <<4 x float>> [#uses=1]
  %tmp207 = load <4 x float>, <4 x float>* %n                  ; <<4 x float>> [#uses=1]
  %call208 = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp206, <4 x float> %tmp207) ; <float> [#uses=1]
  ...
  %tmp213 = load <4 x float>, <4 x float>* %.compoundliteral212 ; <<4 x float>> [#uses=1]
  %tmp214 = load <4 x float>, <4 x float>* %n                  ; <<4 x float>> [#uses=1]
  %call215 = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp213, <4 x float> %tmp214) ; <float> [#uses=1]
  %tmp216 = load float, float* %phi                      ; <float> [#uses=1]
  ...
  %tmp222 = load float, float addrspace(1)* @PI          ; <float> [#uses=1]
  ...
  %tmp228 = load float, float* %phi                      ; <float> [#uses=1]
  %tmp229 = load float, float addrspace(1)* @PI          ; <float> [#uses=3]
  ...
  %tmp234 = load <2 x float>, <2 x float>* %.compoundliteral211 ; <<2 x float>> [#uses=1]
  store <2 x float> %tmp234, <2 x float>* %uv
  %tmp235 = load <2 x float>, <2 x float>* %uv                 ; <<2 x float>> [#uses=1]
  ...
  %tmp239 = load <2 x float>, <2 x float>* %uv                 ; <<2 x float>> [#uses=1]
  ...
  %tmp249 = load <4 x float>, <4 x float>* %sphereColor        ; <<4 x float>> [#uses=1]
...
if.end251:                                        ; preds = %if.then204, %if.end180
  %tmp252 = load <4 x float>, <4 x float>* %sphereMaterial     ; <<4 x float>> [#uses=1]
  %tmp253 = extractelement <4 x float> %tmp252, i32 0 ; <float> [#uses=1]
  %tmp254 = load i32, i32* %shadowTest                 ; <i32> [#uses=1]
  %conv255 = sitofp i32 %tmp254 to float          ; <float> [#uses=1]
  %tmp256 = load float, float* %diffuse                  ; <float> [#uses=1]
  %tmp257 = load <4 x float>, <4 x float>* %sphereMaterial     ; <<4 x float>> [#uses=1]
  %tmp258 = extractelement <4 x float> %tmp257, i32 1 ; <float> [#uses=1]
  %mul259 = fmul float %tmp256, %tmp258           ; <float> [#uses=1]
  %tmp260 = load float, float* %specular                 ; <float> [#uses=1]
  %tmp261 = load <4 x float>, <4 x float>* %sphereMaterial     ; <<4 x float>> [#uses=1]
  ...
  %tmp267 = load <4 x float>, <4 x float>* %colorScale         ; <<4 x float>> [#uses=1]
  %tmp268 = load float, float* %lightVal                 ; <float> [#uses=1]
  ...
  %tmp272 = load <4 x float>, <4 x float>* %sphereColor        ; <<4 x float>> [#uses=1]
  %mul273 = fmul <4 x float> %mul271, %tmp272     ; <<4 x float>> [#uses=1]
  %tmp274 = load <4 x float>, <4 x float>* %dst                ; <<4 x float>> [#uses=1]
  %add275 = fadd <4 x float> %tmp274, %mul273     ; <<4 x float>> [#uses=1]
  store <4 x float> %add275, <4 x float>* %dst
  %tmp276 = load <4 x float>, <4 x float>* %dst                ; <<4 x float>> [#uses=1]
  %call277 = call <4 x float> @_Z5clampU8__vector4fff(<4 x float> %tmp276, float 0.000000e+000, float 1.000000e+000) ; <<4 x float>> [#uses=1]
  store <4 x float> %call277, <4 x float>* %dst
  %tmp278 = load <4 x float>, <4 x float>* %sphereMaterial     ; <<4 x float>> [#uses=1]
...
if.then282:                                       ; preds = %if.end251
  %tmp283 = load <4 x float>, <4 x float>* %dir                ; <<4 x float>> [#uses=1]
  %tmp284 = load <4 x float>, <4 x float>* %dir                ; <<4 x float>> [#uses=1]
  %tmp285 = load <4 x float>, <4 x float>* %n                  ; <<4 x float>> [#uses=1]
  %call286 = call float @_Z3dotU8__vector4fS_(<4 x float> %tmp284, <4 x float> %tmp285) ; <float> [#uses=1]
  ...
  %tmp290 = load <4 x float>, <4 x float>* %n                  ; <<4 x float>> [#uses=1]
  ...
  %tmp293 = load <4 x float>, <4 x float>* %dirReflect         ; <<4 x float>> [#uses=1]
  %call294 = call <4 x float> @_Z9normalizeU8__vector4f(<4 x float> %tmp293) ; <<4 x float>> [#uses=1]
  store <4 x float> %call294, <4 x float>* %dirReflect
  %tmp295 = load <4 x float>, <4 x float>* %hitPoint           ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp295, <4 x float>* %origin
  %tmp296 = load <4 x float>, <4 x float>* %dirReflect         ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp296, <4 x float>* %dir
  %tmp297 = load i32, i32* %rayShots                   ; <i32> [#uses=1]
  %dec = add nsw i32 %tmp297, -1                  ; <i32> [#uses=1]
  store i32 %dec, i32* %rayShots
  %tmp298 = load <4 x float>, <4 x float>* %sphereMaterial     ; <<4 x float>> [#uses=1]
  ...
  %tmp302 = load <4 x float>, <4 x float>* %sphereColor        ; <<4 x float>> [#uses=1]
  %mul303 = fmul <4 x float> %splat301, %tmp302   ; <<4 x float>> [#uses=1]
  %tmp304 = load <4 x float>, <4 x float>* %colorScale         ; <<4 x float>> [#uses=1]
...
while.end:                                        ; preds = %while.cond
  %tmp310 = load <4 x float>, <4 x float>* %dst                ; <<4 x float>> [#uses=1]
...
entry:
  ...
  %tmp1 = load <4 x float>, <4 x float>* %result               ; <<4 x float>> [#uses=1]
...
entry:
  ...
  %tmp = load i32, i32* %renderWidth.addr              ; <i32> [#uses=1]
  %tmp2 = load i32, i32* %renderHeight.addr            ; <i32> [#uses=1]
  %mul = mul i32 %tmp, %tmp2                      ; <i32> [#uses=1]
  %tmp3 = load i32, i32* %global_size                  ; <i32> [#uses=2]
  ...
  %tmp5 = load i32, i32* %renderWidth.addr             ; <i32> [#uses=1]
  %tmp6 = load i32, i32* %renderHeight.addr            ; <i32> [#uses=1]
  %mul7 = mul i32 %tmp5, %tmp6                    ; <i32> [#uses=1]
  %tmp8 = load i32, i32* %global_id                    ; <i32> [#uses=1]
  %mul9 = mul i32 %mul7, %tmp8                    ; <i32> [#uses=1]
  %tmp10 = load i32, i32* %global_size                 ; <i32> [#uses=2]
  ...
  %tmp15 = load i32, i32* %renderHeight.addr           ; <i32> [#uses=1]
  %tmp16 = load i32, i32* %global_id                   ; <i32> [#uses=1]
  %mul17 = mul i32 %tmp15, %tmp16                 ; <i32> [#uses=1]
  %tmp18 = load i32, i32* %global_size                 ; <i32> [#uses=2]
  ...
  %tmp23 = load i32, i32* %index                       ; <i32> [#uses=1]
  %tmp24 = load i32, i32* %row                         ; <i32> [#uses=1]
  %tmp25 = load i32, i32* %renderWidth.addr            ; <i32> [#uses=1]
  %mul26 = mul i32 %tmp24, %tmp25                 ; <i32> [#uses=1]
  %sub = sub i32 %tmp23, %mul26                   ; <i32> [#uses=1]
  store i32 %sub, i32* %startingColumn
  %tmp28 = load i32, i32* %startingColumn              ; <i32> [#uses=1]
  store i32 %tmp28, i32* %column
  store i32 0, i32* %i
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %tmp31 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp32 = load i32, i32* %count                       ; <i32> [#uses=1]
  %cmp33 = icmp ult i32 %tmp31, %tmp32            ; <i1> [#uses=1]
  br i1 %cmp33, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp34 = load i32, i32* %column                      ; <i32> [#uses=1]
  %tmp35 = load <2 x i32>, <2 x i32>* %thePixel              ; <<2 x i32>> [#uses=1]
  %tmp36 = insertelement <2 x i32> %tmp35, i32 %tmp34, i32 0 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %tmp36, <2 x i32>* %thePixel
  %tmp37 = load i32, i32* %row                         ; <i32> [#uses=1]
  %tmp38 = load <2 x i32>, <2 x i32>* %thePixel              ; <<2 x i32>> [#uses=1]
  %tmp39 = insertelement <2 x i32> %tmp38, i32 %tmp37, i32 1 ; <<2 x i32>> [#uses=1]
  store <2 x i32> %tmp39, <2 x i32>* %thePixel
  %tmp40 = load float addrspace(1)*, float addrspace(1)** %pSphereArray.addr ; <float addrspace(1)*> [#uses=1]
  %tmp41 = load <2 x i32>, <2 x i32>* %thePixel              ; <<2 x i32>> [#uses=1]
  %tmp42 = load i32, i32* %numberOfSpheres.addr        ; <i32> [#uses=1]
  %tmp43 = load i32, i32* %numberOfSphereParameters.addr ; <i32> [#uses=1]
  %tmp44 = load i32, i32* %maxRayShots.addr            ; <i32> [#uses=1]
  %tmp45 = load i32, i32* %renderWidth.addr            ; <i32> [#uses=1]
  %tmp46 = load i32, i32* %renderHeight.addr           ; <i32> [#uses=1]
  %tmp47 = load float, float* %viewPlaneDistance.addr    ; <float> [#uses=1]
  %tmp48 = load <4 x float>, <4 x float>* %lightPos.addr       ; <<4 x float>> [#uses=1]
  ...
  %tmp50 = load i32, i32* %row                         ; <i32> [#uses=1]
  %tmp51 = load i32, i32* %renderWidth.addr            ; <i32> [#uses=1]
  %mul52 = mul i32 %tmp50, %tmp51                 ; <i32> [#uses=1]
  %tmp53 = load i32, i32* %column                      ; <i32> [#uses=1]
  %add = add i32 %mul52, %tmp53                   ; <i32> [#uses=1]
  %tmp54 = load <4 x float>*, <4 x float>** %pOutput.addr       ; <<4 x float>*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float>* %tmp54, i32 %add ; <<4 x float>*> [#uses=1]
  store <4 x float> %call49, <4 x float>* %arrayidx
  %tmp55 = load i32, i32* %column                      ; <i32> [#uses=1]
  %inc = add i32 %tmp55, 1                        ; <i32> [#uses=2]
  store i32 %inc, i32* %column
  %tmp56 = load i32, i32* %renderWidth.addr            ; <i32> [#uses=1]
  %cmp57 = icmp uge i32 %inc, %tmp56              ; <i1> [#uses=1]
  br i1 %cmp57, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %tmp58 = load i32, i32* %startingColumn              ; <i32> [#uses=1]
  store i32 %tmp58, i32* %column
  %tmp59 = load i32, i32* %row                         ; <i32> [#uses=1]

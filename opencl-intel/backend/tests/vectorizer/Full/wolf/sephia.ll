...
bb.nph6:                                          ; preds = %0
  ...
  %4 = getelementptr inbounds float, float addrspace(1)* %coef, i32 1 ; <float addrspace(1)*> [#uses=1]
  %5 = getelementptr inbounds float, float addrspace(1)* %coef, i32 2 ; <float addrspace(1)*> [#uses=1]
  %6 = getelementptr inbounds float, float addrspace(1)* %coef, i32 3 ; <float addrspace(1)*> [#uses=1]
  %7 = getelementptr inbounds float, float addrspace(1)* %coef, i32 16 ; <float addrspace(1)*> [#uses=1]
  %8 = getelementptr inbounds float, float addrspace(1)* %coef, i32 17 ; <float addrspace(1)*> [#uses=1]
  %9 = getelementptr inbounds float, float addrspace(1)* %coef, i32 18 ; <float addrspace(1)*> [#uses=1]
  %10 = getelementptr inbounds float, float addrspace(1)* %coef, i32 19 ; <float addrspace(1)*> [#uses=1]
  %11 = getelementptr inbounds float, float addrspace(1)* %coef, i32 32 ; <float addrspace(1)*> [#uses=1]
  %12 = getelementptr inbounds float, float addrspace(1)* %coef, i32 33 ; <float addrspace(1)*> [#uses=1]
  %13 = getelementptr inbounds float, float addrspace(1)* %coef, i32 34 ; <float addrspace(1)*> [#uses=1]
  %14 = getelementptr inbounds float, float addrspace(1)* %coef, i32 35 ; <float addrspace(1)*> [#uses=1]
  %15 = getelementptr inbounds float, float addrspace(1)* %coef, i32 48 ; <float addrspace(1)*> [#uses=1]
  %16 = getelementptr inbounds float, float addrspace(1)* %coef, i32 49 ; <float addrspace(1)*> [#uses=1]
  %17 = getelementptr inbounds float, float addrspace(1)* %coef, i32 50 ; <float addrspace(1)*> [#uses=1]
  %18 = getelementptr inbounds float, float addrspace(1)* %coef, i32 51 ; <float addrspace(1)*> [#uses=1]
  br label %19
...
bb.nph:                                           ; preds = %19, %bb.nph
  ...
  %28 = load float, float addrspace(1)* %4               ; <float> [#uses=1]
  %29 = load float, float addrspace(1)* %24              ; <float> [#uses=1]
  %30 = fmul float %28, %29                       ; <float> [#uses=2]
  %31 = or i32 %offset.01, 1                      ; <i32> [#uses=2]
  %32 = getelementptr inbounds float, float addrspace(1)* %dest, i32 %31 ; <float addrspace(1)*> [#uses=4]
  store float %30, float addrspace(1)* %32
  %33 = load float, float addrspace(1)* %5               ; <float> [#uses=1]
  %34 = load float, float addrspace(1)* %24              ; <float> [#uses=1]
  %35 = fmul float %33, %34                       ; <float> [#uses=2]
  %36 = or i32 %offset.01, 2                      ; <i32> [#uses=2]
  %37 = getelementptr inbounds float, float addrspace(1)* %dest, i32 %36 ; <float addrspace(1)*> [#uses=4]
  store float %35, float addrspace(1)* %37
  %38 = load float, float addrspace(1)* %6               ; <float> [#uses=1]
  %39 = load float, float addrspace(1)* %24              ; <float> [#uses=1]
  ...
  %48 = load float, float addrspace(1)* %8               ; <float> [#uses=1]
  %49 = load float, float addrspace(1)* %44              ; <float> [#uses=1]
  %50 = fmul float %48, %49                       ; <float> [#uses=1]
  %51 = fadd float %30, %50                       ; <float> [#uses=2]
  store float %51, float addrspace(1)* %32
  %52 = load float, float addrspace(1)* %9               ; <float> [#uses=1]
  %53 = load float, float addrspace(1)* %44              ; <float> [#uses=1]
  %54 = fmul float %52, %53                       ; <float> [#uses=1]
  %55 = fadd float %35, %54                       ; <float> [#uses=2]
  store float %55, float addrspace(1)* %37
  %56 = load float, float addrspace(1)* %10              ; <float> [#uses=1]
  %57 = load float, float addrspace(1)* %44              ; <float> [#uses=1]
  ...
  %65 = load float, float addrspace(1)* %12              ; <float> [#uses=1]
  %66 = load float, float addrspace(1)* %61              ; <float> [#uses=1]
  %67 = fmul float %65, %66                       ; <float> [#uses=1]
  %68 = fadd float %51, %67                       ; <float> [#uses=2]
  store float %68, float addrspace(1)* %32
  %69 = load float, float addrspace(1)* %13              ; <float> [#uses=1]
  %70 = load float, float addrspace(1)* %61              ; <float> [#uses=1]
  %71 = fmul float %69, %70                       ; <float> [#uses=1]
  %72 = fadd float %55, %71                       ; <float> [#uses=2]
  store float %72, float addrspace(1)* %37
  %73 = load float, float addrspace(1)* %14              ; <float> [#uses=1]
  %74 = load float, float addrspace(1)* %61              ; <float> [#uses=1]
  ...
  %82 = load float, float addrspace(1)* %16              ; <float> [#uses=1]
  %83 = load float, float addrspace(1)* %78              ; <float> [#uses=1]
  %84 = fmul float %82, %83                       ; <float> [#uses=1]
  %85 = fadd float %68, %84                       ; <float> [#uses=1]
  store float %85, float addrspace(1)* %32
  %86 = load float, float addrspace(1)* %17              ; <float> [#uses=1]
  %87 = load float, float addrspace(1)* %78              ; <float> [#uses=1]
  %88 = fmul float %86, %87                       ; <float> [#uses=1]
  %89 = fadd float %72, %88                       ; <float> [#uses=1]
  store float %89, float addrspace(1)* %37
  %90 = load float, float addrspace(1)* %18              ; <float> [#uses=1]
  %91 = load float, float addrspace(1)* %78              ; <float> [#uses=1]
...
bb.nph6:                                          ; preds = %0
  %3 = getelementptr inbounds float, float addrspace(1)* %coef, i32 1 ; <float addrspace(1)*> [#uses=1]
  %4 = getelementptr inbounds float, float addrspace(1)* %coef, i32 2 ; <float addrspace(1)*> [#uses=1]
  %5 = getelementptr inbounds float, float addrspace(1)* %coef, i32 3 ; <float addrspace(1)*> [#uses=1]
  %6 = getelementptr inbounds float, float addrspace(1)* %coef, i32 16 ; <float addrspace(1)*> [#uses=1]
  %7 = getelementptr inbounds float, float addrspace(1)* %coef, i32 17 ; <float addrspace(1)*> [#uses=1]
  %8 = getelementptr inbounds float, float addrspace(1)* %coef, i32 18 ; <float addrspace(1)*> [#uses=1]
  %9 = getelementptr inbounds float, float addrspace(1)* %coef, i32 19 ; <float addrspace(1)*> [#uses=1]
  %10 = getelementptr inbounds float, float addrspace(1)* %coef, i32 32 ; <float addrspace(1)*> [#uses=1]
  %11 = getelementptr inbounds float, float addrspace(1)* %coef, i32 33 ; <float addrspace(1)*> [#uses=1]
  %12 = getelementptr inbounds float, float addrspace(1)* %coef, i32 34 ; <float addrspace(1)*> [#uses=1]
  %13 = getelementptr inbounds float, float addrspace(1)* %coef, i32 35 ; <float addrspace(1)*> [#uses=1]
  %14 = getelementptr inbounds float, float addrspace(1)* %coef, i32 48 ; <float addrspace(1)*> [#uses=1]
  %15 = getelementptr inbounds float, float addrspace(1)* %coef, i32 49 ; <float addrspace(1)*> [#uses=1]
  %16 = getelementptr inbounds float, float addrspace(1)* %coef, i32 50 ; <float addrspace(1)*> [#uses=1]
  %17 = getelementptr inbounds float, float addrspace(1)* %coef, i32 51 ; <float addrspace(1)*> [#uses=1]
  br label %.preheader
...
bb.nph:                                           ; preds = %.preheader, %bb.nph
  ...
  %30 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %34 = load float, float addrspace(1)* %4               ; <float> [#uses=1]
  %35 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %39 = load float, float addrspace(1)* %5               ; <float> [#uses=1]
  %40 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %44 = load float, float addrspace(1)* %6               ; <float> [#uses=1]
  %45 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %50 = load float, float addrspace(1)* %7               ; <float> [#uses=1]
  %51 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %56 = load float, float addrspace(1)* %8               ; <float> [#uses=1]
  %57 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %62 = load float, float addrspace(1)* %9               ; <float> [#uses=1]
  %63 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %68 = load float, float addrspace(1)* %10              ; <float> [#uses=1]
  %69 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %74 = load float, float addrspace(1)* %11              ; <float> [#uses=1]
  %75 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %80 = load float, float addrspace(1)* %12              ; <float> [#uses=1]
  %81 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %86 = load float, float addrspace(1)* %13              ; <float> [#uses=1]
  %87 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %92 = load float, float addrspace(1)* %14              ; <float> [#uses=1]
  %93 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %98 = load float, float addrspace(1)* %15              ; <float> [#uses=1]
  %99 = load <4 x float>, <4 x float> addrspace(1)* %22        ; <<4 x float>> [#uses=1]
  ...
  %104 = load float, float addrspace(1)* %16             ; <float> [#uses=1]
  %105 = load <4 x float>, <4 x float> addrspace(1)* %22       ; <<4 x float>> [#uses=1]
  ...
  %110 = load float, float addrspace(1)* %17             ; <float> [#uses=1]
  %111 = load <4 x float>, <4 x float> addrspace(1)* %22       ; <<4 x float>> [#uses=1]
...
bb.nph6:                                          ; preds = %0
  %3 = getelementptr inbounds float, float addrspace(1)* %coef, i32 16 ; <float addrspace(1)*> [#uses=1]
  %4 = getelementptr inbounds float, float addrspace(1)* %coef, i32 32 ; <float addrspace(1)*> [#uses=1]
  %5 = getelementptr inbounds float, float addrspace(1)* %coef, i32 48 ; <float addrspace(1)*> [#uses=1]
  %6 = getelementptr inbounds float, float addrspace(1)* %coef, i32 1 ; <float addrspace(1)*> [#uses=1]
  %7 = getelementptr inbounds float, float addrspace(1)* %coef, i32 17 ; <float addrspace(1)*> [#uses=1]
  %8 = getelementptr inbounds float, float addrspace(1)* %coef, i32 33 ; <float addrspace(1)*> [#uses=1]
  %9 = getelementptr inbounds float, float addrspace(1)* %coef, i32 49 ; <float addrspace(1)*> [#uses=1]
  %10 = getelementptr inbounds float, float addrspace(1)* %coef, i32 2 ; <float addrspace(1)*> [#uses=1]
  %11 = getelementptr inbounds float, float addrspace(1)* %coef, i32 18 ; <float addrspace(1)*> [#uses=1]
  %12 = getelementptr inbounds float, float addrspace(1)* %coef, i32 34 ; <float addrspace(1)*> [#uses=1]
  %13 = getelementptr inbounds float, float addrspace(1)* %coef, i32 50 ; <float addrspace(1)*> [#uses=1]
  %14 = getelementptr inbounds float, float addrspace(1)* %coef, i32 3 ; <float addrspace(1)*> [#uses=1]
  %15 = getelementptr inbounds float, float addrspace(1)* %coef, i32 19 ; <float addrspace(1)*> [#uses=1]
  %16 = getelementptr inbounds float, float addrspace(1)* %coef, i32 35 ; <float addrspace(1)*> [#uses=1]
  %17 = getelementptr inbounds float, float addrspace(1)* %coef, i32 51 ; <float addrspace(1)*> [#uses=1]
  br label %.preheader
...
bb.nph:                                           ; preds = %0
  %3 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %coef, i32 4 ; <<4 x float> addrspace(1)*> [#uses=1]
  %4 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %coef, i32 8 ; <<4 x float> addrspace(1)*> [#uses=1]
  %5 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %coef, i32 12 ; <<4 x float> addrspace(1)*> [#uses=1]
  %6 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %src, i32 %1 ; <<4 x float> addrspace(1)*> [#uses=1]
  %7 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %dest, i32 %1 ; <<4 x float> addrspace(1)*> [#uses=1]
  br label %8

; <label>:8                                       ; preds = %8, %bb.nph
  %i.01 = phi i32 [ 0, %bb.nph ], [ %73, %8 ]     ; <i32> [#uses=1]
  %9 = load <4 x float>, <4 x float> addrspace(1)* %coef       ; <<4 x float>> [#uses=4]
  %10 = load <4 x float>, <4 x float> addrspace(1)* %3         ; <<4 x float>> [#uses=4]
  %11 = load <4 x float>, <4 x float> addrspace(1)* %4         ; <<4 x float>> [#uses=4]
  %12 = load <4 x float>, <4 x float> addrspace(1)* %5         ; <<4 x float>> [#uses=4]
  %13 = load <4 x float>, <4 x float> addrspace(1)* %6         ; <<4 x float>> [#uses=4]
  ...
  %40 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %dest, i32 %26 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %56 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %dest, i32 %42 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %72 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %dest, i32 %58 ; <<4 x float> addrspace(1)*> [#uses=1]
...
bb.nph:                                           ; preds = %0
  %3 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %coef, i32 2 ; <<8 x float> addrspace(1)*> [#uses=1]
  %4 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %coef, i32 4 ; <<8 x float> addrspace(1)*> [#uses=1]
  %5 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %coef, i32 6 ; <<8 x float> addrspace(1)*> [#uses=1]
  %6 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %src, i32 %1 ; <<8 x float> addrspace(1)*> [#uses=1]
  %7 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %dest, i32 %1 ; <<8 x float> addrspace(1)*> [#uses=1]
  br label %8

; <label>:8                                       ; preds = %8, %bb.nph
  %i.01 = phi i32 [ 0, %bb.nph ], [ %41, %8 ]     ; <i32> [#uses=1]
  %9 = load <8 x float>, <8 x float> addrspace(1)* %coef       ; <<8 x float>> [#uses=2]
  %10 = load <8 x float>, <8 x float> addrspace(1)* %3         ; <<8 x float>> [#uses=2]
  %11 = load <8 x float>, <8 x float> addrspace(1)* %4         ; <<8 x float>> [#uses=2]
  %12 = load <8 x float>, <8 x float> addrspace(1)* %5         ; <<8 x float>> [#uses=2]
  %13 = load <8 x float>, <8 x float> addrspace(1)* %6         ; <<8 x float>> [#uses=4]
  ...
  %40 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %dest, i32 %26 ; <<8 x float> addrspace(1)*> [#uses=1]
...
bb.nph:                                           ; preds = %0
  %3 = getelementptr inbounds <16 x float>, <16 x float> addrspace(1)* %coef, i32 1 ; <<16 x float> addrspace(1)*> [#uses=1]
  %4 = getelementptr inbounds <16 x float>, <16 x float> addrspace(1)* %coef, i32 2 ; <<16 x float> addrspace(1)*> [#uses=1]
  %5 = getelementptr inbounds <16 x float>, <16 x float> addrspace(1)* %coef, i32 3 ; <<16 x float> addrspace(1)*> [#uses=1]
  %6 = getelementptr inbounds <16 x float>, <16 x float> addrspace(1)* %src, i32 %1 ; <<16 x float> addrspace(1)*> [#uses=1]
  %7 = getelementptr inbounds <16 x float>, <16 x float> addrspace(1)* %dest, i32 %1 ; <<16 x float> addrspace(1)*> [#uses=1]
  br label %8

; <label>:8                                       ; preds = %8, %bb.nph
  %i.01 = phi i32 [ 0, %bb.nph ], [ %25, %8 ]     ; <i32> [#uses=1]
  %9 = load <16 x float>, <16 x float> addrspace(1)* %coef      ; <<16 x float>> [#uses=1]
  %10 = load <16 x float>, <16 x float> addrspace(1)* %3        ; <<16 x float>> [#uses=1]
  %11 = load <16 x float>, <16 x float> addrspace(1)* %4        ; <<16 x float>> [#uses=1]
  %12 = load <16 x float>, <16 x float> addrspace(1)* %5        ; <<16 x float>> [#uses=1]
  %13 = load <16 x float>, <16 x float> addrspace(1)* %6        ; <<16 x float>> [#uses=4]

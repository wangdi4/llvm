...
@opencl_metadata = appending global [3 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (i32, i32, i32 addrspace(1)*)* @initMatrix to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_initMatrix_locals to i8*), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @opencl_initMatrix_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (i32, i32, i32 addrspace(1)*)* @initMatrixMult to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_initMatrixMult_locals to i8*), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @opencl_initMatrixMult_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (i32 addrspace(1)*, i32 addrspace(1)*, i32)* @copyMatrix to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_copyMatrix_locals to i8*), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @opencl_copyMatrix_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[3 x %opencl_metadata_type]*> [#uses=0]

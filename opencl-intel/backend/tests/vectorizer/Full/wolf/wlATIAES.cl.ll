...
@opencl_metadata = appending global [2 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (<4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*, i8 addrspace(1)*, <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)*, i32, i32)* @AESEncrypt to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_AESEncrypt_locals to i8*), i8* getelementptr inbounds ([286 x i8], [286 x i8]* @opencl_AESEncrypt_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (<4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)*, i8 addrspace(1)*, <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)*, i32, i32)* @AESDecrypt to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_AESDecrypt_locals to i8*), i8* getelementptr inbounds ([286 x i8], [286 x i8]* @opencl_AESDecrypt_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[2 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %tmp = load <4 x i8>, <4 x i8>* %row.addr                 ; <<4 x i8>> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %tmp3 = load i32, i32* %j.addr                       ; <i32> [#uses=1]
  %cmp = icmp ult i32 %tmp2, %tmp3                ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp4 = load <4 x i8>, <4 x i8>* %r                       ; <<4 x i8>> [#uses=1]
...
for.end:                                          ; preds = %for.cond
  %tmp7 = load <4 x i8>, <4 x i8>* %r                       ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp7, <4 x i8>* %retval
  %0 = load <4 x i8>, <4 x i8>* %retval                     ; <<4 x i8>> [#uses=1]
  ret <4 x i8> %0
}
...
for.cond:                                         ; preds = %for.inc643, %entry
  %tmp41 = load i32, i32* %r                           ; <i32> [#uses=1]
  %tmp42 = load i32, i32* %rounds.addr                 ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp74 = load i32, i32* %localIndex                  ; <i32> [#uses=1]
  %sub = sub i32 %tmp73, %tmp74                   ; <i32> [#uses=1]
  %tmp75 = load i32, i32* %bw                          ; <i32> [#uses=2]
...
if.then:                                          ; preds = %for.body85
  %tmp89 = load i8, i8* %a                            ; <i8> [#uses=1]
  %conv90 = zext i8 %tmp89 to i32                 ; <i32> [#uses=1]
  %tmp91 = load i8, i8* %p                            ; <i8> [#uses=1]
...
if.end:                                           ; preds = %if.then, %for.body85
  ...
  %tmp103 = load i8, i8* %hiBitSet                    ; <i8> [#uses=1]
...
for.inc:                                          ; preds = %if.end112
  %tmp116 = load i32, i32* %i                          ; <i32> [#uses=1]
...
for.end:                                          ; preds = %for.cond82
  ...
  %tmp123 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub124 = sub i32 %tmp122, %tmp123              ; <i32> [#uses=1]
  %tmp125 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then145:                                       ; preds = %for.body139
  %tmp146 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv147 = zext i8 %tmp146 to i32               ; <i32> [#uses=1]
  %tmp148 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end152:                                        ; preds = %if.then145, %for.body139
  ...
  %tmp163 = load i8, i8* %hiBitSet154                 ; <i8> [#uses=1]
...
for.inc177:                                       ; preds = %if.end172
  %tmp178 = load i32, i32* %i134                       ; <i32> [#uses=1]
...
for.end180:                                       ; preds = %for.cond135
  ...
  %tmp187 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub188 = sub i32 %tmp186, %tmp187              ; <i32> [#uses=1]
  %tmp189 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then209:                                       ; preds = %for.body203
  %tmp210 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv211 = zext i8 %tmp210 to i32               ; <i32> [#uses=1]
  %tmp212 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end216:                                        ; preds = %if.then209, %for.body203
  ...
  %tmp227 = load i8, i8* %hiBitSet218                 ; <i8> [#uses=1]
...
for.inc241:                                       ; preds = %if.end236
  %tmp242 = load i32, i32* %i198                       ; <i32> [#uses=1]
...
for.end244:                                       ; preds = %for.cond199
  ...
  %tmp251 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub252 = sub i32 %tmp250, %tmp251              ; <i32> [#uses=1]
  %tmp253 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then273:                                       ; preds = %for.body267
  %tmp274 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv275 = zext i8 %tmp274 to i32               ; <i32> [#uses=1]
  %tmp276 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end280:                                        ; preds = %if.then273, %for.body267
  ...
  %tmp291 = load i8, i8* %hiBitSet282                 ; <i8> [#uses=1]
...
for.body315:                                      ; preds = %for.cond311
  ...
  %tmp326 = load i32, i32* %bw                         ; <i32> [#uses=1]
  %add327 = add i32 %tmp325, %tmp326              ; <i32> [#uses=1]
  %tmp328 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub329 = sub i32 %add327, %tmp328              ; <i32> [#uses=1]
  %tmp330 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then350:                                       ; preds = %for.body344
  %tmp351 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv352 = zext i8 %tmp351 to i32               ; <i32> [#uses=1]
  %tmp353 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end357:                                        ; preds = %if.then350, %for.body344
  ...
  %tmp368 = load i8, i8* %hiBitSet359                 ; <i8> [#uses=1]
...
for.inc382:                                       ; preds = %if.end377
  %tmp383 = load i32, i32* %i339                       ; <i32> [#uses=1]
...
for.end385:                                       ; preds = %for.cond340
  ...
  %tmp393 = load i32, i32* %bw                         ; <i32> [#uses=1]
  %add394 = add i32 %tmp392, %tmp393              ; <i32> [#uses=1]
  %tmp395 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub396 = sub i32 %add394, %tmp395              ; <i32> [#uses=1]
  %tmp397 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then417:                                       ; preds = %for.body411
  %tmp418 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv419 = zext i8 %tmp418 to i32               ; <i32> [#uses=1]
  %tmp420 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end424:                                        ; preds = %if.then417, %for.body411
  ...
  %tmp435 = load i8, i8* %hiBitSet426                 ; <i8> [#uses=1]
...
for.inc449:                                       ; preds = %if.end444
  %tmp450 = load i32, i32* %i406                       ; <i32> [#uses=1]
...
for.end452:                                       ; preds = %for.cond407
  ...
  %tmp460 = load i32, i32* %bw                         ; <i32> [#uses=1]
  %add461 = add i32 %tmp459, %tmp460              ; <i32> [#uses=1]
  %tmp462 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub463 = sub i32 %add461, %tmp462              ; <i32> [#uses=1]
  %tmp464 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then484:                                       ; preds = %for.body478
  %tmp485 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv486 = zext i8 %tmp485 to i32               ; <i32> [#uses=1]
  %tmp487 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end491:                                        ; preds = %if.then484, %for.body478
  ...
  %tmp502 = load i8, i8* %hiBitSet493                 ; <i8> [#uses=1]
...
for.inc516:                                       ; preds = %if.end511
  %tmp517 = load i32, i32* %i473                       ; <i32> [#uses=1]
...
for.end519:                                       ; preds = %for.cond474
  ...
  %tmp527 = load i32, i32* %bw                         ; <i32> [#uses=1]
  %add528 = add i32 %tmp526, %tmp527              ; <i32> [#uses=1]
  %tmp529 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub530 = sub i32 %add528, %tmp529              ; <i32> [#uses=1]
  %tmp531 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then551:                                       ; preds = %for.body545
  %tmp552 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv553 = zext i8 %tmp552 to i32               ; <i32> [#uses=1]
  %tmp554 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end558:                                        ; preds = %if.then551, %for.body545
  ...
  %tmp569 = load i8, i8* %hiBitSet560                 ; <i8> [#uses=1]
...
for.end586:                                       ; preds = %for.cond541
  ...
  %tmp594 = load i8, i8* %y1                          ; <i8> [#uses=1]
  %conv595 = zext i8 %tmp594 to i32               ; <i32> [#uses=1]
  %tmp596 = load i8, i8* %y                           ; <i8> [#uses=1]
  ...
  %tmp600 = load i8, i8* %z1                          ; <i8> [#uses=1]
  %conv601 = zext i8 %tmp600 to i32               ; <i32> [#uses=1]
  %tmp602 = load i8, i8* %z                           ; <i8> [#uses=1]
  ...
  %tmp606 = load i8, i8* %w1                          ; <i8> [#uses=1]
  %conv607 = zext i8 %tmp606 to i32               ; <i32> [#uses=1]
  %tmp608 = load i8, i8* %w                           ; <i8> [#uses=1]
...
for.inc643:                                       ; preds = %for.end615
  %tmp644 = load i32, i32* %r                          ; <i32> [#uses=1]
...
entry:
  ...
  %tmp = load <4 x i8>, <4 x i8>* %block.addr               ; <<4 x i8>> [#uses=1]
...
for.cond:                                         ; preds = %for.inc647, %entry
  %tmp45 = load i32, i32* %r                           ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp92 = load i32, i32* %localIndex                  ; <i32> [#uses=1]
  %sub93 = sub i32 %tmp91, %tmp92                 ; <i32> [#uses=1]
  %tmp94 = load i32, i32* %bw                          ; <i32> [#uses=2]
...
if.end:                                           ; preds = %if.then, %for.body104
  ...
  %tmp122 = load i8, i8* %hiBitSet                    ; <i8> [#uses=1]
...
for.inc:                                          ; preds = %if.end131
  %tmp135 = load i32, i32* %i                          ; <i32> [#uses=1]
...
for.end:                                          ; preds = %for.cond101
  ...
  %tmp142 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub143 = sub i32 %tmp141, %tmp142              ; <i32> [#uses=1]
  %tmp144 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then164:                                       ; preds = %for.body158
  %tmp165 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv166 = zext i8 %tmp165 to i32               ; <i32> [#uses=1]
  %tmp167 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end171:                                        ; preds = %if.then164, %for.body158
  ...
  %tmp182 = load i8, i8* %hiBitSet173                 ; <i8> [#uses=1]
...
for.inc196:                                       ; preds = %if.end191
  %tmp197 = load i32, i32* %i153                       ; <i32> [#uses=1]
...
for.end199:                                       ; preds = %for.cond154
  ...
  %tmp206 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub207 = sub i32 %tmp205, %tmp206              ; <i32> [#uses=1]
  %tmp208 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then228:                                       ; preds = %for.body222
  %tmp229 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv230 = zext i8 %tmp229 to i32               ; <i32> [#uses=1]
  %tmp231 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end235:                                        ; preds = %if.then228, %for.body222
  ...
  %tmp246 = load i8, i8* %hiBitSet237                 ; <i8> [#uses=1]
...
for.inc260:                                       ; preds = %if.end255
  %tmp261 = load i32, i32* %i217                       ; <i32> [#uses=1]
...
for.end263:                                       ; preds = %for.cond218
  ...
  %tmp270 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub271 = sub i32 %tmp269, %tmp270              ; <i32> [#uses=1]
  %tmp272 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then292:                                       ; preds = %for.body286
  %tmp293 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv294 = zext i8 %tmp293 to i32               ; <i32> [#uses=1]
  %tmp295 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end299:                                        ; preds = %if.then292, %for.body286
  ...
  %tmp310 = load i8, i8* %hiBitSet301                 ; <i8> [#uses=1]
...
for.body334:                                      ; preds = %for.cond330
  ...
  %tmp345 = load i32, i32* %bw                         ; <i32> [#uses=1]
  %add346 = add i32 %tmp344, %tmp345              ; <i32> [#uses=1]
  %tmp347 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub348 = sub i32 %add346, %tmp347              ; <i32> [#uses=1]
  %tmp349 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then369:                                       ; preds = %for.body363
  %tmp370 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv371 = zext i8 %tmp370 to i32               ; <i32> [#uses=1]
  %tmp372 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end376:                                        ; preds = %if.then369, %for.body363
  ...
  %tmp387 = load i8, i8* %hiBitSet378                 ; <i8> [#uses=1]
...
for.inc401:                                       ; preds = %if.end396
  %tmp402 = load i32, i32* %i358                       ; <i32> [#uses=1]
...
for.end404:                                       ; preds = %for.cond359
  ...
  %tmp412 = load i32, i32* %bw                         ; <i32> [#uses=1]
  %add413 = add i32 %tmp411, %tmp412              ; <i32> [#uses=1]
  %tmp414 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub415 = sub i32 %add413, %tmp414              ; <i32> [#uses=1]
  %tmp416 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then436:                                       ; preds = %for.body430
  %tmp437 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv438 = zext i8 %tmp437 to i32               ; <i32> [#uses=1]
  %tmp439 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end443:                                        ; preds = %if.then436, %for.body430
  ...
  %tmp454 = load i8, i8* %hiBitSet445                 ; <i8> [#uses=1]
...
for.inc468:                                       ; preds = %if.end463
  %tmp469 = load i32, i32* %i425                       ; <i32> [#uses=1]
...
for.end471:                                       ; preds = %for.cond426
  ...
  %tmp479 = load i32, i32* %bw                         ; <i32> [#uses=1]
  %add480 = add i32 %tmp478, %tmp479              ; <i32> [#uses=1]
  %tmp481 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub482 = sub i32 %add480, %tmp481              ; <i32> [#uses=1]
  %tmp483 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then503:                                       ; preds = %for.body497
  %tmp504 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv505 = zext i8 %tmp504 to i32               ; <i32> [#uses=1]
  %tmp506 = load i8, i8* %p                           ; <i8> [#uses=1]
...
if.end510:                                        ; preds = %if.then503, %for.body497
  ...
  %tmp521 = load i8, i8* %hiBitSet512                 ; <i8> [#uses=1]
...
for.inc535:                                       ; preds = %if.end530
  %tmp536 = load i32, i32* %i492                       ; <i32> [#uses=1]
...
for.end538:                                       ; preds = %for.cond493
  ...
  %tmp546 = load i32, i32* %bw                         ; <i32> [#uses=1]
  %add547 = add i32 %tmp545, %tmp546              ; <i32> [#uses=1]
  %tmp548 = load i32, i32* %localIndex                 ; <i32> [#uses=1]
  %sub549 = sub i32 %add547, %tmp548              ; <i32> [#uses=1]
  %tmp550 = load i32, i32* %bw                         ; <i32> [#uses=2]
...
if.then570:                                       ; preds = %for.body564
  %tmp571 = load i8, i8* %a                           ; <i8> [#uses=1]
  %conv572 = zext i8 %tmp571 to i32               ; <i32> [#uses=1]
  %tmp573 = load i8, i8* %p                           ; <i8> [#uses=1]
...
for.end605:                                       ; preds = %for.cond560
  ...
  %tmp613 = load i8, i8* %y1                          ; <i8> [#uses=1]
  %conv614 = zext i8 %tmp613 to i32               ; <i32> [#uses=1]
  %tmp615 = load i8, i8* %y                           ; <i8> [#uses=1]
  ...
  %tmp619 = load i8, i8* %z1                          ; <i8> [#uses=1]
  %conv620 = zext i8 %tmp619 to i32               ; <i32> [#uses=1]
  %tmp621 = load i8, i8* %z                           ; <i8> [#uses=1]
  ...
  %tmp625 = load i8, i8* %w1                          ; <i8> [#uses=1]
  %conv626 = zext i8 %tmp625 to i32               ; <i32> [#uses=1]
  %tmp627 = load i8, i8* %w                           ; <i8> [#uses=1]
...
for.inc647:                                       ; preds = %for.end634
  %tmp648 = load i32, i32* %r                          ; <i32> [#uses=1]

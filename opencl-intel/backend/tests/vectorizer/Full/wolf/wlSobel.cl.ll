...
if.end125:                                        ; preds = %if.end124, %if.end95
  ...
  %call173 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp172) ; <float> [#uses=1]
...
if.end174:                                        ; preds = %if.end173, %if.end144
  ...
  %call247 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp246) ; <float> [#uses=1]
...
for.body89:                                       ; preds = %for.cond83
  ...
  %call237 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp236) ; <float> [#uses=1]
...
entry:
  ...
  %call = call <4 x float> @_Z11read_imagefP10_image2d_tjU8__vector2i(%struct._image2d_t* %tmp, i32 1, <2 x i32> %tmp4) ; <<4 x float>> [#uses=1]
  store <4 x float> %call, <4 x float>* %outputColor
...
for.body33:                                       ; preds = %for.cond28
  ...
  %call127 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp126) ; <float> [#uses=1]
...
entry:
  ...
  %call112 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp111) ; <float> [#uses=1]
...
entry:
  ...
  store <2 x i32> %vecinit3, <2 x i32>* %.compoundliteral
  %tmp4 = load <2 x i32>* %.compoundliteral       ; <<2 x i32>> [#uses=1]
  %call = call <4 x float> @_Z11read_imagefP10_image2d_tjU8__vector2i(%struct._image2d_t* %tmp, i32 0, <2 x i32> %tmp4) ; <<4 x float>> [#uses=1]
  store <4 x float> %call, <4 x float>* %outputColor
  %tmp5 = load <4 x float>* %outputColor          ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp5, <4 x float>* %retval
  %0 = load <4 x float>* %retval                  ; <<4 x float>> [#uses=1]
...
for.body35:                                       ; preds = %for.cond29
  ...
  %call155 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp154) ; <float> [#uses=1]
...
for.body48:                                       ; preds = %for.cond42
  ...
  %call229 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp228) ; <float> [#uses=1]
  ...
  %call233 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp232) ; <float> [#uses=1]
...
for.body89:                                       ; preds = %for.cond85
  ...
  %call200 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp199) ; <float> [#uses=1]
...
if.then242:                                       ; preds = %land.lhs.true
  ...
  %call283 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp282) ; <float> [#uses=1]
...
for.body323:                                      ; preds = %for.cond316
  ...
  %call395 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp394) ; <float> [#uses=1]
...
if.then434:                                       ; preds = %land.lhs.true430
  ...
  %call485 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp484) ; <float> [#uses=1]
...
for.body527:                                      ; preds = %for.cond520
  ...
  %call608 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp607) ; <float> [#uses=1]
...
if.then649:                                       ; preds = %land.lhs.true645
  ...
  %call706 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp705) ; <float> [#uses=1]
...
for.body750:                                      ; preds = %for.cond743
  ...
  %call848 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp847) ; <float> [#uses=1]
...
for.body898:                                      ; preds = %for.cond891
  ...
  %call984 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp983) ; <float> [#uses=1]
...
if.then1027:                                      ; preds = %land.lhs.true1023
  ...
  %call1085 = call float @_Z6lengthU8__vector2f(<2 x float> %tmp1084) ; <float> [#uses=1]

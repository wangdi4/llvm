...
@opencl_metadata = appending global [2 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (i32 addrspace(1)*, i32 addrspace(1)*, i32 addrspace(1)*, i32)* @prefixSumStep1 to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_prefixSumStep1_locals to i8*), i8* getelementptr inbounds ([145 x i8], [145 x i8]* @opencl_prefixSumStep1_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (i32 addrspace(1)*, i32 addrspace(1)*, i32)* @prefixSumStep2 to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_prefixSumStep2_locals to i8*), i8* getelementptr inbounds ([103 x i8], [103 x i8]* @opencl_prefixSumStep2_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[2 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %tmp = load i32 addrspace(1)*, i32 addrspace(1)** %puiInputArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %tmp1 = load i32, i32* %gid                          ; <i32> [#uses=1]
  %tmp2 = load i32, i32* %szElementsPerItem.addr       ; <i32> [#uses=1]
  ...
  %tmp4 = load i32 addrspace(1)*, i32 addrspace(1)** %puiOutputArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %tmp5 = load i32, i32* %gid                          ; <i32> [#uses=1]
  %tmp6 = load i32, i32* %szElementsPerItem.addr       ; <i32> [#uses=1]
  %mul7 = mul i32 %tmp5, %tmp6                    ; <i32> [#uses=1]
  %add.ptr8 = getelementptr inbounds i32, i32 addrspace(1)* %tmp4, i32 %mul7 ; <i32 addrspace(1)*> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %tmp11 = load i32, i32* %szElementsPerItem.addr      ; <i32> [#uses=1]
...
for.cond30:                                       ; preds = %for.inc48, %for.body26
  %tmp31 = load i32, i32* %p                           ; <i32> [#uses=1]
  %tmp32 = load i32, i32* %h                           ; <i32> [#uses=1]
...
entry:
  ...
  %call = call i32 @_Z13get_global_idj(i32 0)          ; <i32> [#uses=1]
  store i32 %call, i32* %gid
  %tmp = load i32, i32* %szElementsPerItem.addr        ; <i32> [#uses=1]
  store i32 %tmp, i32* %offset
  %tmp2 = load i32 addrspace(1)*, i32 addrspace(1)** %puiOutputArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %tmp3 = load i32, i32* %gid                          ; <i32> [#uses=1]
  %tmp4 = load i32, i32* %szElementsPerItem.addr       ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc52, %entry
  %tmp15 = load i32, i32* %h                           ; <i32> [#uses=1]
  %tmp16 = load i32, i32* %szPairs                     ; <i32> [#uses=1]
  %cmp = icmp ule i32 %tmp15, %tmp16              ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end55

for.body:                                         ; preds = %for.cond
  %tmp17 = load i32, i32* %offset                      ; <i32> [#uses=1]
  %shr18 = lshr i32 %tmp17, 1                     ; <i32> [#uses=1]
  store i32 %shr18, i32* %offset
  %tmp20 = load i32, i32* %offset                      ; <i32> [#uses=1]
...
for.cond23:                                       ; preds = %for.inc, %for.body
  %tmp24 = load i32, i32* %p                           ; <i32> [#uses=1]
  %tmp25 = load i32, i32* %h                           ; <i32> [#uses=1]
...
for.inc52:                                        ; preds = %for.end
  %tmp53 = load i32, i32* %h                           ; <i32> [#uses=1]
...
for.cond57:                                       ; preds = %for.inc70, %for.end55
  %tmp58 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp59 = load i32, i32* %szElementsPerItem.addr      ; <i32> [#uses=1]
...
for.inc70:                                        ; preds = %for.body61
  %tmp71 = load i32, i32* %i                           ; <i32> [#uses=1]

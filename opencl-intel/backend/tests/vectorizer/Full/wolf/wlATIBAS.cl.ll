...
entry:
  ...
  %call = call <4 x float> @_Z4fabsU8__vector4f(<4 x float> %tmp) ; <<4 x float>> [#uses=1]
  ...
  %call14 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %div13) ; <<4 x float>> [#uses=1]
...
entry:
  ...
  %call43 = call <4 x float> @_Z4sqrtU8__vector4f(<4 x float> %tmp42) ; <<4 x float>> [#uses=1]
  ...
  %call47 = call <4 x float> @_Z3logU8__vector4f(<4 x float> %div) ; <<4 x float>> [#uses=1]
  ...
  %call71 = call <4 x float> @_Z3expU8__vector4f(<4 x float> %mul70) ; <<4 x float>> [#uses=1]

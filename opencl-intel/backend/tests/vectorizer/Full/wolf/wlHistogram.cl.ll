...
@opencl_metadata = appending global [8 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (i32 addrspace(1)*, i32 addrspace(1)*, i32)* @histogramScalar to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_histogramScalar_locals to i8*), i8* getelementptr inbounds ([103 x i8], [103 x i8]* @opencl_histogramScalar_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (i32 addrspace(1)*, i32 addrspace(1)*, i32 addrspace(1)*, i32, i32, i32)* @histogramGrouped to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_histogramGrouped_locals to i8*), i8* getelementptr inbounds ([173 x i8], [173 x i8]* @opencl_histogramGrouped_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (i32 addrspace(1)*, i32 addrspace(1)*, i32, i32)* @histogramStep1 to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_histogramStep1_locals to i8*), i8* getelementptr inbounds ([117 x i8], [117 x i8]* @opencl_histogramStep1_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (i32 addrspace(1)*, i32 addrspace(1)*, i32, i32, i32)* @histogramStep2int to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_histogramStep2int_locals to i8*), i8* getelementptr inbounds ([125 x i8], [125 x i8]* @opencl_histogramStep2int_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (<2 x i32> addrspace(1)*, <2 x i32> addrspace(1)*, i32, i32, i32)* @histogramStep2int2 to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_histogramStep2int2_locals to i8*), i8* getelementptr inbounds ([127 x i8], [127 x i8]* @opencl_histogramStep2int2_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (<4 x i32> addrspace(1)*, <4 x i32> addrspace(1)*, i32, i32, i32)* @histogramStep2int4 to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_histogramStep2int4_locals to i8*), i8* getelementptr inbounds ([127 x i8], [127 x i8]* @opencl_histogramStep2int4_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (<8 x i32> addrspace(1)*, <8 x i32> addrspace(1)*, i32, i32, i32)* @histogramStep2int8 to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_histogramStep2int8_locals to i8*), i8* getelementptr inbounds ([127 x i8], [127 x i8]* @opencl_histogramStep2int8_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (<16 x i32> addrspace(1)*, <16 x i32> addrspace(1)*, i32, i32, i32)* @histogramStep2int16 to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_histogramStep2int16_locals to i8*), i8* getelementptr inbounds ([129 x i8], [129 x i8]* @opencl_histogramStep2int16_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[8 x %opencl_metadata_type]*> [#uses=0]
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %tmp1 = load i32, i32* %szMatrix.addr                ; <i32> [#uses=1]
  %cmp2 = icmp ult i32 %tmp, %tmp1                ; <i1> [#uses=1]
  br i1 %cmp2, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp3 = load i32, i32* %i                            ; <i32> [#uses=1]
  %tmp4 = load i32 addrspace(1)*, i32 addrspace(1)** %puiInputMatrix.addr ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %tmp4, i32 %tmp3 ; <i32 addrspace(1)*> [#uses=1]
  %tmp5 = load i32, i32 addrspace(1)* %arrayidx        ; <i32> [#uses=1]
  %tmp6 = load i32 addrspace(1)*, i32 addrspace(1)** %puiOutputArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx7 = getelementptr inbounds i32, i32 addrspace(1)* %tmp6, i32 %tmp5 ; <i32 addrspace(1)*> [#uses=2]
  %tmp8 = load i32, i32 addrspace(1)* %arrayidx7       ; <i32> [#uses=1]
...
entry:
  ...
  %tmp = load i32 addrspace(1)*, i32 addrspace(1)** %puiTmpArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %tmp2 = load i32, i32* %gid                          ; <i32> [#uses=1]
  %tmp3 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul = mul i32 %tmp2, %tmp3                     ; <i32> [#uses=1]
  %add.ptr = getelementptr inbounds i32, i32 addrspace(1)* %tmp, i32 %mul ; <i32 addrspace(1)*> [#uses=1]
  ...
  %tmp6 = load i32, i32* %szBinsPerItem.addr           ; <i32> [#uses=1]
  %mul7 = mul i32 %add, %tmp6                     ; <i32> [#uses=1]
  %tmp8 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul9 = mul i32 %mul7, %tmp8                    ; <i32> [#uses=1]
  store i32 %mul9, i32* %outerLastIndex
  %tmp11 = load i32, i32* %gid                         ; <i32> [#uses=1]
  %tmp12 = load i32, i32* %szBin.addr                  ; <i32> [#uses=1]
  %mul13 = mul i32 %tmp11, %tmp12                 ; <i32> [#uses=1]
  %tmp14 = load i32, i32* %szBinsPerItem.addr          ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %tmp17 = load i32, i32* %outerLastIndex              ; <i32> [#uses=1]
  %cmp = icmp ult i32 %tmp16, %tmp17              ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp18 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp19 = load i32 addrspace(1)*, i32 addrspace(1)** %puiInputMatrix.addr ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %tmp19, i32 %tmp18 ; <i32 addrspace(1)*> [#uses=1]
  %tmp20 = load i32, i32 addrspace(1)* %arrayidx       ; <i32> [#uses=1]
  %tmp21 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedTmpArray ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx22 = getelementptr inbounds i32, i32 addrspace(1)* %tmp21, i32 %tmp20 ; <i32 addrspace(1)*> [#uses=2]
  %tmp23 = load i32, i32 addrspace(1)* %arrayidx22     ; <i32> [#uses=1]
...
for.end:                                          ; preds = %for.cond
  ...
  %tmp28 = load i32, i32* %lid                         ; <i32> [#uses=1]
  %add29 = add i32 %tmp28, 1                      ; <i32> [#uses=1]
  %tmp30 = load i32, i32* %szElemenetsPerItem.addr     ; <i32> [#uses=1]
  %mul31 = mul i32 %add29, %tmp30                 ; <i32> [#uses=1]
  store i32 %mul31, i32* %innerLastIndex
  %tmp32 = load i32 addrspace(1)*, i32 addrspace(1)** %puiTmpArray.addr ; <i32 addrspace(1)*> [#uses=1]
  ...
  %tmp36 = load i32, i32* %szBin.addr                  ; <i32> [#uses=1]
  %mul37 = mul i32 %mul35, %tmp36                 ; <i32> [#uses=1]
  %add.ptr38 = getelementptr inbounds i32, i32 addrspace(1)* %tmp32, i32 %mul37 ; <i32 addrspace(1)*> [#uses=1]
  ...
  %tmp41 = load i32 addrspace(1)*, i32 addrspace(1)** %puiGroupOutputArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %call42 = call i32 @get_group_id(i32 0)         ; <i32> [#uses=1]
  %tmp43 = load i32, i32* %szBin.addr                  ; <i32> [#uses=1]
  %mul44 = mul i32 %call42, %tmp43                ; <i32> [#uses=1]
  %add.ptr45 = getelementptr inbounds i32, i32 addrspace(1)* %tmp41, i32 %mul44 ; <i32 addrspace(1)*> [#uses=1]
  store i32 addrspace(1)* %add.ptr45, i32 addrspace(1)** %shiftedGroupOutputArray
  store i32 0, i32* %t
  br label %for.cond47

for.cond47:                                       ; preds = %for.inc80, %for.end
  %tmp48 = load i32, i32* %t                           ; <i32> [#uses=1]
  %tmp49 = load i32, i32* %outerLastIndex              ; <i32> [#uses=1]
  %cmp50 = icmp ult i32 %tmp48, %tmp49            ; <i1> [#uses=1]
  br i1 %cmp50, label %for.body51, label %for.end83

for.body51:                                       ; preds = %for.cond47
  %tmp52 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedTmpArray ; <i32 addrspace(1)*> [#uses=1]
  %tmp53 = load i32, i32* %t                           ; <i32> [#uses=1]
  %tmp54 = load i32, i32* %szBin.addr                  ; <i32> [#uses=1]
  %mul55 = mul i32 %tmp53, %tmp54                 ; <i32> [#uses=1]
  %add.ptr56 = getelementptr inbounds i32, i32 addrspace(1)* %tmp52, i32 %mul55 ; <i32 addrspace(1)*> [#uses=1]
  store i32 addrspace(1)* %add.ptr56, i32 addrspace(1)** %shiftedOutTmpArray
  %tmp59 = load i32, i32* %lid                         ; <i32> [#uses=1]
  %tmp60 = load i32, i32* %szElemenetsPerItem.addr     ; <i32> [#uses=1]
  %mul61 = mul i32 %tmp59, %tmp60                 ; <i32> [#uses=1]
  store i32 %mul61, i32* %i58
  br label %for.cond62

for.cond62:                                       ; preds = %for.inc76, %for.body51
  %tmp63 = load i32, i32* %i58                         ; <i32> [#uses=1]
  %tmp64 = load i32, i32* %innerLastIndex              ; <i32> [#uses=1]
  %cmp65 = icmp ult i32 %tmp63, %tmp64            ; <i1> [#uses=1]
  br i1 %cmp65, label %for.body66, label %for.end79

for.body66:                                       ; preds = %for.cond62
  %tmp67 = load i32, i32* %i58                         ; <i32> [#uses=1]
  %tmp68 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedOutTmpArray ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx69 = getelementptr inbounds i32, i32 addrspace(1)* %tmp68, i32 %tmp67 ; <i32 addrspace(1)*> [#uses=1]
  %tmp70 = load i32, i32 addrspace(1)* %arrayidx69     ; <i32> [#uses=1]
  %tmp71 = load i32, i32* %i58                         ; <i32> [#uses=1]
  %tmp72 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedGroupOutputArray ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx73 = getelementptr inbounds i32, i32 addrspace(1)* %tmp72, i32 %tmp71 ; <i32 addrspace(1)*> [#uses=2]
  %tmp74 = load i32, i32 addrspace(1)* %arrayidx73     ; <i32> [#uses=1]
  %add75 = add i32 %tmp74, %tmp70                 ; <i32> [#uses=1]
  store i32 %add75, i32 addrspace(1)* %arrayidx73
  br label %for.inc76

for.inc76:                                        ; preds = %for.body66
  %tmp77 = load i32, i32* %i58                         ; <i32> [#uses=1]
...
for.inc80:                                        ; preds = %for.end79
  %tmp81 = load i32, i32* %t                           ; <i32> [#uses=1]
...
entry:
  ...
  store i32 %call, i32* %gid
  %tmp = load i32 addrspace(1)*, i32 addrspace(1)** %puiTmpArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %tmp1 = load i32, i32* %gid                          ; <i32> [#uses=1]
  %tmp2 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul = mul i32 %tmp1, %tmp2                     ; <i32> [#uses=1]
  %add.ptr = getelementptr inbounds i32, i32 addrspace(1)* %tmp, i32 %mul ; <i32 addrspace(1)*> [#uses=1]
  store i32 addrspace(1)* %add.ptr, i32 addrspace(1)** %shiftedTmpArray
  %tmp4 = load i32, i32* %gid                          ; <i32> [#uses=1]
  %add = add i32 %tmp4, 1                         ; <i32> [#uses=1]
  %tmp5 = load i32, i32* %szBinsPerItem.addr           ; <i32> [#uses=1]
  %mul6 = mul i32 %add, %tmp5                     ; <i32> [#uses=1]
  %tmp7 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul8 = mul i32 %mul6, %tmp7                    ; <i32> [#uses=1]
  store i32 %mul8, i32* %lastIndex
  %tmp10 = load i32, i32* %gid                         ; <i32> [#uses=1]
  %tmp11 = load i32, i32* %szBin.addr                  ; <i32> [#uses=1]
  %mul12 = mul i32 %tmp10, %tmp11                 ; <i32> [#uses=1]
  %tmp13 = load i32, i32* %szBinsPerItem.addr          ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %tmp16 = load i32, i32* %lastIndex                   ; <i32> [#uses=1]
  %cmp = icmp ult i32 %tmp15, %tmp16              ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp17 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp18 = load i32 addrspace(1)*, i32 addrspace(1)** %puiInputMatrix.addr ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %tmp18, i32 %tmp17 ; <i32 addrspace(1)*> [#uses=1]
  %tmp19 = load i32, i32 addrspace(1)* %arrayidx       ; <i32> [#uses=1]
  %tmp20 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedTmpArray ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx21 = getelementptr inbounds i32, i32 addrspace(1)* %tmp20, i32 %tmp19 ; <i32 addrspace(1)*> [#uses=2]
  %tmp22 = load i32, i32 addrspace(1)* %arrayidx21     ; <i32> [#uses=1]
...
entry:
  ...
  %tmp1 = load i32, i32* %szElemenetsPerItem.addr      ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc28, %entry
  %tmp4 = load i32, i32* %t                            ; <i32> [#uses=1]
  %tmp5 = load i32, i32* %szBinsInTmp.addr             ; <i32> [#uses=1]
  %cmp = icmp ult i32 %tmp4, %tmp5                ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end31

for.body:                                         ; preds = %for.cond
  %tmp6 = load i32 addrspace(1)*, i32 addrspace(1)** %puiTmpArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %tmp7 = load i32, i32* %t                            ; <i32> [#uses=1]
  %tmp8 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul9 = mul i32 %tmp7, %tmp8                    ; <i32> [#uses=1]
  %add.ptr = getelementptr inbounds i32, i32 addrspace(1)* %tmp6, i32 %mul9 ; <i32 addrspace(1)*> [#uses=1]
  store i32 addrspace(1)* %add.ptr, i32 addrspace(1)** %shiftedTmpArray
  %tmp11 = load i32, i32* %gid                         ; <i32> [#uses=1]
  %tmp12 = load i32, i32* %szElemenetsPerItem.addr     ; <i32> [#uses=1]
  %mul13 = mul i32 %tmp11, %tmp12                 ; <i32> [#uses=1]
...
for.body18:                                       ; preds = %for.cond14
  ...
  %tmp20 = load i32 addrspace(1)*, i32 addrspace(1)** %shiftedTmpArray ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %tmp20, i32 %tmp19 ; <i32 addrspace(1)*> [#uses=1]
  %tmp21 = load i32, i32 addrspace(1)* %arrayidx       ; <i32> [#uses=1]
  %tmp22 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp23 = load i32 addrspace(1)*, i32 addrspace(1)** %puiOutputArray.addr ; <i32 addrspace(1)*> [#uses=1]
  %arrayidx24 = getelementptr inbounds i32, i32 addrspace(1)* %tmp23, i32 %tmp22 ; <i32 addrspace(1)*> [#uses=2]
...
for.inc28:                                        ; preds = %for.end
  %tmp29 = load i32, i32* %t                           ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  %tmp6 = load <2 x i32> addrspace(1)*, <2 x i32> addrspace(1)** %puiTmpArray.addr ; <<2 x i32> addrspace(1)*> [#uses=1]
  %tmp7 = load i32, i32* %t                            ; <i32> [#uses=1]
  %tmp8 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul9 = mul i32 %tmp7, %tmp8                    ; <i32> [#uses=1]
  %add.ptr = getelementptr inbounds <2 x i32>, <2 x i32> addrspace(1)* %tmp6, i32 %mul9 ; <<2 x i32> addrspace(1)*> [#uses=1]
...
for.body18:                                       ; preds = %for.cond14
  %tmp19 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp20 = load <2 x i32> addrspace(1)*, <2 x i32> addrspace(1)** %shiftedTmpArray ; <<2 x i32> addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds <2 x i32>, <2 x i32> addrspace(1)* %tmp20, i32 %tmp19 ; <<2 x i32> addrspace(1)*> [#uses=1]
  %tmp21 = load <2 x i32>, <2 x i32> addrspace(1)* %arrayidx ; <<2 x i32>> [#uses=1]
  %tmp22 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp23 = load <2 x i32> addrspace(1)*, <2 x i32> addrspace(1)** %puiOutputArray.addr ; <<2 x i32> addrspace(1)*> [#uses=1]
  %arrayidx24 = getelementptr inbounds <2 x i32>, <2 x i32> addrspace(1)* %tmp23, i32 %tmp22 ; <<2 x i32> addrspace(1)*> [#uses=2]
  %tmp25 = load <2 x i32>, <2 x i32> addrspace(1)* %arrayidx24 ; <<2 x i32>> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  %tmp6 = load <4 x i32> addrspace(1)*, <4 x i32> addrspace(1)** %puiTmpArray.addr ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp7 = load i32, i32* %t                            ; <i32> [#uses=1]
  %tmp8 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul9 = mul i32 %tmp7, %tmp8                    ; <i32> [#uses=1]
  %add.ptr = getelementptr inbounds <4 x i32>, <4 x i32> addrspace(1)* %tmp6, i32 %mul9 ; <<4 x i32> addrspace(1)*> [#uses=1]
...
for.body18:                                       ; preds = %for.cond14
  %tmp19 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp20 = load <4 x i32> addrspace(1)*, <4 x i32> addrspace(1)** %shiftedTmpArray ; <<4 x i32> addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x i32>, <4 x i32> addrspace(1)* %tmp20, i32 %tmp19 ; <<4 x i32> addrspace(1)*> [#uses=1]
  %tmp21 = load <4 x i32>, <4 x i32> addrspace(1)* %arrayidx ; <<4 x i32>> [#uses=1]
  %tmp22 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp23 = load <4 x i32> addrspace(1)*, <4 x i32> addrspace(1)** %puiOutputArray.addr ; <<4 x i32> addrspace(1)*> [#uses=1]
  %arrayidx24 = getelementptr inbounds <4 x i32>, <4 x i32> addrspace(1)* %tmp23, i32 %tmp22 ; <<4 x i32> addrspace(1)*> [#uses=2]
  %tmp25 = load <4 x i32>, <4 x i32> addrspace(1)* %arrayidx24 ; <<4 x i32>> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  %tmp6 = load <8 x i32> addrspace(1)*, <8 x i32> addrspace(1)** %puiTmpArray.addr ; <<8 x i32> addrspace(1)*> [#uses=1]
  %tmp7 = load i32, i32* %t                            ; <i32> [#uses=1]
  %tmp8 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul9 = mul i32 %tmp7, %tmp8                    ; <i32> [#uses=1]
  %add.ptr = getelementptr inbounds <8 x i32>, <8 x i32> addrspace(1)* %tmp6, i32 %mul9 ; <<8 x i32> addrspace(1)*> [#uses=1]
...
for.body18:                                       ; preds = %for.cond14
  %tmp19 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp20 = load <8 x i32> addrspace(1)*, <8 x i32> addrspace(1)** %shiftedTmpArray ; <<8 x i32> addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds <8 x i32>, <8 x i32> addrspace(1)* %tmp20, i32 %tmp19 ; <<8 x i32> addrspace(1)*> [#uses=1]
  %tmp21 = load <8 x i32>, <8 x i32> addrspace(1)* %arrayidx ; <<8 x i32>> [#uses=1]
  %tmp22 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp23 = load <8 x i32> addrspace(1)*, <8 x i32> addrspace(1)** %puiOutputArray.addr ; <<8 x i32> addrspace(1)*> [#uses=1]
  %arrayidx24 = getelementptr inbounds <8 x i32>, <8 x i32> addrspace(1)* %tmp23, i32 %tmp22 ; <<8 x i32> addrspace(1)*> [#uses=2]
  %tmp25 = load <8 x i32>, <8 x i32> addrspace(1)* %arrayidx24 ; <<8 x i32>> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  %tmp6 = load <16 x i32> addrspace(1)*, <16 x i32> addrspace(1)** %puiTmpArray.addr ; <<16 x i32> addrspace(1)*> [#uses=1]
  %tmp7 = load i32, i32* %t                            ; <i32> [#uses=1]
  %tmp8 = load i32, i32* %szBin.addr                   ; <i32> [#uses=1]
  %mul9 = mul i32 %tmp7, %tmp8                    ; <i32> [#uses=1]
  %add.ptr = getelementptr inbounds <16 x i32>, <16 x i32> addrspace(1)* %tmp6, i32 %mul9 ; <<16 x i32> addrspace(1)*> [#uses=1]
...
for.body18:                                       ; preds = %for.cond14
  %tmp19 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp20 = load <16 x i32> addrspace(1)*, <16 x i32> addrspace(1)** %shiftedTmpArray ; <<16 x i32> addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds <16 x i32>, <16 x i32> addrspace(1)* %tmp20, i32 %tmp19 ; <<16 x i32> addrspace(1)*> [#uses=1]
  %tmp21 = load <16 x i32>, <16 x i32> addrspace(1)* %arrayidx ; <<16 x i32>> [#uses=1]
  %tmp22 = load i32, i32* %i                           ; <i32> [#uses=1]
  %tmp23 = load <16 x i32> addrspace(1)*, <16 x i32> addrspace(1)** %puiOutputArray.addr ; <<16 x i32> addrspace(1)*> [#uses=1]
  %arrayidx24 = getelementptr inbounds <16 x i32>, <16 x i32> addrspace(1)* %tmp23, i32 %tmp22 ; <<16 x i32> addrspace(1)*> [#uses=2]
  %tmp25 = load <16 x i32>, <16 x i32> addrspace(1)* %arrayidx24 ; <<16 x i32>> [#uses=1]

...
; RUN: opt  -runtimelib %p/../../Full/runtime.bc -inline-threshold=4096 -inline -lowerswitch -scalarize -mergereturn -loop-simplify -phicanon -predicate -mem2reg -dce -packetize -packet-size=16 -subscript -verify %t.bc -S -o %t1.ll

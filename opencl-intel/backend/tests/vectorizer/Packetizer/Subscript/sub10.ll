...
;CHECK: kernel
;CHECK: @"internal.gather.v16i32[i64].m1"(i1 %Entry3_to_Entry4, i32* [[NAME2:%stripAS[0-9]*]], <16 x i64> %6, i32 64, i1 true)
;CHECK: @"internal.scatter.v16i32[i64].m1"(i1 %Entry3_to_Entry4, i32* [[NAME3:%stripAS[0-9]*]], <16 x i64> %6, <16 x i32> %24, i32 64, i1 true)
;CHECK: ret void

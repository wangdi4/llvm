...
; RUN: opt -runtimelib %p/../../Full/runtime.bc -scalarize -predicate -mem2reg -dce -packetize -packet-size=16 -subscript -subscript-prefetch -verify %s -S -o - | FileCheck -check-prefix=CHECK_HW_PF %s
; RUN: opt -runtimelib %p/../../Full/runtime.bc -scalarize -predicate -mem2reg -dce -packetize -packet-size=16 -subscript -verify %s -S -o - | FileCheck -check-prefix=CHECK_SW_PF %s

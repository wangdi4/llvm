...
;CHECK: kernel
;CHECK: @"internal.gather.v16i32[i32].m1"(i1 true, i32* [[NAME1:%stripAS[0-9]*]], <16 x i32> %3, i32 32, i1 true)
;CHECK: @"internal.scatter.v16i32[i32].m1"(i1 true, i32* [[NAME2:%stripAS[0-9]*]], <16 x i32> %3, <16 x i32> %22, i32 32, i1 true)
;CHECK: ret void

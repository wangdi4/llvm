...
;CHECK: kernel
;CHECK: @"internal.gather.v4i8[i32].m4"(<4 x i1> [[NAME1:%[0-9]*]], i8* [[NAME2:%stripAS[0-9]*]], <4 x i32> %6, i32 32, i1 true)
;CHECK: @"internal.scatter.v4i8[i32].m4"(<4 x i1> [[NAME1]], i8* [[NAME3:%stripAS[0-9]*]], <4 x i32> %6, <4 x i8> %13, i32 32, i1 true)
;CHECK: ret void

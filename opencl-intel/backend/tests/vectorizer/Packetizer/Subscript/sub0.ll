...
;CHECK: kernel
;CHECK: @"internal.gather.v16i32[i32].m16"(<16 x i1> [[NAME1:%_to_[0-9]*]], i32* [[NAME2:%stripAS[0-9]*]], <16 x i32> %5, i32 32, i1 true)
;CHECK: @"internal.scatter.v16i32[i32].m16"(<16 x i1> [[NAME1]], i32* [[NAME3:%stripAS[0-9]*]], <16 x i32> %5, <16 x i32> %24, i32 32, i1 true)
;CHECK: ret void

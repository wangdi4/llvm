...
; CHECK: load <16 x i1> addrspace(1)* %{{[a-zA-Z0-9_.]+}}, align 1
; CHECK: store <16 x i1> %{{[a-zA-Z0-9_.]+}}, <16 x i1> addrspace(1)* %{{[a-zA-Z0-9_.]+}}, align 1
; CHECK: ret
  %1 = tail call i64 @get_global_id(i64 0) nounwind
  %2 = getelementptr inbounds i1 addrspace(1)* %X, i64 %1
  %3 = load i1 addrspace(1)* %2
  %4 = add i1 %3, 1
  %5 = getelementptr inbounds i1 addrspace(1)* %Y, i64 %1
...
; CHECK: load <16 x float> addrspace(1)* %{{[a-zA-Z0-9_.]+}}, align 64

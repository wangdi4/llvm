...
; The same as IsKernelVectorizationProfitableHasVecLength.ll
;   but with forced __attribute__((intel_reqd_sub_group_size(1)))
; It's expected that in such case vectorized kernel will be kept.

; CHECK-NOT: define
; CHECK: define void @"_ZTSZZ4mainENK3$_0clERN2cl4sycl7handlerEE4Test"
; CHECK: define void @"_ZGVeN16uuuuuuuuuuuuuuuu_TSZZ4mainENK3$_0clERN2cl4sycl7handlerEE4Test"
; CHECK-NOT: define

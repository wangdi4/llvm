...
; CHECK: declare spir_func i8 @_Z25intel_sub_group_broadcastcj(i8, i32) local_unnamed_addr [[ATTR]]
; CHECK: declare spir_func i8 @_Z26intel_sub_group_reduce_addc(i8) local_unnamed_addr [[ATTR]]
; CHECK: declare spir_func i8 @_Z26intel_sub_group_reduce_minc(i8) local_unnamed_addr [[ATTR]]
; CHECK: declare spir_func i8 @_Z26intel_sub_group_reduce_maxc(i8) local_unnamed_addr [[ATTR]]
; CHECK-NOT: opencl-vec-uniform-return
...
entry:
  ...
  %1 = trunc i32 %0 to i8
  %call4 = tail call spir_func i8 @_Z25intel_sub_group_broadcastcj(i8 %1, i32 0) #4
  %call5 = tail call spir_func i8 @_Z26intel_sub_group_reduce_addc(i8 %1) #4
  %call6 = tail call spir_func i8 @_Z26intel_sub_group_reduce_minc(i8 %1) #4
  %call7 = tail call spir_func i8 @_Z26intel_sub_group_reduce_maxc(i8 %1) #4
...
declare spir_func i8 @_Z26intel_sub_group_reduce_addc(i8) local_unnamed_addr #1
declare spir_func i8 @_Z26intel_sub_group_reduce_minc(i8) local_unnamed_addr #1

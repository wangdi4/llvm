...
; RUN: %oclopt < %s --ocl-vecclone -dpcpp-vect-info=%p/../Inputs/VectInfo64.gen --dpcpp-vector-variant-isa-encoding-override=AVX512Core -S -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
; RUN: %oclopt < %s --ocl-vecclone -dpcpp-vect-info=%p/../Inputs/VectInfo64.gen --dpcpp-vector-variant-isa-encoding-override=AVX512Core -S -o - | FileCheck %s

target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux"

define void @_ZTSZ4mainE9broadcast(i32 addrspace(1)* %_arg_, i32 addrspace(1)* %_arg_1) local_unnamed_addr #0 !kernel_has_sub_groups !1 !intel_reqd_sub_group_size !2 !recommended_vector_length !2 {
...
; CHECK:         [[CALL2_I_I_I_I_I0:%.*]] = tail call i32 @_Z19sub_group_broadcastjj(i32 [[ADD0]], i32 0) #5

...
; CHECK: = call {{(spir_func )?}}<64 x i32> @_Z20work_group_broadcastDv64_im(<64 x i32> %wide.load, i64 0)
  %call4 = tail call spir_func i32 @_Z20work_group_broadcastimm(i32 %0, i64 0, i64 0) #4
; CHECK: = call {{(spir_func )?}}<64 x i32> @_Z20work_group_broadcastDv64_imm(<64 x i32> %wide.load, i64 0, i64 0)
  %call5 = tail call spir_func i32 @_Z20work_group_broadcastimmm(i32 %0, i64 0, i64 0, i64 0) #4
; CHECK: = call {{(spir_func )?}}<64 x i32> @_Z20work_group_broadcastDv64_immm(<64 x i32> %wide.load, i64 0, i64 0, i64 0)

...
; CHECK: call <4 x float> @_Z4fmaxDv4_ff(<4 x float> [[WIDE_LOAD_TRUNCf32]]
; CHECK: call <4 x double> @_Z4fmaxDv4_dd(<4 x double> [[WIDE_LOAD_TRUNCf64]]
...
; CHECK: call <4 x float> @_Z11native_fmaxDv4_ff(<4 x float> [[WIDE_LOAD_TRUNCf32]]
; CHECK: call <4 x double> @_Z11native_fmaxDv4_dd(<4 x double> [[WIDE_LOAD_TRUNCf64]]
...
; CHECK: call <4 x i8> @_Z5clampDv4_ccc(<4 x i8> [[WIDE_LOAD_TRUNCi8]])
...
; CHECK: call <4 x float> @_Z3mixDv4_fS_f(<4 x float> [[WIDE_LOAD_TRUNCf32]]
; CHECK: call <4 x double> @_Z3mixDv4_dS_d(<4 x double> [[WIDE_LOAD_TRUNCf64]]
...
declare spir_func float @_Z4fmaxff(float) #0
declare spir_func double @_Z4fmaxdd(double) #0
...
declare spir_func float @_Z11native_fmaxff(float) #0
declare spir_func double @_Z11native_fmaxdd(double) #0
...
declare spir_func i8 @_Z8upsamplech(i8) #0
declare spir_func i8 @_Z5clampccc(i8) #0

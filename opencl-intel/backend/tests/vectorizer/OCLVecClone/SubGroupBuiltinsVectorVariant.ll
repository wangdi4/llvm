...
; CHECK: attributes #10 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv__Z23intel_sub_group_shuffleij(_Z23intel_sub_group_shuffleDv4_iDv4_jS0_)" }
; CHECK-NEXT: attributes #11 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv__Z23intel_sub_group_shufflejj(_Z23intel_sub_group_shuffleDv4_jS_S_)" }
; CHECK-NEXT: attributes #12 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv__Z23intel_sub_group_shuffleDv3_ij(_Z23intel_sub_group_shuffleDv12_iDv4_jS0_)" }
; CHECK-NEXT: attributes #13 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv__Z23intel_sub_group_shuffleDv16_sj(_Z23intel_sub_group_shuffleDv64_sDv4_jS0_)" }
; CHECK-NEXT: attributes #14 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z13sub_group_alli(_Z13sub_group_allDv4_iDv4_j)" }
; CHECK-NEXT: attributes #15 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv__Z19sub_group_broadcastlj(_Z19sub_group_broadcastDv4_lDv4_jS0_),_ZGVbM4vu__Z19sub_group_broadcastlj(_Z19sub_group_broadcastDv4_ljDv4_j)" }
; CHECK-NEXT: attributes #16 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv__Z19sub_group_broadcastij(_Z19sub_group_broadcastDv4_iDv4_jS0_),_ZGVbM4vu__Z19sub_group_broadcastij(_Z19sub_group_broadcastDv4_ijDv4_j)" }
; CHECK-NEXT: attributes #17 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv__Z25intel_sub_group_broadcastsj(_Z25intel_sub_group_broadcastDv4_sDv4_jS0_),_ZGVbM4vu__Z25intel_sub_group_broadcastsj(_Z25intel_sub_group_broadcastDv4_sjDv4_j)" }
; CHECK-NEXT: attributes #18 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv__Z25intel_sub_group_broadcastcj(_Z25intel_sub_group_broadcastDv4_cDv4_jS0_),_ZGVbM4vu__Z25intel_sub_group_broadcastcj(_Z25intel_sub_group_broadcastDv4_cjDv4_j)" }
; CHECK-NEXT: attributes #19 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z20sub_group_reduce_addi(_Z20sub_group_reduce_addDv4_iDv4_j)" }
; CHECK-NEXT: attributes #20 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z26intel_sub_group_reduce_mins(_Z26intel_sub_group_reduce_minDv4_sDv4_j)" }
; CHECK-NEXT: attributes #21 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z26intel_sub_group_reduce_maxc(_Z26intel_sub_group_reduce_maxDv4_cDv4_j)" }
; CHECK-NEXT: attributes #22 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z28sub_group_scan_exclusive_addi(_Z28sub_group_scan_exclusive_addDv4_iDv4_j)" }
; CHECK-NEXT: attributes #23 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z34intel_sub_group_scan_exclusive_mins(_Z34intel_sub_group_scan_exclusive_minDv4_sDv4_j)" }
; CHECK-NEXT: attributes #24 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z34intel_sub_group_scan_exclusive_maxc(_Z34intel_sub_group_scan_exclusive_maxDv4_cDv4_j)" }
; CHECK-NEXT: attributes #25 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z28sub_group_scan_inclusive_addi(_Z28sub_group_scan_inclusive_addDv4_iDv4_j)" }
; CHECK-NEXT: attributes #26 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z34intel_sub_group_scan_inclusive_mins(_Z34intel_sub_group_scan_inclusive_minDv4_sDv4_j)" }
; CHECK-NEXT: attributes #27 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z34intel_sub_group_scan_inclusive_maxc(_Z34intel_sub_group_scan_inclusive_maxDv4_cDv4_j)" }
; CHECK-NEXT: attributes #28 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vvv__Z28intel_sub_group_shuffle_downllj(_Z28intel_sub_group_shuffle_downDv4_lS_Dv4_jS0_)" }
; CHECK-NEXT: attributes #29 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vvv__Z28intel_sub_group_shuffle_downDv4_iS_j(_Z28intel_sub_group_shuffle_downDv16_iS_Dv4_jS0_)" }
; CHECK-NEXT: attributes #30 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4u__Z27intel_sub_group_block_read2PU3AS1Kj(_Z29intel_sub_group_block_read2_4PU3AS1KjDv4_j),_ZGVbM4v__Z27intel_sub_group_block_read2PU3AS1Kj(_Z29intel_sub_group_block_read2_4Dv4_PU3AS1KjDv4_j)" }
; CHECK-NEXT: attributes #31 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uv__Z28intel_sub_group_block_write2PU3AS1jDv2_j(_Z30intel_sub_group_block_write2_4PU3AS1jDv8_jDv4_j),_ZGVbM4vv__Z28intel_sub_group_block_write2PU3AS1jDv2_j(_Z30intel_sub_group_block_write2_4Dv4_PU3AS1jDv8_jDv4_j)" }
; CHECK-NEXT: attributes #32 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4u__Z30intel_sub_group_block_read_us2PU3AS1Kt(_Z32intel_sub_group_block_read_us2_4PU3AS1KtDv4_j),_ZGVbM4v__Z30intel_sub_group_block_read_us2PU3AS1Kt(_Z32intel_sub_group_block_read_us2_4Dv4_PU3AS1KtDv4_j)" }
; CHECK-NEXT: attributes #33 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uv__Z31intel_sub_group_block_write_us2PU3AS1tDv2_t(_Z33intel_sub_group_block_write_us2_4PU3AS1tDv8_tDv4_j),_ZGVbM4vv__Z31intel_sub_group_block_write_us2PU3AS1tDv2_t(_Z33intel_sub_group_block_write_us2_4Dv4_PU3AS1tDv8_tDv4_j)" }
; CHECK-NEXT: attributes #34 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uu__Z27intel_sub_group_block_read214ocl_image2d_roDv2_i(_Z29intel_sub_group_block_read2_414ocl_image2d_roDv2_iDv4_j),_ZGVbM4vv__Z27intel_sub_group_block_read214ocl_image2d_roDv2_i(_Z29intel_sub_group_block_read2_4Dv4_14ocl_image2d_roDv8_iDv4_j)" }
; CHECK-NEXT: attributes #35 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uuv__Z28intel_sub_group_block_write214ocl_image2d_woDv2_iDv2_j(_Z30intel_sub_group_block_write2_414ocl_image2d_woDv2_iDv8_jDv4_j),_ZGVbM4vvv__Z28intel_sub_group_block_write214ocl_image2d_woDv2_iDv2_j(_Z30intel_sub_group_block_write2_4Dv4_14ocl_image2d_woDv8_iDv8_jDv4_j)" }
; CHECK-NEXT: attributes #36 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uu__Z30intel_sub_group_block_read_us214ocl_image2d_roDv2_i(_Z32intel_sub_group_block_read_us2_414ocl_image2d_roDv2_iDv4_j),_ZGVbM4vv__Z30intel_sub_group_block_read_us214ocl_image2d_roDv2_i(_Z32intel_sub_group_block_read_us2_4Dv4_14ocl_image2d_roDv8_iDv4_j)" }
; CHECK-NEXT: attributes #37 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uuv__Z31intel_sub_group_block_write_us214ocl_image2d_woDv2_iDv2_t(_Z33intel_sub_group_block_write_us2_414ocl_image2d_woDv2_iDv8_tDv4_j),_ZGVbM4vvv__Z31intel_sub_group_block_write_us214ocl_image2d_woDv2_iDv2_t(_Z33intel_sub_group_block_write_us2_4Dv4_14ocl_image2d_woDv8_iDv8_tDv4_j)" }
; CHECK-NEXT: attributes #38 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v__Z22intel_sub_group_balloti(_Z22intel_sub_group_ballotDv4_iDv4_j)" }

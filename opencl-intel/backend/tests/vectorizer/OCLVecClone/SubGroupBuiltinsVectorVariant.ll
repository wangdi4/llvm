...
; CHECK: attributes #10 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv_intel_sub_group_shuffle(_Z23intel_sub_group_shuffleDv4_iDv4_jS0_)" }
; CHECK-NEXT: attributes #11 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv_intel_sub_group_shuffle(_Z23intel_sub_group_shuffleDv4_jS_S_)" }
; CHECK-NEXT: attributes #12 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv_intel_sub_group_shuffle(_Z23intel_sub_group_shuffleDv12_iDv4_jS0_)" }
; CHECK-NEXT: attributes #13 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv_intel_sub_group_shuffle(_Z23intel_sub_group_shuffleDv64_sDv4_jS0_)" }
; CHECK-NEXT: attributes #14 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_sub_group_all(_Z13sub_group_allDv4_iDv4_j)" }
; CHECK-NEXT: attributes #15 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv_sub_group_broadcast(_Z19sub_group_broadcastDv4_lDv4_jS0_),_ZGVbM4vu_sub_group_broadcast(_Z19sub_group_broadcastDv4_ljDv4_j)" }
; CHECK-NEXT: attributes #16 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv_sub_group_broadcast(_Z19sub_group_broadcastDv4_iDv4_jS0_),_ZGVbM4vu_sub_group_broadcast(_Z19sub_group_broadcastDv4_ijDv4_j)" }
; CHECK-NEXT: attributes #17 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv_intel_sub_group_broadcast(_Z25intel_sub_group_broadcastDv4_sDv4_jS0_),_ZGVbM4vu_intel_sub_group_broadcast(_Z25intel_sub_group_broadcastDv4_sjDv4_j)" }
; CHECK-NEXT: attributes #18 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vv_intel_sub_group_broadcast(_Z25intel_sub_group_broadcastDv4_cDv4_jS0_),_ZGVbM4vu_intel_sub_group_broadcast(_Z25intel_sub_group_broadcastDv4_cjDv4_j)" }
; CHECK-NEXT: attributes #19 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_sub_group_reduce_add(_Z20sub_group_reduce_addDv4_iDv4_j)" }
; CHECK-NEXT: attributes #20 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_intel_sub_group_reduce_min(_Z26intel_sub_group_reduce_minDv4_sDv4_j)" }
; CHECK-NEXT: attributes #21 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_intel_sub_group_reduce_max(_Z26intel_sub_group_reduce_maxDv4_cDv4_j)" }
; CHECK-NEXT: attributes #22 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_sub_group_scan_exclusive_add(_Z28sub_group_scan_exclusive_addDv4_iDv4_j)" }
; CHECK-NEXT: attributes #23 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_intel_sub_group_scan_exclusive_min(_Z34intel_sub_group_scan_exclusive_minDv4_sDv4_j)" }
; CHECK-NEXT: attributes #24 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_intel_sub_group_scan_exclusive_max(_Z34intel_sub_group_scan_exclusive_maxDv4_cDv4_j)" }
; CHECK-NEXT: attributes #25 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_sub_group_scan_inclusive_add(_Z28sub_group_scan_inclusive_addDv4_iDv4_j)" }
; CHECK-NEXT: attributes #26 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_intel_sub_group_scan_inclusive_min(_Z34intel_sub_group_scan_inclusive_minDv4_sDv4_j)" }
; CHECK-NEXT: attributes #27 = { convergent nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_intel_sub_group_scan_inclusive_max(_Z34intel_sub_group_scan_inclusive_maxDv4_cDv4_j)" }
; CHECK-NEXT: attributes #28 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vvv_intel_sub_group_shuffle_down(_Z28intel_sub_group_shuffle_downDv4_lS_Dv4_jS0_)" }
; CHECK-NEXT: attributes #29 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4vvv_intel_sub_group_shuffle_down(_Z28intel_sub_group_shuffle_downDv16_iS_Dv4_jS0_)" }
; CHECK-NEXT: attributes #30 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4u_intel_sub_group_block_read2_4(_Z29intel_sub_group_block_read2_4PU3AS1KjDv4_j),_ZGVbM4v_intel_sub_group_block_read(_Z29intel_sub_group_block_read2_4Dv4_PU3AS1KjDv4_j)" }
; CHECK-NEXT: attributes #31 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uv_intel_sub_group_block_write2_4(_Z30intel_sub_group_block_write2_4PU3AS1jDv8_jDv4_j),_ZGVbM4vv_intel_sub_group_block_write(_Z30intel_sub_group_block_write2_4Dv4_PU3AS1jDv8_jDv4_j)" }
; CHECK-NEXT: attributes #32 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4u_intel_sub_group_block_read_us2_4(_Z32intel_sub_group_block_read_us2_4PU3AS1KtDv4_j),_ZGVbM4v_intel_sub_group_block_read_us(_Z32intel_sub_group_block_read_us2_4Dv4_PU3AS1KtDv4_j)" }
; CHECK-NEXT: attributes #33 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uv_intel_sub_group_block_write_us2_4(_Z33intel_sub_group_block_write_us2_4PU3AS1tDv8_tDv4_j),_ZGVbM4vv_intel_sub_group_block_write_us(_Z33intel_sub_group_block_write_us2_4Dv4_PU3AS1tDv8_tDv4_j)" }
; CHECK-NEXT: attributes #34 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uu_intel_sub_group_block_read2_4(_Z29intel_sub_group_block_read2_414ocl_image2d_roDv2_iDv4_j),_ZGVbM4vv_intel_sub_group_block_read(_Z29intel_sub_group_block_read2_4Dv4_14ocl_image2d_roDv8_iDv4_j)" }
; CHECK-NEXT: attributes #35 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uuv_intel_sub_group_block_write2_4(_Z30intel_sub_group_block_write2_414ocl_image2d_woDv2_iDv8_jDv4_j),_ZGVbM4vvv_intel_sub_group_block_write(_Z30intel_sub_group_block_write2_4Dv4_14ocl_image2d_woDv8_iDv8_jDv4_j)" }
; CHECK-NEXT: attributes #36 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uu_intel_sub_group_block_read_us2_4(_Z32intel_sub_group_block_read_us2_414ocl_image2d_roDv2_iDv4_j),_ZGVbM4vv_intel_sub_group_block_read_us(_Z32intel_sub_group_block_read_us2_4Dv4_14ocl_image2d_roDv8_iDv4_j)" }
; CHECK-NEXT: attributes #37 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4uuv_intel_sub_group_block_write_us2_4(_Z33intel_sub_group_block_write_us2_414ocl_image2d_woDv2_iDv8_tDv4_j),_ZGVbM4vvv_intel_sub_group_block_write_us(_Z33intel_sub_group_block_write_us2_4Dv4_14ocl_image2d_woDv8_iDv8_tDv4_j)" }
; CHECK-NEXT: attributes #38 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_intel_sub_group_ballot(_Z22intel_sub_group_ballotDv4_iDv4_j)" }
; CHECK-NEXT: attributes #39 = { "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM4v_sub_group_ballot(intel_sub_group_ballot_vf4)" }

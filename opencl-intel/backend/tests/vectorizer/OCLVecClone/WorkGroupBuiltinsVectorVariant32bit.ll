...
; CHECK: = call <4 x i32> @_Z20work_group_broadcastDv4_ij(<4 x i32> %wide.load, i32 0)
  %call4 = tail call spir_func i32 @_Z20work_group_broadcastijj(i32 %0, i32 0, i32 0) #4
; CHECK: = call <4 x i32> @_Z20work_group_broadcastDv4_ijj(<4 x i32> %wide.load, i32 0, i32 0)
  %call5 = tail call spir_func i32 @_Z20work_group_broadcastijjj(i32 %0, i32 0, i32 0, i32 0) #4
; CHECK: = call <4 x i32> @_Z20work_group_broadcastDv4_ijjj(<4 x i32> %wide.load, i32 0, i32 0, i32 0)

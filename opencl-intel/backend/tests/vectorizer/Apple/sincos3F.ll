...
; CHECK: ret
 ...
 NewDefault:                                       ; preds = %LeafBlock1, %LeafBlock
  ...
  !0 = metadata !{void (float addrspace(1)*, float addrspace(1)*, float addrspace(1)*)* @math_kernel3, metadata !1}
  ...
  !6 = metadata !{metadata !"float", metadata !4}

  !7 = metadata !{void (float addrspace(1)*, float addrspace(1)*, float addrspace(1)*)* @math_kernel3, metadata !8}

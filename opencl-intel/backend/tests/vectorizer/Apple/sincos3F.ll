...
; CHECK: ret
  ...
  @llvm.global.annotations = appending global [1 x { i8*, i8*, i8*, i8*, i32 }] [{ i8*, i8*, i8*, i8*, i32 } { i8* bitcast (void (float addrspace(1)*, float addrspace(1)*, float addrspace(1)*)* @math_kernel3 to i8*), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sgv, i32 0, i32 0), i8* getelementptr inbounds ([0 x i8], [0 x i8]* @fgv, i32 0, i32 0), i8* bitcast ([0 x i8*]* @lvgv to i8*), i32 0 }], section "llvm.metadata"
  ...
  define void @__Vectorized_.math_kernel3(float addrspace(1)* %out, float addrspace(1)* %out2, float addrspace(1)* %in) nounwind {
     ...
     %14 = load <4 x float>, <4 x float>* %9, align 16
 ...
 LeafBlock:                                        ; preds = %NodeBlock
     ...
     %22 = load float, float addrspace(1)* %21, align 4, !tbaa !6

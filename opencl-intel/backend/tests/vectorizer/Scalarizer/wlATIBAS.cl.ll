...
@opencl_metadata = appending global [2 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (<4 x float> addrspace(1)*, i32, <4 x float> addrspace(1)*, <4 x float> addrspace(1)*)* @blackScholes to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_blackScholes_locals to i8*), i8* getelementptr inbounds ([142 x i8], [142 x i8]* @opencl_blackScholes_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (float addrspace(1)*, i32, float addrspace(1)*, float addrspace(1)*)* @blackScholes_scalar to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_blackScholes_scalar_locals to i8*), i8* getelementptr inbounds ([139 x i8], [139 x i8]* @opencl_blackScholes_scalar_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[2 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %tmp = load <4 x float>, <4 x float>* %X.addr                ; <<4 x float>> [#uses=1]
  %call = call <4 x float> @_Z4fabsDv4_f(<4 x float> %tmp) ; <<4 x float>> [#uses=1]
  store <4 x float> %call, <4 x float>* %absX
  %tmp1 = load <4 x float>, <4 x float>* %one                  ; <<4 x float>> [#uses=1]
  %tmp2 = load <4 x float>, <4 x float>* %one                  ; <<4 x float>> [#uses=1]
  %tmp3 = load <4 x float>, <4 x float>* %temp4                ; <<4 x float>> [#uses=1]
  %tmp4 = load <4 x float>, <4 x float>* %absX                 ; <<4 x float>> [#uses=1]
  ...
  %tmp5 = load <4 x float>, <4 x float>* %one                  ; <<4 x float>> [#uses=1]
  %tmp6 = load <4 x float>, <4 x float>* %oneBySqrt2pi         ; <<4 x float>> [#uses=1]
  %tmp7 = load <4 x float>, <4 x float>* %X.addr               ; <<4 x float>> [#uses=1]
  %neg = fsub <4 x float> <float -0.000000e+000, float -0.000000e+000, float -0.000000e+000, float -0.000000e+000>, %tmp7 ; <<4 x float>> [#uses=1]
  %tmp8 = load <4 x float>, <4 x float>* %X.addr               ; <<4 x float>> [#uses=1]
  %mul9 = fmul <4 x float> %neg, %tmp8            ; <<4 x float>> [#uses=1]
  %tmp10 = load <4 x float>, <4 x float>* %two                 ; <<4 x float>> [#uses=3]
  ...
  %tmp16 = load <4 x float>, <4 x float>* %t                   ; <<4 x float>> [#uses=1]
  %mul17 = fmul <4 x float> %mul15, %tmp16        ; <<4 x float>> [#uses=1]
  %tmp18 = load <4 x float>, <4 x float>* %c1                  ; <<4 x float>> [#uses=1]
  %tmp19 = load <4 x float>, <4 x float>* %t                   ; <<4 x float>> [#uses=1]
  %tmp20 = load <4 x float>, <4 x float>* %c2                  ; <<4 x float>> [#uses=1]
  %tmp21 = load <4 x float>, <4 x float>* %t                   ; <<4 x float>> [#uses=1]
  %tmp22 = load <4 x float>, <4 x float>* %c3                  ; <<4 x float>> [#uses=1]
  %tmp23 = load <4 x float>, <4 x float>* %t                   ; <<4 x float>> [#uses=1]
  %tmp24 = load <4 x float>, <4 x float>* %c4                  ; <<4 x float>> [#uses=1]
  %tmp25 = load <4 x float>, <4 x float>* %t                   ; <<4 x float>> [#uses=1]
  %tmp26 = load <4 x float>, <4 x float>* %c5                  ; <<4 x float>> [#uses=1]
  ...
  %tmp36 = load <4 x float>, <4 x float>* %X.addr              ; <<4 x float>> [#uses=1]
  %tmp37 = extractelement <4 x float> %tmp36, i32 0 ; <float> [#uses=1]
  %tmp38 = load <4 x float>, <4 x float>* %zero                ; <<4 x float>> [#uses=1]
...
cond.true55:                                      ; preds = %cond.end
  %tmp56 = load <4 x float>, <4 x float>* %one                 ; <<4 x float>> [#uses=1]
  %tmp57 = extractelement <4 x float> %tmp56, i32 1 ; <float> [#uses=1]
  %tmp58 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
...
cond.false61:                                     ; preds = %cond.end
  %tmp62 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
...
cond.true73:                                      ; preds = %cond.end64
  %tmp74 = load <4 x float>, <4 x float>* %one                 ; <<4 x float>> [#uses=1]
  %tmp75 = extractelement <4 x float> %tmp74, i32 2 ; <float> [#uses=1]
  %tmp76 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
...
cond.false79:                                     ; preds = %cond.end64
  %tmp80 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
...
cond.true91:                                      ; preds = %cond.end82
  %tmp92 = load <4 x float>, <4 x float>* %one                 ; <<4 x float>> [#uses=1]
  %tmp93 = extractelement <4 x float> %tmp92, i32 3 ; <float> [#uses=1]
  %tmp94 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
...
cond.false97:                                     ; preds = %cond.end82
  %tmp98 = load <4 x float>, <4 x float>* %y                   ; <<4 x float>> [#uses=1]
...
cond.end100:                                      ; preds = %cond.false97, %cond.true91
  ...
  %tmp102 = load <4 x float>, <4 x float>* %result             ; <<4 x float>> [#uses=1]
  %tmp103 = insertelement <4 x float> %tmp102, float %cond101, i32 3 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp103, <4 x float>* %result
  %tmp104 = load <4 x float>, <4 x float>* %result             ; <<4 x float>> [#uses=1]
  %tmp105 = load <4 x float>*, <4 x float>** %phi.addr          ; <<4 x float>*> [#uses=1]
...
entry:
  ...
  store <4 x float> <float 2.000000e+000, float 2.000000e+000, float 2.000000e+000, float 2.000000e+000>, <4 x float>* %two
  %tmp = load i32, i32* %yPos                          ; <i32> [#uses=1]
  %tmp3 = load i32, i32* %width.addr                   ; <i32> [#uses=1]
  ...
  %tmp10 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp14 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp16 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp21 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp23 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp28 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp30 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp35 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp37 = load <4 x float>, <4 x float>* %inRand              ; <<4 x float>> [#uses=1]
  ...
  %tmp41 = load <4 x float>, <4 x float>* %sigmaVal            ; <<4 x float>> [#uses=1]
  %tmp42 = load <4 x float>, <4 x float>* %T                   ; <<4 x float>> [#uses=1]
  ...
  %tmp45 = load <4 x float>, <4 x float>* %S                   ; <<4 x float>> [#uses=1]
  %tmp46 = load <4 x float>, <4 x float>* %K                   ; <<4 x float>> [#uses=3]
  ...
  %tmp48 = load <4 x float>, <4 x float>* %R                   ; <<4 x float>> [#uses=1]
  %tmp49 = load <4 x float>, <4 x float>* %sigmaVal            ; <<4 x float>> [#uses=1]
  %tmp50 = load <4 x float>, <4 x float>* %sigmaVal            ; <<4 x float>> [#uses=1]
  %mul51 = fmul <4 x float> %tmp49, %tmp50        ; <<4 x float>> [#uses=1]
  %tmp52 = load <4 x float>, <4 x float>* %two                 ; <<4 x float>> [#uses=3]
  ...
  %tmp57 = load <4 x float>, <4 x float>* %T                   ; <<4 x float>> [#uses=1]
  %mul58 = fmul <4 x float> %add56, %tmp57        ; <<4 x float>> [#uses=1]
  %add59 = fadd <4 x float> %call47, %mul58       ; <<4 x float>> [#uses=1]
  %tmp60 = load <4 x float>, <4 x float>* %sigmaSqrtT          ; <<4 x float>> [#uses=3]
  ...
  %tmp64 = load <4 x float>, <4 x float>* %d1                  ; <<4 x float>> [#uses=1]
  %tmp65 = load <4 x float>, <4 x float>* %sigmaSqrtT          ; <<4 x float>> [#uses=1]
  %sub66 = fsub <4 x float> %tmp64, %tmp65        ; <<4 x float>> [#uses=1]
  store <4 x float> %sub66, <4 x float>* %d2
  %tmp67 = load <4 x float>, <4 x float>* %K                   ; <<4 x float>> [#uses=1]
  %tmp68 = load <4 x float>, <4 x float>* %R                   ; <<4 x float>> [#uses=1]
  ...
  %tmp69 = load <4 x float>, <4 x float>* %T                   ; <<4 x float>> [#uses=1]
  ...
  %tmp73 = load <4 x float>, <4 x float>* %d1                  ; <<4 x float>> [#uses=1]
  call void @phi(<4 x float> %tmp73, <4 x float>* %phiD1)
  %tmp74 = load <4 x float>, <4 x float>* %d2                  ; <<4 x float>> [#uses=1]
  call void @phi(<4 x float> %tmp74, <4 x float>* %phiD2)
  %tmp75 = load <4 x float>, <4 x float>* %S                   ; <<4 x float>> [#uses=1]
  %tmp76 = load <4 x float>, <4 x float>* %phiD1               ; <<4 x float>> [#uses=1]
  %mul77 = fmul <4 x float> %tmp75, %tmp76        ; <<4 x float>> [#uses=1]
  %tmp78 = load <4 x float>, <4 x float>* %KexpMinusRT         ; <<4 x float>> [#uses=1]
  %tmp79 = load <4 x float>, <4 x float>* %phiD2               ; <<4 x float>> [#uses=1]
  %mul80 = fmul <4 x float> %tmp78, %tmp79        ; <<4 x float>> [#uses=1]
  %sub81 = fsub <4 x float> %mul77, %mul80        ; <<4 x float>> [#uses=1]
  %tmp82 = load i32, i32* %yPos                        ; <i32> [#uses=1]
  %tmp83 = load i32, i32* %width.addr                  ; <i32> [#uses=1]
  ...
  %tmp91 = load <4 x float>, <4 x float>* %d2                  ; <<4 x float>> [#uses=1]
  ...
  %tmp93 = load <4 x float>, <4 x float>* %KexpMinusRT         ; <<4 x float>> [#uses=1]
  %tmp94 = load <4 x float>, <4 x float>* %phiD2               ; <<4 x float>> [#uses=1]
  %mul95 = fmul <4 x float> %tmp93, %tmp94        ; <<4 x float>> [#uses=1]
  %tmp96 = load <4 x float>, <4 x float>* %S                   ; <<4 x float>> [#uses=1]
  %tmp97 = load <4 x float>, <4 x float>* %phiD1               ; <<4 x float>> [#uses=1]
  %mul98 = fmul <4 x float> %tmp96, %tmp97        ; <<4 x float>> [#uses=1]
  %sub99 = fsub <4 x float> %mul95, %mul98        ; <<4 x float>> [#uses=1]
  %tmp100 = load i32, i32* %yPos                       ; <i32> [#uses=1]
  %tmp101 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
entry:
  ...
  %tmp = load float, float* %X.addr                      ; <float> [#uses=1]
  %call = call float @_Z4fabsf(float %tmp)        ; <float> [#uses=1]
  store float %call, float* %absX
  %tmp1 = load float, float* %temp4                      ; <float> [#uses=1]
  %tmp2 = load float, float* %absX                       ; <float> [#uses=1]
  ...
  %tmp3 = load float, float* %oneBySqrt2pi               ; <float> [#uses=1]
  %tmp4 = load float, float* %X.addr                     ; <float> [#uses=1]
  %neg = fsub float -0.000000e+000, %tmp4         ; <float> [#uses=1]
  %tmp5 = load float, float* %X.addr                     ; <float> [#uses=1]
  ...
  %tmp10 = load float, float* %t                         ; <float> [#uses=1]
  %mul11 = fmul float %mul9, %tmp10               ; <float> [#uses=1]
  %tmp12 = load float, float* %c1                        ; <float> [#uses=1]
  %tmp13 = load float, float* %t                         ; <float> [#uses=1]
  %tmp14 = load float, float* %c2                        ; <float> [#uses=1]
  %tmp15 = load float, float* %t                         ; <float> [#uses=1]
  %tmp16 = load float, float* %c3                        ; <float> [#uses=1]
  %tmp17 = load float, float* %t                         ; <float> [#uses=1]
  %tmp18 = load float, float* %c4                        ; <float> [#uses=1]
  %tmp19 = load float, float* %t                         ; <float> [#uses=1]
  %tmp20 = load float, float* %c5                        ; <float> [#uses=1]
...
entry:
  ...
  %tmp10 = load float, float* %inRand                    ; <float> [#uses=1]
  ...
  %tmp14 = load float, float* %inRand                    ; <float> [#uses=1]
  %mul15 = fmul float 1.000000e+001, %tmp14       ; <float> [#uses=1]
  %tmp16 = load float, float* %inRand                    ; <float> [#uses=1]
  ...
  %tmp21 = load float, float* %inRand                    ; <float> [#uses=1]
  %mul22 = fmul float 1.000000e+000, %tmp21       ; <float> [#uses=1]
  %tmp23 = load float, float* %inRand                    ; <float> [#uses=1]
  ...
  %tmp28 = load float, float* %inRand                    ; <float> [#uses=1]
  %mul29 = fmul float 0x3F847AE140000000, %tmp28  ; <float> [#uses=1]
  %tmp30 = load float, float* %inRand                    ; <float> [#uses=1]
  ...
  %tmp35 = load float, float* %inRand                    ; <float> [#uses=1]
  %mul36 = fmul float 0x3F847AE140000000, %tmp35  ; <float> [#uses=1]
  %tmp37 = load float, float* %inRand                    ; <float> [#uses=1]
  ...
  %tmp41 = load float, float* %sigmaVal                  ; <float> [#uses=1]
  ...
  %tmp45 = load float, float* %S                         ; <float> [#uses=1]
  %tmp46 = load float, float* %K                         ; <float> [#uses=3]
  ...
  %tmp48 = load float, float* %R                         ; <float> [#uses=1]
  %tmp49 = load float, float* %sigmaVal                  ; <float> [#uses=1]
  %tmp50 = load float, float* %sigmaVal                  ; <float> [#uses=1]
  %mul51 = fmul float %tmp49, %tmp50              ; <float> [#uses=1]
  %tmp52 = load float, float* %two                       ; <float> [#uses=3]
  ...
  %tmp57 = load float, float* %T                         ; <float> [#uses=1]
  %mul58 = fmul float %add56, %tmp57              ; <float> [#uses=1]
  %add59 = fadd float %call47, %mul58             ; <float> [#uses=1]
  %tmp60 = load float, float* %sigmaSqrtT                ; <float> [#uses=3]
  ...
  %tmp64 = load float, float* %d1                        ; <float> [#uses=1]
  %tmp65 = load float, float* %sigmaSqrtT                ; <float> [#uses=1]
  %sub66 = fsub float %tmp64, %tmp65              ; <float> [#uses=1]
  store float %sub66, float* %d2
  %tmp67 = load float, float* %K                         ; <float> [#uses=1]
  %tmp68 = load float, float* %R                         ; <float> [#uses=1]
  %neg = fsub float -0.000000e+000, %tmp68        ; <float> [#uses=1]
  %tmp69 = load float, float* %T                         ; <float> [#uses=1]
  ...
  %tmp73 = load float, float* %d1                        ; <float> [#uses=1]
  call void @phi_scalar(float %tmp73, float* %phiD1)
  %tmp74 = load float, float* %d2                        ; <float> [#uses=1]
  call void @phi_scalar(float %tmp74, float* %phiD2)
  %tmp75 = load float, float* %S                         ; <float> [#uses=1]
  %tmp76 = load float, float* %phiD1                     ; <float> [#uses=1]
  %mul77 = fmul float %tmp75, %tmp76              ; <float> [#uses=1]
  %tmp78 = load float, float* %KexpMinusRT               ; <float> [#uses=1]
  %tmp79 = load float, float* %phiD2                     ; <float> [#uses=1]
  ...
  %tmp91 = load float, float* %d2                        ; <float> [#uses=1]
  %neg92 = fsub float -0.000000e+000, %tmp91      ; <float> [#uses=1]
  call void @phi_scalar(float %neg92, float* %phiD2)
  %tmp93 = load float, float* %KexpMinusRT               ; <float> [#uses=1]
  %tmp94 = load float, float* %phiD2                     ; <float> [#uses=1]
  %mul95 = fmul float %tmp93, %tmp94              ; <float> [#uses=1]
  %tmp96 = load float, float* %S                         ; <float> [#uses=1]
  %tmp97 = load float, float* %phiD1                     ; <float> [#uses=1]

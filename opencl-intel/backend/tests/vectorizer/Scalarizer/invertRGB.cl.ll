...
entry:
  ...
  %tmp2 = load <4 x float>* %pixel.addr           ; <<4 x float>> [#uses=1]
  ...
  %tmp7 = load <4 x float>* %pixel.addr           ; <<4 x float>> [#uses=1]

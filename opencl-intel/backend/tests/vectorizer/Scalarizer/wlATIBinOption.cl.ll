...
entry:
  ...
  %call29 = call <4 x float> @_Z4sqrtDv4_f(<4 x float> %tmp28) ; <<4 x float>> [#uses=1]
  ...
  %call36 = call <4 x float> @_Z3expDv4_f(<4 x float> %tmp35) ; <<4 x float>> [#uses=1]
  ...
  %call44 = call <4 x float> @_Z3expDv4_f(<4 x float> %tmp43) ; <<4 x float>> [#uses=1]
  ...
  %call83 = call <4 x float> @_Z3expDv4_f(<4 x float> %mul82) ; <<4 x float>> [#uses=1]

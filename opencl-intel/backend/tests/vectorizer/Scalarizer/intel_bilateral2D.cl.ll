...
entry:
  ...
  call void @llvm.memset.p0i8.i32(i8* %tmp, i8 0, i32 16, i32 4, i1 false)
...
for.body89:                                       ; preds = %for.cond81
  ...
  %call113 = call <4 x float> @_Z4fabsDv4_f(<4 x float> %sub112) ; <<4 x float>> [#uses=1]
...
if.then:                                          ; preds = %for.body89
  ...
  %call136 = call float @_Z3dotDv4_fS_(<4 x float> %tmp134, <4 x float> %tmp135) ; <float> [#uses=1]

...
@opencl_metadata = appending global [1 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (%struct._image2d_t*, %struct._image2d_t*, float, i32)* @wlAdobe_PB_PixelateKernel to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_wlAdobe_PB_PixelateKernel_locals to i8*), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @opencl_wlAdobe_PB_PixelateKernel_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[1 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %call6 = call <2 x float> @_Z14convert_float2Dv2_i(<2 x i32> %tmp5) ; <<2 x float>> [#uses=1]
  ...
  %call10 = call <2 x float> @_Z5floorDv2_f(<2 x float> %div) ; <<2 x float>> [#uses=1]
  ...
  call void @_Z12write_imagefP10_image2d_tDv2_iDv4_f(%struct._image2d_t* %tmp17, <2 x i32> %tmp18, <4 x float> %tmp19)
  ret void
}

...
; Unmasked load/store <2 x i32> with no gather/scatter support
...
;CHECK: kernel
;CHECK: [[NAME1:%[0-9]*]] = load <2 x i32>*
;CHECK-NO: load <2 x i32>*
;CHECK: store <2 x i32>
;CHECK-NO: load <2 x i32>*
;CHECK-NO: store <2 x i32>
;CHECK: ret void
...
define void @kernel(<2 x i32>* nocapture %A) nounwind {
  ...
  %2 = mul nsw i32 %1, 7
  %3 = sext i32 %2 to i64
  %4 = getelementptr inbounds <2 x i32>* %A, i64 %3
  %5 = load <2 x i32>* %4, align 4, !tbaa !0

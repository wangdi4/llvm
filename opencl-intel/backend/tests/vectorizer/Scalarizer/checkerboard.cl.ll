...
entry:
  ...
  %call = call <2 x float> @_Z5floorDv2_f(<2 x float> %div) ; <<2 x float>> [#uses=1]
  ...
  %call6 = call <2 x float> @_Z4fmodDv2_fS_(<2 x float> %tmp4, <2 x float> %tmp5) ; <<2 x float>> [#uses=1]
  ...
  %call12 = call <2 x i32> @_Z7isequalDv2_fS_(<2 x float> %tmp10, <2 x float> %tmp11) ; <<2 x i32>> [#uses=1]
  %call13 = call i32 @_Z3allDv2_i(<2 x i32> %call12) ; <i32> [#uses=1]
...
lor.rhs:                                          ; preds = %entry
  ...
  %call16 = call <2 x i32> @_Z7isequalDv2_fS_(<2 x float> %tmp14, <2 x float> %tmp15) ; <<2 x i32>> [#uses=1]
  %call17 = call i32 @_Z3allDv2_i(<2 x i32> %call16) ; <i32> [#uses=1]

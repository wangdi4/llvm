...
entry:
  ...
  %tmp20 = load i32, i32* %groupIdy                    ; <i32> [#uses=1]
  %tmp21 = load i32, i32* %blockSize.addr              ; <i32> [#uses=1]
  %mul22 = mul i32 %tmp20, %tmp21                 ; <i32> [#uses=1]
  %tmp23 = load i32, i32* %localIdy                    ; <i32> [#uses=1]
  %add24 = add i32 %mul22, %tmp23                 ; <i32> [#uses=1]
  store i32 %add24, i32* %targetGlobalIdx
  %tmp26 = load i32, i32* %groupIdx                    ; <i32> [#uses=1]
  %tmp27 = load i32, i32* %blockSize.addr              ; <i32> [#uses=1]
  %mul28 = mul i32 %tmp26, %tmp27                 ; <i32> [#uses=1]
  %tmp29 = load i32, i32* %localIdx                    ; <i32> [#uses=1]
  %add30 = add i32 %mul28, %tmp29                 ; <i32> [#uses=1]
  store i32 %add30, i32* %targetGlobalIdy
  %tmp32 = load i32, i32* %targetGlobalIdy             ; <i32> [#uses=1]
  %tmp33 = load i32, i32* %height.addr                 ; <i32> [#uses=1]
  %mul34 = mul i32 %tmp32, %tmp33                 ; <i32> [#uses=1]
  %tmp35 = load i32, i32* %targetGlobalIdx             ; <i32> [#uses=1]
  %add36 = add i32 %mul34, %tmp35                 ; <i32> [#uses=1]
  store i32 %add36, i32* %targetIndex
  %tmp38 = load i32, i32* %localIdy                    ; <i32> [#uses=1]
  %tmp39 = load i32, i32* %blockSize.addr              ; <i32> [#uses=1]

...
entry:
  ...
  %tmp6 = load i32, i32* %k1                           ; <i32> [#uses=1]
  %mul = mul i32 %tmp6, 8                         ; <i32> [#uses=1]
  store i32 %mul, i32* %index1
  %tmp7 = load i32, i32* %groupIdy                     ; <i32> [#uses=1]
  %mul8 = mul i32 %tmp7, 8                        ; <i32> [#uses=1]
  %tmp9 = load i32, i32* %width.addr                   ; <i32> [#uses=1]
  %mul10 = mul i32 %mul8, %tmp9                   ; <i32> [#uses=1]
  %tmp11 = load i32, i32* %groupIdx                    ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc39, %entry
  %tmp14 = load i32, i32* %ind                         ; <i32> [#uses=1]
...
for.cond15:                                       ; preds = %for.inc, %for.body
  %tmp16 = load i32, i32* %n1                          ; <i32> [#uses=1]
  %cmp17 = icmp ult i32 %tmp16, 8                 ; <i1> [#uses=1]
  br i1 %cmp17, label %for.body18, label %for.end

for.body18:                                       ; preds = %for.cond15
  %tmp19 = load i32, i32* %index1                      ; <i32> [#uses=1]
  %tmp20 = load i32, i32* %n1                          ; <i32> [#uses=1]
  %add21 = add i32 %tmp19, %tmp20                 ; <i32> [#uses=1]
  %tmp22 = load float addrspace(1)*, float addrspace(1)** %dct.addr    ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp24 = load i32, i32* %index2                      ; <i32> [#uses=1]
  %tmp25 = load i32, i32* %n1                          ; <i32> [#uses=1]
  %add26 = add i32 %tmp24, %tmp25                 ; <i32> [#uses=1]
  %tmp27 = load float addrspace(1)*, float addrspace(1)** %input.addr  ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp31 = load i32, i32* %ind                         ; <i32> [#uses=1]
  %arraydecay = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx32 = getelementptr inbounds float, float* %arraydecay, i32 %tmp31 ; <float*> [#uses=2]
  %tmp33 = load float, float* %arrayidx32                ; <float> [#uses=1]
  %add34 = fadd float %tmp33, %mul30              ; <float> [#uses=1]
  store float %add34, float* %arrayidx32
  br label %for.inc

for.inc:                                          ; preds = %for.body18
  %tmp35 = load i32, i32* %n1                          ; <i32> [#uses=1]
  %inc = add i32 %tmp35, 1                        ; <i32> [#uses=1]
  store i32 %inc, i32* %n1
  br label %for.cond15

for.end:                                          ; preds = %for.cond15
  %tmp36 = load i32, i32* %width.addr                  ; <i32> [#uses=1]
...
for.inc39:                                        ; preds = %for.end
  %tmp40 = load i32, i32* %ind                         ; <i32> [#uses=1]
  %inc41 = add nsw i32 %tmp40, 1                  ; <i32> [#uses=1]
  store i32 %inc41, i32* %ind
  br label %for.cond

for.end42:                                        ; preds = %for.cond
  %tmp43 = load i32, i32* %k1                          ; <i32> [#uses=1]
  %mul44 = mul i32 %tmp43, 8                      ; <i32> [#uses=1]
  store i32 %mul44, i32* %idx
  %arraydecay45 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx46 = getelementptr inbounds float, float* %arraydecay45, i32 0 ; <float*> [#uses=1]
...
for.cond95:                                       ; preds = %for.inc102, %for.end42
  %tmp96 = load i32, i32* %ind94                       ; <i32> [#uses=1]
  %cmp97 = icmp slt i32 %tmp96, 8                 ; <i1> [#uses=1]
  br i1 %cmp97, label %for.body98, label %for.end105

for.body98:                                       ; preds = %for.cond95
  %tmp99 = load i32, i32* %ind94                       ; <i32> [#uses=1]
  %arraydecay100 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
...
for.cond111:                                      ; preds = %for.inc142, %for.end105
  %tmp112 = load i32, i32* %ind110                     ; <i32> [#uses=1]
...
for.cond115:                                      ; preds = %for.inc136, %for.body114
  %tmp116 = load i32, i32* %n2                         ; <i32> [#uses=1]
...
for.end145:                                       ; preds = %for.cond111
  ...
  %tmp158 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %add159 = add i32 %tmp158, 0                    ; <i32> [#uses=1]
  %tmp160 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx161 = getelementptr inbounds float, float addrspace(1)* %tmp160, i32 %add159 ; <float addrspace(1)*> [#uses=1]
  store float %tmp157, float addrspace(1)* %arrayidx161
  %arraydecay162 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  ...
  %tmp165 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %add166 = add i32 %tmp165, 1                    ; <i32> [#uses=1]
  %tmp167 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx168 = getelementptr inbounds float, float addrspace(1)* %tmp167, i32 %add166 ; <float addrspace(1)*> [#uses=1]
  store float %tmp164, float addrspace(1)* %arrayidx168
  %arraydecay169 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx170 = getelementptr inbounds float, float* %arraydecay169, i32 2 ; <float*> [#uses=1]
  %tmp171 = load float, float* %arrayidx170              ; <float> [#uses=1]
  %tmp172 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %add173 = add i32 %tmp172, 2                    ; <i32> [#uses=1]
  %tmp174 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  ...
  %arraydecay176 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx177 = getelementptr inbounds float, float* %arraydecay176, i32 3 ; <float*> [#uses=1]
  %tmp178 = load float, float* %arrayidx177              ; <float> [#uses=1]
  %tmp179 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %add180 = add i32 %tmp179, 3                    ; <i32> [#uses=1]
  %tmp181 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx182 = getelementptr inbounds float, float addrspace(1)* %tmp181, i32 %add180 ; <float addrspace(1)*> [#uses=1]
  store float %tmp178, float addrspace(1)* %arrayidx182
  %arraydecay183 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx184 = getelementptr inbounds float, float* %arraydecay183, i32 4 ; <float*> [#uses=1]
  %tmp185 = load float, float* %arrayidx184              ; <float> [#uses=1]
  %tmp186 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %add187 = add i32 %tmp186, 4                    ; <i32> [#uses=1]
  %tmp188 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx189 = getelementptr inbounds float, float addrspace(1)* %tmp188, i32 %add187 ; <float addrspace(1)*> [#uses=1]
  store float %tmp185, float addrspace(1)* %arrayidx189
  %arraydecay190 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx191 = getelementptr inbounds float, float* %arraydecay190, i32 5 ; <float*> [#uses=1]
  %tmp192 = load float, float* %arrayidx191              ; <float> [#uses=1]
  %tmp193 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %add194 = add i32 %tmp193, 5                    ; <i32> [#uses=1]
  %tmp195 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx196 = getelementptr inbounds float, float addrspace(1)* %tmp195, i32 %add194 ; <float addrspace(1)*> [#uses=1]
  store float %tmp192, float addrspace(1)* %arrayidx196
  %arraydecay197 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx198 = getelementptr inbounds float, float* %arraydecay197, i32 6 ; <float*> [#uses=1]
  %tmp199 = load float, float* %arrayidx198              ; <float> [#uses=1]
  %tmp200 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %add201 = add i32 %tmp200, 6                    ; <i32> [#uses=1]
  %tmp202 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx203 = getelementptr inbounds float, float addrspace(1)* %tmp202, i32 %add201 ; <float addrspace(1)*> [#uses=1]
  store float %tmp199, float addrspace(1)* %arrayidx203
  %arraydecay204 = getelementptr inbounds [8 x float], [8 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx205 = getelementptr inbounds float, float* %arraydecay204, i32 7 ; <float*> [#uses=1]
  %tmp206 = load float, float* %arrayidx205              ; <float> [#uses=1]
  %tmp207 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %add208 = add i32 %tmp207, 7                    ; <i32> [#uses=1]
  %tmp209 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx210 = getelementptr inbounds float, float addrspace(1)* %tmp209, i32 %add208 ; <float addrspace(1)*> [#uses=1]
...
entry:
  ...
  %arrayidx = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp14, i32 %tmp13 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx18 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp17, i32 %tmp16 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp46 = load i32, i32* %step                        ; <i32> [#uses=1]
  %tmp47 = load i32, i32* %index2                      ; <i32> [#uses=1]
  ...
  %arrayidx51 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp50, i32 %tmp49 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx55 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp54, i32 %tmp53 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp83 = load i32, i32* %step                        ; <i32> [#uses=1]
  ...
  %arrayidx88 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp87, i32 %tmp86 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx92 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp91, i32 %tmp90 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp120 = load i32, i32* %step                       ; <i32> [#uses=1]
  ...
  %arrayidx125 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp124, i32 %tmp123 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx129 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp128, i32 %tmp127 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp157 = load i32, i32* %step                       ; <i32> [#uses=1]
  %tmp158 = load i32, i32* %index2                     ; <i32> [#uses=1]
  ...
  %arrayidx162 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp161, i32 %tmp160 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx166 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp165, i32 %tmp164 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp194 = load i32, i32* %step                       ; <i32> [#uses=1]
  %tmp195 = load i32, i32* %index2                     ; <i32> [#uses=1]
  ...
  %arrayidx199 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp198, i32 %tmp197 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx203 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp202, i32 %tmp201 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp231 = load i32, i32* %step                       ; <i32> [#uses=1]
  %tmp232 = load i32, i32* %index2                     ; <i32> [#uses=1]
  ...
  %arrayidx236 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp235, i32 %tmp234 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx240 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp239, i32 %tmp238 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp268 = load i32, i32* %step                       ; <i32> [#uses=1]
  %tmp269 = load i32, i32* %index2                     ; <i32> [#uses=1]
  ...
  %arrayidx273 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp272, i32 %tmp271 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx277 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp276, i32 %tmp275 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp342 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @opencl_DCT_VECTOR_local_inter, i32 0, i32 1) ; <<8 x float>> [#uses=1]
  ...
  %tmp373 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @opencl_DCT_VECTOR_local_inter, i32 0, i32 2) ; <<8 x float>> [#uses=1]
  ...
  %tmp404 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @opencl_DCT_VECTOR_local_inter, i32 0, i32 3) ; <<8 x float>> [#uses=1]
  ...
  %tmp435 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @opencl_DCT_VECTOR_local_inter, i32 0, i32 4) ; <<8 x float>> [#uses=1]
  ...
  %tmp466 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @opencl_DCT_VECTOR_local_inter, i32 0, i32 5) ; <<8 x float>> [#uses=1]
  ...
  %tmp497 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @opencl_DCT_VECTOR_local_inter, i32 0, i32 6) ; <<8 x float>> [#uses=1]
  ...
  %tmp528 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @opencl_DCT_VECTOR_local_inter, i32 0, i32 7) ; <<8 x float>> [#uses=1]
  ...
  %tmp567 = load <8 x float>, <8 x float>* %acc                ; <<8 x float>> [#uses=1]
  %tmp568 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %tmp569 = load <8 x float> addrspace(1)*, <8 x float> addrspace(1)** %output.addr ; <<8 x float> addrspace(1)*> [#uses=1]
  %arrayidx570 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp569, i32 %tmp568 ; <<8 x float> addrspace(1)*> [#uses=1]
...
entry:
  ...
  %arrayidx19 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp18, i32 %tmp17 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call22 = call float @_Z3dotDv4_fS_(<4 x float> %tmp16, <4 x float> %tmp21) ; <float> [#uses=1]
  ...
  %arrayidx25 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp24, i32 %tmp23 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx30 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp29, i32 %tmp28 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call33 = call float @_Z3dotDv4_fS_(<4 x float> %tmp27, <4 x float> %tmp32) ; <float> [#uses=1]
  ...
  %tmp37 = load i32, i32* %step                        ; <i32> [#uses=1]
  %tmp38 = load i32, i32* %index2                      ; <i32> [#uses=1]
  ...
  %arrayidx42 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp41, i32 %tmp40 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx47 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp46, i32 %tmp45 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call50 = call float @_Z3dotDv4_fS_(<4 x float> %tmp44, <4 x float> %tmp49) ; <float> [#uses=1]
  ...
  %arrayidx53 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp52, i32 %tmp51 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx58 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp57, i32 %tmp56 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call61 = call float @_Z3dotDv4_fS_(<4 x float> %tmp55, <4 x float> %tmp60) ; <float> [#uses=1]
  ...
  %tmp65 = load i32, i32* %step                        ; <i32> [#uses=1]
  %tmp66 = load i32, i32* %index2                      ; <i32> [#uses=1]
  ...
  %arrayidx70 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp69, i32 %tmp68 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx75 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp74, i32 %tmp73 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call78 = call float @_Z3dotDv4_fS_(<4 x float> %tmp72, <4 x float> %tmp77) ; <float> [#uses=1]
  ...
  %arrayidx81 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp80, i32 %tmp79 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx86 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp85, i32 %tmp84 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call89 = call float @_Z3dotDv4_fS_(<4 x float> %tmp83, <4 x float> %tmp88) ; <float> [#uses=1]
  ...
  %tmp93 = load i32, i32* %step                        ; <i32> [#uses=1]
  %tmp94 = load i32, i32* %index2                      ; <i32> [#uses=1]
  ...
  %arrayidx98 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp97, i32 %tmp96 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx103 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp102, i32 %tmp101 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call106 = call float @_Z3dotDv4_fS_(<4 x float> %tmp100, <4 x float> %tmp105) ; <float> [#uses=1]
  ...
  %arrayidx109 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp108, i32 %tmp107 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx114 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp113, i32 %tmp112 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call117 = call float @_Z3dotDv4_fS_(<4 x float> %tmp111, <4 x float> %tmp116) ; <float> [#uses=1]
  ...
  %tmp122 = load i32, i32* %index2                     ; <i32> [#uses=1]
  ...
  %arrayidx126 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp125, i32 %tmp124 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx131 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp130, i32 %tmp129 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call134 = call float @_Z3dotDv4_fS_(<4 x float> %tmp128, <4 x float> %tmp133) ; <float> [#uses=1]
  ...
  %arrayidx137 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp136, i32 %tmp135 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx142 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp141, i32 %tmp140 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call145 = call float @_Z3dotDv4_fS_(<4 x float> %tmp139, <4 x float> %tmp144) ; <float> [#uses=1]
  ...
  %tmp149 = load i32, i32* %step                       ; <i32> [#uses=1]
  %tmp150 = load i32, i32* %index2                     ; <i32> [#uses=1]
  ...
  %arrayidx154 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp153, i32 %tmp152 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx159 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp158, i32 %tmp157 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call162 = call float @_Z3dotDv4_fS_(<4 x float> %tmp156, <4 x float> %tmp161) ; <float> [#uses=1]
  ...
  %arrayidx165 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp164, i32 %tmp163 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx170 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp169, i32 %tmp168 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call173 = call float @_Z3dotDv4_fS_(<4 x float> %tmp167, <4 x float> %tmp172) ; <float> [#uses=1]
  ...
  %tmp177 = load i32, i32* %step                       ; <i32> [#uses=1]
  %tmp178 = load i32, i32* %index2                     ; <i32> [#uses=1]
  ...
  %arrayidx182 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp181, i32 %tmp180 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx187 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp186, i32 %tmp185 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call190 = call float @_Z3dotDv4_fS_(<4 x float> %tmp184, <4 x float> %tmp189) ; <float> [#uses=1]
  ...
  %arrayidx193 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp192, i32 %tmp191 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx198 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp197, i32 %tmp196 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call201 = call float @_Z3dotDv4_fS_(<4 x float> %tmp195, <4 x float> %tmp200) ; <float> [#uses=1]
  ...
  %tmp205 = load i32, i32* %step                       ; <i32> [#uses=1]
  %tmp206 = load i32, i32* %index2                     ; <i32> [#uses=1]
  ...
  %arrayidx210 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp209, i32 %tmp208 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx215 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp214, i32 %tmp213 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call218 = call float @_Z3dotDv4_fS_(<4 x float> %tmp212, <4 x float> %tmp217) ; <float> [#uses=1]
  ...
  %arrayidx221 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp220, i32 %tmp219 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx226 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp225, i32 %tmp224 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call229 = call float @_Z3dotDv4_fS_(<4 x float> %tmp223, <4 x float> %tmp228) ; <float> [#uses=1]
  ...
  %arrayidx243 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp242, i32 %tmp241 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call246 = call float @_Z3dotDv4_fS_(<4 x float> %tmp240, <4 x float> %tmp245) ; <float> [#uses=1]
  ...
  %arrayidx251 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp250, i32 %tmp249 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call254 = call float @_Z3dotDv4_fS_(<4 x float> %tmp248, <4 x float> %tmp253) ; <float> [#uses=1]
  ...
  %arrayidx262 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp261, i32 %tmp260 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call265 = call float @_Z3dotDv4_fS_(<4 x float> %tmp259, <4 x float> %tmp264) ; <float> [#uses=1]
  ...
  %arrayidx270 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp269, i32 %tmp268 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call273 = call float @_Z3dotDv4_fS_(<4 x float> %tmp267, <4 x float> %tmp272) ; <float> [#uses=1]
  ...
  %arrayidx281 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp280, i32 %tmp279 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call284 = call float @_Z3dotDv4_fS_(<4 x float> %tmp278, <4 x float> %tmp283) ; <float> [#uses=1]
  ...
  %arrayidx289 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp288, i32 %tmp287 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call292 = call float @_Z3dotDv4_fS_(<4 x float> %tmp286, <4 x float> %tmp291) ; <float> [#uses=1]
  ...
  %arrayidx300 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp299, i32 %tmp298 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call303 = call float @_Z3dotDv4_fS_(<4 x float> %tmp297, <4 x float> %tmp302) ; <float> [#uses=1]
  ...
  %arrayidx308 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp307, i32 %tmp306 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call311 = call float @_Z3dotDv4_fS_(<4 x float> %tmp305, <4 x float> %tmp310) ; <float> [#uses=1]
  ...
  %arrayidx319 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp318, i32 %tmp317 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call322 = call float @_Z3dotDv4_fS_(<4 x float> %tmp316, <4 x float> %tmp321) ; <float> [#uses=1]
  ...
  %arrayidx327 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp326, i32 %tmp325 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call330 = call float @_Z3dotDv4_fS_(<4 x float> %tmp324, <4 x float> %tmp329) ; <float> [#uses=1]
  ...
  %arrayidx338 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp337, i32 %tmp336 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call341 = call float @_Z3dotDv4_fS_(<4 x float> %tmp335, <4 x float> %tmp340) ; <float> [#uses=1]
  ...
  %arrayidx346 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp345, i32 %tmp344 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call349 = call float @_Z3dotDv4_fS_(<4 x float> %tmp343, <4 x float> %tmp348) ; <float> [#uses=1]
  ...
  %arrayidx357 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp356, i32 %tmp355 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call360 = call float @_Z3dotDv4_fS_(<4 x float> %tmp354, <4 x float> %tmp359) ; <float> [#uses=1]
  ...
  %arrayidx365 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp364, i32 %tmp363 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call368 = call float @_Z3dotDv4_fS_(<4 x float> %tmp362, <4 x float> %tmp367) ; <float> [#uses=1]
  ...
  %call379 = call float @_Z3dotDv4_fS_(<4 x float> %tmp373, <4 x float> %tmp378) ; <float> [#uses=1]
  ...
  %arrayidx384 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp383, i32 %tmp382 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %call387 = call float @_Z3dotDv4_fS_(<4 x float> %tmp381, <4 x float> %tmp386) ; <float> [#uses=1]
  ...
  %tmp399 = load <8 x float>, <8 x float>* %acc                ; <<8 x float>> [#uses=1]
  %tmp400 = load i32, i32* %idx                        ; <i32> [#uses=1]
  %tmp401 = load <8 x float> addrspace(1)*, <8 x float> addrspace(1)** %output.addr ; <<8 x float> addrspace(1)*> [#uses=1]
  %arrayidx402 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp401, i32 %tmp400 ; <<8 x float> addrspace(1)*> [#uses=1]
...
entry:
  ...
  %tmp8 = load i32, i32* %groupIdy                     ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc52, %entry
  %tmp13 = load i32, i32* %n2                          ; <i32> [#uses=1]
...
for.cond14:                                       ; preds = %for.inc45, %for.body
  %tmp15 = load i32, i32* %k1                          ; <i32> [#uses=1]
...
for.cond18:                                       ; preds = %for.inc, %for.body17
  %tmp19 = load i32, i32* %n1                          ; <i32> [#uses=1]
  %cmp20 = icmp ult i32 %tmp19, 8                 ; <i1> [#uses=1]
  br i1 %cmp20, label %for.body21, label %for.end

for.body21:                                       ; preds = %for.cond18
  %tmp22 = load i32, i32* %dctIndex                    ; <i32> [#uses=1]
  %tmp23 = load i32, i32* %n1                          ; <i32> [#uses=1]
  %add24 = add i32 %tmp22, %tmp23                 ; <i32> [#uses=1]
  %tmp25 = load float addrspace(1)*, float addrspace(1)** %dct.addr    ; <float addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %tmp25, i32 %add24 ; <float addrspace(1)*> [#uses=1]
  %tmp26 = load float, float addrspace(1)* %arrayidx     ; <float> [#uses=1]
  %tmp27 = load i32, i32* %inputIndex                  ; <i32> [#uses=1]
  %tmp28 = load i32, i32* %n1                          ; <i32> [#uses=1]
  %add29 = add i32 %tmp27, %tmp28                 ; <i32> [#uses=1]
  %tmp30 = load float addrspace(1)*, float addrspace(1)** %input.addr  ; <float addrspace(1)*> [#uses=1]
  %arrayidx31 = getelementptr inbounds float, float addrspace(1)* %tmp30, i32 %add29 ; <float addrspace(1)*> [#uses=1]
  %tmp32 = load float, float addrspace(1)* %arrayidx31   ; <float> [#uses=1]
  %mul33 = fmul float %tmp26, %tmp32              ; <float> [#uses=1]
  %tmp34 = load i32, i32* %interIndex                  ; <i32> [#uses=1]
  %tmp35 = load i32, i32* %n2                          ; <i32> [#uses=1]
  %add36 = add i32 %tmp34, %tmp35                 ; <i32> [#uses=1]
  %arraydecay = getelementptr inbounds [64 x float], [64 x float]* %inter, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx37 = getelementptr inbounds float, float* %arraydecay, i32 %add36 ; <float*> [#uses=2]
  %tmp38 = load float, float* %arrayidx37                ; <float> [#uses=1]
  %add39 = fadd float %tmp38, %mul33              ; <float> [#uses=1]
  store float %add39, float* %arrayidx37
  br label %for.inc

for.inc:                                          ; preds = %for.body21
  %tmp40 = load i32, i32* %n1                          ; <i32> [#uses=1]
  %inc = add i32 %tmp40, 1                        ; <i32> [#uses=1]
  store i32 %inc, i32* %n1
  br label %for.cond18

for.end:                                          ; preds = %for.cond18
  %tmp41 = load i32, i32* %dctIndex                    ; <i32> [#uses=1]
  %add42 = add i32 %tmp41, 8                      ; <i32> [#uses=1]
  store i32 %add42, i32* %dctIndex
  %tmp43 = load i32, i32* %interIndex                  ; <i32> [#uses=1]
  %add44 = add i32 %tmp43, 8                      ; <i32> [#uses=1]
  store i32 %add44, i32* %interIndex
  br label %for.inc45

for.inc45:                                        ; preds = %for.end
  %tmp46 = load i32, i32* %k1                          ; <i32> [#uses=1]
  %inc47 = add i32 %tmp46, 1                      ; <i32> [#uses=1]
  store i32 %inc47, i32* %k1
  br label %for.cond14

for.end48:                                        ; preds = %for.cond14
  %tmp49 = load i32, i32* %step                        ; <i32> [#uses=1]
  %tmp50 = load i32, i32* %inputIndex                  ; <i32> [#uses=1]
  %add51 = add i32 %tmp50, %tmp49                 ; <i32> [#uses=1]
  store i32 %add51, i32* %inputIndex
  br label %for.inc52

for.inc52:                                        ; preds = %for.end48
  %tmp53 = load i32, i32* %n2                          ; <i32> [#uses=1]
...
for.cond63:                                       ; preds = %for.inc115, %for.end55
  %tmp64 = load i32, i32* %k2                          ; <i32> [#uses=1]
...
for.cond67:                                       ; preds = %for.inc106, %for.body66
  %tmp68 = load i32, i32* %k1                          ; <i32> [#uses=1]
  %cmp69 = icmp ult i32 %tmp68, 8                 ; <i1> [#uses=1]
  br i1 %cmp69, label %for.body70, label %for.end109

for.body70:                                       ; preds = %for.cond67
  %tmp71 = load i32, i32* %outputIndex                 ; <i32> [#uses=1]
  %tmp72 = load i32, i32* %k1                          ; <i32> [#uses=1]
  %add73 = add i32 %tmp71, %tmp72                 ; <i32> [#uses=1]
  %tmp74 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx75 = getelementptr inbounds float, float addrspace(1)* %tmp74, i32 %add73 ; <float addrspace(1)*> [#uses=1]
  store float 0.000000e+000, float addrspace(1)* %arrayidx75
  store i32 0, i32* %n2
  br label %for.cond76

for.cond76:                                       ; preds = %for.inc100, %for.body70
  %tmp77 = load i32, i32* %n2                          ; <i32> [#uses=1]
  %cmp78 = icmp ult i32 %tmp77, 8                 ; <i1> [#uses=1]
  br i1 %cmp78, label %for.body79, label %for.end103

for.body79:                                       ; preds = %for.cond76
  %tmp80 = load i32, i32* %dctIndex                    ; <i32> [#uses=1]
  %tmp81 = load i32, i32* %n2                          ; <i32> [#uses=1]
  %add82 = add i32 %tmp80, %tmp81                 ; <i32> [#uses=1]
  %tmp83 = load float addrspace(1)*, float addrspace(1)** %dct.addr    ; <float addrspace(1)*> [#uses=1]
  ...
  %tmp86 = load i32, i32* %interIndex                  ; <i32> [#uses=1]
  %tmp87 = load i32, i32* %n2                          ; <i32> [#uses=1]
  %add88 = add i32 %tmp86, %tmp87                 ; <i32> [#uses=1]
  %arraydecay89 = getelementptr inbounds [64 x float], [64 x float]* %inter, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx90 = getelementptr inbounds float, float* %arraydecay89, i32 %add88 ; <float*> [#uses=1]
  %tmp91 = load float, float* %arrayidx90                ; <float> [#uses=1]
  %mul92 = fmul float %tmp85, %tmp91              ; <float> [#uses=1]
  %tmp93 = load i32, i32* %outputIndex                 ; <i32> [#uses=1]
  %tmp94 = load i32, i32* %k1                          ; <i32> [#uses=1]
  %add95 = add i32 %tmp93, %tmp94                 ; <i32> [#uses=1]
  %tmp96 = load float addrspace(1)*, float addrspace(1)** %output.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx97 = getelementptr inbounds float, float addrspace(1)* %tmp96, i32 %add95 ; <float addrspace(1)*> [#uses=2]
...
for.inc100:                                       ; preds = %for.body79
  %tmp101 = load i32, i32* %n2                         ; <i32> [#uses=1]
...
for.body15:                                       ; preds = %for.cond12
  ...
  %arrayidx = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp17, i32 %tmp16 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx21 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp20, i32 %tmp19 ; <<8 x float> addrspace(1)*> [#uses=1]
  ...
  %tmp24 = load <8 x float>, <8 x float>* %temp                ; <<8 x float>> [#uses=1]
  ...
  %add43 = fadd float %add40, %tmp42              ; <float> [#uses=1]
  %tmp44 = load <8 x float>, <8 x float>* %temp                ; <<8 x float>> [#uses=1]
  %tmp45 = extractelement <8 x float> %tmp44, i32 7 ; <float> [#uses=1]
  %add46 = fadd float %add43, %tmp45              ; <float> [#uses=1]
  %tmp47 = load i32, i32* %interIndex                  ; <i32> [#uses=1]
  %tmp48 = load i32, i32* %n2                          ; <i32> [#uses=1]
  %add49 = add i32 %tmp47, %tmp48                 ; <i32> [#uses=1]
  %arraydecay = getelementptr inbounds [64 x float], [64 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx50 = getelementptr inbounds float, float* %arraydecay, i32 %add49 ; <float*> [#uses=1]
...
for.end:                                          ; preds = %for.cond12
  %tmp54 = load i32, i32* %step                        ; <i32> [#uses=1]
  %tmp55 = load i32, i32* %inputIndex                  ; <i32> [#uses=1]
...
for.body65:                                       ; preds = %for.cond62
  ...
  %arraydecay67 = getelementptr inbounds [64 x float], [64 x float]* %acc, i32 0, i32 0 ; <float*> [#uses=1]
  %arrayidx68 = getelementptr inbounds float, float* %arraydecay67, i32 0 ; <float*> [#uses=1]
  %call69 = call <8 x float> @_Z6vload8jPKf(i32 %tmp66, float* %arrayidx68) ; <<8 x float>> [#uses=1]
  %tmp70 = load i32, i32* %i                           ; <i32> [#uses=1]
  %arraydecay71 = getelementptr inbounds [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 0 ; <<8 x float>*> [#uses=1]
  %arrayidx72 = getelementptr inbounds <8 x float>, <8 x float>* %arraydecay71, i32 %tmp70 ; <<8 x float>*> [#uses=1]
...
for.body91:                                       ; preds = %for.cond88
  ...
  %arrayidx94 = getelementptr inbounds <8 x float>, <8 x float> addrspace(1)* %tmp93, i32 %tmp92 ; <<8 x float> addrspace(1)*> [#uses=1]
  %tmp95 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx94 ; <<8 x float>> [#uses=1]
  %tmp96 = load i32, i32* %k1                          ; <i32> [#uses=1]
  %arraydecay97 = getelementptr inbounds [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 0 ; <<8 x float>*> [#uses=1]
  %arrayidx98 = getelementptr inbounds <8 x float>, <8 x float>* %arraydecay97, i32 %tmp96 ; <<8 x float>*> [#uses=1]
  ...
  %tmp101 = load <8 x float>, <8 x float>* %temp               ; <<8 x float>> [#uses=1]
...
for.end132:                                       ; preds = %for.cond88
  %tmp133 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %tmp134 = load i32, i32* %outputIndex                ; <i32> [#uses=1]

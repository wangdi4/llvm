...
@opencl_metadata = appending global [2 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (%struct.anon addrspace(1)*, %0 addrspace(1)*, i32)* @wlMonteCarloKernel to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_wlMonteCarloKernel_locals to i8*), i8* getelementptr inbounds ([109 x i8], [109 x i8]* @opencl_wlMonteCarloKernel_parameters, i32 0, i32 0) }>, %opencl_metadata_type <{ i8* bitcast (void (%struct.anon addrspace(1)*, %0 addrspace(1)*, float addrspace(1)*, i32)* @wlMonteCarloKernel_PrecalculatedSamples to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_wlMonteCarloKernel_PrecalculatedSamples_locals to i8*), i8* getelementptr inbounds ([152 x i8], [152 x i8]* @opencl_wlMonteCarloKernel_PrecalculatedSamples_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[2 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %tmp = load i32, i32* %pathN.addr                    ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp26 = load float, float* %c1                        ; <float> [#uses=1]
  %tmp27 = load float, float* %z                         ; <float> [#uses=1]
  %tmp28 = load float, float* %c2                        ; <float> [#uses=1]
  %tmp29 = load float, float* %z                         ; <float> [#uses=1]
  %tmp30 = load float, float* %c3                        ; <float> [#uses=1]
  %tmp31 = load float, float* %z                         ; <float> [#uses=1]
  %tmp32 = load float, float* %c4                        ; <float> [#uses=1]
  %tmp33 = load float, float* %z                         ; <float> [#uses=1]
  %tmp34 = load float, float* %c5                        ; <float> [#uses=1]
  %tmp35 = load float, float* %z                         ; <float> [#uses=1]
  %tmp36 = load float, float* %c6                        ; <float> [#uses=1]
  %tmp37 = load float, float* %z                         ; <float> [#uses=1]
  %tmp38 = load float, float* %c7                        ; <float> [#uses=1]
  %tmp39 = load float, float* %z                         ; <float> [#uses=1]
  %tmp40 = load float, float* %c8                        ; <float> [#uses=1]
  %tmp41 = load float, float* %z                         ; <float> [#uses=1]
  %tmp42 = load float, float* %c9                        ; <float> [#uses=1]
  ...
  %tmp59 = load float, float* %z                         ; <float> [#uses=1]
...
for.inc:                                          ; preds = %for.body
  %tmp63 = load i32, i32* %pos                         ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp43 = load float, float* %b4                        ; <float> [#uses=1]
  %tmp44 = load float, float* %z                         ; <float> [#uses=1]
  %mul45 = fmul float %tmp43, %tmp44              ; <float> [#uses=1]
  %tmp46 = load float, float* %b3                        ; <float> [#uses=1]
  %add47 = fadd float %mul45, %tmp46              ; <float> [#uses=1]
  %tmp48 = load float, float* %z                         ; <float> [#uses=1]
  %mul49 = fmul float %add47, %tmp48              ; <float> [#uses=1]
  %tmp50 = load float, float* %b2                        ; <float> [#uses=1]
  %add51 = fadd float %mul49, %tmp50              ; <float> [#uses=1]
  %tmp52 = load float, float* %z                         ; <float> [#uses=1]
  %mul53 = fmul float %add51, %tmp52              ; <float> [#uses=1]
  %tmp54 = load float, float* %b1                        ; <float> [#uses=1]
  %add55 = fadd float %mul53, %tmp54              ; <float> [#uses=1]
  %tmp56 = load float, float* %z                         ; <float> [#uses=1]
...
for.inc:                                          ; preds = %for.body
  %tmp61 = load i32, i32* %pos                         ; <i32> [#uses=1]
...
entry:
  ...
  %tmp32 = load float, float* %V                         ; <float> [#uses=1]
  ...
  %tmp35 = load float, float* %T                         ; <float> [#uses=1]
  ...
  %tmp40 = load float, float* %V                         ; <float> [#uses=1]
  %tmp41 = load float, float* %T                         ; <float> [#uses=1]
  ...
  %tmp47 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
  ...
  %tmp53 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  %tmp61 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp62 = load i32, i32* %boundary12                  ; <i32> [#uses=1]
...
for.body75:                                       ; preds = %for.cond71
  ...
  %tmp88 = load i32, i32* %i                           ; <i32> [#uses=1]
...
for.cond92:                                       ; preds = %for.body96, %for.end
  %tmp93 = load i32, i32* %i91                         ; <i32> [#uses=1]
...
for.body96:                                       ; preds = %for.cond92
  ...
  %tmp106 = load float, float* %callValue                ; <float> [#uses=1]
  %call107 = call float @_Z3maxff(float %tmp106, float 0.000000e+000) ; <float> [#uses=1]
  store float %call107, float* %callValue
  %tmp108 = load float, float* %callValue                ; <float> [#uses=1]
  %tmp109 = load float, float* %sum                      ; <float> [#uses=1]
  %add110 = fadd float %tmp109, %tmp108           ; <float> [#uses=1]
  store float %add110, float* %sum
  %tmp111 = load float, float* %callValue                ; <float> [#uses=1]
  %tmp112 = load float, float* %callValue                ; <float> [#uses=1]
  %mul113 = fmul float %tmp111, %tmp112           ; <float> [#uses=1]
  %tmp114 = load float, float* %sum2                     ; <float> [#uses=1]
  %add115 = fadd float %tmp114, %mul113           ; <float> [#uses=1]
  store float %add115, float* %sum2
  %tmp116 = load i32, i32* %i91                        ; <i32> [#uses=1]
...
for.cond137:                                      ; preds = %for.inc155, %if.then
  %tmp138 = load i32, i32* %i136                       ; <i32> [#uses=1]
  %tmp139 = load i32, i32* %n                          ; <i32> [#uses=1]
...
for.inc155:                                       ; preds = %for.body142
  %tmp156 = load i32, i32* %i136                       ; <i32> [#uses=1]
...
for.cond161:                                      ; preds = %for.inc187, %for.end158
  %tmp162 = load i32, i32* %i160                       ; <i32> [#uses=1]
  %tmp163 = load i32, i32* %n                          ; <i32> [#uses=1]
...
for.body202:                                      ; preds = %for.cond195
  %tmp204 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
...
for.body223:                                      ; preds = %for.cond219
  ...
  %tmp275 = load float, float* %sample240                ; <float> [#uses=1]
  %tmp276 = load float, float* %VBySqrtT                 ; <float> [#uses=1]
  ...
  %tmp284 = load i32, i32* %i218                       ; <i32> [#uses=1]
...
for.cond289:                                      ; preds = %for.body293, %for.end286
  %tmp290 = load i32, i32* %i288                       ; <i32> [#uses=1]
...
for.body293:                                      ; preds = %for.cond289
  ...
  %tmp304 = load float, float* %callValue295             ; <float> [#uses=1]
  %call305 = call float @_Z3maxff(float %tmp304, float 0.000000e+000) ; <float> [#uses=1]
  store float %call305, float* %callValue295
  %tmp306 = load float, float* %callValue295             ; <float> [#uses=1]
  %tmp307 = load float, float* %sum                      ; <float> [#uses=1]
  %add308 = fadd float %tmp307, %tmp306           ; <float> [#uses=1]
  store float %add308, float* %sum
  %tmp309 = load float, float* %callValue295             ; <float> [#uses=1]
  %tmp310 = load float, float* %callValue295             ; <float> [#uses=1]
  %mul311 = fmul float %tmp309, %tmp310           ; <float> [#uses=1]
  %tmp312 = load float, float* %sum2                     ; <float> [#uses=1]
  %add313 = fadd float %tmp312, %mul311           ; <float> [#uses=1]
  store float %add313, float* %sum2
  %tmp314 = load i32, i32* %i288                       ; <i32> [#uses=1]
...
for.cond337:                                      ; preds = %for.inc355, %if.then327
  %tmp338 = load i32, i32* %i336                       ; <i32> [#uses=1]
  %tmp339 = load i32, i32* %n                          ; <i32> [#uses=1]
...
for.inc355:                                       ; preds = %for.body342
  %tmp356 = load i32, i32* %i336                       ; <i32> [#uses=1]
...
for.cond361:                                      ; preds = %for.inc387, %for.end358
  %tmp362 = load i32, i32* %i360                       ; <i32> [#uses=1]
  %tmp363 = load i32, i32* %n                          ; <i32> [#uses=1]
...
for.cond412:                                      ; preds = %for.body416, %for.body403
  %tmp413 = load i32, i32* %i411                       ; <i32> [#uses=1]
...
for.body416:                                      ; preds = %for.cond412
  ...
  %tmp429 = load i32, i32* %i411                       ; <i32> [#uses=1]
...
for.cond434:                                      ; preds = %for.body438, %for.end431
  %tmp435 = load i32, i32* %i433                       ; <i32> [#uses=1]
...
for.body438:                                      ; preds = %for.cond434
  ...
  %tmp449 = load float, float* %callValue440             ; <float> [#uses=1]
  %call450 = call float @_Z3maxff(float %tmp449, float 0.000000e+000) ; <float> [#uses=1]
  store float %call450, float* %callValue440
  %tmp451 = load float, float* %callValue440             ; <float> [#uses=1]
  %tmp452 = load float, float* %sum                      ; <float> [#uses=1]
  %add453 = fadd float %tmp452, %tmp451           ; <float> [#uses=1]
  store float %add453, float* %sum
  %tmp454 = load float, float* %callValue440             ; <float> [#uses=1]
  %tmp455 = load float, float* %callValue440             ; <float> [#uses=1]
  %mul456 = fmul float %tmp454, %tmp455           ; <float> [#uses=1]
  %tmp457 = load float, float* %sum2                     ; <float> [#uses=1]
  %add458 = fadd float %tmp457, %mul456           ; <float> [#uses=1]
  store float %add458, float* %sum2
  %tmp459 = load i32, i32* %i433                       ; <i32> [#uses=1]
...
for.cond482:                                      ; preds = %for.inc500, %if.then472
  %tmp483 = load i32, i32* %i481                       ; <i32> [#uses=1]
  %tmp484 = load i32, i32* %n                          ; <i32> [#uses=1]
...
for.inc500:                                       ; preds = %for.body487
  %tmp501 = load i32, i32* %i481                       ; <i32> [#uses=1]
...
for.cond506:                                      ; preds = %for.inc532, %for.end503
  %tmp507 = load i32, i32* %i505                       ; <i32> [#uses=1]
  %tmp508 = load i32, i32* %n                          ; <i32> [#uses=1]
...
if.end539:                                        ; preds = %for.end535, %for.end465
  ...
  %tmp549 = load float, float* %ExpRT                    ; <float> [#uses=1]
  %tmp550 = load float, float* %totalsum                 ; <float> [#uses=1]
  %mul551 = fmul float %tmp549, %tmp550           ; <float> [#uses=1]
  %tmp552 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  ...
  %tmp562 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %conv563 = sitofp i32 %tmp562 to float          ; <float> [#uses=1]
  %tmp564 = load float, float* %totalsum2                ; <float> [#uses=1]
  %mul565 = fmul float %conv563, %tmp564          ; <float> [#uses=1]
  %tmp566 = load float, float* %totalsum                 ; <float> [#uses=1]
  %tmp567 = load float, float* %totalsum                 ; <float> [#uses=1]
  %mul568 = fmul float %tmp566, %tmp567           ; <float> [#uses=1]
  %sub569 = fsub float %mul565, %mul568           ; <float> [#uses=1]
  %tmp570 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
  %conv571 = sitofp i32 %tmp570 to float          ; <float> [#uses=1]
  %tmp572 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]
...
entry:
  ...
  %tmp31 = load float, float* %V                         ; <float> [#uses=1]
  %mul32 = fmul float %mul, %tmp31                ; <float> [#uses=1]
  %sub = fsub float %tmp29, %mul32                ; <float> [#uses=1]
  %tmp33 = load float, float* %T                         ; <float> [#uses=1]
  %mul34 = fmul float %sub, %tmp33                ; <float> [#uses=1]
  store float %mul34, float* %MuByT
  %tmp36 = load float, float* %V                         ; <float> [#uses=1]
  %tmp37 = load float, float* %T                         ; <float> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  %tmp43 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp44 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
...
for.end:                                          ; preds = %for.cond
  ...
  %tmp90 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
  %conv91 = sitofp i32 %tmp90 to float            ; <float> [#uses=1]
  %tmp92 = load float, float* %totalsum2                 ; <float> [#uses=1]
  %mul93 = fmul float %conv91, %tmp92             ; <float> [#uses=1]
  %tmp94 = load float, float* %totalsum                  ; <float> [#uses=1]
  %tmp95 = load float, float* %totalsum                  ; <float> [#uses=1]
  %mul96 = fmul float %tmp94, %tmp95              ; <float> [#uses=1]
  %sub97 = fsub float %mul93, %mul96              ; <float> [#uses=1]
  %tmp98 = load i32, i32* %pathN.addr                  ; <i32> [#uses=1]
  %conv99 = sitofp i32 %tmp98 to float            ; <float> [#uses=1]
  %tmp100 = load i32, i32* %pathN.addr                 ; <i32> [#uses=1]

...
@opencl_metadata = appending global [1 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (float addrspace(1)*, float addrspace(1)*, float addrspace(1)*, float addrspace(3)*, i32, i32, i32)* @dwtHaar1D to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_dwtHaar1D_locals to i8*), i8* getelementptr inbounds ([189 x i8], [189 x i8]* @opencl_dwtHaar1D_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[1 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %tmp = load i32, i32* %groupId                       ; <i32> [#uses=1]
  %tmp4 = load i32, i32* %localSize                    ; <i32> [#uses=1]
  ...
  %tmp8 = load float addrspace(1)*, float addrspace(1)** %inSignal.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %tmp8, i32 %add ; <float addrspace(1)*> [#uses=1]
  %tmp9 = load float, float addrspace(1)* %arrayidx      ; <float> [#uses=1]
  %tmp10 = load i32, i32* %localId                     ; <i32> [#uses=1]
  %mul11 = mul i32 %tmp10, 2                      ; <i32> [#uses=1]
  %tmp12 = load float addrspace(3)*, float addrspace(3)** %sharedArray.addr ; <float addrspace(3)*> [#uses=1]
  %arrayidx13 = getelementptr inbounds float, float addrspace(3)* %tmp12, i32 %mul11 ; <float addrspace(3)*> [#uses=1]
  store float %tmp9, float addrspace(3)* %arrayidx13
  %tmp14 = load i32, i32* %groupId                     ; <i32> [#uses=1]
  %tmp15 = load i32, i32* %localSize                   ; <i32> [#uses=1]
  %mul16 = mul i32 %tmp14, %tmp15                 ; <i32> [#uses=1]
  %mul17 = mul i32 %mul16, 2                      ; <i32> [#uses=1]
  %tmp18 = load i32, i32* %localId                     ; <i32> [#uses=1]
  %mul19 = mul i32 %tmp18, 2                      ; <i32> [#uses=1]
  %add20 = add i32 %mul17, %mul19                 ; <i32> [#uses=1]
  %add21 = add i32 %add20, 1                      ; <i32> [#uses=1]
  %tmp22 = load float addrspace(1)*, float addrspace(1)** %inSignal.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx23 = getelementptr inbounds float, float addrspace(1)* %tmp22, i32 %add21 ; <float addrspace(1)*> [#uses=1]
  %tmp24 = load float, float addrspace(1)* %arrayidx23   ; <float> [#uses=1]
  %tmp25 = load i32, i32* %localId                     ; <i32> [#uses=1]
  %mul26 = mul i32 %tmp25, 2                      ; <i32> [#uses=1]
  %add27 = add i32 %mul26, 1                      ; <i32> [#uses=1]
  %tmp28 = load float addrspace(3)*, float addrspace(3)** %sharedArray.addr ; <float addrspace(3)*> [#uses=1]
  %arrayidx29 = getelementptr inbounds float, float addrspace(3)* %tmp28, i32 %add27 ; <float addrspace(3)*> [#uses=1]
  store float %tmp24, float addrspace(3)* %arrayidx29
  %tmp30 = load i32, i32* %levelsDone.addr             ; <i32> [#uses=1]
  %cmp = icmp eq i32 0, %tmp30                    ; <i1> [#uses=1]
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %tmp31 = load i32, i32* %signalLength.addr           ; <i32> [#uses=1]
  %conv = uitofp i32 %tmp31 to float              ; <float> [#uses=1]
  %call32 = call float @_Z4sqrtf(float %conv)     ; <float> [#uses=3]
  %tmp33 = load i32, i32* %localId                     ; <i32> [#uses=1]
  %mul34 = mul i32 %tmp33, 2                      ; <i32> [#uses=1]
  %tmp35 = load float addrspace(3)*, float addrspace(3)** %sharedArray.addr ; <float addrspace(3)*> [#uses=1]
  %arrayidx36 = getelementptr inbounds float, float addrspace(3)* %tmp35, i32 %mul34 ; <float addrspace(3)*> [#uses=2]
  %tmp37 = load float, float addrspace(3)* %arrayidx36   ; <float> [#uses=1]
  ...
  %tmp39 = load i32, i32* %signalLength.addr           ; <i32> [#uses=1]
  %conv40 = uitofp i32 %tmp39 to float            ; <float> [#uses=1]
  %call41 = call float @_Z4sqrtf(float %conv40)   ; <float> [#uses=3]
  %tmp42 = load i32, i32* %localId                     ; <i32> [#uses=1]
  %mul43 = mul i32 %tmp42, 2                      ; <i32> [#uses=1]
  %add44 = add i32 %mul43, 1                      ; <i32> [#uses=1]
  %tmp45 = load float addrspace(3)*, float addrspace(3)** %sharedArray.addr ; <float addrspace(3)*> [#uses=1]
  %arrayidx46 = getelementptr inbounds float, float addrspace(3)* %tmp45, i32 %add44 ; <float addrspace(3)*> [#uses=2]
  %tmp47 = load float, float addrspace(3)* %arrayidx46   ; <float> [#uses=1]
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %tmp53 = load i32, i32* %tLevels.addr                ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %cond.end
  ...
  %tmp65 = load i32, i32* %levels                      ; <i32> [#uses=1]
  %cmp66 = icmp ult i32 %tmp64, %tmp65            ; <i1> [#uses=1]
  br i1 %cmp66, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp68 = load i32, i32* %localId                     ; <i32> [#uses=1]
  %tmp69 = load i32, i32* %activeThreads               ; <i32> [#uses=1]
  %cmp70 = icmp ult i32 %tmp68, %tmp69            ; <i1> [#uses=1]
  br i1 %cmp70, label %if.then72, label %if.end114

if.then72:                                        ; preds = %for.body
  %tmp74 = load i32, i32* %localId                     ; <i32> [#uses=1]
  %mul75 = mul i32 2, %tmp74                      ; <i32> [#uses=1]
  %tmp76 = load float addrspace(3)*, float addrspace(3)** %sharedArray.addr ; <float addrspace(3)*> [#uses=1]
  %arrayidx77 = getelementptr inbounds float, float addrspace(3)* %tmp76, i32 %mul75 ; <float addrspace(3)*> [#uses=1]
  ...
  %tmp83 = load float addrspace(3)*, float addrspace(3)** %sharedArray.addr ; <float addrspace(3)*> [#uses=1]
  %arrayidx84 = getelementptr inbounds float, float addrspace(3)* %tmp83, i32 %add82 ; <float addrspace(3)*> [#uses=1]
  %tmp85 = load float, float addrspace(3)* %arrayidx84   ; <float> [#uses=1]
  store float %tmp85, float* %data1
  %tmp86 = load float, float* %data0                     ; <float> [#uses=1]
  %tmp87 = load float, float* %data1                     ; <float> [#uses=1]
  ...
  %tmp93 = load i32, i32* %localId                     ; <i32> [#uses=1]
  %tmp94 = load float addrspace(3)*, float addrspace(3)** %sharedArray.addr ; <float addrspace(3)*> [#uses=1]
  %arrayidx95 = getelementptr inbounds float, float addrspace(3)* %tmp94, i32 %tmp93 ; <float addrspace(3)*> [#uses=1]
  store float %div92, float addrspace(3)* %arrayidx95
  %tmp97 = load i32, i32* %midOutPos                   ; <i32> [#uses=1]
  %tmp98 = load i32, i32* %groupId                     ; <i32> [#uses=1]
  %tmp99 = load i32, i32* %activeThreads               ; <i32> [#uses=1]
  %mul100 = mul i32 %tmp98, %tmp99                ; <i32> [#uses=1]
  %add101 = add i32 %tmp97, %mul100               ; <i32> [#uses=1]
  %tmp102 = load i32, i32* %localId                    ; <i32> [#uses=1]
  %add103 = add i32 %add101, %tmp102              ; <i32> [#uses=1]
  store i32 %add103, i32* %globalPos
  %tmp104 = load float, float* %data0                    ; <float> [#uses=1]
  %tmp105 = load float, float* %data1                    ; <float> [#uses=1]
  ...
  %tmp110 = load i32, i32* %globalPos                  ; <i32> [#uses=1]
  %tmp111 = load float addrspace(1)*, float addrspace(1)** %coefsSignal.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx112 = getelementptr inbounds float, float addrspace(1)* %tmp111, i32 %tmp110 ; <float addrspace(1)*> [#uses=1]
  store float %div109, float addrspace(1)* %arrayidx112
  %tmp113 = load i32, i32* %midOutPos                  ; <i32> [#uses=1]
  %shr = lshr i32 %tmp113, 1                      ; <i32> [#uses=1]
  store i32 %shr, i32* %midOutPos
  br label %if.end114

if.end114:                                        ; preds = %if.then72, %for.body
  %tmp115 = load i32, i32* %activeThreads              ; <i32> [#uses=1]
...
for.end:                                          ; preds = %for.cond
  %tmp118 = load i32, i32* %localId                    ; <i32> [#uses=1]
  %cmp119 = icmp eq i32 0, %tmp118                ; <i1> [#uses=1]
  br i1 %cmp119, label %if.then121, label %if.end128

if.then121:                                       ; preds = %for.end
  %tmp122 = load float addrspace(3)*, float addrspace(3)** %sharedArray.addr ; <float addrspace(3)*> [#uses=1]
  %arrayidx123 = getelementptr inbounds float, float addrspace(3)* %tmp122, i32 0 ; <float addrspace(3)*> [#uses=1]
  %tmp124 = load float, float addrspace(3)* %arrayidx123 ; <float> [#uses=1]
  %tmp125 = load i32, i32* %groupId                    ; <i32> [#uses=1]
  %tmp126 = load float addrspace(1)*, float addrspace(1)** %AverageSignal.addr ; <float addrspace(1)*> [#uses=1]
  %arrayidx127 = getelementptr inbounds float, float addrspace(1)* %tmp126, i32 %tmp125 ; <float addrspace(1)*> [#uses=1]

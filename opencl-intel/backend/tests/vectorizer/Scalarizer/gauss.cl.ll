...
for.body:                                         ; preds = %for.cond
  ...
  %call19 = call <4 x float> @_Z11read_imagefP10_image2d_tjDv2_f(%struct._image2d_t* %tmp17, i32 1, <2 x float> %tmp18) ; <<4 x float>> [#uses=1]
...
entry:
  ...
  %call5 = call <2 x i32> @_Z13convert_uint2Dv2_i(<2 x i32> %call4) ; <<2 x i32>> [#uses=1]
...
declare <2 x i32> @_Z13convert_uint2Dv2_i(<2 x i32>)

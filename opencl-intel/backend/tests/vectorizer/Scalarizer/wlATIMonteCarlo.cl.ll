...
; RUN: %oclopt  -runtimelib %p/../Full/runtime.bc -O3 -loopopt -inline-threshold=4096 -inline -lowerswitch -scalarize -mergereturn -loop-simplify -phicanon -predicate -mem2reg -dce -packetize -packet-size=4 -resolve -scalarize -verify %t.bc -S -o %t1.ll
...
@opencl_metadata = appending global [1 x %opencl_metadata_type] [%opencl_metadata_type <{ i8* bitcast (void (<4 x float> addrspace(1)*, i32, i32, <4 x i32> addrspace(1)*, <4 x float> addrspace(1)*, <4 x float> addrspace(1)*)* @calPriceVega to i8*), i8* null, [4 x i32] zeroinitializer, [4 x i32] zeroinitializer, i8* bitcast ([1 x i8*]* @opencl_calPriceVega_locals to i8*), i8* getelementptr inbounds ([184 x i8], [184 x i8]* @opencl_calPriceVega_parameters, i32 0, i32 0) }>], section "llvm.metadata" ; <[1 x %opencl_metadata_type]*> [#uses=0]
...
entry:
  ...
  %tmp33 = load i32, i32* %invshift                    ; <i32> [#uses=1]
  %shr34 = lshr i32 %tmp32, %tmp33                ; <i32> [#uses=1]
  %or35 = or i32 %shl30, %shr34                   ; <i32> [#uses=1]
  %tmp36 = load <4 x i32>, <4 x i32>* %temp                  ; <<4 x i32>> [#uses=1]
  %tmp37 = insertelement <4 x i32> %tmp36, i32 %or35, i32 3 ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp37, <4 x i32>* %temp
  %tmp38 = load <4 x i32>, <4 x i32>* %temp                  ; <<4 x i32>> [#uses=1]
  %tmp39 = load <4 x i32>*, <4 x i32>** %output.addr          ; <<4 x i32>*> [#uses=1]
...
entry:
  ...
  %tmp80 = load <4 x i32>, <4 x i32>* %mask4                 ; <<4 x i32>> [#uses=1]
  %tmp81 = load <4 x i32>, <4 x i32>* %state1                ; <<4 x i32>> [#uses=1]
  %tmp82 = load <4 x i32>, <4 x i32>* %state1                ; <<4 x i32>> [#uses=1]
  %tmp83 = load <4 x i32>, <4 x i32>* %thirty4               ; <<4 x i32>> [#uses=1]
  ...
  %tmp84 = load <4 x i32>, <4 x i32>* %one4                  ; <<4 x i32>> [#uses=1]
  %add = add <4 x i32> %mul, %tmp84               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %add, <4 x i32>* %state2
  %tmp85 = load <4 x i32>, <4 x i32>* %mask4                 ; <<4 x i32>> [#uses=1]
  %tmp86 = load <4 x i32>, <4 x i32>* %state2                ; <<4 x i32>> [#uses=1]
  %tmp87 = load <4 x i32>, <4 x i32>* %state2                ; <<4 x i32>> [#uses=1]
  %tmp88 = load <4 x i32>, <4 x i32>* %thirty4               ; <<4 x i32>> [#uses=1]
  ...
  %tmp92 = load <4 x i32>, <4 x i32>* %two4                  ; <<4 x i32>> [#uses=1]
  %add93 = add <4 x i32> %mul91, %tmp92           ; <<4 x i32>> [#uses=1]
  store <4 x i32> %add93, <4 x i32>* %state3
  %tmp94 = load <4 x i32>, <4 x i32>* %mask4                 ; <<4 x i32>> [#uses=1]
  %tmp95 = load <4 x i32>, <4 x i32>* %state3                ; <<4 x i32>> [#uses=1]
  %tmp96 = load <4 x i32>, <4 x i32>* %state3                ; <<4 x i32>> [#uses=1]
  %tmp97 = load <4 x i32>, <4 x i32>* %thirty4               ; <<4 x i32>> [#uses=1]
  ...
  %tmp101 = load <4 x i32>, <4 x i32>* %three4               ; <<4 x i32>> [#uses=1]
  %add102 = add <4 x i32> %mul100, %tmp101        ; <<4 x i32>> [#uses=1]
  store <4 x i32> %add102, <4 x i32>* %state4
  %tmp103 = load <4 x i32>, <4 x i32>* %mask4                ; <<4 x i32>> [#uses=1]
  %tmp104 = load <4 x i32>, <4 x i32>* %state4               ; <<4 x i32>> [#uses=1]
  %tmp105 = load <4 x i32>, <4 x i32>* %state4               ; <<4 x i32>> [#uses=1]
  %tmp106 = load <4 x i32>, <4 x i32>* %thirty4              ; <<4 x i32>> [#uses=1]
  ...
  %tmp110 = load <4 x i32>, <4 x i32>* %four4                ; <<4 x i32>> [#uses=1]
...
for.cond:                                         ; preds = %for.inc, %entry
  %tmp113 = load i32, i32* %i                          ; <i32> [#uses=1]
  %tmp114 = load i32, i32* %mulFactor                  ; <i32> [#uses=1]
  %cmp = icmp ult i32 %tmp113, %tmp114            ; <i1> [#uses=1]
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %tmp115 = load i32, i32* %i                          ; <i32> [#uses=1]
...
sw.bb:                                            ; preds = %for.body
  %tmp116 = load <4 x i32>, <4 x i32>* %state4               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp116, <4 x i32>* %r1
  %tmp117 = load <4 x i32>, <4 x i32>* %state5               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp117, <4 x i32>* %r2
  %tmp118 = load <4 x i32>, <4 x i32>* %state1               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp118, <4 x i32>* %a
  %tmp119 = load <4 x i32>, <4 x i32>* %state3               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp119, <4 x i32>* %b
  br label %sw.epilog

sw.bb120:                                         ; preds = %for.body
  %tmp121 = load <4 x i32>, <4 x i32>* %r2                   ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp121, <4 x i32>* %r1
  %arraydecay = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay, i32 0 ; <<4 x i32>*> [#uses=1]
  %tmp122 = load <4 x i32>, <4 x i32>* %arrayidx             ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp122, <4 x i32>* %r2
  %tmp123 = load <4 x i32>, <4 x i32>* %state2               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp123, <4 x i32>* %a
  %tmp124 = load <4 x i32>, <4 x i32>* %state4               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp124, <4 x i32>* %b
  br label %sw.epilog

sw.bb125:                                         ; preds = %for.body
  %tmp126 = load <4 x i32>, <4 x i32>* %r2                   ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp126, <4 x i32>* %r1
  %arraydecay127 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx128 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay127, i32 1 ; <<4 x i32>*> [#uses=1]
  %tmp129 = load <4 x i32>, <4 x i32>* %arrayidx128          ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp129, <4 x i32>* %r2
  %tmp130 = load <4 x i32>, <4 x i32>* %state3               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp130, <4 x i32>* %a
  %tmp131 = load <4 x i32>, <4 x i32>* %state5               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp131, <4 x i32>* %b
  br label %sw.epilog

sw.bb132:                                         ; preds = %for.body
  %tmp133 = load <4 x i32>, <4 x i32>* %r2                   ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp133, <4 x i32>* %r1
  %arraydecay134 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx135 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay134, i32 2 ; <<4 x i32>*> [#uses=1]
  %tmp136 = load <4 x i32>, <4 x i32>* %arrayidx135          ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp136, <4 x i32>* %r2
  %tmp137 = load <4 x i32>, <4 x i32>* %state4               ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp137, <4 x i32>* %a
  %tmp138 = load <4 x i32>, <4 x i32>* %state1               ; <<4 x i32>> [#uses=1]
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb132, %sw.bb125, %sw.bb120, %sw.bb
  %tmp139 = load <4 x i32>, <4 x i32>* %a                    ; <<4 x i32>> [#uses=1]
  %tmp140 = load i32, i32* %shift                      ; <i32> [#uses=1]
  call void @lshift128(<4 x i32> %tmp139, i32 %tmp140, <4 x i32>* %e)
  %tmp141 = load <4 x i32>, <4 x i32>* %r1                   ; <<4 x i32>> [#uses=1]
  %tmp142 = load i32, i32* %shift                      ; <i32> [#uses=1]
  call void @rshift128(<4 x i32> %tmp141, i32 %tmp142, <4 x i32>* %f)
  %tmp143 = load <4 x i32>, <4 x i32>* %a                    ; <<4 x i32>> [#uses=1]
  %tmp144 = extractelement <4 x i32> %tmp143, i32 0 ; <i32> [#uses=1]
  %tmp145 = load <4 x i32>, <4 x i32>* %e                    ; <<4 x i32>> [#uses=1]
  %tmp146 = extractelement <4 x i32> %tmp145, i32 0 ; <i32> [#uses=1]
  %xor147 = xor i32 %tmp144, %tmp146              ; <i32> [#uses=1]
  %tmp148 = load <4 x i32>, <4 x i32>* %b                    ; <<4 x i32>> [#uses=1]
  %tmp149 = extractelement <4 x i32> %tmp148, i32 0 ; <i32> [#uses=1]
  %tmp150 = load i32, i32* %thirteen                   ; <i32> [#uses=1]
  %shr151 = lshr i32 %tmp149, %tmp150             ; <i32> [#uses=1]
  %tmp152 = load i32, i32* %mask11                     ; <i32> [#uses=1]
  %and = and i32 %shr151, %tmp152                 ; <i32> [#uses=1]
  %xor153 = xor i32 %xor147, %and                 ; <i32> [#uses=1]
  %tmp154 = load <4 x i32>, <4 x i32>* %f                    ; <<4 x i32>> [#uses=1]
  %tmp155 = extractelement <4 x i32> %tmp154, i32 0 ; <i32> [#uses=1]
  %xor156 = xor i32 %xor153, %tmp155              ; <i32> [#uses=1]
  %tmp157 = load <4 x i32>, <4 x i32>* %r2                   ; <<4 x i32>> [#uses=1]
  %tmp158 = extractelement <4 x i32> %tmp157, i32 0 ; <i32> [#uses=1]
  %tmp159 = load i32, i32* %fifteen                    ; <i32> [#uses=1]
  %shl = shl i32 %tmp158, %tmp159                 ; <i32> [#uses=1]
  %xor160 = xor i32 %xor156, %shl                 ; <i32> [#uses=1]
  %tmp161 = load i32, i32* %i                          ; <i32> [#uses=1]
  %arraydecay162 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx163 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay162, i32 %tmp161 ; <<4 x i32>*> [#uses=2]
  %tmp164 = load <4 x i32>, <4 x i32>* %arrayidx163          ; <<4 x i32>> [#uses=1]
  %tmp165 = insertelement <4 x i32> %tmp164, i32 %xor160, i32 0 ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp165, <4 x i32>* %arrayidx163
  %tmp166 = load <4 x i32>, <4 x i32>* %a                    ; <<4 x i32>> [#uses=1]
  %tmp167 = extractelement <4 x i32> %tmp166, i32 1 ; <i32> [#uses=1]
  %tmp168 = load <4 x i32>, <4 x i32>* %e                    ; <<4 x i32>> [#uses=1]
  %tmp169 = extractelement <4 x i32> %tmp168, i32 1 ; <i32> [#uses=1]
  %xor170 = xor i32 %tmp167, %tmp169              ; <i32> [#uses=1]
  %tmp171 = load <4 x i32>, <4 x i32>* %b                    ; <<4 x i32>> [#uses=1]
  %tmp172 = extractelement <4 x i32> %tmp171, i32 1 ; <i32> [#uses=1]
  %tmp173 = load i32, i32* %thirteen                   ; <i32> [#uses=1]
  %shr174 = lshr i32 %tmp172, %tmp173             ; <i32> [#uses=1]
  %tmp175 = load i32, i32* %mask12                     ; <i32> [#uses=1]
  %and176 = and i32 %shr174, %tmp175              ; <i32> [#uses=1]
  %xor177 = xor i32 %xor170, %and176              ; <i32> [#uses=1]
  %tmp178 = load <4 x i32>, <4 x i32>* %f                    ; <<4 x i32>> [#uses=1]
  %tmp179 = extractelement <4 x i32> %tmp178, i32 1 ; <i32> [#uses=1]
  %xor180 = xor i32 %xor177, %tmp179              ; <i32> [#uses=1]
  %tmp181 = load <4 x i32>, <4 x i32>* %r2                   ; <<4 x i32>> [#uses=1]
  %tmp182 = extractelement <4 x i32> %tmp181, i32 1 ; <i32> [#uses=1]
  %tmp183 = load i32, i32* %fifteen                    ; <i32> [#uses=1]
  %shl184 = shl i32 %tmp182, %tmp183              ; <i32> [#uses=1]
  %xor185 = xor i32 %xor180, %shl184              ; <i32> [#uses=1]
  %tmp186 = load i32, i32* %i                          ; <i32> [#uses=1]
  %arraydecay187 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx188 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay187, i32 %tmp186 ; <<4 x i32>*> [#uses=2]
  %tmp189 = load <4 x i32>, <4 x i32>* %arrayidx188          ; <<4 x i32>> [#uses=1]
  %tmp190 = insertelement <4 x i32> %tmp189, i32 %xor185, i32 1 ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp190, <4 x i32>* %arrayidx188
  %tmp191 = load <4 x i32>, <4 x i32>* %a                    ; <<4 x i32>> [#uses=1]
  %tmp192 = extractelement <4 x i32> %tmp191, i32 2 ; <i32> [#uses=1]
  %tmp193 = load <4 x i32>, <4 x i32>* %e                    ; <<4 x i32>> [#uses=1]
  %tmp194 = extractelement <4 x i32> %tmp193, i32 2 ; <i32> [#uses=1]
  %xor195 = xor i32 %tmp192, %tmp194              ; <i32> [#uses=1]
  %tmp196 = load <4 x i32>, <4 x i32>* %b                    ; <<4 x i32>> [#uses=1]
  %tmp197 = extractelement <4 x i32> %tmp196, i32 2 ; <i32> [#uses=1]
  %tmp198 = load i32, i32* %thirteen                   ; <i32> [#uses=1]
  %shr199 = lshr i32 %tmp197, %tmp198             ; <i32> [#uses=1]
  %tmp200 = load i32, i32* %mask13                     ; <i32> [#uses=1]
  %and201 = and i32 %shr199, %tmp200              ; <i32> [#uses=1]
  %xor202 = xor i32 %xor195, %and201              ; <i32> [#uses=1]
  %tmp203 = load <4 x i32>, <4 x i32>* %f                    ; <<4 x i32>> [#uses=1]
  %tmp204 = extractelement <4 x i32> %tmp203, i32 2 ; <i32> [#uses=1]
  %xor205 = xor i32 %xor202, %tmp204              ; <i32> [#uses=1]
  %tmp206 = load <4 x i32>, <4 x i32>* %r2                   ; <<4 x i32>> [#uses=1]
  %tmp207 = extractelement <4 x i32> %tmp206, i32 2 ; <i32> [#uses=1]
  %tmp208 = load i32, i32* %fifteen                    ; <i32> [#uses=1]
  %shl209 = shl i32 %tmp207, %tmp208              ; <i32> [#uses=1]
  %xor210 = xor i32 %xor205, %shl209              ; <i32> [#uses=1]
  %tmp211 = load i32, i32* %i                          ; <i32> [#uses=1]
  %arraydecay212 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx213 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay212, i32 %tmp211 ; <<4 x i32>*> [#uses=2]
  %tmp214 = load <4 x i32>, <4 x i32>* %arrayidx213          ; <<4 x i32>> [#uses=1]
  %tmp215 = insertelement <4 x i32> %tmp214, i32 %xor210, i32 2 ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp215, <4 x i32>* %arrayidx213
  %tmp216 = load <4 x i32>, <4 x i32>* %a                    ; <<4 x i32>> [#uses=1]
  %tmp217 = extractelement <4 x i32> %tmp216, i32 3 ; <i32> [#uses=1]
  %tmp218 = load <4 x i32>, <4 x i32>* %e                    ; <<4 x i32>> [#uses=1]
  %tmp219 = extractelement <4 x i32> %tmp218, i32 3 ; <i32> [#uses=1]
  %xor220 = xor i32 %tmp217, %tmp219              ; <i32> [#uses=1]
  %tmp221 = load <4 x i32>, <4 x i32>* %b                    ; <<4 x i32>> [#uses=1]
  %tmp222 = extractelement <4 x i32> %tmp221, i32 3 ; <i32> [#uses=1]
  %tmp223 = load i32, i32* %thirteen                   ; <i32> [#uses=1]
  %shr224 = lshr i32 %tmp222, %tmp223             ; <i32> [#uses=1]
  %tmp225 = load i32, i32* %mask14                     ; <i32> [#uses=1]
  %and226 = and i32 %shr224, %tmp225              ; <i32> [#uses=1]
  %xor227 = xor i32 %xor220, %and226              ; <i32> [#uses=1]
  %tmp228 = load <4 x i32>, <4 x i32>* %f                    ; <<4 x i32>> [#uses=1]
  %tmp229 = extractelement <4 x i32> %tmp228, i32 3 ; <i32> [#uses=1]
  %xor230 = xor i32 %xor227, %tmp229              ; <i32> [#uses=1]
  %tmp231 = load <4 x i32>, <4 x i32>* %r2                   ; <<4 x i32>> [#uses=1]
  %tmp232 = extractelement <4 x i32> %tmp231, i32 3 ; <i32> [#uses=1]
  %tmp233 = load i32, i32* %fifteen                    ; <i32> [#uses=1]
  %shl234 = shl i32 %tmp232, %tmp233              ; <i32> [#uses=1]
  %xor235 = xor i32 %xor230, %shl234              ; <i32> [#uses=1]
  %tmp236 = load i32, i32* %i                          ; <i32> [#uses=1]
  %arraydecay237 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx238 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay237, i32 %tmp236 ; <<4 x i32>*> [#uses=2]
  %tmp239 = load <4 x i32>, <4 x i32>* %arrayidx238          ; <<4 x i32>> [#uses=1]
  %tmp240 = insertelement <4 x i32> %tmp239, i32 %xor235, i32 3 ; <<4 x i32>> [#uses=1]
  store <4 x i32> %tmp240, <4 x i32>* %arrayidx238
  br label %for.inc

for.inc:                                          ; preds = %sw.epilog
  %tmp241 = load i32, i32* %i                          ; <i32> [#uses=1]
  %inc = add i32 %tmp241, 1                       ; <i32> [#uses=1]
  store i32 %inc, i32* %i
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %arraydecay243 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx244 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay243, i32 0 ; <<4 x i32>*> [#uses=1]
  %tmp245 = load <4 x i32>, <4 x i32>* %arrayidx244          ; <<4 x i32>> [#uses=1]
  ...
  %arraydecay248 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx249 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay248, i32 0 ; <<4 x i32>*> [#uses=1]
  %tmp250 = load <4 x i32>, <4 x i32>* %arrayidx249          ; <<4 x i32>> [#uses=1]
  ...
  %arraydecay254 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx255 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay254, i32 0 ; <<4 x i32>*> [#uses=1]
  %tmp256 = load <4 x i32>, <4 x i32>* %arrayidx255          ; <<4 x i32>> [#uses=1]
  ...
  %arraydecay260 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx261 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay260, i32 0 ; <<4 x i32>*> [#uses=1]
  %tmp262 = load <4 x i32>, <4 x i32>* %arrayidx261          ; <<4 x i32>> [#uses=1]
  ...
  %tmp266 = load <4 x float>, <4 x float>* %tmpValue1          ; <<4 x float>> [#uses=1]
  %tmp267 = load float, float* %one                      ; <float> [#uses=1]
  ...
  %tmp270 = load float, float* %intMax                   ; <float> [#uses=1]
  ...
  %arraydecay275 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx276 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay275, i32 1 ; <<4 x i32>*> [#uses=1]
  %tmp277 = load <4 x i32>, <4 x i32>* %arrayidx276          ; <<4 x i32>> [#uses=1]
  ...
  %arraydecay281 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx282 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay281, i32 1 ; <<4 x i32>*> [#uses=1]
  %tmp283 = load <4 x i32>, <4 x i32>* %arrayidx282          ; <<4 x i32>> [#uses=1]
  ...
  %arraydecay287 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx288 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay287, i32 1 ; <<4 x i32>*> [#uses=1]
  %tmp289 = load <4 x i32>, <4 x i32>* %arrayidx288          ; <<4 x i32>> [#uses=1]
  ...
  %arraydecay293 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx294 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay293, i32 1 ; <<4 x i32>*> [#uses=1]
  %tmp295 = load <4 x i32>, <4 x i32>* %arrayidx294          ; <<4 x i32>> [#uses=1]
  ...
  %tmp299 = load <4 x float>, <4 x float>* %tmpValue2          ; <<4 x float>> [#uses=1]
  %tmp300 = load float, float* %one                      ; <float> [#uses=1]
  ...
  %tmp304 = load float, float* %intMax                   ; <float> [#uses=1]
  ...
  %tmp310 = load float, float* %two                      ; <float> [#uses=1]
  ...
  %tmp313 = load <4 x float>, <4 x float>* %temp1              ; <<4 x float>> [#uses=1]
  ...
  %tmp316 = load float, float* %two                      ; <float> [#uses=1]
  %tmp317 = load float, float* %PI                       ; <float> [#uses=1]
  ...
  %tmp321 = load <4 x float>, <4 x float>* %temp2              ; <<4 x float>> [#uses=1]
  %mul322 = fmul <4 x float> %splat320, %tmp321   ; <<4 x float>> [#uses=1]
  store <4 x float> %mul322, <4 x float>* %phi
  %tmp323 = load <4 x float>, <4 x float>* %r                  ; <<4 x float>> [#uses=1]
  %tmp324 = load <4 x float>, <4 x float>* %phi                ; <<4 x float>> [#uses=1]
  ...
  %tmp327 = load <4 x float>*, <4 x float>** %gaussianRand1.addr ; <<4 x float>*> [#uses=1]
  store <4 x float> %mul326, <4 x float>* %tmp327
  %tmp328 = load <4 x float>, <4 x float>* %r                  ; <<4 x float>> [#uses=1]
  %tmp329 = load <4 x float>, <4 x float>* %phi                ; <<4 x float>> [#uses=1]
  ...
  %tmp332 = load <4 x float>*, <4 x float>** %gaussianRand2.addr ; <<4 x float>*> [#uses=1]
  store <4 x float> %mul331, <4 x float>* %tmp332
  %arraydecay333 = getelementptr inbounds [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0 ; <<4 x i32>*> [#uses=1]
  %arrayidx334 = getelementptr inbounds <4 x i32>, <4 x i32>* %arraydecay333, i32 2 ; <<4 x i32>*> [#uses=1]
  %tmp335 = load <4 x i32>, <4 x i32>* %arrayidx334          ; <<4 x i32>> [#uses=1]
  %tmp336 = load <4 x i32>*, <4 x i32>** %nextRand.addr       ; <<4 x i32>*> [#uses=1]
...
if.end90:                                         ; preds = %if.then83, %if.end79
  %tmp91 = load <4 x float>, <4 x float>* %meanDeriv1.addr     ; <<4 x float>> [#uses=1]
  %tmp92 = load <4 x float>, <4 x float>* %temp1               ; <<4 x float>> [#uses=1]
  %mul = fmul <4 x float> %tmp91, %tmp92          ; <<4 x float>> [#uses=1]
  %tmp93 = load <4 x float>*, <4 x float>** %pathDeriv1.addr    ; <<4 x float>*> [#uses=1]
  store <4 x float> %mul, <4 x float>* %tmp93
  %tmp94 = load <4 x float>, <4 x float>* %meanDeriv2.addr     ; <<4 x float>> [#uses=1]
  %tmp95 = load <4 x float>, <4 x float>* %temp2               ; <<4 x float>> [#uses=1]
  %mul96 = fmul <4 x float> %tmp94, %tmp95        ; <<4 x float>> [#uses=1]
  %tmp97 = load <4 x float>*, <4 x float>** %pathDeriv2.addr    ; <<4 x float>*> [#uses=1]
  store <4 x float> %mul96, <4 x float>* %tmp97
  %tmp98 = load <4 x float>, <4 x float>* %temp3               ; <<4 x float>> [#uses=1]
  %tmp99 = load <4 x float>*, <4 x float>** %priceVec1.addr     ; <<4 x float>*> [#uses=1]
  store <4 x float> %tmp98, <4 x float>* %tmp99
  %tmp100 = load <4 x float>, <4 x float>* %temp4              ; <<4 x float>> [#uses=1]
  %tmp101 = load <4 x float>*, <4 x float>** %priceVec2.addr    ; <<4 x float>*> [#uses=1]
...
entry:
  ...
  %arrayidx = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp, i32 0 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx4 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp3, i32 1 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx8 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp7, i32 2 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx12 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp11, i32 3 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx16 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp15, i32 4 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx20 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp19, i32 5 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx24 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp23, i32 6 ; <<4 x float> addrspace(1)*> [#uses=1]
  ...
  %arrayidx63 = getelementptr inbounds <4 x i32>, <4 x i32> addrspace(1)* %tmp62, i32 %add ; <<4 x i32> addrspace(1)*> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp102 = load <4 x float>, <4 x float>* %initPrice          ; <<4 x float>> [#uses=3]
  ...
  %tmp105 = load <4 x float>, <4 x float>* %temp               ; <<4 x float>> [#uses=1]
  %sub = fsub <4 x float> %call104, %tmp105       ; <<4 x float>> [#uses=1]
  %tmp106 = load <4 x float>, <4 x float>* %sigma              ; <<4 x float>> [#uses=3]
  ...
  %tmp112 = load <4 x float>, <4 x float>* %sumDeriv2          ; <<4 x float>> [#uses=1]
  %tmp113 = load <4 x float>, <4 x float>* %trajPrice2         ; <<4 x float>> [#uses=1]
  %tmp114 = load <4 x float>, <4 x float>* %trajPrice2         ; <<4 x float>> [#uses=1]
  %tmp115 = load <4 x float>, <4 x float>* %initPrice          ; <<4 x float>> [#uses=3]
  ...
  %tmp120 = load <4 x float>, <4 x float>* %temp               ; <<4 x float>> [#uses=1]
  %sub121 = fsub <4 x float> %call119, %tmp120    ; <<4 x float>> [#uses=1]
  %tmp122 = load <4 x float>, <4 x float>* %sigma              ; <<4 x float>> [#uses=3]
...
for.inc:                                          ; preds = %for.body
  %tmp128 = load i32, i32* %i                          ; <i32> [#uses=1]
  %inc = add nsw i32 %tmp128, 1                   ; <i32> [#uses=1]
  store i32 %inc, i32* %i
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %tmp129 = load <4 x float>, <4 x float>* %sumPrice1          ; <<4 x float>> [#uses=1]
  %tmp130 = load i32, i32* %noOfSum.addr               ; <i32> [#uses=1]
  ...
  %tmp137 = load <4 x float>, <4 x float>* %sumPrice2          ; <<4 x float>> [#uses=1]
  %tmp138 = load i32, i32* %noOfSum.addr               ; <i32> [#uses=1]
  ...
  %tmp145 = load <4 x float>, <4 x float>* %sumDeriv1          ; <<4 x float>> [#uses=1]
  %tmp146 = load i32, i32* %noOfSum.addr               ; <i32> [#uses=1]
  ...
  %tmp153 = load <4 x float>, <4 x float>* %sumDeriv2          ; <<4 x float>> [#uses=1]
  %tmp154 = load i32, i32* %noOfSum.addr               ; <i32> [#uses=1]
  ...
  %tmp161 = load <4 x float>, <4 x float>* %strikePrice        ; <<4 x float>> [#uses=1]
  %tmp162 = load <4 x float>, <4 x float>* %meanDeriv1         ; <<4 x float>> [#uses=1]
  %tmp163 = load <4 x float>, <4 x float>* %meanDeriv2         ; <<4 x float>> [#uses=1]
  %tmp164 = load <4 x float>, <4 x float>* %meanPrice1         ; <<4 x float>> [#uses=1]
  %tmp165 = load <4 x float>, <4 x float>* %meanPrice2         ; <<4 x float>> [#uses=1]
  ...
  %tmp166 = load <4 x float>, <4 x float>* %price1             ; <<4 x float>> [#uses=1]
  %tmp167 = load i32, i32* %yPos                       ; <i32> [#uses=1]
  %tmp168 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul169 = mul i32 %tmp167, %tmp168              ; <i32> [#uses=1]
  %tmp170 = load i32, i32* %xPos                       ; <i32> [#uses=1]
  %add171 = add i32 %mul169, %tmp170              ; <i32> [#uses=1]
  %mul172 = mul i32 %add171, 2                    ; <i32> [#uses=1]
  %tmp173 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %priceSamples.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx174 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp173, i32 %mul172 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp166, <4 x float> addrspace(1)* %arrayidx174
  %tmp175 = load <4 x float>, <4 x float>* %price2             ; <<4 x float>> [#uses=1]
  %tmp176 = load i32, i32* %yPos                       ; <i32> [#uses=1]
  %tmp177 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul178 = mul i32 %tmp176, %tmp177              ; <i32> [#uses=1]
  %tmp179 = load i32, i32* %xPos                       ; <i32> [#uses=1]
  %add180 = add i32 %mul178, %tmp179              ; <i32> [#uses=1]
  %mul181 = mul i32 %add180, 2                    ; <i32> [#uses=1]
  %add182 = add i32 %mul181, 1                    ; <i32> [#uses=1]
  %tmp183 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %priceSamples.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx184 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp183, i32 %add182 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp175, <4 x float> addrspace(1)* %arrayidx184
  %tmp185 = load <4 x float>, <4 x float>* %pathDeriv1         ; <<4 x float>> [#uses=1]
  %tmp186 = load i32, i32* %yPos                       ; <i32> [#uses=1]
  %tmp187 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul188 = mul i32 %tmp186, %tmp187              ; <i32> [#uses=1]
  %tmp189 = load i32, i32* %xPos                       ; <i32> [#uses=1]
  %add190 = add i32 %mul188, %tmp189              ; <i32> [#uses=1]
  %mul191 = mul i32 %add190, 2                    ; <i32> [#uses=1]
  %tmp192 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %pathDeriv.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx193 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp192, i32 %mul191 ; <<4 x float> addrspace(1)*> [#uses=1]
  store <4 x float> %tmp185, <4 x float> addrspace(1)* %arrayidx193
  %tmp194 = load <4 x float>, <4 x float>* %pathDeriv2         ; <<4 x float>> [#uses=1]
  %tmp195 = load i32, i32* %yPos                       ; <i32> [#uses=1]
  %tmp196 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul197 = mul i32 %tmp195, %tmp196              ; <i32> [#uses=1]
  %tmp198 = load i32, i32* %xPos                       ; <i32> [#uses=1]
  %add199 = add i32 %mul197, %tmp198              ; <i32> [#uses=1]
  %mul200 = mul i32 %add199, 2                    ; <i32> [#uses=1]
  %add201 = add i32 %mul200, 1                    ; <i32> [#uses=1]
  %tmp202 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %pathDeriv.addr ; <<4 x float> addrspace(1)*> [#uses=1]
  %arrayidx203 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %tmp202, i32 %add201 ; <<4 x float> addrspace(1)*> [#uses=1]

...
entry:
  ...
  %tmp6 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp6, i32 %add ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp7 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx   ; <<4 x i8>> [#uses=1]
  ...
  %tmp13 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block.addr ; <<4 x i8> addrspace(3)*> [#uses=1]
  %arrayidx14 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(3)* %tmp13, i32 %add12 ; <<4 x i8> addrspace(3)*> [#uses=1]
  store <4 x i8> %tmp7, <4 x i8> addrspace(3)* %arrayidx14
  call void @_Z7barrierm(i32 1)
  %tmp16 = load i32, i32* %localIdy                    ; <i32> [#uses=1]
  %tmp17 = load i32, i32* %blockSize.addr              ; <i32> [#uses=1]
  %mul18 = mul i32 %tmp16, %tmp17                 ; <i32> [#uses=1]
  %tmp19 = load i32, i32* %localIdx                    ; <i32> [#uses=1]
  %add20 = add i32 %mul18, %tmp19                 ; <i32> [#uses=1]
  store i32 %add20, i32* %sourceIndex
  %tmp22 = load i32, i32* %globalIdy                   ; <i32> [#uses=1]
  %tmp23 = load i32, i32* %globalIdx                   ; <i32> [#uses=1]
  %tmp24 = load i32, i32* %height.addr                 ; <i32> [#uses=1]
  %mul25 = mul i32 %tmp23, %tmp24                 ; <i32> [#uses=1]
  %add26 = add i32 %tmp22, %mul25                 ; <i32> [#uses=1]
  store i32 %add26, i32* %targetIndex
  %tmp27 = load i32, i32* %sourceIndex                 ; <i32> [#uses=1]
  %tmp28 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block.addr ; <<4 x i8> addrspace(3)*> [#uses=1]
  %arrayidx29 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(3)* %tmp28, i32 %tmp27 ; <<4 x i8> addrspace(3)*> [#uses=1]
  %tmp30 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx29 ; <<4 x i8>> [#uses=1]
  %tmp31 = load i32, i32* %targetIndex                 ; <i32> [#uses=1]
  %tmp32 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx33 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp32, i32 %tmp31 ; <<4 x i8> addrspace(1)*> [#uses=1]
...
entry:
  ...
  %tmp1 = load i32, i32* %width.addr                   ; <i32> [#uses=1]
...
for.body:                                         ; preds = %for.cond
  ...
  %tmp14 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp15 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp15, i32 %tmp14 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp16 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx  ; <<4 x i8>> [#uses=1]
  ...
  %tmp18 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp19 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx20 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp19, i32 %tmp18 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp21 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx20 ; <<4 x i8>> [#uses=1]
  ...
  %tmp25 = load i32, i32* %pos                         ; <i32> [#uses=1]
  ...
  %tmp32 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp33 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  ...
  %tmp39 = load <4 x float>, <4 x float>* %.compoundliteral    ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp39, <4 x float>* %xc
  %tmp41 = load float, float* %a0.addr                   ; <float> [#uses=1]
  ...
  %tmp43 = load <4 x float>, <4 x float>* %xc                  ; <<4 x float>> [#uses=1]
  %mul44 = fmul <4 x float> %splat, %tmp43        ; <<4 x float>> [#uses=1]
  %tmp45 = load float, float* %a1.addr                   ; <float> [#uses=1]
  ...
  %tmp59 = load <4 x float>, <4 x float>* %yb                  ; <<4 x float>> [#uses=1]
  ...
  %tmp63 = load <4 x float>, <4 x float>* %yc                  ; <<4 x float>> [#uses=1]
  ...
  %tmp67 = load <4 x float>, <4 x float>* %yc                  ; <<4 x float>> [#uses=1]
  ...
  %tmp71 = load <4 x float>, <4 x float>* %yc                  ; <<4 x float>> [#uses=1]
  ...
  %tmp75 = load <4 x float>, <4 x float>* %yc                  ; <<4 x float>> [#uses=1]
  ...
  %tmp79 = load <4 x i8>, <4 x i8>* %.compoundliteral62     ; <<4 x i8>> [#uses=1]
  %tmp80 = load i32, i32* %pos                         ; <i32> [#uses=1]
  %tmp81 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx82 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp81, i32 %tmp80 ; <<4 x i8> addrspace(1)*> [#uses=1]
  store <4 x i8> %tmp79, <4 x i8> addrspace(1)* %arrayidx82
  %tmp83 = load <4 x float>, <4 x float>* %xc                  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp83, <4 x float>* %xp
  %tmp84 = load <4 x float>, <4 x float>* %yp                  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp84, <4 x float>* %yb
  %tmp85 = load <4 x float>, <4 x float>* %yc                  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp85, <4 x float>* %yp
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %tmp86 = load i32, i32* %y                           ; <i32> [#uses=1]
...
for.end:                                          ; preds = %for.cond
  ...
  %tmp89 = load <4 x float>, <4 x float>* %.compoundliteral88  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp89, <4 x float>* %xn
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral91
  %tmp92 = load <4 x float>, <4 x float>* %.compoundliteral91  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp92, <4 x float>* %xa
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral94
  %tmp95 = load <4 x float>, <4 x float>* %.compoundliteral94  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp95, <4 x float>* %yn
  store <4 x float> zeroinitializer, <4 x float>* %.compoundliteral97
  %tmp98 = load <4 x float>, <4 x float>* %.compoundliteral97  ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp98, <4 x float>* %ya
  %tmp101 = load i32, i32* %height.addr                ; <i32> [#uses=1]
  %sub102 = sub i32 %tmp101, 1                    ; <i32> [#uses=1]
  store i32 %sub102, i32* %y100
  br label %for.cond103

for.cond103:                                      ; preds = %for.inc230, %for.end
  %tmp104 = load i32, i32* %y100                       ; <i32> [#uses=1]
  %cmp105 = icmp sgt i32 %tmp104, -1              ; <i1> [#uses=1]
  br i1 %cmp105, label %for.body107, label %for.end232

for.body107:                                      ; preds = %for.cond103
  %tmp110 = load i32, i32* %x                          ; <i32> [#uses=1]
  %tmp111 = load i32, i32* %y100                       ; <i32> [#uses=1]
  %tmp112 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul113 = mul i32 %tmp111, %tmp112              ; <i32> [#uses=1]
  %add114 = add i32 %tmp110, %mul113              ; <i32> [#uses=1]
  store i32 %add114, i32* %pos109
  %tmp118 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp119 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx120 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp119, i32 %tmp118 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp121 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx120 ; <<4 x i8>> [#uses=1]
  ...
  %tmp125 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp126 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx127 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp126, i32 %tmp125 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp128 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx127 ; <<4 x i8>> [#uses=1]
  ...
  %tmp132 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp133 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx134 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp133, i32 %tmp132 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp135 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx134 ; <<4 x i8>> [#uses=1]
  ...
  %tmp139 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp140 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx141 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp140, i32 %tmp139 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp142 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx141 ; <<4 x i8>> [#uses=1]
  ...
  %tmp146 = load <4 x float>, <4 x float>* %.compoundliteral117 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp146, <4 x float>* %xc116
  %tmp149 = load float, float* %a2.addr                  ; <float> [#uses=1]
  ...
  %tmp152 = load <4 x float>, <4 x float>* %xn                 ; <<4 x float>> [#uses=1]
  %mul153 = fmul <4 x float> %splat151, %tmp152   ; <<4 x float>> [#uses=1]
  %tmp154 = load float, float* %a3.addr                  ; <float> [#uses=1]
  ...
  %tmp169 = load <4 x float>, <4 x float>* %ya                 ; <<4 x float>> [#uses=1]
  ...
  %tmp172 = load <4 x float>, <4 x float>* %xn                 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp172, <4 x float>* %xa
  %tmp173 = load <4 x float>, <4 x float>* %xc116              ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp173, <4 x float>* %xn
  %tmp174 = load <4 x float>, <4 x float>* %yn                 ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp174, <4 x float>* %ya
  %tmp175 = load <4 x float>, <4 x float>* %yc148              ; <<4 x float>> [#uses=1]
  store <4 x float> %tmp175, <4 x float>* %yn
  %tmp178 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp179 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx180 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp179, i32 %tmp178 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp181 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx180 ; <<4 x i8>> [#uses=1]
  ...
  %tmp185 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp186 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx187 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp186, i32 %tmp185 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp188 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx187 ; <<4 x i8>> [#uses=1]
  ...
  %tmp192 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp193 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx194 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp193, i32 %tmp192 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp195 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx194 ; <<4 x i8>> [#uses=1]
  ...
  %tmp199 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp200 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx201 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp200, i32 %tmp199 ; <<4 x i8> addrspace(1)*> [#uses=1]
  %tmp202 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx201 ; <<4 x i8>> [#uses=1]
  ...
  %tmp206 = load <4 x float>, <4 x float>* %.compoundliteral177 ; <<4 x float>> [#uses=1]
  %tmp207 = load <4 x float>, <4 x float>* %yc148              ; <<4 x float>> [#uses=1]
  %add208 = fadd <4 x float> %tmp206, %tmp207     ; <<4 x float>> [#uses=1]
  store <4 x float> %add208, <4 x float>* %temp
  %tmp210 = load <4 x float>, <4 x float>* %temp               ; <<4 x float>> [#uses=1]
  ...
  %tmp214 = load <4 x float>, <4 x float>* %temp               ; <<4 x float>> [#uses=1]
  ...
  %tmp218 = load <4 x float>, <4 x float>* %temp               ; <<4 x float>> [#uses=1]
  ...
  %tmp222 = load <4 x float>, <4 x float>* %temp               ; <<4 x float>> [#uses=1]
  ...
  %tmp226 = load <4 x i8>, <4 x i8>* %.compoundliteral209   ; <<4 x i8>> [#uses=1]
  %tmp227 = load i32, i32* %pos109                     ; <i32> [#uses=1]
  %tmp228 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr ; <<4 x i8> addrspace(1)*> [#uses=1]
  %arrayidx229 = getelementptr inbounds <4 x i8>, <4 x i8> addrspace(1)* %tmp228, i32 %tmp227 ; <<4 x i8> addrspace(1)*> [#uses=1]
  store <4 x i8> %tmp226, <4 x i8> addrspace(1)* %arrayidx229
  br label %for.inc230

for.inc230:                                       ; preds = %for.body107
  %tmp231 = load i32, i32* %y100                       ; <i32> [#uses=1]

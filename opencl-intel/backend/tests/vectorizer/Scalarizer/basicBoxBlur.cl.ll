...
entry:
  ...
  %tmp = load float, float* %radius.addr                 ; <float> [#uses=1]
  %call5 = call float @_Z4ceilf(float %tmp)       ; <float> [#uses=1]
  %conv = fptosi float %call5 to i32              ; <i32> [#uses=1]
  store i32 %conv, i32* %local_radius
  %tmp7 = load i32, i32* %height.addr                  ; <i32> [#uses=1]
  %tmp8 = load i32, i32* %global_szy                   ; <i32> [#uses=2]
  ...
  %tmp10 = load i32, i32* %width.addr                  ; <i32> [#uses=1]
  ...
  %tmp18 = load i32, i32* %global_szx                  ; <i32> [#uses=2]
  ...
  %tmp23 = load i32, i32* %height.addr                 ; <i32> [#uses=1]
  %tmp24 = load i32, i32* %globalIdy                   ; <i32> [#uses=1]
  %mul25 = mul i32 %tmp23, %tmp24                 ; <i32> [#uses=1]
  %tmp26 = load i32, i32* %global_szy                  ; <i32> [#uses=2]
  ...
  %tmp34 = load i32, i32* %index_y                     ; <i32> [#uses=1]
  %tmp35 = load i32, i32* %count_y                     ; <i32> [#uses=1]
  %add = add i32 %tmp34, %tmp35                   ; <i32> [#uses=1]
  %tmp36 = load i32, i32* %local_radius                ; <i32> [#uses=1]
  %add37 = add i32 %add, %tmp36                   ; <i32> [#uses=1]
  %tmp38 = load i32, i32* %height.addr                 ; <i32> [#uses=1]
  %cmp39 = icmp uge i32 %add37, %tmp38            ; <i1> [#uses=1]
  br i1 %cmp39, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  store i8 1, i8* %bottomEdge
  %tmp41 = load i32, i32* %height.addr                 ; <i32> [#uses=1]
  %tmp42 = load i32, i32* %index_y                     ; <i32> [#uses=1]
  %sub = sub i32 %tmp41, %tmp42                   ; <i32> [#uses=1]
  %tmp43 = load i32, i32* %local_radius                ; <i32> [#uses=1]
  %sub44 = sub i32 %sub, %tmp43                   ; <i32> [#uses=1]
  store i32 %sub44, i32* %count_y
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %tmp45 = load i32, i32* %index_x                     ; <i32> [#uses=1]
  %tmp46 = load i32, i32* %count_x                     ; <i32> [#uses=1]
  %add47 = add i32 %tmp45, %tmp46                 ; <i32> [#uses=1]
  %tmp48 = load i32, i32* %local_radius                ; <i32> [#uses=1]
  %add49 = add i32 %add47, %tmp48                 ; <i32> [#uses=1]
  %tmp50 = load i32, i32* %width.addr                  ; <i32> [#uses=1]
...
if.then53:                                        ; preds = %if.end
  ...
  %tmp54 = load i32, i32* %width.addr                  ; <i32> [#uses=1]
  %tmp55 = load i32, i32* %index_x                     ; <i32> [#uses=1]
  %sub56 = sub i32 %tmp54, %tmp55                 ; <i32> [#uses=1]
  %tmp57 = load i32, i32* %local_radius                ; <i32> [#uses=1]
...
if.end79:                                         ; preds = %if.then74, %if.end69
  ...
  %tmp99 = load i32, i32* %index_y                     ; <i32> [#uses=1]
  %tmp100 = load i32, i32* %local_radius               ; <i32> [#uses=1]
  %sub101 = sub i32 %tmp99, %tmp100               ; <i32> [#uses=1]
  %tmp102 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul103 = mul i32 %sub101, %tmp102              ; <i32> [#uses=1]
  %tmp104 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %add105 = add i32 %mul103, %tmp104              ; <i32> [#uses=1]
  %tmp106 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.cond:                                         ; preds = %for.inc135, %if.end79
  %tmp109 = load i32, i32* %y                          ; <i32> [#uses=1]
  %tmp110 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.cond116:                                      ; preds = %for.inc, %for.body
  ...
  %tmp118 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.inc:                                          ; preds = %for.body123
  %tmp131 = load i32, i32* %x                          ; <i32> [#uses=1]
  %inc = add i32 %tmp131, 1                       ; <i32> [#uses=1]
  store i32 %inc, i32* %x
  br label %for.cond116

for.end:                                          ; preds = %for.cond116
  %tmp132 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %tmp133 = load i32, i32* %leftIndex                  ; <i32> [#uses=1]
  %add134 = add i32 %tmp133, %tmp132              ; <i32> [#uses=1]
  store i32 %add134, i32* %leftIndex
  br label %for.inc135

for.inc135:                                       ; preds = %for.end
  %tmp136 = load i32, i32* %y                          ; <i32> [#uses=1]
  %inc137 = add i32 %tmp136, 1                    ; <i32> [#uses=1]
  store i32 %inc137, i32* %y
  br label %for.cond

for.end138:                                       ; preds = %for.cond
  %tmp140 = load i32, i32* %index_y                    ; <i32> [#uses=1]
  %tmp141 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul142 = mul i32 %tmp140, %tmp141              ; <i32> [#uses=1]
  %tmp143 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %add144 = add i32 %mul142, %tmp143              ; <i32> [#uses=1]
  store i32 %add144, i32* %sourceIndex
  %tmp145 = load <4 x float>, <4 x float>* %firstBlockAccumulator ; <<4 x float>> [#uses=1]
  %tmp146 = load float, float* %denominator              ; <float> [#uses=1]
  ...
  %tmp156 = load i32, i32* %sourceIndex                ; <i32> [#uses=1]
  %inc157 = add i32 %tmp156, 1                    ; <i32> [#uses=1]
  store i32 %inc157, i32* %sourceIndex
  %tmp163 = load i32, i32* %index_y                    ; <i32> [#uses=1]
  %tmp164 = load i32, i32* %local_radius               ; <i32> [#uses=1]
  %sub165 = sub i32 %tmp163, %tmp164              ; <i32> [#uses=1]
  %tmp166 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul167 = mul i32 %sub165, %tmp166              ; <i32> [#uses=1]
  %tmp168 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %add169 = add i32 %mul167, %tmp168              ; <i32> [#uses=1]
  %tmp170 = load i32, i32* %local_radius               ; <i32> [#uses=1]
  %sub171 = sub i32 %add169, %tmp170              ; <i32> [#uses=1]
  store i32 %sub171, i32* %topRowIndex
  %tmp173 = load i32, i32* %index_y                    ; <i32> [#uses=1]
  %tmp174 = load i32, i32* %local_radius               ; <i32> [#uses=1]
  %add175 = add i32 %tmp173, %tmp174              ; <i32> [#uses=1]
  %tmp176 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul177 = mul i32 %add175, %tmp176              ; <i32> [#uses=1]
  %tmp178 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %add179 = add i32 %mul177, %tmp178              ; <i32> [#uses=1]
  %tmp180 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.cond183:                                      ; preds = %for.end290, %for.end138
  %tmp184 = load i32, i32* %row                        ; <i32> [#uses=1]
  %tmp185 = load i32, i32* %count_y                    ; <i32> [#uses=1]
...
for.body189:                                      ; preds = %for.cond183
  %tmp190 = load i32, i32* %topRowIndex                ; <i32> [#uses=1]
  store i32 %tmp190, i32* %leftColumnIndex
  %tmp191 = load i32, i32* %topRowIndex                ; <i32> [#uses=1]
  %tmp192 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.body214:                                      ; preds = %for.cond207
  ...
  %tmp231 = load i32, i32* %tmpIndex2                  ; <i32> [#uses=1]
  %add232 = add i32 %tmp231, %tmp230              ; <i32> [#uses=1]
  store i32 %add232, i32* %tmpIndex2
  br label %for.inc233

for.inc233:                                       ; preds = %for.body214
  %tmp234 = load i32, i32* %c                          ; <i32> [#uses=1]
  %inc235 = add i32 %tmp234, 1                    ; <i32> [#uses=1]
  store i32 %inc235, i32* %c
  br label %for.cond207

for.end236:                                       ; preds = %for.cond207
  %tmp237 = load <4 x float>, <4 x float>* %colorAccumulator   ; <<4 x float>> [#uses=1]
  %tmp238 = load float, float* %denominator              ; <float> [#uses=1]
...
for.inc287:                                       ; preds = %for.body270
  %tmp288 = load i32, i32* %r                          ; <i32> [#uses=1]
  %inc289 = add i32 %tmp288, 1                    ; <i32> [#uses=1]
  store i32 %inc289, i32* %r
  br label %for.cond263

for.end290:                                       ; preds = %for.cond263
  %tmp291 = load i32, i32* %index_y                    ; <i32> [#uses=1]
  %tmp292 = load i32, i32* %row                        ; <i32> [#uses=1]
  %add293 = add i32 %tmp291, %tmp292              ; <i32> [#uses=1]
  %tmp294 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %mul295 = mul i32 %add293, %tmp294              ; <i32> [#uses=1]
  %tmp296 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %add297 = add i32 %mul295, %tmp296              ; <i32> [#uses=1]
  store i32 %add297, i32* %sourceIndex
  %tmp298 = load <4 x float>, <4 x float>* %firstBlockAccumulator ; <<4 x float>> [#uses=1]
  %tmp299 = load float, float* %denominator              ; <float> [#uses=1]
  ...
  %tmp309 = load i32, i32* %sourceIndex                ; <i32> [#uses=1]
  %inc310 = add i32 %tmp309, 1                    ; <i32> [#uses=1]
  store i32 %inc310, i32* %sourceIndex
  %tmp311 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %tmp312 = load i32, i32* %topRowIndex                ; <i32> [#uses=1]
  %add313 = add i32 %tmp312, %tmp311              ; <i32> [#uses=1]
  store i32 %add313, i32* %topRowIndex
  br label %for.cond183

for.end314:                                       ; preds = %for.cond183
  %tmp315 = load i32, i32* %topRowIndex                ; <i32> [#uses=1]
  store i32 %tmp315, i32* %leftColumnIndex
  %tmp316 = load i32, i32* %topRowIndex                ; <i32> [#uses=1]
  %tmp317 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.body341:                                      ; preds = %for.cond334
  ...
  %tmp358 = load i32, i32* %tmpIndex2                  ; <i32> [#uses=1]
  %add359 = add i32 %tmp358, %tmp357              ; <i32> [#uses=1]
  store i32 %add359, i32* %tmpIndex2
  br label %for.inc360

for.inc360:                                       ; preds = %for.body341
  %tmp361 = load i32, i32* %c333                       ; <i32> [#uses=1]
  %inc362 = add i32 %tmp361, 1                    ; <i32> [#uses=1]
  store i32 %inc362, i32* %c333
  br label %for.cond334

for.end363:                                       ; preds = %for.cond334
  %tmp364 = load <4 x float>, <4 x float>* %colorAccumulator   ; <<4 x float>> [#uses=1]
  %tmp365 = load float, float* %denominator              ; <float> [#uses=1]
...
for.cond390:                                      ; preds = %for.inc479, %if.then387
  %tmp391 = load i32, i32* %row389                     ; <i32> [#uses=1]
  %tmp392 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.cond398:                                      ; preds = %for.inc475, %for.body395
  %tmp399 = load i32, i32* %column397                  ; <i32> [#uses=1]
  %tmp400 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
if.end437:                                        ; preds = %if.then436, %for.body424
  %tmp438 = load i32, i32* %w                          ; <i32> [#uses=1]
...
if.end442:                                        ; preds = %if.then441, %if.end437
  %tmp443 = load i32, i32* %h                          ; <i32> [#uses=1]
  %tmp444 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc453:                                       ; preds = %if.end442
  %tmp454 = load i32, i32* %j                          ; <i32> [#uses=1]
...
for.inc457:                                       ; preds = %for.end456
  %tmp458 = load i32, i32* %i                          ; <i32> [#uses=1]
  %inc459 = add nsw i32 %tmp458, 1                ; <i32> [#uses=1]
  store i32 %inc459, i32* %i
  br label %for.cond410

for.end460:                                       ; preds = %for.cond410
  %tmp461 = load <4 x float>, <4 x float>* %colorAccumulator   ; <<4 x float>> [#uses=1]
  %tmp462 = load float, float* %denominator              ; <float> [#uses=1]
  ...
  %tmp468 = load i32, i32* %row389                     ; <i32> [#uses=1]
  %tmp469 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc475:                                       ; preds = %for.end460
  %tmp476 = load i32, i32* %column397                  ; <i32> [#uses=1]
...
for.inc479:                                       ; preds = %for.end478
  %tmp480 = load i32, i32* %row389                     ; <i32> [#uses=1]
...
if.end483:                                        ; preds = %for.end482, %land.lhs.true, %for.end381
  %tmp484 = load i8, i8* %topEdge                     ; <i8> [#uses=1]
...
for.cond489:                                      ; preds = %for.inc581, %if.then486
  %tmp490 = load i32, i32* %row488                     ; <i32> [#uses=1]
  %tmp491 = load i32, i32* %local_radius               ; <i32> [#uses=1]
  %cmp492 = icmp slt i32 %tmp490, %tmp491         ; <i1> [#uses=1]
  br i1 %cmp492, label %for.body494, label %for.end584

for.body494:                                      ; preds = %for.cond489
  %tmp497 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  store i32 %tmp497, i32* %column496
  br label %for.cond498

for.cond498:                                      ; preds = %for.inc577, %for.body494
  %tmp499 = load i32, i32* %column496                  ; <i32> [#uses=1]
  %tmp500 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %tmp501 = load i32, i32* %count_x                    ; <i32> [#uses=1]
...
if.end544:                                        ; preds = %if.then543, %for.body529
  %tmp545 = load i32, i32* %h531                       ; <i32> [#uses=1]
  %tmp546 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc555:                                       ; preds = %if.end544
  %tmp556 = load i32, i32* %j521                       ; <i32> [#uses=1]
...
for.inc559:                                       ; preds = %for.end558
  %tmp560 = load i32, i32* %i511                       ; <i32> [#uses=1]
  %inc561 = add nsw i32 %tmp560, 1                ; <i32> [#uses=1]
  store i32 %inc561, i32* %i511
  br label %for.cond514

for.end562:                                       ; preds = %for.cond514
  %tmp563 = load <4 x float>, <4 x float>* %colorAccumulator   ; <<4 x float>> [#uses=1]
  %tmp564 = load float, float* %denominator              ; <float> [#uses=1]
  ...
  %tmp570 = load i32, i32* %row488                     ; <i32> [#uses=1]
  %tmp571 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc577:                                       ; preds = %for.end562
  %tmp578 = load i32, i32* %column496                  ; <i32> [#uses=1]
...
for.inc581:                                       ; preds = %for.end580
  %tmp582 = load i32, i32* %row488                     ; <i32> [#uses=1]
...
if.end585:                                        ; preds = %for.end584, %if.end483
  %tmp586 = load i8, i8* %topEdge                     ; <i8> [#uses=1]
...
land.lhs.true589:                                 ; preds = %if.end585
  %tmp590 = load i8, i8* %rightEdge                   ; <i8> [#uses=1]
...
for.cond596:                                      ; preds = %for.inc700, %if.then593
  %tmp597 = load i32, i32* %row595                     ; <i32> [#uses=1]
  %tmp598 = load i32, i32* %local_radius               ; <i32> [#uses=1]
  %cmp599 = icmp slt i32 %tmp597, %tmp598         ; <i1> [#uses=1]
  br i1 %cmp599, label %for.body601, label %for.end703

for.body601:                                      ; preds = %for.cond596
  %tmp604 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %tmp605 = load i32, i32* %count_x                    ; <i32> [#uses=1]
...
for.cond607:                                      ; preds = %for.inc696, %for.body601
  %tmp608 = load i32, i32* %column603                  ; <i32> [#uses=1]
  %tmp609 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %tmp610 = load i32, i32* %count_x                    ; <i32> [#uses=1]
  %add611 = add i32 %tmp609, %tmp610              ; <i32> [#uses=1]
  %tmp612 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
if.end655:                                        ; preds = %if.then654, %for.body640
  %tmp656 = load i32, i32* %w647                       ; <i32> [#uses=1]
...
if.then660:                                       ; preds = %if.end655
  %tmp661 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
  %sub662 = sub i32 %tmp661, 1                    ; <i32> [#uses=1]
  store i32 %sub662, i32* %w647
  br label %if.end663

if.end663:                                        ; preds = %if.then660, %if.end655
  %tmp664 = load i32, i32* %h642                       ; <i32> [#uses=1]
  %tmp665 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc674:                                       ; preds = %if.end663
  %tmp675 = load i32, i32* %j632                       ; <i32> [#uses=1]
...
for.inc678:                                       ; preds = %for.end677
  %tmp679 = load i32, i32* %i622                       ; <i32> [#uses=1]
  %inc680 = add nsw i32 %tmp679, 1                ; <i32> [#uses=1]
  store i32 %inc680, i32* %i622
  br label %for.cond625

for.end681:                                       ; preds = %for.cond625
  %tmp682 = load <4 x float>, <4 x float>* %colorAccumulator   ; <<4 x float>> [#uses=1]
  %tmp683 = load float, float* %denominator              ; <float> [#uses=1]
  ...
  %tmp689 = load i32, i32* %row595                     ; <i32> [#uses=1]
  %tmp690 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc696:                                       ; preds = %for.end681
  %tmp697 = load i32, i32* %column603                  ; <i32> [#uses=1]
...
for.inc700:                                       ; preds = %for.end699
  %tmp701 = load i32, i32* %row595                     ; <i32> [#uses=1]
...
for.cond721:                                      ; preds = %for.inc798, %for.body718
  %tmp722 = load i32, i32* %column720                  ; <i32> [#uses=1]
  %tmp723 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
if.end765:                                        ; preds = %if.then764, %for.body750
  %tmp766 = load i32, i32* %h752                       ; <i32> [#uses=1]
  %tmp767 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc776:                                       ; preds = %if.end765
  %tmp777 = load i32, i32* %j742                       ; <i32> [#uses=1]
...
for.inc780:                                       ; preds = %for.end779
  %tmp781 = load i32, i32* %i732                       ; <i32> [#uses=1]
  %inc782 = add nsw i32 %tmp781, 1                ; <i32> [#uses=1]
  store i32 %inc782, i32* %i732
  br label %for.cond735

for.end783:                                       ; preds = %for.cond735
  %tmp784 = load <4 x float>, <4 x float>* %colorAccumulator   ; <<4 x float>> [#uses=1]
  %tmp785 = load float, float* %denominator              ; <float> [#uses=1]
  ...
  %tmp791 = load i32, i32* %row709                     ; <i32> [#uses=1]
...
for.inc798:                                       ; preds = %for.end783
  %tmp799 = load i32, i32* %column720                  ; <i32> [#uses=1]
...
for.inc802:                                       ; preds = %for.end801
  %tmp803 = load i32, i32* %row709                     ; <i32> [#uses=1]
...
if.end806:                                        ; preds = %for.end805, %if.end704
  %tmp807 = load i8, i8* %bottomEdge                  ; <i8> [#uses=1]
...
land.lhs.true810:                                 ; preds = %if.end806
  %tmp811 = load i8, i8* %leftEdge                    ; <i8> [#uses=1]
...
if.then814:                                       ; preds = %land.lhs.true810
  %tmp817 = load i32, i32* %index_y                    ; <i32> [#uses=1]
  %tmp818 = load i32, i32* %count_y                    ; <i32> [#uses=1]
...
for.cond820:                                      ; preds = %for.inc921, %if.then814
  %tmp821 = load i32, i32* %row816                     ; <i32> [#uses=1]
  %tmp822 = load i32, i32* %index_y                    ; <i32> [#uses=1]
  %tmp823 = load i32, i32* %count_y                    ; <i32> [#uses=1]
  %add824 = add i32 %tmp822, %tmp823              ; <i32> [#uses=1]
  %tmp825 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.cond832:                                      ; preds = %for.inc917, %for.body829
  %tmp833 = load i32, i32* %column831                  ; <i32> [#uses=1]
  %tmp834 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
if.end884:                                        ; preds = %if.then883, %if.end879
  %tmp885 = load i32, i32* %h863                       ; <i32> [#uses=1]
  %tmp886 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc895:                                       ; preds = %if.end884
  %tmp896 = load i32, i32* %j853                       ; <i32> [#uses=1]
...
for.inc899:                                       ; preds = %for.end898
  %tmp900 = load i32, i32* %i843                       ; <i32> [#uses=1]
  %inc901 = add nsw i32 %tmp900, 1                ; <i32> [#uses=1]
  store i32 %inc901, i32* %i843
  br label %for.cond846

for.end902:                                       ; preds = %for.cond846
  %tmp903 = load <4 x float>, <4 x float>* %colorAccumulator   ; <<4 x float>> [#uses=1]
  %tmp904 = load float, float* %denominator              ; <float> [#uses=1]
  ...
  %tmp910 = load i32, i32* %row816                     ; <i32> [#uses=1]
  %tmp911 = load i32, i32* %width.addr                 ; <i32> [#uses=1]
...
for.inc917:                                       ; preds = %for.end902
  %tmp918 = load i32, i32* %column831                  ; <i32> [#uses=1]
...
for.inc921:                                       ; preds = %for.end920
  %tmp922 = load i32, i32* %row816                     ; <i32> [#uses=1]
...
for.cond934:                                      ; preds = %for.inc1033, %if.then928
  %tmp935 = load i32, i32* %row930                     ; <i32> [#uses=1]
  %tmp936 = load i32, i32* %index_y                    ; <i32> [#uses=1]
  %tmp937 = load i32, i32* %count_y                    ; <i32> [#uses=1]
  %add938 = add i32 %tmp936, %tmp937              ; <i32> [#uses=1]
  %tmp939 = load i32, i32* %local_radius               ; <i32> [#uses=1]
...
for.body943:                                      ; preds = %for.cond934
  %tmp946 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  store i32 %tmp946, i32* %column945
  br label %for.cond947

for.cond947:                                      ; preds = %for.inc1029, %for.body943
  %tmp948 = load i32, i32* %column945                  ; <i32> [#uses=1]
  %tmp949 = load i32, i32* %index_x                    ; <i32> [#uses=1]
  %tmp950 = load i32, i32* %count_x                    ; <i32> [#uses=1]
...
for.inc1007:                                      ; preds = %if.end996
  %tmp1008 = load i32, i32* %j970                      ; <i32> [#uses=1]
...
for.inc1011:                                      ; preds = %for.end1010
  %tmp1012 = load i32, i32* %i960                      ; <i32> [#uses=1]
  %inc1013 = add nsw i32 %tmp1012, 1              ; <i32> [#uses=1]
  store i32 %inc1013, i32* %i960
  br label %for.cond963

for.end1014:                                      ; preds = %for.cond963
  %tmp1015 = load <4 x float>, <4 x float>* %colorAccumulator  ; <<4 x float>> [#uses=1]
  %tmp1016 = load float, float* %denominator             ; <float> [#uses=1]
  ...
  %tmp1022 = load i32, i32* %row930                    ; <i32> [#uses=1]
  %tmp1023 = load i32, i32* %width.addr                ; <i32> [#uses=1]
...
for.inc1029:                                      ; preds = %for.end1014
  %tmp1030 = load i32, i32* %column945                 ; <i32> [#uses=1]
...
for.inc1033:                                      ; preds = %for.end1032
  %tmp1034 = load i32, i32* %row930                    ; <i32> [#uses=1]
...
if.end1037:                                       ; preds = %for.end1036, %if.end925
  %tmp1038 = load i8, i8* %rightEdge                  ; <i8> [#uses=1]
...
if.then1040:                                      ; preds = %if.end1037
  %tmp1043 = load i32, i32* %index_y                   ; <i32> [#uses=1]
  store i32 %tmp1043, i32* %row1042
  br label %for.cond1044

for.cond1044:                                     ; preds = %for.inc1145, %if.then1040
  %tmp1045 = load i32, i32* %row1042                   ; <i32> [#uses=1]
  %tmp1046 = load i32, i32* %index_y                   ; <i32> [#uses=1]
  %tmp1047 = load i32, i32* %count_y                   ; <i32> [#uses=1]
...
for.body1051:                                     ; preds = %for.cond1044
  %tmp1054 = load i32, i32* %index_x                   ; <i32> [#uses=1]
  %tmp1055 = load i32, i32* %count_x                   ; <i32> [#uses=1]
...
for.cond1057:                                     ; preds = %for.inc1141, %for.body1051
  %tmp1058 = load i32, i32* %column1053                ; <i32> [#uses=1]
  %tmp1059 = load i32, i32* %index_x                   ; <i32> [#uses=1]
  %tmp1060 = load i32, i32* %count_x                   ; <i32> [#uses=1]
  %add1061 = add i32 %tmp1059, %tmp1060           ; <i32> [#uses=1]
  %tmp1062 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.body1066:                                     ; preds = %for.cond1057
  ...
  %tmp1073 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.cond1075:                                     ; preds = %for.inc1123, %for.body1066
  %tmp1076 = load i32, i32* %i1072                     ; <i32> [#uses=1]
  %tmp1077 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.body1080:                                     ; preds = %for.cond1075
  %tmp1083 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.cond1085:                                     ; preds = %for.inc1119, %for.body1080
  %tmp1086 = load i32, i32* %j1082                     ; <i32> [#uses=1]
  %tmp1087 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.body1090:                                     ; preds = %for.cond1085
  %tmp1093 = load i32, i32* %row1042                   ; <i32> [#uses=1]
  %tmp1094 = load i32, i32* %i1072                     ; <i32> [#uses=1]
  %add1095 = add nsw i32 %tmp1093, %tmp1094       ; <i32> [#uses=1]
  store i32 %add1095, i32* %h1092
  %tmp1098 = load i32, i32* %column1053                ; <i32> [#uses=1]
  %tmp1099 = load i32, i32* %j1082                     ; <i32> [#uses=1]
  %add1100 = add nsw i32 %tmp1098, %tmp1099       ; <i32> [#uses=1]
  store i32 %add1100, i32* %w1097
  %tmp1101 = load i32, i32* %w1097                     ; <i32> [#uses=1]
  %tmp1102 = load i32, i32* %width.addr                ; <i32> [#uses=1]
...
for.inc1119:                                      ; preds = %if.end1108
  %tmp1120 = load i32, i32* %j1082                     ; <i32> [#uses=1]
...
for.inc1123:                                      ; preds = %for.end1122
  %tmp1124 = load i32, i32* %i1072                     ; <i32> [#uses=1]
  %inc1125 = add nsw i32 %tmp1124, 1              ; <i32> [#uses=1]
  store i32 %inc1125, i32* %i1072
  br label %for.cond1075

for.end1126:                                      ; preds = %for.cond1075
  %tmp1127 = load <4 x float>, <4 x float>* %colorAccumulator  ; <<4 x float>> [#uses=1]
  %tmp1128 = load float, float* %denominator             ; <float> [#uses=1]
  ...
  %tmp1134 = load i32, i32* %row1042                   ; <i32> [#uses=1]
  %tmp1135 = load i32, i32* %width.addr                ; <i32> [#uses=1]
...
for.inc1141:                                      ; preds = %for.end1126
  %tmp1142 = load i32, i32* %column1053                ; <i32> [#uses=1]
...
for.inc1145:                                      ; preds = %for.end1144
  %tmp1146 = load i32, i32* %row1042                   ; <i32> [#uses=1]
...
if.end1149:                                       ; preds = %for.end1148, %if.end1037
  %tmp1150 = load i8, i8* %bottomEdge                 ; <i8> [#uses=1]
...
land.lhs.true1153:                                ; preds = %if.end1149
  %tmp1154 = load i8, i8* %rightEdge                  ; <i8> [#uses=1]
...
if.then1157:                                      ; preds = %land.lhs.true1153
  %tmp1160 = load i32, i32* %index_y                   ; <i32> [#uses=1]
  %tmp1161 = load i32, i32* %count_y                   ; <i32> [#uses=1]
...
for.cond1163:                                     ; preds = %for.inc1274, %if.then1157
  %tmp1164 = load i32, i32* %row1159                   ; <i32> [#uses=1]
  %tmp1165 = load i32, i32* %index_y                   ; <i32> [#uses=1]
  %tmp1166 = load i32, i32* %count_y                   ; <i32> [#uses=1]
  %add1167 = add i32 %tmp1165, %tmp1166           ; <i32> [#uses=1]
  %tmp1168 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.body1172:                                     ; preds = %for.cond1163
  %tmp1175 = load i32, i32* %index_x                   ; <i32> [#uses=1]
  %tmp1176 = load i32, i32* %count_x                   ; <i32> [#uses=1]
...
for.cond1178:                                     ; preds = %for.inc1270, %for.body1172
  %tmp1179 = load i32, i32* %column1174                ; <i32> [#uses=1]
  %tmp1180 = load i32, i32* %index_x                   ; <i32> [#uses=1]
  %tmp1181 = load i32, i32* %count_x                   ; <i32> [#uses=1]
  %add1182 = add i32 %tmp1180, %tmp1181           ; <i32> [#uses=1]
  %tmp1183 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.body1187:                                     ; preds = %for.cond1178
  ...
  %tmp1194 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.cond1196:                                     ; preds = %for.inc1252, %for.body1187
  %tmp1197 = load i32, i32* %i1193                     ; <i32> [#uses=1]
  %tmp1198 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.body1201:                                     ; preds = %for.cond1196
  %tmp1204 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.cond1206:                                     ; preds = %for.inc1248, %for.body1201
  %tmp1207 = load i32, i32* %j1203                     ; <i32> [#uses=1]
  %tmp1208 = load i32, i32* %local_radius              ; <i32> [#uses=1]
...
for.body1211:                                     ; preds = %for.cond1206
  %tmp1214 = load i32, i32* %row1159                   ; <i32> [#uses=1]
  %tmp1215 = load i32, i32* %i1193                     ; <i32> [#uses=1]
  %add1216 = add nsw i32 %tmp1214, %tmp1215       ; <i32> [#uses=1]
  store i32 %add1216, i32* %h1213
  %tmp1219 = load i32, i32* %column1174                ; <i32> [#uses=1]
  %tmp1220 = load i32, i32* %j1203                     ; <i32> [#uses=1]
  %add1221 = add nsw i32 %tmp1219, %tmp1220       ; <i32> [#uses=1]
  store i32 %add1221, i32* %w1218
  %tmp1222 = load i32, i32* %h1213                     ; <i32> [#uses=1]
  %tmp1223 = load i32, i32* %height.addr               ; <i32> [#uses=1]
...
if.then1226:                                      ; preds = %for.body1211
  %tmp1227 = load i32, i32* %height.addr               ; <i32> [#uses=1]
  %sub1228 = sub i32 %tmp1227, 1                  ; <i32> [#uses=1]
  store i32 %sub1228, i32* %h1213
  br label %if.end1229

if.end1229:                                       ; preds = %if.then1226, %for.body1211
  %tmp1230 = load i32, i32* %w1218                     ; <i32> [#uses=1]
  %tmp1231 = load i32, i32* %width.addr                ; <i32> [#uses=1]
...
if.then1234:                                      ; preds = %if.end1229
  %tmp1235 = load i32, i32* %width.addr                ; <i32> [#uses=1]
  %sub1236 = sub i32 %tmp1235, 1                  ; <i32> [#uses=1]
  store i32 %sub1236, i32* %w1218
  br label %if.end1237

if.end1237:                                       ; preds = %if.then1234, %if.end1229
  %tmp1238 = load i32, i32* %h1213                     ; <i32> [#uses=1]
  %tmp1239 = load i32, i32* %width.addr                ; <i32> [#uses=1]
...
for.inc1248:                                      ; preds = %if.end1237
  %tmp1249 = load i32, i32* %j1203                     ; <i32> [#uses=1]
...
for.inc1252:                                      ; preds = %for.end1251
  %tmp1253 = load i32, i32* %i1193                     ; <i32> [#uses=1]
  %inc1254 = add nsw i32 %tmp1253, 1              ; <i32> [#uses=1]
  store i32 %inc1254, i32* %i1193
  br label %for.cond1196

for.end1255:                                      ; preds = %for.cond1196
  %tmp1256 = load <4 x float>, <4 x float>* %colorAccumulator  ; <<4 x float>> [#uses=1]
  %tmp1257 = load float, float* %denominator             ; <float> [#uses=1]
  ...
  %tmp1263 = load i32, i32* %row1159                   ; <i32> [#uses=1]
  %tmp1264 = load i32, i32* %width.addr                ; <i32> [#uses=1]
...
for.inc1270:                                      ; preds = %for.end1255
  %tmp1271 = load i32, i32* %column1174                ; <i32> [#uses=1]
...
for.inc1274:                                      ; preds = %for.end1273
  %tmp1275 = load i32, i32* %row1159                   ; <i32> [#uses=1]

...
; RUN: %oclopt  -predicate -specialize %t.bc -S -o %t1.ll
...
BB0322:                                           ; preds = %BB0321, %BB0326
  ...
  %arrayidx30.i = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp113 ; <float addrspace(1)*> [#uses=1]
  %tmp114 = add i32 %storemerge3.i, 3             ; <i32> [#uses=1]
  %arrayidx23.i = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp114 ; <float addrspace(1)*> [#uses=1]
  %tmp115 = add i32 %storemerge3.i, 2             ; <i32> [#uses=1]
  %arrayidx17.i = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp115 ; <float addrspace(1)*> [#uses=1]
  %tmp117 = add i32 %storemerge3.i, 1             ; <i32> [#uses=1]
  %arrayidx11.i = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp117 ; <float addrspace(1)*> [#uses=1]
  %arrayidx.i = getelementptr float, float addrspace(1)* %pSphereArray, i32 %storemerge3.i ; <float addrspace(1)*> [#uses=1]
  %tmp8.i = load float, float addrspace(1)* %arrayidx.i  ; <float> [#uses=1]
  %tmp12.i = load float, float addrspace(1)* %arrayidx11.i ; <float> [#uses=1]
  %tmp18.i = load float, float addrspace(1)* %arrayidx17.i ; <float> [#uses=1]
  %tmp24.i = load float, float addrspace(1)* %arrayidx23.i ; <float> [#uses=1]
  %tmp31.i = load float, float addrspace(1)* %arrayidx30.i ; <float> [#uses=2]
...
BB0328:                                           ; preds = %BB0327
  %arrayidx = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %sphereNum.0 ; <float addrspace(1)*> [#uses=1]
  %tmp67 = load float, float addrspace(1)* %arrayidx     ; <float> [#uses=1]
  %add70 = add nsw i32 %sphereNum.0, 1            ; <i32> [#uses=1]
  %arrayidx72 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add70 ; <float addrspace(1)*> [#uses=1]
  %tmp73 = load float, float addrspace(1)* %arrayidx72   ; <float> [#uses=1]
  %add76 = add nsw i32 %sphereNum.0, 2            ; <i32> [#uses=1]
  %arrayidx78 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add76 ; <float addrspace(1)*> [#uses=1]
  %tmp79 = load float, float addrspace(1)* %arrayidx78   ; <float> [#uses=1]
  %add82 = add nsw i32 %sphereNum.0, 3            ; <i32> [#uses=1]
  %arrayidx84 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add82 ; <float addrspace(1)*> [#uses=1]
  %tmp85 = load float, float addrspace(1)* %arrayidx84   ; <float> [#uses=1]
  %add89 = add nsw i32 %sphereNum.0, 4            ; <i32> [#uses=1]
  %arrayidx91 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add89 ; <float addrspace(1)*> [#uses=1]
  %tmp92 = load float, float addrspace(1)* %arrayidx91   ; <float> [#uses=4]
  %add95 = add nsw i32 %sphereNum.0, 5            ; <i32> [#uses=1]
  %arrayidx97 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add95 ; <float addrspace(1)*> [#uses=1]
  %tmp98 = load float, float addrspace(1)* %arrayidx97   ; <float> [#uses=2]
  %add101 = add nsw i32 %sphereNum.0, 6           ; <i32> [#uses=1]
  %arrayidx103 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add101 ; <float addrspace(1)*> [#uses=1]
  %tmp104 = load float, float addrspace(1)* %arrayidx103 ; <float> [#uses=2]
  %add107 = add nsw i32 %sphereNum.0, 7           ; <i32> [#uses=1]
  %arrayidx109 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add107 ; <float addrspace(1)*> [#uses=1]
  %tmp110 = load float, float addrspace(1)* %arrayidx109 ; <float> [#uses=2]
  %add113 = add nsw i32 %sphereNum.0, 8           ; <i32> [#uses=1]
  %arrayidx115 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add113 ; <float addrspace(1)*> [#uses=1]
  %tmp116 = load float, float addrspace(1)* %arrayidx115 ; <float> [#uses=2]
  %add121 = add nsw i32 %sphereNum.0, 9           ; <i32> [#uses=1]
  %arrayidx123 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add121 ; <float addrspace(1)*> [#uses=1]
  %tmp124 = load float, float addrspace(1)* %arrayidx123 ; <float> [#uses=1]
  %add127 = add nsw i32 %sphereNum.0, 10          ; <i32> [#uses=1]
  %arrayidx129 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add127 ; <float addrspace(1)*> [#uses=1]
  %tmp130 = load float, float addrspace(1)* %arrayidx129 ; <float> [#uses=1]
  %add133 = add nsw i32 %sphereNum.0, 11          ; <i32> [#uses=1]
  %arrayidx135 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add133 ; <float addrspace(1)*> [#uses=1]
  %tmp136 = load float, float addrspace(1)* %arrayidx135 ; <float> [#uses=1]
  %add139 = add nsw i32 %sphereNum.0, 12          ; <i32> [#uses=1]
  %arrayidx141 = getelementptr inbounds float, float addrspace(1)* %pSphereArray, i32 %add139 ; <float addrspace(1)*> [#uses=1]
  %tmp142 = load float, float addrspace(1)* %arrayidx141 ; <float> [#uses=5]
...
BB0330:                                           ; preds = %BB0329, %BB0334
  ...
  %arrayidx30.i15 = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp102 ; <float addrspace(1)*> [#uses=1]
  %tmp103 = add i32 %tmp, 3                       ; <i32> [#uses=1]
  %arrayidx23.i13 = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp103 ; <float addrspace(1)*> [#uses=1]
  %tmp105 = add i32 %tmp, 2                       ; <i32> [#uses=1]
  %arrayidx17.i11 = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp105 ; <float addrspace(1)*> [#uses=1]
  %tmp106 = add i32 %tmp, 1                       ; <i32> [#uses=1]
  %arrayidx11.i9 = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp106 ; <float addrspace(1)*> [#uses=1]
  %arrayidx.i7 = getelementptr float, float addrspace(1)* %pSphereArray, i32 %tmp ; <float addrspace(1)*> [#uses=1]
  %tmp8.i17 = load float, float addrspace(1)* %arrayidx.i7 ; <float> [#uses=1]
  %tmp12.i19 = load float, float addrspace(1)* %arrayidx11.i9 ; <float> [#uses=1]
  %tmp18.i21 = load float, float addrspace(1)* %arrayidx17.i11 ; <float> [#uses=1]
  %tmp24.i23 = load float, float addrspace(1)* %arrayidx23.i13 ; <float> [#uses=1]
  %tmp31.i25 = load float, float addrspace(1)* %arrayidx30.i15 ; <float> [#uses=2]
...
BB0340:                                           ; preds = %BB0339, %BB0337
  ...
  %tmp199 = load float, float addrspace(1)* @SPECULAR_EXPONENT ; <float> [#uses=1]

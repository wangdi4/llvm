...
; RUN: opt -std-compile-opts -inline-threshold=4096 -inline -lowerswitch -scalarize -mergereturn -loopsimplify -phicanon -predicate -specialize -mem2reg -dce -verify %t.bc -S -o %t1.ll

...
; This module was already processed by -std-link-opts -inline-threshold=4096 -inline -lowerswitch -mergereturn -loopsimplify passes
...
bb.nph75:
  ...
  %0 = getelementptr inbounds [8 x <4 x i32>]* %cmp, i64 0, i64 0
  %1 = getelementptr inbounds [8 x <4 x i32>]* %cmp, i64 0, i64 1
  %2 = getelementptr inbounds [8 x <4 x i32>]* %cmp, i64 0, i64 2
  %3 = getelementptr inbounds [8 x <4 x i32>]* %cmp, i64 0, i64 3
  %4 = getelementptr inbounds [8 x <4 x i32>]* %cmp, i64 0, i64 4
  %5 = getelementptr inbounds [8 x <4 x i32>]* %cmp, i64 0, i64 5
  %6 = getelementptr inbounds [8 x <4 x i32>]* %cmp, i64 0, i64 6
  %7 = getelementptr inbounds [8 x <4 x i32>]* %cmp, i64 0, i64 7
...
bb.nph72:                                         ; preds = %._crit_edge73, %bb.nph75
  ...
  %scevgep299 = getelementptr float addrspace(1)* %str1, i64 %tmp165170
  %tmp166171 = or i64 %tmp164, 2
  %scevgep297 = getelementptr float addrspace(1)* %str1, i64 %tmp166171
  %tmp167172 = or i64 %tmp164, 3
  %scevgep295 = getelementptr float addrspace(1)* %str1, i64 %tmp167172
  %scevgep300 = getelementptr float addrspace(1)* %str1, i64 %tmp164
...
; <label>:24                                      ; preds = %._crit_edge, %bb.nph72
  ...
  %scevgep236 = getelementptr float addrspace(1)* %str2, i64 %tmp123
...
; <label>:35                                      ; preds = %._crit_edge315, %bb.nph65
  ...
  %scevgep92 = getelementptr [48 x i32]* %cmp_id, i64 0, i64 %tmp18
  %tmp19 = add i64 %tmp17, 18
  %scevgep90 = getelementptr [48 x i32]* %cmp_id, i64 0, i64 %tmp19
  %tmp20 = add i64 %tmp17, 17
  %scevgep88 = getelementptr [48 x i32]* %cmp_id, i64 0, i64 %tmp20
  %tmp21 = add i64 %tmp17, 16
  %scevgep86 = getelementptr [48 x i32]* %cmp_id, i64 0, i64 %tmp21
...
._crit_edge315:                                   ; preds = %35
  ...
  %scevgep93.phi.trans.insert = getelementptr [8 x <4 x i32>]* %cmp, i64 0, i64 %tmp16
...
; <label>:49                                      ; preds = %._crit_edge314, %bb.nph68
  ...
  %scevgep105 = getelementptr [48 x i32]* %cmp_id, i64 0, i64 %tmp9
  %tmp10 = add i64 %tmp8, 18
  %scevgep103 = getelementptr [48 x i32]* %cmp_id, i64 0, i64 %tmp10
  %tmp11 = add i64 %tmp8, 17
  %scevgep101 = getelementptr [48 x i32]* %cmp_id, i64 0, i64 %tmp11
  %tmp12 = add i64 %tmp8, 16
  %scevgep99 = getelementptr [48 x i32]* %cmp_id, i64 0, i64 %tmp12
...
._crit_edge314:                                   ; preds = %49
  ...
  %scevgep106.phi.trans.insert = getelementptr [8 x <4 x i32>]* %cmp, i64 0, i64 %tmp
...
; <label>:63                                      ; preds = %152, %bb.nph70
  ...
  %scevgep181 = getelementptr i32 addrspace(1)* %C, i64 %tmp127
  %tmp130 = add i64 %tmp129, %indvar
  %scevgep177 = getelementptr i32 addrspace(1)* %C, i64 %tmp130
  %tmp133 = add i64 %tmp132, %indvar
  %scevgep173 = getelementptr i32 addrspace(1)* %C, i64 %tmp133
  %tmp136 = add i64 %tmp135, %indvar
  %scevgep169 = getelementptr i32 addrspace(1)* %C, i64 %tmp136
  %tmp139 = add i64 %tmp138, %indvar
  %scevgep165 = getelementptr i32 addrspace(1)* %C, i64 %tmp139
  %tmp142 = add i64 %tmp141, %indvar
  %scevgep161 = getelementptr i32 addrspace(1)* %C, i64 %tmp142
  %tmp145 = add i64 %tmp144, %indvar
  %scevgep157 = getelementptr i32 addrspace(1)* %C, i64 %tmp145
  %tmp148 = add i64 %tmp147, %indvar
  %scevgep153 = getelementptr i32 addrspace(1)* %C, i64 %tmp148
  %tmp151 = add i64 %tmp150, %indvar
  %scevgep149 = getelementptr i32 addrspace(1)* %C, i64 %tmp151
  %tmp154 = add i64 %tmp153, %indvar
  %scevgep145 = getelementptr i32 addrspace(1)* %C, i64 %tmp154
  %tmp157 = add i64 %tmp156, %indvar
  %scevgep141 = getelementptr i32 addrspace(1)* %C, i64 %tmp157
  %tmp160 = add i64 %tmp159, %indvar
  %scevgep137 = getelementptr i32 addrspace(1)* %C, i64 %tmp160
  %tmp163 = add i64 %tmp162, %indvar
  %scevgep133 = getelementptr i32 addrspace(1)* %C, i64 %tmp163
  %tmp67 = shl i64 %indvar, 2
  %tmp69173 = or i64 %tmp67, 3
  %scevgep123 = getelementptr [32 x i32]* @Lcs.iterator_cmp, i64 0, i64 %tmp69173
  %tmp70174 = or i64 %tmp67, 2
  %scevgep121 = getelementptr [32 x i32]* @Lcs.iterator_cmp, i64 0, i64 %tmp70174
  %tmp71175 = or i64 %tmp67, 1
  %scevgep119 = getelementptr [32 x i32]* @Lcs.iterator_cmp, i64 0, i64 %tmp71175
  %tmp72 = add i64 %tmp67, 17
  %scevgep114 = getelementptr [32 x i32]* @Lcs.iterator_cmp, i64 0, i64 %tmp72
  %tmp73 = add i64 %tmp67, 18
  %scevgep112 = getelementptr [32 x i32]* @Lcs.iterator_cmp, i64 0, i64 %tmp73
  %tmp74 = add i64 %tmp67, 19
  %scevgep110 = getelementptr [32 x i32]* @Lcs.iterator_cmp, i64 0, i64 %tmp74
  %64 = load i32 addrspace(1)* %scevgep133, align 4
  %65 = add nsw i32 %64, 1
  %66 = load i32 addrspace(1)* %scevgep137, align 4
  %67 = add nsw i32 %66, 1
  %68 = load i32 addrspace(1)* %scevgep141, align 4
  %69 = add nsw i32 %68, 1
  %70 = load i32 addrspace(1)* %scevgep145, align 4
  %71 = add nsw i32 %70, 1
  %72 = load i32 addrspace(1)* %scevgep149, align 4
  %73 = insertelement <4 x i32> undef, i32 %72, i32 0
  %74 = load i32 addrspace(1)* %scevgep153, align 4
  %75 = insertelement <4 x i32> %73, i32 %74, i32 1
  %76 = load i32 addrspace(1)* %scevgep157, align 4
  %77 = insertelement <4 x i32> %75, i32 %76, i32 2
  %78 = load i32 addrspace(1)* %scevgep161, align 4
  %79 = insertelement <4 x i32> %77, i32 %78, i32 3
  %80 = load i32 addrspace(1)* %scevgep165, align 4
...
; <label>:86                                      ; preds = %63
  %scevgep117 = getelementptr [32 x i32]* @Lcs.iterator_cmp, i64 0, i64 %tmp67
  %87 = load i32* %scevgep117, align 4
  %88 = sext i32 %87 to i64
  %89 = getelementptr inbounds [48 x i32]* %cmp_id, i64 0, i64 %88
...
; <label>:94                                      ; preds = %92, %86
  ...
  %95 = load i32* %scevgep119, align 4
  %96 = sext i32 %95 to i64
  %97 = getelementptr inbounds [48 x i32]* %cmp_id, i64 0, i64 %96
...
; <label>:102                                     ; preds = %100, %94
  ...
  %103 = load i32* %scevgep121, align 4
  %104 = sext i32 %103 to i64
  %105 = getelementptr inbounds [48 x i32]* %cmp_id, i64 0, i64 %104
...
; <label>:110                                     ; preds = %108, %102
  ...
  %111 = load i32* %scevgep123, align 4
  %112 = sext i32 %111 to i64
  %113 = getelementptr inbounds [48 x i32]* %cmp_id, i64 0, i64 %112
...
; <label>:119                                     ; preds = %63
  ...
  %scevgep116 = getelementptr [32 x i32]* @Lcs.iterator_cmp, i64 0, i64 %tmp68
  %120 = load i32* %scevgep116, align 4
  %121 = sext i32 %120 to i64
  %122 = getelementptr inbounds [48 x i32]* %cmp_id, i64 0, i64 %121
...
; <label>:127                                     ; preds = %125, %119
  ...
  %128 = load i32* %scevgep114, align 4
  %129 = sext i32 %128 to i64
  %130 = getelementptr inbounds [48 x i32]* %cmp_id, i64 0, i64 %129
...
; <label>:135                                     ; preds = %133, %127
  ...
  %136 = load i32* %scevgep112, align 4
  %137 = sext i32 %136 to i64
  %138 = getelementptr inbounds [48 x i32]* %cmp_id, i64 0, i64 %137
...
; <label>:143                                     ; preds = %141, %135
  ...
  %144 = load i32* %scevgep110, align 4
  %145 = sext i32 %144 to i64
  %146 = getelementptr inbounds [48 x i32]* %cmp_id, i64 0, i64 %145

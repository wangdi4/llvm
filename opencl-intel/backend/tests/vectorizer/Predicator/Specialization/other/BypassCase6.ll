...
; CHECK: ret
define void @BypassCase6(i32 %arg1, i32 %arg2, float addrspace(1)* nocapture %a, float addrspace(1)* nocapture %b) nounwind {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %cmp6 = fcmp ogt float %mul, 5.000000e+001
...
if.else:                                          ; preds = %if.then
  ...
  %cmp7 = fcmp ogt float %div, 100.000000e+001

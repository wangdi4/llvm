...
; RUN: %oclopt  -O3 -loopopt -inline-threshold=4096 -inline -lowerswitch -mergereturn -loop-simplify -phicanon -predicate -specialize -verify %t.bc -S -o %t1.ll
...
entry:
	...
	%tmp = load <4 x i32>, <4 x i32>* %seed.addr		; <<4 x i32>> [#uses=1]
	...
	%tmp8 = load i32, i32* %stateMask		; <i32> [#uses=1]
	...
	%tmp11 = load i32, i32* %thirty		; <i32> [#uses=1]
	...
	%tmp39 = load <4 x i32>, <4 x i32>* %mask4		; <<4 x i32>> [#uses=1]
	%tmp40 = load <4 x i32>, <4 x i32>* %state1		; <<4 x i32>> [#uses=1]
	%tmp41 = load <4 x i32>, <4 x i32>* %state1		; <<4 x i32>> [#uses=1]
	%tmp42 = load <4 x i32>, <4 x i32>* %thirty4		; <<4 x i32>> [#uses=1]
	...
	%tmp43 = load <4 x i32>, <4 x i32>* %one4		; <<4 x i32>> [#uses=1]
	%add = add <4 x i32> %mul, %tmp43		; <<4 x i32>> [#uses=1]
	store <4 x i32> %add, <4 x i32>* %state2
	%tmp44 = load <4 x i32>, <4 x i32>* %mask4		; <<4 x i32>> [#uses=1]
	%tmp45 = load <4 x i32>, <4 x i32>* %state2		; <<4 x i32>> [#uses=1]
	%tmp46 = load <4 x i32>, <4 x i32>* %state2		; <<4 x i32>> [#uses=1]
	%tmp47 = load <4 x i32>, <4 x i32>* %thirty4		; <<4 x i32>> [#uses=1]
	...
	%tmp52 = load <4 x i32>, <4 x i32>* %two4		; <<4 x i32>> [#uses=1]
	%add53 = add <4 x i32> %mul51, %tmp52		; <<4 x i32>> [#uses=1]
	store <4 x i32> %add53, <4 x i32>* %state3
	%tmp54 = load <4 x i32>, <4 x i32>* %mask4		; <<4 x i32>> [#uses=1]
	%tmp55 = load <4 x i32>, <4 x i32>* %state3		; <<4 x i32>> [#uses=1]
	%tmp56 = load <4 x i32>, <4 x i32>* %state3		; <<4 x i32>> [#uses=1]
	%tmp57 = load <4 x i32>, <4 x i32>* %thirty4		; <<4 x i32>> [#uses=1]
	...
	%tmp62 = load <4 x i32>, <4 x i32>* %three4		; <<4 x i32>> [#uses=1]
	%add63 = add <4 x i32> %mul61, %tmp62		; <<4 x i32>> [#uses=1]
	store <4 x i32> %add63, <4 x i32>* %state4
	%tmp64 = load <4 x i32>, <4 x i32>* %mask4		; <<4 x i32>> [#uses=1]
	%tmp65 = load <4 x i32>, <4 x i32>* %state4		; <<4 x i32>> [#uses=1]
	%tmp66 = load <4 x i32>, <4 x i32>* %state4		; <<4 x i32>> [#uses=1]
	%tmp67 = load <4 x i32>, <4 x i32>* %thirty4		; <<4 x i32>> [#uses=1]
	...
	%tmp72 = load <4 x i32>, <4 x i32>* %four4		; <<4 x i32>> [#uses=1]
...
for.cond:		; preds = %for.inc, %entry
	%tmp75 = load i32, i32* %i		; <i32> [#uses=1]
	%tmp76 = load i32, i32* %mulFactor		; <i32> [#uses=1]
...
sw.bb:		; preds = %for.body
	%tmp78 = load <4 x i32>, <4 x i32>* %state4		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp78, <4 x i32>* %r1
	%tmp79 = load <4 x i32>, <4 x i32>* %state5		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp79, <4 x i32>* %r2
	%tmp80 = load <4 x i32>, <4 x i32>* %state1		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp80, <4 x i32>* %a
	%tmp81 = load <4 x i32>, <4 x i32>* %state3		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp81, <4 x i32>* %b
	br label %sw.epilog

sw.bb82:		; preds = %for.body
	%tmp83 = load <4 x i32>, <4 x i32>* %r2		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp83, <4 x i32>* %r1
	%arraydecay = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx = getelementptr <4 x i32>, <4 x i32>* %arraydecay, i32 0		; <<4 x i32>*> [#uses=1]
	%tmp84 = load <4 x i32>, <4 x i32>* %arrayidx		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp84, <4 x i32>* %r2
	%tmp85 = load <4 x i32>, <4 x i32>* %state2		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp85, <4 x i32>* %a
	%tmp86 = load <4 x i32>, <4 x i32>* %state4		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp86, <4 x i32>* %b
	br label %sw.epilog

sw.bb87:		; preds = %for.body
	%tmp88 = load <4 x i32>, <4 x i32>* %r2		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp88, <4 x i32>* %r1
	%arraydecay89 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx90 = getelementptr <4 x i32>, <4 x i32>* %arraydecay89, i32 1		; <<4 x i32>*> [#uses=1]
	%tmp91 = load <4 x i32>, <4 x i32>* %arrayidx90		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp91, <4 x i32>* %r2
	%tmp92 = load <4 x i32>, <4 x i32>* %state3		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp92, <4 x i32>* %a
	%tmp93 = load <4 x i32>, <4 x i32>* %state5		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp93, <4 x i32>* %b
	br label %sw.epilog

sw.bb94:		; preds = %for.body
	%tmp95 = load <4 x i32>, <4 x i32>* %r2		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp95, <4 x i32>* %r1
	%arraydecay96 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx97 = getelementptr <4 x i32>, <4 x i32>* %arraydecay96, i32 2		; <<4 x i32>*> [#uses=1]
	%tmp98 = load <4 x i32>, <4 x i32>* %arrayidx97		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp98, <4 x i32>* %r2
	%tmp99 = load <4 x i32>, <4 x i32>* %state4		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp99, <4 x i32>* %a
	%tmp100 = load <4 x i32>, <4 x i32>* %state1		; <<4 x i32>> [#uses=1]
...
for.end:		; preds = %for.cond
	...
	%arraydecay218 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx219 = getelementptr <4 x i32>, <4 x i32>* %arraydecay218, i32 0		; <<4 x i32>*> [#uses=1]
	%tmp220 = load <4 x i32>, <4 x i32>* %arrayidx219		; <<4 x i32>> [#uses=1]
	...
	%arraydecay223 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx224 = getelementptr <4 x i32>, <4 x i32>* %arraydecay223, i32 0		; <<4 x i32>*> [#uses=1]
	%tmp225 = load <4 x i32>, <4 x i32>* %arrayidx224		; <<4 x i32>> [#uses=1]
	...
	%arraydecay228 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx229 = getelementptr <4 x i32>, <4 x i32>* %arraydecay228, i32 0		; <<4 x i32>*> [#uses=1]
	%tmp230 = load <4 x i32>, <4 x i32>* %arrayidx229		; <<4 x i32>> [#uses=1]
	...
	%tmp233 = load <4 x float>, <4 x float>* %tmpValue1		; <<4 x float>> [#uses=1]
	%tmp234 = load float, float* %one		; <float> [#uses=1]
	...
	%tmp238 = load float, float* %intMax		; <float> [#uses=1]
	...
	%arraydecay242 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx243 = getelementptr <4 x i32>, <4 x i32>* %arraydecay242, i32 1		; <<4 x i32>*> [#uses=1]
	%tmp244 = load <4 x i32>, <4 x i32>* %arrayidx243		; <<4 x i32>> [#uses=1]
	...
	%arraydecay247 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx248 = getelementptr <4 x i32>, <4 x i32>* %arraydecay247, i32 1		; <<4 x i32>*> [#uses=1]
	%tmp249 = load <4 x i32>, <4 x i32>* %arrayidx248		; <<4 x i32>> [#uses=1]
	...
	%arraydecay252 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx253 = getelementptr <4 x i32>, <4 x i32>* %arraydecay252, i32 1		; <<4 x i32>*> [#uses=1]
	%tmp254 = load <4 x i32>, <4 x i32>* %arrayidx253		; <<4 x i32>> [#uses=1]
	...
	%arraydecay257 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx258 = getelementptr <4 x i32>, <4 x i32>* %arraydecay257, i32 1		; <<4 x i32>*> [#uses=1]
	%tmp259 = load <4 x i32>, <4 x i32>* %arrayidx258		; <<4 x i32>> [#uses=1]
	...
	%tmp262 = load <4 x float>, <4 x float>* %tmpValue2		; <<4 x float>> [#uses=1]
	%tmp263 = load float, float* %one		; <float> [#uses=1]
	...
	%tmp267 = load float, float* %intMax		; <float> [#uses=1]
	...
	%tmp271 = load float, float* %two		; <float> [#uses=1]
	...
	%tmp274 = load <4 x float>, <4 x float>* %temp1		; <<4 x float>> [#uses=1]
	...
	%tmp277 = load float, float* %two		; <float> [#uses=1]
	%tmp278 = load float, float* %PI		; <float> [#uses=1]
	...
	%tmp282 = load <4 x float>, <4 x float>* %temp2		; <<4 x float>> [#uses=1]
	%mul283 = fmul <4 x float> %splat281, %tmp282		; <<4 x float>> [#uses=1]
	store <4 x float> %mul283, <4 x float>* %phi
	%tmp284 = load <4 x float>*, <4 x float>** %gaussianRand1.addr		; <<4 x float>*> [#uses=1]
	%tmp285 = load <4 x float>, <4 x float>* %r		; <<4 x float>> [#uses=1]
	%tmp286 = load <4 x float>, <4 x float>* %phi		; <<4 x float>> [#uses=1]
	...
	%tmp289 = load <4 x float>*, <4 x float>** %gaussianRand2.addr		; <<4 x float>*> [#uses=1]
	%tmp290 = load <4 x float>, <4 x float>* %r		; <<4 x float>> [#uses=1]
	%tmp291 = load <4 x float>, <4 x float>* %phi		; <<4 x float>> [#uses=1]
	...
	%tmp294 = load <4 x i32>*, <4 x i32>** %nextRand.addr		; <<4 x i32>*> [#uses=1]
	%arraydecay295 = getelementptr [8 x <4 x i32>], [8 x <4 x i32>]* %temp, i32 0, i32 0		; <<4 x i32>*> [#uses=1]
	%arrayidx296 = getelementptr <4 x i32>, <4 x i32>* %arraydecay295, i32 2		; <<4 x i32>*> [#uses=1]
	%tmp297 = load <4 x i32>, <4 x i32>* %arrayidx296		; <<4 x i32>> [#uses=1]
...
if.end24:		; preds = %if.then17, %if.end
	%tmp25 = load <4 x float>, <4 x float>* %tempDiff1		; <<4 x float>> [#uses=1]
...
if.end35:		; preds = %if.then28, %if.end24
	%tmp36 = load <4 x float>, <4 x float>* %tempDiff1		; <<4 x float>> [#uses=1]
...
if.end46:		; preds = %if.then39, %if.end35
	%tmp47 = load <4 x float>, <4 x float>* %tempDiff2		; <<4 x float>> [#uses=1]
...
if.end57:		; preds = %if.then50, %if.end46
	%tmp58 = load <4 x float>, <4 x float>* %tempDiff2		; <<4 x float>> [#uses=1]
...
if.end68:		; preds = %if.then61, %if.end57
	%tmp69 = load <4 x float>, <4 x float>* %tempDiff2		; <<4 x float>> [#uses=1]
...
if.end79:		; preds = %if.then72, %if.end68
	%tmp80 = load <4 x float>, <4 x float>* %tempDiff2		; <<4 x float>> [#uses=1]
...
if.end90:		; preds = %if.then83, %if.end79
	%tmp91 = load <4 x float>*, <4 x float>** %pathDeriv1.addr		; <<4 x float>*> [#uses=1]
	%tmp92 = load <4 x float>, <4 x float>* %meanDeriv1.addr		; <<4 x float>> [#uses=1]
	%tmp93 = load <4 x float>, <4 x float>* %temp1		; <<4 x float>> [#uses=1]
	%mul = fmul <4 x float> %tmp92, %tmp93		; <<4 x float>> [#uses=1]
	store <4 x float> %mul, <4 x float>* %tmp91
	%tmp94 = load <4 x float>*, <4 x float>** %pathDeriv2.addr		; <<4 x float>*> [#uses=1]
	%tmp95 = load <4 x float>, <4 x float>* %meanDeriv2.addr		; <<4 x float>> [#uses=1]
	%tmp96 = load <4 x float>, <4 x float>* %temp2		; <<4 x float>> [#uses=1]
	%mul97 = fmul <4 x float> %tmp95, %tmp96		; <<4 x float>> [#uses=1]
	store <4 x float> %mul97, <4 x float>* %tmp94
	%tmp98 = load <4 x float>*, <4 x float>** %priceVec1.addr		; <<4 x float>*> [#uses=1]
	%tmp99 = load <4 x float>, <4 x float>* %temp3		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp99, <4 x float>* %tmp98
	%tmp100 = load <4 x float>*, <4 x float>** %priceVec2.addr		; <<4 x float>*> [#uses=1]
	%tmp101 = load <4 x float>, <4 x float>* %temp4		; <<4 x float>> [#uses=1]
...
entry:
	...
	%tmp = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %attrib.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp, i32 0		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp1 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp1, <4 x float>* %strikePrice
	%tmp3 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %attrib.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx4 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp3, i32 1		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp5 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx4		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp5, <4 x float>* %c1
	%tmp7 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %attrib.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx8 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp7, i32 2		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp9 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx8		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp9, <4 x float>* %c2
	%tmp11 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %attrib.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx12 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp11, i32 3		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp13 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx12		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp13, <4 x float>* %c3
	%tmp15 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %attrib.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx16 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp15, i32 4		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp17 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx16		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp17, <4 x float>* %initPrice
	%tmp19 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %attrib.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx20 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp19, i32 5		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp21 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx20		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp21, <4 x float>* %sigma
	%tmp23 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %attrib.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx24 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp23, i32 6		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp25 = load <4 x float>, <4 x float> addrspace(1)* %arrayidx24		; <<4 x float>> [#uses=1]
	...
	%tmp35 = load <4 x float>, <4 x float>* %initPrice		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp35, <4 x float>* %trajPrice1
	%tmp37 = load <4 x float>, <4 x float>* %initPrice		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp37, <4 x float>* %trajPrice2
	%tmp39 = load <4 x float>, <4 x float>* %initPrice		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp39, <4 x float>* %sumPrice1
	%tmp41 = load <4 x float>, <4 x float>* %initPrice		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp41, <4 x float>* %sumPrice2
	%tmp43 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp43, <4 x float>* %meanPrice1
	%tmp45 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp45, <4 x float>* %meanPrice2
	%tmp47 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp47, <4 x float>* %sumDeriv1
	%tmp49 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp49, <4 x float>* %sumDeriv2
	%tmp51 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp51, <4 x float>* %meanDeriv1
	%tmp53 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp53, <4 x float>* %meanDeriv2
	%tmp55 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp55, <4 x float>* %finalRandf1
	%tmp57 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp57, <4 x float>* %finalRandf2
	%tmp59 = load i32, i32* %yPos		; <i32> [#uses=1]
	%tmp60 = load i32, i32* %width.addr		; <i32> [#uses=1]
	%mul = mul i32 %tmp59, %tmp60		; <i32> [#uses=1]
	%tmp61 = load i32, i32* %xPos		; <i32> [#uses=1]
	%add = add i32 %mul, %tmp61		; <i32> [#uses=1]
	%tmp62 = load <4 x i32> addrspace(1)*, <4 x i32> addrspace(1)** %randArray.addr		; <<4 x i32> addrspace(1)*> [#uses=1]
	%arrayidx63 = getelementptr <4 x i32>, <4 x i32> addrspace(1)* %tmp62, i32 %add		; <<4 x i32> addrspace(1)*> [#uses=1]
	%tmp64 = load <4 x i32>, <4 x i32> addrspace(1)* %arrayidx63		; <<4 x i32>> [#uses=1]
...
for.cond:		; preds = %for.inc, %entry
	...
	%tmp67 = load i32, i32* %noOfSum.addr		; <i32> [#uses=1]
	%cmp = icmp slt i32 %tmp66, %tmp67		; <i1> [#uses=1]
	br i1 %cmp, label %for.body, label %for.end

for.body:		; preds = %for.cond
	%tmp69 = load <4 x i32>, <4 x i32>* %nextRand		; <<4 x i32>> [#uses=1]
	store <4 x i32> %tmp69, <4 x i32>* %tempRand
	%tmp70 = load <4 x i32>, <4 x i32>* %tempRand		; <<4 x i32>> [#uses=1]
	call void @generateRand(<4 x i32> %tmp70, <4 x float>* %finalRandf1, <4 x float>* %finalRandf2, <4 x i32>* %nextRand)
	%tmp71 = load <4 x float>, <4 x float>* %trajPrice1		; <<4 x float>> [#uses=1]
	%tmp72 = load <4 x float>, <4 x float>* %c1		; <<4 x float>> [#uses=1]
	%tmp73 = load <4 x float>, <4 x float>* %c2		; <<4 x float>> [#uses=1]
	%tmp74 = load <4 x float>, <4 x float>* %finalRandf1		; <<4 x float>> [#uses=1]
	...
	%tmp79 = load <4 x float>, <4 x float>* %trajPrice2		; <<4 x float>> [#uses=1]
	%tmp80 = load <4 x float>, <4 x float>* %c1		; <<4 x float>> [#uses=1]
	%tmp81 = load <4 x float>, <4 x float>* %c2		; <<4 x float>> [#uses=1]
	%tmp82 = load <4 x float>, <4 x float>* %finalRandf2		; <<4 x float>> [#uses=1]
	...
	%tmp87 = load <4 x float>, <4 x float>* %sumPrice1		; <<4 x float>> [#uses=1]
	%tmp88 = load <4 x float>, <4 x float>* %trajPrice1		; <<4 x float>> [#uses=1]
	%add89 = fadd <4 x float> %tmp87, %tmp88		; <<4 x float>> [#uses=1]
	store <4 x float> %add89, <4 x float>* %sumPrice1
	%tmp90 = load <4 x float>, <4 x float>* %sumPrice2		; <<4 x float>> [#uses=1]
	%tmp91 = load <4 x float>, <4 x float>* %trajPrice2		; <<4 x float>> [#uses=1]
	%add92 = fadd <4 x float> %tmp90, %tmp91		; <<4 x float>> [#uses=1]
	store <4 x float> %add92, <4 x float>* %sumPrice2
	%tmp93 = load <4 x float>, <4 x float>* %c3		; <<4 x float>> [#uses=1]
	%tmp94 = load <4 x float>, <4 x float>* %timeStep		; <<4 x float>> [#uses=1]
	%mul95 = fmul <4 x float> %tmp93, %tmp94		; <<4 x float>> [#uses=1]
	%tmp96 = load i32, i32* %i		; <i32> [#uses=1]
	...
	%tmp99 = load <4 x float>, <4 x float>* %sumDeriv1		; <<4 x float>> [#uses=1]
	%tmp100 = load <4 x float>, <4 x float>* %trajPrice1		; <<4 x float>> [#uses=1]
	%tmp101 = load <4 x float>, <4 x float>* %trajPrice1		; <<4 x float>> [#uses=1]
	%tmp102 = load <4 x float>, <4 x float>* %initPrice		; <<4 x float>> [#uses=1]
	%div = fdiv <4 x float> %tmp101, %tmp102		; <<4 x float>> [#uses=1]
	%call103 = call <4 x float> @__logf4(<4 x float> %div)		; <<4 x float>> [#uses=1]
	%tmp104 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	%sub = fsub <4 x float> %call103, %tmp104		; <<4 x float>> [#uses=1]
	%tmp105 = load <4 x float>, <4 x float>* %sigma		; <<4 x float>> [#uses=1]
	...
	%tmp109 = load <4 x float>, <4 x float>* %sumDeriv2		; <<4 x float>> [#uses=1]
	%tmp110 = load <4 x float>, <4 x float>* %trajPrice2		; <<4 x float>> [#uses=1]
	%tmp111 = load <4 x float>, <4 x float>* %trajPrice2		; <<4 x float>> [#uses=1]
	%tmp112 = load <4 x float>, <4 x float>* %initPrice		; <<4 x float>> [#uses=1]
	%div113 = fdiv <4 x float> %tmp111, %tmp112		; <<4 x float>> [#uses=1]
	%call114 = call <4 x float> @__logf4(<4 x float> %div113)		; <<4 x float>> [#uses=1]
	%tmp115 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	%sub116 = fsub <4 x float> %call114, %tmp115		; <<4 x float>> [#uses=1]
	%tmp117 = load <4 x float>, <4 x float>* %sigma		; <<4 x float>> [#uses=1]
...
for.inc:		; preds = %for.body
	%tmp121 = load i32, i32* %i		; <i32> [#uses=1]
	%inc = add i32 %tmp121, 1		; <i32> [#uses=1]
	store i32 %inc, i32* %i
	br label %for.cond

for.end:		; preds = %for.cond
	%tmp122 = load <4 x float>, <4 x float>* %sumPrice1		; <<4 x float>> [#uses=1]
	%tmp123 = load i32, i32* %noOfSum.addr		; <i32> [#uses=1]
	...
	%tmp128 = load <4 x float>, <4 x float>* %sumPrice2		; <<4 x float>> [#uses=1]
	%tmp129 = load i32, i32* %noOfSum.addr		; <i32> [#uses=1]
	...
	%tmp134 = load <4 x float>, <4 x float>* %sumDeriv1		; <<4 x float>> [#uses=1]
	%tmp135 = load i32, i32* %noOfSum.addr		; <i32> [#uses=1]
	...
	%tmp140 = load <4 x float>, <4 x float>* %sumDeriv2		; <<4 x float>> [#uses=1]
	%tmp141 = load i32, i32* %noOfSum.addr		; <i32> [#uses=1]
	...
	%tmp146 = load <4 x float>, <4 x float>* %strikePrice		; <<4 x float>> [#uses=1]
	%tmp147 = load <4 x float>, <4 x float>* %meanDeriv1		; <<4 x float>> [#uses=1]
	%tmp148 = load <4 x float>, <4 x float>* %meanDeriv2		; <<4 x float>> [#uses=1]
	%tmp149 = load <4 x float>, <4 x float>* %meanPrice1		; <<4 x float>> [#uses=1]
	%tmp150 = load <4 x float>, <4 x float>* %meanPrice2		; <<4 x float>> [#uses=1]
	...
	%tmp151 = load i32, i32* %yPos		; <i32> [#uses=1]
	%tmp152 = load i32, i32* %width.addr		; <i32> [#uses=1]
	%mul153 = mul i32 %tmp151, %tmp152		; <i32> [#uses=1]
	%tmp154 = load i32, i32* %xPos		; <i32> [#uses=1]
	%add155 = add i32 %mul153, %tmp154		; <i32> [#uses=1]
	%mul156 = mul i32 %add155, 2		; <i32> [#uses=1]
	%tmp157 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %priceSamples.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx158 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp157, i32 %mul156		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp159 = load <4 x float>, <4 x float>* %price1		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp159, <4 x float> addrspace(1)* %arrayidx158
	%tmp160 = load i32, i32* %yPos		; <i32> [#uses=1]
	%tmp161 = load i32, i32* %width.addr		; <i32> [#uses=1]
	%mul162 = mul i32 %tmp160, %tmp161		; <i32> [#uses=1]
	%tmp163 = load i32, i32* %xPos		; <i32> [#uses=1]
	%add164 = add i32 %mul162, %tmp163		; <i32> [#uses=1]
	%mul165 = mul i32 %add164, 2		; <i32> [#uses=1]
	%add166 = add i32 %mul165, 1		; <i32> [#uses=1]
	%tmp167 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %priceSamples.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx168 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp167, i32 %add166		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp169 = load <4 x float>, <4 x float>* %price2		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp169, <4 x float> addrspace(1)* %arrayidx168
	%tmp170 = load i32, i32* %yPos		; <i32> [#uses=1]
	%tmp171 = load i32, i32* %width.addr		; <i32> [#uses=1]
	%mul172 = mul i32 %tmp170, %tmp171		; <i32> [#uses=1]
	%tmp173 = load i32, i32* %xPos		; <i32> [#uses=1]
	%add174 = add i32 %mul172, %tmp173		; <i32> [#uses=1]
	%mul175 = mul i32 %add174, 2		; <i32> [#uses=1]
	%tmp176 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %pathDeriv.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx177 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp176, i32 %mul175		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp178 = load <4 x float>, <4 x float>* %pathDeriv1		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp178, <4 x float> addrspace(1)* %arrayidx177
	%tmp179 = load i32, i32* %yPos		; <i32> [#uses=1]
	%tmp180 = load i32, i32* %width.addr		; <i32> [#uses=1]
	%mul181 = mul i32 %tmp179, %tmp180		; <i32> [#uses=1]
	%tmp182 = load i32, i32* %xPos		; <i32> [#uses=1]
	%add183 = add i32 %mul181, %tmp182		; <i32> [#uses=1]
	%mul184 = mul i32 %add183, 2		; <i32> [#uses=1]
	%add185 = add i32 %mul184, 1		; <i32> [#uses=1]
	%tmp186 = load <4 x float> addrspace(1)*, <4 x float> addrspace(1)** %pathDeriv.addr		; <<4 x float> addrspace(1)*> [#uses=1]
	%arrayidx187 = getelementptr <4 x float>, <4 x float> addrspace(1)* %tmp186, i32 %add185		; <<4 x float> addrspace(1)*> [#uses=1]
	%tmp188 = load <4 x float>, <4 x float>* %pathDeriv2		; <<4 x float>> [#uses=1]

...
; RUN: %oclopt -presucf=false -O3 -inline-threshold=4096 -inline -lowerswitch -mergereturn -loop-simplify -phicanon -predicate -specialize -verify %t.bc -S -o %t1.ll
...
entry:
	...
	%tmp = load i32, i32* %localIdy		; <i32> [#uses=1]
	%tmp4 = load i32, i32* %blockSize.addr		; <i32> [#uses=1]
	%mul = mul i32 %tmp, %tmp4		; <i32> [#uses=1]
	%tmp5 = load i32, i32* %localIdx		; <i32> [#uses=1]
	%add = add i32 %mul, %tmp5		; <i32> [#uses=1]
	%tmp6 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp6, i32 %add		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp7 = load i32, i32* %globalIdy		; <i32> [#uses=1]
	%tmp8 = load i32, i32* %width.addr		; <i32> [#uses=1]
	%mul9 = mul i32 %tmp7, %tmp8		; <i32> [#uses=1]
	%tmp10 = load i32, i32* %globalIdx		; <i32> [#uses=1]
	%add11 = add i32 %mul9, %tmp10		; <i32> [#uses=1]
	%tmp12 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx13 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp12, i32 %add11		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp14 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx13		; <<4 x i8>> [#uses=1]
	...
	%tmp27 = load i32, i32* %targetIndex		; <i32> [#uses=1]
	%tmp28 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx29 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp28, i32 %tmp27		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp30 = load i32, i32* %sourceIndex		; <i32> [#uses=1]
	%tmp31 = load <4 x i8> addrspace(3)*, <4 x i8> addrspace(3)** %block.addr		; <<4 x i8> addrspace(3)*> [#uses=1]
	%arrayidx32 = getelementptr <4 x i8>, <4 x i8> addrspace(3)* %tmp31, i32 %tmp30		; <<4 x i8> addrspace(3)*> [#uses=1]
	%tmp33 = load <4 x i8>, <4 x i8> addrspace(3)* %arrayidx32		; <<4 x i8>> [#uses=1]
...
for.body:		; preds = %for.cond
	...
	%arrayidx = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp15, i32 %tmp14		; <<4 x i8> addrspace(1)*> [#uses=1]
	...
	%arrayidx20 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp19, i32 %tmp18		; <<4 x i8> addrspace(1)*> [#uses=1]
	...
	%tmp24 = load i32, i32* %pos		; <i32> [#uses=1]
	%tmp25 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx26 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp25, i32 %tmp24		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp27 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx26		; <<4 x i8>> [#uses=1]
	...
	%tmp30 = load i32, i32* %pos		; <i32> [#uses=1]
	%tmp31 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx32 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp31, i32 %tmp30		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp33 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx32		; <<4 x i8>> [#uses=1]
	...
	%tmp36 = load <4 x float>, <4 x float>* %.compoundliteral		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp36, <4 x float>* %xc
	%tmp38 = load float, float* %a0.addr		; <float> [#uses=1]
	...
	%tmp40 = load <4 x float>, <4 x float>* %xc		; <<4 x float>> [#uses=1]
	%mul41 = fmul <4 x float> %splat, %tmp40		; <<4 x float>> [#uses=1]
	%tmp42 = load float, float* %a1.addr		; <float> [#uses=1]
	...
	%tmp56 = load <4 x float>, <4 x float>* %yb		; <<4 x float>> [#uses=1]
	...
	%tmp59 = load i32, i32* %pos		; <i32> [#uses=1]
	%tmp60 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx61 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp60, i32 %tmp59		; <<4 x i8> addrspace(1)*> [#uses=1]
	...
	%tmp66 = load <4 x float>, <4 x float>* %yc		; <<4 x float>> [#uses=1]
	...
	%tmp69 = load <4 x float>, <4 x float>* %yc		; <<4 x float>> [#uses=1]
	...
	%tmp72 = load <4 x float>, <4 x float>* %yc		; <<4 x float>> [#uses=1]
	...
	%tmp75 = load <4 x i8>, <4 x i8>* %.compoundliteral62		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp75, <4 x i8> addrspace(1)* %arrayidx61
	%tmp76 = load <4 x float>, <4 x float>* %xc		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp76, <4 x float>* %xp
	%tmp77 = load <4 x float>, <4 x float>* %yp		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp77, <4 x float>* %yb
	%tmp78 = load <4 x float>, <4 x float>* %yc		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp78, <4 x float>* %yp
	br label %for.inc

for.inc:		; preds = %for.body
	%tmp79 = load i32, i32* %y		; <i32> [#uses=1]
...
for.body92:		; preds = %for.cond88
	...
	%tmp103 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp104 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx105 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp104, i32 %tmp103		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp106 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx105		; <<4 x i8>> [#uses=1]
	...
	%tmp109 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp110 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx111 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp110, i32 %tmp109		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp112 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx111		; <<4 x i8>> [#uses=1]
	...
	%tmp115 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp116 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx117 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp116, i32 %tmp115		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp118 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx117		; <<4 x i8>> [#uses=1]
	...
	%tmp121 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp122 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %input.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx123 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp122, i32 %tmp121		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp124 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx123		; <<4 x i8>> [#uses=1]
	...
	%tmp127 = load <4 x float>, <4 x float>* %.compoundliteral102		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp127, <4 x float>* %xc101
	%tmp130 = load float, float* %a2.addr		; <float> [#uses=1]
	...
	%tmp133 = load <4 x float>, <4 x float>* %xn		; <<4 x float>> [#uses=1]
	%mul134 = fmul <4 x float> %splat132, %tmp133		; <<4 x float>> [#uses=1]
	%tmp135 = load float, float* %a3.addr		; <float> [#uses=1]
	...
	%tmp150 = load <4 x float>, <4 x float>* %ya		; <<4 x float>> [#uses=1]
	...
	%tmp153 = load <4 x float>, <4 x float>* %xn		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp153, <4 x float>* %xa
	%tmp154 = load <4 x float>, <4 x float>* %xc101		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp154, <4 x float>* %xn
	%tmp155 = load <4 x float>, <4 x float>* %yn		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp155, <4 x float>* %ya
	%tmp156 = load <4 x float>, <4 x float>* %yc129		; <<4 x float>> [#uses=1]
	store <4 x float> %tmp156, <4 x float>* %yn
	%tmp159 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp160 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx161 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp160, i32 %tmp159		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp162 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx161		; <<4 x i8>> [#uses=1]
	...
	%tmp165 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp166 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx167 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp166, i32 %tmp165		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp168 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx167		; <<4 x i8>> [#uses=1]
	...
	%tmp171 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp172 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx173 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp172, i32 %tmp171		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp174 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx173		; <<4 x i8>> [#uses=1]
	...
	%tmp177 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp178 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx179 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp178, i32 %tmp177		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp180 = load <4 x i8>, <4 x i8> addrspace(1)* %arrayidx179		; <<4 x i8>> [#uses=1]
	...
	%tmp183 = load <4 x float>, <4 x float>* %.compoundliteral158		; <<4 x float>> [#uses=1]
	%tmp184 = load <4 x float>, <4 x float>* %yc129		; <<4 x float>> [#uses=1]
	%add185 = fadd <4 x float> %tmp183, %tmp184		; <<4 x float>> [#uses=1]
	store <4 x float> %add185, <4 x float>* %temp
	%tmp186 = load i32, i32* %pos94		; <i32> [#uses=1]
	%tmp187 = load <4 x i8> addrspace(1)*, <4 x i8> addrspace(1)** %output.addr		; <<4 x i8> addrspace(1)*> [#uses=1]
	%arrayidx188 = getelementptr <4 x i8>, <4 x i8> addrspace(1)* %tmp187, i32 %tmp186		; <<4 x i8> addrspace(1)*> [#uses=1]
	%tmp190 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	...
	%tmp193 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	...
	%tmp196 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	...
	%tmp199 = load <4 x float>, <4 x float>* %temp		; <<4 x float>> [#uses=1]
	...
	%tmp202 = load <4 x i8>, <4 x i8>* %.compoundliteral189		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp202, <4 x i8> addrspace(1)* %arrayidx188
	br label %for.inc203

for.inc203:		; preds = %for.body92
	%tmp204 = load i32, i32* %y85		; <i32> [#uses=1]

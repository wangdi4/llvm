...
cond.false:		; preds = %entry
	%tmp30 = load i32, i32* %x		; <i32> [#uses=1]
	%tmp31 = load i32, i32* %vstep		; <i32> [#uses=1]
...
cond.end:		; preds = %cond.false, %cond.true
	...
	%tmp35 = load i32, i32* %vstep		; <i32> [#uses=1]
...
cond.true38:		; preds = %cond.end
	%tmp39 = load i32, i32* %width		; <i32> [#uses=1]
	%sub40 = sub i32 %tmp39, 1		; <i32> [#uses=1]
	br label %cond.end45

cond.false41:		; preds = %cond.end
	%tmp42 = load i32, i32* %x		; <i32> [#uses=1]
	%tmp43 = load i32, i32* %vstep		; <i32> [#uses=1]
...
cond.end45:		; preds = %cond.false41, %cond.true38
	...
	%tmp48 = load i32, i32* %y		; <i32> [#uses=1]
	%tmp49 = load i32, i32* %hstep		; <i32> [#uses=1]
...
cond.false52:		; preds = %cond.end45
	%tmp53 = load i32, i32* %y		; <i32> [#uses=1]
	%tmp54 = load i32, i32* %hstep		; <i32> [#uses=1]
...
for.body85:		; preds = %for.cond81
	...
	%tmp100 = load i32, i32* %j		; <i32> [#uses=1]
	%tmp101 = load i32, i32* %width		; <i32> [#uses=1]
...
for.inc:		; preds = %for.body85
	%tmp115 = load i32, i32* %j		; <i32> [#uses=1]
...
for.inc116:		; preds = %for.end
	%tmp117 = load i32, i32* %i		; <i32> [#uses=1]

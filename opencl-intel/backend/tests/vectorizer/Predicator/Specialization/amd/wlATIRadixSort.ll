...
; RUN: opt  -std-link-opts -inline-threshold=4096 -inline -lowerswitch -mergereturn -loop-simplify -phicanon -predicate -specialize -specialize-threshold=10 -verify %t.bc -S -o %t1.ll

; RUN: %oclopt -inline-threshold=4096 -inline -domtree -mem2reg -instcombine -simplifycfg -lowerswitch -mergereturn -loop-simplify -phicanon -predicate -specialize -specialize-threshold=10 -verify %s -S -o %t1.ll

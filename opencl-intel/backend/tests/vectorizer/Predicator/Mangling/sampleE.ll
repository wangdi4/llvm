...
for.cond5:                                        ; preds = %for.inc, %if.then
  %tmp6 = load i64, i64* %j                            ; <i64> [#uses=1]
  %tmp7 = load i64, i64* %t                            ; <i64> [#uses=1]
...
for.inc:                                          ; preds = %for.body9
  %tmp16 = load i64, i64* %j                           ; <i64> [#uses=1]
...
for.cond19:                                       ; preds = %for.inc32, %if.else
  %tmp20 = load i64, i64* %j18                         ; <i64> [#uses=1]
...
for.inc32:                                        ; preds = %for.body23
  %tmp33 = load i64, i64* %j18                         ; <i64> [#uses=1]
...
for.inc36:                                        ; preds = %if.end
  %tmp37 = load i64, i64* %i                           ; <i64> [#uses=1]

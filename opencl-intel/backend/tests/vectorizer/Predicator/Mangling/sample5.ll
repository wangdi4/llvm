...
for.body:                                         ; preds = %for.cond
  ...
  %tmp3 = load i64*, i64** %B.addr                      ; <i64*> [#uses=1]
...
for.cond7:                                        ; preds = %for.inc, %for.body
  %tmp8 = load i64, i64* %j                            ; <i64> [#uses=1]
  %tmp9 = load i64, i64* %n.addr                       ; <i64> [#uses=1]
  %div10 = sdiv i64 %tmp9, 10                     ; <i64> [#uses=1]
  %cmp11 = icmp slt i64 %tmp8, %div10             ; <i1> [#uses=1]
  br i1 %cmp11, label %for.body12, label %for.end

for.body12:                                       ; preds = %for.cond7
  %tmp13 = load i64, i64* %j                           ; <i64> [#uses=1]
  %tmp14 = load i64*, i64** %A.addr                     ; <i64*> [#uses=1]
...
for.inc:                                          ; preds = %for.body12
  %tmp19 = load i64, i64* %j                           ; <i64> [#uses=1]
...
for.inc20:                                        ; preds = %for.end
  %tmp21 = load i64, i64* %i                           ; <i64> [#uses=1]
  %inc22 = add nsw i64 %tmp21, 1                  ; <i64> [#uses=1]
  store i64 %inc22, i64* %i
  br label %for.cond

for.end23:                                        ; preds = %for.cond
  %tmp24 = load i64, i64* %sum                         ; <i64> [#uses=1]
  %tmp25 = load i64*, i64** %A.addr                     ; <i64*> [#uses=1]
  %arrayidx26 = getelementptr inbounds i64, i64* %tmp25, i64 5 ; <i64*> [#uses=1]

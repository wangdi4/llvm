...
for.cond:                                         ; preds = %for.inc, %crazy
  ...
  %tmp4 = load i64, i64* %n.addr                       ; <i64> [#uses=1]
...
for.cond17:                                       ; preds = %for.inc38, %if.else
  %tmp18 = load i32, i32* %i16                         ; <i32> [#uses=1]
  %conv19 = sext i32 %tmp18 to i64                ; <i64> [#uses=1]
  %tmp20 = load i64, i64* %n.addr                      ; <i64> [#uses=1]
...
for.body23:                                       ; preds = %for.cond17
  %tmp24 = load i32, i32* %i16                         ; <i32> [#uses=1]
...
if.end:                                           ; preds = %for.body23
  %tmp28 = load i32, i32* %i16                         ; <i32> [#uses=1]
  ...
  %arrayidx37 = getelementptr inbounds i64, i64* %tmp35, i64 %idxprom36 ; <i64*> [#uses=1]
  store i64 %tmp32, i64* %arrayidx37
  br label %for.inc38

for.inc38:                                        ; preds = %if.end
  %tmp39 = load i32, i32* %i16                         ; <i32> [#uses=1]

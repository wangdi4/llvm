...
if.then:		; preds = %land.lhs.true10
	...
	%arrayidx = getelementptr i8, i8 addrspace(2)* %tmp20, i32 %add		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx29 = getelementptr i8, i8 addrspace(2)* %tmp28, i32 %add27		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx42 = getelementptr i8, i8 addrspace(2)* %tmp41, i32 %add40		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx54 = getelementptr i8, i8 addrspace(2)* %tmp53, i32 %add52		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx65 = getelementptr i8, i8 addrspace(2)* %tmp64, i32 %add63		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx78 = getelementptr i8, i8 addrspace(2)* %tmp77, i32 %add76		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx90 = getelementptr i8, i8 addrspace(2)* %tmp89, i32 %add88		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx100 = getelementptr i8, i8 addrspace(2)* %tmp99, i32 %add98		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx113 = getelementptr i8, i8 addrspace(2)* %tmp112, i32 %add111		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx125 = getelementptr i8, i8 addrspace(2)* %tmp124, i32 %add123		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx137 = getelementptr i8, i8 addrspace(2)* %tmp136, i32 %add135		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx150 = getelementptr i8, i8 addrspace(2)* %tmp149, i32 %add148		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx163 = getelementptr i8, i8 addrspace(2)* %tmp162, i32 %add161		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx174 = getelementptr i8, i8 addrspace(2)* %tmp173, i32 %add172		; <i8 addrspace(2)*> [#uses=1]
	...
	%arrayidx187 = getelementptr i8, i8 addrspace(2)* %tmp186, i32 %add185		; <i8 addrspace(2)*> [#uses=1]
	...
	%tmp191 = load i32, i32* %x		; <i32> [#uses=1]
	%tmp192 = load i32, i32* %y		; <i32> [#uses=1]
	%tmp193 = load i32, i32* %width		; <i32> [#uses=1]
	%mul194 = mul i32 %tmp192, %tmp193		; <i32> [#uses=1]
	%add195 = add i32 %tmp191, %mul194		; <i32> [#uses=1]
	%tmp196 = load i8 addrspace(1)*, i8 addrspace(1)** %outputImage.addr		; <i8 addrspace(1)*> [#uses=1]
	%arrayidx197 = getelementptr i8, i8 addrspace(1)* %tmp196, i32 %add195		; <i8 addrspace(1)*> [#uses=1]
	%tmp198 = load i32, i32* %Gx		; <i32> [#uses=1]
	%conv199 = sitofp i32 %tmp198 to float		; <float> [#uses=1]
	%tmp200 = load i32, i32* %Gy		; <i32> [#uses=1]

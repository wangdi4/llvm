...
for.body:		; preds = %for.cond
	...
	%arrayidx = getelementptr <8 x i16>, <8 x i16> addrspace(1)* %tmp13, i32 %tmp12		; <<8 x i16> addrspace(1)*> [#uses=1]
	...
	%arrayidx18 = getelementptr <8 x i16>, <8 x i16> addrspace(1)* %tmp17, i32 %tmp16		; <<8 x i16> addrspace(1)*> [#uses=1]
	%tmp19 = load <8 x i16>, <8 x i16> addrspace(1)* %arrayidx18		; <<8 x i16>> [#uses=1]
	store <8 x i16> %tmp19, <8 x i16>* %v16
	%tmp20 = load <8 x i16>, <8 x i16>* %u16		; <<8 x i16>> [#uses=1]
	%tmp21 = load <8 x i16>, <8 x i16> addrspace(2)* @uv_min_val_8_s16		; <<8 x i16>> [#uses=1]
	%add = add <8 x i16> %tmp20, %tmp21		; <<8 x i16>> [#uses=1]
	store <8 x i16> %add, <8 x i16>* %u16
	%tmp22 = load <8 x i16>, <8 x i16>* %v16		; <<8 x i16>> [#uses=1]
	%tmp23 = load <8 x i16>, <8 x i16> addrspace(2)* @uv_min_val_8_s16		; <<8 x i16>> [#uses=1]
	...
	%arrayidx45 = getelementptr i8, i8 addrspace(2)* %tmp44, i32 %idxprom		; <i8 addrspace(2)*> [#uses=1]
	%conv = addrspacecast i8 addrspace(2)* %arrayidx45 to i32*		; <i32*> [#uses=1]
	%tmp46 = load i32, i32* %conv		; <i32> [#uses=1]
	...
	%arrayidx52 = getelementptr i8, i8 addrspace(2)* %tmp50, i32 %idxprom51		; <i8 addrspace(2)*> [#uses=1]
	%conv53 = addrspacecast i8 addrspace(2)* %arrayidx52 to i32*		; <i32*> [#uses=1]
	%tmp54 = load i32, i32* %conv53		; <i32> [#uses=1]
	%tmp55 = load <8 x i32>, <8 x i32>* %sat_data_uint8		; <<8 x i32>> [#uses=1]
	%vecins56 = insertelement <8 x i32> %tmp55, i32 %tmp54, i32 1		; <<8 x i32>> [#uses=1]
	store <8 x i32> %vecins56, <8 x i32>* %sat_data_uint8
	%tmp57 = load <8 x i16>, <8 x i16>* %u_key_16		; <<8 x i16>> [#uses=1]
	%vecext58 = extractelement <8 x i16> %tmp57, i32 2		; <i16> [#uses=1]
	%tmp59 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%idxprom60 = sext i16 %vecext58 to i32		; <i32> [#uses=1]
	%arrayidx61 = getelementptr i8, i8 addrspace(2)* %tmp59, i32 %idxprom60		; <i8 addrspace(2)*> [#uses=1]
	%conv62 = addrspacecast i8 addrspace(2)* %arrayidx61 to i32*		; <i32*> [#uses=1]
	%tmp63 = load i32, i32* %conv62		; <i32> [#uses=1]
	%tmp64 = load <8 x i32>, <8 x i32>* %sat_data_uint8		; <<8 x i32>> [#uses=1]
	%vecins65 = insertelement <8 x i32> %tmp64, i32 %tmp63, i32 2		; <<8 x i32>> [#uses=1]
	store <8 x i32> %vecins65, <8 x i32>* %sat_data_uint8
	%tmp66 = load <8 x i16>, <8 x i16>* %u_key_16		; <<8 x i16>> [#uses=1]
	%vecext67 = extractelement <8 x i16> %tmp66, i32 3		; <i16> [#uses=1]
	%tmp68 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%idxprom69 = sext i16 %vecext67 to i32		; <i32> [#uses=1]
	%arrayidx70 = getelementptr i8, i8 addrspace(2)* %tmp68, i32 %idxprom69		; <i8 addrspace(2)*> [#uses=1]
	%conv71 = addrspacecast i8 addrspace(2)* %arrayidx70 to i32*		; <i32*> [#uses=1]
	%tmp72 = load i32, i32* %conv71		; <i32> [#uses=1]
	%tmp73 = load <8 x i32>, <8 x i32>* %sat_data_uint8		; <<8 x i32>> [#uses=1]
	%vecins74 = insertelement <8 x i32> %tmp73, i32 %tmp72, i32 3		; <<8 x i32>> [#uses=1]
	store <8 x i32> %vecins74, <8 x i32>* %sat_data_uint8
	%tmp75 = load <8 x i16>, <8 x i16>* %u_key_16		; <<8 x i16>> [#uses=1]
	...
	%arrayidx79 = getelementptr i8, i8 addrspace(2)* %tmp77, i32 %idxprom78		; <i8 addrspace(2)*> [#uses=1]
	%conv80 = addrspacecast i8 addrspace(2)* %arrayidx79 to i32*		; <i32*> [#uses=1]
	%tmp81 = load i32, i32* %conv80		; <i32> [#uses=1]
	%tmp82 = load <8 x i32>, <8 x i32>* %sat_data_uint8		; <<8 x i32>> [#uses=1]
	%vecins83 = insertelement <8 x i32> %tmp82, i32 %tmp81, i32 4		; <<8 x i32>> [#uses=1]
	store <8 x i32> %vecins83, <8 x i32>* %sat_data_uint8
	%tmp84 = load <8 x i16>, <8 x i16>* %u_key_16		; <<8 x i16>> [#uses=1]
	%vecext85 = extractelement <8 x i16> %tmp84, i32 5		; <i16> [#uses=1]
	%tmp86 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%idxprom87 = sext i16 %vecext85 to i32		; <i32> [#uses=1]
	%arrayidx88 = getelementptr i8, i8 addrspace(2)* %tmp86, i32 %idxprom87		; <i8 addrspace(2)*> [#uses=1]
	%conv89 = addrspacecast i8 addrspace(2)* %arrayidx88 to i32*		; <i32*> [#uses=1]
	%tmp90 = load i32, i32* %conv89		; <i32> [#uses=1]
	%tmp91 = load <8 x i32>, <8 x i32>* %sat_data_uint8		; <<8 x i32>> [#uses=1]
	%vecins92 = insertelement <8 x i32> %tmp91, i32 %tmp90, i32 5		; <<8 x i32>> [#uses=1]
	store <8 x i32> %vecins92, <8 x i32>* %sat_data_uint8
	%tmp93 = load <8 x i16>, <8 x i16>* %u_key_16		; <<8 x i16>> [#uses=1]
	%vecext94 = extractelement <8 x i16> %tmp93, i32 6		; <i16> [#uses=1]
	%tmp95 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%idxprom96 = sext i16 %vecext94 to i32		; <i32> [#uses=1]
	%arrayidx97 = getelementptr i8, i8 addrspace(2)* %tmp95, i32 %idxprom96		; <i8 addrspace(2)*> [#uses=1]
	%conv98 = addrspacecast i8 addrspace(2)* %arrayidx97 to i32*		; <i32*> [#uses=1]
	%tmp99 = load i32, i32* %conv98		; <i32> [#uses=1]
	%tmp100 = load <8 x i32>, <8 x i32>* %sat_data_uint8		; <<8 x i32>> [#uses=1]
	%vecins101 = insertelement <8 x i32> %tmp100, i32 %tmp99, i32 6		; <<8 x i32>> [#uses=1]
	store <8 x i32> %vecins101, <8 x i32>* %sat_data_uint8
	%tmp102 = load <8 x i16>, <8 x i16>* %u_key_16		; <<8 x i16>> [#uses=1]
	%vecext103 = extractelement <8 x i16> %tmp102, i32 7		; <i16> [#uses=1]
	%tmp104 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%idxprom105 = sext i16 %vecext103 to i32		; <i32> [#uses=1]
	%arrayidx106 = getelementptr i8, i8 addrspace(2)* %tmp104, i32 %idxprom105		; <i8 addrspace(2)*> [#uses=1]
	%conv107 = addrspacecast i8 addrspace(2)* %arrayidx106 to i32*		; <i32*> [#uses=1]
	%tmp108 = load i32, i32* %conv107		; <i32> [#uses=1]
	%tmp109 = load <8 x i32>, <8 x i32>* %sat_data_uint8		; <<8 x i32>> [#uses=1]
	%vecins110 = insertelement <8 x i32> %tmp109, i32 %tmp108, i32 7		; <<8 x i32>> [#uses=1]
	store <8 x i32> %vecins110, <8 x i32>* %sat_data_uint8
	%tmp112 = load <8 x i32>, <8 x i32>* %sat_data_uint8		; <<8 x i32>> [#uses=1]
	...
	%tmp116 = load <16 x i16>, <16 x i16>* %sat_data		; <<16 x i16>> [#uses=1]
	%tmp117 = load <16 x i16>, <16 x i16> addrspace(2)* @ff_const_16_u16		; <<16 x i16>> [#uses=1]
	%and118 = and <16 x i16> %tmp116, %tmp117		; <<16 x i16>> [#uses=1]
	store <16 x i16> %and118, <16 x i16>* %sat_data
	%tmp120 = load <16 x i16>, <16 x i16>* %sat_data		; <<16 x i16>> [#uses=1]
	%tmp121 = load <16 x i16>, <16 x i16>* %sat_data_shifted_8		; <<16 x i16>> [#uses=1]
	%sub = sub <16 x i16> %tmp120, %tmp121		; <<16 x i16>> [#uses=1]
	store <16 x i16> %sub, <16 x i16>* %delta_sat_data
	%tmp123 = load <8 x i16>, <8 x i16> addrspace(2)* @zero_const_8_s16		; <<8 x i16>> [#uses=1]
	store <8 x i16> %tmp123, <8 x i16>* %SF0
	%tmp125 = load <8 x i16>, <8 x i16> addrspace(2)* @zero_const_8_s16		; <<8 x i16>> [#uses=1]
	store <8 x i16> %tmp125, <8 x i16>* %SF1
	%tmp127 = load <16 x i16>, <16 x i16>* %delta_sat_data		; <<16 x i16>> [#uses=1]
	...
	%tmp129 = load <8 x i16>, <8 x i16>* %SF_original		; <<8 x i16>> [#uses=1]
	%tmp130 = load <8 x i16>, <8 x i16>* %uv_tmp_16		; <<8 x i16>> [#uses=1]
	...
	%tmp133 = load <8 x i16>, <8 x i16> addrspace(2)* @rounding_SF_8_s16		; <<8 x i16>> [#uses=1]
	%add134 = add <8 x i16> %tmp132, %tmp133		; <<8 x i16>> [#uses=1]
	store <8 x i16> %add134, <8 x i16>* %SF0
	%tmp135 = load <8 x i16>, <8 x i16>* %SF0		; <<8 x i16>> [#uses=1]
	...
	%tmp137 = load <8 x i16>, <8 x i16>* %SF_original		; <<8 x i16>> [#uses=1]
	%tmp138 = load <8 x i16>, <8 x i16>* %SF0		; <<8 x i16>> [#uses=1]
	%add139 = add <8 x i16> %tmp137, %tmp138		; <<8 x i16>> [#uses=1]
	store <8 x i16> %add139, <8 x i16>* %SF0
	%tmp140 = load <16 x i16>, <16 x i16>* %delta_sat_data		; <<16 x i16>> [#uses=1]
	...
	%tmp142 = load <8 x i16>, <8 x i16>* %SF_original		; <<8 x i16>> [#uses=1]
	%tmp143 = load <8 x i16>, <8 x i16>* %uv_tmp_16		; <<8 x i16>> [#uses=1]
	...
	%tmp146 = load <8 x i16>, <8 x i16> addrspace(2)* @rounding_SF_8_s16		; <<8 x i16>> [#uses=1]
	%add147 = add <8 x i16> %tmp145, %tmp146		; <<8 x i16>> [#uses=1]
	store <8 x i16> %add147, <8 x i16>* %SF1
	%tmp148 = load <8 x i16>, <8 x i16>* %SF1		; <<8 x i16>> [#uses=1]
	...
	%tmp150 = load <8 x i16>, <8 x i16>* %SF_original		; <<8 x i16>> [#uses=1]
	%tmp151 = load <8 x i16>, <8 x i16>* %SF1		; <<8 x i16>> [#uses=1]
	%add152 = add <8 x i16> %tmp150, %tmp151		; <<8 x i16>> [#uses=1]
	store <8 x i16> %add152, <8 x i16>* %SF1
	%tmp153 = load <8 x i16>, <8 x i16>* %u16		; <<8 x i16>> [#uses=1]
	%tmp154 = load <8 x i16>, <8 x i16> addrspace(2)* @alpha_mask_SF_8_s16		; <<8 x i16>> [#uses=1]
	...
	%tmp157 = load <8 x i16>, <8 x i16>* %SF0		; <<8 x i16>> [#uses=1]
	...
	%tmp160 = load <8 x i16>, <8 x i16>* %uv_tmp_16		; <<8 x i16>> [#uses=1]
	%mul161 = mul <8 x i16> %tmp159, %tmp160		; <<8 x i16>> [#uses=1]
	store <8 x i16> %mul161, <8 x i16>* %SF1
	%tmp162 = load <8 x i16>, <8 x i16>* %SF1		; <<8 x i16>> [#uses=1]
	%tmp163 = load <8 x i16>, <8 x i16> addrspace(2)* @rounding_SF_8_s16		; <<8 x i16>> [#uses=1]
	%add164 = add <8 x i16> %tmp162, %tmp163		; <<8 x i16>> [#uses=1]
	store <8 x i16> %add164, <8 x i16>* %SF1
	%tmp165 = load <8 x i16>, <8 x i16>* %SF1		; <<8 x i16>> [#uses=1]
	...
	%tmp167 = load <8 x i16>, <8 x i16>* %SF1		; <<8 x i16>> [#uses=1]
	%tmp168 = load <8 x i16>, <8 x i16>* %SF0		; <<8 x i16>> [#uses=1]
	...
	%tmp177 = load <8 x i16>, <8 x i16>* %SF0		; <<8 x i16>> [#uses=1]
	%tmp178 = load <8 x i16>, <8 x i16>* %u16		; <<8 x i16>> [#uses=1]
	%call179 = call <8 x i16> @__mul_hi_8i16(<8 x i16> %tmp177, <8 x i16> %tmp178)		; <<8 x i16>> [#uses=1]
	%tmp180 = load <16 x i16>, <16 x i16>* %uvl_short16		; <<16 x i16>> [#uses=1]
	...
	%tmp184 = load <16 x i16>, <16 x i16>* %uvl_short16		; <<16 x i16>> [#uses=1]
	%astype185 = bitcast <16 x i16> %tmp184 to <8 x i32>		; <<8 x i32>> [#uses=1]
	store <8 x i32> %astype185, <8 x i32>* %uvl_int8
	%tmp186 = load <8 x i32>, <8 x i32>* %uvl_int8		; <<8 x i32>> [#uses=1]
	%tmp187 = load <8 x i32>, <8 x i32> addrspace(2)* @uv_final_rounding_8_s32		; <<8 x i32>> [#uses=1]
	%add188 = add <8 x i32> %tmp186, %tmp187		; <<8 x i32>> [#uses=1]
	store <8 x i32> %add188, <8 x i32>* %uvl_int8
	%tmp189 = load <8 x i32>, <8 x i32>* %uvl_int8		; <<8 x i32>> [#uses=1]
	...
	%tmp191 = load <8 x i32>, <8 x i32>* %uvl_int8		; <<8 x i32>> [#uses=1]
	%astype192 = bitcast <8 x i32> %tmp191 to <16 x i16>		; <<16 x i16>> [#uses=1]
	store <16 x i16> %astype192, <16 x i16>* %uvl_short16
	%tmp194 = load <16 x i16>, <16 x i16>* %uvl_short16		; <<16 x i16>> [#uses=1]
	...
	%tmp197 = load i16, i16 addrspace(2)* @uv_min_val_16		; <i16> [#uses=1]
	...
	%tmp200 = load i16, i16 addrspace(2)* @uv_max_val_16		; <i16> [#uses=1]
	...
	%tmp203 = load <8 x i16>, <8 x i16>* %uvl_short8		; <<8 x i16>> [#uses=1]
	%tmp204 = load <8 x i16>, <8 x i16> addrspace(2)* @uv_min_val_8_s16		; <<8 x i16>> [#uses=1]
	%call205 = call <8 x i16> @__max_8i16(<8 x i16> %tmp203, <8 x i16> %tmp204)		; <<8 x i16>> [#uses=1]
	%tmp206 = load <8 x i16>, <8 x i16> addrspace(2)* @uv_max_val_8_s16		; <<8 x i16>> [#uses=1]
	%call207 = call <8 x i16> @__min_8i16(<8 x i16> %call205, <8 x i16> %tmp206)		; <<8 x i16>> [#uses=1]
	store <8 x i16> %call207, <8 x i16>* %u16
	%tmp208 = load <8 x i16>, <8 x i16>* %u16		; <<8 x i16>> [#uses=1]
	%tmp209 = load i16, i16 addrspace(2)* @uv_min_val_16		; <i16> [#uses=1]
	...
	%tmp213 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%tmp214 = load <8 x i16> addrspace(1)*, <8 x i16> addrspace(1)** %Uout.addr		; <<8 x i16> addrspace(1)*> [#uses=1]
	%arrayidx215 = getelementptr <8 x i16>, <8 x i16> addrspace(1)* %tmp214, i32 %tmp213		; <<8 x i16> addrspace(1)*> [#uses=1]
	%tmp216 = load <8 x i16>, <8 x i16>* %u16		; <<8 x i16>> [#uses=1]
	...
	%tmp223 = load <8 x i16>, <8 x i16>* %SF0		; <<8 x i16>> [#uses=1]
	%tmp224 = load <8 x i16>, <8 x i16>* %v16		; <<8 x i16>> [#uses=1]
	%call225 = call <8 x i16> @__mul_hi_8i16(<8 x i16> %tmp223, <8 x i16> %tmp224)		; <<8 x i16>> [#uses=1]
	%tmp226 = load <16 x i16>, <16 x i16>* %uvl_short16		; <<16 x i16>> [#uses=1]
	...
	%tmp229 = load <16 x i16>, <16 x i16>* %uvl_short16		; <<16 x i16>> [#uses=1]
	%astype230 = bitcast <16 x i16> %tmp229 to <8 x i32>		; <<8 x i32>> [#uses=1]
	store <8 x i32> %astype230, <8 x i32>* %uvl_int8
	%tmp231 = load <8 x i32>, <8 x i32>* %uvl_int8		; <<8 x i32>> [#uses=1]
	%tmp232 = load <8 x i32>, <8 x i32> addrspace(2)* @uv_final_rounding_8_s32		; <<8 x i32>> [#uses=1]
	%add233 = add <8 x i32> %tmp231, %tmp232		; <<8 x i32>> [#uses=1]
	store <8 x i32> %add233, <8 x i32>* %uvl_int8
	%tmp234 = load <8 x i32>, <8 x i32>* %uvl_int8		; <<8 x i32>> [#uses=1]
	...
	%tmp236 = load <8 x i32>, <8 x i32>* %uvl_int8		; <<8 x i32>> [#uses=1]
	%astype237 = bitcast <8 x i32> %tmp236 to <16 x i16>		; <<16 x i16>> [#uses=1]
	store <16 x i16> %astype237, <16 x i16>* %uvl_short16
	%tmp238 = load <16 x i16>, <16 x i16>* %uvl_short16		; <<16 x i16>> [#uses=1]
	...
	%tmp240 = load <8 x i16>, <8 x i16>* %uvl_short8		; <<8 x i16>> [#uses=1]
	%tmp241 = load <8 x i16>, <8 x i16> addrspace(2)* @uv_min_val_8_s16		; <<8 x i16>> [#uses=1]
	%call242 = call <8 x i16> @__max_8i16(<8 x i16> %tmp240, <8 x i16> %tmp241)		; <<8 x i16>> [#uses=1]
	%tmp243 = load <8 x i16>, <8 x i16> addrspace(2)* @uv_max_val_8_s16		; <<8 x i16>> [#uses=1]
	%call244 = call <8 x i16> @__min_8i16(<8 x i16> %call242, <8 x i16> %tmp243)		; <<8 x i16>> [#uses=1]
	store <8 x i16> %call244, <8 x i16>* %v16
	%tmp245 = load <8 x i16>, <8 x i16>* %v16		; <<8 x i16>> [#uses=1]
	%tmp246 = load i16, i16 addrspace(2)* @uv_min_val_16		; <i16> [#uses=1]
	...
	%tmp250 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%tmp251 = load <8 x i16> addrspace(1)*, <8 x i16> addrspace(1)** %Vout.addr		; <<8 x i16> addrspace(1)*> [#uses=1]
	%arrayidx252 = getelementptr <8 x i16>, <8 x i16> addrspace(1)* %tmp251, i32 %tmp250		; <<8 x i16> addrspace(1)*> [#uses=1]
	%tmp253 = load <8 x i16>, <8 x i16>* %v16		; <<8 x i16>> [#uses=1]
	store <8 x i16> %tmp253, <8 x i16> addrspace(1)* %arrayidx252
	%tmp254 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%inc = add i32 %tmp254, 1		; <i32> [#uses=1]
	store i32 %inc, i32* %pixel_index
	br label %for.inc

for.inc:		; preds = %for.body
	%tmp255 = load i32, i32* %iter		; <i32> [#uses=1]
...
for.body:		; preds = %for.cond
	...
	%add.ptr = getelementptr i16, i16 addrspace(1)* %tmp13, i32 %tmp14		; <i16 addrspace(1)*> [#uses=1]
	...
	%add.ptr18 = getelementptr i16, i16 addrspace(1)* %tmp16, i32 %tmp17		; <i16 addrspace(1)*> [#uses=1]
	...
	%tmp21 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%tmp22 = load i16 addrspace(1)*, i16 addrspace(1)** %Uin.addr		; <i16 addrspace(1)*> [#uses=1]
	%arrayidx = getelementptr i16, i16 addrspace(1)* %tmp22, i32 %tmp21		; <i16 addrspace(1)*> [#uses=1]
	%tmp23 = load i16, i16 addrspace(1)* %arrayidx		; <i16> [#uses=1]
	%conv24 = zext i16 %tmp23 to i32		; <i32> [#uses=1]
	%conv25 = trunc i32 %conv24 to i16		; <i16> [#uses=1]
	%conv26 = sext i16 %conv25 to i32		; <i32> [#uses=1]
	%tmp27 = load i16, i16 addrspace(2)* @uv_min_val_16		; <i16> [#uses=1]
	...
	%tmp31 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%tmp32 = load i16 addrspace(1)*, i16 addrspace(1)** %Vin.addr		; <i16 addrspace(1)*> [#uses=1]
	%arrayidx33 = getelementptr i16, i16 addrspace(1)* %tmp32, i32 %tmp31		; <i16 addrspace(1)*> [#uses=1]
	%tmp34 = load i16, i16 addrspace(1)* %arrayidx33		; <i16> [#uses=1]
	%conv35 = zext i16 %tmp34 to i32		; <i32> [#uses=1]
	%conv36 = trunc i32 %conv35 to i16		; <i16> [#uses=1]
	%conv37 = sext i16 %conv36 to i32		; <i32> [#uses=1]
	%tmp38 = load i16, i16 addrspace(2)* @uv_min_val_16		; <i16> [#uses=1]
	...
	%tmp43 = load i16, i16* %u16		; <i16> [#uses=1]
	...
	%tmp47 = load i16, i16* %v16		; <i16> [#uses=1]
	%conv48 = sext i16 %tmp47 to i32		; <i32> [#uses=1]
	%tmp49 = load i16, i16 addrspace(2)* @hi_key_mask_16		; <i16> [#uses=1]
	...
	%tmp52 = load i16, i16* %u_key_16		; <i16> [#uses=1]
	%conv53 = sext i16 %tmp52 to i32		; <i32> [#uses=1]
	%tmp54 = load i16, i16* %v_key_16		; <i16> [#uses=1]
	...
	%tmp59 = load i16, i16* %v16		; <i16> [#uses=1]
	%conv60 = sext i16 %tmp59 to i32		; <i32> [#uses=1]
	%tmp61 = load i16, i16 addrspace(2)* @alpha_mask_SF_16		; <i16> [#uses=1]
	...
	store i32 0, i32* %SF0
	store i32 0, i32* %SF1
	%tmp68 = load i16, i16* %u_key_16		; <i16> [#uses=1]
	...
	%tmp73 = load i16, i16* %index		; <i16> [#uses=1]
	%tmp74 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%idxprom = sext i16 %tmp73 to i32		; <i32> [#uses=1]
	%arrayidx75 = getelementptr i8, i8 addrspace(2)* %tmp74, i32 %idxprom		; <i8 addrspace(2)*> [#uses=1]
	%tmp76 = load i8, i8 addrspace(2)* %arrayidx75		; <i8> [#uses=1]
	%tmp77 = load <4 x i8>, <4 x i8>* %sat_data		; <<4 x i8>> [#uses=1]
	%tmp78 = insertelement <4 x i8> %tmp77, i8 %tmp76, i32 0		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp78, <4 x i8>* %sat_data
	%tmp79 = load i16, i16* %index		; <i16> [#uses=1]
	...
	%arrayidx83 = getelementptr i8, i8 addrspace(2)* %tmp82, i32 %add81		; <i8 addrspace(2)*> [#uses=1]
	%tmp84 = load i8, i8 addrspace(2)* %arrayidx83		; <i8> [#uses=1]
	...
	%tmp87 = load i16, i16* %index		; <i16> [#uses=1]
	...
	%arrayidx91 = getelementptr i8, i8 addrspace(2)* %tmp90, i32 %add89		; <i8 addrspace(2)*> [#uses=1]
	%tmp92 = load i8, i8 addrspace(2)* %arrayidx91		; <i8> [#uses=1]
	%tmp93 = load <4 x i8>, <4 x i8>* %sat_data		; <<4 x i8>> [#uses=1]
	%tmp94 = insertelement <4 x i8> %tmp93, i8 %tmp92, i32 2		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp94, <4 x i8>* %sat_data
	%tmp95 = load i16, i16* %index		; <i16> [#uses=1]
	...
	%arrayidx99 = getelementptr i8, i8 addrspace(2)* %tmp98, i32 %add97		; <i8 addrspace(2)*> [#uses=1]
	%tmp100 = load i8, i8 addrspace(2)* %arrayidx99		; <i8> [#uses=1]
	%tmp101 = load <4 x i8>, <4 x i8>* %sat_data		; <<4 x i8>> [#uses=1]
	...
	%tmp146 = load i16, i16* %u16		; <i16> [#uses=1]
	%conv147 = sext i16 %tmp146 to i32		; <i32> [#uses=1]
	%tmp148 = load i16, i16 addrspace(2)* @alpha_mask_SF_16		; <i16> [#uses=1]
	...
	%tmp184 = load i16, i16* %u16		; <i16> [#uses=1]
	...
	%arraydecay = getelementptr [2 x i32], [2 x i32]* %uOut, i32 0, i32 0		; <i32*> [#uses=1]
	%arrayidx211 = getelementptr i32, i32* %arraydecay, i32 0		; <i32*> [#uses=1]
	%tmp212 = load i16, i16* %u16		; <i16> [#uses=1]
	%conv213 = sext i16 %tmp212 to i32		; <i32> [#uses=1]
	store i32 %conv213, i32* %arrayidx211
	%arraydecay214 = getelementptr [2 x i32], [2 x i32]* %vOut, i32 0, i32 0		; <i32*> [#uses=1]
	%arrayidx215 = getelementptr i32, i32* %arraydecay214, i32 0		; <i32*> [#uses=1]
	%tmp216 = load i16, i16* %v16		; <i16> [#uses=1]
	%conv217 = sext i16 %tmp216 to i32		; <i32> [#uses=1]
	store i32 %conv217, i32* %arrayidx215
	%tmp218 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%inc = add i32 %tmp218, 1		; <i32> [#uses=1]
	store i32 %inc, i32* %pixel_index
	%tmp219 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%tmp220 = load i16 addrspace(1)*, i16 addrspace(1)** %Uin.addr		; <i16 addrspace(1)*> [#uses=1]
	%arrayidx221 = getelementptr i16, i16 addrspace(1)* %tmp220, i32 %tmp219		; <i16 addrspace(1)*> [#uses=1]
	%tmp222 = load i16, i16 addrspace(1)* %arrayidx221		; <i16> [#uses=1]
	...
	%tmp226 = load i16, i16 addrspace(2)* @uv_min_val_16		; <i16> [#uses=1]
	...
	%tmp230 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%tmp231 = load i16 addrspace(1)*, i16 addrspace(1)** %Vin.addr		; <i16 addrspace(1)*> [#uses=1]
	%arrayidx232 = getelementptr i16, i16 addrspace(1)* %tmp231, i32 %tmp230		; <i16 addrspace(1)*> [#uses=1]
	%tmp233 = load i16, i16 addrspace(1)* %arrayidx232		; <i16> [#uses=1]
	...
	%tmp237 = load i16, i16 addrspace(2)* @uv_min_val_16		; <i16> [#uses=1]
	...
	%tmp241 = load i16, i16* %u16		; <i16> [#uses=1]
	...
	%tmp247 = load i16, i16* %v16		; <i16> [#uses=1]
	%conv248 = sext i16 %tmp247 to i32		; <i32> [#uses=1]
	%tmp249 = load i16, i16 addrspace(2)* @hi_key_mask_16		; <i16> [#uses=1]
	...
	%tmp253 = load i16, i16* %u_key_16		; <i16> [#uses=1]
	%conv254 = sext i16 %tmp253 to i32		; <i32> [#uses=1]
	%tmp255 = load i16, i16* %v_key_16246		; <i16> [#uses=1]
	...
	%tmp259 = load i16, i16* %v16		; <i16> [#uses=1]
	%conv260 = sext i16 %tmp259 to i32		; <i32> [#uses=1]
	%tmp261 = load i16, i16 addrspace(2)* @alpha_mask_SF_16		; <i16> [#uses=1]
	...
	%tmp265 = load i16, i16* %u_key_16		; <i16> [#uses=1]
	...
	%tmp269 = load i16, i16* %index		; <i16> [#uses=1]
	%tmp270 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%idxprom271 = sext i16 %tmp269 to i32		; <i32> [#uses=1]
	%arrayidx272 = getelementptr i8, i8 addrspace(2)* %tmp270, i32 %idxprom271		; <i8 addrspace(2)*> [#uses=1]
	%tmp273 = load i8, i8 addrspace(2)* %arrayidx272		; <i8> [#uses=1]
	%tmp274 = load <4 x i8>, <4 x i8>* %sat_data		; <<4 x i8>> [#uses=1]
	%tmp275 = insertelement <4 x i8> %tmp274, i8 %tmp273, i32 0		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp275, <4 x i8>* %sat_data
	%tmp276 = load i16, i16* %index		; <i16> [#uses=1]
	%conv277 = sext i16 %tmp276 to i32		; <i32> [#uses=1]
	%add278 = add i32 %conv277, 1		; <i32> [#uses=1]
	%tmp279 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%arrayidx280 = getelementptr i8, i8 addrspace(2)* %tmp279, i32 %add278		; <i8 addrspace(2)*> [#uses=1]
	%tmp281 = load i8, i8 addrspace(2)* %arrayidx280		; <i8> [#uses=1]
	%tmp282 = load <4 x i8>, <4 x i8>* %sat_data		; <<4 x i8>> [#uses=1]
	%tmp283 = insertelement <4 x i8> %tmp282, i8 %tmp281, i32 1		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp283, <4 x i8>* %sat_data
	%tmp284 = load i16, i16* %index		; <i16> [#uses=1]
	%conv285 = sext i16 %tmp284 to i32		; <i32> [#uses=1]
	%add286 = add i32 %conv285, 2		; <i32> [#uses=1]
	%tmp287 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%arrayidx288 = getelementptr i8, i8 addrspace(2)* %tmp287, i32 %add286		; <i8 addrspace(2)*> [#uses=1]
	%tmp289 = load i8, i8 addrspace(2)* %arrayidx288		; <i8> [#uses=1]
	%tmp290 = load <4 x i8>, <4 x i8>* %sat_data		; <<4 x i8>> [#uses=1]
	%tmp291 = insertelement <4 x i8> %tmp290, i8 %tmp289, i32 2		; <<4 x i8>> [#uses=1]
	store <4 x i8> %tmp291, <4 x i8>* %sat_data
	%tmp292 = load i16, i16* %index		; <i16> [#uses=1]
	%conv293 = sext i16 %tmp292 to i32		; <i32> [#uses=1]
	%add294 = add i32 %conv293, 3		; <i32> [#uses=1]
	%tmp295 = load i8 addrspace(2)*, i8 addrspace(2)** %SatLUTEntry.addr		; <i8 addrspace(2)*> [#uses=1]
	%arrayidx296 = getelementptr i8, i8 addrspace(2)* %tmp295, i32 %add294		; <i8 addrspace(2)*> [#uses=1]
	%tmp297 = load i8, i8 addrspace(2)* %arrayidx296		; <i8> [#uses=1]
	...
	%tmp300 = load <4 x i8>, <4 x i8>* %sat_data		; <<4 x i8>> [#uses=1]
	%tmp301 = extractelement <4 x i8> %tmp300, i32 0		; <i8> [#uses=1]
	%conv302 = zext i8 %tmp301 to i32		; <i32> [#uses=1]
	%tmp303 = load <4 x i8>, <4 x i8>* %sat_data		; <<4 x i8>> [#uses=1]
	...
	%arraydecay408 = getelementptr [2 x i32], [2 x i32]* %uOut, i32 0, i32 0		; <i32*> [#uses=1]
	%arrayidx409 = getelementptr i32, i32* %arraydecay408, i32 1		; <i32*> [#uses=1]
	%tmp410 = load i16, i16* %u16		; <i16> [#uses=1]
	%conv411 = sext i16 %tmp410 to i32		; <i32> [#uses=1]
	store i32 %conv411, i32* %arrayidx409
	%arraydecay412 = getelementptr [2 x i32], [2 x i32]* %vOut, i32 0, i32 0		; <i32*> [#uses=1]
	%arrayidx413 = getelementptr i32, i32* %arraydecay412, i32 1		; <i32*> [#uses=1]
	%tmp414 = load i16, i16* %v16		; <i16> [#uses=1]
	%conv415 = sext i16 %tmp414 to i32		; <i32> [#uses=1]
	store i32 %conv415, i32* %arrayidx413
	%tmp416 = load i32 addrspace(1)*, i32 addrspace(1)** %UoutPtr		; <i32 addrspace(1)*> [#uses=1]
	%arraydecay417 = getelementptr [2 x i32], [2 x i32]* %uOut, i32 0, i32 0		; <i32*> [#uses=1]
	%arrayidx418 = getelementptr i32, i32* %arraydecay417, i32 0		; <i32*> [#uses=1]
	%tmp419 = load i32, i32* %arrayidx418		; <i32> [#uses=1]
	%and420 = and i32 %tmp419, 65535		; <i32> [#uses=1]
	%shl = shl i32 %and420, 16		; <i32> [#uses=1]
	%arraydecay421 = getelementptr [2 x i32], [2 x i32]* %uOut, i32 0, i32 0		; <i32*> [#uses=1]
	%arrayidx422 = getelementptr i32, i32* %arraydecay421, i32 1		; <i32*> [#uses=1]
	%tmp423 = load i32, i32* %arrayidx422		; <i32> [#uses=1]
	%and424 = and i32 %tmp423, 65535		; <i32> [#uses=1]
	%or = or i32 %shl, %and424		; <i32> [#uses=1]
	store i32 %or, i32 addrspace(1)* %tmp416
	%tmp425 = load i32 addrspace(1)*, i32 addrspace(1)** %VoutPtr		; <i32 addrspace(1)*> [#uses=1]
	%arraydecay426 = getelementptr [2 x i32], [2 x i32]* %vOut, i32 0, i32 0		; <i32*> [#uses=1]
	%arrayidx427 = getelementptr i32, i32* %arraydecay426, i32 0		; <i32*> [#uses=1]
	%tmp428 = load i32, i32* %arrayidx427		; <i32> [#uses=1]
	%and429 = and i32 %tmp428, 65535		; <i32> [#uses=1]
	%shl430 = shl i32 %and429, 16		; <i32> [#uses=1]
	%arraydecay431 = getelementptr [2 x i32], [2 x i32]* %vOut, i32 0, i32 0		; <i32*> [#uses=1]
	%arrayidx432 = getelementptr i32, i32* %arraydecay431, i32 1		; <i32*> [#uses=1]
	%tmp433 = load i32, i32* %arrayidx432		; <i32> [#uses=1]
	%and434 = and i32 %tmp433, 65535		; <i32> [#uses=1]
	%or435 = or i32 %shl430, %and434		; <i32> [#uses=1]
	store i32 %or435, i32 addrspace(1)* %tmp425
	%tmp436 = load i32, i32* %pixel_index		; <i32> [#uses=1]
	%inc437 = add i32 %tmp436, 1		; <i32> [#uses=1]
	store i32 %inc437, i32* %pixel_index
	br label %for.inc

for.inc:		; preds = %for.body
	%tmp438 = load i32, i32* %iter		; <i32> [#uses=1]

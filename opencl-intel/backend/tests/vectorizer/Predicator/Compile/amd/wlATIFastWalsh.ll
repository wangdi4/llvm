...
entry:
	...
	%tmp1 = load i32, i32* %step.addr		; <i32> [#uses=2]
	...
	%tmp3 = load i32, i32* %step.addr		; <i32> [#uses=1]
	%mul = mul i32 2, %tmp3		; <i32> [#uses=1]
	%tmp4 = load i32, i32* %tid		; <i32> [#uses=1]
	%tmp5 = load i32, i32* %step.addr		; <i32> [#uses=2]
	...
	%tmp9 = load i32, i32* %group		; <i32> [#uses=1]
	%add = add i32 %mul8, %tmp9		; <i32> [#uses=1]
	store i32 %add, i32* %pair
	%tmp11 = load i32, i32* %pair		; <i32> [#uses=1]
	...
	%arrayidx = getelementptr float, float addrspace(1)* %tmp16, i32 %tmp15		; <float addrspace(1)*> [#uses=1]
	...
	%arrayidx21 = getelementptr float, float addrspace(1)* %tmp20, i32 %tmp19		; <float addrspace(1)*> [#uses=1]
	%tmp22 = load float, float addrspace(1)* %arrayidx21		; <float> [#uses=1]
	store float %tmp22, float* %T2
	%tmp23 = load i32, i32* %pair		; <i32> [#uses=1]
	%tmp24 = load float addrspace(1)*, float addrspace(1)** %tArray.addr		; <float addrspace(1)*> [#uses=1]
	%arrayidx25 = getelementptr float, float addrspace(1)* %tmp24, i32 %tmp23		; <float addrspace(1)*> [#uses=1]
	%tmp26 = load float, float* %T1		; <float> [#uses=1]
	%tmp27 = load float, float* %T2		; <float> [#uses=1]
	%add28 = fadd float %tmp26, %tmp27		; <float> [#uses=1]
	store float %add28, float addrspace(1)* %arrayidx25
	%tmp29 = load i32, i32* %match		; <i32> [#uses=1]
	%tmp30 = load float addrspace(1)*, float addrspace(1)** %tArray.addr		; <float addrspace(1)*> [#uses=1]
	%arrayidx31 = getelementptr float, float addrspace(1)* %tmp30, i32 %tmp29		; <float addrspace(1)*> [#uses=1]
	%tmp32 = load float, float* %T1		; <float> [#uses=1]
	%tmp33 = load float, float* %T2		; <float> [#uses=1]

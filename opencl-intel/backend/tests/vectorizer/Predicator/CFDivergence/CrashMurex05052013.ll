...
; CHECK: for.cond5.preheader.i20.i:    ; preds = %header129, %cond.end.i49.i
; CHECK-NEXT: %indvars.iv14.i15.i = phi i64 [ %indvars.iv.next15.i46.i, %cond.end.i49.i ], [ 1, %header129 ]
; CHECK: ret

...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %conv = bitcast i8 addrspace(2)* %arrayidx45 to i32*
  ...
  %conv53 = bitcast i8 addrspace(2)* %arrayidx52 to i32*
  ...
  %conv62 = bitcast i8 addrspace(2)* %arrayidx61 to i32*
  ...
  %conv71 = bitcast i8 addrspace(2)* %arrayidx70 to i32*
  ...
  %conv80 = bitcast i8 addrspace(2)* %arrayidx79 to i32*
  ...
  %conv89 = bitcast i8 addrspace(2)* %arrayidx88 to i32*
  ...
  %conv98 = bitcast i8 addrspace(2)* %arrayidx97 to i32*
  ...
  %conv107 = bitcast i8 addrspace(2)* %arrayidx106 to i32*

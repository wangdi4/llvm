...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %tmp14 = load <8 x i16>, <8 x i16> addrspace(1)* %arrayidx, align 16
  %arrayidx18 = getelementptr <8 x i16>, <8 x i16> addrspace(1)* %Vin, i32 %inc14
  %tmp19 = load <8 x i16>, <8 x i16> addrspace(1)* %arrayidx18, align 16
  %tmp21 = load <8 x i16>, <8 x i16> addrspace(2)* @uv_min_val_8_s16, align 16
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %tmp23 = load i16, i16 addrspace(1)* %arrayidx, align 2
  %add = add i16 %tmp27, %tmp23
  %arrayidx33 = getelementptr i16, i16 addrspace(1)* %Vin, i32 %inc4373142
  %tmp34 = load i16, i16 addrspace(1)* %arrayidx33, align 2
  ...
  %tmp222 = load i16, i16 addrspace(1)* %arrayidx221, align 2
  %add228 = add i16 %tmp222, %tmp207
  %arrayidx232 = getelementptr i16, i16 addrspace(1)* %Vin, i32 %inc
  %tmp233 = load i16, i16 addrspace(1)* %arrayidx232, align 2

; RUN: %oclopt -ChooseVectorizationDimensionModulePass -ocl-vecclone -ocl-vec-clone-isa-encoding-override=AVX512Core -S %s | FileCheck %s
...
; CHECK-LABEL: define void @_ZGVeN16uu_sample_test(
; CHECK-SAME: !vectorization_dimension ![[VEC_DIM:[0-9]*]]
; CHECK: ![[VEC_DIM]] = !{i32 0}

...
; RUN: %oclopt -runtimelib %p/../../Full/runtime.bc -analyze -dpcpp-kernel-analysis -cl-loop-bound -verify %t.bc -S -o %t1.ll
...
define void @cmp_select_eq_min_kernel(<4 x i8> addrspace(1)* nocapture %dst, i32 %width, i32 %height) nounwind {
...
!0 = !{void (<4 x i8> addrspace(1)*, i32, i32)* @cmp_select_eq_min_kernel}

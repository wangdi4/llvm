...
; CHECK: call fastcc i32 @foo1(i64 16)
  %call1 = tail call fastcc i32 @foo1() #4
  ret void
}
...
; CHECK: call fastcc i32 @foo1(i64 8)
  %call1 = tail call fastcc i32 @foo1() #4
  ret void
}

; CHECK-NOT: define fastcc i32 @foo1()
; CHECK-NOT: define fastcc i32 @foo()

define fastcc i32 @foo1() {
entry:

...
entry:
    %temp8 = lshr <4 x i8> %x8bits, %y8bits
    %temp16 = lshr <4 x i16> %x16bits, %y16bits
    %temp32 = lshr <4 x i32> %x32bits, %y32bits
    %temp64 = lshr <4 x i64> %x64bits, %y64bits
    
    %result8 = lshr <4 x i8> %x8bits, <i8 0, i8 8, i8 33, i8 32>
    %result16 = lshr <4 x i16> %x16bits, <i16 0, i16 17, i16 116, i16 8>
    %result32 = lshr <4 x i32> %x32bits, <i32 4, i32 31, i32 32, i32 33>
    %result64 = lshr <4 x i64> %x64bits, <i64 4, i64 65, i64 32, i64 33>

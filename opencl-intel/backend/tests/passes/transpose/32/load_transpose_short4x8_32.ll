...
; RUN: %oclopt -dpcpp-kernel-builtin-lib=clbltfns9.rtl -dpcpp-kernel-builtin-import -dpcpp-kernel-builtin-call-to-inst -instcombine -inline -scalarrepl -S %s -o %t3.ll

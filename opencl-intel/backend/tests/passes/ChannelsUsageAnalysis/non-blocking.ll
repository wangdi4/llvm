...
; CHECK: digraph G {
; CHECK: edge [arrowtail=obox,arrowhead=empty,dir=both,label="a"];
...
entry:
  ...
  %call1 = call i32 @__write_pipe_2_fpga(%opencl.pipe_wo_t addrspace(1)* %2, i8 addrspace(4)* %3, i32 4, i32 4)

...
; channel int a;
;
; __kernel void writer_non_blocking() {
;   write_channel_nb_intel(a, 10);
; }
;
; __kernel void reader_blocking(__global int *data) {
...
; CHECK: digraph G {
; CHECK: edge [arrowtail=obox,arrowhead=normal,dir=both,label="a"];
; CHECK-NEXT: "writer_non_blocking" -> "reader_blocking"
; CHECK-NEXT: }
...
define spir_kernel void @writer_non_blocking() #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !4 !kernel_arg_type !4 !kernel_arg_base_type !4 !kernel_arg_type_qual !4 !kernel_arg_host_accessible !4 !kernel_arg_pipe_depth !4 !kernel_arg_pipe_io !4 !kernel_arg_buffer_location !4 {
entry:
...
; Function Attrs: convergent nounwind
define spir_kernel void @reader_blocking(i32 addrspace(1)* %data) #0 !kernel_arg_addr_space !9 !kernel_arg_access_qual !10 !kernel_arg_type !11 !kernel_arg_base_type !11 !kernel_arg_type_qual !12 !kernel_arg_host_accessible !13 !kernel_arg_pipe_depth !14 !kernel_arg_pipe_io !12 !kernel_arg_buffer_location !12 {
entry:
  %read.dst = alloca i32

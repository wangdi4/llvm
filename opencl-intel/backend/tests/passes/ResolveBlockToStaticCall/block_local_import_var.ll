...
entry:
  ...
  %8 = load i32 (i32) addrspace(4)*, i32 (i32) addrspace(4)** %kernelBlock, align 8, !tbaa !19
  %block.literal = bitcast i32 (i32) addrspace(4)* %8 to %struct.__opencl_block_literal_generic addrspace(4)*
  %9 = getelementptr inbounds %struct.__opencl_block_literal_generic, %struct.__opencl_block_literal_generic addrspace(4)* %block.literal, i32 0, i32 2
  %10 = bitcast %struct.__opencl_block_literal_generic addrspace(4)* %block.literal to i8 addrspace(4)*
...
; CHECK-NOT: call i32 %
  ...
  %16 = bitcast i32 (i32) addrspace(4)** %kernelBlock to i8*

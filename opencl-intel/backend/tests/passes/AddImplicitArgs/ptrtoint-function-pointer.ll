...
define spir_kernel void @_ZTS1K(i32 %_arg_, i32 addrspace(1)* %_arg_1, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_AccessRange, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_MemRange, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_Offset, i32 addrspace(1)* %_arg_3, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_AccessRange5, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_MemRange6, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_Offset7, i32 addrspace(1)* %_arg_8, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_AccessRange10, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_MemRange11, %"class.cl::sycl::range"* byval nocapture readonly align 8 %_arg_Offset12) local_unnamed_addr #1 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !7 !kernel_arg_type_qual !8 {
entry:
  ...
  %call4.i = tail call spir_func i32 %11(i32 %8, i32 %9), !callees !13
  ...
  %call6.i = tail call spir_func i32 %13(i32 %8, i32 %9), !callees !13
  store i32 %call4.i, i32 addrspace(1)* %arrayidx.i.i, align 4, !tbaa !9
  store i32 %_arg_, i32 addrspace(1)* %add.ptr.i26, align 4, !tbaa !9
  ret void
}

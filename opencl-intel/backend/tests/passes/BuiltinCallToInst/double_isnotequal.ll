...
;CHECK-NOT: call i32 @_Z10isnotequaldd
;CHECK: [[cmp:%[a-zA-Z0-9]+]] = fcmp une double %0, %1
;CHECK-NEXT: [[zext:%[a-zA-Z0-9]+]] = zext i1 [[cmp]] to i32
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare i32 @_Z10isnotequaldd(double, double) #1
...
;CHECK-NOT: call <2 x i64> @_Z10isnotequalDv2_dS_
;CHECK: [[cmp2:%[a-zA-Z0-9]+]] = fcmp une <2 x double> %0, %1
;CHECK-NEXT: [[sext2:%[a-zA-Z0-9]+]] = sext <2 x i1> [[cmp2]] to <2 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <2 x i64> @_Z10isnotequalDv2_dS_(<2 x double>, <2 x double>) #1
...
;CHECK-NOT: call <3 x i64> @_Z10isnotequalDv3_dS_
;CHECK: [[cmp3:%[a-zA-Z0-9]+]] = fcmp une <3 x double> %extractVec, %extractVec3
;CHECK-NEXT: [[sext3:%[a-zA-Z0-9]+]] = sext <3 x i1> [[cmp3]] to <3 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <3 x i64> @_Z10isnotequalDv3_dS_(<3 x double>, <3 x double>) #1
...
;CHECK-NOT: call <4 x i64> @_Z10isnotequalDv4_dS_
;CHECK: [[cmp4:%[a-zA-Z0-9]+]] = fcmp une <4 x double> %0, %1
;CHECK-NEXT: [[sext4:%[a-zA-Z0-9]+]] = sext <4 x i1> [[cmp4]] to <4 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <4 x i64> @_Z10isnotequalDv4_dS_(<4 x double>, <4 x double>) #1
...
;CHECK-NOT: call <8 x i64> @_Z10isnotequalDv8_dS_
;CHECK: [[cmp8:%[a-zA-Z0-9]+]] = fcmp une <8 x double> %0, %1
;CHECK-NEXT: [[sext8:%[a-zA-Z0-9]+]] = sext <8 x i1> [[cmp2]] to <8 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <8 x i64> @_Z10isnotequalDv8_dS_(<8 x double>, <8 x double>) #1
...
;CHECK-NOT: call <16 x i64> @_Z10isnotequalDv16_dS_
;CHECK: [[cmp16:%[a-zA-Z0-9]+]] = fcmp une <16 x double> %0, %1
;CHECK-NEXT: [[sext16:%[a-zA-Z0-9]+]] = sext <16 x i1> [[cmp2]] to <16 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <16 x i64> @_Z10isnotequalDv16_dS_(<16 x double>, <16 x double>) #1

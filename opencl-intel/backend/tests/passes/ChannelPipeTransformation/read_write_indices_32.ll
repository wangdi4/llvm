...
; CHECK: %[[GEP_BAR_PIPE_ARR_W:.*]] = getelementptr {{.*}} @pipe.bar_arr, i32 0, i32 %[[BAR_PIPE_ARR_W_INDEX0]]
...
; CHECK: %[[GEP_FAR_PIPE_ARR_W:.*]] = getelementptr {{.*}} @pipe.far_arr, i32 0, i32 %[[FAR_PIPE_ARR_W_INDEX0]], i32 %[[FAR_PIPE_ARR_W_INDEX1]]
...
; CHECK: %[[GEP_STAR_PIPE_ARR_W:.*]] = getelementptr {{.*}} @pipe.star_arr, i32 0, i32 %[[STAR_PIPE_ARR_W_INDEX0]], i32 %[[STAR_PIPE_ARR_W_INDEX1]], i32 %[[STAR_PIPE_ARR_W_INDEX2]]
...
; CHECK: %[[GEP_LAR_PIPE_ARR_W:.*]] = getelementptr {{.*}} @pipe.lar_arr, i32 0, i32 %[[LAR_PIPE_ARR_W_INDEX0]], i32 %[[LAR_PIPE_ARR_W_INDEX1]], i32 %[[LAR_PIPE_ARR_W_INDEX2]], i32 %[[LAR_PIPE_ARR_W_INDEX3]]
...
; CHECK: %[[GEP_BAR_PIPE_ARR_R:.*]] = getelementptr {{.*}} @pipe.bar_arr, i32 0, i32 %[[BAR_PIPE_ARR_R_INDEX0]]
...
; CHECK: %[[GEP_FAR_PIPE_ARR_R:.*]] = getelementptr {{.*}} @pipe.far_arr, i32 0, i32 %[[FAR_PIPE_ARR_R_INDEX0]], i32 %[[FAR_PIPE_ARR_R_INDEX1]]
...
; CHECK: %[[GEP_STAR_PIPE_ARR_R:.*]] = getelementptr {{.*}} @pipe.star_arr, i32 0, i32 %[[STAR_PIPE_ARR_R_INDEX0]], i32 %[[STAR_PIPE_ARR_R_INDEX1]], i32 %[[STAR_PIPE_ARR_R_INDEX2]]
...
; CHECK: %[[GEP_LAR_PIPE_ARR_R:.*]] = getelementptr {{.*}} @pipe.lar_arr, i32 0, i32 %[[LAR_PIPE_ARR_R_INDEX0]], i32 %[[LAR_PIPE_ARR_R_INDEX1]], i32 %[[LAR_PIPE_ARR_R_INDEX2]], i32 %[[LAR_PIPE_ARR_R_INDEX3]]

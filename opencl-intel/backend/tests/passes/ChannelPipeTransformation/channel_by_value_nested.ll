...
;
; CHECK: define {{.*}} @sendData4(%opencl.pipe_t {{.*}}*, %opencl.pipe_t {{.*}}*, %opencl.pipe_t {{.*}}*, %opencl.pipe_t {{.*}}*)
; CHECK: %[[SD4_PIPE_A_ADDR:.*]] = alloca %opencl.pipe_t
; CHECK: %[[SD4_PIPE_B_ADDR:.*]] = alloca %opencl.pipe_t
; CHECK: %[[SD4_PIPE_C_ADDR:.*]] = alloca %opencl.pipe_t
; CHECK: %[[SD4_PIPE_D_ADDR:.*]] = alloca %opencl.pipe_t
...
; CHECK: %[[SD4_PIPE_BITCAST:.*]] = bitcast {{.*}} %[[SD4_PIPE]]
...
;
; CHECK: define {{.*}} @sendData3(%opencl.pipe_t {{.*}}*, %opencl.pipe_t {{.*}}*, %opencl.pipe_t {{.*}}*)
; CHECK: %[[SD3_PIPE_A_ADDR:.*]] = alloca %opencl.pipe_t
; CHECK: %[[SD3_PIPE_B_ADDR:.*]] = alloca %opencl.pipe_t
; CHECK: %[[SD3_PIPE_C_ADDR:.*]] = alloca %opencl.pipe_t
...
; CHECK: %[[SD3_PIPE_BITCAST:.*]] = bitcast {{.*}} %[[SD3_PIPE]]
...
;
; CHECK: define {{.*}} @sendData2(%opencl.pipe_t {{.*}}*, %opencl.pipe_t {{.*}}*)
; CHECK: %[[SD2_PIPE_A_ADDR:.*]] = alloca %opencl.pipe_t
; CHECK: %[[SD2_PIPE_B_ADDR:.*]] = alloca %opencl.pipe_t
; CHECK: store {{.*}} %0, {{.*}} %[[SD2_PIPE_A_ADDR]]
; CHECK: store {{.*}} %1, {{.*}} %[[SD2_PIPE_B_ADDR]]
; CHECK: %[[SD2_PIPE:.*]] = load {{.*}} %[[SD2_PIPE_A_ADDR]]
; CHECK: %[[SD2_PIPE_BITCAST:.*]] = bitcast {{.*}} %[[SD2_PIPE]]
; CHECK: call i32 @__write_pipe_2{{.*}} %[[SD2_PIPE_BITCAST]]
; CHECK: %[[SD2_PIPE_B:.*]] = load {{.*}} %[[SD2_PIPE_B_ADDR]]
; CHECK: call void @sendData1({{.*}} %[[SD2_PIPE_B]])
;
; CHECK: define {{.*}} @sendData1(%opencl.pipe_t {{.*}}*)
; CHECK: %[[SD1_PIPE_A_ADDR:.*]] = alloca %opencl.pipe_t
; CHECK: store {{.*}} %0, {{.*}} %[[SD1_PIPE_A_ADDR]]
; CHECK: %[[SD1_PIPE:.*]] = load {{.*}} %[[SD1_PIPE_A_ADDR]]
; CHECK: %[[SD1_PIPE_BITCAST:.*]] = bitcast {{.*}} %[[SD1_PIPE]]

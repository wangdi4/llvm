...
; CHECK: %[[CALL_STAR_ARR_PIPE:.*]] = call i32 @__write_pipe_2_intel({{.*}} %[[CAST_STAR_ARR_PIPE]], {{.*}}, i32 8, i32 4)
...
; CHECK: %[[CALL_BAR_PIPE1:.*]] = call i32 @__write_pipe_2_intel({{.*}} %[[CAST_BAR_PIPE1]], {{.*}}, i32 4, i32 4)
...
; CHECK: %[[CALL_STAR_ARR_PIPE1:.*]] = call i32 @__write_pipe_2_intel({{.*}} %[[CAST_STAR_ARR_PIPE1]], {{.*}}, i32 8, i32 4)

...
; CHECK: @t1
define void @t1(i32 %arg1, <2 x i32> %arg2, <2 x i32> %arg3, <3 x i32> %arg4, <16 x i32> %arg5, <4 x i32> %arg6, <8 x i32> %arg7 ) nounwind !kernel_arg_addr_space !1 !kernel_arg_access_qual !2 !kernel_arg_type !3 !kernel_arg_type_qual !4 !kernel_arg_name !5 {
entry:
  ret void
}
...
!3 = !{!"int", !"int2", !"int2", !"int3", !"int16", !"int4", !"int8"}
!4 = !{!"", !"", !"", !"", !"", !"", !""}

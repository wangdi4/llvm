...
; CHECK: @t1
define void @t1(i16 %arg1, <2 x i16> %arg2, <2 x i16> %arg3, <3 x i16> %arg4, <16 x i16> %arg5, <4 x i16> %arg6, <8 x i16> %arg7 ) nounwind !kernel_arg_addr_space !1 !kernel_arg_access_qual !2 !kernel_arg_type !3 !kernel_arg_type_qual !4 !kernel_arg_name !5 {
entry:
  ret void
}
...
; CHECK-NEXT: [[ARG5_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %pUniformArgs, i32 64
...
; CHECK-NEXT: [[ARG6_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %pUniformArgs, i32 80
...
!3 = !{!"short", !"short2", !"short2", !"short3", !"short16", !"short4", !"short8"}
!4 = !{!"", !"", !"", !"", !"", !"", !""}

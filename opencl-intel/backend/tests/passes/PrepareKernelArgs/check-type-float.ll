...
; CHECK: @t1
define void @t1(float %arg1) nounwind !kernel_arg_addr_space !1 !kernel_arg_access_qual !2 !kernel_arg_type !3 !kernel_arg_type_qual !4 !kernel_arg_name !5 {
entry:
  ret void
}
...
;;implicit args
;; call original func
; CHECK: call void @__t1_separated_args(float %explicit_0, [[IMPLICIT_ARGS:[a-zA-Z0-9]+]]
; CHECK-NEXT: ret void

...
; }
;
; __attribute__ ((max_global_work_dim(0))) __kernel void moo(__global int *iters) {
;   boo(*iters);
; }
; ----------------------------------------------------
; Compile options:
...
entry:
  %iters.addr = alloca i32, align 4
  store i32 %iters, i32* %iters.addr, align 4, !tbaa !6
  %0 = load i32, i32* %iters.addr, align 4, !tbaa !6
  call void @foo(i32 %0) #5
  ret void
}

; Function Attrs: convergent nounwind
define void @moo(i32 addrspace(1)* %iters) #2 !kernel_arg_addr_space !11 !kernel_arg_access_qual !12 !kernel_arg_type !13 !kernel_arg_base_type !13 !kernel_arg_type_qual !14 !kernel_arg_host_accessible !15 !kernel_arg_pipe_depth !16 !kernel_arg_pipe_io !14 !kernel_arg_buffer_location !14 !max_global_work_dim !16 {
entry:

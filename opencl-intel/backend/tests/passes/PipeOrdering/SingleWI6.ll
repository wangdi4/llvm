...
define void @moo(i32 addrspace(1)* %iters) #2 !kernel_arg_addr_space !13 !kernel_arg_access_qual !14 !kernel_arg_type !15 !kernel_arg_base_type !15 !kernel_arg_type_qual !16 !max_global_work_dim !17 {
entry:

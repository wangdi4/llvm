...
define void @boo(i32 addrspace(1)* %iters) #2 !kernel_arg_addr_space !8 !kernel_arg_access_qual !9 !kernel_arg_type !10 !kernel_arg_base_type !10 !kernel_arg_type_qual !11 {
entry:
  %iters.addr = alloca i32 addrspace(1)*, align 8
  store i32 addrspace(1)* %iters, i32 addrspace(1)** %iters.addr, align 8, !tbaa !13
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %iters.addr, align 8, !tbaa !13
  call void @foo(i32 addrspace(1)* %0)
  ret void
}
...
!7 = !{void (i32 addrspace(1)*)* @foo, void (i32 addrspace(1)*)* @boo}
!8 = !{i32 1}
!9 = !{!"none"}
!10 = !{!"int*"}
!11 = !{!""}

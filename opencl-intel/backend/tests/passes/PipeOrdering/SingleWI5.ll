...
; Function Attrs: nounwind
define void @moo(i32 addrspace(1)* %iters) #2 !kernel_arg_addr_space !13 !kernel_arg_access_qual !14 !kernel_arg_type !15 !kernel_arg_base_type !15 !kernel_arg_type_qual !16 {
entry:
  %iters.addr = alloca i32 addrspace(1)*, align 8
  store i32 addrspace(1)* %iters, i32 addrspace(1)** %iters.addr, align 8, !tbaa !18
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %iters.addr, align 8, !tbaa !18
...
!7 = !{void (i32 addrspace(1)*)* @boo, void (i32 addrspace(1)*)* @moo}
!8 = !{!9, !9, i64 0}
!9 = !{!"int", !10, i64 0}

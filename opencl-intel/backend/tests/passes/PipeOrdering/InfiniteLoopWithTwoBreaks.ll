...
define void @foo(i32 addrspace(1)* %flags) #0 !kernel_arg_addr_space !8 !kernel_arg_access_qual !9 !kernel_arg_type !10 !kernel_arg_base_type !10 !kernel_arg_type_qual !11 {
entry:
...
for.cond:                                         ; preds = %for.inc, %entry
  %1 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch, align 4, !tbaa !18
  store i32 42, i32* %write.src
  %2 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)* addrspace(1)* @pipe.ch
  %3 = bitcast %opencl.pipe_t addrspace(1)* %2 to %struct.__pipe_t addrspace(1)*
  %4 = addrspacecast i32* %write.src to i8 addrspace(4)*
  %5 = call i32 @__write_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %3, i8 addrspace(4)* %4)
...
if.end:                                           ; preds = %for.cond
  %9 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch, align 4, !tbaa !18
  store i32 42, i32* %write.src
  %10 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)* addrspace(1)* @pipe.ch
  %11 = bitcast %opencl.pipe_t addrspace(1)* %10 to %struct.__pipe_t addrspace(1)*
  %12 = addrspacecast i32* %write.src to i8 addrspace(4)*
  %13 = call i32 @__write_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %11, i8 addrspace(4)* %12)
...
if.end5:                                          ; preds = %if.end
  %18 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch, align 4, !tbaa !18
  store i32 42, i32* %write.src
  %19 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)* addrspace(1)* @pipe.ch
  %20 = bitcast %opencl.pipe_t addrspace(1)* %19 to %struct.__pipe_t addrspace(1)*
  %21 = addrspacecast i32* %write.src to i8 addrspace(4)*
  %22 = call i32 @__write_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %20, i8 addrspace(4)* %21)
  br label %for.inc

...
; CHECK: call void @llvm.memcpy.p1i8.p1i8.i32(i8 addrspace(1)* align 1 %0, i8 addrspace(1)* align 1 %1, i32 1000, i1 false)
; CHECK: ret

; CHECK: declare void @llvm.memcpy.p1i8.p1i8.i32(i8 addrspace(1)* noalias nocapture writeonly, i8 addrspace(1)* noalias nocapture readonly, i32, i1 immarg)

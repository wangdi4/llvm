...
; CHECK: %arrayidx7 = getelementptr inbounds i32, i32 addrspace(1)* %2, i32 2
...
; CHECK: %arrayidx3 = getelementptr inbounds i32, i32 addrspace(1)* %a12, i32 0
...
; CHECK: %arrayidx3 = getelementptr inbounds i32, i32 addrspace(3)* %a12, i32 0
...
entry:
  %arrayidx = getelementptr inbounds i32, i32 addrspace(4)* %a, i32 0
  store i32 0, i32 addrspace(4)* %arrayidx, align 4
  %arrayidx1 = getelementptr inbounds i32, i32 addrspace(4)* %a, i32 1
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %arrayidx6 = getelementptr inbounds i32, i32 addrspace(4)* %call, i32 8
...
if.then9:                                         ; preds = %if.end
  %arrayidx10 = getelementptr inbounds i32, i32 addrspace(4)* %12, i32 9
...
if.end15:                                         ; preds = %if.then12, %if.end11
  ...
  %add.ptr = getelementptr inbounds float, float addrspace(4)* %16, i32 10

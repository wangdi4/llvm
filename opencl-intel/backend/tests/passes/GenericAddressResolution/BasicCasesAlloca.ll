...
; CHECK: %7 = load i32 addrspace(4)*, i32 addrspace(4)** %pGen1, align 4
; CHECK: %28 = ptrtoint i32 addrspace(4)* %27 to i32
; CHECK: store i32 %28, i32* %intGen2, align 4
; CHECK: %29 = load i32, i32* %intGen2, align 4
; CHECK: %30 = inttoptr i32 %29 to i32 addrspace(4)*
; CHECK: %32 = load i32 addrspace(1)*, i32 addrspace(1)** %pGlobal.addr, align 4
; CHECK: %33 = bitcast i32 addrspace(1)* %32 to i32 addrspace(1)*
; CHECK: %34 = load i32 addrspace(3)*, i32 addrspace(3)** %pLocal.addr, align 4
...
; CHECK: %p116 = addrspacecast i32 addrspace(1)* %p115 to i32 addrspace(4)*
...
; CHECK: %0 = load i32 addrspace(4)*, i32 addrspace(4)** %p1.addr, align 4
; CHECK: %1 = load i32 addrspace(4)*, i32 addrspace(4)** %p2.addr, align 4
...
if.end:                                           ; preds = %entry
  %3 = load i32 addrspace(4)*, i32 addrspace(4)** %p2.addr, align 4
  store i32 addrspace(4)* %3, i32 addrspace(4)** %retval
  br label %return

return:                                           ; preds = %if.end, %if.then
  %4 = load i32 addrspace(4)*, i32 addrspace(4)** %retval
...
if.then:                                          ; preds = %entry
  %14 = load i32 addrspace(1)*, i32 addrspace(1)** %pGlobal.addr, align 4
  %15 = addrspacecast i32 addrspace(1)* %14 to i32 addrspace(4)*
  store i32 addrspace(4)* %15, i32 addrspace(4)** %pGen1, align 4
  br label %if.end

if.else:                                          ; preds = %entry
  %16 = load i32 addrspace(3)*, i32 addrspace(3)** %pLocal.addr, align 4
  %17 = addrspacecast i32 addrspace(3)* %16 to i32 addrspace(4)*
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %20 = addrspacecast i32 addrspace(1)* %19 to i32 addrspace(4)*
  ...
  %30 = load i32 addrspace(3)*, i32 addrspace(3)** %pLocal.addr, align 4
...
if.end11:                                         ; preds = %if.then9, %if.end
  %40 = load i32 addrspace(4)*, i32 addrspace(4)** %pGen3, align 4
  %41 = load i32 addrspace(4)*, i32 addrspace(4)** %pGen1, align 4

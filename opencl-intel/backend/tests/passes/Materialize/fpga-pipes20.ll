...
; CHECK: %{{[0-9]+}} = call i32 @__read_pipe_2_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %{{[0-9]+}})
  %3 = call i32 @__read_pipe_2(%opencl.pipe_t addrspace(1)* %0, i8 addrspace(4)* %2, i32 4, i32 4)
...
; CHECK: %{{[0-9]+}} = call i32 @__read_pipe_2_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %{{[0-9]+}})
  %7 = call i32 @__read_pipe_2(%opencl.pipe_t addrspace(1)* %4, i8 addrspace(4)* %6, i32 4, i32 4)
...
; CHECK: %{{[0-9]+}} = call i32 @__read_pipe_2_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %{{[0-9]+}})
  %11 = call i32 @__read_pipe_2(%opencl.pipe_t addrspace(1)* %8, i8 addrspace(4)* %10, i32 4, i32 4)
  ret void
}
...
entry:
  ...
  %1 = load i32 addrspace(1)*, i32 addrspace(1)** %ptr.addr, align 4
  %2 = addrspacecast i32 addrspace(1)* %1 to i8 addrspace(4)*
; CHECK: %{{[0-9]+}} = call i32 @__write_pipe_2_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %{{[0-9]+}})
  %3 = call i32 @__write_pipe_2(%opencl.pipe_t addrspace(1)* %0, i8 addrspace(4)* %2, i32 4, i32 4)
  %4 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)** %p.addr, align 4
  %5 = load i32 addrspace(3)*, i32 addrspace(3)** %ptr_l, align 4
  %6 = addrspacecast i32 addrspace(3)* %5 to i8 addrspace(4)*
; CHECK: %{{[0-9]+}} = call i32 @__write_pipe_2_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %{{[0-9]+}})
  %7 = call i32 @__write_pipe_2(%opencl.pipe_t addrspace(1)* %4, i8 addrspace(4)* %6, i32 4, i32 4)
  %8 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)** %p.addr, align 4
  %9 = load i32 addrspace(4)*, i32 addrspace(4)** %ptr_p, align 4
  %10 = bitcast i32 addrspace(4)* %9 to i8 addrspace(4)*
; CHECK: %{{[0-9]+}} = call i32 @__write_pipe_2_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %{{[0-9]+}})
  %11 = call i32 @__write_pipe_2(%opencl.pipe_t addrspace(1)* %8, i8 addrspace(4)* %10, i32 4, i32 4)
  ...
  %15 = call i32 @__write_pipe_2(%opencl.pipe_t addrspace(1)* %12, i8 addrspace(4)* %14, i32 4, i32 4)
; CHECK: %{{[0-9]+}} = call i32 @__write_pipe_2_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %{{[0-9]+}})
  ret void
}

declare i32 @__write_pipe_2(%opencl.pipe_t addrspace(1)*, i8 addrspace(4)*, i32, i32)

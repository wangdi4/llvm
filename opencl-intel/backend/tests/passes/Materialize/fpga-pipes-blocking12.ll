...
; CHECK: %{{[0-9]+}} = call i32 @__read_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %[[GL2GEN]])
  %3 = call i32 @__read_pipe_2_bl_AS1(%opencl.pipe_t addrspace(1)* %0, i8 addrspace(1)* %2, i32 4, i32 4)
...
; CHECK: %{{[0-9]+}} = call i32 @__read_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %[[LO2GEN]])
  %7 = call i32 @__read_pipe_2_bl_AS3(%opencl.pipe_t addrspace(1)* %4, i8 addrspace(3)* %6, i32 4, i32 4)
...
; CHECK: %{{[0-9]+}} = call i32 @__read_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %[[PR2GEN]])
  %11 = call i32 @__read_pipe_2_bl_AS0(%opencl.pipe_t addrspace(1)* %8, i8* %10, i32 4, i32 4)
  ret void
}

declare i32 @__read_pipe_2_bl_AS1(%opencl.pipe_t addrspace(1)*, i8 addrspace(1)*, i32, i32)

declare i32 @__read_pipe_2_bl_AS3(%opencl.pipe_t addrspace(1)*, i8 addrspace(3)*, i32, i32)

declare i32 @__read_pipe_2_bl_AS0(%opencl.pipe_t addrspace(1)*, i8*, i32, i32)
...
entry:
  ...
  %2 = bitcast i32 addrspace(1)* %1 to i8 addrspace(1)*
; CHECK: [[GL2GEN:[0-9]+]] = addrspacecast i8 addrspace(1)* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK: %{{[0-9]+}} = call i32 @__write_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %[[GL2GEN]])
  %3 = call i32 @__write_pipe_2_bl_AS1(%opencl.pipe_t addrspace(1)* %0, i8 addrspace(1)* %2, i32 4, i32 4)
  %4 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)** %p.addr, align 4
  %5 = load i32 addrspace(3)*, i32 addrspace(3)** %ptr_l, align 4
  %6 = bitcast i32 addrspace(3)* %5 to i8 addrspace(3)*
; CHECK: [[LO2GEN:[0-9]+]] = addrspacecast i8 addrspace(3)* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK: %{{[0-9]+}} = call i32 @__write_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %[[LO2GEN]])
  %7 = call i32 @__write_pipe_2_bl_AS3(%opencl.pipe_t addrspace(1)* %4, i8 addrspace(3)* %6, i32 4, i32 4)
  %8 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)** %p.addr, align 4
  %9 = load i32*, i32** %ptr_p, align 4
  %10 = bitcast i32* %9 to i8*
; CHECK: [[PR2GEN:[0-9]+]] = addrspacecast i8* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK: %{{[0-9]+}} = call i32 @__write_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %[[PR2GEN]])
  %11 = call i32 @__write_pipe_2_bl_AS0(%opencl.pipe_t addrspace(1)* %8, i8* %10, i32 4, i32 4)
...
; CHECK: %{{[0-9]+}} = call i32 @__write_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %{{[0-9]+}}, i8 addrspace(4)* %[[CO2GEN]])
  %15 = call i32 @__write_pipe_2_bl_AS2(%opencl.pipe_t addrspace(1)* %12, i8 addrspace(2)* %14, i32 4, i32 4)
  ret void
}

declare i32 @__write_pipe_2_bl_AS1(%opencl.pipe_t addrspace(1)*, i8 addrspace(1)*, i32, i32)

declare i32 @__write_pipe_2_bl_AS3(%opencl.pipe_t addrspace(1)*, i8 addrspace(3)*, i32, i32)

declare i32 @__write_pipe_2_bl_AS0(%opencl.pipe_t addrspace(1)*, i8*, i32, i32)

declare i32 @__write_pipe_2_bl_AS2(%opencl.pipe_t addrspace(1)*, i8 addrspace(2)*, i32, i32)

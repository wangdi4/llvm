; RUN: %oclopt -runtimelib=%p/../../vectorizer/Full/runtime.bc -dpcpp-kernel-builtin-lib=%p/../../vectorizer/Full/runtime.bc -sycl-pipes-hack -dpcpp-demangle-fpga-pipes -dpcpp-kernel-equalizer -S %s -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
; RUN: %oclopt -runtimelib=%p/../../vectorizer/Full/runtime.bc -dpcpp-kernel-builtin-lib=%p/../../vectorizer/Full/runtime.bc -sycl-pipes-hack -dpcpp-demangle-fpga-pipes -dpcpp-kernel-equalizer -verify -S %s -o - | FileCheck %s

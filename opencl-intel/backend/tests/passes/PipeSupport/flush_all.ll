...
; CHECK:      %[[READ_ARR:[0-9]+]] = alloca i8 addrspace(1)*, i32 37
  ...
  %call3 = call i32 @__read_pipe_2_bl_intel(%opencl.pipe_ro_t addrspace(1)* %3, i8 addrspace(4)* %4, i32 4, i32 4)
...
; CHECK:      %[[RET0:.*]] = call i32 @__read_pipe_2_intel(%opencl.pipe_ro_t addrspace(1)* %[[PIPE0RO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR]]
  ...
  %call12 = call i32 @__read_pipe_2_bl_intel(%opencl.pipe_ro_t addrspace(1)* %9, i8 addrspace(4)* %10, i32 4, i32 4)
...
; CHECK:      %[[RET1:.*]] = call i32 @__read_pipe_2_intel(%opencl.pipe_ro_t addrspace(1)* %[[PIPE1RO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR]]
  ...
  %17 = call i32 @__read_pipe_2_bl_intel(%opencl.pipe_ro_t addrspace(1)* %15, i8 addrspace(4)* %16, i32 16, i32 8)
...
; CHECK:      %[[RET2:.*]] = call i32 @__read_pipe_2_intel(%opencl.pipe_ro_t addrspace(1)* %[[PIPE2RO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR]]
  ...
  %22 = call i32 @__write_pipe_2_bl_intel(%opencl.pipe_wo_t addrspace(1)* %20, i8 addrspace(4)* %21, i32 4, i32 4)
...
; CHECK:      %[[RET3:.*]] = call i32 @__write_pipe_2_intel(%opencl.pipe_wo_t addrspace(1)* %[[PIPE3WO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR]]
  ...
  %call21 = call i32 @__read_pipe_2_bl_intel(%opencl.pipe_ro_t addrspace(1)* %26, i8 addrspace(4)* %27, i32 4, i32 4)
...
; CHECK:      %[[RET4:.*]] = call i32 @__read_pipe_2_intel(%opencl.pipe_ro_t addrspace(1)* %[[PIPE4RO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR]]
  ...
  %33 = call i32 @__write_pipe_2_bl_intel(%opencl.pipe_wo_t addrspace(1)* %31, i8 addrspace(4)* %32, i32 4, i32 4)
...
; CHECK:      %[[RET5:.*]] = call i32 @__write_pipe_2_intel(%opencl.pipe_wo_t addrspace(1)* %[[PIPE5WO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR]]
  ...
  %38 = call i32 @__read_pipe_2_intel(%opencl.pipe_ro_t addrspace(1)* %35, i8 addrspace(4)* %37, i32 4, i32 4)
...
; CHECK:      %[[RET6:.*]] = call i32 @__read_pipe_2_intel(%opencl.pipe_ro_t addrspace(1)* %[[PIPE6RO]]
...
; CHECK:      %[[READ_ARR1:[0-9]+]] = alloca i8 addrspace(1)*, i32 37
  ...
  %4 = call i32 @__write_pipe_2_bl_intel(%opencl.pipe_wo_t addrspace(1)* %2, i8 addrspace(4)* %3, i32 4, i32 4)
...
; CHECK:      %[[RET7:.*]] = call i32 @__write_pipe_2_intel(%opencl.pipe_wo_t addrspace(1)* %[[PIPE7WO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR1]]
  ...
  %9 = call i32 @__write_pipe_2_bl_intel(%opencl.pipe_wo_t addrspace(1)* %7, i8 addrspace(4)* %8, i32 4, i32 4)
...
; CHECK:      %[[RET8:.*]] = call i32 @__write_pipe_2_intel(%opencl.pipe_wo_t addrspace(1)* %[[PIPE8WO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR1]]
  ...
  %16 = call i32 @__write_pipe_2_bl_intel(%opencl.pipe_wo_t addrspace(1)* %14, i8 addrspace(4)* %15, i32 16, i32 8)
...
; CHECK:      %[[RET9:.*]] = call i32 @__write_pipe_2_intel(%opencl.pipe_wo_t addrspace(1)* %[[PIPE9WO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR1]]
  ...
  %call2 = call i32 @__read_pipe_2_bl_intel(%opencl.pipe_ro_t addrspace(1)* %20, i8 addrspace(4)* %21, i32 4, i32 4)
...
; CHECK:      %[[RET10:.*]] = call i32 @__read_pipe_2_intel(%opencl.pipe_ro_t addrspace(1)* %[[PIPE10RO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR1]]
  ...
  %27 = call i32 @__write_pipe_2_bl_intel(%opencl.pipe_wo_t addrspace(1)* %25, i8 addrspace(4)* %26, i32 4, i32 4)
...
; CHECK:      %[[RET11:.*]] = call i32 @__write_pipe_2_intel(%opencl.pipe_wo_t addrspace(1)* %[[PIPE11WO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR1]]
  ...
  %call11 = call i32 @__read_pipe_2_bl_intel(%opencl.pipe_ro_t addrspace(1)* %31, i8 addrspace(4)* %32, i32 4, i32 4)
...
; CHECK:      %[[RET12:.*]] = call i32 @__read_pipe_2_intel(%opencl.pipe_ro_t addrspace(1)* %[[PIPE12RO]]
...
; CHECK-NEXT: call void @__flush_pipe_write_array(i8 addrspace(1)** %[[WRITE_ARR1]]
  ...
  %37 = addrspacecast i8* %36 to i8 addrspace(4)*
  %38 = call i32 @__write_pipe_2_intel(%opencl.pipe_wo_t addrspace(1)* %35, i8 addrspace(4)* %37, i32 4, i32 4)
...
; CHECK:      %[[RET13:.*]] = call i32 @__write_pipe_2_intel(%opencl.pipe_wo_t addrspace(1)* %[[PIPE13WO]]
...
entry:
  call void @__pipe_init_intel(%struct.__pipe_t addrspace(1)* bitcast ([328 x i8] addrspace(1)* @c1.pipe.bs to %struct.__pipe_t addrspace(1)*), i32 4, i32 0, i32 0)
  ...
  call void @__pipe_init_intel(%struct.__pipe_t addrspace(1)* bitcast ([328 x i8] addrspace(1)* @c2.pipe.bs to %struct.__pipe_t addrspace(1)*), i32 4, i32 0, i32 0)
  ...
  call void @__pipe_init_intel(%struct.__pipe_t addrspace(1)* bitcast ([352 x i8] addrspace(1)* @c3.pipe.bs to %struct.__pipe_t addrspace(1)*), i32 16, i32 0, i32 0)
  ...
  call void @__pipe_init_intel(%struct.__pipe_t addrspace(1)* bitcast ([328 x i8] addrspace(1)* @c5.pipe.bs to %struct.__pipe_t addrspace(1)*), i32 4, i32 0, i32 0)

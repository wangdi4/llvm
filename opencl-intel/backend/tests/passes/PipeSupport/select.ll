...
@ch1.pipe = addrspace(1) global %opencl.pipe_t addrspace(1)* null, align 8
@ch1.pipe.bs = addrspace(1) global [1408 x i8] zeroinitializer, align 4
@ch2.pipe = addrspace(1) global %opencl.pipe_t addrspace(1)* null, align 8
@ch2.pipe.bs = addrspace(1) global [1408 x i8] zeroinitializer, align 4
...
entry:
  ...
  %ch2.val3 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)* addrspace(1)* @ch2.pipe
  %ch2.val = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch2, align 4
  %ch1.val1 = load %opencl.pipe_t addrspace(1)*, %opencl.pipe_t addrspace(1)* addrspace(1)* @ch1.pipe
  %ch1.val = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch1, align 4
  %0 = select i1 %tobool, %opencl.pipe_t addrspace(1)* %ch2.val3, %opencl.pipe_t addrspace(1)* %ch1.val1
  ...
  %call12 = call i32 @__read_pipe_2_bl_intel(%struct.__pipe_t addrspace(1)* %2, i8 addrspace(4)* %3)
  %4 = load i32, i32* %read.dst
  store i32 %4, i32 addrspace(1)* %res, align 4, !tbaa !13
  ret void

; CHECK:      call void @__store_pipe_use({{.*}} %struct.__pipe_t addrspace(1)* %[[PIPE:[0-9]+]]
; CHECK:      %[[CALL:.+]] = call i32 @__read_pipe_2_intel(%struct.__pipe_t addrspace(1)* %[[PIPE]]
...
entry:
  store %opencl.pipe_t addrspace(1)* bitcast ([1408 x i8] addrspace(1)* @ch1.pipe.bs to %opencl.pipe_t addrspace(1)*), %opencl.pipe_t addrspace(1)* addrspace(1)* @ch1.pipe
  call void @__pipe_init_intel(%struct.__pipe_t addrspace(1)* bitcast (%opencl.pipe_t addrspace(1)* addrspace(1)* @ch1.pipe to %struct.__pipe_t addrspace(1)*), i32 4, i32 1)
  store %opencl.pipe_t addrspace(1)* bitcast ([1408 x i8] addrspace(1)* @ch2.pipe.bs to %opencl.pipe_t addrspace(1)*), %opencl.pipe_t addrspace(1)* addrspace(1)* @ch2.pipe
  call void @__pipe_init_intel(%struct.__pipe_t addrspace(1)* bitcast (%opencl.pipe_t addrspace(1)* addrspace(1)* @ch2.pipe to %struct.__pipe_t addrspace(1)*), i32 4, i32 1)
  ret void
}

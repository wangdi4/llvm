...
; CHECK: declare !kernel_wrapper {{![0-9]}} !scalar_kernel {{![0-9]}} void @____Vectorized_.test_separated_args
...
define void @____Vectorized_.test_separated_args(i32 addrspace(1)* noalias %dst, i8 addrspace(3)* noalias %pLocalMemBase, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* noalias %pWorkDim, i64* noalias %pWGId, [4 x i64] %BaseGlbId, i8* noalias %pSpecialBuf, {}* noalias %RuntimeHandle) !kernel_wrapper !3 !scalar_kernel !0 {
  ret void
}
...
define void @__Vectorized_.test(i8* noalias %pUniformArgs, i64* noalias %pWGId, {}* noalias %RuntimeHandle) !scalar_kernel !0 {
  ret void
}

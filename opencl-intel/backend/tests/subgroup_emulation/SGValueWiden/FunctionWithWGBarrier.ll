...
sg.dummy.bb.2:                                    ; preds = %sg.barrier.bb.
  call void @dummy_sg_barrier()
  %0 = load i32, i32* %lid.addr, align 4
...
sg.dummy.bb.:                                     ; preds = %sg.barrier.bb.
  call void @dummy_sg_barrier()
  %1 = load i32 addrspace(1)*, i32 addrspace(1)** %scan_add.addr, align 8
  %2 = load i32, i32* %lid, align 4
  %idxprom = sext i32 %2 to i64
  %ptridx = getelementptr inbounds i32, i32 addrspace(1)* %1, i64 %idxprom
  store i32 %call1, i32 addrspace(1)* %ptridx, align 4
  br label %sg.barrier.bb.1

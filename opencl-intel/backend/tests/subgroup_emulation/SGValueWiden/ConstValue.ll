...
; CHECK-NEXT: %.splatinsert = insertelement <16 x i64> undef, i64 %[[#OP1]], i32 0
; CHECK-NEXT: %.splat = shufflevector <16 x i64> %.splatinsert, <16 x i64> undef, <16 x i32> zeroinitializer
...
; CHECK-NEXT: store i32 %[[#OP3]], i32* %u.call, align 4

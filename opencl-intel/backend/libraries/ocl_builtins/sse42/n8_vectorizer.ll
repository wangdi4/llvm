...
entry:
  ...
  %f = call i1 @__ocl_allOne_v4_i32(<4 x i32> %v)
  ret i1 %f
}
...
entry:
  ...
  %f0 = call i1 @__ocl_allOne_v8_i32(<8 x i32> %v1_7)
  %f1 = call i1 @__ocl_allOne_v8_i32(<8 x i32> %v2_7)
  %f = and i1 %f0, %f1
  ret i1 %f
}
...
entry:
  ...
  %f0 = call i1 @__ocl_allOne_v8(<8 x i1> %v1_7)
  %f1 = call i1 @__ocl_allOne_v8(<8 x i1> %v2_7)
  %f = and i1 %f0, %f1
  ret i1 %f
}
...
entry:
  ...
  %res = call i1 @__ocl_allOne_v2(<2 x i1> %t)
  ret i1 %res
}
...
entry:
  ...
  %res = call i1 @__ocl_allOne_v4(<4 x i1> %t)
  ret i1 %res
}
...
entry:
  ...
  %res = call i1 @__ocl_allOne_v8(<8 x i1> %t)
  ret i1 %res
}
...
entry:
  ...
  %res = call i1 @__ocl_allOne_v16(<16 x i1> %t)
  ret i1 %res
}
...
entry:
  %t = xor i32 %pred, -1
  %f = call i1 @__ocl_allOne_i32(i32 %t)
  ret i1 %f
}
...
entry:
  ...
  %res = call i1 @__ocl_allOne_v2_i32(<2 x i32> %t)
  ret i1 %res
}

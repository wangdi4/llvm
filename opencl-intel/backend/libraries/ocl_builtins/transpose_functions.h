...
void INLINE_ATTRIBUTE  __ocl_load_transpose_char_4x16(__private char4* pLoadAdd, __private char16* xOut, __private char16* yOut, __private char16* zOut, __private char16* wOut);

void INLINE_ATTRIBUTE  __ocl_gather_transpose_char_4x16(__private char4* pLoadAdd0, __private char4* pLoadAdd1, __private char4* pLoadAdd2, __private char4* pLoadAdd3,

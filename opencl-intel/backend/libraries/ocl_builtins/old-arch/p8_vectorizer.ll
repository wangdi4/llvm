...
entry:
  %one = shufflevector <8 x i32> %pred, <8 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %two = shufflevector <8 x i32> %pred, <8 x i32> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %v = and <4 x i32> %one, %two
  %f = call i1 @allOne_v4_i32(<4 x i32> %v)
  ret i1 %f
}

...
"@ICC_CPU_CL_NATIVE@" @ICC_COMPILER_PARAMS@ @BUILD_TYPE_ICC_COMPILER_FLAGS_Release@ /D%4 %5 /Fo%3 %2
goto fin

:debug
"@ICC_CPU_CL_NATIVE@" @ICC_COMPILER_PARAMS@ @BUILD_TYPE_ICC_COMPILER_FLAGS_Debug@ /D%4 %5 /Fo%3 %2

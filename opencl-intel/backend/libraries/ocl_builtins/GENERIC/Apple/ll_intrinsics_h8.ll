...
define <16 x i8> @__ocl_trunc_v3i64_v3i8(<3 x i64>* byval align 32 %x) nounwind {
  %tmp = load <3 x i64>* %x, align 32
  %tmp2 = shufflevector <3  x i64> %tmp, <3 x i64> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  %1 = trunc <4 x i64> %tmp2 to <4 x i8>
  %ret = shufflevector <4 x i8> %1, <4 x i8> <i8 0, i8 undef, i8 undef, i8 undef>, <16 x i32> <i32 0, i32 1, i32 2, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4>
  ret <16 x i8> %ret
}
...
define <8 x i16> @__ocl_trunc_v3i64_v3i16(<3 x i64>* byval align 32 %x) nounwind {
  %tmp = load <3 x i64>* %x, align 32
  %tmp2 = shufflevector <3  x i64> %tmp, <3 x i64> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  %1 = trunc <4 x i64> %tmp2 to <4 x i16>
  %ret = shufflevector <4 x i16> %1, <4 x i16> <i16 0, i16 undef, i16 undef, i16 undef>, <8 x i32> <i32 0, i32 1, i32 2, i32 4, i32 4, i32 4, i32 4, i32 4>
  ret <8 x i16> %ret
}
...
define <4 x i32> @__ocl_trunc_v3i64_v3i32(<3 x i64>* byval align 32 %x) nounwind {
  %tmp = load <3 x i64>* %x, align 32
  %tmp2 = shufflevector <3  x i64> %tmp, <3 x i64> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  %1 = trunc <4 x i64> %tmp2 to <4 x i32>
  ret <4 x i32> %1
}
...
define <16 x i8> @__ocl_trunc_v4i64_v4i8(<4 x i64>* byval align 32 %x) nounwind {
  %tmp = load <4 x i64>* %x, align 32
...
define <8 x i16> @__ocl_trunc_v4i64_v4i16(<4 x i64>* byval align 32 %x) nounwind {
  %tmp = load <4 x i64>* %x, align 32
...
define <4 x i32> @__ocl_trunc_v4i64_v4i32(<4 x i64>* byval align 32 %x) nounwind {
  %tmp = load <4 x i64>* %x, align 32
...
define <16 x i8> @__ocl_trunc_v8i32_v8i8(<8 x i32>* byval align 32 %x) nounwind {
  %tmp = load <8 x i32>* %x, align 32
  %1 = trunc <8 x i32> %tmp to <8 x i8>
  %ret = shufflevector <8 x i8> %1, <8 x i8> <i8 0, i8 undef, i8 undef, i8 undef, i8 undef, i8 undef, i8 undef, i8 undef>, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8>
  ret <16 x i8> %ret
}
...
define <8 x i16> @__ocl_trunc_v8i32_v8i16(<8 x i32>* byval align 32 %x) nounwind {
  %tmp = load <8 x i32>* %x, align 32
  %1 = trunc <8 x i32> %tmp to <8 x i16>
  ret <8 x i16> %1
}
...
define <8 x i64> @__ocl_zext_v8i32_v8i64(<8 x i32>* byval align 32 %x) nounwind {
  %tmp = load <8 x i32>* %x, align 32
  %1 = zext <8 x i32> %tmp to <8 x i64>
  ret <8 x i64> %1
}

define <8 x i64> @__ocl_sext_v8i32_v8i64(<8 x i32>* byval align 32 %x) nounwind {
  %tmp = load <8 x i32>* %x, align 32
  %1 = sext <8 x i32> %tmp to <8 x i64>
  ret <8 x i64> %1
}
...
define <16 x i8> @__ocl_trunc_v16i16_v16i8(<16 x i16>* byval align 32 %x) nounwind {
  %tmp = load <16 x i16>* %x, align 32
  %1 = trunc <16 x i16> %tmp to <16 x i8>
  ret <16 x i8> %1
}
...
define <16 x i32> @__ocl_zext_v16i16_v16i32(<16 x i16>* byval align 32 %x) nounwind {
  %tmp = load <16 x i16>* %x, align 32
  %1 = zext <16 x i16> %tmp to <16 x i32>
  ret <16 x i32> %1
}

define <16 x i32> @__ocl_sext_v16i16_v16i32(<16 x i16>* byval align 32 %x) nounwind {
  %tmp = load <16 x i16>* %x, align 32
  %1 = sext <16 x i16> %tmp to <16 x i32>
  ret <16 x i32> %1
}
...
define void @__ocl_zext_v16i16_v16i64(<16 x i64>* %sret, <16 x i16>* byval align 32 %x) nounwind {
  %tmp = load <16 x i16>* %x, align 32
  %1 = zext <16 x i16> %tmp to <16 x i64>
  store <16 x i64> %1, <16 x i64>* %sret, align 128
  ret void
}

define void @__ocl_sext_v16i16_v16i64(<16 x i64>* %sret, <16 x i16>* byval align 32 %x) nounwind {
  %tmp = load <16 x i16>* %x, align 32
  %1 = sext <16 x i16> %tmp to <16 x i64>
  store <16 x i64> %1, <16 x i64>* %sret, align 128
  ret void
}

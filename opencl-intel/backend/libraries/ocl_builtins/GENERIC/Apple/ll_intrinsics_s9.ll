...
define <8 x i16> @__ocl_zext_v2i8_v2i16(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <2 x i32> <i32 0, i32 1>
...
define <8 x i16> @__ocl_sext_v2i8_v2i16(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <2 x i32> <i32 0, i32 1>
...
define <16 x i8> @__ocl_trunc_v2i16_v2i8(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <2 x i32> <i32 0, i32 1>
...
define <4 x i32> @__ocl_zext_v2i8_v2i32(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <2 x i32> <i32 0, i32 1>
...
define <4 x i32> @__ocl_sext_v2i8_v2i32(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <2 x i32> <i32 0, i32 1>
...
define <16 x i8> @__ocl_trunc_v2i32_v2i8(<4 x i32> %x) nounwind {
  %tmp = shufflevector <4 x i32> %x, <4 x i32> undef, <2 x i32> <i32 0, i32 1>
  %1 = trunc <2 x i32> %tmp to <2 x i8>
  %ret = shufflevector <2 x i8> %1, <2 x i8> <i8 0, i8 undef>, <16 x i32> <i32 0, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
  ret <16 x i8> %ret
}

define <2 x i64> @__ocl_zext_v2i8_v2i64(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <2 x i32> <i32 0, i32 1>
  %1 = zext <2 x i8> %tmp to <2 x i64>
  ret <2 x i64> %1
}

define <2 x i64> @__ocl_sext_v2i8_v2i64(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <2 x i32> <i32 0, i32 1>
...
define <4 x i32> @__ocl_zext_v2i16_v2i32(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <2 x i32> <i32 0, i32 1>
...
define <4 x i32> @__ocl_sext_v2i16_v2i32(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <2 x i32> <i32 0, i32 1>
...
define <8 x i16> @__ocl_trunc_v2i32_v2i16(<4 x i32> %x) nounwind {
  %tmp = shufflevector <4 x i32> %x, <4 x i32> undef, <2 x i32> <i32 0, i32 1>
...
define <2 x i64> @__ocl_zext_v2i16_v2i64(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <2 x i32> <i32 0, i32 1>
  %1 = zext <2 x i16> %tmp to <2 x i64>
  ret <2 x i64> %1
}

define <2 x i64> @__ocl_sext_v2i16_v2i64(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <2 x i32> <i32 0, i32 1>
...
define <2 x i64> @__ocl_zext_v2i32_v2i64(<4 x i32> %x) nounwind {
  %tmp = shufflevector <4 x i32> %x, <4 x i32> undef, <2 x i32> <i32 0, i32 1>
  %1 = zext <2 x i32> %tmp to <2 x i64>
  ret <2 x i64> %1
}

define <2 x i64> @__ocl_sext_v2i32_v2i64(<4 x i32> %x) nounwind {
  %tmp = shufflevector <4 x i32> %x, <4 x i32> undef, <2 x i32> <i32 0, i32 1>
...
define <8 x i16> @__ocl_zext_v3i8_v3i16(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
define <8 x i16> @__ocl_sext_v3i8_v3i16(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
define <16 x i8> @__ocl_trunc_v3i16_v3i8(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
define <4 x i32> @__ocl_zext_v3i8_v3i32(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i8> %tmp to <4 x i32>
  ret <4 x i32> %1
}

define <4 x i32> @__ocl_sext_v3i8_v3i32(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = sext <4 x i8> %tmp to <4 x i32>
  ret <4 x i32> %1
}

define <16 x i8> @__ocl_trunc_v3i32_v3i8(<4 x i32> %x) nounwind {
  %tmp = shufflevector <4 x i32> %x, <4 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = trunc <4 x i32> %tmp to <4 x i8>
  %ret = shufflevector <4 x i8> %1, <4 x i8> <i8 0, i8 undef, i8 undef, i8 undef>, <16 x i32> <i32 0, i32 1, i32 2, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4>
  ret <16 x i8> %ret
}

define <4 x i64> @__ocl_zext_v3i8_v3i64(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i8> %tmp to <4 x i64>
  ret <4 x i64> %1
}

define <4 x i64> @__ocl_sext_v3i8_v3i64(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
define <4 x i32> @__ocl_zext_v3i16_v3i32(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i16> %tmp to <4 x i32>
  ret <4 x i32> %1
}

define <4 x i32> @__ocl_sext_v3i16_v3i32(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = sext <4 x i16> %tmp to <4 x i32>
  ret <4 x i32> %1
}

define <8 x i16> @__ocl_trunc_v3i32_v3i16(<4 x i32> %x) nounwind {
  %tmp = shufflevector <4 x i32> %x, <4 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
define <4 x i64> @__ocl_zext_v3i16_v3i64(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i16> %tmp to <4 x i64>
  ret <4 x i64> %1
}

define <4 x i64> @__ocl_sext_v3i16_v3i64(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
define <4 x i64> @__ocl_zext_v3i32_v3i64(<4 x i32> %x) nounwind {
  %tmp = shufflevector <4 x i32> %x, <4 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i32> %tmp to <4 x i64>
  ret <4 x i64> %1
}

define <4 x i64> @__ocl_sext_v3i32_v3i64(<4 x i32> %x) nounwind {
  %tmp = shufflevector <4 x i32> %x, <4 x i32> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
define <8 x i16> @__ocl_zext_v4i8_v4i16(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i8> %tmp to <4 x i16>
...
define <8 x i16> @__ocl_sext_v4i8_v4i16(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = sext <4 x i8> %tmp to <4 x i16>
  %ret = shufflevector <4 x i16> %1, <4 x i16> <i16 0, i16 undef, i16 undef, i16 undef>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 4, i32 4, i32 4>
  ret <8 x i16> %ret
...
define <16 x i8> @__ocl_trunc_v4i16_v4i8(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = trunc <4 x i16> %tmp to <4 x i8>
...
define <4 x i32> @__ocl_zext_v4i8_v4i32(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i8> %tmp to <4 x i32>
  ret <4 x i32> %1
}

define <4 x i32> @__ocl_sext_v4i8_v4i32(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = sext <4 x i8> %tmp to <4 x i32>
  ret <4 x i32> %1
}
...
define <4 x i64> @__ocl_zext_v4i8_v4i64(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i8> %tmp to <4 x i64>
  ret <4 x i64> %1
}

define <4 x i64> @__ocl_sext_v4i8_v4i64(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = sext <4 x i8> %tmp to <4 x i64>
  ret <4 x i64> %1
}
...
define <4 x i32> @__ocl_zext_v4i16_v4i32(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i16> %tmp to <4 x i32>
  ret <4 x i32> %1
}

define <4 x i32> @__ocl_sext_v4i16_v4i32(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = sext <4 x i16> %tmp to <4 x i32>
  ret <4 x i32> %1
}
...
define <4 x i64> @__ocl_zext_v4i16_v4i64(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = zext <4 x i16> %tmp to <4 x i64>
  ret <4 x i64> %1
}

define <4 x i64> @__ocl_sext_v4i16_v4i64(<8 x i16> %x) nounwind {
  %tmp = shufflevector <8 x i16> %x, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = sext <4 x i16> %tmp to <4 x i64>
  ret <4 x i64> %1
}
...
define <8 x i16> @__ocl_zext_v8i8_v8i16(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %1 = zext <8 x i8> %tmp to <8 x i16>
  ret <8 x i16> %1
}

define <8 x i16> @__ocl_sext_v8i8_v8i16(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
define <4 x i64> @__ocl_zext_v8i8_v8i32(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %1 = zext <8 x i8> %tmp to <8 x i32>
  %ret = bitcast <8 x i32> %1 to <4 x i64>
  ret <4 x i64> %ret
}

define <4 x i64> @__ocl_sext_v8i8_v8i32(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
define <8 x i64> @__ocl_zext_v8i8_v8i64(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %1 = zext <8 x i8> %tmp to <8 x i64>
  ret <8 x i64> %1
}

define <8 x i64> @__ocl_sext_v8i8_v8i64(<16 x i8> %x) nounwind {
  %tmp = shufflevector <16 x i8> %x, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %1 = sext <8 x i8> %tmp to <8 x i64>
  ret <8 x i64> %1
}

define <16 x i8> @__ocl_trunc_v8i64_v8i8(<8 x i64> %x) nounwind {
  %1 = trunc <8 x i64> %x to <8 x i8>
  %ret = shufflevector <8 x i8> %1, <8 x i8> <i8 0, i8 undef, i8 undef, i8 undef, i8 undef, i8 undef, i8 undef, i8 undef>, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8>
  ret <16 x i8> %ret
}

define <4 x i64> @__ocl_zext_v8i16_v8i32(<8 x i16> %x) nounwind {
  %1 = zext <8 x i16> %x to <8 x i32>
  %ret = bitcast <8 x i32> %1 to <4 x i64>
  ret <4 x i64> %ret
}

define <4 x i64> @__ocl_sext_v8i16_v8i32(<8 x i16> %x) nounwind {
...
define <8 x i16> @__ocl_trunc_v8i64_v8i16(<8 x i64> %x) nounwind {
...
define <4 x i64> @__ocl_trunc_v8i64_v8i32(<8 x i64> %x) nounwind {
  %1 = trunc <8 x i64> %x to <8 x i32>
  %ret = bitcast <8 x i32> %1 to <4 x i64>
  ret <4 x i64> %ret
}

define <4 x i64> @__ocl_zext_v16i8_v16i16(<16 x i8> %x) nounwind {
  %1 = zext <16 x i8> %x to <16 x i16>
  %ret = bitcast <16 x i16> %1 to <4 x i64>
  ret <4 x i64> %ret
}

define <4 x i64> @__ocl_sext_v16i8_v16i16(<16 x i8> %x) nounwind {
...
define <16 x i8> @__ocl_trunc_v16i32_v16i8(<16 x i32> %x) nounwind {
...
define <16 x i8> @__ocl_trunc_v16i64_v16i8(<16 x i64> %x) nounwind {
...
define <4 x i64> @__ocl_trunc_v16i32_v16i16(<16 x i32> %x) nounwind {
...
define <4 x i64> @__ocl_trunc_v16i64_v16i16(<16 x i64> %x) nounwind {
  %1 = trunc <16 x i64> %x to <16 x i16>
  %ret = bitcast <16 x i16> %1 to <4 x i64>
  ret <4 x i64> %ret
}

define void @__ocl_zext_v16i32_v16i64(<16 x i64>* %sret, <16 x i32> %x) nounwind {
  %1 = zext <16 x i32> %x to <16 x i64>
  store <16 x i64> %1, <16 x i64>* %sret, align 128
  ret void
}

define void @__ocl_sext_v16i32_v16i64(<16 x i64>* %sret, <16 x i32> %x) nounwind {
  %1 = sext <16 x i32> %x to <16 x i64>
  store <16 x i64> %1, <16 x i64>* %sret, align 128
  ret void
}

define <16 x i32> @__ocl_trunc_v16i64_v16i32(<16 x i64> %x) nounwind {

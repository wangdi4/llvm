...
define <16 x float> @gather.v16f32_ind_v16i64(float* %addr, <16 x i64>%index) {
  ...
  %t0 = call <8 x float> @llvm.x86.avx512.gather.qps.512(<8 x float> undef, i8* %ptr, <8 x i64> %index0, i8 -1, i32 4)
  %t1 = call <8 x float> @llvm.x86.avx512.gather.qps.512(<8 x float> undef, i8* %ptr, <8 x i64> %index1, i8 -1, i32 4)
...
define <16 x float> @masked_gather.v16f32_ind_v16i64(<16 x i1> %mask, float* %addr, <16 x i64>%index) {
  ...
  %t0 = call <8 x float> @llvm.x86.avx512.gather.qps.512(<8 x float> undef, i8* %ptr, <8 x i64> %index0, i8 %imask0, i32 4)
  %t1 = call <8 x float> @llvm.x86.avx512.gather.qps.512(<8 x float> undef, i8* %ptr, <8 x i64> %index1, i8 %imask1, i32 4)
  %t2 = shufflevector <8 x float> %t0, <8 x float> %t1,
            <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7,
             i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ret <16 x float> %t2
...
define <16 x double> @gather.v16f64_ind_v16i64 (double* %addr, <16 x i64>%index) {
  ...
  %index1 = shufflevector <16 x i64> %index, <16 x i64> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %t0 = call <8 x double> @llvm.x86.avx512.gather.qpd.512(<8 x double> undef, i8* %ptr, <8 x i64> %index0, i8 -1, i32 8)
  %t1 = call <8 x double> @llvm.x86.avx512.gather.qpd.512(<8 x double> undef, i8* %ptr, <8 x i64> %index1, i8 -1, i32 8)
  %t2 = shufflevector <8 x double> %t0, <8 x double> %t1,
            <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7,
             i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ret <16 x double> %t2
...
define <16 x double> @masked_gather.v16f64_ind_v16i64(<16 x i1> %mask, double* %addr, <16 x i64>%index) {
  ...
  %mask1 = shufflevector <16 x i1> %mask, <16 x i1> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %imask1 = bitcast <8 x i1> %mask1 to i8
  %t0 = call <8 x double> @llvm.x86.avx512.gather.qpd.512(<8 x double> undef, i8* %ptr, <8 x i64> %index0, i8 %imask0, i32 8)
  %t1 = call <8 x double> @llvm.x86.avx512.gather.qpd.512(<8 x double> undef, i8* %ptr, <8 x i64> %index1, i8 %imask1, i32 8)
  %t2 = shufflevector <8 x double> %t0, <8 x double> %t1,
            <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7,
             i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ret <16 x double> %t2
...
define <16 x i32> @gather.v16i32_ind_v16i64(i32* %addr, <16 x i64>%index) {
  ...
  %index1 = shufflevector <16 x i64> %index, <16 x i64> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %t0 = call <8 x i32> @llvm.x86.avx512.gather.qpi.512(<8 x i32> undef, i8* %ptr, <8 x i64> %index0, i8 -1, i32 4)
  %t1 = call <8 x i32> @llvm.x86.avx512.gather.qpi.512(<8 x i32> undef, i8* %ptr, <8 x i64> %index1, i8 -1, i32 4)
...
define <16 x i32> @masked_gather.v16i32_ind_v16i64(<16 x i1> %mask, i32* %addr, <16 x i64>%index) {
  ...
  %mask1 = shufflevector <16 x i1> %mask, <16 x i1> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %imask1 = bitcast <8 x i1> %mask1 to i8
  %t0 = call <8 x i32> @llvm.x86.avx512.gather.qpi.512(<8 x i32> undef, i8* %ptr, <8 x i64> %index0, i8 %imask0, i32 4)
  %t1 = call <8 x i32> @llvm.x86.avx512.gather.qpi.512(<8 x i32> undef, i8* %ptr, <8 x i64> %index1, i8 %imask1, i32 4)
  %t2 = shufflevector <8 x i32> %t0, <8 x i32> %t1,
            <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7,
             i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ret <16 x i32> %t2
...
define <16 x i64> @gather.v16i64_ind_v16i64 (i64* %addr, <16 x i64>%index) {
  ...
  %index1 = shufflevector <16 x i64> %index, <16 x i64> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %t0 = call <8 x i64> @llvm.x86.avx512.gather.qpq.512(<8 x i64> undef, i8* %ptr, <8 x i64> %index0, i8 -1, i32 8)
  %t1 = call <8 x i64> @llvm.x86.avx512.gather.qpq.512(<8 x i64> undef, i8* %ptr, <8 x i64> %index1, i8 -1, i32 8)
  %t2 = shufflevector <8 x i64> %t0, <8 x i64> %t1,
            <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7,
             i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ret <16 x i64> %t2
...
define <16 x i64> @masked_gather.v16i64_ind_v16i64(<16 x i1> %mask, i64* %addr, <16 x i64>%index) {
  ...
  %mask1 = shufflevector <16 x i1> %mask, <16 x i1> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %imask1 = bitcast <8 x i1> %mask1 to i8
  %t0 = call <8 x i64> @llvm.x86.avx512.gather.qpq.512(<8 x i64> undef, i8* %ptr, <8 x i64> %index0, i8 %imask0, i32 8)
  %t1 = call <8 x i64> @llvm.x86.avx512.gather.qpq.512(<8 x i64> undef, i8* %ptr, <8 x i64> %index1, i8 %imask1, i32 8)
  %t2 = shufflevector <8 x i64> %t0, <8 x i64> %t1,
            <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7,
             i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ret <16 x i64> %t2
...
define void @scatter.v16f32_ind_v16i64 (float* %addr,
  ...
  %index1 = shufflevector <16 x i64> %index, <16 x i64> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  call void @llvm.x86.avx512.scatter.qps.512(i8* %ptr, i8 -1, <8 x i64> %index0,
                                    <8 x float> %data0,
                                    i32 4) ; scale 4
  call void @llvm.x86.avx512.scatter.qps.512(i8* %ptr, i8 -1, <8 x i64> %index1,
                                    <8 x float> %data1,
                                    i32 4) ; scale 4
  ret void
}
...
define void @scatter.v16i32_ind_v16i64 (i32* %addr,
  ...
  %index1 = shufflevector <16 x i64> %index, <16 x i64> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  call void @llvm.x86.avx512.scatter.qpi.512(i8* %ptr, i8 -1, <8 x i64> %index0,
                                    <8 x i32> %data0,
                                    i32 4) ; scale 4
  call void @llvm.x86.avx512.scatter.qpi.512(i8* %ptr, i8 -1, <8 x i64> %index1,
                                    <8 x i32> %data1,
                                    i32 4) ; scale 4
  ret void
}
...
define void @masked_scatter.v16f32_ind_v16i64 (<16 x i1> %mask, float* %addr,
  ...
  %mask1 = shufflevector <16 x i1> %mask, <16 x i1> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %imask1 = bitcast <8 x i1> %mask1 to i8
  call void @llvm.x86.avx512.scatter.qps.512(i8* %ptr, i8 %imask0, <8 x i64> %index0,
                                    <8 x float> %data0,
                                    i32 4) ; scale 4
  call void @llvm.x86.avx512.scatter.qps.512(i8* %ptr, i8 %imask1, <8 x i64> %index1,
                                    <8 x float> %data1,
                                    i32 4) ; scale 4
  ret void
}
...
define void @scatter.v16f64_ind_v16i64 (double* %addr, <16 x i64>%index, <16 x double> %data) {
  ...
  %index1 = shufflevector <16 x i64> %index, <16 x i64> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  call void @llvm.x86.avx512.scatter.qpd.512(i8* %ptr, i8 -1, <8 x i64> %index0,
                                    <8 x double> %data0,
                                    i32 8) ; scale 8
  call void @llvm.x86.avx512.scatter.qpd.512(i8* %ptr, i8 -1, <8 x i64> %index1,
                                    <8 x double> %data1,
                                    i32 8) ; scale 8
  ret void
}
...
define void @masked_scatter.v16f64_ind_v16i64 (<16 x i1> %mask, double* %addr,
  ...
  %mask1 = shufflevector <16 x i1> %mask, <16 x i1> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %imask1 = bitcast <8 x i1> %mask1 to i8
  call void @llvm.x86.avx512.scatter.qpd.512(i8* %ptr, i8 %imask0, <8 x i64> %index0,
                                    <8 x double> %data0,
                                    i32 8) ; scale 4
  call void @llvm.x86.avx512.scatter.qpd.512(i8* %ptr, i8 %imask1, <8 x i64> %index1,
                                    <8 x double> %data1,
                                    i32 8) ; scale 4
  ret void
}
...
define void @masked_scatter.v16i32_ind_v16i64 (<16 x i1> %mask, i32* %addr,
  ...
  %mask1 = shufflevector <16 x i1> %mask, <16 x i1> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %imask1 = bitcast <8 x i1> %mask1 to i8
  call void @llvm.x86.avx512.scatter.qpi.512(i8* %ptr, i8 %imask0, <8 x i64> %index0,
                                    <8 x i32> %data0,
                                    i32 4) ; scale 4
  call void @llvm.x86.avx512.scatter.qpi.512(i8* %ptr, i8 %imask1, <8 x i64> %index1,
                                    <8 x i32> %data1,
                                    i32 4) ; scale 4
  ret void
}
...
define void @scatter.v16i64_ind_v16i64 (i64* %addr, <16 x i64>%index, <16 x i64> %data) {
  ...
  %index1 = shufflevector <16 x i64> %index, <16 x i64> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  call void @llvm.x86.avx512.scatter.qpq.512(i8* %ptr, i8 -1, <8 x i64> %index0,
                                    <8 x i64> %data0,
                                    i32 8) ; scale 8
  call void @llvm.x86.avx512.scatter.qpq.512(i8* %ptr, i8 -1, <8 x i64> %index1,
                                    <8 x i64> %data1,
                                    i32 8) ; scale 8
  ret void
}
...
define void @masked_scatter.v16i64_ind_v16i64 (<16 x i1> %mask, i64* %addr,
  ...
  %mask1 = shufflevector <16 x i1> %mask, <16 x i1> undef,
            <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %imask1 = bitcast <8 x i1> %mask1 to i8
  call void @llvm.x86.avx512.scatter.qpq.512(i8* %ptr, i8 %imask0, <8 x i64> %index0,
                                    <8 x i64> %data0,
                                    i32 8) ; scale 4
  call void @llvm.x86.avx512.scatter.qpq.512(i8* %ptr, i8 %imask1, <8 x i64> %index1,
                                    <8 x i64> %data1,
                                    i32 8) ; scale 4
  ret void
}

...
def main():
    ...
    __attribute__((svmlcc)) __attribute__((const)) float   __ocl_svml_{arch}_cvtfp64tofp32up1(double);
    __attribute__((svmlcc)) __attribute__((const)) float2  __ocl_svml_{arch}_cvtfp64tofp32up2(double2);
    __attribute__((svmlcc)) __attribute__((const)) float3  __ocl_svml_{arch}_cvtfp64tofp32up3(double3);
    __attribute__((svmlcc)) __attribute__((const)) float4  __ocl_svml_{arch}_cvtfp64tofp32up4(double4);
    __attribute__((svmlcc)) __attribute__((const)) float8  __ocl_svml_{arch}_cvtfp64tofp32up8(double8);
    __attribute__((svmlcc)) __attribute__((const)) float16 __ocl_svml_{arch}_cvtfp64tofp32up16(double16);

    __attribute__((svmlcc)) __attribute__((const)) float   __ocl_svml_{arch}_cvtfp64tofp32down1(double);
    __attribute__((svmlcc)) __attribute__((const)) float2  __ocl_svml_{arch}_cvtfp64tofp32down2(double2);
    __attribute__((svmlcc)) __attribute__((const)) float3  __ocl_svml_{arch}_cvtfp64tofp32down3(double3);
    __attribute__((svmlcc)) __attribute__((const)) float4  __ocl_svml_{arch}_cvtfp64tofp32down4(double4);
    __attribute__((svmlcc)) __attribute__((const)) float8  __ocl_svml_{arch}_cvtfp64tofp32down8(double8);
    __attribute__((svmlcc)) __attribute__((const)) float16 __ocl_svml_{arch}_cvtfp64tofp32down16(double16);
    ...
    """.format(arch=target.svml_id))
        ...
        # _attribute__((svmlcc)) __attribute__((const)) int    __ocl_svml_{arch}_cvtfptoi32rtnnosatf1(float);
        ...
        # _attribute__((svmlcc)) __attribute__((const)) int    __ocl_svml_{arch}_cvtfptoi32rtnsatf1(float);
        ...
        # _attribute__((svmlcc)) __attribute__((const)) int    __ocl_svml_{arch}_cvtfptoi32rtnnosat1(double);
        ...
        # _attribute__((svmlcc)) __attribute__((const)) int    __ocl_svml_{arch}_cvtfptoi32rtnsat1(double);

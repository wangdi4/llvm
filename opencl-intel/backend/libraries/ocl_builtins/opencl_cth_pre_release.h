...
// atomic_sub
float __attribute__((overloadable))
atomic_sub(volatile __global float *p, float val);
float __attribute__((overloadable))
atomic_sub(volatile __local float *p, float val);

#if defined(cl_khr_fp64)
double __attribute__((overloadable))
atomic_sub(volatile __global double *p, double val);
double __attribute__((overloadable))
atomic_sub(volatile __local double *p, double val);
#endif // #if defined(cl_khr_fp64)

// atom_min
float __attribute__((overloadable))
atomic_min(volatile __global float *p, float val);
float __attribute__((overloadable))
atomic_min(volatile __local float *p, float val);
...
// atom_max
float __attribute__((overloadable))
atomic_max(volatile __global float *p, float val);
float __attribute__((overloadable))
atomic_max(volatile __local float *p, float val);
...
sub_group_broadcast(int x, uint sub_group_local_id);
uint __attribute__((overloadable))
sub_group_broadcast(uint x, uint sub_group_local_id);
long __attribute__((overloadable))
sub_group_broadcast(long x, uint sub_group_local_id);
ulong __attribute__((overloadable))
sub_group_broadcast(ulong x, uint sub_group_local_id);
float __attribute__((overloadable))
sub_group_broadcast(float x, uint sub_group_local_id);
...
#if defined(cl_khr_fp64)
double __attribute__((overloadable))
sub_group_broadcast(double x, uint sub_group_local_id);
...
sub_group_broadcast(char x, uint sub_group_local_id);
uchar __attribute__((overloadable))
sub_group_broadcast(uchar x, uint sub_group_local_id);
char2 __attribute__((overloadable))
sub_group_broadcast(char2 x, uint sub_group_local_id);
uchar2 __attribute__((overloadable))
sub_group_broadcast(uchar2 x, uint sub_group_local_id);
char3 __attribute__((overloadable))
sub_group_broadcast(char3 x, uint sub_group_local_id);
uchar3 __attribute__((overloadable))
sub_group_broadcast(uchar3 x, uint sub_group_local_id);
char4 __attribute__((overloadable))
sub_group_broadcast(char4 x, uint sub_group_local_id);
uchar4 __attribute__((overloadable))
sub_group_broadcast(uchar4 x, uint sub_group_local_id);
char8 __attribute__((overloadable))
sub_group_broadcast(char8 x, uint sub_group_local_id);
uchar8 __attribute__((overloadable))
sub_group_broadcast(uchar8 x, uint sub_group_local_id);
char16 __attribute__((overloadable))
sub_group_broadcast(char16 x, uint sub_group_local_id);
uchar16 __attribute__((overloadable))
sub_group_broadcast(uchar16 x, uint sub_group_local_id);

short __attribute__((overloadable))
sub_group_broadcast(short x, uint sub_group_local_id);
ushort __attribute__((overloadable))
sub_group_broadcast(ushort x, uint sub_group_local_id);
short2 __attribute__((overloadable))
sub_group_broadcast(short2 x, uint sub_group_local_id);
ushort2 __attribute__((overloadable))
sub_group_broadcast(ushort2 x, uint sub_group_local_id);
short3 __attribute__((overloadable))
sub_group_broadcast(short3 x, uint sub_group_local_id);
ushort3 __attribute__((overloadable))
sub_group_broadcast(ushort3 x, uint sub_group_local_id);
short4 __attribute__((overloadable))
sub_group_broadcast(short4 x, uint sub_group_local_id);
ushort4 __attribute__((overloadable))
sub_group_broadcast(ushort4 x, uint sub_group_local_id);
short8 __attribute__((overloadable))
sub_group_broadcast(short8 x, uint sub_group_local_id);
ushort8 __attribute__((overloadable))
sub_group_broadcast(ushort8 x, uint sub_group_local_id);
short16 __attribute__((overloadable))
sub_group_broadcast(short16 x, uint sub_group_local_id);
ushort16 __attribute__((overloadable))
sub_group_broadcast(ushort16 x, uint sub_group_local_id);
...
sub_group_broadcast(int2 x, uint sub_group_local_id);
uint2 __attribute__((overloadable))
sub_group_broadcast(uint2 x, uint sub_group_local_id);
int3 __attribute__((overloadable))
sub_group_broadcast(int3 x, uint sub_group_local_id);
uint3 __attribute__((overloadable))
sub_group_broadcast(uint3 x, uint sub_group_local_id);
int4 __attribute__((overloadable))
sub_group_broadcast(int4 x, uint sub_group_local_id);
uint4 __attribute__((overloadable))
sub_group_broadcast(uint4 x, uint sub_group_local_id);
int8 __attribute__((overloadable))
sub_group_broadcast(int8 x, uint sub_group_local_id);
uint8 __attribute__((overloadable))
sub_group_broadcast(uint8 x, uint sub_group_local_id);
int16 __attribute__((overloadable))
sub_group_broadcast(int16 x, uint sub_group_local_id);
uint16 __attribute__((overloadable))
sub_group_broadcast(uint16 x, uint sub_group_local_id);

float __attribute__((overloadable))
sub_group_broadcast(float x, uint sub_group_local_id);
float2 __attribute__((overloadable))
sub_group_broadcast(float2 x, uint sub_group_local_id);
float3 __attribute__((overloadable))
sub_group_broadcast(float3 x, uint sub_group_local_id);
float4 __attribute__((overloadable))
sub_group_broadcast(float4 x, uint sub_group_local_id);
float8 __attribute__((overloadable))
sub_group_broadcast(float8 x, uint sub_group_local_id);
float16 __attribute__((overloadable))
sub_group_broadcast(float16 x, uint sub_group_local_id);

#if defined(cl_khr_fp64)
double __attribute__((overloadable))
sub_group_broadcast(double x, uint sub_group_local_id);
double2 __attribute__((overloadable))
sub_group_broadcast(double2 x, uint sub_group_local_id);
double3 __attribute__((overloadable))
sub_group_broadcast(double3 x, uint sub_group_local_id);
double4 __attribute__((overloadable))
sub_group_broadcast(double4 x, uint sub_group_local_id);
double8 __attribute__((overloadable))
sub_group_broadcast(double8 x, uint sub_group_local_id);
double16 __attribute__((overloadable))
sub_group_broadcast(double16 x, uint sub_group_local_id);
#endif
...
// reduce logical
int __attribute__((overloadable))
sub_group_non_uniform_reduce_logical_and(int x);
int __attribute__((overloadable))
sub_group_non_uniform_reduce_logical_or(int x);
int __attribute__((overloadable))
sub_group_non_uniform_reduce_logical_xor(int x);

// scan_inclusive
char __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(ulong x);
float __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(float x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(ulong x);
float __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(float x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(ulong x);
float __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(float x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(ulong x);
float __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(float x);

// scan_inclusive bitwise
char __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_and(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_and(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_and(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_and(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_and(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_and(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_and(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_and(ulong x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_or(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_or(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_or(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_or(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_or(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_or(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_or(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_or(ulong x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_xor(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_xor(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_xor(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_xor(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_xor(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_xor(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_xor(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_xor(ulong x);

// scan_inclusive logical
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_logical_and(int x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_logical_or(int x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_logical_xor(int x);

// scan_exclusive
char __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(ulong x);
float __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(float x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(ulong x);
float __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(float x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(ulong x);
float __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(float x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(ulong x);
float __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(float x);

// scan_exclusive bitwise
char __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_and(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_and(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_and(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_and(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_and(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_and(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_and(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_and(ulong x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_or(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_or(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_or(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_or(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_or(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_or(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_or(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_or(ulong x);

char __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_xor(char x);
uchar __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_xor(uchar x);
short __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_xor(short x);
ushort __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_xor(ushort x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_xor(int x);
uint __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_xor(uint x);
long __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_xor(long x);
ulong __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_xor(ulong x);

// scan_exclusive logical
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_logical_and(int x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_logical_or(int x);
int __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_logical_xor(int x);
...
double __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_add(double x);
double __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(double x);
double __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(double x);
double __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(double x);

double __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(double x);
double __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(double x);
double __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(double x);
double __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(double x);
#endif
...
sub_group_non_uniform_scan_inclusive_add(half x);
half __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_min(half x);
half __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_max(half x);
half __attribute__((overloadable))
sub_group_non_uniform_scan_inclusive_mul(half x);

half __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_add(half x);
half __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_min(half x);
half __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_max(half x);
half __attribute__((overloadable))
sub_group_non_uniform_scan_exclusive_mul(half x);
#endif
...
char __attribute__((overloadable)) sub_group_shuffle_xor(char x, uint c);
uchar __attribute__((overloadable)) sub_group_shuffle_xor(uchar x, uint c);
short __attribute__((overloadable)) sub_group_shuffle_xor(short x, uint c);
ushort __attribute__((overloadable)) sub_group_shuffle_xor(ushort x, uint c);
int __attribute__((overloadable)) sub_group_shuffle_xor(int x, uint c);
uint __attribute__((overloadable)) sub_group_shuffle_xor(uint x, uint c);
long __attribute__((overloadable)) sub_group_shuffle_xor(long x, uint c);
ulong __attribute__((overloadable)) sub_group_shuffle_xor(ulong x, uint c);
float __attribute__((overloadable)) sub_group_shuffle_xor(float x, uint c);
#if defined(cl_khr_fp64)
double __attribute__((overloadable)) sub_group_shuffle(double x, uint c);
double __attribute__((overloadable)) sub_group_shuffle_xor(double x, uint c);
#endif
#if defined(cl_khr_fp16)
...
float16 __attribute__((overloadable))
intel_sub_group_shuffle(float16 x, uint c);
...
int __attribute__((overloadable))
intel_sub_group_shuffle_down(int cur, int next, uint c);
int2 __attribute__((overloadable))
...
int __attribute__((overloadable))
intel_sub_group_shuffle_up(int prev, int cur, uint c);
int2 __attribute__((overloadable))
...
float __attribute__((overloadable))
intel_sub_group_shuffle_xor(float x, uint c);
float2 __attribute__((overloadable))
intel_sub_group_shuffle_xor(float2 x, uint c);
float3 __attribute__((overloadable))
intel_sub_group_shuffle_xor(float3 x, uint c);
float4 __attribute__((overloadable))
intel_sub_group_shuffle_xor(float4 x, uint c);
float8 __attribute__((overloadable))
intel_sub_group_shuffle_xor(float8 x, uint c);
float16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(float16 x, uint c);
...
int16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(int16 x, uint c);

uint __attribute__((overloadable)) intel_sub_group_shuffle_xor(uint x, uint c);
uint2 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uint2 x, uint c);
uint3 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uint3 x, uint c);
uint4 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uint4 x, uint c);
uint8 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uint8 x, uint c);
uint16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uint16 x, uint c);

long __attribute__((overloadable)) intel_sub_group_shuffle_xor(long x, uint c);
ulong __attribute__((overloadable))
intel_sub_group_shuffle_xor(ulong x, uint c);
...
uint __attribute__((overloadable))
intel_sub_group_block_read(const __global uint *p);
uint2 __attribute__((overloadable))
intel_sub_group_block_read2(const __global uint *p);
uint4 __attribute__((overloadable))
intel_sub_group_block_read4(const __global uint *p);
uint8 __attribute__((overloadable))
intel_sub_group_block_read8(const __global uint *p);

// ui
uint __attribute__((overloadable))
intel_sub_group_block_read_ui(read_only image2d_t image, int2 coord);
uint2 __attribute__((overloadable))
intel_sub_group_block_read_ui2(read_only image2d_t image, int2 coord);
uint4 __attribute__((overloadable))
intel_sub_group_block_read_ui4(read_only image2d_t image, int2 coord);
uint8 __attribute__((overloadable))
intel_sub_group_block_read_ui8(read_only image2d_t image, int2 coord);

uint __attribute__((overloadable))
intel_sub_group_block_read_ui(const __global uint *p);
uint2 __attribute__((overloadable))
intel_sub_group_block_read_ui2(const __global uint *p);
uint4 __attribute__((overloadable))
intel_sub_group_block_read_ui4(read_only image2d_t image, int2 coord);
uint8 __attribute__((overloadable))
intel_sub_group_block_read_ui8(read_only image2d_t image, int2 coord);
...
void __attribute__((overloadable))
intel_sub_group_block_write_ui(image2d_t image, int2 coord, uint data);
void __attribute__((overloadable))
intel_sub_group_block_write_ui2(image2d_t image, int2 coord, uint2 data);
void __attribute__((overloadable))
intel_sub_group_block_write_ui4(image2d_t image, int2 coord, uint4 data);
void __attribute__((overloadable))
intel_sub_group_block_write_ui8(image2d_t image, int2 coord, uint8 data);

void __attribute__((overloadable))
intel_sub_group_block_write_ui(write_only image2d_t image, int2 coord,
                               uint data);
void __attribute__((overloadable))
intel_sub_group_block_write_ui2(write_only image2d_t image, int2 coord,
                                uint2 data);
void __attribute__((overloadable))
intel_sub_group_block_write_ui4(write_only image2d_t image, int2 coord,
                                uint4 data);
void __attribute__((overloadable))
intel_sub_group_block_write_ui8(write_only image2d_t image, int2 coord,
                                uint8 data);
...
void __attribute__((overloadable))
intel_sub_group_block_write2(write_only image2d_t image, int2 coord,
                             uint2 data);
void __attribute__((overloadable))
intel_sub_group_block_write4(write_only image2d_t image, int2 coord,
                             uint4 data);
void __attribute__((overloadable))
intel_sub_group_block_write8(write_only image2d_t image, int2 coord,
                             uint8 data);
...
void __attribute__((overloadable))
intel_sub_group_block_write2(read_write image2d_t image, int2 coord,
                             uint2 data);
void __attribute__((overloadable))
intel_sub_group_block_write4(read_write image2d_t image, int2 coord,
                             uint4 data);
void __attribute__((overloadable))
intel_sub_group_block_write8(read_write image2d_t image, int2 coord,
                             uint8 data);
...
void __attribute__((overloadable))
intel_sub_group_block_write(read_write image2d_t image, int2 coord,
                            ushort data);
void __attribute__((overloadable))
intel_sub_group_block_write2(read_write image2d_t image, int2 coord,
                             ushort2 data);
...
intel_sub_group_block_write8(read_write image2d_t image, int2 coord,
                             ushort8 data);
void __attribute__((overloadable))
intel_sub_group_block_write16(read_write image2d_t image, int2 coord,
                              ushort16 data);
#endif // (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)

ushort __attribute__((overloadable))
intel_sub_group_block_read(const __global ushort *p);
ushort2 __attribute__((overloadable))
...
short16 __attribute__((overloadable))
intel_sub_group_shuffle(short16 x, uint c);

ushort __attribute__((overloadable)) intel_sub_group_shuffle(ushort x, uint c);
ushort2 __attribute__((overloadable))
intel_sub_group_shuffle(ushort2 x, uint c);
ushort3 __attribute__((overloadable))
intel_sub_group_shuffle(ushort3 x, uint c);
ushort4 __attribute__((overloadable))
intel_sub_group_shuffle(ushort4 x, uint c);
ushort8 __attribute__((overloadable))
intel_sub_group_shuffle(ushort8 x, uint c);
ushort16 __attribute__((overloadable))
intel_sub_group_shuffle(ushort16 x, uint c);
...
short __attribute__((overloadable))
intel_sub_group_shuffle_xor(short x, uint c);
short2 __attribute__((overloadable))
intel_sub_group_shuffle_xor(short2 x, uint c);
short3 __attribute__((overloadable))
intel_sub_group_shuffle_xor(short3 x, uint c);
short4 __attribute__((overloadable))
intel_sub_group_shuffle_xor(short4 x, uint c);
short8 __attribute__((overloadable))
intel_sub_group_shuffle_xor(short8 x, uint c);
short16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(short16 x, uint c);

ushort __attribute__((overloadable))
intel_sub_group_shuffle_xor(ushort x, uint c);
ushort2 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ushort2 x, uint c);
ushort3 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ushort3 x, uint c);
ushort4 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ushort4 x, uint c);
ushort8 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ushort8 x, uint c);
ushort16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ushort16 x, uint c);
...
void __attribute__((overloadable))
intel_sub_group_block_write_us(read_write image2d_t image, int2 coord,
                               ushort data);
void __attribute__((overloadable))
intel_sub_group_block_write_us2(read_write image2d_t image, int2 coord,
                                ushort2 data);
void __attribute__((overloadable))
intel_sub_group_block_write_us4(read_write image2d_t image, int2 coord,
                                ushort4 data);
void __attribute__((overloadable))
intel_sub_group_block_write_us8(read_write image2d_t image, int2 coord,
                                ushort8 data);
#endif // (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
...
void __attribute__((overloadable))
intel_sub_group_block_write_us(write_only image2d_t image, int2 coord,
                               ushort data);
void __attribute__((overloadable))
intel_sub_group_block_write_us2(write_only image2d_t image, int2 coord,
                                ushort2 data);
void __attribute__((overloadable))
intel_sub_group_block_write_us4(write_only image2d_t image, int2 coord,
                                ushort4 data);
void __attribute__((overloadable))
intel_sub_group_block_write_us8(write_only image2d_t image, int2 coord,
                                ushort8 data);
...
uchar16 __attribute__((overloadable))
intel_sub_group_shuffle(uchar16 x, uint c);
...
char2 __attribute__((overloadable))
intel_sub_group_shuffle_xor(char2 x, uint c);
char3 __attribute__((overloadable))
intel_sub_group_shuffle_xor(char3 x, uint c);
char4 __attribute__((overloadable))
intel_sub_group_shuffle_xor(char4 x, uint c);
char8 __attribute__((overloadable))
intel_sub_group_shuffle_xor(char8 x, uint c);
char16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(char16 x, uint c);

uchar __attribute__((overloadable))
intel_sub_group_shuffle_xor(uchar x, uint c);
uchar2 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uchar2 x, uint c);
uchar3 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uchar3 x, uint c);
uchar4 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uchar4 x, uint c);
uchar8 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uchar8 x, uint c);
uchar16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(uchar16 x, uint c);
...
void __attribute__((overloadable))
intel_sub_group_block_write_uc(read_write image2d_t image, int2 coord,
                               uchar data);
void __attribute__((overloadable))
intel_sub_group_block_write_uc2(read_write image2d_t image, int2 coord,
                                uchar2 data);
void __attribute__((overloadable))
intel_sub_group_block_write_uc4(read_write image2d_t image, int2 coord,
                                uchar4 data);
void __attribute__((overloadable))
intel_sub_group_block_write_uc8(read_write image2d_t image, int2 coord,
                                uchar8 data);
void __attribute__((overloadable))
intel_sub_group_block_write_uc16(read_write image2d_t image, int2 coord,
                                 uchar16 data);
#endif // (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
...
void __attribute__((overloadable))
intel_sub_group_block_write_uc(write_only image2d_t image, int2 coord,
                               uchar data);
void __attribute__((overloadable))
intel_sub_group_block_write_uc2(write_only image2d_t image, int2 coord,
                                uchar2 data);
void __attribute__((overloadable))
intel_sub_group_block_write_uc4(write_only image2d_t image, int2 coord,
                                uchar4 data);
void __attribute__((overloadable))
intel_sub_group_block_write_uc8(write_only image2d_t image, int2 coord,
                                uchar8 data);
void __attribute__((overloadable))
intel_sub_group_block_write_uc16(write_only image2d_t image, int2 coord,
                                 uchar16 data);
...
intel_sub_group_shuffle(ulong16 x, uint c);

long __attribute__((overloadable))
intel_sub_group_shuffle_down(long cur, long next, uint c);
long2 __attribute__((overloadable))
intel_sub_group_shuffle_down(long2 cur, long2 next, uint c);
long3 __attribute__((overloadable))
intel_sub_group_shuffle_down(long3 cur, long3 next, uint c);
long4 __attribute__((overloadable))
intel_sub_group_shuffle_down(long4 cur, long4 next, uint c);
long8 __attribute__((overloadable))
intel_sub_group_shuffle_down(long8 cur, long8 next, uint c);
long16 __attribute__((overloadable))
intel_sub_group_shuffle_down(long16 cur, long16 next, uint c);

ulong __attribute__((overloadable))
intel_sub_group_shuffle_down(ulong cur, ulong next, uint c);
ulong2 __attribute__((overloadable))
intel_sub_group_shuffle_down(ulong2 cur, ulong2 next, uint c);
ulong3 __attribute__((overloadable))
intel_sub_group_shuffle_down(ulong3 cur, ulong3 next, uint c);
ulong4 __attribute__((overloadable))
intel_sub_group_shuffle_down(ulong4 cur, ulong4 next, uint c);
ulong8 __attribute__((overloadable))
intel_sub_group_shuffle_down(ulong8 cur, ulong8 next, uint c);
ulong16 __attribute__((overloadable))
intel_sub_group_shuffle_down(ulong16 cur, ulong16 next, uint c);

long __attribute__((overloadable))
intel_sub_group_shuffle_up(long cur, long next, uint c);
long2 __attribute__((overloadable))
intel_sub_group_shuffle_up(long2 cur, long2 next, uint c);
long3 __attribute__((overloadable))
intel_sub_group_shuffle_up(long3 cur, long3 next, uint c);
long4 __attribute__((overloadable))
intel_sub_group_shuffle_up(long4 cur, long4 next, uint c);
long8 __attribute__((overloadable))
intel_sub_group_shuffle_up(long8 cur, long8 next, uint c);
long16 __attribute__((overloadable))
intel_sub_group_shuffle_up(long16 cur, long16 next, uint c);

ulong __attribute__((overloadable))
intel_sub_group_shuffle_up(ulong cur, ulong next, uint c);
ulong2 __attribute__((overloadable))
intel_sub_group_shuffle_up(ulong2 cur, ulong2 next, uint c);
ulong3 __attribute__((overloadable))
intel_sub_group_shuffle_up(ulong3 cur, ulong3 next, uint c);
ulong4 __attribute__((overloadable))
intel_sub_group_shuffle_up(ulong4 cur, ulong4 next, uint c);
ulong8 __attribute__((overloadable))
intel_sub_group_shuffle_up(ulong8 cur, ulong8 next, uint c);
ulong16 __attribute__((overloadable))
intel_sub_group_shuffle_up(ulong16 cur, ulong16 next, uint c);

long __attribute__((overloadable)) intel_sub_group_shuffle_xor(long x, uint c);
long2 __attribute__((overloadable))
intel_sub_group_shuffle_xor(long2 x, uint c);
long3 __attribute__((overloadable))
intel_sub_group_shuffle_xor(long3 x, uint c);
long4 __attribute__((overloadable))
intel_sub_group_shuffle_xor(long4 x, uint c);
long8 __attribute__((overloadable))
intel_sub_group_shuffle_xor(long8 x, uint c);
long16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(long16 x, uint c);

ulong __attribute__((overloadable))
intel_sub_group_shuffle_xor(ulong x, uint c);
ulong2 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ulong2 x, uint c);
ulong3 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ulong3 x, uint c);
ulong4 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ulong4 x, uint c);
ulong8 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ulong8 x, uint c);
ulong16 __attribute__((overloadable))
intel_sub_group_shuffle_xor(ulong16 x, uint c);
...
void __attribute__((overloadable))
intel_sub_group_block_write_ul(read_write image2d_t image, int2 coord,
                               ulong data);
void __attribute__((overloadable))
intel_sub_group_block_write_ul2(read_write image2d_t image, int2 coord,
                                ulong2 data);
void __attribute__((overloadable))
intel_sub_group_block_write_ul4(read_write image2d_t image, int2 coord,
                                ulong4 data);
void __attribute__((overloadable))
intel_sub_group_block_write_ul8(read_write image2d_t image, int2 coord,
                                ulong8 data);
#endif // (__OPENCL_C_VERSION__ >= CL_VERSION_2_0)
...
void __attribute__((overloadable))
intel_sub_group_block_write_ul(write_only image2d_t image, int2 coord,
                               ulong data);
void __attribute__((overloadable))
intel_sub_group_block_write_ul2(write_only image2d_t image, int2 coord,
                                ulong2 data);
void __attribute__((overloadable))
intel_sub_group_block_write_ul4(write_only image2d_t image, int2 coord,
                                ulong4 data);
void __attribute__((overloadable))
intel_sub_group_block_write_ul8(write_only image2d_t image, int2 coord,
                                ulong8 data);
...
double __attribute__((overloadable))
intel_sub_group_shuffle_xor(double x, uint c);
#endif

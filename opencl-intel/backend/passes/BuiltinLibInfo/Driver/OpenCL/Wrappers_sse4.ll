...
entry:
  ...
  %v2_0 = insertelement <4 x i32> undef, i32 %elem0, i32 0
  %v2_1 = insertelement <4 x i32> %v2_0, i32 %elem1, i32 1
  %v2_2 = insertelement <4 x i32> %v2_1, i32 %elem2, i32 2
  %v2_3 = insertelement <4 x i32> %v2_2, i32 %elem3, i32 3
...
entry:
  ...
  %v2_0 = insertelement <4 x i1> undef, i1 %elem0, i32 0
  %v2_1 = insertelement <4 x i1> %v2_0, i1 %elem1, i32 1
  %v2_2 = insertelement <4 x i1> %v2_1, i1 %elem2, i32 2
  %v2_3 = insertelement <4 x i1> %v2_2, i1 %elem3, i32 3

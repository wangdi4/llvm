...
#ifndef __RenderscriptRuntime_H__
#define __RenderscriptRuntime_H__
...
/// @brief
///  Runtime services for Renderscript
...
class RenderscriptRuntime : public RuntimeServices {
public:
  ...
  /// @brief RS is an ordered programming language. WIAnalysis is needed
  /// @return True
  ...
  /// Pre-Scalarization used WiDepPrePacketizationPass
  /// @param funcName Function name to check
...
protected:
  ...
  RenderscriptRuntime(); // Do not implement
...
/// @brief RS-specific function names
#define GET_ID_NAME  "get.id"

} // Namespace

#endif // __RenderscriptRuntime_H__

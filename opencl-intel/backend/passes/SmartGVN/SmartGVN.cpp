...
static cl::opt<unsigned int> GVNHNumOfInstructions(
    "gvn-inst-number", cl::init(500), cl::Hidden,
...
static cl::opt<unsigned int> GVNHLoadRatio(
    "gvn-load-ratio", cl::init(10), cl::Hidden,
    cl::desc(
        "The percentage of load instructions in a basic block which disables "

...
namespace intel{
    ...
    public:
        ...
        Inst2FunctionLookup(const Intel::OpenCL::Utils::CPUDetect *CpuId) {
          ...
          FPToUI_Lookup[std::make_pair(Integer64, Double)] =
          ...
          FPToUI_Lookup[std::make_pair(Integer64, Float)] =
          ...
          FPToUI_Lookup[std::make_pair(Integer32, Double)] =
          ...
          SIToFP_Lookup[std::make_pair(Double, Integer64)] =
          ...
          if (isV16Supported) {
            ...
            /// float> %tmp2) nounwind
            FPToUI_Lookup[std::make_pair(v16xInteger64, v16xFloat)] =
            ...
            FPToUI_Lookup[std::make_pair(v16xInteger64, v16xDouble)] =
            ...
            FPToSI_Lookup[std::make_pair(Integer64, Float)] =
            ...
            /// float> %tmp2) nounwind
            FPToSI_Lookup[std::make_pair(v16xInteger64, v16xFloat)] =
            ...
            FPToSI_Lookup[std::make_pair(Integer64, Double)] =
            ...
            /// double> %tmp2) nounwind
            FPToSI_Lookup[std::make_pair(v16xInteger64, v16xDouble)] =
            ...
            SIToFP_Lookup[std::make_pair(Float, Integer64)] =
            ...
            /// i64> %tmp2) nounwind
            SIToFP_Lookup[std::make_pair(v16xFloat, v16xInteger64)] =
            ...
            /// nounwind
            UIToFP_Lookup[std::make_pair(Double, Integer64)] =
            ...
            /// i64> %tmp2) nounwind
            UIToFP_Lookup[std::make_pair(v16xFloat, v16xInteger64)] =
            ...
            /// x i64> %tmp2) nounwind
            UIToFP_Lookup[std::make_pair(v16xDouble, v16xInteger64)] =
            ...
            UIToFP_Lookup[std::make_pair(Float, Integer64)] =
          ...
          if (ReplaceFDivFastWithSVML ||
            ...
            FDiv_Lookup[{Float, Float}] = {"_Z9divide_rmff", CallingConv::C};
    ...
    public:
        ...
        InstToFuncCall(const Intel::OpenCL::Utils::CPUDetect *CpuId = nullptr);

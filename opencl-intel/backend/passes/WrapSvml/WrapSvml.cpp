...
protected:
        ...
        // Utility function to remove the instruction from the basic block
...
BasicBlock::iterator WrapSvmlPass::removeInstruction(BasicBlock* pBB, BasicBlock::iterator it) {
...
extern "C" llvm::ModulePass *createSvmlWrapperPass( llvm::LLVMContext *pContext) 
{
    return new Intel::OpenCL::DeviceBackend::WrapSvmlPass( pContext);
}

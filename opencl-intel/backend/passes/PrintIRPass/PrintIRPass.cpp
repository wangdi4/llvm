...
PrintIRPass::PrintIRPass(IRDumpOptions option, dump_IR_options optionLocation,
                         std::string dumpDir)
...
extern "C" llvm::ModulePass *createPrintIRPass(int option, int optionLocation,
                                               std::string dumpDir) {
  return new Intel::OpenCL::DeviceBackend::PrintIRPass(
      (Intel::OpenCL::DeviceBackend::IRDumpOptions)option,
      (Intel::OpenCL::DeviceBackend::dump_IR_options)optionLocation, dumpDir);
}

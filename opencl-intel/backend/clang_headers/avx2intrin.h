...
{
    return (__m256i)__builtin_elementwise_abs((__v32qi)__a);
}
...
{
  return (__m256i)__builtin_elementwise_max((__v32qi)__a, (__v32qi)__b);
}
...
{
  return (__m256i)__builtin_elementwise_min((__v32qi)__a, (__v32qi)__b);
}
...
static __inline__ __m256i __DEFAULT_FN_ATTRS256
_mm256_maskload_epi64(long const *__X, __m256i __M)
{
...
static __inline__ __m128i __DEFAULT_FN_ATTRS128
_mm_maskload_epi64(long const *__X, __m128i __M)
{
...
static __inline__ void __DEFAULT_FN_ATTRS256
_mm256_maskstore_epi64(long *__X, __m256i __M, __m256i __Y)
{
...
static __inline__ void __DEFAULT_FN_ATTRS128
_mm_maskstore_epi64(long *__X, __m128i __M, __m128i __Y)
{

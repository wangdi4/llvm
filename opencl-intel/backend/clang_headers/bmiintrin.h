...
__andn_u64 (unsigned long __X, unsigned long __Y)
{
  return ~__X & __Y;
}
...
/// \see _bextr_u64
static __inline__ unsigned long __DEFAULT_FN_ATTRS
__bextr_u64(unsigned long __X, unsigned long __Y)
{
...
/// \see __bextr_u64
static __inline__ unsigned long __DEFAULT_FN_ATTRS
_bextr_u64(unsigned long __X, unsigned int __Y, unsigned int __Z)
{
...
static __inline__ unsigned long __DEFAULT_FN_ATTRS
__blsmsk_u64(unsigned long __X)
{
  return __X ^ (__X - 1);
}
...
///    bits in the operand.
static __inline__ unsigned long __RELAXED_FN_ATTRS
__tzcnt_u64(unsigned long __X)
{
...
///    the operand.
static __inline__ long __RELAXED_FN_ATTRS
_mm_tzcnt_64(unsigned long __X)
{
  return __builtin_ia32_tzcnt_u64(__X);
}

...
typedef long __v4di __attribute__ ((__vector_size__ (32)));
typedef int __v8si __attribute__ ((__vector_size__ (32)));
typedef short __v16hi __attribute__ ((__vector_size__ (32)));
typedef char __v32qi __attribute__ ((__vector_size__ (32)));

/* Unsigned types */
typedef unsigned long __v4du __attribute__ ((__vector_size__ (32)));
...
typedef long __m256i __attribute__((__vector_size__(32), __aligned__(32)));
...
typedef long __m256i_u __attribute__((__vector_size__(32), __aligned__(1)));
...
#define _mm256_extract_epi64(X, N) \
  (long)__builtin_ia32_vec_ext_v4di((__v4di)(__m256i)(X), (int)(N))
#endif
...
/// \returns An initialized 256-bit integer vector.
static __inline __m256i __DEFAULT_FN_ATTRS
_mm256_set_epi64x(long __a, long __b, long __c, long __d)
{
...
/// \returns An initialized 256-bit integer vector.
static __inline __m256i __DEFAULT_FN_ATTRS
_mm256_setr_epi64x(long __a, long __b, long __c, long __d)
{

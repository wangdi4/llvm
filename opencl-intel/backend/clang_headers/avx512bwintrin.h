...
typedef unsigned long __mmask64;
...
_cvtmask64_u64(__mmask64 __A) {
  return (unsigned long)__builtin_ia32_kmovq((__mmask64)__A);
}
...
static __inline__ __mmask64 __DEFAULT_FN_ATTRS
_cvtu64_mask64(unsigned long __A) {
...
{
  return (__m512i)__builtin_elementwise_abs((__v64qi)__A);
}
...
{
  return (__m512i)__builtin_elementwise_max((__v64qi) __A, (__v64qi) __B);
}
...
{
  return (__m512i)__builtin_elementwise_min((__v64qi) __A, (__v64qi) __B);
}

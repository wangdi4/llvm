...
#ifdef __x86_64__
static __inline__ int __attribute__((__always_inline__, __nodebug__, __target__("rdrnd")))
_rdrand64_step(unsigned long *__p)
{
...
static __inline__ unsigned long __attribute__((__always_inline__, __nodebug__, __target__("fsgsbase")))
...
static __inline__ void __attribute__((__always_inline__, __nodebug__, __target__("fsgsbase")))
_writefsbase_u64(unsigned long __V)
{
...
static __inline__ void __attribute__((__always_inline__, __nodebug__, __target__("fsgsbase")))
_writegsbase_u64(unsigned long __V)
{
...
#ifdef __x86_64__
static __inline__ long __attribute__((__always_inline__, __nodebug__, __target__("movbe")))
...
static __inline__ void __attribute__((__always_inline__, __nodebug__, __target__("movbe")))
_storebe_i64(void * __P, long __D) {
  struct __storeu_i64 {
    long __v;
  } __attribute__((__packed__, __may_alias__));

...
typedef long __m128i __attribute__((__vector_size__(16), __aligned__(16)));

typedef double __m128d_u __attribute__((__vector_size__(16), __aligned__(1)));
typedef long __m128i_u __attribute__((__vector_size__(16), __aligned__(1)));
...
/* Unsigned types */
typedef unsigned long __v2du __attribute__ ((__vector_size__ (16)));
...
_mm_loadu_si64(void const *__a)
{
  ...
  long __u = ((struct __loadu_si64*)__a)->__v;
...
{
  return (__m128i)__builtin_elementwise_max((__v16qi)__a, (__v16qi)__b);
}
...
{
  return (__m128i)__builtin_elementwise_min((__v16qi)__a, (__v16qi)__b);
}
...
static __inline__ __m128d __DEFAULT_FN_ATTRS
_mm_cvtsi64_sd(__m128d __a, long __b)
{
  __a[0] = __b;
  return __a;
}
...
static __inline__ __m128i __DEFAULT_FN_ATTRS
_mm_set_epi64x(long __q1, long __q0)
{
...
{
  return _mm_set_epi64x((long)__q1, (long)__q0);
}
...
static __inline__ void __attribute__((__always_inline__, __nodebug__, __target__("sse2")))
_mm_stream_si64(long *__p, long __a)
{
...
{
  return __extension__ (__m128i)(__v2di){ (long)__a, 0 };
}

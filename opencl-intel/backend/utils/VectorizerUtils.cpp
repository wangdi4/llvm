...
Constant *VectorizerUtils::importFunctionDecl(Module *Dst,
                                              const Function *Orig) {
...
StringRef VectorizerUtils::stripStructNameTrailingDigits(StringRef TyName) {
...
bool VectorizerUtils::isSameStructPtrType(Type *Ty1, Type *Ty2) {
...
bool VectorizerUtils::isSameStructType(StructType *STy1, StructType *STy2) {

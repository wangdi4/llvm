...
// License.
//
// This file is taken from llvm with two modifications:
// 1. Move GDBJITRegistrationListener to ManagedStatic.
// 2. Define a function 'getGDBRegistrationListenerInstance'.
// 3. Remove function JITEventListener::createGDBRegistrationListener()
// Original file path: llvm/lib/ExecutionEngine/GDBRegistrationListener.cpp
...
static llvm::ManagedStatic<GDBJITRegistrationListener> GDBRegListener;
...
// We define this function and use it to ensure that the ocl runtime finally
// links the file.
llvm::JITEventListener *getGDBRegistrationListenerInstance(void) {

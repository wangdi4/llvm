...
namespace Intel { namespace OpenCL { namespace DeviceBackend {
  ...
  namespace {
    ...
    // CSSD100018605 [OpenCL2.0] Clang should provide reliable way to detect block functions and compute block context size
  ...
  bool BlockUtils::IsBlockInvocationKernel(const llvm::Function& F)
  {
    ...
    LLVM_DEBUG(llvm::dbgs() << "BlockUtils::IsBlockInvocationKernel Entry point \n");

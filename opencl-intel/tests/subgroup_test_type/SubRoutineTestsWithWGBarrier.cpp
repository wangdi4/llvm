...
// This test is to check the same function called by two kernels while one
// kernel has subgroup and another doesn't have.

TEST_P(SGEmulationTest, SubRoutineTestsWithWGBarrier) {

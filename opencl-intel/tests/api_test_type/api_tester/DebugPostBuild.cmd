...
del /f %MTV_LOCAL_BIN_DIR%.dbg\api_test_type.py >> %PLATFORM_NAME%\%CONFIG_NAME%\customBuild.log 2>&1
copy .\..\api_test_type.py %MTV_LOCAL_BIN_DIR%.dbg >> %PLATFORM_NAME%\%CONFIG_NAME%\customBuild.log 2>&1

...
RandomInputGenerator::RandomInputGenerator() {
  ...
  // no need for ucharEdgeCases.push_back(numeric_limits<unsigned
  // int8_t>::min()) because it's 0
  ...
  // no need for ushortEdgeCases.push_back(numeric_limits<unsigned
  // int16_t>::min()) because it's 0
  ushortEdgeCases.push_back(numeric_limits<uint16_t>::max());
  ushortGen = new IntGenerator<uint16_t>(baseSeeds.getNum(), ushortEdgeCases);
  ...
  // no need for uintEdgeCases.push_back(numeric_limits<unsigned
  // int32_t>::min()) because it's 0
  ...
  // no need for ulongEdgeCases.push_back(numeric_limits<unsigned
  // int64_t>::min()) because it's 0

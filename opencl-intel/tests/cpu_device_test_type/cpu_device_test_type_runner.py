...
def main():
    ...
    prefixPath = 'validation/cpu_device_test_type'
    os.chdir(prefixPath)
    prefixPath = '.'
    script = prefixPath + '/cmk_cpu_device_test_type.py'
    if osType == 'win32':
        cfgPath = prefixPath + '/cpu_device_test/cfg.xml'
    else:
        cfgPath = prefixPath + '/cpu_device_test/cfg_linux.xml'

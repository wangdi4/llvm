...
TEST(ReflectionToLLVM, Image2ddepth){
  llvm::LLVMContext CTX;
  reflection::RefParamType sTy(new reflection::PrimitiveType(reflection::PRIMITIVE_IMAGE_2D_DEPTH_T));
  llvm::Type* llvmSTy = intel::reflectionToLLVM(CTX, sTy);
  ASSERT_TRUE(llvmSTy->isStructTy());
  llvm::StructType *STy = llvm::dyn_cast<llvm::StructType>(llvmSTy);
  llvm::StringRef Name = STy->getName();
...
TEST(ReflectionToLLVM, Image2darraydepth){
  llvm::LLVMContext CTX;
  reflection::RefParamType sTy(new reflection::PrimitiveType(reflection::PRIMITIVE_IMAGE_2D_ARRAY_DEPTH_T));
  llvm::Type* llvmSTy = intel::reflectionToLLVM(CTX, sTy);
  ASSERT_TRUE(llvmSTy->isStructTy());
  llvm::StructType *STy = llvm::dyn_cast<llvm::StructType>(llvmSTy);
  llvm::StringRef Name = STy->getName();
...
TEST(ReflectionToLLVM, Event){
  llvm::LLVMContext CTX;
  reflection::RefParamType sTy(new reflection::PrimitiveType(reflection::PRIMITIVE_EVENT_T));
  llvm::Type* llvmSTy = intel::reflectionToLLVM(CTX, sTy);
  ASSERT_TRUE(llvmSTy->isStructTy());
  llvm::StructType *STy = llvm::dyn_cast<llvm::StructType>(llvmSTy);
  llvm::StringRef Name = STy->getName();
...
TEST(ReflectionToLLVM, ClkEvent){
  llvm::LLVMContext CTX;
  reflection::RefParamType sTy(new reflection::PrimitiveType(reflection::PRIMITIVE_CLK_EVENT_T));
  llvm::Type* llvmSTy = intel::reflectionToLLVM(CTX, sTy);
  ASSERT_TRUE(llvmSTy->isStructTy());
  llvm::StructType *STy = llvm::dyn_cast<llvm::StructType>(llvmSTy);
  llvm::StringRef Name = STy->getName();

...
#   1. Different work_items number with different global ID: default(TC-51)
#       and non-default(TC-52)
...
class GlobalIdTest(DebuggerTestCase):
    ...
    #
    # TEST: GlobalId.test_1D_default_global_id
    #
    # Purpose 
    # -------
    #
...
#                   "local_size_array=",local_size_x)
    ...
    #
    # TEST: GlobalId.test_3D_default_global_id
    #
    # Purpose 
    # -------
    #

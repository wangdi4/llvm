...
template<>
double POW<double>(double in, double in2)
{
    return pow(in, in2);
}

template<>
 float POW<float>(float in, float in2)
{
    return powf(in, in2);
}
// EXP
...
template<>
 double EXP<double>(double in)
{
    return exp(in);
}

template<>
 float EXP<float>(float in)
{
    return expf(in);
}
...
template<>
 double EXP10<double>(double in)
{
    return exp10(in);
}

template<>
 float EXP10<float>(float in)
{
    return exp10f(in);
}
...
template<>
 double EXP2<double>(double in)
{
    return exp2(in);
}

template<>
 float EXP2<float>(float in)
{
    return exp2f(in);
}
...
template<>
 double MAX<double>(double in, double in2)
{
    return fmax(in, in2);
}

template<>
float MAX<float>(float in, float in2)
{
    return fmaxf(in, in2);
}
...
template<>
 double MIN<double>(double in, double in2)
{
    return fmin(in, in2);
}

template<>
 float MIN<float>(float in, float in2)
{
    return fminf(in, in2);
}
...
template<>
double LOG<double>(double in)
{
    return log(in);
}

template<>
float LOG<float>(float in)
{
    return logf(in);
}
...
template<>
 double LOG10<double>(double in)
{
    return log10(in);
}

template<>
 float LOG10<float>(float in)
{
    return log10f(in);
}

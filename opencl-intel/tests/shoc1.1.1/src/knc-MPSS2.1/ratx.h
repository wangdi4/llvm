...
template <class real>
__declspec(target(mic)) void
ratx2_kernel(const real* RESTRICT C, real* RESTRICT RF, real* RESTRICT RB , const int n)
{
	#pragma omp parallel for
	for(int el=0;el<n;el++)
	{
...
template <class real>
__declspec(target(mic)) void
ratx4_kernel(const real* RESTRICT C, real* RESTRICT RF, real* RESTRICT RB, const int n)
{
	#pragma omp parallel for
	for(int el=0;el<n;el++)
	{

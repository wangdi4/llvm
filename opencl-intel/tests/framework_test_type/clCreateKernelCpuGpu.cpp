...
bool clCreateKernelCpuGpuTest()
{
	...
	strncpy_s((char*)pCont->container, strlen(szDLLName)+1, szDLLName, strlen(szDLLName));
	...
	pCont->container = ((char*)pCont)+sizeof(cl_prog_container);
	strncpy_s((char*)pCont->container, strlen(szCubinName)+1, szCubinName, strlen(szCubinName));

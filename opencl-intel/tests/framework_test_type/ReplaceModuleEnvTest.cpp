...
// the first dumped IR to store 1 to dst and the second dumped IR to store 2 to
// dst.
...
// "VOLCANO_STATS=All" and then modify the first dumped IR to store 3 to dst and
// the second dumped IR to store 4 to dst.

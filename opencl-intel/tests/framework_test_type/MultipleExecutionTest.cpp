...
/**************************************************************************************************
* Multiple Execution test: test running several ND-Ranges in the same process, with the host thread participating
*                          Intended as regression for CSSD100016390                               *
*                                                                                                 *
...
bool clMultipleExecutionTest()
{
    ...
    //We must use local size of 1 to ensure the number of work groups equals the number of compute units
    size_t localSize  = 1;

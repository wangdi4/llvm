...
void CL_CALLBACK _KerenlTestFunc( void* params)
{
    ...
    {
        pOutBuffer[index] = pInBuffer1[index % szInBuffer1Size] * pInBuffer2[index % szInBuffer2Size];
    }
}

bool test_native_kernel(cl_command_queue queue1, cl_mem buffer_srcA, cl_mem buffer_srcB, cl_mem buffer_dst)
{
    cl_err_code iRet;

	...
	printf("buffer3 = %p\n", (void*)buffer3);

				{
...

                                  {
                                    ...
                                    iRet = clEnqueueWriteBuffer(
                                        queue, buffer1, CL_FALSE, 0,
                                    ...
                                    iRet = clEnqueueCopyBuffer(
                                        queue, buffer1, buffer3, 0,
                                        UINT_BUFFER_LEN / 2,
                                    ...
                                    //
                                    iRet = clEnqueueReadBuffer(
                                        queue, buffer3, CL_TRUE, 0,

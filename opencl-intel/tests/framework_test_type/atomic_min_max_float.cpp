...
/*******************************************************************************
 * Test checks that atomic_min/atomic_max in kernel code compares float values
 *correctly.
 *******************************************************************************/
...
const char *OCL20_KERNEL_MIN_TEST_CODE_STR =
    "T __attribute__((overloadable)) "
    "atomic_fetch_min_explicit(volatile __global AT *p, T val, "
...
const char *OCL20_KERNEL_MAX_TEST_CODE_STR =
    "T __attribute__((overloadable)) "
    "atomic_fetch_max_explicit(volatile __global AT *p, T val, "
    "memory_order order, memory_scope scope); "
    "void __attribute__((overloadable)) "
    "atomic_store_explicit(volatile __global AT *p, T val, memory_order order);"

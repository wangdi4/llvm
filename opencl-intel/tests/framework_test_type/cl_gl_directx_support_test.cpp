...
//| -------
//|
//| Test that cl gl sharing and directX extensions are disabled if CL_CONFIG_GL_DIRECTX_INTEROP
//| environment variable is set to False, And enabled otherwise
//|
//|
//| Pass criteria
//| -------------
...
void death_test_imp( bool supported )
{
    ...
    EXPECT_EXIT( { gl_directx_support_test( supported ); exit(1); }, ::testing::ExitedWithCode(0), "" );
#endif
}

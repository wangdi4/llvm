...
copy %PLATFORM_NAME%\%CONFIG_NAME%\%TARGET_NAME%.exe.manifest %MTV_LOCAL_BIN_DIR%.opt >> %PLATFORM_NAME%\%CONFIG_NAME%\customBuild.log 2>&1
...
copy %TARGET_NAME%.py %MTV_LOCAL_BIN_DIR%.opt >> %PLATFORM_NAME%\%CONFIG_NAME%\customBuild.log 2>&1

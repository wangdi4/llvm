...
public:
    ...
    /// @brief implementing the interface's method, added the CPU selection & CPU features option
...
/** @brief SerializationServiceOptions: used when calling GetSerializationService
 *        the options consist of:
 *        - the CPU architecture selection

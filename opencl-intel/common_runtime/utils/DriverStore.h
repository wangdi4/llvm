...
__inline char *getModulePath(char *dllPath, const char *FileName) {
  /* GetModuleFileName retrieves the fully qualified path for the file that
   contains the specified module e.g.
   C:\Windows\System32\DriverStore\FileRepository\igdlh64.inf_amd64_808e12707a8c1658\igdrcl64.dll
...
__inline HMODULE LoadDependency(const char *dependencyFileName) {
...
Returns:     UINSIGNED INT 99 9 99999 ( MajorVersion x 1000 000 MinorVersion x
100 000 OSBuildNumber)
\******************************************************************************/

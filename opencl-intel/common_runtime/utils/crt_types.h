...
typedef void(CL_CALLBACK *ctxt_logging_fn)(const char *, const void *, size_t,
                                           void *);
...
typedef void(CL_CALLBACK *pfn_free)(cl_command_queue queue,
...
#define INTEL_PLATFORM_NAME "Intel(R) OpenCL 2.1 CPU Only Platform"
...
#else
#define SET_ALIAS(func)                                                        \
  void intel_ocl_crt_##func() __attribute__((alias(#func)))

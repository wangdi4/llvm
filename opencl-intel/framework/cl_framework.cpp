...
cl_int CL_API_CALL clSetCommandQueueProperty(
  ...
  if (g_pUserLogger->IsApiLoggingEnabled()) {
    ...
    CALL_TRACED_API_LOGGER(EXECUTION_MODULE, cl_int,
                           SetCommandQueueProperty(command_queue, properties,
                                                   enable, old_properties),
                           clSetCommandQueueProperty, &command_queue,
                           &properties, &enable, &old_properties);
  } else {
    CALL_TRACED_API(EXECUTION_MODULE, cl_int,
                    SetCommandQueueProperty(command_queue, properties, enable,
                                            old_properties),
                    clSetCommandQueueProperty, &command_queue, &properties,
                    &enable, &old_properties);
  }
}
///////////////////////////////////////////////////////////////////////////////////////////////////

...
namespace Intel { namespace OpenCL { namespace Framework {
	...
	public:
        ...
        static SharedPtr<ProgramWithBinary> Allocate(SharedPtr<Context>            pContext,
                                                     ...
                                                     cl_int*                       piRet)
        {
            return SharedPtr<ProgramWithBinary>(new ProgramWithBinary(pContext,
                                                                      uiNumDevices,
                                                                      pDevices,
                                                                      pszLengths,
                                                                      pBinaries,
	...
	protected:
        ...
        ProgramWithBinary(SharedPtr<Context>            pContext,
                          cl_uint                       uiNumDevices,
                          SharedPtr<FissionableDevice>* pDevices,
                          const size_t*                 pszLengths,
                          const unsigned char**         pBinaries,

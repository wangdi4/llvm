...
DECLARE_ALIAS(clCreateBufferWithProperties);
DECLARE_ALIAS(clCreateImage);
DECLARE_ALIAS(clCreateImageWithProperties);
...
DECLARE_ALIAS(clSetProgramSpecializationConstant);
...
DECLARE_ALIAS(clEnqueueWriteGlobalVariableINTEL);
...
DECLARE_ALIAS(clMemBlockingFreeINTEL);

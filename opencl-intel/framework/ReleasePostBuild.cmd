...
copy .\cl.cfg %MTV_LOCAL_BIN_DIR% >> %PLATFORM_NAME%\%CONFIG_NAME%\exportPhase.log 2>&1
copy .\cl.cfg %MTV_LOCAL_BIN_DIR%.opt >> %PLATFORM_NAME%\%CONFIG_NAME%\exportPhase.log 2>&1
...
del /f %MTV_LOCAL_LIB_DIR%.opt\%TARGET_NAME%.lib >> %PLATFORM_NAME%\%CONFIG_NAME%\customBuild.log 2>&1
copy %PLATFORM_NAME%\%CONFIG_NAME%\%TARGET_NAME%.lib %MTV_LOCAL_LIB_DIR%.opt >> %PLATFORM_NAME%\%CONFIG_NAME%\customBuild.log 2>&1

...
#define REGISTER_EXTENSION_FUNCTION(__NAME__, __ADDRESS__)                     \
  static void *UNUSED(func##__ADDRESS__) = RegisterExtensionFunctionAddress(   \
      #__NAME__, (void *)(ptrdiff_t)GET_ALIAS(__ADDRESS__))
...
extern cl_int CL_API_CALL clGetKernelArgInfo(cl_kernel kernel, cl_uint arg_indx,
...
cl_int(CL_API_CALL *INTELpfn_clEnqueueAcquireDX9ObjectsINTEL)(
    cl_command_queue /* command_queue */, cl_uint /* num_objects */,
    const cl_mem * /* mem_objects */, cl_uint /* num_events_in_wait_list */,
    const cl_event * /* event_wait_list */, cl_event * /* ocl_event */);

typedef CL_API_ENTRY
cl_int(CL_API_CALL *INTELpfn_clEnqueueReleaseDX9ObjectsINTEL)(
    cl_command_queue /* command_queue */, cl_uint /* num_objects */,
    const cl_mem * /* mem_objects */, cl_uint /* num_events_in_wait_list */,
    const cl_event * /* event_wait_list */, cl_event * /* ocl_event */);

typedef CL_API_ENTRY
cl_mem(CL_API_CALL *INTELpfn_clCreateFromDX9MediaSurfaceINTEL)(
    cl_context /* context */, cl_mem_flags /* flags */,
    IDirect3DSurface9 * /* resource */, HANDLE /* sharedHandle */,
    UINT /* plane */, cl_int * /* errcode_ret */);

typedef CL_API_ENTRY cl_int(CL_API_CALL *INTELpfn_clGetDeviceIDsFromDX9INTEL)(
    cl_platform_id /* platform */,
    cl_dx9_device_source_intel /* d3d_device_source */, void * /* d3d_object */,
    cl_dx9_device_set_intel /* d3d_device_set */, cl_uint /* num_entries */,
    cl_device_id * /* devices */, cl_uint * /* num_devices */);

extern CL_API_ENTRY cl_mem CL_API_CALL clCreateFromDX9MediaSurfaceINTEL(
    cl_context /*context*/, cl_mem_flags /*flags*/,
    IDirect3DSurface9 * /*resource*/, HANDLE /*sharehandle*/, UINT /*plane*/,
    cl_int * /*errcode_ret*/);
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueReleaseDX9ObjectsINTEL(
    cl_command_queue /*command_queue*/, cl_uint /*num_objects*/,
    cl_mem * /*mem_objects*/, cl_uint /*num_events_in_wait_list*/,
    const cl_event * /*event_wait_list*/, cl_event * /*event*/);
...
typedef CL_API_ENTRY
cl_command_queue(CL_API_CALL *INTELpfn_clCreatePerfCountersCommandQueueINTEL)();
typedef CL_API_ENTRY
cl_accelerator_intel(CL_API_CALL *INTELpfn_clCreateAcceleratorINTEL)();
...
typedef CL_API_ENTRY
cl_program(CL_API_CALL *INTELpfn_clCreateProfiledProgramWithSourceINTEL)();
typedef CL_API_ENTRY
cl_int(CL_API_CALL *INTELpfn_clCreateKernelProfilingJournalINTEL)();
typedef CL_API_ENTRY
cl_int(CL_API_CALL *INTELpfn_clEnqueueAcquireVAMediaSurfacesINTEL)();
typedef CL_API_ENTRY
cl_int(CL_API_CALL *INTELpfn_clEnqueueReleaseVAMediaSurfacesINTEL)();
typedef CL_API_ENTRY
cl_int(CL_API_CALL *INTELpfn_clGetDeviceIDsFromVAMediaAdapterINTEL)();
typedef CL_API_ENTRY
cl_mem(CL_API_CALL *INTELpfn_clCreateFromVAMediaSurfaceINTEL)();
...
typedef CL_API_ENTRY cl_mem(CL_API_CALL *INTELpfn_clCreatePipeINTEL)(
    ...
    const cl_pipe_properties * /*attributes*/, void * /*host_ptr*/,
    size_t * /*size_ret*/, cl_int * /*errcode_ret*/);
...
struct SOCLCRTDispatchTable {
  ...
  INTELpfn_clCreatePerfCountersCommandQueueINTEL
  ...
  INTELpfn_clCreateProfiledProgramWithSourceINTEL
      clCreateProfiledProgramWithSourceINTEL;
  INTELpfn_clCreateKernelProfilingJournalINTEL
      clCreateKernelProfilingJournalINTEL;
  INTELpfn_clCreateFromVAMediaSurfaceINTEL clCreateFromVAMediaSurfaceINTEL;
  INTELpfn_clGetDeviceIDsFromVAMediaAdapterINTEL
      clGetDeviceIDsFromVAMediaAdapterINTEL;
  INTELpfn_clEnqueueReleaseVAMediaSurfacesINTEL
      clEnqueueReleaseVAMediaSurfacesINTEL;
  INTELpfn_clEnqueueAcquireVAMediaSurfacesINTEL

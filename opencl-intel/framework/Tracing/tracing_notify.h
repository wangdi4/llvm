...
#define TRACING_ZERO_CLIENT_COUNTER(state) ((state) &\
    (HostSideTracing::TRACING_STATE_ENABLED_BIT |\
    HostSideTracing::TRACING_STATE_LOCKED_BIT))
#define TRACING_GET_CLIENT_COUNTER(state)  ((state) &\
    (~(HostSideTracing::TRACING_STATE_ENABLED_BIT |\
    HostSideTracing::TRACING_STATE_LOCKED_BIT)))
...
#define TRACING_ENTER(name, ...)                                              \
    ...
    if (TRACING_GET_ENABLED_BIT(HostSideTracing::tracingState.load(           \
...
class clBuildProgramTracer {
  public:
    ...
    void enter(cl_program *program,
               ...
               const char **options,
               void(CL_CALLBACK **funcNotify)(cl_program program,
                                              void *userData),
               void **userData) {
    ...
    void enter(cl_context *context,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            if (handle->getTracingPoint(
                ...
                data.correlationData = correlationData + i;
                handle->call(CL_FUNCTION_clCreateCommandQueueWithProperties,
                    &data);
            }
        }
...
class clCreateContextTracer {
  public:
    ...
    void enter(const cl_context_properties **properties,
               ...
               void(CL_CALLBACK **funcNotify)(const char *,
                                              const void *,
                                              size_t,
                                              void *),
               void **userData,
  ...
  public:
    ...
    void enter(cl_program *program,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clCreateKernelsInProgram)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_context *context,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clCreateProgramWithBinary)) {
                data.correlationData = correlationData + i;
    ...
    void enter(cl_context *context,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            if (handle->getTracingPoint(
                ...
                data.correlationData = correlationData + i;
                handle->call(CL_FUNCTION_clCreateProgramWithBuiltInKernels,
                    &data);
            }
        }
  ...
  public:
    ...
    void enter(cl_context *context,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clCreateProgramWithSource)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_context *context,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clCreateSamplerWithProperties)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_command_queue *commandQueue,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clEnqueueBarrierWithWaitList)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_command_queue *commandQueue,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clEnqueueMarkerWithWaitList)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_command_queue *commandQueue,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clEnqueueMigrateMemObjects)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(const char **funcName) {
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clGetExtensionFunctionAddress)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_kernel *kernel,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clGetKernelWorkGroupInfo)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_context *context,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clGetSupportedImageFormats)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_command_queue *commandQueue,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clSetCommandQueueProperty)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_context *context,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clSetDefaultDeviceCommandQueue)) {
                data.correlationData = correlationData + i;
                handle->call(CL_FUNCTION_clSetDefaultDeviceCommandQueue,
                    &data);
            }
        }
  ...
  public:
    ...
    void enter(cl_kernel *kernel,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clSetKernelArgSVMPointer)) {
                data.correlationData = correlationData + i;
    ...
    void enter(cl_mem *memobj,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            if (handle->getTracingPoint(
                ...
                data.correlationData = correlationData + i;
                handle->call(CL_FUNCTION_clSetMemObjectDestructorCallback,
                    &data);
            }
        }
  ...
  public:
    ...
    void enter(cl_platform_id *platform) {
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clUnloadPlatformCompiler)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_context *context,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clCreateFromGLRenderbuffer)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_command_queue *commandQueue,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clEnqueueAcquireGLObjects)) {
                data.correlationData = correlationData + i;
  ...
  public:
    ...
    void enter(cl_command_queue *commandQueue,
        ...
        for (size_t i = 0; i < tracingHandle.size(); ++i) {
            ...
            assert(handle != nullptr);
            if (handle->getTracingPoint(
                    CL_FUNCTION_clEnqueueReleaseGLObjects)) {
                data.correlationData = correlationData + i;

...
typedef struct _cl_tracing_handle *cl_tracing_handle;
...
/*!
    ...
    The structure contains comprehensive information about the traced function.
    ...
    Correlation ID and Data fields allows to associate the callback on
...
/*!
    ...
    \param[in] callbackData Data structure with comprehensive information about
                            the traced function
...
*/
typedef void (*cl_tracing_callback)(cl_function_id fid,

...
CPUBinary::CPUBinary( const KernelProperties* pKernelProperties,
...
Executable* CPUBinary::CreateExecutableImp(Binary* pBinary) const
{
    return new CPUExecutable(this);
}

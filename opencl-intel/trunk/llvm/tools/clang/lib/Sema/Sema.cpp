...
Sema::Sema(Preprocessor &pp, ASTContext &ctxt, ASTConsumer &consumer,
  ...
  : TheTargetAttributesSema(0), FPFeatures(pp.getLangOptions().OpenCL),
    ...
    NonInstantiationEntries(0), CurrentInstantiationScope(0), TyposCorrected(0), AnalysisWarnings(*this)
{
  TUScope = 0;
...
void Sema::PopFunctionOrBlockScope() {
  ...
  LLVM_ASSERT(!FunctionScopes.empty() && "mismatched push/pop!");

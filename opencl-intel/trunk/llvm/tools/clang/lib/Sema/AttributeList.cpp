...
AttributeList::Kind AttributeList::getKind(const IdentifierInfo *Name) {
  ...
  return llvm::StringSwitch<AttributeList::Kind>(AttrName)
    ...
    .Case("svmlcc", AT_svmlcall)
    .Case("svmlcc_p2_f8_f8_f8", AT_svml_p2_f8_f8_f8_call)
    ...
    .Case("reqd_extension", AT_reqd_extension)
    ...
    .Case("llvm_alignstack", AT_llvm_alignstack)
    .Case("llvm_alwaysinline", AT_llvm_alwaysinline)
    .Case("llvm_hotpatch", AT_llvm_hotpatch)
    .Case("llvm_nonlazybind", AT_llvm_nonlazybind)
    .Case("llvm_inlinehint", AT_llvm_inlinehint)
    .Case("llvm_naked", AT_llvm_naked)
    .Case("llvm_noimplicitfloat", AT_llvm_noimplicitfloat)
    .Case("llvm_noinline", AT_llvm_noinline)
    .Case("llvm_noredzone", AT_llvm_noredzone)
    .Case("llvm_noreturn", AT_llvm_noreturn)
    .Case("llvm_nounwind", AT_llvm_nounwind)
    .Case("llvm_optsize", AT_llvm_optsize)
    .Case("llvm_readnone", AT_llvm_readnone)
    .Case("llvm_readonly", AT_llvm_readonly)
    .Case("llvm_ssp", AT_llvm_ssp)
    .Case("llvm_sspreq", AT_llvm_sspreq)

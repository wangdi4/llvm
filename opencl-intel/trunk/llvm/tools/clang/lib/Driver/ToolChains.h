...
public:
  ...
  void setTarget(bool isIPhoneOS, unsigned Major, unsigned Minor,
    ...
    LLVM_ASSERT(!TargetInitialized && "Target already initialized!");
  ...
  bool isTargetIPhoneOS() const {
    LLVM_ASSERT(TargetInitialized && "Target not initialized!");
  ...
  bool isIPhoneOSVersionLT(unsigned V0, unsigned V1=0, unsigned V2=0) const {
    LLVM_ASSERT(isTargetIPhoneOS() && "Unexpected call for OS X target!");
    unsigned B[3] = { V0, V1, V2 };
    return isVersionLT(TargetVersion, B);
  }

  bool isMacosxVersionLT(unsigned V0, unsigned V1=0, unsigned V2=0) const {
    LLVM_ASSERT(!isTargetIPhoneOS() && "Unexpected call for iPhoneOS target!");
    unsigned B[3] = { V0, V1, V2 };
    return isVersionLT(TargetVersion, B);
  }

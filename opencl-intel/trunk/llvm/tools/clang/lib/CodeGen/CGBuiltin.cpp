...
static Value *EmitCastToInt(CodeGenFunction &CGF,
  ...
  LLVM_ASSERT(Val->getType()->isIntegerTy() &&
         "Used a non-integer and non-pointer type with atomic builtin");
  LLVM_ASSERT(Val->getType()->getScalarSizeInBits() <=
...
/// Utility to emit OpenCL as_typen builtins.
static RValue EmitAsTypeN(CodeGenFunction &CGF, 
                          unsigned BuiltinID, const CallExpr *E)
{
  const llvm::Type *ElemType;
  unsigned ElemDimension;
  llvm::LLVMContext& context = CGF.CGM.getLLVMContext();

  // Select the appropriate type and dimension from the builtin's name
#define AS_TYPEN_SELECT(builtin_name, elemtype, elemdimension) \
  case Builtin::BI##builtin_name:\
    ElemType = elemtype;\
    ElemDimension = elemdimension;\
    break;

  switch (BuiltinID) {
    AS_TYPEN_SELECT(__builtin_as_char, llvm::Type::getInt8Ty(context), 1)
    AS_TYPEN_SELECT(__builtin_as_char2, llvm::Type::getInt8Ty(context), 2)
    AS_TYPEN_SELECT(__builtin_as_char3, llvm::Type::getInt8Ty(context), 3)
    AS_TYPEN_SELECT(__builtin_as_char4, llvm::Type::getInt8Ty(context), 4)
    AS_TYPEN_SELECT(__builtin_as_char8, llvm::Type::getInt8Ty(context), 8)
    AS_TYPEN_SELECT(__builtin_as_char16, llvm::Type::getInt8Ty(context), 16)
    AS_TYPEN_SELECT(__builtin_as_uchar, llvm::Type::getInt8Ty(context), 1)
    AS_TYPEN_SELECT(__builtin_as_uchar2, llvm::Type::getInt8Ty(context), 2)
    AS_TYPEN_SELECT(__builtin_as_uchar3, llvm::Type::getInt8Ty(context), 3)
    AS_TYPEN_SELECT(__builtin_as_uchar4, llvm::Type::getInt8Ty(context), 4)
    AS_TYPEN_SELECT(__builtin_as_uchar8, llvm::Type::getInt8Ty(context), 8)
    AS_TYPEN_SELECT(__builtin_as_uchar16, llvm::Type::getInt8Ty(context), 16)
    AS_TYPEN_SELECT(__builtin_as_short, llvm::Type::getInt16Ty(context), 1)
    AS_TYPEN_SELECT(__builtin_as_short2, llvm::Type::getInt16Ty(context), 2)
    AS_TYPEN_SELECT(__builtin_as_short3, llvm::Type::getInt16Ty(context), 3)
    AS_TYPEN_SELECT(__builtin_as_short4, llvm::Type::getInt16Ty(context), 4)
    AS_TYPEN_SELECT(__builtin_as_short8, llvm::Type::getInt16Ty(context), 8)
    AS_TYPEN_SELECT(__builtin_as_short16, llvm::Type::getInt16Ty(context), 16)
    AS_TYPEN_SELECT(__builtin_as_ushort, llvm::Type::getInt16Ty(context), 1)
    AS_TYPEN_SELECT(__builtin_as_ushort2, llvm::Type::getInt16Ty(context), 2)
    AS_TYPEN_SELECT(__builtin_as_ushort3, llvm::Type::getInt16Ty(context), 3)
    AS_TYPEN_SELECT(__builtin_as_ushort4, llvm::Type::getInt16Ty(context), 4)
    AS_TYPEN_SELECT(__builtin_as_ushort8, llvm::Type::getInt16Ty(context), 8)
    AS_TYPEN_SELECT(__builtin_as_ushort16, llvm::Type::getInt16Ty(context), 16)
    AS_TYPEN_SELECT(__builtin_as_int, llvm::Type::getInt32Ty(context), 1)
    AS_TYPEN_SELECT(__builtin_as_int2, llvm::Type::getInt32Ty(context), 2)
    AS_TYPEN_SELECT(__builtin_as_int3, llvm::Type::getInt32Ty(context), 3)
    AS_TYPEN_SELECT(__builtin_as_int4, llvm::Type::getInt32Ty(context), 4)
    AS_TYPEN_SELECT(__builtin_as_int8, llvm::Type::getInt32Ty(context), 8)
    AS_TYPEN_SELECT(__builtin_as_int16, llvm::Type::getInt32Ty(context), 16)
    AS_TYPEN_SELECT(__builtin_as_uint, llvm::Type::getInt32Ty(context), 1)
    AS_TYPEN_SELECT(__builtin_as_uint2, llvm::Type::getInt32Ty(context), 2)
    AS_TYPEN_SELECT(__builtin_as_uint3, llvm::Type::getInt32Ty(context), 3)
    AS_TYPEN_SELECT(__builtin_as_uint4, llvm::Type::getInt32Ty(context), 4)
    AS_TYPEN_SELECT(__builtin_as_uint8, llvm::Type::getInt32Ty(context), 8)
    AS_TYPEN_SELECT(__builtin_as_uint16, llvm::Type::getInt32Ty(context), 16)
    AS_TYPEN_SELECT(__builtin_as_long, llvm::Type::getInt64Ty(context), 1)
    AS_TYPEN_SELECT(__builtin_as_long2, llvm::Type::getInt64Ty(context), 2)
    AS_TYPEN_SELECT(__builtin_as_long3, llvm::Type::getInt64Ty(context), 3)
    AS_TYPEN_SELECT(__builtin_as_long4, llvm::Type::getInt64Ty(context), 4)
    AS_TYPEN_SELECT(__builtin_as_long8, llvm::Type::getInt64Ty(context), 8)
    AS_TYPEN_SELECT(__builtin_as_long16, llvm::Type::getInt64Ty(context), 16)
    AS_TYPEN_SELECT(__builtin_as_ulong, llvm::Type::getInt64Ty(context), 1)
    AS_TYPEN_SELECT(__builtin_as_ulong2, llvm::Type::getInt64Ty(context), 2)
    AS_TYPEN_SELECT(__builtin_as_ulong3, llvm::Type::getInt64Ty(context), 3)
    AS_TYPEN_SELECT(__builtin_as_ulong4, llvm::Type::getInt64Ty(context), 4)
    AS_TYPEN_SELECT(__builtin_as_ulong8, llvm::Type::getInt64Ty(context), 8)
    AS_TYPEN_SELECT(__builtin_as_ulong16, llvm::Type::getInt64Ty(context), 16)
    AS_TYPEN_SELECT(__builtin_as_float, llvm::Type::getFloatTy(context), 1)
    AS_TYPEN_SELECT(__builtin_as_float2, llvm::Type::getFloatTy(context), 2)
    AS_TYPEN_SELECT(__builtin_as_float3, llvm::Type::getFloatTy(context), 3)
    AS_TYPEN_SELECT(__builtin_as_float4, llvm::Type::getFloatTy(context), 4)
    AS_TYPEN_SELECT(__builtin_as_float8, llvm::Type::getFloatTy(context), 8)
    AS_TYPEN_SELECT(__builtin_as_float16, llvm::Type::getFloatTy(context), 16)
    AS_TYPEN_SELECT(__builtin_as_double, llvm::Type::getDoubleTy(context), 1)
    AS_TYPEN_SELECT(__builtin_as_double2, llvm::Type::getDoubleTy(context), 2)
    AS_TYPEN_SELECT(__builtin_as_double3, llvm::Type::getDoubleTy(context), 3)
    AS_TYPEN_SELECT(__builtin_as_double4, llvm::Type::getDoubleTy(context), 4)
    AS_TYPEN_SELECT(__builtin_as_double8, llvm::Type::getDoubleTy(context), 8)
    AS_TYPEN_SELECT(__builtin_as_double16, llvm::Type::getDoubleTy(context), 16)    
    default: assert(0 && "Invalid case in switch");
  }
  ...
  if (ElemDimension == 1) {
    ...
    CastType = llvm::VectorType::get(ElemType, ElemDimension);
  }

  assert(E->getNumArgs() == 1 && "Expect valid invocation of as_typen here");
  const Expr *Arg = E->getArg(0);
  llvm::Value *Operand = CGF.EmitScalarExpr(Arg);

  // The OpenCL 1.1 spec states (6.2.4.2) that as_typen conversion from a 
  // 4-element vector to a 3-element vector of the same element size is valid.
  if (ElemDimension == 3 && Arg->getType()->isVectorType() &&
      Arg->getType()->getAs<clang::VectorType>()->getNumElements() == 4) {
    // First create a bitcast to a 4-element vector of the target element type
    const llvm::Type *VecCastType = llvm::VectorType::get(ElemType, 4);
    llvm::Value *Cast = CGF.Builder.CreateBitCast(Operand, VecCastType);

    // Now create a shufflevector instruction to truncate the 4th element
    const IntegerType *Int32Ty = llvm::Type::getInt32Ty(context);
    llvm::Constant *MaskArray[] = {
      llvm::ConstantInt::get(Int32Ty, 0),
      llvm::ConstantInt::get(Int32Ty, 1),
      llvm::ConstantInt::get(Int32Ty, 2)
    };
    llvm::Constant *Mask = llvm::ConstantVector::get(MaskArray, 3);

    return RValue::get(CGF.Builder.CreateShuffleVector(
      Cast, llvm::UndefValue::get(VecCastType), Mask, "as_typen"));
  }

  // as_typen conversion is specified as implementation-defined for conversion
  // from a 3-element vector to 4-element vector, but the conformance currently
  // tests this case, so it's implemented
  if (ElemDimension == 4 && Arg->getType()->isVectorType() &&
      Arg->getType()->getAs<clang::VectorType>()->getNumElements() == 3) {
      // First create a bitcast to a 3-element vector of the target element type
      const llvm::Type *VecCastType = llvm::VectorType::get(ElemType, 3);
      llvm::Value *Cast = CGF.Builder.CreateBitCast(Operand, VecCastType);

      // Now create a shufflevector instruction to expand to 4-elements, the 
      // 4th being undefined
      const IntegerType *Int32Ty = llvm::Type::getInt32Ty(context);
      llvm::Constant *MaskArray[] = {
        llvm::ConstantInt::get(Int32Ty, 0),
      ...
      llvm::Constant *Mask = llvm::ConstantVector::get(MaskArray, 4);

      return RValue::get(CGF.Builder.CreateShuffleVector(
        Cast, llvm::UndefValue::get(VecCastType), Mask, "as_typen"));
  }

  return RValue::get(CGF.Builder.CreateBitCast(Operand, CastType, "as_typen"));
}
...
static Value *EmitFAbs(CodeGenFunction &CGF, Value *V, QualType ValTy) {
  ...
  LLVM_ASSERT(ValTyP && "isn't scalar fp type!");
  
  StringRef FnName;
  switch (ValTyP->getKind()) {
  default: LLVM_ASSERT(0 && "Isn't a scalar fp type!");
...
RValue CodeGenFunction::EmitBuiltinExpr(const FunctionDecl *FD,
  ...
  case Builtin::BI__builtin_isunordered: {
    ...
    switch (BuiltinID) {
    default: LLVM_ASSERT(0 && "Unknown ordered comparison");
    case Builtin::BI__builtin_isgreater:
  ...
  case Builtin::BI__builtin_eh_return: {
    ...
    LLVM_ASSERT((IntTy->getBitWidth() == 32 || IntTy->getBitWidth() == 64) &&
  ...
  case Builtin::BI__sync_lock_release:
    LLVM_ASSERT(0 && "Shouldn't make it through sema");
  ...
  if (BuiltinID >= Builtin::BI__builtin_as_char &&
    BuiltinID <= Builtin::BI__builtin_as_uintptr_t) {
    return EmitAsTypeN(*this, BuiltinID, E);
  }
  ...
  if (IntrinsicID != Intrinsic::not_intrinsic) {
    ...
    for (unsigned i = 0, e = E->getNumArgs(); i != e; ++i) {
      ...
      if (PTy != ArgValue->getType()) {
        LLVM_ASSERT(PTy->canLosslesslyBitCastTo(FTy->getParamType(i)) &&
    ...
    if (RetTy != V->getType()) {
      LLVM_ASSERT(V->getType()->canLosslesslyBitCastTo(RetTy) &&
...
Value *CodeGenFunction::EmitARMBuiltinExpr(unsigned BuiltinID,
  ...
  case ARM::BI__builtin_neon_vld4_dup_v: {
    ...
    case ARM::BI__builtin_neon_vld4_dup_v:
      Int = Intrinsic::arm_neon_vld2lane; 
      break;
    default: LLVM_ASSERT(0 && "unknown vld_dup intrinsic?");
    }
    Function *F = CGM.getIntrinsic(Int, &Ty, 1);
...
Value *CodeGenFunction::EmitX86BuiltinExpr(unsigned BuiltinID,
  ...
  case X86::BI__builtin_ia32_psrlwi128: {
    ...
    switch (BuiltinID) {
    default: LLVM_ASSERT(0 && "Unsupported shift intrinsic!");
    case X86::BI__builtin_ia32_pslldi128:
      name = "pslldi";
...
Value *CodeGenFunction::EmitPPCBuiltinExpr(unsigned BuiltinID,
  ...
  case PPC::BI__builtin_altivec_lvsr:
  {
    ...
    switch (BuiltinID) {
    default: LLVM_ASSERT(0 && "Unsupported ld/lvsl/lvsr intrinsic!");
    case PPC::BI__builtin_altivec_lvx:
  ...
  case PPC::BI__builtin_altivec_stvewx:
  {
    ...
    switch (BuiltinID) {
    default: LLVM_ASSERT(0 && "Unsupported st intrinsic!");
    case PPC::BI__builtin_altivec_stvx:

...
bool CodeGenModule::TryEmitDefinitionAsAlias(GlobalDecl AliasDecl,
  ...
  if (Entry) {
    LLVM_ASSERT(Entry->isDeclaration() && "definition already exists for alias");
    LLVM_ASSERT(Entry->getType() == AliasType &&
...
void CGCXXABI::EmitThisParam(CodeGenFunction &CGF) {
  ...
  LLVM_ASSERT(getThisDecl(CGF) && "no 'this' variable for function");
  getThisValue(CGF)

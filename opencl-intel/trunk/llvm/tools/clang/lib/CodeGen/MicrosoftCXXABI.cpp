...
MicrosoftCXXNameMangler::mangleUnqualifiedName(const NamedDecl *ND,
  ...
  switch (Name.getNameKind()) {
    ...
    case DeclarationName::CXXConstructorName:
      LLVM_ASSERT(false && "Can't mangle constructors yet!");
      break;
      
    case DeclarationName::CXXDestructorName:
      LLVM_ASSERT(false && "Can't mangle destructors yet!");
      break;
    ...
    case DeclarationName::CXXLiteralOperatorName:
      ...
      LLVM_ASSERT(false && "Don't know how to mangle literal operators yet!");
      break;
...
void MicrosoftCXXNameMangler::mangleOperatorName(OverloadedOperatorKind OO) {
  ...
  case OO_Conditional:
    LLVM_ASSERT(false && "Don't know how to mangle ?:");
    break;
...
void MicrosoftCXXNameMangler::mangleType(const BuiltinType *T) {
  ...
  case BuiltinType::NullPtr:
    LLVM_ASSERT(false && "Don't know how to mangle this type");
    break;
  }
}
...
void MicrosoftCXXNameMangler::mangleCallingConvention(const FunctionType *T) {
  ...
  switch (T->getCallConv()) {
    ...
    case CC_X86SvmlCall: LLVM_ASSERT(false && "Cannot handle this CC now"); break;
  }
}
...
void MicrosoftCXXNameMangler::mangleType(const UnresolvedUsingType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle UnresolvedUsingTypes yet!");
}
...
void MicrosoftCXXNameMangler::mangleExtraDimensions(QualType ElementTy) {
  ...
  for (;;) {
    if (ElementTy->isConstantArrayType()) {
      ...
      LLVM_ASSERT(false && "Don't know how to mangle VLAs!");
    } else if (ElementTy->isDependentSizedArrayType()) {
      // The dependent expression has to be folded into a constant (TODO).
      LLVM_ASSERT(false && "Don't know how to mangle dependent-sized arrays!");
...
void MicrosoftCXXNameMangler::mangleType(const TemplateTypeParmType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle TemplateTypeParmTypes yet!");
}
...
void MicrosoftCXXNameMangler::mangleType(const RValueReferenceType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle RValueReferenceTypes yet!");
}

void MicrosoftCXXNameMangler::mangleType(const ComplexType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle ComplexTypes yet!");
}

void MicrosoftCXXNameMangler::mangleType(const VectorType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle VectorTypes yet!");
}
void MicrosoftCXXNameMangler::mangleType(const ExtVectorType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle ExtVectorTypes yet!");
}
void MicrosoftCXXNameMangler::mangleType(const DependentSizedExtVectorType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle DependentSizedExtVectorTypes yet!");
}
...
void MicrosoftCXXNameMangler::mangleType(const InjectedClassNameType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle InjectedClassNameTypes yet!");
}

void MicrosoftCXXNameMangler::mangleType(const TemplateSpecializationType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle TemplateSpecializationTypes yet!");
}

void MicrosoftCXXNameMangler::mangleType(const DependentNameType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle DependentNameTypes yet!");
}
...
void MicrosoftCXXNameMangler::mangleType(const TypeOfType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle TypeOfTypes yet!");
}

void MicrosoftCXXNameMangler::mangleType(const TypeOfExprType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle TypeOfExprTypes yet!");
}

void MicrosoftCXXNameMangler::mangleType(const DecltypeType *T) {
  LLVM_ASSERT(false && "Don't know how to mangle DecltypeTypes yet!");
}
...
void MicrosoftMangleContext::mangleThunk(const CXXMethodDecl *MD,
                                         const ThunkInfo &Thunk,
                                         llvm::SmallVectorImpl<char> &) {
  LLVM_ASSERT(false && "Can't yet mangle thunks!");
}
void MicrosoftMangleContext::mangleCXXDtorThunk(const CXXDestructorDecl *DD,
                                                CXXDtorType Type,
                                                const ThisAdjustment &,
                                                llvm::SmallVectorImpl<char> &) {
  LLVM_ASSERT(false && "Can't yet mangle destructor thunks!");
}
void MicrosoftMangleContext::mangleGuardVariable(const VarDecl *D,
                                                 llvm::SmallVectorImpl<char> &) {
  LLVM_ASSERT(false && "Can't yet mangle guard variables!");
}
void MicrosoftMangleContext::mangleCXXVTable(const CXXRecordDecl *RD,
                                             llvm::SmallVectorImpl<char> &) {
  LLVM_ASSERT(false && "Can't yet mangle virtual tables!");
}
...
void MicrosoftMangleContext::mangleCXXRTTI(QualType T,
                                           llvm::SmallVectorImpl<char> &) {
  LLVM_ASSERT(false && "Can't yet mangle RTTI!");
}
void MicrosoftMangleContext::mangleCXXRTTIName(QualType T,
                                               llvm::SmallVectorImpl<char> &) {
  LLVM_ASSERT(false && "Can't yet mangle RTTI names!");
}
void MicrosoftMangleContext::mangleCXXCtor(const CXXConstructorDecl *D,
                                           CXXCtorType Type,
                                           llvm::SmallVectorImpl<char> &) {
  LLVM_ASSERT(false && "Can't yet mangle constructors!");
}
void MicrosoftMangleContext::mangleCXXDtor(const CXXDestructorDecl *D,
                                           CXXDtorType Type,
                                           llvm::SmallVectorImpl<char> &) {
  LLVM_ASSERT(false && "Can't yet mangle destructors!");
}

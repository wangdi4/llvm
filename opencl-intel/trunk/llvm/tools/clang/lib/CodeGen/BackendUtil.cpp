...
private:
	EmitAssemblyHelper(const EmitAssemblyHelper &e): Diags(e.Diags), 
		     CodeGenOpts(e.CodeGenOpts), TargetOpts(e.TargetOpts) {}
...
bool EmitAssemblyHelper::AddEmitPasses(BackendAction Action,
  ...
  if (CodeGenOpts.FloatABI == "soft")
    ...
    LLVM_ASSERT(CodeGenOpts.FloatABI.empty() && "Invalid float abi!");
  ...
  if (CodeGenOpts.RelocationModel == "static") {
    ...
    LLVM_ASSERT(CodeGenOpts.RelocationModel == "dynamic-no-pic" &&
           "Invalid PIC model!");
  ...
  if (CodeGenOpts.CodeModel == "small") {
    ...
    LLVM_ASSERT(CodeGenOpts.CodeModel.empty() && "Invalid code model!");
  ...
  if (Action == Backend_EmitObj)
    ...
    LLVM_ASSERT(Action == Backend_EmitAssembly && "Invalid action!");

...
RValue CodeGenFunction::EmitObjCMessageExpr(const ObjCMessageExpr *E,
  ...
  case ObjCMessageExpr::Class: {
    ...
    LLVM_ASSERT(ObjTy && "Invalid Objective-C class message send");
    OID = ObjTy->getInterface();
    LLVM_ASSERT(OID && "Invalid Objective-C class message send");
...
void CodeGenFunction::GenerateObjCGetter(ObjCImplementationDecl *IMP,
  ...
  LLVM_ASSERT(OMD && "Invalid call to generate getter (empty method)");
...
void CodeGenFunction::GenerateObjCSetter(ObjCImplementationDecl *IMP,
  ...
  LLVM_ASSERT(OMD && "Invalid call to generate setter (empty method)");
  StartObjCMethod(OMD, IMP->getClassInterface());
...
void CodeGenFunction::EmitObjCForCollectionStmt(const ObjCForCollectionStmt &S){
  ...
  if (const DeclStmt *SD = dyn_cast<DeclStmt>(S.getElement())) {
    EmitStmt(SD);
    LLVM_ASSERT(HaveInsertPoint() && "DeclStmt destroyed insert point!");

...
ExprResult Parser::ParseInitializerWithPotentialDesignator() {
  ...
  if (Tok.is(tok::identifier)) {
    ...
    LLVM_ASSERT(Tok.is(tok::colon) && "MayBeDesignationStart not working properly!");
  ...
  while (Tok.is(tok::period) || Tok.is(tok::l_square)) {
    ...
    LLVM_ASSERT(Tok.is(tok::l_square) && "Unexpected token!");
  ...
  LLVM_ASSERT(!Desig.empty() && "Designator is empty?");

...
Parser::ParseTemplateDeclarationOrSpecialization(unsigned Context,
                                                 SourceLocation &DeclEnd,
                                                 AccessSpecifier AS) {
  LLVM_ASSERT((Tok.is(tok::kw_export) || Tok.is(tok::kw_template)) &&
...
Parser::ParseSingleDeclarationAfterTemplate(
                                       ...
                                       SourceLocation &DeclEnd,
                                       AccessSpecifier AS) {
  LLVM_ASSERT(TemplateInfo.Kind != ParsedTemplateInfo::NonTemplate &&
...
Decl *Parser::ParseTypeParameter(unsigned Depth, unsigned Position) {
  LLVM_ASSERT((Tok.is(tok::kw_class) || Tok.is(tok::kw_typename)) &&
...
Parser::ParseTemplateTemplateParameter(unsigned Depth, unsigned Position) {
  LLVM_ASSERT(Tok.is(tok::kw_template) && "Expected 'template' keyword");
...
Parser::ParseTemplateIdAfterTemplateName(TemplateTy Template,
                                         ...
                                         SourceLocation &RAngleLoc) {
  LLVM_ASSERT(Tok.is(tok::less) && "Must have already parsed the template-name");
...
bool Parser::AnnotateTemplateIdToken(TemplateTy Template, TemplateNameKind TNK,
  ...
  LLVM_ASSERT(getLang().CPlusPlus && "Can only annotate template-ids in C++");
  LLVM_ASSERT(Template && Tok.is(tok::less) &&
...
void Parser::AnnotateTemplateIdTokenAsType(const CXXScopeSpec *SS) {
  LLVM_ASSERT(Tok.is(tok::annot_template_id) && "Requires template-id tokens");

  TemplateIdAnnotation *TemplateId
    = static_cast<TemplateIdAnnotation *>(Tok.getAnnotationValue());
  LLVM_ASSERT((TemplateId->Kind == TNK_Type_template ||

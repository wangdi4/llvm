...
bool Parser::isCXXSimpleDeclaration() {
  ...
  LLVM_ASSERT(TPR == TPResult::True() || TPR == TPResult::False());
...
Parser::TPResult Parser::TryParseSimpleDeclaration() {
  ...
  // by a '('.
  LLVM_ASSERT(isCXXDeclarationSpecifier() == TPResult::Ambiguous());
  ...
  LLVM_ASSERT(Tok.is(tok::l_paren) && "Expected '('");
...
Parser::TPResult Parser::TryParseTypeofSpecifier() {
  LLVM_ASSERT(Tok.is(tok::kw_typeof) && "Expected 'typeof'!");
  ConsumeToken();

...
class LocInfoType : public Type {
  ...
  LocInfoType(QualType ty, TypeSourceInfo *TInfo)
    ...
    LLVM_ASSERT(getTypeClass() == (TypeClass)LocInfo && "LocInfo didn't fit in TC?");
  }
  friend class Sema;
...
public:
  ...
  public:
    ContextRAII(Sema &S, DeclContext *ContextToPush)
      ...
      LLVM_ASSERT(ContextToPush && "pushing null context");
...
public:
  ...
  bool IsOpenCLImageType(const std::string& str);
...
public:
  ...
  void DiagnoseUnusedExprResult(const Stmt *S, bool isComma = false);
  ...
  ExprResult CreateSizeOfAlignOfExpr(Expr *E, SourceLocation OpLoc,
                                     ...
                                     SourceRange R);
  ExprResult
    ActOnSizeOfAlignOfExpr(SourceLocation OpLoc, SizeOfAlignOfExpr::Kind_t exprKind, bool isType,
                           void *TyOrEx, const SourceRange &ArgRange);

  ExprResult
    ActOnEndianAttr(SourceLocation OpLoc, const char* param, unsigned int len);

  bool CheckAlignOfExpr(Expr *E, SourceLocation OpLoc, const SourceRange &R);
  bool CheckVecStepExpr(Expr *E, SourceLocation OpLoc, const SourceRange &R);
  bool CheckSizeOfAlignOfOperand(QualType type, SourceLocation OpLoc,
                                 const SourceRange &R, SizeOfAlignOfExpr::Kind_t exprKind);
  ...
  ExprResult BuildCStyleCastExpr(SourceLocation LParenLoc,
                                 TypeSourceInfo *Ty,
                                 SourceLocation RParenLoc,
                                 Expr *Op, bool isParenthesizedExprSet = false);
  ...
  QualType CheckVectorOperands(SourceLocation l, Expr *&lex, Expr *&rex, bool allowFloatingPointTypes);
  ...
  bool CheckCastTypes(SourceRange TyRange, QualType CastTy, Expr *&CastExpr,
                      CastKind &Kind, CXXCastPath &BasePath, bool isParenthesizedExprSet = false,
...
private:
  ...
  bool SemaBuiltinAsTypeN(unsigned BuiltinID, ExprResult TheCallResult);

...
public:
  ...
  public:
    ...
    iterator(NamedDecl *D) {
      ...
      LLVM_ASSERT((Ptr & 0x1) == 0 && "Invalid Ptr!");
    }
    ...
    BaseIter getIterator() const {
      LLVM_ASSERT(isIterator() && "Ptr not an iterator!");
...
private:
  ...
  IdentifierResolver(const IdentifierResolver &i);
  IdentifierResolver& operator=(const IdentifierResolver &i);
  class IdDeclInfoMap;
  ...
  static inline IdDeclInfo *toIdDeclInfo(void *Ptr) {
    LLVM_ASSERT((reinterpret_cast<uintptr_t>(Ptr) & 0x1) == 1

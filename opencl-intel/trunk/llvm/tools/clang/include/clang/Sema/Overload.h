...
namespace clang {
  ...
  enum ImplicitConversionKind {
	...
	ICK_Widening,			   ///< Widening only (OpenCL)
	ICK_Integral_Promotion_Widening, ///< Integral promotions and widening (OpenCL)
	ICK_Floating_Promotion_Widening, ///< Floating point promotions and widening (OpenCL)
	...
	ICK_Integral_Conversion_Widening, ///< Integral conversions and widening (OpenCL)
	ICK_Floating_Conversion_Widening, ///< Floating point conversions and widening (OpenCL)
	ICK_Floating_Integral_Widening, ///< Floating-integral conversions and widening (OpenCL)
  ...
  enum ImplicitConversionRank {
	...
	ICR_Widening,				///< Widening (OpenCL)
	ICR_Promotion_Widening,		///< Promotion + Widening (OpenCL)
    ICR_Conversion,             ///< Conversion
	ICR_Conversion_Widening,	///< Conversion + Widening (OpenCL)
  ...
  public:
    ...
    void setToType(unsigned Idx, QualType T) { 
      LLVM_ASSERT(Idx < 3 && "To type index is out of range");
  ...
  public:
    ...
    Kind getKind() const {
      LLVM_ASSERT(isInitialized() && "querying uninitialized conversion");

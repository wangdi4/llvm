...
public:
  ...
  CXXRecordDecl *getBaseClass() const {
    LLVM_ASSERT(!IsMember); return cast<CXXRecordDecl>(Target);
  }
  ...
  void setDiag(const PartialDiagnostic &PDiag) {
    LLVM_ASSERT(isQuiet() && "partial diagnostic already defined");
    Diag = PDiag;
  }
  PartialDiagnostic &setDiag(unsigned DiagID) {
    LLVM_ASSERT(isQuiet() && "partial diagnostic already defined");
    LLVM_ASSERT(DiagID && "creating null diagnostic");
    Diag.Reset(DiagID);
    return Diag;
  }

...
private:
  ...
  Storage *getStorage() const {
    ...
    if (Allocator)
      ...
      LLVM_ASSERT(Allocator != reinterpret_cast<StorageAllocator *>(~uintptr_t(0)));
  ...
  void AddSourceRange(const CharSourceRange &R) const {
    ...
    LLVM_ASSERT(DiagStorage->NumDiagRanges < 
  ...
  void AddFixItHint(const FixItHint &Hint) const {
    ...
    LLVM_ASSERT(DiagStorage->NumFixItHints < Storage::MaxFixItHints &&
...
public:
  ...
  void AddTaggedVal(intptr_t V, Diagnostic::ArgumentKind Kind) const {
    ...
    LLVM_ASSERT(DiagStorage->NumDiagArgs < Storage::MaxArguments &&
           "Too many arguments to diagnostic!");

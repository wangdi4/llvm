...
struct StmtDeclBitVector_Types {
  ...
  public:
    ...
    ASTContext& getContext() {
      LLVM_ASSERT(ctx && "ASTContext should not be NULL.");
      return *ctx;
    }

    void setCFG(CFG& c) { cfg = &c; }
    CFG& getCFG() { LLVM_ASSERT(cfg && "CFG should not be NULL."); return *cfg; }
    ...
    unsigned getIdx(const Stmt* S) const {
      ...
      LLVM_ASSERT(I && "Stmtession not tracked for bitvector.");
      return I;
    }

...
public:
  ...
  TemplateArgument& operator=(const TemplateArgument& Other) {
    ...
    // FIXME: Handle Packs
    LLVM_ASSERT(Kind != Pack && "FIXME: Handle packs");
    LLVM_ASSERT(Other.Kind != Pack && "FIXME: Handle packs");
...
#ifndef NDEBUG
    LLVM_ASSERT(Kind == K_TypeSourceInfo);
#endif
    return Declarator;
  }
...
public:
  ...
  TemplateArgumentLoc(const TemplateArgument &Argument, TypeSourceInfo *TInfo)
    ...
    LLVM_ASSERT(Argument.getKind() == TemplateArgument::Type);
  }

  TemplateArgumentLoc(const TemplateArgument &Argument, Expr *E)
    : Argument(Argument), LocInfo(E) {
    LLVM_ASSERT(Argument.getKind() == TemplateArgument::Expression);
  }
  ...
  TemplateArgumentLoc(const TemplateArgument &Argument, 
    ...
    LLVM_ASSERT(Argument.getKind() == TemplateArgument::Template);
  }
  ...
  Expr *getSourceDeclExpression() const {
    LLVM_ASSERT(Argument.getKind() == TemplateArgument::Declaration);
    return LocInfo.getAsExpr();
  }
...
inline const TemplateArgument &
  ...
  LLVM_ASSERT(Idx < getNumArgs() && "Template argument out of range");
  return getArgs()[Idx];
}

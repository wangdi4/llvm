...
private:
  ...
  DeclarationNameExtra *getExtra() const {
    LLVM_ASSERT(getStoredNameKind() == StoredDeclarationNameExtra &&
  ...
  DeclarationName(CXXSpecialName *Name)
    ...
    LLVM_ASSERT((Ptr & PtrMask) == 0 && "Improperly aligned CXXSpecialName");
  ...
  DeclarationName(CXXOperatorIdName *Name)
    : Ptr(reinterpret_cast<uintptr_t>(Name)) {
    LLVM_ASSERT((Ptr & PtrMask) == 0 && "Improperly aligned CXXOperatorId");
    Ptr |= StoredDeclarationNameExtra;
  }

  DeclarationName(CXXLiteralOperatorIdName *Name)
    : Ptr(reinterpret_cast<uintptr_t>(Name)) {
    LLVM_ASSERT((Ptr & PtrMask) == 0 && "Improperly aligned CXXLiteralOperatorId");
    Ptr |= StoredDeclarationNameExtra;
  }
...
public:
  ...
  DeclarationName(const IdentifierInfo *II)
    ...
    LLVM_ASSERT((Ptr & PtrMask) == 0 && "Improperly aligned IdentifierInfo");
  }
...
public:
  ...
  TypeSourceInfo *getNamedTypeInfo() const {
    LLVM_ASSERT(Name.getNameKind() == DeclarationName::CXXConstructorName ||
  ...
  SourceRange getCXXOperatorNameRange() const {
    LLVM_ASSERT(Name.getNameKind() == DeclarationName::CXXOperatorName);
    return SourceRange(
  ...
  SourceLocation getCXXLiteralOperatorNameLoc() const {
    LLVM_ASSERT(Name.getNameKind() == DeclarationName::CXXLiteralOperatorName);

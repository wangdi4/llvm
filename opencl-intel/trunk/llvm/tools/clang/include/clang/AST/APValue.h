...
public:
  ...
  APSInt &getInt() {
    LLVM_ASSERT(isInt() && "Invalid accessor");
  ...
  APFloat &getFloat() {
    LLVM_ASSERT(isFloat() && "Invalid accessor");
  ...
  APValue &getVectorElt(unsigned i) {
    LLVM_ASSERT(isVector() && "Invalid accessor");
  ...
  APSInt &getComplexIntReal() {
    LLVM_ASSERT(isComplexInt() && "Invalid accessor");
  ...
  APFloat &getComplexFloatReal() {
    LLVM_ASSERT(isComplexFloat() && "Invalid accessor");
  ...
  void setComplexInt(const APSInt &R, const APSInt &I) {
    LLVM_ASSERT(R.getBitWidth() == I.getBitWidth() &&
  ...
  void setComplexFloat(const APFloat &R, const APFloat &I) {
    LLVM_ASSERT(&R.getSemantics() == &I.getSemantics() &&
...
private:
  void MakeUninit();
  void MakeInt() {
    LLVM_ASSERT(isUninit() && "Bad state change");

...
void AssemblyWriter::printFunction(const Function *F) {
  ...
  case CallingConv::X86_Svml:     Out << "x86_svmlcc "; break;
  case CallingConv::X86_Svml_P2_F8_F8_F8:     Out << "x86_svmlcc_p2_f8_f8_f8 "; break;
  case CallingConv::X86_OCL_Kernel:     Out << " x86_ocl_kernelcc "; break;
  case CallingConv::X86_SvmlThunk: Out << "x86_svmlthunk"; break;

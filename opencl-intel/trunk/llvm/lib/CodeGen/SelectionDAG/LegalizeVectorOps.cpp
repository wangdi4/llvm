...
class VectorLegalizer {
  ...
  // SINT_TO_FLOAT on vectors isn't legal.
...
SDValue VectorLegalizer::ExpandUINT_TO_FLOAT(SDValue Op) {
  ...
  // We are going to use vector SINT_TO_FP, SRL and SHL instructions. 

...
X86FastISel::X86FastEmitStore(EVT VT, unsigned Val,
  ...
  case MVT::f32:
    Opc = Subtarget->hasAVX()? X86::VMOVSSmr : (Subtarget->hasSSE1() ? X86::MOVSSmr : X86::ST_Fp32m);
    break;
  case MVT::f64:
    Opc = Subtarget->hasAVX()? X86::VMOVSSmr : (Subtarget->hasSSE2() ? X86::MOVSDmr : X86::ST_Fp64m);
    break;
  }
...
bool X86FastISel::X86SelectRet(const Instruction *I) {
  ...
  if (CC != CallingConv::C &&
      ...
      CC != CallingConv::X86_Svml &&
      CC != CallingConv::X86_Svml_P2_F8_F8_F8)
    return false;
...
static unsigned X86ChooseCmpOpcode(EVT VT, const X86Subtarget *Subtarget) {
  ...
  case MVT::f32: return Subtarget->hasAVX() ? X86::VUCOMISSrr : (Subtarget->hasSSE1() ? X86::UCOMISSrr : 0);
  case MVT::f64: return Subtarget->hasAVX() ? X86::VUCOMISDrr : (Subtarget->hasSSE2() ? X86::UCOMISDrr : 0);
  }
}

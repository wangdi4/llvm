...
namespace llvm {
  ...
  bool JumpOptimizationDisabled(false);
}
...
DisableFPElim("disable-fp-elim",
  ...
  cl::init(false));
static cl::opt<bool, true>
DisableJumpOptimization("disable-jump-opt",
  cl::desc("Do not run jump optimization because jump is expensive"),
  cl::location(JumpOptimizationDisabled),
  cl::init(false));
static cl::opt<bool, true>

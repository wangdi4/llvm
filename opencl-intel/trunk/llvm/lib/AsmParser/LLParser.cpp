...
bool LLParser::ParseOptionalCallingConv(CallingConv::ID &CC) {
  ...
  case lltok::kw_x86_svmlcc:     CC = CallingConv::X86_Svml; break;
  case lltok::kw_x86_svmlcc_p2_f8_f8_f8:     CC = CallingConv::X86_Svml_P2_F8_F8_F8; break;
  case lltok::kw_x86_ocl_kernelcc: CC = CallingConv::X86_OCL_Kernel; break;

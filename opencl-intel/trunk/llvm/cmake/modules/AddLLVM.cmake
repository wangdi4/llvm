...
# - in Windows it will create .lib and .dll
# - in Linux it creates .so 
#   The executable that wants to use shared library name _name_
# should add "set( LLVM_USED_LIBS _name_ )
# Example of usage: DX2LLVM convertor
macro(add_llvm_shared_library name)
    llvm_process_sources( ALL_FILES ${ARGN} )
...
endmacro(add_llvm_shared_library name)

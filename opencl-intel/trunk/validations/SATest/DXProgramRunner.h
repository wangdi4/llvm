...
File Name:  DXProgramRunner.h

\*****************************************************************************/
#ifndef DX_PROGRAM_RUNNER_H
#define DX_PROGRAM_RUNNER_H

#include "IProgramRunner.h"

namespace Validation
{
  /// @brief This class enables to run a single DirectX test
  class DXProgramRunner : public IProgramRunner
  {
  public:

    // @brief Constructor
    DXProgramRunner(void);

    /// @brief Destructor
    virtual ~DXProgramRunner(void);

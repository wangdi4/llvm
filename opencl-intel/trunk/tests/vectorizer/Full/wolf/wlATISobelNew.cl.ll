...
if.then:                                          ; preds = %land.lhs.true17
  ...
  %call29 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp28) ; <<4 x float>> [#uses=1]
  ...
  %call37 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp36) ; <<4 x float>> [#uses=1]
  ...
  %call46 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp45) ; <<4 x float>> [#uses=1]
  ...
  %call53 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp52) ; <<4 x float>> [#uses=1]
  ...
  %call59 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp58) ; <<4 x float>> [#uses=1]
  ...
  %call66 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp65) ; <<4 x float>> [#uses=1]
  ...
  %call75 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp74) ; <<4 x float>> [#uses=1]
  ...
  %call83 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp82) ; <<4 x float>> [#uses=1]
  ...
  %call92 = call <4 x float> @_Z14convert_float4U8__vector4h(<4 x i8> %tmp91) ; <<4 x float>> [#uses=1]
  ...
  %call131 = call <4 x float> @_Z5hypotU8__vector4fS_(<4 x float> %tmp129, <4 x float> %tmp130) ; <<4 x float>> [#uses=1]
...
declare <4 x float> @_Z5hypotU8__vector4fS_(<4 x float>, <4 x float>)

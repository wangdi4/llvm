...
@uv_min_val_16 = addrspace(2) global i16 -512, align 2 ; <i16 addrspace(2)*> [#uses=12]
@uv_max_val_16 = addrspace(2) global i16 511, align 2 ; <i16 addrspace(2)*> [#uses=4]
...
@uv_min_val_8_s16 = addrspace(2) global <8 x i16> <i16 -512, i16 -512, i16 -512, i16 -512, i16 -512, i16 -512, i16 -512, i16 -512>, align 16 ; <<8 x i16> addrspace(2)*> [#uses=0]
@uv_max_val_8_s16 = addrspace(2) global <8 x i16> <i16 511, i16 511, i16 511, i16 511, i16 511, i16 511, i16 511, i16 511>, align 16 ; <<8 x i16> addrspace(2)*> [#uses=0]
@hi_key_mask_8_s16 = addrspace(2) global <8 x i16> <i16 -32, i16 -32, i16 -32, i16 -32, i16 -32, i16 -32, i16 -32, i16 -32>, align 16 ; <<8 x i16> addrspace(2)*> [#uses=0]
@alpha_mask_SF_8_s16 = addrspace(2) global <8 x i16> <i16 31, i16 31, i16 31, i16 31, i16 31, i16 31, i16 31, i16 31>, align 16 ; <<8 x i16> addrspace(2)*> [#uses=0]
@rounding_SF_8_s16 = addrspace(2) global <8 x i16> <i16 16, i16 16, i16 16, i16 16, i16 16, i16 16, i16 16, i16 16>, align 16 ; <<8 x i16> addrspace(2)*> [#uses=0]
...
@zero_const_8_s16 = addrspace(2) global <8 x i16> zeroinitializer, align 16 ; <<8 x i16> addrspace(2)*> [#uses=0]
@u_key_16_mask_8_s16 = addrspace(2) global <8 x i16> <i16 528, i16 528, i16 528, i16 528, i16 528, i16 528, i16 528, i16 528>, align 16 ; <<8 x i16> addrspace(2)*> [#uses=0]
@u_key_clear_lower_bits = addrspace(2) global <8 x i16> <i16 -4, i16 -4, i16 -4, i16 -4, i16 -4, i16 -4, i16 -4, i16 -4>, align 16 ; <<8 x i16> addrspace(2)*> [#uses=0]
...
@ff_const_16_u16 = addrspace(2) global <16 x i16> <i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255>, align 32 ; <<16 x i16> addrspace(2)*> [#uses=0]
...
@uv_final_rounding_8_s32 = addrspace(2) global <8 x i32> <i32 64, i32 64, i32 64, i32 64, i32 64, i32 64, i32 64, i32 64>, align 32 ; <<8 x i32> addrspace(2)*> [#uses=0]
@zero_const_8_u32 = addrspace(2) global <8 x i32> zeroinitializer, align 32 ; <<8 x i32> addrspace(2)*> [#uses=0]
...
entry:
  ...
  call void @_Z7vstore8U8__vector8tjPt(<8 x i16> %tmp56, i32 0, i16* %arraydecay)
  store i32 1, i32* %i
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  ...
  %call168 = call <8 x i16> @_Z3maxU8__vector8tS_(<8 x i16> %tmp166, <8 x i16> %tmp167) ; <<8 x i16>> [#uses=1]
  %tmp169 = load <8 x i16>* @maxYVec              ; <<8 x i16>> [#uses=1]
  %call170 = call <8 x i16> @_Z3minU8__vector8tS_(<8 x i16> %call168, <8 x i16> %tmp169) ; <<8 x i16>> [#uses=1]
  %tmp171 = load <8 x i16>** %pui16DstHistPnt.addr ; <<8 x i16>*> [#uses=1]
  store <8 x i16> %call170, <8 x i16>* %tmp171
  ret void
}

declare void @_Z7vstore8U8__vector8tjPt(<8 x i16>, i32, i16*)

declare <8 x i16> @_Z6vload8jPKt(i32, i16*)

declare <8 x i16> @_Z3minU8__vector8tS_(<8 x i16>, <8 x i16>)

declare <8 x i16> @_Z3maxU8__vector8tS_(<8 x i16>, <8 x i16>)
...
for.end:                                          ; preds = %for.cond157
  ...
  %call = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp359, <16 x i16> %tmp360) ; <<16 x i16>> [#uses=1]
  ...
  %call374 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp372, <16 x i16> %tmp373) ; <<16 x i16>> [#uses=1]
  ...
  %call388 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp386, <16 x i16> %tmp387) ; <<16 x i16>> [#uses=1]
  ...
  %call402 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp400, <16 x i16> %tmp401) ; <<16 x i16>> [#uses=1]
  ...
  %call416 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp414, <16 x i16> %tmp415) ; <<16 x i16>> [#uses=1]
  ...
  %call430 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp428, <16 x i16> %tmp429) ; <<16 x i16>> [#uses=1]
  ...
  %call444 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp442, <16 x i16> %tmp443) ; <<16 x i16>> [#uses=1]
  ...
  %call458 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp456, <16 x i16> %tmp457) ; <<16 x i16>> [#uses=1]
  ...
  %call472 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp470, <16 x i16> %tmp471) ; <<16 x i16>> [#uses=1]
  ...
  %call486 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp484, <16 x i16> %tmp485) ; <<16 x i16>> [#uses=1]
  ...
  %call500 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp498, <16 x i16> %tmp499) ; <<16 x i16>> [#uses=1]
  ...
  %call514 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp512, <16 x i16> %tmp513) ; <<16 x i16>> [#uses=1]
  ...
  %call528 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp526, <16 x i16> %tmp527) ; <<16 x i16>> [#uses=1]
  ...
  %call542 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp540, <16 x i16> %tmp541) ; <<16 x i16>> [#uses=1]
  ...
  %call556 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp554, <16 x i16> %tmp555) ; <<16 x i16>> [#uses=1]
  ...
  %call570 = call <16 x i16> @_Z3minU8__vector16tS_(<16 x i16> %tmp568, <16 x i16> %tmp569) ; <<16 x i16>> [#uses=1]
...
declare <16 x i16> @_Z3minU8__vector16tS_(<16 x i16>, <16 x i16>)
...
entry:
  ...
  %v_key_16236 = alloca i16, align 2              ; <i16*> [#uses=2]
...
for.body:                                         ; preds = %for.cond
  ...
  %idxprom = sext i16 %tmp67 to i32               ; <i32> [#uses=1]
  %arrayidx69 = getelementptr inbounds i8 addrspace(2)* %tmp68, i32 %idxprom ; <i8 addrspace(2)*> [#uses=1]
  %tmp70 = load i8 addrspace(2)* %arrayidx69      ; <i8> [#uses=1]
  %tmp71 = load <4 x i8>* %sat_data               ; <<4 x i8>> [#uses=1]
  %tmp72 = insertelement <4 x i8> %tmp71, i8 %tmp70, i32 0 ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp72, <4 x i8>* %sat_data
  %tmp73 = load i16* %index                       ; <i16> [#uses=1]
  %conv74 = sext i16 %tmp73 to i32                ; <i32> [#uses=1]
  %add75 = add nsw i32 %conv74, 1                 ; <i32> [#uses=1]
  %tmp76 = load i8 addrspace(2)** %SatLUTEntry.addr ; <i8 addrspace(2)*> [#uses=1]
  %arrayidx77 = getelementptr inbounds i8 addrspace(2)* %tmp76, i32 %add75 ; <i8 addrspace(2)*> [#uses=1]
  %tmp78 = load i8 addrspace(2)* %arrayidx77      ; <i8> [#uses=1]
  %tmp79 = load <4 x i8>* %sat_data               ; <<4 x i8>> [#uses=1]
  %tmp80 = insertelement <4 x i8> %tmp79, i8 %tmp78, i32 1 ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp80, <4 x i8>* %sat_data
  %tmp81 = load i16* %index                       ; <i16> [#uses=1]
  %conv82 = sext i16 %tmp81 to i32                ; <i32> [#uses=1]
  %add83 = add nsw i32 %conv82, 2                 ; <i32> [#uses=1]
  %tmp84 = load i8 addrspace(2)** %SatLUTEntry.addr ; <i8 addrspace(2)*> [#uses=1]
  %arrayidx85 = getelementptr inbounds i8 addrspace(2)* %tmp84, i32 %add83 ; <i8 addrspace(2)*> [#uses=1]
  %tmp86 = load i8 addrspace(2)* %arrayidx85      ; <i8> [#uses=1]
  %tmp87 = load <4 x i8>* %sat_data               ; <<4 x i8>> [#uses=1]
  %tmp88 = insertelement <4 x i8> %tmp87, i8 %tmp86, i32 2 ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp88, <4 x i8>* %sat_data
  %tmp89 = load i16* %index                       ; <i16> [#uses=1]
  %conv90 = sext i16 %tmp89 to i32                ; <i32> [#uses=1]
  %add91 = add nsw i32 %conv90, 3                 ; <i32> [#uses=1]
  %tmp92 = load i8 addrspace(2)** %SatLUTEntry.addr ; <i8 addrspace(2)*> [#uses=1]
  %arrayidx93 = getelementptr inbounds i8 addrspace(2)* %tmp92, i32 %add91 ; <i8 addrspace(2)*> [#uses=1]
  %tmp94 = load i8 addrspace(2)* %arrayidx93      ; <i8> [#uses=1]
  %tmp95 = load <4 x i8>* %sat_data               ; <<4 x i8>> [#uses=1]
  %tmp96 = insertelement <4 x i8> %tmp95, i8 %tmp94, i32 3 ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp96, <4 x i8>* %sat_data
  %tmp97 = load <4 x i8>* %sat_data               ; <<4 x i8>> [#uses=1]
  %tmp98 = extractelement <4 x i8> %tmp97, i32 0  ; <i8> [#uses=1]
  %conv99 = zext i8 %tmp98 to i32                 ; <i32> [#uses=1]
  %tmp100 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp101 = extractelement <4 x i8> %tmp100, i32 1 ; <i8> [#uses=1]
  %conv102 = zext i8 %tmp101 to i32               ; <i32> [#uses=1]
  %sub = sub i32 %conv99, %conv102                ; <i32> [#uses=1]
  store i32 %sub, i32* %SF0
  %tmp103 = load i32* %SF0                        ; <i32> [#uses=1]
  %tmp104 = load i16* %uv_tmp_16                  ; <i16> [#uses=1]
  %conv105 = sext i16 %tmp104 to i32              ; <i32> [#uses=1]
  %mul106 = mul i32 %tmp103, %conv105             ; <i32> [#uses=1]
  store i32 %mul106, i32* %SF0
  %tmp107 = load i32* %SF0                        ; <i32> [#uses=1]
  %tmp108 = load i16 addrspace(2)* @rounding_SF_16 ; <i16> [#uses=1]
  %conv109 = sext i16 %tmp108 to i32              ; <i32> [#uses=1]
  %add110 = add nsw i32 %tmp107, %conv109         ; <i32> [#uses=1]
  store i32 %add110, i32* %SF0
  %tmp111 = load i32* %SF0                        ; <i32> [#uses=1]
  %shr112 = ashr i32 %tmp111, 5                   ; <i32> [#uses=1]
  store i32 %shr112, i32* %SF0
  %tmp113 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp114 = extractelement <4 x i8> %tmp113, i32 0 ; <i8> [#uses=1]
  %conv115 = zext i8 %tmp114 to i32               ; <i32> [#uses=1]
  %tmp116 = load i32* %SF0                        ; <i32> [#uses=1]
  %add117 = add nsw i32 %conv115, %tmp116         ; <i32> [#uses=1]
  store i32 %add117, i32* %SF0
  %tmp118 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp119 = extractelement <4 x i8> %tmp118, i32 2 ; <i8> [#uses=1]
  %conv120 = zext i8 %tmp119 to i32               ; <i32> [#uses=1]
  %tmp121 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp122 = extractelement <4 x i8> %tmp121, i32 3 ; <i8> [#uses=1]
  %conv123 = zext i8 %tmp122 to i32               ; <i32> [#uses=1]
  %sub124 = sub i32 %conv120, %conv123            ; <i32> [#uses=1]
  store i32 %sub124, i32* %SF1
  %tmp125 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp126 = load i16* %uv_tmp_16                  ; <i16> [#uses=1]
  %conv127 = sext i16 %tmp126 to i32              ; <i32> [#uses=1]
  %mul128 = mul i32 %tmp125, %conv127             ; <i32> [#uses=1]
  store i32 %mul128, i32* %SF1
  %tmp129 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp130 = load i16 addrspace(2)* @rounding_SF_16 ; <i16> [#uses=1]
  %conv131 = sext i16 %tmp130 to i32              ; <i32> [#uses=1]
  %add132 = add nsw i32 %tmp129, %conv131         ; <i32> [#uses=1]
  store i32 %add132, i32* %SF1
  %tmp133 = load i32* %SF1                        ; <i32> [#uses=1]
  %shr134 = ashr i32 %tmp133, 5                   ; <i32> [#uses=1]
  store i32 %shr134, i32* %SF1
  %tmp135 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  ...
  %add139 = add nsw i32 %conv137, %tmp138         ; <i32> [#uses=1]
  store i32 %add139, i32* %SF1
  %tmp140 = load i16* %u16                        ; <i16> [#uses=1]
  %conv141 = sext i16 %tmp140 to i32              ; <i32> [#uses=1]
  %tmp142 = load i16 addrspace(2)* @alpha_mask_SF_16 ; <i16> [#uses=1]
  %conv143 = sext i16 %tmp142 to i32              ; <i32> [#uses=1]
  %and144 = and i32 %conv141, %conv143            ; <i32> [#uses=1]
  %conv145 = trunc i32 %and144 to i16             ; <i16> [#uses=1]
  store i16 %conv145, i16* %uv_tmp_16
  %tmp146 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp147 = load i32* %SF0                        ; <i32> [#uses=1]
  %sub148 = sub i32 %tmp146, %tmp147              ; <i32> [#uses=1]
  store i32 %sub148, i32* %SF1
  %tmp149 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp150 = load i16* %uv_tmp_16                  ; <i16> [#uses=1]
  %conv151 = sext i16 %tmp150 to i32              ; <i32> [#uses=1]
  %mul152 = mul i32 %tmp149, %conv151             ; <i32> [#uses=1]
  store i32 %mul152, i32* %SF1
  %tmp153 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp154 = load i16 addrspace(2)* @rounding_SF_16 ; <i16> [#uses=1]
  %conv155 = sext i16 %tmp154 to i32              ; <i32> [#uses=1]
  %add156 = add nsw i32 %tmp153, %conv155         ; <i32> [#uses=1]
  store i32 %add156, i32* %SF1
  %tmp157 = load i32* %SF1                        ; <i32> [#uses=1]
  %shr158 = ashr i32 %tmp157, 5                   ; <i32> [#uses=1]
  store i32 %shr158, i32* %SF1
  %tmp159 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp160 = load i32* %SF0                        ; <i32> [#uses=1]
  %add161 = add nsw i32 %tmp159, %tmp160          ; <i32> [#uses=1]
  store i32 %add161, i32* %SF0
  %tmp163 = load i32* %SF0                        ; <i32> [#uses=1]
  %tmp164 = load i16* %u16                        ; <i16> [#uses=1]
  %conv165 = sext i16 %tmp164 to i32              ; <i32> [#uses=1]
  %mul166 = mul i32 %tmp163, %conv165             ; <i32> [#uses=1]
  store i32 %mul166, i32* %uvl
  %tmp167 = load i32* %uvl                        ; <i32> [#uses=1]
  %tmp168 = load i32 addrspace(2)* @uv_final_rounding_32 ; <i32> [#uses=1]
  %add169 = add nsw i32 %tmp167, %tmp168          ; <i32> [#uses=1]
  store i32 %add169, i32* %uvl
  %tmp170 = load i32* %uvl                        ; <i32> [#uses=1]
  %shr171 = ashr i32 %tmp170, 7                   ; <i32> [#uses=1]
  store i32 %shr171, i32* %uvl
  %tmp172 = load i32* %uvl                        ; <i32> [#uses=1]
  %conv173 = trunc i32 %tmp172 to i16             ; <i16> [#uses=1]
  %tmp174 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %call175 = call signext i16 @_Z3maxss(i16 signext %conv173, i16 signext %tmp174) ; <i16> [#uses=1]
  %tmp176 = load i16 addrspace(2)* @uv_max_val_16 ; <i16> [#uses=1]
  %call177 = call signext i16 @_Z3minss(i16 signext %call175, i16 signext %tmp176) ; <i16> [#uses=1]
  store i16 %call177, i16* %u16
  %tmp178 = load i16* %u16                        ; <i16> [#uses=1]
  %conv179 = sext i16 %tmp178 to i32              ; <i32> [#uses=1]
  %tmp180 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %conv181 = sext i16 %tmp180 to i32              ; <i32> [#uses=1]
  %sub182 = sub i32 %conv179, %conv181            ; <i32> [#uses=1]
  %conv183 = trunc i32 %sub182 to i16             ; <i16> [#uses=1]
  store i16 %conv183, i16* %u16
  %tmp184 = load i32* %SF0                        ; <i32> [#uses=1]
  %tmp185 = load i16* %v16                        ; <i16> [#uses=1]
  %conv186 = sext i16 %tmp185 to i32              ; <i32> [#uses=1]
  %mul187 = mul i32 %tmp184, %conv186             ; <i32> [#uses=1]
  store i32 %mul187, i32* %uvl
  %tmp188 = load i32* %uvl                        ; <i32> [#uses=1]
  %tmp189 = load i32 addrspace(2)* @uv_final_rounding_32 ; <i32> [#uses=1]
  %add190 = add nsw i32 %tmp188, %tmp189          ; <i32> [#uses=1]
  store i32 %add190, i32* %uvl
  %tmp191 = load i32* %uvl                        ; <i32> [#uses=1]
  %shr192 = ashr i32 %tmp191, 7                   ; <i32> [#uses=1]
  store i32 %shr192, i32* %uvl
  %tmp193 = load i32* %uvl                        ; <i32> [#uses=1]
  %conv194 = trunc i32 %tmp193 to i16             ; <i16> [#uses=1]
  %tmp195 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %call196 = call signext i16 @_Z3maxss(i16 signext %conv194, i16 signext %tmp195) ; <i16> [#uses=1]
  %tmp197 = load i16 addrspace(2)* @uv_max_val_16 ; <i16> [#uses=1]
  %call198 = call signext i16 @_Z3minss(i16 signext %call196, i16 signext %tmp197) ; <i16> [#uses=1]
  store i16 %call198, i16* %v16
  %tmp199 = load i16* %v16                        ; <i16> [#uses=1]
  %conv200 = sext i16 %tmp199 to i32              ; <i32> [#uses=1]
  %tmp201 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %conv202 = sext i16 %tmp201 to i32              ; <i32> [#uses=1]
  %sub203 = sub i32 %conv200, %conv202            ; <i32> [#uses=1]
  %conv204 = trunc i32 %sub203 to i16             ; <i16> [#uses=1]
  store i16 %conv204, i16* %v16
  %tmp205 = load i16* %u16                        ; <i16> [#uses=1]
  %conv206 = sext i16 %tmp205 to i32              ; <i32> [#uses=1]
  %arraydecay = getelementptr inbounds [2 x i32]* %uOut, i32 0, i32 0 ; <i32*> [#uses=1]
  %arrayidx207 = getelementptr inbounds i32* %arraydecay, i32 0 ; <i32*> [#uses=1]
  store i32 %conv206, i32* %arrayidx207
  %tmp208 = load i16* %v16                        ; <i16> [#uses=1]
  %conv209 = sext i16 %tmp208 to i32              ; <i32> [#uses=1]
  %arraydecay210 = getelementptr inbounds [2 x i32]* %vOut, i32 0, i32 0 ; <i32*> [#uses=1]
  %arrayidx211 = getelementptr inbounds i32* %arraydecay210, i32 0 ; <i32*> [#uses=1]
  store i32 %conv209, i32* %arrayidx211
  %tmp212 = load i32* %pixel_index                ; <i32> [#uses=1]
  %inc = add i32 %tmp212, 1                       ; <i32> [#uses=1]
  store i32 %inc, i32* %pixel_index
  %tmp213 = load i32* %pixel_index                ; <i32> [#uses=1]
  %tmp214 = load i16 addrspace(1)** %Uin.addr     ; <i16 addrspace(1)*> [#uses=1]
  %arrayidx215 = getelementptr inbounds i16 addrspace(1)* %tmp214, i32 %tmp213 ; <i16 addrspace(1)*> [#uses=1]
  %tmp216 = load i16 addrspace(1)* %arrayidx215   ; <i16> [#uses=1]
  %conv217 = sext i16 %tmp216 to i32              ; <i32> [#uses=1]
  %tmp218 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %conv219 = sext i16 %tmp218 to i32              ; <i32> [#uses=1]
  %add220 = add nsw i32 %conv217, %conv219        ; <i32> [#uses=1]
  %conv221 = trunc i32 %add220 to i16             ; <i16> [#uses=1]
  store i16 %conv221, i16* %u16
  %tmp222 = load i32* %pixel_index                ; <i32> [#uses=1]
  %tmp223 = load i16 addrspace(1)** %Vin.addr     ; <i16 addrspace(1)*> [#uses=1]
  %arrayidx224 = getelementptr inbounds i16 addrspace(1)* %tmp223, i32 %tmp222 ; <i16 addrspace(1)*> [#uses=1]
  %tmp225 = load i16 addrspace(1)* %arrayidx224   ; <i16> [#uses=1]
  %conv226 = sext i16 %tmp225 to i32              ; <i32> [#uses=1]
  %tmp227 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %conv228 = sext i16 %tmp227 to i32              ; <i32> [#uses=1]
  %add229 = add nsw i32 %conv226, %conv228        ; <i32> [#uses=1]
  %conv230 = trunc i32 %add229 to i16             ; <i16> [#uses=1]
  store i16 %conv230, i16* %v16
  %tmp231 = load i16* %u16                        ; <i16> [#uses=1]
  %conv232 = sext i16 %tmp231 to i32              ; <i32> [#uses=1]
  %shr233 = ashr i32 %conv232, 5                  ; <i32> [#uses=1]
  %conv234 = trunc i32 %shr233 to i16             ; <i16> [#uses=1]
  store i16 %conv234, i16* %u_key_16
  %tmp237 = load i16* %v16                        ; <i16> [#uses=1]
  %conv238 = sext i16 %tmp237 to i32              ; <i32> [#uses=1]
  %tmp239 = load i16 addrspace(2)* @hi_key_mask_16 ; <i16> [#uses=1]
  %conv240 = sext i16 %tmp239 to i32              ; <i32> [#uses=1]
  %and241 = and i32 %conv238, %conv240            ; <i32> [#uses=1]
  %conv242 = trunc i32 %and241 to i16             ; <i16> [#uses=1]
  store i16 %conv242, i16* %v_key_16236
  %tmp243 = load i16* %u_key_16                   ; <i16> [#uses=1]
  %conv244 = sext i16 %tmp243 to i32              ; <i32> [#uses=1]
  %tmp245 = load i16* %v_key_16236                ; <i16> [#uses=1]
  %conv246 = sext i16 %tmp245 to i32              ; <i32> [#uses=1]
  %add247 = add nsw i32 %conv244, %conv246        ; <i32> [#uses=1]
  %conv248 = trunc i32 %add247 to i16             ; <i16> [#uses=1]
  store i16 %conv248, i16* %u_key_16
  %tmp249 = load i16* %v16                        ; <i16> [#uses=1]
  %conv250 = sext i16 %tmp249 to i32              ; <i32> [#uses=1]
  %tmp251 = load i16 addrspace(2)* @alpha_mask_SF_16 ; <i16> [#uses=1]
  %conv252 = sext i16 %tmp251 to i32              ; <i32> [#uses=1]
  %and253 = and i32 %conv250, %conv252            ; <i32> [#uses=1]
  %conv254 = trunc i32 %and253 to i16             ; <i16> [#uses=1]
  store i16 %conv254, i16* %uv_tmp_16
  %tmp255 = load i16* %u_key_16                   ; <i16> [#uses=1]
  %conv256 = sext i16 %tmp255 to i32              ; <i32> [#uses=1]
  %add257 = add nsw i32 %conv256, 528             ; <i32> [#uses=1]
  %conv258 = trunc i32 %add257 to i16             ; <i16> [#uses=1]
  store i16 %conv258, i16* %index
  %tmp259 = load i16* %index                      ; <i16> [#uses=1]
  %tmp260 = load i8 addrspace(2)** %SatLUTEntry.addr ; <i8 addrspace(2)*> [#uses=1]
  %idxprom261 = sext i16 %tmp259 to i32           ; <i32> [#uses=1]
  %arrayidx262 = getelementptr inbounds i8 addrspace(2)* %tmp260, i32 %idxprom261 ; <i8 addrspace(2)*> [#uses=1]
  %tmp263 = load i8 addrspace(2)* %arrayidx262    ; <i8> [#uses=1]
  %tmp264 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp265 = insertelement <4 x i8> %tmp264, i8 %tmp263, i32 0 ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp265, <4 x i8>* %sat_data
  %tmp266 = load i16* %index                      ; <i16> [#uses=1]
  %conv267 = sext i16 %tmp266 to i32              ; <i32> [#uses=1]
  %add268 = add nsw i32 %conv267, 1               ; <i32> [#uses=1]
  %tmp269 = load i8 addrspace(2)** %SatLUTEntry.addr ; <i8 addrspace(2)*> [#uses=1]
  %arrayidx270 = getelementptr inbounds i8 addrspace(2)* %tmp269, i32 %add268 ; <i8 addrspace(2)*> [#uses=1]
  %tmp271 = load i8 addrspace(2)* %arrayidx270    ; <i8> [#uses=1]
  %tmp272 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp273 = insertelement <4 x i8> %tmp272, i8 %tmp271, i32 1 ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp273, <4 x i8>* %sat_data
  %tmp274 = load i16* %index                      ; <i16> [#uses=1]
  %conv275 = sext i16 %tmp274 to i32              ; <i32> [#uses=1]
  %add276 = add nsw i32 %conv275, 2               ; <i32> [#uses=1]
  %tmp277 = load i8 addrspace(2)** %SatLUTEntry.addr ; <i8 addrspace(2)*> [#uses=1]
  %arrayidx278 = getelementptr inbounds i8 addrspace(2)* %tmp277, i32 %add276 ; <i8 addrspace(2)*> [#uses=1]
  %tmp279 = load i8 addrspace(2)* %arrayidx278    ; <i8> [#uses=1]
  %tmp280 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp281 = insertelement <4 x i8> %tmp280, i8 %tmp279, i32 2 ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp281, <4 x i8>* %sat_data
  %tmp282 = load i16* %index                      ; <i16> [#uses=1]
  %conv283 = sext i16 %tmp282 to i32              ; <i32> [#uses=1]
  %add284 = add nsw i32 %conv283, 3               ; <i32> [#uses=1]
  %tmp285 = load i8 addrspace(2)** %SatLUTEntry.addr ; <i8 addrspace(2)*> [#uses=1]
  %arrayidx286 = getelementptr inbounds i8 addrspace(2)* %tmp285, i32 %add284 ; <i8 addrspace(2)*> [#uses=1]
  %tmp287 = load i8 addrspace(2)* %arrayidx286    ; <i8> [#uses=1]
  %tmp288 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp289 = insertelement <4 x i8> %tmp288, i8 %tmp287, i32 3 ; <<4 x i8>> [#uses=1]
  store <4 x i8> %tmp289, <4 x i8>* %sat_data
  %tmp290 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp291 = extractelement <4 x i8> %tmp290, i32 0 ; <i8> [#uses=1]
  %conv292 = zext i8 %tmp291 to i32               ; <i32> [#uses=1]
  %tmp293 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp294 = extractelement <4 x i8> %tmp293, i32 1 ; <i8> [#uses=1]
  %conv295 = zext i8 %tmp294 to i32               ; <i32> [#uses=1]
  %sub296 = sub i32 %conv292, %conv295            ; <i32> [#uses=1]
  store i32 %sub296, i32* %SF0
  %tmp297 = load i32* %SF0                        ; <i32> [#uses=1]
  %tmp298 = load i16* %uv_tmp_16                  ; <i16> [#uses=1]
  %conv299 = sext i16 %tmp298 to i32              ; <i32> [#uses=1]
  %mul300 = mul i32 %tmp297, %conv299             ; <i32> [#uses=1]
  store i32 %mul300, i32* %SF0
  %tmp301 = load i32* %SF0                        ; <i32> [#uses=1]
  %tmp302 = load i16 addrspace(2)* @rounding_SF_16 ; <i16> [#uses=1]
  %conv303 = sext i16 %tmp302 to i32              ; <i32> [#uses=1]
  %add304 = add nsw i32 %tmp301, %conv303         ; <i32> [#uses=1]
  store i32 %add304, i32* %SF0
  %tmp305 = load i32* %SF0                        ; <i32> [#uses=1]
  %shr306 = ashr i32 %tmp305, 5                   ; <i32> [#uses=1]
  store i32 %shr306, i32* %SF0
  %tmp307 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp308 = extractelement <4 x i8> %tmp307, i32 0 ; <i8> [#uses=1]
  %conv309 = zext i8 %tmp308 to i32               ; <i32> [#uses=1]
  %tmp310 = load i32* %SF0                        ; <i32> [#uses=1]
  %add311 = add nsw i32 %conv309, %tmp310         ; <i32> [#uses=1]
  store i32 %add311, i32* %SF0
  %tmp312 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp313 = extractelement <4 x i8> %tmp312, i32 2 ; <i8> [#uses=1]
  %conv314 = zext i8 %tmp313 to i32               ; <i32> [#uses=1]
  %tmp315 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp316 = extractelement <4 x i8> %tmp315, i32 3 ; <i8> [#uses=1]
  %conv317 = zext i8 %tmp316 to i32               ; <i32> [#uses=1]
  %sub318 = sub i32 %conv314, %conv317            ; <i32> [#uses=1]
  store i32 %sub318, i32* %SF1
  %tmp319 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp320 = load i16* %uv_tmp_16                  ; <i16> [#uses=1]
  %conv321 = sext i16 %tmp320 to i32              ; <i32> [#uses=1]
  %mul322 = mul i32 %tmp319, %conv321             ; <i32> [#uses=1]
  store i32 %mul322, i32* %SF1
  %tmp323 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp324 = load i16 addrspace(2)* @rounding_SF_16 ; <i16> [#uses=1]
  %conv325 = sext i16 %tmp324 to i32              ; <i32> [#uses=1]
  %add326 = add nsw i32 %tmp323, %conv325         ; <i32> [#uses=1]
  store i32 %add326, i32* %SF1
  %tmp327 = load i32* %SF1                        ; <i32> [#uses=1]
  %shr328 = ashr i32 %tmp327, 5                   ; <i32> [#uses=1]
  store i32 %shr328, i32* %SF1
  %tmp329 = load <4 x i8>* %sat_data              ; <<4 x i8>> [#uses=1]
  %tmp330 = extractelement <4 x i8> %tmp329, i32 2 ; <i8> [#uses=1]
  %conv331 = zext i8 %tmp330 to i32               ; <i32> [#uses=1]
  %tmp332 = load i32* %SF1                        ; <i32> [#uses=1]
  %add333 = add nsw i32 %conv331, %tmp332         ; <i32> [#uses=1]
  store i32 %add333, i32* %SF1
  %tmp334 = load i16* %u16                        ; <i16> [#uses=1]
  %conv335 = sext i16 %tmp334 to i32              ; <i32> [#uses=1]
  %tmp336 = load i16 addrspace(2)* @alpha_mask_SF_16 ; <i16> [#uses=1]
  %conv337 = sext i16 %tmp336 to i32              ; <i32> [#uses=1]
  %and338 = and i32 %conv335, %conv337            ; <i32> [#uses=1]
  %conv339 = trunc i32 %and338 to i16             ; <i16> [#uses=1]
  store i16 %conv339, i16* %uv_tmp_16
  %tmp340 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp341 = load i32* %SF0                        ; <i32> [#uses=1]
  %sub342 = sub i32 %tmp340, %tmp341              ; <i32> [#uses=1]
  store i32 %sub342, i32* %SF1
  %tmp343 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp344 = load i16* %uv_tmp_16                  ; <i16> [#uses=1]
  %conv345 = sext i16 %tmp344 to i32              ; <i32> [#uses=1]
  %mul346 = mul i32 %tmp343, %conv345             ; <i32> [#uses=1]
  store i32 %mul346, i32* %SF1
  %tmp347 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp348 = load i16 addrspace(2)* @rounding_SF_16 ; <i16> [#uses=1]
  %conv349 = sext i16 %tmp348 to i32              ; <i32> [#uses=1]
  %add350 = add nsw i32 %tmp347, %conv349         ; <i32> [#uses=1]
  store i32 %add350, i32* %SF1
  %tmp351 = load i32* %SF1                        ; <i32> [#uses=1]
  %shr352 = ashr i32 %tmp351, 5                   ; <i32> [#uses=1]
  store i32 %shr352, i32* %SF1
  %tmp353 = load i32* %SF1                        ; <i32> [#uses=1]
  %tmp354 = load i32* %SF0                        ; <i32> [#uses=1]
  %add355 = add nsw i32 %tmp353, %tmp354          ; <i32> [#uses=1]
  store i32 %add355, i32* %SF0
  %tmp356 = load i32* %SF0                        ; <i32> [#uses=1]
  %tmp357 = load i16* %u16                        ; <i16> [#uses=1]
  %conv358 = sext i16 %tmp357 to i32              ; <i32> [#uses=1]
  %mul359 = mul i32 %tmp356, %conv358             ; <i32> [#uses=1]
  store i32 %mul359, i32* %uvl
  %tmp360 = load i32* %uvl                        ; <i32> [#uses=1]
  %tmp361 = load i32 addrspace(2)* @uv_final_rounding_32 ; <i32> [#uses=1]
  %add362 = add nsw i32 %tmp360, %tmp361          ; <i32> [#uses=1]
  store i32 %add362, i32* %uvl
  %tmp363 = load i32* %uvl                        ; <i32> [#uses=1]
  %shr364 = ashr i32 %tmp363, 7                   ; <i32> [#uses=1]
  store i32 %shr364, i32* %uvl
  %tmp365 = load i32* %uvl                        ; <i32> [#uses=1]
  %conv366 = trunc i32 %tmp365 to i16             ; <i16> [#uses=1]
  %tmp367 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %call368 = call signext i16 @_Z3maxss(i16 signext %conv366, i16 signext %tmp367) ; <i16> [#uses=1]
  %tmp369 = load i16 addrspace(2)* @uv_max_val_16 ; <i16> [#uses=1]
  %call370 = call signext i16 @_Z3minss(i16 signext %call368, i16 signext %tmp369) ; <i16> [#uses=1]
  store i16 %call370, i16* %u16
  %tmp371 = load i16* %u16                        ; <i16> [#uses=1]
  %conv372 = sext i16 %tmp371 to i32              ; <i32> [#uses=1]
  %tmp373 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %conv374 = sext i16 %tmp373 to i32              ; <i32> [#uses=1]
  %sub375 = sub i32 %conv372, %conv374            ; <i32> [#uses=1]
  %conv376 = trunc i32 %sub375 to i16             ; <i16> [#uses=1]
  store i16 %conv376, i16* %u16
  %tmp377 = load i32* %SF0                        ; <i32> [#uses=1]
  %tmp378 = load i16* %v16                        ; <i16> [#uses=1]
  %conv379 = sext i16 %tmp378 to i32              ; <i32> [#uses=1]
  %mul380 = mul i32 %tmp377, %conv379             ; <i32> [#uses=1]
  store i32 %mul380, i32* %uvl
  %tmp381 = load i32* %uvl                        ; <i32> [#uses=1]
  %tmp382 = load i32 addrspace(2)* @uv_final_rounding_32 ; <i32> [#uses=1]
  %add383 = add nsw i32 %tmp381, %tmp382          ; <i32> [#uses=1]
  store i32 %add383, i32* %uvl
  %tmp384 = load i32* %uvl                        ; <i32> [#uses=1]
  %shr385 = ashr i32 %tmp384, 7                   ; <i32> [#uses=1]
  store i32 %shr385, i32* %uvl
  %tmp386 = load i32* %uvl                        ; <i32> [#uses=1]
  %conv387 = trunc i32 %tmp386 to i16             ; <i16> [#uses=1]
  %tmp388 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %call389 = call signext i16 @_Z3maxss(i16 signext %conv387, i16 signext %tmp388) ; <i16> [#uses=1]
  %tmp390 = load i16 addrspace(2)* @uv_max_val_16 ; <i16> [#uses=1]
  %call391 = call signext i16 @_Z3minss(i16 signext %call389, i16 signext %tmp390) ; <i16> [#uses=1]
  store i16 %call391, i16* %v16
  %tmp392 = load i16* %v16                        ; <i16> [#uses=1]
  %conv393 = sext i16 %tmp392 to i32              ; <i32> [#uses=1]
  %tmp394 = load i16 addrspace(2)* @uv_min_val_16 ; <i16> [#uses=1]
  %conv395 = sext i16 %tmp394 to i32              ; <i32> [#uses=1]
  %sub396 = sub i32 %conv393, %conv395            ; <i32> [#uses=1]
  %conv397 = trunc i32 %sub396 to i16             ; <i16> [#uses=1]
  store i16 %conv397, i16* %v16
  %tmp398 = load i16* %u16                        ; <i16> [#uses=1]
  %conv399 = sext i16 %tmp398 to i32              ; <i32> [#uses=1]
  %arraydecay400 = getelementptr inbounds [2 x i32]* %uOut, i32 0, i32 0 ; <i32*> [#uses=1]
  %arrayidx401 = getelementptr inbounds i32* %arraydecay400, i32 1 ; <i32*> [#uses=1]
  store i32 %conv399, i32* %arrayidx401
  %tmp402 = load i16* %v16                        ; <i16> [#uses=1]
  %conv403 = sext i16 %tmp402 to i32              ; <i32> [#uses=1]
  %arraydecay404 = getelementptr inbounds [2 x i32]* %vOut, i32 0, i32 0 ; <i32*> [#uses=1]
  %arrayidx405 = getelementptr inbounds i32* %arraydecay404, i32 1 ; <i32*> [#uses=1]
  store i32 %conv403, i32* %arrayidx405
  %arraydecay406 = getelementptr inbounds [2 x i32]* %uOut, i32 0, i32 0 ; <i32*> [#uses=1]
  %arrayidx407 = getelementptr inbounds i32* %arraydecay406, i32 0 ; <i32*> [#uses=1]
  %tmp408 = load i32* %arrayidx407                ; <i32> [#uses=1]
  %and409 = and i32 %tmp408, 65535                ; <i32> [#uses=1]
  %shl = shl i32 %and409, 16                      ; <i32> [#uses=1]
  %arraydecay410 = getelementptr inbounds [2 x i32]* %uOut, i32 0, i32 0 ; <i32*> [#uses=1]
  %arrayidx411 = getelementptr inbounds i32* %arraydecay410, i32 1 ; <i32*> [#uses=1]
  %tmp412 = load i32* %arrayidx411                ; <i32> [#uses=1]
  %and413 = and i32 %tmp412, 65535                ; <i32> [#uses=1]
  %or = or i32 %shl, %and413                      ; <i32> [#uses=1]
  %tmp414 = load i32 addrspace(1)** %UoutPtr      ; <i32 addrspace(1)*> [#uses=1]
  store i32 %or, i32 addrspace(1)* %tmp414
  %arraydecay415 = getelementptr inbounds [2 x i32]* %vOut, i32 0, i32 0 ; <i32*> [#uses=1]
  %arrayidx416 = getelementptr inbounds i32* %arraydecay415, i32 0 ; <i32*> [#uses=1]
  %tmp417 = load i32* %arrayidx416                ; <i32> [#uses=1]
  %and418 = and i32 %tmp417, 65535                ; <i32> [#uses=1]
  %shl419 = shl i32 %and418, 16                   ; <i32> [#uses=1]
  %arraydecay420 = getelementptr inbounds [2 x i32]* %vOut, i32 0, i32 0 ; <i32*> [#uses=1]
  %arrayidx421 = getelementptr inbounds i32* %arraydecay420, i32 1 ; <i32*> [#uses=1]
  %tmp422 = load i32* %arrayidx421                ; <i32> [#uses=1]
  %and423 = and i32 %tmp422, 65535                ; <i32> [#uses=1]
  %or424 = or i32 %shl419, %and423                ; <i32> [#uses=1]
  %tmp425 = load i32 addrspace(1)** %VoutPtr      ; <i32 addrspace(1)*> [#uses=1]
  store i32 %or424, i32 addrspace(1)* %tmp425
  %tmp426 = load i32* %pixel_index                ; <i32> [#uses=1]
  %inc427 = add i32 %tmp426, 1                    ; <i32> [#uses=1]
  store i32 %inc427, i32* %pixel_index
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %tmp428 = load i32* %iter                       ; <i32> [#uses=1]
  %inc429 = add nsw i32 %tmp428, 1                ; <i32> [#uses=1]
  store i32 %inc429, i32* %iter
  br label %for.cond

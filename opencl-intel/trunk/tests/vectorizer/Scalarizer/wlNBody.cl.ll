...
for.body347:                                      ; preds = %for.cond342
  ...
  %call393 = call <4 x float> @_Z5rsqrtDv4_f(<4 x float> %tmp392) ; <<4 x float>> [#uses=1]

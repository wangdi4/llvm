...
entry:
  ...
  %call7 = call float @_Z6lengthDv2_f(<2 x float> %mul) ; <float> [#uses=1]
  ...
  %call13 = call float @_Z6lengthDv2_f(<2 x float> %tmp12) ; <float> [#uses=1]
  ...
  %call80 = call <4 x float> @_Z11read_imagefP10_image2d_tjDv2_f(%struct._image2d_t* %tmp76, i32 17, <2 x float> %add79) ; <<4 x float>> [#uses=1]
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %call26 = call <2 x float> @_Z14convert_float2Dv2_i(<2 x i32> %sub25) ; <<2 x float>> [#uses=1]

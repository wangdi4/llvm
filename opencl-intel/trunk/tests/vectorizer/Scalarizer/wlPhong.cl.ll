...
for.body:                                         ; preds = %for.cond
  ...
  %call142 = call float @_Z3dotDv4_fS_(<4 x float> %tmp140, <4 x float> %tmp141) ; <float> [#uses=1]
  ...
  %call155 = call <4 x float> @_Z4fabsDv4_f(<4 x float> %tmp154) ; <<4 x float>> [#uses=1]
  ...
  %call164 = call float @_Z3dotDv4_fS_(<4 x float> %tmp162, <4 x float> %tmp163) ; <float> [#uses=1]
...
if.end197:                                        ; preds = %if.end189, %for.body
  ...
  %call221 = call <4 x float> @_Z3minDv4_fS_(<4 x float> %tmp216, <4 x float> %add220) ; <<4 x float>> [#uses=1]

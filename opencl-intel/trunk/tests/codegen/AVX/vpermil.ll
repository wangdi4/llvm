...
; CHECK: vpermilpd
define <4 x double> @funcB(<4 x double> %a) nounwind  readnone {
entry:
...
; CHECK: vpermilps
define <8 x i32> @funcC(<8 x i32> %a) nounwind  readnone {
entry:
...
; CHECK: vpermilpd
define <4 x i64> @funcD(<4 x i64> %a) nounwind  readnone {
entry:
...
; CHECK: vpermilps $-100
define <8 x float> @funcE(<8 x float> %a) nounwind  readnone {
entry:
...
; CHECK-NOT: vpermilps
; CHECK: ret
define <8 x float> @funcF(<8 x float> %a) nounwind  readnone {
entry:

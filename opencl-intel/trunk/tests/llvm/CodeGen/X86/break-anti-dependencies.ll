; CSSD100006341 
; RUN: llc < %s -march=x86-64 -post-RA-scheduler -break-anti-dependencies=none -mcpu=corei7 > %t
; RUN:   grep {%xmm0} %t | count 14
; RUN:   not grep {%xmm1} %t
; RUN: llc < %s -march=x86-64 -post-RA-scheduler -break-anti-dependencies=critical -mcpu=corei7 > %t

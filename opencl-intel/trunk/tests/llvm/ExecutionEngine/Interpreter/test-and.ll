...
define i32 @and_2()
{
       ...
       %res_i8 = and <2 x i8> < i8 5, i8 2>, < i8 1, i8 3>
...
; CHECK: 1 2
       %res_i16 = and <2 x i16> < i16 105, i16 207>, < i16 12, i16 39>
...
; CHECK: 8 7
       ...
       %res_i32 = and <2 x i32> < i32 589, i32 2999>, < i32 781, i32 333>
...
; CHECK: 525 261
       ...
       %res_i64 = and <2 x i64> < i64 145675, i64 4562>, < i64 109999, i64 45603>
...
define i32 @and_8_i8()
{
       ...
       %res_i8 = and <8 x i8> < i8 15, i8 12, i8 25, i8 22, i8 35, i8 32, i8 45, i8 42>, < i8 1, i8 3, i8 11, i8 13, i8 21, i8 23, i8 31, i8 33>
...
; CHECK: 1 0 9 4 1 0 13 32

       ret i32 0
}

define i32 @and_8_i16()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

       %res_i16 = and <8 x i16> < i16 15, i16 12, i16 25, i16 22, i16 35, i16 32, i16 45, i16 42>, < i16 1, i16 3, i16 11, i16 13, i16 21, i16 23, i16 31, i16 33>
...
define i32 @and_8_i32()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

       %res_i32 = and <8 x i32> < i32 215, i32 212, i32 325, i32 422, i32 535, i32 632, i32 645, i32 742>, < i32 451, i32 33, i32 611, i32 513, i32 221, i32 8823, i32 631, i32 9933>
...
; CHECK: 195 0 65 0 21 624 517 708

       ret i32 0
}

define i32 @and_8_i64()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

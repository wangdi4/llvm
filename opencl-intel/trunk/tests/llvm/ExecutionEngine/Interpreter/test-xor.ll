...
define i32 @xor_2()
{
       ...
       %res_i8 = xor <2 x i8> < i8 5, i8 2>, < i8 1, i8 3>
...
; CHECK: 4 1
       ...
       %res_i16 = xor <2 x i16> < i16 105, i16 207>, < i16 12, i16 39>
...
; CHECK: 101 232
       ...
       %res_i32 = xor <2 x i32> < i32 589, i32 2999>, < i32 781, i32 333>
...
; CHECK: 320 2810
       ...
       %res_i64 = xor <2 x i64> < i64 145675, i64 4562>, < i64 109999, i64 45603>
...
define i32 @xor_8_i8()
{
       ...
       %res_i8 = xor <8 x i8> < i8 15, i8 12, i8 25, i8 22, i8 35, i8 32, i8 45, i8 42>, < i8 1, i8 3, i8 11, i8 13, i8 21, i8 23, i8 31, i8 33>
...
; CHECK: 14 15 18 27 54 55 50 11

       ret i32 0
}

define i32 @xor_8_i16()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

       %res_i16 = xor <8 x i16> < i16 15, i16 12, i16 25, i16 22, i16 35, i16 32, i16 45, i16 42>, < i16 1, i16 3, i16 11, i16 13, i16 21, i16 23, i16 31, i16 33>
...
define i32 @xor_8_i32()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

       %res_i32 = xor <8 x i32> < i32 215, i32 212, i32 325, i32 422, i32 535, i32 632, i32 645, i32 742>, < i32 451, i32 33, i32 611, i32 513, i32 221, i32 8823, i32 631, i32 9933>
...
; CHECK: 276 245 806 935 714 8207 242 9259

       ret i32 0
}

define i32 @xor_8_i64()
{
       %ptr = getelementptr [26 x i8]* @r_int_8, i32 0, i32 0 ; to printf

       %res_i64 = xor <8 x i64> < i64 45615, i64 4612, i64 78925, i64 34522, i64 6735, i64 95632, i64 85645, i64 1342>, < i64 2341, i64 23, i64 311, i64 22213, i64 784621, i64 6723, i64 731, i64 99933>
...
; CHECK: 47882 4627 79226 53279 778914 94163 85078 99171

...
#define islessgreater(X,Y)      __CLFN_F2_D(X,Y,islessgreater)

#define isfinite(X)     __CLFN_F1_D(X,isfinite)
#define isinf(X)        __CLFN_F1_D(X,isinf)
#define isnan(X)        __CLFN_F1_D(X,isnan)
#define isnormal(X)     __CLFN_F1_D(X,isnormal)
#define isordered(X,Y)     __CLFN_F2_D(X,Y,isordered)
#define isunordered(X,Y)     __CLFN_F2_D(X,Y,isunordered)
#define signbit(X)     __CLFN_F1_D(X,signbit)

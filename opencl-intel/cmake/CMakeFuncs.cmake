...
#
# Adds the given path to the PATH environment
# Usage: add_path( PATH )
#
...
function (add_ocl_unittest test_name)
  ...
  if (WIN32)
    ...
    set_target_properties(${test_name} PROPERTIES
      RUNTIME_OUTPUT_DIRECTORY_DEBUG ${OCL_BINARY_DIR}/tests/${FNAME}
      LIBRARY_OUTPUT_DIRECTORY_DEBUG ${OCL_BINARY_DIR}/tests/${FNAME}
      ARCHIVE_OUTPUT_DIRECTORY_DEBUG ${OCL_BINARY_DIR}/tests/${FNAME}
      RUNTIME_OUTPUT_DIRECTORY_RELEASE ${OCL_BINARY_DIR}/tests/${FNAME}
      LIBRARY_OUTPUT_DIRECTORY_RELEASE ${OCL_BINARY_DIR}/tests/${FNAME}
      ARCHIVE_OUTPUT_DIRECTORY_RELEASE ${OCL_BINARY_DIR}/tests/${FNAME})
  else (WIN32)
    set_target_properties(${test_name} PROPERTIES

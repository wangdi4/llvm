...
if(BUILD_X64)
  set(INIT_LINKER_FLAGS
      "/MACHINE:X64 /OPT:REF /INCREMENTAL:NO /DYNAMICBASE /NXCOMPAT")
else(BUILD_X64)
  set(INIT_LINKER_FLAGS
      "/MACHINE:X86 /OPT:REF /INCREMENTAL:NO /DYNAMICBASE /NXCOMPAT /SAFESEH")
endif(BUILD_X64)

set(ADD_LINKER_FLAGS_DEBUG "/DEBUG /NODEFAULTLIB:LIBCMT /NODEFAULTLIB:LIBCPMT")
set(ADD_LINKER_FLAGS_RELEASE
    "/OPT:REF /OPT:ICF /NODEFAULTLIB:LIBCMTD /NODEFAULTLIB:LIBCPMTD")

...
set( ANDROID_NDK_TOOLCHAIN_ROOT $ENV{ANDROID_STANDALONE_TOOLCHAIN32} )
...
set( CMAKE_ASM_COMPILER "${ANDROID_NDK_TOOLCHAIN_ROOT}/bin/i686-linux-android-gcc${TOOL_OS_SUFFIX}"  CACHE PATH "gcc" FORCE )
...
set( CMAKE_CXX_FLAGS "-m32 -fPIC -DANDROID -Wno-psabi -fsigned-char -Wformat -Wformat-security ${FSTACK_PROTECTOR_C_FLAGS}" )
set( CMAKE_C_FLAGS "-m32 -fPIC -DANDROID -Wno-psabi -fsigned-char -Wformat -Wformat-security ${FSTACK_PROTECTOR_C_FLAGS}" )
...
if( INCLUDE_ATOM )
 ...
 set ( CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -Xassembler --32" )
else( INCLUDE_ATOM )
 set ( CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -Wa,--32,-march=core2" )
endif( INCLUDE_ATOM )

...
// License.
//
//===--- abi-omp.cpp - Device code generated by OpenMP compiler -----------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains device RTL code generated by OpenMP compiler.
//
//===----------------------------------------------------------------------===//
...
///
/// Support for kernel SLM pointer interface
///
static void *__omp_spirv_kernel_slm_ptr;
#pragma omp groupprivate(__omp_spirv_kernel_slm_ptr)

EXTERN void *ompx_get_dyn_cgroup_mem(void) {
  return __omp_spirv_kernel_slm_ptr;
}

EXTERN void __kmpc_set_kernel_dyn_cgroup_mem(void *ptr) {
  __omp_spirv_kernel_slm_ptr = ptr;
}

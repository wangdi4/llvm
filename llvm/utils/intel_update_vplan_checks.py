...
def main():
  ...
  for test in args.tests:
    ...
    # insert autogenerated_note as the first line unless the first line is
    # SW_ADVANCED, in which case insert autogenerated_note after this line.
    if (input_lines[0].startswith(SW_ADVANCED)):
    ...
    for count, input_line in enumerate(input_lines):
      ...
      if count == 0 and input_line.startswith(SW_ADVANCED):
        continue

...
// CHECK: vcvtdq2pd ymm2, xmm3
// CHECK: encoding: [0xc5,0xfe,0xe6,0xd3]
          vcvtdq2pd ymm2, xmm3

// CHECK: vcvtdq2pd ymm2 {k7}, xmm3
// CHECK: encoding: [0x62,0xf1,0x7e,0x2f,0xe6,0xd3]
          vcvtdq2pd ymm2 {k7}, xmm3

// CHECK: vcvtdq2pd ymm2 {k7} {z}, xmm3
// CHECK: encoding: [0x62,0xf1,0x7e,0xaf,0xe6,0xd3]
          vcvtdq2pd ymm2 {k7} {z}, xmm3
...
// CHECK: vcvtne2ps2ph ymm2, ymm3, ymm4, {rn-sae}
// CHECK: encoding: [0x62,0xf2,0x61,0x18,0x67,0xd4]
          vcvtne2ps2ph ymm2, ymm3, ymm4, {rn-sae}

// CHECK: vcvtne2ps2ph ymm2, ymm3, ymm4, {rd-sae}
// CHECK: encoding: [0x62,0xf2,0x61,0x38,0x67,0xd4]
          vcvtne2ps2ph ymm2, ymm3, ymm4, {rd-sae}

// CHECK: vcvtne2ps2ph ymm2, ymm3, ymm4, {rz-sae}
// CHECK: encoding: [0x62,0xf2,0x61,0x78,0x67,0xd4]
          vcvtne2ps2ph ymm2, ymm3, ymm4, {rz-sae}
...
// CHECK: vcvtudq2pd ymm2, xmm3
// CHECK: encoding: [0x62,0xf1,0x7e,0x28,0x7a,0xd3]
          vcvtudq2pd ymm2, xmm3

// CHECK: vcvtudq2pd ymm2 {k7}, xmm3
// CHECK: encoding: [0x62,0xf1,0x7e,0x2f,0x7a,0xd3]
          vcvtudq2pd ymm2 {k7}, xmm3

// CHECK: vcvtudq2pd ymm2 {k7} {z}, xmm3
// CHECK: encoding: [0x62,0xf1,0x7e,0xaf,0x7a,0xd3]
          vcvtudq2pd ymm2 {k7} {z}, xmm3

...
// CHECK: vcvtdq2pd %xmm23, %ymm22
// CHECK: encoding: [0x62,0xa1,0x7e,0x28,0xe6,0xf7]
          vcvtdq2pd %xmm23, %ymm22

// CHECK: vcvtdq2pd %xmm23, %ymm22 {%k7}
// CHECK: encoding: [0x62,0xa1,0x7e,0x2f,0xe6,0xf7]
          vcvtdq2pd %xmm23, %ymm22 {%k7}

// CHECK: vcvtdq2pd %xmm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa1,0x7e,0xaf,0xe6,0xf7]
          vcvtdq2pd %xmm23, %ymm22 {%k7} {z}
...
// CHECK: vcvtne2ps2ph {rn-sae}, %ymm24, %ymm23, %ymm22
// CHECK: encoding: [0x62,0x82,0x41,0x10,0x67,0xf0]
          vcvtne2ps2ph {rn-sae}, %ymm24, %ymm23, %ymm22

// CHECK: vcvtne2ps2ph {rd-sae}, %ymm24, %ymm23, %ymm22
// CHECK: encoding: [0x62,0x82,0x41,0x30,0x67,0xf0]
          vcvtne2ps2ph {rd-sae}, %ymm24, %ymm23, %ymm22

// CHECK: vcvtne2ps2ph {rz-sae}, %ymm24, %ymm23, %ymm22
// CHECK: encoding: [0x62,0x82,0x41,0x70,0x67,0xf0]
          vcvtne2ps2ph {rz-sae}, %ymm24, %ymm23, %ymm22
...
// CHECK: vcvtudq2pd %xmm23, %ymm22
// CHECK: encoding: [0x62,0xa1,0x7e,0x28,0x7a,0xf7]
          vcvtudq2pd %xmm23, %ymm22

// CHECK: vcvtudq2pd %xmm23, %ymm22 {%k7}
// CHECK: encoding: [0x62,0xa1,0x7e,0x2f,0x7a,0xf7]
          vcvtudq2pd %xmm23, %ymm22 {%k7}

// CHECK: vcvtudq2pd %xmm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa1,0x7e,0xaf,0x7a,0xf7]
          vcvtudq2pd %xmm23, %ymm22 {%k7} {z}

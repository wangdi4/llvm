...
// CHECK:      t2rpntlvwz0advise $123, 268435456(%rbp,%r14,8), %tmm6
// CHECK: encoding: [0xc4,0xa3,0x78,0x76,0xb4,0xf5,0x00,0x00,0x00,0x10,0x7b]
               t2rpntlvwz0advise $123, 268435456(%rbp,%r14,8), %tmm6

// CHECK:      t2rpntlvwz0advise $123, 291(%r8,%rax,4), %tmm2
// CHECK: encoding: [0xc4,0xc3,0x78,0x76,0x94,0x80,0x23,0x01,0x00,0x00,0x7b]
               t2rpntlvwz0advise $123, 291(%r8,%rax,4), %tmm2

// CHECK:      t2rpntlvwz0advise $123, -32(,%rbp,2), %tmm2
// CHECK: encoding: [0xc4,0xe3,0x78,0x76,0x14,0x6d,0xe0,0xff,0xff,0xff,0x7b]
               t2rpntlvwz0advise $123, -32(,%rbp,2), %tmm2

// CHECK:      t2rpntlvwz1advise $123, 268435456(%rbp,%r14,8), %tmm6
// CHECK: encoding: [0xc4,0xa3,0x79,0x76,0xb4,0xf5,0x00,0x00,0x00,0x10,0x7b]
               t2rpntlvwz1advise $123, 268435456(%rbp,%r14,8), %tmm6

// CHECK:      t2rpntlvwz1advise $123, 291(%r8,%rax,4), %tmm2
// CHECK: encoding: [0xc4,0xc3,0x79,0x76,0x94,0x80,0x23,0x01,0x00,0x00,0x7b]
               t2rpntlvwz1advise $123, 291(%r8,%rax,4), %tmm2

// CHECK:      t2rpntlvwz1advise $123, -32(,%rbp,2), %tmm2
// CHECK: encoding: [0xc4,0xe3,0x79,0x76,0x14,0x6d,0xe0,0xff,0xff,0xff,0x7b]
               t2rpntlvwz1advise $123, -32(,%rbp,2), %tmm2
...
// CHECK: tileloaddrs 64(%rbx), %tmm6
// CHECK: encoding: [0xc4,0xe2,0x7b,0x4a,0x74,0x23,0x40]
          tileloaddrs 64(%rbx), %tmm6
...
// CHECK: tileloaddrst1 64(%rbx), %tmm6
// CHECK: encoding: [0xc4,0xe2,0x79,0x4a,0x74,0x23,0x40]
          tileloaddrst1 64(%rbx), %tmm6

...
// CHECK:      {evex} vcvtne2ps2ph zmm22 {k7}, zmm23, zmm24
// CHECK: encoding: [0x62,0x82,0x45,0x47,0x67,0xf0]
               {evex} vcvtne2ps2ph zmm22 {k7}, zmm23, zmm24

// CHECK:      {evex} vcvtne2ps2ph zmm22 {k7} {z}, zmm23, zmm24
// CHECK: encoding: [0x62,0x82,0x45,0xc7,0x67,0xf0]
               {evex} vcvtne2ps2ph zmm22 {k7} {z}, zmm23, zmm24
...
// CHECK:      {evex} vcvtne2ps2ph zmm22 {k7}, zmm23, zmmword ptr [r8 + 4*rax + 291]
// CHECK: encoding: [0x62,0xc2,0x45,0x47,0x67,0xb4,0x80,0x23,0x01,0x00,0x00]
               {evex} vcvtne2ps2ph zmm22 {k7}, zmm23, zmmword ptr [r8 + 4*rax + 291]
...
// CHECK:      {evex} vcvtne2ps2ph zmm22 {k7} {z}, zmm23, zmmword ptr [rcx + 8128]
// CHECK: encoding: [0x62,0xe2,0x45,0xc7,0x67,0x71,0x7f]
               {evex} vcvtne2ps2ph zmm22 {k7} {z}, zmm23, zmmword ptr [rcx + 8128]

// CHECK:      {evex} vcvtne2ps2ph zmm22 {k7} {z}, zmm23, dword ptr [rdx - 512]{1to16}
// CHECK: encoding: [0x62,0xe2,0x45,0xd7,0x67,0x72,0x80]
               {evex} vcvtne2ps2ph zmm22 {k7} {z}, zmm23, dword ptr [rdx - 512]{1to16}

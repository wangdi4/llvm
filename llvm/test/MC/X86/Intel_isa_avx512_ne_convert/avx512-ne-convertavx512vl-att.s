...
// CHECK:      {evex} vcvtne2ps2ph %ymm4, %ymm3, %ymm2 {%k7}
// CHECK: encoding: [0x62,0xf2,0x65,0x2f,0x67,0xd4]
               {evex} vcvtne2ps2ph %ymm4, %ymm3, %ymm2 {%k7}

// CHECK:      {evex} vcvtne2ps2ph %ymm4, %ymm3, %ymm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf2,0x65,0xaf,0x67,0xd4]
               {evex} vcvtne2ps2ph %ymm4, %ymm3, %ymm2 {%k7} {z}

// CHECK:      {evex} vcvtne2ps2ph %xmm4, %xmm3, %xmm2
// CHECK: encoding: [0x62,0xf2,0x65,0x08,0x67,0xd4]
               {evex} vcvtne2ps2ph %xmm4, %xmm3, %xmm2

// CHECK:      {evex} vcvtne2ps2ph %xmm4, %xmm3, %xmm2 {%k7}
// CHECK: encoding: [0x62,0xf2,0x65,0x0f,0x67,0xd4]
               {evex} vcvtne2ps2ph %xmm4, %xmm3, %xmm2 {%k7}

// CHECK:      {evex} vcvtne2ps2ph %xmm4, %xmm3, %xmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf2,0x65,0x8f,0x67,0xd4]
               {evex} vcvtne2ps2ph %xmm4, %xmm3, %xmm2 {%k7} {z}
...
// CHECK:      {evex} vcvtne2ps2ph  291(%edi,%eax,4), %ymm3, %ymm2 {%k7}
// CHECK: encoding: [0x62,0xf2,0x65,0x2f,0x67,0x94,0x87,0x23,0x01,0x00,0x00]
               {evex} vcvtne2ps2ph  291(%edi,%eax,4), %ymm3, %ymm2 {%k7}
...
// CHECK:      {evex} vcvtne2ps2ph  4064(%ecx), %ymm3, %ymm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf2,0x65,0xaf,0x67,0x51,0x7f]
               {evex} vcvtne2ps2ph  4064(%ecx), %ymm3, %ymm2 {%k7} {z}

// CHECK:      {evex} vcvtne2ps2ph  -512(%edx){1to8}, %ymm3, %ymm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf2,0x65,0xbf,0x67,0x52,0x80]
               {evex} vcvtne2ps2ph  -512(%edx){1to8}, %ymm3, %ymm2 {%k7} {z}
...
// CHECK:      {evex} vcvtne2ps2ph  291(%edi,%eax,4), %xmm3, %xmm2 {%k7}
// CHECK: encoding: [0x62,0xf2,0x65,0x0f,0x67,0x94,0x87,0x23,0x01,0x00,0x00]
               {evex} vcvtne2ps2ph  291(%edi,%eax,4), %xmm3, %xmm2 {%k7}
...
// CHECK:      {evex} vcvtne2ps2ph  2032(%ecx), %xmm3, %xmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf2,0x65,0x8f,0x67,0x51,0x7f]
               {evex} vcvtne2ps2ph  2032(%ecx), %xmm3, %xmm2 {%k7} {z}

// CHECK:      {evex} vcvtne2ps2ph  -512(%edx){1to4}, %xmm3, %xmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf2,0x65,0x9f,0x67,0x52,0x80]
               {evex} vcvtne2ps2ph  -512(%edx){1to4}, %xmm3, %xmm2 {%k7} {z}

...
// CHECK:      {evex} vcvtne2ps2ph ymm2 {k7}, ymm3, ymm4
// CHECK: encoding: [0x62,0xf2,0x65,0x2f,0x67,0xd4]
               {evex} vcvtne2ps2ph ymm2 {k7}, ymm3, ymm4

// CHECK:      {evex} vcvtne2ps2ph ymm2 {k7} {z}, ymm3, ymm4
// CHECK: encoding: [0x62,0xf2,0x65,0xaf,0x67,0xd4]
               {evex} vcvtne2ps2ph ymm2 {k7} {z}, ymm3, ymm4

// CHECK:      {evex} vcvtne2ps2ph xmm2, xmm3, xmm4
// CHECK: encoding: [0x62,0xf2,0x65,0x08,0x67,0xd4]
               {evex} vcvtne2ps2ph xmm2, xmm3, xmm4

// CHECK:      {evex} vcvtne2ps2ph xmm2 {k7}, xmm3, xmm4
// CHECK: encoding: [0x62,0xf2,0x65,0x0f,0x67,0xd4]
               {evex} vcvtne2ps2ph xmm2 {k7}, xmm3, xmm4

// CHECK:      {evex} vcvtne2ps2ph xmm2 {k7} {z}, xmm3, xmm4
// CHECK: encoding: [0x62,0xf2,0x65,0x8f,0x67,0xd4]
               {evex} vcvtne2ps2ph xmm2 {k7} {z}, xmm3, xmm4
...
// CHECK:      {evex} vcvtne2ps2ph ymm2 {k7}, ymm3, ymmword ptr [edi + 4*eax + 291]
// CHECK: encoding: [0x62,0xf2,0x65,0x2f,0x67,0x94,0x87,0x23,0x01,0x00,0x00]
               {evex} vcvtne2ps2ph ymm2 {k7}, ymm3, ymmword ptr [edi + 4*eax + 291]
...
// CHECK:      {evex} vcvtne2ps2ph ymm2 {k7} {z}, ymm3, ymmword ptr [ecx + 4064]
// CHECK: encoding: [0x62,0xf2,0x65,0xaf,0x67,0x51,0x7f]
               {evex} vcvtne2ps2ph ymm2 {k7} {z}, ymm3, ymmword ptr [ecx + 4064]

// CHECK:      {evex} vcvtne2ps2ph ymm2 {k7} {z}, ymm3, dword ptr [edx - 512]{1to8}
// CHECK: encoding: [0x62,0xf2,0x65,0xbf,0x67,0x52,0x80]
               {evex} vcvtne2ps2ph ymm2 {k7} {z}, ymm3, dword ptr [edx - 512]{1to8}
...
// CHECK:      {evex} vcvtne2ps2ph xmm2 {k7}, xmm3, xmmword ptr [edi + 4*eax + 291]
// CHECK: encoding: [0x62,0xf2,0x65,0x0f,0x67,0x94,0x87,0x23,0x01,0x00,0x00]
               {evex} vcvtne2ps2ph xmm2 {k7}, xmm3, xmmword ptr [edi + 4*eax + 291]
...
// CHECK:      {evex} vcvtne2ps2ph xmm2 {k7} {z}, xmm3, xmmword ptr [ecx + 2032]
// CHECK: encoding: [0x62,0xf2,0x65,0x8f,0x67,0x51,0x7f]
               {evex} vcvtne2ps2ph xmm2 {k7} {z}, xmm3, xmmword ptr [ecx + 2032]

// CHECK:      {evex} vcvtne2ps2ph xmm2 {k7} {z}, xmm3, dword ptr [edx - 512]{1to4}
// CHECK: encoding: [0x62,0xf2,0x65,0x9f,0x67,0x52,0x80]
               {evex} vcvtne2ps2ph xmm2 {k7} {z}, xmm3, dword ptr [edx - 512]{1to4}

...
// CHECK:      {evex} vcvtne2ps2ph ymm22 {k7}, ymm23, ymm24
// CHECK: encoding: [0x62,0x82,0x45,0x27,0x67,0xf0]
               {evex} vcvtne2ps2ph ymm22 {k7}, ymm23, ymm24

// CHECK:      {evex} vcvtne2ps2ph ymm22 {k7} {z}, ymm23, ymm24
// CHECK: encoding: [0x62,0x82,0x45,0xa7,0x67,0xf0]
               {evex} vcvtne2ps2ph ymm22 {k7} {z}, ymm23, ymm24

// CHECK:      {evex} vcvtne2ps2ph xmm22, xmm23, xmm24
// CHECK: encoding: [0x62,0x82,0x45,0x00,0x67,0xf0]
               {evex} vcvtne2ps2ph xmm22, xmm23, xmm24

// CHECK:      {evex} vcvtne2ps2ph xmm22 {k7}, xmm23, xmm24
// CHECK: encoding: [0x62,0x82,0x45,0x07,0x67,0xf0]
               {evex} vcvtne2ps2ph xmm22 {k7}, xmm23, xmm24

// CHECK:      {evex} vcvtne2ps2ph xmm22 {k7} {z}, xmm23, xmm24
// CHECK: encoding: [0x62,0x82,0x45,0x87,0x67,0xf0]
               {evex} vcvtne2ps2ph xmm22 {k7} {z}, xmm23, xmm24
...
// CHECK:      {evex} vcvtne2ps2ph ymm22 {k7}, ymm23, ymmword ptr [r8 + 4*rax + 291]
// CHECK: encoding: [0x62,0xc2,0x45,0x27,0x67,0xb4,0x80,0x23,0x01,0x00,0x00]
               {evex} vcvtne2ps2ph ymm22 {k7}, ymm23, ymmword ptr [r8 + 4*rax + 291]
...
// CHECK:      {evex} vcvtne2ps2ph ymm22 {k7} {z}, ymm23, ymmword ptr [rcx + 4064]
// CHECK: encoding: [0x62,0xe2,0x45,0xa7,0x67,0x71,0x7f]
               {evex} vcvtne2ps2ph ymm22 {k7} {z}, ymm23, ymmword ptr [rcx + 4064]

// CHECK:      {evex} vcvtne2ps2ph ymm22 {k7} {z}, ymm23, dword ptr [rdx - 512]{1to8}
// CHECK: encoding: [0x62,0xe2,0x45,0xb7,0x67,0x72,0x80]
               {evex} vcvtne2ps2ph ymm22 {k7} {z}, ymm23, dword ptr [rdx - 512]{1to8}
...
// CHECK:      {evex} vcvtne2ps2ph xmm22 {k7}, xmm23, xmmword ptr [r8 + 4*rax + 291]
// CHECK: encoding: [0x62,0xc2,0x45,0x07,0x67,0xb4,0x80,0x23,0x01,0x00,0x00]
               {evex} vcvtne2ps2ph xmm22 {k7}, xmm23, xmmword ptr [r8 + 4*rax + 291]
...
// CHECK:      {evex} vcvtne2ps2ph xmm22 {k7} {z}, xmm23, xmmword ptr [rcx + 2032]
// CHECK: encoding: [0x62,0xe2,0x45,0x87,0x67,0x71,0x7f]
               {evex} vcvtne2ps2ph xmm22 {k7} {z}, xmm23, xmmword ptr [rcx + 2032]

// CHECK:      {evex} vcvtne2ps2ph xmm22 {k7} {z}, xmm23, dword ptr [rdx - 512]{1to4}
// CHECK: encoding: [0x62,0xe2,0x45,0x97,0x67,0x72,0x80]
               {evex} vcvtne2ps2ph xmm22 {k7} {z}, xmm23, dword ptr [rdx - 512]{1to4}

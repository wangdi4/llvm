...
// CHECK: vcvtph2ibs %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa5,0x7c,0xaf,0x69,0xf7]
          vcvtph2ibs %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vcvtph2iubs %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa5,0x7c,0xaf,0x6b,0xf7]
          vcvtph2iubs %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vcvtps2ibs %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa5,0x7d,0xaf,0x69,0xf7]
          vcvtps2ibs %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vcvtps2iubs %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa5,0x7d,0xaf,0x6b,0xf7]
          vcvtps2iubs %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vcvttph2ibs %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa5,0x7c,0xaf,0x68,0xf7]
          vcvttph2ibs %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vcvttph2iubs %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa5,0x7c,0xaf,0x6a,0xf7]
          vcvttph2iubs %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vcvttps2ibs %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa5,0x7d,0xaf,0x68,0xf7]
          vcvttps2ibs %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vcvttps2iubs %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0xa5,0x7d,0xaf,0x6a,0xf7]
          vcvttps2iubs %ymm23, %ymm22 {%k7} {z}

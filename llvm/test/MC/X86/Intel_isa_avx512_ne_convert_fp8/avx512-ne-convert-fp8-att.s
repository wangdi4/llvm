...
// CHECK: vcvtnebf82ph  $123, 268435456(%esp,%esi,8), %zmm2
// CHECK: encoding: [0x62,0xf3,0x7e,0x48,0x1c,0x94,0xf4,0x00,0x00,0x00,0x10,0x7b]
          vcvtnebf82ph  $123, 268435456(%esp,%esi,8), %zmm2

// CHECK: vcvtnebf82ph  $123, 291(%edi,%eax,4), %zmm2 {%k7}
// CHECK: encoding: [0x62,0xf3,0x7e,0x4f,0x1c,0x94,0x87,0x23,0x01,0x00,0x00,0x7b]
          vcvtnebf82ph  $123, 291(%edi,%eax,4), %zmm2 {%k7}

// CHECK: vcvtnebf82ph  $123, (%eax){1to32}, %zmm2
// CHECK: encoding: [0x62,0xf3,0x7e,0x58,0x1c,0x10,0x7b]
          vcvtnebf82ph  $123, (%eax){1to32}, %zmm2

// CHECK: vcvtnebf82ph  $123, -2048(,%ebp,2), %zmm2
// CHECK: encoding: [0x62,0xf3,0x7e,0x48,0x1c,0x14,0x6d,0x00,0xf8,0xff,0xff,0x7b]
          vcvtnebf82ph  $123, -2048(,%ebp,2), %zmm2

// CHECK: vcvtnebf82ph  $123, 8128(%ecx), %zmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x7e,0xcf,0x1c,0x51,0x7f,0x7b]
          vcvtnebf82ph  $123, 8128(%ecx), %zmm2 {%k7} {z}

// CHECK: vcvtnebf82ph  $123, -256(%edx){1to32}, %zmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x7e,0xdf,0x1c,0x52,0x80,0x7b]
          vcvtnebf82ph  $123, -256(%edx){1to32}, %zmm2 {%k7} {z}

// CHECK: vcvtnebf82ps  $123, 268435456(%esp,%esi,8), %zmm2
// CHECK: encoding: [0x62,0xf3,0x7c,0x48,0x1c,0x94,0xf4,0x00,0x00,0x00,0x10,0x7b]
          vcvtnebf82ps  $123, 268435456(%esp,%esi,8), %zmm2

// CHECK: vcvtnebf82ps  $123, 291(%edi,%eax,4), %zmm2 {%k7}
// CHECK: encoding: [0x62,0xf3,0x7c,0x4f,0x1c,0x94,0x87,0x23,0x01,0x00,0x00,0x7b]
          vcvtnebf82ps  $123, 291(%edi,%eax,4), %zmm2 {%k7}

// CHECK: vcvtnebf82ps  $123, (%eax){1to16}, %zmm2
// CHECK: encoding: [0x62,0xf3,0x7c,0x58,0x1c,0x10,0x7b]
          vcvtnebf82ps  $123, (%eax){1to16}, %zmm2

// CHECK: vcvtnebf82ps  $123, -2048(,%ebp,2), %zmm2
// CHECK: encoding: [0x62,0xf3,0x7c,0x48,0x1c,0x14,0x6d,0x00,0xf8,0xff,0xff,0x7b]
          vcvtnebf82ps  $123, -2048(,%ebp,2), %zmm2

// CHECK: vcvtnebf82ps  $123, 8128(%ecx), %zmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x7c,0xcf,0x1c,0x51,0x7f,0x7b]
          vcvtnebf82ps  $123, 8128(%ecx), %zmm2 {%k7} {z}

// CHECK: vcvtnebf82ps  $123, -512(%edx){1to16}, %zmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x7c,0xdf,0x1c,0x52,0x80,0x7b]
          vcvtnebf82ps  $123, -512(%edx){1to16}, %zmm2 {%k7} {z}

// CHECK: vcvtnehf82ph  $123, 268435456(%esp,%esi,8), %zmm2
// CHECK: encoding: [0x62,0xf3,0x7f,0x48,0x1c,0x94,0xf4,0x00,0x00,0x00,0x10,0x7b]
          vcvtnehf82ph  $123, 268435456(%esp,%esi,8), %zmm2

// CHECK: vcvtnehf82ph  $123, 291(%edi,%eax,4), %zmm2 {%k7}
// CHECK: encoding: [0x62,0xf3,0x7f,0x4f,0x1c,0x94,0x87,0x23,0x01,0x00,0x00,0x7b]
          vcvtnehf82ph  $123, 291(%edi,%eax,4), %zmm2 {%k7}

// CHECK: vcvtnehf82ph  $123, (%eax){1to32}, %zmm2
// CHECK: encoding: [0x62,0xf3,0x7f,0x58,0x1c,0x10,0x7b]
          vcvtnehf82ph  $123, (%eax){1to32}, %zmm2

// CHECK: vcvtnehf82ph  $123, -2048(,%ebp,2), %zmm2
// CHECK: encoding: [0x62,0xf3,0x7f,0x48,0x1c,0x14,0x6d,0x00,0xf8,0xff,0xff,0x7b]
          vcvtnehf82ph  $123, -2048(,%ebp,2), %zmm2

// CHECK: vcvtnehf82ph  $123, 8128(%ecx), %zmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x7f,0xcf,0x1c,0x51,0x7f,0x7b]
          vcvtnehf82ph  $123, 8128(%ecx), %zmm2 {%k7} {z}

// CHECK: vcvtnehf82ph  $123, -256(%edx){1to32}, %zmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x7f,0xdf,0x1c,0x52,0x80,0x7b]
          vcvtnehf82ph  $123, -256(%edx){1to32}, %zmm2 {%k7} {z}

// CHECK: vcvtnehf82ps  $123, 268435456(%esp,%esi,8), %zmm2
// CHECK: encoding: [0x62,0xf3,0x7d,0x48,0x1c,0x94,0xf4,0x00,0x00,0x00,0x10,0x7b]
          vcvtnehf82ps  $123, 268435456(%esp,%esi,8), %zmm2

// CHECK: vcvtnehf82ps  $123, 291(%edi,%eax,4), %zmm2 {%k7}
// CHECK: encoding: [0x62,0xf3,0x7d,0x4f,0x1c,0x94,0x87,0x23,0x01,0x00,0x00,0x7b]
          vcvtnehf82ps  $123, 291(%edi,%eax,4), %zmm2 {%k7}

// CHECK: vcvtnehf82ps  $123, (%eax){1to16}, %zmm2
// CHECK: encoding: [0x62,0xf3,0x7d,0x58,0x1c,0x10,0x7b]
          vcvtnehf82ps  $123, (%eax){1to16}, %zmm2

// CHECK: vcvtnehf82ps  $123, -2048(,%ebp,2), %zmm2
// CHECK: encoding: [0x62,0xf3,0x7d,0x48,0x1c,0x14,0x6d,0x00,0xf8,0xff,0xff,0x7b]
          vcvtnehf82ps  $123, -2048(,%ebp,2), %zmm2

// CHECK: vcvtnehf82ps  $123, 8128(%ecx), %zmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x7d,0xcf,0x1c,0x51,0x7f,0x7b]
          vcvtnehf82ps  $123, 8128(%ecx), %zmm2 {%k7} {z}

// CHECK: vcvtnehf82ps  $123, -512(%edx){1to16}, %zmm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x7d,0xdf,0x1c,0x52,0x80,0x7b]
          vcvtnehf82ps  $123, -512(%edx){1to16}, %zmm2 {%k7} {z}

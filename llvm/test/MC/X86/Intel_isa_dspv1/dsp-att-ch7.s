...
// CHECK: dvpmuldllq %xmm4, %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcc,0xd4]
          dvpmuldllq %xmm4, %xmm3, %xmm2

// CHECK: dvpmuldllq  268435456(%esp,%esi,8), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcc,0x94,0xf4,0x00,0x00,0x00,0x10]
          dvpmuldllq  268435456(%esp,%esi,8), %xmm3, %xmm2

// CHECK: dvpmuldllq  291(%edi,%eax,4), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcc,0x94,0x87,0x23,0x01,0x00,0x00]
          dvpmuldllq  291(%edi,%eax,4), %xmm3, %xmm2

// CHECK: dvpmuldllq  (%eax), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcc,0x10]
          dvpmuldllq  (%eax), %xmm3, %xmm2

// CHECK: dvpmuldllq  -512(,%ebp,2), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcc,0x14,0x6d,0x00,0xfe,0xff,0xff]
          dvpmuldllq  -512(,%ebp,2), %xmm3, %xmm2

// CHECK: dvpmuldllq  2032(%ecx), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcc,0x91,0xf0,0x07,0x00,0x00]
          dvpmuldllq  2032(%ecx), %xmm3, %xmm2

// CHECK: dvpmuldllq  -2048(%edx), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcc,0x92,0x00,0xf8,0xff,0xff]
          dvpmuldllq  -2048(%edx), %xmm3, %xmm2

// CHECK: dvpmuludllq %xmm4, %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcb,0xd4]
          dvpmuludllq %xmm4, %xmm3, %xmm2

// CHECK: dvpmuludllq  268435456(%esp,%esi,8), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcb,0x94,0xf4,0x00,0x00,0x00,0x10]
          dvpmuludllq  268435456(%esp,%esi,8), %xmm3, %xmm2

// CHECK: dvpmuludllq  291(%edi,%eax,4), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcb,0x94,0x87,0x23,0x01,0x00,0x00]
          dvpmuludllq  291(%edi,%eax,4), %xmm3, %xmm2

// CHECK: dvpmuludllq  (%eax), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcb,0x10]
          dvpmuludllq  (%eax), %xmm3, %xmm2

// CHECK: dvpmuludllq  -512(,%ebp,2), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcb,0x14,0x6d,0x00,0xfe,0xff,0xff]
          dvpmuludllq  -512(,%ebp,2), %xmm3, %xmm2

// CHECK: dvpmuludllq  2032(%ecx), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcb,0x91,0xf0,0x07,0x00,0x00]
          dvpmuludllq  2032(%ecx), %xmm3, %xmm2

// CHECK: dvpmuludllq  -2048(%edx), %xmm3, %xmm2
// CHECK: encoding: [0xc4,0xe8,0xe3,0xcb,0x92,0x00,0xf8,0xff,0xff]
          dvpmuludllq  -2048(%edx), %xmm3, %xmm2

...
// CHECK: vminmaxpd $123, %ymm24, %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0x83,0xc5,0xa7,0x52,0xf0,0x7b]
          vminmaxpd $123, %ymm24, %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vminmaxph $123, %ymm24, %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0x83,0x44,0xa7,0x52,0xf0,0x7b]
          vminmaxph $123, %ymm24, %ymm23, %ymm22 {%k7} {z}
...
// CHECK: vminmaxps $123, %ymm24, %ymm23, %ymm22 {%k7} {z}
// CHECK: encoding: [0x62,0x83,0x45,0xa7,0x52,0xf0,0x7b]
          vminmaxps $123, %ymm24, %ymm23, %ymm22 {%k7} {z}

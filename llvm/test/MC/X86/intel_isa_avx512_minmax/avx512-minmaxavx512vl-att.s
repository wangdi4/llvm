...
// CHECK: vminmaxpd $123, %ymm4, %ymm3, %ymm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0xe5,0xaf,0x52,0xd4,0x7b]
          vminmaxpd $123, %ymm4, %ymm3, %ymm2 {%k7} {z}
...
// CHECK: vminmaxph $123, %ymm4, %ymm3, %ymm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x64,0xaf,0x52,0xd4,0x7b]
          vminmaxph $123, %ymm4, %ymm3, %ymm2 {%k7} {z}
...
// CHECK: vminmaxps $123, %ymm4, %ymm3, %ymm2 {%k7} {z}
// CHECK: encoding: [0x62,0xf3,0x65,0xaf,0x52,0xd4,0x7b]
          vminmaxps $123, %ymm4, %ymm3, %ymm2 {%k7} {z}

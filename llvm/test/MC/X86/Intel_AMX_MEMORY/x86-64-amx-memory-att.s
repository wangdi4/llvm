...
// CHECK:     tgatherrowd     268435456(%rbp,%r14,8), %tmm5
// CHECK: encoding: [0xc4,0xa2,0x7b,0x6e,0xac,0xf5,0x00,0x00,0x00,0x10]
               tgatherrowd 268435456(%rbp,%r14,8), %tmm5
...
// CHECK:     tgatherrowdt1     31(%rcx), %tmm5
// CHECK: encoding: [0xc4,0xe2,0x7b,0x6f,0x6c,0x21,0x1f]
               tgatherrowdt1 31(%rcx), %tmm5

// CHECK:     tgatherrowdt1     -32(%rdx), %tmm3
// CHECK: encoding: [0xc4,0xe2,0x7b,0x6f,0x5c,0x22,0xe0]
               tgatherrowdt1 -32(%rdx), %tmm3

// CHECK:     tgatherrowq     268435456(%rbp,%r14,8), %tmm5
// CHECK: encoding: [0xc4,0xa2,0xfb,0x6e,0xac,0xf5,0x00,0x00,0x00,0x10]
               tgatherrowq 268435456(%rbp,%r14,8), %tmm5
...
// CHECK:     tgatherrowq     31(%rcx), %tmm5
// CHECK: encoding: [0xc4,0xe2,0xfb,0x6e,0x6c,0x21,0x1f]
               tgatherrowq 31(%rcx), %tmm5

// CHECK:     tgatherrowq     -32(%rdx), %tmm3
// CHECK: encoding: [0xc4,0xe2,0xfb,0x6e,0x5c,0x22,0xe0]
               tgatherrowq -32(%rdx), %tmm3

// CHECK:     tgatherrowqt1     268435456(%rbp,%r14,8), %tmm5
// CHECK: encoding: [0xc4,0xa2,0xfb,0x6f,0xac,0xf5,0x00,0x00,0x00,0x10]
               tgatherrowqt1 268435456(%rbp,%r14,8), %tmm5
...
// CHECK:     tgatherrowqt1     31(%rcx), %tmm5
// CHECK: encoding: [0xc4,0xe2,0xfb,0x6f,0x6c,0x21,0x1f]
               tgatherrowqt1 31(%rcx), %tmm5

// CHECK:     tgatherrowqt1     -32(%rdx), %tmm3
// CHECK: encoding: [0xc4,0xe2,0xfb,0x6f,0x5c,0x22,0xe0]
               tgatherrowqt1 -32(%rdx), %tmm3

// CHECK:     tscatterrowd     %tmm5, 268435456(%rbp,%r14,8)
// CHECK: encoding: [0xc4,0xa2,0x7a,0x6e,0xac,0xf5,0x00,0x00,0x00,0x10]
               tscatterrowd %tmm5, 268435456(%rbp,%r14,8)
...
// CHECK:     tscatterrowqt1     %tmm5, 31(%rcx)
// CHECK: encoding: [0xc4,0xe2,0xfa,0x6f,0x6c,0x21,0x1f]
               tscatterrowqt1 %tmm5, 31(%rcx)

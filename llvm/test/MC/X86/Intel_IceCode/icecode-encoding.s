...
// CHECK: creg_xchg_mtl $16909060, %ebx
// CHECK: encoding: [0xf2,0x81,0xc3,0x04,0x03,0x02,0x01]
          creg_xchg_mt $0x01020304, %ebx

// CHECK: creg_xchg_mtq $16909060, %rbx
// CHECK: encoding: [0xf2,0x48,0x81,0xc3,0x04,0x03,0x02,0x01]
          creg_xchg_mt $0x01020304, %rbx

// CHECK: creg_read_mtl $16909060, %ebx
// CHECK: encoding: [0xf2,0x81,0xeb,0x04,0x03,0x02,0x01]
          creg_read_mt $0x01020304, %ebx

// CHECK: creg_read_mtq $16909060, %rbx
// CHECK: encoding: [0xf2,0x48,0x81,0xeb,0x04,0x03,0x02,0x01]
          creg_read_mt $0x01020304, %rbx

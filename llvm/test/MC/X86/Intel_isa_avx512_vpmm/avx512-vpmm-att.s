...
// CHECK: vmmf16ps        %xmm4, %xmm3, %xmm0             # encoding: [0x62,0xf6,0x66,0x08,0x6f,0xc4]
     vmmf16ps %xmm4, %xmm3, %xmm0

// CHECK: vmmf16ps        %ymm4, %ymm3, %ymm0             # encoding: [0x62,0xf6,0x66,0x28,0x6f,0xc4]
     vmmf16ps %ymm4, %ymm3, %ymm0

// CHECK: vmmf16ps        %zmm4, %zmm3, %zmm0             # encoding: [0x62,0xf6,0x66,0x48,0x6f,0xc4]

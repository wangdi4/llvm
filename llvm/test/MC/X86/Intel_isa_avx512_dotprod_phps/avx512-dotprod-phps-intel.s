...
// RUN: llvm-mc -triple i686-unknown-unknown -mattr=+avx512dotprodphps -x86-asm-syntax=intel -output-asm-variant=1 --show-encoding %s | FileCheck %s

// CHECK:      vdpphps zmm2, zmm3, zmm4
// CHECK: encoding: [0x62,0xf2,0x64,0x48,0x52,0xd4]
               vdpphps zmm2, zmm3, zmm4

// CHECK:      vdpphps zmm2, zmm3, zmm4, {rn-sae}
// CHECK: encoding: [0x62,0xf2,0x64,0x18,0x52,0xd4]
               vdpphps zmm2, zmm3, zmm4, {rn-sae}

// CHECK:      vdpphps zmm2 {k7}, zmm3, zmm4
// CHECK: encoding: [0x62,0xf2,0x64,0x4f,0x52,0xd4]
               vdpphps zmm2 {k7}, zmm3, zmm4

// CHECK:      vdpphps zmm2 {k7} {z}, zmm3, zmm4, {rz-sae}
// CHECK: encoding: [0x62,0xf2,0x64,0xff,0x52,0xd4]
               vdpphps zmm2 {k7} {z}, zmm3, zmm4, {rz-sae}

...
; INTEL_CUSTOMIZATION
; RUN: llvm-lto2 run %t2.o -lto-opaque-pointers -save-temps -use-new-pm -pass-remarks=. \
...
; INTEL_CUSTOMIZATION
; RUN: llvm-lto2 run %t.o -lto-opaque-pointers -save-temps -use-new-pm -pass-remarks=. \
; RUN:   %intel_devirt_options \
; end INTEL_CUSTOMIZATION
; RUN:   -o %t3 \
; RUN:   -r=%t.o,test,px \

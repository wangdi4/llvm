...
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t2.o -save-temps -pass-remarks=. \
...
; Regular LTO WPD
; RUN: opt -o %t4.o %s
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers %t4.o -save-temps -pass-remarks=. \
; RUN:   -whole-program-visibility \
; INTEL_CUSTOMIZATION
; RUN:   %intel_devirt_options \
; end INTEL_CUSTOMIZATION

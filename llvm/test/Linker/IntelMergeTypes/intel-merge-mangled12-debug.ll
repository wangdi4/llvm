...
; RUN: llvm-link -debug-only=irmover-dtrans-metadata-loss -irmover-enable-merge-with-dtrans -irmover-enable-module-verify -irmover-type-merging=false -irmover-enable-full-dtrans-types-check -S %S/Inputs/intel-merge-mangled12-a.ll %S/Inputs/intel-merge-mangled12-b.ll 2>&1 | FileCheck %s

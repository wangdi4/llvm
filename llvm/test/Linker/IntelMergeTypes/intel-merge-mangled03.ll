...
; RUN: llvm-link -irmover-enable-merge-with-dtrans -irmover-enable-module-verify -irmover-type-merging=false -irmover-enable-full-dtrans-types-check -S %S/Inputs/intel-merge-mangled03-a.ll %S/Inputs/intel-merge-mangled03-b.ll %S/Inputs/intel-merge-mangled03-c.ll %S/Inputs/intel-merge-mangled03-d.ll 2>&1 | FileCheck %s

; This test case checks that the types were correctly merged when there are
; anonymous structures inside the class. The goal is to check that the
; anonymous structures weren't merged. It was generated from the following
; example:

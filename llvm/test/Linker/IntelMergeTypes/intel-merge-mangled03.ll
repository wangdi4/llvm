...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-module-verify -irmover-type-merging=false -irmover-enable-full-dtrans-types-check -S %S/Inputs/intel-merge-mangled03-a.ll %S/Inputs/intel-merge-mangled03-b.ll %S/Inputs/intel-merge-mangled03-c.ll %S/Inputs/intel-merge-mangled03-d.ll 2>&1 | FileCheck %s

...
; RUN: llvm-link -irmover-trace-dtrans-metadata-loss -irmover-enable-merge-with-dtrans -irmover-type-merging=false -S %S/Inputs/intel-merge-types-09a.ll %S/Inputs/intel-merge-types-09b.ll 2>&1 | FileCheck %s

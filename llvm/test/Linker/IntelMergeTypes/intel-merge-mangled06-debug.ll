...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-module-verify -irmover-type-merging=false -debug-only=irmover-mangled-names -irmover-enable-full-dtrans-types-check -S %S/Inputs/intel-merge-mangled06-a.ll %S/Inputs/intel-merge-mangled06-b.ll %S/Inputs/intel-merge-mangled06-c.ll 2>&1 | FileCheck %s

...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-module-verify -irmover-type-merging=false -debug-only=irmover-mangled-names -S %S/Inputs/intel-merge-mangled04-a.ll %S/Inputs/intel-merge-mangled04-b.ll %S/Inputs/intel-merge-mangled04-c.ll %S/Inputs/intel-merge-mangled04-d.ll 2>&1 | FileCheck %s
...
; CHECK-SAME: Inputs/intel-merge-mangled04-a.ll
...
; CHECK:   Source type: %union._ZTSN9TestClassIiEUt_E.anon = type { double }
; CHECK:     Destination type: None
; CHECK:   Source type: %class._ZTS9TestClassIdE.TestClass = type { double, %union._ZTSN9TestClassIdEUt_E.anon }
; CHECK:     Destination type: None
; CHECK:   Source type: %union._ZTSN9TestClassIdEUt_E.anon = type { double }
; CHECK:     Destination type: None
; CHECK: -------------------------------------------------------

; CHECK: Merging types from source module:
; CHECK-SAME: Inputs/intel-merge-mangled04-b.ll

...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-module-verify -irmover-type-merging=false -irmover-enable-full-dtrans-types-check -S %S/Inputs/intel-merge-mangled02-a.ll %S/Inputs/intel-merge-mangled02-b.ll %S/Inputs/intel-merge-mangled02-c.ll %S/Inputs/intel-merge-mangled02-d.ll | FileCheck %s

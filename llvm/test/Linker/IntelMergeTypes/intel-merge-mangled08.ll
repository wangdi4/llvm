...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-module-verify -irmover-type-merging=false -irmover-enable-full-dtrans-types-check -S %S/Inputs/intel-merge-mangled08-a.ll %S/Inputs/intel-merge-mangled08-b.ll %S/Inputs/intel-merge-mangled08-c.ll %S/Inputs/intel-merge-mangled08-d.ll 2>&1 | FileCheck %s

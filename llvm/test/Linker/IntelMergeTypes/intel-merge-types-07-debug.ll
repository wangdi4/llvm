...
; RUN: llvm-link -debug-only=irmover-dtrans-types -irmover-enable-merge-with-dtrans -irmover-enable-module-verify -irmover-type-merging=false -S %S/Inputs/intel-merge-types-07a.ll %S/Inputs/intel-merge-types-07b.ll %S/Inputs/intel-merge-types-07c.ll 2>&1 | FileCheck %s

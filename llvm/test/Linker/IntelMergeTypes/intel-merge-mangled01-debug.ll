...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-module-verify -irmover-type-merging=false -debug-only=irmover-mangled-names -irmover-enable-full-dtrans-types-check -S %s %S/Inputs/intel-merge-mangled01-a.ll %S/Inputs/intel-merge-mangled01-b.ll 2>&1 | FileCheck %s

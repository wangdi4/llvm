...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-module-verify -irmover-type-merging=false -irmover-enable-full-dtrans-types-check -S %s %S/Inputs/intel-merge-mangled01-a.ll %S/Inputs/intel-merge-mangled01-b.ll | FileCheck %s

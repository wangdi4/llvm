...
; RUN: llvm-link -debug-only=irmover-mangled-names  -irmover-enable-merge-by-mangled-names -irmover-enable-dtrans-incomplete-metadata -irmover-enable-module-verify -irmover-type-merging=false -opaque-pointers -S %S/Inputs/intel-merge-types-opq-02a.ll %S/Inputs/intel-merge-types-opq-02b.ll 2>&1 | FileCheck %s
...
; same test case as intel-merge-types-opq-02-debug.ll. This test case
...
; CHECK: Merging types from source module:
; CHECK-SAME: intel-merge-types-opq-02b.ll

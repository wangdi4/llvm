...
; RUN: llvm-link -debug-only=irmover-mangled-names -irmover-enable-merge-by-mangled-names -irmover-enable-dtrans-incomplete-metadata -irmover-enable-module-verify -irmover-type-merging=false -opaque-pointers -S %S/Inputs/intel-merge-types-opq-01a.ll %S/Inputs/intel-merge-types-opq-01b.ll 2>&1 | FileCheck %s
...
; intel-merge-types-opq-01-debug.ll but it checks the debug information. The
...
; CHECK-SAME: intel-merge-types-opq-01a.ll
...
; CHECK: Merging types from source module:
; CHECK-SAME: intel-merge-types-opq-01b.ll

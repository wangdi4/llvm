...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-dtrans-incomplete-metadata -irmover-enable-module-verify -irmover-type-merging=false -S %S/Inputs/intel-merge-types-opq-03a.ll %S/Inputs/intel-merge-types-opq-03b.ll | FileCheck %s -check-prefix=CHECK-AB
...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-dtrans-incomplete-metadata -irmover-enable-module-verify -irmover-type-merging=false -S %S/Inputs/intel-merge-types-opq-03b.ll %S/Inputs/intel-merge-types-opq-03a.ll | FileCheck %s -check-prefix=CHECK-BA

...
define dso_local void @_Z3fooP9TestClassIiEi(ptr nocapture "intel_dtrans_func_index"="1" %T, i32 %I) local_unnamed_addr #0 !intel.dtrans.func.type !10 {
entry:
  %val.i = getelementptr inbounds %class._ZTS9TestClassIiE.TestClass, ptr %T, i64 0, i32 0, !intel-tbaa !12
  store i32 %I, ptr %val.i, align 4, !tbaa !12
  ret void
}

...
%class._ZTS9TestClassIdE.TestClass = type { ptr }

@globDouble = dso_local local_unnamed_addr global ptr null, align 8, !intel_dtrans_type !0

; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local void @_Z9fooDoubledi(double %I, i32 %j) local_unnamed_addr #0 {
entry:
  %0 = load ptr, ptr @globDouble, align 8, !tbaa !8
  %val.i = getelementptr inbounds %class._ZTS9TestClassIdE.TestClass, ptr %0, i64 0, i32 0, !intel-tbaa !12
  ...
  store double %I, ptr %arrayidx.i, align 8, !tbaa !15
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local double @_Z9barDoubled(double %i) local_unnamed_addr #1 {
entry:
  %0 = load ptr, ptr @globDouble, align 8, !tbaa !8
  %conv = fptosi double %i to i32
  %val.i = getelementptr inbounds %class._ZTS9TestClassIdE.TestClass, ptr %0, i64 0, i32 0, !intel-tbaa !12
  %1 = load ptr, ptr %val.i, align 8, !tbaa !12
  %idxprom.i = sext i32 %conv to i64
  %arrayidx.i = getelementptr inbounds double, ptr %1, i64 %idxprom.i
...
!0 = !{%class._ZTS9TestClassIdE.TestClass zeroinitializer, i32 1}
!1 = !{i32 1, !"wchar_size", i32 4}
!2 = !{i32 7, !"uwtable", i32 1}
!3 = !{i32 1, !"ThinLTO", i32 0}
!4 = !{i32 1, !"EnableSplitLTOUnit", i32 1}
!5 = !{!"S", %class._ZTS9TestClassIdE.TestClass zeroinitializer, i32 1, !6}
!6 = !{double 0.000000e+00, i32 1}
!7 = !{!"Intel(R) oneAPI DPC++/C++ Compiler 2021.4.0 (2021.x.0.YYYYMMDD)"}
!8 = !{!9, !9, i64 0}
!9 = !{!"pointer@_ZTSP9TestClassIdE", !10, i64 0}
!10 = !{!"omnipotent char", !11, i64 0}
!11 = !{!"Simple C++ TBAA"}
!12 = !{!13, !14, i64 0}
!13 = !{!"struct@_ZTS9TestClassIdE", !14, i64 0}

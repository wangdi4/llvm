...
define dso_local i32 @_Z3barP11TestStructAP11TestStructBi(%struct._ZTS11TestStructA.TestStructA* nocapture readonly "intel_dtrans_func_index"="1" %T, %struct._ZTS11TestStructB.TestStructB* nocapture readonly %S, i32 %in) local_unnamed_addr #0 !intel.dtrans.func.type !8 {
entry:
  ...
  %i1 = getelementptr inbounds %struct._ZTS11TestStructB.TestStructB, %struct._ZTS11TestStructB.TestStructB* %S, i64 0, i32 0, !intel-tbaa !18
  %2 = load i32*, i32** %i1, align 8, !tbaa !18
...
!17 = !{!"int", !14, i64 0}
!18 = !{!19, !13, i64 0}
!19 = !{!"struct@_ZTS11TestStructB", !13, i64 0, !13, i64 8}

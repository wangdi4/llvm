...
; ModuleID = 'intel-merge-types-opq-09a.ll'
...
define dso_local i32 @_Z3fooP11TestStructAP11TestStructBi(ptr "intel_dtrans_func_index"="1" %T, ptr %S, i32 %in) local_unnamed_addr #0 !intel.dtrans.func.type !7 {
entry:
  ...
  %call = tail call i32 @_Z3barP11TestStructAP11TestStructBi(ptr %T, ptr %S, i32 %in)
  %add = add nsw i32 %call, %1
  ret i32 %add
}

declare !intel.dtrans.func.type !16 dso_local i32 @_Z3barP11TestStructAP11TestStructBi(ptr "intel_dtrans_func_index"="1", ptr, i32) local_unnamed_addr #1

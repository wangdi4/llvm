...
declare !intel.dtrans.func.type !21 dso_local void @_Z3fooP9TestClassIiEi(ptr "intel_dtrans_func_index"="1", i32) local_unnamed_addr #2
...
entry:
  ...
  %0 = bitcast ptr %T to ptr
  call void @llvm.lifetime.start.p0i8(i64 32, ptr nonnull %0) #3
  call void @_Z3basP9TestClassIdEd(ptr nonnull %T, double 1.000000e+01)
  %val.i = getelementptr inbounds %class._ZTS9TestClassIdE.TestClass, ptr %T, i64 0, i32 0, !intel-tbaa !23
  %1 = load double, ptr %val.i, align 8, !tbaa !23
  call void @llvm.lifetime.end.p0i8(i64 32, ptr nonnull %0) #3
  ret double %1
}

declare !intel.dtrans.func.type !26 dso_local void @_Z3basP9TestClassIdEd(ptr "intel_dtrans_func_index"="1", double) local_unnamed_addr #2

...
define dso_local void @_Z3basP9TestClassIdEd(%class._ZTS9TestClassIdE.TestClass* nocapture "intel_dtrans_func_index"="1" %T, double %I) local_unnamed_addr #0 !intel.dtrans.func.type !11 {
entry:
  %val.i = getelementptr inbounds %class._ZTS9TestClassIdE.TestClass, %class._ZTS9TestClassIdE.TestClass* %T, i64 0, i32 0, !intel-tbaa !13
  store double %I, double* %val.i, align 8, !tbaa !13
  ret void
}

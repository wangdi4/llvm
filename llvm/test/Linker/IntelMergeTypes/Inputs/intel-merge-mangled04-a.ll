...
declare !intel.dtrans.func.type !19 dso_local void @_Z3fooP9TestClassIiEi(%class._ZTS9TestClassIiE.TestClass* "intel_dtrans_func_index"="1", i32) local_unnamed_addr #2
...
entry:
  ...
  %val.i = getelementptr inbounds %class._ZTS9TestClassIdE.TestClass, %class._ZTS9TestClassIdE.TestClass* %T, i64 0, i32 0, !intel-tbaa !21
  %1 = load double, double* %val.i, align 8, !tbaa !21
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %0) #3
  ret double %1
}

declare !intel.dtrans.func.type !24 dso_local void @_Z3basP9TestClassIdEd(%class._ZTS9TestClassIdE.TestClass* "intel_dtrans_func_index"="1", double) local_unnamed_addr #2

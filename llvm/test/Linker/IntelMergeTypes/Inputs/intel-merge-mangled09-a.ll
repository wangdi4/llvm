...
define dso_local i32 @_Z3fooP10TestStruct(ptr "intel_dtrans_func_index"="1" %T) local_unnamed_addr #0 !intel.dtrans.func.type !11 {
entry:
  ...
  %add = add nsw i32 %1, %0
  %call = tail call i32 @_Z3barP10TestStruct(ptr %T)
  %add1 = add nsw i32 %add, %call
  ret i32 %add1
}

declare !intel.dtrans.func.type !16 dso_local i32 @_Z3barP10TestStruct(ptr "intel_dtrans_func_index"="1") local_unnamed_addr #1

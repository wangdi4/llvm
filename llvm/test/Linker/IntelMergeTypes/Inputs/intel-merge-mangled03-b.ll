...
entry:
  ...
  %1 = load i32, ptr %val.i, align 4, !tbaa !14
...
declare !intel.dtrans.func.type !20 dso_local void @_Z3fooP9TestClassIiEi(ptr "intel_dtrans_func_index"="1", i32) local_unnamed_addr #2
...
entry:
  ...
  %val.i = getelementptr inbounds %class._ZTS9TestClassIdE.TestClass, ptr %T, i64 0, i32 0, !intel-tbaa !22
  %1 = load double, ptr %val.i, align 8, !tbaa !22

...
entry:
  ...
  %1 = load i32, i32* %val.i, align 4, !tbaa !14
...
declare !intel.dtrans.func.type !20 dso_local void @_Z3fooP9TestClassIiEi(%class._ZTS9TestClassIiE.TestClass* "intel_dtrans_func_index"="1", i32) local_unnamed_addr #2
...
entry:
  ...
  %val.i = getelementptr inbounds %class._ZTS9TestClassIdE.TestClass, %class._ZTS9TestClassIdE.TestClass* %T, i64 0, i32 0, !intel-tbaa !22
  %1 = load double, double* %val.i, align 8, !tbaa !22
...
!9 = !{!"S", %class._ZTS9TestClassIdE.TestClass zeroinitializer, i32 2, !10, !11}
!10 = !{double 0.000000e+00, i32 0}
!11 = !{%struct._ZTSN9TestClassIdEUt_E.anon zeroinitializer, i32 0}
!12 = !{!"S", %struct._ZTSN9TestClassIdEUt_E.anon zeroinitializer, i32 1, !10}
!13 = !{!"Intel(R) oneAPI DPC++/C++ Compiler 2021.4.0 (2021.x.0.YYYYMMDD)"}
!14 = !{!15, !16, i64 0}
!15 = !{!"struct@_ZTS9TestClassIiE", !16, i64 0, !19, i64 4}
!16 = !{!"int", !17, i64 0}
!17 = !{!"omnipotent char", !18, i64 0}
!18 = !{!"Simple C++ TBAA"}
!19 = !{!"struct@_ZTSN9TestClassIiEUt_E", !16, i64 0}
!20 = distinct !{!21}
!21 = !{%class._ZTS9TestClassIiE.TestClass zeroinitializer, i32 1}
!22 = !{!23, !24, i64 0}
!23 = !{!"struct@_ZTS9TestClassIdE", !24, i64 0, !25, i64 8}
!24 = !{!"double", !17, i64 0}
!25 = !{!"struct@_ZTSN9TestClassIdEUt_E", !24, i64 0}
!26 = distinct !{!27}

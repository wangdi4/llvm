...
define dso_local void @_Z3fooP9TestClassi(ptr nocapture "intel_dtrans_func_index"="1" %T, i32 %I) local_unnamed_addr #0 !intel.dtrans.func.type !8 {
entry:
  %val.i = getelementptr inbounds %class._ZTS9TestClass.TestClass, ptr %T, i64 0, i32 0, !intel-tbaa !10

...
; RUN: llvm-link -irmover-enable-merge-with-dtrans -irmover-enable-module-verify -irmover-type-merging=false -S %S/Inputs/intel-merge-types-07a.ll %S/Inputs/intel-merge-types-07b.ll %S/Inputs/intel-merge-types-07c.ll | FileCheck %s

...
; RUN: llvm-link -irmover-enable-merge-by-mangled-names -irmover-enable-module-verify -irmover-type-merging=false -S %S/Inputs/intel-merge-mangled04-a.ll %S/Inputs/intel-merge-mangled04-b.ll %S/Inputs/intel-merge-mangled04-c.ll %S/Inputs/intel-merge-mangled04-d.ll 2>&1 | FileCheck %s

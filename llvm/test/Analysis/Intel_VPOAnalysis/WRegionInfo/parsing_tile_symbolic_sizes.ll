...
define void @test_(ptr noalias dereferenceable(4) %"test_$M$argptr", ptr noalias dereferenceable(8) %"test_$N$argptr", ptr noalias dereferenceable(4) %"test_$S$argptr", ptr noalias dereferenceable(8) %"test_$T$argptr") #0 {
alloca_0:
...
do.body14:  ; preds = %do.cond13
  ...
  call void @bar_.t0p.t0p.t0p(ptr %"test_$I", ptr %"test_$J", ptr %"test_$K"), !llfort.type_idx !6

...
; This test checks if THREAD_LIMIT clause on target construct is parsed correctly.
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.THREAD_LIMIT"(i32* %n.addr) ]

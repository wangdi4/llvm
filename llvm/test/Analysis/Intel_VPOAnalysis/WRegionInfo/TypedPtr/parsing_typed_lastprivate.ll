...
; CHECK: LASTPRIVATE clause (size=1): TYPED({{.*}}, TYPE: i32, NUM_ELEMENTS: i32 1)
...
entry:
  ...
  %5 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.LASTPRIVATE:TYPED"(i32* %x, i32 0, i32 1), "QUAL.OMP.PRIVATE:TYPED"(i32* %i, i32 0, i32 1), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub) ]

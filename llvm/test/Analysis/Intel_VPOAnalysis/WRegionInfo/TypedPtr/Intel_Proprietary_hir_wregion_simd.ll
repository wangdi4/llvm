...
;
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -hir-framework -vpo-wrncollection -vpo-wrninfo -hir-vplan-vec -debug-only=vpo-wrninfo %s 2>&1 | FileCheck %s

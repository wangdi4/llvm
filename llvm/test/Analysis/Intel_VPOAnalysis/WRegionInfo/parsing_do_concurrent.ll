...
DIR.OMP.LOOP.1:                                   ; preds = %entry
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.GENERICLOOP"(), "QUAL.EXT.DO.CONCURRENT"() ]
  br label %DIR.OMP.LOOP.2

DIR.OMP.LOOP.2:                                   ; preds = %DIR.OMP.SIMD.1
...
DIR.OMP.END.LOOP.3:                               ; preds = %omp.loop.exit
  ret void
}

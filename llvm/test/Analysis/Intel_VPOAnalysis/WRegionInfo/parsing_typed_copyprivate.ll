...
; The test is passed if COPYPRIVATE:TYPED clauses are parsed correctly
...
; int nder;
; int priv;
; #pragma omp threadprivate(nder, priv)
; void foo() {
...
; CHECK: COPYPRIVATE clause (size=1): TYPED(ptr @priv, TYPE: i32, NUM_ELEMENTS: i32 1)

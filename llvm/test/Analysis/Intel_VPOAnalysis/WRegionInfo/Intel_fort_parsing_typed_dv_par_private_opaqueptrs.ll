...
; CHECK: PRIVATE clause (size=1): F90_DV(ptr %"foo_$A") , TYPED (TYPE: %"QNCA_a0$i16*$rank3$" = type { ptr, i64, i64, i64, i64, i64, [3 x { i64, i64, i64 }] }, POINTEE_TYPE: i16, NUM_ELEMENTS: i32 1)

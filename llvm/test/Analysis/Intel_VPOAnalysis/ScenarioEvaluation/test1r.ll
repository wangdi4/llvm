...
; REQUIRES: asserts
; RUN: opt < %s -O2 -S -disable-hir-loop-reversal -disable-hir-complete-unroll -debug -enable-vect-vls=1 -hir-vplan-vec=0 2>&1 | FileCheck %s
;

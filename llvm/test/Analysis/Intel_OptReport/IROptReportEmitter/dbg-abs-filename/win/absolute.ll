...
; CHECK: LOOP BEGIN at C:\Users\dwoodwor\opt-report-abs-filename\example\src\iota.c (2, 3)
; RELATIVE: LOOP BEGIN at src\iota.c (2, 3)

source_filename = "C:\\Users\\dwoodwor\\opt-report-abs-filename\\example\\src\\iota.c"
...
!0 = distinct !DICompileUnit(language: DW_LANG_C11, file: !1, producer: "clang based Intel(R) oneAPI DPC++/C++ Compiler 2024.0.0 (2024.0.0.YYYYMMDD)", isOptimized: true, flags: " --intel -O3 -x CORE-AVX512 -qopt-report=2 -c C:\\Users\\dwoodwor\\opt-report-abs-filename\\example\\src\\iota.c -mllvm -print-before=intel-ir-optreport-emitter -mllvm -print-module-scope -qopt-report-file=stderr -fveclib=SVML -fheinous-gnu-extensions", runtimeVersion: 0, emissionKind: LineTablesOnly, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "C:\\Users\\dwoodwor\\opt-report-abs-filename\\example\\src\\iota.c", directory: "C:\\Users\\dwoodwor\\opt-report-abs-filename\\example\\build")
...
!4 = !DIFile(filename: "src\\iota.c", directory: "C:\\Users\\dwoodwor\\opt-report-abs-filename\\example")

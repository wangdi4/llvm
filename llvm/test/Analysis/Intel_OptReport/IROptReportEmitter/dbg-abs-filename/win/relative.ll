...
!15 = distinct !{!"intel.optreport.rootnode", !16}
!16 = distinct !{!"intel.optreport", !17}
!17 = !{!"intel.optreport.remarks", !18, !19}
!18 = !{!"intel.optreport.remark", i32 15300, !"LOOP WAS VECTORIZED"}
!19 = !{!"intel.optreport.remark", i32 15305, !"vectorization support: vector length %s", !"4"}

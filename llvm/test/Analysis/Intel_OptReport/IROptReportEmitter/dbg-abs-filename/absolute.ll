...
!16 = distinct !{!"intel.optreport.rootnode", !17}
!17 = distinct !{!"intel.optreport", !18}
!18 = !{!"intel.optreport.remarks", !19, !20}
!19 = !{!"intel.optreport.remark", i32 15300, !"LOOP WAS VECTORIZED"}
!20 = !{!"intel.optreport.remark", i32 15305, !"vectorization support: vector length %s", !"4"}

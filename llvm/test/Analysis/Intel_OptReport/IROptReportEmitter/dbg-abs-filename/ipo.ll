...
!0 = distinct !DICompileUnit(language: DW_LANG_C11, file: !1, producer: "clang based Intel(R) oneAPI DPC++/C++ Compiler 2024.0.0 (2024.0.0.YYYYMMDD)", isOptimized: true, flags: " --intel -flto=full -O3 -x CORE-AVX512 -qopt-report=2 -o iota ../src/iota.c /home/dwoodwor/opt-report-abs-filename/example/src/main.c -mllvm -print-before=intel-ir-optreport-emitter -mllvm -print-module-scope -qopt-report-file=stderr -fveclib=SVML -fheinous-gnu-extensions -dumpdir iota-", runtimeVersion: 0, emissionKind: LineTablesOnly, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "../src/iota.c", directory: "/home/dwoodwor/opt-report-abs-filename/example/build")
!2 = distinct !DICompileUnit(language: DW_LANG_C11, file: !3, producer: "clang based Intel(R) oneAPI DPC++/C++ Compiler 2024.0.0 (2024.0.0.YYYYMMDD)", isOptimized: true, flags: " --intel -flto=full -O3 -x CORE-AVX512 -qopt-report=2 -o iota ../src/iota.c /home/dwoodwor/opt-report-abs-filename/example/src/main.c -mllvm -print-before=intel-ir-optreport-emitter -mllvm -print-module-scope -qopt-report-file=stderr -fveclib=SVML -fheinous-gnu-extensions -dumpdir iota-", runtimeVersion: 0, emissionKind: LineTablesOnly, splitDebugInlining: false, nameTableKind: None)

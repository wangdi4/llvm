<<<<<<< HEAD
; RUN: opt < %s -aa-pipeline=tbaa -aa-eval -evaluate-aa-metadata -print-may-aliases -gvn 2>&1 | FileCheck %s
; RUN: opt < %s -aa-pipeline=tbaa -aa-eval -evaluate-aa-metadata -print-may-aliases -licm 2>&1 | FileCheck %s
=======
...
; CHECK: Function
; CHECK: MayAlias:  %0 = load float, float* getelementptr inbounds ([2 x float], [2 x float]* @c, i64 0, i64 0), align 16, !tbaa !2 <-> store float %call.i.i, float*     %arrayidx11, align 4, !tbaa !6

entry:
  call void @llvm.memset.p0i8.i64(i8* bitcast ([2 x float]* @c to i8*), i8 0, i64 8, i32 4, i1 false)
  store i32 1073741824, i32* bitcast ([2 x %"struct.std::complex"]* @a to i32*), align 8
  store i32 1077936128, i32* bitcast (float* getelementptr inbounds ([2 x %"struct.std::complex"], [2 x %"struct.std::complex"]* @a, i64 0, i64 0, i32 0, i32 1) to i32*), align 4
  store i32 1073741824, i32* bitcast (%"struct.std::complex"* getelementptr inbounds ([2 x %"struct.std::complex"], [2 x %"struct.std::complex"]* @a, i64 0, i64 1) to i32*), align 8
  store i32 1077936128, i32* bitcast (float* getelementptr inbounds ([2 x %"struct.std::complex"], [2 x %"struct.std::complex"]* @a, i64 0, i64 1, i32 0, i32 1) to i32*), align 4
  br label %for.body

for.cond.cleanup:                                ; preds = %for.body
  %0 = load float, float* getelementptr inbounds ([2 x float], [2 x float]* @c, i64 0, i64 0), align 16, !tbaa !2
  %conv.i = fpext float %0 to double
  ret double %conv.i

for.body:                                        ; preds = %entry, %for.body
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ]
  %_M_value.realp.i.i = getelementptr inbounds [2 x %"struct.std::complex"], [2 x %"struct.std::complex"]* @a, i64 0, i64 %indvars.iv, i32 0, i32 0
  %_M_value.real.i.i = load float, float* %_M_value.realp.i.i, align 8
  %_M_value.imagp.i.i = getelementptr inbounds [2 x %"struct.std::complex"], [2 x %"struct.std::complex"]* @a, i64 0, i64 %indvars.iv, i32 0, i32 1
  %_M_value.imag.i.i = load float, float* %_M_value.imagp.i.i, align 4
  ...
  %arrayidx11 = getelementptr inbounds [2 x float], [2 x float]* @c, i64 0, i64 %indvars.iv
  store float %call.i.i, float* %arrayidx11, align 4, !tbaa !6
...
; CHECK: Function
; CHECK: MayAlias: %0 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @ra, i64 0, i64 0), align 4, !tbaa !7 <->   store i32 %j.05, i32* %arrayidx, align 4, !tbaa !2  
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx = getelementptr inbounds [2 x i32], [2 x i32]* @ra, i64 0, i64 %idxprom
  store i32 %j.05, i32* %arrayidx, align 4, !tbaa !10
  %0 = load i32, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @ra, i64 0, i64 0), align 4, !tbaa !8
  %idxprom.i = zext i32 %0 to i64
  %arrayidx1.i = getelementptr inbounds [2 x i32], [2 x i32]* @ar, i64 0, i64 %idxprom.i
  %1 = load i32, i32* %arrayidx1.i, align 4, !tbaa !10

...
; CHECK:       Loop %for.body: Trip multiple is 3 ;INTEL
;
entry:
  %rem = urem i32 %num, 3
...
; CHECK-NEXT:  Loop %for.body: Predicated backedge-taken count is (-1 + %num)
; CHECK-NEXT:   Predicates:
; CHECK:       Loop %for.body: Trip multiple is 5 ;INTEL
;
entry:
  %rem = urem i32 %num, 5
  %cmp = icmp eq i32 %rem, 0
...
; CHECK-NEXT:  Loop %for.body: Predicated backedge-taken count is (-1 + %num)
; CHECK-NEXT:   Predicates:
; CHECK:       Loop %for.body: Trip multiple is 6 ;INTEL
;
entry:
  %rem = urem i32 %num, 6
  %cmp = icmp eq i32 %rem, 0
...
; CHECK-NEXT:  Loop %for.body: Predicated backedge-taken count is (-1 + %num)
; CHECK-NEXT:   Predicates:
; CHECK:       Loop %for.body: Trip multiple is 7 ;INTEL
;
entry:
  %rem = urem i32 %num, 7
  %cmp = icmp eq i32 %rem, 0
...
; CHECK-NEXT:  Loop %for.body: Predicated backedge-taken count is (-1 + %num)
; CHECK-NEXT:   Predicates:
; CHECK:       Loop %for.body: Trip multiple is 9 ;INTEL
;
entry:
  %rem = urem i32 %num, 9
  %cmp = icmp eq i32 %rem, 0
...
; CHECK-NEXT:  Loop %for.body: Predicated backedge-taken count is (-1 + %num)
; CHECK-NEXT:   Predicates:
; CHECK:       Loop %for.body: Trip multiple is 10 ;INTEL
;
entry:
  %rem = urem i32 %num, 10
  %cmp = icmp eq i32 %rem, 0

...
; RUN: opt < %s -analyze -bugpoint-enable-legacy-pm -scalar-evolution -scalar-evolution-print-scoped-mode -scalar-evolution-nowrap-user-tracking-threshold=1 | FileCheck %s --check-prefix=SCOPED-MODE-THRESHOLD

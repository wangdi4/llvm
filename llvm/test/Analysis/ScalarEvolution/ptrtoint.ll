...
; INTEL_CUSTOMIZATION
; Added <nuw><nsw> flags.
; X32-NEXT:    --> {(zext i32 (ptrtoint i8* %arg to i32) to i64),+,1}<nuw><%bb6> U: [0,8589934591) S: [0,8589934591) Exits: ((zext i32 (-1 + (-1 * (ptrtoint i8* %arg to i32)) + (ptrtoint i8* %arg1 to i32)) to i64) + (zext i32 (ptrtoint i8* %arg to i32) to i64))<nuw><nsw> LoopDispositions: { %bb6: Computable }
...
>>>>>>> cc19628ed7965ec9200e54a0118ab7ca7f8b31d6
...
; INTEL_CUSTOMIZATION
; Added <nuw><nsw> flags.
; X32-NEXT:    --> {(zext i32 (ptrtoint i32* %arg to i32) to i64),+,4}<nuw><%bb6> U: [0,8589934588) S: [0,8589934588) Exits: ((zext i32 (ptrtoint i32* %arg to i32) to i64) + (4 * ((zext i32 (-4 + (-1 * (ptrtoint i32* %arg to i32)) + (ptrtoint i32* %arg1 to i32)) to i64) /u 4))<nuw><nsw>)<nuw><nsw> LoopDispositions: { %bb6: Computable }
; END INTEL_CUSTOMIZATION
=======
; X32-NEXT:    %i9 = ptrtoint ptr %i7 to i64
...
; INTEL_CUSTOMIZATION
; use signum expansion for ashr
; X32-NEXT:    --> ({0,+,1}<nuw><%bb6> * (1 smin {0,+,4}<nuw><nsw><%bb6>))<nuw><nsw> U: [0,1073741824) S: [0,1073741824) Exits: (((zext i32 (-4 + (-1 * (ptrtoint i32* %arg to i32)) + (ptrtoint i32* %arg1 to i32)) to i64) /u 4) * (1 smin (4 * ((zext i32 (-4 + (-1 * (ptrtoint i32* %arg to i32)) + (ptrtoint i32* %arg1 to i32)) to i64) /u 4))<nuw><nsw>))<nuw><nsw> LoopDispositions: { %bb6: Computable }

...
; CHECK-NEXT:    --> %r U: [24,43) S: [24,43) ;INTEL
...
; INTEL_CUSTOMIZATION
; the exit value could be analyzed to @constant
; CHECK-NEXT:    --> %r U: [0,-3) S: [-9223372036854775808,9223372036854775805) Exits: <<Unknown>> LoopDispositions: { %loop: Variant } ;INTEL

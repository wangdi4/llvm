...
; INTEL_CUSTOMIZATION
; We expand "ashr exact" to the smax..smin expression below, when llorg
; would return SCEVUnknown. This is suppressed for HIR and IVUsers.
...
; CHECK-NEXT:    %ashr = ashr exact i64 %shl, 8
; CHECK-NEXT:    --> ((((256 + (64 * %a)) smax (-256 + (-64 * %a))) /u 256) * (1 smin (-1 smax (256 + (64 * %a)))))<nsw> U: [-72057594037927935,72057594037927936) S: [-72057594037927935,72057594037927936) ;INTEL

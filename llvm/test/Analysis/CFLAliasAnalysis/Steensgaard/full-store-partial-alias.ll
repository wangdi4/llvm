...
; INTEL
; RUN: opt -S < %s -convert-to-subscript | opt -S -disable-basicaa -tbaa -cfl-steens-aa -gvn | FileCheck -check-prefix=CFLSteensAA %s
; RUN: opt -S < %s -convert-to-subscript | opt -S -disable-basicaa -tbaa -gvn | FileCheck %s

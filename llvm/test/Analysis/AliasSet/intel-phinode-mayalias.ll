...
; CHECK-NEXT:   AliasSet[0x{{[0-9a-f]+}}, 2] may alias, Mod/Ref Pointers: (ptr %gc, LocationSize::precise(4)), (ptr %p.02, LocationSize::precise(4))

; CHECK-NOT: store i32 0, ptr null, align 4
...
for.cond:                                         ; preds = %for.end, %entry
  ...
  %p.0 = phi ptr [ null, %entry ], [ %arrayidx, %for.end ]
...
for.end:                                          ; preds = %for.cond1
  %arrayidx7 = getelementptr inbounds [3 x i32], ptr %gc, i64 0, i64 1
  %inc10 = add i32 %i.0, 1
  br label %for.cond

...
for.body:                                         ; preds = %for.body, %entry
  ...
  store i64 %indvars.iv54, ptr %arrayidx, align 4
...
for.body3:                                        ; preds = %barrier, %for.body3
  ...
  %arrayidx5 = getelementptr inbounds [10000 x i64], ptr %array, i64 0, i64 %indvars.iv51
  %val = load i64, ptr %arrayidx5, align 4

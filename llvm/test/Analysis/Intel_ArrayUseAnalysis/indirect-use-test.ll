...
entry:
  %array = alloca [10000 x ptr], align 16
  %0 = bitcast ptr %array to ptr
  br label %for.body

for.body:                                         ; preds = %for.body, %entry
  %indvars.iv47 = phi i64 [ 0, %entry ], [ %indvars.iv.next48, %for.body ]
  %call = call dereferenceable_or_null(8) ptr @malloc(i64 8)
  %arrayidx = getelementptr inbounds [10000 x ptr], ptr %array, i64 0, i64 %indvars.iv47
...
for.body5:                                        ; preds = %for.body5, %for.cond.cleanup
  ...
  %arrayidx7 = getelementptr inbounds [10000 x ptr], ptr %array, i64 0, i64 %indvars.iv43
  %2 = load ptr, ptr %arrayidx7, align 8
  %a = getelementptr inbounds %struct.example, ptr %2, i64 0, i32 0
  %3 = trunc i64 %indvars.iv43 to i32
  store i32 %3, ptr %a, align 4
  %b = getelementptr inbounds %struct.example, ptr %2, i64 0, i32 1
...
for.body17:                                       ; preds = %for.body17, %for.cond.cleanup4
  ...
  %arrayidx19 = getelementptr inbounds [10000 x ptr], ptr %array, i64 0, i64 %indvars.iv
  %5 = load ptr, ptr %arrayidx19, align 8
  %a20 = getelementptr inbounds %struct.example, ptr %5, i64 0, i32 0
  %6 = load i32, ptr %a20, align 4
  %b23 = getelementptr inbounds %struct.example, ptr %5, i64 0, i32 1
  %7 = load i32, ptr %b23, align 4
  %add = add nsw i32 %7, %6

...
; INTEL
; RUN: opt < %s -aa-pipeline=basic-aa -gvn -instcombine -S 2>&1 | FileCheck --check-prefix=CHECK-GEP %s
; RUN: opt -convert-to-subscript -S < %s | opt -aa-pipeline=basic-aa -gvn -instcombine -S 2>&1 | FileCheck %s

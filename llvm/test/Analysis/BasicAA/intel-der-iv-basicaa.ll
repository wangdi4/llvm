...
; CHECK: gepload = load i32, i32* %arrayIdx
; CHECK: store{{.*}}t4.0
; CHECK: gepload30 = load i32, i32* %arrayIdx
...
define dso_local [100 x i32]* @foo([100 x i32]* %f) local_unnamed_addr  {
entry:
...
loop.20:                                          ; preds = %loop.20.loop.20_crit_edge, %entry
  ...
  %arrayIdx = getelementptr inbounds [100 x i32], [100 x i32]* %f, i64 0, i64 %t2
  %gepload = load i32, i32* %arrayIdx, align 4
  store i32 %gepload, i32* %t4.0, align 4
  %gepload30 = load i32, i32* %arrayIdx, align 4
  %arrayIdx27 = getelementptr inbounds [100 x i32], [100 x i32]* %a, i64 0, i64 0
  store i32 %gepload30, i32* %arrayIdx27, align 4
  %t6 = add i64 %t2, 2
  %arrayIdx47 = getelementptr inbounds [100 x i32], [100 x i32]* %f, i64 0, i64 %t6

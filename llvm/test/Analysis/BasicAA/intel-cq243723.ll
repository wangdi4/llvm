...
%struct.matrix = type <{ ptr, i32, [4 x i8] }>

$_ZN6matrixmlERS_ = comdat any

; Function Attrs: noinline nounwind uwtable
define weak_odr void @_ZN6matrixmlERS_(ptr noalias nocapture sret(%struct.matrix) %agg.result, ptr nocapture readonly %this, ptr nocapture readonly dereferenceable(16) %y) #0 comdat align 2 {
entry:
  %row_size = getelementptr inbounds %struct.matrix, ptr %y, i64 0, i32 1
  %0 = load i32, ptr %row_size, align 4, !tbaa !1
  %conv.i = sext i32 %0 to i64
  %mul.i = shl nsw i64 %conv.i, 2
  %mul3.i = mul i64 %mul.i, %conv.i
  %call.i = tail call noalias ptr @malloc(i64 %mul3.i) #2
  %1 = bitcast ptr %agg.result to ptr
  store ptr %call.i, ptr %1, align 8, !tbaa !7
  tail call void @llvm.memset.p0i8.i64(ptr %call.i, i8 0, i64 %mul3.i, i32 4, i1 false) #2
  %row_size.i = getelementptr inbounds %struct.matrix, ptr %agg.result, i64 0, i32 1
  store i32 %0, ptr %row_size.i, align 4, !tbaa !1
  %cmp.61 = icmp sgt i32 %0, 0
  %2 = bitcast ptr %call.i to ptr
...
for.cond.2.preheader.lr.ph.split.us:              ; preds = %entry
  %ptr13 = getelementptr inbounds %struct.matrix, ptr %this, i64 0, i32 0
  %ptr18 = getelementptr inbounds %struct.matrix, ptr %y, i64 0, i32 0
  %3 = load ptr, ptr %ptr18, align 8, !tbaa !7
  %4 = load ptr, ptr %ptr13, align 8, !tbaa !7
...
for.body.9.lr.ph.us.us:                           ; preds = %for.body.5.lr.ph.split.us.us, %for.cond.cleanup.8.us.us
  ...
  %arrayidx.us.us = getelementptr inbounds float, ptr %2, i64 %5
  store float 0.000000e+00, ptr %arrayidx.us.us, align 4, !tbaa !8
  %arrayidx25.us.us = getelementptr inbounds float, ptr %2, i64 %5
...
for.body.9.us.us:                                 ; preds = %for.body.9.us.us, %for.body.9.lr.ph.us.us
  ...
  %arrayidx14.us.us = getelementptr inbounds float, ptr %4, i64 %7
  %8 = load float, ptr %arrayidx14.us.us, align 4, !tbaa !8
  %9 = mul nsw i64 %indvars.iv, %conv.i
  %10 = add nsw i64 %9, %indvars.iv96
  %arrayidx19.us.us = getelementptr inbounds float, ptr %3, i64 %10
  %11 = load float, ptr %arrayidx19.us.us, align 4, !tbaa !8
  %mul20.us.us = fmul float %8, %11
  %add26.us.us = fadd float %mul20.us.us, %6
  store float %add26.us.us, ptr %arrayidx25.us.us, align 4, !tbaa !8
...
; Function Attrs: nounwind
declare void @llvm.memset.p0i8.i64(ptr nocapture, i8, i64, i32, i1) #2

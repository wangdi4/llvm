...
define void @_Z3fooPA2_ii(ptr %A, i32 %n) #0 {
entry:
  br label %for.cond
...
; CHECK: NoAlias: i32* %arrayidx1, i32* %arrayidx4
  %arrayidx1 = getelementptr inbounds [2 x i32], ptr %A, i64 %idxprom, i64 2
  %0 = load i32, ptr %arrayidx1, align 4
  %add = add nsw i32 %0, 2
  store i32 %add, ptr %arrayidx1, align 4
  %idxprom2 = sext i32 %storemerge to i64
; A[i][0] += 2;
  %arrayidx4 = getelementptr inbounds [2 x i32], ptr %A, i64 %idxprom2, i64 0

...
for.cond.1.preheader:                             ; preds = %for.inc.20, %entry
  ...
  %mul = mul nuw nsw i64 %i.043, 6
  %mul12 = shl nsw i64 %i.043, 1
...
for.cond.4.preheader:                             ; preds = %for.inc.17, %for.cond.1.preheader
  ...
  %mul7 = shl i64 %j.042, 3
  %add = add nuw nsw i64 %mul7, %mul
  %add9 = add nuw nsw i64 %j.042, %i.043
  %mul13 = shl nsw i64 %j.042, 2
  %sub14 = sub nsw i64 %mul12, %mul13
  br label %for.body.6

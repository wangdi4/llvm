...
define dso_local void @foo(ptr noalias nocapture %p, ptr nocapture readonly %q, i64 %n, i64 %m) local_unnamed_addr #0 {
entry:
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %arrayidx = getelementptr inbounds i32, ptr %p, i64 %i.048
  store i32 %conv, ptr %arrayidx, align 4
  %arrayidx6 = getelementptr inbounds [100 x i32], ptr %q, i64 %i.048, i64 %i.048
  %0 = load i32, ptr %arrayidx6, align 4
  %add = add nsw i32 %0, 1
  %add7 = add nuw nsw i64 %i.048, 1
  %arrayidx8 = getelementptr inbounds i32, ptr %p, i64 %add7
...
for.body14:                                       ; preds = %for.body14.preheader, %for.body14
  ...
  %arrayidx16 = getelementptr inbounds i32, ptr %p, i64 %i9.049
  store i32 %conv15, ptr %arrayidx16, align 4
  %arrayidx18 = getelementptr inbounds [100 x i32], ptr %q, i64 %i9.049, i64 %i9.049
  %1 = load i32, ptr %arrayidx18, align 4
  %add19 = add nsw i32 %1, 1
  %add20 = add nuw nsw i64 %i9.049, 1
  %arrayidx21 = getelementptr inbounds i32, ptr %p, i64 %add20

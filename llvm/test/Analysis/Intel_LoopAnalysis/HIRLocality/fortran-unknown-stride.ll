...
; RUN: opt < %s -passes="hir-ssa-deconstruction,print<hir-locality-analysis>" -hir-spatial-locality -debug-only=hir-locality-analysis -hir-details-dims -disable-output 2>&1 | FileCheck %s
...
define void @func(ptr %ptr, i64 %stride, i64 %t) {
bb60:
  br label %bb64

bb64:                                             ; preds = %bb64, %bb60
  %iv = phi i64 [ %iv.next, %bb64 ], [ 1, %bb60 ]
  %sub0 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %stride, ptr elementtype(i32) %ptr, i64 %iv)
  %ld1 = load i32, ptr %sub0, align 4
  %add = add nsw i64 %iv, 1
  %sub.0 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %stride, ptr elementtype(i32) %ptr, i64 %add)
  %ld2 = load i32, ptr %sub.0, align 4

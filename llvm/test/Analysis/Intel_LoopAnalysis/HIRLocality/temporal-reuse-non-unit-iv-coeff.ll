...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx9 = getelementptr inbounds i32, ptr %A, i64 %5
  %6 = load i32, ptr %arrayidx9, align 4, !tbaa !2
  %add10 = add nsw i32 %add5, %6
  %arrayidx13 = getelementptr inbounds i32, ptr %A, i64 %0
  store i32 %add10, ptr %arrayidx13, align 4, !tbaa !2

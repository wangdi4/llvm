; RUN: opt < %s -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,print<hir-locality-analysis>" -vplan-force-vf=8 -hir-spatial-locality -disable-output  2>&1 | FileCheck %s
...
define dso_local float @f(i64 %n, ptr noalias nocapture readonly %A, ptr noalias nocapture readonly %B, ptr noalias nocapture %C) local_unnamed_addr #0 {
entry:
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  %0 = load float, ptr %C, align 4, !tbaa !2
  %sub = add nsw i64 %n, -1
  %ptridx7 = getelementptr inbounds float, ptr %C, i64 %sub
  %1 = load float, ptr %ptridx7, align 4, !tbaa !2
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %2 = load float, ptr %ptridx, align 4, !tbaa !2
  %ptridx3 = getelementptr inbounds float, ptr %B, i64 %indvars.iv
  %3 = load float, ptr %ptridx3, align 4, !tbaa !2
  %add = fadd fast float %3, %2
  %ptridx5 = getelementptr inbounds float, ptr %C, i64 %indvars.iv
  store float %add, ptr %ptridx5, align 4, !tbaa !2

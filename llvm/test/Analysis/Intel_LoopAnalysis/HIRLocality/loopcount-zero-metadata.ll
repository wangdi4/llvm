...
; Ensure that zero loopcount metadata does not break locality analysis.

; The C source for this test is:
;
;     void test1(float *P, int N) {
;       #pragma loop_count max=0
;       for (int I = 0; I < N; I++)
;         P[I] = I;
;     }

; Verify that the trip count is estimated to 1 based on 0 pragma value.

; CHECK: Locality Info for Loop level: 1     NumCacheLines: 1
...
!0 = distinct !{!0, !1}
!1 = !{!"llvm.loop.intel.loopcount_maximum", i32 0}

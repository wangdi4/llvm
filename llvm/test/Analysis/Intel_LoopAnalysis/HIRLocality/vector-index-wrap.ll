; RUN: opt < %s -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -VPlanDriverHIR -vplan-force-vf=4 -analyze -hir-locality-analysis -hir-spatial-locality | FileCheck %s
...
; CHECK: Locality Info for Loop level: 1     NumCacheLines: 2        SpatialCacheLines: 2     TempInvCacheLines: 0     AvgLvalStride: 5         AvgStride: 5

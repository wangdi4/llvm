...
; CHECK: (LINEAR ptr @obj)[i64 0].0[LINEAR i64 i1] inbounds !tbaa !1 {sb:[[BASE1:[0-9]+]]}
; CHECK-NOT: (LINEAR ptr @obj)[i64 0].1[LINEAR i64 i1] inbounds !tbaa !7 {sb:[[BASE1]]}
; CHECK: (LINEAR ptr @obj)[i64 0].1[LINEAR i64 i1] inbounds !tbaa !7 {sb:[[BASE2:[0-9]+]]}
...
define void @foo(i32 %n, ptr nocapture %p) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx = getelementptr inbounds %struct.S, ptr @obj, i64 0, i32 0, i64 %indvars.iv26
  %0 = trunc i64 %indvars.iv26 to i32
  store i32 %0, ptr %arrayidx, align 4, !tbaa !1
  %mul = shl nsw i32 %0, 1
  %add = or i32 %mul, 1
  %arrayidx2 = getelementptr inbounds %struct.S, ptr @obj, i64 0, i32 1, i64 %indvars.iv26
  store i32 %add, ptr %arrayidx2, align 4, !tbaa !7
...
for.body5:                                        ; preds = %for.body5.preheader, %for.body5
  ...
  %arrayidx7 = getelementptr inbounds i8, ptr %p, i64 %indvars.iv
  store i8 %conv, ptr %arrayidx7, align 1, !tbaa !8

; REQUIRES: asserts
; RUN: opt -passes="print<hir-framework>" -aa-pipeline=tbaa -disable-basic-aa -hir-framework-debug=symbase-assignment -debug-only=hir-framework < %s 2>&1 | FileCheck %s

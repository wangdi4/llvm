...
; RUN: opt -analyze -enable-new-pm=0 -hir-framework -hir-framework-debug=symbase-assignment -debug-only=hir-framework -scoped-noalias-aa < %s 2>&1 | FileCheck -check-prefix=NOALIAS %s

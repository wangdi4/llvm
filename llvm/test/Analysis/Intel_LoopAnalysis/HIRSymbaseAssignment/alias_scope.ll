...
; RUN: opt -passes="print<hir-framework>" -aa-pipeline=basic-aa,scoped-noalias-aa -hir-framework-debug=symbase-assignment -debug-only=hir-framework < %s 2>&1 | FileCheck -check-prefix=NOALIAS %s

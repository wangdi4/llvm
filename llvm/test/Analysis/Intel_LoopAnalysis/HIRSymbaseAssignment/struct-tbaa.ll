...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %arrayidx = getelementptr inbounds %struct.S, ptr @obj, i64 0, i32 0, i64 %indvars.iv
  %0 = trunc i64 %indvars.iv to i32
  store i32 %0, ptr %arrayidx, align 4, !tbaa !1
  %1 = trunc i64 %indvars.iv to i32
  %mul = shl nsw i32 %1, 1
  %add = or i32 %mul, 1
  %arrayidx2 = getelementptr inbounds %struct.S, ptr @obj, i64 0, i32 1, i64 %indvars.iv

; RUN: opt < %s -loop-simplify -hir-ssa-deconstruction | opt -analyze -anders-aa -hir-symbase-assignment | FileCheck %s
...
@A = internal unnamed_addr global i32* null, align 8
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds i32, i32* %bb, i64 %j.08
  %0 = load i32, i32* %arrayidx, align 4
  %arrayidx2 = getelementptr inbounds i32, i32* %aa, i64 %j.08
...
for.end:                                          ; preds = %for.body
  ...
  %arrayidx3 = getelementptr inbounds i32, i32* %1, i64 2

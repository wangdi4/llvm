; RUN: opt < %s -analyze -hir-region-identification -xmain-opt-level=3 | FileCheck %s --check-prefix=O3
; RUN: opt < %s -analyze -hir-region-identification -hir-cost-model-throttling=0 | FileCheck %s --check-prefix=ALL

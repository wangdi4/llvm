...
; RUN: opt < %s -opaque-pointers -analyze -hir-region-identification | FileCheck %s
...
; RUN: opt < %s -opaque-pointers -analyze -hir-region-identification -hir-region-inst-threshold=1 | FileCheck %s --check-prefix=INST-THRESHOLD

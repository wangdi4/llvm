...
define dso_local void @_Z14inner_product2PiS_S_iii(ptr noundef %A_mem, ptr noundef %B_mem, i64 %conv27, i64 %mul19, i64 %mul28, i64 %wide.trip.count246) {
entry:
...
for.body14:                                       ; preds = %for.body14, %entry
  ...
  %A_mem18 = getelementptr inbounds i32, ptr %A_mem, i64 %t11
  %t13 = tail call x86_amx @llvm.x86.tileloadd64.internal(i16 16, i16 64, ptr %A_mem18, i64 %mul19) #2
  %t14 = mul nsw i64 %t11, %conv27
  %A_mem26 = getelementptr inbounds i32, ptr %B_mem, i64 %t14
  %t16 = tail call x86_amx @llvm.x86.tileloadd64.internal(i16 16, i16 64, ptr %A_mem26, i64 %mul28) #2

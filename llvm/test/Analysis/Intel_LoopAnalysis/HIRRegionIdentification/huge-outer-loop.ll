...
@p = external dso_local local_unnamed_addr global ptr, align 8

; Function Attrs: nofree norecurse nounwind uwtable
define dso_local i32 @main() local_unnamed_addr {
entry:
  %0 = load i64, ptr @x, align 8, !tbaa !2
  %1 = load i64, ptr @y, align 8, !tbaa !2
  %2 = load i64, ptr @z, align 8, !tbaa !2
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %arrayidx = getelementptr inbounds [100 x i64], ptr @a, i64 0, i64 %add, !intel-tbaa !6
  %3 = load i64, ptr %arrayidx, align 8, !tbaa !6
  %add4 = add nsw i64 %3, %0
  store i64 %add4, ptr %arrayidx, align 8, !tbaa !6
...
for.body7:                                        ; preds = %for.body7.preheader, %for.body7
  ...
  %arrayidx8 = getelementptr inbounds [100 x i64], ptr @a, i64 0, i64 %sub, !intel-tbaa !6
  %4 = load i64, ptr %arrayidx8, align 8, !tbaa !6
  %sub9 = sub nsw i64 %4, %1
  store i64 %sub9, ptr %arrayidx8, align 8, !tbaa !6
...
for.body15:                                       ; preds = %for.body15.preheader, %for.body15
  ...
  %arrayidx17 = getelementptr inbounds [100 x i64], ptr @a, i64 0, i64 %add16, !intel-tbaa !6
  %5 = load i64, ptr %arrayidx17, align 8, !tbaa !6
  %add18 = add nsw i64 %5, %2
  store i64 %add18, ptr %arrayidx17, align 8, !tbaa !6
...
for.body24:                                       ; preds = %for.body24.preheader, %for.body24
  ...
  %arrayidx26 = getelementptr inbounds [100 x i64], ptr @a, i64 0, i64 %sub25, !intel-tbaa !6
  %6 = load i64, ptr %arrayidx26, align 8, !tbaa !6
  %sub27 = sub nsw i64 %6, %0
  store i64 %sub27, ptr %arrayidx26, align 8, !tbaa !6
...
for.body33:                                       ; preds = %for.body33.preheader, %for.body33
  ...
  %arrayidx35 = getelementptr inbounds [100 x i64], ptr @a, i64 0, i64 %add34, !intel-tbaa !6
  %7 = load i64, ptr %arrayidx35, align 8, !tbaa !6
  %add36 = add nsw i64 %7, %1
  store i64 %add36, ptr %arrayidx35, align 8, !tbaa !6
...
for.end39:                                        ; preds = %for.body33
  %arrayidx40 = getelementptr inbounds [100 x i64], ptr @a, i64 0, i64 %i.081, !intel-tbaa !6
  %8 = load i64, ptr %arrayidx40, align 8, !tbaa !6
  %9 = load ptr, ptr @p, align 8, !tbaa !8
  %add.ptr = getelementptr inbounds i8, ptr %9, i64 %8, !intel-tbaa !10
  br label %while.cond

while.cond:                                       ; preds = %while.cond, %for.end39
  %storemerge = phi ptr [ %add.ptr, %for.end39 ], [ %incdec.ptr, %while.cond ]
  store ptr %storemerge, ptr @p, align 8, !tbaa !8
  %10 = load i8, ptr %storemerge, align 1, !tbaa !10

...
define i8* @dot_dec(i32 %ip) local_unnamed_addr {
entry:
  %tmpbuf.i = alloca [12 x i8], align 1
  %0 = load i32, i32* @dot_dec.nxt, align 4
  %mul = shl nsw i32 %0, 4
  %add.ptr = getelementptr inbounds [256 x i8], [256 x i8]* @dot_dec.bufs, i32 0, i32 %mul
  %cmp = icmp eq i32 %0, 15
  %add = add nsw i32 %0, 1
  %.add = select i1 %cmp, i32 0, i32 %add
  store i32 %.add, i32* @dot_dec.nxt, align 4
  %shr = lshr i32 %ip, 24
...
do.body.i:                                        ; preds = %do.body.i, %entry
  ...
  %cptr.0.i = phi i8* [ %1, %entry ], [ %incdec.ptr.i, %do.body.i ]
  %rem.i = urem i32 %x.addr.0.i, 10
  %arrayidx.i = getelementptr inbounds [11 x i8], [11 x i8]* @.str.5, i32 0, i32 %rem.i
  %2 = load i8, i8* %arrayidx.i, align 1
  %incdec.ptr.i = getelementptr inbounds i8, i8* %cptr.0.i, i32 1
  store i8 %2, i8* %cptr.0.i, align 1
...
while.body.i:                                     ; preds = %while.body.i.preheader, %while.body.i
  %4 = phi i8* [ %incdec.ptr3.i, %while.body.i ], [ %add.ptr, %while.body.i.preheader ]
  %cptr.1.i79 = phi i8* [ %incdec.ptr2.i, %while.body.i ], [ %incdec.ptr.i.lcssa, %while.body.i.preheader ]
  %n.1.i78 = phi i32 [ %dec.i, %while.body.i ], [ %inc.i.lcssa, %while.body.i.preheader ]
  %dec.i = add nsw i32 %n.1.i78, -1
  %incdec.ptr2.i = getelementptr inbounds i8, i8* %cptr.1.i79, i32 -1
  %5 = load i8, i8* %incdec.ptr2.i, align 1
  %incdec.ptr3.i = getelementptr inbounds i8, i8* %4, i32 1

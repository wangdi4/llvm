...
define hidden void @x_solve.DIR.OMP.DISTRIBUTE.PARLOOP.5.split168.split(ptr nocapture readonly %tid, ptr nocapture readnone %bid, ptr noalias nocapture readonly %gp12.addr.fpriv, ptr noalias nocapture readonly %isize.addr.fpriv, ptr noalias nocapture %lhsX, i64 %.omp.lb.priv.val.zext, i64 %.omp.ub.priv.val) #2 {
DIR.OMP.DISTRIBUTE.PARLOOP.8:
  ...
  %gp12.addr.fpriv.v = load i32, ptr %gp12.addr.fpriv, align 4
  %isize.addr.fpriv.v = load i32, ptr %isize.addr.fpriv, align 4
...
omp.inner.for.body.lr.ph:                         ; preds = %DIR.OMP.DISTRIBUTE.PARLOOP.8
  ...
  call void @__kmpc_dist_for_static_init_4(ptr nonnull @.kmpc_loc.0.0, i32 %my.tid, i32 34, ptr nonnull %is.last, ptr nonnull %lower.bnd, ptr nonnull %upper.bnd, ptr nonnull %upperD, ptr nonnull %stride, i32 1, i32 1) #0
...
loop.region.exit:                                 ; preds = %loop.region.exit.loopexit, %omp.inner.for.body.lr.ph
  call void @__kmpc_for_static_fini(ptr nonnull @.kmpc_loc.0.0.2, i32 %my.tid) #0
...
omp.inner.for.body13.lr.ph:                       ; preds = %omp.inner.for.body
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.LINEAR:IV"(ptr %j.priv.linear.iv, i32 1), "QUAL.OMP.NORMALIZED.IV"(ptr null), "QUAL.OMP.NORMALIZED.UB"(ptr null) ]
...
omp.inner.for.body13:                             ; preds = %omp.inner.for.body13, %omp.inner.for.body13.lr.ph
  ...
  %arrayidx21 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 0, i64 0, i64 1, i64 0, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx21, align 8
  %arrayidx30 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 0, i64 0, i64 1, i64 %idxprom25, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx30, align 8
  %arrayidx38 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 1, i64 1, i64 1, i64 0, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx38, align 8
  %arrayidx47 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 1, i64 1, i64 1, i64 %idxprom25, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx47, align 8
  %arrayidx55 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 2, i64 2, i64 1, i64 0, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx55, align 8
  %arrayidx64 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 2, i64 2, i64 1, i64 %idxprom25, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx64, align 8
  %arrayidx72 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 3, i64 3, i64 1, i64 0, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx72, align 8
  %arrayidx81 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 3, i64 3, i64 1, i64 %idxprom25, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx81, align 8
  %arrayidx89 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 4, i64 4, i64 1, i64 0, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx89, align 8
  %arrayidx98 = getelementptr inbounds [5 x [5 x [3 x [102 x [101 x [101 x double]]]]]], ptr %lhsX, i64 0, i64 4, i64 4, i64 1, i64 %idxprom25, i64 %indvars.iv.next, i64 %indvars.iv.next20
  store double 1.000000e+00, ptr %arrayidx98, align 8
...
omp.inner.for.cond11.omp.loop.exit.split.loopexit_crit_edge: ; preds = %omp.inner.for.body13
  store i32 %add100, ptr %j.priv.linear.iv, align 4

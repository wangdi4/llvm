; RUN: opt < %s -hir-ssa-deconstruction -hir-cost-model-throttling=0 | opt -analyze -hir-framework -hir-cost-model-throttling=0 | FileCheck %s
...
%struct.wobble = type { i64, i32, %struct.wobble*, %struct.wobble*, %struct.wobble*, %struct.wobble*, %struct.snork*, %struct.snork*, %struct.snork*, %struct.snork*, i64, i64, i32, i32 }
...
bb123:                                            ; preds = %bb143, %bb121
  %tmp = phi %struct.wobble* [ %tmp137, %bb143 ], [ undef, %bb121 ]
  br label %bb124
...
bb132:                                            ; preds = %bb129, %bb124
  ...
  %tmp134 = load %struct.wobble*, %struct.wobble** %tmp133, align 8
  %tmp135 = icmp eq %struct.wobble* %tmp134, undef
  br i1 %tmp135, label %bb145, label %bb124

bb136:                                            ; preds = %bb124
  %tmp137 = phi %struct.wobble* [ %tmp125, %bb124 ]
  br label %bb143

bb143:                                            ; preds = %bb136
  %tmp144 = icmp eq %struct.wobble* %tmp137, undef

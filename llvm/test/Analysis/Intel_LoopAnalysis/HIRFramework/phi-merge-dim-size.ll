...
define void @foo(ptr %ptr1, ptr %ptr2, i64 %n, i64 %t) {
entry:
  %cmp1 = icmp slt i64 %t, 5
  br i1 %cmp1, label %then, label %else

then:
  %p.0 = getelementptr inbounds [10 x i32], ptr %ptr1, i64 0, i64 0
  br label %for.body.preheader

else:
  %p.1 = getelementptr inbounds [25 x i32], ptr %ptr2, i64 0, i64 0
  br label %for.body.preheader

for.body.preheader:                               ; preds = %then, %else
  %p = phi ptr [ %p.0, %then ], [ %p.1, %else ]
  br label %for.body

; RUN: opt < %s -disable-output -passes="hir-ssa-deconstruction,print<hir>" 2>&1  | FileCheck %s --check-prefix=CHECK-HIR
...
bb5:                                            ; preds = %bb5, %alloca
  ...
  %pR = call ptr @llvm.intel.subscript.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(%complex_64bit) @pR, i64 %int_sext17)
  ...
  store %complex_64bit %insertval10, ptr %pR

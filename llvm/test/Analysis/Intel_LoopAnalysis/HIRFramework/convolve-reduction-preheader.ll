...
define dso_local double @foo(ptr nocapture readonly %pix1, ptr nocapture readonly %pix2, ptr nocapture readonly %mul_ptr, i32 %n) local_unnamed_addr #0 {
entry:
...
for.cond4.preheader.preheader:                    ; preds = %for.cond1.preheader.lr.ph, %for.inc103
  ...
  %mul = load double, ptr %mul_ptr, align 8

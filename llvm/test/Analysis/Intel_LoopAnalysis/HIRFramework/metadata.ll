; RUN: opt -hir-ssa-deconstruction -analyze -hir-framework -hir-details -enable-new-pm=0 < %s 2>&1 | FileCheck %s
...
!0 = !{!"clang version 3.7.0 (trunk 814) (llvm/branches/loopopt 832)"}
!1 = !{!2, !2, i64 0}
!2 = !{!"float", !3, i64 0}

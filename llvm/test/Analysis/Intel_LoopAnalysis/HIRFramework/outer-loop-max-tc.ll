...
; CHECK: + DO i1 = 0, %n + -1, 1   <DO_LOOP>  <MAX_TC_EST = 21>
; CHECK: |   + DO i2 = 0, 19, 1   <DO_LOOP>
; CHECK: |   |   (@A)[0][i1 + i2] = i1 + i2;
; CHECK: |   + END LOOP
; CHECK: + END LOOP

; ModuleID = 'outer-max-tc.ll'
source_filename = "outer-max-tc.c"
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %arrayidx = getelementptr inbounds [40 x i64], ptr @A, i64 0, i64 %add

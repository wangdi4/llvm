...
entry:
  ...
  %0 = bitcast ptr %v_icp to ptr
  call void @llvm.lifetime.start(i64 4, ptr %0) #6
  %1 = load i32, ptr @g_er, align 4, !tbaa !1
  %2 = load i32, ptr @g_eqw, align 4, !tbaa !1
  %or = or i32 %2, %1
  store i32 %or, ptr %v_icp, align 4, !tbaa !1
  store i32 63, ptr @g_eqw, align 4, !tbaa !1
...
for.body42.lr.ph:                                 ; preds = %sw.bb
  ...
  %arrayidx82 = getelementptr inbounds [192 x i32], ptr @a1_w, i64 0, i64 %indvars.iv310
...
for.body42.us.preheader:                          ; preds = %for.body42.lr.ph
  %9 = load i16, ptr @g_pr, align 2, !tbaa !5
...
if.then75.us:                                     ; preds = %for.body42.us
  %10 = load i32, ptr %arrayidx82, align 4, !tbaa !7
  %xor83.us = xor i32 %10, 6
  store i32 %xor83.us, ptr %arrayidx82, align 4, !tbaa !7
  br label %if.end99.us

if.else.us:                                       ; preds = %for.body42.us
  %sub84.us = sub i64 185, %v_yo.0285.us
  %arrayidx85.us = getelementptr inbounds [192 x i32], ptr @a1_w, i64 0, i64 %sub84.us
  %11 = load i32, ptr %arrayidx85.us, align 4, !tbaa !7
  %add86.us = add i32 %11, %8
  store i32 %add86.us, ptr %arrayidx85.us, align 4, !tbaa !7
  br label %if.end99.us
...
for.body42:                                       ; preds = %for.body42.preheader, %if.end99
  ...
  call void @_Z4swapRjS_(ptr nonnull dereferenceable(4) %v_icp, ptr nonnull dereferenceable(4) %v_icp)
  %12 = load i16, ptr @g_pr, align 2, !tbaa !5
  %tobool74 = icmp eq i16 %12, 0
  br i1 %tobool74, label %if.else, label %if.then75

if.then75:                                        ; preds = %for.body42
  %13 = load i32, ptr %arrayidx82, align 4, !tbaa !7
  %xor83 = xor i32 %13, 6
  store i32 %xor83, ptr %arrayidx82, align 4, !tbaa !7
  br label %if.end99

if.else:                                          ; preds = %for.body42
  %sub84 = sub i64 185, %v_yo.0285
  %arrayidx85 = getelementptr inbounds [192 x i32], ptr @a1_w, i64 0, i64 %sub84
  %14 = load i32, ptr %arrayidx85, align 4, !tbaa !7
  %add86 = add i32 %14, %8
  store i32 %add86, ptr %arrayidx85, align 4, !tbaa !7
  br label %if.end99
...
for.end103.loopexit296:                           ; preds = %if.end99
  ...
  %.pre317 = load i32, ptr @g_eqw, align 4, !tbaa !1
  br label %for.end103
...
for.end103:                                       ; preds = %for.end103.loopexit, %for.end103.loopexit296, %sw.bb
  ...
  %arrayidx109 = getelementptr inbounds [192 x [192 x i32]], ptr @a2_z, i64 0, i64 %idxprom107, i64 %7
  %18 = load i32, ptr %arrayidx109, align 4, !tbaa !9
  %arrayidx111 = getelementptr inbounds [192 x i16], ptr @a1_awoie, i64 0, i64 %idxprom107
  %19 = load i16, ptr %arrayidx111, align 2, !tbaa !11
  %conv112 = zext i16 %19 to i32
  %and113 = and i32 %conv112, %18
  %conv114 = trunc i32 %and113 to i16
  store i16 %conv114, ptr %arrayidx111, align 2, !tbaa !11
  %mul115 = mul i32 %v_mcnxqlr.0.lcssa, 68
  br label %if.end128

sw.default:                                       ; preds = %for.body16
  call void @_Z6printbj(i32 %v_jq.0291)
  %20 = load i32, ptr @g_er, align 4, !tbaa !1
  %21 = trunc i64 %indvars.iv310 to i32
  %or124 = or i32 %20, %21
  store i32 %or124, ptr @g_er, align 4, !tbaa !1
  br label %if.end128
...
if.end128:                                        ; preds = %for.body16, %sw.default, %for.end103
  ...
  %22 = load i32, ptr %v_icp, align 4, !tbaa !1
  ...
  %arrayidx134 = getelementptr inbounds [192 x i16], ptr @a1_awoie, i64 0, i64 %24
  %25 = load i16, ptr %arrayidx134, align 2, !tbaa !11
  %conv135 = zext i16 %25 to i64
  %and136 = and i64 %conv135, %add130
  %conv137 = trunc i64 %and136 to i16
  store i16 %conv137, ptr %arrayidx134, align 2, !tbaa !11
...
if.end128.for.body16_crit_edge:                   ; preds = %if.end128
  ...
  %.pre = load i32, ptr @g_er, align 4, !tbaa !1
  %.pre315 = load i32, ptr @g_eqw, align 4, !tbaa !1
  br label %for.body16

for.end139:                                       ; preds = %if.end128
  store i32 42, ptr @g_er, align 4, !tbaa !1
  %26 = load i32, ptr @g_eqw, align 4, !tbaa !1
  %dec141 = add i32 %26, -1
  store i32 %dec141, ptr @g_eqw, align 4, !tbaa !1
  %cmp = icmp ugt i32 %dec141, 28
  br i1 %cmp, label %for.cond2.preheader, label %for.end142

for.end142:                                       ; preds = %for.end139
  store i32 10, ptr @g_er, align 4, !tbaa !1
  %27 = load i32, ptr %v_icp, align 4, !tbaa !1
  call void @_Z6printbj(i32 %27)
  %28 = load i32, ptr @g_eqw, align 4, !tbaa !1
  call void @_Z6printbj(i32 %28)
  %29 = load i16, ptr @g_pr, align 2, !tbaa !5
  call void @_Z6printbt(i16 zeroext %29)
  %30 = load i32, ptr @g_er, align 4, !tbaa !1
...
for.body146:                                      ; preds = %for.end142, %for.body146
  ...
  %arrayidx148 = getelementptr inbounds [192 x i32], ptr @a1_w, i64 0, i64 %indvars.iv301
  %31 = load i32, ptr %arrayidx148, align 4, !tbaa !7
...
for.body157:                                      ; preds = %for.body157.preheader, %for.body157
  ...
  %arrayidx159 = getelementptr inbounds [192 x i16], ptr @a1_awoie, i64 0, i64 %indvars.iv299
  %32 = load i16, ptr %arrayidx159, align 2, !tbaa !11
...
for.cond.cleanup166:                              ; preds = %for.cond.cleanup171
  ...
  call void @llvm.lifetime.end(i64 4, ptr %0) #6
  ret i32 0
...
for.body172:                                      ; preds = %for.cond169.preheader, %for.body172
  ...
  %arrayidx176 = getelementptr inbounds [192 x [192 x i32]], ptr @a2_z, i64 0, i64 %indvars.iv297, i64 %indvars.iv
  %33 = load i32, ptr %arrayidx176, align 4, !tbaa !9

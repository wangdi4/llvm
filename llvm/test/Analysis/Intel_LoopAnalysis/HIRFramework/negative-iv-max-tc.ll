...
bb520:                                            ; preds = %bb546, %bb516
  ...
  %i525 = call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 2000, double* nonnull %i14, i64 %i521)
  %i526 = call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* nonnull %i525, i64 %i518)
...
bb531:                                            ; preds = %bb531, %bb530
  ...
  %i535 = call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* nonnull %i30, i64 %i534)
  %i536 = load double, double* %i535, align 1
  %i537 = call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* nonnull %i525, i64 %i533)
...
bb546:                                            ; preds = %bb544, %bb520
  ...
  %i550 = call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* nonnull %i30, i64 %i528)

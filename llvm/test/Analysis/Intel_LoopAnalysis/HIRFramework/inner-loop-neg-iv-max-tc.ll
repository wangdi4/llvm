...
; CHECK: |   + DO i2 = 0, %n + -1, 1   <DO_LOOP>  <MAX_TC_EST = 10>
; CHECK: |   |   {al:8}(@A)[0][i1 + -1 * i2] = i1;
; CHECK: |   + END LOOP
; CHECK: + END LOOP


; ModuleID = 'inner-loop-neg-iv-max-tc.ll'
source_filename = "max-tc2.c"

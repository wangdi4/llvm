...
; RUN: opt < %s -hir-ssa-deconstruction -hir-complete-unroll -print-after=hir-complete-unroll -hir-details-framework 2>&1 -S | FileCheck %s

; CHECK: BEGIN REGION 
; CHECK: EntryBB 
; CHECK: DO i1 = 0

; RUN: opt < %s -hir-ssa-deconstruction -hir-complete-unroll -print-after=hir-complete-unroll 2>&1 -S | FileCheck --check-prefix=REG-CHECK %s
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %for.body.preheader ], !in.de.ssa !1
  ...
  %indvars.iv.in = bitcast i64 %indvars.iv.next to i64, !in.de.ssa !1
...
!0 = !{!"clang version 4.0.0 (trunk 20398) (llvm/branches/loopopt 20472)"}
!1 = !{!"indvars.iv.de.ssa"}
!2 = !{!3, !3, i64 0}
!3 = !{!"int", !4, i64 0}

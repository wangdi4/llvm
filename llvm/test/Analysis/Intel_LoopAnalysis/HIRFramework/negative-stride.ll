...
loop.outer:                             ; preds = %entry, %loop_exit6
  ...
  %"subn_$B.addr_a0$_fetch.1[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 80, ptr elementtype(float) %ptr, i64 %iv.outer)
  br label %loop_body5

loop_body5:                                       ; preds = %loop.outer, %loop_body5
  %iv.inner = phi i64 [ 1, %loop.outer ], [ %add.7, %loop_body5 ]
  %"subn_$B.addr_a0$_fetch.1[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 -4, ptr elementtype(float) %"subn_$B.addr_a0$_fetch.1[]", i64 %iv.inner)
  store float 1.000000e+00, ptr %"subn_$B.addr_a0$_fetch.1[][]", align 1

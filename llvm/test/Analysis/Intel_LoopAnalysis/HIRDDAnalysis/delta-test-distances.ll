...
bb4:                                              ; preds = %bb4, %alloca_0
  ...
  %A_ = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul, ptr elementtype(float) %A, i64 %indvars.iv)
  %A__ = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(float) %A_, i64 %indvars.iv)
  ...
  %A16_ = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul, ptr elementtype(float) %A, i64 %1)
  %A16__ = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(float) %A16_, i64 %0)
  store float %add5, ptr %A16__, align 1

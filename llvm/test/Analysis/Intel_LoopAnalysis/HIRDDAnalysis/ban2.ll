...
; RUN: opt < %s -passes="loop-simplify,hir-ssa-deconstruction,print<hir-dd-analysis>" -hir-dd-test-skip-lin-refs-test -hir-dd-analysis-verify=Region -disable-output 2>&1 | FileCheck %s

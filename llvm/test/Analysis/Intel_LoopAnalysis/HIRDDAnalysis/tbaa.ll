; Check that TBAA removes egdes that do not alias. There are three vars int *%x, ptr %y, char *%z.
...
define i32 @foo(ptr nocapture %x, ptr nocapture readonly %y, ptr nocapture %z) #0 {
entry:
  br label %for.body
...
for.body:                                         ; preds = %for.body, %entry
  ...
  store i8 %conv3, ptr %z, align 1, !tbaa !7

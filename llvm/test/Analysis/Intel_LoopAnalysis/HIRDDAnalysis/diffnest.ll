...
for.body4.preheader:                              ; preds = %for.end, %entry
  ...
  %arrayidx = getelementptr inbounds [100 x i32], ptr @yy, i64 0, i64 %0
...
for.body4:                                        ; preds = %for.body4, %for.body4.preheader
  ...
  %arrayidx6 = getelementptr inbounds [100 x i32], ptr @xk, i64 0, i64 %2
  %3 = load i32, ptr %arrayidx6, align 4, !tbaa !1
  %sub7 = sub nsw i32 0, %3
  %indvars.iv.next37 = add nuw nsw i64 %indvars.iv36, 1
  %arrayidx10 = getelementptr inbounds [100 x i32], ptr @yy, i64 0, i64 %indvars.iv.next37
  store i32 %sub7, ptr %arrayidx10, align 4, !tbaa !1
...
for.end:                                          ; preds = %for.body4
  %arrayidx12 = getelementptr inbounds [100 x i32], ptr @yy, i64 0, i64 %indvars.iv39
  %4 = load i32, ptr %arrayidx12, align 4, !tbaa !1
  %add13 = add nsw i32 %4, 1
  %indvars.iv.next40 = add nsw i64 %indvars.iv39, -1
  %arrayidx16 = getelementptr inbounds [100 x i32], ptr @xk, i64 0, i64 %indvars.iv.next40
  store i32 %add13, ptr %arrayidx16, align 4, !tbaa !1
  %cmp = icmp sgt i64 %indvars.iv.next40, 1
  br i1 %cmp, label %for.body4.preheader, label %for.end18

for.end18:                                        ; preds = %for.end
  %5 = load i32, ptr getelementptr inbounds ([100 x i32], ptr @xk, i64 0, i64 10), align 8, !tbaa !1

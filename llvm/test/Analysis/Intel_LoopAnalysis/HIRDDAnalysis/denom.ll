...
define i32 @foo(ptr nocapture %p, i32 %n) local_unnamed_addr #0 {
entry:
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  ...
  %arrayidx2 = getelementptr inbounds float, ptr %p, i64 %i.0.lcssa
  %0 = load float, ptr %arrayidx2, align 4, !tbaa !1

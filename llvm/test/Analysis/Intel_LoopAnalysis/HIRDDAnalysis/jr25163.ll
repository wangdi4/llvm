...
for.body8.lr.ph:                                  ; preds = %for.body3
  %arrayidx = getelementptr inbounds [20 x i8], ptr @e, i64 0, i64 %indvars.iv
  br label %for.body8
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %for.body3
  %arrayidx19 = getelementptr inbounds [20 x i32], ptr @i, i64 0, i64 %indvars.iv
...
for.body8:                                        ; preds = %for.body8.lr.ph, %for.body8
  ...
  %arrayidx13 = getelementptr inbounds [20 x i8], ptr @e, i64 0, i64 %indvars.iv32

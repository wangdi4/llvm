...
; RUN: opt -scoped-noalias-aa -hir-ssa-deconstruction -hir-runtime-dd -hir-vec-dir-insert -hir-vplan-vec  -print-after=hir-vplan-vec -vplan-force-vf=1 < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-runtime-dd,hir-vec-dir-insert,hir-vplan-vec,print<hir>" -disable-output -vplan-force-vf=1 < %s 2>&1 | FileCheck %s

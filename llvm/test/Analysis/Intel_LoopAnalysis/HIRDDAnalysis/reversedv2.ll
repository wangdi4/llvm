...
for.body.6:                                       ; preds = %for.body.6, %for.cond.4.preheader
  ...
  %arrayidx8 = getelementptr inbounds [10000 x [100 x i64]], ptr @p, i64 0, i64 %sub, i64 %k.041
  store i64 1, ptr %arrayidx8, align 8, !tbaa !1
  %sub9 = add nsw i64 %k.041, -1
  %arrayidx13 = getelementptr inbounds [10000 x [100 x i64]], ptr @p, i64 0, i64 %add, i64 %sub9
  %0 = load i64, ptr %arrayidx13, align 8, !tbaa !1
  %add15 = add nuw nsw i64 %add14, %k.041
  %arrayidx16 = getelementptr inbounds [100000 x i64], ptr @q, i64 0, i64 %add15
  store i64 %0, ptr %arrayidx16, align 8, !tbaa !1

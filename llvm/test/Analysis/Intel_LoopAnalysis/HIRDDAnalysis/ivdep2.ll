...
;    B[i] = A[i+m] + 1;
; }
; Test case for ivdep using option hir-assume-ivdep-innermost-loop
; expecting dv (=) for all of them
; except the the one with constant distance
;
; RUN: opt < %s -hir-ssa-deconstruction | opt -hir-dd-analysis -hir-assume-ivdep-innermost-loop -hir-dd-analysis-verify=Region -analyze -enable-new-pm=0 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,print<hir-dd-analysis>" -hir-dd-analysis-verify=Region -hir-assume-ivdep-innermost-loop  -disable-output 2>&1 < %s | FileCheck %s
;
...
;
;Module Before HIR; ModuleID = 'ivdep2.c'
source_filename = "ivdep2.c"
...
!1 = !{!"clang version 7.0.0 (ssh://git-amr-2.devtools.intel.com:29418/dpd_icl-clang 7277ef25cac670b925c89fab076a39a389835fc5) (ssh://git-amr-2.devtools.intel.com:29418/dpd_icl-llvm f44e54d66cb460ff52d3cbb4adf6de2113cc0f93)"}
!2 = !{!3, !3, i64 0}
!3 = !{!"float", !4, i64 0}

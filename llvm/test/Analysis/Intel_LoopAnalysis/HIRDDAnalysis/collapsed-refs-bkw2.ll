...
; dependency during loop collapsing. In this case distance
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %arrayidx13 = getelementptr inbounds [9 x [4 x i64]], ptr %array, i64 0, i64 %add2, i64 %indvars.iv, !intel-tbaa !11

...
define void @BZ2_blockSort(ptr nocapture %s) #0 {
entry:
  %budget = alloca i32, align 4
  %ptr1 = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 8
  %0 = load ptr, ptr %ptr1, align 8, !tbaa !1
  %block2 = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 9
  %1 = load ptr, ptr %block2, align 8, !tbaa !7
  %ftab3 = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 6
  %2 = load ptr, ptr %ftab3, align 8, !tbaa !8
  %nblock4 = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 17
  %3 = load i32, ptr %nblock4, align 4, !tbaa !9
  %verbosity = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 28
  %4 = load i32, ptr %verbosity, align 8, !tbaa !10
  %workFactor = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 12
  %5 = load i32, ptr %workFactor, align 8, !tbaa !11
  %6 = bitcast ptr %budget to ptr
  call void @llvm.lifetime.start(i64 4, ptr %6) #7
  %cmp = icmp slt i32 %3, 10000
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %arr1 = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 4
  %7 = load ptr, ptr %arr1, align 8, !tbaa !12
  %arr2 = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 5
  %8 = load ptr, ptr %arr2, align 8, !tbaa !13
  tail call fastcc void @fallbackSort(ptr %7, ptr %8, ptr %2, i32 %3, i32 %4)
  br label %if.end33
...
if.end11:                                         ; preds = %if.end8, %if.else
  ...
  store i32 %mul, ptr %budget, align 4, !tbaa !14
  call fastcc void @mainSort(ptr %0, ptr %1, ptr %9, ptr %2, i32 %3, i32 %4, ptr nonnull %budget)
  %cmp12 = icmp sgt i32 %4, 2
  br i1 %cmp12, label %if.then13, label %if.end21

if.then13:                                        ; preds = %if.end11
  %10 = load ptr, ptr @stderr, align 8, !tbaa !15
  %11 = load i32, ptr %budget, align 4, !tbaa !14
  ...
  %call = tail call i32 (ptr, ptr, ...) @fprintf(ptr %10, ptr nonnull @.str, i32 %sub14, i32 %3, double %conv20) #8
  br label %if.end21

if.end21:                                         ; preds = %if.then13, %if.end11
  %13 = load i32, ptr %budget, align 4, !tbaa !14
...
if.then27:                                        ; preds = %if.then24
  ...
  %15 = tail call i64 @fwrite(ptr nonnull @.str.1, i64 53, i64 1, ptr %14) #8
  br label %if.end29

if.end29:                                         ; preds = %if.then27, %if.then24
  %arr130 = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 4
  %16 = load ptr, ptr %arr130, align 8, !tbaa !12
  %arr231 = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 5
  %17 = load ptr, ptr %arr231, align 8, !tbaa !13
  tail call fastcc void @fallbackSort(ptr %16, ptr %17, ptr %2, i32 %3, i32 %4)
  br label %if.end33

if.end33:                                         ; preds = %if.end21, %if.end29, %if.then
  %origPtr = getelementptr inbounds %struct.EState, ptr %s, i64 0, i32 7
  store i32 -1, ptr %origPtr, align 8, !tbaa !16
  %18 = load i32, ptr %nblock4, align 4, !tbaa !9
...
for.body:                                         ; preds = %if.end33, %for.inc
  ...
  %arrayidx38 = getelementptr inbounds i32, ptr %0, i64 %indvars.iv
  %19 = load i32, ptr %arrayidx38, align 4, !tbaa !14
  %cmp39 = icmp eq i32 %19, 0
  br i1 %cmp39, label %if.then41, label %for.inc

if.then41:                                        ; preds = %for.body
  %20 = trunc i64 %indvars.iv to i32
  store i32 %20, ptr %origPtr, align 8, !tbaa !16
  br label %for.end

for.inc:                                          ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %21 = load i32, ptr %nblock4, align 4, !tbaa !9
...
for.endthread-pre-split:                          ; preds = %for.inc, %if.end33
  %.pr = load i32, ptr %origPtr, align 8, !tbaa !16
  br label %for.end
...
if.end49:                                         ; preds = %for.end, %if.then48
  call void @llvm.lifetime.end(i64 4, ptr %6) #7
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal fastcc void @fallbackSort(ptr nocapture %fmap, ptr nocapture %eclass, ptr nocapture %bhtab, i32 %nblock, i32 %verb) unnamed_addr #0 {
entry:
  %bhtab495 = bitcast ptr %bhtab to ptr
  %ftab = alloca [257 x i32], align 16
  %0 = bitcast ptr %ftab to ptr
  %ftabCopy = alloca [256 x i32], align 16
  %1 = bitcast ptr %ftabCopy to ptr
  call void @llvm.lifetime.start(i64 1028, ptr %0) #7
  call void @llvm.lifetime.start(i64 1024, ptr %1) #7
  %2 = bitcast ptr %eclass to ptr
  %cmp = icmp sgt i32 %verb, 3
  br i1 %cmp, label %if.then, label %for.cond2.preheader

if.then:                                          ; preds = %entry
  %3 = load ptr, ptr @stderr, align 8, !tbaa !15
  %4 = tail call i64 @fwrite(ptr nonnull @.str.2, i64 27, i64 1, ptr %3) #8
  br label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %entry, %if.then
  call void @llvm.memset.p0.i64(ptr %0, i8 0, i64 1028, i32 16, i1 false)
...
for.body4:                                        ; preds = %for.cond2.preheader, %for.body4
  ...
  %arrayidx6 = getelementptr inbounds i8, ptr %2, i64 %indvars.iv488
  %5 = load i8, ptr %arrayidx6, align 1, !tbaa !17
  %idxprom7 = zext i8 %5 to i64
  %arrayidx8 = getelementptr inbounds [257 x i32], ptr %ftab, i64 0, i64 %idxprom7
  %6 = load i32, ptr %arrayidx8, align 4, !tbaa !14
  %inc9 = add nsw i32 %6, 1
  store i32 %inc9, ptr %arrayidx8, align 4, !tbaa !14
...
for.body25.preheader:                             ; preds = %for.body4, %for.cond2.preheader
  call void @llvm.memcpy.p0.p0.i64(ptr %1, ptr nonnull %0, i64 1024, i32 16, i1 false)
  br label %for.body25
...
for.body25:                                       ; preds = %for.body25, %for.body25.preheader
  ...
  %arrayidx27 = getelementptr inbounds [257 x i32], ptr %ftab, i64 0, i64 %7
  %8 = load i32, ptr %arrayidx27, align 4, !tbaa !14
  %arrayidx29 = getelementptr inbounds [257 x i32], ptr %ftab, i64 0, i64 %indvars.iv481
  %9 = load i32, ptr %arrayidx29, align 4, !tbaa !14
  %add = add nsw i32 %9, %8
  store i32 %add, ptr %arrayidx29, align 4, !tbaa !14
...
for.body35:                                       ; preds = %for.cond33.preheader, %for.body35
  ...
  %arrayidx37 = getelementptr inbounds i8, ptr %2, i64 %indvars.iv477
  %10 = load i8, ptr %arrayidx37, align 1, !tbaa !17
  ...
  store i32 %sub40, ptr %arrayidx39, align 4, !tbaa !14
  %idxprom43 = sext i32 %sub40 to i64
  %arrayidx44 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom43
  %12 = trunc i64 %indvars.iv477 to i32
  store i32 %12, ptr %arrayidx44, align 4, !tbaa !14
...
for.body61.preheader.loopexit:                    ; preds = %for.end47
  ...
  call void @llvm.memset.p0.i64(ptr %bhtab495, i8 0, i64 %17, i32 4, i1 false)
  br label %for.body61
...
for.body61:                                       ; preds = %for.end47, %for.body61.preheader.loopexit, %for.body61
  ...
  %arrayidx63 = getelementptr inbounds [257 x i32], ptr %ftab, i64 0, i64 %indvars.iv472
  %18 = load i32, ptr %arrayidx63, align 4, !tbaa !14
  %and = and i32 %18, 31
  %shl = shl i32 1, %and
  %shr = ashr i32 %18, 5
  %idxprom66 = sext i32 %shr to i64
  %arrayidx67 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom66
  %19 = load i32, ptr %arrayidx67, align 4, !tbaa !14
  %or = or i32 %shl, %19
  store i32 %or, ptr %arrayidx67, align 4, !tbaa !14
...
for.body74:                                       ; preds = %for.body61, %for.body74
  ...
  %arrayidx82 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom81
  %20 = load i32, ptr %arrayidx82, align 4, !tbaa !14
  %or83 = or i32 %20, %shl77
  store i32 %or83, ptr %arrayidx82, align 4, !tbaa !14
  ...
  %arrayidx94 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom93
  %21 = load i32, ptr %arrayidx94, align 4, !tbaa !14
  %and95 = and i32 %21, %neg
  store i32 %and95, ptr %arrayidx94, align 4, !tbaa !14
...
if.then101:                                       ; preds = %while.body
  ...
  %call102 = tail call i32 (ptr, ptr, ...) @fprintf(ptr %22, ptr nonnull @.str.3, i32 %H.0) #8
...
for.body107:                                      ; preds = %for.cond104.preheader, %for.body107
  ...
  %arrayidx110 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom109
  %24 = load i32, ptr %arrayidx110, align 4, !tbaa !14
  ...
  %arrayidx117 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv465
  %27 = load i32, ptr %arrayidx117, align 4, !tbaa !14
  ...
  %arrayidx125 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom124
  store i32 %j.0.i.8, ptr %arrayidx125, align 4, !tbaa !14
...
while.cond132:                                    ; preds = %if.end226, %while.cond132, %while.body130.outer
  ...
  %arrayidx135 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom134
  %29 = load i32, ptr %arrayidx135, align 4, !tbaa !14
...
while.cond152:                                    ; preds = %while.end, %while.cond152
  ...
  %arrayidx155 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom154
  %30 = load i32, ptr %arrayidx155, align 4, !tbaa !14
...
while.cond161:                                    ; preds = %while.cond152, %while.cond161
  ...
  %arrayidx164 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom163
  %31 = load i32, ptr %arrayidx164, align 4, !tbaa !14
...
while.cond178:                                    ; preds = %if.end172, %while.cond178
  ...
  %arrayidx181 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom180
  %32 = load i32, ptr %arrayidx181, align 4, !tbaa !14
...
while.cond201:                                    ; preds = %while.end192, %while.cond201
  ...
  %arrayidx204 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom203
  %33 = load i32, ptr %arrayidx204, align 4, !tbaa !14
...
while.cond210:                                    ; preds = %while.cond201, %while.cond210
  ...
  %arrayidx213 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom212
  %34 = load i32, ptr %arrayidx213, align 4, !tbaa !14
...
if.then229:                                       ; preds = %if.end226
  ...
  tail call fastcc void @fallbackQSort3(ptr %fmap, ptr %eclass, i32 %sub173.le, i32 %sub222)
...
for.body236:                                      ; preds = %for.body236.preheader, %for.inc251
  ...
  %arrayidx238 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv469
  %37 = load i32, ptr %arrayidx238, align 4, !tbaa !14
  %idxprom239 = zext i32 %37 to i64
  %arrayidx240 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom239
  %38 = load i32, ptr %arrayidx240, align 4, !tbaa !14
...
if.then243:                                       ; preds = %for.body236
  ...
  %arrayidx248 = getelementptr inbounds i32, ptr %bhtab, i64 %idxprom247
  %41 = load i32, ptr %arrayidx248, align 4, !tbaa !14
  %or249 = or i32 %41, %shl245
  store i32 %or249, ptr %arrayidx248, align 4, !tbaa !14
  br label %for.inc251
...
if.then258:                                       ; preds = %while.end255
  ...
  %call259 = tail call i32 (ptr, ptr, ...) @fprintf(ptr %42, ptr nonnull @.str.4, i32 %nNotDone.0.ph) #8
  br label %if.end260
...
if.then271:                                       ; preds = %while.end268
  ...
  %44 = tail call i64 @fwrite(ptr nonnull @.str.5, i64 33, i64 1, ptr %43) #8
...
while.cond278:                                    ; preds = %while.cond278, %while.cond278.preheader
  ...
  %arrayidx280 = getelementptr inbounds [256 x i32], ptr %ftabCopy, i64 0, i64 %indvars.iv
  %46 = load i32, ptr %arrayidx280, align 4, !tbaa !14
...
while.end285:                                     ; preds = %while.cond278
  ...
  store i32 %dec, ptr %arrayidx280, align 4, !tbaa !14
  %conv288 = trunc i64 %indvars.iv to i8
  %arrayidx290 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv463
  %47 = load i32, ptr %arrayidx290, align 4, !tbaa !14
  %idxprom291 = zext i32 %47 to i64
  %arrayidx292 = getelementptr inbounds i8, ptr %2, i64 %idxprom291
  store i8 %conv288, ptr %arrayidx292, align 1, !tbaa !17
...
if.end299:                                        ; preds = %for.cond274.preheader, %if.then298, %for.end295
  call void @llvm.lifetime.end(i64 1024, ptr %1) #7
  call void @llvm.lifetime.end(i64 1028, ptr %0) #7
  ret void
}

; Function Attrs: nounwind uwtable
define internal fastcc void @mainSort(ptr nocapture %ptr, ptr %block, ptr nocapture %quadrant, ptr %ftab, i32 %nblock, i32 %verb, ptr nocapture %budget) unnamed_addr #0 {
entry:
  %ftab891 = bitcast ptr %ftab to ptr
  %runningOrder = alloca [256 x i32], align 16
  %bigDone = alloca [256 x i8], align 16
  %bigDone888 = getelementptr inbounds [256 x i8], ptr %bigDone, i64 0, i64 0
  %copyStart = alloca [256 x i32], align 16
  %copyEnd = alloca [256 x i32], align 16
  %0 = bitcast ptr %runningOrder to ptr
  call void @llvm.lifetime.start(i64 1024, ptr %0) #7
  %1 = getelementptr inbounds [256 x i8], ptr %bigDone, i64 0, i64 0
  call void @llvm.lifetime.start(i64 256, ptr %1) #7
  %2 = bitcast ptr %copyStart to ptr
  call void @llvm.lifetime.start(i64 1024, ptr %2) #7
  %3 = bitcast ptr %copyEnd to ptr
  call void @llvm.lifetime.start(i64 1024, ptr %3) #7
  %cmp = icmp sgt i32 %verb, 3
  br i1 %cmp, label %if.then, label %for.end

if.then:                                          ; preds = %entry
  %4 = load ptr, ptr @stderr, align 8, !tbaa !15
  %5 = tail call i64 @fwrite(ptr nonnull @.str.6, i64 33, i64 1, ptr %4) #8
  br label %for.end

for.end:                                          ; preds = %entry, %if.then
  call void @llvm.memset.p0.i64(ptr %ftab891, i8 0, i64 262148, i32 4, i1 false)
  %6 = load i8, ptr %block, align 1, !tbaa !17
...
for.body6:                                        ; preds = %for.body6.preheader, %for.body6
  ...
  %arrayidx8 = getelementptr inbounds i16, ptr %quadrant, i64 %indvars.iv884
  store i16 0, ptr %arrayidx8, align 2, !tbaa !18
  %shr = ashr i32 %j.0841, 8
  %arrayidx10 = getelementptr inbounds i8, ptr %block, i64 %indvars.iv884
  %14 = load i8, ptr %arrayidx10, align 1, !tbaa !17
  %conv12 = zext i8 %14 to i32
  %shl13 = shl nuw nsw i32 %conv12, 8
  %or = or i32 %shl13, %shr
  %idxprom14 = sext i32 %or to i64
  %arrayidx15 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom14
  %15 = load i32, ptr %arrayidx15, align 4, !tbaa !14
  %inc = add i32 %15, 1
  store i32 %inc, ptr %arrayidx15, align 4, !tbaa !14
  %sub16 = add nsw i32 %i.1842, -1
  %idxprom17 = sext i32 %sub16 to i64
  %arrayidx18 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom17
  store i16 0, ptr %arrayidx18, align 2, !tbaa !18
  %shr19 = ashr i32 %or, 8
  %arrayidx22 = getelementptr inbounds i8, ptr %block, i64 %idxprom17
  %16 = load i8, ptr %arrayidx22, align 1, !tbaa !17
  %conv24 = zext i8 %16 to i32
  %shl25 = shl nuw nsw i32 %conv24, 8
  %or26 = or i32 %shl25, %shr19
  %idxprom27 = sext i32 %or26 to i64
  %arrayidx28 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom27
  %17 = load i32, ptr %arrayidx28, align 4, !tbaa !14
  %inc29 = add i32 %17, 1
  store i32 %inc29, ptr %arrayidx28, align 4, !tbaa !14
  %sub30 = add nsw i32 %i.1842, -2
  %idxprom31 = sext i32 %sub30 to i64
  %arrayidx32 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom31
  store i16 0, ptr %arrayidx32, align 2, !tbaa !18
  %shr33 = ashr i32 %or26, 8
  %arrayidx36 = getelementptr inbounds i8, ptr %block, i64 %idxprom31
  %18 = load i8, ptr %arrayidx36, align 1, !tbaa !17
  %conv38 = zext i8 %18 to i32
  %shl39 = shl nuw nsw i32 %conv38, 8
  %or40 = or i32 %shl39, %shr33
  %idxprom41 = sext i32 %or40 to i64
  %arrayidx42 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom41
  %19 = load i32, ptr %arrayidx42, align 4, !tbaa !14
  %inc43 = add i32 %19, 1
  store i32 %inc43, ptr %arrayidx42, align 4, !tbaa !14
  %sub44 = add nsw i32 %i.1842, -3
  %idxprom45 = sext i32 %sub44 to i64
  %arrayidx46 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom45
  store i16 0, ptr %arrayidx46, align 2, !tbaa !18
  %shr47 = ashr i32 %or40, 8
  %arrayidx50 = getelementptr inbounds i8, ptr %block, i64 %idxprom45
  %20 = load i8, ptr %arrayidx50, align 1, !tbaa !17
  %conv52 = zext i8 %20 to i32
  %shl53 = shl nuw nsw i32 %conv52, 8
  %or54 = or i32 %shl53, %shr47
  %idxprom55 = sext i32 %or54 to i64
  %arrayidx56 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom55
  %21 = load i32, ptr %arrayidx56, align 4, !tbaa !14
  %inc57 = add i32 %21, 1
  store i32 %inc57, ptr %arrayidx56, align 4, !tbaa !14
...
for.body64:                                       ; preds = %for.body64.preheader, %for.body64
  ...
  %arrayidx66 = getelementptr inbounds i16, ptr %quadrant, i64 %indvars.iv882
  store i16 0, ptr %arrayidx66, align 2, !tbaa !18
  %shr67 = ashr i32 %j.1838, 8
  %arrayidx69 = getelementptr inbounds i8, ptr %block, i64 %indvars.iv882
  %22 = load i8, ptr %arrayidx69, align 1, !tbaa !17
  %conv71 = zext i8 %22 to i32
  %shl72 = shl nuw nsw i32 %conv71, 8
  %or73 = or i32 %shl72, %shr67
  %idxprom74 = sext i32 %or73 to i64
  %arrayidx75 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom74
  %23 = load i32, ptr %arrayidx75, align 4, !tbaa !14
  %inc76 = add i32 %23, 1
...
for.body83:                                       ; preds = %for.body83, %for.body83.preheader
  ...
  %arrayidx85 = getelementptr inbounds i8, ptr %block, i64 %indvars.iv878
  %25 = load i8, ptr %arrayidx85, align 1, !tbaa !17
  %26 = add nsw i64 %indvars.iv878, %24
  %arrayidx87 = getelementptr inbounds i8, ptr %block, i64 %26
  store i8 %25, ptr %arrayidx87, align 1, !tbaa !17
  %arrayidx90 = getelementptr inbounds i16, ptr %quadrant, i64 %26
  store i16 0, ptr %arrayidx90, align 2, !tbaa !18
...
if.then96:                                        ; preds = %for.end93
  ...
  %28 = tail call i64 @fwrite(ptr nonnull @.str.2, i64 27, i64 1, ptr %27) #8
...
for.body102:                                      ; preds = %for.end93, %if.then96, %for.body102
  ...
  %arrayidx105 = getelementptr inbounds i32, ptr %ftab, i64 %29
  %30 = load i32, ptr %arrayidx105, align 4, !tbaa !14
  %arrayidx107 = getelementptr inbounds i32, ptr %ftab, i64 %indvars.iv874
  %31 = load i32, ptr %arrayidx107, align 4, !tbaa !14
  %add108 = add i32 %31, %30
  store i32 %add108, ptr %arrayidx107, align 4, !tbaa !14
...
for.end111:                                       ; preds = %for.body102
  %32 = load i8, ptr %block, align 1, !tbaa !17
...
for.body120:                                      ; preds = %for.body120.preheader, %for.body120
  ...
  %arrayidx124 = getelementptr inbounds i8, ptr %block, i64 %indvars.iv872
  %40 = load i8, ptr %arrayidx124, align 1, !tbaa !17
  %conv125 = zext i8 %40 to i16
  %shl126 = shl nuw i16 %conv125, 8
  %or127 = or i16 %shl126, %shr122802
  %idxprom129 = zext i16 %or127 to i64
  %arrayidx130 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom129
  %41 = load i32, ptr %arrayidx130, align 4, !tbaa !14
  %sub131 = add i32 %41, -1
  store i32 %sub131, ptr %arrayidx130, align 4, !tbaa !14
  %idxprom134 = sext i32 %sub131 to i64
  %arrayidx135 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom134
  %42 = trunc i64 %indvars.iv872 to i32
  store i32 %42, ptr %arrayidx135, align 4, !tbaa !14
  %sub138 = add nsw i32 %i.5832, -1
  %idxprom139 = sext i32 %sub138 to i64
  %arrayidx140 = getelementptr inbounds i8, ptr %block, i64 %idxprom139
  %43 = load i8, ptr %arrayidx140, align 1, !tbaa !17
  %conv141 = zext i8 %43 to i16
  %shl142 = shl nuw i16 %conv141, 8
  %or143 = or i16 %shl142, %conv125
  %idxprom145 = zext i16 %or143 to i64
  %arrayidx146 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom145
  %44 = load i32, ptr %arrayidx146, align 4, !tbaa !14
  %sub147 = add i32 %44, -1
  store i32 %sub147, ptr %arrayidx146, align 4, !tbaa !14
  %idxprom151 = sext i32 %sub147 to i64
  %arrayidx152 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom151
  store i32 %sub138, ptr %arrayidx152, align 4, !tbaa !14
  %sub155 = add nsw i32 %i.5832, -2
  %idxprom156 = sext i32 %sub155 to i64
  %arrayidx157 = getelementptr inbounds i8, ptr %block, i64 %idxprom156
  %45 = load i8, ptr %arrayidx157, align 1, !tbaa !17
  %conv158 = zext i8 %45 to i16
  %shl159 = shl nuw i16 %conv158, 8
  %or160 = or i16 %shl159, %conv141
  %idxprom162 = zext i16 %or160 to i64
  %arrayidx163 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom162
  %46 = load i32, ptr %arrayidx163, align 4, !tbaa !14
  %sub164 = add i32 %46, -1
  store i32 %sub164, ptr %arrayidx163, align 4, !tbaa !14
  %idxprom168 = sext i32 %sub164 to i64
  %arrayidx169 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom168
  store i32 %sub155, ptr %arrayidx169, align 4, !tbaa !14
  %sub172 = add nsw i32 %i.5832, -3
  %idxprom173 = sext i32 %sub172 to i64
  %arrayidx174 = getelementptr inbounds i8, ptr %block, i64 %idxprom173
  %47 = load i8, ptr %arrayidx174, align 1, !tbaa !17
  %conv175 = zext i8 %47 to i16
  %shl176 = shl nuw i16 %conv175, 8
  %or177 = or i16 %shl176, %conv158
  %idxprom179 = zext i16 %or177 to i64
  %arrayidx180 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom179
  %48 = load i32, ptr %arrayidx180, align 4, !tbaa !14
  %sub181 = add i32 %48, -1
  store i32 %sub181, ptr %arrayidx180, align 4, !tbaa !14
  %idxprom185 = sext i32 %sub181 to i64
  %arrayidx186 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom185
  store i32 %sub172, ptr %arrayidx186, align 4, !tbaa !14
...
for.body193:                                      ; preds = %for.body193.preheader, %for.body193
  ...
  %arrayidx197 = getelementptr inbounds i8, ptr %block, i64 %indvars.iv870
  %49 = load i8, ptr %arrayidx197, align 1, !tbaa !17
  %conv198 = zext i8 %49 to i16
  %shl199 = shl nuw i16 %conv198, 8
  %or200 = or i16 %shl199, %shr195801
  %idxprom202 = zext i16 %or200 to i64
  %arrayidx203 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom202
  %50 = load i32, ptr %arrayidx203, align 4, !tbaa !14
  %sub204 = add i32 %50, -1
  store i32 %sub204, ptr %arrayidx203, align 4, !tbaa !14
  %idxprom207 = sext i32 %sub204 to i64
  %arrayidx208 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom207
  %51 = trunc i64 %indvars.iv870 to i32
  store i32 %51, ptr %arrayidx208, align 4, !tbaa !14
...
for.body215.preheader:                            ; preds = %for.body193, %for.cond190.preheader
  call void @llvm.memset.p0.i64(ptr %bigDone888, i8 0, i64 256, i32 16, i1 false)
...
for.body215:                                      ; preds = %for.body215, %for.body215.preheader
  ...
  %arrayidx219 = getelementptr inbounds [256 x i32], ptr %runningOrder, i64 0, i64 %indvars.iv867
  %52 = trunc i64 %indvars.iv867 to i32
  store i32 %52, ptr %arrayidx219, align 4, !tbaa !14
...
for.body230:                                      ; preds = %for.body230.preheader, %zero
  ...
  %arrayidx232 = getelementptr inbounds [256 x i32], ptr %runningOrder, i64 0, i64 %indvars.iv865
  %54 = load i32, ptr %arrayidx232, align 4, !tbaa !14
  %add247 = shl i32 %54, 8
  %shl248 = add i32 %add247, 256
  %idxprom249 = sext i32 %shl248 to i64
  %arrayidx250 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom249
  %55 = load i32, ptr %arrayidx250, align 4
  %idxprom252 = sext i32 %add247 to i64
  %arrayidx253 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom252
  %56 = load i32, ptr %arrayidx253, align 4
...
while.cond:                                       ; preds = %while.body, %for.body230
  ...
  %58 = load i32, ptr %arrayidx235, align 4, !tbaa !14
  %add236 = shl i32 %58, 8
  %shl237 = add i32 %add236, 256
  %idxprom238 = sext i32 %shl237 to i64
  %arrayidx239 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom238
  %59 = load i32, ptr %arrayidx239, align 4, !tbaa !14
  %idxprom244 = sext i32 %add236 to i64
  %arrayidx245 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom244
  %60 = load i32, ptr %arrayidx245, align 4, !tbaa !14
...
while.body:                                       ; preds = %while.cond
  ...
  store i32 %58, ptr %arrayidx261, align 4, !tbaa !14
...
zero:                                             ; preds = %while.cond, %while.body
  ...
  store i32 %54, ptr %arrayidx269, align 4, !tbaa !14
...
for.body280:                                      ; preds = %do.cond273, %for.inc507
  ...
  %arrayidx282 = getelementptr inbounds [256 x i32], ptr %runningOrder, i64 0, i64 %indvars.iv863
  %62 = load i32, ptr %arrayidx282, align 4, !tbaa !14
  %shl290 = shl i32 %62, 8
...
if.then289:                                       ; preds = %for.body286
  ...
  %arrayidx293 = getelementptr inbounds i32, ptr %ftab, i64 %65
  %66 = load i32, ptr %arrayidx293, align 4, !tbaa !14
...
if.then294:                                       ; preds = %if.then289
  ...
  %67 = add nsw i64 %65, 1
  %arrayidx300 = getelementptr inbounds i32, ptr %ftab, i64 %67
  %68 = load i32, ptr %arrayidx300, align 4, !tbaa !14
...
if.then308:                                       ; preds = %if.then305
  ...
  %call311 = tail call i32 (ptr, ptr, ...) @fprintf(ptr %69, ptr nonnull @.str.7, i32 %62, i32 %70, i32 %numQSorted.1810, i32 %add310) #8
  br label %if.end312

if.end312:                                        ; preds = %if.then308, %if.then305
  tail call fastcc void @mainQSort3(ptr %ptr, ptr %block, ptr %quadrant, i32 %nblock, i32 %and297, i32 %sub302, ptr %budget)
  %sub313 = add i32 %numQSorted.1810, 1
  %add314 = sub i32 %sub313, %and297
  %add315 = add i32 %add314, %sub302
  %71 = load i32, ptr %budget, align 4, !tbaa !14
...
if.end322:                                        ; preds = %if.end312, %if.then294, %if.then289
  ...
  %72 = load i32, ptr %arrayidx293, align 4, !tbaa !14
  %or325 = or i32 %72, 2097152
  store i32 %or325, ptr %arrayidx293, align 4, !tbaa !14
  br label %for.inc327
...
for.end329:                                       ; preds = %for.inc327
  ...
  %arrayidx331 = getelementptr inbounds [256 x i8], ptr %bigDone, i64 0, i64 %idxprom330
  %73 = load i8, ptr %arrayidx331, align 1, !tbaa !17
...
for.body338:                                      ; preds = %for.body338, %for.body338.preheader
  ...
  %arrayidx342 = getelementptr inbounds i32, ptr %ftab, i64 %76
  %77 = load i32, ptr %arrayidx342, align 4, !tbaa !14
  %and343 = and i32 %77, -2097153
  %arrayidx345 = getelementptr inbounds [256 x i32], ptr %copyStart, i64 0, i64 %indvars.iv849
  store i32 %and343, ptr %arrayidx345, align 4, !tbaa !14
  %78 = add nsw i64 %76, 1
  %arrayidx350 = getelementptr inbounds i32, ptr %ftab, i64 %78
  %79 = load i32, ptr %arrayidx350, align 4, !tbaa !14
  %and351 = and i32 %79, -2097153
  %sub352 = add i32 %and351, -1
  %arrayidx354 = getelementptr inbounds [256 x i32], ptr %copyEnd, i64 0, i64 %indvars.iv849
  store i32 %sub352, ptr %arrayidx354, align 4, !tbaa !14
...
for.end357:                                       ; preds = %for.body338
  ...
  %arrayidx360 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom359
  %80 = load i32, ptr %arrayidx360, align 4, !tbaa !14
  %and361 = and i32 %80, -2097153
  %arrayidx364 = getelementptr inbounds [256 x i32], ptr %copyStart, i64 0, i64 %idxprom330
  %81 = load i32, ptr %arrayidx364, align 4, !tbaa !14
...
for.body367:                                      ; preds = %for.body367.preheader, %for.inc388
  ...
  %arrayidx369 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv854
  %83 = load i32, ptr %arrayidx369, align 4, !tbaa !14
  %sub370 = add i32 %83, -1
  ...
  %arrayidx377 = getelementptr inbounds i8, ptr %block, i64 %idxprom376
  %84 = load i8, ptr %arrayidx377, align 1, !tbaa !17
  %idxprom378 = zext i8 %84 to i64
  %arrayidx379 = getelementptr inbounds [256 x i8], ptr %bigDone, i64 0, i64 %idxprom378
  %85 = load i8, ptr %arrayidx379, align 1, !tbaa !17
  %tobool380 = icmp eq i8 %85, 0
  br i1 %tobool380, label %if.then381, label %for.inc388

if.then381:                                       ; preds = %for.body367
  %arrayidx383 = getelementptr inbounds [256 x i32], ptr %copyStart, i64 0, i64 %idxprom378
  %86 = load i32, ptr %arrayidx383, align 4, !tbaa !14
  %inc384 = add nsw i32 %86, 1
  store i32 %inc384, ptr %arrayidx383, align 4, !tbaa !14
  %idxprom385 = sext i32 %86 to i64
  %arrayidx386 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom385
  store i32 %add374.sub370, ptr %arrayidx386, align 4, !tbaa !14
  br label %for.inc388

for.inc388:                                       ; preds = %for.body367, %if.then381
  %indvars.iv.next855 = add i64 %indvars.iv854, 1
  %87 = load i32, ptr %arrayidx364, align 4, !tbaa !14
...
for.end390:                                       ; preds = %for.inc388, %for.end357
  ...
  %arrayidx394 = getelementptr inbounds i32, ptr %ftab, i64 %idxprom393
  %89 = load i32, ptr %arrayidx394, align 4, !tbaa !14
  %and395 = and i32 %89, -2097153
  %j.7815 = add i32 %and395, -1
  %arrayidx399 = getelementptr inbounds [256 x i32], ptr %copyEnd, i64 0, i64 %idxprom330
  %90 = load i32, ptr %arrayidx399, align 4, !tbaa !14
...
for.body402:                                      ; preds = %for.end390, %for.cond397.backedge
  ...
  %arrayidx404 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom403
  %91 = load i32, ptr %arrayidx404, align 4, !tbaa !14
  %sub405 = add i32 %91, -1
  ...
  %arrayidx412 = getelementptr inbounds i8, ptr %block, i64 %idxprom411
  %92 = load i8, ptr %arrayidx412, align 1, !tbaa !17
  %idxprom413 = zext i8 %92 to i64
  %arrayidx414 = getelementptr inbounds [256 x i8], ptr %bigDone, i64 0, i64 %idxprom413
  %93 = load i8, ptr %arrayidx414, align 1, !tbaa !17
...
for.cond397.backedge:                             ; preds = %for.body402, %if.then416
  ...
  %94 = load i32, ptr %arrayidx399, align 4, !tbaa !14
  %cmp400 = icmp sgt i32 %j.7, %94
  br i1 %cmp400, label %for.body402, label %for.end425

if.then416:                                       ; preds = %for.body402
  %arrayidx418 = getelementptr inbounds [256 x i32], ptr %copyEnd, i64 0, i64 %idxprom413
  %95 = load i32, ptr %arrayidx418, align 4, !tbaa !14
  %dec419 = add nsw i32 %95, -1
  store i32 %dec419, ptr %arrayidx418, align 4, !tbaa !14
  %idxprom420 = sext i32 %95 to i64
  %arrayidx421 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom420
  store i32 %add409.sub405, ptr %arrayidx421, align 4, !tbaa !14
...
for.end425:                                       ; preds = %for.cond397.backedge, %for.end390
  ...
  %96 = load i32, ptr %arrayidx364, align 4, !tbaa !14
...
for.body447:                                      ; preds = %for.body447, %for.body447.preheader
  ...
  %arrayidx451 = getelementptr inbounds i32, ptr %ftab, i64 %99
  %100 = load i32, ptr %arrayidx451, align 4, !tbaa !14
  %or452 = or i32 %100, 2097152
  store i32 %or452, ptr %arrayidx451, align 4, !tbaa !14
...
for.body482:                                      ; preds = %for.body482.preheader, %if.end496
  ...
  %arrayidx485 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom484
  %105 = load i32, ptr %arrayidx485, align 4, !tbaa !14
  ...
  %arrayidx489 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom488
  store i16 %conv487, ptr %arrayidx489, align 2, !tbaa !18
...
if.then492:                                       ; preds = %for.body482
  ...
  %arrayidx495 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom494
  store i16 %conv487, ptr %arrayidx495, align 2, !tbaa !18
  br label %if.end496
...
if.then512:                                       ; preds = %for.end509
  ...
  %call514 = tail call i32 (ptr, ptr, ...) @fprintf(ptr %107, ptr nonnull @.str.8, i32 %nblock, i32 %numQSorted.5, i32 %sub513) #8
  br label %cleanup516

cleanup516:                                       ; preds = %if.end312, %for.end509, %if.then512
  call void @llvm.lifetime.end(i64 1024, ptr %3) #7
  call void @llvm.lifetime.end(i64 1024, ptr %2) #7
  call void @llvm.lifetime.end(i64 256, ptr %1) #7
  call void @llvm.lifetime.end(i64 1024, ptr %0) #7
  ret void
}

; Function Attrs: nounwind
declare i32 @fprintf(ptr nocapture, ptr nocapture readonly, ...) #2
...
; Function Attrs: nounwind uwtable
define internal fastcc void @fallbackQSort3(ptr nocapture %fmap, ptr nocapture readonly %eclass, i32 %loSt, i32 %hiSt) unnamed_addr #0 {
entry:
  %stackLo = alloca [100 x i32], align 16
  %stackHi = alloca [100 x i32], align 16
  %0 = bitcast ptr %stackLo to ptr
  call void @llvm.lifetime.start(i64 400, ptr %0) #7
  %1 = bitcast ptr %stackHi to ptr
  call void @llvm.lifetime.start(i64 400, ptr %1) #7
  %arrayidx = getelementptr inbounds [100 x i32], ptr %stackLo, i64 0, i64 0
  store i32 %loSt, ptr %arrayidx, align 16, !tbaa !14
  %arrayidx2 = getelementptr inbounds [100 x i32], ptr %stackHi, i64 0, i64 0
  store i32 %hiSt, ptr %arrayidx2, align 16, !tbaa !14
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %3 = load i32, ptr %arrayidx5, align 4, !tbaa !14
  %arrayidx7 = getelementptr inbounds [100 x i32], ptr %stackHi, i64 0, i64 %idxprom4
...
if.then9:                                         ; preds = %if.end
  tail call fastcc void @fallbackSimpleSort(ptr %fmap, ptr %eclass, i32 %3, i32 %4)
...
if.then13:                                        ; preds = %if.end10
  ...
  %arrayidx15 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom14
  %6 = load i32, ptr %arrayidx15, align 4, !tbaa !14
  %idxprom16 = zext i32 %6 to i64
  %arrayidx17 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom16
  br label %if.end31
...
if.then19:                                        ; preds = %if.end10
  ...
  %arrayidx22 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom21
  %7 = load i32, ptr %arrayidx22, align 4, !tbaa !14
  %idxprom23 = zext i32 %7 to i64
  %arrayidx24 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom23
  br label %if.end31

if.else25:                                        ; preds = %if.end10
  %idxprom26 = sext i32 %4 to i64
  %arrayidx27 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom26
  %8 = load i32, ptr %arrayidx27, align 4, !tbaa !14
  %idxprom28 = zext i32 %8 to i64
  %arrayidx29 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom28
  br label %if.end31

if.end31:                                         ; preds = %if.then19, %if.else25, %if.then13
  %med.0.in = phi ptr [ %arrayidx17, %if.then13 ], [ %arrayidx24, %if.then19 ], [ %arrayidx29, %if.else25 ]
  %med.0 = load i32, ptr %med.0.in, align 4, !tbaa !14
...
if.end38:                                         ; preds = %if.end59, %if.end38.lr.ph
  ...
  %arrayidx40 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv452
  %12 = load i32, ptr %arrayidx40, align 4, !tbaa !14
  %idxprom41 = zext i32 %12 to i64
  %arrayidx42 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom41
  %13 = load i32, ptr %arrayidx42, align 4, !tbaa !14
  %cmp44 = icmp eq i32 %13, %med.0
  br i1 %cmp44, label %if.then45, label %if.end56

if.then45:                                        ; preds = %if.end38
  %14 = trunc i64 %indvars.iv452 to i32
  %arrayidx49 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv454
  %15 = load i32, ptr %arrayidx49, align 4, !tbaa !14
  store i32 %15, ptr %arrayidx40, align 4, !tbaa !14
  store i32 %12, ptr %arrayidx49, align 4, !tbaa !14
...
if.end65:                                         ; preds = %if.end87, %if.end65.lr.ph
  ...
  %arrayidx67 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv456
  %20 = load i32, ptr %arrayidx67, align 4, !tbaa !14
  %idxprom68 = zext i32 %20 to i64
  %arrayidx69 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom68
  %21 = load i32, ptr %arrayidx69, align 4, !tbaa !14
...
if.then72:                                        ; preds = %if.end65
  ...
  %arrayidx77 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv458
  %23 = load i32, ptr %arrayidx77, align 4, !tbaa !14
  store i32 %23, ptr %arrayidx67, align 4, !tbaa !14
  store i32 %20, ptr %arrayidx77, align 4, !tbaa !14
...
if.end92:                                         ; preds = %if.end84
  ...
  %arrayidx95 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom94
  %27 = load i32, ptr %arrayidx95, align 4, !tbaa !14
  store i32 %20, ptr %arrayidx95, align 4, !tbaa !14
  store i32 %27, ptr %arrayidx67, align 4, !tbaa !14
...
while.body116:                                    ; preds = %while.body116.preheader, %while.body116
  ...
  %arrayidx119 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv462
  %38 = load i32, ptr %arrayidx119, align 4, !tbaa !14
  %arrayidx121 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv460
  %39 = load i32, ptr %arrayidx121, align 4, !tbaa !14
  store i32 %39, ptr %arrayidx119, align 4, !tbaa !14
  store i32 %38, ptr %arrayidx121, align 4, !tbaa !14
...
while.body146:                                    ; preds = %while.body146.preheader, %while.body146
  ...
  %arrayidx149 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv467
  %41 = load i32, ptr %arrayidx149, align 4, !tbaa !14
  %idxprom150 = sext i32 %yyp2140.0414 to i64
  %arrayidx151 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom150
  %42 = load i32, ptr %arrayidx151, align 4, !tbaa !14
  store i32 %42, ptr %arrayidx149, align 4, !tbaa !14
  store i32 %41, ptr %arrayidx151, align 4, !tbaa !14
...
if.then169:                                       ; preds = %while.end159
  store i32 %sub162, ptr %arrayidx7, align 4, !tbaa !14
  ...
  store i32 %add165, ptr %arrayidx176, align 4, !tbaa !14
  %arrayidx178 = getelementptr inbounds [100 x i32], ptr %stackHi, i64 0, i64 %idxprom175
  store i32 %4, ptr %arrayidx178, align 4, !tbaa !14
  %inc179 = add nsw i32 %5, 1
  br label %while.cond.outer.backedge

if.else180:                                       ; preds = %while.end159
  store i32 %add165, ptr %arrayidx5, align 4, !tbaa !14
  %sext = shl i64 %indvars.iv, 32
  %idxprom186 = ashr exact i64 %sext, 32
  %arrayidx187 = getelementptr inbounds [100 x i32], ptr %stackLo, i64 0, i64 %idxprom186
  store i32 %3, ptr %arrayidx187, align 4, !tbaa !14
  %arrayidx189 = getelementptr inbounds [100 x i32], ptr %stackHi, i64 0, i64 %idxprom186
  store i32 %sub162, ptr %arrayidx189, align 4, !tbaa !14
  %inc190 = add nsw i32 %5, 1
  br label %while.cond.outer.backedge

while.end192:                                     ; preds = %while.cond.outer.backedge, %if.then9
  call void @llvm.lifetime.end(i64 400, ptr %1) #7
  call void @llvm.lifetime.end(i64 400, ptr %0) #7
  ret void
}

; Function Attrs: inlinehint norecurse nounwind uwtable
define internal fastcc void @fallbackSimpleSort(ptr nocapture %fmap, ptr nocapture readonly %eclass, i32 %lo, i32 %hi) unnamed_addr #4 {
entry:
...
for.body:                                         ; preds = %for.body.preheader, %for.end
  ...
  %arrayidx = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv131
  %7 = load i32, ptr %arrayidx, align 4, !tbaa !14
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom6
  %8 = load i32, ptr %arrayidx7, align 4, !tbaa !14
...
land.rhs:                                         ; preds = %land.rhs.preheader, %for.body15
  ...
  %arrayidx11 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv129
  %12 = load i32, ptr %arrayidx11, align 4, !tbaa !14
  %idxprom12 = zext i32 %12 to i64
  %arrayidx13 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom12
...
for.body15:                                       ; preds = %land.rhs
  ...
  %arrayidx20 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom19
  store i32 %12, ptr %arrayidx20, align 4, !tbaa !14
...
for.end:                                          ; preds = %land.rhs, %for.body15, %for.body
  ...
  %arrayidx24 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom23
  store i32 %7, ptr %arrayidx24, align 4, !tbaa !14
...
for.body31:                                       ; preds = %for.body31.preheader, %for.end53
  ...
  %arrayidx33 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv.next128
  %14 = load i32, ptr %arrayidx33, align 4, !tbaa !14
  %idxprom34 = sext i32 %14 to i64
  %arrayidx35 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom34
  %15 = load i32, ptr %arrayidx35, align 4, !tbaa !14
...
land.rhs39:                                       ; preds = %for.body31, %for.body46
  ...
  %arrayidx41 = getelementptr inbounds i32, ptr %fmap, i64 %indvars.iv124
  %16 = load i32, ptr %arrayidx41, align 4, !tbaa !14
  %idxprom42 = zext i32 %16 to i64
  %arrayidx43 = getelementptr inbounds i32, ptr %eclass, i64 %idxprom42
  %17 = load i32, ptr %arrayidx43, align 4, !tbaa !14
...
for.body46:                                       ; preds = %land.rhs39
  ...
  %arrayidx51 = getelementptr inbounds i32, ptr %fmap, i64 %19
  store i32 %16, ptr %arrayidx51, align 4, !tbaa !14
...
for.end53:                                        ; preds = %for.body46, %land.rhs39, %for.body31
  ...
  %arrayidx56 = getelementptr inbounds i32, ptr %fmap, i64 %idxprom55
  store i32 %14, ptr %arrayidx56, align 4, !tbaa !14
...
; Function Attrs: nounwind uwtable
define internal fastcc void @mainQSort3(ptr nocapture %ptr, ptr readonly %block, ptr nocapture readonly %quadrant, i32 %nblock, i32 %loSt, i32 %hiSt, ptr nocapture %budget) unnamed_addr #0 {
entry:
  %stackLo = alloca [100 x i32], align 16
  %stackHi = alloca [100 x i32], align 16
  ...
  %1 = bitcast ptr %stackHi to ptr
  call void @llvm.lifetime.start(i64 400, ptr %1) #7
  %2 = bitcast ptr %stackD to ptr
  call void @llvm.lifetime.start(i64 400, ptr %2) #7
  %arrayidx = getelementptr inbounds [100 x i32], ptr %stackLo, i64 0, i64 0
  store i32 %loSt, ptr %arrayidx, align 16, !tbaa !14
  %arrayidx2 = getelementptr inbounds [100 x i32], ptr %stackHi, i64 0, i64 0
  store i32 %hiSt, ptr %arrayidx2, align 16, !tbaa !14
  %arrayidx4 = getelementptr inbounds [100 x i32], ptr %stackD, i64 0, i64 0
  store i32 2, ptr %arrayidx4, align 16, !tbaa !14
  br label %while.body.lr.ph
...
while.body.lr.ph:                                 ; preds = %entry, %while.cond.outer.backedge
  ...
  %arrayidx9 = getelementptr inbounds [100 x i32], ptr %stackHi, i64 0, i64 %idxprom6
  %arrayidx11 = getelementptr inbounds [100 x i32], ptr %stackD, i64 0, i64 %idxprom6
  %3 = load i32, ptr %arrayidx7, align 4
  %4 = load i32, ptr %arrayidx9, align 4
  %sub = sub nsw i32 %4, %3
  %cmp12 = icmp slt i32 %sub, 20
  %idxprom19 = sext i32 %3 to i64
  %arrayidx20 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom19
  %idxprom23 = sext i32 %4 to i64
  %arrayidx24 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom23
  %add28 = add nsw i32 %4, %3
  %shr = ashr i32 %add28, 1
  %idxprom29 = sext i32 %shr to i64
  %arrayidx30 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom29
  br label %while.body
...
if.then14:                                        ; preds = %if.end
  tail call fastcc void @mainSimpleSort(ptr %ptr, ptr %block, ptr %quadrant, i32 %nblock, i32 %3, i32 %4, i32 %5, ptr %budget)
  %6 = load i32, ptr %budget, align 4, !tbaa !14
...
if.end18:                                         ; preds = %if.end
  %7 = load i32, ptr %arrayidx20, align 4, !tbaa !14
  %add = add i32 %7, %5
  %idxprom21 = zext i32 %add to i64
  %arrayidx22 = getelementptr inbounds i8, ptr %block, i64 %idxprom21
  %8 = load i8, ptr %arrayidx22, align 1, !tbaa !17
  %9 = load i32, ptr %arrayidx24, align 4, !tbaa !14
  %add25 = add i32 %9, %5
  %idxprom26 = zext i32 %add25 to i64
  %arrayidx27 = getelementptr inbounds i8, ptr %block, i64 %idxprom26
  %10 = load i8, ptr %arrayidx27, align 1, !tbaa !17
  %11 = load i32, ptr %arrayidx30, align 4, !tbaa !14
  %add31 = add i32 %11, %5
  %idxprom32 = zext i32 %add31 to i64
  %arrayidx33 = getelementptr inbounds i8, ptr %block, i64 %idxprom32
  %12 = load i8, ptr %arrayidx33, align 1, !tbaa !17
...
if.end41:                                         ; preds = %if.end66, %if.end41.lr.ph
  ...
  %arrayidx43 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv
  %16 = load i32, ptr %arrayidx43, align 4, !tbaa !14
  %add44 = add i32 %16, %5
  %idxprom45 = zext i32 %add44 to i64
  %arrayidx46 = getelementptr inbounds i8, ptr %block, i64 %idxprom45
  %17 = load i8, ptr %arrayidx46, align 1, !tbaa !17
  %cmp49 = icmp eq i8 %17, %call
  br i1 %cmp49, label %if.then51, label %if.end62

if.then51:                                        ; preds = %if.end41
  %18 = trunc i64 %indvars.iv to i32
  %arrayidx55 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv108
  %19 = load i32, ptr %arrayidx55, align 4, !tbaa !14
  store i32 %19, ptr %arrayidx43, align 4, !tbaa !14
  store i32 %16, ptr %arrayidx55, align 4, !tbaa !14
...
if.end73:                                         ; preds = %if.end99, %if.end73.lr.ph
  ...
  %arrayidx75 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv110
  %24 = load i32, ptr %arrayidx75, align 4, !tbaa !14
  %add76 = add i32 %24, %5
  %idxprom77 = zext i32 %add76 to i64
  %arrayidx78 = getelementptr inbounds i8, ptr %block, i64 %idxprom77
  %25 = load i8, ptr %arrayidx78, align 1, !tbaa !17
...
if.then83:                                        ; preds = %if.end73
  ...
  %arrayidx88 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv112
  %27 = load i32, ptr %arrayidx88, align 4, !tbaa !14
  store i32 %27, ptr %arrayidx75, align 4, !tbaa !14
  store i32 %24, ptr %arrayidx88, align 4, !tbaa !14
...
if.end105:                                        ; preds = %if.end95
  ...
  %arrayidx108 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom107
  %31 = load i32, ptr %arrayidx108, align 4, !tbaa !14
  store i32 %24, ptr %arrayidx108, align 4, !tbaa !14
  store i32 %31, ptr %arrayidx75, align 4, !tbaa !14
...
if.then120:                                       ; preds = %while.end117
  ...
  store i32 %add125, ptr %arrayidx11, align 4, !tbaa !14
  br label %while.body
...
while.body140:                                    ; preds = %while.body140.preheader, %while.body140
  ...
  %arrayidx143 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv116
  %42 = load i32, ptr %arrayidx143, align 4, !tbaa !14
  %arrayidx145 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv114
  %43 = load i32, ptr %arrayidx145, align 4, !tbaa !14
  store i32 %43, ptr %arrayidx143, align 4, !tbaa !14
  store i32 %42, ptr %arrayidx145, align 4, !tbaa !14
...
while.body172:                                    ; preds = %while.body172.preheader, %while.body172
  ...
  %arrayidx175 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv121
  %45 = load i32, ptr %arrayidx175, align 4, !tbaa !14
  %idxprom176 = sext i32 %yyp2165.065 to i64
  %arrayidx177 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom176
  %46 = load i32, ptr %arrayidx177, align 4, !tbaa !14
  store i32 %46, ptr %arrayidx175, align 4, !tbaa !14
  store i32 %45, ptr %arrayidx177, align 4, !tbaa !14
...
while.end185:                                     ; preds = %while.body172, %while.end153
  ...
  store i32 %nextLo.sroa.10.1.add191., ptr %arrayidx7, align 4, !tbaa !14
  store i32 %nextHi.sroa.10.1..sub188, ptr %arrayidx9, align 4, !tbaa !14
  store i32 %nextD.sroa.8.1., ptr %arrayidx11, align 4, !tbaa !14
  %idxprom283 = sext i32 %sp.0.ph66 to i64
  %arrayidx284 = getelementptr inbounds [100 x i32], ptr %stackLo, i64 0, i64 %idxprom283
  store i32 %add191..nextLo.sroa.10.1, ptr %arrayidx284, align 4, !tbaa !14
  %arrayidx287 = getelementptr inbounds [100 x i32], ptr %stackHi, i64 0, i64 %idxprom283
  store i32 %.sub188.nextHi.sroa.10.1, ptr %arrayidx287, align 4, !tbaa !14
  %arrayidx290 = getelementptr inbounds [100 x i32], ptr %stackD, i64 0, i64 %idxprom283
  store i32 %.nextD.sroa.8.1, ptr %arrayidx290, align 4, !tbaa !14
  ...
  store i32 %.add191.sub187, ptr %arrayidx294, align 4, !tbaa !14
  %arrayidx297 = getelementptr inbounds [100 x i32], ptr %stackHi, i64 0, i64 %idxprom293
  store i32 %sub188..sub190, ptr %arrayidx297, align 4, !tbaa !14
  %arrayidx300 = getelementptr inbounds [100 x i32], ptr %stackD, i64 0, i64 %idxprom293
  store i32 %.add202, ptr %arrayidx300, align 4, !tbaa !14
  %inc301 = add nsw i32 %sp.0.ph66, 2
  br label %while.cond.outer.backedge

cleanup:                                          ; preds = %if.then14, %while.cond.outer.backedge
  call void @llvm.lifetime.end(i64 400, ptr %2) #7
  call void @llvm.lifetime.end(i64 400, ptr %1) #7
  call void @llvm.lifetime.end(i64 400, ptr %0) #7
  ret void
}
...
define internal fastcc void @mainSimpleSort(ptr nocapture %ptr, ptr readonly %block, ptr nocapture readonly %quadrant, i32 %nblock, i32 %lo, i32 %hi, i32 %d, ptr nocapture %budget) unnamed_addr #5 {
entry:
  %sub = sub nsw i32 %hi, %lo
...
while.cond:                                       ; preds = %entry, %while.cond
  ...
  %arrayidx = getelementptr inbounds [14 x i32], ptr @incs, i64 0, i64 %indvars.iv203
...
for.body:                                         ; preds = %for.body.preheader, %for.cond.loopexit
  ...
  %arrayidx4 = getelementptr inbounds [14 x i32], ptr @incs, i64 0, i64 %indvars.iv.next202
  %6 = load i32, ptr %arrayidx4, align 4, !tbaa !14
...
if.end10:                                         ; preds = %while.body7
  %arrayidx12 = getelementptr inbounds i32, ptr %ptr, i64 %indvars.iv
  %9 = load i32, ptr %arrayidx12, align 4, !tbaa !14
  %add18 = add i32 %9, %d
...
while.cond13:                                     ; preds = %while.body19, %if.end10
  ...
  %arrayidx16 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom15
  %11 = load i32, ptr %arrayidx16, align 4, !tbaa !14
  %add17 = add i32 %11, %d
  %call = tail call fastcc zeroext i8 @mainGtU(i32 %add17, i32 %add18, ptr %block, ptr %quadrant, i32 %nblock, ptr %budget)
  %tobool = icmp eq i8 %call, 0
  br i1 %tobool, label %while.end31, label %while.body19

while.body19:                                     ; preds = %while.cond13
  %12 = load i32, ptr %arrayidx16, align 4, !tbaa !14
  %idxprom23 = sext i32 %j.0 to i64
  %arrayidx24 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom23
  store i32 %12, ptr %arrayidx24, align 4, !tbaa !14
...
while.end31:                                      ; preds = %while.cond13, %while.body19
  ...
  %arrayidx33 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom32
  store i32 %9, ptr %arrayidx33, align 4, !tbaa !14
...
if.end37:                                         ; preds = %while.end31
  %arrayidx39 = getelementptr inbounds i32, ptr %ptr, i64 %13
  %14 = load i32, ptr %arrayidx39, align 4, !tbaa !14
  %add45 = add i32 %14, %d
...
while.cond40:                                     ; preds = %while.body48, %if.end37
  ...
  %arrayidx43 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom42
  %16 = load i32, ptr %arrayidx43, align 4, !tbaa !14
  %add44 = add i32 %16, %d
  %call46 = tail call fastcc zeroext i8 @mainGtU(i32 %add44, i32 %add45, ptr %block, ptr %quadrant, i32 %nblock, ptr %budget)
...
while.body48:                                     ; preds = %while.cond40
  ...
  %arrayidx53 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom52
  store i32 %17, ptr %arrayidx53, align 4, !tbaa !14
...
while.end60:                                      ; preds = %while.cond40, %while.body48
  ...
  %arrayidx62 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom61
  store i32 %14, ptr %arrayidx62, align 4, !tbaa !14
...
if.end66:                                         ; preds = %while.end60
  %arrayidx68 = getelementptr inbounds i32, ptr %ptr, i64 %18
  %19 = load i32, ptr %arrayidx68, align 4, !tbaa !14
  %add74 = add i32 %19, %d
...
while.cond69:                                     ; preds = %while.body77, %if.end66
  ...
  %arrayidx72 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom71
  %21 = load i32, ptr %arrayidx72, align 4, !tbaa !14
  %add73 = add i32 %21, %d
  %call75 = tail call fastcc zeroext i8 @mainGtU(i32 %add73, i32 %add74, ptr %block, ptr %quadrant, i32 %nblock, ptr %budget)
  %tobool76 = icmp eq i8 %call75, 0
  br i1 %tobool76, label %while.end89, label %while.body77

while.body77:                                     ; preds = %while.cond69
  %22 = load i32, ptr %arrayidx72, align 4, !tbaa !14
  %idxprom81 = sext i32 %j.4 to i64
  %arrayidx82 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom81
  store i32 %22, ptr %arrayidx82, align 4, !tbaa !14
...
while.end89:                                      ; preds = %while.cond69, %while.body77
  ...
  %arrayidx91 = getelementptr inbounds i32, ptr %ptr, i64 %idxprom90
  store i32 %19, ptr %arrayidx91, align 4, !tbaa !14
  %23 = load i32, ptr %budget, align 4, !tbaa !14
...
; Function Attrs: inlinehint norecurse nounwind uwtable
define internal fastcc zeroext i8 @mainGtU(i32 %i1, i32 %i2, ptr readonly %block, ptr nocapture readonly %quadrant, i32 %nblock, ptr nocapture %budget) unnamed_addr #4 {
entry:
  ...
  %arrayidx2 = getelementptr inbounds i8, ptr %block, i64 %idxprom1
  %1 = load i8, ptr %arrayidx2, align 1, !tbaa !17
  %cmp = icmp eq i8 %0, %1
...
if.end:                                           ; preds = %entry
  ...
  %arrayidx12 = getelementptr inbounds i8, ptr %block, i64 %idxprom11
  %2 = load i8, ptr %arrayidx12, align 1, !tbaa !17
  %idxprom13 = zext i32 %inc10 to i64
  %arrayidx14 = getelementptr inbounds i8, ptr %block, i64 %idxprom13
  %3 = load i8, ptr %arrayidx14, align 1, !tbaa !17
...
if.end25:                                         ; preds = %if.end
  ...
  %arrayidx29 = getelementptr inbounds i8, ptr %block, i64 %idxprom28
  %4 = load i8, ptr %arrayidx29, align 1, !tbaa !17
  %idxprom30 = zext i32 %inc27 to i64
  %arrayidx31 = getelementptr inbounds i8, ptr %block, i64 %idxprom30
  %5 = load i8, ptr %arrayidx31, align 1, !tbaa !17
...
if.end42:                                         ; preds = %if.end25
  ...
  %arrayidx46 = getelementptr inbounds i8, ptr %block, i64 %idxprom45
  %6 = load i8, ptr %arrayidx46, align 1, !tbaa !17
  %idxprom47 = zext i32 %inc44 to i64
  %arrayidx48 = getelementptr inbounds i8, ptr %block, i64 %idxprom47
  %7 = load i8, ptr %arrayidx48, align 1, !tbaa !17
...
if.end59:                                         ; preds = %if.end42
  ...
  %arrayidx63 = getelementptr inbounds i8, ptr %block, i64 %idxprom62
  %8 = load i8, ptr %arrayidx63, align 1, !tbaa !17
  %idxprom64 = zext i32 %inc61 to i64
  %arrayidx65 = getelementptr inbounds i8, ptr %block, i64 %idxprom64
  %9 = load i8, ptr %arrayidx65, align 1, !tbaa !17
...
if.end76:                                         ; preds = %if.end59
  ...
  %arrayidx80 = getelementptr inbounds i8, ptr %block, i64 %idxprom79
  %10 = load i8, ptr %arrayidx80, align 1, !tbaa !17
  %idxprom81 = zext i32 %inc78 to i64
  %arrayidx82 = getelementptr inbounds i8, ptr %block, i64 %idxprom81
  %11 = load i8, ptr %arrayidx82, align 1, !tbaa !17
...
if.end93:                                         ; preds = %if.end76
  ...
  %arrayidx97 = getelementptr inbounds i8, ptr %block, i64 %idxprom96
  %12 = load i8, ptr %arrayidx97, align 1, !tbaa !17
  %idxprom98 = zext i32 %inc95 to i64
  %arrayidx99 = getelementptr inbounds i8, ptr %block, i64 %idxprom98
  %13 = load i8, ptr %arrayidx99, align 1, !tbaa !17
...
if.end110:                                        ; preds = %if.end93
  ...
  %arrayidx114 = getelementptr inbounds i8, ptr %block, i64 %idxprom113
  %14 = load i8, ptr %arrayidx114, align 1, !tbaa !17
  %idxprom115 = zext i32 %inc112 to i64
  %arrayidx116 = getelementptr inbounds i8, ptr %block, i64 %idxprom115
  %15 = load i8, ptr %arrayidx116, align 1, !tbaa !17
...
if.end127:                                        ; preds = %if.end110
  ...
  %arrayidx131 = getelementptr inbounds i8, ptr %block, i64 %idxprom130
  %16 = load i8, ptr %arrayidx131, align 1, !tbaa !17
  %idxprom132 = zext i32 %inc129 to i64
  %arrayidx133 = getelementptr inbounds i8, ptr %block, i64 %idxprom132
  %17 = load i8, ptr %arrayidx133, align 1, !tbaa !17
...
if.end144:                                        ; preds = %if.end127
  ...
  %arrayidx148 = getelementptr inbounds i8, ptr %block, i64 %idxprom147
  %18 = load i8, ptr %arrayidx148, align 1, !tbaa !17
  %idxprom149 = zext i32 %inc146 to i64
  %arrayidx150 = getelementptr inbounds i8, ptr %block, i64 %idxprom149
  %19 = load i8, ptr %arrayidx150, align 1, !tbaa !17
...
if.end161:                                        ; preds = %if.end144
  ...
  %arrayidx165 = getelementptr inbounds i8, ptr %block, i64 %idxprom164
  %20 = load i8, ptr %arrayidx165, align 1, !tbaa !17
  %idxprom166 = zext i32 %inc163 to i64
  %arrayidx167 = getelementptr inbounds i8, ptr %block, i64 %idxprom166
  %21 = load i8, ptr %arrayidx167, align 1, !tbaa !17
...
if.end178:                                        ; preds = %if.end161
  ...
  %arrayidx182 = getelementptr inbounds i8, ptr %block, i64 %idxprom181
  %22 = load i8, ptr %arrayidx182, align 1, !tbaa !17
  %idxprom183 = zext i32 %inc180 to i64
  %arrayidx184 = getelementptr inbounds i8, ptr %block, i64 %idxprom183
  %23 = load i8, ptr %arrayidx184, align 1, !tbaa !17
...
do.body:                                          ; preds = %if.end451, %if.end195
  ...
  %arrayidx199 = getelementptr inbounds i8, ptr %block, i64 %idxprom198
  %24 = load i8, ptr %arrayidx199, align 1, !tbaa !17
  %idxprom200 = zext i32 %i2.addr.0 to i64
  %arrayidx201 = getelementptr inbounds i8, ptr %block, i64 %idxprom200
  %25 = load i8, ptr %arrayidx201, align 1, !tbaa !17
...
if.end212:                                        ; preds = %do.body
  %arrayidx214 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom198
  %26 = load i16, ptr %arrayidx214, align 2, !tbaa !18
  %arrayidx216 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom200
  %27 = load i16, ptr %arrayidx216, align 2, !tbaa !18
...
if.end227:                                        ; preds = %if.end212
  ...
  %arrayidx231 = getelementptr inbounds i8, ptr %block, i64 %idxprom230
  %28 = load i8, ptr %arrayidx231, align 1, !tbaa !17
  %idxprom232 = zext i32 %inc229 to i64
  %arrayidx233 = getelementptr inbounds i8, ptr %block, i64 %idxprom232
  %29 = load i8, ptr %arrayidx233, align 1, !tbaa !17
...
if.end244:                                        ; preds = %if.end227
  %arrayidx246 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom230
  %30 = load i16, ptr %arrayidx246, align 2, !tbaa !18
  %arrayidx248 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom232
  %31 = load i16, ptr %arrayidx248, align 2, !tbaa !18
...
if.end259:                                        ; preds = %if.end244
  ...
  %arrayidx263 = getelementptr inbounds i8, ptr %block, i64 %idxprom262
  %32 = load i8, ptr %arrayidx263, align 1, !tbaa !17
  %idxprom264 = zext i32 %inc261 to i64
  %arrayidx265 = getelementptr inbounds i8, ptr %block, i64 %idxprom264
  %33 = load i8, ptr %arrayidx265, align 1, !tbaa !17
...
if.end276:                                        ; preds = %if.end259
  %arrayidx278 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom262
  %34 = load i16, ptr %arrayidx278, align 2, !tbaa !18
  %arrayidx280 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom264
  %35 = load i16, ptr %arrayidx280, align 2, !tbaa !18
...
if.end291:                                        ; preds = %if.end276
  ...
  %arrayidx295 = getelementptr inbounds i8, ptr %block, i64 %idxprom294
  %36 = load i8, ptr %arrayidx295, align 1, !tbaa !17
  %idxprom296 = zext i32 %inc293 to i64
  %arrayidx297 = getelementptr inbounds i8, ptr %block, i64 %idxprom296
  %37 = load i8, ptr %arrayidx297, align 1, !tbaa !17
...
if.end308:                                        ; preds = %if.end291
  %arrayidx310 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom294
  %38 = load i16, ptr %arrayidx310, align 2, !tbaa !18
  %arrayidx312 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom296
  %39 = load i16, ptr %arrayidx312, align 2, !tbaa !18
...
if.end323:                                        ; preds = %if.end308
  ...
  %arrayidx327 = getelementptr inbounds i8, ptr %block, i64 %idxprom326
  %40 = load i8, ptr %arrayidx327, align 1, !tbaa !17
  %idxprom328 = zext i32 %inc325 to i64
  %arrayidx329 = getelementptr inbounds i8, ptr %block, i64 %idxprom328
  %41 = load i8, ptr %arrayidx329, align 1, !tbaa !17
...
if.end340:                                        ; preds = %if.end323
  %arrayidx342 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom326
  %42 = load i16, ptr %arrayidx342, align 2, !tbaa !18
  %arrayidx344 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom328
  %43 = load i16, ptr %arrayidx344, align 2, !tbaa !18
...
if.end355:                                        ; preds = %if.end340
  ...
  %arrayidx359 = getelementptr inbounds i8, ptr %block, i64 %idxprom358
  %44 = load i8, ptr %arrayidx359, align 1, !tbaa !17
  %idxprom360 = zext i32 %inc357 to i64
  %arrayidx361 = getelementptr inbounds i8, ptr %block, i64 %idxprom360
  %45 = load i8, ptr %arrayidx361, align 1, !tbaa !17
...
if.end372:                                        ; preds = %if.end355
  %arrayidx374 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom358
  %46 = load i16, ptr %arrayidx374, align 2, !tbaa !18
  %arrayidx376 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom360
  %47 = load i16, ptr %arrayidx376, align 2, !tbaa !18
...
if.end387:                                        ; preds = %if.end372
  ...
  %arrayidx391 = getelementptr inbounds i8, ptr %block, i64 %idxprom390
  %48 = load i8, ptr %arrayidx391, align 1, !tbaa !17
  %idxprom392 = zext i32 %inc389 to i64
  %arrayidx393 = getelementptr inbounds i8, ptr %block, i64 %idxprom392
  %49 = load i8, ptr %arrayidx393, align 1, !tbaa !17
...
if.end404:                                        ; preds = %if.end387
  %arrayidx406 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom390
  %50 = load i16, ptr %arrayidx406, align 2, !tbaa !18
  %arrayidx408 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom392
  %51 = load i16, ptr %arrayidx408, align 2, !tbaa !18
...
if.end419:                                        ; preds = %if.end404
  ...
  %arrayidx423 = getelementptr inbounds i8, ptr %block, i64 %idxprom422
  %52 = load i8, ptr %arrayidx423, align 1, !tbaa !17
  %idxprom424 = zext i32 %inc421 to i64
  %arrayidx425 = getelementptr inbounds i8, ptr %block, i64 %idxprom424
  %53 = load i8, ptr %arrayidx425, align 1, !tbaa !17
...
if.end436:                                        ; preds = %if.end419
  %arrayidx438 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom422
  %54 = load i16, ptr %arrayidx438, align 2, !tbaa !18
  %arrayidx440 = getelementptr inbounds i16, ptr %quadrant, i64 %idxprom424
  %55 = load i16, ptr %arrayidx440, align 2, !tbaa !18
...
if.end451:                                        ; preds = %if.end436
  ...
  %57 = load i32, ptr %budget, align 4, !tbaa !14
  %dec = add nsw i32 %57, -1
  store i32 %dec, ptr %budget, align 4, !tbaa !14
...
; Function Attrs: nounwind
declare i64 @fwrite(ptr nocapture, i64, i64, ptr nocapture) #7

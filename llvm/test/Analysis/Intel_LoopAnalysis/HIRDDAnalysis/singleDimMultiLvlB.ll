...
;  Loop can be vectorized because the output dep is lexically forward 
;  do i=1, n
;     do j=1,n
;        a(j+1)  = b(j) + 1.0
;        a(j)   =  b(j)  ! can be vectorized    
;       enddo
;    enddo
...
;Module Before HIR
; ModuleID = 'singleDimMultiLvlB.f90'
source_filename = "singleDimMultiLvlB.f90"
...
do.body6:                                         ; preds = %do.body2, %do.body6
  ...
  %"sub_$A[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$A", i64 %indvars.iv.next), !llfort.type_idx !5
  store float %add.1, ptr %"sub_$A[]", align 1, !tbaa !8
  %"sub_$A[]6" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$A", i64 %indvars.iv), !llfort.type_idx !5
  store float %"sub_$B[]_fetch.6", ptr %"sub_$A[]6", align 1, !tbaa !8

...
for.body.3:                                       ; preds = %for.inc.21, %for.cond.1.preheader
  ...
  store float 0.000000e+00, ptr %arrayidx5, align 4, !tbaa !1
  br label %for.body.8
...
for.body.8:                                       ; preds = %for.body.8, %for.body.3
  ...
  %0 = load float, ptr %arrayidx12, align 4, !tbaa !1
  %arrayidx16 = getelementptr inbounds [100000 x [100000 x float]], ptr @B, i64 0, i64 %indvars.iv, i64 %indvars.iv44
  %1 = load float, ptr %arrayidx16, align 4, !tbaa !1
  %mul = fmul float %0, %1
  %2 = load float, ptr %arrayidx5, align 4, !tbaa !1
  %add = fadd float %2, %mul
  store float %add, ptr %arrayidx5, align 4, !tbaa !1

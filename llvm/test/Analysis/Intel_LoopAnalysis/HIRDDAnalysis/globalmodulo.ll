...
for.cond1.preheader:                              ; preds = %for.cond.cleanup3, %entry
  ...
  %B.025 = phi ptr [ @Bg, %entry ], [ %cond9, %for.cond.cleanup3 ]
  %A.024 = phi ptr [ @Ag, %entry ], [ %cond, %for.cond.cleanup3 ]
  br label %for.body4
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %cond9 = select i1 %tobool, ptr @Bg, ptr @Ag
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %arrayidx = getelementptr inbounds float, ptr %B.025, i64 %indvars.iv
  %0 = load float, ptr %arrayidx, align 4
  %add = fadd float %0, 1.000000e+00
  %arrayidx6 = getelementptr inbounds float, ptr %A.024, i64 %indvars.iv

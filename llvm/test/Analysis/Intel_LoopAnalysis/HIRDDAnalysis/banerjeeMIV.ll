...
; RUN: opt -aa-pipeline="type-based-aa,scoped-noalias-aa" -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert"  -S -debug-only=parvec-analysis < %s 2>&1 | FileCheck %s
;

...
define dso_local void @foo1(i64 %n, ptr nocapture %A, i64 %k) local_unnamed_addr {
entry:
...
for.body6.us:                                     ; preds = %for.cond3.preheader.us, %for.body6.us
  ...
  %arrayidx.us = getelementptr inbounds i32, ptr %A, i64 %add7.us
  %0 = load i32, ptr %arrayidx.us, align 4
  %add8.us = add nsw i32 %0, 1
  store i32 %add8.us, ptr %arrayidx.us, align 4
...
; Function Attrs: nofree norecurse nosync nounwind uwtable
define dso_local void @foo2(i64 %n, ptr nocapture %A, ptr nocapture readonly %p) local_unnamed_addr {
entry:
...
for.body6.us:                                     ; preds = %for.cond3.preheader.us, %for.body6.us
  ...
  %arrayidx.us = getelementptr inbounds i64, ptr %p, i64 %j2.025.us
  %0 = load i64, ptr %arrayidx.us, align 8
  %add7.us = add nsw i64 %add.us, %0
  %arrayidx8.us = getelementptr inbounds i32, ptr %A, i64 %add7.us
  %1 = load i32, ptr %arrayidx8.us, align 4

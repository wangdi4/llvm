...
bb4:                                              ; preds = %bb4, %alloca_0
  ...
  %A14_ = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul, ptr elementtype(float) %A, i64 %0)
  %A14__ = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(float) %A14_, i64 %indvars.iv)
  store float %add5, ptr %A14__, align 1

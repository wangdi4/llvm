...
bb4:                                              ; preds = %bb4, %alloca_0
  ...
  %A14_ = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %mul, float* elementtype(float) %A, i64 %0)
  %A14__ = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* elementtype(float) %A14_, i64 %indvars.iv)

...
define i32 @_Z3subPjj(ptr nocapture %b, i32 %deg) #0 {
entry:
  %sub = add i32 %deg, -1
  %add5 = add i32 %deg, 1
  br label %for.body
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx2 = getelementptr inbounds i32, ptr %b, i64 %indvars.iv.next
  store i32 %mul, ptr %arrayidx2, align 4, !tbaa !1
  %mul6 = mul i32 %0, %add5
  ...
  store i32 %mul6, ptr %arrayidx9, align 4, !tbaa !1

...
define void @sub1(ptr nocapture %A, i32 %n) local_unnamed_addr #0 {
entry:
  %B = alloca [1000 x float], align 16
  %0 = bitcast ptr %B to ptr
  call void @llvm.lifetime.start.p0(i64 4000, ptr nonnull %0) #2
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx = getelementptr inbounds [1000 x float], ptr %B, i64 0, i64 %2
  %3 = load float, ptr %arrayidx, align 8, !tbaa !1
...
for.body4:                                        ; preds = %for.body4.preheader, %for.body4
  ...
  %arrayidx8 = getelementptr inbounds [1000 x float], ptr %B, i64 0, i64 %idxprom7
  %6 = load float, ptr %arrayidx8, align 4, !tbaa !1
  %add9 = fadd float %6, 1.000000e+00
  store float %add9, ptr %arrayidx8, align 4, !tbaa !1
...
for.end12:                                        ; preds = %for.end12.loopexit, %entry, %for.cond1.preheader
  call void @llvm.lifetime.end.p0(i64 4000, ptr nonnull %0) #2
  ret void
}

...
define void @bar_(ptr noalias nocapture readonly dereferenceable(4) %"bar_$A") local_unnamed_addr #0 !llfort.type_idx !1 {
bb15:
  %"var$7" = alloca [2 x i64], align 16, !llfort.type_idx !2
  %"(ptr)var$7$" = getelementptr inbounds [2 x i64], ptr %"var$7", i64 0, i64 0
  %"var$7[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 8, ptr nonnull elementtype(i64) %"(ptr)var$7$", i64 0), !llfort.type_idx !3
  store i64 3, ptr %"var$7[]", align 8, !tbaa !4
  %"var$7[]10" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 8, ptr nonnull elementtype(i64) %"(ptr)var$7$", i64 1), !llfort.type_idx !8
  store i64 2, ptr %"var$7[]10", align 8, !tbaa !4
  %"var$161853" = alloca [6 x i32], align 4
  %"var$161853.sub" = getelementptr inbounds [6 x i32], ptr %"var$161853", i64 0, i64 0
...
loop_body18:                                      ; preds = %loop_test17.preheader, %loop_body18
  ...
  %"var$1618[][][]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(i32) %"var$1618[][]", i64 %"$loop_ctr2.055"), !llfort.type_idx !10
  %"bar_$A_entry[][][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(i32) %"bar_$A_entry[][]", i64 %"$loop_ctr2.055"), !llfort.type_idx !11
  %"bar_$A_entry[][][]_fetch.7" = load i32, ptr %"bar_$A_entry[][][]", align 1, !tbaa !12, !llfort.type_idx !14
...
loop_test17.preheader:                            ; preds = %loop_test21.preheader, %loop_exit19
  ...
  %"var$1618[][]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 0, ptr nonnull elementtype(i32) %"var$1618[]19", i64 %"$loop_ctr3.056"), !llfort.type_idx !15
  %"bar_$A_entry[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 12, ptr nonnull elementtype(i32) %"bar_$A_entry[]", i64 %"$loop_ctr3.056"), !llfort.type_idx !16
...
loop_test21.preheader:                            ; preds = %loop_test21.preheader.preheader, %loop_exit23
  ...
  %"var$1618[]19" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 12, ptr nonnull elementtype(i32) %"var$161853.sub", i64 %"$loop_ctr4.057"), !llfort.type_idx !17
  %"bar_$A_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 48, ptr nonnull elementtype(i32) %"bar_$A", i64 %"$loop_ctr4.057"), !llfort.type_idx !18, !ifx.array_extent !19
...
loop_body30:                                      ; preds = %loop_test29.preheader, %loop_body30
  ...
  %"bar_$SUM2[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(i32) %"bar_$SUM2[]", i64 %"$loop_ctr.058"), !llfort.type_idx !21
  store i32 %"var$1618[][]_fetch.47", ptr %"bar_$SUM2[][]", align 4, !tbaa !22
...
loop_test29.preheader:                            ; preds = %loop_test29.preheader.preheader, %loop_exit31
  ...
  %"var$1618[]20" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 12, ptr nonnull elementtype(i32) %"var$161853.sub", i64 %"$loop_ctr1.059"), !llfort.type_idx !24
  %"bar_$SUM2[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 12, ptr elementtype(i32) @"bar_$SUM2", i64 %"$loop_ctr1.059"), !llfort.type_idx !25, !ifx.array_extent !19

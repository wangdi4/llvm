...
for.body.us:                                      ; preds = %for.inc.us, %for.body.us.preheader
  ...
  store i32 %inc.us, ptr @g_y, align 4
  br i1 %tobool, label %for.inc.us, label %if.then2.us

if.then2.us:                                      ; preds = %for.body.us
  %5 = load i32, ptr @g_xau, align 4
  %inc3.us = add nsw i32 %5, 1
  store i32 %inc3.us, ptr @g_xau, align 4
  %6 = load volatile i32, ptr @g_yf, align 4
  %inc4.us = add i32 %6, 1
  store volatile i32 %inc4.us, ptr @g_yf, align 4
  %inc5.us = add nsw i32 %4, 2
  store i32 %inc5.us, ptr @g_y, align 4
  br i1 %tobool6, label %if.else.us, label %if.then7.us

if.then7.us:                                      ; preds = %if.then2.us
  %7 = load i32, ptr @a1_x_0, align 4
  %xor.us = xor i32 %7, 1
  store i32 %xor.us, ptr @a1_x_0, align 4
  br label %if.end.us

if.else.us:                                       ; preds = %if.then2.us
  %idxprom.us = sext i32 %3 to i64
  %arrayidx.us = getelementptr inbounds [0 x i32], ptr @a2_gfnls, i64 0, i64 %idxprom.us
  %8 = load i32, ptr %arrayidx.us, align 4
  %inc8.us = add nsw i32 %8, 1
  store i32 %inc8.us, ptr %arrayidx.us, align 4
  br label %if.end.us

if.end.us:                                        ; preds = %if.else.us, %if.then7.us
  %9 = load i32, ptr @main_v_mjl, align 4
  %dec.us = add nsw i32 %9, -1
  store i32 %dec.us, ptr @main_v_mjl, align 4
  br label %for.inc.us

for.inc.us:                                       ; preds = %if.end.us, %for.body.us
  %10 = phi i32 [ %inc5.us, %if.end.us ], [ %inc.us, %for.body.us ]
  %inc11.us = add nsw i32 %3, 1
  store i32 %inc11.us, ptr @main_v_wu, align 4

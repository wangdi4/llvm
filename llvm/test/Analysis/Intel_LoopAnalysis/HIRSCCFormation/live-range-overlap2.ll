...
for.body:                                         ; preds = %for.cond.backedge, %entry
  ...
  %arrayidx = getelementptr inbounds [100 x i32], ptr %lh, i64 0, i64 %indvars.iv257
  store i32 0, ptr %arrayidx, align 4
  %1 = add nsw i64 %indvars.iv257, -1
  %arrayidx10 = getelementptr inbounds [100 x i32], ptr %xa, i64 0, i64 %1
...
if.then:                                          ; preds = %for.body
  %arrayidx18 = getelementptr inbounds [100 x i32], ptr %t5, i64 0, i64 %1
  %5 = load i32, ptr %arrayidx18, align 4
  %sub19 = sub i32 %5, %2
  store i32 %sub19, ptr %arrayidx18, align 4
  store i32 %sub11, ptr %arrayidx, align 4
  %arrayidx29 = getelementptr inbounds [100 x i32], ptr %t5, i64 0, i64 %indvars.iv.next258
  %6 = load i32, ptr %arrayidx29, align 4
  %add31 = add i32 %add, %6
  store i32 %add31, ptr %s, align 4
  %arrayidx34 = getelementptr inbounds [100 x i32], ptr %m8, i64 0, i64 %indvars.iv.next258
  %7 = load i32, ptr %arrayidx34, align 4
  %8 = load i32, ptr %w, align 4
  %add35 = add i32 %8, %7
  store i32 %add35, ptr %w, align 4
  %arrayidx38 = getelementptr inbounds [100 x i32], ptr %z5, i64 0, i64 %1
...
if.then40:                                        ; preds = %if.then
  ...
  store i32 %mul42, ptr %d1, align 4
  %arrayidx44 = getelementptr inbounds [100 x i32], ptr %z5, i64 0, i64 %indvars.iv257
  %11 = load i32, ptr %arrayidx44, align 4
  %sub48 = sub i32 %sub19, %11
  store i32 %sub48, ptr %arrayidx18, align 4
  %add52 = add i32 %add35, %9
  store i32 %add52, ptr %w, align 4
  %arrayidx54 = getelementptr inbounds [100 x i32], ptr %m8, i64 0, i64 %indvars.iv257
  %12 = load i32, ptr %arrayidx54, align 4
  %arrayidx57 = getelementptr inbounds [100 x i32], ptr %y, i64 0, i64 %indvars.iv.next258
  store i32 %12, ptr %arrayidx57, align 4
  %13 = load i32, ptr %n8, align 4
  %sub60 = sub i32 %13, %11
  store i32 %sub60, ptr %n8, align 4

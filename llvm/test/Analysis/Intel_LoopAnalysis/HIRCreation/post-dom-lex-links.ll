...
for.body:                                         ; preds = %if.end.977, %for.body.preheader
  ...
  store i32 31, ptr @gcnt2, align 4
  store i32 -2147483648, ptr @gmask, align 4
...
if.end.343.thread4166:                            ; preds = %land.lhs.true.337
  %call341 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 340)
  %call342 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 31, i32 1)
...
if.then.350:                                      ; preds = %if.end.343, %if.end.343.thread
  %call351 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.3, i32 340)
  %call352 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 31, i32 1)
  store i32 1, ptr @failed, align 4
  br label %if.end.363
...
if.then.380:                                      ; preds = %land.lhs.true.377
  %call381 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.6, i32 340)
  %call382 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 31, i32 1)
  store i32 1, ptr @failed, align 4
  br label %if.end.383
...
if.then.412:                                      ; preds = %land.lhs.true.387
  %call391 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 340)
  %call392 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 31, i32 1)
  store i32 1, ptr @failed, align 4
  store i32 31, ptr @gcnt2, align 4
  store i32 -2147483648, ptr @gmask, align 4
  %call413 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 341)
  %call414 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 31, i32 0)
  store i32 1, ptr @failed, align 4
...
if.end.445.thread4170:                            ; preds = %land.lhs.true.439
  %call443 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.4, i32 341)
  %call444 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 31, i32 0)
  store i32 1, ptr @failed, align 4
  store i32 31, ptr @gcnt2, align 4
  store i32 -2147483648, ptr @gmask, align 4
  br label %if.end.475
...
if.then.452:                                      ; preds = %if.end.445, %if.end.445.thread
  %call453 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.5, i32 341)
  %call454 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 31, i32 0)
  store i32 1, ptr @failed, align 4
  br label %if.end.475
...
if.then.482:                                      ; preds = %if.end.475
  %call483 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 341)
  %call484 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 31, i32 0)
  store i32 1, ptr @failed, align 4
  br label %if.end.567

if.end.567:                                       ; preds = %if.then.482, %if.end.475
  store i32 30, ptr @gcnt2, align 4
  store i32 -2147483648, ptr @gmask, align 4
...
if.then.576:                                      ; preds = %land.lhs.true.573
  %call577 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 343)
  %call578 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 30, i32 0)
  store i32 1, ptr @failed, align 4
  store i32 30, ptr @gcnt2, align 4
  store i32 -2147483648, ptr @gmask, align 4
  %call617 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.5, i32 343)
  %call618 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 30, i32 0)
  store i32 1, ptr @failed, align 4
...
if.then.606:                                      ; preds = %land.lhs.true.603
  %call607 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.4, i32 343)
  %call608 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 30, i32 0)
  store i32 1, ptr @failed, align 4
  store i32 30, ptr @gcnt2, align 4
  store i32 -2147483648, ptr @gmask, align 4
  %call647 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 343)
  %call648 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -2147483648, i32 30, i32 0)
  store i32 1, ptr @failed, align 4
  br label %if.end.649
...
if.end.649:                                       ; preds = %if.end.649.critedge, %if.end.639.thread, %if.then.606
  store i32 24, ptr @gcnt2, align 4
  store i32 -285212672, ptr @gmask, align 4
...
if.end.671.thread:                                ; preds = %land.lhs.true.655
  %call659 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 345)
  %call660 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -285212672, i32 24, i32 79)
  store i32 1, ptr @failed, align 4
  br label %if.end.701.thread

land.lhs.true.685:                                ; preds = %land.lhs.true.665
  %call669 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 345)
  %call670 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -285212672, i32 24, i32 79)
  store i32 1, ptr @failed, align 4
  br label %if.end.711
...
if.then.718:                                      ; preds = %if.end.711.thread
  %call719 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 345)
  %call720 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -285212672, i32 24, i32 79)
  store i32 1, ptr @failed, align 4
  br label %if.end.721
...
if.then.728:                                      ; preds = %if.end.721, %if.end.711
  %call729 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 345)
  %call730 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -285212672, i32 24, i32 79)
  store i32 1, ptr @failed, align 4
  br label %if.end.731

if.end.731:                                       ; preds = %if.then.728, %if.end.721, %if.end.711
  store i32 24, ptr @gcnt2, align 4
  store i32 -822083584, ptr @gmask, align 4
...
if.end.753.thread:                                ; preds = %land.lhs.true.737
  %call741 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 346)
  %call742 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -822083584, i32 24, i32 143)
  store i32 1, ptr @failed, align 4
  br label %if.end.783.thread

land.lhs.true.767:                                ; preds = %land.lhs.true.747
  %call751 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 346)
  %call752 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -822083584, i32 24, i32 143)
  store i32 1, ptr @failed, align 4
  br label %if.end.793
...
if.then.800:                                      ; preds = %if.end.793.thread
  %call801 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 346)
  %call802 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -822083584, i32 24, i32 143)
  store i32 1, ptr @failed, align 4
  br label %if.end.803
...
if.then.810:                                      ; preds = %if.end.803, %if.end.793
  %call811 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 346)
  %call812 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -822083584, i32 24, i32 143)
  store i32 1, ptr @failed, align 4
  br label %if.end.813

if.end.813:                                       ; preds = %if.then.810, %if.end.803, %if.end.793
  store i32 24, ptr @gcnt2, align 4
  store i32 -1358954496, ptr @gmask, align 4
...
if.end.835.thread:                                ; preds = %land.lhs.true.819
  %call823 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 347)
  %call824 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -1358954496, i32 24, i32 112)
  store i32 1, ptr @failed, align 4
  br label %if.end.865.thread

land.lhs.true.849:                                ; preds = %land.lhs.true.829
  %call833 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 347)
  %call834 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -1358954496, i32 24, i32 112)
  store i32 1, ptr @failed, align 4
  br label %if.end.875
...
if.then.882:                                      ; preds = %if.end.875.thread
  %call883 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 347)
  %call884 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -1358954496, i32 24, i32 112)
  store i32 1, ptr @failed, align 4
  br label %if.end.885
...
if.then.892:                                      ; preds = %if.end.885, %if.end.875
  %call893 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 347)
  %call894 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.1, i32 %x.04084, i32 -1358954496, i32 24, i32 112)
  store i32 1, ptr @failed, align 4
  br label %if.end.977

if.end.977:                                       ; preds = %if.then.892, %if.end.885, %if.end.875
  store i32 24, ptr @gcnt2, align 4
  store i32 -1090519040, ptr @gmask, align 4
...
if.end.1422:                                      ; preds = %if.end.2361, %for.body.984.preheader
  ...
  store i32 31, ptr @gcnt2, align 4
  store i64 -2147483648, ptr @glmask, align 8
...
if.end.1513:                                      ; preds = %if.end.1448, %if.end.1422
  store i32 27, ptr @gcnt2, align 4
  store i64 -1879048192, ptr @glmask, align 8
...
if.end.1541.thread:                               ; preds = %land.lhs.true.1521
  %call1526 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 358)
  %call1527 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048192, i32 27, i64 3)
  br label %if.end.1580.thread

land.lhs.true.1560:                               ; preds = %land.lhs.true.1534
  %call1539 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 358)
  %call1540 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048192, i32 27, i64 3)
  br label %if.end.1593
...
if.then.1603:                                     ; preds = %if.end.1593.thread
  %call1604 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 358)
  %call1605 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048192, i32 27, i64 3)
...
if.then.1616:                                     ; preds = %if.end.1606, %if.end.1593
  %call1617 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 358)
  %call1618 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048192, i32 27, i64 3)
  br label %if.end.1619

if.end.1619:                                      ; preds = %if.then.1616, %if.end.1606, %if.end.1593
  store i32 26, ptr @gcnt2, align 4
  store i64 -268435456, ptr @glmask, align 8
...
if.end.1647.thread:                               ; preds = %land.lhs.true.1627
  %call1632 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 359)
  %call1633 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -268435456, i32 26, i64 16)
  br label %if.end.1686.thread

land.lhs.true.1666:                               ; preds = %land.lhs.true.1640
  %call1645 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 359)
  %call1646 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -268435456, i32 26, i64 16)
  br label %if.end.1699
...
if.then.1709:                                     ; preds = %if.end.1699.thread
  %call1710 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 359)
  %call1711 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -268435456, i32 26, i64 16)
...
if.then.1722:                                     ; preds = %if.end.1712, %if.end.1699
  %call1723 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 359)
  %call1724 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -268435456, i32 26, i64 16)
  br label %if.end.1725

if.end.1725:                                      ; preds = %if.then.1722, %if.end.1712, %if.end.1699
  store i32 24, ptr @gcnt2, align 4
  store i64 -134217728, ptr @glmask, align 8
...
if.end.1753.thread:                               ; preds = %land.lhs.true.1733
  %call1738 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 360)
  %call1739 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -134217728, i32 24, i64 240)
  br label %if.end.1792.thread

land.lhs.true.1772:                               ; preds = %land.lhs.true.1746
  %call1751 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 360)
  %call1752 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -134217728, i32 24, i64 240)
  br label %if.end.1805
...
if.then.1815:                                     ; preds = %if.end.1805.thread
  %call1816 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 360)
  %call1817 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -134217728, i32 24, i64 240)
...
if.then.1828:                                     ; preds = %if.end.1818, %if.end.1805
  %call1829 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 360)
  %call1830 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -134217728, i32 24, i64 240)
  br label %if.end.1831

if.end.1831:                                      ; preds = %if.then.1828, %if.end.1818, %if.end.1805
  store i32 1, ptr @gcnt2, align 4
  store i64 -1879048194, ptr @glmask, align 8
...
if.end.1859.thread:                               ; preds = %land.lhs.true.1839
  %call1844 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 362)
  %call1845 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048194, i32 1, i64 3458764513820540928)
  br label %if.end.1937

land.lhs.true.1878:                               ; preds = %land.lhs.true.1852
  %call1857 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 362)
  %call1858 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048194, i32 1, i64 3458764513820540928)
  br label %if.end.1911
...
if.then.1934:                                     ; preds = %land.lhs.true.1930
  %call1935 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 362)
  %call1936 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048194, i32 1, i64 3458764513820540928)
...
if.then.1962:                                     ; preds = %land.lhs.true.1958
  %call1963 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 363)
  %call1964 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048194, i32 1, i64 8070450532247928832)
...
if.then.1988:                                     ; preds = %land.lhs.true.1984
  %call1989 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.4, i32 363)
  %call1990 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048194, i32 1, i64 8070450532247928832)
  br label %if.end.1991.thread.thread
...
if.then.2027:                                     ; preds = %if.end.2017.thread
  %call2028 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 363)
  %call2029 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048194, i32 1, i64 8070450532247928832)
...
if.then.2040:                                     ; preds = %if.end.2030, %if.end.2017
  %call2041 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 363)
  %call2042 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048194, i32 1, i64 8070450532247928832)
  br label %if.end.2043

if.end.2043:                                      ; preds = %if.then.2040, %if.end.2030, %if.end.2017
  store i32 2, ptr @gcnt2, align 4
  store i64 -1879048198, ptr @glmask, align 8
...
if.end.2071.thread:                               ; preds = %land.lhs.true.2051
  %call2056 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 364)
  %call2057 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048198, i32 2, i64 3458764513820540928)
  br label %if.end.2110.thread

land.lhs.true.2090:                               ; preds = %land.lhs.true.2064
  %call2069 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 364)
  %call2070 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048198, i32 2, i64 3458764513820540928)
  br label %if.end.2123
...
if.then.2133:                                     ; preds = %if.end.2123.thread
  %call2134 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 364)
  %call2135 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048198, i32 2, i64 3458764513820540928)
...
if.then.2146:                                     ; preds = %if.end.2136, %if.end.2123
  %call2147 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 364)
  %call2148 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048198, i32 2, i64 3458764513820540928)
  br label %if.end.2149

if.end.2149:                                      ; preds = %if.then.2146, %if.end.2136, %if.end.2123
  store i32 2, ptr @gcnt2, align 4
  store i64 -1879048196, ptr @glmask, align 8
...
if.end.2177.thread:                               ; preds = %land.lhs.true.2157
  %call2162 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str, i32 365)
  %call2163 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048196, i32 2, i64 3458764513820540928)
  br label %if.end.2216.thread

land.lhs.true.2196:                               ; preds = %land.lhs.true.2170
  %call2175 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.2, i32 365)
  %call2176 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048196, i32 2, i64 3458764513820540928)
  br label %if.end.2229
...
if.then.2239:                                     ; preds = %if.end.2229.thread
  %call2240 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.7, i32 365)
  %call2241 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048196, i32 2, i64 3458764513820540928)
...
if.then.2252:                                     ; preds = %if.end.2242, %if.end.2229
  %call2253 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.8, i32 365)
  %call2254 = tail call i32 (ptr, ...) @printf(ptr nonnull @.str.9, i64 %lx.04080, i64 -1879048196, i32 2, i64 3458764513820540928)

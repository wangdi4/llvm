...
; CHECK:    %add = %s.015  +  %0;  <Safe Reduction>
; CHECK:    %s.015 = %add  +  %add3; <Safe Reduction>
;
; ModuleID = 'sum3.c'
...
define i32 @sub(ptr nocapture readonly %a, ptr nocapture readonly %b, i32 %n1, i32 %n2, i32 %n3) #0 {
entry:
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  ...
  %call = tail call i32 (ptr, ...) @printf(ptr @.str, double %s.0.lcssa)
  ret i32 0

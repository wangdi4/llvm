...
define void @sub_(i32* noalias nocapture readonly dereferenceable(4) %"sub_$A", i32* noalias nocapture dereferenceable(4) %"sub_$S", i32* noalias nocapture readonly dereferenceable(4) %"sub_$N", i32* noalias nocapture readonly dereferenceable(4) %"sub_$V") local_unnamed_addr #0 {
alloca_0:
  %"sub_$V_fetch.1" = load i32, i32* %"sub_$V", align 1
  store i32 %"sub_$V_fetch.1", i32* %"sub_$S", align 1
  %"sub_$N_fetch.2" = load i32, i32* %"sub_$N", align 1
...
bb2:                                              ; preds = %bb2.preheader, %bb2
  ...
  %"sub_$A_entry[]" = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull elementtype(i32) %"sub_$A", i64 %indvars.iv)
  %"sub_$A_entry[]_fetch.6" = load i32, i32* %"sub_$A_entry[]", align 1
...
bb3.loopexit:                                     ; preds = %bb2
  ...
  store i32 %div.1.lcssa, i32* %"sub_$S", align 1
  br label %bb3

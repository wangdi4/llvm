...
for.body:                                         ; preds = %entry, %for.body
  ...
  %s.020 = phi float [ %add4, %for.body ], [ 0.000000e+00, %entry ]
  %arrayidx = getelementptr inbounds float, float* %a, i64 %indvars.iv
  %0 = load float, float* %arrayidx, align 4, !tbaa !1
  %add = fadd float %s.020, %0
  ...
  %arrayidx7 = getelementptr inbounds [1000 x i32], [1000 x i32]* @c, i64 0, i64 %indvars.iv
  store i32 %conv5, i32* %arrayidx7, align 4, !tbaa !5

...
define i32 @sub(ptr nocapture %a, ptr nocapture readnone %b, i32 %n1, i32 %n2, i32 %n3) #0 {
entry:
...
for.body9.lr.ph:                                  ; preds = %for.body4
  %arrayidx11 = getelementptr inbounds [1000 x float], ptr @d, i64 0, i64 %indvars.iv82
  br label %for.body9
...
for.body9:                                        ; preds = %for.body9, %for.body9.lr.ph
  ...
  %1 = load float, ptr %arrayidx11, align 4, !tbaa !1
  %add12 = fadd float %1, 2.000000e+00
  %arrayidx14 = getelementptr inbounds float, ptr %a, i64 %indvars.iv74
  %2 = load float, ptr %arrayidx14, align 4, !tbaa !1
  %add15 = fadd float %2, %add12
  store float %add15, ptr %arrayidx14, align 4, !tbaa !1
...
for.cond.cleanup22:                               ; preds = %for.body23
  %arrayidx31 = getelementptr inbounds [1000 x float], ptr @d, i64 0, i64 %indvars.iv82
  %3 = load float, ptr %arrayidx31, align 4, !tbaa !1
  %add32 = fadd float %add26, %3
  store float %add32, ptr %arrayidx31, align 4, !tbaa !1
...
for.body23:                                       ; preds = %for.body9, %for.body23
  ...
  %arrayidx25 = getelementptr inbounds float, ptr %a, i64 %indvars.iv78
  %4 = load float, ptr %arrayidx25, align 4, !tbaa !1

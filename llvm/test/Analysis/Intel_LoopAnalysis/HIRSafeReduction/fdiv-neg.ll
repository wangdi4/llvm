...
alloca_0:
  %"sub_$V_fetch.1" = load float, ptr %"sub_$V", align 1, !tbaa !1, !llfort.type_idx !6
  store float %"sub_$V_fetch.1", ptr %"sub_$S", align 1, !tbaa !7
...
bb2:                                              ; preds = %bb2.preheader, %bb2
  ...
  %"sub_$A_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$A", i64 %indvars.iv), !llfort.type_idx !12
  %"sub_$A_entry[]_fetch.5" = load float, ptr %"sub_$A_entry[]", align 1, !tbaa !13, !llfort.type_idx !15
...
bb3.loopexit:                                     ; preds = %bb2
  ...
  store float %div.1.lcssa, ptr %"sub_$S", align 1, !tbaa !7
  br label %bb3

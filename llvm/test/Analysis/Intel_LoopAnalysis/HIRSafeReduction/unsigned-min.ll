...
;  return min;
;}
; unsigned min recognition for safe reduction analysis
;
...
;
; CHECK:   %min.011 = (%0 <u %min.011) ? %0 : %min.011; <Safe Reduction>
;
;Module Before HIR
; ModuleID = 't3.c'
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %min.011 = phi i32 [ 255, %entry ], [ %spec.select, %for.body ]
  %arrayidx = getelementptr inbounds [1024 x i32], [1024 x i32]* @a, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %0 = load i32, i32* %arrayidx, align 4, !tbaa !2
  %cmp1 = icmp ult i32 %0, %min.011
  %spec.select = select i1 %cmp1, i32 %0, i32 %min.011

...
; negative case for 'min' recognition for safe reduction analysis, multiple uses of 'j'
...
;Module Before HIR; ModuleID = 'min4.c'
source_filename = "min4.c"
...
for.body:                                         ; preds = %for.body, %entry
  ...
  store i32 %j.016, ptr %arrayidx, align 4, !tbaa !1

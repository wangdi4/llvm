; RUN: opt < %s -hir-create-function-level-region -hir-ssa-deconstruction -analyze -hir-framework -hir-framework-debug=parser -hir-details | FileCheck %s
...
for.body3:                                        ; preds = %for.body3.preheader, %for.body3
  ...
  store i32 %tA, i32* %ptridx5, align 4

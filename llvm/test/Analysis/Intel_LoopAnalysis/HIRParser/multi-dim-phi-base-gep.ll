...
define i32 @doit(ptr nocapture readonly %inp) {
entry:
  br label %for.body
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %ref.06 = phi ptr [ %inp, %entry ], [ %incdec.ptr, %for.body ]
  %incdec.ptr = getelementptr inbounds [32 x i32], ptr %ref.06, i32 1
  %arraydecay = getelementptr inbounds [32 x i32], ptr %ref.06, i32 0, i32 0

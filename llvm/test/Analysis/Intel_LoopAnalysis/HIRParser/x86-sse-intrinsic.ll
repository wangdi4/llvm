...
define dso_local noundef float @_Z8Max_IntrPfiPi(ptr noundef %src, i32 noundef %n, ptr nocapture noundef readnone %position) local_unnamed_addr #0 {
entry:
  ...
  %src.val = load <4 x float>, ptr %1, align 1, !tbaa !4
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %2 = load float, ptr %arrayidx8, align 4, !tbaa !7
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  ...
  %add.ptr = getelementptr inbounds float, ptr %src, i32 %n, !intel-tbaa !7
  %add.ptr39 = getelementptr inbounds float, ptr %add.ptr, i32 -4, !intel-tbaa !7
  %6 = bitcast ptr %add.ptr39 to ptr
  %add.ptr39.val = load <4 x float>, ptr %6, align 1, !tbaa !4
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %add.ptr35 = getelementptr inbounds float, ptr %arrayidx8, i32 %nextFour.0119, !intel-tbaa !7
  %23 = bitcast ptr %add.ptr35 to ptr
  %add.ptr35.val = load <4 x float>, ptr %23, align 16, !tbaa !4

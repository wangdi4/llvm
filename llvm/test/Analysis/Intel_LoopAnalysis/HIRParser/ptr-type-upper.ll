; RUN: opt -opaque-pointers=0 < %s -passes="hir-ssa-deconstruction,print<hir-framework>" -disable-output 2>&1 | FileCheck %s
...
while.body67.i:                                   ; preds = %while.body67.i, %entry
  %in.addr.4444.i = phi i8* [ %incdec.ptr69.i, %while.body67.i ], [ %in.addr.3454.i, %entry ]
  ...
  %incdec.ptr69.i = getelementptr inbounds i8, i8* %in.addr.4444.i, i64 1
  %ld = load i8, i8* %in.addr.4444.i, align 1
  ...
  %cmp66.i = icmp ult i8* %incdec.ptr69.i, %add.ptr2.i
...
while.end73.i.loopexit:                           ; preds = %while.body67.i
  %incdec.ptr69.i.lcssa = phi i8* [ %incdec.ptr69.i, %while.body67.i ]

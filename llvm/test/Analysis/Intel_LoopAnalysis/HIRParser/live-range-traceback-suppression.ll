...
define void @DeriveHuffmanTable(ptr %p, ptr %q, ptr %r) {
entry:
...
for.body.52:                                      ; preds = %entry, %for.inc.64
  ...
  %arrayidx53 = getelementptr inbounds i8, ptr %p, i32 %length_index.1185
  %0 = load i8, ptr %arrayidx53, align 1
  %tobool54 = icmp eq i8 %0, 0
  br i1 %tobool54, label %for.inc.64, label %if.then.55

if.then.55:                                       ; preds = %for.body.52
  %arrayidx56 = getelementptr inbounds [257 x i32], ptr %huffcode, i32 0, i32 %index.4184
  %1 = load i32, ptr %arrayidx56, align 4
  %sub = sub nsw i32 %index.4184, %1
  %arrayidx57 = getelementptr inbounds i32, ptr %q, i32 %length_index.1185
  store i32 %sub, ptr %arrayidx57, align 4
  %2 = load i8, ptr %arrayidx53, align 1
  %conv = zext i8 %2 to i32
  %add = add nsw i32 %conv, %index.4184
  %sub59 = add nsw i32 %add, -1
  %arrayidx60 = getelementptr inbounds [257 x i32], ptr %huffcode, i32 0, i32 %sub59
  %3 = load i32, ptr %arrayidx60, align 4
  br label %for.inc.64
...
for.inc.64:                                       ; preds = %for.body.52, %if.then.55
  ...
  %4 = getelementptr inbounds i32, ptr %r, i32 %length_index.1185

...
; [0:i3:1200(ptr:33)] from %tmp1968

;         + DO i1 = 0, %tmp1876 + -2, 1   <DO_LOOP>
;         |   %tmp1944.out = %tmp1944;
;         |   %tmp1943.out = %tmp1943;
; CHECK:  |   %tmp1946 = (getelementptr inbounds ([2523968 x i8], ptr @global.40, i64 0, i64 2523600))[0:i1:4(i32:30)];
;         |   %tmp1944 = %tmp1946 + %tmp1944.out  +  1;
;         |   if (%tmp1944 >= %tmp1943)
;         |   {
; CHECK:  |      %tmp1953 = (getelementptr inbounds ([2523968 x i8], ptr @global.40, i64 0, i64 2523720))[0:i1:8(double:30)];
;         |
...
; CHECK:  |      |   |   %tmp1968 = (getelementptr inbounds ([2523968 x i8], ptr @global.40, i64 0, i64 2484000))[0:i3:1200(double:33)][0:i2 + sext.i32.i64(%tmp1943.out) + -1:8(double:150)];
...
define dso_local void @zot.bb1941(ptr %tmp1940, ptr %tmp1939, i64 %tmp1876) #1 {
newFuncRoot:
  br label %bb1941
...
bb1941:                                           ; preds = %newFuncRoot, %bb1985
  ...
  %tmp1945 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(i32) getelementptr inbounds ([2523968 x i8], ptr @global.40, i64 0, i64 2523600), i64 %tmp1942) #2, !llfort.type_idx !3, !ifx.array_extent !4
  %tmp1946 = load i32, ptr %tmp1945, align 1, !tbaa !5, !alias.scope !10, !noalias !13
...
bb1950:                                           ; preds = %bb1941
  ...
  %tmp1952 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) getelementptr inbounds ([2523968 x i8], ptr @global.40, i64 0, i64 2523720), i64 %tmp1942) #2, !llfort.type_idx !20, !ifx.array_extent !4
  %tmp1953 = load double, ptr %tmp1952, align 1, !tbaa !21, !alias.scope !23, !noalias !24, !llfort.type_idx !25
...
bb1962:                                           ; preds = %bb1962, %bb1961
  ...
  %tmp1966 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 1200, ptr nonnull elementtype(double) getelementptr inbounds ([2523968 x i8], ptr @global.40, i64 0, i64 2484000), i64 %tmp1965) #2, !llfort.type_idx !26, !ifx.array_extent !27
  %tmp1967 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %tmp1966, i64 %tmp1960) #2, !llfort.type_idx !28
  %tmp1968 = load double, ptr %tmp1967, align 1, !tbaa !29, !alias.scope !31, !noalias !32, !llfort.type_idx !33
  %tmp1969 = add nsw i64 %tmp1963, %tmp1954
  %tmp1970 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %tmp1940, i64 %tmp1969) #2, !llfort.type_idx !34
  %tmp1971 = load double, ptr %tmp1970, align 1, !tbaa !35, !alias.scope !37, !noalias !38, !llfort.type_idx !39
...
bb1977:                                           ; preds = %bb1975, %bb1959
  ...
  %tmp1980 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %tmp1939, i64 %tmp1960) #2, !llfort.type_idx !40
  store double %tmp1979, ptr %tmp1980, align 1, !tbaa !41, !alias.scope !43, !noalias !44

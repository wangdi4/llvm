...
define void @main() local_unnamed_addr personality ptr @__gxx_personality_v0 {
entry:
  invoke void @_Znwm()
          to label %for.body unwind label %lpad252

for.body:                              ; preds = %entry, %exit
  %incdec.ptr = phi ptr [ %incdec.ptr.i.i, %exit ], [ undef, %entry ]
  br label %while.body

while.body:                         ; preds = %while.body, %for.body
  %0 = phi ptr [ %incdec.ptr.i, %while.body ], [ undef, %for.body ]
  %1 = phi ptr [ %incdec.ptr.i.i.i, %while.body ], [ %incdec.ptr, %for.body ]
  %incdec.ptr.i.i.i = getelementptr inbounds i32, ptr %1, i64 -1
  %incdec.ptr.i = getelementptr inbounds %"struct.(anonymous namespace)::Int", ptr %0, i64 -1
  %cmp = icmp ne ptr %incdec.ptr.i.i.i, undef
  %cmp.i = icmp ne ptr %incdec.ptr.i, undef
  %lnot = and i1 %cmp.i, %cmp
  br i1 %lnot, label %while.body, label %exit

exit: ; preds = %while.body
  %incdec.ptr.i.i = getelementptr inbounds i32, ptr %incdec.ptr, i64 1

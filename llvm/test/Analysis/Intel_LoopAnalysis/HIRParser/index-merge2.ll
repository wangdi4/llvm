...
define void @foo(ptr nocapture %A, i32 %offset, i32 %n) {
entry:
  %div = lshr i32 %offset, 1
  %add.ptr = getelementptr inbounds i32, ptr %A, i32 %div
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx = getelementptr inbounds i32, ptr %add.ptr, i32 %i.08
  store i32 %i.08, ptr %arrayidx, align 4

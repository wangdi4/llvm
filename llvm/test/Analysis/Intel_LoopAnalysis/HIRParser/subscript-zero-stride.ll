...
loop:
  ...
  %p1 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 3, i64 0, i64 0, ptr elementtype(double) nonnull %p, i64 1)
  %p2 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 0, i64 0, ptr elementtype(double) nonnull %p1, i64 0)
  %p3 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 0, i64 0, ptr elementtype(double) nonnull %p2, i64 0)

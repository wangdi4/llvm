...
entry:
  ...
  %l.0.l.0..sroa_cast = bitcast i32* %l to i8*
  store i32 0, i32* %l, align 4
  %w.sroa.0.0..sroa_cast = bitcast i32* %w.sroa.0 to i8*
  store i32 0, i32* %w.sroa.0, align 16
  br label %for.body

for.body:                                         ; preds = %for.body, %entry
  %pz.035 = phi i32* [ %l, %entry ], [ %w.sroa.0, %for.body ]
  %id7.034 = phi i32 [ 1, %entry ], [ %inc, %for.body ]
  store i32 0, i32* %w.sroa.0, align 16
  store i32 0, i32* %l, align 4
  %0 = load i32, i32* %pz.035, align 4
  %sub = add i32 %0, -1
  store i32 %sub, i32* %pz.035, align 4
  %inc = add nuw nsw i32 %id7.034, 1
  %exitcond = icmp eq i32 %inc, 76
  br i1 %exitcond, label %for.end, label %for.body

for.end:                                          ; preds = %for.body
  %l.0.l.0.23 = load i32, i32* %l, align 4
  %cmp4 = icmp eq i32 %l.0.l.0.23, 0
  br i1 %cmp4, label %if.then, label %if.else

if.then:                                          ; preds = %for.end
  %puts25 = tail call i32 @puts(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.2, i64 0, i64 0))
  br label %if.end

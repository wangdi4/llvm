; RUN: opt < %s -hir-ssa-deconstruction -print-after=hir-ssa-deconstruction -analyze -hir-framework -hir-framework-debug=parser 2>&1 | FileCheck %s
...
for.end:                                      ; preds = %6
  ...
  store i32 %.lcssa, i32* %min, align 4
  br label %exit

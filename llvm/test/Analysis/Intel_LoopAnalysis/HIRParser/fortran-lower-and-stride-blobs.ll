; RUN: opt -opaque-pointers=0 %s -passes="hir-ssa-deconstruction,print<hir-framework>" -hir-framework-debug=parser -disable-output -hir-details -hir-details-dims 2>&1 | FileCheck %s
...
bb60:
  ...
  %t13 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"ul_arg_0.0_GEPs_$field6$_$field1$", i32 0)
  %t14 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"ul_arg_0.0_GEPs_$field6$_$field1$", i32 1)
  br label %bb64
...
bb64:                                             ; preds = %bb64, %bb60
  ...
  %t19 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 4, i32* elementtype(i32) %"ul_arg_0.0_GEPs_$field0$33", i64 %indvars.iv2486)
  %t20 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 %t17, i64 %t18, i32* elementtype(i32) %t19, i64 %t)

...
define void @foo([1024 x i32]* %i, i32* %arg3, i32 %i19, i32 %i45, i32 %i46) {
entry:
  br label %bb50

bb50:                                             ; preds = %bb70, %entry
  %i51 = phi i64 [ 0, %entry ], [ %i53, %bb70 ]
  %i52 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.NORMALIZED.IV"(i8* null), "QUAL.OMP.NORMALIZED.UB"(i8* null)]
...
bb58:                                             ; preds = %bb58, %bb50
  ...
  %i65 = getelementptr inbounds i32, i32* %arg3, i64 %i64
  %i66 = load i32, i32* %i65, align 4
  %i67 = add nuw nsw i64 %i59, %i57
  %i68 = getelementptr inbounds [1024 x i32], [1024 x i32]* %i, i64 0, i64 %i67
  store i32 %i66, i32* %i68, align 4

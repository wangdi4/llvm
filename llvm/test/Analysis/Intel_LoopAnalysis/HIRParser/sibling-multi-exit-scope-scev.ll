...
define void @foo(i64 %t28, i32* %t3, i32* %t4, i32 %sub65, i32** %t1) {
entry:
  br label %for.body
...
for.body60:                                       ; preds = %for.inc71, %for.body60.ph
  ...
  %arrayidx64 = getelementptr inbounds i32, i32* %t3, i64 %indvars.iv246
  %t29 = load i32, i32* %arrayidx64, align 4
...
for.body97:                                       ; preds = %for.body97, %for.body97.ph
  ...
  %arrayidx99 = getelementptr inbounds i32, i32* %t3, i64 %indvars.iv.next249
  %t36 = load i32, i32* %arrayidx99, align 4
  %arrayidx108 = getelementptr inbounds i32, i32* %t4, i64 %indvars.iv.next249
  store i32 %t36, i32* %arrayidx108, align 4
...
for.end111:                                       ; preds = %for.end111.loopexit1, %for.end111.loopexit, %for.body
  %arrayidx = getelementptr inbounds i32*, i32** %t1, i64 %indvars.iv253
  %ld = load i32*, i32** %arrayidx, align 4
  %indvars.iv253.next = add nsw i64 %indvars.iv253, 1
  %exitcond253 = icmp eq i32* %ld, null

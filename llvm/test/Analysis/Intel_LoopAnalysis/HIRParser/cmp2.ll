...
define float @foo(ptr nocapture %p, ptr nocapture %q, i32 %M1, i32 %M2, i64 %n) {
entry:
...
for.body:                                         ; preds = %if.end, %for.body.lr.ph
  ...
  %arrayidx = getelementptr inbounds float, ptr %q, i64 %i.025
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx10 = getelementptr inbounds float, ptr %p, i64 %i.025
  store float %conv9, ptr %arrayidx10, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %arrayidx11 = getelementptr inbounds float, ptr %p, i64 %i.025
  %1 = load float, ptr %arrayidx11, align 4
  %2 = load float, ptr %arrayidx, align 4
  %add13 = fadd float %1, %2
  store float %add13, ptr %arrayidx, align 4

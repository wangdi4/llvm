...
; RUN: opt < %s -hir-ssa-deconstruction -hir-cg -force-hir-cg -instcombine -S | FileCheck -check-prefix=CHECK-CG %s
...
; CHECK-CG: getelementptr inbounds [50 x %struct.S], [50 x %struct.S]* @obj1, i64 0, i64 [[IV1]], i32 1, i32 1, i64 [[IV2]]
...
for.body3:                                        ; preds = %for.body3, %for.body3.lr.ph
  ...
  %arrayidx5 = getelementptr inbounds [50 x %struct.S], [50 x %struct.S]* @obj1, i64 0, i64 %indvars.iv20, i32 1, i32 1, i64 %indvars.iv

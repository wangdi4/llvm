...
1:                                                ; preds = %7, %0
  %2 = phi i32 [ %9, %7 ], [ 0, %0 ]
  %3 = phi ptr [ %8, %7 ], [ @"_unnamed_main$$_$RES", %0 ]
...
11:                                               ; preds = %4, %11
  %12 = phi i64 [ 1, %11 ], [ 0, %4 ]
  %13 = phi ptr [ %16, %11 ], [ %3, %4 ]
  %14 = getelementptr inbounds [2 x i8], ptr @strlit.5, i64 0, i64 %12
...
18:                                               ; preds = %11
  %19 = getelementptr i8, ptr %3, i64 2
  br label %20

20:                                               ; preds = %18, %20
  %21 = phi i64 [ %26, %20 ], [ 0, %18 ]
  %22 = phi ptr [ %25, %20 ], [ %19, %18 ]
  %23 = getelementptr inbounds [3 x i8], ptr @strlit.4, i64 0, i64 %21

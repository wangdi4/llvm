...
; CHECK: |   (%p1)[18014398509481984 * i1 + 1] = 144115188075855872 * i1 + ptrtoint.i64*.i64(%p1) + 144115188075855880;
; CHECK: |   (%p2)[0] = 144115188075855872 * i1 + ptrtoint.i64*.i64(%p1) + 144115188075855880;
; CHECK: + END LOOP

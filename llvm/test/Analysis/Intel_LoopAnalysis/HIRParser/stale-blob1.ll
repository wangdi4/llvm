...
entry:
  ...
  %arrayidx38 = getelementptr inbounds [100 x [100 x [100 x i32]]], ptr %ip, i64 0, i64 6, i64 7, i64 %idxprom32
  br label %for.body20
...
for.body20:                                       ; preds = %entry, %for.cond77.preheader
  ...
  %arrayidx29 = getelementptr inbounds [100 x [100 x [100 x i32]]], ptr %ip, i64 0, i64 6, i64 8, i64 %1
  %2 = load i32, ptr %arrayidx29, align 4
  %add30 = add i32 %2, 7
  store i32 %add30, ptr %arrayidx38, align 4
  %arrayidx41 = getelementptr inbounds [100 x i32], ptr %xp, i64 0, i64 %1
  %3 = load i32, ptr %arrayidx41, align 4
  %add42 = add i32 %0, %3
  %arrayidx74 = getelementptr inbounds [100 x [100 x i32]], ptr %i, i64 0, i64 %indvars.iv222, i64 %indvars.iv222
...
for.body45:                                       ; preds = %for.body45, %for.body20
  ...
  %arrayidx52 = getelementptr inbounds [100 x i32], ptr %e9, i64 0, i64 %7
  %inc = add i32 %6, 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx57 = getelementptr inbounds [100 x i32], ptr %xp, i64 0, i64 %indvars.iv.next
  %8 = load i32, ptr %arrayidx57, align 4
  %sub54.neg = sub i32 87, %6
  %sub58 = add i32 %sub54.neg, %8
  store i32 %sub58, ptr %arrayidx57, align 4
  store i32 %sub58, ptr %arrayidx52, align 4
...
for.cond77.preheader:                             ; preds = %for.body45
  ...
  store i32 %add75.lcssa, ptr %arrayidx74, align 4

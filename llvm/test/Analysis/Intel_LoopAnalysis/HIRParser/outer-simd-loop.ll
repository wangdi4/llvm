...
define dso_local void @foo(i64 %N, i64* nocapture readnone %lb, i64* nocapture readonly %ub) local_unnamed_addr {
entry:
...
omp.inner.for.cond.omp.loop.exit_crit_edge:       ; preds = %omp.inner.for.inc
  ...
  store i64 %add10.lcssa, i64* %.omp.iv, align 8

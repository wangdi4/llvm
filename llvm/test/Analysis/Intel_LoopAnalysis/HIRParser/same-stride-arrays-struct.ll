...
define dso_local void @blam.bb256(ptr %tmp239, i64 %n, ptr %tmp260.out) {
newFuncRoot:
  br label %bb256
...
bb256:                                            ; preds = %newFuncRoot, %bb256
  ...
  %tmp257 = phi ptr [ %tmp258, %bb256 ], [ %tmp239, %newFuncRoot ]
  %tmp258 = getelementptr inbounds %struct.wombat, ptr %tmp257, i64 -1
  %tmp259 = getelementptr inbounds %struct.wombat, ptr %tmp258, i64 0, i32 0, i32 0, i64 0
  %tmp260 = load double, ptr %tmp259, align 8
  store double %tmp260, ptr %tmp260.out
  %iv.inc = add i64 %iv, 1

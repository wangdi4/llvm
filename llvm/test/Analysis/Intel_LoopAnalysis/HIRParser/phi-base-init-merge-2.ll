...
; CHECK: |   (%arg)[undef * i1 + undef + zext.i32.i64(undef)] = undef;
; CHECK: + END LOOP
...
define dso_local void @quux(ptr %arg, i32 %arg1) {
bb:
  %tmp = getelementptr inbounds i8, ptr %arg, i64 undef
...
bb3:                                              ; preds = %bb8, %bb2
  %tmp4 = phi ptr [ %tmp, %bb2 ], [ %tmp11, %bb8 ]
  %tmp5 = phi i32 [ 0, %bb2 ], [ %tmp12, %bb8 ]
  %tmp6 = zext i32 undef to i64
  %tmp7 = getelementptr inbounds i8, ptr %tmp4, i64 %tmp6
  store i8 undef, ptr %tmp7, align 4
  br label %bb8

bb8:                                              ; preds = %bb3
  %tmp9 = bitcast ptr %tmp4 to ptr
  %tmp10 = getelementptr inbounds i8, ptr %tmp9, i64 undef
  %tmp11 = bitcast ptr %tmp10 to ptr

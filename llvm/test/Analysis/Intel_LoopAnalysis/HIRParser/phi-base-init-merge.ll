...
bb:
  %tmp = getelementptr inbounds i32, ptr %arg, i64 undef
...
bb3:                                              ; preds = %bb8, %bb2
  %tmp4 = phi ptr [ %tmp, %bb2 ], [ %tmp10, %bb8 ]
  %tmp5 = phi i32 [ 0, %bb2 ], [ %tmp12, %bb8 ]
  %tmp6 = zext i32 undef to i64
  %tmp7 = getelementptr inbounds i32, ptr %tmp4, i64 %tmp6
  store i32 undef, ptr %tmp7, align 4
  br label %bb8

bb8:                                              ; preds = %bb3
  %tmp10 = getelementptr inbounds i8, ptr %tmp4, i64 undef

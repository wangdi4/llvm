...
%struct.tree_function_decl.1650.1739 = type { %struct.tree_decl_non_common.1620.1709, ptr, ptr, ptr, ptr, i32 }
%struct.tree_decl_non_common.1620.1709 = type { %struct.tree_decl_with_vis.1619.1708, ptr, ptr, ptr, ptr }
%struct.tree_decl_with_vis.1619.1708 = type { %struct.tree_decl_with_rtl.1618.1707, ptr, ptr, ptr, i24 }
%struct.tree_decl_with_rtl.1618.1707 = type { %struct.tree_decl_common.1609.1698, ptr }
%struct.tree_decl_common.1609.1698 = type { %struct.tree_decl_minimal.1607.1696, ptr, i40, i32, ptr, ptr, ptr, ptr, ptr }
%struct.tree_decl_minimal.1607.1696 = type { %struct.tree_common.1606.1695, i32, i32, ptr, ptr }
%struct.tree_common.1606.1695 = type { %struct.tree_base.1605.1694, ptr, ptr }
...
%struct.block_symbol.1615.1704 = type { [3 x %union.rtunion_def.1610.1699], ptr, i64 }
%union.rtunion_def.1610.1699 = type { ptr }
%struct.object_block.1614.1703 = type { ptr, i32, i64, ptr, ptr }
%union.section.1611.1700 = type opaque
%struct.VEC_rtx_gc.1613.1702 = type { %struct.VEC_rtx_base.1612.1701 }
%struct.VEC_rtx_base.1612.1701 = type { i32, i32, [1 x ptr] }
%struct.function.1649.1738 = type { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i32, i32, i32, i32, i32, i32, ptr, i32 }
%struct.eh_status.1621.1710 = type opaque
%struct.control_flow_graph.1641.1730 = type { ptr, ptr, ptr, i32, i32, i32, ptr, i32, [2 x i32], [2 x i32], i32, i32 }
%struct.basic_block_def.1638.1727 = type { ptr, ptr, ptr, ptr, [2 x ptr], ptr, ptr, %union.basic_block_il_dependent.1637.1726, i64, i32, i32, i32, i32, i32 }
%struct.VEC_edge_gc.1633.1722 = type { %struct.VEC_edge_base.1632.1721 }
%struct.VEC_edge_base.1632.1721 = type { i32, i32, [1 x ptr] }
%struct.edge_def.1631.1720 = type { ptr, ptr, %union.edge_def_insns.1630.1719, ptr, ptr, i32, i32, i32, i32, i64 }
%union.edge_def_insns.1630.1719 = type { ptr }
%struct.loop.1634.1723 = type opaque
%struct.et_node.1635.1724 = type opaque
%union.basic_block_il_dependent.1637.1726 = type { ptr }
%struct.gimple_bb_info.1636.1725 = type { ptr, ptr }
%struct.VEC_basic_block_gc.1640.1729 = type { %struct.VEC_basic_block_base.1639.1728 }
%struct.VEC_basic_block_base.1639.1728 = type { i32, i32, [1 x ptr] }
%struct.gimple_seq_d.1629.1718 = type { ptr, ptr, ptr }
%struct.gimple_seq_node_d.1628.1717 = type { ptr, ptr, ptr }
%union.gimple_statement_d.1627.1716 = type { %struct.gimple_statement_phi.1626.1715 }
%struct.gimple_statement_phi.1626.1715 = type { %struct.gimple_statement_base.1622.1711, i32, i32, ptr, [1 x %struct.phi_arg_d.1625.1714] }
%struct.gimple_statement_base.1622.1711 = type { i32, i32, i32, i32, ptr, ptr }
%struct.phi_arg_d.1625.1714 = type { %struct.ssa_use_operand_d.1624.1713, ptr, i32 }
%struct.ssa_use_operand_d.1624.1713 = type { ptr, ptr, %union.anon.1623.1712, ptr }
%union.anon.1623.1712 = type { ptr }
%struct.gimple_df.1642.1731 = type opaque
%struct.loops.1643.1732 = type opaque
%struct.machine_function.1647.1736 = type { ptr, ptr, i32, i32, [4 x i32], i32, %struct.machine_cfa_state.1646.1735, i32, i8 }
%struct.stack_local_entry.1645.1734 = type opaque
%struct.machine_cfa_state.1646.1735 = type { ptr, i64 }
%struct.language_function.1648.1737 = type opaque
%struct.htab.1644.1733 = type { ptr, ptr, ptr, ptr, i64, i64, i64, i32, i32, ptr, ptr, ptr, ptr, ptr, i32 }

; Function Attrs: nounwind uwtable
define void @native_encode_expr(ptr nocapture readonly %expr) local_unnamed_addr {
entry:
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  %int_cst13.i = getelementptr inbounds %union.tree_node.1651.1740, ptr %expr, i64 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1
  %high.i = getelementptr inbounds i32, ptr %int_cst13.i, i64 2
  %0 = bitcast ptr %high.i to ptr

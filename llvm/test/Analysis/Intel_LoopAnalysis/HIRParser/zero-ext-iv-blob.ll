...
define void @_Z3fooPA100_iS0_S0_S0_i(ptr nocapture %A, ptr nocapture readonly %B, ptr nocapture readonly %C, ptr nocapture %D, i32 %N) {
entry:
...
for.body.3:                                       ; preds = %for.body.3, %for.body.3.lr.ph
  ...
  %arrayidx5 = getelementptr inbounds [100 x i32], ptr %B, i64 %indvars.iv47, i64 %indvars.iv
  %0 = load i32, ptr %arrayidx5, align 4
  %arrayidx9 = getelementptr inbounds [100 x i32], ptr %C, i64 %indvars.iv47, i64 %indvars.iv
  %1 = load i32, ptr %arrayidx9, align 4
  %add = add nsw i32 %1, %0
  %arrayidx13 = getelementptr inbounds [100 x i32], ptr %A, i64 %indvars.iv47, i64 %indvars.iv
  store i32 %add, ptr %arrayidx13, align 4
  %arrayidx17 = getelementptr inbounds [100 x i32], ptr %A, i64 %idxprom15, i64 %indvars.iv
  %2 = load i32, ptr %arrayidx17, align 4
  %conv = sitofp i32 %2 to double
  %mul = fmul double %conv, 2.000000e+00
  %conv18 = fptosi double %mul to i32
  %arrayidx22 = getelementptr inbounds [100 x i32], ptr %D, i64 %indvars.iv47, i64 %indvars.iv

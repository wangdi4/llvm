...
define dso_local i32 @foo(ptr nocapture readonly %A, ptr nocapture readonly %B, i32 %s, i32 %n, i64 %t) {
entry:
  %Aoffset = getelementptr inbounds i8, ptr %A, i64 %t
  %Boffset = getelementptr inbounds i8, ptr %B, i64 %t
  %inc1 = add i32 %s, 1
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond
  ...
  %arrayidx = getelementptr inbounds i8, ptr %Aoffset, i64 %idxprom
  %0 = load i8, ptr %arrayidx, align 1
  %arrayidx2 = getelementptr inbounds i8, ptr %Boffset, i64 %idxprom

...
define void @foo(i64 %dec.in, ptr %first.in, ptr %s.in, i8 %stval, ptr %addr.in) {
entry:
...
while.body29.i:                                   ; preds = %entry, %while.cond26.i.loopexit
  ...
  %first.addr = phi ptr [ %first.addr.lcssa, %while.cond26.i.loopexit ], [ %first.in, %entry ]
  %s.addr = phi ptr [ %s.addr.3.lcssa, %while.cond26.i.loopexit ], [ %s.in, %entry ]
  %dec27.i456 = add i64 %dec27.i456.in, -1
  store i8 %stval, ptr %s.addr, align 1
  %arrayidx32.i = getelementptr inbounds i8, ptr %addr.in, i64 %dec27.i456
  %0 = load i8, ptr %arrayidx32.i, align 1
  %s.addr.1 = getelementptr inbounds i8, ptr %s.addr, i64 1
...
for.body37.i:                                     ; preds = %for.body37.i.preheader, %for.body37.i
  %s.addr.2 = phi ptr [ %s.addr.3, %for.body37.i ], [ %s.addr.1, %for.body37.i.preheader ]
  %i31.0.i448 = phi i8 [ %dec41.i, %for.body37.i ], [ %0, %for.body37.i.preheader ]
  %first.addr.1 = phi ptr [ %incdec.ptr38.i, %for.body37.i ], [ %first.addr, %for.body37.i.preheader ]
  %incdec.ptr38.i = getelementptr inbounds i8, ptr %first.addr.1, i64 1
  %1 = load i8, ptr %first.addr.1, align 1
  store i8 %1, ptr %s.addr.2, align 1
  %dec41.i = add nsw i8 %i31.0.i448, -1
  %s.addr.3 = getelementptr inbounds i8, ptr %s.addr.2, i64 1
...
while.cond26.i.loopexit.loopexit:                 ; preds = %for.body37.i
  %incdec.ptr38.i.lcssa = phi ptr [ %incdec.ptr38.i, %for.body37.i ]
  %s.addr.3.lcssa558 = phi ptr [ %s.addr.3, %for.body37.i ]
  br label %while.cond26.i.loopexit

while.cond26.i.loopexit:                          ; preds = %while.cond26.i.loopexit.loopexit, %while.body29.i
  %first.addr.lcssa = phi ptr [ %first.addr, %while.body29.i ], [ %incdec.ptr38.i.lcssa, %while.cond26.i.loopexit.loopexit ]
  %s.addr.3.lcssa = phi ptr [ %s.addr.1, %while.body29.i ], [ %s.addr.3.lcssa558, %while.cond26.i.loopexit.loopexit ]

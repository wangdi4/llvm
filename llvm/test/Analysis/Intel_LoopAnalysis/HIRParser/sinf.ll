; RUN: opt < %s -hir-ssa-deconstruction -vector-library=SVML | opt -analyze -hir-parser -vector-library=SVML | FileCheck %s
...
define void @foo(float* nocapture readonly %A, float* nocapture %B, i32 %n) local_unnamed_addr #0 {
entry:

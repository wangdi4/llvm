...
; AVX512:  LV: Found an estimated cost of 24 for VF 8 For instruction: %v0 = load i64, ptr %in0, align 8
; AVX512:  LV: Found an estimated cost of 48 for VF 16 For instruction: %v0 = load i64, ptr %in0, align 8
; AVX512:  LV: Found an estimated cost of 96 for VF 32 For instruction: %v0 = load i64, ptr %in0, align 8

...
; SSE-LABEL: 'f32'
; INTEL_CUSTOMIZATION
; SSE-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %F32 = call float @llvm.minnum.f32(float undef, float undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 53 for instruction: %V2F32 = call <2 x float> @llvm.minnum.v2f32(<2 x float> undef, <2 x float> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 107 for instruction: %V4F32 = call <4 x float> @llvm.minnum.v4f32(<4 x float> undef, <4 x float> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 214 for instruction: %V8F32 = call <8 x float> @llvm.minnum.v8f32(<8 x float> undef, <8 x float> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 428 for instruction: %V16F32 = call <16 x float> @llvm.minnum.v16f32(<16 x float> undef, <16 x float> undef)
; end INTEL_CUSTOMIZATION
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i32 undef
;
; AVX-LABEL: 'f32'
; INTEL_CUSTOMIZATION
; AVX-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %F32 = call float @llvm.minnum.f32(float undef, float undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 53 for instruction: %V2F32 = call <2 x float> @llvm.minnum.v2f32(<2 x float> undef, <2 x float> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 107 for instruction: %V4F32 = call <4 x float> @llvm.minnum.v4f32(<4 x float> undef, <4 x float> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 215 for instruction: %V8F32 = call <8 x float> @llvm.minnum.v8f32(<8 x float> undef, <8 x float> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 430 for instruction: %V16F32 = call <16 x float> @llvm.minnum.v16f32(<16 x float> undef, <16 x float> undef)
; end INTEL_CUSTOMIZATION
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i32 undef
;
; AVX512-LABEL: 'f32'
; INTEL_CUSTOMIZATION
; AVX512-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %F32 = call float @llvm.minnum.f32(float undef, float undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 53 for instruction: %V2F32 = call <2 x float> @llvm.minnum.v2f32(<2 x float> undef, <2 x float> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 107 for instruction: %V4F32 = call <4 x float> @llvm.minnum.v4f32(<4 x float> undef, <4 x float> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 215 for instruction: %V8F32 = call <8 x float> @llvm.minnum.v8f32(<8 x float> undef, <8 x float> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 431 for instruction: %V16F32 = call <16 x float> @llvm.minnum.v16f32(<16 x float> undef, <16 x float> undef)
; end INTEL_CUSTOMIZATION
=======
; SSE2-LABEL: 'f32'
...
>>>>>>> 48fca4b6f30fc204fdce0f83ff0a8eb4d3e584ab
...
; SSE-LABEL: 'f64'
; INTEL_CUSTOMIZATION
; SSE-NEXT:  Cost Model: Found an estimated cost of 41 for instruction: %f64 = call double @llvm.minnum.f64(double undef, double undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 83 for instruction: %V2f64 = call <2 x double> @llvm.minnum.v2f64(<2 x double> undef, <2 x double> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 166 for instruction: %V4f64 = call <4 x double> @llvm.minnum.v4f64(<4 x double> undef, <4 x double> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 332 for instruction: %V8f64 = call <8 x double> @llvm.minnum.v8f64(<8 x double> undef, <8 x double> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 664 for instruction: %V16f64 = call <16 x double> @llvm.minnum.v16f64(<16 x double> undef, <16 x double> undef)
; end INTEL_CUSTOMIZATION
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i32 undef
;
; AVX-LABEL: 'f64'
; INTEL_CUSTOMIZATION
; AVX-NEXT:  Cost Model: Found an estimated cost of 41 for instruction: %f64 = call double @llvm.minnum.f64(double undef, double undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 83 for instruction: %V2f64 = call <2 x double> @llvm.minnum.v2f64(<2 x double> undef, <2 x double> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 167 for instruction: %V4f64 = call <4 x double> @llvm.minnum.v4f64(<4 x double> undef, <4 x double> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 334 for instruction: %V8f64 = call <8 x double> @llvm.minnum.v8f64(<8 x double> undef, <8 x double> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 668 for instruction: %V16f64 = call <16 x double> @llvm.minnum.v16f64(<16 x double> undef, <16 x double> undef)
; end INTEL_CUSTOMIZATION
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i32 undef
;
; AVX512-LABEL: 'f64'
; INTEL_CUSTOMIZATION
; AVX512-NEXT:  Cost Model: Found an estimated cost of 41 for instruction: %f64 = call double @llvm.minnum.f64(double undef, double undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 83 for instruction: %V2f64 = call <2 x double> @llvm.minnum.v2f64(<2 x double> undef, <2 x double> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 167 for instruction: %V4f64 = call <4 x double> @llvm.minnum.v4f64(<4 x double> undef, <4 x double> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 335 for instruction: %V8f64 = call <8 x double> @llvm.minnum.v8f64(<8 x double> undef, <8 x double> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 670 for instruction: %V16f64 = call <16 x double> @llvm.minnum.v16f64(<16 x double> undef, <16 x double> undef)
; end INTEL_CUSTOMIZATION
=======
; SSE2-LABEL: 'f64'
...
<<<<<<< HEAD
; INTEL_CUSTOMIZATION
; SSE-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %F32 = call nnan float @llvm.minnum.f32(float undef, float undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 53 for instruction: %V2F32 = call nnan <2 x float> @llvm.minnum.v2f32(<2 x float> undef, <2 x float> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 107 for instruction: %V4F32 = call nnan <4 x float> @llvm.minnum.v4f32(<4 x float> undef, <4 x float> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 214 for instruction: %V8F32 = call nnan <8 x float> @llvm.minnum.v8f32(<8 x float> undef, <8 x float> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 428 for instruction: %V16F32 = call nnan <16 x float> @llvm.minnum.v16f32(<16 x float> undef, <16 x float> undef)
; end INTEL_CUSTOMIZATION
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i32 undef
;
; AVX-LABEL: 'f32_nnan'
; INTEL_CUSTOMIZATION
; AVX-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %F32 = call nnan float @llvm.minnum.f32(float undef, float undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 53 for instruction: %V2F32 = call nnan <2 x float> @llvm.minnum.v2f32(<2 x float> undef, <2 x float> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 107 for instruction: %V4F32 = call nnan <4 x float> @llvm.minnum.v4f32(<4 x float> undef, <4 x float> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 215 for instruction: %V8F32 = call nnan <8 x float> @llvm.minnum.v8f32(<8 x float> undef, <8 x float> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 430 for instruction: %V16F32 = call nnan <16 x float> @llvm.minnum.v16f32(<16 x float> undef, <16 x float> undef)
; end INTEL_CUSTOMIZATION
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i32 undef
;
; AVX512-LABEL: 'f32_nnan'
; INTEL_CUSTOMIZATION
; AVX512-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %F32 = call nnan float @llvm.minnum.f32(float undef, float undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 53 for instruction: %V2F32 = call nnan <2 x float> @llvm.minnum.v2f32(<2 x float> undef, <2 x float> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 107 for instruction: %V4F32 = call nnan <4 x float> @llvm.minnum.v4f32(<4 x float> undef, <4 x float> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 215 for instruction: %V8F32 = call nnan <8 x float> @llvm.minnum.v8f32(<8 x float> undef, <8 x float> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 431 for instruction: %V16F32 = call nnan <16 x float> @llvm.minnum.v16f32(<16 x float> undef, <16 x float> undef)
; end INTEL_CUSTOMIZATION
=======
...
<<<<<<< HEAD
; INTEL_CUSTOMIZATION
; SSE-NEXT:  Cost Model: Found an estimated cost of 41 for instruction: %f64 = call nnan double @llvm.minnum.f64(double undef, double undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 83 for instruction: %V2f64 = call nnan <2 x double> @llvm.minnum.v2f64(<2 x double> undef, <2 x double> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 166 for instruction: %V4f64 = call nnan <4 x double> @llvm.minnum.v4f64(<4 x double> undef, <4 x double> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 332 for instruction: %V8f64 = call nnan <8 x double> @llvm.minnum.v8f64(<8 x double> undef, <8 x double> undef)
; SSE-NEXT:  Cost Model: Found an estimated cost of 664 for instruction: %V16f64 = call nnan <16 x double> @llvm.minnum.v16f64(<16 x double> undef, <16 x double> undef)
; end INTEL_CUSTOMIZATION
; SSE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i32 undef
;
; AVX-LABEL: 'f64_nnan'
; INTEL_CUSTOMIZATION
; AVX-NEXT:  Cost Model: Found an estimated cost of 41 for instruction: %f64 = call nnan double @llvm.minnum.f64(double undef, double undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 83 for instruction: %V2f64 = call nnan <2 x double> @llvm.minnum.v2f64(<2 x double> undef, <2 x double> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 167 for instruction: %V4f64 = call nnan <4 x double> @llvm.minnum.v4f64(<4 x double> undef, <4 x double> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 334 for instruction: %V8f64 = call nnan <8 x double> @llvm.minnum.v8f64(<8 x double> undef, <8 x double> undef)
; AVX-NEXT:  Cost Model: Found an estimated cost of 668 for instruction: %V16f64 = call nnan <16 x double> @llvm.minnum.v16f64(<16 x double> undef, <16 x double> undef)
; end INTEL_CUSTOMIZATION
; AVX-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i32 undef
;
; AVX512-LABEL: 'f64_nnan'
; INTEL_CUSTOMIZATION
; AVX512-NEXT:  Cost Model: Found an estimated cost of 41 for instruction: %f64 = call nnan double @llvm.minnum.f64(double undef, double undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 83 for instruction: %V2f64 = call nnan <2 x double> @llvm.minnum.v2f64(<2 x double> undef, <2 x double> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 167 for instruction: %V4f64 = call nnan <4 x double> @llvm.minnum.v4f64(<4 x double> undef, <4 x double> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 335 for instruction: %V8f64 = call nnan <8 x double> @llvm.minnum.v8f64(<8 x double> undef, <8 x double> undef)
; AVX512-NEXT:  Cost Model: Found an estimated cost of 670 for instruction: %V16f64 = call nnan <16 x double> @llvm.minnum.v16f64(<16 x double> undef, <16 x double> undef)
; end INTEL_CUSTOMIZATION
=======

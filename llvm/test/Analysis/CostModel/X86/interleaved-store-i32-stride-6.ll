...
; 16 elements of int32 type). For each such VF it runs cost model and evaluates register pressure.
...
; AVX512: LV: Found an estimated cost of 12 for VF 8 For instruction:   store i32 %v5, i32* %out5, align 4
; AVX512: LV: Found an estimated cost of 24 for VF 16 For instruction:   store i32 %v5, i32* %out5, align 4

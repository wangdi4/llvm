...
; INTEL_CUSTOMIZATION
; AVX512:  LV: Found an estimated cost of 28 for VF 4 For instruction: store i64 %v6, ptr %out6, align 8
; AVX512:  LV: Found an estimated cost of 56 for VF 8 For instruction: store i64 %v6, ptr %out6, align 8
; AVX512:  LV: Found an estimated cost of 112 for VF 16 For instruction: store i64 %v6, ptr %out6, align 8

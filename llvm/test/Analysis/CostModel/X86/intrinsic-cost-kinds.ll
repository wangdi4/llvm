...
; THRU-NEXT:  Cost Model: Found an estimated cost of 116 for instruction: %v = call { <16 x i32>, <16 x i1> } @llvm.umul.with.overflow.v16i32(<16 x i32> %va, <16 x i32> %vb)
...
; THRU-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v = call <16 x i32> @llvm.smax.v16i32(<16 x i32> %va, <16 x i32> %vb)
; THRU-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
; LATE-LABEL: 'smax'
...
; THRU-NEXT:  Cost Model: Found an estimated cost of 152 for instruction: %v = call <16 x i32> @llvm.fshl.v16i32(<16 x i32> %va, <16 x i32> %vb, <16 x i32> %vc)
; THRU-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
; LATE-LABEL: 'fshl'
...
; INTEL_CUSTOMIZATION
; THRU-NEXT:  Cost Model: Found an estimated cost of 119 for instruction: %v = call <16 x float> @llvm.masked.gather.v16f32.v16p0f32(<16 x float*> %va, i32 1, <16 x i1> %vb, <16 x float> %vc)
; END INTEL_CUSTOMIZATION
; THRU-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;

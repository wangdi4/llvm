...
; LATE-LABEL: 'log2'
; INTEL_CUSTOMIZATION
; LATE-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %s = call float @llvm.log2.f32(float %a)
; LATE-NEXT:  Cost Model: Found an estimated cost of 440 for instruction: %v = call <16 x float> @llvm.log2.v16f32(<16 x float> %va)
; end INTEL_CUSTOMIZATION
; LATE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
; SIZE-LABEL: 'log2'
...
; LATE-LABEL: 'fmaximum'
; INTEL_CUSTOMIZATION
; LATE-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %s = call float @llvm.maximum.f32(float %a, float %b)
; LATE-NEXT:  Cost Model: Found an estimated cost of 452 for instruction: %v = call <16 x float> @llvm.maximum.v16f32(<16 x float> %va, <16 x float> %vb)
; end INTEL_CUSTOMIZATION
; LATE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
; SIZE-LABEL: 'fmaximum'
; INTEL_CUSTOMIZATION
; SIZE-NEXT:  Cost Model: Found an estimated cost of 26 for instruction: %s = call float @llvm.maximum.f32(float %a, float %b)
; SIZE-NEXT:  Cost Model: Found an estimated cost of 452 for instruction: %v = call <16 x float> @llvm.maximum.v16f32(<16 x float> %va, <16 x float> %vb)
; end INTEL_CUSTOMIZATION
; SIZE-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
...
; THRU-NEXT:  Cost Model: Found an estimated cost of 136 for instruction: %v = call <16 x i32> @llvm.fshl.v16i32(<16 x i32> %va, <16 x i32> %vb, <16 x i32> %vc)
; THRU-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: ret void
;
; LATE-LABEL: 'fshl'

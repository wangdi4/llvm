...
; INTEL_CUSTOMIZATION
; AVX512:  LV: Found an estimated cost of 32 for VF 4 For instruction: store i64 %v7, ptr %out7, align 8
; AVX512:  LV: Found an estimated cost of 64 for VF 8 For instruction: store i64 %v7, ptr %out7, align 8

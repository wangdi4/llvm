...
; INTEL_CUSTOMIZATION
; AVX512:  LV: Found an estimated cost of 28 for VF 8 For instruction: %v0 = load i32, ptr %in0, align 4
; AVX512:  LV: Found an estimated cost of 56 for VF 16 For instruction: %v0 = load i32, ptr %in0, align 4
; AVX512:  LV: Found an estimated cost of 112 for VF 32 For instruction: %v0 = load i32, ptr %in0, align 4

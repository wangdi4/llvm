...
; AVX512: LV: Found an estimated cost of 8 for VF 8 For instruction:   store float %v3, float* %out3, align 4
; AVX512: LV: Found an estimated cost of 16 for VF 16 For instruction:   store float %v3, float* %out3, align 4
; AVX512: LV: Found an estimated cost of 32 for VF 32 For instruction:   store float %v3, float* %out3, align 4

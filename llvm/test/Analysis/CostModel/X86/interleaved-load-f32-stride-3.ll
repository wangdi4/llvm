...
; AVX512: LV: Found an estimated cost of 48 for VF 32 For instruction:   %v0 = load float, float* %in0, align 4
; AVX512: LV: Found an estimated cost of 96 for VF 64 For instruction:   %v0 = load float, float* %in0, align 4

...
; AVX512:  LV: Found an estimated cost of 24 for VF 4 For instruction: store i64 %v5, ptr %out5, align 8
; AVX512:  LV: Found an estimated cost of 48 for VF 8 For instruction: store i64 %v5, ptr %out5, align 8
; AVX512:  LV: Found an estimated cost of 96 for VF 16 For instruction: store i64 %v5, ptr %out5, align 8

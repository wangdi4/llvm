...
; AVX512: LV: Found an estimated cost of 18 for VF 4 For instruction:   %v0 = load double, double* %in0, align 8
; AVX512: LV: Found an estimated cost of 24 for VF 8 For instruction:   %v0 = load double, double* %in0, align 8

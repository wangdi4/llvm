...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %V3 = call i1 @llvm.vector.reduce.or.v3i1(<3 x i1> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %V4 = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %V5 = call i1 @llvm.vector.reduce.or.v5i1(<5 x i1> undef)
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %V6 = call i1 @llvm.vector.reduce.or.v6i1(<6 x i1> undef)
...
;
  ...
  %V3   = call i1 @llvm.vector.reduce.or.v3i1(<3 x i1> undef)
  %V4   = call i1 @llvm.vector.reduce.or.v4i1(<4 x i1> undef)
  %V5   = call i1 @llvm.vector.reduce.or.v5i1(<5 x i1> undef)
  %V6   = call i1 @llvm.vector.reduce.or.v6i1(<6 x i1> undef)
...
declare i1 @llvm.vector.reduce.or.v5i1(<5 x i1>)
declare i1 @llvm.vector.reduce.or.v6i1(<6 x i1>)

; It checks restrict analysis in anders-aa helps to detect %data, which
; is marked as noalias (restrict) argument and %twp.addr.029, which
...
define void @FFT_transform_internal(i32 %N, double* noalias nocapture %data, i32 %direction, double* nocapture readonly %twp) local_unnamed_addr {
entry:
...
for.body3:                                        ; preds = %for.body3.preheader, %for.body3
  ...
  %1 = load double, double* %arrayidx, align 8, !tbaa !1
...
!0 = !{!"clang version 4.0.0 (trunk 20717)"}
!1 = !{!2, !2, i64 0}
!2 = !{!"double", !3, i64 0}

...
%class.NppParameters = type { i64 (%"class.std::_Lockit"*, i32)* }

@"?_pSelf@NppParameters@@0PEAV1@EA" = internal global %class.NppParameters { i64 (%"class.std::_Lockit"*, i32)* @"?OFNHookProc@FileDialog@@KA_KPEAUHWND__@@I_K_J@Z" }
...
define internal i64 @"?run_dlgProc@ColumnEditorDlg@@MEAA_JI_K_J@Z"(%class.ColumnEditorDlg* %in0) {
  ...
  %fptr.as.winproc = load i64 (%"class.std::_Lockit"*, i32)*, i64 (%"class.std::_Lockit"*, i32)** %fptr.addr
  %isnull = icmp eq i64 (%"class.std::_Lockit"*, i32)* %fptr.as.winproc, null
  br i1 %isnull, label %done, label %make_icall

make_icall:
  ; Change the function pointer to another type, which has a different return type
  %fptr.as.ETDTProc = bitcast i64 (%"class.std::_Lockit"*, i32)* %fptr.as.winproc to i32 (%"class.std::_Lockit"*, i32)*
  ...
  %icall_result = call i32 %fptr.as.ETDTProc(%"class.std::_Lockit"* %lockit, i32 6)
  br label %done
...
define internal i64 @"?OFNHookProc@FileDialog@@KA_KPEAUHWND__@@I_K_J@Z"(%"class.std::_Lockit"* %0, i32 %1) {
  ret i64 0
}
...
define void @test(i64 (%"class.std::_Lockit"*, i32)* %fptr) {
  %fptr.addr = getelementptr inbounds %class.NppParameters, %class.NppParameters* @"?_pSelf@NppParameters@@0PEAV1@EA", i64 0, i32 0
  store i64 (%"class.std::_Lockit"*, i32)* %fptr, i64 (%"class.std::_Lockit"*, i32)** %fptr.addr
  ret void
}

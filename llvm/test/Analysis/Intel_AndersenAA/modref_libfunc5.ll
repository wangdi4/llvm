...
define internal i32 @printf(i8* %0, ...) {
  %2 = alloca i8*, align 8
...
define internal i32 @fprintf(%struct._iobuf* %0, i8* %1, ...) {
  %3 = alloca i8*, align 8
  ...
  %6 = call i64* @__local_stdio_printf_options()
  %7 = load i64, i64* %6
  %8 = call i32 @__stdio_common_vfprintf(i64 %7, %struct._iobuf* %0, i8* %1, %struct.__crt_locale_pointers* null, i8* %5
)
...
; CHECK: Just Ref:  Ptr: i8* %call1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %ar1)
; CHECK: Just Ref:  Ptr: i32* %ar1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %ar1)
...
; CHECK-LABEL: Function: test02:
 ;CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str2, i64 0, i64 0), i32* %ar1)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str2, i64 0, i64 0), i32* %ar1)
...
entry:
  ...
  %fp = load %struct._iobuf*, %struct._iobuf** @nabout
  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* %str, i32* %ar1)

  ret void
}
; CHECK-LABEL: Function: test03:
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* %str, i32* %ar1)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* %str, i32* %ar1)
...
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str4, i64 0, i64 0), i32* %arindex5)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str4, i64 0, i64 0), i32* %arindex5)
; CHECK:   Both ModRef:  Ptr: i32* %arindex5	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str4, i64 0, i64 0), i32* %arindex5)
...
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str5, i64 0, i64 0), i16* %arindex5)
; CHECK: Both ModRef:  Ptr: i16* %ar1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str5, i64 0, i64 0), i16* %arindex5)
; CHECK: Both ModRef:  Ptr: i16* %arindex5	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str5, i64 0, i64 0), i16* %arindex5)
...
; CHECK: Just Ref:  Ptr: i8* %call1	<->  %t1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str6, i64 0, i64 0), i32* %ar1)
; CHECK: Just Ref:  Ptr: i32* %ar1	<->  %t1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str6, i64 0, i64 0), i32* %ar1)
...
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str7, i64 0, i64 0), i32* %arindex5)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str7, i64 0, i64 0), i32* %arindex5)
; CHECK: Both ModRef:  Ptr: i32* %arindex5	<->  %t1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str7, i64 0, i64 0), i32* %arindex5)
...
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str08, i64 0, i64 0), i32* %ar1)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (%struct._iobuf*, i8*, ...) @fprintf(%struct._iobuf* %fp, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str08, i64 0, i64 0), i32* %ar1)

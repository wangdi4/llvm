...
define internal i32 @printf(ptr %0, ...) {
  ...
  %7 = load i64, ptr %6
  %8 = call i32 @__stdio_common_vfprintf(i64 %7, ptr %5, ptr %0, ptr null, ptr %4)
  call void @llvm.va_end(ptr nonnull %3)
  call void @llvm.lifetime.end.p0i8(i64 8, ptr nonnull %3)
  ret i32 %8
}

define internal i32 @fprintf(ptr %0, ptr %1, ...) {
  ...
  %6 = call ptr @__local_stdio_printf_options()
  %7 = load i64, ptr %6
  %8 = call i32 @__stdio_common_vfprintf(i64 %7, ptr %0, ptr %1, ptr null, ptr %5
)
...
entry:
  ...
  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp,
    ptr @.str,
    ptr %ar1)
...
; CHECK: Just Ref:  Ptr: i8* %call1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str, ptr %ar1)
; CHECK: Just Ref:  Ptr: i32* %ar1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str, ptr %ar1)
...
; CHECK-LABEL: Function: test02:
 ;CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str2, ptr %ar1)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str2, ptr %ar1)
...
entry:
  ...
  %fp = load ptr, ptr @nabout
  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr %str, ptr %ar1)

  ret void
}
; CHECK-LABEL: Function: test03:
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr %str, ptr %ar1)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr %str, ptr %ar1)
...
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str4, ptr %arindex5)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str4, ptr %arindex5)
; CHECK:   Both ModRef:  Ptr: i32* %arindex5	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str4, ptr %arindex5)
...
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str5, ptr %arindex5)
; CHECK: Both ModRef:  Ptr: i16* %ar1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str5, ptr %arindex5)
; CHECK: Both ModRef:  Ptr: i16* %arindex5	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str5, ptr %arindex5)
...
; CHECK: Just Ref:  Ptr: i8* %call1	<->  %t1 = call i32 (ptr, ...) @printf(ptr @.str6, ptr %ar1)
; CHECK: Just Ref:  Ptr: i32* %ar1	<->  %t1 = call i32 (ptr, ...) @printf(ptr @.str6, ptr %ar1)
...
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (ptr, ...) @printf(ptr @.str7, ptr %arindex5)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (ptr, ...) @printf(ptr @.str7, ptr %arindex5)
; CHECK: Both ModRef:  Ptr: i32* %arindex5	<->  %t1 = call i32 (ptr, ...) @printf(ptr @.str7, ptr %arindex5)
...
; CHECK: Both ModRef:  Ptr: i8* %call1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str08, ptr %ar1)
; CHECK: Both ModRef:  Ptr: i32* %ar1	<->  %t1 = call i32 (ptr, ptr, ...) @fprintf(ptr %fp, ptr @.str08, ptr %ar1)

...
define internal i32 @foo(ptr nocapture %a, ptr nocapture readonly %b, i32 %n) local_unnamed_addr #0 {
entry:
...
entry:
  ...
  %call.i = tail call noalias ptr @malloc(i64 %mul.i)
  %0 = bitcast ptr %call.i to ptr
  %call.i13 = tail call noalias ptr @malloc(i64 %mul.i)
  %1 = bitcast ptr %call.i13 to ptr
  %call2 = tail call i32 @foo(ptr %0, ptr %1, i32 %argc)

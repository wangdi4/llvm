...
define i32 @foo(ptr nocapture %fooPtr, i32 %aconst, i32 %n, ptr nocapture %bf) #0 {
entry:
...
if.end:                                           ; preds = %if.then, %entry.if.end_crit_edge
  ...
  %i1 = bitcast ptr %bf to ptr
  store i64 %i, ptr %i1, align 8, !tbaa !1
  %div = sdiv i32 %aconst, 2
  %idxprom = sext i32 %div to i64
  %idxprom1 = sext i32 %n to i64
  %i2 = load ptr, ptr @foo.fooBuf, align 8, !tbaa !1
  %arrayidx2 = getelementptr inbounds [2 x [1024 x i32]], ptr %i2, i64 0, i64 %idxprom1, i64 %idxprom
...
for.body.prol:                                    ; preds = %for.body.prol, %for.body.prol.preheader
  ...
  %i4 = trunc i64 %indvars.iv.prol to i32
  store i32 %i4, ptr %arrayidx5.prol, align 4, !tbaa !5
  %i5 = load i32, ptr %arrayidx2, align 4, !tbaa !5
  %add.prol = add nsw i32 %i5, %sum.016.prol
...
for.body.preheader.split:                         ; preds = %for.body.preheader.split.loopexit, %for.body.preheader
  ...
  %i6 = icmp ult i32 %i3, 3
  br i1 %i6, label %for.end.loopexit, label %for.body.preheader.split.split
...
for.body:                                         ; preds = %for.body, %for.body.preheader.split.split
  ...
  %i7 = trunc i64 %indvars.iv to i32
  store i32 %i7, ptr %arrayidx5, align 4, !tbaa !5
  %i8 = load i32, ptr %arrayidx2, align 4, !tbaa !5
  %add = add nsw i32 %i8, %sum.016
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx5.1 = getelementptr inbounds i32, ptr %fooPtr, i64 %indvars.iv.next
  %i9 = trunc i64 %indvars.iv.next to i32
  store i32 %i9, ptr %arrayidx5.1, align 4, !tbaa !5
  %i10 = load i32, ptr %arrayidx2, align 4, !tbaa !5
  %add.1 = add nsw i32 %i10, %add
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2
  %arrayidx5.2 = getelementptr inbounds i32, ptr %fooPtr, i64 %indvars.iv.next.1
  %i11 = trunc i64 %indvars.iv.next.1 to i32
  store i32 %i11, ptr %arrayidx5.2, align 4, !tbaa !5
  %i12 = load i32, ptr %arrayidx2, align 4, !tbaa !5
  %add.2 = add nsw i32 %i12, %add.1
  %indvars.iv.next.2 = add nsw i64 %indvars.iv, 3
  %arrayidx5.3 = getelementptr inbounds i32, ptr %fooPtr, i64 %indvars.iv.next.2
  %i13 = trunc i64 %indvars.iv.next.2 to i32
  store i32 %i13, ptr %arrayidx5.3, align 4, !tbaa !5
  %i14 = load i32, ptr %arrayidx2, align 4, !tbaa !5
  %add.3 = add nsw i32 %i14, %add.2

; RUN: opt < %s -anders-aa -print-non-escape-candidates -disable-output 2>&1 | grep "foo." | count 2
; RUN: opt < %s -convert-to-subscript -S | opt -anders-aa -print-non-escape-candidates -disable-output 2>&1 | grep "foo." | count 2
...
@bf = common global [2 x [1024 x i32]]* null, align 8
...
if.end:                                           ; preds = %entry.if.end_crit_edge, %if.then
  ...
  store i64 %0, i64* bitcast ([2 x [1024 x i32]]** @bf to i64*), align 8, !tbaa !1
...
for.body.prol:                                    ; preds = %for.body.prol.preheader, %for.body.prol
  ...
  store i32 %2, i32* %arrayidx5.prol, align 4, !tbaa !5
  %3 = load i32, i32* %arrayidx2, align 4, !tbaa !5
  %add.prol = add nsw i32 %3, %sum.016.prol
...
for.body.preheader.split:                         ; preds = %for.body.preheader.split.loopexit, %for.body.preheader
  ...
  %4 = icmp ult i32 %1, 3
  br i1 %4, label %for.end.loopexit, label %for.body.preheader.split.split
...
for.body:                                         ; preds = %for.body, %for.body.preheader.split.split
  ...
  store i32 %11, i32* %arrayidx5.3, align 4, !tbaa !5

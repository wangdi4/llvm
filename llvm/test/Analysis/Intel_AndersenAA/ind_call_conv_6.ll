...
make_icall:
  ...
  %icall_result = call i64 %fptr.as.ETDTProc(ptr %lockit, i32 6)
  br label %done
...
define internal i64 @"?OFNHookProc@FileDialog@@KA_KPEAUHWND__@@I_K_J@Z"(ptr %0, i32 %1, i64 %2, i64 %3) {
  ret i64 0
}
...
define void @test(ptr %fptr) {
  %fptr.addr = getelementptr inbounds %class.NppParameters, ptr @"?_pSelf@NppParameters@@0PEAV1@EA", i64 0, i32 0
  store ptr %fptr, ptr %fptr.addr, align 8
  ret void
}

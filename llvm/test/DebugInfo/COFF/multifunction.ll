...
; RUN: llc -mcpu=core2 -mtriple=x86_64-pc-win32 -o - -O0 -debug-emit-wincodeviewlinetables < %s | llvm-mc -triple=x86_64-pc-win32 -filetype=obj | llvm-readobj -s -sr -codeview -section-symbols | FileCheck --check-prefix=OBJ64 %s

...
!0 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus, file: !1, producer: "clang version 3.8.0 (branches/dgi-xm 3706)", isOptimized: false, runtimeVersion: 0, emissionKind: 1, enums: !2)
!1 = !DIFile(filename: "<stdin>", directory: "/tmp")
!2 = !{}
!4 = distinct !DISubprogram(name: "f", linkageName: "\01?f@C@Test1@@UEAAXXZ", scope: !6, file: !5, line: 35, type: !8, isLocal: false, isDefinition: true, scopeLine: 35, flags: DIFlagPrototyped, isOptimized: false, unit: !0, declaration: !11, variables: !2)
...
!7 = !DINamespace(name: "Test1", scope: null)
...
!12 = distinct !DISubprogram(linkageName: "\01?f@C@Test1@@W7EAAXXZ", scope: !5, file: !5, line: 35, type: !13, isLocal: false, isDefinition: true, scopeLine: 35, flags: DIFlagArtificial | DIFlagThunk, isOptimized: false, unit: !0, variables: !2)

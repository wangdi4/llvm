...
; X86:       .secrel32 __ZL3bariz
; X86-NEXT:  .secidx   __ZL3bariz
; X86:       .long   242
; X86-NEXT:  .long   L{{[^-]+}}-L{{[^-]+}}
; X86-NEXT:  L{{.*}}:
; X86-NEXT:  .secrel32 __ZL3bariz
; X86-NEXT:  .secidx   __ZL3bariz
; X86-NEXT:  .short  0
; X86-NEXT:  .long   [[BAR_END]]-[[BAR_BEGIN]]
; X86-NEXT:  L{{.*}}:
; X86-NEXT:  .long   0
; X86-NEXT:  .long   2
; X86-NEXT:  .long   L{{[^-]+}}-L{{[^-]+}}
; X86-NEXT:  .long   [[BAR_BEGIN]]-[[BAR_BEGIN]]
; X86-NEXT:  .long   3
; X86-NEXT:  .long   L{{[^-]+}}-[[BAR_BEGIN]]
; X86-NEXT:  .long   4
...
!7 = distinct !DISubprogram(name: "bar", line: 3, isLocal: true, isDefinition: true, virtualIndex: 6, flags: DIFlagPrototyped, isOptimized: true, scopeLine: 3, file: !1, scope: !5, type: !6, function: void (i32, ...)* @_ZL3bariz, variables: !2)

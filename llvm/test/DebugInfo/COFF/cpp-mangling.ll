;;***INTEL
; RUN: llc -mcpu=core2 -mtriple=i686-pc-win32 -debug-emit-function-ids -o - -O0 < %s | llvm-mc -triple=i686-pc-win32 -filetype=obj | llvm-readobj -s -sr -codeview -section-symbols | FileCheck %s

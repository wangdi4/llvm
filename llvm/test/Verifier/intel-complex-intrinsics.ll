...
;T3: declare <3 x double> @llvm.intel.complex.fmul.v3f64(<3 x double>, <3 x double>)
;T3: define <3 x double> @t3(<3 x double> %a, <3 x double> %b) {
;T3:   %res = call <3 x double> @llvm.intel.complex.fmul.v3f64(<3 x double> %a, <3 x double> %b)
...
;T4: declare <2 x i64> @llvm.intel.complex.fmul.v2i64(<2 x i64>, <2 x i64>)
;T4: define <2 x i64> @t4(<2 x i64> %a, <2 x i64> %b) {
;T4:   %res = call <2 x i64> @llvm.intel.complex.fmul.v2i64(<2 x i64> %a, <2 x i64> %b)
;T4:   ret <2 x i64> %res
;T4: }

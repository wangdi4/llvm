...
define <16 x i32> @usmad(<32 x i32> %A, <16 x i32> %B, <16 x i32> %C) {
  %result = call <16 x i32> @llvm.experimental.matrix.usmad.v16i32.v32i32.v16i32(<32 x i32> %A, <16 x i32> %B, <16 x i32> %C, i32 8, i32 4, i32 4, metadata !"scope.subgroup")
  ret <16 x i32> %result
}

; CHECK1: @uumad
define <64 x i64> @uumad(<128 x i32> %A, <128 x i32> %B, <64 x i64> %C) {
  %result = call <64 x i64> @llvm.experimental.matrix.uumad.v64i64.v128i32.v128i32(<128 x i32> %A, <128 x i32> %B, <64 x i64> %C, i32 8, i32 16, i32 8, metadata !"scope.subgroup")
  ret <64 x i64> %result
}
...
declare <64 x float> @llvm.experimental.matrix.mad.v64f32.v128f32.v128f32(<128 x float>, <128 x float>, <64 x float>, i32, i32, i32, metadata)

declare <64 x float> @llvm.experimental.matrix.mad.v64f32.v128i16.v128i16(<128 x i16>, <128 x i16>, <64 x float>, i32, i32, i32, metadata)

declare <64 x i32> @llvm.experimental.matrix.sumad.v64i32.v128i32.v128i32(<128 x i32>, <128 x i32>, <64 x i32>, i32, i32, i32, metadata)

declare <16 x i32> @llvm.experimental.matrix.usmad.v16i32.v32i32.v16i32(<32 x i32>, <16 x i32>, <16 x i32>, i32, i32, i32, metadata)

declare <64 x i64> @llvm.experimental.matrix.uumad.v64i64.v128i32.v128i32(<128 x i32>, <128 x i32>, <64 x i64>, i32, i32, i32, metadata)
...
;T7: }
;T7:
;T7: declare <64 x float> @llvm.experimental.matrix.uumad.v64f32.v128f32.v128f32(<128 x float>, <128 x float>, <64 x float>, i32, i32, i32, metadata)

...
%"class.xercesc_2_7::XMLURL" = type { i32 (...)**, %"class.xercesc_2_7::MemoryManager"*, i16*, i16*, i16*, i16*, i32, i32, i16*, i16*, i16*, i8 }
...
define internal %"class.xercesc_2_7::BinInputStream"* @"?makeNewStream@XMLURL@xercesc_2_7@@QEBAPEAVBinInputStream@2@XZ"(%"class.xercesc_2_7::XMLURL"* nocapture readonly %arg) unnamed_addr align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {

bb89:
  %i54 = getelementptr inbounds %"class.xercesc_2_7::XMLURL", %"class.xercesc_2_7::XMLURL"* %arg, i64 0, i32 1
  %i55 = load %"class.xercesc_2_7::MemoryManager"*, %"class.xercesc_2_7::MemoryManager"** %i54, align 8
  %i56 = getelementptr inbounds %"class.xercesc_2_7::XMLURL", %"class.xercesc_2_7::XMLURL"* %arg, i64 0, i32 5
  %i91 = invoke noalias nonnull i8* @bar(i64 75)
...
bb94:                                             ; preds = %bb92
  %i95 = catchpad within %i93 [i8* null, i32 64, i8* null]
  unreachable

bb102:                                            ; preds = %bb89
  %i103 = bitcast i8* %i91 to i16*
  %i105 = load %"class.xercesc_2_7::MemoryManager"*, %"class.xercesc_2_7::MemoryManager"** %i54, align 8
...
bb139:                                            ; preds = %bb130, %bb116, %bb102
  ...
  %i141 = phi %"class.xercesc_2_7::MemoryManager"* [ %i105, %bb130 ], [ %i105, %bb102 ], [ %i55, %bb116 ]
  %i142 = phi i8* [ %i91, %bb130 ], [ %i91, %bb102 ], [ null, %bb116 ]
...
bb232:                                            ; preds = %bb217
  %i234 = invoke noalias nonnull i8* @bar(i64 11)
...
bb237:                                            ; preds = %bb235
  %i238 = catchpad within %i236 [i8* null, i32 64, i8* null]
  invoke void @_CxxThrowException(i8* null, %eh.ThrowInfo* null) [ "funclet"(token %i238) ]
          to label %bb460 unwind label %bb421
...
bb291:                                            ; preds = %bb291, %bb284
  %i292 = phi i16* [ %i293, %bb291 ], [ %i103, %bb284 ]
  %i293 = getelementptr inbounds i16, i16* %i292, i64 1
  %i294 = load i16, i16* %i293, align 2
  br i1 undef, label %bb301, label %bb291
...
bb337:                                            ; preds = %bb323
  %i339 = invoke noalias nonnull i8* @bar(i64 32)
...
bb342:                                            ; preds = %bb340
  %i343 = catchpad within %i341 [i8* null, i32 64, i8* null]
  invoke void @_CxxThrowException(i8* null, %eh.ThrowInfo* null) [ "funclet"(token %i343) ]
          to label %bb460 unwind label %bb421
...
bb385:                                            ; preds = %bb369
  invoke void @_CxxThrowException(i8* null, %eh.ThrowInfo* null) [ "funclet"(token %i370) ]
...
bb395:                                            ; preds = %bb358
  %i396 = bitcast i8* null to %"class.xercesc_2_7::BinInputStream"*
  br label %bb397

bb397:                                            ; preds = %bb395, %bb358
  %i398 = phi %"class.xercesc_2_7::BinInputStream"* [ %i396, %bb395 ], [ null, %bb358 ]
...
bb421:                                            ; preds = %bb394, %bb345, %bb342, %bb340, %bb307, %bb305, %bb251, %bb249, %bb240, %bb237, %bb235, %bb144, %bb139
  ...
  %i423 = phi %"class.xercesc_2_7::MemoryManager"* [ %i105, %bb345 ], [ %i105, %bb342 ], [ %i105, %bb340 ], [ %i105, %bb307 ], [ %i105, %bb305 ], [ %i105, %bb240 ], [ %i105, %bb237 ], [ %i105, %bb235 ], [ %i141, %bb144 ], [ %i141, %bb139 ], [ %i105, %bb394 ], [ %i105, %bb251 ], [ %i105, %bb249 ]
  %i424 = phi i8* [ %i91, %bb345 ], [ %i91, %bb342 ], [ %i91, %bb340 ], [ %i91, %bb307 ], [ %i91, %bb305 ], [ %i91, %bb240 ], [ %i91, %bb237 ], [ %i91, %bb235 ], [ %i142, %bb144 ], [ %i142, %bb139 ], [ %i91, %bb394 ], [ %i91, %bb251 ], [ %i91, %bb249 ]
...
bb459:                                            ; preds = %bb397
  ret %"class.xercesc_2_7::BinInputStream"* %i398

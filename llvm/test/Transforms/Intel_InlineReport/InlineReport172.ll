...
; Check that the names of the functions multiversioned by auto cpu dispatch are
; correct in the inlining reports.
; Since the target triple specifies Windows OS, __intel.acd.resolver should be
; generated.

; CHECK-LABEL: COMPILE FUNC: foo.A
; CHECK-LABEL: COMPILE FUNC: foo.a
; CHECK-CL-LABEL: COMPILE FUNC: __intel.acd.resolver

target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc19.29.30133"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @foo(ptr nocapture noundef %a, ptr nocapture noundef readonly %b, i32 noundef %n) local_unnamed_addr #0 !llvm.auto.cpu.dispatch !3 {
entry:

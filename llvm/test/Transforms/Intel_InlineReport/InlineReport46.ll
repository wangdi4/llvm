...
; RUN: opt < %s -enable-new-pm=0 -inline -dtrans-inline-heuristics -intel-libirc-allowed -inline-report=0xe807 -S 2>&1 | FileCheck %s
...
define internal fastcc void @foo() unnamed_addr #1 !prof !38 !PGOFuncName !39 {
entry:
  ret void
}

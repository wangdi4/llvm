...
define internal fastcc void @sw_IP_ddx_(%uplevel_type* noalias nocapture %0, %"QNCA_a0$double*$rank2$.3"* noalias nocapture readonly dereferenceable(96) %1, %"QNCA_a0$double*$rank2$.3"* noalias nocapture readonly dereferenceable(96) "ptrnoalias" %2) unnamed_addr #0 {
  ...
  %10 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %7, i32 0)
  %11 = load i64, i64* %10, align 1
  %12 = icmp sgt i64 %11, 0
  %13 = select i1 %12, i64 %11, i64 0
  %14 = trunc i64 %13 to i32
  %15 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %7, i32 1)
  ...
  %25 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %8, i32 0)
  %26 = load i64, i64* %25, align 1
  %27 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %8, i32 1)
...
37:                                               ; preds = %54, %37
  ...
  %41 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %26, double* %56, i64 %38)
  %42 = load double, double* %41, align 1
  %43 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %26, double* %56, i64 %40)
  %44 = load double, double* %43, align 1
  %45 = fsub fast double %42, %44
  %46 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %57, i64 %39)
...
54:                                               ; preds = %51, %32
  ...
  %56 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %28, double* %24, i64 %55)
  %57 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %23, double* %20, i64 %55)
  br label %37

58:                                               ; preds = %71, %58
  %59 = phi i64 [ %69, %58 ], [ 1, %71 ]
  %60 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %28, double* %24, i64 %59)
  %61 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %26, double* %60, i64 2)
  %62 = load double, double* %61, align 1
  %63 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %26, double* %60, i64 1)
  %64 = load double, double* %63, align 1
  %65 = fsub fast double %62, %64
  %66 = fmul fast double %65, 2.000000e+00
  %67 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %23, double* %20, i64 %59)
  %68 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %67, i64 1)
...
75:                                               ; preds = %88, %75
  ...
  %77 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %28, double* nonnull %24, i64 %76)
  %78 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %26, double* %77, i64 %22)
  %79 = load double, double* %78, align 1
  %80 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %26, double* %77, i64 %90)
  %81 = load double, double* %80, align 1
  %82 = fsub fast double %79, %81
  %83 = fmul fast double %82, 2.000000e+00
  %84 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %23, double* nonnull %20, i64 %76)
  %85 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %84, i64 %22)
...
define internal fastcc void @sw_IP_ddy_(%uplevel_type* noalias nocapture %0, %"QNCA_a0$double*$rank2$.3"* noalias nocapture readonly dereferenceable(96) %1, %"QNCA_a0$double*$rank2$.3"* noalias nocapture readonly dereferenceable(96) "ptrnoalias" %2) unnamed_addr #0 {
  ...
  %28 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %8, i32 0)
  %29 = load i64, i64* %28, align 1
  %30 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %8, i32 1)
...
38:                                               ; preds = %53, %38
  ...
  %40 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %29, double* %57, i64 %39)
  %41 = load double, double* %40, align 1
  %42 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %29, double* %58, i64 %39)
  %43 = load double, double* %42, align 1
  %44 = fsub fast double %41, %43
  %45 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %59, i64 %39)
...
53:                                               ; preds = %48, %35
  ...
  %57 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %31, double* %27, i64 %54)
  %58 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %31, double* %27, i64 %56)
  %59 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %23, double* %20, i64 %55)
  br label %38
...
62:                                               ; preds = %60
  %63 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %31, double* %27, i64 2)
  %64 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %31, double* %27, i64 1)
  %65 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %23, double* %20, i64 1)
  %66 = add nsw i64 %22, 1
  br label %67

67:                                               ; preds = %67, %62
  %68 = phi i64 [ 1, %62 ], [ %76, %67 ]
  %69 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %29, double* %63, i64 %68)
  %70 = load double, double* %69, align 1
  %71 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %29, double* %64, i64 %68)
  %72 = load double, double* %71, align 1
  %73 = fsub fast double %70, %72
  %74 = fmul fast double %73, 2.000000e+00
  %75 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %65, i64 %68)
...
78:                                               ; preds = %89, %78
  ...
  %80 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %29, double* %91, i64 %79)
  %81 = load double, double* %80, align 1
  %82 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 %29, double* %92, i64 %79)
  %83 = load double, double* %82, align 1
  %84 = fsub fast double %81, %83
  %85 = fmul fast double %84, 2.000000e+00
  %86 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %93, i64 %79)
...
89:                                               ; preds = %67
  ...
  %91 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %31, double* nonnull %27, i64 %90)
  %92 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %31, double* nonnull %27, i64 %26)
  %93 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 %23, double* nonnull %20, i64 %90)
  br label %78

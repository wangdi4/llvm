...
; CHECK-OLD: call void @f(%struct.ss* byval %theXObject)
; CHECK-OLD: call void @g(%struct.ss* byval %theXObject)
; CHECK-OLD: call void @f(%struct.ss* byval %theXObject)
; CHECK-OLD: call void @g(%struct.ss* byval %theXObject)
; CHECK-OLD: call void @f(%struct.ss* byval %theXObject)
; CHECK-OLD: call void @g(%struct.ss* byval %theXObject)
...
; CHECK-NEW: call void @f(%struct.ss* byval %theXObject)
; CHECK-NEW: call void @g(%struct.ss* byval %theXObject)
; CHECK-NEW: call void @f(%struct.ss* byval %theXObject)
; CHECK-NEW: call void @g(%struct.ss* byval %theXObject)
; CHECK-NEW: call void @f(%struct.ss* byval %theXObject)
; CHECK-NEW: call void @g(%struct.ss* byval %theXObject)

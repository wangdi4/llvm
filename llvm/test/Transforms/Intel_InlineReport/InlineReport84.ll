...
; RUN: opt -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -dtrans-inline-heuristics -intel-libirc-allowed -inline-report=0xe886 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,CHECK-MD

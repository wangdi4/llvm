...
define i32 @mc_polymer_iteration(%struct.Phase* %p, i32 %nsteps, i32 %tuning_parameter) local_unnamed_addr {
entry:
...
define i32 @mc_set_iteration(%struct.Phase* %p, i32 %nsteps, i32 %tuning_parameter) local_unnamed_addr {
entry:
  %p.addr = alloca %struct.Phase*, align 8

...
; RUN: opt -opaque-pointers -passes='inlinereportsetup' -inline-report=0xe886 < %s -S | opt -passes='cgscc(inline)' -lto-inline-cost -inlining-dyn-alloca-adjustable=true -inlining-dyn-alloca-adjustable-max-count=1 -inline-report=0xe886 -S | opt -passes='inlinereportemitter' -inline-report=0xe886 -S 2>&1 | FileCheck %s

...
; RUN: opt  -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-dyn-alloca-adjustable=true -inline-report=0xe886 -S < %s 2>&1 | FileCheck %s

; RUN: opt -opaque-pointers -inline -inline-report=0xf859 -intel-opt-report-file=stdout < %s -disable-output | FileCheck %s --check-prefixes=CHECK,CHECK-INLREP
; RUN: opt -opaque-pointers -inline -inline-report=0xf859 -intel-opt-report-file=stderr < %s -disable-output 2>&1 >%tout | FileCheck %s --check-prefixes=CHECK,CHECK-INLREP
; RUN: opt -opaque-pointers -inline -inline-report=0xf859 -intel-opt-report-file=%t < %s -disable-output
...
; RUN: opt -opaque-pointers -inlinereportsetup -inline-report=0xf8d8 < %s -S | opt -inline -inline-report=0xf8d8 -S | opt -inlinereportemitter -inline-report=0xf8d8 -intel-opt-report-file=stdout -disable-output | FileCheck %s --check-prefixes=CHECK,CHECK-MD-INLREP
; RUN: opt -opaque-pointers -inlinereportsetup -inline-report=0xf8d8 < %s -S | opt -inline -inline-report=0xf8d8 -S | opt -inlinereportemitter -inline-report=0xf8d8 -intel-opt-report-file=stderr -disable-output 2>&1 >%tout | FileCheck %s --check-prefixes=CHECK,CHECK-MD-INLREP
; RUN: opt -opaque-pointers -inlinereportsetup -inline-report=0xf8d8 < %s -S | opt -inline -inline-report=0xf8d8 -S | opt -inlinereportemitter -inline-report=0xf8d8 -intel-opt-report-file=%t -disable-output

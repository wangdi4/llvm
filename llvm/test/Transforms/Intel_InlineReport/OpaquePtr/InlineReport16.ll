; RUN: opt -opaque-pointers -inline -inline-report=0xf847 -inline-threshold=10 -disable-output < %s 2>&1 | FileCheck %s
...
; RUN: opt -opaque-pointers -inlinereportsetup -inline-report=0xf8c6 < %s -S | opt -inline -inline-report=0xf8c6 -inline-threshold=10 -S | opt -inlinereportemitter -inline-report=0xf8c6 -disable-output 2>&1 | FileCheck %s

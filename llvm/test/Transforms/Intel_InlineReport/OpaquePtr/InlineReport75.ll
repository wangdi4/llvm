...
; RUN: opt -opaque-pointers -inline -disable-output -inline-report=0xe807 -dtrans-inline-heuristics -pre-lto-inline-cost < %s 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers -passes=inline -disable-output -inline-report=0xe807 -dtrans-inline-heuristics -pre-lto-inline-cost < %s 2>&1 | FileCheck %s

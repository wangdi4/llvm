...
; RUN: opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inline-threshold=0 -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -inline-threshold=0 -S -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefix=CHECK-BG
; RUN: opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-host -sycl-optimization-mode -inline-threshold=0 -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-host -inline-threshold=0 -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-optimization-mode -inline-threshold=0 -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD

...
; RUN: opt -opaque-pointers -passes='inlinereportsetup' -inline-report=0xea86 < %s -S | opt -passes='function(gvn)' -inline-report=0xea86 -S | opt -passes='inlinereportemitter' -inline-report=0xea86 -S 2>&1 | FileCheck %s

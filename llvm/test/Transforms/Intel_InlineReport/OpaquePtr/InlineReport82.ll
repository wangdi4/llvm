...
; when outer functions do not meet criteria (Missing openmp attribute).
...
define i32 @mc_polymer_iteration(ptr %p, i32 %nsteps, i32 %tuning_parameter) local_unnamed_addr {
entry:
...
define i32 @mc_set_iteration(ptr %p, i32 %nsteps, i32 %tuning_parameter) local_unnamed_addr {
entry:
  %p.addr = alloca ptr, align 8

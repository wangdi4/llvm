...
define dso_local void @_Z4initP8two_intsiS_S_(ptr noundef %a, i32 noundef %n, i64 %value_one.coerce, i64 %value_two.coerce) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  %call = call i64 @_ZN8two_intsplES_(ptr noundef nonnull align 4 dereferenceable(8) %tmpcast, i64 %value_two.coerce)
  %idxprom = zext i32 %i.0 to i64
  %arrayidx = getelementptr inbounds %class.two_ints, ptr %a, i64 %idxprom
  %ref.tmp.sroa.0.0..sroa_cast1 = bitcast ptr %arrayidx to ptr
  store i64 %call, ptr %ref.tmp.sroa.0.0..sroa_cast1, align 4, !tbaa.struct !3
...
declare dso_local i64 @_ZN8two_intsplES_(ptr noundef nonnull align 4 dereferenceable(8), i64) local_unnamed_addr #1

; Function Attrs: mustprogress uwtable
define dso_local i64 @_Z5mysumP8two_intsi(ptr noundef %a, i32 noundef %n) local_unnamed_addr #0 {
entry:
  %retval = alloca i64, align 8
  %tmpcast = bitcast ptr %retval to ptr
  call void @_ZN8two_intsC2Eii(ptr noundef nonnull align 4 dereferenceable(8) %tmpcast, i32 noundef 0, i32 noundef 0)
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %agg.tmp.sroa.0.0.copyload = load i64, ptr %agg.tmp.sroa.0.0..sroa_cast, align 4, !tbaa.struct !3
  %call = call i64 @_ZN8two_intsplES_(ptr noundef nonnull align 4 dereferenceable(8) %tmpcast, i64 %agg.tmp.sroa.0.0.copyload)
  store i64 %call, ptr %retval, align 8, !tbaa.struct !3
  %inc = add nuw nsw i32 %i.0, 1
  br label %for.cond, !llvm.loop !10

for.end:                                          ; preds = %for.cond
  %i = load i64, ptr %retval, align 8
  ret i64 %i
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN8two_intsC2Eii(ptr noundef nonnull align 4 dereferenceable(8) %this, i32 noundef %int_one, i32 noundef %int_two) unnamed_addr #2 comdat align 2 {
entry:
  %_int_one = getelementptr inbounds %class.two_ints, ptr %this, i64 0, i32 0, !intel-tbaa !11
  store i32 %int_one, ptr %_int_one, align 4, !tbaa !11
  %_int_two = getelementptr inbounds %class.two_ints, ptr %this, i64 0, i32 1, !intel-tbaa !13
  store i32 %int_two, ptr %_int_two, align 4, !tbaa !13
  ret void
}

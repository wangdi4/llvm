...
; RUN: opt -opaque-pointers -passes='cgscc(inline)' -pre-lto-inline-cost -inlining-dyn-alloca-special-arg-count=3 < %s -S 2>&1 | opt -opaque-pointers -passes='cgscc(inline)' -inline-report=0xe807 -lto-inline-cost -inlining-dyn-alloca-special-arg-count=3 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-GOOD,CHECK-GOOD-CL
; RUN: opt -opaque-pointers -passes='cgscc(inline)' -pre-lto-inline-cost -inlining-dyn-alloca-special-arg-count=3 < %s -S 2>&1 | opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -inline-report=0xe886 -lto-inline-cost -inlining-dyn-alloca-special-arg-count=3 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-GOOD,CHECK-GOOD-ML
; RUN: opt -opaque-pointers -passes='cgscc(inline)' -pre-lto-inline-cost -inlining-dyn-alloca-special-arg-count=4 < %s -S 2>&1 | opt -opaque-pointers -passes='cgscc(inline)' -inline-report=0xe807 -lto-inline-cost -inlining-dyn-alloca-special-arg-count=4 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-BAD,CHECK-BAD-CL
; RUN: opt -opaque-pointers -passes='cgscc(inline)' -pre-lto-inline-cost -inlining-dyn-alloca-special-arg-count=4 < %s -S 2>&1 | opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -inline-report=0xe886 -lto-inline-cost -inlining-dyn-alloca-special-arg-count=4 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-BAD,CHECK-BAD-ML

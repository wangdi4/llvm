...
; RUN: opt -opaque-pointers < %s -enable-new-pm=0 -ip-cloning -ip-gen-cloning-force-enable-dtrans -inline -inline-report=0xe807 -S 2>&1 | FileCheck --check-prefix=CHECK-OLD %s

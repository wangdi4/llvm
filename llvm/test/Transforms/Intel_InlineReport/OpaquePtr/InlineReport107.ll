; RUN: opt -opaque-pointers < %s -inline -call-tree-clone -inline-report=0xe807 -call-tree-clone-do-mv=false -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -disable-output 2>&1 | FileCheck %s --check-prefix=CHECK
...
; RUN: opt -opaque-pointers -inlinereportsetup -inline-report=0xe886 < %s -S | opt -inline -call-tree-clone -inline-report=0xe886 -call-tree-clone-do-mv=false -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -S | opt -inlinereportemitter -inline-report=0xe886 -disable-output 2>&1 | FileCheck %s --check-prefix=CHECK-MD
; RUN: opt -opaque-pointers -passes='inlinereportsetup' -inline-report=0xe886 < %s -S | opt -passes='cgscc(inline),module(call-tree-clone)' -inline-report=0xe886 -call-tree-clone-do-mv=false -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -S | opt -passes='inlinereportemitter' -inline-report=0xe886 -disable-output 2>&1 | FileCheck %s --check-prefix=CHECK-MD
...
; CHECK: foo {{.*}}Callee has noinline attribute
; CHECK: foo {{.*}}Callee has noinline attribute

; CHECK-LABEL: COMPILE FUNC: gee{{ *$}}
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: bar {{.*}}Callee has noinline attribute
; CHECK: bar {{.*}}Callee has noinline attribute

; CHECK-LABEL: COMPILE FUNC: main{{ *$}}
; CHECK: EXTERN: printf0{{ *$}}
; CHECK: gee|2.4.5 {{.*}}Callee has noinline attribute
; CHECK: gee|1.2.3 {{.*}}Callee has noinline attribute
; CHECK: gee|2.4.5 {{.*}}Callee has noinline attribute
; CHECK: gee|3.1.0 {{.*}}Callee has noinline attribute
...
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: foo {{.*}}Callee has noinline attribute
; CHECK: foo|_.6.5.11 {{.*}}Callee has noinline attribute
...
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: foo|9.7.13.2 {{.*}}Callee has noinline attribute
; CHECK: foo|15.9.5.14 {{.*}}Callee has noinline attribute

; CHECK-LABEL: COMPILE FUNC: gee|2.4.5{{ *$}}
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: bar|_.5.6 {{.*}}Callee has noinline attribute
; CHECK: bar|7.8.6 {{.*}}Callee has noinline attribute
...
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: foo {{.*}}Callee has noinline attribute
; CHECK: foo|_.4.5.7 {{.*}}Callee has noinline attribute
...
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: foo|9.7.10.2 {{.*}}Callee has noinline attribute
; CHECK: foo|15.9.5.11 {{.*}}Callee has noinline attribute

; CHECK-LABEL: COMPILE FUNC: gee|1.2.3{{ *$}}
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: bar|_.3.4 {{.*}}Callee has noinline attribute
; CHECK: bar|7.8.3 {{.*}}Callee has noinline attribute
...
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: foo {{.*}}Callee has noinline attribute
; CHECK: foo|_.3.5.3 {{.*}}Callee has noinline attribute
...
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: foo|9.7.11.2 {{.*}}Callee has noinline attribute
; CHECK: foo|15.9.5.12 {{.*}}Callee has noinline attribute

; CHECK-LABEL: COMPILE FUNC: gee|3.1.0{{ *$}}
; CHECK: EXTERN: printf3{{ *$}}
; CHECK: bar|_.2.1 {{.*}}Callee has noinline attribute
; CHECK: bar|7.8.4 {{.*}}Callee has noinline attribute
...
; CHECK-MD: foo {{.*}}Callee has noinline attribute
; CHECK-MD: foo {{.*}}Callee has noinline attribute
...
; CHECK-MD: gee|2.4.5 {{.*}}Callee has noinline attribute
; CHECK-MD: gee|1.2.3 {{.*}}Callee has noinline attribute
; CHECK-MD: gee|2.4.5 {{.*}}Callee has noinline attribute
; CHECK-MD: gee|3.1.0 {{.*}}Callee has noinline attribute
...
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: foo {{.*}}Callee has noinline attribute
; CHECK-MD: foo|_.6.5.11 {{.*}}Callee has noinline attribute
...
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: foo|9.7.13.2 {{.*}}Callee has noinline attribute
; CHECK-MD: foo|15.9.5.14 {{.*}}Callee has noinline attribute

; CHECK-MD-LABEL: COMPILE FUNC: gee|2.4.5{{ *$}}
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: bar|_.5.6 {{.*}}Callee has noinline attribute
; CHECK-MD: bar|7.8.6 {{.*}}Callee has noinline attribute
...
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: foo {{.*}}Callee has noinline attribute
; CHECK-MD: foo|_.4.5.7 {{.*}}Callee has noinline attribute
...
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: foo|9.7.10.2 {{.*}}Callee has noinline attribute
; CHECK-MD: foo|15.9.5.11 {{.*}}Callee has noinline attribute

; CHECK-MD-LABEL: COMPILE FUNC: gee|1.2.3{{ *$}}
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: bar|_.3.4 {{.*}}Callee has noinline attribute
; CHECK-MD: bar|7.8.3 {{.*}}Callee has noinline attribute
...
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: foo {{.*}}Callee has noinline attribute
; CHECK-MD: foo|_.3.5.3{{.*}}Callee has noinline attribute
...
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: foo|9.7.11.2 {{.*}}Callee has noinline attribute
; CHECK-MD: foo|15.9.5.12 {{.*}}Callee has noinline attribute

; CHECK-MD-LABEL: COMPILE FUNC: gee|3.1.0{{ *$}}
; CHECK-MD: EXTERN: printf3{{ *$}}
; CHECK-MD: bar|_.2.1 {{.*}}Callee has noinline attribute
; CHECK-MD: bar|7.8.4 {{.*}}Callee has noinline attribute

...
L1161:                                            ; preds = %L1161, %entry
  ...
  call fastcc void @sw_IP_ddx_(ptr nonnull %t3, ptr nonnull %t181, ptr nonnull %t180)
  call fastcc void @sw_IP_ddy_(ptr nonnull %t3, ptr nonnull %t183, ptr nonnull %t182)

; RUN: opt -opaque-pointers -passes=inlinereportsetup -inline-report=128 < %s -S 2>&1 | FileCheck %s
...
; CHECK-NEXT: [[A1_MAIN_CS]] = distinct !{!"intel.callsite.inlining.report", [[A_NAME:![0-9]+]], null, [[INL_0:![0-9]+]], [[REASON_NO_REASON:![0-9]+]], [[INL_COST:![0-9]+]], [[OUT_INL_COST:![0-9]+]], [[INL_TR:![0-9]+]], [[EE_COST:![0-9]+]], [[EE_TR:![0-9]+]], !"line: 11 col: 3", [[MODULE_NAME]], [[SUPPRESS_PRINT]], [[ISCOSTBENEFIT:![0-9]+]], [[CBPAIRCOST:![0-9]+]], [[CBPAIRBENEFIT:![0-9]+]], [[ICSMETHOD:![0-9]+]]}
...
; CHECK-NEXT: [[B_MAIN_CS]] = distinct !{!"intel.callsite.inlining.report", [[B_NAME:![0-9]+]], null, [[INL_0]], [[REASON_EXTRN:![0-9]+]], [[INL_COST]], [[OUT_INL_COST]], [[INL_TR]], [[EE_COST]], [[EE_TR]], !"line: 12 col: 3", [[MODULE_NAME]], [[SUPPRESS_PRINT]], [[ISCOSTBENEFIT]], [[CBPAIRCOST]], [[CBPAIRBENEFIT]], [[ICSMETHOD]]}
; CHECK-NEXT: [[B_NAME]] = !{!"name: b"}
; CHECK-NEXT: [[REASON_EXTRN]] = !{!"reason: {{[0-9]+}}"}
; CHECK-NEXT: [[A2_MAIN_CS]] = distinct !{!"intel.callsite.inlining.report", [[A_NAME]], null, [[INL_0]], [[REASON_NO_REASON]], [[INL_COST]], [[OUT_INL_COST]], [[INL_TR]], [[EE_COST]], [[EE_TR]], !"line: 13 col: 3", [[MODULE_NAME]], [[SUPPRESS_PRINT]], [[ISCOSTBENEFIT]], [[CBPAIRCOST]], [[CBPAIRBENEFIT]], [[ICSMETHOD]]}
...
; CHECK-NEXT: [[X_A_CS]] = distinct !{!"intel.callsite.inlining.report", [[X_NAME:![0-9]+]], null, [[INL_0]], [[REASON_EXTRN]], [[INL_COST]], [[OUT_INL_COST]], [[INL_TR]], [[EE_COST]], [[EE_TR]], !"line: 18 col: 3", [[MODULE_NAME]], [[SUPPRESS_PRINT]], [[ISCOSTBENEFIT]], [[CBPAIRCOST]], [[CBPAIRBENEFIT]], [[ICSMETHOD]]}
; CHECK-NEXT: [[X_NAME]] = !{!"name: x"}
; CHECK-NEXT: [[Y_A_CS]] = distinct !{!"intel.callsite.inlining.report", [[Y_NAME:![0-9]+]], null, [[INL_0]], [[REASON_NO_REASON]], [[INL_COST]], [[OUT_INL_COST]], [[INL_TR]], [[EE_COST]], [[EE_TR]], !"line: 19 col: 3", [[MODULE_NAME]], [[SUPPRESS_PRINT]], [[ISCOSTBENEFIT]], [[CBPAIRCOST]], [[CBPAIRBENEFIT]], [[ICSMETHOD]]}
...
; CHECK-NEXT: [[Z_Y_CS]] = distinct !{!"intel.callsite.inlining.report", [[Z_NAME:![0-9]+]], null, [[INL_0]], [[REASON_EXTRN]], [[INL_COST]], [[OUT_INL_COST]], [[INL_TR]], [[EE_COST]], [[EE_TR]], !"line: 23 col: 3", [[MODULE_NAME]], [[SUPPRESS_PRINT]], [[ISCOSTBENEFIT]], [[CBPAIRCOST]], [[CBPAIRBENEFIT]], [[ICSMETHOD]]}

...
; RUN: opt -passes=inline -pre-lto-inline-cost -inline-threshold=0 -inline-report=0xf867 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-CL
; RUN: opt -passes=inline -pre-lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -inline-threshold=0 -S -inline-report=0xf867 < %s 2>&1 | FileCheck %s --check-prefix=CHECK-BG
; RUN: opt -passes=inline -pre-lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-host -sycl-optimization-mode -inline-threshold=0 -S -inline-report=0xf867 < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-CL
; RUN: opt -passes=inline -pre-lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-host -inline-threshold=0 -S -inline-report=0xf867 < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-CL
; RUN: opt -passes=inline -pre-lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-optimization-mode -inline-threshold=0 -S -inline-report=0xf867 < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-CL
; RUN: opt -passes='inlinereportsetup' -inline-report=0xf8e6 < %s -S | opt -passes=inline -pre-lto-inline-cost -inline-threshold=0 -inline-report=0xf8e6 -S | opt -passes=inlinereportemitter -inline-report=0xf8e6 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -passes=inlinereportsetup -inline-report=0xf8e6 < %s -S | opt -passes=inline -pre-lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -inline-threshold=0 -S -inline-report=0xf8e6 -S | opt -passes=inlinereportemitter -inline-report=0xf8e6 -S 2>&1 | FileCheck %s --check-prefix=CHECK-BG
; RUN: opt -passes=inlinereportsetup -inline-report=0xf8e6 < %s -S | opt -passes=inline -pre-lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-host -sycl-optimization-mode -inline-threshold=0 -S -inline-report=0xf8e6 -S | opt -passes=inlinereportemitter -inline-report=0xf8e6 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -passes=inlinereportsetup -inline-report=0xf8e6 < %s -S | opt -passes=inline -pre-lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-host -inline-threshold=0 -S -inline-report=0xf8e6 -S | opt -passes=inlinereportemitter -inline-report=0xf8e6 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -passes=inlinereportsetup -inline-report=0xf8e6 < %s -S | opt -passes=inline -pre-lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-optimization-mode -inline-threshold=0 -S -inline-report=0xf8e6 -S | opt -passes=inlinereportemitter -inline-report=0xf8e6 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD

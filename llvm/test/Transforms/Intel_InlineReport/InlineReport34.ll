...
; CHECK-OLD-DAG: DEAD STATIC FUNC: foo.4
; CHECK-OLD-DAG: DEAD STATIC FUNC: foo.5
; CHECK-OLD-DAG: DEAD STATIC FUNC: foo.6
...
; CHECK-NEW-DAG: DEAD STATIC FUNC: foo.4
; CHECK-NEW-DAG: DEAD STATIC FUNC: foo.5
; CHECK-NEW-DAG: DEAD STATIC FUNC: foo.6

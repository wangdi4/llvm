...
; CHECK: [[MAIN_FIR]] = distinct !{!"intel.function.inlining.report", [[MAIN_NAME:![0-9]+]], [[MAIN_CSs:![0-9]+]], [[MODULE_NAME:![0-9]+]], [[IS_DEAD_0:![0-9]+]], [[IS_DECL_0:![0-9]+]], [[LINK_A:![0-9]+]]}
...
; CHECK-NEXT: [[B_FIR]] = distinct !{!"intel.function.inlining.report", [[B_NAME]], null, [[MODULE_NAME]], [[IS_DEAD_0]], [[IS_DECL_1:![0-9]+]], [[LINK_A]]}
; CHECK-NEXT: [[IS_DECL_1]] = !{!"isDeclaration: 1"}
; CHECK-NEXT: [[A_FIR]] = distinct !{!"intel.function.inlining.report", [[A_NAME]], [[A_CSs:![0-9]+]], [[MODULE_NAME]], [[IS_DEAD_0]], [[IS_DECL_0]], [[LINK_A]]}
...
; CHECK-NEXT: [[Y_FIR]] = distinct !{!"intel.function.inlining.report", [[Y_NAME]], [[Y_CSs:![0-9]+]], [[MODULE_NAME]], [[IS_DEAD_1:![0-9]+]], [[IS_DECL_0]], [[LINK_L:![0-9]+]]}
...
; CHECK-NEXT: [[Z_FIR]] = distinct !{!"intel.function.inlining.report", [[Z_NAME]], null, [[MODULE_NAME]], [[IS_DEAD_0]], [[IS_DECL_1]], [[LINK_A]]}
...
!11 = distinct !{!"intel.callsite.inlining.report", !12, null, !13, !14, !15, !16, !17, !18, !19, !"line: 10 col: 3", !20}
!12 = !{!"name: a"}
!13 = !{!"isInlined: 0"}
!14 = !{!"reason: 24"}
!15 = !{!"inlineCost: -1"}
...
!21 = distinct !{!"intel.callsite.inlining.report", !22, null, !13, !23, !15, !16, !17, !18, !19, !"line: 11 col: 3", !20}
!22 = !{!"name: b"}
!23 = !{!"reason: 30"}
!24 = !{!"isDead: 0"}
!25 = !{!"isDeclaration: 0"}
!26 = !{!"linkage: A"}
!27 = distinct !{!"intel.function.inlining.report", !22, null, !20, !24, !28, !26}
!28 = !{!"isDeclaration: 1"}
!29 = distinct !{!"intel.function.inlining.report", !12, !30, !20, !24, !25, !26}
!30 = distinct !{!"intel.callsites.inlining.report", !31, !33}
!31 = distinct !{!"intel.callsite.inlining.report", !32, null, !13, !23, !15, !16, !17, !18, !19, !"line: 16 col: 3", !20}
!32 = !{!"name: x"}
!33 = distinct !{!"intel.callsite.inlining.report", !34, null, !13, !14, !15, !16, !17, !18, !19, !"line: 17 col: 3", !20}
!34 = !{!"name: y"}
!35 = distinct !{!"intel.function.inlining.report", !32, null, !20, !24, !28, !26}
!36 = distinct !{!"intel.function.inlining.report", !34, !37, !20, !24, !25, !40}
!37 = distinct !{!"intel.callsites.inlining.report", !38}
!38 = distinct !{!"intel.callsite.inlining.report", !39, null, !13, !23, !15, !16, !17, !18, !19, !"line: 21 col: 3", !20}
!39 = !{!"name: z"}
!40 = !{!"linkage: L"}
!41 = distinct !{!"intel.function.inlining.report", !39, null, !20, !24, !28, !26}

...
; CHECK: [[MAIN_FIR]] = distinct !{!"intel.function.inlining.report", [[MAIN_NAME:![0-9]+]], [[MAIN_CSs:![0-9]+]], [[MODULE_NAME:![0-9]+]], [[IS_DEAD_0:![0-9]+]], [[IS_DECL_0:![0-9]+]], [[LINK_A:![0-9]+]], [[SUPPRESS_PRINT:![0-9]+]]}
...
; CHECK-NEXT: [[B_FIR]] = distinct !{!"intel.function.inlining.report", [[B_NAME]], null, [[MODULE_NAME]], [[IS_DEAD_0]], [[IS_DECL_1:![0-9]+]], [[LINK_A]], [[SUPPRESS_PRINT:![0-9]+]]}
; CHECK-NEXT: [[IS_DECL_1]] = !{!"isDeclaration: 1"}
; CHECK-NEXT: [[A_FIR]] = distinct !{!"intel.function.inlining.report", [[A_NAME]], [[A_CSs:![0-9]+]], [[MODULE_NAME]], [[IS_DEAD_0]], [[IS_DECL_0]], [[LINK_A]], [[SUPPRESS_PRINT:![0-9]+]]}
...
; CHECK-NEXT: [[X_FIR]] = distinct !{!"intel.function.inlining.report", [[X_NAME]], null, [[MODULE_NAME]], [[IS_DEAD_0]], [[IS_DECL_1]], [[LINK_A]], [[SUPPRESS_PRINT:![0-9]+]]}
; CHECK-NEXT: [[Y_FIR]] = distinct !{!"intel.function.inlining.report", [[Y_NAME]], [[Y_CSs:![0-9]+]], [[MODULE_NAME]], [[IS_DEAD_1:![0-9]+]], [[IS_DECL_0]], [[LINK_L:![0-9]+]], [[SUPPRESS_PRINT:![0-9]+]]}
...
!8 = distinct !{!"intel.function.inlining.report", !9, !10, !20, !24, !25, !26, !58}
!9 = !{!"name: main"}
...
!25 = !{!"isDeclaration: 0"}
!26 = !{!"linkage: A"}
!27 = distinct !{!"intel.function.inlining.report", !22, null, !20, !24, !28, !26, !58}
!28 = !{!"isDeclaration: 1"}
!29 = distinct !{!"intel.function.inlining.report", !12, !30, !20, !24, !25, !26, !58}
...
!34 = !{!"name: y"}
!35 = distinct !{!"intel.function.inlining.report", !32, null, !20, !24, !28, !26, !58}
!36 = distinct !{!"intel.function.inlining.report", !34, !37, !20, !24, !25, !40, !58}

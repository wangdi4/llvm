...
; CHECK-NEXT: [[A_MAIN_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: a", [[A_MAIN_CSs:![0-9]+]], !"isInlined: 1", !"reason: 7", {{.*}}
; CHECK-NEXT: [[A_MAIN_CSs]] = distinct !{!"intel.callsites.inlining.report", [[X_A_MAIN_CS:![0-9]+]], [[Y_A_MAIN_CS:![0-9]+]]}
; CHECK-NEXT: [[X_A_MAIN_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: x", [[X_A_MAIN_CSs:![0-9]+]], !"isInlined: 0", !"reason: 29", {{.*}}
; CHECK-NEXT: [[X_A_MAIN_CSs]] = distinct !{!"intel.callsites.inlining.report"}
; CHECK-NEXT: [[Y_A_MAIN_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: y", [[Y_A_MAIN_CSs:![0-9]+]], !"isInlined: 1", !"reason: 6", {{.*}}
; CHECK-NEXT: [[Y_A_MAIN_CSs]] = distinct !{!"intel.callsites.inlining.report", [[Z_Y_A_MAIN_CS:![0-9]+]]}
; CHECK-NEXT: [[Z_Y_A_MAIN_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: z", [[Z_Y_A_MAIN_CSs:![0-9]+]], !"isInlined: 0", !"reason: 29", {{.*}}
; CHECK-NEXT: [[Z_Y_A_MAIN_CSs]] = distinct !{!"intel.callsites.inlining.report"}
; CHECK-NEXT: [[B_MAIN_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: b", [[B_MAIN_CSs:![0-9]+]], !"isInlined: 0", !"reason: 29", {{.*}}
...
; CHECK-NEXT: [[X_A_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: x", [[X_A_CSs:![0-9]+]], !"isInlined: 0", !"reason: 29", {{.*}}
; CHECK-NEXT: [[X_A_CSs]] = distinct !{!"intel.callsites.inlining.report"}
; CHECK-NEXT: [[Y_A_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: y", [[Y_A_CSs:![0-9]+]], !"isInlined: 1", !"reason: 6", {{.*}}
; CHECK-NEXT: [[Y_A_CSs]] = distinct !{!"intel.callsites.inlining.report", [[Z_Y_A_CS:![0-9]+]]}
; CHECK-NEXT: [[Z_Y_A_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: z", [[Z_Y_A_CSs:![0-9]+]], !"isInlined: 0", !"reason: 29", {{.*}}
...
; CHECK-NEXT: [[Z_Y_CS]] = distinct !{!"intel.callsite.inlining.report", !"name: z", [[Z_Y_CSs:![0-9]+]], !"isInlined: 0", !"reason: 29", {{.*}}

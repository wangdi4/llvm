...
define dso_local i32 @foo1(ptr nocapture %a, ptr nocapture readonly %b, i32 %tca, i32 %tcb) local_unnamed_addr {
entry:
  %and = and i32 %tca, 7
  %and1 = and i32 %tcb, 7
...
define dso_local i32 @foo2(ptr nocapture %a, ptr nocapture readonly %b, i32 %tca, i32 %tcb) local_unnamed_addr {
entry:
  %and = and i32 %tca, 6
  %and1 = and i32 %tcb, 5
  %cmp29 = icmp eq i32 %and, 0
...
entry:
  %0 = load i32, ptr @tca, align 4
  %1 = load i32, ptr @tcb, align 4
  %call1 = call i32 @foo1(ptr getelementptr inbounds ([100 x i32], ptr @a, i64 0, i64 0), ptr getelementptr inbounds ([100 x i32], ptr @b, i64 0, i64 0), i32 %0, i32 %1)
  %call2 = call i32 @foo2(ptr getelementptr inbounds ([100 x i32], ptr @a, i64 0, i64 0), ptr getelementptr inbounds ([100 x i32], ptr @b, i64 0, i64 0), i32 %0, i32 %1)

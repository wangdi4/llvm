...
; RUN: opt -passes='inlinereportsetup' -inline-report=0x86 < %s -S | opt -passes='cgscc(inline)' -pre-lto-inline-cost -inline-report=0x86 -S | opt -passes='inlinereportemitter' -inline-report=0x86 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-MD

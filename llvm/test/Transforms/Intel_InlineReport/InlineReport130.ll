...
; RUN: opt -passes=inline -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -inline-threshold=0 -sycl-host -sycl-optimization-mode -S -inline-report=0xf867 < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-CL
; RUN: opt -passes=inline -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -inline-threshold=0 -sycl-host -S -inline-report=0xf867 < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-CL
; RUN: opt -passes=inline -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -inline-threshold=0 -sycl-optimization-mode -S -inline-report=0xf867 < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-CL
; RUN: opt -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inline-threshold=0 -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -inline-threshold=0 -S -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefix=CHECK-BG
; RUN: opt -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-host -sycl-optimization-mode -inline-threshold=0 -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-host -inline-threshold=0 -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD
; RUN: opt -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -lto-inline-cost -inlining-huge-lto-odr-bb-count=0 -sycl-optimization-mode -inline-threshold=0 -inline-report=0xf8e6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK-SM,CHECK-SM-MD

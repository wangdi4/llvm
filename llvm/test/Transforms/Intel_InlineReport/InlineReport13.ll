...
; RUN: opt -inlinereportsetup -inline-report=134 < %s -S | opt -inline -new-double-callsite-inlining-heuristics=true -inline-report=134 -inline-threshold=2000 -S | opt -inlinereportemitter -inline-report=134 -S 2>&1 | FileCheck %s
; RUN: opt -passes='inlinereportsetup' -inline-report=134 < %s -S | opt -passes='cgscc(inline)' -new-double-callsite-inlining-heuristics=true -inline-report=134 -inline-threshold=2000 -S | opt -passes='inlinereportemitter' -inline-report=134 -S 2>&1 | FileCheck %s

...
; RUN: opt -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -inline-threshold=225 -inlinehint-threshold=325 -inline-report=0xf8c6 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,CHECK-MD

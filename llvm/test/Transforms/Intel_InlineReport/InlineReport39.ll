...
define dso_local i32 @foo(i32 %arg1, i32 %arg2, ptr %arg3, ptr %arg4, ptr %arg5, ptr %arg6, i32 %arg8) #0 {
entry:
...
entry:
  ...
  %call6 = call i32 @foo(i32 2, i32 4, ptr nonnull %forfake, ptr nonnull %forreal, ptr nonnull %forreal, ptr %forfake, i32 5)

...
define dso_local i32 @foo(i32 %arg1, i32 %arg2, i32* %arg3, i32* %arg4, i32* %arg5, i32* %arg6, i32 %arg8) #0 {
entry:
...
entry:
  ...
  %call = call i32 @foo(i32 2, i32 3, i32* nonnull %forreal, i32* nonnull %dummy, i32* nonnull %dummy, i32* nonnull %dummy, i32 4)
  %call1 = call i32 @foo(i32 2, i32 4, i32* nonnull %forfake, i32* nonnull %dummy, i32* nonnull %dummy, i32* nonnull %dummy, i32 5)
  %add = add nsw i32 %call, %call1
  %call2 = call i32 @foo(i32 2, i32 4, i32* nonnull %forreal, i32* nonnull %temp, i32* nonnull %temp, i32* nonnull %temp, i32 5)
  %add3 = add nsw i32 %add, %call2
  %call4 = call i32 @foo(i32 2, i32 4, i32* nonnull %forfake, i32* nonnull %dummy, i32* nonnull %dummy, i32* nonnull %dummy, i32 5)
  %add5 = add nsw i32 %add3, %call4
  %call6 = call i32 @foo(i32 2, i32 4, i32* nonnull %forfake, i32* nonnull %forreal, i32* nonnull %forreal, i32* nonnull %forfake, i32 5)

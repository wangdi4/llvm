; Inline report
; RUN: opt -inlinelists -inline -inline-report=0xe807 -inline-inline-list="main,f1;main,f2,22;f3" -inline-noinline-list="main,f2,21;main,f4,25" < %s -S 2>&1 | FileCheck %s
...
; RUN: opt -inlinereportsetup -inline-report=0xe886 < %s -S | opt -inlinelists -inline -inline-report=0xe886 -inline-inline-list="main,f1;main,f2,22;f3" -inline-noinline-list="main,f2,21;main,f4,25" -S | opt -inlinereportemitter -inline-report=0xe886 -S 2>&1 | FileCheck %s

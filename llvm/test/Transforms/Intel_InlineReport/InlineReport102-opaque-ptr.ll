...
bb13:                                             ; preds = %bb10
  call void @rpassm_(ptr getelementptr inbounds ([100 x float], ptr @"main_$ACOX", i64 0, i64 0), ptr getelementptr inbounds ([100 x float], ptr @"main_$BCOX", i64 0, i64 0), ptr getelementptr inbounds ([100 x i32], ptr @"main_$INDARR", i64 0, i64 0), ptr nonnull @1)
  call void @rpassm_(ptr getelementptr inbounds ([100 x float], ptr @"main_$BCOX", i64 0, i64 0), ptr nonnull %"main_$CCOX", ptr getelementptr inbounds ([100 x i32], ptr @"main_$INDARR", i64 0, i64 0), ptr nonnull @2)
  ret void
}

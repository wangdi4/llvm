...
; args" heuristic, because it does not have a long enough formal arg series.
...
define dso_local i32 @foo(i32 %arg1, i32 %arg2, ptr %arg3, ptr %arg4, ptr %arg5, ptr %arg6, i32 %arg8) {
entry:
...
entry:
  ...
  %call = call i32 @foo(i32 2, i32 3, ptr nonnull %forreal, ptr nonnull %dummy, ptr nonnull %dummy, ptr nonnull %dummy, i32 4)
  %call1 = call i32 @foo(i32 2, i32 4, ptr nonnull %forfake, ptr nonnull %dummy, ptr nonnull %dummy, ptr nonnull %dummy, i32 5)
  %add = add nsw i32 %call, %call1
  %call2 = call i32 @foo(i32 2, i32 4, ptr nonnull %forreal, ptr nonnull %temp, ptr nonnull %temp, ptr nonnull %temp, i32 5)
  %add3 = add nsw i32 %add, %call2
  %call4 = call i32 @foo(i32 2, i32 4, ptr nonnull %forfake, ptr nonnull %dummy, ptr nonnull %dummy, ptr nonnull %dummy, i32 5)
  %add5 = add nsw i32 %add3, %call4
  %call6 = call i32 @foo(i32 2, i32 4, ptr nonnull %forfake, ptr nonnull %forreal, ptr nonnull %forreal, ptr nonnull %forfake, i32 5)

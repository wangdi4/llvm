...
; RUN: opt -passes='inlinereportsetup' -inline-report=0x2898 < %s -S | opt -passes='cgscc(inline)' -inline-report=0x2898 -S | opt -passes='inlinereportemitter' -inline-report=0x2898 -S 2>&1 | FileCheck --strict-whitespace %s

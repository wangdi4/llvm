...
%struct.TCDef.7 = type { [16 x i8], [16 x i8], [16 x i8], [16 x i8], [64 x i8], i16, ptr, %struct.version_number, %struct.version_number, %struct.version_number, i64, ptr, ptr, ptr, ptr }
...
@argva = internal global [128 x ptr] zeroinitializer, align 16
@argv0_pgm = internal unnamed_addr global ptr null, align 8
...
declare noundef i32 @fgetc(ptr nocapture noundef)

declare i32 @i_printf(ptr nocapture noundef readonly, ptr noundef)

declare i32 @i_sprintf(ptr nocapture noundef, ptr nocapture noundef readonly, ptr noundef)

declare i32 @i_sends(ptr noundef readonly)

declare i32 @i_putchar(i8 noundef signext)

declare i32 @i_write_con(ptr nocapture noundef, i64 noundef)

declare i64 @i_read_con(ptr nocapture noundef writeonly, i64 noundef returned)
...
declare ptr @i_malloc(i64 noundef, ptr nocapture readnone, i32)

declare void @i_free(ptr nocapture noundef, ptr nocapture readnone, i32)
...
declare void @i_exit(i32 noundef, ptr noundef, ptr noundef)

declare ptr @i_get_file_def(ptr nocapture readnone)

declare ptr @i_get_file_num(i32)

declare i32 @i_send_buf_as_file(ptr noundef readonly, i64 noundef, ptr noundef)

declare i32 @i_report_results(ptr nocapture noundef readonly, i16 noundef zeroext)

declare i32 @i_harness_poll()

declare void @t_exit(i32 noundef, ptr noundef, ...)
...
declare noundef i32 @fputc(i32 noundef, ptr nocapture noundef) #0

define i32 @wait_for_start_signal() unnamed_addr {
bb:
  %i = alloca [16 x i8], align 16
  %i1 = load i1, ptr @autogo, align 4
  br i1 %i1, label %bb4, label %bb2

bb2:                                              ; preds = %bb
  %i3 = getelementptr inbounds [16 x i8], ptr %i, i64 0, i64 0
  br label %bb7

bb4:                                              ; preds = %bb
  %i5 = load i1, ptr @wait_for_start_signal.state, align 4
  br i1 %i5, label %bb738, label %bb6

bb6:                                              ; preds = %bb4
  store i1 true, ptr @wait_for_start_signal.state, align 4
  br label %bb738
...
bb8:                                              ; preds = %bb30, %bb7
  ...
  %i10 = load ptr, ptr @stdin, align 8, !tbaa !6
  %i11 = tail call i32 @fgetc(ptr noundef %i10)
  %i12 = icmp eq i32 %i11, -1
  br i1 %i12, label %bb13, label %bb14

bb13:                                             ; preds = %bb8
  tail call void (i32, ptr, ...) @t_exit(i32 noundef 1, ptr noundef @.str.7) #2
  unreachable
...
bb21:                                             ; preds = %bb17
  ...
  %i24 = getelementptr inbounds [1041 x i8], ptr @inbuf, i64 0, i64 %i23, !intel-tbaa !10
  store i8 %i15, ptr %i24, align 1, !tbaa !10
  %i25 = sext i32 %i22 to i64
  %i26 = getelementptr inbounds [1041 x i8], ptr @inbuf, i64 0, i64 %i25, !intel-tbaa !10
  store i8 0, ptr %i26, align 1, !tbaa !10
  %i27 = load ptr, ptr @stdout, align 8, !tbaa !6
  %i28 = zext i8 %i15 to i32
  %i29 = tail call i32 @fputc(i32 %i28, ptr %i27)
  br label %bb30
...
bb32:                                             ; preds = %bb30, %bb30
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %i3) #2
  %i33 = tail call ptr @__ctype_b_loc() #3
  %i34 = load ptr, ptr %i33, align 8, !tbaa !12
  br label %bb35

bb35:                                             ; preds = %bb35, %bb32
  %i36 = phi ptr [ @inbuf, %bb32 ], [ %i43, %bb35 ]
  %i37 = load i8, ptr %i36, align 1, !tbaa !14
  %i38 = sext i8 %i37 to i64
  %i39 = getelementptr inbounds i16, ptr %i34, i64 %i38
  %i40 = load i16, ptr %i39, align 2, !tbaa !15
  %i41 = and i16 %i40, 8192
  %i42 = icmp eq i16 %i41, 0
  %i43 = getelementptr inbounds i8, ptr %i36, i64 1
  br i1 %i42, label %bb44, label %bb35

bb44:                                             ; preds = %bb35
  %i45 = phi ptr [ %i36, %bb35 ]
  %i46 = phi i8 [ %i37, %bb35 ]
...
bb52:                                             ; preds = %bb44
  store i8 0, ptr %i3, align 16, !tbaa !14
  br label %bb74

bb53:                                             ; preds = %bb62, %bb51
  %i54 = phi i8 [ %i65, %bb62 ], [ %i46, %bb51 ]
  %i55 = phi i32 [ %i58, %bb62 ], [ 0, %bb51 ]
  %i56 = phi ptr [ %i64, %bb62 ], [ %i45, %bb51 ]
  %i57 = phi ptr [ %i63, %bb62 ], [ %i3, %bb51 ]
  %i58 = add nuw nsw i32 %i55, 1
  %i59 = icmp ult i32 %i55, 15
  br i1 %i59, label %bb60, label %bb62

bb60:                                             ; preds = %bb53
  %i61 = getelementptr inbounds i8, ptr %i57, i64 1
  store i8 %i54, ptr %i57, align 1, !tbaa !14
  br label %bb62

bb62:                                             ; preds = %bb60, %bb53
  %i63 = phi ptr [ %i61, %bb60 ], [ %i57, %bb53 ]
  %i64 = getelementptr inbounds i8, ptr %i56, i64 1
  %i65 = load i8, ptr %i64, align 1, !tbaa !14
  %i66 = add i8 %i65, -127
  %i67 = icmp ult i8 %i66, -94
  br i1 %i67, label %bb68, label %bb53

bb68:                                             ; preds = %bb62
  %i69 = phi ptr [ %i63, %bb62 ]
  %i70 = phi ptr [ %i64, %bb62 ]
  br label %bb71

bb71:                                             ; preds = %bb68, %bb48
  %i72 = phi ptr [ %i3, %bb48 ], [ %i69, %bb68 ]
  %i73 = phi ptr [ %i45, %bb48 ], [ %i70, %bb68 ]
  store i8 0, ptr %i72, align 1, !tbaa !14
  br label %bb74

bb74:                                             ; preds = %bb71, %bb52
  %i75 = phi ptr [ null, %bb52 ], [ %i73, %bb71 ]
  %i76 = load i8, ptr %i3, align 16, !tbaa !14
...
bb84:                                             ; preds = %bb89, %bb83
  ...
  %i86 = phi ptr [ %i91, %bb89 ], [ @.str.33, %bb83 ]
  %i87 = phi ptr [ %i90, %bb89 ], [ %i3, %bb83 ]
  %i88 = icmp eq i8 %i85, 0
  br i1 %i88, label %bb105, label %bb89

bb89:                                             ; preds = %bb84
  %i90 = getelementptr inbounds i8, ptr %i87, i64 1
  %i91 = getelementptr inbounds i8, ptr %i86, i64 1
  %i92 = load i8, ptr %i90, align 1, !tbaa !14
  %i93 = sext i8 %i92 to i32
  %i94 = add i8 %i92, -97
  %i95 = icmp ult i8 %i94, 26
  %i96 = add nsw i32 %i93, -32
  %i97 = select i1 %i95, i32 %i96, i32 %i93
  %i98 = load i8, ptr %i91, align 1, !tbaa !14
...
bb105:                                            ; preds = %bb84
  %i106 = load i8, ptr %i75, align 1, !tbaa !14
...
bb109:                                            ; preds = %bb114, %bb108
  ...
  %i111 = phi ptr [ %i115, %bb114 ], [ %i75, %bb108 ]
  %i112 = add i8 %i110, -48
  %i113 = icmp ult i8 %i112, 10
  br i1 %i113, label %bb118, label %bb114

bb114:                                            ; preds = %bb109
  %i115 = getelementptr inbounds i8, ptr %i111, i64 1
  %i116 = load i8, ptr %i115, align 1, !tbaa !14
  %i117 = icmp eq i8 %i116, 0
  br i1 %i117, label %bb156, label %bb109

bb118:                                            ; preds = %bb109
  %i119 = phi i8 [ %i110, %bb109 ]
  %i120 = phi ptr [ %i111, %bb109 ]
  %i121 = load ptr, ptr %i33, align 8, !tbaa !12
  %i122 = zext i8 %i119 to i64
  %i123 = getelementptr inbounds i16, ptr %i121, i64 %i122
  %i124 = load i16, ptr %i123, align 2, !tbaa !15
...
bb128:                                            ; preds = %bb128, %bb127
  ...
  %i132 = phi ptr [ %i136, %bb128 ], [ %i120, %bb127 ]
  %i133 = mul i64 %i130, 10
  %i134 = add nsw i64 %i129, -48
  %i135 = add i64 %i134, %i133
  %i136 = getelementptr inbounds i8, ptr %i132, i64 1
  %i137 = add nuw nsw i32 %i131, 1
  %i138 = load i8, ptr %i136, align 1, !tbaa !14
  %i139 = sext i8 %i138 to i64
  %i140 = getelementptr inbounds i16, ptr %i121, i64 %i139
  %i141 = load i16, ptr %i140, align 2, !tbaa !15
...
bb149:                                            ; preds = %bb146, %bb118
  %i150 = load ptr, ptr @the_tcdef_ptr, align 8, !tbaa !17
  %i151 = getelementptr inbounds %struct.TCDef.7, ptr %i150, i64 0, i32 10, !intel-tbaa !19
  %i152 = load i64, ptr %i151, align 8, !tbaa !19
  br label %bb153

bb153:                                            ; preds = %bb149, %bb146
  %i154 = phi ptr [ %i120, %bb149 ], [ %i120, %bb146 ]
  %i155 = phi i64 [ %i152, %bb149 ], [ %i147, %bb146 ]
  store i64 %i155, ptr @iterations, align 8, !tbaa !29
  br label %bb158
...
bb158:                                            ; preds = %bb157, %bb156, %bb153, %bb105, %bb74
  %i159 = phi ptr [ %i154, %bb153 ], [ null, %bb105 ], [ %i75, %bb74 ], [ null, %bb156 ], [ %i75, %bb157 ]
  %i160 = load i8, ptr %i3, align 16, !tbaa !14
...
bb190:                                            ; preds = %bb189, %bb158
  %i191 = load i8, ptr %i3, align 16, !tbaa !14
...
bb199:                                            ; preds = %bb204, %bb198
  ...
  %i201 = phi ptr [ %i206, %bb204 ], [ @.str.36, %bb198 ]
  %i202 = phi ptr [ %i205, %bb204 ], [ %i3, %bb198 ]
  %i203 = icmp eq i8 %i200, 0
  br i1 %i203, label %bb220, label %bb204

bb204:                                            ; preds = %bb199
  %i205 = getelementptr inbounds i8, ptr %i202, i64 1
  %i206 = getelementptr inbounds i8, ptr %i201, i64 1
  %i207 = load i8, ptr %i205, align 1, !tbaa !14
  %i208 = sext i8 %i207 to i32
  %i209 = add i8 %i207, -97
  %i210 = icmp ult i8 %i209, 26
  %i211 = add nsw i32 %i208, -32
  %i212 = select i1 %i210, i32 %i211, i32 %i208
  %i213 = load i8, ptr %i206, align 1, !tbaa !14
...
bb222:                                            ; preds = %bb221, %bb220, %bb190
  %i223 = load i8, ptr %i3, align 16, !tbaa !14
...
bb231:                                            ; preds = %bb236, %bb230
  ...
  %i233 = phi ptr [ %i238, %bb236 ], [ @.str.37.63, %bb230 ]
  %i234 = phi ptr [ %i237, %bb236 ], [ %i3, %bb230 ]
  %i235 = icmp eq i8 %i232, 0
  br i1 %i235, label %bb252, label %bb236

bb236:                                            ; preds = %bb231
  %i237 = getelementptr inbounds i8, ptr %i234, i64 1
  %i238 = getelementptr inbounds i8, ptr %i233, i64 1
  %i239 = load i8, ptr %i237, align 1, !tbaa !14
  %i240 = sext i8 %i239 to i32
  %i241 = add i8 %i239, -97
  %i242 = icmp ult i8 %i241, 26
  %i243 = add nsw i32 %i240, -32
  %i244 = select i1 %i242, i32 %i243, i32 %i240
  %i245 = load i8, ptr %i238, align 1, !tbaa !14
...
bb254:                                            ; preds = %bb253, %bb252, %bb222
  %i255 = load i8, ptr %i3, align 16, !tbaa !14
...
bb263:                                            ; preds = %bb268, %bb262
  ...
  %i265 = phi ptr [ %i270, %bb268 ], [ @.str.38, %bb262 ]
  %i266 = phi ptr [ %i269, %bb268 ], [ %i3, %bb262 ]
  %i267 = icmp eq i8 %i264, 0
  br i1 %i267, label %bb284, label %bb268

bb268:                                            ; preds = %bb263
  %i269 = getelementptr inbounds i8, ptr %i266, i64 1
  %i270 = getelementptr inbounds i8, ptr %i265, i64 1
  %i271 = load i8, ptr %i269, align 1, !tbaa !14
  %i272 = sext i8 %i271 to i32
  %i273 = add i8 %i271, -97
  %i274 = icmp ult i8 %i273, 26
  %i275 = add nsw i32 %i272, -32
  %i276 = select i1 %i274, i32 %i275, i32 %i272
  %i277 = load i8, ptr %i270, align 1, !tbaa !14
...
bb286:                                            ; preds = %bb285, %bb284, %bb254
  %i287 = load i8, ptr %i3, align 16, !tbaa !14
...
bb295:                                            ; preds = %bb300, %bb294
  ...
  %i297 = phi ptr [ %i302, %bb300 ], [ @.str.40, %bb294 ]
  %i298 = phi ptr [ %i301, %bb300 ], [ %i3, %bb294 ]
  %i299 = icmp eq i8 %i296, 0
  br i1 %i299, label %bb316, label %bb300

bb300:                                            ; preds = %bb295
  %i301 = getelementptr inbounds i8, ptr %i298, i64 1
  %i302 = getelementptr inbounds i8, ptr %i297, i64 1
  %i303 = load i8, ptr %i301, align 1, !tbaa !14
  %i304 = sext i8 %i303 to i32
  %i305 = add i8 %i303, -97
  %i306 = icmp ult i8 %i305, 26
  %i307 = add nsw i32 %i304, -32
  %i308 = select i1 %i306, i32 %i307, i32 %i304
  %i309 = load i8, ptr %i302, align 1, !tbaa !14
...
bb318:                                            ; preds = %bb317, %bb316, %bb286
  %i319 = load i8, ptr %i3, align 16, !tbaa !14
...
bb327:                                            ; preds = %bb332, %bb326
  ...
  %i329 = phi ptr [ %i334, %bb332 ], [ @.str.43, %bb326 ]
  %i330 = phi ptr [ %i333, %bb332 ], [ %i3, %bb326 ]
  %i331 = icmp eq i8 %i328, 0
  br i1 %i331, label %bb348, label %bb332

bb332:                                            ; preds = %bb327
  %i333 = getelementptr inbounds i8, ptr %i330, i64 1
  %i334 = getelementptr inbounds i8, ptr %i329, i64 1
  %i335 = load i8, ptr %i333, align 1, !tbaa !14
  %i336 = sext i8 %i335 to i32
  %i337 = add i8 %i335, -97
  %i338 = icmp ult i8 %i337, 26
  %i339 = add nsw i32 %i336, -32
  %i340 = select i1 %i338, i32 %i339, i32 %i336
  %i341 = load i8, ptr %i334, align 1, !tbaa !14
...
bb348:                                            ; preds = %bb327
  %i349 = load ptr, ptr @mem_base, align 8, !tbaa !30
  %i350 = load i1, ptr @mem_size, align 8
  %i351 = select i1 %i350, i64 4194304, i64 0
  %i352 = load i1, ptr @mem_size, align 8
...
bb355:                                            ; preds = %bb354, %bb348, %bb318
  %i356 = load i8, ptr %i3, align 16, !tbaa !14
...
bb364:                                            ; preds = %bb369, %bb363
  ...
  %i366 = phi ptr [ %i371, %bb369 ], [ @.str.44, %bb363 ]
  %i367 = phi ptr [ %i370, %bb369 ], [ %i3, %bb363 ]
  %i368 = icmp eq i8 %i365, 0
  br i1 %i368, label %bb735, label %bb369

bb369:                                            ; preds = %bb364
  %i370 = getelementptr inbounds i8, ptr %i367, i64 1
  %i371 = getelementptr inbounds i8, ptr %i366, i64 1
  %i372 = load i8, ptr %i370, align 1, !tbaa !14
  %i373 = sext i8 %i372 to i32
  %i374 = add i8 %i372, -97
  %i375 = icmp ult i8 %i374, 26
  %i376 = add nsw i32 %i373, -32
  %i377 = select i1 %i375, i32 %i376, i32 %i373
  %i378 = load i8, ptr %i371, align 1, !tbaa !14
...
bb386:                                            ; preds = %bb385, %bb355
  %i387 = load i8, ptr %i3, align 16, !tbaa !14
...
bb395:                                            ; preds = %bb400, %bb394
  ...
  %i397 = phi ptr [ %i402, %bb400 ], [ @.str.45, %bb394 ]
  %i398 = phi ptr [ %i401, %bb400 ], [ %i3, %bb394 ]
  %i399 = icmp eq i8 %i396, 0
  br i1 %i399, label %bb416, label %bb400

bb400:                                            ; preds = %bb395
  %i401 = getelementptr inbounds i8, ptr %i398, i64 1
  %i402 = getelementptr inbounds i8, ptr %i397, i64 1
  %i403 = load i8, ptr %i401, align 1, !tbaa !14
  %i404 = sext i8 %i403 to i32
  %i405 = add i8 %i403, -97
  %i406 = icmp ult i8 %i405, 26
  %i407 = add nsw i32 %i404, -32
  %i408 = select i1 %i406, i32 %i407, i32 %i404
  %i409 = load i8, ptr %i402, align 1, !tbaa !14
...
bb416:                                            ; preds = %bb395
  %i417 = icmp eq ptr %i159, null
  br i1 %i417, label %bb437, label %bb418

bb418:                                            ; preds = %bb416
  %i419 = load i8, ptr %i159, align 1, !tbaa !14
  %i420 = icmp eq i8 %i419, 0
  br i1 %i420, label %bb437, label %bb421

bb421:                                            ; preds = %bb418
  %i422 = tail call ptr @__ctype_b_loc() #3
  %i423 = load ptr, ptr %i422, align 8, !tbaa !12
  br label %bb428

bb424:                                            ; preds = %bb428
  %i425 = getelementptr inbounds i8, ptr %i429, i64 1
  %i426 = load i8, ptr %i425, align 1, !tbaa !14
  %i427 = icmp eq i8 %i426, 0
  br i1 %i427, label %bb436, label %bb428

bb428:                                            ; preds = %bb424, %bb421
  %i429 = phi ptr [ %i159, %bb421 ], [ %i425, %bb424 ]
  %i430 = phi i8 [ %i419, %bb421 ], [ %i426, %bb424 ]
  %i431 = sext i8 %i430 to i64
  %i432 = getelementptr inbounds i16, ptr %i423, i64 %i431
  %i433 = load i16, ptr %i432, align 2, !tbaa !15
...
bb437:                                            ; preds = %bb436, %bb418, %bb416
  %i438 = load i32, ptr @argca, align 4, !tbaa !32
  %i439 = load i32, ptr @argca, align 4, !tbaa !32
...
bb442:                                            ; preds = %bb442, %bb441
  ...
  %i444 = getelementptr inbounds [128 x ptr], ptr @argva, i64 0, i64 %i443, !intel-tbaa !34
  %i445 = load ptr, ptr %i444, align 8, !tbaa !34
  %i446 = trunc i64 %i443 to i32
  %i447 = add nuw nsw i64 %i443, 1
  %i448 = load i32, ptr @argca, align 4, !tbaa !32
  %i449 = sext i32 %i448 to i64
  %i450 = icmp slt i64 %i447, %i449
  br i1 %i450, label %bb442, label %bb732

bb451:                                            ; preds = %bb428
  store i32 1, ptr @argca, align 4, !tbaa !32
  %i452 = load ptr, ptr @argv0_pgm, align 8, !tbaa !30
  %i453 = icmp eq ptr %i452, null
  %i454 = select i1 %i453, ptr @.str.30, ptr %i452
  store ptr %i454, ptr @argva, align 16, !tbaa !34
  store ptr null, ptr getelementptr inbounds ([128 x ptr], ptr @argva, i64 0, i64 1), align 8, !tbaa !34
  %i455 = icmp eq ptr %i159, null
  br i1 %i455, label %bb530, label %bb456

bb456:                                            ; preds = %bb451
  %i457 = load i8, ptr %i159, align 1, !tbaa !14
  %i458 = icmp eq i8 %i457, 0
  br i1 %i458, label %bb530, label %bb459

bb459:                                            ; preds = %bb456
  %i460 = load i8, ptr %i159, align 1, !tbaa !14
...
bb463:                                            ; preds = %bb470, %bb462
  ...
  %i465 = phi ptr [ %i474, %bb470 ], [ @clbuf, %bb462 ]
  %i466 = phi ptr [ %i475, %bb470 ], [ %i159, %bb462 ]
  %i467 = phi i32 [ %i468, %bb470 ], [ 1041, %bb462 ]
  store i8 %i464, ptr %i465, align 1, !tbaa !14
  %i468 = add nsw i32 %i467, -1
  %i469 = icmp eq i32 %i468, 0
  br i1 %i469, label %bb478, label %bb470

bb470:                                            ; preds = %bb463
  %i471 = load i8, ptr %i466, align 1, !tbaa !14
  %i472 = icmp ne i8 %i471, 0
  %i473 = zext i1 %i472 to i64
  %i474 = getelementptr i8, ptr %i465, i64 %i473
  %i475 = getelementptr i8, ptr %i466, i64 %i473
  %i476 = load i8, ptr %i475, align 1, !tbaa !14
  %i477 = icmp eq i8 %i476, 0
  br i1 %i477, label %bb478, label %bb463

bb478:                                            ; preds = %bb470, %bb463
  %i479 = phi ptr [ %i474, %bb470 ], [ %i465, %bb463 ]
  br label %bb480

bb480:                                            ; preds = %bb478, %bb459
  %i481 = phi ptr [ @clbuf, %bb459 ], [ %i479, %bb478 ]
  store i8 0, ptr %i481, align 1, !tbaa !14
  %i482 = load i32, ptr @argca, align 4, !tbaa !32
  %i483 = sext i32 %i482 to i64
  br label %bb484

bb484:                                            ; preds = %bb522, %bb480
  %i485 = phi i64 [ %i503, %bb522 ], [ %i483, %bb480 ]
  %i486 = phi ptr [ %i524, %bb522 ], [ @clbuf, %bb480 ]
  %i487 = load ptr, ptr %i33, align 8, !tbaa !12
  br label %bb488

bb488:                                            ; preds = %bb488, %bb484
  %i489 = phi ptr [ %i486, %bb484 ], [ %i496, %bb488 ]
  %i490 = load i8, ptr %i489, align 1, !tbaa !14
  %i491 = sext i8 %i490 to i64
  %i492 = getelementptr inbounds i16, ptr %i487, i64 %i491
  %i493 = load i16, ptr %i492, align 2, !tbaa !15
  %i494 = and i16 %i493, 8192
  %i495 = icmp eq i16 %i494, 0
  %i496 = getelementptr inbounds i8, ptr %i489, i64 1
  br i1 %i495, label %bb497, label %bb488

bb497:                                            ; preds = %bb488
  %i498 = phi ptr [ %i489, %bb488 ]
  %i499 = phi i8 [ %i490, %bb488 ]
  %i500 = icmp eq i8 %i499, 0
  br i1 %i500, label %bb525, label %bb501

bb501:                                            ; preds = %bb497
  %i502 = getelementptr inbounds [128 x ptr], ptr @argva, i64 0, i64 %i485, !intel-tbaa !34
  store ptr %i498, ptr %i502, align 8, !tbaa !34
  %i503 = add i64 %i485, 1
  %i504 = trunc i64 %i503 to i32
  store i32 %i504, ptr @argca, align 4, !tbaa !32
  %i505 = load i8, ptr %i498, align 1, !tbaa !14
...
bb508:                                            ; preds = %bb516, %bb507
  ...
  %i510 = phi ptr [ %i517, %bb516 ], [ %i498, %bb507 ]
  %i511 = sext i8 %i509 to i64
  %i512 = getelementptr inbounds i16, ptr %i487, i64 %i511
  %i513 = load i16, ptr %i512, align 2, !tbaa !15
  %i514 = and i16 %i513, 8192
  %i515 = icmp eq i16 %i514, 0
  br i1 %i515, label %bb516, label %bb520

bb516:                                            ; preds = %bb508
  %i517 = getelementptr inbounds i8, ptr %i510, i64 1
  %i518 = load i8, ptr %i517, align 1, !tbaa !14
  %i519 = icmp eq i8 %i518, 0
  br i1 %i519, label %bb520, label %bb508

bb520:                                            ; preds = %bb516, %bb508
  %i521 = phi ptr [ %i517, %bb516 ], [ %i510, %bb508 ]
  br label %bb522

bb522:                                            ; preds = %bb520, %bb501
  %i523 = phi ptr [ %i498, %bb501 ], [ %i521, %bb520 ]
  %i524 = getelementptr inbounds i8, ptr %i523, i64 1
  store i8 0, ptr %i523, align 1, !tbaa !14
  br label %bb484
...
bb525:                                            ; preds = %bb497
  ...
  %i529 = getelementptr inbounds [128 x ptr], ptr @argva, i64 0, i64 %i528, !intel-tbaa !34
  store ptr null, ptr %i529, align 8, !tbaa !34
  br label %bb530
...
bb532:                                            ; preds = %bb531, %bb386
  %i533 = load i8, ptr %i3, align 16, !tbaa !14
...
bb541:                                            ; preds = %bb546, %bb540
  ...
  %i543 = phi ptr [ %i548, %bb546 ], [ @.str.49, %bb540 ]
  %i544 = phi ptr [ %i547, %bb546 ], [ %i3, %bb540 ]
  %i545 = icmp eq i8 %i542, 0
  br i1 %i545, label %bb562, label %bb546

bb546:                                            ; preds = %bb541
  %i547 = getelementptr inbounds i8, ptr %i544, i64 1
  %i548 = getelementptr inbounds i8, ptr %i543, i64 1
  %i549 = load i8, ptr %i547, align 1, !tbaa !14
  %i550 = sext i8 %i549 to i32
  %i551 = add i8 %i549, -97
  %i552 = icmp ult i8 %i551, 26
  %i553 = add nsw i32 %i550, -32
  %i554 = select i1 %i552, i32 %i553, i32 %i550
  %i555 = load i8, ptr %i548, align 1, !tbaa !14
...
bb562:                                            ; preds = %bb541
  %i563 = load i32, ptr @argca, align 4, !tbaa !32
  store i32 1, ptr @argca, align 4, !tbaa !32
  %i564 = load ptr, ptr @argv0_pgm, align 8, !tbaa !30
  %i565 = icmp eq ptr %i564, null
  %i566 = select i1 %i565, ptr @.str.30, ptr %i564
  store ptr %i566, ptr @argva, align 16, !tbaa !34
  store ptr null, ptr getelementptr inbounds ([128 x ptr], ptr @argva, i64 0, i64 1), align 8, !tbaa !34
  br label %bb734
...
bb568:                                            ; preds = %bb567, %bb532
  %i569 = load i8, ptr %i3, align 16, !tbaa !14
...
bb577:                                            ; preds = %bb582, %bb576
  ...
  %i579 = phi ptr [ %i584, %bb582 ], [ @.str.52, %bb576 ]
  %i580 = phi ptr [ %i583, %bb582 ], [ %i3, %bb576 ]
  %i581 = icmp eq i8 %i578, 0
  br i1 %i581, label %bb598, label %bb582

bb582:                                            ; preds = %bb577
  %i583 = getelementptr inbounds i8, ptr %i580, i64 1
  %i584 = getelementptr inbounds i8, ptr %i579, i64 1
  %i585 = load i8, ptr %i583, align 1, !tbaa !14
  %i586 = sext i8 %i585 to i32
  %i587 = add i8 %i585, -97
  %i588 = icmp ult i8 %i587, 26
  %i589 = add nsw i32 %i586, -32
  %i590 = select i1 %i588, i32 %i589, i32 %i586
  %i591 = load i8, ptr %i584, align 1, !tbaa !14
...
bb598:                                            ; preds = %bb577
  %i599 = load ptr, ptr @the_tcdef_ptr, align 8, !tbaa !17
  %i600 = getelementptr inbounds %struct.TCDef.7, ptr %i599, i64 0, i32 4, i64 0
  %i601 = load ptr, ptr @the_tcdef_ptr, align 8, !tbaa !17
  %i602 = getelementptr inbounds %struct.TCDef.7, ptr %i601, i64 0, i32 0, i64 0
  br label %bb734
...
bb604:                                            ; preds = %bb603, %bb568
  %i605 = load i8, ptr %i3, align 16, !tbaa !14
...
bb613:                                            ; preds = %bb618, %bb612
  ...
  %i615 = phi ptr [ %i620, %bb618 ], [ @.str.54, %bb612 ]
  %i616 = phi ptr [ %i619, %bb618 ], [ %i3, %bb612 ]
  %i617 = icmp eq i8 %i614, 0
  br i1 %i617, label %bb634, label %bb618

bb618:                                            ; preds = %bb613
  %i619 = getelementptr inbounds i8, ptr %i616, i64 1
  %i620 = getelementptr inbounds i8, ptr %i615, i64 1
  %i621 = load i8, ptr %i619, align 1, !tbaa !14
  %i622 = sext i8 %i621 to i32
  %i623 = add i8 %i621, -97
  %i624 = icmp ult i8 %i623, 26
  %i625 = add nsw i32 %i622, -32
  %i626 = select i1 %i624, i32 %i625, i32 %i622
  %i627 = load i8, ptr %i620, align 1, !tbaa !14
...
bb636:                                            ; preds = %bb635, %bb604
  %i637 = load i8, ptr %i3, align 16, !tbaa !14
...
bb645:                                            ; preds = %bb650, %bb644
  ...
  %i647 = phi ptr [ %i652, %bb650 ], [ @.str.57, %bb644 ]
  %i648 = phi ptr [ %i651, %bb650 ], [ %i3, %bb644 ]
  %i649 = icmp eq i8 %i646, 0
  br i1 %i649, label %bb730, label %bb650

bb650:                                            ; preds = %bb645
  %i651 = getelementptr inbounds i8, ptr %i648, i64 1
  %i652 = getelementptr inbounds i8, ptr %i647, i64 1
  %i653 = load i8, ptr %i651, align 1, !tbaa !14
  %i654 = sext i8 %i653 to i32
  %i655 = add i8 %i653, -97
  %i656 = icmp ult i8 %i655, 26
  %i657 = add nsw i32 %i654, -32
  %i658 = select i1 %i656, i32 %i657, i32 %i654
  %i659 = load i8, ptr %i652, align 1, !tbaa !14
...
bb667:                                            ; preds = %bb666, %bb636
  %i668 = load i8, ptr %i3, align 16, !tbaa !14
...
bb676:                                            ; preds = %bb681, %bb675
  ...
  %i678 = phi ptr [ %i683, %bb681 ], [ @.str.58, %bb675 ]
  %i679 = phi ptr [ %i682, %bb681 ], [ %i3, %bb675 ]
  %i680 = icmp eq i8 %i677, 0
  br i1 %i680, label %bb729, label %bb681

bb681:                                            ; preds = %bb676
  %i682 = getelementptr inbounds i8, ptr %i679, i64 1
  %i683 = getelementptr inbounds i8, ptr %i678, i64 1
  %i684 = load i8, ptr %i682, align 1, !tbaa !14
  %i685 = sext i8 %i684 to i32
  %i686 = add i8 %i684, -97
  %i687 = icmp ult i8 %i686, 26
  %i688 = add nsw i32 %i685, -32
  %i689 = select i1 %i687, i32 %i688, i32 %i685
  %i690 = load i8, ptr %i683, align 1, !tbaa !14
...
bb698:                                            ; preds = %bb697, %bb667
  %i699 = load i8, ptr %i3, align 16, !tbaa !14
...
bb707:                                            ; preds = %bb712, %bb706
  ...
  %i709 = phi ptr [ %i714, %bb712 ], [ @.str.59, %bb706 ]
  %i710 = phi ptr [ %i713, %bb712 ], [ %i3, %bb706 ]
  %i711 = icmp eq i8 %i708, 0
  br i1 %i711, label %bb728, label %bb712

bb712:                                            ; preds = %bb707
  %i713 = getelementptr inbounds i8, ptr %i710, i64 1
  %i714 = getelementptr inbounds i8, ptr %i709, i64 1
  %i715 = load i8, ptr %i713, align 1, !tbaa !14
  %i716 = sext i8 %i715 to i32
  %i717 = add i8 %i715, -97
  %i718 = icmp ult i8 %i717, 26
  %i719 = add nsw i32 %i716, -32
  %i720 = select i1 %i718, i32 %i719, i32 %i716
  %i721 = load i8, ptr %i714, align 1, !tbaa !14
...
bb734:                                            ; preds = %bb733, %bb732, %bb731, %bb698, %bb634, %bb598, %bb562, %bb530, %bb437
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %i3) #2
  br label %bb7

...
; Caller for test case 1:

define dso_local %class.cSimpleModule* @_ZN11cSimulation17selectNextModule1Ev(%class.cSimulation*) #0 align 2 {
...
; <label>:37:                                     ; preds = %31, %22
  %38 = tail call %class.cMessage* @_ZN12cMessageHeap12removeFirst1Ev(%class.cMessageHeap* nonnull %4)
  %39 = icmp eq %class.cMessage* %38, null
  br i1 %39, label %46, label %40

; <label>:40:                                     ; preds = %37
  %t38 = tail call %class.cMessage* @_ZN12cMessageHeap12removeFirst1Ev(%class.cMessageHeap* nonnull %4)
...
; Caller for test case 2:

define dso_local %class.cSimpleModule* @_ZN11cSimulation17selectNextModule2Ev(%class.cSimulation*) #0 align 2 {
  %2 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 11
  %3 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 3
  %4 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 17
  br label %5
...
; <label>:37:                                     ; preds = %31, %22
  %38 = tail call %class.cMessage* @_ZN12cMessageHeap12removeFirst2Ev(%class.cMessageHeap* nonnull %4)
  %39 = icmp eq %class.cMessage* %38, null
  br i1 %39, label %46, label %40

; <label>:40:                                     ; preds = %37
  %t38 = tail call %class.cMessage* @_ZN12cMessageHeap12removeFirst2Ev(%class.cMessageHeap* nonnull %4)
  %t39 = icmp eq %class.cMessage* %t38, null
  br i1 %39, label %46, label %41
...
; Caller for test case 3:

define dso_local void @_ZN11cSimulation17selectNextModule3Ev(%class.cSimulation*) #0 align 2 {
  %2 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 11
  %3 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 3
  %4 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 17
  br label %5
...
; <label>:37:                                     ; preds = %31, %22
  tail call void @_ZN12cMessageHeap12removeFirst3Ev(%class.cMessageHeap* nonnull %4)
  ret void
...
; Caller for test case 4:

define dso_local %class.cSimpleModule* @_ZN11cSimulation17selectNextModule4Ev(%class.cSimulation*) #0 align 2 {
  %2 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 11
  %3 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 3
  %4 = getelementptr inbounds %class.cSimulation, %class.cSimulation* %0, i64 0, i32 17
  br label %5
...
; <label>:37:                                     ; preds = %31, %22
  %38 = tail call %class.cMessage* @_ZN12cMessageHeap12removeFirst4Ev(%class.cMessageHeap* nonnull %4)
  %39 = icmp eq %class.cMessage* %38, null
  br i1 %39, label %46, label %40

; <label>:40:                                     ; preds = %37
  %t38 = tail call %class.cMessage* @_ZN12cMessageHeap12removeFirst4Ev(%class.cMessageHeap* nonnull %4)
  %t39 = icmp eq %class.cMessage* %t38, null
  br i1 %39, label %46, label %41
...
; This test case fails the "structure test" heuristic because it has too many
; basic blocks.

define internal %class.cMessage* @_ZN12cMessageHeap12removeFirst1Ev(%class.cMessageHeap*) #0 align 2 {
...
; This test case fails the "structure test" heuristic because its GEP
; comparison at the end of the entry block does not have the form:
; 'GEP .gt. 0'.

define internal %class.cMessage* @_ZN12cMessageHeap12removeFirst2Ev(%class.cMessageHeap*) #0 align 2 {
  %2 = getelementptr inbounds %class.cMessageHeap, %class.cMessageHeap* %0, i64 0, i32 2
  %3 = load i32, i32* %2, align 8
  %4 = icmp sgt i32 %3, 23
  br i1 %4, label %5, label %22
...
; This test case fails the "structure test" heuristic because it returns
; void.

define internal void @_ZN12cMessageHeap12removeFirst3Ev(%class.cMessageHeap*) #0 align 2 {
  %2 = getelementptr inbounds %class.cMessageHeap, %class.cMessageHeap* %0, i64 0, i32 2
  %3 = load i32, i32* %2, align 8
  %4 = icmp sgt i32 %3, 0
  br i1 %4, label %5, label %22
...
; This test case fails the "structure test" heuristic because it has more
; than one conditional branch.

define internal %class.cMessage* @_ZN12cMessageHeap12removeFirst4Ev(%class.cMessageHeap*) #0 align 2 {
  %2 = getelementptr inbounds %class.cMessageHeap, %class.cMessageHeap* %0, i64 0, i32 2
  %3 = load i32, i32* %2, align 8
  %4 = icmp sgt i32 %3, 0
  br i1 %4, label %5, label %22
...
; <label>:5:                                      ; preds = %1
  ...
  %21 = getelementptr inbounds %class.cMessage, %class.cMessage* %9, i64 0, i32 15
  store i32 -1, i32* %21, align 8
  br i1 %4, label %22, label %22

; <label>:22:                                     ; preds = %5, %1
  %23 = phi %class.cMessage* [ %9, %5 ], [ null, %1 ], [ %9, %5 ]
  br i1 0, label %24, label %24

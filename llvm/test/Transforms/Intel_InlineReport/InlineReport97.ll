...
; Inline report
; RUN: opt -wholeprogramanalysis -whole-program-assume-read -inline -lto-inline-cost -inline-report=7 -forced-inline-opt-level=3  -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 < %s -S 2>&1 | FileCheck %s --check-prefixes=CHECK-LEGACY,CHECK-BEFORE
; RUN: opt -passes='require<wholeprogram>,cgscc(inline)' -whole-program-assume-read -lto-inline-cost -inline-report=7 -forced-inline-opt-level=3  -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 < %s -S 2>&1 | FileCheck %s --check-prefixes=CHECK-NPM,CHECK-AFTER
; Inline report via metadata
; RUN: opt -inlinereportsetup -inline-report=0x86 < %s -S | opt -wholeprogramanalysis -whole-program-assume-read -inline -lto-inline-cost -inline-report=0x86 -forced-inline-opt-level=3  -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -S | opt -inlinereportemitter -inline-report=0x86 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-LEGACY,CHECK-AFTER
; RUN: opt -inlinereportsetup -inline-report=0x86 < %s -S | opt -passes='require<wholeprogram>,cgscc(inline)' -whole-program-assume-read -lto-inline-cost -inline-report=0x86 -forced-inline-opt-level=3  -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -S | opt -inlinereportemitter -inline-report=0x86 -S 2>&1 | FileCheck %s --check-prefixes=CHECK-NPM,CHECK-AFTER
...
define internal fastcc void @wolff_(double %0, double* noalias nocapture %1, i32* noalias nocapture %2, i32* noalias nocapture %3) unnamed_addr #0 {
  ...
  %26 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 64, i32* nonnull getelementptr inbounds ([16 x [16 x i32]], [16 x [16 x i32]]* @"_unnamed_main$$_$IZ", i64 0, i64 0, i64 0), i64 %25)
  %27 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %26, i64 %24)
  ...
  %40 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 1024, i32* nonnull getelementptr inbounds ([2 x [256 x i32]], [2 x [256 x i32]]* @"_unnamed_main$$_$ISTACK", i64 0, i64 0, i64 0), i64 1)
  %41 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 1024, i32* nonnull getelementptr inbounds ([2 x [256 x i32]], [2 x [256 x i32]]* @"_unnamed_main$$_$ISTACK", i64 0, i64 0, i64 0), i64 2)
  br label %42
...
42:                                               ; preds = %99, %4
  ...
  %50 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull getelementptr inbounds ([16 x i32], [16 x i32]* @"_unnamed_main$$_$IN1", i64 0, i64 0), i64 %49)
  %51 = load i32, i32* %50, align 1
  store i32 %51, i32* %33, align 1
  store i32 %47, i32* %34, align 1
  %52 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull getelementptr inbounds ([16 x i32], [16 x i32]* @"_unnamed_main$$_$IP1", i64 0, i64 0), i64 %49)
  %53 = load i32, i32* %52, align 1
  store i32 %53, i32* %35, align 1
  %54 = sext i32 %47 to i64
  %55 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull getelementptr inbounds ([16 x i32], [16 x i32]* @"_unnamed_main$$_$IN1", i64 0, i64 0), i64 %54)
  %56 = load i32, i32* %55, align 1
  store i32 %56, i32* %36, align 1
  store i32 %48, i32* %37, align 1
  %57 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull getelementptr inbounds ([16 x i32], [16 x i32]* @"_unnamed_main$$_$IP1", i64 0, i64 0), i64 %54)
...
59:                                               ; preds = %89, %42
  ...
  %72 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %71, i64 %69)
...
83:                                               ; preds = %75
  ...
  %87 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %40, i64 %86)
  store i32 %66, i32* %87, align 1
  %88 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %41, i64 %86)
...
99:                                               ; preds = %96
  ...
  %101 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %40, i64 %100)
  %102 = load i32, i32* %101, align 1
  %103 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %41, i64 %100)

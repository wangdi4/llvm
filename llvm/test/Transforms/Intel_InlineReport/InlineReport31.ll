...
; Inline report
; RUN: opt -opaque-pointers -passes='cgscc(inline)' -inline-report=0xe807 -dtrans-inline-heuristics -intel-libirc-allowed -pre-lto-inline-cost < %s -S 2>&1 | FileCheck --check-prefix=CHECK-NEW %s
; Inline report via metadata
; RUN: opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -inline-report=0xe886 -dtrans-inline-heuristics -intel-libirc-allowed -pre-lto-inline-cost -S < %s 2>&1 | FileCheck %s --check-prefix=CHECK-MD
...
define dso_local ptr @_ZN12cMessageHeap12removeFirst1Ev(ptr %this) local_unnamed_addr align 2 {
entry:
...
define dso_local ptr @_ZN12cMessageHeap12removeFirst2Ev(ptr %this) local_unnamed_addr align 2 {
entry:
  %n = getelementptr inbounds %class.cMessageHeap, ptr %this, i64 0, i32 2
  %i = load i32, ptr %n, align 8
  %cmp = icmp sgt i32 %i, 15
  br i1 %cmp, label %if.then, label %return
...
define dso_local void @_ZN12cMessageHeap12removeFirst3Ev(ptr %this) local_unnamed_addr align 2 {
entry:
  %n = getelementptr inbounds %class.cMessageHeap, ptr %this, i64 0, i32 2
  %i = load i32, ptr %n, align 8
  %cmp = icmp sgt i32 %i, 0
...
define dso_local ptr @_ZN12cMessageHeap12removeFirst4Ev(ptr %this) local_unnamed_addr align 2 {
entry:
  %n = getelementptr inbounds %class.cMessageHeap, ptr %this, i64 0, i32 2
  %i = load i32, ptr %n, align 8
  %cmp = icmp sgt i32 %i, 0
...
whpr.continue:                                    ; preds = %whpr.continue, %whpr.wrap, %if.then
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 13
  %i11 = load ptr, ptr %vfn, align 8
  call void %i11(ptr %i5, ptr %i2)
  %heapindex7 = getelementptr inbounds %class.cMessage, ptr %i2, i64 0, i32 15
  store i32 -1, ptr %heapindex7, align 8
  %t10 = call i1 @llvm.type.test(ptr %vtable, metadata !"_ZTS7cObject")
...
define dso_local ptr @_ZN12cMessageHeap12removeFirst5Ev(ptr %this) local_unnamed_addr align 2 {
entry:
  %n = getelementptr inbounds %class.cMessageHeap, ptr %this, i64 0, i32 2
  %i = load i32, ptr %n, align 8
  %cmp = icmp sgt i32 %i, 0

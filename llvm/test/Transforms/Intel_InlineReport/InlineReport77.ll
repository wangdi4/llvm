; RUN: opt < %s -partial-inliner -skip-partial-inlining-cost-analysis -inline-report=7 -force-print-inline-report-after-partial-inline -disable-output 2>&1 | FileCheck %s
; RUN: opt < %s -passes=partial-inliner -skip-partial-inlining-cost-analysis -inline-report=7 -force-print-inline-report-after-partial-inline -disable-output 2>&1 | FileCheck %s

; RUN: opt < %s -partial-inliner -skip-partial-inlining-cost-analysis -inline-report=0xe807 -force-print-inline-report-after-partial-inline -disable-output 2>&1 | FileCheck %s

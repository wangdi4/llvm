...
; even though BlockFrequencyInfo used in the new pass manager would indicate
; that it should not be inlined both times.

; CHECK-DAG: INLINE: _ZN11xercesc_2_717JanitorMemFunCallINS_13FieldValueMapEED2Ev {{.*}}Inlining is profitable
; CHECK-DAG: INLINE: _ZN11xercesc_2_717JanitorMemFunCallINS_13FieldValueMapEED2Ev {{.*}}Callee has single callsite and local linkage
; CHECK-NOT: call {{.*}} _ZN11xercesc_2_717JanitorMemFunCallINS_13FieldValueMapEED2Ev
...
if.then:                                          ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %cleanup) #15
  ...
  %i4 = load ptr, ptr %fValues4, align 8, !tbaa !15
...
invoke.cont6:                                     ; preds = %if.then
  ...
  invoke void @_ZN11xercesc_2_713ValueVectorOfIPNS_8IC_FieldEEC2ERKS3_(ptr noundef %call7, ptr noundef nonnull align 8 dereferenceable(32) %i7)
          to label %invoke.cont10 unwind label %lpad9

invoke.cont10:                                    ; preds = %invoke.cont6
  store ptr %call7, ptr %fFields, align 8, !tbaa !6
...
invoke.cont13:                                    ; preds = %invoke.cont10
  ...
  invoke void @_ZN11xercesc_2_713ValueVectorOfIPNS_17DatatypeValidatorEEC2ERKS3_(ptr noundef %call14, ptr noundef nonnull align 8 dereferenceable(32) %i10)
          to label %invoke.cont17 unwind label %lpad16

invoke.cont17:                                    ; preds = %invoke.cont13
  store ptr %call14, ptr %fValidators, align 8, !tbaa !14
...
invoke.cont20:                                    ; preds = %invoke.cont17
  ...
  invoke void @_ZN11xercesc_2_716RefArrayVectorOfItEC2EjbPNS_13MemoryManagerE(ptr noundef %call21, i32 noundef %call25, i1 noundef zeroext true, ptr noundef %i14)
          to label %invoke.cont27 unwind label %lpad23

invoke.cont27:                                    ; preds = %invoke.cont20
  store ptr %call21, ptr %fValues, align 8, !tbaa !15
  br label %for.cond
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %cleanup) #15
  br label %if.end
...
for.body:                                         ; preds = %for.cond
  %i20 = load ptr, ptr %fValues, align 8, !tbaa !15
  %i22 = load ptr, ptr %fValues4, align 8, !tbaa !15
...
whpr.wrap:                                        ; preds = %delete.notnull6
  %i8 = tail call i1 @llvm.type.test(ptr %vtable, metadata !"_ZTSN11xercesc_2_716RefArrayVectorOfItEE")
...
whpr.wrap:                                        ; preds = %entry
  %i7 = tail call i1 @llvm.type.test(ptr %vtable, metadata !"_ZTSN11xercesc_2_713MemoryManagerE")
...
whpr.continue:                                    ; preds = %whpr.wrap, %entry
  ...
  store ptr %call, ptr %fElemList, align 8, !tbaa !36
...
whpr.continue:                                    ; preds = %whpr.wrap, %entry
  ...
  %i8 = load ptr, ptr %vfn, align 8
  %call = tail call noundef ptr %i8(ptr noundef nonnull %i3, i64 noundef %mul)
  store ptr %call, ptr %fElemList, align 8, !tbaa !46
...
_ZN11xercesc_2_79XMLString9stringLenEPKt.exit:    ; preds = %while.end.i, %lor.lhs.false.i
  ...
  %vtable = load ptr, ptr %manager, align 8, !tbaa !19
...
whpr.wrap:                                        ; preds = %_ZN11xercesc_2_79XMLString9stringLenEPKt.exit
  %i5 = tail call i1 @llvm.type.test(ptr %vtable, metadata !"_ZTSN11xercesc_2_713MemoryManagerE")
...
whpr.continue:                                    ; preds = %whpr.wrap, %_ZN11xercesc_2_79XMLString9stringLenEPKt.exit
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 2 %call1, ptr nonnull align 2 %toRep, i64 %retval.0.i, i1 false)
  br label %if.end

if.end:                                           ; preds = %whpr.continue, %entry
  %ret.0 = phi ptr [ %call1, %whpr.continue ], [ null, %entry ]
  ret ptr %ret.0
}
...
if.then:                                          ; preds = %entry
  ...
  invoke void @_ZN11xercesc_2_730ArrayIndexOutOfBoundsExceptionC2EPKcjNS_10XMLExcepts5CodesEPNS_13MemoryManagerE(ptr noundef %exception, ptr noundef @.str, i32 noundef 249, i32 noundef 116, ptr noundef %i2)
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %i2 = getelementptr inbounds i8, ptr %i, i64 %.unpack5
  %i3 = and i64 %.unpack, 1
...
memptr.virtual:                                   ; preds = %if.then
  ...
  %memptr.virtualfn = load ptr, ptr %i6, align 8, !nosanitize !58
  br label %memptr.end
...
memptr.end:                                       ; preds = %memptr.nonvirtual, %memptr.virtual
  ...
  invoke void %i8(ptr noundef nonnull %i2)
...
entry:
  ...
  %i2 = load ptr, ptr %fElemList2, align 8, !tbaa !36
  %vtable = load ptr, ptr %i, align 8, !tbaa !19
  %i4 = tail call i1 @llvm.intel.wholeprogramsafe()
  br i1 %i4, label %whpr.wrap, label %whpr.continue

whpr.wrap:                                        ; preds = %entry
  %i6 = tail call i1 @llvm.type.test(ptr %vtable, metadata !"_ZTSN11xercesc_2_713MemoryManagerE")
...
entry:
  ...
  %i2 = load ptr, ptr %fElemList2, align 8, !tbaa !46
  %vtable = load ptr, ptr %i, align 8, !tbaa !19
  %i4 = tail call i1 @llvm.intel.wholeprogramsafe()
  br i1 %i4, label %whpr.wrap, label %whpr.continue
...
whpr.wrap:                                        ; preds = %entry
  %i4 = tail call i1 @llvm.type.test(ptr %vtable, metadata !"_ZTSN11xercesc_2_713MemoryManagerE")
...
whpr.continue:                                    ; preds = %whpr.wrap, %entry
  ...
  store ptr %call, ptr %fElemList, align 8, !tbaa !51
...
for.end23:                                        ; preds = %for.body18.preheader, %for.cond16.preheader
  ...
  %i21 = load ptr, ptr %fElemList25, align 8, !tbaa !51
  %vtable26 = load ptr, ptr %i19, align 8, !tbaa !19
  %i23 = tail call i1 @llvm.intel.wholeprogramsafe()
  br i1 %i23, label %whpr.wrap27, label %whpr.continue28

whpr.wrap27:                                      ; preds = %for.end23
  %i25 = tail call i1 @llvm.type.test(ptr %vtable26, metadata !"_ZTSN11xercesc_2_713MemoryManagerE")
...
whpr.continue28:                                  ; preds = %whpr.wrap27, %for.end23
  ...
  store ptr %call, ptr %fElemList25, align 8, !tbaa !51

...
L1161:                                             ; preds = %1461, %1104
  ...
  call fastcc void @sw_IP_ddx_(%uplevel_type* nonnull %t2, %"QNCA_a0$double*$rank2$.3"* nonnull %t177, %"QNCA_a0$double*$rank2$.3"* nonnull %t180)
  call fastcc void @sw_IP_ddy_(%uplevel_type* nonnull %t2, %"QNCA_a0$double*$rank2$.3"* nonnull %t179, %"QNCA_a0$double*$rank2$.3"* nonnull %t182)

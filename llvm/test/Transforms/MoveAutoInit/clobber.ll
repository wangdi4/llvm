...
; instructions.
<<<<<<< HEAD
; RUN: opt < %s -S -opaque-pointers -passes='move-auto-init' -verify-memoryssa | FileCheck %s ;INTEL
=======
; ifdef INTEL_SYCL_OPAQUEPOINTER_READY
; COM: opt < %s -S -passes='move-auto-init' -verify-memoryssa | FileCheck %s
; else
; RUN: opt < %s -S -opaque-pointers -passes='move-auto-init' -verify-memoryssa | FileCheck %s
; endif
>>>>>>> 1a729b9ec842d5c2b1554e214bd8ee003d1e0a7d

...
; CHECK-NOT: %1 = load ptr, ptr @stdout, align 8
...
entry:
  %0 = load i64, ptr bitcast (ptr @stdout to ptr), align 8
  store i64 %0, ptr bitcast (ptr @nabout to ptr), align 8
  tail call void @bar()
  %1 = load ptr, ptr @nabout, align 8
  %call1 = tail call i32 @fflush(ptr %1)
; stdout is modified.
  store i64 0, ptr bitcast (ptr @stdout to ptr), align 8
  ret i32 0
}

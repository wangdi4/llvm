...
entry:
  %call = call ptr @"??0MArrayImpl@@QEAA@XZ"(ptr @"?gArrayM@@3VMArrayImpl@1@A")
...
entry:
  call void bitcast (ptr @"??1M@@UEAA@XZ" to ptr)(ptr @"?gArrayM@@3VMArrayImpl@1@A")
  ret void
}

define linkonce_odr dso_local void @"??1M@@UEAA@XZ"(ptr %this) unnamed_addr align 2 {
entry:
  ret void
}

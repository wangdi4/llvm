...
@foo.p = internal unnamed_addr global ptr null, align 8
@foo_r.p = internal unnamed_addr global ptr null, align 8
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %incdec.ptr6 = phi ptr [ %a, %for.body.lr.ph ], [ %incdec.ptr, %for.body ]
  %i.05 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %for.body ]
  %2 = load i32, ptr %incdec.ptr6, align 4, !tbaa !5
  %add = add nsw i32 %2, %i.05
  store i32 %add, ptr %incdec.ptr6, align 4, !tbaa !5
  %incdec.ptr = getelementptr inbounds i32, ptr %incdec.ptr6, i64 1
...
for.cond.for.end_crit_edge:                       ; preds = %for.body
  ...
  %scevgep = getelementptr i32, ptr %a, i64 %3
  store ptr %scevgep, ptr @foo.p, align 8, !tbaa !1
  br label %for.end
...
; Function Attrs: nounwind uwtable
define void @bar(i32 %n, ptr %a) local_unnamed_addr #0 {
; CHECK-LABEL: @bar(
; CHECK-NOT: alloca
entry:
  store ptr %a, ptr @bar.p, align 8
  %call = call i32 @_setjmp(ptr getelementptr inbounds ([1 x %struct.__jmp_buf_tag], ptr @b0, i64 0, i64 0)) #3
  %cmp4 = icmp sgt i32 %n, 0
  br i1 %cmp4, label %for.body.lr.ph, label %for.end

for.body.lr.ph:                                   ; preds = %entry
  %bar.p.promoted = load ptr, ptr @bar.p, align 8
  %0 = add i32 %n, -1
  %1 = zext i32 %0 to i64
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %incdec.ptr6 = phi ptr [ %bar.p.promoted, %for.body.lr.ph ], [ %incdec.ptr, %for.body ]
  %i.05 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %for.body ]
  %3 = load i32, ptr %incdec.ptr6, align 4
  %add = add nsw i32 %3, %i.05
  store i32 %add, ptr %incdec.ptr6, align 4
  %incdec.ptr = getelementptr inbounds i32, ptr %incdec.ptr6, i64 1
  %inc = add nuw nsw i32 %i.05, 1
  %exitcond = icmp eq i32 %inc, %n
  br i1 %exitcond, label %for.cond.for.end_crit_edge, label %for.body
...
for.cond.for.end_crit_edge:                       ; preds = %for.body
  %scevgep = getelementptr i32, ptr %bar.p.promoted, i64 %2
  store ptr %scevgep, ptr @bar.p, align 8
  br label %for.end
...
; Function Attrs: nounwind uwtable
define void @foo_recurse(i32 %n, ptr %a) #0 {
; CHECK-LABEL: @foo_recurse(
; CHECK-NOT: alloca
entry:
  store ptr %a, ptr @foo_r.p, align 8, !tbaa !1
  %cmp.4 = icmp sgt i32 %n, 0
  br i1 %cmp.4, label %for.body.lr.ph, label %for.end
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %2 = load i32, ptr %incdec.ptr6, align 4, !tbaa !5
  %add = add nsw i32 %2, %i.05
  call void @foo(i32 %2, ptr %incdec.ptr6) #1
  store i32 %add, ptr %incdec.ptr6, align 4, !tbaa !5
  %incdec.ptr = getelementptr inbounds i32, ptr %incdec.ptr6, i64 1
  %inc = add nuw nsw i32 %i.05, 1
  %exitcond = icmp eq i32 %inc, %n
...
for.cond.for.end_crit_edge:                       ; preds = %for.body
  %3 = add nuw nsw i64 %1, 1
  %scevgep = getelementptr i32, ptr %a, i64 %3
  store ptr %scevgep, ptr @foo_r.p, align 8, !tbaa !1
  br label %for.end
...
declare i32 @_setjmp(ptr) local_unnamed_addr #2

...
; RUN: opt -passes='inlinereportsetup,cgscc(inline),inlinereportemitter' -inline-threshold=20 -inlining-for-deep-ifs=true -dtrans-inline-heuristics -intel-libirc-allowed -inlining-min-if-depth=4 -inline-report=0xe886 < %s -S 2>&1 | FileCheck %s

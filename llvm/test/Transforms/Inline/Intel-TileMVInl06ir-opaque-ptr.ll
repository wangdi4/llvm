...
; This is the same test as Intel-TileMVInl06-opaque-ptr.ll, but does not
...
bb6:                                              ; preds = %bb6, %bb4
  ...
  %i19 = trunc i64 %i11 to i32
  %i20 = icmp eq i32 %i5, %i19
  br i1 %i20, label %bb21, label %bb6

...
; RUN: opt -opaque-pointers < %s -whole-program-assume -intel-libirc-allowed -agginliner -inline -inline-threshold=-50 -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers < %s -whole-program-assume -intel-libirc-allowed -passes='module(agginliner),cgscc(inline)' -inline-threshold=-50 -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers < %s -whole-program-assume -intel-libirc-allowed -agginliner -inline -inline-threshold=-50 -mtriple=i686-- -mattr=+avx2 -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers < %s -whole-program-assume -intel-libirc-allowed -passes='module(agginliner),cgscc(inline)' -inline-threshold=-50 -mtriple=i686-- -mattr=+avx2 -S 2>&1 | FileCheck %s
...
bb3:                                              ; preds = %bb
  %i4 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str, double 0x40698EF800000000)
  tail call void @exit(i32 1)
  unreachable

bb5:                                              ; preds = %bb
  %i6 = getelementptr inbounds i8, ptr %i, i64 3200000
...
; Function Attrs: norecurse
define internal fastcc void @LBM_freeGrid(ptr nocapture %arg) unnamed_addr #0 {
bb:
...
; Function Attrs: norecurse
define internal fastcc void @LBM_initializeGrid(ptr nocapture %arg) unnamed_addr #0 {
bb:
  ret void
}
...
; Function Attrs: norecurse
define internal fastcc void @LBM_loadObstacleFile(ptr nocapture %arg, ptr nocapture readonly %arg1) unnamed_addr #0 {
bb:
  ret void
}

; Function Attrs: norecurse
define internal fastcc void @LBM_initializeSpecialCellsForLDC(ptr nocapture %arg) unnamed_addr #0 {
bb:
  ret void
}

; Function Attrs: norecurse
define internal fastcc void @LBM_initializeSpecialCellsForChannel(ptr nocapture %arg) unnamed_addr #0 {
bb:
  ret void
}

; Function Attrs: norecurse
define internal fastcc void @LBM_performStreamCollideTRT(ptr readonly %arg, ptr %arg1) unnamed_addr #0 {
bb:
  ret void
}

; Function Attrs: norecurse
define internal fastcc void @LBM_handleInOutFlow(ptr %arg) unnamed_addr #0 {
bb:
  ret void
}

; Function Attrs: norecurse
define internal fastcc void @LBM_showGridStatistics(ptr nocapture readonly %arg) unnamed_addr #0 {
bb:
  ret void
}

; Function Attrs: norecurse
define internal fastcc void @LBM_storeVelocityField(ptr nocapture readonly %arg, ptr nocapture readonly %arg1) unnamed_addr #0 {
bb:
  ret void
}

; Function Attrs: norecurse
define internal fastcc void @LBM_compareVelocityField(ptr nocapture readonly %arg, ptr nocapture readonly %arg1) unnamed_addr #0 {
bb:
  ret void
}
...
bb:
  ...
  %i23 = call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.5.2, i32 100, i32 100, i32 130, double 0x3FF4CCCCCCCCCCCC, i32 %i8, ptr %i10, ptr nonnull %i22, ptr nonnull %i20, ptr %i18)
...
bb37:                                             ; preds = %bb27
  %i38 = call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.9, i32 %i28)
...
bb52:                                             ; preds = %bb44
  %i53 = call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.9, i32 %i45)
...
; Function Attrs: norecurse
define internal fastcc void @MAIN_parseCommandLine(i32 %arg, ptr nocapture readonly %arg1, ptr nocapture %arg2) unnamed_addr #0 {
bb:
  ret void
}

; Function Attrs: norecurse
define internal fastcc void @MAIN_initialize(ptr nocapture readonly %arg) unnamed_addr #0 {
bb:

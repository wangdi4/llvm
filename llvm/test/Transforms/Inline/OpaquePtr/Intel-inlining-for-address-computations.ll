...
; RUN: opt -opaque-pointers -inline -inlining-for-address-computations -inlining-for-ac-min-arg-refs=4 -inlining-for-ac-loop-depth=2 -inline-threshold=40 -inline-report=0xe807 -disable-output < %s -S 2>&1 | FileCheck %s

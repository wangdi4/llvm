...
; RUN: opt -opaque-pointers -inline  -dtrans-inline-heuristics=false -pre-lto-inline-cost=false -inline-report=0xe807 < %s -S 2>&1 | FileCheck --check-prefix=CHECK-NEW %s

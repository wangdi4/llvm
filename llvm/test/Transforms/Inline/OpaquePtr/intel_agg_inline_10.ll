...
; This test is an extension of intel_agg_inline01.ll, where a use is progated
; through multiple calls to a function (@bar) and to multiple arguments of a
; function (@bar2).
...
define dso_local void @bar2(ptr nocapture %d1, ptr nocapture %d2) {
entry:
  store double 2.000000e+01, ptr %d1, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  tail call void @bar2(ptr nonnull %add.ptr1, ptr nonnull %add.ptr2)

...
; CHECK:         %cmp.i[[V6:[0-9]+]] = icmp eq i8* %i1, null
...
; CHECK:        codeRepl.i{{.*}}:
; CHECK-NEXT:    call void @_ZN7Derived3fooEPvi.2.for.body.preheader(i32 %Size, i32* %A)
...
; CHECK: codeRepl.i{{.*}}:
; CHECK-NEXT:    call void @_ZN8Derived23fooEPvi.1.for.body.preheader(i32 %Size, i32* %A)

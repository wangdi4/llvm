...
; This test is similar to Intel-TileMVInl01.ll, but tests additional loop
; forms, including loops where the induction variable is on the right-hand
; side of the ICmpInst, and loops where a TruncInst is interposed between
; the induction variable increment and the ICmpInst.
...
; CHECK: TMVINL: fun00_ Loop Index   %13 = add nuw nsw i64 %9, 1
; CHECK: TMVINL: fun00_ Loop Inc   %9 = phi i64 [ 3, %6 ], [ %13, %8 ]

...
; CHECK: tail call fastcc void @LBM_initializeSpecialCellsForLDC
; CHECK: AggInl:  Marking callsite for inline
; CHECK: tail call fastcc void @LBM_initializeSpecialCellsForChannel
; CHECK: AggInl:  Marking callsite for inline
; CHECK: tail call fastcc void @LBM_loadObstacleFile
; CHECK: AggInl:  Marking callsite for inline
; CHECK: tail call fastcc void @LBM_initializeGrid
; CHECK: AggInl:  Marking callsite for inline
; CHECK: tail call fastcc void @LBM_allocateGrid
; CHECK: AggInl:  Marking callsite for inline
; CHECK: call fastcc void @LBM_freeGrid
; CHECK: AggInl:  Marking callsite for inline
; CHECK:        call fastcc void @LBM_performStreamCollideTRT
; CHECK: AggInl:  Marking callsite for inline
; CHECK:        call fastcc void @LBM_performStreamCollideTRT
; CHECK: AggInl:  Marking all callsites of LBM_swapGrids
; CHECK: AggInl:  Marking all callsites of LBM_swapGrids
; CHECK: AggInl:  Marking callsite for inline
; CHECK: tail call fastcc void @LBM_showGridStatistics
; CHECK: AggInl:  Marking callsite for inline
; CHECK: tail call fastcc void @LBM_initializeSpecialCellsForLDC
; CHECK: AggInl:  Marking callsite for inline
; CHECK: tail call fastcc void @LBM_initializeSpecialCellsForChannel
...
; CHECK: call fastcc void @LBM_freeGrid
; CHECK: AggInl:  Marking callsite for inline
; CHECK: call fastcc void @LBM_storeVelocityField
; CHECK: AggInl:  Marking callsite for inline
; CHECK: call fastcc void @LBM_compareVelocityField
; CHECK: AggInl:  Marking callsite for inline
; CHECK: call fastcc void @LBM_showGridStatistics
; CHECK: AggInl:  Marking callsite for inline
; CHECK: call fastcc void @LBM_showGridStatistics
; CHECK: AggInl:  Marking callsite for inline
; CHECK: call fastcc void @LBM_performStreamCollideTRT
...
; CHECK: call fastcc void @LBM_performStreamCollideTRT
; CHECK: AggInl:  Marking callsite for inline
; CHECK: call fastcc void @LBM_handleInOutFlow
; CHECK: AggInl:  Marking all callsites of LBM_swapGrids
; CHECK: AggInl:  Marking all callsites of LBM_swapGrids
...
; CHECK: call fastcc void @LBM_performStreamCollideTRT
; CHECK: call fastcc void @LBM_performStreamCollideTRT
; CHECK: call fastcc void @LBM_swapGrids
; CHECK: call fastcc void @LBM_swapGrids
; CHECK: tail call fastcc void @LBM_showGridStatistics
; CHECK: tail call fastcc void @LBM_initializeSpecialCellsForLDC
; CHECK: tail call fastcc void @LBM_initializeSpecialCellsForChannel
; CHECK: tail call fastcc void @LBM_loadObstacleFile
; CHECK: tail call fastcc void @LBM_initializeGrid
; CHECK: tail call fastcc void @LBM_allocateGri
; CHECK: call fastcc void @LBM_freeGrid
; CHECK: call fastcc void @LBM_storeVelocityField
; CHECK: call fastcc void @LBM_compareVelocityField
; CHECK: call fastcc void @LBM_showGridStatistics
...
; CHECK: call fastcc void @LBM_showGridStatistics
; CHECK: call fastcc void @LBM_handleInOutFlow
; CHECK: call fastcc void @MAIN_initialize

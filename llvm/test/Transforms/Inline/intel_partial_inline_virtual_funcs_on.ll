...
; RUN: opt < %s -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -enable-new-pm=0 -partial-inliner -skip-partial-inlining-cost-analysis -partial-inline-virtual-functions -S 2>&1 | FileCheck %s
; RUN: opt < %s -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -passes='module(partial-inliner)' -skip-partial-inlining-cost-analysis -partial-inline-virtual-functions -S 2>&1 | FileCheck %s
...
; There should not be a Call to Derived::foo
; CHECK-NOT :   %i23 = tail call zeroext i1 bitcast (i1 (i8*, i32)* @_ZN7Derived3fooEPvi to i1 (%class.Base*, i8*, i32)*)(%class.Base* %i15, i8* nonnull %call.i8, i32 10), !_Intel.Devirt.Call
...
; Call to Derived2::foo should not be in the IR
; CHECK-NOT:   %i24 = tail call zeroext i1 bitcast (i1 (i8*, i32)* @_ZN8Derived23fooEPvi to i1 (%class.Base*, i8*, i32)*)(%class.Base* %i15, i8* nonnull %call.i8, i32 10), !_Intel.Devirt.Call

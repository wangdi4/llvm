...
; RUN: opt -inline -dtrans-inline-heuristics=false -pre-lto-inline-cost=false -inline-report=0xe807 < %s -S 2>&1 | FileCheck --check-prefix=CHECK-NEW %s
...
; RUN: opt -inlinereportsetup -inline-report=0xe886 < %s -S | opt -inline -dtrans-inline-heuristics=false -pre-lto-inline-cost=false -inline-report=0xe886 -S | opt -inlinereportemitter -inline-report=0xe886 -S 2>&1 | FileCheck --check-prefix=CHECK-OLD %s
; RUN: opt -inlinereportsetup -inline-report=0xe886 < %s -S | opt -passes='cgscc(inline)' -dtrans-inline-heuristics=false -pre-lto-inline-cost=false -inline-report=0xe886 -S | opt -inlinereportemitter -inline-report=0xe886 -S 2>&1 | FileCheck --check-prefix=CHECK-OLD %s

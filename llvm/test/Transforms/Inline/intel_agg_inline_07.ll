...
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -agginliner -inline -inline-threshold=-50 -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -S 2>&1 | FileCheck %s

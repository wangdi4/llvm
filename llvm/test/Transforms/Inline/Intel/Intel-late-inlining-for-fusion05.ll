...
; CHECK-OLD: define void @foo_{{.*}}#[[A0:[0-9]+]]
...
; CHECK-OLD: attributes #[[A0]] = { "prefer-function-level-region" }
...
; CHECK-NEW: define void @foo_{{.*}}#[[A0:[0-9]+]]
...
; CHECK-NEW: attributes #[[A0]] = { "prefer-function-level-region" }

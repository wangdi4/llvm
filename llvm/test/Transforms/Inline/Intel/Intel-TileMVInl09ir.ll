...
; RUN: opt < %s -S -passes='tilemvinlmarker' -tile-candidate-mark -tile-candidate-test -tile-candidate-min=4 -tile-candidate-arg-min=2 -tile-candidate-sub-arg-min=2 2>&1 | FileCheck %s

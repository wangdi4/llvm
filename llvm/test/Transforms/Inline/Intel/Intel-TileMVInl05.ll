...
define internal fastcc void @init_(ptr noalias nocapture %arg) unnamed_addr {
bb:
...
bb:
  ...
  call fastcc void @init_(ptr nonnull @mymod_mp_mynnodes_)
...
bb7:                                              ; preds = %bb7, %bb4
  ...
  store double %i18, ptr %i19, align 8
  %i20 = icmp sle i64 %i12, %i6
  br i1 %i20, label %bb7, label %bb21
...
bb6:                                              ; preds = %bb6, %bb4
  ...
  %i18 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(double) %arg1, i64 %i7)
  store double %i17, ptr %i18, align 8
  %i19 = icmp sgt i64 %i11, %i5
  br i1 %i19, label %bb6, label %bb20

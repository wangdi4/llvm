...
; RUN: opt -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -passes='module(partial-inliner),print<inline-report>' -skip-partial-inlining-cost-analysis -partial-inline-virtual-functions -S -inline-report=0xf847 < %s 2>&1 | FileCheck %s

; Test that the compiler does not die when encounting a virtual function for which partial inlining
; can be applied, even when the function appears in a call for which it is not the called function.

; This test case is derived from intel_partial_inline_virtual_funcs.ll in this directory.
; See that test case for details.

; Check the inlining report: 

; CHECK-LABEL: COMPILE FUNC: _ZN7Manager6runnerEPii
; CHECK: INLINE: _ZN7Derived3fooEPvi.2 {{.*}}Preferred for partial inlining
; CHECK: _ZN7Derived3fooEPvi.2.for.body.preheader {{.*}}Outlined function from partial inlining
; CHECK: INLINE: _ZN8Derived23fooEPvi.1 {{.*}}Preferred for partial inlining
; CHECK: _ZN8Derived23fooEPvi.1.for.body.preheader {{.*}}Outlined function from partial inlining

; Check the IR

; CHECK-LABEL: define internal zeroext i1 @_ZN7Manager6runnerEPii(
; CHECK: call void @_ZN7Derived3fooEPvi.2.for.body.preheader(
; CHECK: call void @_ZN8Derived23fooEPvi.1.for.body.preheader(
...
@_ZTI7Manager = internal constant { ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 2), ptr @_ZTS7Manager }, align 8
...
@_ZTI7cObject = internal constant { ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 2), ptr @_ZTS7cObject }, align 8
@_ZTI4Base = internal constant { ptr, ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2), ptr @_ZTS4Base, ptr @_ZTI7cObject }, align 8
@_ZTI7Derived = internal constant { ptr, ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2), ptr @_ZTS7Derived, ptr @_ZTI4Base }, align 8
...
@_ZTI8Derived2 = internal constant { ptr, ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2), ptr @_ZTS8Derived2, ptr @_ZTI4Base }, align 8
...
dynamic_cast.end.i:                               ; preds = %invoke.cont
  %i9 = tail call ptr @__dynamic_cast(ptr nonnull %call2.i.i6, ptr @_ZTI7cObject, ptr @_ZTI7Derived, i64 0) #14
...
dynamic_cast.end6.i:                              ; preds = %invoke.cont
  %i11 = tail call ptr @__dynamic_cast(ptr nonnull %call4.i.i7, ptr @_ZTI7cObject, ptr @_ZTI8Derived2, i64 0) #14
...
for.body.i.i:                                     ; preds = %for.body.i.i, %whpr.wrap.i
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i, %for.body.i.i ], [ 0, %whpr.wrap.i ]
...
_ZN7Manager3runEv.exit:                           ; preds = %for.body.i.i, %whpr.wrap.i
  ret i32 0
...
define internal void @goo(ptr %myaddr) {
  ret void
}
...
entry:
  ...
  %i = bitcast ptr %i6 to ptr
  %i1 = bitcast ptr @_ZN7Derived3fooEPvi to ptr
  %i2 = icmp eq ptr %i, %i1
  br i1 %i2, label %BBDevirt__ZN7Derived3fooEPvi, label %BBDevirt__ZN8Derived23fooEPvi

BBDevirt__ZN7Derived3fooEPvi:                     ; preds = %entry
  %i3 = tail call zeroext i1 @_ZN7Derived3fooEPvi(ptr %A, i32 %Size), !_Intel.Devirt.Call !27
  br label %MergeBB

BBDevirt__ZN8Derived23fooEPvi:                    ; preds = %entry
  %i4 = tail call zeroext i1 @_ZN8Derived23fooEPvi(ptr %A, i32 %Size), !_Intel.Devirt.Call !27
  br label %MergeBB

MergeBB:                                          ; preds = %BBDevirt__ZN8Derived23fooEPvi, %BBDevirt__ZN7Derived3fooEPvi
  %i7 = phi i1 [ %i3, %BBDevirt__ZN7Derived3fooEPvi ], [ %i4, %BBDevirt__ZN8Derived23fooEPvi ]
  br label %bb

bb:                                               ; preds = %MergeBB
  call void @goo(ptr @_ZN7Derived3fooEPvi)
  ret i1 %i7
}
...
entry:
  ...
  %i0 = tail call i32 @__cxa_atexit(ptr @_ZNSt8ios_base4InitD1Ev, ptr @_ZSt8__ioinit, ptr nonnull @__dso_handle) #14
  ret void
}
...
attributes #10 = { nocallback nofree nosync nounwind speculatable willreturn memory(none) "target-features"="+avx2" }
attributes #11 = { nocallback nofree nosync nounwind willreturn memory(inaccessiblemem: readwrite) "target-features"="+avx2" }
attributes #12 = { nounwind memory(read) "target-features"="+avx2" }

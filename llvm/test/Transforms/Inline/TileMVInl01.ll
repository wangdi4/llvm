...
; CHECK: TILEMVINL: Tile Choice fun0_
; CHECK: TILEMVINL: Tile Choice fun1_
; CHECK: TILEMVINL: Tile Choice fun2_
; CHECK: TILEMVINL: Tile Choice extra_
; CHECK: TILEMVINL: Tile Choice fun00_
; CHECK: TILEMVINL: Tile Choice fun01_

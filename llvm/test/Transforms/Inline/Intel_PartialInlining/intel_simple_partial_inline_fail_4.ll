...
; }
;
; This is the same test case as intel_simple_partial_inline_fail_4.ll, but it
...
; ModuleID = 'intel_simple_partial_inline_fail_4.ll'
source_filename = "intel_simple_partial_inline_fail_4.ll"
...
entry:
  ...
  %call = call zeroext i1 @_Z3fooP4Node(ptr %0) #0
  ret i1 %call
}

...
;
; This test case will check that debug information is printed correctly. It is
; the same test case as intel_simple_partial_inline.ll, but for opaque
; pointers.
;
...
; ModuleID = 'intel_simple_partial_inline.ll'
source_filename = "intel_simple_partial_inline.ll"

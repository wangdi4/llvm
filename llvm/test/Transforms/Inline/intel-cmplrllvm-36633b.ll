...
; CHECK:   %"foo_$ACOX_fetch.1.i.i" = load i32, i32* %"baz_$ZCOX", align 1, !tbaa !38, !alias.scope !42, !noalias !43
; CHECK:   store i32 %add.1.i.i, i32* %"baz_$WCOX", align 1, !tbaa !44, !alias.scope !43, !noalias !42
; CHECK:   %"foo_$ACOX_fetch.1.i1.i" = load i32, i32* %"baz_$WCOX", align 1, !tbaa !51, !alias.scope !55, !noalias !56
; CHECK:   store i32 %add.1.i2.i, i32* %"baz_$ZCOX", align 1, !tbaa !57, !alias.scope !56, !noalias !55
...
; Function Attrs: nounwind uwtable
define void @baz_(i32* noalias dereferenceable(4) %"baz_$ZCOX", i32* noalias dereferenceable(4) %"baz_$WCOX") local_unnamed_addr #0 {
alloca_2:
  call void @bar_(i32* nonnull %"baz_$ZCOX", i32* nonnull %"baz_$WCOX"), !llfort.type_idx !8
  ret void
}

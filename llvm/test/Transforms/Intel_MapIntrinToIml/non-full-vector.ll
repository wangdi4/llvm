...
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx <8 x float> @__svml_sinf8_l9(<8 x float> [[ARG]])
...
; CHECK: [[QUOTIENT:%.*]] = call svml_cc_avx <8 x i32> @__svml_idiv8_l9(<8 x i32> [[DIVIDEND_WIDEN]], <8 x i32> [[DIVISOR_WIDEN]])
...
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx <8 x float> @__svml_sinf8_mask_e9(<8 x float> [[ARG]], <8 x i32> [[MASK]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <8 x float> [[RESULT]], <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK: ret <4 x float> [[RESULT_EXTRACT]]
...
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx512 <16 x float> @__svml_sinf16_z0(<16 x float> [[ARG]])
...
; CHECK: [[ARG:%.*]] = shufflevector <8 x float> %A, <8 x float> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx512 <16 x float> @__svml_sinf16_mask_z0(<16 x float> undef, <16 x i1> [[MASK]], <16 x float> [[ARG]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <16 x float> [[RESULT]], <16 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: ret <8 x float> [[RESULT_EXTRACT]]
...
; CHECK: [[QUOTIENT:%.*]] = call svml_cc_avx512 <16 x i32> @__svml_idiv16_mask_z0(<16 x i32> undef, <16 x i1> [[MASK_WIDEN]], <16 x i32> [[DIVIDEND_WIDEN]], <16 x i32> [[DIVISOR_WIDEN]])
...
; CHECK: [[ARG:%.*]] = shufflevector <8 x float> %a, <8 x float> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[RESULT:%.*]] = call svml_cc_avx512 { <16 x float>, <16 x float> } @__svml_sincosf16_ha_z0(<16 x float> [[ARG]])
...
; CHECK: [[RESULT:%.*]] = call svml_cc_avx512 { <16 x float>, <16 x float> } @__svml_sincosf16_ha_mask_z0({ <16 x float>, <16 x float> } undef, <16 x i1> [[MASK]], <16 x float> [[ARG]])
; CHECK: [[SIN:%.*]] = extractvalue { <16 x float>, <16 x float> } [[RESULT]], 0
; CHECK: [[SIN_EXTRACT:%.*]] = shufflevector <16 x float> [[SIN]], <16 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[TMP1:%.*]] = insertvalue { <8 x float>, <8 x float> } undef, <8 x float> [[SIN_EXTRACT]], 0
; CHECK: [[COS:%.*]] = extractvalue { <16 x float>, <16 x float> } [[RESULT]], 1
...
; CHECK: [[DIVIDEND_WIDEN:%.*]] = shufflevector <8 x i32> [[DIVIDEND]], <8 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[DIVISOR_WIDEN:%.*]] = shufflevector <8 x i32> [[DIVISOR]], <8 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[RESULT:%.*]] = call svml_cc_avx512 { <16 x i32>, <16 x i32> } @__svml_idivrem16_z0(<16 x i32> [[DIVIDEND_WIDEN]], <16 x i32> [[DIVISOR_WIDEN]])
...
; CHECK: [[ARG:%.*]] = shufflevector <8 x float> %A, <8 x float> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx512 <16 x float> @__svml_cexpf8_z0(<16 x float> [[ARG]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <16 x float> [[RESULT]], <16 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: ret <8 x float> [[RESULT_EXTRACT]]
...
; CHECK: [[ARG:%.*]] = shufflevector <8 x float> %A, <8 x float> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx512 <16 x float> @__svml_cexpf8_mask_z0(<16 x float> undef, <8 x i1> [[MASK]], <16 x float> [[ARG]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <16 x float> [[RESULT]], <16 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: ret <8 x float> [[RESULT_EXTRACT]]

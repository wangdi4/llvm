...
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx <8 x float> @__svml_sinf8(<8 x float> [[ARG]])
...
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx <8 x float> @__svml_sinf8_mask(<8 x float> [[ARG]], <8 x i32> [[MASK]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <8 x float> [[RESULT]], <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK: ret <4 x float> [[RESULT_EXTRACT]]
...
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx512 <16 x float> @__svml_sinf16(<16 x float> [[ARG]])
...
; CHECK: [[ARG:%.*]] = shufflevector <8 x float> %A, <8 x float> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx512 <16 x float> @__svml_sinf16_mask(<16 x float> undef, <16 x i1> [[MASK]], <16 x float> [[ARG]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <16 x float> [[RESULT]], <16 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: ret <8 x float> [[RESULT_EXTRACT]]
...
; CHECK: [[ARG:%.*]] = shufflevector <8 x float> %A, <8 x float> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx512 <16 x float> @__svml_cexpf8(<16 x float> [[ARG]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <16 x float> [[RESULT]], <16 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: ret <8 x float> [[RESULT_EXTRACT]]
...
; CHECK: [[ARG:%.*]] = shufflevector <8 x float> %A, <8 x float> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: [[RESULT:%.*]] = call fast svml_cc_avx512 <16 x float> @__svml_cexpf8_mask(<16 x float> undef, <8 x i1> [[MASK]], <16 x float> [[ARG]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <16 x float> [[RESULT]], <16 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK: ret <8 x float> [[RESULT_EXTRACT]]

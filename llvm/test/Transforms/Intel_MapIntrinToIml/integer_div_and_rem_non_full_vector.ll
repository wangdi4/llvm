...
; CHECK-NEXT:    [[VCALL:%.*]] = call svml_avx512_cc <64 x i8> @__svml_i8div64_z0(<64 x i8> [[SHUFFLE_DUP]], <64 x i8> [[SHUFFLE_DUP1]])
...
; CHECK-NEXT:    [[VCALL:%.*]] = call svml_avx512_cc <32 x i16> @__svml_i16div32_z0(<32 x i16> [[SHUFFLE_DUP]], <32 x i16> [[SHUFFLE_DUP1]])
...
; CHECK-NEXT:    [[VCALL:%.*]] = call svml_avx512_cc <16 x i32> @__svml_idiv16_z0(<16 x i32> [[SHUFFLE_DUP]], <16 x i32> [[SHUFFLE_DUP1]])
...
; CHECK-NEXT:    [[VCALL:%.*]] = call svml_avx512_cc <8 x i64> @__svml_i64div8_z0(<8 x i64> [[SHUFFLE_DUP]], <8 x i64> [[SHUFFLE_DUP1]])

; Check to see that the llvm.cos.v4f32 intrinsic is translated to svml.
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %2 = call <4 x float> @llvm.cos.v4f32(<4 x float> %1)
...
declare <4 x float> @llvm.cos.v4f32(<4 x float>) #3

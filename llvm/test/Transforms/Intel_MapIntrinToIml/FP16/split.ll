...
; CHECK: [[RESULT1:%.*]] = call fast svml_cc_avx512 <32 x half> @__svml_sins32_mask(<32 x half> [[SRC1]], <32 x i1> [[MASK1]], <32 x half> [[ARG1]])
...
; CHECK: [[RESULT2:%.*]] = call fast svml_cc_avx512 <32 x half> @__svml_sins32_mask(<32 x half> [[SRC2]], <32 x i1> [[MASK2]], <32 x half> [[ARG2]])
...
; CHECK: [[RESULT1:%.*]] = call svml_cc_avx512 { <32 x half>, <32 x half> } @__svml_sincoss32_ha_mask({ <32 x half>, <32 x half> } [[SRC1]], <32 x i1> [[MASK1]], <32 x half> [[ARG1]])
...
; CHECK: [[RESULT2:%.*]] = call svml_cc_avx512 { <32 x half>, <32 x half> } @__svml_sincoss32_ha_mask({ <32 x half>, <32 x half> } [[SRC2]], <32 x i1> [[MASK2]], <32 x half> [[ARG2]])

...
; CHECK: [[RESULT:%.*]] = call nnan afn svml_cc <4 x float> @__svml_sinf4_mask(<4 x float> %A, <4 x i32> %B)
...
; CHECK: [[RESULT:%.*]] = call svml_cc <4 x float> @__svml_sinf4_ha_mask(<4 x float> %A, <4 x i32> %B)
; CHECK: ret <4 x float> [[RESULT]]
...
; CHECK: [[RESULT1:%.*]] = call nnan afn svml_cc <4 x float> @__svml_sinf4_mask(<4 x float> [[ARG1]], <4 x i32> [[MASK1]])
...
; CHECK: [[RESULT2:%.*]] = call nnan afn svml_cc <4 x float> @__svml_sinf4_mask(<4 x float> [[ARG2]], <4 x i32> [[MASK2]])
...
; CHECK: [[RESULT3:%.*]] = call nnan afn svml_cc <4 x float> @__svml_sinf4_mask(<4 x float> [[ARG3]], <4 x i32> [[MASK3]])
...
; CHECK: [[RESULT4:%.*]] = call nnan afn svml_cc <4 x float> @__svml_sinf4_mask(<4 x float> [[ARG4]], <4 x i32> [[MASK4]])
...
; CHECK: [[RESULT:%.*]] = call nnan afn svml_cc_avx <8 x float> @__svml_sinf8_mask(<8 x float> [[ARG]], <8 x i32> [[MASK]])
...
; CHECK: [[ARG:%.*]] = shufflevector <4 x float> %A, <4 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
; CHECK: [[MASK:%.*]] = shufflevector <4 x i32> %B, <4 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
; CHECK: [[RESULT:%.*]] = call svml_cc_avx <8 x float> @__svml_sinf8_ha_mask(<8 x float> [[ARG]], <8 x i32> [[MASK]])
; CHECK: [[RESULT_EXTRACT:%.*]] = shufflevector <8 x float> [[RESULT]], <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK: ret <4 x float> [[RESULT_EXTRACT]]

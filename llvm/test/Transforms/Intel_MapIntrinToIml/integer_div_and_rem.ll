...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[VCALL1:%.*]] = call svml_avx_avx_impl_cc <32 x i8> @__svml_i8div32_l9(<32 x i8> [[A:%.*]], <32 x i8> [[B:%.*]])
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[VCALL1:%.*]] = call svml_avx_avx_impl_cc <16 x i16> @__svml_i16div16_l9(<16 x i16> [[A:%.*]], <16 x i16> [[B:%.*]])
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[VCALL1:%.*]] = call svml_avx_avx_impl_cc <8 x i32> @__svml_idiv8_l9(<8 x i32> [[A:%.*]], <8 x i32> [[B:%.*]])
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[VCALL1:%.*]] = call svml_avx_avx_impl_cc <8 x i32> @__svml_irem8_l9(<8 x i32> [[A:%.*]], <8 x i32> [[B:%.*]])
; CHECK-NEXT:    ret <8 x i32> [[VCALL1]]
;
entry:
  %0 = srem <8 x i32> %A, %B
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[VCALL1:%.*]] = call svml_avx_avx_impl_cc <8 x i32> @__svml_udiv8_l9(<8 x i32> [[A:%.*]], <8 x i32> [[B:%.*]])
; CHECK-NEXT:    ret <8 x i32> [[VCALL1]]
;
entry:
  %0 = udiv <8 x i32> %A, %B
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[VCALL1:%.*]] = call svml_avx_avx_impl_cc <8 x i32> @__svml_urem8_l9(<8 x i32> [[A:%.*]], <8 x i32> [[B:%.*]])
; CHECK-NEXT:    ret <8 x i32> [[VCALL1]]
;
entry:
  %0 = urem <8 x i32> %A, %B
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[VCALL1:%.*]] = call svml_avx_avx_impl_cc <4 x i64> @__svml_i64div4_l9(<4 x i64> [[A:%.*]], <4 x i64> [[B:%.*]])

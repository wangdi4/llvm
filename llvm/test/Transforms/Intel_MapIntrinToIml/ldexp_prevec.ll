...
; CHECK-NEXT:    [[TMP8:%.*]] = call fast <4 x float> @__svml_ldexpf4(<4 x float> [[TMP4]], <4 x i32> [[VEC_IND6]]) [[ATTR2:#.*]]
...
; CHECK-NEXT:    [[CONV:%.*]] = sitofp i32 [[TMP13]] to float
...
; CHECK-NEXT:    [[TMP15:%.*]] = tail call fast float @ldexpf(float [[CONV]], i32 [[TMP13]]) [[ATTR2]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds float, float* [[VARRAY]], i64 [[INDVARS_IV]]
; CHECK-NEXT:    store float [[TMP15]], float* [[ARRAYIDX2]], align 4

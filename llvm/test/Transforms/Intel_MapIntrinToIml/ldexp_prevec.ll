...
; CHECK-NEXT:    [[TMP8:%.*]] = sitofp <4 x i32> [[VEC_IND7]] to <4 x float>
; CHECK-NEXT:    [[TMP9:%.*]] = sitofp <4 x i32> [[STEP_ADD8]] to <4 x float>
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds float, float* [[EXP]], i64 [[TMP0]]
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds float, float* [[EXP]], i64 [[TMP4]]
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds float, float* [[TMP10]], i32 0
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast float* [[TMP12]] to <4 x float>*
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x float>, <4 x float>* [[TMP13]], align 4, !alias.scope !0
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds float, float* [[TMP10]], i32 4
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast float* [[TMP14]] to <4 x float>*
; CHECK-NEXT:    [[WIDE_LOAD11:%.*]] = load <4 x float>, <4 x float>* [[TMP15]], align 4, !alias.scope !0
; CHECK-NEXT:    [[TMP16:%.*]] = call fast <4 x float> @__svml_ldexpf4(<4 x float> [[TMP8]], <4 x i32> [[VEC_IND7]]) #[[ATTR2:[0-9]+]]
; CHECK-NEXT:    [[TMP17:%.*]] = call fast <4 x float> @__svml_ldexpf4(<4 x float> [[TMP9]], <4 x i32> [[STEP_ADD8]]) #[[ATTR2]]
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr inbounds float, float* [[VARRAY]], i64 [[TMP0]]
; CHECK-NEXT:    [[TMP19:%.*]] = getelementptr inbounds float, float* [[VARRAY]], i64 [[TMP4]]
; CHECK-NEXT:    [[TMP20:%.*]] = getelementptr inbounds float, float* [[TMP18]], i32 0
; CHECK-NEXT:    [[TMP21:%.*]] = bitcast float* [[TMP20]] to <4 x float>*
; CHECK-NEXT:    store <4 x float> [[TMP16]], <4 x float>* [[TMP21]], align 4, !alias.scope !3, !noalias !0
; CHECK-NEXT:    [[TMP22:%.*]] = getelementptr inbounds float, float* [[TMP18]], i32 4
; CHECK-NEXT:    [[TMP23:%.*]] = bitcast float* [[TMP22]] to <4 x float>*
; CHECK-NEXT:    store <4 x float> [[TMP17]], <4 x float>* [[TMP23]], align 4, !alias.scope !3, !noalias !0
...
; CHECK-NEXT:    [[CONV:%.*]] = sitofp i32 [[TMP25]] to float
...
; CHECK-NEXT:    [[TMP27:%.*]] = tail call fast float @ldexpf(float [[CONV]], i32 [[TMP25]]) #[[ATTR2]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds float, float* [[VARRAY]], i64 [[INDVARS_IV]]
; CHECK-NEXT:    store float [[TMP27]], float* [[ARRAYIDX2]], align 4

...
; CHECK: call fast svml_avx_avx_impl_cc <8 x float> @__svml_pownf8_l9
; CHECK: ret
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %4 = call fast <8 x float> @__svml_pownf8(<8 x float> %wide.load, <8 x i32> %wide.load11)
...
; CHECK: call fast svml_avx_avx_impl_cc <4 x double> @__svml_pown4_l9
; CHECK: ret
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %4 = call fast <4 x double> @__svml_pown4(<4 x double> %wide.load, <4 x i32> %wide.load11)

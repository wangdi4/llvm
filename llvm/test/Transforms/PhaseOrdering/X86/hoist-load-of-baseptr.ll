...
; RUN-DISABLED: opt -O2 -S -enable-new-pm=0 < %s | FileCheck --check-prefixes=OLDPM_O2 %s
; RUN-DISABLED: opt -O3 -S -enable-new-pm=0 < %s | FileCheck --check-prefixes=OLDPM_O3 %s
; RUN: opt -passes='default<O1>' -S < %s | FileCheck --check-prefixes=NEWPM_O1 %s
; RUN-DISABLED: opt -passes='default<O2>' -S < %s | FileCheck --check-prefixes=NEWPM_O2 %s
; RUN-DISABLED: opt -passes='default<O3>' -S < %s | FileCheck --check-prefixes=NEWPM_O3 %s

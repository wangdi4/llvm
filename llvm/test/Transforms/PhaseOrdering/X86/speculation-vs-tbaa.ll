...
; RUN-DISABLED: opt -O2 -S -enable-new-pm=0 < %s | FileCheck --check-prefixes=OLDPM_O23 %s
; RUN-DISABLED: opt -O3 -S -enable-new-pm=0 < %s | FileCheck --check-prefixes=OLDPM_O23 %s
; RUN: opt -passes='default<O1>' -S < %s | FileCheck --check-prefixes=NEWPM_O1 %s
; RUN-DISABLED: opt -passes='default<O2>' -S < %s | FileCheck --check-prefixes=NEWPM_O23 %s
; RUN-DISABLED: opt -passes='default<O3>' -S < %s | FileCheck --check-prefixes=NEWPM_O23 %s
...
>>>>>>> 20cf4f8af8da9ad758bbb7972e5aa9cae6c5f995

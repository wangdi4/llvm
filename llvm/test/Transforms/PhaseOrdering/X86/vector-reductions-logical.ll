...
; CHECK-NEXT:    [[TMP9:%.*]] = select i1 [[CMP34]], float 0.000000e+00, float [[ADD]]
; CHECK-NEXT:    br label [[RETURN]]
; CHECK:       return:
; CHECK-NEXT:    [[RETVAL_0:%.*]] = phi float [ [[TMP9]], [[LOR_LHS_FALSE31]] ], [ 0.000000e+00, [[LOR_LHS_FALSE11]] ], [ 0.000000e+00, [[ENTRY:%.*]] ]
=======
...
>>>>>>> 7d6b8249faba3c761de5de66f3dafb96a3fd9047
; CHECK-NEXT:    ret float [[RETVAL_0]]
;
; end INTEL_CUSTOMIZATION
entry:
...
; CHECK-NEXT:    [[ADD:%.*]] = fadd float [[TMP3]], [[TMP2]]
; CHECK-NEXT:    [[TMP9:%.*]] = select i1 [[CMP33]], float 0.000000e+00, float [[ADD]]
; CHECK-NEXT:    br label [[RETURN]]
; CHECK:       return:
; CHECK-NEXT:    [[RETVAL_0:%.*]] = phi float [ 0.000000e+00, [[LOR_LHS_FALSE11]] ], [ 0.000000e+00, [[ENTRY:%.*]] ], [ [[TMP9]], [[LOR_LHS_FALSE30]] ]
; CHECK-NEXT:    ret float [[RETVAL_0]]
;
; end INTEL_CUSTOMIZATION
entry:
...
; CHECK-NEXT:    [[TMP6:%.*]] = add nsw <4 x i32> [[T_FR]], [[SHIFT]]
; CHECK-NEXT:    [[ADD:%.*]] = extractelement <4 x i32> [[TMP6]], i64 0
; CHECK-NEXT:    [[TMP7:%.*]] = select i1 [[TMP5]], i32 0, i32 [[ADD]]
; CHECK-NEXT:    br label [[RETURN]]
; CHECK:       return:
; CHECK-NEXT:    [[RETVAL_0:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[TMP7]], [[IF_END]] ]
...
; CHECK-NEXT:    [[TMP5:%.*]] = select i1 [[DOTNOT6]], i32 [[ADD]], i32 0
; CHECK-NEXT:    br label [[RETURN]]
; CHECK:       return:
; CHECK-NEXT:    [[RETVAL_0:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[TMP5]], [[IF_END]] ]
; CHECK-NEXT:    ret i32 [[RETVAL_0]]
; end INTEL_CUSTOMIZATION
;
entry:

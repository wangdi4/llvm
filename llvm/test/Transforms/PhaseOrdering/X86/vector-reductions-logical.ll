...
; CHECK-NEXT:    [[TMP7:%.*]] = select i1 [[OR_COND5]], i1 true, i1 [[CMP34]]
; CHECK-NEXT:    [[TMP8:%.*]] = select i1 [[TMP7]], float 0.000000e+00, float [[ADD]]
...
; CHECK-NEXT:    [[ADD:%.*]] = fadd float [[TMP3]], [[TMP2]]
; CHECK-NEXT:    [[TMP7:%.*]] = select i1 [[OR_COND5]], i1 true, i1 [[CMP33]]
; CHECK-NEXT:    [[TMP8:%.*]] = select i1 [[TMP7]], float 0.000000e+00, float [[ADD]]
; CHECK-NEXT:    ret float [[TMP8]]
;
entry:
...
; CHECK-NEXT:    [[CONV:%.*]] = sitofp i32 [[ADD]] to float
; CHECK-NEXT:    [[TMP7:%.*]] = select i1 [[OR_COND6]], float 0.000000e+00, float [[CONV]]

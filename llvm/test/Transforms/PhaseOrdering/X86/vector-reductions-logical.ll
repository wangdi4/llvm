...
; INTEL_CUSTOMIZATION
; Difference(s) in xmain autogenerated checks vs llorg:
...
>>>>>>> 3edec9ba602c1ed5904e5bbcd8986dcd05fe3a83
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[T_FR:%.*]] = freeze <4 x float> [[T:%.*]]
; CHECK-NEXT:    [[TMP0:%.*]] = extractelement <4 x float> [[T_FR]], i64 3
; CHECK-NEXT:    [[TMP1:%.*]] = extractelement <4 x float> [[T_FR]], i64 2
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x float> [[T_FR]], i64 1
; CHECK-NEXT:    [[TMP3:%.*]] = extractelement <4 x float> [[T_FR]], i64 0
...
; CHECK-NEXT:    [[OR_COND3:%.*]] = or i1 [[OR_COND]], [[CMP9]]
...
; CHECK-NEXT:    [[OP_RDX:%.*]] = or i1 [[TMP6]], [[CMP14]]

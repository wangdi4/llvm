...
; INTEL: Added -enable-instcombine-add-sub-reassoc
; RUN: opt -O2                   -enable-instcombine-add-sub-reassoc -S -mattr=avx < %s | FileCheck %s
; RUN: opt -passes='default<O2>' -enable-instcombine-add-sub-reassoc -S -mattr=avx < %s | FileCheck %s

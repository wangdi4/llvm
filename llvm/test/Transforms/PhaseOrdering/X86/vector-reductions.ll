...
; RUN: opt -O2                   -disable-instcombine-add-sub-reassoc=0 -S -mattr=avx < %s | FileCheck %s
; RUN: opt -passes='default<O2>' -disable-instcombine-add-sub-reassoc=0 -S -mattr=avx < %s | FileCheck %s

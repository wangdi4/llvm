...
; INTEL_CUSTOMIZATION
; Auto-generated checks differ in xmain vs llorg.
...
; ALL-NEXT:    [[DOTV:%.*]] = select i1 [[TOBOOL_NOT]], i64 [[LO:%.*]], i64 [[HI:%.*]]
; ALL-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i32, i32* [[IN:%.*]], i64 [[DOTV]]
; ALL-NEXT:    [[ARRAYVAL2:%.*]] = load i32, i32* [[TMP0]], align 4
; ALL-NEXT:    [[INC2:%.*]] = add nsw i32 [[ARRAYVAL2]], 1
; ALL-NEXT:    store i32 [[INC2]], i32* [[TMP0]], align 4
; ALL-NEXT:    ret void
;
entry:

...
; INTEL_CUSTOMIZATION
; This test has been cloned for the xmain O3 pipeline as:
; Intel-SROA-after-loop-unrolling.ll
; The author did not expect the old-PM pipeline to optimize this code at all.
; XFAIL: *

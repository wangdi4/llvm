...
; RUN: opt -passes="default<O3>" -S            < %s | FileCheck %s --check-prefix=SSE ;INTEL
; RUN: opt -passes="default<O3>" -S -mattr=avx < %s | FileCheck %s --check-prefix=AVX ;INTEL
...
>>>>>>> 457dc72fdd2eefe364548e721619cc1951854372

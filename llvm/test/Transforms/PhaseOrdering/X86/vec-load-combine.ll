...
; INTEL_CUSTOMIZATION
; RUN: opt -xmain-enable-gep0-removal -passes="default<O3>" -S            < %s | FileCheck %s --check-prefix=SSE
; RUN: opt -xmain-enable-gep0-removal -passes="default<O3>" -S -mattr=avx < %s | FileCheck %s --check-prefix=AVX
...
; INTEL_CUSTOMIZATION
<<<<<<< HEAD
; xmain uses an i64 type consistently on the geps/loads.
; SSE-NEXT:    [[V_VAL21:%.*]] = load i64, ptr [[V:%.*]], align 16
; SSE-NEXT:    [[TMP0:%.*]] = getelementptr i64, ptr [[V]], i64 1
; SSE-NEXT:    [[V_VAL422:%.*]] = load i64, ptr [[TMP0]], align 8
; SSE-NEXT:    [[VEC_V_VAL21:%.*]] = bitcast i64 [[V_VAL21]] to <2 x i32>
; SSE-NEXT:    [[TMP1:%.*]] = shufflevector <2 x i32> [[VEC_V_VAL21]], <2 x i32> poison, <4 x i32> <i32 0, i32 undef, i32 undef, i32 undef>
; SSE-NEXT:    [[TMP2:%.*]] = lshr i64 [[V_VAL21]], 32
; SSE-NEXT:    [[TMP3:%.*]] = trunc i64 [[TMP2]] to i32
; SSE-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> [[TMP1]], i32 [[TMP3]], i64 1
; SSE-NEXT:    [[TMP5:%.*]] = trunc i64 [[V_VAL422]] to i32
; end INTEL_CUSTOMIZATION
...
; SSE-NEXT:    [[TMP0:%.*]] = getelementptr i64, ptr [[V]], i64 1
; SSE-NEXT:    [[V_VAL422:%.*]] = load i64, ptr [[TMP0]], align 8
; SSE-NEXT:    [[TMP1:%.*]] = lshr i64 [[V_VAL21]], 32
; SSE-NEXT:    [[TMP2:%.*]] = insertelement <2 x i64> poison, i64 [[V_VAL21]], i64 0
; end INTEL_CUSTOMIZATION
...
; AVX-NEXT:    [[V_VAL422:%.*]] = load i64, ptr [[TMP0]], align 8
<<<<<<< HEAD
; AVX-NEXT:    [[VEC_V_VAL21:%.*]] = bitcast i64 [[V_VAL21]] to <2 x i32>
; AVX-NEXT:    [[TMP1:%.*]] = shufflevector <2 x i32> [[VEC_V_VAL21]], <2 x i32> poison, <4 x i32> <i32 0, i32 undef, i32 undef, i32 undef>
; AVX-NEXT:    [[TMP2:%.*]] = lshr i64 [[V_VAL21]], 32
; AVX-NEXT:    [[TMP3:%.*]] = trunc i64 [[TMP2]] to i32
; AVX-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> [[TMP1]], i32 [[TMP3]], i64 1
; AVX-NEXT:    [[TMP5:%.*]] = trunc i64 [[V_VAL422]] to i32
; end INTEL_CUSTOMIZATION
...
=======
; AVX-NEXT:    [[TMP1:%.*]] = trunc i64 [[V_VAL21]] to i32
; AVX-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> undef, i32 [[TMP1]], i64 0
; AVX-NEXT:    [[TMP3:%.*]] = lshr i64 [[V_VAL21]], 32
; end INTEL_CUSTOMIZATION

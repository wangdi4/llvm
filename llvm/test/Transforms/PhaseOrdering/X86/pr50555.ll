...
; SSE-NEXT:    [[TMP3:%.*]] = bitcast i8* [[TMP1:%.*]] to <16 x i8>*
; SSE-NEXT:    [[COALESCEDLOAD:%.*]] = load <16 x i8>, <16 x i8>* [[TMP3]], align 1
...
; SSE-NEXT:    [[TMP7:%.*]] = bitcast i16* [[TMP0:%.*]] to <8 x i16>*
; SSE-NEXT:    [[TMP8:%.*]] = lshr <8 x i16> [[TMP6]], <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
; SSE-NEXT:    store <8 x i16> [[TMP8]], <8 x i16>* [[TMP7]], align 2
; SSE-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i16, i16* [[TMP0]], i64 8
...
; SSE-NEXT:    [[TMP14:%.*]] = bitcast i16* [[TMP9]] to <8 x i16>*
...
; SSE-NEXT:    [[TMP4:%.*]] = bitcast i8* [[TMP1:%.*]] to <16 x i8>*
; SSE-NEXT:    [[COALESCEDLOAD:%.*]] = load <16 x i8>, <16 x i8>* [[TMP4]], align 1
; SSE-NEXT:    [[LOADCOALESCINGSHUFFLE_:%.*]] = shufflevector <16 x i8> [[COALESCEDLOAD]], <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; SSE-NEXT:    [[TMP5:%.*]] = zext <8 x i8> [[LOADCOALESCINGSHUFFLE_]] to <8 x i16>
; SSE-NEXT:    [[TMP6:%.*]] = bitcast i8* [[TMP2:%.*]] to <16 x i8>*
; SSE-NEXT:    [[COALESCEDLOAD2:%.*]] = load <16 x i8>, <16 x i8>* [[TMP6]], align 1
...
; SSE-NEXT:    [[TMP11:%.*]] = bitcast i16* [[TMP0:%.*]] to <8 x i16>*
; SSE-NEXT:    [[TMP12:%.*]] = lshr <8 x i16> [[TMP10]], <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
; SSE-NEXT:    [[LOADCOALESCINGSHUFFLE_1:%.*]] = shufflevector <16 x i8> [[COALESCEDLOAD]], <16 x i8> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; SSE-NEXT:    store <8 x i16> [[TMP12]], <8 x i16>* [[TMP11]], align 2
; SSE-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i16, i16* [[TMP0]], i64 8
...
; SSE-NEXT:    [[TMP20:%.*]] = bitcast i16* [[TMP13]] to <8 x i16>*
; SSE-NEXT:    store <8 x i16> [[TMP19]], <8 x i16>* [[TMP20]], align 2
; SSE-NEXT:    ret void
; end INTEL_CUSTOMIZATION
;

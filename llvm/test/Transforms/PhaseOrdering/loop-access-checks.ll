...
; CHECK-NEXT:  entry:
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[VEC_VAL:%.*]] = load ptr, ptr [[VEC]], align 8, !tbaa [[TBAA0:![0-9]+]]
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr [[VEC]], i64 8
; CHECK-NEXT:    [[VEC_VAL4:%.*]] = load ptr, ptr [[TMP0]], align 8, !tbaa [[TBAA5:![0-9]+]]
; CHECK-NEXT:    [[SUB_PTR_LHS_CAST_I_I:%.*]] = ptrtoint ptr [[VEC_VAL4]] to i64
; CHECK-NEXT:    [[SUB_PTR_RHS_CAST_I_I:%.*]] = ptrtoint ptr [[VEC_VAL]] to i64
...
; CHECK-NEXT:    [[CMP_NOT11:%.*]] = icmp eq ptr [[VEC_VAL4]], [[VEC_VAL]] ;INTEL
; CHECK-NEXT:    br i1 [[CMP_NOT11]], label [[FOR_COND_CLEANUP:%.*]], label [[FOR_BODY:%.*]] ;INTEL
; CHECK:       for.cond.cleanup:
; CHECK-NEXT:    ret void
; CHECK:       for.body:
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[I_012:%.*]] = phi i64 [ [[INC:%.*]], [[FOR_BODY]] ], [ 0, [[ENTRY:%.*]] ]
; CHECK-NEXT:    [[ADD_PTR_I:%.*]] = getelementptr inbounds double, ptr [[VEC_VAL]], i64 [[I_012]]
; CHECK-NEXT:    [[TMP1:%.*]] = load double, ptr [[ADD_PTR_I]], align 8
; CHECK-NEXT:    [[ADD:%.*]] = fadd double [[TMP1]], 1.000000e+00
; end INTEL_CUSTOMIZATION
; CHECK-NEXT:    store double [[ADD]], ptr [[ADD_PTR_I]], align 8
; CHECK-NEXT:    [[INC]] = add nuw i64 [[I_012]], 1 ;INTEL
...
; CHECK-NEXT:  entry:
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[VEC_VAL:%.*]] = load ptr, ptr [[VEC]], align 8, !tbaa [[TBAA0]]
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds i8, ptr [[VEC]], i64 8
; CHECK-NEXT:    [[VEC_VAL4:%.*]] = load ptr, ptr [[TMP0]], align 8, !tbaa [[TBAA5]]
; CHECK-NEXT:    [[SUB_PTR_LHS_CAST_I_I:%.*]] = ptrtoint ptr [[VEC_VAL4]] to i64
; CHECK-NEXT:    [[SUB_PTR_RHS_CAST_I_I:%.*]] = ptrtoint ptr [[VEC_VAL]] to i64
; end INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[SUB_PTR_SUB_I_I:%.*]] = sub i64 [[SUB_PTR_LHS_CAST_I_I]], [[SUB_PTR_RHS_CAST_I_I]]
; CHECK-NEXT:    [[SUB_PTR_DIV_I_I:%.*]] = ashr exact i64 [[SUB_PTR_SUB_I_I]], 3
; CHECK-NEXT:    [[CMP11:%.*]] = icmp sgt i64 [[SUB_PTR_DIV_I_I]], 0 ;INTEL
; CHECK-NEXT:    br i1 [[CMP11]], label [[OPERATOR_ACC_EXIT:%.*]], label [[FOR_COND_CLEANUP:%.*]] ;INTEL
; CHECK:       for.cond.cleanup:
; CHECK-NEXT:    ret void
; CHECK:       operator_acc.exit:
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[I_012:%.*]] = phi i64 [ [[INC:%.*]], [[OPERATOR_ACC_EXIT]] ], [ 0, [[ENTRY:%.*]] ]
; CHECK-NEXT:    [[ADD_PTR_I:%.*]] = getelementptr inbounds double, ptr [[VEC_VAL]], i64 [[I_012]]
; CHECK-NEXT:    [[TMP1:%.*]] = load double, ptr [[ADD_PTR_I]], align 8, !tbaa [[TBAA6:![0-9]+]]
; CHECK-NEXT:    [[ADD:%.*]] = fadd double [[TMP1]], 1.000000e+00
; end INTEL_CUSTOMIZATION
; CHECK-NEXT:    store double [[ADD]], ptr [[ADD_PTR_I]], align 8, !tbaa [[TBAA6]]
; CHECK-NEXT:    [[INC]] = add nuw nsw i64 [[I_012]], 1 ;INTEL

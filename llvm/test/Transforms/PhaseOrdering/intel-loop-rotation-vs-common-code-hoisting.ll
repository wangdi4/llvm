...
; HOIST-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[I_0]], [[TMP0]]
; HOIST-NEXT:    tail call void @f0()
; HOIST-NEXT:    br i1 [[EXITCOND]], label [[FOR_COND_CLEANUP:%.*]], label [[FOR_BODY]]
...
; ROTATED_LATER_OLDPM-NEXT:    [[EXITCOND3:%.*]] = icmp eq i32 [[TMP0]], 0
; ROTATED_LATER_OLDPM-NEXT:    br i1 [[EXITCOND3]], label [[FOR_COND_CLEANUP:%.*]], label [[FOR_BODY:%.*]]
...
; ROTATED_LATER_OLDPM-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC]], [[TMP0]]
; ROTATED_LATER_OLDPM-NEXT:    br i1 [[EXITCOND]], label [[FOR_COND_CLEANUP]], label [[FOR_BODY]]
...
; ROTATED_LATER_NEWPM-NEXT:    [[EXITCOND3:%.*]] = icmp eq i32 [[TMP0]], 0
; ROTATED_LATER_NEWPM-NEXT:    br i1 [[EXITCOND3]], label [[FOR_COND_CLEANUP:%.*]], label [[FOR_COND_PREHEADER_FOR_BODY_CRIT_EDGE:%.*]]
...
; ROTATED_LATER_NEWPM-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC_PHI]], [[TMP0]]
; ROTATED_LATER_NEWPM-NEXT:    br i1 [[EXITCOND]], label [[FOR_COND_CLEANUP]], label [[FOR_BODY_FOR_BODY_CRIT_EDGE]]
...
; ROTATE_OLDPM-NEXT:    [[CMP13:%.*]] = icmp eq i32 [[WIDTH]], 1
; ROTATE_OLDPM-NEXT:    br i1 [[CMP13]], label [[FOR_COND_CLEANUP:%.*]], label [[FOR_BODY:%.*]]
...
; ROTATE_OLDPM-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC]], [[SUB]]
; ROTATE_OLDPM-NEXT:    br i1 [[EXITCOND]], label [[FOR_COND_CLEANUP]], label [[FOR_BODY]]
; ROTATE_OLDPM:       return:
...
; ROTATE_NEWPM-NEXT:    [[CMP13:%.*]] = icmp eq i32 [[WIDTH]], 1
; ROTATE_NEWPM-NEXT:    br i1 [[CMP13]], label [[FOR_COND_CLEANUP:%.*]], label [[FOR_COND_PREHEADER_FOR_BODY_CRIT_EDGE:%.*]]
; ROTATE_NEWPM:       for.cond.preheader.for.body_crit_edge:
...
; ROTATE_NEWPM-NEXT:    [[INC_PHI:%.*]] = phi i32 [ [[INC_0:%.*]], [[FOR_BODY_FOR_BODY_CRIT_EDGE:%.*]] ], [ [[INC_1]], [[FOR_COND_PREHEADER_FOR_BODY_CRIT_EDGE]] ]
; ROTATE_NEWPM-NEXT:    tail call void @f0()
; ROTATE_NEWPM-NEXT:    tail call void @f1()
; ROTATE_NEWPM-NEXT:    [[EXITCOND:%.*]] = icmp eq i32 [[INC_PHI]], [[SUB]]
; ROTATE_NEWPM-NEXT:    br i1 [[EXITCOND]], label [[FOR_COND_CLEANUP]], label [[FOR_BODY_FOR_BODY_CRIT_EDGE]]

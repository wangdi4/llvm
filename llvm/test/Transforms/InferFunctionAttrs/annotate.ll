...
; CHECK: declare i32 @abs(i32) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE:#[0-9]+]] ;INTEL
declare i32 @abs(i32)
...
; CHECK: declare double @acos(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @acos(double) readonly

; CHECK: declare float @acosf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @acosf(float)

; CHECK: declare double @acosh(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @acosh(double)

; CHECK: declare float @acoshf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @acoshf(float)

; CHECK: declare x86_fp80 @acoshl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @acoshl(x86_fp80)

; CHECK: declare x86_fp80 @acosl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @asin(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @asin(double)

; CHECK: declare float @asinf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @asinf(float)

; CHECK: declare double @asinh(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @asinh(double)

; CHECK: declare float @asinhf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @asinhf(float)

; CHECK: declare x86_fp80 @asinhl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @asinhl(x86_fp80)

; CHECK: declare x86_fp80 @asinl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @asinl(x86_fp80)

; CHECK: declare double @atan(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @atan(double)

; CHECK: declare double @atan2(double, double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @atan2(double, double)

; CHECK: declare float @atan2f(float, float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @atan2f(float, float)

; CHECK: declare x86_fp80 @atan2l(x86_fp80, x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @atan2l(x86_fp80, x86_fp80)

; CHECK: declare float @atanf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @atanf(float)

; CHECK: declare double @atanh(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @atanh(double)

; CHECK: declare float @atanhf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @atanhf(float)

; CHECK: declare x86_fp80 @atanhl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @cbrt(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @cbrt(double)

; CHECK: declare float @cbrtf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @cbrtf(float)

; CHECK: declare x86_fp80 @cbrtl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @cbrtl(x86_fp80)

; CHECK: declare double @ceil(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @ceil(double)

; CHECK: declare float @ceilf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @ceilf(float)

; CHECK: declare x86_fp80 @ceill(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @copysign(double, double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @copysign(double, double)

; CHECK: declare float @copysignf(float, float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @copysignf(float, float)

; CHECK: declare x86_fp80 @copysignl(x86_fp80, x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @copysignl(x86_fp80, x86_fp80)

; CHECK: declare double @cos(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @cos(double)

; CHECK: declare float @cosf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @cosf(float)

; CHECK: declare double @cosh(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @cosh(double)

; CHECK: declare float @coshf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @coshf(float)

; CHECK: declare x86_fp80 @coshl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @coshl(x86_fp80)

; CHECK: declare x86_fp80 @cosl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @cosl(x86_fp80)

; CHECK: declare noundef ptr @ctermid(ptr nocapture noundef) [[NOFREE_NOUNWIND]]
declare ptr @ctermid(ptr)

; CHECK: declare double @exp(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @exp(double)

; CHECK: declare double @exp2(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @exp2(double)

; CHECK: declare float @exp2f(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @exp2f(float)

; CHECK: declare x86_fp80 @exp2l(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @exp2l(x86_fp80)

; CHECK: declare float @expf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @expf(float)

; CHECK: declare x86_fp80 @expl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @expl(x86_fp80)

; CHECK: declare double @expm1(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @expm1(double)

; CHECK: declare float @expm1f(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @expm1f(float)

; CHECK: declare x86_fp80 @expm1l(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @expm1l(x86_fp80)

; CHECK: declare double @fabs(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @fabs(double)

; CHECK: declare float @fabsf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @fabsf(float)

; CHECK: declare x86_fp80 @fabsl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare i32 @ffs(i32) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare i32 @ffs(i32)

; CHECK-KNOWN: declare i32 @ffsl(i64) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
; CHECK-UNKNOWN: declare i32 @ffsl(i64){{$}}
declare i32 @ffsl(i64)

; CHECK-KNOWN: declare i32 @ffsll(i64) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @floor(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @floor(double)

; CHECK: declare float @floorf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @floorf(float)

; CHECK: declare x86_fp80 @floorl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @fmax(double, double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @fmax(double, double)

; CHECK: declare float @fmaxf(float, float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @fmaxf(float, float)

; CHECK: declare x86_fp80 @fmaxl(x86_fp80, x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @fmaxl(x86_fp80, x86_fp80)

; CHECK: declare double @fmin(double, double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @fmin(double, double)

; CHECK: declare float @fminf(float, float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @fminf(float, float)

; CHECK: declare x86_fp80 @fminl(x86_fp80, x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @fminl(x86_fp80, x86_fp80)

; CHECK: declare double @fmod(double, double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @fmod(double, double)

; CHECK: declare float @fmodf(float, float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @fmodf(float, float)

; CHECK: declare x86_fp80 @fmodl(x86_fp80, x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare i32 @isascii(i32) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare i32 @isascii(i32)

; CHECK: declare i32 @isdigit(i32) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare i32 @isdigit(i32)

; CHECK: declare i64 @labs(i64) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @ldexp(double, i32) [[NOFREE_WILLRETURN_READONLY:#[0-9]+]] ;INTEL
declare double @ldexp(double, i32)

; CHECK: declare float @ldexpf(float, i32) [[NOFREE_WILLRETURN_READONLY]] ;INTEL
declare float @ldexpf(float, i32)

; CHECK: declare x86_fp80 @ldexpl(x86_fp80, i32) [[NOFREE_WILLRETURN_READONLY]] ;INTEL
declare x86_fp80 @ldexpl(x86_fp80, i32)

; CHECK: declare i64 @llabs(i64) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare i64 @llabs(i64)

; CHECK: declare double @log(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @log(double)

; CHECK: declare double @log10(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @log10(double)

; CHECK: declare float @log10f(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @log10f(float)

; CHECK: declare x86_fp80 @log10l(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @log10l(x86_fp80)

; CHECK: declare double @log1p(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @log1p(double)

; CHECK: declare float @log1pf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @log1pf(float)

; CHECK: declare x86_fp80 @log1pl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @log1pl(x86_fp80)

; CHECK: declare double @log2(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @log2(double)

; CHECK: declare float @log2f(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @log2f(float)

; CHECK: declare x86_fp80 @log2l(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @log2l(x86_fp80)

; CHECK: declare double @logb(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @logb(double)

; CHECK: declare float @logbf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @logbf(float)

; CHECK: declare x86_fp80 @logbl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @logbl(x86_fp80)

; CHECK: declare float @logf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @logf(float)

; CHECK: declare x86_fp80 @logl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @nearbyint(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @nearbyint(double)

; CHECK: declare float @nearbyintf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @nearbyintf(float)

; CHECK: declare x86_fp80 @nearbyintl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @pow(double, double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @pow(double, double)

; CHECK: declare float @powf(float, float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @powf(float, float)

; CHECK: declare x86_fp80 @powl(x86_fp80, x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @rint(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @rint(double)

; CHECK: declare float @rintf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @rintf(float)

; CHECK: declare x86_fp80 @rintl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @round(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @round(double)

; CHECK: declare float @roundf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @roundf(float)

; CHECK: declare x86_fp80 @roundl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @sin(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @sin(double)

; CHECK: declare float @sinf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @sinf(float)

; CHECK: declare double @sinh(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @sinh(double)

; CHECK: declare float @sinhf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @sinhf(float)

; CHECK: declare x86_fp80 @sinhl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @sinhl(x86_fp80)

; CHECK: declare x86_fp80 @sinl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @sqrt(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @sqrt(double)

; CHECK: declare float @sqrtf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @sqrtf(float)

; CHECK: declare x86_fp80 @sqrtl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare double @tan(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @tan(double)

; CHECK: declare float @tanf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @tanf(float)

; CHECK: declare double @tanh(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @tanh(double)

; CHECK: declare float @tanhf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @tanhf(float)

; CHECK: declare x86_fp80 @tanhl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare x86_fp80 @tanhl(x86_fp80)

; CHECK: declare x86_fp80 @tanl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
...
; CHECK: declare i32 @toascii(i32) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare i32 @toascii(i32)

; CHECK: declare double @trunc(double) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare double @trunc(double)

; CHECK: declare float @truncf(float) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL
declare float @truncf(float)

; CHECK: declare x86_fp80 @truncl(x86_fp80) [[NOFREE_NOUNWIND_WILLRETURN_MEMNONE]] ;INTEL

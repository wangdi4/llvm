;RUN: opt -hir-ssa-deconstruction -hir-sinking-for-perfect-loopnest  -hir-loop-distribute-loopnest -print-after=hir-loop-distribute-loopnest  < %s 2>&1 | FileCheck %s
...
define dso_local void @_Z15matrix_multiplyiPdS_S_(i32 %N, double* noalias nocapture readonly %b, double* noalias nocapture readonly %c, double* noalias nocapture %a) local_unnamed_addr #0 {
entry:

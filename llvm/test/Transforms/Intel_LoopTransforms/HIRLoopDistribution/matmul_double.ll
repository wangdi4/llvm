...
;RUN: opt -hir-ssa-deconstruction -hir-loop-distribute -print-after=hir-loop-distribute -hir-loop-distribute-heuristics=nest < %s 2>&1 | FileCheck %s
...
; CHECK-DAG: {al:4}(@C)[0][i1][i2] = 0.000000e+00;
; CHECK-DAG: {al:4}(@D)[0][i1][i2] = 0.000000e+00;
; CHECK-NEXT: END LOOP
; CHECK-NEXT: END LOOP
...
@D = common global [100000 x [100000 x float]] zeroinitializer, align 16

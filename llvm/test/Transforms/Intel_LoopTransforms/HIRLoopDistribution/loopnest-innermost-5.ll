...
; Check that loop will distribute into three chunks by hir-loop-distribute-loopnest.
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %arrayidx2 = getelementptr inbounds [100 x float], [100 x float]* @q1, i64 0, i64 %indvars.iv
  ...
  store float %conv5, float* %arrayidx2, align 4

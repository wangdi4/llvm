...
;        |   @llvm.lifetime.start.p0i8(64,  &((i8*)(%out.priv.priv)[0]));
;        |
...
;        |   + END LOOP
;        |
;        |   @llvm.lifetime.end.p0i8(64,  &((i8*)(%out.priv.priv)[0]));
;        + END LOOP
;  END REGION

define void @foo(i64 %t5, i64 %t7, i32* nocapture %tmpArray.map.ptr.tmp.priv.val) {
entry:
  %out.priv.priv = alloca [16 x i32], align 16
  %t3 = bitcast [16 x i32]* %out.priv.priv to i8*
  br label %omp.inner.for.body

omp.inner.for.body:                               ; preds = %for.cond.cleanup54, %entry
  %indvars.iv38 = phi i64 [ %t5, %entry ], [ %indvars.iv.next39, %for.cond.cleanup54 ]
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %t3) #3
  br label %for.body

for.body:                                         ; preds = %for.body, %omp.inner.for.body
  %indvars.iv31 = phi i64 [ 0, %omp.inner.for.body ], [ %indvars.iv.next32, %for.body ]
  %arrayidx15 = getelementptr inbounds [16 x i32], [16 x i32]* %out.priv.priv, i64 0, i64 %indvars.iv31
...
for.body55:                                       ; preds = %for.body55, %for.cond16.preheader
  ...
  %arrayidx57 = getelementptr inbounds [16 x i32], [16 x i32]* %out.priv.priv, i64 0, i64 %indvars.iv34
  %t18 = load i32, i32* %arrayidx57, align 4
  %t19 = add i64 %indvars.iv34, %mul58
  %sext42 = shl i64 %t19, 32
  %idxprom60 = ashr exact i64 %sext42, 32
  %arrayidx61 = getelementptr inbounds i32, i32* %tmpArray.map.ptr.tmp.priv.val, i64 %idxprom60
  store i32 %t18, i32* %arrayidx61, align 4
...
for.cond.cleanup54:                               ; preds = %for.body55
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %t3) #3

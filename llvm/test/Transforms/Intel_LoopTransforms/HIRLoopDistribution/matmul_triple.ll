...
;<33>         |   |   + END LOOP
;<25>         |   |   {al:4}(@E)[0][i1][i2] = 0.000000e+00;
;<34>         |   + END LOOP
;<35>         + END LOOP
;          END REGION
...
; CHECK-DAG: {al:4}(@E)[0][i1][i2] = 0.000000e+00;
; CHECK-NEXT: END LOOP
; CHECK-NEXT: END LOOP
...
@E = common global [100000 x [100000 x float]] zeroinitializer, align 16
...
for.inc.21:                                       ; preds = %for.body.8
  %arrayidx7 = getelementptr inbounds [100000 x [100000 x float]], [100000 x [100000 x float]]* @E, i64 0, i64 %indvars.iv48, i64 %indvars.iv44

...
;<27>         |   |   |   %11 = (@t11)[0][i1 + %0 + %6 + -1][i2 + 1][i3 + sext.i32.i64(%t4)];
;<31>         |   |   |   %12 = (@t11)[0][i1 + %0 + %6 + -1][i2 + 1][i3 + sext.i32.i64((-1 + %t4))];
;<32>         |   |   |   %sub24 = %11  -  %12;
;<33>         |   |   |   %conv25 = fpext.float.double(%sub24);
;<34>         |   |   |   %mul26 = %mul  *  %conv25;
;<35>         |   |   |   %conv27 = fptrunc.double.float(%mul26);
;<37>         |   |   |   (@t15)[0][i1 + %0 + %6 + -1][i2 + 1][i3 + sext.i32.i64(%t4)] = %conv27;
;<38>         |   |   |   %t132.3 = %t4;
;<39>         |   |   |   if (%t4 > 0)
;<39>         |   |   |   {
...
;<48>         |   |   |      (@t12)[0][i1 + 1][i2 + 1][i3 + sext.i32.i64(%t4)] = %conv48;
;<49>         |   |   |      %t132.3 = i3 + %t4;
;<39>         |   |   |   }
;<83>         |   |   + END LOOP
;<62>         |   |      %t132.1111 = %t132.3;

...
bb20:                                             ; preds = %bb20, %alloca_1
  ...
  %"calc_$IND[]_fetch.76" = load i32, i32* null, align 1
  %"calc_$T110[]86" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$T110[]_fetch.79" = load i32, i32* %"calc_$T110[]86", align 4
  %"calc_$T110[]_fetch.79.fr" = freeze i32 %"calc_$T110[]_fetch.79"
  %"calc_$RR50[]90" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$RR50[]_fetch.83" = load i32, i32* %"calc_$RR50[]90", align 4
  %"calc_$PP62[]92" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$PP62[]_fetch.85" = load i32, i32* %"calc_$PP62[]92", align 4
  %mul.21 = mul nsw i32 %"calc_$PP62[]_fetch.85", %"calc_$RR50[]_fetch.83"
  %"calc_$TT46[]" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$V114[]95" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$V114[]_fetch.88" = load i32, i32* %"calc_$V114[]95", align 4
  %div.18 = sdiv i32 %mul.21, 0
  %"calc_$S142[]_fetch.100" = load i32, i32* null, align 4
  %"calc_$WW58[]107" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$WW58[]_fetch.102" = load i32, i32* %"calc_$WW58[]107", align 4
  ...
  %"calc_$E30[]" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  store i32 %div.21, i32* %"calc_$E30[]", align 4
  %div.22 = sdiv i32 0, %"calc_$T110[]_fetch.79.fr"
  %"calc_$P1[]_fetch.120" = load i32, i32* null, align 1
  %mul.24 = mul nsw i32 %"calc_$P1[]_fetch.120", %"calc_$P1[]_fetch.120"
  %mul.25 = mul nsw i32 %mul.24, %"calc_$P1[]_fetch.120"
  %"calc_$XX2[]126" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$XX2[]_fetch.128" = load i32, i32* %"calc_$XX2[]126", align 4
  %mul.27 = mul nsw i32 %"calc_$XX2[]_fetch.128", %"calc_$IND[]_fetch.76"
  store i32 %mul.27, i32* %"calc_$TT46[]", align 4
  %add.22 = fadd reassoc ninf nsz arcp contract afn float 0.000000e+00, 0.000000e+00
  %"calc_$ONE38[]132" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$ONE38[]_fetch.140" = load i32, i32* %"calc_$ONE38[]132", align 4
  %mul.30 = mul nsw i32 %"calc_$ONE38[]_fetch.140", %mul.25
  %"(float)mul.30$" = sitofp i32 %mul.30 to float
  %"calc_$DW34[]134" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$DW34[]_fetch.142" = load i32, i32* %"calc_$DW34[]134", align 4
  %mul.32 = mul nsw i32 %mul.25, 3
  %add.23 = add nsw i32 %"calc_$DW34[]_fetch.142", %mul.32
  %"calc_$TMP54[]_fetch.148" = load i32, i32* null, align 4
  %mul.34 = mul nsw i32 %div.22, %"calc_$TMP54[]_fetch.148"
  %"calc_$TG222[]149" = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 0, i32* nonnull elementtype(i32) null, i64 0)
  %"calc_$TG222[]_fetch.163" = load i32, i32* %"calc_$TG222[]149", align 4
  %"calc_$TG318[]_fetch.165" = load i32, i32* null, align 4
  ...
  store i32 %div.28, i32* null, align 4
  %"calc_$SS[]_fetch.200" = load i32, i32* null, align 1
  store i32 %"calc_$SS[]_fetch.200", i32* null, align 1

...
; Test checks that distribution does not happen on ill-formed linearized version of matrix multiplication (%a array reference).


; <0>          BEGIN REGION { }
; <43>               + DO i1 = 0, zext.i32.i64(%N) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 4294967295>
; <44>               |   + DO i2 = 0, zext.i32.i64(%N) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 4294967295>
; <8>                |   |   (%a)[zext.i32.i64(%K) * i1 + i2] = 0.000000e+00;
; <45>               |   |
...
; <22>               |   |   |   (%a)[zext.i32.i64(%K) * i1 + i2] = %add22.us.us;
; <45>               |   |   + END LOOP
; <44>               |   + END LOOP
; <43>               + END LOOP
; <0>          END REGION
...
; CHECK-NOT: DO i1 = 0, zext.i32.i64(%N) + -1, 1

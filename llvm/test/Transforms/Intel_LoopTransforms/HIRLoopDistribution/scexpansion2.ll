...
;       |   (@B9)[0][i1] = %sub63;
;       |   %sub59 = (@B8)[0][i1]  -  %conv9;
;       |   (%.TempArray144)[0][i1] = %sub59;
;       + END LOOP
;       + DO i1 = 0, 44, 1   <DO_LOOP>
;       |   %sub59 = (%.TempArray144)[0][i1];
;       |   (@B8)[0][i1] = %sub59;
;       |   %conv9 = (%.TempArray)[0][i1];
;
...
;Module Before HIR; ModuleID = 'scexpansion2.c'
source_filename = "scexpansion2.c"

...
define void @quux(i32* %arg, i32* %arg1, i32 %arg2) {
bb:
...
bb13:
  ...
  %tmp18 = getelementptr inbounds i32, i32* %arg, i64 %tmp17
  store i32 %tmp5.030, i32* %tmp18, align 4
  %tmp19 = call token @llvm.directive.region.entry() [ "DIR.PRAGMA.DISTRIBUTE_POINT"() ]
  %tmp23 = sext i32 %tmp5.030 to i64
  %tmp24 = getelementptr inbounds i32, i32* %arg1, i64 %tmp23
  store i32 %tmp5.030, i32* %tmp24, align 4

...
; CHECK:       + DO i1 = 0, (trunc.i64.i32((((-1 * ptrtoint.double*.i64(%val_ptr)) + ptrtoint.double*.i64(%val_end_of_row)) /u 8)) + -1)/u64, 1
...
define dso_local double @sub(double* noundef %val_ptr, double* noundef %val_end_of_row, double* nocapture noundef readonly %src, i32* nocapture noundef readonly %colnum_ptr) local_unnamed_addr #0 {
entry:
  %sub.ptr.lhs.cast = ptrtoint double* %val_end_of_row to i64
  %sub.ptr.rhs.cast = ptrtoint double* %val_ptr to i64
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %val_ptr.addr.013 = phi double* [ %incdec.ptr2, %for.body ], [ %val_ptr, %for.body.preheader ]
  %colnum_ptr.addr.012 = phi i32* [ %incdec.ptr, %for.body ], [ %colnum_ptr, %for.body.preheader ]
  %sum.011 = phi double [ %add, %for.body ], [ 0.000000e+00, %for.body.preheader ]
  %incdec.ptr = getelementptr inbounds i32, i32* %colnum_ptr.addr.012, i64 1
  %1 = load i32, i32* %colnum_ptr.addr.012, align 4, !tbaa !3
  %idxprom = sext i32 %1 to i64
  %arrayidx = getelementptr inbounds double, double* %src, i64 %idxprom
  %2 = load double, double* %arrayidx, align 8, !tbaa !7
  %3 = call token @llvm.directive.region.entry() [ "DIR.PRAGMA.DISTRIBUTE_POINT"() ]
  %incdec.ptr2 = getelementptr inbounds double, double* %val_ptr.addr.013, i64 1
  %4 = load double, double* %val_ptr.addr.013, align 8, !tbaa !7

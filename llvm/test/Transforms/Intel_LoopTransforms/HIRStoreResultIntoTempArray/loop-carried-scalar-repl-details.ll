...
;
;<0>          BEGIN REGION { }
;<123:36>           + DO i1 = 0, sext.i32.i64(%"jacobian_$NZ_fetch1") + -1, 1   <DO_LOOP>
;<124:35>           |   + DO i2 = 0, sext.i32.i64(%"jacobian_$NY_fetch") + -1, 1   <DO_LOOP>
;<18:17>            |   |   %mod = i2 + 3  %  %"jacobian_$NY_fetch";
;<125:34>           |   |
;<125:34>           |   |   + DO i3 = 0, sext.i32.i64(%"jacobian_$NX_fetch") + -1, 1   <DO_LOOP>
;<30:19>            |   |   |   %mod26 = i3 + 2  %  %"jacobian_$NX_fetch";
;<36:20>            |   |   |   %"jacobian_$Q[]52[][][]_fetch" = (%"jacobian_$Q")[0:i1 + 1:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:0:8(double*:5)];
;<37:20>            |   |   |   %div = (%"jacobian_$Q")[0:i1 + 1:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:1:8(double*:5)]  /  %"jacobian_$Q[]52[][][]_fetch";
;<41:21>            |   |   |   %div86 = (%"jacobian_$Q")[0:i1 + 1:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:2:8(double*:5)]  /  %"jacobian_$Q[]52[][][]_fetch";
;<43:22>            |   |   |   %mul98 = %div  *  %div;
;<44:22>            |   |   |   %mul100 = %div86  *  %div86;
;<45:22>            |   |   |   %add101 = %mul98  +  %mul100;
;<46:22>            |   |   |   %mul102 = %add101  *  2.000000e+00;
;<48:23>            |   |   |   %mul106 = %mul102  *  2.000000e+00;
;<49:23>            |   |   |   %div105 = %mul106  /  %"jacobian_$Q[]52[][][]_fetch";
;<51:24>            |   |   |   %func_result = @llvm.pow.f64(%div105,  2.500000e+00);
;<58:27>            |   |   |   %"jacobian_$Q[]144[][][]_fetch" = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][1:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][1:%mod26:40(double*:0)][0:0:8(double*:5)];
;<59:27>            |   |   |   %div152 = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][1:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][1:%mod26:40(double*:0)][0:1:8(double*:5)]  /  %"jacobian_$Q[]144[][][]_fetch";
;<63:28>            |   |   |   %div202 = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][1:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][1:%mod26:40(double*:0)][0:2:8(double*:5)]  /  %"jacobian_$Q[]144[][][]_fetch";
;<65:29>            |   |   |   %mul214 = %div152  *  %div152;
;<66:29>            |   |   |   %mul216 = %div202  *  %div202;
;<67:29>            |   |   |   %add217 = %mul214  +  %mul216;
;<68:29>            |   |   |   %mul218 = %add217  *  2.000000e+00;
;<70:30>            |   |   |   %mul230 = %mul218  *  2.000000e+00;
;<71:30>            |   |   |   %div229 = %mul230  /  %"jacobian_$Q[]144[][][]_fetch";
;<73:31>            |   |   |   %func_result242 = @llvm.pow.f64(%div229,  2.500000e+00);
;<75:33>            |   |   |   %add243 = %"jacobian_$M.0"  +  %func_result242;
;<76:33>            |   |   |   %"jacobian_$M.0" = %func_result  +  %add243;
;<125:34>           |   |   + END LOOP
;<124:35>           |   + END LOOP
;<123:36>           + END LOOP
;<0>          END REGION
...
;Function: jacobian_
;
; CHECK:   (%TempArray)[0:i1:8 * (sext.i32.i64(%"jacobian_$NX_fetch") * sext.i32.i64(%"jacobian_$NY_fetch"))(double*:0)][0:i2:8 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:8(double*:0)] = @llvm.pow.f64(%div105,  2.500000e+00);

; CHECK:    %func_result = (%TempArray)[0:i1:8 * (sext.i32.i64(%"jacobian_$NX_fetch") * sext.i32.i64(%"jacobian_$NY_fetch"))(double*:0)][0:i2:8 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:8(double*:0)];

; CHECK:    %func_result242 = (%TempArray)[0:i1 + 1:8 * (sext.i32.i64(%"jacobian_$NX_fetch") * sext.i32.i64(%"jacobian_$NY_fetch"))(double*:0)][1:%mod:8 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][1:%mod26:8(double*:0)];
;
;Module Before HIR
; ModuleID = 'j.f90'
...
bb133:                                            ; preds = %bb26
  ...
  call void @llvm.dbg.value(metadata double %add244.lcssa.lcssa.lcssa, metadata !28, metadata !DIExpression()), !dbg !30
  call void @llvm.dbg.value(metadata double %add244.lcssa.lcssa.lcssa, metadata !28, metadata !DIExpression()), !dbg !30
  %.fca.0.gep = getelementptr inbounds [4 x i8], [4 x i8]* %addressof, i64 0, i64 0, !dbg !73
  store i8 48, i8* %.fca.0.gep, align 1, !dbg !73
  %.fca.1.gep = getelementptr inbounds [4 x i8], [4 x i8]* %addressof, i64 0, i64 1, !dbg !73
  store i8 1, i8* %.fca.1.gep, align 1, !dbg !73
  %.fca.2.gep = getelementptr inbounds [4 x i8], [4 x i8]* %addressof, i64 0, i64 2, !dbg !73
  store i8 1, i8* %.fca.2.gep, align 1, !dbg !73
  %.fca.3.gep = getelementptr inbounds [4 x i8], [4 x i8]* %addressof, i64 0, i64 3, !dbg !73
  store i8 0, i8* %.fca.3.gep, align 1, !dbg !73
  %BLKFIELD_ = getelementptr inbounds { double }, { double }* %ARGBLOCK_0, i64 0, i32 0, !dbg !73
  store double %add244.lcssa.lcssa.lcssa, double* %BLKFIELD_, align 8, !dbg !73
  %ptr_cast = bitcast [8 x i64]* %"var$1" to i8*, !dbg !73
  %ptr_cast278 = bitcast { double }* %ARGBLOCK_0 to i8*, !dbg !73
  %func_result280 = call i32 (i8*, i32, i64, i8*, i8*, ...) @for_write_seq_lis(i8* nonnull %ptr_cast, i32 -1, i64 1239157112576, i8* nonnull %.fca.0.gep, i8* nonnull %ptr_cast278), !dbg !73
  br label %bb1, !dbg !74

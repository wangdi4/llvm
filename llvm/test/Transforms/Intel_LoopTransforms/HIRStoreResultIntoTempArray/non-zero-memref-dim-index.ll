...
;<139:36>           + DO i1 = 0, sext.i32.i64(%"jacobian_$NZ_fetch1") + -1, 1   <DO_LOOP>
;<140:35>           |   + DO i2 = 0, sext.i32.i64(%"jacobian_$NY_fetch") + -1, 1   <DO_LOOP>
;<33:17>            |   |   %mod = i2 + 3  %  %"jacobian_$NY_fetch";
;<141:34>           |   |
;<141:34>           |   |   + DO i3 = 0, sext.i32.i64(%"jacobian_$NX_fetch") + -1, 1   <DO_LOOP>
;<45:19>            |   |   |   %mod26 = i3 + 2  %  %"jacobian_$NX_fetch";
;<51:20>            |   |   |   %"jacobian_$Q[]52[][][]_fetch" = (%"jacobian_$Q")[1:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:0:8(double*:5)];
;<52:20>            |   |   |   %div = (%"jacobian_$Q")[1:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:1:8(double*:5)]  /  %"jacobian_$Q[]52[][][]_fetch";
;<56:21>            |   |   |   %div86 = (%"jacobian_$Q")[1:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:2:8(double*:5)]  /  %"jacobian_$Q[]52[][][]_fetch";
;<58:22>            |   |   |   %mul98 = %div  *  %div;
;<59:22>            |   |   |   %mul100 = %div86  *  %div86;
;<60:22>            |   |   |   %add101 = %mul98  +  %mul100;
;<61:22>            |   |   |   %mul102 = %add101  *  2.000000e+00;
;<63:23>            |   |   |   %mul106 = %mul102  *  2.000000e+00;
;<64:23>            |   |   |   %div105 = %mul106  /  %"jacobian_$Q[]52[][][]_fetch";
;<66:24>            |   |   |   %func_result = @llvm.pow.f64(%div105,  2.500000e+00);
;<73:27>            |   |   |   %"jacobian_$Q[]144[][][]_fetch" = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][1:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][1:%mod26:40(double*:0)][0:0:8(double*:5)];
;<74:27>            |   |   |   %div152 = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][1:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][1:%mod26:40(double*:0)][0:1:8(double*:5)]  /  %"jacobian_$Q[]144[][][]_fetch";
;<78:28>            |   |   |   %div202 = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][1:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][1:%mod26:40(double*:0)][0:2:8(double*:5)]  /  %"jacobian_$Q[]144[][][]_fetch";
;<80:29>            |   |   |   %mul214 = %div152  *  %div152;
;<81:29>            |   |   |   %mul216 = %div202  *  %div202;
;<82:29>            |   |   |   %add217 = %mul214  +  %mul216;
;<83:29>            |   |   |   %mul218 = %add217  *  2.000000e+00;
;<85:30>            |   |   |   %mul230 = %mul218  *  2.000000e+00;
;<86:30>            |   |   |   %div229 = %mul230  /  %"jacobian_$Q[]144[][][]_fetch";
;<88:31>            |   |   |   %func_result242 = @llvm.pow.f64(%div229,  2.500000e+00);
;<90:33>            |   |   |   %add243 = %"jacobian_$M.0"  +  %func_result242;
;<91:33>            |   |   |   %"jacobian_$M.0" = %func_result  +  %add243;
;<141:34>           |   |   + END LOOP
;<140:35>           |   + END LOOP
;<139:36>           + END LOOP
;<124:38>              (%addressof)[0:0:4([4 x i8]*:0)][0:0:1([4 x i8]:4)] = 48;
;<126:38>              (%addressof)[0:0:4([4 x i8]*:0)][0:1:1([4 x i8]:4)] = 1;
;<128:38>              (%addressof)[0:0:4([4 x i8]*:0)][0:2:1([4 x i8]:4)] = 1;
;<130:38>              (%addressof)[0:0:4([4 x i8]*:0)][0:3:1([4 x i8]:4)] = 0;
;<132:38>              (%ARGBLOCK_0)[0:0:8({ double }*:0)].0 = %"jacobian_$M.0";
;<135:38>              %func_result280 = @for_write_seq_lis(&((i8*)(%"var$1")[0:0:64([8 x i64]*:0)]),  -1,  1239157112576,  &((%addressof)[0:0:4([4 x i8]*:0)][0:0:1([4 x i8]:4)]),  &((i8*)(%ARGBLOCK_0)[0:0:8({ double }*:0)]));
;<139:36>
;<138:39>           ret ;
;<0>          END REGION
;
...
; CHECK:           |   |   |   %"jacobian_$Q[]52[][][]_fetch" = (%"jacobian_$Q")[1:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:0:8(double*:5)];
; CHECK:           |   |   |   %div = (%"jacobian_$Q")[1:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:1:8(double*:5)]  /  %"jacobian_$Q[]52[][][]_fetch";
; CHECK:           |   |   |   %div86 = (%"jacobian_$Q")[1:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:2:8(double*:5)]  /  %"jacobian_$Q[]52[][][]_fetch";
; CHECK:           |   |   |   %mul98 = %div  *  %div;
...
; CHECK:           |   |   |   %func_result = (%TempArray)[1:i1:8 * (sext.i32.i64(%"jacobian_$NX_fetch") * sext.i32.i64(%"jacobian_$NY_fetch"))(double*:0)][0:i2:8 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:8(double*:0)];
; CHECK:           |   |   |   %func_result242 = (%TempArray)[0:i1:8 * (sext.i32.i64(%"jacobian_$NX_fetch") * sext.i32.i64(%"jacobian_$NY_fetch"))(double*:0)][1:%mod:8 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][1:%mod26:8(double*:0)];
; CHECK:           |   |   |   %add243 = %"jacobian_$M.0"  +  %func_result242;
; CHECK:           |   |   |   %"jacobian_$M.0" = %func_result  +  %add243;
; CHECK:           |   |   + END LOOP
; CHECK:           |   + END LOOP
; CHECK:           + END LOOP
; CHECK:              (%addressof)[0:0:4([4 x i8]*:0)][0:0:1([4 x i8]:4)] = 48;
; CHECK:              (%addressof)[0:0:4([4 x i8]*:0)][0:1:1([4 x i8]:4)] = 1;
; CHECK:              (%addressof)[0:0:4([4 x i8]*:0)][0:2:1([4 x i8]:4)] = 1;
; CHECK:              (%addressof)[0:0:4([4 x i8]*:0)][0:3:1([4 x i8]:4)] = 0;
; CHECK:              (%ARGBLOCK_0)[0:0:8({ double }*:0)].0 = %"jacobian_$M.0";
; CHECK:              %func_result280 = @for_write_seq_lis(&((i8*)(%"var$1")[0:0:64([8 x i64]*:0)]),  -1,  1239157112576,  &((%addressof)[0:0:4([4 x i8]*:0)][0:0:1([4 x i8]:4)]),  &((i8*)(%ARGBLOCK_0)[0:0:8({ double }*:0)]));
;
; CHECK:           @llvm.stackrestore(&((%call)[0:0:1(i8*:0)]));
; CHECK:           ret ;
; CHECK:     END REGION
;
;Module Before HIR
...
bb21:                                             ; preds = %bb21.preheader, %bb26
  ...
  %tr = trunc i64 %indvars.iv.next355 to i32
  %sext = sext i32 %tr to i64
  %"jacobian_$Q[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul28, double* %"jacobian_$Q", i64 %sext), !dbg !19

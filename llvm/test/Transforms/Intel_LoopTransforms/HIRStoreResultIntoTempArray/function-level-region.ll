...
bb30.preheader:                                   ; preds = %bb31, %bb26.preheader
  ...
  %"jacobian_$Q[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul35, double* %"jacobian_$Q", i64 %indvars.iv.next495)
  %5 = add nuw nsw i64 %indvars.iv494, 2
  %"jacobian_$Q[]88" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul35, double* %"jacobian_$Q", i64 %5)
...
bb35.preheader:                                   ; preds = %bb36, %bb30.preheader
  ...
  %"jacobian_$Q[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]", i64 %indvars.iv490)
  %int_sext97 = zext i32 %mod to i64
  %"jacobian_$Q[]88[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]88", i64 %int_sext97)
  br label %bb35
...
bb35:                                             ; preds = %bb35.preheader, %bb35
  ...
  %"jacobian_$Q[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[][]", i64 %indvars.iv)
  %"jacobian_$Q[][][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[][][]", i64 1)
  %"jacobian_$Q[][][][]_fetch" = load double, double* %"jacobian_$Q[][][][]", align 1
  %"jacobian_$Q[]52[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[][][]", i64 2)
  %"jacobian_$Q[]52[][][]_fetch" = load double, double* %"jacobian_$Q[]52[][][]", align 1
  %div = fdiv double %"jacobian_$Q[]52[][][]_fetch", %"jacobian_$Q[][][][]_fetch"
  %"jacobian_$Q[]63[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[][][]", i64 3)
  ...
  %"jacobian_$Q[]88[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[]88[]", i64 %int_sext95)
  %"jacobian_$Q[]88[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]88[][]", i64 1)
  %"jacobian_$Q[]88[][][]_fetch" = load double, double* %"jacobian_$Q[]88[][][]", align 1
  %"jacobian_$Q[]105[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]88[][]", i64 2)
  ...
  %"jacobian_$Q[]126[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]88[][]", i64 3)
...
bb107.preheader:                                  ; preds = %bb107.preheader.preheader, %bb108
  ...
  %"jacobian_$Q[]211" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul35, double* nonnull %"jacobian_$Q", i64 %9)
  %10 = add nuw nsw i64 %indvars.iv508, 3
  %"jacobian_$Q[]284" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul35, double* nonnull %"jacobian_$Q", i64 %10)
...
bb112.preheader:                                  ; preds = %bb113, %bb107.preheader
  ...
  %"jacobian_$Q[]211[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]211", i64 %indvars.iv504)
  %int_sext293 = zext i32 %mod200 to i64
  %"jacobian_$Q[]284[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]284", i64 %int_sext293)
  br label %bb112
...
bb112:                                            ; preds = %bb112.preheader, %bb112
  ...
  %"jacobian_$Q[]211[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[]211[]", i64 %indvars.iv499)
  %"jacobian_$Q[]211[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]211[][]", i64 1)
  %"jacobian_$Q[]211[][][]_fetch" = load double, double* %"jacobian_$Q[]211[][][]", align 1
  %"jacobian_$Q[]230[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]211[][]", i64 2)
  ...
  %"jacobian_$Q[]251[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]211[][]", i64 3)
  ...
  %"jacobian_$Q[]284[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[]284[]", i64 %int_sext291)
  %"jacobian_$Q[]284[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]284[][]", i64 1)
  %"jacobian_$Q[]284[][][]_fetch" = load double, double* %"jacobian_$Q[]284[][][]", align 1
  %"jacobian_$Q[]301[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]284[][]", i64 2)
  ...
  %"jacobian_$Q[]322[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]284[][]", i64 3)

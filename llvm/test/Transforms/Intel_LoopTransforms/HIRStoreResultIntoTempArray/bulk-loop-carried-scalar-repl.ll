...
bb26.preheader:                                   ; preds = %bb26.preheader.preheader, %bb27
  ...
  %"jacobian_$Q[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul33, double* %"jacobian_$Q", i64 %indvars.iv.next498)
  %3 = add nuw nsw i64 %indvars.iv497, 2
  %"jacobian_$Q[]86" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul33, double* %"jacobian_$Q", i64 %3)
...
bb31.preheader:                                   ; preds = %bb32, %bb26.preheader
  ...
  %"jacobian_$Q[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]", i64 %indvars.iv493)
  %int_sext95 = zext i32 %mod to i64
  %"jacobian_$Q[]86[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]86", i64 %int_sext95)
  br label %bb31
...
bb31:                                             ; preds = %bb31.preheader, %bb31
  ...
  %"jacobian_$Q[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[][]", i64 %indvars.iv488)
  ...
  %"jacobian_$Q[]50[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[][][]", i64 2)
  %"jacobian_$Q[]50[][][]_fetch" = load double, double* %"jacobian_$Q[]50[][][]", align 1
  %div = fdiv double %"jacobian_$Q[]50[][][]_fetch", %"jacobian_$Q[][][][]_fetch"
  %"jacobian_$Q[]61[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[][][]", i64 3)
  ...
  %"jacobian_$Q[]86[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[]86[]", i64 %int_sext93)
  %"jacobian_$Q[]86[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]86[][]", i64 1)
  %"jacobian_$Q[]86[][][]_fetch" = load double, double* %"jacobian_$Q[]86[][][]", align 1
  %"jacobian_$Q[]103[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]86[][]", i64 2)
  ...
  %"jacobian_$Q[]124[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]86[][]", i64 3)
...
bb103.preheader:                                  ; preds = %bb103.preheader.preheader, %bb104
  ...
  %"jacobian_$Q[]209" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul33, double* nonnull %"jacobian_$Q", i64 %8)
  %9 = add nuw nsw i64 %indvars.iv482, 3
  %"jacobian_$Q[]282" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul33, double* nonnull %"jacobian_$Q", i64 %9)
...
bb108.preheader:                                  ; preds = %bb109, %bb103.preheader
  ...
  %"jacobian_$Q[]209[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]209", i64 %indvars.iv478)
  %int_sext291 = zext i32 %mod198 to i64
  %"jacobian_$Q[]282[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]282", i64 %int_sext291)
  br label %bb108
...
bb108:                                            ; preds = %bb108.preheader, %bb108
  ...
  %"jacobian_$Q[]209[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[]209[]", i64 %indvars.iv)
  %"jacobian_$Q[]209[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]209[][]", i64 1)
  %"jacobian_$Q[]209[][][]_fetch" = load double, double* %"jacobian_$Q[]209[][][]", align 1
  %"jacobian_$Q[]228[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]209[][]", i64 2)
  ...
  %"jacobian_$Q[]249[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]209[][]", i64 3)
  ...
  %"jacobian_$Q[]282[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[]282[]", i64 %int_sext289)
  %"jacobian_$Q[]282[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]282[][]", i64 1)
  %"jacobian_$Q[]282[][][]_fetch" = load double, double* %"jacobian_$Q[]282[][][]", align 1
  %"jacobian_$Q[]299[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]282[][]", i64 2)
  ...
  %"jacobian_$Q[]320[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]282[][]", i64 3)

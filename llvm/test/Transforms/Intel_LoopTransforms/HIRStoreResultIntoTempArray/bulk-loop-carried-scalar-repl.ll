...
;<183>
;<183>                 + DO i1 = 0, sext.i32.i64(%"jacobian_$NZ_fetch1") + -1, 1   <DO_LOOP>
;<184>                 |   + DO i2 = 0, sext.i32.i64(%"jacobian_$NY_fetch") + -1, 1   <DO_LOOP>
;<25>                  |   |   %mod = i2 + 2  %  %"jacobian_$NY_fetch";
;<185>                 |   |
;<185>                 |   |   + DO i3 = 0, sext.i32.i64(%"jacobian_$NX_fetch") + -1, 1   <DO_LOOP>
;<34>                  |   |   |   %mod31 = i3 + 3  %  %"jacobian_$NX_fetch";
;<37>                  |   |   |   %"jacobian_$Q[][][][]_fetch" = (%"jacobian_$Q")[i1 + 1][i2 + 1][i3 + 1][0];
;<40>                  |   |   |   %div = (%"jacobian_$Q")[i1 + 1][i2 + 1][i3 + 1][1]  /  %"jacobian_$Q[][][][]_fetch";
;<43>                  |   |   |   %div65 = (%"jacobian_$Q")[i1 + 1][i2 + 1][i3 + 1][2]  /  %"jacobian_$Q[][][][]_fetch";
;<44>                  |   |   |   %mul77 = %div  *  %div;
;<45>                  |   |   |   %mul79 = %div65  *  %div65;
;<46>                  |   |   |   %add80 = %mul77  +  %mul79;
;<47>                  |   |   |   %mul81 = %add80  *  2.000000e+00;
;<48>                  |   |   |   %div83 = %mul81  /  %"jacobian_$Q[][][][]_fetch";
;<49>                  |   |   |   %func_result = @llvm.pow.f64(%div83,  2.500000e+00);
;<53>                  |   |   |   %"jacobian_$Q[]86[][][]_fetch" = (%"jacobian_$Q")[i1 + 2][%mod][%mod31][0];
;<56>                  |   |   |   %div111 = (%"jacobian_$Q")[i1 + 2][%mod][%mod31][1]  /  %"jacobian_$Q[]86[][][]_fetch";
;<59>                  |   |   |   %div134 = (%"jacobian_$Q")[i1 + 2][%mod][%mod31][2]  /  %"jacobian_$Q[]86[][][]_fetch";
;<60>                  |   |   |   %mul148 = %div111  *  %div111;
;<61>                  |   |   |   %mul150 = %div134  *  %div134;
;<62>                  |   |   |   %add151 = %mul148  +  %mul150;
;<63>                  |   |   |   %mul152 = %add151  *  2.000000e+00;
;<64>                  |   |   |   %div154 = %mul152  /  %"jacobian_$Q[]86[][][]_fetch";
;<65>                  |   |   |   %func_result146 = @llvm.pow.f64(%div154,  2.500000e+00);
;<66>                  |   |   |   %add155 = %"jacobian_$M.0"  +  %func_result;
;<67>                  |   |   |   %"jacobian_$M.0" = %add155  +  %func_result146;
;<185>                 |   |   + END LOOP
;<184>                 |   + END LOOP
;<183>                 + END LOOP
;<183>
;<91>                  %"jacobian_$M.6" = %"jacobian_$M.0";
;<186>
;<186>                 + DO i1 = 0, sext.i32.i64(%"jacobian_$NZ_fetch1") + 1, 1   <DO_LOOP>
;<187>                 |   + DO i2 = 0, sext.i32.i64(%"jacobian_$NY_fetch") + -1, 1   <DO_LOOP>
;<103>                 |   |   %mod198 = i2 + 2  %  %"jacobian_$NY_fetch";
;<188>                 |   |
;<188>                 |   |   + DO i3 = 0, sext.i32.i64(%"jacobian_$NX_fetch") + -1, 1   <DO_LOOP>
;<112>                 |   |   |   %mod206 = i3 + 3  %  %"jacobian_$NX_fetch";
;<115>                 |   |   |   %"jacobian_$Q[]209[][][]_fetch" = (%"jacobian_$Q")[i1 + 2][i2 + 1][i3 + 1][0];
;<118>                 |   |   |   %div236 = (%"jacobian_$Q")[i1 + 2][i2 + 1][i3 + 1][1]  /  %"jacobian_$Q[]209[][][]_fetch";
;<121>                 |   |   |   %div259 = (%"jacobian_$Q")[i1 + 2][i2 + 1][i3 + 1][2]  /  %"jacobian_$Q[]209[][][]_fetch";
;<122>                 |   |   |   %mul273 = %div236  *  %div236;
;<123>                 |   |   |   %mul275 = %div259  *  %div259;
;<124>                 |   |   |   %add276 = %mul273  +  %mul275;
;<125>                 |   |   |   %mul277 = %add276  *  2.000000e+00;
;<126>                 |   |   |   %div279 = %mul277  /  %"jacobian_$Q[]209[][][]_fetch";
;<127>                 |   |   |   %func_result271 = @llvm.pow.f64(%div279,  2.500000e+00);
;<131>                 |   |   |   %"jacobian_$Q[]282[][][]_fetch" = (%"jacobian_$Q")[i1 + 3][%mod198][%mod206][0];
;<134>                 |   |   |   %div307 = (%"jacobian_$Q")[i1 + 3][%mod198][%mod206][1]  /  %"jacobian_$Q[]282[][][]_fetch";
;<137>                 |   |   |   %div330 = (%"jacobian_$Q")[i1 + 3][%mod198][%mod206][2]  /  %"jacobian_$Q[]282[][][]_fetch";
;<138>                 |   |   |   %mul344 = %div307  *  %div307;
;<139>                 |   |   |   %mul346 = %div330  *  %div330;
;<140>                 |   |   |   %add347 = %mul344  +  %mul346;
;<141>                 |   |   |   %mul348 = %add347  *  2.000000e+00;
;<142>                 |   |   |   %div350 = %mul348  /  %"jacobian_$Q[]282[][][]_fetch";
;<143>                 |   |   |   %func_result342 = @llvm.pow.f64(%div350,  2.500000e+00);
;<144>                 |   |   |   %add352 = %"jacobian_$M.6"  +  %func_result271;
;<145>                 |   |   |   %"jacobian_$M.6" = %add352  +  %func_result342;
;<188>                 |   |   + END LOOP
;<187>                 |   + END LOOP
;<186>                 + END LOOP
;<186>
...
;<172>                 (%"(&)val$")[0][2] = 1;
;<174>                 (%"(&)val$")[0][3] = 0;
;<176>                 (%argblock)[0].0 = %"jacobian_$M.6";
;<179>                 %func_result385 = @for_write_seq_lis(&((i8*)(%"var$1")[0]),  -1,  1239157112576,  &((%"(&)val$")[0][0]),  &((i8*)(%argblock)[0]));
;<2>                }
;<182>              ret ;
;<0>          END REGION
;
...
; CHECK:              (%"(&)val$")[0][2] = 1;
; CHECK:              (%"(&)val$")[0][3] = 0;
; CHECK:              (%argblock)[0].0 = %"jacobian_$M.6";
; CHECK:              %func_result385 = @for_write_seq_lis(&((i8*)(%"var$1")[0]),  -1,  1239157112576,  &((%"(&)val$")[0][0]),  &((i8*)(%argblock)[0]));
; CHECK:           ret ;
; CHECK:     END REGION
;
; Module Before HIR
...
define void @jacobian_(double* noalias nocapture readonly %"jacobian_$Q", i32* noalias nocapture readonly %"jacobian_$NX", i32* noalias nocapture readonly %"jacobian_$NY", i32* noalias nocapture readonly %"jacobian_$NZ") local_unnamed_addr #0 {
alloca_0:
...
bb26.preheader:                                   ; preds = %bb26.preheader.preheader, %bb27
  ...
  %"jacobian_$Q[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul33, double* elementtype(double) %"jacobian_$Q", i64 %indvars.iv.next498)
  %3 = add nuw nsw i64 %indvars.iv497, 2
  %"jacobian_$Q[]86" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul33, double* elementtype(double) %"jacobian_$Q", i64 %3)
...
bb31.preheader:                                   ; preds = %bb32, %bb26.preheader
  ...
  %"jacobian_$Q[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* elementtype(double) %"jacobian_$Q[]", i64 %indvars.iv493)
  %int_sext95 = zext i32 %mod to i64
  %"jacobian_$Q[]86[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* elementtype(double) %"jacobian_$Q[]86", i64 %int_sext95)
  br label %bb31
...
bb31:                                             ; preds = %bb31.preheader, %bb31
  ...
  %"jacobian_$Q[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* elementtype(double) %"jacobian_$Q[][]", i64 %indvars.iv488)
  ...
  %"jacobian_$Q[]50[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[][][]", i64 2)
  %"jacobian_$Q[]50[][][]_fetch" = load double, double* %"jacobian_$Q[]50[][][]", align 1
  %div = fdiv double %"jacobian_$Q[]50[][][]_fetch", %"jacobian_$Q[][][][]_fetch"
  %"jacobian_$Q[]61[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[][][]", i64 3)
  %"jacobian_$Q[]61[][][]_fetch" = load double, double* %"jacobian_$Q[]61[][][]", align 1
  ...
  %"jacobian_$Q[]86[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* elementtype(double) %"jacobian_$Q[]86[]", i64 %int_sext93)
  %"jacobian_$Q[]86[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]86[][]", i64 1)
  %"jacobian_$Q[]86[][][]_fetch" = load double, double* %"jacobian_$Q[]86[][][]", align 1
  %"jacobian_$Q[]103[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]86[][]", i64 2)
  %"jacobian_$Q[]103[][][]_fetch" = load double, double* %"jacobian_$Q[]103[][][]", align 1
  %div111 = fdiv double %"jacobian_$Q[]103[][][]_fetch", %"jacobian_$Q[]86[][][]_fetch"
  %"jacobian_$Q[]124[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]86[][]", i64 3)
  %"jacobian_$Q[]124[][][]_fetch" = load double, double* %"jacobian_$Q[]124[][][]", align 1
...
bb103.preheader:                                  ; preds = %bb103.preheader.preheader, %bb104
  ...
  %"jacobian_$Q[]209" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul33, double* elementtype(double) nonnull %"jacobian_$Q", i64 %8)
  %9 = add nuw nsw i64 %indvars.iv482, 3
  %"jacobian_$Q[]282" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul33, double* elementtype(double) nonnull %"jacobian_$Q", i64 %9)
...
bb108.preheader:                                  ; preds = %bb109, %bb103.preheader
  ...
  %"jacobian_$Q[]209[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* elementtype(double) %"jacobian_$Q[]209", i64 %indvars.iv478)
  %int_sext291 = zext i32 %mod198 to i64
  %"jacobian_$Q[]282[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* elementtype(double) %"jacobian_$Q[]282", i64 %int_sext291)
  br label %bb108
...
bb108:                                            ; preds = %bb108.preheader, %bb108
  ...
  %"jacobian_$Q[]209[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* elementtype(double) %"jacobian_$Q[]209[]", i64 %indvars.iv)
  %"jacobian_$Q[]209[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]209[][]", i64 1)
  %"jacobian_$Q[]209[][][]_fetch" = load double, double* %"jacobian_$Q[]209[][][]", align 1
  %"jacobian_$Q[]228[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]209[][]", i64 2)
  %"jacobian_$Q[]228[][][]_fetch" = load double, double* %"jacobian_$Q[]228[][][]", align 1
  %div236 = fdiv double %"jacobian_$Q[]228[][][]_fetch", %"jacobian_$Q[]209[][][]_fetch"
  %"jacobian_$Q[]249[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]209[][]", i64 3)
  %"jacobian_$Q[]249[][][]_fetch" = load double, double* %"jacobian_$Q[]249[][][]", align 1
  ...
  %"jacobian_$Q[]282[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* elementtype(double) %"jacobian_$Q[]282[]", i64 %int_sext289)
  %"jacobian_$Q[]282[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]282[][]", i64 1)
  %"jacobian_$Q[]282[][][]_fetch" = load double, double* %"jacobian_$Q[]282[][][]", align 1
  %"jacobian_$Q[]299[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]282[][]", i64 2)
  %"jacobian_$Q[]299[][][]_fetch" = load double, double* %"jacobian_$Q[]299[][][]", align 1
  %div307 = fdiv double %"jacobian_$Q[]299[][][]_fetch", %"jacobian_$Q[]282[][][]_fetch"
  %"jacobian_$Q[]320[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* elementtype(double) %"jacobian_$Q[]282[][]", i64 3)
  %"jacobian_$Q[]320[][][]_fetch" = load double, double* %"jacobian_$Q[]320[][][]", align 1
...
bb100:                                            ; preds = %bb104
  ...
  store double %add353.lcssa.lcssa.lcssa, double* %BLKFIELD_, align 8
  %"(i8*)var$1" = bitcast [8 x i64]* %"var$1" to i8*
  %"(i8*)argblock" = bitcast { double }* %argblock to i8*
  %func_result385 = call i32 (i8*, i32, i64, i8*, i8*, ...) @for_write_seq_lis(i8* nonnull %"(i8*)var$1", i32 -1, i64 1239157112576, i8* nonnull %.fca.0.gep, i8* nonnull %"(i8*)argblock") #4
  br label %end_label1

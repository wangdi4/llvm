...
;
; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -disable-hir-store-result-into-temp-array=false -hir-store-result-into-temp-array -print-after=hir-store-result-into-temp-array < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-store-result-into-temp-array,print<hir>" -disable-hir-store-result-into-temp-array=false 2>&1 < %s | FileCheck %s
;
; *** IR Dump After HIR Store Result Into Temp Array ***
;Function: jacobian_
;
;<0>          BEGIN REGION { }
;<125:36>           + DO i1 = 0, sext.i32.i64(%"jacobian_$NZ_fetch1") + -1, 1   <DO_LOOP>
;<126:35>           |   + DO i2 = 0, sext.i32.i64(%"jacobian_$NY_fetch") + -1, 1   <DO_LOOP>
;<17>               |   |   %sext = sext.i32.i64(i2 + 1);
;<19:17>            |   |   %mod = i2 + 3  %  %"jacobian_$NY_fetch" + 1;
;<127:34>           |   |
;<127:34>           |   |   + DO i3 = 0, sext.i32.i64(%"jacobian_$NX_fetch") + -1, 1   <DO_LOOP>
;<31:19>            |   |   |   %mod27 = i3 + 2  %  %"jacobian_$NX_fetch";
;<37:20>            |   |   |   %"jacobian_$Q[]53[][][]_fetch" = (%"jacobian_$Q")[0:i1 + 1:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:0:8(double*:5)];
;<38:20>            |   |   |   %div = (%"jacobian_$Q")[0:i1 + 1:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:1:8(double*:5)]  /  %"jacobian_$Q[]53[][][]_fetch";
;<42:21>            |   |   |   %div87 = (%"jacobian_$Q")[0:i1 + 1:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][0:i2:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:i3:40(double*:0)][0:2:8(double*:5)]  /  %"jacobian_$Q[]53[][][]_fetch";
;<44:22>            |   |   |   %mul99 = %div  *  %div;
;<45:22>            |   |   |   %mul101 = %div87  *  %div87;
;<46:22>            |   |   |   %add102 = %mul99  +  %mul101;
;<47:22>            |   |   |   %mul103 = %add102  *  2.000000e+00;
;<49:23>            |   |   |   %mul107 = %mul103  *  2.000000e+00;
;<50:23>            |   |   |   %div106 = %mul107  /  %"jacobian_$Q[]53[][][]_fetch";
;<52:24>            |   |   |   %func_result = @llvm.pow.f64(%div106,  2.500000e+00);
;<60:27>            |   |   |   %"jacobian_$Q[]147[][][]_fetch" = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][%sext:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:zext.i32.i64(%mod27):40(double*:0)][0:0:8(double*:5)];
;<61:27>            |   |   |   %div155 = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][%sext:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:zext.i32.i64(%mod27):40(double*:0)][0:1:8(double*:5)]  /  %"jacobian_$Q[]147[][][]_fetch";
;<65:28>            |   |   |   %div208 = (%"jacobian_$Q")[0:i1 + 2:40 * (sext.i32.i64(%"jacobian_$NY_fetch") * sext.i32.i64(%"jacobian_$NX_fetch"))(double*:0)][%sext:%mod:40 * sext.i32.i64(%"jacobian_$NX_fetch")(double*:0)][0:zext.i32.i64(%mod27):40(double*:0)][0:2:8(double*:5)]  /  %"jacobian_$Q[]147[][][]_fetch";
;<67:29>            |   |   |   %mul221 = %div155  *  %div155;
;<68:29>            |   |   |   %mul223 = %div208  *  %div208;
;<69:29>            |   |   |   %add224 = %mul221  +  %mul223;
;<70:29>            |   |   |   %mul225 = %add224  *  2.000000e+00;
;<72:30>            |   |   |   %mul237 = %mul225  *  2.000000e+00;
;<73:30>            |   |   |   %div236 = %mul237  /  %"jacobian_$Q[]147[][][]_fetch";
;<75:31>            |   |   |   %func_result250 = @llvm.pow.f64(%div236,  2.500000e+00);
;<77:33>            |   |   |   %add251 = %"jacobian_$M.0"  +  %func_result250;
;<78:33>            |   |   |   %"jacobian_$M.0" = %func_result  +  %add251;
;<127:34>           |   |   + END LOOP
;<126:35>           |   + END LOOP
;<125:36>           + END LOOP
;<0>          END REGION
...
define void @jacobian_(double* noalias nocapture readonly %"jacobian_$Q", i32* noalias nocapture readonly %"jacobian_$NX", i32* noalias nocapture readonly %"jacobian_$NY", i32* noalias nocapture readonly %"jacobian_$NZ") local_unnamed_addr #0 !dbg !5 {
alloca_0:
  %"var$1" = alloca [8 x i64], align 16
  %addressof = alloca [4 x i8], align 1, !dbg !8
  %ARGBLOCK_0 = alloca { double }, align 8, !dbg !8
  call void @llvm.dbg.declare(metadata double* %"jacobian_$Q", metadata !9, metadata !DIExpression()), !dbg !8
  call void @llvm.dbg.declare(metadata i32* %"jacobian_$NX", metadata !11, metadata !DIExpression()), !dbg !13
  call void @llvm.dbg.declare(metadata i32* %"jacobian_$NY", metadata !14, metadata !DIExpression()), !dbg !15
  call void @llvm.dbg.declare(metadata i32* %"jacobian_$NZ", metadata !16, metadata !DIExpression()), !dbg !17
  %"jacobian_$NX_fetch" = load i32, i32* %"jacobian_$NX", align 1, !dbg !18
  %"jacobian_$NY_fetch" = load i32, i32* %"jacobian_$NY", align 1, !dbg !18
  ...
  %"jacobian_$NZ_fetch1" = load i32, i32* %"jacobian_$NZ", align 1, !dbg !20
...
bb21:                                             ; preds = %bb21.preheader, %bb26
  ...
  %"jacobian_$Q[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul29, double* %"jacobian_$Q", i64 %indvars.iv.next363), !dbg !19
  %2 = add nuw nsw i64 %indvars.iv362, 2, !dbg !34
  %"jacobian_$Q[]120" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 3, i64 1, i64 %mul29, double* %"jacobian_$Q", i64 %2), !dbg !34
...
bb30.preheader:                                   ; preds = %bb31, %bb21
  ...
  %"jacobian_$Q[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* %"jacobian_$Q[]", i64 %indvars.iv357), !dbg !19
  %int_sext161 = zext i32 %mod to i64, !dbg !34
  %"jacobian_$Q[]120[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 %sext, i64 %mul, double* %"jacobian_$Q[]120", i64 %int_sext161), !dbg !34
...
bb30:                                             ; preds = %bb30.preheader, %bb30
  ...
  %"jacobian_$Q[]53[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[][][]", i64 1), !dbg !19
  %"jacobian_$Q[]53[][][]_fetch" = load double, double* %"jacobian_$Q[]53[][][]", align 1, !dbg !19
  ...
  %"jacobian_$Q[]64[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[][][]", i64 3), !dbg !44
  %"jacobian_$Q[]64[][][]_fetch" = load double, double* %"jacobian_$Q[]64[][][]", align 1, !dbg !44
  ...
  %"jacobian_$Q[]120[][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 1, i64 40, double* %"jacobian_$Q[]120[]", i64 %int_sext158), !dbg !34
  %"jacobian_$Q[]120[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]120[][]", i64 2), !dbg !34
  %"jacobian_$Q[]120[][][]_fetch" = load double, double* %"jacobian_$Q[]120[][][]", align 1, !dbg !34
  %"jacobian_$Q[]147[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]120[][]", i64 1), !dbg !34
  %"jacobian_$Q[]147[][][]_fetch" = load double, double* %"jacobian_$Q[]147[][][]", align 1, !dbg !34
  ...
  %"jacobian_$Q[]169[][][]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"jacobian_$Q[]120[][]", i64 3), !dbg !59
  %"jacobian_$Q[]169[][][]_fetch" = load double, double* %"jacobian_$Q[]169[][][]", align 1, !dbg !59
...
bb133:                                            ; preds = %bb26
  ...
  call void @llvm.dbg.value(metadata double %add252.lcssa.lcssa.lcssa, metadata !29, metadata !DIExpression()), !dbg !31
  call void @llvm.dbg.value(metadata double %add252.lcssa.lcssa.lcssa, metadata !29, metadata !DIExpression()), !dbg !31
  %.fca.0.gep = getelementptr inbounds [4 x i8], [4 x i8]* %addressof, i64 0, i64 0, !dbg !74
  store i8 48, i8* %.fca.0.gep, align 1, !dbg !74
  %.fca.1.gep = getelementptr inbounds [4 x i8], [4 x i8]* %addressof, i64 0, i64 1, !dbg !74
  store i8 1, i8* %.fca.1.gep, align 1, !dbg !74
  %.fca.2.gep = getelementptr inbounds [4 x i8], [4 x i8]* %addressof, i64 0, i64 2, !dbg !74
  store i8 1, i8* %.fca.2.gep, align 1, !dbg !74
  %.fca.3.gep = getelementptr inbounds [4 x i8], [4 x i8]* %addressof, i64 0, i64 3, !dbg !74
  store i8 0, i8* %.fca.3.gep, align 1, !dbg !74
  %BLKFIELD_ = getelementptr inbounds { double }, { double }* %ARGBLOCK_0, i64 0, i32 0, !dbg !74
  store double %add252.lcssa.lcssa.lcssa, double* %BLKFIELD_, align 8, !dbg !74
  %ptr_cast = bitcast [8 x i64]* %"var$1" to i8*, !dbg !74
  %ptr_cast286 = bitcast { double }* %ARGBLOCK_0 to i8*, !dbg !74
  %func_result288 = call i32 (i8*, i32, i64, i8*, i8*, ...) @for_write_seq_lis(i8* nonnull %ptr_cast, i32 -1, i64 1239157112576, i8* nonnull %.fca.0.gep, i8* nonnull %ptr_cast286), !dbg !74
  br label %bb1, !dbg !75

...
bb30.preheader:                                   ; preds = %bb31, %bb21
  ...
  %"jacobian_$Q[]120[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %mul, double* elementtype(double) %"jacobian_$Q[]120", i64 %int_sext161), !dbg !34

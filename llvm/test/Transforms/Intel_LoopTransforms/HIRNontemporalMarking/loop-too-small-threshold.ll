...
; Do not convert for loops that are too small.

; Before:
; <0>          BEGIN REGION { }
; <10>               + DO i64 i1 = 0, 640, 1   <DO_LOOP>
; <4>                |   (%dest)[i1] = i1;
; <10>               + END LOOP
; <0>          END REGION
...
; CHECK-NEXT:       + DO i64 i1 = 0, 640, 1   <DO_LOOP>
; CHECK-NEXT:       |   (%dest)[i1] = i1;
; CHECK-NEXT:       |   <LVAL-REG> {al:8}(LINEAR ptr %dest)[LINEAR i64 i1] inbounds  {sb:8}

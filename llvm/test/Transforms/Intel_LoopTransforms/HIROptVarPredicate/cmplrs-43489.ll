...
%struct.ModifierData = type { ptr }
%struct.ParticleSystem = type { ptr, i32, i32, ptr }
%struct.ParticleSettings = type opaque
%struct.ParticleCacheKey = type { i32 }
%struct.MEdge = type { i32, i32, i8, i8, i16 }

; Function Attrs: norecurse nounwind uwtable
define i32 @aaaa(ptr nocapture readonly %md) local_unnamed_addr #0 {
entry:
  %psys1 = getelementptr inbounds %struct.ModifierData, ptr %md, i64 0, i32 0
  %0 = load ptr, ptr %psys1, align 8
  %totcached = getelementptr inbounds %struct.ParticleSystem, ptr %0, i64 0, i32 1
  %1 = load i32, ptr %totcached, align 8
  %pathcache = getelementptr inbounds %struct.ParticleSystem, ptr %0, i64 0, i32 3
  %2 = load ptr, ptr %pathcache, align 8
...
for.body:                                         ; preds = %for.body.preheader, %for.inc9
  ...
  %medge.049 = phi ptr [ %medge.1.lcssa, %for.inc9 ], [ undef, %for.body.preheader ]
  %arrayidx = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv
  %3 = load ptr, ptr %arrayidx, align 8
  %steps = getelementptr inbounds %struct.ParticleCacheKey, ptr %3, i64 0, i32 0
...
for.body5:                                        ; preds = %for.inc, %for.body5.preheader
  ...
  %medge.142 = phi ptr [ %medge.2, %for.inc ], [ %medge.049, %for.body5.preheader ]
...
if.then:                                          ; preds = %for.body5
  ...
  %v1 = getelementptr inbounds %struct.MEdge, ptr %medge.142, i64 0, i32 0
  store i32 %sub, ptr %v1, align 4
  %v2 = getelementptr inbounds %struct.MEdge, ptr %medge.142, i64 0, i32 1
  store i32 %cvert.144, ptr %v2, align 4
  %flag = getelementptr inbounds %struct.MEdge, ptr %medge.142, i64 0, i32 4
  store i16 162, ptr %flag, align 2
  %incdec.ptr = getelementptr inbounds %struct.MEdge, ptr %medge.142, i64 1
  br label %for.inc

for.inc:                                          ; preds = %for.body5, %if.then
  %medge.2 = phi ptr [ %incdec.ptr, %if.then ], [ %medge.142, %for.body5 ]
...
for.inc9.loopexit:                                ; preds = %for.inc
  %medge.2.lcssa = phi ptr [ %medge.2, %for.inc ]
  br label %for.inc9

for.inc9:                                         ; preds = %for.inc9.loopexit, %for.body
  %medge.1.lcssa = phi ptr [ %medge.049, %for.body ], [ %medge.2.lcssa, %for.inc9.loopexit ]

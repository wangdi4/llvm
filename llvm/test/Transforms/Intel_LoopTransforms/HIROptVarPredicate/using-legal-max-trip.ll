...
define dso_local void @foo(ptr nocapture writeonly %p, ptr nocapture writeonly %q, i16 signext %n, i16 signext %d) local_unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %for.body
  ...
  store i32 %j.017, ptr %arrayidx, align 4, !tbaa !3
  br label %for.inc

if.else:                                          ; preds = %for.body
  %idxprom7 = zext i32 %j.017 to i64
  %arrayidx8 = getelementptr inbounds i32, ptr %q, i64 %idxprom7
  store i32 %j.017, ptr %arrayidx8, align 4, !tbaa !3
  br label %for.inc

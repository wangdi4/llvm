...
; Test checks that Opt Var Predicate can handle non-constant RHS in presence of constant in LHS of EQ condition.
...
; CHECK:           + DO i1 = 0, smin((-2 + zext.i32.i64(%n)), (-2 + sext.i32.i64(%m))), 1   <DO_LOOP>  <MAX_TC_EST = 99>  <LEGAL_MAX_TC = 2147483646>
; CHECK:           |   %1 = (@B)[0][i1 + 1];
; CHECK:           |   (@A)[0][i1 + 1] = %1 + 1;
; CHECK:           + END LOOP
;    
; CHECK:           if (smax(0, (-1 + sext.i32.i64(%m))) < smin((-2 + zext.i32.i64(%n)), (-1 + sext.i32.i64(%m))) + 1)
; CHECK:           {
; CHECK:              %1 = (@B)[0][smax(0, (-1 + sext.i32.i64(%m))) + 1];
; CHECK:              (@A)[0][smax(0, (-1 + sext.i32.i64(%m))) + 1] = %1 + 1;
; CHECK:              (@C)[0][smax(0, (-1 + sext.i32.i64(%m))) + 1] = %1 + -1;
; CHECK:           }
;    

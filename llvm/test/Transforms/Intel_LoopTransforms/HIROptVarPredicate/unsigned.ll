...
; Test checks that OptVarPredicate pass is able to hoist out 'if'
; with unsigned predicate if both sides of it are non-negative.
...
; CHECK:           + DO i1 = 0, zext.i32.i64(%M) + -7, 1   <DO_LOOP>  <MAX_TC_EST = 4294967294>  <LEGAL_MAX_TC = 4294967294>
; CHECK:           |   (%A)[i1 + 6] = i1 + 6;
; CHECK:           + END LOOP
; CHECK:     END REGION

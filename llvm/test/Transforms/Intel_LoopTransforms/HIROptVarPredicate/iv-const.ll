...
if.else:                                          ; preds = %for.body
  %arrayidx3 = getelementptr inbounds i32, ptr %q, i64 %j.015
  store i32 %conv, ptr %arrayidx3, align 4
  br label %if.end

if.end:                                           ; preds = %for.body, %if.else
  %arrayidx5.sink = getelementptr inbounds i32, ptr %p, i64 %j.015
  store i32 %conv, ptr %arrayidx5.sink, align 4

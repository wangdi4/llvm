...
; the hoist and sink variables into one variable for the i32 casting, but
; not for the double casting.
...
;       |   {
;       |      %Ai32.then = (i32*)(%A)[i1];
;       |      (double*)(%A)[i1] = 1.000000e+00;
;       |      (i32*)(%A)[i1] = %Ai32.then;
;       |   }
;       |   else
;       |   {
;       |      %Ai32.else = (i32*)(%A)[i1];
;       |      (double*)(%A)[i1] = 2.000000e+00;
;       |      (i32*)(%A)[i1] = %Ai32.else;
;       |   }
;       + END LOOP
; END REGION
...
; CHECK:       |      (double*)(%A)[i1] = 1.000000e+00;
; CHECK:       |      %cldst.motioned = %Ai32.then;
; CHECK:       |   }
; CHECK:       |   else
; CHECK:       |   {
; CHECK:       |      %Ai32.else = %cldst.motioned;
; CHECK:       |      (double*)(%A)[i1] = 2.000000e+00;

...
define double @nestedind([64 x double]* %A, double %what, i1 %which) {
...
then:
  ...
  %stptr.then = getelementptr inbounds [64 x double], [64 x double]* %A, i64 %i.next, i64 %j
  ...
  %stptr.else = getelementptr inbounds [64 x double], [64 x double]* %A, i64 %i.next, i64 %j

...
; transformation works even if the inner then branch doesn't have a reference
; to %a[i]. It was created from the following example in C++:

; TODO: There is a chance to improve the hoist in the inner else branch.
...
if.else10:                                        ; preds = %if.else
  ...
  %5 = load i32, ptr %arrayidx9
  %add12 = add nsw i32 %add8 , %5

...
; %a[i] because there is reference in the inner else, but not in the inner
; then branch. This will produce that the result for the inner condition is
; conditional, and the transformation can't be applied. It was created from

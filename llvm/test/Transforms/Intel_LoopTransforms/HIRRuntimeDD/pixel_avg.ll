...
; CHECK: %mv.test = &((%src1)[sext.i32.i64(%i_width) + (sext.i32.i64((-1 + %i_height)) * smax(0, sext.i32.i64(%i_src1_stride))) + -1]) >=u &((%dst)[(sext.i32.i64((-1 + %i_height)) * (-1 + (-1 * smax(-1, (-1 + (-1 * sext.i32.i64(%i_dst_stride)))))))]);
; CHECK: %mv.test2 = &((%dst)[sext.i32.i64(%i_width) + (sext.i32.i64((-1 + %i_height)) * smax(0, sext.i32.i64(%i_dst_stride))) + -1]) >=u &((%src1)[(sext.i32.i64((-1 + %i_height)) * (-1 + (-1 * smax(-1, (-1 + (-1 * sext.i32.i64(%i_src1_stride)))))))]);
; CHECK: %mv.and = %mv.test  &&  %mv.test2;
; CHECK: %mv.test3 = &((%dst)[sext.i32.i64(%i_width) + (sext.i32.i64((-1 + %i_height)) * smax(0, sext.i32.i64(%i_dst_stride))) + -1]) >=u &((%src2)[(sext.i32.i64((-1 + %i_height)) * (-1 + (-1 * smax(-1, (-1 + (-1 * sext.i32.i64(%i_src2_stride)))))))]);
; CHECK: %mv.test4 = &((%src2)[sext.i32.i64(%i_width) + (sext.i32.i64((-1 + %i_height)) * smax(0, sext.i32.i64(%i_src2_stride))) + -1]) >=u &((%dst)[(sext.i32.i64((-1 + %i_height)) * (-1 + (-1 * smax(-1, (-1 + (-1 * sext.i32.i64(%i_dst_stride)))))))]);

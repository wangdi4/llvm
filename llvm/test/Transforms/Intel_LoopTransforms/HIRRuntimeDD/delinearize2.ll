...
; BEGIN REGION { }
;       + DO i1 = 0, %TC1, 1   <DO_LOOP>
;       |   + DO i2 = 0, %TC2, 1   <DO_LOOP>
;       |   |   + DO i3 = 0, %TC3, 1   <DO_LOOP>
...
; CHECK: %mv.test = &((%q)[%TC3]) >=u &((%p)[0][0][0]);
; CHECK: %mv.test3 = &((%p)[%TC1][%TC2 + 1][%TC3]) >=u &((%q)[0]);
...
define void @foo(i32* nocapture %p, i32* nocapture readonly %q, i64 %d2, i64 %d1, i64 %TC1, i64 %TC2, i64 %TC3) {
entry:
  %mul = mul i64 %d1, %d2

...
; accessed contiguously in the loop, even if the accesses in the HIR aren't
; in order (+3 happens before +2).
...
; CHECK:           |   %10 = (%B)[i1 + 3];
; CHECK:           |   (%A)[4 * i1 + sext.i32.i64(%t) + 2] = %10;
; CHECK:           + END LOOP
; CHECK:        }
; CHECK:        else
; CHECK:        {

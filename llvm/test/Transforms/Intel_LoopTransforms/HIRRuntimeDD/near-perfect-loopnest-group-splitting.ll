...
define dso_local void @_Z19composite_referenceiiiiPvPh(i32 %width, i32 %height, i32 %channels, i32 %other_channels, ptr nocapture readnone %highP, ptr nocapture %prow) local_unnamed_addr #0 {
entry:
...
for.body5.preheader:                              ; preds = %for.body
  %arrayidx1 = getelementptr inbounds [2000 x [8000 x i8]], ptr @vrow, i64 0, i64 %indvars.iv72, i64 0, !intel-tbaa !3
  br label %for.body5
...
for.body5:                                        ; preds = %for.body5.preheader, %for.cond.cleanup10
  ...
  %other_row.063 = phi ptr [ %arrayidx1, %for.body5.preheader ], [ %add.ptr25, %for.cond.cleanup10 ]
  %this_row.061 = phi ptr [ %prow, %for.body5.preheader ], [ %add.ptr, %for.cond.cleanup10 ]
  %arrayidx7 = getelementptr inbounds i8, ptr %other_row.063, i64 %indvars.iv67
  %2 = load i8, ptr %arrayidx7, align 1, !tbaa !10
...
for.cond.cleanup10:                               ; preds = %for.cond.cleanup10.loopexit, %for.body5
  %add.ptr = getelementptr inbounds i8, ptr %this_row.061, i64 %idx.ext, !intel-tbaa !10
  %add.ptr25 = getelementptr inbounds i8, ptr %other_row.063, i64 %idx.ext24, !intel-tbaa !10
...
for.body11:                                       ; preds = %for.body11.preheader, %for.body11
  ...
  %arrayidx15 = getelementptr inbounds [2000 x [8000 x i8]], ptr @vrow, i64 0, i64 %indvars.iv72, i64 %indvars.iv, !intel-tbaa !3
  %3 = load i8, ptr %arrayidx15, align 1, !tbaa !3
  %conv16 = zext i8 %3 to i32
  %mul = mul nuw nsw i32 %conv16, %conv
  %arrayidx18 = getelementptr inbounds i8, ptr %this_row.061, i64 %indvars.iv
  %4 = load i8, ptr %arrayidx18, align 1, !tbaa !10
  ...
  store i8 %conv21, ptr %arrayidx18, align 1, !tbaa !10

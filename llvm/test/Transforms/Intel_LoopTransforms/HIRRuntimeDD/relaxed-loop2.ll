; i2 loop is relaxed because we split the memref group which includes (@vrow)[0][i1][i3]
; (@vrow)[0][i1][(1 + sext.i32.i64(%other_channels)) * i2] into two memref groups.
...
; CHECK:           |   if (%width > 0)
; CHECK:           |   {
; CHECK:           |      %mv.test = &((@vrow)[0][i1][-1 * smax(0, (1 + sext.i32.i64(%other_channels))) + (zext.i32.i64(%width) * smax(0, (1 + sext.i32.i64(%other_channels))))]) >=u &((%prow)[0]);
; CHECK:           |      %mv.test5 = &((%prow)[zext.i32.i64(%smax) + -1 * sext.i32.i64(%channels) + (zext.i32.i64(%width) * sext.i32.i64(%channels)) + -1]) >=u &((@vrow)[0][i1][-1 * smin(0, (1 + sext.i32.i64(%other_channels))) + (zext.i32.i64(%width) * smin(0, (1 + sext.i32.i64(%other_channels))))]);
; CHECK:           |      %mv.and = %mv.test  &  %mv.test5;
; CHECK:           |      %mv.test6 = &((%prow)[zext.i32.i64(%smax) + -1 * sext.i32.i64(%channels) + (zext.i32.i64(%width) * sext.i32.i64(%channels)) + -1]) >=u &((@vrow)[0][i1][0]);
; CHECK:           |      %mv.test7 = &((@vrow)[0][i1][zext.i32.i64(%smax) + -1]) >=u &((%prow)[0]);

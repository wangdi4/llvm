...
define dso_local void @fcn(ptr nocapture %A, ptr nocapture readnone %B, ptr nocapture readonly %LoopCount) local_unnamed_addr #0 {
entry:
  br label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %indvars.iv20 = phi i64 [ 0, %entry ], [ %indvars.iv.next21, %for.cond.cleanup3 ]
  %arrayidx = getelementptr inbounds i32, ptr %LoopCount, i64 %indvars.iv20

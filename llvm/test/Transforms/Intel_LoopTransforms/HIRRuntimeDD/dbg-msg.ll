...
;
; CHECK:          + DO i1 = 0, zext.i32.i64(%n) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 4294967295>  <MVTag: 13>
; CHECK:          |   %0 = (%q)[i1];
; CHECK:          |   (%p)[i1] = %0 + 1;
; CHECK:          + END LOOP
; CHECK:       }
...
;
; CHECK:          + DO i1 = 0, zext.i32.i64(%n) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 4294967295>  <MVTag: 13> <nounroll> <novectorize>
; CHECK:          |   %0 = (%q)[i1];
; CHECK:          |   (%p)[i1] = %0 + 1;
; CHECK:          + END LOOP
; CHECK:       }

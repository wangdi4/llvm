...
; CHECK: %mv.test = &((%src)[sext.i32.i64(%i_width) + (sext.i32.i64((-1 + %i_height)) * smax(0, sext.i32.i64(%i_src_stride))) + -1]) >=u &((i8*)(%weight)[0]);
...
define void @mc_weight(ptr nocapture readnone %dst, i32 %i_dst_stride, ptr nocapture %src, i32 %i_src_stride, ptr nocapture readonly %weight, i32 %i_width, i32 %i_height) local_unnamed_addr #0 {
entry:
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %i_offset = getelementptr inbounds %struct.x264_weight_t, ptr %weight, i64 0, i32 2
...
for.body:                                         ; preds = %for.cond.cleanup3, %for.body.lr.ph
  ...
  %src.addr.024 = phi ptr [ %src, %for.body.lr.ph ], [ %add.ptr10, %for.cond.cleanup3 ]
...
for.cond.cleanup3:                                ; preds = %for.cond.cleanup3.loopexit, %for.body
  ...
  %add.ptr10 = getelementptr inbounds i8, ptr %src.addr.024, i64 %idx.ext9
...
for.body4:                                        ; preds = %for.body4, %for.body4.lr.ph
  ...
  %arrayidx = getelementptr inbounds i8, ptr %src.addr.024, i64 %0
  %1 = load i8, ptr %arrayidx, align 1
  %conv = zext i8 %1 to i32
  %2 = load i32, ptr %weight, align 4
  %mul = mul nsw i32 %2, %conv
  %3 = load i32, ptr %i_offset, align 4
  ...
  %arrayidx6 = getelementptr inbounds i8, ptr %src.addr.024, i64 %indvars.iv
  store i8 %conv.i, ptr %arrayidx6, align 1

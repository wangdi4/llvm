...
; unsigned foo(unsigned *a, int m, int n) {
;   unsigned res = 0;
;   for (int i = 0; i < m; i++ ) {
;     for (int j = 0; j < n; j++) {
;       res += a[m * i + n *j];
...
; CHECK: BEGIN REGION { }
; CHECK:       + DO i1 = 0, zext.i32.i64(%m) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 2147483647>  <LEGAL_MAX_TC = 2147483647>
; CHECK:       |   + DO i2 = 0, zext.i32.i64(%n) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 2147483647>  <LEGAL_MAX_TC = 2147483647>
; CHECK:       |   |   %5 = (%a)[sext.i32.i64(%m) * i1 + sext.i32.i64(%n) * i2];
...
; CHECK: BEGIN REGION { }
; CHECK:       + DO i1 = 0, sext.i32.i64(%m) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 2147483647>  <LEGAL_MAX_TC = 2147483647>
...
define dso_local noundef i32 @_Z3fooPjii(ptr nocapture noundef readonly %a, i32 noundef %m, i32 noundef %n) {
entry:

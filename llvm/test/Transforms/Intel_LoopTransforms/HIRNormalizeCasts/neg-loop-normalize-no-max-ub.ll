...
; converted into sext. The reason is that the coefficient for the zext in the
; loop upperbound makes the legal trip count larger that INT_MAX. It was
; created from the following C++ code, but the casting was added in the IR:
...
; CHECK:  BEGIN REGION { }
; CHECK:        + DO i1 = 0, 3 * zext.i32.i64(%n) + -1, 1   <DO_LOOP>
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %ub2

...
; Verify that we are able to optimize away store to (%A)[0][i2 + %t] in the
; first i2 loop even though %A is defined at LCA level of the refs making it
...
define dso_local void @foo(i64 %t) {
entry:
  br label %loop.outer

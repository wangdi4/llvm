...
;
; RUN: opt -hir-ssa-deconstruction -tbaa -hir-create-function-level-region -hir-dead-store-elimination -hir-details -print-before=hir-dead-store-elimination -print-after=hir-dead-store-elimination < %s 2>&1 | FileCheck %s
;

; RUN: opt  -passes="hir-ssa-deconstruction,hir-dead-store-elimination" -print-before=hir-dead-store-elimination -print-after=hir-dead-store-elimination -disable-output -hir-dead-store-elimination-deduce-region-local-alloca=true -hir-details 2>&1 < %s | FileCheck %s

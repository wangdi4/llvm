...
; CHECK:           (float**)(%ARGBLOCK_0)[0].1 = &((%"sub_$A")[0]);
...
define void @sub_(float* noalias %"sub_$A", float* noalias nocapture readonly %"sub_$B", i32* noalias nocapture readonly %"sub_$N") local_unnamed_addr #0 {
alloca:
...
bb22:                                             ; preds = %bb22.loopexit, %alloca
  ...
  store float* %"sub_$A", float** %0, align 8

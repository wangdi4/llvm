...
;       |   if (%N > 4)
;       |   {
;       |      + DO i2 = 0, %N + -1, 1   <DO_LOOP>  <MAX_TC_EST = 7>  <LEGAL_MAX_TC = 2147483647>
;       |      |   %sub = (%M)[i2]  -  (@B)[0][i1][i2];
;       |      |   (%M)[i2] = %sub;
;       |      + END LOOP
;       |   }
...
@B = dso_local local_unnamed_addr global [1000 x [7 x float]] zeroinitializer, align 16
...
for.body4:                                        ; preds = %for.body4.lr.ph, %for.body4
  ...
  %arrayidx6 = getelementptr inbounds [1000 x [7 x float]], [1000 x [7 x float]]* @B, i64 0, i64 %idxprom, i64 %idxprom5

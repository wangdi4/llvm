...
for.cond1.preheader:                              ; preds = %for.inc17, %entry
  ...
  %arrayidx = getelementptr inbounds [10 x i32], ptr @A, i64 0, i64 %indvars.iv33
  %arrayidx12 = getelementptr inbounds [10 x i32], ptr @B, i64 0, i64 %indvars.iv33
  %.pre = load i32, ptr %arrayidx, align 4, !tbaa !1
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  %0 = phi i32 [ %.pre, %for.cond1.preheader ], [ %add14, %for.body3 ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body3 ]
  %arrayidx5 = getelementptr inbounds [10 x i32], ptr @B, i64 0, i64 %indvars.iv
  %1 = load i32, ptr %arrayidx5, align 4, !tbaa !1
  %add = add i32 %0, 1
  %add6 = add i32 %add, %1
  store i32 %add6, ptr %arrayidx5, align 4, !tbaa !1
  %arrayidx10 = getelementptr inbounds [10 x i32], ptr @A, i64 0, i64 %indvars.iv
  %2 = load i32, ptr %arrayidx10, align 4, !tbaa !1
  %3 = load i32, ptr %arrayidx12, align 4, !tbaa !1
  %add13 = add i32 %2, 2
  %add14 = add i32 %add13, %3
  store i32 %add14, ptr %arrayidx, align 4, !tbaa !1
...
for.end19:                                        ; preds = %for.inc17
  ...
  %5 = load i32, ptr getelementptr inbounds ([10 x i32], ptr @B, i64 0, i64 1), align 4, !tbaa !1
  %add20 = add i32 %4, 1

...
; CHECK-DAG: %dummygep{{.*}} = getelementptr inbounds i32, i32* %bc2, i64 1
; CHECK-DAG: %dummygep{{.*}} = getelementptr inbounds [100 x [4 x i32]], [100 x [4 x i32]]* @A, i64 0, i64 0, i64 2
; CHECK-DAG: %dummygep{{.*}} = getelementptr inbounds [100 x [4 x i32]], [100 x [4 x i32]]* @A, i64 0, i64 0, i64 1
; CHECK-DAG: %dummygep{{.*}} = getelementptr inbounds [100 x [4 x i32]], [100 x [4 x i32]]* @A, i64 0, i64 0, i64 0
; CHECK-NOT: dummygep
...
entry:
  %gep = getelementptr inbounds [100 x [4 x i32]], [100 x [4 x i32]]* @A, i64 0, i64 1, i64 0
  %bc1 = bitcast i32* %gep to i8*
  %bc2 = bitcast i8* %bc1 to i32*
  %gep2 = getelementptr inbounds i32, i32* %bc2, i64 1
  br label %for.body

for.body:                                         ; preds = %for.inc4, %entry
  %i.014 = phi i32 [ 0, %entry ], [ %inc5, %for.inc4 ]
  %0 = load i32, i32* %gep2, align 16
  br label %for.body3

for.body3:                                        ; preds = %for.body3, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next, %for.body3 ]
  %arrayidx = getelementptr inbounds [100 x [4 x i32]], [100 x [4 x i32]]* @A, i64 0, i64 0, i64 %indvars.iv

; RUN: opt -hir-ssa-deconstruction -hir-lmm -hir-lmm-loopnest-hoisting=true -print-before=hir-lmm -print-after=hir-lmm < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,print<hir>,hir-lmm,print<hir>" -aa-pipeline="basic-aa" -hir-lmm-loopnest-hoisting=true < %s 2>&1 | FileCheck %s

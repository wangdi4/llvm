...
for.cond1.preheader:                              ; preds = %for.inc8, %entry
  ...
  %arrayidx7 = getelementptr inbounds [1000 x i32], ptr @A, i64 0, i64 %indvars.iv22
  br label %for.body3
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %mul = shl nsw i32 %1, 1
  store i32 %mul, ptr %arrayidx7, align 4, !tbaa !1
...
for.end10:                                        ; preds = %for.inc8
  ...
  %3 = load i32, ptr getelementptr inbounds ([10 x i32], ptr @B, i64 0, i64 1), align 4, !tbaa !1
  %add = add i32 %2, 1
  %add11 = add i32 %add, %3
  ret i32 %add11
}

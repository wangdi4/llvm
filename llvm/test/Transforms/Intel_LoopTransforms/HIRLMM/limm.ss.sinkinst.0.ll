...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  store i32 %j.016, ptr %arrayidx5, align 4, !tbaa !1
...
for.end8:                                         ; preds = %for.inc6
  ...
  %2 = load i32, ptr getelementptr inbounds ([1000 x i32], ptr @B, i64 0, i64 1), align 4, !tbaa !1
  %add = add nsw i32 %2, %1
  %3 = load i32, ptr getelementptr inbounds ([1000 x i32], ptr @C, i64 0, i64 2), align 8, !tbaa !1

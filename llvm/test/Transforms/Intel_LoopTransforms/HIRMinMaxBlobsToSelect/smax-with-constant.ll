...
; that represents a max. The goal is to check that the blob for the constant
; 5 was created correctly. The test case resables the following C++ code:
...
;        {
;              %limm = (%maxchar)[0];
;           + DO i1 = 0, zext.i32.i64(%n_res) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 2147483647>  <LEGAL_MAX_TC = 2147483647>  <MVTag: 16>
;           |   %0 = %limm;
;           |   %limm = smax(5, %0);
...
;        else
;        {
;           + DO i1 = 0, zext.i32.i64(%n_res) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 2147483647>  <LEGAL_MAX_TC = 2147483647>  <MVTag: 16> <nounroll> <novectorize>
;           |   %0 = (%maxchar)[0];
;           |   (%maxchar)[0] = smax(5, %0);
;           |   %conv3 = (%res)[i1]  +  1.000000e+00;
;           |   (%res)[i1] = %conv3;
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  store i32 %1, i32* %maxchar, align 4

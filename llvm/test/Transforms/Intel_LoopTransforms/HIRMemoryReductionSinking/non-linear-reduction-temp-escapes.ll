...
for.body:                                         ; preds = %for.body, %entry
  ...
  %2 = load i32, ptr getelementptr inbounds ([100 x i32], ptr @A, i64 0, i64 8), align 16
  %add4 = add nsw i32 %2, 9
  store i32 %add4, ptr getelementptr inbounds ([100 x i32], ptr @A, i64 0, i64 8), align 16

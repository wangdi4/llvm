...
; This test case checks that the data collection can the memref that is loop
; invariant when the add instruction has two memrefs.
...
do.body18:                                        ; preds = %do.body18, %alloca_1
  ...
  %add.6 = fadd reassoc ninf nsz arcp contract afn float %"B[]_fetch.37", %"A[]_fetch.32"
  ...
  %add.7 = fadd reassoc ninf nsz arcp contract afn float %"B[]_fetch.38", %"A[]_fetch.35"

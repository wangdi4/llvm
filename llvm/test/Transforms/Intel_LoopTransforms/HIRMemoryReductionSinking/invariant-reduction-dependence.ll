...
; Verify that we are able to sink invariant reductions in the presence of dependencies to linear reduction and other invariant reduction.
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx2 = getelementptr inbounds [100 x i32], [100 x i32]* @A, i64 0, i64 %t

; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-temp-cleanup,print<hir>,hir-mv-variable-stride,print<hir>" -hir-details-dims -aa-pipeline="basic-aa" -hir-print-only=0 < %s 2>&1 | FileCheck %s
...
alloca.bb53_crit_edge:                            ; preds = %alloca
  ...
  %.pre329 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"step2d_tile_$ZETA_$field6$_$field1$", i32 0)
  %.pre330 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"step2d_tile_$ZETA_$field6$_$field1$", i32 1)
  %.pre331 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"step2d_tile_$ZETA_$field6$_$field1$", i32 2)
  br label %bb53
...
bb8.preheader:                                    ; preds = %alloca
  ...
  %func_result22 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"step2d_tile_$ZETA_$field6$_$field1$", i32 0)
  %int_sext26 = sext i32 %"step2d_tile_$L1_fetch" to i64
  %func_result30 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"step2d_tile_$ZETA_$field6$_$field1$", i32 1)
  %int_sext34 = sext i32 %"step2d_tile_$L2_fetch" to i64
  %func_result38 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"step2d_tile_$ZETA_$field6$_$field1$", i32 2)
  %int_sext42 = sext i32 %"step2d_tile_$M1_fetch" to i64
  %func_result72 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"step2d_tile_$H_$field6$_$field1$", i32 0)
  %func_result82 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %"step2d_tile_$H_$field6$_$field1$", i32 1)
  ...
  %func_result66 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %func_result38_fetch, double* elementtype(double) %"step2d_tile_$ZETA_$field0$_fetch", i64 %int_sext42)
...
bb12.preheader:                                   ; preds = %bb13, %bb8.preheader
  ...
  %func_result110 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 %int_sext34, i64 %func_result82_fetch, double* elementtype(double) %"step2d_tile_$H_$field0$_fetch", i64 %indvars.iv326)
  %func_result148 = call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 %int_sext34, i64 %mul120, double* elementtype(double) nonnull %"step2d_tile_$DRHS", i64 %indvars.iv326)
  br label %bb12
...
bb53:                                             ; preds = %bb53.loopexit, %alloca.bb53_crit_edge
  ...
  %func_result172 = call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 1, i64 %int_sext235.pre-phi, i64 %mul120, double* elementtype(double) nonnull %"step2d_tile_$DRHS", i64 8)
  ...
  %func_result226 = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 2, i64 1, i64 %func_result202_fetch, double* elementtype(double) %"step2d_tile_$ZETA_$field0$_fetch176", i64 8)

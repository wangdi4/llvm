...
; CHECK:               |   |   (%"bcint_$BC")[i2 + 2][%"bcint_$NBCT[]11_fetch"] = (null)[i2 + 1][%indvars.iv.out + -1];
; CHECK:               |   + END LOOP
; CHECK:               |
; CHECK:               |   bb3:
; CHECK:               + END LOOP
...
define void @bcint_(ptr noalias nocapture %"bcint_$BC", ptr noalias nocapture readonly %"bcint_$IBC") local_unnamed_addr #0 {
alloca:
  %"bcint_$IBC_fetch" = load i32, ptr %"bcint_$IBC", align 4
  %int_sext9 = sext i32 %"bcint_$IBC_fetch" to i64
  %mul10 = shl nsw i64 %int_sext9, 2
  %"bcint_$P.addr_a0$_fetch[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 undef, i64 undef, ptr elementtype(i32) null, i64 4)
  %"bcint_$NBCT[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(i32) @"bcint_$NBCT", i64 5)
  %"bcint_$NBCT[]_fetch" = load i32, ptr %"bcint_$NBCT[]", align 4
  br label %bb6
...
bb10:                                             ; preds = %bb76_endif, %bb6
  ...
  %"bcint_$P.addr_a0$_fetch[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 undef, i64 undef, ptr elementtype(i32) %"bcint_$P.addr_a0$_fetch[]", i64 %indvars.iv)
  %"bcint_$P.addr_a0$_fetch[][]_fetch" = load i32, ptr %"bcint_$P.addr_a0$_fetch[][]", align 4
...
bb67:                                             ; preds = %bb67, %bb37_then
  ...
  %"bcint_$P.addr_a0$_fetch[]36" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 undef, i64 undef, ptr elementtype(i32) null, i64 %"var$5.083")
  %"bcint_$P.addr_a0$_fetch[]36[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 undef, i64 undef, ptr elementtype(i32) %"bcint_$P.addr_a0$_fetch[]36", i64 %int_sext23)
  %"bcint_$P.addr_a0$_fetch[]36[]_fetch" = load i32, ptr %"bcint_$P.addr_a0$_fetch[]36[]", align 4
  %"bcint_$BC[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul10, ptr elementtype(i32) %"bcint_$BC", i64 %"var$7.084")
  %"bcint_$BC[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(i32) %"bcint_$BC[]", i64 %int_sext13)
  store i32 %"bcint_$P.addr_a0$_fetch[]36[]_fetch", ptr %"bcint_$BC[][]", align 4
...
bb37_then:                                        ; preds = %bb10
  ...
  %"bcint_$NBCT[]11" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(i32) @"bcint_$NBCT", i64 %indvars.iv88)
  %"bcint_$NBCT[]11_fetch" = load i32, ptr %"bcint_$NBCT[]11", align 4

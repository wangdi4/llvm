...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %cgep = getelementptr inbounds [100 x i32], ptr @C, i64 0, i64 %indvars.iv
  %ld = load i32, ptr %cgep, align 4
  %arrayidx = getelementptr inbounds [100 x [100 x i32]], ptr @A, i64 0, i64 %indvars.iv38, i64 %indvars.iv
...
for.body6:                                        ; preds = %for.body6.preheader, %for.body6
  ...
  %arrayidx8 = getelementptr inbounds [100 x [100 x i32]], ptr @A, i64 0, i64 %indvars.iv38, i64 %indvars.iv.next36

...
define void @stencil_2D(double* noalias nocapture readonly %input_array, double* noalias nocapture %output_array, double* noalias nocapture readonly %Dx, double* noalias nocapture readonly %Dy) {
entry:
  %0 = load double, double* %Dx, align 8
  %arrayidx12 = getelementptr inbounds double, double* %Dx, i64 1
  %1 = load double, double* %arrayidx12, align 8
  %arrayidx17 = getelementptr inbounds double, double* %Dx, i64 2
  %2 = load double, double* %arrayidx17, align 8
  %arrayidx22 = getelementptr inbounds double, double* %Dx, i64 3
  %3 = load double, double* %arrayidx22, align 8
  %arrayidx27 = getelementptr inbounds double, double* %Dx, i64 4
  %4 = load double, double* %arrayidx27, align 8
  %arrayidx32 = getelementptr inbounds double, double* %Dx, i64 5
  %5 = load double, double* %arrayidx32, align 8
  %arrayidx37 = getelementptr inbounds double, double* %Dx, i64 6
  %6 = load double, double* %arrayidx37, align 8
  %arrayidx42 = getelementptr inbounds double, double* %Dx, i64 7
  %7 = load double, double* %arrayidx42, align 8
  %arrayidx47 = getelementptr inbounds double, double* %Dx, i64 8
  %8 = load double, double* %arrayidx47, align 8
  %9 = load double, double* %Dy, align 8
  %arrayidx57 = getelementptr inbounds double, double* %Dy, i64 1
  %10 = load double, double* %arrayidx57, align 8
  %arrayidx62 = getelementptr inbounds double, double* %Dy, i64 2
  %11 = load double, double* %arrayidx62, align 8
  %arrayidx67 = getelementptr inbounds double, double* %Dy, i64 3
  %12 = load double, double* %arrayidx67, align 8
  %arrayidx72 = getelementptr inbounds double, double* %Dy, i64 5
  %13 = load double, double* %arrayidx72, align 8
  %arrayidx77 = getelementptr inbounds double, double* %Dy, i64 6
  %14 = load double, double* %arrayidx77, align 8
  %arrayidx82 = getelementptr inbounds double, double* %Dy, i64 7
  %15 = load double, double* %arrayidx82, align 8
  %arrayidx87 = getelementptr inbounds double, double* %Dy, i64 8
  %16 = load double, double* %arrayidx87, align 8
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %arrayidx9 = getelementptr inbounds double, double* %input_array, i64 %add8
  ...
  %arrayidx14 = getelementptr inbounds double, double* %input_array, i64 %add13
  ...
  %arrayidx19 = getelementptr inbounds double, double* %input_array, i64 %add18
  ...
  %arrayidx24 = getelementptr inbounds double, double* %input_array, i64 %add23
  %20 = load double, double* %arrayidx24, align 8
  %mul25 = fmul double %3, %20
  %add26 = fadd double %add21, %mul25
  %arrayidx29 = getelementptr inbounds double, double* %input_array, i64 %add7
  ...
  %arrayidx34 = getelementptr inbounds double, double* %input_array, i64 %add33
  ...
  %arrayidx39 = getelementptr inbounds double, double* %input_array, i64 %add38
  ...
  %arrayidx44 = getelementptr inbounds double, double* %input_array, i64 %add43
  %24 = load double, double* %arrayidx44, align 8
  %mul45 = fmul double %7, %24
  %add46 = fadd double %add41, %mul45
  %add48 = add nuw nsw i64 %mul6, 4104
  %arrayidx49 = getelementptr inbounds double, double* %input_array, i64 %add48
  %25 = load double, double* %arrayidx49, align 8
  %mul50 = fmul double %8, %25
  %add51 = fadd double %add46, %mul50
  %add53 = add nuw nsw i64 %mul6, 4
  %arrayidx54 = getelementptr inbounds double, double* %input_array, i64 %add53
  ...
  %arrayidx59 = getelementptr inbounds double, double* %input_array, i64 %add58
  ...
  %arrayidx64 = getelementptr inbounds double, double* %input_array, i64 %add63
  %28 = load double, double* %arrayidx64, align 8
  %mul65 = fmul double %11, %28
  %add66 = fadd double %add61, %mul65
  %add68 = add nuw nsw i64 %mul6, 3076
  %arrayidx69 = getelementptr inbounds double, double* %input_array, i64 %add68
  ...
  %arrayidx74 = getelementptr inbounds double, double* %input_array, i64 %add73
  ...
  %arrayidx79 = getelementptr inbounds double, double* %input_array, i64 %add78
  %31 = load double, double* %arrayidx79, align 8
  %mul80 = fmul double %14, %31
  %add81 = fadd double %add76, %mul80
  %add83 = add nuw nsw i64 %mul6, 7172
  %arrayidx84 = getelementptr inbounds double, double* %input_array, i64 %add83
  %32 = load double, double* %arrayidx84, align 8
  %mul85 = fmul double %15, %32
  %add86 = fadd double %add81, %mul85
  %add88 = add nuw nsw i64 %mul6, 8196
  %arrayidx89 = getelementptr inbounds double, double* %input_array, i64 %add88
  %33 = load double, double* %arrayidx89, align 8
  %mul90 = fmul double %16, %33
  %add91 = fadd double %add86, %mul90
  %add93 = add nuw nsw i64 %i.0179, %mul92
  %arrayidx94 = getelementptr inbounds double, double* %output_array, i64 %add93
  store double %add91, double* %arrayidx94, align 8

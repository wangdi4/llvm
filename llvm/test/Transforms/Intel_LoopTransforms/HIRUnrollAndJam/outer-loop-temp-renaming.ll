...
define void @foo(i64 %init1, i64 %init2, i64 %add, i64 %n, i64 %sub, i64 %mul, float* noalias %in1, float* noalias %in2, float* noalias %out) {
bb:
  br label %bb9
...
bb27:                                             ; preds = %bb27, %bb25
  ...
  %tmp30 = getelementptr inbounds float, float* %in1, i64 %tmp28
  %tmp31 = load float, float* %tmp30, align 4
  %tmp32 = sub nsw i64 %tmp28, %sub
  %tmp33 = mul nsw i64 %tmp32, %mul
  %tmp34 = add nsw i64 %tmp33, %tmp1
  %tmp35 = getelementptr inbounds float, float* %in2, i64 %tmp34
...
bb41:                                             ; preds = %bb27
  ...
  %tmp45 = getelementptr inbounds float, float* %out, i64 %tmp1
  store float %tmp44, float* %tmp45, align 4

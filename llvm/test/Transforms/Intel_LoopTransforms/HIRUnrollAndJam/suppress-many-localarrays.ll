; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -hir-unroll-and-jam  -print-after=hir-unroll-and-jam %s 2>&1 < %s -S | FileCheck %s
...
; Verify that unroll and jam doesn't happen when extremely many locals are present.

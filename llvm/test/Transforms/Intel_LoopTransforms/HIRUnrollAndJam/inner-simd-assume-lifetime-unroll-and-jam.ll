...
; CHECK: |   |   @llvm.lifetime.start.p0i8(4,  &((i8*)(%n144.linear.iv)[0]));
; CHECK: |   |   %0 = (@B)[0][i2];
; CHECK: |   |   %1 = (@A)[0][i1];
; CHECK: |   |   (@A)[0][i1] = %0 + %1;
; CHECK: |   |   @llvm.lifetime.end.p0i8(4,  &((i8*)(%n144.linear.iv)[0]));
; CHECK: |   + END LOOP
; CHECK: |
...
entry:
  ...
  %t4 = bitcast i32* %n144.linear.iv to i8*
...
for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  %t7 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.ALIGNED:PTR_TO_PTR"(double** null, i32 64), "QUAL.OMP.LINEAR:IV"(i32* %n144.linear.iv, i32 1) ]
  call void @llvm.assume(i1 true)
  br label %for.body3

for.body3:                                        ; preds = %for.body3.lr.ph, %for.body3
  %j.02 = phi i32 [ 0, %for.body3.lr.ph ], [ %inc, %for.body3 ]
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %t4) #1
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %t4) #1

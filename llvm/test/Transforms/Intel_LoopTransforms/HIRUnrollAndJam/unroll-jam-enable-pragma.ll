...
; Verify that we unroll & jam small trip count i1 loop because of enabling metadata.

; + DO i1 = 0, 9, 1   <DO_LOOP>  <MAX_TC_EST = 100>
...
; CHECK: + DO i1 = 0, 9, 1   <DO_LOOP> <unroll and jam>
; CHECK: + END LOOP

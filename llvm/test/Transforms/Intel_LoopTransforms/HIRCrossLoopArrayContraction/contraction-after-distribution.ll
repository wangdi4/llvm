; RUN: opt -disable-hir-pragma-bailout -hir-create-function-level-region -hir-ssa-deconstruction  -hir-loop-distribute-loopnest -hir-cross-loop-array-contraction -hir-cg -force-hir-cg -print-before=hir-cross-loop-array-contraction -print-after=hir-cross-loop-array-contraction -disable-output -S < %s 2>&1 | FileCheck %s
; RUN: opt -disable-hir-pragma-bailout -hir-create-function-level-region -passes="hir-ssa-deconstruction,require<hir-loop-statistics>,hir-loop-distribute-loopnest,print<hir>,hir-cross-loop-array-contraction,print<hir>,hir-cg" -force-hir-cg -aa-pipeline="basic-aa" -disable-output < %s 2>&1 | FileCheck %s
...
for.body16:                                       ; preds = %for.cond13.preheader, %for.body16
  ...
  %cgep = getelementptr inbounds [10 x i32], [10 x i32]* @C, i64 0, i64  %indvars.iv157
  ...
  store i32 %ld, i32* %arrayidx24, align 4, !tbaa !2
  %dgep = getelementptr inbounds [10 x i32], [10 x i32]* @D, i64 0, i64  %indvars.iv157
  store i32 %ld, i32* %dgep, align 4

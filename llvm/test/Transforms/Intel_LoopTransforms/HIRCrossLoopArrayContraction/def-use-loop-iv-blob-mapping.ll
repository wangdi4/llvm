...
define dso_local void @shell(ptr nocapture readonly %b, i64 %n) local_unnamed_addr #0 {
entry:
...
for.body16:                                       ; preds = %for.cond13.preheader, %for.body16
  ...
  %gep = getelementptr inbounds [100 x i64], ptr @C, i64 0, i64 %mod1
...
for.body61:                                       ; preds = %for.cond58.preheader, %for.body61
  ...
  %arrayidx71 = getelementptr inbounds [100 x [100 x [100 x [10 x [10 x i32]]]]], ptr %A, i64 0, i64 %mod, i64 %indvars.iv151, i64 %indvars.iv148, i64 %indvars.iv, i64 %indvars.iv145, !intel-tbaa !2

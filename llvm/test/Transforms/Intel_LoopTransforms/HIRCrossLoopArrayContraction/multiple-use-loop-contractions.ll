...
for.body16:                                       ; preds = %for.cond13.preheader, %for.body16
  ...
  store i32 %t4, ptr %arrayidx24, align 4, !tbaa !7
  %arrayidx241 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], ptr %B, i64 0, i64 %indvars.iv278, i64 %indvars.iv275, i64 %indvars.iv272, i64 %indvars.iv269, i64 %indvars.iv265, !intel-tbaa !7
  store i32 %t4, ptr %arrayidx241, align 4, !tbaa !7
...
for.body61:                                       ; preds = %for.cond58.preheader, %for.body61
  ...
  %t5 = load i32, ptr %arrayidx71, align 4, !tbaa !7
  %arrayidx711 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], ptr %B, i64 0, i64 %indvars.iv262, i64 %indvars.iv259, i64 %indvars.iv256, i64 %indvars.iv250, i64 %indvars.iv253, !intel-tbaa !7
  %t6 = load i32, ptr %arrayidx711, align 4, !tbaa !7
  %add72 = add nsw i32 %t5, %t6
  %arrayidx82 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], ptr %C, i64 0, i64 %indvars.iv262, i64 %indvars.iv259, i64 %indvars.iv256, i64 %indvars.iv253, i64 %indvars.iv250, !intel-tbaa !7
...
for.cond.cleanup101:                              ; preds = %for.cond.cleanup106
  ...
  %t7 = load i32, ptr %arrayidx163, align 4, !tbaa !7
...
for.body122:                                      ; preds = %for.cond119.preheader, %for.body122
  ...
  %arrayidx132 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], ptr %A, i64 0, i64 %indvars.iv247, i64 %indvars.iv244, i64 %indvars.iv241, i64 %indvars.iv, i64 %indvars.iv238, !intel-tbaa !7
  %t8 = load i32, ptr %arrayidx132, align 4, !tbaa !7
  %arrayidx1321 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], ptr %B, i64 0, i64 %indvars.iv247, i64 %indvars.iv244, i64 %indvars.iv241, i64 %indvars.iv, i64 %indvars.iv238, !intel-tbaa !7
  %t9 = load i32, ptr %arrayidx1321, align 4, !tbaa !7

; RUN: opt -disable-hir-cross-loop-array-contraction=false -disable-hir-cross-loop-array-contraction-post-processing=true -hir-create-function-level-region -hir-ssa-deconstruction -hir-cross-loop-array-contraction -print-after=hir-cross-loop-array-contraction -hir-cg -force-hir-cg -disable-output < %s 2>&1 | FileCheck %s
...
; Check that multiple use loops and multiple array contractions are handled for
; the same def loop by merging def loop into each use loop.

; The contracted array is different for each use loop.
...
; |   |   |   + DO i4 = 0, 99, 1   <DO_LOOP>
; |   |   |   |   + DO i5 = 0, 99, 1   <DO_LOOP>
; |   |   |   |   |   %t5 = (%A)[0][i1][i2][i3][i5][i4];
; |   |   |   |   |   %t6 = (%B)[0][i1][i2][i3][i5][i4];
; |   |   |   |   |   (%C)[0][i1][i2][i3][i4][i5] = %t5 + %t6;
; |   |   |   |   + END LOOP
; |   |   |   + END LOOP
; |   |   + END LOOP
; |   + END LOOP
...
; |   |   |   + DO i4 = 0, 99, 1   <DO_LOOP>
; |   |   |   |   + DO i5 = 0, 99, 1   <DO_LOOP>
; |   |   |   |   |   %t8 = (%A)[0][i1][i2][i3][i5][i4];
; |   |   |   |   |   %t9 = (%B)[0][i1][i2][i3][i5][i4];
; |   |   |   |   |   (%C)[0][i1][i2][i3][i4][i5] = %t8 + %t9;
; |   |   |   |   + END LOOP
; |   |   |   + END LOOP
; |   |   + END LOOP
; |   + END LOOP
...
entry:
  ...
  %t0 = bitcast [100 x [100 x [100 x [100 x [100 x i32]]]]]* %A to i8*
  call void @llvm.lifetime.start.p0i8(i64 40000000000, i8* nonnull %t0) #3
  %t1 = bitcast [100 x [100 x [100 x [100 x [100 x i32]]]]]* %B to i8*
  call void @llvm.lifetime.start.p0i8(i64 40000000000, i8* nonnull %t1) #3
  %t2 = bitcast [100 x [100 x [100 x [100 x [100 x i32]]]]]* %C to i8*
  call void @llvm.lifetime.start.p0i8(i64 40000000000, i8* nonnull %t2) #3
...
for.body16:                                       ; preds = %for.cond13.preheader, %for.body16
  ...
  %t3 = add nuw nsw i64 %indvars.iv265, %indvars.iv269
  ...
  store i32 %t4, i32* %arrayidx24, align 4, !tbaa !7
  %arrayidx241 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], [100 x [100 x [100 x [100 x [100 x i32]]]]]* %B, i64 0, i64 %indvars.iv278, i64 %indvars.iv275, i64 %indvars.iv272, i64 %indvars.iv269, i64 %indvars.iv265, !intel-tbaa !7
  store i32 %t4, i32* %arrayidx241, align 4, !tbaa !7
...
for.body61:                                       ; preds = %for.cond58.preheader, %for.body61
  ...
  %t5 = load i32, i32* %arrayidx71, align 4, !tbaa !7
  %arrayidx711 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], [100 x [100 x [100 x [100 x [100 x i32]]]]]* %B, i64 0, i64 %indvars.iv262, i64 %indvars.iv259, i64 %indvars.iv256, i64 %indvars.iv250, i64 %indvars.iv253, !intel-tbaa !7
  %t6 = load i32, i32* %arrayidx711, align 4, !tbaa !7
  %add72 = add nsw i32 %t5, %t6
  %arrayidx82 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], [100 x [100 x [100 x [100 x [100 x i32]]]]]* %C, i64 0, i64 %indvars.iv262, i64 %indvars.iv259, i64 %indvars.iv256, i64 %indvars.iv253, i64 %indvars.iv250, !intel-tbaa !7
...
for.cond.cleanup101:                              ; preds = %for.cond.cleanup106
  ...
  %t7 = load i32, i32* %arrayidx163, align 4, !tbaa !7
  call void @llvm.lifetime.end.p0i8(i64 40000000000, i8* nonnull %t2) #3
  call void @llvm.lifetime.end.p0i8(i64 40000000000, i8* nonnull %t1) #3
  call void @llvm.lifetime.end.p0i8(i64 40000000000, i8* nonnull %t0) #3
  ret i32 %t7
...
for.body122:                                      ; preds = %for.cond119.preheader, %for.body122
  ...
  %arrayidx132 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], [100 x [100 x [100 x [100 x [100 x i32]]]]]* %A, i64 0, i64 %indvars.iv247, i64 %indvars.iv244, i64 %indvars.iv241, i64 %indvars.iv, i64 %indvars.iv238, !intel-tbaa !7
  %t8 = load i32, i32* %arrayidx132, align 4, !tbaa !7
  %arrayidx1321 = getelementptr inbounds [100 x [100 x [100 x [100 x [100 x i32]]]]], [100 x [100 x [100 x [100 x [100 x i32]]]]]* %B, i64 0, i64 %indvars.iv247, i64 %indvars.iv244, i64 %indvars.iv241, i64 %indvars.iv, i64 %indvars.iv238, !intel-tbaa !7
  %t9 = load i32, i32* %arrayidx1321, align 4, !tbaa !7
  %add133 = add nsw i32 %t8, %t9

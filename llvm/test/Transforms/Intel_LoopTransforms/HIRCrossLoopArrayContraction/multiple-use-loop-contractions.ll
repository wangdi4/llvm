; RUN: opt -hir-create-function-level-region -hir-ssa-deconstruction -hir-cross-loop-array-contraction -print-after=hir-cross-loop-array-contraction -hir-cg -force-hir-cg -disable-output < %s 2>&1 | FileCheck %s

...
for.body16:                                       ; preds = %for.cond13.preheader, %for.body16
  ...
  %arrayidx240 = getelementptr inbounds [100 x [100 x [100 x [10 x [10 x i32]]]]], ptr %A, i64 0, i64 %indvars.iv170, i64 %indvars.iv167, i64 %indvars.iv164, i64 %indvars.iv161, i64 0, !intel-tbaa !2
  %iv.trunc = trunc i64 %indvars.iv157 to i32
  store i32 %iv.trunc,  ptr %arrayidx240, align 4, !tbaa !2
  %ld = load i32, ptr %arrayidx240, align 4, !tbaa !2

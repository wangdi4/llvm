...
; |   |   |   + DO i4 = 0, 0, 1   <DO_LOOP>
; |   |   |   |   + DO i5 = 0, 0, 1   <DO_LOOP>
; |   |   |   |   |   (%A)[0][i1][i2][i3][i4][0] = i5;
; |   |   |   |   |   %ld = (%A)[0][i1][i2][i3][i4][0];
; |   |   |   |   + END LOOP
; |   |   |   + END LOOP
; |   |   + END LOOP
; |   + END LOOP
...
for.cond.cleanup15:                               ; preds = %for.body16
  ...
  %exitcond163 = icmp eq i64 %indvars.iv.next162, 1
...
for.body16:                                       ; preds = %for.cond13.preheader, %for.body16
  ...
  %arrayidx240 = getelementptr inbounds [100 x [100 x [100 x [10 x [10 x i32]]]]], [100 x [100 x [100 x [10 x [10 x i32]]]]]* %A, i64 0, i64 %indvars.iv170, i64 %indvars.iv167, i64 %indvars.iv164, i64 %indvars.iv161, i64 0, !intel-tbaa !2
  %iv.trunc = trunc i64 %indvars.iv157 to i32
  store i32 %iv.trunc,  i32* %arrayidx240, align 4, !tbaa !2
  %ld = load i32, i32* %arrayidx240, align 4, !tbaa !2
  %indvars.iv.next158 = add nuw nsw i64 %indvars.iv157, 1
  %exitcond160 = icmp eq i64 %indvars.iv.next158, 1
...
for.cond.cleanup40:                               ; preds = %for.cond.cleanup45
  %bld = load i32, i32* %b, align 4, !tbaa !11
...
for.cond.cleanup60:                               ; preds = %for.body61
  ...
  %exitcond147 = icmp eq i64 %indvars.iv.next146, 1
...
for.body61:                                       ; preds = %for.cond58.preheader, %for.body61
  ...
  %ld1 = load i32, i32* %arrayidx71, align 4, !tbaa !2

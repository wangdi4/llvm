; RUN: opt -disable-hir-cross-loop-array-contraction=false -disable-hir-cross-loop-array-contraction-post-processing=true -hir-create-function-level-region -hir-ssa-deconstruction -hir-cross-loop-array-contraction -print-after=hir-cross-loop-array-contraction -disable-output < %s 2>&1 | FileCheck %s

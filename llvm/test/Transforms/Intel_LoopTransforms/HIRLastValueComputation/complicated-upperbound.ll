...
;<29>               |         %11 = 0.000000e+00;
;<72>               |
;<72>               |         + DO i2 = 0, zext.i32.i64(smax(1, ((-1 * %3) + %4))) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 2147483647> <simd>
;<32>               |         |   %12 = i2  +  %3;
...
; CHECK:           |
; CHECK:           |         + DO i2 = 0, zext.i32.i64(smax(1, ((-1 * %3) + %4))) + -1, 1   <DO_LOOP>  <MAX_TC_EST = 2147483647> <simd>
...
!139 = !{!34, !20, !"OMPAliasScope", !79, !22, !35, !80}

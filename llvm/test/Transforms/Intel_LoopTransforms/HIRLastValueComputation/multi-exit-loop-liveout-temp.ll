; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-lmm,hir-last-value-computation,print<hir>" -aa-pipeline="basic-aa" 2>&1 < %s | FileCheck %s
...
loop:                 ; preds = %latch, %entry
  ...
  store i64 %t106, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @__profc__ZNK4llvm9StringRef5emptyEv, i64 0, i64 0), align 8
...
latch:               ; preds = %loop
  ...
  store i64 %t116, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @__profc__ZNK4llvm9StringRef5emptyEv, i64 0, i64 0), align 8

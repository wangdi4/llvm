...
entry:
  ...
  %0 = bitcast ptr %hidden_act to ptr
  call void @llvm.lifetime.start.p0(i64 124, ptr nonnull %0) #3
  %1 = bitcast ptr %output_act to ptr
  call void @llvm.lifetime.start.p0(i64 140, ptr nonnull %1) #3
  %puts = tail call i32 @puts(ptr @str)
  %call1 = tail call i32 @initialize()
  %puts44 = tail call i32 @puts(ptr @str.9)
  %arraydecay6 = getelementptr inbounds [31 x float], ptr %hidden_act, i64 0, i64 0
  %arrayidx12.i = getelementptr inbounds [31 x float], ptr %hidden_act, i64 0, i64 30
  %arraydecay9 = getelementptr inbounds [35 x float], ptr %output_act, i64 0, i64 0
  %2 = bitcast ptr %psum_array.i to ptr
...
for.cond4.preheader.i:                            ; preds = %for.end.i, %for.body5
  %receiver.0.ptr32.i = phi ptr [ %arraydecay6, %for.body5 ], [ %receiver.0.ptr.i, %for.end.i ]
  %receiver.0.idx31.i = phi i64 [ 0, %for.body5 ], [ %receiver.0.add.i, %for.end.i ]
  %weight.030.i = phi ptr [ @i_h_weights, %for.body5 ], [ %scevgep.i, %for.end.i ]
  store float 0.000000e+00, ptr %receiver.0.ptr32.i, align 4, !tbaa !2
  br label %for.body6.i

for.body6.i:                                      ; preds = %for.body6.i, %for.cond4.preheader.i
  %weight.129.i = phi ptr [ %weight.030.i, %for.cond4.preheader.i ], [ %incdec.ptr7.i, %for.body6.i ]
  ...
  %sender.0.ptr.i = getelementptr inbounds [30 x [1221 x float]], ptr @next_input, i64 0, i64 %indvars.iv, i64 %sender.0.idx28.i
  %sender.0.add.i = add nuw nsw i64 %sender.0.idx28.i, 1
  %3 = load float, ptr %sender.0.ptr.i, align 4, !tbaa !2
  %incdec.ptr7.i = getelementptr inbounds float, ptr %weight.129.i, i64 1
  %4 = load float, ptr %weight.129.i, align 4, !tbaa !2
  %mul.i = fmul float %3, %4
  %add.i = fadd float %storemerge27.i, %mul.i
  store float %add.i, ptr %receiver.0.ptr32.i, align 4, !tbaa !2
...
for.end.i:                                        ; preds = %for.body6.i
  ...
  %scevgep.i = getelementptr float, ptr %weight.030.i, i64 1221
  ...
  store float %conv9.i, ptr %receiver.0.ptr32.i, align 4, !tbaa !2
  %receiver.0.add.i = add nuw nsw i64 %receiver.0.idx31.i, 1
  %receiver.0.ptr.i = getelementptr inbounds [31 x float], ptr %hidden_act, i64 0, i64 %receiver.0.add.i
...
input_hidden.exit:                                ; preds = %for.end.i
  store float 1.000000e+00, ptr %arrayidx12.i, align 8, !tbaa !2
  br label %for.cond4.preheader.i45

for.cond4.preheader.i45:                          ; preds = %for.end.i62, %input_hidden.exit
  %receiver.0.ptr30.i = phi ptr [ %arraydecay9, %input_hidden.exit ], [ %receiver.0.ptr.i61, %for.end.i62 ]
  %receiver.0.idx29.i = phi i64 [ 0, %input_hidden.exit ], [ %receiver.0.add.i60, %for.end.i62 ]
  %weight.028.i = phi ptr [ @h_o_weights, %input_hidden.exit ], [ %scevgep.i53, %for.end.i62 ]
  store float 0.000000e+00, ptr %receiver.0.ptr30.i, align 4, !tbaa !2
  br label %for.body6.i52

for.body6.i52:                                    ; preds = %for.body6.i52, %for.cond4.preheader.i45
  %weight.127.i = phi ptr [ %weight.028.i, %for.cond4.preheader.i45 ], [ %incdec.ptr7.i48, %for.body6.i52 ]
  ...
  %sender.0.ptr.i46 = getelementptr inbounds [31 x float], ptr %hidden_act, i64 0, i64 %sender.0.idx26.i
  %sender.0.add.i47 = add nuw nsw i64 %sender.0.idx26.i, 1
  %5 = load float, ptr %sender.0.ptr.i46, align 4, !tbaa !2
  %incdec.ptr7.i48 = getelementptr inbounds float, ptr %weight.127.i, i64 1
  %6 = load float, ptr %weight.127.i, align 4, !tbaa !2
  %mul.i49 = fmul float %5, %6
  %add.i50 = fadd float %storemerge25.i, %mul.i49
  store float %add.i50, ptr %receiver.0.ptr30.i, align 4, !tbaa !2
...
for.end.i62:                                      ; preds = %for.body6.i52
  ...
  %scevgep.i53 = getelementptr float, ptr %weight.028.i, i64 31
  ...
  store float %conv9.i59, ptr %receiver.0.ptr30.i, align 4, !tbaa !2
  %receiver.0.add.i60 = add nuw nsw i64 %receiver.0.idx29.i, 1
  %receiver.0.ptr.i61 = getelementptr inbounds [35 x float], ptr %output_act, i64 0, i64 %receiver.0.add.i60
...
for.body.i:                                       ; preds = %for.body.i, %for.body.i.preheader
  ...
  %arrayidx.i = getelementptr inbounds [30 x [35 x float]], ptr @next_output, i64 0, i64 %indvars.iv, i64 %indvars.iv.i
  %8 = load float, ptr %arrayidx.i, align 4, !tbaa !2
  %arrayidx2.i = getelementptr inbounds [35 x float], ptr %output_act, i64 0, i64 %indvars.iv.i
  %9 = load float, ptr %arrayidx2.i, align 4, !tbaa !2
...
update_stats.exit:                                ; preds = %for.body.i
  ...
  call void @llvm.lifetime.start.p0(i64 124, ptr nonnull %2) #3
  call void @llvm.memset.p0.i64(ptr nonnull align 16 %2, i8 0, i64 124, i1 false) #3
...
for.body3.i87:                                    ; preds = %for.inc44.i, %update_stats.exit
  ...
  %arrayidx5.i81 = getelementptr inbounds [30 x [35 x float]], ptr @next_output, i64 0, i64 %indvars.iv, i64 %indvars.iv105.i
  %10 = load float, ptr %arrayidx5.i81, align 4, !tbaa !2
  %arrayidx7.i = getelementptr inbounds [35 x float], ptr %output_act, i64 0, i64 %indvars.iv105.i
  %11 = load float, ptr %arrayidx7.i, align 4, !tbaa !2
...
for.body21.i:                                     ; preds = %for.body21.i, %for.body3.i87
  ...
  %arrayidx27.i = getelementptr inbounds [35 x [31 x float]], ptr @h_o_weights, i64 0, i64 %indvars.iv105.i, i64 %indvars.iv102.i
  %12 = load float, ptr %arrayidx27.i, align 4, !tbaa !6
  %mul28.i = fmul float %12, %conv15.i86
  %arrayidx30.i88 = getelementptr inbounds [31 x float], ptr %psum_array.i, i64 0, i64 %indvars.iv102.i
  %13 = load float, ptr %arrayidx30.i88, align 4, !tbaa !9
  %add.i89 = fadd float %13, %mul28.i
  store float %add.i89, ptr %arrayidx30.i88, align 4, !tbaa !9
  %arrayidx34.i = getelementptr inbounds [31 x float], ptr %hidden_act, i64 0, i64 %indvars.iv102.i
  %14 = load float, ptr %arrayidx34.i, align 4, !tbaa !2
  %mul35.i = fmul float %14, %conv15.i86
  %arrayidx39.i = getelementptr inbounds [35 x [31 x float]], ptr @h_o_w_ch_sum_array, i64 0, i64 %indvars.iv105.i, i64 %indvars.iv102.i
  %15 = load float, ptr %arrayidx39.i, align 4, !tbaa !6
  %add40.i = fadd float %15, %mul35.i
  store float %add40.i, ptr %arrayidx39.i, align 4, !tbaa !6
...
for.body50.i:                                     ; preds = %for.body50.i, %for.body50.i.preheader
  ...
  %arrayidx52.i = getelementptr inbounds [31 x float], ptr %hidden_act, i64 0, i64 %indvars.iv.i90
  %16 = load float, ptr %arrayidx52.i, align 4, !tbaa !2
  %conv53.i = fpext float %16 to double
  %sub57.i = fsub double 1.000000e+00, %conv53.i
  %mul58.i = fmul double %sub57.i, %conv53.i
  %arrayidx60.i = getelementptr inbounds [31 x float], ptr %psum_array.i, i64 0, i64 %indvars.iv.i90
  %17 = load float, ptr %arrayidx60.i, align 4, !tbaa !9
  %conv61.i = fpext float %17 to double
  %mul62.i = fmul double %mul58.i, %conv61.i
  %conv63.i = fptrunc double %mul62.i to float
  %arrayidx65.i = getelementptr inbounds [31 x float], ptr @hidden_delta, i64 0, i64 %indvars.iv.i90
  store float %conv63.i, ptr %arrayidx65.i, align 4, !tbaa !9
...
output_hidden.exit:                               ; preds = %for.body50.i
  call void @llvm.lifetime.end.p0(i64 124, ptr nonnull %2) #3
  br label %for.cond2.preheader.i

for.cond2.preheader.i:                            ; preds = %for.end.i80, %output_hidden.exit
  %w_ch.019.i = phi ptr [ @i_h_w_ch_sum_array, %output_hidden.exit ], [ %scevgep.i79, %for.end.i80 ]
  %delta.018.i = phi ptr [ @hidden_delta, %output_hidden.exit ], [ %incdec.ptr6.i, %for.end.i80 ]
  %ii = phi i64 [ 0, %output_hidden.exit ], [ %ip, %for.end.i80 ]
  br label %for.body4.i

for.body4.i:                                      ; preds = %for.body4.i, %for.cond2.preheader.i
  %w_ch.117.i = phi ptr [ %w_ch.019.i, %for.cond2.preheader.i ], [ %incdec.ptr5.i, %for.body4.i ]
  %sender.0.idx16.i = phi i64 [ 0, %for.cond2.preheader.i ], [ %sender.0.add.i75, %for.body4.i ]
  %sender.0.ptr.i74 = getelementptr inbounds [30 x [1221 x float]], ptr @next_input, i64 0, i64 %indvars.iv, i64 %sender.0.idx16.i
  %18 = load float, ptr %delta.018.i, align 4, !tbaa !2
  %sender.0.add.i75 = add nuw nsw i64 %sender.0.idx16.i, 1
  %19 = load float, ptr %sender.0.ptr.i74, align 4, !tbaa !2
  %mul.i76 = fmul float %18, %19
  %incdec.ptr5.i = getelementptr inbounds float, ptr %w_ch.117.i, i64 1
  %20 = load float, ptr %w_ch.117.i, align 4, !tbaa !2
  %add.i77 = fadd float %20, %mul.i76
  store float %add.i77, ptr %w_ch.117.i, align 4, !tbaa !2
...
for.end.i80:                                      ; preds = %for.body4.i
  %scevgep.i79 = getelementptr float, ptr %w_ch.019.i, i64 1221
  %incdec.ptr6.i = getelementptr inbounds float, ptr %delta.018.i, i64 1
  %ip = add nsw i64 %ii, 1
...
for.end:                                          ; preds = %hidden_input.exit
  ...
  %21 = load float, ptr @i_h_lrc, align 4, !tbaa !2
  br label %for.end30

for.end30:                                        ; preds = %update_weights.exit
  call void @llvm.lifetime.end.p0(i64 140, ptr nonnull %1) #3
  call void @llvm.lifetime.end.p0(i64 124, ptr nonnull %0) #3
  ret i32 0
}
...
; Function Attrs: nounwind
declare i32 @puts(ptr nocapture readonly) local_unnamed_addr #3

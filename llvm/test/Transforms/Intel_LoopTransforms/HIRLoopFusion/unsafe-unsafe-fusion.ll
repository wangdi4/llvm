...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [100 x i32], ptr @B, i64 0, i64 %indvars.iv35
  %0 = load i32, ptr %arrayidx, align 4
  %1 = trunc i64 %indvars.iv35 to i32
  %add = add nsw i32 %0, %1
  %arrayidx2 = getelementptr inbounds [100 x i32], ptr @A, i64 0, i64 %indvars.iv35
...
for.body9:                                        ; preds = %for.body9.preheader, %for.body9
  ...
  %call17 = tail call i32 (ptr, ...) @printf(ptr @.str, i32 %add12)

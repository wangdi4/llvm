...
; INPUT:
;<0>       BEGIN REGION { }
;<29>            + DO i1 = 0, 99, 1   <DO_LOOP> <min_trip_count = 60> <avg_trip_count = 70> <max_trip_count = 100>
;<5>             |   (%a)[i1] = i1;
;<29>            + END LOOP
;<29>
;<30>
;<30>            + DO i1 = 0, 99, 1   <DO_LOOP> <min_trip_count = 50> <avg_trip_count = 80> <max_trip_count = 100>
;<17>            |   %1 = (%a)[i1];
;<20>            |   (%b)[i1] = %1 + 1;
;<30>            + END LOOP
;<30>
...
; CHECK:     DO i1 = 0, 99, 1   <DO_LOOP> <max_trip_count = 100>
;

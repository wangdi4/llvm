; RUN: opt -hir-ssa-deconstruction -disable-output -hir-create-function-level-region -hir-loop-fusion -print-after=hir-loop-fusion < %s 2>&1 | FileCheck %s
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [100 x i32], [100 x i32]* @B, i64 0, i64 %indvars.iv31
  %0 = load i32, i32* %arrayidx, align 4
  %1 = trunc i64 %indvars.iv31 to i32
  %add = add nsw i32 %0, %1
  %arrayidx2 = getelementptr inbounds [100 x i32], [100 x i32]* @A, i64 0, i64 %indvars.iv31

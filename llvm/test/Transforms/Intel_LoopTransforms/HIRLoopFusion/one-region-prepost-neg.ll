; RUN: opt -hir-ssa-deconstruction -disable-output -hir-temp-cleanup -print-after=hir-loop-fusion -hir-create-function-level-region -hir-loop-fusion < %s 2>&1 | FileCheck %s

...
define void @foo(i32* noalias nocapture %a, i32* noalias nocapture %b, i32* nocapture %c, i32 %n) local_unnamed_addr #0 {
entry:
  br label %for.body
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds i32, i32* %a, i64 %indvars.iv47
...
for.body5:                                        ; preds = %for.body5, %for.cond.cleanup
  ...
  %arrayidx7 = getelementptr inbounds i32, i32* %a, i64 %indvars.iv44
  %1 = load i32, i32* %arrayidx7, align 4
  %add = add nsw i32 %1, 1
  %arrayidx9 = getelementptr inbounds i32, i32* %b, i64 %indvars.iv44
...
for.body17:                                       ; preds = %for.body17, %for.cond.cleanup4
  ...
  %arrayidx22 = getelementptr inbounds i32, i32* %c, i64 %indvars.iv

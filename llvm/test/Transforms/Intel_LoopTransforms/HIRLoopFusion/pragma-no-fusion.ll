...
define dso_local void @foo([10 x i32]* noalias nocapture %a, [10 x i32]* nocapture %b, i32 %n) {
entry:
...
for.body4:                                        ; preds = %for.body4, %for.body4.lr.ph
  ...
  %arrayidx6 = getelementptr inbounds [10 x i32], [10 x i32]* %a, i64 %indvars.iv, i64 %indvars.iv58
...
for.body11:                                       ; preds = %for.body11.preheader, %for.body11
  ...
  %arrayidx15 = getelementptr inbounds [10 x i32], [10 x i32]* %a, i64 %indvars.iv54, i64 %indvars.iv58
  %2 = load i32, i32* %arrayidx15, align 4
  %3 = trunc i64 %indvars.iv54 to i32
  %add16 = add nsw i32 %2, %3
  %arrayidx20 = getelementptr inbounds [10 x i32], [10 x i32]* %b, i64 %indvars.iv54, i64 %indvars.iv58
...
define dso_local void @foo_no_fusion([10 x i32]* noalias nocapture %a, [10 x i32]* nocapture %b, i32 %n) {
entry:
  %cmp49 = icmp sgt i32 %n, 0
  br i1 %cmp49, label %for.cond1.preheader.lr.ph, label %for.cond.cleanup

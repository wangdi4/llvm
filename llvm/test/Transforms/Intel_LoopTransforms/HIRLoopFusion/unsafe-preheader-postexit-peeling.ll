...
; Check that we do not fuse loops with different Ztts in presence of preheader/
; postexit. Fusion would merge both ztts, which will incorrectly guard
; the preheader/postexit if done.

...
for.body9:                                        ; preds = %for.body9.preheader, %for.body9
  ...
  %arrayidx11 = getelementptr inbounds [100 x i32], [100 x i32]* @A, i64 0, i64 %indvars.iv39
  %3 = load i32, i32* %arrayidx11, align 4
  %4 = trunc i64 %indvars.iv39 to i32
  %add12 = add nsw i32 %3, %4
  %arrayidx14 = getelementptr inbounds [100 x i32], [100 x i32]* @B, i64 0, i64 %indvars.iv39

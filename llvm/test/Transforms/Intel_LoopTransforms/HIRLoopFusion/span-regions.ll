; RUN: opt -hir-ssa-deconstruction -disable-output -hir-loop-fusion -print-before=hir-loop-fusion -print-after=hir-loop-fusion -disable-hir-create-fusion-regions=0 < %s 2>&1 | FileCheck %s

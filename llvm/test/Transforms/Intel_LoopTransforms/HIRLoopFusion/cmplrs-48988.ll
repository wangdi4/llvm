...
define i32 @baz(double* noalias readonly %arg, i64* noalias nocapture readonly %arg1, double* noalias nocapture %arg2, i64* noalias nocapture readonly %arg3) local_unnamed_addr #0 {
bb:
  ...
  %tmp8 = load i64, i64* %arg3, align 8
  %tmp9 = add nsw i64 %tmp8, 1
  %tmp10 = mul nsw i64 %tmp9, %tmp8
  %tmp11 = xor i64 %tmp10, -1
  %tmp12 = getelementptr inbounds double, double* %arg2, i64 %tmp11
...
bb147:                                            ; preds = %bb147, %bb137
  ...
  %tmp150 = getelementptr inbounds double, double* %tmp7, i64 %tmp149
  %tmp151 = load double, double* %tmp150, align 8
  %tmp152 = add nsw i64 %tmp148, %tmp142
  %tmp153 = getelementptr inbounds double, double* %tmp7, i64 %tmp152
  %tmp154 = load double, double* %tmp153, align 8
  ...
  %tmp159 = getelementptr inbounds double, double* %tmp12, i64 %tmp158
  %tmp160 = load double, double* %tmp159, align 8
  %tmp161 = fadd double %tmp160, %tmp156
  store double %tmp161, double* %tmp159, align 8
...
bb166:                                            ; preds = %bb166, %bb164
  ...
  %tmp170 = getelementptr inbounds double, double* %tmp7, i64 %tmp169
  %tmp171 = load double, double* %tmp170, align 8
  %tmp172 = add nsw i64 %tmp167, %tmp140
  %tmp173 = getelementptr inbounds double, double* %tmp7, i64 %tmp172
  %tmp174 = load double, double* %tmp173, align 8
  %tmp175 = fadd double %tmp171, %tmp174
  %tmp176 = add nsw i64 %tmp168, %tmp142
  %tmp177 = getelementptr inbounds double, double* %tmp7, i64 %tmp176
  %tmp178 = load double, double* %tmp177, align 8
  %tmp179 = fadd double %tmp175, %tmp178
  %tmp180 = add nsw i64 %tmp167, %tmp142
  %tmp181 = getelementptr inbounds double, double* %tmp7, i64 %tmp180
  %tmp182 = load double, double* %tmp181, align 8
  ...
  %tmp187 = getelementptr inbounds double, double* %tmp12, i64 %tmp186
  %tmp188 = load double, double* %tmp187, align 8
  %tmp189 = fadd double %tmp188, %tmp184
  store double %tmp189, double* %tmp187, align 8
...
bb212:                                            ; preds = %bb212, %bb197
  ...
  %tmp215 = getelementptr inbounds double, double* %tmp7, i64 %tmp214
  %tmp216 = load double, double* %tmp215, align 8
  %tmp217 = add nsw i64 %tmp213, %tmp203
  %tmp218 = getelementptr inbounds double, double* %tmp7, i64 %tmp217
  %tmp219 = load double, double* %tmp218, align 8
  %tmp220 = fadd double %tmp216, %tmp219
  %tmp221 = add nsw i64 %tmp213, %tmp205
  %tmp222 = getelementptr inbounds double, double* %tmp7, i64 %tmp221
  %tmp223 = load double, double* %tmp222, align 8
  %tmp224 = fadd double %tmp220, %tmp223
  %tmp225 = add nsw i64 %tmp213, %tmp207
  %tmp226 = getelementptr inbounds double, double* %tmp7, i64 %tmp225
  %tmp227 = load double, double* %tmp226, align 8
  ...
  %tmp232 = getelementptr inbounds double, double* %tmp12, i64 %tmp231
  %tmp233 = load double, double* %tmp232, align 8
  %tmp234 = fadd double %tmp233, %tmp229
  store double %tmp234, double* %tmp232, align 8
...
bb239:                                            ; preds = %bb239, %bb237
  ...
  %tmp243 = getelementptr inbounds double, double* %tmp7, i64 %tmp242
  %tmp244 = load double, double* %tmp243, align 8
  %tmp245 = add nsw i64 %tmp241, %tmp203
  %tmp246 = getelementptr inbounds double, double* %tmp7, i64 %tmp245
  %tmp247 = load double, double* %tmp246, align 8
  %tmp248 = fadd double %tmp244, %tmp247
  %tmp249 = add nsw i64 %tmp240, %tmp201
  %tmp250 = getelementptr inbounds double, double* %tmp7, i64 %tmp249
  %tmp251 = load double, double* %tmp250, align 8
  %tmp252 = fadd double %tmp248, %tmp251
  %tmp253 = add nsw i64 %tmp240, %tmp203
  %tmp254 = getelementptr inbounds double, double* %tmp7, i64 %tmp253
  %tmp255 = load double, double* %tmp254, align 8
  %tmp256 = fadd double %tmp252, %tmp255
  %tmp257 = add nsw i64 %tmp241, %tmp205
  %tmp258 = getelementptr inbounds double, double* %tmp7, i64 %tmp257
  %tmp259 = load double, double* %tmp258, align 8
  %tmp260 = fadd double %tmp256, %tmp259
  %tmp261 = add nsw i64 %tmp241, %tmp207
  %tmp262 = getelementptr inbounds double, double* %tmp7, i64 %tmp261
  %tmp263 = load double, double* %tmp262, align 8
  %tmp264 = fadd double %tmp260, %tmp263
  %tmp265 = add nsw i64 %tmp240, %tmp205
  %tmp266 = getelementptr inbounds double, double* %tmp7, i64 %tmp265
  %tmp267 = load double, double* %tmp266, align 8
  %tmp268 = fadd double %tmp264, %tmp267
  %tmp269 = add nsw i64 %tmp240, %tmp207
  %tmp270 = getelementptr inbounds double, double* %tmp7, i64 %tmp269
  %tmp271 = load double, double* %tmp270, align 8
  ...
  %tmp276 = getelementptr inbounds double, double* %tmp12, i64 %tmp275
  %tmp277 = load double, double* %tmp276, align 8
  %tmp278 = fadd double %tmp277, %tmp273
  store double %tmp278, double* %tmp276, align 8
...
bb288:                                            ; preds = %bb287, %bb
  %tmp289 = tail call i32 @eggs(double* %arg2, i64* %arg3)
  ret i32 0
}

; Function Attrs: norecurse nounwind uwtable
declare i32 @eggs(double* noalias nocapture, i64* noalias nocapture readonly) local_unnamed_addr #0

...
; OPTREPORT:         Remark #XXXXX: Loops have been fused with (11,15)
; OPTREPORT:     LOOP END
; OPTREPORT:     LOOP BEGIN at t1.c (7, 5)
; OPTREPORT:         Remark #XXXXX: Peeled loop after fusion
; OPTREPORT:     LOOP END
...
!19 = distinct !DISubprogram(name: "foo", scope: !3, file: !3, line: 4, type: !20, isLocal: false, isDefinition: true, scopeLine: 4, isOptimized: true, unit: !2, variables: !22)

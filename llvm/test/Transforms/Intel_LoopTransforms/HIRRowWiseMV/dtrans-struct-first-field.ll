...
; RUN: opt -whole-program-assume -passes='require<dtrans-safetyanalyzer>,function(hir-ssa-deconstruction,hir-temp-cleanup,hir-rowwise-mv)' -print-before=hir-rowwise-mv -disable-output 2>&1 < %s | FileCheck %s

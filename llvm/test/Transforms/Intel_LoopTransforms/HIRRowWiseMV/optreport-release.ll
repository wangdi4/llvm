; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-rowwise-mv,hir-cg,simplifycfg,intel-ir-optreport-emitter" -hir-rowwise-mv-skip-dtrans -force-hir-cg -intel-opt-report=low -disable-output 2>&1 < %s | FileCheck --implicit-check-not multiversioned %s

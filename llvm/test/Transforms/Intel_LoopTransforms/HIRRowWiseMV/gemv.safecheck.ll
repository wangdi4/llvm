...
; the expected code when the in-loop-nest check loop is needed.
...
L0:
  ...
  %Afirst = load double, double* %A
  %Acheck = fcmp une double %Afirst, 0.0
  br i1 %Acheck, label %L1.pre, label %L0.latch

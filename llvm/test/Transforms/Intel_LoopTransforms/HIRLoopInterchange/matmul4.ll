...
for.body.6.lr.ph:                                 ; preds = %for.inc.14, %for.cond.4.preheader.preheader
  ...
  %arrayidx9 = getelementptr inbounds [1024 x [1024 x double]], ptr @a, i64 0, i64 %i.043, i64 %k.040
...
for.body.6:                                       ; preds = %for.body.6, %for.body.6.lr.ph
  ...
  %arrayidx7 = getelementptr inbounds [1024 x [1024 x double]], ptr @c, i64 0, i64 %i.043, i64 %j.038
  %1 = load double, ptr %arrayidx7, align 8, !tbaa !1
  %arrayidx11 = getelementptr inbounds [1024 x [1024 x double]], ptr @b, i64 0, i64 %k.040, i64 %j.038

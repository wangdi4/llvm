...
;  Already in memory ref order.  no interchange needed. 
...
for.cond.4.preheader.preheader:                   ; preds = %entry, %for.inc.17
  %i.043 = phi i64 [ %inc18, %for.inc.17 ], [ 0, %entry ]
...
for.body.6.lr.ph:                                 ; preds = %for.inc.14, %for.cond.4.preheader.preheader
  ...
  %arrayidx9 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @a, i64 0, i64 %i.043, i64 %k.040
...
for.body.6:                                       ; preds = %for.body.6, %for.body.6.lr.ph
  ...
  %arrayidx7 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @c, i64 0, i64 %i.043, i64 %j.038
  %1 = load double, double* %arrayidx7, align 8, !tbaa !1
  %arrayidx11 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @b, i64 0, i64 %k.040, i64 %j.038

...
define void @sub2_(double* noalias nocapture dereferenceable(8) %"sub2_$A", double* noalias nocapture readonly dereferenceable(8) %"sub2_$B", i32* noalias nocapture readonly dereferenceable(4) %"sub2_$N") local_unnamed_addr #0 {
alloca_0:

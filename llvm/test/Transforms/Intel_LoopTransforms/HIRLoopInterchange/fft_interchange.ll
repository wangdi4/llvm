; REQUIRES: asserts
; RUN: opt -passes="function(hir-ssa-deconstruction,hir-temp-cleanup,hir-sinking-for-perfect-loopnest,hir-loop-interchange)" -aa-pipeline="basic-aa" -debug-only=hir-loop-interchange  -disable-output < %s 2>&1 | FileCheck %s
; CHECK:  Interchanged:
...
; RUN: opt -passes="function(hir-ssa-deconstruction,hir-temp-cleanup,print<hir>,hir-sinking-for-perfect-loopnest,hir-loop-interchange,print<hir>)" -aa-pipeline="basic-aa" -hir-details -disable-output < %s 2>&1 | FileCheck %s -check-prefix=CHECK-LIVE
...
; CHECK-LIVE: BLOB> LINEAR ptr %twp.addr.0162{def@1} {sb:[[NEWLIVEIN:.*]]}
...
define void @FFT_transform_internal(i32 %N, ptr noalias nocapture %data, i32 %direction, ptr nocapture readonly %twp) local_unnamed_addr #0 {
entry:
  %div = sdiv i32 %N, 2
  %0 = and i32 %N, -2
  %1 = icmp eq i32 %0, 2
...
for.cond5.preheader:                              ; preds = %for.end68, %for.cond5.preheader.lr.ph
  %twp.addr.0162 = phi ptr [ %twp, %for.cond5.preheader.lr.ph ], [ %twp.addr.1.lcssa, %for.end68 ]
...
for.body27.lr.ph:                                 ; preds = %for.cond25.preheader
  %scevgep = getelementptr double, ptr %twp.addr.0162, i32 -2
  br label %for.body27
...
for.body7:                                        ; preds = %for.body7.lr.ph, %for.body7
  ...
  %arrayidx = getelementptr inbounds double, ptr %data, i32 %mul8
  %2 = load double, ptr %arrayidx, align 4, !tbaa !1
  %add9 = or i32 %mul8, 1
  %arrayidx10 = getelementptr inbounds double, ptr %data, i32 %add9
  %3 = load double, ptr %arrayidx10, align 4, !tbaa !1
  %arrayidx11 = getelementptr inbounds double, ptr %data, i32 %mul
  %4 = load double, ptr %arrayidx11, align 4, !tbaa !1
  %sub = fsub double %4, %2
  store double %sub, ptr %arrayidx, align 4, !tbaa !1
  %add13 = or i32 %mul, 1
  %arrayidx14 = getelementptr inbounds double, ptr %data, i32 %add13
  %5 = load double, ptr %arrayidx14, align 4, !tbaa !1
  %sub15 = fsub double %5, %3
  store double %sub15, ptr %arrayidx10, align 4, !tbaa !1
  %6 = load double, ptr %arrayidx11, align 4, !tbaa !1
  %add19 = fadd double %2, %6
  store double %add19, ptr %arrayidx11, align 4, !tbaa !1
  %7 = load double, ptr %arrayidx14, align 4, !tbaa !1
  %add22 = fadd double %3, %7
  store double %add22, ptr %arrayidx14, align 4, !tbaa !1
...
for.body27:                                       ; preds = %for.inc67, %for.body27.lr.ph
  %twp.addr.1157 = phi ptr [ %twp.addr.0162, %for.body27.lr.ph ], [ %incdec.ptr28, %for.inc67 ]
  %a.0155 = phi i32 [ 1, %for.body27.lr.ph ], [ %inc, %for.inc67 ]
  %incdec.ptr = getelementptr inbounds double, ptr %twp.addr.1157, i32 1
  %8 = load double, ptr %twp.addr.1157, align 4, !tbaa !1
  %incdec.ptr28 = getelementptr inbounds double, ptr %twp.addr.1157, i32 2
  %9 = load double, ptr %incdec.ptr, align 4, !tbaa !1
...
for.body31:                                       ; preds = %for.body31.preheader, %for.body31
  ...
  %arrayidx39 = getelementptr inbounds double, ptr %data, i32 %mul38
  %10 = load double, ptr %arrayidx39, align 4, !tbaa !1
  %add40 = or i32 %mul38, 1
  %arrayidx41 = getelementptr inbounds double, ptr %data, i32 %add40
  %11 = load double, ptr %arrayidx41, align 4, !tbaa !1
  ...
  %arrayidx50 = getelementptr inbounds double, ptr %data, i32 %mul34
  %12 = load double, ptr %arrayidx50, align 4, !tbaa !1
  %sub51 = fsub double %12, %sub45
  store double %sub51, ptr %arrayidx39, align 4, !tbaa !1
  %add53 = or i32 %mul34, 1
  %arrayidx54 = getelementptr inbounds double, ptr %data, i32 %add53
  %13 = load double, ptr %arrayidx54, align 4, !tbaa !1
  %sub55 = fsub double %13, %add49
  store double %sub55, ptr %arrayidx41, align 4, !tbaa !1
  %14 = load double, ptr %arrayidx50, align 4, !tbaa !1
  %add59 = fadd double %sub45, %14
  store double %add59, ptr %arrayidx50, align 4, !tbaa !1
  %15 = load double, ptr %arrayidx54, align 4, !tbaa !1
  %add62 = fadd double %add49, %15
  store double %add62, ptr %arrayidx54, align 4, !tbaa !1
...
for.end68.loopexit:                               ; preds = %for.inc67
  %scevgep163 = getelementptr double, ptr %scevgep, i32 %mul64
  br label %for.end68

for.end68:                                        ; preds = %for.cond25.preheader, %for.end68.loopexit
  %twp.addr.1.lcssa = phi ptr [ %scevgep163, %for.end68.loopexit ], [ %twp.addr.0162, %for.cond25.preheader ]
...
attributes #0 = { mustprogress "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "pre_loopopt" "stack-protector-buffer-size"="8" "target-cpu"="pentium4" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }

...
; Verify that compiler does not abort for interchange case, see HIRLoopInterchange::getNearbyPermutation (std::abort)
...
define void @ccsd_idx1_wrk1_(double* noalias nocapture dereferenceable(8) %"ccsd_idx1_wrk1_$SISN", double* noalias nocapture readonly dereferenceable(8) %"ccsd_idx1_wrk1_$ERI1", i64* noalias nocapture readonly dereferenceable(8) %"ccsd_idx1_wrk1_$KLO") local_unnamed_addr #1 {
alloca_2:
  %"ccsd_idx1_wrk1_$KLO_fetch" = load i64, i64* %"ccsd_idx1_wrk1_$KLO", align 1

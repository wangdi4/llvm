...
define void @foo(i64 %i232, i8* %i231) {
entry:
 br label %loop

loop:                                            ; preds = %latch, %entry
  %i739 = phi i64 [ %i762, %latch ], [ %i232, %entry ]
  %i740 = phi i8* [ %i757, %latch ], [ getelementptr inbounds ([4096 x i8], [4096 x i8]* @log_name, i64 0, i64 0), %entry ]
  %i741 = phi i8* [ %i761, %latch ], [ %i231, %entry ]
  %i742 = getelementptr inbounds i8, i8* %i740, i64 1
  %i743 = load i8, i8* %i740, align 1
  store i8 %i743, i8* %i741, align 1
  %i744 = icmp eq i8 %i743, 0
  br i1 %i744, label %bb798, label %bb745

bb745:                                            ; preds = %loop
  %i746 = getelementptr inbounds i8, i8* %i741, i64 1
  %i747 = getelementptr inbounds i8, i8* %i740, i64 2
  %i748 = load i8, i8* %i742, align 1
  store i8 %i748, i8* %i746, align 1
  %i749 = icmp eq i8 %i748, 0
  br i1 %i749, label %bb798, label %bb750

bb750:                                            ; preds = %bb745
  %i751 = getelementptr inbounds i8, i8* %i741, i64 2
  %i752 = getelementptr inbounds i8, i8* %i740, i64 3
  %i753 = load i8, i8* %i747, align 1
  store i8 %i753, i8* %i751, align 1
  %i754 = icmp eq i8 %i753, 0
  br i1 %i754, label %bb798, label %bb755

bb755:                                            ; preds = %bb750
  %i756 = getelementptr inbounds i8, i8* %i741, i64 3
  %i757 = getelementptr inbounds i8, i8* %i740, i64 4
  %i758 = load i8, i8* %i752, align 1
  store i8 %i758, i8* %i756, align 1
  %i759 = icmp eq i8 %i758, 0
  br i1 %i759, label %bb798, label %latch

latch:                                            ; preds = %bb755
  %i761 = getelementptr inbounds i8, i8* %i741, i64 4
  %i762 = add i64 %i739, -4
  %i763 = icmp ugt i64 %i762, 4
  br i1 %i763, label %loop, label %bb764

bb764:                                            ; preds = %latch
  %i765 = phi i8* [ %i761, %latch ]
  %i766 = phi i64 [ %i762, %latch ]
  %i767 = phi i8* [ %i757, %latch ]
  ret void

bb798:                                            ; preds = %bb755, %bb750, %bb745, %loop
  %i799 = phi i8* [ %i742, %loop ], [ %i747, %bb745 ], [ %i752, %bb750 ], [ %i757, %bb755 ]
  ret void
}

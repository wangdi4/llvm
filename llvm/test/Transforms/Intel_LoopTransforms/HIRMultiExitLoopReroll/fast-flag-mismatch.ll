...
define dso_local float* @foo(float* noalias noundef readonly %A, float* noalias nocapture noundef readonly %B, float* noalias nocapture noundef readonly %C, i64 noundef %n) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  ...
  %arrayidx3 = getelementptr inbounds float, float* %C, i64 %mul
...
if.end:                                           ; preds = %for.body
  ...
  %3 = load float, float* %arrayidx9, align 4, !tbaa !3
  %arrayidx13 = getelementptr inbounds float, float* %C, i64 %add8
  %4 = load float, float* %arrayidx13, align 4, !tbaa !3
...
if.end20:                                         ; preds = %if.end
  %add22 = or i64 %mul, 2
  %arrayidx23 = getelementptr inbounds float, float* %A, i64 %add22
  %5 = load float, float* %arrayidx23, align 4, !tbaa !3
  %arrayidx27 = getelementptr inbounds float, float* %C, i64 %add22
  %6 = load float, float* %arrayidx27, align 4, !tbaa !3
...
if.end34:                                         ; preds = %if.end20
  ...
  %7 = load float, float* %arrayidx37, align 4, !tbaa !3
  %arrayidx41 = getelementptr inbounds float, float* %C, i64 %add36
  %8 = load float, float* %arrayidx41, align 4, !tbaa !3
...
cleanup49.loopexit.split.loop.exit:               ; preds = %if.end34
  %arrayidx37.lcssa = phi float* [ %arrayidx37, %if.end34 ]
  br label %cleanup49

cleanup49.loopexit.split.loop.exit98:             ; preds = %if.end20
  %arrayidx23.lcssa = phi float* [ %arrayidx23, %if.end20 ]
  br label %cleanup49

cleanup49.loopexit.split.loop.exit100:            ; preds = %if.end
  %arrayidx9.lcssa = phi float* [ %arrayidx9, %if.end ]
  br label %cleanup49

cleanup49.loopexit.split.loop.exit102:            ; preds = %for.body
  %arrayidx.lcssa = phi float* [ %arrayidx, %for.body ]
  br label %cleanup49
...
cleanup49:                                        ; preds = %cleanup49.loopexit, %cleanup49.loopexit.split.loop.exit, %cleanup49.loopexit.split.loop.exit98, %cleanup49.loopexit.split.loop.exit100, %cleanup49.loopexit.split.loop.exit102, %entry
  %t.0 = phi float* [ undef, %entry ], [ %arrayidx37.lcssa, %cleanup49.loopexit.split.loop.exit ], [ %arrayidx23.lcssa, %cleanup49.loopexit.split.loop.exit98 ], [ %arrayidx9.lcssa, %cleanup49.loopexit.split.loop.exit100 ], [ %arrayidx.lcssa, %cleanup49.loopexit.split.loop.exit102 ], [ undef, %cleanup49.loopexit ]
  ret float* %t.0
}

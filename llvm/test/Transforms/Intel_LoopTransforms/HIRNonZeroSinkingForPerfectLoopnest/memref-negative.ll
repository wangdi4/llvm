...
define void @dgemm_(ptr noalias nocapture readnone %"dgemm_$A", ptr noalias nocapture readonly %"dgemm_$B", ptr noalias nocapture %"dgemm_$C") local_unnamed_addr #0 {
alloca_0:
...
bb3:                                              ; preds = %bb35_endif, %alloca_0
  ...
  %"dgemm_$B_entry[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(double) nonnull %"dgemm_$B_entry[]", i64 %indvars.iv61)
...
bb17.preheader:                                   ; preds = %bb3
  %"dgemm_$C_entry[]10" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 8000, ptr elementtype(double) %"dgemm_$C", i64 %indvars.iv61)
  br label %bb17
...
bb17:                                             ; preds = %bb17, %bb17.preheader
  ...
  %"dgemm_$C_entry[]10[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(double) %"dgemm_$C_entry[]10", i64 %indvars.iv)
  %"dgemm_$C_entry[]10[]_fetch" = load double, ptr %"dgemm_$C_entry[]10[]", align 1

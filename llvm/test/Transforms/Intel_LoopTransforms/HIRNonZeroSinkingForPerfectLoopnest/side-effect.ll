...
define void @dgemm_(ptr noalias nocapture readonly %"dgemm_$A", ptr noalias nocapture readonly %"dgemm_$B", ptr noalias nocapture %"dgemm_$C", ptr noalias nocapture %"dgemm_$D") local_unnamed_addr #0 {
alloca_0:
  br label %bb3

bb3:                                              ; preds = %bb8, %alloca_0
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %bb8 ], [ 1, %alloca_0 ]
  %"dgemm_$B_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 8000, ptr elementtype(double) %"dgemm_$B", i64 %indvars.iv84)
  %"dgemm_$C_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 8000, ptr elementtype(double) %"dgemm_$C", i64 %indvars.iv84)
  %"dgemm_$D_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 8000, ptr elementtype(double) %"dgemm_$D", i64 %indvars.iv84)
  br label %bb7

bb7:                                              ; preds = %bb45_endif, %bb3
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %bb45_endif ], [ 1, %bb3 ]
  %"dgemm_$B_entry[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(double) %"dgemm_$B_entry[]", i64 %indvars.iv81)
...
bb21.preheader:                                   ; preds = %bb7
  %"dgemm_$A_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 8000, ptr elementtype(double) %"dgemm_$A", i64 %indvars.iv81)
  br label %bb21
...
bb21:                                             ; preds = %bb21, %bb21.preheader
  ...
  store double %sub, ptr %"dgemm_$C_entry[][]", align 1
  %0 = trunc i64 %indvars.iv to i32
  %int_cast = sitofp i32 %0 to double
  %"dgemm_$D_entry[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(double) %"dgemm_$D_entry[]", i64 %indvars.iv)
  store double %int_cast, ptr %"dgemm_$D_entry[][]", align 1

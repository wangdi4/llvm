...
define void @dgemm_(ptr noalias nocapture readonly %"dgemm_$A", ptr noalias nocapture readonly %"dgemm_$B", ptr noalias nocapture %"dgemm_$C", ptr noalias nocapture readonly %"dgemm_$D") local_unnamed_addr #0 {
alloca_0:
  %"dgemm_$B_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 8000, ptr elementtype(double) %"dgemm_$B", i64 0)
  %"dgemm_$D_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 8000, ptr elementtype(double) %"dgemm_$D", i64 0)
  %"dgemm_$C_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 8000, ptr elementtype(double) %"dgemm_$C", i64 0)
  br label %bb3

bb3:                                              ; preds = %bb40_endif, %alloca_0
  %indvars.iv73 = phi i64 [ %indvars.iv.next74, %bb40_endif ], [ 1, %alloca_0 ]
  %"dgemm_$B_entry[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(double) nonnull %"dgemm_$B_entry[]", i64 %indvars.iv73)
...
bb22:                                             ; preds = %bb22, %bb12_then
  ...
  %"dgemm_$C_entry[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(double) nonnull %"dgemm_$C_entry[]", i64 %indvars.iv)
...
bb12_then:                                        ; preds = %bb3
  %"dgemm_$D_entry[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr elementtype(double) nonnull %"dgemm_$D_entry[]", i64 %indvars.iv73)
  %"dgemm_$D_entry[][]_fetch" = load double, ptr %"dgemm_$D_entry[][]", align 1

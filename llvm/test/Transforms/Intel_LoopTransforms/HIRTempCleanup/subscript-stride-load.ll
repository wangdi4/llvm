...
define void @foo(ptr %ptr, ptr %stride_ptr, i64 %n) {
alloca_0:
...
loop:                                             ; preds = %loop, %loop
  ...
  %stride = load i64, ptr %stride_ptr, align 1
  %subs = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 %stride, ptr elementtype(i64) %ptr, i64 0)

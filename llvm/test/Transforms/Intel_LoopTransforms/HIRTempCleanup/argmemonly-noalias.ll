...
; Verify that we are able to forward substitute loads (%B)[i1] and (%A)[i1] in
; the presence of argmemonly function call @bar since it is writing to
; non-aliasing memory.

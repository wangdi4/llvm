...
define void @foo(i32 %t294, i64 %t295, i64 %t298, i32 %t79, float* %t23, float* %t27, float* %t28) {
entry:
  br label %loop
...
loop:                                              ; preds = %t327, %entry
  ...
  %t302 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* nonnull elementtype(float) %t23, i64 %t300) #6
  store float 0.000000e+00, float* %t302, align 1
  %t303 = icmp slt i32 %t79, %t301
  br i1 %t303, label %t327, label %t304

t304:                                              ; preds = %loop
  %t305 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* nonnull elementtype(float) getelementptr inbounds ([33 x float], [33 x float]* @module_mp_fast_sbm_mp_dropradii_, i64 0, i64 0), i64 %t300) #6
  %t306 = load float, float* %t305, align 1
...
t308:                                              ; preds = %t321, %t304
  ...
  %t312 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* nonnull elementtype(float) %t28, i64 %t310) #6
  %t313 = load float, float* %t312, align 1
  %t314 = fcmp fast ugt float %t313, %t306
  %t315 = add nsw i64 %t310, 1
  br i1 %t314, label %t321, label %t316

t316:                                              ; preds = %t308
  %t317 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* nonnull elementtype(float) %t27, i64 %t310) #6
  %t318 = load float, float* %t317, align 1
  %t319 = fadd fast float %t318, %t309
  store float %t319, float* %t302, align 1
...
declare float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8, i64, i64, float*, i64) #4

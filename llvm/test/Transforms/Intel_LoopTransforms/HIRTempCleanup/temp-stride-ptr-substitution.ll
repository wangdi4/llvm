...
define void @foo(i64** %ptr, i64 %stride, i64 %n) {
alloca_0:
...
loop:                                             ; preds = %loop, %loop
  ...
  %ptr.load = load i64*, i64** %ptr, align 1
  %subs = call i64* @llvm.intel.subscript.p0i64.i64.i64.p0i64.i64(i8 0, i64 0, i64 %stride, i64* elementtype(i64) %ptr.load, i64 0)

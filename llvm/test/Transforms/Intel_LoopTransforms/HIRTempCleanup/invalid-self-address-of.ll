...
define void @foo(ptr %ptr, ptr %lb_ptr, i64 %n) {
alloca_0:
...
loop:                                             ; preds = %loop, %loop
  ...
  %lb = load i64, ptr %lb_ptr, align 1
  %subs = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %lb, i64 8, ptr elementtype(i64) %ptr, i64 0)

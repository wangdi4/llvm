...
; Verify that we give up on forward substituting load (%B)[i1] in the presence
; of argmemonly function @bar() which can write to it. We do forward substitute
; non-aliasing load of (%A)[i1].

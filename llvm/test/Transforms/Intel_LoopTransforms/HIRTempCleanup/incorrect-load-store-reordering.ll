...
define void @foo(ptr %t11, i64 %t239) {
entry:
  br label %t240
...
t240:                                              ; preds = %t240, %entry
  ...
  %t244 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(i32) %t11, i64 %t241) #27
  %t245 = load i32, ptr %t244, align 1
  %t246 = add nsw i32 %t245, %t242
  store i32 %t242, ptr %t244, align 1

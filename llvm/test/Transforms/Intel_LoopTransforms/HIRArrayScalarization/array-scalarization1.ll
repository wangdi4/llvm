...
;CHECK:            |   %2 = (@x1)[0];
;CHECK:            |   %3 = (@B1)[0][i1 + 1];
;CHECK:            |   %[[ARRSC:array-scalarize[0-9]*]] = %2 + %3;
;CHECK:            |   %4 = (@x2)[0];
;CHECK:            |   %5 = (@B2)[0][i1 + 1];
;CHECK:            |   %[[ARRSC2:array-scalarize[0-9]*]] = %4 + %5;
;CHECK:            |   %6 = (@x3)[0];
;CHECK:            |   %7 = (@B3)[0][i1 + 1];
;CHECK:            |   %[[ARRSC3:array-scalarize[0-9]*]] = %6 + %7;
;CHECK:            |   %8 = (@x4)[0];
;CHECK:            |   %9 = (@B4)[0][i1 + 1];
;CHECK:            |   %[[ARRSC4:array-scalarize[0-9]*]] = %8 + %9;
;CHECK:            |   %10 = (@x1)[0];
;CHECK:            |   %12 = (@B1)[0][i1];
;CHECK:            |   %[[ARRSC5:array-scalarize[0-9]*]] = %10 + %12;
;CHECK:            |   %13 = (@x2)[0];
;CHECK:            |   %14 = (@B2)[0][i1];
;CHECK:            |   %[[ARRSC6:array-scalarize[0-9]*]] = %13 + %14;
;CHECK:            |   %15 = (@x3)[0];
;CHECK:            |   %16 = (@B3)[0][i1];
;CHECK:            |   %[[ARRSC7:array-scalarize[0-9]*]] = %15 + %16;
;CHECK:            |   %17 = (@x4)[0];
;CHECK:            |   %18 = (@B4)[0][i1];
;CHECK:            |   %[[ARRSC8:array-scalarize[0-9]*]] = %17 + %18;
;CHECK:            |   %19 = (@D)[0][1][i1 + 1];
;CHECK:            |   %20 = %[[ARRSC]];
;CHECK:            |   %21 = %[[ARRSC5]];

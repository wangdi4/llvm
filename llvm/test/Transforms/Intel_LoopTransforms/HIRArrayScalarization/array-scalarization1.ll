...
; RUN: opt -hir-create-function-level-region -hir-ssa-deconstruction -hir-pre-vec-complete-unroll -hir-arrayscalarization-test-launcher -disable-hir-arrayscalarization-test-launcher=false -run-hir-arrayscalarization-test-launcher-array-scalarization-symbases -hir-arrayscalarization-test-launcher-array-scalarization-symbases=42,59,60,61,62,63,64,65,67,68,70,73 -print-before=hir-arrayscalarization-test-launcher -print-after=hir-arrayscalarization-test-launcher -S < %s 2>&1 | FileCheck %s
; RUN: opt -aa-pipeline="basic-aa" -passes="hir-ssa-deconstruction,hir-pre-vec-complete-unroll,print<hir>,hir-arrayscalarization-test-launcher,print<hir>" -hir-create-function-level-region -disable-hir-arrayscalarization-test-launcher=false -run-hir-arrayscalarization-test-launcher-array-scalarization-symbases -hir-arrayscalarization-test-launcher-array-scalarization-symbases=59,60,61,62,63,64,65,67,68,70,73 -S < %s 2>&1  | FileCheck %s
;
...
;<73>               + END LOOP
;
;<70>               @llvm.lifetime.end.p0i8(400,  &((i8*)(%AM1)[0]));
;<71>               @llvm.lifetime.end.p0i8(400,  &((i8*)(%AA)[0]));
;<72>               ret ;
;<0>          END REGION
...
;CHECK:            |   %2 = (@x1)[0];
;CHECK:            |   %3 = (@B1)[0][i1 + 1];
;CHECK:            |   %array-scalarize = %2 + %3;
;CHECK:            |   %4 = (@x2)[0];
;CHECK:            |   %5 = (@B2)[0][i1 + 1];
;CHECK:            |   %array-scalarize19 = %4 + %5;
;CHECK:            |   %6 = (@x3)[0];
;CHECK:            |   %7 = (@B3)[0][i1 + 1];
;CHECK:            |   %array-scalarize22 = %6 + %7;
;CHECK:            |   %8 = (@x4)[0];
;CHECK:            |   %9 = (@B4)[0][i1 + 1];
;CHECK:            |   %array-scalarize25 = %8 + %9;
;CHECK:            |   %10 = (@x1)[0];
;CHECK:            |   %12 = (@B1)[0][i1];
;CHECK:            |   %array-scalarize28 = %10 + %12;
;CHECK:            |   %13 = (@x2)[0];
;CHECK:            |   %14 = (@B2)[0][i1];
;CHECK:            |   %array-scalarize31 = %13 + %14;
;CHECK:            |   %15 = (@x3)[0];
;CHECK:            |   %16 = (@B3)[0][i1];
;CHECK:            |   %array-scalarize34 = %15 + %16;
;CHECK:            |   %17 = (@x4)[0];
;CHECK:            |   %18 = (@B4)[0][i1];
;CHECK:            |   %array-scalarize37 = %17 + %18;
;CHECK:            |   %19 = (@D)[0][1][i1 + 1];
;CHECK:            |   %20 = %array-scalarize;
;CHECK:            |   %21 = %array-scalarize28;
;CHECK:            |   (@D)[0][1][i1 + 1] = %19 + %20 + %21;
;CHECK:            |   %19 = (@D)[0][2][i1 + 1];
;CHECK:            |   %20 = %array-scalarize19;
;CHECK:            |   %21 = %array-scalarize31;
;CHECK:            |   (@D)[0][2][i1 + 1] = %19 + %20 + %21;
;CHECK:            |   %19 = (@D)[0][3][i1 + 1];
;CHECK:            |   %20 = %array-scalarize22;
;CHECK:            |   %21 = %array-scalarize34;
;CHECK:            |   (@D)[0][3][i1 + 1] = %19 + %20 + %21;
;CHECK:            |   %19 = (@D)[0][4][i1 + 1];
;CHECK:            |   %20 = %array-scalarize25;
;CHECK:            |   %21 = %array-scalarize37;
;CHECK:            |   (@D)[0][4][i1 + 1] = %19 + %20 + %21;
;CHECK:            + END LOOP
;
;CHECK:            @llvm.lifetime.end.p0i8(400,  &((i8*)(%AM1)[0]));
...
entry:
  ...
  %arrayidx17 = getelementptr inbounds [100 x i32], [100 x i32]* %AM1, i64 0, i64 1, !intel-tbaa !2
  %arrayidx22 = getelementptr inbounds [100 x i32], [100 x i32]* %AM1, i64 0, i64 2, !intel-tbaa !2
  %arrayidx27 = getelementptr inbounds [100 x i32], [100 x i32]* %AM1, i64 0, i64 3, !intel-tbaa !2
  %arrayidx32 = getelementptr inbounds [100 x i32], [100 x i32]* %AM1, i64 0, i64 4, !intel-tbaa !2
  br label %for.body
...
for.body:                                         ; preds = %entry, %for.cond.cleanup35
  ...
  %2 = load  i32, i32* @x1, align 4, !tbaa !7
  %arrayidx = getelementptr inbounds [100 x i32], [100 x i32]* @B1, i64 0, i64 %indvars.iv74, !intel-tbaa !2
  %3 = load  i32, i32* %arrayidx, align 4, !tbaa !2
  %add = add nsw i32 %3, %2
  store  i32 %add, i32* %arrayidx1, align 4, !tbaa !2
  %4 = load  i32, i32* @x2, align 4, !tbaa !7
  %arrayidx3 = getelementptr inbounds [100 x i32], [100 x i32]* @B2, i64 0, i64 %indvars.iv74, !intel-tbaa !2
  %5 = load  i32, i32* %arrayidx3, align 4, !tbaa !2
  %add4 = add nsw i32 %5, %4
  store  i32 %add4, i32* %arrayidx5, align 8, !tbaa !2
  %6 = load  i32, i32* @x3, align 4, !tbaa !7
  %arrayidx7 = getelementptr inbounds [100 x i32], [100 x i32]* @B3, i64 0, i64 %indvars.iv74, !intel-tbaa !2
  %7 = load  i32, i32* %arrayidx7, align 4, !tbaa !2
  %add8 = add nsw i32 %7, %6
  store  i32 %add8, i32* %arrayidx9, align 4, !tbaa !2
  %8 = load  i32, i32* @x4, align 4, !tbaa !7
  %arrayidx11 = getelementptr inbounds [100 x i32], [100 x i32]* @B4, i64 0, i64 %indvars.iv74, !intel-tbaa !2
  %9 = load  i32, i32* %arrayidx11, align 4, !tbaa !2
  %add12 = add nsw i32 %9, %8
  store  i32 %add12, i32* %arrayidx13, align 16, !tbaa !2
  %10 = load  i32, i32* @x1, align 4, !tbaa !7
  %11 = add nsw i64 %indvars.iv74, -1
  %arrayidx15 = getelementptr inbounds [100 x i32], [100 x i32]* @B1, i64 0, i64 %11, !intel-tbaa !2
  %12 = load  i32, i32* %arrayidx15, align 4, !tbaa !2
  %add16 = add nsw i32 %12, %10
  store  i32 %add16, i32* %arrayidx17, align 4, !tbaa !2
  %13 = load  i32, i32* @x2, align 4, !tbaa !7
  %arrayidx20 = getelementptr inbounds [100 x i32], [100 x i32]* @B2, i64 0, i64 %11, !intel-tbaa !2
  %14 = load  i32, i32* %arrayidx20, align 4, !tbaa !2
  %add21 = add nsw i32 %14, %13
  store  i32 %add21, i32* %arrayidx22, align 8, !tbaa !2
  %15 = load  i32, i32* @x3, align 4, !tbaa !7
  %arrayidx25 = getelementptr inbounds [100 x i32], [100 x i32]* @B3, i64 0, i64 %11, !intel-tbaa !2
  %16 = load  i32, i32* %arrayidx25, align 4, !tbaa !2
  %add26 = add nsw i32 %16, %15
  store  i32 %add26, i32* %arrayidx27, align 4, !tbaa !2
  %17 = load  i32, i32* @x4, align 4, !tbaa !7
  %arrayidx30 = getelementptr inbounds [100 x i32], [100 x i32]* @B4, i64 0, i64 %11, !intel-tbaa !2
  %18 = load  i32, i32* %arrayidx30, align 4, !tbaa !2
  %add31 = add nsw i32 %18, %17
  store  i32 %add31, i32* %arrayidx32, align 16, !tbaa !2
  br label %for.body36
...
for.body36:                                       ; preds = %for.body, %for.body36
  ...
  %arrayidx40 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @D, i64 0, i64 %indvars.iv, i64 %indvars.iv74, !intel-tbaa !8
  %19 = load  i32, i32* %arrayidx40, align 4, !tbaa !8
  %arrayidx42 = getelementptr inbounds [100 x i32], [100 x i32]* %AA, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %20 = load  i32, i32* %arrayidx42, align 4, !tbaa !2
  %add43 = add nsw i32 %20, %19
  %arrayidx45 = getelementptr inbounds [100 x i32], [100 x i32]* %AM1, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %21 = load  i32, i32* %arrayidx45, align 4, !tbaa !2
  %add46 = add nsw i32 %add43, %21
  store  i32 %add46, i32* %arrayidx40, align 4, !tbaa !8

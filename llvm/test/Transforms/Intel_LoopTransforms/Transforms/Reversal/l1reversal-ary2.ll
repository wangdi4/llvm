...
; BEFORE:       |   %12 = {al:4}(%1)[-10 * i1 + %cond323330 + -1];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -1] = %12;
; BEFORE:       |   %13 = {al:4}(%1)[-10 * i1 + %cond323330 + -2];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -2] = %13;
; BEFORE:       |   %14 = {al:4}(%1)[-10 * i1 + %cond323330 + -3];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -3] = %14;
; BEFORE:       |   %15 = {al:4}(%1)[-10 * i1 + %cond323330 + -4];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -4] = %15;
; BEFORE:       |   %16 = {al:4}(%1)[-10 * i1 + %cond323330 + -5];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -5] = %16;
; BEFORE:       |   %17 = {al:4}(%1)[-10 * i1 + %cond323330 + -6];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -6] = %17;
; BEFORE:       |   %18 = {al:4}(%1)[-10 * i1 + %cond323330 + -7];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -7] = %18;
; BEFORE:       |   %19 = {al:4}(%1)[-10 * i1 + %cond323330 + -8];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -8] = %19;
; BEFORE:       |   %20 = {al:4}(%1)[-10 * i1 + %cond323330 + -9];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -9] = %20;
; BEFORE:       |   %21 = {al:4}(%1)[-10 * i1 + %cond323330 + -10];
; BEFORE:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -10] = %21;
; BEFORE:       + END LOOP
; BEFORE:    END REGION
;
;
...
; AFTER:       |   %12 = {al:4}(%1)[-10 * i1 + %cond323330 + -1];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -1] = %12;
; AFTER:       |   %13 = {al:4}(%1)[-10 * i1 + %cond323330 + -2];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -2] = %13;
; AFTER:       |   %14 = {al:4}(%1)[-10 * i1 + %cond323330 + -3];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -3] = %14;
; AFTER:       |   %15 = {al:4}(%1)[-10 * i1 + %cond323330 + -4];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -4] = %15;
; AFTER:       |   %16 = {al:4}(%1)[-10 * i1 + %cond323330 + -5];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -5] = %16;
; AFTER:       |   %17 = {al:4}(%1)[-10 * i1 + %cond323330 + -6];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -6] = %17;
; AFTER:       |   %18 = {al:4}(%1)[-10 * i1 + %cond323330 + -7];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -7] = %18;
; AFTER:       |   %19 = {al:4}(%1)[-10 * i1 + %cond323330 + -8];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -8] = %19;
; AFTER:       |   %20 = {al:4}(%1)[-10 * i1 + %cond323330 + -9];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -9] = %20;
; AFTER:       |   %21 = {al:4}(%1)[-10 * i1 + %cond323330 + -10];
; AFTER:       |   {al:4}(%2)[-10 * i1 + %cond323330 + -10] = %21;
; AFTER:       + END LOOP
; AFTER:    END REGION
;
;

...
;<4>             |   %1 = {vol}{al:4}(@B)[0][-1 * i1 + 10][i1];
;<8>             |   {vol}{al:8}(@A)[0][-1 * i1 + 10][2] = -1 * i1 + %1;
;<11>            |   %4 = {vol}{al:8}(@B)[0][-1 * i1 + 20][2];
;<16>            |   {vol}{al:4}(@A)[0][1][-1 * i1 + 20] = 2 * i1 + %4;
;<23>            + END LOOP
;          END REGION
;
; 
...
; BEFORE:        |   %1 = {vol}{al:4}(@B)[0][-1 * i1 + 10][i1];
; BEFORE:        |   {vol}{al:8}(@A)[0][-1 * i1 + 10][2] = -1 * i1 + %1;
; BEFORE:        |   %4 = {vol}{al:8}(@B)[0][-1 * i1 + 20][2];
; BEFORE:        |   {vol}{al:4}(@A)[0][1][-1 * i1 + 20] = 2 * i1 + %4;
; BEFORE:         + END LOOP
; BEFORE:  END REGION
;
; === -------------------------------------- ===
...
; AFTER:        |   %1 = {vol}{al:4}(@B)[0][-1 * i1 + 10][i1];
; AFTER:        |   {vol}{al:8}(@A)[0][-1 * i1 + 10][2] = -1 * i1 + %1;
; AFTER:        |   %4 = {vol}{al:8}(@B)[0][-1 * i1 + 20][2];
; AFTER:        |   {vol}{al:4}(@A)[0][1][-1 * i1 + 20] = 2 * i1 + %4;
; AFTER:         + END LOOP
; AFTER:  END REGION
; 
;

; RUN: opt -hir-ssa-deconstruction -hir-complete-unroll -hir-complete-unroll-trip-threshold=64 -print-before=hir-complete-unroll -print-after=hir-complete-unroll 2>&1 < %s | FileCheck %s

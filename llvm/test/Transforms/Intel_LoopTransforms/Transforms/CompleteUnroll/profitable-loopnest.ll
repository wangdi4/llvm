...
; |   + DO i2 = 0, 2, 1   <DO_LOOP>
; |   |   %0 = {al:1}(%base)[3 * %conv.i * i1 + 3 * i2 + 3 * ((%add.i.us * %conv.i) + %add36.i.us)];
; |   |   %conv41.us.i.us = uitofp.i8.float(%0);
; |   |   %1 = {al:4}(@_ZZ13sharpen_imagePK5ImagePS_E6kernel)[0][3 * i1 + i2];
; |   |   %mul45.us.i.us = %conv41.us.i.us  *  %1;
; |   |   %r.1192.us.i.us = %mul45.us.i.us  +  %r.1192.us.i.us;
; |   |   %2 = {al:1}(%base)[3 * %conv.i * i1 + 3 * i2 + 3 * ((%add.i.us * %conv.i) + %add36.i.us) + 1];
; |   |   %conv48.us.i.us = uitofp.i8.float(%2);
; |   |   %mul52.us.i.us = %conv48.us.i.us  *  %1;
; |   |   %g.1189.us.i.us = %mul52.us.i.us  +  %g.1189.us.i.us;
; |   |   %3 = {al:1}(%base)[3 * %conv.i * i1 + 3 * i2 + 3 * ((%add.i.us * %conv.i) + %add36.i.us) + 2];

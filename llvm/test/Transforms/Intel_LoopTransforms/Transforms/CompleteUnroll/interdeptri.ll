...
; RUN: opt -hir-ssa-deconstruction -hir-complete-unroll -print-after=hir-complete-unroll -hir-complete-unroll-trip-threshold=50 2>&1 < %s | FileCheck %s

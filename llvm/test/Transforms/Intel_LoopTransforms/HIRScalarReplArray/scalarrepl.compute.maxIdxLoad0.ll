; RUN: opt -mem2reg -loop-rotate -hir-ssa-deconstruction -hir-temp-cleanup -hir-scalarrepl-array -print-before=hir-scalarrepl-array -print-after=hir-scalarrepl-array -disable-output < %s 2>&1 | FileCheck %s
; RUN: opt -passes="mem2reg,loop(rotate),hir-ssa-deconstruction,hir-temp-cleanup,print<hir>,hir-scalarrepl-array,print<hir>" -aa-pipeline="basic-aa" -disable-output < %s 2>&1 | FileCheck %s
;
...
if.else:                                          ; preds = %entry
  ...
  store i32 %call, i32* %ITER, align 4
  br label %if.end
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx = getelementptr inbounds [301 x i64], [301 x i64]* @flags1, i64 0, i64 %idxprom
  store i64 %conv, i64* %arrayidx, align 8
  %8 = load i32, i32* %j, align 4
  store i32 %8, i32* %k, align 4
  %9 = load i32, i32* %j, align 4
  %idxprom5 = sext i32 %9 to i64
  %arrayidx6 = getelementptr inbounds [301 x i64], [301 x i64]* @flags1, i64 0, i64 %idxprom5
  ...
  %arrayidx12 = getelementptr inbounds [301 x i64], [301 x i64]* @flags2, i64 0, i64 %idxprom11
  store i64 %add10, i64* %arrayidx12, align 8
  %14 = load i32, i32* %j, align 4
  store i32 %14, i32* %l, align 4
  %15 = load i32, i32* %k, align 4
  %idxprom13 = sext i32 %15 to i64
  %arrayidx14 = getelementptr inbounds [301 x i64], [301 x i64]* @flags2, i64 0, i64 %idxprom13
  ...
  %arrayidx22 = getelementptr inbounds [301 x i64], [301 x i64]* @flags3, i64 0, i64 %idxprom21
  store i64 %add20, i64* %arrayidx22, align 8
  %21 = load i32, i32* %j, align 4
  store i32 %21, i32* %m, align 4
  %22 = load i32, i32* %l, align 4
  %idxprom23 = sext i32 %22 to i64
  %arrayidx24 = getelementptr inbounds [301 x i64], [301 x i64]* @flags3, i64 0, i64 %idxprom23
  ...
  %arrayidx34 = getelementptr inbounds [301 x i64], [301 x i64]* @flags4, i64 0, i64 %idxprom33
  store i64 %add32, i64* %arrayidx34, align 8
  ...
  %arrayidx36 = getelementptr inbounds [301 x i64], [301 x i64]* @flags1, i64 0, i64 %idxprom35
  %33 = load i64, i64* %arrayidx36, align 8
  %34 = load i32, i32* %k, align 4
  %idxprom37 = sext i32 %34 to i64
  %arrayidx38 = getelementptr inbounds [301 x i64], [301 x i64]* @flags2, i64 0, i64 %idxprom37
  %35 = load i64, i64* %arrayidx38, align 8
  %add39 = add nsw i64 %33, %35
  %36 = load i32, i32* %l, align 4
  %idxprom40 = sext i32 %36 to i64
  %arrayidx41 = getelementptr inbounds [301 x i64], [301 x i64]* @flags3, i64 0, i64 %idxprom40
  %37 = load i64, i64* %arrayidx41, align 8
  %add42 = add nsw i64 %add39, %37
  %38 = load i32, i32* %m, align 4
  %idxprom43 = sext i32 %38 to i64
  %arrayidx44 = getelementptr inbounds [301 x i64], [301 x i64]* @flags4, i64 0, i64 %idxprom43
  ...
  %arrayidx48 = getelementptr inbounds [301 x i64], [301 x i64]* @flags2, i64 0, i64 %idxprom47
  %43 = load i64, i64* %arrayidx48, align 8
  %sub49 = sub nsw i64 %add45, %43
  %44 = load i32, i32* %j, align 4
  %idxprom50 = sext i32 %44 to i64
  %arrayidx51 = getelementptr inbounds [301 x i64], [301 x i64]* @flags1, i64 0, i64 %idxprom50
  store i64 %sub49, i64* %arrayidx51, align 8
  br label %for.inc
...
for.end54:                                        ; preds = %for.cond
  %47 = load i64, i64* getelementptr inbounds ([301 x i64], [301 x i64]* @flags1, i64 0, i64 0), align 16
  %48 = load i64, i64* getelementptr inbounds ([301 x i64], [301 x i64]* @flags1, i64 0, i64 1), align 8
  %49 = load i64, i64* getelementptr inbounds ([301 x i64], [301 x i64]* @flags1, i64 0, i64 299), align 8
  %50 = load i64, i64* getelementptr inbounds ([301 x i64], [301 x i64]* @flags1, i64 0, i64 300), align 16
  %call55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i64 %47, i64 %48, i64 %49, i64 %50)
  ret i32 0
}

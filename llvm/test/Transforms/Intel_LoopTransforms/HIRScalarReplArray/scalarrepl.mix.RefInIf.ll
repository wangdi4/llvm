...
for.body:                                         ; preds = %for.cond.backedge, %entry
  ...
  store  i32 %add3, ptr %arrayidx6, align 4, !tbaa !1
...
if.then:                                          ; preds = %for.body
  %arrayidx10 = getelementptr inbounds [100 x i32], ptr @B, i64 0, i64 %2
  %3 = load  i32, ptr %arrayidx10, align 4, !tbaa !1
  %arrayidx12 = getelementptr inbounds [100 x i32], ptr @B, i64 0, i64 %indvars.iv
  store  i32 %3, ptr %arrayidx12, align 4, !tbaa !1
  br label %for.cond.backedge

for.end:                                          ; preds = %for.cond.backedge
  %4 = load  i32, ptr @A, align 16, !tbaa !1
  %5 = load  i32, ptr getelementptr inbounds ([100 x i32], ptr @B, i64 0, i64 1), align 4, !tbaa !1
  %6 = load  i32, ptr getelementptr inbounds ([100 x i32], ptr @C, i64 0, i64 2), align 8, !tbaa !1
  %add13 = add i32 %4, 1

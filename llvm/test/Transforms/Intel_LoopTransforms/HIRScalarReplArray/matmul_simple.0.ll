; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -hir-sinking-for-perfect-loopnest -hir-loop-blocking -hir-lmm -hir-unroll-and-jam -hir-loop-blocking-blocksize=128 -hir-vec-dir-insert -VPlanDriverHIR -hir-scalarrepl-array  -print-after=hir-scalarrepl-array -disable-output -S < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-sinking-for-perfect-loopnest,hir-loop-blocking,hir-lmm,hir-unroll-and-jam,hir-vec-dir-insert,vplan-driver-hir,hir-scalarrepl-array,print<hir>" -aa-pipeline="basic-aa" -hir-loop-blocking-blocksize=128 -disable-output < %s 2>&1 | FileCheck %s
;
...
;<70>               |   |   |   |   |   %temp5 = (@"main_$B")[0][128 * i1 + 4 * i4][128 * i2 + 4 * i5];
;<71>               |   |   |   |   |   %temp6 = (@"main_$B")[0][128 * i1 + 4 * i4 + 1][128 * i2 + 4 * i5];
;<72>               |   |   |   |   |   %temp7 = (@"main_$B")[0][128 * i1 + 4 * i4 + 2][128 * i2 + 4 * i5];
;<73>               |   |   |   |   |   %temp8 = (@"main_$B")[0][128 * i1 + 4 * i4 + 3][128 * i2 + 4 * i5];
;<74>               |   |   |   |   |   %temp9 = (@"main_$B")[0][128 * i1 + 4 * i4][128 * i2 + 4 * i5 + 1];
;<75>               |   |   |   |   |   %temp10 = (@"main_$B")[0][128 * i1 + 4 * i4 + 1][128 * i2 + 4 * i5 + 1];
;<76>               |   |   |   |   |   %temp11 = (@"main_$B")[0][128 * i1 + 4 * i4 + 2][128 * i2 + 4 * i5 + 1];
;<77>               |   |   |   |   |   %temp12 = (@"main_$B")[0][128 * i1 + 4 * i4 + 3][128 * i2 + 4 * i5 + 1];
;<78>               |   |   |   |   |   %temp13 = (@"main_$B")[0][128 * i1 + 4 * i4][128 * i2 + 4 * i5 + 2];
;<79>               |   |   |   |   |   %temp14 = (@"main_$B")[0][128 * i1 + 4 * i4 + 1][128 * i2 + 4 * i5 + 2];
;<80>               |   |   |   |   |   %temp15 = (@"main_$B")[0][128 * i1 + 4 * i4 + 2][128 * i2 + 4 * i5 + 2];
;<81>               |   |   |   |   |   %temp16 = (@"main_$B")[0][128 * i1 + 4 * i4 + 3][128 * i2 + 4 * i5 + 2];
;<56>               |   |   |   |   |   %temp = (@"main_$B")[0][128 * i1 + 4 * i4][128 * i2 + 4 * i5 + 3];
;<57>               |   |   |   |   |   %temp3 = (@"main_$B")[0][128 * i1 + 4 * i4 + 1][128 * i2 + 4 * i5 + 3];
;<58>               |   |   |   |   |   %temp4 = (@"main_$B")[0][128 * i1 + 4 * i4 + 2][128 * i2 + 4 * i5 + 3];
;<9>                |   |   |   |   |   %"main_$B[][]_fetch.9" = (@"main_$B")[0][128 * i1 + 4 * i4 + 3][128 * i2 + 4 * i5 + 3];
;<120>              |   |   |   |   |
;<120>              |   |   |   |   |   + DO i6 = 0, 127, 4   <DO_LOOP> <auto-vectorized> <novectorize>
;<121>              |   |   |   |   |   |   %.vec = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5][128 * i3 + i6];
;<122>              |   |   |   |   |   |   %.vec17 = %temp5  *  %.vec;
;<123>              |   |   |   |   |   |   %.vec18 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4][128 * i3 + i6];
;<124>              |   |   |   |   |   |   %.vec19 = %.vec17  +  %.vec18;
;<125>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4][128 * i3 + i6] = %.vec19;
;<126>              |   |   |   |   |   |   %.vec20 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5][128 * i3 + i6];
;<127>              |   |   |   |   |   |   %.vec21 = %temp6  *  %.vec20;
;<128>              |   |   |   |   |   |   %.vec22 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 1][128 * i3 + i6];
;<129>              |   |   |   |   |   |   %.vec23 = %.vec21  +  %.vec22;
;<130>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 1][128 * i3 + i6] = %.vec23;
;<131>              |   |   |   |   |   |   %.vec24 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5][128 * i3 + i6];
;<132>              |   |   |   |   |   |   %.vec25 = %temp7  *  %.vec24;
;<133>              |   |   |   |   |   |   %.vec26 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 2][128 * i3 + i6];
;<134>              |   |   |   |   |   |   %.vec27 = %.vec25  +  %.vec26;
;<135>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 2][128 * i3 + i6] = %.vec27;
;<136>              |   |   |   |   |   |   %.vec28 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5][128 * i3 + i6];
;<137>              |   |   |   |   |   |   %.vec29 = %temp8  *  %.vec28;
;<138>              |   |   |   |   |   |   %.vec30 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 3][128 * i3 + i6];
;<139>              |   |   |   |   |   |   %.vec31 = %.vec29  +  %.vec30;
;<140>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 3][128 * i3 + i6] = %.vec31;
;<141>              |   |   |   |   |   |   %.vec32 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 1][128 * i3 + i6];
;<142>              |   |   |   |   |   |   %.vec33 = %temp9  *  %.vec32;
;<143>              |   |   |   |   |   |   %.vec34 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4][128 * i3 + i6];
;<144>              |   |   |   |   |   |   %.vec35 = %.vec33  +  %.vec34;
;<145>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4][128 * i3 + i6] = %.vec35;
;<146>              |   |   |   |   |   |   %.vec36 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 1][128 * i3 + i6];
;<147>              |   |   |   |   |   |   %.vec37 = %temp10  *  %.vec36;
;<148>              |   |   |   |   |   |   %.vec38 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 1][128 * i3 + i6];
;<149>              |   |   |   |   |   |   %.vec39 = %.vec37  +  %.vec38;
;<150>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 1][128 * i3 + i6] = %.vec39;
;<151>              |   |   |   |   |   |   %.vec40 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 1][128 * i3 + i6];
;<152>              |   |   |   |   |   |   %.vec41 = %temp11  *  %.vec40;
;<153>              |   |   |   |   |   |   %.vec42 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 2][128 * i3 + i6];
;<154>              |   |   |   |   |   |   %.vec43 = %.vec41  +  %.vec42;
;<155>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 2][128 * i3 + i6] = %.vec43;
;<156>              |   |   |   |   |   |   %.vec44 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 1][128 * i3 + i6];
;<157>              |   |   |   |   |   |   %.vec45 = %temp12  *  %.vec44;
;<158>              |   |   |   |   |   |   %.vec46 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 3][128 * i3 + i6];
;<159>              |   |   |   |   |   |   %.vec47 = %.vec45  +  %.vec46;
;<160>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 3][128 * i3 + i6] = %.vec47;
;<161>              |   |   |   |   |   |   %.vec48 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 2][128 * i3 + i6];
;<162>              |   |   |   |   |   |   %.vec49 = %temp13  *  %.vec48;
;<163>              |   |   |   |   |   |   %.vec50 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4][128 * i3 + i6];
;<164>              |   |   |   |   |   |   %.vec51 = %.vec49  +  %.vec50;
;<165>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4][128 * i3 + i6] = %.vec51;
;<166>              |   |   |   |   |   |   %.vec52 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 2][128 * i3 + i6];
;<167>              |   |   |   |   |   |   %.vec53 = %temp14  *  %.vec52;
;<168>              |   |   |   |   |   |   %.vec54 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 1][128 * i3 + i6];
;<169>              |   |   |   |   |   |   %.vec55 = %.vec53  +  %.vec54;
;<170>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 1][128 * i3 + i6] = %.vec55;
;<171>              |   |   |   |   |   |   %.vec56 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 2][128 * i3 + i6];
;<172>              |   |   |   |   |   |   %.vec57 = %temp15  *  %.vec56;
;<173>              |   |   |   |   |   |   %.vec58 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 2][128 * i3 + i6];
;<174>              |   |   |   |   |   |   %.vec59 = %.vec57  +  %.vec58;
;<175>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 2][128 * i3 + i6] = %.vec59;
;<176>              |   |   |   |   |   |   %.vec60 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 2][128 * i3 + i6];
;<177>              |   |   |   |   |   |   %.vec61 = %temp16  *  %.vec60;
;<178>              |   |   |   |   |   |   %.vec62 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 3][128 * i3 + i6];
;<179>              |   |   |   |   |   |   %.vec63 = %.vec61  +  %.vec62;
;<180>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 3][128 * i3 + i6] = %.vec63;
;<181>              |   |   |   |   |   |   %.vec64 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 3][128 * i3 + i6];
;<182>              |   |   |   |   |   |   %.vec65 = %temp  *  %.vec64;
;<183>              |   |   |   |   |   |   %.vec66 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4][128 * i3 + i6];
;<184>              |   |   |   |   |   |   %.vec67 = %.vec65  +  %.vec66;
;<185>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4][128 * i3 + i6] = %.vec67;
;<186>              |   |   |   |   |   |   %.vec68 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 3][128 * i3 + i6];
;<187>              |   |   |   |   |   |   %.vec69 = %temp3  *  %.vec68;
;<188>              |   |   |   |   |   |   %.vec70 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 1][128 * i3 + i6];
;<189>              |   |   |   |   |   |   %.vec71 = %.vec69  +  %.vec70;
;<190>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 1][128 * i3 + i6] = %.vec71;
;<191>              |   |   |   |   |   |   %.vec72 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 3][128 * i3 + i6];
;<192>              |   |   |   |   |   |   %.vec73 = %temp4  *  %.vec72;
;<193>              |   |   |   |   |   |   %.vec74 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 2][128 * i3 + i6];
;<194>              |   |   |   |   |   |   %.vec75 = %.vec73  +  %.vec74;
;<195>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 2][128 * i3 + i6] = %.vec75;
;<196>              |   |   |   |   |   |   %.vec76 = (<4 x double>*)(@"main_$A")[0][128 * i2 + 4 * i5 + 3][128 * i3 + i6];
;<197>              |   |   |   |   |   |   %.vec77 = %"main_$B[][]_fetch.9"  *  %.vec76;
;<198>              |   |   |   |   |   |   %.vec78 = (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 3][128 * i3 + i6];
;<199>              |   |   |   |   |   |   %.vec79 = %.vec77  +  %.vec78;
;<200>              |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[0][128 * i1 + 4 * i4 + 3][128 * i3 + i6] = %.vec79;
;<120>              |   |   |   |   |   + END LOOP
;<68>               |   |   |   |   + END LOOP
;<52>               |   |   |   + END LOOP
;<44>               |   |   + END LOOP
...
alloca_0:
  %func_result = tail call i32 @for_set_reentrancy(i32* nonnull @0) #3
  br label %bb1
...
bb9:                                              ; preds = %bb9, %bb5
  ...
  store double %add.1, double* %"main_$C[][]", align 1

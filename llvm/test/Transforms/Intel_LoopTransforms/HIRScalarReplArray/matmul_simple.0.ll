...
;<120>              |   |   |   |   |
;<120>              |   |   |   |   |   + DO i6 = 0, 127, 4   <DO_LOOP> <auto-vectorized> <novectorize>
; CHECK:            |   |   |   |   |   |   %scalarepl.vec[[NUM0:[0-9]+]] = (<4 x double>*)(@"main_$A")[128 * i2 + 4 * i5][128 * i3 + i6];
; CHECK:            |   |   |   |   |   |   %.vec = %scalarepl.vec[[NUM0]];
; CHECK:            |   |   |   |   |   |   %.vec17 = %temp5  *  %.vec;
; CHECK:            |   |   |   |   |   |   %scalarepl.vec = (<4 x double>*)(@"main_$C")[128 * i1 + 4 * i4][128 * i3 + i6];
...
; CHECK:            |   |   |   |   |   |   %scalarepl.vec[[NUM1:[0-9]+]] = (<4 x double>*)(@"main_$C")[128 * i1 + 4 * i4 + 1][128 * i3 + i6];
...
; CHECK:            |   |   |   |   |   |   %scalarepl.vec[[NUM2:[0-9]+]] = (<4 x double>*)(@"main_$C")[128 * i1 + 4 * i4 + 2][128 * i3 + i6];
...
; CHECK:            |   |   |   |   |   |   %scalarepl.vec[[NUM3:[0-9]+]] = (<4 x double>*)(@"main_$C")[128 * i1 + 4 * i4 + 3][128 * i3 + i6];
; CHECK:            |   |   |   |   |   |   %.vec30 = %scalarepl.vec[[NUM3]];
; CHECK:            |   |   |   |   |   |   %.vec31 = %.vec29  +  %.vec30;
; CHECK:            |   |   |   |   |   |   %scalarepl.vec[[NUM3]] = %.vec31;
; CHECK:            |   |   |   |   |   |   %scalarepl.vec[[NUM4:[0-9]+]] = (<4 x double>*)(@"main_$A")[128 * i2 + 4 * i5 + 1][128 * i3 + i6];
...
; CHECK:            |   |   |   |   |   |   %scalarepl.vec[[NUM5:[0-9]+]] = (<4 x double>*)(@"main_$A")[128 * i2 + 4 * i5 + 2][128 * i3 + i6];
...
; CHECK:            |   |   |   |   |   |   %scalarepl.vec[[NUM6:[0-9]+]] = (<4 x double>*)(@"main_$A")[128 * i2 + 4 * i5 + 3][128 * i3 + i6];
...
; CHECK:            |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[128 * i1 + 4 * i4][128 * i3 + i6] = %scalarepl.vec;
...
; CHECK:            |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[128 * i1 + 4 * i4 + 1][128 * i3 + i6] = %scalarepl.vec[[NUM1]];
...
; CHECK:            |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[128 * i1 + 4 * i4 + 2][128 * i3 + i6] = %scalarepl.vec[[NUM2]];
...
; CHECK:            |   |   |   |   |   |   (<4 x double>*)(@"main_$C")[128 * i1 + 4 * i4 + 3][128 * i3 + i6] = %scalarepl.vec[[NUM3]];
;<120>              |   |   |   |   |   + END LOOP
;<68>               |   |   |   |   + END LOOP
;<52>               |   |   |   + END LOOP
;<44>               |   |   + END LOOP

; RUN: opt -hir-cost-model-throttling=0 -hir-ssa-deconstruction -hir-temp-cleanup -hir-scalarrepl-array -print-after=hir-scalarrepl-array -disable-output < %s 2>&1 | FileCheck %s

...
; Verify that we are able to scalar-replace group {(%A)[i1][i2], (%A)[i1][i2 + 1]}
; in the presence of ref (@A)[0][%t][i2 + 2] for which we cannot compute distance
; w.r.t other refs
...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %arrayidx15 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* @A, i64 0, i64 %idxprom11, i64 %2

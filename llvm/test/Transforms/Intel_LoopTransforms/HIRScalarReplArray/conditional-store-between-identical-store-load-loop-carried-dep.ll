...
; The loop carried lexically forward dependence of the store with load of
; (@A)[0][i1] is preserved even with the transformation so it doesn't prevent
; vectorization.

...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3
  ...
  %2 = load i32, ptr getelementptr inbounds ([1000 x [1000 x i32]], ptr @C, i64 0, i64 2, i64 2), align 8, !tbaa !1
  %3 = load i32, ptr getelementptr inbounds ([1000 x i32], ptr @D, i64 0, i64 3), align 4, !tbaa !1
  %add23 = add i32 %0, 1
...
for.cond.cleanup3:                                ; preds = %for.body4
  %arrayidx10 = getelementptr inbounds [1000 x i32], ptr @A, i64 0, i64 %indvars.iv41
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %arrayidx8 = getelementptr inbounds [1000 x [1000 x i32]], ptr @C, i64 0, i64 %indvars.iv, i64 %indvars.iv41
  %5 = load i32, ptr %arrayidx8, align 4, !tbaa !1
  %add = add nsw i32 %5, %4
  %arrayidx14 = getelementptr inbounds [1000 x i32], ptr @D, i64 0, i64 %indvars.iv
  %6 = load i32, ptr %arrayidx14, align 4, !tbaa !1

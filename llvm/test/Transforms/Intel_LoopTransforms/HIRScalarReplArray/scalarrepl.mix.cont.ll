...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [1000 x i32], ptr @D, i64 0, i64 %indvars.iv
  ...
  %4 = load i32, ptr %arrayidx9, align 4, !tbaa !1
  %add10 = add nsw i32 %4, %add3
  %5 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx13 = getelementptr inbounds [1000 x i32], ptr @A, i64 0, i64 %5
  store i32 %add10, ptr %arrayidx13, align 4, !tbaa !1

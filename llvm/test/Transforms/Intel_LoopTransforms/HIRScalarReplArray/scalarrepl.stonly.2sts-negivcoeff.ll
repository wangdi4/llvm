...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  %1 = load  i32, ptr getelementptr inbounds ([1002 x i32], ptr @B, i64 0, i64 1), align 4, !tbaa !1
  %add8 = add i32 %0, 1
  %add9 = add i32 %add8, %1
  ret i32 %add9
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [1002 x i32], ptr @B, i64 0, i64 %2
  %3 = trunc i64 %indvars.iv.next to i32
  store  i32 %3, ptr %arrayidx, align 4, !tbaa !1
  %arrayidx3 = getelementptr inbounds [1002 x i32], ptr @A, i64 0, i64 %indvars.iv
  %4 = load  i32, ptr %arrayidx3, align 4, !tbaa !1
  %sub4 = add nsw i32 %4, -1
  %5 = sub nuw nsw i64 901, %indvars.iv
  %arrayidx7 = getelementptr inbounds [1002 x i32], ptr @B, i64 0, i64 %5
  store  i32 %sub4, ptr %arrayidx7, align 4, !tbaa !1

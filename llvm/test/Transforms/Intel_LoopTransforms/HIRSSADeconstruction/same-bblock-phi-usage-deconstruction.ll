...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx6 = getelementptr inbounds [100 x i32], ptr %u, i64 0, i64 %indvars.iv
  %add9 = add i32 %1, %2
  store i32 %add9, ptr %arrayidx6, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx14 = getelementptr inbounds [100 x i32], ptr %u, i64 0, i64 %indvars.iv.next
  %3 = load i32, ptr %arrayidx14, align 4
  %arrayidx17 = getelementptr inbounds [100 x i32], ptr %g, i64 0, i64 %indvars.iv.next
  %4 = load i32, ptr %arrayidx17, align 4
  %sub18 = sub i32 %3, %4
  %arrayidx20 = getelementptr inbounds [100 x i32], ptr %g, i64 0, i64 %indvars.iv

...
; This test checks that the innermost invariant If condition isn't hoisted out
; since the outer Ifs can't be hoisted and the innermost If is inside nested
; Ifs. It isn't profitable to hoist deeply nested Ifs as they might not even
; execute at runtime.
...
if.inner:
  ...
  br i1 %cmp3, label %if.inner2, label %for.inc

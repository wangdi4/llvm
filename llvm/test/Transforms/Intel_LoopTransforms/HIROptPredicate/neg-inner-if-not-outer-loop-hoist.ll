...
; This test checks that the inner If condition was not hoisted out since the
; outer If couldn't be hoisted and the inner If can't be moved out of the
; loopnest. This isn't allowed at the moment since moving the condition may
; affect the opportunity for other transformations like loop interchange and
; loop collapsing.

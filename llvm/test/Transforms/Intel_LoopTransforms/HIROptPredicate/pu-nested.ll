; RUN: opt -hir-details -hir-ssa-deconstruction -hir-temp-cleanup -hir-opt-predicate -hir-opt-predicate -disable-output -print-after=hir-opt-predicate < %s 2>&1 | FileCheck %s

...
; This test case checks that the non-linear partial unswitching will be
; applied when there is more than one candidate in the 'AND'd condition.
; Both predicates in the If condition are candidates for partial unswitching.
...
; This is the same test, but without hir-temp-cleanup. The temps won't be
; be cleaned in the If conditions.

...
; This test case checks that the Select instruction inside case 0 was
; converted into If/Else and unswitch was applied. Then, the unswitching for
; the Switch instruction is applied.

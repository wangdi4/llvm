...
;OPTREPORT: LOOP BEGIN at t.c (6, 3)
;OPTREPORT: <Predicate Optimized v2>
;OPTREPORT:     LOOP BEGIN at t.c (7, 5)
;OPTREPORT:     LOOP END
;OPTREPORT: LOOP END
...
for.body:                                         ; preds = %for.end, %entry
  %indvars.iv64 = phi i64 [ 1, %entry ], [ %indvars.iv.next65, %for.end ]
  call void @llvm.dbg.value(metadata i32 1, metadata !25, metadata !DIExpression()), !dbg !30
  call void @llvm.dbg.value(metadata i64 %indvars.iv64, metadata !24, metadata !DIExpression()), !dbg !27
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1, !dbg !31
...
for.inc:                                          ; preds = %for.body3, %if.then
  %exitcond = icmp eq i64 %indvars.iv.next, 1000, !dbg !60
...
!3 = !DIFile(filename: "t.c", directory: "/export/iusers/linayu/opt_report/llvm/test/Transforms/Intel_LoopTransforms/HIROptPredicate")
!4 = !{}
!5 = !{!6, !0, !12}
...
!59 = !DILocation(line: 11, column: 7, scope: !56)
!60 = !DILocation(line: 7, column: 17, scope: !38)
!61 = distinct !{!61, !33, !62}
!62 = !DILocation(line: 12, column: 5, scope: !34)
!63 = !DILocation(line: 13, column: 5, scope: !35)
!64 = !DILocation(line: 13, column: 13, scope: !35)
!65 = !DILocation(line: 6, column: 15, scope: !32)
!66 = distinct !{!66, !28, !67}
!67 = !DILocation(line: 14, column: 3, scope: !29)
!68 = !DILocation(line: 15, column: 1, scope: !19)

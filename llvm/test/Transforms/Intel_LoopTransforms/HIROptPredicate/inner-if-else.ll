...
; even if the outer If couldn't be hoisted. This case checks
; when there is an Then and Else branches in the inner condition.
...
if.then:
  ...
  br i1 %cmp2, label %if.inner, label %else.then

...
; OPTREPORT:     Remark #XXXXX: Invariant Condition at line 9 hoisted out of this loop
; OPTREPORT:     Remark #XXXXX: Invariant Condition at line 12 hoisted out of this loop
; OPTREPORT:     LOOP BEGIN at t1.c (7, 5)
; OPTREPORT:     LOOP END
; OPTREPORT: LOOP END
...
!19 = distinct !DISubprogram(name: "foo", scope: !3, file: !3, line: 4, type: !20, isLocal: false, isDefinition: true, scopeLine: 4, flags: DIFlagPrototyped, isOptimized: true, unit: !2, variables: !22)

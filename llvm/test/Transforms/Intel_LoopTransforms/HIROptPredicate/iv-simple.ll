...
; RUN: opt -passes="loop-simplify,hir-ssa-deconstruction,hir-opt-var-predicate,hir-cg,loop-simplifycfg,intel-ir-optreport-emitter" -aa-pipeline="basic-aa" -disable-output -intel-loop-optreport=low 2>&1 < %s -S | FileCheck %s -check-prefix=OPTREPORT
...
;Module Before HIR; ModuleID = 'iv-simple.c'
source_filename = "iv-simple.c"
...
if.then:                                          ; preds = %for.body
  %arrayidx = getelementptr inbounds i32, i32* %p, i64 %j.010

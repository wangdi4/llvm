...
; '%t > 1'. The goal of this test is that even two conditions are candidates for
; partial hoisting, the condition that can be hoisted outermost is selected.
...
for.inner.body:                                         ; preds = %entry, %for.inc
  ...
  %cmp1 = icmp sgt i32 %j.05, 5
  %cmp2 = icmp sgt i32 %t, 1
  %cmp3 = icmp ne i32 %i.05, 5
  %and = and i1 %cmp1, %cmp2
  %and2 = and i1 %and, %cmp3
  br i1 %and2, label %if.then, label %for.inner.inc
...
for.inner.inc:                                          ; preds = %if.end
  ...
  %cmp4 = icmp slt i32 %inc2, 100
  br i1 %cmp4, label %for.inner.body, label %for.inc

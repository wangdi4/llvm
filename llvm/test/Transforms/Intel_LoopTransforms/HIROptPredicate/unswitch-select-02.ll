...
alloca_3:
  ...
  %I_STARTBLK_fetch.103 = load i32, ptr %I_STARTBLK
  %I_ENDBLK_fetch.104 = load i32, ptr %I_ENDBLK
...
bb22.preheader:                                   ; preds = %alloca_3
  %I_STARTLEV_fetch.106 = load i32, ptr %I_STARTLEV
  %I_ENDLEV_fetch.107 = load i32, ptr %I_ENDLEV
  %rel.26 = icmp slt i32 %I_ENDLEV_fetch.107, %I_STARTLEV_fetch.106
  %I_STARTIDX_fetch.109 = load i32, ptr %I_STARTIDX
  %I_ENDIDX_fetch.110 = load i32, ptr %I_ENDIDX
...
bb26.preheader:                                   ; preds = %bb22
  %"BLKIDX[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.14, ptr nonnull elementtype(i32) %BLKIDX, i64 %indvars.iv85)
  %"ARRAY[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 %mul.17, ptr nonnull elementtype(double) %ARRAY, i64 %indvars.iv85)
  br label %bb26
...
bb30.preheader:                                   ; preds = %bb26
  %"BLKIDX[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(i32) %"BLKIDX[]", i64 %indvars.iv81)
  %"BLKIDX[][]_fetch.118" = load i32, ptr %"BLKIDX[][]"
  %rel.28 = icmp sgt i32 %"BLKIDX[][]_fetch.118", 0
  %slct.7 = select i1 %rel.28, i32 %"BLKIDX[][]_fetch.118", i32 1
  %"ARRAY[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.16, ptr nonnull elementtype(double) %"ARRAY[]", i64 %indvars.iv81)
  %int_sext33 = zext i32 %slct.7 to i64
  %"ARRAY[]34" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 %mul.17, ptr nonnull elementtype(double) %ARRAY, i64 %int_sext33)
  %"ARRAY[][]35" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.16, ptr nonnull elementtype(double) %"ARRAY[]34", i64 %indvars.iv81)
  br label %bb30

bb30:                                             ; preds = %bb30.preheader, %bb30
  %indvars.iv = phi i64 [ %0, %bb30.preheader ], [ %indvars.iv.next, %bb30 ]
  %"ARRAY[][][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"ARRAY[][]", i64 %indvars.iv)
  %"ARRAY[][][]_fetch.137" = load double, ptr %"ARRAY[][][]"
  ...
  %"ARRAY[][][]36" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"ARRAY[][]35", i64 %indvars.iv)
  store double %add.27, ptr %"ARRAY[][][]36"

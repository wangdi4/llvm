...
; CHECK: region.0:
; CHECK: loop.{{[0-9]+}}:
; CHECK: = load i32, ptr getelementptr inbounds (%struct.key, ptr @keytab, i64 0, i32 1)

%struct.key = type { ptr, i32 }
...
for.body:                                     ; preds = %for.body, %entry
  ...
  %gep1 = getelementptr inbounds [28 x %struct.key], ptr @keytab, i64 0, i64 0, i32 1

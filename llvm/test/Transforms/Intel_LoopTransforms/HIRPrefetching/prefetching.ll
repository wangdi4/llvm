...
;
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-prefetching" -hir-prefetching-skip-non-modified-regions="false" -hir-prefetching-skip-num-memory-streams-check="true" -hir-prefetching-skip-AVX2-check="true" 2>&1 -print-changed -disable-output < %s | FileCheck %s --check-prefix=CHECK-CHANGED
...
; CHECK-NEXT:      |   @llvm.prefetch.p0(&((i8*)(@A)[0][i1 + 7]),  0,  3,  1);
; CHECK-NEXT:      |   @llvm.prefetch.p0(&((i8*)(@A)[0][i1 + 100007]),  0,  3,  1);
; CHECK-NEXT:      |   @llvm.prefetch.p0(&((i8*)(@A)[0][i1 + 400007]),  0,  3,  1);
; CHECK-NEXT:      |   @llvm.prefetch.p0(&((i8*)(@A)[0][2 * i1 + 16]),  0,  3,  1);
; CHECK-NEXT:      |   @llvm.prefetch.p0(&((i8*)(@B)[0][i1 + 7]),  0,  3,  1);
; CHECK-NEXT:      |   @llvm.prefetch.p0(&((i8*)(@B)[0][2 * i1 + 18]),  0,  3,  1);
; CHECK-NEXT:      + END LOOP
; CHECK:     END  REGION
;
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [1000000 x i32], ptr @A, i64 0, i64 %indvars.iv.next, !intel-tbaa !2
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !2
  %1 = shl nuw nsw i64 %indvars.iv, 1
  %2 = add nuw nsw i64 %1, 2
  %arrayidx3 = getelementptr inbounds [1000000 x i32], ptr @A, i64 0, i64 %2, !intel-tbaa !2
  %3 = load i32, ptr %arrayidx3, align 8, !tbaa !2
  %add4 = add nsw i32 %3, %0
  %4 = add nuw nsw i64 %indvars.iv, 100000
  %arrayidx7 = getelementptr inbounds [1000000 x i32], ptr @A, i64 0, i64 %4, !intel-tbaa !2
  %5 = load i32, ptr %arrayidx7, align 4, !tbaa !2
  %add8 = add nsw i32 %add4, %5
  %6 = add nuw nsw i64 %indvars.iv, 400000
  %arrayidx11 = getelementptr inbounds [1000000 x i32], ptr @A, i64 0, i64 %6, !intel-tbaa !2
  %7 = load i32, ptr %arrayidx11, align 4, !tbaa !2
  %add12 = add nsw i32 %add8, %7
  %8 = add nuw nsw i64 %indvars.iv, 80000
  %arrayidx15 = getelementptr inbounds [1000000 x i32], ptr @A, i64 0, i64 %8, !intel-tbaa !2
  %9 = load i32, ptr %arrayidx15, align 4, !tbaa !2
  %add16 = add nsw i32 %add12, %9
  %10 = add nuw nsw i64 %indvars.iv, 24
  %arrayidx19 = getelementptr inbounds [1000000 x i32], ptr @A, i64 0, i64 %10, !intel-tbaa !2
  %11 = load i32, ptr %arrayidx19, align 4, !tbaa !2
  %add20 = add nsw i32 %add16, %11
  %12 = load i32, ptr getelementptr inbounds ([1000000 x i32], ptr @A, i64 0, i64 20), align 16, !tbaa !2
  %add21 = add nsw i32 %add20, %12
  %arrayidx23 = getelementptr inbounds [1000000 x i32], ptr @A, i64 0, i64 %indvars.iv, !intel-tbaa !2
  store i32 %add21, ptr %arrayidx23, align 4, !tbaa !2
  %arrayidx26 = getelementptr inbounds [1000000 x i32], ptr @B, i64 0, i64 %indvars.iv.next, !intel-tbaa !2
  %13 = load i32, ptr %arrayidx26, align 4, !tbaa !2
  %14 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx29 = getelementptr inbounds [1000000 x i32], ptr @B, i64 0, i64 %14, !intel-tbaa !2
  %15 = load i32, ptr %arrayidx29, align 4, !tbaa !2
  %add30 = add nsw i32 %15, %13
  %16 = add nuw nsw i64 %1, 4
  %arrayidx34 = getelementptr inbounds [1000000 x i32], ptr @B, i64 0, i64 %16, !intel-tbaa !2
  %17 = load i32, ptr %arrayidx34, align 8, !tbaa !2
  %add35 = add nsw i32 %add30, %17
  %18 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx38 = getelementptr inbounds [1000000 x i32], ptr @B, i64 0, i64 %18, !intel-tbaa !2
  %19 = load i32, ptr %arrayidx38, align 4, !tbaa !2
  %add39 = add nsw i32 %add35, %19
  %20 = add nuw nsw i64 %indvars.iv, 12
  %arrayidx42 = getelementptr inbounds [1000000 x i32], ptr @B, i64 0, i64 %20, !intel-tbaa !2
  %21 = load i32, ptr %arrayidx42, align 4, !tbaa !2
  %add43 = add nsw i32 %add39, %21
  %22 = add nuw nsw i64 %indvars.iv, 16
  %arrayidx46 = getelementptr inbounds [1000000 x i32], ptr @B, i64 0, i64 %22, !intel-tbaa !2
  %23 = load i32, ptr %arrayidx46, align 4, !tbaa !2
  %add47 = add nsw i32 %add43, %23
  %arrayidx49 = getelementptr inbounds [1000000 x i32], ptr @B, i64 0, i64 %indvars.iv, !intel-tbaa !2

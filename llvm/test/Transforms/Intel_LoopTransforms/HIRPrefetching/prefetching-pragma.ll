...
define dso_local noalias i8* @sub(float* %A, float* %B, float* %C, i32 %N) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %ptridx2 = getelementptr inbounds float, float* %2, i64 %indvars.iv
  %5 = load float, float* %ptridx2, align 4, !tbaa !6
  ...
  %ptridx6 = getelementptr inbounds float, float* %3, i64 %indvars.iv
  store float %conv4, float* %ptridx6, align 4, !tbaa !6

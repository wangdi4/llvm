...
; CHECK-NEXT: |   }
; CHECK-NEXT: |   @llvm.prefetch.p0i8(&((i8*)(@A)[0][i1 + 521]),  0,  3,  1);
; CHECK-NEXT: + END LOOP
...
define dso_local noalias i8* @sub(i32* nocapture readonly %M, i32 %N) {
entry:
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx1 = getelementptr inbounds [10000 x i32], [10000 x i32]* @A, i64 0, i64 %iv.add
  %1 = load i32, i32* %arrayidx1, align 4
  %arrayidx2 = getelementptr inbounds [10000 x i32], [10000 x i32]* @B, i64 0, i64 %indvars.iv
  %2 = load i32, i32* %arrayidx2, align 4
  %sext = sext i32 %2 to i64
  %arrayidx3 = getelementptr inbounds [10000 x i32], [10000 x i32]* @C, i64 0, i64 %sext
  %ld = load i32, i32* %arrayidx3, align 4

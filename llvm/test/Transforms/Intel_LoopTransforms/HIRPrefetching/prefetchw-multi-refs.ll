...
; CHECK:           |   %2 = (@A)[0][i1 + 5000];
; CHECK:           |   (@A)[0][i1 + 1] = %0 + %2;
; CHECK:           |   @llvm.prefetch.p0i8(&((i8*)(@A)[0][i1 + 40]),  1,  3,  1);
; CHECK:           |   @llvm.prefetch.p0i8(&((i8*)(@A)[0][i1 + 5040]),  0,  3,  1);
; CHECK:           + END LOOP
; CHECK:     END REGION
;
;Module Before HIR
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx2 = getelementptr inbounds [10000 x i32], [10000 x i32]* @A, i64 0, i64 %1, !intel-tbaa !2
  %2 = load i32, i32* %arrayidx2, align 4, !tbaa !2
  %add3 = add nsw i32 %2, %0
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx6 = getelementptr inbounds [10000 x i32], [10000 x i32]* @A, i64 0, i64 %indvars.iv.next, !intel-tbaa !2

...
; CHECK-NEXT:           |      @llvm.prefetch.p0(&((i8*)(@A)[0][%Load]),  1,  2,  1);
; CHECK-NEXT:           |   }
; CHECK-NEXT:           |   @llvm.prefetch.p0(&((i8*)(@B)[0][i1 + 32]),  0,  3,  1);
; CHECK-NEXT:           |   @llvm.prefetch.p0(&((i8*)(@C)[0][i1 + 32]),  0,  3,  1);
; CHECK-NEXT:           + END LOOP
;
; CHECK:                ret ;
; CHECK:         END REGION
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx = getelementptr inbounds [100000 x i32], ptr @B, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %1 = load i32, ptr %arrayidx, align 4, !tbaa !2
  %arrayidx2 = getelementptr inbounds [100000 x i32], ptr @C, i64 0, i64 %indvars.iv, !intel-tbaa !2
  ...
  %arrayidx5 = getelementptr inbounds [100000 x i32], ptr @A, i64 0, i64 %idxprom4, !intel-tbaa !2

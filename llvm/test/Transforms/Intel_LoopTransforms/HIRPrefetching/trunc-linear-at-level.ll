...
; RUN: opt -passes="hir-ssa-deconstruction,hir-prefetching" -hir-prefetching-num-cachelines-threshold=1 -hir-prefetching-skip-non-modified-regions=false -hir-prefetching-num-memory-streams-threshold=1 -hir-prefetching-skip-AVX2-check=true -hir-details -print-after=hir-prefetching 2>&1 < %s -disable-output | FileCheck %s
...
; CHECK: |   (%A)[i1] = i1;
; CHECK: |   <LVAL-REG> {al:4}(LINEAR ptr %A)[LINEAR trunc.i64.i32(i1)]
; CHECK: |   @llvm.prefetch.p0(&((i8*)(%A)[i1 + 140]),  0,  3,  1);
; CHECK: + END LOOP


target datalayout = "e-m:e-p:32:32-i64:64-f80:128-n8:16:32:64-S128"

define dso_local void @foo(i32 %n, ptr %A) {
entry:
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds i32, ptr %A, i32 %0

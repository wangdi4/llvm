...
; CHECK:           |   @llvm.prefetch.p0i8(&((i8*)(@M)[0][i1 + 23]),  0,  3,  1);
; CHECK:           + END LOOP
;
; CHECK:           ret ;
; CHECK:     END REGION
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx4 = getelementptr inbounds [1000 x i32], [1000 x i32]* @M, i64 0, i64 %3, !intel-tbaa !3
  ...
  %arrayidx8 = getelementptr inbounds [1000 x float], [1000 x float]* @A, i64 0, i64 %indvars.iv, !intel-tbaa !8
  store float %add, float* %arrayidx8, align 4, !tbaa !8

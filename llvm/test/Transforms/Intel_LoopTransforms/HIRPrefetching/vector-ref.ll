...
; MERGED-CFG:        |   @llvm.prefetch.p0(&((i8*)(@A)[0][i1 + 256][0]),  0,  3,  1);
; MERGED-CFG:        |   @llvm.prefetch.p0(&((i8*)(@A)[0][i1 + 257][0]),  0,  3,  1);
; MERGED-CFG:        |   @llvm.prefetch.p0(&((i8*)(@A)[0][i1 + 258][0]),  0,  3,  1);
; MERGED-CFG:        |   @llvm.prefetch.p0(&((i8*)(@A)[0][i1 + 259][0]),  0,  3,  1);
; MERGED-CFG:        + END LOOP

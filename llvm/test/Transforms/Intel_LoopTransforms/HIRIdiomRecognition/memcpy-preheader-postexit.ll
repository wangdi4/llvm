; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-idiom" -print-before=hir-idiom -print-after=hir-idiom -disable-output < %s 2>&1 | FileCheck %s
...
; CHECK: if (%n >u 12)
; CHECK: {
; CHECK:    @llvm.memcpy.p0i8.p0i8.i32(&((i8*)(%r)[0]),  &((i8*)(%p)[0]),  4 * %n,  0);
; CHECK:    @llvm.memcpy.p0i8.p0i8.i32(&((i8*)(%p)[0]),  &((i8*)(%q)[0]),  4 * %n,  0);
; CHECK: }
; CHECK: else
; CHECK: {
...
define void @foo(i32* nocapture %p, i32* noalias nocapture readonly %q, i32* noalias %r, i32 %n)  {
entry:
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  ...
  %r.addr.03 = phi i32* [ %incdec.ptr2, %while.body ], [ %r, %while.body.preheader ]
  %incdec.ptr1 = getelementptr inbounds i32, i32* %p.addr.03, i64 1
  %pld = load i32, i32* %p.addr.03, align 4
  %incdec.ptr2 = getelementptr inbounds i32, i32* %r.addr.03, i64 1
  store i32 %pld, i32* %r.addr.03, align 4

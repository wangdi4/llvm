...
; CHECK:        |   |   @llvm.for.cpystr.i64.i64.i64(&((%temp_array1)[0:i1:7(i8:0)][0:i2:161(i8:0)]),  7,  &((%"rt$VECTOR$_142")[0:i2:7(i8:0)]),  7,  0,  0);
; CHECK:        |   + END LOOP
; CHECK:        + END LOOP
...
do.end_do48:                                      ; preds = %do.end_do48.loopexit, %do.end_do36.thread
  %"var$1924159" = phi ptr [ %"var$1924156169", %do.end_do36.thread ], [ %"var$1924", %do.end_do48.loopexit ]
...
loop_body29:                                      ; preds = %do.body21, %loop_body29
  ...
  %"var$148[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 1, ptr nonnull elementtype(i8) %"var$1484", i64 %"$loop_ctr9.02"), !llfort.type_idx !28
  store i8 %int_zext, ptr %"var$148[]", align 1
...
loop_exit30:                                      ; preds = %loop_body29
  %"var$11[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(ptr) %"var$113", i64 %"var$8.0"), !llfort.type_idx !22
  store ptr inttoptr (i64 11 to ptr), ptr %"var$11[]", align 8, !tbaa !29
  %add.3 = add nuw nsw i64 %"var$8.0", 1
  %"var$11[]12" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(ptr) %"var$113", i64 %add.3), !llfort.type_idx !22
  %func_result = call i32 @for_allocate_handle(i64 11, ptr nonnull %"var$11[]12", i32 262144, ptr null) #6, !llfort.type_idx !0
  %"var$11[]12_fetch.25" = load ptr, ptr %"var$11[]12", align 8, !tbaa !29, !llfort.type_idx !22
  call void @llvm.for.cpystr.i64.i64.i64(ptr %"var$11[]12_fetch.25", i64 11, ptr nonnull %"var$1484", i64 11, i64 0, i1 false), !llfort.type_idx !30
  %add.4 = add nuw nsw i64 %"var$8.0", 2
  %add.5 = add nuw nsw i32 %"var$9.0", 1
...
do.epilog42:                                      ; preds = %do.end_do22, %do.epilog42
  ...
  %"var$11[]18" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(ptr) %"var$113", i64 %"var$8.1"), !llfort.type_idx !22
  %"var$11[]18_fetch.38" = load ptr, ptr %"var$11[]18", align 8, !tbaa !29, !llfort.type_idx !20
  %"var$1014[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 11, ptr nonnull elementtype(i8) %"var$101420", i64 %"var$16.0"), !llfort.type_idx !32
  ...
  %sub.6 = add nsw i64 %"var$8.1", -1
  %"var$11[]19" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(ptr) %"var$113", i64 %sub.6), !llfort.type_idx !22
  %"var$11[]19_fetch.40" = load ptr, ptr %"var$11[]19", align 8, !tbaa !29, !llfort.type_idx !22
  %"(i64)var$11[]19_fetch.40$" = ptrtoint ptr %"var$11[]19_fetch.40" to i64, !llfort.type_idx !21
...
do.body47:                                        ; preds = %do.end_do36, %do.body47
  %"var$20.0" = phi i64 [ 1, %do.end_do36 ], [ %add.9, %do.body47 ]
  %"var$1924[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 11, ptr nonnull elementtype(i8) %"var$192421", i64 %"var$20.0"), !llfort.type_idx !35
  %"var$1014[]26" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 11, ptr nonnull elementtype(i8) %"var$101420", i64 %"var$20.0"), !llfort.type_idx !36
...
loop_body57:                                      ; preds = %loop_body57.preheader, %loop_body57
  ...
  %"var$1924[]27" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 11, ptr nonnull elementtype(i8) %"var$192421", i64 %"$loop_ctr.03"), !llfort.type_idx !37
  %"rt$VECTOR$_14[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 7, ptr nonnull elementtype(i8) %"rt$VECTOR$_142", i64 %"$loop_ctr.03"), !llfort.type_idx !38
...
loop_body70:                                      ; preds = %loop_test69.preheader, %loop_body70
  ...
  %"rt$VECTOR$_14[]59" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 7, ptr nonnull elementtype(i8) %"rt$VECTOR$_142", i64 %"$loop_ctr42.04"), !llfort.type_idx !43
...
loop_test69.preheader:                            ; preds = %bb20, %loop_exit71
  ...
  %"temp_array[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 7, ptr nonnull elementtype(i8) %temp_array1, i64 %"$loop_ctr43.05") #7, !llfort.type_idx !45
  br label %loop_body70
...
loop_test79.preheader:                            ; preds = %loop_exit75, %loop_exit81
  ...
  %"temp_array[]63" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 161, ptr nonnull elementtype(i8) %temp_array1, i64 %"$loop_ctr37.07"), !llfort.type_idx !49
  %"temp_array62[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 184, ptr nonnull elementtype(i8) %temp_array625, i64 %"$loop_ctr37.07"), !llfort.type_idx !50
  br label %loop_body80
...
loop_test88.preheader:                            ; preds = %loop_test88.preheader.preheader, %loop_exit90
  ...
  %"rt$MANSWER1$_12[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 184, ptr nonnull elementtype(i8) %"rt$MANSWER1$_121", i64 %"$loop_ctr37.19"), !llfort.type_idx !53
  %"temp_array62[]65" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 184, ptr nonnull elementtype(i8) %temp_array625, i64 %"$loop_ctr37.19"), !llfort.type_idx !54
  br label %loop_body89

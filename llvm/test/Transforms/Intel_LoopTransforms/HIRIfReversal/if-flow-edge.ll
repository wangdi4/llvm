...
define void @sub_(ptr noalias nocapture dereferenceable(4) %"sub_$A", ptr noalias nocapture readonly dereferenceable(4) %"sub_$N", i32 %"sub_$N_fetch.1") #0 {
alloca_0:
...
bb2:                                              ; preds = %bb6_endif, %bb2.preheader
  ...
  %"sub_$A_entry[]10" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$A", i64 %indvars.iv)
  %"sub_$A_entry[]_fetch.4" = load float, ptr %"sub_$A_entry[]10", align 1
...
bb_new3_then:                                     ; preds = %bb2
  %1 = add nsw i64 1, -1
  %"sub_$A_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$A", i64 3)
  %"sub_$A_entry[]_fetch.6" = load float, ptr %"sub_$A_entry[]", align 1
...
bb_new4_else:                                     ; preds = %bb2
  ...
  store float %"(float)sub_$I_fetch.10$", ptr %"sub_$A_entry[]10", align 1
  br label %bb6_endif

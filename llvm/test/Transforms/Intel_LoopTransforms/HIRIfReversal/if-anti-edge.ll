...
; CHECK-CHANGED: Dump After HIRIfReversal

target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nofree nosync nounwind uwtable
define void @sub_(ptr noalias nocapture dereferenceable(4) %"sub_$A", ptr noalias nocapture
 dereferenceable(4) %"sub_$B", ptr noalias nocapture readonly dereferenceable(4) %"sub_$N", i32
%"sub_$N_fetch.1") #0 {
alloca_0:
...
bb2:                                              ; preds = %bb6_endif, %bb2.preheader
  ...
  %"sub_$B_entry[]13" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 0, ptr nonnull elementtype(float) %"sub_$B", i64 %indvars.iv)
  %"sub_$B_entry[]_fetch.4" = load float, ptr null, align 1
...
bb_new4_else:                                     ; preds = %bb2
  %"sub_$A_entry[]4" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$A", i64 %indvars.iv)
  %"sub_$A_entry[]_fetch.9" = load float, ptr %"sub_$A_entry[]4", align 1
  %add.1 = fadd reassoc ninf nsz arcp contract afn float %"sub_$B_entry[]_fetch.4", %"sub_$A_entry[]_fetch.9"
  store float %add.1, ptr %"sub_$B_entry[]13", align 1
  br label %bb6_endif

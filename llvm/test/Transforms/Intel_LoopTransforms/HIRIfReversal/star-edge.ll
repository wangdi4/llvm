...
define void @sub_(ptr noalias nocapture dereferenceable(4) %"sub_$A", ptr noalias nocapture dereferenceable(4) %"sub_$B", ptr noalias nocapture readonly dereferenceable(4) %"sub_$C", ptr noalias nocapture readonly dereferenceable(4) %"sub_$N") local_unnamed_addr #0 {
alloca_0:
...
bb2.preheader:                                    ; preds = %alloca_0
  ...
  %"sub_$A_entry[]4" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$A", i64 %int_sext2)
  %0 = or i32 %mul.1, 1
...
bb2:                                              ; preds = %bb2.preheader, %bb6_endif
  ...
  %"sub_$C_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$C", i64 %indvars.iv)
  %"sub_$C_entry[]_fetch.4" = load float, ptr %"sub_$C_entry[]", align 1, !tbaa !4
  %rel.2 = fcmp reassoc ninf nsz arcp contract afn oeq float %"sub_$C_entry[]_fetch.4", 1.000000e+02
  %"sub_$B_entry[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"sub_$B", i64 %indvars.iv)
  br i1 %rel.2, label %bb_new3_then, label %bb_new4_else

bb_new3_then:                                     ; preds = %bb2
  %"sub_$B_entry[]_fetch.6" = load float, ptr %"sub_$B_entry[]", align 1, !tbaa !6
  ...
  store float %"sub_$B_entry[]_fetch.6", ptr %"sub_$A_entry[]", align 1, !tbaa !8
  br label %bb6_endif

bb_new4_else:                                     ; preds = %bb2
  %"sub_$A_entry[]_fetch.9" = load float, ptr %"sub_$A_entry[]4", align 1, !tbaa !8
  store float %"sub_$A_entry[]_fetch.9", ptr %"sub_$B_entry[]", align 1, !tbaa !6
  br label %bb6_endif

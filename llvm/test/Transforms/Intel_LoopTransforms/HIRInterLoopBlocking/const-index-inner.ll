; REQUIRES: asserts
; RUN: opt -disable-hir-inter-loop-blocking=false -hir-ssa-deconstruction -hir-temp-cleanup -hir-inter-loop-blocking -debug-only=hir-inter-loop-blocking-profit -print-before=hir-inter-loop-blocking -hir-inter-loop-blocking-stripmine-size=2 -print-after=hir-inter-loop-blocking  < %s 2>&1 | FileCheck %s
...
bb30:                                             ; preds = %bb30.preheader, %bb30
  ...
  %"sub1_$A[]32[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"sub1_$A[]32", i64 1)
  ...
  %"sub1_$B[]43[]" = tail call double* @llvm.intel.subscript.p0f64.i64.i64.p0f64.i64(i8 0, i64 1, i64 8, double* %"sub1_$B[]43", i64 1)

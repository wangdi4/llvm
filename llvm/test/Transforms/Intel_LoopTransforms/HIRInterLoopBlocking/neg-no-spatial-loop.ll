...
entry:
  ...
  %1 = bitcast [100 x i32]* %oe to i8*
  call void @llvm.lifetime.start.p0i8(i64 400, i8* nonnull %1) #3
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 dereferenceable(400) %1, i8 0, i64 400, i1 false)
  %2 = bitcast [100 x i32]* %mw4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 400, i8* nonnull %2) #3
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 dereferenceable(400) %2, i8 0, i64 400, i1 false)
...
for.body3:                                        ; preds = %for.cond1.preheader, %for.body3
  ...
  %arrayidx = getelementptr inbounds [100 x i32], [100 x i32]* %mw4, i64 0, i64 %indvars.iv, !intel-tbaa !2
  store i32 62, i32* %arrayidx, align 4, !tbaa !2
  %arrayidx5 = getelementptr inbounds [100 x i32], [100 x i32]* %oe, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %3 = load i32, i32* %arrayidx5, align 4, !tbaa !2
  %arrayidx7 = getelementptr inbounds [100 x i32], [100 x i32]* %nz9, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %4 = load i32, i32* %arrayidx7, align 4, !tbaa !2
  %add = add i32 %4, %3
  store i32 %add, i32* %arrayidx7, align 4, !tbaa !2
...
for.body10:                                       ; preds = %for.body10.preheader, %for.body10
  ...
  %arrayidx12 = getelementptr inbounds [100 x i32], [100 x i32]* %mw4, i64 0, i64 %indvars.iv36, !intel-tbaa !2
  %5 = load i32, i32* %arrayidx12, align 4, !tbaa !2
  %sub = sub i32 0, %5
  %arrayidx14 = getelementptr inbounds [100 x i32], [100 x i32]* %oe, i64 0, i64 %indvars.iv36, !intel-tbaa !2
  store i32 %sub, i32* %arrayidx14, align 4, !tbaa !2
...
attributes #0 = { nounwind readnone uwtable "denormal-fp-math"="preserve-sign,preserve-sign" "denormal-fp-math-f32"="ieee,ieee" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="true" "no-jump-tables"="false" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "pre_loopopt" "stack-protector-buffer-size"="8" "target-cpu"="skylake-avx512" "target-features"="+adx,+aes,+avx,+avx2,+avx512bw,+avx512cd,+avx512dq,+avx512f,+avx512vl,+bmi,+bmi2,+clflushopt,+clwb,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+pku,+popcnt,+prfchw,+rdrnd,+rdseed,+sahf,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves" "unsafe-fp-math"="true" "use-soft-float"="false" }

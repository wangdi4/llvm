...
define void @arbrcs_(ptr noalias nocapture readonly dereferenceable(1) %"arbrcs_$OA", ptr noalias nocapture readonly dereferenceable(1) %"arbrcs_$OB", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$NDIM", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$NLINK", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$FA", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$A", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$LDA", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$B", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$LDB", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$FC", ptr noalias nocapture dereferenceable(8) %"arbrcs_$C", ptr noalias nocapture readonly dereferenceable(8) %"arbrcs_$LDC", i64 %"var$159$val", i64 %"var$160$val") local_unnamed_addr #1 !llfort.type_idx !1 {
alloca_12:
  %"arbrcs_$LDA_fetch.2228" = load i64, ptr %"arbrcs_$LDA", align 1, !tbaa !2, !llfort.type_idx !7
  %"arbrcs_$LDB_fetch.2229" = load i64, ptr %"arbrcs_$LDB", align 1, !tbaa !8, !llfort.type_idx !10
  %"arbrcs_$LDC_fetch.2230" = load i64, ptr %"arbrcs_$LDC", align 1, !tbaa !11, !llfort.type_idx !13
  ...
  %func_result = tail call i64 @for_cpstr(ptr nonnull %"arbrcs_$OA", i64 1, ptr @strlit.98, i64 1, i64 2) #3, !llfort.type_idx !14
...
bb665:                                            ; preds = %bb665.preheader, %bb670
  ...
  %"arbrcs_$C[]17" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.236, ptr nonnull elementtype(double) %"arbrcs_$C", i64 %"arbrcs_$I.0"), !llfort.type_idx !15
  br label %bb669
...
bb673.preheader:                                  ; preds = %bb669
  %"arbrcs_$B[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.233, ptr nonnull elementtype(double) %"arbrcs_$B", i64 %"arbrcs_$J.0"), !llfort.type_idx !16
  br label %bb673
...
bb673:                                            ; preds = %bb673, %bb673.preheader
  ...
  %"arbrcs_$A[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.231, ptr nonnull elementtype(double) %"arbrcs_$A", i64 %"arbrcs_$K.0"), !llfort.type_idx !17
  %"arbrcs_$A[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$A[]", i64 %"arbrcs_$I.0"), !llfort.type_idx !18
  %"arbrcs_$A[][]_fetch.2248" = load double, ptr %"arbrcs_$A[][]", align 1, !tbaa !19, !llfort.type_idx !18
  %"arbrcs_$B[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$B[]", i64 %"arbrcs_$K.0"), !llfort.type_idx !21
  %"arbrcs_$B[][]_fetch.2255" = load double, ptr %"arbrcs_$B[][]", align 1, !tbaa !22, !llfort.type_idx !21
...
bb674:                                            ; preds = %bb674.loopexit, %bb669
  ...
  %"arbrcs_$C[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.236, ptr nonnull elementtype(double) %"arbrcs_$C", i64 %"arbrcs_$J.0"), !llfort.type_idx !24
  %"arbrcs_$C[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$C[]", i64 %"arbrcs_$I.0"), !llfort.type_idx !25
  %"arbrcs_$C[][]_fetch.2266" = load double, ptr %"arbrcs_$C[][]", align 1, !tbaa !26, !llfort.type_idx !25
  ...
  store double %add.318, ptr %"arbrcs_$C[][]", align 1, !tbaa !26
  %"arbrcs_$C[][]18" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$C[]17", i64 %"arbrcs_$J.0"), !llfort.type_idx !28
  store double %add.318, ptr %"arbrcs_$C[][]18", align 1, !tbaa !26
...
bb677:                                            ; preds = %bb677.preheader, %bb682
  ...
  %"arbrcs_$C[]37" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.236, ptr nonnull elementtype(double) %"arbrcs_$C", i64 %"arbrcs_$I.1"), !llfort.type_idx !29
  br label %bb681
...
bb685:                                            ; preds = %bb685, %bb685.preheader
  ...
  %"arbrcs_$A[]27" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.231, ptr nonnull elementtype(double) %"arbrcs_$A", i64 %"arbrcs_$K.1"), !llfort.type_idx !30
  %"arbrcs_$A[][]28" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$A[]27", i64 %"arbrcs_$I.1"), !llfort.type_idx !31
  %"arbrcs_$A[][]_fetch.2301" = load double, ptr %"arbrcs_$A[][]28", align 1, !tbaa !19, !llfort.type_idx !31
  %"arbrcs_$B[]29" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.233, ptr nonnull elementtype(double) %"arbrcs_$B", i64 %"arbrcs_$K.1"), !llfort.type_idx !32
  %"arbrcs_$B[][]30" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$B[]29", i64 %"arbrcs_$J.1"), !llfort.type_idx !33
  %"arbrcs_$B[][]_fetch.2306" = load double, ptr %"arbrcs_$B[][]30", align 1, !tbaa !22, !llfort.type_idx !33
...
bb686:                                            ; preds = %bb686.loopexit, %bb681
  ...
  %"arbrcs_$C[]31" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.236, ptr nonnull elementtype(double) %"arbrcs_$C", i64 %"arbrcs_$J.1"), !llfort.type_idx !34
  %"arbrcs_$C[][]32" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$C[]31", i64 %"arbrcs_$I.1"), !llfort.type_idx !35
  %"arbrcs_$C[][]_fetch.2315" = load double, ptr %"arbrcs_$C[][]32", align 1, !tbaa !26, !llfort.type_idx !35
  ...
  store double %add.323, ptr %"arbrcs_$C[][]32", align 1, !tbaa !26
  %"arbrcs_$C[][]38" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$C[]37", i64 %"arbrcs_$J.1"), !llfort.type_idx !36
  store double %add.323, ptr %"arbrcs_$C[][]38", align 1, !tbaa !26
...
bb_new1956_then:                                  ; preds = %bb_new1953_else
  %"arbrcs_$NDIM_fetch.2290" = load i64, ptr %"arbrcs_$NDIM", align 1, !tbaa !37, !llfort.type_idx !39
...
bb677.preheader:                                  ; preds = %bb_new1956_then
  %"arbrcs_$NLINK_fetch.2294" = load i64, ptr %"arbrcs_$NLINK", align 1, !tbaa !40, !llfort.type_idx !42
  %rel.420 = icmp slt i64 %"arbrcs_$NLINK_fetch.2294", 1
  %"arbrcs_$FC_fetch.2310" = load double, ptr %"arbrcs_$FC", align 1, !tbaa !43, !llfort.type_idx !45
  %"arbrcs_$FA_fetch.2316" = load double, ptr %"arbrcs_$FA", align 1, !tbaa !46, !llfort.type_idx !48
  %1 = add nsw i64 %"arbrcs_$NLINK_fetch.2294", 1
  %2 = add nuw i64 %"arbrcs_$NDIM_fetch.2290", 2
  br label %bb677

bb_new1942_then:                                  ; preds = %bb_new1939_then
  %"arbrcs_$NDIM_fetch.2235" = load i64, ptr %"arbrcs_$NDIM", align 1, !tbaa !37, !llfort.type_idx !49
...
bb665.preheader:                                  ; preds = %bb_new1942_then
  %"arbrcs_$NLINK_fetch.2239" = load i64, ptr %"arbrcs_$NLINK", align 1, !tbaa !40, !llfort.type_idx !50
  %rel.414 = icmp slt i64 %"arbrcs_$NLINK_fetch.2239", 1
  %"arbrcs_$FC_fetch.2259" = load double, ptr %"arbrcs_$FC", align 1, !tbaa !43, !llfort.type_idx !51
  %"arbrcs_$FA_fetch.2267" = load double, ptr %"arbrcs_$FA", align 1, !tbaa !46, !llfort.type_idx !52
  %3 = add nsw i64 %"arbrcs_$NLINK_fetch.2239", 1
  %4 = add nuw i64 %"arbrcs_$NDIM_fetch.2235", 2
  br label %bb665

bb_new1953_else:                                  ; preds = %bb_new1939_then
  %func_result20 = tail call i64 @for_cpstr(ptr nonnull %"arbrcs_$OB", i64 1, ptr @strlit.96, i64 1, i64 2) #3, !llfort.type_idx !14
...
bb692:                                            ; preds = %bb692.preheader, %bb697
  ...
  %"arbrcs_$C[]67" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.236, ptr nonnull elementtype(double) %"arbrcs_$C", i64 %"arbrcs_$I.2"), !llfort.type_idx !53
...
bb700.preheader:                                  ; preds = %bb696
  %"arbrcs_$B[]59" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.233, ptr nonnull elementtype(double) %"arbrcs_$B", i64 %"arbrcs_$J.2"), !llfort.type_idx !54
  br label %bb700
...
bb700:                                            ; preds = %bb700, %bb700.preheader
  ...
  %"arbrcs_$A[][]58" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$A[]57", i64 %"arbrcs_$K.2"), !llfort.type_idx !55
  %"arbrcs_$A[][]_fetch.2352" = load double, ptr %"arbrcs_$A[][]58", align 1, !tbaa !19, !llfort.type_idx !55
  %"arbrcs_$B[][]60" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$B[]59", i64 %"arbrcs_$K.2"), !llfort.type_idx !56
  %"arbrcs_$B[][]_fetch.2357" = load double, ptr %"arbrcs_$B[][]60", align 1, !tbaa !22, !llfort.type_idx !56
...
bb701:                                            ; preds = %bb701.loopexit, %bb696
  ...
  %"arbrcs_$C[]61" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.236, ptr nonnull elementtype(double) %"arbrcs_$C", i64 %"arbrcs_$J.2"), !llfort.type_idx !57
  %"arbrcs_$C[][]62" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$C[]61", i64 %"arbrcs_$I.2"), !llfort.type_idx !58
  %"arbrcs_$C[][]_fetch.2366" = load double, ptr %"arbrcs_$C[][]62", align 1, !tbaa !26, !llfort.type_idx !58
  ...
  store double %add.328, ptr %"arbrcs_$C[][]62", align 1, !tbaa !26
  %"arbrcs_$C[][]68" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$C[]67", i64 %"arbrcs_$J.2"), !llfort.type_idx !59
  store double %add.328, ptr %"arbrcs_$C[][]68", align 1, !tbaa !26
...
bb704:                                            ; preds = %bb704.preheader, %bb709
  ...
  %"arbrcs_$C[]87" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.236, ptr nonnull elementtype(double) %"arbrcs_$C", i64 %"arbrcs_$I.3"), !llfort.type_idx !60
  %"arbrcs_$A[]77" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.231, ptr nonnull elementtype(double) %"arbrcs_$A", i64 %"arbrcs_$I.3")
  br label %bb708
...
bb712:                                            ; preds = %bb712, %bb712.preheader
  ...
  %"arbrcs_$A[][]78" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$A[]77", i64 %"arbrcs_$K.3"), !llfort.type_idx !61
  %"arbrcs_$A[][]_fetch.2401" = load double, ptr %"arbrcs_$A[][]78", align 1, !tbaa !19, !llfort.type_idx !61
  %"arbrcs_$B[]79" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.233, ptr nonnull elementtype(double) %"arbrcs_$B", i64 %"arbrcs_$K.3"), !llfort.type_idx !62
  %"arbrcs_$B[][]80" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$B[]79", i64 %"arbrcs_$J.3"), !llfort.type_idx !63
  %"arbrcs_$B[][]_fetch.2406" = load double, ptr %"arbrcs_$B[][]80", align 1, !tbaa !22, !llfort.type_idx !63
...
bb713:                                            ; preds = %bb713.loopexit, %bb708
  ...
  %"arbrcs_$C[]81" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.236, ptr nonnull elementtype(double) %"arbrcs_$C", i64 %"arbrcs_$J.3"), !llfort.type_idx !64
  %"arbrcs_$C[][]82" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$C[]81", i64 %"arbrcs_$I.3"), !llfort.type_idx !65
  %"arbrcs_$C[][]_fetch.2415" = load double, ptr %"arbrcs_$C[][]82", align 1, !tbaa !26, !llfort.type_idx !65
  ...
  store double %add.333, ptr %"arbrcs_$C[][]82", align 1, !tbaa !26
  %"arbrcs_$C[][]88" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"arbrcs_$C[]87", i64 %"arbrcs_$J.3"), !llfort.type_idx !66
  store double %add.333, ptr %"arbrcs_$C[][]88", align 1, !tbaa !26
...
bb_new1975_then:                                  ; preds = %bb_new1972_else
  %"arbrcs_$NDIM_fetch.2390" = load i64, ptr %"arbrcs_$NDIM", align 1, !tbaa !37, !llfort.type_idx !67
...
bb704.preheader:                                  ; preds = %bb_new1975_then
  %"arbrcs_$NLINK_fetch.2394" = load i64, ptr %"arbrcs_$NLINK", align 1, !tbaa !40, !llfort.type_idx !68
  %rel.432 = icmp slt i64 %"arbrcs_$NLINK_fetch.2394", 1
  %"arbrcs_$FC_fetch.2410" = load double, ptr %"arbrcs_$FC", align 1, !tbaa !43, !llfort.type_idx !69
  %"arbrcs_$FA_fetch.2416" = load double, ptr %"arbrcs_$FA", align 1, !tbaa !46, !llfort.type_idx !70
  %6 = add nsw i64 %"arbrcs_$NLINK_fetch.2394", 1
  %7 = add nuw i64 %"arbrcs_$NDIM_fetch.2390", 2
  br label %bb704

bb_new1967_then:                                  ; preds = %bb_new1964_then
  %"arbrcs_$NDIM_fetch.2341" = load i64, ptr %"arbrcs_$NDIM", align 1, !tbaa !37, !llfort.type_idx !71
...
bb692.preheader:                                  ; preds = %bb_new1967_then
  %"arbrcs_$NLINK_fetch.2345" = load i64, ptr %"arbrcs_$NLINK", align 1, !tbaa !40, !llfort.type_idx !72
  %rel.426 = icmp slt i64 %"arbrcs_$NLINK_fetch.2345", 1
  %"arbrcs_$FC_fetch.2361" = load double, ptr %"arbrcs_$FC", align 1, !tbaa !43, !llfort.type_idx !73
  %"arbrcs_$FA_fetch.2367" = load double, ptr %"arbrcs_$FA", align 1, !tbaa !46, !llfort.type_idx !74
  %8 = add nsw i64 %"arbrcs_$NLINK_fetch.2345", 1
  %9 = add nuw i64 %"arbrcs_$NDIM_fetch.2341", 2
  br label %bb692

bb_new1972_else:                                  ; preds = %bb_new1964_then
  %func_result70 = tail call i64 @for_cpstr(ptr nonnull %"arbrcs_$OB", i64 1, ptr @strlit.93, i64 1, i64 2) #3, !llfort.type_idx !14
...
bb_new1964_then:                                  ; preds = %bb_new1961_else
  %func_result50 = tail call i64 @for_cpstr(ptr nonnull %"arbrcs_$OB", i64 1, ptr @strlit.94, i64 1, i64 2) #3, !llfort.type_idx !14
...
bb_new1939_then:                                  ; preds = %alloca_12
  %func_result6 = tail call i64 @for_cpstr(ptr nonnull %"arbrcs_$OB", i64 1, ptr @strlit.97, i64 1, i64 2) #3, !llfort.type_idx !14
...
bb_new1961_else:                                  ; preds = %alloca_12
  %func_result42 = tail call i64 @for_cpstr(ptr nonnull %"arbrcs_$OA", i64 1, ptr @strlit.95, i64 1, i64 2) #3, !llfort.type_idx !14
...
declare !llfort.type_idx !75 !llfort.intrin_id !76 i64 @for_cpstr(ptr nocapture readonly, i64, ptr nocapture readonly, i64, i64) local_unnamed_addr #2

...
define void @barney(i32 %tmp220, i32* %tmp97, i32* %tmp84) #0 {
bb:
  %tmp173 = getelementptr [130000 x i32], [130000 x i32]* null, i64 0, i64 0
...
bb247:                                            ; preds = %bb268, %bb245
  ...
  %tmp250 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 0, i32* elementtype(i32) %tmp173, i64 %tmp248)
  %tmp251 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 0, i32* elementtype(i32) %tmp250, i64 %tmp246)
  store i32 0, i32* %tmp251, align 1
  br i1 true, label %bb268, label %bb252

bb252:                                            ; preds = %bb247
  %tmp253 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 8000, i32* elementtype(i32) %tmp97, i64 %tmp248)
  br label %bb254
...
bb254:                                            ; preds = %bb254, %bb252
  ...
  %tmp258 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 4000, i32* elementtype(i32) %tmp84, i64 %tmp255)
  %tmp259 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* elementtype(i32) %tmp258, i64 %tmp246)
  %tmp260 = load i32, i32* %tmp259, align 1
  %tmp261 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* elementtype(i32) %tmp253, i64 %tmp255)
  %tmp262 = load i32, i32* %tmp261, align 1
...
bb266:                                            ; preds = %bb254
  store i32 %tmp264, i32* %tmp251, align 1
  br label %bb268
...
uselistorder i32* (i8, i64, i64, i32*, i64)* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64, { 5, 4, 3, 2, 1, 0 }

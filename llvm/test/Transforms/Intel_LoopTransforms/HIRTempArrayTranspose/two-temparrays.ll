; RUN: opt %s -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-temp-array-transpose" -print-after=hir-temp-array-transpose -hir-temp-array-transpose-mintc=2 -hir-temp-array-transpose-allow-unknown-sizes -disable-output 2>&1 | FileCheck %s

...
bb:
  ...
  %i = tail call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit, i64 0, i32 0), i8* nonnull @__dso_handle) #11
  ret void
}
...
define internal fastcc void @_Z16gemm_lowp_matmuliiiPKiS0_PiiSt5arrayIiLm1024EE(i32 noundef %arg, i32 noundef %arg1, i32 noundef %arg2, i32* noalias nocapture noundef readonly %arg3, i32* noalias nocapture noundef readonly %arg4, i32* noalias nocapture noundef %arg5, %"struct.std::array"* noalias nocapture noundef readonly byval(%"struct.std::array") align 8 %arg6) unnamed_addr #4 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
bb:
...
bb11:                                             ; preds = %bb9
  ...
  %i13 = tail call noalias noundef nonnull i8* @_Znwm(i64 noundef %i12) #13
  %i14 = bitcast i8* %i13 to i32*
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 4 %i13, i8 0, i64 %i12, i1 false), !tbaa !6
  br label %bb15

bb15:                                             ; preds = %bb11, %bb9
  %i16 = phi i32* [ %i14, %bb11 ], [ null, %bb9 ]
...
bb23:                                             ; preds = %bb21
  ...
  %i25 = invoke noalias noundef nonnull i8* @_Znwm(i64 noundef %i24) #13
          to label %bb26 unwind label %bb76

bb26:                                             ; preds = %bb23
  %i27 = bitcast i8* %i25 to i32*
  tail call void @llvm.memset.p0i8.i64(i8* nonnull align 4 %i25, i8 0, i64 %i24, i1 false), !tbaa !6
...
bb32:                                             ; preds = %bb45, %bb30
  ...
  %i34 = getelementptr inbounds i32, i32* %i27, i64 %i33, !intel-tbaa !6
  store i32 0, i32* %i34, align 4, !tbaa !6
...
bb36:                                             ; preds = %bb36, %bb32
  ...
  %i40 = getelementptr inbounds i32, i32* %arg3, i64 %i39
  %i41 = load i32, i32* %i40, align 4, !tbaa !6
...
bb45:                                             ; preds = %bb36
  ...
  store i32 %i46, i32* %i34, align 4, !tbaa !6
...
bb51:                                             ; preds = %bb50, %bb49, %bb21
  %i52 = phi i32* [ null, %bb21 ], [ %i27, %bb49 ], [ %i27, %bb50 ]
...
bb59:                                             ; preds = %bb72, %bb57
  ...
  %i61 = getelementptr inbounds i32, i32* %i16, i64 %i60, !intel-tbaa !6
...
bb62:                                             ; preds = %bb62, %bb59
  ...
  %i67 = getelementptr inbounds i32, i32* %arg4, i64 %i66
  %i68 = load i32, i32* %i67, align 4, !tbaa !6
...
bb72:                                             ; preds = %bb62
  ...
  store i32 %i73, i32* %i61, align 4, !tbaa !6
  %i74 = add nuw nsw i64 %i60, 1
  %i75 = icmp eq i64 %i74, %i
  br i1 %i75, label %bb86, label %bb59, !llvm.loop !14

bb76:                                             ; preds = %bb23, %bb19
  %i77 = landingpad { i8*, i32 }
          cleanup
  %i78 = icmp eq i32* %i16, null
  br i1 %i78, label %bb151, label %bb79

bb79:                                             ; preds = %bb76
  %i80 = bitcast i32* %i16 to i8*
  tail call void @_ZdlPv(i8* noundef nonnull %i80) #11
  br label %bb151

bb81:                                             ; preds = %bb81, %bb29
  %i82 = phi i64 [ %i84, %bb81 ], [ 0, %bb29 ]
  %i83 = getelementptr inbounds i32, i32* %i27, i64 %i82, !intel-tbaa !6
  store i32 0, i32* %i83, align 4, !tbaa !6
...
bb91:                                             ; preds = %bb133, %bb89
  ...
  %i95 = getelementptr inbounds i32, i32* %i52, i64 %i92, !intel-tbaa !6
  %i96 = load i32, i32* %i95, align 4, !tbaa !6
  br label %bb97

bb97:                                             ; preds = %bb107, %bb91
  %i98 = phi i64 [ 0, %bb91 ], [ %i117, %bb107 ]
  %i99 = getelementptr inbounds %"struct.std::array", %"struct.std::array"* %arg6, i64 0, i32 0, i64 %i98, !intel-tbaa !15
  %i100 = load i32, i32* %i99, align 4, !tbaa !15
  %i101 = add nsw i64 %i98, %i93
  %i102 = getelementptr inbounds i32, i32* %arg5, i64 %i101
  %i103 = load i32, i32* %i102, align 4, !tbaa !6
...
bb107:                                            ; preds = %bb105, %bb97
  ...
  %i109 = getelementptr inbounds i32, i32* %i16, i64 %i98, !intel-tbaa !6
  %i110 = load i32, i32* %i109, align 4, !tbaa !6
  ...
  store i32 %i116, i32* %i102, align 4, !tbaa !6
...
bb119:                                            ; preds = %bb119, %bb104
  ...
  %i123 = getelementptr inbounds i32, i32* %arg3, i64 %i122
  %i124 = load i32, i32* %i123, align 4, !tbaa !6
  %i125 = mul nsw i64 %isext, %i
  %i126 = add nsw i64 %i125, %i98
  %i127 = getelementptr inbounds i32, i32* %arg4, i64 %i126
  %i128 = load i32, i32* %i127, align 4, !tbaa !6
...
bb136:                                            ; preds = %bb136, %bb56
  ...
  %i138 = getelementptr inbounds i32, i32* %i16, i64 %i137, !intel-tbaa !6
  store i32 0, i32* %i138, align 4, !tbaa !6
  %i139 = add nuw nsw i64 %i137, 1
  %i140 = icmp eq i64 %i139, %i
  br i1 %i140, label %bb87, label %bb136, !llvm.loop !14

bb141:                                            ; preds = %bb88, %bb51
  %i142 = icmp eq i32* %i52, null
...
bb144:                                            ; preds = %bb143, %bb141
  %i145 = bitcast i32* %i52 to i8*
  tail call void @_ZdlPv(i8* noundef nonnull %i145) #11
  br label %bb146

bb146:                                            ; preds = %bb144, %bb141
  %i147 = icmp eq i32* %i16, null
  br i1 %i147, label %bb150, label %bb148

bb148:                                            ; preds = %bb146
  %i149 = bitcast i32* %i16 to i8*
  tail call void @_ZdlPv(i8* noundef nonnull %i149) #11
  br label %bb150
...
bb:
  ...
  %i6 = bitcast [1048576 x i32]* %i5 to i8*
  %i7 = alloca %"struct.std::array", align 8
  %i8 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %i8) #11
  %i9 = bitcast i32* %i1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %i9) #11
  %i10 = bitcast i32* %i2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %i10) #11
  %i11 = bitcast [1048576 x i32]* %i3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4194304, i8* nonnull %i11) #11
  %i12 = bitcast [1048576 x i32]* %i4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4194304, i8* nonnull %i12) #11
  call void @llvm.lifetime.start.p0i8(i64 4194304, i8* nonnull %i6) #11
  %i13 = call noundef nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, i32* noundef nonnull align 4 dereferenceable(4) %i)
  %i14 = call noundef nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, i32* noundef nonnull align 4 dereferenceable(4) %i1)
  %i15 = call noundef nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, i32* noundef nonnull align 4 dereferenceable(4) %i2)
  %i16 = bitcast %"struct.std::array"* %i7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4096, i8* nonnull %i16) #11
  %i17 = load i32, i32* %i, align 4, !tbaa !6
  %i18 = icmp sgt i32 %i17, 0
  br i1 %i18, label %bb19, label %bb45

bb19:                                             ; preds = %bb
  %i20 = load i32, i32* %i2, align 4, !tbaa !6
...
bb28:                                             ; preds = %bb28, %bb25
  ...
  %i31 = getelementptr inbounds [1048576 x i32], [1048576 x i32]* %i3, i64 0, i64 %i30, !intel-tbaa !21
  store i32 1, i32* %i31, align 4, !tbaa !21
...
bb37:                                             ; preds = %bb34
  %i38 = load i32, i32* %i1, align 4, !tbaa !6
  %i39 = icmp sgt i32 %i38, 0
  br i1 %i39, label %bb53, label %bb76

bb40:                                             ; preds = %bb19
  %i41 = load i32, i32* %i1, align 4, !tbaa !6
...
bb45:                                             ; preds = %bb
  %i46 = load i32, i32* %i1, align 4, !tbaa !6
  %i47 = icmp sgt i32 %i46, 0
  %i48 = load i32, i32* %i2, align 4
...
bb59:                                             ; preds = %bb59, %bb57
  ...
  %i63 = getelementptr inbounds [1048576 x i32], [1048576 x i32]* %i4, i64 0, i64 %i62, !intel-tbaa !21
  store i32 2, i32* %i63, align 4, !tbaa !21
...
bb70:                                             ; preds = %bb69, %bb40
  ...
  %i75 = shl i64 %i74, 2
  call void @llvm.memset.p0i8.i64(i8* nonnull align 16 %i6, i8 0, i64 %i75, i1 false), !tbaa !21
  br label %bb76
...
bb79:                                             ; preds = %bb78, %bb69, %bb45
  %i80 = getelementptr inbounds [1048576 x i32], [1048576 x i32]* %i3, i64 0, i64 0, !intel-tbaa !21
  %i81 = getelementptr inbounds [1048576 x i32], [1048576 x i32]* %i4, i64 0, i64 0, !intel-tbaa !21
  %i82 = getelementptr inbounds [1048576 x i32], [1048576 x i32]* %i5, i64 0, i64 0, !intel-tbaa !21
  br label %bb116

bb83:                                             ; preds = %bb83, %bb76
  %i84 = phi i64 [ 0, %bb76 ], [ %i87, %bb83 ]
  %i85 = getelementptr inbounds %"struct.std::array", %"struct.std::array"* %i7, i64 0, i32 0, i64 %i84, !intel-tbaa !15
  %i86 = trunc i64 %i84 to i32
  store i32 %i86, i32* %i85, align 4, !tbaa !15
...
bb92:                                             ; preds = %bb89
  %i93 = load i32, i32* %i1, align 4, !tbaa !6
...
bb102:                                            ; preds = %bb102, %bb98
  ...
  %i106 = getelementptr inbounds [1048576 x i32], [1048576 x i32]* %i5, i64 0, i64 %i105, !intel-tbaa !21
  %i107 = load i32, i32* %i106, align 4, !tbaa !21
...
bb116:                                            ; preds = %bb116, %bb79
  ...
  %i119 = load i32, i32* %i1, align 4, !tbaa !6
  %i120 = load i32, i32* %i2, align 4, !tbaa !6
  call fastcc void @_Z16gemm_lowp_matmuliiiPKiS0_PiiSt5arrayIiLm1024EE(i32 noundef %i117, i32 noundef %i119, i32 noundef %i120, i32* noundef nonnull %i80, i32* noundef nonnull %i81, i32* noundef nonnull %i82, %"struct.std::array"* noundef nonnull byval(%"struct.std::array") align 8 %i7) #14
  %i121 = load i32, i32* %i, align 4, !tbaa !6
  %i122 = srem i32 %i118, %i121
  %i123 = zext i32 %i122 to i64
  %i124 = getelementptr inbounds [1048576 x i32], [1048576 x i32]* %i5, i64 0, i64 %i123, !intel-tbaa !21
  store i32 %i122, i32* %i124, align 4, !tbaa !21
...
bb129:                                            ; preds = %bb127, %bb92, %bb89
  ...
  %i131 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !31
  %i132 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %i131, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), double noundef %i130) #15
  call void @llvm.lifetime.end.p0i8(i64 4096, i8* nonnull %i16) #11
  call void @llvm.lifetime.end.p0i8(i64 4194304, i8* nonnull %i6) #11
  call void @llvm.lifetime.end.p0i8(i64 4194304, i8* nonnull %i12) #11
  call void @llvm.lifetime.end.p0i8(i64 4194304, i8* nonnull %i11) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %i10) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %i9) #11
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %i8) #11
  ret i32 0
}

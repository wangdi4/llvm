...
; Check loop with boundary condition and no level specified blocks entire loopnest.
...
;            |   |   %min3 = (-256 * i2 + 998 <= 255) ? -256 * i2 + 998 : 255;
;            |   |
;CHECK:      |   |   + DO i3 = 0, %min, 1   <DO_LOOP>
;CHECK:      |   |   |   + DO i4 = 0, %min3, 1   <DO_LOOP>
;            |   |   |   |   %1 = (%B)[256 * i1 + i3 + 1];
;            |   |   |   |   %add26 = (%A)[256 * i1 + i3 + 1];
;            |   |   |   |   %mul = (%1)[256 * i2 + i4 + 1]  *  %add26;
;            |   |   |   |   %add26 = %mul  +  %add26;
;            |   |   |   |   (%A)[256 * i1 + i3 + 1] = %add26;
;            |   |   |   + END LOOP
;            |   |   + END LOOP

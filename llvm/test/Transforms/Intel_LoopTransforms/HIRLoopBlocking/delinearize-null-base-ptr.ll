...
define void @foo(ptr noalias nocapture readonly dereferenceable(4) %SF_SURFACE_PHYSICS, ptr noalias nocapture writeonly dereferenceable_or_null(4) %SR, i64 %int_sext5848) {
alloca_1:
  store i32 1, ptr %SF_SURFACE_PHYSICS, align 1
  %rel.2259.not = icmp eq ptr %SR, null
...
loop_test1209.preheader:                          ; preds = %loop_exit1211, %loop_test1209.preheader.preheader
  ...
  %t2 = getelementptr inbounds float, ptr null, i64 %t1
...
loop_body1210:                                    ; preds = %loop_test1209.preheader, %loop_body1210
  ...
  %t0 = getelementptr inbounds float, ptr %t2, i64 %"$loop_ctr5846.02"
  store float 1.000000e+00, ptr %t0, align 4

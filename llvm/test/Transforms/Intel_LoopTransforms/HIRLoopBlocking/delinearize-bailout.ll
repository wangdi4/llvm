; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -hir-loop-blocking -print-after=hir-loop-blocking -disable-output < %s 2>&1 | FileCheck %s

; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-loop-blocking,print<hir>" -aa-pipeline="basic-aa" -disable-output 2>&1 < %s | FileCheck %s
...
define void @foo(i32* %a, i32 %stride, i32 %parity, i32 %sub28) {
...
for.cond34.preheader:                             ; preds = %for.end42, %for.cond34.preheader.lr.ph
  ...
  %srcptr.1155 = phi i32* [ %ptridx25, %for.cond34.preheader.lr.ph ], [ %add.ptr47, %for.end42 ]
  %dstptr.1154 = phi i32* [ %ptridx, %for.cond34.preheader.lr.ph ], [ %add.ptr44, %for.end42 ]
  br label %for.body37

for.body37:                                       ; preds = %for.body37, %for.cond34.preheader
  %i.1151 = phi i32 [ 0, %for.cond34.preheader ], [ %inc41, %for.body37 ]
  %dstptr2.1150 = phi i32* [ %dstptr.1154, %for.cond34.preheader ], [ %incdec.ptr38, %for.body37 ]
  %srcptr2.1149 = phi i32* [ %srcptr.1155, %for.cond34.preheader ], [ %incdec.ptr39, %for.body37 ]
  %t4 = load i32, i32* %srcptr2.1149, align 4
  store i32 %t4, i32* %dstptr2.1150, align 4
  %incdec.ptr38 = getelementptr inbounds i32, i32* %dstptr2.1150, i64 1
  %incdec.ptr39 = getelementptr inbounds i32, i32* %srcptr2.1149, i64 1
...
for.end42:
  ...
  %add.ptr44 = getelementptr inbounds i32, i32* %dstptr.1154, i64 %idx.ext43
  %add.ptr47 = getelementptr inbounds i32, i32* %srcptr.1155, i64 %idx.ext46

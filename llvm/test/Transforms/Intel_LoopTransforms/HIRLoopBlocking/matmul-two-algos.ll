...
; KANDR: IR Dump Before HIR Loop Blocking
...
; KANDR:    IR Dump After HIR Loop Blocking 
...
; KANDR:           |   |   |   + DO i4 = 0, %min3, 1   <DO_LOOP>  <MAX_TC_EST = 1024>
; KANDR:           |   |   |   |   %min = (-128 * i2 + %N + -1 <= 127) ? -128 * i2 + %N + -1 : 127;
; KANDR:           |   |   |   |   
; KANDR:           |   |   |   |   + DO i5 = 0, %min, 1   <DO_LOOP>  <MAX_TC_EST = 1024>
...
; DEFAULT: IR Dump Before HIR Loop Blocking
...
; DEFAULT: IR Dump After HIR Loop Blocking

...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx = getelementptr inbounds [1000 x double], [1000 x double]* @A, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %0 = load double, double* %arrayidx, align 16, !tbaa !2
  %add = fadd double %S.013, %0
  %1 = or i64 %indvars.iv, 1
  %arrayidx3 = getelementptr inbounds [1000 x double], [1000 x double]* @A, i64 0, i64 %1, !intel-tbaa !2

; RUN: opt -disable-output -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-pre-vec-complete-unroll,hir-lmm,print<hir>,hir-loop-reroll,print<hir>" -aa-pipeline="basic-aa"  < %s 2>&1 | FileCheck %s
...
entry:
  ...
  %6 = bitcast ptr %cw to ptr
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %6) #5
  call void @llvm.memset.p0.i64(ptr nonnull align 16 dereferenceable(400) %6, i8 0, i64 400, i1 false)
  %7 = bitcast ptr %o1 to ptr
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %7) #5
  call void @llvm.memset.p0.i64(ptr nonnull align 16 dereferenceable(400) %7, i8 0, i64 400, i1 false)
  %8 = bitcast ptr %i2 to ptr
  call void @llvm.lifetime.start.p0(i64 40000, ptr nonnull %8) #5
  call void @llvm.memset.p0.i64(ptr nonnull align 16 dereferenceable(40000) %8, i8 0, i64 40000, i1 false)
  %arraydecay = getelementptr inbounds [100 x i32], ptr %e, i64 0, i64 0
  %call = call i32 (ptr, i32, i32, ...) @init(ptr nonnull %arraydecay, i32 100, i32 68) #5
  %arraydecay1 = getelementptr inbounds [100 x i32], ptr %cw, i64 0, i64 0
  %call2 = call i32 (ptr, i32, i32, ...) @init(ptr nonnull %arraydecay1, i32 100, i32 1) #5
  %arraydecay3 = getelementptr inbounds [100 x i32], ptr %o1, i64 0, i64 0
  %call4 = call i32 (ptr, i32, i32, ...) @init(ptr nonnull %arraydecay3, i32 100, i32 86) #5
...
for.body:                                         ; preds = %entry, %for.cond.loopexit
  %p4.0100 = phi ptr [ %o, %entry ], [ %y, %for.cond.loopexit ]
...
for.end73:                                        ; preds = %for.cond.loopexit
  ...
  %call85 = call i32 (ptr, i32, ...) @checkSum(ptr nonnull %9, i32 10000) #5
  ...
  %call88 = call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) @.str.1, i32 %add87)
  call void @llvm.lifetime.end.p0(i64 40000, ptr nonnull %8) #5
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %0) #5
  ret i32 0
}
...
declare dso_local i32 @__isoc99_scanf(ptr nocapture readonly, ...) local_unnamed_addr #4

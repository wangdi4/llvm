...
; CHECK:             |   %p4.0100 = &((%y)[0]);
; CHECK:             + END LOOP
; CHECK:                (%i2)[0][3][4] = %limm376;
; CHECK:                (%i2)[0][3][1] = %limm374;
; CHECK:                (%i2)[0][4][4] = %limm372;
; CHECK:                (%i2)[0][4][1] = %limm370;
; CHECK:                (%i2)[0][5][1] = %limm368;
; CHECK:                (%i2)[0][6][4] = %limm366;
; CHECK:                (%i2)[0][6][1] = %limm364;
; CHECK:                (%i2)[0][7][4] = %limm362;
; CHECK:                (%i2)[0][7][1] = %limm360;
; CHECK:                (%i2)[0][8][4] = %limm358;
; CHECK:                (%i2)[0][8][1] = %limm356;
; CHECK:                (%i2)[0][9][4] = %limm354;
; CHECK:                (%i2)[0][9][1] = %limm352;
; CHECK:                (%i2)[0][10][4] = %limm350;
; CHECK:                (%i2)[0][10][1] = %limm348;
; CHECK:                (%i2)[0][11][4] = %limm346;
; CHECK:                (%i2)[0][11][1] = %limm344;
; CHECK:                (%i2)[0][12][4] = %limm342;
; CHECK:                (%i2)[0][12][1] = %limm340;
; CHECK:                (%i2)[0][13][4] = %limm338;
; CHECK:                (%i2)[0][13][1] = %limm336;
; CHECK:                (%i2)[0][14][4] = %limm334;
; CHECK:                (%i2)[0][14][1] = %limm332;
; CHECK:                (%i2)[0][15][4] = %limm330;
; CHECK:                (%i2)[0][15][1] = %limm328;
; CHECK:                (%i2)[0][16][4] = %limm326;
; CHECK:                (%i2)[0][16][1] = %limm324;
; CHECK:                (%i2)[0][17][4] = %limm322;
; CHECK:                (%i2)[0][17][1] = %limm320;
; CHECK:                (%i2)[0][18][4] = %limm318;
; CHECK:                (%i2)[0][18][1] = %limm316;
; CHECK:                (%i2)[0][19][4] = %limm314;
; CHECK:                (%i2)[0][19][1] = %limm312;
; CHECK:                (%i2)[0][20][4] = %limm310;
; CHECK:                (%i2)[0][20][1] = %limm308;
; CHECK:                (%i2)[0][21][4] = %limm306;
; CHECK:                (%i2)[0][21][1] = %limm304;
; CHECK:                (%i2)[0][22][4] = %limm302;
; CHECK:                (%i2)[0][22][1] = %limm300;
; CHECK:                (%i2)[0][23][4] = %limm298;
; CHECK:                (%i2)[0][23][1] = %limm296;
; CHECK:                (%i2)[0][24][4] = %limm294;
; CHECK:                (%i2)[0][24][1] = %limm292;
; CHECK:                (%i2)[0][25][4] = %limm290;
; CHECK:                (%i2)[0][25][1] = %limm288;
; CHECK:                (%i2)[0][26][4] = %limm286;
; CHECK:                (%i2)[0][26][1] = %limm284;
; CHECK:                (%i2)[0][27][4] = %limm282;
; CHECK:                (%i2)[0][27][1] = %limm280;
; CHECK:                (%i2)[0][28][4] = %limm278;
; CHECK:                (%i2)[0][28][1] = %limm276;
; CHECK:                (%i2)[0][29][4] = %limm274;
; CHECK:                (%i2)[0][29][1] = %limm272;
; CHECK:                (%i2)[0][30][4] = %limm270;
; CHECK:                (%i2)[0][30][1] = %limm268;
; CHECK:                (%i2)[0][31][4] = %limm266;
; CHECK:                (%i2)[0][31][1] = %limm264;
; CHECK:                (%i2)[0][32][4] = %limm262;
; CHECK:                (%i2)[0][32][1] = %limm260;
; CHECK:                (%i2)[0][33][4] = %limm258;

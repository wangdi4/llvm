...
; Notice that the example is similar to red-self-multi-oprd.ll.
; The differnced is the order of add operands in the RHS of reduction inst.
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %add7 = add nsw i32 %add, %add14
  %add21 = add nsw i32 %add7, %S.036

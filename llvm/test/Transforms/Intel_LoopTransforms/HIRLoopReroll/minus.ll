...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %2 = add nsw i64 %1, %0
  %arrayidx = getelementptr inbounds [10 x i64], [10 x i64]* @B, i64 0, i64 %indvars.iv
  store i64 %2, i64* %arrayidx, align 16, !tbaa !2
  %3 = or i64 %indvars.iv, 1
  %4 = mul nsw i64 %3, %3
  %5 = sub nsw i64 %0, %4
  %arrayidx8 = getelementptr inbounds [10 x i64], [10 x i64]* @B, i64 0, i64 %3
  store i64 %5, i64* %arrayidx8, align 8, !tbaa !2
  %6 = or i64 %indvars.iv, 2
  %7 = mul nsw i64 %6, %6
  %8 = add nsw i64 %7, %0
  %arrayidx16 = getelementptr inbounds [10 x i64], [10 x i64]* @B, i64 0, i64 %6
  store i64 %8, i64* %arrayidx16, align 16, !tbaa !2
  %9 = or i64 %indvars.iv, 3
  %10 = mul nsw i64 %9, %9
  %11 = add nsw i64 %10, %0
  %arrayidx24 = getelementptr inbounds [10 x i64], [10 x i64]* @B, i64 0, i64 %9
  store i64 %11, i64* %arrayidx24, align 8, !tbaa !2

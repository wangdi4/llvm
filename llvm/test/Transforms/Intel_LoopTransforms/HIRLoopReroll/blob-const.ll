...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %arrayidx4 = getelementptr inbounds [10 x i32], [10 x i32]* @B, i64 0, i64 %1
  ...
  store i32 %add, i32* %arrayidx8, align 8, !tbaa !2
  %3 = or i64 %indvars.iv, 3
  %arrayidx12 = getelementptr inbounds [10 x i32], [10 x i32]* @B, i64 0, i64 %3

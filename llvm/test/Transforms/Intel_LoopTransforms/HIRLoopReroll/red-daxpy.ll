...
for.cond1.preheader:                              ; preds = %for.cond.cleanup3, %for.cond1.preheader.preheader
  ...
  %arrayidx8 = getelementptr inbounds [10 x double], [10 x double]* @c, i64 0, i64 %indvars.iv37, !intel-tbaa !2
  %arrayidx8.promoted = load double, double* %arrayidx8, align 8, !tbaa !2
  br label %for.body4
...
for.cond.cleanup3:                                ; preds = %for.body4
  %add18.lcssa = phi double [ %add18, %for.body4 ]
  store double %add18.lcssa, double* %arrayidx8, align 8, !tbaa !2
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  ...
  %arrayidx = getelementptr inbounds [10 x double], [10 x double]* @y, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %0 = load double, double* %arrayidx, align 16, !tbaa !2
  %arrayidx6 = getelementptr inbounds [10 x double], [10 x double]* @x, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %1 = load double, double* %arrayidx6, align 16, !tbaa !2
  %mul = fmul double %0, %1
  %add = fadd double %add1833, %mul
  %2 = or i64 %indvars.iv, 1
  %arrayidx11 = getelementptr inbounds [10 x double], [10 x double]* @y, i64 0, i64 %2, !intel-tbaa !2
  %3 = load double, double* %arrayidx11, align 8, !tbaa !2
  %arrayidx14 = getelementptr inbounds [10 x double], [10 x double]* @x, i64 0, i64 %2, !intel-tbaa !2
  %4 = load double, double* %arrayidx14, align 8, !tbaa !2

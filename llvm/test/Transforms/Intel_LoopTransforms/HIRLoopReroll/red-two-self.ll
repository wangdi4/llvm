...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx = getelementptr inbounds [100 x i32], [100 x i32]* @A, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %0 = load i32, i32* %arrayidx, align 8, !tbaa !2
  %1 = or i64 %indvars.iv, 1
  %arrayidx2 = getelementptr inbounds [100 x i32], [100 x i32]* @A, i64 0, i64 %1, !intel-tbaa !2
  %2 = load i32, i32* %arrayidx2, align 4, !tbaa !2
  %add3 = add i32 %0, %S.024
  %add4 = add i32 %add3, %2
  %arrayidx6 = getelementptr inbounds [100 x i32], [100 x i32]* @B, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %3 = load i32, i32* %arrayidx6, align 8, !tbaa !2
  %arrayidx9 = getelementptr inbounds [100 x i32], [100 x i32]* @B, i64 0, i64 %1, !intel-tbaa !2

...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx = getelementptr inbounds [100 x double], [100 x double]* @A, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %0 = load double, double* %arrayidx, align 16, !tbaa !2
  %sub = fsub double %S.012, %0
  %1 = or i64 %indvars.iv, 1
  %arrayidx2 = getelementptr inbounds [100 x double], [100 x double]* @A, i64 0, i64 %1, !intel-tbaa !2

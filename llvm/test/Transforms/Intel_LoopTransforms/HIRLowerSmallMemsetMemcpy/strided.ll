...
;            BEGIN REGION { }
;                  + DO i1 = 0, 2, 1   <DO_LOOP>
;                  |   @llvm.memset.p0i8.i64(&((i8*)(%A)[0]),  5,  12,  0);
;                  + END LOOP
;            END REGION
...
bb17:                                             ; preds = %alloca, %bb17
  ...
  %t1 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 8, i32* elementtype(i32) %A, i64 1)
  %bc = bitcast i32* %t1 to i8*

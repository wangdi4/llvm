...
; and transformed to a loop. Check that missing trailing offsets are added correctly. Also
; check that loop is correctly formed on level 2.

; HIR:
;            BEGIN REGION { }
;                  + DO i1 = 0, 9, 1   <DO_LOOP>
;                  |   @llvm.memset.p0i8.i64(&((i8*)(%SSS)[0].0),  97,  30,  0);
;                  + END LOOP
;            END REGION
...
entry:
  ...
  %0 = getelementptr inbounds %struct.s1, %struct.s1* %SSS, i64 0, i32 0
  %bc =  bitcast %struct.s2* %0 to i8* 
  call void @llvm.lifetime.start.p0i8(i64 100, i8* nonnull %bc) #3
  br label %for.body

for.body:                                         ; preds = %entry, %for.body
  %i.03 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(30) %bc, i8 97, i64 30, i1 false)
...
for.end:                                          ; preds = %for.body
  ...
  call void @llvm.lifetime.end.p0i8(i64 100, i8* nonnull %bc) #3
  ret i32 %conv
}

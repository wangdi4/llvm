...
;            BEGIN REGION { }
;                  + DO i1 = 0, 9, 1   <DO_LOOP>
;                  |   @llvm.memset.p0.i64(&((i8*)(%SSS)[0].0),  97,  30,  0);
;                  + END LOOP
;            END REGION
...
entry:
  ...
  %0 = getelementptr inbounds %struct.s1, ptr %SSS, i64 0, i32 0
  %bc =  bitcast ptr %0 to ptr 
  call void @llvm.lifetime.start.p0(i64 100, ptr nonnull %bc) #3
  br label %for.body

for.body:                                         ; preds = %entry, %for.body
  %i.03 = phi i32 [ 0, %entry ], [ %inc, %for.body ]
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(30) %bc, i8 97, i64 30, i1 false)
...
for.end:                                          ; preds = %for.body
  ...
  call void @llvm.lifetime.end.p0(i64 100, ptr nonnull %bc) #3
  ret i32 %conv
}

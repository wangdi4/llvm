...
;            BEGIN REGION { }
;                  + DO i1 = 0, 9, 1   <DO_LOOP>
;                  |   @llvm.memset.p0i8.i64(&((i8*)(%arr)[0][i1][0]),  0,  32,  0);
;                  + END LOOP
;            END REGION
...
entry:
  %arr = alloca [10 x [10 x double*]], align 16
  br label %for.body

for.cond.cleanup:                                 ; preds = %for.body
  %idxprom3 = sext i32 %n to i64
  %arrayidx4 = getelementptr inbounds [10 x [10 x double*]], [10 x [10 x double*]]* %arr, i64 0, i64 3, i64 %idxprom3, !intel-tbaa !3
  %ld1 = load double*, double** %arrayidx4, align 8, !tbaa !3
  ret double* %ld1

for.body:                                         ; preds = %entry, %for.body
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ]
  %arrayidx1 = getelementptr inbounds [10 x [10 x double*]], [10 x [10 x double*]]* %arr, i64 0, i64 %indvars.iv, i64 0, !intel-tbaa !3
  %bc2 = bitcast double** %arrayidx1 to i8*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(32) %bc2, i8 0, i64 32, i1 false)

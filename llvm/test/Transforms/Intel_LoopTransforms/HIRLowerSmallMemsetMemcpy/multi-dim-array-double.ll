...
for.cond.cleanup:                                 ; preds = %for.body
  ...
  %arrayidx4 = getelementptr inbounds [10 x [20 x double]], [10 x [20 x double]]* %arr, i64 0, i64 3, i64 %idxprom3, !intel-tbaa !3
  %l1 = load double, double* %arrayidx4, align 8, !tbaa !3
  ret double %l1

for.body:                                         ; preds = %entry, %for.body
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.body ]
  %arrayidx1 = getelementptr inbounds [10 x [20 x double]], [10 x [20 x double]]* %arr, i64 0, i64 %indvars.iv, i64 0, !intel-tbaa !3

...
; <label>:9:                                      ; preds = %9, %4
  ...
  %11 = phi i8* [ %0, %4 ], [ %88, %9 ]
  %12 = phi i8* [ %2, %4 ], [ %89, %9 ]
  %13 = load i8, i8* %11, align 1, !tbaa !1
  %14 = zext i8 %13 to i32
  %15 = load i8, i8* %12, align 1, !tbaa !1
...
; <label>:92:                                     ; preds = %92, %91
  ...
  %102 = load i32, i32* %101, align 4, !tbaa !4
...
; <label>:146:                                    ; preds = %146, %137
  ...
  %150 = load i8, i8* %148, align 1, !tbaa !1
  ...
  %207 = load i8, i8* %206, align 1, !tbaa !1
...
; <label>:231:                                    ; preds = %231, %228
  ...
  %241 = load i32, i32* %240, align 4, !tbaa !4
...
; <label>:282:                                    ; preds = %282, %276
  ...
  %317 = load i8, i8* %316, align 1, !tbaa !1
  ...
  %343 = load i8, i8* %342, align 1, !tbaa !1
...
; <label>:367:                                    ; preds = %367, %364
  ...
  %379 = load i32, i32* %378, align 4, !tbaa !4
  %380 = add i32 %379, %377
  %381 = sub i32 %377, %379
...
; <label>:418:                                    ; preds = %418, %412
  ...
  %479 = load i8, i8* %478, align 1, !tbaa !1
...
; <label>:834:                                    ; preds = %834, %828
  ...
  %838 = load i8, i8* %836, align 1, !tbaa !1
  %839 = zext i8 %838 to i32
  %840 = load i8, i8* %837, align 1, !tbaa !1
  %841 = zext i8 %840 to i32
  %842 = sub nsw i32 %839, %841
  %843 = getelementptr inbounds i8, i8* %836, i64 4
  %844 = load i8, i8* %843, align 1, !tbaa !1
...
!3 = !{!"Simple C/C++ TBAA"}
!4 = !{!5, !7, i64 0}
!5 = !{!"array@_ZTSA4_A4_j", !6, i64 0}
!6 = !{!"array@_ZTSA4_j", !7, i64 0}
!7 = !{!"int", !2, i64 0}

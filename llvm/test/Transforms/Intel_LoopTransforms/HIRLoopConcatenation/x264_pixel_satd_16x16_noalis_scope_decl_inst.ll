; RUN: opt -enable-intel-advanced-opts -mattr=+avx2 -xmain-opt-level=3 -passes="hir-ssa-deconstruction,hir-temp-cleanup,print<hir>,hir-loop-concatenation,print<hir>" -disable-output 2>&1 < %s | FileCheck %s

; Verifies that we can handle intermediate calls to
; @llvm.experimental.noalias.scope.decl() by moving them before the first loop.
...
; CHECK: @llvm.experimental.noalias.scope.decl(!16);
; CHECK: DO i1 = 0, 3, 1
; CHECK: DO i1 = 0, 3, 1
; CHECK: @llvm.experimental.noalias.scope.decl(!24);
; CHECK: DO i1 = 0, 3, 1
; CHECK: DO i1 = 0, 3, 1
; CHECK: @llvm.experimental.noalias.scope.decl(!32);
; CHECK: DO i1 = 0, 3, 1
; CHECK: DO i1 = 0, 3, 1
; CHECK: DO i1 = 0, 3, 1
; CHECK: DO i1 = 0, 3, 1
...
; Check that NoAliasScope Insts are moved to the beginning of the region.
; CHECK: @llvm.experimental.noalias.scope.decl(!16);
; CHECK: @llvm.experimental.noalias.scope.decl(!24);
; CHECK: @llvm.experimental.noalias.scope.decl(!32);
...
!9 = !{!"int", !4, i64 0}
!10 = !{!11}
!11 = distinct !{!11, !12, !"bar: %x"}
!12 = distinct !{!12, !"bar"}
!13 = !{!14}
!14 = distinct !{!14, !15, !"bar: %x"}
!15 = distinct !{!15, !"bar"}
!16 = !{!17}
!17 = distinct !{!17, !18, !"bar: %x"}
!18 = distinct !{!18, !"bar"}

...
;
; RUN: opt -opaque-pointers -hir-ssa-deconstruction -hir-temp-cleanup -hir-identity-matrix-idiom-recognition -print-after=hir-identity-matrix-idiom-recognition < %s 2>&1 | FileCheck %s

...
; CHECK:           |   |   (@A)[0][10][i1][i2] = 0.000000e+00;
; CHECK:           |   + END LOOP
; CHECK:           + END LOOP
;
; CHECK:           + DO i1 = 0, 99, 1   <DO_LOOP>
; CHECK:           |   (@A)[0][10][i1][i1] = 1.000000e+00;
; CHECK:           + END LOOP
; CHECK:     END REGION
;
;Module Before HIR
...
@A = common dso_local local_unnamed_addr global [100 x [100 x [100 x float]]] zeroinitializer, align 16

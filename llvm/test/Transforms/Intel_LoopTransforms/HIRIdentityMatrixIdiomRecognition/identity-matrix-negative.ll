; Skip the transformation when the number of elements does not equal to the inner loop trip count
; Source code
;
;float A[100][100];
;void foo(){
...
; CHECK:           |   |   %. = (i1 == i2) ? 1.000000e+00 : 0.000000e+00;
; CHECK:           |   |   (@A)[0][i1][i2] = %.;
; CHECK:           |   + END LOOP
; CHECK:           + END LOOP
; CHECK:     END REGION
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %arrayidx6 = getelementptr inbounds [100 x [100 x float]], [100 x [100 x float]]* @A, i64 0, i64 %indvars.iv23, i64 %indvars.iv
...
for.inc11:                                        ; preds = %for.body3
  ...
  %exitcond25 = icmp eq i64 %indvars.iv.next24, 50

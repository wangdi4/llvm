...
bb3:                                              ; preds = %bb16, %alloca
  ...
  %"A[]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 20, float* getelementptr inbounds ([5 x [5 x float]], [5 x [5 x float]]* @A, i64 0, i64 0, i64 0), i64 %indvars.iv77)
  br label %bb7

bb7:                                              ; preds = %bb7, %bb3
  %indvars.iv74 = phi i64 [ %indvars.iv.next75, %bb7 ], [ 1, %bb3 ]
  %"A[][]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* %"A[]", i64 %indvars.iv74)
...
bb16:                                             ; preds = %bb7
  %"A[]6[]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* nonnull %"A[]", i64 %indvars.iv77)
...
bb21:                                             ; preds = %bb21.preheader, %bb39
  ...
  %"B[]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 20, float* getelementptr inbounds ([5 x [5 x float]], [5 x [5 x float]]* @B, i64 0, i64 0, i64 0), i64 %indvars.iv71)
  %"C[]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 20, float* getelementptr inbounds ([5 x [5 x float]], [5 x [5 x float]]* @C, i64 0, i64 0, i64 0), i64 %indvars.iv71)
  br label %bb25

bb25:                                             ; preds = %bb25, %bb21
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb25 ], [ 1, %bb21 ]
  %"B[][]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* %"B[]", i64 %indvars.iv)
  store float 0.000000e+00, float* %"B[][]", align 4
  %"C[][]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* %"C[]", i64 %indvars.iv)
...
bb39:                                             ; preds = %bb25
  %"B[]35[]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* nonnull %"B[]", i64 %indvars.iv71)
  store float 1.000000e+00, float* %"B[]35[]", align 4
  %"C[]40[]" = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* nonnull %"C[]", i64 %indvars.iv71)

...
define i32 @foo(ptr %blk1, ptr %blk2, ptr %add.ptr220, i32 %h, i32 %lx) {
entry:
...
for.cond225.preheader:                            ; preds = %entry, %for.end248
  ...
  %p2.2471 = phi ptr [ %add.ptr250, %for.end248 ], [ %blk2, %entry ]
  %p1a.0470 = phi ptr [ %add.ptr249, %for.end248 ], [ %add.ptr220, %entry ]
  %p1.2469 = phi ptr [ %p1a.0470, %for.end248 ], [ %blk1, %entry ]
...
for.body228:                                      ; preds = %for.body228, %for.cond225.preheader
  ...
  %arrayidx229 = getelementptr inbounds i8, ptr %p1.2469, i32 %i.1466
  %0 = load i8, ptr %arrayidx229, align 1
  %conv230 = zext i8 %0 to i32
  %arrayidx231 = getelementptr inbounds i8, ptr %p1a.0470, i32 %i.1466
  %1 = load i8, ptr %arrayidx231, align 1
  %conv232 = zext i8 %1 to i32
  %add233 = add nuw nsw i32 %conv230, 1
  %add234 = add nuw nsw i32 %add233, %conv232
  %shr235 = lshr i32 %add234, 1
  %arrayidx236 = getelementptr inbounds i8, ptr %p2.2471, i32 %i.1466
  %2 = load i8, ptr %arrayidx236, align 1
...
for.end248:                                       ; preds = %for.body228
  ...
  %add.ptr249 = getelementptr inbounds i8, ptr %p1a.0470, i32 %lx
  %add.ptr250 = getelementptr inbounds i8, ptr %p2.2471, i32 %lx

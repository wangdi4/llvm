...
; Verify that unroll of simple triangular loop is disabled due to disabling metadata on inner loop.
...
for.inc:                                          ; preds = %for.body3
  ...
  br i1 %cmp2, label %for.body3, label %for.cond1.for.end_crit_edge, !llvm.loop !0

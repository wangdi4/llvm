...
; CHECK: |   (%t5)[0][i1][0] = zext.i8.i32(%t60) + zext.i8.i32(%t44) + zext.i8.i32(%t28) + zext.i8.i32(%t13) + 65536 * zext.i8.i32(%t67) + 65536 * zext.i8.i32(%t51) + 65536 * zext.i8.i32(%t35) + 65536 * zext.i8.i32(%t19) + -65536 * zext.i8.i32(%t70) + -65536 * zext.i8.i32(%t54) + -65536 * zext.i8.i32(%t38) + -65536 * zext.i8.i32(%t22) + -1 * zext.i8.i32(%t63) + -1 * zext.i8.i32(%t47) + -1 * zext.i8.i32(%t31) + -1 * zext.i8.i32(%t15);
; CHECK: |   (%t5)[0][i1][2] = -1 * zext.i8.i32(%t60) + -1 * zext.i8.i32(%t44) + zext.i8.i32(%t28) + zext.i8.i32(%t13) + -65536 * zext.i8.i32(%t67) + -65536 * zext.i8.i32(%t51) + 65536 * zext.i8.i32(%t35) + 65536 * zext.i8.i32(%t19) + 65536 * zext.i8.i32(%t70) + 65536 * zext.i8.i32(%t54) + -65536 * zext.i8.i32(%t38) + -65536 * zext.i8.i32(%t22) + zext.i8.i32(%t63) + zext.i8.i32(%t47) + -1 * zext.i8.i32(%t31) + -1 * zext.i8.i32(%t15);
; CHECK: |   (%t5)[0][i1][1] = -1 * zext.i8.i32(%t60) + zext.i8.i32(%t44) + -1 * zext.i8.i32(%t28) + zext.i8.i32(%t13) + -65536 * zext.i8.i32(%t67) + 65536 * zext.i8.i32(%t51) + -65536 * zext.i8.i32(%t35) + 65536 * zext.i8.i32(%t19) + 65536 * zext.i8.i32(%t70) + -65536 * zext.i8.i32(%t54) + 65536 * zext.i8.i32(%t38) + -65536 * zext.i8.i32(%t22) + zext.i8.i32(%t63) + -1 * zext.i8.i32(%t47) + zext.i8.i32(%t31) + -1 * zext.i8.i32(%t15);
; CHECK: |   (%t5)[0][i1][3] = zext.i8.i32(%t60) + -1 * zext.i8.i32(%t44) + -1 * zext.i8.i32(%t28) + zext.i8.i32(%t13) + 65536 * zext.i8.i32(%t67) + -65536 * zext.i8.i32(%t51) + -65536 * zext.i8.i32(%t35) + 65536 * zext.i8.i32(%t19) + -65536 * zext.i8.i32(%t70) + 65536 * zext.i8.i32(%t54) + 65536 * zext.i8.i32(%t38) + -65536 * zext.i8.i32(%t22) + -1 * zext.i8.i32(%t63) + zext.i8.i32(%t47) + zext.i8.i32(%t31) + -1 * zext.i8.i32(%t15);
; CHECK: + END LOOP
...
define void @foo(ptr %t0, ptr %t2, i64 %t7, i64 %t8) {
entry:
...
loop:                                      ; preds = %loop, %entry
  ...
  %t80 = getelementptr inbounds [4 x [4 x i32]], ptr %t5, i64 0, i64 %t10, i64 0
  store i32 %t79, ptr %t80, align 16
  %t81 = sub nsw i32 %t75, %t77
  %t82 = getelementptr inbounds [4 x [4 x i32]], ptr %t5, i64 0, i64 %t10, i64 2
  store i32 %t81, ptr %t82, align 8
  %t83 = add nsw i32 %t78, %t76
  %t84 = getelementptr inbounds [4 x [4 x i32]], ptr %t5, i64 0, i64 %t10, i64 1
  store i32 %t83, ptr %t84, align 4
  %t85 = sub nsw i32 %t76, %t78
  %t86 = getelementptr inbounds [4 x [4 x i32]], ptr %t5, i64 0, i64 %t10, i64 3
  store i32 %t85, ptr %t86, align 4
  %t87 = add nuw nsw i64 %t10, 1
  %t88 = getelementptr inbounds i8, ptr %t11, i64 %t7
  %t89 = getelementptr inbounds i8, ptr %t12, i64 %t8

...
; Verify that there are GEP savings of 2 due to these address simplifications-
; 1. Addition of i1 and the trailing offset 1.
; 2. Addition with the base pointer.
...
@A = internal global [10 x %struct.S] zeroinitializer
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %d = getelementptr inbounds [10 x %struct.S], [10 x %struct.S]* @A, i64 0, i64 %indvars.iv, i32 1

...
; RUN: opt -convert-to-subscript < %s | opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-pre-vec-complete-unroll" -aa-pipeline="type-based-aa" -debug-only=hir-complete-unroll 2>&1 | FileCheck %s

...
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,hir-post-vec-complete-unroll,print<hir>" -disable-output -vplan-force-loop-vf=1:1 2>&1 < %s | FileCheck %s

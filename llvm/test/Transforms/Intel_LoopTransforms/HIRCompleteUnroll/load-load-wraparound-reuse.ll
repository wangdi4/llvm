...
define void @foo(ptr nocapture %arg, i64 %tmp211) {
entry:
...
bb212:                                            ; preds = %bb244, %entry
  ...
  %tmp214 = getelementptr inbounds [8 x i8], ptr %arg, i64 %tmp213, i64 %tmp211
  %tmp215 = load i8, ptr %tmp214, align 1, !tbaa !2
  %tmp216 = icmp eq i8 %tmp215, 0
  br i1 %tmp216, label %bb227, label %bb217

bb217:                                            ; preds = %bb212
  %tmp218 = zext i8 %tmp215 to i64
  %tmp219 = getelementptr inbounds [256 x i8], ptr @Logtable, i64 0, i64 %tmp218
  %tmp220 = load i8, ptr %tmp219, align 1, !tbaa !6
  %tmp221 = zext i8 %tmp220 to i32
  %tmp222 = add nuw nsw i32 %tmp221, 25
  %tmp223 = urem i32 %tmp222, 255
  %tmp224 = zext i32 %tmp223 to i64
  %tmp225 = getelementptr inbounds [256 x i8], ptr @Alogtable, i64 0, i64 %tmp224
  %tmp226 = load i8, ptr %tmp225, align 1, !tbaa !6
  br label %bb227
...
bb227:                                            ; preds = %bb217, %bb212
  ...
  %tmp231 = getelementptr inbounds [8 x i8], ptr %arg, i64 %tmp230, i64 %tmp211
  %tmp232 = load i8, ptr %tmp231, align 1, !tbaa !2
  %tmp233 = icmp eq i8 %tmp232, 0
  br i1 %tmp233, label %bb244, label %bb234

bb234:                                            ; preds = %bb227
  %tmp235 = zext i8 %tmp232 to i64
  %tmp236 = getelementptr inbounds [256 x i8], ptr @Logtable, i64 0, i64 %tmp235
  %tmp237 = load i8, ptr %tmp236, align 1, !tbaa !6
  %tmp238 = zext i8 %tmp237 to i32
  %tmp239 = add nuw nsw i32 %tmp238, 1
  %tmp240 = urem i32 %tmp239, 255
  %tmp241 = zext i32 %tmp240 to i64
  %tmp242 = getelementptr inbounds [256 x i8], ptr @Alogtable, i64 0, i64 %tmp241
  %tmp243 = load i8, ptr %tmp242, align 1, !tbaa !6
  br label %bb244
...
bb244:                                            ; preds = %bb234, %bb227
  ...
  %tmp249 = getelementptr inbounds [8 x i8], ptr %arg, i64 %tmp248, i64 %tmp211
  %tmp250 = load i8, ptr %tmp249, align 1, !tbaa !2
  %tmp251 = xor i8 %tmp246, %tmp250
  %tmp252 = add nuw nsw i64 %tmp213, 3
  %tmp253 = and i64 %tmp252, 3
  %tmp254 = getelementptr inbounds [8 x i8], ptr %arg, i64 %tmp253, i64 %tmp211
  %tmp255 = load i8, ptr %tmp254, align 1, !tbaa !2
  %tmp256 = xor i8 %tmp251, %tmp255
  %tmp257 = getelementptr inbounds [4 x [8 x i8]], ptr %tmp4, i64 0, i64 %tmp213, i64 %tmp211
  store i8 %tmp256, ptr %tmp257, align 1, !tbaa !11

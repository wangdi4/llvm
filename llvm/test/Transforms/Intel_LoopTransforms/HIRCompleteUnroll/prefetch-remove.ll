; RUN: opt -S -hir-ssa-deconstruction -hir-post-vec-complete-unroll -print-before=hir-post-vec-complete-unroll -print-after=hir-post-vec-complete-unroll 2>&1 -disable-output < %s | FileCheck %s
...
for.cond1.preheader:                              ; preds = %for.cond.cleanup10, %entry
  ...
  %add.ptr = getelementptr inbounds i32, i32* %a, i64 %0
  br label %for.body4
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %add.ptr6 = getelementptr inbounds i32, i32* %add.ptr, i64 %indvars.iv
...
for.body11:                                       ; preds = %for.body11.preheader, %for.body11
  ...
  %arrayidx = getelementptr inbounds i32, i32* %a, i64 %indvars.iv32
...
declare void @llvm.prefetch(i8* nocapture readonly, i32 immarg, i32 immarg, i32) #0

...
for.body:                                         ; preds = %for.inc.22, %entry
  ...
  %arrayidx = getelementptr inbounds i32, ptr %A, i64 %indvars.iv58
...
for.body.3:                                       ; preds = %for.inc.19, %for.body
  ...
  %arrayidx5 = getelementptr inbounds i32, ptr %A, i64 %indvars.iv55
...
for.body.8:                                       ; preds = %for.body.8, %for.body.3
  ...
  %arrayidx15 = getelementptr inbounds i32, ptr %A, i64 %8
  %9 = trunc i64 %7 to i32
  store i32 %9, ptr %arrayidx15, align 4
  %10 = mul nuw nsw i64 %indvars.iv, 3
  %arrayidx18 = getelementptr inbounds i32, ptr %A, i64 %10

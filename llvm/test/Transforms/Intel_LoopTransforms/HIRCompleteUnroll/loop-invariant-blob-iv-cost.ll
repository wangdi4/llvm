...
; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -hir-post-vec-complete-unroll -print-after=hir-post-vec-complete-unroll -debug-only=hir-complete-unroll 2>&1 < %s | FileCheck %s

...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [500 x i32], ptr @B, i64 0, i64 %i.05
  %0 = load i32, ptr %arrayidx, align 4, !tbaa !1
  %arrayidx1 = getelementptr inbounds [500 x i32], ptr @A, i64 0, i64 %i.05
...
for.end:                                          ; preds = %for.body
  %1 = load i32, ptr getelementptr inbounds ([500 x i32], ptr @A, i64 0, i64 2), align 8, !tbaa !1
  ret i32 %1
}

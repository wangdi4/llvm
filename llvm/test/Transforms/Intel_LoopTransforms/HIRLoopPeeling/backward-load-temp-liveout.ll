...
; Currently, this test case fails because %t.09 is a copy inst, not a load inst.
; TODO: Either improve temp cleanup to forward substitute %0 load into %t.09 or
; improve peeling to handle this case.

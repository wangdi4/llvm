...
define void @tf_(ptr noalias nocapture readonly dereferenceable(8) %ARRAY, ptr noalias nocapture readonly dereferenceable(4) %"tf_$BLOCK", ptr noalias nocapture readonly dereferenceable(4) %"tf_$K", ptr noalias nocapture readonly dereferenceable(4) %"tf_$NX_BLOCK", ptr noalias nocapture readonly dereferenceable(4) %"tf_$NY_BLOCK", ptr noalias nocapture dereferenceable(4) %BUF_3D) local_unnamed_addr {
alloca_0:
...
where_mask_then11:                                ; preds = %loop_body14
  ...
  store float %"(float)tf_$ARRAY[][]_fetch.30$", ptr %"tf_$TAVG_BUF_3D[][][][][]12", align 1
...
loop_test13.preheader:                            ; preds = %loop_test13.preheader.preheader, %loop_exit15
  ...
  %"tf_$ARRAY[]6" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.9, ptr nonnull elementtype(double) %ARRAY, i64 %"$loop_ctr1.064")

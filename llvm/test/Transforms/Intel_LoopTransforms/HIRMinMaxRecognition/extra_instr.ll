...
define void @tf_(ptr noalias nocapture readonly dereferenceable(8) %"tf_$ARRAY", ptr noalias nocapture readonly dereferenceable(4) %"tf_$BLOCK", ptr noalias nocapture readonly dereferenceable(4) %"tf_$K", ptr noalias nocapture readonly dereferenceable(4) %"tf_$NX_BLOCK", ptr noalias nocapture readonly dereferenceable(4) %"tf_$NY_BLOCK", ptr noalias nocapture dereferenceable(4) %BUF_3D) local_unnamed_addr {
alloca_0:
  ...
  %"tf_$TAVG_BUF_3D[]8" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 4, i64 1, i64 %mul.4, ptr nonnull elementtype(float) %BUF_3D, i64 0)
  %"tf_$TAVG_BUF_3D[][]9" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 3, i64 1, i64 %mul.3, ptr nonnull elementtype(float) %"tf_$TAVG_BUF_3D[]8", i64 %int_sext16)
  %"tf_$TAVG_BUF_3D[][][]10" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 %mul.2, ptr nonnull elementtype(float) %"tf_$TAVG_BUF_3D[][]9", i64 %int_sext15)
...
where_mask_then11:                                ; preds = %loop_body14
  ...
  store float %Z, ptr %"tf_$TAVG_BUF_3D[][][][][]12", align 1
...
loop_body14:                                      ; preds = %loop_body14.preheader, %where_mask_endif12
  ...
  %"tf_$TAVG_BUF_3D[][][][][]12" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %"tf_$TAVG_BUF_3D[][][][]11", i64 %"$loop_ctr.062")
  %"tf_$TAVG_BUF_3D[][][][][]_fetch.50" = load float, ptr %"tf_$TAVG_BUF_3D[][][][][]12", align 1
...
loop_test13.preheader:                            ; preds = %loop_test13.preheader.preheader, %loop_exit15
  ...
  %"tf_$ARRAY[]6" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.9, ptr nonnull elementtype(double) %"tf_$ARRAY", i64 %"$loop_ctr1.064")
  %"tf_$TAVG_BUF_3D[][][][]11" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %mul.1, ptr nonnull elementtype(float) %"tf_$TAVG_BUF_3D[][][]10", i64 %"$loop_ctr1.064")

...
; CHECK:           |   (%"sub_$STRUCTURE")[0:0:1600(double:0)][0:0:80(double:20)][0:i1:8(double:10)] = 1.000000e+00;
; CHECK:           + END LOOP
; CHECK:        END REGION
;
;Module Before HIR
...
define void @sub_(ptr noalias nocapture writeonly dereferenceable(48008) %"sub_$STRUCTURE") local_unnamed_addr #0 {
alloca_0:
...
loop_body4:                                       ; preds = %loop_test3.preheader, %loop_body4
  ...
  %"sub_$STRUCTURE.A$[][][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 8, ptr nonnull elementtype(double) %"sub_$STRUCTURE.A$[][]", i64 %"$loop_ctr.09")
  store double 1.000000e+00, ptr %"sub_$STRUCTURE.A$[][][]", align 1, !tbaa !0
...
loop_test3.preheader:                             ; preds = %loop_test7.preheader, %loop_exit5
  ...
  %"sub_$STRUCTURE.A$[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 80, ptr nonnull elementtype(double) %"sub_$STRUCTURE.A$[]", i64 %"$loop_ctr1.010")
  br label %loop_body4
...
loop_test7.preheader:                             ; preds = %alloca_0, %loop_exit9
  ...
  %"sub_$STRUCTURE.A$[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 1600, ptr nonnull elementtype(double) %"sub_$STRUCTURE", i64 %"$loop_ctr2.011")

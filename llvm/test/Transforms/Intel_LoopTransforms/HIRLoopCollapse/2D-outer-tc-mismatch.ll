...
;
; Verify that the loops are collapsed even though the number of elements in the
; outer dimension do not match the trip count of the outer loop.
; The array access is still contiguous but we are not traversing the outer

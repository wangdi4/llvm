...
define void @aer_(ptr dereferenceable(8) %"aer_$A") local_unnamed_addr #0 {
alloca_0:
  %"aer_$P" = alloca %"QNCA_a0$ptr$rank2$", align 8, !llfort.type_idx !0
  %"aer_$P.flags$" = getelementptr inbounds %"QNCA_a0$ptr$rank2$", ptr %"aer_$P", i64 0, i32 3
  store i64 3, ptr %"aer_$P.flags$", align 8, !tbaa !1
  %"aer_$P.addr_length$" = getelementptr inbounds %"QNCA_a0$ptr$rank2$", ptr %"aer_$P", i64 0, i32 1
  store i64 8, ptr %"aer_$P.addr_length$", align 8, !tbaa !6
  %"aer_$P.dim$" = getelementptr inbounds %"QNCA_a0$ptr$rank2$", ptr %"aer_$P", i64 0, i32 4
  store i64 2, ptr %"aer_$P.dim$", align 8, !tbaa !7
  %"aer_$P.codim$" = getelementptr inbounds %"QNCA_a0$ptr$rank2$", ptr %"aer_$P", i64 0, i32 2
  store i64 0, ptr %"aer_$P.codim$", align 8, !tbaa !8
  %"aer_$P.dim_info$.spacing$" = getelementptr inbounds %"QNCA_a0$ptr$rank2$", ptr %"aer_$P", i64 0, i32 6, i64 0, i32 1
  ...
  store i64 16, ptr %"aer_$P.dim_info$.spacing$[]", align 1, !tbaa !9
  %"aer_$P.dim_info$.lower_bound$" = getelementptr inbounds %"QNCA_a0$ptr$rank2$", ptr %"aer_$P", i64 0, i32 6, i64 0, i32 2
  ...
  store i64 1, ptr %"aer_$P.dim_info$.lower_bound$[]", align 1, !tbaa !10
  %"aer_$P.dim_info$.extent$" = getelementptr inbounds %"QNCA_a0$ptr$rank2$", ptr %"aer_$P", i64 0, i32 6, i64 0, i32 0
  ...
  store i64 3, ptr %"aer_$P.dim_info$.extent$[]", align 1, !tbaa !11
  ...
  store i64 40, ptr %"aer_$P.dim_info$.spacing$[]6", align 1, !tbaa !9
  ...
  store i64 1, ptr %"aer_$P.dim_info$.lower_bound$[]9", align 1, !tbaa !10
  ...
  store i64 4, ptr %"aer_$P.dim_info$.extent$[]12", align 1, !tbaa !11
  store ptr %"aer_$A", ptr %"aer_$P", align 8, !tbaa !12
...
loop_body6:                                       ; preds = %loop_test5.preheader, %loop_body6
  ...
  %"aer_$P.addr_a0$_fetch.1[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 16, ptr nonnull elementtype(double) %"aer_$P.addr_a0$_fetch.1[]", i64 %"var$5.070")
  store double 1.000000e+00, ptr %"aer_$P.addr_a0$_fetch.1[][]", align 1, !tbaa !13
...
loop_test5.preheader:                             ; preds = %alloca_0, %loop_exit7
  ...
  %"aer_$P.addr_a0$_fetch.1[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 40, ptr nonnull elementtype(double) %"aer_$A", i64 %"var$6.072")
  br label %loop_body6

...
; RUN: opt -passes="loop-simplify,hir-ssa-deconstruction,hir-loop-collapse,hir-cg,loop-simplifycfg,intel-ir-optreport-emitter" -aa-pipeline="basic-aa" -intel-loop-optreport=low 2>&1 < %s -S | FileCheck %s  -check-prefix=OPTREPORT
; OPTREPORT: LOOP BEGIN
; OPTREPORT:    Remark: 3 loops have been collapsed
; OPTREPORT: LOOP END

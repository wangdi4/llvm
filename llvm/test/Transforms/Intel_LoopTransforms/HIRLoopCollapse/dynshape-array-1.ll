...
define void @sub_(double* noalias nocapture dereferenceable(8) %"sub_$A", float* noalias nocapture readnone dereferenceable(4) %"sub_$B", i32* noalias nocapture readonly dereferenceable(4) %"sub_$N1", i32* noalias nocapture readnone dereferenceable(4) %"sub_$N2", i32* noalias nocapture readonly dereferenceable(4) %"sub_$N3") local_unnamed_addr #0 {
alloca_0:
  %"sub_$N1_fetch.1" = load i32, i32* %"sub_$N1", align 1
  %"sub_$N3_fetch.2" = load i32, i32* %"sub_$N3", align 1

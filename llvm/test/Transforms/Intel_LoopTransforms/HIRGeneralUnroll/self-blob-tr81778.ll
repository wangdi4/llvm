...
do.body:                                          ; preds = %entry, %do.body
  ...
  %arrayidx = getelementptr inbounds [256 x i8], ptr @mapchar, i64 0, i64 %indvars.iv
...
if.end9:                                          ; preds = %do.body
  ...
  %call10 = tail call i32 @fflush(ptr %3)
...
declare i32 @fflush(ptr nocapture) local_unnamed_addr #2

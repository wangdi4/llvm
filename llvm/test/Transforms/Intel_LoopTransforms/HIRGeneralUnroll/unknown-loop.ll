...
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,print<hir>,hir-general-unroll,print<hir>,hir-cg,simplifycfg,intel-ir-optreport-emitter" -intel-loop-optreport=low < %s 2>&1 | FileCheck %s

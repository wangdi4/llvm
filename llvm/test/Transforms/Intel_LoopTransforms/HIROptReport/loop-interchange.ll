...
; RUN: opt -passes="hir-ssa-deconstruction,hir-loop-interchange,hir-optreport-emitter,hir-cg" -intel-opt-report=low 2>&1 < %s -S | FileCheck %s -check-prefix=OPTREPORT --strict-whitespace
...
for.body4:                                        ; preds = %for.body4, %for.body4.lr.ph
  ...
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !2
  %arrayidx6 = getelementptr inbounds i32, ptr %1, i64 %indvars.iv25

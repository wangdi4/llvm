...
; CHECK: [[M1:!.*]] = distinct !{!"intel.optreport", [[M21:!.*]], [[M3:!.*]]}
; CHECK: [[M21]] = !{!"intel.optreport.title", !"FUNCTION REPORT"}
...
; CHECK: [[M9]] = distinct !{!"intel.optreport", [[M6]], [[M11:!.*]], [[M16:!.*]]}
; CHECK: [[M11]] = !{!"intel.optreport.next_sibling", [[M12:!.*]]}
; CHECK: [[M12]] = distinct !{!"intel.optreport", [[M14:!.*]]}
...
; CHECK: [[M17]] = distinct !{!"intel.optreport", [[M19:!.*]]}

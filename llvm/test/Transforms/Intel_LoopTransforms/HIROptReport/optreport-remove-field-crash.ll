; RUN: opt -passes="hir-ssa-deconstruction,hir-opt-predicate,hir-vec-dir-insert,hir-vplan-vec,hir-cg,intel-ir-optreport-emitter" -intel-opt-report=high 2>&1 -disable-output -vplan-force-vf=4 < %s | FileCheck %s
;

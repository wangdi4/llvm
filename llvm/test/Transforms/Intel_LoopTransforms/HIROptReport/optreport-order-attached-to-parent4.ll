...
; CHECK: [[M5]] = distinct !{!"intel.optreport", [[M7:!.*]], [[M9:!.*]]}
...
; CHECK: [[M10]] = distinct !{!"intel.optreport", [[M7]], [[M12:!.*]]}
; CHECK: [[M12]] = !{!"intel.optreport.next_sibling", [[M13:!.*]]}
; CHECK: [[M13]] = distinct !{!"intel.optreport", [[M7]]}
...
for.body9:                                        ; preds = %for.body9, %for.cond.cleanup3
  ...
  %arrayidx11 = getelementptr inbounds i32, ptr %A, i64 %indvars.iv20
  %1 = trunc i64 %indvars.iv20 to i32
  store i32 %1, ptr %arrayidx11, align 4, !tbaa !2
...
for.body19:                                       ; preds = %for.body19, %for.cond.cleanup8
  ...
  %arrayidx21 = getelementptr inbounds i32, ptr %C, i64 %indvars.iv23
  %2 = trunc i64 %indvars.iv23 to i32
  store i32 %2, ptr %arrayidx21, align 4, !tbaa !2

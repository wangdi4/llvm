...
for.body5:                                        ; preds = %for.body5, %if.then
  ...
  %arrayidx = getelementptr inbounds i32, ptr %A, i64 %indvars.iv23
...
for.body20:                                       ; preds = %for.body20, %if.end
  ...
  %arrayidx22 = getelementptr inbounds i32, ptr %C, i64 %indvars.iv26
  %2 = trunc i64 %indvars.iv26 to i32
  store i32 %2, ptr %arrayidx22, align 4, !tbaa !2

...
%"class.std::ios_base" = type { ptr, i32, i32, i32, i32, i32, ptr, %"struct.std::ios_base::_Words", [8 x %"struct.std::ios_base::_Words"], i32, ptr, %"class.std::locale" }
%"struct.std::ios_base::_Callback_list" = type { ptr, ptr, i32, i32 }
%"struct.std::ios_base::_Words" = type { ptr, i32 }
%"class.std::locale" = type { ptr }
%"class.std::locale::_Impl" = type { i32, ptr, i32, ptr, ptr }
%"class.std::locale::facet" = type { ptr, i32 }
%"class.std::basic_streambuf" = type { ptr, ptr, ptr, ptr, ptr, ptr, ptr, %"class.std::locale" }
%"class.std::ctype" = type <{ %"class.std::locale::facet", ptr, i8, [3 x i8], ptr, ptr, ptr, i8, [256 x i8], [256 x i8], i8, [2 x i8] }>
...
define i32 @main(i32 %argc, ptr nocapture readonly %argv) #3 personality ptr @__gxx_personality_v0 {
entry:
...
cond.end:                                         ; preds = %entry
  ...
  %call.i = tail call i32 @strtol(ptr nocapture nonnull %0, ptr null, i32 10) #2
...
for.body.i.i.preheader.i.i.i.i.i:                 ; preds = %cond.end, %entry
  ...
  %call2.i.i.i6.i.i170 = invoke ptr @_Znwj(i32 %mul.i.i.i.i.i)
...
for.body.i.i.preheader.i.i.i.i.i185:              ; preds = %for.body.i.i.preheader.i.i.i.i.i
  tail call void @llvm.memset.p0.i32(ptr nonnull %call2.i.i.i6.i.i170, i8 0, i32 %mul.i.i.i.i.i, i32 4, i1 false) #2
  %call2.i.i.i6.i.i188 = invoke ptr @_Znwj(i32 %mul.i.i.i.i.i)
          to label %for.body.preheader unwind label %ehcleanup97.thread

for.body.preheader:                               ; preds = %for.body.i.i.preheader.i.i.i.i.i185
  %1 = bitcast ptr %call2.i.i.i6.i.i170 to ptr
  %2 = bitcast ptr %call2.i.i.i6.i.i188 to ptr
  %add.ptr.i.i.i184 = getelementptr inbounds i32, ptr %2, i32 %cond323330
  tail call void @llvm.memset.p0.i32(ptr nonnull %call2.i.i.i6.i.i188, i8 0, i32 %mul.i.i.i.i.i, i32 4, i1 false) #2
  br label %for.body

for.body:                                         ; preds = %for.body, %for.body.preheader
  %i.0356 = phi i32 [ %inc34, %for.body ], [ 0, %for.body.preheader ]
  %add.ptr.i = getelementptr inbounds i32, ptr %1, i32 %i.0356
  store i32 %i.0356, ptr %add.ptr.i, align 4, !tbaa !5
  %inc = or i32 %i.0356, 1
  %add.ptr.i195 = getelementptr inbounds i32, ptr %1, i32 %inc
  store i32 %inc, ptr %add.ptr.i195, align 4, !tbaa !5
  %inc10 = add nuw nsw i32 %i.0356, 2
  %add.ptr.i206 = getelementptr inbounds i32, ptr %1, i32 %inc10
  store i32 %inc10, ptr %add.ptr.i206, align 4, !tbaa !5
  %inc13 = add nuw nsw i32 %i.0356, 3
  %add.ptr.i208 = getelementptr inbounds i32, ptr %1, i32 %inc13
  store i32 %inc13, ptr %add.ptr.i208, align 4, !tbaa !5
  %inc16 = add nuw nsw i32 %i.0356, 4
  %add.ptr.i217 = getelementptr inbounds i32, ptr %1, i32 %inc16
  store i32 %inc16, ptr %add.ptr.i217, align 4, !tbaa !5
  %inc19 = add nuw nsw i32 %i.0356, 5
  %add.ptr.i219 = getelementptr inbounds i32, ptr %1, i32 %inc19
  store i32 %inc19, ptr %add.ptr.i219, align 4, !tbaa !5
  %inc22 = add nuw nsw i32 %i.0356, 6
  %add.ptr.i225 = getelementptr inbounds i32, ptr %1, i32 %inc22
  store i32 %inc22, ptr %add.ptr.i225, align 4, !tbaa !5
  %inc25 = add nuw nsw i32 %i.0356, 7
  %add.ptr.i271 = getelementptr inbounds i32, ptr %1, i32 %inc25
  store i32 %inc25, ptr %add.ptr.i271, align 4, !tbaa !5
  %inc28 = add nuw nsw i32 %i.0356, 8
  %add.ptr.i275 = getelementptr inbounds i32, ptr %1, i32 %inc28
  store i32 %inc28, ptr %add.ptr.i275, align 4, !tbaa !5
  %inc31 = add nuw nsw i32 %i.0356, 9
  %add.ptr.i273 = getelementptr inbounds i32, ptr %1, i32 %inc31
  store i32 %inc31, ptr %add.ptr.i273, align 4, !tbaa !5
...
if.then.i.i.i268:                                 ; preds = %lpad5
  tail call void @_ZdlPv(ptr %call2.i.i.i6.i.i188) #2
...
for.body38:                                       ; preds = %for.body38.preheader, %for.body38
  ...
  %add.ptr.i265 = getelementptr inbounds i32, ptr %1, i32 %i35.0354
  %12 = load i32, ptr %add.ptr.i265, align 4, !tbaa !5
  %add.ptr.i263 = getelementptr inbounds i32, ptr %2, i32 %i35.0354
  store i32 %12, ptr %add.ptr.i263, align 4, !tbaa !5
  %dec = add nsw i32 %i35.0.in353, -2
  %add.ptr.i261 = getelementptr inbounds i32, ptr %1, i32 %dec
  %13 = load i32, ptr %add.ptr.i261, align 4, !tbaa !5
  %add.ptr.i259 = getelementptr inbounds i32, ptr %2, i32 %dec
  store i32 %13, ptr %add.ptr.i259, align 4, !tbaa !5
  %dec48 = add nsw i32 %i35.0.in353, -3
  %add.ptr.i257 = getelementptr inbounds i32, ptr %1, i32 %dec48
  %14 = load i32, ptr %add.ptr.i257, align 4, !tbaa !5
  %add.ptr.i255 = getelementptr inbounds i32, ptr %2, i32 %dec48
  store i32 %14, ptr %add.ptr.i255, align 4, !tbaa !5
  %dec53 = add nsw i32 %i35.0.in353, -4
  %add.ptr.i253 = getelementptr inbounds i32, ptr %1, i32 %dec53
  %15 = load i32, ptr %add.ptr.i253, align 4, !tbaa !5
  %add.ptr.i251 = getelementptr inbounds i32, ptr %2, i32 %dec53
  store i32 %15, ptr %add.ptr.i251, align 4, !tbaa !5
  %dec58 = add nsw i32 %i35.0.in353, -5
  %add.ptr.i249 = getelementptr inbounds i32, ptr %1, i32 %dec58
  %16 = load i32, ptr %add.ptr.i249, align 4, !tbaa !5
  %add.ptr.i247 = getelementptr inbounds i32, ptr %2, i32 %dec58
  store i32 %16, ptr %add.ptr.i247, align 4, !tbaa !5
  %dec63 = add nsw i32 %i35.0.in353, -6
  %add.ptr.i245 = getelementptr inbounds i32, ptr %1, i32 %dec63
  %17 = load i32, ptr %add.ptr.i245, align 4, !tbaa !5
  %add.ptr.i243 = getelementptr inbounds i32, ptr %2, i32 %dec63
  store i32 %17, ptr %add.ptr.i243, align 4, !tbaa !5
  %dec68 = add nsw i32 %i35.0.in353, -7
  %add.ptr.i241 = getelementptr inbounds i32, ptr %1, i32 %dec68
  %18 = load i32, ptr %add.ptr.i241, align 4, !tbaa !5
  %add.ptr.i239 = getelementptr inbounds i32, ptr %2, i32 %dec68
  store i32 %18, ptr %add.ptr.i239, align 4, !tbaa !5
  %dec73 = add nsw i32 %i35.0.in353, -8
  %add.ptr.i237 = getelementptr inbounds i32, ptr %1, i32 %dec73
  %19 = load i32, ptr %add.ptr.i237, align 4, !tbaa !5
  %add.ptr.i235 = getelementptr inbounds i32, ptr %2, i32 %dec73
  store i32 %19, ptr %add.ptr.i235, align 4, !tbaa !5
  %dec78 = add nsw i32 %i35.0.in353, -9
  %add.ptr.i233 = getelementptr inbounds i32, ptr %1, i32 %dec78
  %20 = load i32, ptr %add.ptr.i233, align 4, !tbaa !5
  %add.ptr.i231 = getelementptr inbounds i32, ptr %2, i32 %dec78
  store i32 %20, ptr %add.ptr.i231, align 4, !tbaa !5
  %dec83 = add nsw i32 %i35.0.in353, -10
  %add.ptr.i229 = getelementptr inbounds i32, ptr %1, i32 %dec83
  %21 = load i32, ptr %add.ptr.i229, align 4, !tbaa !5
  %add.ptr.i227 = getelementptr inbounds i32, ptr %2, i32 %dec83
  store i32 %21, ptr %add.ptr.i227, align 4, !tbaa !5
  %cmp37 = icmp sgt i32 %i35.0.in353, 10
  br i1 %cmp37, label %for.body38, label %invoke.cont90

invoke.cont90:                                    ; preds = %for.body38
  %add.ptr.i.i = getelementptr inbounds i32, ptr %add.ptr.i.i.i184, i32 -1
  %22 = load i32, ptr %add.ptr.i.i, align 4, !tbaa !5
  %call93 = invoke dereferenceable(140) ptr @_ZNSolsEi(ptr nonnull @_ZSt4cout, i32 %22)
          to label %invoke.cont92 unwind label %lpad5

invoke.cont92:                                    ; preds = %invoke.cont90
  %23 = bitcast ptr %call93 to ptr
  %vtable.i = load ptr, ptr %23, align 4, !tbaa !7
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i32 -12
  %24 = bitcast ptr %vbase.offset.ptr.i to ptr
  %vbase.offset.i = load i32, ptr %24, align 4
  %25 = bitcast ptr %call93 to ptr
  %add.ptr.i198 = getelementptr inbounds i8, ptr %25, i32 %vbase.offset.i
  %_M_ctype.i = getelementptr inbounds i8, ptr %add.ptr.i198, i32 124
  %26 = bitcast ptr %_M_ctype.i to ptr
  %27 = load ptr, ptr %26, align 4, !tbaa !9
  %tobool.i220 = icmp eq ptr %27, null
...
call.i209.noexc:                                  ; preds = %invoke.cont92
  %_M_widen_ok.i = getelementptr inbounds %"class.std::ctype", ptr %27, i32 0, i32 7
  %28 = load i8, ptr %_M_widen_ok.i, align 4, !tbaa !12
  %tobool.i = icmp eq i8 %28, 0
  br i1 %tobool.i, label %if.end.i, label %if.then.i

if.then.i:                                        ; preds = %call.i209.noexc
  %arrayidx.i = getelementptr inbounds %"class.std::ctype", ptr %27, i32 0, i32 8, i32 10
  %29 = load i8, ptr %arrayidx.i, align 1, !tbaa !14
  br label %call.i199.noexc

if.end.i:                                         ; preds = %call.i209.noexc
  invoke void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr nonnull %27)
          to label %.noexc214 unwind label %lpad5

.noexc214:                                        ; preds = %if.end.i
  %30 = bitcast ptr %27 to ptr
  %vtable.i212 = load ptr, ptr %30, align 4, !tbaa !7
  %vfn.i = getelementptr inbounds ptr, ptr %vtable.i212, i32 6
  %31 = load ptr, ptr %vfn.i, align 4
  %call.i213215 = invoke signext i8 %31(ptr nonnull %27, i8 signext 10)
...
call.i199.noexc:                                  ; preds = %.noexc214, %if.then.i
  ...
  %call1.i201 = invoke dereferenceable(140) ptr @_ZNSo3putEc(ptr nonnull %call93, i8 signext %retval.0.i)
          to label %call1.i.noexc unwind label %lpad5

call1.i.noexc:                                    ; preds = %call.i199.noexc
  %call.i203204 = invoke dereferenceable(140) ptr @_ZNSo5flushEv(ptr nonnull %call1.i201)
...
if.then.i.i.i173:                                 ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit193
  tail call void @_ZdlPv(ptr %call2.i.i.i6.i.i170) #2
...
if.then.i.i.i:                                    ; preds = %ehcleanup97, %ehcleanup97.thread
  ...
  %exn.slot.0346 = phi ptr [ %7, %ehcleanup97.thread ], [ %10, %ehcleanup97 ]
  tail call void @_ZdlPv(ptr %call2.i.i.i6.i.i170) #2
  br label %ehcleanup99

ehcleanup99:                                      ; preds = %if.then.i.i.i, %ehcleanup97, %lpad
  %exn.slot.1 = phi ptr [ %4, %lpad ], [ %10, %ehcleanup97 ], [ %exn.slot.0346, %if.then.i.i.i ]
  %ehselector.slot.1 = phi i32 [ %5, %lpad ], [ %11, %ehcleanup97 ], [ %ehselector.slot.0348, %if.then.i.i.i ]
  %lpad.val = insertvalue { ptr, i32 } undef, ptr %exn.slot.1, 0
  %lpad.val101 = insertvalue { ptr, i32 } %lpad.val, i32 %ehselector.slot.1, 1
  resume { ptr, i32 } %lpad.val101
}

; Function Attrs: argmemonly nounwind
declare void @llvm.lifetime.start(i64, ptr nocapture) #4

declare i32 @__gxx_personality_v0(...)

; Function Attrs: argmemonly nounwind
declare void @llvm.lifetime.end(i64, ptr nocapture) #4

declare dereferenceable(140) ptr @_ZNSolsEi(ptr, i32) #0

; Function Attrs: nounwind
declare i32 @strtol(ptr readonly, ptr nocapture, i32) #1

; Function Attrs: noreturn
declare void @_ZSt17__throw_bad_allocv() #5

; Function Attrs: nobuiltin
declare noalias nonnull ptr @_Znwj(i32) #6

declare void @__cxa_call_unexpected(ptr)

; Function Attrs: nobuiltin nounwind
declare void @_ZdlPv(ptr) #7

declare ptr @__cxa_begin_catch(ptr)

declare void @_ZSt9terminatev()

declare dereferenceable(140) ptr @_ZNSo3putEc(ptr, i8 signext) #0

declare dereferenceable(140) ptr @_ZNSo5flushEv(ptr) #0

; Function Attrs: noreturn
declare void @_ZSt16__throw_bad_castv() #5

declare void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr) #0
...
; Function Attrs: argmemonly nounwind
declare void @llvm.memset.p0.i32(ptr nocapture, i8, i32, i32, i1) #4

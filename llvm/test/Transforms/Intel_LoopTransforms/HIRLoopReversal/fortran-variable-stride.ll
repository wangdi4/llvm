...
bb119:
  ...
  %t0 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"foo_$A_$field6$_$field1$", i32 0)
  %t1 = load i64, i64* %t0, align 8
  %t2 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"foo_$A_$field6$_$field1$", i32 1)
...
bb172:                                            ; preds = %bb172, %bb119
  ...
  %t16 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 5, i64 %t3, i32* nonnull %"foo_$A_$field0$1", i64 %"var$24.0304")
  %t17 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 17, i64 %t1, i32* %t16, i64 20)
  %t18 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 5, i64 %t3, i32* nonnull %"foo_$A_$field0$1", i64 %"var$23.0305")
  %t19 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 17, i64 %t1, i32* %t18, i64 17)

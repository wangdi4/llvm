...
;
;
;RUN: opt -passes="loop-simplify,hir-ssa-deconstruction,hir-loop-reversal,hir-cg,simplifycfg,intel-ir-optreport-emitter" -aa-pipeline="basic-aa" -intel-opt-report=low 2>&1 < %s -S | FileCheck %s  -check-prefix=OPTREPORT
...
define i64 @foo(ptr nocapture %A, i64 %n) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  store i64 %i.010, ptr %arrayidx, align 8, !tbaa !1
  %inc = add nuw nsw i64 %i.010, 1
  %exitcond = icmp eq i64 %inc, %n
  br i1 %exitcond, label %for.end, label %for.body

for.end:                                          ; preds = %for.body, %entry
  %arrayidx2 = getelementptr inbounds i64, ptr %A, i64 5
  %0 = load i64, ptr %arrayidx2, align 8, !tbaa !1
  ret i64 %0
}

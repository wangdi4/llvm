...
entry:
  %0 = load i32, ptr @inptr, align 4, !tbaa !1
  %1 = load i32, ptr @insize, align 4, !tbaa !1
  %cmp = icmp ult i32 %0, %1
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %inc = add i32 %0, 1
  store i32 %inc, ptr @inptr, align 4, !tbaa !1
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  store i32 %cond, ptr @maxbits, align 4, !tbaa !1
  %and = and i32 %cond, 128
  store i32 %and, ptr @block_mode, align 4, !tbaa !1
  %and1 = and i32 %cond, 96
  %cmp2 = icmp eq i32 %and1, 0
  br i1 %cmp2, label %if.end11, label %if.then

if.then:                                          ; preds = %cond.end
  %3 = load i32, ptr @quiet, align 4, !tbaa !1
  %tobool = icmp eq i32 %3, 0
  br i1 %tobool, label %if.then4, label %if.end

if.then4:                                         ; preds = %if.then
  %4 = load ptr, ptr @stderr, align 8, !tbaa !6
  %5 = load ptr, ptr @progname, align 8, !tbaa !6
  %call6 = tail call i32 (ptr, ptr, ...) @fprintf(ptr %4, ptr @.str, ptr %5, ptr @ifname, i32 %and1) #5
  br label %if.end

if.end:                                           ; preds = %if.then, %if.then4
  %6 = load i32, ptr @exit_code, align 4, !tbaa !1
  %cmp7 = icmp eq i32 %6, 0
  br i1 %cmp7, label %if.then9, label %if.end11

if.then9:                                         ; preds = %if.end
  store i32 2, ptr @exit_code, align 4, !tbaa !1
  br label %if.end11

if.end11:                                         ; preds = %cond.end, %if.end, %if.then9
  %7 = load i32, ptr @maxbits, align 4, !tbaa !1
  %and12 = and i32 %7, 31
  store i32 %and12, ptr @maxbits, align 4, !tbaa !1
...
if.then15:                                        ; preds = %if.end11
  ...
  %call16 = tail call i32 (ptr, ptr, ...) @fprintf(ptr %8, ptr @.str.1, ptr %9, ptr @ifname, i32 %and12, i32 16) #5
  store i32 1, ptr @exit_code, align 4, !tbaa !1
  br label %cleanup

if.end17:                                         ; preds = %if.end11
  %10 = load i32, ptr @insize, align 4, !tbaa !1
  %11 = load i32, ptr @inptr, align 4, !tbaa !1
  %shl19 = shl i32 %11, 3
  %12 = load i32, ptr @block_mode, align 4, !tbaa !1
  %tobool21 = icmp ne i32 %12, 0
  tail call void @llvm.memset.p0.i64(ptr @prev, i8 0, i64 256, i32 2, i1 false)
  br label %for.body

for.body:                                         ; preds = %if.end17, %for.body
  %code.0436 = phi i64 [ 255, %if.end17 ], [ %dec, %for.body ]
  %conv26 = trunc i64 %code.0436 to i8
  %arrayidx27 = getelementptr inbounds [0 x i8], ptr @window, i64 0, i64 %code.0436
...
resetbuf:                                         ; preds = %if.then129, %if.end92, %do.body
  ...
  %13 = load i32, ptr @insize, align 4, !tbaa !1
...
for.body33:                                       ; preds = %for.body33, %for.body33.preheader
  ...
  %arrayidx35 = getelementptr inbounds [0 x i8], ptr @inbuf, i64 0, i64 %15
  %16 = load i8, ptr %arrayidx35, align 1, !tbaa !5
  %arrayidx37 = getelementptr inbounds [0 x i8], ptr @inbuf, i64 0, i64 %indvars.iv
  store i8 %16, ptr %arrayidx37, align 1, !tbaa !5
...
for.end40:                                        ; preds = %for.body33, %resetbuf
  store i32 %sub29, ptr @insize, align 4, !tbaa !1
...
if.then43:                                        ; preds = %for.end40
  ...
  %add.ptr = getelementptr inbounds [0 x i8], ptr @inbuf, i64 0, i64 %idx.ext
  %call44 = tail call i32 (i32, ptr, i32, ...) @spec_read(i32 %in, ptr %add.ptr, i32 32768) #4
...
if.end48:                                         ; preds = %if.then47, %if.then43
  %17 = load i32, ptr @insize, align 4, !tbaa !1
  %add49 = add i32 %17, %call44
  store i32 %add49, ptr @insize, align 4, !tbaa !1
  %conv50 = sext i32 %call44 to i64
  %18 = load i64, ptr @bytes_in, align 8, !tbaa !8
  %add51 = add i64 %18, %conv50
  store i64 %add51, ptr @bytes_in, align 8, !tbaa !8
  br label %if.end52
...
if.then72:                                        ; preds = %while.body
  ...
  %20 = load i32, ptr @maxbits, align 4, !tbaa !1
...
if.end95:                                         ; preds = %while.body
  ...
  %arrayidx97 = getelementptr inbounds [0 x i8], ptr @inbuf, i64 0, i64 %shr96
  %21 = load i8, ptr %arrayidx97, align 1, !tbaa !5
  %conv99 = zext i8 %21 to i64
  %arrayidx100 = getelementptr inbounds i8, ptr %arrayidx97, i64 1
  %22 = load i8, ptr %arrayidx100, align 1, !tbaa !5
  %conv101 = zext i8 %22 to i64
  %shl102 = shl nuw nsw i64 %conv101, 8
  %or = or i64 %shl102, %conv99
  %arrayidx103 = getelementptr inbounds i8, ptr %arrayidx97, i64 2
  %23 = load i8, ptr %arrayidx103, align 1, !tbaa !5
...
if.then118:                                       ; preds = %if.then115
  tail call void @error(ptr @.str.2) #4
  br label %if.end119
...
if.end119:                                        ; preds = %if.then118, %if.then115
  ...
  %arrayidx124 = getelementptr inbounds [0 x i8], ptr @outbuf, i64 0, i64 %idxprom123
  store i8 %conv121, ptr %arrayidx124, align 1, !tbaa !5
...
if.end125:                                        ; preds = %if.end95
  ...
  %24 = load i32, ptr @block_mode, align 4
...
if.then150:                                       ; preds = %if.then147
  %25 = load i32, ptr @test, align 4, !tbaa !1
...
if.then155:                                       ; preds = %if.then150
  tail call void @write_buf(i32 %out, ptr @outbuf, i32 %outpos.2388) #4
  %conv156 = sext i32 %outpos.2388 to i64
  %26 = load i64, ptr @bytes_out, align 8, !tbaa !8
  %add157 = add i64 %26, %conv156
  store i64 %add157, ptr @bytes_out, align 8, !tbaa !8
  br label %if.end158

if.end158:                                        ; preds = %if.then150, %if.then155
  %27 = load i32, ptr @to_stdout, align 4, !tbaa !1
  %tobool159 = icmp ne i32 %27, 0
  %cond160 = select i1 %tobool159, ptr @.str.2, ptr @.str.3
  tail call void @error(ptr %cond160) #4
  br label %if.end161

if.end161:                                        ; preds = %if.end158, %if.then147
  %conv162 = trunc i32 %finchar.2389 to i8
  store i8 %conv162, ptr getelementptr (i8, ptr getelementptr inbounds ([0 x i16], ptr @d_buf, i64 0, i64 32767), i64 -1), align 1, !tbaa !5
...
while.cond164.preheader:                          ; preds = %if.end161, %if.end144
  ...
  %stackp.0.ph = phi ptr [ getelementptr inbounds ([0 x i16], ptr @d_buf, i64 0, i64 32767), %if.end144 ], [ getelementptr (i8, ptr getelementptr inbounds ([0 x i16], ptr @d_buf, i64 0, i64 32767), i64 -1), %if.end161 ]
  %cmp165380 = icmp ugt i64 %code.1.ph, 255
  %arrayidx168381 = getelementptr inbounds [0 x i8], ptr @window, i64 0, i64 %code.1.ph
  %28 = load i8, ptr %arrayidx168381, align 1, !tbaa !5
...
while.body167:                                    ; preds = %while.cond164.preheader, %while.body167
  ...
  %stackp.0383 = phi ptr [ %incdec.ptr169, %while.body167 ], [ %stackp.0.ph, %while.cond164.preheader ]
  %code.1382 = phi i64 [ %conv171, %while.body167 ], [ %code.1.ph, %while.cond164.preheader ]
  %incdec.ptr169 = getelementptr inbounds i8, ptr %stackp.0383, i64 -1
  store i8 %29, ptr %incdec.ptr169, align 1, !tbaa !5
  %arrayidx170 = getelementptr inbounds [0 x i16], ptr @prev, i64 0, i64 %code.1382
  %30 = load i16, ptr %arrayidx170, align 2, !tbaa !10
  %conv171 = zext i16 %30 to i64
  %cmp165 = icmp ugt i16 %30, 255
  %arrayidx168 = getelementptr inbounds [0 x i8], ptr @window, i64 0, i64 %conv171
  %31 = load i8, ptr %arrayidx168, align 1, !tbaa !5
...
while.end:                                        ; preds = %while.body167, %while.cond164.preheader
  ...
  %stackp.0.lcssa = phi ptr [ %stackp.0.ph, %while.cond164.preheader ], [ %incdec.ptr169, %while.body167 ]
  %conv173 = zext i8 %.lcssa to i32
  %incdec.ptr175 = getelementptr inbounds i8, ptr %stackp.0.lcssa, i64 -1
  store i8 %.lcssa, ptr %incdec.ptr175, align 1, !tbaa !5
  %sub.ptr.rhs.cast = ptrtoint ptr %incdec.ptr175 to i64
...
do.body182:                                       ; preds = %while.end, %if.end205
  ...
  %stackp.1 = phi ptr [ %add.ptr207, %if.end205 ], [ %incdec.ptr175, %while.end ]
...
if.then191:                                       ; preds = %do.body182
  ...
  %add.ptr193 = getelementptr inbounds [0 x i8], ptr @outbuf, i64 0, i64 %idx.ext192
  %conv194 = sext i32 %sub183.i176.0 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr %add.ptr193, ptr %stackp.1, i64 %conv194, i32 1, i1 false)
...
if.then199:                                       ; preds = %if.end196
  %32 = load i32, ptr @test, align 4, !tbaa !1
  %tobool200 = icmp eq i32 %32, 0
  br i1 %tobool200, label %if.then201, label %if.end205

if.then201:                                       ; preds = %if.then199
  tail call void @write_buf(i32 %out, ptr @outbuf, i32 %outpos.4) #4
  %conv202 = sext i32 %outpos.4 to i64
  %33 = load i64, ptr @bytes_out, align 8, !tbaa !8
  %add203 = add i64 %33, %conv202
  store i64 %add203, ptr @bytes_out, align 8, !tbaa !8
  br label %if.end205
...
if.end205:                                        ; preds = %if.then201, %if.then199, %if.end196
  ...
  %add.ptr207 = getelementptr inbounds i8, ptr %stackp.1, i64 %idx.ext206
  %sub.ptr.rhs.cast208 = ptrtoint ptr %add.ptr207 to i64
  %sub.ptr.sub209 = sub i64 ptrtoint (ptr getelementptr inbounds ([0 x i16], ptr @d_buf, i64 0, i64 32767) to i64), %sub.ptr.rhs.cast208
...
if.else213:                                       ; preds = %while.end
  ...
  %add.ptr215 = getelementptr inbounds [0 x i8], ptr @outbuf, i64 0, i64 %idx.ext214
  %sext = shl i64 %sub.ptr.sub, 32
  %conv216 = ashr exact i64 %sext, 32
  tail call void @llvm.memcpy.p0.p0.i64(ptr %add.ptr215, ptr %incdec.ptr175, i64 %conv216, i32 1, i1 false)
  br label %if.end218
...
if.then221:                                       ; preds = %if.end218
  ...
  %arrayidx223 = getelementptr inbounds [0 x i16], ptr @prev, i64 0, i64 %free_ent.2.ph414
  store i16 %conv222, ptr %arrayidx223, align 2, !tbaa !10
  %arrayidx225 = getelementptr inbounds [0 x i8], ptr @window, i64 0, i64 %free_ent.2.ph414
  store i8 %.lcssa, ptr %arrayidx225, align 1, !tbaa !5
...
do.end232:                                        ; preds = %while.end228
  %34 = load i32, ptr @test, align 4, !tbaa !1
...
if.then237:                                       ; preds = %do.end232
  tail call void @write_buf(i32 %out, ptr @outbuf, i32 %outpos.2.lcssa) #4
  %conv238 = sext i32 %outpos.2.lcssa to i64
  %35 = load i64, ptr @bytes_out, align 8, !tbaa !8
  %add239 = add i64 %35, %conv238
  store i64 %add239, ptr @bytes_out, align 8, !tbaa !8
  br label %cleanup
...
declare i32 @fprintf(ptr nocapture, ptr nocapture readonly, ...) #3
...
declare void @error(ptr) #2

declare void @write_buf(i32, ptr, i32) #2

...
define void @window1d(ptr %A, ptr noalias %B, ptr %OuterStop, ptr %Ms) {
...
L0:
  ...
  %Mptr = getelementptr inbounds i64, ptr %Ms, i64 %h
  %M = load i64, ptr %Mptr, align 8
  br label %L1
...
L1.latch:
  ...
  %stopptr = getelementptr inbounds i8, ptr %OuterStop, i64 %i
  %stop = load i8, ptr %stopptr

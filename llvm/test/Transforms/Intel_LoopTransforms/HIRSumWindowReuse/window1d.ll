...
; checks that the placeholder pass is runnable and prints the placeholder
; message.
...
; CHECK: [NYI] Initial placeholder pass for HIR Sum Window Reuse

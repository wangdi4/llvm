...
; void sincos(double, double*, double*) and double fmod(double) were generated
; correctly since llvm.sin.f64 and llvm.cos.f64 are in the module.

; CHECK: Math function declarations added:
; CHECK:   Intrinsic @llvm.sin.f64 generates function @sin
; CHECK:   Intrinsic @llvm.cos.f64 generates function @cos
; CHECK:   New function @sincos generated
; CHECK:   New function @fmod generated
; CHECK:   Total functions added: 4

...
; xmain can dead-code-eliminate most of this. Probably because of x/0. ;INTEL
...
; CHECK-NEXT:    [[T121:%.*]] = icmp sgt i32 [[T11]], 0
<<<<<<< HEAD
; CHECK-NEXT:    br i1 [[T121]], label [[BB_LR_PH:%.*]], label [[BB3:%.*]], !prof [[PROF0:![0-9]+]] ;INTEL
=======
; CHECK-NEXT:    br i1 [[T121]], label [[BB_LR_PH:%.*]], label [[BB3:%.*]], !prof [[PROF0:![0-9]+]]
>>>>>>> f470922a299f6036259c703a534a9b1e60573df7
; CHECK:       bb.lr.ph:
; CHECK-NEXT:    [[TMP0:%.*]] = sext i32 [[T11]] to i64
; CHECK-NEXT:    br label [[BB:%.*]]
; CHECK:       bb:
...
; CHECK-NEXT:    br i1 [[OR_COND]], label [[BB]], label [[BB1_BB3_CRIT_EDGE:%.*]], !prof [[PROF0]] ;INTEL
=======
; CHECK-NEXT:    [[OR_COND:%.*]] = and i1 [[T10]], [[T12]]

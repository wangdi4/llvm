...
define dso_local void @test(i32 addrspace(1)* %results) {
; CHECK-LABEL: define dso_local void @test(
; CHECK: store i32 %0, i32 addrspace(3)* getelementptr inbounds ([100 x i32], [100 x i32] addrspace(3)* @test.i,
; CHECK: store i32 %1, i32 addrspace(3)* @test.j,
; CHECK: call fastcc zeroext i1 @foo()
;
entry:
  %0 = load i32, i32 addrspace(1)* null, align 4294967296
  store i32 %0, i32 addrspace(3)* getelementptr inbounds ([100 x i32], [100 x i32] addrspace(3)* @test.i, i64 0, i64 0), align 16
  %1 = load i32, i32 addrspace(1)* null, align 4294967296
  store i32 %1, i32 addrspace(3)* @test.j, align 4
  %call2 = tail call fastcc zeroext i1 @foo()
  ret void
}

define dso_local void @test2(i32 addrspace(1)* %results) {
...
define dso_local void @test3(i32 addrspace(1)* %results) {
...
; CHECK: store i32 %0, i32 addrspace(3)* getelementptr inbounds ([100 x i32], [100 x i32] addrspace(3)* @test.i.clone,
...
; CHECK: store i32 %0, i32 addrspace(3)* getelementptr inbounds ([100 x i32], [100 x i32] addrspace(3)* @test.i.clone.clone,
; CHECK: store i32 %1, i32 addrspace(3)* @test.j.clone.clone,

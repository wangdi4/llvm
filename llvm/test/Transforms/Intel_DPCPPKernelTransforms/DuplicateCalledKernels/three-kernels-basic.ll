...
; Check that kernel 'test' and functon 'foo' are cloned correctly.
; Local variables used in these two functions are also cloned.
;
;     test2    test3
;       |        |
;     test      bar
...
;
entry:
  store i32 0, i32 addrspace(3)* getelementptr inbounds ([100 x i32], [100 x i32] addrspace(3)* @test.i, i64 0, i64 0), align 16

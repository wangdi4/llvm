...
entry:
  ...
  %call = tail call i32 @_Z14isgreaterequaldd(double %0, double %1) #2
  %conv = sext i32 %call to i64
  store i64 %conv, i64* %c, align 8, !tbaa !10
  ret void
;CHECK: define void @foo_double
;CHECK-NOT: call i32 @_Z14isgreaterequaldd
;CHECK: [[cmp:%[a-zA-Z0-9]+]] = fcmp oge double %0, %1
;CHECK-NEXT: [[zext:%[a-zA-Z0-9]+]] = zext i1 [[cmp]] to i32
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare i32 @_Z14isgreaterequaldd(double, double) #1
...
entry:
  ...
  %call = tail call <2 x i64> @_Z14isgreaterequalDv2_dS_(<2 x double> %0, <2 x double> %1) #2
  store <2 x i64> %call, <2 x i64>* %c, align 16, !tbaa !8
  ret void
;CHECK: define void @foo_double2
;CHECK-NOT: call <2 x i64> @_Z14isgreaterequalDv2_dS_
;CHECK: [[cmp2:%[a-zA-Z0-9]+]] = fcmp oge <2 x double> %0, %1
;CHECK-NEXT: [[sext2:%[a-zA-Z0-9]+]] = sext <2 x i1> [[cmp2]] to <2 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <2 x i64> @_Z14isgreaterequalDv2_dS_(<2 x double>, <2 x double>) #1
...
entry:
  ...
  %call = tail call <3 x i64> @_Z14isgreaterequalDv3_dS_(<3 x double> %extractVec, <3 x double> %extractVec3) #2
...
;CHECK-NOT: call <3 x i64> @_Z14isgreaterequalDv3_dS_
;CHECK: [[cmp3:%[a-zA-Z0-9]+]] = fcmp oge <3 x double> %extractVec, %extractVec3
;CHECK-NEXT: [[sext3:%[a-zA-Z0-9]+]] = sext <3 x i1> [[cmp3]] to <3 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <3 x i64> @_Z14isgreaterequalDv3_dS_(<3 x double>, <3 x double>) #1
...
entry:
  ...
  %call = tail call <4 x i64> @_Z14isgreaterequalDv4_dS_(<4 x double> %0, <4 x double> %1) #2
  store <4 x i64> %call, <4 x i64>* %c, align 32, !tbaa !8
  ret void
;CHECK: define void @foo_double4
;CHECK-NOT: call <4 x i64> @_Z14isgreaterequalDv4_dS_
;CHECK: [[cmp4:%[a-zA-Z0-9]+]] = fcmp oge <4 x double> %0, %1
;CHECK-NEXT: [[sext4:%[a-zA-Z0-9]+]] = sext <4 x i1> [[cmp4]] to <4 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <4 x i64> @_Z14isgreaterequalDv4_dS_(<4 x double>, <4 x double>) #1
...
entry:
  ...
  %call = tail call <8 x i64> @_Z14isgreaterequalDv8_dS_(<8 x double> %0, <8 x double> %1) #2
  store <8 x i64> %call, <8 x i64>* %c, align 64, !tbaa !8
  ret void
;CHECK: define void @foo_double8
;CHECK-NOT: call <8 x i64> @_Z14isgreaterequalDv8_dS_
;CHECK: [[cmp8:%[a-zA-Z0-9]+]] = fcmp oge <8 x double> %0, %1
;CHECK-NEXT: [[sext8:%[a-zA-Z0-9]+]] = sext <8 x i1> [[cmp2]] to <8 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <8 x i64> @_Z14isgreaterequalDv8_dS_(<8 x double>, <8 x double>) #1
...
entry:
  ...
  %call = tail call <16 x i64> @_Z14isgreaterequalDv16_dS_(<16 x double> %0, <16 x double> %1) #2
  store <16 x i64> %call, <16 x i64>* %c, align 128, !tbaa !8
  ret void
;CHECK: define void @foo_double16
;CHECK-NOT: call <16 x i64> @_Z14isgreaterequalDv16_dS_
;CHECK: [[cmp16:%[a-zA-Z0-9]+]] = fcmp oge <16 x double> %0, %1
;CHECK-NEXT: [[sext16:%[a-zA-Z0-9]+]] = sext <16 x i1> [[cmp2]] to <16 x i64>
;CHECK: ret void
}

; Function Attrs: nounwind readnone
declare <16 x i64> @_Z14isgreaterequalDv16_dS_(<16 x double>, <16 x double>) #1

...
declare i32 @_Z7isequalff(float, float) #1
...
; Function Attrs: nounwind readnone
declare <2 x i32> @_Z7isequalDv2_fS_(<2 x float>, <2 x float>) #1
...
; Function Attrs: nounwind readnone
declare <3 x i32> @_Z7isequalDv3_fS_(<3 x float>, <3 x float>) #1
...
; Function Attrs: nounwind readnone
declare <4 x i32> @_Z7isequalDv4_fS_(<4 x float>, <4 x float>) #1
...
; Function Attrs: nounwind readnone
declare <8 x i32> @_Z7isequalDv8_fS_(<8 x float>, <8 x float>) #1
...
; Function Attrs: nounwind readnone
declare <16 x i32> @_Z7isequalDv16_fS_(<16 x float>, <16 x float>) #1

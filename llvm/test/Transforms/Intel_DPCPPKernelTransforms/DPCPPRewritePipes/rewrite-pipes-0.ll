...
; Function Attrs: nounwind
declare spir_func %opencl.pipe_wo_t addrspace(1)* @_Z39__spirv_CreatePipeFromPipeStorage_writePU3AS445_ZTS19ConstantPipeStorage.ConstantPipeStorage(%struct.__spirv_ConstantPipeStorage addrspace(4)*) #0
...
declare spir_func %opencl.pipe_ro_t addrspace(1)* @_Z38__spirv_CreatePipeFromPipeStorage_readPU3AS445_ZTS19ConstantPipeStorage.ConstantPipeStorage(%struct.__spirv_ConstantPipeStorage addrspace(4)*) #0

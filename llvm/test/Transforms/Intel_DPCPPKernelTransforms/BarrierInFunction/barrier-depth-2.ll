...
;;      1. A call to @barrier_dummy() at the begining of the kernel "foo"
;;      2. A call to @_Z18work_group_barrierj(LOCAL_MEM_FENCE) just before calling the function "foo1"
;;      3. A call to @barrier_dummy() just after calling the function "foo1"
;;      4. A call to @_Z18work_group_barrierj(LOCAL_MEM_FENCE) at the end of the kernel "foo"
;;      5. A call to @barrier_dummy() at the begining of the function "foo1"
...
; DEBUGIFY-COUNT-2: WARNING: Instruction with empty DebugLoc in function foo -- call void @barrier_dummy()
; DEBUGIFY-COUNT-1: WARNING: Instruction with empty DebugLoc in function foo1 -- call void @barrier_dummy()

...
; RUN: opt --passes=dpcpp-kernel-sg-remap-wi-call -dpcpp-sg-construction-mode=linear -S %s | FileCheck %s
; RUN: opt --passes=dpcpp-kernel-sg-remap-wi-call -dpcpp-sg-construction-mode=0 -S %s | FileCheck -check-prefix=CHECK-DEFAULT %s
; RUN: opt --passes=dpcpp-kernel-sg-remap-wi-call -dpcpp-sg-construction-mode=1 -S %s | FileCheck %s
; RUN: opt --passes=dpcpp-kernel-sg-remap-wi-call -dpcpp-sg-construction-mode=2 -S %s | FileCheck %s
; RUN: opt --passes=dpcpp-kernel-sg-remap-wi-call -dpcpp-sg-construction-mode=linear -enable-debugify -disable-output -S %s 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
...
; RUN: opt --passes=dpcpp-kernel-sg-remap-wi-call -dpcpp-sg-construction-mode=1 -enable-debugify -disable-output -S %s 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
; RUN: opt --passes=dpcpp-kernel-sg-remap-wi-call -dpcpp-sg-construction-mode=2 -enable-debugify -disable-output -S %s 2>&1 | FileCheck -check-prefix=DEBUGIFY %s

...
define void @load_mad_store(i32 addrspace(4)* %ptr, i64 %Stride, <616 x i8> %x, <560 x i8> %y) {
  %1 = call <110 x i32> @llvm.experimental.matrix.load.v110i32.p4i32(i32 addrspace(4)* %ptr, i64 %Stride, i1 false, i32 11, i32 10, metadata !"matrix.rowmajor", metadata !"matrix.rowmajor", metadata !"scope.subgroup")
  ...
  call void @llvm.experimental.matrix.store.v110i32.p4i32(<110 x i32> %2, i32 addrspace(4)* %ptr, i64 %Stride, i1 false, i32 11, i32 10, metadata !"matrix.rowmajor", metadata !"matrix.rowmajor", metadata !"scope.subgroup")
  ret void
}

declare <110 x i32> @llvm.experimental.matrix.load.v110i32.p4i32(i32 addrspace(4)*, i64, i1, i32, i32, metadata, metadata, metadata) #5
...
declare void @llvm.experimental.matrix.store.v110i32.p4i32(<110 x i32>, i32 addrspace(4)*, i64, i1, i32, i32, metadata, metadata, metadata) #5

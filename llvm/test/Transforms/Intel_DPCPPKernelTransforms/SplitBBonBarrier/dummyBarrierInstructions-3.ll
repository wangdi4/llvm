...
;; The case: function "main" with 4 __builtin_dpcpp_kernel_barrier_dummy instructions
;;           2 start at begining of its basic block while other 2 are in middle
;; The expected result:
;;      1. 4 __builtin_dpcpp_kernel_barrier_dummy instructions each start at begining of basic block

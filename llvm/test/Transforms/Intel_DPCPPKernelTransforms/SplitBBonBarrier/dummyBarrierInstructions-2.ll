...
;; The case: function "main" with 3 __builtin_dpcpp_kernel_barrier_dummy instructions
;;           2 start at begining of its basic block while another 1 is in middle
;; The expected result:
;;      1. 3 __builtin_dpcpp_kernel_barrier_dummy instructions each start at begining of basic block
...
; CHECK:      [[BARRIER_BB]]:
; CHECK-NEXT: call void @__builtin_dpcpp_kernel_barrier_dummy()

...
;; The case: function "main" with 1 __builtin_dpcpp_kernel_barrier_dummy instruction in middle of its basic block
;; The expected result:
;;      1. 1 __builtin_dpcpp_kernel_barrier_dummy instruction start at begining of basic block

...
; CHECK-NEXT: [[GEP:%.*]] = getelementptr inbounds [4 x i32], [4 x i32]* [[I]], i64 0, i64 0 SR:[1] VR:[0] PR:[1]
; CHECK-NEXT: store i32 0, i32* [[GEP]], align 4, !tbaa !{{.*}} SR:[1] VR:[0] PR:[0]
...
entry:
  ...
  %arrayidx = getelementptr inbounds [4 x i32], [4 x i32]* %i, i64 0, i64 0

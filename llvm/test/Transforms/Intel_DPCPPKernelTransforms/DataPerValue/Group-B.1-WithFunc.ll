...
;; The case: kernel "main" with barrier instructions
;;           and non-uniform value "%y" that cross the barrier instruction.
;;           Also kernel "main" is calling function "foo", which contains
;;           a barrier instruction and return a void.
...
;;      3. Only value "%y" was collected to this group

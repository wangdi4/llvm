...
define void @test(i32 addrspace(1)* align 4 %_arg_r_acc, %"class.cl::sycl::id"* byval(%"class.cl::sycl::id") align 8 %_arg_r_acc3) {
entry:
...
Split.Barrier.BB18:                               ; preds = %entry
  ...
  %i1 = getelementptr inbounds %"class.cl::sycl::id", %"class.cl::sycl::id"* %_arg_r_acc3, i64 0, i32 0, i32 0, i64 0
  %i2 = load i64, i64* %i1, align 8
  %add.ptr.i = getelementptr inbounds i32, i32 addrspace(1)* %_arg_r_acc, i64 %i2
...
VPlannedBB4:                                      ; preds = %Split.Barrier.BB16, %Split.Barrier.BB18
  ...
  %CallWGForItem = call <4 x i32> @_Z14work_group_anyDv4_iPS_(<4 x i32> %broadcast.splat7, <4 x i32>* %AllocaWGResult)
...
Split.Barrier.BB17:                               ; preds = %Split.Barrier.BB
  ...
  %scalar.gep.copy = getelementptr inbounds i32, i32 addrspace(1)* %add.ptr.i, i64 %.copy
...
VPlannedBB9:                                      ; preds = %Split.Barrier.BB17
  %i6 = bitcast i32 addrspace(1)* %scalar.gep.copy to <4 x i32> addrspace(1)*
  store <4 x i32> <i32 1, i32 1, i32 1, i32 1>, <4 x i32> addrspace(1)* %i6, align 4
...
declare <4 x i32> @_Z14work_group_anyDv4_iPS_(<4 x i32> noundef, <4 x i32>* nocapture noundef)

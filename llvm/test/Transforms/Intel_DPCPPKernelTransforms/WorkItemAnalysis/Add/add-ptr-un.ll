...
; CHECK-NEXT: PTR   %3 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %2
...
; CHECK-NEXT: PTR   %9 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %1
; CHECK-NEXT: RND   store i32 %8, i32 addrspace(1)* %9, align 4
; CHECK-NEXT: UNI   ret void
; CHECK-NEXT: PTR   %11 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %1
; CHECK-NEXT: RND   store i32 2, i32 addrspace(1)* %11, align 4
; CHECK-NEXT: UNI   ret void

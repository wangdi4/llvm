...
; CHECK-NEXT: UNI   %0 = getelementptr inbounds float, float* %A, i64 5
; CHECK-NEXT: UNI   %1 = load float, float* %0, align 4
; CHECK-NEXT: UNI   %2 = fcmp ogt float %1, 3.000000e+00
; CHECK-NEXT: UNI   br i1 %2, label %bb, label %return
; CHECK-NEXT: UNI   %3 = getelementptr inbounds float, float* %A, i64 6
; CHECK-NEXT: UNI   store float 8.000000e+00, float* %3, align 4
...
; CHECK-NEXT: UNI   %2 = getelementptr inbounds float, float* %A, i64 6
; CHECK-NEXT: UNI   store float 8.000000e+00, float* %2, align 4
; CHECK-NEXT: UNI   ret i32 undef
; CHECK-NEXT: UNI   ret i32 undef

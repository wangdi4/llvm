...
; CHECK-NEXT: PTR   %10 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %1
; CHECK-NEXT: RND   store i32 %9, i32 addrspace(1)* %10, align 4
...
; CHECK-NEXT: PTR   %19 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %18
; CHECK-NEXT: RND   store i32 %17, i32 addrspace(1)* %19, align 4

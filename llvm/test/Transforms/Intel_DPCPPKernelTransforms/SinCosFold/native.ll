...
;CHECK: call <8 x float> @_Z13native_sincosDv8_fPS_(<8 x float> %a, <8 x float>*
...
;CHECK: call <8 x float> @_Z13native_sincosDv8_fPS_(<8 x float> %a, <8 x float>*
;CHECK: call <8 x float> @_Z13native_sincosDv8_fPS_(<8 x float> %b, <8 x float>*
...
;CHECK-NOT: call <8 x float> @_Z10native_cosDv8_f
;CHECK-NOT: call <8 x float> @_Z10native_sinDv8_f
;CHECK: call <4 x float> @_Z13native_sincosDv4_fPS_(<4 x float> %b, <4 x float>*
;CHECK-NOT: call <8 x float> @_Z10native_cosDv8_f
;CHECK-NOT: call <8 x float> @_Z10native_sinDv8_f
;CHECK-NOT: call <4 x float> @_Z6cosDv4_f
;CHECK-NOT: call <4 x float> @_Z6sinDv4_f
...
;CHECK: call double @_Z13native_sincosdPd(double %a, double*
;CHECK-NOT: call <8 x float> @_Z10native_cosd
;CHECK-NOT: call <8 x float> @_Z10native_sind
;CHECK: call double @_Z13native_sincosdPd(double %b, double*
;CHECK-NOT: call <8 x float> @_Z10native_sind
;CHECK-NOT: call <8 x float> @_Z10native_cosd
;CHECK: ret void

...
entry:
; CHECK: select i1 %{{[0-9]+}}, <2 x i32 (i32, i32)*> <i32 (i32, i32)* bitcast (i32 (i32, i32, i8 addrspace(3)*, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }*, i64*, [4 x i64], i8*, {}*)* @add to i32 (i32, i32)*), i32 (i32, i32)* poison>, <2 x i32 (i32, i32)*> <i32 (i32, i32)* bitcast (i32 (i32, i32, i8 addrspace(3)*, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }*, i64*, [4 x i64], i8*, {}*)* @sub to i32 (i32, i32)*), i32 (i32, i32)* poison>

  %0 = icmp eq i32 %arg, 0
  %1 = select i1 %0, <2 x i32 (i32, i32)*> <i32 (i32, i32)* @add, i32 (i32, i32)* poison>, <2 x i32 (i32, i32)*> <i32 (i32, i32)* @sub, i32 (i32, i32)* poison>

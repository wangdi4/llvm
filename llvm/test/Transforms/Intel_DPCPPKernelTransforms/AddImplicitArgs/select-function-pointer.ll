...
define i32 @_Z3subii(i32 %a, i32 %b) local_unnamed_addr {
entry:
  %sub = sub nsw i32 %a, %b
  ret i32 %sub
}
...
entry:
  ...
  %call4.i = tail call i32 %_Z3addii._Z3subii.i(i32 %8, i32 %9)
  %cmp.i2 = icmp ne i32 %_arg_, 0
  %_Z3addii._Z3subii.i2 = select i1 %cmp.i2, i32 (i32, i32)* @_Z3addii, i32 (i32, i32)* @_Z3subii
  %call4.i2 = tail call i32 %_Z3addii._Z3subii.i2(i32 %8, i32 %9)

...
; CHECK-NEXT:   entry:
; CHECK-NEXT:   %LocalMem_functionWithoutArgs = getelementptr i8, i8 addrspace(3)* %pLocalMemBase, i32 0
; CHECK-NEXT:   call void @functionWithoutArgs(i8 addrspace(3)* noalias %LocalMem_functionWithoutArgs,
; CHECK:          { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* noalias %pWorkDim,
; CHECK:          i64* noalias %pWGId,
; CHECK:          [4 x i64] %BaseGlbId,
; CHECK:          i8* noalias %pSpecialBuf,
; CHECK:          {}* noalias %RuntimeHandle)
; CHECK-NEXT:   %LocalMem_functionWithArgs = getelementptr i8, i8 addrspace(3)* %pLocalMemBase, i32 0
; CHECK-NEXT:   [[VAR2:%[a-zA-Z0-9]+]] = call i32 @functionWithArgs(i32 %x, i32 %y,
; CHECK:          i8 addrspace(3)* noalias %LocalMem_functionWithArgs,
; CHECK:          { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* noalias %pWorkDim,
; CHECK:          i64* noalias %pWGId,
; CHECK:          [4 x i64] %BaseGlbId,
; CHECK:          i8* noalias %pSpecialBuf,

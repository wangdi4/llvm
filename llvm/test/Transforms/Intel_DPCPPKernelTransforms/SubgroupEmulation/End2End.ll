...
; RUN: opt -dpcpp-kernel-sg-emu-builtin -dpcpp-kernel-sg-emu-barrier-propagate -dpcpp-kernel-sg-emu-barrier-simplify -dpcpp-kernel-sg-emu-value-widen -dpcpp-kernel-sg-emu-loop-construct -dpcpp-vect-info=%p/../Inputs/VectInfo64.gen -S %s | FileCheck %s

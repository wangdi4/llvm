; RUN: opt -dpcpp-kernel-sg-emu-builtin -S %s -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
; RUN: opt -dpcpp-kernel-sg-emu-builtin -S %s | FileCheck %s

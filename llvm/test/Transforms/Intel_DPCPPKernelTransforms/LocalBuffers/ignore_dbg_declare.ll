...
define void @mykernel(i8 addrspace(3)* noalias %a) nounwind {
entry:
  %_Z13get_global_idj0 = call i32 @_Z13get_global_idj(i32 0)
  %gid0_i64 = zext i32 %_Z13get_global_idj0 to i64
  %_Z13get_global_idj1 = call i32 @_Z13get_global_idj(i32 1)
...
!3 = !{!4}
!4 = !{!5, !12}
!5 = !{i32 786478, i32 0, !6, !"f1", !"f1", !"", !6, i32 2, !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i8 addrspace(3)*)* @f1, null, null, !1, i32 2} ; [ DW_TAG_subprogram ] [line 2] [def] [f1]
...
!12 = !{i32 786478, i32 0, !6, !"mykernel", !"mykernel", !"", !6, i32 4, !13, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, void (i8 addrspace(3)*)* @mykernel, null, null, !1, i32 4} ; [ DW_TAG_subprogram ] [line 4] [def] [mykernel]
...
!15 = !{!16}
!16 = !{!17}
!17 = !{i32 786484, i32 0, !12, !"x", !"x", !"", !6, i32 5, !18, i32 1, i32 1, [100 x i8] addrspace(3)* @mykernel.x} ; [ DW_TAG_variable ] [x] [line 5] [local] [def]

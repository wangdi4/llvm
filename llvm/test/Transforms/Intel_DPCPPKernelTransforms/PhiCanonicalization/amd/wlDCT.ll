...
entry:
  ...
  %.array = getelementptr [8 x float], [8 x float]* %acc, i32 0, i32 0
  %.array5 = getelementptr [8 x float], [8 x float]* %acc, i32 0, i32 1
  %.array6 = getelementptr [8 x float], [8 x float]* %acc, i32 0, i32 2
  %.array7 = getelementptr [8 x float], [8 x float]* %acc, i32 0, i32 3
  %.array8 = getelementptr [8 x float], [8 x float]* %acc, i32 0, i32 4
  %.array9 = getelementptr [8 x float], [8 x float]* %acc, i32 0, i32 5
  %.array10 = getelementptr [8 x float], [8 x float]* %acc, i32 0, i32 6
  %.array11 = getelementptr [8 x float], [8 x float]* %acc, i32 0, i32 7
  %mul = shl i32 %call4, 3
  %mul14 = shl i32 %call3, 3
  %mul16 = mul i32 %mul14, %width
  %mul18 = shl i32 %call2, 3
  %add = add i32 %mul16, %mul18
  %arrayidx31 = getelementptr float, float addrspace(1)* %dct, i32 %mul
  %0 = bitcast [8 x float]* %acc to i8*
  call void @llvm.memset.p0i8.i64(i8* %0, i8 0, i64 32, i32 4, i1 false)
  %tmp32.pre = load float, float addrspace(1)* %arrayidx31, align 4
...
for.end48:                                        ; preds = %for.cond21.preheader
  ...
  %tmp139.pre = load float, float addrspace(1)* %arrayidx31, align 4
  %tmp139.1.pre = load float, float addrspace(1)* %arrayidx31.1, align 4
  %tmp139.2.pre = load float, float addrspace(1)* %arrayidx31.2, align 4
  %tmp139.3.pre = load float, float addrspace(1)* %arrayidx31.3, align 4
  %tmp139.4.pre = load float, float addrspace(1)* %arrayidx31.4, align 4
  %tmp139.5.pre = load float, float addrspace(1)* %arrayidx31.5, align 4
  %tmp139.6.pre = load float, float addrspace(1)* %arrayidx31.6, align 4
  %tmp139.7.pre = load float, float addrspace(1)* %arrayidx31.7, align 4
...
entry:
  ...
  %tmp373 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_cllocal_inter, i32 0, i32 2), align 32
  ...
  %tmp404 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_cllocal_inter, i32 0, i32 3), align 32
  ...
  %tmp435 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_cllocal_inter, i32 0, i32 4), align 32
  ...
  %tmp466 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_cllocal_inter, i32 0, i32 5), align 32
  ...
  %tmp497 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_cllocal_inter, i32 0, i32 6), align 32
  ...
  %tmp528 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_cllocal_inter, i32 0, i32 7), align 32
  ...
  %arrayidx569 = getelementptr <8 x float>, <8 x float> addrspace(1)* %output, i32 %add566
...
entry:
  ...
  %tmp31 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx19, align 32
  ...
  %tmp59 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx47, align 32
  ...
  %tmp87 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx75, align 32
  ...
  %tmp115 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx103, align 32
  ...
  %tmp143 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx131, align 32
  ...
  %tmp171 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx159, align 32
  ...
  %tmp199 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx187, align 32
  ...
  %tmp227 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx215, align 32
  ...
  %arrayidx235 = getelementptr [8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 %call4
  store <8 x float> %tmp232, <8 x float> addrspace(3)* %arrayidx235, align 32
  call void @_Z7barrierm(i32 2) nounwind
  %tmp239 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 0), align 32
  %tmp240 = shufflevector <8 x float> %tmp239, <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %tmp244 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp247 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 0), align 32
  %tmp248 = shufflevector <8 x float> %tmp247, <8 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %tmp252 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp258 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 1), align 32
  %tmp259 = shufflevector <8 x float> %tmp258, <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %tmp263 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp266 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 1), align 32
  %tmp267 = shufflevector <8 x float> %tmp266, <8 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %tmp271 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp277 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 2), align 32
  %tmp278 = shufflevector <8 x float> %tmp277, <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %tmp282 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp285 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 2), align 32
  %tmp286 = shufflevector <8 x float> %tmp285, <8 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %tmp290 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp296 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 3), align 32
  %tmp297 = shufflevector <8 x float> %tmp296, <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %tmp301 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp304 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 3), align 32
  %tmp305 = shufflevector <8 x float> %tmp304, <8 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %tmp309 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp315 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 4), align 32
  %tmp316 = shufflevector <8 x float> %tmp315, <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %tmp320 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp323 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 4), align 32
  %tmp324 = shufflevector <8 x float> %tmp323, <8 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %tmp328 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp334 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 5), align 32
  %tmp335 = shufflevector <8 x float> %tmp334, <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %tmp339 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp342 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 5), align 32
  %tmp343 = shufflevector <8 x float> %tmp342, <8 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %tmp347 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp353 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 6), align 32
  %tmp354 = shufflevector <8 x float> %tmp353, <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %tmp358 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp361 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 6), align 32
  %tmp362 = shufflevector <8 x float> %tmp361, <8 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %tmp366 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp372 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 7), align 32
  %tmp373 = shufflevector <8 x float> %tmp372, <8 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %tmp377 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %tmp380 = load <8 x float>, <8 x float> addrspace(3)* getelementptr inbounds ([8 x <8 x float>], [8 x <8 x float>] addrspace(3)* @DCT_VECTOR_DOT_cllocal_inter, i32 0, i32 7), align 32
  %tmp381 = shufflevector <8 x float> %tmp380, <8 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %tmp385 = load <8 x float>, <8 x float> addrspace(1)* %arrayidx, align 32
  ...
  %arrayidx401 = getelementptr <8 x float>, <8 x float> addrspace(1)* %output, i32 %add398
...
for.cond62.preheader:                             ; preds = %for.end
  %arraydecay70 = getelementptr [64 x float], [64 x float]* %acc, i32 0, i32 0
  %arrayidx68 = getelementptr [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 0
  %call72 = call <8 x float> @__vload8_f8(i32 0, float* %arraydecay70) nounwind
  store <8 x float> %call72, <8 x float>* %arrayidx68, align 32
  %arrayidx68.1 = getelementptr [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 1
  ...
  %arrayidx68.2 = getelementptr [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 2
  ...
  %arrayidx68.3 = getelementptr [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 3
  ...
  %arrayidx68.4 = getelementptr [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 4
  ...
  %arrayidx68.5 = getelementptr [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 5
  ...
  %arrayidx68.6 = getelementptr [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 6
  ...
  %arrayidx68.7 = getelementptr [8 x <8 x float>], [8 x <8 x float>]* %inter, i32 0, i32 7
...
for.cond88.preheader:                             ; preds = %for.cond62.preheader, %for.end132
  ...
  %arrayidx94 = getelementptr <8 x float>, <8 x float> addrspace(1)* %dct, i32 %storemerge10
  br label %for.body91

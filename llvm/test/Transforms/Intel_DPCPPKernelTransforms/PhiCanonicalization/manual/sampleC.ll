...
; NOSKIP: phi-split-bb:                                     ; preds = %for.cond22.preheader, %if.end.loopexit13
; NOSKIP: phi-split-bb1:                                    ; preds = %for.cond.preheader, %if.end.loopexit
; NOSKIP: ret
...
for.body8.lr.ph:                                  ; preds = %for.cond3.preheader
  %arrayidx = getelementptr inbounds i64, i64* %B, i64 %storemerge18
  br label %for.body8
...
; DEBUGIFY-NOSKIP: WARNING: Instruction with empty DebugLoc in function func --  br label %if.end
; DEBUGIFY-NOSKIP: WARNING: Instruction with empty DebugLoc in function func --  br label %if.end

...
; DEBUGIFY: WARNING: Instruction with empty DebugLoc in function PhiCanonCase1 --  br label %phi-split-bb1
; DEBUGIFY: WARNING: Instruction with empty DebugLoc in function PhiCanonCase1 --  br label %if.end18

...
; NOSKIP: @PhiCanonIdenticalValues
; NOSKIP-NOT: phi i32 [ 0, %if.then ], [ 0, %entry ]
; NOSKIP: ret
...
; DEBUGIFY-NOSKIP: WARNING: Instruction with empty DebugLoc in function PhiCanonIdenticalValues --  br label %for.body

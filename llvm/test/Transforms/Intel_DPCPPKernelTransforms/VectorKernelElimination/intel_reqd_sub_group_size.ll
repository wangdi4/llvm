...
for.body:                                         ; preds = %for.body, %entry
  ...
  %0 = load i64, i64 addrspace(1)* %arrayidx, align 8, !tbaa !13
  %arrayidx4 = getelementptr inbounds i64, i64 addrspace(1)* %dst, i64 %add
  store i64 %0, i64 addrspace(1)* %arrayidx4, align 8, !tbaa !13
  %1 = load i64, i64 addrspace(1)* %arrayidx, align 8, !tbaa !13
  %arrayidx12 = getelementptr inbounds i64, i64 addrspace(1)* %dst2, i64 %add
  store i64 %1, i64 addrspace(1)* %arrayidx12, align 8, !tbaa !13

...
declare i8 @_Z31__finalize_work_group_broadcastcm(i8  signext %src, i64  %local_id) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_cm(<4 x i8>  %src, i64  %local_id) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_cm(<8 x i8>  %src, i64  %local_id) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_cm(<16 x i8>  %src, i64  %local_id) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_cm(<32 x i8>  %src, i64  %local_id) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_cm(<64 x i8>  %src, i64  %local_id) 

declare zeroext i8 @_Z31__finalize_work_group_broadcasthm(i8  zeroext %src, i64  %local_id) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_hm(<4 x i8>  %src, i64  %local_id) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_hm(<8 x i8>  %src, i64  %local_id) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_hm(<16 x i8>  %src, i64  %local_id) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_hm(<32 x i8>  %src, i64  %local_id) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_hm(<64 x i8>  %src, i64  %local_id) 

declare signext i16 @_Z31__finalize_work_group_broadcastsm(i16  signext %src, i64  %local_id) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_sm(<4 x i16>  %src, i64  %local_id) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_sm(<8 x i16>  %src, i64  %local_id) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_sm(<16 x i16>  %src, i64  %local_id) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_sm(<32 x i16>  %src, i64  %local_id) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_sm(<64 x i16>  %src, i64  %local_id) 

declare zeroext i16 @_Z31__finalize_work_group_broadcasttm(i16  zeroext %src, i64  %local_id) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_tm(<4 x i16>  %src, i64  %local_id) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_tm(<8 x i16>  %src, i64  %local_id) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_tm(<16 x i16>  %src, i64  %local_id) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_tm(<32 x i16>  %src, i64  %local_id) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_tm(<64 x i16>  %src, i64  %local_id) 

declare i32 @_Z31__finalize_work_group_broadcastim(i32  %src, i64  %local_id) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_im(<4 x i32>  %src, i64  %local_id) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_im(<8 x i32>  %src, i64  %local_id) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_im(<16 x i32>  %src, i64  %local_id) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_im(<32 x i32>  %src, i64  %local_id) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_im(<64 x i32>  %src, i64  %local_id) 

declare i32 @_Z31__finalize_work_group_broadcastjm(i32  %src, i64  %local_id) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_jm(<4 x i32>  %src, i64  %local_id) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_jm(<8 x i32>  %src, i64  %local_id) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_jm(<16 x i32>  %src, i64  %local_id) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_jm(<32 x i32>  %src, i64  %local_id) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_jm(<64 x i32>  %src, i64  %local_id) 

declare i64 @_Z31__finalize_work_group_broadcastlm(i64  %src, i64  %local_id) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_lm(<4 x i64>  %src, i64  %local_id) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_lm(<8 x i64>  %src, i64  %local_id) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_lm(<16 x i64>  %src, i64  %local_id) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_lm(<32 x i64>  %src, i64  %local_id) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_lm(<64 x i64>  %src, i64  %local_id) 

declare i64 @_Z31__finalize_work_group_broadcastmm(i64  %src, i64  %local_id) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_mm(<4 x i64>  %src, i64  %local_id) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_mm(<8 x i64>  %src, i64  %local_id) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_mm(<16 x i64>  %src, i64  %local_id) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_mm(<32 x i64>  %src, i64  %local_id) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_mm(<64 x i64>  %src, i64  %local_id) 

declare float @_Z31__finalize_work_group_broadcastfm(float  %src, i64  %local_id) 

declare <4 x float> @_Z31__finalize_work_group_broadcastDv4_fm(<4 x float>  %src, i64  %local_id) 

declare <8 x float> @_Z31__finalize_work_group_broadcastDv8_fm(<8 x float>  %src, i64  %local_id) 

declare <16 x float> @_Z31__finalize_work_group_broadcastDv16_fm(<16 x float>  %src, i64  %local_id) 

declare <32 x float> @_Z31__finalize_work_group_broadcastDv32_fm(<32 x float>  %src, i64  %local_id) 

declare <64 x float> @_Z31__finalize_work_group_broadcastDv64_fm(<64 x float>  %src, i64  %local_id) 

declare double @_Z31__finalize_work_group_broadcastdm(double  %src, i64  %local_id) 

declare <4 x double> @_Z31__finalize_work_group_broadcastDv4_dm(<4 x double>  %src, i64  %local_id) 

declare <8 x double> @_Z31__finalize_work_group_broadcastDv8_dm(<8 x double>  %src, i64  %local_id) 

declare <16 x double> @_Z31__finalize_work_group_broadcastDv16_dm(<16 x double>  %src, i64  %local_id) 

declare <32 x double> @_Z31__finalize_work_group_broadcastDv32_dm(<32 x double>  %src, i64  %local_id) 

declare <64 x double> @_Z31__finalize_work_group_broadcastDv64_dm(<64 x double>  %src, i64  %local_id) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_cmDv4_j(<4 x i8>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_cmDv8_j(<8 x i8>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_cmDv16_j(<16 x i8>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_cmDv32_j(<32 x i8>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_cmDv64_j(<64 x i8>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_hmDv4_j(<4 x i8>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_hmDv8_j(<8 x i8>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_hmDv16_j(<16 x i8>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_hmDv32_j(<32 x i8>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_hmDv64_j(<64 x i8>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_smDv4_j(<4 x i16>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_smDv8_j(<8 x i16>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_smDv16_j(<16 x i16>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_smDv32_j(<32 x i16>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_smDv64_j(<64 x i16>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_tmDv4_j(<4 x i16>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_tmDv8_j(<8 x i16>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_tmDv16_j(<16 x i16>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_tmDv32_j(<32 x i16>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_tmDv64_j(<64 x i16>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_imDv4_j(<4 x i32>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_imDv8_j(<8 x i32>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_imDv16_j(<16 x i32>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_imDv32_j(<32 x i32>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_imDv64_j(<64 x i32>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_jmS_(<4 x i32>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_jmS_(<8 x i32>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_jmS_(<16 x i32>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_jmS_(<32 x i32>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_jmS_(<64 x i32>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_lmDv4_j(<4 x i64>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_lmDv8_j(<8 x i64>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_lmDv16_j(<16 x i64>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_lmDv32_j(<32 x i64>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_lmDv64_j(<64 x i64>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_mmDv4_j(<4 x i64>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_mmDv8_j(<8 x i64>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_mmDv16_j(<16 x i64>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_mmDv32_j(<32 x i64>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_mmDv64_j(<64 x i64>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x float> @_Z31__finalize_work_group_broadcastDv4_fmDv4_j(<4 x float>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x float> @_Z31__finalize_work_group_broadcastDv8_fmDv8_j(<8 x float>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x float> @_Z31__finalize_work_group_broadcastDv16_fmDv16_j(<16 x float>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x float> @_Z31__finalize_work_group_broadcastDv32_fmDv32_j(<32 x float>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x float> @_Z31__finalize_work_group_broadcastDv64_fmDv64_j(<64 x float>  %src, i64  %local_id, <64 x i32>  %mask) 

declare <4 x double> @_Z31__finalize_work_group_broadcastDv4_dmDv4_j(<4 x double>  %src, i64  %local_id, <4 x i32>  %mask) 

declare <8 x double> @_Z31__finalize_work_group_broadcastDv8_dmDv8_j(<8 x double>  %src, i64  %local_id, <8 x i32>  %mask) 

declare <16 x double> @_Z31__finalize_work_group_broadcastDv16_dmDv16_j(<16 x double>  %src, i64  %local_id, <16 x i32>  %mask) 

declare <32 x double> @_Z31__finalize_work_group_broadcastDv32_dmDv32_j(<32 x double>  %src, i64  %local_id, <32 x i32>  %mask) 

declare <64 x double> @_Z31__finalize_work_group_broadcastDv64_dmDv64_j(<64 x double>  %src, i64  %local_id, <64 x i32>  %mask) 

declare signext i8 @_Z31__finalize_work_group_broadcastcmm(i8  signext %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_cmm(<4 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_cmm(<8 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_cmm(<16 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_cmm(<32 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_cmm(<64 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare zeroext i8 @_Z31__finalize_work_group_broadcasthmm(i8  zeroext %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_hmm(<4 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_hmm(<8 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_hmm(<16 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_hmm(<32 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_hmm(<64 x i8>  %src, i64  %local_id_x, i64  %local_id_y) 

declare signext i16 @_Z31__finalize_work_group_broadcastsmm(i16  signext %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_smm(<4 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_smm(<8 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_smm(<16 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_smm(<32 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_smm(<64 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare zeroext i16 @_Z31__finalize_work_group_broadcasttmm(i16  zeroext %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_tmm(<4 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_tmm(<8 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_tmm(<16 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_tmm(<32 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_tmm(<64 x i16>  %src, i64  %local_id_x, i64  %local_id_y) 

declare i32 @_Z31__finalize_work_group_broadcastimm(i32  %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_imm(<4 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_imm(<8 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_imm(<16 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_imm(<32 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_imm(<64 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare i32 @_Z31__finalize_work_group_broadcastjmm(i32  %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_jmm(<4 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_jmm(<8 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_jmm(<16 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_jmm(<32 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_jmm(<64 x i32>  %src, i64  %local_id_x, i64  %local_id_y) 

declare i64 @_Z31__finalize_work_group_broadcastlmm(i64  %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_lmm(<4 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_lmm(<8 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_lmm(<16 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_lmm(<32 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_lmm(<64 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare i64 @_Z31__finalize_work_group_broadcastmmm(i64  %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_mmm(<4 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_mmm(<8 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_mmm(<16 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_mmm(<32 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_mmm(<64 x i64>  %src, i64  %local_id_x, i64  %local_id_y) 

declare float @_Z31__finalize_work_group_broadcastfmm(float  %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x float> @_Z31__finalize_work_group_broadcastDv4_fmm(<4 x float>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x float> @_Z31__finalize_work_group_broadcastDv8_fmm(<8 x float>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x float> @_Z31__finalize_work_group_broadcastDv16_fmm(<16 x float>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x float> @_Z31__finalize_work_group_broadcastDv32_fmm(<32 x float>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x float> @_Z31__finalize_work_group_broadcastDv64_fmm(<64 x float>  %src, i64  %local_id_x, i64  %local_id_y) 

declare double @_Z31__finalize_work_group_broadcastdmm(double  %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x double> @_Z31__finalize_work_group_broadcastDv4_dmm(<4 x double>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <8 x double> @_Z31__finalize_work_group_broadcastDv8_dmm(<8 x double>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <16 x double> @_Z31__finalize_work_group_broadcastDv16_dmm(<16 x double>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <32 x double> @_Z31__finalize_work_group_broadcastDv32_dmm(<32 x double>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <64 x double> @_Z31__finalize_work_group_broadcastDv64_dmm(<64 x double>  %src, i64  %local_id_x, i64  %local_id_y) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_cmmDv4_j(<4 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_cmmDv8_j(<8 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_cmmDv16_j(<16 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_cmmDv32_j(<32 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_cmmDv64_j(<64 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_hmmDv4_j(<4 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_hmmDv8_j(<8 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_hmmDv16_j(<16 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_hmmDv32_j(<32 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_hmmDv64_j(<64 x i8>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_smmDv4_j(<4 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_smmDv8_j(<8 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_smmDv16_j(<16 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_smmDv32_j(<32 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_smmDv64_j(<64 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_tmmDv4_j(<4 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_tmmDv8_j(<8 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_tmmDv16_j(<16 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_tmmDv32_j(<32 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_tmmDv64_j(<64 x i16>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_immDv4_j(<4 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_immDv8_j(<8 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_immDv16_j(<16 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_immDv32_j(<32 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_immDv64_j(<64 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_jmmS_(<4 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_jmmS_(<8 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_jmmS_(<16 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_jmmS_(<32 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_jmmS_(<64 x i32>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_lmmDv4_j(<4 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_lmmDv8_j(<8 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_lmmDv16_j(<16 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_lmmDv32_j(<32 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_lmmDv64_j(<64 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_mmmDv4_j(<4 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_mmmDv8_j(<8 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_mmmDv16_j(<16 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_mmmDv32_j(<32 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_mmmDv64_j(<64 x i64>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x float> @_Z31__finalize_work_group_broadcastDv4_fmmDv4_j(<4 x float>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x float> @_Z31__finalize_work_group_broadcastDv8_fmmDv8_j(<8 x float>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x float> @_Z31__finalize_work_group_broadcastDv16_fmmDv16_j(<16 x float>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x float> @_Z31__finalize_work_group_broadcastDv32_fmmDv32_j(<32 x float>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x float> @_Z31__finalize_work_group_broadcastDv64_fmmDv64_j(<64 x float>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare <4 x double> @_Z31__finalize_work_group_broadcastDv4_dmmDv4_j(<4 x double>  %src, i64  %local_id_x, i64  %local_id_y, <4 x i32>  %mask) 

declare <8 x double> @_Z31__finalize_work_group_broadcastDv8_dmmDv8_j(<8 x double>  %src, i64  %local_id_x, i64  %local_id_y, <8 x i32>  %mask) 

declare <16 x double> @_Z31__finalize_work_group_broadcastDv16_dmmDv16_j(<16 x double>  %src, i64  %local_id_x, i64  %local_id_y, <16 x i32>  %mask) 

declare <32 x double> @_Z31__finalize_work_group_broadcastDv32_dmmDv32_j(<32 x double>  %src, i64  %local_id_x, i64  %local_id_y, <32 x i32>  %mask) 

declare <64 x double> @_Z31__finalize_work_group_broadcastDv64_dmmDv64_j(<64 x double>  %src, i64  %local_id_x, i64  %local_id_y, <64 x i32>  %mask) 

declare signext i8 @_Z31__finalize_work_group_broadcastcmmm(i8  signext %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_cmmm(<4 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_cmmm(<8 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_cmmm(<16 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_cmmm(<32 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_cmmm(<64 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare zeroext i8 @_Z31__finalize_work_group_broadcasthmmm(i8  zeroext %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_hmmm(<4 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_hmmm(<8 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_hmmm(<16 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_hmmm(<32 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_hmmm(<64 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare signext i16 @_Z31__finalize_work_group_broadcastsmmm(i16  signext %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_smmm(<4 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_smmm(<8 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_smmm(<16 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_smmm(<32 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_smmm(<64 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare zeroext i16 @_Z31__finalize_work_group_broadcasttmmm(i16  zeroext %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_tmmm(<4 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_tmmm(<8 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_tmmm(<16 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_tmmm(<32 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_tmmm(<64 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare i32 @_Z31__finalize_work_group_broadcastimmm(i32  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_immm(<4 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_immm(<8 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_immm(<16 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_immm(<32 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_immm(<64 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare i32 @_Z31__finalize_work_group_broadcastjmmm(i32  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_jmmm(<4 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_jmmm(<8 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_jmmm(<16 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_jmmm(<32 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_jmmm(<64 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare i64 @_Z31__finalize_work_group_broadcastlmmm(i64  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_lmmm(<4 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_lmmm(<8 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_lmmm(<16 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_lmmm(<32 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_lmmm(<64 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare i64 @_Z31__finalize_work_group_broadcastmmmm(i64  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_mmmm(<4 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_mmmm(<8 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_mmmm(<16 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_mmmm(<32 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_mmmm(<64 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare float @_Z31__finalize_work_group_broadcastfmmm(float  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x float> @_Z31__finalize_work_group_broadcastDv4_fmmm(<4 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x float> @_Z31__finalize_work_group_broadcastDv8_fmmm(<8 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x float> @_Z31__finalize_work_group_broadcastDv16_fmmm(<16 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x float> @_Z31__finalize_work_group_broadcastDv32_fmmm(<32 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x float> @_Z31__finalize_work_group_broadcastDv64_fmmm(<64 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare double @_Z31__finalize_work_group_broadcastdmmm(double  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x double> @_Z31__finalize_work_group_broadcastDv4_dmmm(<4 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <8 x double> @_Z31__finalize_work_group_broadcastDv8_dmmm(<8 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <16 x double> @_Z31__finalize_work_group_broadcastDv16_dmmm(<16 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <32 x double> @_Z31__finalize_work_group_broadcastDv32_dmmm(<32 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <64 x double> @_Z31__finalize_work_group_broadcastDv64_dmmm(<64 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_cmmmDv4_j(<4 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_cmmmDv8_j(<8 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_cmmmDv16_j(<16 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_cmmmDv32_j(<32 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_cmmmDv64_j(<64 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_hmmmDv4_j(<4 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_hmmmDv8_j(<8 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_hmmmDv16_j(<16 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_hmmmDv32_j(<32 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_hmmmDv64_j(<64 x i8>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_smmmDv4_j(<4 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_smmmDv8_j(<8 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_smmmDv16_j(<16 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_smmmDv32_j(<32 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_smmmDv64_j(<64 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_tmmmDv4_j(<4 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_tmmmDv8_j(<8 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_tmmmDv16_j(<16 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_tmmmDv32_j(<32 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_tmmmDv64_j(<64 x i16>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_immmDv4_j(<4 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_immmDv8_j(<8 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_immmDv16_j(<16 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_immmDv32_j(<32 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_immmDv64_j(<64 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_jmmmS_(<4 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_jmmmS_(<8 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_jmmmS_(<16 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_jmmmS_(<32 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_jmmmS_(<64 x i32>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_lmmmDv4_j(<4 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_lmmmDv8_j(<8 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_lmmmDv16_j(<16 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_lmmmDv32_j(<32 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_lmmmDv64_j(<64 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_mmmmDv4_j(<4 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_mmmmDv8_j(<8 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_mmmmDv16_j(<16 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_mmmmDv32_j(<32 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_mmmmDv64_j(<64 x i64>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x float> @_Z31__finalize_work_group_broadcastDv4_fmmmDv4_j(<4 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x float> @_Z31__finalize_work_group_broadcastDv8_fmmmDv8_j(<8 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x float> @_Z31__finalize_work_group_broadcastDv16_fmmmDv16_j(<16 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x float> @_Z31__finalize_work_group_broadcastDv32_fmmmDv32_j(<32 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x float> @_Z31__finalize_work_group_broadcastDv64_fmmmDv64_j(<64 x float>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare <4 x double> @_Z31__finalize_work_group_broadcastDv4_dmmmDv4_j(<4 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <4 x i32>  %mask) 

declare <8 x double> @_Z31__finalize_work_group_broadcastDv8_dmmmDv8_j(<8 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <8 x i32>  %mask) 

declare <16 x double> @_Z31__finalize_work_group_broadcastDv16_dmmmDv16_j(<16 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <16 x i32>  %mask) 

declare <32 x double> @_Z31__finalize_work_group_broadcastDv32_dmmmDv32_j(<32 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <32 x i32>  %mask) 

declare <64 x double> @_Z31__finalize_work_group_broadcastDv64_dmmmDv64_j(<64 x double>  %src, i64  %local_id_x, i64  %local_id_y, i64  %local_id_z, <64 x i32>  %mask) 

declare signext i8 @_Z31__finalize_work_group_broadcastcmmPc(i8  signext %src, i64  %linear_local_id, i64  %linear_id, i8*   %accum) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_cmmPS_(<4 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i8>*   %accum) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_cmmPS_(<8 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i8>*   %accum) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_cmmPS_(<16 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i8>*   %accum) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_cmmPS_(<32 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i8>*   %accum) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_cmmPS_(<64 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i8>*   %accum) 

declare zeroext i8 @_Z31__finalize_work_group_broadcasthmmPh(i8  zeroext %src, i64  %linear_local_id, i64  %linear_id, i8*   %accum) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_hmmPS_(<4 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i8>*   %accum) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_hmmPS_(<8 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i8>*   %accum) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_hmmPS_(<16 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i8>*   %accum) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_hmmPS_(<32 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i8>*   %accum) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_hmmPS_(<64 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i8>*   %accum) 

declare signext i16 @_Z31__finalize_work_group_broadcastsmmPs(i16  signext %src, i64  %linear_local_id, i64  %linear_id, i16*   %accum) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_smmPS_(<4 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i16>*   %accum) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_smmPS_(<8 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i16>*   %accum) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_smmPS_(<16 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i16>*   %accum) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_smmPS_(<32 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i16>*   %accum) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_smmPS_(<64 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i16>*   %accum) 

declare zeroext i16 @_Z31__finalize_work_group_broadcasttmmPt(i16  zeroext %src, i64  %linear_local_id, i64  %linear_id, i16*   %accum) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_tmmPS_(<4 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i16>*   %accum) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_tmmPS_(<8 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i16>*   %accum) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_tmmPS_(<16 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i16>*   %accum) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_tmmPS_(<32 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i16>*   %accum) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_tmmPS_(<64 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i16>*   %accum) 

declare i32 @_Z31__finalize_work_group_broadcastimmPi(i32  %src, i64  %linear_local_id, i64  %linear_id, i32*   %accum) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_immPS_(<4 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>*   %accum) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_immPS_(<8 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>*   %accum) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_immPS_(<16 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>*   %accum) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_immPS_(<32 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>*   %accum) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_immPS_(<64 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>*   %accum) 

declare i32 @_Z31__finalize_work_group_broadcastjmmPj(i32  %src, i64  %linear_local_id, i64  %linear_id, i32*   %accum) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_jmmPS_(<4 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>*   %accum) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_jmmPS_(<8 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>*   %accum) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_jmmPS_(<16 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>*   %accum) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_jmmPS_(<32 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>*   %accum) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_jmmPS_(<64 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>*   %accum) 

declare i64 @_Z31__finalize_work_group_broadcastlmmPl(i64  %src, i64  %linear_local_id, i64  %linear_id, i64*   %accum) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_lmmPS_(<4 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i64>*   %accum) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_lmmPS_(<8 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i64>*   %accum) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_lmmPS_(<16 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i64>*   %accum) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_lmmPS_(<32 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i64>*   %accum) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_lmmPS_(<64 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i64>*   %accum) 

declare i64 @_Z31__finalize_work_group_broadcastmmmPm(i64  %src, i64  %linear_local_id, i64  %linear_id, i64*   %accum) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_mmmPS_(<4 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i64>*   %accum) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_mmmPS_(<8 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i64>*   %accum) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_mmmPS_(<16 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i64>*   %accum) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_mmmPS_(<32 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i64>*   %accum) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_mmmPS_(<64 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i64>*   %accum) 

declare float @_Z31__finalize_work_group_broadcastfmmPf(float  %src, i64  %linear_local_id, i64  %linear_id, float*   %accum) 

declare <4 x float> @_Z31__finalize_work_group_broadcastDv4_fmmPS_(<4 x float>  %src, i64  %linear_local_id, i64  %linear_id, <4 x float>*   %accum) 

declare <8 x float> @_Z31__finalize_work_group_broadcastDv8_fmmPS_(<8 x float>  %src, i64  %linear_local_id, i64  %linear_id, <8 x float>*   %accum) 

declare <16 x float> @_Z31__finalize_work_group_broadcastDv16_fmmPS_(<16 x float>  %src, i64  %linear_local_id, i64  %linear_id, <16 x float>*   %accum) 

declare <32 x float> @_Z31__finalize_work_group_broadcastDv32_fmmPS_(<32 x float>  %src, i64  %linear_local_id, i64  %linear_id, <32 x float>*   %accum) 

declare <64 x float> @_Z31__finalize_work_group_broadcastDv64_fmmPS_(<64 x float>  %src, i64  %linear_local_id, i64  %linear_id, <64 x float>*   %accum) 

declare double @_Z31__finalize_work_group_broadcastdmmPd(double  %src, i64  %linear_local_id, i64  %linear_id, double*   %accum) 

declare <4 x double> @_Z31__finalize_work_group_broadcastDv4_dmmPS_(<4 x double>  %src, i64  %linear_local_id, i64  %linear_id, <4 x double>*   %accum) 

declare <8 x double> @_Z31__finalize_work_group_broadcastDv8_dmmPS_(<8 x double>  %src, i64  %linear_local_id, i64  %linear_id, <8 x double>*   %accum) 

declare <16 x double> @_Z31__finalize_work_group_broadcastDv16_dmmPS_(<16 x double>  %src, i64  %linear_local_id, i64  %linear_id, <16 x double>*   %accum) 

declare <32 x double> @_Z31__finalize_work_group_broadcastDv32_dmmPS_(<32 x double>  %src, i64  %linear_local_id, i64  %linear_id, <32 x double>*   %accum) 

declare <64 x double> @_Z31__finalize_work_group_broadcastDv64_dmmPS_(<64 x double>  %src, i64  %linear_local_id, i64  %linear_id, <64 x double>*   %accum) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_cmmDv4_jPS_(<4 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x i8>*   %accum) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_cmmDv8_jPS_(<8 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x i8>*   %accum) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_cmmDv16_jPS_(<16 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x i8>*   %accum) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_cmmDv32_jPS_(<32 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x i8>*   %accum) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_cmmDv64_jPS_(<64 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x i8>*   %accum) 

declare <4 x i8> @_Z31__finalize_work_group_broadcastDv4_hmmDv4_jPS_(<4 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x i8>*   %accum) 

declare <8 x i8> @_Z31__finalize_work_group_broadcastDv8_hmmDv8_jPS_(<8 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x i8>*   %accum) 

declare <16 x i8> @_Z31__finalize_work_group_broadcastDv16_hmmDv16_jPS_(<16 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x i8>*   %accum) 

declare <32 x i8> @_Z31__finalize_work_group_broadcastDv32_hmmDv32_jPS_(<32 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x i8>*   %accum) 

declare <64 x i8> @_Z31__finalize_work_group_broadcastDv64_hmmDv64_jPS_(<64 x i8>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x i8>*   %accum) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_smmDv4_jPS_(<4 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x i16>*   %accum) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_smmDv8_jPS_(<8 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x i16>*   %accum) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_smmDv16_jPS_(<16 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x i16>*   %accum) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_smmDv32_jPS_(<32 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x i16>*   %accum) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_smmDv64_jPS_(<64 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x i16>*   %accum) 

declare <4 x i16> @_Z31__finalize_work_group_broadcastDv4_tmmDv4_jPS_(<4 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x i16>*   %accum) 

declare <8 x i16> @_Z31__finalize_work_group_broadcastDv8_tmmDv8_jPS_(<8 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x i16>*   %accum) 

declare <16 x i16> @_Z31__finalize_work_group_broadcastDv16_tmmDv16_jPS_(<16 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x i16>*   %accum) 

declare <32 x i16> @_Z31__finalize_work_group_broadcastDv32_tmmDv32_jPS_(<32 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x i16>*   %accum) 

declare <64 x i16> @_Z31__finalize_work_group_broadcastDv64_tmmDv64_jPS_(<64 x i16>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x i16>*   %accum) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_immDv4_jPS_(<4 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x i32>*   %accum) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_immDv8_jPS_(<8 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x i32>*   %accum) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_immDv16_jPS_(<16 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x i32>*   %accum) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_immDv32_jPS_(<32 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x i32>*   %accum) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_immDv64_jPS_(<64 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x i32>*   %accum) 

declare <4 x i32> @_Z31__finalize_work_group_broadcastDv4_jmmS_PS_(<4 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x i32>*   %accum) 

declare <8 x i32> @_Z31__finalize_work_group_broadcastDv8_jmmS_PS_(<8 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x i32>*   %accum) 

declare <16 x i32> @_Z31__finalize_work_group_broadcastDv16_jmmS_PS_(<16 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x i32>*   %accum) 

declare <32 x i32> @_Z31__finalize_work_group_broadcastDv32_jmmS_PS_(<32 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x i32>*   %accum) 

declare <64 x i32> @_Z31__finalize_work_group_broadcastDv64_jmmS_PS_(<64 x i32>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x i32>*   %accum) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_lmmDv4_jPS_(<4 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x i64>*   %accum) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_lmmDv8_jPS_(<8 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x i64>*   %accum) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_lmmDv16_jPS_(<16 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x i64>*   %accum) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_lmmDv32_jPS_(<32 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x i64>*   %accum) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_lmmDv64_jPS_(<64 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x i64>*   %accum) 

declare <4 x i64> @_Z31__finalize_work_group_broadcastDv4_mmmDv4_jPS_(<4 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x i64>*   %accum) 

declare <8 x i64> @_Z31__finalize_work_group_broadcastDv8_mmmDv8_jPS_(<8 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x i64>*   %accum) 

declare <16 x i64> @_Z31__finalize_work_group_broadcastDv16_mmmDv16_jPS_(<16 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x i64>*   %accum) 

declare <32 x i64> @_Z31__finalize_work_group_broadcastDv32_mmmDv32_jPS_(<32 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x i64>*   %accum) 

declare <64 x i64> @_Z31__finalize_work_group_broadcastDv64_mmmDv64_jPS_(<64 x i64>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x i64>*   %accum) 

declare <4 x float> @_Z31__finalize_work_group_broadcastDv4_fmmDv4_jPS_(<4 x float>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x float>*   %accum) 

declare <8 x float> @_Z31__finalize_work_group_broadcastDv8_fmmDv8_jPS_(<8 x float>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x float>*   %accum) 

declare <16 x float> @_Z31__finalize_work_group_broadcastDv16_fmmDv16_jPS_(<16 x float>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x float>*   %accum) 

declare <32 x float> @_Z31__finalize_work_group_broadcastDv32_fmmDv32_jPS_(<32 x float>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x float>*   %accum) 

declare <64 x float> @_Z31__finalize_work_group_broadcastDv64_fmmDv64_jPS_(<64 x float>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x float>*   %accum) 

declare <4 x double> @_Z31__finalize_work_group_broadcastDv4_dmmDv4_jPS_(<4 x double>  %src, i64  %linear_local_id, i64  %linear_id, <4 x i32>  %mask, <4 x double>*   %accum) 

declare <8 x double> @_Z31__finalize_work_group_broadcastDv8_dmmDv8_jPS_(<8 x double>  %src, i64  %linear_local_id, i64  %linear_id, <8 x i32>  %mask, <8 x double>*   %accum) 

declare <16 x double> @_Z31__finalize_work_group_broadcastDv16_dmmDv16_jPS_(<16 x double>  %src, i64  %linear_local_id, i64  %linear_id, <16 x i32>  %mask, <16 x double>*   %accum) 

declare <32 x double> @_Z31__finalize_work_group_broadcastDv32_dmmDv32_jPS_(<32 x double>  %src, i64  %linear_local_id, i64  %linear_id, <32 x i32>  %mask, <32 x double>*   %accum) 

declare <64 x double> @_Z31__finalize_work_group_broadcastDv64_dmmDv64_jPS_(<64 x double>  %src, i64  %linear_local_id, i64  %linear_id, <64 x i32>  %mask, <64 x double>*   %accum) 

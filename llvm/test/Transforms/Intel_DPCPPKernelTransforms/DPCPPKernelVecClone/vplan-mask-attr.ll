...
; CHECK: call signext i16 @_Z23intel_sub_group_shufflesj(i16 signext 1, i32 0) #[[SHUFFLE_ATTR:[0-9]+]]
  %call1 = tail call zeroext i16 @_Z29intel_sub_group_block_read_us14ocl_image2d_roDv2_i(%opencl.image2d_ro_t.5 addrspace(1)* %img, <2 x i32> zeroinitializer) #3
; CHECK: call zeroext i16 @_Z29intel_sub_group_block_read_us14ocl_image2d_roDv2_i(%opencl.image2d_ro_t.5 addrspace(1)* {{%.*}}, <2 x i32> zeroinitializer) #[[BLOCK_READ_ATTR:[0-9]+]]

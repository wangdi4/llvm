; RUN: opt -dpcpp-kernel-vec-clone -dpcpp-enable-direct-function-call-vectorization=true -dpcpp-enable-direct-subgroup-function-call-vectorization=true -dpcpp-vector-variant-isa-encoding-override=SSE42 -dpcpp-vect-info=%p/VectInfo64.gen %s -S -o - | FileCheck %s
; RUN: opt -passes=dpcpp-kernel-vec-clone -dpcpp-enable-direct-function-call-vectorization=true -dpcpp-enable-direct-subgroup-function-call-vectorization=true -dpcpp-vector-variant-isa-encoding-override=SSE42 -dpcpp-vect-info=%p/VectInfo64.gen %s -S -o - | FileCheck %s
; RUN: opt -dpcpp-kernel-vec-clone -dpcpp-enable-direct-function-call-vectorization=true -dpcpp-enable-direct-subgroup-function-call-vectorization=true -dpcpp-vector-variant-isa-encoding-override=SSE42 -dpcpp-vect-info=%p/VectInfo64.gen %s -S -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
; RUN: opt -passes=dpcpp-kernel-vec-clone -dpcpp-enable-direct-function-call-vectorization=true -dpcpp-enable-direct-subgroup-function-call-vectorization=true -dpcpp-vector-variant-isa-encoding-override=SSE42 -dpcpp-vect-info=%p/VectInfo64.gen %s -S -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
...
; CHECK: attributes #2 = { "vector-variants"="_ZGVeM4_foo,_ZGVeN4_foo" "widened-size"="4" }

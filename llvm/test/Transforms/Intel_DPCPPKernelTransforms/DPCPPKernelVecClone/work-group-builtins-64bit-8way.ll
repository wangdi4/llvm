...
entry:
  ...
  %1 = zext i32 %0 to i64
; CHECK: [[WIDE_LOAD_i64:%.*]] = zext <8 x i32> %wide.load to <8 x i64>

  %call1 = tail call spir_func i32 @_Z14work_group_alli(i32 %0) #4
; CHECK: [[VECTOR_ALL:%.*]] = call {{(spir_func )?}}<8 x i32> @_Z14work_group_allDv8_i(<8 x i32> %wide.load)
  %call2 = tail call spir_func i32 @_Z14work_group_anyi(i32 %0) #4
; CHECK: [[VECTOR_ANY:%.*]] = call {{(spir_func )?}}<8 x i32> @_Z14work_group_anyDv8_i(<8 x i32> %wide.load)

  %call3 = tail call spir_func i32 @_Z20work_group_broadcastim(i32 %0, i64 0) #4
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z20work_group_broadcastDv8_im(<8 x i32> %wide.load, i64 0)
  %call4 = tail call spir_func i32 @_Z20work_group_broadcastimm(i32 %0, i64 0, i64 0) #4
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z20work_group_broadcastDv8_imm(<8 x i32> %wide.load, i64 0, i64 0)
  %call5 = tail call spir_func i32 @_Z20work_group_broadcastimmm(i32 %0, i64 0, i64 0, i64 0) #4
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z20work_group_broadcastDv8_immm(<8 x i32> %wide.load, i64 0, i64 0, i64 0)
...
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z21work_group_reduce_addDv8_i(<8 x i32> %wide.load)
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z21work_group_reduce_minDv8_j(<8 x i32> %wide.load)
; CHECK: = call {{(spir_func )?}}<8 x i64> @_Z21work_group_reduce_maxDv8_l(<8 x i64> [[WIDE_LOAD_i64]])
...
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z29work_group_scan_exclusive_addDv8_i(<8 x i32> %wide.load)
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z29work_group_scan_exclusive_minDv8_j(<8 x i32> %wide.load)
; CHECK: = call {{(spir_func )?}}<8 x i64> @_Z29work_group_scan_exclusive_maxDv8_l(<8 x i64> [[WIDE_LOAD_i64]])
...
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z29work_group_scan_inclusive_addDv8_i(<8 x i32> %wide.load)
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z29work_group_scan_inclusive_minDv8_j(<8 x i32> %wide.load)
; CHECK: = call {{(spir_func )?}}<8 x i64> @_Z29work_group_scan_inclusive_maxDv8_l(<8 x i64> [[WIDE_LOAD_i64]])
...
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z21work_group_reduce_mulDv8_i(<8 x i32> %wide.load)
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z29work_group_scan_exclusive_mulDv8_i(<8 x i32> %wide.load)
; CHECK: = call {{(spir_func )?}}<8 x i32> @_Z29work_group_scan_inclusive_mulDv8_i(<8 x i32> %wide.load)

  %conv = trunc i32 %0 to i16
; CHECK: [[WIDE_LOAD_i16:%.*]] = trunc <8 x i32> %wide.load to <8 x i16>
...
; CHECK: call {{(spir_func )?}}<8 x i16> @_Z29work_group_reduce_bitwise_andDv8_t(<8 x i16> [[WIDE_LOAD_i16]])
; CHECK: call {{(spir_func )?}}<8 x i32> @_Z28work_group_reduce_bitwise_orDv8_i(<8 x i32> %wide.load)
; CHECK: call {{(spir_func )?}}<8 x i64> @_Z29work_group_reduce_bitwise_xorDv8_l(<8 x i64> [[WIDE_LOAD_i64]])
; CHECK: call {{(spir_func )?}}<8 x i32> @_Z29work_group_reduce_logical_andDv8_i(<8 x i32> %wide.load)
; CHECK: call {{(spir_func )?}}<8 x i32> @_Z28work_group_reduce_logical_orDv8_i(<8 x i32> %wide.load)
; CHECK: call {{(spir_func )?}}<8 x i32> @_Z29work_group_reduce_logical_xorDv8_i(<8 x i32> %wide.load)

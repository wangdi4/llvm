...
; RUN: opt -dpcpp-kernel-vec-clone -dpcpp-vector-variant-isa-encoding-override=AVX512Core %s -S -enable-debugify -disable-output 2>&1 | FileCheck %s -check-prefix=DEBUGIFY
; RUN: opt -passes=dpcpp-kernel-vec-clone -dpcpp-vector-variant-isa-encoding-override=AVX512Core %s -S -enable-debugify -disable-output 2>&1 | FileCheck %s -check-prefix=DEBUGIFY
; RUN: opt -dpcpp-kernel-vec-clone -dpcpp-vector-variant-isa-encoding-override=AVX512Core %s -S -o - | FileCheck %s -check-prefix=LT2GB
; RUN: opt -passes=dpcpp-kernel-vec-clone -dpcpp-vector-variant-isa-encoding-override=AVX512Core %s -S -o - | FileCheck %s -check-prefix=LT2GB
...
; RUN: opt -dpcpp-kernel-vec-clone --dpcpp-less-than-two-gig-max-work-group-size=false -dpcpp-vector-variant-isa-encoding-override=AVX512Core %s -S -enable-debugify -disable-output 2>&1 | FileCheck %s -check-prefixes=DEBUGIFY,DEBUGIFY2
; RUN: opt -passes=dpcpp-kernel-vec-clone --dpcpp-less-than-two-gig-max-work-group-size=false -dpcpp-vector-variant-isa-encoding-override=AVX512Core %s -S -enable-debugify -disable-output 2>&1 | FileCheck %s -check-prefixes=DEBUGIFY,DEBUGIFY2
; RUN: opt -dpcpp-kernel-vec-clone --dpcpp-less-than-two-gig-max-work-group-size=false -dpcpp-vector-variant-isa-encoding-override=AVX512Core %s -S -o - | FileCheck %s -check-prefix=GT2GB
; RUN: opt -passes=dpcpp-kernel-vec-clone --dpcpp-less-than-two-gig-max-work-group-size=false -dpcpp-vector-variant-isa-encoding-override=AVX512Core %s -S -o - | FileCheck %s -check-prefix=GT2GB

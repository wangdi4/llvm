...
; CHECK: = call spir_func <8 x i32> @_Z20work_group_broadcastDv8_ij(<8 x i32> %wide.load, i32 0)
  %call4 = tail call spir_func i32 @_Z20work_group_broadcastijj(i32 %0, i32 0, i32 0) #4
; CHECK: = call spir_func <8 x i32> @_Z20work_group_broadcastDv8_ijj(<8 x i32> %wide.load, i32 0, i32 0)
  %call5 = tail call spir_func i32 @_Z20work_group_broadcastijjj(i32 %0, i32 0, i32 0, i32 0) #4
; CHECK: = call spir_func <8 x i32> @_Z20work_group_broadcastDv8_ijjj(<8 x i32> %wide.load, i32 0, i32 0, i32 0)

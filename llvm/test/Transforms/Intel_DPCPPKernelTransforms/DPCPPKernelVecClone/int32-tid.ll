...
; RUN: opt -dpcpp-kernel-vec-clone -dpcpp-vector-variant-isa-encoding-override=SSE42 -S %s | FileCheck %s
; RUN: opt -passes=dpcpp-kernel-vec-clone -dpcpp-vector-variant-isa-encoding-override=SSE42 -S %s | FileCheck %s
...
define void @foo(i32 addrspace(1)* %a) local_unnamed_addr {
entry:

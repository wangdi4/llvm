...
; CHECK-NEXT: [[GEP:%[a-zA-Z0-9]+]]             = getelementptr { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }* %pWorkDim, i32 0, i32 8, i32 [[LocalSizeIdx]], i32 0
; CHECK:      [[LocalSize:%[a-zA-Z0-9_]+]]       = load i64, i64* [[GEP]]
...
; CHECK-NEXT: [[IsLastGroup:%[a-zA-Z0-9_]+]]    = icmp eq i64 [[NumGroups:%[a-zA-Z0-9_]+]], [[GropuIDPlusOne]]
; CHECK-NEXT: [[LocalSizeIdx:%[a-zA-Z0-9_]+]]   = zext i1 [[IsLastGroup]] to i32
; CHECK-NEXT: [[GEP:%[a-zA-Z0-9]+]]             = getelementptr { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }* %pWorkDim, i32 0, i32 8, i32 [[LocalSizeIdx]], i32 1
; CHECK:      [[LocalSize:%[a-zA-Z0-9_]+]]       = load i64, i64* [[GEP]]
; CHECK:      ret i64 [[LocalSize]]
...
; CHECK-NEXT: [[IsLastGroup:%[a-zA-Z0-9_]+]]    = icmp eq i64 [[NumGroups:%[a-zA-Z0-9_]+]], [[GropuIDPlusOne]]
; CHECK-NEXT: [[LocalSizeIdx:%[a-zA-Z0-9_]+]]   = zext i1 [[IsLastGroup]] to i32
; CHECK-NEXT: [[GEP:%[a-zA-Z0-9]+]]             = getelementptr { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }* %pWorkDim, i32 0, i32 8, i32 [[LocalSizeIdx]], i32 2
; CHECK:      [[LocalSize:%[a-zA-Z0-9_]+]]       = load i64, i64* [[GEP]]
; CHECK:      ret i64 [[LocalSize]]
...
; CHECK-NEXT: [[IsLastGroup:%[a-zA-Z0-9_]+]]    = icmp eq i64 [[NumGroups:%[a-zA-Z0-9_]+]], [[GropuIDPlusOne]]
; CHECK-NEXT: [[LocalSizeIdx:%[a-zA-Z0-9_]+]]   = zext i1 [[IsLastGroup]] to i32
; CHECK-NEXT: [[GEP:%[a-zA-Z0-9]+]]             = getelementptr { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }* %pWorkDim, i32 0, i32 8, i32 [[LocalSizeIdx]], i32 %x 
; CHECK:      [[LocalSize:%[a-zA-Z0-9_]+]]       = load i64, i64* [[GEP]]

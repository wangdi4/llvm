...
; CHECK-NOT: call i32 @llvm.experimental.matrix.wi.slice.extractelement
  %the.element = call i32 @llvm.experimental.matrix.wi.slice.extractelement.v144i32.i64(<144 x i32> %mat, i32 12, i32 12, i64 %element.index, metadata !"matrix.rowmajor", metadata !"scope.subgroup")
  ret void
}
...
declare i32 @llvm.experimental.matrix.wi.slice.extractelement.v144i32.i64(<144 x i32>, i32, i32, i64, metadata, metadata) #0

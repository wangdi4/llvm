...
; CHECK-NOT: call i64 @llvm.experimental.matrix.wi.slice.length
  %slice.length = call i64 @llvm.experimental.matrix.wi.slice.length.v144i32(<144 x i32> %mat, i32 12, i32 12, metadata !"matrix.rowmajor", metadata !"scope.subgroup")
  ret void
}

; Function Attrs: nofree nosync nounwind willreturn
declare i64 @llvm.experimental.matrix.wi.slice.length.v144i32(<144 x i32>, i32, i32, metadata, metadata) #0

...
; CHECK: call i32 @__read_pipe_2_fpga(%opencl.pipe_ro_t {{.*}}, i8 addrspace(4)* %[[GL2GEN]], i32 4, i32 4)
; CHECK: %[[LO2GEN:[0-9]+]] = addrspacecast i8 addrspace(3)* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK-NOT: call i32 @__read_pipe_2_AS3
; CHECK: call i32 @__read_pipe_2_fpga(%opencl.pipe_ro_t {{.*}}, i8 addrspace(4)* %[[LO2GEN]], i32 4, i32 4)
; CHECK: %[[PR2GEN:[0-9]+]] = addrspacecast i8* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK-NOT: call i32 @__read_pipe_2_AS0
; CHECK: call i32 @__read_pipe_2_fpga(%opencl.pipe_ro_t {{.*}}, i8 addrspace(4)* %[[PR2GEN]], i32 4, i32 4)
; CHECK-NOT: declare i32 @__read_pipe_2_AS1(%opencl.pipe_ro_t addrspace(1)*, i8 addrspace(1)*, i32, i32)
; CHECK-NOT: declare i32 @__read_pipe_2_AS3(%opencl.pipe_ro_t addrspace(1)*, i8 addrspace(3)*, i32, i32)
; CHECK-NOT: declare i32 @__read_pipe_2_AS0(%opencl.pipe_ro_t addrspace(1)*, i8*, i32, i32)
;
; CHECK-LABEL: define void @test2
; CHECK: %[[GL2GEN:[0-9]+]] = addrspacecast i8 addrspace(1)* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK-NOT: call i32 @__write_pipe_2_AS1
; CHECK: call i32 @__write_pipe_2_fpga(%opencl.pipe_wo_t {{.*}}, i8 addrspace(4)* %[[GL2GEN]], i32 4, i32 4)
; CHECK: %[[LO2GEN:[0-9]+]] = addrspacecast i8 addrspace(3)* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK-NOT: call i32 @__write_pipe_2_AS3
; CHECK: call i32 @__write_pipe_2_fpga(%opencl.pipe_wo_t {{.*}}, i8 addrspace(4)* %[[LO2GEN]], i32 4, i32 4)
; CHECK: %[[PR2GEN:[0-9]+]] = addrspacecast i8* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK-NOT: call i32 @__write_pipe_2_AS0
; CHECK: call i32 @__write_pipe_2_fpga(%opencl.pipe_wo_t {{.*}}, i8 addrspace(4)* %[[PR2GEN]], i32 4, i32 4)
; CHECK: %[[CO2GEN:[0-9]+]] = addrspacecast i8 addrspace(2)* %{{[0-9]+}} to i8 addrspace(4)*
; CHECK-NOT: call i32 @__write_pipe_2_AS2
; CHECK: call i32 @__write_pipe_2_fpga(%opencl.pipe_wo_t {{.*}}, i8 addrspace(4)* %[[CO2GEN]], i32 4, i32 4)
; CHECK-NOT: declare i32 @__write_pipe_2_AS1(%opencl.pipe_wo_t addrspace(1)*, i8 addrspace(1)*, i32, i32)
; CHECK-NOT: declare i32 @__write_pipe_2_AS3(%opencl.pipe_wo_t addrspace(1)*, i8 addrspace(3)*, i32, i32)
; CHECK-NOT: declare i32 @__write_pipe_2_AS0(%opencl.pipe_wo_t addrspace(1)*, i8*, i32, i32)
; CHECK-NOT: declare i32 @__write_pipe_2_AS2(%opencl.pipe_wo_t addrspace(1)*, i8 addrspace(2)*, i32, i32)

; CHECK: declare i32 @__read_pipe_2_fpga
; CHECK: declare i32 @__write_pipe_2_fpga
...
entry:
  ...
  %8 = call i32 @__read_pipe_2_AS3(%opencl.pipe_ro_t addrspace(1)* %5, i8 addrspace(3)* %7, i32 4, i32 4)
  ...
  %13 = call i32 @__read_pipe_2_AS0(%opencl.pipe_ro_t addrspace(1)* %10, i8* %12, i32 4, i32 4)
...
declare i32 @__read_pipe_2_AS3(%opencl.pipe_ro_t addrspace(1)*, i8 addrspace(3)*, i32, i32)
...
entry:
  ...
  %1 = load i32 addrspace(1)*, i32 addrspace(1)** %ptr.addr, align 8, !tbaa !7
  %2 = bitcast i32 addrspace(1)* %1 to i8 addrspace(1)*
  %3 = call i32 @__write_pipe_2_AS1(%opencl.pipe_wo_t addrspace(1)* %0, i8 addrspace(1)* %2, i32 4, i32 4)
  %4 = bitcast i32 addrspace(3)** %ptr_l to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #2
  %5 = load %opencl.pipe_wo_t addrspace(1)*, %opencl.pipe_wo_t addrspace(1)** %p.addr, align 8, !tbaa !4
  %6 = load i32 addrspace(3)*, i32 addrspace(3)** %ptr_l, align 8, !tbaa !7
  %7 = bitcast i32 addrspace(3)* %6 to i8 addrspace(3)*
  %8 = call i32 @__write_pipe_2_AS3(%opencl.pipe_wo_t addrspace(1)* %5, i8 addrspace(3)* %7, i32 4, i32 4)
  %9 = bitcast i32** %ptr_p to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %9) #2
  %10 = load %opencl.pipe_wo_t addrspace(1)*, %opencl.pipe_wo_t addrspace(1)** %p.addr, align 8, !tbaa !4
  %11 = load i32*, i32** %ptr_p, align 8, !tbaa !7
  %12 = bitcast i32* %11 to i8*
  %13 = call i32 @__write_pipe_2_AS0(%opencl.pipe_wo_t addrspace(1)* %10, i8* %12, i32 4, i32 4)
  ...
  %18 = call i32 @__write_pipe_2_AS2(%opencl.pipe_wo_t addrspace(1)* %15, i8 addrspace(2)* %17, i32 4, i32 4)
...
declare i32 @__write_pipe_2_AS1(%opencl.pipe_wo_t addrspace(1)*, i8 addrspace(1)*, i32, i32)

declare i32 @__write_pipe_2_AS3(%opencl.pipe_wo_t addrspace(1)*, i8 addrspace(3)*, i32, i32)

declare i32 @__write_pipe_2_AS0(%opencl.pipe_wo_t addrspace(1)*, i8*, i32, i32)

declare i32 @__write_pipe_2_AS2(%opencl.pipe_wo_t addrspace(1)*, i8 addrspace(2)*, i32, i32)

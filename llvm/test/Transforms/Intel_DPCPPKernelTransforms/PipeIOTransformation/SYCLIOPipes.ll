...
; RUN: opt -dpcpp-kernel-builtin-lib=%t.rtl.bc -dpcpp-demangle-fpga-pipes -passes='dpcpp-kernel-rewrite-pipes,dpcpp-kernel-equalizer,dpcpp-kernel-pipe-io-transform' %s -S -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
; RUN: opt -dpcpp-kernel-builtin-lib=%t.rtl.bc -dpcpp-demangle-fpga-pipes -passes='dpcpp-kernel-rewrite-pipes,dpcpp-kernel-equalizer,dpcpp-kernel-pipe-io-transform' %s -S | FileCheck %s
; RUN: opt -enable-new-pm=0 -dpcpp-kernel-builtin-lib=%t.rtl.bc -dpcpp-demangle-fpga-pipes -dpcpp-kernel-rewrite-pipes -dpcpp-kernel-equalizer -dpcpp-kernel-pipe-io-transform %s -S -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
; RUN: opt -enable-new-pm=0 -dpcpp-kernel-builtin-lib=%t.rtl.bc -dpcpp-demangle-fpga-pipes -dpcpp-kernel-rewrite-pipes -dpcpp-kernel-equalizer -dpcpp-kernel-pipe-io-transform %s -S | FileCheck %s

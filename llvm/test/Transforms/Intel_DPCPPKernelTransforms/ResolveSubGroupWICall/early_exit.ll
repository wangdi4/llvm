...
; RUN: opt -dpcpp-kernel-builtin-lib=%t.rtl.bc -enable-debugify -dpcpp-kernel-resolve-sub-group-wi-call -disable-output 2>&1 -S < %s | FileCheck -check-prefix=DEBUGIFY %s

...
; CHECK: @t1
define void @t1( <16 x i32> %arg1) #0 {
entry:
  ret void
}

;; new func
;;int16 arg1 - expected alignment: 64
; CHECK: [[ARG0_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %UniformArgs, i32 0
; CHECK-NEXT: [[ARG0_TYPECAST:%[a-zA-Z0-9]+]] = bitcast i8* [[ARG0_BUFF_INDEX]] to <16 x i32>*
; CHECK-NEXT: %explicit_0 = load <16 x i32>, <16 x i32>* [[ARG0_TYPECAST]], align 64
;;implicit args
; CHECK: ret void

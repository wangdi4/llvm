...
define internal void @__block_fn_block_invoke(i8 addrspace(4)* %.block_descriptor, i8 addrspace(3)* noalias %pLocalMemBase, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* noalias %pWorkDim, i64* noalias %pWGId, [4 x i64] %BaseGlbId, i8* noalias %pSpecialBuf, {}* noalias %RuntimeHandle) #0 {
entry:
  ...
  %1 = getelementptr { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* %pWorkDim, i64 0, i32 6
  %2 = bitcast {}** %1 to i8**
  ...
  store i8 addrspace(4)* addrspacecast (i8* bitcast (void (i8 addrspace(4)*, i8 addrspace(3)*, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }*, i64*, [4 x i64], i8*, {}*)* @__block_fn_block_invoke to i8*) to i8 addrspace(4)*), i8 addrspace(4)** %block.invoke.i, align 8
...
define dso_local void @__block_fn_block_invoke_kernel(i8 addrspace(4)* %0, i8 addrspace(3)* noalias %pLocalMemBase, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* noalias %pWorkDim, i64* noalias %pWGId, [4 x i64] %BaseGlbId, i8* noalias %pSpecialBuf, {}* noalias %RuntimeHandle) #1 !no_barrier_path !1 !kernel_has_sub_groups !1 !block_literal_size !2 !local_buffer_size !3 !barrier_buffer_size !4 !kernel_execution_length !5 !kernel_has_barrier !1 !kernel_has_global_sync !1 !private_memory_size !6 !opencl.stats.InstCounter.CantVectNonInlineUnsupportedFunctions !7 {
entry:
  %1 = getelementptr { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* %pWorkDim, i64 0, i32 5
  %2 = bitcast {}** %1 to i8**
  %RuntimeInterface9 = load i8*, i8** %2, align 1
  %3 = getelementptr { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* %pWorkDim, i64 0, i32 6
  %4 = bitcast {}** %3 to i8**
  %Block2KernelMapper10 = load i8*, i8** %4, align 1
  %pSB_LocalId4 = alloca %struct.ndrange_t.6, align 8
  %5 = getelementptr { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }* %pWorkDim, i64 0, i32 5
  %6 = bitcast {}** %5 to i8**
  ...
  store i8 addrspace(4)* addrspacecast (i8* bitcast (void (i8 addrspace(4)*, i8 addrspace(3)*, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }*, i64*, [4 x i64], i8*, {}*)* @__block_fn_block_invoke to i8*) to i8 addrspace(4)*), i8 addrspace(4)** %13, align 8
...
!0 = !{void (i8 addrspace(4)*, i8 addrspace(3)*, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}* }*, i64*, [4 x i64], i8*, {}*)* @__block_fn_block_invoke_kernel}
!1 = !{i1 false}
!2 = !{i32 32}
!3 = !{i32 0}
!4 = !{i32 112}

...
; CHECK-DAG: RND    %broadcast.splatinsertvector_func = insertelement <16 x i32> zeroinitializer, i32 %dim_0_vector_ind_var, i64 0
; CHECK-DAG: STR    %broadcast.splatvector_func = shufflevector <16 x i32> %broadcast.splatinsertvector_func, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer
...
; CHECK-DAG: i32 16    %broadcast.splatinsertvector_func = insertelement <16 x i32> zeroinitializer, i32 %dim_0_vector_ind_var, i64 0
; CHECK-DAG: i32 16    %broadcast.splatvector_func = shufflevector <16 x i32> %broadcast.splatinsertvector_func, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer

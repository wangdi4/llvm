...
; RUN: opt -passes=dpcpp-kernel-deduce-max-dim -dpcpp-kernel-builtin-lib=%t.rtl.bc -S %s | FileCheck %s
...
; RUN: opt -dpcpp-kernel-deduce-max-dim -dpcpp-kernel-builtin-lib=%t.rtl.bc -S %s | FileCheck %s

...
define dso_local i32 @foo(i32 addrspace(1)* noalias noundef %dst) #0 !dbg !6 {
entry:
; CHECK-LABEL: @foo
...
; CHECK: %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* [[PTR]], i64 [[GIDLoad]], !dbg
  ...
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid1, metadata !16, metadata !DIExpression()), !dbg !15
  %__ocl_dbg_gid2 = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid2, metadata !17, metadata !DIExpression()), !dbg !15
  ...
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %call, !dbg !20
...
; Function Attrs: convergent noinline norecurse nounwind optnone
define dso_local i32 @bar(i32 addrspace(1)* noalias noundef %dst) #0 !dbg !24 {
entry:
; CHECK-LABEL: @bar
; CHECK: call i64 @_Z13get_global_idj(i32 noundef 0)
  ...
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %dst.addr, align 8, !dbg !27
  %call = call i64 @_Z13get_global_idj(i32 noundef 0) #6, !dbg !28
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %call, !dbg !27
  store i32 0, i32 addrspace(1)* %arrayidx, align 4, !dbg !29
  %1 = load i32, i32* %retval, align 4, !dbg !30
  ret i32 %1, !dbg !30
}

; Function Attrs: convergent noinline norecurse nounwind optnone
define dso_local void @test(i32 addrspace(1)* noalias noundef align 4 %dst) #3 !dbg !31 !kernel_arg_addr_space !34 !kernel_arg_access_qual !35 !kernel_arg_type !36 !kernel_arg_base_type !36 !kernel_arg_type_qual !37 !kernel_arg_name !38 !kernel_arg_host_accessible !39 !kernel_arg_pipe_depth !40 !kernel_arg_pipe_io !41 !kernel_arg_buffer_location !41 !no_barrier_path !42 !kernel_has_sub_groups !39 !kernel_execution_length !43 !kernel_has_global_sync !39 !recommended_vector_length !34 {
entry:
  %__ocl_dbg_gid0 = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid0, metadata !44, metadata !DIExpression()), !dbg !45
  %__ocl_dbg_gid1 = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid1, metadata !46, metadata !DIExpression()), !dbg !45
  %__ocl_dbg_gid2 = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid2, metadata !47, metadata !DIExpression()), !dbg !45
  %GlobalID_0 = call i64 @_Z13get_global_idj(i32 0)
  store volatile i64 %GlobalID_0, i64* %__ocl_dbg_gid0, align 8
  %GlobalID_1 = call i64 @_Z13get_global_idj(i32 1)
  store volatile i64 %GlobalID_1, i64* %__ocl_dbg_gid1, align 8
  ...
  %dst.addr = alloca i32 addrspace(1)*, align 8
  store i32 addrspace(1)* %dst, i32 addrspace(1)** %dst.addr, align 8
  call void @llvm.dbg.declare(metadata i32 addrspace(1)** %dst.addr, metadata !48, metadata !DIExpression()), !dbg !49
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %dst.addr, align 8, !dbg !50
  %call = call i32 @foo(i32 addrspace(1)* noundef %0) #7, !dbg !51
  ret void, !dbg !52
}

; Function Attrs: convergent noinline norecurse nounwind optnone
define dso_local void @test_barrier(i32 addrspace(1)* noalias noundef align 4 %dst) #4 !dbg !53 !kernel_arg_addr_space !34 !kernel_arg_access_qual !35 !kernel_arg_type !36 !kernel_arg_base_type !36 !kernel_arg_type_qual !37 !kernel_arg_name !38 !kernel_arg_host_accessible !39 !kernel_arg_pipe_depth !40 !kernel_arg_pipe_io !41 !kernel_arg_buffer_location !41 !no_barrier_path !39 !kernel_has_sub_groups !39 !kernel_execution_length !54 !kernel_has_global_sync !39 !recommended_vector_length !34 {
entry:
  %dst.addr = alloca i32 addrspace(1)*, align 8
  store i32 addrspace(1)* %dst, i32 addrspace(1)** %dst.addr, align 8
  call void @llvm.dbg.declare(metadata i32 addrspace(1)** %dst.addr, metadata !55, metadata !DIExpression()), !dbg !56
  call void @_Z7barrierj(i32 noundef 1) #8, !dbg !57
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %dst.addr, align 8, !dbg !58
  %call = call i32 @bar(i32 addrspace(1)* noundef %0) #7, !dbg !59
  ret void, !dbg !60
}

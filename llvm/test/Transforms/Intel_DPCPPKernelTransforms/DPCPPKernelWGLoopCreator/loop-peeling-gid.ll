...
entry:
  ...
  store i32 3, i32 addrspace(1)* %ptridx, align 4, !tbaa !12, !nontemporal !1
  ret void
...
define [7 x i64] @WG.boundaries.test(i32 addrspace(1)* %0) !recommended_vector_length !16 {
entry:
...
entry:
  ...
  store <16 x i32> <i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3>, <16 x i32> addrspace(1)* %0, align 4, !nontemporal !1, !intel.preferred_alignment !18
  ret void
}
...
!6 = !{i32 0}
!7 = !{!"dst"}
!8 = !{void (i32 addrspace(1)*)* @_ZGVeN16u_test}
!9 = !{i1 true}
!10 = !{null}
!11 = !{i32 4}
!12 = !{!13, !13, i64 0}

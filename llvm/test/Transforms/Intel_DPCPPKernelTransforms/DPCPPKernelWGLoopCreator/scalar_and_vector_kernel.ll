...
; CHECK-NEXT:    [[VECTOR_SIZE:%.*]] = ashr i64 [[TMP2]], 4
...
; CHECK-NEXT:    br i1 [[TMP7]], label [[DIM_2_VECTOR_PRE_HEAD:%.*]], label [[SCALARIF:%.*]]
...
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[SCALAR_GEPVECTOR_FUNC]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> <i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345, i32 12345>, <16 x i32>* [[TMP10]], align 4
...
; CHECK-NEXT:    [[DIM_1_VECTOR_CMP_TO_MAX:%.*]] = icmp eq i64 [[DIM_1_VECTOR_INC_IND_VAR]], [[TMP4]]
...
; CHECK-NEXT:    [[DIM_2_VECTOR_CMP_TO_MAX:%.*]] = icmp eq i64 [[DIM_2_VECTOR_INC_IND_VAR]], [[TMP6]]
...
; CHECK:       scalarIf:
; CHECK-NEXT:    [[TMP11:%.*]] = icmp ne i64 [[SCALAR_SIZE]], 0
; CHECK-NEXT:    br i1 [[TMP11]], label [[DIM_2_PRE_HEAD:%.*]], label [[RET:%.*]]

...
; Function Attrs: convergent noinline norecurse nounwind optnone
define dso_local void @test(i32 addrspace(1)* noundef align 4 %dst1, i32 addrspace(1)* noundef align 4 %dst2) #2 !kernel_arg_addr_space !2 !kernel_arg_access_qual !3 !kernel_arg_type !4 !kernel_arg_base_type !4 !kernel_arg_type_qual !5 !kernel_arg_name !6 !kernel_arg_host_accessible !7 !kernel_arg_pipe_depth !8 !kernel_arg_pipe_io !5 !kernel_arg_buffer_location !5 !no_barrier_path !9 !kernel_has_sub_groups !10 !kernel_execution_length !11 !kernel_has_global_sync !10 !recommended_vector_length !12 {
entry:
; CHECK-LABEL: @test
...
; CHECK-NEXT: store i64 %dim_1_tid, i64* %local.id1, align 8
; CHECK-NEXT: store i64 %dim_2_tid, i64* %local.id2, align 8
; CHECK-NEXT: call void @foo(i32 addrspace(1)* noalias noundef %2, [3 x i64]* noalias %local.ids) #2

  %dst1.addr = alloca i32 addrspace(1)*, align 8
  %dst2.addr = alloca i32 addrspace(1)*, align 8
  store i32 addrspace(1)* %dst1, i32 addrspace(1)** %dst1.addr, align 8
  store i32 addrspace(1)* %dst2, i32 addrspace(1)** %dst2.addr, align 8
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %dst1.addr, align 8
  call void @foo(i32 addrspace(1)* noundef %0) #4
  %1 = load i32 addrspace(1)*, i32 addrspace(1)** %dst2.addr, align 8
  call void @foo(i32 addrspace(1)* noundef %1) #4
  ret void
}
...
!1 = !{void (i32 addrspace(1)*, i32 addrspace(1)*)* @test}
!2 = !{i32 1, i32 1}
!3 = !{!"none", !"none"}
!4 = !{!"int*", !"int*"}
!5 = !{!"", !""}

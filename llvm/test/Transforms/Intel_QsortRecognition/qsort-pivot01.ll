...
; CHECK: QsortRec: Pivot:   %tmp33 = getelementptr inbounds i8, i8* %tmp29, i64 %tmp32
...
; CHECK: QsortRec: Check:  %tmp33 = getelementptr inbounds i8, i8* %tmp29, i64 %tmp32
; CHECK: QsortRec: Check:  %tmp38 = getelementptr inbounds i8, i8* %tmp29, i64 %tmp37
; CHECK: QsortRec: Check:  %tmp99 = getelementptr inbounds i8, i8* %tmp38, i64 %tmp98
; CHECK: QsortRec: Check:  %tmp100 = getelementptr inbounds i8, i8* %tmp38, i64 %tmp70
; CHECK: QsortRec: Check:  %tmp44 = getelementptr inbounds i8, i8* %tmp29, i64 %tmp43
; CHECK: QsortRec: Check:  %tmp42 = getelementptr inbounds i8, i8* %tmp29, i64 %tmp41
; CHECK: QsortRec: Check:  %tmp72 = getelementptr inbounds i8, i8* %tmp33, i64 %tmp41
; CGECK: QsortRec: Check:  %tmp71 = getelementptr inbounds i8, i8* %tmp33, i64 %tmp70
; CHECK: QsortRec: qsort_pivot passed pivot test
...
bb28:                                             ; preds = %bb151, %bb
  ...
  %tmp33 = getelementptr inbounds i8, i8* %tmp29, i64 %tmp32

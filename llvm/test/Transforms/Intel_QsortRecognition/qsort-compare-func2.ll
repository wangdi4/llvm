...
; This test checks that the compare function wasn't found since arc_compare is
; not defined as we want. This is the same test as qsort-sorter01.ll but with

...
; CHECK: QsortRec: Recursion candidate in qsort_rec
; CHECK: tail call fastcc void @qsort_rec(i8* %34, i64 %312)
; CHECK: QsortRec: Recursion in qsort_rec PASSED Test.
...
311:                                              ; preds = %309
  %312 = lshr i64 %259, 3
  tail call fastcc void @qsort_rec(i8* %34, i64 %312)
  br label %313

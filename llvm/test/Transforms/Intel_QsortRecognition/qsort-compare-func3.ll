...
; Check that the compare function test fails since qsort is using two different
; compare functions. This is the same test as qsort-sorter01.ll but with two
; compare functions defined.

; CHECK: QsortRec: Compare Function NOT found
...
define internal i32 @arc_compare_new(%struct.arc** nocapture readonly %arg, %struct.arc** nocapture readonly %arg1) {
bb:
  %tmp = load %struct.arc*, %struct.arc** %arg, align 8
  %tmp2 = getelementptr inbounds %struct.arc, %struct.arc* %tmp, i64 0, i32 7
  %tmp3 = load i64, i64* %tmp2, align 8
...
199:                                              ; preds = %194, %215
  ...
  %205 = tail call i32 @arc_compare_new(%struct.arc** %203, %struct.arc** %204) #12
...
239:                                              ; preds = %236, %246
  ...
  %244 = tail call i32 @arc_compare_new(%struct.arc** nonnull %242, %struct.arc** %243) #12

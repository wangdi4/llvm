...
; RUN: opt -opaque-pointers=0 < %s  -passes='module(deadarrayopselimination)' -dead-array-ops-functions="s_qsort,491" -debug-only=deadarrayopselimination -whole-program-assume -disable-output 2>&1 | FileCheck %s

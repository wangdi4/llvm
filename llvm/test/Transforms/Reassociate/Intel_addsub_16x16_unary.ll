; RUN: opt -passes="addsub-reassoc" < %s -addsub-reassoc-simplify-trunks=true -addsub-reassoc-simplify-chains=true -addsub-reassoc-max-distributed-instructions=1 -addsub-reassoc-unshare-leaves=true -addsub-reassoc-canonicalize-group=true -S | FileCheck %s -check-prefix=CHECK_CANON_GROUP
; RUN: opt -passes="addsub-reassoc" < %s -addsub-reassoc-simplify-trunks=true -addsub-reassoc-simplify-chains=true -addsub-reassoc-max-distributed-instructions=1 -addsub-reassoc-unshare-leaves=true -addsub-reassoc-canonicalize-group=false -S | FileCheck %s -check-prefix=CHECK_UNSHARE
; RUN: opt -passes="addsub-reassoc" < %s -addsub-reassoc-simplify-trunks=true -addsub-reassoc-simplify-chains=true -addsub-reassoc-max-distributed-instructions=1 -addsub-reassoc-unshare-leaves=false -addsub-reassoc-canonicalize-group=false -S | FileCheck %s -check-prefix=CHECK_UNARY_ASSOC
; RUN: opt -passes="addsub-reassoc" < %s -addsub-reassoc-simplify-trunks=true -addsub-reassoc-simplify-chains=true -addsub-reassoc-max-distributed-instructions=0 -addsub-reassoc-unshare-leaves=false -addsub-reassoc-canonicalize-group=false -S | FileCheck %s -check-prefix=CHECK_SIMP
; RUN: opt -passes="addsub-reassoc" < %s -addsub-reassoc-simplify-trunks=false -addsub-reassoc-simplify-chains=false -addsub-reassoc-max-distributed-instructions=0 -addsub-reassoc-unshare-leaves=false -addsub-reassoc-canonicalize-group=false -S | FileCheck %s -check-prefix=CHECK
...
; CHECK_CANON_GROUP: [[Bridge2_1:%.*]] = sub i32 [[Chain2_3]], [[Chain3_3]]
; CHECK_CANON_GROUP: [[Bridge2_2:%.*]] = sub i32 [[Bridge2_1]], [[Chain4_3]]
; CHECK_CANON_GROUP: [[Bridge2_3:%.*]] = add i32 [[Bridge2_2]], [[Chain1_3]]
; CHECK_CANON_GROUP: store i32 [[Bridge2_3]]
; CHECK_CANON_GROUP: [[Bridge3_1:%.*]] = sub i32 [[Chain3_3]], [[Chain4_3]]
; CHECK_CANON_GROUP: [[Bridge3_2:%.*]] = sub i32 [[Bridge3_1]], [[Chain2_3]]
; CHECK_CANON_GROUP: [[Bridge3_3:%.*]] = add i32 [[Bridge3_2]], [[Chain1_3]]
...
; CHECK_UNSHARE: [[Chain2_173177:%.*]] = sub i32 [[Chain2_189]], [[Chain2_191]]
; CHECK_UNSHARE: [[Chain2_174178:%.*]] = sub i32 [[Chain2_173177]]
; CHECK_UNSHARE: [[Chain2_3:%.*]] = add i32 [[Chain2_174178]]
; CHECK_UNSHARE: [[Chain3_191:%.*]] = shl i32
; CHECK_UNSHARE: [[Chain3_189:%.*]] = shl i32
; CHECK_UNSHARE: [[Chain3_173177:%.*]] = sub i32 [[Chain3_189]], [[Chain3_191]]
; CHECK_UNSHARE: [[Chain3_174178:%.*]] = sub i32 [[Chain3_173177]]
; CHECK_UNSHARE: [[Chain3_3:%.*]] = add i32 [[Chain3_174178]]
; CHECK_UNSHARE: [[Chain4_191:%.*]] = shl i32
; CHECK_UNSHARE: [[Chain4_189:%.*]] = shl i32
; CHECK_UNSHARE: [[Chain4_173177:%.*]] = sub i32 [[Chain4_189]], [[Chain4_191]]
; CHECK_UNSHARE: [[Chain4_174178:%.*]] = sub i32 [[Chain4_173177]]
; CHECK_UNSHARE: [[Chain4_3:%.*]] = add i32 [[Chain4_174178]]
...
; CHECK_UNARY_ASSOC: [[Chain1_191:%.*]] = shl i32
; CHECK_UNARY_ASSOC: [[Chain1_189:%.*]] = shl i32
; CHECK_UNARY_ASSOC: [[Chain1_173177:%.*]] = sub i32 [[Chain1_189]], [[Chain1_191]]
; CHECK_UNARY_ASSOC: [[Chain1_174178:%.*]] = sub i32 [[Chain1_173177]]
; CHECK_UNARY_ASSOC: [[Chain1_3:%.*]] = add i32 [[Chain1_174178]]
; CHECK_UNARY_ASSOC: [[Chain2_191:%.*]] = shl i32
; CHECK_UNARY_ASSOC: [[Chain2_189:%.*]] = shl i32
; CHECK_UNARY_ASSOC: [[Chain2_173177:%.*]] = sub i32 [[Chain2_189]], [[Chain2_191]]
; CHECK_UNARY_ASSOC: [[Chain2_174178:%.*]] = sub i32 [[Chain2_173177]]
; CHECK_UNARY_ASSOC: [[Chain2_3:%.*]] = add i32 [[Chain2_174178]]
; CHECK_UNARY_ASSOC: [[Chain3_189:%.*]] = shl i32
; CHECK_UNARY_ASSOC: [[Chain3_173177:%.*]] = sub i32 [[Chain3_189]]
; CHECK_UNARY_ASSOC: [[Chain3_3:%.*]] = add i32 [[Chain3_173177]]
; CHECK_UNARY_ASSOC: [[Bridge0_0:%.*]] = sub i32 [[Chain3_3]], [[Chain2_3]]
; CHECK_UNARY_ASSOC: [[Bridge0_1:%.*]] = add i32 [[Bridge0_0]], [[Chain1_3]]
; CHECK_UNARY_ASSOC: store i32 [[Bridge0_1]]

; CHECK_SIMP:  [[Chain1_1:%.*]] = sub i32 [[l57:%.*]], [[l65:%.*]]
; CHECK_SIMP:  [[Chain2_1:%.*]] = sub i32 [[l64:%.*]], [[l56:%.*]]
; CHECK_SIMP:  [[Bridge0_0:%.*]] = sub i32 [[Chain2_1]], [[Chain1_1]]
; CHECK_SIMP:  [[Bridge0_1:%.*]] = add i32 [[Bridge0_0]],

; CHECK:  [[Chain0_0:%.*]] = add i32 0, [[l65:%.*]]
; CHECK:  [[Chain0_1:%.*]] = sub i32 [[Chain0_0]], [[l57:%.*]]
; CHECK:  [[Chain1_0:%.*]] = sub i32 0, [[l64:%.*]]
; CHECK:  [[Chain1_1:%.*]] = add i32 [[Chain1_0]], [[l56:%.*]]
; CHECK:  [[Bridge0_0:%.*]] = add i32 0, [[Chain1_1]]
; CHECK:  [[Bridge0_1:%.*]] = sub i32 [[Bridge0_0]], [[Chain0_1]]
; CHECK:  [[Bridge0_2:%.*]] = add i32 [[Bridge0_1]]

define dso_local i32 @x264_pixel_satd_16x16(ptr nocapture readonly %pix1, i32 %i_pix1, ptr nocapture readonly %pix2, i32 %i_pix2) #2 {
entry:
...
loop.1247:                                        ; preds = %loop.1247, %entry
  ...
  %arrayIdx = getelementptr inbounds i8, ptr %pix1, i64 %1
  %gepload = load i8, ptr %arrayIdx, align 1, !tbaa !21
  %2 = sext i32 %i_pix2 to i64
  %3 = mul i64 %i1.i64.0, %2
  %arrayIdx1013 = getelementptr inbounds i8, ptr %pix2, i64 %3
  %gepload1014 = load i8, ptr %arrayIdx1013, align 1, !tbaa !21
  %4 = add i64 %1, 4
  %arrayIdx1015 = getelementptr inbounds i8, ptr %pix1, i64 %4
  %gepload1016 = load i8, ptr %arrayIdx1015, align 1, !tbaa !21
  %5 = add i64 %3, 4
  %arrayIdx1017 = getelementptr inbounds i8, ptr %pix2, i64 %5
  %gepload1018 = load i8, ptr %arrayIdx1017, align 1, !tbaa !21
  %6 = add i64 %1, 1
  %arrayIdx1019 = getelementptr inbounds i8, ptr %pix1, i64 %6
  %gepload1020 = load i8, ptr %arrayIdx1019, align 1, !tbaa !21
  %7 = add i64 %3, 1
  %arrayIdx1021 = getelementptr inbounds i8, ptr %pix2, i64 %7
  %gepload1022 = load i8, ptr %arrayIdx1021, align 1, !tbaa !21
  %8 = add i64 %1, 5
  %arrayIdx1023 = getelementptr inbounds i8, ptr %pix1, i64 %8
  %gepload1024 = load i8, ptr %arrayIdx1023, align 1, !tbaa !21
  %9 = add i64 %3, 5
  %arrayIdx1025 = getelementptr inbounds i8, ptr %pix2, i64 %9
  %gepload1026 = load i8, ptr %arrayIdx1025, align 1, !tbaa !21
  %10 = add i64 %1, 2
  %arrayIdx1027 = getelementptr inbounds i8, ptr %pix1, i64 %10
  %gepload1028 = load i8, ptr %arrayIdx1027, align 1, !tbaa !21
  %11 = add i64 %3, 2
  %arrayIdx1029 = getelementptr inbounds i8, ptr %pix2, i64 %11
  %gepload1030 = load i8, ptr %arrayIdx1029, align 1, !tbaa !21
  %12 = add i64 %1, 6
  %arrayIdx1031 = getelementptr inbounds i8, ptr %pix1, i64 %12
  %gepload1032 = load i8, ptr %arrayIdx1031, align 1, !tbaa !21
  %13 = add i64 %3, 6
  %arrayIdx1033 = getelementptr inbounds i8, ptr %pix2, i64 %13
  %gepload1034 = load i8, ptr %arrayIdx1033, align 1, !tbaa !21
  %14 = add i64 %1, 3
  %arrayIdx1035 = getelementptr inbounds i8, ptr %pix1, i64 %14
  %gepload1036 = load i8, ptr %arrayIdx1035, align 1, !tbaa !21
  %15 = add i64 %3, 3
  %arrayIdx1037 = getelementptr inbounds i8, ptr %pix2, i64 %15
  %gepload1038 = load i8, ptr %arrayIdx1037, align 1, !tbaa !21
  %16 = add i64 %1, 7
  %arrayIdx1039 = getelementptr inbounds i8, ptr %pix1, i64 %16
  %gepload1040 = load i8, ptr %arrayIdx1039, align 1, !tbaa !21
  %17 = add i64 %3, 7
  %arrayIdx1041 = getelementptr inbounds i8, ptr %pix2, i64 %17
  %gepload1042 = load i8, ptr %arrayIdx1041, align 1, !tbaa !21
...
%18 = zext i8 %gepload1036 to i32
  ...
  store i32 %38, ptr %arrayIdx1043, align 4
  ...
  store i32 %42, ptr %arrayIdx1045, align 4
  ...
  store i32 %47, ptr %arrayIdx1063, align 4
  ...
  store i32 %51, ptr %arrayIdx1081, align 4
  %52 = add i64 %1, 8
  %arrayIdx1098 = getelementptr inbounds i8, ptr %pix1, i64 %52
  %gepload1099 = load i8, ptr %arrayIdx1098, align 1, !tbaa !21
  %53 = add i64 %3, 8
  %arrayIdx1100 = getelementptr inbounds i8, ptr %pix2, i64 %53
  %gepload1101 = load i8, ptr %arrayIdx1100, align 1, !tbaa !21
  %54 = add i64 %1, 12
  %arrayIdx1102 = getelementptr inbounds i8, ptr %pix1, i64 %54
  %gepload1103 = load i8, ptr %arrayIdx1102, align 1, !tbaa !21
  %55 = add i64 %3, 12
  %arrayIdx1104 = getelementptr inbounds i8, ptr %pix2, i64 %55
  %gepload1105 = load i8, ptr %arrayIdx1104, align 1, !tbaa !21
  %56 = add i64 %1, 9
  %arrayIdx1106 = getelementptr inbounds i8, ptr %pix1, i64 %56
  %gepload1107 = load i8, ptr %arrayIdx1106, align 1, !tbaa !21
  %57 = add i64 %3, 9
  %arrayIdx1108 = getelementptr inbounds i8, ptr %pix2, i64 %57
  %gepload1109 = load i8, ptr %arrayIdx1108, align 1, !tbaa !21
  %58 = add i64 %1, 13
  %arrayIdx1110 = getelementptr inbounds i8, ptr %pix1, i64 %58
  %gepload1111 = load i8, ptr %arrayIdx1110, align 1, !tbaa !21
  %59 = add i64 %3, 13
  %arrayIdx1112 = getelementptr inbounds i8, ptr %pix2, i64 %59
  %gepload1113 = load i8, ptr %arrayIdx1112, align 1, !tbaa !21
  %60 = add i64 %1, 10
  %arrayIdx1114 = getelementptr inbounds i8, ptr %pix1, i64 %60
  %gepload1115 = load i8, ptr %arrayIdx1114, align 1, !tbaa !21
  %61 = add i64 %3, 10
  %arrayIdx1116 = getelementptr inbounds i8, ptr %pix2, i64 %61
  %gepload1117 = load i8, ptr %arrayIdx1116, align 1, !tbaa !21
  %62 = add i64 %1, 14
  %arrayIdx1118 = getelementptr inbounds i8, ptr %pix1, i64 %62
  %gepload1119 = load i8, ptr %arrayIdx1118, align 1, !tbaa !21
  %63 = add i64 %3, 14
  %arrayIdx1120 = getelementptr inbounds i8, ptr %pix2, i64 %63
  %gepload1121 = load i8, ptr %arrayIdx1120, align 1, !tbaa !21
  %64 = add i64 %1, 11
  %arrayIdx1122 = getelementptr inbounds i8, ptr %pix1, i64 %64
  %gepload1123 = load i8, ptr %arrayIdx1122, align 1, !tbaa !21
  %65 = add i64 %3, 11
  %arrayIdx1124 = getelementptr inbounds i8, ptr %pix2, i64 %65
  %gepload1125 = load i8, ptr %arrayIdx1124, align 1, !tbaa !21
  %66 = add i64 %1, 15
  %arrayIdx1126 = getelementptr inbounds i8, ptr %pix1, i64 %66
  %gepload1127 = load i8, ptr %arrayIdx1126, align 1, !tbaa !21
  %67 = add i64 %3, 15
  %arrayIdx1128 = getelementptr inbounds i8, ptr %pix2, i64 %67
  %gepload1129 = load i8, ptr %arrayIdx1128, align 1, !tbaa !21
  ...
  store i32 %88, ptr %arrayIdx1131, align 4
  ...
  store i32 %92, ptr %arrayIdx1133, align 4
  ...
  store i32 %97, ptr %arrayIdx1151, align 4
 ...
 %99 = add nuw nsw i32 %98, %68
  ...
  store i32 %101, ptr %arrayIdx1169, align 4

; RUN: opt < %s -addsub-reassoc -addsub-reassoc-simplify-trunks=true -addsub-reassoc-simplify-chains=true -addsub-reassoc-max-distributed-instructions=1 -addsub-reassoc-unshare-leaves=true -addsub-reassoc-canonicalize-group=true -S | FileCheck %s -check-prefix=CHECK_CANON_GROUP
; RUN: opt < %s -addsub-reassoc -addsub-reassoc-simplify-trunks=true -addsub-reassoc-simplify-chains=true -addsub-reassoc-max-distributed-instructions=1 -addsub-reassoc-unshare-leaves=true -addsub-reassoc-canonicalize-group=false -S | FileCheck %s -check-prefix=CHECK_UNSHARE
; RUN: opt < %s -addsub-reassoc -addsub-reassoc-simplify-trunks=true -addsub-reassoc-simplify-chains=true -addsub-reassoc-max-distributed-instructions=1 -addsub-reassoc-unshare-leaves=false -addsub-reassoc-canonicalize-group=false -S | FileCheck %s -check-prefix=CHECK_UNARY_ASSOC
; RUN: opt < %s -addsub-reassoc -addsub-reassoc-simplify-trunks=true -addsub-reassoc-simplify-chains=true -addsub-reassoc-max-distributed-instructions=0 -addsub-reassoc-unshare-leaves=false -addsub-reassoc-canonicalize-group=false -S | FileCheck %s -check-prefix=CHECK_SIMP
; RUN: opt < %s -addsub-reassoc -addsub-reassoc-simplify-trunks=false -addsub-reassoc-simplify-chains=false -addsub-reassoc-max-distributed-instructions=0 -addsub-reassoc-unshare-leaves=false -addsub-reassoc-canonicalize-group=false -S | FileCheck %s -check-prefix=CHECK

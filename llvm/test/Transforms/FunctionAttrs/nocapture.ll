...
; RUN: opt -passes=function-attrs -S < %s | FileCheck %s --check-prefixes=COMMON,FNATTRS,FNATTRS-NO-SUBSCRIPT ;INTEL
; RUN: opt -passes=attributor-light -S < %s | FileCheck --check-prefixes=COMMON,ATTRIBUTOR %s
; RUN: opt -S -passes=convert-to-subscript < %s | opt -passes=function-attrs -S | FileCheck %s --check-prefixes=COMMON,FNATTRS,FNATTRS-SUBSCRIPT ;INTEL
...
; INTEL_CUSTOMIZATION
; FNATTRS-NO-SUBSCRIPT: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none)
; FNATTRS-NO-SUBSCRIPT-LABEL: define i1 @c5
; FNATTRS-NO-SUBSCRIPT-SAME: (ptr [[Q:%.*]], i32 [[BITNO:%.*]]) #[[ATTR3:[0-9]+]] {
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[TMP:%.*]] = ptrtoint ptr [[Q]] to i32
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[TMP2:%.*]] = lshr i32 [[TMP]], [[BITNO]]
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[BIT:%.*]] = and i32 [[TMP2]], 1
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[LOOKUP:%.*]] = getelementptr [2 x i1], ptr @lookup_table, i32 0, i32 [[BIT]]
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[VAL:%.*]] = load i1, ptr [[LOOKUP]], align 1
; FNATTRS-NO-SUBSCRIPT-NEXT:    ret i1 [[VAL]]
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SUBSCRIPT: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none)
; FNATTRS-SUBSCRIPT-LABEL: define i1 @c5
; FNATTRS-SUBSCRIPT-SAME: (ptr [[Q:%.*]], i32 [[BITNO:%.*]]) #[[ATTR3:[0-9]+]] {
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP:%.*]] = ptrtoint ptr [[Q]] to i32
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP2:%.*]] = lshr i32 [[TMP]], [[BITNO]]
; FNATTRS-SUBSCRIPT-NEXT:    [[BIT:%.*]] = and i32 [[TMP2]], 1
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP1:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 1, i64 0, i64 2, ptr elementtype(i1) @lookup_table, i32 0)
; FNATTRS-SUBSCRIPT-NEXT:    [[LOOKUP:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 0, i64 0, i64 1, ptr elementtype(i1) [[TMP1]], i32 [[BIT]])
; FNATTRS-SUBSCRIPT-NEXT:    [[VAL:%.*]] = load i1, ptr [[LOOKUP]], align 1
; FNATTRS-SUBSCRIPT-NEXT:    ret i1 [[VAL]]
; end INTEL_CUSTOMIZATION
;
  %tmp = ptrtoint ptr %q to i32
  %tmp2 = lshr i32 %tmp, %bitno
...
; INTEL_CUSTOMIZATION
; FNATTRS-NO-SUBSCRIPT: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
; FNATTRS-NO-SUBSCRIPT-LABEL: define nonnull ptr @lookup_bit
; FNATTRS-NO-SUBSCRIPT-SAME: (ptr [[Q:%.*]], i32 [[BITNO:%.*]]) #[[ATTR0]] {
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[TMP:%.*]] = ptrtoint ptr [[Q]] to i32
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[TMP2:%.*]] = lshr i32 [[TMP]], [[BITNO]]
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[BIT:%.*]] = and i32 [[TMP2]], 1
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[LOOKUP:%.*]] = getelementptr [2 x i1], ptr @lookup_table, i32 0, i32 [[BIT]]
; FNATTRS-NO-SUBSCRIPT-NEXT:    ret ptr [[LOOKUP]]
; end INTEL_CUSTOMIZATION
;
; ATTRIBUTOR: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SUBSCRIPT: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
; FNATTRS-SUBSCRIPT-LABEL: define nonnull ptr @lookup_bit
; FNATTRS-SUBSCRIPT-SAME: (ptr [[Q:%.*]], i32 [[BITNO:%.*]]) #[[ATTR0]] {
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP:%.*]] = ptrtoint ptr [[Q]] to i32
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP2:%.*]] = lshr i32 [[TMP]], [[BITNO]]
; FNATTRS-SUBSCRIPT-NEXT:    [[BIT:%.*]] = and i32 [[TMP2]], 1
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP1:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 1, i64 0, i64 2, ptr elementtype(i1) @lookup_table, i32 0)
; FNATTRS-SUBSCRIPT-NEXT:    [[LOOKUP:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 0, i64 0, i64 1, ptr elementtype(i1) [[TMP1]], i32 [[BIT]])
; FNATTRS-SUBSCRIPT-NEXT:    ret ptr [[LOOKUP]]
; end INTEL_CUSTOMIZATION
;
  %tmp = ptrtoint ptr %q to i32
  %tmp2 = lshr i32 %tmp, %bitno
...
; INTEL_CUSTOMIZATION
; FNATTRS-NO-SUBSCRIPT: Function Attrs: nofree norecurse nounwind memory(argmem: readwrite, inaccessiblemem: readwrite)
; FNATTRS-NO-SUBSCRIPT-LABEL: define void @test_volatile
; FNATTRS-NO-SUBSCRIPT-SAME: (ptr [[X:%.*]]) #[[ATTR12:[0-9]+]] {
; FNATTRS-NO-SUBSCRIPT-NEXT:  entry:
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[GEP:%.*]] = getelementptr i32, ptr [[X]], i64 1
; FNATTRS-NO-SUBSCRIPT-NEXT:    store volatile i32 0, ptr [[GEP]], align 4
; FNATTRS-NO-SUBSCRIPT-NEXT:    ret void
; end INTEL_CUSTOMIZATION
;
; ATTRIBUTOR: Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(argmem: readwrite)
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SUBSCRIPT: Function Attrs: nofree norecurse nounwind memory(argmem: readwrite, inaccessiblemem: readwrite)
; FNATTRS-SUBSCRIPT-LABEL: define void @test_volatile
; FNATTRS-SUBSCRIPT-SAME: (ptr [[X:%.*]]) #[[ATTR12:[0-9]+]] {
; FNATTRS-SUBSCRIPT-NEXT:  entry:
; FNATTRS-SUBSCRIPT-NEXT:    [[GEP:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 4, ptr elementtype(i32) [[X]], i64 1)
; FNATTRS-SUBSCRIPT-NEXT:    store volatile i32 0, ptr [[GEP]], align 4
; FNATTRS-SUBSCRIPT-NEXT:    ret void
; end INTEL_CUSTOMIZATION
;
entry:
...
; INTEL_CUSTOMIZATION
; FNATTRS-NO-SUBSCRIPT: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
; FNATTRS-NO-SUBSCRIPT-LABEL: define i1 @nocaptureInboundsGEPICmp
; FNATTRS-NO-SUBSCRIPT-SAME: (ptr readnone [[X:%.*]]) #[[ATTR0]] {
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[TMP1:%.*]] = getelementptr inbounds i32, ptr [[X]], i32 5
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[TMP2:%.*]] = icmp eq ptr [[TMP1]], null
; FNATTRS-NO-SUBSCRIPT-NEXT:    ret i1 [[TMP2]]
; end INTEL_CUSTOMIZATION
;
; ATTRIBUTOR: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
...
; INTEL_CUSTOMIZATION
; FNATTRS-SUBSCRIPT: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
; FNATTRS-SUBSCRIPT-LABEL: define i1 @nocaptureInboundsGEPICmp
; FNATTRS-SUBSCRIPT-SAME: (ptr nocapture readnone [[X:%.*]]) #[[ATTR0]] {
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP1:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 0, i64 0, i64 4, ptr elementtype(i32) [[X]], i32 5)
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP2:%.*]] = icmp eq ptr [[TMP1]], null
; FNATTRS-SUBSCRIPT-NEXT:    ret i1 [[TMP2]]
; end INTEL_CUSTOMIZATION
;
...
; INTEL_CUSTOMIZATION
; FNATTRS-NO-SUBSCRIPT: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
; FNATTRS-NO-SUBSCRIPT-LABEL: define i1 @nocaptureInboundsGEPICmpRev
; FNATTRS-NO-SUBSCRIPT-SAME: (ptr readnone [[X:%.*]]) #[[ATTR0]] {
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[TMP1:%.*]] = getelementptr inbounds i32, ptr [[X]], i32 5
; FNATTRS-NO-SUBSCRIPT-NEXT:    [[TMP2:%.*]] = icmp eq ptr null, [[TMP1]]
; FNATTRS-NO-SUBSCRIPT-NEXT:    ret i1 [[TMP2]]
; end INTEL_CUSTOMIZATION
;
; ATTRIBUTOR: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
...
; INTEL_CUSTOMIZATION
; FNATTRS-SUBSCRIPT: Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
; FNATTRS-SUBSCRIPT-LABEL: define i1 @nocaptureInboundsGEPICmpRev
; FNATTRS-SUBSCRIPT-SAME: (ptr nocapture readnone [[X:%.*]]) #[[ATTR0]] {
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP1:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 0, i64 0, i64 4, ptr elementtype(i32) [[X]], i32 5)
; FNATTRS-SUBSCRIPT-NEXT:    [[TMP2:%.*]] = icmp eq ptr null, [[TMP1]]
; FNATTRS-SUBSCRIPT-NEXT:    ret i1 [[TMP2]]
; end INTEL_CUSTOMIZATION
;
  %1 = getelementptr inbounds i32, ptr %x, i32 5
...
; FNATTRS-NO-SUBSCRIPT: define i1 @captureGEPICmp(ptr readnone %x)
; FNATTRS-SUBSCRIPT: define i1 @captureGEPICmp(ptr nocapture readnone %x)
...
; FIXME: after converting GEP to llvm.intel.subscript the pointer shouldn't be nocapture.
; FNATTRS-NO-SUBSCRIPT: define i1 @captureGEPICmpRev(ptr readnone %x)
; FNATTRS-SUBSCRIPT: define i1 @captureGEPICmpRev(ptr nocapture readnone %x)

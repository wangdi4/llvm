; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -wholeprogramanalysis -function-attrs -whole-program-assume -S %s | FileCheck %s --check-prefix=CHECK-TEST1
...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -wholeprogramanalysis -function-attrs -S %s | FileCheck %s --check-prefix=CHECK-TEST2
; TODO: Include the run command for the new pass manager once we fix the
; whole program analysis in the new pass manager.
...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -wholeprogramanalysis -function-attrs -whole-program-assume  -S %s | FileCheck %s --check-prefix=CHECK-TEST3
; TODO: Include the run command for the new pass manager once we fix the
; whole program analysis in the new pass manager.
...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -wholeprogramanalysis -function-attrs -whole-program-assume  -S %s | FileCheck %s --check-prefix=CHECK-TEST4
; TODO: Include the run command for the new pass manager once we fix the
; whole program analysis in the new pass manager.
...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -wholeprogramanalysis -function-attrs -whole-program-assume  -S %s | FileCheck %s --check-prefix=CHECK-TEST5
; TODO: Include the run command for the new pass manager once we fix the
; whole program analysis in the new pass manager.

...
; }
;
; CHECK: define void @callback(i8* nocapture readnone %ID, i32* nocapture %A, i32* nocapture readonly %B, i32 %N)
; CHECK: define void @foo(i32* nocapture %A, i32* nocapture readonly %B, i32 %N)

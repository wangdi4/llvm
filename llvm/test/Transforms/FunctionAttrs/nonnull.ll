...
; INTEL_CUSTOMIZATION
; RUN: opt -S -passes=function-attrs -enable-nonnull-arg-prop %s | FileCheck %s --check-prefixes=FNATTR,FNATTR-NO-SS
; RUN: opt -S -passes=convert-to-subscript %s | opt -S -passes=function-attrs -enable-nonnull-arg-prop | FileCheck %s --check-prefixes=FNATTR,FNATTR-SS
...
>>>>>>> 400fde92963588ae2b618626cb1ac73fd91c7d4d

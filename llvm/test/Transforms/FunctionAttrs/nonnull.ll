...
; INTEL_CUSTOMIZATION
; RUN: opt -S -functionattrs -enable-nonnull-arg-prop %s | FileCheck %s --check-prefixes=BOTH,FNATTR,OLD,BOTH-NO-SS,OLD-NO-SS
; RUN: opt -S -passes=function-attrs -enable-nonnull-arg-prop %s | FileCheck %s --check-prefixes=BOTH,FNATTR,OLD,BOTH-NO-SS,OLD-NO-SS
; RUN: opt -attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=5 -S < %s | FileCheck %s --check-prefixes=BOTH,OLD,ATTRIBUTOR,ATTRIBUTOR_OPM,BOTH-NO-SS,OLD-NO-SS,ATTRIBUTOR-NO-SS
; RUN: opt -passes=attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=5 -S < %s | FileCheck %s --check-prefixes=BOTH,ATTRIBUTOR,ATTRIBUTOR_NPM,BOTH-NO-SS,ATTRIBUTOR-NO-SS,ATTRIBUTOR_NPM-NO-SS

; RUN: opt -S -convert-to-subscript %s | opt -S -functionattrs -enable-nonnull-arg-prop | FileCheck %s --check-prefixes=BOTH,FNATTR,OLD,BOTH-SS,OLD-SS
; RUN: opt -S -passes=convert-to-subscript %s | opt -S -passes=function-attrs -enable-nonnull-arg-prop | FileCheck %s --check-prefixes=BOTH,FNATTR,OLD,BOTH-SS,OLD-SS
; RUN: opt -S -convert-to-subscript %s | opt -attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=5 -S | FileCheck %s --check-prefixes=BOTH,OLD,ATTRIBUTOR,ATTRIBUTOR_OPM,BOTH-SS,OLD-SS,ATTRIBUTOR-SS
; RUN: opt -S -passes=convert-to-subscript %s | opt -passes=attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=5 -S | FileCheck %s --check-prefixes=BOTH,ATTRIBUTOR,ATTRIBUTOR_NPM,BOTH-SS,ATTRIBUTOR-SS,ATTRIBUTOR_NPM-SS
...
; ATTRIBUTOR-NO-SS: define nonnull i8* @test8
; ATTRIBUTOR-SS: define i8* @test8
; end INTEL_CUSTOMIZATION
...
; ATTIRBUTOR-NO-SS: define nonnull i32* @gep1(
; ATTIRBUTOR-SS: define i32* @gep1(
; INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; BOTH-NO-SS-NEXT: [[TMP6:%.*]] = getelementptr inbounds i32, i32* [[TMP0:%.*]], i64 [[TMP5]]
; BOTH-SS-NEXT:    [[TMP6:%.*]] = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 4, i32* [[TMP0:%.*]], i64 [[TMP5]])
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; OLD-NO-SS-NEXT: [[TMP6:%.*]] = getelementptr inbounds i32, i32* [[TMP0:%.*]], i64 [[TMP5]]
; OLD-SS-NEXT:    [[TMP6:%.*]] = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 4, i32* [[TMP0:%.*]], i64 [[TMP5]])
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; ATTRIBUTOR_NPM-NO-SS-NEXT: [[TMP6:%.*]] = getelementptr inbounds i32, i32* [[TMP0:%.*]], i64 [[TMP5]]
; ATTRIBUTOR_NPM-SS-NEXT:    [[TMP6:%.*]] = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 4, i32* [[TMP0:%.*]], i64 [[TMP5]])
; end INTEL_CUSTOMIZATION
...
<<<<<<< HEAD
; INTEL_CUSTOMIZATION
; ATTRIBUTOR_NPM-NO-SS-NEXT: tail call void @sink(i32* nonnull [[TMP6]])
; ATTRIBUTOR_NPM-SS-NEXT:    tail call void @sink(i32* [[TMP6]])
; end INTEL_CUSTOMIZATION
=======
; ATTRIBUTOR_NPM-NEXT:    tail call void @sink(i32* [[TMP6]])
>>>>>>> 6ea47759008526dc11f5064b266de95c61915581

...
; RUN: opt -attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=7 -S < %s | FileCheck %s --check-prefixes=BOTH,OLD,ATTRIBUTOR,ATTRIBUTOR_OPM,BOTH-NO-SS,OLD-NO-SS,ATTRIBUTOR-NO-SS
; RUN: opt -passes=attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=7 -S < %s | FileCheck %s --check-prefixes=BOTH,ATTRIBUTOR,ATTRIBUTOR_NPM,BOTH-NO-SS,ATTRIBUTOR-NO-SS,ATTRIBUTOR_NPM-NO-SS
...
; RUN: opt -S -convert-to-subscript %s | opt -attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=8 -S | FileCheck %s --check-prefixes=BOTH,OLD,ATTRIBUTOR,ATTRIBUTOR_OPM,BOTH-SS,OLD-SS,ATTRIBUTOR-SS
; RUN: opt -S -passes=convert-to-subscript %s | opt -passes=attributor --attributor-disable=false -attributor-max-iterations-verify -attributor-annotate-decl-cs -attributor-max-iterations=8 -S | FileCheck %s --check-prefixes=BOTH,ATTRIBUTOR,ATTRIBUTOR_NPM,BOTH-SS,ATTRIBUTOR-SS,ATTRIBUTOR_NPM-SS
...
>>>>>>> f35740d6e954b4a0bc319be74ca35bdf8c10a780

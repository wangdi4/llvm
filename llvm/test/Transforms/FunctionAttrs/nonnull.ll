...
; RUN: opt -S -passes=function-attrs -enable-nonnull-arg-prop %s | FileCheck %s --check-prefixes=COMMON,FNATTRS,FNATTRS-NO-SS ;INTEL
; RUN: opt -S -passes=attributor-light %s | FileCheck %s --check-prefixes=COMMON,ATTRIBUTOR
; RUN: opt -S -passes=convert-to-subscript %s | opt -S -passes=function-attrs -enable-nonnull-arg-prop | FileCheck %s --check-prefixes=COMMON,FNATTRS,FNATTRS-SS ;INTEL
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SS-LABEL: define nonnull ptr @test8
; FNATTRS-SS-SAME: (ptr readnone [[A:%.*]]) #[[ATTR0]] {
; FNATTRS-SS-NEXT:    [[B:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 1, ptr elementtype(i8) [[A]], i64 1)
; FNATTRS-SS-NEXT:    ret ptr [[B]]
; end INTEL_CUSTOMIZATION
;
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SS-LABEL: define ptr @test9
; FNATTRS-SS-SAME: (ptr readnone [[A:%.*]], i64 [[N:%.*]]) #[[ATTR0]] {
; FNATTRS-SS-NEXT:    [[B:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 1, ptr elementtype(i8) [[A]], i64 [[N]])
; FNATTRS-SS-NEXT:    ret ptr [[B]]
; end INTEL_CUSTOMIZATION
;
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SS-LABEL: define ptr @test10
; FNATTRS-SS-SAME: (ptr readnone [[A:%.*]], i64 [[N:%.*]]) #[[ATTR3:[0-9]+]] {
; FNATTRS-SS-NEXT:    [[CMP:%.*]] = icmp ne i64 [[N]], 0
; FNATTRS-SS-NEXT:    call void @llvm.assume(i1 [[CMP]])
; FNATTRS-SS-NEXT:    [[B:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 1, ptr elementtype(i8) [[A]], i64 [[N]])
; FNATTRS-SS-NEXT:    ret ptr [[B]]
; end INTEL_CUSTOMIZATION
;
...
; FNATTRS-NO-SS:       bb1:
; FNATTRS-NO-SS-NEXT:    [[TMP2:%.*]] = load i32, ptr [[ARG]], align 4
; FNATTRS-NO-SS-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[TMP2]], 0
; FNATTRS-NO-SS-NEXT:    br i1 [[TMP3]], label [[BB6:%.*]], label [[BB4:%.*]]
; FNATTRS-NO-SS:       bb4:
; FNATTRS-NO-SS-NEXT:    [[TMP5:%.*]] = getelementptr inbounds i32, ptr [[ARG]], i64 1
; FNATTRS-NO-SS-NEXT:    [[TMP5B:%.*]] = tail call ptr @f3(ptr [[TMP5]])
; FNATTRS-NO-SS-NEXT:    [[TMP5C:%.*]] = getelementptr inbounds i32, ptr [[TMP5B]], i64 -1
; FNATTRS-NO-SS-NEXT:    br label [[BB9]]
; FNATTRS-NO-SS:       bb6:
; FNATTRS-NO-SS-NEXT:    [[TMP7:%.*]] = tail call ptr @f2(ptr [[ARG]])
; FNATTRS-NO-SS-NEXT:    ret ptr [[TMP7]]
; FNATTRS-NO-SS:       bb9:
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SS-LABEL: define internal nonnull ptr @f1
; FNATTRS-SS-SAME: (ptr readonly [[ARG:%.*]]) #[[ATTR4:[0-9]+]] {
; FNATTRS-SS-NEXT:  bb:
; FNATTRS-SS-NEXT:    [[TMP:%.*]] = icmp eq ptr [[ARG]], null
; FNATTRS-SS-NEXT:    br i1 [[TMP]], label [[BB9:%.*]], label [[BB1:%.*]]
; FNATTRS-SS:       bb1:
; FNATTRS-SS-NEXT:    [[TMP2:%.*]] = load i32, ptr [[ARG]], align 4
; FNATTRS-SS-NEXT:    [[TMP3:%.*]] = icmp eq i32 [[TMP2]], 0
; FNATTRS-SS-NEXT:    br i1 [[TMP3]], label [[BB6:%.*]], label [[BB4:%.*]]
; FNATTRS-SS:       bb4:
; FNATTRS-SS-NEXT:    [[TMP5:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 4, ptr elementtype(i32) [[ARG]], i64 1)
; FNATTRS-SS-NEXT:    [[TMP5B:%.*]] = tail call ptr @f3(ptr [[TMP5]])
; FNATTRS-SS-NEXT:    [[TMP5C:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 4, ptr elementtype(i32) [[TMP5B]], i64 -1)
; FNATTRS-SS-NEXT:    br label [[BB9]]
; FNATTRS-SS:       bb6:
; FNATTRS-SS-NEXT:    [[TMP7:%.*]] = tail call ptr @f2(ptr [[ARG]])
; FNATTRS-SS-NEXT:    ret ptr [[TMP7]]
; FNATTRS-SS:       bb9:
; FNATTRS-SS-NEXT:    [[TMP10:%.*]] = phi ptr [ [[TMP5C]], [[BB4]] ], [ inttoptr (i64 4 to ptr), [[BB:%.*]] ]
; FNATTRS-SS-NEXT:    ret ptr [[TMP10]]
; end INTEL_CUSTOMIZATION
;
bb:
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SS-LABEL: define nonnull ptr @gep1
; FNATTRS-SS-SAME: (ptr readnone [[P:%.*]]) #[[ATTR0]] {
; FNATTRS-SS-NEXT:    [[Q:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 0, i64 0, i64 4, ptr elementtype(i32) [[P]], i32 1)
; FNATTRS-SS-NEXT:    ret ptr [[Q]]
; end INTEL_CUSTOMIZATION
;
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SS-LABEL: define ptr @gep1_no_null_opt
; FNATTRS-SS-SAME: (ptr readnone [[P:%.*]]) #[[ATTR8:[0-9]+]] {
; FNATTRS-SS-NEXT:    [[Q:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 0, i64 0, i64 4, ptr elementtype(i32) [[P]], i32 1)
; FNATTRS-SS-NEXT:    ret ptr [[Q]]
; end INTEL_CUSTOMIZATION
;
...
;
; INTEL_CUSTOMIZATION
; FNATTRS-SS-LABEL: define ptr addrspace(3) @gep2
; FNATTRS-SS-SAME: (ptr addrspace(3) readnone [[P:%.*]]) #[[ATTR0]] {
; FNATTRS-SS-NEXT:    [[Q:%.*]] = call ptr addrspace(3) @llvm.intel.subscript.p3.i64.i64.p3.i32(i8 0, i64 0, i64 4, ptr addrspace(3) elementtype(i32) [[P]], i32 1)
; FNATTRS-SS-NEXT:    ret ptr addrspace(3) [[Q]]
; end INTEL_CUSTOMIZATION
;
...
; FNATTRS-NO-SS:       4:
; FNATTRS-NO-SS-NEXT:    [[TMP5:%.*]] = zext i32 [[TMP1]] to i64
; FNATTRS-NO-SS-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i32, ptr [[TMP0]], i64 [[TMP5]]
; FNATTRS-NO-SS-NEXT:    br label [[TMP8:%.*]]
; FNATTRS-NO-SS:       7:
; FNATTRS-NO-SS-NEXT:    ret void
; FNATTRS-NO-SS:       8:
; FNATTRS-NO-SS-NEXT:    [[TMP9:%.*]] = phi i32 [ 1, [[TMP4]] ], [ [[TMP10:%.*]], [[TMP8]] ]
; FNATTRS-NO-SS-NEXT:    tail call void @sink(ptr [[TMP6]])
; FNATTRS-NO-SS-NEXT:    [[TMP10]] = add nuw nsw i32 [[TMP9]], 1
; FNATTRS-NO-SS-NEXT:    [[TMP11:%.*]] = icmp eq i32 [[TMP10]], [[TMP1]]
; FNATTRS-NO-SS-NEXT:    br i1 [[TMP11]], label [[TMP7]], label [[TMP8]]
;
; ATTRIBUTOR-LABEL: define void @PR43833
; ATTRIBUTOR-SAME: (ptr [[TMP0:%.*]], i32 [[TMP1:%.*]]) {
...
; ATTRIBUTOR-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i32, ptr [[TMP0]], i64 [[TMP5]]
; ATTRIBUTOR-NEXT:    br label [[TMP8:%.*]]
; ATTRIBUTOR:       7:
; ATTRIBUTOR-NEXT:    ret void
; ATTRIBUTOR:       8:
; ATTRIBUTOR-NEXT:    [[TMP9:%.*]] = phi i32 [ 1, [[TMP4]] ], [ [[TMP10:%.*]], [[TMP8]] ]
; ATTRIBUTOR-NEXT:    tail call void @sink(ptr [[TMP6]])
...
;
; FNATTRS-SS-LABEL: define void @PR43833
; FNATTRS-SS-SAME: (ptr [[TMP0:%.*]], i32 [[TMP1:%.*]]) {
; FNATTRS-SS-NEXT:    [[TMP3:%.*]] = icmp sgt i32 [[TMP1]], 1
; FNATTRS-SS-NEXT:    br i1 [[TMP3]], label [[TMP4:%.*]], label [[TMP7:%.*]]
; FNATTRS-SS:       4:
; FNATTRS-SS-NEXT:    [[TMP5:%.*]] = zext i32 [[TMP1]] to i64
; FNATTRS-SS-NEXT:    [[TMP6:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 4, ptr elementtype(i32) [[TMP0]], i64 [[TMP5]])
; FNATTRS-SS-NEXT:    br label [[TMP8:%.*]]
; FNATTRS-SS:       7:
; FNATTRS-SS-NEXT:    ret void
; FNATTRS-SS:       8:
; FNATTRS-SS-NEXT:    [[TMP9:%.*]] = phi i32 [ 1, [[TMP4]] ], [ [[TMP10:%.*]], [[TMP8]] ]
; FNATTRS-SS-NEXT:    tail call void @sink(ptr [[TMP6]])
; FNATTRS-SS-NEXT:    [[TMP10]] = add nuw nsw i32 [[TMP9]], 1
...
; FNATTRS-NO-SS-NEXT:    br i1 [[TMP11]], label [[TMP7]], label [[TMP8]]
;
; ATTRIBUTOR-LABEL: define void @PR43833_simple
; ATTRIBUTOR-SAME: (ptr [[TMP0:%.*]], i32 [[TMP1:%.*]]) {
; ATTRIBUTOR-NEXT:    [[TMP3:%.*]] = icmp ne i32 [[TMP1]], 0
; ATTRIBUTOR-NEXT:    br i1 [[TMP3]], label [[TMP4:%.*]], label [[TMP7:%.*]]
; ATTRIBUTOR:       4:
; ATTRIBUTOR-NEXT:    [[TMP5:%.*]] = zext i32 [[TMP1]] to i64
; ATTRIBUTOR-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i32, ptr [[TMP0]], i64 [[TMP5]]
...
; ATTRIBUTOR-NEXT:    br i1 [[TMP11]], label [[TMP7]], label [[TMP8]]
;
; FNATTRS-SS-LABEL: define void @PR43833_simple
; FNATTRS-SS-SAME: (ptr [[TMP0:%.*]], i32 [[TMP1:%.*]]) {
; FNATTRS-SS-NEXT:    [[TMP3:%.*]] = icmp ne i32 [[TMP1]], 0
; FNATTRS-SS-NEXT:    br i1 [[TMP3]], label [[TMP4:%.*]], label [[TMP7:%.*]]
; FNATTRS-SS:       4:
; FNATTRS-SS-NEXT:    [[TMP5:%.*]] = zext i32 [[TMP1]] to i64
; FNATTRS-SS-NEXT:    [[TMP6:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 0, i64 4, ptr elementtype(i32) [[TMP0]], i64 [[TMP5]])

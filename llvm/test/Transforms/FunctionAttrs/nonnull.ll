...
; INTEL_CUSTOMIZATION
; RUN: opt -S -function-attrs -enable-nonnull-arg-prop %s | FileCheck %s --check-prefixes=FNATTR,FNATTR-NO-SS
; RUN: opt -S -passes=function-attrs -enable-nonnull-arg-prop %s | FileCheck %s --check-prefixes=FNATTR,FNATTR-NO-SS
; RUN: opt -S -convert-to-subscript %s | opt -S -function-attrs -enable-nonnull-arg-prop | FileCheck %s --check-prefixes=FNATTR,FNATTR-SS

...
; CHECK: %indvars.iv372 = phi i64 [ 1,
; CHECK: %"foo_$BCOX.addr_a0$_fetch.56[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %"foo_$BCOX.dim_info$.lower_bound$[]_fetch.60", i64 %"foo_$BCOX.dim_info$.spacing$[]_fetch.59", ptr elementtype(float) %"foo_$BCOX.addr_a0$_fetch.56", i64 %indvars.iv372)
; CHECK: %"foo_$ACOX.addr_a0$_fetch.37[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %"foo_$ACOX.dim_info$.lower_bound$[]_fetch.41", i64 %"foo_$ACOX.dim_info$.spacing$[]_fetch.40", ptr elementtype(float) %"foo_$ACOX.addr_a0$215_fetch.111.pre", i64 %indvars.iv372)
; CHECK: %indvars.iv = phi i64 [ 1,
; CHECK: %"foo_$ACOX.addr_a0$_fetch.37[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %"foo_$ACOX.dim_info$.lower_bound$[]_fetch.38", i64 4, ptr elementtype(float) %"foo_$ACOX.addr_a0$_fetch.37[]", i64 %indvars.iv)
; CHECK: %"foo_$BCOX.addr_a0$_fetch.56[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %"foo_$BCOX.dim_info$.lower_bound$[]_fetch.57", i64 4, ptr elementtype(float) %"foo_$BCOX.addr_a0$_fetch.56[]", i64 %indvars.iv)
; CHECK: %indvars.iv380 = phi i64 [ 1,
; CHECK: %"foo_$BCOX.addr_a0$_fetch.85[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %"foo_$BCOX.dim_info$.lower_bound$[]_fetch.60", i64 %"foo_$BCOX.dim_info$.spacing$[]_fetch.59", ptr elementtype(float) %"foo_$BCOX.addr_a0$_fetch.56", i64 %indvars.iv380)
; CHECK: %"foo_$ACOX.addr_a0$_fetch.75[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %"foo_$ACOX.dim_info$.lower_bound$[]_fetch.41", i64 %"foo_$ACOX.dim_info$.spacing$[]_fetch.40", ptr elementtype(float) %"foo_$ACOX.addr_a0$215_fetch.111.pre", i64 %indvars.iv380)
; CHECK: %indvars.iv376 = phi i64 [ 1,
; CHECK: %"foo_$ACOX.addr_a0$_fetch.75[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %"foo_$ACOX.dim_info$.lower_bound$[]_fetch.38", i64 4, ptr elementtype(float) %"foo_$ACOX.addr_a0$_fetch.75[]", i64 %indvars.iv376)
; CHECK: %"foo_$BCOX.addr_a0$_fetch.85[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %"foo_$BCOX.dim_info$.lower_bound$[]_fetch.57", i64 4, ptr elementtype(float) %"foo_$BCOX.addr_a0$_fetch.85[]", i64 %indvars.iv376)
...
alloca_0:
  ...
  %"foo_$ACOX.dim_info$.lower_bound$[]22" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.2.fca.6.0.2.gep", i32 0), !llfort.type_idx !18
  store i64 1, ptr %"foo_$ACOX.dim_info$.lower_bound$[]22", align 1, !tbaa !19
  %0 = tail call i32 @llvm.smax.i32(i32 %"foo_$N_fetch.4", i32 0)
  %slct.1 = zext i32 %0 to i64
  %"foo_$ACOX.dim_info$.extent$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.2.fca.6.0.0.gep", i32 0), !llfort.type_idx !20
  store i64 %slct.1, ptr %"foo_$ACOX.dim_info$.extent$[]", align 1, !tbaa !21
  %"foo_$ACOX.dim_info$.spacing$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.2.fca.6.0.1.gep", i32 0), !llfort.type_idx !22
  store i64 4, ptr %"foo_$ACOX.dim_info$.spacing$[]", align 1, !tbaa !23
  %mul.1 = shl nuw nsw i64 %slct.1, 2
  %"foo_$ACOX.dim_info$.lower_bound$[]28" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.2.fca.6.0.2.gep", i32 1), !llfort.type_idx !18
  store i64 1, ptr %"foo_$ACOX.dim_info$.lower_bound$[]28", align 1, !tbaa !19
  %"foo_$ACOX.dim_info$.extent$[]31" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.2.fca.6.0.0.gep", i32 1), !llfort.type_idx !20
  store i64 %slct.1, ptr %"foo_$ACOX.dim_info$.extent$[]31", align 1, !tbaa !21
  %"foo_$ACOX.dim_info$.spacing$[]34" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.2.fca.6.0.1.gep", i32 1), !llfort.type_idx !22
  store i64 %mul.1, ptr %"foo_$ACOX.dim_info$.spacing$[]34", align 1, !tbaa !23
  %func_result = call i32 (ptr, i32, ...) @for_check_mult_overflow64(ptr nonnull %"var$4", i32 3, i64 %slct.1, i64 %slct.1, i64 4) #4, !llfort.type_idx !24
  ...
  %func_result12 = call i32 @for_alloc_allocatable_handle(i64 %"var$4_fetch.6", ptr nonnull %"var$2_fetch.2.fca.0.gep", i32 %or.9, ptr null) #4, !llfort.type_idx !24
  ...
  %"foo_$BCOX.dim_info$.lower_bound$[]61" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.1.fca.6.0.2.gep", i32 0), !llfort.type_idx !18
  store i64 1, ptr %"foo_$BCOX.dim_info$.lower_bound$[]61", align 1, !tbaa !32
  %"foo_$BCOX.dim_info$.extent$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.1.fca.6.0.0.gep", i32 0), !llfort.type_idx !20
  store i64 %slct.1, ptr %"foo_$BCOX.dim_info$.extent$[]", align 1, !tbaa !33
  %"foo_$BCOX.dim_info$.spacing$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.1.fca.6.0.1.gep", i32 0), !llfort.type_idx !22
  store i64 4, ptr %"foo_$BCOX.dim_info$.spacing$[]", align 1, !tbaa !34
  %"foo_$BCOX.dim_info$.lower_bound$[]67" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.1.fca.6.0.2.gep", i32 1), !llfort.type_idx !18
  store i64 1, ptr %"foo_$BCOX.dim_info$.lower_bound$[]67", align 1, !tbaa !32
  %"foo_$BCOX.dim_info$.extent$[]70" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.1.fca.6.0.0.gep", i32 1), !llfort.type_idx !20
  store i64 %slct.1, ptr %"foo_$BCOX.dim_info$.extent$[]70", align 1, !tbaa !33
  %"foo_$BCOX.dim_info$.spacing$[]73" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %"var$2_fetch.1.fca.6.0.1.gep", i32 1), !llfort.type_idx !22
  store i64 %mul.1, ptr %"foo_$BCOX.dim_info$.spacing$[]73", align 1, !tbaa !34
  %func_result36 = call i32 (ptr, i32, ...) @for_check_mult_overflow64(ptr nonnull %"var$6", i32 3, i64 %slct.1, i64 %slct.1, i64 4) #4, !llfort.type_idx !24
  ...
  %func_result50 = call i32 @for_alloc_allocatable_handle(i64 %"var$6_fetch.16", ptr nonnull %"var$2_fetch.1.fca.0.gep", i32 %or.18, ptr null) #4, !llfort.type_idx !24
...
do.body15.preheader:                              ; preds = %alloca_0
  ...
  %1 = add nuw nsw i32 %"foo_$N_fetch.4", 1
  %wide.trip.count374 = sext i32 %1 to i64
  br label %do.body15

do.body15:                                        ; preds = %do.body15.preheader, %do.end_do20
  %indvars.iv372 = phi i64 [ 1, %do.body15.preheader ], [ %indvars.iv.next373, %do.end_do20 ]
  ...
  %"foo_$BCOX.addr_a0$_fetch.56[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %"foo_$BCOX.dim_info$.lower_bound$[]_fetch.60", i64 %"foo_$BCOX.dim_info$.spacing$[]_fetch.59", ptr elementtype(float) %"foo_$BCOX.addr_a0$_fetch.56", i64 %indvars.iv372), !llfort.type_idx !43
  br label %do.body19
...
do.body19:                                        ; preds = %do.body15, %do.body19
  ...
  %"foo_$BCOX.addr_a0$_fetch.56[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %"foo_$BCOX.dim_info$.lower_bound$[]_fetch.57", i64 4, ptr elementtype(float) %"foo_$BCOX.addr_a0$_fetch.56[]", i64 %indvars.iv), !llfort.type_idx !43
  ...
  br i1 %exitcond, label %do.end_do20, label %do.body19

do.end_do20:                                      ; preds = %do.body19
...
do.body25.preheader:                              ; preds = %do.end_do20
...
do.body25:                                        ; preds = %do.body25.preheader, %do.end_do30
  %indvars.iv380 = phi i64 [ 1, %do.body25.preheader ], [ %indvars.iv.next381, %do.end_do30 ]
...
do.body29:                                        ; preds = %do.body25, %do.body29
  ...
  %add.15 = fadd reassoc ninf nsz arcp contract afn float %"foo_$BCOX.addr_a0$_fetch.85[][]_fetch.94", %"foo_$ACOX.addr_a0$_fetch.75[][]_fetch.84"
  ...
  br i1 %exitcond379, label %do.end_do30, label %do.body29

do.end_do30:                                      ; preds = %do.body29
...
do.end_do26:                                      ; preds = %do.end_do26.loopexit, %alloca_0
  ...
  %2 = shl i32 %"foo_$ACOX.flags$217_fetch.112.tr", 1
  %or.20 = and i32 %2, 6
  %3 = lshr i32 %"foo_$ACOX.flags$217_fetch.112.tr", 3
  %int_zext223 = and i32 %3, 256
  %4 = lshr i64 %"foo_$ACOX.flags$217_fetch.112", 15
  %5 = trunc i64 %4 to i32
  %6 = and i32 %5, 65011712
  %or.21 = or i32 %int_zext223, %or.20
  %or.24 = or i32 %or.21, %6
  ...
  %func_result233 = tail call i32 @for_dealloc_allocatable_handle(ptr %"foo_$ACOX.addr_a0$215_fetch.111.pre", i32 %or.25, ptr %"(ptr)foo_$ACOX.reserved$231_fetch.113$") #4, !llfort.type_idx !24
...
bb3_endif:                                        ; preds = %do.end_do26, %bb_new36_then
  ...
  %7 = shl i32 %"foo_$BCOX.flags$246_fetch.119.tr", 1
  %or.28 = and i32 %7, 6
  %8 = lshr i32 %"foo_$BCOX.flags$246_fetch.119.tr", 3
  %int_zext252 = and i32 %8, 256
  %9 = lshr i64 %"foo_$BCOX.flags$246_fetch.119", 15
  %10 = trunc i64 %9 to i32
  %11 = and i32 %10, 65011712
  %or.29 = or i32 %int_zext252, %or.28
  %or.32 = or i32 %or.29, %11
  ...
  %func_result262 = tail call i32 @for_dealloc_allocatable_handle(ptr %"foo_$BCOX.addr_a0$244_fetch.118", i32 %or.33, ptr %"(ptr)foo_$BCOX.reserved$260_fetch.120$") #4, !llfort.type_idx !24
...
dealloc.list.then40:                              ; preds = %bb6_endif
  ...
  %12 = and i32 %"foo_$ACOX.flags$271_fetch.124.tr", 2
  %13 = or i32 %12, %and.65.tr
  %or.36 = shl nuw nsw i32 %13, 1
  %14 = lshr i32 %"foo_$ACOX.flags$271_fetch.124.tr", 3
  %int_zext281 = and i32 %14, 256
  %or.37 = or i32 %or.36, %int_zext281
  %15 = lshr i64 %"foo_$ACOX.flags$271_fetch.124", 15
  %16 = trunc i64 %15 to i32
  %17 = and i32 %16, 65011712
  %and.78 = or i32 %or.37, %17
  %or.41 = or i32 %and.78, 262144
  %func_result291 = tail call i32 @for_dealloc_allocatable_handle(ptr %"foo_$ACOX.addr_a0$273_fetch.125", i32 %or.41, ptr %"(ptr)foo_$ACOX.reserved$231_fetch.113$") #4, !llfort.type_idx !24
...
dealloc.list.then45:                              ; preds = %dealloc.list.end41
  ...
  %18 = shl i32 %"foo_$BCOX.flags$298_fetch.130.tr", 1
  %int_zext304 = and i32 %18, 4
  %19 = lshr i32 %"foo_$BCOX.flags$298_fetch.130.tr", 3
  %int_zext308 = and i32 %19, 256
  %20 = lshr i64 %"foo_$BCOX.flags$298_fetch.130", 15
  %21 = trunc i64 %20 to i32
  %22 = and i32 %21, 65011712
  %or.43 = or i32 %int_zext308, %int_zext304
  %or.46 = or i32 %or.43, %22
  %or.48 = or i32 %or.46, 262146
  %func_result318 = tail call i32 @for_dealloc_allocatable_handle(ptr %"foo_$BCOX.addr_a0$300_fetch.131", i32 %or.48, ptr %"(ptr)foo_$BCOX.reserved$260_fetch.120$") #4, !llfort.type_idx !24
...
attributes #0 = { nounwind uwtable "denormal-fp-math"="preserve_sign" "frame-pointer"="none" "intel-lang"="fortran" "loopopt-pipeline"="light" "min-legal-vector-width"="0" "pre_loopopt" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" }

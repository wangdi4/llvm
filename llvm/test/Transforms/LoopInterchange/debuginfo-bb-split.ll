...
; instruction at the end of the new basic block gets the
; source location of the first non-debug-intrinsic-call
; instruction following the debug intrinsic call.
...
!15 = !DILocation(line: 2, column: 27, scope: !5)

; CHECK: for2.preheader:
; CHECK-NEXT: br label %for2, !dbg [[SRC_LOC:![0-9]+]]

; CHECK: for2:
; CHECK-NEXT: %j = phi i64
; CHECK-NEXT: br label %for1.header.preheader, !dbg [[SRC_LOC]]

; CHECK: [[SRC_LOC]] = !DILocation(line: 2

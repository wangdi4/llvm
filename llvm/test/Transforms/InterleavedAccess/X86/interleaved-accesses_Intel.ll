...
; RUN: opt -opaque-pointers=0 < %s -mtriple=x86_64-pc-linux -mattr=+avx -interleaved-access -S | FileCheck %s --check-prefix=AVX2
; RUN: opt -opaque-pointers=0 < %s -mtriple=x86_64-pc-linux -mattr=+avx2 -interleaved-access -S | FileCheck %s --check-prefix=AVX2
; RUN: opt -opaque-pointers=0 < %s -mtriple=x86_64-pc-linux -mattr=+avx512f -mattr=+avx512bw -mattr=+avx512vl -interleaved-access -S | FileCheck %s --check-prefix=AVX2

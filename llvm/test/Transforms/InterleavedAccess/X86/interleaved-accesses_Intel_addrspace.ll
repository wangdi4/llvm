...
define <8 x i32> @interleaved_load_vf8_i32_stride4(<32 x i32> addrspace(1)* %ptr){
; CHECK-LABEL: @interleaved_load_vf8_i32_stride4(
; CHECK-NEXT:    bitcast <32 x i32> addrspace(1)* %ptr to <4 x i32> addrspace(1)*
  %wide.vec = load <32 x i32>, <32 x i32> addrspace(1)* %ptr, align 16
...
define void @interleaved_store_vf8_i32_stride4(<8 x i32> %a0,<8 x i32> %b0,<8 x i32> %c0,<8 x i32> %d0,<32 x i32> addrspace(1)* %ptr){
; CHECK-LABEL: @interleaved_store_vf8_i32_stride4(
; CHECK:        bitcast <32 x i32> addrspace(1)* %ptr to <4 x i32> addrspace(1)*
  ...
  store <32 x i32> %interleave.vec, <32 x i32> addrspace(1)* %ptr, align 16
  ret void
}

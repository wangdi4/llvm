...
; CHECK:  %i[[V0:[0-9]+]] = load ptr, ptr %vfn.i, align 8
; CHECK:  %call.i[[V3:[0-9]+]] = tail call zeroext i1 %i[[V0]](ptr %i[[V1:[0-9]+]], ptr nonnull %call.i[[V2:[0-9]+]], i32 10)
...
; CHECK: %i[[I1:[0-9]+]] = bitcast ptr @_ZN7Derived3fooEPvi to ptr
; CHECK: %i[[I2:[0-9]+]] = icmp eq ptr %i, %i[[I1]]
...
; CHECK:   %i[[I3:[0-9]+]] = tail call zeroext i1 @_ZN7Derived3fooEPvi(ptr %A, i32 %Size)
; CHECK:   br label %MergeBB

; CHECK: BBDevirt__ZN8Derived23fooEPvi:
; CHECK:   %i[[I4:[0-9]+]] = tail call zeroext i1 @_ZN8Derived23fooEPvi(ptr %A, i32 %Size)
; CHECK:   br label %MergeBB

...
@vt2 = constant [1 x i8*] [i8* bitcast (void (i8*, i8*)* @_ZNSt13my_runtime_errorC1EPKc to i8*)], !type !8

declare void @_ZNSt13runtime_errorC1EPKc(i8*, i8*)
declare void @_ZNSt13my_runtime_errorC1EPKc(i8*, i8*)
...
; CHECK: br i1 [[T3]], label %BBDevirt__ZNSt13runtime_errorC1EPKc, label %ElseDevirt__ZNSt13runtime_errorC1EPKc
...
; Check that the branching to _ZNSt13my_runtime_errorC1EPKc is generated
; CHECK: [[T4:%[^ ]*]] = bitcast void (i8*, i8*)* @_ZNSt13my_runtime_errorC1EPKc to i8*
; CHECK: [[T5:%[^ ]*]] = icmp eq i8* [[T1]], [[T4]]
; CHECK: br i1 [[T5]], label %BBDevirt__ZNSt13my_runtime_errorC1EPKc, label %DefaultBB

; Check that the call to _ZNSt13my_runtime_errorC1EPKc is generated
; CHECK: call void @_ZNSt13my_runtime_errorC1EPKc(i8* %obj, i8* %alloc)
; CHECK: br label %MergeBB

...
@vt2 = constant [1 x ptr] [ptr bitcast (ptr @_ZNSt13my_runtime_errorC1EPKc to ptr)], !type !8

declare void @_ZNSt13runtime_errorC1EPKc(ptr, ptr)
declare void @_ZNSt13my_runtime_errorC1EPKc(ptr, ptr)
...
; CHECK: [[T4:%[^ ]*]] = bitcast ptr @_ZNSt13my_runtime_errorC1EPKc to ptr
...
; CHECK: call void @_ZNSt13my_runtime_errorC1EPKc(ptr %obj, ptr %alloc)
; CHECK: br label %MergeBB

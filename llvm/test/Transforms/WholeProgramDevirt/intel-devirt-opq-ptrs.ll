...
; RUN: opt -opaque-pointers -S -wholeprogramdevirt-downcasting-filter -wholeprogramdevirt -whole-program-assume %s | FileCheck %s
; RUN: opt -opaque-pointers -S -wholeprogramdevirt-downcasting-filter -passes=wholeprogramdevirt -whole-program-assume %s | FileCheck %s

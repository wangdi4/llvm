...
; RUN: opt < %s -xmain-enable-gep0-removal -passes='default<O2>' -S | FileCheck %s ;INTEL
...
; CHECK-LABEL: @main(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    tail call void @print(i32 4) ;INTEL
; CHECK-NEXT:    tail call void @print(i32 5) ;INTEL
; CHECK-NEXT:    tail call void @print(i32 6) ;INTEL

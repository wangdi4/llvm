...
; INTEL_CUSTOMIZATION
; We run SROA after unrolling now: it cleans up a lot of the stuff that
; was here. As with many "-O2" tests, if this fails again, just run
; update_test_checks.py on it.
...
>>>>>>> 1b7089fe67b924bdd5ecef786a34bdba7a88778f

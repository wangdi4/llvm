...
; instructions
;
; RUN: opt -opaque-pointers < %s -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -multiversioning -multiversioning-threshold=2 -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers < %s -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -passes=multiversioning -multiversioning-threshold=2 -S 2>&1 | FileCheck %s

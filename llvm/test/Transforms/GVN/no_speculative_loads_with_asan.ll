...
<<<<<<< HEAD
; RUN: opt -xmain-enable-gep0-removal -O3 -S %s | FileCheck %s ;INTEL
=======
; RUN: opt -passes=gvn -S %s | FileCheck %s
>>>>>>> 2774984e6d254dc10ed95da863e801f0f0f34b34
...
; CHECK-NEXT:    br i1 [[I4]], label [[BB10:%.*]], label [[BB5:%.*]]
; CHECK:       bb5:
; CHECK-NEXT:    [[I6:%.*]] = getelementptr inbounds i16, ptr [[I]], i64 1 ;INTEL

...
define hidden i32 @lzma_mf_bt2_find(%struct.lzma_mf_s* nocapture %0, %struct.lzma_match* %1) #0 {
  ...
  %7 = sub i32 %6, %4
  %8 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 18, !intel-tbaa !17
...
13:                                               ; preds = %11
  %14 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 20, !intel-tbaa !18
...
17:                                               ; preds = %13, %11
  %18 = add i32 %4, 1
  store i32 %18, i32* %3, align 8, !tbaa !7
  %19 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 9, !intel-tbaa !19
...
22:                                               ; preds = %13, %2
  ...
  %28 = getelementptr inbounds i8, i8* %26, i64 %27, !intel-tbaa !21
  %29 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 4, !intel-tbaa !22
  %30 = load i32, i32* %29, align 4, !tbaa !22
  %31 = add i32 %30, %4
  %32 = load i8, i8* %28, align 1, !tbaa !21
  ...
  %38 = or i64 %37, %33
  %39 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 12, !intel-tbaa !23
  %40 = load i32*, i32** %39, align 8, !tbaa !23
  %41 = getelementptr inbounds i32, i32* %40, i64 %38
  %42 = load i32, i32* %41, align 4, !tbaa !24
  store i32 %31, i32* %41, align 4, !tbaa !24
  %43 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 17, !intel-tbaa !25
  %44 = load i32, i32* %43, align 4, !tbaa !25
  %45 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 13, !intel-tbaa !26
  %46 = load i32*, i32** %45, align 8, !tbaa !26
  %47 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 14, !intel-tbaa !27
  %48 = load i32, i32* %47, align 8, !tbaa !27
  %49 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 15, !intel-tbaa !28
  %50 = load i32, i32* %49, align 4, !tbaa !28
  %51 = shl i32 %48, 1
  %52 = zext i32 %51 to i64
  %53 = getelementptr inbounds i32, i32* %46, i64 %52, !intel-tbaa !24
  %54 = getelementptr inbounds i32, i32* %53, i64 1, !intel-tbaa !24
  %55 = sub i32 %31, %42
  %56 = icmp ne i32 %44, 0
...
61:                                               ; preds = %134, %22
  %62 = phi %struct.lzma_match* [ %1, %22 ], [ %123, %134 ]
  %63 = phi i32* [ %54, %22 ], [ %135, %134 ]
  %64 = phi i32* [ %53, %22 ], [ %136, %134 ]
  store i32 0, i32* %63, align 4, !tbaa !24
...
65:                                               ; preds = %134, %59
  ...
  %71 = phi i32* [ %136, %134 ], [ %53, %59 ]
  %72 = phi i32* [ %135, %134 ], [ %54, %59 ]
  %73 = phi i32 [ %124, %134 ], [ 1, %59 ]
  %74 = phi %struct.lzma_match* [ %123, %134 ], [ %1, %59 ]
  %75 = add i32 %66, -1
  %76 = sub i32 %48, %67
  ...
  %82 = getelementptr inbounds i32, i32* %46, i64 %81, !intel-tbaa !24
  %83 = zext i32 %67 to i64
  %84 = sub nsw i64 0, %83
  %85 = getelementptr inbounds i8, i8* %28, i64 %84, !intel-tbaa !21
  %86 = icmp ult i32 %70, %69
  %87 = select i1 %86, i32 %70, i32 %69
  %88 = zext i32 %87 to i64
  %89 = getelementptr inbounds i8, i8* %85, i64 %88
  %90 = load i8, i8* %89, align 1, !tbaa !21
  %91 = getelementptr inbounds i8, i8* %28, i64 %88
...
103:                                              ; preds = %99
  %104 = getelementptr inbounds %struct.lzma_match, %struct.lzma_match* %74, i64 0, i32 0, !intel-tbaa !29
  store i32 %100, i32* %104, align 4, !tbaa !29
  %105 = add i32 %67, -1
  %106 = getelementptr inbounds %struct.lzma_match, %struct.lzma_match* %74, i64 0, i32 1, !intel-tbaa !31
  store i32 %105, i32* %106, align 4, !tbaa !31
  %107 = getelementptr inbounds %struct.lzma_match, %struct.lzma_match* %74, i64 1
  br label %121
...
108:                                              ; preds = %97
  ...
  %110 = phi i32* [ %71, %97 ]
  %111 = phi i32* [ %72, %97 ]
  %112 = phi %struct.lzma_match* [ %74, %97 ]
  %113 = phi i32* [ %82, %97 ]
  %114 = getelementptr inbounds %struct.lzma_match, %struct.lzma_match* %112, i64 0, i32 0, !intel-tbaa !29
  store i32 %23, i32* %114, align 4, !tbaa !29
  %115 = add i32 %109, -1
  %116 = getelementptr inbounds %struct.lzma_match, %struct.lzma_match* %112, i64 0, i32 1, !intel-tbaa !31
  store i32 %115, i32* %116, align 4, !tbaa !31
  %117 = getelementptr inbounds %struct.lzma_match, %struct.lzma_match* %112, i64 1
  %118 = load i32, i32* %113, align 4, !tbaa !24
  store i32 %118, i32* %110, align 4, !tbaa !24
  %119 = getelementptr inbounds i32, i32* %113, i64 1
  %120 = load i32, i32* %119, align 4, !tbaa !24
  store i32 %120, i32* %111, align 4, !tbaa !24
  br label %145

121:                                              ; preds = %103, %99, %97, %65
  %122 = phi i64 [ %101, %103 ], [ %101, %99 ], [ %88, %65 ], [ %60, %97 ]
  %123 = phi %struct.lzma_match* [ %107, %103 ], [ %74, %99 ], [ %74, %65 ], [ %74, %97 ]
  %124 = phi i32 [ %100, %103 ], [ %73, %99 ], [ %73, %65 ], [ %73, %97 ]
  %125 = phi i32 [ %100, %103 ], [ %100, %99 ], [ %87, %65 ], [ %23, %97 ]
  %126 = getelementptr inbounds i8, i8* %85, i64 %122
  %127 = load i8, i8* %126, align 1, !tbaa !21
  %128 = getelementptr inbounds i8, i8* %28, i64 %122
  %129 = load i8, i8* %128, align 1, !tbaa !21
  %130 = icmp ult i8 %127, %129
  br i1 %130, label %131, label %133

131:                                              ; preds = %121
  store i32 %68, i32* %71, align 4, !tbaa !24
  %132 = getelementptr inbounds i32, i32* %82, i64 1, !intel-tbaa !24
  br label %134

133:                                              ; preds = %121
  store i32 %68, i32* %72, align 4, !tbaa !24
  br label %134

134:                                              ; preds = %133, %131
  %135 = phi i32* [ %72, %131 ], [ %82, %133 ]
  %136 = phi i32* [ %132, %131 ], [ %71, %133 ]
  %137 = phi i32 [ %70, %131 ], [ %125, %133 ]
  %138 = phi i32 [ %125, %131 ], [ %69, %133 ]
  %139 = phi i32* [ %132, %131 ], [ %82, %133 ]
...
145:                                              ; preds = %108, %61
  %146 = phi %struct.lzma_match* [ %117, %108 ], [ %62, %61 ]
  %147 = ptrtoint %struct.lzma_match* %146 to i64
  %148 = ptrtoint %struct.lzma_match* %1 to i64
  %149 = sub i64 %147, %148
  %150 = lshr exact i64 %149, 3
  %151 = trunc i64 %150 to i32
  %152 = load i32, i32* %47, align 8, !tbaa !27
  %153 = add i32 %152, 1
  %154 = load i32, i32* %49, align 4, !tbaa !28
  %155 = icmp eq i32 %153, %154
  %156 = select i1 %155, i32 0, i32 %153
  store i32 %156, i32* %47, align 8
  %157 = load i32, i32* %3, align 8, !tbaa !7
  %158 = add i32 %157, 1
  store i32 %158, i32* %3, align 8, !tbaa !7
  %159 = load i32, i32* %29, align 4, !tbaa !22
  %160 = add i32 %159, %158
...
162:                                              ; preds = %145
  %163 = xor i32 %154, -1
  %164 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 21, !intel-tbaa !32
  %165 = load i32, i32* %164, align 4, !tbaa !32
  %166 = getelementptr inbounds %struct.lzma_mf_s, %struct.lzma_mf_s* %0, i64 0, i32 22, !intel-tbaa !33
...
177:                                              ; preds = %313, %162
  ...
  %179 = sub i32 %178, %163
  store i32 %179, i32* %29, align 4, !tbaa !22
  br label %180
...
182:                                              ; preds = %94
  %183 = load i32, i32* @__Intel_PaddedMallocCounter, align 4
  %184 = icmp ult i32 %183, 250
  %185 = add i32 %87, 1
  %186 = zext i32 %185 to i64
  %187 = getelementptr inbounds i8, i8* %85, i64 %186
  %188 = load i8, i8* %187, align 1, !tbaa !21
  %189 = add i32 %87, 1
  %190 = zext i32 %189 to i64
  %191 = getelementptr inbounds i8, i8* %28, i64 %190
...
210:                                              ; preds = %234, %207
  ...
  %216 = load <32 x i8>, <32 x i8>* %215, align 1, !tbaa !21
  %217 = add i32 %189, %211
  %218 = zext i32 %217 to i64
  %219 = getelementptr inbounds i8, i8* %28, i64 %218
  %220 = bitcast i8* %219 to <32 x i8>*
  %221 = load <32 x i8>, <32 x i8>* %220, align 1, !tbaa !21
...
250:                                              ; preds = %265, %245
  ...
  %254 = getelementptr inbounds i8, i8* %85, i64 %253
  %255 = load i8, i8* %254, align 1, !tbaa !21
  %256 = add i32 %189, %251
  %257 = zext i32 %256 to i64
  %258 = getelementptr inbounds i8, i8* %28, i64 %257
...
271:                                              ; preds = %271, %268
  ...
  %273 = getelementptr inbounds i32, i32* %40, i64 %272
  %274 = bitcast i32* %273 to <8 x i32>*
  %275 = load <8 x i32>, <8 x i32>* %274, align 4, !tbaa !24
  %276 = sub i32 0, %154
  %277 = add i32 %276, -1
  ...
  %287 = getelementptr inbounds i32, i32* %40, i64 %272
  %288 = bitcast i32* %287 to <8 x i32>*
  %289 = add <8 x i32> %275, %286
  store <8 x i32> %289, <8 x i32>* %288, align 4, !tbaa !24
...
302:                                              ; preds = %302, %297
  ...
  %305 = load i32, i32* %304, align 4, !tbaa !24
  %306 = getelementptr inbounds i32, i32* %40, i64 %303
  %307 = sub i32 -1, %154
  %308 = call i32 @llvm.umin.i32(i32 %305, i32 %307)
  %309 = sub i32 0, %308
  %310 = add i32 %305, %309
  store i32 %310, i32* %306, align 4, !tbaa !24
  %311 = add nuw nsw i64 %303, 1
  %312 = icmp ne i64 %303, %301
  br i1 %312, label %302, label %313, !llvm.loop !41

313:                                              ; preds = %302, %292
  %314 = load i32, i32* %29, align 4, !tbaa !22
  br label %177
}
...
define i1 @__Intel_PaddedMallocInterface() local_unnamed_addr #37 !dtrans.paddedmallocsize !1277 {
...
attributes #0 = { nofree nosync nounwind uwtable "denormal-fp-math"="preserve-sign,preserve-sign" "denormal-fp-math-f32"="ieee,ieee" "frame-pointer"="none" "loopopt-pipeline"="full" "min-legal-vector-width"="0" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="skylake-avx512" "target-features"="+adx,+aes,+avx,+avx2,+avx512bw,+avx512cd,+avx512dq,+avx512f,+avx512vl,+bmi,+bmi2,+clflushopt,+clwb,+crc32,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+pku,+popcnt,+prfchw,+rdrnd,+rdseed,+sahf,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves" "unsafe-fp-math"="true" }

...
; CHECK-NEXT:    [[TMP1:%.*]] = load i1, ptr [[A]], align 1 ;INTEL
; CHECK-NEXT:    ret i1 [[TMP1]] ;INTEL
;
entry:
...
; CHECK-NEXT:    [[TMP1:%.*]] = load i8, ptr [[A]], align 1 ;INTEL
; CHECK-NEXT:    ret i8 [[TMP1]] ;INTEL
;
entry:
...
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4 ;INTEL
...
; CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[A]], align 4 ;INTEL
; CHECK-NEXT:    ret float [[TMP1]] ;INTEL
;
entry:

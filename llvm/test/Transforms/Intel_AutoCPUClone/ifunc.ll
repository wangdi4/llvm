...
; CHECK-NOT: @resolver = ifunc i32 (...)* (), i32 (...)* ()* ()* @resolver.resolver


target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@foo = dso_local ifunc i32 (...), i32 (...)* ()* @resolver
...
; Function Attrs: nounwind uwtable
define dso_local i32 (...)* @resolver() #0 !llvm.auto.cpu.dispatch !3 {
entry:
  ret i32 (...)* bitcast (i32 ()* @f1 to i32 (...)*)
}

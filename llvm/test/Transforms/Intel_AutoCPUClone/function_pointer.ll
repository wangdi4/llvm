...
; This lit test checks that function pointers (i.e. declared and defined locally)
; to multiversioned functions are initialized to the correct versions.
;
...
define dso_local i32 @main() #0 !llvm.auto.cpu.dispatch !3 {
entry:
  %fptr = alloca void (...)*, align 8
  store void (...)* bitcast (void ()* @empty to void (...)*), void (...)** %fptr, align 8, !tbaa !6
  %0 = load void (...)*, void (...)** %fptr, align 8, !tbaa !6
  call void (...) %0()
  ret i32 0
}

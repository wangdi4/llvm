...
; CHECK-NOT: define dso_local noundef i32 @_Z11calledFromLoopFnii(
; CHECK-DAG: @_Z11calledFromLoopFnii.A
; CHECK-DAG: @_Z11calledFromLoopFnii.a
; CHECK-DAG: @_Z11calledFromLoopFnii.resolver
...
define dso_local noundef i32 @_Z11calledFromLoopFnii(i32 noundef %sum, i32 noundef %i) local_unnamed_addr #0 !llvm.auto.cpu.dispatch !0 {
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %call = tail call noundef i32 @_Z11calledFromLoopFnii(i32 noundef %sum.07, i32 noundef %0)

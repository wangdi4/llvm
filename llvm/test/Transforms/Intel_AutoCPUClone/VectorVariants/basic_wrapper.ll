...
; CHECK:      define internal void @__intel.acd.resolver() #4 {
...
; CHECK-NEXT:   store ptr @_ZGVZN16vv_func.l, ptr @_ZGVZN16vv_func.ptr, align 8
...
; CHECK-NEXT:   store ptr @_ZGVZN16vv_func.a, ptr @_ZGVZN16vv_func.ptr, align 8
; CHECK-NEXT:   br label %resolver_exit
; CHECK-EMPTY:
; CHECK-NEXT: resolver_else5:                                   ; preds = %resolver_else
; CHECK-NEXT:   br label %resolver_exit
; CHECK-EMPTY:
; CHECK-NEXT: resolver_exit:                                    ; preds = %resolver_else5, %resolver_return4, %resolver_return
; CHECK-NEXT:   ret void
; CHECK-NEXT: }
; CHECK-EMPTY:

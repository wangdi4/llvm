...
define weak_odr dso_local i32 @_Z3foo_weak_odrv(i32 %a) !llvm.auto.arch !3 {
entry:
  ret i32 %a
}

define weak dso_local i32 @_Z3foo_weakv(i32 %a) !llvm.auto.arch !3 {
entry:
  ret i32 %a
}

define linkonce dso_local i32 @_Z3foo_linkoncev(i32 %a) !llvm.auto.arch !3 {
entry:
  ret i32 %a
}

define linkonce_odr dso_local i32 @_Z3foo_linkonce_odrv(i32 %a) !llvm.auto.arch !3 {
entry:
  ret i32 %a
}

...
define dso_local noundef i32 @_Z11intrinsicFnii(i32 noundef %sum, i32 noundef %i) local_unnamed_addr #0 !llvm.auto.arch !0 {
entry:
...
define dso_local noundef i32 @_Z6loopFnv() local_unnamed_addr #1 !llvm.auto.arch !0 {
entry:
  br label %for.body
...
define dso_local noundef i32 @_Z6noneFnv() local_unnamed_addr #2 !llvm.auto.arch !0 {
entry:

...
define dso_local void @TransitivelyCalledFn() local_unnamed_addr #0 !llvm.auto.arch !3 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @DirectlyCalledFn() local_unnamed_addr #0 !llvm.auto.arch !3 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @Loop2Fn(i32 noundef %N) local_unnamed_addr #0 !llvm.auto.arch !3 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Loop1Fn(i32 noundef %N) local_unnamed_addr #0 !llvm.auto.arch !3 {
entry:
  br label %for.cond

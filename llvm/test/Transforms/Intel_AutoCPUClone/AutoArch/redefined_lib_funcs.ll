...
define dso_local ptr @strcpy(ptr noundef %s, ptr noundef %t) !llvm.auto.arch !3 {
entry:
  ret ptr %s
}

define dso_local i32 @strcmp(ptr noundef %s, ptr noundef %t) !llvm.auto.arch !3 {
entry:
  ret i32 0
}

define dso_local i64 @strlen(ptr noundef %s) !llvm.auto.arch !3 {
entry:
  ret i64 0
}

define dso_local void @reverse(ptr noundef %s) !llvm.auto.arch !3 {
entry:
  ret void
}

define dso_local i32 @main() !llvm.auto.arch !3 {
entry:
  ret i32 0
}

...
; RUN: opt -opaque-pointers=0 < %s -bugpoint-enable-legacy-pm -fold-loads-to-gather -S -mtriple=x86_64-- -mcpu=skylake | FileCheck %s --check-prefixes=CHECK
...
; CHECK-NEXT:    [[I3:%.*]] = call <4 x i32> @llvm.masked.gather.v4i32.v4p1i32(<4 x i32 addrspace(1)*> [[TMP1]], i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i32> poison)
...
; CHECK-NEXT:    [[I3:%.*]] = call <4 x i32> @llvm.masked.gather.v4i32.v4p1i32(<4 x i32 addrspace(1)*> [[TMP2]], i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i32> poison)
; CHECK-NEXT:    ret <4 x i32> [[I3]]
;
  %E0 = extractelement <4 x i32> %offset, i64 0
...
; CHECK-NEXT:    [[I3:%.*]] = call <4 x double> @llvm.masked.gather.v4f64.v4p1f64(<4 x double addrspace(1)*> [[TMP1]], i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x double> poison)
...
; CHECK-NEXT:    [[I3:%.*]] = call <4 x double> @llvm.masked.gather.v4f64.v4p1f64(<4 x double addrspace(1)*> [[TMP2]], i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x double> poison)
; CHECK-NEXT:    ret <4 x double> [[I3]]
;
  %E0 = extractelement <4 x i32> %offset, i64 0
  %Ext0 = zext i32 %E0 to i64

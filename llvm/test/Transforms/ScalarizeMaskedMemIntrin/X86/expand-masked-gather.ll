...
define <2 x i64> @scalarize_v2i64_var_mask_gep(i64* %p, <2 x i64> %passthru, <2 x i1> %mask) {
...
;
  ...
  %vptr1 = shufflevector <2 x i64*> %vptr0, <2 x i64*> undef, <2 x i32> zeroinitializer
  %vptr2 = getelementptr i64, <2 x i64*> %vptr1, <2 x i64> <i64 0, i64 2>
  %ret = call <2 x i64> @llvm.masked.gather.v2i64.v2p0i64(<2 x i64*> %vptr2, i32 8, <2 x i1> %mask, <2 x i64> %passthru)
  ret <2 x i64> %ret
}

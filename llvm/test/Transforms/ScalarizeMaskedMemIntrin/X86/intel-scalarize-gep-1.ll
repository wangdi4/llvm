...
; RUN: opt -opaque-pointers=0 -S -passes=scalarize-masked-mem-intrin -mtriple=x86_64-unknown-unknown -mattr=+avx2 < %s | FileCheck %s
...
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i16, i16* [[TMP5]], i32 1
; CHECK-NEXT:    [[TMP7:%.*]] = load i16, i16* [[TMP6]], align 2
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i16, i16* [[TMP8]], i32 2
; CHECK-NEXT:    [[TMP10:%.*]] = load i16, i16* [[TMP9]], align 2
; CHECK-NEXT:    [[TMP11:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr i16, i16* [[TMP11]], i32 3
; CHECK-NEXT:    [[TMP13:%.*]] = load i16, i16* [[TMP12]], align 2
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr i16, i16* [[TMP14]], i32 4
; CHECK-NEXT:    [[TMP16:%.*]] = load i16, i16* [[TMP15]], align 2
; CHECK-NEXT:    [[TMP17:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr i16, i16* [[TMP17]], i32 5
; CHECK-NEXT:    [[TMP19:%.*]] = load i16, i16* [[TMP18]], align 2
; CHECK-NEXT:    [[TMP20:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP21:%.*]] = getelementptr i16, i16* [[TMP20]], i32 6
; CHECK-NEXT:    [[TMP22:%.*]] = load i16, i16* [[TMP21]], align 2
; CHECK-NEXT:    [[TMP23:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr i16, i16* [[TMP23]], i32 7
; CHECK-NEXT:    [[TMP25:%.*]] = load i16, i16* [[TMP24]], align 2
; CHECK-NEXT:    [[TMP26:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr i16, i16* [[TMP26]], i32 8
; CHECK-NEXT:    [[TMP28:%.*]] = load i16, i16* [[TMP27]], align 2
; CHECK-NEXT:    [[TMP29:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP30:%.*]] = getelementptr i16, i16* [[TMP29]], i32 9
; CHECK-NEXT:    [[TMP31:%.*]] = load i16, i16* [[TMP30]], align 2
; CHECK-NEXT:    [[TMP32:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP33:%.*]] = getelementptr i16, i16* [[TMP32]], i32 10
; CHECK-NEXT:    [[TMP34:%.*]] = load i16, i16* [[TMP33]], align 2
; CHECK-NEXT:    [[TMP35:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP36:%.*]] = getelementptr i16, i16* [[TMP35]], i32 11
; CHECK-NEXT:    [[TMP37:%.*]] = load i16, i16* [[TMP36]], align 2
; CHECK-NEXT:    [[TMP38:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP39:%.*]] = getelementptr i16, i16* [[TMP38]], i32 12
; CHECK-NEXT:    [[TMP40:%.*]] = load i16, i16* [[TMP39]], align 2
; CHECK-NEXT:    [[TMP41:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP42:%.*]] = getelementptr i16, i16* [[TMP41]], i32 13
; CHECK-NEXT:    [[TMP43:%.*]] = load i16, i16* [[TMP42]], align 2
; CHECK-NEXT:    [[TMP44:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP45:%.*]] = getelementptr i16, i16* [[TMP44]], i32 14
; CHECK-NEXT:    [[TMP46:%.*]] = load i16, i16* [[TMP45]], align 2
; CHECK-NEXT:    [[TMP47:%.*]] = bitcast <16 x i16>* [[TMP0]] to i16*
; CHECK-NEXT:    [[TMP48:%.*]] = getelementptr i16, i16* [[TMP47]], i32 15
; CHECK-NEXT:    [[TMP49:%.*]] = load i16, i16* [[TMP48]], align 2
; CHECK-NEXT:    [[TMP50:%.*]] = sext i16 [[TMP4]] to i64
; CHECK-NEXT:    [[TMP51:%.*]] = add i64 [[TMP50]], 32768
; CHECK-NEXT:    [[PTR0:%.*]] = getelementptr i16, i16* [[MAP:%.*]], i64 [[TMP51]]
...
; CHECK-NEXT:    [[PTR1:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP53]]
...
; CHECK-NEXT:    [[PTR2:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP55]]
...
; CHECK-NEXT:    [[PTR3:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP57]]
...
; CHECK-NEXT:    [[PTR4:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP59]]
...
; CHECK-NEXT:    [[PTR5:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP61]]
...
; CHECK-NEXT:    [[PTR6:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP63]]
...
; CHECK-NEXT:    [[PTR7:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP65]]
...
; CHECK-NEXT:    [[PTR8:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP67]]
...
; CHECK-NEXT:    [[PTR9:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP69]]
...
; CHECK-NEXT:    [[PTR10:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP71]]
...
; CHECK-NEXT:    [[PTR11:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP73]]
...
; CHECK-NEXT:    [[PTR12:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP75]]
...
; CHECK-NEXT:    [[PTR13:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP77]]
...
; CHECK-NEXT:    [[PTR14:%.*]] = getelementptr i16, i16* [[MAP]], i64 [[TMP79]]

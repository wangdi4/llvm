...
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast <2 x i64>* [[INDEX_PTR]] to i64*
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i64, i64* [[TMP3]], i32 1
; CHECK-NEXT:    [[TMP5:%.*]] = load i64, i64* [[TMP4]], align 8
; CHECK-NEXT:    [[TMP6:%.*]] = add i64 [[TMP2]], 0
; CHECK-NEXT:    [[PTR0:%.*]] = getelementptr [10240 x [10240 x i32]], [10240 x [10240 x i32]]* @a, i64 0, i64 [[TMP6]], i64 0
; CHECK-NEXT:    [[LOAD0:%.*]] = load i32, i32* [[PTR0]], align 4
; CHECK-NEXT:    [[RES0:%.*]] = insertelement <2 x i32> undef, i32 [[LOAD0]], i64 0

...
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>" -disable-output -vplan-force-vf=4 -vplan-print-after-ssa-deconstruction < %s 2>&1 | FileCheck %s
;
...
; CHECK:               + DO i1 = 80, 81, 1  <DO_LOOP> <vector-remainder> <novectorize>
; CHECK-NEXT:          |   (%lp)[i1] = i1;
; CHECK-NEXT:          + END LOOP

...
;RUN: opt -disable-output -VPlanDriver -vplan-print-after-cfg-merge -vplan-enable-peeling -vplan-enable-new-cfg-merge -vplan-print-vec-scenario < %s 2>&1 | FileCheck %s

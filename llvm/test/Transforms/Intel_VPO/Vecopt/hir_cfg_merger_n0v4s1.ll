...
; RUN: opt -passes=hir-ssa-deconstruction,hir-vplan-vec -vplan-print-after-create-in-merge -vplan-print-after-cfg-merge -vplan-vec-scenario="n0;v4;s1" -disable-output < %s 2>&1 | FileCheck %s
...
; CHECK-NEXT:     [DA: Uni] i64 [[VP10:%.*]] = vector-trip-count i64 [[VP3]], UF = 1

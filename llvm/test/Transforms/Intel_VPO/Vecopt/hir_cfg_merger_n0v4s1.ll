...
; RUN: opt -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -vplan-print-after-create-in-merge -vplan-print-after-cfg-merge -vplan-enable-new-cfg-merge-hir -vplan-vec-scenario="n0;v4;s1" -disable-output < %s 2>&1 | FileCheck %s

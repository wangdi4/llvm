...
; CHECK-NEXT:  VPlan IR for: main:for.body.#{{[0-9]+}}.cloned.masked
...
; CHECK-NEXT:     [DA: Uni] i32 [[VP_NORM_UB:%.*]] = sub i32 [[N0:%.*]] i32 live-in0
; CHECK-NEXT:     [DA: Uni] br [[BB2:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]: # preds: [[BB1]], new_latch
; CHECK-NEXT:     [DA: Div] i32 [[VP_IV:%.*]] = phi  [ i32 [[VP0]], [[BB1]] ],  [ i32 [[VP_IV_NEXT:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_NEW_IND:%.*]] = add i32 [[VP_IV]] i32 live-in0
; CHECK-NEXT:     [DA: Div] i1 [[VP2:%.*]] = icmp ult i32 [[VP_IV]] i32 [[VP_NORM_UB]]
...
; CHECK-NEXT:     [DA: Div] i1 [[VP3:%.*]] = icmp ult i32 [[VP_IV_NEXT]] i32 [[VP_NORM_UB]]
; CHECK-NEXT:     [DA: Uni] i1 [[VP4:%.*]] = all-zero-check i1 [[VP3]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP4]], [[BB4:BB[0-9]+]], [[BB2]]
; CHECK-EMPTY:
...
for.body:
  ...
  %bottom_test = icmp ugt i32 %N, %iv.next
...
; CHECK-LABEL:  VPlan after emitting masked variant:
; CHECK-NEXT:  VPlan IR for: main2:for.body.#{{[0-9]+}}.cloned.masked
; CHECK-NEXT:    [[BB0:BB[0-9]+]]: # preds:
; CHECK-NEXT:     [DA: Uni] br [[BB1:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB1]]: # preds: [[BB0]]
...
; CHECK-NEXT:     [DA: Div] i32 [[VP_IV:%.*]] = phi  [ i32 [[VP0]], [[BB1]] ],  [ i32 [[VP_IV_NEXT:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_NEW_IND:%.*]] = add i32 [[VP_IV]] i32 live-in0
; CHECK-NEXT:     [DA: Div] i1 [[VP2:%.*]] = icmp ule i32 [[VP_IV]] i32 [[VP_NORM_UB]]
; CHECK-NEXT:     [DA: Div] br i1 [[VP2]], [[BB3:BB[0-9]+]], new_latch
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB3]]: # preds: [[BB2]]
; CHECK-NEXT:       [DA: Uni] br new_latch
...
; CHECK-NEXT:    new_latch: # preds: [[BB3]], [[BB2]]
; CHECK-NEXT:     [DA: Div] i32 [[VP_IV_NEXT]] = add i32 [[VP_IV]] i32 [[VP1]]
; CHECK-NEXT:     [DA: Div] i1 [[VP3:%.*]] = icmp ule i32 [[VP_IV_NEXT]] i32 [[VP_NORM_UB]]
; CHECK-NEXT:     [DA: Uni] i1 [[VP4:%.*]] = all-zero-check i1 [[VP3]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP4]], [[BB4:BB[0-9]+]], [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB4]]: # preds: new_latch
...
for.body:
  %iv = phi i32 [ 0, %preheader ], [ %iv.next, %for.body ]
  %iv.next = add nsw i32 %iv, 1
  %bottom_test = icmp uge i32 %N, %iv.next
  br i1 %bottom_test, label %for.body, label %loopexit

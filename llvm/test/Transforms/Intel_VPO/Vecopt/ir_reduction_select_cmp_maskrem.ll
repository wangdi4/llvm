...
; CHECK: VPlannedBB25
; CHECK:  [[MLOAD:%.*]] = call <8 x i32> @llvm.masked.load.v8i32.p0
...
define noundef i32 @reduc_select_icmp_var_maskrem(ptr nocapture noundef readonly %v, i32 noundef %a, i32 noundef %b, i64 noundef %n) local_unnamed_addr {
entry:

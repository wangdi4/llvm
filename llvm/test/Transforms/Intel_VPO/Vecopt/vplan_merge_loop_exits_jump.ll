...
; CHECK-NEXT:     i32 [[VP_EXIT_ID_PHI:%.*]] = phi  [ i32 0, [[BB6]] ],  [ i32 1, [[INTERMEDIATE_BB0]] ]
; CHECK-NEXT:     i1 [[VP_TAKE_BACKEDGE_COND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB6]] ],  [ i1 false, [[INTERMEDIATE_BB0]] ]
...
; CHECK-NEXT:     i1 [[VP_CMP2:%.*]] = icmp i32 [[VP_PHI_OUTER_LOOP_INDUCTION]] i32 128

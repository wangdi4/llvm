...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_EXIT_ID_PHI]] = phi  [ i32 [[VP0]], [[BB6]] ],  [ i32 1, [[INTERMEDIATE_BB0]] ]
; CHECK-NEXT:     [DA: Divergent] i1 [[VP_TAKE_BACKEDGE_COND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB6]] ],  [ i1 false, [[INTERMEDIATE_BB0]] ]
...
; CHECK-NEXT:     [DA: Divergent] i1 [[VP1:%.*]] = icmp i32 [[VP_EXIT_ID_PHI]] i32 1

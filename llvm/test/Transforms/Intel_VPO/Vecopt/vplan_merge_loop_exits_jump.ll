...
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP1]] = phi  [ i32 [[VP0]], [[BB6]] ],  [ i32 1, [[INTERMEDIATE_BB0]] ]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP_TAKE_BACKEDGE_COND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB6]] ],  [ i1 false, [[INTERMEDIATE_BB0]] ]
; CHECK-NEXT:    SUCCESSORS(2):[[BB5]](i1 [[VP_TAKE_BACKEDGE_COND]]), [[CASCADED_IF_BLOCK0:cascaded.if.block[0-9]+]](!i1 [[VP_TAKE_BACKEDGE_COND]])
; CHECK-NEXT:    PREDECESSORS(2): [[BB6]] [[INTERMEDIATE_BB0]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[CASCADED_IF_BLOCK0]] (BP: NULL) :
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP2:%.*]] = icmp i32 [[VP1]] i32 1
; CHECK-NEXT:    SUCCESSORS(2):[[BB7:BB[0-9]+]](i1 [[VP2]]), [[BB8:BB[0-9]+]](!i1 [[VP2]])
...
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP_CMP2:%.*]] = icmp i32 [[VP_PHI_OUTER_LOOP_INDUCTION]] i32 128
; CHECK-NEXT:    SUCCESSORS(2):[[BB2]](i1 [[VP_CMP2]]), [[BB9:BB[0-9]+]](!i1 [[VP_CMP2]])
...
inner.loop:
  ...
  br i1 %cmp1, label %inner.loop.latch, label %exit_bb1

inner.loop.latch:
  %bottom_test = icmp eq i32 %phi.inner.loop.induction, 128
  br i1 %bottom_test, label %inner.loop, label %exit_bb2
...
outer.loop.latch:
  ...
  %cmp2 = icmp eq i32 %phi.outer.loop.induction, 128
  br i1 %cmp2, label %outer.loop, label %outer.loop.exit

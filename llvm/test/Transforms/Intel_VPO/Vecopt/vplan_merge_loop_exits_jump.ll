...
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP1]] = phi  [ i32 [[VP0]], [[BB6]] ],  [ i32 1, [[INTERMEDIATEBB0]] ]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP_TAKEBACKEDGECOND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB6]] ],  [ i1 false, [[INTERMEDIATEBB0]] ]
; CHECK-NEXT:    SUCCESSORS(2):[[BB5]](i1 [[VP_TAKEBACKEDGECOND]]), [[CASCADEDIFBLOCK0:CascadedIfBlock[0-9]+]](!i1 [[VP_TAKEBACKEDGECOND]])
; CHECK-NEXT:    PREDECESSORS(2): [[BB6]] [[INTERMEDIATEBB0]]
; CHECK-EMPTY:

...
define dso_local void @foo(double* noalias nocapture noundef %A, i32* nocapture noundef readonly %B, double* noalias nocapture noundef readonly %C, i32 noundef %N) local_unnamed_addr #0 {
;
; double A[N], C[N];

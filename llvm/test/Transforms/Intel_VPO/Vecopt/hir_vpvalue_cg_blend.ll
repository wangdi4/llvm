...
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -hir-cg -vplan-force-vf=4  -disable-output -print-after=hir-vplan-vec -enable-vp-value-codegen-hir < %s 2>&1 | FileCheck %s

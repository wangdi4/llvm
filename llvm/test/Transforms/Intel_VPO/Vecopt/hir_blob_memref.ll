...
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>,hir-cg,simplifycfg,sroa" -vplan-force-vf=4 -print-after=sroa -disable-output < %s 2>&1 | FileCheck %s

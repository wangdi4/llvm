...
; CHECK:        DO i1 = 0, 99, 4
; CHECK-NEXT:     %shuffle = shufflevector i1 + <i32 0, i32 1, i32 2, i32 3> + 2,  undef,  <i32 0, i32 1, i32 2, i32 3, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4>;
; CHECK-NEXT:     %shuffle1 = shufflevector undef,  %shuffle,  <i32 16, i32 1, i32 2, i32 17, i32 4, i32 5, i32 18, i32 7, i32 8, i32 19, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>;
; CHECK-NEXT:     %shuffle2 = shufflevector i1 + <i64 0, i64 1, i64 2, i64 3> + 1,  undef,  <i32 0, i32 1, i32 2, i32 3, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4>;
; CHECK-NEXT:     %shuffle3 = shufflevector %shuffle1,  %shuffle2,  <i32 0, i32 16, i32 2, i32 3, i32 17, i32 5, i32 6, i32 18, i32 8, i32 9, i32 19, i32 11, i32 12, i32 13, i32 14, i32 15>;
; CHECK-NEXT:     %shuffle4 = shufflevector i1 + <i64 0, i64 1, i64 2, i64 3>,  undef,  <i32 0, i32 1, i32 2, i32 3, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4, i32 4>;
; CHECK-NEXT:     %shuffle5 = shufflevector %shuffle3,  %shuffle4,  <i32 0, i32 1, i32 16, i32 3, i32 4, i32 17, i32 6, i32 7, i32 18, i32 9, i32 10, i32 19, i32 12, i32 13, i32 14, i32 15>;
; CHECK-NEXT:     (<16 x i32>*)(@arr1)[0][3 * i1] = %shuffle5; Mask = @{<i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 false, i1 false, i1 false, i1 false>}
; CHECK-NEXT:   END LOOP
; ModuleID = 't1.c'

...
define dso_local noundef i32 @main(i32 noundef %argc, i8** nocapture noundef readonly %argv) local_unnamed_addr #0 {
entry:
  %i9.linear.iv = alloca i64, align 8
  %b = alloca [128 x i64], align 16
  %0 = bitcast [128 x i64]* %b to i8*
  %arrayidx3 = getelementptr inbounds i8*, i8** %argv, i64 1
  %1 = load i8*, i8** %arrayidx3, align 8
  %call = tail call i32 @atoi(i8* nocapture noundef %1) #7
...
omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.155, %omp.inner.for.body
  ...
  store i64 %mul, i64* %i9.linear.iv, align 8
  %call12 = call noundef i64 @_Z3fooiRl(i32 noundef %call, i64* noundef nonnull align 8 dereferenceable(8) %i9.linear.iv) #3
  %4 = load i64, i64* %i9.linear.iv, align 8
  %arrayidx13 = getelementptr inbounds [128 x i64], [128 x i64]* %b, i64 0, i64 %4
  store i64 %call12, i64* %arrayidx13, align 8
...
declare dso_local noundef i64 @_Z3fooiRl(i32 noundef, i64* noundef nonnull align 8 dereferenceable(8)) local_unnamed_addr #4

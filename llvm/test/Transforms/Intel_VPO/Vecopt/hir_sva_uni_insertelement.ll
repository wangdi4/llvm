...
; RUN: opt -vplan-enable-new-cfg-merge-hir=false -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -disable-output -vplan-print-scalvec-results < %s 2>&1 | FileCheck %s
; RUN: opt -vplan-enable-new-cfg-merge-hir -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -disable-output -vplan-print-scalvec-results < %s 2>&1 | FileCheck %s

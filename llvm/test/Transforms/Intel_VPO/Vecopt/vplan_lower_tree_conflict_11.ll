...
define dso_local void @foo(i32* noalias nocapture noundef %A, i8* nocapture noundef readonly %B, i32* noalias nocapture noundef readonly %C, i32 noundef %N) local_unnamed_addr #0 {
;
; int A[N], C[N];

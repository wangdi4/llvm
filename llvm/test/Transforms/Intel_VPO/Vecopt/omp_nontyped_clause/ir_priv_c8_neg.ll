...
;
; RUN: opt -disable-output -passes=vplan-vec -vplan-force-vf=4 -vplan-print-after-plain-cfg  -debug-only=vploop-analysis -disable-vplan-codegen %s 2>&1 | FileCheck %s

...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -passes="vplan-vec" -vplan-force-vf=2 -S -debug-only=vplan-vec -debug-only=vpo-ir-loop-vectorize-legality -disable-output < %s 2>&1 | FileCheck %s

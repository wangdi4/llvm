; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,print<hir>' -vplan-enable-general-peeling-hir -vplan-force-vf=4 -hir-details -disable-output 2>&1 < %s | FileCheck %s
;

...
; RUN: opt -opaque-pointers=0 %s -S -passes=vplan-vec --debug-only=LoopVectorizationPlanner_vec_lengths 2>&1 | FileCheck %s
; REQUIRES: asserts
;
; Cheks if the code with #pragma vector vectorlength(1, 0, 4, 1, 8) (!{!"llvm.loop.vector.vectorlength", i64 1, i64 0, i64 4, i64 1, i64 8} metadata)
...
; }
;
; CHECK: LVP: Specified vectorlengths: 4 8
;

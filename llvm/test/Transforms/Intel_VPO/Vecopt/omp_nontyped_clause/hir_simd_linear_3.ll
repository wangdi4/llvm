...
; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,print<hir>' -disable-output -vplan-print-after-vpentity-instrs < %s 2>&1 | FileCheck %s

...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -passes='vplan-vec' -enable-intel-advanced-opts -vplan-enable-all-zero-bypass-non-loops -vplan-print-after-all-zero-bypass -vplan-enable-masked-vectorized-remainder=0 -vplan-enable-non-masked-vectorized-remainder=0 \

...
; RUN: opt -passes='hir-ssa-deconstruction,hir-vplan-vec,print<hir>,hir-cg,mem2reg,simplifycfg' -vplan-force-vf=4 -hir-details -vplan-enable-hir-private-arrays -S < %s 2>&1 | FileCheck %s

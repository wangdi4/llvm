...
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>" -vplan-print-after-create-masked-vplan -vplan-force-vf=2 -vplan-enable-hir-private-arrays -vplan-vec-scenario="n0;v2;m2" -disable-output %s 2>&1 | FileCheck %s -check-prefixes=CHECK,HIR

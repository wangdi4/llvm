...
; Incomming HIR
; <24>    BEGIN REGION { }
; <26>          %2 = @llvm.directive.region.entry(); [ DIR.OMP.SIMD(),  QUAL.OMP.LASTPRIVATE:NONPOD(&((%myPoint.lpriv)[0])&((@_ZTS7point2d.omp.def_constr)[0])&((@_ZTS7point2d.omp.copy_assign)[0])&((@_ZTS7point2d.omp.destr)[0])),  QUAL.OMP.NORMALIZED.IV(null),  QUAL.OMP.NORMALIZED.UB(null),  QUAL.OMP.LINEAR:IV(&((%i.linear.iv)[0])1) ]
; <75>

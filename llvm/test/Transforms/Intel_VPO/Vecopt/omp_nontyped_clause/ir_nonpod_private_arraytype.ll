...
; Incomming HIR
; <24>         BEGIN REGION { }
; <26>               %2 = @llvm.directive.region.entry(); [ DIR.OMP.SIMD(),  QUAL.OMP.PRIVATE:NONPOD(&((%myPoint.priv)[0])&((@_ZTS7point2d.omp.def_constr)[0])&((@_ZTS7point2d.omp.destr)[0])),  QUAL.OMP.NORMALIZED.IV(null),  QUAL.OMP.NORMALIZED.UB(null),  QUAL.OMP.LINEAR:IV(&((%i.linear.iv)[0])1) ]
; <49>
...
entry.split:
  ...
  %array.begin10 = getelementptr inbounds [4 x %struct.point2d], [4 x %struct.point2d]* %myPoint.priv, i64 0, i64 0
...
priv.constr.body:                                 ; preds = %priv.constr.body, %entry.split
  %priv.cpy.dest.ptr = phi %struct.point2d* [ %array.begin10, %entry.split ], [ %priv.cpy.dest.inc, %priv.constr.body ]
...
DIR.OMP.SIMD.1:                                   ; preds = %arrayctor.loop
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.PRIVATE:NONPOD"([4 x %struct.point2d]* %myPoint.priv, %struct.point2d* (%struct.point2d*)* @_ZTS7point2d.omp.def_constr, void (%struct.point2d*)* @_ZTS7point2d.omp.destr), "QUAL.OMP.NORMALIZED.IV"(i8* null), "QUAL.OMP.NORMALIZED.UB"(i8* null), "QUAL.OMP.LINEAR:IV"(i32* %i.linear.iv, i32 1) ]
...
DIR.OMP.END.SIMD.2:                               ; preds = %omp.inner.for.body
  ...
  br label %DIR.OMP.END.SIMD.219

DIR.OMP.END.SIMD.219:                             ; preds = %DIR.OMP.END.SIMD.2

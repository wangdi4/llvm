...
attributes #0 = { noinline norecurse nounwind readnone uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" "vector-variants"="_ZGVbN2vvl_foo,_ZGVcN4vvl_foo,_ZGVdN4vvl_foo,_ZGVeN8vvl_foo,_ZGVbM2vvl_foo,_ZGVcM4vvl_foo,_ZGVdM4vvl_foo,_ZGVeM8vvl_foo,_ZGVbN2vvu_foo,_ZGVcN4vvu_foo,_ZGVdN4vvu_foo,_ZGVeN8vvu_foo,_ZGVbM2vvu_foo,_ZGVcM4vvu_foo,_ZGVdM4vvu_foo,_ZGVeM8vvu_foo" }

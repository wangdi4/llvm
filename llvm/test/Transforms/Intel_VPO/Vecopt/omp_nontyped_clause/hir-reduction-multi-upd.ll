...
;
; RUN: opt -opaque-pointers=0 -disable-output -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec" -print-after=hir-vplan-vec -vplan-print-after-vpentity-instrs -vplan-entities-dump -vplan-print-legality  %s 2>&1 | FileCheck %s
;

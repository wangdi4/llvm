...
; HIR-run.
; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-vplan-vec,print<hir>' -vplan-enable-masked-variant-hir=0 -vplan-enable-soa-hir -vplan-dump-soa-info\

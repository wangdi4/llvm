...
; RUN: opt -opaque-pointers=0 %s -S -passes=vplan-vec -vplan-force-vf=2 --debug-only=LoopVectorizationPlanner_vec_lengths 2>&1 | FileCheck %s
; REQUIRES: asserts
;
; Cheks if the code with #pragma vector vectorlength(4) (!{!"llvm.loop.vector.vectorlength", i64 4} metadata)i,
...
; }
;
; CHECK: LVP: Specified vectorlengths: 2
;

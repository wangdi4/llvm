...
; REQUIRES: asserts
; RUN: opt -disable-output -passes=vplan-vec -vplan-force-vf=2 -vplan-entities-dump -vplan-print-after-vpentity-instrs  < %s 2>&1 | FileCheck %s
;
...
; CHECK-EMPTY:
; CHECK-NEXT:   IntInduction(+) Start: i64 [[K_IV_B0:%.*]] Step: i64 1 StartVal: ? EndVal: ? BinOp: i64 [[VP1:%.*]] = add i64 [[VP_K_IV:%.*]] i64 [[VP_K_IV_IND_INIT_STEP:%.*]] need close form

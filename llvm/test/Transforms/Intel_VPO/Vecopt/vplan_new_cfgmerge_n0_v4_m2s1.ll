...
; CHECK-NEXT:     [DA: Div, SVA: (FV )] i64 [[VP_NEW_IND:%.*]] = add i64 [[VP_INDVARS_IV_1]] i64 live-in0 (SVAOpBits 0->FV 1->FV )
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i1 [[VP2:%.*]] = icmp ult i64 [[VP_INDVARS_IV_1]] i64 [[VP_NORM_UB]] (SVAOpBits 0->V 1->V )
...
; CHECK-NEXT:     [DA: Div, SVA: (F  )] ptr [[VP_PTR_1:%.*]] = getelementptr inbounds i64, ptr [[ARY0]] i64 [[VP_NEW_IND]] (SVAOpBits 0->F 1->F )
; CHECK-NEXT:     [DA: Uni, SVA: (F  )] i64 [[VP_CC_1:%.*]] = sext i32 [[C0]] to i64 (SVAOpBits 0->F )
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i64 [[VP_ADD_1:%.*]] = add i64 [[VP_CC_1]] i64 [[VP_NEW_IND]] (SVAOpBits 0->V 1->V )
...
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i1 [[VP4:%.*]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_1]] i64 [[VP_NORM_UB]] (SVAOpBits 0->V 1->V )
...
; CHECK-NEXT:     [DA: Uni] i1 [[VP_VEC_TC_CHECK:%.*]] = icmp eq i64 0 i64 [[VP7]]
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB12]]: # preds: [[MERGE_BLK0]]
; CHECK-NEXT:       [DA: Uni] token [[VP_VPLAN_ADAPTER:%.*]] = vplan-adapter for VPlan {test_store:for.body.#{{[0-9]+}}.cloned.masked} i64 [[VP8]]
; CHECK-NEXT:       [DA: Uni] br final.merge
; CHECK-EMPTY:
; CHECK-NEXT:    final.merge: # preds: [[BB12]], [[BB11]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP9:%.*]] = phi-merge  [ token [[VP_VPLAN_ADAPTER]], [[BB12]] ],  [ i64 live-out0, [[BB11]] ]
; CHECK-NEXT:     [DA: Uni] popvf
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP_NORM_UB]] = sub i64 1024 i64 [[VP8]]
; CHECK-NEXT:       [DA: Uni] br [[BB7]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB7]]: # preds: [[BB6]], new_latch
; CHECK-NEXT:       [DA: Div] i64 [[VP_INDVARS_IV_1]] = phi  [ i64 [[VP0]], [[BB6]] ],  [ i64 [[VP_INDVARS_IV_NEXT_1]], new_latch ]
; CHECK-NEXT:       [DA: Div] i64 [[VP_NEW_IND]] = add i64 [[VP_INDVARS_IV_1]] i64 [[VP8]]
; CHECK-NEXT:       [DA: Div] i1 [[VP2]] = icmp ult i64 [[VP_INDVARS_IV_1]] i64 [[VP_NORM_UB]]
; CHECK-NEXT:       [DA: Uni] br [[BB8]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB8]]: # preds: [[BB7]]
; CHECK-NEXT:       [DA: Div] i1 [[VP3]] = block-predicate i1 [[VP2]]
; CHECK-NEXT:       [DA: Div] ptr [[VP_PTR_1]] = getelementptr inbounds i64, ptr [[ARY0]] i64 [[VP_NEW_IND]]
; CHECK-NEXT:       [DA: Uni] i64 [[VP_CC_1]] = sext i32 [[C0]] to i64
; CHECK-NEXT:       [DA: Div] i64 [[VP_ADD_1]] = add i64 [[VP_CC_1]] i64 [[VP_NEW_IND]]
...
; CHECK-NEXT:       [DA: Div] i1 [[VP4]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_1]] i64 [[VP_NORM_UB]]

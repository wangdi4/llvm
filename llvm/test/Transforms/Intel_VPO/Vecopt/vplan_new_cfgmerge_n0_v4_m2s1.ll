...
; CHECK-NEXT:     [DA: Uni, SVA: (F  )] br Cloned.[[BB8:BB[0-9]+]] (SVAOpBits 0->F )
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB8]]: # preds: Cloned.[[BB7]], new_latch
; CHECK-NEXT:     [DA: Div, SVA: (FV )] i64 [[VP_INDVARS_IV_1:%.*]] = phi  [ i64 [[VP0]], Cloned.[[BB7]] ],  [ i64 [[VP_INDVARS_IV_NEXT_1:%.*]], new_latch ] (SVAOpBits 0->FV 1->FV )
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i1 [[VP3:%.*]] = icmp ult i64 [[VP_INDVARS_IV_1]] i64 1024 (SVAOpBits 0->V 1->V )
...
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i1 [[VP5:%.*]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_1]] i64 1024 (SVAOpBits 0->V 1->V )
; CHECK-NEXT:     [DA: Uni, SVA: RetVal:(F  ), Inst:( V )] i1 [[VP6:%.*]] = all-zero-check i1 [[VP5]] (SVAOpBits 0->V )
; CHECK-NEXT:     [DA: Uni, SVA: (F  )] br i1 [[VP6]], Cloned.[[BB10:BB[0-9]+]], Cloned.[[BB8]] (SVAOpBits 0->F 1->F 2->F )
; CHECK-EMPTY:
...
; CHECK-NEXT:     [DA: Uni, SVA: (F  )] br Cloned.[[BB11:BB[0-9]+]] (SVAOpBits 0->F )
; CHECK-EMPTY:
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[MERGE_BLK0]]: # preds: [[BB13]], [[BB12]]
; CHECK-NEXT:       [DA: Uni] i64 [[VP9:%.*]] = phi-merge  [ i64 live-out0, [[BB13]] ],  [ i64 0, [[BB12]] ]
; CHECK-NEXT:       [DA: Uni] br [[BB14:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB14]]: # preds: [[MERGE_BLK0]]
; CHECK-NEXT:       [DA: Uni] token [[VP_VPLAN_ADAPTER:%.*]] = vplan-adapter for VPlan {test_store:for.body.cloned.masked} i64 [[VP9]]
; CHECK-NEXT:       [DA: Uni] br final.merge
; CHECK-EMPTY:
; CHECK-NEXT:    final.merge: # preds: [[BB15:BB[0-9]+]], [[BB14]], [[BB13]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP10:%.*]] = phi-merge  [ token [[VP_VPLAN_ADAPTER_1:%.*]], [[BB15]] ],  [ token [[VP_VPLAN_ADAPTER]], [[BB14]] ],  [ i64 live-out0, [[BB13]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:

...
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,vplan-driver-hir" -vplan-print-plain-cfg -vplan-dump-subscript-details -disable-output < %s 2>&1 | FileCheck %s

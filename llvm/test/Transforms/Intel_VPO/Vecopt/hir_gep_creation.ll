...
; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec'  -disable-output  -vplan-print-after-plain-cfg < %s | FileCheck %s

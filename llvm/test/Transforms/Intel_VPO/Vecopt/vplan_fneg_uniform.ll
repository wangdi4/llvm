...
; RUN: opt -S -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -hir-vplan-vec -hir-cg -enable-vp-value-codegen-hir -vplan-force-vf=4 < %s | FileCheck %s -check-prefix=CHECK-HIR

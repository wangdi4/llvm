...
; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,print<hir>' -vplan-print-after-vpentity-instrs -disable-output < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,UF1
; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,print<hir>' -vplan-print-after-vpentity-instrs -disable-output -vplan-force-uf=2 < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,UF2
...
; UF1-NEXT:          |   [[PHI_TEMP0]] = &((<4 x i64*>)([[PHI_TEMP0]])[%ind.step.init])
; UF2-NEXT:          |   (<4 x i64*>*)([[PRIV_MEM0]])[0] = &((<4 x i64*>)([[PHI_TEMP0]])[%ind.step.init])
; UF2-NEXT:          |   @_Z3bazPPl(&((i64**)([[PRIV_MEM0]])[0]))
; UF2-NEXT:          |   [[EXTRACT_1_30:%.*]] = extractelement &((<4 x i64**>)([[PRIV_MEM_BC0]])[<i32 0, i32 1, i32 2, i32 3>]),  1
; UF2-NEXT:          |   @_Z3bazPPl([[EXTRACT_1_30]])
; UF2-NEXT:          |   [[EXTRACT_2_40:%.*]] = extractelement &((<4 x i64**>)([[PRIV_MEM_BC0]])[<i32 0, i32 1, i32 2, i32 3>]),  2
; UF2-NEXT:          |   @_Z3bazPPl([[EXTRACT_2_40]])
; UF2-NEXT:          |   [[EXTRACT_3_50:%.*]] = extractelement &((<4 x i64**>)([[PRIV_MEM_BC0]])[<i32 0, i32 1, i32 2, i32 3>]),  3
; UF2-NEXT:          |   @_Z3bazPPl([[EXTRACT_3_50]])
; UF2-NEXT:          |   [[DOTVEC60:%.*]] = (<4 x i64*>*)([[PRIV_MEM0]])[0]
; UF2-NEXT:          |   (<4 x i64*>*)([[PRIV_MEM0]])[0] = &((<4 x i64*>)([[DOTVEC60]])[%0 + 1])

; UF2-NEXT:          |   [[GEP_BASE_COPY0:%.*]] = &((<4 x i64*>)([[PHI_TEMP0]])[%ind.step.init])
; UF2-NEXT:          |   [[PHI_TEMP0]] = &((<4 x i64*>)([[GEP_BASE_COPY0]])[%ind.step.init])
; CHECK-NEXT:        + END LOOP
; CHECK-NEXT:<{{[0-9]+}}>

...
; RUN: opt -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,print<hir>' -vplan-print-after-vpentity-instrs -disable-output < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,UF1
; RUN: opt -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,print<hir>' -vplan-print-after-vpentity-instrs -disable-output -vplan-force-uf=2 < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,UF2

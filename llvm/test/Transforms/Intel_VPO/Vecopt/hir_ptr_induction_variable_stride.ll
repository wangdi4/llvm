...
; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -vplan-print-after-vpentity-instrs -hir-vplan-vec -disable-output -print-after=hir-vplan-vec < %s 2>&1 | FileCheck %s

...
; CHECK-EMPTY:
; CHECK-NEXT:   PtrInduction(+) Start: i64* [[K_IV_B0:%.*]] Step: i64 1 BinOp: i64* [[VP_K_IV_NEXT:%.*]] = phi  [ i64* [[VP_K_IV_N1:%.*]], [[BB1:BB[0-9]+]] ],  [ i64* [[VP_K_IV_N2:%.*]], [[BB2:BB[0-9]+]] ] need close form
...
; CHECK-NEXT:     i1 [[VP_EE:%.*]] = icmp i64 [[VP_INDVARS_IV_NEXT]] i64 43

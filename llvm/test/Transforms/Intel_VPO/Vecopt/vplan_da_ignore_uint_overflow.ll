...
; REQUIRES: asserts
; RUN: opt -vplan-print-terminator-inst=false %s -vplan-da-ignore-integer-overflow=true -vplan-dump-da -VPlanDriver -vplan-force-vf=4 -disable-output 2>&1 | FileCheck %s
; RUN: opt -vplan-print-terminator-inst=false %s -vplan-da-ignore-integer-overflow=true -vplan-dump-da -passes="vplan-driver" -vplan-force-vf=4 -disable-output 2>&1 | FileCheck %s

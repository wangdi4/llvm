...
; CHECK-NEXT:     [DA: Div] i32 [[VP_IV_IND_INIT:%.*]] = induction-init{add} i32 live-in0 i32 1
...
; CHECK-NEXT:     [DA: Div] i32 [[VP_IV:%.*]] = phi  [ i32 [[VP_IV_IND_INIT]], [[BB1]] ],  [ i32 [[VP_IV_NEXT:%.*]], [[BB2]] ]
...
; CHECK-NEXT:     [DA: Uni] i32 [[VP_IV_IND_FINAL:%.*]] = induction-final{add} i32 live-in0 i32 1
...
; CHECK-NEXT:  Id: 0     [[LCSSA_PHI0:%.*]] = phi i32 [ [[IV_NEXT0:%.*]], [[HEADER0:%.*]] ] i32 [[VP_IV_IND_FINAL]] -> i32 [[IV_NEXT0]]
;
entry:
  br label %preheader

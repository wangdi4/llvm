...
;
define void @simd_loop(ptr %A, ptr %B) {
...
; CHECK-NEXT:     ptr [[VP_PRIVATE:%.*]] = allocate-priv i32, OrigAlign = 4
; CHECK-NEXT:     call i64 4 ptr [[VP_PRIVATE]] ptr @llvm.lifetime.start.p0
...
; CHECK-NEXT:     call i64 4 ptr [[VP_PRIVATE]] ptr @llvm.lifetime.end.p0
...
;
; CHECK:  define void @simd_loop(ptr [[A0]], ptr [[B0:%.*]]) {
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[PRIVATE0:%.*]] = alloca i32, align 4
; CHECK-NEXT:    [[PRIVATE_VEC0:%.*]] = alloca <4 x i32>, align 16
; CHECK-NEXT:    [[PRIVATE_VEC_BASE_ADDR0:%.*]] = getelementptr i32, ptr [[PRIVATE_VEC0]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[PRIVATE_VEC_BASE_ADDR0_EXTRACT0:%.*]] = extractelement <4 x ptr> [[PRIVATE_VEC_BASE_ADDR0]], i32 0
...
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 16, ptr [[PRIVATE_VEC_BASE_ADDR0_EXTRACT0]])
...
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 16, ptr [[PRIVATE_VEC_BASE_ADDR0_EXTRACT0]])
...
; CHECK-NEXT:    store i32 [[DOT_LCSSA0]], ptr [[PRIVATE0]], align 8
...
DIR.OMP.SIMD.3:                                   ; preds = %entry
  %entry.region = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 4), "QUAL.OMP.PRIVATE:TYPED"(ptr %private, i32 0, i32 1) ]

...
; RUN: opt -S -VPlanDriver -vplan-force-vf=4 --vplan-print-after-live-inout-list %s | FileCheck %s
; RUN: opt -S -passes="vplan-driver" -vplan-force-vf=4 --vplan-print-after-live-inout-list %s | FileCheck %s
;

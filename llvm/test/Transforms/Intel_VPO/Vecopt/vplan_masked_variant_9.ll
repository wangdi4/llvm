...
; RUN: opt -S -vplan-vec -vplan-force-vf=2 -vplan-print-after-create-masked-vplan -vplan-enable-masked-variant < %s -disable-output | FileCheck %s
...
; CHECK-NEXT:     [DA: Uni] br i1 [[VP4]], Cloned.[[BB9:BB[0-9]+]], Cloned.[[BB2]]
; CHECK-EMPTY:

...
; CHECK-NEXT:       [DA: Uni] i32 [[VP_X_LCSSA:%.*]] = phi  [ i32 [[VP_X]], Cloned.[[BB5]] ]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_X_LCSSA_PHI:%.*]] = phi  [ i32 [[VP_X]], Cloned.[[BB5]] ]
; CHECK-NEXT:       [DA: Uni] i1 [[VP_X_COND:%.*]] = icmp eq i32 [[VP_X_LCSSA]] i32 16
; CHECK-NEXT:       [DA: Uni] br i1 [[VP_X_COND]], Cloned.[[BB7:BB[0-9]+]], Cloned.[[BB8:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:        Cloned.[[BB8]]: # preds: Cloned.[[BB6]]
; CHECK-NEXT:         [DA: Uni] i32 [[VP_X_ADD:%.*]] = add i32 [[VP_X_LCSSA]] i32 1
; CHECK-NEXT:         [DA: Uni] br Cloned.[[BB7]]
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.[[BB7]]: # preds: Cloned.[[BB6]], Cloned.[[BB8]]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_X_PHI:%.*]] = phi  [ i32 [[VP_X_LCSSA_PHI]], Cloned.[[BB6]] ],  [ i32 [[VP_X_ADD]], Cloned.[[BB8]] ]
...
; CHECK-NEXT:     [DA: Uni] br i1 [[VP_OUTER_BOTTOM_TEST_1]], Cloned.[[BB9:BB[0-9]+]], Cloned.[[BB2]]
; CHECK-EMPTY:
...
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB13]]: # preds: Cloned.[[BB12]], new_latch
; CHECK-NEXT:     [DA: Div] i32 [[VP_OUTER_IV_1:%.*]] = phi  [ i32 [[VP4]], Cloned.[[BB12]] ],  [ i32 [[VP_OUTER_IV_NEXT_1:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i1 [[VP_OUTER_BOTTOM_TEST_2:%.*]] = icmp eq i32 [[VP_OUTER_IV_1]] i32 [[VP6]]
; CHECK-NEXT:     [DA: Div] br i1 [[VP_OUTER_BOTTOM_TEST_2]], [[BB14:BB[0-9]+]], new_latch
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB14]]: # preds: Cloned.[[BB13]]
; CHECK-NEXT:       [DA: Uni] br Cloned.[[BB15:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.[[BB15]]: # preds: Cloned.[[BB16:BB[0-9]+]], [[BB14]]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_INNER_IV_1:%.*]] = phi  [ i32 0, [[BB14]] ],  [ i32 [[VP_INNER_IV_NEXT_1:%.*]], Cloned.[[BB16]] ]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_INNER_IV_NEXT_1]] = add i32 [[VP_INNER_IV_1]] i32 1
; CHECK-NEXT:       [DA: Uni] br Cloned.[[BB16]]
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.[[BB16]]: # preds: Cloned.[[BB15]]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_X_1:%.*]] = add i32 [[VP_INNER_IV_1]] i32 1
; CHECK-NEXT:       [DA: Uni] i1 [[VP_INNER_BOTTOM_TEST_1:%.*]] = icmp eq i32 [[VP_INNER_IV_NEXT_1]] i32 [[INNER_TC0]]
; CHECK-NEXT:       [DA: Uni] br i1 [[VP_INNER_BOTTOM_TEST_1]], Cloned.[[BB17:BB[0-9]+]], Cloned.[[BB15]]
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.[[BB17]]: # preds: Cloned.[[BB16]]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_X_LCSSA_1:%.*]] = phi  [ i32 [[VP_X_1]], Cloned.[[BB16]] ]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_X_LCSSA_PHI_1:%.*]] = phi  [ i32 [[VP_X_1]], Cloned.[[BB16]] ]
; CHECK-NEXT:       [DA: Uni] i1 [[VP_X_COND_1:%.*]] = icmp eq i32 [[VP_X_LCSSA_1]] i32 16
; CHECK-NEXT:       [DA: Uni] br i1 [[VP_X_COND_1]], Cloned.[[BB18:BB[0-9]+]], Cloned.[[BB19:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:        Cloned.[[BB19]]: # preds: Cloned.[[BB17]]
; CHECK-NEXT:         [DA: Uni] i32 [[VP_X_ADD_1:%.*]] = add i32 [[VP_X_LCSSA_1]] i32 1
; CHECK-NEXT:         [DA: Uni] br Cloned.[[BB18]]
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.[[BB18]]: # preds: Cloned.[[BB17]], Cloned.[[BB19]]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_X_PHI_1:%.*]] = phi  [ i32 [[VP_X_LCSSA_PHI_1]], Cloned.[[BB17]] ],  [ i32 [[VP_X_ADD_1]], Cloned.[[BB19]] ]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_X_ADD_FINAL_1:%.*]] = add i32 [[VP_X_PHI_1]] i32 1
; CHECK-NEXT:       [DA: Uni] br new_latch
; CHECK-EMPTY:
; CHECK-NEXT:    new_latch: # preds: Cloned.[[BB18]], Cloned.[[BB13]]
...
; CHECK-NEXT:     [DA: Uni] br i1 [[VP_OUTER_BOTTOM_TEST_3]], Cloned.[[BB20:BB[0-9]+]], Cloned.[[BB13]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB20]]: # preds: new_latch
; CHECK-NEXT:     [DA: Uni] i32 [[VP7:%.*]] = induction-final{add} i32 live-in0 i32 1
; CHECK-NEXT:     [DA: Uni] br Cloned.[[BB21:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB21]]: # preds: Cloned.[[BB20]]
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
...
bb1:
  ...
  %x.cond = icmp eq i32 %x, 16
  br i1 %x.cond, label %outer.latch, label %bb2

bb2:
  %x.add = add nsw i32 %x, 1

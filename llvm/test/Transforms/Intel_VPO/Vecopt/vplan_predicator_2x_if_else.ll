...
; RUN: opt %s -VPlanDriver -enable-new-vplan-predicator=false -vplan-predicator-report -disable-predicator-opts -disable-vplan-codegen -disable-vplan-subregions=0 -disable-vplan-loop-regions=0 -S -o /dev/null | FileCheck %s -check-prefix=NOOPT

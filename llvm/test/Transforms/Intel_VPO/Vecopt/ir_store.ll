...
; RUN: opt -opaque-pointers=0 -S -passes=vplan-vec -disable-vplan-predicator -vplan-force-vf=4 -vplan-enable-masked-vectorized-remainder=0 -vplan-enable-non-masked-vectorized-remainder=0 < %s  | FileCheck %s

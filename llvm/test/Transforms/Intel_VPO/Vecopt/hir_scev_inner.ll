...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.cond3.for.cond.cleanup5_crit_edge.us
  ...
  %ptridx.us = getelementptr inbounds i32, ptr %dst, i64 %1
  %2 = load i32, ptr %ptridx.us, align 4
  %ptridx2.us = getelementptr inbounds i32, ptr %dst, i64 %indvars.iv39
  store i32 %2, ptr %ptridx2.us, align 4
...
for.body6.us:                                     ; preds = %for.body.us, %for.body6.us
  ...
  %ptridx9.us = getelementptr inbounds i32, ptr %src, i64 %5
  %6 = load i32, ptr %ptridx9.us, align 4
  %7 = add nuw nsw i64 %indvars.iv, %4
  %ptridx13.us = getelementptr inbounds i32, ptr %dst, i64 %7
  store i32 %6, ptr %ptridx13.us, align 4

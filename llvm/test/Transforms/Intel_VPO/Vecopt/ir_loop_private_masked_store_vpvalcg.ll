...
; This test checks for widened allocas for the private and scatters being generated to
...
; CHECK:         call void @llvm.masked.scatter.v4i64.v4p0i64(<4 x i64> [[VEC_PHI0]], <4 x i64*> [[PRIVATE_MEM_BASE_ADDR0]], i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 true>)
...
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i64.v4p0i64(<4 x i64> [[WIDE_MASKED_LOAD0]], <4 x i64*> [[PRIVATE_MEM_BASE_ADDR0]], i32 8, <4 x i1> [[TMP8]])

...
; RUN:     -vector-library=SVML -enable-intel-advanced-opts -vplan-force-vf=1 \
; RUN:     | FileCheck %s --check-prefix=CM-ANAL-VF1

; RUN: opt < %s -S -vplan-vec -mtriple=x86_64-unknown-unknown -mattr=+avx2 \
; RUN:     -instcombine -simplifycfg  -cost-model -analyze \
; RUN:     -vector-library=SVML -enable-intel-advanced-opts -vplan-force-vf=2 \
; RUN:     | FileCheck %s --check-prefix=CM-ANAL-VF2

; RUN: opt < %s -S -vplan-vec -mtriple=x86_64-unknown-unknown -mattr=+avx2 \
; RUN:     -instcombine -simplifycfg  -cost-model -analyze \
; RUN:     -vector-library=SVML -enable-intel-advanced-opts -vplan-force-vf=4 \
; RUN:     | FileCheck %s --check-prefix=CM-ANAL-VF4
...
; VPLAN-CM-VF4-NEXT:    Cost 1 for i64 [[VP_UDIV64_BY_POWER2:%.*]] = udiv i64 [[VP_LD64_2:%.*]] i64 16
...
; VPLAN-CM-VF4-NEXT:    Cost 10 for i64 [[VP_SDIV64_BY_POWER2:%.*]] = sdiv i64 [[VP_LD64_2]] i64 16
...
; CM-ANAL-VF4-NEXT:  Cost Model: Found an estimated cost of 1 for instruction:   [[TMP13:%.*]] = lshr <4 x i64> [[WIDE_LOAD170:%.*]], <i64 4, i64 4, i64 4, i64 4>
...
; CM-ANAL-VF4-NEXT:  Cost Model: Found an estimated cost of 10 for instruction:   [[TMP16:%.*]] = sdiv <4 x i64> [[WIDE_LOAD170]], <i64 16, i64 16, i64 16, i64 16>

...
; CHECK-NEXT:  Analyzing VPBasicBlock [[BB2]], total cost: 26
...
; CHECK-NEXT:    Cost 2 for i1 [[VP4:%.*]] = icmp ne i32 [[VP3]] i32 0
; CHECK-NEXT:    Cost 0 for br [[BB4:BB[0-9]+]]
; CHECK-NEXT:  Analyzing VPBasicBlock [[BB4]], total cost: 20
...
; CHECK-NEXT:    Cost 32 for i1 [[VP17:%.*]] = icmp sle i64 [[VP1]] i64 1023

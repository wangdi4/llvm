...
; CHECK-NEXT:  Total Cost: 140012
; CHECK-NEXT:  Base Cost: 84012
...
; CHECK-NEXT:  Analyzing VPBasicBlock [[BB2]], total cost: 26011
...
; CHECK-NEXT:  Analyzing VPBasicBlock [[BB4]], total cost: 20000
; CHECK-NEXT:  Block Vector spill/fill approximate cost (not included into total cost): 24000
...
; CHECK-NEXT:  Analyzing VPBasicBlock [[BB3]], total cost: 38001
...
; CHECK-NEXT:    Cost 2001 for store i32 [[VP__BLEND_BB4]] i32* [[VP_SUBSCRIPT_11]]
; CHECK-NEXT:    Cost 4000 for i64 [[VP1]] = add i64 [[VP0]] i64 [[VP__IND_INIT_STEP]]
; CHECK-NEXT:    Cost 32000 for i1 [[VP17:%.*]] = icmp sle i64 [[VP1]] i64 1023

...
; RUN: opt < %s -passes=hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec -disable-output \
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD:%.*]] = load ptr [[VP_SUBSCRIPT]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_1:%.*]] = load ptr [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_2:%.*]] = load ptr [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_3:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_3:%.*]] = load ptr [[VP_SUBSCRIPT_3]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_4:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_4:%.*]] = load ptr [[VP_SUBSCRIPT_4]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_5:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_5:%.*]] = load ptr [[VP_SUBSCRIPT_5]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_6:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_6:%.*]] = load ptr [[VP_SUBSCRIPT_6]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_7:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_7:%.*]] = load ptr [[VP_SUBSCRIPT_7]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_8:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_8:%.*]] = load ptr [[VP_SUBSCRIPT_8]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_9:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_9:%.*]] = load ptr [[VP_SUBSCRIPT_9]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_10:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for i32 [[VP_LOAD_10:%.*]] = load ptr [[VP_SUBSCRIPT_10]]
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_11:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP0]]
; CHECK-NEXT:    Cost 2 for store i32 [[VP__BLEND_BB4]] ptr [[VP_SUBSCRIPT_11]]
...
for.body:                                         ; preds = %for.inc, %entry
  ...
  %arrayidx1 = getelementptr inbounds [1024 x i32], ptr @a, i64 0, i64 %indvars.iv
  %arrayidx2 = getelementptr inbounds [1024 x i32], ptr @b, i64 0, i64 %indvars.iv
  %load1 = load i32, ptr %arrayidx1, align 4
  %load20 = load i32, ptr %arrayidx2, align 4
  %load21 = load i32, ptr %arrayidx2, align 4
  %load22 = load i32, ptr %arrayidx2, align 4
  %load23 = load i32, ptr %arrayidx2, align 4
  %load24 = load i32, ptr %arrayidx2, align 4
  %load25 = load i32, ptr %arrayidx2, align 4
  %load26 = load i32, ptr %arrayidx2, align 4
  %load27 = load i32, ptr %arrayidx2, align 4
  %load28 = load i32, ptr %arrayidx2, align 4
  %load29 = load i32, ptr %arrayidx2, align 4
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  store i32 %res, ptr %arrayidx2, align 4

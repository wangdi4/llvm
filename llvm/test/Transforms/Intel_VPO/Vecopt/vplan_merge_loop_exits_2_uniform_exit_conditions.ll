...
; of bb1 (BB8 in checks) is uniform. Thus, the bottom test should be uniform.
...
; CHECK-NEXT:       i1 [[VP_CMP3:%.*]] = icmp i32 [[VP_L]] i32 32
...
; CHECK-NEXT:     <Empty Block>
; CHECK-NEXT:     Condition(NewLoopLatch15): [DA: Uniform]  i1 [[VP2]] = phi  [ i1 true, [[BB10]] ],  [ i1 false, Intermediate[[BB9]] ],  [ i1 false, Intermediate[[BB11]] ]
...
; CHECK-EMPTY:
; CHECK-NEXT:  BottomTest is uniform
;
entry:

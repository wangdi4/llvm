...
; REQUIRES: asserts
; RUN: opt -disable-output -VPlanDriver -vplan-dump-debug-loc -vplan-print-after-plain-cfg < %s 2>&1 | FileCheck %s --check-prefixes=CHECKPCFG
; RUN: opt -disable-output -VPlanDriver -vplan-dump-debug-loc -vplan-print-after-vpentity-instrs < %s 2>&1 | FileCheck %s --check-prefixes=CHECKVPE
; RUN: opt -disable-output -hir-ssa-deconstruction -hir-vec-dir-insert -VPlanDriverHIR -vplan-dump-debug-loc -vplan-print-after-plain-cfg < %s 2>&1 | FileCheck %s --check-prefixes=CHECKHIRPCFG
; RUN: opt -disable-output -hir-ssa-deconstruction -hir-vec-dir-insert -VPlanDriverHIR -vplan-dump-debug-loc -vplan-print-after-vpentity-instrs < %s 2>&1 | FileCheck %s --check-prefixes=CHECKHIRVPE

; RUN: opt -disable-output -passes="vplan-driver" -vplan-dump-debug-loc -vplan-print-after-plain-cfg < %s 2>&1 | FileCheck %s --check-prefixes=CHECKPCFG
; RUN: opt -disable-output -passes="vplan-driver" -vplan-dump-debug-loc -vplan-print-after-vpentity-instrs < %s 2>&1 | FileCheck %s --check-prefixes=CHECKVPE
; RUN: opt -disable-output -passes="hir-ssa-deconstruction,hir-vec-dir-insert,vplan-driver-hir" -vplan-dump-debug-loc -vplan-print-after-plain-cfg < %s 2>&1 | FileCheck %s --check-prefixes=CHECKHIRPCFG
; RUN: opt -disable-output -passes="hir-ssa-deconstruction,hir-vec-dir-insert,vplan-driver-hir" -vplan-dump-debug-loc -vplan-print-after-vpentity-instrs < %s 2>&1 | FileCheck %s --check-prefixes=CHECKHIRVPE

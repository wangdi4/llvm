...
; RUN: opt -opaque-pointers=0 -S < %s -passes=vplan-vec -vplan-enable-soa-phis -disable-output -vplan-force-vf=2 -vplan-enable-soa -vplan-print-scalvec-results | FileCheck %s

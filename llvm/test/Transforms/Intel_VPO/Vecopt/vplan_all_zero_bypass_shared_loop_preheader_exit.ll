...
; CHECK-NEXT:      SUCCESSORS(2):all.zero.bypass.begin13(i1 [[VP4]]), [[BB2]](!i1 [[VP4]])
; CHECK-NEXT:      PREDECESSORS(2): [[BB2]] [[BB1]]
; CHECK-EMPTY:
;
; FIXME: Regions are overlapping here because the 1st loop region isn't
; extended. There should be one region for both loops.
;
; CHECK-NEXT:      all.zero.bypass.begin13:
; CHECK-NEXT:       [DA: Uni] i1 [[VP_ALL_ZERO_CHECK_1:%.*]] = all-zero-check i1 [[VP_CMP1]]
; CHECK-NEXT:      SUCCESSORS(2):all.zero.bypass.end15(i1 [[VP_ALL_ZERO_CHECK_1]]), [[BB3:BB[0-9]+]](!i1 [[VP_ALL_ZERO_CHECK_1]])
...
; CHECK-NEXT:       [DA: Uni] i32 [[VP6:%.*]] = phi  [ i32 [[VP_DIV]], [[BB3]] ],  [ i32 0, all.zero.bypass.begin9 ]
; CHECK-NEXT:      SUCCESSORS(1):[[BB4:BB[0-9]+]]
; CHECK-NEXT:      PREDECESSORS(2): all.zero.bypass.begin9 [[BB3]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB4]]:
; CHECK-NEXT:       [DA: Uni] i64 [[VP_INDVARS_IV37:%.*]] = phi  [ i64 0, all.zero.bypass.end11 ],  [ i64 [[VP_INDVARS_IV_NEXT38:%.*]], [[BB4]] ]
...
; CHECK-NEXT:       [DA: Uni] store i32 [[VP6]] i32* [[VP_PTRIDX10]]
...
; CHECK-NEXT:       [DA: Uni] i1 [[VP9:%.*]] = or i1 [[VP8]] i1 [[VP_EXITCOND39]]
; CHECK-NEXT:      SUCCESSORS(2):[[BB5:BB[0-9]+]](i1 [[VP9]]), [[BB4]](!i1 [[VP9]])

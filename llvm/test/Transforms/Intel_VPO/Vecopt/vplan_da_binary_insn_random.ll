...
; CHECK-NEXT:  Divergent: [Shape: Random] i64 [[VP_ADD_PHI:%.*]] = phi  [ i64 [[VP_ADD_PHI_IND_INIT:%.*]], [[BB3]] ],  [ i64 [[VP0:%.*]], [[BB2]] ]
; CHECK-EMPTY:
...
; CHECK-NEXT:  Divergent: [Shape: Random] i64 [[VP0]] = add i64 [[VP_ADD_PHI]] i64 [[VP1:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  Basic Block: [[BB2]]
; CHECK-NEXT:  Divergent: [Shape: Unit Stride, Stride: i64 1] i64 [[VP_FIRST_INDUCTION]] = add i64 [[VP_FIRST_INDUCTION_PHI]] i64 [[VP2:%.*]]
...
; CHECK-NEXT:  Uniform: [Shape: Uniform] i64 [[VP_ADD_PHI_IND_FINAL:%.*]] = induction-final{add} i64 0 i64 [[STEP0]]
; CHECK-EMPTY:

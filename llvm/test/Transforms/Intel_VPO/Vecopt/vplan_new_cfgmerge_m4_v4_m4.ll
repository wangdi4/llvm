...
; CHECK-NEXT:     [DA: Div] i64 [[VP_INDVARS_IV_2:%.*]] = phi  [ i64 [[VP5]], Cloned.Cloned.[[BB12]] ],  [ i64 [[VP_INDVARS_IV_NEXT_2:%.*]], Cloned.new_latch17 ]
; CHECK-NEXT:     [DA: Div] i1 [[VP_CMP_3:%.*]] = icmp ult i64 [[VP_INDVARS_IV_2]] i64 [[VP7]]
; CHECK-NEXT:     [DA: Uni] br Cloned.[[BB14:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB14]]: # preds: Cloned.Cloned.[[BB13]]
; CHECK-NEXT:     [DA: Div] i1 [[VP8:%.*]] = block-predicate i1 [[VP_CMP_3]]
...
; CHECK-NEXT:     [DA: Uni] i1 [[VP_CMP_4:%.*]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_2]] i64 [[VP7]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP_CMP_4]], Cloned.Cloned.[[BB13]], Cloned.Cloned.[[BB15:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.Cloned.[[BB15]]: # preds: Cloned.new_latch17
; CHECK-NEXT:     [DA: Uni] i64 [[VP9:%.*]] = induction-final{add} i64 live-in0 i64 1
...
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
; CHECK-NEXT:  Id: 0   no underlying for i64 [[VP9]]
; CHECK-EMPTY:

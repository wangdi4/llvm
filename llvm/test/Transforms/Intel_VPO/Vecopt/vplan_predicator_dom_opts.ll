...
; RUN: opt %s -VPlanDriver -enable-new-vplan-predicator=false -enable-vp-value-codegen=0 -vplan-predicator-report -disable-vplan-subregions=0 -disable-predicator-opts -S -o /dev/null | FileCheck %s -check-prefix=NOOPT
; RUN: opt %s -VPlanDriver -enable-new-vplan-predicator=false -enable-vp-value-codegen=0 -vplan-predicator-report -disable-vplan-subregions=0 -S -o /dev/null | FileCheck %s -check-prefix=OPT

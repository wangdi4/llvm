...
; RUN: opt %s -VPlanDriver -enable-new-vplan-predicator=false -vplan-predicator-report -disable-predicator-opts -S -o /dev/null | FileCheck %s -check-prefix=NOOPT
; RUN: opt %s -VPlanDriver -enable-new-vplan-predicator=false -vplan-predicator-report -S -o /dev/null | FileCheck %s -check-prefix=OPT
...
; NOOPT-NEXT:      [[BP6:BP[0-9]+]] = [[BP5]] || [[IFF1]]
; NOOPT-NEXT:  End of the Predicator report.
; NOOPT-NEXT:  Predicator report
; NOOPT-NEXT:  [[REGION1]]:
; NOOPT-NEXT:    [[BB7:BB[0-9]+]]:
; NOOPT-NEXT:      [[BP7:BP[0-9]+]] = [[IFT0]]
; NOOPT-NEXT:      [[IFF2:IfF[0-9]+]] = [[BP7]] && !i1 [[VP1:%.*]]
; NOOPT-NEXT:      [[IFT3:IfT[0-9]+]] = [[BP7]] && i1 [[VP1]]
; NOOPT-NEXT:    [[BB8:BB[0-9]+]]:
; NOOPT-NEXT:      [[BP8:BP[0-9]+]] = [[IFF2]]
; NOOPT-NEXT:    [[BB9:BB[0-9]+]]:
; NOOPT-NEXT:      [[BP9:BP[0-9]+]] = [[IFT3]]
...
; NOOPT-NEXT:      [[IFF4:IfF[0-9]+]] = [[BP11]] && !i1 [[VP2:%.*]]
; NOOPT-NEXT:      [[IFT5:IfT[0-9]+]] = [[BP11]] && i1 [[VP2]]
; NOOPT-NEXT:    [[BB12:BB[0-9]+]]:
; NOOPT-NEXT:      [[BP12:BP[0-9]+]] = [[IFF4]]
; NOOPT-NEXT:    [[BB13:BB[0-9]+]]:
; NOOPT-NEXT:      [[BP13:BP[0-9]+]] = [[IFT5]]
...
; OPT-NEXT:      [[IFF3:IfF[0-9]+]] = [[BP4]] && !i1 [[VP1:%.*]]
; OPT-NEXT:      [[IFT4:IfT[0-9]+]] = [[BP4]] && i1 [[VP1]]
; OPT-NEXT:    [[BB5:BB[0-9]+]]:
; OPT-NEXT:      [[BP6:BP[0-9]+]] = [[IFF3]]
; OPT-NEXT:    [[BB6:BB[0-9]+]]:
; OPT-NEXT:      [[BP7:BP[0-9]+]] = [[IFT4]]
; OPT-NEXT:    [[BB7:BB[0-9]+]]:
...
; OPT-NEXT:    [[BB8:BB[0-9]+]]:
; OPT-NEXT:      [[IFT0]] = i1 [[VP2:%.*]]
; OPT-NEXT:      [[IFF5:IfF[0-9]+]] = !i1 [[VP2]]
; OPT-NEXT:    [[REGION0]]:
; OPT-NEXT:      [[IFT0]] = i1 [[VP2]]
; OPT-NEXT:    [[BB9:BB[0-9]+]]:
; OPT-NEXT:      [[BP5]] = [[IFT0]]

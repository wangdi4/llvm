...
; CHECK-NEXT:    Linked values: i64 [[VP7]], i64 [[VP6]], i64 [[VP__IND_INIT:%.*]], i64 [[VP__IND_FINAL:%.*]],
; CHECK:       Compress/expand idiom list
; CHECK-NEXT:    Phi: i32 [[VP9:%.*]] = phi  [ i32 [[J_0160]], [[BB1:BB[0-9]+]] ],  [ i32 [[VP10:%.*]], [[BB2:BB[0-9]+]] ]
; CHECK-NEXT:    LiveIn: i32 [[J_0160]]
; CHECK-NEXT:    Increments:
; CHECK-NEXT:      i32 [[VP8:%.*]] = add i32 [[VP9]] i32 1 (Stride = 1)
; CHECK-NEXT:    Loads:
; CHECK-NEXT:      double** [[VP_SUBSCRIPT:%.*]] = subscript inbounds double** [[B20]] i64 [[VP11:%.*]]
; CHECK-NEXT:    Indices:
; CHECK-NEXT:      i64 [[VP11]] = sext i32 [[VP9]] to i64
; CHECK-EMPTY:
; CHECK-NEXT:    Linked values: i32 [[VP9]], i32 [[J_0160]], i32 [[VP8]], double** [[VP_SUBSCRIPT]], i64 [[VP11]],
...
; CHECK-NEXT:     i32 [[VP9]] = phi  [ i32 [[J_0160]], [[BB1]] ],  [ i32 [[VP10]], [[BB2]] ]
...
; CHECK-NEXT:       i64 [[VP11]] = sext i32 [[VP9]] to i64
; CHECK-NEXT:       double** [[VP_SUBSCRIPT]] = subscript inbounds double** [[B20]] i64 [[VP11]]
; CHECK-NEXT:       double* [[VP_LOAD_1:%.*]] = load double** [[VP_SUBSCRIPT]]
...
; CHECK-NEXT:       double* [[VP_SUBSCRIPT_3:%.*]] = subscript inbounds double* [[VP_LOAD_1]] i64 [[VP14]]
; CHECK-NEXT:       store double [[VP_LOAD_2]] double* [[VP_SUBSCRIPT_3]]
; CHECK-NEXT:       i32 [[VP8]] = add i32 [[VP9]] i32 1
; CHECK-NEXT:       br [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]: # preds: [[BB4]], [[BB0]]
; CHECK-NEXT:     i32 [[VP10]] = phi  [ i32 [[VP8]], [[BB4]] ],  [ i32 [[VP9]], [[BB0]] ]
; CHECK-NEXT:     i64 [[VP6]] = add i64 [[VP7]] i64 [[VP__IND_INIT_STEP]]
; CHECK-NEXT:     i1 [[VP15:%.*]] = icmp slt i64 [[VP6]] i64 [[VP12]]

...
; CHECK-NEXT:     i32 [[VP18]] = compress-expand-index-inc i32 [[VP8]] i1 [[VP9]] i32 1
...
; CHECK-NEXT:        |   [[EXP_LOAD0:%.*]] = @llvm.masked.expandload.v8p0f64(&((double**)([[B20]])[%phi.temp]),  [[DOTVEC10]],  undef)

...
; CHECK-EMPTY:
; CHECK-NEXT:    Linked values: i32 [[VP8]], i32 [[J_0160]], i32 [[VP10]], ptr [[VP_LOAD]], i64 [[VP11]],
...
; CHECK-NEXT:     ptr [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds ptr [[C0:%.*]] i64 [[VP7]]
...
; CHECK-NEXT:       i64 [[VP11]] = sext i32 [[VP8]] to i64
; CHECK-NEXT:       ptr [[VP_SUBSCRIPT]] = subscript inbounds ptr [[B20]] i64 [[VP11]]
; CHECK-NEXT:       ptr [[VP17:%.*]] = expand-load ptr [[VP_SUBSCRIPT]]
; CHECK-NEXT:       ptr [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds ptr [[A0:%.*]] i64 [[VP7]]
; CHECK-NEXT:       double [[VP_LOAD_2:%.*]] = load ptr [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:       i64 [[VP14:%.*]] = sext i32 [[T0:%.*]] to i64
; CHECK-NEXT:       ptr [[VP_SUBSCRIPT_3:%.*]] = subscript inbounds ptr [[VP17]] i64 [[VP14]]
; CHECK-NEXT:       store double [[VP_LOAD_2]] ptr [[VP_SUBSCRIPT_3]]
; CHECK-NEXT:       br [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]: # preds: [[BB4]], [[BB0]]
; CHECK-NEXT:     i1 [[VP9:%.*]] = phi  [ i1 true, [[BB4]] ],  [ i1 false, [[BB0]] ]
; CHECK-NEXT:     i32 [[VP18]] = compress-expand-index-inc {stride: 1} i32 [[VP8]] i1 [[VP9]]
...
; CHECK-NEXT:        |   [[EXP_LOAD0:%.*]] = @llvm.masked.expandload.v8p0(&((ptr)([[B20]])[%phi.temp]),  [[DOTVEC10]],  poison)
...
define dso_local void @_Z3fooPdPrS_S1_Piii(ptr noalias nocapture noundef readonly %A, ptr noalias nocapture noundef readnone %B1, ptr noalias nocapture noundef readonly %B2, ptr noalias nocapture noundef readonly %C, i32 noundef %N, i32 noundef %t) local_unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx5 = getelementptr inbounds ptr, ptr %B2, i64 %idxprom4

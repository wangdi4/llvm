...
; RUN: opt -vector-library=SVML -hir-ssa-deconstruction -hir-framework -VPlanDriverHIR -vplan-force-vf=4 -vplan-force-uf=2 -vplan-print-after-unroll -print-after=VPlanDriverHIR -disable-output < %s 2>&1 | FileCheck %s
...
; CHECK-NEXT:           |   %__svml_sinf4 = @__svml_sinf4(%.vec);
; CHECK-NEXT:           |   (<4 x float>*)(%a)[i1] = %__svml_sinf4;
; CHECK-NEXT:           |   %.vec = (<4 x float>*)(%a)[i1 + 4];
; CHECK-NEXT:           |   %__svml_sinf4 = @__svml_sinf4(%.vec);
; CHECK-NEXT:           |   (<4 x float>*)(%a)[i1 + 4] = %__svml_sinf4;
; CHECK-NEXT:           + END LOOP

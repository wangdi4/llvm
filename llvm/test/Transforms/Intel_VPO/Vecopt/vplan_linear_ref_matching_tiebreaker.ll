...
omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.2, %omp.inner.for.body
  ...
  %call = call noundef i64 @_Z3fooiRl(i32 noundef 2, i64* noundef nonnull align 8 dereferenceable(8) %arrayidx) #2
  %arrayidx6 = getelementptr inbounds [128 x i64], [128 x i64]* %b, i64 0, i64 %mul
  store i64 %call, i64* %arrayidx6, align 16
...
declare dso_local noundef i64 @_Z3fooiRl(i32 noundef, i64* noundef nonnull align 8 dereferenceable(8)) local_unnamed_addr #3

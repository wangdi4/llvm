...
; CHECK-NEXT:     [DA: Div] i1 [[VP5:%.*]] = icmp ult i32 [[VP_IV]] i32 128
...
; CHECK-NEXT:     [DA: Div] i1 [[VP_BOTTOM_TEST:%.*]] = icmp ult i32 [[VP_IV_NEXT]] i32 128
; CHECK-NEXT:     [DA: Uni] i1 [[VP6:%.*]] = all-zero-check i1 [[VP_BOTTOM_TEST]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP6]], Cloned.[[BB8:BB[0-9]+]], Cloned.[[BB2]]
; CHECK-EMPTY:
...
; CHECK-NEXT:  Id: 0     [[LCSSA_PHI0:%.*]] = phi i32 [ [[ADD0:%.*]], [[LATCH0:%.*]] ] i32 [[VP7]] -> i32 [[ADD0]]
; CHECK-EMPTY:

...
; RUN: opt -S < %s -VPlanDriver -disable-output -vplan-print-after-linearization -disable-vplan-subregions=0 -enable-vp-value-codegen=0 -disable-vplan-codegen | FileCheck %s --check-prefixes=CHECK,CHECK-LLVM
; RUN: opt -S < %s -VPlanDriver -disable-output -vplan-print-after-linearization -disable-vplan-subregions=0 -enable-vp-value-codegen=1 -disable-vplan-codegen | FileCheck %s --check-prefixes=CHECK,CHECK-VPVALUE

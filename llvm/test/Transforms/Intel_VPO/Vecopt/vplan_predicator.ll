...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB10]]:
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP5:%.*]] = induction-final{add} i32 0 i32 1
...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB15]]:
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP7:%.*]] = induction-final{add} i32 0 i32 1
...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB11]]:
; CHECK-NEXT:     [DA: Divergent] i1 [[VP6:%.*]] = block-predicate i1 [[VP_BB12_BR_VP_LOOP_MASK]]
...
; CHECK-NEXT:     Condition([[BB12]]): [DA: Uniform]   i1 [[VP8]] = all-zero-check i1 [[VP_LOOP_MASK_NEXT]]
; CHECK-NEXT:    SUCCESSORS(2):[[BB13:BB[0-9]+]](i1 [[VP8]]), [[BB7]](!i1 [[VP8]])
; CHECK-NEXT:    PREDECESSORS(1): [[BB12]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB13]]:
...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB17]]:
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP11:%.*]] = induction-final{add} i32 0 i32 1
...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB10]]:
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP6:%.*]] = induction-final{add} i32 0 i32 1
; CHECK-NEXT:    SUCCESSORS(1):[[BB11:BB[0-9]+]]
; CHECK-NEXT:    PREDECESSORS(1): [[BB3]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB11]]:

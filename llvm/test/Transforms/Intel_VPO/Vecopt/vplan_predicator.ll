...
; RUN: opt -S < %s -VPlanDriver -disable-output -vplan-print-after-linearization -disable-vplan-subregions=0 -enable-vp-value-codegen=0 | FileCheck %s --check-prefixes=CHECK,CHECK-LLVM
; RUN: opt -S < %s -VPlanDriver -disable-output -vplan-print-after-linearization -disable-vplan-subregions=0 -enable-vp-value-codegen=1 | FileCheck %s --check-prefixes=CHECK,CHECK-VPVALUE

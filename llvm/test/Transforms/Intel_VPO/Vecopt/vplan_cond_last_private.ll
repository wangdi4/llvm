...
; CHECK-NEXT:    call void @llvm.masked.store.v4i32.p0(<4 x i32> [[VEC_PHI]], ptr [[PRIV_IDX_MEM_VEC]], i32 1, <4 x i1> [[TMP1]])
; CHECK-NEXT:    call void @llvm.masked.store.v4i8.p0(<4 x i8> [[BROADCAST_SPLAT]], ptr [[RET_LPRIV_VEC]], i32 1, <4 x i1> [[TMP1]])
...
; CHECK-NEXT:    [[WIDE_LOAD6:%.*]] = load <4 x i32>, ptr [[PRIV_IDX_MEM_VEC]], align 1

...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [10000 x i32], ptr @a, i64 0, i64 %0
  %1 = load i32, ptr %arrayidx, align 4, !tbaa !2
  %2 = add nuw nsw i64 %0, 1
  %arrayidx3 = getelementptr inbounds [10000 x i32], ptr @a, i64 0, i64 %2
  %3 = load i32, ptr %arrayidx3, align 4, !tbaa !2
  %4 = add nuw nsw i64 %0, 2
  %arrayidx8 = getelementptr inbounds [10000 x i32], ptr @a, i64 0, i64 %4

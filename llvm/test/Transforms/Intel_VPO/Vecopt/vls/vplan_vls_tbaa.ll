...
; RUN: opt -tbaa -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -hir-cg -mem2reg -S < %s -vplan-enable-new-cfg-merge-hir=0 | FileCheck %s
; RUN: opt -tbaa -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -hir-cg -mem2reg -S < %s -vplan-enable-new-cfg-merge-hir=1 | FileCheck %s

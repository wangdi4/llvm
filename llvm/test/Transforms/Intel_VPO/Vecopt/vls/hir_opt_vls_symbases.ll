; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-vec-dir-insert,print<hir>,hir-vplan-vec,print<hir>' -vplan-force-vf=4 -disable-output -hir-details < %s 2>&1 | FileCheck %s

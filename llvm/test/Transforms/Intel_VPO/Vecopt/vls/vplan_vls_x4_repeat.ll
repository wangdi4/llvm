...
; CHECK-NEXT:    [[SCALAR_GEP:%.*]] = getelementptr inbounds i32, ptr [[ARY:%.*]], i64 [[DOTEXTRACT_0_]]
; CHECK-NEXT:    [[SCALAR_GEP4:%.*]] = getelementptr i32, ptr [[SCALAR_GEP]], i64 -3
; CHECK-NEXT:    [[VLS_LOAD:%.*]] = load <16 x i32>, ptr [[SCALAR_GEP4]], align 4
...
; CHECK-NEXT:    [[SCALAR_GEP5:%.*]] = getelementptr inbounds i32, ptr [[ARY]], i64 [[UNI_PHI3:%.*]]
; CHECK-NEXT:    [[MM_VECTORGEP:%.*]] = getelementptr inbounds i32, <4 x ptr> [[BROADCAST_SPLAT:%.*]], <4 x i64> [[VEC_PHI]]
...
; CHECK-NEXT:    [[MM_VECTORGEP6:%.*]] = getelementptr inbounds i32, <4 x ptr> [[BROADCAST_SPLAT]], <4 x i64> [[TMP4]]
...
; CHECK-NEXT:    [[MM_VECTORGEP7:%.*]] = getelementptr inbounds i32, <4 x ptr> [[BROADCAST_SPLAT]], <4 x i64> [[TMP7]]
; CHECK-NEXT:    [[TMP8:%.*]] = add nsw <4 x i32> [[VP_L4]], <i32 55, i32 55, i32 55, i32 55>
; CHECK-NEXT:    [[WIDE_MASKED_GATHER8:%.*]] = call <4 x i32> @llvm.masked.gather.v4i32.v4p0(<4 x ptr> [[MM_VECTORGEP6]], i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>, <4 x i32> poison)
; CHECK-NEXT:    [[TMP9:%.*]] = add nsw <4 x i32> [[WIDE_MASKED_GATHER8]], <i32 66, i32 66, i32 66, i32 66>
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i32.v4p0(<4 x i32> [[TMP2]], <4 x ptr> [[MM_VECTORGEP7]], i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>)
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i32.v4p0(<4 x i32> [[TMP3]], <4 x ptr> [[MM_VECTORGEP6]], i32 4, <4 x i1> <i1 true, i1 true, i1 true, i1 true>)
; CHECK-NEXT:    [[EXTENDED_:%.*]] = shufflevector <4 x i32> [[TMP6]], <4 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; CHECK-NEXT:    [[EXTENDED_9:%.*]] = shufflevector <4 x i32> [[TMP9]], <4 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; CHECK-NEXT:    [[EXTENDED_10:%.*]] = shufflevector <4 x i32> [[TMP8]], <4 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; CHECK-NEXT:    [[EXTENDED_11:%.*]] = shufflevector <4 x i32> [[TMP5]], <4 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
...
; CHECK-NEXT:    store <16 x i32> [[TMP13]], ptr [[SCALAR_GEP5]], align 4
;
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %p0 = getelementptr inbounds i32, ptr %ary, i64 %i0
  %l0 = load i32, ptr %p0, align 4
  %t0 = add nsw i32 %l0, 11

  ; ld: stmt 1 (ary + 0)
  %p1 = getelementptr inbounds i32, ptr %ary, i64 %indvars.iv
  ...
  %p4 = getelementptr inbounds i32, ptr %ary, i64 %i4
  ...
  ; st: stmt 0 (ary + 1)
  store i32 %t0, ptr %p4, align 4

  ; st: stmt 1 (ary + 2)
  store i32 %t1, ptr %p2, align 4

  ; st: stmt 2 (ary + 3)
  store i32 %t2, ptr %p0, align 4

  ; st: stmt 3 (ary + 0)
  store i32 %t3, ptr %p1, align 4

  ; st: stmt 4 (ary + 2)
  store i32 %t4, ptr %p2, align 4

  ; st: stmt 5 (ary + 1)
  store i32 %t5, ptr %p4, align 4

...
; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -hir-vplan-vec -vplan-force-vf=4 -enable-vplan-vls-cg -enable-vp-value-codegen-hir -disable-output -print-after=hir-vplan-vec -tbaa < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec" -vplan-force-vf=4 -enable-vplan-vls-cg -enable-vp-value-codegen-hir -disable-output -print-after=hir-vplan-vec < %s 2>&1 | FileCheck %s

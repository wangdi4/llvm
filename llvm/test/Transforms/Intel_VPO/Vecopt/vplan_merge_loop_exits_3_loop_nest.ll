...
; CHECK-NEXT:       [DA: Divergent] i32 [[VP_EXIT_ID_PHI:%.*]] = phi  [ i32 0, [[BB9]] ],  [ i32 1, [[INTERMEDIATE_BB1]] ],  [ i32 2, [[INTERMEDIATE_BB2]] ]
...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_EXIT_ID_PHI_SSA_PHI:%.*]] = phi  [ i32 [[VP_EXIT_ID_PHI]], [[BB11]] ],  [ i32 undef, [[INTERMEDIATE_BB0]] ],  [ i32 [[VP_EXIT_ID_PHI]], [[INTERMEDIATE_BB3]] ]
...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_EXIT_ID_PHI_1:%.*]] = phi  [ i32 0, [[BB11]] ],  [ i32 1, [[INTERMEDIATE_BB0]] ],  [ i32 2, [[INTERMEDIATE_BB3]] ]
...
; CHECK-NEXT:     [DA: Divergent] i1 [[VP1:%.*]] = icmp i32 [[VP_EXIT_ID_PHI_1]] i32 1
...
; CHECK-NEXT:       [DA: Divergent] i1 [[VP2:%.*]] = icmp i32 [[VP_EXIT_ID_PHI_1]] i32 2
...
; CHECK-NEXT:         [DA: Divergent] i1 [[VP3:%.*]] = icmp i32 [[VP_EXIT_ID_PHI_SSA_PHI]] i32 2

...
DIR.OMP.SIMD.1:                                   ; preds = %entry
  %y.init = load i32, ptr @y, align 4
  store i32 %y.init, ptr %y.linear.ptr, align 4
  br label %omp.region.entry

omp.region.entry:                                 ; preds = %DIR.OMP.SIMD.1
  %i3 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.LINEAR:TYPED"(ptr %y.linear.ptr, i32 0, i32 1, i32 %step), "QUAL.OMP.LINEAR:IV.TYPED"(ptr %i.linear.iv.ptr, i32 0, i32 1, i32 1) ]
...
omp.inner.for.body:                               ; preds = %omp.inner.for.body, %omp.region.entry
  ...
  %y = load i32, ptr %y.linear.ptr, align 4
  %i = load i32, ptr %i.linear.iv.ptr, align 4
  %x.ptr = getelementptr inbounds [10 x i32], ptr @x, i64 0, i32 %i
  store i32 %y, ptr %x.ptr, align 4
...
DIR.OMP.END.SIMD.1:                               ; preds = %omp.region.exit
  %y.last = load i32, ptr %y.linear.ptr, align 4
  store i32 %y.last, ptr @y, align 4

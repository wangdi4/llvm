...
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,vplan-driver-hir" -disable-output -vplan-print-after-plain-cfg < %s 2>&1 | FileCheck %s

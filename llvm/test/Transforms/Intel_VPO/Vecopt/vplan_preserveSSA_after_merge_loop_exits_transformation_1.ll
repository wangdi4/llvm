...
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP_DEF_PHI:%.*]] = phi  [ i32 0, [[BB4]] ],  [ i32 [[VP_DEF_SSA_PHI:%.*]], [[NEW_LOOP_LATCH0]] ]
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB6]]:
; CHECK-NEXT:       [DA: Uniform]   i32 [[VP_DEF:%.*]] = add i32 [[VP_INNER_LOOP_INDUCTION_PHI]] i32 2
...
; CHECK-NEXT:         [DA: Uniform]   i32 [[VP_LIVE_OUT:%.*]] = phi  [ i32 [[VP_VAR2]], [[BB7]] ]
; CHECK-NEXT:        SUCCESSORS(1):[[NEW_LOOP_LATCH0]]
...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_LIVE_OUT_SSA_PHI:%.*]] = phi  [ i32 undef, [[BB8]] ],  [ i32 undef, [[INTERMEDIATE_BB0]] ],  [ i32 [[VP_LIVE_OUT]], [[INTERMEDIATE_BB1]] ]
...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_DEF_SSA_PHI]] = phi  [ i32 [[VP_DEF]], [[BB8]] ],  [ i32 undef, [[INTERMEDIATE_BB0]] ],  [ i32 [[VP_DEF]], [[INTERMEDIATE_BB1]] ]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_EXIT_ID_PHI]] = phi  [ i32 [[VP0]], [[BB8]] ],  [ i32 1, [[INTERMEDIATE_BB0]] ],  [ i32 2, [[INTERMEDIATE_BB1]] ]
; CHECK-NEXT:     [DA: Divergent] i1 [[VP_TAKE_BACKEDGE_COND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB8]] ],  [ i1 false, [[INTERMEDIATE_BB0]] ],  [ i1 false, [[INTERMEDIATE_BB1]] ]
...
; CHECK-NEXT:    SUCCESSORS(2):[[BB9:BB[0-9]+]](i1 [[VP1]]), [[CASCADED_IF_BLOCK1:cascaded.if.block[0-9]+]](!i1 [[VP1]])
...
; CHECK-NEXT:      SUCCESSORS(2):[[BB10:BB[0-9]+]](i1 [[VP2]]), [[BB11:BB[0-9]+]](!i1 [[VP2]])
...
; CHECK-EMPTY:
; CHECK-NEXT:        [[BB10]]:
; CHECK-NEXT:         [DA: Uniform]   i32 [[VP_VAR3:%.*]] = add i32 [[VP_LIVE_OUT_SSA_PHI]] i32 2
; CHECK-NEXT:        SUCCESSORS(1):[[BB3]]
; CHECK-NEXT:        PREDECESSORS(1): [[CASCADED_IF_BLOCK1]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB9]]:

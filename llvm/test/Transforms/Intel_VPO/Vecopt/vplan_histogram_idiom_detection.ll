...
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT:%.*]] = subscript inbounds i32* [[B0:%.*]] i64 [[VP2]]
; CHECK-NEXT:     i32 [[VP_LOAD:%.*]] = load i32* [[VP_SUBSCRIPT]]
; CHECK-NEXT:     i64 [[VP4:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     float* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds float* [[A0:%.*]] i64 [[VP4]]
; CHECK-NEXT:     float [[VP_LOAD_1:%.*]] = load float* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:     float [[VP5:%.*]] = fadd float [[VP_LOAD_1]] float 2.000000e+00
; CHECK-NEXT:     i64 [[VP6:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     float* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds float* [[A0]] i64 [[VP6]]
; CHECK-NEXT:     store float [[VP5]] float* [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:     i64 [[VP3]] = add i64 [[VP2]] i64 1
; CHECK-NEXT:     i1 [[VP7:%.*]] = icmp sle i64 [[VP3]] i64 1023
...
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds i32* [[A0]] i64 [[VP8]]
...
define dso_local void @foo3(i32* noalias nocapture %A, i32* noalias nocapture readonly %B, i32* noalias nocapture readonly %C, i32* noalias nocapture readonly %D, i32* noalias nocapture readonly %E, i32 %N) local_unnamed_addr #0 {
; CHECK-LABEL:  VPlan after VPlanHIRDecomposer:
...
; CHECK-NEXT:     i32 [[VP_LOAD:%.*]] = load i32* [[VP_SUBSCRIPT]]
; CHECK-NEXT:     i64 [[VP8:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds i32* [[A0:%.*]] i64 [[VP8]]
; CHECK-NEXT:     i32 [[VP_LOAD_1:%.*]] = load i32* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:     i32 [[VP_LOAD_2:%.*]] = load i32* [[C0:%.*]]
...
; CHECK-NEXT:     i32 [[VP9:%.*]] = add i32 [[VP_LOAD_1]] i32 [[VP_LOAD_4]]
; CHECK-NEXT:     i32 [[VP10:%.*]] = mul i32 [[VP_LOAD_3]] i32 [[VP_LOAD_2]]
; CHECK-NEXT:     i32 [[VP11:%.*]] = add i32 [[VP9]] i32 [[VP10]]
; CHECK-NEXT:     i64 [[VP12:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_4:%.*]] = subscript inbounds i32* [[A0]] i64 [[VP12]]
; CHECK-NEXT:     store i32 [[VP11]] i32* [[VP_SUBSCRIPT_4]]
; CHECK-NEXT:     i64 [[VP7]] = add i64 [[VP6]] i64 1
; CHECK-NEXT:     i1 [[VP13:%.*]] = icmp sle i64 [[VP7]] i64 [[VP1]]
...
; CHECK-NEXT:     i64 [[VP6:%.*]] = sext i32 [[VP5]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds i32* [[A0:%.*]] i64 [[VP6]]
; CHECK-NEXT:     i32 [[VP_LOAD_1:%.*]] = load i32* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:     i32 [[VP7:%.*]] = add i32 [[VP_LOAD_1]] i32 100
; CHECK-NEXT:     i32 [[VP8:%.*]] = add i32 [[VP_LOAD]] i32 2
; CHECK-NEXT:     i64 [[VP9:%.*]] = sext i32 [[VP8]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds i32* [[A0]] i64 [[VP9]]
; CHECK-NEXT:     store i32 [[VP7]] i32* [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:     i64 [[VP4]] = add i64 [[VP3]] i64 1
; CHECK-NEXT:     i1 [[VP10:%.*]] = icmp sle i64 [[VP4]] i64 [[VP2]]
...
; Function Attrs: nofree norecurse nosync nounwind uwtable mustprogress
define dso_local void @foo5(i32* noalias nocapture %A, i32* noalias nocapture readonly %B, i32 %N) local_unnamed_addr #0 {
; CHECK-LABEL:  VPlan after VPlanHIRDecomposer:
...
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds i32* [[A0:%.*]] i64 [[VP5]]
; CHECK-NEXT:     i32 [[VP_LOAD_1:%.*]] = load i32* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:     i32 [[VP6:%.*]] = add i32 [[VP_LOAD_1]] i32 -100
...
; CHECK-NEXT:     i64 [[VP4]] = add i64 [[VP3]] i64 1
; CHECK-NEXT:     i1 [[VP8:%.*]] = icmp sle i64 [[VP4]] i64 [[VP0]]
...
; Function Attrs: nofree norecurse nosync nounwind uwtable mustprogress
define dso_local void @foo6(i32* noalias nocapture %A, i32* noalias nocapture readonly %B, i32* noalias nocapture %C, i32* noalias nocapture readonly %D, i32 %N) local_unnamed_addr #0 {
; CHECK-LABEL:  VPlan after VPlanHIRDecomposer:
...
; CHECK-NEXT:     i32 [[VP_LOAD:%.*]] = load i32* [[VP_SUBSCRIPT]]
; CHECK-NEXT:     i64 [[VP7:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds i32* [[A0:%.*]] i64 [[VP7]]
; CHECK-NEXT:     i32 [[VP_LOAD_1:%.*]] = load i32* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:     i32 [[VP8:%.*]] = add i32 [[VP_LOAD_1]] i32 100
...
; CHECK-NEXT:     i64 [[VP10:%.*]] = sext i32 [[VP_LOAD_2]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_4:%.*]] = subscript inbounds i32* [[C0:%.*]] i64 [[VP10]]
; CHECK-NEXT:     i32 [[VP_LOAD_3:%.*]] = load i32* [[VP_SUBSCRIPT_4]]
; CHECK-NEXT:     i32 [[VP11:%.*]] = add i32 [[VP_LOAD_3]] i32 500
; CHECK-NEXT:     i64 [[VP12:%.*]] = sext i32 [[VP_LOAD_2]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_5:%.*]] = subscript inbounds i32* [[C0]] i64 [[VP12]]
; CHECK-NEXT:     store i32 [[VP11]] i32* [[VP_SUBSCRIPT_5]]
; CHECK-NEXT:     i64 [[VP6]] = add i64 [[VP5]] i64 1
; CHECK-NEXT:     i1 [[VP13:%.*]] = icmp sle i64 [[VP6]] i64 [[VP1]]
; CHECK-NEXT:     br i1 [[VP13]], [[BB2]], [[BB3:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]: # preds: [[BB2]]
; CHECK-NEXT:     br [[BB4:BB[0-9]+]]
...
; Function Attrs: nofree norecurse nosync nounwind uwtable mustprogress
define dso_local void @foo7(i32* noalias nocapture %A, i32* noalias nocapture readonly %B, i32* noalias nocapture %C, i32 %N) local_unnamed_addr #0 {
; CHECK-LABEL:  VPlan after VPlanHIRDecomposer:
...
; CHECK-NEXT:     store i32 [[VP7]] i32* [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:     i64 [[VP9:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_3:%.*]] = subscript inbounds i32* [[C0:%.*]] i64 [[VP9]]
; CHECK-NEXT:     i32 [[VP_LOAD_2:%.*]] = load i32* [[VP_SUBSCRIPT_3]]
; CHECK-NEXT:     i32 [[VP10:%.*]] = add i32 [[VP_LOAD_2]] i32 500
; CHECK-NEXT:     i64 [[VP11:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_4:%.*]] = subscript inbounds i32* [[C0]] i64 [[VP11]]
; CHECK-NEXT:     store i32 [[VP10]] i32* [[VP_SUBSCRIPT_4]]
; CHECK-NEXT:     i64 [[VP5]] = add i64 [[VP4]] i64 1
; CHECK-NEXT:     i1 [[VP12:%.*]] = icmp sle i64 [[VP5]] i64 [[VP2]]
...
; Function Attrs: nofree norecurse nosync nounwind uwtable mustprogress
define dso_local void @foo8(i32* noalias nocapture %A, i32* noalias nocapture readonly %B, i32 %N) local_unnamed_addr #1 {
; CHECK-LABEL:  VPlan after VPlanHIRDecomposer:
...
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds i32* [[A0:%.*]] i64 [[VP6]]
; CHECK-NEXT:     i32 [[VP_LOAD_1:%.*]] = load i32* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:     i32 [[VP7:%.*]] = add i32 [[VP_LOAD_1]] i32 [[CALL0:%.*]]
; CHECK-NEXT:     i64 [[VP8:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds i32* [[A0]] i64 [[VP8]]
; CHECK-NEXT:     store i32 [[VP7]] i32* [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:     i64 [[VP5]] = add i64 [[VP4]] i64 1
; CHECK-NEXT:     i1 [[VP9:%.*]] = icmp sle i64 [[VP5]] i64 [[VP2]]
; CHECK-NEXT:     br i1 [[VP9]], [[BB2]], [[BB3:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]: # preds: [[BB2]]
; CHECK-NEXT:     br [[BB4:BB[0-9]+]]
...
define dso_local void @foo9(i32* noalias nocapture %A, i32* noalias nocapture readonly %B, i32* noalias nocapture %D, i32* noalias nocapture readonly %E, i32 %N) local_unnamed_addr #0 {
;
; CHECK-LABEL:  VPlan after VPlanHIRDecomposer:
; CHECK-NEXT:  VPlan IR for: foo9:HIR
; CHECK-NEXT:  External Defs Start:
; CHECK-DAG:     [[VP0:%.*]] = {%0}
; CHECK-DAG:     [[VP1:%.*]] = {%D}
; CHECK-DAG:     [[VP2:%.*]] = {zext.i32.i64(%N) + -1}
...
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds i32* [[A0:%.*]] i64 [[VP7]]
; CHECK-NEXT:     i32 [[VP_LOAD_1:%.*]] = load i32* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:     i32 [[VP8:%.*]] = add i32 [[VP_LOAD_1]] i32 [[TMP0:%.*]]
; CHECK-NEXT:     i64 [[VP9:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds i32* [[A0]] i64 [[VP9]]
; CHECK-NEXT:     store i32 [[VP8]] i32* [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_3:%.*]] = subscript inbounds i32* [[D0:%.*]] i64 [[VP5]]
; CHECK-NEXT:     i32 [[VP_LOAD_2:%.*]] = load i32* [[VP_SUBSCRIPT_3]]
; CHECK-NEXT:     i32 [[VP10:%.*]] = add i32 [[TMP0]] i32 [[VP_LOAD_2]]
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_4:%.*]] = subscript inbounds i32* [[D0]] i64 [[VP5]]
; CHECK-NEXT:     store i32 [[VP10]] i32* [[VP_SUBSCRIPT_4]]
; CHECK-NEXT:     i64 [[VP6]] = add i64 [[VP5]] i64 1
; CHECK-NEXT:     i1 [[VP11:%.*]] = icmp sle i64 [[VP6]] i64 [[VP2]]
...
define dso_local void @foo10(i32* noalias nocapture %A, i32* noalias nocapture readonly %B, i32* noalias nocapture %D, i32* noalias nocapture readonly %E, i32 %N) local_unnamed_addr #0 {
; CHECK-LABEL:  VPlan after VPlanHIRDecomposer:
; CHECK-NEXT:  VPlan IR for: foo10:HIR
; CHECK-NEXT:  External Defs Start:
; CHECK-DAG:     [[VP0:%.*]] = {%D}
; CHECK-DAG:     [[VP1:%.*]] = {%0}
; CHECK-DAG:     [[VP2:%.*]] = {%B}

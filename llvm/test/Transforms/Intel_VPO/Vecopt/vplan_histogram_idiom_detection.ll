...
; CHECK-NEXT:     float [[VP_GENERAL_MEM_OPT_CONFLICT:%.*]] = vp-general-mem-opt-conflict i64 [[VP_VCONFLICT_INDEX]] void [[VP_CONFLICT_REGION:%.*]] float [[VP_LOAD_1]] float 2.000000e+00 -> VConflictRegion (float [[VP_LIVE_IN0:%.*]] float [[VP_LIVE_IN1:%.*]] ) {
...
; CHECK-NEXT:     i32 [[VP_GENERAL_MEM_OPT_CONFLICT:%.*]] = vp-general-mem-opt-conflict i64 [[VP_VCONFLICT_INDEX]] void [[VP_CONFLICT_REGION:%.*]] i32 [[VP_LOAD_1]] i32 100 -> VConflictRegion (i32 [[VP_LIVE_IN0:%.*]] i32 [[VP_LIVE_IN1:%.*]] ) {
; CHECK-NEXT:      value : none
; CHECK-NEXT:      mask : none
; CHECK-NEXT:      live-in : i32 [[VP_LIVE_IN0]]
; CHECK-NEXT:      live-in : i32 [[VP_LIVE_IN1]]
...
; CHECK-NEXT:     i32 [[VP_GENERAL_MEM_OPT_CONFLICT_1:%.*]] = vp-general-mem-opt-conflict i64 [[VP_VCONFLICT_INDEX_1]] void [[VP_CONFLICT_REGION_1:%.*]] i32 [[VP_LOAD_3]] i32 500 -> VConflictRegion (i32 [[VP_LIVE_IN0_1:%.*]] i32 [[VP_LIVE_IN1_1:%.*]] ) {
; CHECK-NEXT:      value : none
; CHECK-NEXT:      mask : none
...
; CHECK-NEXT:     i32 [[VP_GENERAL_MEM_OPT_CONFLICT_1:%.*]] = vp-general-mem-opt-conflict i64 [[VP_VCONFLICT_INDEX_1]] void [[VP_CONFLICT_REGION_1:%.*]] i32 [[VP_LOAD_2]] i32 500 -> VConflictRegion (i32 [[VP_LIVE_IN0_1:%.*]] i32 [[VP_LIVE_IN1_1:%.*]] ) {
; CHECK-NEXT:      value : none
; CHECK-NEXT:      mask : none
; CHECK-NEXT:      live-in : i32 [[VP_LIVE_IN0_1]]
; CHECK-NEXT:      live-in : i32 [[VP_LIVE_IN1_1]]
...
; CHECK-NEXT:     i64 [[VP5]] = add i64 [[VP4]] i64 1
; CHECK-NEXT:     i1 [[VP10:%.*]] = icmp sle i64 [[VP5]] i64 [[VP3]]
...
; CHECK-NEXT:     i64 [[VP6:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds i32* [[A0]] i64 [[VP6]]
; CHECK-NEXT:     i32 [[VP_GENERAL_MEM_OPT_CONFLICT:%.*]] = vp-general-mem-opt-conflict i64 [[VP_VCONFLICT_INDEX]] void [[VP_CONFLICT_REGION:%.*]] i32 [[VP_LOAD_1]] i32 [[CALL0:%.*]] -> VConflictRegion (i32 [[VP_LIVE_IN0:%.*]] i32 [[VP_LIVE_IN1:%.*]] ) {
; CHECK-NEXT:      value : none
; CHECK-NEXT:      mask : none
; CHECK-NEXT:      live-in : i32 [[VP_LIVE_IN0]]
; CHECK-NEXT:      live-in : i32 [[VP_LIVE_IN1]]
...
; CHECK-NEXT:     i64 [[VP7:%.*]] = sext i32 [[VP_LOAD]] to i64
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds i32* [[A0]] i64 [[VP7]]
; CHECK-NEXT:     i32 [[VP_GENERAL_MEM_OPT_CONFLICT:%.*]] = vp-general-mem-opt-conflict i64 [[VP_VCONFLICT_INDEX]] void [[VP_CONFLICT_REGION:%.*]] i32 [[VP_LOAD_1]] i32 [[TMP0:%.*]] -> VConflictRegion (i32 [[VP_LIVE_IN0:%.*]] i32 [[VP_LIVE_IN1:%.*]] ) {
; CHECK-NEXT:      value : none
; CHECK-NEXT:      mask : none
; CHECK-NEXT:      live-in : i32 [[VP_LIVE_IN0]]
; CHECK-NEXT:      live-in : i32 [[VP_LIVE_IN1]]
...
; CHECK-NEXT:     i64 [[VP6]] = add i64 [[VP5]] i64 1
; CHECK-NEXT:     i1 [[VP10:%.*]] = icmp sle i64 [[VP6]] i64 [[VP1]]
; CHECK-NEXT:     br i1 [[VP10]], [[BB2]], [[BB3:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]: # preds: [[BB2]]
; CHECK-NEXT:     br [[BB4:BB[0-9]+]]

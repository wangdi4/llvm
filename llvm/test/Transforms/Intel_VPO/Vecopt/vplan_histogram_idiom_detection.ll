...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -S -mattr=+avx512vl,+avx512cd -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec' -vplan-print-after-hir-decomposer -vplan-force-vf=2 -disable-output < %s 2>&1 | FileCheck %s

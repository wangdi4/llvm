...
; RUN: opt -opaque-pointers=0 -passes='vplan-pragma-omp-ordered-simd-extract,vpo-cfg-restructuring,vplan-vec,vpo-directive-cleanup,always-inline' -vplan-force-vf=2 -S < %s 2>&1 | FileCheck %s

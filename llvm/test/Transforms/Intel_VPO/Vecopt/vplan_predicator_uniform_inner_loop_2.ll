...
; REQUIRES: asserts
; RUN: opt -S < %s -VPlanDriver -disable-output -vplan-print-after-linearization -enable-vp-value-codegen=0 | FileCheck %s --check-prefixes=CHECK,CHECK-LLVM
; R UN: opt -S < %s -VPlanDriver -disable-output -vplan-print-after-linearization -enable-vp-value-codegen=1 | FileCheck %s --check-prefixes=CHECK,CHECK-VPVALUE
...
; CHECK-NEXT:       [DA: Uniform]   i32 [[VP_I1_014:%.*]] = phi  [ i32 [[VP_INC:%.*]], [[BB8:BB[0-9]+]] ],  [ i32 0, [[BB6]] ]

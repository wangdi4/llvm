...
; RUN: opt -vplan-enable-soa=false < %s -S -vplan-pragma-omp-ordered-simd-extract -vpo-cfg-restructuring -vplan-vec -vplan-force-vf=2 -VPODirectiveCleanup -always-inline 2>&1 | FileCheck %s

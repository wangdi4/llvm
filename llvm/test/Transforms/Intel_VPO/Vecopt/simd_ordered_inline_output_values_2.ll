...
; CHECK-NEXT:    [[UNI_PHI10:%.*]] = phi i64 [ [[TMP3:%.*]], [[VECTOR_BODY0]] ], [ 0, [[VECTOR_PH0]] ]
; CHECK-NEXT:    [[VEC_PHI0:%.*]] = phi <2 x i64> [ [[TMP2:%.*]], [[VECTOR_BODY0]] ], [ <i64 0, i64 1>, [[VECTOR_PH0]] ]
...
; CHECK-NEXT:    [[VAL_I30:%.*]] = load i32, i32* [[MM_VECTORGEP_EXTRACT_1_0]], align 4
; CHECK-NEXT:    store i32 [[VAL_I30]], i32* [[VAL_LOC_VEC_BASE_ADDR_EXTRACT_1_0]], align 4
...
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast i32* [[MM_VECTORGEP_EXTRACT_0_0]] to <2 x i32>*
; CHECK-NEXT:    store <2 x i32> [[WIDE_LOAD0]], <2 x i32>* [[TMP1]], align 4
...
; CHECK-NEXT:    [[BC_RESUME_VAL0:%.*]] = phi i64 [ 0, [[FOR_BODY_PREHEADER0]] ], [ [[TMP7]], [[MIDDLE_BLOCK0]] ]
...
; CHECK-NEXT:    [[VAL_I20:%.*]] = load i32, i32* [[ARRAYIDX0]], align 4
; CHECK-NEXT:    store i32 [[VAL_I20]], i32* [[VAL_LOC0]], align 4

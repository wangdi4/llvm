...
; CHECK-LABEL: entry:
; CHECK-NEXT: {{.*}} = alloca [2 x [1024 x i32]], align 16
...
define dso_local i32 @_Z10getElementi(i32 %RetIdx) local_unnamed_addr #0 {
entry:
  ...
  store i32 1023, i32* %.omp.ub, align 4, !tbaa !2
...
for.body:                                         ; preds = %for.body, %omp.inner.for.body
  ...
  %arrayidx = getelementptr inbounds [1024 x i32], [1024 x i32]* @arr, i64 0, i64 %indvars.iv, !intel-tbaa !6
  store i32 %mul2, i32* %arrayidx, align 4, !tbaa !6
...
omp.inner.for.cond.omp.loop.exit_crit_edge:       ; preds = %omp.inner.for.inc
  ...
  store i32 1024, i32* @j, align 4, !tbaa !2
  store i32 %storemerge10.lcssa, i32* @i, align 4, !tbaa !2
  store i32 %add3.lcssa, i32* %.omp.iv, align 4, !tbaa !2
...
DIR.OMP.END.SIMD.4:                               ; preds = %DIR.OMP.END.SIMD.3
  ...
  %arrayidx5 = getelementptr inbounds [1024 x i32], [1024 x i32]* @arr, i64 0, i64 %idxprom4, !intel-tbaa !6

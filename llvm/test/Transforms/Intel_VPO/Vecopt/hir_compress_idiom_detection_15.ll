; RUN: opt %s -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -disable-output -debug-only=parvec-analysis -enable-compress-expand-idiom -hir-vplan-vec -vplan-print-after-plain-cfg -vplan-print-after-vpentity-instrs -vplan-entities-dump -print-after=hir-vplan-vec -vplan-force-vf=16 2>&1 | FileCheck %s
...
; CHECK-NEXT:      i32 [[VP8:%.*]] = add i32 [[VP6]] i32 5 (Stride = 5)
; CHECK-NEXT:    Stores:
...
; CM4: Cost 6 for i32 [[VP15:%.*]] = compress-expand-index-inc i32 [[VP1:%.*]]
...
; CM8: Cost 7 for i32 [[VP15:%.*]] = compress-expand-index-inc i32 [[VP1:%.*]]

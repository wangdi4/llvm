...
; CHECK-NEXT:       i32 [[VP21:%.*]] = compress-expand-index-inc i32 [[VP6]] i32 5
; CHECK-NEXT:       br [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]: # preds: [[BB4]], [[BB0]]
; CHECK-NEXT:     i32 [[VP7]] = phi  [ i32 [[VP21]], [[BB4]] ],  [ i32 [[VP6]], [[BB0]] ]
...
; CHECK-NEXT:     i32 [[VP22:%.*]] = compress-expand-index-final i32 [[VP7]]

...
; CHECK: call <2 x i64> @_ZGVbN2vlv_3foolll
...
DIR.OMP.SIMD.1:                                   ; preds = %omp.inner.for.body.lr.ph
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 2), "QUAL.OMP.LINEAR:IV"(i64* %i.linear.iv, i32 1

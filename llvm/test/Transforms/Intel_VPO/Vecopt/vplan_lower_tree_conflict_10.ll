...
define dso_local void @foo(double* noalias nocapture noundef %A, i8* nocapture noundef readonly %B, double* noalias nocapture noundef readonly %C, i32 noundef %N) local_unnamed_addr #0 {
;
; double A[N], C[N];
...
; CHECK-VF4-NEXT:           |   |   [[UNIFCOND250:%.*]] = extractelement [[DOTVEC200]],  0
; CHECK-VF4-NEXT:           |   |   if ([[UNIFCOND250]] == 1)
; CHECK-VF4-NEXT:           |   |   {
...
; CHECK-VF4-NEXT:           |   [[DOTVEC260:%.*]] = [[DOTVEC20]]  +  [[PHI_TEMP0]]
; CHECK-VF4-NEXT:           |   (<4 x double>*)([[A0]])[[[DOTVEC0]]] = [[DOTVEC260]]
; CHECK-VF4-NEXT:           + END LOOP
; CHECK-VF4-NEXT:        }
;
...
; CHECK-VF8-NEXT:           |   (<8 x double>*)([[A0]])[[[DOTVEC0]]] = [[DOTVEC260]]
; CHECK-VF8-NEXT:           + END LOOP
; CHECK-VF8-NEXT:        }
;
entry:

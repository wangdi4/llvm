...
define dso_local void @foo(double* noalias nocapture noundef %A, i8* nocapture noundef readonly %B, double* noalias nocapture noundef readonly %C) local_unnamed_addr #0 {
;
; double A[8], C[8];

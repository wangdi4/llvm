...
; RUN: opt -VPlanDriver -vplan-force-vf=4 -disable-output -vplan-print-after-linearization < %s 2>&1 | FileCheck %s
...
; CHECK-NEXT:     [DA: Uni] i1 [[VP_EXITCOND:%.*]] = icmp eq i64 [[VP_IV_NEXT]] i64 [[VP_VECTOR_TRIP_COUNT]]

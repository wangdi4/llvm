...
; CHECK:       VPlannedBB28:
; CHECK-NEXT:    [[UNI_PHI29:%.*]] = phi i64 [ [[UNI_PHI25]], [[VPLANNEDBB27]] ], [ [[TMP36:%.*]], [[CLONED_NEW_LATCH19:%.*]] ]
; CHECK-NEXT:    [[VEC_PHI30:%.*]] = phi <4 x i64> [ [[TMP30]], [[VPLANNEDBB27]] ], [ [[TMP35:%.*]], [[CLONED_NEW_LATCH19]] ]

...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_ADD6_2:%.*]] = add i32 [[VP2]] i32 [[VP_ADD6_1]]
; CHECK-NEXT:     [DA: Divergent] i64 [[VP_INDVARS_IV_NEXT_2:%.*]] = add i64 [[VP_INDVARS_IV_NEXT_1]] i64 [[VP0]]
...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP3:%.*]] = load i32* [[VP_ARRAYIDX_2]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_ADD6]] = add i32 [[VP3]] i32 [[VP_ADD6_2]]
; CHECK-NEXT:     [DA: Divergent] i64 [[VP_INDVARS_IV_NEXT]] = add i64 [[VP_INDVARS_IV_NEXT_2]] i64 [[VP0]]
...
; CHECK-NEXT:    [[BC_MERGE_REDUCTION0:%.*]] = phi i32 [ 0, [[DIR_OMP_SIMD_10]] ], [ [[TMP16]], [[MIDDLE_BLOCK0]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL0:%.*]] = phi i64 [ 0, [[DIR_OMP_SIMD_10]] ], [ [[TMP18]], [[MIDDLE_BLOCK0]] ]

...
; RUN: opt -S < %s -VPlanDriver -loop-simplify --vplan-force-vf=4 --vplan-force-uf=3 \
...
; CHECK-NEXT:    [[TMP10:%.*]] = icmp uge i64 [[TMP9]], [[N_VEC0]]
...
; CHECK-NEXT:    [[TMP15:%.*]] = icmp uge i64 [[TMP14]], [[N_VEC0]]

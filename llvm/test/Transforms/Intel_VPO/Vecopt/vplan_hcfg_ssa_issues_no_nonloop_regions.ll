...
; FIXME: Enable code-gen once predicator is fixed to not generate broken VPlan!
...
; CHECK-NEXT:      [[BB10]] (BP: NULL) :
;
; FIXME: Incoming value on BB9 should be "false"!
;
; CHECK-NEXT:       [DA: Uniform]   i1 [[VP_BB7_BR_VP_SIDEEXIT_CMP_NOT_PHI_BB9:%.*]] = phi  [ i1 [[VP_BB7_BR_VP_SIDEEXIT_CMP_NOT_PHI_BB9]], [[BB9]] ],  [ i1 [[VP_BB7_BR_VP_SIDEEXIT_CMP_NOT]], [[BB11]] ]

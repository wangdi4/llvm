...
; CHECK-NEXT:        LiveOut: i32 [[VP9:%.*]] = phi  [ i32 [[VP7]], [[BB1:BB[0-9]+]] ],  [ i32 [[VP8]], [[BB0]] ]
; CHECK-NEXT:    Stores:
; CHECK-NEXT:      store double [[VP_LOAD:%.*]] double* [[VP_SUBSCRIPT:%.*]]
; CHECK-NEXT:    Indices:
; CHECK-NEXT:      i32 [[VP8]] = phi  [ i32 [[J_0150]], [[BB2:BB[0-9]+]] ],  [ i32 [[VP9]], [[BB3:BB[0-9]+]] ]
; CHECK-EMPTY:
; CHECK-NEXT:    Linked values: i32 [[VP7]], i32 [[VP8]], i32 [[J_0150]], i32 [[VP9]], void [[VP_STORE:%.*]],

; CHECK:         [[BB2:BB[0-9]+]]: # preds:
; CHECK-NEXT:     br [[BB3:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]: # preds: [[BB2]]
; CHECK-NEXT:     i64 [[VP10:%.*]] = add i64 [[VP1:%.*]] i64 1
; CHECK-NEXT:     i64 [[VP__IND_INIT]] = induction-init{add} i64 0 i64 1
; CHECK-NEXT:     i64 [[VP__IND_INIT_STEP]] = induction-init-step{add} i64 1
; CHECK-NEXT:     br [[BB0]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB0]]: # preds: [[BB3]], [[BB4:BB[0-9]+]]
; CHECK-NEXT:     i32 [[VP8]] = phi  [ i32 [[J_0150]], [[BB3]] ],  [ i32 [[VP9]], [[BB4]] ]
; CHECK-NEXT:     i64 [[VP6]] = phi  [ i64 [[VP__IND_INIT]], [[BB3]] ],  [ i64 [[VP5]], [[BB4]] ]
...
; CHECK-NEXT:       br [[BB4]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB4]]: # preds: [[BB1]], [[BB0]]
; CHECK-NEXT:     i32 [[VP9]] = phi  [ i32 [[VP7]], [[BB1]] ],  [ i32 [[VP8]], [[BB0]] ]

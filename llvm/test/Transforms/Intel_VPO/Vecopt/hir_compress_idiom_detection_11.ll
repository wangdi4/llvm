...
; CHECK-NEXT:     i32 [[VP7]] = phi  [ i32 [[VP15]], [[BB1]] ],  [ i32 [[VP16:%.*]], [[BB2]] ]
...
; CHECK-NEXT:       i32 [[VP17:%.*]] = compress-expand-index-inc i32 [[VP7]] i32 1
; CHECK-NEXT:       br [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]: # preds: [[BB3]], [[BB0]]
; CHECK-NEXT:     i32 [[VP8]] = phi  [ i32 [[VP17]], [[BB3]] ],  [ i32 [[VP7]], [[BB0]] ]

...
; RUN: opt -S -VPlanDriver -disable-output -debug-only=ovls < %s 2>&1 | FileCheck %s
; REQUIRES: asserts
...
; CHECK-EMPTY:
; CHECK-NEXT:    Printing Groups- Total Groups 2
; CHECK-NEXT:    Group#1:
; CHECK-NEXT:      Vector Length(in bytes): 64
; CHECK-NEXT:      AccType: SStore, Stride (in bytes): 48
; CHECK-NEXT:      AccessMask(per byte, R to L): 
; CHECK-NEXT:     #2 <4 x 32> SStore: store i32 1 i32* [[VP_P1]]
; CHECK-NEXT:     #3 <4 x 32> SStore: store i32 3 i32* [[VP_P2]]
; CHECK-NEXT:    Group#2:
; CHECK-NEXT:      Vector Length(in bytes): 64

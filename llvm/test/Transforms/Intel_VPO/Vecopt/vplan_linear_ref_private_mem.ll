...
DIR.OMP.SIMD.1:                                   ; preds = %DIR.OMP.SIMD.123
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 8), "QUAL.OMP.LINEAR:IV"(i32* %i.linear.iv, i32 1) ]
...
omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.2, %omp.inner.for.body
  ...
  store i32 %.omp.iv.local.016, i32* %i.linear.iv, align 4
  %call = call noundef i32 @_Z3fooRi(i32* noundef nonnull align 4 dereferenceable(4) %i.linear.iv)
  %3 = load i32, i32* %i.linear.iv, align 4
...
declare dso_local noundef i32 @_Z3fooRi(i32* noundef nonnull align 4 dereferenceable(4)) #3

...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -disable-output -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -vplan-entities-dump -enable-mmindex=1  -disable-nonlinear-mmindex=0 -vplan-print-after-vpentity-instrs -vplan-print-after-plain-cfg -vplan-force-vf=4 -S < %s 2>&1 | FileCheck %s

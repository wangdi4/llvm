...
for.body:
  ...
  %ld.i32.idx = getelementptr inbounds [1024 x i32], ptr @arr.i32.1, i64 0, i64 %idx
  %ld.i32 = load i32, ptr %ld.i32.idx

  %ld.i32.idx.2 = getelementptr inbounds [1024 x i32], ptr @arr.i32.2, i64 0, i64 %idx
  %ld.i32.2 = load i32, ptr %ld.i32.idx.2

  %ld.i32.idx.3 = getelementptr inbounds [1024 x i32], ptr @arr.i32.3, i64 0, i64 %idx
  %ld.i32.3 = load i32, ptr %ld.i32.idx.3

  %div.1 = sdiv i32 %ld.i32, %ld.i32.2
  %div.2 = sdiv i32 %div.1, %ld.i32.3


  %st.i32.idx = getelementptr inbounds [1024 x i32], ptr @arr.i32.4, i64 0, i64 %idx
  store i32 %div.2, ptr %st.i32.idx

...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_INC:%.*]] = add i32 [[VP2]] i32 1
; CHECK-NEXT:     [DA: Divergent] store i32 [[VP_INC]] i32* [[VP_ARRAYIDX]]
...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_INC_1:%.*]] = add i32 [[VP3]] i32 1
; CHECK-NEXT:     [DA: Divergent] store i32 [[VP_INC_1]] i32* [[VP_ARRAYIDX_1]]
; CHECK-NEXT:     [DA: Divergent] i64 [[VP_INDVARS_IV_NEXT]] = add i64 [[VP_INDVARS_IV_NEXT_1]] i64 [[VP1]]
...
; CHECK-NEXT:    [[VEC_PHI0:%.*]] = phi <2 x i64> [ <i64 0, i64 1>, [[VECTOR_PH0]] ], [ [[TMP9:%.*]], [[VECTOR_BODY0]] ]
...
; CHECK-NEXT:    [[TMP5:%.*]] = icmp eq <2 x i64> [[TMP3]], [[BROADCAST_SPLAT0]]
; CHECK-NEXT:    [[SCALAR_GEP10:%.*]] = getelementptr inbounds i32, i32* [[A0]], i64 [[TMP4]]
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i32* [[SCALAR_GEP10]] to <2 x i32>*
; CHECK-NEXT:    [[WIDE_LOAD20:%.*]] = load <2 x i32>, <2 x i32>* [[TMP6]], align 4
; CHECK-NEXT:    [[TMP7:%.*]] = add nsw <2 x i32> [[WIDE_LOAD20]], <i32 1, i32 1>
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i32* [[SCALAR_GEP10]] to <2 x i32>*
...
; CHECK-NEXT:    [[TMP11:%.*]] = icmp eq <2 x i64> [[TMP9]], [[BROADCAST_SPLAT0]]
; CHECK-NEXT:    [[DOTEXTRACT_0_0:%.*]] = extractelement <2 x i1> [[TMP11]], i32 0
...
; CHECK-NEXT:    [[INC0:%.*]] = add nsw i32 [[TMP15]], 1

...
; CHECK-NEXT:    [[UNI_PHI0:%.*]] = phi i64 [ 0, [[VECTOR_PH0]] ], [ [[TMP13:%.*]], [[VPLANNEDBB40:%.*]] ]
; CHECK-NEXT:    [[UNI_PHI30:%.*]] = phi i64 [ 0, [[VECTOR_PH0]] ], [ [[TMP12:%.*]], [[VPLANNEDBB40]] ]
; CHECK-NEXT:    [[VEC_PHI0:%.*]] = phi <2 x i64> [ <i64 0, i64 1>, [[VECTOR_PH0]] ], [ [[TMP11:%.*]], [[VPLANNEDBB40]] ]
...
; CHECK-NEXT:    [[TMP2:%.*]] = add nsw <2 x i32> [[WIDE_LOAD0]], <i32 1, i32 1>
...
; CHECK-NEXT:    [[TMP5:%.*]] = add nuw nsw i64 [[UNI_PHI30]], 2
; CHECK-NEXT:    [[TMP6:%.*]] = add i64 [[UNI_PHI0]], 2
...
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i32* [[SCALAR_GEP50]] to <2 x i32>*
; CHECK-NEXT:    [[WIDE_LOAD60:%.*]] = load <2 x i32>, <2 x i32>* [[TMP8]], align 4
; CHECK-NEXT:    [[TMP9:%.*]] = add nsw <2 x i32> [[WIDE_LOAD60]], <i32 1, i32 1>
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i32* [[SCALAR_GEP50]] to <2 x i32>*
; CHECK-NEXT:    store <2 x i32> [[TMP9]], <2 x i32>* [[TMP10]], align 4
; CHECK-NEXT:    [[TMP11]] = add nuw nsw <2 x i64> [[TMP4]], <i64 2, i64 2>
; CHECK-NEXT:    [[TMP12]] = add nuw nsw i64 [[TMP5]], 2
; CHECK-NEXT:    [[TMP13]] = add i64 [[TMP6]], 2
...
; CHECK-NEXT:    [[TMP17:%.*]] = icmp ne i64 [[WIDE_TRIP_COUNT0]], [[N_VEC0]]
; CHECK-NEXT:    br i1 [[TMP17]], label [[SCALAR_PH0]], label [[VPLANNEDBB80:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  scalar.ph:
; CHECK-NEXT:    [[UNI_PHI90:%.*]] = phi i64 [ [[TMP16]], [[MIDDLE_BLOCK0]] ], [ 0, [[VPLANNEDBB10]] ]
...
; CHECK-NEXT:    [[UNI_PHI110:%.*]] = phi i64 [ [[TMP16]], [[MIDDLE_BLOCK0]] ], [ [[INDVARS_IV_NEXT0:%.*]], [[VPLANNEDBB8_LOOPEXIT0:%.*]] ]
...
; CHECK-NEXT:    [[INDVARS_IV0:%.*]] = phi i64 [ [[UNI_PHI90]], [[VPLANNEDBB100]] ], [ [[INDVARS_IV_NEXT0]], [[OMP_INNER_FOR_BODY0]] ]

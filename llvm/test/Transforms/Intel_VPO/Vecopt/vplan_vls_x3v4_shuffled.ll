...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <4 x i64> [ <i64 0, i64 3, i64 6, i64 9>, [[VECTOR_PH]] ], [ [[TMP8:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP8]] = add nuw nsw <4 x i64> [[VEC_PHI]], <i64 12, i64 12, i64 12, i64 12>
; CHECK-NEXT:    [[TMP9]] = add nuw nsw i64 [[UNI_PHI]], 12
; CHECK-NEXT:    [[TMP10:%.*]] = icmp ult <4 x i64> [[TMP8]], <i64 1024, i64 1024, i64 1024, i64 1024>
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <4 x i1> [[TMP10]], i32 0
; CHECK-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 4
; CHECK-NEXT:    [[TMP12:%.*]] = icmp eq i64 [[INDEX_NEXT]], 340

...
define dso_local noalias double** @alloc_matrix(double** %0, i32 noundef %m) local_unnamed_addr #0 {
entry:
  %load_initial = load double*, double** %0, align 8
  %cmp18 = icmp sgt i32 %m, 1
  br i1 %cmp18, label %for.body, label %for.end

for.body:                                         ; preds = %entry, %for.body
  %store_forwarded = phi double* [ %load_initial, %entry ], [ %add.ptr, %for.body ]
  %indvars.iv = phi i64 [ 1, %entry ], [ %indvars.iv.next, %for.body ]
  %idx.ext = sext i32 %m to i64
  %add.ptr = getelementptr inbounds double, double* %store_forwarded, i64 %idx.ext
  %arrayidx6 = getelementptr inbounds double*, double** %0, i64 %indvars.iv
  store double* %add.ptr, double** %arrayidx6, align 8

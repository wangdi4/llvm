...
; CHECK-NEXT:    [[VEC_PHI0:%.*]] = phi <2 x i32> [ [[TMP8:%.*]], [[VECTOR_BODY0]] ], [ <i32 0, i32 1>, [[VECTOR_PH0]] ]
; CHECK-NEXT:    [[TMP0:%.*]] = load i32 (i32)*, i32 (i32)** [[FUNC0]], align 8
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, i32* [[C0]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = call i32 (i32 (i32)*, ...) @__intel_indirect_call_i32(i32 (i32)* [[TMP0]], i32 [[TMP1]])
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x i32> undef, i32 [[TMP2]], i32 0
; CHECK-NEXT:    [[TMP4:%.*]] = call i32 (i32 (i32)*, ...) @__intel_indirect_call_i32(i32 (i32)* [[TMP0]], i32 [[TMP1]])
...
; CHECK-NEXT:    [[TMP8]] = add nsw <2 x i32> [[VEC_PHI0]], <i32 2, i32 2>
; CHECK-NEXT:    [[TMP9]] = add nsw i32 [[UNI_PHI10]], 2
; CHECK-NEXT:    [[TMP10]] = add i32 [[UNI_PHI0]], 2
...
; CHECK-NEXT:    [[BC_RESUME_VAL0:%.*]] = phi i32 [ 0, [[PREHEADER0]] ], [ [[TMP13]], [[MIDDLE_BLOCK0]] ]
; CHECK-NEXT:    br label [[FOR_BODY0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  for.body:
; CHECK-NEXT:    [[IV_PHI0:%.*]] = phi i32 [ [[IV0:%.*]], [[FOR_BODY0]] ], [ [[BC_RESUME_VAL0]], [[SCALAR_PH0]] ]

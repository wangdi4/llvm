; RUN: opt %s -S -passes='hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec' --debug-only="VPlan_pragma_metadata" 2>&1 | FileCheck %s
; REQUIRES: asserts
;
...
; CHECK-NEXT: Vector Remainder was set by the user's #pragma vecremainder
;

...
; RUN: opt -passes=hir-ssa-deconstruction,hir-vplan-vec -vplan-print-after-create-in-merge -vplan-print-after-cfg-merge -vplan-vec-scenario="s1;v4;s1" -disable-vplan-codegen -disable-output < %s 2>&1 | FileCheck %s
...
; CHECK-NEXT:     [DA: Div, SVA: (F  )] ptr [[VP_SUBSCRIPT:%.*]] = subscript inbounds ptr [[A0:%.*]] i64 [[VP7]] (SVAOpBits 0->F 1->F 2->F 3->F )
...
; CHECK-NEXT:       [DA: Div] ptr [[VP_SUBSCRIPT]] = subscript inbounds ptr [[A0]] i64 [[VP7]]

...
; RUN: opt %s -S -hir-ssa-deconstruction -hir-vec-dir-insert -VPlanDriverHIR -vplan-force-vf=4 --debug-only=LoopVectorizationPlanner_vec_lengths 2>&1 | FileCheck %s
;
...
!8 = !{!"llvm.loop.vector.vectorlength", i64 8}

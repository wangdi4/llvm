...
bb155:                                            ; preds = %bb155, %bb106
  ...
  %tmp162 = load i16, i16* %tmp161, align 2, !tbaa !5, !alias.scope !917, !noalias !99
  %tmp163 = zext i16 %tmp162 to i32
  %tmp164 = add nsw i64 %tmp114, %tmp156
  %tmp165 = getelementptr inbounds i16, i16* %arg9, i64 %tmp164
  %tmp166 = load i16, i16* %tmp165, align 2, !tbaa !5, !alias.scope !915, !noalias !99
...
!8 = !{!"Simple C++ TBAA"}
!9 = distinct !{!9, !10}
!10 = distinct !{!"intel.optreport.rootnode", !11}
!11 = distinct !{!"intel.optreport", !12}

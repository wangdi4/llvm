...
; CHECK: [[GEP2:%.*]] = getelementptr inbounds <{ i32, i32, i8 addrspace(4)*, i32 addrspace(1)*, i32 }>, <2 x <{ i32, i32, i8 addrspace(4)*, i32 addrspace(1)*, i32 }>*> %11, <2 x i64> zeroinitializer, <2 x i32> zeroinitializer
; CHECK: call void @llvm.masked.scatter.v2i32.v2p0i32(<2 x i32> <i32 28, i32 28>, <2 x i32*> [[GEP2]], i32 8, <2 x i1> {{.*}})
; CHECK: [[GEP3:%.*]] = getelementptr inbounds <{ i32, i32, i8 addrspace(4)*, i32 addrspace(1)*, i32 }>, <2 x <{ i32, i32, i8 addrspace(4)*, i32 addrspace(1)*, i32 }>*> %11, <2 x i64> zeroinitializer, <2 x i32> <i32 1, i32 1>
; CHECK: call void @llvm.masked.scatter.v2i32.v2p0i32(<2 x i32> <i32 8, i32 8>, <2 x i32*> [[GEP3]], i32 4, <2 x i1> [[XOR]])
; CHECK: [[GEP4:%.*]] = getelementptr inbounds <{ i32, i32, i8 addrspace(4)*, i32 addrspace(1)*, i32 }>, <2 x <{ i32, i32, i8 addrspace(4)*, i32 addrspace(1)*, i32 }>*> %11, <2 x i64> zeroinitializer, <2 x i32> <i32 2, i32 2>

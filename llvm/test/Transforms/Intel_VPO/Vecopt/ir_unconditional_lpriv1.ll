...
; RUN: opt -S -VPlanDriver --vplan-print-after-live-inout-list -vplan-enable-all-liveouts %s | FileCheck %s
; RUN: opt -S -passes="vplan-driver" --vplan-print-after-live-inout-list -vplan-enable-all-liveouts %s | FileCheck %s
;

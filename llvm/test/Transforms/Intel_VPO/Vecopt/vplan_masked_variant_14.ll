...
; CHECK-NEXT:     [DA: Uni] i32 [[VP3:%.*]] = vector-trip-count i32 [[OUTER_TC0:%.*]], UF = 1
; CHECK-NEXT:     [DA: Uni] br Cloned.[[BB2:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB2]]: # preds: Cloned.[[BB1]], new_latch
; CHECK-NEXT:     [DA: Div] i32 [[VP_OUTER_IV:%.*]] = phi  [ i32 [[VP1]], Cloned.[[BB1]] ],  [ i32 [[VP_OUTER_IV_NEXT:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_ADD_PHI:%.*]] = phi  [ i32 [[VP0]], Cloned.[[BB1]] ],  [ i32 [[VP4:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i1 [[VP_OUTER_BOTTOM_TEST:%.*]] = icmp eq i32 [[VP_OUTER_IV]] i32 [[VP3]]
...
; CHECK-NEXT:     [DA: Div] i32 [[VP4]] = phi  [ i32 [[VP_ADD]], Cloned.[[BB6]] ],  [ i32 [[VP_ADD_PHI]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_OUTER_IV_NEXT]] = add i32 [[VP_OUTER_IV]] i32 [[VP2]]
; CHECK-NEXT:     [DA: Uni] i1 [[VP_OUTER_BOTTOM_TEST_1:%.*]] = icmp eq i32 [[VP_OUTER_IV_NEXT]] i32 [[VP3]]
...
; CHECK-NEXT:  Id: 0     [[LCSSA_ADD_PHI_10:%.*]] = phi i32 [ [[ADD0:%.*]], [[OUTER_LATCH0:%.*]] ] i32 [[VP5]] -> i32 [[ADD0]]
; CHECK-EMPTY:
; CHECK-NEXT:  Id: 1   no underlying for i32 [[VP6]]
; CHECK-EMPTY:
; CHECK-NEXT:  VPlan after emitting masked variant:
; CHECK-NEXT:  VPlan IR for: main:outer.header.cloned.masked
; CHECK-NEXT:    Cloned.[[BB9:BB[0-9]+]]: # preds:
; CHECK-NEXT:     [DA: Uni] br Cloned.[[BB10:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB10]]: # preds: Cloned.[[BB9]]
; CHECK-NEXT:     [DA: Div] i32 [[VP7:%.*]] = reduction-init i32 0 i32 live-in0
; CHECK-NEXT:     [DA: Div] i32 [[VP8:%.*]] = induction-init{add} i32 live-in1 i32 1
; CHECK-NEXT:     [DA: Uni] i32 [[VP9:%.*]] = induction-init-step{add} i32 1
; CHECK-NEXT:     [DA: Uni] i32 [[VP10:%.*]] = vector-trip-count i32 [[OUTER_TC0]], UF = 1
; CHECK-NEXT:     [DA: Uni] br Cloned.[[BB11:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB11]]: # preds: Cloned.[[BB10]], new_latch
; CHECK-NEXT:     [DA: Div] i32 [[VP_OUTER_IV_1:%.*]] = phi  [ i32 [[VP8]], Cloned.[[BB10]] ],  [ i32 [[VP_OUTER_IV_NEXT_1:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_ADD_PHI_1:%.*]] = phi  [ i32 [[VP7]], Cloned.[[BB10]] ],  [ i32 [[VP11:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i1 [[VP_OUTER_BOTTOM_TEST_2:%.*]] = icmp eq i32 [[VP_OUTER_IV_1]] i32 [[VP10]]
; CHECK-NEXT:     [DA: Div] br i1 [[VP_OUTER_BOTTOM_TEST_2]], [[BB12:BB[0-9]+]], new_latch
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB12]]: # preds: Cloned.[[BB11]]
; CHECK-NEXT:       [DA: Div] i32 [[VP_ADD_1:%.*]] = add i32 [[VP_ADD_PHI_1]] i32 2
; CHECK-NEXT:       [DA: Uni] br Cloned.[[BB13:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.[[BB13]]: # preds: Cloned.[[BB14:BB[0-9]+]], [[BB12]]
; CHECK-NEXT:       [DA: Uni] i32 [[VP_INNER_IV_1:%.*]] = phi  [ i32 0, [[BB12]] ],  [ i32 [[VP_INNER_IV_NEXT_1:%.*]], Cloned.[[BB14]] ]
; CHECK-NEXT:       [DA: Uni] br Cloned.[[BB14]]
; CHECK-EMPTY:
...
; CHECK-NEXT:       [DA: Uni] br i1 [[VP_INNER_BOTTOM_TEST_1]], Cloned.[[BB15:BB[0-9]+]], Cloned.[[BB13]]
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.[[BB15]]: # preds: Cloned.[[BB14]]
; CHECK-NEXT:       [DA: Uni] br new_latch
; CHECK-EMPTY:
; CHECK-NEXT:    new_latch: # preds: Cloned.[[BB15]], Cloned.[[BB11]]
; CHECK-NEXT:     [DA: Div] i32 [[VP11]] = phi  [ i32 [[VP_ADD_1]], Cloned.[[BB15]] ],  [ i32 [[VP_ADD_PHI_1]], Cloned.[[BB11]] ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_OUTER_IV_NEXT_1]] = add i32 [[VP_OUTER_IV_1]] i32 [[VP9]]
; CHECK-NEXT:     [DA: Uni] i1 [[VP_OUTER_BOTTOM_TEST_3:%.*]] = icmp eq i32 [[VP_OUTER_IV_NEXT_1]] i32 [[VP10]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP_OUTER_BOTTOM_TEST_3]], Cloned.[[BB16:BB[0-9]+]], Cloned.[[BB11]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB16]]: # preds: new_latch
; CHECK-NEXT:     [DA: Uni] i32 [[VP12:%.*]] = reduction-final{u_add} i32 [[VP11]]
...
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
; CHECK-NEXT:  Id: 0     [[LCSSA_ADD_PHI_10]] = phi i32 [ [[ADD0]], [[OUTER_LATCH0]] ] i32 [[VP12]] -> i32 [[ADD0]]
; CHECK-EMPTY:

...
;        making it unprofilable to vectorize the test regardless of
;        -vplan-cost-model-i1-bail-out-limit settings.  Updated CM might
;        cover the knob functionality making it and related code redundant.
;        https://jira.devtools.intel.com/browse/CMPLRLLVM-19696

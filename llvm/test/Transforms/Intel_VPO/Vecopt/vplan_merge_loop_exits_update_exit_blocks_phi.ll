...
; CHECK-NEXT:       i32 [[VP_INNER_LOOP_2_INDUCTION_SSA_PHI]] = phi  [ i32 [[VP_INNER_LOOP_2_INDUCTION]], [[BB10]] ],  [ i32 undef, [[INTERMEDIATE_BB1]] ],  [ i32 undef, [[INTERMEDIATE_BB2]] ],  [ i32 [[VP_INNER_LOOP_2_INDUCTION]], [[INTERMEDIATE_BB3]] ]
; CHECK-NEXT:       i32 [[VP_EXIT_ID_PHI:%.*]] = phi  [ i32 0, [[BB10]] ],  [ i32 1, [[INTERMEDIATE_BB1]] ],  [ i32 2, [[INTERMEDIATE_BB2]] ],  [ i32 3, [[INTERMEDIATE_BB3]] ]
; CHECK-NEXT:       i1 [[VP_TAKE_BACKEDGE_COND:%.*]] = phi  [ i1 true, [[BB10]] ],  [ i1 false, [[INTERMEDIATE_BB1]] ],  [ i1 false, [[INTERMEDIATE_BB2]] ],  [ i1 false, [[INTERMEDIATE_BB3]] ]
...
; CHECK-NEXT:         i32 [[VP_EXITBB1_PHI:%.*]] = phi  [ i32 1, [[BB5]] ],  [ i32 2, [[CASCADED_IF_BLOCK1]] ]
...
; CHECK-NEXT:       i32 [[VP_EXITBB2_PHI:%.*]] = phi  [ i32 3, [[CASCADED_IF_BLOCK0]] ],  [ i32 4, [[BB11]] ]
; CHECK-NEXT:      SUCCESSORS(1):[[NEW_LOOP_LATCH0]]
; CHECK-NEXT:      PREDECESSORS(2): [[BB11]] [[CASCADED_IF_BLOCK0]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[NEW_LOOP_LATCH0]]:
; CHECK-NEXT:     i32 [[VP_INNER_LOOP_1_INDUCTION_SSA_PHI]] = phi  [ i32 [[VP_INNER_LOOP_1_INDUCTION]], [[BB12]] ],  [ i32 undef, [[INTERMEDIATE_BB0]] ],  [ i32 undef, [[INTERMEDIATE_BB4]] ]
; CHECK-NEXT:     i32 [[VP_EXIT_ID_PHI_1:%.*]] = phi  [ i32 0, [[BB12]] ],  [ i32 1, [[INTERMEDIATE_BB0]] ],  [ i32 2, [[INTERMEDIATE_BB4]] ]
; CHECK-NEXT:     i1 [[VP_TAKE_BACKEDGE_COND_1:%.*]] = phi  [ i1 true, [[BB12]] ],  [ i1 false, [[INTERMEDIATE_BB0]] ],  [ i1 false, [[INTERMEDIATE_BB4]] ]

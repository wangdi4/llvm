...
; CHECK-NEXT:       [DA: Divergent] i32 [[VP_EXIT_ID_PHI:%.*]] = phi  [ i32 0, [[BB10]] ],  [ i32 1, [[INTERMEDIATE_BB1]] ],  [ i32 2, [[INTERMEDIATE_BB2]] ],  [ i32 3, [[INTERMEDIATE_BB3]] ]
...
; CHECK-NEXT:         [DA: Divergent] i1 [[VP1:%.*]] = icmp i32 [[VP_EXIT_ID_PHI]] i32 3
; CHECK-NEXT:        SUCCESSORS(2):[[BB11:BB[0-9]+]](i1 [[VP1]]), [[INTERMEDIATE_BB0]](!i1 [[VP1]])
...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_EXIT_ID_PHI_1:%.*]] = phi  [ i32 0, [[BB12]] ],  [ i32 1, [[INTERMEDIATE_BB0]] ],  [ i32 2, [[INTERMEDIATE_BB4]] ]
...
; CHECK-NEXT:    SUCCESSORS(2):[[BB13:BB[0-9]+]](i1 [[VP2]]), [[BB14:BB[0-9]+]](!i1 [[VP2]])

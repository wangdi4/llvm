; RUN: opt -tbaa -hir-ssa-deconstruction  -hir-vec-dir-insert -VPlanDriverHIR -disable-output -print-before=VPlanDriverHIR -print-after=VPlanDriverHIR -vplan-force-vf=4  -hir-details < %s 2>&1 | FileCheck %s

...
; RUN: opt -vplan-print-terminator-inst=false < %s -S -VPlanDriver  -mtriple=x86_64-unknown-unknown -mattr=+avx2 \
; RUN:     -vplan-cost-model-print-analysis-for-vf=8 -vplan-force-vf=8 -disable-output \
; RUN:     | FileCheck %s --check-prefix=VPLAN-CM-AVX2

; RUN: opt -vplan-print-terminator-inst=false < %s -S -VPlanDriver  -mtriple=x86_64-unknown-unknown -mattr=+sse2 \
; RUN:     -vplan-cost-model-print-analysis-for-vf=8 -vplan-force-vf=8 -disable-output \
; RUN:     | FileCheck %s --check-prefix=VPLAN-CM-SSE2

; RUN: opt -vplan-print-terminator-inst=false < %s -hir-ssa-deconstruction -hir-vec-dir-insert -VPlanDriverHIR \
...
; VPLAN-CM-AVX2-NEXT:  Total Cost: 15
...
; VPLAN-CM-AVX2-NEXT:  Analyzing VPBasicBlock [[BB2:BB[0-9]+]], total cost: 15
...
; VPLAN-CM-AVX2-NEXT:    Cost 2 for i1 [[VP_CMP:%.*]] = icmp sge i64 [[VP_LD]] i64 [[VP_LD2]]
...
; VPLAN-CM-AVX2-NEXT:    Cost 2 for i64 [[VP_VECTOR_LOOP_IV_NEXT]] = add i64 [[VP_VECTOR_LOOP_IV]] i64 [[VP_VF]]
; VPLAN-CM-AVX2-NEXT:    Cost 2 for i1 [[VP_VECTOR_LOOP_EXITCOND:%.*]] = icmp eq i64 [[VP_VECTOR_LOOP_IV_NEXT]] i64 [[VP_VECTOR_TRIP_COUNT]]
...
; VPLAN-CM-SSE2-NEXT:  Total Cost: 85
...
; VPLAN-CM-SSE2-NEXT:  Analyzing VPBasicBlock [[BB2:BB[0-9]+]], total cost: 85
...
; VPLAN-CM-SSE2-NEXT:    Cost 4 for i64 [[VP_VECTOR_LOOP_IV_NEXT]] = add i64 [[VP_VECTOR_LOOP_IV]] i64 [[VP_VF]]
; VPLAN-CM-SSE2-NEXT:    Cost 32 for i1 [[VP_VECTOR_LOOP_EXITCOND:%.*]] = icmp eq i64 [[VP_VECTOR_LOOP_IV_NEXT]] i64 [[VP_VECTOR_TRIP_COUNT]]
...
; VPLAN-HIR-CM-AVX2-NEXT:  Total VPlan Cost: 13
; VPLAN-HIR-CM-AVX2-NEXT:  VPlan Base Cost before adjustments: 13
...
; VPLAN-HIR-CM-SSE2-NEXT:  Total VPlan Cost: 81
; VPLAN-HIR-CM-SSE2-NEXT:  VPlan Base Cost before adjustments: 81

...
; REQUIRES: asserts
; RUN: opt -vplan-print-terminator-inst=false < %s -VPlanDriver -vplan-enable-all-zero-bypass-loops -vplan-print-after-all-zero-bypass -vplan-force-vf=4 -disable-output -S 2>&1 | FileCheck %s
; RUN: opt -vplan-print-terminator-inst=false < %s -passes="vplan-driver" -vplan-enable-all-zero-bypass-loops -vplan-print-after-all-zero-bypass -vplan-force-vf=4 -disable-output -S 2>&1 | FileCheck %s

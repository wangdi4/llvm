...
; CHECK-NEXT: Uniform: i1 [[VAL3:%vp[0-9]+]] = trunc i64 [[VAL4:%vp[0-9]+]]
; CHECK-LABEL: Basic Block: BB4
; CHECK-NEXT: Uniform: i32 [[VAL5:%vp[0-9]+]] = trunc i64 [[VAL4:%vp[0-9]+]]
...
; CHECK-NEXT: Divergent: float* [[VAL8:%vp[0-9]+]] = getelementptr float* [[VAL9:%vp[0-9]+]] i64 [[VAL1:%vp[0-9]+]]
...
; CHECK-NEXT: Uniform: i1 [[VAL10:%vp[0-9]+]] = icmp i64 [[VAL9:%vp[0-9]+]] i64 [[VAL4:%vp[0-9]+]]

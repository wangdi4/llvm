...
;
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec" -vplan-print-legality -vplan-print-after-vpentity-instrs -disable-output %s 2>&1 | FileCheck %s --check-prefix=HIR

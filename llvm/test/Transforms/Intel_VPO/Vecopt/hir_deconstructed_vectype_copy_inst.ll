...
; CHECK-NEXT:     [DA: Uni] i1 [[VP9:%.*]] = icmp slt i64 [[N00:%.*]] i64 [[N10:%.*]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP9]], [[BB4:BB[0-9]+]], [[BB5:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB5]]: # preds: [[BB2]]
; CHECK-NEXT:       [DA: Div] i64 [[VP10:%.*]] = mul i64 2 i64 [[VP7]]
; CHECK-NEXT:       [DA: Div] i64* [[VP_SUBSCRIPT:%.*]] = subscript inbounds i64* [[LARR20:%.*]] i64 [[VP10]]
; CHECK-NEXT:       [DA: Div] <2 x i64>* [[VP11:%.*]] = bitcast i64* [[VP_SUBSCRIPT]]
; CHECK-NEXT:       [DA: Div] <2 x i64> [[VP_LOAD:%.*]] = load <2 x i64>* [[VP11]]
; CHECK-NEXT:       [DA: Div] <2 x i64> [[VP12:%.*]] = hir-copy <2 x i64> [[VP_LOAD]] , OriginPhiId: -1
; CHECK-NEXT:       [DA: Div] <2 x i64> [[VP13:%.*]] = hir-copy <2 x i64> [[VP12]] , OriginPhiId: 0
; CHECK-NEXT:       [DA: Uni] br [[BB3]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB4]]: # preds: [[BB2]]
; CHECK-NEXT:       [DA: Div] i64 [[VP14:%.*]] = mul i64 2 i64 [[VP7]]
; CHECK-NEXT:       [DA: Div] i64* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds i64* [[LARR10:%.*]] i64 [[VP14]]
; CHECK-NEXT:       [DA: Div] <2 x i64>* [[VP15:%.*]] = bitcast i64* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:       [DA: Div] <2 x i64> [[VP_LOAD_1:%.*]] = load <2 x i64>* [[VP15]]
; CHECK-NEXT:       [DA: Div] <2 x i64> [[VP16:%.*]] = hir-copy <2 x i64> [[VP_LOAD_1]] , OriginPhiId: -1
; CHECK-NEXT:       [DA: Div] <2 x i64> [[VP17:%.*]] = hir-copy <2 x i64> [[VP16]] , OriginPhiId: 0
; CHECK-NEXT:       [DA: Uni] br [[BB3]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]: # preds: [[BB4]], [[BB5]]
; CHECK-NEXT:     [DA: Div] <2 x i64> [[VP18:%.*]] = phi  [ <2 x i64> [[VP17]], [[BB4]] ],  [ <2 x i64> [[VP13]], [[BB5]] ]
; CHECK-NEXT:     [DA: Div] <2 x i64> [[VP19:%.*]] = add <2 x i64> [[VP18]] <2 x i64> [[L2N0:%.*]]
; CHECK-NEXT:     [DA: Div] i64 [[VP20:%.*]] = mul i64 2 i64 [[VP7]]
; CHECK-NEXT:     [DA: Div] i64* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds i64* [[LARR30:%.*]] i64 [[VP20]]
...
; CHECK-NEXT:         |   {
; CHECK-NEXT:         |      %.vec4 = (<8 x i64>*)(%larr1)[2 * i1];
; CHECK-NEXT:         |      %.copy5 = %.vec4;
; CHECK-NEXT:         |      %phi.temp = %.copy5;
; CHECK-NEXT:         |   }
; CHECK-NEXT:         |   else
; CHECK-NEXT:         |   {
; CHECK-NEXT:         |      %.vec2 = (<8 x i64>*)(%larr2)[2 * i1];

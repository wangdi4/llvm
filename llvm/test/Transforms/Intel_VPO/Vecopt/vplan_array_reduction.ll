...
begin.simd:
  %tok = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.REDUCTION.ADD:TYPED"([8 x i32]* %sum, i32 0, i32 8), "QUAL.OMP.REDUCTION.MIN:TYPED"([9 x i32]* %min, i32 0, i32 9) ]
  br label %for.body

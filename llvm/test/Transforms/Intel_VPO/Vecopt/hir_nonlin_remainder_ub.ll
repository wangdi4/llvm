...
; RUN: opt -enable-new-pm=0 -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -hir-vplan-vec -vplan-enable-masked-vectorized-remainder -disable-output -hir-details -print-after=hir-vplan-vec -vplan-force-vf=8 %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec" -vplan-enable-masked-vectorized-remainder -disable-output -hir-details -print-after=hir-vplan-vec -vplan-force-vf=8 %s 2>&1 | FileCheck %s

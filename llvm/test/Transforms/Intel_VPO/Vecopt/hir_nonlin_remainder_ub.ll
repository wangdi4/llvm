...
; CHECK:             |   + DO i64 i2 = 0, [[LOOP_UB110:%.*]], 8   <DO_LOOP>  <MAX_TC_EST = 1>  <LEGAL_MAX_TC = 1> <vector-remainder> <nounroll> <novectorize> <max_trip_count = 1>
; CHECK-NEXT:        |   | <RVAL-REG> LINEAR i64 %loop.ub11{def@1} {sb:30}
; skipping body
; CHECK:             |   + END LOOP
;
alloca_11:

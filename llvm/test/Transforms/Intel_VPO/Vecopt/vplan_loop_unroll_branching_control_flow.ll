...
; RUN: opt -vplan-print-terminator-inst=false -S < %s -VPlanDriver -loop-simplify --vplan-force-vf=4 --vplan-force-uf=3 --vplan-print-after-unroll -disable-output | FileCheck %s --check-prefix=VPLAN
; RUN: opt -vplan-print-terminator-inst=false -S < %s -VPlanDriver -loop-simplify --vplan-force-vf=4 --vplan-force-uf=3  | FileCheck %s --check-prefix=CG

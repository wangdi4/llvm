...
; RUN: --vplan-print-after-unroll -disable-output -vplan-enable-new-cfg-merge | FileCheck %s --check-prefix=VPLAN
; RUN: opt -S < %s -VPlanDriver -loop-simplify --vplan-force-vf=4 --vplan-force-uf=3  \
; RUN: -vplan-enable-new-cfg-merge| FileCheck %s --check-prefix=CG

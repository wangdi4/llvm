...
; RUN: opt -vplan-print-terminator-inst=false -vplan-build-vect-candidates=1 -VPlanDriver -vplan-force-vf=4 -S -vplan-print-after-linearization %s | FileCheck %s
; RUN: opt -vplan-print-terminator-inst=false -vplan-build-vect-candidates=1 -passes="vplan-driver" -vplan-force-vf=4 -S -vplan-print-after-linearization %s | FileCheck %s
;

...
; RUN: opt -vplan-build-vect-candidates=1 -vplan-vec -vplan-force-vf=4 -S -vplan-print-after-linearization %s | FileCheck %s
; RUN: opt -vplan-build-vect-candidates=1 -passes="vplan-vec" -vplan-force-vf=4 -S -vplan-print-after-linearization %s | FileCheck %s
;

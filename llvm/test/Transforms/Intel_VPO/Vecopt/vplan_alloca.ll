...
; RUN: opt < %s -VPlanDriver -vplan-enable-improved-alignment=true -disable-output -vplan-print-after-linearization -vplan-force-vf=2 | FileCheck %s --check-prefix=LLVM
; RUN: opt < %s -S -VPlanDriver -vplan-enable-improved-alignment=true -vplan-force-vf=2 | FileCheck %s --check-prefix=LLVM-CG

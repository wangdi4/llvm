...
; RUN: opt -opaque-pointers=0 -disable-output %s -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec" -vplan-force-vf=4 --vplan-print-after-plain-cfg -vplan-entities-dump 2>&1 | FileCheck %s

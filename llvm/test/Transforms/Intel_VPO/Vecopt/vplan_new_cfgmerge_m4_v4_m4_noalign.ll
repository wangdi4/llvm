...
; CHECK-NEXT:       [DA: Uni] i64 [[VP20:%.*]] = phi-merge  [ i64 live-out0, [[BB19]] ],  [ i64 0, [[PEEL_CHECKL0]] ],  [ i64 0, [[PEEL_CHECKV0]] ],  [ i64 [[VP18]], [[BB18]] ]
; CHECK-NEXT:       [DA: Uni] br [[BB20:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB20]]: # preds: [[MERGE_BLK0]]
; CHECK-NEXT:       [DA: Uni] token [[VP_VPLAN_ADAPTER:%.*]] = vplan-adapter for VPlan {test_store:for.body.#{{[0-9]+}}.cloned.masked.cloned} i64 [[VP20]]
; CHECK-NEXT:       [DA: Uni] br final.merge
; CHECK-EMPTY:
; CHECK-NEXT:    final.merge: # preds: [[BB20]], [[BB19]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP21:%.*]] = phi-merge  [ token [[VP_VPLAN_ADAPTER]], [[BB20]] ],  [ i64 live-out0, [[BB19]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
...
; CHECK-NEXT:     [DA: Uni] i64 [[VP21]] = phi-merge  [ i64 [[VP15]], [[BB16]] ],  [ i64 live-out0, [[BB19]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:

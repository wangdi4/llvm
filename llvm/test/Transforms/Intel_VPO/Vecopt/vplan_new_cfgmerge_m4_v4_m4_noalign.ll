...
; CHECK-NEXT:     [DA: Uni] i64 [[VP14:%.*]] = ptrtoint i64* [[VP_PEEL_BASE_PTR]] to i64
; CHECK-NEXT:     [DA: Uni] i64 [[VP_PEEL_LOWBIT_AND:%.*]] = and i64 [[VP14]] i64 7
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP16:%.*]] = phi-merge  [ i64 0, [[PEEL_CHECKZ0]] ],  [ token [[VP_VPLAN_PEEL_ADAPTER]], [[BB17]] ]
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP19:%.*]] = phi-merge  [ i64 live-out0, [[BB19]] ],  [ i64 0, [[PEEL_CHECKL0]] ],  [ i64 0, [[PEEL_CHECKV0]] ],  [ i64 [[VP16]], [[BB18]] ]
; CHECK-NEXT:       [DA: Uni] br [[BB20:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB20]]: # preds: [[MERGE_BLK0]]
; CHECK-NEXT:       [DA: Uni] token [[VP_VPLAN_ADAPTER:%.*]] = vplan-adapter for VPlan {test_store:for.body.cloned.masked.cloned} i64 [[VP19]]
; CHECK-NEXT:       [DA: Uni] br final.merge
; CHECK-EMPTY:
; CHECK-NEXT:    final.merge: # preds: [[BB20]], [[BB19]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP20:%.*]] = phi-merge  [ token [[VP_VPLAN_ADAPTER]], [[BB20]] ],  [ i64 live-out0, [[BB19]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP_PEEL_COUNT]] = urem i64 [[VP_QMULTIPLIER]] i64 4
; CHECK-NEXT:       [DA: Uni] i1 [[VP_PEEL_ZERO_CHECK]] = icmp eq i64 0 i64 [[VP_PEEL_COUNT]]
; CHECK-NEXT:       [DA: Uni] br i1 [[VP_PEEL_ZERO_CHECK]], [[MERGE_BLK1]], [[PEEL_CHECKV0]]
; CHECK-EMPTY:
; CHECK-NEXT:        [[PEEL_CHECKV0]]: # preds: [[PEEL_CHECKZ0]]
; CHECK-NEXT:         [DA: Uni] i64 [[VP15]] = add i64 [[VP_PEEL_COUNT]] i64 4
; CHECK-NEXT:         [DA: Uni] i1 [[VP_PEEL_VEC_TC_CHECK]] = icmp ugt i64 [[VP15]] i64 1024
; CHECK-NEXT:         [DA: Uni] br i1 [[VP_PEEL_VEC_TC_CHECK]], [[MERGE_BLK0]], Cloned.[[BB0]]
; CHECK-EMPTY:
...
; CHECK-NEXT:         [DA: Uni] br [[MERGE_BLK1]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[MERGE_BLK1]]: # preds: [[PEEL_CHECKZ0]], Cloned.[[BB5]]
...
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.Cloned.[[BB11]]: # preds: [[MERGE_BLK0]]
; CHECK-NEXT:       [DA: Uni] pushvf VF=4 UF=1
...
; CHECK-NEXT:       [DA: Uni] br final.merge
; CHECK-EMPTY:
; CHECK-NEXT:    final.merge: # preds: [[BB19]], Cloned.Cloned.[[BB16]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP20]] = phi-merge  [ i64 [[VP13]], Cloned.Cloned.[[BB16]] ],  [ i64 live-out0, [[BB19]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:

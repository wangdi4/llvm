...
; CHECK-NEXT:        |   [[DOTVEC20]] = (<4 x double>*)([[A0]])[i1], Mask = @{[[DOTVEC10]]}
; CHECK-NEXT:        |   [[EXTRACT_0_0:%.*]] = extractelement &((<4 x double*>)([[B0]])[%phi.temp + 1]),  0
; CHECK-NEXT:        |   @llvm.masked.compressstore.v4f64([[DOTVEC20]],  [[EXTRACT_0_0]],  [[DOTVEC10]])
; CHECK-NEXT:        |   [[SELECT0:%.*]] = ([[DOTVEC10]] == <i1 true, i1 true, i1 true, i1 true>) ? [[PHI_TEMP0]] + 1 : [[PHI_TEMP0]]
...
; CHECK-NEXT:        [[J_0140]] = [[EXTRACT_0_50]]

...
; CHECK-NEXT:     i64 [[VP1:%.*]] = phi  [ i64 [[VP__IND_INIT]], [[BB1]] ],  [ i64 [[VP2:%.*]], [[BB2]] ] ({{.*}}), KnownBits: {Zero=-1024, One=0}
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT:%.*]] = subscript i64* [[ARRAY0:%.*]] i64 [[VP1]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_1:%.*]] = subscript i64* [[ARRAY0]] i64 [[VP1]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     i64 [[VP_LOAD:%.*]] = load i64* [[VP_SUBSCRIPT_1]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     i32* [[VP_SUBSCRIPT_2:%.*]] = subscript i32* null i64 4 ({{.*}}), KnownBits: {Zero=-17, One=16}
; CHECK-NEXT:     store i32 1 i32* [[VP_SUBSCRIPT_2]] ({{.*}})
; CHECK-NEXT:     i8* [[VP_SUBSCRIPT_3:%.*]] = subscript i8* null i64 4 ({{.*}}), KnownBits: {Zero=-5, One=4}
; CHECK-NEXT:     store i8 2 i8* [[VP_SUBSCRIPT_3]] ({{.*}})
; CHECK-NEXT:     i8* [[VP_SUBSCRIPT_4:%.*]] = subscript { i8, i8 }* null i64 2 (1 ) ({{.*}}), KnownBits: {Zero=-6, One=5}
; CHECK-NEXT:     store i8 3 i8* [[VP_SUBSCRIPT_4]] ({{.*}})
; CHECK-NEXT:     i8* [[VP_SUBSCRIPT_5:%.*]] = subscript { i8, i8 }* null i64 [[VP_LOAD]] (1 ) ({{.*}}), KnownBits: {Zero=0, One=1}
; CHECK-NEXT:     store i8 4 i8* [[VP_SUBSCRIPT_5]] ({{.*}})
; CHECK-NEXT:     i64 [[VP3:%.*]] = mul i64 [[VP_LOAD]] i64 8 ({{.*}}), KnownBits: {Zero=7, One=0}
; CHECK-NEXT:     i8* [[VP_SUBSCRIPT_6:%.*]] = subscript inbounds i8* null i64 [[VP3]] ({{.*}}), KnownBits: {Zero=15, One=0}
; CHECK-NEXT:     store i8 5 i8* [[VP_SUBSCRIPT_6]] ({{.*}})
; CHECK-NEXT:     i64 [[VP4:%.*]] = mul i64 [[VP_LOAD]] i64 2 ({{.*}}), KnownBits: {Zero=1, One=0}
; CHECK-NEXT:     i8* [[VP_SUBSCRIPT_7:%.*]] = subscript inbounds i8* null i64 [[VP3]] ({{.*}}), KnownBits: {Zero=3, One=0}
; CHECK-NEXT:     store i8 6 i8* [[VP_SUBSCRIPT_7]] ({{.*}})
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_8:%.*]] = subscript inbounds i64* null i64 [[VP3]] ({{.*}}), KnownBits: {Zero=127, One=0}
; CHECK-NEXT:     store i64 7 i64* [[VP_SUBSCRIPT_8]] ({{.*}})
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_9:%.*]] = subscript inbounds i64* null i64 [[VP3]] ({{.*}}), KnownBits: {Zero=31, One=0}
; CHECK-NEXT:     store i64 8 i64* [[VP_SUBSCRIPT_9]] ({{.*}})
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_10:%.*]] = subscript inbounds i64* null i64 [[VP_LOAD]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     store i64 9 i64* [[VP_SUBSCRIPT_10]] ({{.*}})
; CHECK-NEXT:     i64 [[VP5:%.*]] = add i64 [[VP3]] i64 [[VP1]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_11:%.*]] = subscript i64* [[ARRAY0]] i64 [[VP5]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     store i64 10 i64* [[VP_SUBSCRIPT_11]] ({{.*}})
; CHECK-NEXT:     i8* [[VP_SUBSCRIPT_12:%.*]] = subscript i8* null i64 [[VP_LOAD]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     store i8 11 i8* [[VP_SUBSCRIPT_12]] ({{.*}})
; CHECK-NEXT:     i8* [[VP_SUBSCRIPT_13:%.*]] = subscript inbounds i8* null i64 [[VP3]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     store i8 12 i8* [[VP_SUBSCRIPT_13]] ({{.*}})
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_14:%.*]] = subscript inbounds i64* [[VP_SUBSCRIPT]] i64 [[VP3]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     store i64 13 i64* [[VP_SUBSCRIPT_14]] ({{.*}})
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_15:%.*]] = subscript inbounds i64* null i64 [[VP_LOAD]] ({{.*}}), KnownBits: {Zero=0, One=0}
; CHECK-NEXT:     store i64 14 i64* [[VP_SUBSCRIPT_15]] ({{.*}})
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_16:%.*]] = subscript [256 x i64]* null i64 0 i64 0 ({{.*}}), KnownBits: {Zero=-1, One=0}
; CHECK-NEXT:     store i64 15 i64* [[VP_SUBSCRIPT_16]] ({{.*}})
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_17:%.*]] = subscript [256 x i64]* null i64 0 i64 [[VP1]] ({{.*}}), KnownBits: {Zero=-8185, One=0}

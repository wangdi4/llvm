...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -S < %s -passes=vplan-vec -disable-output -vplan-enable-scalvec-analysis -vplan-print-scalvec-results -vector-library=SVML | FileCheck %s

...
; RUN: opt -opaque-pointers=0 < %s -S -passes=vplan-pragma-omp-ordered-simd-extract,print -disable-output 2>&1 | FileCheck %s

; Tests whether Code Extractor works for a simple case.

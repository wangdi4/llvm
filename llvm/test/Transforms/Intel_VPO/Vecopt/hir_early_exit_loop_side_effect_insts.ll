...
; containing a store (side-effects instruction) as unsafe to vectorize.
...
; CHECK: EarlyExitVecSafety: Instruction with side-effects is not safe.
...
define dso_local i32 @_Z3fooiPKaPaa(i32 %n, ptr %a, i8 signext %val) local_unnamed_addr {
entry:

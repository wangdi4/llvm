...
; CHECK-NEXT:    [[VEC_PHI:%.*]] = phi <4 x i64> [ <i64 0, i64 4, i64 8, i64 12>, [[VECTOR_PH]] ], [ [[TMP7:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP7]] = add nuw nsw <4 x i64> [[VEC_PHI]], <i64 16, i64 16, i64 16, i64 16>
; CHECK-NEXT:    [[TMP8]] = add nuw nsw i64 [[UNI_PHI]], 16
; CHECK-NEXT:    [[TMP9:%.*]] = icmp ult <4 x i64> [[TMP7]], <i64 1024, i64 1024, i64 1024, i64 1024>
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <4 x i1> [[TMP9]], i32 0
; CHECK-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 4
; CHECK-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[INDEX_NEXT]], 256

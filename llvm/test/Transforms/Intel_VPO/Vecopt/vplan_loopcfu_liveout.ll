...
; REQUIRES: asserts
; RUN: opt -S < %s -VPlanDriver -enable-vp-value-codegen -disable-output -vplan-print-after-loop-cfu | FileCheck %s
...
; CHECK-NEXT:      SUCCESSORS(2):[[BB13:BB[0-9]+]](i1 [[VP2]]), [[BB8]](!i1 [[VP2]])
...
; CHECK-NEXT:    PREDECESSORS(3): [[BB13]] [[BB6]] [[BB4]]
; CHECK-EMPTY:

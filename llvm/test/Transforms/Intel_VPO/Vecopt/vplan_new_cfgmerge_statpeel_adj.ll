...
; CHECK-NEXT:         {label [[DIR_OMP_END_SIMD_20:%.*]] in {  br i1 [[EXITCOND0:%.*]], label [[OMP_INNER_FOR_BODY0:%.*]], label [[DIR_OMP_END_SIMD_20]], !llvm.loop !0} -> label [[BB0:BB[0-9]+]] }
; CHECK-NEXT:         {i64 131072 in {  [[EXITCOND0]] = icmp ule i64 [[ADD0:%.*]], 131072} -> i64 2 }
...
attributes #0 = { nounwind uwtable mustprogress "pre_loopopt" "target-cpu"="skylake-avx512" "unsafe-fp-math"="true" }

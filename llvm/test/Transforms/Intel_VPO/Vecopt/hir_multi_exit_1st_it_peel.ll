...
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-last-value-computation,hir-vec-dir-insert,vplan-driver-hir,print<hir>" -mtriple=x86_64-unknown-unknown -mattr=+avx2 -enable-intel-advanced-opts -allow-memory-speculation -vplan-force-vf=16 -disable-output < %s 2>&1 | FileCheck %s

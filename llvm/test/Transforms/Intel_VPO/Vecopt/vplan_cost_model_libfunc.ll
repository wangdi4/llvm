; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -vector-library=SVML -vplan-cost-model-print-analysis-for-vf=1 -vplan-cost-model-print-analysis-for-vf=8 -disable-output < %s | FileCheck %s

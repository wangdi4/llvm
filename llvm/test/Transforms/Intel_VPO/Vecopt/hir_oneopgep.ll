...
; RUN: opt -vplan-enable-new-cfg-merge-hir=false -enable-new-pm=0 -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -vplan-force-vf=4 -tbaa -print-after=hir-vplan-vec -disable-output < %s 2>&1 | FileCheck %s
...
; RUN: opt -vplan-enable-new-cfg-merge-hir -enable-new-pm=0 -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -vplan-force-vf=4 -tbaa -print-after=hir-vplan-vec -disable-output < %s 2>&1 | FileCheck %s

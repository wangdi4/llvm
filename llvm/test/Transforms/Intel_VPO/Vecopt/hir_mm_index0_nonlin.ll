...
; CHECK-NEXT:   IntInduction(+) Start: i32 0 Step: i32 1 StartVal: i32 0 EndVal: i32 2147483647 BinOp: i32 [[VP6:%.*]] = add i32 [[VP7:%.*]] i32 [[VP__IND_INIT_STEP:%.*]]
...
; CHECK-NEXT:     ptr [[VP10:%.*]] = subscript inbounds ptr [[ORDERING0:%.*]] i64 [[VP9]]
; CHECK-NEXT:     i32 [[VP11:%.*]] = load ptr [[VP10]]

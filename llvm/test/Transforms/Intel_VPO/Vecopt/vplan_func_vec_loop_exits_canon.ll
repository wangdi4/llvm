...
; RUN: opt -S -passes=vplan-func-vec -print-after-vplan-func-vec-loop-exit-canon < %s -disable-output | FileCheck %s
...
; CHECK-NEXT:     i1 [[VP_EXIT_COND:%.*]] = call i1 [[VP_MASK_NEXT]] ptr @allzero
...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB1]]: # preds: [[BB0]], [[NEW_LOOP_LATCH0:new.loop.latch[0-9]+]]
; CHECK-NEXT:     i1 [[VP_COND:%.*]] = call i32 [[VP_LANE]] ptr @foo

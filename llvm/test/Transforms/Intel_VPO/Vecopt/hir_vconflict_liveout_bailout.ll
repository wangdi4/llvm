...
; CHECK:      [VConflict Idiom] Looking at store candidate:<[[NUM1:[0-9]+]]>          (%A)[%0] = (%A)[%0];
; CHECK-NEXT: [VConflict Idiom] Depends(WAR) on:<[[NUM1]]>          (%A)[%0] = (%A)[%0];
...
for.body:                                         ; preds = %entry, %for.body
  ...
  store float %1, float* %ptridx2, align 4

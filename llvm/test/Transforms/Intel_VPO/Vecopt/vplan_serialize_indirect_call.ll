...
; RUN: opt -opaque-pointers=0 -vplan-enable-soa=false %s -passes=vplan-vec,intel-ir-optreport-emitter -vplan-force-vf=2 -intel-opt-report=high -disable-output 2>&1 | FileCheck %s -check-prefixes=OPTREPORT

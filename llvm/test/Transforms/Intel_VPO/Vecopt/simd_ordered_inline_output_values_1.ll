...
; CHECK-NEXT:    [[UNI_PHI0:%.*]] = phi i64 [ [[TMP3:%.*]], [[VPLANNEDBB60:%.*]] ], [ 0, [[VECTOR_PH0]] ]
; CHECK-NEXT:    [[VEC_PHI0:%.*]] = phi <2 x i64> [ [[TMP2:%.*]], [[VPLANNEDBB60]] ], [ <i64 0, i64 1>, [[VECTOR_PH0]] ]
...
; CHECK-NEXT:    br i1 [[TMP4]], label [[VPLANNEDBB70:%.*]], label [[VECTOR_BODY0]], !llvm.loop !0
; CHECK-EMPTY:
...
; CHECK-NEXT:    [[TMP7:%.*]] = icmp ne i64 [[WIDE_TRIP_COUNT0]], [[N_VEC0]]
; CHECK-NEXT:    br i1 [[TMP7]], label [[SCALAR_PH0]], label [[VPLANNEDBB80:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  scalar.ph:
; CHECK-NEXT:    [[UNI_PHI90:%.*]] = phi i64 [ [[TMP6]], [[MIDDLE_BLOCK0]] ], [ 0, [[VPLANNEDBB20]] ]
...
; CHECK-NEXT:    [[UNI_PHI110:%.*]] = phi i64 [ [[INDVARS_IV_NEXT0:%.*]], [[LATCH0:%.*]] ], [ [[TMP6]], [[MIDDLE_BLOCK0]] ]
...
; CHECK-EMPTY:
; CHECK-NEXT:  for.body:
; CHECK-NEXT:    [[INDVARS_IV0:%.*]] = phi i64 [ [[INDVARS_IV_NEXT0]], [[LATCH0]] ], [ [[UNI_PHI90]], [[VPLANNEDBB100]] ]
...
; CHECK-NEXT:    br i1 [[EXITCOND0]], label [[VPLANNEDBB80]], label [[FOR_BODY0]], !llvm.loop !2
; CHECK-EMPTY:
; CHECK-NEXT:  for.end:

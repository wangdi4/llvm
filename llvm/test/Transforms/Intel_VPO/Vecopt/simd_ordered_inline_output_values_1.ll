...
; CHECK-NEXT:    [[UNI_PHI0:%.*]] = phi i64 [ [[TMP4:%.*]], [[VPLANNEDBB60:%.*]] ], [ 0, [[VECTOR_PH0]] ]
; CHECK-NEXT:    [[VEC_PHI0:%.*]] = phi <2 x i64> [ [[TMP3:%.*]], [[VPLANNEDBB60]] ], [ <i64 0, i64 1>, [[VECTOR_PH0]] ]
...
; CHECK-NEXT:    [[TMP5:%.*]] = icmp uge i64 [[TMP4]], [[TMP0]]
; CHECK-NEXT:    br i1 [[TMP5]], label [[VPLANNEDBB70:%.*]], label [[VECTOR_BODY0]], !llvm.loop !0
; CHECK-EMPTY:
; CHECK-NEXT:  VPlannedBB7:
; CHECK-NEXT:    [[TMP6:%.*]] = mul i64 1, [[TMP0]]
; CHECK-NEXT:    [[TMP7:%.*]] = add i64 0, [[TMP6]]
; CHECK-NEXT:    br label [[MIDDLE_BLOCK0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  middle.block:
; CHECK-NEXT:    [[TMP8:%.*]] = icmp ne i64 [[WIDE_TRIP_COUNT0]], [[TMP0]]
; CHECK-NEXT:    br i1 [[TMP8]], label [[SCALAR_PH0]], label [[VPLANNEDBB80:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  scalar.ph:
; CHECK-NEXT:    [[UNI_PHI90:%.*]] = phi i64 [ [[TMP7]], [[MIDDLE_BLOCK0]] ], [ 0, [[VPLANNEDBB20]] ]
...
; CHECK-NEXT:    [[UNI_PHI110:%.*]] = phi i64 [ [[INDVARS_IV_NEXT0:%.*]], [[LATCH0:%.*]] ], [ [[TMP7]], [[MIDDLE_BLOCK0]] ]

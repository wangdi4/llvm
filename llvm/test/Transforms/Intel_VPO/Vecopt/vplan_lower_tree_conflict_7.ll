...
define dso_local void @foo(i32* noalias nocapture noundef %A, i64* nocapture noundef readonly %B, i32* noalias nocapture noundef readonly %C, i32 noundef %N) local_unnamed_addr #0 {
;
; int A[N], C[N];
...
; CHECK-VF4-NEXT:           |   |   [[UNIFCOND280:%.*]] = extractelement [[DOTVEC230]],  0
; CHECK-VF4-NEXT:           |   |   if ([[UNIFCOND280]] == 1)
; CHECK-VF4-NEXT:           |   |   {

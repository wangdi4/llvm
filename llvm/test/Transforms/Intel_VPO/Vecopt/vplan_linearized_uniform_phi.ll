...
; RUN: opt < %s -vplan-enable-masked-variant=0 -vplan-vec -vplan-force-vf=2 -disable-output -vplan-print-after-linearization 2>&1 | FileCheck %s --check-prefixes=VPLAN

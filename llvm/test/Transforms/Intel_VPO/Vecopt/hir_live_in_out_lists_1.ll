...
; RUN: opt -passes=hir-ssa-deconstruction,hir-vplan-vec -vplan-print-after-live-inout-list -vplan-dump-live-inout -vplan-entities-dump -disable-output < %s 2>&1 | FileCheck %s

; RUN: opt < %s -S -O2 -tti -mtriple=x86_64-unknown-linux-gnu -mcpu=haswell -load-coalescing -load-coalescing-allow-scalars \
; RUN: | FileCheck %s --check-prefix=LC-HASWELL

; RUN: opt < %s -S -O2 -tti -mtriple=x86_64-unknown-linux-gnu -mcpu=silvermont -load-coalescing -load-coalescing-allow-scalars \
; RUN: | FileCheck %s --check-prefix=LC-SILVERMONT
...
define dso_local void @dummyFunc(i32 %x) #0 {
entry:
  ...
  store i32 %2, i32* %arrayidx3, align 4, !tbaa !6
  ...
  store i32 %8, i32* %arrayidx15, align 4, !tbaa !6
  ...
  %11 = load i32, i32* %arrayidx18, align 4, !tbaa !6
  ...
  store i32 %11, i32* %arrayidx21, align 4, !tbaa !6
  ...
  %14 = load i32, i32* %arrayidx24, align 4, !tbaa !6
  ...
  store i32 %14, i32* %arrayidx27, align 4, !tbaa !6
  ...
  %17 = load i32, i32* %arrayidx30, align 4, !tbaa !6
  ...
  store i32 %17, i32* %arrayidx33, align 4, !tbaa !6
  ...
  %20 = load i32, i32* %arrayidx36, align 4, !tbaa !6
  ...
  store i32 %20, i32* %arrayidx39, align 4, !tbaa !6
  ...
  %23 = load i32, i32* %arrayidx42, align 4, !tbaa !6
  ...
  store i32 %23, i32* %arrayidx45, align 4, !tbaa !6
  ...
  %26 = load i32, i32* %arrayidx48, align 4, !tbaa !6
  ...
  store i32 %26, i32* %arrayidx51, align 4, !tbaa !6
  ...
  %29 = load i32, i32* %arrayidx54, align 4, !tbaa !6
  ...
  store i32 %29, i32* %arrayidx57, align 4, !tbaa !6
  ...
  %32 = load i32, i32* %arrayidx60, align 4, !tbaa !6
  ...
  store i32 %32, i32* %arrayidx63, align 4, !tbaa !6
  ...
  %35 = load i32, i32* %arrayidx66, align 4, !tbaa !6
  ...
  store i32 %39, i32* %arrayidx75, align 4, !tbaa !6
  %41 = load i32, i32* %i, align 4, !tbaa !2
  %42 = load i32, i32* %x.addr, align 4, !tbaa !2
  ...
  %43 = load i32, i32* %arrayidx79, align 4, !tbaa !6
  ...
  store i32 %43, i32* %arrayidx82, align 4, !tbaa !6
...
!1 = !{!"clang version 8.0.0 (ssh://git-amr-2.devtools.intel.com:29418/dpd_icl-clang 0caec453655197ac8aec9eb86c1dc485b40576dd) (ssh://git-amr-2.devtools.intel.com:29418/dpd_icl-llvm 5b61f5465654d84aa10873c960405bd11ffa6a77)"}
!2 = !{!3, !3, i64 0}
!3 = !{!"int", !4, i64 0}
!4 = !{!"omnipotent char", !5, i64 0}
!5 = !{!"Simple C/C++ TBAA"}
!6 = !{!7, !3, i64 0}
!7 = !{!"array@_ZTSA16384_i", !3, i64 0}

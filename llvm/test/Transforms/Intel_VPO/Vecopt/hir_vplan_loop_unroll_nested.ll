...
; RUN: opt %s -S -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-pre-vec-complete-unroll,hir-memory-reduction-sinking,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -disable-output 2>&1 | FileCheck %s --check-prefix=VPCHECK

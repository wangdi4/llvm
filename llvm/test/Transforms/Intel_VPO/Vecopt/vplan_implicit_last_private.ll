...
; RUN: opt %s -S -VPlanDriver -VPlanDriver -vplan-enable-all-liveouts -vplan-enable-cfg-merge=0 -vplan-entities-dump -vplan-print-after-live-inout-list | FileCheck %s
...
; CHECK-NEXT:  Id: 0     [[DOTLCSSA0:%.*]] = phi i32 [ [[TMP2:%.*]], [[OMP_INNER_FOR_BODY0:%.*]] ] i32 [[VP0]] -> i32 [[TMP2]]
; CHECK-EMPTY:
...
; CHECK-NEXT:    br i1 [[TMP4]], label [[VPLANNEDBB0:%.*]], label [[VECTOR_BODY0]]
; CHECK-EMPTY:

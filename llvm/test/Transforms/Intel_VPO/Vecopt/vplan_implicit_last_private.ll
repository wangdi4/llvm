...
; RUN: opt %s -S -vplan-vec -vplan-vec -vplan-entities-dump -vplan-print-after-live-inout-list | FileCheck %s
...
; CHECK-NEXT:    [[VEC_PHI0:%.*]] = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, [[VPLANNEDBB10]] ], [ [[TMP2]], [[VECTOR_BODY0]] ]

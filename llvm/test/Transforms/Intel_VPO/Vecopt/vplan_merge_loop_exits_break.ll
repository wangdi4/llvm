...
; inner.loop (BB5) exits to exit_bb1 (BB7).
...
; CHECK-NEXT:    SUCCESSORS(2):[[BB5]](i1 [[VP_TAKE_BACKEDGE_COND]]), [[BB7:BB[0-9]+]](!i1 [[VP_TAKE_BACKEDGE_COND]])
...
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP_CMP2:%.*]] = icmp i32 [[VP_OUTER_LOOP_INDUCTION]] i32 128
...
outer.loop.latch:
  ...
  %cmp2 = icmp eq i32 %outer.loop.induction, 128

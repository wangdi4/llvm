...
; REQUIRES: asserts
; RUN: opt -disable-output -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -VPlanDriverHIR -vplan-plain-dump -vplan-entities-dump -disable-vplan-codegen -enable-mmindex=1  -disable-nonlinear-mmindex=0 -vplan-print-after-vpentity-instrs -vplan-force-vf=4 -S < %s 2>&1 | FileCheck -check-prefixes CHECK %s
...
; CHECK-EMPTY:
; CHECK-NEXT:   signed (SIntMax) Start: i32 [[TMP_0240:%.*]] Exit: i32 [[VP3:%.*]]
...
; CHECK-NEXT:   signed (SIntMax) Start: i32 [[VAL_0250:%.*]] Exit: i32 [[VP5:%.*]]
...
; CHECK-NEXT:     i1 [[VP15:%.*]] = icmp sge i32 [[VP12]] i32 [[VP1]]
; CHECK-NEXT:     i32 [[VP5]] = select i1 [[VP15]] i32 [[VP14]] i32 [[VP6]]
; CHECK-NEXT:     i1 [[VP16:%.*]] = icmp sge i32 [[VP12]] i32 [[VP1]]
...
; CHECK-NEXT:     i32 [[VP__RED_FINAL]] = reduction-final{s_smax} i32 [[VP3]] i32 [[VP0]] i32 [[VP2]]
; CHECK-NEXT:     i32 [[VP__RED_FINAL_1]] = reduction-final{s_smax} i32 [[VP5]] i32 [[VP3]] i32 [[VP__RED_FINAL]]
...
;CG_ENABLE-NEXT:            %idx.blend = (%best.023 == %red.var) ? %red.var1 : <i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648>;
;CG_ENABLE-NEXT:            %tmp.024 = @llvm.vector.reduce.smax.v4i32(%idx.blend);

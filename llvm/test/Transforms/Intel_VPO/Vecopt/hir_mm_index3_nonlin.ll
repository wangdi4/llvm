...
;CG_ENABLE-NEXT:            %[[idxblend:.*]] = (%[[best023]] == %.[[vec9]]) ? %.[[vec7:.*]] : <i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648>;
;CG_ENABLE-NEXT:            %[[tmp024:.*]] = @llvm.vector.reduce.smax.v4i32(%[[idxblend]]);

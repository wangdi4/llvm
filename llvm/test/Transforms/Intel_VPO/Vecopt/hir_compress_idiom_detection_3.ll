...
; CHECK:      [Compress/Expand Idiom] Increment {sb:3}+9 detected: {{.*}} [[J_0140:%.*]] = 4  +  [[J_0140]] + 5
; CHECK-NOT:  [Compress/Expand Idiom] Increment rejected
; CHECK:      Idiom List
; CHECK-NEXT: CEIndexIncFirst: {{.*}} [[J_0140]] = 4  +  [[J_0140]] + 5
...
; CHECK-NEXT:      i32 [[VP7:%.*]] = add i32 4 i32 [[VP8:%.*]]
; CHECK-NEXT:        Stride: 9
; CHECK-NEXT:        Init: i32 [[J_0140]]
; CHECK-NEXT:    Stores:
; CHECK-NEXT:      store double [[VP_LOAD:%.*]] double* [[VP_SUBSCRIPT:%.*]]
; CHECK-NEXT:    Indices:
; CHECK-NEXT:      i32 [[VP9:%.*]] = phi  [ i32 [[J_0140]], [[BB1:BB[0-9]+]] ],  [ i32 [[VP10:%.*]], [[BB2:BB[0-9]+]] ]
; CHECK-EMPTY:
; CHECK-NEXT:    Linked values: i32 [[VP7]], i32 [[J_0140]], void [[VP_STORE:%.*]], i32 [[VP9]],

; CHECK:         [[BB1:BB[0-9]+]]: # preds:
; CHECK-NEXT:     br [[BB2:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]: # preds: [[BB1]]
; CHECK-NEXT:     i64 [[VP10:%.*]] = add i64 [[VP0:%.*]] i64 1
; CHECK-NEXT:     i64 [[VP__IND_INIT]] = induction-init{add} i64 0 i64 1
; CHECK-NEXT:     i64 [[VP__IND_INIT_STEP]] = induction-init-step{add} i64 1
; CHECK-NEXT:     br [[BB0]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB0]]: # preds: [[BB2]], [[BB3:BB[0-9]+]]
; CHECK-NEXT:     i32 [[VP9]] = phi  [ i32 [[J_0140]], [[BB2]] ],  [ i32 [[VP11:%.*]], [[BB3]] ]
...
; CHECK-NEXT:       i64 [[VP13:%.*]] = sext i32 [[VP9]] to i64
; CHECK-NEXT:       double* [[VP_SUBSCRIPT]] = subscript inbounds double* [[B0]] i64 [[VP13]]
; CHECK-NEXT:       store double [[VP_LOAD]] double* [[VP_SUBSCRIPT]]
; CHECK-NEXT:       i32 [[VP8]] = add i32 [[VP9]] i32 5
; CHECK-NEXT:       i32 [[VP7]] = add i32 4 i32 [[VP8]]
; CHECK-NEXT:       br [[BB3]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]: # preds: [[BB4]], [[BB0]]
; CHECK-NEXT:     i32 [[VP11]] = phi  [ i32 [[VP7]], [[BB4]] ],  [ i32 [[VP9]], [[BB0]] ]
; CHECK-NEXT:     i64 [[VP5]] = add i64 [[VP6]] i64 [[VP__IND_INIT_STEP]]
; CHECK-NEXT:     i1 [[VP14:%.*]] = icmp slt i64 [[VP5]] i64 [[VP10]]

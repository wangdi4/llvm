...
; CHECK-NEXT:    Phi: i32 [[VP9:%.*]] = phi  [ i32 [[J_0140]], [[BB1:BB[0-9]+]] ],  [ i32 [[VP10:%.*]], [[BB2:BB[0-9]+]] ]
...
; CHECK-EMPTY:
; CHECK-NEXT:    Linked values: i32 [[VP9]], i32 [[J_0140]], i32 [[VP7]], void [[VP_STORE:%.*]], i64 [[VP11]],
...
; CHECK-NEXT:     i32 [[VP9]] = phi  [ i32 [[J_0140]], [[BB1]] ],  [ i32 [[VP10]], [[BB2]] ]
...
; CHECK-NEXT:     i32 [[VP10]] = phi  [ i32 [[VP7]], [[BB4]] ],  [ i32 [[VP9]], [[BB0]] ]

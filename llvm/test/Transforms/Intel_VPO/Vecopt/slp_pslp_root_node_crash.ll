...
; INTADV-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> [[TMP3]], i32 [[GEPLOAD]], i32 1
; INTADV-NEXT:    [[TMP5:%.*]] = insertelement <4 x i32> [[TMP4]], i32 [[GEPLOAD]], i32 2
; INTADV-NEXT:    [[TMP6:%.*]] = insertelement <4 x i32> [[TMP5]], i32 [[GEPLOAD]], i32 3
; INTADV-NEXT:    [[TMP7:%.*]] = sub <4 x i32> [[TMP2]], [[TMP6]]
; INTADV-NEXT:    [[TMP8:%.*]] = insertelement <4 x i32> poison, i32 [[I12]], i32 0
; INTADV-NEXT:    [[TMP9:%.*]] = insertelement <4 x i32> [[TMP8]], i32 [[I12]], i32 1
; INTADV-NEXT:    [[TMP10:%.*]] = insertelement <4 x i32> [[TMP9]], i32 [[I12]], i32 2
; INTADV-NEXT:    [[TMP11:%.*]] = insertelement <4 x i32> [[TMP10]], i32 [[I12]], i32 3
; INTADV-NEXT:    [[TMP12:%.*]] = sub <4 x i32> [[TMP7]], [[TMP11]]
; INTADV-NEXT:    [[TMP13:%.*]] = add <4 x i32> [[TMP12]], <i32 50, i32 50, i32 50, i32 50>
; INTADV-NEXT:    [[TMP14:%.*]] = call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> [[TMP13]])
; INTADV-NEXT:    [[OP_EXTRA:%.*]] = or i32 [[TMP14]], [[I15]]
...
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <4 x i32> poison, i32 [[I12]], i32 0

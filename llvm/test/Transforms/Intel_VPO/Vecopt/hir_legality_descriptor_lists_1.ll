...
omp.inner.for.body:                               ; preds = %omp.inner.for.body, %omp.inner.for.body.lr.ph
  %2 = phi i32 [ %.pre, %omp.inner.for.body.lr.ph ], [ %add8, %omp.inner.for.body ]
  %inc17 = phi i8 [ %c.promoted, %omp.inner.for.body.lr.ph ], [ %inc, %omp.inner.for.body ]
  %incdec.ptr16 = phi ptr [ %ptr.addr.promoted, %omp.inner.for.body.lr.ph ], [ %incdec.ptr, %omp.inner.for.body ]
  %storemerge15 = phi i32 [ 0, %omp.inner.for.body.lr.ph ], [ %add9, %omp.inner.for.body ]
  %3 = load i32, ptr %incdec.ptr16, align 4, !tbaa !6
  %conv6 = sext i8 %inc17 to i32
  %mul7 = mul nsw i32 %3, %conv6
  %add8 = add nsw i32 %mul7, %2
  store i32 %add8, ptr %s, align 4, !tbaa !6
  %incdec.ptr = getelementptr inbounds i32, ptr %incdec.ptr16, i64 1
  %inc = add i8 %inc17, 1
  %add9 = add nuw nsw i32 %storemerge15, 1
  store i32 %add9, ptr %.omp.iv, align 4, !tbaa !6
  %cmp4 = icmp slt i32 %storemerge15, %1
...
omp.loop.exit:                                    ; preds = %omp.inner.for.cond.omp.loop.exit_crit_edge, %omp.precond.then
  ...
  %.pre18 = load i32, ptr %s, align 4, !tbaa !6
  br label %omp.precond.end
...
omp.precond.end:                                  ; preds = %entry.omp.precond.end_crit_edge, %omp.loop.exit
  ...
  %4 = phi i32 [ 0, %entry.omp.precond.end_crit_edge ], [ %.pre18, %omp.loop.exit ]

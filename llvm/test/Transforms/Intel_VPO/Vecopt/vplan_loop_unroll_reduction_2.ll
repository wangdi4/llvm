...
; RUN: opt -opaque-pointers=0 -S < %s -passes=vplan-vec,loop-simplify --vplan-force-vf=2 --vplan-force-uf=2 \
...
; CHECK-NEXT:    [[TMP4:%.*]] = add nsw <2 x i32> [[WIDE_LOAD0]], [[VEC_PHI40]]
...
; CHECK-NEXT:    [[TMP9]] = add nsw <2 x i32> [[WIDE_LOAD70]], [[TMP4]]

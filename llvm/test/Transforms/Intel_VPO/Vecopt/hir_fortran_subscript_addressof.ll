...
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec" -vplan-force-vf=2 -vplan-print-after-plain-cfg -disable-output -print-after=hir-vplan-vec < %s 2>&1 | FileCheck %s

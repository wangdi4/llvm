...
; Main loop
; CHECK: Cost 13 for i8 %vp{{[0-9]+}} = private-final-c-mem i8 %vp{{[0-9]+}} i32 %vp{{[0-9]+}} ptr %ret.c.lpriv
...
0:
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.LASTPRIVATE:CONDITIONAL.TYPED"(ptr %ret.c.lpriv, i8 0, i32 1), "QUAL.OMP.LASTPRIVATE:TYPED"(ptr %ret.uc.lpriv, i8 0, i32 1)]
...
if.then:
  %2 = load i8, ptr %a
  store i8 %2, ptr %ret.c.lpriv
  br label %omp.inner.for.inc

omp.inner.for.inc:
  %3 = load i8, ptr %a
  store i8 %3, ptr %ret.uc.lpriv

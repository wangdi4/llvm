...
; RUN: opt -disable-output -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,print<hir>" -print-after=hir-vplan-vec -vplan-force-vf=16 -debug-only=VPlanLegality < %s 2>&1 | FileCheck %s --check-prefix=HIR-CHECK

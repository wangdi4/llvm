...
;RUN: opt -vector-library=SVML -VPlanDriver -enable-vp-value-codegen -S %s | FileCheck %s --check-prefix=VPVALCG
; VPVALCG: call svml_cc <4 x float> @__svml_sinf4
...
define x86_regcallcc void @foo(float* nocapture %a, float* nocapture readonly %b, i32 %i) local_unnamed_addr #0 {
entry:

...
; CHECK-NEXT:     [DA: Div] i1 [[VP4:%.*]] = icmp ult i32 [[VP_IV_NEXT]] i32 128
; CHECK-NEXT:     [DA: Uni] i1 [[VP5:%.*]] = all-zero-check i1 [[VP4]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP5]], Cloned.[[BB5:BB[0-9]+]], Cloned.[[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB5]]: # preds: new_latch
; CHECK-NEXT:     [DA: Uni] i32 [[VP6:%.*]] = induction-final{add} i32 live-in0 i32 1
...
; CHECK-NEXT:  Id: 0   no underlying for i32 [[VP6]]
;
entry:
  br label %preheader

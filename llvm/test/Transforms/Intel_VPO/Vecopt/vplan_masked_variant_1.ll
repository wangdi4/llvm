...
; CHECK-NEXT:       [DA: Div] i32 [[VP_X:%.*]] = add i32 [[VP_IV]] i32 1
; CHECK-NEXT:       [DA: Uni] br new_latch
; CHECK-EMPTY:
; CHECK-NEXT:    new_latch: # preds: Cloned.[[BB4]], Cloned.[[BB2]]
; CHECK-NEXT:     [DA: Div] i32 [[VP8:%.*]] = phi  [ i32 [[VP_IV_NEXT]], Cloned.[[BB4]] ],  [ i32 [[VP_IV]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Uni] i32 [[VP9:%.*]] = phi  [ i32 [[VP6]], Cloned.[[BB4]] ],  [ i32 [[VP5]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Uni] i32 [[VP6]] = add i32 [[VP5]] i32 [[VP2]]
; CHECK-NEXT:     [DA: Uni] i1 [[VP10:%.*]] = icmp uge i32 [[VP6]] i32 [[VP4]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP10]], Cloned.[[BB5:BB[0-9]+]], Cloned.[[BB2]]
; CHECK-EMPTY:
...
; CHECK-NEXT:  Id: 0   no underlying for i32 [[VP11]]
;
entry:
  br label %preheader

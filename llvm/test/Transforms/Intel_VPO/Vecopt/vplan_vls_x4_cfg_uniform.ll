...
; CHECK-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <4 x i32> @llvm.masked.gather.v4i32.v4p0i32(<4 x i32*> [[MM_VECTORGEP]], i32 4, <4 x i1> [[TMP2]], <4 x i32> undef)
...
; CHECK-NEXT:    [[TMP5:%.*]] = add nsw <4 x i32> [[WIDE_MASKED_GATHER4]], <i32 11, i32 11, i32 11, i32 11>
; CHECK-NEXT:    [[TMP6:%.*]] = or <4 x i64> [[VEC_IND]], <i64 2, i64 2, i64 2, i64 2>
...
; CHECK-NEXT:    [[TMP7:%.*]] = add nsw <4 x i32> [[WIDE_MASKED_GATHER6]], <i32 12, i32 12, i32 12, i32 12>
; CHECK-NEXT:    [[TMP8:%.*]] = or <4 x i64> [[VEC_IND]], <i64 3, i64 3, i64 3, i64 3>
; CHECK-NEXT:    [[MM_VECTORGEP7:%.*]] = getelementptr inbounds i32, <4 x i32*> [[BROADCAST_SPLAT2]], <4 x i64> [[TMP8]]
; CHECK-NEXT:    [[WIDE_MASKED_GATHER8:%.*]] = call <4 x i32> @llvm.masked.gather.v4i32.v4p0i32(<4 x i32*> [[MM_VECTORGEP7]], i32 4, <4 x i1> [[TMP2]], <4 x i32> undef)
; CHECK-NEXT:    [[TMP9:%.*]] = add nsw <4 x i32> [[WIDE_MASKED_GATHER8]], <i32 61, i32 61, i32 61, i32 61>
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i32.v4p0i32(<4 x i32> [[TMP3]], <4 x i32*> [[MM_VECTORGEP]], i32 4, <4 x i1> [[TMP2]])
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i32.v4p0i32(<4 x i32> [[TMP5]], <4 x i32*> [[MM_VECTORGEP3]], i32 4, <4 x i1> [[TMP2]])
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i32.v4p0i32(<4 x i32> [[TMP7]], <4 x i32*> [[MM_VECTORGEP5]], i32 4, <4 x i1> [[TMP2]])
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i32.v4p0i32(<4 x i32> [[TMP9]], <4 x i32*> [[MM_VECTORGEP7]], i32 4, <4 x i1> [[TMP2]])

...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE5:%.*]] = shufflevector <4 x i8> [[TMP1]], <4 x i8> [[TMP3]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE3:%.*]] = shufflevector <4 x i8> [[TMP5]], <4 x i8> [[TMP7]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE4:%.*]] = shufflevector <4 x i8> [[TMP13]], <4 x i8> [[TMP15]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP26:%.*]] = insertelement <4 x i32> poison, i32 [[TMP25]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP27:%.*]] = extractelement <8 x i32> [[TMP24]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP28:%.*]] = insertelement <4 x i32> [[TMP26]], i32 [[TMP27]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP29:%.*]] = extractelement <8 x i32> [[TMP24]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP30:%.*]] = insertelement <4 x i32> [[TMP28]], i32 [[TMP29]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP31:%.*]] = extractelement <8 x i32> [[TMP24]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP32:%.*]] = insertelement <4 x i32> [[TMP30]], i32 [[TMP31]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP32]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 2, i32 3, i32 3, i32 3>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP33:%.*]] = extractelement <8 x i32> [[TMP24]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP34:%.*]] = insertelement <4 x i32> poison, i32 [[TMP33]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP35:%.*]] = insertelement <4 x i32> [[TMP34]], i32 [[TMP25]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP36:%.*]] = extractelement <8 x i32> [[TMP24]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP37:%.*]] = insertelement <4 x i32> [[TMP35]], i32 [[TMP36]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP38:%.*]] = insertelement <4 x i32> [[TMP37]], i32 [[TMP29]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP38]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 2, i32 3, i32 2, i32 2>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP39:%.*]] = add <8 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP40:%.*]] = sub <8 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP41:%.*]] = shufflevector <8 x i32> [[TMP39]], <8 x i32> [[TMP40]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 13, i32 6, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP42:%.*]] = extractelement <8 x i32> [[TMP24]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP43:%.*]] = insertelement <4 x i32> poison, i32 [[TMP42]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP44:%.*]] = insertelement <4 x i32> [[TMP43]], i32 [[TMP25]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP45:%.*]] = extractelement <8 x i32> [[TMP24]], i32 6
; 8WIDE_PATH_STEERING-NEXT:    [[TMP46:%.*]] = insertelement <4 x i32> [[TMP44]], i32 [[TMP45]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP47:%.*]] = insertelement <4 x i32> [[TMP46]], i32 [[TMP29]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <4 x i32> [[TMP47]], <4 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP48:%.*]] = add <8 x i32> [[TMP41]], [[SHUFFLE2]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP49:%.*]] = sub <8 x i32> [[TMP41]], [[SHUFFLE2]]
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP51:%.*]] = add <8 x i32> [[TMP50]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP52:%.*]] = sub <8 x i32> [[TMP50]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP53:%.*]] = shufflevector <8 x i32> [[TMP51]], <8 x i32> [[TMP52]], <8 x i32> <i32 0, i32 9, i32 10, i32 3, i32 4, i32 13, i32 14, i32 7>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP54:%.*]] = bitcast i32* [[ARRAYIDX1043]] to <8 x i32>*
; 8WIDE_PATH_STEERING-NEXT:    store <8 x i32> [[TMP53]], <8 x i32>* [[TMP54]], align 4

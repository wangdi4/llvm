...
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i32> [[TMP32]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 2, i32 3, i32 3, i32 3>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP33:%.*]] = extractelement <8 x i32> [[TMP24]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP34:%.*]] = insertelement <8 x i32> poison, i32 [[TMP33]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP35:%.*]] = insertelement <8 x i32> [[TMP34]], i32 [[TMP25]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP36:%.*]] = extractelement <8 x i32> [[TMP24]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP37:%.*]] = insertelement <8 x i32> [[TMP35]], i32 [[TMP36]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP38:%.*]] = insertelement <8 x i32> [[TMP37]], i32 [[TMP29]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <8 x i32> [[TMP38]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 2, i32 3, i32 2, i32 2>
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP43:%.*]] = insertelement <8 x i32> poison, i32 [[TMP42]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP44:%.*]] = insertelement <8 x i32> [[TMP43]], i32 [[TMP25]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP45:%.*]] = extractelement <8 x i32> [[TMP24]], i32 6
; 8WIDE_PATH_STEERING-NEXT:    [[TMP46:%.*]] = insertelement <8 x i32> [[TMP44]], i32 [[TMP45]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP47:%.*]] = insertelement <8 x i32> [[TMP46]], i32 [[TMP29]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <8 x i32> [[TMP47]], <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2>

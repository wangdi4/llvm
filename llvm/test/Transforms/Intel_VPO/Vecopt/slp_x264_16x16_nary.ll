...
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP32]], <4 x i32> undef, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 2, i32 3, i32 3, i32 3>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP38]], <4 x i32> undef, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 2, i32 3, i32 2, i32 2>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <4 x i32> [[TMP47]], <4 x i32> undef, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2>

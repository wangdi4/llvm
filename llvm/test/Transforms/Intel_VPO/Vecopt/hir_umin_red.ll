...
; This test case checks that the reduction with the intrinsic llvm.umin
...
; CHECK:  (UIntMin) Start: i32 %min.013 Exit: i32 [[VP_LOAD:%.*]]
...
; CHECK: |   %llvm.umin.v8i32 = @llvm.umin.v8i32(%.vec7,  %phi.temp5);
; CHECK: |   %phi.temp5 = %llvm.umin.v8i32;
; CHECK: + END LOOP
; CHECK: %min.013 = @llvm.vector.reduce.umin.v8i32(%llvm.umin.v8i32);

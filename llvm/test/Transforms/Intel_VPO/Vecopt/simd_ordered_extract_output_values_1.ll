...
; RUN: opt < %s -S -vplan-pragma-omp-ordered-simd-extract -print-after=vplan-pragma-omp-ordered-simd-extract -disable-output --vpo-utils-add-typed-privates 2>&1 | FileCheck %s --check-prefixes=CHECK,TYPED
; RUN: opt < %s -S -vplan-pragma-omp-ordered-simd-extract -print-after=vplan-pragma-omp-ordered-simd-extract -disable-output 2>&1 | FileCheck %s --check-prefixes=CHECK,UNTYPED

...
; RUN: opt -S < %s -VPlanDriver -enable-vp-value-codegen -disable-output -vplan-print-after-linearization -disable-vplan-subregions -disable-vplan-loop-regions | FileCheck %s
;

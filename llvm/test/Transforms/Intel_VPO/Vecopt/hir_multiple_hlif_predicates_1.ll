...
; Check plain HCFG
; HCFG: i1 [[Cmp1:%.*]] = icmp ult i64 {{%.*}} i64 512
; HCFG-NEXT: i1 [[Cmp2:%.*]] = icmp sgt i32 {{%.*}} i32 0
; HCFG-NEXT: i1 [[And:%.*]] = and i1 [[Cmp1]] i1 [[Cmp2]]
; HCFG: br i1 [[And]], {{BB[0-9]+}}, {{BB[0-9]+}}
...
define dso_local i32 @foo(ptr nocapture %arr, i32 %n1) local_unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx6 = getelementptr inbounds i32, ptr %arr, i64 %3
...
for.end:                                          ; preds = %for.inc
  %4 = load i32, ptr %arr, align 4, !tbaa !2
  ret i32 %4
}

...
; RUN:     -disable-output -vplan-force-vf=2 -vplan-cost-model-print-analysis-for-vf=2 2>&1 | FileCheck %s
...
;CHECK-NEXT:   Cost 1000 for i1 [[VP5:%.*]] = icmp sgt i32 [[VP2]] i32 1
;CHECK-NEXT:   Cost 6000 for %"EXTENT$.btINTVL" = type { i32, i32 } [[VP9:%.*]] = select i1 [[VP5]] %"EXTENT$.btINTVL" = type { i32, i32 } [[VP17]] %"EXTENT$.btINTVL" = type { i32, i32 } [[VP18]]

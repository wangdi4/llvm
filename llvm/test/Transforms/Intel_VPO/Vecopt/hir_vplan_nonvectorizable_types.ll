...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT:%.*]] = subscript inbounds ptr %"A.addr_a0$_fetch.8" i64 [[VP2]] (0 )
; CHECK-NEXT:    Cost 9 for i32 [[VP_LOAD:%.*]] = load ptr [[VP_SUBSCRIPT]]
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds ptr %"var$6" i64 [[VP2]]
; CHECK-NEXT:    Cost 1.0625 for store i32 [[VP16]] ptr [[VP_SUBSCRIPT_1]]
...
alloca_2:
  %"A.addr_a0$" = getelementptr inbounds %"QNCA_a0$%\22EXTENT$.btINTVL\22*$rank1$", ptr %A, i64 0, i32 0
  %"A.addr_a0$_fetch.8" = load ptr, ptr %"A.addr_a0$", align 1
...
loop_body10:                                      ; preds = %loop_body10.preheader, %loop_body10
  ...
  %"A.addr_a0$_fetch.8[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %"A.dim_info$.spacing$[]_fetch.9", ptr elementtype(%"EXTENT$.btINTVL") %"A.addr_a0$_fetch.8", i64 %"$loop_ctr.012")
  %"A.FIRST$.i" = getelementptr inbounds %"EXTENT$.btINTVL", ptr %"A.addr_a0$_fetch.8[]", i64 0, i32 0
  %"A.FIRST$_fetch.1.i" = load i32, ptr %"A.FIRST$.i", align 1

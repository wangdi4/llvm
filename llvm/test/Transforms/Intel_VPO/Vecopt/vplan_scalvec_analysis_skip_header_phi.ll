...
; REQUIRES: asserts
; RUN: opt -S < %s -vplan-vec -vplan-force-vf=2 -disable-output -vplan-enable-scalvec-analysis -vplan-print-scalvec-results | FileCheck %s
...
; CHECK-NEXT:       [DA: Uni, SVA: (F  )] i1 [[VP_SIMD_EXITCOND:%.*]] = icmp uge i64 [[VP_SIMD_IV_NEXT]] i64 [[VP_VECTOR_TRIP_COUNT]] (SVAOpBits 0->F 1->F )

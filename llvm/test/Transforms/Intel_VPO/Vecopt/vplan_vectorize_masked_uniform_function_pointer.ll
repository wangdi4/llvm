...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT50:%.*]] = insertelement <4 x i32> poison, i32 [[TMP12]], i32 0
...
; CHECK-NEXT:    [[BROADCAST_SPLATINSERT70:%.*]] = insertelement <4 x i32> poison, i32 [[TMP21]], i32 0

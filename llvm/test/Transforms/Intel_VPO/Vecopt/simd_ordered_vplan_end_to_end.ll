...
; RUN: opt -S < %s -vplan-pragma-omp-ordered-simd-extract -vplan-force-vf=2 -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -vplan-enable-new-cfg-merge-hir=0 | FileCheck %s --check-prefix=HIR
; RUN: opt -S < %s -vplan-pragma-omp-ordered-simd-extract -vplan-force-vf=2 -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -vplan-enable-new-cfg-merge-hir=1 | FileCheck %s --check-prefix=HIR

...
; RUN: opt -opaque-pointers=0 -S < %s -passes=vplan-pragma-omp-ordered-simd-extract,vplan-vec -vplan-force-vf=2 | FileCheck %s --check-prefix=LLVMIR
; RUN: opt -opaque-pointers=0 -S < %s -passes=vplan-pragma-omp-ordered-simd-extract,hir-ssa-deconstruction,hir-vplan-vec -vplan-force-vf=2 | FileCheck %s --check-prefix=HIR

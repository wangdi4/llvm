...
; RUN: opt -S < %s -vplan-pragma-omp-ordered-simd-extract -vplan-force-vf=2 -hir-framework -VPlanDriverHIR | FileCheck %s --check-prefix=HIR
...
; LLVMIR-NEXT:    br i1 [[TMP3]], label [[VPLANNEDBB0:%.*]], label [[VECTOR_BODY0]]
; LLVMIR-EMPTY:
...
; LLVMIR-NEXT:    br i1 [[EXITCOND0]], label [[FOR_END0]], label [[FOR_BODY0]]
; LLVMIR-EMPTY:
; LLVMIR-NEXT:  for.end:
...
; LLVMIR-EMPTY:
; LLVMIR-NEXT:  ordered:
; LLVMIR-NEXT:    [[VAL0:%.*]] = load i32, i32* [[X0]]
...
; HIR-EMPTY:
; HIR-NEXT:  for.body:
; HIR-NEXT:    [[INDVARS_IV0:%.*]] = phi i64 [ [[INDVARS_IV_NEXT0:%.*]], [[LATCH0:%.*]] ], [ 0, [[FOR_BODY_PREHEADER0]] ]

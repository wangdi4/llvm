...
; RUN: opt -enable-new-pm=0 -hir-ssa-deconstruction -hir-framework  -hir-vec-dir-insert -hir-vplan-vec -print-after=hir-vplan-vec -vplan-enable-new-cfg-merge-hir=false -hir-details -disable-output < %s 2>&1 | FileCheck %s
; RUN: opt -passes='hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -vplan-enable-new-cfg-merge-hir=false -hir-details -disable-output < %s 2>&1 | FileCheck %s
; RUN: opt -enable-new-pm=0 -hir-ssa-deconstruction -hir-framework  -hir-vec-dir-insert -hir-vplan-vec -print-after=hir-vplan-vec -vplan-enable-new-cfg-merge-hir -hir-details -disable-output < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,MERGED-CFG
; RUN: opt -passes='hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -vplan-enable-new-cfg-merge-hir -hir-details -disable-output < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,MERGED-CFG
...
; CHECK-NEXT:        |
; CHECK-NEXT:        |   [[BB1]].90:
; MERGED-CFG-NEXT:   |   [[PHI_TEMP350:%.*]] = [[PHI_TEMP270]];
; MERGED-CFG-NEXT:   |   <LVAL-REG> NON-LINEAR i32 [[PHI_TEMP350]] {sb:59}
; MERGED-CFG-NEXT:   |   <RVAL-REG> NON-LINEAR i32 [[PHI_TEMP270]] {sb:54}
; MERGED-CFG-NEXT:   |
; MERGED-CFG-NEXT:   |   [[PHI_TEMP370:%.*]] = [[PHI_TEMP210]];
; MERGED-CFG-NEXT:   |   <LVAL-REG> NON-LINEAR float [[PHI_TEMP370]] {sb:60}
; MERGED-CFG-NEXT:   |   <RVAL-REG> NON-LINEAR float [[PHI_TEMP210]] {sb:45}
; MERGED-CFG-NEXT:   |
; MERGED-CFG-NEXT:   |   [[PHI_TEMP390:%.*]] = 128;
; MERGED-CFG-NEXT:   |   <LVAL-REG> NON-LINEAR i64 [[PHI_TEMP390]] {sb:61}
; MERGED-CFG-NEXT:   |

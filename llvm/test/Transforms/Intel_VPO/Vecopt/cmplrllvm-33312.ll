...
; RUN: opt < %s -tbaa -hir-ssa-deconstruction -hir-framework  -hir-vec-dir-insert -hir-vplan-vec -disable-output -print-after=hir-vplan-vec  -hir-details 2>&1 | FileCheck %s

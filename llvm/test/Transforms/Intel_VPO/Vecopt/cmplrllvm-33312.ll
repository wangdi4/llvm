...
; RUN: opt -enable-new-pm=0 -hir-ssa-deconstruction -hir-framework  -hir-vec-dir-insert -hir-vplan-vec -print-after=hir-vplan-vec -vplan-enable-new-cfg-merge-hir -hir-details -disable-output < %s 2>&1 | FileCheck %s
; RUN: opt -passes='hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -vplan-enable-new-cfg-merge-hir -hir-details -disable-output < %s 2>&1 | FileCheck %s

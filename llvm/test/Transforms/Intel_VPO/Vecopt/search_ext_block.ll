...
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -allow-memory-speculation -hir-vplan-vec -debug -debug-only=vplan-idioms -vplan-print-after-plain-cfg -disable-output %s -vplan-enable-new-cfg-merge-hir=0 | FileCheck %s
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -allow-memory-speculation -hir-vplan-vec -debug -debug-only=vplan-idioms -vplan-print-after-plain-cfg -disable-output %s -vplan-enable-new-cfg-merge-hir=1 | FileCheck %s

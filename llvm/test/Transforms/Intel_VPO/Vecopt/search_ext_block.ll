...
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -allow-memory-speculation -VPlanDriverHIR -debug -debug-only=vplan-idioms -vplan-print-after-plain-cfg -disable-output %s | FileCheck %s

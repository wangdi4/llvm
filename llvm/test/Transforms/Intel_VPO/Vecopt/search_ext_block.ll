...
; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec' -allow-memory-speculation -debug -debug-only=vplan-idioms -vplan-print-after-plain-cfg -disable-output %s | FileCheck %s

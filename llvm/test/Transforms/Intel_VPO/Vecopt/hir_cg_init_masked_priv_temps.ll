...
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,vplan-driver-hir,print<hir>,hir-cg,sroa" -vplan-force-vf=4 -enable-vp-value-codegen-hir=0 -S < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,IRCHECK
...
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,vplan-driver-hir,print<hir>,hir-cg,sroa" -vplan-force-vf=4 -enable-vp-value-codegen-hir -S < %s 2>&1 | FileCheck %s --check-prefixes=VPCHECK,IRCHECK

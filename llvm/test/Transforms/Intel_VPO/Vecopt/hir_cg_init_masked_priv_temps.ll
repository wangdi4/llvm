...
; VPCHECK-NEXT:   |   %.vec7 = (<4 x i32>*)(@d)[0][i1]; Mask = @{%.vec3}
; VPCHECK-NEXT:   |   %.vec9 = i1 + <i32 0, i32 1, i32 2, i32 3> + %.vec5 + %.vec6 < %.vec7;
; VPCHECK-NEXT:   |   %.vec10 = %.vec3  &  %.vec9;
; VPCHECK-NEXT:   |   %.vec11 = %.vec4  *  2;
; VPCHECK-NEXT:   |   %.vec12 = %.vec  *  i1 + <i32 0, i32 1, i32 2, i32 3>;
; VPCHECK-NEXT:   |   (<4 x i32>*)(@e)[0][i1] = %.vec11 + %.vec12; Mask = @{%.vec10}

...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -S < %s -passes='hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec' -disable-output -vplan-dump-external-defs-hir=false -vplan-enable-scalvec-analysis -vplan-print-scalvec-results | FileCheck %s

...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 3000 for i32 [[VP12:%.*]] = udiv i32 [[VP10]] i32 [[VP11]] *IDiv/IRem*(-77000)
...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 3000 for i32 [[VP17:%.*]] = sdiv i32 [[VP15]] i32 [[VP16]] *IDiv/IRem*(-77000)
; VPLAN-HIR-CM-VF4-NEXT:    Cost 16000 for i64 [[VP18:%.*]] = udiv i64 [[VP_LOAD_1]] i64 7 *IDiv/IRem*(-144000)
...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 8000 for i64 [[VP21:%.*]] = udiv i64 [[VP20]] i64 [[VP_LOAD_3]] *IDiv/IRem*(-72000)
; VPLAN-HIR-CM-VF4-NEXT:    Cost 48000 for i64 [[VP22:%.*]] = sdiv i64 [[VP21]] i64 -7 *IDiv/IRem*(-432000)
...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 8000 for i64 [[VP25:%.*]] = sdiv i64 [[VP24]] i64 [[VP_LOAD_3]] *IDiv/IRem*(-72000)

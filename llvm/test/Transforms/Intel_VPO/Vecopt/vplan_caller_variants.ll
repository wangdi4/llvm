; RUN: opt %s -S -hir-vplan-vec -debug-only=VPlanCallVecDecisions -disable-output 2>&1 | FileCheck %s
...
DIR.OMP.SIMD.1:                                   ; preds = %DIR.OMP.SIMD.127
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 8), "QUAL.OMP.LINEAR:IV"(i32* %i.linear.iv, i32 1) ]
...
omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.2, %omp.inner.for.body
  ...
  %arrayidx = getelementptr inbounds [128 x i32], [128 x i32]* %b, i64 0, i64 %indvars.iv
  %call = call noundef i32 @_Z3fooiPiRi(i32 noundef 1, i32* noundef nonnull %arrayidx, i32* noundef nonnull align 4 dereferenceable(4) %i.linear.iv)
  %2 = load i32, i32* %i.linear.iv, align 4
  %idxprom1 = sext i32 %2 to i64
  %arrayidx2 = getelementptr inbounds [128 x i32], [128 x i32]* %a, i64 0, i64 %idxprom1
...
declare dso_local noundef i32 @_Z3fooiPiRi(i32 noundef, i32* noundef, i32* noundef nonnull align 4 dereferenceable(4)) local_unnamed_addr #3

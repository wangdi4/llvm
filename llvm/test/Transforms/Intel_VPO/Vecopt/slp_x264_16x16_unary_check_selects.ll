...
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -mtriple=x86_64-unknown-linux-gnu -pslp -mcpu=skylake-avx512 -x86-experimental-max-legal-vector-width=256 -tti -S | FileCheck %s -check-prefix=8WIDE
...
; 8WIDE-NEXT:    [[TMP161:%.*]] = add <8 x i32> [[TMP90]], [[TMP160]]

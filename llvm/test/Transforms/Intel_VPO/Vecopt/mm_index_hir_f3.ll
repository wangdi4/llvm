...
;CHECK-NEXT: [MinMax+Index] Skipped: nonlinear rhs disabled (nonterm)
;
;<0>          BEGIN REGION { }
;<18>               + DO i1 = 0, sext.i32.i64(%m) + -1, 1   <DO_LOOP>
;<6>                |   %0 = (%ordering)[i1];
;<10>               |   %tmp.027 = (%0 > %best.026) ? (%ordering)[i1 + -1] : %tmp.027;
;<11>               |   %best.026 = (%0 > %best.026) ? %0 : %best.026;
;<18>               + END LOOP
;<0>          END REGION
;
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %ndx2 = sub nuw nsw i64 %indvars.iv, 1
  %arrayidx2 = getelementptr inbounds i32, i32* %ordering, i64 %ndx2
  %0 = load i32, i32* %arrayidx, align 4, !tbaa !2
  %ld2 = load i32, i32* %arrayidx2, align 4, !tbaa !2
  %cmp1 = icmp sgt i32 %0, %best.026
  %1 = trunc i64 %indvars.iv to i32
  %2 = select i1 %cmp1, i32 %ld2, i32 %tmp.027

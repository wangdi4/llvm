...
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,vplan-driver-hir" -mtriple=x86_64-unknown-unknown -mattr=+avx2 -disable-output -vplan-cost-model-print-analysis-for-vf=4 -vplan-cost-model-use-gettype -vplan-force-vf=4 < %s 2>&1 | FileCheck %s
...
;
; CHECK-LABEL:  Cost Model for VPlan HIR foo.19 with VF = 4:

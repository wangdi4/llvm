...
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,vplan-driver-hir" -vplan-force-vf=4 -print-after=vplan-driver-hir -enable-mmindex=1 -disable-output %s 2>&1 | FileCheck %s

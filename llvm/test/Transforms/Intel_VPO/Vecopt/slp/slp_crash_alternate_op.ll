...
; RUN: opt < %s  -slp-vectorizer -enable-intel-advanced-opts -slp-multinode=false -slp-multinode-legacy -S -mtriple=x86_64-unknown-linux-gnu -mcpu=core-avx2 | FileCheck %s
; RUN: opt < %s  -slp-vectorizer -enable-intel-advanced-opts -slp-multinode -S -mtriple=x86_64-unknown-linux-gnu -mcpu=core-avx2 | FileCheck %s

...
; INTADV-NEXT:    [[TMP0:%.*]] = insertelement <4 x i32> poison, i32 [[DOTNEG313_NEG]], i32 0
...
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <2 x i32> poison, i32 [[I1]], i32 0
...
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <2 x i32> [[TMP2]], <2 x i32> [[TMP3]], <4 x i32> <i32 0, i32 0, i32 3, i32 0>
; CHECK-NEXT:    [[TMP5:%.*]] = mul <4 x i32> [[TMP4]], <i32 6, i32 5, i32 4, i32 3>
; CHECK-NEXT:    [[TMP6:%.*]] = add <4 x i32> [[TMP4]], <i32 6, i32 5, i32 4, i32 3>
; CHECK-NEXT:    [[TMP7:%.*]] = shufflevector <4 x i32> [[TMP5]], <4 x i32> [[TMP6]], <4 x i32> <i32 0, i32 1, i32 6, i32 3>
; CHECK-NEXT:    [[TMP8:%.*]] = insertelement <4 x i32> poison, i32 [[GEPLOAD]], i32 0
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP8]], <4 x i32> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP9:%.*]] = sub <4 x i32> [[TMP7]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <4 x i32> poison, i32 [[I12]], i32 0
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP10]], <4 x i32> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP11:%.*]] = sub <4 x i32> [[TMP9]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP12:%.*]] = add <4 x i32> [[TMP11]], <i32 50, i32 50, i32 50, i32 50>
; CHECK-NEXT:    [[TMP13:%.*]] = call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> [[TMP12]])
; CHECK-NEXT:    [[TMP14:%.*]] = or i32 [[TMP13]], [[I18]]
; CHECK-NEXT:    [[TMP15:%.*]] = or i32 [[TMP14]], [[I16]]
; CHECK-NEXT:    [[OP_EXTRA:%.*]] = or i32 [[TMP15]], [[I15]]

...
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -slp-multinode=false -slp-multinode-legacy -mtriple="x86_64" -mcpu=skylake-avx512 -S | FileCheck %s
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -slp-multinode -mtriple="x86_64" -mcpu=skylake-avx512 -S | FileCheck %s -check-prefix=CHECKNEW
...
; CHECK-NEXT:    [[T0:%.*]] = add i64 [[C:%.*]], 2
; CHECK-NEXT:    [[T12:%.*]] = sub i64 [[C]], 1
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <2 x i64> poison, i64 [[T0]], i32 0
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x i64> [[TMP1]], i64 [[T12]], i32 1
; CHECK-NEXT:    [[TMP3:%.*]] = sub <2 x i64> [[TMP2]], <i64 1, i64 2>
; CHECK-NEXT:    [[TMP4:%.*]] = add <2 x i64> [[TMP2]], <i64 1, i64 2>
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <2 x i64> [[TMP3]], <2 x i64> [[TMP4]], <4 x i32> <i32 0, i32 3, i32 3, i32 3>
; CHECK-NEXT:    [[TMP6:%.*]] = load <4 x i64>, <4 x i64>* bitcast ([4 x i64]* @C to <4 x i64>*), align 8
; CHECK-NEXT:    [[TMP7:%.*]] = load <4 x i64>, <4 x i64>* bitcast ([4 x i64]* @B to <4 x i64>*), align 8
; CHECK-NEXT:    [[TMP8:%.*]] = shl <4 x i64> [[TMP7]], [[TMP5]]
; CHECK-NEXT:    [[TMP9:%.*]] = shufflevector <4 x i64> [[TMP5]], <4 x i64> poison, <4 x i32> <i32 1, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i64> [[TMP9]], <4 x i64> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP10:%.*]] = shl <4 x i64> [[TMP6]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP11:%.*]] = add <4 x i64> [[TMP10]], [[TMP8]]
; CHECK-NEXT:    store <4 x i64> [[TMP11]], <4 x i64>* bitcast ([4 x i64]* @A to <4 x i64>*), align 8
; CHECK-NEXT:    ret void
;
; CHECKNEW-LABEL: @crash_condition(
; CHECKNEW-NEXT:    [[TMP1:%.*]] = insertelement <2 x i64> poison, i64 [[C:%.*]], i32 0
; CHECKNEW-NEXT:    [[TMP2:%.*]] = insertelement <2 x i64> [[TMP1]], i64 [[C]], i32 1
; CHECKNEW-NEXT:    [[TMP3:%.*]] = add <2 x i64> [[TMP2]], <i64 2, i64 2>
; CHECKNEW-NEXT:    [[TMP4:%.*]] = sub nsw <2 x i64> [[TMP3]], <i64 1, i64 1>
; CHECKNEW-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <2 x i64> [[TMP4]], <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
; CHECKNEW-NEXT:    [[TMP5:%.*]] = load <4 x i64>, <4 x i64>* bitcast ([4 x i64]* @C to <4 x i64>*), align 8
; CHECKNEW-NEXT:    [[TMP6:%.*]] = load <4 x i64>, <4 x i64>* bitcast ([4 x i64]* @B to <4 x i64>*), align 8
; CHECKNEW-NEXT:    [[TMP7:%.*]] = shl <4 x i64> [[TMP6]], [[SHUFFLE1]]
; CHECKNEW-NEXT:    [[TMP8:%.*]] = shufflevector <2 x i64> [[TMP4]], <2 x i64> poison, <4 x i32> <i32 1, i32 undef, i32 undef, i32 undef>
; CHECKNEW-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i64> [[TMP8]], <4 x i64> poison, <4 x i32> zeroinitializer
; CHECKNEW-NEXT:    [[TMP9:%.*]] = shl <4 x i64> [[TMP5]], [[SHUFFLE]]
; CHECKNEW-NEXT:    [[TMP10:%.*]] = add <4 x i64> [[TMP9]], [[TMP7]]
; CHECKNEW-NEXT:    store <4 x i64> [[TMP10]], <4 x i64>* bitcast ([4 x i64]* @A to <4 x i64>*), align 8
; CHECKNEW-NEXT:    ret void
;
  %t0 = add i64 %c, 2
  %c0 = sub nsw i64 %t0, 1
  %t1 = add i64 %c, 2

...
; RUN: opt < %s -passes=slp-vectorizer -enable-intel-advanced-opts -mtriple=x86_64 -mcpu=skylake-avx512 -S | FileCheck %s
; RUN: opt < %s -passes=slp-vectorizer -enable-intel-advanced-opts -mtriple=x86_64 -mcpu=skylake-avx512 -slp-threshold=8 -S | FileCheck %s --check-prefix=COST

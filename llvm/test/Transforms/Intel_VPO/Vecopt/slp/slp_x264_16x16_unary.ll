...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP31:%.*]] = insertelement <8 x i32> [[TMP30]], i32 [[TMP25]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[TMP32:%.*]] = extractelement <8 x i32> [[TMP24]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP33:%.*]] = insertelement <8 x i32> [[TMP31]], i32 [[TMP32]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP34:%.*]] = extractelement <8 x i32> [[TMP24]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP35:%.*]] = insertelement <8 x i32> [[TMP33]], i32 [[TMP34]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP36:%.*]] = extractelement <8 x i32> [[TMP24]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP37:%.*]] = insertelement <8 x i32> [[TMP35]], i32 [[TMP36]], i32 6
; 8WIDE_PATH_STEERING-NEXT:    [[TMP38:%.*]] = extractelement <8 x i32> [[TMP24]], i32 6
; 8WIDE_PATH_STEERING-NEXT:    [[TMP39:%.*]] = insertelement <8 x i32> [[TMP37]], i32 [[TMP38]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP40:%.*]] = extractelement <8 x i32> [[TMP24]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP41:%.*]] = insertelement <8 x i32> poison, i32 [[TMP40]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP42:%.*]] = insertelement <8 x i32> [[TMP41]], i32 [[TMP29]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP43:%.*]] = insertelement <8 x i32> [[TMP42]], i32 [[TMP40]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP44:%.*]] = insertelement <8 x i32> [[TMP43]], i32 [[TMP27]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[TMP45:%.*]] = insertelement <8 x i32> [[TMP44]], i32 [[TMP36]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP46:%.*]] = insertelement <8 x i32> [[TMP45]], i32 [[TMP38]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP47:%.*]] = insertelement <8 x i32> [[TMP46]], i32 [[TMP32]], i32 6
; 8WIDE_PATH_STEERING-NEXT:    [[TMP48:%.*]] = insertelement <8 x i32> [[TMP47]], i32 [[TMP34]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP49:%.*]] = add <8 x i32> [[TMP39]], [[TMP48]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP50:%.*]] = sub <8 x i32> [[TMP39]], [[TMP48]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP51:%.*]] = shufflevector <8 x i32> [[TMP49]], <8 x i32> [[TMP50]], <8 x i32> <i32 0, i32 9, i32 10, i32 3, i32 4, i32 5, i32 14, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP52:%.*]] = insertelement <8 x i32> poison, i32 [[TMP29]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP53:%.*]] = insertelement <8 x i32> [[TMP52]], i32 [[TMP25]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP54:%.*]] = insertelement <8 x i32> [[TMP53]], i32 [[TMP27]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP55:%.*]] = insertelement <8 x i32> [[TMP54]], i32 [[TMP40]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[TMP56:%.*]] = insertelement <8 x i32> [[TMP55]], i32 [[TMP38]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP57:%.*]] = insertelement <8 x i32> [[TMP56]], i32 [[TMP36]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP58:%.*]] = insertelement <8 x i32> [[TMP57]], i32 [[TMP34]], i32 6
; 8WIDE_PATH_STEERING-NEXT:    [[TMP59:%.*]] = insertelement <8 x i32> [[TMP58]], i32 [[TMP32]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP60:%.*]] = add <8 x i32> [[TMP51]], [[TMP59]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP61:%.*]] = sub <8 x i32> [[TMP51]], [[TMP59]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP62:%.*]] = shufflevector <8 x i32> [[TMP60]], <8 x i32> [[TMP61]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 13, i32 14, i32 7>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP63:%.*]] = add <8 x i32> [[TMP62]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP64:%.*]] = sub <8 x i32> [[TMP62]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP65:%.*]] = shufflevector <8 x i32> [[TMP63]], <8 x i32> [[TMP64]], <8 x i32> <i32 0, i32 1, i32 10, i32 11, i32 4, i32 13, i32 6, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP66:%.*]] = bitcast i32* [[ARRAYIDX1043]] to <8 x i32>*
; 8WIDE_PATH_STEERING-NEXT:    store <8 x i32> [[TMP65]], <8 x i32>* [[TMP66]], align 4

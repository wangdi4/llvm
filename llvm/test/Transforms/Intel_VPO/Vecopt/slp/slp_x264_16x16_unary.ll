...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP29:%.*]] = shufflevector <8 x i32> [[TMP27]], <8 x i32> %28, <8 x i32> <i32 0, i32 9, i32 10, i32 3, i32 4, i32 5, i32 14, i32 15>
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP33:%.*]] = shufflevector <8 x i32> [[TMP31]], <8 x i32> %32, <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 13, i32 14, i32 7>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP34:%.*]] = add <8 x i32> [[TMP33]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP35:%.*]] = sub <8 x i32> [[TMP33]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP36:%.*]] = shufflevector <8 x i32> %34, <8 x i32> [[TMP35]], <8 x i32> <i32 0, i32 1, i32 10, i32 11, i32 4, i32 13, i32 6, i32 15>

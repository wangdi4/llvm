...
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -slp-multinode=false -slp-multinode-legacy -mtriple=x86_64 -mcpu=skylake-avx512 -enable-path-steering=true -S | FileCheck %s -check-prefix=8WIDE_PATH_STEERING

; RUN: opt < %s -passes=slp-vectorizer -enable-intel-advanced-opts -slp-multinode -mtriple=x86_64 -mcpu=skylake-avx512 -mattr=-prefer-256-bit -S | FileCheck %s -check-prefix=16WIDE
...
loop.1452:                                        ; preds = %loop.1452, %entry
  ...
  %2 = mul i64 %1, %0
  %arrayIdx = getelementptr inbounds i8, ptr %pix1, i64 %2
  %gepload = load i8, ptr %arrayIdx, align 1
  %3 = sext i32 %i_pix2 to i64
  %4 = mul i64 %1, %3
  %arrayIdx1020 = getelementptr inbounds i8, ptr %pix2, i64 %4
  %gepload1021 = load i8, ptr %arrayIdx1020, align 1
  %5 = add i64 %2, 4
  %arrayIdx1022 = getelementptr inbounds i8, ptr %pix1, i64 %5
  %gepload1023 = load i8, ptr %arrayIdx1022, align 1
  %6 = add i64 %4, 4
  %arrayIdx1024 = getelementptr inbounds i8, ptr %pix2, i64 %6
  %gepload1025 = load i8, ptr %arrayIdx1024, align 1
  %7 = or i64 %2, 1
  %arrayIdx1026 = getelementptr inbounds i8, ptr %pix1, i64 %7
  %gepload1027 = load i8, ptr %arrayIdx1026, align 1
  %8 = or i64 %4, 1
  %arrayIdx1028 = getelementptr inbounds i8, ptr %pix2, i64 %8
  %gepload1029 = load i8, ptr %arrayIdx1028, align 1
  %9 = add i64 %2, 5
  %arrayIdx1030 = getelementptr inbounds i8, ptr %pix1, i64 %9
  %gepload1031 = load i8, ptr %arrayIdx1030, align 1
  %10 = add i64 %4, 5
  %arrayIdx1032 = getelementptr inbounds i8, ptr %pix2, i64 %10
  %gepload1033 = load i8, ptr %arrayIdx1032, align 1
  %11 = add i64 %2, 2
  %arrayIdx1034 = getelementptr inbounds i8, ptr %pix1, i64 %11
  %gepload1035 = load i8, ptr %arrayIdx1034, align 1
  %12 = add i64 %4, 2
  %arrayIdx1036 = getelementptr inbounds i8, ptr %pix2, i64 %12
  %gepload1037 = load i8, ptr %arrayIdx1036, align 1
  %13 = add i64 %2, 6
  %arrayIdx1038 = getelementptr inbounds i8, ptr %pix1, i64 %13
  %gepload1039 = load i8, ptr %arrayIdx1038, align 1
  %14 = add i64 %4, 6
  %arrayIdx1040 = getelementptr inbounds i8, ptr %pix2, i64 %14
  %gepload1041 = load i8, ptr %arrayIdx1040, align 1
  %15 = add i64 %2, 3
  %arrayIdx1042 = getelementptr inbounds i8, ptr %pix1, i64 %15
  %gepload1043 = load i8, ptr %arrayIdx1042, align 1
  %16 = add i64 %4, 3
  %arrayIdx1044 = getelementptr inbounds i8, ptr %pix2, i64 %16
  %gepload1045 = load i8, ptr %arrayIdx1044, align 1
  %17 = add i64 %2, 7
  %arrayIdx1046 = getelementptr inbounds i8, ptr %pix1, i64 %17
  %gepload1047 = load i8, ptr %arrayIdx1046, align 1
  %18 = add i64 %4, 7
  %arrayIdx1048 = getelementptr inbounds i8, ptr %pix2, i64 %18
  %gepload1049 = load i8, ptr %arrayIdx1048, align 1
  %arrayIdx1050 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %1, i64 0
  ...
  %arrayIdx1052 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %1, i64 2
  ...
  %arrayIdx1070 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %1, i64 1
  ...
  %arrayIdx1088 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %1, i64 3
  ...
  %43 = add i64 %2, 8
  %arrayIdx1105 = getelementptr inbounds i8, ptr %pix1, i64 %43
  %gepload1106 = load i8, ptr %arrayIdx1105, align 1
  %44 = add i64 %4, 8
  %arrayIdx1107 = getelementptr inbounds i8, ptr %pix2, i64 %44
  %gepload1108 = load i8, ptr %arrayIdx1107, align 1
  %45 = add i64 %2, 12
  %arrayIdx1109 = getelementptr inbounds i8, ptr %pix1, i64 %45
  %gepload1110 = load i8, ptr %arrayIdx1109, align 1
  %46 = add i64 %4, 12
  %arrayIdx1111 = getelementptr inbounds i8, ptr %pix2, i64 %46
  %gepload1112 = load i8, ptr %arrayIdx1111, align 1
  %47 = add i64 %2, 9
  %arrayIdx1113 = getelementptr inbounds i8, ptr %pix1, i64 %47
  %gepload1114 = load i8, ptr %arrayIdx1113, align 1
  %48 = add i64 %4, 9
  %arrayIdx1115 = getelementptr inbounds i8, ptr %pix2, i64 %48
  %gepload1116 = load i8, ptr %arrayIdx1115, align 1
  %49 = add i64 %2, 13
  %arrayIdx1117 = getelementptr inbounds i8, ptr %pix1, i64 %49
  %gepload1118 = load i8, ptr %arrayIdx1117, align 1
  %50 = add i64 %4, 13
  %arrayIdx1119 = getelementptr inbounds i8, ptr %pix2, i64 %50
  %gepload1120 = load i8, ptr %arrayIdx1119, align 1
  %51 = add i64 %2, 10
  %arrayIdx1121 = getelementptr inbounds i8, ptr %pix1, i64 %51
  %gepload1122 = load i8, ptr %arrayIdx1121, align 1
  %52 = add i64 %4, 10
  %arrayIdx1123 = getelementptr inbounds i8, ptr %pix2, i64 %52
  %gepload1124 = load i8, ptr %arrayIdx1123, align 1
  %53 = add i64 %2, 14
  %arrayIdx1125 = getelementptr inbounds i8, ptr %pix1, i64 %53
  %gepload1126 = load i8, ptr %arrayIdx1125, align 1
  %54 = add i64 %4, 14
  %arrayIdx1127 = getelementptr inbounds i8, ptr %pix2, i64 %54
  %gepload1128 = load i8, ptr %arrayIdx1127, align 1
  %55 = add i64 %2, 11
  %arrayIdx1129 = getelementptr inbounds i8, ptr %pix1, i64 %55
  %gepload1130 = load i8, ptr %arrayIdx1129, align 1
  %56 = add i64 %4, 11
  %arrayIdx1131 = getelementptr inbounds i8, ptr %pix2, i64 %56
  %gepload1132 = load i8, ptr %arrayIdx1131, align 1
  %57 = add i64 %2, 15
  %arrayIdx1133 = getelementptr inbounds i8, ptr %pix1, i64 %57
  %gepload1134 = load i8, ptr %arrayIdx1133, align 1
  %58 = add i64 %4, 15
  %arrayIdx1135 = getelementptr inbounds i8, ptr %pix2, i64 %58
  %gepload1136 = load i8, ptr %arrayIdx1135, align 1
  %arrayIdx1138 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %1, i64 4
  ...
  %arrayIdx1140 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %1, i64 6
  ...
  %arrayIdx1158 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %1, i64 5
  ...
  %arrayIdx1176 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %1, i64 7
  ...
  %83 = add i64 %2, %0
  %arrayIdx1193 = getelementptr inbounds i8, ptr %pix1, i64 %83
  %gepload1194 = load i8, ptr %arrayIdx1193, align 1
  %84 = add i64 %4, %3
  %arrayIdx1195 = getelementptr inbounds i8, ptr %pix2, i64 %84
  ...
  %85 = or i64 %1, 1
  %arrayIdx1226 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %85, i64 0
  ...
  %arrayIdx1244 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %85, i64 2
  ...
  %arrayIdx1262 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %85, i64 1
  ...
  %arrayIdx1280 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %85, i64 3
  ...
  %arrayIdx1330 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %85, i64 4
  ...
  %arrayIdx1348 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %85, i64 6
  ...
  %arrayIdx1366 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %85, i64 5
  ...
  %arrayIdx1384 = getelementptr inbounds [16 x [8 x i32]], ptr %alloca, i64 0, i64 %85, i64 7
...
; 16WIDE: [[L1:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L2:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L3:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L4:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L5:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L6:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L7:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L8:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L9:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L10:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L11:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L12:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L13:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L14:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L15:%.*]] = load <4 x i8>, ptr
; 16WIDE: [[L16:%.*]] = load <4 x i8>, ptr
; 16WIDE: store <16 x i32>

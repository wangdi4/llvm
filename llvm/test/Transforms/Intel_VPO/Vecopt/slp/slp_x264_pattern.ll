...
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP20]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
; CHECK-NEXT:    [[TMP21:%.*]] = extractelement <4 x i32> [[TMP16]], i32 1
; CHECK-NEXT:    [[TMP22:%.*]] = insertelement <4 x i32> poison, i32 [[TMP21]], i32 0
; CHECK-NEXT:    [[TMP23:%.*]] = insertelement <4 x i32> [[TMP22]], i32 [[TMP17]], i32 1
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP23]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
; CHECK-NEXT:    [[TMP24:%.*]] = add <4 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP25:%.*]] = sub <4 x i32> [[SHUFFLE]], [[SHUFFLE1]]
...
; CHECK-NEXT:    [[TMP28:%.*]] = insertelement <4 x i32> poison, i32 [[TMP27]], i32 0
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <4 x i32> [[TMP28]], i32 [[TMP17]], i32 1
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <4 x i32> [[TMP29]], <4 x i32> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
; CHECK-NEXT:    [[TMP30:%.*]] = add <4 x i32> [[TMP26]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP31:%.*]] = sub <4 x i32> [[TMP26]], [[SHUFFLE2]]
...
; WOIC-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP20]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
; WOIC-NEXT:    [[TMP21:%.*]] = extractelement <4 x i32> [[TMP16]], i32 1
; WOIC-NEXT:    [[TMP22:%.*]] = insertelement <4 x i32> poison, i32 [[TMP21]], i32 0
; WOIC-NEXT:    [[TMP23:%.*]] = insertelement <4 x i32> [[TMP22]], i32 [[TMP17]], i32 1
; WOIC-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP23]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
...
; WOIC-NEXT:    [[TMP28:%.*]] = insertelement <4 x i32> poison, i32 [[TMP27]], i32 0
; WOIC-NEXT:    [[TMP29:%.*]] = insertelement <4 x i32> [[TMP28]], i32 [[TMP17]], i32 1
; WOIC-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <4 x i32> [[TMP29]], <4 x i32> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>

...
; CHECK-NEXT:    [[TMP17:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 3, i32 0, i32 1, i32 2>
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
; CHECK-NEXT:    [[TMP19:%.*]] = add <4 x i32> [[TMP17]], [[TMP18]]
; CHECK-NEXT:    [[TMP20:%.*]] = sub <4 x i32> [[TMP17]], [[TMP18]]
; CHECK-NEXT:    [[TMP21:%.*]] = shufflevector <4 x i32> [[TMP19]], <4 x i32> %20, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
; CHECK-NEXT:    [[TMP22:%.*]] = add <4 x i32> [[TMP21]], [[TMP16]]
; CHECK-NEXT:    [[TMP23:%.*]] = sub <4 x i32> [[TMP21]], [[TMP16]]
; CHECK-NEXT:    [[TMP24:%.*]] = shufflevector <4 x i32> [[TMP22]], <4 x i32> %23, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 1, i32 2, i32 3, i32 0>
; CHECK-NEXT:    [[TMP26:%.*]] = add <4 x i32> [[TMP24]], [[TMP25]]
; CHECK-NEXT:    [[TMP27:%.*]] = sub <4 x i32> [[TMP24]], [[TMP25]]
; CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <4 x i32> [[TMP26]], <4 x i32> %27, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
...
; WOIC-NEXT:    [[TMP17:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 3, i32 0, i32 1, i32 2>
; WOIC-NEXT:    [[TMP18:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
; WOIC-NEXT:    [[TMP19:%.*]] = add <4 x i32> [[TMP17]], [[TMP18]]
; WOIC-NEXT:    [[TMP20:%.*]] = sub <4 x i32> [[TMP17]], [[TMP18]]
; WOIC-NEXT:    [[TMP21:%.*]] = shufflevector <4 x i32> [[TMP19]], <4 x i32> %20, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
; WOIC-NEXT:    [[TMP22:%.*]] = add <4 x i32> [[TMP21]], [[TMP16]]
; WOIC-NEXT:    [[TMP23:%.*]] = sub <4 x i32> [[TMP21]], [[TMP16]]
; WOIC-NEXT:    [[TMP24:%.*]] = shufflevector <4 x i32> [[TMP22]], <4 x i32> %23, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
; WOIC-NEXT:    [[TMP25:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 1, i32 2, i32 3, i32 0>
; WOIC-NEXT:    [[TMP26:%.*]] = add <4 x i32> [[TMP24]], [[TMP25]]
; WOIC-NEXT:    [[TMP27:%.*]] = sub <4 x i32> [[TMP24]], [[TMP25]]
; WOIC-NEXT:    [[TMP28:%.*]] = shufflevector <4 x i32> [[TMP26]], <4 x i32> %27, <4 x i32> <i32 0, i32 5, i32 6, i32 3>

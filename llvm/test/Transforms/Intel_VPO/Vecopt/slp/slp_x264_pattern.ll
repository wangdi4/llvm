...
; RUN: opt < %s   -instcombine -slp-vectorizer -enable-intel-advanced-opts -slp-multinode -mtriple=x86_64 -mcpu=skylake-avx512 -S | FileCheck %s
; RUN: opt < %s   -slp-vectorizer -enable-intel-advanced-opts -slp-multinode -mtriple=x86_64 -mcpu=skylake-avx512 -S | FileCheck %s --check-prefixes=CHECKWOIC
...
; CHECK-NEXT:    [[TMP17:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 2, i32 0, i32 0, i32 3>
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 1>
...
; CHECKWOIC-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 3, i32 2>
; CHECKWOIC-NEXT:    [[TMP17:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 2, i32 0, i32 0, i32 3>
; CHECKWOIC-NEXT:    [[TMP18:%.*]] = shufflevector <4 x i32> [[TMP16]], <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 1>
; CHECKWOIC-NEXT:    [[TMP19:%.*]] = add <4 x i32> [[TMP17]], [[TMP18]]
; CHECKWOIC-NEXT:    [[TMP20:%.*]] = sub <4 x i32> [[TMP17]], [[TMP18]]
; CHECKWOIC-NEXT:    [[TMP21:%.*]] = shufflevector <4 x i32> [[TMP19]], <4 x i32> [[TMP20]], <4 x i32> <i32 0, i32 1, i32 2, i32 7>
; CHECKWOIC-NEXT:    [[TMP22:%.*]] = add <4 x i32> [[TMP21]], [[SHUFFLE]]
; CHECKWOIC-NEXT:    [[TMP23:%.*]] = sub <4 x i32> [[TMP21]], [[SHUFFLE]]

...
; CHECK_LO_LIMIT-NOT: [[L1:%.*]] = load <4 x i8>, ptr
; CHECK_LO_LIMIT-NOT: [[L2:%.*]] = load <4 x i8>, ptr
; CHECK_LO_LIMIT-NOT: [[L3:%.*]] = load <4 x i8>, ptr
; CHECK_LO_LIMIT-NOT: [[L4:%.*]] = load <4 x i8>, ptr
; CHECK_LO_LIMIT-NOT: [[L5:%.*]] = load <4 x i8>, ptr
; CHECK_LO_LIMIT-NOT: [[L6:%.*]] = load <4 x i8>, ptr
; CHECK_LO_LIMIT-NOT: [[L7:%.*]] = load <4 x i8>, ptr
; CHECK_LO_LIMIT-NOT: [[L8:%.*]] = load <4 x i8>, ptr

; Check that we vectorize Multi-Node with vector length 8
; CHECK_HI_LIMIT: [[L1:%.*]] = load <4 x i8>, ptr
; CHECK_HI_LIMIT: [[L2:%.*]] = load <4 x i8>, ptr
; CHECK_HI_LIMIT: [[L3:%.*]] = load <4 x i8>, ptr
; CHECK_HI_LIMIT: [[L4:%.*]] = load <4 x i8>, ptr
; CHECK_HI_LIMIT: [[L5:%.*]] = load <4 x i8>, ptr
; CHECK_HI_LIMIT: [[L6:%.*]] = load <4 x i8>, ptr
; CHECK_HI_LIMIT: [[L7:%.*]] = load <4 x i8>, ptr
; CHECK_HI_LIMIT: [[L8:%.*]] = load <4 x i8>, ptr
; CHECK_HI_LIMIT: store <8 x i32> [[SEL1:%.*]]


%struct.S = type { [8 x i32], [8 x i32] }

define i32 @foo(ptr nocapture readonly %pix1, i32 %i_pix1, ptr nocapture readonly %pix2, i32 %i_pix2, i32 %x, ptr nocapture %p) {
entry:
...
lp.1247:
  ...
  %64 = add i64 %0, 8
  %arrayIdx1098 = getelementptr inbounds i8, ptr %pix1, i64 %64
  %gepload1099 = load i8, ptr %arrayIdx1098, align 1
  %65 = add i64 %1, 8
  %arrayIdx1100 = getelementptr inbounds i8, ptr %pix2, i64 %65
  %gepload1101 = load i8, ptr %arrayIdx1100, align 1
  %66 = add i64 %0, 12
  %arrayIdx1102 = getelementptr inbounds i8, ptr %pix1, i64 %66
  %gepload1103 = load i8, ptr %arrayIdx1102, align 1
  %67 = add i64 %1, 12
  %arrayIdx1104 = getelementptr inbounds i8, ptr %pix2, i64 %67
  %gepload1105 = load i8, ptr %arrayIdx1104, align 1
  %68 = add i64 %0, 9
  %arrayIdx1106 = getelementptr inbounds i8, ptr %pix1, i64 %68
  %gepload1107 = load i8, ptr %arrayIdx1106, align 1
  %69 = add i64 %1, 9
  %arrayIdx1108 = getelementptr inbounds i8, ptr %pix2, i64 %69
  %gepload1109 = load i8, ptr %arrayIdx1108, align 1
  %70 = add i64 %0, 13
  %arrayIdx1110 = getelementptr inbounds i8, ptr %pix1, i64 %70
  %gepload1111 = load i8, ptr %arrayIdx1110, align 1
  %71 = add i64 %1, 13
  %arrayIdx1112 = getelementptr inbounds i8, ptr %pix2, i64 %71
  %gepload1113 = load i8, ptr %arrayIdx1112, align 1
  %72 = add i64 %0, 10
  %arrayIdx1114 = getelementptr inbounds i8, ptr %pix1, i64 %72
  %gepload1115 = load i8, ptr %arrayIdx1114, align 1
  %73 = add i64 %1, 10
  %arrayIdx1116 = getelementptr inbounds i8, ptr %pix2, i64 %73
  %gepload1117 = load i8, ptr %arrayIdx1116, align 1
  %74 = add i64 %0, 14
  %arrayIdx1118 = getelementptr inbounds i8, ptr %pix1, i64 %74
  %gepload1119 = load i8, ptr %arrayIdx1118, align 1
  %75 = add i64 %1, 14
  %arrayIdx1120 = getelementptr inbounds i8, ptr %pix2, i64 %75
  %gepload1121 = load i8, ptr %arrayIdx1120, align 1
  %76 = add i64 %0, 11
  %arrayIdx1122 = getelementptr inbounds i8, ptr %pix1, i64 %76
  %gepload1123 = load i8, ptr %arrayIdx1122, align 1
  %77 = add i64 %1, 11
  %arrayIdx1124 = getelementptr inbounds i8, ptr %pix2, i64 %77
  %gepload1125 = load i8, ptr %arrayIdx1124, align 1
  %78 = add i64 %0, 15
  %arrayIdx1126 = getelementptr inbounds i8, ptr %pix1, i64 %78
  %gepload1127 = load i8, ptr %arrayIdx1126, align 1
  %79 = add i64 %1, 15
  %arrayIdx1128 = getelementptr inbounds i8, ptr %pix2, i64 %79
...
lp.1248:
  ...
  %n3 = load i32, ptr %arrayidx7, align 4
  %sub8 = add i32 %n2, 2
  %add9 = sub i32 %sub8, %n3
  store i32 %add9, ptr %arrayidx7, align 4
  %arrayidx13 = getelementptr inbounds %struct.S, ptr %p, i64 0, i32 1, i64 2
  %n4 = load i32, ptr %arrayidx13, align 4
  %arrayidx15 = getelementptr inbounds %struct.S, ptr %p, i64 0, i32 0, i64 2
  %n5 = load i32, ptr %arrayidx15, align 4
  %sub16 = add i32 %n4, 3
  %add17 = sub i32 %sub16, %n5
  store i32 %add17, ptr %arrayidx15, align 4
  %arrayidx21 = getelementptr inbounds %struct.S, ptr %p, i64 0, i32 1, i64 3
  %n6 = load i32, ptr %arrayidx21, align 4
  %arrayidx23 = getelementptr inbounds %struct.S, ptr %p, i64 0, i32 0, i64 3
  %n7 = load i32, ptr %arrayidx23, align 4
  %sub24 = add i32 %n6, 4
  %add25 = sub i32 %sub24, %n7
  store i32 %add25, ptr %arrayidx23, align 4

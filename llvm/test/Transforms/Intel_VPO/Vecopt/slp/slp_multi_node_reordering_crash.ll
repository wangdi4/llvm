...
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -slp-multinode=false -slp-multinode-legacy -mcpu=haswell -multi-node-verifier-checks=true -S | FileCheck %s
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -slp-multinode -mcpu=haswell -S | FileCheck %s

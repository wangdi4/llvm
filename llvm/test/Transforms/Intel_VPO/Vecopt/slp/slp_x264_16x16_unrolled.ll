...
; CHECK-NEXT:    [[TMP103:%.*]] = shufflevector <16 x i32> [[TMP101]], <16 x i32> [[TMP102]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 16, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP104:%.*]] = insertelement <16 x i32> [[TMP103]], i32 [[BRIDGE_T797_2968]], i32 9
; CHECK-NEXT:    [[TMP105:%.*]] = shufflevector <16 x i32> [[TMP104]], <16 x i32> [[TMP102]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 undef, i32 undef, i32 undef, i32 undef>
...
; CHECK-NEXT:    [[TMP110:%.*]] = shufflevector <16 x i32> [[TMP108]], <16 x i32> [[TMP109]], <16 x i32> <i32 0, i32 17, i32 undef, i32 21, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
...
; CHECK-NEXT:    [[TMP115:%.*]] = shufflevector <16 x i32> [[TMP113]], <16 x i32> [[TMP114]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 17, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>

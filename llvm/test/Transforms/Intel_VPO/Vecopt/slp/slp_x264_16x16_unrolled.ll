...
; CHECK-NEXT:    [[TMP54:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <4 x i8> [[TMP54]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP56:%.*]] = insertelement <4 x i8> [[TMP55]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP57:%.*]] = insertelement <4 x i8> [[TMP56]], i8 [[GEPLOAD1306]], i32 3
; CHECK-NEXT:    [[TMP58:%.*]] = zext <4 x i8> [[TMP57]] to <4 x i32>
; CHECK-NEXT:    [[I113:%.*]] = zext i8 [[GEPLOAD1298]] to i32
; CHECK-NEXT:    [[TMP59:%.*]] = zext <2 x i8> [[TMP50]] to <2 x i32>
; CHECK-NEXT:    [[TMP60:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP61:%.*]] = insertelement <4 x i8> [[TMP60]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP62:%.*]] = insertelement <4 x i8> [[TMP61]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP63:%.*]] = insertelement <4 x i8> [[TMP62]], i8 [[GEPLOAD1310]], i32 3
; CHECK-NEXT:    [[TMP64:%.*]] = zext <4 x i8> [[TMP63]] to <4 x i32>
; CHECK-NEXT:    [[I117:%.*]] = zext i8 [[GEPLOAD1302]] to i32
; CHECK-NEXT:    [[TMP65:%.*]] = zext <2 x i8> [[TMP52]] to <2 x i32>
; CHECK-NEXT:    [[TMP66:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <4 x i8> [[TMP66]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP68:%.*]] = insertelement <4 x i8> [[TMP67]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP69:%.*]] = insertelement <4 x i8> [[TMP68]], i8 [[GEPLOAD1312]], i32 3
; CHECK-NEXT:    [[TMP70:%.*]] = zext <4 x i8> [[TMP69]] to <4 x i32>
; CHECK-NEXT:    [[I121:%.*]] = zext i8 [[GEPLOAD1304]] to i32
; CHECK-NEXT:    [[TMP71:%.*]] = zext <2 x i8> [[TMP48]] to <2 x i32>
; CHECK-NEXT:    [[TMP72:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP73:%.*]] = insertelement <4 x i8> [[TMP72]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <4 x i8> [[TMP73]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP75:%.*]] = insertelement <4 x i8> [[TMP74]], i8 [[GEPLOAD1308]], i32 3
; CHECK-NEXT:    [[TMP76:%.*]] = zext <4 x i8> [[TMP75]] to <4 x i32>
; CHECK-NEXT:    [[I125:%.*]] = zext i8 [[GEPLOAD1300]] to i32
; CHECK-NEXT:    [[I126:%.*]] = shl nsw i32 [[I117]], 16
; CHECK-NEXT:    [[I127:%.*]] = shl nsw i32 [[I121]], 16
; CHECK-NEXT:    [[TMP77:%.*]] = shl nsw <4 x i32> [[TMP64]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP78:%.*]] = shl nsw <4 x i32> [[TMP70]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP79:%.*]] = sub <4 x i32> [[TMP77]], [[TMP78]]
; CHECK-NEXT:    [[TMP80:%.*]] = sub <4 x i32> [[TMP79]], [[TMP76]]
; CHECK-NEXT:    [[TMP81:%.*]] = add <4 x i32> [[TMP80]], [[TMP58]]
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP81]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
...
; CHECK-NEXT:    [[TMP82:%.*]] = shl nsw <2 x i32> [[TMP59]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP83:%.*]] = shl nsw <2 x i32> [[TMP65]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP84:%.*]] = sub <2 x i32> [[TMP82]], [[TMP71]]
; CHECK-NEXT:    [[TMP85:%.*]] = sub <2 x i32> [[TMP84]], [[TMP83]]
; CHECK-NEXT:    [[TMP86:%.*]] = add <2 x i32> [[TMP85]], [[TMP53]]
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <2 x i32> [[TMP86]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
...
; CHECK-NEXT:    [[TMP87:%.*]] = extractelement <4 x i32> [[SHUFFLE2]], i32 1
; CHECK-NEXT:    [[TMP88:%.*]] = insertelement <4 x i32> poison, i32 [[TMP87]], i32 0
; CHECK-NEXT:    [[TMP89:%.*]] = extractelement <4 x i32> [[SHUFFLE2]], i32 0
; CHECK-NEXT:    [[TMP90:%.*]] = insertelement <4 x i32> [[TMP88]], i32 [[TMP89]], i32 1
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <4 x i32> [[TMP90]], i32 [[CHAIN_T775_2764]], i32 2
; CHECK-NEXT:    [[TMP92:%.*]] = insertelement <4 x i32> [[TMP91]], i32 [[TMP87]], i32 3
; CHECK-NEXT:    [[TMP93:%.*]] = add <4 x i32> [[TMP92]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP94:%.*]] = sub <4 x i32> [[TMP92]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP95:%.*]] = shufflevector <4 x i32> [[TMP93]], <4 x i32> [[TMP94]], <4 x i32> <i32 0, i32 5, i32 6, i32 7>
...
; CHECK-NEXT:    [[TMP102:%.*]] = shufflevector <4 x i32> [[TMP95]], <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
...
; CHECK-NEXT:    [[TMP110:%.*]] = insertelement <16 x i32> [[TMP109]], i32 [[TMP87]], i32 6

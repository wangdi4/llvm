...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE5:%.*]] = shufflevector <4 x i8> [[TMP1]], <4 x i8> [[TMP3]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE4:%.*]] = shufflevector <4 x i8> [[TMP5]], <4 x i8> [[TMP7]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE:%.*]] = shufflevector <4 x i8> [[TMP9]], <4 x i8> [[TMP11]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE3:%.*]] = shufflevector <4 x i8> [[TMP13]], <4 x i8> [[TMP15]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP16:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE5]] to <8 x i32>
; CHECK-NEXT:    [[TMP17:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE]] to <8 x i32>
; CHECK-NEXT:    [[TMP18:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE3]] to <8 x i32>
; CHECK-NEXT:    [[TMP19:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE4]] to <8 x i32>
...
; CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 1, i32 0, i32 3, i32 undef, i32 5, i32 4, i32 7, i32 undef>
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i32> [[TMP25]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 4, i32 5, i32 6, i32 4>
; CHECK-NEXT:    [[TMP26:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 3, i32 0, i32 7, i32 4, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <8 x i32> [[TMP26]], <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
; CHECK-NEXT:    [[TMP27:%.*]] = add <8 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP28:%.*]] = sub <8 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP29:%.*]] = shufflevector <8 x i32> [[TMP27]], <8 x i32> [[TMP28]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP30:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 2, i32 1, i32 6, i32 5, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <8 x i32> [[TMP30]], <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2>
; CHECK-NEXT:    [[TMP31:%.*]] = add <8 x i32> [[TMP29]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP32:%.*]] = sub <8 x i32> [[TMP29]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP33:%.*]] = shufflevector <8 x i32> [[TMP31]], <8 x i32> [[TMP32]], <8 x i32> <i32 0, i32 1, i32 10, i32 3, i32 4, i32 5, i32 14, i32 7>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE13:%.*]] = shufflevector <2 x i8> [[TMP39]], <2 x i8> [[TMP41]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE12:%.*]] = shufflevector <2 x i8> [[TMP43]], <2 x i8> [[TMP45]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE10:%.*]] = shufflevector <2 x i8> [[TMP47]], <2 x i8> [[TMP49]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE11:%.*]] = shufflevector <2 x i8> [[TMP51]], <2 x i8> [[TMP53]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE9:%.*]] = shufflevector <2 x i8> [[TMP55]], <2 x i8> [[TMP57]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE8:%.*]] = shufflevector <2 x i8> [[TMP59]], <2 x i8> [[TMP61]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE6:%.*]] = shufflevector <2 x i8> [[TMP63]], <2 x i8> [[TMP65]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE7:%.*]] = shufflevector <2 x i8> [[TMP67]], <2 x i8> [[TMP69]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP70:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE9]] to <4 x i32>
; CHECK-NEXT:    [[TMP71:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE13]] to <4 x i32>
; CHECK-NEXT:    [[TMP72:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE6]] to <4 x i32>
; CHECK-NEXT:    [[TMP73:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE10]] to <4 x i32>
; CHECK-NEXT:    [[TMP74:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE7]] to <4 x i32>
; CHECK-NEXT:    [[TMP75:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE11]] to <4 x i32>
; CHECK-NEXT:    [[TMP76:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE8]] to <4 x i32>
; CHECK-NEXT:    [[TMP77:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE12]] to <4 x i32>

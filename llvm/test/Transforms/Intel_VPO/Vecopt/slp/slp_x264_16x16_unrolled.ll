...
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -slp-multinode=false -slp-multinode-legacy -mtriple=x86_64 -mcpu=skylake-avx512 -mattr=-prefer-256-bit -S -slp-min-gather-load-size=128 | FileCheck %s
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -slp-multinode -mtriple=x86_64 -mcpu=skylake-avx512 -mattr=-prefer-256-bit -S -slp-min-gather-load-size=128 | FileCheck %s -check-prefix=CHECKNEW

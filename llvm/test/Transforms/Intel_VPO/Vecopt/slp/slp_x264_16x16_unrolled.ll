...
; CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <4 x i8> [[TMP1]], <4 x i8> [[TMP3]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast i8* [[ARRAYIDX1020]] to <4 x i8>*
; CHECK-NEXT:    [[TMP6:%.*]] = load <4 x i8>, <4 x i8>* [[TMP5]], align 1
; CHECK-NEXT:    [[TMP7:%.*]] = bitcast i8* [[ARRAYIDX1107]] to <4 x i8>*
; CHECK-NEXT:    [[TMP8:%.*]] = load <4 x i8>, <4 x i8>* [[TMP7]], align 1
; CHECK-NEXT:    [[TMP9:%.*]] = shufflevector <4 x i8> [[TMP6]], <4 x i8> [[TMP8]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i8* [[ARRAYIDX1022]] to <4 x i8>*
; CHECK-NEXT:    [[TMP11:%.*]] = load <4 x i8>, <4 x i8>* [[TMP10]], align 1
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i8* [[ARRAYIDX1109]] to <4 x i8>*
; CHECK-NEXT:    [[TMP13:%.*]] = load <4 x i8>, <4 x i8>* [[TMP12]], align 1
; CHECK-NEXT:    [[TMP14:%.*]] = shufflevector <4 x i8> [[TMP11]], <4 x i8> [[TMP13]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i8* [[ARRAYIDX1024]] to <4 x i8>*
; CHECK-NEXT:    [[TMP16:%.*]] = load <4 x i8>, <4 x i8>* [[TMP15]], align 1
; CHECK-NEXT:    [[TMP17:%.*]] = bitcast i8* [[ARRAYIDX1111]] to <4 x i8>*
; CHECK-NEXT:    [[TMP18:%.*]] = load <4 x i8>, <4 x i8>* [[TMP17]], align 1
; CHECK-NEXT:    [[TMP19:%.*]] = shufflevector <4 x i8> [[TMP16]], <4 x i8> [[TMP18]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP20:%.*]] = zext <8 x i8> [[TMP4]] to <8 x i32>
; CHECK-NEXT:    [[TMP21:%.*]] = zext <8 x i8> [[TMP14]] to <8 x i32>
; CHECK-NEXT:    [[TMP22:%.*]] = zext <8 x i8> [[TMP19]] to <8 x i32>
; CHECK-NEXT:    [[TMP23:%.*]] = zext <8 x i8> [[TMP9]] to <8 x i32>
; CHECK-NEXT:    [[TMP24:%.*]] = shl nsw <8 x i32> [[TMP21]], <i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP25:%.*]] = shl nsw <8 x i32> [[TMP22]], <i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP26:%.*]] = sub nsw <8 x i32> [[TMP24]], [[TMP25]]
; CHECK-NEXT:    [[TMP27:%.*]] = sub nsw <8 x i32> [[TMP26]], [[TMP23]]
; CHECK-NEXT:    [[TMP28:%.*]] = add nsw <8 x i32> [[TMP27]], [[TMP20]]
; CHECK-NEXT:    [[TMP29:%.*]] = shufflevector <8 x i32> [[TMP28]], <8 x i32> poison, <8 x i32> <i32 1, i32 0, i32 3, i32 undef, i32 5, i32 4, i32 7, i32 undef>
; CHECK-NEXT:    [[TMP30:%.*]] = shufflevector <8 x i32> [[TMP29]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 4, i32 5, i32 6, i32 4>
; CHECK-NEXT:    [[TMP31:%.*]] = shufflevector <8 x i32> [[TMP28]], <8 x i32> poison, <8 x i32> <i32 3, i32 0, i32 7, i32 4, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP32:%.*]] = shufflevector <8 x i32> [[TMP31]], <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
; CHECK-NEXT:    [[TMP33:%.*]] = add <8 x i32> [[TMP30]], [[TMP32]]
; CHECK-NEXT:    [[TMP34:%.*]] = sub <8 x i32> [[TMP30]], [[TMP32]]
; CHECK-NEXT:    [[TMP35:%.*]] = shufflevector <8 x i32> [[TMP33]], <8 x i32> [[TMP34]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP36:%.*]] = shufflevector <8 x i32> [[TMP28]], <8 x i32> poison, <8 x i32> <i32 2, i32 1, i32 6, i32 5, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP37:%.*]] = shufflevector <8 x i32> [[TMP36]], <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2>
; CHECK-NEXT:    [[TMP38:%.*]] = add <8 x i32> [[TMP35]], [[TMP37]]
; CHECK-NEXT:    [[TMP39:%.*]] = sub <8 x i32> [[TMP35]], [[TMP37]]
; CHECK-NEXT:    [[TMP40:%.*]] = shufflevector <8 x i32> [[TMP38]], <8 x i32> [[TMP39]], <8 x i32> <i32 0, i32 1, i32 10, i32 3, i32 4, i32 5, i32 14, i32 7>
; CHECK-NEXT:    [[TMP41:%.*]] = add <8 x i32> [[TMP40]], [[TMP28]]
; CHECK-NEXT:    [[TMP42:%.*]] = sub <8 x i32> [[TMP40]], [[TMP28]]
; CHECK-NEXT:    [[TMP43:%.*]] = shufflevector <8 x i32> [[TMP41]], <8 x i32> [[TMP42]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 13, i32 6, i32 15>
; CHECK-NEXT:    [[TMP44:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <8 x i32>*
; CHECK-NEXT:    store <8 x i32> [[TMP43]], <8 x i32>* [[TMP44]], align 4
=======
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE5:%.*]] = shufflevector <4 x i8> [[TMP0]], <4 x i8> [[TMP1]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i8>, ptr [[ARRAYIDX1020]], align 1
; CHECK-NEXT:    [[TMP3:%.*]] = load <4 x i8>, ptr [[ARRAYIDX1107]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE4:%.*]] = shufflevector <4 x i8> [[TMP2]], <4 x i8> [[TMP3]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP4:%.*]] = load <4 x i8>, ptr [[ARRAYIDX1022]], align 1
; CHECK-NEXT:    [[TMP5:%.*]] = load <4 x i8>, ptr [[ARRAYIDX1109]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE:%.*]] = shufflevector <4 x i8> [[TMP4]], <4 x i8> [[TMP5]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP6:%.*]] = load <4 x i8>, ptr [[ARRAYIDX1024]], align 1
; CHECK-NEXT:    [[TMP7:%.*]] = load <4 x i8>, ptr [[ARRAYIDX1111]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE3:%.*]] = shufflevector <4 x i8> [[TMP6]], <4 x i8> [[TMP7]], <8 x i32> <i32 2, i32 3, i32 0, i32 1, i32 6, i32 7, i32 4, i32 5>
; CHECK-NEXT:    [[TMP8:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE5]] to <8 x i32>
; CHECK-NEXT:    [[TMP9:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE]] to <8 x i32>
; CHECK-NEXT:    [[TMP10:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE3]] to <8 x i32>
; CHECK-NEXT:    [[TMP11:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE4]] to <8 x i32>
; CHECK-NEXT:    [[TMP12:%.*]] = shl nsw <8 x i32> [[TMP9]], <i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP13:%.*]] = shl nsw <8 x i32> [[TMP10]], <i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP14:%.*]] = sub nsw <8 x i32> [[TMP12]], [[TMP13]]
; CHECK-NEXT:    [[TMP15:%.*]] = sub nsw <8 x i32> [[TMP14]], [[TMP11]]
; CHECK-NEXT:    [[TMP16:%.*]] = add nsw <8 x i32> [[TMP15]], [[TMP8]]
; CHECK-NEXT:    [[TMP17:%.*]] = shufflevector <8 x i32> [[TMP16]], <8 x i32> poison, <8 x i32> <i32 1, i32 0, i32 3, i32 undef, i32 5, i32 4, i32 7, i32 undef>
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i32> [[TMP17]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 4, i32 5, i32 6, i32 4>
; CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <8 x i32> [[TMP16]], <8 x i32> poison, <8 x i32> <i32 3, i32 0, i32 7, i32 4, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <8 x i32> [[TMP18]], <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
; CHECK-NEXT:    [[TMP19:%.*]] = add <8 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP20:%.*]] = sub <8 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP21:%.*]] = shufflevector <8 x i32> [[TMP19]], <8 x i32> [[TMP20]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP22:%.*]] = shufflevector <8 x i32> [[TMP16]], <8 x i32> poison, <8 x i32> <i32 2, i32 1, i32 6, i32 5, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <8 x i32> [[TMP22]], <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2>
; CHECK-NEXT:    [[TMP23:%.*]] = add <8 x i32> [[TMP21]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP24:%.*]] = sub <8 x i32> [[TMP21]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i32> [[TMP23]], <8 x i32> [[TMP24]], <8 x i32> <i32 0, i32 1, i32 10, i32 3, i32 4, i32 5, i32 14, i32 7>
; CHECK-NEXT:    [[TMP26:%.*]] = add <8 x i32> [[TMP25]], [[TMP16]]
; CHECK-NEXT:    [[TMP27:%.*]] = sub <8 x i32> [[TMP25]], [[TMP16]]
; CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <8 x i32> [[TMP26]], <8 x i32> [[TMP27]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 13, i32 6, i32 15>
; CHECK-NEXT:    store <8 x i32> [[TMP28]], ptr [[ARRAYIDX1050]], align 4
>>>>>>> eaf1520a99ed91fdf533610eb74f7812151d4a9c
...
; CHECK-NEXT:    [[TMP45:%.*]] = bitcast i8* [[ARRAYIDX1195]] to <2 x i8>*
; CHECK-NEXT:    [[TMP46:%.*]] = load <2 x i8>, <2 x i8>* [[TMP45]], align 1
; CHECK-NEXT:    [[TMP47:%.*]] = zext <2 x i8> [[TMP46]] to <2 x i32>
; CHECK-NEXT:    [[TMP48:%.*]] = bitcast i8* [[ARRAYIDX1193]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP52:%.*]] = bitcast i8* [[ARRAYIDX1199]] to <2 x i8>*
; CHECK-NEXT:    [[TMP53:%.*]] = load <2 x i8>, <2 x i8>* [[TMP52]], align 1
; CHECK-NEXT:    [[TMP54:%.*]] = zext <2 x i8> [[TMP49]] to <2 x i32>
; CHECK-NEXT:    [[TMP55:%.*]] = zext <2 x i8> [[TMP51]] to <2 x i32>
; CHECK-NEXT:    [[TMP56:%.*]] = zext <2 x i8> [[TMP53]] to <2 x i32>
; CHECK-NEXT:    [[TMP57:%.*]] = shl nsw <2 x i32> [[TMP55]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP58:%.*]] = shl nsw <2 x i32> [[TMP56]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP59:%.*]] = sub <2 x i32> [[TMP58]], [[TMP54]]
; CHECK-NEXT:    [[TMP60:%.*]] = sub <2 x i32> [[TMP59]], [[TMP57]]
...
; CHECK-NEXT:    [[ARRAYIDX1244:%.*]] = getelementptr inbounds [16 x [8 x i32]], ptr [[ALLOCA]], i64 0, i64 [[I85]], i64 2
; CHECK-NEXT:    [[BRIDGE_T795_:%.*]] = add nsw i64 8, [[I83]]
...
; CHECK-NEXT:    [[TMP61:%.*]] = bitcast i8* [[ARRAYIDX1211]] to <2 x i8>*
; CHECK-NEXT:    [[TMP62:%.*]] = load <2 x i8>, <2 x i8>* [[TMP61]], align 1
; CHECK-NEXT:    [[TMP63:%.*]] = bitcast i8* [[ARRAYIDX1313]] to <2 x i8>*
; CHECK-NEXT:    [[TMP64:%.*]] = load <2 x i8>, <2 x i8>* [[TMP63]], align 1
; CHECK-NEXT:    [[TMP65:%.*]] = shufflevector <2 x i8> [[TMP62]], <2 x i8> [[TMP64]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP66:%.*]] = bitcast i8* [[ARRAYIDX1209]] to <2 x i8>*
; CHECK-NEXT:    [[TMP67:%.*]] = load <2 x i8>, <2 x i8>* [[TMP66]], align 1
; CHECK-NEXT:    [[TMP68:%.*]] = bitcast i8* [[ARRAYIDX1315]] to <2 x i8>*
; CHECK-NEXT:    [[TMP69:%.*]] = load <2 x i8>, <2 x i8>* [[TMP68]], align 1
; CHECK-NEXT:    [[TMP70:%.*]] = shufflevector <2 x i8> [[TMP67]], <2 x i8> [[TMP69]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP71:%.*]] = bitcast i8* [[ARRAYIDX1215]] to <2 x i8>*
; CHECK-NEXT:    [[TMP72:%.*]] = load <2 x i8>, <2 x i8>* [[TMP71]], align 1
; CHECK-NEXT:    [[TMP73:%.*]] = bitcast i8* [[ARRAYIDX1317]] to <2 x i8>*
; CHECK-NEXT:    [[TMP74:%.*]] = load <2 x i8>, <2 x i8>* [[TMP73]], align 1
; CHECK-NEXT:    [[TMP75:%.*]] = shufflevector <2 x i8> [[TMP72]], <2 x i8> [[TMP74]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP76:%.*]] = bitcast i8* [[ARRAYIDX1213]] to <2 x i8>*
; CHECK-NEXT:    [[TMP77:%.*]] = load <2 x i8>, <2 x i8>* [[TMP76]], align 1
; CHECK-NEXT:    [[TMP78:%.*]] = bitcast i8* [[ARRAYIDX1319]] to <2 x i8>*
; CHECK-NEXT:    [[TMP79:%.*]] = load <2 x i8>, <2 x i8>* [[TMP78]], align 1
; CHECK-NEXT:    [[TMP80:%.*]] = shufflevector <2 x i8> [[TMP77]], <2 x i8> [[TMP79]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP81:%.*]] = zext <4 x i8> [[TMP65]] to <4 x i32>
; CHECK-NEXT:    [[TMP82:%.*]] = zext <4 x i8> [[TMP75]] to <4 x i32>
; CHECK-NEXT:    [[TMP83:%.*]] = zext <4 x i8> [[TMP80]] to <4 x i32>
; CHECK-NEXT:    [[TMP84:%.*]] = zext <4 x i8> [[TMP70]] to <4 x i32>
; CHECK-NEXT:    [[TMP85:%.*]] = shl nsw <4 x i32> [[TMP82]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP86:%.*]] = shl nsw <4 x i32> [[TMP83]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP87:%.*]] = sub nsw <4 x i32> [[TMP85]], [[TMP86]]
; CHECK-NEXT:    [[TMP88:%.*]] = sub nsw <4 x i32> [[TMP87]], [[TMP84]]
; CHECK-NEXT:    [[TMP89:%.*]] = add nsw <4 x i32> [[TMP88]], [[TMP81]]
; CHECK-NEXT:    [[TMP90:%.*]] = extractelement <4 x i32> [[TMP89]], i32 0
; CHECK-NEXT:    [[TMP91:%.*]] = extractelement <4 x i32> [[TMP89]], i32 1
; CHECK-NEXT:    [[BRIDGE_T797_2968:%.*]] = sub nsw i32 [[TMP91]], [[TMP90]]
; CHECK-NEXT:    [[TMP92:%.*]] = shufflevector <2 x i32> [[TMP60]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP93:%.*]] = shufflevector <4 x i32> [[TMP89]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP94:%.*]] = shufflevector <8 x i32> [[TMP92]], <8 x i32> [[TMP93]], <8 x i32> <i32 0, i32 1, i32 9, i32 8, i32 11, i32 10, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <8 x i32> [[TMP94]], i32 [[CHAIN_T775_2764]], i32 6
; CHECK-NEXT:    [[TMP96:%.*]] = shufflevector <8 x i32> [[TMP95]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 4>
; CHECK-NEXT:    [[TMP97:%.*]] = shufflevector <2 x i32> [[TMP47]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP98:%.*]] = shufflevector <8 x i32> [[TMP97]], <8 x i32> [[TMP93]], <8 x i32> <i32 0, i32 1, i32 8, i32 9, i32 10, i32 11, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <8 x i32> [[TMP98]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 4, i32 4>
; CHECK-NEXT:    [[TMP100:%.*]] = add nsw <8 x i32> [[TMP96]], [[TMP99]]
; CHECK-NEXT:    [[TMP101:%.*]] = sub nsw <8 x i32> [[TMP96]], [[TMP99]]
; CHECK-NEXT:    [[TMP102:%.*]] = shufflevector <8 x i32> [[TMP100]], <8 x i32> [[TMP101]], <8 x i32> <i32 0, i32 1, i32 2, i32 11, i32 4, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP103:%.*]] = shufflevector <8 x i32> [[TMP102]], <8 x i32> poison, <8 x i32> <i32 2, i32 0, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP104:%.*]] = insertelement <8 x i32> [[TMP103]], i32 [[CHAIN_T775_2764]], i32 2
; CHECK-NEXT:    [[TMP105:%.*]] = shufflevector <8 x i32> [[TMP104]], <8 x i32> [[TMP93]], <8 x i32> <i32 0, i32 1, i32 2, i32 11, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP106:%.*]] = shufflevector <8 x i32> [[TMP105]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 2, i32 2, i32 3, i32 2>
; CHECK-NEXT:    [[TMP107:%.*]] = add <8 x i32> [[TMP102]], [[TMP106]]
; CHECK-NEXT:    [[TMP108:%.*]] = sub <8 x i32> [[TMP102]], [[TMP106]]
; CHECK-NEXT:    [[TMP109:%.*]] = shufflevector <8 x i32> [[TMP107]], <8 x i32> [[TMP108]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 5, i32 14, i32 7>
; CHECK-NEXT:    [[TMP110:%.*]] = shufflevector <8 x i32> [[TMP102]], <8 x i32> poison, <8 x i32> <i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP111:%.*]] = insertelement <8 x i32> [[TMP110]], i32 [[BRIDGE_T797_2968]], i32 1
; CHECK-NEXT:    [[TMP112:%.*]] = insertelement <8 x i32> [[TMP111]], i32 [[CHAIN_T775_2771]], i32 4
; CHECK-NEXT:    [[TMP113:%.*]] = shufflevector <8 x i32> [[TMP112]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
; CHECK-NEXT:    [[TMP114:%.*]] = sub <8 x i32> [[TMP109]], [[TMP113]]
; CHECK-NEXT:    [[TMP115:%.*]] = add <8 x i32> [[TMP109]], [[TMP113]]
; CHECK-NEXT:    [[TMP116:%.*]] = shufflevector <8 x i32> [[TMP114]], <8 x i32> [[TMP115]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 12, i32 5, i32 14, i32 7>
; CHECK-NEXT:    [[TMP117:%.*]] = bitcast i32* [[ARRAYIDX1226]] to <8 x i32>*
; CHECK-NEXT:    store <8 x i32> [[TMP116]], <8 x i32>* [[TMP117]], align 4
=======
; CHECK-NEXT:    [[ARRAYIDX1319:%.*]] = getelementptr inbounds i8, ptr [[PIX2]], i64 [[BRIDGE_T784_]]
; CHECK-NEXT:    [[ARRAYIDX1348:%.*]] = getelementptr inbounds [16 x [8 x i32]], ptr [[ALLOCA]], i64 0, i64 [[I85]], i64 6
; CHECK-NEXT:    [[TMP29:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1195]], align 1
; CHECK-NEXT:    [[TMP30:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1297]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE13:%.*]] = shufflevector <2 x i8> [[TMP29]], <2 x i8> [[TMP30]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP31:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1193]], align 1
; CHECK-NEXT:    [[TMP32:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1299]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE12:%.*]] = shufflevector <2 x i8> [[TMP31]], <2 x i8> [[TMP32]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP33:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1199]], align 1
; CHECK-NEXT:    [[TMP34:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1301]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE10:%.*]] = shufflevector <2 x i8> [[TMP33]], <2 x i8> [[TMP34]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP35:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1197]], align 1
; CHECK-NEXT:    [[TMP36:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1303]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE11:%.*]] = shufflevector <2 x i8> [[TMP35]], <2 x i8> [[TMP36]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP37:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1211]], align 1
; CHECK-NEXT:    [[TMP38:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1313]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE9:%.*]] = shufflevector <2 x i8> [[TMP37]], <2 x i8> [[TMP38]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP39:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1209]], align 1
; CHECK-NEXT:    [[TMP40:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1315]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE8:%.*]] = shufflevector <2 x i8> [[TMP39]], <2 x i8> [[TMP40]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP41:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1215]], align 1
; CHECK-NEXT:    [[TMP42:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1317]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE6:%.*]] = shufflevector <2 x i8> [[TMP41]], <2 x i8> [[TMP42]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP43:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1213]], align 1
; CHECK-NEXT:    [[TMP44:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1319]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE7:%.*]] = shufflevector <2 x i8> [[TMP43]], <2 x i8> [[TMP44]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP45:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE9]] to <4 x i32>
; CHECK-NEXT:    [[TMP46:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE13]] to <4 x i32>
; CHECK-NEXT:    [[TMP47:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE6]] to <4 x i32>
; CHECK-NEXT:    [[TMP48:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE10]] to <4 x i32>
; CHECK-NEXT:    [[TMP49:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE7]] to <4 x i32>
; CHECK-NEXT:    [[TMP50:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE11]] to <4 x i32>
; CHECK-NEXT:    [[TMP51:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE8]] to <4 x i32>
; CHECK-NEXT:    [[TMP52:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE12]] to <4 x i32>
; CHECK-NEXT:    [[TMP53:%.*]] = shl nsw <4 x i32> [[TMP48]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP54:%.*]] = shl nsw <4 x i32> [[TMP50]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP55:%.*]] = sub nsw <4 x i32> [[TMP53]], [[TMP54]]
; CHECK-NEXT:    [[TMP56:%.*]] = sub nsw <4 x i32> [[TMP55]], [[TMP52]]
; CHECK-NEXT:    [[TMP57:%.*]] = add nsw <4 x i32> [[TMP56]], [[TMP46]]
; CHECK-NEXT:    [[TMP58:%.*]] = shl nsw <4 x i32> [[TMP47]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP59:%.*]] = shl nsw <4 x i32> [[TMP49]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP60:%.*]] = sub nsw <4 x i32> [[TMP58]], [[TMP59]]
; CHECK-NEXT:    [[TMP61:%.*]] = sub nsw <4 x i32> [[TMP60]], [[TMP51]]
; CHECK-NEXT:    [[TMP62:%.*]] = add nsw <4 x i32> [[TMP61]], [[TMP45]]
; CHECK-NEXT:    [[TMP63:%.*]] = shufflevector <4 x i32> [[TMP62]], <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP64:%.*]] = add nsw <4 x i32> [[TMP62]], [[TMP63]]
; CHECK-NEXT:    [[TMP65:%.*]] = sub nsw <4 x i32> [[TMP62]], [[TMP63]]
; CHECK-NEXT:    [[TMP66:%.*]] = shufflevector <4 x i32> [[TMP64]], <4 x i32> [[TMP65]], <4 x i32> <i32 0, i32 5, i32 2, i32 7>
; CHECK-NEXT:    [[TMP67:%.*]] = extractelement <4 x i32> [[TMP66]], i32 0
; CHECK-NEXT:    [[TMP68:%.*]] = extractelement <4 x i32> [[TMP57]], i32 1
; CHECK-NEXT:    [[TMP69:%.*]] = extractelement <4 x i32> [[TMP57]], i32 0
; CHECK-NEXT:    [[TMP70:%.*]] = extractelement <4 x i32> [[TMP62]], i32 0
; CHECK-NEXT:    [[TMP71:%.*]] = extractelement <4 x i32> [[TMP62]], i32 1
; CHECK-NEXT:    [[BRIDGE_T797_2968:%.*]] = sub nsw i32 [[TMP70]], [[TMP71]]
; CHECK-NEXT:    [[TMP72:%.*]] = insertelement <2 x i32> poison, i32 [[TMP67]], i32 0
; CHECK-NEXT:    [[TMP73:%.*]] = insertelement <2 x i32> [[TMP72]], i32 [[BRIDGE_T797_2968]], i32 1
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <2 x i32> poison, i32 [[TMP68]], i32 0
; CHECK-NEXT:    [[TMP75:%.*]] = insertelement <2 x i32> [[TMP74]], i32 [[TMP69]], i32 1
; CHECK-NEXT:    [[TMP76:%.*]] = add <2 x i32> [[TMP73]], [[TMP75]]
; CHECK-NEXT:    [[TMP77:%.*]] = insertelement <2 x i32> poison, i32 [[TMP69]], i32 0
; CHECK-NEXT:    [[TMP78:%.*]] = insertelement <2 x i32> [[TMP77]], i32 [[TMP68]], i32 1
; CHECK-NEXT:    [[TMP79:%.*]] = sub <2 x i32> [[TMP76]], [[TMP78]]
; CHECK-NEXT:    store <2 x i32> [[TMP79]], ptr [[ARRAYIDX1226]], align 4
; CHECK-NEXT:    [[TMP80:%.*]] = extractelement <4 x i32> [[TMP62]], i32 3
; CHECK-NEXT:    [[TMP81:%.*]] = extractelement <4 x i32> [[TMP57]], i32 3
; CHECK-NEXT:    [[TMP82:%.*]] = extractelement <4 x i32> [[TMP62]], i32 2
; CHECK-NEXT:    [[TMP83:%.*]] = extractelement <4 x i32> [[TMP57]], i32 2
; CHECK-NEXT:    [[TMP84:%.*]] = sub <4 x i32> [[TMP66]], [[TMP57]]
; CHECK-NEXT:    [[TMP85:%.*]] = add <4 x i32> [[TMP66]], [[TMP57]]
; CHECK-NEXT:    [[TMP86:%.*]] = shufflevector <4 x i32> [[TMP84]], <4 x i32> [[TMP85]], <4 x i32> <i32 0, i32 1, i32 6, i32 7>
; CHECK-NEXT:    [[TMP87:%.*]] = shufflevector <4 x i32> [[TMP57]], <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP88:%.*]] = sub <4 x i32> [[TMP86]], [[TMP87]]
; CHECK-NEXT:    [[TMP89:%.*]] = add <4 x i32> [[TMP86]], [[TMP87]]
; CHECK-NEXT:    [[TMP90:%.*]] = shufflevector <4 x i32> [[TMP88]], <4 x i32> [[TMP89]], <4 x i32> <i32 0, i32 5, i32 6, i32 3>
; CHECK-NEXT:    store <4 x i32> [[TMP90]], ptr [[ARRAYIDX1244]], align 4
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <2 x i32> poison, i32 [[TMP81]], i32 0
; CHECK-NEXT:    [[TMP92:%.*]] = insertelement <2 x i32> [[TMP91]], i32 [[TMP82]], i32 1
; CHECK-NEXT:    [[TMP93:%.*]] = insertelement <2 x i32> poison, i32 [[TMP80]], i32 0
; CHECK-NEXT:    [[TMP94:%.*]] = insertelement <2 x i32> [[TMP93]], i32 [[TMP80]], i32 1
; CHECK-NEXT:    [[TMP95:%.*]] = sub <2 x i32> [[TMP92]], [[TMP94]]
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <2 x i32> poison, i32 [[TMP82]], i32 0
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <2 x i32> [[TMP96]], i32 [[TMP83]], i32 1
; CHECK-NEXT:    [[TMP98:%.*]] = sub <2 x i32> [[TMP95]], [[TMP97]]
; CHECK-NEXT:    [[TMP99:%.*]] = insertelement <2 x i32> poison, i32 [[TMP83]], i32 0
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <2 x i32> [[TMP99]], i32 [[TMP81]], i32 1
; CHECK-NEXT:    [[TMP101:%.*]] = add <2 x i32> [[TMP98]], [[TMP100]]
; CHECK-NEXT:    store <2 x i32> [[TMP101]], ptr [[ARRAYIDX1348]], align 4
>>>>>>> eaf1520a99ed91fdf533610eb74f7812151d4a9c

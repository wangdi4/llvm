...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE7:%.*]] = shufflevector <2 x i8> [[TMP1]], <2 x i8> [[TMP3]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CHECK-NEXT:    [[TMP16:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE7]] to <4 x i32>
...
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <4 x i32> [[TMP24]], i32 1
; CHECK-NEXT:    [[TMP26:%.*]] = insertelement <8 x i32> poison, i32 [[TMP25]], i32 0
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <4 x i32> [[TMP24]], i32 0
...
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <4 x i32> [[TMP24]], i32 3
; CHECK-NEXT:    [[TMP31:%.*]] = insertelement <8 x i32> [[TMP29]], i32 [[TMP30]], i32 3
; CHECK-NEXT:    [[TMP32:%.*]] = extractelement <4 x i32> [[TMP24]], i32 2
...
; CHECK-NEXT:    [[TMP35:%.*]] = shufflevector <4 x i32> [[TMP24]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[SHUFFLE4:%.*]] = shufflevector <8 x i32> [[TMP35]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 2, i32 3, i32 2, i32 2>
; CHECK-NEXT:    [[TMP36:%.*]] = add <8 x i32> [[SHUFFLE3]], [[SHUFFLE4]]
; CHECK-NEXT:    [[TMP37:%.*]] = sub <8 x i32> [[SHUFFLE3]], [[SHUFFLE4]]
; CHECK-NEXT:    [[TMP38:%.*]] = shufflevector <8 x i32> [[TMP36]], <8 x i32> [[TMP37]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
...
; CHECK-NEXT:    [[BRIDGE_T797_2968:%.*]] = sub nsw i32 [[CHAIN_T802_29102912]], [[CHAIN_T802_29182920]]
; CHECK-NEXT:    [[ARRAYIDX1280:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I85]], i64 3
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T802_29182920]], i32 0
; CHECK-NEXT:    [[TMP40:%.*]] = insertelement <2 x i32> [[TMP39]], i32 [[CHAIN_T802_29182920]], i32 1
; CHECK-NEXT:    [[TMP41:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T802_29102912]], i32 0
; CHECK-NEXT:    [[TMP42:%.*]] = insertelement <2 x i32> [[TMP41]], i32 [[CHAIN_T802_29102912]], i32 1
; CHECK-NEXT:    [[TMP43:%.*]] = add <2 x i32> [[TMP40]], [[TMP42]]
; CHECK-NEXT:    [[TMP44:%.*]] = sub <2 x i32> [[TMP40]], [[TMP42]]
...
; CHECK-NEXT:    [[TMP46:%.*]] = bitcast i8* [[ARRAYIDX1313]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP48:%.*]] = bitcast i8* [[ARRAYIDX1315]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP50:%.*]] = bitcast i8* [[ARRAYIDX1317]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP52:%.*]] = bitcast i8* [[ARRAYIDX1319]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP54:%.*]] = zext <2 x i8> [[TMP47]] to <2 x i32>
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP56:%.*]] = insertelement <4 x i8> [[TMP55]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP57:%.*]] = insertelement <4 x i8> [[TMP56]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP58:%.*]] = insertelement <4 x i8> [[TMP57]], i8 [[GEPLOAD1306]], i32 3
; CHECK-NEXT:    [[TMP59:%.*]] = zext <4 x i8> [[TMP58]] to <4 x i32>
; CHECK-NEXT:    [[I113:%.*]] = zext i8 [[GEPLOAD1298]] to i32
; CHECK-NEXT:    [[TMP60:%.*]] = zext <2 x i8> [[TMP51]] to <2 x i32>
; CHECK-NEXT:    [[TMP61:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP62:%.*]] = insertelement <4 x i8> [[TMP61]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP63:%.*]] = insertelement <4 x i8> [[TMP62]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP64:%.*]] = insertelement <4 x i8> [[TMP63]], i8 [[GEPLOAD1310]], i32 3
; CHECK-NEXT:    [[TMP65:%.*]] = zext <4 x i8> [[TMP64]] to <4 x i32>
; CHECK-NEXT:    [[I117:%.*]] = zext i8 [[GEPLOAD1302]] to i32
; CHECK-NEXT:    [[TMP66:%.*]] = zext <2 x i8> [[TMP53]] to <2 x i32>
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP68:%.*]] = insertelement <4 x i8> [[TMP67]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP69:%.*]] = insertelement <4 x i8> [[TMP68]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP70:%.*]] = insertelement <4 x i8> [[TMP69]], i8 [[GEPLOAD1312]], i32 3
; CHECK-NEXT:    [[TMP71:%.*]] = zext <4 x i8> [[TMP70]] to <4 x i32>
; CHECK-NEXT:    [[I121:%.*]] = zext i8 [[GEPLOAD1304]] to i32
; CHECK-NEXT:    [[TMP72:%.*]] = zext <2 x i8> [[TMP49]] to <2 x i32>
; CHECK-NEXT:    [[TMP73:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <4 x i8> [[TMP73]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP75:%.*]] = insertelement <4 x i8> [[TMP74]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP76:%.*]] = insertelement <4 x i8> [[TMP75]], i8 [[GEPLOAD1308]], i32 3
; CHECK-NEXT:    [[TMP77:%.*]] = zext <4 x i8> [[TMP76]] to <4 x i32>
; CHECK-NEXT:    [[I125:%.*]] = zext i8 [[GEPLOAD1300]] to i32
; CHECK-NEXT:    [[I126:%.*]] = shl nsw i32 [[I117]], 16
; CHECK-NEXT:    [[I127:%.*]] = shl nsw i32 [[I121]], 16
; CHECK-NEXT:    [[TMP78:%.*]] = shl nsw <4 x i32> [[TMP65]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP79:%.*]] = shl nsw <4 x i32> [[TMP71]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP80:%.*]] = sub <4 x i32> [[TMP78]], [[TMP77]]
; CHECK-NEXT:    [[TMP81:%.*]] = sub <4 x i32> [[TMP80]], [[TMP79]]
; CHECK-NEXT:    [[TMP82:%.*]] = add <4 x i32> [[TMP81]], [[TMP59]]
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP82]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
...
; CHECK-NEXT:    [[TMP83:%.*]] = shl nsw <2 x i32> [[TMP60]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP84:%.*]] = shl nsw <2 x i32> [[TMP66]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP85:%.*]] = sub <2 x i32> [[TMP83]], [[TMP72]]
; CHECK-NEXT:    [[TMP86:%.*]] = sub <2 x i32> [[TMP85]], [[TMP84]]
; CHECK-NEXT:    [[TMP87:%.*]] = add <2 x i32> [[TMP86]], [[TMP54]]
...
; CHECK-NEXT:    [[TMP88:%.*]] = extractelement <2 x i32> [[TMP87]], i32 1
; CHECK-NEXT:    [[TMP89:%.*]] = insertelement <4 x i32> poison, i32 [[TMP88]], i32 0
; CHECK-NEXT:    [[TMP90:%.*]] = extractelement <2 x i32> [[TMP87]], i32 0
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <4 x i32> [[TMP89]], i32 [[TMP90]], i32 1
; CHECK-NEXT:    [[TMP92:%.*]] = insertelement <4 x i32> [[TMP91]], i32 [[CHAIN_T775_2764]], i32 2
; CHECK-NEXT:    [[TMP93:%.*]] = insertelement <4 x i32> [[TMP92]], i32 [[TMP88]], i32 3
; CHECK-NEXT:    [[TMP94:%.*]] = shufflevector <2 x i32> [[TMP87]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <4 x i32> [[TMP94]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
; CHECK-NEXT:    [[TMP95:%.*]] = add <4 x i32> [[TMP93]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP96:%.*]] = sub <4 x i32> [[TMP93]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP97:%.*]] = shufflevector <4 x i32> [[TMP95]], <4 x i32> [[TMP96]], <4 x i32> <i32 0, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP98:%.*]] = shufflevector <8 x i32> [[TMP38]], <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP99:%.*]] = extractelement <2 x i32> [[TMP45]], i32 0
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <16 x i32> [[TMP98]], i32 [[TMP99]], i32 8
; CHECK-NEXT:    [[TMP101:%.*]] = insertelement <16 x i32> [[TMP100]], i32 [[BRIDGE_T797_2968]], i32 9
; CHECK-NEXT:    [[TMP102:%.*]] = shufflevector <2 x i32> [[TMP45]], <2 x i32> poison, <16 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP103:%.*]] = shufflevector <16 x i32> [[TMP101]], <16 x i32> [[TMP102]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP104:%.*]] = shufflevector <4 x i32> [[TMP97]], <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP105:%.*]] = shufflevector <16 x i32> [[TMP103]], <16 x i32> [[TMP104]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 18, i32 19>
; CHECK-NEXT:    [[TMP106:%.*]] = insertelement <16 x i32> poison, i32 [[CHAIN_T856_3322]], i32 0
; CHECK-NEXT:    [[TMP107:%.*]] = insertelement <16 x i32> [[TMP106]], i32 [[TMP25]], i32 1
; CHECK-NEXT:    [[TMP108:%.*]] = insertelement <16 x i32> [[TMP107]], i32 [[CHAIN_T829_3169]], i32 2
; CHECK-NEXT:    [[TMP109:%.*]] = insertelement <16 x i32> [[TMP108]], i32 [[TMP30]], i32 3
; CHECK-NEXT:    [[TMP110:%.*]] = insertelement <16 x i32> [[TMP109]], i32 [[CHAIN_T802_2928]], i32 4
; CHECK-NEXT:    [[TMP111:%.*]] = insertelement <16 x i32> [[TMP110]], i32 [[CHAIN_T775_2764]], i32 5
; CHECK-NEXT:    [[TMP112:%.*]] = insertelement <16 x i32> [[TMP111]], i32 [[TMP88]], i32 6
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <16 x i32> [[TMP112]], <16 x i32> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2, i32 4, i32 4, i32 4, i32 4, i32 5, i32 5, i32 6, i32 5>
; CHECK-NEXT:    [[TMP113:%.*]] = add <16 x i32> [[TMP105]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP114:%.*]] = sub <16 x i32> [[TMP105]], [[SHUFFLE]]
...
; CHECK-NEXT:    [[TMP116:%.*]] = add <16 x i32> [[TMP115]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP117:%.*]] = sub <16 x i32> [[TMP115]], [[SHUFFLE1]]

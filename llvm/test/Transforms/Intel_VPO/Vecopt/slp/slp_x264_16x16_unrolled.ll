...
; CHECK-NEXT:    [[TMP22:%.*]] = shufflevector <8 x i32> [[TMP20]], <8 x i32> poison, <4 x i32> <i32 3, i32 0, i32 7, i32 4>
; CHECK-NEXT:    [[TMP23:%.*]] = shufflevector <8 x i32> [[TMP20]], <8 x i32> poison, <8 x i32> <i32 3, i32 3, i32 0, i32 0, i32 7, i32 7, i32 4, i32 4>
; CHECK-NEXT:    [[TMP24:%.*]] = add <8 x i32> [[TMP21]], [[TMP23]]
; CHECK-NEXT:    [[TMP25:%.*]] = sub <8 x i32> [[TMP21]], [[TMP23]]
; CHECK-NEXT:    [[TMP26:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> [[TMP25]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP27:%.*]] = shufflevector <8 x i32> [[TMP20]], <8 x i32> poison, <4 x i32> <i32 2, i32 1, i32 6, i32 5>
; CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <8 x i32> [[TMP20]], <8 x i32> poison, <8 x i32> <i32 2, i32 2, i32 1, i32 2, i32 6, i32 6, i32 5, i32 6>
; CHECK-NEXT:    [[TMP29:%.*]] = add <8 x i32> [[TMP26]], [[TMP28]]
; CHECK-NEXT:    [[TMP30:%.*]] = sub <8 x i32> [[TMP26]], [[TMP28]]
; CHECK-NEXT:    [[TMP31:%.*]] = shufflevector <8 x i32> [[TMP29]], <8 x i32> [[TMP30]], <8 x i32> <i32 0, i32 1, i32 10, i32 3, i32 4, i32 5, i32 14, i32 7>
; CHECK-NEXT:    [[TMP32:%.*]] = add <8 x i32> [[TMP31]], [[TMP20]]
; CHECK-NEXT:    [[TMP33:%.*]] = sub <8 x i32> [[TMP31]], [[TMP20]]
; CHECK-NEXT:    [[TMP34:%.*]] = shufflevector <8 x i32> [[TMP32]], <8 x i32> [[TMP33]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 13, i32 6, i32 15>
; CHECK-NEXT:    store <8 x i32> [[TMP34]], ptr [[ARRAYIDX1050]], align 4
...
; CHECK-NEXT:    [[TMP35:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1195]], align 1
; CHECK-NEXT:    [[TMP36:%.*]] = zext <2 x i8> [[TMP35]] to <2 x i32>
; CHECK-NEXT:    [[TMP37:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1193]], align 1
; CHECK-NEXT:    [[TMP38:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1197]], align 1
; CHECK-NEXT:    [[TMP39:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1199]], align 1
...
; CHECK-NEXT:    [[TMP43:%.*]] = shl nsw <2 x i32> [[TMP41]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP44:%.*]] = shl nsw <2 x i32> [[TMP42]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP45:%.*]] = sub <2 x i32> [[TMP44]], [[TMP40]]
...
; CHECK-NEXT:    [[TMP47:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1211]], align 1
; CHECK-NEXT:    [[TMP48:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1313]], align 1
; CHECK-NEXT:    [[TMP49:%.*]] = shufflevector <2 x i8> [[TMP47]], <2 x i8> [[TMP48]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP50:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1209]], align 1
; CHECK-NEXT:    [[TMP51:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1315]], align 1
; CHECK-NEXT:    [[TMP52:%.*]] = shufflevector <2 x i8> [[TMP50]], <2 x i8> [[TMP51]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP53:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1215]], align 1
; CHECK-NEXT:    [[TMP54:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1317]], align 1
; CHECK-NEXT:    [[TMP55:%.*]] = shufflevector <2 x i8> [[TMP53]], <2 x i8> [[TMP54]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP56:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1213]], align 1
; CHECK-NEXT:    [[TMP57:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1319]], align 1
; CHECK-NEXT:    [[TMP58:%.*]] = shufflevector <2 x i8> [[TMP56]], <2 x i8> [[TMP57]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP59:%.*]] = zext <4 x i8> [[TMP49]] to <4 x i32>
; CHECK-NEXT:    [[TMP60:%.*]] = zext <4 x i8> [[TMP55]] to <4 x i32>
; CHECK-NEXT:    [[TMP61:%.*]] = zext <4 x i8> [[TMP58]] to <4 x i32>
; CHECK-NEXT:    [[TMP62:%.*]] = zext <4 x i8> [[TMP52]] to <4 x i32>
; CHECK-NEXT:    [[TMP63:%.*]] = shl nsw <4 x i32> [[TMP60]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP64:%.*]] = shl nsw <4 x i32> [[TMP61]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP65:%.*]] = sub nsw <4 x i32> [[TMP63]], [[TMP64]]
; CHECK-NEXT:    [[TMP66:%.*]] = sub nsw <4 x i32> [[TMP65]], [[TMP62]]
; CHECK-NEXT:    [[TMP67:%.*]] = add nsw <4 x i32> [[TMP66]], [[TMP59]]
; CHECK-NEXT:    [[TMP68:%.*]] = extractelement <4 x i32> [[TMP67]], i32 0
; CHECK-NEXT:    [[TMP69:%.*]] = extractelement <4 x i32> [[TMP67]], i32 1
; CHECK-NEXT:    [[BRIDGE_T797_2968:%.*]] = sub nsw i32 [[TMP69]], [[TMP68]]
; CHECK-NEXT:    [[TMP70:%.*]] = shufflevector <2 x i32> [[TMP46]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP71:%.*]] = shufflevector <4 x i32> [[TMP67]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP72:%.*]] = shufflevector <8 x i32> [[TMP70]], <8 x i32> [[TMP71]], <8 x i32> <i32 0, i32 1, i32 9, i32 8, i32 11, i32 10, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP73:%.*]] = insertelement <8 x i32> [[TMP72]], i32 [[CHAIN_T775_2764]], i32 6
; CHECK-NEXT:    [[TMP74:%.*]] = shufflevector <8 x i32> [[TMP73]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 4>
; CHECK-NEXT:    [[TMP75:%.*]] = shufflevector <2 x i32> [[TMP36]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP76:%.*]] = shufflevector <8 x i32> [[TMP75]], <8 x i32> [[TMP71]], <8 x i32> <i32 0, i32 1, i32 8, i32 9, i32 10, i32 11, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP77:%.*]] = shufflevector <8 x i32> [[TMP76]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 4, i32 4>
; CHECK-NEXT:    [[TMP78:%.*]] = add nsw <8 x i32> [[TMP74]], [[TMP77]]
; CHECK-NEXT:    [[TMP79:%.*]] = sub nsw <8 x i32> [[TMP74]], [[TMP77]]
; CHECK-NEXT:    [[TMP80:%.*]] = shufflevector <8 x i32> [[TMP78]], <8 x i32> [[TMP79]], <8 x i32> <i32 0, i32 1, i32 2, i32 11, i32 4, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP81:%.*]] = shufflevector <8 x i32> [[TMP80]], <8 x i32> [[TMP74]], <4 x i32> <i32 2, i32 0, i32 14, i32 12>
; CHECK-NEXT:    [[TMP82:%.*]] = shufflevector <4 x i32> [[TMP81]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 2, i32 2, i32 3, i32 2>
; CHECK-NEXT:    [[TMP83:%.*]] = add <8 x i32> [[TMP80]], [[TMP82]]
; CHECK-NEXT:    [[TMP84:%.*]] = sub <8 x i32> [[TMP80]], [[TMP82]]
; CHECK-NEXT:    [[TMP85:%.*]] = shufflevector <8 x i32> [[TMP83]], <8 x i32> [[TMP84]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 5, i32 14, i32 7>
; CHECK-NEXT:    [[TMP86:%.*]] = shufflevector <8 x i32> [[TMP80]], <8 x i32> poison, <8 x i32> <i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP87:%.*]] = insertelement <8 x i32> [[TMP86]], i32 [[BRIDGE_T797_2968]], i32 1
; CHECK-NEXT:    [[TMP88:%.*]] = insertelement <8 x i32> [[TMP87]], i32 [[CHAIN_T775_2771]], i32 4
; CHECK-NEXT:    [[TMP89:%.*]] = shufflevector <8 x i32> [[TMP88]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
; CHECK-NEXT:    [[TMP90:%.*]] = sub <8 x i32> [[TMP85]], [[TMP89]]
; CHECK-NEXT:    [[TMP91:%.*]] = add <8 x i32> [[TMP85]], [[TMP89]]
; CHECK-NEXT:    [[TMP92:%.*]] = shufflevector <8 x i32> [[TMP90]], <8 x i32> [[TMP91]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 12, i32 5, i32 14, i32 7>
; CHECK-NEXT:    store <8 x i32> [[TMP92]], ptr [[ARRAYIDX1226]], align 4

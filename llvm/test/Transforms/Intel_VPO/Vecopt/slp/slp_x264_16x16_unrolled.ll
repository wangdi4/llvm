...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE8:%.*]] = shufflevector <2 x i8> [[TMP1]], <2 x i8> [[TMP3]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE7:%.*]] = shufflevector <2 x i8> [[TMP5]], <2 x i8> [[TMP7]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CHECK-NEXT:    [[SPLITLOADSHUFFLE6:%.*]] = shufflevector <2 x i8> [[TMP13]], <2 x i8> [[TMP15]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP16:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE8]] to <4 x i32>
; CHECK-NEXT:    [[TMP17:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE]] to <4 x i32>
; CHECK-NEXT:    [[TMP18:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE6]] to <4 x i32>
; CHECK-NEXT:    [[TMP19:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE7]] to <4 x i32>
...
; CHECK-NEXT:    [[SHUFFLE9:%.*]] = shufflevector <4 x i32> [[TMP24]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 2, i32 3, i32 2, i32 2>
; CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <4 x i32> [[TMP24]], <4 x i32> poison, <8 x i32> <i32 1, i32 0, i32 undef, i32 undef, i32 3, i32 2, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP26:%.*]] = insertelement <8 x i32> [[TMP25]], i32 [[CHAIN_T856_3322]], i32 2
; CHECK-NEXT:    [[TMP27:%.*]] = insertelement <8 x i32> [[TMP26]], i32 [[CHAIN_T829_3169]], i32 6
; CHECK-NEXT:    [[SHUFFLE5:%.*]] = shufflevector <8 x i32> [[TMP27]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 4, i32 5, i32 6, i32 4>
; CHECK-NEXT:    [[TMP28:%.*]] = add <8 x i32> [[SHUFFLE5]], [[SHUFFLE9]]
; CHECK-NEXT:    [[TMP29:%.*]] = sub <8 x i32> [[SHUFFLE5]], [[SHUFFLE9]]
...
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast i8* [[ARRAYIDX1105]] to <4 x i8>*
; CHECK-NEXT:    [[TMP3:%.*]] = load <4 x i8>, <4 x i8>* [[TMP2]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE3:%.*]] = shufflevector <4 x i8> [[TMP1]], <4 x i8> [[TMP3]], <8 x i32> <i32 2, i32 0, i32 1, i32 3, i32 6, i32 4, i32 5, i32 7>
; CHECK-NEXT:    [[TMP4:%.*]] = bitcast i8* [[ARRAYIDX1020]] to <4 x i8>*
; CHECK-NEXT:    [[TMP5:%.*]] = load <4 x i8>, <4 x i8>* [[TMP4]], align 1
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i8* [[ARRAYIDX1107]] to <4 x i8>*
; CHECK-NEXT:    [[TMP7:%.*]] = load <4 x i8>, <4 x i8>* [[TMP6]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE2:%.*]] = shufflevector <4 x i8> [[TMP5]], <4 x i8> [[TMP7]], <8 x i32> <i32 2, i32 0, i32 1, i32 3, i32 6, i32 4, i32 5, i32 7>
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i8* [[ARRAYIDX1022]] to <4 x i8>*
; CHECK-NEXT:    [[TMP9:%.*]] = load <4 x i8>, <4 x i8>* [[TMP8]], align 1
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i8* [[ARRAYIDX1109]] to <4 x i8>*
; CHECK-NEXT:    [[TMP11:%.*]] = load <4 x i8>, <4 x i8>* [[TMP10]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE:%.*]] = shufflevector <4 x i8> [[TMP9]], <4 x i8> [[TMP11]], <8 x i32> <i32 2, i32 0, i32 1, i32 3, i32 6, i32 4, i32 5, i32 7>
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i8* [[ARRAYIDX1024]] to <4 x i8>*
; CHECK-NEXT:    [[TMP13:%.*]] = load <4 x i8>, <4 x i8>* [[TMP12]], align 1
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i8* [[ARRAYIDX1111]] to <4 x i8>*
; CHECK-NEXT:    [[TMP15:%.*]] = load <4 x i8>, <4 x i8>* [[TMP14]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE1:%.*]] = shufflevector <4 x i8> [[TMP13]], <4 x i8> [[TMP15]], <8 x i32> <i32 2, i32 0, i32 1, i32 3, i32 6, i32 4, i32 5, i32 7>
; CHECK-NEXT:    [[TMP16:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE3]] to <8 x i32>
; CHECK-NEXT:    [[TMP17:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE]] to <8 x i32>
; CHECK-NEXT:    [[TMP18:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE1]] to <8 x i32>
; CHECK-NEXT:    [[TMP19:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE2]] to <8 x i32>
; CHECK-NEXT:    [[TMP20:%.*]] = shl nsw <8 x i32> [[TMP17]], <i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP21:%.*]] = shl nsw <8 x i32> [[TMP18]], <i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP22:%.*]] = sub nsw <8 x i32> [[TMP20]], [[TMP21]]
; CHECK-NEXT:    [[TMP23:%.*]] = sub nsw <8 x i32> [[TMP22]], [[TMP19]]
; CHECK-NEXT:    [[TMP24:%.*]] = add nsw <8 x i32> [[TMP23]], [[TMP16]]
; CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 3, i32 2, i32 0, i32 1, i32 7, i32 6, i32 4, i32 5>
; CHECK-NEXT:    [[TMP26:%.*]] = add <8 x i32> [[TMP24]], [[TMP25]]
; CHECK-NEXT:    [[TMP27:%.*]] = sub <8 x i32> [[TMP24]], [[TMP25]]
; CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <8 x i32> [[TMP26]], <8 x i32> [[TMP27]], <8 x i32> <i32 0, i32 9, i32 10, i32 3, i32 4, i32 13, i32 14, i32 7>
; CHECK-NEXT:    [[TMP29:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 1, i32 0, i32 3, i32 2, i32 5, i32 4, i32 7, i32 6>
; CHECK-NEXT:    [[TMP30:%.*]] = add <8 x i32> [[TMP28]], [[TMP29]]
; CHECK-NEXT:    [[TMP31:%.*]] = sub <8 x i32> [[TMP28]], [[TMP29]]
; CHECK-NEXT:    [[TMP32:%.*]] = shufflevector <8 x i32> [[TMP30]], <8 x i32> [[TMP31]], <8 x i32> <i32 0, i32 1, i32 10, i32 11, i32 4, i32 5, i32 14, i32 15>
; CHECK-NEXT:    [[TMP33:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 2, i32 3, i32 1, i32 0, i32 6, i32 7, i32 5, i32 4>
; CHECK-NEXT:    [[TMP34:%.*]] = add <8 x i32> [[TMP32]], [[TMP33]]
; CHECK-NEXT:    [[TMP35:%.*]] = sub <8 x i32> [[TMP32]], [[TMP33]]
; CHECK-NEXT:    [[TMP36:%.*]] = shufflevector <8 x i32> [[TMP34]], <8 x i32> [[TMP35]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 13, i32 6, i32 15>
; CHECK-NEXT:    [[TMP37:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <8 x i32>*
; CHECK-NEXT:    store <8 x i32> [[TMP36]], <8 x i32>* [[TMP37]], align 4
>>>>>>> b3691bf8def90572695862bae31a7783dacaa236
...
; CHECK-NEXT:    [[BRIDGE_T802_29162940:%.*]] = add nsw i32 [[TMP49]], [[TMP48]]
; CHECK-NEXT:    [[TMP50:%.*]] = shufflevector <2 x i32> [[TMP47]], <2 x i32> poison, <2 x i32> <i32 1, i32 0>
; CHECK-NEXT:    [[TMP51:%.*]] = sub <2 x i32> [[TMP50]], [[TMP47]]
=======
...
; CHECK-NEXT:    [[TMP52:%.*]] = bitcast i8* [[ARRAYIDX1313]] to <2 x i8>*
; CHECK-NEXT:    [[TMP53:%.*]] = load <2 x i8>, <2 x i8>* [[TMP52]], align 1
; CHECK-NEXT:    [[TMP54:%.*]] = bitcast i8* [[ARRAYIDX1315]] to <2 x i8>*
; CHECK-NEXT:    [[TMP55:%.*]] = load <2 x i8>, <2 x i8>* [[TMP54]], align 1
; CHECK-NEXT:    [[TMP56:%.*]] = bitcast i8* [[ARRAYIDX1317]] to <2 x i8>*
; CHECK-NEXT:    [[TMP57:%.*]] = load <2 x i8>, <2 x i8>* [[TMP56]], align 1
; CHECK-NEXT:    [[TMP58:%.*]] = bitcast i8* [[ARRAYIDX1319]] to <2 x i8>*
; CHECK-NEXT:    [[TMP59:%.*]] = load <2 x i8>, <2 x i8>* [[TMP58]], align 1
; CHECK-NEXT:    [[TMP60:%.*]] = zext <2 x i8> [[TMP53]] to <2 x i32>
; CHECK-NEXT:    [[TMP61:%.*]] = zext <2 x i8> [[TMP57]] to <2 x i32>
; CHECK-NEXT:    [[TMP62:%.*]] = zext <2 x i8> [[TMP59]] to <2 x i32>
; CHECK-NEXT:    [[TMP63:%.*]] = zext <2 x i8> [[TMP55]] to <2 x i32>
; CHECK-NEXT:    [[TMP64:%.*]] = shl nsw <2 x i32> [[TMP61]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP65:%.*]] = shl nsw <2 x i32> [[TMP62]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP66:%.*]] = sub nsw <2 x i32> [[TMP64]], [[TMP65]]
; CHECK-NEXT:    [[TMP67:%.*]] = sub nsw <2 x i32> [[TMP66]], [[TMP63]]
; CHECK-NEXT:    [[TMP68:%.*]] = add nsw <2 x i32> [[TMP67]], [[TMP60]]
; CHECK-NEXT:    [[SHUFFLE4:%.*]] = shufflevector <2 x i32> [[TMP68]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
; CHECK-NEXT:    [[TMP69:%.*]] = shufflevector <2 x i32> [[TMP68]], <2 x i32> poison, <4 x i32> <i32 1, i32 0, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP70:%.*]] = insertelement <4 x i32> [[TMP69]], i32 [[CHAIN_T775_2764]], i32 2
; CHECK-NEXT:    [[SHUFFLE3:%.*]] = shufflevector <4 x i32> [[TMP70]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
; CHECK-NEXT:    [[TMP71:%.*]] = add <4 x i32> [[SHUFFLE3]], [[SHUFFLE4]]
; CHECK-NEXT:    [[TMP72:%.*]] = sub <4 x i32> [[SHUFFLE3]], [[SHUFFLE4]]
; CHECK-NEXT:    [[TMP73:%.*]] = shufflevector <4 x i32> [[TMP71]], <4 x i32> [[TMP72]], <4 x i32> <i32 0, i32 5, i32 6, i32 7>
...
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP75:%.*]] = insertelement <4 x i8> [[TMP74]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP76:%.*]] = insertelement <4 x i8> [[TMP75]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP77:%.*]] = insertelement <4 x i8> [[TMP76]], i8 [[GEPLOAD1306]], i32 3
; CHECK-NEXT:    [[TMP78:%.*]] = zext <4 x i8> [[TMP77]] to <4 x i32>
; CHECK-NEXT:    [[TMP79:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP80:%.*]] = insertelement <4 x i8> [[TMP79]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP81:%.*]] = insertelement <4 x i8> [[TMP80]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <4 x i8> [[TMP81]], i8 [[GEPLOAD1310]], i32 3
; CHECK-NEXT:    [[TMP83:%.*]] = zext <4 x i8> [[TMP82]] to <4 x i32>
; CHECK-NEXT:    [[TMP84:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP85:%.*]] = insertelement <4 x i8> [[TMP84]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <4 x i8> [[TMP85]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP87:%.*]] = insertelement <4 x i8> [[TMP86]], i8 [[GEPLOAD1312]], i32 3
; CHECK-NEXT:    [[TMP88:%.*]] = zext <4 x i8> [[TMP87]] to <4 x i32>
; CHECK-NEXT:    [[TMP89:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP90:%.*]] = insertelement <4 x i8> [[TMP89]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <4 x i8> [[TMP90]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP92:%.*]] = insertelement <4 x i8> [[TMP91]], i8 [[GEPLOAD1308]], i32 3
; CHECK-NEXT:    [[TMP93:%.*]] = zext <4 x i8> [[TMP92]] to <4 x i32>
; CHECK-NEXT:    [[TMP94:%.*]] = shl nsw <4 x i32> [[TMP83]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP95:%.*]] = shl nsw <4 x i32> [[TMP88]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP96:%.*]] = sub nsw <4 x i32> [[TMP94]], [[TMP95]]
; CHECK-NEXT:    [[TMP97:%.*]] = sub nsw <4 x i32> [[TMP96]], [[TMP93]]
; CHECK-NEXT:    [[TMP98:%.*]] = add nsw <4 x i32> [[TMP97]], [[TMP78]]
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <4 x i32> [[TMP98]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <8 x i32> [[TMP30]], <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <16 x i32> [[TMP99]], i32 [[BRIDGE_T802_29162940]], i32 8
; CHECK-NEXT:    [[TMP101:%.*]] = shufflevector <2 x i32> [[TMP51]], <2 x i32> poison, <16 x i32> <i32 0, i32 undef, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP102:%.*]] = shufflevector <16 x i32> [[TMP100]], <16 x i32> [[TMP101]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 16, i32 undef, i32 18, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP103:%.*]] = shufflevector <4 x i32> [[TMP73]], <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP104:%.*]] = shufflevector <16 x i32> [[TMP102]], <16 x i32> [[TMP103]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 undef, i32 11, i32 16, i32 17, i32 18, i32 19>
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <16 x i32> [[TMP104]], <16 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 8, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP105:%.*]] = insertelement <16 x i32> poison, i32 [[CHAIN_T856_3322]], i32 0
; CHECK-NEXT:    [[TMP106:%.*]] = shufflevector <4 x i32> [[TMP24]], <4 x i32> poison, <16 x i32> <i32 undef, i32 1, i32 undef, i32 undef, i32 undef, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP107:%.*]] = shufflevector <16 x i32> [[TMP105]], <16 x i32> [[TMP106]], <16 x i32> <i32 0, i32 undef, i32 17, i32 undef, i32 undef, i32 undef, i32 21, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP108:%.*]] = insertelement <16 x i32> [[TMP107]], i32 [[CHAIN_T829_3169]], i32 4
; CHECK-NEXT:    [[TMP109:%.*]] = insertelement <16 x i32> [[TMP108]], i32 [[CHAIN_T802_2928]], i32 8
; CHECK-NEXT:    [[TMP110:%.*]] = insertelement <16 x i32> [[TMP109]], i32 [[CHAIN_T775_2764]], i32 12
; CHECK-NEXT:    [[TMP111:%.*]] = shufflevector <2 x i32> [[TMP68]], <2 x i32> poison, <16 x i32> <i32 undef, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP112:%.*]] = shufflevector <16 x i32> [[TMP110]], <16 x i32> [[TMP111]], <16 x i32> <i32 0, i32 undef, i32 2, i32 undef, i32 4, i32 undef, i32 6, i32 undef, i32 8, i32 undef, i32 undef, i32 undef, i32 12, i32 undef, i32 17, i32 undef>
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <16 x i32> [[TMP112]], <16 x i32> poison, <16 x i32> <i32 0, i32 0, i32 2, i32 0, i32 4, i32 4, i32 6, i32 4, i32 8, i32 8, i32 8, i32 8, i32 12, i32 12, i32 14, i32 12>
; CHECK-NEXT:    [[TMP113:%.*]] = add nsw <16 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP114:%.*]] = sub nsw <16 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP115:%.*]] = shufflevector <16 x i32> [[TMP113]], <16 x i32> [[TMP114]], <16 x i32> <i32 0, i32 1, i32 18, i32 3, i32 4, i32 5, i32 22, i32 7, i32 8, i32 25, i32 26, i32 27, i32 12, i32 13, i32 30, i32 15>
; CHECK-NEXT:    [[TMP116:%.*]] = add nsw <16 x i32> [[TMP115]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP117:%.*]] = sub nsw <16 x i32> [[TMP115]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP118:%.*]] = shufflevector <16 x i32> [[TMP116]], <16 x i32> [[TMP117]], <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 24, i32 9, i32 26, i32 11, i32 12, i32 29, i32 14, i32 31>
; CHECK-NEXT:    [[TMP119:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> [[TMP118]], <16 x i32>* [[TMP119]], align 4
=======
; CHECK-NEXT:    [[ARRAYIDX1348:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I85]], i64 6
; CHECK-NEXT:    [[TMP38:%.*]] = bitcast i8* [[ARRAYIDX1195]] to <2 x i8>*
; CHECK-NEXT:    [[TMP39:%.*]] = load <2 x i8>, <2 x i8>* [[TMP38]], align 1
; CHECK-NEXT:    [[TMP40:%.*]] = bitcast i8* [[ARRAYIDX1297]] to <2 x i8>*
; CHECK-NEXT:    [[TMP41:%.*]] = load <2 x i8>, <2 x i8>* [[TMP40]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE11:%.*]] = shufflevector <2 x i8> [[TMP39]], <2 x i8> [[TMP41]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP42:%.*]] = bitcast i8* [[ARRAYIDX1193]] to <2 x i8>*
; CHECK-NEXT:    [[TMP43:%.*]] = load <2 x i8>, <2 x i8>* [[TMP42]], align 1
; CHECK-NEXT:    [[TMP44:%.*]] = bitcast i8* [[ARRAYIDX1299]] to <2 x i8>*
; CHECK-NEXT:    [[TMP45:%.*]] = load <2 x i8>, <2 x i8>* [[TMP44]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE10:%.*]] = shufflevector <2 x i8> [[TMP43]], <2 x i8> [[TMP45]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP46:%.*]] = bitcast i8* [[ARRAYIDX1199]] to <2 x i8>*
; CHECK-NEXT:    [[TMP47:%.*]] = load <2 x i8>, <2 x i8>* [[TMP46]], align 1
; CHECK-NEXT:    [[TMP48:%.*]] = bitcast i8* [[ARRAYIDX1301]] to <2 x i8>*
; CHECK-NEXT:    [[TMP49:%.*]] = load <2 x i8>, <2 x i8>* [[TMP48]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE8:%.*]] = shufflevector <2 x i8> [[TMP47]], <2 x i8> [[TMP49]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP50:%.*]] = bitcast i8* [[ARRAYIDX1197]] to <2 x i8>*
; CHECK-NEXT:    [[TMP51:%.*]] = load <2 x i8>, <2 x i8>* [[TMP50]], align 1
; CHECK-NEXT:    [[TMP52:%.*]] = bitcast i8* [[ARRAYIDX1303]] to <2 x i8>*
; CHECK-NEXT:    [[TMP53:%.*]] = load <2 x i8>, <2 x i8>* [[TMP52]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE9:%.*]] = shufflevector <2 x i8> [[TMP51]], <2 x i8> [[TMP53]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP54:%.*]] = bitcast i8* [[ARRAYIDX1211]] to <2 x i8>*
; CHECK-NEXT:    [[TMP55:%.*]] = load <2 x i8>, <2 x i8>* [[TMP54]], align 1
; CHECK-NEXT:    [[TMP56:%.*]] = bitcast i8* [[ARRAYIDX1313]] to <2 x i8>*
; CHECK-NEXT:    [[TMP57:%.*]] = load <2 x i8>, <2 x i8>* [[TMP56]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE7:%.*]] = shufflevector <2 x i8> [[TMP55]], <2 x i8> [[TMP57]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP58:%.*]] = bitcast i8* [[ARRAYIDX1209]] to <2 x i8>*
; CHECK-NEXT:    [[TMP59:%.*]] = load <2 x i8>, <2 x i8>* [[TMP58]], align 1
; CHECK-NEXT:    [[TMP60:%.*]] = bitcast i8* [[ARRAYIDX1315]] to <2 x i8>*
; CHECK-NEXT:    [[TMP61:%.*]] = load <2 x i8>, <2 x i8>* [[TMP60]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE6:%.*]] = shufflevector <2 x i8> [[TMP59]], <2 x i8> [[TMP61]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP62:%.*]] = bitcast i8* [[ARRAYIDX1215]] to <2 x i8>*
; CHECK-NEXT:    [[TMP63:%.*]] = load <2 x i8>, <2 x i8>* [[TMP62]], align 1
; CHECK-NEXT:    [[TMP64:%.*]] = bitcast i8* [[ARRAYIDX1317]] to <2 x i8>*
; CHECK-NEXT:    [[TMP65:%.*]] = load <2 x i8>, <2 x i8>* [[TMP64]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE4:%.*]] = shufflevector <2 x i8> [[TMP63]], <2 x i8> [[TMP65]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP66:%.*]] = bitcast i8* [[ARRAYIDX1213]] to <2 x i8>*
; CHECK-NEXT:    [[TMP67:%.*]] = load <2 x i8>, <2 x i8>* [[TMP66]], align 1
; CHECK-NEXT:    [[TMP68:%.*]] = bitcast i8* [[ARRAYIDX1319]] to <2 x i8>*
; CHECK-NEXT:    [[TMP69:%.*]] = load <2 x i8>, <2 x i8>* [[TMP68]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE5:%.*]] = shufflevector <2 x i8> [[TMP67]], <2 x i8> [[TMP69]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP70:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE7]] to <4 x i32>
; CHECK-NEXT:    [[TMP71:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE11]] to <4 x i32>
; CHECK-NEXT:    [[TMP72:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE4]] to <4 x i32>
; CHECK-NEXT:    [[TMP73:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE8]] to <4 x i32>
; CHECK-NEXT:    [[TMP74:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE5]] to <4 x i32>
; CHECK-NEXT:    [[TMP75:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE9]] to <4 x i32>
; CHECK-NEXT:    [[TMP76:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE6]] to <4 x i32>
; CHECK-NEXT:    [[TMP77:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE10]] to <4 x i32>
; CHECK-NEXT:    [[TMP78:%.*]] = shl nsw <4 x i32> [[TMP73]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP79:%.*]] = shl nsw <4 x i32> [[TMP75]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP80:%.*]] = sub nsw <4 x i32> [[TMP78]], [[TMP79]]
; CHECK-NEXT:    [[TMP81:%.*]] = sub nsw <4 x i32> [[TMP80]], [[TMP77]]
; CHECK-NEXT:    [[TMP82:%.*]] = add nsw <4 x i32> [[TMP81]], [[TMP71]]
; CHECK-NEXT:    [[TMP83:%.*]] = shl nsw <4 x i32> [[TMP72]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP84:%.*]] = shl nsw <4 x i32> [[TMP74]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP85:%.*]] = sub nsw <4 x i32> [[TMP83]], [[TMP84]]
; CHECK-NEXT:    [[TMP86:%.*]] = sub nsw <4 x i32> [[TMP85]], [[TMP76]]
; CHECK-NEXT:    [[TMP87:%.*]] = add nsw <4 x i32> [[TMP86]], [[TMP70]]
; CHECK-NEXT:    [[TMP88:%.*]] = shufflevector <4 x i32> [[TMP87]], <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP89:%.*]] = add nsw <4 x i32> [[TMP87]], [[TMP88]]
; CHECK-NEXT:    [[TMP90:%.*]] = sub nsw <4 x i32> [[TMP87]], [[TMP88]]
; CHECK-NEXT:    [[TMP91:%.*]] = shufflevector <4 x i32> [[TMP89]], <4 x i32> [[TMP90]], <4 x i32> <i32 0, i32 5, i32 2, i32 7>
; CHECK-NEXT:    [[TMP92:%.*]] = extractelement <4 x i32> [[TMP91]], i32 0
; CHECK-NEXT:    [[TMP93:%.*]] = extractelement <4 x i32> [[TMP82]], i32 1
; CHECK-NEXT:    [[TMP94:%.*]] = extractelement <4 x i32> [[TMP82]], i32 0
; CHECK-NEXT:    [[TMP95:%.*]] = extractelement <4 x i32> [[TMP87]], i32 0
; CHECK-NEXT:    [[TMP96:%.*]] = extractelement <4 x i32> [[TMP87]], i32 1
; CHECK-NEXT:    [[BRIDGE_T797_2968:%.*]] = sub nsw i32 [[TMP95]], [[TMP96]]
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <2 x i32> poison, i32 [[TMP92]], i32 0
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <2 x i32> [[TMP97]], i32 [[BRIDGE_T797_2968]], i32 1
; CHECK-NEXT:    [[TMP99:%.*]] = insertelement <2 x i32> poison, i32 [[TMP93]], i32 0
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <2 x i32> [[TMP99]], i32 [[TMP94]], i32 1
; CHECK-NEXT:    [[TMP101:%.*]] = add <2 x i32> [[TMP98]], [[TMP100]]
; CHECK-NEXT:    [[TMP102:%.*]] = insertelement <2 x i32> poison, i32 [[TMP94]], i32 0
; CHECK-NEXT:    [[TMP103:%.*]] = insertelement <2 x i32> [[TMP102]], i32 [[TMP93]], i32 1
; CHECK-NEXT:    [[TMP104:%.*]] = sub <2 x i32> [[TMP101]], [[TMP103]]
; CHECK-NEXT:    [[TMP105:%.*]] = bitcast i32* [[ARRAYIDX1226]] to <2 x i32>*
; CHECK-NEXT:    store <2 x i32> [[TMP104]], <2 x i32>* [[TMP105]], align 4
; CHECK-NEXT:    [[TMP106:%.*]] = extractelement <4 x i32> [[TMP87]], i32 3
; CHECK-NEXT:    [[TMP107:%.*]] = extractelement <4 x i32> [[TMP82]], i32 3
; CHECK-NEXT:    [[TMP108:%.*]] = extractelement <4 x i32> [[TMP87]], i32 2
; CHECK-NEXT:    [[TMP109:%.*]] = extractelement <4 x i32> [[TMP82]], i32 2
; CHECK-NEXT:    [[TMP110:%.*]] = sub <4 x i32> [[TMP91]], [[TMP82]]
; CHECK-NEXT:    [[TMP111:%.*]] = add <4 x i32> [[TMP91]], [[TMP82]]
; CHECK-NEXT:    [[TMP112:%.*]] = shufflevector <4 x i32> [[TMP110]], <4 x i32> [[TMP111]], <4 x i32> <i32 0, i32 1, i32 6, i32 7>
; CHECK-NEXT:    [[TMP113:%.*]] = shufflevector <4 x i32> [[TMP82]], <4 x i32> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP114:%.*]] = sub <4 x i32> [[TMP112]], [[TMP113]]
; CHECK-NEXT:    [[TMP115:%.*]] = add <4 x i32> [[TMP112]], [[TMP113]]
; CHECK-NEXT:    [[TMP116:%.*]] = shufflevector <4 x i32> [[TMP114]], <4 x i32> [[TMP115]], <4 x i32> <i32 0, i32 5, i32 6, i32 3>
; CHECK-NEXT:    [[TMP117:%.*]] = bitcast i32* [[ARRAYIDX1244]] to <4 x i32>*
; CHECK-NEXT:    store <4 x i32> [[TMP116]], <4 x i32>* [[TMP117]], align 4
; CHECK-NEXT:    [[TMP118:%.*]] = insertelement <2 x i32> poison, i32 [[TMP107]], i32 0
; CHECK-NEXT:    [[TMP119:%.*]] = insertelement <2 x i32> [[TMP118]], i32 [[TMP108]], i32 1
; CHECK-NEXT:    [[TMP120:%.*]] = insertelement <2 x i32> poison, i32 [[TMP106]], i32 0
; CHECK-NEXT:    [[TMP121:%.*]] = insertelement <2 x i32> [[TMP120]], i32 [[TMP106]], i32 1
; CHECK-NEXT:    [[TMP122:%.*]] = sub <2 x i32> [[TMP119]], [[TMP121]]
; CHECK-NEXT:    [[TMP123:%.*]] = insertelement <2 x i32> poison, i32 [[TMP108]], i32 0
; CHECK-NEXT:    [[TMP124:%.*]] = insertelement <2 x i32> [[TMP123]], i32 [[TMP109]], i32 1
; CHECK-NEXT:    [[TMP125:%.*]] = sub <2 x i32> [[TMP122]], [[TMP124]]
; CHECK-NEXT:    [[TMP126:%.*]] = insertelement <2 x i32> poison, i32 [[TMP109]], i32 0
; CHECK-NEXT:    [[TMP127:%.*]] = insertelement <2 x i32> [[TMP126]], i32 [[TMP107]], i32 1
; CHECK-NEXT:    [[TMP128:%.*]] = add <2 x i32> [[TMP125]], [[TMP127]]
; CHECK-NEXT:    [[TMP129:%.*]] = bitcast i32* [[ARRAYIDX1348]] to <2 x i32>*
; CHECK-NEXT:    store <2 x i32> [[TMP128]], <2 x i32>* [[TMP129]], align 4
>>>>>>> b3691bf8def90572695862bae31a7783dacaa236

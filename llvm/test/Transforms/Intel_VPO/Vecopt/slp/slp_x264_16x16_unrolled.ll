...
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <8 x i32> [[SHUFFLE7]], i32 1
; CHECK-NEXT:    [[TMP26:%.*]] = insertelement <8 x i32> poison, i32 [[TMP25]], i32 0
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <8 x i32> [[SHUFFLE7]], i32 0
; CHECK-NEXT:    [[TMP28:%.*]] = insertelement <8 x i32> [[TMP26]], i32 [[TMP27]], i32 1
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <8 x i32> [[TMP28]], i32 [[CHAIN_T856_3322]], i32 2
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <8 x i32> [[SHUFFLE7]], i32 5
; CHECK-NEXT:    [[TMP31:%.*]] = insertelement <8 x i32> [[TMP29]], i32 [[TMP30]], i32 3
; CHECK-NEXT:    [[TMP32:%.*]] = extractelement <8 x i32> [[SHUFFLE7]], i32 4
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <8 x i32> [[TMP31]], i32 [[TMP32]], i32 4
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <8 x i32> [[TMP33]], i32 [[CHAIN_T829_3169]], i32 5
; CHECK-NEXT:    [[SHUFFLE3:%.*]] = shufflevector <8 x i32> [[TMP34]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 0, i32 3, i32 4, i32 5, i32 3>
; CHECK-NEXT:    [[TMP35:%.*]] = add <8 x i32> [[SHUFFLE3]], [[SHUFFLE7]]
; CHECK-NEXT:    [[TMP36:%.*]] = sub <8 x i32> [[SHUFFLE3]], [[SHUFFLE7]]
; CHECK-NEXT:    [[TMP37:%.*]] = shufflevector <8 x i32> [[TMP35]], <8 x i32> [[TMP36]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
...
; CHECK-NEXT:    [[TMP38:%.*]] = bitcast i8* [[ARRAYIDX1209]] to <2 x i8>*
; CHECK-NEXT:    [[TMP39:%.*]] = load <2 x i8>, <2 x i8>* [[TMP38]], align 1
; CHECK-NEXT:    [[TMP40:%.*]] = bitcast i8* [[ARRAYIDX1211]] to <2 x i8>*
; CHECK-NEXT:    [[TMP41:%.*]] = load <2 x i8>, <2 x i8>* [[TMP40]], align 1
; CHECK-NEXT:    [[TMP42:%.*]] = bitcast i8* [[ARRAYIDX1213]] to <2 x i8>*
; CHECK-NEXT:    [[TMP43:%.*]] = load <2 x i8>, <2 x i8>* [[TMP42]], align 1
; CHECK-NEXT:    [[TMP44:%.*]] = bitcast i8* [[ARRAYIDX1215]] to <2 x i8>*
; CHECK-NEXT:    [[TMP45:%.*]] = load <2 x i8>, <2 x i8>* [[TMP44]], align 1
; CHECK-NEXT:    [[TMP46:%.*]] = zext <2 x i8> [[TMP39]] to <2 x i32>
; CHECK-NEXT:    [[TMP47:%.*]] = zext <2 x i8> [[TMP43]] to <2 x i32>
; CHECK-NEXT:    [[TMP48:%.*]] = zext <2 x i8> [[TMP45]] to <2 x i32>
; CHECK-NEXT:    [[TMP49:%.*]] = zext <2 x i8> [[TMP41]] to <2 x i32>
; CHECK-NEXT:    [[TMP50:%.*]] = shl nsw <2 x i32> [[TMP47]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP51:%.*]] = shl nsw <2 x i32> [[TMP48]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP52:%.*]] = sub <2 x i32> [[TMP51]], [[TMP46]]
; CHECK-NEXT:    [[TMP53:%.*]] = sub <2 x i32> [[TMP52]], [[TMP50]]
; CHECK-NEXT:    [[TMP54:%.*]] = add <2 x i32> [[TMP53]], [[TMP49]]
; CHECK-NEXT:    [[TMP55:%.*]] = extractelement <2 x i32> [[TMP54]], i32 0
; CHECK-NEXT:    [[TMP56:%.*]] = extractelement <2 x i32> [[TMP54]], i32 1
; CHECK-NEXT:    [[BRIDGE_T797_2968:%.*]] = sub nsw i32 [[TMP56]], [[TMP55]]
; CHECK-NEXT:    [[TMP57:%.*]] = insertelement <2 x i32> poison, i32 [[TMP55]], i32 0
; CHECK-NEXT:    [[TMP58:%.*]] = insertelement <2 x i32> [[TMP57]], i32 [[TMP55]], i32 1
; CHECK-NEXT:    [[TMP59:%.*]] = insertelement <2 x i32> poison, i32 [[TMP56]], i32 0
; CHECK-NEXT:    [[TMP60:%.*]] = insertelement <2 x i32> [[TMP59]], i32 [[TMP56]], i32 1
; CHECK-NEXT:    [[TMP61:%.*]] = add <2 x i32> [[TMP58]], [[TMP60]]
; CHECK-NEXT:    [[TMP62:%.*]] = sub <2 x i32> [[TMP58]], [[TMP60]]
; CHECK-NEXT:    [[TMP63:%.*]] = shufflevector <2 x i32> [[TMP61]], <2 x i32> [[TMP62]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP64:%.*]] = bitcast i8* [[ARRAYIDX1313]] to <2 x i8>*
; CHECK-NEXT:    [[TMP65:%.*]] = load <2 x i8>, <2 x i8>* [[TMP64]], align 1
; CHECK-NEXT:    [[TMP66:%.*]] = bitcast i8* [[ARRAYIDX1315]] to <2 x i8>*
; CHECK-NEXT:    [[TMP67:%.*]] = load <2 x i8>, <2 x i8>* [[TMP66]], align 1
; CHECK-NEXT:    [[TMP68:%.*]] = bitcast i8* [[ARRAYIDX1317]] to <2 x i8>*
; CHECK-NEXT:    [[TMP69:%.*]] = load <2 x i8>, <2 x i8>* [[TMP68]], align 1
; CHECK-NEXT:    [[TMP70:%.*]] = bitcast i8* [[ARRAYIDX1319]] to <2 x i8>*
; CHECK-NEXT:    [[TMP71:%.*]] = load <2 x i8>, <2 x i8>* [[TMP70]], align 1
; CHECK-NEXT:    [[TMP72:%.*]] = zext <2 x i8> [[TMP65]] to <2 x i32>
; CHECK-NEXT:    [[TMP73:%.*]] = zext <2 x i8> [[TMP69]] to <2 x i32>
; CHECK-NEXT:    [[TMP74:%.*]] = zext <2 x i8> [[TMP71]] to <2 x i32>
; CHECK-NEXT:    [[TMP75:%.*]] = zext <2 x i8> [[TMP67]] to <2 x i32>
; CHECK-NEXT:    [[TMP76:%.*]] = shl nsw <2 x i32> [[TMP73]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP77:%.*]] = shl nsw <2 x i32> [[TMP74]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP78:%.*]] = sub <2 x i32> [[TMP76]], [[TMP75]]
; CHECK-NEXT:    [[TMP79:%.*]] = sub <2 x i32> [[TMP78]], [[TMP77]]
; CHECK-NEXT:    [[TMP80:%.*]] = add <2 x i32> [[TMP79]], [[TMP72]]
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <2 x i32> [[TMP80]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
; CHECK-NEXT:    [[TMP81:%.*]] = extractelement <4 x i32> [[SHUFFLE2]], i32 1
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <4 x i32> poison, i32 [[TMP81]], i32 0
; CHECK-NEXT:    [[TMP83:%.*]] = extractelement <4 x i32> [[SHUFFLE2]], i32 0
; CHECK-NEXT:    [[TMP84:%.*]] = insertelement <4 x i32> [[TMP82]], i32 [[TMP83]], i32 1
; CHECK-NEXT:    [[TMP85:%.*]] = insertelement <4 x i32> [[TMP84]], i32 [[CHAIN_T775_2764]], i32 2
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <4 x i32> [[TMP85]], i32 [[TMP81]], i32 3
; CHECK-NEXT:    [[TMP87:%.*]] = add <4 x i32> [[TMP86]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP88:%.*]] = sub <4 x i32> [[TMP86]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP89:%.*]] = shufflevector <4 x i32> [[TMP87]], <4 x i32> [[TMP88]], <4 x i32> <i32 0, i32 5, i32 6, i32 7>
...
; CHECK-NEXT:    [[TMP90:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <4 x i8> [[TMP90]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP92:%.*]] = insertelement <4 x i8> [[TMP91]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP93:%.*]] = insertelement <4 x i8> [[TMP92]], i8 [[GEPLOAD1306]], i32 3
; CHECK-NEXT:    [[TMP94:%.*]] = zext <4 x i8> [[TMP93]] to <4 x i32>
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <4 x i8> [[TMP95]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <4 x i8> [[TMP96]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <4 x i8> [[TMP97]], i8 [[GEPLOAD1310]], i32 3
; CHECK-NEXT:    [[TMP99:%.*]] = zext <4 x i8> [[TMP98]] to <4 x i32>
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP101:%.*]] = insertelement <4 x i8> [[TMP100]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP102:%.*]] = insertelement <4 x i8> [[TMP101]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP103:%.*]] = insertelement <4 x i8> [[TMP102]], i8 [[GEPLOAD1312]], i32 3
; CHECK-NEXT:    [[TMP104:%.*]] = zext <4 x i8> [[TMP103]] to <4 x i32>
; CHECK-NEXT:    [[TMP105:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP106:%.*]] = insertelement <4 x i8> [[TMP105]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP107:%.*]] = insertelement <4 x i8> [[TMP106]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP108:%.*]] = insertelement <4 x i8> [[TMP107]], i8 [[GEPLOAD1308]], i32 3
; CHECK-NEXT:    [[TMP109:%.*]] = zext <4 x i8> [[TMP108]] to <4 x i32>
; CHECK-NEXT:    [[TMP110:%.*]] = shl nsw <4 x i32> [[TMP99]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP111:%.*]] = shl nsw <4 x i32> [[TMP104]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP112:%.*]] = sub <4 x i32> [[TMP110]], [[TMP111]]
; CHECK-NEXT:    [[TMP113:%.*]] = sub <4 x i32> [[TMP112]], [[TMP109]]
; CHECK-NEXT:    [[TMP114:%.*]] = add <4 x i32> [[TMP113]], [[TMP94]]
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP114]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
; CHECK-NEXT:    [[TMP115:%.*]] = shufflevector <8 x i32> [[TMP37]], <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP116:%.*]] = extractelement <2 x i32> [[TMP63]], i32 0
; CHECK-NEXT:    [[TMP117:%.*]] = insertelement <16 x i32> [[TMP115]], i32 [[TMP116]], i32 8
; CHECK-NEXT:    [[TMP118:%.*]] = insertelement <16 x i32> [[TMP117]], i32 [[BRIDGE_T797_2968]], i32 9
; CHECK-NEXT:    [[TMP119:%.*]] = shufflevector <2 x i32> [[TMP63]], <2 x i32> poison, <16 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP120:%.*]] = shufflevector <16 x i32> [[TMP118]], <16 x i32> [[TMP119]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP121:%.*]] = shufflevector <4 x i32> [[TMP89]], <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP122:%.*]] = shufflevector <16 x i32> [[TMP120]], <16 x i32> [[TMP121]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 18, i32 19>
; CHECK-NEXT:    [[TMP123:%.*]] = insertelement <16 x i32> poison, i32 [[CHAIN_T856_3322]], i32 0
; CHECK-NEXT:    [[TMP124:%.*]] = insertelement <16 x i32> [[TMP123]], i32 [[TMP25]], i32 1
; CHECK-NEXT:    [[TMP125:%.*]] = insertelement <16 x i32> [[TMP124]], i32 [[CHAIN_T829_3169]], i32 2
; CHECK-NEXT:    [[TMP126:%.*]] = insertelement <16 x i32> [[TMP125]], i32 [[TMP30]], i32 3
; CHECK-NEXT:    [[TMP127:%.*]] = insertelement <16 x i32> [[TMP126]], i32 [[CHAIN_T802_2928]], i32 4
; CHECK-NEXT:    [[TMP128:%.*]] = insertelement <16 x i32> [[TMP127]], i32 [[CHAIN_T775_2764]], i32 5
; CHECK-NEXT:    [[TMP129:%.*]] = insertelement <16 x i32> [[TMP128]], i32 [[TMP81]], i32 6
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <16 x i32> [[TMP129]], <16 x i32> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2, i32 4, i32 4, i32 4, i32 4, i32 5, i32 5, i32 6, i32 5>
; CHECK-NEXT:    [[TMP130:%.*]] = add <16 x i32> [[TMP122]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP131:%.*]] = sub <16 x i32> [[TMP122]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP132:%.*]] = shufflevector <16 x i32> [[TMP130]], <16 x i32> [[TMP131]], <16 x i32> <i32 0, i32 1, i32 18, i32 3, i32 4, i32 5, i32 22, i32 7, i32 8, i32 25, i32 26, i32 27, i32 12, i32 13, i32 30, i32 15>
; CHECK-NEXT:    [[TMP133:%.*]] = add <16 x i32> [[TMP132]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP134:%.*]] = sub <16 x i32> [[TMP132]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP135:%.*]] = shufflevector <16 x i32> [[TMP133]], <16 x i32> [[TMP134]], <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 24, i32 9, i32 26, i32 11, i32 12, i32 29, i32 14, i32 31>
; CHECK-NEXT:    [[TMP136:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> [[TMP135]], <16 x i32>* [[TMP136]], align 4

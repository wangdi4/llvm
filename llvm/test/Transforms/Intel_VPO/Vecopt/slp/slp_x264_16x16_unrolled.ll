...
; CHECK-NEXT:    [[TMP38:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T802_29182920]], i32 0
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <2 x i32> [[TMP38]], i32 [[CHAIN_T802_29182920]], i32 1
; CHECK-NEXT:    [[TMP40:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T802_29102912]], i32 0
; CHECK-NEXT:    [[TMP41:%.*]] = insertelement <2 x i32> [[TMP40]], i32 [[CHAIN_T802_29102912]], i32 1
; CHECK-NEXT:    [[TMP42:%.*]] = add <2 x i32> [[TMP39]], [[TMP41]]
; CHECK-NEXT:    [[TMP43:%.*]] = sub <2 x i32> [[TMP39]], [[TMP41]]
; CHECK-NEXT:    [[TMP44:%.*]] = shufflevector <2 x i32> [[TMP42]], <2 x i32> [[TMP43]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP45:%.*]] = bitcast i8* [[ARRAYIDX1313]] to <2 x i8>*
; CHECK-NEXT:    [[TMP46:%.*]] = load <2 x i8>, <2 x i8>* [[TMP45]], align 1
; CHECK-NEXT:    [[TMP47:%.*]] = bitcast i8* [[ARRAYIDX1315]] to <2 x i8>*
; CHECK-NEXT:    [[TMP48:%.*]] = load <2 x i8>, <2 x i8>* [[TMP47]], align 1
; CHECK-NEXT:    [[TMP49:%.*]] = bitcast i8* [[ARRAYIDX1317]] to <2 x i8>*
; CHECK-NEXT:    [[TMP50:%.*]] = load <2 x i8>, <2 x i8>* [[TMP49]], align 1
; CHECK-NEXT:    [[TMP51:%.*]] = bitcast i8* [[ARRAYIDX1319]] to <2 x i8>*
; CHECK-NEXT:    [[TMP52:%.*]] = load <2 x i8>, <2 x i8>* [[TMP51]], align 1
; CHECK-NEXT:    [[TMP53:%.*]] = zext <2 x i8> [[TMP46]] to <2 x i32>
; CHECK-NEXT:    [[TMP54:%.*]] = zext <2 x i8> [[TMP50]] to <2 x i32>
; CHECK-NEXT:    [[TMP55:%.*]] = zext <2 x i8> [[TMP52]] to <2 x i32>
; CHECK-NEXT:    [[TMP56:%.*]] = zext <2 x i8> [[TMP48]] to <2 x i32>
; CHECK-NEXT:    [[TMP57:%.*]] = shl nsw <2 x i32> [[TMP54]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP58:%.*]] = shl nsw <2 x i32> [[TMP55]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP59:%.*]] = sub <2 x i32> [[TMP57]], [[TMP56]]
; CHECK-NEXT:    [[TMP60:%.*]] = sub <2 x i32> [[TMP59]], [[TMP58]]
; CHECK-NEXT:    [[TMP61:%.*]] = add <2 x i32> [[TMP60]], [[TMP53]]
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <2 x i32> [[TMP61]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
; CHECK-NEXT:    [[TMP62:%.*]] = extractelement <4 x i32> [[SHUFFLE2]], i32 1
; CHECK-NEXT:    [[TMP63:%.*]] = insertelement <4 x i32> poison, i32 [[TMP62]], i32 0
; CHECK-NEXT:    [[TMP64:%.*]] = extractelement <4 x i32> [[SHUFFLE2]], i32 0
; CHECK-NEXT:    [[TMP65:%.*]] = insertelement <4 x i32> [[TMP63]], i32 [[TMP64]], i32 1
; CHECK-NEXT:    [[TMP66:%.*]] = insertelement <4 x i32> [[TMP65]], i32 [[CHAIN_T775_2764]], i32 2
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <4 x i32> [[TMP66]], i32 [[TMP62]], i32 3
; CHECK-NEXT:    [[TMP68:%.*]] = add <4 x i32> [[TMP67]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP69:%.*]] = sub <4 x i32> [[TMP67]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP70:%.*]] = shufflevector <4 x i32> [[TMP68]], <4 x i32> [[TMP69]], <4 x i32> <i32 0, i32 5, i32 6, i32 7>
...
; CHECK-NEXT:    [[TMP71:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP72:%.*]] = insertelement <4 x i8> [[TMP71]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP73:%.*]] = insertelement <4 x i8> [[TMP72]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <4 x i8> [[TMP73]], i8 [[GEPLOAD1306]], i32 3
; CHECK-NEXT:    [[TMP75:%.*]] = zext <4 x i8> [[TMP74]] to <4 x i32>
; CHECK-NEXT:    [[TMP76:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP77:%.*]] = insertelement <4 x i8> [[TMP76]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP78:%.*]] = insertelement <4 x i8> [[TMP77]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP79:%.*]] = insertelement <4 x i8> [[TMP78]], i8 [[GEPLOAD1310]], i32 3
; CHECK-NEXT:    [[TMP80:%.*]] = zext <4 x i8> [[TMP79]] to <4 x i32>
; CHECK-NEXT:    [[TMP81:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <4 x i8> [[TMP81]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP83:%.*]] = insertelement <4 x i8> [[TMP82]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP84:%.*]] = insertelement <4 x i8> [[TMP83]], i8 [[GEPLOAD1312]], i32 3
; CHECK-NEXT:    [[TMP85:%.*]] = zext <4 x i8> [[TMP84]] to <4 x i32>
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP87:%.*]] = insertelement <4 x i8> [[TMP86]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP88:%.*]] = insertelement <4 x i8> [[TMP87]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP89:%.*]] = insertelement <4 x i8> [[TMP88]], i8 [[GEPLOAD1308]], i32 3
; CHECK-NEXT:    [[TMP90:%.*]] = zext <4 x i8> [[TMP89]] to <4 x i32>
; CHECK-NEXT:    [[TMP91:%.*]] = shl nsw <4 x i32> [[TMP80]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP92:%.*]] = shl nsw <4 x i32> [[TMP85]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP93:%.*]] = sub <4 x i32> [[TMP91]], [[TMP92]]
; CHECK-NEXT:    [[TMP94:%.*]] = sub <4 x i32> [[TMP93]], [[TMP90]]
; CHECK-NEXT:    [[TMP95:%.*]] = add <4 x i32> [[TMP94]], [[TMP75]]
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP95]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
; CHECK-NEXT:    [[TMP96:%.*]] = shufflevector <8 x i32> [[TMP37]], <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP97:%.*]] = extractelement <2 x i32> [[TMP44]], i32 0
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <16 x i32> [[TMP96]], i32 [[TMP97]], i32 8
; CHECK-NEXT:    [[TMP99:%.*]] = insertelement <16 x i32> [[TMP98]], i32 [[BRIDGE_T797_2968]], i32 9
; CHECK-NEXT:    [[TMP100:%.*]] = shufflevector <2 x i32> [[TMP44]], <2 x i32> poison, <16 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP101:%.*]] = shufflevector <16 x i32> [[TMP99]], <16 x i32> [[TMP100]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP102:%.*]] = shufflevector <4 x i32> [[TMP70]], <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP103:%.*]] = shufflevector <16 x i32> [[TMP101]], <16 x i32> [[TMP102]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 18, i32 19>
; CHECK-NEXT:    [[TMP104:%.*]] = insertelement <16 x i32> poison, i32 [[CHAIN_T856_3322]], i32 0
; CHECK-NEXT:    [[TMP105:%.*]] = insertelement <16 x i32> [[TMP104]], i32 [[TMP25]], i32 1
; CHECK-NEXT:    [[TMP106:%.*]] = insertelement <16 x i32> [[TMP105]], i32 [[CHAIN_T829_3169]], i32 2
; CHECK-NEXT:    [[TMP107:%.*]] = insertelement <16 x i32> [[TMP106]], i32 [[TMP30]], i32 3
; CHECK-NEXT:    [[TMP108:%.*]] = insertelement <16 x i32> [[TMP107]], i32 [[CHAIN_T802_2928]], i32 4
; CHECK-NEXT:    [[TMP109:%.*]] = insertelement <16 x i32> [[TMP108]], i32 [[CHAIN_T775_2764]], i32 5
; CHECK-NEXT:    [[TMP110:%.*]] = insertelement <16 x i32> [[TMP109]], i32 [[TMP62]], i32 6
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <16 x i32> [[TMP110]], <16 x i32> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2, i32 4, i32 4, i32 4, i32 4, i32 5, i32 5, i32 6, i32 5>
; CHECK-NEXT:    [[TMP111:%.*]] = add <16 x i32> [[TMP103]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP112:%.*]] = sub <16 x i32> [[TMP103]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP113:%.*]] = shufflevector <16 x i32> [[TMP111]], <16 x i32> [[TMP112]], <16 x i32> <i32 0, i32 1, i32 18, i32 3, i32 4, i32 5, i32 22, i32 7, i32 8, i32 25, i32 26, i32 27, i32 12, i32 13, i32 30, i32 15>
; CHECK-NEXT:    [[TMP114:%.*]] = add <16 x i32> [[TMP113]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP115:%.*]] = sub <16 x i32> [[TMP113]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP116:%.*]] = shufflevector <16 x i32> [[TMP114]], <16 x i32> [[TMP115]], <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 24, i32 9, i32 26, i32 11, i32 12, i32 29, i32 14, i32 31>
; CHECK-NEXT:    [[TMP117:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> [[TMP116]], <16 x i32>* [[TMP117]], align 4

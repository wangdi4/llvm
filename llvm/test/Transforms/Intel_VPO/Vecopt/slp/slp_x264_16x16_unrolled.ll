...
; CHECK-NEXT:    [[LOAD:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1209]], align 1
; CHECK-NEXT:    [[TMP48:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1211]], align 1
; CHECK-NEXT:    [[TMP49:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1213]], align 1
; CHECK-NEXT:    [[TMP50:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1215]], align 1
; CHECK-NEXT:    [[TMP51:%.*]] = zext <2 x i8> [[LOAD]] to <2 x i32>
; CHECK-NEXT:    [[TMP52:%.*]] = zext <2 x i8> [[TMP49]] to <2 x i32>
; CHECK-NEXT:    [[TMP53:%.*]] = zext <2 x i8> [[TMP50]] to <2 x i32>
; CHECK-NEXT:    [[TMP54:%.*]] = zext <2 x i8> [[TMP48]] to <2 x i32>
; CHECK-NEXT:    [[TMP55:%.*]] = shl nsw <2 x i32> [[TMP52]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP56:%.*]] = shl nsw <2 x i32> [[TMP53]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP57:%.*]] = sub <2 x i32> [[TMP54]], [[TMP51]]
; CHECK-NEXT:    [[TMP58:%.*]] = sub <2 x i32> [[TMP57]], [[TMP55]]
; CHECK-NEXT:    [[TMP59:%.*]] = add <2 x i32> [[TMP58]], [[TMP56]]
; CHECK-NEXT:    [[TMP60:%.*]] = extractelement <2 x i32> [[TMP59]], i32 0
; CHECK-NEXT:    [[TMP61:%.*]] = extractelement <2 x i32> [[TMP59]], i32 1
; CHECK-NEXT:    [[BRIDGE_T797_2968:%.*]] = sub nsw i32 [[TMP61]], [[TMP60]]
...
; CHECK-NEXT:    [[TMP62:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1313]], align 1
; CHECK-NEXT:    [[TMP63:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1315]], align 1
; CHECK-NEXT:    [[TMP64:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1317]], align 1
; CHECK-NEXT:    [[TMP65:%.*]] = load <2 x i8>, ptr [[ARRAYIDX1319]], align 1
; CHECK-NEXT:    [[TMP66:%.*]] = zext <2 x i8> [[TMP62]] to <2 x i32>
; CHECK-NEXT:    [[TMP67:%.*]] = zext <2 x i8> [[TMP64]] to <2 x i32>
; CHECK-NEXT:    [[TMP68:%.*]] = zext <2 x i8> [[TMP65]] to <2 x i32>
; CHECK-NEXT:    [[TMP69:%.*]] = zext <2 x i8> [[TMP63]] to <2 x i32>
; CHECK-NEXT:    [[TMP70:%.*]] = shl nsw <2 x i32> [[TMP67]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP71:%.*]] = shl nsw <2 x i32> [[TMP68]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP72:%.*]] = sub <2 x i32> [[TMP66]], [[TMP69]]
; CHECK-NEXT:    [[TMP73:%.*]] = sub <2 x i32> [[TMP72]], [[TMP71]]
; CHECK-NEXT:    [[TMP74:%.*]] = add <2 x i32> [[TMP73]], [[TMP70]]
; CHECK-NEXT:    [[TMP75:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
; CHECK-NEXT:    [[TMP76:%.*]] = shufflevector <2 x i32> [[TMP47]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP77:%.*]] = shufflevector <2 x i32> [[TMP59]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP78:%.*]] = shufflevector <8 x i32> [[TMP76]], <8 x i32> [[TMP77]], <8 x i32> <i32 0, i32 1, i32 9, i32 8, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP79:%.*]] = shufflevector <4 x i32> [[TMP75]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP80:%.*]] = shufflevector <2 x i32> [[TMP74]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP81:%.*]] = shufflevector <8 x i32> [[TMP78]], <8 x i32> [[TMP80]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 9, i32 8, i32 undef, i32 9>
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <8 x i32> [[TMP81]], i32 [[CHAIN_T775_2764]], i32 6
; CHECK-NEXT:    [[TMP83:%.*]] = shufflevector <2 x i32> [[TMP37]], <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP84:%.*]] = shufflevector <8 x i32> [[TMP83]], <8 x i32> [[TMP77]], <8 x i32> <i32 0, i32 1, i32 8, i32 9, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP85:%.*]] = shufflevector <8 x i32> [[TMP84]], <8 x i32> [[TMP79]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
; CHECK-NEXT:    [[TMP86:%.*]] = add nsw <8 x i32> [[TMP82]], [[TMP85]]
; CHECK-NEXT:    [[TMP87:%.*]] = sub nsw <8 x i32> [[TMP82]], [[TMP85]]
; CHECK-NEXT:    [[TMP88:%.*]] = shufflevector <8 x i32> [[TMP86]], <8 x i32> [[TMP87]], <8 x i32> <i32 0, i32 1, i32 2, i32 11, i32 4, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP89:%.*]] = shufflevector <8 x i32> [[TMP88]], <8 x i32> poison, <8 x i32> <i32 2, i32 0, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP90:%.*]] = insertelement <8 x i32> [[TMP89]], i32 [[CHAIN_T775_2764]], i32 2
; CHECK-NEXT:    [[TMP91:%.*]] = shufflevector <8 x i32> [[TMP90]], <8 x i32> [[TMP80]], <8 x i32> <i32 0, i32 1, i32 2, i32 9, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP92:%.*]] = shufflevector <8 x i32> [[TMP91]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 2, i32 2, i32 3, i32 2>
; CHECK-NEXT:    [[TMP93:%.*]] = add <8 x i32> [[TMP88]], [[TMP92]]
; CHECK-NEXT:    [[TMP94:%.*]] = sub <8 x i32> [[TMP88]], [[TMP92]]
; CHECK-NEXT:    [[TMP95:%.*]] = shufflevector <8 x i32> [[TMP93]], <8 x i32> [[TMP94]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 5, i32 14, i32 7>
; CHECK-NEXT:    [[TMP96:%.*]] = shufflevector <8 x i32> [[TMP88]], <8 x i32> poison, <8 x i32> <i32 1, i32 undef, i32 1, i32 1, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <8 x i32> [[TMP96]], i32 [[BRIDGE_T797_2968]], i32 1
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <4 x i32> poison, i32 [[CHAIN_T775_2771]], i32 0
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <4 x i32> [[TMP98]], <4 x i32> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP100:%.*]] = shufflevector <4 x i32> [[TMP99]], <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP101:%.*]] = shufflevector <8 x i32> [[TMP97]], <8 x i32> [[TMP100]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
; CHECK-NEXT:    [[TMP102:%.*]] = sub <8 x i32> [[TMP95]], [[TMP101]]
; CHECK-NEXT:    [[TMP103:%.*]] = add <8 x i32> [[TMP95]], [[TMP101]]
; CHECK-NEXT:    [[TMP104:%.*]] = shufflevector <8 x i32> [[TMP102]], <8 x i32> [[TMP103]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 12, i32 5, i32 14, i32 7>
; CHECK-NEXT:    store <8 x i32> [[TMP104]], ptr [[ARRAYIDX1226]], align 4

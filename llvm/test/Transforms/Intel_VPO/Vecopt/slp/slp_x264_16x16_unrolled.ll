...
; CHECK-NEXT:    [[TMP36:%.*]] = add nsw <8 x i32> [[SHUFFLE3]], [[SHUFFLE4]]
; CHECK-NEXT:    [[TMP37:%.*]] = sub nsw <8 x i32> [[SHUFFLE3]], [[SHUFFLE4]]
...
; CHECK-NEXT:    [[TMP43:%.*]] = add nsw <2 x i32> [[TMP40]], [[TMP42]]
; CHECK-NEXT:    [[TMP44:%.*]] = sub nsw <2 x i32> [[TMP40]], [[TMP42]]
...
; CHECK-NEXT:    [[TMP80:%.*]] = sub nsw <4 x i32> [[TMP78]], [[TMP77]]
; CHECK-NEXT:    [[TMP81:%.*]] = sub nsw <4 x i32> [[TMP80]], [[TMP79]]
; CHECK-NEXT:    [[TMP82:%.*]] = add nsw <4 x i32> [[TMP81]], [[TMP59]]
...
; CHECK-NEXT:    [[TMP85:%.*]] = sub nsw <2 x i32> [[TMP83]], [[TMP72]]
; CHECK-NEXT:    [[TMP86:%.*]] = sub nsw <2 x i32> [[TMP85]], [[TMP84]]
; CHECK-NEXT:    [[TMP87:%.*]] = add nsw <2 x i32> [[TMP86]], [[TMP54]]
...
; CHECK-NEXT:    [[TMP95:%.*]] = add nsw <4 x i32> [[TMP93]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP96:%.*]] = sub nsw <4 x i32> [[TMP93]], [[SHUFFLE2]]
...
; CHECK-NEXT:    [[TMP113:%.*]] = add nsw <16 x i32> [[TMP105]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP114:%.*]] = sub nsw <16 x i32> [[TMP105]], [[SHUFFLE]]
...
; CHECK-NEXT:    [[TMP116:%.*]] = add nsw <16 x i32> [[TMP115]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP117:%.*]] = sub nsw <16 x i32> [[TMP115]], [[SHUFFLE1]]

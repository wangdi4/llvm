...
; CHECK: [[L1:%.*]] = load <4 x i8>, ptr
; CHECK: [[L2:%.*]] = load <4 x i8>, ptr
; CHECK: [[L3:%.*]] = load <4 x i8>, ptr
; CHECK: [[L4:%.*]] = load <4 x i8>, ptr
; CHECK: [[L5:%.*]] = load <4 x i8>, ptr
; CHECK: [[L6:%.*]] = load <4 x i8>, ptr
; CHECK: [[L7:%.*]] = load <4 x i8>, ptr
; CHECK: [[L8:%.*]] = load <4 x i8>, ptr

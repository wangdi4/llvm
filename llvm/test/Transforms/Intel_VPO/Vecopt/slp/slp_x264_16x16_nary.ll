...
; RUN: opt < %s -passes=slp-vectorizer -enable-intel-advanced-opts -slp-multinode -mtriple=x86_64 -mcpu=skylake-avx512 -enable-path-steering=true -S | FileCheck %s -check-prefix=8WIDE_PATH_STEERING
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE5:%.*]] = shufflevector <4 x i8> [[TMP1]], <4 x i8> [[TMP3]], <8 x i32> <i32 0, i32 2, i32 3, i32 1, i32 6, i32 7, i32 5, i32 4>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE3:%.*]] = shufflevector <4 x i8> [[TMP5]], <4 x i8> [[TMP7]], <8 x i32> <i32 0, i32 2, i32 3, i32 1, i32 6, i32 7, i32 5, i32 4>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE:%.*]] = shufflevector <4 x i8> [[TMP9]], <4 x i8> [[TMP11]], <8 x i32> <i32 0, i32 2, i32 3, i32 1, i32 6, i32 7, i32 5, i32 4>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE4:%.*]] = shufflevector <4 x i8> [[TMP13]], <4 x i8> [[TMP15]], <8 x i32> <i32 0, i32 2, i32 3, i32 1, i32 6, i32 7, i32 5, i32 4>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP16:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE5]] to <8 x i32>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP17:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE4]] to <8 x i32>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP18:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE3]] to <8 x i32>
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 2, i32 0, i32 7, i32 5, i32 undef, i32 undef, i32 undef, i32 undef>
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i32> [[TMP25]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 3>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP26:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 3, i32 2, i32 6, i32 5, i32 undef, i32 undef, i32 undef, i32 undef>
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <8 x i32> [[TMP26]], <8 x i32> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 1, i32 2, i32 2, i32 3, i32 2>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP27:%.*]] = add <8 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP28:%.*]] = sub <8 x i32> [[SHUFFLE]], [[SHUFFLE1]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP29:%.*]] = shufflevector <8 x i32> [[TMP27]], <8 x i32> [[TMP28]], <8 x i32> <i32 0, i32 9, i32 2, i32 3, i32 4, i32 13, i32 14, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP30:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 1, i32 2, i32 5, i32 4, i32 undef, i32 undef, i32 undef, i32 undef>
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <8 x i32> [[TMP30]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 2, i32 3, i32 3, i32 3>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP31:%.*]] = add <8 x i32> [[TMP29]], [[SHUFFLE2]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP32:%.*]] = sub <8 x i32> [[TMP29]], [[SHUFFLE2]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP33:%.*]] = shufflevector <8 x i32> [[TMP31]], <8 x i32> [[TMP32]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 5, i32 14, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP34:%.*]] = add <8 x i32> [[TMP33]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP35:%.*]] = sub <8 x i32> [[TMP33]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP36:%.*]] = shufflevector <8 x i32> [[TMP34]], <8 x i32> [[TMP35]], <8 x i32> <i32 0, i32 1, i32 10, i32 11, i32 4, i32 13, i32 6, i32 7>

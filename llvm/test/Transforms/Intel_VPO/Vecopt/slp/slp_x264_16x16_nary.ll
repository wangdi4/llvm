...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP29:%.*]] = extractelement <8 x i32> [[TMP24]], i32 3
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP33:%.*]] = extractelement <8 x i32> [[TMP24]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP34:%.*]] = insertelement <8 x i32> [[TMP32]], i32 [[TMP33]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP35:%.*]] = extractelement <8 x i32> [[TMP24]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP36:%.*]] = insertelement <8 x i32> [[TMP34]], i32 [[TMP35]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i32> [[TMP36]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 1, i32 3, i32 4, i32 5, i32 4>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP37:%.*]] = add <8 x i32> [[TMP24]], [[SHUFFLE]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP38:%.*]] = sub <8 x i32> [[TMP24]], [[SHUFFLE]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP39:%.*]] = shufflevector <8 x i32> [[TMP37]], <8 x i32> [[TMP38]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP40:%.*]] = insertelement <8 x i32> poison, i32 [[TMP29]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP41:%.*]] = insertelement <8 x i32> [[TMP40]], i32 [[TMP25]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP42:%.*]] = extractelement <8 x i32> [[TMP24]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP43:%.*]] = insertelement <8 x i32> [[TMP41]], i32 [[TMP42]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP44:%.*]] = insertelement <8 x i32> [[TMP43]], i32 [[TMP35]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[TMP45:%.*]] = insertelement <8 x i32> [[TMP44]], i32 [[TMP31]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP46:%.*]] = extractelement <8 x i32> [[TMP24]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP47:%.*]] = insertelement <8 x i32> [[TMP45]], i32 [[TMP46]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE8:%.*]] = shufflevector <8 x i32> [[TMP47]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 2, i32 3, i32 4, i32 5, i32 5>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP48:%.*]] = add <8 x i32> [[TMP39]], [[SHUFFLE8]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP49:%.*]] = sub <8 x i32> [[TMP39]], [[SHUFFLE8]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP50:%.*]] = shufflevector <8 x i32> [[TMP48]], <8 x i32> [[TMP49]], <8 x i32> <i32 0, i32 1, i32 10, i32 11, i32 4, i32 5, i32 14, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP51:%.*]] = insertelement <8 x i32> poison, i32 [[TMP42]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP52:%.*]] = insertelement <8 x i32> [[TMP51]], i32 [[TMP29]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP53:%.*]] = insertelement <8 x i32> [[TMP52]], i32 [[TMP27]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP54:%.*]] = insertelement <8 x i32> [[TMP53]], i32 [[TMP25]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[TMP55:%.*]] = insertelement <8 x i32> [[TMP54]], i32 [[TMP46]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP56:%.*]] = insertelement <8 x i32> [[TMP55]], i32 [[TMP35]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP57:%.*]] = insertelement <8 x i32> [[TMP56]], i32 [[TMP33]], i32 6
; 8WIDE_PATH_STEERING-NEXT:    [[TMP58:%.*]] = insertelement <8 x i32> [[TMP57]], i32 [[TMP31]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP59:%.*]] = add <8 x i32> [[TMP50]], [[TMP58]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP60:%.*]] = sub <8 x i32> [[TMP50]], [[TMP58]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP61:%.*]] = shufflevector <8 x i32> [[TMP59]], <8 x i32> [[TMP60]], <8 x i32> <i32 0, i32 9, i32 2, i32 3, i32 4, i32 13, i32 6, i32 7>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP62:%.*]] = bitcast i32* [[ARRAYIDX1043]] to <8 x i32>*
; 8WIDE_PATH_STEERING-NEXT:    store <8 x i32> [[TMP61]], <8 x i32>* [[TMP62]], align 4

...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE3:%.*]] = shufflevector <4 x i8> [[TMP1]], <4 x i8> [[TMP3]], <8 x i32> <i32 1, i32 2, i32 0, i32 3, i32 5, i32 6, i32 4, i32 7>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE1:%.*]] = shufflevector <4 x i8> [[TMP5]], <4 x i8> [[TMP7]], <8 x i32> <i32 1, i32 2, i32 0, i32 3, i32 5, i32 6, i32 4, i32 7>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE2:%.*]] = shufflevector <4 x i8> [[TMP13]], <4 x i8> [[TMP15]], <8 x i32> <i32 1, i32 2, i32 0, i32 3, i32 5, i32 6, i32 4, i32 7>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP16:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE3]] to <8 x i32>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP17:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE2]] to <8 x i32>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP18:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE1]] to <8 x i32>
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 2, i32 0, i32 3, i32 undef, i32 6, i32 4, i32 7, i32 undef>
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i32> [[TMP25]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 1, i32 4, i32 5, i32 6, i32 5>
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP29:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 3, i32 2, i32 1, i32 undef, i32 7, i32 6, i32 5, i32 undef>
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE4:%.*]] = shufflevector <8 x i32> [[TMP29]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 2, i32 4, i32 5, i32 6, i32 6>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP30:%.*]] = add <8 x i32> [[TMP28]], [[SHUFFLE4]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP31:%.*]] = sub <8 x i32> [[TMP28]], [[SHUFFLE4]]

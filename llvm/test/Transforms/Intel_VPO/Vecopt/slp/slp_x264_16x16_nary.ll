...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 2, i32 3, i32 1, i32 6, i32 7, i32 5, i32 undef, i32 undef>
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i32> [[TMP25]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 2, i32 3, i32 4, i32 4, i32 5>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP26:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 3, i32 2, i32 1, i32 7, i32 6, i32 5, i32 undef, i32 undef>
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE5:%.*]] = shufflevector <8 x i32> [[TMP26]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 1, i32 3, i32 4, i32 5, i32 4>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP27:%.*]] = add <8 x i32> [[SHUFFLE]], [[SHUFFLE5]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP28:%.*]] = sub <8 x i32> [[SHUFFLE]], [[SHUFFLE5]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP29:%.*]] = shufflevector <8 x i32> [[TMP27]], <8 x i32> [[TMP28]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP30:%.*]] = shufflevector <8 x i32> [[TMP24]], <8 x i32> poison, <8 x i32> <i32 1, i32 0, i32 5, i32 4, i32 undef, i32 undef, i32 undef, i32 undef>
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE6:%.*]] = shufflevector <8 x i32> [[TMP30]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 1, i32 1, i32 2, i32 3, i32 3, i32 3>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP31:%.*]] = add <8 x i32> [[TMP29]], [[SHUFFLE6]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP32:%.*]] = sub <8 x i32> [[TMP29]], [[SHUFFLE6]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP33:%.*]] = shufflevector <8 x i32> [[TMP31]], <8 x i32> [[TMP32]], <8 x i32> <i32 0, i32 1, i32 10, i32 11, i32 4, i32 5, i32 14, i32 15>

...
; FORCE-VECT-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i8> [[TMP11]], <8 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 1, i32 6, i32 7>
; FORCE-VECT-NEXT:    [[TMP12:%.*]] = shufflevector <2 x i8> [[TMP0]], <2 x i8> [[TMP2]], <8 x i32> <i32 1, i32 undef, i32 undef, i32 2, i32 undef, i32 3, i32 undef, i32 undef>
...
; FORCE-VECT-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <8 x i8> [[TMP15]], <8 x i8> poison, <8 x i32> <i32 0, i32 0, i32 2, i32 3, i32 4, i32 5, i32 3, i32 7>

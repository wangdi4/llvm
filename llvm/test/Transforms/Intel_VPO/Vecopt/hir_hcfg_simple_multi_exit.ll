...
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -VPlanDriverHIR -vplan-print-after-initial-transforms -disable-output -vplan-force-vf=2 < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,vplan-driver-hir" -vplan-print-after-initial-transforms -disable-output -vplan-force-vf=2 < %s 2>&1 | FileCheck %s

; RUN: opt %s -passes=hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,hir-cg -vector-library=SVML -vplan-enable-masked-vectorized-remainder=0 -vplan-force-vf=4 -S | FileCheck %s

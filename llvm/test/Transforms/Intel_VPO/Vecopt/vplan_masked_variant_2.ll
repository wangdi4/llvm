...
; CHECK-NEXT:     [DA: Uni] i32 [[VP8:%.*]] = phi  [ i32 0, Cloned.[[BB1]] ],  [ i32 [[VP9:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_IV:%.*]] = phi  [ i32 [[VP1]], Cloned.[[BB1]] ],  [ i32 [[VP10:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_ADD_PHI:%.*]] = phi  [ i32 [[VP0]], Cloned.[[BB1]] ],  [ i32 [[VP11:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Div] i32 [[VP_ADD_PHI_2:%.*]] = phi  [ i32 [[VP3]], Cloned.[[BB1]] ],  [ i32 [[VP12:%.*]], new_latch ]
; CHECK-NEXT:     [DA: Uni] i1 [[VP13:%.*]] = icmp uge i32 [[VP8]] i32 [[VP7]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP13]], [[BB3:BB[0-9]+]], new_latch
; CHECK-EMPTY:
...
; CHECK-NEXT:     [DA: Div] i32 [[VP10]] = phi  [ i32 [[VP_IV_NEXT]], Cloned.[[BB4]] ],  [ i32 [[VP_IV]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Div] i32 [[VP11]] = phi  [ i32 [[VP_ADD]], Cloned.[[BB4]] ],  [ i32 [[VP_ADD_PHI]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Div] i32 [[VP12]] = phi  [ i32 [[VP_ADD_2]], Cloned.[[BB4]] ],  [ i32 [[VP_ADD_PHI_2]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Uni] i32 [[VP9]] = add i32 [[VP8]] i32 [[VP5]]
; CHECK-NEXT:     [DA: Uni] i1 [[VP14:%.*]] = icmp uge i32 [[VP9]] i32 [[VP7]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP14]], Cloned.[[BB5:BB[0-9]+]], Cloned.[[BB2]]
; CHECK-EMPTY:

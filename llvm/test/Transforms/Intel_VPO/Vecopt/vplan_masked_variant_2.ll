...
; CHECK-NEXT:     [DA: Div] i32 [[VP_ADD_PHI_2:%.*]] = phi  [ i32 [[VP3]], Cloned.[[BB1]] ],  [ i32 [[VP_ADD_2:%.*]], new_latch ]
...
; CHECK-NEXT:     [DA: Div] i32 [[VP11:%.*]] = phi  [ i32 [[VP_IV_NEXT]], Cloned.[[BB4]] ],  [ i32 [[VP_IV]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Div] i32 [[VP12:%.*]] = phi  [ i32 [[VP_ADD]], Cloned.[[BB4]] ],  [ i32 [[VP_ADD_PHI]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Div] i32 [[VP13:%.*]] = phi  [ i32 [[VP_ADD_2]], Cloned.[[BB4]] ],  [ i32 [[VP_ADD_PHI_2]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Uni] i32 [[VP14:%.*]] = phi  [ i32 [[VP9]], Cloned.[[BB4]] ],  [ i32 [[VP8]], Cloned.[[BB2]] ]
; CHECK-NEXT:     [DA: Uni] i32 [[VP9]] = add i32 [[VP8]] i32 [[VP5]]
; CHECK-NEXT:     [DA: Uni] i1 [[VP15:%.*]] = icmp uge i32 [[VP9]] i32 [[VP7]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP15]], Cloned.[[BB5:BB[0-9]+]], Cloned.[[BB2]]
; CHECK-EMPTY:

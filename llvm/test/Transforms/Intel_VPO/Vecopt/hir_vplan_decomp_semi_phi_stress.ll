; A stress test to check correctness of semi-phi optimizations and placement generated by VPlan HIR decomposer.
...
; CHECK: i32 [[PHI:%vp.*]] = semi-phi i32 [[IFT:%vp.*]] i32 [[IFF:%vp.*]]

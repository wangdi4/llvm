...
; RUN: opt -mtriple=x86_64 -mcpu=skylake-avx512 -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>" -disable-output  < %s 2>&1 | FileCheck %s
...
;   FIXME -- <8 x double> type have to be passed/returned in two parts for AVX2.
; CHECK-NEXT:        [[DOTVEC0:%.*]] = (<8 x double>*)([[VEC_X0:%.*]])[0]
; CHECK-NEXT:        [[_ZGVYN8V_ORIGIN0:%.*]] = @_ZGVYN8v_Origin([[DOTVEC0]])
; CHECK-NEXT:        (<8 x double>*)([[VEC_RETVAL0:%.*]])[0] = [[_ZGVYN8V_ORIGIN0]]

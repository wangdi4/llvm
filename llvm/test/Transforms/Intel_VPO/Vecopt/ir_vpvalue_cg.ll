...
; RUN: opt -VPlanDriver -enable-vp-value-codegen -vplan-force-vf=16 -S < %s 2>&1 | FileCheck %s
...
; CHECK-NEXT:    [[MM_VECTORGEP:%.*]] = getelementptr inbounds [1024 x i32], <16 x [1024 x i32]*> <[1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a, [1024 x i32]* @a>, <16 x i64> zeroinitializer, <16 x i64> [[VEC_IND]]
...
; CHECK-NEXT:    [[MM_VECTORGEP1:%.*]] = getelementptr inbounds [1024 x i32], <16 x [1024 x i32]*> <[1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b, [1024 x i32]* @b>, <16 x i64> zeroinitializer, <16 x i64> [[VEC_IND]]
...
; CHECK-NEXT:    [[TMP17:%.*]] = add nuw nsw <16 x i64> [[VEC_IND]], <i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1, i64 1>
; CHECK-NEXT:    [[TMP18:%.*]] = icmp slt <16 x i64> [[TMP17]], [[BROADCAST_SPLAT]]
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <16 x i1> [[TMP18]], i32 0
; CHECK-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 16
; CHECK-NEXT:    [[TMP20:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC:%.*]]
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add <16 x i64> [[VEC_IND]], <i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16, i64 16>
; CHECK-NEXT:    br i1 [[TMP20]], label [[VPLANNEDBB:%.*]], label [[VECTOR_BODY]]

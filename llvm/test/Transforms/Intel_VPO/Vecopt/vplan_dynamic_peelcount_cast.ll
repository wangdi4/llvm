...
define dso_local void @foo(i32 %n, i32 %x, i32* nocapture %A, i32* nocapture readonly %B) local_unnamed_addr #0 {
entry:
...
omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.125, %omp.inner.for.body
  ...
  %arrayidx7 = getelementptr inbounds i32, i32* %A, i32 %indvars.iv

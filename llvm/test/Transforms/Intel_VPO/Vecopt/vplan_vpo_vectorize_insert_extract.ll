...
; CHECK-VF2: [[wideInsert:%.*]] = shufflevector <2 x i32> [[VAR:%.*]], <2 x i32> undef, <4 x i32> <i32 0, i32 poison, i32 1, i32 poison>
; CHECK-VF2-NEXT: [[extendedSubVec:%.*]] = shufflevector <2 x i32> [[VAR1:%.*]], <2 x i32> undef, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
...
; CHECK-VF8: [[wideInsert:%.*]] = shufflevector <8 x i32> [[VAR:%.*]], <8 x i32> undef, <16 x i32> <i32 0, i32 poison, i32 1, i32 poison, i32 2, i32 poison, i32 3, i32 poison, i32 4, i32 poison, i32 5, i32 poison, i32 6, i32 poison, i32 7, i32 poison> 
; CHECK-VF8-NEXT: [[extendedSubVec:%.*]] = shufflevector <8 x i32> [[VAR1:%.*]], <8 x i32> undef,  <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison> 

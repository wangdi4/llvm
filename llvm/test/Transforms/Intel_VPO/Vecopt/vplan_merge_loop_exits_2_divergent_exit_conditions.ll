...
; The exit condition of loop2 (BB7 in checks) is divergent and the exit condition
...
; CHECK-NEXT:     i32 [[VP_J_INC:%.*]] = add i32 [[VP_J]] i32 [[VP_I]]
...
; CHECK-NEXT:     <Empty Block>
; CHECK-NEXT:     Condition([[BB5]]): [DA: Divergent] i1 [[VP_CMP2]] = icmp i32 [[VP_J_INC]] i32 16

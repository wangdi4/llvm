...
; tracker peel/remainder loops generated by LLVM-IR vectorizer.

; RUN: opt -vplan-vec -vplan-vec-scenario="n0;v4;v2s1" -intel-loop-optreport=high -intel-ir-optreport-emitter < %s -disable-output 2>&1 | FileCheck %s --strict-whitespace
...
; CHECK-NEXT:     remark #15558: Call to function 'serial_call' was serialized due to no suitable vector variants were found.

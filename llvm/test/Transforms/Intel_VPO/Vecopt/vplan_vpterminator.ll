...
; RUN: opt -opaque-pointers=0 -disable-output < %s -passes=vplan-vec,loop-simplify --vplan-force-vf=4 --vplan-print-after-init - | FileCheck %s
...
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i32 [[VP0:%.*]] = load i32* [[VP_ARRAYIDX]] (SVAOpBits 0->F )

...
; CHECK-NEXT:    [[I32:%.*]] = shl nuw nsw i32 [[I20]], 16
; CHECK-NEXT:    [[I33:%.*]] = shl nuw nsw i32 [[I21]], 16
; CHECK-NEXT:    [[I34:%.*]] = shl nuw nsw i32 [[I22]], 16
; CHECK-NEXT:    [[I35:%.*]] = shl nuw nsw i32 [[I23]], 16
; CHECK-NEXT:    [[I36:%.*]] = shl nuw nsw i32 [[I28]], 16
; CHECK-NEXT:    [[I37:%.*]] = shl nuw nsw i32 [[I29]], 16
; CHECK-NEXT:    [[I38:%.*]] = shl nuw nsw i32 [[I30]], 16
; CHECK-NEXT:    [[I39:%.*]] = shl nuw nsw i32 [[I31]], 16
; CHECK-NEXT:    [[TMP0:%.*]] = or i32 [[I32]], [[I24]]
; CHECK-NEXT:    [[N2:%.*]] = sub nsw i32 [[I36]], [[TMP0]]
; CHECK-NEXT:    [[N3:%.*]] = add nsw i32 [[N2]], [[I16]]
; CHECK-NEXT:    [[TMP1:%.*]] = or i32 [[I33]], [[I25]]
; CHECK-NEXT:    [[N5:%.*]] = sub nsw i32 [[I37]], [[TMP1]]
; CHECK-NEXT:    [[N6:%.*]] = add nsw i32 [[N5]], [[I17]]
; CHECK-NEXT:    [[TMP2:%.*]] = or i32 [[I34]], [[I26]]
; CHECK-NEXT:    [[N8:%.*]] = sub nsw i32 [[I38]], [[TMP2]]
; CHECK-NEXT:    [[N9:%.*]] = add nsw i32 [[N8]], [[I18]]
; CHECK-NEXT:    [[TMP3:%.*]] = or i32 [[I35]], [[I27]]
; CHECK-NEXT:    [[N11:%.*]] = sub nsw i32 [[I39]], [[TMP3]]
; CHECK-NEXT:    [[N12:%.*]] = add nsw i32 [[N11]], [[I19]]
; CHECK-NEXT:    [[GEP043:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[R:%.*]], i64 0, i64 [[I1_I64_0]], i64 0
; CHECK-NEXT:    [[N151:%.*]] = add nsw i32 [[N12]], [[N9]]
; CHECK-NEXT:    [[N159:%.*]] = add nsw i32 [[N151]], [[N6]]
; CHECK-NEXT:    [[N167:%.*]] = add i32 [[N159]], [[N3]]
; CHECK-NEXT:    store i32 [[N167]], i32* [[GEP043]], align 4
; CHECK-NEXT:    [[GEP045:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[R]], i64 0, i64 [[I1_I64_0]], i64 2
; CHECK-NEXT:    [[N156:%.*]] = add nsw i32 [[N12]], [[N9]]
; CHECK-NEXT:    [[TMP4:%.*]] = add nsw i32 [[N6]], [[N3]]
; CHECK-NEXT:    [[N172:%.*]] = sub nsw i32 [[N156]], [[TMP4]]
; CHECK-NEXT:    store i32 [[N172]], i32* [[GEP045]], align 4
; CHECK-NEXT:    [[GEP063:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[R]], i64 0, i64 [[I1_I64_0]], i64 1
; CHECK-NEXT:    [[TMP5:%.*]] = add nsw i32 [[N12]], [[N6]]
; CHECK-NEXT:    [[TMP6:%.*]] = add nsw i32 [[N9]], [[N3]]
; CHECK-NEXT:    [[N173:%.*]] = sub nsw i32 [[TMP5]], [[TMP6]]
; CHECK-NEXT:    store i32 [[N173]], i32* [[GEP063]], align 4
; CHECK-NEXT:    [[GEP081:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[R]], i64 0, i64 [[I1_I64_0]], i64 3
; CHECK-NEXT:    [[TMP7:%.*]] = add nsw i32 [[N9]], [[N6]]
; CHECK-NEXT:    [[N166:%.*]] = sub nsw i32 [[N12]], [[TMP7]]
; CHECK-NEXT:    [[N174:%.*]] = add i32 [[N166]], [[N3]]
; CHECK-NEXT:    store i32 [[N174]], i32* [[GEP081]], align 4

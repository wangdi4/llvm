...
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,print<hir>" -vplan-force-vf=4 -vplan-force-uf=3 -vplan-enable-partial-sums=false \
; RUN:  -vplan-print-after-unroll -disable-output < %s 2>&1 | FileCheck %s --check-prefixes=CHECK,VPVALCG

...
; RUN: opt -S < %s -hir-ssa-deconstruction -hir-temp-cleanup -hir-vplan-vec -vplan-force-vf=4 -vplan-force-uf=3 -vplan-print-after-unroll -print-after=hir-vplan-vec -disable-output 2>&1 | FileCheck %s --check-prefixes=CHECK,VPVALCG,PM1
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec" -S < %s -vplan-force-vf=4 -vplan-force-uf=3 -vplan-print-after-unroll -print-after=hir-vplan-vec -disable-output 2>&1 | FileCheck %s --check-prefixes=CHECK,VPVALCG,PM2
...
; CHECK-EMPTY:
; PM1:         *** IR Dump After VPlan HIR Vectorizer (hir-vplan-vec) ***
...
; VPVALCG-NEXT:                 {
; VPVALCG-NEXT:                    [[RED_VAR0:%.*]] = 0
; VPVALCG-NEXT:                    [[RED_VAR0]] = insertelement [[RED_VAR0]],  [[ACC_0190]],  0

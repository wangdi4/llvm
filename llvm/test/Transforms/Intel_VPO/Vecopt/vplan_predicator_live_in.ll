...
; RUN: opt %s -VPlanDriver -enable-new-vplan-predicator=false -disable-uniform-regions -vplan-predicator-report -disable-vplan-codegen -disable-vplan-subregions=0 -disable-vplan-loop-regions=0 -disable-predicator-opts -S -o /dev/null | FileCheck %s -check-prefix=NOOPT
; RUN: opt %s -VPlanDriver -enable-new-vplan-predicator=false -disable-uniform-regions -vplan-predicator-report -disable-vplan-codegen -disable-vplan-subregions=0 -disable-vplan-loop-regions=0 -S -o /dev/null | FileCheck %s -check-prefix=OPT

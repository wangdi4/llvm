...
; CHECK-NEXT:       float [[VP10:%.*]] = phi  [ float [[VP5]], [[BB0]] ]
...
; CHECK-NEXT:       float [[VP6]] = fadd float [[VP10]] float [[VP11]]
; CHECK-NEXT:       br [[BB3]]
; CHECK-EMPTY:
...
; CHECK-NEXT:     i1 [[VP12:%.*]] = icmp sle i64 [[VP7]] i64 [[VP1:%.*]]
...
; CHECK-NEXT:  float [[VP__RED_FINAL]] -> [[VP13:%.*]] = {%tsum.015}
;
entry:

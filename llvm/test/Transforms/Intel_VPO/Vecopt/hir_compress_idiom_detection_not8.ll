...
; CHECK:      [Compress/Expand Idiom] Increment {sb:3}+1 detected: <17>         %j.017 = %j.017  +  1;
; CHECK-NEXT: [Compress/Expand Idiom] Non-linear BlobRef found: %2
; CHECK-NEXT: [Compress/Expand Idiom] Increment rejected: <17>         %j.017 = %j.017  +  1;
...
for.inc:                                          ; preds = %for.body, %if.then
  %j.1 = phi i32 [ %inc, %if.then ], [ %j.017, %for.body ]

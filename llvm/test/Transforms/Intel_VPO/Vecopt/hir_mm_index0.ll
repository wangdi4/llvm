...
;CGCHECK-NEXT:          %[[idxblend:.*]] = (%[[best023]] == %.[[vec5]]) ? %.[[vec4:.*]] : <i32 2147483647, i32 2147483647, i32 2147483647, i32 2147483647>;
;CGCHECK-NEXT:          %[[tmp024:.*]] = @llvm.vector.reduce.smin.v4i32(%[[idxblend]]);
;CGCHECK:            }

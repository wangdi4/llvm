...
entry:
  ...
  store i32 0, i32* %i1.linear, align 4
  br label %preheader

preheader:                                 ; preds = %DIR.OMP.SIMD.1
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.LINEAR:TYPED"(i32* %i1.linear, i32 0, i32 1, i32 1) ]
  br label %for.body

for.body:                               ; preds = %preheader, %for.body
  %.omp.iv.local.011 = phi i64 [ 0, %preheader ], [ %add2, %for.body ]
  %1 = load i32, i32* %i1.linear, align 4
  %add1 = add nsw i32 %1, 1
  store i32 %add1, i32* %i1.linear, align 4

...
; CHECK-NEXT:  <71>                  [[VEC_REDUCE0:%.*]] = @llvm.experimental.vector.reduce.v2.fadd.f32.v4f32([[RED_PHI0]],  [[RED_VAR0]])
...
; MIXED-NEXT:  <73>                  [[VEC_REDUCE0:%.*]] = @llvm.experimental.vector.reduce.v2.fadd.f32.v4f32([[RED_PHI0:%.*]],  [[RED_VAR0]])

...
; CHECK-NEXT:     ptr [[VP__IND_INIT:%.*]] = induction-init{getelementptr} ptr live-in1 i64 4
; CHECK-NEXT:     i64 [[VP__IND_INIT_STEP:%.*]] = induction-init-step{getelementptr} i64 4
...
; CHECK-NEXT:     ptr [[VP0:%.*]] = phi  [ ptr [[VP__IND_INIT]], [[BB1]] ],  [ ptr [[VP1:%.*]], [[BB2]] ]
; CHECK-NEXT:     i32 [[VP__OMP_IV_LOCAL_011:%.*]] = phi  [ i32 [[VP__OMP_IV_LOCAL_011_IND_INIT]], [[BB1]] ],  [ i32 [[VP_ADD2:%.*]], [[BB2]] ]
; CHECK-NEXT:     ptr [[VP1]] = getelementptr inbounds i8, ptr [[VP0]] i64 [[VP__IND_INIT_STEP]]
; CHECK-NEXT:     ptr [[VP_INCDEC_PTR:%.*]] = getelementptr inbounds i32, ptr [[VP0]] i64 1
; CHECK-NEXT:     i32 [[VP2:%.*]] = load ptr [[VP0]]
...
; CHECK-NEXT:     ptr [[VP__IND_FINAL:%.*]] = induction-final{getelementptr} ptr [[B_ADDR_LINEAR_PROMOTED0:%.*]] i64 4
...
; CHECK-NEXT:     call i64 4 ptr [[VP_V_LPRIV]] ptr @llvm.lifetime.end.p0
...
; CHECK-EMPTY:
; CHECK-NEXT:  Id: 1   no underlying for ptr [[VP__IND_FINAL]]
; CHECK-EMPTY:
...
DIR.OMP.SIMD.1:                                   ; preds = %DIR.OMP.SIMD.118
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.LASTPRIVATE:TYPED"(ptr %v.lpriv, i32 0, i32 1), "QUAL.OMP.LINEAR:PTR_TO_PTR.TYPED"(ptr %b.addr.linear, i32 0, i32 1, i32 1), "QUAL.OMP.LINEAR:IV.TYPED"(ptr %i.linear.iv, i32 0, i32 1, i32 1) ]

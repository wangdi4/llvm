...
; CHECK-NEXT:  Divergent: [Shape: Random] i32 [[VP_LOAD:%.*]] = load ptr addrspace(4) [[VP_GEP_ASCAST]]
; CHECK-NEXT:  Divergent: [Shape: Random] i32 [[VP_OP:%.*]] = mul i32 [[VP_LOAD]] i32 3
; CHECK-NEXT:  Divergent: [Shape: Strided, Stride: i64 4] store i32 [[VP_OP:%.*]] ptr addrspace(4) [[VP_GEP_ASCAST]]
...
; CHECK-NEXT:    [[WIDE_LOAD0:%.*]] = load <8 x i32>, ptr addrspace(4) [[TMP0]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = mul <8 x i32> [[WIDE_LOAD0]], <i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3>
; CHECK-NEXT:    store <8 x i32> [[TMP2]], ptr addrspace(4) [[TMP0]], align 4
...
for.body:
  ...
  %ld.1 = load i32, ptr addrspace(4) %gep.ascast, align 4
  %mul = mul i32 %ld.1, 3
  store i32 %mul, ptr addrspace(4) %gep.ascast, align 4

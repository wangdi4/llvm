...
; RUN: opt %s -hir-ssa-deconstruction -hir-temp-cleanup -hir-vplan-vec -vplan-vec-scenario="n0;v4;v2s1" -vplan-enable-new-cfg-merge-hir -vplan-print-after-create-in-merge  -disable-output 2>&1 | FileCheck %s --check-prefix=CHECK-HIR

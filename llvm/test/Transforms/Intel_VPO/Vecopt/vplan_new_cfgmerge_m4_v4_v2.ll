...
; CHECK-NEXT:     [DA: Uni, SVA: (F  )] i1 [[VP_CMP_1:%.*]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_1]] i64 [[VP_VECTOR_TRIP_COUNT]] (SVAOpBits 0->F 1->F )
; CHECK-NEXT:     [DA: Uni, SVA: (F  )] br i1 [[VP_CMP_1]], [[BB8]], [[BB9:BB[0-9]+]] (SVAOpBits 0->F 1->F 2->F )
; CHECK-EMPTY:
...
; CHECK-NEXT:     [DA: Uni] i1 [[VP_CMP_2:%.*]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_2]] i64 [[VP9]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP_CMP_2]], Cloned.[[BB13]], Cloned.[[BB14:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB14]]: # preds: Cloned.[[BB13]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP10:%.*]] = induction-final{add} i64 live-in0 i64 1

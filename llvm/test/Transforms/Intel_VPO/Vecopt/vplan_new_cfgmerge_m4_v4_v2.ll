...
; CHECK-NEXT:     [DA: Uni, SVA: (F  )] br i1 [[VP5]], Cloned.[[BB4:BB[0-9]+]], Cloned.[[BB2]] (SVAOpBits 0->F 1->F 2->F )
; CHECK-EMPTY:
...
; CHECK-NEXT:     [DA: Uni] i1 [[VP_CMP_1:%.*]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_2]] i64 [[VP9]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP_CMP_1]], Cloned.[[BB13]], Cloned.[[BB14:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB14]]: # preds: Cloned.[[BB13]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP10:%.*]] = induction-final{add} i64 0 i64 1
...
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
; CHECK-NEXT:  Id: 0   no underlying for i64 [[VP10]]
; CHECK-EMPTY:
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP11:%.*]] = add i64 [[VP_PEEL_COUNT]] i64 4
; CHECK-NEXT:       [DA: Uni] i1 [[VP_PEEL_VEC_TC_CHECK:%.*]] = icmp ugt i64 [[VP11]] i64 1024
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP12:%.*]] = phi-merge  [ i64 0, [[PEEL_CHECKZ0]] ],  [ token [[VP_VPLAN_PEEL_ADAPTER]], [[BB16]] ]
; CHECK-NEXT:       [DA: Uni] br [[BB17:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB17]]: # preds: [[MERGE_BLK0]]
; CHECK-NEXT:       [DA: Uni] pushvf VF=2 UF=1
; CHECK-NEXT:       [DA: Div] i64 [[VP13:%.*]] = vector-trip-count i64 1024, UF = 1
; CHECK-NEXT:       [DA: Uni] popvf
; CHECK-NEXT:       [DA: Uni] i64 [[VP14:%.*]] = add i64 [[VP_PEEL_COUNT]] i64 2
; CHECK-NEXT:       [DA: Uni] i1 [[VP_PEEL_VEC_TC_CHECK_1:%.*]] = icmp ugt i64 [[VP14]] i64 [[VP13]]
; CHECK-NEXT:       [DA: Uni] br i1 [[VP_PEEL_VEC_TC_CHECK_1]], final.merge, [[BB18:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:        [[BB18]]: # preds: [[BB17]]
; CHECK-NEXT:         [DA: Div] i64 [[VP15:%.*]] = vector-trip-count i64 1024, UF = 1
; CHECK-NEXT:         [DA: Uni] i64 [[VP16:%.*]] = add i64 [[VP_PEEL_COUNT]] i64 4
; CHECK-NEXT:         [DA: Uni] i1 [[VP_PEEL_VEC_TC_CHECK_2:%.*]] = icmp ugt i64 [[VP16]] i64 [[VP15]]
...
; CHECK-NEXT:         [DA: Uni] pushvf VF=2 UF=1
; CHECK-NEXT:         [DA: Div] i64 [[VP17:%.*]] = vector-trip-count i64 1024, UF = 1
; CHECK-NEXT:         [DA: Uni] popvf
; CHECK-NEXT:         [DA: Uni] i1 [[VP_REMTC_CHECK:%.*]] = icmp eq i64 [[VP17]] i64 [[VP_VECTOR_TRIP_COUNT]]
; CHECK-NEXT:         [DA: Uni] br i1 [[VP_REMTC_CHECK]], final.merge, [[MERGE_BLK1]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[MERGE_BLK1]]: # preds: [[BB19]], [[PEEL_CHECKV0]], [[BB18]]
; CHECK-NEXT:       [DA: Uni] i64 [[VP18:%.*]] = phi-merge  [ i64 live-out0, [[BB19]] ],  [ i64 0, [[PEEL_CHECKV0]] ],  [ i64 [[VP12]], [[BB18]] ]
; CHECK-NEXT:       [DA: Uni] br [[BB20:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB20]]: # preds: [[MERGE_BLK1]]
; CHECK-NEXT:       [DA: Uni] token [[VP_VPLAN_ADAPTER:%.*]] = vplan-adapter for VPlan {test_store:for.body.cloned} i64 [[VP18]]
; CHECK-NEXT:       [DA: Uni] br final.merge
; CHECK-EMPTY:
; CHECK-NEXT:    final.merge: # preds: [[BB20]], [[BB19]], [[BB17]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP19:%.*]] = phi-merge  [ token [[VP_VPLAN_ADAPTER]], [[BB20]] ],  [ i64 live-out0, [[BB19]] ],  [ i64 [[VP12]], [[BB17]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP12]] = phi-merge  [ i64 0, [[PEEL_CHECKZ0]] ],  [ i64 [[VP6]], Cloned.[[BB5]] ]
...
; CHECK-EMPTY:
; CHECK-NEXT:      Cloned.[[BB12]]: # preds: Cloned.[[BB11]]
; CHECK-NEXT:       [DA: Div] i64 [[VP7]] = induction-init{add} i64 [[VP18]] i64 1
; CHECK-NEXT:       [DA: Uni] i64 [[VP8]] = induction-init-step{add} i64 1
; CHECK-NEXT:       [DA: Uni] i64 [[VP9]] = vector-trip-count i64 1024, UF = 1
...
; CHECK-NEXT:     [DA: Uni] i64 [[VP19]] = phi-merge  [ i64 [[VP10]], Cloned.[[BB15]] ],  [ i64 live-out0, [[BB19]] ],  [ i64 [[VP12]], [[BB17]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:

...
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>,hir-cg" -disable-output -vplan-force-vf=4 -vplan-print-scalvec-results < %s 2>&1 | FileCheck %s
;

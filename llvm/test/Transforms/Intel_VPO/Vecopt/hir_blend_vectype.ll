...
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -hir-cg -disable-output -print-after=hir-vplan-vec  -vplan-force-vf=4 -vplan-print-scalvec-results -vplan-enable-new-cfg-merge-hir=false < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>,hir-cg" -disable-output -vplan-force-vf=4 -vplan-print-scalvec-results -vplan-enable-new-cfg-merge-hir=false < %s 2>&1 | FileCheck %s
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -hir-cg -disable-output -print-after=hir-vplan-vec  -vplan-force-vf=4 -vplan-print-scalvec-results -vplan-enable-new-cfg-merge-hir < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>,hir-cg" -disable-output -vplan-force-vf=4 -vplan-print-scalvec-results -vplan-enable-new-cfg-merge-hir < %s 2>&1 | FileCheck %s
;

...
; CHECK-NEXT:  Divergent: [Shape: Unit Stride, Stride: i64 1] i64 [[VP_INDVARS_IV:%.*]] = phi  [ i64 [[VP_INDVARS_IV_NEXT:%.*]], [[BB4]] ],  [ i64 0, [[BB5:BB[0-9]+]] ]
; CHECK-NEXT:  Divergent: [Shape: Random] void [[VP0:%.*]] = call i64 4 i8* [[TMP2:%.*]] void (i64, i8*)* @llvm.lifetime.start.p0i8
...
; CHECK-NEXT:  Divergent: [Shape: Random] store float [[VP_ADD5]] float* [[IN_VALS_TMP_REAL_PRIV_PRIV0:%.*]]
; CHECK-NEXT:  Divergent: [Shape: Random] void [[VP2:%.*]] = call i64 4 i8* [[TMP3:%.*]] void (i64, i8*)* @llvm.lifetime.start.p0i8
; CHECK-NEXT:  Divergent: [Shape: Random] store float [[SUB0:%.*]] float* [[IN_VALS_TMP_IMAGINE_PRIV_PRIV0:%.*]]
...
; CHECK-NEXT:  Divergent: [Shape: Random] void [[VP3:%.*]] = call i64 4 i8* [[TMP3]] void (i64, i8*)* @llvm.lifetime.end.p0i8
; CHECK-NEXT:  Divergent: [Shape: Random] void [[VP4:%.*]] = call i64 4 i8* [[TMP2]] void (i64, i8*)* @llvm.lifetime.end.p0i8
; CHECK-NEXT:  Divergent: [Shape: Unit Stride, Stride: i64 1] i64 [[VP_INDVARS_IV_NEXT]] = add i64 [[VP_INDVARS_IV]] i64 1
; CHECK-NEXT:  Uniform: [Shape: Uniform] i1 [[VP_EXITCOND:%.*]] = icmp i64 [[VP_INDVARS_IV_NEXT]] i64 3000
; CHECK-EMPTY:

...
; REQUIRES: asserts
;
; Checks if the code with #pragma vector vectorlength(4, 8) (!{!"llvm.loop.vector.vectorlength", i64 4, i64 8} metadata)
; and #pragma omp simd is being vectorized correctly with LLVM-IR.
;
; void foo(int *arr){
;   #pragma omp simd
;   #pragma vector vectorlength(4, 8)
...
!10 = !{!"llvm.loop.intel.vector.vectorlength", i64 4, i64 8}

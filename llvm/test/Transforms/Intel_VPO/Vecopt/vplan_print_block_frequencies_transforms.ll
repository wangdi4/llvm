...
; RUN: opt -S -enable-new-pm=0 -vplan-vec -vplan-print-after-plain-cfg -vplan-print-after-loop-cfu -vplan-print-after-loop-massaging -vplan-print-after-predicator -vplan-print-block-frequencies -disable-output < %s 2>&1 | FileCheck %s

...
; RUN: opt -vplan-vec -print-after=vplan-vec -disable-output < %s 2>&1 | FileCheck %s --check-prefix=IR-CHECK
...
; IR-CHECK-LABEL:  *** IR Dump After VPlan Vectorizer (vplan-vec) ***
;
...
;
; HIR-CHECK-LABEL:  *** IR Dump After VPlan HIR Vectorizer (hir-vplan-vec) ***

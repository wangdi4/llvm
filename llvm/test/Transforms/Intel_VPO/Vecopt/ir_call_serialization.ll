...
; RUN: opt -S -passes=vplan-vec,intel-ir-optreport-emitter -vplan-force-vf=2 -intel-opt-report=high -disable-output 2>&1 < %s | FileCheck %s -check-prefixes=OPTREPORT
;void baz(int i);
;
;void foo(int *arr) {
;#pragma omp simd

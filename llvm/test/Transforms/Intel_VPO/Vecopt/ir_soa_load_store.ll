...
; CHECK: vector.body:
; CHECK:   [[IDX:%.*]] = phi i64
; CHECK:   [[UNI_PHI:%.*]] = phi i64 [ 0, %vector.ph ], [ [[UNI_PHI_LOOP:%.*]], %vector.body ]
; CHECK:   [[GEP1:%.*]] = getelementptr inbounds <2 x i32>, <2 x i32>* [[PTR]], i64 [[UNI_PHI]]
...
; CHECK:   %[[GEP3:.*]] = getelementptr inbounds <2 x i32>, <2 x i32>* [[PTR]], i64 [[UNI_PHI]]

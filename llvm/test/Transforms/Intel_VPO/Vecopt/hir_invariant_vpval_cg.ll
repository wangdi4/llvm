...
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -VPlanDriverHIR -disable-output -vplan-print-plain-cfg -print-after=VPlanDriverHIR -vplan-force-vf=4 -enable-vp-value-codegen-hir < %s 2>&1 | FileCheck %s
...
; CHECK-NEXT:     i64* [[VP7:%.*]] = getelementptr inbounds [100 x [100 x i64]]* @arr i64 0 i64 [[I10:%.*]] i64 [[VP6]]

...
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,print<hir>,hir-vplan-vec,print<hir>" -disable-output -hir-details -vplan-force-vf=4 < %s 2>&1 | FileCheck %s
;

...
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP9:%.*]] = not i1 [[VP8]]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP10:%.*]] = and i1 [[VP4]] i1 [[VP9]]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP11:%.*]] = block-predicate i1 [[VP10]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP12:%.*]] = add i32 [[VP7]] i32 5
; CHECK-NEXT:     [DA: Divergent] i32* [[VP13:%.*]] = getelementptr inbounds i32* [[A0]] i64 [[VP0]]
; CHECK-NEXT:     [DA: Divergent] store i32 [[VP12]] i32* [[VP13]]
; CHECK-NEXT:    SUCCESSORS(1):[[BB7:BB[0-9]+]]
; CHECK-NEXT:    PREDECESSORS(1): [[BB5]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB7]] (BP: NULL) :
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP14:%.*]] = and i1 [[VP4]] i1 [[VP8]]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP15:%.*]] = block-predicate i1 [[VP14]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP16:%.*]] = mul i32 [[VP3]] i32 5
; CHECK-NEXT:     [DA: Divergent] i32* [[VP17:%.*]] = getelementptr inbounds i32* [[B0]] i64 [[VP0]]
; CHECK-NEXT:     [DA: Divergent] store i32 [[VP16]] i32* [[VP17]]
; CHECK-NEXT:    SUCCESSORS(1):[[BB8:BB[0-9]+]]
; CHECK-NEXT:    PREDECESSORS(1): [[BB6]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB8]] (BP: NULL) :
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP18:%.*]] = block-predicate i1 [[VP4]]
; CHECK-NEXT:     [DA: Divergent] i32* [[VP19:%.*]] = getelementptr inbounds i32* [[C0:%.*]] i64 [[VP0]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP20:%.*]] = load i32* [[VP19]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP21:%.*]] = mul i32 [[VP20]] i32 [[N0:%.*]]
; CHECK-NEXT:     [DA: Divergent] i32* [[VP22:%.*]] = getelementptr inbounds i32* [[C0]] i64 [[VP0]]
; CHECK-NEXT:     [DA: Divergent] store i32 [[VP21]] i32* [[VP22]]
; CHECK-NEXT:     [DA: Divergent] i32* [[VP23:%.*]] = getelementptr inbounds i32* [[A0]] i64 [[VP0]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP24:%.*]] = load i32* [[VP23]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP25:%.*]] = mul i32 [[VP20]] i32 [[N0]]
; CHECK-NEXT:     [DA: Divergent] i1 [[VP26:%.*]] = icmp i32 [[VP25]] i32 0
...
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP27:%.*]] = block-predicate i1 [[VP4]]
; CHECK-NEXT:    SUCCESSORS(1):[[BB10:BB[0-9]+]]
; CHECK-NEXT:    PREDECESSORS(1): [[REGION2]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB10]] (BP: NULL) :
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP28:%.*]] = not i1 [[VP26]]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP29:%.*]] = and i1 [[VP4]] i1 [[VP28]]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP30:%.*]] = block-predicate i1 [[VP29]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP31:%.*]] = mul i32 [[VP24]] i32 [[N0]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP32:%.*]] = mul i32 [[VP20]] i32 [[VP31]]
; CHECK-NEXT:     [DA: Divergent] i32* [[VP33:%.*]] = getelementptr inbounds i32* [[B0]] i64 [[VP0]]
...
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP34:%.*]] = and i1 [[VP4]] i1 [[VP26]]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP35:%.*]] = block-predicate i1 [[VP34]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP36:%.*]] = mul i32 [[VP20]] i32 [[N0]]
; CHECK-NEXT:     [DA: Divergent] i32 [[VP37:%.*]] = mul i32 [[VP24]] i32 -1
; CHECK-NEXT:     [DA: Divergent] i32 [[VP38:%.*]] = add i32 [[VP36]] i32 [[VP37]]
; CHECK-NEXT:     [DA: Divergent] i32* [[VP39:%.*]] = getelementptr inbounds i32* [[A0]] i64 [[VP0]]
; CHECK-NEXT:     [DA: Divergent] store i32 [[VP38]] i32* [[VP39]]
...
; CHECK-NEXT:     <Empty Block>
; CHECK-NEXT:     Condition([[BB12]]): [DA: Uniform]   i1 [[VP41]] = icmp i64 [[VP1]] i64 299
; CHECK-NEXT:    SUCCESSORS(2):[[BB2]](i1 [[VP41]]), [[BB13:BB[0-9]+]](!i1 [[VP41]])

...
omp.inner.for.body:                               ; preds = %omp.inner.for.body, %DIR.OMP.SIMD.2
  ...
  store volatile i32 %.omp.iv.local.07, ptr %i, align 4
  %i.0.i.0. = load volatile i32, ptr %i, align 4
  %conv = sext i32 %i.0.i.0. to i64
  %i.0.i.0.3 = load volatile i32, ptr %i, align 4
  %idxprom = sext i32 %i.0.i.0.3 to i64
  %arrayidx = getelementptr inbounds [256 x i64], ptr @A, i64 0, i64 %idxprom

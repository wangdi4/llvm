...
; CHECK-NEXT:    SUCCESSORS(2):[[INTERMEDIATEBB0:IntermediateBB[0-9]+]](i1 [[VP_CMP1]]), [[BB6:BB[0-9]+]](!i1 [[VP_CMP1]])
...
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP_TAKEBACKEDGECOND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB6]] ],  [ i1 true, [[INTERMEDIATEBB0]] ]

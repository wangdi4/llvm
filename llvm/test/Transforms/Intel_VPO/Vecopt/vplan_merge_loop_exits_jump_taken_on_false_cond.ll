...
; CHECK-NEXT:    SUCCESSORS(2):[[INTERMEDIATE_BB0:intermediate.bb[0-9]+]](i1 [[VP_CMP1]]), [[BB6:BB[0-9]+]](!i1 [[VP_CMP1]])
...
; CHECK-NEXT:     [DA: Divergent] i1 [[VP_TAKE_BACKEDGE_COND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB6]] ],  [ i1 true, [[INTERMEDIATE_BB0]] ]
...
inner.loop:
  ...
  br i1 %cmp1, label %exit_bb1, label %inner.loop.latch

inner.loop.latch:
  %bottom_test = icmp eq i32 %phi.inner.loop.induction, 128
  br i1 %bottom_test, label %exit_bb2, label %inner.loop

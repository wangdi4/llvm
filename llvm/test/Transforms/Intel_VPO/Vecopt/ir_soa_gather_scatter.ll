...
; CHECK:   %[[S_PTR_TO_SCALAR:.*]] = bitcast <4 x <2 x i32>*> {{.*}} to <4 x i32*>
; CHECK:   %[[S_VEC_BASE_PTR:.*]] = shufflevector <4 x i32*> %[[S_PTR_TO_SCALAR]], <4 x i32*> undef, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
; CHECK:   %[[S_ELEM_BASE_PTR:.*]] = getelementptr i32, <8 x i32*> %[[S_VEC_BASE_PTR]], <8 x i64> <i64 0, i64 1, i64 0, i64 1, i64 0, i64 1, i64 0, i64 1>

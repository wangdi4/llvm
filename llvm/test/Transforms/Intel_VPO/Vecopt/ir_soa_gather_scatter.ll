...
; CHECK:   %[[CONCAT:.*]] = shufflevector <4 x i32> %[[G_INDICES_FOR_ELTS_0]], <4 x i32> %[[G_INDICES_FOR_ELTS_1]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK:   %[[G_INDICES_FOR_ELTS_0_AND_1:.*]] = shufflevector <8 x i32> %[[CONCAT]], <8 x i32> undef, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
...
; CHECK:   %[[CONCAT1:.*]] = shufflevector <4 x i32> %[[S_INDICES_FOR_ELTS_0]], <4 x i32> %[[S_INDICES_FOR_ELTS_1]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; CHECK:   %[[S_INDICES_FOR_ELTS_0_AND_1:.*]] = shufflevector <8 x i32> %[[CONCAT1]], <8 x i32> undef, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
; CHECK:   %[[S_GEP_FOR_SCATTER:.*]] = getelementptr inbounds i32, i32* %[[S_PTR_TO_SCALAR]], <8 x i32> %[[S_INDICES_FOR_ELTS_0_AND_1]]
; CHECK:   call void @llvm.masked.scatter.v8i32.v8p0i32(<8 x i32> %[[VALUE_TO_STORE]], <8 x i32*> %[[S_GEP_FOR_SCATTER]], i32 4, <8 x i1> %[[ReplicatedMaskVec]])

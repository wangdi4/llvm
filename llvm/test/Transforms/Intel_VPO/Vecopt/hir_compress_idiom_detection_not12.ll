...
; CHECK:      [Compress/Expand Idiom] Increment {sb:3}+1 detected: <18>         %n2.025 = %n2.025  +  1;
; CHECK-NEXT: [Compress/Expand Idiom] Increment {sb:4}+1 detected: <22>         %n1.024 = %n1.024  +  1;
; CHECK-NEXT: [Compress/Expand Idiom] Data-dependency on other memory found: (%B)[%n1.024]
; CHECK-NEXT: [Compress/Expand Idiom] Increment rejected: <18>         %n2.025 = %n2.025  +  1;
; CHECK-NEXT: [Compress/Expand Idiom] Data-dependency on other memory found: (%B)[%n2.025]
; CHECK-NEXT: [Compress/Expand Idiom] Increment rejected: <22>         %n1.024 = %n1.024  +  1;
...
if.else6:                                         ; preds = %if.else
  ...
  %idxprom10 = sext i32 %n1.024 to i64

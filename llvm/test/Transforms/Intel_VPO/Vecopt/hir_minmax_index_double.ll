...
; RUN: opt %s -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -hir-vplan-vec -print-after=VPlanDriverHIR -disable-output 2>&1 | FileCheck %s
...
; CHECK-NEXT:          |   [[DOTVEC0:%.*]] = (<4 x double>*)([[TMP0:%.*]])[i1]
...
; CHECK-NEXT:          + END LOOP
; CHECK-NEXT:             [[TMP1]] = @llvm.vector.reduce.fmin.v4f64([[RED_VAR0]])
; CHECK-NEXT:             [[IDX_BLEND0:%.*]] = ([[TMP1]] == [[RED_VAR0]]) ? [[RED_VAR10]] : <i64 -1, i64 -1, i64 -1, i64 -1>
; CHECK-NEXT:             [[RETVAL_SROA_2_0_COPYLOAD_SROA_SPECULATE_LOAD_FALSE0]] = @llvm.vector.reduce.umin.v4i64([[IDX_BLEND0]])
; CHECK-NEXT:       }
;

...
define dso_local void @_Z3fooPdS_S_PiS0_S_i(ptr noalias nocapture noundef readonly %A1, ptr noalias nocapture noundef readonly %A2, ptr noalias nocapture noundef %B, ptr noalias nocapture noundef readonly %C1, ptr noalias nocapture noundef readonly %C2, ptr noalias nocapture noundef writeonly %C3, i32 noundef %N) local_unnamed_addr #0 {
entry:
...
if.then9:                                         ; preds = %if.else
  %arrayidx11 = getelementptr inbounds double, ptr %A2, i64 %indvars.iv
  %3 = load double, ptr %arrayidx11, align 8, !tbaa !7
  store double %3, ptr %B, align 8, !tbaa !7
  br label %if.end21

if.else14:                                        ; preds = %if.else
  %inc15 = add nsw i32 %n2.046, 1
  %idxprom16 = sext i32 %n2.046 to i64
  %arrayidx17 = getelementptr inbounds double, ptr %B, i64 %idxprom16
  %4 = load double, ptr %arrayidx17, align 8, !tbaa !7
  %inc18 = add nsw i32 %n1.045, 1
  %idxprom19 = sext i32 %n1.045 to i64
  %arrayidx20 = getelementptr inbounds double, ptr %B, i64 %idxprom19
  store double %4, ptr %arrayidx20, align 8, !tbaa !7
  br label %if.end21
...
if.end21:                                         ; preds = %if.then9, %if.else14, %if.then
  ...
  %arrayidx23 = getelementptr inbounds double, ptr %B, i64 %indvars.iv
  %5 = load double, ptr %arrayidx23, align 8, !tbaa !7
  %arrayidx25 = getelementptr inbounds double, ptr %C3, i64 %indvars.iv
  store double %5, ptr %arrayidx25, align 8, !tbaa !7

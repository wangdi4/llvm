; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -mtriple=x86_64-unknown-linux-gnu -mcpu=skylake-avx512 -max-bb-size-for-multi-node-slp=100 -S | FileCheck %s

...
; CMCHECK-NEXT:    Cost 24000 for i32 [[VP_LOAD:%.*]] = load i32* [[VP_SUBSCRIPT]] *OVLS*(+16000) AdjCost: 40000
...
; CMCHECK-NEXT:    Cost 24000 for i32 [[VP_LOAD_1:%.*]] = load i32* [[VP_SUBSCRIPT_1]] *OVLS*(-24000) AdjCost: 0
...
; HIRCHECK-NEXT:                 |   [[DOTVLS_LOAD0:%.*]] = (<8 x i32>*)([[LP0:%.*]])[2 * i1]
...
; HIRCHECK:                      [[SUM_0130]] = @llvm.vector.reduce.add.v4i32([[RED_VAR0]])

...
; CMCHECK-NEXT:    Cost 12000 for i32 [[VP_LOAD:%.*]] = load i32* [[VP_SUBSCRIPT]] *OVLS*(+6000) AdjCost: 18000
...
; HIRCHECK-NEXT:  <28>               |   [[DOTVLS_LOAD0:%.*]] = (<8 x i32>*)([[LP0:%.*]])[2 * i1]
...
; HIRCHECK-NEXT:  <20>
; HIRCHECK-NEXT:  <34>               [[SUM_0130]] = @llvm.vector.reduce.add.v4i32([[RED_VAR0]])

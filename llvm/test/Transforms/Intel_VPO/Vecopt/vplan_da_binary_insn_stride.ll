...
; CHECK-NEXT:  Divergent: [Shape: Strided, Stride: i64 4] i64 [[VP_FIRST_INDUCTION_PHI:%.*]] = phi  [ i64 0, [[BB3:BB[0-9]+]] ],  [ i64 [[VP_FIRST_INDUCTION:%.*]], [[BB2]] ]
; CHECK-NEXT:  Divergent: [Shape: Unit Stride, Stride: i64 1] i64 [[VP_SECOND_INDUCTION_PHI:%.*]] = phi  [ i64 0, [[BB3]] ],  [ i64 [[VP_SECOND_INDUCTION:%.*]], [[BB2]] ]
; CHECK-EMPTY:
...
; CHECK-NEXT:  Divergent: [Shape: Strided, Stride: i64 4] i64 [[VP_FIRST_INDUCTION]] = add i64 [[VP_FIRST_INDUCTION_PHI]] i64 4
; CHECK-NEXT:  Divergent: [Shape: Unit Stride, Stride: i64 1] i64 [[VP_SECOND_INDUCTION]] = add i64 [[VP_SECOND_INDUCTION_PHI]] i64 1

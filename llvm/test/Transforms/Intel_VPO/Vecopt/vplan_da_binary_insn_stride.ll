...
; CHECK-NEXT:  Uniform: [Shape: Uniform] i64 [[VP_FIRST_INDUCTION_PHI_IND_FINAL:%.*]] = induction-final{add} i64 0 i64 4
; CHECK-NEXT:  Uniform: [Shape: Uniform] i64 [[VP_SECOND_INDUCTION_PHI_IND_FINAL:%.*]] = induction-final{add} i64 0 i64 1
; CHECK-EMPTY:

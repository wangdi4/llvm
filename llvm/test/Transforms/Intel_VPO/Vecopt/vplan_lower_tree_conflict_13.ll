...
define dso_local void @foo(float* noalias nocapture noundef %A, i16* nocapture noundef readonly %B, float* noalias nocapture noundef readonly %C) local_unnamed_addr #0 {
;
; float A[8], C[8];

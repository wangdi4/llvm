...
define dso_local void @foo(float* noalias nocapture noundef %A, i16* nocapture noundef readonly %B, float* noalias nocapture noundef readonly %C, i32 noundef %N) local_unnamed_addr #0 {
;
; float A[N], C[N];

...
; CHECK-NEXT: i32 [[LOAD1:%vp.*]] = load ptr [[ADDR1]]
; CHECK-NEXT: ptr [[ADDR2:%vp.*]] = subscript inbounds ptr %c {i64 0 : i64 [[I1]] : i64 4 : ptr(i32)}
; CHECK-NEXT: i32 [[LOAD2:%vp.*]] = load ptr [[ADDR2]]
; CHECK-NEXT: i32 [[ADD:%vp.*]] = add i32 [[LOAD1]] i32 [[LOAD2]]
; CHECK-NEXT: ptr [[ADDR3:%vp.*]] = subscript inbounds ptr %a {i64 0 : i64 [[I1]] : i64 4 : ptr(i32)}
; CHECK-NEXT: store i32 [[ADD]] ptr [[ADDR3]]
...
define dso_local ptr @foo(ptr returned %a, ptr nocapture readonly %b, ptr nocapture readonly %c) local_unnamed_addr {
entry:
  br label %for.body

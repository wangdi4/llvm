...
; RUN: opt -S -vplan-vec -vplan-force-vf=2 -vplan-print-block-frequencies -vplan-print-after-plain-cfg -vplan-print-after-create-masked-vplan < %s -disable-output | FileCheck %s
...
; CHECK-NEXT:     [DA: Div] i1 [[VP2:%.*]] = icmp ult i32 [[VP_IV_1]] i32 128
...
; CHECK-NEXT:     [DA: Div] i1 [[VP3:%.*]] = icmp ult i32 [[VP_IV_NEXT_1]] i32 128

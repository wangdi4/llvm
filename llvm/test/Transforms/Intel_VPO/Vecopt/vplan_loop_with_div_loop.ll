...
; CHECK-NEXT: Divergent: [[VAL11:%vp[0-9]+]] = add [[VAL3:%vp[0-9]+]] i64 1
; CHECK-NEXT: Divergent: [[VAL12:%vp[0-9]+]] = icmp [[VAL4:%vp[0-9]+]] [[VAL1:%vp[0-9]+]]
; CHECK-LABEL: Basic Block: BB5
; CHECK-NEXT: Divergent: [[VAL13:%vp[0-9]+]] = add [[VAL1:%vp[0-9]+]] i64 1
; CHECK-NEXT: Uniform: [[VAL14:%vp[0-9]+]] = icmp [[VAL13:%vp[0-9]+]] [[VAL6:%vp[0-9]+]]

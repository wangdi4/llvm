; REQUIRES: asserts
; RUN: opt %s -VPlanDriver -disable-vplan-da=false -disable-vplan-codegen -debug 2>&1 | FileCheck %s 
...
; CHECK-NEXT: Uniform: i64 [[VAL3:%vp[0-9]+]] = phi [ i64 0, BB3 ], [ i64 [[VAL4:%vp[0-9]+]], BB4 ]

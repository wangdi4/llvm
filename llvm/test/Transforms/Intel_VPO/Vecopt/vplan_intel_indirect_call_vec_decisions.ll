...
; RUN: opt -opaque-pointers=0 < %s -S -passes=vplan-vec -vplan-force-vf=4 -vplan-print-after-call-vec-decisions | FileCheck %s
...
; CHECK-NEXT:    [[CURRENT_FPTR_SPLATINSERT0:%.*]] = insertelement <4 x i32 (i32, float)**> poison, i32 (i32, float)** [[CURRENT_FPTR0]], i64 0

...
; RUN: opt -vplan-vec -S -vplan-vec-scenario="n1;v16;m16" -vplan-print-after-vpentity-instrs -vplan-print-after-create-masked-vplan -vplan-enable-masked-variant -vplan-enable-peel-rem-strip=0 -vplan-print-after-final-cond-transform < %s 2>&1 | FileCheck %s

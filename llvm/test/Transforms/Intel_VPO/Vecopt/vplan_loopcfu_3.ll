...
; CHECK-NEXT:     [DA: Div] i1 [[VP_INNER_TOPTEST:%.*]] = icmp i32 [[VP0]] i32 0
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB4]]:
; CHECK-NEXT:       [DA: Div] i32 [[VP1:%.*]] = trunc i64 [[VP_OUTER_IV]] to i32
; CHECK-NEXT:      SUCCESSORS(1):[[BB5:BB[0-9]+]]
; CHECK-NEXT:      PREDECESSORS(1): [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB5]]:
; CHECK-NEXT:       [DA: Uni] i64 [[VP_INNER_IV:%.*]] = phi  [ i64 0, [[BB4]] ],  [ i64 [[VP_INNER_IV_NEXT:%.*]], [[BB6:BB[0-9]+]] ]
; CHECK-NEXT:       [DA: Div] i32 [[VP2:%.*]] = phi  [ i32 [[VP0]], [[BB4]] ],  [ i32 [[VP3:%.*]], [[BB6]] ]
...
; CHECK-NEXT:         [DA: Uni] i32** [[VP_ARRAYIDX5:%.*]] = getelementptr inbounds i32** [[A0:%.*]] i64 [[VP_INNER_IV]]
; CHECK-NEXT:         [DA: Uni] i32* [[VP4:%.*]] = load i32** [[VP_ARRAYIDX5]]
; CHECK-NEXT:         [DA: Div] i32* [[VP_ARRAYIDX7:%.*]] = getelementptr inbounds i32* [[VP4]] i64 [[VP_OUTER_IV]]
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB9]]:
; CHECK-NEXT:       [DA: Div] i1 [[VP_INNER_EXITCOND:%.*]] = icmp i64 [[VP_INNER_IV]] i64 [[VP5]]
...
; CHECK-NEXT:      [[BB6]]:
; CHECK-NEXT:       <Empty Block>
; CHECK-NEXT:       Condition([[BB9]]): [DA: Uni] i1 [[VP7]] = not i1 [[VP6]]
...
; CHECK-NEXT:     [DA: Uni] i1 [[VP_OUTER_EXITCOND:%.*]] = icmp i64 [[VP_OUTER_IV_NEXT]] i64 [[M_SEXT0:%.*]]

...
; CHECK-NEXT: ptr [[GEPB:%vp.*]] = subscript inbounds ptr @b i64 0 i64 [[IV:%vp.*]]
; CHECK-NEXT: store i32 [[PHI]] ptr [[GEPB]]
; CHECK-NEXT: i32 [[MUL1:%vp.*]] = mul i32 {{.*}} i32 2
; CHECK-NEXT: i32 [[ADD1:%vp.*]] = add i32 [[PHI]] i32 [[MUL1]]
; CHECK-NEXT: ptr [[GEPC:%vp.*]] = subscript inbounds ptr @c i64 0 i64 [[IV]]
; CHECK-NEXT: store i32 [[ADD1]] ptr [[GEPC]]
; CHECK-NEXT: ptr [[GEPD:%vp.*]] = subscript inbounds ptr @d i64 0 i64 [[IV]]
; CHECK-NEXT: i32 [[D_I1:%vp.*]] = load ptr [[GEPD]]
...
; CHECK-NEXT: ptr [[GEPD:%vp.*]] = subscript inbounds ptr @d i64 0 i64 [[IV]]
; CHECK-NEXT: store i32 [[SEL]] ptr [[GEPD]]
; CHECK-NOT: phi

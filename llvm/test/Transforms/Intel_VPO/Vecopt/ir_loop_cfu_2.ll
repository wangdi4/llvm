...
; CHECK: [[BB_2]] -> [[BB_14:BB[0-9]+]] [ label="Branch If Not All Zero Recipe"]
; CHECK: [[BB_14]] [label = "{[[BB_14]]}"]
; CHECK: [[BB_14]] -> [[BB_3:BB[0-9]+]] [ label="Branch If Not All Zero Recipe" lhead=[[cluster_loop_19:cluster_loop[0-9]+]]]
; CHECK: [[BB_14]] -> [[BB_4:BB[0-9]+]] [ label="!Branch If Not All Zero Recipe"]
...
; CHECK: [[BB_5]] -> [[BB_20:BB[0-9]+]] [ label="Non-Uniform Cond Bit Recipe"]
; CHECK: [[BB_5]] -> [[BB_21:BB[0-9]+]] [ label="!Non-Uniform Cond Bit Recipe"]
...
; CHECK: [[BB_20]] -> [[BB_16:BB[0-9]+]] [ label="[[UniformCBR_4]]"]
; CHECK: [[BB_16]] [label = "{[[BB_16]]}"]
; CHECK: [[BB_16]] -> [[BB_6:BB[0-9]+]] [ label="[[UniformCBR_4]]"]
; CHECK: [[BB_16]] -> [[BB_7:BB[0-9]+]] [ label="![[UniformCBR_4]]"]
; CHECK: [[BB_6]] [label = "{[[BB_6]] | Vectorize VPInstIR:\n  %5 = add nsw i64 %indvars.iv, %indvars.iv41\n  %6 = trunc i64 %5 to i32}"]
; CHECK: [[BB_6]] -> [[BB_8:BB[0-9]+]] [ label=""]
...
; CHECK: [[BB_8]] -> [[BB_21]] [ label="Branch If Not All Zero Recipe"]
; CHECK: [[BB_21]] [label = "{[[BB_21]] | Vectorize VPInstIR:\n  %indvars.iv.next = add nsw i64 %indvars.iv, 1\n  %add15 = add nsw i32 %j.035, 1 | IfNotAllZero: \n  %cmp1 = icmp slt i64 %indvars.iv, %1}"]
; CHECK: [[BB_21]] -> [[BB_17:BB[0-9]+]] [ label="Branch If Not All Zero Recipe"]
; CHECK: [[BB_17]] [label = "{[[BB_17]]}"]
; CHECK: [[BB_17]] -> [[BB_5]] [ label="Branch If Not All Zero Recipe"]
; CHECK: [[BB_17]] -> [[BB_9:BB[0-9]+]] [ label="!Branch If Not All Zero Recipe"]
; CHECK: [[BB_9]] [label = "{[[BB_9]]}"]
; CHECK: [[BB_7]] [label = "{[[BB_7]] | Vectorize VPInstIR:\n  %mul = mul nsw i32 %j.035, %2\n  %arrayidx12 = getelementptr inbounds float*, float** %a, i64 %indvars.iv\n  %7 = load float*, float** %arrayidx12, align 8}"]
; CHECK: [[BB_7]] -> [[BB_8]] [ label=""]

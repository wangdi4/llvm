...
; VPLAN-CM-AVX2-NEXT:    Cost 0 for i64* [[VP2:%.*]] = getelementptr [1024 x i64]* @arr.i64.1 i64 0 i64 [[VP0]]
; VPLAN-CM-AVX2-NEXT:    Cost 16 for i64 [[VP3:%.*]] = load i64* [[VP2]]
; VPLAN-CM-AVX2-NEXT:    Cost 0 for i64* [[VP4:%.*]] = getelementptr [1024 x i64]* @arr.i64.3 i64 0 i64 [[VP0]]
...
; VPLAN-CM-AVX2-NEXT:    Cost 0 for i64* [[VP8:%.*]] = getelementptr [1024 x i64]* @arr.i64.2 i64 0 i64 [[VP0]]
...
; VPLAN-CM-SSE2-NEXT:    Cost 0 for i64* [[VP2:%.*]] = getelementptr [1024 x i64]* @arr.i64.1 i64 0 i64 [[VP0]]
; VPLAN-CM-SSE2-NEXT:    Cost 16 for i64 [[VP3:%.*]] = load i64* [[VP2]]
; VPLAN-CM-SSE2-NEXT:    Cost 0 for i64* [[VP4:%.*]] = getelementptr [1024 x i64]* @arr.i64.3 i64 0 i64 [[VP0]]
...
; VPLAN-CM-SSE2-NEXT:    Cost 0 for i64* [[VP8:%.*]] = getelementptr [1024 x i64]* @arr.i64.2 i64 0 i64 [[VP0]]
...
; VPLAN-HIR-CM-AVX2-NEXT:    Cost 0 for i64* [[VP2:%.*]] = getelementptr [1024 x i64]* @arr.i64.1 i64 0 i64 [[VP0]]
; VPLAN-HIR-CM-AVX2-NEXT:    Cost 2 for i64 [[VP3:%.*]] = load i64* [[VP2]]
; VPLAN-HIR-CM-AVX2-NEXT:    Cost 0 for i64* [[VP4:%.*]] = getelementptr [1024 x i64]* @arr.i64.3 i64 0 i64 [[VP0]]
...
; VPLAN-HIR-CM-AVX2-NEXT:    Cost 0 for i64* [[VP8:%.*]] = getelementptr [1024 x i64]* @arr.i64.2 i64 0 i64 [[VP0]]
...
; VPLAN-HIR-CM-SSE2-NEXT:    Cost 0 for i64* [[VP2:%.*]] = getelementptr [1024 x i64]* @arr.i64.1 i64 0 i64 [[VP0]]
; VPLAN-HIR-CM-SSE2-NEXT:    Cost 4 for i64 [[VP3:%.*]] = load i64* [[VP2]]
; VPLAN-HIR-CM-SSE2-NEXT:    Cost 0 for i64* [[VP4:%.*]] = getelementptr [1024 x i64]* @arr.i64.3 i64 0 i64 [[VP0]]
...
; VPLAN-HIR-CM-SSE2-NEXT:    Cost 0 for i64* [[VP8:%.*]] = getelementptr [1024 x i64]* @arr.i64.2 i64 0 i64 [[VP0]]

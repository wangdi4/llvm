...
; RUN: opt -vplan-enable-soa=false -S < %s -VPlanDriver -loop-simplify --vplan-force-vf=4 --vplan-force-uf=3 --vplan-print-after-unroll -vplan-enable-all-liveouts -vplan-enable-cfg-merge=0 | FileCheck %s

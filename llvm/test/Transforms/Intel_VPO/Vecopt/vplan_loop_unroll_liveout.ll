...
; RUN: opt -vplan-print-terminator-inst=false -vplan-enable-soa=false -S < %s -VPlanDriver -loop-simplify --vplan-force-vf=4 --vplan-force-uf=3 --vplan-print-after-unroll -vplan-enable-all-liveouts | FileCheck %s
...
; CHECK-NEXT:  Id: 0     [[DOTLCSSA0:%.*]] = phi i32 [ [[TMP2:%.*]], [[OMP_INNER_FOR_BODY0:%.*]] ] i32 [[VP5]] -> i32 [[TMP2]]
; CHECK-EMPTY:
...
; CHECK-NEXT:    br i1 [[TMP15]], label [[VPLANNEDBB0:%.*]], label [[VECTOR_BODY0]], !llvm.loop !0
; CHECK-EMPTY:

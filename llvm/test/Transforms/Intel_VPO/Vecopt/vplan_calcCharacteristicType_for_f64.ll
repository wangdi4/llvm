...
; CHECK-NEXT:     [DA: Div] double [[VP_CALL_I:%.*]] = call i32 5 _ZGVbM4v__Z3barPif [x 1] [@CurrMask]
...
; CHECK-NEXT:    [[TMP3:%.*]] = call <4 x double> @_ZGVbM4v__Z3barPif(<4 x i32> <i32 5, i32 5, i32 5, i32 5>, <4 x double> [[MASKCAST0]])

...
declare dso_local double @_Z3barPif(i32) #2
...
; CHECK-NEXT:     [DA: Div, SVA: ( V )] double [[VP_CALL_I:%.*]] = call i32 5 _ZGVbM4v_Z3barPif [x 1] [@CurrMask] (SVAOpBits 0->V 1->F )
...
; CHECK-NEXT:    [[MASKCAST0:%.*]] = bitcast <4 x i64> [[MASKEXT0]] to <4 x double>
; CHECK-NEXT:    [[TMP3:%.*]] = call <4 x double> @_ZGVbM4v_Z3barPif(<4 x i32> <i32 5, i32 5, i32 5, i32 5>, <4 x double> [[MASKCAST0]])
...
simd.loop.then:                                   ; preds = %simd.loop
  %call.i = call double @_Z3barPif(i32 5) #2

...
; RUN: opt -vplan-print-terminator-inst=false %s -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -VPlanDriverHIR -disable-vplan-codegen -disable-output -vplan-print-after-linearization -vplan-dump-external-defs-hir=0 -S | FileCheck %s
; REQUIRES: asserts

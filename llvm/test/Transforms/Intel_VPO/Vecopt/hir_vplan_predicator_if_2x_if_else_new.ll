...
; RUN: opt %s -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -hir-vplan-vec -disable-vplan-codegen -disable-output -vplan-print-after-linearization -vplan-dump-external-defs-hir=0 -S | FileCheck %s
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec" %s -disable-vplan-codegen -disable-output -vplan-print-after-linearization -vplan-dump-external-defs-hir=0 -S | FileCheck %s

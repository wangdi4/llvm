...
; CHECK-NEXT:     [DA: Uni] br i1 [[VP6]], Cloned.[[BB4:BB[0-9]+]], Cloned.[[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    Cloned.[[BB4]]: # preds: new_latch
; CHECK-NEXT:     [DA: Uni] i64 [[VP7:%.*]] = induction-final{add} i64 live-in0 i64 1
...
; CHECK-NEXT:     [DA: Uni] i64 [[VP16:%.*]] = add i64 1 i64 4
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP17:%.*]] = phi-merge  [ token [[VP_VPLAN_PEEL_ADAPTER]], [[BB17]] ]
; CHECK-NEXT:       [DA: Uni] br [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB2]]: # preds: [[MERGE_BLK1]]
; CHECK-NEXT:       [DA: Div] i64 [[VP18:%.*]] = vector-trip-count i64 1024, UF = 1
; CHECK-NEXT:       [DA: Uni] i64 [[VP19:%.*]] = add i64 1 i64 4
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[MERGE_BLK0]]: # preds: [[BB18]], [[PEEL_CHECKV0]], [[BB2]]
...
; CHECK-NEXT:      new_latch: # preds: [[BB3]]
; CHECK-NEXT:       [DA: Div] i64 [[VP_INDVARS_IV_NEXT]] = add i64 [[VP_INDVARS_IV]] i64 [[VP1]]
; CHECK-NEXT:       [DA: Div] i1 [[VP5]] = icmp ult i64 [[VP_INDVARS_IV_NEXT]] i64 1
; CHECK-NEXT:       [DA: Uni] i1 [[VP6]] = all-zero-check i1 [[VP5]]
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[MERGE_BLK1]]: # preds: Cloned.[[BB5]]
; CHECK-NEXT:       [DA: Uni] i64 [[VP17]] = phi-merge  [ i64 [[VP7]], Cloned.[[BB5]] ]
; CHECK-NEXT:       [DA: Uni] br [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB2]]: # preds: [[MERGE_BLK1]]
; CHECK-NEXT:       [DA: Div] i64 [[VP18]] = vector-trip-count i64 1024, UF = 1

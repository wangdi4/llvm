...
; RUN: opt -passes="hir-ssa-deconstruction,hir-pre-vec-complete-unroll,hir-vec-dir-insert,vplan-driver-hir" -vplan-print-after-plain-cfg -disable-output < %s 2>&1 | FileCheck %s

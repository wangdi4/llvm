...
; RUN: opt -vplan-print-terminator-inst=false -hir-ssa-deconstruction -hir-pre-vec-complete-unroll -hir-vec-dir-insert -VPlanDriverHIR -vplan-print-after-plain-cfg -disable-output < %s 2>&1 | FileCheck %s

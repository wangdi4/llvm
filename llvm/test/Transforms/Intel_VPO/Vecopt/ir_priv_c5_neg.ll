...
;
; RUN: opt -opaque-pointers=0 -disable-output -passes=vplan-vec -vplan-force-vf=4 -vplan-enable-all-liveouts -vplan-print-after-plain-cfg  -debug-only=vploop-analysis -disable-vplan-codegen %s 2>&1 | FileCheck %s

...
; RUN: opt -disable-output -vplan-vec -vplan-force-vf=4 -vplan-enable-pushvf -vplan-enable-cfg-merge -vplan-print-after-cfg-merge < %s  | FileCheck %s -check-prefixes CHECK

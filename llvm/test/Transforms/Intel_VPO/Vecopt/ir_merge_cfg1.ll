...
; RUN: opt -disable-output -disable-vplan-codegen -vplan-vec -vplan-force-vf=4  -vplan-print-after-cfg-merge -vplan-enable-masked-vectorized-remainder=0 -vplan-enable-non-masked-vectorized-remainder=0 < %s  | FileCheck %s
; RUN: opt -disable-output -vplan-vec -vplan-force-vf=4 -vplan-enable-pushvf  -vplan-print-after-cfg-merge -vplan-enable-masked-vectorized-remainder=0 -vplan-enable-non-masked-vectorized-remainder=0 < %s  | FileCheck %s -check-prefixes CHECK

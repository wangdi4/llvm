...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB5]]:
; CHECK-NEXT:     [DA: Div] i32 [[VP_INNER_REC:%.*]] = phi  [ i32 [[VP_INNER_REC_NEXT:%.*]], [[BB6:BB[0-9]+]] ],  [ i32 [[VP__PRE]], [[BB4]] ]
; CHECK-NEXT:     [DA: Uni] i32 [[VP_INNER_IV:%.*]] = phi  [ i32 [[VP_INNER_IV_NEXT:%.*]], [[BB6]] ],  [ i32 0, [[BB4]] ]
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB8]]:
; CHECK-NEXT:       [DA: Div] i32 [[VP_MUL:%.*]] = mul i32 [[VP_INNER_REC]] i32 [[VP_INNER_IV]]
...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB9]]:
; CHECK-NEXT:     [DA: Div] i1 [[VP_INNER_EXITCOND:%.*]] = icmp i32 [[VP_INNER_REC]] i32 0
...
; CHECK-NEXT:    [[BB3]]:
; CHECK-NEXT:     <Empty Block>
; CHECK-NEXT:     Condition([[BB10]]): [DA: Uni] i1 [[VP_VECTOR_LOOP_EXITCOND]] = icmp i64 [[VP_VECTOR_LOOP_IV_NEXT]] i64 [[VP_VECTOR_TRIP_COUNT]]

...
; RUN: opt < %s -disable-output -opaque-pointers -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -vplan-print-after-plain-cfg -print-after=hir-vplan-vec -hir-details 2>&1 -vplan-enable-new-cfg-merge-hir=0 | FileCheck %s
; RUN: opt < %s -disable-output -opaque-pointers -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -vplan-print-after-plain-cfg -print-after=hir-vplan-vec -hir-details 2>&1 -vplan-enable-new-cfg-merge-hir=1 | FileCheck %s
; RUN: opt < %s -disable-output -opaque-pointers -passes='hir-ssa-deconstruction,hir-vplan-vec,print<hir>' -vplan-print-after-plain-cfg -hir-details 2>&1 -vplan-enable-new-cfg-merge-hir=0 | FileCheck %s
; RUN: opt < %s -disable-output -opaque-pointers -passes='hir-ssa-deconstruction,hir-vplan-vec,print<hir>' -vplan-print-after-plain-cfg -hir-details 2>&1 -vplan-enable-new-cfg-merge-hir=1 | FileCheck %s
%S = type { ptr }

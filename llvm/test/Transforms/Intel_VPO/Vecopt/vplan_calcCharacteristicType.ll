...
declare dso_local i32 @_Z3barPif(i32) #2
...
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i32 [[VP_CALL_I:%.*]] = call i32 5 _ZGVbM4v_Z3barPif [x 1] [@CurrMask] (SVAOpBits 0->V 1->F )
...
simd.loop.then:                                   ; preds = %simd.loop
  %call.i = call i32 @_Z3barPif(i32 5) #2

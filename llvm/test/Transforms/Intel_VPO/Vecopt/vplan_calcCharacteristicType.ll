...
; RUN: opt -vplan-print-terminator-inst=false < %s -S -VPlanDriver -vplan-force-vf=4 -vplan-print-after-call-vec-decisions | FileCheck %s
...
; CHECK-NEXT:    [[TMP7:%.*]] = icmp ne i32 [[TMP6]], 4

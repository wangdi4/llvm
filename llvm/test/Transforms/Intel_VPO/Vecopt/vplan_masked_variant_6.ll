...
; Check if the right top and bottom checks are created.
...
; CHECK-NEXT:     [DA: Div] i1 [[VP_BOTTOM_TEST:%.*]] = icmp uge i32 [[VP_IV]] i32 [[VP2]]
...
; CHECK-NEXT:     [DA: Uni] i1 [[VP_BOTTOM_TEST_1:%.*]] = icmp uge i32 [[VP_IV_NEXT]] i32 [[VP2]]
...
; CHECK-NEXT:     [DA: Div] i1 [[VP_BOTTOM_TEST_2:%.*]] = icmp uge i32 [[VP_IV_1]] i32 [[VP6]]
...
; CHECK-NEXT:     [DA: Uni] i1 [[VP_BOTTOM_TEST_3:%.*]] = icmp uge i32 [[VP_IV_NEXT_1]] i32 [[VP6]]
; CHECK-NEXT:     [DA: Uni] br i1 [[VP_BOTTOM_TEST_3]], Cloned.[[BB10:BB[0-9]+]], Cloned.[[BB8]]
; CHECK-EMPTY:
...
for.body:
  ...
  %bottom_test = icmp uge i32 %iv.next, %N

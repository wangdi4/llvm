...
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-loop-concatenation,hir-vec-dir-insert,hir-vplan-vec,hir-cg" -enable-intel-advanced-opts -mattr=+avx2 -xmain-opt-level=3 -vplan-print-after-plain-cfg -S -disable-output 2>&1 < %s | FileCheck %s

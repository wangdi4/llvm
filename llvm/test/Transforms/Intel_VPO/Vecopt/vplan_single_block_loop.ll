...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 < %s -passes=vplan-vec -vplan-force-vf=2 -vplan-dump-da -disable-output 2>&1 | FileCheck %s
...
; CHECK-NEXT:  Divergent: [Shape: Strided, Stride: i64 4] store float 4.200000e+01 float* [[VP_ARRAYIDX]]

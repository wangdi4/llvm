...
; RUN: opt -S < %s -passes=vplan-vec,loop-simplify,intel-ir-optreport-emitter --vplan-force-vf=4 --vplan-force-uf=3 \
; RUN: -intel-opt-report=low 2>&1 | FileCheck %s -check-prefixes=OPTREPORT
...
; CHECK-NEXT:    store <4 x i32> [[TMP2]], ptr [[SCALAR_GEP0]], align 4
...
; CHECK-NEXT:    store <4 x i32> [[TMP8]], ptr [[SCALAR_GEP70]], align 4
...
; CHECK-NEXT:    store <4 x i32> [[TMP14]], ptr [[SCALAR_GEP100]], align 4
...
; CHECK-NEXT:    [[TMP22:%.*]] = load i32, ptr [[ARRAYIDX0]], align 4

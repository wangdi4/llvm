...
; CHECK-NEXT:    [[TMP21:%.*]] = icmp eq i64 [[INDEX_NEXT0]], [[N_VEC0]]
; CHECK-NEXT:    br i1 [[TMP21]], label [[VPLANNEDBB0:%.*]], label [[VECTOR_BODY0]]
; CHECK-EMPTY:
...
; CHECK-NEXT:    [[BC_RESUME_VAL0:%.*]] = phi i64 [ 0, [[DIR_OMP_SIMD_10]] ], [ [[TMP23]], [[MIDDLE_BLOCK0]] ]
...
; CHECK-NEXT:    [[TMP24:%.*]] = load i32, i32* [[ARRAYIDX0]], align 4
; CHECK-NEXT:    [[INC0:%.*]] = add nsw i32 [[TMP24]], 1

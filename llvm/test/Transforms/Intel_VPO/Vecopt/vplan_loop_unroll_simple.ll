...
; RUN: --vplan-print-after-unroll -vplan-enable-new-cfg-merge | FileCheck %s -check-prefixes=CHECK
; RUN: opt -S < %s -VPlanDriver -loop-simplify --vplan-force-vf=4 --vplan-force-uf=3 \
; RUN: -intel-ir-optreport-emitter -intel-loop-optreport=low -vplan-enable-new-cfg-merge 2>&1 | FileCheck %s -check-prefixes=OPTREPORT

...
; CHECK-NEXT:     [DA: Divergent] i32 [[VP_INC_2:%.*]] = add i32 [[VP3]] i32 1
; CHECK-NEXT:     [DA: Divergent] store i32 [[VP_INC_2]] i32* [[VP_ARRAYIDX_2]]
...
; CHECK-NEXT:    [[VEC_PHI0:%.*]] = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, [[VECTOR_PH0]] ], [ [[TMP15:%.*]], [[VECTOR_BODY0]] ]
...
; CHECK-NEXT:    [[TMP5:%.*]] = icmp eq <4 x i64> [[TMP3]], [[BROADCAST_SPLAT0]]
; CHECK-NEXT:    [[SCALAR_GEP10:%.*]] = getelementptr inbounds i32, i32* [[A0]], i64 [[TMP4]]
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i32* [[SCALAR_GEP10]] to <4 x i32>*
; CHECK-NEXT:    [[WIDE_LOAD20:%.*]] = load <4 x i32>, <4 x i32>* [[TMP6]], align 4
; CHECK-NEXT:    [[TMP7:%.*]] = add nsw <4 x i32> [[WIDE_LOAD20]], <i32 1, i32 1, i32 1, i32 1>
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i32* [[SCALAR_GEP10]] to <4 x i32>*
...
; CHECK-NEXT:    [[TMP11:%.*]] = icmp eq <4 x i64> [[TMP9]], [[BROADCAST_SPLAT0]]
; CHECK-NEXT:    [[SCALAR_GEP30:%.*]] = getelementptr inbounds i32, i32* [[A0]], i64 [[TMP10]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i32* [[SCALAR_GEP30]] to <4 x i32>*
; CHECK-NEXT:    [[WIDE_LOAD40:%.*]] = load <4 x i32>, <4 x i32>* [[TMP12]], align 4
; CHECK-NEXT:    [[TMP13:%.*]] = add nsw <4 x i32> [[WIDE_LOAD40]], <i32 1, i32 1, i32 1, i32 1>
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i32* [[SCALAR_GEP30]] to <4 x i32>*
...
; CHECK-NEXT:    [[TMP17:%.*]] = icmp eq <4 x i64> [[TMP15]], [[BROADCAST_SPLAT0]]
; CHECK-NEXT:    [[DOTEXTRACT_0_0:%.*]] = extractelement <4 x i1> [[TMP17]], i32 0
...
; CHECK-NEXT:    [[INC0:%.*]] = add nsw i32 [[TMP21]], 1

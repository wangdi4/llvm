...
define dso_local void @foo(float* noalias nocapture noundef %A, i64* nocapture noundef readonly %B, float* noalias nocapture noundef readonly %C, i32 noundef %N) local_unnamed_addr #0 {
;
; float A[N], C[N];
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx2 = getelementptr inbounds float, float* %A, i64 %0

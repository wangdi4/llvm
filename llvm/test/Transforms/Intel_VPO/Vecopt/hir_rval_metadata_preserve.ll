...
; RUN: opt %s -S -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -VPlanDriverHIR -print-after=VPlanDriverHIR -hir-details -disable-output 2>&1 | FileCheck %s
...
; CHECK-NEXT:  |   <LVAL-REG> NON-LINEAR <4 x double*> [[NSBGEPCOPY0]] {sb:13}
; CHECK-NEXT:  |
; CHECK-NEXT:  |   [[NSBGEPCOPY10:%.*]] = undef
; CHECK-NEXT:  |   <LVAL-REG> NON-LINEAR double* [[NSBGEPCOPY10]] {sb:15}
; CHECK-NEXT:  |
; CHECK-NEXT:  |   [[DOTVEC0:%.*]] = (<4 x double>*)([[NSBGEPCOPY10]])[0][%18 + -1][i1]
; CHECK-NEXT:  |   <LVAL-REG> NON-LINEAR <4 x double> [[DOTVEC0]] {sb:17}
;                  FIXME: should be "inbounds  !alias.scope !1 !noalias !4" (metadata loss)
; CHECK-NEXT:  |   <RVAL-REG> {al:1}(<4 x double>*)(NON-LINEAR double* [[NSBGEPCOPY10]])[i64 0][LINEAR i64 [[TMP18:%.*]] + -1][LINEAR i64 i1] inbounds  {undefined} {sb:10}
; CHECK-NEXT:  |      <BLOB> NON-LINEAR double* [[NSBGEPCOPY10]] {sb:15}
; CHECK-NEXT:  |      <BLOB> LINEAR i64 [[TMP18]] {sb:5}
; CHECK-NEXT:  |
; CHECK-NEXT:  |   [[NSBGEPCOPY20:%.*]] = undef
; CHECK-NEXT:  |   <LVAL-REG> NON-LINEAR <4 x double*> [[NSBGEPCOPY20]] {sb:18}
; CHECK-NEXT:  |
; CHECK-NEXT:  |   [[NSBGEPCOPY30:%.*]] = undef
; CHECK-NEXT:  |   <LVAL-REG> NON-LINEAR double* [[NSBGEPCOPY30]] {sb:20}
; CHECK-NEXT:  |
; CHECK-NEXT:  |   (<4 x double>*)([[NSBGEPCOPY30]])[0][%18 + -1][i1] = [[DOTVEC0]]
; CHECK-NEXT:  |   <LVAL-REG> {al:1}(<4 x double>*)(NON-LINEAR double* [[NSBGEPCOPY30]])[i64 0][LINEAR i64 [[TMP18]] + -1][LINEAR i64 i1] inbounds  !alias.scope !1 !noalias !4 {undefined} {sb:11}
; CHECK-NEXT:  |      <BLOB> NON-LINEAR double* [[NSBGEPCOPY30]] {sb:20}
; CHECK-NEXT:  |      <BLOB> LINEAR i64 [[TMP18]] {sb:5}
; CHECK-NEXT:  |   <RVAL-REG> NON-LINEAR <4 x double> [[DOTVEC0]] {sb:17}
; CHECK-NEXT:  |
; CHECK-NEXT:  + END LOOP
;
; CHECK:       + DO i64 i1 = 4, 4, 1   <DO_LOOP> <novectorize>
; CHECK-NEXT:  |   (undef)[0][%18 + -1][i1] = (undef)[0][%18 + -1][i1]
; CHECK-NEXT:  |   <LVAL-REG> {al:1}(double* undef)[i64 0][LINEAR i64 [[TMP18]] + -1][LINEAR i64 i1] inbounds  !alias.scope !1 !noalias !4 {undefined} {sb:11}
; CHECK-NEXT:  |      <BLOB> LINEAR i64 [[TMP18]] {sb:5}
; CHECK-NEXT:  |   <RVAL-REG> {al:1}(double* undef)[i64 0][LINEAR i64 [[TMP18]] + -1][LINEAR i64 i1] inbounds  !alias.scope !1 !noalias !4 {undefined} {sb:10}
; CHECK-NEXT:  |      <BLOB> LINEAR i64 [[TMP18]] {sb:5}
; CHECK-NEXT:  |
; CHECK-NEXT:  + END LOOP
;

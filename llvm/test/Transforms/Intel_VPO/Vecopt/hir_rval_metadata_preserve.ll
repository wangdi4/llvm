...
; RUN: opt -opaque-pointers=0 %s -S -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -hir-details -disable-output 2>&1 | FileCheck %s

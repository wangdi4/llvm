...
; CHECK-NEXT:     [DA: Uni] br i1 [[VP12]], [[BB16:BB[0-9]+]], [[BB14]]
; CHECK-EMPTY:
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP16]] = phi-merge  [ i64 0, [[PEEL_CHECKZ0]] ],  [ i64 [[VP6]], [[BB5]] ]
...
; CHECK-NEXT:       [DA: Div] i1 [[VP11]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_2]] i64 1024
; CHECK-NEXT:       [DA: Uni] i1 [[VP12]] = all-zero-check i1 [[VP11]]
; CHECK-NEXT:       [DA: Uni] br i1 [[VP12]], [[BB16]], [[BB14]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB16]]: # preds: new_latch19
; CHECK-NEXT:       [DA: Uni] i64 [[VP13]] = induction-final{add} i64 0 i64 1
...
; CHECK-NEXT:     [DA: Uni] i64 [[VP19]] = phi-merge  [ i64 [[VP_ORIG_LIVEOUT]], [[BB11]] ],  [ i64 [[VP13]], [[BB17]] ],  [ i64 live-out0, [[BB21]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:

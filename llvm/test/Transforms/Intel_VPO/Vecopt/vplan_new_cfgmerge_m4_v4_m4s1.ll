...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB14]]: # preds: [[BB13]], new_latch19
; CHECK-NEXT:     [DA: Div] i64 [[VP_INDVARS_IV_2:%.*]] = phi  [ i64 [[VP7]], [[BB13]] ],  [ i64 [[VP_INDVARS_IV_NEXT_2:%.*]], new_latch19 ]
...
; CHECK-NEXT:     [DA: Uni] br new_latch19
; CHECK-EMPTY:
; CHECK-NEXT:    new_latch19: # preds: [[BB15]]
...
; CHECK-NEXT:     [DA: Uni] br i1 [[VP14]], [[BB16:BB[0-9]+]], [[BB14]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB16]]: # preds: new_latch19
...
; CHECK-NEXT:   Kind: remainder VF:1 TC:3
...
; CHECK-NEXT:       [DA: Uni] token [[VP_VPLAN_ADAPTER:%.*]] = vplan-adapter for VPlan {test_store:for.body.#{{[0-9]+}}.ScalarRemainder} i64 [[VP17]]
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP19:%.*]] = add i64 [[VP18]] i64 4
; CHECK-NEXT:       [DA: Uni] i1 [[VP_PEEL_VEC_TC_CHECK_1:%.*]] = icmp ugt i64 [[VP19]] i64 1024
...
; CHECK-NEXT:         [DA: Uni] i64 [[VP_VECTOR_TRIP_COUNT]] = vector-trip-count i64 1024 i64 [[VP18]], UF = 1
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP20:%.*]] = phi-merge  [ i64 live-out0, [[BB21]] ],  [ i64 [[VP18]], [[BB20]] ]
; CHECK-NEXT:       [DA: Uni] br [[BB22:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB22]]: # preds: [[MERGE_BLK2]]
; CHECK-NEXT:       [DA: Uni] token [[VP_VPLAN_ADAPTER_1:%.*]] = vplan-adapter for VPlan {test_store:for.body.#{{[0-9]+}}.cloned.masked.cloned} i64 [[VP20]]
; CHECK-NEXT:       [DA: Uni] br final.merge
; CHECK-EMPTY:
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP18]] = phi-merge  [ i64 0, [[PEEL_CHECKZ0]] ],  [ i64 [[VP6]], [[BB5]] ]
...
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB12]]: # preds: [[MERGE_BLK2]]
; CHECK-NEXT:       [DA: Uni] pushvf VF=4 UF=1
...
; CHECK-NEXT:       [DA: Div] i64 [[VP7]] = induction-init{add} i64 0 i64 1
; CHECK-NEXT:       [DA: Uni] i64 [[VP8]] = induction-init-step{add} i64 1
; CHECK-NEXT:       [DA: Uni] i64 [[VP9]] = sub i64 1024 i64 [[VP20]]
; CHECK-NEXT:       [DA: Uni] br [[BB14]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB14]]: # preds: [[BB13]], new_latch19
; CHECK-NEXT:       [DA: Div] i64 [[VP_INDVARS_IV_2]] = phi  [ i64 [[VP7]], [[BB13]] ],  [ i64 [[VP_INDVARS_IV_NEXT_2]], new_latch19 ]
; CHECK-NEXT:       [DA: Div] i64 [[VP10]] = add i64 [[VP_INDVARS_IV_2]] i64 [[VP20]]
; CHECK-NEXT:       [DA: Div] i1 [[VP11]] = icmp ult i64 [[VP_INDVARS_IV_2]] i64 [[VP9]]
...
; CHECK-NEXT:       [DA: Div] i1 [[VP13]] = icmp ult i64 [[VP_INDVARS_IV_NEXT_2]] i64 [[VP9]]
; CHECK-NEXT:       [DA: Uni] i1 [[VP14]] = all-zero-check i1 [[VP13]]
; CHECK-NEXT:       [DA: Uni] br i1 [[VP14]], [[BB16]], [[BB14]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB16]]: # preds: new_latch19
; CHECK-NEXT:       [DA: Uni] i64 [[VP15]] = induction-final{add} i64 0 i64 1
...
; CHECK-NEXT:       [DA: Uni] br final.merge
; CHECK-EMPTY:
; CHECK-NEXT:    final.merge: # preds: [[BB21]], [[BB11]], [[BB17]]
; CHECK-NEXT:     [DA: Uni] i64 [[VP21]] = phi-merge  [ i64 [[VP_ORIG_LIVEOUT]], [[BB11]] ],  [ i64 [[VP15]], [[BB17]] ],  [ i64 live-out0, [[BB21]] ]
; CHECK-NEXT:     [DA: Uni] popvf
; CHECK-NEXT:     [DA: Uni] br <External Block>
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:

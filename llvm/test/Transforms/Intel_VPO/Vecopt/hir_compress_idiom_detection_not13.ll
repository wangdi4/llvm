...
define dso_local void @_Z3fooPdS_S_PiS0_S_i(ptr noalias nocapture noundef readnone %A1, ptr noalias nocapture noundef readnone %A2, ptr noalias nocapture noundef %B, ptr noalias nocapture noundef readonly %C1, ptr noalias nocapture noundef readonly %C2, ptr noalias nocapture noundef readnone %C3, i32 noundef %N) local_unnamed_addr #0 {
entry:

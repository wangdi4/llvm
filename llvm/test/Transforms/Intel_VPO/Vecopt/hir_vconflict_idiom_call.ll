...
define dso_local void @_Z4foo15PiS_S_(ptr noalias nocapture %A, ptr noalias nocapture readonly %B, ptr nocapture %C) local_unnamed_addr #0 {
entry:
  br label %for.body
...
for.body:                                         ; preds = %entry, %for.body
  ...
  call void @foo(ptr nonnull %ptridx2)

...
; REQUIRES: asserts
; RUN: opt -S -hir-ssa-deconstruction -hir-cost-model-throttling=0 -hir-vec-dir-insert -enable-vconflict-idiom -debug-only=parvec-analysis -tbaa < %s 2>&1 | FileCheck %s

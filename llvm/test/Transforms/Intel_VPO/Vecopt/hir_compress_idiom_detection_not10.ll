...
; CHECK:      [Compress/Expand Idiom] Increment {sb:3}+1 detected: {{.*}} %j.014 = %j.014  +  1;
; CHECK-NEXT: [Compress/Expand Idiom] Non-standalone blob found: 2 * %j.014
; CHECK-NEXT: [Compress/Expand Idiom] Increment rejected: <16>         %j.014 = %j.014  +  1;

...
define void @_ZGVeN16uuu__ZTSZZ4mainENKUlRN2cl4sycl7handlerEE_clES2_E11AtomicTests(i64 %_arg_m_capacity, ptr addrspace(1) %ptr, i1 zeroext %cmp.i.i) {
...
simd.begin.region:                                ; preds = %entry
  %entry.region = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 16), "QUAL.OMP.UNIFORM:TYPED"(ptr addrspace(1) %ptr, i64 0, i32 1), "QUAL.OMP.UNIFORM"(i1 %cmp.i.i), "QUAL.OMP.PRIVATE:TYPED"(ptr %.sroa.0, i64 0, i32 32),"QUAL.OMP.PRIVATE:TYPED"(ptr %alt, i64 0, i32 32) ]

...
; RUN: opt -disable-output -passes='hir-ssa-deconstruction,hir-loop-collapse,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -hir-details -vplan-force-vf=16 -vplan-enable-masked-main-loop < %s 2>&1 | FileCheck %s
;

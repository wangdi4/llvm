...
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,vplan-driver-hir" -vplan-print-after-linearization -vplan-force-vf=4 -print-after=vplan-driver-hir -disable-output < %s 2>&1 | FileCheck %s

...
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>" -vplan-print-after-predicator -vplan-force-vf=4 -disable-output < %s 2>&1 | FileCheck %s

...
DIR.OMP.SIMD.135:                                 ; preds = %DIR.OMP.SIMD.1
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 8), "QUAL.OMP.LINEAR:IV"(i64* %i2.linear.iv, i32 2) ]
  br label %DIR.OMP.SIMD.2

DIR.OMP.SIMD.2:                                   ; preds = %DIR.OMP.SIMD.135
  %2 = bitcast i64* %i2.linear.iv to i8*
  br label %omp.inner.for.body

omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.2, %omp.inner.for.body
  %.omp.iv.local.028 = phi i64 [ 0, %DIR.OMP.SIMD.2 ], [ %add4, %omp.inner.for.body ]
  %mul = shl nuw nsw i64 %.omp.iv.local.028, 1
  store i64 %mul, i64* %i2.linear.iv, align 8
  %call = call noundef i64 @_Z3fooRl(i64* noundef nonnull align 8 dereferenceable(8) %i2.linear.iv) #2
  %3 = load i64, i64* %i2.linear.iv, align 8
  %arrayidx3 = getelementptr inbounds [128 x i64], [128 x i64]* %a, i64 0, i64 %3

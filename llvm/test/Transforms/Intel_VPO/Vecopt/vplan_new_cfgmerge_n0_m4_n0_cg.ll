...
; RUN: opt -opaque-pointers=0 -passes='vplan-vec' -vplan-vec-scenario="n0;m4;n0" -print-after=vplan-vec -vplan-enable-peeling -disable-output %s 2>&1 | FileCheck %s
...
; CHECK-NEXT:    [[SCALAR_GEP0:%.*]] = getelementptr inbounds i64, i64* [[ARY0]], i64 [[DOTEXTRACT_0_0]]

...
; RUN: opt -enable-new-pm=0 -vplan-vec -vplan-vec-scenario="n0;m4;n0" -vplan-enable-new-cfg-merge -print-after=vplan-vec -vplan-enable-peeling -disable-output %s 2>&1 | FileCheck %s
; RUN: opt -passes='vplan-vec' -vplan-vec-scenario="n0;m4;n0" -vplan-enable-new-cfg-merge -print-after=vplan-vec -vplan-enable-peeling -disable-output %s 2>&1 | FileCheck %s

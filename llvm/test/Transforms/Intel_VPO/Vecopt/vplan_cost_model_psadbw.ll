...
; CHECK-NEXT:    Cost 1000 for i32 [[VP4:%.*]] = zext i8 [[VP_LOAD]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP5:%.*]] = zext i8 [[VP_LOAD_1]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP6:%.*]] = mul i32 [[VP5]] i32 -1 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP7:%.*]] = add i32 [[VP4]] i32 [[VP6]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 2000 for i32 [[VP8:%.*]] = abs i32 [[VP7]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP0]] = add i32 [[VP8]] i32 [[VP1]] *PSADBW* (CarryOut Def)
...
; CHECK-NEXT:    Cost 1000 for i32 [[VP8:%.*]] = zext i8 [[VP_LOAD_1]] to i32 *PSADBW*, CarryOut: [[VP0]]
...
; CHECK-NEXT:    Cost 1000 for i32 [[VP16:%.*]] = zext i8 [[VP_LOAD_2]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP17:%.*]] = zext i8 [[VP_LOAD_3]] to i32 *PSADBW*, CarryOut: [[VP0]]
...
; CHECK-NEXT:    Cost 1000 for i32 [[VP25:%.*]] = zext i8 [[VP_LOAD_4]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP26:%.*]] = zext i8 [[VP_LOAD_5]] to i32 *PSADBW*, CarryOut: [[VP0]]
...
; CHECK-NEXT:    Cost 1000 for i32 [[VP34:%.*]] = zext i8 [[VP_LOAD_6]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP35:%.*]] = zext i8 [[VP_LOAD_7]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP36:%.*]] = mul i32 [[VP35]] i32 -1 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP37:%.*]] = add i32 [[VP34]] i32 [[VP36]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 2000 for i32 [[VP38:%.*]] = abs i32 [[VP37]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 0 for i64 [[VP39:%.*]] = zext i32 [[VP29]] to i64 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 0 for i64 [[VP40:%.*]] = zext i32 [[VP20]] to i64 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i64 [[VP41:%.*]] = add i64 [[VP39]] i64 [[VP40]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 0 for i64 [[VP42:%.*]] = zext i32 [[VP11]] to i64 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i64 [[VP43:%.*]] = add i64 [[VP41]] i64 [[VP42]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i64 [[VP44:%.*]] = add i64 [[VP43]] i64 [[VP4]]
; CHECK-NEXT:    Cost 0 for i64 [[VP45:%.*]] = zext i32 [[VP38]] to i64 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i64 [[VP0]] = add i64 [[VP44]] i64 [[VP45]] *PSADBW* (CarryOut Def)
; CHECK-NEXT:    Cost 1000 for i64 [[VP3]] = add i64 [[VP2]] i64 [[VP__IND_INIT_STEP]]
...
; CHECK-NEXT:    Cost 1000 for i8 [[VP_LOAD_3:%.*]] = load i8* [[VP_SUBSCRIPT_3]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP9:%.*]] = zext i8 [[VP_LOAD_2]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP10:%.*]] = zext i8 [[VP_LOAD_3]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP11:%.*]] = mul i32 [[VP10]] i32 -1 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP12:%.*]] = add i32 [[VP9]] i32 [[VP11]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 2000 for i32 [[VP13:%.*]] = abs i32 [[VP12]] *PSADBW*, CarryOut: [[VP0]]
...
; CHECK-NEXT:    Cost 1000 for i8 [[VP_LOAD_5:%.*]] = load i8* [[VP_SUBSCRIPT_5]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP14:%.*]] = zext i8 [[VP_LOAD_4]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP15:%.*]] = zext i8 [[VP_LOAD_5]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP16:%.*]] = mul i32 [[VP15]] i32 -1 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP17:%.*]] = add i32 [[VP14]] i32 [[VP16]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 2000 for i32 [[VP18:%.*]] = abs i32 [[VP17]] *PSADBW*, CarryOut: [[VP0]]
...
; CHECK-NEXT:    Cost 1000 for i8 [[VP_LOAD_7:%.*]] = load i8* [[VP_SUBSCRIPT_7]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP19:%.*]] = zext i8 [[VP_LOAD_6]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP20:%.*]] = zext i8 [[VP_LOAD_7]] to i32 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP21:%.*]] = mul i32 [[VP20]] i32 -1 *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP22:%.*]] = add i32 [[VP19]] i32 [[VP21]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 2000 for i32 [[VP23:%.*]] = abs i32 [[VP22]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP24:%.*]] = add i32 [[VP13]] i32 [[VP8]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP25:%.*]] = add i32 [[VP24]] i32 [[VP23]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP26:%.*]] = add i32 [[VP25]] i32 [[VP18]] *PSADBW*, CarryOut: [[VP0]]
; CHECK-NEXT:    Cost 1000 for i32 [[VP0]] = add i32 [[VP26]] i32 [[VP1]] *PSADBW* (CarryOut Def)
; CHECK-NEXT:    Cost 1000 for i64 [[VP3]] = add i64 [[VP2]] i64 [[VP__IND_INIT_STEP]]

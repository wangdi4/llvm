...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP2]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD:%.*]] = load ptr [[VP_SUBSCRIPT]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP2]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_1:%.*]] = load ptr [[VP_SUBSCRIPT_1]]
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP5]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD:%.*]] = load ptr [[VP_SUBSCRIPT]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP5]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_1:%.*]] = load ptr [[VP_SUBSCRIPT_1]]
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP13]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_2:%.*]] = load ptr [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_3:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP13]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_3:%.*]] = load ptr [[VP_SUBSCRIPT_3]]
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_4:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP22]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_4:%.*]] = load ptr [[VP_SUBSCRIPT_4]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_5:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP22]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_5:%.*]] = load ptr [[VP_SUBSCRIPT_5]]
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_6:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP31]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_6:%.*]] = load ptr [[VP_SUBSCRIPT_6]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_7:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP31]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_7:%.*]] = load ptr [[VP_SUBSCRIPT_7]]
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx7 = getelementptr inbounds [1024 x i8], ptr @a, i64 0, i64 %4
  %5 = load i8, ptr %arrayidx7, align 1
  %conv8 = zext i8 %5 to i32
  %arrayidx11 = getelementptr inbounds [1024 x i8], ptr @b, i64 0, i64 %4
  ...
  %arrayidx19 = getelementptr inbounds [1024 x i8], ptr @a, i64 0, i64 %9
  %10 = load i8, ptr %arrayidx19, align 2
  %conv20 = zext i8 %10 to i32
  %arrayidx23 = getelementptr inbounds [1024 x i8], ptr @b, i64 0, i64 %9
  %11 = load i8, ptr %arrayidx23, align 2
  ...
  %arrayidx31 = getelementptr inbounds [1024 x i8], ptr @a, i64 0, i64 %14
  %15 = load i8, ptr %arrayidx31, align 1
  %conv32 = zext i8 %15 to i32
  %arrayidx35 = getelementptr inbounds [1024 x i8], ptr @b, i64 0, i64 %14
...
; CHECK-NEXT:    Cost 1 for i32 [[VP7:%.*]] = add i32 [[VP4]] i32 [[VP6]] *PSADBW*, CarryOut: [[VP1]]
; CHECK-NEXT:    Cost 2 for i32 [[VP8:%.*]] = abs i32 [[VP7]] *PSADBW*, CarryOut: [[VP1]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP2]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_2:%.*]] = load ptr [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_3:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP2]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_3:%.*]] = load ptr [[VP_SUBSCRIPT_3]]
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_4:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP2]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_4:%.*]] = load ptr [[VP_SUBSCRIPT_4]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_5:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP2]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_5:%.*]] = load ptr [[VP_SUBSCRIPT_5]]
...
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_6:%.*]] = subscript inbounds ptr @a i64 0 i64 [[VP2]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_6:%.*]] = load ptr [[VP_SUBSCRIPT_6]]
; CHECK-NEXT:    Cost 0 for ptr [[VP_SUBSCRIPT_7:%.*]] = subscript inbounds ptr @b i64 0 i64 [[VP2]]
; CHECK-NEXT:    Cost 1 for i8 [[VP_LOAD_7:%.*]] = load ptr [[VP_SUBSCRIPT_7]]
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx1.0 = getelementptr inbounds [1024 x i8], ptr @a, i64 0, i64 %indvars.iv
  %val1.0 = load i8, ptr %arrayidx1.0, align 1
  %conv.0 = zext i8 %val1.0 to i32
  %arrayidx2.0 = getelementptr inbounds [1024 x i8], ptr @b, i64 0, i64 %indvars.iv
  %val2.0 = load i8, ptr %arrayidx2.0, align 1
  ...
  %arrayidx1.1 = getelementptr inbounds [1024 x i8], ptr @a, i64 0, i64 %indvars.iv
  %val1.1 = load i8, ptr %arrayidx1.1, align 1
  %conv.1 = zext i8 %val1.1 to i32
  %arrayidx2.1 = getelementptr inbounds [1024 x i8], ptr @b, i64 0, i64 %indvars.iv
  %val2.1 = load i8, ptr %arrayidx2.1, align 1
  ...
  %arrayidx1.2 = getelementptr inbounds [1024 x i8], ptr @a, i64 0, i64 %indvars.iv
  %val1.2 = load i8, ptr %arrayidx1.2, align 1
  %conv.2 = zext i8 %val1.2 to i32
  %arrayidx2.2 = getelementptr inbounds [1024 x i8], ptr @b, i64 0, i64 %indvars.iv
  %val2.2 = load i8, ptr %arrayidx2.2, align 1
  ...
  %arrayidx1.3 = getelementptr inbounds [1024 x i8], ptr @a, i64 0, i64 %indvars.iv
  %val1.3 = load i8, ptr %arrayidx1.3, align 1
  %conv.3 = zext i8 %val1.3 to i32
  %arrayidx2.3 = getelementptr inbounds [1024 x i8], ptr @b, i64 0, i64 %indvars.iv
  %val2.3 = load i8, ptr %arrayidx2.3, align 1

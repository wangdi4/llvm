; RUN: opt %s -VPlanDriver -vplan-predicator-report -disable-predicator-opts -disable-vplan-codegen -S -o /dev/null | FileCheck %s -check-prefix=NOOPT
...
; NOOPT:   [[BB_5:BB[0-9]+]]:
; NOOPT:     [[BP_32:BP[0-9]+]] = [[BP_33]] || [[BP_31]] || [[IfF_39]] 

; NOOPT: [[region_23]]:
; NOOPT:   [[BB_4:BB[0-9]+]]:
; NOOPT:     [[BP_40:BP[0-9]+]] = [[IfT_35]]
; NOOPT:     [[IfF_45:IfF[0-9]+]] = [[BP_40]] && ![[VBR_44:%vp[0-9]+]]
...
; OPT:     [[IfF_45:IfF[0-9]+]] = [[BP_40]] && ![[VBR_44:%vp[0-9]+]]
...
; OPT:   [[BB_18:BB[0-9]+]]:
; OPT-NOT: BP[0-9]+ =
; OPT:     [[IfT_35]] = [[VBR_34:%vp[0-9]+]]
; OPT:     [[IfF_39:IfF[0-9]+]] = ![[VBR_34]]
; OPT:   [[region_23]]:
; OPT:     [[IfT_35]] = [[VBR_34]]
; OPT:   [[BB_20:BB[0-9]+]]:
; OPT:     [[BP_30:BP[0-9]+]] = [[IfT_35]]
; OPT:     [[IfF_37:IfF[0-9]+]] = [[BP_30]] && ![[VBR_36:%vp[0-9]+]]

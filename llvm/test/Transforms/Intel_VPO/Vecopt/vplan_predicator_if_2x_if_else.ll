...
; RUN: opt %s -VPlanDriver -enable-new-vplan-predicator=false -vplan-predicator-report -disable-predicator-opts -disable-vplan-codegen -S -o /dev/null | FileCheck %s -check-prefix=NOOPT

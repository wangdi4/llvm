...
define dso_local void @foo(double* noalias nocapture noundef %A, i16* nocapture noundef readonly %B, double* noalias nocapture noundef readonly %C) local_unnamed_addr #0 {
;
; double A[8], C[8];
; short B[8]; // conflict idx
; for (int i=0; i<8; ++i) {
;   int index = B[i];
;   A[index] = A[index] + C[i];
; }
...
; CHECK-VF4-NEXT:        |   [[DOTVEC0:%.*]] = (<4 x i16>*)([[B0:%.*]])[i1]
...
; CHECK-VF8-NEXT:        |   [[DOTVEC0:%.*]] = (<8 x i16>*)([[B0:%.*]])[i1]

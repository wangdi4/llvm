...
for.body.epil:                                    ; preds = %for.cond.for.cond.cleanup_crit_edge.unr-lcssa, %for.body.epil
  ...
  %arrayidx.epil = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %i.08.epil
  store i32 %conv.epil, ptr addrspace(1) %arrayidx.epil, align 4, !tbaa !16
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %arrayidx = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %i.08
  store i32 %conv, ptr addrspace(1) %arrayidx, align 4, !tbaa !16
  %inc = or i64 %i.08, 1
  %conv.1 = trunc i64 %inc to i32
  %arrayidx.1 = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %inc
  store i32 %conv.1, ptr addrspace(1) %arrayidx.1, align 4, !tbaa !16
  %inc.1 = or i64 %i.08, 2
  %conv.2 = trunc i64 %inc.1 to i32
  %arrayidx.2 = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %inc.1
  store i32 %conv.2, ptr addrspace(1) %arrayidx.2, align 4, !tbaa !16
  %inc.2 = or i64 %i.08, 3
  %conv.3 = trunc i64 %inc.2 to i32
  %arrayidx.3 = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %inc.2
  store i32 %conv.3, ptr addrspace(1) %arrayidx.3, align 4, !tbaa !16
  %inc.3 = or i64 %i.08, 4
  %conv.4 = trunc i64 %inc.3 to i32
  %arrayidx.4 = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %inc.3
  store i32 %conv.4, ptr addrspace(1) %arrayidx.4, align 4, !tbaa !16
  %inc.4 = or i64 %i.08, 5
  %conv.5 = trunc i64 %inc.4 to i32
  %arrayidx.5 = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %inc.4
  store i32 %conv.5, ptr addrspace(1) %arrayidx.5, align 4, !tbaa !16
  %inc.5 = or i64 %i.08, 6
  %conv.6 = trunc i64 %inc.5 to i32
  %arrayidx.6 = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %inc.5
  store i32 %conv.6, ptr addrspace(1) %arrayidx.6, align 4, !tbaa !16
  %inc.6 = or i64 %i.08, 7
  %conv.7 = trunc i64 %inc.6 to i32
  %arrayidx.7 = getelementptr inbounds i32, ptr addrspace(1) %dst, i64 %inc.6
  store i32 %conv.7, ptr addrspace(1) %arrayidx.7, align 4, !tbaa !16
...
define [7 x i64] @WG.boundaries.pragma_unroll(ptr addrspace(1)) !ocl_recommended_vector_length !23 {
entry:

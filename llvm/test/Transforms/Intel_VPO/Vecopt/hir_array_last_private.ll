...
; CHECK-NEXT:        %tgu = (%n + 1)/u4
; CHECK-NEXT:        if (0 <u 4 * %tgu)
; CHECK-NEXT:        {
; CHECK-NEXT:           %priv.mem.bc = &(([12 x i16]*)(%priv.mem)[0])
; CHECK:           + DO i1 = 0, 4 * %tgu + -1, 4   <DO_LOOP> <simd-vectorized> <nounroll> <novectorize>
...
; CHECK-NEXT:        }
; CHECK:        + DO i1 = 4 * %tgu, %n, 1   <DO_LOOP>  <MAX_TC_EST = 3>  <LEGAL_MAX_TC = 3> <nounroll> <novectorize> <max_trip_count = 3>

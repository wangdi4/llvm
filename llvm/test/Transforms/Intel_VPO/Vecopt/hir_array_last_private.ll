...
; RUN: opt -enable-new-pm=0 -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -print-after=hir-vplan-vec -disable-output -vplan-force-vf=4 -vplan-enable-new-cfg-merge-hir=false %s 2>&1 | FileCheck %s
; RUN: opt -enable-new-pm=0 -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -print-after=hir-vplan-vec -disable-output -vplan-force-vf=4 -vplan-enable-new-cfg-merge-hir %s 2>&1 | FileCheck %s

...
; RUN: opt -opaque-pointers=0 -enable-new-pm=0 -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -print-after=hir-vplan-vec -disable-output -vplan-force-vf=4 %s 2>&1 | FileCheck %s

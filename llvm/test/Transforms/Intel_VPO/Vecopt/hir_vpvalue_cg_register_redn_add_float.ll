...
; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -VPlanDriverHIR -vplan-force-vf=4 -vplan-use-entity-instr -enable-vp-value-codegen -print-after=VPlanDriverHIR -disable-output < %s 2>&1 | FileCheck %s
; Mixed codegen

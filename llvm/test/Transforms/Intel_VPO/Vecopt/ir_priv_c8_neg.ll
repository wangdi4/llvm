...
define dso_local i32 @_Z3fooPiS_(ptr nocapture readonly %a, ptr nocapture readonly %b) local_unnamed_addr #0 {
...
; CHECK-NEXT:     ptr [[VP_ARRAYIDX3:%.*]] = getelementptr inbounds i32, ptr [[B0:%.*]] i64 [[VP_INDVARS_IV]]
; CHECK-NEXT:     i32 [[VP2:%.*]] = load ptr [[VP_ARRAYIDX3]]
...
; CHECK-NEXT:       ptr [[VP_ARRAYIDX6:%.*]] = getelementptr inbounds i32, ptr [[B0]] i64 [[VP3]]
; CHECK-NEXT:       i32 [[VP4:%.*]] = load ptr [[VP_ARRAYIDX6]]
...
DIR.OMP.SIMD.1:                                   ; preds = %DIR.OMP.SIMD.136
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.LASTPRIVATE:TYPED"(ptr %v.lpriv, i32 0, i32 1), "QUAL.OMP.REDUCTION.ADD:TYPED"(ptr %s.red, i32 0, i32 1), "QUAL.OMP.LINEAR:IV.TYPED"(ptr %i.linear.iv, i32 0, i32 1, i32 1) ]
...
cond.true:                                        ; preds = %omp.inner.for.body
  ...
  %mul7 = mul nsw i32 %5, %add1
  br label %cond.end

cond.end:                                         ; preds = %omp.inner.for.body, %cond.true
  %cond = phi i32 [ %mul7, %cond.true ], [ %2, %omp.inner.for.body ]
...
DIR.OMP.END.SIMD.237:                             ; preds = %cond.end
  ...
  store i32 %cond.lcssa, ptr %v.lpriv

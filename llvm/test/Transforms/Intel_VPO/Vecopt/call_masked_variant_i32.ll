...
; CHECK-NEXT:    [[TMP4:%.*]] = call x86_regcallcc { <16 x i32>, <16 x i32> } @_ZGVZM32v_vfunc(<16 x i32> noundef [[WIDE_LOAD_PART_0_OF_2_0]], <16 x i32> noundef [[WIDE_LOAD_PART_1_OF_2_0]], i32 zext (i16 bitcast (<16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true> to i16) to i32), i32 zext (i16 bitcast (<16 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true> to i16) to i32)) #0
;

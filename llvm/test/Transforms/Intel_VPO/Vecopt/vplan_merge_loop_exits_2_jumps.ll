...
; CHECK-NEXT:       [DA: Uniform]   i32 [[VP_K_INC:%.*]] = add i32 [[VP_PHI_INNER_LOOP_INDUCTION]] i32 1
; CHECK-NEXT:       [DA: Uniform]   i1 [[VP_CMP2:%.*]] = icmp i32 [[VP_K_INC]] i32 16
...
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP2:%.*]] = icmp i32 [[VP1]] i32 1
; CHECK-NEXT:    SUCCESSORS(2):[[BB8:BB[0-9]+]](i1 [[VP2]]), [[CASCADEDIFBLOCK1:CascadedIfBlock[0-9]+]](!i1 [[VP2]])
; CHECK-NEXT:    PREDECESSORS(1): [[NEWLOOPLATCH0]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[CASCADEDIFBLOCK1]] (BP: NULL) :
; CHECK-NEXT:       [DA: Uniform]   i1 [[VP3:%.*]] = icmp i32 [[VP1]] i32 2
; CHECK-NEXT:      SUCCESSORS(2):[[BB9:BB[0-9]+]](i1 [[VP3]]), [[BB10:BB[0-9]+]](!i1 [[VP3]])
; CHECK-NEXT:      PREDECESSORS(1): [[CASCADEDIFBLOCK0]]
; CHECK-EMPTY:
; CHECK-NEXT:        [[BB10]] (BP: NULL) :
; CHECK-NEXT:         <Empty Block>
; CHECK-NEXT:        SUCCESSORS(1):[[BB3]]
; CHECK-NEXT:        PREDECESSORS(1): [[CASCADEDIFBLOCK1]]
; CHECK-EMPTY:
...
; CHECK-NEXT:       <Empty Block>
; CHECK-NEXT:      SUCCESSORS(1):[[BB3]]
; CHECK-NEXT:      PREDECESSORS(2): [[BB9]] [[BB8]]
; CHECK-EMPTY:
...
; CHECK-NEXT:    PREDECESSORS(2): [[BB10]] [[BB11]]
; CHECK-EMPTY:
...
bb1:
  %k_inc = add nsw i32 %phi.inner.loop.induction, 1
...
inner.loop.latch:
  ...
  br i1 %bottom_test, label %inner.loop, label %exit_bb3

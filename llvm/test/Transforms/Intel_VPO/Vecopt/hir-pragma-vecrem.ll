...
; CHECK-NEXT:        {
; CHECK-NEXT:           goto [[MERGE_BLK2:merge.blk[0-9]+]].65
; CHECK-NEXT:        }
...
; CHECK-NEXT:        + END LOOP
; CHECK:             [[PHI_TEMP460]] = [[S_090]]
; CHECK-NEXT:        [[PHI_TEMP480]] = [[N0]] + -1
; CHECK-NEXT:        final.merge.101:

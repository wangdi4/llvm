...
; RUN: opt < %s -vplan-vec -vplan-force-vf=2 -vplan-enable-int-divrem-blend-with-safe-value=0 -S | FileCheck %s
; RUN: opt < %s -vplan-vec -vplan-force-vf=2  -intel-ir-optreport-emitter -intel-opt-report=high -disable-output -vplan-enable-int-divrem-blend-with-safe-value=0 2>&1 | FileCheck %s -check-prefixes=OPTREPORT

; RUN: opt %s -enable-new-pm=0 -hir-ssa-deconstruction -hir-temp-cleanup -hir-vplan-vec -vplan-force-vf=2 -print-after=hir-vplan-vec -vplan-enable-int-divrem-blend-with-safe-value=0 -disable-output 2>&1 | FileCheck %s -check-prefixes=HIR
; RUN: opt %s -enable-new-pm=0 -hir-ssa-deconstruction -hir-temp-cleanup -hir-vplan-vec -vplan-force-vf=2  -hir-optreport-emitter -vplan-enable-int-divrem-blend-with-safe-value=0 -intel-opt-report=high -disable-output 2>&1 | FileCheck %s -check-prefixes=HIR-OPTREPORT
...
; RUN: opt < %s -vplan-vec -vplan-force-vf=2  -S | FileCheck %s -check-prefixes=BLENDED
; RUN: opt < %s -vplan-vec -vplan-force-vf=2  -intel-ir-optreport-emitter -intel-opt-report=high -disable-output  2>&1 | FileCheck %s -check-prefixes=OPTREPORT-BLENDED

; RUN: opt %s -enable-new-pm=0 -hir-ssa-deconstruction -hir-temp-cleanup -hir-vplan-vec -vplan-force-vf=2 -print-after=hir-vplan-vec  -disable-output 2>&1 | FileCheck %s -check-prefixes=HIR-BLENDED
; RUN: opt %s -enable-new-pm=0 -hir-ssa-deconstruction -hir-temp-cleanup -hir-vplan-vec -vplan-force-vf=2  -hir-optreport-emitter  -intel-opt-report=high -disable-output 2>&1 | FileCheck %s -check-prefixes=HIR-OPTREPORT-BLENDED

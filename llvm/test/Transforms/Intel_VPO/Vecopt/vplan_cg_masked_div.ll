...
; RUN: opt -opaque-pointers=0 < %s -passes=vplan-vec -vplan-force-vf=2 -vplan-enable-int-divrem-blend-with-safe-value=0 -S | FileCheck %s
; RUN: opt -opaque-pointers=0 < %s -passes=vplan-vec,intel-ir-optreport-emitter -vplan-force-vf=2 -intel-opt-report=high -disable-output -vplan-enable-int-divrem-blend-with-safe-value=0 2>&1 | FileCheck %s -check-prefixes=OPTREPORT

; RUN: opt -opaque-pointers=0 %s -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec" -vplan-force-vf=2 -print-after=hir-vplan-vec -vplan-enable-int-divrem-blend-with-safe-value=0 -disable-output 2>&1 | FileCheck %s -check-prefixes=HIR
; RUN: opt -opaque-pointers=0 %s -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,hir-optreport-emitter" -vplan-force-vf=2   -intel-opt-report=high -vplan-enable-int-divrem-blend-with-safe-value=0 -disable-output 2>&1 | FileCheck %s -check-prefixes=HIR-OPTREPORT

; RUN: opt -opaque-pointers=0 < %s -passes=vplan-vec -vplan-force-vf=2  -S | FileCheck %s -check-prefixes=BLENDED
; RUN: opt -opaque-pointers=0 < %s -passes=vplan-vec,intel-ir-optreport-emitter -vplan-force-vf=2 -intel-opt-report=high -disable-output  2>&1 | FileCheck %s -check-prefixes=OPTREPORT-BLENDED

; RUN: opt -opaque-pointers=0 %s -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec" -vplan-force-vf=2 -print-after=hir-vplan-vec  -disable-output 2>&1 | FileCheck %s -check-prefixes=HIR-BLENDED
; RUN: opt -opaque-pointers=0 %s -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vplan-vec,hir-optreport-emitter" -vplan-force-vf=2   -intel-opt-report=high  -disable-output 2>&1 | FileCheck %s -check-prefixes=HIR-OPTREPORT-BLENDED

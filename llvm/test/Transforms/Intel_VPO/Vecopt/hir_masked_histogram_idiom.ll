...
; RUN: opt -opaque-pointers=0 -mattr=+avx512vl,+avx512cd -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -vplan-force-vf=4 -vplan-print-after-optimize-vconflict-idiom -disable-output < %s 2>&1 | FileCheck %s

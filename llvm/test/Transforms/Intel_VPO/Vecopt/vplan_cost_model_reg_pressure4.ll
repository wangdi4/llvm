...
; VPLAN-CM-AVX2-NEXT:  Total VPlan Cost: 1292
; VPLAN-CM-AVX2-NEXT:  VPlan Base Cost before adjustments: 476
; VPLAN-CM-AVX2-NEXT:  VPlan Base Cost includes Total VPlan GS Cost: 320
; VPLAN-CM-AVX2-NEXT:  Total VPlan GS Cost is bumped: +640
; VPLAN-CM-AVX2-NEXT:  Total VPlan spill/fill cost: +176
...
; VPLAN-CM-AVX2-NEXT:  Analyzing VPBasicBlock [[BB2:BB[0-9]+]], total cost: 476
; VPLAN-CM-AVX2-NEXT:  total cost includes GS Cost: 320
; VPLAN-CM-AVX2-NEXT:  Block Vector spill/fill approximate cost (not included into total cost): 176
...
; VPLAN-CM-AVX2-NEXT:    Cost 4 for i64 [[VP_LOAD:%.*]] = load i64* [[VP_SUBSCRIPT]]
; VPLAN-CM-AVX2-NEXT:    Cost 4 for i64 [[VP2:%.*]] = mul i64 [[VP_LOAD]] i64 2
; VPLAN-CM-AVX2-NEXT:    Cost 32 for i64 [[VP3:%.*]] = mul i64 2 i64 [[VP0]]
...
; VPLAN-CM-AVX2-NEXT:    Cost 32 for i64 [[VP5:%.*]] = mul i64 3 i64 [[VP0]]
...
; VPLAN-CM-AVX2-NEXT:    Cost 32 for i64 [[VP7:%.*]] = mul i64 4 i64 [[VP0]]
...
; VPLAN-CM-AVX2-NEXT:    Cost 32 for i64 [[VP8:%.*]] = mul i64 5 i64 [[VP0]]
...
; VPLAN-CM-AVX2-NEXT:    Cost 4 for i1 [[VP9:%.*]] = icmp sle i64 [[VP1]] i64 1023
...
; VPLAN-CM-AVX512-NEXT:    Cost 16 for i64 [[VP3:%.*]] = mul i64 2 i64 [[VP0]]
...
; VPLAN-CM-AVX512-NEXT:    Cost 16 for i64 [[VP5:%.*]] = mul i64 3 i64 [[VP0]]
...
; VPLAN-CM-AVX512-NEXT:    Cost 16 for i64 [[VP7:%.*]] = mul i64 4 i64 [[VP0]]
...
; VPLAN-CM-AVX512-NEXT:    Cost 16 for i64 [[VP8:%.*]] = mul i64 5 i64 [[VP0]]
...
; VPLAN-CM-AVX512-NEXT:    Cost 2 for i1 [[VP9:%.*]] = icmp sle i64 [[VP1]] i64 1023
; VPLAN-CM-AVX512-NEXT:  Analyzing VPBasicBlock [[BB3:BB[0-9]+]], total cost: 0
; VPLAN-CM-AVX512-NEXT:    Cost Unknown for i64 [[VP__IND_FINAL:%.*]] = induction-final{add} i64 live-in0 i64 1
; VPLAN-CM-AVX512-NEXT:  Analyzing VPBasicBlock [[BB4:BB[0-9]+]], total cost: 0
;
entry:
  br label %for.body

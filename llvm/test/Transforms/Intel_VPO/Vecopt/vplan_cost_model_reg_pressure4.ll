...
; VPLAN-CM-AVX2-NEXT:  Total Cost: 1292004
; VPLAN-CM-AVX2-NEXT:  Base Cost: 476004
...
; VPLAN-CM-AVX2-NEXT:  Analyzing VPBasicBlock [[BB2]], total cost: 476004
...
; VPLAN-CM-AVX2-NEXT:    Cost 4004 for i64 [[VP_LOAD:%.*]] = load i64* [[VP_SUBSCRIPT]]
...
; VPLAN-CM-AVX512-NEXT:  Total Cost: 510004
; VPLAN-CM-AVX512-NEXT:  Base Cost: 222004
...
; VPLAN-CM-AVX512-NEXT:  Analyzing VPBasicBlock [[BB2]], total cost: 222004
...
; VPLAN-CM-AVX512-NEXT:    Cost 2004 for i64 [[VP_LOAD:%.*]] = load i64* [[VP_SUBSCRIPT]]

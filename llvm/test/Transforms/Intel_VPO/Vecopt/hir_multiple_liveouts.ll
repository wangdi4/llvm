...
; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -VPlanDriverHIR -disable-output -vplan-print-after-hcfg < %s 2>&1 | FileCheck %s
...
; CHECK:          i32 [[VP__RED_INIT:%.*]] = reduction-init i32 0 i32 %x4.sroa.0.140

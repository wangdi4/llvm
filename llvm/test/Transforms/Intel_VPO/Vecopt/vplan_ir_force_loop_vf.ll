...
; RUN: opt < %s -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -disable-output -vplan-force-vf=4 -vplan-force-loop-vf=2:2 -vplan-force-loop-vf=3:8  -debug-only=LoopVectorizationPlanner -print-after=hir-vplan-vec  -enable-vp-value-codegen-hir 2>&1 | FileCheck %s --check-prefixes=CHECK,HIR

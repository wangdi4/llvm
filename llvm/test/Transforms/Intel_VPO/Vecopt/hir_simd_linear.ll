...
define void @_Z3fooPlS_(ptr nocapture noundef writeonly %lp1, ptr nocapture noundef readnone %lp2) {
...
omp.inner.for.body:                               ; preds = %omp.inner.for.body, %DIR.OMP.SIMD.118
  ...
  %arrayidx = getelementptr inbounds i64, ptr %lp1, i64 %.omp.iv.local.011
  store i64 %1, ptr %arrayidx, align 8
  %add1 = add nsw i64 %1, 2
  store i64 %add1, ptr %l2.linear, align 8

...
define hidden zeroext i1 @_ZN11__sanitizer11mem_is_zeroEPKcm(ptr %beg, i32 %size) local_unnamed_addr  {
entry:
  br label %if.end

if.end:                                           ; preds = %entry
  %add.ptr = getelementptr inbounds i8, ptr %beg, i32 %size
  %0 = ptrtoint ptr %beg to i32
  %sub.i = add i32 %0, 3
  %and.i = and i32 %sub.i, -4
  %1 = inttoptr i32 %and.i to ptr
  %2 = ptrtoint ptr %add.ptr to i32
  %and.i59 = and i32 %2, -4
  %3 = inttoptr i32 %and.i59 to ptr
  %4 = inttoptr i32 %and.i to ptr
  %cmp567 = icmp ugt ptr %4, %beg
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  %mem.070 = phi ptr [ %incdec.ptr, %for.body ], [ %beg, %for.body.preheader ]
  %all.069 = phi i32 [ %or, %for.body ], [ 0, %for.body.preheader ]
  %6 = load i8, ptr %mem.070, align 1
  %conv7 = sext i8 %6 to i32
  %or = or i32 %all.069, %conv7
  %incdec.ptr = getelementptr inbounds i8, ptr %mem.070, i32 1
  %cmp5 = icmp ult ptr %incdec.ptr, %4
...
for.body10:                                       ; preds = %for.body10, %for.body10.preheader
  ...
  %aligned_beg.064 = phi ptr [ %incdec.ptr13, %for.body10 ], [ %1, %for.body10.preheader ]
  %8 = load i32, ptr %aligned_beg.064, align 4
  %or11 = or i32 %8, %all.165
  %incdec.ptr13 = getelementptr inbounds i32, ptr %aligned_beg.064, i32 1
  %cmp9 = icmp ult ptr %incdec.ptr13, %3
...
for.end14:                                        ; preds = %for.end14.loopexit, %for.cond8.preheader
  ...
  %cmp15.not = icmp uge ptr %9, %beg
  %cmp1960 = icmp ugt ptr %add.ptr, %9
...
for.body21:                                       ; preds = %for.body21, %for.body21.preheader
  %mem17.062 = phi ptr [ %incdec.ptr25, %for.body21 ], [ %9, %for.body21.preheader ]
  %all.261 = phi i32 [ %or23, %for.body21 ], [ %all.1.lcssa, %for.body21.preheader ]
  %10 = load i8, ptr %mem17.062, align 1
  %conv22 = sext i8 %10 to i32
  %or23 = or i32 %all.261, %conv22
  %incdec.ptr25 = getelementptr inbounds i8, ptr %mem17.062, i32 1
  %exitcond.not = icmp eq ptr %incdec.ptr25, %add.ptr

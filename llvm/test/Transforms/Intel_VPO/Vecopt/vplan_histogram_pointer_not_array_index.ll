...
; REQUIRES: asserts
; RUN: opt -S -mattr=+avx512vl,+avx512cd -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec' -debug-only=parvec-analysis -disable-vplan-codegen -disable-output < %s 2>&1 | FileCheck %s

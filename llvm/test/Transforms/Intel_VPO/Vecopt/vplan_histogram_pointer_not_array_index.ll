...
; REQUIRES: asserts
; RUN: opt -S -mattr=+avx512vl,+avx512cd -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -enable-vconflict-idiom -hir-vplan-vec -debug-only=parvec-analysis -disable-vplan-codegen -disable-output < %s 2>&1 | FileCheck %s

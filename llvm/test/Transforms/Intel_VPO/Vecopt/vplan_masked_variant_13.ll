...
; Check if the masked variant is generated when the induction of the outer loop is a live-out.
...
; CHECK-NEXT:  Id: 0     [[LCSSA_PHI_IV0:%.*]] = phi i32 [ [[OUTER_IV_NEXT0:%.*]], [[OUTER_LATCH0:%.*]] ] i32 [[VP3]] -> i32 [[OUTER_IV_NEXT0]]
; CHECK-EMPTY:
...
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
; CHECK-NEXT:  Id: 0     [[LCSSA_PHI_IV0]] = phi i32 [ [[OUTER_IV_NEXT0]], [[OUTER_LATCH0]] ] i32 [[VP7]] -> i32 [[OUTER_IV_NEXT0]]
;
entry:
  br label %preheader
...
loopexit:
  %lcssa.phi.iv = phi i32 [ %outer.iv.next, %outer.latch ]

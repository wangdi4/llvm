...
; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -hir-vplan-vec -vplan-print-after-plain-cfg -vplan-force-vf=4 -print-after=hir-vplan-vec -disable-output < %s 2>&1  | FileCheck %s -check-prefixes=PM1
; RUN: opt -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec" -vplan-print-after-plain-cfg -vplan-force-vf=4 -print-after=hir-vplan-vec -disable-output < %s 2>&1 | FileCheck %s -check-prefixes=PM2
...
; CHECK-NEXT:     i1 [[VP9:%.*]] = icmp sle i64 [[VP5]] i64 99
...
; CHECK-NEXT:     i64 [[VP7:%.*]] = add i64 [[VP6]] i64 2
; CHECK-NEXT:     i1 [[VP8:%.*]] = icmp sgt i64 [[VP2]] i64 [[VP7]]
; CHECK-NEXT:     i64 [[VP3]] = select i1 [[VP8]] i64 [[VP7]] i64 [[VP2]]
...
; CHECK-EMPTY:
; CHECK-NEXT:  External Uses:
; CHECK-NEXT:  Id: 0   i64 [[VP3]] -> [[VP11:%.*]] = {%min.012}
; CHECK-EMPTY:

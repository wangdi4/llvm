...
DIR.OMP.SIMD.124:
  ...
  %1 = bitcast [128 x i64]* %b to i8*
  br label %DIR.OMP.SIMD.1

DIR.OMP.SIMD.1:                                   ; preds = %DIR.OMP.SIMD.124
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 8), "QUAL.OMP.LINEAR:IV"(i64* %i.linear.iv, i32 2) ]
  br label %DIR.OMP.SIMD.2

DIR.OMP.SIMD.2:                                   ; preds = %DIR.OMP.SIMD.1
  %3 = bitcast i64* %i.linear.iv to i8*
  br label %omp.inner.for.body

omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.2, %omp.inner.for.body
  %.omp.iv.local.017 = phi i64 [ 0, %DIR.OMP.SIMD.2 ], [ %add2, %omp.inner.for.body ]
  %mul = shl nuw nsw i64 %.omp.iv.local.017, 1
  %arrayidx = getelementptr inbounds [128 x i64], [128 x i64]* %a, i64 0, i64 %mul
  %call = call noundef i64 @_Z3fooRl(i64* noundef nonnull align 8 dereferenceable(8) %arrayidx) #2
  %arrayidx1 = getelementptr inbounds [128 x i64], [128 x i64]* %b, i64 0, i64 %mul
  store i64 %call, i64* %arrayidx1, align 16
...
declare dso_local noundef i64 @_Z3fooRl(i64* noundef nonnull align 8 dereferenceable(8)) local_unnamed_addr #3

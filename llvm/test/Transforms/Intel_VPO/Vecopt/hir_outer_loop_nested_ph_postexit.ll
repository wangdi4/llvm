...
; RUN: opt -vplan-print-terminator-inst=false -hir-ssa-deconstruction -hir-framework -VPlanDriverHIR -vplan-print-after-plain-cfg -disable-output -vplan-force-build < %s 2>&1 | FileCheck %s

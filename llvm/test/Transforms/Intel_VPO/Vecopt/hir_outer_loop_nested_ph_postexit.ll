...
; CHECK-NEXT:     i64 [[VP10:%.*]] = hir-copy i64 [[VP6]] , OriginPhiId: -1
; CHECK-NEXT:     i64 [[VP11:%.*]] = hir-copy i64 [[VP8]] , OriginPhiId: -1
; CHECK-NEXT:     i64 [[VP12:%.*]] = hir-copy i64 0 , OriginPhiId: -1
; CHECK-NEXT:     br [[BB4:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB4]]: # preds: [[BB2]]
; CHECK-NEXT:     float [[VP13:%.*]] = sitofp i64 [[VP8]] to float
...
; CHECK-NEXT:     store float [[VP13]] float* [[VP_SUBSCRIPT]]
; CHECK-NEXT:     i64 [[VP16:%.*]] = mul i64 3 i64 [[VP14]]
; CHECK-NEXT:     i64 [[VP17:%.*]] = add i64 [[VP10]] i64 [[VP16]]
; CHECK-NEXT:     i64* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds i64* [[UB0:%.*]] i64 [[VP14]]
; CHECK-NEXT:     store i64 [[VP17]] i64* [[VP_SUBSCRIPT_1]]
; CHECK-NEXT:     i64 [[VP18:%.*]] = mul i64 2 i64 [[VP14]]
; CHECK-NEXT:     i64 [[VP19:%.*]] = add i64 [[VP10]] i64 [[VP18]]
; CHECK-NEXT:     i64 [[VP20:%.*]] = add i64 [[VP19]] i64 2
; CHECK-NEXT:     i64 [[VP15]] = add i64 [[VP14]] i64 1
; CHECK-NEXT:     i1 [[VP21:%.*]] = icmp sle i64 [[VP15]] i64 [[VP1]]
; CHECK-NEXT:     br i1 [[VP21]], [[BB5]], [[BB3]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]: # preds: [[BB5]]
; CHECK-NEXT:     i64 [[VP7]] = hir-copy i64 [[VP20]] , OriginPhiId: -1
; CHECK-NEXT:     i64 [[VP22:%.*]] = hir-copy i64 [[M0:%.*]] , OriginPhiId: -1
; CHECK-NEXT:     i64 [[VP23:%.*]] = hir-copy i64 [[VP6]] , OriginPhiId: -1
...
; CHECK-NEXT:  Id: 0   i64 [[VP11]] -> [[VP25:%.*]] = {%.omp.iv.0.out}
; CHECK-EMPTY:
; CHECK-NEXT:  Id: 1   i64 [[VP22]] -> [[VP26:%.*]] = {%inc.lcssa25}
; CHECK-EMPTY:
; CHECK-NEXT:  Id: 2   i64 [[VP23]] -> [[VP27:%.*]] = {%ret.021.out}
;
entry:
  %i = alloca i64
  %j = alloca i64

...
; RUN: opt -S -vplan-vec -vplan-force-vf=4 < %s  | FileCheck --check-prefix=FORCEVF %s
; RUN: opt -S -vplan-vec -vplan-force-vf=4 -vplan-target-vf=8 < %s  | FileCheck --check-prefix=BOTH %s
; RUN: opt -S -vplan-vec -vplan-target-vf=8 < %s  | FileCheck --check-prefix=TARGETVF %s

...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -disable-output -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -vplan-plain-dump -vplan-entities-dump -disable-vplan-codegen -enable-mmindex=1 -disable-nonlinear-mmindex=0 -vplan-print-after-vpentity-instrs -vplan-force-vf=4 -S -vplan-enable-masked-vectorized-remainder=0 -vplan-enable-non-masked-vectorized-remainder=0 < %s 2>&1 | FileCheck %s
...
; RUN: opt -opaque-pointers=0 -disable-output -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -enable-mmindex=1 -disable-nonlinear-mmindex=0 -vplan-force-vf=4  -S  -vplan-enable-masked-vectorized-remainder=0 -vplan-enable-non-masked-vectorized-remainder=0 < %s 2>&1 | FileCheck --check-prefix=CG_ENABLE %s

; CHECK:  Reduction list
; CHECK-NEXT:   signed (SIntMax) Start: i32 [[BEST_0230:%.*]] Exit: i32 [[VP0:%.*]]
; CHECK-NEXT:    Linked values: i32 [[VP1:%.*]], i32 [[VP0]], i32 [[VP__RED_INIT:%.*]], i32 [[VP2:%.*]],
; CHECK-EMPTY:
; CHECK-NEXT:   signed (SIntMin) Start: i32 [[VAL_0250:%.*]] Exit: i32 [[VP3:%.*]]
; CHECK-NEXT:    Linked values: i32 [[VP4:%.*]], i32 [[VP3]], i32 [[VP__RED_INIT_1:%.*]], i32 [[VP__RED_FINAL:%.*]],
; CHECK-NEXT:  IsLinearIndex: 0 Parent exit: i32 [[VP5:%.*]]
; CHECK-NEXT:   signed (SIntMin) Start: i32 [[TMP_0240:%.*]] Exit: i32 [[VP5]]
; CHECK-NEXT:    Linked values: i32 [[VP6:%.*]], i32 [[VP5]], i32 [[VP__RED_INIT_2:%.*]], i32 [[VP__RED_FINAL_1:%.*]],
...
; CHECK:         [[BB0:BB[0-9]+]]:
; CHECK-NEXT:     i32 [[VP6]] = phi  [ i32 [[VP__RED_INIT_2]], [[BB2]] ],  [ i32 [[VP5]], [[BB0]] ]
; CHECK-NEXT:     i32 [[VP4]] = phi  [ i32 [[VP__RED_INIT_1]], [[BB2]] ],  [ i32 [[VP3]], [[BB0]] ]
...
; CHECK-NEXT:     i32 [[VP13:%.*]] = add i32 [[VP12]] i32 2
; CHECK-NEXT:     i1 [[VP14:%.*]] = icmp sgt i32 [[VP12]] i32 [[VP1]]
; CHECK-NEXT:     i32 [[VP3]] = select i1 [[VP14]] i32 [[VP13]] i32 [[VP4]]
; CHECK-NEXT:     i1 [[VP15:%.*]] = icmp sgt i32 [[VP12]] i32 [[VP1]]
; CHECK-NEXT:     i32 [[VP5]] = select i1 [[VP15]] i32 [[VP8]] i32 [[VP6]]
...
; CHECK-NEXT:     i32 [[VP__RED_FINAL]] = reduction-final{s_smin} i32 [[VP3]] i32 [[VP5]] i32 [[VP__RED_FINAL_1]]

...
omp.region.entry:                                 ; preds = %DIR.OMP.SIMD.1
  %i3 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.LINEAR:TYPED"(ptr %y.linear.ptr, i32 0, i32 1, i32 1), "QUAL.OMP.LINEAR:IV.TYPED"(ptr %i.linear.iv.ptr, i32 0, i32 1, i32 1) ]

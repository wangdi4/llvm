...
; RUN: opt %s -S -hir-ssa-deconstruction -hir-vec-dir-insert -VPlanDriverHIR --debug-only=LoopVectorizationPlanner_vec_lengths 2>&1 | FileCheck %s
;
...
; }
;
; CHECK: LVP: Specified vectorlengths: 1
;

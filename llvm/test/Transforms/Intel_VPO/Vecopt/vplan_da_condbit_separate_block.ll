...
; RUN: opt -vplan-print-terminator-inst=false < %s -VPlanDriver -vplan-dump-da -disable-output -S 2>&1 | FileCheck %s
; RUN: opt -vplan-print-terminator-inst=false < %s -passes="vplan-driver" -vplan-dump-da -disable-output -S 2>&1 | FileCheck %s

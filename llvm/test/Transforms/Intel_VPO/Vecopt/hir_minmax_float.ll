...
; RUN: opt -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -VPlanDriverHIR -print-after=VPlanDriverHIR -disable-nonlinear-mmindex=0 -disable-output %s 2>&1 | FileCheck %s
;

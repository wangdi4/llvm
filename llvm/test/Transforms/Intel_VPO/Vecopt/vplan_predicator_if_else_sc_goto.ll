...
; NOOPT-NEXT:      [[IFF1:IfF[0-9]+]] = [[BP5]] && !i1 [[VP_CMP4:%.*]]
; NOOPT-NEXT:      [[IFT1:IfT[0-9]+]] = [[BP5]] && i1 [[VP_CMP4]]
; NOOPT-NEXT:    [[BB6:BB[0-9]+]]:
; NOOPT-NEXT:      [[BP6:BP[0-9]+]] = [[IFF1]]
; NOOPT-NEXT:    [[BB7:BB[0-9]+]]:
; NOOPT-NEXT:      [[BP7:BP[0-9]+]] = [[IFT1]] || [[IFF0]]
; NOOPT-NEXT:    [[BB8:BB[0-9]+]]:
; NOOPT-NEXT:      [[BP8:BP[0-9]+]] = [[BP7]] || [[BP6]]
; NOOPT-NEXT:  End of the Predicator report.
;
...
; OPT-NEXT:    [[BB1:BB[0-9]+]]:
; OPT-NEXT:      [[BP0:BP[0-9]+]] = [[IFT0]]
; OPT-NEXT:      [[IFF1:IfF[0-9]+]] = [[BP0]] && !i1 [[VP_CMP4:%.*]]
; OPT-NEXT:      [[IFT1:IfT[0-9]+]] = [[BP0]] && i1 [[VP_CMP4]]
; OPT-NEXT:    [[BB2:BB[0-9]+]]:
; OPT-NEXT:      [[BP1:BP[0-9]+]] = [[IFF1]]
; OPT-NEXT:    [[BB3:BB[0-9]+]]:
; OPT-NEXT:      [[BP2:BP[0-9]+]] = [[IFT1]] || [[IFF0]]
; OPT-NEXT:    [[BB4:BB[0-9]+]]:

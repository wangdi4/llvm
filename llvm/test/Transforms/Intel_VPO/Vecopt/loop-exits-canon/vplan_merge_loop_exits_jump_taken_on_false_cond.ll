...
; CHECK-NEXT:     br i1 [[VP_CMP1]], [[INTERMEDIATE_BB0:intermediate.bb[0-9]+]], [[BB2:BB[0-9]+]]
; CHECK-EMPTY:
...
; CHECK-NEXT:     i1 [[VP_TAKE_BACKEDGE_COND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB2]] ],  [ i1 true, [[INTERMEDIATE_BB0]] ]
...
header:
  ...
  br i1 %cmp1, label %exit_bb1, label %latch

latch:
  %bottom_test = icmp eq i32 %iv.next, 128
  br i1 %bottom_test, label %exit_bb2, label %header

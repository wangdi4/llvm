...
; CHECK-NEXT:  Divergent: [Shape: Strided, Stride: i64 2] i64 [[VP_SECOND_INDUCTION_PHI:%.*]] = phi  [ i64 0, [[BB3]] ],  [ i64 [[VP_SECOND_INDUCTION:%.*]], [[BB2]] ]
; CHECK-EMPTY:
...
; CHECK-NEXT:  Divergent: [Shape: Strided, Stride: i64 2] i64 [[VP_SECOND_INDUCTION]] = add i64 [[VP_SECOND_INDUCTION_PHI]] i64 2

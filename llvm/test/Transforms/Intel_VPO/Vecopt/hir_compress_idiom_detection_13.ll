; RUN: opt %s -mattr=+avx512f,+avx512vl -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec' -disable-output -debug-only=parvec-analysis -vplan-print-after-plain-cfg -vplan-print-after-vpentity-instrs -vplan-entities-dump 2>&1 | FileCheck %s
...
; CHECK-NEXT:       i64 [[VP11]] = add i64 [[VP3]] i64 [[VP12]]
; CHECK-NEXT:       ptr [[VP_SUBSCRIPT]] = subscript inbounds ptr [[B0]] i64 [[VP11]]
...
; CHECK-NEXT:     i32 [[VP17]] = compress-expand-index-inc {stride: 1} i32 [[VP8]] i1 [[VP9]]

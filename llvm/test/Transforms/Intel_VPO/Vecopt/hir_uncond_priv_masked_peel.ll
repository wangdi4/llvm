...
; RUN: opt -enable-new-pm=0 -hir-ssa-deconstruction -hir-temp-cleanup -hir-vec-dir-insert -hir-vplan-vec -print-after=hir-vplan-vec  -vplan-vec-scenario="m8;v8;s1" -disable-output %s 2>&1 | FileCheck %s

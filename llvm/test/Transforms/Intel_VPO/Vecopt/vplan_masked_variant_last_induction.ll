...
; MASKED-PEEL-REMAINDER-NEXT:    [[UNI_PHI200:%.*]] = phi i32 [ [[UNI_PHI160]], [[VPLANNEDBB180]] ], [ [[TMP18:%.*]], [[CLONED_NEW_LATCH170:%.*]] ]
; MASKED-PEEL-REMAINDER-NEXT:    [[VEC_PHI210:%.*]] = phi <4 x i32> [ [[TMP15]], [[VPLANNEDBB180]] ], [ [[TMP17:%.*]], [[CLONED_NEW_LATCH170]] ]
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP16:%.*]] = icmp ult <4 x i32> [[VEC_PHI210]], [[BROADCAST_SPLAT230]]
...
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP19:%.*]] = icmp ult <4 x i32> [[TMP17]], [[BROADCAST_SPLAT230]]
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP20:%.*]] = bitcast <4 x i1> [[TMP19]] to i4
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP21:%.*]] = icmp eq i4 [[TMP20]], 0
; MASKED-PEEL-REMAINDER-NEXT:    [[BROADCAST_SPLATINSERT250:%.*]] = insertelement <4 x i1> poison, i1 [[TMP21]], i32 0
...
; MASKED-PEEL-REMAINDER-NEXT:    [[UNI_PHI290:%.*]] = phi i32 [ [[TMP23]], [[VPLANNEDBB280]] ], [ [[TMP13]], [[VPLANNEDBB150]] ]

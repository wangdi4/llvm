...
; MASKED-PEEL-NEXT:    [[BROADCAST_SPLATINSERT0:%.*]] = insertelement <4 x i1> poison, i1 [[TMP6]], i32 0
; MASKED-PEEL-NEXT:    [[BROADCAST_SPLAT0:%.*]] = shufflevector <4 x i1> [[BROADCAST_SPLATINSERT0]], <4 x i1> poison, <4 x i32> zeroinitializer
; MASKED-PEEL-NEXT:    [[BROADCAST_SPLAT_EXTRACT_0_0:%.*]] = extractelement <4 x i1> [[BROADCAST_SPLAT0]], i32 0
; MASKED-PEEL-NEXT:    br i1 [[BROADCAST_SPLAT_EXTRACT_0_0]], label [[VPLANNEDBB40:%.*]], label [[VPLANNEDBB20]]
; MASKED-PEEL-EMPTY:
...
; MASKED-PEEL-NEXT:    [[TMP7:%.*]] = and i32 [[N0]], -4
; MASKED-PEEL-NEXT:    [[TMP8:%.*]] = icmp ugt i32 5, [[TMP7]]
; MASKED-PEEL-NEXT:    br i1 [[TMP8]], label %[[MERGE_BLK0]], label [[VPLANNEDBB80:%.*]]
; MASKED-PEEL-EMPTY:
...
; MASKED-PEEL-NEXT:    [[TMP10:%.*]] = and i32 [[N0]], -4
; MASKED-PEEL-NEXT:    br label [[VECTOR_BODY0:%.*]]
; MASKED-PEEL-EMPTY:
; MASKED-PEEL-NEXT:  vector.body:
; MASKED-PEEL-NEXT:    [[UNI_PHI110:%.*]] = phi i32 [ [[UNI_PHI60]], [[VPLANNEDBB90]] ], [ [[TMP12:%.*]], [[VECTOR_BODY0]] ]
; MASKED-PEEL-NEXT:    [[VEC_PHI120:%.*]] = phi <4 x i32> [ [[TMP9]], [[VPLANNEDBB90]] ], [ [[TMP11:%.*]], [[VECTOR_BODY0]] ]
; MASKED-PEEL-NEXT:    [[TMP11]] = add nsw <4 x i32> [[VEC_PHI120]], <i32 4, i32 4, i32 4, i32 4>
; MASKED-PEEL-NEXT:    [[TMP12]] = add nsw i32 [[UNI_PHI110]], 4
; MASKED-PEEL-NEXT:    [[TMP13:%.*]] = icmp eq i32 [[TMP12]], [[TMP10]]
; MASKED-PEEL-NEXT:    br i1 [[TMP13]], label [[VPLANNEDBB130:%.*]], label [[VECTOR_BODY0]], !llvm.loop !0
; MASKED-PEEL-EMPTY:
; MASKED-PEEL-NEXT:  VPlannedBB13:
; MASKED-PEEL-NEXT:    [[TMP14:%.*]] = mul i32 1, [[TMP10]]
; MASKED-PEEL-NEXT:    [[TMP15:%.*]] = add i32 0, [[TMP14]]
...
; MASKED-PEEL-NEXT:    [[TMP16:%.*]] = icmp eq i32 [[N0]], [[TMP10]]
; MASKED-PEEL-NEXT:    br i1 [[TMP16]], label [[FINAL_MERGE0:%.*]], label %[[MERGE_BLK0]]
; MASKED-PEEL-EMPTY:
; MASKED-PEEL-NEXT:  [[MERGE_BLK0]]:
; MASKED-PEEL-NEXT:    [[UNI_PHI160:%.*]] = phi i32 [ [[TMP15]], [[VPLANNEDBB150]] ], [ 0, [[PEEL_CHECKV0]] ], [ [[UNI_PHI60]], [[VPLANNEDBB70]] ]
...
; MASKED-PEEL-NEXT:    [[UNI_PHI180:%.*]] = phi i32 [ [[IV_NEXT0:%.*]], [[VPLANNEDBB170:%.*]] ], [ [[TMP15]], [[VPLANNEDBB150]] ]
...
; MASKED-REMAINDER-NEXT:    [[BROADCAST_SPLATINSERT140:%.*]] = insertelement <4 x i1> poison, i1 [[TMP15]], i32 0
...
; MASKED-REMAINDER-NEXT:    [[UNI_PHI180:%.*]] = phi i32 [ [[TMP17]], [[VPLANNEDBB170]] ], [ [[TMP7]], [[VPLANNEDBB60]] ]
...
; MASKED-PEEL-REMAINDER-NEXT:    [[BROADCAST_SPLATINSERT0:%.*]] = insertelement <4 x i1> poison, i1 [[TMP6]], i32 0
; MASKED-PEEL-REMAINDER-NEXT:    [[BROADCAST_SPLAT0:%.*]] = shufflevector <4 x i1> [[BROADCAST_SPLATINSERT0]], <4 x i1> poison, <4 x i32> zeroinitializer
; MASKED-PEEL-REMAINDER-NEXT:    [[BROADCAST_SPLAT_EXTRACT_0_0:%.*]] = extractelement <4 x i1> [[BROADCAST_SPLAT0]], i32 0
; MASKED-PEEL-REMAINDER-NEXT:    br i1 [[BROADCAST_SPLAT_EXTRACT_0_0]], label [[VPLANNEDBB40:%.*]], label [[VPLANNEDBB20]]
; MASKED-PEEL-REMAINDER-EMPTY:
...
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP7:%.*]] = and i32 [[N0]], -4
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP8:%.*]] = icmp ugt i32 5, [[TMP7]]
...
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP10:%.*]] = and i32 [[N0]], -4
; MASKED-PEEL-REMAINDER-NEXT:    br label [[VECTOR_BODY0:%.*]]
; MASKED-PEEL-REMAINDER-EMPTY:
; MASKED-PEEL-REMAINDER-NEXT:  vector.body:
; MASKED-PEEL-REMAINDER-NEXT:    [[UNI_PHI110:%.*]] = phi i32 [ [[UNI_PHI60]], [[VPLANNEDBB90]] ], [ [[TMP12:%.*]], [[VECTOR_BODY0]] ]
; MASKED-PEEL-REMAINDER-NEXT:    [[VEC_PHI120:%.*]] = phi <4 x i32> [ [[TMP9]], [[VPLANNEDBB90]] ], [ [[TMP11:%.*]], [[VECTOR_BODY0]] ]
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP11]] = add nsw <4 x i32> [[VEC_PHI120]], <i32 4, i32 4, i32 4, i32 4>
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP12]] = add nsw i32 [[UNI_PHI110]], 4
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP13:%.*]] = icmp eq i32 [[TMP12]], [[TMP10]]
; MASKED-PEEL-REMAINDER-NEXT:    br i1 [[TMP13]], label [[VPLANNEDBB130:%.*]], label [[VECTOR_BODY0]], !llvm.loop !0
; MASKED-PEEL-REMAINDER-EMPTY:
; MASKED-PEEL-REMAINDER-NEXT:  VPlannedBB13:
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP14:%.*]] = mul i32 1, [[TMP10]]
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP15:%.*]] = add i32 0, [[TMP14]]
...
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP16:%.*]] = icmp eq i32 [[N0]], [[TMP10]]
; MASKED-PEEL-REMAINDER-NEXT:    br i1 [[TMP16]], label [[FINAL_MERGE0:%.*]], label %[[MERGE_BLK0]]
; MASKED-PEEL-REMAINDER-EMPTY:
; MASKED-PEEL-REMAINDER-NEXT:  [[MERGE_BLK0]]:
; MASKED-PEEL-REMAINDER-NEXT:    [[UNI_PHI160:%.*]] = phi i32 [ [[TMP15]], [[VPLANNEDBB150]] ], [ 0, %[[PEEL_CHECKV0]] ], [ [[UNI_PHI60]], [[VPLANNEDBB70]] ]
; MASKED-PEEL-REMAINDER-NEXT:    br label [[VPLANNEDBB170:%.*]]
; MASKED-PEEL-REMAINDER-EMPTY:
; MASKED-PEEL-REMAINDER-NEXT:  VPlannedBB17:
; MASKED-PEEL-REMAINDER-NEXT:    [[BROADCAST_SPLATINSERT220:%.*]] = insertelement <4 x i32> poison, i32 [[N0]], i32 0
...
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP17:%.*]] = add <4 x i32> [[UNI_PHI16IND_START_BCAST_SPLAT0]], <i32 0, i32 1, i32 2, i32 3>
; MASKED-PEEL-REMAINDER-NEXT:    br label [[VPLANNEDBB190:%.*]]
; MASKED-PEEL-REMAINDER-EMPTY:
; MASKED-PEEL-REMAINDER-NEXT:  VPlannedBB19:
; MASKED-PEEL-REMAINDER-NEXT:    [[UNI_PHI200:%.*]] = phi i32 [ [[UNI_PHI160]], [[VPLANNEDBB180]] ], [ [[TMP20:%.*]], [[CLONED_NEW_LATCH170:%.*]] ]
; MASKED-PEEL-REMAINDER-NEXT:    [[VEC_PHI210:%.*]] = phi <4 x i32> [ [[TMP17]], [[VPLANNEDBB180]] ], [ [[TMP19:%.*]], [[CLONED_NEW_LATCH170]] ]
...
; MASKED-PEEL-REMAINDER-NEXT:    [[BROADCAST_SPLATINSERT250:%.*]] = insertelement <4 x i1> poison, i1 [[TMP23]], i32 0
; MASKED-PEEL-REMAINDER-NEXT:    [[BROADCAST_SPLAT260:%.*]] = shufflevector <4 x i1> [[BROADCAST_SPLATINSERT250]], <4 x i1> poison, <4 x i32> zeroinitializer
; MASKED-PEEL-REMAINDER-NEXT:    [[BROADCAST_SPLAT26_EXTRACT_0_0:%.*]] = extractelement <4 x i1> [[BROADCAST_SPLAT260]], i32 0
; MASKED-PEEL-REMAINDER-NEXT:    br i1 [[BROADCAST_SPLAT26_EXTRACT_0_0]], label [[VPLANNEDBB270:%.*]], label [[VPLANNEDBB190]]
; MASKED-PEEL-REMAINDER-EMPTY:
; MASKED-PEEL-REMAINDER-NEXT:  VPlannedBB27:
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP24:%.*]] = mul i32 1, [[N0]]
; MASKED-PEEL-REMAINDER-NEXT:    [[TMP25:%.*]] = add i32 0, [[TMP24]]
; MASKED-PEEL-REMAINDER-NEXT:    br label [[VPLANNEDBB280:%.*]]
; MASKED-PEEL-REMAINDER-EMPTY:
; MASKED-PEEL-REMAINDER-NEXT:  VPlannedBB28:
; MASKED-PEEL-REMAINDER-NEXT:    br label [[FINAL_MERGE0]]
; MASKED-PEEL-REMAINDER-EMPTY:
; MASKED-PEEL-REMAINDER-NEXT:  final.merge:
; MASKED-PEEL-REMAINDER-NEXT:    [[UNI_PHI290:%.*]] = phi i32 [ [[TMP25]], [[VPLANNEDBB280]] ], [ [[TMP15]], [[VPLANNEDBB150]] ]
...
; MASKED-PEEL-REMAINDER-NEXT:    [[LCSSA_PHI0:%.*]] = phi i32 [ [[UNI_PHI290]], [[FINAL_MERGE0]] ]

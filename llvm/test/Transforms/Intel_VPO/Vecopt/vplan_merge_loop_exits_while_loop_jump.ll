...
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB7]]:
; CHECK-NEXT:       i32 [[VP_INC1:%.*]] = add i32 [[VP_PHI_INNER_LOOP_INDUCTION]] i32 2
; CHECK-NEXT:       i1 [[VP_CMP3:%.*]] = icmp i32 [[VP_INC1]] i32 16
; CHECK-NEXT:      SUCCESSORS(2):[[BB6]](i1 [[VP_CMP3]]), [[INTERMEDIATE_BB0:intermediate.bb[0-9]+]](!i1 [[VP_CMP3]])
; CHECK-NEXT:      PREDECESSORS(1): [[BB5]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB6]]:
; CHECK-NEXT:       i32 [[VP_INC2:%.*]] = add i32 [[VP_PHI_INNER_LOOP_INDUCTION]] i32 1
; CHECK-NEXT:       i1 [[VP_CMP2:%.*]] = icmp i32 [[VP_INC2]] i32 16
...
; CHECK-NEXT:     i1 [[VP_TAKE_BACKEDGE_COND:%.*]] = phi  [ i1 true, [[BB8]] ],  [ i1 false, [[INTERMEDIATE_BB0]] ]
...
; CHECK-NEXT:    SUCCESSORS(2):[[BB2]](i1 [[VP_CMP4]]), [[BB10:BB[0-9]+]](!i1 [[VP_CMP4]])
...
bb2:
  %inc1 = add nsw i32 %phi.inner.loop.induction, 2
  %cmp3 = icmp eq i32 %inc1, 16
  br i1 %cmp3, label %bb1, label %exit_bb1

bb1:
  %inc2 = add nsw i32 %phi.inner.loop.induction, 1
  %cmp2 = icmp eq i32 %inc2, 16
...
outer.loop.latch:
  ...
  br i1 %cmp4, label %outer.loop, label %loop1_exit

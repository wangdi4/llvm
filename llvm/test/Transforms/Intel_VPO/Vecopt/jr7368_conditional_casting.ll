...
land.end:                                         ; preds = %land.lhs.true, %land.rhs
  ...
  store i32 %1, ptr addrspace(1) %arrayidx, align 4, !tbaa !15
  br label %if.end22
...
land.rhs15:                                       ; preds = %land.lhs.true13
  %2 = load i32, ptr addrspace(1) %.gint, align 4
...
land.end18:                                       ; preds = %land.lhs.true13, %land.rhs15
  ...
  %arrayidx21 = getelementptr inbounds i32, ptr addrspace(1) %results, i64 %idxprom20
  store i32 %3, ptr addrspace(1) %arrayidx21, align 4, !tbaa !15
  br label %if.end22
...
land.rhs:                                         ; preds = %land.lhs.true
  %1 = load i32, ptr addrspace(1) %.gint, align 4
  %cmp = icmp eq i32 %1, 1
  %phitmp11 = zext i1 %cmp to i32
  br label %land.end
...
land.end:                                         ; preds = %land.rhs, %land.lhs.true
  ...
  %arrayidx = getelementptr inbounds i32, ptr addrspace(1) %results, i64 %idxprom
  store i32 %2, ptr addrspace(1) %arrayidx, align 4, !tbaa !15
  br label %if.end22
...
land.rhs15:                                       ; preds = %land.lhs.true13
  %3 = load i32, ptr addrspace(1) %.gint, align 4
...
land.end18:                                       ; preds = %land.rhs15, %land.lhs.true13
  ...
  %arrayidx21 = getelementptr inbounds i32, ptr addrspace(1) %results, i64 %idxprom20
  store i32 %4, ptr addrspace(1) %arrayidx21, align 4, !tbaa !15
  br label %if.end22

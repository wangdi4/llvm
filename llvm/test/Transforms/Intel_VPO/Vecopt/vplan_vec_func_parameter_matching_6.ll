; RUN: opt -S -mattr=avx2 -VPlanDriver < %s | FileCheck %s
; RUN: opt -S -mattr=avx2 -passes="vplan-driver" < %s | FileCheck %s
...
omp.inner.for.body.lr.ph:
  ...
  %1 = bitcast [256 x i64]* %b to i8*
  br label %DIR.OMP.SIMD.1

DIR.OMP.SIMD.1:                                   ; preds = %omp.inner.for.body.lr.ph
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 2), "QUAL.OMP.LINEAR:IV"(i64* %i.linear.iv, i32 1), "QUAL.OMP.NORMALIZED.IV"(i8* null), "QUAL.OMP.NORMALIZED.UB"(i8* null) ]
...
omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.1, %omp.inner.for.body
  ...
  %arrayidx = getelementptr inbounds [256 x i64], [256 x i64]* %b, i64 0, i64 %.omp.iv.local.010
  %3 = load i64, i64* %arrayidx, align 8
  %call = call i64 @_Z3foolll(i64 256, i64 %.omp.iv.local.010, i64 %3) #3
  %arrayidx1 = getelementptr inbounds [256 x i64], [256 x i64]* %a, i64 0, i64 %.omp.iv.local.010

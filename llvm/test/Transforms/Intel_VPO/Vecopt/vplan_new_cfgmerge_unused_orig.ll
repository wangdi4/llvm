...
;RUN: opt -vplan-vec -vplan-force-vf=2 -S -print-after=vplan-vec -vplan-vec-scenario="n0;v2;m2"  -vplan-enable-new-cfg-merge %s | FileCheck %s
;RUN: opt -passes="vplan-vec" -vplan-force-vf=2 -S -print-after=vplan-vec -vplan-vec-scenario="n0;v2;m2" -vplan-enable-new-cfg-merge %s | FileCheck %s

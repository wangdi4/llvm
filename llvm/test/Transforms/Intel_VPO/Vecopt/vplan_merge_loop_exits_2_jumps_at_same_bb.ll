...
; Test merge loop exits transformation when the loop has two exiting blocks
; (BB5 (inner.loop) and BB6 (bb1)) at the same exit block (BB8 (exit_bb1)).
...
; CHECK-NEXT:      SUCCESSORS(2):[[BB7:BB[0-9]+]](i1 [[VP_CMP2]]), [[INTERMEDIATEBB0]](!i1 [[VP_CMP2]])
; CHECK-NEXT:      PREDECESSORS(1): [[BB5]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[INTERMEDIATEBB0]] (BP: NULL) :
; CHECK-NEXT:       [DA: Uniform]   i32 [[VP_M1:%.*]] = phi  [ i32 0, [[BB5]] ],  [ i32 1, [[BB6]] ]
...
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP1]] = phi  [ i32 [[VP0]], [[BB7]] ],  [ i32 1, [[INTERMEDIATEBB0]] ]
; CHECK-NEXT:     [DA: Uniform]   i1 [[VP_TAKEBACKEDGECOND:%.*]] = phi  [ i1 [[VP_BOTTOM_TEST]], [[BB7]] ],  [ i1 false, [[INTERMEDIATEBB0]] ]
; CHECK-NEXT:    SUCCESSORS(2):[[BB5]](i1 [[VP_TAKEBACKEDGECOND]]), [[CASCADEDIFBLOCK0:CascadedIfBlock[0-9]+]](!i1 [[VP_TAKEBACKEDGECOND]])
; CHECK-NEXT:    PREDECESSORS(2): [[BB7]] [[INTERMEDIATEBB0]]
; CHECK-EMPTY:

...
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,print<hir>,vplan-driver-hir,print<hir>" -vplan-force-vf=4 -enable-vp-value-codegen-hir=0 -disable-output < %s 2>&1 | FileCheck %s
...
; RUN: opt -passes="hir-ssa-deconstruction,hir-vec-dir-insert,print<hir>,vplan-driver-hir,print<hir>" -vplan-force-vf=4 -enable-vp-value-codegen-hir -disable-output < %s 2>&1 | FileCheck %s

...
; CHECK-NEXT:    [[ARRAYIDX592:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[Y]], i64 0, i64 14
; CHECK-NEXT:    [[ARRAYIDX595:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[CL7]], i64 0, i64 14
; CHECK-NEXT:    [[ARRAYIDX605:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[D5]], i64 0, i64 13
; CHECK-NEXT:    [[ARRAYIDX616:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[Y]], i64 0, i64 13
; CHECK-NEXT:    [[ARRAYIDX619:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[CL7]], i64 0, i64 13
; CHECK-NEXT:    [[ARRAYIDX629:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[D5]], i64 0, i64 12
; CHECK-NEXT:    [[ARRAYIDX640:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[Y]], i64 0, i64 12
; CHECK-NEXT:    [[ARRAYIDX643:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[CL7]], i64 0, i64 12
; CHECK-NEXT:    [[ARRAYIDX653:%.*]] = getelementptr inbounds [100 x i32], [100 x i32]* [[D5]], i64 0, i64 11
...
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <4 x i32> undef, i32 [[I131]], i32 0
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <4 x i32> [[TMP6]], i32 0
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x i32> [[TMP7]], i32 [[TMP8]], i32 1
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <4 x i32> [[TMP6]], i32 1
; CHECK-NEXT:    [[TMP11:%.*]] = insertelement <4 x i32> [[TMP9]], i32 [[TMP10]], i32 2
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <4 x i32> [[TMP6]], i32 2
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <4 x i32> [[TMP11]], i32 [[TMP12]], i32 3
; CHECK-NEXT:    [[TMP14:%.*]] = sub <4 x i32> [[TMP6]], [[TMP13]]
; CHECK-NEXT:    [[TMP15:%.*]] = add <4 x i32> [[TMP14]], [[TMP4]]

...
;          |   %2 = @llvm.directive.region.entry(); [ DIR.OMP.SIMD(),  QUAL.OMP.NORMALIZED.IV(null),  QUAL.OMP.NORMALIZED.UB(null),  QUAL.OMP.LINEAR:IV(&((%j.i.linear.iv)[0])1), QUAL.OMP.PRIVATE:NONPOD.TYPED(&((%ref.tmp.i.priv)[0])zeroinitializer1&((@_ZTSSt7complexIdE.omp.def_constr)[0])&((@_ZTSSt7complexIdE.omp.destr)[0])) ]
;          |

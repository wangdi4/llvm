...
; CHECK-NEXT:    Loads:
; CHECK-NEXT:       float* [[VP_SUBSCRIPT_1:%.*]] = subscript inbounds float* [[A0]] i64 [[VP9:%.*]]
; CHECK-NEXT:       float* [[VP_SUBSCRIPT_2:%.*]] = subscript inbounds float* [[B0]] i64 [[VP10:%.*]]
; CHECK-NEXT:    Indices:
; CHECK-NEXT:      i32 [[VP7]] = phi  [ i32 [[K_0130]], [[BB1:BB[0-9]+]] ],  [ i32 [[VP11:%.*]], [[BB2:BB[0-9]+]] ]
; CHECK-NEXT:      i32 [[VP7]] = phi  [ i32 [[K_0130]], [[BB1]] ],  [ i32 [[VP11]], [[BB2]] ]
; CHECK-NEXT:      i32 [[VP7]] = phi  [ i32 [[K_0130]], [[BB1]] ],  [ i32 [[VP11]], [[BB2]] ]
; CHECK-EMPTY:
; CHECK-NEXT:    Linked values: i32 [[VP6]], i32 [[VP7]], i32 [[K_0130]], void [[VP_STORE:%.*]], float* [[VP_SUBSCRIPT_1]], float* [[VP_SUBSCRIPT_2]],
...
; CHECK-NEXT:     i32 [[VP_LOAD:%.*]] = load i32* [[VP_SUBSCRIPT_3]]
...
; CHECK-NEXT:       float* [[VP_SUBSCRIPT_2]] = subscript inbounds float* [[B0]] i64 [[VP10]]
; CHECK-NEXT:       float [[VP_LOAD_2:%.*]] = load float* [[VP_SUBSCRIPT_2]]
; CHECK-NEXT:       float [[VP8]] = fadd float [[VP_LOAD_1]] float [[VP_LOAD_2]]
; CHECK-NEXT:       i64 [[VP13:%.*]] = zext i32 [[VP7]] to i64
; CHECK-NEXT:       float* [[VP_SUBSCRIPT]] = subscript inbounds float* [[A0]] i64 [[VP13]]
; CHECK-NEXT:       store float [[VP8]] float* [[VP_SUBSCRIPT]]
; CHECK-NEXT:       i32 [[VP6]] = add i32 [[VP7]] i32 1
; CHECK-NEXT:       br [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]: # preds: [[BB4]], [[BB0]]
; CHECK-NEXT:     i32 [[VP11]] = phi  [ i32 [[VP6]], [[BB4]] ],  [ i32 [[VP7]], [[BB0]] ]

...
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP_PHI_INNER_LOOP_LATCH:%.*]] = phi  [ i32 0, [[BB4]] ],  [ i32 [[VP_INNER_LOOP_INDUCTION:%.*]], [[NEWLOOPLATCH0:NewLoopLatch[0-9]+]] ]
...
; CHECK-NEXT:    SUCCESSORS(2):[[BB7:BB[0-9]+]](i1 [[VP_CMP2]]), [[NEWLOOPLATCH0]](!i1 [[VP_CMP2]])
...
; CHECK-NEXT:     [DA: Uniform]   i32 [[VP_LIVE_OUT:%.*]] = phi  [ i32 [[VP_INC]], [[NEWLOOPLATCH0]] ]

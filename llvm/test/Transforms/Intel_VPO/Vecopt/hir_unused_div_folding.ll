...
; CHECK-NEXT:        if ([[C0:%.*]] != 0)
; CHECK-NEXT:        {
; CHECK-NEXT:           [[DOTVEC0:%.*]] = ([[T0:%.*]] + <i64 0, i64 1, i64 2, i64 3>)/9  +  3
; CHECK-NEXT:           (<4 x i64>*)([[A0:%.*]])[0] = [[DOTVEC0]]
; CHECK-NEXT:           [[DOTVEC0]] = ([[T0]] + <i64 0, i64 1, i64 2, i64 3> + 4)/9  +  3
; CHECK-NEXT:           (<4 x i64>*)([[A0]])[4] = [[DOTVEC0]]
; CHECK-NEXT:           [[DOTVEC0]] = ([[T0]] + <i64 0, i64 1, i64 2, i64 3> + 8)/9  +  3
; CHECK-NEXT:           (<4 x i64>*)([[A0]])[8] = [[DOTVEC0]]
; CHECK-NEXT:        }
; CHECK-NEXT:        else
; CHECK-NEXT:        {
; CHECK-NEXT:           [[DOTVEC20:%.*]] = [[T0]] + <i64 0, i64 1, i64 2, i64 3>  /  9
; CHECK-NEXT:           [[DOTVEC20]] = [[T0]] + <i64 0, i64 1, i64 2, i64 3> + 4  /  9
; CHECK-NEXT:           [[DOTVEC20]] = [[T0]] + <i64 0, i64 1, i64 2, i64 3> + 8  /  9
; CHECK-NEXT:        }

...
; CHECK-NEXT:    [[BRIDGE_T829_3162:%.*]] = add nsw i32 [[TMP27]], [[CHAIN_T829_3166]]
...
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP30:%.*]] = insertelement <4 x i8> [[TMP29]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP31:%.*]] = insertelement <4 x i8> [[TMP30]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP32:%.*]] = insertelement <4 x i8> [[TMP31]], i8 [[GEPLOAD1306]], i32 3
...
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP35:%.*]] = insertelement <4 x i8> [[TMP34]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <4 x i8> [[TMP35]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP37:%.*]] = insertelement <4 x i8> [[TMP36]], i8 [[GEPLOAD1310]], i32 3
...
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP40:%.*]] = insertelement <4 x i8> [[TMP39]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP41:%.*]] = insertelement <4 x i8> [[TMP40]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP42:%.*]] = insertelement <4 x i8> [[TMP41]], i8 [[GEPLOAD1312]], i32 3
...
; CHECK-NEXT:    [[TMP44:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP45:%.*]] = insertelement <4 x i8> [[TMP44]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP46:%.*]] = insertelement <4 x i8> [[TMP45]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <4 x i8> [[TMP46]], i8 [[GEPLOAD1308]], i32 3
...
; CHECK-NEXT:    [[TMP49:%.*]] = shl nsw <4 x i32> [[TMP38]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP50:%.*]] = shl nsw <4 x i32> [[TMP43]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP51:%.*]] = sub nsw <4 x i32> [[TMP49]], [[TMP48]]
; CHECK-NEXT:    [[TMP52:%.*]] = sub nsw <4 x i32> [[TMP51]], [[TMP50]]
; CHECK-NEXT:    [[TMP53:%.*]] = add nsw <4 x i32> [[TMP52]], [[TMP33]]
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP53]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
...
; CHECK-NEXT:    [[TMP54:%.*]] = insertelement <16 x i32> poison, i32 [[BRIDGE_T856_3315]], i32 0
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <16 x i32> [[TMP54]], i32 [[BRIDGE_T851_]], i32 1
; CHECK-NEXT:    [[TMP56:%.*]] = insertelement <16 x i32> [[TMP55]], i32 [[BRIDGE_T855_3295]], i32 2
; CHECK-NEXT:    [[TMP57:%.*]] = insertelement <16 x i32> [[TMP56]], i32 [[BRIDGE_T850_3240]], i32 3
; CHECK-NEXT:    [[TMP58:%.*]] = insertelement <16 x i32> [[TMP57]], i32 [[BRIDGE_T829_3162]], i32 4
; CHECK-NEXT:    [[TMP59:%.*]] = insertelement <16 x i32> [[TMP58]], i32 [[BRIDGE_T824_]], i32 5
; CHECK-NEXT:    [[TMP60:%.*]] = insertelement <16 x i32> [[TMP59]], i32 [[BRIDGE_T828_3142]], i32 6
; CHECK-NEXT:    [[TMP61:%.*]] = insertelement <16 x i32> [[TMP60]], i32 [[BRIDGE_T823_3087]], i32 7
; CHECK-NEXT:    [[TMP62:%.*]] = insertelement <16 x i32> [[TMP61]], i32 [[BRIDGE_T802_29162940]], i32 8
; CHECK-NEXT:    [[TMP63:%.*]] = insertelement <16 x i32> [[TMP62]], i32 [[BRIDGE_T797_2968]], i32 9
; CHECK-NEXT:    [[TMP64:%.*]] = insertelement <16 x i32> [[TMP63]], i32 [[BRIDGE_T802_29162940]], i32 10
; CHECK-NEXT:    [[TMP65:%.*]] = insertelement <16 x i32> [[TMP64]], i32 [[BRIDGE_T796_]], i32 11
; CHECK-NEXT:    [[TMP66:%.*]] = insertelement <16 x i32> [[TMP65]], i32 [[BRIDGE_T775_2757]], i32 12
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <16 x i32> [[TMP66]], i32 [[BRIDGE_T770_]], i32 13
; CHECK-NEXT:    [[TMP68:%.*]] = insertelement <16 x i32> [[TMP67]], i32 [[BRIDGE_T774_2737]], i32 14
; CHECK-NEXT:    [[TMP69:%.*]] = insertelement <16 x i32> [[TMP68]], i32 [[BRIDGE_T769_2682]], i32 15
; CHECK-NEXT:    [[TMP70:%.*]] = shufflevector <8 x i32> [[SHUFFLE1]], <8 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP71:%.*]] = shufflevector <16 x i32> poison, <16 x i32> [[TMP70]], <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP72:%.*]] = insertelement <16 x i32> [[TMP71]], i32 [[CHAIN_T802_2928]], i32 8
; CHECK-NEXT:    [[TMP73:%.*]] = insertelement <16 x i32> [[TMP72]], i32 [[CHAIN_T802_2928]], i32 9
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <16 x i32> [[TMP73]], i32 [[CHAIN_T802_2928]], i32 10
; CHECK-NEXT:    [[TMP75:%.*]] = insertelement <16 x i32> [[TMP74]], i32 [[CHAIN_T802_2928]], i32 11
; CHECK-NEXT:    [[TMP76:%.*]] = insertelement <16 x i32> [[TMP75]], i32 [[CHAIN_T775_2764]], i32 12
; CHECK-NEXT:    [[TMP77:%.*]] = insertelement <16 x i32> [[TMP76]], i32 [[CHAIN_T775_2764]], i32 13
; CHECK-NEXT:    [[TMP78:%.*]] = insertelement <16 x i32> [[TMP77]], i32 [[CHAIN_T775_2756]], i32 14
; CHECK-NEXT:    [[TMP79:%.*]] = insertelement <16 x i32> [[TMP78]], i32 [[CHAIN_T775_2764]], i32 15
; CHECK-NEXT:    [[TMP80:%.*]] = add nsw <16 x i32> [[TMP69]], [[TMP79]]
; CHECK-NEXT:    [[TMP81:%.*]] = sub nsw <16 x i32> [[TMP69]], [[TMP79]]
; CHECK-NEXT:    [[TMP82:%.*]] = shufflevector <16 x i32> [[TMP80]], <16 x i32> [[TMP81]], <16 x i32> <i32 0, i32 1, i32 18, i32 3, i32 4, i32 5, i32 22, i32 7, i32 8, i32 25, i32 26, i32 27, i32 12, i32 13, i32 30, i32 15>
; CHECK-NEXT:    [[TMP83:%.*]] = add nsw <16 x i32> [[TMP82]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP84:%.*]] = sub nsw <16 x i32> [[TMP82]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP85:%.*]] = shufflevector <16 x i32> [[TMP83]], <16 x i32> [[TMP84]], <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 24, i32 9, i32 26, i32 11, i32 12, i32 29, i32 14, i32 31>
; CHECK-NEXT:    [[TMP86:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> [[TMP85]], <16 x i32>* [[TMP86]], align 4

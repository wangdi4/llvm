...
; CHECK-NEXT:    [[I41:%.*]] = shl nsw i32 [[I23]], 16
; CHECK-NEXT:    [[I42:%.*]] = shl nsw i32 [[I27]], 16
; CHECK-NEXT:    [[CHAIN_T856_:%.*]] = sub nsw i32 [[I41]], [[I42]]
; CHECK-NEXT:    [[CHAIN_T856_3313:%.*]] = sub nsw i32 [[CHAIN_T856_]], [[I31]]
; CHECK-NEXT:    [[CHAIN_T856_3314:%.*]] = add nsw i32 [[CHAIN_T856_3313]], [[I19]]
; CHECK-NEXT:    [[BRIDGE_T856_3315:%.*]] = add nsw i32 [[CHAIN_T856_3314]], [[CHAIN_T856_3319]]
; CHECK-NEXT:    [[ARRAYIDX1052:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 2
; CHECK-NEXT:    [[BRIDGE_T855_3295:%.*]] = sub nsw i32 [[CHAIN_T856_3322]], [[CHAIN_T856_3319]]
; CHECK-NEXT:    [[ARRAYIDX1070:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 1
; CHECK-NEXT:    [[BRIDGE_T851_:%.*]] = sub nsw i32 [[CHAIN_T856_3319]], [[CHAIN_T856_3314]]
; CHECK-NEXT:    [[ARRAYIDX1088:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 3
; CHECK-NEXT:    [[BRIDGE_T850_3240:%.*]] = sub nsw i32 [[CHAIN_T856_3314]], [[CHAIN_T856_3319]]
...
; CHECK-NEXT:    [[I81:%.*]] = shl nsw i32 [[I63]], 16
; CHECK-NEXT:    [[I82:%.*]] = shl nsw i32 [[I67]], 16
; CHECK-NEXT:    [[CHAIN_T829_:%.*]] = sub nsw i32 [[I81]], [[I82]]
; CHECK-NEXT:    [[CHAIN_T829_3160:%.*]] = sub nsw i32 [[CHAIN_T829_]], [[I71]]
; CHECK-NEXT:    [[CHAIN_T829_3161:%.*]] = add nsw i32 [[CHAIN_T829_3160]], [[I59]]
; CHECK-NEXT:    [[BRIDGE_T829_3162:%.*]] = add nsw i32 [[CHAIN_T829_3161]], [[CHAIN_T829_3166]]
; CHECK-NEXT:    [[ARRAYIDX1140:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 6
; CHECK-NEXT:    [[BRIDGE_T828_3142:%.*]] = sub nsw i32 [[CHAIN_T829_3169]], [[CHAIN_T829_3166]]
; CHECK-NEXT:    [[ARRAYIDX1158:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 5
; CHECK-NEXT:    [[BRIDGE_T824_:%.*]] = sub nsw i32 [[CHAIN_T829_3166]], [[CHAIN_T829_3161]]
; CHECK-NEXT:    [[ARRAYIDX1176:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 7
; CHECK-NEXT:    [[BRIDGE_T823_3087:%.*]] = sub nsw i32 [[CHAIN_T829_3161]], [[CHAIN_T829_3166]]
...
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[ARRAYIDX1211]] to <2 x i8>*
; CHECK-NEXT:    [[TMP1:%.*]] = load <2 x i8>, <2 x i8>* [[TMP0]], align 1
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast i8* [[ARRAYIDX1313]] to <2 x i8>*
; CHECK-NEXT:    [[TMP3:%.*]] = load <2 x i8>, <2 x i8>* [[TMP2]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE4:%.*]] = shufflevector <2 x i8> [[TMP1]], <2 x i8> [[TMP3]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[BRIDGE_T782_:%.*]] = add nsw i64 11, [[I84]]
; CHECK-NEXT:    [[ARRAYIDX1323:%.*]] = getelementptr inbounds i8, i8* [[PIX2]], i64 [[BRIDGE_T782_]]
; CHECK-NEXT:    [[TMP4:%.*]] = bitcast i8* [[ARRAYIDX1209]] to <2 x i8>*
; CHECK-NEXT:    [[TMP5:%.*]] = load <2 x i8>, <2 x i8>* [[TMP4]], align 1
; CHECK-NEXT:    [[TMP6:%.*]] = bitcast i8* [[ARRAYIDX1315]] to <2 x i8>*
; CHECK-NEXT:    [[TMP7:%.*]] = load <2 x i8>, <2 x i8>* [[TMP6]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE2:%.*]] = shufflevector <2 x i8> [[TMP5]], <2 x i8> [[TMP7]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[BRIDGE_T781_:%.*]] = add nsw i64 15, [[I83]]
; CHECK-NEXT:    [[ARRAYIDX1325:%.*]] = getelementptr inbounds i8, i8* [[PIX1]], i64 [[BRIDGE_T781_]]
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i8* [[ARRAYIDX1215]] to <2 x i8>*
; CHECK-NEXT:    [[TMP9:%.*]] = load <2 x i8>, <2 x i8>* [[TMP8]], align 1
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast i8* [[ARRAYIDX1317]] to <2 x i8>*
; CHECK-NEXT:    [[TMP11:%.*]] = load <2 x i8>, <2 x i8>* [[TMP10]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE:%.*]] = shufflevector <2 x i8> [[TMP9]], <2 x i8> [[TMP11]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[BRIDGE_T780_:%.*]] = add nsw i64 15, [[I84]]
; CHECK-NEXT:    [[ARRAYIDX1327:%.*]] = getelementptr inbounds i8, i8* [[PIX2]], i64 [[BRIDGE_T780_]]
; CHECK-NEXT:    [[TMP12:%.*]] = bitcast i8* [[ARRAYIDX1213]] to <2 x i8>*
; CHECK-NEXT:    [[TMP13:%.*]] = load <2 x i8>, <2 x i8>* [[TMP12]], align 1
; CHECK-NEXT:    [[TMP14:%.*]] = bitcast i8* [[ARRAYIDX1319]] to <2 x i8>*
; CHECK-NEXT:    [[TMP15:%.*]] = load <2 x i8>, <2 x i8>* [[TMP14]], align 1
; CHECK-NEXT:    [[SPLITLOADSHUFFLE3:%.*]] = shufflevector <2 x i8> [[TMP13]], <2 x i8> [[TMP15]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
; CHECK-NEXT:    [[TMP16:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE4]] to <4 x i32>
; CHECK-NEXT:    [[TMP17:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE]] to <4 x i32>
; CHECK-NEXT:    [[TMP18:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE3]] to <4 x i32>
; CHECK-NEXT:    [[TMP19:%.*]] = zext <4 x i8> [[SPLITLOADSHUFFLE2]] to <4 x i32>
...
; CHECK-NEXT:    [[BRIDGE_T797_2968:%.*]] = sub nsw i32 [[TMP25]], [[TMP26]]
...
; CHECK-NEXT:    [[TMP27:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP28:%.*]] = insertelement <4 x i8> [[TMP27]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <4 x i8> [[TMP28]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP30:%.*]] = insertelement <4 x i8> [[TMP29]], i8 [[GEPLOAD1306]], i32 3
; CHECK-NEXT:    [[TMP31:%.*]] = zext <4 x i8> [[TMP30]] to <4 x i32>
; CHECK-NEXT:    [[I113:%.*]] = zext i8 [[GEPLOAD1298]] to i32
; CHECK-NEXT:    [[TMP32:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <4 x i8> [[TMP32]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <4 x i8> [[TMP33]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP35:%.*]] = insertelement <4 x i8> [[TMP34]], i8 [[GEPLOAD1310]], i32 3
; CHECK-NEXT:    [[TMP36:%.*]] = zext <4 x i8> [[TMP35]] to <4 x i32>
; CHECK-NEXT:    [[I117:%.*]] = zext i8 [[GEPLOAD1302]] to i32
; CHECK-NEXT:    [[TMP37:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP38:%.*]] = insertelement <4 x i8> [[TMP37]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <4 x i8> [[TMP38]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP40:%.*]] = insertelement <4 x i8> [[TMP39]], i8 [[GEPLOAD1312]], i32 3
; CHECK-NEXT:    [[TMP41:%.*]] = zext <4 x i8> [[TMP40]] to <4 x i32>
; CHECK-NEXT:    [[I121:%.*]] = zext i8 [[GEPLOAD1304]] to i32
; CHECK-NEXT:    [[TMP42:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP43:%.*]] = insertelement <4 x i8> [[TMP42]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP44:%.*]] = insertelement <4 x i8> [[TMP43]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP45:%.*]] = insertelement <4 x i8> [[TMP44]], i8 [[GEPLOAD1308]], i32 3
...
; CHECK-NEXT:    [[TMP47:%.*]] = shl nsw <4 x i32> [[TMP36]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP48:%.*]] = shl nsw <4 x i32> [[TMP41]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP49:%.*]] = sub nsw <4 x i32> [[TMP47]], [[TMP46]]
; CHECK-NEXT:    [[TMP50:%.*]] = sub nsw <4 x i32> [[TMP49]], [[TMP48]]
; CHECK-NEXT:    [[TMP51:%.*]] = add nsw <4 x i32> [[TMP50]], [[TMP31]]
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP51]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
...
; CHECK-NEXT:    [[TMP52:%.*]] = extractelement <4 x i32> [[TMP24]], i32 3
; CHECK-NEXT:    [[BRIDGE_T774_2737:%.*]] = sub nsw i32 [[CHAIN_T775_2764]], [[TMP52]]
; CHECK-NEXT:    [[ARRAYIDX1366:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I85]], i64 5
; CHECK-NEXT:    [[TMP53:%.*]] = insertelement <4 x i32> poison, i32 [[TMP26]], i32 0
; CHECK-NEXT:    [[TMP54:%.*]] = insertelement <4 x i32> [[TMP53]], i32 [[TMP25]], i32 1
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <4 x i32> [[TMP54]], i32 [[TMP52]], i32 2
; CHECK-NEXT:    [[TMP56:%.*]] = extractelement <4 x i32> [[TMP24]], i32 2
; CHECK-NEXT:    [[TMP57:%.*]] = insertelement <4 x i32> [[TMP55]], i32 [[TMP56]], i32 3
; CHECK-NEXT:    [[TMP58:%.*]] = add nsw <4 x i32> [[TMP24]], [[TMP57]]
; CHECK-NEXT:    [[TMP59:%.*]] = sub nsw <4 x i32> [[TMP24]], [[TMP57]]
; CHECK-NEXT:    [[TMP60:%.*]] = shufflevector <4 x i32> [[TMP58]], <4 x i32> [[TMP59]], <4 x i32> <i32 0, i32 5, i32 2, i32 7>
; CHECK-NEXT:    [[ARRAYIDX1384:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I85]], i64 7
; CHECK-NEXT:    [[BRIDGE_T769_2682:%.*]] = sub nsw i32 [[TMP56]], [[TMP52]]
; CHECK-NEXT:    [[TMP61:%.*]] = insertelement <16 x i32> poison, i32 [[BRIDGE_T856_3315]], i32 0
; CHECK-NEXT:    [[TMP62:%.*]] = insertelement <16 x i32> [[TMP61]], i32 [[BRIDGE_T851_]], i32 1
; CHECK-NEXT:    [[TMP63:%.*]] = insertelement <16 x i32> [[TMP62]], i32 [[BRIDGE_T855_3295]], i32 2
; CHECK-NEXT:    [[TMP64:%.*]] = insertelement <16 x i32> [[TMP63]], i32 [[BRIDGE_T850_3240]], i32 3
; CHECK-NEXT:    [[TMP65:%.*]] = insertelement <16 x i32> [[TMP64]], i32 [[BRIDGE_T829_3162]], i32 4
; CHECK-NEXT:    [[TMP66:%.*]] = insertelement <16 x i32> [[TMP65]], i32 [[BRIDGE_T824_]], i32 5
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <16 x i32> [[TMP66]], i32 [[BRIDGE_T828_3142]], i32 6
; CHECK-NEXT:    [[TMP68:%.*]] = insertelement <16 x i32> [[TMP67]], i32 [[BRIDGE_T823_3087]], i32 7
; CHECK-NEXT:    [[TMP69:%.*]] = extractelement <4 x i32> [[TMP60]], i32 0
; CHECK-NEXT:    [[TMP70:%.*]] = insertelement <16 x i32> [[TMP68]], i32 [[TMP69]], i32 8
; CHECK-NEXT:    [[TMP71:%.*]] = insertelement <16 x i32> [[TMP70]], i32 [[BRIDGE_T797_2968]], i32 9
; CHECK-NEXT:    [[TMP72:%.*]] = shufflevector <4 x i32> [[TMP60]], <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP73:%.*]] = shufflevector <16 x i32> [[TMP71]], <16 x i32> [[TMP72]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 18, i32 19, i32 14, i32 15>
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <16 x i32> [[TMP73]], i32 [[BRIDGE_T774_2737]], i32 14
; CHECK-NEXT:    [[TMP75:%.*]] = insertelement <16 x i32> [[TMP74]], i32 [[BRIDGE_T769_2682]], i32 15
; CHECK-NEXT:    [[TMP76:%.*]] = insertelement <16 x i32> poison, i32 [[CHAIN_T856_3322]], i32 0
; CHECK-NEXT:    [[TMP77:%.*]] = insertelement <16 x i32> [[TMP76]], i32 [[CHAIN_T856_3314]], i32 1
; CHECK-NEXT:    [[TMP78:%.*]] = insertelement <16 x i32> [[TMP77]], i32 [[CHAIN_T829_3169]], i32 2
; CHECK-NEXT:    [[TMP79:%.*]] = insertelement <16 x i32> [[TMP78]], i32 [[CHAIN_T829_3161]], i32 3
; CHECK-NEXT:    [[TMP80:%.*]] = insertelement <16 x i32> [[TMP79]], i32 [[CHAIN_T802_2928]], i32 4
; CHECK-NEXT:    [[TMP81:%.*]] = insertelement <16 x i32> [[TMP80]], i32 [[CHAIN_T775_2764]], i32 5
; CHECK-NEXT:    [[TMP82:%.*]] = insertelement <16 x i32> [[TMP81]], i32 [[TMP56]], i32 6
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <16 x i32> [[TMP82]], <16 x i32> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2, i32 4, i32 4, i32 4, i32 4, i32 5, i32 5, i32 6, i32 5>
; CHECK-NEXT:    [[TMP83:%.*]] = add nsw <16 x i32> [[TMP75]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP84:%.*]] = sub nsw <16 x i32> [[TMP75]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP85:%.*]] = shufflevector <16 x i32> [[TMP83]], <16 x i32> [[TMP84]], <16 x i32> <i32 0, i32 1, i32 18, i32 3, i32 4, i32 5, i32 22, i32 7, i32 8, i32 25, i32 26, i32 27, i32 12, i32 13, i32 30, i32 15>
; CHECK-NEXT:    [[TMP86:%.*]] = extractelement <4 x i32> [[TMP60]], i32 3
; CHECK-NEXT:    [[TMP87:%.*]] = extractelement <4 x i32> [[TMP60]], i32 2
; CHECK-NEXT:    [[TMP88:%.*]] = extractelement <4 x i32> [[TMP60]], i32 1
; CHECK-NEXT:    [[TMP89:%.*]] = add nsw <16 x i32> [[TMP85]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP90:%.*]] = sub nsw <16 x i32> [[TMP85]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP91:%.*]] = shufflevector <16 x i32> [[TMP89]], <16 x i32> [[TMP90]], <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 24, i32 9, i32 26, i32 11, i32 12, i32 29, i32 14, i32 31>
; CHECK-NEXT:    [[TMP92:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> [[TMP91]], <16 x i32>* [[TMP92]], align 4

...
; RUN: opt < %s -slp-vectorizer -enable-intel-advanced-opts -mtriple=x86_64-unknown-linux-gnu -mcpu=skylake-avx512 -mattr=-prefer-256-bit -S | FileCheck %s
...
; CHECK-NEXT:    [[TMP22:%.*]] = sub nsw <4 x i32> [[TMP4]], [[TMP19]]
; CHECK-NEXT:    [[TMP23:%.*]] = sub nsw <4 x i32> [[TMP22]], [[TMP21]]
; CHECK-NEXT:    [[TMP24:%.*]] = add nsw <4 x i32> [[TMP23]], [[TMP20]]
; CHECK-NEXT:    [[SHUFFLE62:%.*]] = shufflevector <4 x i32> [[TMP24]], <4 x i32> undef, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2>
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <8 x i32> [[SHUFFLE62]], i32 2
...
; CHECK-NEXT:    [[TMP26:%.*]] = extractelement <8 x i32> [[SHUFFLE62]], i32 0
...
; CHECK-NEXT:    [[TMP27:%.*]] = extractelement <8 x i32> [[SHUFFLE62]], i32 6
; CHECK-NEXT:    [[ARRAYIDX1140:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 6
; CHECK-NEXT:    [[TMP28:%.*]] = extractelement <8 x i32> [[SHUFFLE62]], i32 4
...
; CHECK-NEXT:    [[SHUFFLE63:%.*]] = shufflevector <2 x i32> [[TMP34]], <2 x i32> undef, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
; CHECK-NEXT:    [[TMP35:%.*]] = add nsw <4 x i32> [[TMP32]], [[SHUFFLE63]]
; CHECK-NEXT:    [[TMP36:%.*]] = sub nsw <4 x i32> [[TMP32]], [[SHUFFLE63]]
...
; CHECK-NEXT:    [[TMP60:%.*]] = sub nsw <4 x i32> [[TMP42]], [[TMP57]]
; CHECK-NEXT:    [[TMP61:%.*]] = sub nsw <4 x i32> [[TMP60]], [[TMP59]]
; CHECK-NEXT:    [[TMP62:%.*]] = add nsw <4 x i32> [[TMP61]], [[TMP58]]

...
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD]], i32 0
...
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1023]], i32 0
...
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1025]], i32 0
...
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1021]], i32 0
...
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP24]], <4 x i32> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2>
...
; CHECK-NEXT:    [[TMP28:%.*]] = insertelement <2 x i32> [[TMP27]], i32 [[TMP25]], i32 1
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T856_3319]], i32 0
; CHECK-NEXT:    [[TMP30:%.*]] = insertelement <2 x i32> [[TMP29]], i32 [[CHAIN_T856_3319]], i32 1
; CHECK-NEXT:    [[TMP31:%.*]] = sub nsw <2 x i32> [[TMP28]], [[TMP30]]
...
; CHECK-NEXT:    [[TMP32:%.*]] = extractelement <8 x i32> [[SHUFFLE1]], i32 6
; CHECK-NEXT:    [[ARRAYIDX1140:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 6
; CHECK-NEXT:    [[TMP33:%.*]] = extractelement <8 x i32> [[SHUFFLE1]], i32 4
; CHECK-NEXT:    [[ARRAYIDX1158:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 5
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T829_3166]], i32 0
; CHECK-NEXT:    [[TMP35:%.*]] = insertelement <2 x i32> [[TMP34]], i32 [[CHAIN_T829_3166]], i32 1
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <2 x i32> poison, i32 [[TMP32]], i32 0
; CHECK-NEXT:    [[TMP37:%.*]] = insertelement <2 x i32> [[TMP36]], i32 [[TMP32]], i32 1
; CHECK-NEXT:    [[TMP38:%.*]] = add nsw <2 x i32> [[TMP35]], [[TMP37]]
; CHECK-NEXT:    [[TMP39:%.*]] = sub nsw <2 x i32> [[TMP35]], [[TMP37]]
; CHECK-NEXT:    [[TMP40:%.*]] = shufflevector <2 x i32> [[TMP38]], <2 x i32> [[TMP39]], <2 x i32> <i32 0, i32 3>
; CHECK-NEXT:    [[ARRAYIDX1176:%.*]] = getelementptr inbounds [16 x [8 x i32]], [16 x [8 x i32]]* [[ALLOCA]], i64 0, i64 [[I1]], i64 7
; CHECK-NEXT:    [[TMP41:%.*]] = insertelement <2 x i32> poison, i32 [[TMP33]], i32 0
; CHECK-NEXT:    [[TMP42:%.*]] = insertelement <2 x i32> [[TMP41]], i32 [[TMP32]], i32 1
; CHECK-NEXT:    [[TMP43:%.*]] = sub nsw <2 x i32> [[TMP42]], [[TMP35]]
...
; CHECK-NEXT:    [[TMP44:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T802_29182920]], i32 0
; CHECK-NEXT:    [[TMP45:%.*]] = insertelement <2 x i32> [[TMP44]], i32 [[CHAIN_T802_29182920]], i32 1
; CHECK-NEXT:    [[TMP46:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T802_29102912]], i32 0
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <2 x i32> [[TMP46]], i32 [[CHAIN_T802_29102912]], i32 1
; CHECK-NEXT:    [[TMP48:%.*]] = add nsw <2 x i32> [[TMP45]], [[TMP47]]
; CHECK-NEXT:    [[TMP49:%.*]] = sub nsw <2 x i32> [[TMP45]], [[TMP47]]
; CHECK-NEXT:    [[TMP50:%.*]] = shufflevector <2 x i32> [[TMP48]], <2 x i32> [[TMP49]], <2 x i32> <i32 0, i32 3>
...
; CHECK-NEXT:    [[TMP51:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP52:%.*]] = insertelement <4 x i8> [[TMP51]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP53:%.*]] = insertelement <4 x i8> [[TMP52]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP54:%.*]] = insertelement <4 x i8> [[TMP53]], i8 [[GEPLOAD1306]], i32 3
; CHECK-NEXT:    [[TMP55:%.*]] = zext <4 x i8> [[TMP54]] to <4 x i32>
...
; CHECK-NEXT:    [[TMP56:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP57:%.*]] = insertelement <4 x i8> [[TMP56]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP58:%.*]] = insertelement <4 x i8> [[TMP57]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP59:%.*]] = insertelement <4 x i8> [[TMP58]], i8 [[GEPLOAD1310]], i32 3
; CHECK-NEXT:    [[TMP60:%.*]] = zext <4 x i8> [[TMP59]] to <4 x i32>
...
; CHECK-NEXT:    [[TMP61:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP62:%.*]] = insertelement <4 x i8> [[TMP61]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP63:%.*]] = insertelement <4 x i8> [[TMP62]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP64:%.*]] = insertelement <4 x i8> [[TMP63]], i8 [[GEPLOAD1312]], i32 3
...
; CHECK-NEXT:    [[TMP66:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <4 x i8> [[TMP66]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP68:%.*]] = insertelement <4 x i8> [[TMP67]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP69:%.*]] = insertelement <4 x i8> [[TMP68]], i8 [[GEPLOAD1308]], i32 3
...
; CHECK-NEXT:    [[TMP71:%.*]] = shl nsw <4 x i32> [[TMP60]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP72:%.*]] = shl nsw <4 x i32> [[TMP65]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP73:%.*]] = sub nsw <4 x i32> [[TMP71]], [[TMP70]]
; CHECK-NEXT:    [[TMP74:%.*]] = sub nsw <4 x i32> [[TMP73]], [[TMP72]]
; CHECK-NEXT:    [[TMP75:%.*]] = add nsw <4 x i32> [[TMP74]], [[TMP55]]
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP75]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
...
; CHECK-NEXT:    [[BRIDGE_T775_2757:%.*]] = add nsw i32 [[CHAIN_T775_2756]], [[CHAIN_T775_2761]]
...
; CHECK-NEXT:    [[TMP76:%.*]] = insertelement <16 x i32> poison, i32 [[BRIDGE_T856_3315]], i32 0
; CHECK-NEXT:    [[TMP77:%.*]] = insertelement <16 x i32> [[TMP76]], i32 [[BRIDGE_T851_]], i32 1
; CHECK-NEXT:    [[TMP78:%.*]] = shufflevector <2 x i32> [[TMP31]], <2 x i32> undef, <16 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP79:%.*]] = shufflevector <16 x i32> [[TMP77]], <16 x i32> [[TMP78]], <16 x i32> <i32 0, i32 1, i32 16, i32 17, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP80:%.*]] = shufflevector <2 x i32> [[TMP40]], <2 x i32> undef, <16 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP81:%.*]] = shufflevector <16 x i32> [[TMP79]], <16 x i32> [[TMP80]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 16, i32 17, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP82:%.*]] = shufflevector <2 x i32> [[TMP43]], <2 x i32> undef, <16 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP83:%.*]] = shufflevector <16 x i32> [[TMP81]], <16 x i32> [[TMP82]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 16, i32 17, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP84:%.*]] = extractelement <2 x i32> [[TMP50]], i32 0
; CHECK-NEXT:    [[TMP85:%.*]] = insertelement <16 x i32> [[TMP83]], i32 [[TMP84]], i32 8
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <16 x i32> [[TMP85]], i32 [[BRIDGE_T797_2968]], i32 9
; CHECK-NEXT:    [[TMP87:%.*]] = shufflevector <2 x i32> [[TMP50]], <2 x i32> undef, <16 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP88:%.*]] = shufflevector <16 x i32> [[TMP86]], <16 x i32> [[TMP87]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 16, i32 17, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP89:%.*]] = insertelement <16 x i32> [[TMP88]], i32 [[BRIDGE_T775_2757]], i32 12
; CHECK-NEXT:    [[TMP90:%.*]] = insertelement <16 x i32> [[TMP89]], i32 [[BRIDGE_T770_]], i32 13
; CHECK-NEXT:    [[TMP91:%.*]] = insertelement <16 x i32> [[TMP90]], i32 [[BRIDGE_T774_2737]], i32 14
; CHECK-NEXT:    [[TMP92:%.*]] = insertelement <16 x i32> [[TMP91]], i32 [[BRIDGE_T769_2682]], i32 15
; CHECK-NEXT:    [[TMP93:%.*]] = shufflevector <8 x i32> [[SHUFFLE1]], <8 x i32> undef, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP94:%.*]] = shufflevector <16 x i32> poison, <16 x i32> [[TMP93]], <16 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <16 x i32> [[TMP94]], i32 [[CHAIN_T802_2928]], i32 8
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <16 x i32> [[TMP95]], i32 [[CHAIN_T802_2928]], i32 9
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <16 x i32> [[TMP96]], i32 [[CHAIN_T802_2928]], i32 10
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <16 x i32> [[TMP97]], i32 [[CHAIN_T802_2928]], i32 11
; CHECK-NEXT:    [[TMP99:%.*]] = insertelement <16 x i32> [[TMP98]], i32 [[CHAIN_T775_2764]], i32 12
; CHECK-NEXT:    [[TMP100:%.*]] = insertelement <16 x i32> [[TMP99]], i32 [[CHAIN_T775_2764]], i32 13
; CHECK-NEXT:    [[TMP101:%.*]] = insertelement <16 x i32> [[TMP100]], i32 [[CHAIN_T775_2756]], i32 14
; CHECK-NEXT:    [[TMP102:%.*]] = insertelement <16 x i32> [[TMP101]], i32 [[CHAIN_T775_2764]], i32 15
; CHECK-NEXT:    [[TMP103:%.*]] = add nsw <16 x i32> [[TMP92]], [[TMP102]]
; CHECK-NEXT:    [[TMP104:%.*]] = sub nsw <16 x i32> [[TMP92]], [[TMP102]]
; CHECK-NEXT:    [[TMP105:%.*]] = shufflevector <16 x i32> [[TMP103]], <16 x i32> [[TMP104]], <16 x i32> <i32 0, i32 1, i32 18, i32 3, i32 4, i32 5, i32 22, i32 7, i32 8, i32 25, i32 26, i32 27, i32 12, i32 13, i32 30, i32 15>
; CHECK-NEXT:    [[TMP106:%.*]] = extractelement <2 x i32> [[TMP50]], i32 1
; CHECK-NEXT:    [[TMP107:%.*]] = extractelement <2 x i32> [[TMP43]], i32 1
; CHECK-NEXT:    [[TMP108:%.*]] = extractelement <2 x i32> [[TMP43]], i32 0
; CHECK-NEXT:    [[TMP109:%.*]] = extractelement <2 x i32> [[TMP40]], i32 1
; CHECK-NEXT:    [[TMP110:%.*]] = extractelement <2 x i32> [[TMP40]], i32 0
; CHECK-NEXT:    [[TMP111:%.*]] = extractelement <2 x i32> [[TMP31]], i32 1
; CHECK-NEXT:    [[TMP112:%.*]] = extractelement <2 x i32> [[TMP31]], i32 0
; CHECK-NEXT:    [[TMP113:%.*]] = add nsw <16 x i32> [[TMP105]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP114:%.*]] = sub nsw <16 x i32> [[TMP105]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP115:%.*]] = shufflevector <16 x i32> [[TMP113]], <16 x i32> [[TMP114]], <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 24, i32 9, i32 26, i32 11, i32 12, i32 29, i32 14, i32 31>
; CHECK-NEXT:    [[TMP116:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> [[TMP115]], <16 x i32>* [[TMP116]], align 4

...
; CHECK-NEXT:    [[TMP0:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T802_29182920]], i32 0
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <2 x i32> [[TMP0]], i32 [[CHAIN_T802_29182920]], i32 1
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T802_29102912]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <2 x i32> [[TMP2]], i32 [[CHAIN_T802_29102912]], i32 1
; CHECK-NEXT:    [[TMP4:%.*]] = add nsw <2 x i32> [[TMP1]], [[TMP3]]
; CHECK-NEXT:    [[TMP5:%.*]] = sub nsw <2 x i32> [[TMP1]], [[TMP3]]
...
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP8:%.*]] = insertelement <4 x i8> [[TMP7]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x i8> [[TMP8]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP10:%.*]] = insertelement <4 x i8> [[TMP9]], i8 [[GEPLOAD1306]], i32 3
...
; CHECK-NEXT:    [[TMP12:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <4 x i8> [[TMP12]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP14:%.*]] = insertelement <4 x i8> [[TMP13]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP15:%.*]] = insertelement <4 x i8> [[TMP14]], i8 [[GEPLOAD1310]], i32 3
...
; CHECK-NEXT:    [[TMP17:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
; CHECK-NEXT:    [[TMP18:%.*]] = insertelement <4 x i8> [[TMP17]], i8 [[GEPLOAD1120]], i32 1
; CHECK-NEXT:    [[TMP19:%.*]] = insertelement <4 x i8> [[TMP18]], i8 [[GEPLOAD1206]], i32 2
; CHECK-NEXT:    [[TMP20:%.*]] = insertelement <4 x i8> [[TMP19]], i8 [[GEPLOAD1312]], i32 3
...
; CHECK-NEXT:    [[TMP22:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP23:%.*]] = insertelement <4 x i8> [[TMP22]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP24:%.*]] = insertelement <4 x i8> [[TMP23]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP25:%.*]] = insertelement <4 x i8> [[TMP24]], i8 [[GEPLOAD1308]], i32 3
...
; CHECK-NEXT:    [[TMP27:%.*]] = shl nsw <4 x i32> [[TMP16]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP28:%.*]] = shl nsw <4 x i32> [[TMP21]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP29:%.*]] = sub nsw <4 x i32> [[TMP27]], [[TMP26]]
; CHECK-NEXT:    [[TMP30:%.*]] = sub nsw <4 x i32> [[TMP29]], [[TMP28]]
; CHECK-NEXT:    [[TMP31:%.*]] = add nsw <4 x i32> [[TMP30]], [[TMP11]]
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP31]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
...
; CHECK-NEXT:    [[TMP32:%.*]] = insertelement <16 x i32> poison, i32 [[BRIDGE_T856_3315]], i32 0
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <16 x i32> [[TMP32]], i32 [[BRIDGE_T851_]], i32 1
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <16 x i32> [[TMP33]], i32 [[BRIDGE_T855_3295]], i32 2
; CHECK-NEXT:    [[TMP35:%.*]] = insertelement <16 x i32> [[TMP34]], i32 [[BRIDGE_T850_3240]], i32 3
; CHECK-NEXT:    [[TMP36:%.*]] = insertelement <16 x i32> [[TMP35]], i32 [[BRIDGE_T829_3162]], i32 4
; CHECK-NEXT:    [[TMP37:%.*]] = insertelement <16 x i32> [[TMP36]], i32 [[BRIDGE_T824_]], i32 5
; CHECK-NEXT:    [[TMP38:%.*]] = insertelement <16 x i32> [[TMP37]], i32 [[BRIDGE_T828_3142]], i32 6
; CHECK-NEXT:    [[TMP39:%.*]] = insertelement <16 x i32> [[TMP38]], i32 [[BRIDGE_T823_3087]], i32 7
...
; CHECK-NEXT:    [[TMP47:%.*]] = insertelement <16 x i32> [[TMP46]], i32 [[BRIDGE_T774_2737]], i32 14
; CHECK-NEXT:    [[TMP48:%.*]] = insertelement <16 x i32> [[TMP47]], i32 [[BRIDGE_T769_2682]], i32 15
; CHECK-NEXT:    [[TMP49:%.*]] = insertelement <16 x i32> poison, i32 [[CHAIN_T856_3322]], i32 0
; CHECK-NEXT:    [[TMP50:%.*]] = insertelement <16 x i32> [[TMP49]], i32 [[CHAIN_T856_3314]], i32 1
; CHECK-NEXT:    [[TMP51:%.*]] = insertelement <16 x i32> [[TMP50]], i32 [[CHAIN_T829_3169]], i32 2
; CHECK-NEXT:    [[TMP52:%.*]] = insertelement <16 x i32> [[TMP51]], i32 [[CHAIN_T829_3161]], i32 3
; CHECK-NEXT:    [[TMP53:%.*]] = insertelement <16 x i32> [[TMP52]], i32 [[CHAIN_T802_2928]], i32 4
; CHECK-NEXT:    [[TMP54:%.*]] = insertelement <16 x i32> [[TMP53]], i32 [[CHAIN_T775_2764]], i32 5
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <16 x i32> [[TMP54]], i32 [[CHAIN_T775_2756]], i32 6
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <16 x i32> [[TMP55]], <16 x i32> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2, i32 4, i32 4, i32 4, i32 4, i32 5, i32 5, i32 6, i32 5>
; CHECK-NEXT:    [[TMP56:%.*]] = add nsw <16 x i32> [[TMP48]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP57:%.*]] = sub nsw <16 x i32> [[TMP48]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP58:%.*]] = shufflevector <16 x i32> [[TMP56]], <16 x i32> [[TMP57]], <16 x i32> <i32 0, i32 1, i32 18, i32 3, i32 4, i32 5, i32 22, i32 7, i32 8, i32 25, i32 26, i32 27, i32 12, i32 13, i32 30, i32 15>
; CHECK-NEXT:    [[TMP59:%.*]] = extractelement <2 x i32> [[TMP6]], i32 1
; CHECK-NEXT:    [[TMP60:%.*]] = add nsw <16 x i32> [[TMP58]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP61:%.*]] = sub nsw <16 x i32> [[TMP58]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP62:%.*]] = shufflevector <16 x i32> [[TMP60]], <16 x i32> [[TMP61]], <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 24, i32 9, i32 26, i32 11, i32 12, i32 29, i32 14, i32 31>
; CHECK-NEXT:    [[TMP63:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> [[TMP62]], <16 x i32>* [[TMP63]], align 4

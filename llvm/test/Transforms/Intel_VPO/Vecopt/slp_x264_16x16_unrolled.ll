...
; CHECK-NEXT:    [[TMP36:%.*]] = shufflevector <8 x i32> poison, <8 x i32> [[TMP35]], <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[SHUFFLE4:%.*]] = shufflevector <8 x i32> [[TMP36]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 0, i32 0, i32 2, i32 3, i32 2, i32 2>
; CHECK-NEXT:    [[TMP37:%.*]] = add nsw <8 x i32> [[SHUFFLE3]], [[SHUFFLE4]]
; CHECK-NEXT:    [[TMP38:%.*]] = sub nsw <8 x i32> [[SHUFFLE3]], [[SHUFFLE4]]
; CHECK-NEXT:    [[TMP39:%.*]] = shufflevector <8 x i32> [[TMP37]], <8 x i32> [[TMP38]], <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
...
; CHECK-NEXT:    [[BRIDGE_T802_29162940:%.*]] = add nsw i32 [[CHAIN_T802_29102912]], [[CHAIN_T802_29182920]]
...
; CHECK-NEXT:    [[BRIDGE_T796_:%.*]] = sub nsw i32 [[CHAIN_T802_29182920]], [[CHAIN_T802_29102912]]
...
; CHECK-NEXT:    [[TMP40:%.*]] = bitcast i8* [[ARRAYIDX1313]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP42:%.*]] = bitcast i8* [[ARRAYIDX1315]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP44:%.*]] = bitcast i8* [[ARRAYIDX1317]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP46:%.*]] = bitcast i8* [[ARRAYIDX1319]] to <2 x i8>*
...
; CHECK-NEXT:    [[TMP48:%.*]] = zext <2 x i8> [[TMP41]] to <2 x i32>
; CHECK-NEXT:    [[TMP49:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
; CHECK-NEXT:    [[TMP50:%.*]] = insertelement <4 x i8> [[TMP49]], i8 [[GEPLOAD1114]], i32 1
; CHECK-NEXT:    [[TMP51:%.*]] = insertelement <4 x i8> [[TMP50]], i8 [[GEPLOAD1204]], i32 2
; CHECK-NEXT:    [[TMP52:%.*]] = insertelement <4 x i8> [[TMP51]], i8 [[GEPLOAD1306]], i32 3
; CHECK-NEXT:    [[TMP53:%.*]] = zext <4 x i8> [[TMP52]] to <4 x i32>
; CHECK-NEXT:    [[I113:%.*]] = zext i8 [[GEPLOAD1298]] to i32
; CHECK-NEXT:    [[TMP54:%.*]] = zext <2 x i8> [[TMP45]] to <2 x i32>
; CHECK-NEXT:    [[TMP55:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
; CHECK-NEXT:    [[TMP56:%.*]] = insertelement <4 x i8> [[TMP55]], i8 [[GEPLOAD1118]], i32 1
; CHECK-NEXT:    [[TMP57:%.*]] = insertelement <4 x i8> [[TMP56]], i8 [[GEPLOAD1208]], i32 2
; CHECK-NEXT:    [[TMP58:%.*]] = insertelement <4 x i8> [[TMP57]], i8 [[GEPLOAD1310]], i32 3
; CHECK-NEXT:    [[TMP59:%.*]] = zext <4 x i8> [[TMP58]] to <4 x i32>
; CHECK-NEXT:    [[I117:%.*]] = zext i8 [[GEPLOAD1302]] to i32
; CHECK-NEXT:    [[TMP60:%.*]] = zext <2 x i8> [[TMP47]] to <2 x i32>
...
; CHECK-NEXT:    [[TMP66:%.*]] = zext <2 x i8> [[TMP43]] to <2 x i32>
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
; CHECK-NEXT:    [[TMP68:%.*]] = insertelement <4 x i8> [[TMP67]], i8 [[GEPLOAD1116]], i32 1
; CHECK-NEXT:    [[TMP69:%.*]] = insertelement <4 x i8> [[TMP68]], i8 [[GEPLOAD1202]], i32 2
; CHECK-NEXT:    [[TMP70:%.*]] = insertelement <4 x i8> [[TMP69]], i8 [[GEPLOAD1308]], i32 3
...
; CHECK-NEXT:    [[TMP72:%.*]] = shl nsw <4 x i32> [[TMP59]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP73:%.*]] = shl nsw <4 x i32> [[TMP65]], <i32 16, i32 16, i32 16, i32 16>
; CHECK-NEXT:    [[TMP74:%.*]] = sub nsw <4 x i32> [[TMP72]], [[TMP71]]
; CHECK-NEXT:    [[TMP75:%.*]] = sub nsw <4 x i32> [[TMP74]], [[TMP73]]
; CHECK-NEXT:    [[TMP76:%.*]] = add nsw <4 x i32> [[TMP75]], [[TMP53]]
; CHECK-NEXT:    [[SHUFFLE1:%.*]] = shufflevector <4 x i32> [[TMP76]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
...
; CHECK-NEXT:    [[TMP77:%.*]] = shl nsw <2 x i32> [[TMP54]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP78:%.*]] = shl nsw <2 x i32> [[TMP60]], <i32 16, i32 16>
; CHECK-NEXT:    [[TMP79:%.*]] = sub nsw <2 x i32> [[TMP77]], [[TMP66]]
; CHECK-NEXT:    [[TMP80:%.*]] = sub nsw <2 x i32> [[TMP79]], [[TMP78]]
; CHECK-NEXT:    [[TMP81:%.*]] = add nsw <2 x i32> [[TMP80]], [[TMP48]]
...
; CHECK-NEXT:    [[TMP82:%.*]] = extractelement <2 x i32> [[TMP81]], i32 1
; CHECK-NEXT:    [[TMP83:%.*]] = insertelement <4 x i32> poison, i32 [[TMP82]], i32 0
; CHECK-NEXT:    [[TMP84:%.*]] = extractelement <2 x i32> [[TMP81]], i32 0
; CHECK-NEXT:    [[TMP85:%.*]] = insertelement <4 x i32> [[TMP83]], i32 [[TMP84]], i32 1
; CHECK-NEXT:    [[TMP86:%.*]] = insertelement <4 x i32> [[TMP85]], i32 [[CHAIN_T775_2764]], i32 2
; CHECK-NEXT:    [[TMP87:%.*]] = insertelement <4 x i32> [[TMP86]], i32 [[TMP82]], i32 3
; CHECK-NEXT:    [[TMP88:%.*]] = shufflevector <2 x i32> [[TMP81]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP89:%.*]] = shufflevector <4 x i32> poison, <4 x i32> [[TMP88]], <4 x i32> <i32 4, i32 5, i32 2, i32 3>
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <4 x i32> [[TMP89]], <4 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
; CHECK-NEXT:    [[TMP90:%.*]] = add nsw <4 x i32> [[TMP87]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP91:%.*]] = sub nsw <4 x i32> [[TMP87]], [[SHUFFLE2]]
; CHECK-NEXT:    [[TMP92:%.*]] = shufflevector <4 x i32> [[TMP90]], <4 x i32> [[TMP91]], <4 x i32> <i32 0, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[TMP93:%.*]] = shufflevector <8 x i32> [[TMP39]], <8 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
...
; CHECK-NEXT:    [[TMP95:%.*]] = insertelement <16 x i32> [[TMP94]], i32 [[BRIDGE_T802_29162940]], i32 8
; CHECK-NEXT:    [[TMP96:%.*]] = insertelement <16 x i32> [[TMP95]], i32 [[BRIDGE_T797_2968]], i32 9
; CHECK-NEXT:    [[TMP97:%.*]] = insertelement <16 x i32> [[TMP96]], i32 [[BRIDGE_T802_29162940]], i32 10
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <16 x i32> [[TMP97]], i32 [[BRIDGE_T796_]], i32 11
; CHECK-NEXT:    [[TMP99:%.*]] = shufflevector <4 x i32> [[TMP92]], <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP100:%.*]] = shufflevector <16 x i32> [[TMP98]], <16 x i32> [[TMP99]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 18, i32 19>
; CHECK-NEXT:    [[TMP101:%.*]] = insertelement <16 x i32> poison, i32 [[CHAIN_T856_3322]], i32 0
; CHECK-NEXT:    [[TMP102:%.*]] = insertelement <16 x i32> [[TMP101]], i32 [[TMP25]], i32 1
; CHECK-NEXT:    [[TMP103:%.*]] = insertelement <16 x i32> [[TMP102]], i32 [[CHAIN_T829_3169]], i32 2
; CHECK-NEXT:    [[TMP104:%.*]] = insertelement <16 x i32> [[TMP103]], i32 [[TMP30]], i32 3
; CHECK-NEXT:    [[TMP105:%.*]] = insertelement <16 x i32> [[TMP104]], i32 [[CHAIN_T802_2928]], i32 4
; CHECK-NEXT:    [[TMP106:%.*]] = insertelement <16 x i32> [[TMP105]], i32 [[CHAIN_T775_2764]], i32 5
; CHECK-NEXT:    [[TMP107:%.*]] = insertelement <16 x i32> [[TMP106]], i32 [[TMP82]], i32 6
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <16 x i32> [[TMP107]], <16 x i32> poison, <16 x i32> <i32 0, i32 0, i32 1, i32 0, i32 2, i32 2, i32 3, i32 2, i32 4, i32 4, i32 4, i32 4, i32 5, i32 5, i32 6, i32 5>
; CHECK-NEXT:    [[TMP108:%.*]] = add nsw <16 x i32> [[TMP100]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP109:%.*]] = sub nsw <16 x i32> [[TMP100]], [[SHUFFLE]]
; CHECK-NEXT:    [[TMP110:%.*]] = shufflevector <16 x i32> [[TMP108]], <16 x i32> [[TMP109]], <16 x i32> <i32 0, i32 1, i32 18, i32 3, i32 4, i32 5, i32 22, i32 7, i32 8, i32 25, i32 26, i32 27, i32 12, i32 13, i32 30, i32 15>
; CHECK-NEXT:    [[TMP111:%.*]] = add nsw <16 x i32> [[TMP110]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP112:%.*]] = sub nsw <16 x i32> [[TMP110]], [[SHUFFLE1]]
; CHECK-NEXT:    [[TMP113:%.*]] = shufflevector <16 x i32> [[TMP111]], <16 x i32> [[TMP112]], <16 x i32> <i32 0, i32 17, i32 2, i32 19, i32 4, i32 21, i32 6, i32 23, i32 24, i32 9, i32 26, i32 11, i32 12, i32 29, i32 14, i32 31>
; CHECK-NEXT:    [[TMP114:%.*]] = bitcast i32* [[ARRAYIDX1050]] to <16 x i32>*
; CHECK-NEXT:    store <16 x i32> [[TMP113]], <16 x i32>* [[TMP114]], align 4

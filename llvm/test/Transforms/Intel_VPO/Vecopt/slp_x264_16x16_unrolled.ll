...
; CHECK-NEXT:    [[TMP29:%.*]] = insertelement <4 x i32> poison, i32 [[TMP27]], i32 0
...
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <2 x i32> poison, i32 [[CHAIN_T829_3166]], i32 0
; CHECK-NEXT:    [[TMP34:%.*]] = insertelement <2 x i32> [[TMP33]], i32 [[TMP27]], i32 1
; CHECK-NEXT:    [[SHUFFLE2:%.*]] = shufflevector <2 x i32> [[TMP34]], <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
...
; CHECK-NEXT:    [[TMP38:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1027]], i32 0
...
; CHECK-NEXT:    [[TMP43:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1031]], i32 0
...
; CHECK-NEXT:    [[TMP48:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1033]], i32 0
...
; CHECK-NEXT:    [[TMP53:%.*]] = insertelement <4 x i8> poison, i8 [[GEPLOAD1029]], i32 0
...
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <4 x i32> [[TMP62]], <4 x i32> poison, <16 x i32> <i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 3, i32 3, i32 3, i32 3>
...
; CHECK-NEXT:    [[TMP63:%.*]] = insertelement <4 x i32> poison, i32 [[CHAIN_T802_29102912]], i32 0
...
; CHECK-NEXT:    [[TMP67:%.*]] = insertelement <4 x i32> poison, i32 [[CHAIN_T802_29182920]], i32 0
...
; CHECK-NEXT:    [[TMP74:%.*]] = insertelement <16 x i32> poison, i32 [[BRIDGE_T856_3315]], i32 0
...
; CHECK-NEXT:    [[TMP98:%.*]] = insertelement <16 x i32> poison, i32 [[TMP26]], i32 0

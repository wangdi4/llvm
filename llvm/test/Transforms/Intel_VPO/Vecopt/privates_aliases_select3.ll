...
define void @_ZGVeN16uuu__ZTSZZ4mainENKUlRN2cl4sycl7handlerEE_clES2_E11AtomicTests(i64 %_arg_m_capacity, i64* %ptr, i1 zeroext %cmp.i.i) {
;
...
simd.begin.region:                                ; preds = %entry
  %entry.region = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 16), "QUAL.OMP.UNIFORM:TYPED"(i64* %ptr, i64 0, i32 1), "QUAL.OMP.UNIFORM"(i1 %cmp.i.i), "QUAL.OMP.PRIVATE:TYPED"([32 x i64]* %.sroa.0, i64 0, i32 32),"QUAL.OMP.PRIVATE:TYPED"([32 x i64]* %alt, i64 0, i32 32) ]
...
simd.loop.header:                                 ; preds = %simd.loop.latch, %simd.loop.preheader
  ...
  %sel.cast = addrspacecast i64 addrspace(4)* %select to i64*
  br i1 %cmp.i.i, label %t_block, label %simd.loop.latch

t_block:
  %add.ptr.i14 = getelementptr inbounds i64, i64* %ptr, i32 %index
  br label %simd.loop.latch

simd.loop.latch:                                  ; preds = %simd.loop.header
  %st.ptr = phi i64* [%add.ptr.i14, %t_block], [%sel.cast, %simd.loop.header]
  store i64 %cond.i.i, i64* %st.ptr, align 4

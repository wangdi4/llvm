...
; CHECK-NEXT:         [DA: Uni] i64 [[VP_NORM_UB:%.*]] = sub i64 [[VP0]] i64 0
...
; CHECK-NEXT:         [DA: Div] i1 [[VP4:%.*]] = icmp ule i64 [[VP_INDVARS_IV]] i64 [[VP_NORM_UB]]
...
; CHECK-NEXT:         [DA: Div] i1 [[VP6:%.*]] = icmp ule i64 [[VP_INDVARS_IV_NEXT]] i64 [[VP_NORM_UB]]
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP10:%.*]] = add i64 [[VP9]] i64 4
...
; CHECK-NEXT:       [DA: Uni] i64 [[VP_VECTOR_TRIP_COUNT:%.*]] = vector-trip-count i64 1023 i64 [[VP9]], UF = 1
...
; CHECK-NEXT:       [DA: Div] i64 [[VP12:%.*]] = induction-init{add} i64 0 i64 1
; CHECK-NEXT:       [DA: Uni] i64 [[VP13:%.*]] = induction-init-step{add} i64 1
; CHECK-NEXT:       [DA: Uni] i64 [[VP14:%.*]] = sub i64 1023 i64 [[VP11]]
...
; CHECK-NEXT:       [DA: Div] i64 [[VP15:%.*]] = add i64 [[VP_INDVARS_IV_2]] i64 [[VP11]]
; CHECK-NEXT:       [DA: Div] i1 [[VP16:%.*]] = icmp ule i64 [[VP_INDVARS_IV_2]] i64 [[VP14]]
; CHECK-NEXT:       [DA: Uni] br [[BB15:BB[0-9]+]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB15]]: # preds: [[BB14]]
; CHECK-NEXT:       [DA: Div] i1 [[VP17:%.*]] = block-predicate i1 [[VP16]]
; CHECK-NEXT:       [DA: Div] ptr [[VP_PTR_2:%.*]] = getelementptr inbounds i64, ptr [[ARY0]] i64 [[VP15]]
; CHECK-NEXT:       [DA: Uni] i64 [[VP_CC_2:%.*]] = sext i32 [[C0]] to i64
; CHECK-NEXT:       [DA: Div] i64 [[VP_ADD_2:%.*]] = add i64 [[VP_CC_2]] i64 [[VP15]]
...
; CHECK-NEXT:       [DA: Div] i1 [[VP18:%.*]] = icmp ule i64 [[VP_INDVARS_IV_NEXT_2]] i64 [[VP14]]
; CHECK-NEXT:       [DA: Uni] i1 [[VP19:%.*]] = all-zero-check i1 [[VP18]]
; CHECK-NEXT:       [DA: Uni] br i1 [[VP19]], [[BB16:BB[0-9]+]], [[BB14]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB16]]: # preds: new_latch17
; CHECK-NEXT:       [DA: Uni] i64 [[VP20:%.*]] = induction-final{add} i64 0 i64 1
...
; CHECK-NEXT:     [DA: Uni] i64 [[VP21:%.*]] = phi-merge  [ i64 [[VP20]], [[BB17]] ],  [ i64 live-out0, [[BB11]] ]
; CHECK-NEXT:     [DA: Uni] popvf

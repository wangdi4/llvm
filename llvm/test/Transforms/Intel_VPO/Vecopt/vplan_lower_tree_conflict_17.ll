...
define dso_local void @foo(float* noalias nocapture noundef %A, i32* noalias nocapture noundef readonly %B, float* noalias nocapture noundef readonly %C, i32 noundef %N) local_unnamed_addr #0 {
;
; float A[N], C[N];
...
; CHECK-VF4-NEXT:           |   [[DOTVEC20:%.*]] = (<4 x float>*)([[C0:%.*]])[i1]
...
; CHECK-VF4-NEXT:           |   [[DOTVEC280:%.*]] = [[DOTVEC10]]  -  [[PHI_TEMP0]]
...
; CHECK-VF8-NEXT:           |   [[DOTVEC20:%.*]] = (<8 x float>*)([[C0:%.*]])[i1]
...
; CHECK-VF8-NEXT:           |   [[DOTVEC260:%.*]] = [[DOTVEC10]]  -  [[PHI_TEMP0]]

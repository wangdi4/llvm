...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx2 = getelementptr inbounds [1024 x float], ptr @b, i64 0, i64 %indvars.iv, !intel-tbaa !2
  %2 = load float, ptr %arrayidx2, align 4, !tbaa !2
  %mul = fmul fast float %2, %conv
  %arrayidx7 = getelementptr inbounds [1024 x float], ptr @c, i64 0, i64 %indvars.iv, !intel-tbaa !2

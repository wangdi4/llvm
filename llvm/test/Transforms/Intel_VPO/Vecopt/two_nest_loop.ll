;
; REQUIRES: asserts
; RUN: opt -vplan-print-terminator-inst=false -vplan-enable-soa=false -S %s -VPlanDriver -vplan-print-after-linearization -disable-output | FileCheck %s
; RUN: opt -vplan-print-terminator-inst=false -vplan-enable-soa=false -S %s -passes="vplan-driver" -vplan-print-after-linearization -disable-output | FileCheck %s

...
; REQUIRES: asserts
; RUN: opt -vplan-print-terminator-inst=false < %s -vplan-func-vec -enable-vplan-func-vec-all-zero-bypass-loops -print-after-vplan-func-vec-all-zero-bypass -disable-output -S 2>&1 | FileCheck %s
; RUN: opt -vplan-print-terminator-inst=false < %s -passes="vplan-func-vec" -enable-vplan-func-vec-all-zero-bypass-loops -print-after-vplan-func-vec-all-zero-bypass -disable-output -S 2>&1 | FileCheck %s
...
; CHECK-NEXT:      SUCCESSORS(2):[[BB3:BB[0-9]+]](i1 [[VP5]]), [[BB2]](!i1 [[VP5]])
...
; CHECK-NEXT:    PREDECESSORS(2): [[BB3]] all.zero.bypass.begin12
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB4]]:
; CHECK-NEXT:     [DA: Div] i1 [[VP_BB5_BR_VP_CMP7:%.*]] = and i1 [[VP_CMP1]] i1 [[VP_CMP7]]
; CHECK-NEXT:    SUCCESSORS(1):[[BB5:BB[0-9]+]]
; CHECK-NEXT:    PREDECESSORS(1): all.zero.bypass.end14
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB5]]:
...
; CHECK-NEXT:    SUCCESSORS(1):all.zero.bypass.begin16
; CHECK-NEXT:    PREDECESSORS(1): [[BB4]]
; CHECK-EMPTY:
; CHECK-NEXT:    all.zero.bypass.begin16:
; CHECK-NEXT:     [DA: Uni] i1 [[VP_ALL_ZERO_CHECK_1:%.*]] = all-zero-check i1 [[VP_CMP1]]
; CHECK-NEXT:    SUCCESSORS(2):all.zero.bypass.end18(i1 [[VP_ALL_ZERO_CHECK_1]]), [[BB6:BB[0-9]+]](!i1 [[VP_ALL_ZERO_CHECK_1]])
...
; CHECK-NEXT:      SUCCESSORS(2):[[BB8:BB[0-9]+]](i1 [[VP12]]), [[BB7]](!i1 [[VP12]])

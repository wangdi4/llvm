...
;                 func.exit
;
; FIXME: the two loop regions below should be distinct and not overlapping regions.
;
...
; CHECK-NEXT:    SUCCESSORS(1):all.zero.bypass.begin12
; CHECK-NEXT:    no PREDECESSORS
; CHECK-EMPTY:
; CHECK-NEXT:    all.zero.bypass.begin12:
; CHECK-NEXT:     [DA: Uni] i1 [[VP_ALL_ZERO_CHECK:%.*]] = all-zero-check i1 [[VP_CMP1]]
; CHECK-NEXT:    SUCCESSORS(2):all.zero.bypass.end14(i1 [[VP_ALL_ZERO_CHECK]]), [[BB1:BB[0-9]+]](!i1 [[VP_ALL_ZERO_CHECK]])
...
; CHECK-NEXT:      PREDECESSORS(1): all.zero.bypass.begin12
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB2]]:
...
; CHECK-NEXT:      SUCCESSORS(2):all.zero.bypass.begin16(i1 [[VP5]]), [[BB2]](!i1 [[VP5]])
; CHECK-NEXT:      PREDECESSORS(2): [[BB2]] [[BB1]]
; CHECK-EMPTY:
; CHECK-NEXT:      all.zero.bypass.begin16:
; CHECK-NEXT:       [DA: Uni] i1 [[VP_ALL_ZERO_CHECK_1:%.*]] = all-zero-check i1 [[VP_CMP1]]
; CHECK-NEXT:      SUCCESSORS(2):all.zero.bypass.end18(i1 [[VP_ALL_ZERO_CHECK_1]]), [[BB3:BB[0-9]+]](!i1 [[VP_ALL_ZERO_CHECK_1]])
; CHECK-NEXT:      PREDECESSORS(1): [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:        [[BB3]]:
; CHECK-NEXT:         [DA: Div] i1 [[VP6:%.*]] = block-predicate i1 [[VP_CMP1]]
; CHECK-NEXT:        SUCCESSORS(1):[[BB4:BB[0-9]+]]
; CHECK-NEXT:        PREDECESSORS(1): all.zero.bypass.begin16
; CHECK-EMPTY:
; CHECK-NEXT:        [[BB4]]:
...
; CHECK-NEXT:        SUCCESSORS(1):all.zero.bypass.end14
; CHECK-NEXT:        PREDECESSORS(1): [[BB5]]
; CHECK-EMPTY:
; CHECK-NEXT:      all.zero.bypass.end14:
; CHECK-NEXT:       [DA: Uni] i32 [[VP9:%.*]] = phi  [ i32 [[VP_DIV14]], [[BB6]] ],  [ i32 0, all.zero.bypass.begin12 ]
; CHECK-NEXT:      SUCCESSORS(1):[[BB7:BB[0-9]+]]
; CHECK-NEXT:      PREDECESSORS(2): [[BB6]] all.zero.bypass.begin12
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB7]]:
; CHECK-NEXT:       [DA: Uni] i64 [[VP_INDVARS_IV49:%.*]] = phi  [ i64 0, all.zero.bypass.end14 ],  [ i64 [[VP_INDVARS_IV_NEXT50:%.*]], [[BB7]] ]
...
; CHECK-NEXT:       [DA: Uni] i32* [[VP11:%.*]] = load i32** [[VP_PTRIDX16]]
; CHECK-NEXT:       [DA: Div] i32* [[VP_PTRIDX18:%.*]] = getelementptr inbounds i32* [[VP11]] i64 [[VP_LANE]]
; CHECK-NEXT:       [DA: Div] store i32 [[VP9]] i32* [[VP_PTRIDX18]]
...
; CHECK-NEXT:       [DA: Uni] i1 [[VP12:%.*]] = all-zero-check i1 [[VP_CMP1]]
; CHECK-NEXT:       [DA: Uni] i1 [[VP13:%.*]] = or i1 [[VP12]] i1 [[VP_EXITCOND51]]
; CHECK-NEXT:      SUCCESSORS(2):[[BB8:BB[0-9]+]](i1 [[VP13]]), [[BB7]](!i1 [[VP13]])
; CHECK-NEXT:      PREDECESSORS(2): [[BB7]] all.zero.bypass.end14
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB8]]:
; CHECK-NEXT:       [DA: Div] i1 [[VP14:%.*]] = block-predicate i1 [[VP_CMP1]]
; CHECK-NEXT:      SUCCESSORS(1):all.zero.bypass.end18
; CHECK-NEXT:      PREDECESSORS(1): [[BB7]]
; CHECK-EMPTY:
; CHECK-NEXT:    all.zero.bypass.end18:
; CHECK-NEXT:     <Empty Block>
; CHECK-NEXT:    SUCCESSORS(1):[[BB9:BB[0-9]+]]
; CHECK-NEXT:    PREDECESSORS(2): [[BB8]] all.zero.bypass.begin16
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB9]]:
; CHECK-NEXT:     [DA: Div] ret
; CHECK-NEXT:    no SUCCESSORS
; CHECK-NEXT:    PREDECESSORS(1): all.zero.bypass.end18
;
entry:

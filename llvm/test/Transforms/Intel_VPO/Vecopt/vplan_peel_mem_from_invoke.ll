...
; CHECK:         [[SPLATINSERT:%.*]] = insertelement <2 x i64*> poison, i64* %inv.mem, i64 0
; CHECK:         [[SPLAT:%.*]] = shufflevector <2 x i64*> [[SPLATINSERT]], <2 x i64*> poison, <2 x i32> zeroinitializer
; CHECK:         [[PTRTOINT:%.*]] = ptrtoint <2 x i64*> [[SPLAT]] to <2 x i64>
;
; CHECK:       vector.body:
;

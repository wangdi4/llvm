...
define dso_local noundef i64 @_Z3fooiPl(i32 noundef %c, i64* nocapture noundef readonly %x) local_unnamed_addr #0 {
entry:
...
DIR.OMP.SIMD.2:                                   ; preds = %entry
  ...
  %call = tail call i32 @atoi(i8* nocapture noundef %1) #8
  %conv4 = sext i32 %call to i64
  br label %DIR.OMP.SIMD.1

DIR.OMP.SIMD.1:                                   ; preds = %DIR.OMP.SIMD.2
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 8), "QUAL.OMP.LINEAR:IV"(i64* %i9.linear.iv, i32 %call) ]
  br label %DIR.OMP.SIMD.160

DIR.OMP.SIMD.160:                                 ; preds = %DIR.OMP.SIMD.1
  %3 = bitcast i64* %i9.linear.iv to i8*
...
omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.160, %omp.inner.for.body
  ...
  %arrayidx12 = getelementptr inbounds [128 x i64], [128 x i64]* %a, i64 0, i64 %mul
  %call13 = call noundef i64 @_Z3fooiPl(i32 noundef %call, i64* noundef nonnull %arrayidx12) #4
  %arrayidx14 = getelementptr inbounds [128 x i64], [128 x i64]* %b, i64 0, i64 %mul
  store i64 %call13, i64* %arrayidx14, align 8
...
declare dso_local i32 @atoi(i8* nocapture noundef) local_unnamed_addr

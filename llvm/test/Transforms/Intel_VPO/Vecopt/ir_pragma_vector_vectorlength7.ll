...
; REQUIRES: asserts
;
; Checks if the code with #pragma vector vectorlength(3) (!{!"llvm.loop.vector.vectorlength", i64 3} metadata)
; and #pragma omp simd is failing in LLVM-IR beacuse 3 is not power of 2.
;
; void foo(int *arr){
;   #pragma omp simd
;   #pragma vector vectorlength(3)
...
!10 = !{!"llvm.loop.intel.vector.vectorlength", i64 3}

...
; RUN: opt %s -S -VPlanDriver --debug-only=LoopVectorizationPlanner_vec_lengths 2>&1 | FileCheck %s
;
; Cheks if the code with #pragma vector vectorlength(3) (!{!"llvm.loop.vector.vectorlength", i64 3} metadata)

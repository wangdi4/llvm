; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec,print<hir>" -disable-output -vplan-force-vf=2 -vplan-enable-general-peeling-hir -march=core-avx2 < %s 2>&1 | FileCheck %s

...
; This test checks that we compute a minimum profitable peel count and emit a
; corresponding trip count check when `-vplan-calc-min-profitable-dyn-peel-tc`
; is true, and the loop being vectorized is dynamically peeled.
...
; CHECK:         Using min profitable peel TC: [[THRESHOLD]]

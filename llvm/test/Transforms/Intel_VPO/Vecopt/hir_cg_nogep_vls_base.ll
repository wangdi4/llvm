...
; RUN: opt < %s -enable-intel-advanced-opts -hir-ssa-deconstruction -hir-framework -hir-temp-cleanup -hir-vec-dir-insert -hir-vplan-vec  -disable-output  -print-after=hir-vplan-vec 2>&1 | FileCheck %s

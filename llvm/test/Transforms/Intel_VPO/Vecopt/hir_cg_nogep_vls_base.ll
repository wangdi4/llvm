...
; RUN: opt -opaque-pointers=0 -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -enable-intel-advanced-opts -disable-output < %s 2>&1 | FileCheck %s

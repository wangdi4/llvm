...
; RUN: opt -vplan-vec -vplan-force-vf=4 -intel-loop-optreport=high -intel-ir-optreport-emitter -enable-intel-advanced-opts -mcpu=skylake-avx512 < %s -disable-output 2>&1 | FileCheck %s --strict-whitespace -check-prefixes=AVX512

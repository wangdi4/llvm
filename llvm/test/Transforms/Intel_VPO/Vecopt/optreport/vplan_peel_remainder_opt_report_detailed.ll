...
; RUN: opt -hir-ssa-deconstruction -hir-framework -hir-vplan-vec -vplan-vec-scenario="n0;v4;v2s1" -vplan-enable-new-cfg-merge-hir -intel-opt-report=high -hir-optreport-emitter < %s -disable-output 2>&1 | FileCheck %s --strict-whitespace

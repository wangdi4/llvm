...
; CHECK-NEXT:       |   %6 = (%p1)[0][i1 + -1];
; CHECK-NEXT:       |   %add17 = %6  +  %conv;
...
@p2 = dso_local local_unnamed_addr global ptr null, align 8, !dbg !0
@t1 = dso_local local_unnamed_addr global float 0.000000e+00, align 4, !dbg !5

; Function Attrs: nofree nosync nounwind uwtable
define dso_local float @sub(ptr nocapture noundef %p3, i32 noundef %n, ptr nocapture noundef readonly %M) local_unnamed_addr #0 !dbg !14 {
entry:
  %p1 = alloca [100 x float], align 16
  call void @llvm.dbg.value(metadata ptr %p3, metadata !20, metadata !DIExpression()), !dbg !33  ; test.c:0:0
  call void @llvm.dbg.value(metadata i32 %n, metadata !21, metadata !DIExpression()), !dbg !33  ; test.c:0:0
  call void @llvm.dbg.value(metadata ptr %M, metadata !22, metadata !DIExpression()), !dbg !33  ; test.c:0:0
  call void @llvm.lifetime.start.p0(i64 400, ptr nonnull %p1) #3, !dbg !34  ; test.c:3:2
  call void @llvm.dbg.declare(metadata ptr %p1, metadata !23, metadata !DIExpression()), !dbg !35  ; test.c:3:8
  %0 = load float, ptr %p3, align 4, !dbg !36, !tbaa !37  ; test.c:4:13
  call void @llvm.dbg.value(metadata float %0, metadata !27, metadata !DIExpression()), !dbg !33  ; test.c:0:0
  ...
  %1 = load ptr, ptr @p2, align 8, !dbg !44  ; test.c:9:13
  call void @llvm.dbg.value(metadata i32 0, metadata !29, metadata !DIExpression()), !dbg !41  ; test.c:0:0
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %arrayidx = getelementptr inbounds i32, ptr %M, i64 %indvars.iv53, !dbg !54  ; test.c:9:16
  %2 = load i32, ptr %arrayidx, align 4, !dbg !54, !tbaa !55  ; test.c:9:16
  %idxprom1 = sext i32 %2 to i64, !dbg !44        ; test.c:9:13
  %arrayidx2 = getelementptr inbounds float, ptr %1, i64 %idxprom1, !dbg !44  ; test.c:9:13
  %3 = load float, ptr %arrayidx2, align 4, !dbg !44, !tbaa !37  ; test.c:9:13
  %arrayidx4 = getelementptr inbounds float, ptr %p3, i64 %indvars.iv53, !dbg !57  ; test.c:9:4
  %4 = load float, ptr %arrayidx4, align 4, !dbg !58, !tbaa !37  ; test.c:9:10
  %add = fadd fast float %4, %3, !dbg !58         ; test.c:9:10
  store float %add, ptr %arrayidx4, align 4, !dbg !58, !tbaa !37  ; test.c:9:10
...
for.cond.cleanup8:                                ; preds = %for.cond.cleanup8.loopexit, %for.cond6.preheader
  ...
  call void @llvm.lifetime.end.p0(i64 400, ptr nonnull %p1) #3, !dbg !64  ; test.c:18:1
...
for.body9:                                        ; preds = %for.body9, %for.body9.preheader
  ...
  %t1.047 = phi float [ %0, %for.body9.preheader ], [ %factor, %for.body9 ]
  ...
  %arrayidx11 = getelementptr inbounds [100 x float], ptr %p1, i64 0, i64 %indvars.iv, !dbg !66, !intel-tbaa !67  ; test.c:12:4
  ...
  %5 = add nsw i64 %indvars.iv, -1, !dbg !70      ; test.c:14:14
  %arrayidx16 = getelementptr inbounds [100 x float], ptr %p1, i64 0, i64 %5, !dbg !71, !intel-tbaa !67  ; test.c:14:10
  %6 = load float, ptr %arrayidx16, align 4, !dbg !71, !tbaa !67  ; test.c:14:10
  %add17 = fadd fast float %6, %conv, !dbg !72    ; test.c:14:18
  store float %add17, ptr %arrayidx11, align 4, !dbg !73, !tbaa !67  ; test.c:14:8

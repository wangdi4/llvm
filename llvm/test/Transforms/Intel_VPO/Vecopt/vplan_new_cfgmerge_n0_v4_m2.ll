...
; RUN: opt -opaque-pointers=0 -vplan-vec-scenario="n0;v4;m2" \
...
; CHECK-NEXT:     [DA: Div, SVA: (F  )] i64* [[VP_PTR_1:%.*]] = getelementptr inbounds i64* [[ARY0]] i64 [[VP_NEW_IND]] (SVAOpBits 0->F 1->F )
...
; CHECK-NEXT:       [DA: Div] i64* [[VP_PTR_1]] = getelementptr inbounds i64* [[ARY0]] i64 [[VP_NEW_IND]]

...
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]:
; CHECK-NEXT:     [DA: Uni] i64 [[VP2:%.*]] = phi  [ i64 0, [[BB1]] ],  [ i64 [[VP3:%.*]], [[BB3:BB[0-9]+]] ]
; CHECK-NEXT:     [DA: Uni] i8* [[VP4:%.*]] = getelementptr inbounds i8* [[A0:%.*]] i64 [[VP2]]
; CHECK-NEXT:     [DA: Uni] i8 [[VP5:%.*]] = load i8* [[VP4]]
; CHECK-NEXT:     [DA: Uni] i1 [[VP6:%.*]] = icmp i8 [[VP5]] i8 [[VAL0:%.*]]
...
; CHECK-NEXT:       [DA: Uni] i1 [[VP8:%.*]] = icmp i64 [[VP3]] i64 [[VP1]]
...
; CHECK-NEXT:       Condition([[BB5]]): [DA: Uni] i1 [[VP8]] = icmp i64 [[VP3]] i64 [[VP1]]
...
; CHECK-NEXT:       [DA: Div] i64 [[VP11:%.*]] = call i64 [[VP2]] i64 (i64)* @llvm.ssa.copy.i64

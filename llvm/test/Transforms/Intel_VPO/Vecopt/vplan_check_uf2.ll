...
; RUN:  opt < %s -hir-ssa-deconstruction -hir-framework -VPlanDriverHIR -disable-output -print-after=VPlanDriverHIR 2>&1 | FileCheck %s -check-prefix=CHECK-HIR

; RUN:  opt < %s -VPlanDriver -disable-output -print-after=VPlanDriver -vplan-force-uf=2 2>&1 | FileCheck %s -check-prefix=CHECK-LLVM-IR

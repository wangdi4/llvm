...
; RUN: opt %s -O2 -enable-nested-blob-vec -enable-blob-coeff-vec -vplan-disable-verification -hir-ssa-deconstruction -hir-vec-dir-insert -hir-vplan-vec -hir-cg -print-after=hir-vplan-vec -mem2reg -o - | llc -mcpu=skx -print-after-isel 2>&1 | FileCheck %s

...
; RUN: opt < %s -vplan-func-vec -enable-vplan-func-vec-all-zero-bypass-loops -enable-vplan-func-vec-all-zero-bypass-non-loops -print-after-vplan-func-vec-all-zero-bypass -disable-output -S 2>&1 | FileCheck %s
...
; CHECK-NEXT:    SUCCESSORS(2):all.zero.bypass.end16(i1 [[VP_ALL_ZERO_CHECK]]), [[BB2:BB[0-9]+]](!i1 [[VP_ALL_ZERO_CHECK]])
...
; CHECK-NEXT:      SUCCESSORS(2):all.zero.bypass.end12(i1 [[VP_ALL_ZERO_CHECK_1]]), [[BB4:BB[0-9]+]](!i1 [[VP_ALL_ZERO_CHECK_1]])
...
; CHECK-EMPTY:
;
; FIXME: Order of region exit blocks should be reversed.
;

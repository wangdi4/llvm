...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 < %s -passes="vplan-func-vec" -enable-vplan-func-vec-all-zero-bypass-loops -enable-vplan-func-vec-all-zero-bypass-non-loops -print-after-vplan-func-vec-all-zero-bypass -disable-output -S 2>&1 | FileCheck %s

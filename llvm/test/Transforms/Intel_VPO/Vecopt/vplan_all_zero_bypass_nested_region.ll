...
; REQUIRES: asserts
; RUN: opt -vplan-print-terminator-inst=false < %s -vplan-func-vec -enable-vplan-func-vec-all-zero-bypass-loops -enable-vplan-func-vec-all-zero-bypass-non-loops -print-after-vplan-func-vec-all-zero-bypass -disable-output -S 2>&1 | FileCheck %s
; RUN: opt -vplan-print-terminator-inst=false < %s -passes="vplan-func-vec" -enable-vplan-func-vec-all-zero-bypass-loops -enable-vplan-func-vec-all-zero-bypass-non-loops -print-after-vplan-func-vec-all-zero-bypass -disable-output -S 2>&1 | FileCheck %s
...
; CHECK-NEXT:    SUCCESSORS(1):all.zero.bypass.begin10
; CHECK-NEXT:    PREDECESSORS(1): [[BB0]]
; CHECK-EMPTY:
; CHECK-NEXT:    all.zero.bypass.begin10:
; CHECK-NEXT:     [DA: Uni] i1 [[VP_ALL_ZERO_CHECK:%.*]] = all-zero-check i1 [[VP_CMP1]]
; CHECK-NEXT:    SUCCESSORS(2):all.zero.bypass.end12(i1 [[VP_ALL_ZERO_CHECK]]), [[BB2:BB[0-9]+]](!i1 [[VP_ALL_ZERO_CHECK]])
; CHECK-NEXT:    PREDECESSORS(1): [[BB1]]
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB2]]:
; CHECK-NEXT:       [DA: Div] i1 [[VP1:%.*]] = block-predicate i1 [[VP_CMP1]]
; CHECK-NEXT:       [DA: Div] i32* [[VP_PTRIDX3:%.*]] = getelementptr inbounds i32* [[C0:%.*]] i64 [[VP_LANE]]
; CHECK-NEXT:       [DA: Div] store i32 [[VP_SUB]] i32* [[VP_PTRIDX3]]
; CHECK-NEXT:       [DA: Div] i32 [[VP2:%.*]] = load i32* [[VP_PTRIDX]]
; CHECK-NEXT:       [DA: Div] i1 [[VP_CMP631:%.*]] = icmp sgt i32 [[VP2]] i32 0
; CHECK-NEXT:      SUCCESSORS(1):[[BB3:BB[0-9]+]]
; CHECK-NEXT:      PREDECESSORS(1): all.zero.bypass.begin10
; CHECK-EMPTY:
; CHECK-NEXT:      [[BB3]]:
; CHECK-NEXT:       [DA: Div] i1 [[VP_BB3_BR_VP_CMP631:%.*]] = and i1 [[VP_CMP1]] i1 [[VP_CMP631]]
; CHECK-NEXT:      SUCCESSORS(1):all.zero.bypass.begin14
; CHECK-NEXT:      PREDECESSORS(1): [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:      all.zero.bypass.begin14:
; CHECK-NEXT:       [DA: Uni] i1 [[VP_ALL_ZERO_CHECK_1:%.*]] = all-zero-check i1 [[VP_BB3_BR_VP_CMP631]]
; CHECK-NEXT:      SUCCESSORS(2):all.zero.bypass.end16(i1 [[VP_ALL_ZERO_CHECK_1]]), [[BB4:BB[0-9]+]](!i1 [[VP_ALL_ZERO_CHECK_1]])
; CHECK-NEXT:      PREDECESSORS(1): [[BB3]]
; CHECK-EMPTY:
; CHECK-NEXT:        [[BB4]]:
; CHECK-NEXT:         [DA: Div] i1 [[VP3:%.*]] = block-predicate i1 [[VP_BB3_BR_VP_CMP631]]
; CHECK-NEXT:         [DA: Div] i32** [[VP_PTRIDX9:%.*]] = getelementptr inbounds i32** [[B0:%.*]] i64 [[VP_LANE]]
; CHECK-NEXT:         [DA: Div] i32* [[VP4:%.*]] = load i32** [[VP_PTRIDX9]]
; CHECK-NEXT:        SUCCESSORS(1):[[BB5:BB[0-9]+]]
; CHECK-NEXT:        PREDECESSORS(1): all.zero.bypass.begin14
; CHECK-EMPTY:
; CHECK-NEXT:        [[BB5]]:
...
; CHECK-NEXT:         [DA: Div] i32* [[VP_PTRIDX11:%.*]] = getelementptr inbounds i32* [[VP4]] i64 [[VP_INDVARS_IV]]
; CHECK-NEXT:         [DA: Div] store i32 [[VP_ADD7]] i32* [[VP_PTRIDX11]]
...
; CHECK-NEXT:        SUCCESSORS(2):[[BB5]](i1 [[VP9]]), [[BB6:BB[0-9]+]](!i1 [[VP9]])
; CHECK-NEXT:        PREDECESSORS(2): [[BB5]] [[BB4]]
; CHECK-EMPTY:
; CHECK-NEXT:        [[BB6]]:
; CHECK-NEXT:         [DA: Div] i1 [[VP10:%.*]] = block-predicate i1 [[VP_BB3_BR_VP_CMP631]]
; CHECK-NEXT:        SUCCESSORS(1):all.zero.bypass.end16
; CHECK-NEXT:        PREDECESSORS(1): [[BB5]]
; CHECK-EMPTY:
; CHECK-NEXT:      all.zero.bypass.end16:
; CHECK-NEXT:       <Empty Block>
; CHECK-NEXT:      SUCCESSORS(1):all.zero.bypass.end12
; CHECK-NEXT:      PREDECESSORS(2): [[BB6]] all.zero.bypass.begin14
; CHECK-EMPTY:
; CHECK-NEXT:    all.zero.bypass.end12:
; CHECK-NEXT:     <Empty Block>
; CHECK-NEXT:    SUCCESSORS(1):[[BB7:BB[0-9]+]]
; CHECK-NEXT:    PREDECESSORS(2): all.zero.bypass.begin10 all.zero.bypass.end16
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB7]]:
; CHECK-NEXT:     [DA: Div] ret
; CHECK-NEXT:    no SUCCESSORS
; CHECK-NEXT:    PREDECESSORS(1): all.zero.bypass.end12
;
entry:
;              entry
;                |
...
if.then:
  %ptridx3 = getelementptr inbounds i32, i32* %c, i64 %lane
  store i32 %sub, i32* %ptridx3, align 4
  %1 = load i32, i32* %ptridx, align 4
  %cmp631 = icmp sgt i32 %1, 0
  br i1 %cmp631, label %for.body.ph, label %exit

for.body.ph:
  %ptridx9 = getelementptr inbounds i32*, i32** %b, i64 %lane
  %2 = load i32*, i32** %ptridx9, align 8
  br label %for.body

for.body:
  %indvars.iv = phi i64 [ 0, %for.body.ph ], [ %indvars.iv.next, %for.body ]
  %ptridx11 = getelementptr inbounds i32, i32* %2, i64 %indvars.iv
  store i32 %add7, i32* %ptridx11, align 4

...
; CHECK:       codeRepl:
; CHECK-NEXT:    call void @var_tripcount.ordered.simd.region(i32* [[IP:%.*]], i32 [[N]])
...
ordered.loop:
  ...
  %arrayidx.2 = getelementptr inbounds i32, i32* %ip, i32 %indvars.iv.2
  %ld = load i32, i32* %arrayidx.2, align 4

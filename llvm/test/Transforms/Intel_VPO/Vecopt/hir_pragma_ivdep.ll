...
for.body:                                         ; preds = %for.body, %entry
  ...
  %arrayidx = getelementptr inbounds [1024 x i32], ptr @arr, i64 0, i64 %1
  %2 = load i32, ptr %arrayidx, align 4, !tbaa !2
  %mul = mul nsw i32 %2, %n2
  %arrayidx2 = getelementptr inbounds [1024 x i32], ptr @arr, i64 0, i64 %indvars.iv
  store i32 %mul, ptr %arrayidx2, align 4, !tbaa !2

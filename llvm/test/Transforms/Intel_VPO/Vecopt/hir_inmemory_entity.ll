...
;
; RUN: opt -enable-new-pm=0 -hir-framework -hir-vplan-vec -print-after=hir-vplan-vec -disable-output -vplan-enable-new-cfg-merge-hir=false < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-vplan-vec,print<hir>" -disable-output -vplan-enable-new-cfg-merge-hir=false < %s 2>&1 | FileCheck %s
; RUN: opt -enable-new-pm=0 -hir-framework -hir-vplan-vec -print-after=hir-vplan-vec -disable-output -vplan-enable-new-cfg-merge-hir < %s 2>&1 | FileCheck %s
; RUN: opt -passes="hir-vplan-vec,print<hir>" -disable-output -vplan-enable-new-cfg-merge-hir < %s 2>&1 | FileCheck %s

...
;
;  BB3 (BP: NULL) :
;   i64 %vp46176 = phi  [ i64 %vp50768, BB12 ],  [ i64 0, BB2 ]
;   i32 %vp47424 = trunc i64 %vp46176 to i32
...
;  BB4 (BP: NULL) :
;   i1 %vp64672 = block-predicate i1 %cmp1
;  SUCCESSORS(1):BB6
;  no PREDECESSORS
;
;  BB6 (BP: NULL) :
;   i32 %vp48464 = phi  [ i32 %vp49968, BB13 ],  [ i32 0, BB4 ]
;   i1 %vp46480 = block-predicate i1 %cmp1
;   i32 %vp49712 = call i32 (...)* @baz
;   i32 %vp49968 = add i32 %vp48464 i32 1
;   i1 %vp50224 = icmp i32 %vp49968 i32 1024
;  SUCCESSORS(1):BB13
;  PREDECESSORS(2): BB13 BB4
;
;  BB13 (BP: NULL) :
;   i1 %vp46656 = block-predicate i1 %cmp1
;   i1 %vp3312 = all-zero-check i1 %cmp1
;   i1 %vp3488 = or i1 %vp3312 i1 %vp50224
;  SUCCESSORS(2):BB7(i1 %vp3488), BB6(!i1 %vp3488)
;  PREDECESSORS(1): BB6
;
;  BB7 (BP: NULL) :
;   i1 %vp46896 = block-predicate i1 %cmp1
;  no SUCCESSORS
;  PREDECESSORS(1): BB13
;
;  SUCCESSORS(1):BB5
...
;
;  BB5 (BP: NULL) :
;   i1 %vp64848 = not i1 %cmp1
;   i64 %vp50768 = add i64 %vp46176 i64 1
;   i1 %vp51024 = icmp i64 %vp50768 i64 1024
;  no SUCCESSORS
...
;  BB12 (BP: NULL) :
;   <Empty Block>
;   Condition(BB5): i1 %vp51024 = icmp i64 %vp50768 i64 1024
;  SUCCESSORS(2):BB8(i1 %vp51024), BB3(!i1 %vp51024)
...
; CHECK-NEXT: i1 [[NEWEXITCOND:.*]] = or i1 [[ALLZERO]] i1 [[EXITCOND]]
; CHECK-NEXT: SUCCESSORS(2):BB{{[0-9]+}}(i1 [[NEWEXITCOND]]), [[INNERHEADER]](!i1 [[NEWEXITCOND]])

...
define dso_local void @foo(i64* noalias nocapture noundef %A, i64* nocapture noundef readonly %B, i64* noalias nocapture noundef readonly %C) local_unnamed_addr #0 {
;
; long A[8], C[8];
...
; CHECK-VF4-NEXT:        |      |   [[EXTRACT_0_0:%.*]] = extractelement [[DOTVEC190]],  0
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx2 = getelementptr inbounds i64, i64* %A, i64 %0

...
; RUN: opt -opaque-pointers=0 -passes='vplan-vec' -vplan-force-vf=4 -vplan-enable-all-liveouts -vplan-print-after-vpentity-instrs -vplan-entities-dump -disable-vplan-codegen -S < %s 2>&1 | FileCheck %s

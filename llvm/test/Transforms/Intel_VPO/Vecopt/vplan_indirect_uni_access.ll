...
define void @test(ptr nocapture readonly %Index, ptr nocapture readonly %A, ptr nocapture %C, i32 %m, i32 %n) {
entry:
...
for.cond.cleanup3:                                ; preds = %for.body4, %for.body
  ...
  %arrayidx10 = getelementptr inbounds double, ptr %C, i64 %indvars.iv29
  store double %x.0.lcssa, ptr %arrayidx10, align 8
...
for.body4:                                        ; preds = %for.body4.preheader, %for.body4
  ...
  %arrayidx8 = getelementptr inbounds double, ptr %1, i64 %indvars.iv29

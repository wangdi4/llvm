...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE12:%.*]] = shufflevector <4 x i8> [[TMP1]], <4 x i8> [[TMP3]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE10:%.*]] = shufflevector <4 x i8> [[TMP5]], <4 x i8> [[TMP7]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SPLITLOADSHUFFLE11:%.*]] = shufflevector <4 x i8> [[TMP13]], <4 x i8> [[TMP15]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP16:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE12]] to <8 x i32>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP17:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE11]] to <8 x i32>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP18:%.*]] = zext <8 x i8> [[SPLITLOADSHUFFLE10]] to <8 x i32>
...
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE:%.*]] = shufflevector <8 x i32> [[TMP36]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 4, i32 5, i32 5>
...
; 8WIDE_PATH_STEERING-NEXT:    [[TMP39:%.*]] = insertelement <8 x i32> [[TMP38]], i32 [[TMP31]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP40:%.*]] = insertelement <8 x i32> [[TMP39]], i32 [[TMP29]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[TMP41:%.*]] = extractelement <8 x i32> [[TMP24]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP42:%.*]] = insertelement <8 x i32> [[TMP40]], i32 [[TMP41]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP43:%.*]] = insertelement <8 x i32> [[TMP42]], i32 [[TMP35]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP44:%.*]] = extractelement <8 x i32> [[TMP24]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[TMP45:%.*]] = insertelement <8 x i32> [[TMP43]], i32 [[TMP44]], i32 6
; 8WIDE_PATH_STEERING-NEXT:    [[TMP46:%.*]] = insertelement <8 x i32> [[TMP45]], i32 [[TMP33]], i32 7
; 8WIDE_PATH_STEERING-NEXT:    [[TMP47:%.*]] = add <8 x i32> [[SHUFFLE]], [[TMP46]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP48:%.*]] = sub <8 x i32> [[SHUFFLE]], [[TMP46]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP49:%.*]] = shufflevector <8 x i32> [[TMP47]], <8 x i32> [[TMP48]], <8 x i32> <i32 0, i32 9, i32 2, i32 11, i32 4, i32 5, i32 6, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP50:%.*]] = insertelement <8 x i32> poison, i32 [[TMP29]], i32 0
; 8WIDE_PATH_STEERING-NEXT:    [[TMP51:%.*]] = insertelement <8 x i32> [[TMP50]], i32 [[TMP31]], i32 1
; 8WIDE_PATH_STEERING-NEXT:    [[TMP52:%.*]] = insertelement <8 x i32> [[TMP51]], i32 [[TMP25]], i32 2
; 8WIDE_PATH_STEERING-NEXT:    [[TMP53:%.*]] = insertelement <8 x i32> [[TMP52]], i32 [[TMP27]], i32 3
; 8WIDE_PATH_STEERING-NEXT:    [[TMP54:%.*]] = insertelement <8 x i32> [[TMP53]], i32 [[TMP44]], i32 4
; 8WIDE_PATH_STEERING-NEXT:    [[TMP55:%.*]] = insertelement <8 x i32> [[TMP54]], i32 [[TMP41]], i32 5
; 8WIDE_PATH_STEERING-NEXT:    [[SHUFFLE9:%.*]] = shufflevector <8 x i32> [[TMP55]], <8 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 5, i32 4>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP56:%.*]] = add <8 x i32> [[TMP49]], [[SHUFFLE9]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP57:%.*]] = sub <8 x i32> [[TMP49]], [[SHUFFLE9]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP58:%.*]] = shufflevector <8 x i32> [[TMP56]], <8 x i32> [[TMP57]], <8 x i32> <i32 0, i32 1, i32 10, i32 11, i32 4, i32 13, i32 14, i32 15>
; 8WIDE_PATH_STEERING-NEXT:    [[TMP59:%.*]] = add <8 x i32> [[TMP58]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP60:%.*]] = sub <8 x i32> [[TMP58]], [[TMP24]]
; 8WIDE_PATH_STEERING-NEXT:    [[TMP61:%.*]] = shufflevector <8 x i32> [[TMP59]], <8 x i32> [[TMP60]], <8 x i32> <i32 0, i32 9, i32 10, i32 3, i32 4, i32 13, i32 14, i32 7>

...
; RUN: opt -vplan-print-terminator-inst=false -hir-ssa-deconstruction -hir-vec-dir-insert -hir-temp-cleanup -hir-last-value-computation -VPlanDriverHIR -vplan-print-after-plain-cfg -disable-output -vplan-force-build < %s 2>&1 | FileCheck %s
; RUN: opt -vplan-print-terminator-inst=false -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-last-value-computation,hir-vec-dir-insert,vplan-driver-hir" -vplan-print-after-plain-cfg -disable-output -vplan-force-build < %s 2>&1 | FileCheck %s
...
; CHECK-NEXT:     i1 [[VP20:%.*]] = icmp sle i64 [[VP15]] i64 [[VP3]]
; CHECK-NEXT:    SUCCESSORS(2):[[BB5]](i1 [[VP20]]), [[BB3]](!i1 [[VP20]])
; CHECK-NEXT:    PREDECESSORS(2): [[BB4]] [[BB5]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]:
; CHECK-NEXT:     i64 [[VP21:%.*]] = phi  [ i64 [[VP13]], [[BB5]] ]
...
; CHECK-NEXT:     i1 [[VP27:%.*]] = icmp sle i64 [[VP9]] i64 [[VP1]]

...
; CHECK-NEXT:     i64 [[VP5:%.*]] = call i64 [[VP3]] i64 (i64)* @llvm.ssa.copy.i64
; CHECK-NEXT:     i64 [[VP6:%.*]] = call i64 0 i64 (i64)* @llvm.ssa.copy.i64
; CHECK-NEXT:    SUCCESSORS(1):[[BB4:BB[0-9]+]]
; CHECK-NEXT:    PREDECESSORS(2): [[BB1]] [[BB3]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB4]]:
; CHECK-NEXT:     float [[VP7:%.*]] = sitofp i64 [[VP3]] to float
; CHECK-NEXT:     i64 [[VP8:%.*]] = add i64 [[M0:%.*]] i64 -1
...
; CHECK-NEXT:     store float [[VP7]] float* [[VP12]]
; CHECK-NEXT:     i64 [[VP13:%.*]] = mul i64 3 i64 [[VP10]]
; CHECK-NEXT:     i64 [[VP14:%.*]] = add i64 [[VP9]] i64 [[VP13]]
...
; CHECK-NEXT:     i1 [[VP16:%.*]] = icmp i64 [[VP11]] i64 [[VP8]]
; CHECK-NEXT:    SUCCESSORS(2):[[BB5]](i1 [[VP16]]), [[BB3]](!i1 [[VP16]])
; CHECK-NEXT:    PREDECESSORS(2): [[BB4]] [[BB5]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB3]]:
; CHECK-NEXT:     i64 [[VP17:%.*]] = phi  [ i64 [[VP9]], [[BB5]] ]
; CHECK-NEXT:     i64 [[VP18:%.*]] = mul i64 [[M0]] i64 2
; CHECK-NEXT:     i64 [[VP19:%.*]] = add i64 [[VP18]] i64 [[VP17]]
; CHECK-NEXT:     i64 [[VP20:%.*]] = add i64 [[VP19]] i64 -2
; CHECK-NEXT:     i64 [[VP21:%.*]] = add i64 [[VP20]] i64 2
; CHECK-NEXT:     i64 [[VP2]] = call i64 [[VP21]] i64 (i64)* @llvm.ssa.copy.i64
; CHECK-NEXT:     i64 [[VP22:%.*]] = call i64 [[M0]] i64 (i64)* @llvm.ssa.copy.i64

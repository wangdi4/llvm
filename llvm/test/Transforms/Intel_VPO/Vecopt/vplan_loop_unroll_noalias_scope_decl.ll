...
; RUN: opt %s -S -VPlanDriver -vplan-force-vf=4 -vplan-force-uf=3 -vplan-print-after-unroll | FileCheck %s
...
;                 FIXME: should be a call with another metadata
; CHECK-NEXT:     [DA: Uni] call metadata !0 void (metadata)* @llvm.experimental.noalias.scope.decl
...
;                FIXME: should be the only call with another metadata !3
; CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata !0)
; CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata !0)
; CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata !0)
; CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata !0)
...
;                FIXME: should be !alias.scope !3
; CHECK-NEXT:    [[WIDE_LOAD50:%.*]] = load <4 x i32>, <4 x i32>* [[TMP7]], align 4, !alias.scope !0
; CHECK-NEXT:    [[TMP8:%.*]] = add nsw <4 x i32> [[WIDE_LOAD50]], <i32 1, i32 1, i32 1, i32 1>
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast i32* [[SCALAR_GEP40]] to <4 x i32>*
;                FIXME: should be !noalias !3
; CHECK-NEXT:    store <4 x i32> [[TMP8]], <4 x i32>* [[TMP9]], align 4, !noalias !0
...
;                FIXME: should be the only call with another metadata !5
; CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata !0)
; CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata !0)
; CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata !0)
; CHECK-NEXT:    call void @llvm.experimental.noalias.scope.decl(metadata !0)
...
; CHECK-NEXT:    [[WIDE_LOAD80:%.*]] = load <4 x i32>, <4 x i32>* [[TMP13]], align 4, !alias.scope !0
; CHECK-NEXT:    [[TMP14:%.*]] = add nsw <4 x i32> [[WIDE_LOAD80]], <i32 1, i32 1, i32 1, i32 1>
; CHECK-NEXT:    [[TMP15:%.*]] = bitcast i32* [[SCALAR_GEP70]] to <4 x i32>*
;                FIXME: should be !alias.scope !5
; CHECK-NEXT:    store <4 x i32> [[TMP14]], <4 x i32>* [[TMP15]], align 4, !noalias !0

...
; RUN: opt %s -S -hir-ssa-deconstruction -hir-temp-cleanup -VPlanDriverHIR -vplan-force-vf=4 -print-after=VPlanDriverHIR -hir-details -disable-output 2>&1 | FileCheck %s --check-prefix=CHECK-HIR
...
;
; CHECK-HIR:      + DO i64 i1 = 0, 4 * [[TGU0:%.*]] + -1, 4   <DO_LOOP> <simd-vectorized> <nounroll> <novectorize>

...
; CHECK-NEXT:         {
; CHECK-NEXT:            goto merge.blk14.23;
; CHECK-NEXT:         }
; CHECK-NEXT:         %.vec5 = %.vec3 + 4 >u %n1;
...
; CHECK-NEXT:         merge.blk14.23:
; CHECK-NEXT:         %.vec11 = %.vec3 + 4 >u %n1;

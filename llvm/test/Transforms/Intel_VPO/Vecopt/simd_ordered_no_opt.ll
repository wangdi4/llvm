; RUN: opt -S < %s -vplan-force-vf=2 -disable-output -vplan-print-after-plain-cfg -passes=vplan-vec | FileCheck --allow-empty %s
; RUN: opt -S < %s -vplan-force-vf=2 -disable-output -vplan-print-after-plain-cfg -passes=hir-vplan-vec | FileCheck --allow-empty %s

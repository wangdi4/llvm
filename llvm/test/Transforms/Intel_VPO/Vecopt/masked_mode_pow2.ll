...
define dso_local void @_Z4initPll(i64* nocapture %in) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nounwind uwtable
; CHECK: VPlan after emitting masked variant
define dso_local void @_Z4init2Pll(i64* nocapture %in) local_unnamed_addr #0 {
entry:
  br label %DIR.OMP.SIMD.1
...
define dso_local void @_Z4init3Pll(i64* nocapture %in) local_unnamed_addr #0 {
entry:
  br label %DIR.OMP.SIMD.1

...
; VPLAN-NEXT:   [DA: Uni] i32 [[SG_BCAST:%vp.*]] = call i32 [[IV:%vp.*]] i32 [[UREM_CALL]] _ZGVbM8vu_sub_group_broadcast(_Z19sub_group_broadcastDv8_jjS_) [x 1] [@CurrMask]
...
attributes #0 = { nounwind "has-vplan-mask" "kernel-call-once" "vector-variants"="_ZGVbM8vu_sub_group_broadcast(_Z19sub_group_broadcastDv8_jjS_)" }

...
; RUN: opt -S -hir-ssa-deconstruction -hir-framework -VPlanDriverHIR  -vplan-print-after-plain-cfg -vplan-entities-dump -vplan-print-legality -disable-output < %s 2>&1 | FileCheck %s

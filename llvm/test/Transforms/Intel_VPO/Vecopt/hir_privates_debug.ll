...
; RUN: opt -opaque-pointers=0 -S -passes='hir-ssa-deconstruction,hir-vplan-vec,print<hir>'  -vplan-print-after-plain-cfg -vplan-entities-dump -vplan-print-legality -disable-output < %s 2>&1 | FileCheck %s

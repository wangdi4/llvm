...
define dso_local void @foo(i64* noalias nocapture noundef %A, i8* nocapture noundef readonly %B, i64* noalias nocapture noundef readonly %C) local_unnamed_addr #0 {
;
; long A[8], C[8];

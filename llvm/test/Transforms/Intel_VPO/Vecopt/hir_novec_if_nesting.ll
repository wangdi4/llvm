...
; RUN: opt -S -disable-output -hir-ssa-deconstruction -hir-framework -hir-vec-dir-insert -hir-vplan-vec -print-after=hir-vplan-vec -vplan-force-vf=2 < %s 2>&1 | FileCheck %s

...
; CHECK-NEXT:     i64 [[VP11:%.*]] = add i64 [[VP0:%.*]] i64 1
...
; CHECK-NEXT:       i32 [[VP16:%.*]] = compress-expand-index-inc i32 [[VP7]] i32 2
; CHECK-NEXT:       br [[BB2]]
; CHECK-EMPTY:
; CHECK-NEXT:    [[BB2]]: # preds: [[BB4]], [[BB0]]
; CHECK-NEXT:     i32 [[VP8]] = phi  [ i32 [[VP16]], [[BB4]] ],  [ i32 [[VP7]], [[BB0]] ]
...
; CHECK-NEXT:     i32 [[VP17:%.*]] = compress-expand-index-final i32 [[VP8]]

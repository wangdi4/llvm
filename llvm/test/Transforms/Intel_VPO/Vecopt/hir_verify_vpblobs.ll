...
;   |   <RVAL-REG> {al:1}(LINEAR ptr %pix1)[LINEAR i64 sext.i32.i64(%i_pix1) * i1] inbounds  {sb:30}
;   |      <BLOB> LINEAR i32 %i_pix1 {sb:6}
;   |      <BLOB> LINEAR ptr %pix1 {sb:7}
;   |
;   |   %1 = (%pix2)[sext.i32.i64(%i_pix2) * i1];
;   |   <LVAL-REG> NON-LINEAR i8 %1 {sb:12}
;   |   <RVAL-REG> {al:1}(LINEAR ptr %pix2)[LINEAR i64 sext.i32.i64(%i_pix2) * i1] inbounds  {sb:30}
;   |      <BLOB> LINEAR i32 %i_pix2 {sb:10}
;   |      <BLOB> LINEAR ptr %pix2 {sb:11}
;   |
;   |   %2 = (%pix1)[sext.i32.i64(%i_pix1) * i1 + 4];
;   |   <LVAL-REG> NON-LINEAR i8 %2 {sb:16}
;   |   <RVAL-REG> {al:1}(LINEAR ptr %pix1)[LINEAR i64 sext.i32.i64(%i_pix1) * i1 + 4] inbounds  {sb:30}
;   |      <BLOB> LINEAR i32 %i_pix1 {sb:6}
;   |      <BLOB> LINEAR ptr %pix1 {sb:7}
;   |
;   |   %3 = (%pix2)[sext.i32.i64(%i_pix2) * i1 + 4];
;   |   <LVAL-REG> NON-LINEAR i8 %3 {sb:19}
;   |   <RVAL-REG> {al:1}(LINEAR ptr %pix2)[LINEAR i64 sext.i32.i64(%i_pix2) * i1 + 4] inbounds  {sb:30}
;   |      <BLOB> LINEAR i32 %i_pix2 {sb:10}
;   |      <BLOB> LINEAR ptr %pix2 {sb:11}
;   |
;   |   (%result)[i1] = zext.i8.i32(%0) + 65536 * zext.i8.i32(%2) + -65536 * zext.i8.i32(%3) + -1 * zext.i8.i32(%1);
;   |   <LVAL-REG> {al:4}(LINEAR ptr %result)[LINEAR i64 i1] inbounds  {sb:30}
;   |      <BLOB> LINEAR ptr %result {sb:25}
...
; {al:1}(LINEAR ptr %pix1)[LINEAR i64 sext.i32.i64(%i_pix1) * i1] inbounds  {sb:30}
; {al:1}(LINEAR ptr %pix2)[LINEAR i64 sext.i32.i64(%i_pix2) * i1] inbounds  {sb:30}
...
; CHECK:      llvm.masked.gather.v4i8.v4p0

target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nofree norecurse nounwind uwtable
define dso_local void @verify_vpblobs(ptr nocapture readonly %pix1, i32 %i_pix1, ptr nocapture readonly %pix2, i32 %i_pix2, ptr nocapture %result) local_unnamed_addr {
entry:
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %pix1.addr.023 = phi ptr [ %pix1, %entry ], [ %add.ptr, %for.body ]
  %pix2.addr.022 = phi ptr [ %pix2, %entry ], [ %add.ptr10, %for.body ]
  %0 = load i8, ptr %pix1.addr.023, align 1
  %conv = zext i8 %0 to i32
  %1 = load i8, ptr %pix2.addr.022, align 1
  %conv2 = zext i8 %1 to i32
  %sub = sub nsw i32 %conv, %conv2
  %ptridx3 = getelementptr inbounds i8, ptr %pix1.addr.023, i64 4
  %2 = load i8, ptr %ptridx3, align 1
  %conv4 = zext i8 %2 to i32
  %ptridx5 = getelementptr inbounds i8, ptr %pix2.addr.022, i64 4
  %3 = load i8, ptr %ptridx5, align 1
  %conv6 = zext i8 %3 to i32
  %sub7 = sub nsw i32 %conv4, %conv6
  %shl = shl nsw i32 %sub7, 16
  %add = add nsw i32 %sub, %shl
  %ptridx8 = getelementptr inbounds i32, ptr %result, i64 %indvars.iv
  store i32 %add, ptr %ptridx8, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %add.ptr = getelementptr inbounds i8, ptr %pix1.addr.023, i64 %idx.ext
  %add.ptr10 = getelementptr inbounds i8, ptr %pix2.addr.022, i64 %idx.ext9

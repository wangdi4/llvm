...
; CHECK-NEXT: Scalar Cost = 4 x 23 = 92 < VectorCost = 2[x2] x 112 + 23 x 0 = 224
; CHECK-NEXT: Scalar Cost = 4 x 23 = 92 < VectorCost = 1[x4] x 519 + 23 x 0 = 519
; CHECK-NEXT: Selecting VPlan with VF=2

...
; RUN: opt -vplan-enable-soa=false -VPlanDriver -vplan-force-vf=2 -vplan-enable-cfg-merge=1 -vplan-print-after-live-inout-list -vplan-entities-dump -disable-output %s | FileCheck %s

...
; RUN: opt -opaque-pointers=0 -vplan-enable-soa=false -passes=vplan-vec -vplan-force-vf=2 -vplan-print-after-live-inout-list -vplan-entities-dump -disable-output %s | FileCheck %s

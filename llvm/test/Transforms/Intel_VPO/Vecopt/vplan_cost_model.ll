...
; VPLAN-CM-VF4-NEXT:  Total Cost: 205
...
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 205
...
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 39
...
; VPLAN-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-CM-VF4-NEXT:  Total Cost: 75
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:    Unknown cost for [[VP0:%.*]] = call token ()* @llvm.directive.region.entry
...
;
; VPLAN-HIR-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-HIR-CM-VF4-NEXT:  Total Cost: 70
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
...
; VPLAN-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-CM-VF4-NEXT:  Total Cost: 49
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:    Unknown cost for [[VP0:%.*]] = call token ()* @llvm.directive.region.entry
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 49
; VPLAN-CM-VF4-NEXT:    Unknown cost for [[VP1:%.*]] = phi i64 0 [[VP2:%.*]]
; VPLAN-CM-VF4-NEXT:    Cost 0 for [[VP3:%.*]] = getelementptr [1024 x i32]* @arr.i32.1 i64 0 [[VP1]]
; VPLAN-CM-VF4-NEXT:    Cost 4 for [[VP4:%.*]] = load [[VP3]]
...
;
; VPLAN-HIR-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-HIR-CM-VF4-NEXT:  Total Cost: 23
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 23
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP0:%.*]] = load [[VP1:%.*]]
...
; VPLAN-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-CM-VF4-NEXT:  Total Cost: 78
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:    Unknown cost for [[VP0:%.*]] = call token ()* @llvm.directive.region.entry
...
; VPLAN-CM-VF4-NEXT:    Cost 4 for store [[VP51]] [[VP50]]
; VPLAN-CM-VF4-NEXT:    Cost 1 for [[VP2]] = add [[VP1]] i64 1
...
;
; VPLAN-HIR-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-HIR-CM-VF4-NEXT:  Total Cost: 75
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP11:%.*]] = load [[VP12:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP13:%.*]] = load [[VP14:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP15:%.*]] = load [[VP16:%.*]]
...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP23:%.*]] = load [[VP24:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP25:%.*]] = load [[VP26:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP27:%.*]] = load [[VP28:%.*]]
...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP34:%.*]] = load [[VP35:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP36:%.*]] = load [[VP37:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP38:%.*]] = load [[VP39:%.*]]
...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for store [[VP47:%.*]] [[VP48:%.*]]
...
; VPLAN-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-CM-VF4-NEXT:  Total Cost: 42
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:    Unknown cost for [[VP0:%.*]] = call token ()* @llvm.directive.region.entry
...
; VPLAN-CM-VF4-NEXT:    Cost 0 for [[VP13:%.*]] = getelementptr [1024 x i32]* @arr.i32.4 i64 0 [[VP1]]
; VPLAN-CM-VF4-NEXT:    Cost 4 for store [[VP12]] [[VP13]]
...
; VPLAN-CM-VF4-NEXT:    Cost 4 for store [[VP23]] [[VP24]]
; VPLAN-CM-VF4-NEXT:    Cost 1 for [[VP2]] = add [[VP1]] i64 1
...
;
; VPLAN-HIR-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-HIR-CM-VF4-NEXT:  Total Cost: 32
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-HIR-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
...
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for store [[VP6]] [[VP8:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP9:%.*]] = load [[VP10:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP11:%.*]] = load [[VP12:%.*]]
; VPLAN-HIR-CM-VF4-NEXT:    Cost 4 for [[VP13:%.*]] = load [[VP14:%.*]]
...
; VPLAN-CM-VF4-LABEL:  Cost Model for VPlan  with VF = 4:
; VPLAN-CM-VF4-NEXT:  Total Cost: 14
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:    Unknown cost for [[VP0:%.*]] = call token ()* @llvm.directive.region.entry
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:    Unknown cost for [[VP1:%.*]] = phi i64 0 [[VP2:%.*]]
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 4
; VPLAN-CM-VF4-NEXT:    Cost 0 for [[VP3:%.*]] = getelementptr [1024 x i32]* @arr.i32.1 i64 0 [[VP1]]
; VPLAN-CM-VF4-NEXT:    Cost 4 for [[VP4:%.*]] = load [[VP3]]
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 6
...
; VPLAN-CM-VF4-NEXT:    Cost 4 for [[VP6]] = load [[VP9]]
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0
; VPLAN-CM-VF4-NEXT:  Analyzing VPBasicBlock BB{{.*}}, total cost: 0

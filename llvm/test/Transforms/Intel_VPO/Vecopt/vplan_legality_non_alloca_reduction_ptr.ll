...
; RUN: opt -vplan-print-terminator-inst=false %s -VPlanDriver -vplan-force-vf=2 -disable-output -vplan-entities-dump -vplan-print-after-vpentity-instrs | FileCheck %s

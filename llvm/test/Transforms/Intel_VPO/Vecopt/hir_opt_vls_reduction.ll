...
; RUN: opt -hir-ssa-deconstruction -hir-vec-dir-insert -VPlanDriverHIR -vplan-force-vf=4 -enable-vplan-vls-cg -vplan-use-entity-instr -hir-cg -S -print-after=VPlanDriverHIR  < %s 2>&1  | FileCheck %s

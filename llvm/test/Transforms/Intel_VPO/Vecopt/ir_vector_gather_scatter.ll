...
; CHECK-NEXT:    [[VEC_IND:%.*]] = phi <4 x i64> [ <i64 0, i64 11, i64 22, i64 33>, [[VECTOR_PH]] ], [ [[VEC_IND_NEXT:%.*]], [[VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[TMP2:%.*]] = add <4 x i64> [[VEC_IND]], <i64 3, i64 3, i64 3, i64 3>
...
; CHECK-NEXT:    [[TMP4:%.*]] = add nuw nsw <4 x i64> [[VEC_IND]], <i64 11, i64 11, i64 11, i64 11>
; CHECK-NEXT:    [[TMP5:%.*]] = icmp ult <4 x i64> [[TMP4]], <i64 3072, i64 3072, i64 3072, i64 3072>
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <4 x i1> [[TMP5]], i32 0
; CHECK-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 4
; CHECK-NEXT:    [[TMP7:%.*]] = icmp eq i64 [[INDEX_NEXT]], 280
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add <4 x i64> [[VEC_IND]], <i64 44, i64 44, i64 44, i64 44>

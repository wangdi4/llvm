...
; CHECK: [[SOA_SCALAR_GEP0:%.*]] = getelementptr inbounds [2520 x <4 x double>], ptr [[DOTSOA_VEC0]], i64 0, i64 [[UNI_PHI350:%.*]]
; CHECK: store <4 x double> [[TMP96:%.*]], ptr [[SOA_SCALAR_GEP0]], align 8

...
define dso_local void @foo(i64* noalias nocapture noundef %A, i16* nocapture noundef readonly %B, i64* noalias nocapture noundef readonly %C, i32 noundef %N) local_unnamed_addr #0 {
;
; long A[N], C[N];

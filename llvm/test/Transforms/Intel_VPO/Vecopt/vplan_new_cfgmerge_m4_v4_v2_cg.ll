...
; CHECK:       merge.blk20:
; CHECK-NEXT:    [[UNI_PHI26:%.*]] = phi i64 [ 1024, [[VPLANNEDBB25]] ], [ 0, [[PEEL_CHECKV25]] ], [ [[UNI_PHI12]], [[VPLANNEDBB14]] ]
...
; CHECK-NEXT:    [[TMP29:%.*]] = add <2 x i64> [[UNI_PHI26IND_START_BCAST_SPLAT]], <i64 0, i64 1>
; CHECK-NEXT:    br label [[VPLANNEDBB29:%.*]]
; CHECK:       VPlannedBB29:
; CHECK-NEXT:    [[UNI_PHI30:%.*]] = phi i64 [ [[UNI_PHI26]], [[VPLANNEDBB28]] ], [ [[TMP34:%.*]], [[VPLANNEDBB29]] ]
; CHECK-NEXT:    [[VEC_PHI31:%.*]] = phi <2 x i64> [ [[TMP29]], [[VPLANNEDBB28]] ], [ [[TMP33:%.*]], [[VPLANNEDBB29]] ]
; CHECK-NEXT:    [[SCALAR_GEP32:%.*]] = getelementptr inbounds i64, i64* [[ARY]], i64 [[UNI_PHI30]]
; CHECK-NEXT:    [[TMP30:%.*]] = sext <2 x i32> [[BROADCAST_SPLAT34]] to <2 x i64>
; CHECK-NEXT:    [[TMP31:%.*]] = add <2 x i64> [[TMP30]], [[VEC_PHI31]]
; CHECK-NEXT:    [[TMP32:%.*]] = bitcast i64* [[SCALAR_GEP32]] to <2 x i64>*
; CHECK-NEXT:    store <2 x i64> [[TMP31]], <2 x i64>* [[TMP32]], align 8
; CHECK-NEXT:    [[TMP33]] = add nuw nsw <2 x i64> [[VEC_PHI31]], <i64 2, i64 2>
; CHECK-NEXT:    [[TMP34]] = add nuw nsw i64 [[UNI_PHI30]], 2
; CHECK-NEXT:    [[TMP35:%.*]] = icmp ult i64 [[TMP34]], 1024
; CHECK-NEXT:    br i1 [[TMP35]], label [[VPLANNEDBB29]], label [[VPLANNEDBB35:%.*]]
; CHECK:       VPlannedBB35:
; CHECK-NEXT:    br label [[VPLANNEDBB36:%.*]]
; CHECK:       VPlannedBB36:
; CHECK-NEXT:    br label [[FINAL_MERGE]]
; CHECK:       final.merge:
; CHECK-NEXT:    [[UNI_PHI37:%.*]] = phi i64 [ 1024, [[VPLANNEDBB36]] ], [ 1024, [[VPLANNEDBB25]] ], [ [[UNI_PHI12]], [[VPLANNEDBB13]] ]

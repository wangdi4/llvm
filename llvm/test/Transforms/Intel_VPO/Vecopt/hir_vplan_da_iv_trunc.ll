...
; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec" -S -disable-output -vplan-dump-da %s 2>&1 | FileCheck %s

...
; RUN: opt -vplan-vec -vplan-print-scalvec-results -vplan-force-vf=2 -intel-ir-optreport-emitter -intel-loop-optreport=high 2>&1 -disable-output -S < %s | FileCheck %s -check-prefixes=OPTREPORT

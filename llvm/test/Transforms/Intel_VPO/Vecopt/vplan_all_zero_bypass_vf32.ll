...
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i32 [[VP1:%.*]] = load ptr [[VP_ARRAYIDX]] (SVAOpBits 0->F )
...
; CHECK-NEXT:     [DA: Div, SVA: (F  )] ptr [[VP_ARRAYIDX3:%.*]] = getelementptr inbounds i32, ptr [[C0:%.*]] i64 [[VP_INDVARS_IV]] (SVAOpBits 0->F 1->F )
; CHECK-NEXT:     [DA: Div, SVA: ( V )] i32 [[VP3:%.*]] = load ptr [[VP_ARRAYIDX3]] (SVAOpBits 0->F )
...
; CHECK-NEXT:     [DA: Div, SVA: (F  )] ptr [[VP_ARRAYIDX5:%.*]] = getelementptr inbounds i32, ptr [[B0:%.*]] i64 [[VP_INDVARS_IV]] (SVAOpBits 0->F 1->F )
; CHECK-NEXT:     [DA: Div, SVA: ( V )] store i32 [[VP__BLEND_BB3]] ptr [[VP_ARRAYIDX5]] (SVAOpBits 0->V 1->F )

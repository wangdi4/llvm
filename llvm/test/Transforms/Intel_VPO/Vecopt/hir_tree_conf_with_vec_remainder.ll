; RUN: opt %s -vplan-vec-scenario="n0;v8;v4" -passes='hir-ssa-deconstruction,hir-temp-cleanup,hir-vec-dir-insert,hir-vplan-vec,print<hir>' -vplan-enable-non-masked-vectorized-remainder -disable-output

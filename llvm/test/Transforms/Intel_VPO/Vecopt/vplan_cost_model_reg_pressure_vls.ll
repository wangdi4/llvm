...
; CHECK-NEXT:    Cost 28000 for store i8 [[VP17]] i8* [[VP_SUBSCRIPT_3]] *OVLS*(-17000) AdjCost: 11000
; CHECK-NEXT:    Cost 2000 for i64 [[VP1]] = add i64 [[VP0]] i64 [[VP__IND_INIT_STEP]]
; CHECK-NEXT:    Cost 8000 for i1 [[VP20:%.*]] = icmp sle i64 [[VP1]] i64 [[VP_VECTOR_TRIP_COUNT]]

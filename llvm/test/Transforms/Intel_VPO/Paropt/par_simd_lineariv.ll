...
;   printf("%d\n", indexK);
; }
; ModuleID = 'par_simd_lineariv.cpp'
source_filename = "par_simd_lineariv.cpp"
...
; CHECK: %indexK.linear.iv = alloca i32, align 4
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.NUM_THREADS"(i32 4), "QUAL.OMP.PRIVATE"(i32* %.omp.iv), "QUAL.OMP.PRIVATE"(i32* %.omp.ub), "QUAL.OMP.SHARED"(i32* %indexK), "QUAL.OMP.PRIVATE"(i32* %tmp) ]
...
; CHECK: {{%[^ ]+}} = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), {{.*}} "QUAL.OMP.LINEAR:IV"(i32* %indexK.linear.iv, i32 1) ]
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.LINEAR:IV"(i32* %indexK, i32 1) ]

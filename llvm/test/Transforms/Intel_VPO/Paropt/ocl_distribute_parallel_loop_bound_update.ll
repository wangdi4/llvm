; RUN: opt -opaque-pointers=1 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -S
; RUN: opt -opaque-pointers=1 -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -switch-to-offload -S

; Test src:
;
; void kernel(float c0, float c1, float *A0, float *Anext, const int nx,
...
define dso_local spir_func void @kernel(float %c0, float %c1, ptr addrspace(4) %A0, ptr addrspace(4) %Anext, i32 %nx, i32 %ny, i32 %nz) #0 {
entry:
  %c0.addr = alloca float, align 4
  %0 = addrspacecast ptr %c0.addr to ptr addrspace(4)
  %c1.addr = alloca float, align 4
  %1 = addrspacecast ptr %c1.addr to ptr addrspace(4)
  %A0.addr = alloca ptr addrspace(4), align 8
  %2 = addrspacecast ptr %A0.addr to ptr addrspace(4)
  %Anext.addr = alloca ptr addrspace(4), align 8
  %3 = addrspacecast ptr %Anext.addr to ptr addrspace(4)
  %nx.addr = alloca i32, align 4
  %4 = addrspacecast ptr %nx.addr to ptr addrspace(4)
  %ny.addr = alloca i32, align 4
  %5 = addrspacecast ptr %ny.addr to ptr addrspace(4)
  %nz.addr = alloca i32, align 4
  %6 = addrspacecast ptr %nz.addr to ptr addrspace(4)
  %i = alloca i32, align 4
  %7 = addrspacecast ptr %i to ptr addrspace(4)
  %j = alloca i32, align 4
  %8 = addrspacecast ptr %j to ptr addrspace(4)
  %k = alloca i32, align 4
  %9 = addrspacecast ptr %k to ptr addrspace(4)
  %size = alloca i32, align 4
  %10 = addrspacecast ptr %size to ptr addrspace(4)
  %.capture_expr. = alloca i32, align 4
  %11 = addrspacecast ptr %.capture_expr. to ptr addrspace(4)
  %.capture_expr.2 = alloca i32, align 4
  %12 = addrspacecast ptr %.capture_expr.2 to ptr addrspace(4)
  %.capture_expr.4 = alloca i32, align 4
  %13 = addrspacecast ptr %.capture_expr.4 to ptr addrspace(4)
  %.capture_expr.6 = alloca i64, align 8
  %14 = addrspacecast ptr %.capture_expr.6 to ptr addrspace(4)
  %.omp.lb = alloca i64, align 8
  %15 = addrspacecast ptr %.omp.lb to ptr addrspace(4)
  %.omp.ub = alloca i64, align 8
  %16 = addrspacecast ptr %.omp.ub to ptr addrspace(4)
  %.omp.iv = alloca i64, align 8
  %17 = addrspacecast ptr %.omp.iv to ptr addrspace(4)
  %tmp = alloca i32, align 4
  %18 = addrspacecast ptr %tmp to ptr addrspace(4)
  %tmp22 = alloca i32, align 4
  %19 = addrspacecast ptr %tmp22 to ptr addrspace(4)
  %tmp23 = alloca i32, align 4
  %20 = addrspacecast ptr %tmp23 to ptr addrspace(4)
  store float %c0, ptr addrspace(4) %0, align 4
  store float %c1, ptr addrspace(4) %1, align 4
  store ptr addrspace(4) %A0, ptr addrspace(4) %2, align 8
  store ptr addrspace(4) %Anext, ptr addrspace(4) %3, align 8
  store i32 %nx, ptr addrspace(4) %4, align 4
  store i32 %ny, ptr addrspace(4) %5, align 4
  store i32 %nz, ptr addrspace(4) %6, align 4
  %21 = load i32, ptr addrspace(4) %4, align 4
  %22 = load i32, ptr addrspace(4) %5, align 4
  %mul = mul nsw i32 %21, %22
  %23 = load i32, ptr addrspace(4) %6, align 4
  %mul1 = mul nsw i32 %mul, %23
  store i32 %mul1, ptr addrspace(4) %10, align 4
  %24 = load i32, ptr addrspace(4) %6, align 4
  %sub = sub nsw i32 %24, 1
  store i32 %sub, ptr addrspace(4) %11, align 4
  %25 = load i32, ptr addrspace(4) %5, align 4
  %sub3 = sub nsw i32 %25, 1
  store i32 %sub3, ptr addrspace(4) %12, align 4
  %26 = load i32, ptr addrspace(4) %4, align 4
  %sub5 = sub nsw i32 %26, 1
  store i32 %sub5, ptr addrspace(4) %13, align 4
  %27 = load i32, ptr addrspace(4) %11, align 4
  %sub7 = sub nsw i32 %27, -100
  %sub8 = sub nsw i32 %sub7, 1
  %add = add nsw i32 %sub8, 1
  %div = sdiv i32 %add, 1
  %conv = sext i32 %div to i64
  %28 = load i32, ptr addrspace(4) %12, align 4
  ...
  %29 = load i32, ptr addrspace(4) %13, align 4
  ...
  store i64 %sub21, ptr addrspace(4) %14, align 8
  store i64 0, ptr addrspace(4) %15, align 8
  %30 = load i64, ptr addrspace(4) %14, align 8
  store i64 %30, ptr addrspace(4) %16, align 8
  %31 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %11, i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %12, i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %13, i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %15, i64 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %16, i64 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %9, i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %8, i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %7, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %17, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %18, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %19, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %20, i32 0, i32 1) ]
  %32 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %11, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %12, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %13, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %15, i64 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %16, i64 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %9, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %8, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %7, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %17, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %18, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %19, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %20, i32 0, i32 1) ]
  %33 = load i32, ptr addrspace(4) %11, align 4
  %cmp = icmp slt i32 -100, %33
  br i1 %cmp, label %land.lhs.true, label %omp.precond.end

land.lhs.true:                                    ; preds = %entry
  %34 = load i32, ptr addrspace(4) %12, align 4
  %cmp26 = icmp slt i32 1, %34
  br i1 %cmp26, label %land.lhs.true29, label %omp.precond.end

land.lhs.true29:                                  ; preds = %land.lhs.true
  %35 = load i32, ptr addrspace(4) %13, align 4
  %cmp30 = icmp slt i32 1, %35
  br i1 %cmp30, label %omp.precond.then, label %omp.precond.end

omp.precond.then:                                 ; preds = %land.lhs.true29
  %36 = call token @llvm.directive.region.entry() [ "DIR.OMP.DISTRIBUTE.PARLOOP"(),
    "QUAL.OMP.COLLAPSE"(i32 3),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %15, i64 0, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr addrspace(4) %17, i64 0, i32 1),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr addrspace(4) %16, i64 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %12, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %13, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %9, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %8, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %7, i32 0, i32 1) ]
  %37 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(),
    "QUAL.OMP.COLLAPSE"(i32 3) ]
  %38 = load i64, ptr addrspace(4) %15, align 8
  store i64 %38, ptr addrspace(4) %17, align 8
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %omp.precond.then
  %39 = load i64, ptr addrspace(4) %17, align 8
  %40 = load i64, ptr addrspace(4) %16, align 8
  %cmp33 = icmp sle i64 %39, %40
  br i1 %cmp33, label %omp.inner.for.body, label %omp.inner.for.end

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %41 = load i64, ptr addrspace(4) %17, align 8
  %42 = load i32, ptr addrspace(4) %12, align 4
  %sub35 = sub nsw i32 %42, 1
  %sub36 = sub nsw i32 %sub35, 1
  %add37 = add nsw i32 %sub36, 1
  %div38 = sdiv i32 %add37, 1
  %mul39 = mul nsw i32 1, %div38
  %43 = load i32, ptr addrspace(4) %13, align 4
  ...
  store i32 %conv49, ptr addrspace(4) %9, align 4
  %44 = load i64, ptr addrspace(4) %17, align 8
  %45 = load i64, ptr addrspace(4) %17, align 8
  %46 = load i32, ptr addrspace(4) %12, align 4
  %sub50 = sub nsw i32 %46, 1
  %sub51 = sub nsw i32 %sub50, 1
  %add52 = add nsw i32 %sub51, 1
  %div53 = sdiv i32 %add52, 1
  %mul54 = mul nsw i32 1, %div53
  %47 = load i32, ptr addrspace(4) %13, align 4
  ...
  %50 = load i32, ptr addrspace(4) %13, align 4
  ...
  store i32 %conv84, ptr addrspace(4) %8, align 4
  %51 = load i64, ptr addrspace(4) %17, align 8
  %52 = load i64, ptr addrspace(4) %17, align 8
  %53 = load i32, ptr addrspace(4) %12, align 4
  %sub85 = sub nsw i32 %53, 1
  %sub86 = sub nsw i32 %sub85, 1
  %add87 = add nsw i32 %sub86, 1
  %div88 = sdiv i32 %add87, 1
  %mul89 = mul nsw i32 1, %div88
  %54 = load i32, ptr addrspace(4) %13, align 4
  ...
  %55 = load i32, ptr addrspace(4) %12, align 4
  ...
  %56 = load i32, ptr addrspace(4) %13, align 4
  ...
  %57 = load i64, ptr addrspace(4) %17, align 8
  %58 = load i64, ptr addrspace(4) %17, align 8
  ...
  %60 = load i32, ptr addrspace(4) %13, align 4
  ...
  %61 = load i32, ptr addrspace(4) %12, align 4
  ...
  %62 = load i32, ptr addrspace(4) %13, align 4
  ...
  %63 = load i32, ptr addrspace(4) %13, align 4
  ...
  %64 = load i32, ptr addrspace(4) %13, align 4
  ...
  store i32 %conv152, ptr addrspace(4) %7, align 4
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %65 = load i64, ptr addrspace(4) %17, align 8
  %add153 = add nsw i64 %65, 1
  store i64 %add153, ptr addrspace(4) %17, align 8
  br label %omp.inner.for.cond

; RUN: opt < %s -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-paropt-prepare-disable-offload -S | FileCheck %s
; RUN: opt < %s -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare)' -vpo-paropt-prepare-disable-offload -S | FileCheck %s

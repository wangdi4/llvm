...
; CHECK: store i32 %add, ptr %i.ascast.linear.iv, align 4
; CHECK: %{{[^ ]+}} = load i32, ptr %i.ascast.linear.iv, align 4
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %call = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str to ptr addrspace(4)), i32 %5) #1

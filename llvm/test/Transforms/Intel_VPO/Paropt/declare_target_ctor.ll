...
; CHECK-DAG: @.omp_offloading.entry.{{.*}} = weak target_declare constant { i8*, i8*, i64, i32, i32 } { i8* getelementptr inbounds (%struct.S, %struct.S* @Var, i32 0, i32 0), i8* {{.*}}, i32 0, i32 0), i64 8, i32 0, i32 0 }, section ".omp_offloading.entries"

...
define dso_local void @_Z13cq415166_1d_dv() {
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR:TYPED"(ptr @_ZL1y_593c32c614d5fd7c1fb5cf59b8276c7b, %struct.my_struct zeroinitializer, i32 100, ptr null, ptr @_ZTSA100_9my_struct.omp.destr, ptr @.omp_combiner., ptr @.omp_initializer.),
    ...
    "QUAL.OMP.SHARED:TYPED"(ptr @_ZL1x_593c32c614d5fd7c1fb5cf59b8276c7b, %struct.my_struct zeroinitializer, i32 100) ]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1y_593c32c614d5fd7c1fb5cf59b8276c7b, i64 0, i64 %idxprom
  %7 = load i32, ptr %i, align 4
  %idxprom2 = sext i32 %7 to i64
  %arrayidx3 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_593c32c614d5fd7c1fb5cf59b8276c7b, i64 0, i64 %idxprom2
  call void @_Z6my_addR9my_structRKS_(ptr dereferenceable(40) %arrayidx, ptr dereferenceable(40) %arrayidx3)
  br label %for.inc

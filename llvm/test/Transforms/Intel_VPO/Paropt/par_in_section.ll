...
; RUN: opt < %s -passes='function(vpo-cfg-restructuring,vpo-paropt-loop-collapse,vpo-cfg-restructuring,vpo-paropt-prepare,loop-simplifycfg,loop(loop-simplifycfg),vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt'  -S | FileCheck %s

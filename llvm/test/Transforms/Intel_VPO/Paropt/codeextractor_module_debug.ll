...
; -- codeextractor_module_debug.f90 -------------------------------------------
; MODULE module_1
;   INTEGER :: array_1(10)
; END MODULE module_1
;
...
;
; CHECK: [[PARAM]].addr = alloca [[TYPE]], align 8
; CHECK: store [[TYPE]] [[PARAM]], [[TYPE]]* [[PARAM]].addr, align 8
; CHECK: [[PARAM]].value = load [[TYPE]], [[TYPE]]* [[PARAM]].addr, align 8
;
; CHECK:      call void @llvm.dbg.declare(metadata [[TYPE]]* [[PARAM]].addr
...
;
; ModuleID = 'codeextractor_module_debug.f90'
source_filename = "codeextractor_module_debug.f90"

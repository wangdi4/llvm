...
omp.inner.for.body:                               ; preds = %omp.inner.for.inc, %DIR.OMP.SIMD.2
  %v11 = load i32, ptr %.omp.iv, align 4
  %mul = mul nsw i32 %v11, 1
  %add5 = add nsw i32 0, %mul
  store i32 %add5, ptr %i, align 4
  %x6 = getelementptr inbounds %struct.Dummy, ptr %red, i32 0, i32 0
  %v12 = load float, ptr %x6, align 4
  %v13 = load ptr, ptr %m_out_vec.addr, align 8
  %v14 = load i32, ptr %i, align 4
  %idxprom = sext i32 %v14 to i64
  %arrayidx7 = getelementptr inbounds float, ptr %v13, i64 %idxprom
  store float %v12, ptr %arrayidx7, align 4
  br label %DIR.OMP.SCAN.3

DIR.OMP.SCAN.3:                                   ; preds = %omp.inner.for.body
  %v15 = call token @llvm.directive.region.entry() [ "DIR.OMP.SCAN"(),
...
DIR.OMP.END.SCAN.5:                               ; preds = %DIR.OMP.SCAN.4
  call void @llvm.directive.region.exit(token %v15) [ "DIR.OMP.END.SCAN"() ]
...
DIR.OMP.END.SCAN.6:                               ; preds = %DIR.OMP.END.SCAN.5
  ...
  %v16 = load ptr, ptr %m_in.addr, align 8
  %v17 = load i32, ptr %i, align 4
  %idxprom9 = sext i32 %v17 to i64
  %arrayidx10 = getelementptr inbounds float, ptr %v16, i64 %idxprom9
  %v18 = load float, ptr %arrayidx10, align 4
  store float %v18, ptr %x8, align 4
  %y11 = getelementptr inbounds %struct.Dummy, ptr %ref.tmp, i32 0, i32 1
  %v19 = load ptr, ptr %m_in.addr, align 8
  %v20 = load i32, ptr %i, align 4
  %idxprom12 = sext i32 %v20 to i64
  %arrayidx13 = getelementptr inbounds float, ptr %v19, i64 %idxprom12
  %v21 = load float, ptr %arrayidx13, align 4
  store float %v21, ptr %y11, align 4
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %v22 = load i32, ptr %.omp.iv, align 4
  %add14 = add nsw i32 %v22, 1
...
omp.precond.end:                                  ; preds = %omp.loop.exit, %entry
  ...
  %v23 = load float, ptr %x15, align 4
  ret float %v23
}

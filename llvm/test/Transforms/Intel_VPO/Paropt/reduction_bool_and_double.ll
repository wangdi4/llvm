...
; CHECK: %[[RED:[^,]+]] = load double, ptr %v3.fast_red, align 8
; CHECK-NEXT: %[[ORIG:[^,]+]] = load double, ptr %v3, align 8
...
; CHECK-NEXT: store double %[[CONV]], ptr %v3, align 8
...
entry:
  ...
  store double 1.000000e+00, ptr %v3, align 8
  store i32 0, ptr %.omp.lb, align 4
  store i32 2, ptr %.omp.ub, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.AND:TYPED"(ptr %v3, double 0.000000e+00, i32 1),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %5 = load double, ptr %v3, align 8
  %tobool = fcmp fast une double %5, 0.000000e+00
...
land.end:                                         ; preds = %land.rhs, %omp.inner.for.body
  ...
  store double %conv, ptr %v3, align 8
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %8 = load double, ptr %v3, align 8
  %sub = fsub fast double %8, 1.000000e+00

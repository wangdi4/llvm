...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.OR:TYPED"(ptr %v3, <4 x float> zeroinitializer, i32 1),
...
for.body:                                         ; preds = %for.cond
  ...
  %sub = fsub fast double %conv, 1.000000e+00
  %conv6 = fpext double %sub to x86_fp80
  %14 = call fast x86_fp80 @llvm.fabs.f80(x86_fp80 %conv6)
  %cmp7 = fcmp fast ogt x86_fp80 %14, 0xK3FD78CBCCC096F508800
  br i1 %cmp7, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %call8 = call i32 (ptr, ...) @printf(ptr noundef @.str)

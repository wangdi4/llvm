...
define dso_local void @_Z11for_orderedPi(ptr noundef %x) #0 {
entry:
  ...
  store i32 999, ptr %.omp.ub, align 4, !tbaa !8
  ...
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !8
  store i32 %1, ptr %.omp.iv, align 4, !tbaa !8
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  %2 = load i32, ptr %.omp.iv, align 4, !tbaa !8
  %3 = load i32, ptr %.omp.ub, align 4, !tbaa !8
  %cmp = icmp sle i32 %2, %3
  br i1 %cmp, label %omp.inner.for.body, label %omp.inner.for.end

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #2
  %4 = load i32, ptr %.omp.iv, align 4, !tbaa !8
  %mul = mul nsw i32 %4, 1

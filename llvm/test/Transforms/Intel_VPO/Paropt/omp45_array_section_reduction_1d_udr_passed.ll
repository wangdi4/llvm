...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z20cq415166_1d_e_passedPs(ptr %ypas) #1 {
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR:ARRSECT.PTR_TO_PTR.TYPED"(ptr %ypas.addr, i16 0, i64 25, i64 25, ptr null, ptr null, ptr @.omp_combiner., ptr null),
    "QUAL.OMP.SHARED:TYPED"(ptr @_ZL1x_eb51270620997130c2dd49a2f07950bb, i16 0, i64 100),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x i16], ptr @_ZL1x_eb51270620997130c2dd49a2f07950bb, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], ptr @_ZL1x_eb51270620997130c2dd49a2f07950bb, i64 0, i64 %idxprom
  store i16 1, ptr %arrayidx, align 2
  %2 = load i32, ptr %i, align 4
  %conv = trunc i32 %2 to i16
  %3 = load i32, ptr %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], ptr @_ZL1y_eb51270620997130c2dd49a2f07950bb, i64 0, i64 %idxprom1
...
for.end:                                          ; preds = %for.cond
  call void @_Z20cq415166_1d_e_passedPs(ptr @_ZL1y_eb51270620997130c2dd49a2f07950bb)
  ret i32 0
}

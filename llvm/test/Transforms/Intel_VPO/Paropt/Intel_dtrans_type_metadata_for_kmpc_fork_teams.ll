...
; CHECK: declare{{.*}}!intel.dtrans.func.type ![[FMD:[0-9]+]] void @__kmpc_fork_teams(ptr, i32, ptr, ...)
...
; CHECK-DAG: ![[FMD]] = distinct !{![[IDENTPTRMD:[0-9]+]], ![[CALLBACKPTRMD:[0-9]+]]}
; CHECK-DAG: ![[IDENTPTRMD]] = !{%struct.ident_t zeroinitializer, i32 1}
; CHECK-DAG: ![[CALLBACKPTRMD]] = !{![[CALLBACKMD:[0-9]+]], i32 1}
; CHECK-DAG: ![[CALLBACKMD]] = !{!"F", i1 true, i32 2, ![[VOIDMD:[0-9]+]], ![[I32PTRMD:[0-9]+]], ![[I32PTRMD]]}

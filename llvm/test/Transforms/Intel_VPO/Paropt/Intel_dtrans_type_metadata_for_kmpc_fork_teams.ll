...
; CHECK: declare{{.*}}!intel.dtrans.func.type ![[FMD:[0-9]+]] void @__kmpc_fork_teams(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...)
; OPQPTR: declare{{.*}}!intel.dtrans.func.type ![[FMD:[0-9]+]] void @__kmpc_fork_teams(ptr, i32, ptr, ...)

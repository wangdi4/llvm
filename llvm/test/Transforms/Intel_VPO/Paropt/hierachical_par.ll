; RUN: opt -switch-to-offload -loop-rotate -vpo-cfg-restructuring -vpo-paropt-prepare -sroa -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -S %s | FileCheck %s
...
entry:
  ...
  %7 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0), "QUAL.OMP.MAP.TOFROM"([256 x [256 x double]] addrspace(4)* addrspacecast ([256 x [256 x double]] addrspace(1)* @A to [256 x [256 x double]] addrspace(4)*), [256 x [256 x double]] addrspace(4)* addrspacecast ([256 x [256 x double]] addrspace(1)* @A to [256 x [256 x double]] addrspace(4)*), i64 524288, i64 35, i8* null, i8* null), "QUAL.OMP.MAP.TOFROM"([256 x double] addrspace(4)* addrspacecast ([256 x double] addrspace(1)* @B to [256 x double] addrspace(4)*), [256 x double] addrspace(4)* addrspacecast ([256 x double] addrspace(1)* @B to [256 x double] addrspace(4)*), i64 524288, i64 35, i8* null, i8* null), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %1), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %4), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %5), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %6), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %2), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %3) ]

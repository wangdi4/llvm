...
; PREPR: "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr %f, %struct._FourChars zeroinitializer, i32 1)
...
; Instcombine used to allocate %f as "%f = alloca i32" with typed pointers.
...
; RESTR  "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr [[F]], %struct._FourChars zeroinitializer, i32 1)

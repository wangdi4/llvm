...
define void @ntscale_(ptr noalias dereferenceable(72) "assumed_shape" "ptrnoalias" %"ntscale_$A$argptr", ptr noalias readonly dereferenceable(4) %"ntscale_$B$argptr", ptr noalias readonly dereferenceable(4) %"ntscale_$N$argptr") {
alloca_0:
  ...
  %"ntscale_$N.3_fetch.4" = load i32, ptr %"ntscale_$N.3", align 1
  ...
  %"ntscale_$A.1.addr_a0$_fetch.5" = load ptr, ptr %"ntscale_$A.1.addr_a0$5", align 1
  %omp.pdo.start = alloca i32, align 4
  store i32 1, ptr %omp.pdo.start, align 4
  %omp.pdo.end = alloca i32, align 4
  %"ntscale_$N.3_fetch.6" = load i32, ptr %"ntscale_$N.3", align 1
  ...
  %omp.pdo.end_fetch.7 = load i32, ptr %omp.pdo.end, align 4
  %omp.pdo.start_fetch.8 = load i32, ptr %omp.pdo.start, align 4
  ...
  %omp.pdo.step_fetch.10 = load i32, ptr %omp.pdo.step, align 4
...
bb_new7:  ; preds = %alloca_0
  ...
  %omp.pdo.norm.lb_fetch.11 = load i32, ptr %omp.pdo.norm.lb, align 4
...
omp.pdo.cond4:  ; preds = %omp.pdo.body5, %bb_new7
  %omp.pdo.norm.iv_fetch.12 = load i32, ptr %omp.pdo.norm.iv, align 4
  %omp.pdo.norm.ub_fetch.13 = load i32, ptr %omp.pdo.norm.ub, align 4
...
omp.pdo.body5:  ; preds = %omp.pdo.cond4
  ...
  %omp.pdo.step_fetch.15 = load i32, ptr %omp.pdo.step, align 4
  %mul.1 = mul nsw i32 %omp.pdo.norm.iv_fetch.14, %omp.pdo.step_fetch.15
  %omp.pdo.start_fetch.16 = load i32, ptr %omp.pdo.start, align 4
  %add.2 = add nsw i32 %mul.1, %omp.pdo.start_fetch.16
  store i32 %add.2, ptr %"ntscale_$I", align 8
  %"ntscale_$I_fetch.17" = load i32, ptr %"ntscale_$I", align 8
  %int_sext = sext i32 %"ntscale_$I_fetch.17" to i64
  %"ntscale_$B.2[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(float) %"ntscale_$B.2", i64 %int_sext)
  %"ntscale_$B.2[]_fetch.18" = load float, ptr %"ntscale_$B.2[]", align 1
  ...
  %"ntscale_$A.1.addr_a0$_fetch.19" = load ptr, ptr %"ntscale_$A.1.addr_a0$", align 1
  ...
  %"ntscale_$A.1.dim_info$.spacing$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) %"ntscale_$A.1.dim_info$.spacing$", i32 0)
  %"ntscale_$A.1.dim_info$.spacing$[]_fetch.20" = load i64, ptr %"ntscale_$A.1.dim_info$.spacing$[]", align 1
  %"ntscale_$I_fetch.21" = load i32, ptr %"ntscale_$I", align 8
  %int_sext1 = sext i32 %"ntscale_$I_fetch.21" to i64
  ...
  %"ntscale_$A.1.dim_info$.spacing$[]4" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) %"ntscale_$A.1.dim_info$.spacing$3", i32 0)
  %"ntscale_$A.1.dim_info$.spacing$[]_fetch.22" = load i64, ptr %"ntscale_$A.1.dim_info$.spacing$[]4", align 1
  %"ntscale_$A.1.addr_a0$_fetch.19[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %"ntscale_$A.1.dim_info$.spacing$[]_fetch.20", ptr elementtype(float) %"ntscale_$A.1.addr_a0$_fetch.19", i64 %int_sext1)
  store float %mul.2, ptr %"ntscale_$A.1.addr_a0$_fetch.19[]", align 1
  %"ntscale_$I_fetch.23" = load i32, ptr %"ntscale_$I", align 8
  %omp.pdo.step_fetch.24 = load i32, ptr %omp.pdo.step, align 4
  %add.3 = add nsw i32 %"ntscale_$I_fetch.23", %omp.pdo.step_fetch.24
  store i32 %add.3, ptr %"ntscale_$I", align 8
  %omp.pdo.norm.iv_fetch.25 = load i32, ptr %omp.pdo.norm.iv, align 4
...
declare ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 %0, i64 %1, i32 %2, ptr %3, i32 %4)

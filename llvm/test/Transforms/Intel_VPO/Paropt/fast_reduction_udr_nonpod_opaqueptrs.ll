...
;#pragma omp parallel reduction(merge:s)
; {
; }
;}
...
;FRCTRL3: call void @_ZTS1I.omp.destr(ptr %{{.*}}.fast_red)
...
;FRCTRL7: call void @llvm.memcpy.p0.p0.i64(ptr align 4 %{{.*}}.fast_red, ptr align 4 %{{.*}}.red, i64 12, i1 false)
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.REDUCTION.UDR:TYPED"(ptr %s, %class.I zeroinitializer, i32 1, ptr @_ZTS1I.omp.def_constr, ptr @_ZTS1I.omp.destr, ptr @.omp_combiner., ptr null) ]

...
source_filename = "tile1_outer.f90"
...
omp.pdo.cond3:  ; preds = %bb5, %bb_new6
...
omp.pdo.body4:  ; preds = %omp.pdo.cond3
  ...
  store i32 1, ptr %"test_$J", align 8, !tbaa !10
  br label %bb2

bb2:  ; preds = %omp.pdo.body4, %bb2
  call void @bar_.t0p.t0p(ptr %"test_$I", ptr %"test_$J"), !llfort.type_idx !12
  %"test_$J_fetch.11" = load i32, ptr %"test_$J", align 8, !tbaa !10
  %add.3 = add nsw i32 %"test_$J_fetch.11", 1
  store i32 %add.3, ptr %"test_$J", align 8, !tbaa !10
  %"test_$J_fetch.12" = load i32, ptr %"test_$J", align 8, !tbaa !10
  %rel.2 = icmp sle i32 %"test_$J_fetch.12", 48
  br i1 %rel.2, label %bb2, label %bb5

bb5:  ; preds = %bb2
  %omp.pdo.norm.iv_fetch.13 = load i32, ptr %omp.pdo.norm.iv, align 4, !tbaa !5
  %add.4 = add nsw i32 %omp.pdo.norm.iv_fetch.13, 1
  store i32 %add.4, ptr %omp.pdo.norm.iv, align 4, !tbaa !5
  br label %omp.pdo.cond3

...
; CHECK: store i32 10, ptr addrspace(1) @target_var{{.*}}.__global
...
entry:
  ...
  %target_var.ascast = addrspacecast ptr %target_var to ptr addrspace(4)
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %target_var.ascast, i32 0, i32 1) ]
  store i32 10, ptr addrspace(4) %target_var.ascast, align 4
...
!0 = !{i32 0, i32 53, i32 -1916678319, !"_Z3foo", i32 3, i32 0, i32 0}

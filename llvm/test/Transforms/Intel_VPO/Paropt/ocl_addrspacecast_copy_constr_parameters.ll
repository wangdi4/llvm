; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -S %s | FileCheck %s
...
; CHECK: [[PARAM1:%[^ ]+]] = addrspacecast ptr %priv.cpy.dest.ptr to ptr addrspace(4)
; CHECK: [[PARAM2:%[^ ]+]] = addrspacecast ptr addrspace(1) %priv.cpy.src.ptr to ptr addrspace(4)
; CHECK: call spir_func void @_ZTS1A.omp.copy_constr(ptr addrspace(4) [[PARAM1]], ptr addrspace(4) [[PARAM2]])
; CHECK: [[PARAM3:%[^ ]+]] = addrspacecast ptr %priv.cpy.dest.ptr26 to ptr addrspace(4)
...
!0 = !{i32 0, i32 53, i32 -1926233774, !"_Z3fn1v", i32 9, i32 0, i32 0}

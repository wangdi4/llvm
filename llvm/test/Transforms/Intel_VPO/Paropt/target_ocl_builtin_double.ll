...
define dso_local spir_kernel void @__omp_offloading_fd02_d323b8_main_l37(ptr addrspace(1) %array) #0 {
newFuncRoot:
  br label %for.end
...
; CHECK: {{.*}} call spir_func double @sin
  store double %call, ptr addrspace(1) %array, align 8
  %call2 = call spir_func double @cos(double 1.000000e+00)
; CHECK: {{.*}} call spir_func double @cos
  %arrayidx3 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 1
  store double %call2, ptr addrspace(1) %arrayidx3, align 8
  %call4 = call spir_func double @tan(double 1.000000e+00)
; CHECK: {{.*}} call spir_func double @tan
  %arrayidx5 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 2
  store double %call4, ptr addrspace(1) %arrayidx5, align 8
  %call6 = call spir_func double @pow(double 2.000000e+00, double 3.000000e+00)
; CHECK: {{.*}} call spir_func double @pow
  %arrayidx7 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 3
  store double %call6, ptr addrspace(1) %arrayidx7, align 8
  %call8 = call spir_func double @exp(double 2.000000e+00)
; CHECK: {{.*}} call spir_func double @exp
  %arrayidx9 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 4
  store double %call8, ptr addrspace(1) %arrayidx9, align 8
  %call10 = call spir_func double @log(double 2.000000e+00)
; CHECK: {{.*}} call spir_func double @log
  %arrayidx11 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 5
  store double %call10, ptr addrspace(1) %arrayidx11, align 8
  %call12 = call spir_func double @llvm.ceil.f64(double 2.500000e+00)
; CHECK: {{.*}} call spir_func double @_Z16__spirv_ocl_ceild
  %arrayidx13 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 6
  store double %call12, ptr addrspace(1) %arrayidx13, align 8
  %call14 = call spir_func double @llvm.floor.f64(double 2.500000e+00)
; CHECK: {{.*}} call spir_func double @_Z17__spirv_ocl_floord
  %arrayidx15 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 7
  store double %call14, ptr addrspace(1) %arrayidx15, align 8
  %call16 = call spir_func double @llvm.fabs.f64(double -2.000000e+00)
; CHECK: {{.*}} call spir_func double @llvm.fabs.f64
  %arrayidx17 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 8
  store double %call16, ptr addrspace(1) %arrayidx17, align 8
  %call18 = call spir_func double @sqrt(double 3.000000e+00)
; CHECK: {{.*}} call spir_func double @sqrt
  %arrayidx19 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 9
  store double %call18, ptr addrspace(1) %arrayidx19, align 8
  %call20 = call spir_func double @log2(double 3.000000e+00)
; CHECK: {{.*}} call spir_func double @log2
  %arrayidx21 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 10
  store double %call20, ptr addrspace(1) %arrayidx21, align 8
  %call22 = call spir_func double @erf(double 3.000000e+00)
; CHECK: {{.*}} call spir_func double @erf
  %arrayidx23 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 11
  store double %call22, ptr addrspace(1) %arrayidx23, align 8
...
; CHECK: {{.*}} call spir_func double @_Z16__spirv_ocl_fmaxdd
  %arrayidx25 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 12
  store double %call24, ptr addrspace(1) %arrayidx25, align 8
...
; CHECK: {{.*}} call spir_func double @_Z16__spirv_ocl_fmindd
  %arrayidx27 = getelementptr inbounds [20 x double], ptr addrspace(1) %array, i64 0, i64 13
  store double %call26, ptr addrspace(1) %arrayidx27, align 8
...
; CHECK: {{.*}} call spir_func double @_Z17__spirv_ocl_rsqrtd
  ...
  call spir_func void @sincos(double 1.00e+00, ptr addrspace(4) %sineptr, ptr addrspace(4) %cosptr)
; CHECK: [[SINE:%[A-Za-z0-9_.]+]] = call spir_func double @_Z18__spirv_ocl_sincosdPd
; CHECK: store double [[SINE]], ptr addrspace(4) %sineptr
...
declare dso_local spir_func void @sincos(double, ptr addrspace(4), ptr addrspace(4))

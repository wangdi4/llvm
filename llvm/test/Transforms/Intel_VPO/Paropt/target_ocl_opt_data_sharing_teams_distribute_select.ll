...
DIR.OMP.TARGET.346:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.lb.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %i.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %var.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %ref.tmp.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %ref.tmp2.ascast), "QUAL.OMP.OFFLOAD.NDRANGE"(i32 addrspace(4)* %.omp.ub.ascast), "QUAL.OMP.OPERAND.ADDR"(i32 addrspace(4)* %.omp.iv.ascast, i32 addrspace(4)** %.omp.iv.ascast.addr23), "QUAL.OMP.OPERAND.ADDR"(i32 addrspace(4)* %i.ascast, i32 addrspace(4)** %i.ascast.addr25), "QUAL.OMP.OPERAND.ADDR"(i32 addrspace(4)* %var.ascast, i32 addrspace(4)** %var.ascast.addr27), "QUAL.OMP.OPERAND.ADDR"(i32 addrspace(4)* %tmp.ascast, i32 addrspace(4)** %tmp.ascast.addr29), "QUAL.OMP.OPERAND.ADDR"(i32 addrspace(4)* %ref.tmp.ascast, i32 addrspace(4)** %ref.tmp.ascast.addr31), "QUAL.OMP.OPERAND.ADDR"(i32 addrspace(4)* %ref.tmp2.ascast, i32 addrspace(4)** %ref.tmp2.ascast.addr33), "QUAL.OMP.OPERAND.ADDR"(i32 addrspace(4)* %.omp.lb.ascast, i32 addrspace(4)** %.omp.lb.ascast.addr35), "QUAL.OMP.OPERAND.ADDR"(i32 addrspace(4)* %.omp.ub.ascast, i32 addrspace(4)** %.omp.ub.ascast.addr37), "QUAL.OMP.JUMP.TO.END.IF"(i1* %end.dir.temp43) ]

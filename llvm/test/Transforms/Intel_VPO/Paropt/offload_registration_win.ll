...
; CHECK-DAG: {{.*}} = weak target_declare constant { i8*, i8*, i64, i32, i32 } { i8* @__omp_offloading_{{.*}}_foo_l32.region_id, i8* getelementptr inbounds ([[FOONAMETY]], [[FOONAMETY]]* [[FOONAME]], i32 0, i32 0), i64 0, i32 0, i32 0 }, section ".omp_offloading.entries$B", align 32

; CHECK-DAG: [[BARNAME:.*]] = internal target_declare unnamed_addr constant [[BARNAMETY:[[0-9]+ x i8]]] c{{.*}}__omp_offloading_{{.*}}_bar_l40\00
; CHECK-DAG: {{.*}} = weak target_declare constant { i8*, i8*, i64, i32, i32 } { i8* @__omp_offloading_{{.*}}_bar_l40.region_id, i8* getelementptr inbounds ([[BARNAMETY]], [[BARNAMETY]]* [[BARNAME]], i32 0, i32 0), i64 0, i32 0, i32 0 }, section ".omp_offloading.entries$B", align 32

; RUN: opt -opaque-pointers=1 -bugpoint-enable-legacy-pm -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -switch-to-offload -S -vpo-paropt-atomic-free-reduction=false %s | FileCheck %s
; RUN: opt -opaque-pointers=1 -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -switch-to-offload -S -vpo-paropt-atomic-free-reduction=false %s | FileCheck %s
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %sum.ascast, i32 0, i32 1),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %7 = load i32, ptr addrspace(4) %sum.ascast, align 4
...
!0 = !{i32 0, i32 53, i32 -1925386427, !"_Z4main", i32 3, i32 0, i32 0}

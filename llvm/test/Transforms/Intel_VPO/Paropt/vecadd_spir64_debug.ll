...
; CHECK:   [[V1_STORAGE:%v1.ascast.*]] = alloca [100 x float] addrspace(1)*, align 8
; CHECK:   call void @llvm.dbg.declare(metadata [100 x float] addrspace(1)** [[V1_STORAGE]], metadata [[V1_DIVAR:![0-9]+]], metadata !DIExpression(DW_OP_deref)), !dbg [[L36C17:![0-9]+]]
; CHECK:   [[V2_STORAGE:%v2.ascast.*]] = alloca [100 x float] addrspace(1)*, align 8
; CHECK:   call void @llvm.dbg.declare(metadata [100 x float] addrspace(1)** [[V2_STORAGE]], metadata [[V2_DIVAR:![0-9]+]], metadata !DIExpression(DW_OP_deref)), !dbg [[L36C24:![0-9]+]]
; CHECK:   [[V3_STORAGE:%v3.ascast.*]] = alloca [100 x float] addrspace(1)*, align 8
; CHECK:   call void @llvm.dbg.declare(metadata [100 x float] addrspace(1)** [[V3_STORAGE]], metadata [[V3_DIVAR:![0-9]+]], metadata !DIExpression(DW_OP_deref)), !dbg [[L36C10:![0-9]+]]
; CHECK:   [[I_STORAGE:%i.ascast.*]] = alloca i32 addrspace(1)*, align 8
; CHECK:   call void @llvm.dbg.declare(metadata i32 addrspace(1)** [[I_STORAGE]], metadata [[I_DIVAR:![0-9]+]], metadata !DIExpression(DW_OP_deref)), !dbg [[L39C8:![0-9]+]]
; CHECK:   %i.ascast.fpriv = alloca i32, !dbg [[L40C1:![0-9]+]]
; CHECK: }
;
...
; CHECK: [[EMPTY:![0-9]+]] = !{}
; CHECK: [[OFFLOAD]] = distinct !DISubprogram(name: "_Z6vecaddv.DIR.OMP.TARGET.2.split.split.split.split", scope: [[FILE]], file: [[FILE]], line: 40, type: [[OFFLOAD_TYPE:![0-9]+]], scopeLine: 40, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: [[UNIT]], retainedNodes: [[EMPTY]])
; CHECK: [[OFFLOAD_TYPE]] = !DISubroutineType(types: [[EMPTY]])
; CHECK: [[V1_DIVAR]] = !DILocalVariable(name: "v1", arg: 1, scope: [[OFFLOAD]]
; CHECK: [[L36C17]] = !DILocation(line: 36, column: 17, scope: [[OFFLOAD]]
; CHECK: [[V2_DIVAR]] = !DILocalVariable(name: "v2", arg: 2, scope: [[OFFLOAD]]
; CHECK: [[L36C24]] = !DILocation(line: 36, column: 24, scope: [[OFFLOAD]]
; CHECK: [[V3_DIVAR]] = !DILocalVariable(name: "v3", arg: 3, scope: [[OFFLOAD]]
; CHECK: [[L36C10]] = !DILocation(line: 36, column: 10, scope: [[OFFLOAD]]
; CHECK: [[I_DIVAR]] = !DILocalVariable(name: "i", arg: 6, scope: [[OFFLOAD]]
; CHECK: [[L39C8]] = !DILocation(line: 39, column: 8, scope: [[OFFLOAD]]
; CHECK: [[L40C1]] = !DILocation(line: 40, column: 1, scope: [[OFFLOAD]])
;

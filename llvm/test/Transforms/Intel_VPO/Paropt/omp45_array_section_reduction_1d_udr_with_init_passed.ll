...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR:ARRSECT.PTR_TO_PTR.TYPED"(ptr %ypas.addr, %struct.my_struct zeroinitializer, i64 4, i64 5, ptr null, ptr @_ZTSA4_9my_struct.omp.destr, ptr @.omp_combiner., ptr @.omp_initializer.),
    "QUAL.OMP.NUM_THREADS"(i32 100),
    "QUAL.OMP.SHARED:TYPED"(ptr @_ZL1x_da7442f9a2797092788d9ca28d99f229, %struct.my_struct zeroinitializer, i64 100),
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_da7442f9a2797092788d9ca28d99f229, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_da7442f9a2797092788d9ca28d99f229, i64 0, i64 %idxprom
  ...
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_da7442f9a2797092788d9ca28d99f229, i64 0, i64 %idxprom1
  %b = getelementptr inbounds %struct.my_struct, ptr %arrayidx2, i32 0, i32 1
  store i32 %mul, ptr %b, align 4
  %6 = load i32, ptr %i, align 4
  %idxprom3 = sext i32 %6 to i64
  %arrayidx4 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1y_da7442f9a2797092788d9ca28d99f229, i64 0, i64 %idxprom3
  %a5 = getelementptr inbounds %struct.my_struct, ptr %arrayidx4, i32 0, i32 0
  store i32 0, ptr %a5, align 8
  %7 = load i32, ptr %i, align 4
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1y_da7442f9a2797092788d9ca28d99f229, i64 0, i64 %idxprom6
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_f_pasP9my_struct(ptr @_ZL1y_da7442f9a2797092788d9ca28d99f229)
  ret i32 0
}

; RUN: opt -bugpoint-enable-legacy-pm -S -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt 2>&1 %s
...
; CHECK:   call void @llvm.dbg.declare(metadata ptr %i2.ascast.priv, metadata [[I:![0-9]+]], metadata !DIExpression())
; CHECK-NOT:  call void @llvm.dbg.{{.*}}({{.*}}, metadata [[I]]
; CHECK:   store i32 0, ptr %i2.ascast.priv, align 4
; CHECK-NOT:  call void @llvm.dbg.{{.*}}({{.*}}, metadata [[I]]
; CHECK: }
...
define hidden void @main() !dbg !6 {
entry:
  %i2 = alloca i32, align 4
  %i2.ascast = addrspacecast ptr %i2 to ptr addrspace(4)
  br label %for.end

for.end:                                          ; preds = %entry
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i2.ascast, i32 0, i32 1) ], !dbg !10
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i2.ascast, i32 0, i32 1) ], !dbg !12
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  call void @llvm.dbg.declare(metadata ptr addrspace(4) %i2.ascast, metadata !14, metadata !DIExpression()), !dbg !15
  store i32 0, ptr addrspace(4) %i2.ascast, align 4
  br label %omp.inner.for.cond
...
!2 = !{}
!3 = !{i32 0, i32 2065, i32 21976446, !"_Z4main", i32 14, i32 0, i32 0}
!4 = !{i32 7, !"Dwarf Version", i32 4}
!5 = !{i32 2, !"Debug Info Version", i32 3}
!6 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 5, type: !7, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!7 = !DISubroutineType(types: !8)
!8 = !{!9}
!9 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!10 = !DILocation(line: 21, column: 1, scope: !11)
!11 = distinct !DILexicalBlock(scope: !6, file: !1, line: 21, column: 1)
!12 = !DILocation(line: 22, column: 1, scope: !13)
!13 = distinct !DILexicalBlock(scope: !6, file: !1, line: 22, column: 1)
!14 = !DILocalVariable(name: "i", scope: !6, file: !1, line: 15, type: !9)
!15 = !DILocation(line: 15, column: 12, scope: !6)

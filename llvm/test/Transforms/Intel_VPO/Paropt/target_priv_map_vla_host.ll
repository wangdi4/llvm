...
; CHECK: @.offload_maptypes = private unnamed_addr constant [3 x i64] [i64 160, i64 288, i64 288]
...
; CHECK: define internal void @__omp_offloading{{.*}}main{{.*}}(ptr noalias %vla, i64 [[SIZE_ARG]], i64 [[SIZE_ARG1]])
...
entry:
  ...
  %dir = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TO"(ptr %vla, ptr %vla, i64 %map.size, i64 160, i8* null, i8* null) ]

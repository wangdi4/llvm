...
entry:
  ...
  store ptr @_ZL1y_6a7269ab6e93a4e3ddfa7e54961f4dc9, ptr %yptr, align 8
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    ...
    "QUAL.OMP.SHARED:TYPED"(ptr @_ZL1x_6a7269ab6e93a4e3ddfa7e54961f4dc9, %struct.my_struct zeroinitializer, i64 100) ]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx4 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom3
  call void @_Z6my_addR9my_structRKS_(ptr dereferenceable(8) %arrayidx2, ptr dereferenceable(8) %arrayidx4) #2
  br label %for.inc
...
; Function Attrs: noinline uwtable
define internal void @_ZTSA1_A4_9my_struct.omp.destr(ptr %0) #3 section ".text.startup" {
entry:
  %.addr = alloca ptr, align 8
  store ptr %0, ptr %.addr, align 8
  ret void
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom
  ...
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom1
  %b = getelementptr inbounds %struct.my_struct, ptr %arrayidx2, i32 0, i32 1
  store i32 %mul, ptr %b, align 4
  %6 = load i32, ptr %i, align 4
  %idxprom3 = sext i32 %6 to i64
  %arrayidx4 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1y_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom3
  %a5 = getelementptr inbounds %struct.my_struct, ptr %arrayidx4, i32 0, i32 0
  store i32 0, ptr %a5, align 8
  %7 = load i32, ptr %i, align 4
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1y_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom6

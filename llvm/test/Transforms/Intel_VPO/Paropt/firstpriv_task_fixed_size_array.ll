...
; ModuleID = 'firstpriv_task_fixed_size_array.cpp'
source_filename = "firstpriv_task_fixed_size_array.cpp"
...
arrayctor.cont:                                   ; preds = %arrayctor.loop
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.FIRSTPRIVATE:NONPOD"([100 x %class.A]* %e, void (%class.A*, %class.A*)* @_ZTS1A.omp.copy_constr, void (%class.A*)* @_ZTS1A.omp.destr), "QUAL.OMP.PRIVATE"(i32* %d) ]
  store i32 0, i32* %d, align 4
  br label %for.cond

; Copy Constructor
; CHECK:  %[[TO:[^,]+]] = getelementptr inbounds [100 x %class.A], [100 x %class.A]* %e.priv.gep, i32 0, i32 0
; CHECK-NEXT:  %[[FROM:[^,]+]] = getelementptr inbounds [100 x %class.A], [100 x %class.A]* %e, i32 0, i32 0
...
; Destructor
; CHECK:  %[[DESTR_BEGIN:[^,]+]] = getelementptr inbounds [100 x %class.A], [100 x %class.A]* %{{.*}}, i32 0, i32 0

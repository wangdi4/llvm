...
; This test checks that the "loop" construct is mapped to "parallel.loop"
; after prepare pass.
...
entry:
  ...
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.DISTRIBUTE"(), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.PRIVATE"(i32* %.omp.lb3), "QUAL.OMP.PRIVATE"(i32* %.omp.ub4), "QUAL.OMP.PRIVATE"(i32* %j), "QUAL.OMP.PRIVATE"(i32* %tmp2) ]
...
; CHECK: call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.NORMALIZED.IV"({{.*}}), "QUAL.OMP.NORMALIZED.UB"({{.*}}), "QUAL.OMP.PRIVATE"({{.*}}) ]

  %12 = call token @llvm.directive.region.entry() [ "DIR.OMP.GENERICLOOP"(), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv1), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub4), "QUAL.OMP.PRIVATE"(i32* %j) ]
  %13 = load i32, i32* %.omp.lb3, align 4, !tbaa !2
  store i32 %13, i32* %.omp.iv1, align 4, !tbaa !2
  br label %omp.inner.for.cond5

omp.inner.for.cond5:                              ; preds = %omp.inner.for.inc, %omp.inner.for.body
  %14 = load i32, i32* %.omp.iv1, align 4, !tbaa !2
...
omp.inner.for.body7:                              ; preds = %omp.inner.for.cond5
  ...
  %17 = load i32, i32* %.omp.iv1, align 4, !tbaa !2
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %23 = load i32, i32* %.omp.iv1, align 4, !tbaa !2
  %add12 = add nsw i32 %23, 1
  store i32 %add12, i32* %.omp.iv1, align 4, !tbaa !2
  br label %omp.inner.for.cond5

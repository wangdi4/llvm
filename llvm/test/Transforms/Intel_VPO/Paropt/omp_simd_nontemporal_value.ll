...
entry:
  ...
  store i32 %size, ptr %size.addr, align 4, !tbaa !10
  call void @llvm.lifetime.start.p0(i64 4, ptr %.capture_expr.0) #2
  %0 = load i32, ptr %size.addr, align 4, !tbaa !10
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %add.ptr = getelementptr inbounds float, ptr %8, i64 %idx.ext, !intel-tbaa !12
  %10 = load ptr, ptr %b.addr, align 8, !tbaa !8
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %12 = load i32, ptr %.omp.iv, align 4, !tbaa !10
  %add5 = add nsw i32 %12, 1
  store i32 %add5, ptr %.omp.iv, align 4, !tbaa !10

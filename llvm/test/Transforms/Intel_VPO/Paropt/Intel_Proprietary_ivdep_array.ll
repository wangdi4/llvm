...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %AAA)
  call void @llvm.lifetime.start.p0(i64 4, ptr %i)
  %0 = call token @llvm.directive.region.entry() [ "DIR.PRAGMA.IVDEP"(),
    "QUAL.PRAGMA.ARRAY"(ptr %AAA, i32 -1) ]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [10 x i32], ptr %AAA, i64 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr %AAA)
  ret void
}

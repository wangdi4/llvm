...
DIR.OMP.TARGET.1:                                 ; preds = %entry
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.FIRSTPRIVATE"(i32* %n.addr) ]
  %1 = load i32, i32* %n.addr, align 4, !tbaa !2
  br label %DIR.OMP.TEAMS.3

DIR.OMP.TEAMS.3:                                  ; preds = %DIR.OMP.TARGET.1
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(), "QUAL.OMP.NUM_TEAMS"(i32* %n.addr) ]
  call void @_Z3barv()

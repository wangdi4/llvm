...
define hidden spir_func void @test5(ptr addrspace(4) %X) {
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %mul = mul nsw i32 %7, 1
  %X_addr = load ptr addrspace(4), ptr addrspace(4) %X.map.ptr.tmp.ascast, align 8
  %pref_addr = getelementptr inbounds i32, ptr addrspace(4) %X_addr, i32 %7
  call void @llvm.prefetch(ptr addrspace(4) %pref_addr, i32 1, i32 0, i32 1)
  call void @__builtin_spirv_OpenCL_prefetch_p1i32_i32(ptr addrspace(4) %pref_addr, i32 1)
  call void @__builtin_IB_lsc_prefetch_global_uint(ptr addrspace(4) %pref_addr, i32 0, i32 0)
...
declare void @llvm.prefetch(ptr addrspace(4), i32, i32, i32)
declare void @__builtin_spirv_OpenCL_prefetch_p1i32_i32(ptr addrspace(4), i32)
declare void @__builtin_IB_lsc_prefetch_global_uint(ptr addrspace(4), i32, i32)

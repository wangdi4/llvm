...
define hidden spir_func void @test2(ptr addrspace(4) %X) {
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %12 = call token @llvm.directive.region.entry() [ "DIR.OMP.DISTRIBUTE.PARLOOP"(),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %X.map.ptr.tmp.ascast, ptr addrspace(4) null, i32 1),
  ...
  %13 = load i32, ptr addrspace(4) %.omp.lb4.ascast, align 4
  store i32 %13, ptr addrspace(4) %.omp.iv3.ascast, align 4
...
omp.inner.for.cond6:                              ; preds = %omp.inner.for.inc15, %omp.loop.exit
  ...
  %15 = load i32, ptr addrspace(4) %.omp.ub5.ascast, align 4
...
omp.inner.for.body8:                              ; preds = %omp.inner.for.cond6
  ...
  %17 = load ptr addrspace(4), ptr addrspace(4) %X.map.ptr.tmp.ascast, align 8
  %18 = load i32, ptr addrspace(4) %I9.ascast, align 4
  %idxprom12 = sext i32 %18 to i64
  %arrayidx13 = getelementptr inbounds i32, ptr addrspace(4) %17, i64 %idxprom12
  call spir_func void @foo(ptr addrspace(4) %arrayidx13)
...
omp.inner.for.inc15:                              ; preds = %omp.body.continue14
  %19 = load i32, ptr addrspace(4) %.omp.iv3.ascast, align 4
  %add16 = add nsw i32 %19, 1
  store i32 %add16, ptr addrspace(4) %.omp.iv3.ascast, align 4
  br label %omp.inner.for.cond6
...
declare spir_func void @foo(ptr addrspace(4))

!omp_offload.info = !{!0}

!0 = !{i32 0, i32 135, i32 -698919931, !"_Z5test2", i32 16, i32 0, i32 0}

...
; CHECK: %[[RED:[^,]+]] = load i8, ptr %v3.fast_red, align 1
; CHECK-NEXT: %[[ORIG:[^,]+]] = load i8, ptr %v3, align 1
...
; CHECK-NEXT: store i8 %[[EXT]], ptr %v3, align 1
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.AND:TYPED"(ptr %v3, i8 0, i32 1),

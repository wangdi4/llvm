...
; }
;
; Check that paropt inserts barriers after 'omp parallel for' constructs.
;
; CHECK-COUNT-2: call spir_func void @_Z22__spirv_ControlBarrieriii(i32 2, i32 2, i32 784)

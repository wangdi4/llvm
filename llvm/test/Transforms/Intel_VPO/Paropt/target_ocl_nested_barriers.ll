; RUN: opt -opaque-pointers=0 -enable-new-pm=0 -xmain-opt-level=0 -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-loop-collapse -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt-optimize-data-sharing -vpo-paropt -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-O0
; RUN: opt -opaque-pointers=0 -enable-new-pm=0 -xmain-opt-level=2 -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-loop-collapse -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt-optimize-data-sharing -vpo-paropt -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-O2
...
; CHECK-O2-COUNT-1: call spir_func void @_Z22__spirv_ControlBarrieriii(i32 2, i32 2, i32 784)
;
...
entry:
  ...
  store i32 %2, i32 addrspace(4)* %.omp.ub.ascast, align 4
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 1), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.lb.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %e.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.capture_expr.2.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv7.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.lb8.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.ub9.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %i.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv17.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.lb18.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.ub19.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %i23.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp6.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp16.ascast) ]
  %4 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv.ascast), "QUAL.OMP.SHARED"(i32 addrspace(4)* %.omp.lb.ascast), "QUAL.OMP.SHARED"(i32 addrspace(4)* %.omp.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %e.ascast), "QUAL.OMP.SHARED"(i32 addrspace(4)* %.capture_expr.2.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv7.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.lb8.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.ub9.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %i.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv17.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.lb18.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.ub19.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %i23.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp6.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp16.ascast) ]
...
!1 = !{i32 0, i32 53, i32 -685397249, !"_Z18test_dist_schedule", i32 12, i32 1, i32 0}

...
; Check that paropt pass annotates store to A with nontemporal metadata if a
; dope vector is not referenced through a GEP.
...
omp.pdo.body5:  ; preds = %omp.pdo.cond4
  ...
  %"ntscale_$A.1.addr_a0$_fetch.19" = load ptr, ptr %"ntscale_$A.1", align 1

...
; Test src:
;
;void foo(long long int n, long long int m)
;{
...
; HST: [[TMP3:%[0-9]+]] = load i64, ptr %.thread_limit.0, align 8
; HST: [[THREADLIMIT0:%[0-9]+]] = trunc i64 [[TMP3]] to i32
; HST: call i32 @__tgt_target_teams(i64 %{{.*}}, ptr @{{.*}}Z3foo{{.*}}, i32 0, ptr null, ptr null, ptr null, ptr null, i32 0, i32 [[THREADLIMIT0]])

; HST: [[TMP11:%[0-9]*]] = load i64, ptr %.thread_limit.1, align 8
; HST: [[THREADLIMIT1:%[0-9]*]] = trunc i64 [[TMP11]] to i32
; HST: call i32 @__tgt_target_teams(i64 %{{.*}}, ptr @{{.*}}Z3foo{{.*}}, i32 0, ptr null, ptr null, ptr null, ptr null, i32 0, i32 [[THREADLIMIT1]])

; HST: [[TMP19:%[0-9]*]] = load i64, ptr %.thread_limit.2, align 8
; HST: [[THREADLIMIT2:%[0-9]*]] = trunc i64 [[TMP19]] to i32
; HST: call i32 @__tgt_target_teams(i64 %{{.*}}, ptr @{{.*}}Z3foo{{.*}}, i32 0, ptr null, ptr null, ptr null, ptr null, i32 0, i32 [[THREADLIMIT2]])

; HST: [[TMP27:%[0-9]*]] = load i64, ptr %.thread_limit.3, align 8
; HST: [[THREADLIMIT3:%[0-9]*]] = trunc i64 [[TMP27]] to i32
; HST: call i32 @__tgt_target_teams(i64 %{{.*}}, ptr @{{.*}}Z3foo{{.*}}, i32 0, ptr null, ptr null, ptr null, ptr null, i32 0, i32 [[THREADLIMIT3]])

; HST: [[TMP35:%[0-9]*]] = load i64, ptr %.thread_limit.4, align 8
; HST: [[THREADLIMIT4:%[0-9]*]] = trunc i64 [[TMP35]] to i32
; HST: call i32 @__tgt_target_teams(i64 %{{.*}}, ptr @{{.*}}Z3foo{{.*}}, i32 0, ptr null, ptr null, ptr null, ptr null, i32 0, i32 [[THREADLIMIT4]])

; HST: [[TMP43:%[0-9]*]] = load i64, ptr %.thread_limit.5, align 8
; HST: [[THREADLIMIT5:%[0-9]*]] = trunc i64 [[TMP43]] to i32
; HST: call i32 @__tgt_target_teams(i64 %{{.*}}, ptr @{{.*}}Z3foo{{.*}}, i32 0, ptr null, ptr null, ptr null, ptr null, i32 0, i32 [[THREADLIMIT5]])

; HST: [[TMP58:%[0-9]*]] = load i64, ptr %.thread_limit.6, align 8
; HST: [[THREADLIMIT6:%[0-9]*]] = trunc i64 [[TMP58]] to i32
; HST: call i32 @__tgt_target_teams(i64 %{{.*}}, ptr @{{.*}}Z3foo{{.*}}, i32 1, ptr %{{.*}}, ptr %{{.*}}, ptr {{.*}}, ptr {{.*}}, i32 0, i32 [[THREADLIMIT6]])
...
entry:
  ...
  store i64 %3, ptr %.thread_limit.1, align 8
  %4 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 1),
    "QUAL.OMP.THREAD_LIMIT:TYPED"(ptr %.thread_limit.1, i64 0),
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i64 %12, ptr %.thread_limit.2, align 8
  %13 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 2),
    "QUAL.OMP.THREAD_LIMIT:TYPED"(ptr %.thread_limit.2, i64 0),
...
omp.loop.exit16:                                  ; preds = %omp.inner.for.end15
  ...
  store i64 %21, ptr %.thread_limit.3, align 8
  %22 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 3),
    "QUAL.OMP.THREAD_LIMIT:TYPED"(ptr %.thread_limit.3, i64 0),
...
omp.loop.exit31:                                  ; preds = %omp.inner.for.end30
  ...
  store i64 %31, ptr %.thread_limit.4, align 8
  %32 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 4),
    "QUAL.OMP.THREAD_LIMIT:TYPED"(ptr %.thread_limit.4, i64 0),
...
omp.loop.exit46:                                  ; preds = %omp.inner.for.end45
  ...
  store i64 %40, ptr %.thread_limit.5, align 8
  %41 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 5),
    "QUAL.OMP.THREAD_LIMIT:TYPED"(ptr %.thread_limit.5, i64 0),
...
omp.loop.exit61:                                  ; preds = %omp.inner.for.end60
  ...
  store i64 %50, ptr %.thread_limit.6, align 8
  %51 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 6),
    "QUAL.OMP.THREAD_LIMIT:TYPED"(ptr %.thread_limit.6, i64 0),
...
!0 = !{i32 0, i32 66313, i32 229198015, !"_Z3foo", i32 4, i32 0, i32 0, i32 0}
!1 = !{i32 0, i32 66313, i32 229198015, !"_Z3foo", i32 6, i32 0, i32 1, i32 0}
!2 = !{i32 0, i32 66313, i32 229198015, !"_Z3foo", i32 9, i32 0, i32 2, i32 0}
!3 = !{i32 0, i32 66313, i32 229198015, !"_Z3foo", i32 12, i32 0, i32 3, i32 0}
!4 = !{i32 0, i32 66313, i32 229198015, !"_Z3foo", i32 15, i32 0, i32 4, i32 0}
!5 = !{i32 0, i32 66313, i32 229198015, !"_Z3foo", i32 18, i32 0, i32 5, i32 0}
!6 = !{i32 0, i32 66313, i32 229198015, !"_Z3foo", i32 21, i32 0, i32 6, i32 0}

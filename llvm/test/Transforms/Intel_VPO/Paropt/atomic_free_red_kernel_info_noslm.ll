...
; RUN: opt -opaque-pointers=1 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -vpo-paropt-atomic-free-reduction=false -vpo-paropt-atomic-free-reduction-slm=false -S %s | FileCheck -check-prefixes=CHECK_NOAF %s
; RUN: opt -opaque-pointers=1 -switch-to-offload -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -vpo-paropt-atomic-free-reduction=false -vpo-paropt-atomic-free-reduction-slm=false -S %s | FileCheck -check-prefixes=CHECK_NOAF %s
...
entry:
  ...
  %arrayidx = getelementptr inbounds [10 x i32], ptr addrspace(4) %res.ascast, i64 0, i64 0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.MAP.TOFROM"(ptr addrspace(4) %res.ascast, ptr addrspace(4) %arrayidx, i64 40, i64 35, ptr null, ptr null), ; MAP type: 35 = 0x23 = TARGET_PARAM (0x20) | FROM (0x2) | TO (0x1)
  ...
  %array.begin = getelementptr inbounds [10 x i32], ptr addrspace(4) %res.ascast, i32 0, i32 0
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %res.ascast, i32 0, i64 10),
  ...
  %3 = load i32, ptr addrspace(4) %.omp.lb.ascast, align 4  store i32 %3, ptr addrspace(4) %.omp.iv.ascast, align 4
...
omp.inner.for.body7:                              ; preds = %omp.inner.for.cond5
  ...
  store i32 %add10, ptr addrspace(4) %sum.ascast, align 4
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %arrayidx12 = getelementptr inbounds [10 x i32], ptr addrspace(4) %res.ascast, i64 0, i64 %idxprom
  store i32 %15, ptr addrspace(4) %arrayidx12, align 4
...
!0 = !{i32 0, i32 2050, i32 49111428, !"_Z4main", i32 6, i32 0, i32 0, i32 0}

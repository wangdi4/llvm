...
entry:
  ...
  store i64 1, i64* %v3, align 8
  store i32 0, i32* %.omp.lb, align 4
  store i32 2, i32* %.omp.ub, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.REDUCTION.AND"(i64* %v3), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub) ]

; CHECK-NOT: QUAL.OMP.REDUCTION.AND
; CHECK: %[[RED:[^,]+]] = load i64, i64* %v3.fast_red, align 8
; CHECK-NEXT: %[[ORIG:[^,]+]] = load i64, i64* %v3, align 8
...
; CHECK-NEXT: store i64 %[[EXT]], i64* %v3, align 8

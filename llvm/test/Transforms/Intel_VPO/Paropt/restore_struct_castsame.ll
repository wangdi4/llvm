...
; RESTR: "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr [[FCAST]],
; RESTR-NOT: alloca ptr
; RESTR-NOT: "QUAL.OMP.OPERAND.ADDR"
; RESTR: [[FRENAMED:%[a-zA-Z._0-9]+]] = bitcast ptr [[FCAST]] to ptr
; RESTR: call void @print_str(ptr [[FRENAMED]])
...
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr %tmpcast, %struct._FourChars zeroinitializer, i32 1),

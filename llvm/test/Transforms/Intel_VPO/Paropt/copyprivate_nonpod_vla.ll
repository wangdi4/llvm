...
; CHECK: %[[DST_BEGIN:.*]] = getelementptr inbounds %class.goo, ptr %[[DST]], i32 0
; CHECK: %[[SRC_BEGIN:.*]] = getelementptr inbounds %class.goo, ptr %[[SRC]], i32 0
; CHECK: %[[INDEX:.*]] = getelementptr %class.goo, ptr %[[DST_BEGIN]], i64 %[[SRC_SIZE]]

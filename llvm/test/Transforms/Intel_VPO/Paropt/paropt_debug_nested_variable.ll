...
; CHECK: call void @llvm.dbg.declare(metadata ptr %v.ascast.priv{{.*}}, metadata [[V_TEAMS:![0-9]+]], metadata !DIExpression()), !dbg !16
; CHECK: }
...
DIR.OMP.TARGET.ENTRY:                             ; preds = %entry
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.PRIVATE:WILOCAL.TYPED"(ptr addrspace(4) %v.ascast, i32 0, i32 1) ], !dbg !13
  br label %DIR.OMP.TEAMS.ENTRY

DIR.OMP.TEAMS.ENTRY:                              ; preds = %DIR.OMP.TARGET.ENTRY
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.NUM_TEAMS"(i32 1),
    "QUAL.OMP.PRIVATE:WILOCAL.TYPED"(ptr addrspace(4) %v.ascast, i32 0, i32 1) ], !dbg !15
  br label %KERNEL

KERNEL:                                           ; preds = %DIR.OMP.TEAMS.ENTRY
  call void @llvm.dbg.declare(metadata ptr addrspace(4) %v.ascast, metadata !17, metadata !DIExpression()), !dbg !19
  store i32 0, ptr addrspace(4) %v.ascast, align 4, !dbg !19

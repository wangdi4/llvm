; RUN: opt -enable-new-pm=0 -vpo-cfg-restructuring -vpo-paropt-prepare -S -o %t1.ll <%s
; RUN: opt -enable-new-pm=0 -early-cse -instcombine -vpo-restore-operands -S %t1.ll -o %t2.ll

...
; CHECK: define {{.*}} @_Z3fooPfx.DIR.OMP.PARALLEL.LOOP.{{[0-9]+}}.{{.*}}(ptr {{[^,]*}}, ptr {{[^,]*}}, ptr {{[^,]*}}, ptr {{[^,]*}}, ptr {{[^,]*}}, ptr {{[^,]*}})

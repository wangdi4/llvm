...
; is non-zero constant float point.
;
; #include <stdio.h>
; #include <omp.h>
; void foo ( )
; {
; #pragma omp task final(8.0)
;   {
;     if(omp_in_final()) {
;     printf("passed\n");
;     }
...
; ModuleID = 'task_final_constfp_nonzero.c'
source_filename = "task_final_constfp_nonzero.c"
...
entry:
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.FINAL"(double 8.000000e+00) ]

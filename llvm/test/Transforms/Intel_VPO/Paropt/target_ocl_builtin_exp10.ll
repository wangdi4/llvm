; RUN: opt < %s -switch-to-offload -vpo-cfg-restructuring -vpo-paropt -S | FileCheck %s
; RUN: opt < %s -switch-to-offload -passes='function(vpo-cfg-restructuring),vpo-paropt' -S | FileCheck %s
;

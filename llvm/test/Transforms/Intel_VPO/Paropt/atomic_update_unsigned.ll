...
entry:
  ...
  store fp128 %rhs, ptr %rhs.addr, align 16
; CHECK: call void @__kmpc_atomic_fixed1_div_fp
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.ATOMIC"(),
    "QUAL.OMP.UPDATE"() ]
  fence acquire
  %1 = load fp128, ptr %rhs.addr, align 16
  %2 = load i8, ptr @i1, align 1
...
; CHECK: call void @__kmpc_atomic_fixed1u_div_fp
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.ATOMIC"(),
    "QUAL.OMP.UPDATE"() ]
  fence acquire
  %4 = load fp128, ptr %rhs.addr, align 16
  %5 = load i8, ptr @u1, align 1
...
; CHECK: call void @__kmpc_atomic_fixed2_div_fp
  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.ATOMIC"(),
    "QUAL.OMP.UPDATE"() ]
  fence acquire
  %7 = load fp128, ptr %rhs.addr, align 16
  %8 = load i16, ptr @i2, align 2
...
; CHECK: call void @__kmpc_atomic_fixed2u_div_fp
  %9 = call token @llvm.directive.region.entry() [ "DIR.OMP.ATOMIC"(),
    "QUAL.OMP.UPDATE"() ]
  fence acquire
  %10 = load fp128, ptr %rhs.addr, align 16
  %11 = load i16, ptr @u2, align 2
...
; CHECK: call void @__kmpc_atomic_fixed4_div_fp
  %12 = call token @llvm.directive.region.entry() [ "DIR.OMP.ATOMIC"(),
    "QUAL.OMP.UPDATE"() ]
  fence acquire
  %13 = load fp128, ptr %rhs.addr, align 16
  %14 = load i32, ptr @i4, align 4
...
; CHECK: call void @__kmpc_atomic_fixed4u_div_fp
  %15 = call token @llvm.directive.region.entry() [ "DIR.OMP.ATOMIC"(),
    "QUAL.OMP.UPDATE"() ]
  fence acquire
  %16 = load fp128, ptr %rhs.addr, align 16
  %17 = load i32, ptr @u4, align 4
...
; CHECK: call void @__kmpc_atomic_fixed2_shr
  ...
  store i16 %conv11, ptr @i2, align 2
  fence release
  call void @llvm.directive.region.exit(token %6) [ "DIR.OMP.END.ATOMIC"() ]
; CHECK: call void @__kmpc_atomic_fixed2u_shr
  ...
  store i16 %conv16, ptr @u2, align 2
  fence release
  call void @llvm.directive.region.exit(token %9) [ "DIR.OMP.END.ATOMIC"() ]
; CHECK: call void @__kmpc_atomic_fixed4_shr
  ...
  store i32 %shr19, ptr @i4, align 4
  fence release
  call void @llvm.directive.region.exit(token %12) [ "DIR.OMP.END.ATOMIC"() ]
; CHECK: call void @__kmpc_atomic_fixed4u_shr
  ...
  store i32 %shr22, ptr @u4, align 4
  fence release
  call void @llvm.directive.region.exit(token %15) [ "DIR.OMP.END.ATOMIC"() ]
; CHECK: call void @__kmpc_atomic_fixed8_shr
  ...
  store i64 %shr24, ptr @i8, align 8
  fence release
  call void @llvm.directive.region.exit(token %18) [ "DIR.OMP.END.ATOMIC"() ]
; CHECK: call void @__kmpc_atomic_fixed8u_shr
  ...
  store i64 %shr26, ptr @u8, align 8
  fence release
  call void @llvm.directive.region.exit(token %21) [ "DIR.OMP.END.ATOMIC"() ]
  ret void
}

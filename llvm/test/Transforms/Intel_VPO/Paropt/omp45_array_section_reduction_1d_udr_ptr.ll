...
; ModuleID = 'omp45_array_section_reduction_1d_udr_ptr.cpp'
source_filename = "omp45_array_section_reduction_1d_udr_ptr.cpp"
...
entry:
  %yptr = alloca [100 x i16]*, align 8
  %tmp = alloca i32, align 4
  %.omp.iv = alloca i32, align 4
  %.omp.lb = alloca i32, align 4
  %.omp.ub = alloca i32, align 4
  %i = alloca i32, align 4
  store [100 x i16]* @_ZL1y_04ad2d3e2cff23fc26c501e82cae0492, [100 x i16]** %yptr, align 8
  store i32 0, i32* %.omp.lb, align 4
  store i32 99, i32* %.omp.ub, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.REDUCTION.UDR:ARRSECT"([100 x i16]** %yptr, i64 2, i64 0, i64 1, i64 1, i64 25, i64 25, i64 1, i8* null, i8* null, void (i16*, i16*)* @.omp_combiner., i8* null), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.SHARED"([100 x i16]* @_ZL1x_04ad2d3e2cff23fc26c501e82cae0492) ]
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %5 = load [100 x i16]*, [100 x i16]** %yptr, align 8
  %arrayidx = getelementptr inbounds [100 x i16], [100 x i16]* %5, i64 0
  %6 = load i32, i32* %i, align 4
  %div = sdiv i32 %6, 4
  %add1 = add nsw i32 25, %div
  %idxprom = sext i32 %add1 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], [100 x i16]* %arrayidx, i64 0, i64 %idxprom
  %7 = load i32, i32* %i, align 4
  %idxprom3 = sext i32 %7 to i64
  %arrayidx4 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_04ad2d3e2cff23fc26c501e82cae0492, i64 0, i64 %idxprom3
  call void @_Z6my_addRsRKs(i16* dereferenceable(2) %arrayidx2, i16* dereferenceable(2) %arrayidx4) #2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_04ad2d3e2cff23fc26c501e82cae0492, i64 0, i64 %idxprom
  store i16 1, i16* %arrayidx, align 2
  %2 = load i32, i32* %i, align 4
  %conv = trunc i32 %2 to i16
  %3 = load i32, i32* %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1y_04ad2d3e2cff23fc26c501e82cae0492, i64 0, i64 %idxprom1

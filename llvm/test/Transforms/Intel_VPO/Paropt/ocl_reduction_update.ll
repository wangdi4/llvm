; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -loop-rotate -vpo-cfg-restructuring -vpo-paropt-prepare -sroa -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -simplifycfg -switch-to-offload -S -vpo-paropt-enable-64bit-opencl-atomics=false -vpo-paropt-atomic-free-reduction=false %s | FileCheck %s
...
; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -loop-rotate -vpo-cfg-restructuring -vpo-paropt-prepare -sroa -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -simplifycfg -switch-to-offload -vpo-paropt-atomic-free-reduction=false -S %s | FileCheck %s
...
; CHECK-DAG: declare spir_func void @__kmpc_critical(ptr addrspace(4)) #[[ATTR0:[0-9]+]]
; CHECK-DAG: declare spir_func void @__kmpc_end_critical(ptr addrspace(4)) #[[ATTR0]]
...
entry:
  ...
  %red.ascast = addrspacecast ptr %red to ptr addrspace(4)
  %.omp.lb.ascast = addrspacecast ptr %.omp.lb to ptr addrspace(4)
  %.omp.ub.ascast = addrspacecast ptr %.omp.ub to ptr addrspace(4)
  %tmp.ascast = addrspacecast ptr %tmp to ptr addrspace(4)
  %.omp.iv.ascast = addrspacecast ptr %.omp.iv to ptr addrspace(4)
  %i.ascast = addrspacecast ptr %i to ptr addrspace(4)
  store double 0.000000e+00, ptr addrspace(4) %red.ascast, align 8
  store i32 0, ptr addrspace(4) %.omp.lb.ascast, align 4
  store i32 99, ptr addrspace(4) %.omp.ub.ascast, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.MAP.TOFROM"(ptr addrspace(4) %red.ascast, ptr addrspace(4) %red.ascast, i64 8, i64 547, ptr null, ptr null),
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.ADD:TYPED"(ptr addrspace(4) %red.ascast, double 0.000000e+00, i32 1),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %6 = load double, ptr addrspace(4) %red.ascast, align 8
  %add1 = fadd fast double %6, 7.000000e+00
  store double %add1, ptr addrspace(4) %red.ascast, align 8
...
!0 = !{i32 0, i32 53, i32 -1924411033, !"_Z3foo", i32 3, i32 0, i32 0}

; RUN: opt < %s -enable-new-pm=0 -vpo-cfg-restructuring -vpo-paropt  -S | FileCheck %s
; RUN: opt < %s -passes="function(loop-simplify,vpo-cfg-restructuring),vpo-paropt" -print-after-all  -S | FileCheck %s

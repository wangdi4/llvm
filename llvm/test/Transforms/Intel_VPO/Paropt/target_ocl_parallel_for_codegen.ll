...
entry:
  ...
  %8 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0), "QUAL.OMP.MAP.TOFROM"([10000 x i32] addrspace(4)* addrspacecast ([10000 x i32] addrspace(1)* @A to [10000 x i32] addrspace(4)*), [10000 x i32] addrspace(4)* addrspacecast ([10000 x i32] addrspace(1)* @A to [10000 x i32] addrspace(4)*), i64 40000, i64 35, i8* null, i8* null), "QUAL.OMP.MAP.TOFROM"([10000 x i32] addrspace(4)* addrspacecast ([10000 x i32] addrspace(1)* @B to [10000 x i32] addrspace(4)*), [10000 x i32] addrspace(4)* addrspacecast ([10000 x i32] addrspace(1)* @B to [10000 x i32] addrspace(4)*), i64 40000, i64 35, i8* null, i8* null), "QUAL.OMP.MAP.TOFROM"([10000 x i32] addrspace(4)* addrspacecast ([10000 x i32] addrspace(1)* @C to [10000 x i32] addrspace(4)*), [10000 x i32] addrspace(4)* addrspacecast ([10000 x i32] addrspace(1)* @C to [10000 x i32] addrspace(4)*), i64 40000, i64 35, i8* null, i8* null), "QUAL.OMP.MAP.TO"(i32 addrspace(4)* %0, i32 addrspace(4)* %0, i64 4, i64 33, i8* null, i8* null), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %1), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %4), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %5), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %6), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %7), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %2), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %3) ]

; RUN: opt -bugpoint-enable-legacy-pm -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -simplifycfg -vpo-paropt-use-mapper-api=false -S %s | FileCheck %s
; RUN: opt -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt,function(simplifycfg)' -vpo-paropt-use-mapper-api=false -S %s | FileCheck %s
;
...
; CHECK:   call void {{.*}}@__kmpc_fork_teams({{.+}}, i32 2, ptr [[TEAMS:@.+]], ptr %N.addr, ptr %B.addr)
; CHECK: }
;
; CHECK: define internal void [[TARGET_PARALLEL:@.+]](ptr %{{.+}}, ptr %{{.+}}) #{{[0-9]+}} {
...
; CHECK:   call i32 @omp_get_num_threads(), !range [[RANGE_1_MAX]]
; CHECK:   call i32 @omp_get_thread_num(), !range [[RANGE_0_MAX]]
; CHECK:   call void {{.*}}@__kmpc_fork_call({{.+}}, i32 0, ptr [[TARGET_PARALLEL]])
; CHECK: }

; CHECK: define internal void [[PARALLEL_FOR:@.+]](ptr %tid, ptr %bid, ptr %.capture_expr.0, i64 %.omp.lb22.val.zext, ptr %.omp.ub23) #{{[0-9]+}} {
...
; CHECK:   call i32 @__tgt_target({{.+}}, ptr [[TARGET]].region_id,
; CHECK: }
;
; CHECK: define internal void [[TEAMS]](ptr %tid, ptr %bid, ptr %N.addr, ptr %B.addr) #{{[0-9]+}} {
...
; CHECK:   call void {{.+}}@__kmpc_fork_call({{.+}}, i32 3, ptr [[PARALLEL_FOR]],
; CHECK: }
;
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    ...
    "QUAL.OMP.SHARED:TYPED"(ptr %B.addr, i32 0, i32 1),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(ptr %.omp.iv21, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr %.omp.lb22, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr %.omp.ub23, i32 0, i32 1),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(ptr %tmp12, i32 0, i32 1) ]

  %1 = load i32, ptr %N.addr, align 4
  store i32 %1, ptr %.capture_expr.3, align 4
  %2 = load i32, ptr %B.addr, align 4
  store i32 %2, ptr %.capture_expr.4, align 4
  %3 = load i32, ptr %.capture_expr.3, align 4
  %4 = load i32, ptr %.capture_expr.4, align 4
  %sub = sub nsw i32 0, %4
  %add = add nsw i32 %sub, 1
  %sub4 = sub nsw i32 %3, %add
  %5 = load i32, ptr %.capture_expr.4, align 4
  %div = sdiv i32 %sub4, %5
  %sub5 = sub nsw i32 %div, 1
  store i32 %sub5, ptr %.capture_expr.5, align 4
...
omp.precond.then:                                 ; preds = %entry
  ...
  %7 = load i32, ptr %.capture_expr.5, align 4
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %13 = load i32, ptr %.capture_expr.4, align 4
  ...
  store i32 %14, ptr %.capture_expr.0, align 4
  %15 = load i32, ptr %I, align 4
  %16 = load i32, ptr %B.addr, align 4
  %add13 = add nsw i32 %15, %16
  store i32 %add13, ptr %.capture_expr.1, align 4
  %17 = load i32, ptr %.capture_expr.1, align 4
  %18 = load i32, ptr %.capture_expr.0, align 4
  %sub14 = sub i32 %17, %18
  %sub15 = sub i32 %sub14, 1
  %add16 = add i32 %sub15, 1
  %div17 = udiv i32 %add16, 1
  %sub18 = sub i32 %div17, 1
  store i32 %sub18, ptr %.capture_expr.2, align 4
  %19 = load i32, ptr %.capture_expr.0, align 4
  %20 = load i32, ptr %.capture_expr.1, align 4
...
omp.precond.then20:                               ; preds = %omp.inner.for.body
  ...
  %21 = load i32, ptr %.capture_expr.2, align 4
  store i32 %21, ptr %.omp.ub23, align 4
  ...
  %23 = load i32, ptr %.omp.lb22, align 4
  store i32 %23, ptr %.omp.iv21, align 4
  br label %omp.inner.for.cond24

omp.inner.for.cond24:                             ; preds = %omp.inner.for.inc, %omp.precond.then20
  %24 = load i32, ptr %.omp.iv21, align 4
  %25 = load i32, ptr %.omp.ub23, align 4
  %add25 = add i32 %25, 1
...
omp.inner.for.body27:                             ; preds = %omp.inner.for.cond24
  %26 = load i32, ptr %.capture_expr.0, align 4
  %27 = load i32, ptr %.omp.iv21, align 4
  %mul28 = mul i32 %27, 1
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %30 = load i32, ptr %.omp.iv21, align 4
  %add42 = add nuw i32 %30, 1
  store i32 %add42, ptr %.omp.iv21, align 4
  br label %omp.inner.for.cond24
...
omp.inner.for.inc44:                              ; preds = %omp.body.continue43
  ...
  store i32 %add45, ptr %.omp.iv, align 4
  br label %omp.inner.for.cond

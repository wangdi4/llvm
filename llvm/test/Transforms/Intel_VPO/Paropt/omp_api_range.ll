; RUN: opt -enable-new-pm=0 -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -simplifycfg -vpo-paropt-use-mapper-api=false -S %s | FileCheck %s
...
; }
;
; CHECK: define void @test(i32 %N, i32 %B) #{{[0-9]+}} {
...
define void @test(i32 %N, i32 %B) #0 {
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(), "QUAL.OMP.NUM_TEAMS"(i32 400), "QUAL.OMP.THREAD_LIMIT"(i32 300), "QUAL.OMP.SHARED"(i32* %N.addr), "QUAL.OMP.SHARED"(i32* %B.addr), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.5), "QUAL.OMP.PRIVATE"(i32* %.omp.iv), "QUAL.OMP.PRIVATE"(i32* %.omp.lb), "QUAL.OMP.PRIVATE"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %I), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.3), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.4), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.2), "QUAL.OMP.PRIVATE"(i32* %.omp.iv21), "QUAL.OMP.PRIVATE"(i32* %.omp.lb22), "QUAL.OMP.PRIVATE"(i32* %.omp.ub23), "QUAL.OMP.PRIVATE"(i32* %J), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.0), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.1), "QUAL.OMP.PRIVATE"(i32* %tmp), "QUAL.OMP.PRIVATE"(i32* %tmp12) ]
...
omp.precond.then:                                 ; preds = %entry
  ...
  %8 = call token @llvm.directive.region.entry() [ "DIR.OMP.DISTRIBUTE"(), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %I), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.2), "QUAL.OMP.PRIVATE"(i32* %.omp.iv21), "QUAL.OMP.PRIVATE"(i32* %.omp.lb22), "QUAL.OMP.PRIVATE"(i32* %.omp.ub23), "QUAL.OMP.PRIVATE"(i32* %J), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.0), "QUAL.OMP.PRIVATE"(i32* %.capture_expr.1), "QUAL.OMP.PRIVATE"(i32* %tmp12) ]
...
omp.precond.then20:                               ; preds = %omp.inner.for.body
  ...
  %22 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.NUM_THREADS"(i32 200), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv21), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb22), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub23), "QUAL.OMP.PRIVATE"(i32* %J), "QUAL.OMP.SHARED"(i32* %.capture_expr.0) ]
...
omp.inner.for.body27:                             ; preds = %omp.inner.for.cond24
  ...
  %28 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0) ]
  ...
  %29 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.NUM_THREADS"(i32 100) ]

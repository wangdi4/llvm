; INTEL_CUSTOMIZATION
; RUN: opt -bugpoint-enable-legacy-pm -vpo-paropt-loop-collapse -S <%s | FileCheck %s
; RUN: opt -passes='function(vpo-paropt-loop-collapse)' -S <%s | FileCheck %s
;
...
; CHECK: [[UB1LOAD:%[^ ]+]] = load i32, ptr %omp.pdo.norm.ub
; CHECK: [[UB1SEXT:%[^ ]+]] = sext i32 [[UB1LOAD]] to i64
; CHECK: icmp slt i64 [[UB1SEXT]], 0

; CHECK: [[UB2LOAD:%[^ ]+]] = load i32, ptr %do.norm.ub
...
alloca_0:
  ...
  store ptr %"foo_$N$argptr", ptr %"foo_$N$locptr", align 1
  %"foo_$N.1" = load ptr, ptr %"foo_$N$locptr", align 1
  store ptr %"foo_$M$argptr", ptr %"foo_$M$locptr", align 1
  %"foo_$M.2" = load ptr, ptr %"foo_$M$locptr", align 1
  %do.start = alloca i32, align 4
  store i32 2, ptr %do.start, align 4
  %do.end = alloca i32, align 4
  %"foo_$M.2_fetch.13" = load i32, ptr %"foo_$M.2", align 1
  store i32 %"foo_$M.2_fetch.13", ptr %do.end, align 4
  ...
  %do.end_fetch.14 = load i32, ptr %do.end, align 4
  %do.start_fetch.15 = load i32, ptr %do.start, align 4
  %sub.2 = sub nsw i32 %do.end_fetch.14, %do.start_fetch.15
  %do.step_fetch.16 = load i32, ptr %do.step, align 4
  ...
  store i32 2, ptr %omp.pdo.start, align 4
  %omp.pdo.end = alloca i32, align 4
  %"foo_$N.1_fetch.3" = load i32, ptr %"foo_$N.1", align 1
  ...
  %omp.pdo.start_fetch.5 = load i32, ptr %omp.pdo.start, align 4
  %sub.1 = sub nsw i32 %omp.pdo.end_fetch.4, %omp.pdo.start_fetch.5
  %omp.pdo.step_fetch.6 = load i32, ptr %omp.pdo.step, align 4
...
DIR.OMP.PARALLEL.LOOP.1:                          ; preds = %bb_new6
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    ...
    "QUAL.OMP.SHARED:TYPED"(ptr %"foo_$M.2", i32 0, i64 1),
...
DIR.OMP.PARALLEL.LOOP.2:                          ; preds = %DIR.OMP.PARALLEL.LOOP.1
  %omp.pdo.norm.lb_fetch.7 = load i32, ptr %omp.pdo.norm.lb, align 4
  store i32 %omp.pdo.norm.lb_fetch.7, ptr %omp.pdo.norm.iv, align 4
...
omp.pdo.cond3:                                    ; preds = %do.epilog11, %DIR.OMP.PARALLEL.LOOP.2
  ...
  %omp.pdo.norm.ub_fetch.9 = load i32, ptr %omp.pdo.norm.ub, align 4
...
omp.pdo.body4:                                    ; preds = %omp.pdo.cond3
  %omp.pdo.norm.iv_fetch.10 = load i32, ptr %omp.pdo.norm.iv, align 4
  %omp.pdo.step_fetch.11 = load i32, ptr %omp.pdo.step, align 4
  %mul.1 = mul nsw i32 %omp.pdo.norm.iv_fetch.10, %omp.pdo.step_fetch.11
  %omp.pdo.start_fetch.12 = load i32, ptr %omp.pdo.start, align 4
  %add.1 = add nsw i32 %mul.1, %omp.pdo.start_fetch.12
  store i32 %add.1, ptr %"foo_$I", align 8
  %do.norm.lb_fetch.17 = load i32, ptr %do.norm.lb, align 4
  store i32 %do.norm.lb_fetch.17, ptr %do.norm.iv, align 4
  br label %do.cond9

do.cond9:                                         ; preds = %do.body10, %omp.pdo.body4
  %do.norm.iv_fetch.18 = load i32, ptr %do.norm.iv, align 4
  %do.norm.ub_fetch.19 = load i32, ptr %do.norm.ub, align 4
...
do.body10:                                        ; preds = %do.cond9
  %do.norm.iv_fetch.20 = load i32, ptr %do.norm.iv, align 4
  %do.step_fetch.21 = load i32, ptr %do.step, align 4
  %mul.2 = mul nsw i32 %do.norm.iv_fetch.20, %do.step_fetch.21
  %do.start_fetch.22 = load i32, ptr %do.start, align 4
  %add.2 = add nsw i32 %mul.2, %do.start_fetch.22
  store i32 %add.2, ptr %"foo_$J", align 8
  call void @bar_.void()
...
do.epilog11:                                      ; preds = %do.cond9
  %omp.pdo.norm.iv_fetch.24 = load i32, ptr %omp.pdo.norm.iv, align 4

; INTEL_CUSTOMIZATION
; RUN: opt -vpo-paropt-loop-collapse -S <%s | FileCheck %s
...
;        end subroutine foo
;
source_filename = "lit.f90"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: noinline nounwind optnone uwtable
define void @foo_(i32* noalias dereferenceable(4) %"foo_$N$argptr", i32* noalias dereferenceable(4) %"foo_$M$argptr") #0 {
alloca_0:
  %"$io_ctx" = alloca [8 x i64], align 8, !llfort.type_idx !1
  %"foo_$N$locptr" = alloca i32*, align 8
  %"foo_$M$locptr" = alloca i32*, align 8
  %"foo_$J" = alloca i32, align 8, !llfort.type_idx !2
  %"foo_$I" = alloca i32, align 8, !llfort.type_idx !3
...
; CHECK: icmp slt i64 [[UB2SEXT]], 0
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.COLLAPSE"(i32 2), "QUAL.OMP.SHARED"(i32* %"foo_$M.2"), "QUAL.OMP.SHARED"(i32* %"foo_$N.1"), "QUAL.OMP.PRIVATE"(i32* %"foo_$J"), "QUAL.OMP.PRIVATE"(i32* %"foo_$I"), "QUAL.OMP.SHARED"(i32* %do.step), "QUAL.OMP.SHARED"(i32* %do.start), "QUAL.OMP.SHARED"(i32* %omp.pdo.step), "QUAL.OMP.SHARED"(i32* %omp.pdo.start), "QUAL.OMP.FIRSTPRIVATE"(i32* %do.norm.lb), "QUAL.OMP.FIRSTPRIVATE"(i32* %omp.pdo.norm.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %omp.pdo.norm.iv, i32* %do.norm.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %omp.pdo.norm.ub, i32* %do.norm.ub) ]
...
do.body10:                                        ; preds = %do.cond9
  ...
  call void @bar_.void(), !llfort.type_idx !5
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @bar_.void() #2 {
wrap_start18:
  call void (...) @bar_()
  ret void
}

...
; ModuleID = 'omp45_array_reduction_1d_udr.cpp'
source_filename = "omp45_array_reduction_1d_udr.cpp"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z13cq415166_1d_bv() #1 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_ec586bddf7946ec5149ed0e0672a3784, i64 0, i64 %idxprom
  store i16 1, i16* %arrayidx, align 2
  %2 = load i32, i32* %i, align 4
  %conv = trunc i32 %2 to i16
  %3 = load i32, i32* %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1y_ec586bddf7946ec5149ed0e0672a3784, i64 0, i64 %idxprom1

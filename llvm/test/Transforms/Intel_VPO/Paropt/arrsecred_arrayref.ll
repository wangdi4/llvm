...
; }
;
; ModuleID = 'arrsecred_arrayref.cpp'
source_filename = "arrsecred_arrayref.cpp"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z19arrsecred_array_refRA3_A4_A5_i([3 x [4 x [5 x i32]]]* dereferenceable(240) %y_Arr_ref) #0 {
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.REDUCTION.ADD:BYREF.ARRSECT"([3 x [4 x [5 x i32]]]** %y_Arr_ref.addr, i64 3, i64 1, i64 1, i64 1, i64 2, i64 1, i64 1, i64 0, i64 5, i64 1), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.PRIVATE"(i32* %j), "QUAL.OMP.PRIVATE"(i32* %k) ]

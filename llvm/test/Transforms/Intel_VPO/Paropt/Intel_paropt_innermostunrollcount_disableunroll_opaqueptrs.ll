; RUN: opt -opaque-pointers=1 -passes='require<vpo-paropt-config-analysis>,function(vpo-cfg-restructuring,vpo-paropt-apply-config,vpo-paropt-prepare)' -vpo-paropt-innermost-loop-unroll-count=0 -switch-to-offload -S %s | FileCheck %s
; Check that the global option is applied correctly to disable unrolling
; Original code:
;int main()
;{

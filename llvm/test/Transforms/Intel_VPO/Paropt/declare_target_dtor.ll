...
; CHECK-DAG: @.omp_offloading.entry.{{.*}} = weak target_declare constant %struct.__tgt_offload_entry { i8* bitcast (void ()* @__omp_offloading__32_d79701d4_Var_l5_dtor to i8*), i8* {{.*}}, i32 0, i32 0), i64 0, i32 4, i32 0 }, section "omp_offloading_entries"

...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i.ascast, i32 0, i64 1),
    "QUAL.OMP.MAP.TOFROM"(ptr addrspace(4) %aaa.ascast, ptr addrspace(4) %aaa.ascast, i64 2, i64 35),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv.ascast, i32 0, i64 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.lb.ascast, i32 0, i64 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.ub.ascast, i32 0, i64 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp.ascast, i32 0, i64 1) ]

  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.NUM_THREADS"(i32 32),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %aaa.ascast, i16 0, i64 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i.ascast, i32 0, i64 1),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  fence acquire
  %7 = load i16, ptr addrspace(4) %aaa.ascast, align 2
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %9 = load i16, ptr addrspace(4) %aaa.ascast, align 2
  %conv4 = sext i16 %9 to i32
  %call = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str to ptr addrspace(4)), i32 %conv4)
  ret i32 0
}

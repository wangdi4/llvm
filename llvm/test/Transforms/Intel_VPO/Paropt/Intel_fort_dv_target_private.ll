...
bb31:                                             ; preds = %alloca
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TO"(ptr %A, ptr %A, i64 72, i64 33), ; MAP type: 33 = 0x21 = TARGET_PARAM (0x20) | TO (0x1)
    "QUAL.OMP.PRIVATE:F90_DV.TYPED"(ptr %A, %"QNCA_a0$i32*$rank1$.0" zeroinitializer, i32 0) ]

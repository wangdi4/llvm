; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -mtriple=i686-unknown-linux-gnu -vpo-paropt-fast-reduction=false -S %s | FileCheck %s -check-prefix=CRITICAL -check-prefix=ALL
...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -mtriple=x86_64-unknown-linux-gnu -vpo-paropt-fast-reduction=false -S %s | FileCheck %s -check-prefix=CRITICAL -check-prefix=ALL
...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -mtriple=i686-unknown-linux-gnu -S %s | FileCheck %s -check-prefix=FASTRED -check-prefix=ALL
...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -mtriple=x86_64-unknown-linux-gnu -S %s | FileCheck %s -check-prefix=FASTRED -check-prefix=ALL

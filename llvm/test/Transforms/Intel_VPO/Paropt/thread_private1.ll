...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -vpo-paropt-tpv -S -opt-bisect-limit=0 %s | FileCheck %s
; RUN: opt -opaque-pointers=0 -passes=vpo-paropt-tpv -S -opt-bisect-limit=0 %s | FileCheck %s

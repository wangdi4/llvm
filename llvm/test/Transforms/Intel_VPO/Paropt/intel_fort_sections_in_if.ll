...
define void @ouitra_(ptr %"ouitra_$WT", ptr %"ouitra_$YTF", ptr %"ouitra_$NTLEV", ptr %"ouitra_$NX2P1", ptr %"ouitra_$NX1P1", ptr %"ouitra_$NTL2", ptr %"ouitra_$NX3") {
alloca_0:
...
bb_new4:                                          ; preds = %DIR.OMP.PARALLEL.9
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SECTIONS"(),
    "QUAL.OMP.PRIVATE:TYPED"(ptr undef, i32 0, i64 1) ]
...
DIR.OMP.PARALLEL.9:                               ; preds = %alloca_0
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.SHARED"(ptr %"ouitra_$NX1P1"),
    "QUAL.OMP.SHARED"(ptr %"ouitra_$NX2P1"),
    "QUAL.OMP.SHARED"(ptr %"ouitra_$YTF"),
    "QUAL.OMP.SHARED"(ptr %"ouitra_$NTL2"),
    "QUAL.OMP.SHARED"(ptr %"ouitra_$NTLEV"),
    "QUAL.OMP.SHARED"(ptr %"ouitra_$WT"),
    "QUAL.OMP.SHARED"(ptr %"ouitra_$NX3"),
    "QUAL.OMP.PRIVATE:TYPED"(ptr undef, i32 0, i64 1) ]
  br label %bb_new4

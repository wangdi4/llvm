...
entry:
  ...
  call void @llvm.memset.p0i8.i64(ptr align 4 %maxp, i8 0, i64 8, i1 false)
...
for.end:                                          ; preds = %for.cond
  ...
  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR:TYPED"(ptr %maxp, %struct.point zeroinitializer, i32 1, ptr null, ptr @_ZTS5point.omp.destr, ptr @.omp_combiner., ptr null),
...
; CRITICAL: call void @llvm.memset.{{.*}}(ptr align 4 %maxp, i8 0, i64 8, i1 false)
; CRITICAL: call void @__kmpc_critical({{.*}})
; CRITICAL: call void @.omp_combiner.(ptr %maxp, ptr %maxp.red{{.*}})
...
; FASTRED: call void @llvm.memset.{{.*}}(ptr align 4 %maxp, i8 0, i64 8, i1 false)
; FASTRED: call i32 @__kmpc_reduce({{.*}})
; FASTRED-DAG: call void @.omp_combiner.(ptr %maxp, ptr %maxp.fast_red{{.*}})
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  call void @maxproc(ptr %maxp, ptr %arrayidx5) #3
...
; Function Attrs: noinline nounwind uwtable
define internal void @_ZTS5point.omp.destr(ptr %0) #4 section ".text.startup" {
entry:
  %.addr = alloca ptr, align 8
  store ptr %0, ptr %.addr, align 8
  ret void

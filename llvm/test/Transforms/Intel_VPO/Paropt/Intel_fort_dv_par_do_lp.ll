...
; RUN: opt -passes='function(vpo-cfg-restructuring,loop-simplify,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -vpo-paropt-parameter-homing=false -S < %s  | FileCheck %s
...
alloca:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.PRIVATE"(i32* %"foo_$I"), "QUAL.OMP.LASTPRIVATE:F90_DV"({ i16*, i64, i64, i64, i64, i64, [3 x { i64, i64, i64 }] }* %"foo_$A"), "QUAL.OMP.NORMALIZED.IV"(i32* %temp2), "QUAL.OMP.NORMALIZED.UB"(i32* %temp4), "QUAL.OMP.FIRSTPRIVATE"(i32* %temp) ]

...
; Check that we created a typed Firstprivate clause for NormalizedUB var
; CHECK: addFirstprivateForNormalizedUB: Created Firstprivate Clause for NormalizedUB Var:   %.omp.ub = alloca i32, align 4
; CHECK: define internal void @foo.DIR.OMP.TASKLOOP{{.*}}(i32 %tid, ptr %taskt.withprivates)

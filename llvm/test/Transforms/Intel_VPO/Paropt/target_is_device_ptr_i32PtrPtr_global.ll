...
; This test is similar to target_is_device_ptr_i32PtrPtr.ll, with the difference that the
; is_device_ptr operand is a global.
...
@ap = dso_local global i32* null, align 8

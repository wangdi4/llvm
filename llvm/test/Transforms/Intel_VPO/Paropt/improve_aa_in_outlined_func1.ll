; RUN: opt -vpo-cfg-restructuring -vpo-paropt -basic-aa -scoped-noalias-aa -aa-eval -evaluate-aa-metadata -print-all-alias-modref-info -disable-output -vpo-paropt-parameter-homing=false %s 2>&1 | FileCheck %s
;

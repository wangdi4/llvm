...
omp.pdo.body5:  ; preds = %omp.pdo.cond4
  ...
  call void @bar_.t0p(i32* %"test_$I"), !llfort.type_idx !10
  %omp.pdo.norm.iv_fetch.11 = load i32, i32* %omp.pdo.norm.iv, align 4, !tbaa !5
  %add.3 = add nsw i32 %omp.pdo.norm.iv_fetch.11, 1
  store i32 %add.3, i32* %omp.pdo.norm.iv, align 4, !tbaa !5
  br label %omp.pdo.cond4

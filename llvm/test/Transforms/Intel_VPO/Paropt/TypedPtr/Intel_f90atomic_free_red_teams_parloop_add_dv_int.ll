...
DIR.OMP.TARGET:                                 ; preds = %alloca_0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %"ascastB$val", i32 addrspace(4)* %"ascastB$val", i64 4, i64 547, i8 addrspace(4)* null, i8 addrspace(4)* null),
    "QUAL.OMP.MAP.TOFROM"(%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* addrspacecast (%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(1)* @"_unnamed_main$$_$FA2D" to %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)*), %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* addrspacecast (%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(1)* @"_unnamed_main$$_$FA2D" to %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)*), i64 96, i64 32, i8 addrspace(4)* null, i8 addrspace(4)* null),
    "QUAL.OMP.MAP.TOFROM:CHAIN"(%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* addrspacecast (%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(1)* @"_unnamed_main$$_$FA2D" to %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)*), double addrspace(4)* %fetch.1, i64 %mul.2, i64 562949953421843, i8 addrspace(4)* null, i8 addrspace(4)* null),
    "QUAL.OMP.MAP.TOFROM:CHAIN"(%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* addrspacecast (%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(1)* @"_unnamed_main$$_$FA2D" to %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)*), i64 addrspace(4)* getelementptr inbounds (%"QNCA_a0$double addrspace(4)*$rank2$", %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* addrspacecast (%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(1)* @"_unnamed_main$$_$FA2D" to %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)*), i32 0, i32 1), i64 88, i64 562949953421313, i8 addrspace(4)* null, i8 addrspace(4)* null) ]

  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.REDUCTION.ADD:F90_DV"(%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* addrspacecast (%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(1)* @"_unnamed_main$$_$FA2D" to %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)*)),
    "QUAL.OMP.REDUCTION.ADD"(i32 addrspace(4)* %"ascastB$val") ]

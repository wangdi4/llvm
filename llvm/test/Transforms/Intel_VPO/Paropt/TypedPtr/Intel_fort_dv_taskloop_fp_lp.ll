...
define void @foo_({ i16*, i64, i64, i64, i64, i64, [3 x { i64, i64, i64 }] }* %"foo_$A") {
alloca:
...
; CHECK: call void @_f90_firstprivate_copy(i8* [[FOO_A_PRIV2_CAST]], i8* [[FOO_A_CAST1]])
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASKLOOP"(),
    ...
    "QUAL.OMP.LASTPRIVATE:F90_DV"({ i16*, i64, i64, i64, i64, i64, [3 x { i64, i64, i64 }] }* %"foo_$A"),
    "QUAL.OMP.FIRSTPRIVATE:F90_DV"({ i16*, i64, i64, i64, i64, i64, [3 x { i64, i64, i64 }] }* %"foo_$A"),
    "QUAL.OMP.NORMALIZED.IV"(i32* %temp2),
    "QUAL.OMP.NORMALIZED.UB"(i32* %temp4),
    "QUAL.OMP.FIRSTPRIVATE"(i32* %temp) ]

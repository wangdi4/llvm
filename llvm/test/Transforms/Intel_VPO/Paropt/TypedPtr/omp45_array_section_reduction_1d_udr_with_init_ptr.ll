...
; ModuleID = 'omp45_array_section_reduction_1d_udr_with_init_ptr.cpp'
source_filename = "omp45_array_section_reduction_1d_udr_with_init_ptr.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.my_struct = type { i32, i32 }

@_ZL1y_6a7269ab6e93a4e3ddfa7e54961f4dc9 = internal global [100 x %struct.my_struct] zeroinitializer, align 16
@_ZL1x_6a7269ab6e93a4e3ddfa7e54961f4dc9 = internal global [100 x %struct.my_struct] zeroinitializer, align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z17cq415166_1d_f_ptrv() #1 {
entry:
  ...
  store [100 x %struct.my_struct]* @_ZL1y_6a7269ab6e93a4e3ddfa7e54961f4dc9, [100 x %struct.my_struct]** %yptr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx4 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom3
  call void @_Z6my_addR9my_structRKS_(%struct.my_struct* dereferenceable(8) %arrayidx2, %struct.my_struct* dereferenceable(8) %arrayidx4) #2
  br label %for.inc
...
; Function Attrs: noinline uwtable
define internal void @_ZTSA1_A4_9my_struct.omp.destr([1 x [4 x %struct.my_struct]]* %0) #3 section ".text.startup" {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom
  ...
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom1
  %b = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx2, i32 0, i32 1
  store i32 %mul, i32* %b, align 4
  %6 = load i32, i32* %i, align 4
  %idxprom3 = sext i32 %6 to i64
  %arrayidx4 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom3
  %a5 = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx4, i32 0, i32 0
  store i32 0, i32* %a5, align 8
  %7 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_6a7269ab6e93a4e3ddfa7e54961f4dc9, i64 0, i64 %idxprom6
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_f_ptrv()
  ret i32 0
}

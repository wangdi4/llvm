...
entry:
  ...
  %ptridx = getelementptr inbounds i32, i32 addrspace(4)* %3, i64 1
  %4 = load i32, i32 addrspace(4)* %ptridx, align 4
  %add = add nsw i32 %4, 1
  %5 = load i32 addrspace(4)*, i32 addrspace(4)* addrspace(4)* %x.addr.ascast, align 8
  %ptridx1 = getelementptr inbounds i32, i32 addrspace(4)* %5, i64 1
  ...
  %7 = load i32 addrspace(4)*, i32 addrspace(4)* addrspace(4)* %x.addr.ascast, align 8
  %ptridx2 = getelementptr inbounds i32, i32 addrspace(4)* %7, i64 2
  %8 = load i32, i32 addrspace(4)* %ptridx2, align 4
  %add3 = add nsw i32 %8, 1
  %9 = load i32 addrspace(4)*, i32 addrspace(4)* addrspace(4)* %x.addr.ascast, align 8
  %ptridx4 = getelementptr inbounds i32, i32 addrspace(4)* %9, i64 2

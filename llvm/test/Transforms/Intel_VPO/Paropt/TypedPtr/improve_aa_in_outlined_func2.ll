...
; RUN: opt -opaque-pointers=0 -passes='function(vpo-cfg-restructuring),vpo-paropt' -aa-pipeline=tbaa %s | opt -disable-output -aa-pipeline="scoped-noalias-aa" -passes="aa-eval" -evaluate-aa-metadata -print-no-aliases 2>&1 | FileCheck %s

; RUN: opt -opaque-pointers=0 -passes="hir-ssa-deconstruction,hir-vec-dir-insert,hir-vplan-vec" -S %s | FileCheck %s
...
bb5:                                              ; preds = %bb4
  ...
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.PRIVATE"(i32* %"_unnamed_main$$_$I"),
    "QUAL.OMP.SHARED"([100 x i32]* %"_unnamed_main$$_$B", [100 x i32]* %"_unnamed_main$$_$A"),

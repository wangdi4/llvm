...
; CHECK: store [20 x %class.goo]* %a, [20 x %class.goo]** %b, align 8
; CHECK-NEXT: %[[BREF:.*]] = load [20 x %class.goo]*, [20 x %class.goo]** %b, align 8
...
; CHECK: store [20 x %class.goo]* %[[BREF]], [20 x %class.goo]** %[[CP_BREF]], align 8
...
entry:
  ...
  %b = alloca [20 x %class.goo]*, align 8
...
arrayctor.cont:                                   ; preds = %arrayctor.loop
  store [20 x %class.goo]* %a, [20 x %class.goo]** %b, align 8
  %0 = load [20 x %class.goo]*, [20 x %class.goo]** %b, align 8
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SINGLE"(),
    "QUAL.OMP.COPYPRIVATE:NONPOD"([20 x %class.goo]* %0, void (%class.goo*, %class.goo*)* @_ZTS3goo.omp.copy_assign) ]
  fence acquire
  fence release

...
;
;     !$omp parallel firstprivate(collection)
;       ...
;     !$omp end parallel
; end program test
...
; CHECK:  %"do_test_$COLLECTION.fpriv" = alloca %"DO_TEST$.btOUTER_T5"*, align 8
; CHECK:  call void @"%DO_TEST$.btOUTER_T.omp.copy_ctor_deref1"(%"DO_TEST$.btOUTER_T5"** %"do_test_$COLLECTION.fpriv", %"DO_TEST$.btOUTER_T5"** @"do_test_$COLLECTION")
; CHECK:  call void @"%DO_TEST$.btOUTER_T.omp.dtor_deref1"(%"DO_TEST$.btOUTER_T5"** %"do_test_$COLLECTION.fpriv")
...
bb4:
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.FIRSTPRIVATE:F90_NONPOD"(%"DO_TEST$.btOUTER_T5"** @"do_test_$COLLECTION", void (%"DO_TEST$.btOUTER_T5"**, %"DO_TEST$.btOUTER_T5"**)* @"%DO_TEST$.btOUTER_T.omp.copy_ctor_deref1", void (%"DO_TEST$.btOUTER_T5"**)* @"%DO_TEST$.btOUTER_T.omp.dtor_deref1") ]
  br label %bb23
...
attributes #0 = { "target-features"="+avx,+avx2,+bmi,+bmi2,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+lzcnt,+mmx,+movbe,+pclmul,+popcnt,+rdrnd,+sahf,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsaveopt" }

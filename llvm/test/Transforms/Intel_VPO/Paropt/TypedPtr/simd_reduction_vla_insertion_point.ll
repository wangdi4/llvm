...
;CHECK:  %vla.fast_red.alloca = alloca i32, i64 %{{[^,]}}, align 16
;CHECK:  %vla.red = alloca i32, i64 %{{[^,]}}, align 16
...
entry:
  ...
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.REDUCTION.ADD"(i32* %vla), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.LINEAR:IV"(i32* %d, i32 1) ]

; RUN: opt -opaque-pointers=0 -enable-new-pm=0 -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -vpo-paropt-atomic-free-red-use-fp-team-counter=false -S %s | FileCheck %s
...
; CHECK: %[[GLOBAL_GEP:[^,]+]] = getelementptr i32, i32 addrspace(1)* %[[RED_GLOBAL_BUF]], i64 %[[GEP_OFF]]
...
; CHECK: store i32 %[[RES_PHI]], i32 addrspace(1)* %[[RESULT_PTR]]
; CHECK-NEXT: store i32 0, i32 addrspace(1)* %[[TEAMS_COUNTER_PTR]], align 4

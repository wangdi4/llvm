...
; ModuleID = 'fast_reduction_nowait_add_int.c'
source_filename = "fast_reduction_nowait_add_int.c"
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.PRIVATE"(i32* %.omp.iv), "QUAL.OMP.PRIVATE"(i32* %.omp.lb), "QUAL.OMP.PRIVATE"(i32* %.omp.ub), "QUAL.OMP.SHARED"(i32* %sum), "QUAL.OMP.SHARED"(i32* %i), "QUAL.OMP.PRIVATE"(i32* %tmp) ]

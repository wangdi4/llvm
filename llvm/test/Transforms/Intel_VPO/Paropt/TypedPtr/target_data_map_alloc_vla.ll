...
define dso_local void @foo(i32* %x, i32 %n) {
entry:
  ...
  %5 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET.DATA"(),
    "QUAL.OMP.MAP.TOFROM"(i32* %1, i32* %arrayidx, i64 %4, i64 0, i8* null, i8* null) ]

  %6 = load i32*, i32** %x.addr, align 8
  %ptridx1 = getelementptr inbounds i32, i32* %6, i64 0
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %ptridx1)

...
define void @gpu_ompmod_mp_gpu_ompmod_twoei_jk_(i32 addrspace(4)* dereferenceable(4) %NINTN) {
alloca_1:
...
bb_new9:                                          ; preds = %bb_new4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.DISTRIBUTE.PARLOOP"(),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %"ascast$val7"),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %"ascast$val"),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %omp.pdo.step),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %omp.pdo.end),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %omp.pdo.start),
    "QUAL.OMP.FIRSTPRIVATE"(i64 addrspace(4)* %omp.pdo.norm.lb),
    "QUAL.OMP.NORMALIZED.IV"(i64 addrspace(4)* %omp.pdo.norm.iv),
    "QUAL.OMP.NORMALIZED.UB"(i64 addrspace(4)* %omp.pdo.norm.ub) ]
...
bb_new3:                                          ; preds = %alloca_1
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* %"ascastB$val", %"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* %"ascastB$val", i64 96, i64 32, i8 addrspace(4)* null, i8 addrspace(4)* null),
    "QUAL.OMP.MAP.TOFROM:CHAIN"(%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* %"ascastB$val", double addrspace(4)* %"ascastB$val.addr_a0$_fetch.2", i64 %mul.2, i64 281474976711187, i8 addrspace(4)* null, i8 addrspace(4)* null),
    "QUAL.OMP.MAP.TOFROM:CHAIN"(%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* %"ascastB$val", i64 addrspace(4)* %"ascastB$val.addr_length$", i64 88, i64 281474976710657, i8 addrspace(4)* null, i8 addrspace(4)* null),
    "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %NINTN, i32 addrspace(4)* %NINTN, i64 4, i64 547, i8 addrspace(4)* null, i8 addrspace(4)* null),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %"ascast$val"),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %"ascast$val7"),
    "QUAL.OMP.PRIVATE"(i64 addrspace(4)* %omp.pdo.norm.iv),
    "QUAL.OMP.FIRSTPRIVATE"(i64 addrspace(4)* %omp.pdo.norm.lb),
    "QUAL.OMP.FIRSTPRIVATE"(i64 addrspace(4)* %omp.pdo.norm.ub),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %omp.pdo.step),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %omp.pdo.end),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %omp.pdo.start) ]
  br label %bb_new4

bb_new4:                                          ; preds = %bb_new3
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.REDUCTION.ADD"(i32 addrspace(4)* %NINTN),
    "QUAL.OMP.REDUCTION.ADD:F90_DV"(%"QNCA_a0$double addrspace(4)*$rank2$" addrspace(4)* %"ascastB$val"),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %"ascast$val"),
    "QUAL.OMP.SHARED"(i64 addrspace(4)* %omp.pdo.norm.lb),
    "QUAL.OMP.SHARED"(i64 addrspace(4)* %omp.pdo.norm.ub),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %omp.pdo.step),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %omp.pdo.end),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %omp.pdo.start),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %"ascast$val7"),
...
declare i64 addrspace(4)* @llvm.intel.subscript.p4i64.i64.i32.p4i64.i32(i8, i64, i32, i64 addrspace(4)*, i32)

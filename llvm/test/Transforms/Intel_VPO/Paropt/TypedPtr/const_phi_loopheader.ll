...
DIR.OMP.LOOP.4:                                   ; preds = %DIR.OMP.PARALLEL.3
  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb.i),
    "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv.i),
    "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub.i),
    "QUAL.OMP.PRIVATE"(i32* %i.i) ]
...
if.then.i:                                        ; preds = %omp.inner.for.body.i
  %call.i = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0), i32 %call, i32 1, i32 %10)

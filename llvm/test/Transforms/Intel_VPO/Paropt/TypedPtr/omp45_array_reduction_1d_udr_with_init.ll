...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR"([100 x %struct.my_struct]* @_ZL1y_028756d5d789e2cd5db53a1fdc9e18de, i8* null, void ([100 x %struct.my_struct]*)* @_ZTSA100_9my_struct.omp.destr, void (%struct.my_struct*, %struct.my_struct*)* @.omp_combiner., void (%struct.my_struct*, %struct.my_struct*)* @.omp_initializer.),
    ...
    "QUAL.OMP.SHARED"([100 x %struct.my_struct]* @_ZL1x_028756d5d789e2cd5db53a1fdc9e18de) ]
...
for.body:                                         ; preds = %for.cond
  ...
  call void @_Z6my_addR9my_structRKS_(%struct.my_struct* dereferenceable(8) %arrayidx, %struct.my_struct* dereferenceable(8) %arrayidx3)
  br label %for.inc
...
declare void @_Z6my_addR9my_structRKS_(%struct.my_struct* dereferenceable(8) %lhs, %struct.my_struct* dereferenceable(8) %rhs)
...
declare void @_ZTSA100_9my_struct.omp.destr([100 x %struct.my_struct]* %0)

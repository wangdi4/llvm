...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %x.addr.ascast, i32 addrspace(4)* %x.addr.ascast, i64 4, i64 35, i8* null, i8* null),
...
define dso_local spir_func void @bar(i32 addrspace(4)* %x) #0 {
entry:

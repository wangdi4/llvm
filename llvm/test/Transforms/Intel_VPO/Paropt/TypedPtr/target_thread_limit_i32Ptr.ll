...
; HST: store i32 2, i32* [[LOCAL]], align 4
; HST: [[LOCALVAL:%local.val]] = load i32, i32* [[LOCAL]], align 4
; HST: [[LOCALVALZEXT:%local.val.zext]] = zext i32 [[LOCALVAL]] to i64
; HST: [[THREADLIMIT:%.+]] = load i32, i32* [[LOCAL]], align 4
; HST: call i32 @__tgt_target_teams(i64 {{.*}}, i8* [[ID5]], i32 1, i8** {{.*}}, i8** {{.*}}, i64* {{.*}}, i64* {{.*}}, i32 -1, i32 [[THREADLIMIT]])
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE"(i32* %local),
    "QUAL.OMP.THREAD_LIMIT"(i32* %local) ]
...
!0 = !{i32 0, i32 66313, i32 107162447, !"_Z3foo", i32 5, i32 0, i32 0, i32 0}

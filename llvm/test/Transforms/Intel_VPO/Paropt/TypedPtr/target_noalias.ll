...
entry:
  ...
  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(double* %4, double* %arrayidx1, i64 8, i64 35),
    "QUAL.OMP.PRIVATE"(double** %dst.map.ptr.tmp),
    "QUAL.OMP.PRIVATE"(double** %src.map.ptr.tmp) ]
...
entry:
  ...
  %8 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(double* %4, double* %arrayidx, i64 8, i64 35),
    "QUAL.OMP.MAP.TOFROM"(double* %6, double* %arrayidx2, i64 8, i64 35),
    "QUAL.OMP.PRIVATE"(double** %dst.map.ptr.tmp),
    "QUAL.OMP.PRIVATE"(double** %src.map.ptr.tmp) ]
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(double* %dst, double* %dst, i64 8, i64 35),
    "QUAL.OMP.MAP.TOFROM"(double* %src, double* %src, i64 8, i64 35) ]

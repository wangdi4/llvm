; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -vpo-paropt-target-capture-non-pointers-using-map-to -vpo-cfg-restructuring -vpo-paropt -S %s | FileCheck %s

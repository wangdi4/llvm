...
; Check that the branch b1 -> b3, b4 is deleted, and replaced with "unreachable".
...
; CHECK: b4:
; CHECK-NEXT: %arg1 = phi i1 [ false, %b3 ]
; CHECK-NEXT: call void @_Z3bazb(i1 zeroext %arg1)

...
; CHECK:  getelementptr inbounds float, float addrspace(1)* %red_local_buf, i64
; CHECK:  getelementptr inbounds i32, i32 addrspace(1)* %red_local_buf{{.+}}, i64
...
entry:
  ...
  %sum.ascast = addrspacecast float* %sum to float addrspace(4)*
  %sum2.ascast = addrspacecast i32* %sum2 to i32 addrspace(4)*
  ...
  %tmp12.ascast = addrspacecast i32* %tmp12 to i32 addrspace(4)*
  %.omp.iv13.ascast = addrspacecast i32* %.omp.iv13 to i32 addrspace(4)*
  %.omp.lb14.ascast = addrspacecast i32* %.omp.lb14 to i32 addrspace(4)*
  %.omp.ub15.ascast = addrspacecast i32* %.omp.ub15 to i32 addrspace(4)*
  %j19.ascast = addrspacecast i32* %j19 to i32 addrspace(4)*
  store i32 0, i32 addrspace(4)* %retval.ascast, align 4
  store float 0.000000e+00, float addrspace(4)* %sum.ascast, align 4
  store i32 0, i32 addrspace(4)* %sum2.ascast, align 4
  store i32 0, i32 addrspace(4)* %.omp.lb.ascast, align 4
  store i32 9, i32 addrspace(4)* %.omp.ub.ascast, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.MAP.TOFROM"(float addrspace(4)* %sum.ascast, float addrspace(4)* %sum.ascast, i64 4, i64 33315, i8* null, i8* null), ; MAP type: 33315 = 0x8223 = IMPLICIT (0x200) | TARGET_PARAM (0x20) | FROM (0x2) | TO (0x1) | UNKNOWN (0x8000)
    "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %sum2.ascast, i32 addrspace(4)* %sum2.ascast, i64 4, i64 33315, i8* null, i8* null), ; MAP type: 33315 = 0x8223 = IMPLICIT (0x200) | TARGET_PARAM (0x20) | FROM (0x2) | TO (0x1) | UNKNOWN (0x8000)
    ...
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.iv13.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.lb14.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.ub15.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %j19.ascast, i32 0, i32 1),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %tmp12.ascast, i32 0, i32 1) ]

  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.REDUCTION.ADD:TYPED"(float addrspace(4)* %sum.ascast, float 0.000000e+00, i32 1),
    "QUAL.OMP.REDUCTION.ADD:TYPED"(i32 addrspace(4)* %sum2.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.iv.ascast, i32 0, i32 1),
...
omp.inner.for.body7:                              ; preds = %omp.inner.for.cond5
  ...
  %13 = load float, float addrspace(4)* %sum.ascast, align 4
  %add10 = fadd fast float %13, %conv
  store float %add10, float addrspace(4)* %sum.ascast, align 4
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  store i32 0, i32 addrspace(4)* %.omp.lb14.ascast, align 4
  store i32 9, i32 addrspace(4)* %.omp.ub15.ascast, align 4
  %15 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.ADD:TYPED"(i32 addrspace(4)* %sum2.ascast, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(i32 addrspace(4)* %i.ascast, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(i32 addrspace(4)* %.omp.iv13.ascast, i32 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(i32 addrspace(4)* %.omp.lb14.ascast, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(i32 addrspace(4)* %.omp.ub15.ascast, i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %j19.ascast, i32 0, i32 1) ]

  %16 = load i32, i32 addrspace(4)* %.omp.lb14.ascast, align 4
  store i32 %16, i32 addrspace(4)* %.omp.iv13.ascast, align 4
  br label %omp.inner.for.cond16

omp.inner.for.cond16:                             ; preds = %omp.inner.for.inc25, %omp.loop.exit
  %17 = load i32, i32 addrspace(4)* %.omp.iv13.ascast, align 4
  %18 = load i32, i32 addrspace(4)* %.omp.ub15.ascast, align 4
...
omp.inner.for.body18:                             ; preds = %omp.inner.for.cond16
  %19 = load i32, i32 addrspace(4)* %.omp.iv13.ascast, align 4
  %mul20 = mul nsw i32 %19, 1
  %add21 = add nsw i32 0, %mul20
  store i32 %add21, i32 addrspace(4)* %j19.ascast, align 4
  %20 = load i32, i32 addrspace(4)* %i.ascast, align 4
  %mul22 = mul nsw i32 2, %20
  %21 = load i32, i32 addrspace(4)* %sum2.ascast, align 4
  %add23 = add nsw i32 %21, %mul22
  store i32 %add23, i32 addrspace(4)* %sum2.ascast, align 4
...
omp.inner.for.inc25:                              ; preds = %omp.body.continue24
  %22 = load i32, i32 addrspace(4)* %.omp.iv13.ascast, align 4
  %add26 = add nsw i32 %22, 1
  store i32 %add26, i32 addrspace(4)* %.omp.iv13.ascast, align 4
  br label %omp.inner.for.cond16
...
omp.inner.for.inc30:                              ; preds = %omp.body.continue29
  ...
  store i32 %add31, i32 addrspace(4)* %.omp.iv.ascast, align 4
  br label %omp.inner.for.cond

; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -vpo-paropt-atomic-free-reduction-slm=false -vpo-paropt-atomic-free-red-local-buf-size=0 -S %s | FileCheck %s
; RUN: opt -opaque-pointers=0 -switch-to-offload -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -vpo-paropt-atomic-free-reduction-slm=false -vpo-paropt-atomic-free-red-local-buf-size=0 -S %s | FileCheck %s
...
; CHECK: %[[GLOBAL_GEP:[^,]+]] = getelementptr i32, i32 addrspace(1)* %red_buf
; CHECK-NOT: call void @llvm.dbg.declare(metadata i32 addrspace(1)* %[[GLOBAL_GEP]]
...
entry:
  ...
  store i32 0, i32 addrspace(4)* %sum.ascast, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata i32* %.omp.lb, metadata !19, metadata !DIExpression()), !dbg !21
  store i32 0, i32 addrspace(4)* %.omp.lb.ascast, align 4, !dbg !22
  call void @llvm.dbg.declare(metadata i32* %.omp.ub, metadata !23, metadata !DIExpression()), !dbg !21
  store i32 9, i32 addrspace(4)* %.omp.ub.ascast, align 4, !dbg !22
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %sum.ascast, i32 addrspace(4)* %sum.ascast, i64 4, i64 35, [21 x i8] addrspace(4)* @0, i8* null), ; MAP type: 35 = 0x23 = TARGET_PARAM (0x20) | FROM (0x2) | TO (0x1)
...
, !dbg !24
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %tmp.ascast, i32 0, i32 1) ]
, !dbg !25
  call void @llvm.dbg.declare(metadata i32* %.omp.iv, metadata !27, metadata !DIExpression()), !dbg !29
...
, !dbg !30
  %3 = load i32, i32 addrspace(4)* %.omp.lb.ascast, align 4, !dbg !31
  store i32 %3, i32 addrspace(4)* %.omp.iv.ascast, align 4, !dbg !31
  br label %omp.inner.for.cond, !dbg !25

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  %4 = load i32, i32 addrspace(4)* %.omp.iv.ascast, align 4, !dbg !31
  %5 = load i32, i32 addrspace(4)* %.omp.ub.ascast, align 4, !dbg !31
  %cmp = icmp sle i32 %4, %5, !dbg !32
  br i1 %cmp, label %omp.inner.for.body, label %omp.inner.for.end, !dbg !25

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %6 = load i32, i32 addrspace(4)* %.omp.iv.ascast, align 4, !dbg !31
  %mul = mul nsw i32 %6, 1, !dbg !33
  %add = add nsw i32 0, %mul, !dbg !33
  store i32 %add, i32 addrspace(4)* %i.ascast, align 4, !dbg !33
  %7 = load i32, i32 addrspace(4)* %i.ascast, align 4, !dbg !34
  %8 = load i32, i32 addrspace(4)* %sum.ascast, align 4, !dbg !36
  %add1 = add nsw i32 %8, %7, !dbg !36
  store i32 %add1, i32 addrspace(4)* %sum.ascast, align 4, !dbg !36
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %9 = load i32, i32 addrspace(4)* %.omp.iv.ascast, align 4, !dbg !31
  %add2 = add nsw i32 %9, 1, !dbg !32
  store i32 %add2, i32 addrspace(4)* %.omp.iv.ascast, align 4, !dbg !32

...
entry:
  ...
  %a = getelementptr inbounds %struct.str, %struct.str* %y, i64 0, i32 0
  store i32 1, i32* %a, align 4
  %b = getelementptr inbounds %struct.str, %struct.str* %y, i64 0, i32 1
  store i8 97, i8* %b, align 4
  %y.addr = alloca %struct.str*, align 8
  store %struct.str* %y, %struct.str** %y.addr, align 8
  %end.dir.temp = alloca i1, align 1
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.NUM_THREADS"(i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(%struct.str* %y, %struct.str zeroinitializer, i32 1),
    "QUAL.OMP.OPERAND.ADDR"(%struct.str* %y, %struct.str** %y.addr),
...
DIR.OMP.PARALLEL.3:                               ; preds = %entry
  %y1 = load volatile %struct.str*, %struct.str** %y.addr, align 8
  %2 = bitcast %struct.str* %y1 to i8*

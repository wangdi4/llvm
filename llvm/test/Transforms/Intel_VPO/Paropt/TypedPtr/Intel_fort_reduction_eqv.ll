...
; This test is used to check EQV reduction type.
;        PROGRAM OMP_TEST
;
;          IMPLICIT NONE
;
...
;
;          R = F(1)
;  C$OMP     PARALLEL REDUCTION( .EQV. : R )
;            R = R .EQV. F( 2 )
;  C$OMP     END PARALLEL
;
;        END
...
bb6:                                              ; preds = %bb9
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.REDUCTION.EQV"(i32* %"omp_test_$R") ]
  br label %bb10
...
define i32 @f_(i32* noalias %"f_$X") {
alloca:

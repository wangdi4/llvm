...
bb31:                                             ; preds = %alloca
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TO"(%"QNCA_a0$i32*$rank1$.0"* %A, %"QNCA_a0$i32*$rank1$.0"* %A, i64 72, i64 32),
    "QUAL.OMP.MAP.TO:CHAIN"(%"QNCA_a0$i32*$rank1$.0"* %A, i32** %next, i64 64, i64 281474976710661),
    "QUAL.OMP.MAP.TO:CHAIN"(%"QNCA_a0$i32*$rank1$.0"* %A, i32* %addr0.val, i64 8, i64 281474976710677),
    "QUAL.OMP.FIRSTPRIVATE:F90_DV"(%"QNCA_a0$i32*$rank1$.0"* %A) ]

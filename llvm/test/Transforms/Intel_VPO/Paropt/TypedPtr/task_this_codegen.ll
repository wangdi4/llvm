...
define dso_local void @_ZN6kdnode11buildkdtreeEPxS0_S0_S0_S0_xxPPii(%class.kdnode* %this, i64* %xn, i64* %yn, i64* %zn, i64* %wn, i64* %tn, i64 %start, i64 %end, i32** %x, i32 %p) align 2 {
entry:
  ...
  store i64* %xn, i64** %xn.addr, align 8
  store i64* %yn, i64** %yn.addr, align 8
  store i64* %zn, i64** %zn.addr, align 8
  store i64* %wn, i64** %wn.addr, align 8
  store i64* %tn, i64** %tn.addr, align 8
  ...
  %rem = srem i32 %2, 3
  store i32 %rem, i32* %p.addr, align 4
...
if.then:                                          ; preds = %entry
  %5 = load i64*, i64** %xn.addr, align 8
...
if.then3:                                         ; preds = %if.else
  ...
  %8 = load i64*, i64** %xn.addr, align 8
...
if.then12:                                        ; preds = %if.then3
  ...
  store i64 %12, i64* %n14, align 8
  %call = call i8* @_Znwm(i64 40)
  %15 = bitcast i8* %call to %class.kdnode*
  %16 = load i64*, i64** %xn.addr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %31 = load i64*, i64** %xn.addr, align 8
...
if.else52:                                        ; preds = %for.body
  store i64 %i.0, i64* %middle, align 8
  %dec = add nsw i64 %i.0, -1
  br label %for.cond

for.end:                                          ; preds = %for.body, %for.cond
  %36 = load i64*, i64** %xn.addr, align 8
  %37 = load i64, i64* %middle, align 8
  ...
  store i64 %38, i64* %n55, align 8
  %39 = load i64, i64* %start.addr, align 8
  %sub56 = sub nsw i64 %39, 1
  store i64 %sub56, i64* %lower, align 8
  %40 = load i64, i64* %middle, align 8
  %41 = load i64, i64* %start.addr, align 8
  br label %for.cond57
...
for.body59:                                       ; preds = %for.cond57
  %43 = load i64*, i64** %yn.addr, align 8
  %arrayidx60 = getelementptr inbounds i64, i64* %43, i64 %i.1
  %44 = load i64, i64* %arrayidx60, align 8
  %45 = load i64*, i64** %xn.addr, align 8
  %46 = load i64, i64* %middle, align 8
  %arrayidx61 = getelementptr inbounds i64, i64* %45, i64 %46
  %47 = load i64, i64* %arrayidx61, align 8
...
for.end81:                                        ; preds = %for.cond57
  ...
  store i64 %sub82, i64* %lower, align 8
...
if.then89:                                        ; preds = %for.body85
  ...
  %64 = load i32*, i32** %arrayidx91, align 8
...
if.then110:                                       ; preds = %for.end108
  ...
  store %class.kdnode* %71, %class.kdnode** %lo112, align 8
  %72 = load i64, i64* %lower, align 8
...
DIR.OMP.TASK.1:                                   ; preds = %if.then110
  %74 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(),
    "QUAL.OMP.IF"(i1 %cmp114),
    "QUAL.OMP.SHARED"(i64** %tn.addr, i64** %yn.addr, i64** %xn.addr, i64** %wn.addr, i64** %zn.addr, i32*** %x.addr),
    "QUAL.OMP.FIRSTPRIVATE"(i64* %start.addr),
    "QUAL.OMP.FIRSTPRIVATE"(i64* %lower),
    "QUAL.OMP.FIRSTPRIVATE"(i32* %p.addr),
    "QUAL.OMP.SHARED"(%class.kdnode* %this) ]
  ...
  %78 = load %class.kdnode*, %class.kdnode** %lo115, align 8
  %79 = load i64*, i64** %tn.addr, align 8
  %80 = load i64*, i64** %yn.addr, align 8
  %81 = load i64*, i64** %xn.addr, align 8
  %82 = load i64*, i64** %wn.addr, align 8
  %83 = load i64*, i64** %zn.addr, align 8
  %84 = load i64, i64* %start.addr, align 8
  %85 = load i64, i64* %lower, align 8
  %86 = load i32**, i32*** %x.addr, align 8
  %87 = load i32, i32* %p.addr, align 4
...
if.then119:                                       ; preds = %if.end117
  ...
  store %class.kdnode* %89, %class.kdnode** %hi121, align 8
  %90 = load i64, i64* %end.addr, align 8
  %91 = load i64, i64* %middle, align 8
...
DIR.OMP.TASK.4:                                   ; preds = %if.then119
  %92 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(),
    "QUAL.OMP.IF"(i1 %cmp124),
    "QUAL.OMP.SHARED"(i64** %tn.addr, i64** %yn.addr, i64** %xn.addr, i64** %wn.addr, i64** %zn.addr, i32*** %x.addr),
    "QUAL.OMP.FIRSTPRIVATE"(i64* %middle),
    "QUAL.OMP.FIRSTPRIVATE"(i64* %end.addr),
    "QUAL.OMP.FIRSTPRIVATE"(i32* %p.addr),
    "QUAL.OMP.SHARED"(%class.kdnode* %this) ]
  ...
  %96 = load %class.kdnode*, %class.kdnode** %hi125, align 8
  %97 = load i64*, i64** %tn.addr, align 8
  %98 = load i64*, i64** %yn.addr, align 8
  %99 = load i64*, i64** %xn.addr, align 8
  %100 = load i64*, i64** %wn.addr, align 8
  %101 = load i64*, i64** %zn.addr, align 8
  %102 = load i64, i64* %middle, align 8

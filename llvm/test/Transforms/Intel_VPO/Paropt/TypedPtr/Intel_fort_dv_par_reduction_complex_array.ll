; INTEL_CUSTOMIZATION
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -vpo-paropt-keep-blocks-order=false -S %s | FileCheck %s
; RUN: opt -opaque-pointers=0 -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -vpo-paropt-keep-blocks-order=false -S %s | FileCheck %s
...
bb33:                                             ; preds = %alloca_0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.ADD:CMPLX.F90_DV"(%"QNCA_a0$%complex_128bit*$rank2$"* @"complex_alloc_array_reduction_$PSIC_ALL_NC"),
    "QUAL.OMP.PRIVATE"(i32* %"complex_alloc_array_reduction_$JPOL"),
    "QUAL.OMP.PRIVATE"(i32* %"complex_alloc_array_reduction_$IR"),
    "QUAL.OMP.SHARED"(i32* %"complex_alloc_array_reduction_$NPOL"),
    "QUAL.OMP.SHARED"(i32* %"complex_alloc_array_reduction_$NXXS"),
    "QUAL.OMP.NORMALIZED.IV"(i32* %temp131),
    "QUAL.OMP.NORMALIZED.UB"(i32* %temp133),
    "QUAL.OMP.FIRSTPRIVATE"(i32* %temp129),
    "QUAL.OMP.PRIVATE"(i32* %"var$7"),
    "QUAL.OMP.PRIVATE"(i32* %"var$6"),
    "QUAL.OMP.FIRSTPRIVATE"([8 x i64]* %"var$2") ]
...
declare %complex_128bit* @llvm.intel.subscript.p0s_complex_128bits.i64.i64.p0s_complex_128bits.i64(i8, i64, i64, %complex_128bit*, i64)

...
entry:
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET.ENTER.DATA"(),
    "QUAL.OMP.MAP.ALWAYS.TO:AGGRHEAD"([100 x i32]* @a, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a, i64 0, i64 7), i64 68) ]
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET.EXIT.DATA"(),
    "QUAL.OMP.MAP.ALWAYS.FROM:AGGRHEAD"([100 x i32]* @a, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a, i64 0, i64 9), i64 52) ]

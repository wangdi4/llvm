...
; CHECK: store i8* bitcast (void (i16*, i16*)* @[[RED_COMB_FUNC:[^ ]+task_red_comb[^ ]+]] to i8*), i8** [[RED_COMB_GEP]], align 8
...
define dso_local void @_Z3fooRs(i16* nonnull align 2 dereferenceable(2) %a) #2 {
entry:
  %a.addr = alloca i16*, align 8
  store i16* %a, i16** %a.addr, align 8
  %0 = load i16*, i16** %a.addr, align 8
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASKGROUP"(), "QUAL.OMP.REDUCTION.UDR:BYREF"(i16** %a.addr, i8* null, i8* null, void (i16*, i16*)* @.omp_combiner., void (i16*, i16*)* @.omp_initializer.) ]
  %2 = load i16*, i16** %a.addr, align 8
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.INREDUCTION.UDR:BYREF"(i16** %a.addr, i8* null, i8* null, void (i16*, i16*)* @.omp_combiner., void (i16*, i16*)* @.omp_initializer.) ]

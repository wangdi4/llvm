...
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.FROM"([100 x i32] addrspace(4)* %a.ascast, [100 x i32] addrspace(4)* %a.ascast, i64 400, i64 34),
    ...
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %lp.ascast),
    ...
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv3.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb4.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.ub5.ascast),
  ...
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.SHARED"([100 x i32] addrspace(4)* %a.ascast),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %7 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    ...
    "QUAL.OMP.LASTPRIVATE"(i32 addrspace(4)* %lp.ascast),
    "QUAL.OMP.NORMALIZED.IV"(i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, i32 addrspace(4)* %.omp.uncollapsed.iv3.ascast),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb.ascast),
    "QUAL.OMP.NORMALIZED.UB"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, i32 addrspace(4)* %.omp.uncollapsed.ub5.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %j.ascast),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb4.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %k.ascast) ]

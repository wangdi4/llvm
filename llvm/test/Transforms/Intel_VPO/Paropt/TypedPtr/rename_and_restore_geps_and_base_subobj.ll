...
; SUBOBJ modifiers to the clauses on GEPs.
;
...
; PREPR:      "QUAL.OMP.PRIVATE:TYPED.SUBOBJ"([4 x i8]* %x, [4 x i8] zeroinitializer, i32 1),
...
; CSE:        "QUAL.OMP.PRIVATE:TYPED.SUBOBJ"([4 x i8]* bitcast ([20 x i8]* @global to [4 x i8]*), [4 x i8] zeroinitializer, i32 1),
...
;
; RESTR:      "QUAL.OMP.PRIVATE:TYPED.SUBOBJ"([4 x i8]* [[X_INST]], [4 x i8] zeroinitializer, i32 1)

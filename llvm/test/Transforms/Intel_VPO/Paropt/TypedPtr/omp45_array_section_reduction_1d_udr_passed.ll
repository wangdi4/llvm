...
; void cq415166_1d_e_passed(TYPE ypas[N]) {
; #pragma omp parallel for reduction(my_reduction_add:ypas[25:N/4])
;     for(int i = 0; i < N; i++) {
...
;     }
;
;     cq415166_1d_e_passed(y);
;
;     return 0;
; }


; ModuleID = 'omp45_array_section_reduction_1d_udr_passed.cpp'
source_filename = "omp45_array_section_reduction_1d_udr_passed.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@_ZL1x_eb51270620997130c2dd49a2f07950bb = internal global [100 x i16] zeroinitializer, align 16
@_ZL1y_eb51270620997130c2dd49a2f07950bb = internal global [100 x i16] zeroinitializer, align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z20cq415166_1d_e_passedPs(i16* %ypas) #1 {
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.REDUCTION.UDR:ARRSECT"(i16** %ypas.addr, i64 1, i64 25, i64 25, i64 1, i8* null, i8* null, void (i16*, i16*)* @.omp_combiner., i8* null), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.SHARED"([100 x i16]* @_ZL1x_eb51270620997130c2dd49a2f07950bb) ]
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_eb51270620997130c2dd49a2f07950bb, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_eb51270620997130c2dd49a2f07950bb, i64 0, i64 %idxprom
  store i16 1, i16* %arrayidx, align 2
  %2 = load i32, i32* %i, align 4
  %conv = trunc i32 %2 to i16
  %3 = load i32, i32* %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1y_eb51270620997130c2dd49a2f07950bb, i64 0, i64 %idxprom1
...
for.end:                                          ; preds = %for.cond
  call void @_Z20cq415166_1d_e_passedPs(i16* getelementptr inbounds ([100 x i16], [100 x i16]* @_ZL1y_eb51270620997130c2dd49a2f07950bb, i64 0, i64 0))
  ret i32 0
}

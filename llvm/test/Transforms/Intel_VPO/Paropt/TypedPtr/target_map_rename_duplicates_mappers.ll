...
; CHECK:   [[YY1:%.*]] = bitcast i32* [[YY0]] to i32*
...
DIR.OMP.TARGET.2:                                 ; preds = %DIR.OMP.TARGET.1
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(i32* %yy, i32* %yy, i64 0, i64 544, i8* null, i8* null),
    "QUAL.OMP.MAP.TOFROM"(i32* %yy, i32* %yy, i64 0, i64 544, i8* null, i8* null),
    "QUAL.OMP.MAP.TOFROM"(i32* %zz, i32* %zz, i64 0, i64 544, i8* null, i8* null),
    "QUAL.OMP.PRIVATE:TYPED.WILOCAL"(i32** %yy0.map.ptr.tmp, i32* null, i32 1),
    "QUAL.OMP.PRIVATE:TYPED.WILOCAL"(i32** %yy1.map.ptr.tmp, i32* null, i32 1),
    "QUAL.OMP.PRIVATE:TYPED.WILOCAL"(i32** %zz0.map.ptr.tmp, i32* null, i32 1),

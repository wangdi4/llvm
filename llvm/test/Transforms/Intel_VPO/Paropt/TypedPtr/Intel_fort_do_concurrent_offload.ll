...
alloca_0:
  ...
  store i32 64, i32* %do.end, align 1
  ...
  %do.end_fetch.1 = load i32, i32* %do.end, align 1
  %do.start_fetch.2 = load i32, i32* %do.start, align 1
  %sub.1 = sub nsw i32 %do.end_fetch.1, %do.start_fetch.2
  %do.step_fetch.3 = load i32, i32* %do.step, align 1
  %div.1 = sdiv i32 %sub.1, %do.step_fetch.3
  %int_sext = sext i32 %div.1 to i64
  store i64 %int_sext, i64* %do.norm.ub, align 1
  %do.norm.iv = alloca i64, align 8
  br label %bb_new6

do.cond10:                                        ; preds = %DIR.OMP.GENERICLOOP.4, %do.body11
  %do.norm.iv_fetch.5 = load i64, i64* %do.norm.iv, align 1
  %do.norm.ub_fetch.6 = load i64, i64* %do.norm.ub, align 1
...
do.body11:                                        ; preds = %do.cond10
  %do.norm.iv_fetch.7 = load i64, i64* %do.norm.iv, align 1
  %int_sext4 = trunc i64 %do.norm.iv_fetch.7 to i32
  %do.step_fetch.8 = load i32, i32* %do.step, align 1
  %mul.1 = mul nsw i32 %int_sext4, %do.step_fetch.8
  %do.start_fetch.9 = load i32, i32* %do.start, align 1
  %add.1 = add nsw i32 %mul.1, %do.start_fetch.9
  store i32 %add.1, i32* %"_unnamed_main$$_$I$_1", align 1
  %"_unnamed_main$$_$I$_1_fetch.10" = load i32, i32* %"_unnamed_main$$_$I$_1", align 1
  ...
  %"_unnamed_main$$_$B[]_fetch.11" = load float, float* %1, align 1
  %"_unnamed_main$$_$I$_1_fetch.12" = load i32, i32* %"_unnamed_main$$_$I$_1", align 1
  ...
  %"_unnamed_main$$_$I$_1_fetch.13" = load i32, i32* %"_unnamed_main$$_$I$_1", align 1
  ...
  store float %add.2, float* %3, align 1
...
DIR.OMP.END.TARGET.3:                             ; preds = %DIR.OMP.END.TEAMS.2
  store [4 x i8] c"\1A\05\01\00", [4 x i8]* %"(&)val$", align 1
  %BLKFIELD_i64_ = getelementptr inbounds <{ i64, i8* }>, <{ i64, i8* }>* %argblock, i32 0, i32 0
  store i64 256, i64* %BLKFIELD_i64_, align 1
  ...
  store i8* %"(i8*)_unnamed_main$$_$A$", i8** %"BLKFIELD_i8*_", align 1
...
bb_new8:                                          ; preds = %DIR.OMP.TEAMS.2
  ...
  %4 = call token @llvm.directive.region.entry() [ "DIR.OMP.GENERICLOOP"(),
    ...
    "QUAL.OMP.SHARED"([64 x float]* %"_unnamed_main$$_$A"),
    "QUAL.OMP.SHARED"([64 x float]* @"_unnamed_main$$_$B"),
    "QUAL.OMP.SHARED"(i32* %do.step),
    "QUAL.OMP.SHARED"(i32* %do.start),
    "QUAL.OMP.PRIVATE"(i32* %"_unnamed_main$$_$I$_1"),
    "QUAL.OMP.FIRSTPRIVATE"(i64* %do.norm.lb),
    "QUAL.OMP.NORMALIZED.IV"(i64* %do.norm.iv),
    "QUAL.OMP.NORMALIZED.UB"(i64* %do.norm.ub),
    "QUAL.OMP.OFFLOAD.KNOWN.NDRANGE"(i1 true) ]
  br label %DIR.OMP.GENERICLOOP.4

DIR.OMP.GENERICLOOP.4:                            ; preds = %bb_new8
  %do.norm.lb_fetch.4 = load i64, i64* %do.norm.lb, align 1
  store i64 %do.norm.lb_fetch.4, i64* %do.norm.iv, align 1
  br label %do.cond10
...
DIR.OMP.TARGET.1:                                 ; preds = %DIR.OMP.TARGET.5
  %5 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.EXT.DO.CONCURRENT"(),
    "QUAL.OMP.MAP.TOFROM"([64 x float]* @"_unnamed_main$$_$B", [64 x float]* @"_unnamed_main$$_$B", i64 256, i64 39, i8* null, i8* null),
    "QUAL.OMP.MAP.TOFROM"([64 x float]* %"_unnamed_main$$_$A", [64 x float]* %"_unnamed_main$$_$A", i64 256, i64 39, i8* null, i8* null),
    "QUAL.OMP.PRIVATE"(i64* %do.norm.iv),
    "QUAL.OMP.PRIVATE"(i32* %"_unnamed_main$$_$I$_1"),
    "QUAL.OMP.FIRSTPRIVATE"(i64* %do.norm.ub),
    "QUAL.OMP.FIRSTPRIVATE"(i64* %do.norm.lb),
    "QUAL.OMP.FIRSTPRIVATE"(i32* %do.step),
    "QUAL.OMP.FIRSTPRIVATE"(i32* %do.start),
    "QUAL.OMP.OFFLOAD.NDRANGE"(i64* %do.norm.ub, i64 0) ]
  br label %bb_new7
...
DIR.OMP.TEAMS.2:                                  ; preds = %DIR.OMP.TEAMS.6
  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    ...
    "QUAL.OMP.SHARED"([64 x float]* %"_unnamed_main$$_$A"),
    "QUAL.OMP.SHARED"([64 x float]* @"_unnamed_main$$_$B"),
    "QUAL.OMP.SHARED"(i64* %do.norm.ub),
    "QUAL.OMP.SHARED"(i64* %do.norm.lb),
    "QUAL.OMP.SHARED"(i32* %do.step),
    "QUAL.OMP.SHARED"(i32* %do.start),
    "QUAL.OMP.PRIVATE"(i64* %do.norm.iv),
    "QUAL.OMP.PRIVATE"(i32* %"_unnamed_main$$_$I$_1") ]

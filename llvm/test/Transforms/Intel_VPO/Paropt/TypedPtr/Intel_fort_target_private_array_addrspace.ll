...
; RUN: opt -opaque-pointers=0 -switch-to-offload -passes='function(vpo-cfg-restructuring,loop-simplify,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -S %s | FileCheck %s
...
define void @parray_(i32 addrspace(4)* noalias dereferenceable(4) %"parray_$NDOFX$argptr") {
alloca_0:
...
bb_new7:                                          ; preds = %alloca_0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(double addrspace(4)* %"ascastB$val3", double addrspace(4)* %"ascastB$val3", i64 %mul.2, i64 547, i8 addrspace(4)* null, i8 addrspace(4)* null),
    "QUAL.OMP.PRIVATE:TYPED"(double addrspace(4)* %"ascastB$val3", double 0.000000e+00, i64 %"ascast$val_fetch.6"),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %"ascast$val6"),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %"ascast$val5"),
    "QUAL.OMP.FIRSTPRIVATE"(i64 addrspace(4)* %"ascast$val"),
...
bb_new13:                                         ; preds = %bb_new7
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %"ascast$val6"),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %"ascast$val5"),
    "QUAL.OMP.PRIVATE:TYPED"(double addrspace(4)* %"ascastB$val3", double 0.000000e+00, i64 %"ascast$val_fetch.7"),
...
declare double addrspace(4)* @llvm.intel.subscript.p4f64.i64.i64.p4f64.i64(i8 %0, i64 %1, i64 %2, double addrspace(4)* %3, i64 %4)

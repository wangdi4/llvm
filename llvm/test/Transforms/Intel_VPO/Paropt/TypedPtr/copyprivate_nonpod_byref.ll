...
; RUN: opt -opaque-pointers=0 -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare),vpo-paropt' -S %s | FileCheck %s
...
; CHECK: store %class.goo* %a, %class.goo** %b, align 8
; CHECK-NEXT: %[[BREF:.*]] = load %class.goo*, %class.goo** %b, align 8
...
; CHECK: store %class.goo* %[[BREF]], %class.goo** %[[CP_BREF]], align 8
...
; CHECK: call void @_ZTS3goo.omp.copy_assign(%class.goo* %[[DST]], %class.goo* %[[SRC]]) #5
...
entry:
  ...
  %b = alloca %class.goo*, align 8
  call void @_ZN3gooC2Ev(%class.goo* noundef nonnull align 4 dereferenceable(4) %a)
  store %class.goo* %a, %class.goo** %b, align 8
  %0 = load %class.goo*, %class.goo** %b, align 8
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SINGLE"(),
    "QUAL.OMP.COPYPRIVATE:NONPOD"(%class.goo* %0, void (%class.goo*, %class.goo*)* @_ZTS3goo.omp.copy_assign) ]
  fence acquire
  fence release

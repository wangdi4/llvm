...
; This test checks if OFFLOAD.KNOWN.NDRANGE clause is removed due to the loop's reduction clause supporting
...
entry:
  ...
  %sum.ascast = addrspacecast [32 x i32]* %sum to [32 x i32] addrspace(4)*
  %.omp.lb.ascast = addrspacecast i32* %.omp.lb to i32 addrspace(4)*
  %.omp.ub.ascast = addrspacecast i32* %.omp.ub to i32 addrspace(4)*
  %tmp.ascast = addrspacecast i32* %tmp to i32 addrspace(4)*
  %.omp.iv.ascast = addrspacecast i32* %.omp.iv to i32 addrspace(4)*
  %j.ascast = addrspacecast i32* %j to i32 addrspace(4)*
  %local_sum.ascast = addrspacecast i32* %local_sum to i32 addrspace(4)*
  ...
  store i32 32, i32 addrspace(4)* %N.ascast, align 4
  store i32 0, i32 addrspace(4)* %.omp.lb.ascast, align 4
  store i32 31, i32 addrspace(4)* %.omp.ub.ascast, align 4
  %arrayidx = getelementptr inbounds [32 x i32], [32 x i32] addrspace(4)* %sum.ascast, i64 0, i64 0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.MAP.TOFROM"([32 x i32] addrspace(4)* %sum.ascast, i32 addrspace(4)* %arrayidx, i64 128, i64 35, i8* null, i8* null), ; MAP type: 35 = 0x23 = TARGET_PARAM (0x20) | FROM (0x2) | TO (0x1)
    ...
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %local_sum.ascast, i32 0, i32 1),
  ...
  %array.begin = getelementptr inbounds [32 x i32], [32 x i32] addrspace(4)* %sum.ascast, i32 0, i32 0
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.SHARED:TYPED"([32 x i32] addrspace(4)* %sum.ascast, i32 0, i64 32),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.iv.ascast, i32 0, i32 1),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i32 0, i32 addrspace(4)* %local_sum.ascast, align 4
  %7 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.SHARED:TYPED"(i32 addrspace(4)* %local_sum.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.iv2.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.lb3.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.ub4.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %i.ascast, i32 0, i32 1),
  ...
  store i32 31, i32 addrspace(4)* %.omp.ub4.ascast, align 4
  %8 = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(),
    "QUAL.OMP.REDUCTION.ADD:TYPED"(i32 addrspace(4)* %local_sum.ascast, i32 0, i32 1),
  ...
  %9 = load i32, i32 addrspace(4)* %.omp.lb3.ascast, align 4
  store i32 %9, i32 addrspace(4)* %.omp.iv2.ascast, align 4
...
omp.inner.for.cond5:                              ; preds = %omp.inner.for.inc, %omp.inner.for.body
  ...
  %11 = load i32, i32 addrspace(4)* %.omp.ub4.ascast, align 4
...
omp.inner.for.body7:                              ; preds = %omp.inner.for.cond5
  %12 = load i32, i32 addrspace(4)* %.omp.iv2.ascast, align 4
  %mul8 = mul nsw i32 %12, 1
  %add9 = add nsw i32 0, %mul8
  store i32 %add9, i32 addrspace(4)* %i.ascast, align 4
  %13 = load i32, i32 addrspace(4)* %local_sum.ascast, align 4
  %inc = add nsw i32 %13, 1
  store i32 %inc, i32 addrspace(4)* %local_sum.ascast, align 4
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  store i32 %add10, i32 addrspace(4)* %.omp.iv2.ascast, align 4
  br label %omp.inner.for.cond5
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %15 = load i32, i32 addrspace(4)* %local_sum.ascast, align 4
  %16 = load i32, i32 addrspace(4)* %j.ascast, align 4
  %idxprom = sext i32 %16 to i64
  %arrayidx11 = getelementptr inbounds [32 x i32], [32 x i32] addrspace(4)* %sum.ascast, i64 0, i64 %idxprom
  store i32 %15, i32 addrspace(4)* %arrayidx11, align 4

...
entry:
  ...
  %0 = call [4 x [4 x i32]]* @_ZTW1a()
  %arrayidx = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %0, i64 0, i64 0
  %arrayidx1 = getelementptr inbounds [4 x i32], [4 x i32]* %arrayidx, i64 0, i64 1
  store i32 104, i32* %arrayidx1, align 4, !tbaa !1
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  call void (metadata, ...) @llvm.intel.directive.qual.opndlist(metadata !"QUAL.OMP.COPYIN", [4 x [4 x i32]]* @a)
  call void @llvm.intel.directive(metadata !"DIR.QUAL.LIST.END")
  %1 = call [4 x [4 x i32]]* @_ZTW1a()
  %2 = call [4 x [4 x i32]]* @_ZTW1a()
  %arrayidx2 = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %2, i64 0, i64 0
...
entry:
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i32 %1)
  ret void
}
...
; Function Attrs: nounwind uwtable
define weak_odr hidden [4 x [4 x i32]]* @_ZTW1a() #4 {
  ret [4 x [4 x i32]]* @a
}
...
!0 = !{!"clang version 4.0.0 (branches/vpo 20584)"}
!1 = !{!2, !4, i64 0}

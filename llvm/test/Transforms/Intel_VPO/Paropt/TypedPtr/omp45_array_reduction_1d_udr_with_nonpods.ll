...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR"([100 x %struct.my_struct]* @_ZL1y_593c32c614d5fd7c1fb5cf59b8276c7b, i8* null, void ([100 x %struct.my_struct]*)* @_ZTSA100_9my_struct.omp.destr, void (%struct.my_struct*, %struct.my_struct*)* @.omp_combiner., void (%struct.my_struct*, %struct.my_struct*)* @.omp_initializer.),
    ...
    "QUAL.OMP.SHARED"([100 x %struct.my_struct]* @_ZL1x_593c32c614d5fd7c1fb5cf59b8276c7b) ]
...
for.body:                                         ; preds = %for.cond
  ...
  call void @_Z6my_addR9my_structRKS_(%struct.my_struct* dereferenceable(40) %arrayidx, %struct.my_struct* dereferenceable(40) %arrayidx3)
  br label %for.inc

...
; CHECK:  [[PARAM1:%[^ ]+]] = addrspacecast %class.A addrspace(1)* %priv.cpy.dest.ptr to %class.A addrspace(4)*
; CHECK:  [[PARAM2:%[^ ]+]] = addrspacecast %class.A* %priv.cpy.src.ptr to %class.A addrspace(4)*
; CHECK:  call spir_func void @_ZTS1A.omp.copy_assign(%class.A addrspace(4)* [[PARAM1]], %class.A addrspace(4)* [[PARAM2]])
; CHECK:  [[PARAM3:%[^ ]+]] = addrspacecast %class.A* %priv.cpy.dest.ptr33 to %class.A addrspace(4)*
...
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.FIRSTPRIVATE:NONPOD"([100 x %class.A] addrspace(4)* addrspacecast ([100 x %class.A] addrspace(1)* @e to [100 x %class.A] addrspace(4)*), void (%class.A addrspace(4)*, %class.A addrspace(4)*)* @_ZTS1A.omp.copy_constr, void (%class.A addrspace(4)*)* @_ZTS1A.omp.destr), "QUAL.OMP.LASTPRIVATE:NONPOD"([100 x %class.A] addrspace(4)* addrspacecast ([100 x %class.A] addrspace(1)* @e to [100 x %class.A] addrspace(4)*), i8* null, void (%class.A addrspace(4)*, %class.A addrspace(4)*)* @_ZTS1A.omp.copy_assign, void (%class.A addrspace(4)*)* @_ZTS1A.omp.destr), "QUAL.OMP.NORMALIZED.IV"(i32 addrspace(4)* %.omp.iv.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.lb.ascast), "QUAL.OMP.NORMALIZED.UB"(i32 addrspace(4)* %.omp.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %d.ascast) ]
...
; Function Attrs: convergent noinline nounwind uwtable
declare void @_ZTS1A.omp.copy_assign(%class.A addrspace(4)* %0, %class.A addrspace(4)* %1) #2
...
!0 = !{i32 0, i32 66313, i32 154402823, !"_Z3fn1v", i32 10, i32 0, i32 0}

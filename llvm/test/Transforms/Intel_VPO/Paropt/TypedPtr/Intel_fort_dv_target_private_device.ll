...
bb21:                                             ; preds = %alloca
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TO"(%"QNCA_a0$i32 addrspace(4)*$rank1$" addrspace(1)* @"main_$A", %"QNCA_a0$i32 addrspace(4)*$rank1$" addrspace(1)* @"main_$A", i64 72, i64 32),
    "QUAL.OMP.MAP.TO:CHAIN"(%"QNCA_a0$i32 addrspace(4)*$rank1$" addrspace(1)* @"main_$A", i32 addrspace(4)* addrspace(4)* %next, i64 64, i64 281474976710657),
    "QUAL.OMP.MAP.TO:CHAIN"(%"QNCA_a0$i32 addrspace(4)*$rank1$" addrspace(1)* @"main_$A", i32 addrspace(4)* %addr0.val, i64 12, i64 281474976710673),
...
declare i64 addrspace(1)* @llvm.intel.subscript.p1i64.i64.i32.p1i64.i32(i8, i64, i32, i64 addrspace(1)*, i32)
declare i32 @for_alloc_allocatable(i64, i8**, i32)
declare i32 addrspace(4)* @llvm.intel.subscript.p4i32.i64.i64.p4i32.i64(i8, i64, i64, i32 addrspace(4)*, i64)

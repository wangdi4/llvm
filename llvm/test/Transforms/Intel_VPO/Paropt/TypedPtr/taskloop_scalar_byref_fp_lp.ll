...
; ModuleID = 'taskloop_scalar_byref_fp_lp.cpp'
...
entry:
  ...
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASKLOOP"(), "QUAL.OMP.LASTPRIVATE:BYREF"(i32** %a.addr), "QUAL.OMP.FIRSTPRIVATE:BYREF"(i32** %a.addr), "QUAL.OMP.FIRSTPRIVATE"(i64* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i64* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i) ]

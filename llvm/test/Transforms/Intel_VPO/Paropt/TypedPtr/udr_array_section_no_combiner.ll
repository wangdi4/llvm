; RUN: opt -opaque-pointers=0 -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -S %s | FileCheck %s
...
; This test checks assertion is failed if there is no combiner for UDR.
;
...
; ModuleID = 'udr_array_section.cpp'
source_filename = "udr_array_section.cpp"
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_cfb28f0ac03fe018acd8fdbeebb430b5, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_cfb28f0ac03fe018acd8fdbeebb430b5, i64 0, i64 %idxprom
  ...
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_cfb28f0ac03fe018acd8fdbeebb430b5, i64 0, i64 %idxprom1
  %b = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx2, i32 0, i32 1
  store i32 %mul, i32* %b, align 4
  %6 = load i32, i32* %i, align 4
  %idxprom3 = sext i32 %6 to i64
  %arrayidx4 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_cfb28f0ac03fe018acd8fdbeebb430b5, i64 0, i64 %idxprom3
  %a5 = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx4, i32 0, i32 0
  store i32 0, i32* %a5, align 8
  %7 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_cfb28f0ac03fe018acd8fdbeebb430b5, i64 0, i64 %idxprom6
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_f_pasP9my_struct(%struct.my_struct* getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_cfb28f0ac03fe018acd8fdbeebb430b5, i64 0, i64 0))
  ret i32 0
}

...
; CHECK: [[DV_SIZE:%[^ ]+]] = call i64 @_f90_dope_vector_init2(i8* [[DV_PRIV_CAST]], i8* bitcast (%"QNCA_a0$i32*$rank1$"* @"main_$X" to i8*))
...
bb3:                                              ; preds = %alloca_0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE:F90_DV"(%"QNCA_a0$i32*$rank1$"* @"main_$X"),
    "QUAL.OMP.PRIVATE"(i64* %"var$5"),
    "QUAL.OMP.PRIVATE"(i32* %"var$4"),
    "QUAL.OMP.PRIVATE"(i64* %"var$3"),

...
bb:
  ...
  store i32 1, i32* %tmp3, align 4, !tbaa !5
  %tmp4 = alloca i32, align 4, !llfort.type_idx !4
  store i32 1000, i32* %tmp4, align 4, !tbaa !5
  %tmp5 = alloca i32, align 4, !llfort.type_idx !4
  store i32 1, i32* %tmp5, align 4, !tbaa !5
  %tmp6 = alloca i32, align 4, !llfort.type_idx !4
  %tmp7 = alloca i32, align 4, !llfort.type_idx !4
  store i32 0, i32* %tmp7, align 4, !tbaa !5
  %tmp8 = alloca i32, align 4, !llfort.type_idx !4
  %tmp9 = load i32, i32* %tmp4, align 4, !tbaa !5
  %tmp10 = load i32, i32* %tmp3, align 4, !tbaa !5
  %tmp11 = sub nsw i32 %tmp9, %tmp10
  %tmp12 = load i32, i32* %tmp5, align 4, !tbaa !5
  %tmp13 = add nsw i32 %tmp11, %tmp12
  %tmp14 = load i32, i32* %tmp5, align 4, !tbaa !5
  %tmp15 = sdiv i32 %tmp13, %tmp14
  %tmp16 = sub nsw i32 %tmp15, 1
  store i32 %tmp16, i32* %tmp8, align 4, !tbaa !5
  br label %bb33
...
bb30:  ; preds = %bb35
  %tmp31 = call token @llvm.directive.region.entry() [ "DIR.OMP.TILE"(),
     ...
     "QUAL.OMP.NORMALIZED.IV"(i32* %tmp6),
     "QUAL.OMP.NORMALIZED.UB"(i32* %tmp8),
     "QUAL.OMP.LIVEIN"(i32* %tmp7) ]
  %tmp32 = load i32, i32* %tmp7, align 4, !tbaa !5
  store i32 %tmp32, i32* %tmp6, align 4, !tbaa !5
  br label %bb17

bb17:  ; preds = %bb21, %bb30
  %tmp18 = load i32, i32* %tmp6, align 4, !tbaa !5
  %tmp19 = load i32, i32* %tmp8, align 4, !tbaa !5
  %tmp20 = icmp sle i32 %tmp18, %tmp19
  br i1 %tmp20, label %bb21, label %bb29

bb21:  ; preds = %bb17
  %tmp22 = load i32, i32* %tmp6, align 4, !tbaa !5
  %tmp23 = load i32, i32* %tmp5, align 4, !tbaa !5
  %tmp24 = mul nsw i32 %tmp22, %tmp23
  %tmp25 = load i32, i32* %tmp3, align 4, !tbaa !5
  %tmp26 = add nsw i32 %tmp24, %tmp25
  store i32 %tmp26, i32* %tmp2, align 8, !tbaa !8
  call void @baz(i32* %tmp2), !llfort.type_idx !10
  %tmp27 = load i32, i32* %tmp6, align 4, !tbaa !5
  %tmp28 = add nsw i32 %tmp27, 1
  store i32 %tmp28, i32* %tmp6, align 4, !tbaa !5
  br label %bb17
...
; Function Attrs: nounwind uwtable
define internal void @baz(i32* %arg) #2 {
bb:
  call void (...) @snork(i32* %arg)
  ret void

...
; assignment and destructor for fixed size array type with lastprivate clause.
; class A
; {
; public:
;   A();
...
; ModuleID = 'lastpriv_fixed_size_array.cpp'
source_filename = "lastpriv_fixed_size_array.cpp"
...
arrayctor.cont:                                   ; preds = %arrayctor.loop
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.LASTPRIVATE:NONPOD"([100 x %class.A]* %e, %class.A* (%class.A*)* @_ZTS1A.omp.def_constr, void (%class.A*, %class.A*)* @_ZTS1A.omp.copy_assign, void (%class.A*)* @_ZTS1A.omp.destr), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %d) ]
  %1 = load i32, i32* %.omp.lb, align 4
  store i32 %1, i32* %.omp.iv, align 4
  br label %omp.inner.for.cond

; Constructor
; CHECK:  %[[CONSTR_BEGIN:[^,]+]] = getelementptr inbounds [100 x %class.A], [100 x %class.A]* %e.lpriv, i32 0, i32 0
...
; Copy Assignment
; CHECK:  %[[TO:[^,]+]] = getelementptr inbounds [100 x %class.A], [100 x %class.A]* %e, i32 0, i32 0
; CHECK-NEXT:  %[[FROM:[^,]+]] = getelementptr inbounds [100 x %class.A], [100 x %class.A]* %e.lpriv, i32 0, i32 0
...
; Destructor
; CHECK:  %[[DESTR_BEGIN:[^,]+]] = getelementptr inbounds [100 x %class.A], [100 x %class.A]* %e.lpriv, i32 0, i32 0

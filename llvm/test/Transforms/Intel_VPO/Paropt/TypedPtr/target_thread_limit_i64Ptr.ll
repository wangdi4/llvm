...
; HST:  store i64 [[N:%n]], i64* [[NADDR]], align 8
; HST: [[NADDRVAL:%n.addr.val]] = load i64, i64* [[NADDR]], align 8
; HST: [[TMP9:%.+]] = load i64, i64* [[NADDR]], align 8
; HST: [[THREADLIMIT:%.+]] = trunc i64 [[TMP9]] to i32
; HST: call i32 @__tgt_target_teams(i64 %8, i8* [[ID4]], i32 1, i8** {{.*}}, i8** {{.*}}, i64* {{.*}}, i64* {{.*}}, i32 -1, i32 [[THREADLIMIT]])
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE"(i64* %n.addr),
    "QUAL.OMP.THREAD_LIMIT"(i64* %n.addr) ]

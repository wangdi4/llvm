...
entry:
  ...
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(double addrspace(4)* %vla.ascast, double 0.000000e+00, i64 %1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(i64 addrspace(4)* %omp.vla.tmp.ascast, i64 0, i32 1) ]

  %4 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.PRIVATE:TYPED"(double addrspace(4)* %vla.ascast, double 0.000000e+00, i64 %1),
    "QUAL.OMP.SHARED"(i64 addrspace(4)* %omp.vla.tmp.ascast) ]

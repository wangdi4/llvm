; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -S -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt %s | FileCheck %s

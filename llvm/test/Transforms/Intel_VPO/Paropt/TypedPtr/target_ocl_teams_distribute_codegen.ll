...
entry:
  ...
  %7 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TO"([100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @A to [100 x [100 x i32]] addrspace(4)*), [100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @A to [100 x [100 x i32]] addrspace(4)*), i64 40000, i64 33, i8* null, i8* null),
    "QUAL.OMP.MAP.TO"([100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @B to [100 x [100 x i32]] addrspace(4)*), [100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @B to [100 x [100 x i32]] addrspace(4)*), i64 40000, i64 33, i8* null, i8* null),
    "QUAL.OMP.MAP.TOFROM"([100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @C to [100 x [100 x i32]] addrspace(4)*), [100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @C to [100 x [100 x i32]] addrspace(4)*), i64 40000, i64 35, i8* null, i8* null),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %6),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %5),
  ...
  %8 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    ...
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %5),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %4),
    "QUAL.OMP.SHARED"([100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @A to [100 x [100 x i32]] addrspace(4)*)),
    "QUAL.OMP.SHARED"([100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @B to [100 x [100 x i32]] addrspace(4)*)),
    "QUAL.OMP.SHARED"([100 x [100 x i32]] addrspace(4)* addrspacecast ([100 x [100 x i32]] addrspace(1)* @C to [100 x [100 x i32]] addrspace(4)*)),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %0),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %1) ]

...
DIR.OMP.TASK.4:                                   ; preds = %DIR.OMP.SINGLE.3
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(),
    "QUAL.OMP.PRIVATE:NONPOD"(%class.c* %c1, %class.c* (%class.c*)* @_ZTS1c.omp.def_constr, void (%class.c*)* @_ZTS1c.omp.destr) ]
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %DIR.OMP.TASKLOOP.12
  ...
  %10 = load i64, i64* %.omp.ub, align 8
...
declare void @_ZN1cC2Ev(%class.c* %this)
declare %class.c* @_ZTS1c.omp.def_constr(%class.c*)
declare void @_ZTS1c.omp.destr(%class.c*)
declare void @_ZN1cD2Ev(%class.c* %this)

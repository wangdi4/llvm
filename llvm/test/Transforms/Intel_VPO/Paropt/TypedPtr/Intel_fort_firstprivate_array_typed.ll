...
define void @foo_(i32* dereferenceable(4) %"foo_$A") {
alloca_0:
  ...
  store i32 10, i32* %omp.pdo.end, align 1
...
omp.pdo.body4:                                    ; preds = %omp.pdo.cond3
  ...
  store i32 %add.1, i32* %"foo_$I", align 1
  %"foo_$I_fetch.10" = load i32, i32* %"foo_$I", align 1
  ...
  %"foo_$B[]_fetch.11" = load i32, i32* %"foo_$B[]", align 1
  %"foo_$I_fetch.12" = load i32, i32* %"foo_$I", align 1
  ...
  store i32 %"foo_$B[]_fetch.11", i32* %"foo_$A_entry[]", align 1
  %omp.pdo.norm.iv_fetch.13 = load i64, i64* %omp.pdo.norm.iv, align 1
  %add.2 = add nsw i64 %omp.pdo.norm.iv_fetch.13, 1
  store i64 %add.2, i64* %omp.pdo.norm.iv, align 1
  br label %omp.pdo.cond3

bb_new6:                                          ; preds = %alloca_0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.SHARED"([10 x i32]* %"foo_$A_entry"),
    "QUAL.OMP.PRIVATE:TYPED"(i32* %"foo_$I", i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"([10 x i32]* %"foo_$B", i32 0, i32 10),
    "QUAL.OMP.SHARED"(i32* %omp.pdo.step),
    "QUAL.OMP.SHARED"(i32* %omp.pdo.end),
    "QUAL.OMP.SHARED"(i32* %omp.pdo.start),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(i64* %omp.pdo.norm.lb, i64 0, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(i64* %omp.pdo.norm.iv, i64 0),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(i64* %omp.pdo.norm.ub, i64 0) ]

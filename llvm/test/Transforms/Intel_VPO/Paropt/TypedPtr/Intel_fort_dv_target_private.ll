...
define void @main_IP_foo_(%"QNCA_a0$i32*$rank1$.0"* dereferenceable(72) %A) {
alloca:
  br label %bb31
...
bb31:                                             ; preds = %alloca
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TO"(%"QNCA_a0$i32*$rank1$.0"* %A, %"QNCA_a0$i32*$rank1$.0"* %A, i64 72, i64 33),
    "QUAL.OMP.PRIVATE:F90_DV"(%"QNCA_a0$i32*$rank1$.0"* %A) ]

...
entry:
  ...
  call spir_func void @sincosf(float noundef 2.000000e+00, float addrspace(4)* noundef %fs.ascast, float addrspace(4)* noundef %fc.ascast)
;
...
; CHECK: store float [[SINE0]], float addrspace(4)* %fs.ascast, align 4
  ...
  call spir_func void @sincos(double noundef 3.000000e+00, double addrspace(4)* noundef %ds.ascast, double addrspace(4)* noundef %dc.ascast)
;
...
declare spir_func void @sincosf(float noundef, float addrspace(4)* noundef, float addrspace(4)* noundef)
;
; CHECK: declare dso_local spir_func float @_Z18__spirv_ocl_sincosfPf(float, float addrspace(4)*)
;

declare spir_func void @sincos(double noundef, double addrspace(4)* noundef, double addrspace(4)* noundef)
;

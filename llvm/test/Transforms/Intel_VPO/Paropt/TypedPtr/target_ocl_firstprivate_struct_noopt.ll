...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.TO"(%struct.s1 addrspace(4)* %a.ascast, %struct.s1 addrspace(4)* %a.ascast, i64 80, i64 161, i8* null, i8* null),
    "QUAL.OMP.MAP.TOFROM"(double addrspace(4)* %s.ascast, double addrspace(4)* %s.ascast, i64 8, i64 35, i8* null, i8* null),
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.SHARED"(%struct.s1 addrspace(4)* %a.ascast),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %d = getelementptr inbounds %struct.s1, %struct.s1 addrspace(4)* %a.ascast, i32 0, i32 0
  %7 = load i32, i32 addrspace(4)* %i.ascast, align 4, !tbaa !13
  %idxprom = sext i32 %7 to i64
  %arrayidx = getelementptr inbounds [10 x double], [10 x double] addrspace(4)* %d, i64 0, i64 %idxprom
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %d2 = getelementptr inbounds %struct.s1, %struct.s1 addrspace(4)* %a.ascast, i32 0, i32 0
  %arrayidx3 = getelementptr inbounds [10 x double], [10 x double] addrspace(4)* %d2, i64 0, i64 0
  %9 = load double, double addrspace(4)* %arrayidx3, align 8, !tbaa !19
  %d4 = getelementptr inbounds %struct.s1, %struct.s1 addrspace(4)* %a.ascast, i32 0, i32 0
  %arrayidx5 = getelementptr inbounds [10 x double], [10 x double] addrspace(4)* %d4, i64 0, i64 9

...
define dso_local i32 @main() personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    ...
    "QUAL.OMP.SHARED"(float* @"?running_calc@@3MA"),
    "QUAL.OMP.PRIVATE"(i32* %t),
  ...
  invoke void @_CxxThrowException(i8* %1, %eh.ThrowInfo* @_TI1H)
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %12 = call token @llvm.directive.region.entry() [ "DIR.OMP.ORDERED"(),
...
terminate:                                        ; preds = %catch.dispatch
  ...
  call void @__std_terminate() [ "funclet"(token %17) ]
  unreachable
}

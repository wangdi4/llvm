...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0), "QUAL.OMP.MAP.TOFROM"(i32* %x.addr) ]
...
!0 = !{i32 0, i32 2052, i32 85987128, !"foo", i32 2, i32 0, i32 0}

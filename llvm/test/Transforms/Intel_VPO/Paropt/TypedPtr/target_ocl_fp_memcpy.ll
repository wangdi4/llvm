...
entry:
  %x = alloca [10 x i32 addrspace(4)*], align 8
  %x.ascast = addrspacecast [10 x i32 addrspace(4)*]* %x to [10 x i32 addrspace(4)*] addrspace(4)*
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE"([10 x i32 addrspace(4)*] addrspace(4)* %x.ascast),
    "QUAL.OMP.MAP.TO"([10 x i32 addrspace(4)*] addrspace(4)* %x.ascast, [10 x i32 addrspace(4)*] addrspace(4)* %x.ascast, i64 80, i64 161),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx = getelementptr inbounds [10 x i32 addrspace(4)*], [10 x i32 addrspace(4)*] addrspace(4)* %x.ascast, i64 0, i64 %idxprom
  store i32 addrspace(4)* null, i32 addrspace(4)* addrspace(4)* %arrayidx, align 8

...
define void @test_(%"QNCA_a0$i32*$rank1$"* dereferenceable(72) "assumed_shape" "ptrnoalias" %"test_$B$argptr") {
alloca_0:
...
bb_new6:                                          ; preds = %alloca_0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(),
    "QUAL.OMP.LINEAR"(i32* %"test_$I", i32 1),
    "QUAL.OMP.REDUCTION.ADD:F90_DV"(%"QNCA_a0$i32*$rank1$"* %"test_$B.1"),
...
bb_new7:                                          ; preds = %bb_new6
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(),
    "QUAL.OMP.LINEAR:IV"(i32* %"test_$I", i32 1),
    "QUAL.OMP.REDUCTION.ADD:F90_DV"(%"QNCA_a0$i32*$rank1$"* %"test_$B.1") ]

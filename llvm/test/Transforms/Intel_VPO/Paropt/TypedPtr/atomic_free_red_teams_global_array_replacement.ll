; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt -S -vpo-paropt-atomic-free-reduction-slm=false -vpo-paropt-atomic-free-reduction-par-global=true <%s | FileCheck %s
...
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt -S -vpo-paropt-atomic-free-reduction-slm=true -vpo-paropt-atomic-free-reduction-par-global=true <%s | FileCheck %s
...
; CHECK: store i32 111, i32 addrspace(1)* %i1, align 4
...
bb2:                                              ; preds = %bb1
  %tmp3 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.REDUCTION.ADD"([5 x i32] addrspace(1)* @b) ]

  %i = addrspacecast [5 x i32] addrspace(1)* @b to [5 x i32] addrspace(4)*
  %i1 = getelementptr inbounds [5 x i32], [5 x i32] addrspace(4)* %i, i64 0, i64 1
  store i32 111, i32 addrspace(4)* %i1, align 4
  br label %bb4

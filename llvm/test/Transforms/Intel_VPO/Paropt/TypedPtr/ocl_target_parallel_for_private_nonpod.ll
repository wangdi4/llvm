...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.PRIVATE:NONPOD"(%class.C addrspace(4)* %c.ascast, %class.C addrspace(4)* (%class.C addrspace(4)*)* @_ZTS1C.omp.def_constr, void (%class.C addrspace(4)*)* @_ZTS1C.omp.destr),
...
declare hidden spir_func void @_ZN1CC2Ev(%class.C addrspace(4)* %this) unnamed_addr align 2
declare token @llvm.directive.region.entry()
declare void @llvm.directive.region.exit(token)
declare %class.C addrspace(4)* @_ZTS1C.omp.def_constr(%class.C addrspace(4)* %0)
declare void @_ZTS1C.omp.destr(%class.C addrspace(4)* %0)

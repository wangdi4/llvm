...
; ModuleID = 'omp45_array_section_reduction_1d_udr_with_init_ref.cpp'
source_filename = "omp45_array_section_reduction_1d_udr_with_init_ref.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.my_struct = type { i32, i32 }

@_ZL1x_570f3f42c79ac1417d7f8563e7091082 = internal global [100 x %struct.my_struct] zeroinitializer, align 16
@_ZL1y_570f3f42c79ac1417d7f8563e7091082 = internal global [100 x %struct.my_struct] zeroinitializer, align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z17cq415166_1d_f_refRA100_9my_struct([100 x %struct.my_struct]* dereferenceable(800) %yref) #1 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_570f3f42c79ac1417d7f8563e7091082, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_570f3f42c79ac1417d7f8563e7091082, i64 0, i64 %idxprom
  ...
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_570f3f42c79ac1417d7f8563e7091082, i64 0, i64 %idxprom1
  %b = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx2, i32 0, i32 1
  store i32 %mul, i32* %b, align 4
  %6 = load i32, i32* %i, align 4
  %idxprom3 = sext i32 %6 to i64
  %arrayidx4 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_570f3f42c79ac1417d7f8563e7091082, i64 0, i64 %idxprom3
  %a5 = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx4, i32 0, i32 0
  store i32 0, i32* %a5, align 8
  %7 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_570f3f42c79ac1417d7f8563e7091082, i64 0, i64 %idxprom6
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_f_refRA100_9my_struct([100 x %struct.my_struct]* dereferenceable(800) @_ZL1y_570f3f42c79ac1417d7f8563e7091082)
  ret i32 0
}

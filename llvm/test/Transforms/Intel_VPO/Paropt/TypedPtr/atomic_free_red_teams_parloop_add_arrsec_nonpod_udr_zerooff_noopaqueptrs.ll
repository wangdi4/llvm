...
; CHECK: define weak dso_local spir_kernel void @__omp_offloading{{.*}}main{{.*}}([2 x %struct.Obj] addrspace(1)* %[[RESULT_PTR:sum.*]], %struct.Obj addrspace(1)* %[[RED_GLOBAL_BUF:red_buf.*]], i32 addrspace(1)* %[[TEAMS_COUNTER_PTR:teams_counter.*]], i64 %.omp.lb
...
; CHECK: %[[LOCAL_SUM_PTR_CAST:[^,]+]] = bitcast %struct.Obj addrspace(1)* %[[LOCAL_SUM_GEP]] to [2 x %struct.Obj] addrspace(1)*
; CHECK: %[[RED_VAR_PTR_CAST:[^,]+]] = bitcast [2 x %struct.Obj] addrspace(1)* %[[LOCAL_SUM_PTR_CAST]] to %struct.Obj addrspace(1)*
; CHECK: %[[RED_VAR_PTR_CAST_ASCAST:[^,]+]] = addrspacecast %struct.Obj addrspace(1)* %[[RED_VAR_PTR_CAST]] to %struct.Obj addrspace(4)*
; CHECK-LABEL: atomic.free.red.local.update.update.body:
; CHECK: call spir_func void @.omp_combiner{{.*}}(%struct.Obj addrspace(4)* %[[RED_VAR_PTR_CAST_ASCAST]]
...
entry:
  ...
  %sum = alloca [2 x %struct.Obj], align 4
  ...
  %sum.ascast = addrspacecast [2 x %struct.Obj]* %sum to [2 x %struct.Obj] addrspace(4)*
  ...
  %arrayinit.begin = getelementptr inbounds [2 x %struct.Obj], [2 x %struct.Obj] addrspace(4)* %sum.ascast, i64 0, i64 0
  call spir_func void @_ZN3ObjIiEC2Ei(%struct.Obj addrspace(4)* noundef align 4 dereferenceable_or_null(8) %arrayinit.begin, i32 noundef 0) #6
  %arrayinit.start = getelementptr inbounds %struct.Obj, %struct.Obj addrspace(4)* %arrayinit.begin, i64 1
  %arrayinit.end = getelementptr inbounds %struct.Obj, %struct.Obj addrspace(4)* %arrayinit.begin, i64 2
  br label %arrayinit.body

arrayinit.body:                                   ; preds = %arrayinit.body, %entry
  %arrayinit.cur = phi %struct.Obj addrspace(4)* [ %arrayinit.start, %entry ], [ %arrayinit.next, %arrayinit.body ]
  call spir_func void @_ZN3ObjIiEC2Ev(%struct.Obj addrspace(4)* noundef align 4 dereferenceable_or_null(8) %arrayinit.cur) #6
  %arrayinit.next = getelementptr inbounds %struct.Obj, %struct.Obj addrspace(4)* %arrayinit.cur, i64 1
  %arrayinit.done = icmp eq %struct.Obj addrspace(4)* %arrayinit.next, %arrayinit.end
...
arrayinit.end1:                                   ; preds = %arrayinit.body
  ...
  %arrayidx = getelementptr inbounds [2 x %struct.Obj], [2 x %struct.Obj] addrspace(4)* %sum.ascast, i64 0, i64 0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.MAP.TOFROM"([2 x %struct.Obj] addrspace(4)* %sum.ascast, %struct.Obj addrspace(4)* %arrayidx, i64 8, i64 547, i8* null, i8* null), ; MAP type: 547 = 0x223 = IMPLICIT (0x200) | TARGET_PARAM (0x20) | FROM (0x2) | TO (0x1)
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.REDUCTION.UDR:ARRSECT.TYPED"([2 x %struct.Obj] addrspace(4)* %sum.ascast, %struct.Obj zeroinitializer, i64 1, i64 0, %struct.Obj addrspace(4)* (%struct.Obj addrspace(4)*)* @_ZTS3ObjIiE.omp.def_constr, void (%struct.Obj addrspace(4)*)* @_ZTS3ObjIiE.omp.destr, void (%struct.Obj addrspace(4)*, %struct.Obj addrspace(4)*)* @.omp_combiner..1, i8* null),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.iv.ascast, i32 0, i32 1),
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %arrayinit.end1
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx2 = getelementptr inbounds [2 x %struct.Obj], [2 x %struct.Obj] addrspace(4)* %sum.ascast, i64 0, i64 0
  %call = call spir_func noundef align 4 dereferenceable(8) %struct.Obj addrspace(4)* @_ZN3ObjIiEpLES0_(%struct.Obj addrspace(4)* noundef align 4 dereferenceable_or_null(8) %arrayidx2, %struct.Obj addrspace(4)* noundef byval(%struct.Obj) align 4 %agg.tmp.ascast) #7

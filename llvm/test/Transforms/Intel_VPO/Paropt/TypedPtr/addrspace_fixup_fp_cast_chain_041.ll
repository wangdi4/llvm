; RUN: opt -opaque-pointers=0 -switch-to-offload -bugpoint-enable-legacy-pm -vpo-cfg-restructuring -vpo-paropt -S %s | FileCheck %s
...
; CHECK: store i32 222, i32* %x1.fpriv
...
entry:
  %x4 = addrspacecast i32 addrspace(1)* @x to i32 addrspace(4)*
  %x1 = addrspacecast i32 addrspace(4)* %x4 to i32 addrspace(1)*

  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 1),
    "QUAL.OMP.FIRSTPRIVATE:WILOCAL.TYPED"(i32 addrspace(1)* %x1, i32 0, i32 1),
    "QUAL.OMP.THREAD_LIMIT"(i32 2) ]

  %x14 = addrspacecast i32 addrspace(1)* %x1 to i32 addrspace(4)*
  %x141 = addrspacecast i32 addrspace(4)* %x14 to i32 addrspace(1)*
  %x1414 = addrspacecast i32 addrspace(1)* %x141 to i32 addrspace(4)*
  %x14141 = addrspacecast i32 addrspace(4)* %x1414 to i32 addrspace(1)*
  store i32 222, i32 addrspace(1)* %x14141, align 4
...
!1 = !{i32 1, !"_Z1x", i32 0, i32 0, i32 addrspace(1)* @x}

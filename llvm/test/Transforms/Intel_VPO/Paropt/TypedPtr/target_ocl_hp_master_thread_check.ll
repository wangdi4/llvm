...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %x.ascast),
    ...
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %atomic-temp.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %atomic-temp1.ascast) ]
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %x.ascast),

; REQUIRES: asserts
; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-loop-collapse -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -debug-only=vpo-paropt-transform -S %s 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers=0 -passes='function(vpo-cfg-restructuring,vpo-paropt-loop-collapse,vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -switch-to-offload --debug-only=vpo-paropt-transform -S %s 2>&1 | FileCheck %s
...
define hidden spir_func void @_Z4testPiiS_(i32 addrspace(4)* noundef %a, i32 noundef %n, i32 addrspace(4)* noundef %res) #0 {
entry:
  %a.addr = alloca i32 addrspace(4)*, align 8
  %n.addr = alloca i32, align 4
  %res.addr = alloca i32 addrspace(4)*, align 8
  %.capture_expr.0 = alloca i32, align 4
  %.capture_expr.1 = alloca i32, align 4
  %.omp.lb = alloca i32, align 4
  %.omp.ub = alloca i32, align 4
  %res.map.ptr.tmp = alloca i32 addrspace(4)*, align 8
  ...
  %res.addr.ascast = addrspacecast i32 addrspace(4)** %res.addr to i32 addrspace(4)* addrspace(4)*
  ...
  %res.map.ptr.tmp.ascast = addrspacecast i32 addrspace(4)** %res.map.ptr.tmp to i32 addrspace(4)* addrspace(4)*
  ...
  store i32 addrspace(4)* %res, i32 addrspace(4)* addrspace(4)* %res.addr.ascast, align 8
  ...
  %3 = load i32 addrspace(4)*, i32 addrspace(4)* addrspace(4)* %res.addr.ascast, align 8
  %4 = load i32 addrspace(4)*, i32 addrspace(4)* addrspace(4)* %a.addr.ascast, align 8
  %5 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %3, i32 addrspace(4)* %3, i64 0, i64 544, i8* null, i8* null), ; MAP type: 544 = 0x220 = IMPLICIT (0x200) | TARGET_PARAM (0x20)
    "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %4, i32 addrspace(4)* %4, i64 0, i64 544, i8* null, i8* null), ; MAP type: 544 = 0x220 = IMPLICIT (0x200) | TARGET_PARAM (0x20)
    ...
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(i32 addrspace(4)* %.capture_expr.0.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* addrspace(4)* %res.map.ptr.tmp.ascast, i32 addrspace(4)* null, i32 1),
  ...
  store i32 addrspace(4)* %3, i32 addrspace(4)* addrspace(4)* %res.map.ptr.tmp.ascast, align 8
  store i32 addrspace(4)* %4, i32 addrspace(4)* addrspace(4)* %a.map.ptr.tmp.ascast, align 8
  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    ...
    "QUAL.OMP.SHARED:TYPED"(i32 addrspace(4)* addrspace(4)* %res.map.ptr.tmp.ascast, i32 addrspace(4)* null, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.iv.ascast, i32 0, i32 1),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %i.ascast, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(i32 addrspace(4)* %.capture_expr.0.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %tmp.ascast, i32 0, i32 1) ]

  %7 = load i32, i32 addrspace(4)* %.capture_expr.0.ascast, align 4
...
omp.precond.then:                                 ; preds = %entry
  ...
  %9 = load i32, i32 addrspace(4)* %.omp.lb.ascast, align 4
  store i32 %9, i32 addrspace(4)* %.omp.iv.ascast, align 4
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %omp.precond.then
  %10 = load i32, i32 addrspace(4)* %.omp.iv.ascast, align 4
  %11 = load i32, i32 addrspace(4)* %.omp.ub.ascast, align 4
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx = getelementptr inbounds i32, i32 addrspace(4)* %13, i64 %idxprom
  %15 = load i32, i32 addrspace(4)* %arrayidx, align 4
  %16 = load i32 addrspace(4)*, i32 addrspace(4)* addrspace(4)* %res.map.ptr.tmp.ascast, align 8
  %17 = load i32, i32 addrspace(4)* %i.ascast, align 4
  %idxprom5 = sext i32 %17 to i64
  %arrayidx6 = getelementptr inbounds i32, i32 addrspace(4)* %16, i64 %idxprom5
  %18 = load i32, i32 addrspace(4)* %arrayidx6, align 4
  %add7 = add nsw i32 %18, %15
  store i32 %add7, i32 addrspace(4)* %arrayidx6, align 4

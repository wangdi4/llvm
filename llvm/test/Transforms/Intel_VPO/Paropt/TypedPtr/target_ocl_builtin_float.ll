...
define dso_local spir_kernel void @__omp_offloading_fd02_d323ad_main_l46([20 x float] addrspace(1)* %array) #0 {
newFuncRoot:
  br label %for.end
...
declare dso_local spir_func void @sincosf(float, float addrspace(4)*, float addrspace(4)*)

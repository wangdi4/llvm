; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-loop-collapse -S %s | FileCheck %s
; RUN: opt -opaque-pointers=0 -passes='function(vpo-cfg-restructuring,vpo-paropt-loop-collapse)' -switch-to-offload -S %s | FileCheck %s
...
; CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED.WILOCAL"(i64 addrspace(4)* [[LB:%omp.collapsed.lb[^ ,]*]], i64 0, i32 1)
; CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED.WILOCAL"(i64 addrspace(4)* [[UB:%omp.collapsed.ub[^ ,]*]], i64 0, i32 1)
; CHECK-SAME: "QUAL.OMP.PRIVATE:TYPED"(i64 addrspace(4)* [[IV:%omp.collapsed.iv[^ ,]*]], i64 0, i32 1)
; CHECK-SAME: "QUAL.OMP.OFFLOAD.NDRANGE"(i64 addrspace(4)* [[UB]], i64 0)

; CHECK:      "DIR.OMP.TEAMS"()
; CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED.WILOCAL"(i64 addrspace(4)* [[LB]], i64 0, i32 1)
; CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED.WILOCAL"(i64 addrspace(4)* [[UB]], i64 0, i32 1)
; CHECK-SAME: "QUAL.OMP.PRIVATE:TYPED"(i64 addrspace(4)* [[IV]], i64 0, i32 1)

; CHECK:      "DIR.OMP.DISTRIBUTE"()
; CHECK-NOT:  "QUAL.OMP.NORMALIZED.IV"(i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, i32 addrspace(4)* %.omp.uncollapsed.iv4.ascast)
; CHECK-NOT:  "QUAL.OMP.NORMALIZED.UB"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, i32 addrspace(4)* %.omp.uncollapsed.ub2.ascast)
; CHECK-SAME: "QUAL.OMP.NORMALIZED.IV:TYPED"(i64 addrspace(4)* [[IV]], i64 0)
; CHECK-SAME: "QUAL.OMP.NORMALIZED.UB:TYPED"(i64 addrspace(4)* [[UB]], i64 0)
; CHECK-SAME: "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, i32 0, i32 1)
; CHECK-SAME: "QUAL.OMP.PRIVATE:TYPED"(i32 addrspace(4)* %.omp.uncollapsed.iv4.ascast, i32 0, i32 1)
; CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED"(i64 addrspace(4)* [[LB]], i64 0, i32 1)
; CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, i32 0, i32 1)
; CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED"(i32 addrspace(4)* %.omp.uncollapsed.ub2.ascast, i32 0, i32 1)
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %i.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv4.ascast),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb1.ascast),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.ub2.ascast),
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv.ascast),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %.omp.uncollapsed.lb.ascast),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %i.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv4.ascast),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %.omp.uncollapsed.lb1.ascast),
    "QUAL.OMP.SHARED"(i32 addrspace(4)* %.omp.uncollapsed.ub2.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %j.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp3.ascast) ]
  ...
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.DISTRIBUTE"(),
    ...
    "QUAL.OMP.NORMALIZED.IV"(i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, i32 addrspace(4)* %.omp.uncollapsed.iv4.ascast),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb.ascast),
    "QUAL.OMP.NORMALIZED.UB"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, i32 addrspace(4)* %.omp.uncollapsed.ub2.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %i.ascast),
    "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb1.ascast),
    "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %j.ascast) ]

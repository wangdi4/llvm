...
alloca_0:
  ...
  store i32 1, i32* %do.start, align 4, !tbaa !6
  %do.end = alloca i32, align 4, !llfort.type_idx !5
  store i32 48, i32* %do.end, align 4, !tbaa !6
  %do.step = alloca i32, align 4, !llfort.type_idx !5
  store i32 1, i32* %do.step, align 4, !tbaa !6
  %do.norm.lb = alloca i32, align 4, !llfort.type_idx !5
  store i32 0, i32* %do.norm.lb, align 4, !tbaa !6
  %do.norm.ub = alloca i32, align 4, !llfort.type_idx !5
  %do.end_fetch.11 = load i32, i32* %do.end, align 4, !tbaa !6
  %do.start_fetch.12 = load i32, i32* %do.start, align 4, !tbaa !6
  %sub.3 = sub nsw i32 %do.end_fetch.11, %do.start_fetch.12
  %do.step_fetch.13 = load i32, i32* %do.step, align 4, !tbaa !6
  %add.3 = add nsw i32 %sub.3, %do.step_fetch.13
  %do.step_fetch.14 = load i32, i32* %do.step, align 4, !tbaa !6
  %div.2 = sdiv i32 %add.3, %do.step_fetch.14
  %sub.4 = sub nsw i32 %div.2, 1
  store i32 %sub.4, i32* %do.norm.ub, align 4, !tbaa !6
  %do.norm.iv = alloca i32, align 4, !llfort.type_idx !5
  %do.start1 = alloca i32, align 4, !llfort.type_idx !5
  store i32 1, i32* %do.start1, align 4, !tbaa !6
  %do.end2 = alloca i32, align 4, !llfort.type_idx !5
  store i32 26, i32* %do.end2, align 4, !tbaa !6
  %do.step3 = alloca i32, align 4, !llfort.type_idx !5
  store i32 1, i32* %do.step3, align 4, !tbaa !6
  %do.norm.lb4 = alloca i32, align 4, !llfort.type_idx !5
  store i32 0, i32* %do.norm.lb4, align 4, !tbaa !6
  %do.norm.ub5 = alloca i32, align 4, !llfort.type_idx !5
  %do.end_fetch.21 = load i32, i32* %do.end2, align 4, !tbaa !6
  %do.start_fetch.22 = load i32, i32* %do.start1, align 4, !tbaa !6
  %sub.5 = sub nsw i32 %do.end_fetch.21, %do.start_fetch.22
  %do.step_fetch.23 = load i32, i32* %do.step3, align 4, !tbaa !6
  %add.5 = add nsw i32 %sub.5, %do.step_fetch.23
  %do.step_fetch.24 = load i32, i32* %do.step3, align 4, !tbaa !6
  %div.3 = sdiv i32 %add.5, %do.step_fetch.24
  %sub.6 = sub nsw i32 %div.3, 1
  store i32 %sub.6, i32* %do.norm.ub5, align 4, !tbaa !6
  %do.norm.iv6 = alloca i32, align 4, !llfort.type_idx !5
  %omp.pdo.start = alloca i32, align 4, !llfort.type_idx !5
  store i32 1, i32* %omp.pdo.start, align 4, !tbaa !6
  %omp.pdo.end = alloca i32, align 4, !llfort.type_idx !5
  store i32 100, i32* %omp.pdo.end, align 4, !tbaa !6
  %omp.pdo.step = alloca i32, align 4, !llfort.type_idx !5
  store i32 1, i32* %omp.pdo.step, align 4, !tbaa !6
  %omp.pdo.norm.iv = alloca i32, align 4, !llfort.type_idx !5
  %omp.pdo.norm.lb = alloca i32, align 4, !llfort.type_idx !5
  store i32 0, i32* %omp.pdo.norm.lb, align 4, !tbaa !6
  %omp.pdo.norm.ub = alloca i32, align 4, !llfort.type_idx !5
  %omp.pdo.end_fetch.1 = load i32, i32* %omp.pdo.end, align 4, !tbaa !6
  %omp.pdo.start_fetch.2 = load i32, i32* %omp.pdo.start, align 4, !tbaa !6
  %sub.1 = sub nsw i32 %omp.pdo.end_fetch.1, %omp.pdo.start_fetch.2
  %omp.pdo.step_fetch.3 = load i32, i32* %omp.pdo.step, align 4, !tbaa !6
  %add.1 = add nsw i32 %sub.1, %omp.pdo.step_fetch.3
  %omp.pdo.step_fetch.4 = load i32, i32* %omp.pdo.step, align 4, !tbaa !6
  %div.1 = sdiv i32 %add.1, %omp.pdo.step_fetch.4
  %sub.2 = sub nsw i32 %div.1, 1
  store i32 %sub.2, i32* %omp.pdo.norm.ub, align 4, !tbaa !6
  br label %bb_new6

bb_new6:  ; preds = %alloca_0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TILE"(),
     "QUAL.OMP.SIZES"(i32 4, i32 8, i32 2),
     "QUAL.OMP.NORMALIZED.IV"(i32* %omp.pdo.norm.iv, i32* %do.norm.iv, i32* %do.norm.iv6),
     "QUAL.OMP.NORMALIZED.UB"(i32* %omp.pdo.norm.ub, i32* %do.norm.ub, i32* %do.norm.ub5),
     "QUAL.OMP.LIVEIN"(i32* %do.norm.lb4),
     "QUAL.OMP.LIVEIN"(i32* %do.norm.lb),
     "QUAL.OMP.LIVEIN"(i32* %omp.pdo.norm.lb) ]
  %omp.pdo.norm.lb_fetch.5 = load i32, i32* %omp.pdo.norm.lb, align 4, !tbaa !6
  store i32 %omp.pdo.norm.lb_fetch.5, i32* %omp.pdo.norm.iv, align 4, !tbaa !6
  br label %omp.pdo.cond3

omp.pdo.cond3:  ; preds = %do.epilog11, %bb_new6
  %omp.pdo.norm.iv_fetch.6 = load i32, i32* %omp.pdo.norm.iv, align 4, !tbaa !6
  %omp.pdo.norm.ub_fetch.7 = load i32, i32* %omp.pdo.norm.ub, align 4, !tbaa !6
...
omp.pdo.body4:  ; preds = %omp.pdo.cond3
  %omp.pdo.norm.iv_fetch.8 = load i32, i32* %omp.pdo.norm.iv, align 4, !tbaa !6
  %omp.pdo.step_fetch.9 = load i32, i32* %omp.pdo.step, align 4, !tbaa !6
  %mul.1 = mul nsw i32 %omp.pdo.norm.iv_fetch.8, %omp.pdo.step_fetch.9
  %omp.pdo.start_fetch.10 = load i32, i32* %omp.pdo.start, align 4, !tbaa !6
  %add.2 = add nsw i32 %mul.1, %omp.pdo.start_fetch.10
  store i32 %add.2, i32* %"test_$I", align 8, !tbaa !9
  %do.norm.lb_fetch.15 = load i32, i32* %do.norm.lb, align 4, !tbaa !6
  store i32 %do.norm.lb_fetch.15, i32* %do.norm.iv, align 4, !tbaa !6
  br label %do.cond9

do.cond9:  ; preds = %omp.pdo.body4, %do.epilog15
  %do.norm.iv_fetch.16 = load i32, i32* %do.norm.iv, align 4, !tbaa !6
  %do.norm.ub_fetch.17 = load i32, i32* %do.norm.ub, align 4, !tbaa !6
...
do.body10:  ; preds = %do.cond9
  %do.norm.iv_fetch.18 = load i32, i32* %do.norm.iv, align 4, !tbaa !6
  %do.step_fetch.19 = load i32, i32* %do.step, align 4, !tbaa !6
  %mul.2 = mul nsw i32 %do.norm.iv_fetch.18, %do.step_fetch.19
  %do.start_fetch.20 = load i32, i32* %do.start, align 4, !tbaa !6
  %add.4 = add nsw i32 %mul.2, %do.start_fetch.20
  store i32 %add.4, i32* %"test_$J", align 8, !tbaa !11
  %do.norm.lb4_fetch.25 = load i32, i32* %do.norm.lb4, align 4, !tbaa !6
  store i32 %do.norm.lb4_fetch.25, i32* %do.norm.iv6, align 4, !tbaa !6
  br label %do.cond13

do.cond13:  ; preds = %do.body10, %do.body14
  %do.norm.iv6_fetch.26 = load i32, i32* %do.norm.iv6, align 4, !tbaa !6
  %do.norm.ub5_fetch.27 = load i32, i32* %do.norm.ub5, align 4, !tbaa !6
...
do.body14:  ; preds = %do.cond13
  %do.norm.iv6_fetch.28 = load i32, i32* %do.norm.iv6, align 4, !tbaa !6
  %do.step3_fetch.29 = load i32, i32* %do.step3, align 4, !tbaa !6
  %mul.3 = mul nsw i32 %do.norm.iv6_fetch.28, %do.step3_fetch.29
  %do.start1_fetch.30 = load i32, i32* %do.start1, align 4, !tbaa !6
  %add.6 = add nsw i32 %mul.3, %do.start1_fetch.30
  store i32 %add.6, i32* %"test_$K", align 8, !tbaa !13
  call void @bar_.t0p.t0p.t0p(i32* %"test_$I", i32* %"test_$J", i32* %"test_$K"), !llfort.type_idx !15
  %do.norm.iv6_fetch.31 = load i32, i32* %do.norm.iv6, align 4, !tbaa !6
  %add.7 = add nsw i32 %do.norm.iv6_fetch.31, 1
  store i32 %add.7, i32* %do.norm.iv6, align 4, !tbaa !6
  br label %do.cond13

do.epilog15:  ; preds = %do.cond13
  %do.norm.iv_fetch.32 = load i32, i32* %do.norm.iv, align 4, !tbaa !6
  %add.8 = add nsw i32 %do.norm.iv_fetch.32, 1
  store i32 %add.8, i32* %do.norm.iv, align 4, !tbaa !6
  br label %do.cond9

do.epilog11:  ; preds = %do.cond9
  %omp.pdo.norm.iv_fetch.33 = load i32, i32* %omp.pdo.norm.iv, align 4, !tbaa !6
  %add.9 = add nsw i32 %omp.pdo.norm.iv_fetch.33, 1
  store i32 %add.9, i32* %omp.pdo.norm.iv, align 4, !tbaa !6
  br label %omp.pdo.cond3

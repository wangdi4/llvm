...
define void @test_01_(float* dereferenceable(4) "ptrnoalias" %"test_01_$A", float* readonly dereferenceable(4) "ptrnoalias" %"test_01_$B", i64* readonly dereferenceable(8) %"test_01_$SIZE") local_unnamed_addr {
DIR.OMP.SIMD.2:
...
DIR.OMP.SIMD.182:                                 ; preds = %DIR.OMP.SIMD.2
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(),
    "QUAL.OMP.LINEAR:IV"(i64* %"test_01_$I", i64 1),
    "QUAL.OMP.NONTEMPORAL"(float* %"var$5.addr_a0$_fetch", float* %"var$3.addr_a0$_fetch"),
    "QUAL.OMP.NORMALIZED.IV"(i64* %temp63),
    "QUAL.OMP.NORMALIZED.UB"(i64* %temp64),

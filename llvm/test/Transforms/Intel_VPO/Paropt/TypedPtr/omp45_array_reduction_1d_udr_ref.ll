...
; ModuleID = 'omp45_array_reduction_1d_udr_ref.cpp'
source_filename = "omp45_array_reduction_1d_udr_ref.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@_ZL1x_71e9ee2251ddc39142688e634fc678e6 = internal global [100 x i16] zeroinitializer, align 16
@_ZL1y_71e9ee2251ddc39142688e634fc678e6 = internal global [100 x i16] zeroinitializer, align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z17cq415166_1d_b_refRA100_s([100 x i16]* dereferenceable(200) %yref) #1 {
entry:
  %yref.addr = alloca [100 x i16]*, align 8
  %tmp = alloca i32, align 4
  %.omp.iv = alloca i32, align 4
  %.omp.lb = alloca i32, align 4
  %.omp.ub = alloca i32, align 4
  %i = alloca i32, align 4
  store [100 x i16]* %yref, [100 x i16]** %yref.addr, align 8
  store i32 0, i32* %.omp.lb, align 4
  store i32 99, i32* %.omp.ub, align 4
  %0 = load [100 x i16]*, [100 x i16]** %yref.addr, align 8
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.REDUCTION.UDR:BYREF"([100 x i16]** %yref.addr, i8* null, i8* null, void (i16*, i16*)* @.omp_combiner., i8* null), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.SHARED"([100 x i16]* @_ZL1x_71e9ee2251ddc39142688e634fc678e6) ]
...
; ALL: call void @.omp_combiner.(i16* %{{.*}}, i16* %{{.*}})
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %6 = load [100 x i16]*, [100 x i16]** %yref.addr, align 8
  %7 = load i32, i32* %i, align 4
  %div = sdiv i32 %7, 4
  %add1 = add nsw i32 25, %div
  %idxprom = sext i32 %add1 to i64
  %arrayidx = getelementptr inbounds [100 x i16], [100 x i16]* %6, i64 0, i64 %idxprom
  %8 = load i32, i32* %i, align 4
  %idxprom2 = sext i32 %8 to i64
  %arrayidx3 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_71e9ee2251ddc39142688e634fc678e6, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_71e9ee2251ddc39142688e634fc678e6, i64 0, i64 %idxprom
  store i16 1, i16* %arrayidx, align 2
  %2 = load i32, i32* %i, align 4
  %conv = trunc i32 %2 to i16
  %3 = load i32, i32* %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1y_71e9ee2251ddc39142688e634fc678e6, i64 0, i64 %idxprom1
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_b_refRA100_s([100 x i16]* dereferenceable(200) @_ZL1y_71e9ee2251ddc39142688e634fc678e6)
  ret i32 0
}

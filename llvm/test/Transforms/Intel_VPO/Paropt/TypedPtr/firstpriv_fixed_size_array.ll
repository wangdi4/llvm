...
; ModuleID = 'firstpriv_fixed_size_array.cpp'
source_filename = "firstpriv_fixed_size_array.cpp"
...
arrayctor.cont:                                   ; preds = %arrayctor.loop
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.FIRSTPRIVATE:NONPOD"([100 x %class.A]* %e, void (%class.A*, %class.A*)* @_ZTS1A.omp.copy_constr, void (%class.A*)* @_ZTS1A.omp.destr), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %d) ]
  %1 = load i32, i32* %.omp.lb, align 4
  store i32 %1, i32* %.omp.iv, align 4
  br label %omp.inner.for.cond

; Copy Constructor
; CHECK:  %[[TO:[^,]+]] = getelementptr inbounds [100 x %class.A], [100 x %class.A]* %e.fpriv, i32 0, i32 0

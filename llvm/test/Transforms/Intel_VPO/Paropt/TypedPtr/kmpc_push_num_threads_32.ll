...
; ModuleID = 'kmpc_push_num_threads.cpp'
source_filename = "kmpc_push_num_threads.cpp"
target datalayout = "e-m:e-p:32:32-f64:32:64-f80:32-n8:16:32-S128"
target triple = "i386-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define dso_local void @_Z3fooPPfx(float** %x, i64 %n) #0 {
entry:
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store float* null, float** %arrayidx, align 4, !tbaa !11

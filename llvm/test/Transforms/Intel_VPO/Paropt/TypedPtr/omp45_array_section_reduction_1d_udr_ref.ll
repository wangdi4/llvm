...
; void cq415166_1d_e_ref(TYPE (&yref)[N]) {
; #pragma omp parallel for reduction(my_reduction_add:yref[25:N/4])
;     for(int i = 0; i < N; i++) {
...
; ModuleID = 'omp45_array_section_reduction_1d_udr_ref.cpp'
source_filename = "omp45_array_section_reduction_1d_udr_ref.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@_ZL1x_9555819b599718990694fc37fe498a3b = internal global [100 x i16] zeroinitializer, align 16
@_ZL1y_9555819b599718990694fc37fe498a3b = internal global [100 x i16] zeroinitializer, align 16
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z17cq415166_1d_e_refRA100_s([100 x i16]* dereferenceable(200) %yref) #1 {
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.REDUCTION.UDR:BYREF.ARRSECT"([100 x i16]** %yref.addr, i64 1, i64 25, i64 25, i64 1, i8* null, i8* null, void (i16*, i16*)* @.omp_combiner., i8* null), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.SHARED"([100 x i16]* @_ZL1x_9555819b599718990694fc37fe498a3b) ]
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_9555819b599718990694fc37fe498a3b, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1x_9555819b599718990694fc37fe498a3b, i64 0, i64 %idxprom
  store i16 1, i16* %arrayidx, align 2
  %2 = load i32, i32* %i, align 4
  %conv = trunc i32 %2 to i16
  %3 = load i32, i32* %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], [100 x i16]* @_ZL1y_9555819b599718990694fc37fe498a3b, i64 0, i64 %idxprom1
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_e_refRA100_s([100 x i16]* dereferenceable(200) @_ZL1y_9555819b599718990694fc37fe498a3b)
  ret i32 0
}

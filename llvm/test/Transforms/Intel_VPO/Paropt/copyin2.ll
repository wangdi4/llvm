...
entry:
  ...
  %0 = call ptr @_ZTW1a()
  %arrayidx = getelementptr inbounds [87 x i32], ptr %0, i64 0, i64 6
  store i32 104, ptr %arrayidx, align 8, !tbaa !1
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = call ptr @_ZTW1a()
  %arrayidx1 = getelementptr inbounds [87 x i32], ptr %1, i64 0, i64 0
  %2 = load i32, ptr %arrayidx1, align 16, !tbaa !1
...
entry:
  ...
  %0 = call ptr @_ZTW1a()
  %arrayidx = getelementptr inbounds [87 x i32], ptr %0, i64 0, i64 6
  %1 = load i32, ptr %arrayidx, align 8, !tbaa !1

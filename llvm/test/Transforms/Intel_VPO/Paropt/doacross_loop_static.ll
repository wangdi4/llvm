...
; TFORM-NEXT:  call void @__kmpc_for_static_init_4({{[^,]+}}, i32 %[[TID]], i32 34, ptr %is.last, ptr %lower.bnd, ptr %upper.bnd, ptr %stride, i32 1, i32 1)
...
; ALL: call void @__kmpc_doacross_wait({{[^,]+}}, i32 %{{[a-zA-Z._0-9]+}}, ptr %{{[a-zA-Z._0-9]+}})
; ALL: call void @__kmpc_doacross_wait({{[^,]+}}, i32 %{{[a-zA-Z._0-9]+}}, ptr %{{[a-zA-Z._0-9]+}})
...
; ALL: call void @__kmpc_doacross_post({{[^,]+}}, i32 %{{[a-zA-Z._0-9]+}}, ptr %{{[a-zA-Z._0-9]+}})

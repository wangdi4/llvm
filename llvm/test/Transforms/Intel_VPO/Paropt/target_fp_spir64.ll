...
; RTL:      call {{.*}} @_Z18__spirv_ocl_printfPU3AS2ci({{.*}}, ptr addrspace(4) [[X_CAST]])
...
; MODULE:   call {{.*}} @_Z18__spirv_ocl_printfPU3AS2ci({{.*}}, ptr addrspace(4) addrspacecast (ptr addrspace(1) [[X_FPRIV]] to ptr addrspace(4)))
...
; LOCAL:    call {{.*}} @_Z18__spirv_ocl_printfPU3AS2ci({{.*}}, ptr addrspace(4) [[X_CAST]])

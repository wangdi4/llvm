; RUN: opt -opaque-pointers=0 -bugpoint-enable-legacy-pm -SPIRITTAnnotations -S %s | FileCheck %s
...
; CHECK: call void @__itt_offload_atomic_op_start(i8 addrspace(4)* %5, i32 2, i32 0), !dbg ![[D3:[0-9]+]]
; CHECK: %call4 = call spir_func i32 @_Z18__spirv_AtomicIAddPU3AS1iiii(i32 addrspace(1)* %4, i32 2, i32 0, i32 1){{.*}}!dbg ![[D3]]
; CHECK: call void @__itt_offload_atomic_op_finish(i8 addrspace(4)* %6, i32 2, i32 0), !dbg ![[D3]]
...
!2 = distinct !DICompileUnit(language: DW_LANG_OpenCL, file: !3, producer: "clang based Intel(R) oneAPI DPC++/C++ Compiler 2021.2.0 (2021.x.0.YYYYMMDD)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, globals: !5, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "<stdin>", directory: "/iusers/vzakhari/workspaces/xmain01/test")
!4 = !{}
!5 = !{!0}
!6 = !DIFile(filename: "itt.c", directory: "/iusers/vzakhari/workspaces/xmain01/test")
!7 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !8, size: 64)
!8 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!9 = !{i32 2, !"Debug Info Version", i32 3}
!10 = !{!"Intel(R) oneAPI DPC++/C++ Compiler 2021.2.0 (2021.x.0.YYYYMMDD)"}
!11 = !{i32 3, i32 200000}
!12 = !{i32 2, i32 2}

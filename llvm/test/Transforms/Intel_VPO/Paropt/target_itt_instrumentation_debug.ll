; RUN: opt -bugpoint-enable-legacy-pm -SPIRITTAnnotations -S %s | FileCheck %s
...
;  printf("before atomic\n");
;  atom_add(res, 1);
;  printf("after atomic\n");
;  printf("exit\n");
; }
; LLVM IR produces with the following commands:
; clang -cc1 -emit-llvm-bc -triple spir64-unknown-unknown -cl-std=CL2.0 -disable-llvm-passes -include opencl-c.h itt.cl -debug-info-kind=limited
; llvm-spirv -s itt.bc -o reg.bc
; llvm-dis reg.bc -o reg.ll
...
; CHECK: call spir_func void @__itt_offload_atomic_op_start(ptr addrspace(4) %{{[^,]+}}, i32 2, i32 0), !dbg ![[D3:[0-9]+]]
; CHECK: %call4 = call spir_func i32 @_Z18__spirv_AtomicIAddPU3AS1iiii(ptr addrspace(1) %{{[^,]+}}, i32 2, i32 0, i32 1){{.*}}!dbg ![[D3]]
; CHECK: call spir_func void @__itt_offload_atomic_op_finish(ptr addrspace(4) %{{[^,]+}}, i32 2, i32 0), !dbg ![[D3]]
...
@res = dso_local addrspace(1) global ptr addrspace(1) null, align 8, !dbg !0
...
entry:
  ...
  %call = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) @.str) #1, !dbg !17
  %call1 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) @.str.1) #1, !dbg !18
  call spir_func void @_Z22__spirv_ControlBarrieriii(i32 2, i32 2, i32 528) #1, !dbg !19
  %call2 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) @.str.2) #1, !dbg !20
  %call3 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) @.str.3) #1, !dbg !21
  %0 = load ptr addrspace(1), ptr addrspace(1) @res, align 8, !dbg !22
  %call4 = call spir_func i32 @_Z18__spirv_AtomicIAddPU3AS1iiii(ptr addrspace(1) %0, i32 2, i32 0, i32 1) #1, !dbg !23
  %call5 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) @.str.4) #1, !dbg !24
  %call6 = call spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2) @.str.5) #1, !dbg !25
  ret void, !dbg !26
}
...
; Function Attrs: convergent
declare spir_func i32 @_Z18__spirv_ocl_printfPU3AS2c(ptr addrspace(2)) #1

; Function Attrs: convergent
declare spir_func void @_Z22__spirv_ControlBarrieriii(i32, i32, i32) #1

; Function Attrs: convergent
declare spir_func i32 @_Z18__spirv_AtomicIAddPU3AS1iiii(ptr addrspace(1), i32, i32, i32) #1
...
!2 = distinct !DICompileUnit(language: DW_LANG_OpenCL, file: !3, producer: "clang version 9.0.0", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, globals: !5, splitDebugInlining: false, nameTableKind: None)
!3 = !DIFile(filename: "<stdin>", directory: "/path/to/test")
!4 = !{}
!5 = !{!0}
!6 = !DIFile(filename: "itt.c", directory: "/path/to/test")

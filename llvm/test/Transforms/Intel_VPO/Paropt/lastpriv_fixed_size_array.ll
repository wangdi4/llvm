...
arrayctor.cont:                                   ; preds = %arrayctor.loop
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.LASTPRIVATE:NONPOD.TYPED"(ptr %e, %class.A zeroinitializer, i64 100, ptr @_ZTS1A.omp.def_constr, ptr @_ZTS1A.omp.copy_assign, ptr @_ZTS1A.omp.destr),
...
; Constructor
; CHECK:  %[[CONSTR_BEGIN:[^,]+]] = getelementptr inbounds [100 x %class.A], ptr %e.lpriv.gep, i32 0
...
; Copy Assignment
; CHECK:  %[[TO:[^,]+]] = getelementptr inbounds [100 x %class.A], ptr %e, i32 0
; CHECK-NEXT:  %[[FROM:[^,]+]] = getelementptr inbounds [100 x %class.A], ptr %e.lpriv.gep, i32 0
...
; Destructor
; CHECK:  %[[DESTR_BEGIN:[^,]+]] = getelementptr inbounds [100 x %class.A], ptr %e.lpriv.gep, i32 0
...
define internal noundef ptr @_ZTS1A.omp.def_constr(ptr noundef %0) #3 section ".text.startup" {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_ZTS1A.omp.copy_assign(ptr noundef %0, ptr noundef %1) #3 {
entry:
  %.addr = alloca ptr, align 8

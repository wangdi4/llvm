...
define void @test_01_(ptr dereferenceable(4) "ptrnoalias" %"test_01_$A", ptr readonly dereferenceable(4) "ptrnoalias" %"test_01_$B", ptr readonly dereferenceable(8) %"test_01_$SIZE") local_unnamed_addr {
DIR.OMP.SIMD.2:
  %"var$3" = alloca %"QNCA_a0$float*$rank1$.0", align 8
  %"var$5" = alloca %"QNCA_a0$float*$rank1$.1", align 8
  %"test_01_$I" = alloca i64, align 8
  %"test_01_$SIZE_fetch" = load i64, ptr %"test_01_$SIZE", align 1
  %"var$3.flags$1" = getelementptr inbounds %"QNCA_a0$float*$rank1$.0", ptr %"var$3", i64 0, i32 3
  store i64 1, ptr %"var$3.flags$1", align 8
  ...
  %"var$3.dim_info$.spacing$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) nonnull %"var$3.dim_info$.spacing$", i32 0)
  ...
  %"var$3.dim_info$.lower_bound$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) nonnull %"var$3.dim_info$.lower_bound$", i32 0)
  ...
  %"var$3.dim_info$.extent$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) nonnull %"var$3.dim_info$.extent$", i32 0)
  store i64 %slct4, ptr %"var$3.dim_info$.extent$[]", align 1
  store ptr %"test_01_$A", ptr %"var$3", align 8
  %"var$3.flags$_fetch" = load i64, ptr %"var$3.flags$1", align 8
  %or = or i64 %"var$3.flags$_fetch", 1
  store i64 %or, ptr %"var$3.flags$1", align 8
  ...
  %"var$5.dim_info$.spacing$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) nonnull %"var$5.dim_info$.spacing$", i32 0)
  ...
  %"var$5.dim_info$.lower_bound$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) nonnull %"var$5.dim_info$.lower_bound$", i32 0)
  ...
  %"var$5.dim_info$.extent$[]" = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) nonnull %"var$5.dim_info$.extent$", i32 0)
  store i64 %slct4, ptr %"var$5.dim_info$.extent$[]", align 1
  store ptr %"test_01_$B", ptr %"var$5", align 8
  %"var$5.flags$10_fetch" = load i64, ptr %"var$5.flags$", align 8
  %or12 = or i64 %"var$5.flags$10_fetch", 1
  store i64 %or12, ptr %"var$5.flags$", align 8
  %"var$3.addr_a0$_fetch" = load ptr, ptr %"var$3", align 8
  %"var$5.addr_a0$_fetch" = load ptr, ptr %"var$5", align 8
  %"test_01_$SIZE_fetch58" = load i64, ptr %"test_01_$SIZE", align 1
  store i64 1, ptr %"test_01_$I", align 8
  %temp63 = alloca i64, align 8
  %temp64 = alloca i64, align 8
  store volatile i64 0, ptr %temp63, align 8
  %sub = add nsw i64 %"test_01_$SIZE_fetch58", -1
  store volatile i64 %sub, ptr %temp64, align 8
...
DIR.OMP.SIMD.182:                                 ; preds = %DIR.OMP.SIMD.2
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(),
    "QUAL.OMP.LINEAR:IV.TYPED"(ptr %"test_01_$I", i64 0, i64 1, i64 1),
    "QUAL.OMP.NONTEMPORAL"(ptr %"var$5.addr_a0$_fetch", ptr %"var$3.addr_a0$_fetch"),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr %temp63, i64 0),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr %temp64, i64 0),
...
bb6:                                              ; preds = %DIR.OMP.SIMD.1
  store volatile i64 0, ptr %temp63, align 8
  %temp_fetch9 = load volatile i64, ptr %temp63, align 8
  %add = add nsw i64 %temp_fetch9, 1
  store i64 %add, ptr %"test_01_$I", align 1
  br label %bb10

bb10:                                             ; preds = %bb12, %bb6
  %temp_fetch15 = load volatile i64, ptr %temp63, align 8
  %add19 = add nsw i64 %temp_fetch15, 1
  store i64 %add19, ptr %"test_01_$I", align 1
  %"test_01_$SIZE_fetch21" = load i64, ptr %"test_01_$SIZE", align 1
  store i64 1, ptr %"test_01_$I", align 1
  %rel23 = icmp slt i64 %"test_01_$SIZE_fetch21", 1
  br i1 %rel23, label %bb12, label %bb11

bb11:                                             ; preds = %bb10, %bb11
  %"test_01_$I_fetch" = load i64, ptr %"test_01_$I", align 1
  %"var$5.addr_a0$_fetch[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(float) %"var$5.addr_a0$_fetch", i64 %"test_01_$I_fetch")

; CHECK: load float, ptr %"var$5.addr_a0$_fetch[]", align 1, !nontemporal

  %"var$5.addr_a0$_fetch[]_fetch" = load float, ptr %"var$5.addr_a0$_fetch[]", align 1
  ...
  %"var$3.addr_a0$_fetch[]" = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr elementtype(float) %"var$3.addr_a0$_fetch", i64 %"test_01_$I_fetch")

; CHECK: store float %add29, ptr %"var$3.addr_a0$_fetch[]", align 1, !nontemporal

  store float %add29, ptr %"var$3.addr_a0$_fetch[]", align 1
  %"test_01_$I_fetch33" = load i64, ptr %"test_01_$I", align 1
  %add35 = add nsw i64 %"test_01_$I_fetch33", 1
  store i64 %add35, ptr %"test_01_$I", align 1
  %rel41.not.not = icmp slt i64 %"test_01_$I_fetch33", %"test_01_$SIZE_fetch21"
  br i1 %rel41.not.not, label %bb11, label %bb12

bb12:                                             ; preds = %bb11, %bb10
  %temp_fetch45 = load volatile i64, ptr %temp63, align 8
  %add47 = add nsw i64 %temp_fetch45, 1
  store volatile i64 %add47, ptr %temp63, align 8
  %temp_fetch49 = load volatile i64, ptr %temp64, align 8
  %temp_fetch51 = load volatile i64, ptr %temp63, align 8
...
DIR.OMP.SIMD.1:                                   ; preds = %DIR.OMP.SIMD.283
  store volatile i64 0, ptr %temp63, align 8
  %temp_fetch69 = load volatile i64, ptr %temp63, align 8
  %temp_fetch70 = load volatile i64, ptr %temp64, align 8

; RUN: opt -opaque-pointers=0 -enable-new-pm=0 -switch-to-offload -vpo-paropt-optimize-data-sharing -S %s | FileCheck %s
...
define hidden spir_func void @foo([4 x [4 x float]] addrspace(4)* %P, i32 %N) {
; CHECK-LABEL: define hidden spir_func void @foo(
entry:
  %omp.collapsed.iv = alloca i64, align 8
  %omp.collapsed.iv.ascast = addrspacecast i64* %omp.collapsed.iv to i64 addrspace(4)*
  %omp.collapsed.lb = alloca i64, align 8
  %omp.collapsed.lb.ascast = addrspacecast i64* %omp.collapsed.lb to i64 addrspace(4)*
  %omp.collapsed.ub = alloca i64, align 8
  %omp.collapsed.ub.ascast = addrspacecast i64* %omp.collapsed.ub to i64 addrspace(4)*
  %P.addr = alloca [4 x [4 x float]] addrspace(4)*, align 8
  %P.addr.ascast = addrspacecast [4 x [4 x float]] addrspace(4)** %P.addr to [4 x [4 x float]] addrspace(4)* addrspace(4)*
  ...
  %P.map.ptr.tmp = alloca [4 x [4 x float]] addrspace(4)*, align 8
  %P.map.ptr.tmp.ascast = addrspacecast [4 x [4 x float]] addrspace(4)** %P.map.ptr.tmp to [4 x [4 x float]] addrspace(4)* addrspace(4)*
  %tmp = alloca i32, align 4
  %tmp.ascast = addrspacecast i32* %tmp to i32 addrspace(4)*
  %.omp.iv = alloca i32, align 4
  %.omp.iv.ascast = addrspacecast i32* %.omp.iv to i32 addrspace(4)*
  %Z = alloca i32, align 4
  %Z.ascast = addrspacecast i32* %Z to i32 addrspace(4)*
  %tmp7 = alloca i32, align 4
  %tmp7.ascast = addrspacecast i32* %tmp7 to i32 addrspace(4)*
  %tmp8 = alloca i32, align 4
  %tmp8.ascast = addrspacecast i32* %tmp8 to i32 addrspace(4)*
  ...
  %.omp.uncollapsed.iv9.ascast = addrspacecast i32* %.omp.uncollapsed.iv9 to i32 addrspace(4)*
  ...
  %.omp.uncollapsed.lb10.ascast = addrspacecast i32* %.omp.uncollapsed.lb10 to i32 addrspace(4)*
  %.omp.uncollapsed.ub11 = alloca i32, align 4
  %.omp.uncollapsed.ub11.ascast = addrspacecast i32* %.omp.uncollapsed.ub11 to i32 addrspace(4)*
  %Y = alloca i32, align 4
  %Y.ascast = addrspacecast i32* %Y to i32 addrspace(4)*
  %X = alloca i32, align 4
  %X.ascast = addrspacecast i32* %X to i32 addrspace(4)*
  store [4 x [4 x float]] addrspace(4)* %P, [4 x [4 x float]] addrspace(4)* addrspace(4)* %P.addr.ascast, align 8
  ...
  %3 = load [4 x [4 x float]] addrspace(4)*, [4 x [4 x float]] addrspace(4)* addrspace(4)* %P.addr.ascast, align 8
  %4 = load [4 x [4 x float]] addrspace(4)*, [4 x [4 x float]] addrspace(4)* addrspace(4)* %P.addr.ascast, align 8
  %5 = load [4 x [4 x float]] addrspace(4)*, [4 x [4 x float]] addrspace(4)* addrspace(4)* %P.addr.ascast, align 8
  %arrayidx = getelementptr inbounds [4 x [4 x float]], [4 x [4 x float]] addrspace(4)* %5, i64 0
  %6 = load i32, i32 addrspace(4)* %N.addr.ascast, align 4
...
DIR.OMP.TARGET.2126:                              ; preds = %DIR.OMP.TARGET.1125
  %8 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0), "QUAL.OMP.MAP.FROM"([4 x [4 x float]] addrspace(4)* %4, [4 x [4 x float]] addrspace(4)* %arrayidx, i64 %7, i64 34, i8* null, i8* null), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.lb.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %Z.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.capture_expr.0.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %Y.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv9.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb10.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.ub11.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %X.ascast), "QUAL.OMP.PRIVATE"([4 x [4 x float]] addrspace(4)* addrspace(4)* %P.map.ptr.tmp.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp7.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp8.ascast), "QUAL.OMP.PRIVATE:WILOCAL"(i64 addrspace(4)* %omp.collapsed.lb.ascast, i64 addrspace(4)* %omp.collapsed.ub.ascast), "QUAL.OMP.PRIVATE"(i64 addrspace(4)* %omp.collapsed.iv.ascast), "QUAL.OMP.OFFLOAD.NDRANGE"(i32 addrspace(4)* %.omp.ub.ascast, i32 0), "QUAL.OMP.JUMP.TO.END.IF"(i1* %end.dir.temp122) ]
  br label %DIR.OMP.TARGET.3127

DIR.OMP.TARGET.3127:                              ; preds = %DIR.OMP.TARGET.2126
  %temp.load123 = load volatile i1, i1* %end.dir.temp122, align 1
...
DIR.OMP.TARGET.3:                                 ; preds = %9
  store [4 x [4 x float]] addrspace(4)* %4, [4 x [4 x float]] addrspace(4)* addrspace(4)* %P.map.ptr.tmp.ascast, align 8
...
DIR.OMP.TEAMS.5129:                               ; preds = %DIR.OMP.TEAMS.4128
  %10 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(), "QUAL.OMP.SHARED"([4 x [4 x float]] addrspace(4)* addrspace(4)* %P.map.ptr.tmp.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.iv.ascast), "QUAL.OMP.SHARED"(i32 addrspace(4)* %.omp.lb.ascast), "QUAL.OMP.SHARED"(i32 addrspace(4)* %.omp.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %Z.ascast), "QUAL.OMP.SHARED"(i32 addrspace(4)* %.capture_expr.0.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %Y.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv9.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb10.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.ub11.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %X.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp7.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %tmp8.ascast), "QUAL.OMP.PRIVATE:WILOCAL"(i64 addrspace(4)* %omp.collapsed.lb.ascast, i64 addrspace(4)* %omp.collapsed.ub.ascast), "QUAL.OMP.PRIVATE"(i64 addrspace(4)* %omp.collapsed.iv.ascast), "QUAL.OMP.JUMP.TO.END.IF"(i1* %end.dir.temp119) ]
  br label %DIR.OMP.TEAMS.6130

DIR.OMP.TEAMS.6130:                               ; preds = %DIR.OMP.TEAMS.5129
  %temp.load120 = load volatile i1, i1* %end.dir.temp119, align 1
...
DIR.OMP.DISTRIBUTE.8:                             ; preds = %DIR.OMP.DISTRIBUTE.7131
  %temp.load117 = load volatile i1, i1* %end.dir.temp116, align 1
...
DIR.OMP.DISTRIBUTE.7:                             ; preds = %14
  %15 = load i32, i32 addrspace(4)* %.omp.lb.ascast, align 4
  store volatile i32 %15, i32 addrspace(4)* %.omp.iv.ascast, align 4
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %DIR.OMP.END.PARALLEL.LOOP.11, %DIR.OMP.DISTRIBUTE.7
  %16 = load volatile i32, i32 addrspace(4)* %.omp.iv.ascast, align 4
  %17 = load volatile i32, i32 addrspace(4)* %.omp.ub.ascast, align 4
  %cmp4 = icmp sle i32 %16, %17
  br i1 %cmp4, label %omp.inner.for.body, label %omp.loop.exit

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %18 = load volatile i32, i32 addrspace(4)* %.omp.iv.ascast, align 4
  %mul = mul nsw i32 %18, 1
  %add6 = add nsw i32 0, %mul
  store i32 %add6, i32 addrspace(4)* %Z.ascast, align 4
  store i32 0, i32 addrspace(4)* %.omp.uncollapsed.lb.ascast, align 4
  store i32 3, i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, align 4
  store i32 0, i32 addrspace(4)* %.omp.uncollapsed.lb10.ascast, align 4
  store i32 3, i32 addrspace(4)* %.omp.uncollapsed.ub11.ascast, align 4
...
DIR.OMP.PARALLEL.LOOP.9:                          ; preds = %DIR.OMP.PARALLEL.LOOP.8
  %.omp.uncollapsed.ub.ascast.val = load i32, i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, align 4
  %.zext = zext i32 %.omp.uncollapsed.ub.ascast.val to i64
  %19 = add nuw nsw i64 %.zext, 1
  %.omp.uncollapsed.ub11.ascast.val = load i32, i32 addrspace(4)* %.omp.uncollapsed.ub11.ascast, align 4
  ...
  store i64 0, i64 addrspace(4)* %omp.collapsed.lb.ascast, align 8
  store volatile i64 %omp.collapsed.ub.value, i64 addrspace(4)* %omp.collapsed.ub.ascast, align 8
...
DIR.OMP.PARALLEL.LOOP.10133:                      ; preds = %DIR.OMP.PARALLEL.LOOP.9132
  %22 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.COLLAPSE"(i32 2), "QUAL.OMP.SHARED"([4 x [4 x float]] addrspace(4)* addrspace(4)* %P.map.ptr.tmp.ascast), "QUAL.OMP.SHARED"(i32 addrspace(4)* %Z.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %Y.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.lb10.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %X.ascast), "QUAL.OMP.NORMALIZED.IV"(i64 addrspace(4)* %omp.collapsed.iv.ascast), "QUAL.OMP.NORMALIZED.UB"(i64 addrspace(4)* %omp.collapsed.ub.ascast), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, i32 addrspace(4)* %.omp.uncollapsed.iv9.ascast), "QUAL.OMP.FIRSTPRIVATE"(i64 addrspace(4)* %omp.collapsed.lb.ascast), "QUAL.OMP.FIRSTPRIVATE"(i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, i32 addrspace(4)* %.omp.uncollapsed.ub11.ascast), "QUAL.OMP.JUMP.TO.END.IF"(i1* %end.dir.temp) ]
...
DIR.OMP.PARALLEL.LOOP.9.split:                    ; preds = %23
  %.omp.uncollapsed.ub11.ascast.val2 = load i32, i32 addrspace(4)* %.omp.uncollapsed.ub11.ascast, align 4
...
DIR.OMP.PARALLEL.LOOP.10:                         ; preds = %DIR.OMP.PARALLEL.LOOP.9.split
  %26 = load i32, i32 addrspace(4)* %.omp.uncollapsed.lb.ascast, align 4
  store i32 %26, i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, align 4
  br label %DIR.OMP.PARALLEL.LOOP.10.split

DIR.OMP.PARALLEL.LOOP.10.split:                   ; preds = %DIR.OMP.PARALLEL.LOOP.10
  %27 = load i64, i64 addrspace(4)* %omp.collapsed.lb.ascast, align 8
  store volatile i64 %27, i64 addrspace(4)* %omp.collapsed.iv.ascast, align 8
  br label %omp.collapsed.loop.cond

omp.collapsed.loop.cond:                          ; preds = %omp.collapsed.loop.inc, %DIR.OMP.PARALLEL.LOOP.10.split
  %28 = load volatile i64, i64 addrspace(4)* %omp.collapsed.iv.ascast, align 8
  %29 = load volatile i64, i64 addrspace(4)* %omp.collapsed.ub.ascast, align 8
...
omp.collapsed.loop.body:                          ; preds = %omp.collapsed.loop.cond
  %omp.collapsed.iv.ascast.val = load volatile i64, i64 addrspace(4)* %omp.collapsed.iv.ascast, align 8
  %31 = sdiv i64 %omp.collapsed.iv.ascast.val, %25
  %32 = trunc i64 %31 to i32
  store i32 %32, i32 addrspace(4)* %.omp.uncollapsed.lb.ascast, align 4
  %33 = trunc i64 %31 to i32
  store i32 %33, i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, align 4
  %34 = srem i64 %omp.collapsed.iv.ascast.val, %25
  %35 = trunc i64 %31 to i32
  store i32 %35, i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, align 4
  %36 = sdiv i64 %34, 1
  %37 = trunc i64 %36 to i32
  store i32 %37, i32 addrspace(4)* %.omp.uncollapsed.lb10.ascast, align 4
  %38 = trunc i64 %36 to i32
  store i32 %38, i32 addrspace(4)* %.omp.uncollapsed.ub11.ascast, align 4
  %39 = srem i64 %34, 1
...
omp.uncollapsed.loop.cond:                        ; preds = %omp.collapsed.loop.body, %omp.uncollapsed.loop.inc30
  %40 = load i32, i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, align 4
  %41 = load i32, i32 addrspace(4)* %.omp.uncollapsed.ub.ascast, align 4
...
omp.uncollapsed.loop.body:                        ; preds = %omp.uncollapsed.loop.cond
  %42 = load i32, i32 addrspace(4)* %.omp.uncollapsed.lb10.ascast, align 4
  store i32 %42, i32 addrspace(4)* %.omp.uncollapsed.iv9.ascast, align 4
...
omp.uncollapsed.loop.cond14:                      ; preds = %omp.uncollapsed.loop.body17, %omp.uncollapsed.loop.body
  %43 = load i32, i32 addrspace(4)* %.omp.uncollapsed.iv9.ascast, align 4
  %44 = load i32, i32 addrspace(4)* %.omp.uncollapsed.ub11.ascast, align 4
...
omp.uncollapsed.loop.body17:                      ; preds = %omp.uncollapsed.loop.cond14
  %45 = load i32, i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, align 4
  %mul18 = mul nsw i32 %45, 1
  %add19 = add nsw i32 0, %mul18
  store i32 %add19, i32 addrspace(4)* %Y.ascast, align 4
  %46 = load i32, i32 addrspace(4)* %.omp.uncollapsed.iv9.ascast, align 4
  %mul20 = mul nsw i32 %46, 1
  %add21 = add nsw i32 0, %mul20
  store i32 %add21, i32 addrspace(4)* %X.ascast, align 4
  %47 = load i32, i32 addrspace(4)* %X.ascast, align 4
  %48 = load i32, i32 addrspace(4)* %Y.ascast, align 4
  %add22 = add nsw i32 %47, %48
  %conv23 = sitofp i32 %add22 to float
  %49 = load [4 x [4 x float]] addrspace(4)*, [4 x [4 x float]] addrspace(4)* addrspace(4)* %P.map.ptr.tmp.ascast, align 8
  %50 = load i32, i32 addrspace(4)* %Z.ascast, align 4
  %idxprom = sext i32 %50 to i64
  %arrayidx24 = getelementptr inbounds [4 x [4 x float]], [4 x [4 x float]] addrspace(4)* %49, i64 %idxprom
  %51 = load i32, i32 addrspace(4)* %Y.ascast, align 4
  %idxprom25 = sext i32 %51 to i64
  %arrayidx26 = getelementptr inbounds [4 x [4 x float]], [4 x [4 x float]] addrspace(4)* %arrayidx24, i64 0, i64 %idxprom25
  %52 = load i32, i32 addrspace(4)* %X.ascast, align 4
  %idxprom27 = sext i32 %52 to i64
  %arrayidx28 = getelementptr inbounds [4 x float], [4 x float] addrspace(4)* %arrayidx26, i64 0, i64 %idxprom27
  store float %conv23, float addrspace(4)* %arrayidx28, align 4
  %53 = load i32, i32 addrspace(4)* %.omp.uncollapsed.iv9.ascast, align 4
  %add29 = add nsw i32 %53, 1
  store i32 %add29, i32 addrspace(4)* %.omp.uncollapsed.iv9.ascast, align 4
  br label %omp.uncollapsed.loop.cond14

omp.uncollapsed.loop.inc30:                       ; preds = %omp.uncollapsed.loop.cond14
  %54 = load i32, i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, align 4
  %add31 = add nsw i32 %54, 1
  store i32 %add31, i32 addrspace(4)* %.omp.uncollapsed.iv.ascast, align 4
  br label %omp.uncollapsed.loop.cond

omp.collapsed.loop.inc:                           ; preds = %omp.uncollapsed.loop.cond
  %55 = load volatile i64, i64 addrspace(4)* %omp.collapsed.iv.ascast, align 8
  %56 = add nuw nsw i64 %55, 1
  store volatile i64 %56, i64 addrspace(4)* %omp.collapsed.iv.ascast, align 8
  br label %omp.collapsed.loop.cond
...
DIR.OMP.END.PARALLEL.LOOP.11:                     ; preds = %DIR.OMP.END.PARALLEL.LOOP.12
  %57 = load volatile i32, i32 addrspace(4)* %.omp.iv.ascast, align 4
  %add34 = add nsw i32 %57, 1
  store volatile i32 %add34, i32 addrspace(4)* %.omp.iv.ascast, align 4
  br label %omp.inner.for.cond

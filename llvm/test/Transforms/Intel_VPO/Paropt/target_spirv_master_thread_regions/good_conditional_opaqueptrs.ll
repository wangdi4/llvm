...
; If there's nothing to stop expansion in the conditional, the whole conditional
; can be in the same master thread region.
define spir_func void @good_conditional() {
...
; CHECK:       [[CODE]]:
; CHECK:         %cond = call spir_func i1 @baz()
...
!0 = !{i32 0, i32 66306, i32 88872534, !"good_conditional", i32 0, i32 0, i32 0, i32 0}

...
; CHECK: [[XLOAD:%.+]] = load i16, ptr @x, align 2
; CHECK: store i16 [[XLOAD]], ptr %x.lpriv, align 2

; CHECK: "QUAL.OMP.LASTPRIVATE:CONDITIONAL.TYPED"(ptr %x.lpriv, i16 0, i32 1)
; CHECK: "DIR.OMP.END.SIMD"()

; CHECK: [[XLP_LOAD:%.+]] = load i16, ptr %x.lpriv, align 2
; CHECK: store i16 [[XLP_LOAD]], ptr @x, align 2
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(),
    "QUAL.OMP.LASTPRIVATE:CONDITIONAL.TYPED"(ptr @x, i16 0, i32 1),

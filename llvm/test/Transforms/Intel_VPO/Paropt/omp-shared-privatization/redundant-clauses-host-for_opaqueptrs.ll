...
define dso_local void @test5(i32 noundef %N) {
; CHECK-LABEL: @test5(
entry:
...
; CHECK-SAME: "QUAL.OMP.PRIVATE:TYPED"(ptr %J, i32 0, i32 1)
...
omp.precond.then:                                 ; preds = %entry
  ...
  %5 = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(),
    ...
    "QUAL.OMP.LASTPRIVATE:TYPED"(ptr %J, i32 0, i32 1),
...
; CHECK-SAME: "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr null, i32 0, i32 1), "QUAL.OMP.LASTPRIVATE:TYPED"(ptr null, i32 0, i32 1)
; CHECK-SAME: "QUAL.OMP.PRIVATE:TYPED"(ptr %J, i32 0, i32 1)

; RUN: opt -bugpoint-enable-legacy-pm -vpo-paropt -switch-to-offload -S %s | FileCheck %s
...
entry:
  ...
  %aa.ascast = addrspacecast ptr %aa to ptr addrspace(4)
  %bb = alloca i64, align 8
  %bb.ascast = addrspacecast ptr %bb to ptr addrspace(4)
...
DIR.OMP.TARGET.2:                                 ; preds = %DIR.OMP.TARGET.1
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.PRIVATE:WILOCAL.TYPED"(ptr addrspace(4) %aa.ascast, i32 0, i64 1),
    "QUAL.OMP.PRIVATE:WILOCAL.TYPED"(ptr addrspace(4) %bb.ascast, i64 0, i64 1) ]
...
; CHECK:  call spir_func i32 @_Z17__spirv_ocl_s_absi(i32 123)
  ...
  store i32 %call, ptr addrspace(4) %aa.ascast, align 4

  %call1 = call spir_func i64 @labs(i64 456)
; CHECK:   call spir_func i64 @_Z17__spirv_ocl_s_absl(i64 456)

  store i64 %call1, ptr addrspace(4) %bb.ascast, align 8

...
; CHECK: %[[INDEX:.*]] = getelementptr %class.goo, ptr %[[DST_BEGIN]], i64 20
...
arrayctor.cont:                                   ; preds = %arrayctor.loop
  %array.begin1 = getelementptr inbounds [20 x %class.goo], ptr %a, i32 0, i32 0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.SINGLE"(),
    "QUAL.OMP.COPYPRIVATE:NONPOD.TYPED"(ptr %a, %class.goo zeroinitializer, i64 20, ptr @_ZTS3goo.omp.copy_assign) ]
  fence acquire
  fence release

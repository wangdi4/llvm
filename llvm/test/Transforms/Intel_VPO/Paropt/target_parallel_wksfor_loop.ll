; RUN: opt -bugpoint-enable-legacy-pm -switch-to-offload -vpo-paropt -S %s | FileCheck %s -check-prefix=DEFAULT -check-prefix=ALL
; RUN: opt -passes='vpo-paropt' -switch-to-offload -S %s | FileCheck %s -check-prefix=DEFAULT -check-prefix=ALL
; RUN: opt -bugpoint-enable-legacy-pm -switch-to-offload -vpo-paropt -vpo-paropt-emit-wks-loops-implicit-barrier-for-target=false -S %s | FileCheck %s -check-prefix=NO_BARRIER -check-prefix=ALL
...
%"struct.std::ios_base::_Callback_list" = type { ptr addrspace(4), ptr addrspace(4), i32, i32 }
...
entry:
  ...
  %counts1.ascast = addrspacecast ptr %counts1 to ptr addrspace(4)
  %counts2 = alloca i32, align 4
  %counts2.ascast = addrspacecast ptr %counts2 to ptr addrspace(4)
  %counts_team = alloca i32, align 4
  %counts_team.ascast = addrspacecast ptr %counts_team to ptr addrspace(4)
  ...
  %counts_team4.ascast = addrspacecast ptr %counts_team4 to ptr addrspace(4)
  %tmp5 = alloca i32, align 4
  %tmp5.ascast = addrspacecast ptr %tmp5 to ptr addrspace(4)
  %.omp.iv6 = alloca i32, align 4
  %.omp.iv6.ascast = addrspacecast ptr %.omp.iv6 to ptr addrspace(4)
  %.omp.lb7 = alloca i32, align 4
  %.omp.lb7.ascast = addrspacecast ptr %.omp.lb7 to ptr addrspace(4)
  %.omp.ub8 = alloca i32, align 4
  %.omp.ub8.ascast = addrspacecast ptr %.omp.ub8 to ptr addrspace(4)
  %i12 = alloca i32, align 4
  %i12.ascast = addrspacecast ptr %i12 to ptr addrspace(4)
  store i32 0, ptr addrspace(4) %retval.ascast, align 4
  store i32 0, ptr addrspace(4) %counts1.ascast, align 4
  store i32 0, ptr addrspace(4) %counts2.ascast, align 4
...
DIR.OMP.TARGET.2:                                 ; preds = %DIR.OMP.TARGET.1
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.MAP.FROM"(ptr addrspace(4) %counts1.ascast, ptr addrspace(4) %counts1.ascast, i32 4, i64 34, ptr null, ptr null), ; MAP type: 34 = 0x22 = TARGET_PARAM (0x20) | FROM (0x2)
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %counts_team.ascast, i32 0, i32 1),
...
DIR.OMP.TEAMS.5152:                               ; preds = %DIR.OMP.TEAMS.4
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.ub.ascast, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %counts1.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %atomic-temp.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %atomic-temp1.ascast, i32 0, i32 1) ]
...
DIR.OMP.TEAMS.5:                                  ; preds = %DIR.OMP.TEAMS.6
  store i32 0, ptr addrspace(4) %counts_team.ascast, align 4
...
DIR.OMP.PARALLEL.8153:                            ; preds = %DIR.OMP.PARALLEL.7
  %2 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.ub.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i.ascast, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %counts_team.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %atomic-temp.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %atomic-temp1.ascast, i32 0, i32 1) ]
...
DIR.OMP.PARALLEL.8:                               ; preds = %DIR.OMP.PARALLEL.9
  ...
  store volatile i32 3, ptr addrspace(4) %.omp.ub.ascast, align 4
...
DIR.OMP.LOOP.10:                                  ; preds = %DIR.OMP.LOOP.11
  ...
  store volatile i32 %4, ptr addrspace(4) %.omp.iv.ascast, align 4
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %DIR.OMP.LOOP.10
  %5 = load volatile i32, ptr addrspace(4) %.omp.iv.ascast, align 4
  %6 = load volatile i32, ptr addrspace(4) %.omp.ub.ascast, align 4
  %cmp = icmp sle i32 %5, %6
  br i1 %cmp, label %omp.inner.for.body, label %omp.loop.exit.split

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %7 = load volatile i32, ptr addrspace(4) %.omp.iv.ascast, align 4
  %mul = mul nsw i32 %7, 1
  %add = add nsw i32 0, %mul
  store i32 %add, ptr addrspace(4) %i.ascast, align 4
  %8 = bitcast ptr addrspace(4) %counts_team.ascast to ptr addrspace(4)
  %9 = bitcast ptr addrspace(4) %atomic-temp.ascast to ptr addrspace(4)
  call void @__kmpc_atomic_load(i64 4, ptr addrspace(4) %8, ptr addrspace(4) %9, i32 0)
  br label %atomic_cont

atomic_cont:                                      ; preds = %atomic_cont, %omp.inner.for.body
  %10 = load i32, ptr addrspace(4) %atomic-temp.ascast, align 4
  %add2 = add nsw i32 %10, 1
  store i32 %add2, ptr addrspace(4) %atomic-temp1.ascast, align 4
  %11 = bitcast ptr addrspace(4) %counts_team.ascast to ptr addrspace(4)
  %12 = bitcast ptr addrspace(4) %atomic-temp.ascast to ptr addrspace(4)
  %13 = bitcast ptr addrspace(4) %atomic-temp1.ascast to ptr addrspace(4)
  %call = call zeroext i1 @__kmpc_atomic_compare_exchange(i64 4, ptr addrspace(4) %11, ptr addrspace(4) %12, ptr addrspace(4) %13, i32 0, i32 0)
  br i1 %call, label %omp.inner.for.inc, label %atomic_cont

omp.inner.for.inc:                                ; preds = %atomic_cont
  %14 = load volatile i32, ptr addrspace(4) %.omp.iv.ascast, align 4
  %add3 = add nsw i32 %14, 1
  store volatile i32 %add3, ptr addrspace(4) %.omp.iv.ascast, align 4
  br label %omp.inner.for.cond
...
DIR.OMP.END.PARALLEL.14:                          ; preds = %DIR.OMP.END.PARALLEL.13
  %15 = load i32, ptr addrspace(4) %counts_team.ascast, align 4
  store i32 %15, ptr addrspace(4) %counts1.ascast, align 4
...
DIR.OMP.TARGET.19:                                ; preds = %DIR.OMP.TARGET.18
  %16 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 1),
    "QUAL.OMP.MAP.FROM"(ptr addrspace(4) %counts2.ascast, ptr addrspace(4) %counts2.ascast, i32 4, i64 34, ptr null, ptr null), ; MAP type: 34 = 0x22 = TARGET_PARAM (0x20) | FROM (0x2)
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.ub8.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.lb7.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i12.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv6.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %counts_team4.ascast, i32 0, i32 1),
...
DIR.OMP.TEAMS.22:                                 ; preds = %DIR.OMP.TEAMS.21
  %17 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %counts_team4.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.ub8.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.lb7.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i12.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv6.ascast, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %counts2.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp5.ascast, i32 0, i32 1) ]
...
DIR.OMP.TEAMS.19:                                 ; preds = %DIR.OMP.TEAMS.23
  store i32 0, ptr addrspace(4) %counts_team4.ascast, align 4
...
DIR.OMP.PARALLEL.25:                              ; preds = %DIR.OMP.PARALLEL.24
  %18 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv6.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.lb7.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.ub8.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i12.ascast, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %counts_team4.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp5.ascast, i32 0, i32 1) ]
...
DIR.OMP.PARALLEL.22:                              ; preds = %DIR.OMP.PARALLEL.26
  store i32 0, ptr addrspace(4) %.omp.lb7.ascast, align 4
  store volatile i32 3, ptr addrspace(4) %.omp.ub8.ascast, align 4
  br label %DIR.OMP.LOOP.27

DIR.OMP.LOOP.27:                                  ; preds = %DIR.OMP.PARALLEL.22
  %19 = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(),
    "QUAL.OMP.REDUCTION.ADD:TYPED"(ptr addrspace(4) %counts_team4.ascast, i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.lb7.ascast, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr addrspace(4) %.omp.iv6.ascast, i32 0),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr addrspace(4) %.omp.ub8.ascast, i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i12.ascast, i32 0, i32 1) ]
...
DIR.OMP.LOOP.24:                                  ; preds = %DIR.OMP.LOOP.28
  %20 = load i32, ptr addrspace(4) %.omp.lb7.ascast, align 4
  store volatile i32 %20, ptr addrspace(4) %.omp.iv6.ascast, align 4
  br label %omp.inner.for.cond9

omp.inner.for.cond9:                              ; preds = %omp.inner.for.body11, %DIR.OMP.LOOP.24
  %21 = load volatile i32, ptr addrspace(4) %.omp.iv6.ascast, align 4
  %22 = load volatile i32, ptr addrspace(4) %.omp.ub8.ascast, align 4
...
omp.inner.for.body11:                             ; preds = %omp.inner.for.cond9
  %23 = load volatile i32, ptr addrspace(4) %.omp.iv6.ascast, align 4
  %mul13 = mul nsw i32 %23, 1
  %add14 = add nsw i32 0, %mul13
  store i32 %add14, ptr addrspace(4) %i12.ascast, align 4
  %24 = load i32, ptr addrspace(4) %counts_team4.ascast, align 4
  %add15 = add nsw i32 %24, 1
  store i32 %add15, ptr addrspace(4) %counts_team4.ascast, align 4
  %25 = load volatile i32, ptr addrspace(4) %.omp.iv6.ascast, align 4
  %add18 = add nsw i32 %25, 1
  store volatile i32 %add18, ptr addrspace(4) %.omp.iv6.ascast, align 4
  br label %omp.inner.for.cond9
...
DIR.OMP.END.PARALLEL.31:                          ; preds = %DIR.OMP.END.PARALLEL.30
  %26 = load i32, ptr addrspace(4) %counts_team4.ascast, align 4
  store i32 %26, ptr addrspace(4) %counts2.ascast, align 4
...
DIR.OMP.END.TARGET.34:                            ; preds = %DIR.OMP.END.TARGET.33
  %27 = load i32, ptr addrspace(4) %counts1.ascast, align 4
  %cmp21 = icmp ne i32 %27, 4
  br i1 %cmp21, label %if.then, label %if.else

if.then:                                          ; preds = %DIR.OMP.END.TARGET.34
  %call22 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr addrspace(4) dereferenceable(272) addrspacecast (ptr addrspace(1) @_ZSt4cout to ptr addrspace(4)), ptr addrspace(4) getelementptr inbounds ([18 x i8], ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str to ptr addrspace(4)), i64 0, i64 0))
  %28 = load i32, ptr addrspace(4) %counts1.ascast, align 4
  %call23 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZNSolsEi(ptr addrspace(4) %call22, i32 %28)
  %call24 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr addrspace(4) dereferenceable(272) %call23, ptr addrspace(4) getelementptr inbounds ([14 x i8], ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.1 to ptr addrspace(4)), i64 0, i64 0))
  %call25 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZNSolsEPFRSoS_E(ptr addrspace(4) %call24, ptr addrspace(4) addrspacecast (ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_ to ptr addrspace(4)))
  br label %if.end

if.else:                                          ; preds = %DIR.OMP.END.TARGET.34
  %call26 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr addrspace(4) dereferenceable(272) addrspacecast (ptr addrspace(1) @_ZSt4cout to ptr addrspace(4)), ptr addrspace(4) getelementptr inbounds ([9 x i8], ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.2 to ptr addrspace(4)), i64 0, i64 0))
  %call27 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZNSolsEPFRSoS_E(ptr addrspace(4) %call26, ptr addrspace(4) addrspacecast (ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_ to ptr addrspace(4)))
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %29 = load i32, ptr addrspace(4) %counts2.ascast, align 4
  %cmp28 = icmp ne i32 %29, 4
  br i1 %cmp28, label %if.then29, label %if.else34

if.then29:                                        ; preds = %if.end
  %call30 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr addrspace(4) dereferenceable(272) addrspacecast (ptr addrspace(1) @_ZSt4cout to ptr addrspace(4)), ptr addrspace(4) getelementptr inbounds ([18 x i8], ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.3 to ptr addrspace(4)), i64 0, i64 0))
  %30 = load i32, ptr addrspace(4) %counts2.ascast, align 4
  %call31 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZNSolsEi(ptr addrspace(4) %call30, i32 %30)
  %call32 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr addrspace(4) dereferenceable(272) %call31, ptr addrspace(4) getelementptr inbounds ([14 x i8], ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.1 to ptr addrspace(4)), i64 0, i64 0))
  %call33 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZNSolsEPFRSoS_E(ptr addrspace(4) %call32, ptr addrspace(4) addrspacecast (ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_ to ptr addrspace(4)))
  br label %if.end37

if.else34:                                        ; preds = %if.end
  %call35 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr addrspace(4) dereferenceable(272) addrspacecast (ptr addrspace(1) @_ZSt4cout to ptr addrspace(4)), ptr addrspace(4) getelementptr inbounds ([9 x i8], ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.2 to ptr addrspace(4)), i64 0, i64 0))
  %call36 = call spir_func dereferenceable(272) ptr addrspace(4) @_ZNSolsEPFRSoS_E(ptr addrspace(4) %call35, ptr addrspace(4) addrspacecast (ptr @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_ to ptr addrspace(4)))
  br label %if.end37

if.end37:                                         ; preds = %if.else34, %if.then29
  %31 = load i32, ptr addrspace(4) %retval.ascast, align 4
  ret i32 %31
}
...
declare dso_local spir_func dereferenceable(272) ptr addrspace(4) @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr addrspace(4) dereferenceable(272), ptr addrspace(4)) #2

declare dso_local spir_func dereferenceable(272) ptr addrspace(4) @_ZNSolsEi(ptr addrspace(4), i32) #2

declare dso_local spir_func dereferenceable(272) ptr addrspace(4) @_ZNSolsEPFRSoS_E(ptr addrspace(4), ptr addrspace(4)) #2

declare dso_local spir_func dereferenceable(272) ptr addrspace(4) @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(ptr addrspace(4) dereferenceable(272)) #2

declare dso_local void @__kmpc_atomic_load(i64, ptr addrspace(4), ptr addrspace(4), i32)

declare dso_local i1 @__kmpc_atomic_compare_exchange(i64, ptr addrspace(4), ptr addrspace(4), ptr addrspace(4), i32, i32)

; RUN: opt -opaque-pointers=1 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -vpo-paropt-atomic-free-reduction-slm=true -S %s | FileCheck %s
; RUN: opt -opaque-pointers=1 -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -switch-to-offload -vpo-paropt-atomic-free-reduction-slm=true -S %s | FileCheck %s
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %7 = load i32, ptr addrspace(4) %s.ascast, align 4
  %add1 = add nsw i32 %7, %6
  store i32 %add1, ptr addrspace(4) %s.ascast, align 4
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %9 = load i32, ptr addrspace(4) %s.ascast, align 4
  ret i32 %9
}

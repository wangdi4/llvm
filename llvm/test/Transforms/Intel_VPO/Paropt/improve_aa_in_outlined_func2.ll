; RUN: opt -enable-new-pm=0 -vpo-cfg-restructuring -vpo-paropt -tbaa %s | opt -disable-output -scoped-noalias-aa -aa-eval -evaluate-aa-metadata -print-no-aliases 2>&1 | FileCheck %s

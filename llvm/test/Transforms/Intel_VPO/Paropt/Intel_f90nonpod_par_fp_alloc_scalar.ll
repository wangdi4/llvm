...
; CHECK:  %"test_$COLLECTION.fpriv" = alloca ptr, align 8
; CHECK:  call void @"TEST$.btOUTER_T.omp.copy_ctor_deref"(ptr %"test_$COLLECTION.fpriv", ptr %"test_$COLLECTION")
; CHECK:  call void @"TEST$.btOUTER_T.omp.dtor_deref"(ptr %"test_$COLLECTION.fpriv")
...
bb_new5:                                          ; preds = %alloca_0
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.FIRSTPRIVATE:F90_NONPOD.TYPED"(ptr %"test_$COLLECTION", ptr null, i64 1, ptr @"TEST$.btOUTER_T.omp.copy_ctor_deref", ptr @"TEST$.btOUTER_T.omp.dtor_deref") ]
...
declare void @"TEST$.btOUTER_T.omp.copy_ctor_deref"(ptr %dst, ptr %src)

; RUN: opt -opaque-pointers=1 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -vpo-paropt-atomic-free-reduction=false -S %s | FileCheck %s
; RUN: opt -opaque-pointers=1 -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' -switch-to-offload -vpo-paropt-atomic-free-reduction=false -S %s | FileCheck %s
...
; The order of clauses is straight: ADD, UDR.
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %11 = load i32, ptr addrspace(4) %arrayidx3, align 4
  %12 = load i32, ptr addrspace(4) %sum.ascast, align 4
  %add4 = add nsw i32 %12, %11
  store i32 %add4, ptr addrspace(4) %sum.ascast, align 4
  %13 = load i32, ptr addrspace(4) %sum_udr.ascast, align 4
  ...
  %15 = load i32, ptr addrspace(4) %arrayidx6, align 4
  %add7 = add nsw i32 %13, %15
  store i32 %add7, ptr addrspace(4) %sum_udr.ascast, align 4
  ...
  %17 = load i32, ptr addrspace(4) %arrayidx9, align 4
  %18 = load i32, ptr addrspace(4) %sum1.ascast, align 4
  %add10 = add nsw i32 %18, %17
  store i32 %add10, ptr addrspace(4) %sum1.ascast, align 4
  %19 = load i32, ptr addrspace(4) %sum_udr1.ascast, align 4
  ...
  %21 = load i32, ptr addrspace(4) %arrayidx12, align 4
  %add13 = add nsw i32 %19, %21
  store i32 %add13, ptr addrspace(4) %sum_udr1.ascast, align 4

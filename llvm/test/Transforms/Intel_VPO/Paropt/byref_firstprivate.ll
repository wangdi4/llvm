...
; }
;
; ModuleID = 'byref_firstprivate.cpp'
source_filename = "byref_firstprivate.cpp"
...
define dso_local void @_Z18byref_firstprivateRiRA10_A10_f(i32* dereferenceable(4) %yref, [10 x [10 x float]]* dereferenceable(400) %y_arr_ref) #0 {
entry:
  ...
  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.FIRSTPRIVATE:BYREF"(i32** %yref.addr), "QUAL.OMP.FIRSTPRIVATE:BYREF"([10 x [10 x float]]** %y_arr_ref.addr), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.SHARED"(i32** %yref_addr), "QUAL.OMP.SHARED"([10 x [10 x float]]** %y_arr_ref_addr) ]
...
cond.false:                                       ; preds = %omp.inner.for.body
  call void @__assert_fail(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 11, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__._Z18byref_firstprivateRiRA10_A10_f, i32 0, i32 0)) #4
  br label %cond.end
...
cond.false5:                                      ; preds = %cond.end
  call void @__assert_fail(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 12, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__._Z18byref_firstprivateRiRA10_A10_f, i32 0, i32 0)) #4
  br label %cond.end6
...
cond.false9:                                      ; preds = %cond.end6
  call void @__assert_fail(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 13, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__._Z18byref_firstprivateRiRA10_A10_f, i32 0, i32 0)) #4
  br label %cond.end10
...
cond.end10:                                       ; preds = %cond.false9, %cond.true8
  ...
  %cmp13 = fcmp oeq float %18, 3.000000e+00
...
cond.false15:                                     ; preds = %cond.end10
  call void @__assert_fail(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 14, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @__PRETTY_FUNCTION__._Z18byref_firstprivateRiRA10_A10_f, i32 0, i32 0)) #4
  br label %cond.end16
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  store i32 %add17, i32* %.omp.iv, align 4
  br label %omp.inner.for.cond
...
entry:
  ...
  call void @_Z18byref_firstprivateRiRA10_A10_f(i32* dereferenceable(4) %y, [10 x [10 x float]]* dereferenceable(400) %yarr)
  ret i32 0
}

...
entry:
  ...
  store i32 %1, ptr addrspace(4) %.capture_expr.0.ascast, align 4
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %10 = load ptr addrspace(4), ptr addrspace(4) %x.addr.ascast, align 8
  %11 = load i32, ptr addrspace(4) %i.ascast, align 4
  %idxprom = sext i32 %11 to i64
  %arrayidx = getelementptr inbounds i32, ptr addrspace(4) %10, i64 %idxprom
  %12 = load i32, ptr addrspace(4) %arrayidx, align 4
  %add5 = add nsw i32 %12, 1
  %13 = load ptr addrspace(4), ptr addrspace(4) %x.addr.ascast, align 8
  %14 = load i32, ptr addrspace(4) %i.ascast, align 4
  %idxprom6 = sext i32 %14 to i64
  %arrayidx7 = getelementptr inbounds i32, ptr addrspace(4) %13, i64 %idxprom6

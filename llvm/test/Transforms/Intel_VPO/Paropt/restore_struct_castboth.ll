...
; This test is a subset of rename_and_restore_struct_castboth.ll, which captures the IR
; after instcombine, and does not depend on the optimization's behavior to
; stay the same (for example, the bitcasts, conversion of %f to i32 no longer happen
...
; RESTR: [[FRENAMED:%[a-zA-Z._0-9]+]] = getelementptr %struct._FourChars, ptr [[FCAST]], i64 0, i32 0
...
DIR.OMP.PARALLEL.3:                               ; preds = %entry
  ...
  %2 = getelementptr %struct._FourChars, ptr %f1, i64 0, i32 0

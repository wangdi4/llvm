...
; CHECK:     define {{.*}} void @__omp_offloading{{.*}}main{{.*}}(ptr addrspace(1) %vla.ascast, i64 [[SIZE_ARG:%n.val.*]], i64 [[SIZE_ARG1:%n.val.*]])
...
; CHECK:       [[SIZE_FP1:%n.val.*fpriv]] = alloca i64, align 8

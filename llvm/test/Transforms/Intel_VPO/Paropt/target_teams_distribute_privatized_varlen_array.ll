...
; CHECK-NEXT: %[[X_LOCAL1:[^,]+]] = load i32, ptr addrspace(3) @x.ascast.priv.__local, align 4
; CHECK-NEXT: %[[INDEX1:[^,]+]] = sext i32 %[[X_LOCAL1]] to i64
; CHECK-NEXT: %[[PTR1:[^,]+]] = getelementptr inbounds i32, ptr %vla.ascast.lpriv, i64 %[[INDEX1]]
; CHECK-NEXT: store i32 %[[A_FPRIV1]], ptr %[[PTR1]], align 4
; CHECK-NEXT: %[[A_FPRIV2:[^,]+]] = load i32, ptr %a.ascast.fpriv, align 4
; CHECK-NEXT: %[[MUL_RES:[^,]+]] = mul nsw i32 %[[A_FPRIV2]], 9
; CHECK-NEXT: %[[X_LOCAL2:[^,]+]] = load i32, ptr addrspace(3) @x.ascast.priv.__local, align 4
; CHECK-NEXT: %[[ADD_RES:[^,]+]] = add nsw i32 %[[X_LOCAL2]], 1
; CHECK-NEXT: %[[INDEX2:[^,]+]] = sext i32 %[[ADD_RES]] to i64
; CHECK-NEXT: %[[PTR2:[^,]+]] = getelementptr inbounds i32, ptr %vla.ascast.lpriv, i64 %[[INDEX2]]
; CHECK-NEXT: store i32 %[[MUL_RES]], ptr %[[PTR2]], align 4
...
entry:
  ...
  %i16.ascast = addrspacecast ptr %i16 to ptr addrspace(4)
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %4 = load i32, ptr addrspace(4) %n.addr.ascast, align 4
  %cmp = icmp slt i32 %3, %4
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %5 = load i32, ptr addrspace(4) %i.ascast, align 4
  %idxprom = sext i32 %5 to i64
  %ptridx = getelementptr inbounds i32, ptr addrspace(4) %vla.ascast, i64 %idxprom
  store i32 -1, ptr addrspace(4) %ptridx, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %7 = load i32, ptr addrspace(4) %n.addr.ascast, align 4
  ...
  %9 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET.DATA"(),
    ...
    "QUAL.OMP.MAP.TOFROM"(ptr addrspace(4) %vla.ascast, ptr addrspace(4) %arrayidx, i64 %8, i64 35) ] ; MAP type: 35 = 0x23 = TARGET_PARAM (0x20) | FROM (0x2) | TO (0x1)

  %10 = load i64, ptr addrspace(4) %omp.vla.tmp.ascast, align 8
  store i64 %10, ptr addrspace(4) %omp.vla.tmp1.ascast, align 8
  %11 = load i32, ptr addrspace(4) %n.addr.ascast, align 4
  store i32 %11, ptr addrspace(4) %.capture_expr.0.ascast, align 4
  ...
  store i32 %sub3, ptr addrspace(4) %.capture_expr.1.ascast, align 4
  store i32 0, ptr addrspace(4) %.omp.lb.ascast, align 4
  %13 = load i32, ptr addrspace(4) %.capture_expr.1.ascast, align 4
  store i32 %13, ptr addrspace(4) %.omp.ub.ascast, align 4
  %14 = mul nuw i64 %10, 4
  %15 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.MAP.TOFROM"(ptr addrspace(4) %vla.ascast, ptr addrspace(4) %vla.ascast, i64 %14, i64 547), ; MAP type: 547 = 0x223 = IMPLICIT (0x200) | TARGET_PARAM (0x20) | FROM (0x2) | TO (0x1)
    ...
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %omp.vla.tmp1.ascast, i64 0, i32 1) ]

  %vla.len.load1 = load i64, ptr addrspace(4) %omp.vla.tmp1.ascast, align 8
  %16 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    ...
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %vla.ascast, i32 0, i64 %vla.len.load1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv.ascast, i32 0, i32 1),
  ...
  %vla.len.load2 = load i64, ptr addrspace(4) %omp.vla.tmp1.ascast, align 8
  %17 = load i32, ptr addrspace(4) %.capture_expr.0.ascast, align 4
  %cmp4 = icmp slt i32 0, %17
  br i1 %cmp4, label %omp.precond.then, label %omp.precond.end

omp.precond.then:                                 ; preds = %for.end
  %18 = call token @llvm.directive.region.entry() [ "DIR.OMP.DISTRIBUTE"(),
    "QUAL.OMP.LASTPRIVATE:TYPED"(ptr addrspace(4) %vla.ascast, i32 0, i64 %vla.len.load2),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr addrspace(4) %.omp.iv.ascast, i32 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.lb.ascast, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr addrspace(4) %.omp.ub.ascast, i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %x.ascast, i32 0, i32 1) ]

  %19 = load i64, ptr addrspace(4) %omp.vla.tmp1.ascast, align 8
  %20 = load i32, ptr addrspace(4) %.omp.lb.ascast, align 4
  store i32 %20, ptr addrspace(4) %.omp.iv.ascast, align 4
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %omp.precond.then
  %21 = load i32, ptr addrspace(4) %.omp.iv.ascast, align 4
  %22 = load i32, ptr addrspace(4) %.omp.ub.ascast, align 4
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i32 %add8, ptr addrspace(4) %x.ascast, align 4
  %24 = load i32, ptr addrspace(4) %a.ascast, align 4
  %25 = load i32, ptr addrspace(4) %x.ascast, align 4
  %idxprom9 = sext i32 %25 to i64
  %ptridx10 = getelementptr inbounds i32, ptr addrspace(4) %vla.ascast, i64 %idxprom9
  store i32 %24, ptr addrspace(4) %ptridx10, align 4
  %26 = load i32, ptr addrspace(4) %a.ascast, align 4
  %mul11 = mul nsw i32 %26, 9
  %27 = load i32, ptr addrspace(4) %x.ascast, align 4
  %add12 = add nsw i32 %27, 1
  %idxprom13 = sext i32 %add12 to i64
  %ptridx14 = getelementptr inbounds i32, ptr addrspace(4) %vla.ascast, i64 %idxprom13
  store i32 %mul11, ptr addrspace(4) %ptridx14, align 4
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %28 = load i32, ptr addrspace(4) %.omp.iv.ascast, align 4
...
omp.precond.end:                                  ; preds = %omp.loop.exit, %for.end
  ...
  store i32 0, ptr addrspace(4) %i16.ascast, align 4
  br label %for.cond17

for.cond17:                                       ; preds = %for.inc31, %omp.precond.end
  %29 = load i32, ptr addrspace(4) %i16.ascast, align 4
  %30 = load i32, ptr addrspace(4) %n.addr.ascast, align 4
  %cmp18 = icmp slt i32 %29, %30
  br i1 %cmp18, label %for.body20, label %for.end33

for.body20:                                       ; preds = %for.cond17
  %31 = load i32, ptr addrspace(4) %i16.ascast, align 4
  %idxprom21 = sext i32 %31 to i64
  %ptridx22 = getelementptr inbounds i32, ptr addrspace(4) %vla.ascast, i64 %idxprom21
  %32 = load i32, ptr addrspace(4) %ptridx22, align 4
  %33 = load i32, ptr addrspace(4) %a.ascast, align 4
  %cmp23 = icmp ne i32 %32, %33
  br i1 %cmp23, label %if.then, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %for.body20
  %34 = load i32, ptr addrspace(4) %i16.ascast, align 4
  %add25 = add nsw i32 %34, 1
  %idxprom26 = sext i32 %add25 to i64
  %ptridx27 = getelementptr inbounds i32, ptr addrspace(4) %vla.ascast, i64 %idxprom26
  %35 = load i32, ptr addrspace(4) %ptridx27, align 4
  %36 = load i32, ptr addrspace(4) %a.ascast, align 4
...
if.then:                                          ; preds = %lor.lhs.false, %for.body20
  ...
  store i32 1, ptr addrspace(4) %cleanup.dest.slot.ascast, align 4
  br label %cleanup
...
for.inc31:                                        ; preds = %if.end
  %37 = load i32, ptr addrspace(4) %i16.ascast, align 4
  %add32 = add nsw i32 %37, 2
  store i32 %add32, ptr addrspace(4) %i16.ascast, align 4
  br label %for.cond17

for.end33:                                        ; preds = %for.cond17
  %call34 = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.1 to ptr addrspace(4)))
  store i32 1, ptr addrspace(4) %retval.ascast, align 4
  store i32 1, ptr addrspace(4) %cleanup.dest.slot.ascast, align 4
  br label %cleanup

cleanup:                                          ; preds = %for.end33, %if.then
  %38 = load ptr, ptr addrspace(4) %saved_stack.ascast, align 8
  call void @llvm.stackrestore(ptr %38)
  %39 = load i32, ptr addrspace(4) %retval.ascast, align 4
  ret i32 %39
}
...
declare spir_func i32 @printf(ptr addrspace(4), ...) #2

...
; Test src:
;
; void bar_variant(int AAA, int BBB, int CCC, ...) {}
;
...
define dso_local void @_Z11bar_variantiz(i32 noundef %AAA, i32 noundef %BBB, i32 noundef %CCC, ...)  {
entry:
  %AAA.addr = alloca i32, align 4
  %BBB.addr = alloca i32, align 4
  %CCC.addr = alloca i32, align 4
  store i32 %AAA, ptr %AAA.addr, align 4
  store i32 %BBB, ptr %BBB.addr, align 4
  store i32 %CCC, ptr %BBB.addr, align 4
  ret void
}

...
; ALL:      mayCallOmpGetNumThreads: Region #2 (parallel) may call omp_get_num_threads: Yes.
...
entry:
  ...
  %3 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(), "QUAL.OMP.SHARED"(i32 addrspace(4)* %nt.ascast) ]
  %4 = call token @llvm.directive.region.entry() [ "DIR.OMP.MASTER"() ]
  fence acquire
  %5 = load i32, i32 addrspace(4)* %nt.ascast, align 4
  %call1 = call spir_func i32 (i8 addrspace(4)*, ...) @printf(i8 addrspace(4)* getelementptr inbounds ([4 x i8], [4 x i8] addrspace(4)* addrspacecast ([4 x i8] addrspace(1)* @.str to [4 x i8] addrspace(4)*), i64 0, i64 0), i32 %5) #4
  fence release
  call void @llvm.directive.region.exit(token %4) [ "DIR.OMP.END.MASTER"() ]
...
!0 = !{i32 0, i32 66313, i32 47065382, !"_Z4main", i32 5, i32 0, i32 0}

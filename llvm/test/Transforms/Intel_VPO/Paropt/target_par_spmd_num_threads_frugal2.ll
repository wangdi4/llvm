...
entry:
  ...
  fence acquire
  %5 = load i32, ptr addrspace(4) %nt.ascast, align 4
  %call1 = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str to ptr addrspace(4)), i32 %5) #4
  fence release

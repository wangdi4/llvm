...
; CHECK: @__omp_offloading{{.*}}main{{.*}}_kernel_info = weak target_declare addrspace(1) constant %[[KINFO_TYPE]] { i32 4, i32 5, [5 x %[[KINFO_ARGMAP_TYPE]]] [%[[KINFO_ARGMAP_TYPE]] { i32 0, i32 8 }, %[[KINFO_ARGMAP_TYPE]] { i32 0, i32 8 }, %[[KINFO_ARGMAP_TYPE]] { i32 0, i32 8 }, %[[KINFO_ARGMAP_TYPE]] { i32 0, i32 8 }, %[[KINFO_ARGMAP_TYPE]] { i32 0, i32 8 }], i64 0, i64 1024, i64 1024 }

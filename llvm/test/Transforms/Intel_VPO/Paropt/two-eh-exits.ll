...
DIR.OMP.TARGET.DATA.1:                            ; preds = %DIR.OMP.TARGET.DATA.212
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET.DATA"(), "QUAL.OMP.MAP.TOFROM"(double* %ptr1, double* %ptr2, i64 0, i64 64, [48 x i8]* @.mapname.278, i8* null) ]
  br label %DIR.OMP.TARGET.DATA.3.split.split

DIR.OMP.TARGET.DATA.3.split.split:                ; preds = %DIR.OMP.TARGET.DATA.1
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET.DATA"(), "QUAL.OMP.MAP.TOFROM"(double** %dptr, double** %dptr, i64 0, i64 64, [46 x i8]* @.mapname.257, i8* null) ]

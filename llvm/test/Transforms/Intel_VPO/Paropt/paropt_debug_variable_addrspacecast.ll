...
; CHECK: call void @llvm.dbg.declare(metadata ptr %v.ascast.priv{{.*}}, metadata [[V_TARGET:![0-9]+]], metadata !DIExpression())
; CHECK: }
...
define hidden i32 @main(i32 %argc, ptr addrspace(4) %argv) #2 !dbg !6 {
entry:
  %v = alloca i32, align 4
  call void @llvm.dbg.declare(metadata ptr %v, metadata !13, metadata !DIExpression()), !dbg !16
...
DIR.OMP.TARGET.ENTRY:                             ; preds = %entry
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    ...
    "QUAL.OMP.PRIVATE:WILOCAL.TYPED"(ptr addrspace(4) %v.ascast, i32 0, i32 1) ], !dbg !17
  br label %KERNEL

KERNEL:                                           ; preds = %DIR.OMP.TARGET.ENTRY
  store i32 0, ptr addrspace(4) %v.ascast, align 4, !dbg !16
  br label %DIR.OMP.TARGET.EXIT

DIR.OMP.TARGET.EXIT:                              ; preds = %KERNEL
  call void @llvm.directive.region.exit(token %0) [ "DIR.OMP.END.TARGET"() ], !dbg !17
  ret i32 0, !dbg !18
}
...
!13 = !DILocalVariable(name: "V", scope: !14, file: !1, line: 61, type: !9)
!14 = distinct !DILexicalBlock(scope: !15, file: !1, line: 58, column: 3)
!15 = distinct !DILexicalBlock(scope: !6, file: !1, line: 57, column: 1)
!16 = !DILocation(line: 61, column: 9, scope: !14)
!17 = !DILocation(line: 57, column: 1, scope: !15)

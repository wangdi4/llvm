...
; CHECK: %__struct.kmp_privates.t = type { { ptr, i64, i64, i64, i64, i64, [3 x { i64, i64, i64 }] }, i64, i64, i32, i32, i32 }
...
; CHECK: store i64 224, ptr [[ARR_OFFSET_GEP]]
...
; CHECK: [[FOO_A_PRIV4:%[^ ]+]] = getelementptr inbounds %__struct.kmp_privates.t, ptr {{[^,]+}}, i32 0, i32 0
; CHECK: [[FOO_A_SHR_GEP:[^ ]+]] = getelementptr inbounds %__struct.shared.t, ptr %{{[^ ]+}}, i32 0, i32 0
; CHECK: [[FOO_A_SHR:%[^ ]+]] = load ptr, ptr [[FOO_A_SHR_GEP]]
; CHECK: call void @_f90_lastprivate_copy(ptr [[FOO_A_PRIV4]], ptr [[FOO_A_SHR]])

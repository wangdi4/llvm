; RUN: opt < %s -loop-rotate -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -sroa -vpo-cfg-restructuring -vpo-paropt -simplifycfg -switch-to-offload -S -pass-remarks=vpo-paropt-transform -pass-remarks-missed=vpo-paropt-transform 2>&1 | FileCheck %s
; RUN: opt < %s -passes='function(loop(loop-rotate),vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,loop-simplify,sroa,vpo-cfg-restructuring),vpo-paropt,function(simplify-cfg)' -switch-to-offload -S -pass-remarks=vpo-paropt-transform -pass-remarks-missed=vpo-paropt-transform 2>&1 | FileCheck %s
...
entry:
  ...
  %16 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(), "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %1), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %2), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %3), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %4), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %5), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %6), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %7), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %8), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %9), "QUAL.OMP.MAP.TOFROM"(i32 addrspace(4)* %10), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %13), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %14), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %15), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %11), "QUAL.OMP.PRIVATE"(i32 addrspace(4)* %12) ]

...
;   %scalar.fpriv = call ptr @__kmpc_aligned_alloc(i32 %my.tid1, i64 0, i64 4, i64 %default_allocator)
;
; CHECK: [[TID:%[^ ]+]] = load i32, ptr %tid, align 4
; CHECK: [[DEFALLOC:%[^ ]+]] = call i64 @omp_get_default_allocator()
; CHECK-NEXT:  call ptr @__kmpc_aligned_alloc(i32 [[TID]], i64 0, i64 4, i64 [[DEFALLOC]])
...
;   %array.priv = call ptr @__kmpc_aligned_alloc(i32 %my.tid, i64 0, i64 400, i64 2)
;
; CHECK: [[TID2:%[^ ]+]] = load i32, ptr %tid, align 4
; CHECK-NEXT:  call ptr @__kmpc_aligned_alloc(i32 [[TID2]], i64 0, i64 400, i64 2)
...
DIR.OMP.PARALLEL.2:                               ; preds = %DIR.OMP.PARALLEL.1
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    ...
    "QUAL.OMP.ALLOCATE"(i64 0, ptr %array, i64 2),
    "QUAL.OMP.ALLOCATE"(i64 0, ptr %scalar) ]

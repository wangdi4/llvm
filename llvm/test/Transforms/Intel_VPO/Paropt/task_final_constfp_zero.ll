...
; ModuleID = 'task_final_constfp_zero.c'
source_filename = "task_final_constfp_zero.c"
...
entry:
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.FINAL"(double 0.000000e+00) ]

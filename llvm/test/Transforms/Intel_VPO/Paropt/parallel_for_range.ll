...
; CHECK: call{{.+}}  @__kmpc_fork_call(ptr {{.+}}, i32 3, ptr [[FOO_OUTLINED:@.+]], ptr {{.+}}, i64 {{.+}},
; CHECK: }

; CHECK: define dso_local void @bar(ptr noundef %P, i32 noundef %N) {
; CHECK: call{{.+}}  @__kmpc_fork_call(ptr {{.+}}, i32 3, ptr [[BAR_OUTLINED:@.+]], ptr {{.+}}, i64 {{.+}},
; CHECK: }

; CHECK: define dso_local void @goo(ptr noundef %P) {
; CHECK: call{{.+}}  @__kmpc_fork_call(ptr {{.+}}, i32 3, ptr [[GOO_OUTLINED:@.+]], ptr {{.+}}, i64 {{.+}},
; CHECK: }

; CHECK: define dso_local void @baz(ptr noundef %P) {
; CHECK: call{{.+}}  @__kmpc_fork_call(ptr {{.+}}, i32 3, ptr [[BAZ_OUTLINED:@.+]], ptr {{.+}}, i64 {{.+}},
; CHECK: }

; CHECK: define internal void [[FOO_OUTLINED]](ptr %{{.+}}, ptr %{{.+}}, ptr %{{.+}}, i64 %{{.+}}, ptr %{{.+}}) #{{[0-9]+}} {
; CHECK:   call void @__kmpc_for_static_init_4(ptr {{.+}}, i32 %{{.+}}, i32 34, ptr %{{.+}}, ptr [[FOO_LBA:%.+]], ptr [[FOO_UBA:%.+]], ptr %{{.+}}, i32 1, i32 1)
; CHECK:   %{{.+}} = load i32, ptr [[FOO_LBA]], align 4, !range [[FOO_RANGE:![0-9]+]]
; CHECK:   %{{.+}} = load i32, ptr [[FOO_UBA]], align 4, !range [[FOO_RANGE]]
; CHECK: }

; CHECK: define internal void [[BAR_OUTLINED]](ptr %{{.+}}, ptr %{{.+}}, ptr %{{.+}}, i64 %{{.+}}, ptr %{{.+}}) #{{[0-9]+}} {
; CHECK:   call void @__kmpc_for_static_init_4(ptr {{.+}}, i32 %{{.+}}, i32 34, ptr %{{.+}}, ptr [[BAR_LBA:%.+]], ptr [[BAR_UBA:%.+]], ptr %{{.+}}, i32 1, i32 1)
; CHECK:   %{{.+}} = load i32, ptr [[BAR_LBA]], align 4, !range [[BAR_RANGE:![0-9]+]]
; CHECK:   %{{.+}} = load i32, ptr [[BAR_UBA]], align 4, !range [[BAR_RANGE]]
; CHECK: }

; CHECK: define internal void [[GOO_OUTLINED]](ptr %{{.+}}, ptr %{{.+}}, ptr %{{.+}}, i64 %{{.+}}, ptr %{{.+}}) #{{[0-9]+}} {
; CHECK:   call void @__kmpc_for_static_init_4(ptr {{.+}}, i32 %{{.+}}, i32 33, ptr %{{.+}}, ptr [[GOO_LBA:%.+]], ptr [[GOO_UBA:%.+]], ptr %{{.+}}, i32 1, i32 10)
; CHECK:   %{{.+}} = load i32, ptr [[GOO_LBA]], align 4, !range [[GOO_RANGE:![0-9]+]]
; CHECK:   %{{.+}} = load i32, ptr [[GOO_UBA]], align 4, !range [[GOO_RANGE]]
; CHECK: }

; CHECK: define internal void [[BAZ_OUTLINED]](ptr %{{.+}}, ptr %{{.+}}, ptr %{{.+}}, i64 %{{.+}}, ptr %{{.+}}) #{{[0-9]+}} {
; CHECK:   call void @__kmpc_for_static_init_4u(ptr {{.+}}, i32 %{{.+}}, i32 34, ptr %{{.+}}, ptr [[BAZ_LBA:%.+]], ptr [[BAZ_UBA:%.+]], ptr %{{.+}}, i32 1, i32 1)
; CHECK:   %{{.+}} = load i32, ptr [[BAZ_LBA]], align 4, !range [[BAZ_RANGE:![0-9]+]]
; CHECK:   %{{.+}} = load i32, ptr [[BAZ_UBA]], align 4, !range [[BAZ_RANGE]]
; CHECK: }
...
define dso_local void @bar(ptr noundef %P, i32 noundef %N) {
entry:
  %P.addr = alloca ptr, align 8
...
define dso_local void @goo(ptr noundef %P) {
entry:
  %P.addr = alloca ptr, align 8
  %tmp = alloca i32, align 4
  %.omp.iv = alloca i32, align 4
  ...
  store ptr %P, ptr %P.addr, align 8
  store i32 0, ptr %.omp.lb, align 4
  store i32 599, ptr %.omp.ub, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.SCHEDULE.STATIC"(i32 10),
    "QUAL.OMP.SHARED:TYPED"(ptr %P.addr, ptr null, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr %.omp.iv, i32 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr %.omp.lb, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr %.omp.ub, i32 0),
...
define dso_local void @baz(ptr noundef %P) {
entry:
  %P.addr = alloca ptr, align 8
  %tmp = alloca i32, align 4
  %.omp.iv = alloca i32, align 4
  ...
  store ptr %P, ptr %P.addr, align 8
  store i32 0, ptr %.omp.lb, align 4
  store i32 499, ptr %.omp.ub, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.SHARED:TYPED"(ptr %P.addr, ptr null, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr %.omp.iv, i32 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr %.omp.lb, i32 0, i32 1),

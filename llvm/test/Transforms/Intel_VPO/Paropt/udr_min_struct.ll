...
entry:
  ...
  store i32 9999, ptr %minx, align 4
  store i32 9999, ptr %miny, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [1000 x %struct.point], ptr @points, i64 0, i64 %idxprom
  %x1 = getelementptr inbounds %struct.point, ptr %arrayidx, i32 0, i32 0
  store i32 %3, ptr %x1, align 8
  %5 = load i32, ptr %y, align 4
  %6 = load i32, ptr %i, align 4
  %idxprom2 = sext i32 %6 to i64
  %arrayidx3 = getelementptr inbounds [1000 x %struct.point], ptr @points, i64 0, i64 %idxprom2
  %y4 = getelementptr inbounds %struct.point, ptr %arrayidx3, i32 0, i32 1
  store i32 %5, ptr %y4, align 4
  %7 = load i32, ptr %minx, align 4
...
for.end:                                          ; preds = %for.cond
  ...
  %14 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR:TYPED"(ptr @corner, %struct.point zeroinitializer, i32 1, ptr null, ptr @_ZTS5point.omp.destr, ptr @.omp_combiner., ptr @.omp_initializer.),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr %.omp.lb, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr %.omp.iv, i32 0),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr %.omp.ub, i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr %i, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr @points, [1000 x %struct.point] zeroinitializer, i32 1) ]

; CRITICAL-NOT: "QUAL.OMP.REDUCTION.UDR"
; CRITICAL: call void @.omp_initializer.(ptr %corner.red{{.*}}, ptr @corner)
; CRITICAL: call void @__kmpc_critical({{.*}})
; CRITICAL: call void @.omp_combiner.(ptr @corner, ptr %corner.red{{.*}})
; CRITICAL: call void @__kmpc_end_critical({{.*}})
; CRITICAL: call void @_ZTS5point.omp.destr(ptr %corner.red{{.*}})
...
; FASTRED-DAG: call void @_ZTS5point.omp.destr(ptr %corner.fast_red{{.*}})
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx11 = getelementptr inbounds [1000 x %struct.point], ptr @points, i64 0, i64 %idxprom10
  %x12 = getelementptr inbounds %struct.point, ptr %arrayidx11, i32 0, i32 0
  %20 = load i32, ptr %x12, align 8
  %21 = load i32, ptr @corner, align 4
...
if.then14:                                        ; preds = %omp.inner.for.body
  ...
  %arrayidx16 = getelementptr inbounds [1000 x %struct.point], ptr @points, i64 0, i64 %idxprom15
  %x17 = getelementptr inbounds %struct.point, ptr %arrayidx16, i32 0, i32 0
  %23 = load i32, ptr %x17, align 8
  store i32 %23, ptr @corner, align 4
  br label %if.end18

if.end18:                                         ; preds = %if.then14, %omp.inner.for.body
  %24 = load i32, ptr %i, align 4
  %idxprom19 = sext i32 %24 to i64
  %arrayidx20 = getelementptr inbounds [1000 x %struct.point], ptr @points, i64 0, i64 %idxprom19
  %y21 = getelementptr inbounds %struct.point, ptr %arrayidx20, i32 0, i32 1
  %25 = load i32, ptr %y21, align 4
  %26 = load i32, ptr getelementptr inbounds (%struct.point, ptr @corner, i32 0, i32 1), align 4
...
if.then23:                                        ; preds = %if.end18
  ...
  %arrayidx25 = getelementptr inbounds [1000 x %struct.point], ptr @points, i64 0, i64 %idxprom24
  %y26 = getelementptr inbounds %struct.point, ptr %arrayidx25, i32 0, i32 1
  %28 = load i32, ptr %y26, align 4
  store i32 %28, ptr getelementptr inbounds (%struct.point, ptr @corner, i32 0, i32 1), align 4
  br label %if.end27
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %29 = load i32, ptr %.omp.iv, align 4
...
entry:
  ...
  %x2 = getelementptr inbounds %struct.point, ptr %3, i32 0, i32 0
  %5 = load i32, ptr %x2, align 4
  %cmp = icmp sgt i32 %4, %5
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %x3 = getelementptr inbounds %struct.point, ptr %3, i32 0, i32 0
  %6 = load i32, ptr %x3, align 4
  br label %cond.end

cond.false:                                       ; preds = %entry
  %x4 = getelementptr inbounds %struct.point, ptr %2, i32 0, i32 0
  %7 = load i32, ptr %x4, align 4
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %6, %cond.true ], [ %7, %cond.false ]
  %x5 = getelementptr inbounds %struct.point, ptr %3, i32 0, i32 0
  store i32 %cond, ptr %x5, align 4
  %y = getelementptr inbounds %struct.point, ptr %2, i32 0, i32 1
  %8 = load i32, ptr %y, align 4
  %y6 = getelementptr inbounds %struct.point, ptr %3, i32 0, i32 1
  %9 = load i32, ptr %y6, align 4
  %cmp7 = icmp sgt i32 %8, %9
  br i1 %cmp7, label %cond.true8, label %cond.false10

cond.true8:                                       ; preds = %cond.end
  %y9 = getelementptr inbounds %struct.point, ptr %3, i32 0, i32 1
  %10 = load i32, ptr %y9, align 4
  br label %cond.end12

cond.false10:                                     ; preds = %cond.end
  %y11 = getelementptr inbounds %struct.point, ptr %2, i32 0, i32 1
  %11 = load i32, ptr %y11, align 4
  br label %cond.end12

cond.end12:                                       ; preds = %cond.false10, %cond.true8
  %cond13 = phi i32 [ %10, %cond.true8 ], [ %11, %cond.false10 ]
  %y14 = getelementptr inbounds %struct.point, ptr %3, i32 0, i32 1
  store i32 %cond13, ptr %y14, align 4
  ret void
}
...
entry:
  ...
  store i32 9999, ptr %x, align 4
  %y = getelementptr inbounds %struct.point, ptr %3, i32 0, i32 1
  store i32 9999, ptr %y, align 4
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @_ZTS5point.omp.destr(ptr %0) #2 section ".text.startup" {
entry:
  %.addr = alloca ptr, align 8
  store ptr %0, ptr %.addr, align 8
  ret void

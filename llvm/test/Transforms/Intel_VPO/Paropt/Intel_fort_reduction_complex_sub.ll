...
bb17:                                             ; preds = %bb16
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL"(),
    "QUAL.OMP.REDUCTION.SUB:CMPLX.TYPED"(ptr %"omp_test_$R", %complex_64bit zeroinitializer, i64 2) ]
  br label %bb18
...
bb19:                                             ; preds = %bb18
  ...
  %sub6 = fsub float %func_result4_fetch_comp_1, 0.000000e+00
  %insertval = insertvalue %complex_64bit zeroinitializer, float %sub, 0
  %insertval8 = insertvalue %complex_64bit %insertval, float %sub6, 1
  br label %bb20
...
bb23:                                             ; preds = %bb22
  ...
  %sub17 = fsub float 0x3FBF7CEDA0000000, %int_cast
  %insertval19 = insertvalue %complex_64bit zeroinitializer, float %sub17, 0
  ...
  %sub23 = fsub float %func_result15_fetch_comp_0, %insertval21_comp_0
  ...
  %sub25 = fsub float %func_result15_fetch_comp_1, %insertval21_comp_1
  %insertval27 = insertvalue %complex_64bit zeroinitializer, float %sub23, 0
  %insertval29 = insertvalue %complex_64bit %insertval27, float %sub25, 1
  %insertval29_comp_0 = extractvalue %complex_64bit %insertval29, 0
  %insertval29_comp_1 = extractvalue %complex_64bit %insertval29, 1
  %mul = fmul float %insertval29_comp_1, %insertval29_comp_1
  %mul31 = fmul float %insertval29_comp_0, %insertval29_comp_0
  %add = fadd float %mul31, %mul
  br label %bb24
...
bb25:                                             ; preds = %bb24
  %func_result33 = call float @sqrtf(float %add)
  br label %bb26
...
bb29:                                             ; preds = %bb28
  ...
  %sub51 = fsub float 0x3FBF7CEDA0000000, %int_cast49
  %insertval53 = insertvalue %complex_64bit zeroinitializer, float %sub51, 0
...
bb41:                                             ; preds = %bb40
  ...
  %sub111 = fsub float 0x3FBF7CEDA0000000, %int_cast109
  %insertval113 = insertvalue %complex_64bit zeroinitializer, float %sub111, 0

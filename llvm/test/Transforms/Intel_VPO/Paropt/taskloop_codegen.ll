...
entry:
  ...
  %5 = load i64, i64* %.omp.lb, align 8, !tbaa !1
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  ...
  %7 = load i64, i64* %.omp.ub, align 8, !tbaa !1
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %11 = load i32, i32* %.omp.iv, align 4, !tbaa !5
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %13 = bitcast i64* %.omp.stride to i8*
  call void @llvm.lifetime.end(i64 8, i8* %13) #2
  %14 = bitcast i64* %.omp.ub to i8*
  call void @llvm.lifetime.end(i64 8, i8* %14) #2
  %15 = bitcast i64* %.omp.lb to i8*

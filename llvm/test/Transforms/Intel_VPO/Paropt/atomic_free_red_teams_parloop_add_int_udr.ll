...
; CHECK: %[[LOCAL_SUM_GEP:[^,]+]] = getelementptr inbounds i32, ptr addrspace(1) %[[RED_GLOBAL_BUF]], i64 %[[GROUP_ID]]
...
; CHECK: call spir_func void @.omp_combiner.(ptr addrspace(4) addrspacecast (ptr addrspace(3) @[[LOCAL_PTR:[^,]+]] to ptr addrspace(4)), ptr addrspace(4) %
...
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.REDUCTION.UDR:TYPED"(ptr addrspace(4) %sum.ascast, i32 0, i32 1, ptr null, ptr null, ptr @.omp_combiner., ptr @.omp_initializer.),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv.ascast, i32 0, i32 1),

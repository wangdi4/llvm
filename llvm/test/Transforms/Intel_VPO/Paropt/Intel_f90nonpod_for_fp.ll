...
declare dso_local noalias ptr @calloc(i64 noundef, i64 noundef)

declare dso_local i32 @printf(ptr noundef, ...)

; Function Attrs: nounwind
declare dso_local void @free(ptr noundef)
...
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(),
    "QUAL.OMP.FIRSTPRIVATE:F90_NONPOD.TYPED"(ptr @c, %struct.C zeroinitializer, i32 1, ptr @_ZTS1C.omp.copy_constr, ptr @_ZTS1C.omp.destr),

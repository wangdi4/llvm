...
; instead of NONPOD for the fistprivate operand c.
...
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(), "QUAL.OMP.FIRSTPRIVATE:F90_NONPOD"(%struct.C* @c, void (%struct.C*, %struct.C*)* @_ZTS1C.omp.copy_constr, void (%struct.C*)* @_ZTS1C.omp.destr), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i) ]

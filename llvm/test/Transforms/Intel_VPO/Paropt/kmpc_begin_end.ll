; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-paropt -S %s | FileCheck %s -check-prefix=DEFAULT
; RUN: opt -opaque-pointers=1 -passes='vpo-paropt' -S %s | FileCheck %s -check-prefix=DEFAULT

; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-paropt -S -vpo-paropt-emit-kmpc-begin-end-only-for-windows=false -vpo-paropt-emit-kmpc-begin=true %s | FileCheck %s -check-prefix=WITH_BEGIN --check-prefix=WITH_END
...
; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-paropt -S -mtriple=i686-unknown-windows -vpo-paropt-emit-kmpc-begin=true %s | FileCheck %s -check-prefix=WITH_BEGIN --check-prefix=WITH_END
...
; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-paropt -S -mtriple=x86_64-unknown-windows -vpo-paropt-emit-kmpc-begin=true %s | FileCheck %s -check-prefix=WITH_BEGIN --check-prefix=WITH_END
...
; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-paropt -S -vpo-paropt-emit-kmpc-begin-end-only-for-windows=false %s | FileCheck %s -check-prefix=WITH_END
...
; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-paropt -S -mtriple=i686-unknown-windows %s | FileCheck %s -check-prefix=WITH_END
; RUN: opt -opaque-pointers=1 -passes='vpo-paropt' -S -mtriple=i686-unknown-windows %s | FileCheck %s -check-prefix=WITH_END
; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-paropt -S -mtriple=x86_64-unknown-windows %s | FileCheck %s -check-prefix=WITH_END

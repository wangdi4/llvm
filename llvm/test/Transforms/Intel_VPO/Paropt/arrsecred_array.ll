...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.ADD:ARRSECT.TYPED"(ptr @_Z1y, i32 0, i64 40, i64 20),
...
; CRITICAL-DAG: %[[LOCAL_GEP:[a-zA-Z._0-9]+]] = getelementptr inbounds [40 x i32], ptr %[[LOCAL:[a-zA-Z._0-9]+]], i32 0, i32 0
; CRITICAL-DAG: %[[LOCAL_MINUS_OFFSET:[a-zA-Z._0-9]+]] = getelementptr i32, ptr %[[LOCAL_GEP]], i64 -20
; Zero-trip test for reduction array initialization
; CRITICAL-DAG: %[[LOCAL_END:[0-9]+]] = getelementptr i32, ptr %[[LOCAL_GEP]], i64 40
; CRITICAL-DAG: %{{[a-zA-Z._0-9]+}} = icmp eq ptr %[[LOCAL_GEP]], %[[LOCAL_END]]

; FASTRED: %[[LOCAL:[a-zA-Z._0-9]+]] = getelementptr inbounds %struct.fast_red_t, ptr %fast_red_struct, i32 0, i32 0
; FASTRED-NEXT: %[[LOCAL_GEP:[a-zA-Z._0-9]+]] = getelementptr inbounds [40 x i32], ptr %[[LOCAL:[a-zA-Z._0-9]+]], i32 0, i32 0
; FASTRED-DAG: %[[LOCAL_MINUS_OFFSET:[a-zA-Z._0-9]+]] = getelementptr i32, ptr %[[LOCAL_GEP]], i64 -20
; FASTRED-DAG: %[[LOCAL_MINUS_OFFSET_PLUS_OFFSET:[a-zA-Z._0-9]+]] = getelementptr i32, ptr %[[LOCAL_MINUS_OFFSET]]
; Zero-trip test for reduction array initialization
; FASTRED-DAG: %[[LOCAL_END:[0-9]+]] = getelementptr i32, ptr %[[LOCAL_MINUS_OFFSET_PLUS_OFFSET]], i64 40
; FASTRED-DAG: %{{[a-zA-Z._0-9]+}} = icmp eq ptr %[[LOCAL_MINUS_OFFSET_PLUS_OFFSET]], %[[LOCAL_END]]
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx = getelementptr inbounds [5 x i32], ptr getelementptr inbounds ([3 x [4 x [5 x i32]]], ptr @_Z1y, i64 0, i64 1, i64 2), i64 0, i64 %idxprom
...
; ALL-DAG: icmp eq (ptr getelementptr (i32, ptr @_Z1y, i64 20), ptr getelementptr (i32, ptr @_Z1y, i64 60))

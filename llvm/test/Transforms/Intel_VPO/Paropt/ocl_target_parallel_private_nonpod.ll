...
; CHECK-DAG: call %class.C addrspace(4)* @_ZTS1C.omp.def_constr(%class.C addrspace(4)* addrspacecast (%class.C addrspace(1)* [[C_TGT]] to %class.C addrspace(4)*))
...
; CHECK-DAG: call void @_ZTS1C.omp.destr(%class.C addrspace(4)* addrspacecast (%class.C addrspace(1)* [[C_TGT]] to %class.C addrspace(4)*))

; Check for the private copy of @c for the parallel construct
; CHECK-DAG: [[C_PAR:%c.*]] = alloca %class.C, align 1
; CHECK-DAG: {{%[^ ]+}} = call %class.C addrspace(4)* @_ZTS1C.omp.def_constr(%class.C addrspace(4)* [[C_PAR_CAST:%[^, ]+]])
...
; CHECK-DAG: call void @_ZTS1C.omp.destr(%class.C addrspace(4)* [[C_PAR_CAST1:%[^, ]+]])

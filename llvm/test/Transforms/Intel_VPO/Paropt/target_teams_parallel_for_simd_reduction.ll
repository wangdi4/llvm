...
; CHECK: %i0.ascast.priv.ascast.vec.ascast.base.addr = getelementptr i32, ptr addrspace(4) %i0.ascast.priv.ascast.vec.ascast, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7> 
...
entry:
  ...
  store i32 262144, ptr addrspace(4) %N0.ascast, align 4, !tbaa !9
  store double 2.621440e+05, ptr addrspace(4) %expected_value.ascast, align 8, !tbaa !13
  store double 0.000000e+00, ptr addrspace(4) %counter_N0.ascast, align 8, !tbaa !13
  store i32 0, ptr addrspace(4) %.omp.lb.ascast, align 4, !tbaa !9
  store i32 262143, ptr addrspace(4) %.omp.ub.ascast, align 4, !tbaa !9
  ...
  %4 = load i32, ptr addrspace(4) %.omp.lb.ascast, align 4, !tbaa !9
  store i32 %4, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !9
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  %5 = load i32, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !9
  %6 = load i32, ptr addrspace(4) %.omp.ub.ascast, align 4, !tbaa !9
  %cmp = icmp sle i32 %5, %6
  br i1 %cmp, label %omp.inner.for.body, label %omp.inner.for.end

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %7 = load i32, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !9
  %mul = mul nsw i32 %7, 1
  %add = add nsw i32 0, %mul
  store i32 %add, ptr addrspace(4) %i0.ascast, align 4, !tbaa !9
  %8 = load double, ptr addrspace(4) %counter_N0.ascast, align 8, !tbaa !13
  %add1 = fadd fast double %8, 1.000000e+00
  store double %add1, ptr addrspace(4) %counter_N0.ascast, align 8, !tbaa !13
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %9 = load i32, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !9
  %add2 = add nsw i32 %9, 1
  store i32 %add2, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !9
  br label %omp.inner.for.cond
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %10 = load double, ptr addrspace(4) %counter_N0.ascast, align 8, !tbaa !13

...
entry:
  ...
  %.omp.lb1.ascast = addrspacecast ptr %.omp.lb1 to ptr addrspace(4)
  %.omp.ub2 = alloca i32, align 4
  %.omp.ub2.ascast = addrspacecast ptr %.omp.ub2 to ptr addrspace(4)
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.lb1.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.ub2.ascast, i32 0, i32 1),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store i32 0, ptr addrspace(4) %.omp.lb1.ascast, align 4
  store i32 999, ptr addrspace(4) %.omp.ub2.ascast, align 4
  %5 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv4.ascast, i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.lb1.ascast, i32 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.ub2.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %j.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp3.ascast, i32 0, i32 1) ]

  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.TEAMS"(),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.iv4.ascast, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %.omp.lb1.ascast, i32 0, i32 1),
    "QUAL.OMP.SHARED:TYPED"(ptr addrspace(4) %.omp.ub2.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %j.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp3.ascast, i32 0, i32 1) ]
  ...
  %7 = call token @llvm.directive.region.entry() [ "DIR.OMP.DISTRIBUTE.PARLOOP"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.lb1.ascast, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr addrspace(4) %.omp.ub2.ascast, i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %j.ascast, i32 0, i32 1) ]

  %8 = load i32, ptr addrspace(4) %.omp.lb1.ascast, align 4
...
omp.inner.for.cond5:                              ; preds = %omp.inner.for.inc, %omp.inner.for.body
  ...
  %10 = load i32, ptr addrspace(4) %.omp.ub2.ascast, align 4
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %12 = load i32, ptr addrspace(4) %.omp.iv4.ascast, align 4
  %add10 = add nsw i32 %12, 1
  store i32 %add10, ptr addrspace(4) %.omp.iv4.ascast, align 4
  br label %omp.inner.for.cond5
...
omp.inner.for.inc12:                              ; preds = %omp.body.continue11
  ...
  store i32 %add13, ptr addrspace(4) %.omp.iv.ascast, align 4
  br label %omp.inner.for.cond

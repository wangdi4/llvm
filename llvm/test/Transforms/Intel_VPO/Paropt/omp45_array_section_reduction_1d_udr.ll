...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR:ARRSECT.TYPED"(ptr @_ZL1y_b6acdc6a6767e9f9f0432fc68d908380, i16 0, i64 25, i64 25, ptr null, ptr null, ptr @.omp_combiner., ptr null),
    "QUAL.OMP.SHARED:TYPED"(ptr @_ZL1x_b6acdc6a6767e9f9f0432fc68d908380, i16 0, i64 100),
...
; CHECK: call void @.omp_combiner.(ptr %{{.*}}, ptr %{{.*}})
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], ptr @_ZL1y_b6acdc6a6767e9f9f0432fc68d908380, i64 0, i64 %idxprom
  %6 = load i32, ptr %i, align 4
  %idxprom2 = sext i32 %6 to i64
  %arrayidx3 = getelementptr inbounds [100 x i16], ptr @_ZL1x_b6acdc6a6767e9f9f0432fc68d908380, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], ptr @_ZL1x_b6acdc6a6767e9f9f0432fc68d908380, i64 0, i64 %idxprom
  store i16 1, ptr %arrayidx, align 2
  %2 = load i32, ptr %i, align 4
  %conv = trunc i32 %2 to i16
  %3 = load i32, ptr %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], ptr @_ZL1y_b6acdc6a6767e9f9f0432fc68d908380, i64 0, i64 %idxprom1

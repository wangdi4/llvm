...
; RUN: opt -opaque-pointers=1 -aa-pipeline=basic-aa -passes='function(vpo-cfg-restructuring),vpo-paropt' -S %s | FileCheck %s
...
; The test is a version of target_fp_vla_host.ll, with the hand-modified change
...
; CHECK:   [[SIZE_FP_VAL:%n.val.*]] = load i64, ptr [[SIZE_FP]], align 8

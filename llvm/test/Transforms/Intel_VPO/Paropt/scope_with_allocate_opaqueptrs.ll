...
; This test checks codegen for the 'scope' construct -- with 'allocate' clause.
...
; CHECK: [[TID:%[^ ]+]] = load i32, ptr %{{.*}}, align 4
; CHECK: [[DEFALLOC:%[^ ]+]] = call i64 @omp_get_default_allocator()
; CHECK-NEXT:  call ptr @__kmpc_aligned_alloc(i32 [[TID]], i64 4, i64 4, i64 [[DEFALLOC]])

; CHECK: [[TID2:%[^ ]+]] = load i32, ptr {{.*}}, align 4
; CHECK-NEXT:  call ptr @__kmpc_aligned_alloc(i32 [[TID2]], i64 4, i64 400, i64 2)

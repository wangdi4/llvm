; RUN: opt -opaque-pointers=1 -bugpoint-enable-legacy-pm -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt --vpo-paropt-atomic-free-reduction-ctrl=1 -vpo-paropt-atomic-free-red-local-buf-size=0 -S %s | FileCheck %s
; RUN: opt -opaque-pointers=1 -switch-to-offload -passes='function(vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring),vpo-paropt' --vpo-paropt-atomic-free-reduction-ctrl=1 -vpo-paropt-atomic-free-red-local-buf-size=0 -S %s | FileCheck %s
...
; CHECK: %[[LOCAL_SUM_VAL:[^,]+]] = load volatile i32, ptr addrspace(4) addrspacecast (ptr addrspace(3) @[[LOCAL_SUM:[^,]+]] to ptr addrspace(4))
; CHECK: %[[RED_VALUE:[^,]+]] = add i32 %[[LOCAL_SUM_VAL]], %[[PRIV_SUM_VAL]]
; CHECK: store i32 %[[RED_VALUE]], ptr addrspace(3) @[[LOCAL_SUM]]
...
entry:
  ...
  %3 = load i32, ptr addrspace(4) %.omp.lb.ascast, align 4, !tbaa !8
  store i32 %3, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !8
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  %4 = load i32, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !8
  %5 = load i32, ptr addrspace(4) %.omp.ub.ascast, align 4, !tbaa !8
  %cmp = icmp sle i32 %4, %5
  br i1 %cmp, label %omp.inner.for.body, label %omp.inner.for.end

omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %6 = load i32, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !8
  %mul = mul nsw i32 %6, 1
  %add = add nsw i32 0, %mul
  store i32 %add, ptr addrspace(4) %i.ascast, align 4, !tbaa !8
  %7 = load i32, ptr addrspace(4) %i.ascast, align 4, !tbaa !8
  %8 = load i32, ptr addrspace(4) %sum.ascast, align 4, !tbaa !8
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %9 = load i32, ptr addrspace(4) %.omp.iv.ascast, align 4, !tbaa !8
...
!0 = !{i32 0, i32 53, i32 -1925386438, !"_Z4main", i32 4, i32 0, i32 0}

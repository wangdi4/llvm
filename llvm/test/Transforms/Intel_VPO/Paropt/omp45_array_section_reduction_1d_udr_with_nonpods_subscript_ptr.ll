...
;
; // Reduction on:         Element of Pointee of Pointer to Array.
; // Reduction type:       UDR on NONPOD (with initializer)
; // Array section layout: 1-D
; // Access in body:       EXPR_SUBSCRIPT
; void cq415166_1d_h_ptr() {
;
;     TYPE (*yptr)[N] = &y;
;
; #pragma omp parallel for reduction(my_reduction_add:yptr[0][5]) num_threads(N)
;     for (int i = 0; i < N; i++) {
;         my_add(yptr[0][5], x[i]);
;     }
; }
...
; ModuleID = 'omp45_array_section_reduction_1d_udr_with_nonpods_subscript_ptr.cpp'
source_filename = "omp45_array_section_reduction_1d_udr_with_nonpods_subscript_ptr.cpp"
...
@_ZL1y_fff1d09a986ee533401c4d46852a2bcd = internal global [100 x %struct.my_struct] zeroinitializer, align 16
@__dso_handle = external hidden global i8
@_ZL1x_fff1d09a986ee533401c4d46852a2bcd = internal global [100 x %struct.my_struct] zeroinitializer, align 16
@.str.3 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str.4 = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@.str.5 = private unnamed_addr constant [42 x i8] c"basic_string::_M_construct null not valid\00", align 1
@.str.6 = private unnamed_addr constant [5 x i8] c"stoi\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_omp45_array_section_reduction_1d_udr_with_nonpods_subscript_ptr.cpp, i8* null }]
...
arrayctor.loop:                                   ; preds = %invoke.cont, %entry
  %arrayctor.cur = phi %struct.my_struct* [ getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0), %entry ], [ %arrayctor.next, %invoke.cont ]
...
invoke.cont:                                      ; preds = %arrayctor.loop
  ...
  %arrayctor.done = icmp eq %struct.my_struct* %arrayctor.next, getelementptr inbounds (%struct.my_struct, %struct.my_struct* getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0), i64 100)
...
lpad:                                             ; preds = %arrayctor.loop
  ...
  %arraydestroy.isempty = icmp eq %struct.my_struct* getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0), %arrayctor.cur
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %lpad
  ...
  %arraydestroy.done = icmp eq %struct.my_struct* %arraydestroy.element, getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0)
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %entry
  %arraydestroy.elementPast = phi %struct.my_struct* [ getelementptr inbounds (%struct.my_struct, %struct.my_struct* getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0), i64 100), %entry ], [ %arraydestroy.element, %arraydestroy.body ]
  %arraydestroy.element = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arraydestroy.elementPast, i64 -1
  call void @_ZN9my_structD2Ev(%struct.my_struct* %arraydestroy.element) #5
  %arraydestroy.done = icmp eq %struct.my_struct* %arraydestroy.element, getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0)
  br i1 %arraydestroy.done, label %arraydestroy.done1, label %arraydestroy.body
...
arrayctor.loop:                                   ; preds = %invoke.cont, %entry
  %arrayctor.cur = phi %struct.my_struct* [ getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0), %entry ], [ %arrayctor.next, %invoke.cont ]
  invoke void @_ZN9my_structC2Ev(%struct.my_struct* %arrayctor.cur)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %arrayctor.loop
  %arrayctor.next = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayctor.cur, i64 1
  %arrayctor.done = icmp eq %struct.my_struct* %arrayctor.next, getelementptr inbounds (%struct.my_struct, %struct.my_struct* getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0), i64 100)
  br i1 %arrayctor.done, label %arrayctor.cont, label %arrayctor.loop
...
lpad:                                             ; preds = %arrayctor.loop
  ...
  %3 = extractvalue { i8*, i32 } %1, 1
  store i32 %3, i32* %ehselector.slot, align 4
  %arraydestroy.isempty = icmp eq %struct.my_struct* getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0), %arrayctor.cur
  br i1 %arraydestroy.isempty, label %arraydestroy.done1, label %arraydestroy.body
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %lpad
  ...
  %arraydestroy.element = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arraydestroy.elementPast, i64 -1
  call void @_ZN9my_structD2Ev(%struct.my_struct* %arraydestroy.element) #5
  %arraydestroy.done = icmp eq %struct.my_struct* %arraydestroy.element, getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0)
  br i1 %arraydestroy.done, label %arraydestroy.done1, label %arraydestroy.body
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %entry
  %arraydestroy.elementPast = phi %struct.my_struct* [ getelementptr inbounds (%struct.my_struct, %struct.my_struct* getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0), i64 100), %entry ], [ %arraydestroy.element, %arraydestroy.body ]
  %arraydestroy.element = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arraydestroy.elementPast, i64 -1
  call void @_ZN9my_structD2Ev(%struct.my_struct* %arraydestroy.element) #5
  %arraydestroy.done = icmp eq %struct.my_struct* %arraydestroy.element, getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i32 0, i32 0)
  br i1 %arraydestroy.done, label %arraydestroy.done1, label %arraydestroy.body
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z17cq415166_1d_h_ptrv() #6 {
entry:
  ...
  store [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, [100 x %struct.my_struct]** %yptr, align 8
  store i32 0, i32* %.omp.lb, align 4
  store i32 99, i32* %.omp.ub, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.REDUCTION.UDR:ARRSECT"([100 x %struct.my_struct]** %yptr, i64 2, i64 0, i64 1, i64 1, i64 5, i64 1, i64 1, i8* null, void (%struct.my_struct*)* @_ZTS9my_struct.omp.destr, void (%struct.my_struct*, %struct.my_struct*)* @.omp_combiner., void (%struct.my_struct*, %struct.my_struct*)* @.omp_initializer.), "QUAL.OMP.NUM_THREADS"(i32 100), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.SHARED"([100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd) ]
...
; CRITICAL: call void @_ZTS9my_struct.omp.destr(%struct.my_struct* %yptr{{[a-zA-Z._0-9]*}})
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %5 = load [100 x %struct.my_struct]*, [100 x %struct.my_struct]** %yptr, align 8
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* %5, i64 0
  %arrayidx1 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* %arrayidx, i64 0, i64 5
  %6 = load i32, i32* %i, align 4
  %idxprom = sext i32 %6 to i64
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom
  call void @_Z6my_addR9my_structRKS_(%struct.my_struct* dereferenceable(40) %arrayidx1, %struct.my_struct* dereferenceable(40) %arrayidx2) #5
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom
  ...
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom1
  ...
  %arrayidx6 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom5
  ...
  %arrayidx8 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom7
  %a9 = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx8, i32 0, i32 0
  store i32 0, i32* %a9, align 8
  %11 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %11 to i64
  %arrayidx11 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom10
  %b12 = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx11, i32 0, i32 1
  store i32 0, i32* %b12, align 4
  %12 = load i32, i32* %i, align 4
  %idxprom13 = sext i32 %12 to i64
  %arrayidx14 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom13
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_h_ptrv()
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_omp45_array_section_reduction_1d_udr_with_nonpods_subscript_ptr.cpp() #4 section ".text.startup" {
entry:

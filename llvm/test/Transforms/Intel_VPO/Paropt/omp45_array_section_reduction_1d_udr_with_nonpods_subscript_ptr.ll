...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_omp45_array_section_reduction_1d_udr_with_nonpods_subscript_ptr.cpp, ptr null }]
...
arrayctor.loop:                                   ; preds = %invoke.cont, %entry
  %arrayctor.cur = phi ptr [ @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, %entry ], [ %arrayctor.next, %invoke.cont ]
...
invoke.cont:                                      ; preds = %arrayctor.loop
  ...
  %arrayctor.done = icmp eq ptr %arrayctor.next, getelementptr inbounds (%struct.my_struct, ptr @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i64 100)
...
lpad:                                             ; preds = %arrayctor.loop
  ...
  %arraydestroy.isempty = icmp eq ptr @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, %arrayctor.cur
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %lpad
  ...
  %arraydestroy.done = icmp eq ptr %arraydestroy.element, @_ZL1y_fff1d09a986ee533401c4d46852a2bcd
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %entry
  %arraydestroy.elementPast = phi ptr [ getelementptr inbounds (%struct.my_struct, ptr @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i64 100), %entry ], [ %arraydestroy.element, %arraydestroy.body ]
  %arraydestroy.element = getelementptr inbounds %struct.my_struct, ptr %arraydestroy.elementPast, i64 -1
  call void @_ZN9my_structD2Ev(ptr %arraydestroy.element) #5
  %arraydestroy.done = icmp eq ptr %arraydestroy.element, @_ZL1y_fff1d09a986ee533401c4d46852a2bcd
  br i1 %arraydestroy.done, label %arraydestroy.done1, label %arraydestroy.body
...
arrayctor.loop:                                   ; preds = %invoke.cont, %entry
  %arrayctor.cur = phi ptr [ @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, %entry ], [ %arrayctor.next, %invoke.cont ]
  invoke void @_ZN9my_structC2Ev(ptr %arrayctor.cur)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %arrayctor.loop
  %arrayctor.next = getelementptr inbounds %struct.my_struct, ptr %arrayctor.cur, i64 1
  %arrayctor.done = icmp eq ptr %arrayctor.next, getelementptr inbounds (%struct.my_struct, ptr @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 100)
  br i1 %arrayctor.done, label %arrayctor.cont, label %arrayctor.loop
...
lpad:                                             ; preds = %arrayctor.loop
  ...
  %3 = extractvalue { ptr, i32 } %1, 1
  store i32 %3, ptr %ehselector.slot, align 4
  %arraydestroy.isempty = icmp eq ptr @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, %arrayctor.cur
  br i1 %arraydestroy.isempty, label %arraydestroy.done1, label %arraydestroy.body
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %lpad
  ...
  %arraydestroy.element = getelementptr inbounds %struct.my_struct, ptr %arraydestroy.elementPast, i64 -1
  call void @_ZN9my_structD2Ev(ptr %arraydestroy.element) #5
  %arraydestroy.done = icmp eq ptr %arraydestroy.element, @_ZL1x_fff1d09a986ee533401c4d46852a2bcd
  br i1 %arraydestroy.done, label %arraydestroy.done1, label %arraydestroy.body
...
arraydestroy.body:                                ; preds = %arraydestroy.body, %entry
  %arraydestroy.elementPast = phi ptr [ getelementptr inbounds (%struct.my_struct, ptr @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 100), %entry ], [ %arraydestroy.element, %arraydestroy.body ]
  %arraydestroy.element = getelementptr inbounds %struct.my_struct, ptr %arraydestroy.elementPast, i64 -1
  call void @_ZN9my_structD2Ev(ptr %arraydestroy.element) #5
  %arraydestroy.done = icmp eq ptr %arraydestroy.element, @_ZL1x_fff1d09a986ee533401c4d46852a2bcd
  br i1 %arraydestroy.done, label %arraydestroy.done1, label %arraydestroy.body
...
entry:
  ...
  store ptr @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, ptr %yptr, align 8
  store i32 0, ptr %.omp.lb, align 4
  store i32 99, ptr %.omp.ub, align 4
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR:ARRSECT.PTR_TO_PTR.TYPED"(ptr %yptr, %struct.my_struct zeroinitializer, i64 1, i64 5, ptr null, ptr @_ZTS9my_struct.omp.destr, ptr @.omp_combiner., ptr @.omp_initializer.),
    "QUAL.OMP.NUM_THREADS"(i32 100),
    "QUAL.OMP.SHARED:TYPED"(ptr @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, %struct.my_struct zeroinitializer, i64 100),
...
; CRITICAL: call void @_ZTS9my_struct.omp.destr(ptr %yptr{{[a-zA-Z._0-9]*}})
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], ptr %5, i64 0
  %arrayidx1 = getelementptr inbounds [100 x %struct.my_struct], ptr %arrayidx, i64 0, i64 5
  %6 = load i32, ptr %i, align 4
  %idxprom = sext i32 %6 to i64
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom
  call void @_Z6my_addR9my_structRKS_(ptr dereferenceable(40) %arrayidx1, ptr dereferenceable(40) %arrayidx2) #5
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom
  ...
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom1
  ...
  %arrayidx6 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1x_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom5
  ...
  %arrayidx8 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom7
  %a9 = getelementptr inbounds %struct.my_struct, ptr %arrayidx8, i32 0, i32 0
  store i32 0, ptr %a9, align 8
  %11 = load i32, ptr %i, align 4
  %idxprom10 = sext i32 %11 to i64
  %arrayidx11 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom10
  %b12 = getelementptr inbounds %struct.my_struct, ptr %arrayidx11, i32 0, i32 1
  store i32 0, ptr %b12, align 4
  %12 = load i32, ptr %i, align 4
  %idxprom13 = sext i32 %12 to i64
  %arrayidx14 = getelementptr inbounds [100 x %struct.my_struct], ptr @_ZL1y_fff1d09a986ee533401c4d46852a2bcd, i64 0, i64 %idxprom13

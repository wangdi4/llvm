...
; is constant integer with zero value.
;
; #include <stdio.h>
; #include <omp.h>
; void foo ( )
...
; ModuleID = 'task_final_constint_zero.c'
source_filename = "task_final_constint_zero.c"
...
entry:
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.TASK"(), "QUAL.OMP.FINAL"(i32 0) ]

...
alloca_0:
  ...
  %"foo_$B.addr_a0$_fetch" = load i32*, i32** %"foo_$B.addr_a0$", align 1
  %"foo_$B.addr_length$" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", %"QNCA_a0$i32*$rank1$"* %"foo_$B", i64 0, i32 1
...
; CHECK: [[GEP:%[^ ]+]] = getelementptr inbounds [4 x i8*], [4 x i8*]* %.offload_baseptrs, i32 0, i32 3

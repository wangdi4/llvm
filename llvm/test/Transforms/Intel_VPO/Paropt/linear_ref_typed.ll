...
define dso_local void @_Z3fooRi(ptr noundef nonnull align 4 dereferenceable(4) %y) #0 {
entry:
  ...
  store i32 9, ptr %.omp.ub, align 4, !tbaa !8
  %0 = load ptr, ptr %y.addr, align 8, !tbaa !4
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.LOOP"(),
    "QUAL.OMP.LINEAR:BYREF.TYPED"(ptr %y.addr, i32 0, i32 1, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr %.omp.iv, i32 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr %.omp.lb, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr %.omp.ub, i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr %i, i32 0, i32 1) ]
  %2 = load i32, ptr %.omp.lb, align 4, !tbaa !8
  store i32 %2, ptr %.omp.iv, align 4, !tbaa !8
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  %3 = load i32, ptr %.omp.iv, align 4, !tbaa !8
  %4 = load i32, ptr %.omp.ub, align 4, !tbaa !8
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  ...
  store i32 %add1, ptr %.omp.iv, align 4, !tbaa !8
  br label %omp.inner.for.cond

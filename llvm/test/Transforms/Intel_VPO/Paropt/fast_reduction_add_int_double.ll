...
; USE-REC: %[[I32_REC:[^,]+]] = getelementptr inbounds %struct.fast_red_t, ptr %fast_red_struct, i32 0, i32 0
...
; ALL: %[[RET:[^,]+]] = call i32 @__kmpc_reduce(ptr @{{.*}}, i32 %{{.*}}, i32 2, i32 12, ptr %fast_red_struct, ptr @main_tree_reduce_{{.*}}, ptr @{{.*}})

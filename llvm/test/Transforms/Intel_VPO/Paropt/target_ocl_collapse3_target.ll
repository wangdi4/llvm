...
entry:
  ...
  %.capture_expr..ascast = addrspacecast ptr %.capture_expr. to ptr addrspace(4)
  ...
  %.omp.uncollapsed.lb23.ascast = addrspacecast ptr %.omp.uncollapsed.lb23 to ptr addrspace(4)
  %.omp.uncollapsed.ub24 = alloca i64, align 8
  %.omp.uncollapsed.ub24.ascast = addrspacecast ptr %.omp.uncollapsed.ub24 to ptr addrspace(4)
  %.omp.uncollapsed.lb31 = alloca i64, align 8
  %.omp.uncollapsed.lb31.ascast = addrspacecast ptr %.omp.uncollapsed.lb31 to ptr addrspace(4)
  %.omp.uncollapsed.ub32 = alloca i64, align 8
  %.omp.uncollapsed.ub32.ascast = addrspacecast ptr %.omp.uncollapsed.ub32 to ptr addrspace(4)
  %tmp = alloca i32, align 4
  %tmp.ascast = addrspacecast ptr %tmp to ptr addrspace(4)
  %tmp39 = alloca i32, align 4
  %tmp39.ascast = addrspacecast ptr %tmp39 to ptr addrspace(4)
  %tmp40 = alloca i32, align 4
  %tmp40.ascast = addrspacecast ptr %tmp40 to ptr addrspace(4)
  ...
  %.omp.uncollapsed.iv50.ascast = addrspacecast ptr %.omp.uncollapsed.iv50 to ptr addrspace(4)
  %.omp.uncollapsed.iv51 = alloca i64, align 8
  %.omp.uncollapsed.iv51.ascast = addrspacecast ptr %.omp.uncollapsed.iv51 to ptr addrspace(4)
  ...
  store i32 %0, ptr addrspace(4) %.capture_expr..ascast, align 4
  ...
  %3 = load i32, ptr addrspace(4) %.capture_expr..ascast, align 4
  %sub = sub nsw i32 %3, 0
  ...
  store i64 %sub16, ptr addrspace(4) %.capture_expr.3.ascast, align 8
  store i64 0, ptr addrspace(4) %.omp.uncollapsed.lb.ascast, align 8
  %6 = load i32, ptr addrspace(4) %.capture_expr..ascast, align 4
  ...
  store i64 %sub22, ptr addrspace(4) %.omp.uncollapsed.ub.ascast, align 8
  store i64 0, ptr addrspace(4) %.omp.uncollapsed.lb23.ascast, align 8
  ...
  store i64 %sub30, ptr addrspace(4) %.omp.uncollapsed.ub24.ascast, align 8
  store i64 0, ptr addrspace(4) %.omp.uncollapsed.lb31.ascast, align 8
  ...
  store i64 %sub38, ptr addrspace(4) %.omp.uncollapsed.ub32.ascast, align 8
  %9 = call token @llvm.directive.region.entry() [ "DIR.OMP.TARGET"(),
    "QUAL.OMP.OFFLOAD.ENTRY.IDX"(i32 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.capture_expr..ascast, i32 0, i32 1),
    ...
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.iv50.ascast, i64 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.iv51.ascast, i64 0, i32 1),
    ...
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.lb23.ascast, i64 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.ub24.ascast, i64 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.lb31.ascast, i64 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.ub32.ascast, i64 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp39.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %tmp40.ascast, i32 0, i32 1) ]

  %10 = load i32, ptr addrspace(4) %.capture_expr..ascast, align 4
...
omp.precond.then:                                 ; preds = %land.lhs.true46
  %13 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    ...
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.lb.ascast, i64 0, i32 1),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr addrspace(4) %.omp.uncollapsed.iv.ascast, i64 0, ptr addrspace(4) %.omp.uncollapsed.iv50.ascast, i64 0, ptr addrspace(4) %.omp.uncollapsed.iv51.ascast, i64 0),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr addrspace(4) %.omp.uncollapsed.ub.ascast, i64 0, ptr addrspace(4) %.omp.uncollapsed.ub24.ascast, i64 0, ptr addrspace(4) %.omp.uncollapsed.ub32.ascast, i64 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.lb23.ascast, i64 0, i32 1),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr addrspace(4) %.omp.uncollapsed.lb31.ascast, i64 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %i.ascast, i32 0, i32 1),
    "QUAL.OMP.PRIVATE:TYPED"(ptr addrspace(4) %j.ascast, i32 0, i32 1),
...
omp.uncollapsed.loop.body:                        ; preds = %omp.uncollapsed.loop.cond
  %17 = load i64, ptr addrspace(4) %.omp.uncollapsed.lb23.ascast, align 8
  store i64 %17, ptr addrspace(4) %.omp.uncollapsed.iv50.ascast, align 8
...
omp.uncollapsed.loop.cond54:                      ; preds = %omp.uncollapsed.loop.inc72, %omp.uncollapsed.loop.body
  %18 = load i64, ptr addrspace(4) %.omp.uncollapsed.iv50.ascast, align 8
  %19 = load i64, ptr addrspace(4) %.omp.uncollapsed.ub24.ascast, align 8
...
omp.uncollapsed.loop.body57:                      ; preds = %omp.uncollapsed.loop.cond54
  %20 = load i64, ptr addrspace(4) %.omp.uncollapsed.lb31.ascast, align 8
  store i64 %20, ptr addrspace(4) %.omp.uncollapsed.iv51.ascast, align 8
...
omp.uncollapsed.loop.cond58:                      ; preds = %omp.uncollapsed.loop.inc, %omp.uncollapsed.loop.body57
  %21 = load i64, ptr addrspace(4) %.omp.uncollapsed.iv51.ascast, align 8
  %22 = load i64, ptr addrspace(4) %.omp.uncollapsed.ub32.ascast, align 8
...
omp.uncollapsed.loop.body61:                      ; preds = %omp.uncollapsed.loop.cond58
  ...
  store i32 %conv64, ptr addrspace(4) %i.ascast, align 4
  %24 = load i64, ptr addrspace(4) %.omp.uncollapsed.iv50.ascast, align 8
  %mul65 = mul nsw i64 %24, 1
  %add66 = add nsw i64 0, %mul65
  %conv67 = trunc i64 %add66 to i32
  store i32 %conv67, ptr addrspace(4) %j.ascast, align 4
  %25 = load i64, ptr addrspace(4) %.omp.uncollapsed.iv51.ascast, align 8
  %mul68 = mul nsw i64 %25, 1
  %add69 = add nsw i64 0, %mul68
  %conv70 = trunc i64 %add69 to i32
  store i32 %conv70, ptr addrspace(4) %k.ascast, align 4
  br label %omp.uncollapsed.loop.inc

omp.uncollapsed.loop.inc:                         ; preds = %omp.uncollapsed.loop.body61
  %26 = load i64, ptr addrspace(4) %.omp.uncollapsed.iv51.ascast, align 8
  %add71 = add nsw i64 %26, 1
  store i64 %add71, ptr addrspace(4) %.omp.uncollapsed.iv51.ascast, align 8
  br label %omp.uncollapsed.loop.cond58
...
omp.uncollapsed.loop.inc72:                       ; preds = %omp.uncollapsed.loop.end
  %27 = load i64, ptr addrspace(4) %.omp.uncollapsed.iv50.ascast, align 8
  %add73 = add nsw i64 %27, 1
  store i64 %add73, ptr addrspace(4) %.omp.uncollapsed.iv50.ascast, align 8
  br label %omp.uncollapsed.loop.cond54
...
omp.uncollapsed.loop.inc75:                       ; preds = %omp.uncollapsed.loop.end74
  ...
  store i64 %add76, ptr addrspace(4) %.omp.uncollapsed.iv.ascast, align 8
  br label %omp.uncollapsed.loop.cond

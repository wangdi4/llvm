; RUN: opt -opaque-pointers=0 -enable-new-pm=0 -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -sroa -ipsccp -vpo-cfg-restructuring -vpo-paropt -S %s | FileCheck %s

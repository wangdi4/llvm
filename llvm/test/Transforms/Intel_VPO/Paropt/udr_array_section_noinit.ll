...
; ModuleID = 'udr_array_section_noinit.cpp'
source_filename = "udr_array_section_noinit.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.my_struct = type { i32, i32 }

@_ZL1x_a54d6b49c5082eec49f5007b6152a284 = internal global [100 x %struct.my_struct] zeroinitializer, align 16
@_ZL1y_a54d6b49c5082eec49f5007b6152a284 = internal global [100 x %struct.my_struct] zeroinitializer, align 16
...
entry:
  ...
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.REDUCTION.UDR:ARRSECT"(%struct.my_struct** %ypas.addr, i64 1, i64 5, i64 4, i64 1, i8* null, void ([4 x %struct.my_struct]*)* @_ZTSA4_9my_struct.omp.destr, void (%struct.my_struct*, %struct.my_struct*)* @.omp_combiner., i8* null), "QUAL.OMP.NUM_THREADS"(i32 100), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %i), "QUAL.OMP.PRIVATE"(i32* %j), "QUAL.OMP.SHARED"([100 x %struct.my_struct]* @_ZL1x_a54d6b49c5082eec49f5007b6152a284) ]
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_a54d6b49c5082eec49f5007b6152a284, i64 0, i64 %idxprom2
...
; Function Attrs: noinline uwtable
define internal [4 x %struct.my_struct]* @_ZTSA4_9my_struct.omp.def_constr([4 x %struct.my_struct]* %0) #3 section ".text.startup" {
entry:
  %retval = alloca [4 x %struct.my_struct]*, align 8
  %.addr = alloca [4 x %struct.my_struct]*, align 8
  store [4 x %struct.my_struct]* %0, [4 x %struct.my_struct]** %.addr, align 8
  %1 = load [4 x %struct.my_struct]*, [4 x %struct.my_struct]** %retval, align 8
  ret [4 x %struct.my_struct]* %1
}
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_a54d6b49c5082eec49f5007b6152a284, i64 0, i64 %idxprom
  ...
  %arrayidx2 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1x_a54d6b49c5082eec49f5007b6152a284, i64 0, i64 %idxprom1
  %b = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx2, i32 0, i32 1
  store i32 %mul, i32* %b, align 4
  %6 = load i32, i32* %i, align 4
  %idxprom3 = sext i32 %6 to i64
  %arrayidx4 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_a54d6b49c5082eec49f5007b6152a284, i64 0, i64 %idxprom3
  %a5 = getelementptr inbounds %struct.my_struct, %struct.my_struct* %arrayidx4, i32 0, i32 0
  store i32 0, i32* %a5, align 8
  %7 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds [100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_a54d6b49c5082eec49f5007b6152a284, i64 0, i64 %idxprom6
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_f_pasP9my_struct(%struct.my_struct* getelementptr inbounds ([100 x %struct.my_struct], [100 x %struct.my_struct]* @_ZL1y_a54d6b49c5082eec49f5007b6152a284, i64 0, i64 0))
  ret i32 0
}

...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %aaa, metadata !10, metadata !DIExpression()), !dbg !29
  call void @_ZN2NPC2Ev(ptr %aaa), !dbg !29
  call void @llvm.dbg.declare(metadata ptr %.omp.iv, metadata !30, metadata !DIExpression()), !dbg !32
  call void @llvm.dbg.declare(metadata ptr %.omp.lb, metadata !33, metadata !DIExpression()), !dbg !32
  store i32 0, ptr %.omp.lb, align 4, !dbg !34
  call void @llvm.dbg.declare(metadata ptr %.omp.ub, metadata !35, metadata !DIExpression()), !dbg !32
  store i32 999, ptr %.omp.ub, align 4, !dbg !34
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.FIRSTPRIVATE:NONPOD.TYPED"(ptr %aaa, %struct.NP zeroinitializer, i32 1, ptr @_ZTS2NP.omp.copy_constr, ptr @_ZTS2NP.omp.destr),
    "QUAL.OMP.LASTPRIVATE:NONPOD.TYPED"(ptr %aaa, %struct.NP zeroinitializer, i32 1, ptr null, ptr @_ZTS2NP.omp.copy_assign, ptr @_ZTS2NP.omp.destr),
    "QUAL.OMP.NORMALIZED.IV:TYPED"(ptr %.omp.iv, i32 0),
    "QUAL.OMP.FIRSTPRIVATE:TYPED"(ptr %.omp.lb, i32 0, i32 1),
    "QUAL.OMP.NORMALIZED.UB:TYPED"(ptr %.omp.ub, i32 0),
    "QUAL.OMP.PRIVATE:TYPED"(ptr %i, i32 0, i32 1) ], !dbg !36
  %1 = load i32, ptr %.omp.lb, align 4, !dbg !34
  store i32 %1, ptr %.omp.iv, align 4, !dbg !34
  br label %omp.inner.for.cond, !dbg !36

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %entry
  %2 = load i32, ptr %.omp.iv, align 4, !dbg !34
  %3 = load i32, ptr %.omp.ub, align 4, !dbg !34
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %4 = load i32, ptr %.omp.iv, align 4, !dbg !34
  %mul = mul nsw i32 %4, 1, !dbg !40
  %add = add nsw i32 0, %mul, !dbg !40
  store i32 %add, ptr %i, align 4, !dbg !40
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %5 = load i32, ptr %.omp.iv, align 4, !dbg !34
  %add1 = add nsw i32 %5, 1, !dbg !37
  store i32 %add1, ptr %.omp.iv, align 4, !dbg !37
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  call void @_ZN2NPD1Ev(ptr %aaa) #3, !dbg !46
  ret void, !dbg !46
}
...
define linkonce_odr dso_local void @_ZN2NPC2Ev(ptr %this) unnamed_addr #2 comdat align 2 !dbg !47 {
entry:
  %this.addr = alloca ptr, align 8
  store ptr %this, ptr %this.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %this.addr, metadata !48, metadata !DIExpression()), !dbg !50
  %this1 = load ptr, ptr %this.addr, align 8
  %data = getelementptr inbounds %struct.NP, ptr %this1, i32 0, i32 0, !dbg !51
  store i32 0, ptr %data, align 4, !dbg !53
  ret void, !dbg !54
}
...
define internal void @_ZTS2NP.omp.copy_constr(ptr %0, ptr %1) #4 !dbg !55 {
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %.addr1, metadata !60, metadata !DIExpression()), !dbg !59
  %2 = load ptr, ptr %.addr, align 8, !dbg !61
  %3 = load ptr, ptr %.addr1, align 8, !dbg !59
  call void @_ZN2NPC1ERKS_(ptr %2, ptr nonnull align 4 dereferenceable(4) %3), !dbg !61
  ret void, !dbg !61
}

declare dso_local void @_ZN2NPC1ERKS_(ptr, ptr nonnull align 4 dereferenceable(4)) unnamed_addr #5

; Function Attrs: noinline uwtable
define internal void @_ZTS2NP.omp.destr(ptr %0) #4 section ".text.startup" !dbg !62 {
entry:
  %.addr = alloca ptr, align 8
  store ptr %0, ptr %.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %.addr, metadata !64, metadata !DIExpression()), !dbg !65
  %1 = load ptr, ptr %.addr, align 8
  call void @_ZN2NPD1Ev(ptr %1) #3
  ret void
}

; Function Attrs: nounwind
declare dso_local void @_ZN2NPD1Ev(ptr) unnamed_addr #6

; Function Attrs: noinline uwtable
define internal void @_ZTS2NP.omp.copy_assign(ptr %0, ptr %1) #4 !dbg !66 {
entry:
  %.addr = alloca ptr, align 8
  %.addr1 = alloca ptr, align 8
  store ptr %0, ptr %.addr, align 8
  call void @llvm.dbg.declare(metadata ptr %.addr, metadata !67, metadata !DIExpression()), !dbg !68
  store ptr %1, ptr %.addr1, align 8
  call void @llvm.dbg.declare(metadata ptr %.addr1, metadata !69, metadata !DIExpression()), !dbg !68
  %2 = load ptr, ptr %.addr, align 8, !dbg !70
  %3 = load ptr, ptr %.addr1, align 8, !dbg !70
  %call = call nonnull align 4 dereferenceable(4) ptr @_ZN2NPaSERKS_(ptr %2, ptr nonnull align 4 dereferenceable(4) %3), !dbg !70
  ret void, !dbg !70
}

declare dso_local nonnull align 4 dereferenceable(4) ptr @_ZN2NPaSERKS_(ptr, ptr nonnull align 4 dereferenceable(4)) #5

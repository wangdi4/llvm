; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt -S %s | FileCheck %s -check-prefix=TFORM -check-prefix=ALL
...
; RUN: opt -opaque-pointers=1 -enable-new-pm=0 -vpo-cfg-restructuring -vpo-paropt-prepare -S %s | FileCheck %s -check-prefix=ALL
...
; TFORM-NEXT: %[[L1:[0-9]+]] = getelementptr inbounds [[DIM_STRTY]], ptr %[[INITVEC]], i32 0
; TFORM-NEXT: %[[L1LB:[0-9]+]] = getelementptr inbounds [[DIM_STRTY]], ptr %[[L1]], i32 0, i32 0
; TFORM-NEXT: store i64 0, ptr %[[L1LB]]
; TFORM-NEXT: %[[L1UB:[0-9]+]] = getelementptr inbounds [[DIM_STRTY]], ptr %[[L1]], i32 0, i32 1
; TFORM-NEXT: store i64 4, ptr %[[L1UB]]
; TFORM-NEXT: %[[L1ST:[0-9]+]] = getelementptr inbounds [[DIM_STRTY]], ptr %[[L1]], i32 0, i32 2
; TFORM-NEXT: store i64 1, ptr %[[L1ST]]

; TFORM-NEXT: %[[L2:[0-9]+]] = getelementptr inbounds [[DIM_STRTY]], ptr %[[INITVEC]], i32 1
; TFORM-NEXT: %[[L2LB:[0-9]+]] = getelementptr inbounds [[DIM_STRTY]], ptr %[[L2]], i32 0, i32 0
; TFORM-NEXT: store i64 0, ptr %[[L2LB]]
; TFORM-NEXT: %[[L2UB:[0-9]+]] = getelementptr inbounds [[DIM_STRTY]], ptr %[[L2]], i32 0, i32 1
; TFORM-NEXT: store i64 2, ptr %[[L2UB]]
; TFORM-NEXT: %[[L2ST:[0-9]+]] = getelementptr inbounds [[DIM_STRTY]], ptr %[[L2]], i32 0, i32 2
; TFORM-NEXT: store i64 1, ptr %[[L2ST]]

; TFORM-NEXT: call void @__kmpc_doacross_init({{[^,]+}}, i32 %[[TID:[a-zA-Z._0-9]*]], i32 2, ptr %[[INITVEC]])
...
; ALL: %[[S1GEP1:[a-zA-Z._0-9]+]] = getelementptr inbounds i64, ptr %[[SINK1VEC]], i64 0
; ALL: store i64 %[[S1E1]], ptr %[[S1GEP1]]

; ALL: %[[S1E2:[a-zA-Z._0-9]+]] = sext i32 %div5 to i64
; ALL: %[[S1GEP2:[a-zA-Z._0-9]+]] = getelementptr inbounds i64, ptr %[[SINK1VEC]], i64 1
; ALL: store i64 %[[S1E2]], ptr %[[S1GEP2]]

; ALL: call void @__kmpc_doacross_wait({{[^,]+}}, i32 %{{[a-zA-Z._0-9]+}}, ptr %[[SINK1VEC]])

; ALL: %[[SINK2VEC:[a-zA-Z._0-9]+]] = alloca i64, i32 2
; ALL: %[[S2E1:[a-zA-Z._0-9]+]] = sext i32 %div7 to i64
; ALL: %[[S2GEP1:[a-zA-Z._0-9]+]] = getelementptr inbounds i64, ptr %[[SINK2VEC]], i64 0
; ALL: store i64 %[[S2E1]], ptr %[[S2GEP1]]

; ALL: %[[S2E2:[a-zA-Z._0-9]+]] = sext i32 %div10 to i64
; ALL: %[[S2GEP2:[a-zA-Z._0-9]+]] = getelementptr inbounds i64, ptr %[[SINK2VEC]], i64 1
; ALL: store i64 %[[S2E2]], ptr %[[S2GEP2]]

; ALL: call void @__kmpc_doacross_wait({{[^,]+}}, i32 %{{[a-zA-Z._0-9]+}}, ptr %[[SINK2VEC]])
...
; ALL: %[[SRCGEP1:[a-zA-Z._0-9]+]] = getelementptr inbounds i64, ptr %[[SOURCEVEC]], i64 0
; ALL: store i64 %[[SRCE1]], ptr %[[SRCGEP1]]

; ALL: %[[SRCE2:[a-zA-Z._0-9]+]] = sext i32 %div28 to i64
; ALL: %[[SRCGEP2:[a-zA-Z._0-9]+]] = getelementptr inbounds i64, ptr %[[SOURCEVEC]], i64 1
; ALL: store i64 %[[SRCE2]], ptr %[[SRCGEP2]]

; ALL: call void @__kmpc_doacross_post({{[^,]+}}, i32 %{{[a-zA-Z._0-9]+}}, ptr %[[SOURCEVEC]])

...
; CHECK: Enter VPOParoptTransform::genFirstPrivatizationCode
; CHECK: getItemInfo: Local Element Info for 'i32* %vla' (Typed):: Type: i32, NumElements: i32 %n
; CHECK: Exit VPOParoptTransform::genFirstPrivatizationCode
...
entry:
  ...
  %6 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(), "QUAL.OMP.FIRSTPRIVATE:TYPED"(i32* %vla, i32 0, i32 %n), "QUAL.OMP.NORMALIZED.IV"(i32* %.omp.iv), "QUAL.OMP.FIRSTPRIVATE"(i32* %.omp.lb), "QUAL.OMP.NORMALIZED.UB"(i32* %.omp.ub), "QUAL.OMP.PRIVATE"(i32* %d), "QUAL.OMP.SHARED"(i64* %omp.vla.tmp) ]

...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z17cq415166_1d_e_refRA100_s(ptr dereferenceable(200) %yref) #1 {
entry:
  ...
  %1 = call token @llvm.directive.region.entry() [ "DIR.OMP.PARALLEL.LOOP"(),
    "QUAL.OMP.REDUCTION.UDR:BYREF.ARRSECT.TYPED"(ptr %yref.addr, i16 0, i64 25, i64 25, ptr null, ptr null, ptr @.omp_combiner., ptr null),
    "QUAL.OMP.SHARED:TYPED"(ptr @_ZL1x_9555819b599718990694fc37fe498a3b, i16 0, i64 100),
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %arrayidx3 = getelementptr inbounds [100 x i16], ptr @_ZL1x_9555819b599718990694fc37fe498a3b, i64 0, i64 %idxprom2
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i16], ptr @_ZL1x_9555819b599718990694fc37fe498a3b, i64 0, i64 %idxprom
  store i16 1, ptr %arrayidx, align 2
  %2 = load i32, ptr %i, align 4
  %conv = trunc i32 %2 to i16
  %3 = load i32, ptr %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [100 x i16], ptr @_ZL1y_9555819b599718990694fc37fe498a3b, i64 0, i64 %idxprom1
...
for.end:                                          ; preds = %for.cond
  call void @_Z17cq415166_1d_e_refRA100_s(ptr dereferenceable(200) @_ZL1y_9555819b599718990694fc37fe498a3b)
  ret i32 0
}

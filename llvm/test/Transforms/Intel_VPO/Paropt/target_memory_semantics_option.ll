; RUN: opt -enable-new-pm=0 -switch-to-offload -vpo-cfg-restructuring -vpo-paropt-loop-collapse -vpo-cfg-restructuring -vpo-paropt-prepare -vpo-restore-operands -vpo-cfg-restructuring -vpo-paropt-optimize-data-sharing -vpo-paropt -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-GLOBAL-LOCAL
; RUN: opt -switch-to-offload -passes="function(vpo-cfg-restructuring,vpo-paropt-loop-collapse,vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring,vpo-paropt-optimize-data-sharing),vpo-paropt" -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-GLOBAL-LOCAL
...
; RUN: opt -switch-to-offload -passes="function(vpo-cfg-restructuring,vpo-paropt-loop-collapse,vpo-cfg-restructuring,vpo-paropt-prepare,vpo-restore-operands,vpo-cfg-restructuring,vpo-paropt-optimize-data-sharing),vpo-paropt" -vpo-paropt-exclude-global-fence-from-workgroup-barriers -S %s | FileCheck %s --check-prefixes=CHECK,CHECK-LOCAL-ONLY

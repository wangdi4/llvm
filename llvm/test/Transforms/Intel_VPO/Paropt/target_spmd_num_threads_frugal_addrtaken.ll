...
; DEFAULT:  collectOmpNumThreadsCallerInfo: Function @f2 is address-taken by: 'i64 ptrtoint (ptr @f2 to i64)'.
...
entry:
  ...
  %call = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.1 to ptr addrspace(4)), i32 %6) #5
  ...
  %call4 = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.1 to ptr addrspace(4)), i32 %call3) #5
  ...
  %call6 = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.1 to ptr addrspace(4)), i32 %call5) #5
  ...
  %call8 = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str.2 to ptr addrspace(4)), i64 %call7) #5
...
entry:
  ...
  %retval.ascast = addrspacecast ptr %retval to ptr addrspace(4)
  %call = call spir_func i32 (ptr addrspace(4), ...) @printf(ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str to ptr addrspace(4)), ptr @f2) #6
  ret i64 ptrtoint (ptr @f2 to i64)
}
...
!5 = !{i32 1, !"_Z3val", i32 0, i32 0, ptr addrspace(1) @val}

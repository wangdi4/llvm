...
; This is a version of target_fp_map_vla_host.ll, but the TYPED firstprivate
...
; CHECK:   [[SIZE_ADDR1:%n.val.addr.*]] = alloca i64, align 8
...
; CHECK:   store i64 %n.val, ptr [[SIZE_ADDR1]], align 8

...
; This test is added by da41932 [NFC][IndVarSimplify] Test: replacing IV user with unsafe loop-invariant (PR45360).
; The author admits that it's fragile and it fails in xmain.
; UNSUPPORTED: linux
; REQUIRES: linux

...
; CHECK-IR-MD: define float @bas(ptr %0, float %1, i64 %2, i64 %3) !intel.function.inlining.report !24 {
; CHECK-IR-MD:   %5 = call float @foo(ptr %0, i64 %2, i64 %3), !intel.callsite.inlining.report !29

; CHECK-IR-MD: !intel.module.inlining.report = !{!0, !8, !24, !36}
...
; CHECK-IR-MD: !8 = distinct !{!"intel.function.inlining.report", !9, !10, !2, !23, !4, !5, !6, !7}
; CHECK-IR-MD: !9 = !{!"name: bar"}
; CHECK-IR-MD: !10 = distinct !{!"intel.callsites.inlining.report", !11}
; CHECK-IR-MD: !11 = distinct !{!"intel.callsite.inlining.report", !1, null, !12, !13, !14, !15, !16, !17, !18, !"line: 0 col: 0", !2, !7, !19, !20, !21, !22}
; CHECK-IR-MD: !12 = !{!"isInlined: 0"}
; CHECK-IR-MD: !13 = !{!"reason: 44"}
...
; CHECK-IR-MD: !19 = !{!"isCostBenefit: 0"}
; CHECK-IR-MD: !20 = !{!"CBPairCost: -1"}
; CHECK-IR-MD: !21 = !{!"CBPairBenefit: -1"}
; CHECK-IR-MD: !22 = !{!"icsMethod: 0"}
; CHECK-IR-MD: !23 = !{!"isDead: 1"}
; CHECK-IR-MD: !24 = distinct !{!"intel.function.inlining.report", !25, !26, !2, !3, !4, !35, !6, !7}
; CHECK-IR-MD: !25 = !{!"name: bas"}
; CHECK-IR-MD: !26 = distinct !{!"intel.callsites.inlining.report", !27}
; CHECK-IR-MD: !27 = distinct !{!"intel.callsite.inlining.report", !9, !28, !31, !32, !33, !15, !34, !17, !18, !"line: 0 col: 0", !2, !7, !19, !20, !21, !22}
; CHECK-IR-MD: !28 = distinct !{!"intel.callsites.inlining.report", !29}
; CHECK-IR-MD: !29 = distinct !{!"intel.callsite.inlining.report", !1, null, !12, !30, !14, !15, !16, !17, !18, !"line: 0 col: 0", !2, !7, !19, !20, !21, !22}
; CHECK-IR-MD: !30 = !{!"reason: 63"}
; CHECK-IR-MD: !31 = !{!"isInlined: 1"}
; CHECK-IR-MD: !32 = !{!"reason: 10"}
; CHECK-IR-MD: !33 = !{!"inlineCost: -15000"}
; CHECK-IR-MD: !34 = !{!"inlineThreshold: 337"}
; CHECK-IR-MD: !35 = !{!"linkage: A"}
; CHECK-IR-MD: !36 = distinct !{!"intel.function.inlining.report", !37, null, !2, !3, !38, !35, !6, !7}
; CHECK-IR-MD: !37 = !{!"name: llvm.intel.subscript.p0.i64.i64.p0.i64"}
; CHECK-IR-MD: !38 = !{!"isDeclaration: 1"}

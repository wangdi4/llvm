...
; be performed since function @foo has varargs. This is the same test case
; as intel-ipo-dead-arg-07.ll but for opaque pointers.
...
; ModuleID = 'intel-ipo-dead-arg-07.ll'
source_filename = "intel-ipo-dead-arg-07.ll"

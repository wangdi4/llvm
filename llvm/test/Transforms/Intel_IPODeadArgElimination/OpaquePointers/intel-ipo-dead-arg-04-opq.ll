...
; RUN: opt -opaque-pointers -passes='inlinereportsetup,cgscc(inline),inlinereportemitter',intel-ipo-dead-arg-elimination -inline-report=0xe886 -S < %s 2>&1 | FileCheck %s -check-prefix=CHECK-IR-MD

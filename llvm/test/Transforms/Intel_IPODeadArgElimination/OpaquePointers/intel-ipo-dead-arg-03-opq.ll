...
; to @bar, which isn't a candidate for the transformation. This is the same
; test case as intel-ipo-dead-arg-03.ll but is checks for opaque pointers.
...
; CHECK:   Candidates after analysis: 0

; CHECK:     Total functions modified: 0

; ModuleID = 'intel-ipo-dead-arg-03.ll'
source_filename = "intel-ipo-dead-arg-03.ll"

...
; be performed since function @foo is not internal. This is the same test case
; as intel-ipo-dead-arg-06.ll but it checks for opaque pointers.
...
; ModuleID = 'intel-ipo-dead-arg-06.ll'
source_filename = "intel-ipo-dead-arg-06.ll"

...
; test case as intel-ipo-dead-arg-06-IR.ll but it checks the IR with opaque
; pointers.

; CHECK: define float @foo(ptr %0, ptr %1, i64 %2, i64 %3)
...
; ModuleID = 'intel-ipo-dead-arg-06-IR.ll'
source_filename = "intel-ipo-dead-arg-06-IR.ll"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

define float @foo(ptr %0, ptr %1, i64 %2, i64 %3) {

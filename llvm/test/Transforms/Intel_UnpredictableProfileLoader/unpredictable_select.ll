...
!0 = distinct !DICompileUnit(language: DW_LANG_C11, file: !1, producer: "clang based Intel(R) oneAPI DPC++/C++ Compiler 2023.2.0 (2023.x.0.YYYYMMDD)", isOptimized: true, flags: " --intel -D PREDICTABLE 3.c -o 3.br.ll -S -emit-llvm -O2 -g -fveclib=SVML -fheinous-gnu-extensions", runtimeVersion: 0, emissionKind: FullDebug, globals: !2, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "3.c", directory: "/localdisk2/tmcreech/as1/llvm/llvm/test/Transforms/Intel_UnpredictableProfileLoader")
!2 = !{}

...
; RUN: opt -aa-pipeline=basic-aa -passes=loop-distribute -enable-loop-distribute -S < %s | \
; RUN:     FileCheck %s --check-prefix=DEFAULT

; RUN: opt -aa-pipeline=basic-aa -passes=loop-distribute -enable-loop-distribute -S -enable-mem-access-versioning=0 < %s | \

...
; RUN: opt -force-opaque-pointers < %s -ip-cloning -ip-cloning-after-inl -ip-cloning-loop-heuristic -S 2>&1 | FileCheck %s
; RUN: opt -force-opaque-pointers < %s -passes='module(post-inline-ip-cloning)' -ip-cloning-loop-heuristic -S 2>&1 | FileCheck %s
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %cmp = icmp slt i64 %indvars.iv, %i1

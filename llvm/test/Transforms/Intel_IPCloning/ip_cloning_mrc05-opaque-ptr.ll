...
; RUN: opt -force-opaque-pointers < %s -S -ip-manyreccalls-cloning-min-rec-callsites=2 -ip-cloning -debug-only=ipcloning -ip-manyreccalls-splitting=false 2>&1 | FileCheck %s

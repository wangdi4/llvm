...
; CHECK-NEXT: position: 4 Value {{.*}} bitcast
; CHECK-NEXT: Set_2
; CHECK-NEXT: position: 2 Value i16 2
...
declare void @th_exit(i32 noundef, i8* noundef, ...)

declare i8* @th_malloc_x(i64 noundef, i8* noundef, i32 noundef)

declare i32 @th_printf(i8* noundef, ...)

declare i32 @th_report_results(%struct.THTestResults* noundef, i16 noundef zeroext)

declare i64 @th_signal_finished()

declare void @th_signal_start()

declare i32 @th_sprintf(i8* nocapture noundef, i8* nocapture noundef readonly, ...)

; Function Attrs: nounwind uwtable
define internal i32 @t_run_test(i64 noundef %arg, i32 noundef %arg1, i8** nocapture noundef readonly %arg2) {
bb:
  %i = alloca %struct.THTestResults, align 8
  %i3 = alloca [3 x [2 x i8]], align 1
  %i4 = alloca i64, align 8
  %i5 = alloca [5 x [2 x i8]], align 1
  %i6 = bitcast %struct.THTestResults* %i to i8*
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %i6)
  %i7 = getelementptr inbounds [3 x [2 x i8]], [3 x [2 x i8]]* %i3, i64 0, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 6, i8* nonnull %i7)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(6) %i7, i8* noundef nonnull align 1 dereferenceable(6) getelementptr inbounds ([3 x [2 x i8]], [3 x [2 x i8]]* @__const.t_run_test.CM_ONE, i64 0, i64 0, i64 0), i64 6, i1 false)
  %i8 = bitcast i64* %i4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %i8)
  store i64 72340172821299457, i64* %i4, align 8
  %i9 = getelementptr inbounds [5 x [2 x i8]], [5 x [2 x i8]]* %i5, i64 0, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 10, i8* nonnull %i9)
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 1 dereferenceable(10) %i9, i8* noundef nonnull align 1 dereferenceable(10) getelementptr inbounds ([5 x [2 x i8]], [5 x [2 x i8]]* @__const.t_run_test.CM_THREE, i64 0, i64 0, i64 0), i64 10, i1 false)
  %i10 = tail call i8* @th_malloc_x(i64 noundef 1056, i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i32 noundef 240)
  store i8* %i10, i8** @t_buf, align 8, !tbaa !6
  %i11 = icmp eq i8* %i10, null
  br i1 %i11, label %bb12, label %bb14

bb12:                                             ; preds = %bb
  tail call void (i32, i8*, ...) @th_exit(i32 noundef 8, i8* noundef getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i32 noundef 243)
  %i13 = load i8*, i8** @t_buf, align 8, !tbaa !6
  br label %bb14

bb14:                                             ; preds = %bb12, %bb
  %i15 = phi i8* [ %i13, %bb12 ], [ %i10, %bb ]
  %i16 = getelementptr inbounds i8, i8* %i15, i64 512, !intel-tbaa !10
  %i17 = bitcast i8* %i16 to [2 x i8]*
  %i18 = icmp slt i32 %arg1, 2
  br i1 %i18, label %bb19, label %bb22

bb19:                                             ; preds = %bb14
  %i20 = tail call i32 (i8*, ...) @th_printf(i8* noundef getelementptr inbounds ([45 x i8], [45 x i8]* @.str.3, i64 0, i64 0), i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0))
  %i21 = tail call i32 (i8*, ...) @th_printf(i8* noundef getelementptr inbounds ([49 x i8], [49 x i8]* @.str.4, i64 0, i64 0), i32 noundef 3)
  br label %bb40
...
bb24:                                             ; preds = %bb22
  %i25 = getelementptr inbounds i8*, i8** %arg2, i64 2
  %i26 = load i8*, i8** %i25, align 8, !tbaa !6
  %i27 = tail call i64 @strtol(i8* nocapture noundef nonnull %i26, i8** noundef null, i32 noundef 10)
  %i28 = trunc i64 %i27 to i16
  %i29 = icmp eq i16 %i28, 0
  br i1 %i29, label %bb30, label %bb32

bb30:                                             ; preds = %bb24, %bb22
  %i31 = tail call i32 (i8*, ...) @th_printf(i8* noundef getelementptr inbounds ([49 x i8], [49 x i8]* @.str.4, i64 0, i64 0), i32 noundef 3)
  br label %bb40
...
bb36:                                             ; preds = %bb32
  %i37 = getelementptr inbounds [3 x [2 x i8]], [3 x [2 x i8]]* %i3, i64 0, i64 0
  br label %bb42

bb38:                                             ; preds = %bb32
  %i39 = bitcast i64* %i4 to [2 x i8]*
  br label %bb42

bb40:                                             ; preds = %bb32, %bb30, %bb19
  %i41 = getelementptr inbounds [5 x [2 x i8]], [5 x [2 x i8]]* %i5, i64 0, i64 0
  br label %bb42

bb42:                                             ; preds = %bb40, %bb38, %bb36, %bb32
  %i43 = phi [2 x i8]* [ %i17, %bb32 ], [ %i41, %bb40 ], [ %i39, %bb38 ], [ %i37, %bb36 ]
...
bb48:                                             ; preds = %bb48, %bb42
  ...
  call void @convolutionalEncode(i8* noundef getelementptr inbounds ([512 x i8], [512 x i8]* @input_buf, i64 0, i64 0), i16 noundef signext 512, i16 noundef signext %i45, i16 noundef signext %i46, [2 x i8]* noundef %i43, i8* noundef %i15)
...
bb52:                                             ; preds = %bb48, %bb42
  ...
  %i54 = getelementptr inbounds %struct.THTestResults, %struct.THTestResults* %i, i64 0, i32 1, !intel-tbaa !11
  store i64 %i53, i64* %i54, align 8, !tbaa !11
  %i55 = getelementptr inbounds %struct.THTestResults, %struct.THTestResults* %i, i64 0, i32 0, !intel-tbaa !15
  store i64 %arg, i64* %i55, align 8, !tbaa !15
  %i56 = getelementptr inbounds %struct.THTestResults, %struct.THTestResults* %i, i64 0, i32 3, !intel-tbaa !16
  %i57 = getelementptr inbounds %struct.THTestResults, %struct.THTestResults* %i, i64 0, i32 4, !intel-tbaa !17
  %i58 = getelementptr inbounds %struct.THTestResults, %struct.THTestResults* %i, i64 0, i32 5, !intel-tbaa !18
  %i59 = getelementptr inbounds %struct.THTestResults, %struct.THTestResults* %i, i64 0, i32 7, !intel-tbaa !19
  %i60 = bitcast i64* %i56 to i8*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(32) %i60, i8 0, i64 32, i1 false)
  store i8* getelementptr inbounds ([64 x i8], [64 x i8]* @t_run_test.info, i64 0, i64 0), i8** %i59, align 8, !tbaa !19
  %i61 = call i32 (i8*, i8*, ...) @th_sprintf(i8* noundef getelementptr inbounds ([64 x i8], [64 x i8]* @t_run_test.info, i64 0, i64 0), i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i64 0, i64 0))
  %i62 = getelementptr inbounds %struct.THTestResults, %struct.THTestResults* %i, i64 0, i32 2, !intel-tbaa !20
  store i16 0, i16* %i62, align 8, !tbaa !20
...
bb67:                                             ; preds = %bb88, %bb63
  ...
  %i70 = getelementptr inbounds i8, i8* %i15, i64 %i69
  %i71 = load i8, i8* %i70, align 1, !tbaa !10
  %i72 = call zeroext i16 @Calc_crc8(i8 noundef zeroext %i71, i16 noundef zeroext %i68)
  store i16 %i72, i16* %i62, align 8, !tbaa !20
  %i73 = load i8, i8* %i70, align 1, !tbaa !10
  %i74 = getelementptr inbounds [1024 x i8], [1024 x i8]* @test_buf, i64 0, i64 %i69
  %i75 = load i8, i8* %i74, align 1, !tbaa !10
  %i76 = icmp eq i8 %i73, %i75
  br i1 %i76, label %bb88, label %bb77

bb77:                                             ; preds = %bb67
  %i78 = getelementptr inbounds i8, i8* %i15, i64 %i69
  %i79 = trunc i64 %i69 to i32
  %i80 = and i32 %i79, 65535
  %i81 = zext i8 %i75 to i32
  %i82 = zext i8 %i73 to i32
  %i83 = zext i16 %i72 to i32
  %i84 = call i32 (i8*, ...) @th_printf(i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @.str.6, i64 0, i64 0), i32 noundef %i83, i32 noundef %i80, i32 noundef %i82, i32 noundef %i81)
  store i64 %i69, i64* %i56, align 8, !tbaa !16
  %i85 = load i8, i8* %i78, align 1, !tbaa !10
  %i86 = zext i8 %i85 to i64
  store i64 %i86, i64* %i57, align 8, !tbaa !17
  %i87 = zext i8 %i75 to i64
  store i64 %i87, i64* %i58, align 8, !tbaa !18
  br label %bb91
...
bb91:                                             ; preds = %bb88, %bb77, %bb52
  %i92 = call i32 @th_report_results(%struct.THTestResults* noundef nonnull %i, i16 noundef zeroext -3568)
  call void @llvm.lifetime.end.p0i8(i64 10, i8* nonnull %i9)
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %i8)
  call void @llvm.lifetime.end.p0i8(i64 6, i8* nonnull %i7)
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %i6)
  ret i32 %i92
}
...
define internal void @convolutionalEncode(i8* nocapture noundef readonly %arg, i16 noundef signext %arg1, i16 noundef signext %arg2, i16 noundef signext %arg3, [2 x i8]* nocapture noundef readonly %arg4, i8* nocapture noundef %arg5) {
bb:
  %i = alloca [8 x i8], align 1
  %i6 = getelementptr inbounds [8 x i8], [8 x i8]* %i, i64 0, i64 0
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %i6)
  %i7 = icmp sgt i16 %arg3, 0
  br i1 %i7, label %bb8, label %bb10

bb8:                                              ; preds = %bb
  %i9 = zext i16 %arg3 to i64
  call void @llvm.memset.p0i8.i64(i8* nonnull align 1 %i6, i8 0, i64 %i9, i1 false), !tbaa !21
  br label %bb10
...
bb25:                                             ; preds = %bb28, %bb22
  %i26 = getelementptr inbounds i8, i8* %arg, i64 %i23
  %i27 = load i8, i8* %i26, align 1, !tbaa !10
  store i8 %i27, i8* %i6, align 1, !tbaa !21
  br label %bb39
...
bb28:                                             ; preds = %bb28, %bb22
  ...
  %i33 = getelementptr inbounds [8 x i8], [8 x i8]* %i, i64 0, i64 %i32, !intel-tbaa !21
  %i34 = load i8, i8* %i33, align 1, !tbaa !21
  %i35 = getelementptr inbounds [8 x i8], [8 x i8]* %i, i64 0, i64 %i29, !intel-tbaa !21
  store i8 %i34, i8* %i35, align 1, !tbaa !21
...
bb39:                                             ; preds = %bb58, %bb25
  %i40 = phi i64 [ %i60, %bb58 ], [ 0, %bb25 ]
  %i41 = phi i16 [ %i59, %bb58 ], [ %i24, %bb25 ]
  %i42 = sext i16 %i41 to i64
  %i43 = getelementptr inbounds i8, i8* %arg5, i64 %i42
  store i8 0, i8* %i43, align 1, !tbaa !10
  br label %bb44

bb44:                                             ; preds = %bb54, %bb39
  %i45 = phi i8 [ %i55, %bb54 ], [ 0, %bb39 ]
  %i46 = phi i64 [ %i56, %bb54 ], [ 0, %bb39 ]
  %i47 = getelementptr inbounds [2 x i8], [2 x i8]* %arg4, i64 %i46, i64 %i40
  %i48 = load i8, i8* %i47, align 1, !tbaa !23
  %i49 = icmp eq i8 %i48, 0
  br i1 %i49, label %bb54, label %bb50

bb50:                                             ; preds = %bb44
  %i51 = getelementptr inbounds [8 x i8], [8 x i8]* %i, i64 0, i64 %i46, !intel-tbaa !21
  %i52 = load i8, i8* %i51, align 1, !tbaa !21
  %i53 = xor i8 %i45, %i52
  store i8 %i53, i8* %i43, align 1, !tbaa !10
  br label %bb54
...
bb75:                                             ; preds = %bb94, %bb75
  ...
  %i79 = getelementptr inbounds i8, i8* %arg5, i64 %i78
  store i8 0, i8* %i79, align 1, !tbaa !10
  %i80 = add i16 %i77, 1
...
bb83:                                             ; preds = %bb83, %bb72
  ...
  %i88 = getelementptr inbounds [8 x i8], [8 x i8]* %i, i64 0, i64 %i87, !intel-tbaa !21
  %i89 = load i8, i8* %i88, align 1, !tbaa !21
  %i90 = getelementptr inbounds [8 x i8], [8 x i8]* %i, i64 0, i64 %i84, !intel-tbaa !21
  store i8 %i89, i8* %i90, align 1, !tbaa !21
  %i91 = add i16 %i85, -1
...
bb94:                                             ; preds = %bb83
  %i95 = getelementptr inbounds i8, i8* %arg, i64 %i73
  %i96 = load i8, i8* %i95, align 1, !tbaa !10
  store i8 %i96, i8* %i6, align 1, !tbaa !21
  br label %bb75
...
bb104:                                            ; preds = %bb104, %bb101
  ...
  %i108 = getelementptr inbounds i8, i8* %arg5, i64 %i107
  store i8 0, i8* %i108, align 1, !tbaa !10
  %i109 = add i16 %i106, 1
...
bb122:                                            ; preds = %bb122, %bb120
  ...
  %i127 = getelementptr inbounds [8 x i8], [8 x i8]* %i, i64 0, i64 %i126, !intel-tbaa !21
  %i128 = load i8, i8* %i127, align 1, !tbaa !21
  %i129 = getelementptr inbounds [8 x i8], [8 x i8]* %i, i64 0, i64 %i123, !intel-tbaa !21
  store i8 %i128, i8* %i129, align 1, !tbaa !21
  %i130 = add i16 %i124, -1
...
bb133:                                            ; preds = %bb122
  %i134 = getelementptr inbounds i8, i8* %arg, i64 %i121
  %i135 = load i8, i8* %i134, align 1, !tbaa !10
  store i8 %i135, i8* %i6, align 1, !tbaa !21
...
bb138:                                            ; preds = %bb133, %bb116, %bb112, %bb97, %bb62, %bb10
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %i6)
  ret void
}

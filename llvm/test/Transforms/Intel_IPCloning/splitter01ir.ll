; RUN: opt < %s -ip-cloning -force-ip-manyreccalls-splitting -S 2>&1 | FileCheck %s
; RUN: opt < %s -passes='module(ip-cloning)' -force-ip-manyreccalls-splitting -S 2>&1 | FileCheck %s

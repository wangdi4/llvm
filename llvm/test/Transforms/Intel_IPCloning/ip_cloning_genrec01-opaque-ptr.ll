...
; CHECK: Cloned call:     %call4 = call i32 @foo.1(i32 0, i32 0)
; CHECK: Cloned call:     %call2 = call i32 @foo.1(i32 0, i32 0)
; CHECK: Cloned call:     %call1 = call i32 @foo.1(i32 0, i32 0)
; CHECK: Cloned call:     %call = call i32 @foo.1(i32 0, i32 0)
; CHECK: Skipping main
; CHECK: Skipping foo.1

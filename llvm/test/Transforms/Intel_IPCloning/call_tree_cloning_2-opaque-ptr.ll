; RUN: opt < %s -opaque-pointers -passes='module(call-tree-clone)' -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2  -call-tree-clone-do-mv=false -call-tree-clone-seed=a:0 -call-tree-clone-seed=b:0,1 -S | FileCheck %s
; RUN: opt < %s -opaque-pointers -call-tree-clone -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2  -call-tree-clone-do-mv=false -call-tree-clone-seed=a:0 -call-tree-clone-seed=b:0,1 -S | FileCheck %s
...
; This is the same test case as call_tree_cloning_2.ll, but it checks for
; opaque pointers.

; ModuleID = 'call_tree_cloning_2-opaque-ptr.ll'
source_filename = "call_tree_cloning_2-opaque-ptr.ll"

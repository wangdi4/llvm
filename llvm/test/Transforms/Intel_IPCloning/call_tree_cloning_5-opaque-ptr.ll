...
; This is the same test case as call_tree_cloning_5.ll, but it checks for
; opaque pointers.

; ModuleID = 'call_tree_cloning_5-opaque-ptr.ll'
...
define internal fastcc void @pixel_avg(i32 %0, i32 %1) unnamed_addr #0 {
  %3 = icmp sgt i32 %1, 0
...
7:                                                ; preds = %13, %4
  %8 = phi i32 [ 0, %4 ], [ %17, %13 ]
  %9 = phi ptr [ getelementptr inbounds ([1000 x i8], ptr @dst, i64 0, i64 0), %4 ], [ %14, %13 ]
  %10 = phi ptr [ getelementptr inbounds ([1000 x i8], ptr @src1, i64 0, i64 0), %4 ], [ %15, %13 ]
  %11 = phi ptr [ getelementptr inbounds ([1000 x i8], ptr @src2, i64 0, i64 0), %4 ], [ %16, %13 ]

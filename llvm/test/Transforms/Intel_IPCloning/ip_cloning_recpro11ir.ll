...
; creating an extra clone because its second loop does not have the desired
; form.
; This is the same test as ip_cloning_recpro11.ll, but checks for IR without
; requiring asserts.

; CHECK: define dso_local void @MAIN__()
; CHECK: call void @bad2.1
; CHECK: define internal void @bad2.1
; CHECK: call void @bad2.2
; CHECK: define internal void @bad2.2
; CHECK: call void @bad2.3
; CHECK: define internal void @bad2.3
; CHECK: call void @bad2.4
; CHECK: define internal void @bad2.4
; CHECK: call void @bad2.5
; CHECK: define internal void @bad2.5
; CHECK: call void @bad2.6
; CHECK: define internal void @bad2.6
; CHECK: call void @bad2.7
; CHECK: define internal void @bad2.7
; CHECK: call void @bad2.8
; CHECK: define internal void @bad2.8
...
define dso_local void @MAIN__() {
  ...
  call void @bad2(i32* nonnull %1)
  ret void
}

@myc = internal unnamed_addr constant i32 20

define internal void @bad2(i32* noalias nocapture readonly) {

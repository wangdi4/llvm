...
define void @myoriginal(%struct._NexusInfo* %0) {
 ret void
}

@myalias = dso_local alias void (%struct._NexusInfo*), void (%struct._NexusInfo*)* @myoriginal
...
65:                                               ; preds = %62, %60, %56
  ...
  call void @myalias(%struct._NexusInfo* %6)

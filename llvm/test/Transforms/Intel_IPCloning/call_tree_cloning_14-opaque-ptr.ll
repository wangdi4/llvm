...
; RUN: opt < %s -opaque-pointers -debug-only=call-tree-clone -call-tree-clone -ctcmv-model-user-calls=1 -ctcmv-num-user-calls-modeled=2450 -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -call-tree-clone-mv-bypass-coll-for-littest=0 -disable-output 2>&1 | FileCheck %s
...
; This is the same test case as call_tree_cloning_14.ll, but it checks for
; opaque pointers.

; ModuleID = 'call_tree_cloning_14-opaque-ptr.ll'
source_filename = "call_tree_cloning_14-opaque-ptr.ll"

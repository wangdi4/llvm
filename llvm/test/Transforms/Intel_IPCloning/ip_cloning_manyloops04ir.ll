...
; the argument does not have the readonly attribute.
; This test is similar to ip_cloning_manyloops04.ll, but only tests the IR.
...
define internal void @aer_rad_props_mp_aer_rad_props_sw_(i32* noalias nocapture readonly dereferenceable(4) %0, %"PHYSICS_TYPES$.btPHYSICS_STATE"* noalias nocapture dereferenceable(20552) %1) #0 {
L0:

...
; MLSC: Testing aer_rad_props_mp_aer_rad_props_sw_: Arg missing required attributes
...
define internal void @aer_rad_props_mp_aer_rad_props_sw_(ptr noalias nocapture readonly dereferenceable(4) %arg, ptr noalias nocapture dereferenceable(20552) %arg1) #0 {
L0:

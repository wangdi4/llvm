...
; form.
; This is the same test as ip_cloning_recpro10.ll, but checks for IR without
; requiring asserts.
...
define dso_local void @MAIN__() {
  ...
  call void @bad1(i32* nonnull %1)
  ret void
}

@myc = internal unnamed_addr constant i32 20

define internal void @bad1(i32* noalias nocapture readonly) {

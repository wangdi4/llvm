...
; This is the same test as ip_cloning_callback02.ll, but checks for IR without
; requiring asserts.
...
; CHECK-NOT: call{{.*}}@foo.DIR.OMP.PARALLEL.LOOP.2.split5.[[R1:[0-9]+]]
; CHECK-NOT: define internal void @foo.DIR.OMP.PARALLEL.LOOP.2.split5.[[R0:[0-9]+]]({{.*}})
; CHECK-NOT: define internal void @foo.DIR.OMP.PARALLEL.LOOP.2.split5.[[R1:[0-9]+]]({{.*}})
...
define internal fastcc i32 @foo(i32 %0) unnamed_addr {
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @.kmpc_loc.0.0.4, i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32**, i64, i32*)* @foo.DIR.OMP.PARALLEL.LOOP.2.split5 to void (i32*, i32*, ...)*), i32** nonnull %2, i64 0, i32* nonnull %3)
  %6 = load i32, i32* getelementptr inbounds ([200 x i32], [200 x i32]* @a, i64 0, i64 0), align 16, !tbaa !9
  ret i32 %6
}

; Function Attrs: nofree noinline nounwind uwtable
define internal void @foo.DIR.OMP.PARALLEL.LOOP.2.split5(i32* nocapture readonly %0, i32* nocapture readnone %1, i32** nocapture readonly %2, i64 %3, i32* nocapture readonly %4) {
  ret void
}

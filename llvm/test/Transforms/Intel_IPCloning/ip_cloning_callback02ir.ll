...
; This is the same test as ip_cloning_callback02-opaqueptr.ll, but checks for
...
bb:
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr nonnull @.kmpc_loc.0.0.4, i32 3, ptr @foo.DIR.OMP.PARALLEL.LOOP.2.split5, ptr nonnull %i, i64 0, ptr nonnull %i1)
  %i4 = load i32, ptr getelementptr inbounds ([200 x i32], ptr @a, i64 0, i64 0), align 16, !tbaa !9
  ret i32 %i4
}

define internal void @foo.DIR.OMP.PARALLEL.LOOP.2.split5(ptr nocapture readonly %arg, ptr nocapture readnone %arg1, ptr nocapture readonly %arg2, i64 %arg3, ptr nocapture readonly %arg4) {
bb:
  ret void
}

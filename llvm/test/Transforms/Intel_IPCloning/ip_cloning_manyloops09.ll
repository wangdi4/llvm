...
; Loop specialization should occur even if @foo with a non-dereferenceable 
; pointer argument to an unsized type is introduced. 
...
define internal void @foo(i32 (...)* %myarg) #0 {
  ret void
}

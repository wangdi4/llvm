...
; RUN: opt -force-opaque-pointers < %s -ip-cloning -force-ip-manyreccalls-splitting -S 2>&1 | FileCheck %s
; RUN: opt -force-opaque-pointers < %s -passes='module(ip-cloning)' -force-ip-manyreccalls-splitting -S 2>&1 | FileCheck %s

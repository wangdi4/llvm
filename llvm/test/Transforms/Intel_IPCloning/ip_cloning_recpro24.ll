...
; Here we are testing that the initial value of the argument of the recursive
; function can be a compile-time constant.
...
@anon = internal constant i32 1, align 4
define dso_local void @MAIN__() {
bb:
  %i = alloca i32, align 4
  store i32 1, ptr %i, align 4
  call void @foo(ptr nonnull @anon)
  ret void
}

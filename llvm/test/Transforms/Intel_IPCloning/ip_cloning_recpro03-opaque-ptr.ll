...
; RUN: opt -force-opaque-pointers < %s -tailcallelim -no-tail-call-for-rec-pro-clone -S 2>&1 | FileCheck %s
; RUN: opt -force-opaque-pointers < %s -passes=tailcallelim -no-tail-call-for-rec-pro-clone -S 2>&1 | FileCheck %s
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %locnt)
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %upcnt)
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %kdptr)
...
if.then:                                          ; preds = %entry
  ...
  %i5 = tail call i64 @fwrite(ptr getelementptr inbounds ([40 x i8], ptr @.str, i64 0, i64 0), i64 39, i64 1, ptr %i4)
...
for.end.split:                                    ; preds = %heapsort_index.exit437
  ...
  store ptr %incdec.ptr255, ptr %kdptr, align 8
  %lo256 = getelementptr inbounds i8, ptr %call2, i64 8
  store ptr null, ptr %lo256, align 8
  %hi257 = getelementptr inbounds i8, ptr %call2, i64 16
  store ptr null, ptr %hi257, align 8
  %sub258 = add nsw i32 %natom, -1
  call fastcc void @buildkdtree(ptr %call14, ptr %call5, ptr %call6, ptr %call7, ptr %wn.0, ptr %call8, i32 0, i32 %sub258, ptr nonnull %kdptr, ptr %call2, ptr %x, i32 0, i32 %dim)
  br label %if.end32
...
heapsort_index.exit551:                           ; preds = %downheap_index.exit599, %while.cond.preheader.i540
  ...
  store ptr %incdec.ptr259, ptr %kdptr, align 8
  %lo260 = getelementptr inbounds i8, ptr %call2, i64 8
  store ptr null, ptr %lo260, align 8
  %hi261 = getelementptr inbounds i8, ptr %call2, i64 16
  store ptr null, ptr %hi261, align 8
  %sub262 = add nsw i32 %natom, -1
  call fastcc void @buildkdtree(ptr %call14, ptr %call5, ptr %call6, ptr %call7, ptr %wn.0, ptr %call8, i32 0, i32 %sub262, ptr nonnull %kdptr, ptr %call2, ptr %x, i32 0, i32 4)
  br label %if.end32
...
for.body38:                                       ; preds = %for.cond35
  ...
  call fastcc void @foo(ptr %call2, ptr %x, i32 0, i32 %i.1, ptr nonnull %locnt, ptr nonnull %upcnt, ptr %call33, ptr %call34, double %cutoff, double %mul, i32 %dim, ptr %frozen)
...
if.end126:                                        ; preds = %if.then125, %for.end122
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %kdptr)
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %upcnt)
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %locnt)
  ret i32 %totpair.0
}

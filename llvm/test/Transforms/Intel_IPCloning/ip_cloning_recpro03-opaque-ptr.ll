...
; RUN: opt -opaque-pointers < %s -tailcallelim -no-tail-call-for-rec-pro-clone -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers < %s -passes=tailcallelim -no-tail-call-for-rec-pro-clone -S 2>&1 | FileCheck %s

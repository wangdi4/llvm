...
; CHECK: Cloning Analysis for:  bad2
; CHECK: Selected RecProgression cloning
; CHECK: Function: bad2.1
; CHECK: ArgPos : 0
; CHECK: Argument : i32* %0
; CHECK: IsByRef : T
; CHECK: Replacement:  i32 1
; CHECK: Function: bad2.2
; CHECK: ArgPos : 0
; CHECK: Argument : i32* %0
; CHECK: IsByRef : T
; CHECK: Replacement:  i32 2
; CHECK: Function: bad2.3
; CHECK: ArgPos : 0
; CHECK: Argument : i32* %0
; CHECK: IsByRef : T
; CHECK: Replacement:  i32 3
; CHECK: Function: bad2.4
; CHECK: ArgPos : 0
; CHECK: Argument : i32* %0
; CHECK: IsByRef : T
; CHECK: Replacement:  i32 4
; CHECK: Function: bad2.5
; CHECK: ArgPos : 0
; CHECK: Argument : i32* %0
; CHECK: IsByRef : T
; CHECK: Replacement:  i32 5
; CHECK: Function: bad2.6
; CHECK: ArgPos : 0
; CHECK: Argument : i32* %0
; CHECK: IsByRef : T
; CHECK: Replacement:  i32 6
; CHECK: Function: bad2.7
; CHECK: ArgPos : 0
; CHECK: Argument : i32* %0
; CHECK: IsByRef : T
; CHECK: Replacement:  i32 7
; CHECK: Function: bad2.8
; CHECK: ArgPos : 0
; CHECK: Argument : i32* %0
; CHECK: IsByRef : T
; CHECK: Replacement:  i32 8
; CHECK-NOT: Extra RecProClone Candidate: bad2.8

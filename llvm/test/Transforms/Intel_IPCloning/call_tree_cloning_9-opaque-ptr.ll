...
; This is the same test case as call_tree_cloning_9.ll, but it checks for
; opaque pointers.

; ModuleID = 'call_tree_cloning_9-opaque-ptr.ll'
source_filename = "call_tree_cloning_9-opaque-ptr.ll"

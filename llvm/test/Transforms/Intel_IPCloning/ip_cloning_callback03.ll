; REQUIRES: asserts
; RUN: opt < %s -ip-cloning -ip-cloning-after-inl -ip-cloning-force-heuristics-off -ip-gen-cloning-force-off-callback-cloning -S -debug-only=ipcloning 2>&1 | FileCheck %s

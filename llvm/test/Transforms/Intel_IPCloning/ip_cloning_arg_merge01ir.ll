...
; RUN: opt < %s -passes='module(post-inline-ip-cloning)' -S -filter-print-funcs=c_kernel.DIR.OMP.PARALLEL.LOOP.2.split678.1 2>&1 | FileCheck %s

; The test is a copy of ip_cloning_arg_merge01.ll but checks IR instead of optimization's
; debug output
...
; CHECK-NEXT:    [[TMP13:%.*]] = trunc i64 0 to i32
; CHECK-NEXT:    [[TMP14:%.*]] = trunc i64 0 to i32
; CHECK-NEXT:    [[TMP15:%.*]] = alloca i32, i32 0, align 4
; CHECK-NEXT:    [[TMP16:%.*]] = alloca i64, i32 0, align 8
; CHECK-NEXT:    [[TMP17:%.*]] = alloca i64, i32 0, align 8
; CHECK-NEXT:    [[TMP18:%.*]] = alloca i64, i32 0, align 8
; CHECK-NEXT:    [[TMP19:%.*]] = load i32, ptr null, align 4
; CHECK-NEXT:    [[TMP20:%.*]] = load i64, ptr null, align 8
; CHECK-NEXT:    [[TMP21:%.*]] = load i64, ptr null, align 8
; CHECK-NEXT:    [[TMP22:%.*]] = icmp ugt i64 0, 0
; CHECK-NEXT:    br label [[TMP23:%.*]]
; CHECK:       23:
; CHECK-NEXT:    [[TMP24:%.*]] = freeze i64 0
; CHECK-NEXT:    [[TMP25:%.*]] = sub i64 0, 0
; CHECK-NEXT:    [[TMP26:%.*]] = and i64 0, 0
; CHECK-NEXT:    [[TMP27:%.*]] = load i64, ptr null, align 8
; CHECK-NEXT:    [[TMP28:%.*]] = load i32, ptr null, align 4
; CHECK-NEXT:    [[TMP29:%.*]] = load i64, ptr null, align 8
; CHECK-NEXT:    br label [[TMP30:%.*]]
; CHECK:       30:
; CHECK-NEXT:    [[TMP31:%.*]] = phi i64 [ 0, [[TMP330:%.*]] ], [ 0, [[TMP23]] ]
; CHECK-NEXT:    [[TMP32:%.*]] = udiv i64 0, 0
; CHECK-NEXT:    [[TMP33:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP34:%.*]] = srem i64 0, 0
; CHECK-NEXT:    [[TMP35:%.*]] = trunc i64 0 to i32
; CHECK-NEXT:    [[TMP36:%.*]] = add i32 0, 0
; CHECK-NEXT:    [[TMP37:%.*]] = shl i64 0, 0
; CHECK-NEXT:    [[TMP38:%.*]] = ashr i64 0, 0
; CHECK-NEXT:    [[TMP39:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP40:%.*]] = sext i32 0 to i64
; CHECK-NEXT:    [[TMP41:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP42:%.*]] = add i32 0, 0
; CHECK-NEXT:    [[TMP43:%.*]] = add i32 0, 0
; CHECK-NEXT:    [[TMP44:%.*]] = sub i32 0, 0
; CHECK-NEXT:    [[TMP45:%.*]] = add i32 0, 0
; CHECK-NEXT:    [[TMP46:%.*]] = or i32 0, 0
; CHECK-NEXT:    [[TMP47:%.*]] = lshr i32 0, 0
; CHECK-NEXT:    [[TMP48:%.*]] = sitofp i32 0 to double
; CHECK-NEXT:    br label [[TMP49:%.*]]
; CHECK:       49:
; CHECK-NEXT:    [[TMP50:%.*]] = phi i64 [ 0, [[TMP30]] ], [ 0, [[TMP49]] ]
; CHECK-NEXT:    [[TMP51:%.*]] = phi double [ 0.000000e+00, [[TMP30]] ], [ 0.000000e+00, [[TMP49]] ]
; CHECK-NEXT:    [[TMP52:%.*]] = phi double [ 0.000000e+00, [[TMP30]] ], [ 0.000000e+00, [[TMP49]] ]
; CHECK-NEXT:    [[TMP53:%.*]] = phi double [ 0.000000e+00, [[TMP30]] ], [ 0.000000e+00, [[TMP49]] ]
; CHECK-NEXT:    [[TMP54:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP55:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP56:%.*]] = getelementptr i64, ptr [[TMP3]], i64 [[TMP50]]
; CHECK-NEXT:    [[TMP57:%.*]] = load i64, ptr [[TMP56]], align 8
; CHECK-NEXT:    [[TMP58:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP59:%.*]] = or i64 0, 0
; CHECK-NEXT:    [[TMP60:%.*]] = getelementptr double, ptr [[TMP8]], i64 [[TMP59]]
; CHECK-NEXT:    [[TMP61:%.*]] = load double, ptr [[TMP60]], align 8
; CHECK-NEXT:    [[TMP62:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP63:%.*]] = getelementptr [[STRUCT_PAR_T:%.*]], ptr [[TMP2]], i64 0, i32 1, i64 [[TMP50]]
; CHECK-NEXT:    [[TMP64:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP65:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP66:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP67:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 2, i64 [[TMP50]]
; CHECK-NEXT:    [[TMP68:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP69:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP70:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP71:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP72:%.*]] = icmp eq i64 0, 0
; CHECK-NEXT:    br label [[TMP49]]
; CHECK:       73:
; CHECK-NEXT:    [[TMP74:%.*]] = fdiv double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP75:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP76:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    br label [[TMP77:%.*]]
; CHECK:       77:
; CHECK-NEXT:    [[TMP78:%.*]] = phi i64 [ 0, [[TMP73:%.*]] ], [ 0, [[TMP77]] ]
; CHECK-NEXT:    [[TMP79:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP80:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP81:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP82:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP83:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP84:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP85:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP86:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP87:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP88:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP89:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP90:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP91:%.*]] = phi double [ 0.000000e+00, [[TMP73]] ], [ 0.000000e+00, [[TMP77]] ]
; CHECK-NEXT:    [[TMP92:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP93:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP94:%.*]] = getelementptr i64, ptr [[TMP3]], i64 [[TMP78]]
; CHECK-NEXT:    [[TMP95:%.*]] = load i64, ptr null, align 8
; CHECK-NEXT:    [[TMP96:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP97:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP98:%.*]] = getelementptr double, ptr [[TMP8]], i64 [[TMP97]]
; CHECK-NEXT:    [[TMP99:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP100:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 1, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP101:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP102:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP103:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP104:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 2, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP105:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP106:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP107:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP108:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP109:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP110:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP111:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP112:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 6, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP113:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP114:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP115:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP116:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 7, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP117:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP118:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP119:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP120:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 8, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP121:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP122:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP123:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP124:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 9, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP125:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP126:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP127:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP128:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 10, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP129:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP130:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP131:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP132:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 11, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP133:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP134:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP135:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP136:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 12, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP137:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP138:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP139:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP140:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 13, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP141:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP142:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP143:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP144:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 14, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP145:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP146:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP147:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP148:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 15, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP149:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP150:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP151:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP152:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 16, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP153:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP154:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP155:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP156:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 17, i64 [[TMP78]]
; CHECK-NEXT:    [[TMP157:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP158:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP159:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP160:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP161:%.*]] = icmp eq i64 0, 0
; CHECK-NEXT:    br label [[TMP77]]
; CHECK:       162:
; CHECK-NEXT:    [[TMP163:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP164:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP165:%.*]] = fdiv double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP166:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP167:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP168:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP169:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP170:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP171:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP172:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP173:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP174:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP175:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP176:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP177:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP178:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP179:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP180:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP181:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP182:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP183:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP184:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP185:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP186:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP187:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP188:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP189:%.*]] = fdiv double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP190:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    br label [[TMP191:%.*]]
; CHECK:       191:
; CHECK-NEXT:    [[TMP192:%.*]] = phi i64 [ 0, [[TMP162:%.*]] ], [ 0, [[TMP191]] ]
; CHECK-NEXT:    [[TMP193:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 1, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP194:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP195:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP196:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 2, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP197:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP198:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP199:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP200:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP201:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP202:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP203:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP204:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 6, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP205:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP206:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP207:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 7, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP208:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP209:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP210:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP211:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 8, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP212:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP213:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP214:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP215:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 9, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP216:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP217:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP218:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 10, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP219:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP220:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP221:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 11, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP222:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP223:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP224:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 12, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP225:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP226:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP227:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 13, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP228:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP229:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP230:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 14, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP231:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP232:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP233:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 15, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP234:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP235:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP236:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 16, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP237:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP238:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP239:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 17, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP240:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP241:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP242:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP243:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP244:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP245:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP246:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP247:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP248:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP249:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP250:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP251:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP252:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP253:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP254:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP255:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP256:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP257:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP258:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP259:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP260:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP261:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP262:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP263:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP264:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP265:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP266:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP267:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP268:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP269:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP270:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP271:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP272:%.*]] = fneg double 0.000000e+00
; CHECK-NEXT:    [[TMP273:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP274:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP275:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP276:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP277:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP278:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP279:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP280:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP281:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP282:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP283:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP284:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP285:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP286:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP287:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP288:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP289:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP290:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP291:%.*]] = fadd double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP292:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP293:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP294:%.*]] = getelementptr i64, ptr [[TMP3]], i64 [[TMP192]]
; CHECK-NEXT:    [[TMP295:%.*]] = load i64, ptr null, align 8
; CHECK-NEXT:    [[TMP296:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP297:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP298:%.*]] = getelementptr double, ptr [[TMP8]], i64 [[TMP297]]
; CHECK-NEXT:    [[TMP299:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP300:%.*]] = getelementptr [[STRUCT_PAR_T]], ptr [[TMP2]], i64 0, i32 0, i64 [[TMP192]]
; CHECK-NEXT:    [[TMP301:%.*]] = load double, ptr null, align 8
; CHECK-NEXT:    [[TMP302:%.*]] = fmul double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP303:%.*]] = fsub double 0.000000e+00, 0.000000e+00
; CHECK-NEXT:    [[TMP304:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP305:%.*]] = icmp eq i64 0, 0
; CHECK-NEXT:    br i1 false, label [[TMP306:%.*]], label [[TMP191]]
; CHECK:       306:
; CHECK-NEXT:    [[TMP307:%.*]] = phi i64 [ 0, [[TMP306]] ], [ 0, [[TMP191]] ]
; CHECK-NEXT:    [[TMP308:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP309:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP310:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP311:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP312:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP313:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP314:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP315:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP316:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP317:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP318:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP319:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP320:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP321:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP322:%.*]] = phi double [ 0.000000e+00, [[TMP306]] ], [ 0.000000e+00, [[TMP191]] ]
; CHECK-NEXT:    [[TMP323:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP324:%.*]] = mul i64 0, 0
; CHECK-NEXT:    [[TMP325:%.*]] = getelementptr i64, ptr [[TMP3]], i64 [[TMP307]]
; CHECK-NEXT:    [[TMP326:%.*]] = load i64, ptr null, align 8
; CHECK-NEXT:    [[TMP327:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP328:%.*]] = add i64 0, 0
; CHECK-NEXT:    [[TMP329:%.*]] = getelementptr inbounds double, ptr [[TMP8]], i64 [[TMP328]]
; CHECK-NEXT:    br label [[TMP306]]
; CHECK:       330:
; CHECK-NEXT:    br label [[TMP30]]
;

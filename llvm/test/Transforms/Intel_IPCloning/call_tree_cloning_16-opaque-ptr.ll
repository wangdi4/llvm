...
; RUN: opt < %s -opaque-pointers -call-tree-clone -call-tree-clone-max-direct-callsites=10 -call-tree-clone-do-mv=false -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -S | FileCheck %s

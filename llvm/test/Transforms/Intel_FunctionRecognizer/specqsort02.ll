; REQUIRES: asserts
; UNSUPPORTED: linux
; RUN: opt < %s -enable-dtrans -functionrecognizer -debug-only=functionrecognizer -S 2>&1 | FileCheck %s
; RUN: opt < %s -enable-dtrans -passes='function(functionrecognizer)' -debug-only=functionrecognizer -S 2>&1 | FileCheck %s

; Test that on Windows @spec_qsort is recognized as a qsort spec_qsort.

; CHECK: FUNCTION-RECOGNIZER: FOUND QSORT-SPEC_QSORT spec_qsort
; CHECK: define{{.*}}@spec_qsort{{.*}} #0
...
if.then58:                                        ; preds = %if.then53
  ...
  %add.ptr62 = getelementptr inbounds i8, i8* %a.addr.0, i64 %mul61
  %add.ptr63 = getelementptr inbounds i8, i8* %a.addr.0, i64 %mul60
  %call64 = call i8* @med3(i8* %a.addr.0, i8* %add.ptr63, i8* %add.ptr62, i32 (i8*, i8*)* %cmp)
  %add.ptr65 = getelementptr inbounds i8, i8* %add.ptr50, i64 %mul60
  %idx.neg66 = sub i64 0, %mul60
  %add.ptr67 = getelementptr inbounds i8, i8* %add.ptr50, i64 %idx.neg66
  %call68 = call i8* @med3(i8* %add.ptr67, i8* %add.ptr50, i8* %add.ptr65, i32 (i8*, i8*)* %cmp)
  %idx.neg69 = sub i64 0, %mul60
  %add.ptr70 = getelementptr inbounds i8, i8* %add.ptr55, i64 %idx.neg69
  %mul71 = mul i64 2, %mul60
  %idx.neg72 = sub i64 0, %mul71
  %add.ptr73 = getelementptr inbounds i8, i8* %add.ptr55, i64 %idx.neg72
  %call74 = call i8* @med3(i8* %add.ptr73, i8* %add.ptr70, i8* %add.ptr55, i32 (i8*, i8*)* %cmp)
  br label %if.end75
...
if.then80:                                        ; preds = %if.end77
  ...
  %18 = bitcast i8* %a.addr.0 to i32*
  store i32 %17, i32* %18, align 4
  %19 = bitcast i8* %pm.2 to i32*
...
if.then108:                                       ; preds = %if.then105
  %26 = bitcast i8* %pa.1 to i32*
  %27 = load i32, i32* %26, align 4
  %28 = bitcast i8* %pb.1 to i32*
  %29 = load i32, i32* %28, align 4
  %30 = bitcast i8* %pa.1 to i32*
  store i32 %29, i32* %30, align 4
  %31 = bitcast i8* %pb.1 to i32*
...
if.then136:                                       ; preds = %if.then133
  %38 = bitcast i8* %pc.1 to i32*
  %39 = load i32, i32* %38, align 4
  %40 = bitcast i8* %pd.1 to i32*
  %41 = load i32, i32* %40, align 4
  %42 = bitcast i8* %pc.1 to i32*
  store i32 %41, i32* %42, align 4
  %43 = bitcast i8* %pd.1 to i32*
...
if.then159:                                       ; preds = %if.end156
  %50 = bitcast i8* %pb.1 to i32*
  %51 = load i32, i32* %50, align 4
  %52 = bitcast i8* %pc.1 to i32*
  %53 = load i32, i32* %52, align 4
  %54 = bitcast i8* %pb.1 to i32*
  store i32 %53, i32* %54, align 4
  %55 = bitcast i8* %pc.1 to i32*
...
if.else212:                                       ; preds = %if.else203
  ...
  %add.ptr215 = getelementptr inbounds i8, i8* %pl.2, i64 %idx.neg214
  call void @swapfunc(i8* %pl.2, i8* %add.ptr215, i32 %conv213, i32 %cond4, i32 %cond17)
  br label %for.inc218
...
if.then247:                                       ; preds = %cond.end243
  ...
  %add.ptr250 = getelementptr inbounds i8, i8* %pb.1, i64 %idx.neg249
  call void @swapfunc(i8* %a.addr.0, i8* %add.ptr250, i32 %conv248, i32 %cond4, i32 %cond17)
  br label %if.end251
...
if.then274:                                       ; preds = %cond.end270
  ...
  %add.ptr277 = getelementptr inbounds i8, i8* %add.ptr227, i64 %idx.neg276
  call void @swapfunc(i8* %pb.1, i8* %add.ptr277, i32 %conv275, i32 %cond4, i32 %cond17)
  br label %if.end278

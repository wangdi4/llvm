...
; because the backward pivot loop has incorrect swapping operation.
; This is the same test as specqsort09.ll, but does not require asserts.
...
if.then136:                                       ; preds = %if.then133
  %38 = bitcast i8* %pd.1 to i64*
  %39 = load i64, i64* %38, align 8
  %40 = bitcast i8* %pc.1 to i64*

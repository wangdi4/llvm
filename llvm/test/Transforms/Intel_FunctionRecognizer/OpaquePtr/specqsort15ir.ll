...
; because it has a malformed first two ptr comp block.
; This is the same test as specqsort15.ll, but does not require asserts.
...
if.end278:                                        ; preds = %if.then274, %cond.end270
  ...
  %sub.ptr.sub281 = add i64 %sub.ptr.lhs.cast279, %sub.ptr.rhs.cast280

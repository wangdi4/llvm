...
; because it has a malformed second two ptr comp block.
; This is the same test as specqsort17.ll, but does not require asserts.
...
if.end286:                                        ; preds = %if.then284, %if.end278
  ...
  %sub.ptr.sub289 = mul i64 %sub.ptr.lhs.cast287, %sub.ptr.rhs.cast288

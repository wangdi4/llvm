...
; Test that @swapfunc is not recognized as a qsort swapfunc(), as it has the
; wrong constants in the switch tests.
; This is the same test as swapfunc03.ll, but does not require asserts.

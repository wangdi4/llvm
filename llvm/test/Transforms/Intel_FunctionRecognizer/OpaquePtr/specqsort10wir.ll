...
; because it has a malformed test in the second insertion sort.
; This is the same test as specqsort10w.ll, but does not require asserts.
...
if.then80:                                        ; preds = %if.end77
  ...
  store i32 %i17, ptr %i18, align 4
  %i19 = bitcast ptr %pm.2 to ptr
  store i32 %i15, ptr %i19, align 4
  br label %if.end90
...
if.then108:                                       ; preds = %if.then105
  ...
  store i32 %i29, ptr %i30, align 4
  %i31 = bitcast ptr %pb.1 to ptr
  store i32 %i27, ptr %i31, align 4
  br label %if.end118
...
if.then159:                                       ; preds = %if.end156
  ...
  store i32 %i53, ptr %i54, align 4
  %i55 = bitcast ptr %pc.1 to ptr
  store i32 %i51, ptr %i55, align 4
  br label %if.end169

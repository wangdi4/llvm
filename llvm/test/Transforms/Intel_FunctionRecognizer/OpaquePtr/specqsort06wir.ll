...
; because the first easy swap has a bad comparsion test and misordered
; swap block.
; This is the same test as specqsort06w.ll, but does not require asserts.

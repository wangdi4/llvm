...
; because it has a malformed second vecswap computation.

; CHECK: FXNREC: SPEC_QSORT: spec_qsort: No second vecswap.
...
if.then274:                                       ; preds = %cond.end270
  ...
  call void @swapfunc(ptr %pb.1, ptr %add.ptr276, i32 %conv277, i32 %cond4, i32 %conv277)
  br label %if.end278

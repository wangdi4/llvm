...
; because it has a malformed iterative call block.
; This is the same test as specqsort18w.ll, but does not require asserts.
...
if.then292:                                       ; preds = %if.end286
  %idx.neg293 = add i64 0, %sub.ptr.sub289

...
; RUN: opt -passes=sycl-kernel-vec-clone -sycl-vector-variant-isa-encoding-override=AVX512Core -sycl-vect-info=%p/../Inputs/VectInfo64.gen %s -S -o - | FileCheck -check-prefixes=CHECK,COMMON %s
; RUN: opt -passes=sycl-kernel-vec-clone -sycl-vector-variant-isa-encoding-override=AVX2 -sycl-vect-info=%p/../Inputs/VectInfo64.gen %s -S -o - | FileCheck -check-prefixes=CHECK,COMMON %s
; RUN: opt -passes=sycl-kernel-vec-clone -sycl-vector-variant-isa-encoding-override=AVX1 -sycl-vect-info=%p/../Inputs/VectInfo64.gen %s -S -o - | FileCheck -check-prefixes=AVX1_SSE,COMMON %s
; RUN: opt -passes=sycl-kernel-vec-clone -sycl-vector-variant-isa-encoding-override=SSE42 -sycl-vect-info=%p/../Inputs/VectInfo64.gen %s -S -o - | FileCheck -check-prefixes=AVX1_SSE,COMMON %s

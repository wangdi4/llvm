...
; CHECK: = call spir_func <32 x i32> @_Z20work_group_broadcastDv32_ij(<32 x i32> %wide.load, i32 0)
  %call4 = tail call spir_func i32 @_Z20work_group_broadcastijj(i32 %0, i32 0, i32 0) #4
; CHECK: = call spir_func <32 x i32> @_Z20work_group_broadcastDv32_ijj(<32 x i32> %wide.load, i32 0, i32 0)
  %call5 = tail call spir_func i32 @_Z20work_group_broadcastijjj(i32 %0, i32 0, i32 0, i32 0) #4
; CHECK: = call spir_func <32 x i32> @_Z20work_group_broadcastDv32_ijjj(<32 x i32> %wide.load, i32 0, i32 0, i32 0)
...
; CHECK: = call spir_func <32 x i32> @_Z21work_group_reduce_mulDv32_i(<32 x i32> %wide.load)
; CHECK: = call spir_func <32 x i32> @_Z29work_group_scan_exclusive_mulDv32_i(<32 x i32> %wide.load)
; CHECK: = call spir_func <32 x i32> @_Z29work_group_scan_inclusive_mulDv32_i(<32 x i32> %wide.load)

  %conv = trunc i32 %0 to i16
; CHECK: [[WIDE_LOAD_i16:%.*]] = trunc <32 x i32> %wide.load to <32 x i16>
...
; CHECK: call spir_func <32 x i16> @_Z29work_group_reduce_bitwise_andDv32_t(<32 x i16> [[WIDE_LOAD_i16]])
; CHECK: call spir_func <32 x i32> @_Z28work_group_reduce_bitwise_orDv32_i(<32 x i32> %wide.load)
; CHECK: call spir_func <32 x i64> @_Z29work_group_reduce_bitwise_xorDv32_l(<32 x i64> [[WIDE_LOAD_i64]])
; CHECK: call spir_func <32 x i32> @_Z29work_group_reduce_logical_andDv32_i(<32 x i32> %wide.load)
; CHECK: call spir_func <32 x i32> @_Z28work_group_reduce_logical_orDv32_i(<32 x i32> %wide.load)
; CHECK: call spir_func <32 x i32> @_Z29work_group_reduce_logical_xorDv32_i(<32 x i32> %wide.load)

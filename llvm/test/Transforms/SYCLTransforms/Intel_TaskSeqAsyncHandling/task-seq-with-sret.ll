...
; CHECK: call i64 @"_Z31__spirv_TaskSequenceCreateINTELPU3AS456class.sycl::_V1::ext::intel::experimental::task_sequenceU13block_pointerFvvEi.1"(ptr addrspace(4) %ts_func2Struct.ascast.i, ptr @_Z15function2StructIN4sycl3_V13ext5intel4pipeI8my_pipe1fLi12EEEE14FunctionPacketb, i32 0)
...
; CHECK: call void @"_Z30__spirv_TaskSequenceAsyncINTELPU3AS456class.sycl::_V1::ext::intel::experimental::task_sequenceU13block_pointerFvvElib"(ptr addrspace(4) %ts_func2Struct.ascast.i, ptr @_Z15function2StructIN4sycl3_V13ext5intel4pipeI8my_pipe1fLi12EEEE14FunctionPacketb, i64 {{.*}}, i32 12, i1 {{.*}})

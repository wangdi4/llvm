...
; Check every task function generates one __spirv_TaskSequenceCreateINTEL*
...
; CHECK: call i64 [[CREATE1:@"_Z31__spirv_TaskSequenceCreateINTELPU3AS456class.sycl::_V1::ext::intel::experimental::task_sequenceU13block_pointerFvvEi.[0-9]+"]](ptr addrspace(4) %ts_func2Array.ascast.i, ptr @_Z14function2ArrayIN4sycl3_V13ext5intel4pipeI8my_pipe2fLi12EEEE9FixedVectIfLi2EEb, i32 0)
...
; CHECK: call i64 [[CREATE2:@"_Z31__spirv_TaskSequenceCreateINTELPU3AS456class.sycl::_V1::ext::intel::experimental::task_sequenceU13block_pointerFvvEi.[0-9]+"]](ptr addrspace(4) %ts_func2Struct.ascast.i, ptr @_Z15function2StructIN4sycl3_V13ext5intel4pipeI8my_pipe1fLi12EEEE14FunctionPacketb, i32 0)
...
; CHECK-NEXT: call void [[ASYNC1:@"_Z30__spirv_TaskSequenceAsyncINTELPU3AS456class.sycl::_V1::ext::intel::experimental::task_sequenceU13block_pointerFvvElib"]](ptr addrspace(4) %ts_func2Array.ascast.i, ptr @_Z14function2ArrayIN4sycl3_V13ext5intel4pipeI8my_pipe2fLi12EEEE9FixedVectIfLi2EEb, i64 0, i32 0, i1 true)
...
; CHECK-NEXT: call void [[ASYNC2:@"_Z30__spirv_TaskSequenceAsyncINTELPU3AS456class.sycl::_V1::ext::intel::experimental::task_sequenceU13block_pointerFvvElib.[0-9]+]]"(ptr addrspace(4) %ts_func2Struct.ascast.i, ptr @_Z15function2StructIN4sycl3_V13ext5intel4pipeI8my_pipe1fLi12EEEE14FunctionPacketb, i64 0, i32 0, i1 true)
  ret void
}

; CHECK: define internal i64 [[CREATE]](ptr addrspace(4) %0, ptr %1, i32 %2) {
; CHECK: call ptr @__create_task_sequence(i64 0)
; CHECK: define internal void [[ASYNC]]

; CHECK: define internal void [[ASYNC1]]
; CHECK: define internal i64 [[CREATE1]](ptr addrspace(4) %0, ptr %1, i32 %2) {
; CHECK: call ptr @__create_task_sequence(i64 8)

; CHECK: define internal void [[ASYNC2]]
; CHECK: define internal i64 [[CREATE2]](ptr addrspace(4) %0, ptr %1, i32 %2) {
; CHECK: call ptr @__create_task_sequence(i64 8)

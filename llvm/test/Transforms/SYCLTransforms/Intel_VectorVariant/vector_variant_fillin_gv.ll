...
; CHECK: @"B_foo$SIMDTable" = weak global [2 x ptr] [ptr @_ZGVbM8vv_B_foo, ptr @_ZGVbN8vv_B_foo]
; CHECK: @"A_foo$SIMDTable" = weak global [2 x ptr] [ptr @_ZGVbM8vv_A_foo, ptr @_ZGVbN8vv_A_foo]
...
declare <2 x i32> @_ZGVbM8vv_A_foo(ptr addrspace(4) %this, <2 x i32> %X);
declare <2 x i32> @_ZGVbN8vv_A_foo(ptr addrspace(4) %this, <2 x i32> %X);
declare <2 x i32> @_ZGVbM8vv_B_foo(ptr addrspace(4) %this, <2 x i32> %X);
declare <2 x i32> @_ZGVbN8vv_B_foo(ptr addrspace(4) %this, <2 x i32> %X);

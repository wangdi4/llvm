...
%struct.kmp_local_state = type { [256 x i8], ptr addrspace(4), ptr addrspace(4), i32, i16, i16, i16, %struct.kmp_shared_data, %structtype.0, i16 }
%struct.kmp_thread_state = type { %struct.kmp_team_state, [256 x %struct.kmp_task_state], [8 x [256 x %struct.kmp_task_state]], [256 x ptr addrspace(4)], %union.anon.2, [256 x i32], [256 x i64], [256 x i64], [256 x i64], [256 x i64], i64 }
%struct.kmp_team_state = type { %struct.kmp_task_state, %struct.kmp_task_state }
%struct.kmp_task_state = type { %struct.anon, %struct.anon.0, ptr addrspace(4) }
%struct.anon = type { i64, i64, i64, i64, i32 }
%struct.anon.0 = type { i8, i8, i16, i16, i16, i16, i64 }
%union.anon.2 = type { [256 x i16] }
%struct.kmp_shared_data = type { [64 x ptr addrspace(4)], i32 }
...
@__omp_offloading_entries_table = local_unnamed_addr addrspace(2) constant [1 x %struct.__tgt_offload_entry] [%struct.__tgt_offload_entry { ptr addrspace(4) null, ptr addrspace(2) @.omp_offloading.entry_name, i64 0, i32 0, i32 0, i64 74 }]
...
; Function Attrs: nounwind
define internal fastcc void @_Z24calcBoxBlurFloatLocal_V2PfS_iiii(ptr addrspace(4) nocapture %0, ptr addrspace(4) nocapture readonly %1, i32 %2, i32 %3, i32 %4) #0 !recommended_vector_length !1 !kernel_arg_base_type !3 !arg_type_null_val !4 {
  ret void
}

; Function Attrs: nounwind
define void @__omp_offloading_f66006ff_1a664__ZN17BoxBlurFloatLocal15execute_offloadEi_l565(ptr addrspace(1) %0, ptr addrspace(1) %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6) #0 !recommended_vector_length !1 !kernel_arg_base_type !3 !arg_type_null_val !4 {
  %8 = addrspacecast ptr addrspace(1) %0 to ptr addrspace(4)
  %9 = addrspacecast ptr addrspace(1) %1 to ptr addrspace(4)
  %10 = trunc i64 %3 to i32
  %11 = trunc i64 %2 to i32
  %12 = tail call i64 @_Z13get_global_idj(i32 0)
  %13 = trunc i64 %12 to i32
  %14 = shl nsw i32 %13, 2
  tail call fastcc void @_Z24calcBoxBlurFloatLocal_V2PfS_iiii(ptr addrspace(4) nocapture %8, ptr addrspace(4) nocapture readonly %9, i32 %10, i32 %11, i32 %14) #3
  ret void
}
...
!0 = !{ptr @__omp_offloading_f66006ff_1a664__ZN17BoxBlurFloatLocal15execute_offloadEi_l565}
!1 = !{i32 16}
!2 = !{i32 4, i32 200000}
!3 = !{!"float*", !"float*", !"int", !"int", !"int"}
!4 = !{ptr addrspace(4) null, ptr addrspace(4) null, i32 0, i32 0, i32 0}

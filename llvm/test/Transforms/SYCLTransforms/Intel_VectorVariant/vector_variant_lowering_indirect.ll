...
define dso_local i32 @_Z3barPii(ptr nocapture readnone %a, i32 %n) {
entry:
  %foo_simd = alloca %"class.cl::sycl::intel::SimdFunction", align 8
  %0 = bitcast ptr %foo_simd to ptr
  %1 = tail call ptr @__intel_create_simd_variant_p0f_i32i32f32f.p0f_i32i32f32f(ptr nonnull @_Z3fooif) #0
  %2 = tail call ptr @__intel_create_simd_variant_p0f_i32i32f32f.p0f_i32i32f32f(ptr nonnull @_Z3fooif) #1
...
omp.inner.for.body:                               ; preds = %omp.inner.for.body, %DIR.OMP.SIMD.1
  ...
  %5 = call i32 (ptr, ...) @__intel_indirect_call_i32(ptr %call.i, i32 5, float 2.000000e+00) #2
; CHECK: call i32 (ptr, ...) @__intel_indirect_call_i32(ptr %call.i, i32 5, float 2.000000e+00) #[[ATTRS1:.*]]
...
declare ptr @__intel_create_simd_variant_p0f_i32i32f32f.p0f_i32i32f32f(ptr)

declare i32 @__intel_indirect_call_i32(ptr, ...)

attributes #0 = { nounwind "vector-variant"="_ZGV_unknown_N0lu__Z3fooif" }
attributes #1 = { nounwind "vector-variant"="_ZGV_unknown_M0vv__Z3fooif" }
attributes #2 = { nounwind "vector-variants"="_ZGVeN2vv___intel_indirect_call_i32,_ZGVeM2vv___intel_indirect_call_i32,_ZGVcN2vv___intel_indirect_call_i32,_ZGVcM2vv___intel_indirect_call_i32,_ZGVbN2vv___intel_indirect_call_i32,_ZGVbM2vv___intel_indirect_call_i32" }

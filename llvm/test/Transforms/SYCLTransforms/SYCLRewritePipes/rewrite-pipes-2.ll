...
; CHECK-DAG: @_ZN2cl4sycl4pipeIZ4mainE9some_pipe_0iLi1EE9m_StorageE.syclpipe = addrspace(1) global %opencl.pipe_rw_t addrspace(1)* null, align 8, !packet_size ![[PACKET:[0-9]+]], !packet_align ![[PACKET]], !depth ![[DEPTH1:[0-9]+]], !io ![[IO:[0-9]+]]
; CHECK-DAG: @_ZN2cl4sycl4pipeIZ4mainE9some_pipe_0iLi1EE9m_StorageE.syclpipe.bs = addrspace(1) global [328 x i8] zeroinitializer, align 4
; CHECK-DAG: @_ZN2cl4sycl4pipeIN4some4pipeEiLi1EE9m_StorageE.syclpipe = addrspace(1) global %opencl.pipe_rw_t addrspace(1)* null, align 8, !packet_size ![[PACKET]], !packet_align ![[PACKET]], !depth ![[DEPTH1]], !io ![[IO]]
; CHECK-DAG: @_ZN2cl4sycl4pipeIN4some4pipeEiLi1EE9m_StorageE.syclpipe.bs = addrspace(1) global [328 x i8] zeroinitializer, align 4
; CHECK-DAG: @"_ZN2cl4sycl4pipeIZZZ4mainENK3$_2clERNS0_7handlerEENKUlNS0_2idILi1EEEE_clES6_E9some_pipeiLi1EE9m_StorageE.syclpipe" = addrspace(1) global %opencl.pipe_rw_t addrspace(1)* null, align 8, !packet_size ![[PACKET]], !packet_align ![[PACKET]], !depth ![[DEPTH1]], !io ![[IO]]
; CHECK-DAG: @"_ZN2cl4sycl4pipeIZZZ4mainENK3$_2clERNS0_7handlerEENKUlNS0_2idILi1EEEE_clES6_E9some_pipeiLi1EE9m_StorageE.syclpipe.bs" = addrspace(1) global [328 x i8] zeroinitializer, align 4
; CHECK-DAG: @"_ZN2cl4sycl4pipeIZZZ4mainENK3$_3clERNS0_7handlerEENKUlNS0_2idILi1EEEE_clES6_E9some_pipeiLi1EE9m_StorageE.syclpipe" = addrspace(1) global %opencl.pipe_rw_t addrspace(1)* null, align 8, !packet_size ![[PACKET]], !packet_align ![[PACKET]], !depth ![[DEPTH1]], !io ![[IO]]
; CHECK-DAG: @"_ZN2cl4sycl4pipeIZZZ4mainENK3$_3clERNS0_7handlerEENKUlNS0_2idILi1EEEE_clES6_E9some_pipeiLi1EE9m_StorageE.syclpipe.bs" = addrspace(1) global [328 x i8] zeroinitializer, align 4
; CHECK-DAG: @_ZN2cl4sycl4pipeIZ4mainE21pipe_type_for_lambdasiLi0EE9m_StorageE.syclpipe = addrspace(1) global %opencl.pipe_rw_t addrspace(1)* null, align 8, !packet_size ![[PACKET]], !packet_align ![[PACKET]], !depth ![[DEPTH2:[0-9]+]], !io ![[IO]]
; CHECK-DAG: @_ZN2cl4sycl4pipeIZ4mainE21pipe_type_for_lambdasiLi0EE9m_StorageE.syclpipe.bs = addrspace(1) global [328 x i8] zeroinitializer, align 4
; CHECK-DAG: @_ZN2cl4sycl4pipeIZ4mainE9some_pipeiLi1EE9m_StorageE.syclpipe = addrspace(1) global %opencl.pipe_rw_t addrspace(1)* null, align 8, !packet_size ![[PACKET]], !packet_align ![[PACKET]], !depth ![[DEPTH1]], !io ![[IO]]
; CHECK-DAG: @_ZN2cl4sycl4pipeIZ4mainE9some_pipeiLi1EE9m_StorageE.syclpipe.bs = addrspace(1) global [328 x i8] zeroinitializer, align 4
...
; CHECK: call spir_func %opencl.pipe_wo_t addrspace(1)* @_Z39__spirv_CreatePipeFromPipeStorage_writePU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST1]])
  ret void
}
...
; CHECK: call spir_func %opencl.pipe_ro_t addrspace(1)* @_Z38__spirv_CreatePipeFromPipeStorage_readPU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %3)
  ret i32 0
}
...
; CHECK: call spir_func %opencl.pipe_wo_t addrspace(1)* @_Z39__spirv_CreatePipeFromPipeStorage_writePU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST3]])
  ret void
}
...
; CHECK: call spir_func %opencl.pipe_ro_t addrspace(1)* @_Z38__spirv_CreatePipeFromPipeStorage_readPU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST4]])
  ret i32 0
}
...
; CHECK: call spir_func %opencl.pipe_wo_t addrspace(1)* @_Z39__spirv_CreatePipeFromPipeStorage_writePU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST5]])
  ret void
}
...
; CHECK: call spir_func %opencl.pipe_ro_t addrspace(1)* @_Z38__spirv_CreatePipeFromPipeStorage_readPU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST6]])
  ret i32 0
}
...
; CHECK: call spir_func %opencl.pipe_wo_t addrspace(1)* @_Z39__spirv_CreatePipeFromPipeStorage_writePU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST7]])
  ret void
}
...
; CHECK: call spir_func %opencl.pipe_ro_t addrspace(1)* @_Z38__spirv_CreatePipeFromPipeStorage_readPU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST8]])
  ret i32 0
}
...
; CHECK: call spir_func %opencl.pipe_wo_t addrspace(1)* @_Z39__spirv_CreatePipeFromPipeStorage_writePU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST9]])
  ret void
}
...
; CHECK: call spir_func %opencl.pipe_ro_t addrspace(1)* @_Z38__spirv_CreatePipeFromPipeStorage_readPU3AS427__spirv_ConstantPipeStorage(%struct._ZTS19ConstantPipeStorage.ConstantPipeStorage addrspace(4)* %[[CAST10]])
  ret i32 0
}

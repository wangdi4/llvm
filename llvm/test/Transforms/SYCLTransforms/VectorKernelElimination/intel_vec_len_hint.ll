...
for.body:                                         ; preds = %for.body, %entry
  ...
  %0 = load i64, i64 addrspace(1)* %arrayidx, align 8, !tbaa !12
  %arrayidx4 = getelementptr inbounds i64, i64 addrspace(1)* %dst, i64 %add
  store i64 %0, i64 addrspace(1)* %arrayidx4, align 8, !tbaa !12
  %1 = load i64, i64 addrspace(1)* %arrayidx, align 8, !tbaa !12
  %arrayidx12 = getelementptr inbounds i64, i64 addrspace(1)* %dst2, i64 %add
  store i64 %1, i64 addrspace(1)* %arrayidx12, align 8, !tbaa !12
...
; Function Attrs: convergent norecurse nounwind
define dso_local void @_ZGVbN4uuu_test(i64 addrspace(1)* noundef align 8 %dst, i64 addrspace(1)* noundef align 8 %dst2, i64 addrspace(1)* noundef align 8 %src) local_unnamed_addr #2 !kernel_arg_addr_space !1 !kernel_arg_access_qual !2 !kernel_arg_type !3 !kernel_arg_base_type !3 !kernel_arg_type_qual !4 !kernel_arg_name !5 !kernel_arg_host_accessible !6 !kernel_arg_pipe_depth !7 !kernel_arg_pipe_io !4 !kernel_arg_buffer_location !4 !no_barrier_path !8 !kernel_has_sub_groups !9 !max_wg_dimensions !11 !vectorized_width !16 !intel_vec_len_hint !16 !vectorization_dimension !17 !can_unite_workgroups !8 !scalar_kernel !0 {
entry:
  %call = tail call i64 @_Z13get_global_idj(i32 noundef 0) #5
...
VPlannedBB4:                                      ; preds = %VPlannedBB4, %entry
  ...
  %mm_vectorGEP = getelementptr inbounds i64, <4 x i64 addrspace(1)*> %broadcast.splat9, <4 x i64> %4
  ...
  %mm_vectorGEP12 = getelementptr inbounds i64, <4 x i64 addrspace(1)*> %broadcast.splat11, <4 x i64> %4
  ...
  %mm_vectorGEP16 = getelementptr inbounds i64, <4 x i64 addrspace(1)*> %broadcast.splat15, <4 x i64> %4
...
declare <4 x i64> @llvm.masked.gather.v4i64.v4p1i64(<4 x i64 addrspace(1)*>, i32 immarg, <4 x i1>, <4 x i64>) #3

; Function Attrs: nocallback nofree nosync nounwind willreturn writeonly
declare void @llvm.masked.scatter.v4i64.v4p1i64(<4 x i64>, <4 x i64 addrspace(1)*>, i32 immarg, <4 x i1>) #4
...
!8 = !{i1 true}
!9 = !{i1 false}
!10 = !{void (i64 addrspace(1)*, i64 addrspace(1)*, i64 addrspace(1)*)* @_ZGVbN4uuu_test}
!11 = !{i32 1}
!12 = !{!13, !13, i64 0}
!13 = !{!"long", !14, i64 0}

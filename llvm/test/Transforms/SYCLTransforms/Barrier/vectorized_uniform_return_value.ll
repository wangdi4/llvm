...
define dso_local void @test(ptr addrspace(1) noalias %m) !vectorized_kernel !15 !no_barrier_path !9 {
  ret void
}
...
"Barrier BB5":                                    ; preds = %entry
  ...
  %CallWGForItem = call <4 x i32> @_Z21work_group_reduce_addDv4_jPS_(<4 x i32> %0, ptr %AllocaWGResult) #15
...
; CHECK-NEXT: store <4 x i32> [[FINALIZE_RES]], ptr [[FINALIZE_RES_ADDR:%.*]], align 16
  store <4 x i32> zeroinitializer, ptr %AllocaWGResult, align 16
...
"Barrier BB":                                     ; preds = %"Barrier BB4"
  call void @_Z18work_group_barrierj(i32 1)
; CHECK-LABEL: RetBB:
; CHECK-NEXT: [[LOADED2:%.*]] = load <4 x i32>, ptr [[FINALIZE_RES_ADDR]]
; CHECK-NEXT: ret <4 x i32> [[LOADED2]]
  ret <4 x i32> %CallFinalizeWG
}

; Function Attrs: convergent norecurse nounwind
define dso_local void @_ZGVbN4u_test(ptr addrspace(1) noalias %m) local_unnamed_addr #3 !no_barrier_path !9 !vectorized_kernel !6 !scalar_kernel !4 !vectorized_width !8 !kernel_execution_length !18 !no_barrier_path !9 !vectorization_dimension !14 {
entry:
  call void @dummy_barrier.()
...
"Barrier BB3":                                    ; preds = %"Barrier BB2"
  ...
  store i32 %.extract.3., ptr addrspace(1) %m, align 4
  br label %"Barrier BB"
...
declare <4 x i32> @llvm.masked.load.v4i32.p0(ptr, i32 immarg, <4 x i1>, <4 x i32>) #6

; Function Attrs: convergent
declare <4 x i32> @_Z21work_group_reduce_addDv4_jS_(<4 x i32>, <4 x i32>) local_unnamed_addr #1

; Function Attrs: argmemonly nofree nosync nounwind willreturn writeonly
declare void @llvm.masked.store.v4i32.p0(<4 x i32>, ptr, i32 immarg, <4 x i1>) #7
...
declare void @llvm.masked.scatter.v4i32.v4p1(<4 x i32>, <4 x ptr addrspace(1)>, i32 immarg, <4 x i1>) #8
...
declare i32 @_Z21work_group_reduce_addjPj(i32, ptr nocapture) #10

; Function Attrs: convergent
declare void @_Z18work_group_barrierj(i32) #11

; Function Attrs: nofree norecurse nounwind willreturn
declare <4 x i32> @_Z21work_group_reduce_addDv4_jS_PS_(<4 x i32>, <4 x i32>, ptr nocapture) #12

; Function Attrs: norecurse nounwind readnone willreturn
declare <4 x i32> @_Z32__finalize_work_group_reduce_addDv4_jS_(<4 x i32>, <4 x i32>) #13

; Function Attrs: nofree norecurse nounwind willreturn
declare <4 x i32> @_Z21work_group_reduce_addDv4_jPS_(<4 x i32>, ptr nocapture) #12
...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function _ZGVbN4v_foo --  %pSB = call ptr @get_special_buffer.()
...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function _ZGVbN4u_test --  %pSB = call ptr @get_special_buffer.()

...
@star_arr = addrspace(1) global [3 x [2 x target("spirv.Channel")]] zeroinitializer, align 4, !packet_size !1, !packet_align !0
...
entry:
  ...
  %2 = load ptr addrspace(1), ptr addrspace(1) getelementptr inbounds ([3 x [2 x target("spirv.Channel")]], ptr addrspace(1) @star_arr, i64 0, i64 2, i64 1), align 4, !tbaa !10
  ...
  %5 = load ptr addrspace(1), ptr addrspace(1) getelementptr inbounds ([3 x [2 x target("spirv.Channel")]], ptr addrspace(1) @star_arr, i64 0, i64 2, i64 1), align 4, !tbaa !10

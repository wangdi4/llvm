...
@far_arr = addrspace(1) global [5 x [4 x target("spirv.Channel")]] zeroinitializer, align 1, !packet_size !2, !packet_align !2, !depth !3
@star_arr = addrspace(1) global [5 x [4 x [3 x target("spirv.Channel")]]] zeroinitializer, align 8, !packet_size !4, !packet_align !5
...
entry:
  ...
  %7 = load ptr addrspace(1), ptr addrspace(1) getelementptr inbounds ([5 x [4 x target("spirv.Channel")]], ptr addrspace(1) @far_arr, i64 0, i64 3, i64 2), align 1, !tbaa !14
  %8 = load i8, ptr %f, align 1, !tbaa !14
  call void @_Z19write_channel_intel11ocl_channelcc(ptr addrspace(1) %7, i8 noundef signext %8) #5
  %9 = load ptr addrspace(1), ptr addrspace(1) getelementptr inbounds ([5 x [4 x [3 x target("spirv.Channel")]]], ptr addrspace(1) @star_arr, i64 0, i64 3, i64 2, i64 1), align 8, !tbaa !14

...
entry:
  ...
  %1 = load ptr addrspace(1), ptr addrspace(1) getelementptr inbounds ([3 x [2 x target("spirv.Channel")]], ptr addrspace(1) @star_arr, i64 0, i64 2, i64 1), align 4, !tbaa !6
  ...
  %3 = load ptr addrspace(1), ptr addrspace(1) getelementptr inbounds ([3 x [2 x target("spirv.Channel")]], ptr addrspace(1) @star_arr, i64 0, i64 2, i64 1), align 4, !tbaa !6

; This test checks channel write functions transformation when type-coerced struct is passed as argument.
...
%struct.TS = type { i32, [12 x i8] }
%struct.TS.coerce = type { i64, i64 }

@chan = addrspace(1) global target("spirv.Channel") zeroinitializer, align 4, !packet_size !0, !packet_align !1

; CHECK: %struct.channelpipetransformation.merge = type { i64, i64 }

; Function Attrs: convergent norecurse nounwind
define dso_local void @writer(ptr addrspace(1) noundef align 4 %src) #0 !kernel_arg_addr_space !6 !kernel_arg_access_qual !7 !kernel_arg_type !8 !kernel_arg_base_type !8 !kernel_arg_type_qual !9 !kernel_arg_host_accessible !10 !kernel_arg_pipe_depth !11 !kernel_arg_pipe_io !9 !kernel_arg_buffer_location !9 !arg_type_null_val !12 {
entry:
  %src.addr = alloca ptr addrspace(1), align 8
  %byval-temp = alloca %struct.TS, align 4
  store ptr addrspace(1) %src, ptr %src.addr, align 8, !tbaa !13
  %0 = load ptr addrspace(1), ptr addrspace(1) @chan, align 4, !tbaa !17
  %1 = load ptr addrspace(1), ptr %src.addr, align 8, !tbaa !13
  call void @llvm.lifetime.start.p0(i64 16, ptr %byval-temp) #4
  call void @llvm.memcpy.p0.p1.i64(ptr align 4 %byval-temp, ptr addrspace(1) align 4 %1, i64 16, i1 false), !tbaa.struct !18
  ...
  ; CHECK-NEXT: store i64 [[SRC1:%[a-zA-Z0-9]+]], ptr [[GEP1]]
  ...
  call void @_Z19write_channel_intel11ocl_channel2TSS_(ptr addrspace(1) %0, i64 %3, i64 %5)
...
declare void @___Z19write_channel_intel11ocl_channel2TSS__before.CoerceTypes(ptr addrspace(1), ptr noundef byval(%struct.TS) align 4) #3

; Function Attrs: convergent nounwind
declare void @_Z19write_channel_intel11ocl_channel2TSS_(ptr addrspace(1), i64, i64) #3
...
!16 = !{!"Simple C/C++ TBAA"}
!17 = !{!15, !15, i64 0}
!18 = !{i64 0, i64 4, !19, i64 4, i64 12, !17}
!19 = !{!20, !20, i64 0}
!20 = !{!"int", !15, i64 0}

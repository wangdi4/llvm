...
; RUN: opt -opaque-pointers=0 -sycl-kernel-builtin-lib=%t.rtl.bc -passes=sycl-kernel-channel-pipe-transformation -S %s -o - | FileCheck %s
...
@chan = common addrspace(1) global %opencl.channel_t addrspace(1)* null, align 4, !packet_size !0, !packet_align !1
...
entry:
  ...
  %0 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @chan, align 4
  ...
  ; CHECK-NEXT: store i64 [[SRC1:%[a-zA-Z0-9]+]], i64* [[GEP1]]
  ...
  call void @_Z19write_channel_intel11ocl_channel2TSS_(%opencl.channel_t addrspace(1)* %0, i64 %6, i64 %8)
  ret void
}

; Function Attrs: convergent
declare void @_Z19write_channel_intel11ocl_channel2TSS_(%opencl.channel_t addrspace(1)* %0, i64 %1, i64 %2) #2

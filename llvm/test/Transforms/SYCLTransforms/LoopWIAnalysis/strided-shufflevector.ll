...
; CHECK-NEXT:   RND    %broadcast.splatinsertvector_func = insertelement <16 x i32> zeroinitializer, i32 %dim_0_vector_ind_var, i64 0
; CHECK-NEXT:   STR    %broadcast.splatvector_func = shufflevector <16 x i32> %broadcast.splatinsertvector_func, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer
...
; CHECK-NEXT:   UNI  i32 16
; CHECK-NEXT: StrideIntermediate:
; CHECK-NEXT:   %broadcast.splatinsertvector_func = insertelement <16 x i32> zeroinitializer, i32 %dim_0_vector_ind_var, i64 0
...
; CHECK-NEXT:   i32 16    %broadcast.splatvector_func = shufflevector <16 x i32> %broadcast.splatinsertvector_func, <16 x i32> zeroinitializer, <16 x i32> zeroinitializer
; CHECK-NEXT:   i32 16    %broadcast.splatinsertvector_func = insertelement <16 x i32> zeroinitializer, i32 %dim_0_vector_ind_var, i64 0

...
define dso_local void @test(i32 addrspace(1)* noundef align 4 %data1, i32 addrspace(1)* noundef align 4 %data2, i32 addrspace(1)* noundef align 4 %data3) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 !kernel_arg_name !8 !kernel_arg_host_accessible !9 !kernel_arg_pipe_depth !10 !kernel_arg_pipe_io !7 !kernel_arg_buffer_location !7 !arg_type_null_val !11 !no_barrier_path !12 !kernel_has_sub_groups !12 !kernel_has_global_sync !12 !kernel_execution_length !13 {
entry:
  %call = tail call i32 @_Z21work_group_reduce_addi(i32 noundef 3) #3
  store i32 %call, i32 addrspace(1)* %data1, align 4, !tbaa !14
  %call1 = tail call i32 @_Z29work_group_scan_inclusive_addi(i32 noundef 3) #3
  store i32 %call1, i32 addrspace(1)* %data2, align 4, !tbaa !14
  %cast.data = addrspacecast i32 addrspace(1)* %data3 to i32 addrspace(4)*
  tail call void @_Z66__devicelib_default_work_group_joint_sort_ascending_p1i32_u32_p1i8PU3AS4ijPU3AS4c(i32 addrspace(4)* %cast.data, i32 5, i8 addrspace(4)* addrspacecast (i8 addrspace(3)* getelementptr inbounds ([1024 x i8], [1024 x i8] addrspace(3)* @test.scratch, i64 0, i64 0) to i8 addrspace(4)*)) #3
  ret void
}
...
declare void @_Z66__devicelib_default_work_group_joint_sort_ascending_p1i32_u32_p1i8PU3AS4ijPU3AS4c(i32 addrspace(4)*, i32, i8 addrspace(4)*) local_unnamed_addr #2
...
!3 = !{void (i32 addrspace(1)*, i32 addrspace(1)*, i32 addrspace(1)*)* @test}
!4 = !{i32 1, i32 1, i32 1}
!5 = !{!"none", !"none", !"none"}
!6 = !{!"int*", !"int*", !"int*"}
!7 = !{!"", !"", !""}
...
!11 = !{i32 addrspace(1)* null, i32 addrspace(1)* null, i32 addrspace(1)* null}
!12 = !{i1 false}
!13 = !{i32 7}
!14 = !{!15, !15, i64 0}
!15 = !{!"int", !16, i64 0}

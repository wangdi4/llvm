...
define internal void @__enqueue_block_with_local_arg_block_invoke(ptr addrspace(4) %.block_descriptor, ptr addrspace(3) noundef %buf, ptr addrspace(3) noalias %pLocalMemBase, ptr noalias %pWorkDim, ptr noalias %pWGId, [4 x i64] %BaseGlbId, ptr noalias %pSpecialBuf, ptr noalias %RuntimeHandle, ptr noalias %pBufferRanges) {
entry:
  ret void
}

; Function Attrs: convergent
define void @__enqueue_block_with_local_arg_block_invoke_kernel(ptr addrspace(4) %0, ptr addrspace(3) %1, ptr addrspace(3) noalias %pLocalMemBase, ptr noalias %pWorkDim, ptr noalias %pWGId, [4 x i64] %BaseGlbId, ptr noalias %pSpecialBuf, ptr noalias %RuntimeHandle, ptr noalias %pBufferRanges) #0 !arg_type_null_val !2 {
entry:
  ret void
}

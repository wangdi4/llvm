...
declare ptr @_Z10ndrange_2DPm(ptr) nounwind readnone
declare ptr @_Z10ndrange_2DPmPm(ptr, ptr) nounwind readnone
declare ptr @_Z10ndrange_2DPmPmPm(ptr, ptr, ptr) nounwind readnone
...
define void @enqueue_simple_block(ptr addrspace(1) %res) nounwind !kernel_arg_base_type !1 !arg_type_null_val !2 {
  ...
  ; CHECK: %call1 = call ptr @_Z10ndrange_2DPm(ptr %gws)
  ; CHECK: %call2 = call ptr @_Z10ndrange_2DPmPm(ptr %gws, ptr %lws)
  ; CHECK: %call3 = call ptr @_Z10ndrange_2DPmPmPm(ptr %gwo, ptr %gws, ptr %lws)
  %call1 = call ptr @_Z10ndrange_2DPm(ptr %gws) nounwind readnone
  %call2 = call ptr @_Z10ndrange_2DPmPm(ptr %gws, ptr %lws) nounwind readnone
  %call3 = call ptr @_Z10ndrange_2DPmPmPm(ptr %gwo, ptr %gws, ptr %lws) nounwind readnone
  ret void
}

...
define dso_local void @test(ptr addrspace(1) noundef align 4 %results) local_unnamed_addr !kernel_arg_base_type !2 !arg_type_null_val !3 {
entry:
  %0 = load i32, ptr addrspace(1) %results, align 4
...
define internal fastcc void @xyz(ptr addrspace(1) noundef %results) unnamed_addr !recursive_call !1 !kernel_arg_base_type !2 !arg_type_null_val !3 {
entry:
...
define dso_local void @test2(ptr addrspace(1) noundef align 4 %results) local_unnamed_addr !recursive_call !1 !kernel_arg_base_type !2 !arg_type_null_val !3 {
entry:
  tail call fastcc void @xyz(ptr addrspace(1) noundef %results)
  ret void
}

define dso_local void @test3(ptr addrspace(1) noundef align 4 %results) local_unnamed_addr !recursive_call !1 !kernel_arg_base_type !2 !arg_type_null_val !3 {
entry:
  tail call fastcc void @xyz(ptr addrspace(1) noundef %results)
  ret void
}

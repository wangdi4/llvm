...
define void @test_optnone(i32 addrspace(1)* nocapture %out, i32 addrspace(1)* nocapture %in) noinline optnone !no_barrier_path !1 !kernel_has_sub_groups !2 !recommended_vector_length !3 {
...
!0 = !{void (i32 addrspace(1)*, i32 addrspace(1)*)* @test_optnone}
!1 = !{i1 true}
!2 = !{i1 false}
!3 = !{i32 16}

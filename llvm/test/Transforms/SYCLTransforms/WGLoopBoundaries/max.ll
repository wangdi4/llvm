...
define void @max_kernel(ptr addrspace(1) nocapture %dst, i32 %width, i32 %height) nounwind {
...
; DEBUGIFY-COUNT-27: Instruction with empty DebugLoc in function WG.boundaries.max_kernel

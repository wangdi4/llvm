...
; CHECK-NEXT:  [[ZEXT:%[0-9]+]] = zext i32 17 to i64
; CHECK-NEXT:  [[Add1:%[0-9]+]] = add i64 [[ZEXT]], 1
; CHECK-NEXT:  [[CMP1:%[0-9]+]] = icmp ugt i64 [[ZEXT]], [[Add1]]
; CHECK-NEXT:  %upper.bound.correct0 = select i1 [[CMP1]], i64 [[ZEXT]], i64 [[Add1]]
; CHECK-NEXT:  %init.upper.bound0 = add i64 %local.size0, %base.gid0
; CHECK-NEXT:  [[CMP2:%[0-9]+]] = icmp ult i64 %init.upper.bound0, %upper.bound.correct0
; CHECK-NEXT:  %upper.bound0 = select i1 [[CMP2]], i64 %init.upper.bound0, i64 %upper.bound.correct0

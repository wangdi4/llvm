...
define void @testKernel(i32 addrspace(1)* %a, i32 addrspace(1)* %b) !kernel_has_sub_groups !1 !sg_emu_size !2 {
sg.loop.exclude:
...
; CHECK: [[SGLID:%sg.lid.*]] = load i32, i32* [[P_SGLID:%sg.lid.ptr.*]]
...
; CHECK-NEXT: [[SGLID_ADD1:%.*]] = add i64 [[SGLID_EXT1]], [[LID]]
  ...
  %0 = getelementptr <16 x i64>, <16 x i64>* %w.call1, i32 0, i32 %sg.lid.1
  store i64 %call1, i64* %0, align 8
; _Z22get_sub_group_local_idv() will be resolved
; CHECK-NOT: call i32 @_Z22get_sub_group_local_idv()
; CHECK: [[GEP:%.*]] = getelementptr <16 x i64>, <16 x i64>* %w.call1, i32 0, i32 [[SGLID]]
; CHECK-NOT: store i64 %call1, i64* [[GEP]], align 8
; The use of LID is replaced with LID+SGLId
; CHECK: store i64 [[SGLID_ADD1]], i64* [[GEP]], align 8

  %call2 = tail call i64 @_Z12get_group_idj(i32 0) #5
  %sg.lid.3 = call i32 @_Z22get_sub_group_local_idv()
  %1 = getelementptr <16 x i64>, <16 x i64>* %w.call2, i32 0, i32 %sg.lid.3
; CHECK-NOT: call i32 @_Z22get_sub_group_local_idv()
; CHECK: getelementptr <16 x i64>, <16 x i64>* %w.call2, i32 0, i32 [[SGLID]]

  store i64 %call2, i64* %1, align 8
  %call3 = tail call i64 @_Z14get_local_sizej(i32 0) #5
  %sg.lid.5 = call i32 @_Z22get_sub_group_local_idv()
  %2 = getelementptr <16 x i64>, <16 x i64>* %w.call3, i32 0, i32 %sg.lid.5
; CHECK-NOT: call i32 @_Z22get_sub_group_local_idv()
; CHECK: getelementptr <16 x i64>, <16 x i64>* %w.call3, i32 0, i32 [[SGLID]]

  store i64 %call3, i64* %2, align 8
  %ptridx = getelementptr inbounds i32, i32 addrspace(1)* %b, i64 %call
; The use of GID is replaced with GID+SGLId
; CHECK-NOT: %ptridx = getelementptr inbounds i32, i32 addrspace(1)* %b, i64 %call
; CHECK: %ptridx = getelementptr inbounds i32, i32 addrspace(1)* %b, i64 [[SGLID_ADD]]

  %3 = load i32, i32 addrspace(1)* %ptridx, align 4
  %sg.lid.6 = call i32 @_Z22get_sub_group_local_idv()
  %4 = getelementptr <16 x i32>, <16 x i32>* %w., i32 0, i32 %sg.lid.6
; CHECK-NOT: call i32 @_Z22get_sub_group_local_idv()
; CHECK: getelementptr <16 x i32>, <16 x i32>* %w., i32 0, i32 [[SGLID]]
  store i32 %3, i32* %4, align 4
  br label %sg.barrier.bb.6

sg.barrier.bb.6:                                  ; preds = %sg.dummy.bb.
  call void @_Z17sub_group_barrierj(i32 1)
  %5 = load <16 x i32>, <16 x i32>* %w., align 64
  ...
  store i32 %8, i32* %u.call4, align 4
  br label %sg.dummy.bb.8

sg.dummy.bb.8:                                    ; preds = %sg.barrier.bb.6
; CHECK-LABEL: sg.dummy.bb.8:
; CHECK: [[SGLID1:%sg.lid.*]] = load i32, i32* [[P_SGLID:%sg.lid.ptr.*]]
  call void @dummy_sg_barrier()
  %sg.lid.2 = call i32 @_Z22get_sub_group_local_idv()
  %9 = getelementptr <16 x i64>, <16 x i64>* %w.call2, i32 0, i32 %sg.lid.2
; CHECK-NOT: call i32 @_Z22get_sub_group_local_idv()
; CHECK: getelementptr <16 x i64>, <16 x i64>* %w.call2, i32 0, i32 [[SGLID1]]

  %10 = load i64, i64* %9, align 8
  %sg.lid.4 = call i32 @_Z22get_sub_group_local_idv()
  %11 = getelementptr <16 x i64>, <16 x i64>* %w.call3, i32 0, i32 %sg.lid.4
; CHECK-NOT: call i32 @_Z22get_sub_group_local_idv()
; CHECK: getelementptr <16 x i64>, <16 x i64>* %w.call3, i32 0, i32 [[SGLID1]]

  %12 = load i64, i64* %11, align 8
  %mul = mul i64 %12, %10
  %sg.lid. = call i32 @_Z22get_sub_group_local_idv()
  %13 = getelementptr <16 x i64>, <16 x i64>* %w.call1, i32 0, i32 %sg.lid.
; CHECK-NOT: call i32 @_Z22get_sub_group_local_idv()
; CHECK: getelementptr <16 x i64>, <16 x i64>* %w.call1, i32 0, i32 [[SGLID1]]

  %14 = load i64, i64* %13, align 8
  %add = add i64 %mul, %14
  %ptridx5 = getelementptr inbounds i32, i32 addrspace(1)* %a, i64 %add
  %15 = load i32, i32* %u.call4, align 4
  store i32 %15, i32 addrspace(1)* %ptridx5, align 4

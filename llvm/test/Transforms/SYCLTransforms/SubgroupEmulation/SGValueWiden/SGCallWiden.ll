...
define void @test(i32 addrspace(1)* noalias %p) !kernel_has_sub_groups !1 !sg_emu_size !2 {
entry:
...
sg.dummy.bb.7:                                    ; preds = %sg.barrier.bb.2
  ...
  store <2 x i32> %vecinit3, <2 x i32>* %.compoundliteral, align 8
...
sg.dummy.bb.6:                                    ; preds = %sg.barrier.bb.1
  call void @dummy_sg_barrier()
  %6 = load i32 addrspace(1)*, i32 addrspace(1)** %p.addr, align 8
  br label %sg.barrier.bb.

sg.barrier.bb.:                                   ; preds = %sg.dummy.bb.6
  call void @_Z17sub_group_barrierj(i32 1)
  %call5 = call i32 @_Z26intel_sub_group_block_readPU3AS1Kj(i32 addrspace(1)* %6)
...
; CHECK: declare <16 x i32> @_Z30intel_sub_group_block_read1_16PU3AS1KjDv16_j(i32 addrspace(1)*, <16 x i32>)
...
declare i32 @_Z26intel_sub_group_block_readPU3AS1Kj(i32 addrspace(1)*) #3

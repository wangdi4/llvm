...
; CHECK-NEXT: %[[#OP1:]] = getelementptr <16 x i32>, ptr %w.ret, i32 0, i32 %[[#OP0]]
; CHECK-NEXT: %[[#OP2:]] = load i32, ptr %u.call, align 4
; CHECK-NEXT: store i32 %[[#OP2]], ptr %[[#OP1]], align 4

; CHECK: sg.dummy.bb.:
; CHECK: call void @_Z17sub_group_barrierj(i32 1)
; CHECK-NEXT: %[[#OP3:]] = load <16 x i32>, ptr %w.ret, align 64

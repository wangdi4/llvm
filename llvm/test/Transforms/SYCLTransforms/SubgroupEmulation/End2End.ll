...
; RUN: opt -opaque-pointers=0 -sycl-vect-info=%p/../Inputs/VectInfo64.gen -passes='sycl-kernel-sg-emu-builtin,sycl-kernel-sg-emu-barrier-propagate,sycl-kernel-sg-emu-barrier-simplify,sycl-kernel-sg-emu-value-widen,sycl-kernel-sg-emu-loop-construct' -S %s | FileCheck %s

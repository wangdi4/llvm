...
define void @__test_const_as_global_separated_args(<4 x float> addrspace(1)* nocapture, %opencl.image2d_t.0 addrspace(1)*, <2 x i32>, i8 addrspace(3)* noalias, { i64, [3 x i64], [3 x i64], [2 x [3 x i64]], [3 x i64], {}*, {}*, [3 x i64], [2 x [3 x i64]], [3 x i64] }* noalias, i64* noalias, [4 x i64], i8* noalias, {}* noalias) !kernel_arg_addr_space !1 !kernel_arg_access_qual !2 !kernel_arg_type !3 !kernel_arg_base_type !4 !kernel_arg_type_qual !5 !kernel_arg_name !6 {
  ret void
}

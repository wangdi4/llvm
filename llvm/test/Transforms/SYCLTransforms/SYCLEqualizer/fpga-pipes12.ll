...
; CHECK: call i32 @__read_pipe_2_fpga({{.*}}, ptr addrspace(4) %[[GL2GEN]], i32 4, i32 4)
; CHECK: %[[LO2GEN:[0-9]+]] = addrspacecast ptr addrspace(3) %{{[0-9]+}} to ptr addrspace(4)
; CHECK-NOT: call i32 @__read_pipe_2_AS3
; CHECK: call i32 @__read_pipe_2_fpga({{.*}}, ptr addrspace(4) %[[LO2GEN]], i32 4, i32 4)
; CHECK: %[[PR2GEN:[0-9]+]] = addrspacecast ptr %{{[0-9]+}} to ptr addrspace(4)
; CHECK-NOT: call i32 @__read_pipe_2_AS0
; CHECK: call i32 @__read_pipe_2_fpga({{.*}}, ptr addrspace(4) %[[PR2GEN]], i32 4, i32 4)
; CHECK-NOT: declare i32 @__read_pipe_2_AS1(ptr addrspace(1), ptr addrspace(1), i32, i32)
; CHECK-NOT: declare i32 @__read_pipe_2_AS3(ptr addrspace(1), ptr addrspace(3), i32, i32)
; CHECK-NOT: declare i32 @__read_pipe_2_AS0(ptr addrspace(1), ptr, i32, i32)
;
; CHECK-LABEL: define dso_local void @test2
; CHECK: %[[GL2GEN:[0-9]+]] = addrspacecast ptr addrspace(1) %{{[0-9]+}} to ptr addrspace(4)
; CHECK-NOT: call i32 @__write_pipe_2_AS1
; CHECK: call i32 @__write_pipe_2_fpga({{.*}}, ptr addrspace(4) %[[GL2GEN]], i32 4, i32 4)
; CHECK: %[[LO2GEN:[0-9]+]] = addrspacecast ptr addrspace(3) %{{[0-9]+}} to ptr addrspace(4)
; CHECK-NOT: call i32 @__write_pipe_2_AS3
; CHECK: call i32 @__write_pipe_2_fpga({{.*}}, ptr addrspace(4) %[[LO2GEN]], i32 4, i32 4)
; CHECK: %[[PR2GEN:[0-9]+]] = addrspacecast ptr %{{[0-9]+}} to ptr addrspace(4)
; CHECK-NOT: call i32 @__write_pipe_2_AS0
; CHECK: call i32 @__write_pipe_2_fpga({{.*}}, ptr addrspace(4) %[[PR2GEN]], i32 4, i32 4)
; CHECK: %[[CO2GEN:[0-9]+]] = addrspacecast ptr addrspace(2) %{{[0-9]+}} to ptr addrspace(4)
; CHECK-NOT: call i32 @__write_pipe_2_AS2
; CHECK: call i32 @__write_pipe_2_fpga({{.*}}, ptr addrspace(4) %[[CO2GEN]], i32 4, i32 4)
; CHECK-NOT: declare i32 @__write_pipe_2_AS1(ptr addrspace(1), ptr addrspace(1), i32, i32)
; CHECK-NOT: declare i32 @__write_pipe_2_AS3(ptr addrspace(1), ptr addrspace(3), i32, i32)
; CHECK-NOT: declare i32 @__write_pipe_2_AS0(ptr addrspace(1), ptr, i32, i32)
; CHECK-NOT: declare i32 @__write_pipe_2_AS2(ptr addrspace(1), ptr addrspace(2), i32, i32)
...
entry:
  ...
  %5 = call spir_func i32 @__read_pipe_2_AS3(ptr addrspace(1) %3, ptr addrspace(3) %4, i32 4, i32 4)
  ...
  %8 = call spir_func i32 @__read_pipe_2_AS0(ptr addrspace(1) %6, ptr %7, i32 4, i32 4)
...
declare spir_func i32 @__read_pipe_2_AS3(ptr addrspace(1), ptr addrspace(3), i32, i32)

declare spir_func i32 @__read_pipe_2_AS0(ptr addrspace(1), ptr, i32, i32)
...
entry:
  ...
  %0 = load ptr addrspace(1), ptr %p.addr, align 8, !tbaa !4
  %1 = load ptr addrspace(1), ptr %ptr.addr, align 8, !tbaa !7
  %2 = call spir_func i32 @__write_pipe_2_AS1(ptr addrspace(1) %0, ptr addrspace(1) %1, i32 4, i32 4)
  call void @llvm.lifetime.start.p0(i64 8, ptr %ptr_l) #2
  %3 = load ptr addrspace(1), ptr %p.addr, align 8, !tbaa !4
  %4 = load ptr addrspace(3), ptr %ptr_l, align 8, !tbaa !7
  %5 = call spir_func i32 @__write_pipe_2_AS3(ptr addrspace(1) %3, ptr addrspace(3) %4, i32 4, i32 4)
  call void @llvm.lifetime.start.p0(i64 8, ptr %ptr_p) #2
  %6 = load ptr addrspace(1), ptr %p.addr, align 8, !tbaa !4
  %7 = load ptr, ptr %ptr_p, align 8, !tbaa !7
  %8 = call spir_func i32 @__write_pipe_2_AS0(ptr addrspace(1) %6, ptr %7, i32 4, i32 4)
  ...
  %11 = call spir_func i32 @__write_pipe_2_AS2(ptr addrspace(1) %9, ptr addrspace(2) %10, i32 4, i32 4)
...
declare spir_func i32 @__write_pipe_2_AS1(ptr addrspace(1), ptr addrspace(1), i32, i32)

declare spir_func i32 @__write_pipe_2_AS3(ptr addrspace(1), ptr addrspace(3), i32, i32)

declare spir_func i32 @__write_pipe_2_AS0(ptr addrspace(1), ptr, i32, i32)

declare spir_func i32 @__write_pipe_2_AS2(ptr addrspace(1), ptr addrspace(2), i32, i32)

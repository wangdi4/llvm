...
; CHECK: define dso_local void @device_kernel(ptr addrspace(1) noundef align 4 %inout, ptr %event) {{.*}} !arg_type_null_val [[MD_ARG_TY_NULL:![0-9]+]]
...
; CHECK: call zeroext i1 @_Z14is_valid_event12ocl_clkevent(ptr
...
; CHECK: load ptr, ptr %event.addr, align 8
; CHECK: call void @_Z13release_event12ocl_clkevent(ptr
...
; CHECK-DAG: declare zeroext i1 @_Z14is_valid_event12ocl_clkevent(ptr)

declare spir_func zeroext i1 @_Z14is_valid_event12ocl_clkevent(target("spirv.DeviceEvent")) #1

; CHECK-DAG: declare void @_Z13release_event12ocl_clkevent(ptr)

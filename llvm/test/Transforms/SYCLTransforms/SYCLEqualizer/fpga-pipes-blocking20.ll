...
entry:
  ...
  %3 = call spir_func i32 @__read_pipe_2_bl(ptr addrspace(1) %0, ptr addrspace(4) %2, i32 4, i32 4)
  ...
  %7 = call spir_func i32 @__read_pipe_2_bl(ptr addrspace(1) %4, ptr addrspace(4) %6, i32 4, i32 4)
  ...
  %10 = call spir_func i32 @__read_pipe_2_bl(ptr addrspace(1) %8, ptr addrspace(4) %9, i32 4, i32 4)
  call void @llvm.lifetime.end.p0(i64 8, ptr %ptr_p) #2
  call void @llvm.lifetime.end.p0(i64 8, ptr %ptr_l) #2
  ret void
}

declare spir_func i32 @__read_pipe_2_bl(ptr addrspace(1), ptr addrspace(4), i32, i32)
...
entry:
  ...
  %1 = load ptr addrspace(1), ptr %ptr.addr, align 8, !tbaa !7
  %2 = addrspacecast ptr addrspace(1) %1 to ptr addrspace(4)
  %3 = call spir_func i32 @__write_pipe_2_bl(ptr addrspace(1) %0, ptr addrspace(4) %2, i32 4, i32 4)
  call void @llvm.lifetime.start.p0(i64 8, ptr %ptr_l) #2
  %4 = load ptr addrspace(1), ptr %p.addr, align 8, !tbaa !4
  %5 = load ptr addrspace(3), ptr %ptr_l, align 8, !tbaa !7
  %6 = addrspacecast ptr addrspace(3) %5 to ptr addrspace(4)
  %7 = call spir_func i32 @__write_pipe_2_bl(ptr addrspace(1) %4, ptr addrspace(4) %6, i32 4, i32 4)
  call void @llvm.lifetime.start.p0(i64 8, ptr %ptr_p) #2
  %8 = load ptr addrspace(1), ptr %p.addr, align 8, !tbaa !4
  %9 = load ptr addrspace(4), ptr %ptr_p, align 8, !tbaa !7
  %10 = call spir_func i32 @__write_pipe_2_bl(ptr addrspace(1) %8, ptr addrspace(4) %9, i32 4, i32 4)
  ...
  %14 = call spir_func i32 @__write_pipe_2_bl(ptr addrspace(1) %11, ptr addrspace(4) %13, i32 4, i32 4)
...
declare spir_func i32 @__write_pipe_2_bl(ptr addrspace(1), ptr addrspace(4), i32, i32)

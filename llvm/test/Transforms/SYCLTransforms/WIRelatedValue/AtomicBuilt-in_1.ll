...
; CHECK: @main
define void @main(ptr addrspace(1) %arg) #0 !kernel_arg_base_type !1 !arg_type_null_val !2 {
  %a = call i32 @_Z25atomic_fetch_add_explicitPU3AS1VU7_Atomicjjjj(ptr addrspace(1) %arg, i32 1, i32 0, i32 3) #0
  call void @_Z7barrierj(i32 2)
  ret void
; CHECK: %a = call i32 @_Z25atomic_fetch_add_explicitPU3AS1VU7_Atomicjjjj(ptr addrspace(1) %arg, i32 1, i32 0, i32 3)
...
declare i32 @_Z25atomic_fetch_add_explicitPU3AS1VU7_Atomicjjjj(ptr addrspace(1), i32, i32, i32) #0

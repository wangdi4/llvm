...
; CHECK:   declare void @twoDoubles(ptr)
...
; CHECK: declare void @outOfIntRegisters(ptr, ptr, i32, ptr, i32, i32)
...
; CHECK: declare void @outOfSSERegisters(ptr, ptr, ptr, i32, ptr, i32, i32)

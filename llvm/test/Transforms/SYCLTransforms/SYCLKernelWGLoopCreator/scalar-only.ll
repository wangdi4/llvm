...
define dso_local void @_Z30ParallelForNDRangeImplKernel1DPiS_S_mmm(ptr %out, ptr %dummy) #0 !no_barrier_path !{i1 1} {
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[TMP1]], i64 [[DIM_0_IND_VAR]]

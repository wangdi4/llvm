...
; CHECK-NEXT: store i64 %dim_2_tid, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @LocalIds, i64 0, i32 2), align 8
...
; CHECK-NEXT: store i64 %dim_1_tid, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @LocalIds, i64 0, i32 1), align 8
...
; CHECK-NEXT: store volatile i64 %dim_2_ind_var, i64* %__ocl_dbg_gid2, align 8
  ...
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid0, metadata !22, metadata !DIExpression()), !dbg !24
  %__ocl_dbg_gid1 = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid1, metadata !25, metadata !DIExpression()), !dbg !24
  %__ocl_dbg_gid2 = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid2, metadata !26, metadata !DIExpression()), !dbg !24
  ...
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %dst.addr, align 8, !dbg !29
  %call = call i64 @_Z13get_global_idj(i32 noundef 0) #3, !dbg !30
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %0, i64 %call, !dbg !29

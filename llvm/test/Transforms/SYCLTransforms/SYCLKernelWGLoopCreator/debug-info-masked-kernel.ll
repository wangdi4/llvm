...
; CHECK-NEXT: store volatile i64 %dim_2_vector_ind_var{{.*}}, i64* %__ocl_dbg_gid2
  ...
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid1, metadata !29, metadata !DIExpression()), !dbg !28
  ...
  call void @llvm.dbg.declare(metadata i64* %__ocl_dbg_gid2, metadata !30, metadata !DIExpression()), !dbg !28
  %GlobalID_2 = call i64 @_Z13get_global_idj(i32 2)
  store volatile i64 %GlobalID_2, i64* %__ocl_dbg_gid2, align 8
  call void @llvm.dbg.value(metadata i32 addrspace(1)* %src, metadata !12, metadata !DIExpression()), !dbg !28
  ...
  %ptridx = getelementptr inbounds i32, i32 addrspace(1)* %src, i64 %call1, !dbg !32
  store i32 %subgroup.size, i32 addrspace(1)* %ptridx, align 4, !dbg !33, !tbaa !34
  ret void, !dbg !38
}
...
define [7 x i64] @WG.boundaries.test(i32 addrspace(1)* %0) !recommended_vector_length !39 {
entry:
...
entry:
  ...
  %scalar.gep = getelementptr inbounds i32, i32 addrspace(1)* %src, i64 %call1, !dbg !46
  %5 = bitcast i32 addrspace(1)* %scalar.gep to <16 x i32> addrspace(1)*, !dbg !47
  store <16 x i32> %broadcast.splat3, <16 x i32> addrspace(1)* %5, align 4, !dbg !47, !intel.preferred_alignment !48
  ret void, !dbg !49
}
...
entry:
  ...
  %scalar.gep2 = getelementptr inbounds i32, i32 addrspace(1)* %src, i64 %call1, !dbg !56
  %6 = bitcast i32 addrspace(1)* %scalar.gep2 to <16 x i32> addrspace(1)*, !dbg !57
  call void @llvm.masked.store.v16i32.p1v16i32(<16 x i32> %broadcast.splat4, <16 x i32> addrspace(1)* %6, i32 4, <16 x i1> %5), !dbg !57, !intel.preferred_alignment !48
  ret void, !dbg !58
}
...
!18 = !{i1 false}
!19 = !{i32 0}
!20 = !{void (i32 addrspace(1)*)* @_ZGVeN16u_test}
!21 = !{void (i32 addrspace(1)*, <16 x i32>)* @_ZGVeM16u_test}
!22 = !{i1 true}
!23 = !{null}
!24 = !{i32 12}

...
;;           gep instruction "%p" on "%a" that does not cross barrier
;;           load instruction "%x" from "%p" that does cross barrier
...
;;      4. Only value "%x" collected to this group with offset 0 in the special buffer

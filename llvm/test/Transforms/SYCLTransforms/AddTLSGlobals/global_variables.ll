...
; CHECK: @__pWorkDim = linkonce_odr thread_local global ptr undef
; CHECK: @__pWGId = linkonce_odr thread_local global ptr undef
; CHECK: @__BaseGlbId = linkonce_odr thread_local global [4 x i64] undef
; CHECK-NOT: @__pSpecialBuf
; CHECK: @__RuntimeHandle = linkonce_odr thread_local global ptr undef

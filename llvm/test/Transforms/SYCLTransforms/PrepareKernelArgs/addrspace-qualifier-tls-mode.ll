...
;
; CHECK:         [[TMP1:%.*]] = getelementptr i8, ptr [[UNIFORMARGS]], i32 272
; CHECK-NEXT:    [[BUFFERINFO:%.*]] = alloca i64, i64 6, align 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[BUFFERINFO]], ptr align 1 [[TMP1]], i64 48, i1 false)
; CHECK-NEXT:    store ptr [[BUFFERINFO]], ptr @__pBufferRanges, align 8
;
; CHECK:         call void @callee(ptr addrspace(4) [[TMP2:%.*]], i32 [[CONV:%.*]])
;
entry:
...
; CHECK-NEXT:    [[BUFFERINFO:%.*]] = alloca i64, i64 8, align 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[BUFFERINFO]], ptr align 1 [[TMP4]], i64 64, i1 false)
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr [[BUFFERINFO]], i32 32
; CHECK-NEXT:    store ptr [[TMP3]], ptr [[TMP5]], align 8
; CHECK-NEXT:    store ptr [[BUFFERINFO]], ptr @__pBufferRanges, align 8
;
; CHECK     :    call void @callee(ptr addrspace(4) [[TMP3:%.*]], i32 [[CONV:%.*]])
; CHECK     :    call void @callee(ptr addrspace(4) [[TMP4:%.*]], i32 [[CONV:%.*]])
;
entry:
  %call = call i64 @_Z13get_global_idj(i32 0)
  %conv = trunc i64 %call to i32
...
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr i8, ptr addrspace(3) [[TMP5]], i32 128
; CHECK-NEXT:    store ptr addrspace(3) [[TMP6]], ptr @__pLocalMemBase, align 8
;
; CHECK:         [[TMP26:%.*]] = getelementptr i8, ptr [[UNIFORMARGS]], i32 280
; CHECK-NEXT:    [[BUFFERINFO:%.*]] = alloca i64, i64 8, align 8
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 1 [[BUFFERINFO]], ptr align 1 [[TMP26]], i64 64, i1 false)
;; store local array addr to BufferRanges
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr i8, ptr [[BUFFERINFO]], i32 16
; CHECK-NEXT:    store ptr [[TMP4]], ptr [[TMP27]], align 8
;; store local array size to BufferRanges
; CHECK-NEXT:    [[TMP28:%.*]] = getelementptr i8, ptr [[BUFFERINFO]], i32 24
; CHECK-NEXT:    store i64 320, ptr [[TMP28]], align 4
;; store local arg's addr to BufferRanges
; CHECK-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr [[BUFFERINFO]], i32 32
; CHECK-NEXT:    store ptr [[TMP3]], ptr [[TMP29]], align 8
; CHECK-NEXT:    store ptr [[BUFFERINFO]], ptr @__pBufferRanges, align 8
;

...
define internal void @__block_fn_block_invoke(ptr addrspace(4) %.block_descriptor, ptr addrspace(3) noalias %pLocalMemBase, ptr noalias %pWorkDim, ptr noalias %pWGId, [4 x i64] %BaseGlbId, ptr noalias %pSpecialBuf, ptr noalias %RuntimeHandle) #0 {
entry:

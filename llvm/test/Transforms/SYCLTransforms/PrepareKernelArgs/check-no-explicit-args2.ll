...
; CHECK: [[ARG0_BUFF_IDX:%[a-zA-Z0-9]+]] = getelementptr i8, ptr %UniformArgs, i32 0
; CHECK-NEXT: %explicit_0 = load i8, ptr [[ARG0_BUFF_IDX]], align 1
;;implicit args
; CHECK-NEXT: %pWorkDim = getelementptr i8, ptr %UniformArgs, i32 4

...
; CHECK-NEXT: %explicit_1 = load <2 x i16>, ptr [[ARG1_BUFF_INDEX]], align 4
...
; CHECK-NEXT: %explicit_2 = load <2 x i16>, ptr [[ARG2_BUFF_INDEX]], align 4
...
; CHECK-NEXT: %explicit_3 = load <3 x i16>, ptr [[ARG3_BUFF_INDEX]], align 8
...
; CHECK-NEXT: %explicit_4 = load <16 x i16>, ptr [[ARG4_BUFF_INDEX]], align 32

;; short4 arg6 - alignment: 8 - in UniformArgs 32+32=64 is aligned to 64
; CHECK-NEXT: [[ARG5_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, ptr %UniformArgs, i32 64
; CHECK-NEXT: %explicit_5 = load <4 x i16>, ptr [[ARG5_BUFF_INDEX]], align 8

;; short8 arg7 - alignment: 16 - in UniformArgs 64+8=72 is aligned to 80
; CHECK-NEXT: [[ARG6_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, ptr %UniformArgs, i32 80
; CHECK-NEXT: %explicit_6 = load <8 x i16>, ptr [[ARG6_BUFF_INDEX]], align 16

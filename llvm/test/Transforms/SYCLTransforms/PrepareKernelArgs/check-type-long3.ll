...
; CHECK: @t1
define void @t1( <3 x i64> %arg1) {
entry:
  ret void
}

;; new func
;;long3 arg1 - expected alignment: 32 (n=3 is aligned like n=4)
; CHECK: [[ARG0_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, i8* %UniformArgs, i32 0
; CHECK-NEXT: [[ARG0_TYPECAST:%[a-zA-Z0-9]+]] = bitcast i8* [[ARG0_BUFF_INDEX]] to <3 x i64>*
; CHECK-NEXT: %explicit_0 = load <3 x i64>, <3 x i64>* [[ARG0_TYPECAST]], align 32
;;implicit args
; CHECK: ret void

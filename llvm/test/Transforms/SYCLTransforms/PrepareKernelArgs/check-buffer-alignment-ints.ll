...
; CHECK: @t1
define void @t1(i32 %arg1, <2 x i32> %arg2, <2 x i32> %arg3, <3 x i32> %arg4, <16 x i32> %arg5, <4 x i32> %arg6, <8 x i32> %arg7 ) {
entry:
  ret void
}
...
; CHECK-NEXT: %explicit_0 = load i32, ptr [[ARG0_BUFF_INDEX]], align 4

;; int2 arg2 - alignment: 8 - in UniformArgs 0+4 = 4 is aligned to 8
; CHECK-NEXT: [[ARG1_BUFF_INDEX:%[a-zA-Z0-9]+]] = getelementptr i8, ptr %UniformArgs, i32 8
; CHECK-NEXT: %explicit_1 = load <2 x i32>, ptr [[ARG1_BUFF_INDEX]], align 8
...
; CHECK-NEXT: %explicit_2 = load <2 x i32>, ptr [[ARG2_BUFF_INDEX]], align 8
...
; CHECK-NEXT: %explicit_3 = load <3 x i32>, ptr [[ARG3_BUFF_INDEX]], align 16
...
; CHECK-NEXT: %explicit_4 = load <16 x i32>, ptr [[ARG4_BUFF_INDEX]], align 64
...
; CHECK-NEXT: %explicit_5 = load <4 x i32>, ptr [[ARG5_BUFF_INDEX]], align 16
...
; CHECK-NEXT: %explicit_6 = load <8 x i32>, ptr [[ARG6_BUFF_INDEX]], align 32

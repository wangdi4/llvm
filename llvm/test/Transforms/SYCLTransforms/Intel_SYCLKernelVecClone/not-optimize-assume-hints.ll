...
define void @test(ptr addrspace(1) noalias align 8 %A, ptr addrspace(1) noalias align 8 %B) local_unnamed_addr #0 !recommended_vector_length !4 !kernel_arg_base_type !9 !arg_type_null_val !10 {
entry:
; CHECK-LABEL: @test
; CHECK-NOT: trunc
  ...
  %1 = getelementptr inbounds double, ptr addrspace(1) %A, i64 %0
  %2 = load double, ptr addrspace(1) %1, align 8, !noalias !5
  %3 = getelementptr inbounds double, ptr addrspace(1) %B, i64 %0
  store double %2, ptr addrspace(1) %3, align 8, !noalias !5
  ret void
}

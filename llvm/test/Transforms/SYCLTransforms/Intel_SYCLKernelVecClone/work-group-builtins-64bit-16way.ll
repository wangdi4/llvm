...
; CHECK: = call {{(spir_func )?}}<16 x i32> @_Z20work_group_broadcastDv16_im(<16 x i32> %wide.load, i64 0)
  %call4 = tail call spir_func i32 @_Z20work_group_broadcastimm(i32 %0, i64 0, i64 0) #4
; CHECK: = call {{(spir_func )?}}<16 x i32> @_Z20work_group_broadcastDv16_imm(<16 x i32> %wide.load, i64 0, i64 0)
  %call5 = tail call spir_func i32 @_Z20work_group_broadcastimmm(i32 %0, i64 0, i64 0, i64 0) #4
; CHECK: = call {{(spir_func )?}}<16 x i32> @_Z20work_group_broadcastDv16_immm(<16 x i32> %wide.load, i64 0, i64 0, i64 0)

...
; CHECK: [[LOOP_BODY]]:
; CHECK-NEXT: [[MAT_UPDATE:%mat.update.*]] = call <144 x i32> @llvm.experimental.matrix.wi.slice.insertelement.v144i32.i64(<144 x i32> [[MAT]], i32 12, i32 12, i32 42, i64 [[ELE_INDEX]], metadata !"scope.subgroup", metadata !"matrix.use.a")
...
; CHECK: ret void
entry:
  %call.i = call <144 x i32> @llvm.experimental.matrix.fill.v144i32.i32(i32 42, i32 12, i32 12, metadata !"scope.subgroup", metadata !"matrix.use.a")
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[MAT_INIT:%.*]] = call <144 x i8> @llvm.experimental.matrix.fill.v144i8.i8(i8 0, i32 12, i32 12, metadata !"scope.subgroup", metadata !"matrix.use.b")
; CHECK-NEXT:    [[SLICE_LENGTH:%.*]] = call i64 @llvm.experimental.matrix.wi.slice.length.v144i8(<144 x i8> [[MAT_INIT]], i32 12, i32 12, metadata !"scope.subgroup", metadata !"matrix.use.b")
...
; CHECK-NEXT:    [[MAT_UPDATE]] = call <144 x i8> @llvm.experimental.matrix.wi.slice.insertelement.v144i8.i64(<144 x i8> [[MAT]], i32 12, i32 12, i8 42, i64 [[ELEMENT_INDEX]], metadata !"scope.subgroup", metadata !"matrix.use.b")
...
;
entry:
  %call.i = call <144 x i8> @llvm.experimental.matrix.fill.v144i8.i8(i8 42, i32 12, i32 12, metadata !"scope.subgroup", metadata !"matrix.use.b")

...
; CHECK-SYCLKernelAnalysis-BROKEN: error: llvm.experimental.matrix.load.v8i8.p0i32": AMX matrix primitives are being used on an arch older than Sapphire Rapids! DPC++ joint matrix extension requires presence of AMX on Sapphire Rapids or later

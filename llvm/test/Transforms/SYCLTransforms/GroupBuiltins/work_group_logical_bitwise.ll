...
; CHECK-NEXT:    store <16 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, ptr [[ALLOCAWGRESULT3]], align 32
...
; CHECK-NEXT:    store i32 0, ptr [[ALLOCAWGRESULT1]], align 4
; CHECK-NEXT:    call void @dummy_barrier.()
; CHECK-NEXT:    [[CALLWGFORITEM4:%.*]] = call <16 x i16> @_Z29work_group_reduce_bitwise_andDv16_sPS_(<16 x i16> noundef <i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4, i16 4>, ptr [[ALLOCAWGRESULT3]])
; CHECK-NEXT:    call void @_Z18work_group_barrierj(i32 1)
...
; CHECK-NEXT:    store <16 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, ptr [[ALLOCAWGRESULT3]], align 32
; CHECK-NEXT:    call void @dummy_barrier.()
; CHECK-NEXT:    [[CALLWGFORITEM6:%.*]] = call <16 x i32> @_Z28work_group_reduce_logical_orDv16_iPS_(<16 x i32> noundef <i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8, i32 8>, ptr [[ALLOCAWGRESULT5]])
; CHECK-NEXT:    call void @_Z18work_group_barrierj(i32 1)

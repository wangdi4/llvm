...
; CHECK-DAG: store double 0x7FF0000000000000,{{.*}} double* [[D_POS_INF:%.*]],
; CHECK-DAG: store double 0xFFF0000000000000,{{.*}} double* [[D_NEG_INF:%.*]],
; CHECK-DAG: store float 0x7FF0000000000000,{{.*}} float* [[F_POS_INF:%.*]],
; CHECK-DAG: store float 0xFFF0000000000000,{{.*}} float* [[F_NEG_INF:%.*]],

; CHECK-DAG: store <16 x double> <double 0x7FF0000000000000,{{.*}} <16 x double>* [[D_POS_INF16:%.*]],
; CHECK-DAG: store <16 x double> <double 0xFFF0000000000000,{{.*}} <16 x double>* [[D_NEG_INF16:%.*]],
; CHECK-DAG: store <16 x float> <float 0x7FF0000000000000,{{.*}} <16 x float>* [[F_POS_INF16:%.*]],
; CHECK-DAG: store <16 x float> <float 0xFFF0000000000000,{{.*}} <16 x float>* [[F_NEG_INF16:%.*]],

define spir_func void @test_work_group_scan_fp(float %float_in, double %double_in) {
; CHECK: call spir_func float @_Z29work_group_scan_exclusive_maxfPf({{.*}} float* [[F_NEG_INF]])
; CHECK: call spir_func double @_Z29work_group_scan_exclusive_maxdPd({{.*}} double* [[D_NEG_INF]])
; CHECK: call spir_func float @_Z29work_group_scan_exclusive_minfPf({{.*}} float* [[F_POS_INF]])
; CHECK: call spir_func double @_Z29work_group_scan_exclusive_mindPd({{.*}} double* [[D_POS_INF]])
; CHECK: call spir_func <16 x float> @_Z29work_group_scan_exclusive_maxDv16_fPS_({{.*}} <16 x float>* [[F_NEG_INF16]])
; CHECK: call spir_func <16 x double> @_Z29work_group_scan_exclusive_maxDv16_dPS_({{.*}} <16 x double>* [[D_NEG_INF16]])
; CHECK: call spir_func <16 x float> @_Z29work_group_scan_exclusive_minDv16_fPS_({{.*}} <16 x float>* [[F_POS_INF16]])
; CHECK: call spir_func <16 x double> @_Z29work_group_scan_exclusive_minDv16_dPS_({{.*}} <16 x double>* [[D_POS_INF16]])
entry:

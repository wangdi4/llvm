...
declare <16 x i32> @_Z20work_group_broadcastDv16_jDv16_mS0_S0_S_(<16 x i32> %src, <16 x i64> %local_id_x, <16 x i64> %local_id_y, <16 x i64> %local_id_z, <16 x i32> %mask)
...
; CHECK: %y.assume.uniform{{.*}} = extractelement <16 x i64> %y, i32 0
; CHECK: %z.assume.uniform{{.*}} = extractelement <16 x i64> %z, i32 0
; CHECK: call <16 x i32> @_Z20work_group_broadcastDv16_jmmS_PS_(<16 x i32> {{.*}}, i64 {{.*}}, i64 {{.*}}, <16 x i32> {{.*}}, ptr
  %call.with.mask = call <16 x i32> @_Z20work_group_broadcastDv16_jDv16_mS0_S0_S_(<16 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>, <16 x i64> %x, <16 x i64> %y, <16 x i64> %z, <16 x i32> <i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1, i32 -1>)
  ret void
}

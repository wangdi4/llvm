...
declare <2 x i32> @_ZGVbM8vv_A_foo(%class.S1A.A addrspace(4)* %this, <2 x i32> %X);
declare <2 x i32> @_ZGVbN8vv_A_foo(%class.S1A.A addrspace(4)* %this, <2 x i32> %X);
declare <2 x i32> @_ZGVbM8vv_B_foo(%class.S1B.B addrspace(4)* %this, <2 x i32> %X);
declare <2 x i32> @_ZGVbN8vv_B_foo(%class.S1B.B addrspace(4)* %this, <2 x i32> %X);

attributes #4 = { "vector-variants"="_ZGVbM8vv_B_foo,_ZGVbN8vv_B_foo" "vector_function_ptrs"="B_foo$SIMDTable(_ZGVbM8vv_B_foo,_ZGVbN8vv_B_foo)" }

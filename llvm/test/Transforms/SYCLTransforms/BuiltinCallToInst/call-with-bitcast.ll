...
entry:
  ...
  %call = tail call i32 bitcast (i8 (float, float)* @_Z7isequalff to i32 (float, float)*)(float %0, float %1) #2
...
entry:
  ...
  %call = tail call <2 x i32> bitcast (<2 x i8>(<2 x float>, <2 x float>)* @_Z7isequalDv2_fS_ to <2 x i32> (<2 x float>, <2 x float>)*)(<2 x float> %0, <2 x float> %1) #2
...
entry:
  ...
  %call = tail call <3 x i32> bitcast (<3 x i8>(<3 x float>, <3 x float>)* @_Z7isequalDv3_fS_ to <3 x i32> (<3 x float>, <3 x float>)*)(<3 x float> %extractVec, <3 x float> %extractVec3) #2
...
entry:
  ...
  %call = tail call <4 x i32> bitcast (<4 x i8>(<4 x float>, <4 x float>)* @_Z7isequalDv4_fS_ to <4 x i32> (<4 x float>, <4 x float>)*)(<4 x float> %0, <4 x float> %1) #2
...
entry:
  ...
  %call = tail call <8 x i32> bitcast (<8 x i8>(<8 x float>, <8 x float>)* @_Z7isequalDv8_fS_ to <8 x i32> (<8 x float>, <8 x float>)*)(<8 x float> %0, <8 x float> %1) #2
...
entry:
  ...
  %call = tail call <16 x i32> bitcast (<16 x i8>(<16 x float>, <16 x float>)* @_Z7isequalDv16_fS_ to <16 x i32> (<16 x float>, <16 x float>)*)(<16 x float> %0, <16 x float> %1) #2

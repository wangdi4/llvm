...
; CHECK-NEXT: PTR   %3 = getelementptr inbounds i32, i32 addrspace(1)* %in, i32 %1
...
; CHECK-NEXT: PTR   %14 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %1
; CHECK-NEXT: RND   store i32 %13, i32 addrspace(1)* %14, align 4
...
; CHECK-NEXT: PTR   %23 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %22
; CHECK-NEXT: RND   store i32 %21, i32 addrspace(1)* %23, align 4

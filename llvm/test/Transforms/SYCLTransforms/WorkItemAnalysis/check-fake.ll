...
; RUN: opt -opaque-pointers=0 -sycl-kernel-builtin-lib=%t.rtl.bc -passes='require<sycl-kernel-builtin-info-analysis>,print<sycl-kernel-work-item-analysis>' %s -disable-output 2>&1 | FileCheck %s
...
; CHECK-NEXT: RND   %1 = alloca i32 addrspace(1)*, align 8
; CHECK-NEXT: RND   %2 = alloca i32 addrspace(1)*, align 8
; CHECK-NEXT: PTR   %3 = alloca i32, align 4
; CHECK-NEXT: PTR   %4 = alloca i32, align 4
; CHECK-NEXT: PTR   %gid = alloca i32, align 4
; CHECK-NEXT: RND   store i32 addrspace(1)* %in, i32 addrspace(1)** %1, align 8
; CHECK-NEXT: RND   store i32 addrspace(1)* %out, i32 addrspace(1)** %2, align 8
; CHECK-NEXT: RND   store i32 %num, i32* %3, align 4
; CHECK-NEXT: RND   store i32 %inc, i32* %4, align 4
; CHECK-NEXT: SEQ   %5 = call spir_func i64 @_Z13get_global_idj(i32 0) #1
; CHECK-NEXT: SEQ   %6 = trunc i64 %5 to i32
; CHECK-NEXT: RND   store i32 %6, i32* %gid, align 4
; CHECK-NEXT: RND   %7 = load i32, i32* %3, align 4
; CHECK-NEXT: RND   %8 = load i32, i32* %4, align 4
; CHECK-NEXT: RND   %9 = call spir_func i32 @_Z6selectiii(i32 0, i32 %7, i32 %8) #1
; CHECK-NEXT: RND   %10 = load i32 addrspace(1)*, i32 addrspace(1)** %1, align 8
; CHECK-NEXT: RND   %11 = sext i32 %9 to i64
; CHECK-NEXT: RND   %12 = getelementptr inbounds i32, i32 addrspace(1)* %10, i64 %11
; CHECK-NEXT: RND   store i32 addrspace(1)* %12, i32 addrspace(1)** %1, align 8
; CHECK-NEXT: RND   %13 = load i32, i32* %3, align 4
; CHECK-NEXT: RND   %14 = load i32, i32* %4, align 4
; CHECK-NEXT: RND   %15 = call spir_func i32 @_Z6selectiii(i32 0, i32 %13, i32 %14) #1
; CHECK-NEXT: RND   %16 = load i32 addrspace(1)*, i32 addrspace(1)** %2, align 8
; CHECK-NEXT: RND   %17 = sext i32 %15 to i64
; CHECK-NEXT: RND   %18 = getelementptr inbounds i32, i32 addrspace(1)* %16, i64 %17
; CHECK-NEXT: RND   store i32 addrspace(1)* %18, i32 addrspace(1)** %2, align 8
; CHECK-NEXT: RND   %19 = load i32, i32* %gid, align 4
; CHECK-NEXT: RND   %20 = sext i32 %19 to i64
; CHECK-NEXT: RND   %21 = load i32 addrspace(1)*, i32 addrspace(1)** %1, align 8
; CHECK-NEXT: RND   %22 = getelementptr inbounds i32, i32 addrspace(1)* %21, i64 %20
; CHECK-NEXT: RND   %23 = load i32, i32 addrspace(1)* %22, align 4
; CHECK-NEXT: RND   %24 = load i32, i32* %gid, align 4
; CHECK-NEXT: RND   %25 = sext i32 %24 to i64
; CHECK-NEXT: RND   %26 = load i32 addrspace(1)*, i32 addrspace(1)** %2, align 8
; CHECK-NEXT: RND   %27 = getelementptr inbounds i32, i32 addrspace(1)* %26, i64 %25
; CHECK-NEXT: RND   store i32 %23, i32 addrspace(1)* %27, align 4

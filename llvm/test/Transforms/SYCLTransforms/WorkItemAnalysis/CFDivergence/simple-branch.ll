...
; CHECK-NEXT: PTR   %in1 = getelementptr inbounds i32, i32 addrspace(1)* %in, i32 %id
; CHECK-NEXT: RND   %in2 = load i32, i32 addrspace(1)* %in1, align 4
...
; CHECK-NEXT: PTR   %out1 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %id
; CHECK-NEXT: RND   store i32 %x, i32 addrspace(1)* %out1, align 4

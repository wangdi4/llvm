...
; CHECK-NEXT: PTR   %1 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %0
...
; CHECK-NEXT: RND   store i32 %5, i32 addrspace(1)* %1, align 4
...
; CHECK-NEXT: RND   store i32 %8, i32 addrspace(1)* %1, align 4
...
; CHECK-NEXT: PTR   %.pre11 = getelementptr inbounds i32, i32 addrspace(1)* %out, i32 %0
; CHECK-NEXT: UNI   %12 = add nsw i32 %y.0, %x.0
; CHECK-NEXT: UNI   %13 = add nsw i32 %12, %10
; CHECK-NEXT: RND   store i32 %13, i32 addrspace(1)* %.pre11, align 4

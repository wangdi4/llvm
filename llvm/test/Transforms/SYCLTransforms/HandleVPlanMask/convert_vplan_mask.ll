...
define void @test(%opencl.image2d_ro_t.5 addrspace(1)* noalias %img) local_unnamed_addr #0 {
entry:
...
; Function Attrs: convergent norecurse nounwind
define void @_ZGVcN4u_test(%opencl.image2d_ro_t.5 addrspace(1)* noalias %img) local_unnamed_addr #0 {
entry:
...
; CHECK: call zeroext <4 x i16> @_Z32intel_sub_group_block_read_us1_414ocl_image2d_roDv2_iDv4_j(%opencl.image2d_ro_t.5 addrspace(1)* %img, <2 x i32> zeroinitializer, <4 x i32> <i32 -1, i32 -1, i32 -1, i32 -1>)
...
; Function Attrs: convergent norecurse nounwind
define void @_ZGVcM4u_test(%opencl.image2d_ro_t.5 addrspace(1)* noalias %img, <4 x i32> %mask) local_unnamed_addr #0 {
entry:
...
!0 = !{void (%opencl.image2d_ro_t.5 addrspace(1)*)* @test}

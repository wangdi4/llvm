...
;CHECK: call <8 x float> @_Z6sincosDv8_fPS_(<8 x float> %a, ptr
...
;CHECK: call <8 x float> @_Z6sincosDv8_fPS_(<8 x float> %a, ptr
;CHECK: call <8 x float> @_Z6sincosDv8_fPS_(<8 x float> %b, ptr
...
;CHECK-NOT: call <8 x float> @_Z3cosDv8_f
;CHECK-NOT: call <8 x float> @_Z3sinDv8_f
;CHECK: call <4 x float> @_Z6sincosDv4_fPS_(<4 x float> %b, ptr
;CHECK-NOT: call <8 x float> @_Z3cosDv8_f
;CHECK-NOT: call <8 x float> @_Z3sinDv8_f
;CHECK-NOT: call <4 x float> @_Z6cosDv4_f
;CHECK-NOT: call <4 x float> @_Z6sinDv4_f
...
;CHECK: call double @_Z6sincosdPd(double %a, ptr
;CHECK-NOT: call <8 x float> @_Z3cosd
;CHECK-NOT: call <8 x float> @_Z3sind
;CHECK: call double @_Z6sincosdPd(double %b, ptr
;CHECK-NOT: call <8 x float> @_Z3sind
;CHECK-NOT: call <8 x float> @_Z3cosd
;CHECK: ret void

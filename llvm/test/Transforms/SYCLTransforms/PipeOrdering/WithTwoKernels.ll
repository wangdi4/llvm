...
for.body:                                         ; preds = %for.cond
  %1 = load ptr addrspace(1), ptr addrspace(1) @ch1.pipe, align 8, !tbaa !9
  %2 = load ptr addrspace(1), ptr addrspace(1) @ch1, align 4, !tbaa !9
...
define dso_local void @boo(ptr addrspace(1) noundef align 4 %iters) #0 !kernel_arg_base_type !3 !arg_type_null_val !4 {
entry:
  %write.src = alloca i32, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %1 = load ptr addrspace(1), ptr addrspace(1) @ch2.pipe, align 8, !tbaa !9
  %2 = load ptr addrspace(1), ptr addrspace(1) @ch2, align 4, !tbaa !9
  store i32 42, ptr %write.src, align 4
  %3 = addrspacecast ptr %write.src to ptr addrspace(4)
  %4 = call i32 @__write_pipe_2_bl_fpga(ptr addrspace(1) %1, ptr addrspace(4) %3, i32 4, i32 4)
  %inc = add nuw nsw i32 %i.0, 1

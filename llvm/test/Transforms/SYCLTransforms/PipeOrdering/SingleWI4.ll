...
; channel int ch;
;
; __attribute__((noinline)) __attribute__((max_global_work_dim(0))) kernel void foo(global int *iters) {
...
define dso_local void @foo(ptr addrspace(1) noundef align 4 %iters) #0 !kernel_arg_base_type !3 !kernel_arg_pipe_depth !4 !kernel_arg_pipe_io !5 !arg_type_null_val !6 !max_global_work_dim !4 {
entry:
...
define dso_local void @boo(ptr addrspace(1) noundef align 4 %iters) #0 !kernel_arg_base_type !3 !kernel_arg_pipe_depth !4 !kernel_arg_pipe_io !5 !arg_type_null_val !6 {
entry:
...
attributes #0 = { convergent norecurse noinline nounwind }

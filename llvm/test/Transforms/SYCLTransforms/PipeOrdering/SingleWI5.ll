...
define dso_local void @boo(ptr addrspace(1) noundef align 4 %iters) #1 !kernel_arg_base_type !6 !kernel_arg_pipe_depth !7 !kernel_arg_pipe_io !8 !arg_type_null_val !9 !max_global_work_dim !7 {
entry:
...
define dso_local void @moo(ptr addrspace(1) noundef align 4 %iters) #1 !kernel_arg_base_type !6 !kernel_arg_pipe_depth !7 !kernel_arg_pipe_io !8 !arg_type_null_val !9 {
entry:
  %0 = load i32, ptr addrspace(1) %iters, align 4, !tbaa !10
  call void @foo(i32 noundef %0) #2
  ret void

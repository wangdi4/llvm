...
define dso_local void @foo(ptr addrspace(1) noundef align 4 %flags) #0 !kernel_arg_base_type !3 !kernel_arg_pipe_depth !4 !kernel_arg_pipe_io !5 !arg_type_null_val !6 {
entry:
...
for.cond:                                         ; preds = %if.end5, %entry
  ...
  %0 = load ptr addrspace(1), ptr addrspace(1) @ch.pipe, align 8, !tbaa !7
  %1 = load ptr addrspace(1), ptr addrspace(1) @ch, align 4, !tbaa !7
  ...
  %4 = load i32, ptr addrspace(1) %arrayidx, align 4, !tbaa !10
...
if.end:                                           ; preds = %for.cond
  %5 = load ptr addrspace(1), ptr addrspace(1) @ch.pipe, align 8, !tbaa !7
  %6 = load ptr addrspace(1), ptr addrspace(1) @ch, align 4, !tbaa !7
  store i32 42, ptr %write.src, align 4
  ...
  %arrayidx2 = getelementptr inbounds i32, ptr addrspace(1) %flags, i64 %idxprom1
  %9 = load i32, ptr addrspace(1) %arrayidx2, align 4, !tbaa !10
...
if.end5:                                          ; preds = %if.end
  %10 = load ptr addrspace(1), ptr addrspace(1) @ch.pipe, align 8, !tbaa !7
  %11 = load ptr addrspace(1), ptr addrspace(1) @ch, align 4, !tbaa !7
  store i32 42, ptr %write.src, align 4
  %12 = addrspacecast ptr %write.src to ptr addrspace(4)
  %13 = call i32 @__write_pipe_2_bl_fpga(ptr addrspace(1) %10, ptr addrspace(4) %12, i32 4, i32 4)

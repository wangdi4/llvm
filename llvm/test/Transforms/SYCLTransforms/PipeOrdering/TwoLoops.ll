...
for.cond.cleanup3:                                ; preds = %for.cond1
  %1 = load ptr addrspace(1), ptr addrspace(1) @ch2.pipe, align 8, !tbaa !11
  %2 = load ptr addrspace(1), ptr addrspace(1) @ch2, align 4, !tbaa !11
...
for.body4:                                        ; preds = %for.cond1
  %5 = load ptr addrspace(1), ptr addrspace(1) @ch1.pipe, align 8, !tbaa !11
  %6 = load ptr addrspace(1), ptr addrspace(1) @ch1, align 4, !tbaa !11
  store i32 42, ptr %write.src, align 4

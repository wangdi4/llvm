...
for.body4:                                        ; preds = %for.cond1
  %10 = load %opencl.pipe_rw_t addrspace(1)*, %opencl.pipe_rw_t addrspace(1)* addrspace(1)* @ch1.pipe
  %11 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch1, align 4, !tbaa !18
...
for.end:                                          ; preds = %for.cond.cleanup3
  %16 = load %opencl.pipe_rw_t addrspace(1)*, %opencl.pipe_rw_t addrspace(1)* addrspace(1)* @ch2.pipe
  %17 = load %opencl.channel_t addrspace(1)*, %opencl.channel_t addrspace(1)* addrspace(1)* @ch2, align 4, !tbaa !18
  store i32 42, i32* %write.src
  %18 = bitcast %opencl.pipe_rw_t addrspace(1)* %16 to %opencl.pipe_wo_t addrspace(1)*
  %19 = addrspacecast i32* %write.src to i8 addrspace(4)*
  %20 = call i32 @__write_pipe_2_bl(%opencl.pipe_wo_t addrspace(1)* %18, i8 addrspace(4)* %19, i32 4, i32 4)
  br label %for.inc5

for.inc5:                                         ; preds = %for.end
  %21 = load i32, i32* %i, align 4, !tbaa !16

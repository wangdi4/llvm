...
define dso_local void @foo(ptr addrspace(1) noundef align 4 %iters) #0 !kernel_arg_base_type !3 !kernel_arg_pipe_io !4 !arg_type_null_val !5 {
entry:
...
for.cond:                                         ; preds = %for.body, %entry
  ...
  %0 = load i32, ptr addrspace(1) %iters, align 4, !tbaa !6
...
for.body:                                         ; preds = %for.cond
  %1 = load ptr addrspace(1), ptr addrspace(1) @ch.pipe, align 8, !tbaa !10
  %2 = load ptr addrspace(1), ptr addrspace(1) @ch, align 4, !tbaa !10

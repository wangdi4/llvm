...
for.body:                                         ; preds = %for.body, %entry
  ...
  %0 = load i64, ptr addrspace(1) %arrayidx, align 8, !tbaa !12
  %arrayidx4 = getelementptr inbounds i64, ptr addrspace(1) %dst, i64 %add
  store i64 %0, ptr addrspace(1) %arrayidx4, align 8, !tbaa !12
  %1 = load i64, ptr addrspace(1) %arrayidx, align 8, !tbaa !12
  %arrayidx12 = getelementptr inbounds i64, ptr addrspace(1) %dst2, i64 %add
  store i64 %1, ptr addrspace(1) %arrayidx12, align 8, !tbaa !12

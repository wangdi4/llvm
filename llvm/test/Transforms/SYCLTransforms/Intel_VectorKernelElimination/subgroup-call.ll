...
for.cond.cleanup:                                 ; preds = %for.body
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %i13)
  %call14 = tail call i32 @_Z18get_sub_group_sizev() #8
  store volatile i32 %call14, ptr %i13, align 4, !tbaa !11
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %0 = load i64, ptr addrspace(1) %arrayidx, align 8, !tbaa !15
  %arrayidx4 = getelementptr inbounds i64, ptr addrspace(1) %dst, i64 %add
  store i64 %0, ptr addrspace(1) %arrayidx4, align 8, !tbaa !15
  %1 = load i64, ptr addrspace(1) %arrayidx, align 8, !tbaa !15
  %arrayidx12 = getelementptr inbounds i64, ptr addrspace(1) %dst2, i64 %add
  store i64 %1, ptr addrspace(1) %arrayidx12, align 8, !tbaa !15
...
; Function Attrs: convergent norecurse nounwind
define dso_local void @_ZGVbN4uuu_test(ptr addrspace(1) noundef align 8 %dst, ptr addrspace(1) noundef align 8 %dst2, ptr addrspace(1) noundef align 8 %src) local_unnamed_addr #4 !kernel_arg_addr_space !1 !kernel_arg_access_qual !2 !kernel_arg_type !3 !kernel_arg_base_type !3 !kernel_arg_type_qual !4 !kernel_arg_name !5 !kernel_arg_host_accessible !6 !kernel_arg_pipe_depth !7 !kernel_arg_pipe_io !4 !kernel_arg_buffer_location !4 !no_barrier_path !8 !kernel_has_sub_groups !8 !vectorized_width !17 !vectorization_dimension !18 !can_unite_workgroups !19 !scalar_kernel !0 {
entry:
  %call = tail call i64 @_Z13get_global_idj(i32 noundef 0) #7
  %0 = trunc i64 %call to i32
  %call14 = tail call i32 @_Z18get_sub_group_sizev() #8
  %i13.vec = alloca <4 x i32>, align 16
  %i13.vec.base.addr = getelementptr i32, ptr %i13.vec, <4 x i64> <i64 0, i64 1, i64 2, i64 3>
  %i13.vec.base.addr.extract.3. = extractelement <4 x ptr> %i13.vec.base.addr, i64 3
  %i13.vec.base.addr.extract.2. = extractelement <4 x ptr> %i13.vec.base.addr, i64 2
  %i13.vec.base.addr.extract.1. = extractelement <4 x ptr> %i13.vec.base.addr, i64 1
  %i13.vec.base.addr.extract.0. = extractelement <4 x ptr> %i13.vec.base.addr, i64 0
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %i13.vec)
...
VPlannedBB4:                                      ; preds = %VPlannedBB4, %entry
  ...
  %6 = icmp eq i64 %5, 64
  br i1 %6, label %VPlannedBB17, label %VPlannedBB4

VPlannedBB17:                                     ; preds = %VPlannedBB4
  store volatile i32 %call14, ptr %i13.vec.base.addr.extract.0., align 4
  store volatile i32 %call14, ptr %i13.vec.base.addr.extract.1., align 4
  store volatile i32 %call14, ptr %i13.vec.base.addr.extract.2., align 4
  store volatile i32 %call14, ptr %i13.vec.base.addr.extract.3., align 4
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %i13.vec)
  ret void
}

; Function Attrs: nocallback nofree nosync nounwind readonly willreturn
declare <4 x i64> @llvm.masked.gather.v4i64.v4p1(<4 x ptr addrspace(1)>, i32 immarg, <4 x i1>, <4 x i64>) #5

; Function Attrs: nocallback nofree nosync nounwind willreturn writeonly
declare void @llvm.masked.scatter.v4i64.v4p1(<4 x i64>, <4 x ptr addrspace(1)>, i32 immarg, <4 x i1>) #6

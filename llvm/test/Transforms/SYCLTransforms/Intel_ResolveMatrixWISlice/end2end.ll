...
_ZZZ17matrix_verify_addItLm16ELm16EEvN2cl4sycl5queueER10big_matrixIT_XT0_EXT1_EERNS1_8nd_rangeILi2EEEfENKUlRNS1_7handlerEE_clESB_ENKUlNS1_7nd_itemILi2EEEE_clESE_.exit: ; preds = %for.cond.i
  ...
  %add.ptr.i51.i = getelementptr inbounds i16, ptr addrspace(1) %_arg_, i64 %mul21.i
  %div.i = and i64 %sub5.i, -8
  %add.ptr.i.i = getelementptr inbounds i16, ptr addrspace(1) %add.ptr.i51.i, i64 %div.i
  %call.ascast.i.i = addrspacecast ptr addrspace(1) %add.ptr.i.i to ptr addrspace(4)
  tail call void @llvm.experimental.matrix.store.v128i16.p4(<128 x i16> %sub_a.sroa.0.0.i, ptr addrspace(4) %call.ascast.i.i, i64 16, i1 false, i32 8, i32 16, metadata !"matrix.rowmajor", metadata !"matrix.rowmajor", metadata !"scope.subgroup", metadata !"matrix.use.unnecessary") #7
  ret void
}
...
!4 = !{}
!5 = !{i16 6, i16 14}
!6 = !{ptr @_ZTSZZ17matrix_verify_addItLm16ELm16EEvN2cl4sycl5queueER10big_matrixIT_XT0_EXT1_EERNS1_8nd_rangeILi2EEEfENKUlRNS1_7handlerEE_clESB_E10add_matrix}
...
!17 = !{i32 38, i32 2}
!18 = !{i32 44, i32 8}
!19 = !{ptr addrspace(1) null, ptr null, ptr null, ptr null}
...
; CHECK-NEXT:    [[ADD_PTR_I51_I:%.*]] = getelementptr inbounds i16, ptr addrspace(1) [[_ARG_:%.*]], i64 [[MUL21_I]]
; CHECK-NEXT:    [[DIV_I:%.*]] = and i64 [[SUB5_I]], -8
; CHECK-NEXT:    [[ADD_PTR_I_I:%.*]] = getelementptr inbounds i16, ptr addrspace(1) [[ADD_PTR_I51_I]], i64 [[DIV_I]]
; CHECK-NEXT:    [[CALL_ASCAST_I_I:%.*]] = addrspacecast ptr addrspace(1) [[ADD_PTR_I_I]] to ptr addrspace(4)
; CHECK-NEXT:    tail call void @llvm.experimental.matrix.store.v128i16.p4(<128 x i16> [[SUB_A_SROA_0_0_I_LCSSA]], ptr addrspace(4) [[CALL_ASCAST_I_I]], i64 16, i1 false, i32 8, i32 16, metadata !"matrix.rowmajor", metadata !"matrix.rowmajor", metadata !"scope.subgroup", metadata !"matrix.use.unnecessary")
; CHECK-NEXT:    ret void
;
;
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[ALLOCA__ARG_:%.*]] = alloca ptr addrspace(1), align 8
; CHECK-NEXT:    store ptr addrspace(1) [[_ARG_:%.*]], ptr [[ALLOCA__ARG_]], align 8
; CHECK-NEXT:    [[TMP0:%.*]] = tail call i64 @_Z13get_global_idj(i32 0)
; CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @_Z13get_global_idj(i32 1)
; CHECK-NEXT:    [[TMP2:%.*]] = tail call i64 @_Z12get_local_idj(i32 0)
...
; CHECK-NEXT:    [[LOAD__ARG_:%.*]] = load ptr addrspace(1), ptr [[ALLOCA__ARG_]], align 8
...
; CHECK-NEXT:    [[SCALAR_GEP:%.*]] = getelementptr inbounds i16, ptr addrspace(1) [[LOAD__ARG_]], i64 [[TMP35]]
; CHECK-NEXT:    [[TMP36:%.*]] = and i64 [[TMP33]], -8
; CHECK-NEXT:    [[SCALAR_GEP34:%.*]] = getelementptr inbounds i16, ptr addrspace(1) [[SCALAR_GEP]], i64 [[TMP36]]
; CHECK-NEXT:    [[TMP37:%.*]] = addrspacecast ptr addrspace(1) [[SCALAR_GEP34]] to ptr addrspace(4)
; CHECK-NEXT:    tail call void @llvm.experimental.matrix.store.v128i16.p4(<128 x i16> [[UNI_PHI31]], ptr addrspace(4) [[TMP37]], i64 16, i1 false, i32 8, i32 16, metadata !"matrix.rowmajor", metadata !"matrix.rowmajor", metadata !"scope.subgroup", metadata !"matrix.use.unnecessary")
...
; CHECK-NEXT:    [[MUL21_I:%.*]] = shl nsw i64 [[SUB_I]], 7
; CHECK-NEXT:    [[ADD_PTR_I51_I:%.*]] = getelementptr inbounds i16, ptr addrspace(1) [[LOAD__ARG_]], i64 [[MUL21_I]]
; CHECK-NEXT:    [[DIV_I:%.*]] = and i64 [[SUB5_I]], -8
; CHECK-NEXT:    [[ADD_PTR_I_I:%.*]] = getelementptr inbounds i16, ptr addrspace(1) [[ADD_PTR_I51_I]], i64 [[DIV_I]]
; CHECK-NEXT:    [[CALL_ASCAST_I_I:%.*]] = addrspacecast ptr addrspace(1) [[ADD_PTR_I_I]] to ptr addrspace(4)
; CHECK-NEXT:    tail call void @llvm.experimental.matrix.store.v128i16.p4(<128 x i16> [[SUB_A_SROA_0_0_I_LCSSA]], ptr addrspace(4) [[CALL_ASCAST_I_I]], i64 16, i1 false, i32 8, i32 16, metadata !"matrix.rowmajor", metadata !"matrix.rowmajor", metadata !"scope.subgroup", metadata !"matrix.use.unnecessary")

...
; CHECK-NEXT: store volatile i64 %GlobalID_2, i64* %__ocl_dbg_gid2, align 8
  ...
  store i32 addrspace(1)* %dst, i32 addrspace(1)** %dst.addr, align 8
  call void @llvm.dbg.declare(metadata i32 addrspace(1)** %dst.addr, metadata !37, metadata !DIExpression()), !dbg !38
  call void @llvm.dbg.declare(metadata i64* %gid, metadata !39, metadata !DIExpression()), !dbg !40
  %call = call i64 @_Z13get_global_idj(i32 noundef 0) #6, !dbg !41
  store i64 %call, i64* %gid, align 8, !dbg !40
  call void @_Z7barrierj(i32 noundef 1) #7, !dbg !42
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %dst.addr, align 8, !dbg !43
  %1 = load i64, i64* %gid, align 8, !dbg !44
  %call1 = call i32 @foo(i32 addrspace(1)* noundef %0, i64 noundef %1) #5, !dbg !45

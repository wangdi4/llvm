...
@out = addrspace(1) global target("spirv.Channel") zeroinitializer, align 4, !packet_size !0, !packet_align !0
@in = addrspace(1) global target("spirv.Channel") zeroinitializer, align 4, !packet_size !0, !packet_align !0
...
scalar_kernel_entry:                              ; preds = %scalar_kernel_entry, %dim_0_pre_head
  ...
  %11 = load ptr addrspace(1), ptr addrspace(1) @in, align 4, !tbaa !13
  %call = call i32 @_Z18read_channel_intel11ocl_channeli(ptr addrspace(1) %11) #4

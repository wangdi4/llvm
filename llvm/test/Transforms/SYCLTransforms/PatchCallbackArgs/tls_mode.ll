...
define void @test() #0 !kernel_arg_addr_space !2 !kernel_arg_access_qual !2 !kernel_arg_type !2 !kernel_arg_base_type !2 !kernel_arg_type_qual !2 !kernel_arg_host_accessible !2 !kernel_arg_pipe_depth !2 !kernel_arg_pipe_io !2 !kernel_arg_buffer_location !2 !kernel_arg_name !2 !use_addrspace_qualifier_func !5 {
entry:
  ...
  %call3 = call ptr @__get_buffer_range_info() #2
...
; CHECK-NEXT: %4 = load ptr, ptr @__pBufferRanges
  ret void
}
...
; Function Attrs: convergent
declare ptr @__get_buffer_range_info() #1

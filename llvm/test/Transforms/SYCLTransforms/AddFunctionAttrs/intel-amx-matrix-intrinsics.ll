...
define void @load_mad_store(ptr addrspace(4) %ptr, i64 %Stride, <616 x i8> %x, <560 x i8> %y) {
  ...
  %2 = call <110 x i32> @llvm.experimental.matrix.mad.v110i32.v616i8.v560i8(<616 x i8> %x, <560 x i8> %y, <110 x i32> %1, i32 11, i32 56, i32 10, metadata !"scope.subgroup")
...
declare <110 x i32> @llvm.experimental.matrix.mad.v110i32.v616i8.v560i8(<616 x i8>, <560 x i8>, <110 x i32>, i32, i32, i32, metadata)

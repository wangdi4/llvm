...
; CHECK: call i32 (i8 addrspace(2)*, ...) @printf({{.*}} #[[ATTR:[0-9]+]]
...
entry:
  %call = call i32 (i8 addrspace(2)*, ...) @printf(i8 addrspace(2)* noundef getelementptr inbounds ([4 x i8], [4 x i8] addrspace(2)* @.str, i64 0, i64 0), i32 noundef 15) #2
  ret void
}

; Function Attrs: convergent
declare i32 @printf(i8 addrspace(2)* noundef, ...) #1

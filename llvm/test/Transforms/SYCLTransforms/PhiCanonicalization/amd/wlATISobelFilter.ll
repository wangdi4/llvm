...
; NOSKIP: phi-split-bb:                                     ; preds = %land.lhs.true10, %if.then
...
if.then:                                          ; preds = %land.lhs.true10
  ...
  %arrayidx = getelementptr i8, i8 addrspace(2)* %inputImage, i32 %add
  %tmp21 = load i8, i8 addrspace(2)* %arrayidx, align 1
  %conv = zext i8 %tmp21 to i32
  %add27 = add i32 %mul, %call
  %arrayidx29 = getelementptr i8, i8 addrspace(2)* %inputImage, i32 %add27
  %tmp30 = load i8, i8 addrspace(2)* %arrayidx29, align 1
  %conv31 = zext i8 %tmp30 to i32
  %mul32 = shl nuw nsw i32 %conv31, 1
  %add35 = add i32 %call, 4
  %add40 = add i32 %mul, %add35
  %arrayidx42 = getelementptr i8, i8 addrspace(2)* %inputImage, i32 %add40
  %tmp43 = load i8, i8 addrspace(2)* %arrayidx42, align 1
  %conv44 = zext i8 %tmp43 to i32
  %add50 = add i32 %call1, 1
  %mul51 = mul i32 %call2, %add50
  %add52 = add i32 %mul51, %sub16
  %arrayidx54 = getelementptr i8, i8 addrspace(2)* %inputImage, i32 %add52
  %tmp55 = load i8, i8 addrspace(2)* %arrayidx54, align 1
  %conv56 = zext i8 %tmp55 to i32
  %add63 = add i32 %mul51, %call
  %arrayidx65 = getelementptr i8, i8 addrspace(2)* %inputImage, i32 %add63
  %tmp66 = load i8, i8 addrspace(2)* %arrayidx65, align 1
  %conv67 = zext i8 %tmp66 to i32
  %mul68 = shl nuw nsw i32 %conv67, 1
  %add76 = add i32 %mul51, %add35
  %arrayidx78 = getelementptr i8, i8 addrspace(2)* %inputImage, i32 %add76
  %tmp79 = load i8, i8 addrspace(2)* %arrayidx78, align 1
  ...
  %arrayidx125 = getelementptr i8, i8 addrspace(2)* %inputImage, i32 %add123
  %tmp126 = load i8, i8 addrspace(2)* %arrayidx125, align 1
  %conv127 = zext i8 %tmp126 to i32
  %mul128 = shl nuw nsw i32 %conv127, 1
  %add148 = add i32 %mul122, %add35
  %arrayidx150 = getelementptr i8, i8 addrspace(2)* %inputImage, i32 %add148
  %tmp151 = load i8, i8 addrspace(2)* %arrayidx150, align 1
  ...
  %arrayidx197 = getelementptr i8, i8 addrspace(1)* %outputImage, i32 %add195
...
; DEBUGIFY-NOSKIP: WARNING: Instruction with empty DebugLoc in function sobel_filter --  br label %phi-split-bb1
; DEBUGIFY-NOSKIP: WARNING: Instruction with empty DebugLoc in function sobel_filter --  br label %if.end

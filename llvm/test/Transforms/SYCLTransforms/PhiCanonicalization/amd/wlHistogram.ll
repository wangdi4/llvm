...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %tmp5 = load i32, i32 addrspace(1)* %arrayidx, align 4
  %arrayidx7 = getelementptr i32, i32 addrspace(1)* %puiOutputArray, i32 %tmp5
  %tmp8 = load i32, i32 addrspace(1)* %arrayidx7, align 4
  %inc = add i32 %tmp8, 1
...
for.body66.us:                                    ; preds = %for.body66.lr.ph.us, %for.body66.us
  ...
  %tmp70.us = load i32, i32 addrspace(1)* %arrayidx69.us, align 4
  ...
  %tmp74.us = load i32, i32 addrspace(1)* %arrayidx73.us, align 4
...
for.body18.us:                                    ; preds = %for.body18.lr.ph.us, %for.body18.us
  ...
  %tmp21.us = load i32, i32 addrspace(1)* %arrayidx.us, align 4
  ...
  %tmp25.us = load i32, i32 addrspace(1)* %arrayidx24.us, align 4
...
for.body18.us:                                    ; preds = %for.body18.lr.ph.us, %for.body18.us
  ...
  %tmp21.us = load <2 x i32>, <2 x i32> addrspace(1)* %arrayidx.us, align 8
  %add.ptr.sum.us = add i32 %storemerge13.us, %mul9.us
  %arrayidx24.us = getelementptr <2 x i32>, <2 x i32> addrspace(1)* %puiTmpArray, i32 %add.ptr.sum.us
  %tmp25.us = load <2 x i32>, <2 x i32> addrspace(1)* %arrayidx24.us, align 8
...
for.body18.us:                                    ; preds = %for.body18.lr.ph.us, %for.body18.us
  ...
  %tmp21.us = load <4 x i32>, <4 x i32> addrspace(1)* %arrayidx.us, align 16
  %add.ptr.sum.us = add i32 %storemerge13.us, %mul9.us
  %arrayidx24.us = getelementptr <4 x i32>, <4 x i32> addrspace(1)* %puiTmpArray, i32 %add.ptr.sum.us
  %tmp25.us = load <4 x i32>, <4 x i32> addrspace(1)* %arrayidx24.us, align 16
...
for.body18.us:                                    ; preds = %for.body18.lr.ph.us, %for.body18.us
  ...
  %tmp21.us = load <8 x i32>, <8 x i32> addrspace(1)* %arrayidx.us, align 32
  %add.ptr.sum.us = add i32 %storemerge13.us, %mul9.us
  %arrayidx24.us = getelementptr <8 x i32>, <8 x i32> addrspace(1)* %puiTmpArray, i32 %add.ptr.sum.us
  %tmp25.us = load <8 x i32>, <8 x i32> addrspace(1)* %arrayidx24.us, align 32
...
for.body18.us:                                    ; preds = %for.body18.lr.ph.us, %for.body18.us
  ...
  %tmp21.us = load <16 x i32>, <16 x i32> addrspace(1)* %arrayidx.us, align 64
  %add.ptr.sum.us = add i32 %storemerge13.us, %mul9.us
  %arrayidx24.us = getelementptr <16 x i32>, <16 x i32> addrspace(1)* %puiTmpArray, i32 %add.ptr.sum.us
  %tmp25.us = load <16 x i32>, <16 x i32> addrspace(1)* %arrayidx24.us, align 64

...
entry:
  ...
  %tmp6 = load float, float addrspace(1)* %arrayidx5, align 4
  ...
  %tmp16 = load float, float addrspace(1)* %arrayidx15, align 4
...
if.then:                                          ; preds = %for.body
  ...
  %tmp39 = load float, float addrspace(3)* %arrayidx38, align 4
  %arrayidx42 = getelementptr float, float addrspace(3)* %block, i32 %sub
  %tmp43 = load float, float addrspace(3)* %arrayidx42, align 4
...
if.then69:                                        ; preds = %for.body63
  ...
  %tmp90 = load float, float addrspace(3)* %arrayidx89, align 4
  %arrayidx96 = getelementptr float, float addrspace(3)* %block, i32 %sub85
  %tmp97 = load float, float addrspace(3)* %arrayidx96, align 4
...
for.end108:                                       ; preds = %for.end108.loopexit, %for.cond59.preheader
  ...
  %tmp117 = load float, float addrspace(3)* %arrayidx, align 4
  ...
  %tmp128 = load float, float addrspace(3)* %arrayidx10, align 4

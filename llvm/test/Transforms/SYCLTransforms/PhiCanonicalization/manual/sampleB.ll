...
; NOSKIP: phi-split-bb:                                     ; preds = %for.cond.preheader, %if.end42.loopexit
; NOSKIP: ret
...
; DEBUGIFY-NOSKIP: WARNING: Instruction with empty DebugLoc in function func --  br label %if.end42

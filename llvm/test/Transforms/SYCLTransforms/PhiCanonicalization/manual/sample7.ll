...
; NOSKIP: phi-split-bb:                                     ; preds = %for.cond8.preheader, %for.end22.loopexit
; NOSKIP: ret
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %tmp3 = load i64, i64* %arrayidx, align 8
...
for.body12:                                       ; preds = %for.body12.preheader, %for.body12
  ...
  %arrayidx15 = getelementptr inbounds i64, i64* %B, i64 %storemerge6
  %tmp16 = load i64, i64* %arrayidx15, align 8
...
; DEBUGIFY-NOSKIP: WARNING: Instruction with empty DebugLoc in function func --  br label %for.end22

...
; xmain will use the "not" form in the selects.
; also note: --match-full-lines has been removed; it's incompatible with
; the updater.
...
; CHECK-NEXT:    [[C_2:%.*]] = icmp uge ptr [[C:%.*]], [[D:%.*]], !annotation !0
; CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[C_1_NOT]], i1 true, i1 [[C_2]], !annotation !0 ;INTEL

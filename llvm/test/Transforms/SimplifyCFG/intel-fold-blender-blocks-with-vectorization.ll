...
; RUN: opt -opaque-pointers=0 -passes=simplifycfg -mtriple=i686-linux -mattr=+avx2 -enable-intel-advanced-opts=true -mattr=-prefer-256-bit %s -S 2>&1 | FileCheck %s --check-prefixes=CHECK

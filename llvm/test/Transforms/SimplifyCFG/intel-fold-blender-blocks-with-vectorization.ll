...
define hidden fastcc i32 @_ZL17bvh_node_hit_testI8VBVHNodeEiPT_P5Isect(ptr nocapture readonly %node, ptr nocapture readonly %isec) unnamed_addr #0 {
; CHECK-LABEL: @_ZL17bvh_node_hit_testI8VBVHNodeEiPT_P5Isect(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[BV_INDEX_I:%.*]] = getelementptr inbounds [[STRUCT_ISECT:%.*]], ptr [[ISEC:%.*]], i64 0, i32 5, !intel-tbaa !5
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[BV_INDEX_I]], align 4, !tbaa [[TBAA17:![0-9]+]]
; CHECK-NEXT:    [[IDXPROM_I:%.*]] = sext i32 [[TMP0]] to i64
; CHECK-NEXT:    [[PTRIDX_I:%.*]] = getelementptr inbounds float, ptr [[NODE:%.*]], i64 [[IDXPROM_I]]
; CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[PTRIDX_I]], align 4, !tbaa [[TBAA18:![0-9]+]]
; CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[ISEC]], align 8, !tbaa [[TBAA19:![0-9]+]]
; CHECK-NEXT:    [[SUB_I:%.*]] = fsub fast float [[TMP1]], [[TMP2]]
; CHECK-NEXT:    [[IDOT_AXIS_I:%.*]] = getelementptr inbounds [[STRUCT_ISECT]], ptr [[ISEC]], i64 0, i32 6, !intel-tbaa !20
; CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[IDOT_AXIS_I]], align 4, !tbaa [[TBAA21:![0-9]+]]
; CHECK-NEXT:    [[MUL_I:%.*]] = fmul fast float [[SUB_I]], [[TMP3]]
; CHECK-NEXT:    [[ARRAYIDX4_I:%.*]] = getelementptr inbounds [6 x i32], ptr [[BV_INDEX_I]], i64 0, i64 1, !intel-tbaa !22
; CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[ARRAYIDX4_I]], align 4, !tbaa [[TBAA17]]
; CHECK-NEXT:    [[IDXPROM5_I:%.*]] = sext i32 [[TMP4]] to i64
; CHECK-NEXT:    [[PTRIDX6_I:%.*]] = getelementptr inbounds float, ptr [[NODE]], i64 [[IDXPROM5_I]]
; CHECK-NEXT:    [[TMP5:%.*]] = load float, ptr [[PTRIDX6_I]], align 4, !tbaa [[TBAA18]]
; CHECK-NEXT:    [[SUB9_I:%.*]] = fsub fast float [[TMP5]], [[TMP2]]
; CHECK-NEXT:    [[MUL12_I:%.*]] = fmul fast float [[SUB9_I]], [[TMP3]]
; CHECK-NEXT:    [[ARRAYIDX14_I:%.*]] = getelementptr inbounds [6 x i32], ptr [[BV_INDEX_I]], i64 0, i64 2, !intel-tbaa !22
; CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[ARRAYIDX14_I]], align 4, !tbaa [[TBAA17]]
; CHECK-NEXT:    [[IDXPROM15_I:%.*]] = sext i32 [[TMP6]] to i64
; CHECK-NEXT:    [[PTRIDX16_I:%.*]] = getelementptr inbounds float, ptr [[NODE]], i64 [[IDXPROM15_I]]
; CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[PTRIDX16_I]], align 4, !tbaa [[TBAA18]]
; CHECK-NEXT:    [[ARRAYIDX18_I:%.*]] = getelementptr inbounds [3 x float], ptr [[ISEC]], i64 0, i64 1, !intel-tbaa !23
; CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[ARRAYIDX18_I]], align 4, !tbaa [[TBAA19]]
; CHECK-NEXT:    [[SUB19_I:%.*]] = fsub fast float [[TMP7]], [[TMP8]]
; CHECK-NEXT:    [[ARRAYIDX21_I:%.*]] = getelementptr inbounds [3 x float], ptr [[IDOT_AXIS_I]], i64 0, i64 1, !intel-tbaa !23
; CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[ARRAYIDX21_I]], align 4, !tbaa [[TBAA21]]
; CHECK-NEXT:    [[MUL22_I:%.*]] = fmul fast float [[SUB19_I]], [[TMP9]]
; CHECK-NEXT:    [[ARRAYIDX24_I:%.*]] = getelementptr inbounds [6 x i32], ptr [[BV_INDEX_I]], i64 0, i64 3, !intel-tbaa !22
; CHECK-NEXT:    [[TMP10:%.*]] = load i32, ptr [[ARRAYIDX24_I]], align 4, !tbaa [[TBAA17]]
; CHECK-NEXT:    [[IDXPROM25_I:%.*]] = sext i32 [[TMP10]] to i64
; CHECK-NEXT:    [[PTRIDX26_I:%.*]] = getelementptr inbounds float, ptr [[NODE]], i64 [[IDXPROM25_I]]
; CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[PTRIDX26_I]], align 4, !tbaa [[TBAA18]]
; CHECK-NEXT:    [[SUB29_I:%.*]] = fsub fast float [[TMP11]], [[TMP8]]
; CHECK-NEXT:    [[MUL32_I:%.*]] = fmul fast float [[SUB29_I]], [[TMP9]]
; CHECK-NEXT:    [[ARRAYIDX34_I:%.*]] = getelementptr inbounds [6 x i32], ptr [[BV_INDEX_I]], i64 0, i64 4, !intel-tbaa !22
; CHECK-NEXT:    [[TMP12:%.*]] = load i32, ptr [[ARRAYIDX34_I]], align 4, !tbaa [[TBAA17]]
; CHECK-NEXT:    [[IDXPROM35_I:%.*]] = sext i32 [[TMP12]] to i64
; CHECK-NEXT:    [[PTRIDX36_I:%.*]] = getelementptr inbounds float, ptr [[NODE]], i64 [[IDXPROM35_I]]
; CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[PTRIDX36_I]], align 4, !tbaa [[TBAA18]]
; CHECK-NEXT:    [[ARRAYIDX38_I:%.*]] = getelementptr inbounds [3 x float], ptr [[ISEC]], i64 0, i64 2, !intel-tbaa !23
; CHECK-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX38_I]], align 8, !tbaa [[TBAA19]]
; CHECK-NEXT:    [[SUB39_I:%.*]] = fsub fast float [[TMP13]], [[TMP14]]
; CHECK-NEXT:    [[ARRAYIDX41_I:%.*]] = getelementptr inbounds [3 x float], ptr [[IDOT_AXIS_I]], i64 0, i64 2, !intel-tbaa !23
; CHECK-NEXT:    [[TMP15:%.*]] = load float, ptr [[ARRAYIDX41_I]], align 4, !tbaa [[TBAA21]]
; CHECK-NEXT:    [[MUL42_I:%.*]] = fmul fast float [[SUB39_I]], [[TMP15]]
; CHECK-NEXT:    [[ARRAYIDX44_I:%.*]] = getelementptr inbounds [6 x i32], ptr [[BV_INDEX_I]], i64 0, i64 5, !intel-tbaa !22
; CHECK-NEXT:    [[TMP16:%.*]] = load i32, ptr [[ARRAYIDX44_I]], align 4, !tbaa [[TBAA17]]
; CHECK-NEXT:    [[IDXPROM45_I:%.*]] = sext i32 [[TMP16]] to i64
; CHECK-NEXT:    [[PTRIDX46_I:%.*]] = getelementptr inbounds float, ptr [[NODE]], i64 [[IDXPROM45_I]]
; CHECK-NEXT:    [[TMP17:%.*]] = load float, ptr [[PTRIDX46_I]], align 4, !tbaa [[TBAA18]]
...
; CHECK-NEXT:    br i1 [[OR_COND133_I]], label [[_ZL27RAYOBJECT_BB_INTERSECT_TESTPK5ISECTPKF_EXIT:%.*]], label [[IF_END_I:%.*]]
; CHECK:       if.end.i:
...
; CHECK-NEXT:    br i1 [[OR_COND84_I]], label [[_ZL27RAYOBJECT_BB_INTERSECT_TESTPK5ISECTPKF_EXIT]], label [[IF_END68_I:%.*]]
; CHECK:       if.end68.i:
; CHECK-NEXT:    [[DIST_I:%.*]] = getelementptr inbounds [[STRUCT_ISECT]], ptr [[ISEC]], i64 0, i32 2, !intel-tbaa !24
; CHECK-NEXT:    [[TMP18:%.*]] = load float, ptr [[DIST_I]], align 8, !tbaa [[TBAA24:![0-9]+]]
; CHECK-NEXT:    [[CMP69_I:%.*]] = fcmp fast ule float [[MUL_I]], [[TMP18]]
; CHECK-NEXT:    [[CMP72_I:%.*]] = fcmp fast ule float [[MUL22_I]], [[TMP18]]
; CHECK-NEXT:    [[OR_COND134_I:%.*]] = select i1 [[CMP69_I]], i1 [[CMP72_I]], i1 false
; CHECK-NEXT:    [[CMP75_I:%.*]] = fcmp fast ule float [[MUL42_I]], [[TMP18]]
; CHECK-NEXT:    [[OR_COND135_I:%.*]] = select i1 [[OR_COND134_I]], i1 [[CMP75_I]], i1 false
; CHECK-NEXT:    [[TMP19:%.*]] = zext i1 [[OR_COND135_I]] to i32
...
; CHECK-NEXT:    [[RETVAL_0_I:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ 0, [[IF_END_I]] ], [ [[TMP19]], [[IF_END68_I]] ]
; CHECK-NEXT:    ret i32 [[RETVAL_0_I]]
;
entry:
  %bv_index.i = getelementptr inbounds %struct.Isect, ptr %isec, i64 0, i32 5, !intel-tbaa !12
  %0 = load i32, ptr %bv_index.i, align 4, !tbaa !22
  %idxprom.i = sext i32 %0 to i64
  %ptridx.i = getelementptr inbounds float, ptr %node, i64 %idxprom.i
  %1 = load float, ptr %ptridx.i, align 4, !tbaa !23
  %2 = load float, ptr %isec, align 8, !tbaa !26
  %sub.i = fsub fast float %1, %2
  %idot_axis.i = getelementptr inbounds %struct.Isect, ptr %isec, i64 0, i32 6, !intel-tbaa !27
  %3 = load float, ptr %idot_axis.i, align 4, !tbaa !28
  %mul.i = fmul fast float %sub.i, %3
  %arrayidx4.i = getelementptr inbounds [6 x i32], ptr %bv_index.i, i64 0, i64 1, !intel-tbaa !21
  %4 = load i32, ptr %arrayidx4.i, align 4, !tbaa !22
  %idxprom5.i = sext i32 %4 to i64
  %ptridx6.i = getelementptr inbounds float, ptr %node, i64 %idxprom5.i
  %5 = load float, ptr %ptridx6.i, align 4, !tbaa !23
  %sub9.i = fsub fast float %5, %2
  %mul12.i = fmul fast float %sub9.i, %3
  %arrayidx14.i = getelementptr inbounds [6 x i32], ptr %bv_index.i, i64 0, i64 2, !intel-tbaa !21
  %6 = load i32, ptr %arrayidx14.i, align 4, !tbaa !22
  %idxprom15.i = sext i32 %6 to i64
  %ptridx16.i = getelementptr inbounds float, ptr %node, i64 %idxprom15.i
  %7 = load float, ptr %ptridx16.i, align 4, !tbaa !23
  %arrayidx18.i = getelementptr inbounds [3 x float], ptr %isec, i64 0, i64 1, !intel-tbaa !25
  %8 = load float, ptr %arrayidx18.i, align 4, !tbaa !26
  %sub19.i = fsub fast float %7, %8
  %arrayidx21.i = getelementptr inbounds [3 x float], ptr %idot_axis.i, i64 0, i64 1, !intel-tbaa !25
  %9 = load float, ptr %arrayidx21.i, align 4, !tbaa !28
  %mul22.i = fmul fast float %sub19.i, %9
  %arrayidx24.i = getelementptr inbounds [6 x i32], ptr %bv_index.i, i64 0, i64 3, !intel-tbaa !21
  %10 = load i32, ptr %arrayidx24.i, align 4, !tbaa !22
  %idxprom25.i = sext i32 %10 to i64
  %ptridx26.i = getelementptr inbounds float, ptr %node, i64 %idxprom25.i
  %11 = load float, ptr %ptridx26.i, align 4, !tbaa !23
  %sub29.i = fsub fast float %11, %8
  %mul32.i = fmul fast float %sub29.i, %9
  %arrayidx34.i = getelementptr inbounds [6 x i32], ptr %bv_index.i, i64 0, i64 4, !intel-tbaa !21
  %12 = load i32, ptr %arrayidx34.i, align 4, !tbaa !22
  %idxprom35.i = sext i32 %12 to i64
  %ptridx36.i = getelementptr inbounds float, ptr %node, i64 %idxprom35.i
  %13 = load float, ptr %ptridx36.i, align 4, !tbaa !23
  %arrayidx38.i = getelementptr inbounds [3 x float], ptr %isec, i64 0, i64 2, !intel-tbaa !25
  %14 = load float, ptr %arrayidx38.i, align 8, !tbaa !26
  %sub39.i = fsub fast float %13, %14
  %arrayidx41.i = getelementptr inbounds [3 x float], ptr %idot_axis.i, i64 0, i64 2, !intel-tbaa !25
  %15 = load float, ptr %arrayidx41.i, align 4, !tbaa !28
  %mul42.i = fmul fast float %sub39.i, %15
  %arrayidx44.i = getelementptr inbounds [6 x i32], ptr %bv_index.i, i64 0, i64 5, !intel-tbaa !21
  %16 = load i32, ptr %arrayidx44.i, align 4, !tbaa !22
  %idxprom45.i = sext i32 %16 to i64
  %ptridx46.i = getelementptr inbounds float, ptr %node, i64 %idxprom45.i
  %17 = load float, ptr %ptridx46.i, align 4, !tbaa !23
...
if.end68.i:                                       ; preds = %if.end.i
  %dist.i = getelementptr inbounds %struct.Isect, ptr %isec, i64 0, i32 2, !intel-tbaa !29
  %18 = load float, ptr %dist.i, align 8, !tbaa !29

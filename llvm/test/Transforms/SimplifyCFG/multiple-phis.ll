...
; RUN: opt -S < %s -convert-to-subscript | opt -passes='simplifycfg<no-keep-loops>' -S | FileCheck --check-prefix=CHECK-SUBS %s
...
; CHECK-SUBS-NEXT:    [[ARRAYIDX:%.*]] = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 0, i64 4, i32* elementtype(i32) [[R:%.*]], i64 [[IDXPROM]]

...
; CHECK-NEXT:    [[EXPENSIVE:%.*]] = icmp eq i32 [[Y:%.*]], 0
; CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[EXPECTED_TRUE_NOT]], i1 true, i1 [[EXPENSIVE]] ;INTEL
...
; CHECK-NEXT:    [[EXPECTED_TRUE_NOT:%.*]] = xor i1 [[EXPECTED_TRUE]], true ;INTEL
; CHECK-NEXT:    [[EXPENSIVE:%.*]] = icmp eq i32 [[Y:%.*]], 0
; CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[EXPECTED_TRUE_NOT]], i1 [[EXPENSIVE]], i1 false ;INTEL
...
; CHECK-NEXT:    [[EXPENSIVE:%.*]] = icmp eq i32 [[Y:%.*]], 0
; CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[EXPECTED_FALSE_NOT]], i1 [[EXPENSIVE]], i1 false ;INTEL

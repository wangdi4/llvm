...
; INTEL_CUSTOMIZATION
; xmain is not doing IC/IS inside SimplifyCFG. It's OK as these are run in a
; separate pass.
...
; CHECK-NEXT:    [[A_NOT1:%.*]] = xor i1 [[A_NOT]], true ;INTEL
; CHECK-NEXT:    [[C:%.*]] = or i1 [[B:%.*]], false
; CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[A_NOT1]], i1 [[C]], i1 false ;INTEL
...
; CHECK-NEXT:    [[TMP0:%.*]] = select i1 [[BRMERGE]], i32 [[DOTMUX]], i32 1, !prof [[PROF14:![0-9]+]] ;INTEL
...
; CHECK-NEXT:    [[TMP0:%.*]] = select i1 [[BRMERGE]], i32 [[DOTMUX]], i32 1, !prof [[PROF16:![0-9]+]] ;INTEL
; CHECK-NEXT:    ret i32 [[TMP0]] ;INTEL
;
block1:
...
; CHECK-NEXT:    [[TMP0:%.*]] = select i1 [[BRMERGE]], i32 [[DOTMUX]], i32 1, !prof [[PROF18:![0-9]+]] ;INTEL
; CHECK-NEXT:    ret i32 [[TMP0]] ;INTEL
;
block1:
  br i1 %cmpa, label %block2, label %block3, !prof !13
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[EXPECTED_TRUE:%.*]] = icmp sgt i32 [[X:%.*]], -1 ;INTEL
; CHECK-NEXT:    [[EXPECTED_TRUE_NOT:%.*]] = xor i1 [[EXPECTED_TRUE]], true ;INTEL
; CHECK-NEXT:    [[EXPECTED_TRUE_NOT1:%.*]] = xor i1 [[EXPECTED_TRUE_NOT]], true ;INTEL
; CHECK-NEXT:    [[EXPENSIVE:%.*]] = icmp eq i32 [[Y:%.*]], 0
; CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[EXPECTED_TRUE_NOT1]], i1 true, i1 [[EXPENSIVE]] ;INTEL
...
; CHECK-NEXT:    [[EXPECTED_TRUE_NOT1:%.*]] = xor i1 [[EXPECTED_TRUE_NOT]], true ;INTEL
; CHECK-NEXT:    [[EXPENSIVE:%.*]] = icmp eq i32 [[Y:%.*]], 0
; CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[EXPECTED_TRUE_NOT1]], i1 [[EXPENSIVE]], i1 false ;INTEL
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[EXPECTED_FALSE:%.*]] = icmp sgt i32 [[X:%.*]], -1 ;INTEL
; CHECK-NEXT:    [[EXPECTED_FALSE_NOT:%.*]] = xor i1 [[EXPECTED_FALSE]], true ;INTEL
; CHECK-NEXT:    [[EXPECTED_FALSE_NOT1:%.*]] = xor i1 [[EXPECTED_FALSE_NOT]], true ;INTEL
; CHECK-NEXT:    [[EXPENSIVE:%.*]] = icmp eq i32 [[Y:%.*]], 0
; CHECK-NEXT:    [[OR_COND:%.*]] = select i1 [[EXPECTED_FALSE_NOT1]], i1 [[EXPENSIVE]], i1 false ;INTEL

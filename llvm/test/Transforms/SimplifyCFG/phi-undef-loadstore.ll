...
; RUN: opt < %s -S -passes=convert-to-subscript | opt -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=1 -S | FileCheck --check-prefix=SUBS %s ;INTEL
...
;
; INTEL_CUSTOMIZATION
; SUBS-LABEL: define i32 @test1
; SUBS-SAME: (ptr [[A:%.*]], i32 [[B:%.*]], ptr [[C:%.*]], i32 [[D:%.*]]) #[[ATTR0:[0-9]+]] {
; SUBS-NEXT:  entry:
; SUBS-NEXT:    [[TOBOOL:%.*]] = icmp eq i32 [[B]], 0
; SUBS-NEXT:    br i1 [[TOBOOL]], label [[IF_ELSE:%.*]], label [[IF_THEN:%.*]]
; SUBS:       if.then:
; SUBS-NEXT:    tail call void @bar() #[[ATTR0]]
; SUBS-NEXT:    br label [[IF_END7:%.*]]
; SUBS:       if.else:
; SUBS-NEXT:    [[TOBOOL3:%.*]] = icmp eq i32 [[D]], 0
; SUBS-NEXT:    tail call void @bar() #[[ATTR0]]
; SUBS-NEXT:    br label [[IF_END7]]
; SUBS:       if.end7:
; SUBS-NEXT:    [[X_0:%.*]] = phi ptr [ [[A]], [[IF_THEN]] ], [ [[C]], [[IF_ELSE]] ]
; SUBS-NEXT:    [[TMP9:%.*]] = load i32, ptr [[X_0]], align 4
; SUBS-NEXT:    ret i32 [[TMP9]]
;
...
;
; INTEL_CUSTOMIZATION
; SUBS-LABEL: define i32 @test1_no_null_opt
; SUBS-SAME: (ptr [[A:%.*]], i32 [[B:%.*]], ptr [[C:%.*]], i32 [[D:%.*]]) #[[ATTR1:[0-9]+]] {
; SUBS-NEXT:  entry:
; SUBS-NEXT:    [[TOBOOL:%.*]] = icmp eq i32 [[B]], 0
; SUBS-NEXT:    br i1 [[TOBOOL]], label [[IF_ELSE:%.*]], label [[IF_THEN:%.*]]
; SUBS:       if.then:
...
; SUBS:       if.else:
; SUBS-NEXT:    [[TOBOOL3:%.*]] = icmp eq i32 [[D]], 0
; SUBS-NEXT:    br i1 [[TOBOOL3]], label [[IF_END7]], label [[IF_THEN4:%.*]]
; SUBS:       if.then4:
; SUBS-NEXT:    tail call void @bar() #[[ATTR0]]
; SUBS-NEXT:    br label [[IF_END7]]
; SUBS:       if.end7:
; SUBS-NEXT:    [[X_0:%.*]] = phi ptr [ [[A]], [[IF_THEN]] ], [ [[C]], [[IF_THEN4]] ], [ null, [[IF_ELSE]] ]
; SUBS-NEXT:    [[TMP9:%.*]] = load i32, ptr [[X_0]], align 4
; SUBS-NEXT:    ret i32 [[TMP9]]
;
; end INTEL_CUSTOMIZATION
...
;
; INTEL_CUSTOMIZATION
; SUBS-LABEL: define i32 @test2
; SUBS-SAME: (ptr [[A:%.*]], i32 [[B:%.*]], ptr [[C:%.*]], i32 [[D:%.*]]) #[[ATTR0]] {
; SUBS-NEXT:  entry:
; SUBS-NEXT:    [[TOBOOL:%.*]] = icmp eq i32 [[B]], 0
; SUBS-NEXT:    br i1 [[TOBOOL]], label [[IF_ELSE:%.*]], label [[IF_THEN:%.*]]
; SUBS:       if.then:
; SUBS-NEXT:    tail call void @bar() #[[ATTR0]]
; SUBS-NEXT:    [[TMP9:%.*]] = load i32, ptr [[A]], align 4
; SUBS-NEXT:    ret i32 [[TMP9]]
; SUBS:       if.else:
; SUBS-NEXT:    [[TOBOOL3:%.*]] = icmp eq i32 [[D]], 0
; SUBS-NEXT:    tail call void @bar() #[[ATTR0]]
; SUBS-NEXT:    unreachable
;
; end INTEL_CUSTOMIZATION
entry:
  %tobool = icmp eq i32 %b, 0
...
;
; INTEL_CUSTOMIZATION
; SUBS-LABEL: define i32 @test2_no_null_opt
; SUBS-SAME: (ptr [[A:%.*]], i32 [[B:%.*]], ptr [[C:%.*]], i32 [[D:%.*]]) #[[ATTR1]] {
; SUBS-NEXT:  entry:
; SUBS-NEXT:    [[TOBOOL:%.*]] = icmp eq i32 [[B]], 0
; SUBS-NEXT:    br i1 [[TOBOOL]], label [[IF_ELSE:%.*]], label [[IF_THEN:%.*]]
; SUBS:       if.then:
...
; SUBS-NEXT:    br label [[IF_END7]]
; SUBS:       if.end7:
; SUBS-NEXT:    [[X_0:%.*]] = phi ptr [ [[A]], [[IF_THEN]] ], [ null, [[IF_THEN4]] ], [ null, [[IF_ELSE]] ]
; SUBS-NEXT:    [[TMP9:%.*]] = load i32, ptr [[X_0]], align 4
; SUBS-NEXT:    ret i32 [[TMP9]]
;
; end INTEL_CUSTOMIZATION
...
;
; INTEL_CUSTOMIZATION
; SUBS-LABEL: define i32 @test3_no_null_opt
; SUBS-SAME: (ptr [[A:%.*]], i32 [[B:%.*]], ptr [[C:%.*]], i32 [[D:%.*]]) #[[ATTR1]] {
; SUBS-NEXT:  entry:
; SUBS-NEXT:    [[TOBOOL:%.*]] = icmp eq i32 [[B]], 0
; SUBS-NEXT:    br i1 [[TOBOOL]], label [[IF_ELSE:%.*]], label [[IF_THEN:%.*]]
...
; SUBS:       if.then:
; SUBS-NEXT:    tail call void @bar() #[[ATTR0]]
; SUBS-NEXT:    [[GEP:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 0, i64 0, i64 4, ptr elementtype(i32) [[A]], i32 10)
; SUBS-NEXT:    [[TMP9:%.*]] = load i32, ptr [[GEP]], align 4
; SUBS-NEXT:    [[TMP10:%.*]] = or i32 [[TMP9]], 1
; SUBS-NEXT:    store i32 [[TMP10]], ptr [[GEP]], align 4
; SUBS-NEXT:    ret i32 [[TMP9]]
; SUBS:       if.else:
; SUBS-NEXT:    [[TOBOOL3:%.*]] = icmp eq i32 [[D]], 0
; SUBS-NEXT:    tail call void @bar() #[[ATTR0]]
...
;
; INTEL_CUSTOMIZATION
; SUBS-LABEL: define i32 @test4_no_null_opt
; SUBS-SAME: (ptr [[A:%.*]], i32 [[B:%.*]], ptr [[C:%.*]], i32 [[D:%.*]]) #[[ATTR1]] {
; SUBS-NEXT:  entry:
; SUBS-NEXT:    [[TOBOOL:%.*]] = icmp eq i32 [[B]], 0
; SUBS-NEXT:    br i1 [[TOBOOL]], label [[IF_ELSE:%.*]], label [[IF_THEN:%.*]]
...
; SUBS:       if.end7:
; SUBS-NEXT:    [[X_0:%.*]] = phi ptr [ [[A]], [[IF_THEN]] ], [ null, [[IF_THEN4]] ], [ null, [[IF_ELSE]] ]
; SUBS-NEXT:    [[GEP:%.*]] = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i32(i8 0, i64 0, i64 4, ptr elementtype(i32) [[X_0]], i32 10)
; SUBS-NEXT:    [[TMP9:%.*]] = load i32, ptr [[GEP]], align 4
; SUBS-NEXT:    [[TMP10:%.*]] = or i32 [[TMP9]], 1
; SUBS-NEXT:    store i32 [[TMP10]], ptr [[GEP]], align 4
; SUBS-NEXT:    ret i32 [[TMP9]]

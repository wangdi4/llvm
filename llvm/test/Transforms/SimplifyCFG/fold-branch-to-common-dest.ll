...
define void @one_pred_with_spec_call(i8 %v0, i8 %v1, i32* %p) { ;INTEL
...
define void @one_pred_with_spec_call_deref(i8 %v0, i8 %v1, i32* %p) { ;INTEL
...
define i32 @firewall(i8* %data) { ;INTEL
...
; CHECK-NEXT:    [[TMP0:%.*]] = select i1 [[OR_COND2]], i32 1, i32 [[DOT]] ;INTEL
; CHECK-NEXT:    ret i32 [[TMP0]] ;INTEL
;
; renamed temps for some reason ;INTEL
entry:
...
; CHECK-NEXT:    [[FPCLASSIFY_RESULT:%.*]] = phi i32 [ 2, [[ENTRY:%.*]] ], [ 0, [[FPCLASSIFY_NOT_ZERO]] ], [ [[TMP0:%.*]], [[FPCLASSIFY_NOT_NAN:%.*]] ] ;INTEL
...
; CHECK-NEXT:    [[NORMAL_OR_SUBNORMAL:%.*]] = select i1 [[ISNORMAL]], i32 4, i32 3 ;INTEL
; CHECK-NEXT:    [[TMP0]] = select i1 [[ISINF]], i32 1, i32 [[NORMAL_OR_SUBNORMAL]] ;INTEL

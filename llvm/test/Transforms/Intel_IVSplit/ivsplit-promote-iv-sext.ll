...
@a9 = external dso_local local_unnamed_addr global ptr, align 8
...
for.body:                                         ; preds = %entry, %for.inc52
  ...
  %arrayidx = getelementptr inbounds [0 x i32], ptr @a1, i64 0, i64 %i1.084
...
if.end:                                           ; preds = %for.body
  %arrayidx2 = getelementptr inbounds [0 x i32], ptr @a1, i64 0, i64 %.pre89
  %1 = load i32, ptr %arrayidx2, align 4, !tbaa !2
  %sub = add nsw i32 %1, -10
  store i32 %sub, ptr %arrayidx2, align 4, !tbaa !2
  %2 = or i64 %u2, %u3
  %3 = icmp slt i64 %2, 0
...
for.body5:                                        ; preds = %if.end, %for.inc46
  ...
  %arrayidx6 = getelementptr inbounds [0 x i32], ptr @a2, i64 0, i64 %i2.082
  %4 = load i32, ptr %arrayidx6, align 4, !tbaa !2
  %cmp7 = icmp slt i32 %4, 1
  %.pre90 = add nuw i64 %i2.082, 1
  br i1 %cmp7, label %for.inc46, label %if.end9

if.end9:                                          ; preds = %for.body5
  %arrayidx11 = getelementptr inbounds [0 x i32], ptr @a2, i64 0, i64 %.pre90
  %5 = load i32, ptr %arrayidx11, align 4, !tbaa !2
  %sub12 = add nsw i32 %5, -10
  store i32 %sub12, ptr %arrayidx11, align 4, !tbaa !2
  br label %for.body15

for.body15:                                       ; preds = %for.inc, %if.end9
  %i3.080 = phi i64 [ 0, %if.end9 ], [ %.pre91, %for.inc ]
  %arrayidx16 = getelementptr inbounds [0 x i32], ptr @a3, i64 0, i64 %i3.080
  %6 = load i32, ptr %arrayidx16, align 4, !tbaa !2
  %cmp17 = icmp slt i32 %6, 1
  %.pre91 = add nuw i64 %i3.080, 1
  br i1 %cmp17, label %for.inc, label %if.end19

if.end19:                                         ; preds = %for.body15
  %arrayidx21 = getelementptr inbounds [0 x i32], ptr @a3, i64 0, i64 %.pre91
  %7 = load i32, ptr %arrayidx21, align 4, !tbaa !2
  %sub22 = add nsw i32 %7, -10
  store i32 %sub22, ptr %arrayidx21, align 4, !tbaa !2
  ...
  %arrayidx28 = getelementptr inbounds [0 x i32], ptr @b, i64 0, i64 %add27
  %8 = load i32, ptr %arrayidx28, align 4, !tbaa !2
  %add29 = add i32 %add26, %8
  %sub30 = sub i32 45, %add29
  %9 = load ptr, ptr @a9, align 8, !tbaa !6
  %idxprom = sext i32 %sub30 to i64
  %arrayidx31 = getelementptr inbounds i32, ptr %9, i64 %idxprom
  %10 = load i32, ptr %arrayidx31, align 4, !tbaa !2
...
if.then34:                                        ; preds = %if.end19
  ...
  %arrayidx37 = getelementptr inbounds i32, ptr %9, i64 %idxprom36
  %11 = load i32, ptr %arrayidx37, align 4, !tbaa !2
  %sub38 = add nsw i32 %11, -9
  store i32 %sub38, ptr %arrayidx37, align 4, !tbaa !2
  %.pre = load i32, ptr %arrayidx21, align 4, !tbaa !2
  br label %if.end39

if.end39:                                         ; preds = %if.then34, %if.end19
  %12 = phi i32 [ %.pre, %if.then34 ], [ %sub22, %if.end19 ]
  %add42 = add nsw i32 %12, 10
  store i32 %add42, ptr %arrayidx21, align 4, !tbaa !2
  br label %for.inc
...
for.end:                                          ; preds = %for.inc
  %13 = load i32, ptr %arrayidx11, align 4, !tbaa !2
  %add45 = add nsw i32 %13, 10
  store i32 %add45, ptr %arrayidx11, align 4, !tbaa !2
  br label %for.inc46

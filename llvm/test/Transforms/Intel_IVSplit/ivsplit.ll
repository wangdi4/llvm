...
; CHECK: if.end.us:
; CHECK-NEXT: store i64 %indvars.iv45, ptr %iv-split-var
; IV is being reloaded at inner Loop for use
; CHECK: if.end11.us:
; CHECK: %iv-inner-reload-var = load i64, ptr %iv-split-var
; CHECK: sub nsw i64 %iv-inner-reload-var, %indvars.iv
; IV is being reloaded at exit BB for following use
; CHECK: for.cond4.for.end_crit_edge.us:
; CHECK-NEXT: %iv-reload-var = load i64, ptr %iv-split-var
; Merge orignal and reloaded IV for IV increment
; CHECK: for.inc24.us:
; CHECK-NEXT: %iv-split-phi = phi i64 [ %iv-reload-var, %for.cond4.for.end_crit_edge.us ], [ %indvars.iv45, %for.body.us ]
...
for.body.us:                                      ; preds = %for.inc24.us, %for.body.us.preheader
  ...
  %arrayidx.us = getelementptr inbounds [1 x [9 x i32]], ptr @a, i64 0, i64 0, i64 %indvars.iv45
  %2 = load i32, ptr %arrayidx.us, align 4, !tbaa !2
  %cmp1.us = icmp slt i32 %2, 1
  br i1 %cmp1.us, label %for.inc24.us, label %if.end.us

if.end.us:                                        ; preds = %for.body.us
  %arrayidx3.us = getelementptr inbounds [1 x [9 x i32]], ptr @a, i64 1, i64 0, i64 %indvars.iv45
  %3 = load i32, ptr %arrayidx3.us, align 4, !tbaa !2
  %sub.us = add nsw i32 %3, -10
  store i32 %sub.us, ptr %arrayidx3.us, align 4, !tbaa !2
  br label %for.body6.us

for.body6.us:                                     ; preds = %for.inc.us, %if.end.us
  %indvars.iv = phi i64 [ %0, %if.end.us ], [ %indvars.iv.next, %for.inc.us ]
  %arrayidx8.us = getelementptr inbounds [1 x [9 x i32]], ptr @a, i64 4, i64 0, i64 %indvars.iv
  %4 = load i32, ptr %arrayidx8.us, align 4, !tbaa !2
  %cmp9.us = icmp slt i32 %4, 1
  br i1 %cmp9.us, label %for.inc.us, label %if.end11.us

if.end11.us:                                      ; preds = %for.body6.us
  %arrayidx13.us = getelementptr inbounds [1 x [9 x i32]], ptr @a, i64 5, i64 0, i64 %indvars.iv
  %5 = load i32, ptr %arrayidx13.us, align 4, !tbaa !2
  %sub14.us = add nsw i32 %5, -12
  store i32 %sub14.us, ptr %arrayidx13.us, align 4, !tbaa !2
  %6 = sub nsw i64 %indvars.iv45, %indvars.iv
  %arrayidx17.us = getelementptr inbounds [1 x [9 x i32]], ptr @a, i64 6, i64 0, i64 %6
  %7 = load i32, ptr %arrayidx17.us, align 4, !tbaa !2
  %sub18.us = add nsw i32 %7, -13
  store i32 %sub18.us, ptr %arrayidx17.us, align 4, !tbaa !2
  %8 = load i32, ptr %arrayidx13.us, align 4, !tbaa !2
  %add.us = add nsw i32 %8, 12
  store i32 %add.us, ptr %arrayidx13.us, align 4, !tbaa !2
  br label %for.inc.us
...
for.cond4.for.end_crit_edge.us:                   ; preds = %for.inc.us
  %9 = load i32, ptr %arrayidx3.us, align 4, !tbaa !2
  %add23.us = add nsw i32 %9, 10
  store i32 %add23.us, ptr %arrayidx3.us, align 4, !tbaa !2

...
; constant multiplier (i.e 8) is not divisible by stride.
;
; SCEV that has problem:
; {(152 + (8 * (sext i32 %ld00 to i64))<nsw> + %in1),+,160}<nsw><%b1>
...
b0:
  ...
  %ld00 = load i32, i32* %a0, align 4
  %ld01 = load i32, i32* %a1, align 4
  %s0 = sext i32 %ld00 to i64
  br label %b1

b1:                                                ; preds = %b2, %b0
  %ph1 = phi i64 [ %s0, %b0 ], [ %inc, %b2 ]

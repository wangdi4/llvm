...
; pointer increment (11) is not evenly divisible by element size.
...
; CHECK:    Increment is not divisible by MaxElemSize
...
b0:
  ...
  %pinc = getelementptr inbounds i8, ptr %p1, i64 11

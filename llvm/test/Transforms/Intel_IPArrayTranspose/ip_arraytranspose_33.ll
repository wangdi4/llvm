...
; CHECK: [[SL0:%[0-9]+]] = shl nuw nsw i64 [[S0]], 3
; CHECK: [[G3:%[a-z0-9]+]] = getelementptr i8, ptr [[G0]], i64 [[SL0]]
; CHECK:  %tmp34 = load double, ptr [[G3]], align 4
...
; CHECK: bb52:
; CHECK: [[G4:%[a-z0-9]+]] = getelementptr i8, ptr %arg2, i64 254080000
; CHECK: [[A7:%[0-9]+]] = add i32 [[T0]], %tmp53
; CHECK: [[S1:%[0-9]+]] = zext i32 [[A7]] to i64
; CHECK: [[SL1:%[0-9]+]] = shl nuw nsw i64 [[S1]], 3
; CHECK: [[G5:%[a-z0-9]+]] = getelementptr i8, ptr [[G4]], i64 [[SL1]]
; CHECK: store i32 1, ptr [[G5]], align 4

; This test verifies that array transpose is not enabled because a global
; variable is used to index array.
...
; CHECK:     Index expr is complex to process
; CHECK:    Failed: MemRefs validation failed

@GV = global i64  zeroinitializer, align 8

define i32 @main() #0 {
b0:
  %p1 = tail call ptr @malloc(i64 214400000)
  %idx = load i64, ptr @GV
  %pinc = getelementptr inbounds i8, ptr %p1, i64 %idx

...
; stride is not constant due to %inc2 that is used by %gep2.
...
b1:                                                ; preds = %b2, %b0
  ...
  %inc2 = mul i64 %ph2, 2
  %gep2 = getelementptr inbounds double, ptr %bc0, i64 %inc2
  %ld2 = load double, ptr %gep2, align 8

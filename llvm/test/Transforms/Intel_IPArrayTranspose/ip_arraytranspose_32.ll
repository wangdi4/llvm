...
; CHECK: [[G0:%[a-z0-9]+]]  = getelementptr i8, ptr %inn, i64 [[A1]]
; CHECK: store i64 0, ptr [[G0]], align 8
; CHECK: [[I1]] = add i64 [[I0]], 1

define i32 @main() #0 {
b0:
  %a00 = alloca ptr, align 4
  %p1 = tail call ptr @malloc(i64 1689600000)
  %pinc = getelementptr inbounds i8, ptr %p1, i64 12800000
  store ptr %pinc, ptr %a00
  tail call void @foo(ptr %a00)
  br label %b1
...
b0:
  ...
  %lb0 = load i32, ptr %a0, align 4
  %ub0 = load i32, ptr %a1, align 4
...
b1:                                                ; preds = %b1, %b00
  ...
  %inn = load ptr, ptr %in1, align 4
  %bc1 = bitcast ptr %inn to ptr
  %gep2 = getelementptr inbounds double, ptr %bc1, i64 %add1
  %bc2 = bitcast ptr %gep2 to ptr
  store i64 0, ptr %bc2, align 8

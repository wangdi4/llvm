...
bb20:                                             ; preds = %bb42, %bb14
  ...
  %tmp28 = getelementptr inbounds double, ptr %arg2, i64 %tmp27
  %tmp29 = bitcast ptr %tmp28 to ptr
  %tmp30 = load i32, ptr %tmp29, align 4
  %tmp31 = or i32 %tmp30, 1
  store i32 %tmp31, ptr %tmp29, align 4
...
bb46:                                             ; preds = %bb67, %bb67, %bb61, %bb58, %bb58, %bb45, %bb38, %bb38
  ...
  %tmp52 = getelementptr inbounds double, ptr %arg2, i64 %tmp51
  %tmp54 = load double, ptr %tmp52, align 4
...
bb75:                                             ; preds = %bb71
  ...
  %tmp80 = getelementptr inbounds double, ptr %arg2, i64 %tmp79
  %tmp81 = bitcast ptr %tmp80 to ptr
  store i32 1, ptr %tmp81, align 4
  br label %bb68
}

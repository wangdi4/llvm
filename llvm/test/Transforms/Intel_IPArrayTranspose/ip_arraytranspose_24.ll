...
; CHECK: %pinc = getelementptr inbounds i8, ptr %p1, i64 0
; CHECK-NOT: %pinc = getelementptr inbounds i8, ptr %p1, i64 320000
...
; CHECK:  [[G0:%[a-z0-9]+]] = getelementptr i8, ptr %p1, i64 [[A5]]
; CHECK:  %ld = load double, ptr [[G0]], align 8
; CHECK:  store double %ld, ptr [[G0]], align 8
; CHECK: b5:
...
b4:                                               ; preds = %b3
  ...
  %gep1 = getelementptr inbounds double, ptr %bc0, i64 %add0
  %ld = load double, ptr %gep1, align 8
  store double %ld, ptr %gep1, align 8
  br label %b5

...
b0:
  ...
  %ld0 = load ptr, ptr %g, align 8
  br label %b1

b1:                                               ; preds = %b0
  %ld1 = load ptr, ptr %g, align 8
  tail call void @foo(ptr %ld1)
  tail call void @free(ptr nonnull %p1)
  ret i32 0
}

define void @foo(ptr %grid) {
b0:
  br label %b1
...
b1:                                                ; preds = %b2, %b0
  ...
  %gep1 = getelementptr inbounds double, ptr %grid, i64 %inc1

; This test verifies that array transpose is not enabled because array (%p1)
; is referenced (%ld2) without proper index in "foo".
...
b0:
  ...
  %ld2 = load double, double* %bc0, align 8
  br label %b1

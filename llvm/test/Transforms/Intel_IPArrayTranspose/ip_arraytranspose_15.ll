...
; all callsites of foo ("@foo(ptr null)") are not processed.
...
; CHECK:     Unable to process some calls
...
define void @foo(ptr %in1) {
b0:
  %bc0 = bitcast ptr %in1 to ptr
  br label %b1

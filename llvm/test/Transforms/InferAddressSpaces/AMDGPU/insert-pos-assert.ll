...
; RUN: opt -S -mtriple=amdgcn-amd-amdhsa -passes=infer-address-spaces -remove-same-addressspace-cast=false -infer-as-collect-callinst-opnds=false %s | FileCheck %s

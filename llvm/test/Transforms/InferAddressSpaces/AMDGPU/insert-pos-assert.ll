...
; RUN: opt -S -mtriple=amdgcn-amd-amdhsa -infer-address-spaces -remove-same-addressspace-cast=false -infer-as-collect-callinst-opnds=false %s | FileCheck %s
=======
; RUN: opt -S -mtriple=amdgcn-amd-amdhsa -passes=infer-address-spaces %s | FileCheck %s
>>>>>>> 5651af896c3df30da9edd101b1fb17c00de6636d

...
; This test is same as argument_align_opq_1.ll except return address
; of calloc is passed to "foo" as first argument indirectly.

; This is the same test as argument_align_4.ll, but it checks for the
; opaque pointers case.

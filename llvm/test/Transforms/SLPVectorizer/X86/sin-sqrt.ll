...
; INTEL_CUSTOMIZATION
; Customization note: added -slp-compatibility-mode option to suppress
; lookahead heuristic tweak in xmain.
; RUN: opt < %s -slp-compatibility-mode -mtriple=x86_64-unknown-linux -mcpu=skylake-avx512 -passes=slp-vectorizer -S | FileCheck %s

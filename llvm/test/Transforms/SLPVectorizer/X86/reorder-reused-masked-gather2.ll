...
; INTEL_CUSTOMIZATION
; Customization note: disable split load and turn on compatibility mode
; to match community SLP vectorizer behavior.
; RUN: opt -passes=slp-vectorizer -max-split-load=0 -slp-compatibility-mode -S < %s | FileCheck %s

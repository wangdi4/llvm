...
; CHECK-LABEL: @test(
; CHECK:    [[TMP5:%.*]] = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> {{.*}}, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
...
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast float* {{.*}} to <16 x float>*

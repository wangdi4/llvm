...
; INTEL_CUSTOMIZATION
; Turn off Intel proprietary split-load implementation for community test
; RUN: opt < %s -passes=slp-vectorizer -max-split-load=0 -S -mtriple=x86_64-unknown-linux-gnu -mcpu=skylake-avx512 | FileCheck %s

...
; XMAIN-NEXT:    [[TMP10:%.*]] = fadd fast <2 x double> [[TMP8]], [[TMP9]]
...
; XMAIN-NEXT:    [[TMP14:%.*]] = fadd fast <2 x double> [[TMP13]], [[TMP10]]
...
; XMAIN-NEXT:    [[A0:%.*]] = load double, double* [[IDXA0]], align 8
; XMAIN-NEXT:    [[C0:%.*]] = load double, double* [[IDXC0]], align 8
; XMAIN-NEXT:    [[D0:%.*]] = load double, double* [[IDXD0]], align 8
; XMAIN-NEXT:    [[A1:%.*]] = load double, double* [[IDXA1]], align 8
; XMAIN-NEXT:    [[B2:%.*]] = load double, double* [[IDXB2]], align 8
; XMAIN-NEXT:    [[A2:%.*]] = load double, double* [[IDXA2]], align 8
; XMAIN-NEXT:    [[TMP0:%.*]] = bitcast double* [[IDXB0]] to <2 x double>*
; XMAIN-NEXT:    [[TMP1:%.*]] = load <2 x double>, <2 x double>* [[TMP0]], align 8
; XMAIN-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> undef, double [[C0]], i32 0
; XMAIN-NEXT:    [[TMP3:%.*]] = insertelement <2 x double> [[TMP2]], double [[A1]], i32 1
; XMAIN-NEXT:    [[TMP4:%.*]] = insertelement <2 x double> undef, double [[D0]], i32 0
; XMAIN-NEXT:    [[TMP5:%.*]] = insertelement <2 x double> [[TMP4]], double [[B2]], i32 1
; XMAIN-NEXT:    [[TMP6:%.*]] = fsub fast <2 x double> [[TMP3]], [[TMP5]]
; XMAIN-NEXT:    [[TMP7:%.*]] = insertelement <2 x double> undef, double [[A0]], i32 0
; XMAIN-NEXT:    [[TMP8:%.*]] = insertelement <2 x double> [[TMP7]], double [[A2]], i32 1
; XMAIN-NEXT:    [[TMP9:%.*]] = fsub fast <2 x double> [[TMP8]], [[TMP1]]
; XMAIN-NEXT:    [[TMP10:%.*]] = fadd fast <2 x double> [[TMP9]], [[TMP6]]
...
; XMAIN-NEXT:    store <2 x double> [[TMP10]], <2 x double>* [[TMP11]], align 8
; XMAIN-NEXT:    store double [[A1]], double* [[EXT1:%.*]], align 8
; XMAIN-NEXT:    ret void
; end INTEL_CUSTOMIZATION
entry:
...
; XMAIN-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> undef, double [[B0]], i32 0
; XMAIN-NEXT:    [[TMP3:%.*]] = insertelement <2 x double> [[TMP2]], double [[B2]], i32 1
; XMAIN-NEXT:    [[TMP4:%.*]] = fsub fast <2 x double> [[TMP1]], [[TMP3]]
; XMAIN-NEXT:    [[TMP5:%.*]] = insertelement <2 x double> undef, double [[C0]], i32 0
; XMAIN-NEXT:    [[TMP6:%.*]] = insertelement <2 x double> [[TMP5]], double [[A2]], i32 1
; XMAIN-NEXT:    [[TMP7:%.*]] = insertelement <2 x double> undef, double [[D0]], i32 0
...
; XMAIN-NEXT:    [[TMP3:%.*]] = insertelement <2 x double> undef, double [[C0]], i32 0
...
; XMAIN-NEXT:    [[TMP1:%.*]] = insertelement <2 x double> undef, double [[LOADA0]], i32 0
; XMAIN-NEXT:    [[TMP2:%.*]] = insertelement <2 x double> [[TMP1]], double [[LOADA0]], i32 1
; XMAIN-NEXT:    [[TMP3:%.*]] = fmul <2 x double> [[LOADVEC]], [[TMP2]]
; XMAIN-NEXT:    [[TMP4:%.*]] = insertelement <2 x double> undef, double [[LOADA1]], i32 0
...
; XMAIN-NEXT:    [[TMP3:%.*]] = insertelement <2 x double> undef, double [[EXTRB0]], i32 0
; XMAIN-NEXT:    [[TMP4:%.*]] = insertelement <2 x double> [[TMP3]], double [[EXTRA1]], i32 1
; XMAIN-NEXT:    [[TMP5:%.*]] = extractelement <2 x double> [[TMP2]], i32 1
; XMAIN-NEXT:    [[TMP6:%.*]] = insertelement <2 x double> undef, double [[TMP5]], i32 0
; XMAIN-NEXT:    [[TMP7:%.*]] = extractelement <2 x double> [[TMP2]], i32 0
; XMAIN-NEXT:    [[TMP8:%.*]] = insertelement <2 x double> [[TMP6]], double [[TMP7]], i32 1
; XMAIN-NEXT:    [[TMP9:%.*]] = fmul <2 x double> [[TMP4]], [[TMP8]]
; XMAIN-NEXT:    [[TMP10:%.*]] = insertelement <2 x double> undef, double [[EXTRA0]], i32 0
; XMAIN-NEXT:    [[TMP11:%.*]] = insertelement <2 x double> [[TMP10]], double [[EXTRB1]], i32 1
; XMAIN-NEXT:    [[TMP12:%.*]] = fmul <2 x double> [[TMP11]], [[TMP2]]
; XMAIN-NEXT:    [[TMP13:%.*]] = fadd <2 x double> [[TMP12]], [[TMP9]]
; XMAIN-NEXT:    [[SIDX0:%.*]] = getelementptr inbounds double, double* [[STOREARRAY:%.*]], i64 0
; XMAIN-NEXT:    [[SIDX1:%.*]] = getelementptr inbounds double, double* [[STOREARRAY]], i64 1
; XMAIN-NEXT:    [[TMP14:%.*]] = bitcast double* [[SIDX0]] to <2 x double>*
; XMAIN-NEXT:    store <2 x double> [[TMP13]], <2 x double>* [[TMP14]], align 8
; XMAIN-NEXT:    ret void
; end INTEL_CUSTOMIZATION
;
  %idx0 = getelementptr inbounds double, double* %array, i64 0

...
; Disable new look ahead heuristic to match community behaviour. This heuristic is under review in the community
; and expected to become a part of SLP vectorizer fairly soon.
; RUN: opt -slp-vectorizer -S < %s -mtriple=x86_64-unknown-linux -mcpu=corei7-avx -slp-max-look-ahead-depth=1 | FileCheck %s

...
; RUN: opt -S -passes=slp-vectorizer < %s -mtriple=x86_64-unknown-linux-gnu -mcpu=skylake -slp-threshold=-14 -slp-compatibility-mode -max-split-load=0 | FileCheck %s
; end INTEL_CUSTOMIZATION
=======
; RUN: opt -S -passes=slp-vectorizer < %s -mtriple=x86_64-unknown-linux-gnu -mcpu=skylake -slp-threshold=-13 | FileCheck %s
>>>>>>> 3b3a4c270bcbc12c957c941c8ee2a7bfea0fa673

...
; INTEL_CUSTOMIZATION
; RUN: opt < %s -slp-vectorizer -pslp=false -multi-node-slp=false -S | FileCheck %s
; RUN: opt < %s -slp-vectorizer -pslp=false -multi-node-slp=false -enable-new-pm -S | FileCheck %s

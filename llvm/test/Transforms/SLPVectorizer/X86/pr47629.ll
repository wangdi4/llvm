...
; (higher cost on AVX2 and KNL and lower cost for SKX for v4i32)
...
; AVX2-NEXT:    [[T7:%.*]] = load i32, i32* [[T6]], align 4
; AVX2-NEXT:    [[T11:%.*]] = load i32, i32* [[T10]], align 4
; AVX2-NEXT:    [[T15:%.*]] = load i32, i32* [[T14]], align 4
; AVX2-NEXT:    [[T19:%.*]] = load i32, i32* [[T18]], align 4
...
; AVX2-NEXT:    store i32 [[T8]], i32* [[T5]], align 4
; AVX2-NEXT:    store i32 [[T12]], i32* [[T9]], align 4
; AVX2-NEXT:    store i32 [[T16]], i32* [[T13]], align 4
; AVX2-NEXT:    store i32 [[T20]], i32* [[T17]], align 4
...
; AVX512F-NEXT:    [[T3:%.*]] = load i32, i32* [[T1]], align 4
; AVX512F-NEXT:    [[T7:%.*]] = load i32, i32* [[T6]], align 4
; AVX512F-NEXT:    [[T11:%.*]] = load i32, i32* [[T10]], align 4
; AVX512F-NEXT:    [[T15:%.*]] = load i32, i32* [[T14]], align 4
; AVX512F-NEXT:    [[T19:%.*]] = load i32, i32* [[T18]], align 4
; AVX512F-NEXT:    [[T23:%.*]] = load i32, i32* [[T22]], align 4
; AVX512F-NEXT:    [[T27:%.*]] = load i32, i32* [[T26]], align 4
; AVX512F-NEXT:    [[T31:%.*]] = load i32, i32* [[T30]], align 4
...
; AVX512F-NEXT:    store i32 [[T4]], i32* [[T0]], align 4
; AVX512F-NEXT:    store i32 [[T8]], i32* [[T5]], align 4
; AVX512F-NEXT:    store i32 [[T12]], i32* [[T9]], align 4
; AVX512F-NEXT:    store i32 [[T16]], i32* [[T13]], align 4
; AVX512F-NEXT:    store i32 [[T20]], i32* [[T17]], align 4
; AVX512F-NEXT:    store i32 [[T24]], i32* [[T21]], align 4
; AVX512F-NEXT:    store i32 [[T28]], i32* [[T25]], align 4
; AVX512F-NEXT:    store i32 [[T32]], i32* [[T29]], align 4
...
; AVX512-NEXT:    [[TMP9:%.*]] = call <8 x i32> @llvm.masked.gather.v8i32.v8p0i32(<8 x i32*> [[TMP8]], i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x i32> undef)
...
; AVX512-NEXT:    store <8 x i32> [[TMP10]], <8 x i32>* [[TMP11]], align 4

...
<<<<<<< HEAD
; RUN: opt -scoped-noalias-aa -slp-vectorizer -mtriple=x86_64-apple-darwin -enable-new-pm=false -S -slp-compatibility-mode %s | FileCheck %s ;INTEL
=======
>>>>>>> 99c9b37d115390e24e6f9b877244466b9856552c

...
<<<<<<< HEAD
; INTEL: Added -slp-compatibility-mode=false to workaround failures first. CMPLRLLVM-47305
; RUN: opt -passes=slp-vectorizer -mtriple=x86_64-unknown-linux-gnu -mcpu=skx -S -slp-compatibility-mode=false < %s | FileCheck %s
=======
...
>>>>>>> c0e5e7db9ae27db765981f5e55e0819f369d7095

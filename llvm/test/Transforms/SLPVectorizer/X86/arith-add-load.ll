...
<<<<<<< HEAD
; RUN: opt < %s -aa-pipeline=basic-aa -passes=slp-vectorizer -S -mtriple=x86_64-unknown -mcpu=x86-64    -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,SSE
; RUN: opt < %s -aa-pipeline=basic-aa -passes=slp-vectorizer -S -mtriple=x86_64-unknown -mcpu=x86-64-v2 -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,SSE
; RUN: opt < %s -aa-pipeline=basic-aa -passes=slp-vectorizer -S -mtriple=x86_64-unknown -mcpu=x86-64-v3 -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,AVX
; RUN: opt < %s -aa-pipeline=basic-aa -passes=slp-vectorizer -S -mtriple=x86_64-unknown -mcpu=x86-64-v4 -passes=slp-vectorizer -S | FileCheck %s --check-prefixes=CHECK,AVX
=======
...
>>>>>>> 59ffac7dd204761d06df70c8d4759f84f548e940

...
; INTEL_CUSTOMIZATION
; Customization note: turn on compatibility mode to use same scoring heristics for reordering.
; RUN: opt < %s -passes=slp-vectorizer -S -mtriple=x86_64-unknown-linux-gnu -slp-compatibility-mode | FileCheck %s

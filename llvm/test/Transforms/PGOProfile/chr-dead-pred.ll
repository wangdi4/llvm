...
; CHECK-NEXT:    ]
; CHECK:       bb1:
; CHECK-NEXT:    [[SELECT:%.*]] = select i1 [[C]], i32 0, i32 1, !prof [[PROF30:![0-9]+]] ;INTEL
; CHECK-NEXT:    br label [[EXIT:%.*]]
; CHECK:       bb2:
; CHECK-NEXT:    [[SELECT3:%.*]] = select i1 [[C2]], i32 0, i32 1, !prof [[PROF31:![0-9]+]] ;INTEL
; CHECK-NEXT:    br label [[EXIT]]
; CHECK:       dead:
; CHECK-NEXT:    br label [[BB3]]
; CHECK:       bb3:
; CHECK-NEXT:    [[PHI:%.*]] = phi i64 [ 0, [[DEAD:%.*]] ], [ 1, [[ENTRY:%.*]] ] ;INTEL
; CHECK-NEXT:    br label [[EXIT]]
; CHECK:       exit:
; CHECK-NEXT:    ret void
;

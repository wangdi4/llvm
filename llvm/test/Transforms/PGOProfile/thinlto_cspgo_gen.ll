...
<<<<<<< HEAD
; INTEL RUN: llvm-lto2 run -opaque-pointers -lto-cspgo-profile-file=alloc -lto-cspgo-gen -save-temps -o %t %t1.bc %t2.bc \
=======
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers -lto-cspgo-profile-file=alloc -lto-cspgo-gen -save-temps -o %t %t1.bc %t2.bc \

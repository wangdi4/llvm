...
<<<<<<< HEAD
; INTEL RUN: llvm-lto2 run -opaque-pointers -lto-cspgo-profile-file=%t3.profdata -pgo-instrument-entry=false -save-temps -o %t %t1.bc %t2.bc \
=======
; RUN: llvm-lto2 run -lto-opaque-pointers -opaque-pointers -lto-cspgo-profile-file=%t3.profdata -pgo-instrument-entry=false -save-temps -o %t %t1.bc %t2.bc \
>>>>>>> 442f45e4fe8d2a5161e68067387a7dd1a13384f5
; RUN:   -r=%t1.bc,foo,pl \
; RUN:   -r=%t1.bc,bar,l \

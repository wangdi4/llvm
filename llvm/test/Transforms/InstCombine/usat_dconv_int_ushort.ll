; RUN: opt < %s -instcombine -mcpu=penryn -S | FileCheck %s -check-prefix=PACKUSDW

target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; the source code:
;// packusdw is sse4.1 instruction
...
; PACKUSDW-LABEL: kernel
; PACKUSDW: usat.dcnv.v8i16
define void @kernel(i32* nocapture readonly %a, i16* nocapture %b, i32 %N) #0 {
entry:
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %29 = icmp sgt <8 x i32> %wide.load, <i32 65535, i32 65535, i32 65535, i32 65535, i32 65535, i32 65535, i32 65535, i32 65535>
  %30 = extractelement <8 x i1> %29, i32 0
  %31 = select <8 x i1> %29, <8 x i32> <i32 65535, i32 65535, i32 65535, i32 65535, i32 65535, i32 65535, i32 65535, i32 65535>, <8 x i32> %wide.load
  %32 = icmp slt <8 x i32> %31, zeroinitializer
  %33 = trunc <8 x i32> %31 to <8 x i16>
  %34 = extractelement <8 x i1> %32, i32 0
  %35 = select <8 x i1> %32, <8 x i16> zeroinitializer, <8 x i16> %33
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %cmp1 = icmp sgt i32 %58, 65535
  %. = select i1 %cmp1, i32 65535, i32 %58
  %cmp4 = icmp slt i32 %., 0
  %59 = trunc i32 %. to i16
  %conv = select i1 %cmp4, i16 0, i16 %59

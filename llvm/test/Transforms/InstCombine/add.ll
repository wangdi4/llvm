...
; CHECK-NEXT:    [[TMP1:%.*]] = select i1 [[Y:%.*]], i32 31, i32 0 ;INTEL
; CHECK-NEXT:    [[SUB:%.*]] = add nuw nsw i32 [[TMP1]], [[XZ]] ;INTEL
...
; CHECK-NEXT:    [[TMP1:%.*]] = select i1 [[X:%.*]], i32 31, i32 0 ;INTEL
; CHECK-NEXT:    [[TMP2:%.*]] = select i1 [[Y:%.*]], i32 31, i32 0 ;INTEL
; CHECK-NEXT:    [[SUB:%.*]] = add nuw nsw i32 [[TMP2]], [[TMP1]] ;INTEL
; CHECK-NEXT:    [[R:%.*]] = and i32 [[SUB]], 31
; CHECK-NEXT:    ret i32 [[R]]
;
  %xs = sext i1 %x to i32
...
; CHECK-NEXT:    [[TMP1:%.*]] = select i1 [[A:%.*]], i32 -2, i32 0 ;INTEL
; CHECK-NEXT:    ret i32 [[TMP1]] ;INTEL
;
  %sext = sext i1 %a to i32

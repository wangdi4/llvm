...
; INTEL_CUSTOMIZATION
; RUN: opt --opaque-pointers -xmain-enable-gep0-removal -passes=instcombine -S -o - %s | FileCheck %s
...
; CHECK-NEXT:    call void @llvm.dbg.declare(metadata ptr [[VLA1]], metadata [[META19:![0-9]+]], metadata !DIExpression()), !dbg [[DBG20:![0-9]+]]
; CHECK-NEXT:    [[CALL:%.*]] = call i32 @bar(ptr nonnull [[VLA1]]) #[[ATTR0:[0-9]+]], !dbg [[DBG21:![0-9]+]]

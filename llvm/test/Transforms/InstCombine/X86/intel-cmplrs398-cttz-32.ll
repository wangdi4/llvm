...
; RUN: opt -passes="instcombine" < %s -mtriple=i686-unknown-unknown -mattr=+bmi -S | FileCheck %s
...
entry:
  ...
  %arrayidx = getelementptr inbounds [64 x i32], [64 x i32]* @_ZL10magictable, i32 0, i32 %trunc

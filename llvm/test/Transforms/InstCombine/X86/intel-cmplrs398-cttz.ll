...
; RUN: opt -opaque-pointers=0 -passes="instcombine" < %s -mtriple=x86_64-unknown-unknown -mattr=+bmi -S | FileCheck %s
; RUN: opt -opaque-pointers=0 -passes="instcombine" < %s -mtriple=x86_64-unknown-unknown -mattr=-bmi -S | FileCheck %s --check-prefix=NOBMI

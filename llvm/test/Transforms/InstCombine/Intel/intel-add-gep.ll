...
; Suppress IC folding the add+gep sequence into gep,gep.
; If the sequence is in the loop, LSR may create an extra phi for the GEP.
; BasicAA's base pointer analysis may get the wrong value for the base, if
...
attributes #0 = { "target-features"="+avx2,+avx512bw,+avx512cd,+avx512dq,+avx512f,+avx512vl" }

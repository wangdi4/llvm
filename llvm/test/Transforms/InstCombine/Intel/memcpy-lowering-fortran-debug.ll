...
; CHECK: Generating fields for memcpy   call void @"llvm.memcpy.p0s_ESMF_BASETIMEMOD$.btESMF_BASETIMEs.p0s_ESMF_BASETIMEMOD$.btESMF_BASETIMEs.i64"(ptr nonnull align 1 dereferenceable(32) %0, ptr nonnull align 8 dereferenceable(32) %1, i64 32, i1 false)
; CHECK: Generating fields for memcpy   call void @"llvm.memcpy.p0s_ESMF_BASETIMEMOD$.btESMF_BASETIME_NESTEDs.p0s_ESMF_BASETIMEMOD$.btESMF_BASETIME_NESTEDs.i64"(ptr nonnull align 1 dereferenceable(48) %0, ptr nonnull align 8 dereferenceable(48) %1, i64 48, i1 false)
; CHECK-NOT: Generating fields for memcpy   call void @"llvm.memcpy.p0s_ESMF_BASETIMEMOD$.btESMF_BASETIMEs.p0s_ESMF_BASETIMEMOD$.btESMF_BASETIMEs.i64"(ptr nonnull align 1 dereferenceable(32) %0, ptr nonnull align 8 dereferenceable(32) %1, i64 32, i1 false)
; CHECK-NOT: Generating fields for memcpy   call void @"llvm.memcpy.p0s_ESMF_BASETIMEMOD$.btESMF_BASETIME_NESTEDs.p0s_ESMF_BASETIMEMOD$.btESMF_BASETIME_NESTEDs.i64"(ptr nonnull align 1 dereferenceable(48) %0, ptr nonnull align 8 dereferenceable(48) %1, i64 48, i1 false)

...
; CHECK-NEXT:    [[B:%.*]] = call i32 @llvm.vector.reduce.and.v2i32(<2 x i32> [[X:%.*]])
; CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[B]] to i64
; CHECK-NEXT:    ret i64 [[TMP1]]
;
  %a = sext <2 x i32> %x to <2 x i64>
  %b = call i64 @llvm.vector.reduce.and.v2i64(<2 x i64> %a)
  ret i64 %b
}

define i64 @test_sext_or(<2 x i32> %x) {
; CHECK-LABEL: @test_sext_or(
; CHECK-NEXT:    [[B:%.*]] = call i32 @llvm.vector.reduce.or.v2i32(<2 x i32> [[X:%.*]])
; CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[B]] to i64
; CHECK-NEXT:    ret i64 [[TMP1]]
;
  %a = sext <2 x i32> %x to <2 x i64>
  %b = call i64 @llvm.vector.reduce.or.v2i64(<2 x i64> %a)
  ret i64 %b
}

define i64 @test_sext_xor(<2 x i32> %x) {
; CHECK-LABEL: @test_sext_xor(
; CHECK-NEXT:    [[B:%.*]] = call i32 @llvm.vector.reduce.xor.v2i32(<2 x i32> [[X:%.*]])
; CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[B]] to i64
; CHECK-NEXT:    ret i64 [[TMP1]]
;
  %a = sext <2 x i32> %x to <2 x i64>
  %b = call i64 @llvm.vector.reduce.xor.v2i64(<2 x i64> %a)
  ret i64 %b
}

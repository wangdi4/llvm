...
; CHECK-NEXT:   %3 = load i32, i32* %len, align 4
; CHECK-NEXT:   %sub4 = sub i32 %3, %conv3
; CHECK-NEXT:   store i32 %sub4, i32* %len, align 4
...
define internal fastcc zeroext i1 @dict_repeat(%struct.lzma_dict* noundef %dict, i32 noundef %distance, i32* noundef %len) {
entry:
  %limit = getelementptr inbounds %struct.lzma_dict, %struct.lzma_dict* %dict, i32 0, i32 3
  %0 = load i64, i64* %limit, align 8
  %pos = getelementptr inbounds %struct.lzma_dict, %struct.lzma_dict* %dict, i32 0, i32 1
...
do.body:                                          ; preds = %cond.end, %do.body
  ...
  %buf = getelementptr inbounds %struct.lzma_dict, %struct.lzma_dict* %dict, i32 0, i32 0
...
if.then15:                                        ; preds = %if.else
  %buf16 = getelementptr inbounds %struct.lzma_dict, %struct.lzma_dict* %dict, i32 0, i32 0
  %8 = load i8*, i8** %buf16, align 8
  %add.ptr = getelementptr inbounds i8, i8* %8, i64 %7
  %idx.neg = sub i64 0, %conv11
  %add.ptr21 = getelementptr inbounds i8, i8* %add.ptr, i64 %idx.neg
  %add.ptr22 = getelementptr inbounds i8, i8* %add.ptr21, i64 -1
  %conv23 = zext i32 %conv3 to i64
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %add.ptr, i8* align 1 %add.ptr22, i64 %conv23, i1 false)
...
if.else26:                                        ; preds = %if.else
  ...
  %size = getelementptr inbounds %struct.lzma_dict, %struct.lzma_dict* %dict, i32 0, i32 4
...
if.then39:                                        ; preds = %if.else26
  %buf40 = getelementptr inbounds %struct.lzma_dict, %struct.lzma_dict* %dict, i32 0, i32 0
  %11 = load i8*, i8** %buf40, align 8
  %add.ptr42 = getelementptr inbounds i8, i8* %11, i64 %7
  %add.ptr45 = getelementptr inbounds i8, i8* %11, i64 %conv34
  %conv46 = zext i32 %conv36 to i64
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 1 %add.ptr42, i8* align 1 %add.ptr45, i64 %conv46, i1 false)
  %12 = load i64, i64* %pos, align 8
  %add49 = add i64 %12, %conv46
  store i64 %add49, i64* %pos, align 8
  %sub50 = sub i32 %conv3, %conv36
  %13 = load i8*, i8** %buf40, align 8
  %add.ptr53 = getelementptr inbounds i8, i8* %13, i64 %add49
  %conv55 = zext i32 %sub50 to i64
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %add.ptr53, i8* align 1 %13, i64 %conv55, i1 false)
  %14 = load i64, i64* %pos, align 8
  %add58 = add i64 %14, %conv55
  store i64 %add58, i64* %pos, align 8
  br label %if.end

if.else59:                                        ; preds = %if.else26
  %buf60 = getelementptr inbounds %struct.lzma_dict, %struct.lzma_dict* %dict, i32 0, i32 0
  %15 = load i8*, i8** %buf60, align 8
  %add.ptr62 = getelementptr inbounds i8, i8* %15, i64 %7
  %add.ptr65 = getelementptr inbounds i8, i8* %15, i64 %conv34
  %conv66 = zext i32 %conv3 to i64
  call void @llvm.memmove.p0i8.p0i8.i64(i8* align 1 %add.ptr62, i8* align 1 %add.ptr65, i64 %conv66, i1 false)
...
if.end71:                                         ; preds = %if.then15, %if.end, %do.body
  %full = getelementptr inbounds %struct.lzma_dict, %struct.lzma_dict* %dict, i32 0, i32 2
  %17 = load i64, i64* %full, align 8
  %18 = load i64, i64* %pos, align 8
  %cmp73 = icmp ult i64 %17, %18
  br i1 %cmp73, label %if.then75, label %if.end78

if.then75:                                        ; preds = %if.end71
  store i64 %18, i64* %full, align 8
  br label %if.end78

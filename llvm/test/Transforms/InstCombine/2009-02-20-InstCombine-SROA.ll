...
; RUN: opt -xmain-enable-gep0-removal < %s -passes=instcombine -S | FileCheck --check-prefix=IC %s
; RUN: opt -xmain-enable-gep0-removal < %s -passes='instcombine,sroa' -S | FileCheck --check-prefix=IC_SROA %s

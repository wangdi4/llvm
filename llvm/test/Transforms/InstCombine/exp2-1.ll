...
; NOLDEXPF-NEXT:    [[LDEXPF:%.*]] = call float @ldexpf(float 1.000000e+00, i32 [[X:%.*]]) ;INTEL
; NOLDEXPF-NEXT:    ret float [[LDEXPF]] ;INTEL
;
...
; NOLDEXPF-NEXT:    [[TMP1:%.*]] = zext i8 [[X:%.*]] to i32 ;INTEL
; NOLDEXPF-NEXT:    [[LDEXPF:%.*]] = call float @ldexpf(float 1.000000e+00, i32 [[TMP1]]) ;INTEL
; NOLDEXPF-NEXT:    ret float [[LDEXPF]] ;INTEL
;
...
; NOLDEXPF-NEXT:    [[TMP1:%.*]] = sext i8 [[X:%.*]] to i32 ;INTEL
; NOLDEXPF-NEXT:    [[LDEXPF:%.*]] = tail call nnan float @ldexpf(float 1.000000e+00, i32 [[TMP1]]) ;INTEL
; NOLDEXPF-NEXT:    ret float [[LDEXPF]] ;INTEL
;

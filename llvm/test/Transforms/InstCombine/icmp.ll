...
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i64 [[OFFS:%.*]], -2 ;INTEL
; CHECK-NEXT:    ret i1 [[CMP]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = trunc i32 [[B:%.*]] to i8 ;INTEL
; CHECK-NEXT:    [[TMP2:%.*]] = and i8 [[TMP1]], 127 ;INTEL
; CHECK-NEXT:    [[C:%.*]] = icmp eq i8 [[TMP2]], [[A:%.*]] ;INTEL
; CHECK-NEXT:    ret i1 [[C]]
;
  %t = and i32 %b, 127
  %z = zext i8 %a to i32
...
; CHECK-NEXT:    [[TMP1:%.*]] = trunc i32 [[B:%.*]] to i8 ;INTEL
; CHECK-NEXT:    [[TMP2:%.*]] = and i8 [[TMP1]], -2 ;INTEL
; CHECK-NEXT:    [[C:%.*]] = icmp eq i8 [[TMP2]], [[A:%.*]] ;INTEL
; CHECK-NEXT:    ret i1 [[C]]
;
  %t = and i32 %b, 254
...
; CHECK-NEXT:    [[TMP1:%.*]] = trunc i32 [[CMP_UNSHIFTED]] to i8 ;INTEL
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i8 [[TMP1]], 0 ;INTEL

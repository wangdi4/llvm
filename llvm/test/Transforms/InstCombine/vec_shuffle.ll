...
define <4 x i64> @intel_div_shuffle(i64 %A) {
; CHECK-LABEL: @intel_div_shuffle(
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <4 x i64> undef, i64 [[A:%.*]], i32 0
; CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <4 x i64> [[TMP1]], <4 x i64> undef, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP3:%.*]] = udiv <4 x i64> [[TMP2]], <i64 4294967295, i64 4294967295, i64 4294967295, i64 4294967295>
; CHECK-NEXT:    ret <4 x i64> [[TMP3]]
;
  %1 = insertelement <4 x i64> undef, i64 %A, i32 0
  %2 = shufflevector <4 x i64> %1, <4 x i64> undef, <4 x i32> zeroinitializer
  %3 = udiv <4 x i64> %2, <i64 4294967295, i64 4294967295, i64 4294967295, i64 4294967295>
  ret <4 x i64> %3
}

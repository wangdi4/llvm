...
; CHECK-LABEL:  %1 = getelementptr inbounds %struct.s64, %struct.s64* %q, i64 0, i32 0
; CHECK-NEXT:  %2 = getelementptr inbounds %struct.s64, %struct.s64* %p, i64 0, i32 0
; CHECK-NEXT:  %3 = load i32, i32* %1, align 4, !tbaa !9
; CHECK-NEXT:  store i32 %3, i32* %2, align 4, !tbaa !9
; CHECK-NEXT:  %4 = getelementptr inbounds %struct.s64, %struct.s64* %q, i64 0, i32 1
; CHECK-NEXT:  %5 = getelementptr inbounds %struct.s64, %struct.s64* %p, i64 0, i32 1
; CHECK-NEXT:  %6 = load i16, i16* %4, align 2, !tbaa !11
; CHECK-NEXT:  store i16 %6, i16* %5, align 2, !tbaa !11
; CHECK-NEXT:  %7 = getelementptr inbounds %struct.s64, %struct.s64* %q, i64 0, i32 2
; CHECK-NEXT:  %8 = getelementptr inbounds %struct.s64, %struct.s64* %p, i64 0, i32 2
; CHECK-NEXT:  %9 = load i8, i8* %7, align 1, !tbaa !13
; CHECK-NEXT:  store i8 %9, i8* %8, align 1, !tbaa !13
; CHECK-NEXT:  %10 = getelementptr inbounds %struct.s64, %struct.s64* %q, i64 0, i32 3
; CHECK-NEXT:  %11 = getelementptr inbounds %struct.s64, %struct.s64* %p, i64 0, i32 3
; CHECK-NEXT:  %12 = load i8, i8* %10, align 1, !tbaa !13
; CHECK-NEXT:  store i8 %12, i8* %11, align 1, !tbaa !13

...
; CHECK-LABEL: @use(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[SRC:%.*]], align 4, !tbaa [[TBAA0:![0-9]+]]
; CHECK-NEXT:    store i32 [[TMP0]], ptr getelementptr inbounds ([[STRUCT_A:%.*]], ptr @dest, i64 0, i32 0, i32 0), align 4, !tbaa [[TBAA0]]
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds { i32, i32 }, ptr [[SRC]], i64 0, i32 1
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[TMP1]], align 4, !tbaa [[TBAA0]]
; CHECK-NEXT:    store i32 [[TMP2]], ptr getelementptr inbounds ([[STRUCT_A]], ptr @dest, i64 0, i32 0, i32 1), align 4, !tbaa [[TBAA0]]
; CHECK-NEXT:    ret void
;
entry:

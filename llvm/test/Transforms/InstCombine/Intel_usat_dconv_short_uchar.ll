; RUN: opt < %s -instcombine -S | FileCheck %s -check-prefix=PACKUSWB
...
; PACKUSWB-LABEL: kernel
; PACKUSWD: usat.dcnv.v16i8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %55 = icmp sgt <16 x i16> %wide.load, <i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255, i16 255>
  %56 = icmp slt <16 x i16> %wide.load, zeroinitializer
  ...
  %61 = select <16 x i1> %55, <16 x i8> <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>, <16 x i8> %59
  %62 = extractelement <16 x i1> %58, i32 0
  %63 = select <16 x i1> %58, <16 x i8> zeroinitializer, <16 x i8> %61
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %cmp1 = icmp sgt i16 %102, 255
  %cmp636 = icmp slt i16 %102, 0
  %not.cmp1 = xor i1 %cmp1, true
  %cmp6 = and i1 %cmp636, %not.cmp1
  %conv12 = trunc i16 %102 to i8
  %.conv12 = select i1 %cmp1, i8 -1, i8 %conv12
  %cond23 = select i1 %cmp6, i8 0, i8 %.conv12

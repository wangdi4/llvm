...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp ueq half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CMPZERO:%.*]] = fcmp oeq half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMPZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp ueq half [[X:%.*]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CMPZERO:%.*]] = fcmp oeq half [[X]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMPZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[CMPZERO:%.*]] = fcmp one half [[X:%.*]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp une half [[X]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[NOT_CLASS:%.*]] = and i1 [[CMPZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[NOT_CLASS]]
;
  %fabs = call half @llvm.fabs.f16(half %x)
...
; CHECK-NEXT:    [[IS_NORMAL_INF:%.*]] = fcmp oge half [[X:%.*]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[IS_UNE:%.*]] = fcmp une half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[OR:%.*]] = or i1 [[IS_UNE]], [[IS_NORMAL_INF]] ;INTEL
; CHECK-NEXT:    ret i1 [[OR]]
;
...
; CHECK-NEXT:    [[NOT_IS_POS_NORMAL_INF:%.*]] = fcmp ult half [[X:%.*]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[IS_INF:%.*]] = fcmp oeq half [[X]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[OR:%.*]] = or i1 [[NOT_IS_POS_NORMAL_INF]], [[IS_INF]] ;INTEL
; CHECK-NEXT:    ret i1 [[OR]]
;
...
; CHECK-NEXT:    [[ORD:%.*]] = fcmp ord half [[X:%.*]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_SMALLEST_NORMAL]], [[ORD]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[UNO:%.*]] = fcmp uno half [[X:%.*]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_SMALLEST_NORMAL]], [[UNO]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[UNO:%.*]] = fcmp uno half [[X:%.*]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp uge half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_SMALLEST_NORMAL]], [[UNO]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %uno = fcmp uno half %x, 0.0
...
; CHECK-NEXT:    [[UNO:%.*]] = fcmp uno half [[X:%.*]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp uge half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = and i1 [[CMP_SMALLEST_NORMAL]], [[UNO]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %uno = fcmp uno half %x, 0.0
  %cmp.smallest.normal = fcmp uge half %x, 0xH0400
...
; CHECK-NEXT:    [[LT_INFINITY:%.*]] = fcmp olt half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_SMALLEST_NORMAL]], [[LT_INFINITY]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[LT_INFINITY:%.*]] = fcmp olt half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = and i1 [[CMP_SMALLEST_NORMAL]], [[LT_INFINITY]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %lt.infinity = fcmp olt half %x, 0xH7C00
  %cmp.smallest.normal = fcmp olt half %x, 0xH0400
...
; CHECK-NEXT:    [[LT_INFINITY:%.*]] = fcmp olt half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[ORD:%.*]] = fcmp ord half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[LT_INFINITY]], [[ORD]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %lt.infinity = fcmp olt half %x, 0xH7C00
...
; CHECK-NEXT:    [[LT_INFINITY:%.*]] = fcmp olt half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[UNO:%.*]] = fcmp uno half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[LT_INFINITY]], [[UNO]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %lt.infinity = fcmp olt half %x, 0xH7C00
...
; CHECK-NEXT:    [[LT_NORMAL:%.*]] = fcmp olt half [[X:%.*]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[EQ_INF:%.*]] = fcmp ueq half [[X]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[LT_NORMAL]], [[EQ_INF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[LT_NORMAL:%.*]] = fcmp olt half [[X:%.*]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[EQ_INF:%.*]] = fcmp une half [[X]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[LT_NORMAL]], [[EQ_INF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %lt.normal = fcmp olt half %x, 0xH0400
...
; CHECK-NEXT:    [[LT_NORMAL:%.*]] = fcmp olt half [[X:%.*]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[EQ_INF:%.*]] = fcmp une half [[X]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = and i1 [[LT_NORMAL]], [[EQ_INF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %lt.normal = fcmp olt half %x, 0xH0400
  %eq.inf = fcmp une half %x, 0xH7C00
...
; CHECK-NEXT:    [[OGE_FABS_INF:%.*]] = fcmp oge half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[ORD:%.*]] = fcmp ord half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[AND:%.*]] = and i1 [[OGE_FABS_INF]], [[ORD]] ;INTEL
; CHECK-NEXT:    ret i1 [[AND]]
;
...
; CHECK-NEXT:    [[OGE_FABS_INF:%.*]] = fcmp oge half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[UNO:%.*]] = fcmp uno half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[OR:%.*]] = or i1 [[OGE_FABS_INF]], [[UNO]] ;INTEL
; CHECK-NEXT:    ret i1 [[OR]]
;
  %oge.fabs.inf = fcmp oge half %x, 0xH7C00
  %uno = fcmp uno half %x, 0xH0000
...
; CHECK-NEXT:    [[ULT_FABS_INF:%.*]] = fcmp ult half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[UNO:%.*]] = fcmp uno half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[OR:%.*]] = or i1 [[ULT_FABS_INF]], [[UNO]] ;INTEL
; CHECK-NEXT:    ret i1 [[OR]]
;
  %ult.fabs.inf = fcmp ult half %x, 0xH7C00
  %uno = fcmp uno half %x, 0xH0000
...
; CHECK-NEXT:    [[OEQ_NEG_INFINITY:%.*]] = fcmp oeq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[OEQ_NEG_INFINITY]], [[CMP_SMALLEST_NORMAL]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %oeq.neg.infinity = fcmp oeq half %x, 0xHFC00
  %cmp.smallest.normal = fcmp olt half %x, 0xH0400
...
; CHECK-NEXT:    [[OEQ_NEG_INFINITY:%.*]] = fcmp oeq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = and i1 [[OEQ_NEG_INFINITY]], [[CMP_SMALLEST_NORMAL]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %oeq.neg.infinity = fcmp oeq half %x, 0xHFC00
  %cmp.smallest.normal = fcmp olt half %x, 0xH0400
...
; CHECK-NEXT:    [[OEQ_NEG_INFINITY:%.*]] = fcmp oeq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp oge half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[OEQ_NEG_INFINITY]], [[CMP_SMALLEST_NORMAL]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %oeq.neg.infinity = fcmp oeq half %x, 0xHFC00
...
; CHECK-NEXT:    [[OEQ_NEG_INFINITY:%.*]] = fcmp oeq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[ORD:%.*]] = fcmp ord half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[OEQ_NEG_INFINITY]], [[ORD]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %oeq.neg.infinity = fcmp oeq half %x, 0xHFC00
  %ord = fcmp ord half %x, 0.0
...
; CHECK-NEXT:    [[OEQ_NEG_INFINITY:%.*]] = fcmp oeq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[ORD:%.*]] = fcmp ord half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = and i1 [[OEQ_NEG_INFINITY]], [[ORD]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %oeq.neg.infinity = fcmp oeq half %x, 0xHFC00
  %ord = fcmp ord half %x, 0.0
...
; CHECK-NEXT:    [[ONE_NEG_INFINITY:%.*]] = fcmp one half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[ONE_NEG_INFINITY]], [[CMP_SMALLEST_NORMAL]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[ONE_NEG_INFINITY:%.*]] = fcmp one half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = and i1 [[ONE_NEG_INFINITY]], [[CMP_SMALLEST_NORMAL]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %one.neg.infinity = fcmp one half %x, 0xHFC00
  %cmp.smallest.normal = fcmp olt half %x, 0xH0400
...
; CHECK-NEXT:    [[ONE_NEG_INFINITY:%.*]] = fcmp one half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[UNO:%.*]] = fcmp uno half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[ONE_NEG_INFINITY]], [[UNO]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %one.neg.infinity = fcmp one half %x, 0xHFC00
  %uno = fcmp uno half %x, 0.0
...
; CHECK-NEXT:    [[UEQ_NEG_INFINITY:%.*]] = fcmp ueq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[UEQ_NEG_INFINITY]], [[CMP_SMALLEST_NORMAL]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[UEQ_NEG_INFINITY:%.*]] = fcmp ueq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_SMALLEST_NORMAL:%.*]] = fcmp olt half [[X]], 0xH0400 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = and i1 [[UEQ_NEG_INFINITY]], [[CMP_SMALLEST_NORMAL]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %ueq.neg.infinity = fcmp ueq half %x, 0xHFC00
  %cmp.smallest.normal = fcmp olt half %x, 0xH0400
...
; CHECK-NEXT:    [[UEQ_NEG_INFINITY:%.*]] = fcmp ueq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[UNO:%.*]] = fcmp uno half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[UEQ_NEG_INFINITY]], [[UNO]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %ueq.neg.infinity = fcmp ueq half %x, 0xHFC00
  %uno = fcmp uno half %x, 0.0
...
; CHECK-NEXT:    [[UEQ_NEG_INFINITY:%.*]] = fcmp ueq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[ORD:%.*]] = fcmp uno half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = and i1 [[UEQ_NEG_INFINITY]], [[ORD]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %ueq.neg.infinity = fcmp ueq half %x, 0xHFC00
  %ord = fcmp uno half %x, 0.0
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp ueq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_OGE_ZERO:%.*]] = fcmp oge half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_OGE_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp oeq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_OGE_ZERO:%.*]] = fcmp oge half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_OGE_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp oeq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_OGT_ZERO:%.*]] = fcmp ogt half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_OGT_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp oeq half %x, 0xHFC00
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp oeq half [[X:%.*]], 0xHFC00 ;INTEL
; CHECK-NEXT:    [[CMP_UGT_ZERO:%.*]] = fcmp ugt half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_UGT_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp oeq half %x, 0xHFC00
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp ueq half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CMP_OLE_ZERO:%.*]] = fcmp ole half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_OLE_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp ueq half %x, 0xH7C00
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp oeq half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CMP_OLE_ZERO:%.*]] = fcmp ole half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_OLE_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp oeq half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CMP_OLT_ZERO:%.*]] = fcmp olt half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_OLT_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp oeq half %x, 0xH7C00
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp ueq half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CMP_ULT_ZERO:%.*]] = fcmp ult half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_ULT_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp ueq half %x, 0xH7C00
...
; CHECK-NEXT:    [[CMPINF:%.*]] = fcmp ueq half [[X:%.*]], 0xH7C00 ;INTEL
; CHECK-NEXT:    [[CMP_ULE_ZERO:%.*]] = fcmp ule half [[X]], 0xH0000 ;INTEL
; CHECK-NEXT:    [[CLASS:%.*]] = or i1 [[CMP_ULE_ZERO]], [[CMPINF]] ;INTEL
; CHECK-NEXT:    ret i1 [[CLASS]]
;
  %cmpinf = fcmp ueq half %x, 0xH7C00

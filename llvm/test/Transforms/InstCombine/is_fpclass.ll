...
; Turning off the testing of this intrinsic here until support is added.
; Revert this change when support for is_fpclass is available.
...
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[CLASS0:%.*]] = fcmp oeq <2 x float> [[A:%.*]], <float 0xFFF0000000000000, float 0xFFF0000000000000>
...
; CHECK-NEXT:    [[CLASS0:%.*]] = call i1 @llvm.is.fpclass.f32(float [[A:%.*]], i32 1)
; CHECK-NEXT:    [[CLASS1:%.*]] = fcmp uno float [[A]], 0.000000e+00 ;INTEL
; CHECK-NEXT:    [[AND:%.*]] = and i1 [[CLASS0]], [[CLASS1]] ;INTEL
; CHECK-NEXT:    ret i1 [[AND]] ;INTEL
;
  %class0 = call i1 @llvm.is.fpclass.f32(float %a, i32 1)
  %class1 = fcmp uno float %a, 0.000000e+00
...
; CHECK-NEXT:    [[CLASS1:%.*]] = call i1 @llvm.is.fpclass.f32(float [[A]], i32 2)
; CHECK-NEXT:    [[CLASS2:%.*]] = fcmp ueq float [[A]], 0xFFF0000000000000
...
; CHECK-NEXT:    [[CLASS2:%.*]] = fcmp une float [[A]], 0xFFF0000000000000
...
; CHECK-NEXT:    [[CLASS9:%.*]] = fcmp une float [[A]], 0x7FF0000000000000
; CHECK-NEXT:    [[AND_0:%.*]] = and i1 [[CLASS0]], [[CLASS1]]
; CHECK-NEXT:    [[AND_1:%.*]] = and i1 [[AND_0]], [[CLASS2]]
; CHECK-NEXT:    [[AND_2:%.*]] = and i1 [[AND_1]], [[CLASS3]]
; CHECK-NEXT:    [[AND_3:%.*]] = and i1 [[AND_2]], [[CLASS4]]
...
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[CLASS0:%.*]] = fcmp ueq <2 x float> [[A:%.*]], <float 0xFFF0000000000000, float 0xFFF0000000000000>
...
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[CLASS0:%.*]] = fcmp oeq <2 x float> [[A:%.*]], <float 0xFFF0000000000000, float 0xFFF0000000000000>
; CHECK-NEXT:    [[CLASS1:%.*]] = call <2 x i1> @llvm.is.fpclass.v2f32(<2 x float> [[A]], i32 13)
; CHECK-NEXT:    [[XOR:%.*]] = xor <2 x i1> [[CLASS0]], [[CLASS1]]

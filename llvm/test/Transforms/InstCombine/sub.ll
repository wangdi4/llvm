...
; INTEL: Added -disable-instcombine-add-sub-reassoc=0
; RUN: opt < %s -instcombine -disable-instcombine-add-sub-reassoc=0 -S | FileCheck %s
...
>>>>>>> 8b300679192b317aa91a28e781fcf60d4416b0d6
;
  %B = getelementptr inbounds [42 x i16], [42 x i16]* @Arr, i64 0, i64 %A
  %C = ptrtoint i16* %B to i64

...
; RUN: opt -S -O3 < %s | FileCheck %s --match-full-lines
; RUN: opt -S -O2 < %s | FileCheck %s --match-full-lines
; RUN: opt -passes='default<O2>' -S < %s | FileCheck %s --match-full-lines
; RUN: opt -passes='default<O3>' -S < %s | FileCheck %s --match-full-lines

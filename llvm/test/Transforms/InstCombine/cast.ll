...
; xmain seems to figure out that many of these GEPs are OOB ;INTEL
...
; ALL-LABEL: @test68(
; ALL-NEXT:    [[PP:%.*]] = getelementptr [[S:%.*]], ptr [[P:%.*]], i64 [[I:%.*]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load [[S]], ptr [[PP]], align 4 ;INTEL
; ALL-NEXT:    ret [[S]] [[L]]
;
  %o = mul i64 %i, 12
...
; ALL-NEXT:    [[PP:%.*]] = getelementptr [[S:%.*]], ptr addrspace(1) [[P:%.*]], i32 [[I:%.*]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load [[S]], ptr addrspace(1) [[PP]], align 4 ;INTEL
; ALL-NEXT:    ret [[S]] [[L]]
;
  %o = mul i32 %i, 12
...
; ALL-LABEL: @test69(
; ALL-NEXT:    [[PP:%.*]] = getelementptr inbounds double, ptr [[P:%.*]], i64 [[I:%.*]] ;INTEL
...
; ALL-LABEL: @test70(
; ALL-NEXT:    [[O:%.*]] = mul nsw i64 [[I:%.*]], 3 ;INTEL
; ALL-NEXT:    [[PP:%.*]] = getelementptr inbounds [[S:%.*]], ptr [[P:%.*]], i64 [[O]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load [[S]], ptr [[PP]], align 4 ;INTEL
; ALL-NEXT:    ret [[S]] [[L]]
;
  %o = mul nsw i64 %i, 36
...
; ALL-LABEL: @test71(
; ALL-NEXT:    [[O:%.*]] = shl i64 [[I:%.*]], 2 ;INTEL
; ALL-NEXT:    [[PP:%.*]] = getelementptr double, ptr [[P:%.*]], i64 [[O]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load double, ptr [[PP]], align 8
; ALL-NEXT:    ret double [[L]]
;
  %o = shl i64 %i, 5
...
; ALL-LABEL: @test72(
; ALL-NEXT:    [[O:%.*]] = sext i32 [[I:%.*]] to i64 ;INTEL
; ALL-NEXT:    [[PP:%.*]] = getelementptr inbounds double, ptr [[P:%.*]], i64 [[O]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load double, ptr [[PP]], align 8
; ALL-NEXT:    ret double [[L]]
;
  %so = shl nsw i32 %i, 3
...
; ALL-NEXT:    [[PP:%.*]] = getelementptr double, ptr [[P:%.*]], i64 [[I_TR]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load double, ptr [[PP]], align 8
; ALL-NEXT:    ret double [[L]]
;
  %lo = shl nsw i128 %i, 3
...
; ALL-LABEL: @test76(
; ALL-NEXT:    [[O2:%.*]] = mul i64 [[I:%.*]], [[J:%.*]] ;INTEL
; ALL-NEXT:    [[PP:%.*]] = getelementptr [[S:%.*]], ptr [[P:%.*]], i64 [[O2]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load [[S]], ptr [[PP]], align 4 ;INTEL
; ALL-NEXT:    ret [[S]] [[L]]
;
  %o = mul i64 %i, 12
...
; ALL-NEXT:    [[PP:%.*]] = getelementptr inbounds [[S:%.*]], ptr [[P:%.*]], i64 [[O2]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load [[S]], ptr [[PP]], align 4 ;INTEL
; ALL-NEXT:    ret [[S]] [[L]]
;
  %o = mul nsw i64 %i, 36
...
; ALL-LABEL: @test78(
; ALL-NEXT:    [[A:%.*]] = mul nsw i32 [[K:%.*]], 3 ;INTEL
...
; ALL-NEXT:    [[PP:%.*]] = getelementptr [[S:%.*]], ptr [[P:%.*]], i64 [[H]]
...
; ALL-LABEL: @test80(
; ALL-NEXT:    [[TMP1:%.*]] = sext i32 [[I:%.*]] to i64 ;INTEL
; ALL-NEXT:    [[PP:%.*]] = getelementptr double, ptr [[P:%.*]], i64 [[TMP1]] ;INTEL
; ALL-NEXT:    [[L:%.*]] = load double, ptr [[PP]], align 8
; ALL-NEXT:    ret double [[L]]
;
  %t = shl nsw i32 %i, 3
...
; ALL-NEXT:    [[TMP1:%.*]] = sext i16 [[I:%.*]] to i32 ;INTEL
; ALL-NEXT:    [[PP:%.*]] = getelementptr double, ptr addrspace(1) [[P:%.*]], i32 [[TMP1]] ;INTEL

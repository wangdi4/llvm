; RUN: opt -opaque-pointers -instcombine -instcombine-preserve-for-dtrans=false < %s -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers -passes=instcombine -instcombine-preserve-for-dtrans=false < %s -S 2>&1 | FileCheck %s
...
; CHECK: %"foo_$MYB.repack" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 0
; CHECK: store ptr %phys_prop_mp_physprop__fetch.6.unpack, ptr %"foo_$MYB.repack", align 1
; CHECK: %"foo_$MYB.repack13" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 1
; CHECK: store i64 %phys_prop_mp_physprop__fetch.6.unpack2, ptr %"foo_$MYB.repack13", align 1
; CHECK: %"foo_$MYB.repack15" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 2
; CHECK: store i64 %phys_prop_mp_physprop__fetch.6.unpack3, ptr %"foo_$MYB.repack15", align 1
; CHECK: %"foo_$MYB.repack17" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 3
; CHECK: store i64 %phys_prop_mp_physprop__fetch.6.unpack4, ptr %"foo_$MYB.repack17", align 1
; CHECK: %"foo_$MYB.repack19" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 4
; CHECK: store i64 %phys_prop_mp_physprop__fetch.6.unpack5, ptr %"foo_$MYB.repack19", align 1
; CHECK: %"foo_$MYB.repack21" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 5
; CHECK: store i64 %phys_prop_mp_physprop__fetch.6.unpack6, ptr %"foo_$MYB.repack21", align 1
; CHECK: %"foo_$MYB.repack23.repack" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 6
; CHECK: store i64 %phys_prop_mp_physprop__fetch.6.unpack7.unpack.unpack, ptr %"foo_$MYB.repack23.repack", align 1
; CHECK: %"foo_$MYB.repack23.repack25" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 6, i64 0, i32 1
; CHECK: store i64 %phys_prop_mp_physprop__fetch.6.unpack7.unpack.unpack10, ptr %"foo_$MYB.repack23.repack25", align 1
; CHECK: %"foo_$MYB.repack23.repack27" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i64 0, i32 6, i64 0, i32 2
...
alloca_0:
  ...
  %fetch.1 = load i64, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 3), align 1
  ...
  store i64 %or.2, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 3), align 1
  store i64 0, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 5), align 1
  store i64 4, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 1), align 1
  store i64 1, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 4), align 1
  store i64 0, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 2), align 1
  store i64 1, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 6, i32 0, i32 2), align 1
  store i64 100, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 6, i32 0, i32 0), align 1
  store i64 4, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 6, i32 0, i32 1), align 1
  %fetch.2 = load i64, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 3), align 1
  %and.5 = and i64 %fetch.2, -68451041281
  %or.3 = or i64 %and.5, 1073741824
  store i64 %or.3, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 3), align 1
  ...
  %fetch.4 = load i64, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 5), align 1
  %"(i8*)fetch.4$" = inttoptr i64 %fetch.4 to ptr
  %func_result = call i32 @for_alloc_allocatable_handle(i64 400, ptr @phys_prop_mp_physprop_, i32 %or.9, ptr %"(i8*)fetch.4$")
  %"val$[]_fetch.5" = load i64, ptr getelementptr inbounds (%"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, i32 0, i32 6, i32 0, i32 2), align 1
  %phys_prop_mp_physprop__fetch.6 = load %"QNCA_a0$i32*$rank1$", ptr @phys_prop_mp_physprop_, align 1
  store %"QNCA_a0$i32*$rank1$" %phys_prop_mp_physprop__fetch.6, ptr %"foo_$MYB", align 1
  %"foo_$MYB.flags$" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i32 0, i32 3
  ...
  %"foo_$MYB.addr_a0$" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i32 0, i32 0
  %"foo_$MYB.addr_a0$_fetch.8" = load ptr, ptr %"foo_$MYB.addr_a0$", align 1
  %"foo_$MYB.dim_info$" = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %"foo_$MYB", i32 0, i32 6, i32 0
  ...
  %func_result9 = call i32 (ptr, i32, i64, ptr, ptr, ...) @for_write_seq_lis(ptr %"(i8*)$io_ctx$", i32 -1, i64 1239157112576, ptr %"(i8*)(&)val$$", ptr %"(i8*)argblock$")
  ret void
}

...
; Use SQR instead of SQRT as variable name to avoid checking by SQRT check-prefix.
; NOSQRT-NEXT:    [[SQR:%.*]] = call fast float @llvm.sqrt.f32(float [[X:%.*]])
; NOSQRT-NEXT:    ret float [[SQR]]

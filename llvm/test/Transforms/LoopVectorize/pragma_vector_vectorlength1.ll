...
;
; Cheks if the code with #pragma vector vectorlength(4, 2, 16) (!{!"llvm.loop.vector.vectorlength", i64 4, i64 2, i64 16} metadata)
; is being vectorized correctly with LoopVectorize
;
; void foo(int *arr)
; {
;   int i;
;
; #pragma vector vectorlength(4, 2, 16)
;   for (i = 0; i < 1024; i++)
;     arr[i] = i;
; }
;
; CHECK: Specified vectorlengths: 2 4
;
...
!8 = !{!"llvm.loop.intel.vector.vectorlength", i64 4, i64 2, i64 16}

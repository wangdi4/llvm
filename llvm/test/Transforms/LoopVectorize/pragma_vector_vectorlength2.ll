...
;
; Cheks if the code with #pragma vector vectorlength(2) (!{!"llvm.loop.vector.vectorlength", i64 2} metadata)
...
;   int i;
;
; #pragma vector vectorlength(2)
;   for (i = 0; i < 1024; i++)
;     arr[i] = i;
; }
;
; CHECK: Specified vectorlengths: 2
;
...
!8 = !{!"llvm.loop.intel.vector.vectorlength", i64 2}

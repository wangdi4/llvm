...
; REQUIRES: asserts
;
; Cheks if the code with #pragma vector vectorlength(1, 0, 4, 2, 0, 16)
; (!{!"llvm.loop.vector.vectorlength", i64 1, i64 0, i64 4, i64 2, i64 0, i64 16} metadata)
...
;   int i;
;
; #pragma vector vectorlength(1, 0, 4, 2, 0, 16)
;   for (i = 0; i < 1024; i++)
;     arr[i] = i;
; }
;
; CHECK: Specified vectorlengths: 1 2 4
;
...
!8 = !{!"llvm.loop.intel.vector.vectorlength", i64 1, i64 0, i64 4, i64 2, i64 0, i64 16}

...
; RUN: opt %s -S -loop-vectorize --debug-only=loop-vectorize-vec-lengths 2>&1 | FileCheck %s
;
; Cheks if the code with #pragma vector vectorlength(1) (!{!"llvm.loop.vector.vectorlength", i64 1} metadata)
; is being processed correctly with LoopVectorize
;
; void foo(int *arr)
; {
;   int i;
...
; }
;
; CHECK: Specified vectorlengths: 1
; CHECK-NOT: store <8 x i32>
;
...
!8 = !{!"llvm.loop.vector.vectorlength", i64 1}

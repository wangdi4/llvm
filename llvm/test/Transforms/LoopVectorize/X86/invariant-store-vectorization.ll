...
; CHECK-NEXT:    call void @llvm.masked.scatter.v16i32.v16p0i32(<16 x i32> [[BROADCAST_SPLAT7]], <16 x i32*> [[TMP6]], i32 4, <16 x i1> [[TMP4]])
...
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr i32, i32* [[A]], <8 x i64> zeroinitializer
; CHECK-NEXT:    call void @llvm.masked.scatter.v8i32.v8p0i32(<8 x i32> [[BROADCAST_SPLAT20]], <8 x i32*> [[TMP13]], i32 4, <8 x i1> [[TMP10]])
...
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr i32, i32* [[A]], <16 x i64> zeroinitializer
...
; CHECK-NEXT:    br i1 [[TMP9]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], [[LOOP24:!llvm.loop !.*]]
; CHECK:       middle.block:
; CHECK-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[SMAX]], [[N_VEC]]
; CHECK-NEXT:    br i1 [[CMP_N]], label [[FOR_END:%.*]], label [[VEC_EPILOG_ITER_CHECK:%.*]]
; CHECK:       vec.epilog.iter.check:
...
; CHECK-NEXT:    [[TMP17:%.*]] = getelementptr i32, i32* [[A]], <8 x i64> zeroinitializer
; CHECK-NEXT:    call void @llvm.masked.scatter.v8i32.v8p0i32(<8 x i32> [[WIDE_MASKED_LOAD32]], <8 x i32*> [[TMP17]], i32 4, <8 x i1> [[TMP12]])

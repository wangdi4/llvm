...
; RUN: opt < %s -mcpu=corei7 -enable-lv -loopopt=0 -enable-load-coalescing=false -O3 -unroll-threshold=150 -vectorize-loops=false -S -unroll-allow-partial=0 | FileCheck %s --check-prefix=O3DIS
=======
...
>>>>>>> 65e5006962bd49d0236a18d6772ea9f165b8c41a

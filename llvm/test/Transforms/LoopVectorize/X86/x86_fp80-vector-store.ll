...
<<<<<<< HEAD
; INTEL - Need to enable LV explicitly. Also disable proprietary passes to reduce effects on the pass pipeline.
; RUN: opt -passes='default<O3>,loop-vectorize' -disable-intel-proprietary-opts -enable-lv -force-vector-interleave=1 -force-vector-width=2 -S < %s | FileCheck %s
=======

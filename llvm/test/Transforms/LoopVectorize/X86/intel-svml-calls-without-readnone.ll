...
; RUN: opt -vector-library=SVML -inject-tli-mappings -loop-vectorize -vectorize-non-readonly-libcalls=false -force-vector-width=2 -force-vector-interleave=1 -mattr=avx -S < %s | FileCheck %s

...
; RUN: opt < %s  -O3 -loopopt=false -mcpu=corei7-avx -S | FileCheck %s -check-prefix=AVX -check-prefix=AVX1
; RUN: opt < %s  -O3 -loopopt=false -mcpu=core-avx2 -S | FileCheck %s -check-prefix=AVX -check-prefix=AVX2

...
; OPT-REPORT-NEXT:       remark: 'omp declare' vector variants with linear reference/ref()/uval()/val() or linear step passed as another argument were skipped as unsupported.
; OPT-REPORT-NEXT:   FUNCTION REPORT END
; OPT-REPORT-NEXT:   =================================================================

;; no vector variants to create
; VEC-CLONE-NOT: define {{.*}} _ZGV
; VEC-CLONE-NOT: "vector-variants"

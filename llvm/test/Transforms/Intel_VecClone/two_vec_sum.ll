...
; CHECK-NEXT:    store i32 [[I0]], ptr [[I_ADDR0]], align 4
; CHECK-NEXT:    store i32 [[J0]], ptr [[J_ADDR0]], align 4
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[I_ADDR0]], align 4
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[J_ADDR0]], align 4
...
; CHECK-NEXT:    [[I_ADDR0]] = alloca i32, align 4
; CHECK-NEXT:    [[J_ADDR0]] = alloca i32, align 4
; CHECK-NEXT:    store <4 x i32> [[I0]], ptr [[VEC_I0]], align 16
; CHECK-NEXT:    store <4 x i32> [[J0]], ptr [[VEC_J0]], align 16
; CHECK-NEXT:    br label [[SIMD_BEGIN_REGION0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  simd.begin.region:
; CHECK-NEXT:    [[ENTRY_REGION0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 4), "QUAL.OMP.PRIVATE:TYPED"(ptr [[I_ADDR0]], i32 0, i32 1), "QUAL.OMP.PRIVATE:TYPED"(ptr [[J_ADDR0]], i32 0, i32 1) ]
...
; CHECK-NEXT:    store i32 [[VEC_I_ELEM0]], ptr [[I_ADDR0]], align 4
; CHECK-NEXT:    [[VEC_J_CAST_GEP0:%.*]] = getelementptr i32, ptr [[VEC_J0]], i32 [[INDEX0]]
; CHECK-NEXT:    [[VEC_J_ELEM0:%.*]] = load i32, ptr [[VEC_J_CAST_GEP0]], align 4
; CHECK-NEXT:    store i32 [[VEC_J_ELEM0]], ptr [[J_ADDR0]], align 4
; CHECK-NEXT:    [[TMP0]] = load i32, ptr [[I_ADDR0]], align 4
; CHECK-NEXT:    [[TMP1]] = load i32, ptr [[J_ADDR0]], align 4
; CHECK-NEXT:    [[ADD0]] = add nsw i32 [[TMP0]], [[TMP1]]
; CHECK-NEXT:    [[RET_CAST_GEP0:%.*]] = getelementptr i32, ptr [[VEC_RETVAL0]], i32 [[INDEX0]]
; CHECK-NEXT:    store i32 [[ADD0]], ptr [[RET_CAST_GEP0]], align 4

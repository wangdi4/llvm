...
; Arguments: ptr
; ISA class: YMM1
; "vector-variants"="_ZGVyN8U2__Z3fooRl"
; Origin: linear_uval_optimized.ll
...
; CHECK-LABEL: define dso_local x86_regcallcc noundef { <2 x i64>, <2 x i64>, <2 x i64>, <2 x i64> } @_ZGVyN8U2__Z3fooRl
; CHECK-SAME: (ptr nocapture noundef nonnull readonly align 8 dereferenceable(8) [[X:%.*]]) local_unnamed_addr #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  entry:
...
attributes #0 = { mustprogress nofree noinline norecurse nosync nounwind willreturn memory(argmem: read) uwtable "vector-variants"="_ZGVyN8U2__Z3fooRl" }

...
; CHECK-LABEL-NOT: @_ZGVYN64u_func
; CHECK-NOT: "vector-variants"="_ZGVYN64u_func"
;
; OPT-REPORT:        Global optimization report for : func
; OPT-REPORT-EMPTY:
; OPT-REPORT-NEXT:   FUNCTION REPORT BEGIN
; OPT-REPORT-NEXT:       remark #15581: 'omp declare' vector variants were skipped due to limited support for vector length and/or argument and/or return type: _ZGVYN64u_func.
...
attributes #0 = { "vector-variants"="_ZGVYN64u_func" }

...
; CHECK-NEXT:    [[VEC_I_CAST_GEP0:%.*]] = getelementptr i32, ptr [[VEC_I0]], i32 [[INDEX0]]
; CHECK-NEXT:    [[VEC_I_ELEM0:%.*]] = load i32, ptr [[VEC_I_CAST_GEP0]], align 4
; CHECK-NEXT:    [[CMP0:%.*]] = icmp eq i32 [[VEC_I_ELEM0]], 97
; CHECK-NEXT:    [[CMP_ZEXT0:%.*]] = zext i1 [[CMP0]] to i8
; CHECK-NEXT:    [[RET_CAST_GEP0:%.*]] = getelementptr i8, ptr [[VEC_RETVAL0]], i32 [[INDEX0]]
; CHECK-NEXT:    store i8 [[CMP_ZEXT0]], ptr [[RET_CAST_GEP0]], align 1
...
; CHECK-EMPTY:
; CHECK-NEXT:  return:
; CHECK-NEXT:    [[VEC_RET0:%.*]] = load <16 x i8>, ptr [[VEC_RETVAL0]], align 16

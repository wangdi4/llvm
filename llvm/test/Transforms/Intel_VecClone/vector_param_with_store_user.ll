...
; FIXME: Remove -disable-verify once VecClone is fixed.
...
;
; FIXME: This is wrong and triggers verifier failure.
; CHECK-NEXT:    store <2 x float>* [[VEC_C_COERCE_CAST_GEP0]], <2 x float>* [[TMP0]], align 4

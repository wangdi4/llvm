...
; CHECK-NEXT:    store i32 [[N0]], ptr [[ALLOCA_N0]], align 4
...
; CHECK-NEXT:    store <8 x i32> [[V0]], ptr [[VEC_V0]], align 32
; CHECK-NEXT:    br label [[SIMD_BEGIN_REGION0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  simd.begin.region:
; CHECK-NEXT:    [[ENTRY_REGION0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 8), "QUAL.OMP.UNIFORM:TYPED"(ptr [[ALLOCA_N0]], i32 0, i32 1), "QUAL.OMP.PRIVATE:TYPED"(ptr [[V_ADDR0]], i32 0, i32 1), "QUAL.OMP.PRIVATE:TYPED"(ptr [[N_ADDR0]], i32 0, i32 1), "QUAL.OMP.PRIVATE:TYPED"(ptr [[I0]], i32 0, i32 1) ]
; CHECK-NEXT:    br label [[SIMD_LOOP_PREHEADER0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  simd.loop.preheader:
; CHECK-NEXT:    [[LOAD_N0:%.*]] = load i32, ptr [[ALLOCA_N0]], align 4
...
; CHECK-NEXT:    [[VEC_V_CAST_GEP0:%.*]] = getelementptr i32, ptr [[VEC_V0]], i32 [[INDEX0]]
; CHECK-NEXT:    [[VEC_V_ELEM0:%.*]] = load i32, ptr [[VEC_V_CAST_GEP0]], align 4
; CHECK-NEXT:    store i32 [[VEC_V_ELEM0]], ptr [[V_ADDR0]], align 4
; CHECK-NEXT:    store i32 0, ptr [[I0]], align 4
; CHECK-NEXT:    br label [[FOR_COND0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  for.cond:
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[I0]], align 4
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[N_ADDR0]], align 4
; CHECK-NEXT:    [[CMP0:%.*]] = icmp slt i32 [[TMP0]], [[TMP1]]
; CHECK-NEXT:    br i1 [[CMP0]], label [[FOR_BODY0:%.*]], label [[FOR_END0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  for.body:
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[V_ADDR0]], align 4
; CHECK-NEXT:    [[SHR0:%.*]] = lshr i32 [[TMP2]], 8
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[V_ADDR0]], align 4
; CHECK-NEXT:    [[SHL0:%.*]] = shl i32 [[TMP3]], 24
; CHECK-NEXT:    [[OR0:%.*]] = or i32 [[SHR0]], [[SHL0]]
; CHECK-NEXT:    store i32 [[OR0]], ptr [[V_ADDR0]], align 4
; CHECK-NEXT:    br label [[FOR_INC0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  for.inc:
; CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[I0]], align 4
; CHECK-NEXT:    [[INC0:%.*]] = add nsw i32 [[TMP4]], 1
; CHECK-NEXT:    store i32 [[INC0]], ptr [[I0]], align 4
; CHECK-NEXT:    br label [[FOR_COND0]]
; CHECK-EMPTY:
; CHECK-NEXT:  for.end:
; CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[V_ADDR0]], align 4
; CHECK-NEXT:    [[RET_CAST_GEP0:%.*]] = getelementptr i32, ptr [[VEC_RETVAL0]], i32 [[INDEX0]]
; CHECK-NEXT:    store i32 [[TMP5]], ptr [[RET_CAST_GEP0]], align 4

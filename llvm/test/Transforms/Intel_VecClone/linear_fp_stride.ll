...
; CHECK-NEXT:    [[LOAD_B0:%.*]] = load i32, ptr [[ALLOCA_B0:%.*]], align 4
...
; CHECK-NEXT:    [[VEC_D_CAST_GEP0:%.*]] = getelementptr float, ptr [[VEC_D_CAST0:%.*]], i32 [[INDEX0]]
; CHECK-NEXT:    [[VEC_D_ELEM0:%.*]] = load float, ptr [[VEC_D_CAST_GEP0]], align 4

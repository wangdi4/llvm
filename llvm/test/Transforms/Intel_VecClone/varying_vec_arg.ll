...
; CHECK-NEXT:    store <2 x i32> [[M0]], ptr [[ALLOCA_M0]], align 8
; CHECK-NEXT:    [[VEC_L0:%.*]] = alloca <8 x i32>, align 32
; CHECK-NEXT:    store <8 x i32> [[L0]], ptr [[VEC_L0]], align 32
; CHECK-NEXT:    br label [[SIMD_BEGIN_REGION0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  simd.begin.region:
; CHECK-NEXT:    [[ENTRY_REGION0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 4), "QUAL.OMP.UNIFORM:TYPED"(ptr [[ALLOCA_M0]], <2 x  i32> zeroinitializer, i32 1) ]
; CHECK-NEXT:    br label [[SIMD_LOOP_PREHEADER0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  simd.loop.preheader:
; CHECK-NEXT:    [[LOAD_M0:%.*]] = load <2 x i32>, ptr [[ALLOCA_M0]], align 8
...
; CHECK-NEXT:    [[VEC_L_CAST_GEP0:%.*]] = getelementptr <2 x i32>, ptr [[VEC_L0]], i32 [[INDEX0]]
; CHECK-NEXT:    [[VEC_L_ELEM0:%.*]] = load <2 x i32>, ptr [[VEC_L_CAST_GEP0]], align 8

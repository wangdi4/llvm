...
;
; CHECK:  define dso_local noundef <8 x i64> @_ZGVbN8L2__Z3fooRl(<8 x i64*> nocapture noundef nonnull readonly align 8 dereferenceable(8) [[X0:%.*]]) local_unnamed_addr #1 {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[ENTRY_REGION0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 8), "QUAL.OMP.LINEAR:TYPED"(i64** [[ALLOCA_X_SCALAR0]], i64* null, i32 1, i32 2) ]
...
; CHECK-NEXT:    [[TMP0:%.*]] = load i64, i64* [[LOAD_ALLOCA_X_SCALAR0]], align 8

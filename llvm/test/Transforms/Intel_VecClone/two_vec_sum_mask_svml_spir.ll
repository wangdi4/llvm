...
; CHECK-NEXT:    store float [[I0]], ptr [[I_ADDR0]], align 4
; CHECK-NEXT:    store float [[J0]], ptr [[J_ADDR0]], align 4
; CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr [[I_ADDR0]], align 4
; CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[J_ADDR0]], align 4
...
; CHECK-NEXT:    [[I_ADDR0]] = alloca float, align 4
; CHECK-NEXT:    [[J_ADDR0]] = alloca float, align 4
; CHECK-NEXT:    store <4 x float> [[I0]], ptr [[VEC_I0]], align 16
; CHECK-NEXT:    store <4 x float> [[J0]], ptr [[VEC_J0]], align 16
; CHECK-NEXT:    store <4 x i32> [[MASK0]], ptr [[VEC_MASK0]], align 16
; CHECK-NEXT:    br label [[SIMD_BEGIN_REGION0:%.*]]
; CHECK-EMPTY:
; CHECK-NEXT:  simd.begin.region:
; CHECK-NEXT:    [[ENTRY_REGION0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 4), "QUAL.OMP.PRIVATE:TYPED"(ptr [[I_ADDR0]], float 0.000000e+00, i32 1), "QUAL.OMP.PRIVATE:TYPED"(ptr [[J_ADDR0]], float 0.000000e+00, i32 1) ]
...
; CHECK-NEXT:    [[VEC_I_CAST_GEP0:%.*]] = getelementptr float, ptr [[VEC_I0]], i32 [[INDEX0]]
; CHECK-NEXT:    [[VEC_I_ELEM0:%.*]] = load float, ptr [[VEC_I_CAST_GEP0]], align 4
; CHECK-NEXT:    store float [[VEC_I_ELEM0]], ptr [[I_ADDR0]], align 4
; CHECK-NEXT:    [[VEC_J_CAST_GEP0:%.*]] = getelementptr float, ptr [[VEC_J0]], i32 [[INDEX0]]
; CHECK-NEXT:    [[VEC_J_ELEM0:%.*]] = load float, ptr [[VEC_J_CAST_GEP0]], align 4
; CHECK-NEXT:    store float [[VEC_J_ELEM0]], ptr [[J_ADDR0]], align 4
; CHECK-NEXT:    [[TMP0]] = load float, ptr [[I_ADDR0]], align 4
; CHECK-NEXT:    [[TMP1]] = load float, ptr [[J_ADDR0]], align 4
; CHECK-NEXT:    [[ADD0]] = fadd float [[TMP0]], [[TMP1]]
; CHECK-NEXT:    [[RET_CAST_GEP0:%.*]] = getelementptr float, ptr [[VEC_RETVAL0]], i32 [[INDEX0]]
; CHECK-NEXT:    store float [[ADD0]], ptr [[RET_CAST_GEP0]], align 4
...
; CHECK-EMPTY:
; CHECK-NEXT:  return:
; CHECK-NEXT:    [[VEC_RET0:%.*]] = load <4 x float>, ptr [[VEC_RETVAL0]], align 16

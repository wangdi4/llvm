...
; RUN: opt -opaque-pointers=0 -passes=vec-clone -S < %s -mtriple=x86_64-unknown-linux-gnu | FileCheck %s
...
; CHECK-EMPTY:
; CHECK-NEXT:  return:
; CHECK-NEXT:    [[VEC_RET0:%.*]] = load <16 x i32>, <16 x i32>* [[VEC_RETVAL0]], align 64

...
; CHECK:  define dso_local noundef <8 x i64> @_ZGVbN8U2__Z3fooRl(i64* noundef nonnull align 8 dereferenceable(8) [[X0:%.*]]) #1 {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[ENTRY_REGION0:%.*]] = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 8), "QUAL.OMP.LINEAR:TYPED"(i64** [[ALLOCA_X0]], i64* null, i32 1, i32 2), "QUAL.OMP.PRIVATE:TYPED"(i64** [[X_ADDR0]], i64* null, i32 1) ]

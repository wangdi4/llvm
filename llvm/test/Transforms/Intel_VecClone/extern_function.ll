...
omp.inner.for.body.lr.ph:
  %0 = call token @llvm.directive.region.entry() [ "DIR.OMP.SIMD"(), "QUAL.OMP.SIMDLEN"(i32 4), "QUAL.OMP.NORMALIZED.IV"(ptr null), "QUAL.OMP.NORMALIZED.UB"(ptr null) ]
...
omp.inner.for.body:                               ; preds = %omp.inner.for.body, %omp.inner.for.body.lr.ph
  ...
  %arrayidx = getelementptr inbounds [4096 x float], ptr @a, i64 0, i64 %indvars.iv, !intel-tbaa !2
  store float %conv2, ptr %arrayidx, align 4, !tbaa !2
  %call = tail call fast float @dowork(ptr @a, i32 %1) #1
  store float %call, ptr %arrayidx, align 4, !tbaa !2
...
DIR.OMP.END.SIMD.2:                               ; preds = %omp.inner.for.body
  ...
  %2 = load float, ptr getelementptr inbounds ([4096 x float], ptr @a, i64 0, i64 1024), align 16, !tbaa !2
  %conv6 = fpext float %2 to double
  %call7 = tail call i32 (ptr, ...) @printf(ptr @.str, double %conv6)
  ret i32 0
}
...
declare dso_local float @dowork(ptr, i32) local_unnamed_addr #2

...
; CHECK-NEXT: store i32 %k, ptr %alloca.k
; CHECK-NEXT: %alloca.a = alloca ptr
; CHECK-NEXT: store ptr %a, ptr %alloca.a
...
; CHECK:         [[LOAD_K0:%.*]] = load i32, ptr [[ALLOCA_K0:%.*]], align 4
; CHECK-NEXT:    [[LOAD_A0:%.*]] = load ptr, ptr [[ALLOCA_A0:%.*]], align 8
...
; CHECK-NEXT:    [[RET_CAST_GEP0:%.*]] = getelementptr i32, ptr [[RET_CAST0:%.*]], i32 [[INDEX0]]
; CHECK-NEXT:    store i32 undef, ptr [[RET_CAST_GEP0:%.*]], align 4
...
; CHECK-NEXT:    [[ARRAYIDX0:%.*]] = getelementptr inbounds i32, ptr [[LOAD_A0]], i64 [[IDXPROM0]]
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[ARRAYIDX0]], align 4, !tbaa !2
; CHECK-NEXT:    [[ADD0:%.*]] = add nsw i32 [[TMP0]], 20
; CHECK-NEXT:    store i32 [[ADD0]], ptr [[ARRAYIDX0]], align 4, !tbaa !2
...
define dso_local i32 @foo(ptr nocapture %a, i32 %k) local_unnamed_addr #0 {
entry:

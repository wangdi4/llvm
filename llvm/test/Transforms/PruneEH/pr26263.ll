; PruneEH is less powerful than loop-simplifycfg in terms of cfg simplification,
...
; RUN: opt -passes='function-attrs,function(loop-simplifycfg)' -S < %s | FileCheck %s  --check-prefix=CHECK --check-prefix=CHECK-NEW

...
; This test makes sure IPPredOpt is not triggered because "check" function
; has side-effect (i.e count++).

; RUN: opt < %s -disable-output -debug-only=ippredopt -whole-program-assume -enable-intel-advanced-opts=1 -mtriple=i686-- -mattr=+avx2 -passes=ippredopt 2>&1 | FileCheck %s
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
...
56:                                               ; preds = %46
  %57 = load i32, ptr @count, align 4, !tbaa !25
  %58 = add nsw i32 %57, 1
  store i32 %58, ptr @count, align 4, !tbaa !25
  br label %59

59:                                               ; preds = %56, %49, %39, %29, %19, %9, %2
  %60 = phi i1 [ false, %56 ], [ false, %2 ], [ true, %49 ], [ true, %39 ], [ true, %29 ], [ true, %19 ], [ true, %9 ]
  ret i1 %60
}
...
35:                                               ; preds = %32
  %36 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.4)
  br label %42
...
42:                                               ; preds = %40, %37, %35, %29, %27
  %43 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.5)
  %44 = load i32, ptr @count, align 4, !tbaa !25
...
declare !intel.dtrans.func.type !27 dso_local noalias noundef "intel_dtrans_func_index"="1" ptr @malloc(i64 noundef) local_unnamed_addr #4

; Function Attrs: nofree nounwind
declare noundef i32 @puts(ptr nocapture noundef readonly) local_unnamed_addr #0

; Function Attrs: nofree nounwind
declare !intel.dtrans.func.type !28 dso_local noundef i32 @printf(ptr nocapture noundef readonly "intel_dtrans_func_index"="1", ...) local_unnamed_addr #3

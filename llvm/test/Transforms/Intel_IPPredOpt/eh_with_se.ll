...
; This test makes sure IPPredOpt is not triggered due to EH code in
; "getElement" function.
...
; CHECK:       Checking direct call for no side effects:  %66 = tail call fastcc noundef i32 @_Z11getElement3P1Sj(ptr noundef nonnull %0, i32 noundef %65)
; CHECK:      Failed
...
8:                                                ; preds = %2
  %9 = zext i32 %1 to i64
  %10 = getelementptr inbounds %struct._ZTS1S.S, ptr %0, i64 %9, i32 2
...
60:                                               ; preds = %64
  ...
  br i1 %63, label %68, label %64, !llvm.loop !27

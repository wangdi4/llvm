...
; This test makes sure IPPredOpt is triggered when all possible targets
; of a virtual call have no-side-effects.
...
; CHECK:  %41 = icmp ne i32 %40, 0
; CHECK:  %42 = getelementptr inbounds %struct._ZTS2S1.S1, ptr %18, i64 0, i32 1
; CHECK:  %43 = load i32, ptr %42
; CHECK:  %44 = icmp eq i32 %43, 0
; CHECK:  %45 = select i1 %41, i1 %44, i1 false
; CHECK:  %46 = getelementptr inbounds %struct._ZTS2S1.S1, ptr %18, i64 0, i32 2, !intel-tbaa !39
; CHECK:  %47 = load i32, ptr %46
; CHECK:  %48 = icmp ne i32 %47, 0
; CHECK:  %49 = select i1 %45, i1 %48, i1 false
; CHECK:  %50 = getelementptr inbounds %struct._ZTS2S1.S1, ptr %18, i64 0, i32 0
; CHECK:  %51 = load i32, ptr %50
; CHECK:  %52 = icmp ne i32 %51, 0
; CHECK:  %53 = getelementptr inbounds %struct._ZTS2S1.S1, ptr %18, i64 0, i32 1
; CHECK:  %54 = load i32, ptr %53
; CHECK:  %55 = icmp ne i32 %54, 0
; CHECK:  %56 = select i1 %52, i1 %55, i1 false
; CHECK:  %57 = select i1 %49, i1 true, i1 %56
; CHECK:  br i1 %57, label %58, label %76

; CHECK:58:                                               ; preds = %38
; CHECK:  %59 = call fastcc noundef zeroext i1 @_Z5checkP2S1S0_PP2S2(ptr noundef nonnull %18, ptr noundef nonnull %19, ptr noundef nonnull %37)
; CHECK:  br i1 %59, label %60, label %76
...
define dso_local noundef i32 @main() local_unnamed_addr #3 {
  ...
  call void @llvm.lifetime.start.p0(i64 8000, ptr nonnull %1) #12
  br label %2
...
17:                                               ; preds = %14
  %18 = tail call noalias dereferenceable_or_null(12000) ptr @malloc(i64 noundef 12000) #14
  %19 = tail call noalias dereferenceable_or_null(12000) ptr @malloc(i64 noundef 12000) #14
  br label %20

20:                                               ; preds = %20, %17
  %21 = phi i64 [ 0, %17 ], [ %34, %20 ]
  %22 = tail call i32 @rand() #12
...
55:                                               ; preds = %53, %49, %47, %39, %36
  %56 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.4)
  call void @llvm.lifetime.end.p0(i64 8000, ptr nonnull %1) #12
  ret i32 0
}
...
declare !intel.dtrans.func.type !64 dso_local noundef nonnull "intel_dtrans_func_index"="1" ptr @_Znwm(i64 noundef) local_unnamed_addr #6

; Function Attrs: mustprogress nofree nounwind willreturn allockind("alloc,uninitialized") allocsize(0) memory(inaccessiblemem: readwrite)
declare !intel.dtrans.func.type !65 dso_local noalias noundef "intel_dtrans_func_index"="1" ptr @malloc(i64 noundef) local_unnamed_addr #7
...
define internal noundef zeroext i1 @_ZN2T54testEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) "intel_dtrans_func_index"="1" %0) unnamed_addr #8 comdat align 2 !intel.dtrans.func.type !66 {
  %2 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 2, !intel-tbaa !68
  %3 = load i32, ptr %2, align 4, !tbaa !68
  %4 = add nsw i32 %3, -30
  %5 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 1, !intel-tbaa !70
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define internal noundef zeroext i1 @_ZN2T44testEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) "intel_dtrans_func_index"="1" %0) unnamed_addr #8 comdat align 2 !intel.dtrans.func.type !71 {
  %2 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 2, !intel-tbaa !68
  %3 = load i32, ptr %2, align 4, !tbaa !68
  %4 = add nsw i32 %3, -20
  %5 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 1, !intel-tbaa !70
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define internal noundef zeroext i1 @_ZN2T34testEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) "intel_dtrans_func_index"="1" %0) unnamed_addr #8 comdat align 2 !intel.dtrans.func.type !73 {
  %2 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 1, !intel-tbaa !70
  %3 = load i32, ptr %2, align 8, !tbaa !70
  %4 = add nsw i32 %3, 2
  %5 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 2, !intel-tbaa !68
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define internal noundef zeroext i1 @_ZN2T24testEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) "intel_dtrans_func_index"="1" %0) unnamed_addr #8 comdat align 2 !intel.dtrans.func.type !75 {
  %2 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 2, !intel-tbaa !68
  %3 = load i32, ptr %2, align 4, !tbaa !68
  %4 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 1, !intel-tbaa !70
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define internal noundef zeroext i1 @_ZN2T14testEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) "intel_dtrans_func_index"="1" %0) unnamed_addr #8 comdat align 2 !intel.dtrans.func.type !77 {
  %2 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 1, !intel-tbaa !70
  %3 = load i32, ptr %2, align 8, !tbaa !70
  %4 = getelementptr inbounds %class._ZTS2S2.S2, ptr %0, i64 0, i32 2, !intel-tbaa !68
...
define hidden void @__typeid__ZTS2S2_0_branch_funnel(ptr nest %0, ...) local_unnamed_addr #10 {
...
declare void @llvm.icall.branch.funnel(...) #11
...
attributes #10 = { mustprogress nofree norecurse nosync nounwind willreturn }
...
!65 = distinct !{!1}
!66 = distinct !{!67}
!67 = !{%class._ZTS2T5.T5 zeroinitializer, i32 1}
!68 = !{!69, !40, i64 12}
!69 = !{!"struct@_ZTS2S2", !40, i64 8, !40, i64 12}
!70 = !{!69, !40, i64 8}
!71 = distinct !{!72}
!72 = !{%class._ZTS2T4.T4 zeroinitializer, i32 1}
!73 = distinct !{!74}
!74 = !{%class._ZTS2T3.T3 zeroinitializer, i32 1}
!75 = distinct !{!76}
!76 = !{%class._ZTS2T2.T2 zeroinitializer, i32 1}
!77 = distinct !{!78}
!78 = !{%class._ZTS2T1.T1 zeroinitializer, i32 1}

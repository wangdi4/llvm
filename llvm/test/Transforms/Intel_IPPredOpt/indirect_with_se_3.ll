...
; This test is same as indirect_with_se_1.ll except T1::test and T3::test
; also have side-effects similar to T5::test.
; This test makes sure IPPredOpt is not triggered when number of possible
; targets with SE (T1::test, T3::test and T5::test) is more than or equal to
; number of possible targets with NSE (T2::test and T4::test).
...
; CHECK: No targets selected by heuristics      Failed
...
define internal noundef zeroext i1 @_ZN2T34testEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) "intel_dtrans_func_index"="1" %0) unnamed_addr #9 comdat align 2 !intel.dtrans.func.type !75 {
  ...
  %i.2 = load i32, ptr @count, align 4, !tbaa !64
  %i.3 = add nsw i32 %i.2, 1
  store i32 %i.3, ptr @count, align 4, !tbaa !64

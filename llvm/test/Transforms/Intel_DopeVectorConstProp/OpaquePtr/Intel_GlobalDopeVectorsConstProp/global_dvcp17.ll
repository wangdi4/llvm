...
; CHECK: DV FOUND: ARG #0 myoutput_.1 2 x <UNKNOWN ELEMENT TYPE>
; CHECK: VALID
; CHECK: REPLACING 4 LOADS WITH 96
; CHECK: REPLACING 4 LOADS WITH 1
; CHECK: REPLACING 1 LOAD WITH 10
; CHECK: NOT REPLACING LOAD IN FXN myoutput_.1   %i14 = load i64, ptr %i13, align 1
; CHECK: REPLACING 2 LOADS WITH 4
; CHECK: REPLACING 2 LOADS WITH 1
; CHECK: REPLACING 1 LOAD WITH 10
; CHECK: NOT REPLACING LOAD IN FXN myoutput_.1   %i16 = load i64, ptr %i15, align 1
; CHECK: REPLACING 2 LOADS WITH 40
; CHECK: REPLACING 2 LOADS WITH 1

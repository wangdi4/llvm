...
; and the nested dope vectors wasn't collected neither propagated since
; the nested dope vectors are passed to a function without IR. This is
; the same test as glob_dvcp08.ll but it checks the IR. It was
; generated from the following example but function PRINT_INFO is created
; as declare:
...
; Check that the constant weren't propagated in @arr_mod_mp_initialize_arr_
...
; Function Attrs: nofree nounwind uwtable
declare dso_local void @arr_mod_mp_print_info_(ptr noalias nocapture readonly, ptr noalias nocapture readonly dereferenceable(4), ptr noalias nocapture readonly dereferenceable(4), ptr noalias nocapture readonly dereferenceable(4), ptr noalias nocapture readonly dereferenceable(96) "assumed_shape" "ptrnoalias", ptr noalias nocapture readonly dereferenceable(120) "assumed_shape" "ptrnoalias", ptr noalias nocapture readonly dereferenceable(72) "assumed_shape" "ptrnoalias") #0

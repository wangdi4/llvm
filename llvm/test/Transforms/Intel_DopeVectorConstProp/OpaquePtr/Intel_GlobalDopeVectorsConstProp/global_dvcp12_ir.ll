...
bb:
  %i = tail call i32 @for_allocate_handle(i64 400, ptr @arr_mod_mp_a_, i32 262144, ptr null)
  ret i32 %i
}
...
bb:
  ...
  %i6 = icmp eq i32 %temp, 1
  br i1 %i6, label %if.then, label %if.end

if.then:                                          ; preds = %bb
  %i7 = tail call i32 @arr_alloc_dv()
  br label %if.end

if.end:                                           ; preds = %if.then, %bb
  ret void
}
...
bb:
  ...
  tail call void @arr_mod_mp_allocate_arr_(i32 %i)

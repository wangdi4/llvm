...
; This test case checks that the constant propagation didn't pass because the
; alloc site (for_allocate_handle/for_alloc_allocatable_handle) wasn't found.
; It is the same test case as global_dvcp18.ll, but checks the IR:
...
; Check that constants weren't propagated in function @arr_mod_mp_initialize_arr_
...
; Check that constants weren't propagated in function @@arr_mod_mp_print_arr_

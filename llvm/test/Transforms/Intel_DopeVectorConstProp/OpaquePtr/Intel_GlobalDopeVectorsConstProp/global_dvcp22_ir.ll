...
; RUN: opt -opaque-pointers < %s -dopevectorconstprop -dope-vector-global-const-prop=true -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -dvcp-tile-mv-min-calls=3 -S 2>&1 | FileCheck %s
...
; CHECK:   %i16 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %i15, i64 %i14, ptr elementtype(float) %i11, i64 %i6)
; CHECK:   %i17 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %i13, i64 %i12, ptr elementtype(float) %i16, i64 %i10)

; CHECK: define internal void @arr_mod_mp_print_arr_
; CHECK:  %i24 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %i23, i64 %i22, ptr elementtype(float) %i19, i64 %i16)
; CHECK:  %i25 = call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %i21, i64 %i20, ptr elementtype(float) %i24, i64 %i18)

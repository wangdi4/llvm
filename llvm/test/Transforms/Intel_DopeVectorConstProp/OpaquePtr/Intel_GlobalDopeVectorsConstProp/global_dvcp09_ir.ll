...
; pointer to the dope vector. This test case is the same as glob_dvcp09.ll
; but it checks the IR. This test case was generated from the following
; example but the attributes of function PRINT_INFO were modified to remove
; "readonly", "ptrnoalias" and "noalias":

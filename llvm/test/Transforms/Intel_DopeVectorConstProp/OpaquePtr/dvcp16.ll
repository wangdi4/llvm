; RUN: opt < %s -opaque-pointers -dope-vector-local-const-prop=false -S -dopevectorconstprop 2>&1 | FileCheck %s
; RUN: opt < %s -opaque-pointers -dope-vector-local-const-prop=false -S -passes=dopevectorconstprop 2>&1 | FileCheck %s
...
; CHECK: %44 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 %20, ptr elementtype(i32) %10, i64 %43)
  br label %36
...
; NOTE: DO NOT replace %20 with 324
; CHECK: %70 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 %20, ptr elementtype(i32) %10, i64 %67)

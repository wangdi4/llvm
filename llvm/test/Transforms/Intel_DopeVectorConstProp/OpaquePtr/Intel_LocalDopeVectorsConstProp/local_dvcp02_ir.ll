...
; was added. This is the same test case as local_dvcp02.ll, but it checks
; the IR.
...
; CHECK: %"assumedshape_arrs_$ARRAY_SOURCE.addr_a0$_fetch.31[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 %"assumedshape_arrs_$ARRAY_SOURCE.dim_info$.lower_bound$[]_fetch.38", i64 %"assumedshape_arrs_$ARRAY_SOURCE.dim_info$.spacing$[]_fetch.37", ptr elementtype(float) %"assumedshape_arrs_$ARRAY_SOURCE.addr_a0$_fetch.31", i64 %indvars.iv518)
; CHECK: %"assumedshape_arrs_$ARRAY_ADD.addr_a0$_fetch.46[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 %"assumedshape_arrs_$ARRAY_ADD.dim_info$.lower_bound$[]_fetch.53", i64 %"assumedshape_arrs_$ARRAY_ADD.dim_info$.spacing$[]_fetch.52", ptr elementtype(float) %"assumedshape_arrs_$ARRAY_ADD.addr_a0$_fetch.46", i64 %indvars.iv518)
; CHECK: %"assumedshape_arrs_$ARRAY_TARGET.addr_a0$_fetch.61[]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 %"assumedshape_arrs_$ARRAY_TARGET.dim_info$.lower_bound$[]_fetch.68", i64 %"assumedshape_arrs_$ARRAY_TARGET.dim_info$.spacing$[]_fetch.67", ptr elementtype(float) %"assumedshape_arrs_$ARRAY_TARGET.addr_a0$_fetch.61", i64 %indvars.iv518)

; CHECK: %"assumedshape_arrs_$ARRAY_SOURCE.addr_a0$_fetch.31[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %"assumedshape_arrs_$ARRAY_SOURCE.dim_info$.lower_bound$[]_fetch.35", i64 %"assumedshape_arrs_$ARRAY_SOURCE.dim_info$.spacing$[]_fetch.34", ptr elementtype(float) %"assumedshape_arrs_$ARRAY_SOURCE.addr_a0$_fetch.31[]", i64 %indvars.iv515)
; CHECK: %"assumedshape_arrs_$ARRAY_ADD.addr_a0$_fetch.46[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %"assumedshape_arrs_$ARRAY_ADD.dim_info$.lower_bound$[]_fetch.50", i64 %"assumedshape_arrs_$ARRAY_ADD.dim_info$.spacing$[]_fetch.49", ptr elementtype(float) %"assumedshape_arrs_$ARRAY_ADD.addr_a0$_fetch.46[]", i64 %indvars.iv515)
; CHECK: %"assumedshape_arrs_$ARRAY_TARGET.addr_a0$_fetch.61[][]" = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %"assumedshape_arrs_$ARRAY_TARGET.dim_info$.lower_bound$[]_fetch.65", i64 %"assumedshape_arrs_$ARRAY_TARGET.dim_info$.spacing$[]_fetch.64", ptr elementtype(float) %"assumedshape_arrs_$ARRAY_TARGET.addr_a0$_fetch.61[]", i64 %indvars.iv515)

...
; The reason is that the pointers to the dope vectors are written by other
; pointers. It was created from the following example, but a store instruction
; was added to copy the dope vectors.
...
define void @assumedshape_arrs_(%"QNCA_a0$float*$rank3$"** %ptr, %"QNCA_a0$float*$rank3$"** %ptr2, %"QNCA_a0$float*$rank3$"** %ptr3) local_unnamed_addr #0 {
alloca_0:
  ...
  %func_result = call i32 @for_alloc_allocatable_handle(i64 327680, i8** nonnull %"(i8**)assumedshape_arrs_$ARRAY_SOURCE.addr_a0$$", i32 393218, i8* null) #6
  ...
  %func_result60 = call i32 @for_alloc_allocatable_handle(i64 327680, i8** nonnull %"(i8**)assumedshape_arrs_$ARRAY_TARGET.addr_a0$$", i32 393218, i8* null) #6
  ...
  %func_result128 = call i32 @for_alloc_allocatable_handle(i64 327680, i8** nonnull %"(i8**)assumedshape_arrs_$ARRAY_ADD.addr_a0$$", i32 393218, i8* null) #6
...
bb4:                                              ; preds = %bb8
  store %"QNCA_a0$float*$rank3$"* %"assumedshape_arrs_$ARRAY_ADD", %"QNCA_a0$float*$rank3$"** %ptr
  store %"QNCA_a0$float*$rank3$"* %"assumedshape_arrs_$ARRAY_TARGET", %"QNCA_a0$float*$rank3$"** %ptr2
  store %"QNCA_a0$float*$rank3$"* %"assumedshape_arrs_$ARRAY_SOURCE", %"QNCA_a0$float*$rank3$"** %ptr3

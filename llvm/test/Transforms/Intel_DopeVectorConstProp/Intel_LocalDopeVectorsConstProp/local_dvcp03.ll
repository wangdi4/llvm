...
define void @assumedshape_arrs_(ptr %ptr, ptr %ptr2, ptr %ptr3) local_unnamed_addr #0 {
alloca_0:
...
bb4:                                              ; preds = %bb8
  store ptr %"assumedshape_arrs_$ARRAY_ADD", ptr %ptr, align 8
  store ptr %"assumedshape_arrs_$ARRAY_TARGET", ptr %ptr2, align 8
  store ptr %"assumedshape_arrs_$ARRAY_SOURCE", ptr %ptr3, align 8

...
bb4:                                              ; preds = %bb8
  tail call void (...) @extern_func_(%"QNCA_a0$float*$rank3$"* %"assumedshape_arrs_$ARRAY_ADD", %"QNCA_a0$float*$rank3$"* %"assumedshape_arrs_$ARRAY_TARGET", %"QNCA_a0$float*$rank3$"* %"assumedshape_arrs_$ARRAY_SOURCE")

...
; for assumed shape arrays that are using inside local functions. It
...
; CHECK:     ANALYSIS RESULT: VALID
; CHECK: REPLACING 1 LOAD WITH 1
; CHECK: REPLACING 1 LOAD WITH 40
; CHECK: REPLACING 1 LOAD WITH 1
; CHECK: REPLACING 1 LOAD WITH 2560
; CHECK: REPLACING 1 LOAD WITH 1

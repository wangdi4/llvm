...
; CHECK:  %i4 = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) getelementptr inbounds (%"QNCA_a0$float*$rank2$", ptr @arr_mod_mp_a_, i64 0, i32 6, i64 0, i32 1), i32 0)
; CHECK:  %i5 = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) getelementptr inbounds (%"QNCA_a0$float*$rank2$", ptr @arr_mod_mp_a_, i64 0, i32 6, i64 0, i32 2), i32 0)
; CHECK:  %i6 = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) getelementptr inbounds (%"QNCA_a0$float*$rank2$", ptr @arr_mod_mp_a_, i64 0, i32 6, i64 0, i32 1), i32 1)
; CHECK:  %i7 = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr elementtype(i64) getelementptr inbounds (%"QNCA_a0$float*$rank2$", ptr @arr_mod_mp_a_, i64 0, i32 6, i64 0, i32 2), i32 1)

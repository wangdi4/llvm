...
!5 = !{%"QNCA_a0$float*$rank3$" zeroinitializer, float 0.000000e+00}
!6 = !{%"QNCA_a0$%\22ARR_MOD$.btT_TESTTYPE\22*$rank1$" zeroinitializer, %"ARR_MOD$.btT_TESTTYPE" zeroinitializer}

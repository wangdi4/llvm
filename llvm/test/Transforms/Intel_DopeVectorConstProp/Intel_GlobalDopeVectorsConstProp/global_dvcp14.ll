...
!9 = !{%"QNCA_a0$float*$rank1$" zeroinitializer, float 0.000000e+00}
!10 = !{%"QNCA_a0$float*$rank2$" zeroinitializer, float 0.000000e+00}
!11 = !{%"QNCA_a0$float*$rank3$" zeroinitializer, float 0.000000e+00}
!12 = !{%"QNCA_a0$%\22ARR_MOD$.btT_TESTTYPE\22*$rank1$" zeroinitializer, %"ARR_MOD$.btT_TESTTYPE" zeroinitializer}

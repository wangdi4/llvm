...
; Function Attrs: nofree nounwind uwtable
declare dso_local void @arr_mod_mp_print_info_(i32* noalias nocapture readonly, i32* noalias nocapture readonly dereferenceable(4), i32* noalias nocapture readonly dereferenceable(4), i32* noalias nocapture readonly dereferenceable(4), %"QNCA_a0$float*$rank2$"* noalias nocapture readonly dereferenceable(96) "assumed_shape" "ptrnoalias", %"QNCA_a0$float*$rank3$"* noalias nocapture readonly dereferenceable(120) "assumed_shape" "ptrnoalias", %"QNCA_a0$float*$rank1$"* noalias nocapture readonly dereferenceable(72) "assumed_shape" "ptrnoalias") #0

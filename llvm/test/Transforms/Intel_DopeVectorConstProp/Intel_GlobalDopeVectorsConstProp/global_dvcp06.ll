...
; in other functions that aren't related to data allocation.
...
; CHECK-DAG: Global variable: arr_mod_mp_a_
; CHECK:   LLVM Type: QNCA_a0$%"ARR_MOD$.btT_TESTTYPE"*$rank1$
; CHECK-NEXT:   Dope vector information: Invalid

; CHECK-DAG: Global variable: arr_mod_mp_b_
; CHECK:   LLVM Type: QNCA_a0$%"ARR_MOD$.btT_TESTTYPE"*$rank1$
; CHECK-NEXT:   Dope vector information: Invalid

...
define dso_local void @MAIN__() #1 {
  ...
  %8 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %6, i64 0, i32 0
  %9 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %6, i64 0, i32 2
  %10 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %6, i64 0, i32 4
  %11 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %6, i64 0, i32 6, i64 0, i32 1
  %12 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %5, i64 0, i32 0
  %13 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %5, i64 0, i32 2
  %14 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %5, i64 0, i32 4
  %15 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %5, i64 0, i32 6, i64 0, i32 1
...
30:                                               ; preds = %27
  %31 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %6, i64 0, i32 1
  %32 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %6, i64 0, i32 3
  %33 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %6, i64 0, i32 6, i64 0, i32 0
  %34 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %6, i64 0, i32 6, i64 0, i32 2
  %35 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %5, i64 0, i32 1
  %36 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %5, i64 0, i32 3
  %37 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %5, i64 0, i32 6, i64 0, i32 0
  %38 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %5, i64 0, i32 6, i64 0, i32 2
...
define internal void @new_solver_(ptr noalias nocapture readonly %0, ptr noalias nocapture readonly %1) #1 {
  ...
  %4 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %1, i64 0, i32 6, i64 0, i32 0
  %5 = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %1, i64 0, i32 6, i64 0, i32 1
  %6 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %0, i64 0, i32 0
  %7 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %0, i64 0, i32 6, i64 0, i32 1

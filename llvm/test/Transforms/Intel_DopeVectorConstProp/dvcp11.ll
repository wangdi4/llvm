; RUN: opt -opaque-pointers=0 < %s -dope-vector-local-const-prop=false -S -passes=dopevectorconstprop -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 2>&1 | FileCheck %s
...
20:                                               ; preds = %20, %18
  ...
  %23 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 36, i32* elementtype(i32) getelementptr inbounds ([9 x [9 x i32]], [9 x [9 x i32]]* @"main_$PART", i64 0, i64 0, i64 0), i64 %21)
  %24 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* elementtype(i32) %23, i64 %19)
...
; NOTE: %40 is the dope vector base for lower bound of new_solver actual arg #1
  ...
  %41 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %35, i32 0)
; NOTE: stride 0 of new solver arg #0 is 4
  store i64 4, i64* %41, align 8
  %42 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %12, i32 0)
; NOTE: lower bound 0 of new solver arg #0 is 1
  store i64 1, i64* %42, align 8
  %43 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %11, i32 0)
; NOTE: extent 0 of new solver arg #0 is 9
  store i64 9, i64* %43, align 8
  %44 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %35, i32 1)
; NOTE: stride 1 of new solver arg #0 is 36
  store i64 36, i64* %44, align 8
  %45 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %12, i32 1)
; NOTE: lower bound 1 of new solver arg #0 is 1
  store i64 1, i64* %45, align 8
  %46 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %11, i32 1)
; NOTE: extent 1 of new solver arg #0 is 9
  ...
  %47 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %16, i32 0)
; NOTE: stride 0 of new solver arg #1 is 4
  store i64 4, i64* %47, align 8
  %48 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %40, i32 0)
; NOTE: lower bound 0 of new solver arg #1 is 1
  store i64 1, i64* %48, align 8
  %49 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %39, i32 0)
; NOTE: extent 0 of new solver arg #1 is 9
  store i64 9, i64* %49, align 8
  %50 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %16, i32 1)
; NOTE: stride 1 of new solver arg #1 is 36
  store i64 36, i64* %50, align 8
  %51 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %40, i32 1)
; NOTE: lower bound 1 of new solver arg #1 is 1
  store i64 1, i64* %51, align 8
  %52 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %39, i32 1)
; NOTE: extent 1 of new solver arg #1 is 9
  store i64 9, i64* %52, align 8
  %53 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %16, i32 2)
; NOTE: stride 2 of new solver arg #1 is 324
  store i64 324, i64* %53, align 8
  %54 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %40, i32 2)
; NOTE: lower bound 2 of new solver arg #1 is 1
  store i64 1, i64* %54, align 8
  %55 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %39, i32 2)

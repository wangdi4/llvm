...
bb:
  ...
  %i4 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %arg1, i64 0, i32 0
  %i5 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %arg1, i64 0, i32 6, i64 0
  %i6 = getelementptr inbounds { i64, i64, i64 }, ptr %i5, i64 0, i32 0
  %i7 = getelementptr inbounds { i64, i64, i64 }, ptr %i5, i64 0, i32 1
  %i8 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %arg, i64 0, i32 0
  %i9 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %arg, i64 0, i32 6, i64 0
...
bb:
  ...
  %i4 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %i1, i64 0, i32 0
  %i5 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %i1, i64 0, i32 6, i64 0
  %i6 = getelementptr inbounds { i64, i64, i64 }, ptr %i5, i64 0, i32 0
  %i7 = getelementptr inbounds { i64, i64, i64 }, ptr %i5, i64 0, i32 1
  %i8 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %i3, i64 0, i32 0
  %i9 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %i3, i64 0, i32 6, i64 0
...
bb:
  ...
  %i4 = alloca %"QNCA_a0$i32*$rank2$", align 8
  %i5 = alloca %"QNCA_a0$i32*$rank1$", align 8
  %i6 = alloca [8 x i64], align 16
  %i7 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %i5, i64 0, i32 0
  %i8 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %i5, i64 0, i32 1
  %i9 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %i5, i64 0, i32 2
  %i10 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %i5, i64 0, i32 3
  %i11 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %i5, i64 0, i32 4
  %i12 = getelementptr inbounds %"QNCA_a0$i32*$rank1$", ptr %i5, i64 0, i32 6, i64 0
  ...
  %i16 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %i4, i64 0, i32 0
  %i17 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %i4, i64 0, i32 1
  %i18 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %i4, i64 0, i32 2
  %i19 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %i4, i64 0, i32 3
  %i20 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %i4, i64 0, i32 4
  %i21 = getelementptr inbounds %"QNCA_a0$i32*$rank2$", ptr %i4, i64 0, i32 6, i64 0
...
!1 = !{%"QNCA_a0$i32*$rank2$" zeroinitializer, i32 0}

...
; }
;
; RUN: opt < %s -forced-cmov-generation -S 2>&1 | FileCheck %s
...
entry:
  ...
  %tmpcast = bitcast <4 x i32>* %color_libs to %"class.boost::array.0"*
  %0 = bitcast <4 x i32>* %color_libs to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0) #2
  store <4 x i32> <i32 8, i32 8, i32 8, i32 8>, <4 x i32>* %color_libs, align 16
  %1 = load i32, i32* getelementptr inbounds (%"class.boost::array.0", %"class.boost::array.0"* @m_dirs, i64 0, i32 0, i64 0), align 4
  %add = add nsw i32 %1, %vertex
  %conv5 = sext i32 %add to i64
  %arrayidx.i38 = getelementptr inbounds %"class.boost::array", %"class.boost::array"* @m_parent, i64 0, i32 0, i64 %conv5
  %2 = load i16, i16* %arrayidx.i38, align 2
  %conv7 = zext i16 %2 to i64
  %arrayidx.i37 = getelementptr inbounds %"class.boost::array", %"class.boost::array"* @m_libs, i64 0, i32 0, i64 %conv7
  %3 = load i16, i16* %arrayidx.i37, align 2
  %conv9 = zext i16 %3 to i32
  %arrayidx.i36 = getelementptr inbounds %"class.boost::array.1", %"class.boost::array.1"* @m_square, i64 0, i32 0, i64 %conv5
  %4 = load i32, i32* %arrayidx.i36, align 4
  %conv12 = zext i32 %4 to i64
  %arrayidx.i35 = getelementptr inbounds %"class.boost::array.0", %"class.boost::array.0"* %tmpcast, i64 0, i32 0, i64 %conv12
  %5 = load i32, i32* %arrayidx.i35, align 4
  %cmp14 = icmp sgt i32 %5, %conv9
  br i1 %cmp14, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  store i32 %conv9, i32* %arrayidx.i35, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %conv19 = sext i32 %color to i64
  %arrayidx.i41 = getelementptr inbounds %"class.boost::array.0", %"class.boost::array.0"* %tmpcast, i64 0, i32 0, i64 %conv19
  %6 = load i32, i32* %arrayidx.i41, align 4
  %tobool = icmp eq i32 %color, 0
  %conv21 = zext i1 %tobool to i64
  %arrayidx.i40 = getelementptr inbounds %"class.boost::array.0", %"class.boost::array.0"* %tmpcast, i64 0, i32 0, i64 %conv21
  %7 = load i32, i32* %arrayidx.i40, align 4

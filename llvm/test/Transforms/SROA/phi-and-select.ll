...
; INTEL_CUSTOMIZATION
; CHECK-NOT: alloca
; CHECK: %cond = icmp sle i32 0, 1
; CHECK-NEXT: %0 = bitcast i32 1 to float
; CHECK-NEXT: %1 = bitcast i32 0 to float
; CHECK-NOT: store
; CHECK: %result.sroa.speculated = select i1 %cond, float %0, float %1

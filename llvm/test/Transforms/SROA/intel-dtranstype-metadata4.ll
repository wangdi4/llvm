...
%struct.coder = type { %struct.filter, i64, ptr, ptr, ptr, ptr, ptr }
%struct.allocator = type { ptr, ptr, ptr }
%struct.filter = type { ptr, ptr, i64 }

define void @test() {
  %coder = alloca %struct.coder, align 8
  %gep = getelementptr i8, ptr %coder, i64 8
  call void @llvm.memset.p0.i64(ptr %gep, i8 0, i64 64, i1 false)
  %id = getelementptr inbounds %struct.coder, ptr %coder, i32 0, i32 1
  store i64 0, ptr %id, align 8
  ret void
}

; CHECK: %coder.sroa.{{[0-9]+}} = alloca { ptr, i64 }, align 8, !intel_dtrans_type ![[MD_L1:[0-9]+]]
; CHECK: %coder.sroa.{{[0-9]+}} = alloca { ptr, ptr, ptr, ptr, ptr }, align 8, !intel_dtrans_type ![[MD_L2:[0-9]+]]
...
declare !intel.dtrans.func.type !13 void @llvm.memset.p0.i64(ptr "intel_dtrans_func_index"="1" nocapture writeonly, i8, i64, i1 immarg)

!1 = !{%struct.filter zeroinitializer, i32 0}  ; %struct.filter
!2 = !{i64 0, i32 0}  ; i64
!3 = !{%struct.allocator zeroinitializer, i32 1}  ; ptr
!4 = !{i32 0, i32 1}  ; ptr
!5 = !{%struct.filter zeroinitializer, i32 1}  ; ptr
!6 = !{!"F", i1 false, i32 3, !7, !7, !2, !2}  ; ptr (ptr, i64, i64)
!7 = !{i8 0, i32 1}  ; ptr
!8 = !{!6, i32 1}  ; ptr
!9 = !{!"F", i1 false, i32 2, !10, !7, !7}  ; void (ptr, ptr)
!10 = !{!"void", i32 0}  ; void
!11 = !{!9, i32 1}  ; ptr
!12 = !{i64 0, i32 1}  ; ptr
!13 = distinct !{!7}
!14 = !{!"S", %struct.coder zeroinitializer, i32 7, !1, !2, !3, !3, !4, !4, !5} ; { %struct.filter, i64, ptr, ptr, ptr, ptr, ptr }
!15 = !{!"S", %struct.allocator zeroinitializer, i32 3, !8, !11, !7} ; { ptr, ptr, ptr }
!16 = !{!"S", %struct.filter zeroinitializer, i32 3, !12, !7, !2} ; { ptr, ptr, i64 }

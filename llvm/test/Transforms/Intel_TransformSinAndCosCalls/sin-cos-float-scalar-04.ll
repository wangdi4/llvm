...
; CHECK-NEXT:    [[TMP0:%.*]] = tail call fast float @llvm.sin.f32(float [[CONV1]])
; CHECK-NEXT:    [[TMP1:%.*]] = tail call fast float @llvm.cos.f32(float [[CONV1]])
...
; CHECK-NEXT:    [[TMP3:%.*]] = tail call fast float @cospif(float [[CONV10_OVERPI]])
...
; CHECK-NEXT:    [[TMP7:%.*]] = tail call fast float @llvm.sin.f32(float [[MUL14]])
; CHECK-NEXT:    [[TMP8:%.*]] = tail call fast float @llvm.cos.f32(float [[MUL14]])
...
entry:
  ...
  %3 = tail call fast float @llvm.cos.f32(float %conv10)
  ...
  %7 = tail call fast float @llvm.sin.f32(float %mul14)
  %8 = tail call fast float @llvm.cos.f32(float %mul14)

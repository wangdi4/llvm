...
; CHECK-NEXT:    [[TMP2:%.*]] = load float, float* [[PTRIDX]], align 4, [[TBAA2]], !llvm.access.group !6
; CHECK-NEXT:    [[PTRIDX6:%.*]] = getelementptr inbounds float, float* [[KY:%.*]], i64 [[INDVARS_IV]]
; CHECK-NEXT:    [[TMP3:%.*]] = load float, float* [[PTRIDX6]], align 4, [[TBAA2]], !llvm.access.group !6
...
; CHECK-NEXT:    [[TMP4:%.*]] = call fast float @cospif(float [[MUL8_OVERPI]]) [[ATTR4:#.*]]
; CHECK-NEXT:    [[MUL8_OVERPI1:%.*]] = fmul fast float [[ADD7]], 2.000000e+00
; CHECK-NEXT:    [[TMP5:%.*]] = call fast float @sinpif(float [[MUL8_OVERPI1]]) [[ATTR4]]
...
define dso_local float @_Z11ComputeQCPUiPfS_(i32 %Num, float* nocapture readonly %Kx, float* nocapture readonly %Ky) local_unnamed_addr #0 {
entry:
...
omp.inner.for.body:                               ; preds = %DIR.OMP.SIMD.2, %omp.inner.for.body
  ...
  %2 = load float, float* %ptridx, align 4, !tbaa !2, !llvm.access.group !6
  %ptridx6 = getelementptr inbounds float, float* %Ky, i64 %indvars.iv
  %3 = load float, float* %ptridx6, align 4, !tbaa !2, !llvm.access.group !6

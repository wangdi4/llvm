...
;
; Compilation options:
; icpx -O2 -ffast-math -fimf-precision=high
;
; #include <math.h>
;
...
; CHECK-NEXT:    [[TMP2:%.*]] = tail call fast float @llvm.sin.f32(float [[CONV7]]) [[ATTR0]]
; CHECK-NEXT:    [[CONV10:%.*]] = fmul fast float [[FARG]], 1.025000e+01
; CHECK-NEXT:    [[TMP3:%.*]] = tail call fast float @llvm.cos.f32(float [[CONV10]]) [[ATTR0]]
...
attributes #0 = { "imf-precision"="high" }

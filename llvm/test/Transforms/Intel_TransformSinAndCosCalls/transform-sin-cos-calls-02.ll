...
; Source code compiled with: -O3 -ffast-math -fimf-precision=medium
; #include <math.h>
...
; CHECK-NEXT:    [[ADD11:%.*]] = fadd fast float [[TMP0]], [[TMP1]]
; CHECK-NEXT:    [[ADD14:%.*]] = fadd fast float [[ADD11]], [[TMP2]]
...
entry:
  ...
  %add11 = fadd fast float %0, %1
  %add14 = fadd fast float %add11, %2

...
<<<<<<< HEAD
; RUN: opt -S -opaque-pointers -passes=iroutliner -ir-outlining-no-cost < %s | FileCheck %s ;INTEL
=======
; RUN: opt -S -opaque-pointers -passes=iroutliner -ir-outlining-no-cost < %s | FileCheck %s
>>>>>>> a50158b0c38fccc42f3955166b25f376235f66cd

...
; INTEL_CUSTOMIZATION
; 28224: Test is no longer compatible with the old PM. Old PM force-loads
; MSSA and allows partial invariant motion to run.
; OLDPM: opt -enable-nontrivial-unswitch=true -simple-loop-unswitch -S < %s | FileCheck %s

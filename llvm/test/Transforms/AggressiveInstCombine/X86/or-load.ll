...
; INTEL_CUSTOMIZATION
; ALL-LABEL: @nested_gep(
; ALL-NEXT:    [[GEP1:%.*]] = getelementptr inbounds i8, ptr [[P:%.*]], i64 72
; ALL-NEXT:    [[LD1:%.*]] = load i32, ptr [[GEP1]], align 4
; ALL-NEXT:    [[LD1_ZEXT:%.*]] = zext i32 [[LD1]] to i64
; ALL-NEXT:    [[LD1_SHL:%.*]] = shl nuw i64 [[LD1_ZEXT]], 32
; ALL-NEXT:    [[GEP2:%.*]] = getelementptr inbounds i8, ptr [[P]], i64 64
; ALL-NEXT:    [[FINAL_PTR:%.*]] = getelementptr inbounds i8, ptr [[GEP2]], i64 4
; ALL-NEXT:    [[LD2:%.*]] = load i32, ptr [[FINAL_PTR]], align 4
; ALL-NEXT:    [[LD2_ZEXT:%.*]] = zext i32 [[LD2]] to i64
; ALL-NEXT:    [[OR:%.*]] = or i64 [[LD1_SHL]], [[LD2_ZEXT]]
; ALL-NEXT:    [[ADD:%.*]] = add i64 [[OR]], 0
; ALL-NEXT:    [[TRUNC:%.*]] = trunc i64 [[ADD]] to i32
; ALL-NEXT:    store i32 [[TRUNC]], ptr [[DEST:%.*]], align 4
; ALL-NEXT:    ret void

...
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[RES]], 0 ;INTEL
; CHECK-NEXT:    [[CMP_NOT:%.*]] = xor i1 [[CMP]], true ;INTEL
; CHECK-NEXT:    br i1 [[CMP_NOT]], label [[LATCH]], label [[ZERO_LOOPEXIT_LOOPEXIT4:%.*]] ;INTEL
; CHECK:       latch:
...
; CHECK-NEXT:    [[CMP_POSTLOOP:%.*]] = icmp eq i32 [[RES_POSTLOOP]], 0 ;INTEL
; CHECK-NEXT:    [[CMP_NOT_POSTLOOP:%.*]] = xor i1 [[CMP_POSTLOOP]], true ;INTEL
; CHECK-NEXT:    br i1 [[CMP_NOT_POSTLOOP]], label [[LATCH_POSTLOOP]], label [[ZERO_LOOPEXIT_LOOPEXIT:%.*]] ;INTEL
...
<<<<<<< HEAD
; CHECK-NEXT:    br i1 [[CMP2_POSTLOOP]], label [[LOOPEXIT_LOOPEXIT]], label [[LOOP_POSTLOOP]], !llvm.loop [[LOOP0:![0-9]+]], !irce.loop.clone [[META5:![0-9]+]] ;INTEL
=======
...
>>>>>>> 483e92468e597b73c646182bd755a0d5ef67d327
;
preheader:

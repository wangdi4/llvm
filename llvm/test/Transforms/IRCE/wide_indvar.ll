...
; CHECK-NEXT:    [[TMP3:%.*]] = mul nsw i64 [[TMP1]], [[TMP2]] ;INTEL
...
; CHECK-NEXT:    [[TMP7:%.*]] = mul nsw i64 [[TMP5]], [[TMP6]] ;INTEL
...
; CHECK-NEXT:    [[TMP11:%.*]] = mul nsw i64 [[TMP9]], [[TMP10]] ;INTEL
...
; CHECK-NEXT:    [[TMP15:%.*]] = mul nsw i64 [[TMP13]], [[TMP14]] ;INTEL

...
; CHECK-NEXT:    [[ADDR_NT_STORE_ALLOCA:%.*]] = alloca i8, i64 32856, align 64
...
; CHECK-NEXT:    [[ADDR_3:%.*]] = getelementptr inbounds <8 x i64>, <8 x i64>* [[DEST]], i64 [[INDEX_3]]
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr [4 x <8 x i64>], [4 x <8 x i64>]* [[ADDR_NT_STORE_BUFFER]], i64 [[ADDR_NT_BUF_IDX:%.*]], i64 3
; CHECK-NEXT:    store <8 x i64> [[SPLAT_3]], <8 x i64>* [[TMP5]], align 4
...
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr [4 x <8 x i64>], [4 x <8 x i64>]* [[ADDR_NT_STORE_BUFFER]], i64 [[ADDR_NT_BUF_IDX]], i64 0
; CHECK-NEXT:    store <8 x i64> [[SPLAT]], <8 x i64>* [[TMP6]], align 4
; CHECK-NEXT:    [[ADDR_NT_BUF_IDX2:%.*]] = add nuw nsw i64 [[ADDR_NT_BUF_IDX]], 1
; CHECK-NEXT:    [[TMP7:%.*]] = icmp eq i64 128, [[ADDR_NT_BUF_IDX2]]
; CHECK-NEXT:    br i1 [[TMP7]], label [[ADDR_NT_BUF_DRAIN:%.*]], label [[LOOP_SPLIT_SPLIT:%.*]]
; CHECK:       addr.nt_buf_drain:
; CHECK-NEXT:    call void @__libirc_nontemporal_store(%__nontemporal_buffer_data* [[ADDR_NT_STORE_STRUCT]], i64 32768, i32 0)
...
; CHECK-NEXT:    br i1 [[COND]], label [[EXIT:%.*]], label [[LOOP]], [[LOOP0:!llvm.loop !.*]]
; CHECK:       loop:
...
; CHECK-NEXT:    [[ADDR_2:%.*]] = getelementptr inbounds <8 x i64>, <8 x i64>* [[DEST]], i64 [[INDEX_2]]
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr [4 x <8 x i64>], [4 x <8 x i64>]* [[ADDR_NT_STORE_BUFFER]], i64 [[ADDR_NT_BUF_IDX]], i64 2
; CHECK-NEXT:    store <8 x i64> [[SPLAT_2]], <8 x i64>* [[TMP8]], align 4
; CHECK-NEXT:    [[INDEX_1:%.*]] = add nuw nsw i64 [[INDEX]], 1
; CHECK-NEXT:    [[SPLAT_1:%.*]] = insertelement <8 x i64> zeroinitializer, i64 [[INDEX_1]], i32 0
; CHECK-NEXT:    [[ADDR_1:%.*]] = getelementptr inbounds <8 x i64>, <8 x i64>* [[DEST]], i64 [[INDEX_1]]
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr [4 x <8 x i64>], [4 x <8 x i64>]* [[ADDR_NT_STORE_BUFFER]], i64 [[ADDR_NT_BUF_IDX]], i64 1
; CHECK-NEXT:    store <8 x i64> [[SPLAT_1]], <8 x i64>* [[TMP9]], align 4
...
loop:                                             ; preds = %loop.split, %entry
  ...
  %addr.1 = getelementptr inbounds <8 x i64>, <8 x i64>* %dest, i64 %index.1

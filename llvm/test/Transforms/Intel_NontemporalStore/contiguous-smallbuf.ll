...
; RUN: opt -enable-intel-advanced-opts -S -passes 'unaligned-nontemporal,verify' -unaligned-nontemporal-buffer-elements=16 < %s | FileCheck %s
; RUN: opt -enable-intel-advanced-opts -S -unaligned-nontemporal -verify -unaligned-nontemporal-buffer-elements=16 < %s | FileCheck %s

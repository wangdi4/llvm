; RUN: opt -opaque-pointers=0 -enable-intel-advanced-opts -intel-libirc-allowed -S -passes 'unaligned-nontemporal,verify' -unaligned-nontemporal-buffer-size=1 < %s | FileCheck %s --check-prefixes=ALL,BS1
; RUN: opt -opaque-pointers=0 -enable-intel-advanced-opts -intel-libirc-allowed -S -passes 'unaligned-nontemporal,verify' -unaligned-nontemporal-buffer-size=512 < %s | FileCheck %s --check-prefixes=ALL,BS512
; RUN: opt -opaque-pointers=0 -enable-intel-advanced-opts -intel-libirc-allowed -S -passes 'unaligned-nontemporal,verify' -unaligned-nontemporal-buffer-size=543 < %s | FileCheck %s --check-prefixes=ALL,BS543
; RUN: opt -opaque-pointers=0 -enable-intel-advanced-opts -intel-libirc-allowed -S -passes 'unaligned-nontemporal,verify' -unaligned-nontemporal-buffer-size=544 < %s | FileCheck %s --check-prefixes=ALL,BS544
; RUN: opt -opaque-pointers=0 -enable-intel-advanced-opts -intel-libirc-allowed -S -passes 'unaligned-nontemporal,verify' -unaligned-nontemporal-buffer-size=545 < %s | FileCheck %s --check-prefixes=ALL,BS545

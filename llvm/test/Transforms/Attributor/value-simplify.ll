...
; CHECK-SAME: (%struct.X* noalias nofree sret writeonly [[A:%.*]], %struct.X** nocapture nofree nonnull writeonly dereferenceable(8) [[B:%.*]])
...
; CHECK-NEXT:    call void @test_sret(%struct.X* noalias nofree writeonly null, %struct.X** nocapture nofree writeonly [[B]])
; CHECK-NEXT:    ret void
;

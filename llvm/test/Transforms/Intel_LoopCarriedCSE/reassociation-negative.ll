; Check reassociation does not happen on instruction chains, since fsub operation is not associative.
; %1 = fsub fast float %t44.0, %gepload55
; %2 = fsub fast float %1, %gepload57
...
loop.34:                                          ; preds = %loop.34, %for.body.preheader
  ...
  %5 = fsub fast float %gepload62, %gepload60

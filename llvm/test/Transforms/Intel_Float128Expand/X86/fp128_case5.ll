...
; CHECK-NEXT:    [[TMP5:%.*]] = call i32 @__eqq(fp128* [[TMP0]], fp128* [[TMP2]])
; CHECK-NEXT:    [[TMP6:%.*]] = trunc i32 [[TMP5]] to i1
; CHECK-NEXT:    br label [[BB4:%.*]]
; CHECK:       bb3:
; CHECK-NEXT:    [[TMP7:%.*]] = call i32 @__eqq(fp128* [[TMP2]], fp128* [[TMP2]])
; CHECK-NEXT:    [[TMP8:%.*]] = trunc i32 [[TMP7]] to i1
; CHECK-NEXT:    br label [[BB4]]
; CHECK:       bb4:
; CHECK-NEXT:    [[TMP9:%.*]] = phi i32 [ 1, [[BB3]] ], [ 2, [[BB2]] ]
; CHECK-NEXT:    call void @__itoq(fp128* [[TMP1]], i32 [[TMP9]])
; CHECK-NEXT:    [[TMP10:%.*]] = load fp128, fp128* [[TMP1]], align 16
; CHECK-NEXT:    [[TMP11:%.*]] = call i32 @__eqq(fp128* [[TMP2]], fp128* [[TMP1]])

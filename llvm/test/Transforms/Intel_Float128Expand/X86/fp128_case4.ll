...
; CHECK-NEXT:    call void @__addq(ptr [[TMP1]], ptr [[TMP6]], ptr [[TMP6]])
...
; CHECK-NEXT:    [[TMP9:%.*]] = load fp128, ptr [[TMP4]], align 16
...
; CHECK-NEXT:    call void @__addq(ptr [[TMP0]], ptr [[TMP6]], ptr [[TMP6]])
...
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 16, ptr [[TMP6]])
; CHECK-NEXT:    [[TMP12:%.*]] = load fp128, ptr [[TMP3]], align 16

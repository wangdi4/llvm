...
; CHECK: bb_if:
; CHECK: [[GEP_B:%[0-9]*]] = getelementptr %QNCA_a, ptr %"sub_$B", i64 0, i32 0
; CHECK: [[Load_B:%[0-9]*]] = load ptr, ptr [[GEP_B]], align 1
; CHECK: [[GEP_A:%[0-9]*]] = getelementptr %QNCA_a, ptr %"sub_$A", i64 0, i32 0
; CHECK: [[Load_A:%[0-9]*]] = load ptr, ptr [[GEP_A]], align 1
; CHECK: %"sub_$I_fetch164" = load i32, ptr %"sub_$I", align 1

; CHECK: bb_then:
; CHECK: %A_elem_addr_1 = getelementptr float, ptr [[Load_A]], i64 32
; CHECK: %B_elem_addr_1 = getelementptr float, ptr [[Load_B]], i64 34

; CHECK: bb_else:
; CHECK: %A_elem_addr_2 = getelementptr float, ptr [[Load_A]], i64 32
; CHECK: %B_elem_addr_2 = getelementptr float, ptr [[Load_B]], i64 34

; Function Attrs: nofree norecurse nounwind uwtable
define void @sub_(ptr noalias nocapture readonly dereferenceable(96) "assumed_shape" "ptrnoalias" %"sub_$A", ptr noalias nocapture readonly dereferenceable(96) "assumed_shape" "ptrnoalias" %"sub_$B", ptr noalias nocapture readonly dereferenceable(4) %"sub_$I") local_unnamed_addr #0 {

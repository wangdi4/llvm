...
; RUN: opt -S -aa-pipeline=basic-aa -passes=licm -use-dereferenceable-at-point-semantics=0 < %s | FileCheck %s
; RUN: opt -S -aa-pipeline=basic-aa -passes=licm -use-dereferenceable-at-point-semantics=1 < %s | FileCheck %s

...
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[TMP0:%.*]] = select i1 [[FLAG:%.*]], i1 [[CMP]], i1 [[CMP2]]
; CHECK-NEXT:    [[FROMBOOL1:%.*]] = zext i1 [[TMP0]] to i8
...
define zeroext i1 @test1(i1 zeroext %flag, i32 %blksA, i32 %blksB, i32 %nblks) {
>>>>>>> 15fc293b11181177c9410e8715c2186bbe1390ed
entry:
...
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[NBLKS:%.*]], [[BLKSB:%.*]]
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[TMP0:%.*]] = select i1 [[FLAG:%.*]], i32 [[NBLKS]], i32 [[ADD]]
; CHECK-NEXT:    [[CMP:%.*]] = icmp uge i32 [[BLKSA:%.*]], [[TMP0]]
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; CHECK-NEXT:    [[TMP0:%.*]] = select i1 [[FLAG2:%.*]], i8 [[FROMBOOL3]], i8 0
; CHECK-NEXT:    br label [[IF_END]]
; CHECK:       if.end:
; CHECK-NEXT:    [[OBEYS_0:%.*]] = phi i8 [ [[FROMBOOL1]], [[IF_THEN]] ], [ [[TMP0]], [[IF_ELSE]] ]
; end INTEL_CUSTOMIZATION

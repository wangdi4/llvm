...
; CHECK: Module loaded : Name = {{.*}}, Size = {{[0-9]+}}
; CHECK: Loaded section : Name = .text, Size = {{[0-9]+}}
; CHECK: Loaded section : Name = .eh_frame, Size = {{[0-9]+}}
; CHECK: Module unloaded : Name = {{.*}}, Size = {{[0-9]+}}

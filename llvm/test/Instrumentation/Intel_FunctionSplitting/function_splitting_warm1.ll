...
;
; In this test, the code under the 'if.else' tag is never executed, however the
; function is not HOT according to the profile summary. In this case, function
; splitting should only be applied to it in the case where the command line flag

...
; INTEL_CUSTOMIZATION: Added options to revert to upstream behavior
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx908 -mbb-optreport-opt=false < %s | FileCheck -check-prefix=GFX908 %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx90a -mbb-optreport-opt=false < %s | FileCheck -check-prefix=GFX90A %s

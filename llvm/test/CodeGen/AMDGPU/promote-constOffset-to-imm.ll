...
; RUN: llc -mtriple=amdgcn -mcpu=gfx803 -verify-machineinstrs  -mbb-optreport-opt=false < %s | FileCheck -check-prefixes=GFX8 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx900 -verify-machineinstrs -mbb-optreport-opt=false < %s | FileCheck -check-prefixes=GFX9,GFX900 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1010 -verify-machineinstrs -mbb-optreport-opt=false < %s | FileCheck -check-prefixes=GFX10 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx90a -verify-machineinstrs -mbb-optreport-opt=false < %s | FileCheck -check-prefixes=GFX9,GFX90A %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -verify-machineinstrs -mbb-optreport-opt=false < %s | FileCheck -check-prefixes=GFX11 %s

...
; CHECK: mullohis64 [[LOCHAN:%[a-z_0-9]+]], [[HICHAN:%[a-z_0-9]+]],
; CHECK: st64 [[HIADDR:%[a-z_0-9]+]], [[HICHAN]]
...
; CHECK: .result .reg .i64 [[LOREG:%r[0-9]+]]
; CHECK: mullohiu64 [[LOCHAN:%[a-z_0-9]+]], [[HICHAN:%[a-z_0-9]+]],
; CHECK: st64 [[HIADDR:%[a-z_0-9]+]], [[HICHAN]]
; CHECK: mov64 [[LOREG]], [[LOCHAN]]
...
; CHECK: mullohis64 [[LOCHAN:%[a-z_0-9]+]], [[HICHAN:%[a-z_0-9]+]],
; CHECK: st64 [[LOADDR:%[a-z_0-9]+]], [[LOCHAN]]

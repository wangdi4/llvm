...
define double @truncDF(double %x) local_unnamed_addr #0 {
; CSA_CHECK-label: truncDF
; CSA_CHECK: .call trunc
; CSA_CHECK_NOMATHLIB: truncf64

entry:
  %call = tail call double @trunc(double %x) #2
  ret double %call
}

; Function Attrs: nounwind readnone
declare double @trunc(double) local_unnamed_addr #1

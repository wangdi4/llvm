...
define float @tanFF(float %x) local_unnamed_addr #0 {
; CSA_CHECK-label: tanFF
; CSA_CHECK: .call tanf
; CSA_CHECK_NOMATHLIB: tanf32

entry:
  %call = tail call float @tan(float %x) #2
  ret float %call
}

; Function Attrs: nounwind readnone
declare float @tan(float) local_unnamed_addr #1

...
define double @roundDF(double %x) local_unnamed_addr #0 {
; CSA_CHECK-label: roundDF
; CSA_CHECK: .call round
; CSA_CHECK_NOMATHLIB: roundf64

entry:
  %call = tail call double @round(double %x) #2
  ret double %call
}

; Function Attrs: nounwind readnone
declare double @round(double) local_unnamed_addr #1

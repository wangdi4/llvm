...
define float @ceilFF(float %x) local_unnamed_addr #0 {
; CSA_CHECK-label: ceilFF
; CSA_CHECK: .call ceilf
; CSA_CHECK_NOMATHLIB: ceilf32

entry:
  %call = tail call float @ceil(float %x) #2
  ret float %call
}

; Function Attrs: nounwind readnone
declare float @ceil(float) local_unnamed_addr #1

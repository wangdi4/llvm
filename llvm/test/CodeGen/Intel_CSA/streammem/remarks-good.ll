...
define i32 @foo(i32* nocapture noalias %a, i32* nocapture readonly %b, i32 %N) local_unnamed_addr #0 !dbg !7 {
entry:
...
; CHECK: remark: foo.c:3:12: converted to streaming memory reference
  %arrayidx2 = getelementptr inbounds i32, i32* %a, i64 %indvars.iv, !dbg !31
  store i32 %0, i32* %arrayidx2, align 4, !dbg !32, !tbaa !27
; CHECK: remark: foo.c:3:10: converted to streaming memory reference

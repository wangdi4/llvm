...
; INTEL_CUSTOMIZATION
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+sse2 -disable-iml-trans | FileCheck %s --check-prefix=SSE --check-prefix=SSE2
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+sse4.1 -disable-iml-trans | FileCheck %s --check-prefix=SSE --check-prefix=SSE41
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx -disable-iml-trans | FileCheck %s --check-prefix=AVX --check-prefix=AVX1
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx2 -disable-iml-trans | FileCheck %s --check-prefix=AVX --check-prefix=AVX2 --check-prefix=AVX2NOBW
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx512bw -disable-iml-trans | FileCheck %s --check-prefix=AVX --check-prefix=AVX2 --check-prefix=AVX512BW

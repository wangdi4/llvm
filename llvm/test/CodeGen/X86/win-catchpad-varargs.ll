; RUN: llc -mtriple=x86_64-windows-msvc -stack-symbol-ordering=0 < %s | FileCheck %s --check-prefix=X64
; RUN: llc -mtriple=i686-windows-msvc -stack-symbol-ordering=0 < %s | FileCheck %s --check-prefix=X86

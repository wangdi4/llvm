...
; RUN: llc -opaque-pointers -mcpu=skylake -mtriple=x86_64-pc-linux-gnu < %s | FileCheck %s --check-prefixes=SKL
; RUN: llc -opaque-pointers -mcpu=skylake -mtriple=i686-pc-linux-gnu < %s | FileCheck %s --check-prefixes=SKL-32
; RUN: llc -opaque-pointers -mcpu=skx -mtriple=x86_64-pc-linux-gnu < %s | FileCheck %s --check-prefixes=SKX
; RUN: llc -opaque-pointers -mcpu=skx -mtriple=i686-pc-linux-gnu < %s | FileCheck %s --check-prefixes=SKX-32

...
; RUN: llc < %s -verify-machineinstrs -mtriple=x86_64-unknown-unknown --show-mc-encoding -mattr=+avx512movzxc | FileCheck %s --check-prefixes=AVX512MOVZXC
...
; AVX512MOVZXC-LABEL: test_mm_move_epi32:
; AVX512MOVZXC:       # %bb.0:
; AVX512MOVZXC-NEXT:    vmovd %xmm0, %xmm0 # encoding: [0x62,0xf1,0x7e,0x08,0x7e,0xc0]
; AVX512MOVZXC-NEXT:    retq # encoding: [0xc3]
;
...
; AVX512MOVZXC-LABEL: test_mm_move_epi16:
; AVX512MOVZXC:       # %bb.0:
; AVX512MOVZXC-NEXT:    vmovw %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7e,0x08,0x6e,0xc0]
; AVX512MOVZXC-NEXT:    retq # encoding: [0xc3]
;

...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=avx512f | FileCheck %s --check-prefixes=CHECK,AVX512
...
; CHECK-NEXT:    callq __svml_v4f64_v4i1
; CHECK-NEXT:    popq %rax
...
; CHECK-NEXT:    callq __svml_v8f32_v8i1
; CHECK-NEXT:    popq %rax
; CHECK-NEXT:    .cfi_def_cfa_offset 8
; CHECK-NEXT:    retq

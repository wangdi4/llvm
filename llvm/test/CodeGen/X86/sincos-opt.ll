...
; GNU_SINCOS: callq __libm_sse2_sincosf ;INTEL
; GNU_SINCOS: addss %xmm1, %xmm0 ;INTEL

; GNU_SINCOS_FASTMATH-LABEL: test1:
; GNU_SINCOS_FASTMATH: callq __libm_sse2_sincosf ;INTEL
; GNU_SINCOS_FASTMATH: addss %xmm1, %xmm0 ;INTEL
...
; GNU_SINCOS: callq __libm_sse2_sincos ;INTEL
; GNU_SINCOS: addsd %xmm1, %xmm0 ;INTEL

; GNU_SINCOS_FASTMATH-LABEL: test2:
; GNU_SINCOS_FASTMATH: callq __libm_sse2_sincos ;INTEL
; GNU_SINCOS_FASTMATH: addsd %xmm1, %xmm0 ;INTEL

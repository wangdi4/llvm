...
; AVX512BW-SLOW:       # %bb.0:
; AVX512BW-SLOW-NEXT:    subq $136, %rsp ;INTEL
; AVX512BW-SLOW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%r8), %zmm17
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%r9), %zmm15
...
; AVX512BW-SLOW-NEXT:    kmovd %r10d, %k2 ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm0 {%k2} = ymm1[u,u,u,14,u,12,u,u,u,u,15,u,13,u,u,u,u,u,u,30,u,28,u,u,u,u,31,u,29,u,u,u] ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[2,3,2,3]
; INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpor %ymm1, %ymm2, %ymm1
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm11
...
; AVX512BW-SLOW-NEXT:    kmovq %r10, %k3
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm0, %zmm11 {%k3}
; AVX512BW-SLOW-NEXT:    vmovdqa 32(%r8), %ymm0
; AVX512BW-SLOW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-SLOW-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,2,3],zmm15[4,5,6,7]
...
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqu64 %zmm1, (%rsp) # 64-byte Spill
; AVX512BW-SLOW-NEXT:    vshufi64x2 {{.*#+}} zmm1 = zmm1[0,1,2,3],zmm17[4,5,6,7]
...
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm0, %zmm11 {%k5}
; AVX512BW-SLOW-NEXT:    vextracti64x4 $1, %zmm11, %ymm1
; AVX512BW-SLOW-NEXT:    vmovdqa 32(%rax), %ymm10
...
; AVX512BW-SLOW-NEXT:    vpermw %ymm10, %ymm0, %ymm0
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    movl $-2130574328, %r10d # imm = 0x81020408
; AVX512BW-SLOW-NEXT:    kmovd %r10d, %k3
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm0, %ymm1 {%k3} ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqa64 32(%rcx), %xmm22 ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} xmm0 = <u,u,u,128,7,128,5,u,u,u,128,8,128,6,u,u>
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm22, %xmm2
; AVX512BW-SLOW-NEXT:    vmovdqa64 32(%rdx), %xmm23
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} xmm14 = <u,u,u,7,128,5,128,u,u,u,8,128,6,128,u,u>
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm23, %xmm3
; AVX512BW-SLOW-NEXT:    vpor %xmm2, %xmm3, %xmm2
; AVX512BW-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm22[8],xmm23[8],xmm22[9],xmm23[9],xmm22[10],xmm23[10],xmm22[11],xmm23[11],xmm22[12],xmm23[12],xmm22[13],xmm23[13],xmm22[14],xmm23[14],xmm22[15],xmm23[15]
...
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} xmm3 = <u,128,7,128,5,u,u,u,128,8,128,6,u,u,u,128> ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm27, %xmm4 ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqa64 32(%rdi), %xmm30
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} xmm5 = <u,7,128,5,128,u,u,u,8,128,6,128,u,u,u,9> ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufb %xmm5, %xmm30, %xmm7 ;INTEL
; AVX512BW-SLOW-NEXT:    vpor %xmm4, %xmm7, %xmm4 ;INTEL
...
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} zmm13 = zmm4[0,1,0,1,4,5,4,5]
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm2, %zmm13 {%k5}
; AVX512BW-SLOW-NEXT:    vmovdqa64 32(%r9), %xmm24
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} xmm2 = <128,4,u,u,u,128,7,128,5,u,u,u,128,8,128,6>
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm24, %xmm4
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqa64 32(%r8), %xmm28
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{.*#+}} xmm18 = <4,128,u,u,u,7,128,5,128,u,u,u,8,128,6,128>
; AVX512BW-SLOW-NEXT:    vpshufb %xmm18, %xmm28, %xmm7
; AVX512BW-SLOW-NEXT:    vpor %xmm4, %xmm7, %xmm4
; AVX512BW-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm28[8],xmm24[8],xmm28[9],xmm24[9],xmm28[10],xmm24[10],xmm28[11],xmm24[11],xmm28[12],xmm24[12],xmm28[13],xmm24[13],xmm28[14],xmm24[14],xmm28[15],xmm24[15]
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm7 = xmm7[u,6,7,2,3,u,u,u,8,9,4,5,u,u,u,10]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm7, %zmm4, %zmm4 ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} zmm4 = zmm4[0,1,0,1,4,5,4,5] ;INTEL
; AVX512BW-SLOW-NEXT:    movl $67637280, %r10d # imm = 0x4081020
; AVX512BW-SLOW-NEXT:    kmovd %r10d, %k4
; AVX512BW-SLOW-NEXT:    vextracti64x4 $1, %zmm4, %ymm7 ;INTEL
; AVX512BW-SLOW-NEXT:    vbroadcasti128 {{.*#+}} ymm1 = [4,5,4,5,5,6,5,6,4,5,4,5,5,6,5,6]
; AVX512BW-SLOW-NEXT:    # ymm1 = mem[0,1,0,1]
; AVX512BW-SLOW-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512BW-SLOW-NEXT:    vpermw %ymm10, %ymm1, %ymm9 ;INTEL
...
; AVX512BW-SLOW-NEXT:    vpermw %ymm10, %ymm1, %ymm9 ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm9, %ymm4 {%k6} ;INTEL
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm7, %zmm4, %zmm4 ;INTEL
; AVX512BW-SLOW-NEXT:    movabsq $-8714997200177740921, %r10 # imm = 0x870E1C3870E1C387
; AVX512BW-SLOW-NEXT:    kmovq %r10, %k7 ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm4, %zmm13 {%k7} ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%rcx), %xmm31
; AVX512BW-SLOW-NEXT:    vpshufb %xmm0, %xmm31, %xmm0
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqa (%rdx), %xmm9
; AVX512BW-SLOW-NEXT:    vpshufb %xmm14, %xmm9, %xmm4
; AVX512BW-SLOW-NEXT:    vpor %xmm0, %xmm4, %xmm0
; AVX512BW-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm9[0],xmm31[0],xmm9[1],xmm31[1],xmm9[2],xmm31[2],xmm9[3],xmm31[3],xmm9[4],xmm31[4],xmm9[5],xmm31[5],xmm9[6],xmm31[6],xmm9[7],xmm31[7]
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm4 = xmm4[4,5,0,1,u,u,u,6,7,2,3,u,u,u,8,9]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm0, %zmm4, %zmm0
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%rsi), %xmm29
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpshufb %xmm3, %xmm29, %xmm3
; AVX512BW-SLOW-NEXT:    vmovdqa (%rdi), %xmm12
; AVX512BW-SLOW-NEXT:    vpshufb %xmm5, %xmm12, %xmm4
; AVX512BW-SLOW-NEXT:    vpor %xmm3, %xmm4, %xmm3
; AVX512BW-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm12[0],xmm29[0],xmm12[1],xmm29[1],xmm12[2],xmm29[2],xmm12[3],xmm29[3],xmm12[4],xmm29[4],xmm12[5],xmm29[5],xmm12[6],xmm29[6],xmm12[7],xmm29[7]
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm4 = xmm4[0,1,u,u,u,6,7,2,3,u,u,u,8,9,4,5]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm3, %zmm4, %zmm3 ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} zmm0 = zmm0[0,1,0,1,4,5,4,5]
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} zmm14 = zmm3[0,1,0,1,4,5,4,5] ;INTEL
; AVX512BW-SLOW-NEXT:    movabsq $871499720017774092, %r10 # imm = 0xC183060C183060C
; AVX512BW-SLOW-NEXT:    kmovq %r10, %k7 ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm0, %zmm14 {%k7} ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%r9), %xmm25
; AVX512BW-SLOW-NEXT:    vpshufb %xmm2, %xmm25, %xmm0 ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%r8), %xmm26
; AVX512BW-SLOW-NEXT:    vpshufb %xmm18, %xmm26, %xmm2 ;INTEL
...
; AVX512BW-SLOW-NEXT:    vmovdqa (%rax), %ymm5 ;INTEL
; AVX512BW-SLOW-NEXT:    vpermw %ymm5, %ymm1, %ymm1 ;INTEL
; AVX512BW-SLOW-NEXT:    vextracti64x4 $1, %zmm2, %ymm3
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm1, %ymm3 {%k6} ;INTEL
; AVX512BW-SLOW-NEXT:    movl $135274560, %eax # imm = 0x8102040
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    kmovd %eax, %k6
; AVX512BW-SLOW-NEXT:    vmovdqa64 {{.*#+}} ymm18 = [1,1,0,0,1,1,0,0,4,5,1,1,1,1,0,0]
; AVX512BW-SLOW-NEXT:    vpermw %ymm5, %ymm18, %ymm1
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm1, %ymm2 {%k6}
; end INTEL_CUSTOMIZATION
...
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm1, %zmm14 {%k7}
; AVX512BW-SLOW-NEXT:    movl $270549121, %eax # imm = 0x10204081
; AVX512BW-SLOW-NEXT:    kmovd %eax, %k7
; AVX512BW-SLOW-NEXT:    vbroadcasti128 {{.*#+}} ymm4 = [11,13,12,11,12,13,13,12,11,13,12,11,12,13,13,12]
; AVX512BW-SLOW-NEXT:    # ymm4 = mem[0,1,0,1]
; AVX512BW-SLOW-NEXT:    vpermw %ymm10, %ymm4, %ymm1
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm1, %ymm11 {%k7}
; AVX512BW-SLOW-NEXT:    vmovdqa (%rsi), %ymm8
; AVX512BW-SLOW-NEXT:    vpshufb %ymm6, %ymm8, %ymm1
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm2 = ymm1[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vmovdqa (%rdi), %ymm7 ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufb %ymm20, %ymm7, %ymm3 ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vpor %ymm2, %ymm3, %ymm2
; AVX512BW-SLOW-NEXT:    vpshuflw {{.*#+}} ymm3 = ymm7[1,2,2,3,4,5,6,7,9,10,10,11,12,13,14,15] ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufd {{.*#+}} ymm3 = ymm3[0,0,1,1,4,4,5,5]
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm3 {%k1} = ymm8[u,u,u,u,5,u,3,u,u,u,u,6,u,4,u,u,u,u,u,u,21,u,19,u,u,u,u,22,u,20,u,u] ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm2, %zmm3, %zmm6 ;INTEL
...
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} zmm20 = zmm2[2,3,2,3,6,7,6,7] ;INTEL
...
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm6, %zmm17, %zmm0
; end INTEL_CUSTOMIZATION
...
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} zmm0 = zmm0[2,3,2,3,6,7,6,7]
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqa64 (%r9), %ymm17
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm17, %zmm15, %zmm15
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} zmm15 = zmm15[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u],zero,zmm15[20],zero,zmm15[18],zero,zero,zero,zero,zmm15[21],zero,zmm15[19],zero,zero,zero,zero,zmm15[22,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u],zero,zero,zero,zero,zmm15[57],zero,zmm15[55],zero,zero,zero,zero,zmm15[58],zero,zmm15[56],zero,zero
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} zmm15 = zmm15[2,3,2,3,6,7,6,7]
; AVX512BW-SLOW-NEXT:    vporq %zmm0, %zmm15, %zmm15
; AVX512BW-SLOW-NEXT:    vpermw %ymm5, %ymm4, %ymm0
; AVX512BW-SLOW-NEXT:    vextracti64x4 $1, %zmm15, %ymm4
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm0, %ymm4 {%k7}
; end INTEL_CUSTOMIZATION
...
; AVX512BW-SLOW-NEXT:    vpermw %ymm5, %ymm0, %ymm0 ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm0, %ymm15 {%k5} ;INTEL
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm15, %zmm0 ;INTEL
...
; AVX512BW-SLOW-NEXT:    vpshufhw {{.*#+}} ymm0 = ymm7[0,1,2,3,6,7,7,6,8,9,10,11,14,15,15,14] ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[2,2,3,3,6,6,7,7]
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm0 {%k2} = ymm8[u,u,u,14,u,12,u,u,u,u,15,u,13,u,u,u,u,u,u,30,u,28,u,u,u,u,31,u,29,u,u,u] ;INTEL
; AVX512BW-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm30[0],xmm27[0],xmm30[1],xmm27[1],xmm30[2],xmm27[2],xmm30[3],xmm27[3],xmm30[4],xmm27[4],xmm30[5],xmm27[5],xmm30[6],xmm27[6],xmm30[7],xmm27[7] ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm4 = xmm4[0,1,u,u,u,6,7,2,3,u,u,u,8,9,4,5] ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[2,3,2,3]
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm4 = ymm4[0,1,0,1]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm0
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm4 = ymm2[11,u,u,u,u,14,u,12,u,u,u,u,15,u,13,u,27,u,u,u,u,30,u,28,u,u,u,u,31,u,29,u]
; AVX512BW-SLOW-NEXT:    vpshufhw {{.*#+}} ymm15 = ymm3[0,1,2,3,7,6,6,7,8,9,10,11,15,14,14,15]
; AVX512BW-SLOW-NEXT:    vpshufd {{.*#+}} ymm15 = ymm15[0,2,3,3,4,6,7,7]
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm15, %ymm4 {%k1}
; AVX512BW-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm23[0],xmm22[0],xmm23[1],xmm22[1],xmm23[2],xmm22[2],xmm23[3],xmm22[3],xmm23[4],xmm22[4],xmm23[5],xmm22[5],xmm23[6],xmm22[6],xmm23[7],xmm22[7]
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm15 = xmm15[4,5,0,1,u,u,u,6,7,2,3,u,u,u,8,9]
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm4 = ymm4[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm15 = ymm15[0,1,0,1]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm15, %zmm4, %zmm15
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    movabsq $3485998880071096368, %rax # imm = 0x3060C183060C1830
; AVX512BW-SLOW-NEXT:    kmovq %rax, %k2
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm0, %zmm15 {%k2} ;INTEL
; AVX512BW-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm28[0],xmm24[0],xmm28[1],xmm24[1],xmm28[2],xmm24[2],xmm28[3],xmm24[3],xmm28[4],xmm24[4],xmm28[5],xmm24[5],xmm28[6],xmm24[6],xmm28[7],xmm24[7] ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm0 = xmm0[u,u,4,5,0,1,u,u,u,6,7,2,3,u,u,u]
; AVX512BW-SLOW-NEXT:    vpermw %ymm10, %ymm18, %ymm4 ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,1,0,1]
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm4, %ymm0 {%k6}
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm4 = ymm17[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,29],zero,ymm17[27],zero,zero,zero,zero,ymm17[30],zero,ymm17[28],zero,zero,zero,zero,ymm17[31],zero
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm4 = ymm4[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm18 = ymm6[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u],zero,ymm6[27],zero,zero,zero,zero,ymm6[30],zero,ymm6[28],zero,zero,zero,zero,ymm6[31],zero,ymm6[29]
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm18 = ymm18[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vporq %ymm4, %ymm18, %ymm4
; AVX512BW-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %ymm18 # 32-byte Reload
; AVX512BW-SLOW-NEXT:    vpermw %ymm5, %ymm18, %ymm18
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm18, %ymm4 {%k3}
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm0, %zmm4, %zmm0
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    movabsq $1016749673354069774, %rax # imm = 0xE1C3870E1C3870E
; AVX512BW-SLOW-NEXT:    kmovq %rax, %k3
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm0, %zmm15 {%k3} ;INTEL
...
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} ymm4 = [128,128,128,128,128,14,128,128,128,128,128,128,15,128,128,128,128,128,128,16,128,128,128,128,128,128,17,128,128,128,128,128] ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufb %ymm4, %ymm2, %ymm2 ;INTEL
; AVX512BW-SLOW-NEXT:    vpor %ymm3, %ymm2, %ymm2
; AVX512BW-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm31[8],xmm9[8],xmm31[9],xmm9[9],xmm31[10],xmm9[10],xmm31[11],xmm9[11],xmm31[12],xmm9[12],xmm31[13],xmm9[13],xmm31[14],xmm9[14],xmm31[15],xmm9[15] ;INTEL
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm3 = xmm3[6,3,2,u,u,u,9,8,5,4,u,u,u,11,10,7]
...
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpshufb %ymm3, %ymm7, %ymm1
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} ymm9 = [128,128,128,14,128,128,128,128,128,128,15,128,128,128,128,128,128,16,128,128,128,128,128,128,17,128,128,128,128,128,128,18]
; AVX512BW-SLOW-NEXT:    vpshufb %ymm9, %ymm8, %ymm7
; AVX512BW-SLOW-NEXT:    vpor %ymm1, %ymm7, %ymm1
; AVX512BW-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm29[8],xmm12[8],xmm29[9],xmm12[9],xmm29[10],xmm12[10],xmm29[11],xmm12[11],xmm29[12],xmm12[12],xmm29[13],xmm12[13],xmm29[14],xmm12[14],xmm29[15],xmm12[15]
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm7 = xmm7[2,u,u,u,9,8,5,4,u,u,u,11,10,7,6,u]
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm7 = ymm7[0,1,0,1]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm1, %zmm7, %zmm1
; end INTEL_CUSTOMIZATION
...
; AVX512BW-SLOW-NEXT:    vpshufb %ymm2, %ymm17, %ymm7 ;INTEL
...
; AVX512BW-SLOW-NEXT:    vpshufb %ymm8, %ymm6, %ymm6 ;INTEL
; AVX512BW-SLOW-NEXT:    vpor %ymm7, %ymm6, %ymm6 ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} ymm7 = [12,13,2,3,12,13,0,1,14,15,2,3,0,1,14,15,28,29,18,19,28,29,16,17,30,31,18,19,16,17,30,31] ;INTEL
; AVX512BW-SLOW-NEXT:    movl $541098242, %eax # imm = 0x20408102
; AVX512BW-SLOW-NEXT:    kmovd %eax, %k3
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpshufb %ymm7, %ymm5, %ymm6 {%k3}
; AVX512BW-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %ymm17 # 32-byte Reload
; AVX512BW-SLOW-NEXT:    vpermw %ymm5, %ymm17, %ymm5
; AVX512BW-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm26[8],xmm25[8],xmm26[9],xmm25[9],xmm26[10],xmm25[10],xmm26[11],xmm25[11],xmm26[12],xmm25[12],xmm26[13],xmm25[13],xmm26[14],xmm25[14],xmm26[15],xmm25[15]
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} xmm17 = xmm17[u,6,7,2,3,u,u,u,8,9,4,5,u,u,u,10]
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm17 = ymm17[0,1,0,1]
; AVX512BW-SLOW-NEXT:    vmovdqu8 %ymm5, %ymm17 {%k4}
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm6, %zmm17, %zmm5
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    movabsq $4066998693416279096, %rax # imm = 0x3870E1C3870E1C38
; AVX512BW-SLOW-NEXT:    kmovq %rax, %k4
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm5, %zmm1 {%k4}
; AVX512BW-SLOW-NEXT:    vpshuflw {{.*#+}} ymm5 = ymm21[1,2,2,3,4,5,6,7,9,10,10,11,12,13,14,15]
; AVX512BW-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm5[0,0,1,1,4,4,5,5]
; AVX512BW-SLOW-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Reload
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm5 {%k1} = ymm6[u,u,u,u,5,u,3,u,u,u,u,6,u,4,u,u,u,u,u,u,21,u,19,u,u,u,u,22,u,20,u,u]
; AVX512BW-SLOW-NEXT:    vpshufb %ymm3, %ymm21, %ymm3
; AVX512BW-SLOW-NEXT:    vpshufb %ymm9, %ymm6, %ymm6
; AVX512BW-SLOW-NEXT:    vpor %ymm3, %ymm6, %ymm3
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm5 = ymm5[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm5, %zmm3, %zmm3
; AVX512BW-SLOW-NEXT:    vpshufb %ymm0, %ymm19, %ymm0
; AVX512BW-SLOW-NEXT:    vpshufb %ymm4, %ymm16, %ymm4
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vpor %ymm0, %ymm4, %ymm0
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm4 = zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,zero,ymm19[18],zero,ymm19[18,19,20,21],zero,ymm19[19],zero,ymm19[25,26,27,22],zero,ymm19[20],zero ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm4 = ymm4[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vpshufb {{.*#+}} ymm5 = ymm16[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u],zero,ymm16[18],zero,zero,zero,zero,ymm16[21],zero,ymm16[19],zero,zero,zero,zero,ymm16[22],zero,ymm16[20] ;INTEL
; AVX512BW-SLOW-NEXT:    vpermq {{.*#+}} ymm5 = ymm5[2,3,2,3]
; AVX512BW-SLOW-NEXT:    vpor %ymm4, %ymm5, %ymm4
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm0
; AVX512BW-SLOW-NEXT:    vmovdqu8 %zmm0, %zmm3 {%k2}
; AVX512BW-SLOW-NEXT:    vmovdqu64 (%rsp), %zmm5 # 64-byte Reload ;INTEL
...
; AVX512BW-SLOW-NEXT:    vpshufb %ymm7, %ymm10, %ymm0 {%k3} ;INTEL
; AVX512BW-SLOW-NEXT:    vmovdqa {{.*#+}} ymm2 = [10,9,9,10,10,9,9,10,9,10,14,15,10,9,9,10]
; AVX512BW-SLOW-NEXT:    vpermw %ymm10, %ymm2, %ymm2 ;INTEL
...
; AVX512BW-SLOW-NEXT:    vinserti64x4 $1, {{[-0-9]+}}(%r{{[sb]}}p), %zmm11, %zmm0 # 32-byte Folded Reload ;INTEL
; AVX512BW-SLOW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm3, 320(%rax)
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm1, 64(%rax)
; INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm15, 192(%rax)
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm20, 128(%rax)
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm14, (%rax)
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm13, 256(%rax)
; AVX512BW-SLOW-NEXT:    vmovdqa64 %zmm0, 384(%rax)
; AVX512BW-SLOW-NEXT:    addq $136, %rsp
; end INTEL_CUSTOMIZATION
; AVX512BW-SLOW-NEXT:    vzeroupper
; AVX512BW-SLOW-NEXT:    retq
;

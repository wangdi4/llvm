...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmaxsh %xmm0, %xmm1, %xmm2
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmaxph %xmm0, %xmm1, %xmm2
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmaxph %ymm0, %ymm1, %ymm2
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmaxph %zmm0, %zmm1, %zmm2
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmaxsh {{.*}}(%rip), %xmm0, %xmm0
; CHECK-NEXT:    retq

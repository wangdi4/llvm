...
; X86-NEXT:    vmovdqa %xmm0, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xc8]
; X86-NEXT:    vfmadd231sh (%eax), %xmm0, %xmm1 # encoding: [0x62,0xf6,0x7d,0x08,0xb9,0x08]
...
; X64-NEXT:    vfmadd231sh (%rsi), %xmm0, %xmm1 # encoding: [0x62,0xf6,0x7d,0x08,0xb9,0x0e]

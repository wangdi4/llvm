...
; CHECK-AVX2-NEXT:    retq
;
; CHECK-NO-FASTFMA-LABEL: fmul_pow2_ldexp_4xfloat:
; CHECK-NO-FASTFMA:       # %bb.0:
; CHECK-NO-FASTFMA-NEXT:    vcvtdq2ps %xmm0, %xmm1
; CHECK-NO-FASTFMA-NEXT:    vmovss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; CHECK-NO-FASTFMA-NEXT:    vscalefss %xmm1, %xmm2, %xmm1
; CHECK-NO-FASTFMA-NEXT:    vshufps {{.*#+}} xmm3 = xmm0[1,1,1,1]
; CHECK-NO-FASTFMA-NEXT:    vcvtdq2ps %xmm3, %xmm3
; CHECK-NO-FASTFMA-NEXT:    vscalefss %xmm3, %xmm2, %xmm3
; CHECK-NO-FASTFMA-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[2,3]
; CHECK-NO-FASTFMA-NEXT:    vshufps {{.*#+}} xmm3 = xmm0[2,3,2,3]
; CHECK-NO-FASTFMA-NEXT:    vcvtdq2ps %xmm3, %xmm3
; CHECK-NO-FASTFMA-NEXT:    vscalefss %xmm3, %xmm2, %xmm3
; CHECK-NO-FASTFMA-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1],xmm3[0],xmm1[3]
; CHECK-NO-FASTFMA-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[3,3,3,3]
; CHECK-NO-FASTFMA-NEXT:    vcvtdq2ps %xmm0, %xmm0
; CHECK-NO-FASTFMA-NEXT:    vscalefss %xmm0, %xmm2, %xmm0
; CHECK-NO-FASTFMA-NEXT:    vinsertps {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[0]
; CHECK-NO-FASTFMA-NEXT:    retq
;
; CHECK-FMA-LABEL: fmul_pow2_ldexp_4xfloat:
; CHECK-FMA:       # %bb.0:
; CHECK-FMA-NEXT:    vcvtdq2ps %xmm0, %xmm1
; CHECK-FMA-NEXT:    vmovss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; CHECK-FMA-NEXT:    vscalefss %xmm1, %xmm2, %xmm1
; CHECK-FMA-NEXT:    vpsrlq $32, %xmm0, %xmm3
; CHECK-FMA-NEXT:    vcvtdq2ps %xmm3, %xmm3
; CHECK-FMA-NEXT:    vscalefss %xmm3, %xmm2, %xmm3
; CHECK-FMA-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[2,3]
; CHECK-FMA-NEXT:    vpshufd {{.*#+}} xmm3 = xmm0[2,3,2,3]
; CHECK-FMA-NEXT:    vcvtdq2ps %xmm3, %xmm3
; CHECK-FMA-NEXT:    vscalefss %xmm3, %xmm2, %xmm3
; CHECK-FMA-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0,1],xmm3[0],xmm1[3]
; CHECK-FMA-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[3,3,3,3]
; CHECK-FMA-NEXT:    vcvtdq2ps %xmm0, %xmm0
; CHECK-FMA-NEXT:    vscalefss %xmm0, %xmm2, %xmm0
; CHECK-FMA-NEXT:    vinsertps {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[0]
; CHECK-FMA-NEXT:    retq

...
; RUN: llc < %s -enable-intel-advanced-opts -mtriple=x86_64-unknown-unknown -mattr=+avx2 | FileCheck %s --check-prefix=X64-AVX --check-prefix=X64-AVX2
; RUN: llc < %s -enable-intel-advanced-opts -mtriple=x86_64-unknown-unknown -mattr=+avx512dq,+avx512vl | FileCheck %s --check-prefix=X64-AVX --check-prefix=X64-AVX512DQ
...
; X64-AVX2-LABEL: mul_v2i64_0x8000000000000001:
; X64-AVX2:       # %bb.0:
; X64-AVX2-NEXT:    vpsllq $63, %xmm0, %xmm1
; X64-AVX2-NEXT:    vpsubq %xmm1, %xmm0, %xmm0
; X64-AVX2-NEXT:    retq
;
; X64-AVX512DQ-LABEL: mul_v2i64_0x8000000000000001:
; X64-AVX512DQ:       # %bb.0:
; X64-AVX512DQ-NEXT:    vpsllq $63, %xmm0, %xmm1
; X64-AVX512DQ-NEXT:    vpaddq %xmm0, %xmm1, %xmm0

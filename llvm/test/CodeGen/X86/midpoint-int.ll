...
; end INTEL_CUSTOMIZATION
; X86-NEXT:  .LBB5_3:
; X86-NEXT:    negl %ebx ;INTEL
; X86-NEXT:    movl %ebx, %ebp ;INTEL
; X86-NEXT:    orl $1, %ebp
; X86-NEXT:    subl %esi, %eax ;INTEL
; X86-NEXT:    sbbl %edx, %edi ;INTEL
; X86-NEXT:    shrdl $1, %edi, %eax
; X86-NEXT:    imull %eax, %ebx ;INTEL
; X86-NEXT:    mull %ebp ;INTEL
; X86-NEXT:    addl %ebx, %edx ;INTEL
; X86-NEXT:    shrl %edi
; X86-NEXT:    imull %ebp, %edi
; X86-NEXT:    addl %edi, %edx
; X86-NEXT:    addl {{[0-9]+}}(%esp), %eax ;INTEL
...
; end INTEL_CUSTOMIZATION
; X86-NEXT:    movl %edi, %edx
; X86-NEXT:    sbbl %ecx, %edx ;INTEL
; X86-NEXT:    setl %dl
; X86-NEXT:    movzbl %dl, %ebx ;INTEL
; X86-NEXT:    jl .LBB7_1
; X86-NEXT:  # %bb.2:
; X86-NEXT:    movl %ecx, (%esp) # 4-byte Spill ;INTEL
; X86-NEXT:    movl %esi, %edx ;INTEL
; X86-NEXT:    jmp .LBB7_3
; X86-NEXT:  .LBB7_1:
...
; X86-NEXT:    movl 4(%eax), %ecx ;INTEL
; X86-NEXT:    movl (%edx), %eax
; X86-NEXT:    movl 4(%edx), %edi
; X86-NEXT:    cmpl %esi, %eax ;INTEL
; X86-NEXT:    movl %edi, %edx
; X86-NEXT:    sbbl %ecx, %edx ;INTEL
; X86-NEXT:    setl %dl
; X86-NEXT:    movzbl %dl, %ebx ;INTEL

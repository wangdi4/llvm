...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=icelake-client -mattr=-avx512vnni | FileCheck %s --check-prefixes=CHECK,CHECK-VBMI
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=icelake-server -mattr=-avx512vnni | FileCheck %s --check-prefixes=CHECK,CHECK-VBMI
...
>>>>>>> 635d383fad2baef4cb4b241c8dd31c91913c0f32

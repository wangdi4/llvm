...
; WIN32-NEXT:    subl $8, %esp ;INTEL
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %edi ;INTEL
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %edx
; WIN32-NEXT:    movl %edx, %ecx
; WIN32-NEXT:    movl %edx, %ebx ;INTEL
; WIN32-NEXT:    sarl $31, %ecx
; WIN32-NEXT:    movl %edi, %esi ;INTEL
; WIN32-NEXT:    imull %ecx, %esi ;INTEL
; WIN32-NEXT:    mull %ecx
; WIN32-NEXT:    movl %edx, %ebp ;INTEL
...
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    mull %ecx ;INTEL
; WIN32-NEXT:    movl %edx, %edi
; WIN32-NEXT:    movl %eax, %ecx ;INTEL
; WIN32-NEXT:    addl %ebp, %ecx ;INTEL
; WIN32-NEXT:    adcl $0, %edi
; WIN32-NEXT:    movl %ebx, %eax ;INTEL
...
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    mull {{[0-9]+}}(%esp)
; WIN32-NEXT:    addl %ebx, %eax ;INTEL
; WIN32-NEXT:    movzbl %cl, %ecx ;INTEL
; WIN32-NEXT:    adcl %ecx, %edx
; WIN32-NEXT:    addl (%esp), %eax # 4-byte Folded Reload ;INTEL
; WIN32-NEXT:    adcl %esi, %edx ;INTEL
; WIN32-NEXT:    movl %ebp, %ecx ;INTEL
; WIN32-NEXT:    sarl $31, %ecx
; WIN32-NEXT:    xorl %ecx, %edx
; WIN32-NEXT:    xorl %eax, %ecx
; WIN32-NEXT:    orl %edx, %ecx
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    movl %ebp, 4(%eax) ;INTEL
...
; end INTEL_CUSTOMIZATION
; WIN32-NEXT:    movl %eax, (%esp) # 4-byte Spill
; WIN32-NEXT:    adcl %esi, %ebx ;INTEL
; WIN32-NEXT:    movl %ebp, %eax ;INTEL
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; WIN32-NEXT:    mull %ecx
; WIN32-NEXT:    movl %edx, %esi ;INTEL
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    mull %ecx
; INTEL_CUSTOMIZATION
; WIN32-NEXT:    movl %edx, %ecx
...
; end INTEL_CUSTOMIZATION
; WIN32-NEXT:    setb %cl
; WIN32-NEXT:    movl %edi, %eax ;INTEL
; WIN32-NEXT:    mull {{[0-9]+}}(%esp)
; WIN32-NEXT:    addl %ebp, %eax ;INTEL
...
; end INTEL_CUSTOMIZATION
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    orl %edx, %esi ;INTEL
; WIN32-NEXT:    jne LBB12_2
; WIN32-NEXT:  # %bb.1:
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %edi ;INTEL
; WIN32-NEXT:  LBB12_2:
; WIN32-NEXT:    movl %edi, %edx ;INTEL
...
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    movl (%eax), %edx
; WIN32-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill ;INTEL
; WIN32-NEXT:    movl 4(%eax), %esi ;INTEL
; WIN32-NEXT:    movl %esi, (%esp) # 4-byte Spill ;INTEL
; WIN32-NEXT:    movl %ecx, %eax
; WIN32-NEXT:    movl %ecx, %edi ;INTEL
; WIN32-NEXT:    sarl $31, %eax
; WIN32-NEXT:    movl %eax, %ecx ;INTEL
; WIN32-NEXT:    imull %esi, %ecx ;INTEL
; WIN32-NEXT:    mull %edx
; WIN32-NEXT:    movl %eax, %ebp
; INTEL_CUSTOMIZATION
; WIN32-NEXT:    movl %edx, %ebx
...
; WIN32-NEXT:    adcl %ebx, %edi ;INTEL
; WIN32-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload ;INTEL
; WIN32-NEXT:    movl %esi, %eax
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ecx ;INTEL
; WIN32-NEXT:    mull %ecx ;INTEL
; WIN32-NEXT:    movl %edx, %ebp
; INTEL_CUSTOMIZATION
; WIN32-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; WIN32-NEXT:    movzbl %cl, %ecx ;INTEL
; WIN32-NEXT:    adcl %ecx, %edx
; WIN32-NEXT:    addl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Folded Reload ;INTEL
; WIN32-NEXT:    adcl %edi, %edx ;INTEL
; WIN32-NEXT:    movl %ebp, %ecx ;INTEL
; WIN32-NEXT:    sarl $31, %ecx
; WIN32-NEXT:    xorl %ecx, %edx
; WIN32-NEXT:    xorl %eax, %ecx
...
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    movl (%eax), %ebp ;INTEL
; WIN32-NEXT:    movl 4(%eax), %ebx ;INTEL
; WIN32-NEXT:    movl %ebx, (%esp) # 4-byte Spill ;INTEL
; WIN32-NEXT:    sarl $31, %ecx
; WIN32-NEXT:    movl %ebx, %esi ;INTEL
; WIN32-NEXT:    imull %ecx, %esi ;INTEL
; WIN32-NEXT:    movl %ebp, %eax
; WIN32-NEXT:    mull %ecx ;INTEL
; WIN32-NEXT:    movl %edx, %ecx ;INTEL
; WIN32-NEXT:    movl %eax, %edi ;INTEL
...
; WIN32-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    mull %ebp ;INTEL
; WIN32-NEXT:    movl %edx, %edi
; WIN32-NEXT:    movl %eax, %ecx ;INTEL
; WIN32-NEXT:    addl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Folded Reload ;INTEL
; WIN32-NEXT:    adcl $0, %edi
; INTEL_CUSTOMIZATION
; WIN32-NEXT:    movl %ebx, %eax
...
; end INTEL_CUSTOMIZATION
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    mull (%esp) # 4-byte Folded Reload ;INTEL
; WIN32-NEXT:    addl %ebx, %eax ;INTEL
; WIN32-NEXT:    movzbl %cl, %ecx ;INTEL
; WIN32-NEXT:    adcl %ecx, %edx
; WIN32-NEXT:    addl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Folded Reload ;INTEL

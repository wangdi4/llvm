...
; X64-NEXT:    retq
  ...
  %1 = call intel_ocl_bicc_avx512 <16 x float> @func_float16_ptr(<16 x float> %x, <16 x float>* %y)
...
define intel_ocl_bicc_avx512 <16 x float> @test_prolog_epilog(<16 x float> %a, <16 x float> %b) nounwind {
...
; X64-SKX-NEXT:    retq
  ...
  %1 = call intel_ocl_bicc_avx512 <16 x float> @func_float16_mask(<16 x float> %a, <16 x i1> %imask)
  ret <16 x float> %1
}

define intel_ocl_bicc_avx512 <16 x float> @test_prolog_epilog_with_mask(<16 x float> %a, <16 x i32> %x1, <16 x i32>%x2, <16 x i1> %mask) nounwind {
...
; X64-NEXT:    retq
   ...
   %c = call intel_ocl_bicc_avx512 <16 x float> @func_float16_mask(<16 x float> %a, <16 x i1>%mask1)
   ret <16 x float> %c
}

...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtsd2usi %xmm0, %eax ;INTEL
; CHECK-NEXT:    vcvtsd2usi {rz-sae}, %xmm0, %ecx ;INTEL
; CHECK-NEXT:    addl %eax, %ecx ;INTEL
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtsd2si %xmm0, %eax ;INTEL
; CHECK-NEXT:    vcvtsd2si {rz-sae}, %xmm0, %ecx ;INTEL
; CHECK-NEXT:    addl %eax, %ecx ;INTEL
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtss2usi %xmm0, %eax ;INTEL
; CHECK-NEXT:    vcvtss2usi {rz-sae}, %xmm0, %ecx ;INTEL
; CHECK-NEXT:    addl %eax, %ecx ;INTEL
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtss2si %xmm0, %eax ;INTEL
; CHECK-NEXT:    vcvtss2si {rz-sae}, %xmm0, %ecx ;INTEL
; CHECK-NEXT:    addl %eax, %ecx ;INTEL

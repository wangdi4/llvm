...
; CHECK-LIN-LABEL: b:
; CHECK-LIN:       # %bb.0:
; CHECK-LIN-NEXT:    punpcklwd {{.*#+}} xmm0 = xmm0[0,0,1,1,2,2,3,3] ;INTEL
; CHECK-LIN-NEXT:    psrad $16, %xmm0
; CHECK-LIN-NEXT:    retq
;
; CHECK-WIN-LABEL: b:
; CHECK-WIN:       # %bb.0:
; CHECK-WIN-NEXT:    punpcklwd {{.*#+}} xmm0 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3] ;INTEL
; CHECK-WIN-NEXT:    psrad $16, %xmm0
; CHECK-WIN-NEXT:    retq
...
; CHECK-LIN-LABEL: e:
; CHECK-LIN:       # %bb.0:
; CHECK-LIN-NEXT:    pxor %xmm1, %xmm1 ;INTEL
; CHECK-LIN-NEXT:    punpcklwd {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3] ;INTEL
; CHECK-LIN-NEXT:    retq
;
; CHECK-WIN-LABEL: e:
; CHECK-WIN:       # %bb.0:
; CHECK-WIN-NEXT:    movdqa (%rcx), %xmm0 ;INTEL
; CHECK-WIN-NEXT:    pxor %xmm1, %xmm1 ;INTEL
; CHECK-WIN-NEXT:    punpcklwd {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3] ;INTEL
; CHECK-WIN-NEXT:    retq
...
; CHECK-LIN-LABEL: h:
; CHECK-LIN:       # %bb.0:
; CHECK-LIN-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[0,2,2,3,4,5,6,7] ;INTEL
; CHECK-LIN-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,2,2,3] ;INTEL
; CHECK-LIN-NEXT:    retq
;
; CHECK-WIN-LABEL: h:
; CHECK-WIN:       # %bb.0:
...
>>>>>>> c486b82cfbe59929a80e5f29bab82112555c8bf4
; CHECK-WIN-NEXT:    retq

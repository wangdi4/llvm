...
; RUN: llc < %s -mtriple=i686-unknown-unknown -mattr=+avxdotprodint8  --show-mc-encoding | FileCheck %s --check-prefixes=X86
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avxdotprodint8  --show-mc-encoding | FileCheck %s --check-prefixes=X64

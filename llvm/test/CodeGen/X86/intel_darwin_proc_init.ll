...
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+x87 -intel-advanced-optim -O0 | FileCheck %s --check-prefix=CHECK-NOPINIT
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+x87 -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-X87
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+cmov -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-CMOV
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+mmx -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-MMX
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+sse -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-SSE
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+sse2 -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-SSE2
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+avx -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-AVX
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+avx512f -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-AVX512
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+avx512f -mattr=+cldemote -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-AVX512
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+avx512f -mattr=+sse2 -mattr=+cldemote -mattr=-sse2 -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-AVX512
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+avx512bw -mattr=+cldemote -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-AVX512BW
; RUN: llc < %s -mtriple=x86_64-darwin-unknown -mattr=+avx512bw -mattr=+avx512f -mattr=+avx -mattr=+sse2 -mattr=+sse -mattr=+mmx -mattr=+cmov -mattr=+x87 -intel-advanced-optim | FileCheck %s --check-prefix=CHECK-PINIT-MIX

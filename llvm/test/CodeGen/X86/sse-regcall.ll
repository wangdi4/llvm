...
; WIN32-NEXT:    subl {{[0-9]+}}(%esp), %ebx ;INTEL
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %edx ;INTEL
; WIN32-NEXT:    movl %edx, %ecx ;INTEL
; WIN32-NEXT:    subl {{[0-9]+}}(%esp), %ecx
; WIN32-NEXT:    imull %ebx, %ecx
; WIN32-NEXT:    addl %eax, %ecx ;INTEL
...
; LINUXOSX-NEXT:    addl %r11d, %eax ;INTEL
; LINUXOSX-NEXT:    addl %r15d, %edx ;INTEL
; LINUXOSX-NEXT:    imull %edi, %edx ;INTEL

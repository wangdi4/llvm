...
; RUN: llc < %s -verify-machineinstrs -mtriple=x86_64-unknown-unknown -mattr=+ndd,+cf -disable-cgp-select2branch -x86-cmov-converter=false | FileCheck %s
...
; CHECK-NEXT:    movzbl g_100(%rip), %edx
; CHECK-NEXT:  .LBB3_2: # %func_4.exit.i
; CHECK-NEXT:    pushq %rbx
; CHECK-NEXT:    testb %cl, %cl
; CHECK-NEXT:    setne %bl
; CHECK-NEXT:    movzbl %al, %ecx
; CHECK-NEXT:    cfcmovel %ecx, %ecx
; CHECK-NEXT:    testb %al, %al
...
; CHECK-NEXT:    cmovnel %esi, %edx, %eax
...
; CHECK-NEXT:    cmovgeq %rsi, %rdx, %rax
; CHECK-NEXT:    retq

...
; X64-NEXT:    andb $85, %al, %al
; X64-NEXT:    subb %al, %dil, %al
; X64-NEXT:    andb $51, %al, %cl
; X64-NEXT:    shrb $2, %al, %al
; X64-NEXT:    andb $51, %al, %al
; X64-NEXT:    addb %al, %cl, %al
; X64-NEXT:    shrb $4, %al, %cl
; X64-NEXT:    addb %cl, %al, %al
; X64-NEXT:    andb $15, %al, %al
; X64-NEXT:    retq
;
...
; X64-NEXT:    andl $21845, %eax, %eax # imm = 0x5555
; X64-NEXT:    subl %eax, %edi, %eax
; X64-NEXT:    andl $13107, %eax, %ecx # imm = 0x3333
; X64-NEXT:    shrl $2, %eax, %eax
; X64-NEXT:    andl $13107, %eax, %eax # imm = 0x3333
; X64-NEXT:    addl %eax, %ecx, %eax
; X64-NEXT:    shrl $4, %eax, %ecx
; X64-NEXT:    addl %ecx, %eax, %eax
; X64-NEXT:    andl $3855, %eax, %eax # imm = 0xF0F
...
; X64-NEXT:    imulq %rcx, %rax, %rax
; X64-NEXT:    shrq $56, %rax, %rax
; X64-NEXT:    retq
;
...
; X64-NEXT:    shrq $2, %rax, %rax
; X64-NEXT:    andq %rdx, %rax, %rax
; X64-NEXT:    addq %rax, %rsi, %rax
; X64-NEXT:    shrq $4, %rax, %rsi
; X64-NEXT:    addq %rsi, %rax, %rax
; X64-NEXT:    movabsq $1085102592571150095, %rsi # imm = 0xF0F0F0F0F0F0F0F
; X64-NEXT:    andq %rsi, %rax, %rax
; X64-NEXT:    movabsq $72340172838076673, %r8 # imm = 0x101010101010101
; X64-NEXT:    imulq %r8, %rax, %rax
; X64-NEXT:    shrq $56, %rax, %rax
; X64-NEXT:    shrq %rdi, %r9
; X64-NEXT:    andq %rcx, %r9, %rcx
; X64-NEXT:    subq %rcx, %rdi, %rcx
; X64-NEXT:    andq %rdx, %rcx, %rdi
; X64-NEXT:    shrq $2, %rcx, %rcx
; X64-NEXT:    andq %rdx, %rcx, %rcx
; X64-NEXT:    addq %rcx, %rdi, %rcx
; X64-NEXT:    shrq $4, %rcx, %rdx
; X64-NEXT:    addq %rdx, %rcx, %rcx
; X64-NEXT:    andq %rsi, %rcx, %rcx
; X64-NEXT:    imulq %r8, %rcx, %rcx
; X64-NEXT:    shrq $56, %rcx, %rcx
; X64-NEXT:    addq %rax, %rcx, %rax
...
; X64-POPCNT-NEXT:    addq %rax, %rcx, %rax

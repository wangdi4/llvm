...
; APX-NEXT:    movq %rdi, %r17
; APX-NEXT:    adcq %r14, %r23
; APX-NEXT:    adcq %rcx, %r24
; APX-NEXT:    adcq $0, %r22
...
; APX-NEXT:    adcq $0, %r16
; APX-NEXT:    movq %r11, %rax
; APX-NEXT:    movq %r26, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; APX-NEXT:    mulq %r26
; APX-NEXT:    movq %rdx, %r9
; APX-NEXT:    movq %rax, %r12
; APX-NEXT:    addq %rbx, %r12
...
; APX-NEXT:    movq 32(%rsi), %r21
; APX-NEXT:    adcq {{[-0-9]+}}(%r{{[sb]}}p), %r12 # 8-byte Folded Reload
; APX-NEXT:    adcq %r29, %r16
...
; APX-NEXT:    movq %rax, %r29
; APX-NEXT:    addq %r9, %r29
; APX-NEXT:    adcq $0, %r27
; APX-NEXT:    movq 40(%rsi), %r10
; APX-NEXT:    movq %rdi, %rax
; APX-NEXT:    mulq %r10
; APX-NEXT:    movq %rdx, %r31
; APX-NEXT:    movq %rax, %rbx
; APX-NEXT:    addq %r29, %rbx
...
; APX-NEXT:    adcq $0, %r31
; APX-NEXT:    movq %r30, %rax
; APX-NEXT:    movq %r30, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; APX-NEXT:    mulq %r10
; APX-NEXT:    movq %rdx, %r27
...
; APX-NEXT:    adcq $0, %r29
; APX-NEXT:    adcq $0, %r9
; APX-NEXT:    movq 48(%rsi), %r26
; APX-NEXT:    movq %r30, %rax
; APX-NEXT:    mulq %r26
; APX-NEXT:    movq %rdx, %r27
; APX-NEXT:    movq %rax, %r20
; APX-NEXT:    movq %r18, %rax
; APX-NEXT:    movq %r18, (%rsp) # 8-byte Spill
; APX-NEXT:    mulq %r26
; APX-NEXT:    movq %rdx, %rbx
; APX-NEXT:    movq %rax, %r13
; APX-NEXT:    addq %r27, %r13
; APX-NEXT:    adcq $0, %rbx
; APX-NEXT:    movq 56(%rsi), %r18
; APX-NEXT:    movq %r30, %rax
; APX-NEXT:    mulq %r18
; APX-NEXT:    movq %rdx, %r27
; APX-NEXT:    addq %r13, %rax
...
; APX-NEXT:    addq %r27, %rcx
; APX-NEXT:    movzbl %r30b, %eax
; APX-NEXT:    adcq %rax, %r8
; APX-NEXT:    addq %r15, %r20
; APX-NEXT:    adcq %r31, %r13
; APX-NEXT:    adcq $0, %rcx
; APX-NEXT:    adcq $0, %r8
; APX-NEXT:    addq %r29, %rcx
; APX-NEXT:    adcq %r9, %r8
; APX-NEXT:    setb %r30b
...
; APX-NEXT:    adcq $0, %r11
; APX-NEXT:    adcq $0, %r15
; APX-NEXT:    addq {{[-0-9]+}}(%r{{[sb]}}p), %r29 # 8-byte Folded Reload
; APX-NEXT:    adcq %r23, %rbx
...
; APX-NEXT:    movq %rax, %r8
; APX-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r22 # 8-byte Reload
; APX-NEXT:    movq %r22, %rax
; APX-NEXT:    mulq %r21
; APX-NEXT:    movq %rdx, %r9
; APX-NEXT:    movq %rax, %r16
...
; APX-NEXT:    adcq %rax, %r9
; APX-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r30 # 8-byte Reload
; APX-NEXT:    movq %r30, %rax
; APX-NEXT:    mulq %r21
; APX-NEXT:    movq %rdx, %rcx
; APX-NEXT:    movq %rax, %rdi
...
; APX-NEXT:    adcq %rax, %r31
; APX-NEXT:    adcq $0, %r14
; APX-NEXT:    imulq %r21, %r30
; APX-NEXT:    movq %r21, %rax
; APX-NEXT:    mulq %r13
; APX-NEXT:    movq %rax, %rcx
; APX-NEXT:    addq %r30, %rdx
; APX-NEXT:    imulq %r10, %r13
; APX-NEXT:    addq %rdx, %r13
; APX-NEXT:    movq %r26, %rsi
; APX-NEXT:    imulq %r29, %rsi
...
; APX-NEXT:    movq %r29, %rax
; APX-NEXT:    mulq %r10
; APX-NEXT:    movq %rdx, %r29
; APX-NEXT:    movq %rax, %r15
; APX-NEXT:    addq %rcx, %r15
; APX-NEXT:    movzbl %sil, %eax
; APX-NEXT:    adcq %rax, %r29
; APX-NEXT:    addq %r8, %r15
; APX-NEXT:    adcq %r18, %r29
; APX-NEXT:    movq 112(%r25), %rsi
; APX-NEXT:    movq %r28, %rax
; APX-NEXT:    mulq %rsi
; APX-NEXT:    movq %rax, %rcx
; APX-NEXT:    imulq %r11, %rsi
; APX-NEXT:    addq %rdx, %rsi
; APX-NEXT:    movq 120(%r25), %rax
; APX-NEXT:    imulq %r28, %rax
; APX-NEXT:    addq %rax, %rsi
; APX-NEXT:    movq 96(%r25), %r8
; APX-NEXT:    movq 104(%r25), %r26
; APX-NEXT:    movq %rdi, %rax
; APX-NEXT:    imulq %r26, %rdi
; APX-NEXT:    mulq %r8
; APX-NEXT:    movq %rax, %r27
; APX-NEXT:    addq %rdi, %rdx
; APX-NEXT:    imulq %r8, %r19
; APX-NEXT:    addq %rdx, %r19
; APX-NEXT:    addq %rcx, %r27
; APX-NEXT:    adcq %rsi, %r19
; APX-NEXT:    movq %r8, %rax
; APX-NEXT:    mulq %r28
; APX-NEXT:    movq %rdx, %rcx
; APX-NEXT:    movq %rax, %r22
...
; APX-NEXT:    movq %rax, %r30
; APX-NEXT:    addq %rcx, %r30
; APX-NEXT:    adcq $0, %r28
; APX-NEXT:    movq %r8, %rax
; APX-NEXT:    mulq %r11
; APX-NEXT:    movq %rdx, %rcx
; APX-NEXT:    movq %rax, %r21
; APX-NEXT:    addq %r30, %r21
...
; APX-NEXT:    adcq $0, %r9
; APX-NEXT:    movq %r14, %rax
; APX-NEXT:    movq (%rsp), %rdi # 8-byte Reload
; APX-NEXT:    mulq %rdi
; APX-NEXT:    movq %rdx, %r8
; APX-NEXT:    movq %rax, %r24
; APX-NEXT:    addq %r16, %r24
...
; APX-NEXT:    movzbl %sil, %eax
; APX-NEXT:    adcq %rax, %r9
; APX-NEXT:    movq 64(%r20), %r15
; APX-NEXT:    movq %r15, %rax
; APX-NEXT:    mulq %r19
; APX-NEXT:    movq %rax, %r23
; APX-NEXT:    movq %rdx, %r8
; APX-NEXT:    movq 72(%r20), %rbx
...
; APX-NEXT:    adcq %rax, %r31
; APX-NEXT:    addq %r10, %r16
; APX-NEXT:    adcq %r8, %r13
; APX-NEXT:    movzbl %sil, %eax
; APX-NEXT:    adcq %rax, %r9
; APX-NEXT:    adcq $0, %r31
; APX-NEXT:    movq 96(%r20), %rcx
; APX-NEXT:    imulq %rcx, %r18
; APX-NEXT:    movq %rcx, %rax
; APX-NEXT:    movq %r17, %rsi
; APX-NEXT:    mulq %r17
; APX-NEXT:    movq %rax, %r8
; APX-NEXT:    addq %r18, %rdx
; APX-NEXT:    movq 104(%r20), %r18
; APX-NEXT:    imulq %r18, %rsi
; APX-NEXT:    addq %rdx, %rsi
; APX-NEXT:    movq %rsi, %r11
; APX-NEXT:    movq 112(%r20), %rax
; APX-NEXT:    movq %rax, %rsi
; APX-NEXT:    imulq %rdi, %rsi
; APX-NEXT:    mulq %r19
; APX-NEXT:    movq %rax, %r10
; APX-NEXT:    addq %rsi, %rdx
; APX-NEXT:    movq 120(%r20), %r27
; APX-NEXT:    imulq %r19, %r27
; APX-NEXT:    addq %rdx, %r27
; APX-NEXT:    addq %r8, %r10
; APX-NEXT:    adcq %r11, %r27
; APX-NEXT:    movq %r19, %rax
; APX-NEXT:    mulq %rcx
; APX-NEXT:    movq %rdx, %r8
; APX-NEXT:    movq %rax, %r20
...
; APX-NEXT:    imulq %r15, %rcx
; APX-NEXT:    movq %r15, %rax
; APX-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r8 # 8-byte Reload
; APX-NEXT:    mulq %r8
; APX-NEXT:    movq %rax, %rsi
; APX-NEXT:    addq %rcx, %rdx
; APX-NEXT:    imulq %rbx, %r8
; APX-NEXT:    addq %rdx, %r8
; APX-NEXT:    movq %r8, %rcx
; APX-NEXT:    movq %r14, %r8
; APX-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %rdi # 8-byte Reload
; APX-NEXT:    imulq %rdi, %r8
; APX-NEXT:    movq %r14, %rax
; APX-NEXT:    movq {{[-0-9]+}}(%r{{[sb]}}p), %r10 # 8-byte Reload
; APX-NEXT:    mulq %r10
; APX-NEXT:    movq %rax, %r27
; APX-NEXT:    addq %r8, %rdx
; APX-NEXT:    imulq %r10, %r30
; APX-NEXT:    addq %rdx, %r30
; APX-NEXT:    addq %rsi, %r27
; APX-NEXT:    adcq %rcx, %r30
...
; APX-NEXT:    adcq %r14, %rcx
; APX-NEXT:    setb %r14b
; APX-NEXT:    movq %rdi, %rax
; APX-NEXT:    mulq %rbx
; APX-NEXT:    addq %rcx, %rax
; APX-NEXT:    movzbl %r14b, %ecx
; APX-NEXT:    adcq %rcx, %rdx
; APX-NEXT:    addq %r27, %rax
; APX-NEXT:    adcq %r30, %rdx
; APX-NEXT:    addq %r20, %r8

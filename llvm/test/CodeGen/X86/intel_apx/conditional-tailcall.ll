...
; CHECK64-NEXT:  .LBB2_3:
; CHECK64-NEXT:    xorl %eax, %eax # EVEX TO LEGACY Compression encoding: [0x31,0xc0]
...
; WIN64-NEXT:  .LBB2_3:
; WIN64-NEXT:    xorl %eax, %eax # EVEX TO LEGACY Compression encoding: [0x31,0xc0]
...
; CHECK64-NEXT:    xorl %r8d, %r8d # EVEX TO LEGACY Compression encoding: [0x45,0x31,0xc0]
...
; WIN64-NEXT:    xorl %r8d, %r8d # EVEX TO LEGACY Compression encoding: [0x45,0x31,0xc0]

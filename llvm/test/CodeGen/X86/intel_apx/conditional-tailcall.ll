...
; RUN: llc < %s -mtriple=x86_64-linux -mattr=+ndd -show-mc-encoding | FileCheck %s --check-prefix=CHECK64
; RUN: llc < %s -mtriple=x86_64-win32 -mattr=+ndd -show-mc-encoding | FileCheck %s --check-prefix=WIN64
...
; CHECK64-NEXT:    # in Loop: Header=BB3_1 Depth=1
; CHECK64-NEXT:    addl $-48, %r9d, %r8d # encoding: [0x62,0xd4,0x3c,0x18,0x83,0xc1,0xd0]
...
; CHECK64-NEXT:    addl $-48, %r8d, %r8d # encoding: [0x62,0xd4,0x3c,0x18,0x83,0xc0,0xd0]
...
; CHECK64-NEXT:    # in Loop: Header=BB3_1 Depth=1
; CHECK64-NEXT:    incq %rdi, %rdi # encoding: [0x62,0xf4,0xc4,0x18,0xff,0xc7]
; CHECK64-NEXT:    decq %rax, %rax # encoding: [0x62,0xf4,0xfc,0x18,0xff,0xc8]
...
; WIN64-NEXT:    # in Loop: Header=BB3_1 Depth=1
; WIN64-NEXT:    addl $-48, %r9d, %r9d # encoding: [0x62,0xd4,0x34,0x18,0x83,0xc1,0xd0]
...
; WIN64-NEXT:    addl $-48, %r8d, %r9d # encoding: [0x62,0xd4,0x34,0x18,0x83,0xc0,0xd0]
...
; WIN64-NEXT:    # in Loop: Header=BB3_1 Depth=1
; WIN64-NEXT:    incq %rcx, %rcx # encoding: [0x62,0xf4,0xf4,0x18,0xff,0xc1]
; WIN64-NEXT:    decq %rax, %rax # encoding: [0x62,0xf4,0xfc,0x18,0xff,0xc8]

...
; PPX:       # %bb.0: # %entry
; PPX-NEXT:    pushq %rax
; PPX-NEXT:    push2p %rbp, %r15
; PPX-NEXT:    #APP
; PPX-NEXT:    #NO_APP
; PPX-NEXT:    pop2p %r15, %rbp
; PPX-NEXT:    popq %rax
; PPX-NEXT:    retq
;
; FRAME-LABEL: csr2:
...
; PPX:       # %bb.0: # %entry
; PPX-NEXT:    pushp %rbp
; PPX-NEXT:    push2p %r15, %r14
; PPX-NEXT:    #APP
; PPX-NEXT:    #NO_APP
; PPX-NEXT:    pop2p %r14, %r15
; PPX-NEXT:    popp %rbp
; PPX-NEXT:    retq
;
; FRAME-LABEL: csr3:
...
; PPX-NEXT:    pushq %rax
; PPX-NEXT:    push2p %rbp, %r15
; PPX-NEXT:    push2p %r14, %r13
; PPX-NEXT:    #APP
; PPX-NEXT:    #NO_APP
; PPX-NEXT:    pop2p %r13, %r14
; PPX-NEXT:    pop2p %r15, %rbp
; PPX-NEXT:    popq %rax
; PPX-NEXT:    retq
;
...
; PPX-NEXT:    pushp %rbp
; PPX-NEXT:    push2p %r15, %r14
; PPX-NEXT:    push2p %r13, %r12
; PPX-NEXT:    #APP
; PPX-NEXT:    #NO_APP
; PPX-NEXT:    pop2p %r12, %r13
; PPX-NEXT:    pop2p %r14, %r15
; PPX-NEXT:    popp %rbp
; PPX-NEXT:    retq
;
...
; PPX-NEXT:    push2p %rbp, %r15
; PPX-NEXT:    push2p %r14, %r13
; PPX-NEXT:    push2p %r12, %rbx
; PPX-NEXT:    #APP
; PPX-NEXT:    #NO_APP
; PPX-NEXT:    pop2p %rbx, %r12
; PPX-NEXT:    pop2p %r13, %r14
; PPX-NEXT:    pop2p %r15, %rbp
; PPX-NEXT:    popq %rax
; PPX-NEXT:    retq

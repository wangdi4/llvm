...
; CHECK-NEXT:    store <16 x i32> [[MAT:%.*]], <16 x i32>* [[TMP0]], align 64
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast <16 x i32>* [[TMP0]] to i32*
; CHECK-NEXT:    [[TMP2:%.*]] = mul i32 [[X:%.*]], 4
; CHECK-NEXT:    [[TMP3:%.*]] = add i32 [[TMP2]], [[Y:%.*]]
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i32, i32* [[TMP1]], i32 [[TMP3]]
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast i32* [[TMP4]] to <4 x i32>*
; CHECK-NEXT:    [[TMP6:%.*]] = load <4 x i32>, <4 x i32>* [[TMP5]], align 16
...
; CHECK-NEXT:    store <15 x i32> [[MAT:%.*]], <15 x i32>* [[TMP0]], align 64
; CHECK-NEXT:    [[TMP1:%.*]] = bitcast <15 x i32>* [[TMP0]] to i32*
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i32, i32* [[TMP1]], i32 13
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast i32* [[TMP2]] to <4 x i32>*
; CHECK-NEXT:    [[TMP4:%.*]] = load <4 x i32>, <4 x i32>* [[TMP3]], align 16
...
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i32, i32* [[TMP1]], i32 [[TMP3]]
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast i32* [[TMP4]] to <4 x i32>*
; CHECK-NEXT:    store <4 x i32> [[SLICE:%.*]], <4 x i32>* [[TMP5]], align 16
; CHECK-NEXT:    [[TMP6:%.*]] = load <16 x i32>, <16 x i32>* [[TMP0]], align 64
...
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr i32, i32* [[TMP1]], i32 13
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast i32* [[TMP2]] to <4 x i32>*
; CHECK-NEXT:    store <4 x i32> [[SLICE:%.*]], <4 x i32>* [[TMP3]], align 16
; CHECK-NEXT:    [[TMP4:%.*]] = load <15 x i32>, <15 x i32>* [[TMP0]], align 64
; CHECK-NEXT:    ret <15 x i32> [[TMP4]]
;
enrty:

...
;
  ...
  %D = call <15 x i32> @llvm.experimental.matrix.mad.v15i32.v12i8.v20i8(<12 x i8> %A, <20 x i8> %B, <15 x i32> %C, i32 3, i32 4, i32 5, metadata !"scope.subgroup")
  %E = call <15 x i32> @llvm.experimental.matrix.sumad.v15i32.v12i8.v20i8(<12 x i8> %A, <20 x i8> %B, <15 x i32> %C, i32 3, i32 4, i32 5, metadata !"scope.subgroup")
  %F = call <15 x i32> @llvm.experimental.matrix.usmad.v15i32.v12i8.v20i8(<12 x i8> %A, <20 x i8> %B, <15 x i32> %C, i32 3, i32 4, i32 5, metadata !"scope.subgroup")
  %G = call <15 x i32> @llvm.experimental.matrix.uumad.v15i32.v12i8.v20i8(<12 x i8> %A, <20 x i8> %B, <15 x i32> %C, i32 3, i32 4, i32 5, metadata !"scope.subgroup")
...
;
  ...
  %D = call <225 x float> @llvm.experimental.matrix.mad.v225f32.v450i16.v450i16(<450 x i16> %A, <450 x i16> %B, <225 x float> %C, i32 15, i32 30, i32 15, metadata !"scope.subgroup")
...
declare <225 x float> @llvm.experimental.matrix.mad.v225f32.v450i16.v450i16(<450 x i16>, <450 x i16>, <225 x float>, i32, i32, i32, metadata) #0
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare <15 x i32> @llvm.experimental.matrix.mad.v15i32.v12i8.v20i8(<12 x i8>, <20 x i8>, <15 x i32>, i32, i32, i32, metadata) #0

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare <15 x i32> @llvm.experimental.matrix.sumad.v15i32.v12i8.v20i8(<12 x i8>, <20 x i8>, <15 x i32>, i32, i32, i32, metadata) #0

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare <15 x i32> @llvm.experimental.matrix.usmad.v15i32.v12i8.v20i8(<12 x i8>, <20 x i8>, <15 x i32>, i32, i32, i32, metadata) #0

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare <15 x i32> @llvm.experimental.matrix.uumad.v15i32.v12i8.v20i8(<12 x i8>, <20 x i8>, <15 x i32>, i32, i32, i32, metadata) #0

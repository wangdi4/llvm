...
; RUN: opt -opaque-pointers=0 -x86-lower-matrix-intrinsics -mtriple=x86_64-unknown-unknown -mcpu=sapphirerapids %s -S | FileCheck %s

define <4 x i32> @test_extract_slice_4x4(<16 x i32> %mat, i32 %x, i32 %y) {
; CHECK-LABEL: @test_extract_slice_4x4(
; CHECK-NEXT:  enrty:
; CHECK-NEXT:    [[TMP0:%.*]] = mul i32 [[X:%.*]], 4
; CHECK-NEXT:    [[TMP1:%.*]] = add i32 [[TMP0]], [[Y:%.*]]
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <16 x i32> [[MAT:%.*]], i32 [[TMP1]]
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <4 x i32> poison, i32 [[TMP2]], i32 0
; CHECK-NEXT:    [[TMP4:%.*]] = add i32 [[TMP1]], 1
; CHECK-NEXT:    [[TMP5:%.*]] = extractelement <16 x i32> [[MAT]], i32 [[TMP4]]
; CHECK-NEXT:    [[TMP6:%.*]] = insertelement <4 x i32> [[TMP3]], i32 [[TMP5]], i32 1
; CHECK-NEXT:    [[TMP7:%.*]] = add i32 [[TMP4]], 1
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <16 x i32> [[MAT]], i32 [[TMP7]]
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x i32> [[TMP6]], i32 [[TMP8]], i32 2
; CHECK-NEXT:    [[TMP10:%.*]] = add i32 [[TMP7]], 1
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <16 x i32> [[MAT]], i32 [[TMP10]]
; CHECK-NEXT:    [[TMP12:%.*]] = insertelement <4 x i32> [[TMP9]], i32 [[TMP11]], i32 3
; CHECK-NEXT:    ret <4 x i32> [[TMP12]]
;
enrty:
  %0 = call <4 x i32> @llvm.experimental.matrix.extract.row.slice.v16i32(<16 x i32> %mat,  i32 %x, i32 %y, i32 4, i32 4, i32 4, metadata !"matrix.rowmajor")
  ret <4 x i32> %0
}
...
; CHECK-NEXT:  enrty:
; CHECK-NEXT:    [[TMP0:%.*]] = extractelement <15 x i32> [[MAT:%.*]], i32 13
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <4 x i32> poison, i32 [[TMP0]], i32 0
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <15 x i32> [[MAT]], i32 14
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <4 x i32> [[TMP1]], i32 [[TMP2]], i32 1
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <15 x i32> [[MAT]], i32 15
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <4 x i32> [[TMP3]], i32 [[TMP4]], i32 2
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <15 x i32> [[MAT]], i32 16
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <4 x i32> [[TMP5]], i32 [[TMP6]], i32 3
; CHECK-NEXT:    ret <4 x i32> [[TMP7]]
;
enrty:
  %0 = call <4 x i32> @llvm.experimental.matrix.extract.row.slice.v15i32(<15 x i32> %mat,  i32 2, i32 3, i32 4, i32 3, i32 5, metadata !"matrix.rowmajor")
  ret <4 x i32> %0
}
...
; CHECK-NEXT:    [[TMP0:%.*]] = mul i32 [[X:%.*]], 4
; CHECK-NEXT:    [[TMP1:%.*]] = add i32 [[TMP0]], [[Y:%.*]]
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i32> [[SLICE:%.*]], i32 0
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <16 x i32> [[MAT:%.*]], i32 [[TMP2]], i32 [[TMP1]]
; CHECK-NEXT:    [[TMP4:%.*]] = add i32 [[TMP1]], 1
; CHECK-NEXT:    [[TMP5:%.*]] = extractelement <4 x i32> [[SLICE]], i32 1
; CHECK-NEXT:    [[TMP6:%.*]] = insertelement <16 x i32> [[TMP3]], i32 [[TMP5]], i32 [[TMP4]]
; CHECK-NEXT:    [[TMP7:%.*]] = add i32 [[TMP4]], 1
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <4 x i32> [[SLICE]], i32 2
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <16 x i32> [[TMP6]], i32 [[TMP8]], i32 [[TMP7]]
; CHECK-NEXT:    [[TMP10:%.*]] = add i32 [[TMP7]], 1
; CHECK-NEXT:    [[TMP11:%.*]] = extractelement <4 x i32> [[SLICE]], i32 3
; CHECK-NEXT:    [[TMP12:%.*]] = insertelement <16 x i32> [[TMP9]], i32 [[TMP11]], i32 [[TMP10]]
; CHECK-NEXT:    ret <16 x i32> [[TMP12]]
;
enrty:
  %0 = call <16 x i32> @llvm.experimental.matrix.insert.row.slice.v16i32(<16 x i32> %mat, <4 x i32> %slice, i32 %x, i32 %y, i32 4, i32 4, i32 4, metadata !"matrix.rowmajor")
  ret <16 x i32> %0
}
...
; CHECK-NEXT:  enrty:
; CHECK-NEXT:    [[TMP0:%.*]] = extractelement <4 x i32> [[SLICE:%.*]], i32 0
; CHECK-NEXT:    [[TMP1:%.*]] = insertelement <15 x i32> [[MAT:%.*]], i32 [[TMP0]], i32 13
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i32> [[SLICE]], i32 1
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <15 x i32> [[TMP1]], i32 [[TMP2]], i32 14
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <4 x i32> [[SLICE]], i32 2
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <15 x i32> [[TMP3]], i32 [[TMP4]], i32 15
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <4 x i32> [[SLICE]], i32 3
; CHECK-NEXT:    [[TMP7:%.*]] = insertelement <15 x i32> [[TMP5]], i32 [[TMP6]], i32 16
; CHECK-NEXT:    ret <15 x i32> [[TMP7]]
;
enrty:
  %0 = call <15 x i32> @llvm.experimental.matrix.insert.row.slice.v15i32(<15 x i32> %mat, <4 x i32> %slice, i32 2, i32 3, i32 4, i32 3, i32 5, metadata !"matrix.rowmajor")
  ret <15 x i32> %0
}

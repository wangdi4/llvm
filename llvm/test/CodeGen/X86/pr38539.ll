...
; X86-NEXT:    movzbl (%eax), %ebx ;INTEL
; X86-NEXT:    movzbl %al, %eax
; X86-NEXT:    divb %bl ;INTEL
...
; X86-NEXT:    movb %bl, {{[-0-9]+}}(%e{{[sb]}}p) # 1-byte Spill ;INTEL
...
; X86-NEXT:    andb $15, %cl
; X86-NEXT:    negb %cl
; X86-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill ;INTEL
; X86-NEXT:    movsbl %cl, %edx ;INTEL
...
; X86-NEXT:    movl $0, {{[0-9]+}}(%esp)
; X86-NEXT:    movl $0, {{[0-9]+}}(%esp)
; X86-NEXT:    movl 136(%esp,%edx), %eax ;INTEL
; X86-NEXT:    movb %ch, %cl
; X86-NEXT:    shll %cl, %eax ;INTEL
; X86-NEXT:    notb %cl
; INTEL_CUSTOMIZATION
...
; X86-NEXT:    orl %edx, %eax ;INTEL
; X86-NEXT:    andl $3, %eax ;INTEL
...
; X86-NEXT:    movl $0, {{[0-9]+}}(%esp)
; X86-NEXT:    movl $0, {{[0-9]+}}(%esp)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload ;INTEL
; X86-NEXT:    movb %dl, %ch ;INTEL
; X86-NEXT:    andb $7, %ch
; INTEL_CUSTOMIZATION
; X86-NEXT:    movb %dl, %cl
; X86-NEXT:    shrb $3, %cl
...
; X86-NEXT:    movb %ch, %cl
; X86-NEXT:    shrdl %cl, %edx, %eax ;INTEL
; X86-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill ;INTEL
...
; X86-NEXT:    shldl $1, %eax, %esi ;INTEL
; X86-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload ;INTEL
; X86-NEXT:    shldl $1, %edx, %edi ;INTEL
; X86-NEXT:    orl %esi, %edi
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NEXT:    addl %edx, %edx ;INTEL
; X86-NEXT:    orl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Folded Reload ;INTEL
; X86-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill ;INTEL
; X86-NEXT:    andl $3, %ebx
; X86-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NEXT:    cmpl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Folded Reload ;INTEL
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload ;INTEL
; X86-NEXT:    sbbl %esi, %edx ;INTEL
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ebx # 4-byte Reload
; X86-NEXT:    sbbl %ecx, %ebx
; X86-NEXT:    shll $30, %ebx
; X86-NEXT:    movl %ebx, %edx ;INTEL
; X86-NEXT:    sarl $30, %edx ;INTEL
; X86-NEXT:    sarl $31, %ebx
; X86-NEXT:    shrdl $1, %ebx, %edx ;INTEL
; X86-NEXT:    movl %edx, %edi ;INTEL
; X86-NEXT:    andl $1, %edi
; X86-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NEXT:    andl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Folded Reload ;INTEL
...
; X86-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill ;INTEL
; X86-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NEXT:    orl %edi, %edx ;INTEL
; X86-NEXT:    orl %ebx, %edx ;INTEL

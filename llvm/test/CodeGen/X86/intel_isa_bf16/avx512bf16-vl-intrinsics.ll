...
; X86:       # %bb.0: # %entry
; X86-NEXT:    movzbl 4(%esp), %eax # encoding: [0x0f,0xb6,0x44,0x24,0x04]
; X86-NEXT:    kmovd   %eax, %k1               # encoding: [0xc5,0xfb,0x92,0xc8]
...
declare <8 x i16> @llvm.x86.avx512bf16.cvtneps2bf16.128(<4 x float>) #3
...
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
entry:
  %0 = tail call <8 x i16> @llvm.x86.avx512bf16.cvtneps2bf16.128(<4 x float> %A) #4
  %1 = bitcast <8 x i16> %0 to <2 x i64>
  ret <2 x i64> %1
}
...
; X86:       # %bb.0: # %entry
; X86-NEXT:    movb    4(%esp), %al            # encoding: [0x8a,0x44,0x24,0x04]
; X86-NEXT:    kmovd   %eax, %k1               # encoding: [0xc5,0xfb,0x92,0xc8] 

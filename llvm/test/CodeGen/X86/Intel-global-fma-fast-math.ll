...
; REQUIRES: asserts
; RUN: llc -verify-machineinstrs -mtriple=x86_64-apple-darwin -mcpu=corei7-avx -mattr=+fma -debug-only=global-fma -enable-unsafe-fp-math -fp-contract=fast -o /dev/null < %s 2>&1 | FileCheck %s

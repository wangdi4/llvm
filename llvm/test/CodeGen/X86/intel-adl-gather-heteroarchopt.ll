...
; X64-NEXT:    .p2align 4, 0x90
; X64-NEXT:  .LBB0_7: # %loop.48
; X64-NEXT:    # Parent Loop BB0_6 Depth=1
...
; X64-NEXT:    jb .LBB0_7
; X64-NEXT:  # %bb.8: # %afterloop.48
; X64-NEXT:    # in Loop: Header=BB0_6 Depth=1
...
; X64-NEXT:    jne .LBB0_6
; X64-NEXT:  .LBB0_4: # %for.cond.cleanup
...
; X64-NEXT:    cmpb $64, %al
; X64-NEXT:    je .LBB0_2
; X64-NEXT:  .LBB0_9: # %entry.clone
; X64-NEXT:    testl %r8d, %r8d
; X64-NEXT:    jle .LBB0_3
; X64-NEXT:  # %bb.10: # %for.body.preheader.clone
; X64-NEXT:    movl %r8d, %r9d
; X64-NEXT:    decq %r9
; X64-NEXT:    vxorpd %xmm0, %xmm0, %xmm0
; X64-NEXT:    xorl %r10d, %r10d
; X64-NEXT:    .p2align 4, 0x90
; X64-NEXT:  .LBB0_11: # %loop.39.clone
; X64-NEXT:    # =>This Loop Header: Depth=1
...
; X64-NEXT:    vxorpd %xmm4, %xmm4, %xmm4
; X64-NEXT:    .p2align 4, 0x90
; X64-NEXT:  .LBB0_12: # %loop.48.clone
...
; X64-NEXT:    cmpl $4080, %eax # imm = 0xFF0
; X64-NEXT:    jb .LBB0_12
; X64-NEXT:  # %bb.13: # %afterloop.48.clone

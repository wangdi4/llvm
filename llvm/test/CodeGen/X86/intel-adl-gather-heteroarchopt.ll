...
; X86-CORE-AVX2-NEXT:    movl 24(%ebp), %ebx
; X86-CORE-AVX2-NEXT:    testl %ebx, %ebx
...
; X86-CORE-AVX2-NEXT:    movl 12(%ebp), %edx
...
; X86-CORE-AVX2-NEXT:    movl %edi, %esi
; X86-CORE-AVX2-NEXT:    movl %edx, %eax
; X86-CORE-AVX2-NEXT:    movl %edi, %edx
; X86-CORE-AVX2-NEXT:    notl %edx
; X86-CORE-AVX2-NEXT:    addl %ebx, %edx
; X86-CORE-AVX2-NEXT:    movl 16(%ebp), %edi
; X86-CORE-AVX2-NEXT:    movl (%edi,%edx,4), %ebx
; X86-CORE-AVX2-NEXT:    movl $-16, %edi
; X86-CORE-AVX2-NEXT:    vxorpd %xmm1, %xmm1, %xmm1
; X86-CORE-AVX2-NEXT:    vxorps %xmm5, %xmm5, %xmm5
...
; X86-CORE-AVX2-NEXT:    vmovaps %ymm5, {{[-0-9]+}}(%e{{[sb]}}p) # 32-byte Spill
...
; X86-CORE-AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm5 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero
; X86-CORE-AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm7 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero
; X86-CORE-AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm1 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero
; X86-CORE-AVX2-NEXT:    vpcmpeqd %ymm2, %ymm2, %ymm2
; X86-CORE-AVX2-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; X86-CORE-AVX2-NEXT:    vgatherqpd %ymm2, (%ecx,%ymm1,8), %ymm0
; X86-CORE-AVX2-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1
; X86-CORE-AVX2-NEXT:    vxorpd %xmm2, %xmm2, %xmm2
; X86-CORE-AVX2-NEXT:    vgatherqpd %ymm1, (%ecx,%ymm7,8), %ymm2
; X86-CORE-AVX2-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1
; X86-CORE-AVX2-NEXT:    vxorpd %xmm7, %xmm7, %xmm7
; X86-CORE-AVX2-NEXT:    vgatherqpd %ymm1, (%ecx,%ymm5,8), %ymm7
; X86-CORE-AVX2-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1
; X86-CORE-AVX2-NEXT:    vxorpd %xmm5, %xmm5, %xmm5
; X86-CORE-AVX2-NEXT:    vmovapd {{[-0-9]+}}(%e{{[sb]}}p), %ymm6 # 32-byte Reload
; X86-CORE-AVX2-NEXT:    vgatherqpd %ymm1, (%ecx,%ymm6,8), %ymm5
...
; X86-CORE-AVX2-NEXT:    vfmadd231pd {{.*#+}} ymm3 = (ymm5 * mem) + ymm3
; X86-CORE-AVX2-NEXT:    vmovapd {{[-0-9]+}}(%e{{[sb]}}p), %ymm5 # 32-byte Reload
; X86-CORE-AVX2-NEXT:    vfmadd231pd {{.*#+}} ymm5 = (ymm7 * mem) + ymm5
; X86-CORE-AVX2-NEXT:    vfmadd231pd {{.*#+}} ymm1 = (ymm2 * mem) + ymm1
...
; X86-CORE-AVX2-NEXT:    vaddpd %ymm4, %ymm5, %ymm1
...
; X86-CORE-AVX2-NEXT:    movl %eax, %edx
; X86-CORE-AVX2-NEXT:    movl 24(%ebp), %ebx
...
; X86-CORE-AVX2-NEXT:    vmovdqu 96(%eax,%ebx,4), %ymm1
; X86-CORE-AVX2-NEXT:    vpslld $3, %ymm1, %ymm1
; X86-CORE-AVX2-NEXT:    vpaddd %ymm1, %ymm2, %ymm6
; X86-CORE-AVX2-NEXT:    vpslld $3, %ymm0, %ymm0
; X86-CORE-AVX2-NEXT:    vpaddd %ymm0, %ymm2, %ymm0
; X86-CORE-AVX2-NEXT:    vpextrd $1, %xmm0, %eax
; X86-CORE-AVX2-NEXT:    vpextrd $2, %xmm0, %edx
; X86-CORE-AVX2-NEXT:    vpextrd $3, %xmm0, %esi
; X86-CORE-AVX2-NEXT:    vextracti128 $1, %ymm0, %xmm1
; X86-CORE-AVX2-NEXT:    vpextrd $1, %xmm1, %edi
; X86-CORE-AVX2-NEXT:    vmovsd {{.*#+}} xmm7 = mem[0],zero
; X86-CORE-AVX2-NEXT:    vpextrd $2, %xmm1, %edx
; X86-CORE-AVX2-NEXT:    vmovhps {{.*#+}} xmm2 = xmm7[0,1],mem[0,1]
; X86-CORE-AVX2-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%e{{[sb]}}p) # 16-byte Spill
; X86-CORE-AVX2-NEXT:    vmovd %xmm0, %esi
...
; X86-CORE-AVX2-NEXT:    vpextrd $3, %xmm1, %ecx
...
; X86-CORE-AVX2-NEXT:    vmovd %xmm6, %ecx
; X86-CORE-AVX2-NEXT:    vmovsd {{.*#+}} xmm0 = mem[0],zero
; X86-CORE-AVX2-NEXT:    vpextrd $2, %xmm6, %edx
; X86-CORE-AVX2-NEXT:    vmovhpd {{.*#+}} xmm2 = xmm0[0],mem[0]
...
; X86-CORE-AVX2-NEXT:    vmovd %xmm0, %edx
; X86-CORE-AVX2-NEXT:    vpextrd $1, %xmm0, %esi
; X86-CORE-AVX2-NEXT:    vmovapd %ymm3, %ymm7
; X86-CORE-AVX2-NEXT:    vmovsd {{.*#+}} xmm3 = mem[0],zero
; X86-CORE-AVX2-NEXT:    vpextrd $2, %xmm0, %ecx
; X86-CORE-AVX2-NEXT:    vmovhpd {{.*#+}} xmm3 = xmm3[0],mem[0]
; X86-CORE-AVX2-NEXT:    vpextrd $3, %xmm0, %eax
...
; X86-CORE-AVX2-NEXT:    vinsertf128 $1, %xmm6, %ymm3, %ymm3
; X86-CORE-AVX2-NEXT:    vmovsd {{.*#+}} xmm6 = mem[0],zero
; X86-CORE-AVX2-NEXT:    movl 12(%ebp), %ecx
; X86-CORE-AVX2-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edi # 4-byte Reload
; X86-CORE-AVX2-NEXT:    vmovhpd {{.*#+}} xmm6 = xmm6[0],mem[0]
; X86-CORE-AVX2-NEXT:    vinsertf128 $1, %xmm2, %ymm6, %ymm2
; X86-CORE-AVX2-NEXT:    movl %edi, %eax
...
; X86-CORE-AVX2-NEXT:    vmovapd %ymm7, %ymm3
; X86-CORE-AVX2-NEXT:    vfmadd231pd {{.*#+}} ymm3 = (ymm1 * mem) + ymm3
; X86-CORE-AVX2-NEXT:    vmovapd {{[-0-9]+}}(%e{{[sb]}}p), %ymm1 # 32-byte Reload
...
; X86-CORE-AVX2-NEXT:    xorl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Folded Reload
; X86-CORE-AVX2-NEXT:    orl %edi, %edx
...
; X86-ADL-NEXT:    movl 24(%ebp), %ebx
; X86-ADL-NEXT:    testl %ebx, %ebx
...
; X86-ADL-NEXT:    movl %eax, (%esp) # 4-byte Spill
; X86-ADL-NEXT:    #APP
...
; X86-ADL-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-ADL-NEXT:    vmovsd %xmm1, {{[-0-9]+}}(%e{{[sb]}}p) # 8-byte Spill
; X86-ADL-NEXT:    movl %edi, %esi
; X86-ADL-NEXT:    movl %edx, %eax
; X86-ADL-NEXT:    movl %edi, %edx
; X86-ADL-NEXT:    notl %edx
; X86-ADL-NEXT:    addl %ebx, %edx
; X86-ADL-NEXT:    movl 16(%ebp), %edi
; X86-ADL-NEXT:    movl (%edi,%edx,4), %ebx
; X86-ADL-NEXT:    movl $-16, %edi
; X86-ADL-NEXT:    vxorps %xmm0, %xmm0, %xmm0
; X86-ADL-NEXT:    vxorpd %xmm1, %xmm1, %xmm1
; X86-ADL-NEXT:    vpxor %xmm2, %xmm2, %xmm2
...
; X86-ADL-NEXT:    vpmovzxdq {{.*#+}} ymm3 = mem[0],zero,mem[1],zero,mem[2],zero,mem[3],zero
; X86-ADL-NEXT:    vxorpd %xmm6, %xmm6, %xmm6
; X86-ADL-NEXT:    vmovapd %ymm4, %ymm1
; X86-ADL-NEXT:    vmovdqa %ymm2, %ymm4
; X86-ADL-NEXT:    vpcmpeqd %ymm2, %ymm2, %ymm2
; X86-ADL-NEXT:    vgatherqpd %ymm2, (%ecx,%ymm3,8), %ymm6
; X86-ADL-NEXT:    vmovdqa %ymm4, %ymm2
; X86-ADL-NEXT:    vmovapd %ymm1, %ymm4
...
; X86-ADL-NEXT:    vfmadd231pd {{.*#+}} ymm2 = (ymm6 * mem) + ymm2
...
; X86-ADL-NEXT:    vmovapd %ymm3, {{[-0-9]+}}(%e{{[sb]}}p) # 32-byte Spill
; X86-ADL-NEXT:    vmovapd {{[-0-9]+}}(%e{{[sb]}}p), %ymm0 # 32-byte Reload
; X86-ADL-NEXT:    vfmadd231pd {{.*#+}} ymm4 = (ymm5 * mem) + ymm4
...
; X86-ADL-NEXT:    vmovdqu 96(%eax,%ebx,4), %ymm1
...
; X86-ADL-NEXT:    vextracti128 $1, %ymm0, %xmm1
; X86-ADL-NEXT:    vpextrd $1, %xmm1, %edi
; X86-ADL-NEXT:    vmovsd {{.*#+}} xmm2 = mem[0],zero
; X86-ADL-NEXT:    vmovd %xmm0, %edx
; X86-ADL-NEXT:    vmovhps {{.*#+}} xmm0 = xmm2[0,1],mem[0,1]
; X86-ADL-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%e{{[sb]}}p) # 16-byte Spill
; X86-ADL-NEXT:    vpextrd $2, %xmm1, %esi
; X86-ADL-NEXT:    vmovsd {{.*#+}} xmm0 = mem[0],zero
; X86-ADL-NEXT:    vmovd %xmm1, %ecx
; X86-ADL-NEXT:    vmovhps {{.*#+}} xmm0 = xmm0[0,1],mem[0,1]
; X86-ADL-NEXT:    vmovaps %ymm0, {{[-0-9]+}}(%e{{[sb]}}p) # 32-byte Spill
; X86-ADL-NEXT:    vpextrd $3, %xmm1, %eax
...
; X86-ADL-NEXT:    vmovsd {{.*#+}} xmm2 = mem[0],zero
; X86-ADL-NEXT:    vpextrd $2, %xmm6, %eax
; X86-ADL-NEXT:    vmovhpd {{.*#+}} xmm2 = xmm2[0],mem[0]
; X86-ADL-NEXT:    vpextrd $3, %xmm6, %ecx
...
; X86-ADL-NEXT:    xorl (%esp), %edx # 4-byte Folded Reload
; X86-ADL-NEXT:    orl %edi, %edx
; X86-ADL-NEXT:    vaddpd %ymm5, %ymm0, %ymm0
; X86-ADL-NEXT:    vaddpd %ymm6, %ymm3, %ymm1
; X86-ADL-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; X86-ADL-NEXT:    vextractf128 $1, %ymm0, %xmm1
; X86-ADL-NEXT:    vaddpd %xmm1, %xmm0, %xmm0
; X86-ADL-NEXT:    vshufpd {{.*#+}} xmm1 = xmm0[1,0]

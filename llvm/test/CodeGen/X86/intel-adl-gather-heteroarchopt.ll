...
; X64-NEXT:    movl $26, %eax
; X64-NEXT:    xorl %ecx, %ecx
; X64-NEXT:    cpuid
; X64-NEXT:    shrl $24, %eax
; X64-NEXT:    cmpl $64, %eax
; X64-NEXT:    jne .LBB0_7
; X64-NEXT:  # %bb.1: # %entry
...
; X64-NEXT:    addq $16, %rbx
; X64-NEXT:    leal -16(%rbx), %eax

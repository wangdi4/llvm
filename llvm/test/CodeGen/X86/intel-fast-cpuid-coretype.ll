...
; RUN: opt --mtriple=x86_64-- --mcpu=alderlake -S --x86-pre-isel-intrinsic-lowering --verify < %s | FileCheck %s --check-prefix=ADL
; RUN: opt --mtriple=x86_64-- -S --x86-pre-isel-intrinsic-lowering --verify < %s | FileCheck %s --check-prefix=OTHERS
...
; ADL-NEXT:    [[TMP2:%.*]] = getelementptr [0 x i8], [0 x i8]* @__cpu_core_type, i64 0, i32 [[TMP1]]
; ADL-NEXT:    [[TMP3:%.*]] = load i8, i8* [[TMP2]], align 1

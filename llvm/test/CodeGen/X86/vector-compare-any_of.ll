...
; NOTE: Assertions have been autogenerated by utils/update_llc_test_checks.py UTC_ARGS: --version 2 ; INTEL
...
; AVX-NEXT:    vtestpd %xmm0, %xmm0 ;INTEL
; AVX-NEXT:    setne %al ;INTEL
; AVX-NEXT:    negq %rax ;INTEL
; AVX-NEXT:    retq
;
...
; AVX512-NEXT:    vtestpd %xmm0, %xmm0 ;INTEL
; AVX512-NEXT:    setne %al ;INTEL
; AVX512-NEXT:    negq %rax ;INTEL
; AVX512-NEXT:    retq
...
; AVX-NEXT:    xorl %eax, %eax
; AVX-NEXT:    vtestpd %ymm0, %ymm0 ;INTEL
; AVX-NEXT:    setne %al ;INTEL
; AVX-NEXT:    negq %rax ;INTEL
; AVX-NEXT:    vzeroupper
; AVX-NEXT:    retq
...
; AVX512-NEXT:    xorl %eax, %eax
; AVX512-NEXT:    vtestpd %ymm0, %ymm0 ;INTEL
; AVX512-NEXT:    setne %al ;INTEL
; AVX512-NEXT:    negq %rax ;INTEL
...
; AVX-NEXT:    xorl %eax, %eax
; AVX-NEXT:    vtestps %xmm0, %xmm0 ;INTEL
; AVX-NEXT:    setne %al ;INTEL
; AVX-NEXT:    negq %rax ;INTEL
; AVX-NEXT:    vzeroupper
; AVX-NEXT:    retq
...
; AVX512-NEXT:    xorl %eax, %eax
; AVX512-NEXT:    vtestps %xmm0, %xmm0 ;INTEL
; AVX512-NEXT:    setne %al ;INTEL
; AVX512-NEXT:    negq %rax ;INTEL
; AVX512-NEXT:    vzeroupper
; AVX512-NEXT:    retq
...
; AVX-NEXT:    xorl %eax, %eax
; AVX-NEXT:    vtestps %ymm0, %ymm0 ;INTEL
; AVX-NEXT:    setne %al ;INTEL
; AVX-NEXT:    negl %eax ;INTEL
; AVX-NEXT:    vzeroupper
; AVX-NEXT:    retq
...
; AVX512-NEXT:    xorl %eax, %eax
; AVX512-NEXT:    vtestps %ymm0, %ymm0 ;INTEL
; AVX512-NEXT:    setne %al ;INTEL
; AVX512-NEXT:    negl %eax ;INTEL
; AVX512-NEXT:    vzeroupper
; AVX512-NEXT:    retq
...
; SSE-NEXT:    cmpltps %xmm1, %xmm3
; SSE-NEXT:    cmpltps %xmm0, %xmm2
; SSE-NEXT:    orps %xmm3, %xmm2 ;INTEL
; SSE-NEXT:    movmskps %xmm2, %ecx ;INTEL
; SSE-NEXT:    xorl %eax, %eax
; SSE-NEXT:    negl %ecx
; SSE-NEXT:    sbbl %eax, %eax
; SSE-NEXT:    retq
...
; AVX2-NEXT:    vtestpd %ymm0, %ymm0 ;INTEL
; AVX2-NEXT:    setne %al ;INTEL
; AVX2-NEXT:    negq %rax ;INTEL
...
; SSE42-NEXT:    pcmpgtq %xmm3, %xmm1
; SSE42-NEXT:    pcmpgtq %xmm2, %xmm0
; SSE42-NEXT:    por %xmm1, %xmm0 ;INTEL
; SSE42-NEXT:    movmskpd %xmm0, %ecx ;INTEL
; SSE42-NEXT:    xorl %eax, %eax
; SSE42-NEXT:    negl %ecx
; SSE42-NEXT:    sbbq %rax, %rax
; SSE42-NEXT:    retq
...
; AVX2-NEXT:    xorl %eax, %eax
; AVX2-NEXT:    vtestps %xmm0, %xmm0 ;INTEL
; AVX2-NEXT:    setne %al ;INTEL
; AVX2-NEXT:    negq %rax ;INTEL
; AVX2-NEXT:    vzeroupper
; AVX2-NEXT:    retq
...
; AVX2-NEXT:    xorl %eax, %eax
; AVX2-NEXT:    vtestps %ymm0, %ymm0 ;INTEL
; AVX2-NEXT:    setne %al ;INTEL
; AVX2-NEXT:    negl %eax ;INTEL
; AVX2-NEXT:    vzeroupper
; AVX2-NEXT:    retq
;
...
; SSE-NEXT:    movmskps %xmm0, %ecx ;INTEL
; SSE-NEXT:    xorl %eax, %eax
; SSE-NEXT:    negl %ecx
; SSE-NEXT:    sbbl %eax, %eax
; SSE-NEXT:    retq
...
; SSE42-NEXT:    por %xmm3, %xmm2 ;INTEL
; SSE42-NEXT:    movmskpd %xmm2, %eax ;INTEL
...
; SSE42-NEXT:    por %xmm3, %xmm2 ;INTEL
; SSE42-NEXT:    movmskps %xmm2, %eax ;INTEL
; SSE42-NEXT:    testl %eax, %eax
; SSE42-NEXT:    setne %al
; SSE42-NEXT:    retq
;
...
; AVX512-NEXT:    kunpckwd %k0, %k1, %k2 ;INTEL
; AVX512-NEXT:    kmovd %k2, %eax ;INTEL
; AVX512-NEXT:    kortestw %k1, %k0 ;INTEL
; AVX512-NEXT:    sete %dl
; AVX512-NEXT:    retq

...
!36 = !{!"intel.optreport.remark", !"Loop completely unrolled"}
...
!65 = !{!"intel.optreport.remark", !"Multiversioned loop"}
!66 = !{!"intel.optreport.remarks", !67, !68}
!67 = !{!"intel.optreport.remark", !"LOOP WAS VECTORIZED"}
!68 = !{!"intel.optreport.remark", !"vectorization support: vector length %s", !"8"}
...
!76 = !{!"intel.optreport.remark", !"Remainder loop for vectorization"}
!77 = !{!"intel.optreport.remarks", !78}
!78 = !{!"intel.optreport.remark", !"remainder loop was not vectorized: %s ", !""}
...
!83 = !{!"intel.optreport.remark", !"The loop has been multiversioned"}
...
!107 = !{!"intel.optreport.remark", !"LLorg: Loop has been completely unrolled"}
...
!120 = !{!"intel.optreport.remark", !"Loop has been unrolled by %d factor", i32 2}

...
; AVX1-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX1-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-NEXT:    vbroadcastsd 656(%rbp), %ymm2 ;INTEL
; AVX1-NEXT:    vmovapd %ymm13, %ymm3
; AVX1-NEXT:    vmulpd %ymm2, %ymm13, %ymm1 ;INTEL
; AVX1-NEXT:    vbroadcastsd 664(%rbp), %ymm0
; AVX1-NEXT:    vmulpd %ymm0, %ymm6, %ymm14
; AVX1-NEXT:    vmovapd %ymm6, %ymm10
; AVX1-NEXT:    vaddpd %ymm1, %ymm14, %ymm1 ;INTEL
; AVX1-NEXT:    vmulpd %ymm2, %ymm9, %ymm2 ;INTEL
; AVX1-NEXT:    vmulpd %ymm0, %ymm5, %ymm0
; AVX1-NEXT:    vmovapd %ymm5, %ymm6
; AVX1-NEXT:    vaddpd %ymm0, %ymm2, %ymm0 ;INTEL
; AVX1-NEXT:    vbroadcastsd 672(%rbp), %ymm2 ;INTEL
; AVX1-NEXT:    vmulpd %ymm2, %ymm12, %ymm14 ;INTEL
; AVX1-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX1-NEXT:    vmulpd %ymm2, %ymm15, %ymm2 ;INTEL
; AVX1-NEXT:    vaddpd %ymm2, %ymm1, %ymm1 ;INTEL
...
; AVX2-NEXT:    vaddpd %ymm1, %ymm0, %ymm0
; AVX2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vbroadcastsd 656(%rbp), %ymm2 ;INTEL
; AVX2-NEXT:    vmovapd %ymm13, %ymm3
; AVX2-NEXT:    vmulpd %ymm2, %ymm13, %ymm1 ;INTEL
; AVX2-NEXT:    vbroadcastsd 664(%rbp), %ymm0
; AVX2-NEXT:    vmulpd %ymm0, %ymm6, %ymm14
; AVX2-NEXT:    vmovapd %ymm6, %ymm10
; AVX2-NEXT:    vaddpd %ymm1, %ymm14, %ymm1 ;INTEL
; AVX2-NEXT:    vmulpd %ymm2, %ymm9, %ymm2 ;INTEL
; AVX2-NEXT:    vmulpd %ymm0, %ymm5, %ymm0
; AVX2-NEXT:    vmovapd %ymm5, %ymm6
; AVX2-NEXT:    vaddpd %ymm0, %ymm2, %ymm0 ;INTEL
; AVX2-NEXT:    vbroadcastsd 672(%rbp), %ymm2 ;INTEL
; AVX2-NEXT:    vmulpd %ymm2, %ymm12, %ymm14 ;INTEL
; AVX2-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX2-NEXT:    vmulpd %ymm2, %ymm15, %ymm2 ;INTEL
; AVX2-NEXT:    vaddpd %ymm2, %ymm1, %ymm1 ;INTEL

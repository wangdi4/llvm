...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = call fast <4 x double> @__svml_log4(<4 x double> %wide.load) #2
  %9 = call fast <4 x double> @__svml_log4(<4 x double> %wide.load19) #2
  %10 = call fast <4 x double> @__svml_log4(<4 x double> %wide.load20) #2
  %11 = call fast <4 x double> @__svml_log4(<4 x double> %wide.load21) #2
  %12 = fdiv <4 x double> %8, %9
  %13 = fsub <4 x double> %8, %wide.load
  %14 = fsub <4 x double> %13, %12
  %15 = call fast <4 x double> @__svml_exp4(<4 x double> %14) #2
  %16 = fsub <4 x double> %9, %wide.load19
  %17 = call fast <4 x double> @__svml_exp4(<4 x double> %16) #2
  %18 = fsub <4 x double> %10, %wide.load20
  %19 = call fast <4 x double> @__svml_exp4(<4 x double> %18) #2
  %20 = fsub <4 x double> %11, %wide.load21
  %21 = call fast <4 x double> @__svml_exp4(<4 x double> %20) #2
  %22 = fdiv <4 x double> %19, %21
  %23 = fsub <4 x double> %15, %22
  %24 = call fast <4 x double> @__svml_pow4(<4 x double> %8, <4 x double> %23) #2
  %25 = call fast <4 x double> @__svml_pow4(<4 x double> %9, <4 x double> %17) #2
  %26 = call fast <4 x double> @__svml_pow4(<4 x double> %8, <4 x double> %15) #2
  %27 = call fast <4 x double> @__svml_pow4(<4 x double> %11, <4 x double> %21) #2

...
; CHECK-X64-NEXT:    addl %esi, %edi ;INTEL
; CHECK-X64-NEXT:    addl %ecx, %edx
; CHECK-X64-NEXT:    addl %edi, %edx ;INTEL
; CHECK-X64-NEXT:    addl %r9d, %r8d ;INTEL
...
; CHECK-X86-NEXT:    movl 72048(%esp), %edx ;INTEL
; CHECK-X86-NEXT:    movl 72040(%esp), %ecx ;INTEL
; CHECK-X86-NEXT:    movl 72032(%esp), %esi
; CHECK-X86-NEXT:    addl 72036(%esp), %esi
; CHECK-X86-NEXT:    addl 72044(%esp), %ecx ;INTEL
; CHECK-X86-NEXT:    addl %esi, %ecx ;INTEL
; CHECK-X86-NEXT:    addl 72052(%esp), %edx ;INTEL
; CHECK-X86-NEXT:    addl 72060(%esp), %eax
; CHECK-X86-NEXT:    addl %edx, %eax
; CHECK-X86-NEXT:    addl %ecx, %eax ;INTEL
...
; CHECK-X32-NEXT:    addl %esi, %edi ;INTEL
; CHECK-X32-NEXT:    addl %ecx, %edx
; CHECK-X32-NEXT:    addl %edi, %edx ;INTEL
; CHECK-X32-NEXT:    addl %r9d, %r8d ;INTEL

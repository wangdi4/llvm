...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx,+fma -do-x86-global-fma=false | FileCheck %s --check-prefixes=AVX,FMA-RECIP ;INTEL
...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=haswell -do-x86-global-fma=false | FileCheck %s --check-prefixes=AVX,HASWELL ;INTEL
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=haswell -mattr=-fma | FileCheck %s --check-prefixes=AVX,HASWELL-NO-FMA
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=knl -do-x86-global-fma=false | FileCheck %s --check-prefixes=AVX,AVX512,KNL ;INTEL
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=skx -do-x86-global-fma=false | FileCheck %s --check-prefixes=AVX,AVX512,SKX ;INTEL

...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx,+fma -do-x86-global-fma=false | FileCheck %s --check-prefix=CHECK --check-prefix=AVX --check-prefix=FMA-RECIP ;INTEL
...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=haswell -do-x86-global-fma=false | FileCheck %s --check-prefix=CHECK --check-prefix=AVX --check-prefix=HASWELL ;INTEL
...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=knl -do-x86-global-fma=false | FileCheck %s --check-prefix=CHECK --check-prefix=AVX --check-prefix=AVX512 --check-prefix=KNL ;INTEL
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mcpu=skx -do-x86-global-fma=false | FileCheck %s --check-prefix=CHECK --check-prefix=AVX --check-prefix=AVX512 --check-prefix=SKX ;INTEL

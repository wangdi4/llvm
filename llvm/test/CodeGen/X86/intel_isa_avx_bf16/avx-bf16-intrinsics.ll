...
; RUN: llc < %s -mtriple=i686-unknown-unknown -mattr=+avxbf16 --show-mc-encoding | FileCheck %s --check-prefixes=CHECK,AVX-X86
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avxbf16 --show-mc-encoding | FileCheck %s --check-prefixes=CHECK,AVX-X64
; RUN: llc < %s -mtriple=i686-unknown-unknown -mattr=+avxbf16,+avx512vl,+avx512bf16 --show-mc-encoding | FileCheck %s --check-prefixes=CHECK,AVX512-X86
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avxbf16,,+avx512vl,+avx512bf16 --show-mc-encoding | FileCheck %s --check-prefixes=CHECK,AVX512-X64

...
; AVX1:       # %bb.0:
; AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm2
; AVX1-NEXT:    vpxor %xmm3, %xmm3, %xmm3 ;INTEL
; AVX1-NEXT:    vpcmpgtq %xmm2, %xmm3, %xmm2 ;INTEL
; AVX1-NEXT:    vpcmpgtq %xmm1, %xmm3, %xmm1 ;INTEL
; AVX1-NEXT:    vpackssdw %xmm2, %xmm1, %xmm1
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm2
; AVX1-NEXT:    vpcmpgtq %xmm2, %xmm3, %xmm2 ;INTEL
; AVX1-NEXT:    vpcmpgtq %xmm0, %xmm3, %xmm0 ;INTEL
; AVX1-NEXT:    vpackssdw %xmm2, %xmm0, %xmm0
...
;
; INTEL_CUSTOMIZATION
; AVX512-LABEL: allones_v32i8_and1:
; AVX512:       # %bb.0:
...
; AVX1OR2-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1 ;INTEL
; AVX1OR2-NEXT:    vtestps %xmm1, %xmm0 ;INTEL
; AVX1OR2-NEXT:    setb %al ;INTEL
; AVX1OR2-NEXT:    retq
;
...
; AVX1OR2:       # %bb.0:
; AVX1OR2-NEXT:    vpslld $31, %xmm0, %xmm0
; AVX1OR2-NEXT:    vtestps %xmm0, %xmm0 ;INTEL
; AVX1OR2-NEXT:    sete %al
; AVX1OR2-NEXT:    retq
;
...
; AVX1OR2-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1 ;INTEL
; AVX1OR2-NEXT:    vtestpd %xmm1, %xmm0 ;INTEL
; AVX1OR2-NEXT:    setb %al ;INTEL
; AVX1OR2-NEXT:    retq
;
...
; AVX1OR2:       # %bb.0:
; AVX1OR2-NEXT:    vpsllq $63, %xmm0, %xmm0
; AVX1OR2-NEXT:    vtestpd %xmm0, %xmm0 ;INTEL
; AVX1OR2-NEXT:    sete %al
; AVX1OR2-NEXT:    retq
;
...
;
; INTEL_CUSTOMIZATION
; AVX512-LABEL: allones_v32i8_and4:
; AVX512:       # %bb.0:
...
;
; INTEL_CUSTOMIZATION
; AVX-LABEL: movmsk_v16i8_var:
; AVX:       # %bb.0:
; AVX-NEXT:    vpcmpeqb %xmm1, %xmm0, %xmm0
; AVX-NEXT:    vpmovmskb %xmm0, %eax
; AVX-NEXT:    btl %edi, %eax
; AVX-NEXT:    setb %al
; AVX-NEXT:    retq
; end INTEL_CUSTOMIZATION
  %cmp = icmp eq <16 x i8> %x, %y
...
; AVX1OR2-NEXT:    cmovbl %ecx, %eax ;INTEL
; AVX1OR2-NEXT:    retq
;

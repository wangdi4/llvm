...
; RUN: llc < %s -mtriple=i686-unknown-unknown   -mattr=+sse,+sse2 -disable-iml-trans | FileCheck %s --check-prefix=X86 ;INTEL
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+sse,+sse2 -disable-iml-trans | FileCheck %s --check-prefix=X64 ;INTEL

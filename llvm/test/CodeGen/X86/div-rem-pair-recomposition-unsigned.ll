...
; INTEL_CUSTOMIZATION
; RUN: llc < %s -mtriple=i686-unknown-unknown   -mattr=+sse,+sse2 -disable-iml-trans | FileCheck %s --check-prefixes=ALL,X86
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+sse,+sse2 -disable-iml-trans | FileCheck %s --check-prefixes=ALL,X64

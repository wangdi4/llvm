...
; X32-NEXT:    subl {{[0-9]+}}(%esp), %ebx ;INTEL
; X32-NEXT:    movl {{[0-9]+}}(%esp), %edx ;INTEL
; X32-NEXT:    movl %edx, %ecx ;INTEL
; X32-NEXT:    subl {{[0-9]+}}(%esp), %ecx
; X32-NEXT:    imull %ebx, %ecx
; X32-NEXT:    addl %eax, %ecx ;INTEL
...
; WIN64-NEXT:    addl %r9d, %r11d ;INTEL
...
; WIN64-NEXT:    addl %r10d, %eax ;INTEL
...
; LINUXOSX64-NEXT:    addl %r11d, %eax ;INTEL
; LINUXOSX64-NEXT:    addl %r15d, %edx ;INTEL
; LINUXOSX64-NEXT:    imull %edi, %edx ;INTEL

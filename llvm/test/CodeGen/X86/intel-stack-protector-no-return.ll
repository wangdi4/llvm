; RUN: llc %s -O2 -mtriple=x86_64-unknown-linux-gnu -o - | FileCheck %s

; Source code:
; // icpx -O2 -fstack-protector-all -fomit-frame-pointer -Wno-array-bounds icpx_test.cpp
; void catches () {
;   try {
;     throw 1;
;   }
...
; void vuln(int op) {
;   void * buf[1];
;   buf[2] = (char *) catches + (size_t) 28;
;   buf[1] = (void *) 0xdeadbeef;
;   if (op == 1){
;     throw 1;
;   }
; }

...
; AVX1-ONLY:       # %bb.0:
; AVX1-ONLY-NEXT:    subq $56, %rsp ;INTEL
; AVX1-ONLY-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX1-ONLY-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm12[2,1,3,3,4,5,6,7] ;INTEL
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3 ;INTEL
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5]
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vandps %ymm3, %ymm9, %ymm3
; AVX1-ONLY-NEXT:    vorps %ymm1, %ymm3, %ymm8
; AVX1-ONLY-NEXT:    vmovdqa (%rsi), %xmm3
; AVX1-ONLY-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vmovdqa (%rdi), %xmm1
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3],xmm1[4],xmm3[4],xmm1[5],xmm3[5],xmm1[6],xmm3[6],xmm1[7],xmm3[7]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm10 = xmm3[1,1,1,1]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm10 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm10, %ymm4, %ymm13
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm15[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm4 = xmm4[0],zero,xmm4[1],zero
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm15[0,2,2,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm14 = xmm14[0],zero,xmm14[1],zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm14, %ymm4, %ymm14
; AVX1-ONLY-NEXT:    vbroadcastsd {{.*#+}} ymm6 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX1-ONLY-NEXT:    vandps %ymm6, %ymm13, %ymm13
; AVX1-ONLY-NEXT:    vandnps %ymm14, %ymm6, %ymm14
; AVX1-ONLY-NEXT:    vorps %ymm14, %ymm13, %ymm13
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm4 = ymm13[0],ymm8[1],ymm13[2],ymm8[3],ymm13[4],ymm8[5],ymm13[6],ymm8[7]
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm12, %ymm8, %ymm12
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm8 = xmm3[2,3,2,3]
...
; AVX1-ONLY-NEXT:    vandnps %ymm12, %ymm6, %ymm12
...
; AVX1-ONLY-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm2, %xmm2 # 16-byte Folded Reload
; AVX1-ONLY-NEXT:    # xmm2 = xmm2[8],mem[8],xmm2[9],mem[9],xmm2[10],mem[10],xmm2[11],mem[11],xmm2[12],mem[12],xmm2[13],mem[13],xmm2[14],mem[14],xmm2[15],mem[15]
; AVX1-ONLY-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm2[0,1,2,3,4,4,6,5]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm7[8],xmm5[8],xmm7[9],xmm5[9],xmm7[10],xmm5[10],xmm7[11],xmm5[11],xmm7[12],xmm5[12],xmm7[13],xmm5[13],xmm7[14],xmm5[14],xmm7[15],xmm5[15]
; AVX1-ONLY-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm3[0,1,2,3,4,5,5,7]
...
; AVX1-ONLY-NEXT:    vmovaps %ymm9, %ymm5
; AVX1-ONLY-NEXT:    vorps %ymm0, %ymm2, %ymm0
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm11[8],xmm10[8],xmm11[9],xmm10[9],xmm11[10],xmm10[10],xmm11[11],xmm10[11],xmm11[12],xmm10[12],xmm11[13],xmm10[13],xmm11[14],xmm10[14],xmm11[15],xmm10[15]
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm3[0,1,2,3,4,4,6,5] ;INTEL
...
; AVX1-ONLY-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm3 # 16-byte Folded Reload
; AVX1-ONLY-NEXT:    # xmm3 = xmm1[8],mem[8],xmm1[9],mem[9],xmm1[10],mem[10],xmm1[11],mem[11],xmm1[12],mem[12],xmm1[13],mem[13],xmm1[14],mem[14],xmm1[15],mem[15]
; AVX1-ONLY-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm11[0,1,2,3,4,4,6,5]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm11[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm7[0],xmm13[0],xmm7[1],xmm13[1],xmm7[2],xmm13[2],xmm7[3],xmm13[3],xmm7[4],xmm13[4],xmm7[5],xmm13[5],xmm7[6],xmm13[6],xmm7[7],xmm13[7]
; AVX1-ONLY-NEXT:    vmovdqa %xmm13, %xmm9
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm12[0,1,2,3,4,5,5,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm12[0,1,2,3,6,5,7,7]
...
; AVX1-ONLY-NEXT:    vorps %ymm0, %ymm1, %ymm5
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm10[0,1,2,3,4,4,6,5]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm10[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm0
; AVX1-ONLY-NEXT:    vmovdqa 16(%rsi), %xmm2
; AVX1-ONLY-NEXT:    vmovdqa 16(%rdi), %xmm1
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm1[0],xmm2[0],xmm1[1],xmm2[1],xmm1[2],xmm2[2],xmm1[3],xmm2[3],xmm1[4],xmm2[4],xmm1[5],xmm2[5],xmm1[6],xmm2[6],xmm1[7],xmm2[7]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm15 = ymm0[0],ymm5[1],ymm0[2],ymm5[3],ymm0[4],ymm5[5],ymm0[6],ymm5[7]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm0[8],xmm8[8],xmm0[9],xmm8[9],xmm0[10],xmm8[10],xmm0[11],xmm8[11],xmm0[12],xmm8[12],xmm0[13],xmm8[13],xmm0[14],xmm8[14],xmm0[15],xmm8[15]
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm5[0,1,2,3,4,5,5,7]
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm0[0,1,2,3,4,6,6,7]
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm2[8],xmm1[9],xmm2[9],xmm1[10],xmm2[10],xmm1[11],xmm2[11],xmm1[12],xmm2[12],xmm1[13],xmm2[13],xmm1[14],xmm2[14],xmm1[15],xmm2[15]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm1 = xmm2[2,3,2,3]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm4 = xmm2[3,3,3,3]
; end INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm7[1],ymm1[2],ymm7[3],ymm1[4],ymm7[5],ymm1[6],ymm7[7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm8[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm8[0,2,2,3,4,5,6,7]
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm5[0,1,1,3,4,5,6,7] ;INTEL
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm5[2,1,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5]
; AVX1-ONLY-NEXT:    vandnps %ymm3, %ymm9, %ymm3 ;INTEL
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[0,0,2,1,4,4,6,5]
; AVX1-ONLY-NEXT:    vandps %ymm4, %ymm9, %ymm4 ;INTEL
; AVX1-ONLY-NEXT:    vorps %ymm3, %ymm4, %ymm3
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[1,1,1,1]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm4, %ymm2
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm4 = xmm4[0],zero,xmm4[1],zero
...
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm11[0,0,2,1,4,5,6,7]
...
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm4 = xmm14[1,1,1,1]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0],ymm2[1],ymm3[2],ymm2[3],ymm3[4],ymm2[5],ymm3[6],ymm2[7]
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm4[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm4[0,2,2,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm5[0,1,1,3,4,5,6,7] ;INTEL
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm5[2,1,3,3,4,5,6,7] ;INTEL
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5] ;INTEL
; AVX1-ONLY-NEXT:    vandnps %ymm3, %ymm9, %ymm3 ;INTEL
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[0,0,2,1,4,4,6,5]
; AVX1-ONLY-NEXT:    vandps %ymm4, %ymm9, %ymm4 ;INTEL
; AVX1-ONLY-NEXT:    vorps %ymm3, %ymm4, %ymm3 ;INTEL
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX1-ONLY-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload ;INTEL
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm7[0,0,2,1,4,5,6,7] ;INTEL
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm5 = xmm5[0],zero,xmm5[1],zero
; INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload ;INTEL
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 32(%rax)
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, (%rax)
; AVX1-ONLY-NEXT:    addq $56, %rsp ;INTEL
; AVX1-ONLY-NEXT:    vzeroupper
; AVX1-ONLY-NEXT:    retq
;
...
; AVX1-ONLY:       # %bb.0:
; AVX1-ONLY-NEXT:    subq $328, %rsp # imm = 0x148 ;INTEL
; AVX1-ONLY-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX1-ONLY-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX1-ONLY-NEXT:    vmovdqa (%r10), %xmm1 ;INTEL
; AVX1-ONLY-NEXT:    vmovdqa %xmm1, (%rsp) # 16-byte Spill ;INTEL
; AVX1-ONLY-NEXT:    vmovdqa (%rax), %xmm0 ;INTEL
; AVX1-ONLY-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,2,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vbroadcastsd {{.*#+}} ymm9 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX1-ONLY-NEXT:    vandnps %ymm1, %ymm9, %ymm2
...
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3],xmm1[4],xmm3[4],xmm1[5],xmm3[5],xmm1[6],xmm3[6],xmm1[7],xmm3[7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm1[0,1,2,3,4,5,5,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm1[0,1,2,3,6,5,7,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
...
; AVX1-ONLY-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm2[0],xmm4[0],xmm2[1],xmm4[1],xmm2[2],xmm4[2],xmm2[3],xmm4[3],xmm2[4],xmm4[4],xmm2[5],xmm4[5],xmm2[6],xmm4[6],xmm2[7],xmm4[7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm2[0,1,2,3,4,4,6,5]
...
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm5[0],xmm6[0],xmm5[1],xmm6[1],xmm5[2],xmm6[2],xmm5[3],xmm6[3],xmm5[4],xmm6[4],xmm5[5],xmm6[5],xmm5[6],xmm6[6],xmm5[7],xmm6[7]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm6 = xmm5[2,3,2,3]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm7 = xmm5[3,3,3,3]
; end INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vbroadcastsd {{.*#+}} ymm14 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
...
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm3, %ymm3
; end INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm4 = xmm4[0],zero,xmm4[1],zero
...
; AVX1-ONLY-NEXT:    vmovdqa 48(%r9), %xmm12
; AVX1-ONLY-NEXT:    vmovdqa 48(%r8), %xmm3
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm3[8],xmm12[8],xmm3[9],xmm12[9],xmm3[10],xmm12[10],xmm3[11],xmm12[11],xmm3[12],xmm12[12],xmm3[13],xmm12[13],xmm3[14],xmm12[14],xmm3[15],xmm12[15]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm8[0,1,1,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm8[2,1,3,3,4,5,6,7]
...
; AVX1-ONLY-NEXT:    vandps %ymm5, %ymm9, %ymm5
; AVX1-ONLY-NEXT:    vorps %ymm4, %ymm5, %ymm9
; AVX1-ONLY-NEXT:    vmovdqa 48(%rsi), %xmm4
; AVX1-ONLY-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm6[8],xmm4[8],xmm6[9],xmm4[9],xmm6[10],xmm4[10],xmm6[11],xmm4[11],xmm6[12],xmm4[12],xmm6[13],xmm4[13],xmm6[14],xmm4[14],xmm6[15],xmm4[15]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm5 = xmm10[1,1,1,1]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm7, %ymm0
; AVX1-ONLY-NEXT:    vmovdqa 48(%rcx), %xmm5
; AVX1-ONLY-NEXT:    vmovdqa 48(%rdx), %xmm7
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm15 = xmm7[8],xmm5[8],xmm7[9],xmm5[9],xmm7[10],xmm5[10],xmm7[11],xmm5[11],xmm7[12],xmm5[12],xmm7[13],xmm5[13],xmm7[14],xmm5[14],xmm7[15],xmm5[15]
; end INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vandps %ymm0, %ymm14, %ymm13
; AVX1-ONLY-NEXT:    vandnps %ymm1, %ymm14, %ymm1
; AVX1-ONLY-NEXT:    vorps %ymm1, %ymm13, %ymm1
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm9[1],ymm1[2],ymm9[3],ymm1[4],ymm9[5],ymm1[6],ymm9[7]
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm11[0,1,2,3,4,4,6,5]
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm11[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm9, %ymm1, %ymm1
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,5,5,7]
...
; AVX1-ONLY-NEXT:    vandps %ymm14, %ymm9, %ymm9
; AVX1-ONLY-NEXT:    vorps %ymm8, %ymm9, %ymm8
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm1 = ymm8[0],ymm1[1],ymm8[2],ymm1[3],ymm8[4],ymm1[5],ymm8[6],ymm1[7]
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm2, %xmm1 # 16-byte Folded Reload
; AVX1-ONLY-NEXT:    # xmm1 = xmm2[0],mem[0],xmm2[1],mem[1],xmm2[2],mem[2],xmm2[3],mem[3],xmm2[4],mem[4],xmm2[5],mem[5],xmm2[6],mem[6],xmm2[7],mem[7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm1[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm1[0,2,2,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm8, %ymm2, %ymm8
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm3[0],xmm12[0],xmm3[1],xmm12[1],xmm3[2],xmm12[2],xmm3[3],xmm12[3],xmm3[4],xmm12[4],xmm3[5],xmm12[5],xmm3[6],xmm12[6],xmm3[7],xmm12[7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm2[0,1,1,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[2,1,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm8[0,0,2,1,4,4,6,5]
; AVX1-ONLY-NEXT:    vmovaps %ymm11, %ymm12
; AVX1-ONLY-NEXT:    vandnps %ymm3, %ymm11, %ymm3
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,0,2,1,4,4,6,5]
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vandps %ymm0, %ymm11, %ymm0
; AVX1-ONLY-NEXT:    vorps %ymm3, %ymm0, %ymm3
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm6[0],xmm4[0],xmm6[1],xmm4[1],xmm6[2],xmm4[2],xmm6[3],xmm4[3],xmm6[4],xmm4[4],xmm6[5],xmm4[5],xmm6[6],xmm4[6],xmm6[7],xmm4[7]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm4 = xmm0[1,1,1,1]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm6, %ymm4
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm7[0],xmm5[0],xmm7[1],xmm5[1],xmm7[2],xmm5[2],xmm7[3],xmm5[3],xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm5[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm2, %ymm2
...
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vmovdqa 32(%r10), %xmm1 ;INTEL
; AVX1-ONLY-NEXT:    vmovdqa 32(%rax), %xmm2 ;INTEL
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm11 = xmm2[8],xmm1[8],xmm2[9],xmm1[9],xmm2[10],xmm1[10],xmm2[11],xmm1[11],xmm2[12],xmm1[12],xmm2[13],xmm1[13],xmm2[14],xmm1[14],xmm2[15],xmm1[15] ;INTEL
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm11[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm11[0,2,2,3,4,5,6,7]
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm0, %ymm4
...
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm3[8],xmm0[8],xmm3[9],xmm0[9],xmm3[10],xmm0[10],xmm3[11],xmm0[11],xmm3[12],xmm0[12],xmm3[13],xmm0[13],xmm3[14],xmm0[14],xmm3[15],xmm0[15]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm8[0,1,1,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm8[2,1,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm6, %ymm5, %ymm5
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[0,0,2,1,4,4,6,5]
...
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm7, %ymm13
; AVX1-ONLY-NEXT:    vmovdqa 32(%rcx), %xmm5
; AVX1-ONLY-NEXT:    vmovdqa 32(%rdx), %xmm7
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm7[8],xmm5[8],xmm7[9],xmm5[9],xmm7[10],xmm5[10],xmm7[11],xmm5[11],xmm7[12],xmm5[12],xmm7[13],xmm5[13],xmm7[14],xmm5[14],xmm7[15],xmm5[15]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm14[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm15[0],zero,xmm15[1],zero
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm14[0,2,2,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm12 = xmm12[0],zero,xmm12[1],zero
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm12, %ymm15, %ymm12
; AVX1-ONLY-NEXT:    vbroadcastsd {{.*#+}} ymm15 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX1-ONLY-NEXT:    vandps %ymm15, %ymm13, %ymm13
; AVX1-ONLY-NEXT:    vandnps %ymm12, %ymm15, %ymm12
; AVX1-ONLY-NEXT:    vorps %ymm12, %ymm13, %ymm12
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm9 = ymm12[0],ymm9[1],ymm12[2],ymm9[3],ymm12[4],ymm9[5],ymm12[6],ymm9[7]
; AVX1-ONLY-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm11[0,1,2,3,4,4,6,5]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm11, %ymm9, %ymm9
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm8[0,1,2,3,4,5,5,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,6,5,7,7]
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm14[0,1,2,3,4,4,6,5]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm14[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm11, %ymm9, %ymm9
; end INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0],ymm8[1],ymm9[2],ymm8[3],ymm9[4],ymm8[5],ymm9[6],ymm8[7]
...
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm1[0,2,2,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm8, %ymm2, %ymm8
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm3[0],xmm0[0],xmm3[1],xmm0[1],xmm3[2],xmm0[2],xmm3[3],xmm0[3],xmm3[4],xmm0[4],xmm3[5],xmm0[5],xmm3[6],xmm0[6],xmm3[7],xmm0[7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm2[0,1,1,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[2,1,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm3, %ymm0, %ymm0
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm8[0,0,2,1,4,4,6,5]
...
; AVX1-ONLY-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vmovdqa 16(%r10), %xmm9
; AVX1-ONLY-NEXT:    vmovdqa 16(%rax), %xmm6
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm6[8],xmm9[8],xmm6[9],xmm9[9],xmm6[10],xmm9[10],xmm6[11],xmm9[11],xmm6[12],xmm9[12],xmm6[13],xmm9[13],xmm6[14],xmm9[14],xmm6[15],xmm9[15]
...
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[2,1,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[0,0,2,1,4,4,6,5]
...
; AVX1-ONLY-NEXT:    vorps %ymm2, %ymm3, %ymm11
...
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm4, %ymm12
; AVX1-ONLY-NEXT:    vmovdqa 16(%rcx), %xmm4
; AVX1-ONLY-NEXT:    vmovdqa 16(%rdx), %xmm2
; AVX1-ONLY-NEXT:    vpunpckhbw {{.*#+}} xmm13 = xmm2[8],xmm4[8],xmm2[9],xmm4[9],xmm2[10],xmm4[10],xmm2[11],xmm4[11],xmm2[12],xmm4[12],xmm2[13],xmm4[13],xmm2[14],xmm4[14],xmm2[15],xmm4[15]
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm13[0,0,2,1,4,5,6,7]
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm15[0],zero,xmm15[1],zero
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm13[0,2,2,3,4,5,6,7]
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpmovzxdq {{.*#+}} xmm14 = xmm14[0],zero,xmm14[1],zero
; INTEL_CUSTOMIZATION
...
; AVX1-ONLY-NEXT:    vorps %ymm14, %ymm12, %ymm12
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm11 = ymm12[0],ymm11[1],ymm12[2],ymm11[3],ymm12[4],ymm11[5],ymm12[6],ymm11[7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm1[0,1,2,3,4,4,6,5]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm1, %ymm12, %ymm1
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm0[0,1,2,3,4,5,5,7]
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm13[0,1,2,3,4,4,6,5]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm13[0,1,2,3,4,6,6,7]
...
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm10 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm6[0],xmm9[0],xmm6[1],xmm9[1],xmm6[2],xmm9[2],xmm6[3],xmm9[3],xmm6[4],xmm9[4],xmm6[5],xmm9[5],xmm6[6],xmm9[6],xmm6[7],xmm9[7]
...
; AVX1-ONLY-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm7[2,1,3,3,4,5,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm8, %ymm1, %ymm1
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[0,0,2,1,4,4,6,5]
; AVX1-ONLY-NEXT:    vandnps %ymm0, %ymm14, %ymm0 ;INTEL
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX1-ONLY-NEXT:    vandps %ymm1, %ymm14, %ymm1 ;INTEL
; AVX1-ONLY-NEXT:    vorps %ymm0, %ymm1, %ymm1
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm3[0],xmm5[0],xmm3[1],xmm5[1],xmm3[2],xmm5[2],xmm3[3],xmm5[3],xmm3[4],xmm5[4],xmm3[5],xmm5[5],xmm3[6],xmm5[6],xmm3[7],xmm5[7]
...
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm6[0,1,2,3,4,6,6,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm7[0,1,2,3,4,5,5,7]
; AVX1-ONLY-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm7[0,1,2,3,6,5,7,7]
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,2,2,3,4,6,6,7]
...
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vpunpckhbw (%rsp), %xmm2, %xmm3 # 16-byte Folded Reload
; AVX1-ONLY-NEXT:    # xmm3 = xmm2[8],mem[8],xmm2[9],mem[9],xmm2[10],mem[10],xmm2[11],mem[11],xmm2[12],mem[12],xmm2[13],mem[13],xmm2[14],mem[14],xmm2[15],mem[15]
...
; AVX1-ONLY-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm2, %xmm2 # 16-byte Folded Reload
; AVX1-ONLY-NEXT:    # xmm2 = xmm2[8],mem[8],xmm2[9],mem[9],xmm2[10],mem[10],xmm2[11],mem[11],xmm2[12],mem[12],xmm2[13],mem[13],xmm2[14],mem[14],xmm2[15],mem[15]
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm6 = xmm2[1,1,1,1]
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
...
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm6 = xmm2[2,3,2,3] ;INTEL
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX1-ONLY-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[3,3,3,3] ;INTEL
; AVX1-ONLY-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero ;INTEL
; AVX1-ONLY-NEXT:    vinsertf128 $1, %xmm2, %ymm6, %ymm2 ;INTEL
; AVX1-ONLY-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[2,1,3,3,6,5,7,7]
; INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    vandnps %ymm4, %ymm15, %ymm4
; AVX1-ONLY-NEXT:    vandps %ymm2, %ymm15, %ymm2
; AVX1-ONLY-NEXT:    vorps %ymm4, %ymm2, %ymm2
; AVX1-ONLY-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm3[1],ymm2[2],ymm3[3],ymm2[4],ymm3[5],ymm2[6],ymm3[7]
; end INTEL_CUSTOMIZATION
; AVX1-ONLY-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX1-ONLY-NEXT:    vmovaps %ymm2, 96(%rax) ;INTEL
; AVX1-ONLY-NEXT:    vmovaps %ymm5, 64(%rax) ;INTEL
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 160(%rax) ;INTEL
; AVX1-ONLY-NEXT:    vmovaps %ymm1, 128(%rax)
; AVX1-ONLY-NEXT:    vmovaps %ymm10, 224(%rax)
; AVX1-ONLY-NEXT:    vmovaps %ymm11, 192(%rax) ;INTEL
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX1-ONLY-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX1-ONLY-NEXT:    vmovaps %ymm0, 32(%rax)
; AVX1-ONLY-NEXT:    addq $328, %rsp # imm = 0x148 ;INTEL
; AVX1-ONLY-NEXT:    vzeroupper
; AVX1-ONLY-NEXT:    retq
;
...
; AVX512F-SLOW:       # %bb.0:
; AVX512F-SLOW-NEXT:    subq $920, %rsp # imm = 0x398 ;INTEL
; AVX512F-SLOW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512F-SLOW-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; INTEL_CUSTOMIZATION
...
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm1[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm2, %ymm2
...
; AVX512F-SLOW-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512F-SLOW-NEXT:    vmovdqa 48(%r10), %xmm5
; AVX512F-SLOW-NEXT:    vmovdqa (%rax), %xmm1
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 48(%rax), %xmm7
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm2[8],xmm1[9],xmm2[9],xmm1[10],xmm2[10],xmm1[11],xmm2[11],xmm1[12],xmm2[12],xmm1[13],xmm2[13],xmm1[14],xmm2[14],xmm1[15],xmm2[15]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm1[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm1[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm8, %ymm2, %ymm2
; AVX512F-SLOW-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm1[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm2, %ymm1
...
; AVX512F-SLOW-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512F-SLOW-NEXT:    vmovdqa 48(%r9), %xmm8
; AVX512F-SLOW-NEXT:    vmovdqa (%r8), %xmm1
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 48(%r8), %xmm9
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm2[8],xmm1[9],xmm2[9],xmm1[10],xmm2[10],xmm1[11],xmm2[11],xmm1[12],xmm2[12],xmm1[13],xmm2[13],xmm1[14],xmm2[14],xmm1[15],xmm2[15]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm1[0,1,1,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm1[2,1,3,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm10, %ymm2, %ymm2
; AVX512F-SLOW-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm1[0,1,2,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm2, %ymm10
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3],xmm4[4],xmm3[4],xmm4[5],xmm3[5],xmm4[6],xmm3[6],xmm4[7],xmm3[7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm1[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm1[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm11, %ymm2, %ymm2
; AVX512F-SLOW-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm1[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm2, %ymm1
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm7[0],xmm5[0],xmm7[1],xmm5[1],xmm7[2],xmm5[2],xmm7[3],xmm5[3],xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7] ;INTEL
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm1[0,0,2,1,4,5,6,7] ;INTEL
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm1[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm12, %ymm2, %ymm2 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill ;INTEL
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm1[0,1,2,3,4,4,6,5] ;INTEL
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm2, %ymm1
; AVX512F-SLOW-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3],xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm1[0,1,1,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm1[2,1,3,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm12, %ymm2, %ymm2
; AVX512F-SLOW-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rdx), %xmm2
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm1[0,1,2,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm12, %ymm1
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 32(%r10), %xmm1
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm4[8],xmm3[8],xmm4[9],xmm3[9],xmm4[10],xmm3[10],xmm4[11],xmm3[11],xmm4[12],xmm3[12],xmm4[13],xmm3[13],xmm4[14],xmm3[14],xmm4[15],xmm3[15]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm4[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm4[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm12, %ymm3, %ymm3
; AVX512F-SLOW-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rax), %xmm3
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm4[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm4, %ymm12, %ymm27
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm7[8],xmm5[8],xmm7[9],xmm5[9],xmm7[10],xmm5[10],xmm7[11],xmm5[11],xmm7[12],xmm5[12],xmm7[13],xmm5[13],xmm7[14],xmm5[14],xmm7[15],xmm5[15]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,0,2,1,4,5,6,7]
...
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm4[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm5, %ymm4
; AVX512F-SLOW-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm9[8],xmm8[8],xmm9[9],xmm8[9],xmm9[10],xmm8[10],xmm9[11],xmm8[11],xmm9[12],xmm8[12],xmm9[13],xmm8[13],xmm9[14],xmm8[14],xmm9[15],xmm8[15]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,1,1,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm4[2,1,3,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm5
; AVX512F-SLOW-NEXT:    vmovdqu %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm4[0,1,2,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm4, %ymm5, %ymm4
; AVX512F-SLOW-NEXT:    vmovdqu %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm2[0],xmm0[0],xmm2[1],xmm0[1],xmm2[2],xmm0[2],xmm2[3],xmm0[3],xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm4[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm5
; AVX512F-SLOW-NEXT:    vmovdqu %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm4[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm4, %ymm5, %ymm22
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3],xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm4[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm7, %ymm5, %ymm30
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm4[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm4, %ymm5, %ymm29
; AVX512F-SLOW-NEXT:    vmovdqa 32(%r9), %xmm4
; AVX512F-SLOW-NEXT:    vmovdqa 32(%r8), %xmm5
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm7 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm7[0,1,1,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm7[2,1,3,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm9, %ymm8, %ymm28
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm7[0,1,2,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm7, %ymm8, %ymm26
; end INTEL_CUSTOMIZATION
...
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm3[8],xmm1[8],xmm3[9],xmm1[9],xmm3[10],xmm1[10],xmm3[11],xmm1[11],xmm3[12],xmm1[12],xmm3[13],xmm1[13],xmm3[14],xmm1[14],xmm3[15],xmm1[15]
; end INTEL_CUSTOMIZATION
...
; AVX512F-SLOW-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15] ;INTEL
...
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,2,2,3,4,5,6,7] ;INTEL
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm0, %ymm1, %ymm0
...
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3],xmm2[4],xmm1[4],xmm2[5],xmm1[5],xmm2[6],xmm1[6],xmm2[7],xmm1[7]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm2, %xmm21 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm1, %xmm24 ;INTEL
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,2,2,3,4,5,6,7] ;INTEL
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX512F-SLOW-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 16(%r9), %xmm1
; AVX512F-SLOW-NEXT:    vmovdqa 16(%r8), %xmm2
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3],xmm2[4],xmm1[4],xmm2[5],xmm1[5],xmm2[6],xmm1[6],xmm2[7],xmm1[7]
...
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vmovdqa (%rsi), %xmm0 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa (%rdi), %xmm2
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm2[8],xmm0[8],xmm2[9],xmm0[9],xmm2[10],xmm0[10],xmm2[11],xmm0[11],xmm2[12],xmm0[12],xmm2[13],xmm0[13],xmm2[14],xmm0[14],xmm2[15],xmm0[15]
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm2, %xmm31
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm9 = xmm0[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm1 = xmm0[3,3,3,3]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,1,1,1]
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 48(%rsi), %xmm3
...
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm4[8],xmm3[8],xmm4[9],xmm3[9],xmm4[10],xmm3[10],xmm4[11],xmm3[11],xmm4[12],xmm3[12],xmm4[13],xmm3[13],xmm4[14],xmm3[14],xmm4[15],xmm3[15]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm4 = xmm5[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm6 = xmm5[3,3,3,3]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[1,1,1,1]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm11 = xmm3[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm12 = xmm3[3,3,3,3]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm13 = xmm3[1,1,1,1]
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rsi), %xmm8
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rdi), %xmm3
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm3[0],xmm8[0],xmm3[1],xmm8[1],xmm3[2],xmm8[2],xmm3[3],xmm8[3],xmm3[4],xmm8[4],xmm3[5],xmm8[5],xmm3[6],xmm8[6],xmm3[7],xmm8[7]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm16 = xmm15[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm17 = xmm15[3,3,3,3]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm18 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm15 = xmm15[1,1,1,1]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm9 = xmm9[0],zero,zero,zero,xmm9[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm1, %ymm9, %ymm1
; end INTEL_CUSTOMIZATION
...
; AVX512F-SLOW-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm2 = mem[2,1,3,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm1
; AVX512F-SLOW-NEXT:    vpbroadcastq {{.*#+}} zmm9 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm0, %zmm9, %zmm1
...
; AVX512F-SLOW-NEXT:    vpbroadcastq {{.*#+}} zmm10 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX512F-SLOW-NEXT:    vpandnq %zmm0, %zmm10, %zmm0
; AVX512F-SLOW-NEXT:    vpandq %zmm10, %zmm2, %zmm2
; AVX512F-SLOW-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512F-SLOW-NEXT:    kmovw %eax, %k1
; AVX512F-SLOW-NEXT:    vpord %zmm0, %zmm2, %zmm1 {%k1}
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm0
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm7, %ymm2
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm2, %zmm4
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm0, %zmm9, %zmm4
; AVX512F-SLOW-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm0 = mem[0,0,2,1,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm2 = mem[0,2,2,3,4,6,6,7]
...
; AVX512F-SLOW-NEXT:    vpandnq %zmm0, %zmm10, %zmm0
; AVX512F-SLOW-NEXT:    vpandq %zmm10, %zmm2, %zmm2
; AVX512F-SLOW-NEXT:    vpord %zmm0, %zmm2, %zmm4 {%k1}
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm0
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm14, %ymm2
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm0
; AVX512F-SLOW-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm2 = mem[0,1,1,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm27[2,1,3,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm5, %zmm2, %zmm27
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm0, %zmm9, %zmm27
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm0 = mem[0,0,2,1,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm2 = mem[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm0
; AVX512F-SLOW-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload ;INTEL
; AVX512F-SLOW-NEXT:    # ymm2 = mem[0,0,2,1,4,4,6,5]
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm5 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm5 = mem[0,2,2,3,4,6,6,7]
...
; AVX512F-SLOW-NEXT:    vpandnq %zmm0, %zmm10, %zmm0
; AVX512F-SLOW-NEXT:    vpandq %zmm10, %zmm2, %zmm2
; AVX512F-SLOW-NEXT:    vpord %zmm0, %zmm2, %zmm27 {%k1}
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm16[0],zero,zero,zero,xmm16[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm17[0],zero,zero,zero,xmm17[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm2, %ymm0, %ymm0
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm2, %ymm18, %ymm2
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm0
; AVX512F-SLOW-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm2 = mem[0,1,1,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm22[2,1,3,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm5, %zmm2, %zmm22
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm0, %zmm9, %zmm22
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm30[0,0,2,1,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm2 = ymm29[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm0
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm2 = ymm28[0,0,2,1,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm26[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm5, %zmm2, %zmm2
; AVX512F-SLOW-NEXT:    vpandnq %zmm0, %zmm10, %zmm0
; AVX512F-SLOW-NEXT:    vpandq %zmm10, %zmm2, %zmm2
; AVX512F-SLOW-NEXT:    vpord %zmm0, %zmm2, %zmm22 {%k1}
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm3[8],xmm8[8],xmm3[9],xmm8[9],xmm3[10],xmm8[10],xmm3[11],xmm8[11],xmm3[12],xmm8[12],xmm3[13],xmm8[13],xmm3[14],xmm8[14],xmm3[15],xmm8[15]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm0 = xmm14[2,3,2,3]
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm2 = xmm14[3,3,3,3] ;INTEL
...
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm5, %ymm3, %ymm3
; AVX512F-SLOW-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm0, %ymm3, %ymm23
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm21, %xmm0
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm24, %xmm3
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm0[8],xmm3[8],xmm0[9],xmm3[9],xmm0[10],xmm3[10],xmm0[11],xmm3[11],xmm0[12],xmm3[12],xmm0[13],xmm3[13],xmm0[14],xmm3[14],xmm0[15],xmm3[15]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm0[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm0[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm7, %ymm6, %ymm8
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm0[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm0, %ymm6, %ymm7
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm19, %xmm0
; AVX512F-SLOW-NEXT:    vmovdqa64 %xmm20, %xmm3
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm0[8],xmm3[8],xmm0[9],xmm3[9],xmm0[10],xmm3[10],xmm0[11],xmm3[11],xmm0[12],xmm3[12],xmm0[13],xmm3[13],xmm0[14],xmm3[14],xmm0[15],xmm3[15]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm6[0,1,1,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm6[2,1,3,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm11, %ymm0, %ymm0
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm6[0,1,2,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm6[0,1,2,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm6, %ymm11, %ymm6
; AVX512F-SLOW-NEXT:    vmovdqa (%rsp), %xmm5 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm5, %xmm11 # 16-byte Folded Reload
; AVX512F-SLOW-NEXT:    # xmm11 = xmm5[0],mem[0],xmm5[1],mem[1],xmm5[2],mem[2],xmm5[3],mem[3],xmm5[4],mem[4],xmm5[5],mem[5],xmm5[6],mem[6],xmm5[7],mem[7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm11[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm11[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm13, %ymm12, %ymm16
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm11[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm11, %ymm12, %ymm17
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm5, %xmm11 # 16-byte Folded Reload
; AVX512F-SLOW-NEXT:    # xmm11 = xmm5[0],mem[0],xmm5[1],mem[1],xmm5[2],mem[2],xmm5[3],mem[3],xmm5[4],mem[4],xmm5[5],mem[5],xmm5[6],mem[6],xmm5[7],mem[7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm11[0,0,2,1,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm11[0,2,2,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm13, %ymm12, %ymm18
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm11[0,1,2,3,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm11, %ymm12, %ymm19
; AVX512F-SLOW-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; AVX512F-SLOW-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm5, %xmm11 # 16-byte Folded Reload
; AVX512F-SLOW-NEXT:    # xmm11 = xmm5[0],mem[0],xmm5[1],mem[1],xmm5[2],mem[2],xmm5[3],mem[3],xmm5[4],mem[4],xmm5[5],mem[5],xmm5[6],mem[6],xmm5[7],mem[7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm11[0,1,1,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm11[2,1,3,3,4,5,6,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm13, %ymm12, %ymm20
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm11[0,1,2,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm11, %ymm12, %ymm21
; AVX512F-SLOW-NEXT:    vmovdqa 16(%rsi), %xmm11
; AVX512F-SLOW-NEXT:    vmovdqa 16(%rdi), %xmm12
; AVX512F-SLOW-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3],xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX512F-SLOW-NEXT:    vpunpckhbw {{.*#+}} xmm11 = xmm12[8],xmm11[8],xmm12[9],xmm11[9],xmm12[10],xmm11[10],xmm12[11],xmm11[11],xmm12[12],xmm11[12],xmm12[13],xmm11[13],xmm12[14],xmm11[14],xmm12[15],xmm11[15]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
...
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm14, %ymm12, %ymm12
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm2, %zmm12, %zmm12
; AVX512F-SLOW-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm2 = mem[0,1,1,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm14 = mem[2,1,3,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm14, %zmm2, %zmm2
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm12, %zmm9, %zmm2
; AVX512F-SLOW-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm12 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm12 = mem[0,0,2,1,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm14 = mem[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm14, %zmm12, %zmm12
; AVX512F-SLOW-NEXT:    vpandnq %zmm12, %zmm10, %zmm12
; AVX512F-SLOW-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm14 = mem[0,0,2,1,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm15 = mem[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm15, %zmm14, %zmm14
; AVX512F-SLOW-NEXT:    vpandq %zmm10, %zmm14, %zmm14
; AVX512F-SLOW-NEXT:    vpord %zmm12, %zmm14, %zmm2 {%k1}
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm12 = xmm13[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm14 = xmm13[3,3,3,3]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm13 = xmm13[1,1,1,1]
...
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm13, %ymm15, %ymm13
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm14 = xmm11[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm15 = xmm11[3,3,3,3]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm24 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm25 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm25 = mem[2,1,3,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm25, %zmm13, %zmm13
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm12, %zmm9, %zmm13
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm12 = xmm5[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm25 = xmm5[3,3,3,3]
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm26 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[1,1,1,1]
...
; AVX512F-SLOW-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm29 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm29 = mem[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm29, %zmm30, %zmm29
; AVX512F-SLOW-NEXT:    vpandnq %zmm28, %zmm10, %zmm28
; AVX512F-SLOW-NEXT:    vpandq %zmm10, %zmm29, %zmm29
; AVX512F-SLOW-NEXT:    vpord %zmm28, %zmm29, %zmm13 {%k1}
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti128 $1, %xmm15, %ymm14, %ymm14
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm11 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm11, %ymm24, %ymm11
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm14, %zmm11, %zmm11
; AVX512F-SLOW-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm14 = mem[0,1,1,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm3 = ymm23[2,1,3,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm3, %zmm14, %zmm3
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm11, %zmm9, %zmm3
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm6 = ymm6[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm0
; AVX512F-SLOW-NEXT:    vpandnq %zmm7, %zmm10, %zmm6
; AVX512F-SLOW-NEXT:    vpandq %zmm10, %zmm0, %zmm0
; AVX512F-SLOW-NEXT:    vpord %zmm6, %zmm0, %zmm3 {%k1}
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX512F-SLOW-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm25[0],zero,zero,zero,xmm25[1],zero,zero,zero
...
; AVX512F-SLOW-NEXT:    vinserti32x4 $1, %xmm5, %ymm26, %ymm5
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm0, %zmm5, %zmm0
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm16[0,1,1,3,4,5,5,7]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm6 = ymm17[2,1,3,3,6,5,7,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm6, %zmm5, %zmm5
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm0, %zmm9, %zmm5
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm18[0,0,2,1,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm6 = ymm19[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm0
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm6 = ymm20[0,0,2,1,4,4,6,5]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm7 = ymm21[0,2,2,3,4,6,6,7]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm7, %zmm6, %zmm6
; AVX512F-SLOW-NEXT:    vpandnq %zmm0, %zmm10, %zmm0
; AVX512F-SLOW-NEXT:    vpandq %zmm10, %zmm6, %zmm6
; AVX512F-SLOW-NEXT:    vpord %zmm0, %zmm6, %zmm5 {%k1}
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm5, (%rax) ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm3, 192(%rax) ;INTEL
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm27, 448(%rax)
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm4, 384(%rax)
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm1, 64(%rax)
; AVX512F-SLOW-NEXT:    addq $920, %rsp # imm = 0x398
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vzeroupper
; AVX512F-SLOW-NEXT:    retq
;
...
; AVX512F-FAST:       # %bb.0:
; AVX512F-FAST-NEXT:    subq $616, %rsp # imm = 0x268 ;INTEL
; AVX512F-FAST-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512F-FAST-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX512F-FAST-NEXT:    vmovdqa (%rcx), %xmm3 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa 48(%rcx), %xmm0
; AVX512F-FAST-NEXT:    vmovdqa (%rdx), %xmm2 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa 48(%rdx), %xmm1
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm3[8],xmm2[9],xmm3[9],xmm2[10],xmm3[10],xmm2[11],xmm3[11],xmm2[12],xmm3[12],xmm2[13],xmm3[13],xmm2[14],xmm3[14],xmm2[15],xmm3[15] ;INTEL
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm4 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
; AVX512F-FAST-NEXT:    vpshufb %ymm4, %ymm2, %ymm3
; AVX512F-FAST-NEXT:    vmovdqa %ymm4, %ymm8
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm4 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
...
; AVX512F-FAST-NEXT:    vmovdqa (%r10), %xmm3 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa (%rax), %xmm2 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm3[8],xmm2[9],xmm3[9],xmm2[10],xmm3[10],xmm2[11],xmm3[11],xmm2[12],xmm3[12],xmm2[13],xmm3[13],xmm2[14],xmm3[14],xmm2[15],xmm3[15] ;INTEL
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm4 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
; AVX512F-FAST-NEXT:    vpshufb %ymm4, %ymm2, %ymm3
; AVX512F-FAST-NEXT:    vmovdqa %ymm4, %ymm10
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm4 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX512F-FAST-NEXT:    vpshufb %ymm4, %ymm2, %ymm2
...
; AVX512F-FAST-NEXT:    vpshufb %ymm4, %ymm2, %ymm3
; AVX512F-FAST-NEXT:    vmovdqa %ymm4, %ymm12 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm4 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX512F-FAST-NEXT:    vpshufb %ymm4, %ymm2, %ymm2
; AVX512F-FAST-NEXT:    vmovdqa %ymm4, %ymm13 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm16 ;INTEL
...
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512F-FAST-NEXT:    vpshufb %ymm8, %ymm2, %ymm3 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm2, %ymm2 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm2
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm4, %ymm5 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm4, %ymm4 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm6, %ymm7
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm6, %ymm6
...
; AVX512F-FAST-NEXT:    vpshufb %ymm8, %ymm0, %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm0, %ymm0 ;INTEL
...
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm0, %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm0, %ymm0 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
...
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm2, %ymm3 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm2, %ymm2 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm2
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
...
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm4, %ymm4, %ymm4
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm4, %ymm5
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm4, %ymm4
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm5, %zmm4, %zmm4
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm6, %ymm7
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm6, %ymm6
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm7, %zmm6, %zmm23
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm8, %ymm0, %ymm1 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm6, %ymm7
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm6, %ymm6
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm7, %zmm6, %zmm29
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm10, %ymm20
...
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm12, %ymm22
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm13, %ymm21
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm14
; AVX512F-FAST-NEXT:    vmovdqa (%rsi), %xmm13
; AVX512F-FAST-NEXT:    vmovdqa (%rdi), %xmm12
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm12[8],xmm13[8],xmm12[9],xmm13[9],xmm12[10],xmm13[10],xmm12[11],xmm13[11],xmm12[12],xmm13[12],xmm12[13],xmm13[13],xmm12[14],xmm13[14],xmm12[15],xmm13[15]
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm11 = <4,5,u,u,u,u,u,u,6,7,u,u,u,u,u,u>
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm0, %xmm2 ;INTEL
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm10 = <8,9,u,u,u,u,u,u,10,11,u,u,u,u,u,u,12,13,u,u,u,u,u,u,14,15,u,u,u,u,u,u>
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm9
; AVX512F-FAST-NEXT:    vmovdqa 48(%rsi), %xmm0
; AVX512F-FAST-NEXT:    vmovdqa 48(%rdi), %xmm1
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; AVX512F-FAST-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm2, %xmm4
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm4, %ymm3, %ymm3
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm2, %ymm2
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm2, %zmm3, %zmm8
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512F-FAST-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm0, %xmm2
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm7
; AVX512F-FAST-NEXT:    vmovdqa 32(%rsi), %xmm0
; AVX512F-FAST-NEXT:    vmovdqa 32(%rdi), %xmm1
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; AVX512F-FAST-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm2, %xmm15
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm15, %ymm5, %ymm5
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm2, %ymm2
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm2, %zmm5, %zmm6
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512F-FAST-NEXT:    vpmovzxwq {{.*#+}} xmm1 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm0, %xmm5
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm5, %ymm1, %ymm1
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm4
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpbroadcastq {{.*#+}} zmm5 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm5, %zmm9 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpbroadcastq {{.*#+}} zmm3 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX512F-FAST-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm15 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpandq %zmm3, %zmm16, %zmm16
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512F-FAST-NEXT:    kmovw %eax, %k1
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpord %zmm15, %zmm16, %zmm9 {%k1}
; AVX512F-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512F-FAST-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm15 # 16-byte Folded Reload
; AVX512F-FAST-NEXT:    # xmm15 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm17, %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm0, %ymm15, %ymm1
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm18, %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm0, %ymm15, %ymm15
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm15, %zmm16
; AVX512F-FAST-NEXT:    vmovdqa 16(%rsi), %xmm1
; AVX512F-FAST-NEXT:    vmovdqa 16(%rdi), %xmm15
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm15[0],xmm1[0],xmm15[1],xmm1[1],xmm15[2],xmm1[2],xmm15[3],xmm1[3],xmm15[4],xmm1[4],xmm15[5],xmm1[5],xmm15[6],xmm1[6],xmm15[7],xmm1[7]
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm0, %xmm2
; AVX512F-FAST-NEXT:    vpmovzxwq {{.*#+}} xmm18 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX512F-FAST-NEXT:    vinserti32x4 $1, %xmm2, %ymm18, %ymm2
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm18
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm15[8],xmm1[8],xmm15[9],xmm1[9],xmm15[10],xmm1[10],xmm15[11],xmm1[11],xmm15[12],xmm1[12],xmm15[13],xmm1[13],xmm15[14],xmm1[14],xmm15[15],xmm1[15]
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm15, %ymm2
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm0
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm12[0],xmm13[0],xmm12[1],xmm13[1],xmm12[2],xmm13[2],xmm12[3],xmm13[3],xmm12[4],xmm13[4],xmm12[5],xmm13[5],xmm12[6],xmm13[6],xmm12[7],xmm13[7]
; AVX512F-FAST-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX512F-FAST-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm12, %xmm12 # 16-byte Folded Reload
; AVX512F-FAST-NEXT:    # xmm12 = xmm12[0],mem[0],xmm12[1],mem[1],xmm12[2],mem[2],xmm12[3],mem[3],xmm12[4],mem[4],xmm12[5],mem[5],xmm12[6],mem[6],xmm12[7],mem[7]
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm12, %ymm12, %ymm12
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm22, %ymm13
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm12, %ymm13
...
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm13
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm13, %ymm10
; AVX512F-FAST-NEXT:    vpshufb %xmm11, %xmm2, %xmm11
; AVX512F-FAST-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512F-FAST-NEXT:    vinserti128 $1, %xmm11, %ymm2, %ymm2
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm10, %zmm2, %zmm2
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm5, %zmm8 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm10 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpandq {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm11 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpord %zmm10, %zmm11, %zmm8 {%k1}
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm5, %zmm7 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm10 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpandq {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm11 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpord %zmm10, %zmm11, %zmm7 {%k1}
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm5, %zmm6 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm10 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpandq %zmm3, %zmm23, %zmm11
; AVX512F-FAST-NEXT:    vpord %zmm10, %zmm11, %zmm6 {%k1}
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm24, %zmm5, %zmm4
; AVX512F-FAST-NEXT:    vpandnq %zmm25, %zmm3, %zmm10
; AVX512F-FAST-NEXT:    vpandq %zmm3, %zmm26, %zmm11
; AVX512F-FAST-NEXT:    vpord %zmm10, %zmm11, %zmm4 {%k1}
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm27, %zmm5, %zmm18
; AVX512F-FAST-NEXT:    vpandnq %zmm28, %zmm3, %zmm10
; AVX512F-FAST-NEXT:    vpandq %zmm3, %zmm29, %zmm11
; AVX512F-FAST-NEXT:    vpord %zmm10, %zmm11, %zmm18 {%k1}
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm30, %zmm5, %zmm0
; AVX512F-FAST-NEXT:    vpandnq %zmm31, %zmm3, %zmm10
; AVX512F-FAST-NEXT:    vpandq %zmm3, %zmm14, %zmm11
; AVX512F-FAST-NEXT:    vpord %zmm10, %zmm11, %zmm0 {%k1}
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm16, %zmm5, %zmm2
; AVX512F-FAST-NEXT:    vpandnq %zmm1, %zmm3, %zmm1
; AVX512F-FAST-NEXT:    vpandq %zmm3, %zmm12, %zmm3
; AVX512F-FAST-NEXT:    vpord %zmm1, %zmm3, %zmm2 {%k1}
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm7, 448(%rax)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm8, 384(%rax)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm9, 64(%rax)

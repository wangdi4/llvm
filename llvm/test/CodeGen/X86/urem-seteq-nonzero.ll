...
; X86-NEXT:    imull $-1431655765, {{[0-9]+}}(%esp), %edx # imm = 0xAAAAAAAB ;INTEL
; X86-NEXT:    addl %ecx, %edx ;INTEL
; X86-NEXT:    addl $-1431655766, %eax # imm = 0xAAAAAAAA
; X86-NEXT:    adcl $-1431655766, %edx # imm = 0xAAAAAAAA ;INTEL
; X86-NEXT:    cmpl $1431655765, %eax # imm = 0x55555555
; X86-NEXT:    sbbl $1431655765, %edx # imm = 0x55555555 ;INTEL
; X86-NEXT:    setb %al
; X86-NEXT:    retl
;
; X64-LABEL: t64_3_2:

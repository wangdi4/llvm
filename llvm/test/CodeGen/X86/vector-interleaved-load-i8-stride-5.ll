...
; SSE-NEXT:    punpckhdq {{.*#+}} xmm1 = xmm1[2],xmm2[2],xmm1[3],xmm2[3]
; SSE-NEXT:    packuswb %xmm1, %xmm0
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[0,0,2,3] ;INTEL
; SSE-NEXT:    movdqa {{.*#+}} xmm0 = [255,255,255,255,255,255,255,0,0,0,0,0,0,255,255,255] ;INTEL
...
; SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm9[0,1,2,0]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm2 = xmm11[0,2,1,3,4,5,6,7]
; end INTEL_CUSTOMIZATION
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,3,2,1]
; SSE-NEXT:    pshuflw {{.*#+}} xmm2 = xmm2[0,2,1,3,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm15[0,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,6,5,4,7]
; SSE-NEXT:    punpckhdq {{.*#+}} xmm5 = xmm5[2],xmm7[2],xmm5[3],xmm7[3]
; SSE-NEXT:    packuswb %xmm5, %xmm2
; end INTEL_CUSTOMIZATION
...
; end INTEL_CUSTOMIZATION
; SSE-NEXT:    movdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    punpckhbw {{.*#+}} xmm5 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15] ;INTEL
; SSE-NEXT:    movdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; INTEL_CUSTOMIZATION
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[1,0],xmm0[0,0]
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[2,0],xmm0[2,3]
...
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[2,0],xmm7[3,0]
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,1],xmm5[0,2]
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm7[0,1,2,3,4,7,6,7]
...
; SSE-NEXT:    pandn %xmm5, %xmm10 ;INTEL
; SSE-NEXT:    por %xmm10, %xmm0 ;INTEL
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; INTEL_CUSTOMIZATION
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
...
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm12[0,1,2,0]
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[2,0],xmm7[3,0]
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,1],xmm12[0,2]
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm7[2,1,2,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,4,7,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm7[0,3,2,1,4,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,6,7]
; SSE-NEXT:    packuswb %xmm0, %xmm0
; SSE-NEXT:    movdqa %xmm5, %xmm7 ;INTEL
...
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm10[0,1,2,0]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,6,6,6]
; INTEL_CUSTOMIZATION
; SSE-NEXT:    pshufhw {{.*#+}} xmm10 = xmm12[0,1,2,3,4,5,6,5]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm7[0,1,2,3,4,5,6,5]
...
; SSE-NEXT:    movdqa %xmm5, %xmm7
; SSE-NEXT:    pandn %xmm0, %xmm7 ;INTEL
; SSE-NEXT:    movdqa %xmm1, %xmm0 ;INTEL
...
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[0,1,2,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,4,4,7,5]
; SSE-NEXT:    packuswb %xmm7, %xmm7
; SSE-NEXT:    movdqa %xmm8, %xmm10
; SSE-NEXT:    pandn %xmm7, %xmm10
; end INTEL_CUSTOMIZATION
...
; SSE-NEXT:    packuswb %xmm1, %xmm0
; SSE-NEXT:    pand %xmm5, %xmm0
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm13[0,1,2,3,4,5,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[3,1,2,0]
; SSE-NEXT:    pshuflw {{.*#+}} xmm1 = xmm1[3,0,1,2,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,7,4,6,7]
; SSE-NEXT:    packuswb %xmm1, %xmm1
...
; SSE-NEXT:    por %xmm5, %xmm0
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[2,0],xmm5[3,0]
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[0,1],xmm9[0,2]
; SSE-NEXT:    pand %xmm8, %xmm0
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm9[0,1,0,3,4,5,6,7]
; SSE-NEXT:    punpckldq {{.*#+}} xmm9 = xmm9[0],xmm10[0],xmm9[1],xmm10[1]
; SSE-NEXT:    packuswb %xmm5, %xmm9
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,1],xmm9[2,1]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm9[0,1,1,3]
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[0,3],xmm5[1,2]
...
; INTEL_CUSTOMIZATION
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm5[2,1,3,0,4,5,6,7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,3],xmm9[1,2]
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,2,3,1]
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm10[3,1,2,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm9[0,1,2,3,4,6,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm10 = xmm9[2,1,3,0,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm11[0,1,2,3,4,5,4,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm15[3,1,0,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm9[0,1,2,3,4,5,6,4]
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[0,3,2,1]
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm9[3,1,2,0,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm13 = xmm13[0,1,2,1,4,5,6,7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[0,1],xmm11[2,1]
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; SSE-NEXT:    pand %xmm3, %xmm10

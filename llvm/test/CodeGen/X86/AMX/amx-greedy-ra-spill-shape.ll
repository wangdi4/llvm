...
<<<<<<< HEAD
  ...
  ; CHECK-NEXT:   [[IMUL64rr:%[0-9]+]]:gr64_nosp = nsw IMUL64rr [[IMUL64rr]], [[MOVSX64rr32_2]], implicit-def dead $eflags ;INTEL
  ; CHECK-NEXT:   [[ADD64rr:%[0-9]+]]:gr64_nosp = nsw ADD64rr [[ADD64rr]], [[MOVSX64rm32_]], implicit-def dead $eflags     ;INTEL

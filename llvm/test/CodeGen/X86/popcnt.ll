...
; X86-NOSSE-NEXT:    shrl $24, %ecx
; X86-NOSSE-NEXT:    addl %edx, %ecx
; X86-NOSSE-NEXT:    addl %esi, %ecx ;INTEL
...
; X86-POPCNT:       # %bb.0:
; X86-POPCNT-NEXT:    pushl %esi ;INTEL
...
; X86-POPCNT-NEXT:    popl %esi ;INTEL
...
; X86-NOSSE-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-NOSSE-NEXT:    movl {{[0-9]+}}(%esp), %esi
; X86-NOSSE-NEXT:    movl {{[0-9]+}}(%esp), %eax ;INTEL
...
; end INTEL_CUSTOMIZATION
; X86-NOSSE-NEXT:    shrl %ebx
; X86-NOSSE-NEXT:    andl %edi, %ebx ;INTEL
; X86-NOSSE-NEXT:    subl %ebx, %eax ;INTEL
; X86-NOSSE-NEXT:    movl %eax, %ebx ;INTEL
; X86-NOSSE-NEXT:    andl %ecx, %ebx
; INTEL_CUSTOMIZATION
; X86-NOSSE-NEXT:    shrl $2, %eax
; X86-NOSSE-NEXT:    andl %ecx, %eax
...
; end INTEL_CUSTOMIZATION
; X86-NOSSE-NEXT:    shrl $24, %edx
; X86-NOSSE-NEXT:    addl %ecx, %edx ;INTEL
; X86-NOSSE-NEXT:    movl {{[0-9]+}}(%esp), %eax
; INTEL_CUSTOMIZATION
; X86-NOSSE-NEXT:    addl %edi, %edx
...
; X86-POPCNT-NEXT:    addl %ecx, %edx
; X86-POPCNT-NEXT:    popcntl {{[0-9]+}}(%esp), %ecx
; X86-POPCNT-NEXT:    popcntl {{[0-9]+}}(%esp), %esi ;INTEL
; X86-POPCNT-NEXT:    addl %ecx, %esi ;INTEL
; X86-POPCNT-NEXT:    addl %edx, %esi ;INTEL
; X86-POPCNT-NEXT:    xorl %ecx, %ecx
; X86-POPCNT-NEXT:    movl %ecx, 12(%eax)
; X86-POPCNT-NEXT:    movl %ecx, 8(%eax)
; X86-POPCNT-NEXT:    movl %ecx, 4(%eax)
; X86-POPCNT-NEXT:    movl %esi, (%eax) ;INTEL
; X86-POPCNT-NEXT:    popl %esi ;INTEL
; X86-POPCNT-NEXT:    retl $4
;

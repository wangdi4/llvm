...
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm0 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535] ;INTEL
; AVX512F-SLOW-NEXT:    vpandnq 16(%r8){1to4}, %ymm0, %ymm0 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm3 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535] ;INTEL
; AVX512F-FAST-NEXT:    vpandnq 16(%r8){1to4}, %ymm3, %ymm3 ;INTEL
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm5, %ymm26 ;INTEL
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm4, %ymm27 ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm4 = ymm18[0,1,2,1,4,5,6,5]
...
; AVX512F-SLOW-NEXT:    vpandnq 16(%r8){1to4}, %ymm18, %ymm1 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa (%r8), %ymm9
...
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm14, %zmm1, %zmm1 ;INTEL
...
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm31, %zmm19, %zmm1 ;INTEL
...
; AVX512F-SLOW-NEXT:    vpshufb %ymm3, %ymm2, %ymm12
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[0,1,1,1]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm26 = ymm26[0,1,0,1]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm28 = ymm27[0,1,0,0]
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm9 = ymm9[0,1,1,1]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm29 = ymm21[2,3,2,3] ;INTEL
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpandnq 80(%r8){1to4}, %ymm18, %ymm18
...
; AVX512F-SLOW-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm18, %zmm20 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm18, %zmm25 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm18 = [65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535]
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm10 # 64-byte Reload
; AVX512F-SLOW-NEXT:    vpternlogq $248, %zmm18, %zmm20, %zmm10 ;INTEL
; AVX512F-SLOW-NEXT:    vpternlogq $248, %zmm18, %zmm25, %zmm17 ;INTEL
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm22, %zmm19, %zmm18 ;INTEL
; AVX512F-SLOW-NEXT:    vpermq $68, {{[-0-9]+}}(%r{{[sb]}}p), %zmm19 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    # zmm19 = mem[0,1,0,1,4,5,4,5]
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm20 = [65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535]
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm18, %zmm20, %zmm19
...
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm19, %zmm18, %zmm2
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm28, %zmm26, %zmm19
; AVX512F-SLOW-NEXT:    vpermq $68, {{[-0-9]+}}(%r{{[sb]}}p), %zmm21 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    # zmm21 = mem[0,1,0,1,4,5,4,5]
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm19, %zmm20, %zmm21
; AVX512F-SLOW-NEXT:    vpbroadcastq (%r8), %ymm19
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm9, %zmm19, %zmm9
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm21, %zmm18, %zmm9
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm11, %zmm29, %zmm11
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm15, %zmm8, %zmm8
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm11, %zmm20, %zmm8 ;INTEL
...
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm8, %zmm15, %zmm11
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm5, %zmm7, %zmm5
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm3, %zmm4, %zmm3
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm5, %zmm20, %zmm3 ;INTEL
; AVX512F-SLOW-NEXT:    vpbroadcastq 48(%r8), %ymm4
; AVX512F-SLOW-NEXT:    vpbroadcastq 56(%r8), %ymm5
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm5, %zmm4, %zmm4
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm3, %zmm15, %zmm4 ;INTEL
...
; AVX512F-SLOW-NEXT:    vpternlogq $248, %zmm3, %zmm0, %zmm12 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm12, 384(%r9) ;INTEL
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm1, 448(%r9) ;INTEL
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4,5],ymm0[6],ymm1[7,8],ymm0[9],ymm1[10],ymm0[11],ymm1[12,13],ymm0[14],ymm1[15]
; AVX512F-FAST-NEXT:    vmovdqa 96(%rcx), %xmm1
; AVX512F-FAST-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm10 = <10,11,u,u,6,7,u,u,8,9,8,9,u,u,8,9>
...
; AVX512F-FAST-NEXT:    vpshufb %ymm8, %ymm2, %ymm0 ;INTEL
...
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm4 = ymm1[0,1,1,1]
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm1 = [65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535]
; AVX512F-FAST-NEXT:    vpandn %ymm4, %ymm1, %ymm4
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm3, %zmm4, %zmm3
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-FAST-NEXT:    vmovdqa 32(%rcx), %ymm3 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqu %ymm3, (%rsp) # 32-byte Spill ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm15, %ymm3, %ymm3 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 32(%rdx), %ymm27
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm4 = ymm27[3,0,3,0,7,4,7,4]
...
; AVX512F-FAST-NEXT:    vmovdqa %xmm5, %xmm9
...
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} xmm7 = xmm5[1,2,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0],xmm7[1],xmm1[2],xmm7[3],xmm1[4,5],xmm7[6],xmm1[7]
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm5[0],xmm0[1],xmm5[1],xmm0[2],xmm5[2],xmm0[3],xmm5[3]
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm5 = [4,5,2,3,2,3,0,1,10,11,8,9,4,5,6,7]
; AVX512F-FAST-NEXT:    vpshufb %xmm5, %xmm0, %xmm0
; AVX512F-FAST-NEXT:    vmovdqa %xmm5, %xmm9
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm5 = [0,1,0,1,8,9,8,8]
; AVX512F-FAST-NEXT:    vpermt2q %zmm1, %zmm5, %zmm0
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} zmm19 = zmm3[0,1,0,1,4,5,4,5]
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm0, %zmm31, %zmm19 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa (%rcx), %xmm0 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm10, %xmm0, %xmm1 ;INTEL
...
; AVX512F-FAST-NEXT:    vpermt2q %zmm1, %zmm5, %zmm0
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} zmm21 = zmm4[0,1,0,1,4,5,4,5]
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm0, %zmm31, %zmm21
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vmovdqa (%rcx), %ymm5 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm15, %ymm5, %ymm0 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm7, %ymm5, %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm4 = ymm10[1,1,1,2,5,5,5,6] ;INTEL
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm4[1],ymm1[2,3],ymm4[4],ymm1[5],ymm4[6],ymm1[7,8],ymm4[9],ymm1[10,11],ymm4[12],ymm1[13],ymm4[14],ymm1[15] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[2,3,2,3]
...
; AVX512F-FAST-NEXT:    vpandnq 16(%r8){1to4}, %ymm9, %ymm0 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm4 = ymm18[1,1,1,2,5,5,5,6] ;INTEL
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm4[1],ymm2[2,3],ymm4[4],ymm2[5],ymm4[6],ymm2[7,8],ymm4[9],ymm2[10,11],ymm4[12],ymm2[13],ymm4[14],ymm2[15] ;INTEL
...
; AVX512F-FAST-NEXT:    vpandnq 80(%r8){1to4}, %ymm9, %ymm9 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa 64(%r8), %ymm4 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm14, %ymm4, %ymm15 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm3 = [4,5,2,3,2,3,0,1,10,11,8,9,4,5,6,7] ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm9, %xmm1 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm14 = [0,1,2,3,8,9,10,11,4,5,4,5,6,7,12,13] ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm14, %xmm1, %xmm1 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm5, %ymm3 ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm2 = ymm4[0,1,1,1] ;INTEL
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm5 = ymm10[3,2,3,3,7,6,7,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0],ymm5[1],ymm3[2],ymm5[3,4],ymm3[5,6,7,8],ymm5[9],ymm3[10],ymm5[11,12],ymm3[13,14,15] ;INTEL
; AVX512F-FAST-NEXT:    vpermt2q %zmm0, %zmm9, %zmm3 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %xmm14, %xmm6, %xmm6 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm4 # 32-byte Reload ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm17, %ymm9
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm4, %ymm9 ;INTEL
...
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm3, %zmm1, %zmm9 ;INTEL
; AVX512F-FAST-NEXT:    vpbroadcastq 24(%r8), %ymm3 ;INTEL
; AVX512F-FAST-NEXT:    vpbroadcastq 32(%r8), %ymm6
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm6, %zmm3, %zmm3 ;INTEL
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm9, %zmm5, %zmm3 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm6 # 64-byte Reload ;INTEL
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm5, %zmm6 # 64-byte Folded Reload ;INTEL
...
; AVX512F-FAST-NEXT:    vpternlogq $248, %zmm5, %zmm6, %zmm9 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm3, 128(%r9) ;INTEL

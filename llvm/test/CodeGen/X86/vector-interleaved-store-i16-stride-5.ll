...
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm7 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535] ;INTEL
; AVX512F-SLOW-NEXT:    vpandnq 16(%r8){1to4}, %ymm7, %ymm7 ;INTEL
...
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm7 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535] ;INTEL
; AVX512F-FAST-NEXT:    vpandnq 16(%r8){1to4}, %ymm7, %ymm7 ;INTEL
...
; AVX512F-SLOW-NEXT:    vmovdqa64 32(%rdi), %ymm18 ;INTEL
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm8 = ymm18[1,1,2,2] ;INTEL
...
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm19 = ymm12[0,1,1,1] ;INTEL
...
; AVX512F-SLOW-NEXT:    vpandnq %ymm19, %ymm24, %ymm19 ;INTEL
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm12, %zmm19, %zmm12 ;INTEL
...
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm19 = ymm4[0,1,0,0] ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm4 = ymm18[0,1,2,1,4,5,6,5] ;INTEL
...
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm4 = ymm18[2,3,2,3,6,7,6,7] ;INTEL
...
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm3 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535] ;INTEL
; AVX512F-SLOW-NEXT:    vpandnq 16(%r8){1to4}, %ymm3, %ymm3 ;INTEL
...
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm19, %zmm13, %zmm7 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm2 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535] ;INTEL
; AVX512F-FAST-NEXT:    vpandnq 16(%r8){1to4}, %ymm2, %ymm2 ;INTEL
...
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm3, %zmm4 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm5, %ymm1, %ymm3 ;INTEL
...
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm18 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa (%rdx), %xmm1
; AVX512F-FAST-NEXT:    vmovdqa (%rcx), %xmm3 ;INTEL
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3] ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm2, %xmm3, %xmm2 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm3 = [0,1,2,3,8,9,10,11,4,5,4,5,6,7,12,13] ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm0, %xmm0 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm6, %xmm3 ;INTEL
...
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[0,1,0,1] ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm15 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535] ;INTEL
; AVX512F-FAST-NEXT:    vpandnq 16(%r8){1to4}, %ymm15, %ymm15 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm15, %zmm13, %zmm13
; AVX512F-FAST-NEXT:    vpternlogq $216, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm16, %zmm4 ;INTEL
; AVX512F-FAST-NEXT:    vpternlogq $248, {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %zmm4, %zmm18 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm10, %zmm9, %zmm4 ;INTEL
...
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm1 ;INTEL
...
; AVX512F-FAST-NEXT:    vpbroadcastq 24(%r8), %ymm0
; AVX512F-FAST-NEXT:    vpbroadcastq 32(%r8), %ymm3 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm3, %zmm0, %zmm0 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm4, (%r9) ;INTEL
...
; AVX512F-SLOW:       # %bb.0:
<<<<<<< HEAD
; AVX512F-SLOW-NEXT:    subq $680, %rsp # imm = 0x2A8 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa 96(%rcx), %ymm2 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm1 = <u,u,12,13,u,u,0,1,u,u,u,u,14,15,u,u,u,u,28,29,u,u,16,17,u,u,u,u,30,31,u,u>
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufb %ymm1, %ymm2, %ymm0
...
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm15 = <u,u,12,13,u,u,0,1,u,u,u,u,14,15,u,u,u,u,28,29,u,u,16,17,u,u,u,u,30,31,u,u>
; AVX512F-SLOW-NEXT:    vpshufb %ymm15, %ymm2, %ymm0
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm2, %ymm26
; AVX512F-SLOW-NEXT:    vmovdqa64 96(%rdx), %ymm18
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm1 = ymm18[3,0,3,0,7,4,7,4]
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} xmm14 = <10,11,u,u,6,7,u,u,8,9,8,9,u,u,8,9>
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm0, %xmm3
...
; AVX512F-SLOW-NEXT:    vpshufb %ymm3, %ymm8, %ymm1
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm3, %ymm16
; AVX512F-SLOW-NEXT:    vmovdqa 96(%rdi), %ymm9
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm3 = ymm9[1,1,2,2]
=======
; AVX512F-SLOW-NEXT:    vmovdqa 96(%rsi), %ymm9 ;INTEL
...
; AVX512F-SLOW-NEXT:    vmovdqa64 96(%rdi), %ymm19
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm3 = ymm19[1,1,2,2]
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
...
; INTEL_CUSTOMIZATION
<<<<<<< HEAD
; AVX512F-SLOW-NEXT:    vpshufb %xmm10, %xmm1, %xmm4
...
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} ymm20 = [65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535]
; AVX512F-SLOW-NEXT:    vpandnq %ymm3, %ymm20, %ymm3
...
=======
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm5 = ymm4[0,1,2,3,5,6,7,7,8,9,10,11,13,14,15,15]
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm5[2,3,2,3,6,7,6,7]
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm3 = ymm5[0],ymm3[1],ymm5[2],ymm3[3,4],ymm5[5,6,7,8],ymm3[9],ymm5[10],ymm3[11,12],ymm5[13,14,15]
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
...
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} xmm15 = [4,5,2,3,2,3,0,1,10,11,8,9,4,5,6,7]
; AVX512F-SLOW-NEXT:    vpshufb %xmm15, %xmm0, %xmm0
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,1,0,1]
; AVX512F-SLOW-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
<<<<<<< HEAD
; AVX512F-SLOW-NEXT:    vmovdqa64 64(%rdi), %ymm30 ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm30[2,3,2,3,6,7,6,7] ;INTEL
...
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3] ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,1,3]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,4,5,6]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,1,0,1]
<<<<<<< HEAD
; AVX512F-SLOW-NEXT:    vmovdqu %ymm0, (%rsp) # 32-byte Spill ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa (%rsi), %xmm0
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 64(%rsi), %xmm1
; AVX512F-SLOW-NEXT:    vpshufb %xmm10, %xmm1, %xmm2
; AVX512F-SLOW-NEXT:    vpbroadcastq 72(%rdi), %xmm3
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0],xmm3[1],xmm2[2,3],xmm3[4],xmm2[5],xmm3[6],xmm2[7]
...
; AVX512F-SLOW-NEXT:    vshufi64x2 {{.*#+}} zmm1 = zmm1[0,1,0,1],zmm2[0,1,0,1]
; AVX512F-SLOW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-SLOW-NEXT:    vmovdqa 64(%rdx), %xmm1
; AVX512F-SLOW-NEXT:    vmovdqa 64(%rcx), %xmm2
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm2[0],xmm1[0],xmm2[1],xmm1[1],xmm2[2],xmm1[2],xmm2[3],xmm1[3]
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm2, %xmm2
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,2,2,2]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} xmm1 = xmm2[0],xmm1[1],xmm2[2],xmm1[3],xmm2[4,5],xmm1[6],xmm2[7]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm11, %xmm2, %xmm2 ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[1,2,2,2]
...
; AVX512F-SLOW-NEXT:    vpshufb %xmm10, %xmm2, %xmm3
...
; AVX512F-SLOW-NEXT:    vinserti32x4 $2, %xmm3, %zmm2, %zmm1
; AVX512F-SLOW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm2 = ymm22[3,2,3,3,7,6,7,7]
; AVX512F-SLOW-NEXT:    vmovdqa (%rcx), %ymm12
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm5 = ymm12[0,1,2,3,5,6,7,7,8,9,10,11,13,14,15,15]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm5[2,3,2,3,6,7,6,7]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm2 = ymm5[0],ymm2[1],ymm5[2],ymm2[3,4],ymm5[5,6,7,8],ymm2[9],ymm5[10],ymm2[11,12],ymm5[13,14,15]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm1 = ymm2[2,2,3,2]
; AVX512F-SLOW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; end INTEL_CUSTOMIZATION
...
; AVX512F-SLOW-NEXT:    vmovdqa (%rdx), %ymm7 ;INTEL
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm3[0],xmm0[0],xmm3[1],xmm0[1],xmm3[2],xmm0[2],xmm3[3],xmm0[3] ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm3 = ymm7[3,2,3,3,7,6,7,7] ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,1,3]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,4,5,6]
<<<<<<< HEAD
; AVX512F-SLOW-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm0[0,1,0,1],zmm1[0,1,0,1] ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-SLOW-NEXT:    vmovdqa (%rcx), %ymm6 ;INTEL
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm0 = ymm6[0,1,2,3,5,6,7,7,8,9,10,11,13,14,15,15] ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[2,3,2,3,6,7,6,7]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm3[1],ymm0[2],ymm3[3,4],ymm0[5,6,7,8],ymm3[9],ymm0[10],ymm3[11,12],ymm0[13,14,15] ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rcx), %xmm3 ;INTEL
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[2,2,3,2]
; AVX512F-SLOW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm3[0],xmm5[0],xmm3[1],xmm5[1],xmm3[2],xmm5[2],xmm3[3],xmm5[3] ;INTEL
; AVX512F-SLOW-NEXT:    vpshufb %xmm15, %xmm0, %xmm0 ;INTEL
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,1,0,1]
; AVX512F-SLOW-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa (%rsi), %ymm2
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm4 = ymm2[0,1,2,3,7,6,5,7,8,9,10,11,15,14,13,15]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm4 = ymm4[2,3,2,2,6,7,6,6]
; AVX512F-SLOW-NEXT:    vmovdqa64 (%rdi), %ymm18
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm11 = ymm18[2,3,2,3,6,7,6,7]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm11 = ymm4[0],ymm11[1],ymm4[2],ymm11[3],ymm4[4,5],ymm11[6],ymm4[7,8],ymm11[9],ymm4[10],ymm11[11],ymm4[12,13],ymm11[14],ymm4[15]
...
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm0 = ymm12[0],ymm0[1],ymm12[2],ymm0[3],ymm12[4,5],ymm0[6],ymm12[7,8],ymm0[9],ymm12[10],ymm0[11],ymm12[12,13],ymm0[14],ymm12[15]
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm3, %xmm3
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm5 = xmm5[1,2,2,2]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} xmm3 = xmm3[0],xmm5[1],xmm3[2],xmm5[3],xmm3[4,5],xmm5[6],xmm3[7] ;INTEL
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[0,1,0,0] ;INTEL
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm0, %zmm3, %zmm0 ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm31 = ymm11[2,3,2,2] ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rsi), %ymm5
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rdi), %ymm0
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm16, %ymm3
; AVX512F-SLOW-NEXT:    vpshufb %ymm3, %ymm5, %ymm3
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm11 = ymm0[1,1,2,2]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm3 = ymm11[0],ymm3[1],ymm11[2,3],ymm3[4],ymm11[5],ymm3[6],ymm11[7,8],ymm3[9],ymm11[10,11],ymm3[12],ymm11[13],ymm3[14],ymm11[15]
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rsi), %xmm11
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rdi), %xmm12
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3] ;INTEL
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm3, %zmm10, %zmm26
; AVX512F-SLOW-NEXT:    vmovdqa 32(%r8), %ymm3
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm10 = ymm3[0,1,1,1]
; AVX512F-SLOW-NEXT:    vpandnq %ymm10, %ymm20, %ymm10
...
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm3, %zmm10, %zmm10
; AVX512F-SLOW-NEXT:    vpshufb %xmm15, %xmm13, %xmm3
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm3, %ymm21
; AVX512F-SLOW-NEXT:    vmovdqa (%rdx), %xmm3
; AVX512F-SLOW-NEXT:    vmovdqa (%rcx), %xmm11
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm11[0],xmm3[0],xmm11[1],xmm3[1],xmm11[2],xmm3[2],xmm11[3],xmm3[3]
; AVX512F-SLOW-NEXT:    vpshufb %xmm15, %xmm13, %xmm13
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm13, %ymm29
; AVX512F-SLOW-NEXT:    vpshufb %xmm14, %xmm11, %xmm11
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[1,2,2,2]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} xmm3 = xmm11[0],xmm3[1],xmm11[2],xmm3[3],xmm11[4,5],xmm3[6],xmm11[7]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm3, %ymm28
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm3 = xmm12[0,2,1,3]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,4,4,5,6]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm20 = ymm3[0,1,0,1]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm3 = ymm9[0,1,2,1,4,5,6,5]
; AVX512F-SLOW-NEXT:    vprolq $16, %ymm8, %ymm11
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm3 = ymm11[0,1],ymm3[2],ymm11[3],ymm3[4],ymm11[5,6],ymm3[7],ymm11[8,9],ymm3[10],ymm11[11],ymm3[12],ymm11[13,14],ymm3[15]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm3, %ymm23
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm3 = ymm8[0,1,2,3,7,6,5,7,8,9,10,11,15,14,13,15]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm3 = ymm3[2,3,2,2,6,7,6,6]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm8 = ymm9[2,3,2,3,6,7,6,7]
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm3, %ymm27
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm15 = <u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,19,u,u,22,23,22,23,u,u,20,21,u,u,24,25>
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm22, %ymm3
; AVX512F-SLOW-NEXT:    vpshufb %ymm15, %ymm3, %ymm8
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm9 = ymm17[1,1,1,2,5,5,5,6]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm8 = ymm8[0],ymm9[1],ymm8[2,3],ymm9[4],ymm8[5],ymm9[6],ymm8[7,8],ymm9[9],ymm8[10,11],ymm9[12],ymm8[13],ymm9[14],ymm8[15]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm8, %ymm25
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm8 = ymm3[0,1,2,3,5,6,7,7,8,9,10,11,13,14,15,15]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm8 = ymm8[2,3,2,3,6,7,6,7]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm13 = ymm17[3,2,3,3,7,6,7,7]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm3 = ymm8[0],ymm13[1],ymm8[2],ymm13[3,4],ymm8[5,6,7,8],ymm13[9],ymm8[10],ymm13[11,12],ymm8[13,14,15]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm3, %ymm24
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm8 = ymm0[0,1,2,1,4,5,6,5]
; AVX512F-SLOW-NEXT:    vprolq $16, %ymm5, %ymm13
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm9 = ymm13[0,1],ymm8[2],ymm13[3],ymm8[4],ymm13[5,6],ymm8[7],ymm13[8,9],ymm8[10],ymm13[11],ymm8[12],ymm13[13,14],ymm8[15]
; end INTEL_CUSTOMIZATION
...
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm1[1,1,1,2,5,5,5,6]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm8 = ymm0[0],ymm5[1],ymm0[2,3],ymm5[4],ymm0[5],ymm5[6],ymm0[7,8],ymm5[9],ymm0[10,11],ymm5[12],ymm0[13],ymm5[14],ymm0[15]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm0 = ymm4[0,1,2,3,5,6,7,7,8,9,10,11,13,14,15,15]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[2,3,2,3,6,7,6,7]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[3,2,3,3,7,6,7,7]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm5 = ymm0[0],ymm1[1],ymm0[2],ymm1[3,4],ymm0[5,6,7,8],ymm1[9],ymm0[10],ymm1[11,12],ymm0[13,14,15]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm16, %ymm11
...
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm5[0],xmm6[0],xmm5[1],xmm6[1],xmm5[2],xmm6[2],xmm5[3],xmm6[3]
; AVX512F-SLOW-NEXT:    vmovdqa %xmm4, %xmm1
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm7 = ymm16[2,3,2,3,6,7,6,7]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm7 = ymm2[0],ymm7[1],ymm2[2],ymm7[3],ymm2[4,5],ymm7[6],ymm2[7,8],ymm7[9],ymm2[10],ymm7[11],ymm2[12,13],ymm7[14],ymm2[15]
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rdx), %ymm3
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rcx), %ymm2
; AVX512F-SLOW-NEXT:    vpshufb %ymm15, %ymm2, %ymm4
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm13 = ymm3[3,0,3,0,7,4,7,4]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm4 = ymm13[0],ymm4[1],ymm13[2],ymm4[3],ymm13[4,5],ymm4[6],ymm13[7,8],ymm4[9],ymm13[10],ymm4[11],ymm13[12,13],ymm4[14],ymm13[15]
; AVX512F-SLOW-NEXT:    vpshufb %xmm11, %xmm5, %xmm5
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[1,2,2,2]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} xmm5 = xmm5[0],xmm6[1],xmm5[2],xmm6[3],xmm5[4,5],xmm6[6],xmm5[7]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm5 = ymm5[0,1,0,0]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm5, %zmm0
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm31 = ymm7[2,3,2,2]
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rsi), %ymm5
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rdi), %ymm6
; AVX512F-SLOW-NEXT:    vpshufb %ymm14, %ymm5, %ymm4
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm7 = ymm6[1,1,2,2]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm4 = ymm7[0],ymm4[1],ymm7[2,3],ymm4[4],ymm7[5],ymm4[6],ymm7[7,8],ymm4[9],ymm7[10,11],ymm4[12],ymm7[13],ymm4[14],ymm7[15]
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rsi), %xmm7
; AVX512F-SLOW-NEXT:    vmovdqa 32(%rdi), %xmm13
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm0 = xmm13[0],xmm7[0],xmm13[1],xmm7[1],xmm13[2],xmm7[2],xmm13[3],xmm7[3]
; AVX512F-SLOW-NEXT:    vpshufb %xmm10, %xmm7, %xmm7
; AVX512F-SLOW-NEXT:    vpbroadcastq 40(%rdi), %xmm10
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} xmm7 = xmm7[0],xmm10[1],xmm7[2,3],xmm10[4],xmm7[5],xmm10[6],xmm7[7]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm7 = ymm7[0,1,0,1]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm7, %zmm29
; AVX512F-SLOW-NEXT:    vmovdqa 32(%r8), %ymm4
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm7 = ymm4[0,1,1,1]
; AVX512F-SLOW-NEXT:    vpandnq %ymm7, %ymm24, %ymm7
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm17, %ymm10
; AVX512F-SLOW-NEXT:    vpshufb %ymm10, %ymm4, %ymm4
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm7, %zmm10
...
; AVX512F-SLOW-NEXT:    vmovdqa (%rdx), %xmm7
; AVX512F-SLOW-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm4[0],xmm7[0],xmm4[1],xmm7[1],xmm4[2],xmm7[2],xmm4[3],xmm7[3]
; AVX512F-SLOW-NEXT:    vpshufb %xmm1, %xmm13, %xmm1
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm1, %ymm30
; AVX512F-SLOW-NEXT:    vpshufb %xmm11, %xmm4, %xmm4
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm7 = xmm7[1,2,2,2]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} xmm1 = xmm4[0],xmm7[1],xmm4[2],xmm7[3],xmm4[4,5],xmm7[6],xmm4[7]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm1, %ymm28
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,1,3]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,4,5,6]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm21 = ymm0[0,1,0,1]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm19[0,1,2,1,4,5,6,5]
; AVX512F-SLOW-NEXT:    vprolq $16, %ymm9, %ymm4
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm0 = ymm4[0,1],ymm0[2],ymm4[3],ymm0[4],ymm4[5,6],ymm0[7],ymm4[8,9],ymm0[10],ymm4[11],ymm0[12],ymm4[13,14],ymm0[15]
...
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm4 = <u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,19,u,u,22,23,22,23,u,u,20,21,u,u,24,25>
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm26, %ymm9
; AVX512F-SLOW-NEXT:    vpshufb %ymm4, %ymm9, %ymm0
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm7 = ymm18[1,1,1,2,5,5,5,6]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm7[1],ymm0[2,3],ymm7[4],ymm0[5],ymm7[6],ymm0[7,8],ymm7[9],ymm0[10,11],ymm7[12],ymm0[13],ymm7[14],ymm0[15]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm0, %ymm27
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm0 = ymm9[0,1,2,3,5,6,7,7,8,9,10,11,13,14,15,15]
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[2,3,2,3,6,7,6,7]
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm7 = ymm18[3,2,3,3,7,6,7,7]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm9 = ymm0[0],ymm7[1],ymm0[2],ymm7[3,4],ymm0[5,6,7,8],ymm7[9],ymm0[10],ymm7[11,12],ymm0[13,14,15]
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm9, %ymm20
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm6[0,1,2,1,4,5,6,5]
; AVX512F-SLOW-NEXT:    vprolq $16, %ymm5, %ymm7
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm9 = ymm7[0,1],ymm0[2],ymm7[3],ymm0[4],ymm7[5,6],ymm0[7],ymm7[8,9],ymm0[10],ymm7[11],ymm0[12],ymm7[13,14],ymm0[15]
; AVX512F-SLOW-NEXT:    vpshufhw {{.*#+}} ymm0 = ymm5[0,1,2,3,7,6,5,7,8,9,10,11,15,14,13,15]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[2,3,2,2,6,7,6,6]
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm6[2,3,2,3,6,7,6,7]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm7 = ymm0[0],ymm5[1],ymm0[2],ymm5[3],ymm0[4,5],ymm5[6],ymm0[7,8],ymm5[9],ymm0[10],ymm5[11],ymm0[12,13],ymm5[14],ymm0[15]
; AVX512F-SLOW-NEXT:    vpshufb %ymm4, %ymm2, %ymm0
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm5 = ymm3[1,1,1,2,5,5,5,6]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm6 = ymm0[0],ymm5[1],ymm0[2,3],ymm5[4],ymm0[5],ymm5[6],ymm0[7,8],ymm5[9],ymm0[10,11],ymm5[12],ymm0[13],ymm5[14],ymm0[15]
...
; AVX512F-SLOW-NEXT:    vmovdqa %ymm14, %ymm11
...
; AVX512F-SLOW-NEXT:    vprolq $16, %ymm2, %ymm1 ;INTEL
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm2 = ymm18[0,1,2,1,4,5,6,5] ;INTEL
...
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[2,3,2,3]
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm22
; AVX512F-SLOW-NEXT:    vmovdqa64 %ymm19, %ymm3
; AVX512F-SLOW-NEXT:    vpshufb %ymm3, %ymm6, %ymm1
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm2 = ymm7[3,0,3,0,7,4,7,4]
...
; AVX512F-SLOW-NEXT:    vpshufb %ymm15, %ymm6, %ymm2
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm6 = ymm7[1,1,1,2,5,5,5,6]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm6[1],ymm2[2,3],ymm6[4],ymm2[5],ymm6[6],ymm2[7,8],ymm6[9],ymm2[10,11],ymm6[12],ymm2[13],ymm6[14],ymm2[15]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[2,3,2,3]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm2
; AVX512F-SLOW-NEXT:    vmovdqa {{.*#+}} ymm6 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535]
; AVX512F-SLOW-NEXT:    vpandnq 16(%r8){1to4}, %ymm6, %ymm7
...
; AVX512F-SLOW-NEXT:    vpshufb %ymm4, %ymm1, %ymm14
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm7, %zmm14, %zmm7
; AVX512F-SLOW-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %ymm11, %ymm0, %ymm14
<<<<<<< HEAD
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm12 = ymm30[1,1,2,2]
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm13 = ymm11[1,1,2,2]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm13 = ymm13[0],ymm14[1],ymm13[2,3],ymm14[4],ymm13[5],ymm14[6],ymm13[7,8],ymm14[9],ymm13[10,11],ymm14[12],ymm13[13],ymm14[14],ymm13[15]
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
; AVX512F-SLOW-NEXT:    vprolq $16, %ymm0, %ymm14
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm11 = ymm30[0,1,2,1,4,5,6,5]
; end INTEL_CUSTOMIZATION
...
; AVX512F-SLOW-NEXT:    vmovdqu {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX512F-SLOW-NEXT:    vpshufb %ymm3, %ymm0, %ymm12
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %ymm16 # 32-byte Reload
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm14 = ymm16[3,0,3,0,7,4,7,4]
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpshufb %ymm15, %ymm0, %ymm3
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm14 = ymm16[1,1,1,2,5,5,5,6]
...
; AVX512F-SLOW-NEXT:    vpshufd {{.*#+}} ymm14 = ymm2[1,1,1,2,5,5,5,6]
; AVX512F-SLOW-NEXT:    vpblendw {{.*#+}} ymm4 = ymm4[0],ymm14[1],ymm4[2,3],ymm14[4],ymm4[5],ymm14[6],ymm4[7,8],ymm14[9],ymm4[10,11],ymm14[12],ymm4[13],ymm14[14],ymm4[15]
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, {{[-0-9]+}}(%r{{[sb]}}p), %zmm0, %zmm14 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, (%rsp), %zmm0, %zmm16 # 32-byte Folded Reload
...
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm14, %zmm17, %zmm16
; AVX512F-SLOW-NEXT:    vpbroadcastq 88(%r8), %ymm14
; AVX512F-SLOW-NEXT:    vpbroadcastq 96(%r8), %ymm18
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm18, %zmm14, %zmm14
...
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm16, %zmm18, %zmm14
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, {{[-0-9]+}}(%r{{[sb]}}p), %zmm0, %zmm16 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm20, %zmm31, %zmm19
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm16, %zmm17, %zmm19
; AVX512F-SLOW-NEXT:    vpbroadcastq 24(%r8), %ymm16
<<<<<<< HEAD
; AVX512F-SLOW-NEXT:    vpbroadcastq 32(%r8), %ymm20
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm20, %zmm16, %zmm16
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm19, %zmm18, %zmm16
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm18 = ymm21[0,1,0,1]
; AVX512F-SLOW-NEXT:    vpermq $4, {{[-0-9]+}}(%r{{[sb]}}p), %ymm19 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm19 = mem[0,1,0,0]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[2,3,2,3]
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm3, %zmm12, %zmm3
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa 64(%r8), %ymm12
; AVX512F-SLOW-NEXT:    vpshufb %ymm4, %ymm12, %ymm0 ;INTEL
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm12 = ymm12[0,1,1,1]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm20 = ymm29[0,1,0,1] ;INTEL
...
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm27 = ymm27[2,3,2,2]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm28 = ymm25[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm15 = ymm24[2,2,3,2]
...
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm5 = ymm5[2,2,3,2]
; AVX512F-SLOW-NEXT:    vpandnq 80(%r8){1to4}, %ymm6, %ymm6
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm0
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm6 = [65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0]
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm4 # 64-byte Reload
; AVX512F-SLOW-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm6, %zmm4 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm6, %zmm26 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm6 = [65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535]
=======
; AVX512F-SLOW-NEXT:    vpbroadcastq 32(%r8), %ymm22
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm22, %zmm16, %zmm16
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm21, %zmm18, %zmm16
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm18 = ymm23[0,1,0,1]
; AVX512F-SLOW-NEXT:    vpermq $4, {{[-0-9]+}}(%r{{[sb]}}p), %ymm21 # 32-byte Folded Reload
; AVX512F-SLOW-NEXT:    # ymm21 = mem[0,1,0,0]
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm4 = ymm4[2,3,2,3]
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm13, %zmm4
; AVX512F-SLOW-NEXT:    vmovdqa 64(%r8), %ymm13
; AVX512F-SLOW-NEXT:    vpshufb %ymm1, %ymm13, %ymm0
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm13 = ymm13[0,1,1,1]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm22 = ymm30[0,1,0,1]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm23 = ymm28[0,1,0,0]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm15 = ymm15[0,1,1,1]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm24 = ymm24[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm25 = ymm25[2,3,2,2]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm30 = ymm27[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm12 = ymm20[2,2,3,2]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm9 = ymm9[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm7 = ymm7[2,3,2,2]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX512F-SLOW-NEXT:    vpermq {{.*#+}} ymm2 = ymm19[2,2,3,2]
; AVX512F-SLOW-NEXT:    vpandnq 80(%r8){1to4}, %ymm5, %ymm1
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm1 = [65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0]
; end INTEL_CUSTOMIZATION
...
; AVX512F-SLOW-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm1, %zmm29 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm1 = [65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535]
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm5 # 64-byte Reload
; AVX512F-SLOW-NEXT:    vpternlogq $248, %zmm1, %zmm19, %zmm5
; AVX512F-SLOW-NEXT:    vpternlogq $248, %zmm1, %zmm29, %zmm10
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm21, %zmm18, %zmm1
; AVX512F-SLOW-NEXT:    vpermq $68, {{[-0-9]+}}(%r{{[sb]}}p), %zmm18 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    # zmm18 = mem[0,1,0,1,4,5,4,5]
...
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm1, %zmm19, %zmm18
; AVX512F-SLOW-NEXT:    vpbroadcastq 64(%r8), %ymm1
...
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm18, %zmm13, %zmm1
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm23, %zmm22, %zmm18
; AVX512F-SLOW-NEXT:    vpermq $68, {{[-0-9]+}}(%r{{[sb]}}p), %zmm20 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    # zmm20 = mem[0,1,0,1,4,5,4,5]
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm18, %zmm19, %zmm20
; AVX512F-SLOW-NEXT:    vpbroadcastq (%r8), %ymm18
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm15, %zmm18, %zmm15
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm20, %zmm13, %zmm15
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm25, %zmm24, %zmm13
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm12, %zmm30, %zmm12
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm13, %zmm19, %zmm12
; AVX512F-SLOW-NEXT:    vpbroadcastq 112(%r8), %ymm13
; AVX512F-SLOW-NEXT:    vpbroadcastq 120(%r8), %ymm18
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm18, %zmm13, %zmm13
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm18 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0]
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm12, %zmm18, %zmm13
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm7, %zmm9, %zmm7
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm2, %zmm6, %zmm2
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm7, %zmm19, %zmm2
; AVX512F-SLOW-NEXT:    vpbroadcastq 48(%r8), %ymm6
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm24 # 64-byte Reload
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vpternlogq $248, %zmm6, %zmm4, %zmm24
; AVX512F-SLOW-NEXT:    vpternlogq $248, %zmm6, %zmm26, %zmm10
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm19, %zmm18, %zmm6
...
; AVX512F-SLOW-NEXT:    vpternlogq $184, {{[-0-9]+}}(%r{{[sb]}}p), %zmm18, %zmm6 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    vpbroadcastq 64(%r8), %ymm19
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm12, %zmm19, %zmm12
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm19 = [65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535]
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm6, %zmm19, %zmm12
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm21, %zmm20, %zmm6
; AVX512F-SLOW-NEXT:    vpternlogq $184, {{[-0-9]+}}(%r{{[sb]}}p), %zmm18, %zmm6 # 64-byte Folded Reload
; AVX512F-SLOW-NEXT:    vpbroadcastq (%r8), %ymm20
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm1, %zmm20, %zmm1
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm6, %zmm19, %zmm1
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm27, %zmm23, %zmm6
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm15, %zmm28, %zmm15
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm6, %zmm18, %zmm15
; AVX512F-SLOW-NEXT:    vpbroadcastq 112(%r8), %ymm6
; AVX512F-SLOW-NEXT:    vpbroadcastq 120(%r8), %ymm19
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm19, %zmm6, %zmm6
; AVX512F-SLOW-NEXT:    vmovdqa64 {{.*#+}} zmm19 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0]
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm15, %zmm19, %zmm6
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm13, %zmm9, %zmm9
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm5, %zmm8, %zmm5
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm9, %zmm18, %zmm5
; AVX512F-SLOW-NEXT:    vpbroadcastq 48(%r8), %ymm8
; AVX512F-SLOW-NEXT:    vpbroadcastq 56(%r8), %ymm9
; AVX512F-SLOW-NEXT:    vinserti64x4 $1, %ymm9, %zmm8, %zmm8
; AVX512F-SLOW-NEXT:    vpternlogq $184, %zmm5, %zmm19, %zmm8
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm22, %zmm17, %zmm2
; AVX512F-SLOW-NEXT:    vpternlogq $226, %zmm11, %zmm17, %zmm3
...
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm6, 576(%r9)
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm1, (%r9)
; end INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm10, 192(%r9)
<<<<<<< HEAD
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm16, 128(%r9) ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm12, 320(%r9)
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm14, 448(%r9) ;INTEL
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm24, 512(%r9)
; AVX512F-SLOW-NEXT:    addq $680, %rsp # imm = 0x2A8 ;INTEL
=======
; INTEL_CUSTOMIZATION
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm16, 128(%r9)
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm1, 320(%r9)
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm14, 448(%r9)
; AVX512F-SLOW-NEXT:    vmovdqa64 %zmm5, 512(%r9)
...
; AVX512F-FAST:       # %bb.0:
<<<<<<< HEAD
; AVX512F-FAST-NEXT:    subq $424, %rsp # imm = 0x1A8 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa 96(%rcx), %ymm9 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm1 = <u,u,12,13,u,u,0,1,u,u,u,u,14,15,u,u,u,u,28,29,u,u,16,17,u,u,u,u,30,31,u,u>
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm9, %ymm0 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa %ymm1, %ymm10 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 96(%rdx), %ymm20
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm1 = ymm20[3,0,3,0,7,4,7,4]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4,5],ymm0[6],ymm1[7,8],ymm0[9],ymm1[10],ymm0[11],ymm1[12,13],ymm0[14],ymm1[15]
; AVX512F-FAST-NEXT:    vmovdqa 96(%rcx), %xmm4 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm3 = <10,11,u,u,6,7,u,u,8,9,8,9,u,u,8,9> ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm4, %xmm1 ;INTEL
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa 96(%rsi), %ymm11
=======
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    subq $520, %rsp # imm = 0x208
; AVX512F-FAST-NEXT:    vmovdqa 96(%rcx), %ymm10
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm1 = <u,u,12,13,u,u,0,1,u,u,u,u,14,15,u,u,u,u,28,29,u,u,16,17,u,u,u,u,30,31,u,u>
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm10, %ymm0
...
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4,5],ymm0[6],ymm1[7,8],ymm0[9],ymm1[10],ymm0[11],ymm1[12,13],ymm0[14],ymm1[15]
; AVX512F-FAST-NEXT:    vmovdqa 96(%rcx), %xmm13
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm14 = <10,11,u,u,6,7,u,u,8,9,8,9,u,u,8,9>
; AVX512F-FAST-NEXT:    vpshufb %xmm14, %xmm13, %xmm1
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa 96(%rdx), %xmm15
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} xmm3 = xmm15[1,2,2,2]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0],xmm3[1],xmm1[2],xmm3[3],xmm1[4,5],xmm3[6],xmm1[7]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[0,1,0,0]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm0
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm5[1,1,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2,3],ymm0[4],ymm1[5],ymm0[6],ymm1[7,8],ymm0[9],ymm1[10,11],ymm0[12],ymm1[13],ymm0[14],ymm1[15]
; AVX512F-FAST-NEXT:    vmovdqa 96(%rsi), %xmm1
; AVX512F-FAST-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm2 = <6,7,u,u,10,11,6,7,u,u,8,9,u,u,12,13>
; AVX512F-FAST-NEXT:    vpshufb %xmm2, %xmm1, %xmm1
; AVX512F-FAST-NEXT:    vpbroadcastq 104(%rdi), %xmm6
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0],xmm6[1],xmm1[2,3],xmm6[4],xmm1[5],xmm6[6],xmm1[7]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[0,1,0,1]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm22
...
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm1 = [65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535]
...
; AVX512F-FAST-NEXT:    vpshufb %xmm2, %xmm6, %xmm7
; AVX512F-FAST-NEXT:    vpbroadcastq 72(%rdi), %xmm8
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm7 = xmm7[0],xmm8[1],xmm7[2,3],xmm8[4],xmm7[5],xmm8[6],xmm7[7]
; AVX512F-FAST-NEXT:    vmovdqa 64(%rdi), %xmm8
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm6 = xmm8[0],xmm6[0],xmm8[1],xmm6[1],xmm8[2],xmm6[2],xmm8[3],xmm6[3]
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm8 = [0,1,2,3,8,9,10,11,4,5,4,5,6,7,12,13]
; AVX512F-FAST-NEXT:    vpshufb %xmm8, %xmm6, %xmm6
; AVX512F-FAST-NEXT:    vshufi64x2 {{.*#+}} zmm6 = zmm6[0,1,0,1],zmm7[0,1,0,1]
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-FAST-NEXT:    vmovdqa 64(%rdx), %xmm6
; AVX512F-FAST-NEXT:    vmovdqa 64(%rcx), %xmm7
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm12 = xmm7[0],xmm6[0],xmm7[1],xmm6[1],xmm7[2],xmm6[2],xmm7[3],xmm6[3]
; AVX512F-FAST-NEXT:    vmovdqa %xmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm7, %xmm7
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} xmm6 = xmm6[1,2,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm6 = xmm7[0],xmm6[1],xmm7[2],xmm6[3],xmm7[4,5],xmm6[6],xmm7[7]
; AVX512F-FAST-NEXT:    vmovdqu %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-FAST-NEXT:    vpshufb %xmm2, %xmm0, %xmm6
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa (%rdi), %xmm7
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm7 = xmm7[0],xmm0[0],xmm7[1],xmm0[1],xmm7[2],xmm0[2],xmm7[3],xmm0[3]
; AVX512F-FAST-NEXT:    vmovdqa 32(%rcx), %ymm0
; AVX512F-FAST-NEXT:    vpshufb %xmm8, %xmm7, %xmm7
; AVX512F-FAST-NEXT:    vshufi64x2 {{.*#+}} zmm6 = zmm7[0,1,0,1],zmm6[0,1,0,1]
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm0, %ymm6
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa64 32(%rdx), %ymm25
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm7 = ymm25[3,0,3,0,7,4,7,4] ;INTEL
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm6 = ymm7[0],ymm6[1],ymm7[2],ymm6[3],ymm7[4,5],ymm6[6],ymm7[7,8],ymm6[9],ymm7[10],ymm6[11],ymm7[12,13],ymm6[14],ymm7[15] ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa 32(%rdx), %xmm8
; AVX512F-FAST-NEXT:    vmovdqa 32(%rcx), %xmm12
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm12, %xmm7
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} xmm10 = xmm8[1,2,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm7 = xmm7[0],xmm10[1],xmm7[2],xmm10[3],xmm7[4,5],xmm10[6],xmm7[7]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm7 = ymm7[0,1,0,0]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm6, %zmm7, %zmm6
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-FAST-NEXT:    vmovdqa64 32(%rdi), %ymm26
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa 32(%rsi), %ymm7
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm7, %ymm6
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm10 = ymm26[1,1,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm10 = ymm10[0],ymm6[1],ymm10[2,3],ymm6[4],ymm10[5],ymm6[6],ymm10[7,8],ymm6[9],ymm10[10,11],ymm6[12],ymm10[13],ymm6[14],ymm10[15]
; AVX512F-FAST-NEXT:    vmovdqa 32(%rsi), %xmm14
; AVX512F-FAST-NEXT:    vpshufb %xmm2, %xmm14, %xmm2
; AVX512F-FAST-NEXT:    vpbroadcastq 40(%rdi), %xmm13
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm2 = xmm2[0],xmm13[1],xmm2[2,3],xmm13[4],xmm2[5],xmm13[6],xmm2[7]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[0,1,0,1]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm10, %zmm2, %zmm24
; AVX512F-FAST-NEXT:    vmovdqa 32(%r8), %ymm2
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm10 = ymm2[0,1,1,1]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm16, %ymm6
; AVX512F-FAST-NEXT:    vpshufb %ymm6, %ymm2, %ymm2 ;INTEL
; AVX512F-FAST-NEXT:    vpandn %ymm10, %ymm1, %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm23 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa (%rcx), %xmm1
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm1, %xmm2
; AVX512F-FAST-NEXT:    vmovdqa (%rdx), %xmm3
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm13 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3]
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} xmm1 = xmm3[1,2,2,2]
...
; AVX512F-FAST-NEXT:    vprolq $16, %ymm11, %ymm2 ;INTEL
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0,1],ymm1[2],ymm2[3],ymm1[4],ymm2[5,6],ymm1[7],ymm2[8,9],ymm1[10],ymm2[11],ymm1[12],ymm2[13,14],ymm1[15] ;INTEL
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm11, %ymm1
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm2 = ymm5[2,3,2,3,6,7,6,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2],ymm2[3],ymm1[4,5],ymm2[6],ymm1[7,8],ymm2[9],ymm1[10],ymm2[11],ymm1[12,13],ymm2[14],ymm1[15]
; AVX512F-FAST-NEXT:    vmovdqu %ymm1, (%rsp) # 32-byte Spill
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm2 = <u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,18,19,u,u,22,23,22,23,u,u,20,21,u,u,24,25>
; AVX512F-FAST-NEXT:    vpshufb %ymm2, %ymm9, %ymm1
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm2, %ymm16
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm2 = ymm20[1,1,1,2,5,5,5,6]
...
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm3[1],ymm1[2],ymm3[3,4],ymm1[5,6,7,8],ymm3[9],ymm1[10],ymm3[11,12],ymm1[13,14,15] ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm5 = ymm20[3,2,3,3,7,6,7,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm5[1],ymm1[2],ymm5[3,4],ymm1[5,6,7,8],ymm5[9],ymm1[10],ymm5[11,12],ymm1[13,14,15]
; AVX512F-FAST-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm5 = xmm4[0],xmm15[0],xmm4[1],xmm15[1],xmm4[2],xmm15[2],xmm4[3],xmm15[3]
; AVX512F-FAST-NEXT:    vmovdqa64 64(%rdi), %ymm27
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa 64(%rsi), %ymm3
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm3, %ymm4
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm9 = ymm27[2,3,2,3,6,7,6,7] ;INTEL
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm4[0],ymm9[1],ymm4[2],ymm9[3],ymm4[4,5],ymm9[6],ymm4[7,8],ymm9[9],ymm4[10],ymm9[11],ymm4[12,13],ymm9[14],ymm4[15] ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm31 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm9 = ymm26[0,1,2,1,4,5,6,5]
; AVX512F-FAST-NEXT:    vprolq $16, %ymm7, %ymm11
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm11[0,1],ymm9[2],ymm11[3],ymm9[4],ymm11[5,6],ymm9[7],ymm11[8,9],ymm9[10],ymm11[11],ymm9[12],ymm11[13,14],ymm9[15]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm18
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm7, %ymm7
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm9 = ymm26[2,3,2,3,6,7,6,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm7[0],ymm9[1],ymm7[2],ymm9[3],ymm7[4,5],ymm9[6],ymm7[7,8],ymm9[9],ymm7[10],ymm9[11],ymm7[12,13],ymm9[14],ymm7[15]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm28
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm16, %ymm11
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm0, %ymm7
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm9 = ymm25[1,1,1,2,5,5,5,6]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm7[0],ymm9[1],ymm7[2,3],ymm9[4],ymm7[5],ymm9[6],ymm7[7,8],ymm9[9],ymm7[10,11],ymm9[12],ymm7[13],ymm9[14],ymm7[15] ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm29 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm2, %ymm0, %ymm0 ;INTEL
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm7 = ymm25[3,2,3,3,7,6,7,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm7[1],ymm0[2],ymm7[3,4],ymm0[5,6,7,8],ymm7[9],ymm0[10],ymm7[11,12],ymm0[13,14,15] ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm0, %ymm30
; AVX512F-FAST-NEXT:    vmovdqa (%rcx), %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm2, %ymm1, %ymm2 ;INTEL
...
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm12[0],xmm8[0],xmm12[1],xmm8[1],xmm12[2],xmm8[2],xmm12[3],xmm8[3]
...
; AVX512F-FAST-NEXT:    vpshufb %xmm0, %xmm5, %xmm8
; AVX512F-FAST-NEXT:    vpshufb %xmm0, %xmm15, %xmm0
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm0, %ymm17
; AVX512F-FAST-NEXT:    vmovdqa (%rsi), %ymm15
; AVX512F-FAST-NEXT:    vpshufb %ymm10, %ymm15, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa64 (%rdi), %ymm26
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm10 = ymm26[2,3,2,3,6,7,6,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm13 = ymm0[0],ymm10[1],ymm0[2],ymm10[3],ymm0[4,5],ymm10[6],ymm0[7,8],ymm10[9],ymm0[10],ymm10[11],ymm0[12,13],ymm10[14],ymm0[15]
; AVX512F-FAST-NEXT:    vmovdqa 32(%rdi), %xmm0
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm10 = xmm0[0],xmm14[0],xmm0[1],xmm14[1],xmm0[2],xmm14[2],xmm0[3],xmm14[3]
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm0 = [0,1,2,3,8,9,10,11,4,5,4,5,6,7,12,13]
; AVX512F-FAST-NEXT:    vpshufb %xmm0, %xmm4, %xmm5
; AVX512F-FAST-NEXT:    vpshufb %xmm0, %xmm10, %xmm10
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm9 = <u,u,0,1,u,u,u,u,14,15,u,u,2,3,u,u,u,u,16,17,u,u,u,u,30,31,u,u,18,19,u,u>
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm15, %ymm4
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm14 = ymm26[1,1,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm4 = ymm14[0],ymm4[1],ymm14[2,3],ymm4[4],ymm14[5],ymm4[6],ymm14[7,8],ymm4[9],ymm14[10,11],ymm4[12],ymm14[13],ymm4[14],ymm14[15]
; AVX512F-FAST-NEXT:    vprolq $16, %ymm15, %ymm14
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm15 = ymm26[0,1,2,1,4,5,6,5]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm14 = ymm14[0,1],ymm15[2],ymm14[3],ymm15[4],ymm14[5,6],ymm15[7],ymm14[8,9],ymm15[10],ymm14[11],ymm15[12],ymm14[13,14],ymm15[15]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm14 = ymm14[2,3,2,3]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm4, %zmm4
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm7 = <u,u,12,13,u,u,0,1,u,u,u,u,14,15,u,u,u,u,28,29,u,u,16,17,u,u,u,u,30,31,u,u>
; AVX512F-FAST-NEXT:    vpshufb %ymm7, %ymm1, %ymm14
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm15 = ymm25[3,0,3,0,7,4,7,4]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm14 = ymm15[0],ymm14[1],ymm15[2],ymm14[3],ymm15[4,5],ymm14[6],ymm15[7,8],ymm14[9],ymm15[10],ymm14[11],ymm15[12,13],ymm14[14],ymm15[15]
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm1, %ymm1
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm15 = ymm25[1,1,1,2,5,5,5,6]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm15[1],ymm1[2,3],ymm15[4],ymm1[5],ymm15[6],ymm1[7,8],ymm15[9],ymm1[10,11],ymm15[12],ymm1[13],ymm15[14],ymm1[15]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[2,3,2,3]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm14, %zmm25
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm1 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535]
; AVX512F-FAST-NEXT:    vpandnq 16(%r8){1to4}, %ymm1, %ymm14
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa (%r8), %ymm15
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm0 = [128,128,128,128,12,13,128,128,128,128,128,128,128,128,14,15,128,128,128,128,128,128,128,128,16,17,128,128,128,128,128,128]
; AVX512F-FAST-NEXT:    vpshufb %ymm0, %ymm15, %ymm11
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm11, %zmm11
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm3, %ymm14
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm9 = ymm27[1,1,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm9 = ymm9[0],ymm14[1],ymm9[2,3],ymm14[4],ymm9[5],ymm14[6],ymm9[7,8],ymm14[9],ymm9[10,11],ymm14[12],ymm9[13],ymm14[14],ymm9[15]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vprolq $16, %ymm3, %ymm3
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm14 = ymm27[0,1,2,1,4,5,6,5] ;INTEL
...
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[0,1,0,1] ;INTEL
; AVX512F-FAST-NEXT:    vpermq $4, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    # ymm14 = mem[0,1,0,0]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm12 = ymm12[0,1,0,1] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm26 = ymm19[0,1,0,0]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm15 = ymm15[0,1,1,1] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm3 = ymm3[2,3,2,3]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm3, %zmm9, %zmm3
; AVX512F-FAST-NEXT:    vpshufb %ymm7, %ymm6, %ymm9
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm7 = ymm20[3,0,3,0,7,4,7,4]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm7 = ymm7[0],ymm9[1],ymm7[2],ymm9[3],ymm7[4,5],ymm9[6],ymm7[7,8],ymm9[9],ymm7[10],ymm9[11],ymm7[12,13],ymm9[14],ymm7[15]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm16, %ymm9
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm6, %ymm6
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm9 = ymm20[1,1,1,2,5,5,5,6]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm6 = ymm6[0],ymm9[1],ymm6[2,3],ymm9[4],ymm6[5],ymm9[6],ymm6[7,8],ymm9[9],ymm6[10,11],ymm9[12],ymm6[13],ymm9[14],ymm6[15]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm6 = ymm6[2,3,2,3]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm6, %zmm7, %zmm6
; AVX512F-FAST-NEXT:    vmovdqa 64(%r8), %ymm7
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm9 = ymm7[0,1,1,1]
; AVX512F-FAST-NEXT:    vpshufb %ymm0, %ymm7, %ymm7
; AVX512F-FAST-NEXT:    vpandnq 80(%r8){1to4}, %ymm1, %ymm1
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm7, %zmm1
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm7 = [65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0]
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm7, %zmm22 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm7, %zmm24 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm7 = [65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535]
; AVX512F-FAST-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm27 # 64-byte Reload
; AVX512F-FAST-NEXT:    vpternlogq $248, %zmm7, %zmm22, %zmm27
; AVX512F-FAST-NEXT:    vpternlogq $248, %zmm7, %zmm24, %zmm23
; AVX512F-FAST-NEXT:    vpermq $238, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    # ymm7 = mem[2,3,2,3]
; AVX512F-FAST-NEXT:    vpermq $174, (%rsp), %ymm16 # 32-byte Folded Reload
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm24 = ymm31[2,3,2,2] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm0 = ymm5[0,1,0,1] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm18 = ymm18[2,3,2,3] ;INTEL
...
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm31 = ymm21[2,2,3,2] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm5 = ymm17[0,1,0,1] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm13 = ymm13[2,3,2,2] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm10 = ymm10[0,1,0,1]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm2, %zmm2 ;INTEL
...
; AVX512F-FAST-NEXT:    vpternlogq $184, {{[-0-9]+}}(%r{{[sb]}}p), %zmm14, %zmm2 # 64-byte Folded Reload ;INTEL
; AVX512F-FAST-NEXT:    vpbroadcastq 64(%r8), %ymm17
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm9, %zmm17, %zmm9 ;INTEL
...
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm2, %zmm17, %zmm9 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm26, %zmm12, %zmm2 ;INTEL
; AVX512F-FAST-NEXT:    vpternlogq $184, {{[-0-9]+}}(%r{{[sb]}}p), %zmm14, %zmm2 # 64-byte Folded Reload ;INTEL
...
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm16, %zmm7, %zmm2
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm20, %zmm19, %zmm7
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm2, %zmm14, %zmm7
; AVX512F-FAST-NEXT:    vpbroadcastq 112(%r8), %ymm2
; AVX512F-FAST-NEXT:    vpbroadcastq 120(%r8), %ymm15
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm15, %zmm2, %zmm2
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm15 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0]
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm7, %zmm15, %zmm2
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm8, %zmm22, %zmm7
...
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm7, %zmm8, %zmm0
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm28, %zmm18, %zmm7
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm30, %zmm29, %zmm16
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm7, %zmm14, %zmm16 ;INTEL
; AVX512F-FAST-NEXT:    vpbroadcastq 48(%r8), %ymm7 ;INTEL
; AVX512F-FAST-NEXT:    vpbroadcastq 56(%r8), %ymm14
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm7, %zmm7
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm16, %zmm15, %zmm7
; AVX512F-FAST-NEXT:    vpbroadcastq 88(%r8), %ymm14
; AVX512F-FAST-NEXT:    vpbroadcastq 96(%r8), %ymm15
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm15, %zmm14, %zmm14
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm15 = [0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535]
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm0, %zmm15, %zmm14
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm5, %zmm31, %zmm0
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm10, %zmm13, %zmm5
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm0, %zmm8, %zmm5
; AVX512F-FAST-NEXT:    vpbroadcastq 24(%r8), %ymm0
; AVX512F-FAST-NEXT:    vpbroadcastq 32(%r8), %ymm10
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm10, %zmm0, %zmm0
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm5, %zmm15, %zmm0
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm4, %zmm8, %zmm25
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm3, %zmm8, %zmm6
=======
; AVX512F-FAST-NEXT:    vmovdqa 96(%r8), %ymm1
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm5 = [128,128,128,128,12,13,128,128,128,128,128,128,128,128,14,15,128,128,128,128,128,128,128,128,16,17,128,128,128,128,128,128] ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm5, %ymm1, %ymm4 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm5, %ymm16 ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[0,1,1,1]
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} ymm17 = [65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535] ;INTEL
; AVX512F-FAST-NEXT:    vpandnq %ymm1, %ymm17, %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm4, %zmm1, %zmm1 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm6 = [4,5,2,3,2,3,0,1,10,11,8,9,4,5,6,7]
; AVX512F-FAST-NEXT:    vpshufb %xmm6, %xmm5, %xmm5
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm6, %xmm31
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm2 = ymm5[0,1,0,1]
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-FAST-NEXT:    vpshufb %xmm14, %xmm4, %xmm4
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[1,2,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm1 = xmm4[0],xmm1[1],xmm4[2],xmm1[3],xmm4[4,5],xmm1[6],xmm4[7] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[0,1,0,0]
; AVX512F-FAST-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa (%rsi), %xmm1
; INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vmovdqa 32(%rcx), %ymm11
; AVX512F-FAST-NEXT:    vpshufb %ymm7, %ymm11, %ymm4
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa64 32(%rdx), %ymm27
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm5 = ymm27[3,0,3,0,7,4,7,4]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm5 = ymm5[0],ymm4[1],ymm5[2],ymm4[3],ymm5[4,5],ymm4[6],ymm5[7,8],ymm4[9],ymm5[10],ymm4[11],ymm5[12,13],ymm4[14],ymm5[15]
; AVX512F-FAST-NEXT:    vpshufb %xmm0, %xmm1, %xmm4
; AVX512F-FAST-NEXT:    vpbroadcastq 8(%rdi), %xmm6
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm4 = xmm4[0],xmm6[1],xmm4[2,3],xmm6[4],xmm4[5],xmm6[6],xmm4[7]
...
; AVX512F-FAST-NEXT:    vpshufb %xmm14, %xmm6, %xmm1
; AVX512F-FAST-NEXT:    vmovdqa 32(%rdx), %xmm4
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} xmm7 = xmm4[1,2,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm1 = xmm1[0],xmm7[1],xmm1[2],xmm7[3],xmm1[4,5],xmm7[6],xmm1[7]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[0,1,0,0]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm5, %zmm1, %zmm1 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512F-FAST-NEXT:    vmovdqa 32(%rsi), %ymm7
; AVX512F-FAST-NEXT:    vmovdqa64 32(%rdi), %ymm30
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm7, %ymm1
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm5 = ymm30[1,1,2,2]
...
; AVX512F-FAST-NEXT:    vpbroadcastq 40(%rdi), %xmm12
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} xmm0 = xmm0[0],xmm12[1],xmm0[2,3],xmm12[4],xmm0[5],xmm12[6],xmm0[7]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[0,1,0,1]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm19
; AVX512F-FAST-NEXT:    vmovdqa 32(%r8), %ymm0
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm0[0,1,1,1]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm16, %ymm12
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpandnq %ymm1, %ymm17, %ymm1
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm29
...
; AVX512F-FAST-NEXT:    vpshufb %xmm2, %xmm12, %xmm12
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm2 = ymm12[0,1,0,1]
; AVX512F-FAST-NEXT:    vmovdqu64 %zmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm0 = ymm8[0,1,2,1,4,5,6,5]
; AVX512F-FAST-NEXT:    vprolq $16, %ymm9, %ymm1
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm12 = <u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,30,31,28,29,26,27,30,31,30,31,28,29,30,31,28,29>
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm9, %ymm0
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm1 = ymm8[2,3,2,3,6,7,6,7]
...
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm1 = ymm21[1,1,1,2,5,5,5,6]
...
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm10, %ymm0
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm2 = ymm21[3,2,3,3,7,6,7,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm2[1],ymm0[2],ymm2[3,4],ymm0[5,6,7,8],ymm2[9],ymm0[10],ymm2[11,12],ymm0[13,14,15]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm0, %ymm18
; AVX512F-FAST-NEXT:    vmovdqa64 64(%rdx), %ymm21
; AVX512F-FAST-NEXT:    vmovdqa 64(%rcx), %ymm10
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm10, %ymm0
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm8 = ymm21[3,2,3,3,7,6,7,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm8[1],ymm0[2],ymm8[3,4],ymm0[5,6,7,8],ymm8[9],ymm0[10],ymm8[11,12],ymm0[13,14,15]
; AVX512F-FAST-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm2 = xmm13[0],xmm15[0],xmm13[1],xmm15[1],xmm13[2],xmm15[2],xmm13[3],xmm15[3]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa 64(%rdi), %ymm15
; AVX512F-FAST-NEXT:    vmovdqa 64(%rsi), %ymm9
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm9, %ymm0
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm8 = ymm15[2,3,2,3,6,7,6,7]
...
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm3 = xmm0[0],xmm3[0],xmm0[1],xmm3[1],xmm0[2],xmm3[2],xmm0[3],xmm3[3] ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm7, %ymm0 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm14, %ymm11, %ymm0 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm14, %ymm16 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm11, %ymm0
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm7 = ymm27[3,2,3,3,7,6,7,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm14 = ymm0[0],ymm7[1],ymm0[2],ymm7[3,4],ymm0[5,6,7,8],ymm7[9],ymm0[10],ymm7[11,12],ymm0[13,14,15]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa (%rcx), %ymm0
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm0, %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 (%rdx), %ymm27
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm7 = ymm27[3,2,3,3,7,6,7,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm7[1],ymm1[2],ymm7[3,4],ymm1[5,6,7,8],ymm7[9],ymm1[10],ymm7[11,12],ymm1[13,14,15]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm22
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm6[0],xmm4[0],xmm6[1],xmm4[1],xmm6[2],xmm4[2],xmm6[3],xmm4[3]
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm31, %xmm4
; AVX512F-FAST-NEXT:    vpshufb %xmm4, %xmm2, %xmm8
; AVX512F-FAST-NEXT:    vpshufb %xmm4, %xmm1, %xmm1
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm20
; AVX512F-FAST-NEXT:    vmovdqa (%rsi), %ymm6
; AVX512F-FAST-NEXT:    vpshufb %ymm12, %ymm6, %ymm1
; AVX512F-FAST-NEXT:    vmovdqa64 (%rdi), %ymm30
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm4 = ymm30[2,3,2,3,6,7,6,7]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm12 = ymm1[0],ymm4[1],ymm1[2],ymm4[3],ymm1[4,5],ymm4[6],ymm1[7,8],ymm4[9],ymm1[10],ymm4[11],ymm1[12,13],ymm4[14],ymm1[15]
; AVX512F-FAST-NEXT:    vmovdqa 32(%rdi), %xmm1
; AVX512F-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm4 = xmm1[0],xmm5[0],xmm1[1],xmm5[1],xmm1[2],xmm5[2],xmm1[3],xmm5[3]
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm1 = [0,1,2,3,8,9,10,11,4,5,4,5,6,7,12,13]
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm3, %xmm7
; AVX512F-FAST-NEXT:    vpshufb %xmm1, %xmm4, %xmm1
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm17
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm13 = <u,u,0,1,u,u,u,u,14,15,u,u,2,3,u,u,u,u,16,17,u,u,u,u,30,31,u,u,18,19,u,u>
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm6, %ymm3
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm5 = ymm30[1,1,2,2]
...
; AVX512F-FAST-NEXT:    vprolq $16, %ymm6, %ymm5
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm6 = ymm30[0,1,2,1,4,5,6,5]
...
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm5 = ymm5[2,3,2,3]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm5, %zmm3, %zmm31 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm2 = <u,u,12,13,u,u,0,1,u,u,u,u,14,15,u,u,u,u,28,29,u,u,16,17,u,u,u,u,30,31,u,u>
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm2, %ymm0, %ymm5
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm6 = ymm27[3,0,3,0,7,4,7,4]
...
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm6 = ymm27[1,1,1,2,5,5,5,6]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm6[1],ymm0[2,3],ymm6[4],ymm0[5],ymm6[6],ymm0[7,8],ymm6[9],ymm0[10,11],ymm6[12],ymm0[13],ymm6[14],ymm0[15]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[2,3,2,3]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm5, %zmm27 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa (%r8), %ymm0 ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm5 = ymm0[0,1,1,1] ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm1 = [128,128,128,128,12,13,128,128,128,128,128,128,128,128,14,15,128,128,128,128,128,128,128,128,16,17,128,128,128,128,128,128]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm6 = [65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535]
; AVX512F-FAST-NEXT:    vpandnq 16(%r8){1to4}, %ymm6, %ymm30
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm30, %zmm0, %zmm11
; AVX512F-FAST-NEXT:    vpshufb %ymm13, %ymm9, %ymm3
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm13 = ymm15[1,1,2,2]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm3 = ymm13[0],ymm3[1],ymm13[2,3],ymm3[4],ymm13[5],ymm3[6],ymm13[7,8],ymm3[9],ymm13[10,11],ymm3[12],ymm13[13],ymm3[14],ymm13[15]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vprolq $16, %ymm9, %ymm9
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm13 = ymm15[0,1,2,1,4,5,6,5] ;INTEL
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm9 = ymm9[0,1],ymm13[2],ymm9[3],ymm13[4],ymm9[5,6],ymm13[7],ymm9[8,9],ymm13[10],ymm9[11],ymm13[12],ymm9[13,14],ymm13[15] ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm13 = ymm21[3,0,3,0,7,4,7,4]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm9 = ymm13[0],ymm9[1],ymm13[2],ymm9[3],ymm13[4,5],ymm9[6],ymm13[7,8],ymm9[9],ymm13[10],ymm9[11],ymm13[12,13],ymm9[14],ymm13[15]
; AVX512F-FAST-NEXT:    vpshufb %ymm4, %ymm10, %ymm2
; AVX512F-FAST-NEXT:    vpshufd {{.*#+}} ymm13 = ymm21[1,1,1,2,5,5,5,6]
; AVX512F-FAST-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm13[1],ymm2[2,3],ymm13[4],ymm2[5],ymm13[6],ymm2[7,8],ymm13[9],ymm2[10,11],ymm13[12],ymm2[13],ymm13[14],ymm2[15]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm2 = ymm2[2,3,2,3]
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm2, %zmm9, %zmm2
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa 64(%r8), %ymm9
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm13 = ymm9[0,1,1,1] ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm9, %ymm9
; AVX512F-FAST-NEXT:    vpandnq 80(%r8){1to4}, %ymm6, %ymm6 ;INTEL
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm6, %zmm9, %zmm6 ;INTEL
...
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm9, %zmm28 # 64-byte Folded Reload ;INTEL
; AVX512F-FAST-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm9, %zmm19 # 64-byte Folded Reload ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload ;INTEL
; AVX512F-FAST-NEXT:    vpternlogq $248, %zmm9, %zmm28, %zmm0 ;INTEL
; AVX512F-FAST-NEXT:    vpternlogq $248, %zmm9, %zmm19, %zmm29 ;INTEL
; AVX512F-FAST-NEXT:    vpermq $238, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    # ymm9 = mem[2,3,2,3]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermq $174, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    # ymm15 = mem[2,3,2,2]
; AVX512F-FAST-NEXT:    vpermq $238, {{[-0-9]+}}(%r{{[sb]}}p), %ymm16 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    # ymm16 = mem[2,3,2,3]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm18 = ymm18[2,2,3,2]
; AVX512F-FAST-NEXT:    vpermq $186, {{[-0-9]+}}(%r{{[sb]}}p), %ymm19 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    # ymm19 = mem[2,2,3,2]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm10 = ymm8[0,1,0,1]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm21 = ymm26[2,3,2,2]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm7[0,1,0,1]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm28 = ymm25[2,3,2,3]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm30 = ymm24[2,3,2,2]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm8 = ymm23[2,3,2,3]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm14 = ymm14[2,2,3,2]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm7 = ymm22[2,2,3,2]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm24 = ymm20[0,1,0,1]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm12 = ymm12[2,3,2,2]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm4 = ymm17[0,1,0,1]
; AVX512F-FAST-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm20 # 64-byte Reload
; AVX512F-FAST-NEXT:    vinserti64x4 $1, {{[-0-9]+}}(%r{{[sb]}}p), %zmm20, %zmm20 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    vpermq $68, {{[-0-9]+}}(%r{{[sb]}}p), %zmm22 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    # zmm22 = mem[0,1,0,1,4,5,4,5]
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm23 = [65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535]
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm20, %zmm23, %zmm22
; AVX512F-FAST-NEXT:    vpbroadcastq 64(%r8), %ymm20
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm13, %zmm20, %zmm13
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm20 = [65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535,65535,65535,0,65535,65535]
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm22, %zmm20, %zmm13
; AVX512F-FAST-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm17 # 64-byte Reload
; AVX512F-FAST-NEXT:    vinserti64x4 $1, (%rsp), %zmm17, %zmm17 # 32-byte Folded Reload
; AVX512F-FAST-NEXT:    vpermq $68, {{[-0-9]+}}(%r{{[sb]}}p), %zmm22 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    # zmm22 = mem[0,1,0,1,4,5,4,5]
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm17, %zmm23, %zmm22
; AVX512F-FAST-NEXT:    vpbroadcastq (%r8), %ymm17
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm5, %zmm17, %zmm5
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm22, %zmm20, %zmm5
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm15, %zmm9, %zmm9
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm18, %zmm16, %zmm15
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm9, %zmm23, %zmm15
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm15, %zmm16, %zmm9
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm10, %zmm19, %zmm10
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm1, %zmm21, %zmm1
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm15 = [65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535,65535,0,0,65535,65535]
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm10, %zmm15, %zmm1
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm30, %zmm28, %zmm10
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm8, %zmm8
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm10, %zmm23, %zmm8
; AVX512F-FAST-NEXT:    vpbroadcastq 48(%r8), %ymm10
; AVX512F-FAST-NEXT:    vpbroadcastq 56(%r8), %ymm14
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm10, %zmm10
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm8, %zmm16, %zmm10
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm1, %zmm14, %zmm8
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm24, %zmm7, %zmm1
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm4, %zmm12, %zmm4
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm1, %zmm15, %zmm4
; AVX512F-FAST-NEXT:    vpbroadcastq 24(%r8), %ymm1
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpbroadcastq 32(%r8), %ymm7
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm7, %zmm1, %zmm1
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm4, %zmm14, %zmm1
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm31, %zmm15, %zmm27
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm3, %zmm15, %zmm2
>>>>>>> d9afe4ac26476a145074293d07a03ed321e8f433
...
; AVX512F-FAST-NEXT:    vpternlogq $248, %zmm3, %zmm25, %zmm11
; AVX512F-FAST-NEXT:    vpternlogq $248, %zmm3, %zmm6, %zmm1
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm1, 384(%r9)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm11, 64(%r9)
<<<<<<< HEAD
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm0, 128(%r9)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm7, 256(%r9)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm14, 448(%r9)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm2, 576(%r9)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm12, (%r9)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm23, 192(%r9)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm9, 320(%r9)
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm27, 512(%r9)
; AVX512F-FAST-NEXT:    addq $424, %rsp # imm = 0x1A8
; end INTEL_CUSTOMIZATION
=======
...
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm13, 320(%r9) ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %zmm0, 512(%r9) ;INTEL

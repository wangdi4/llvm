...
; RUN: llc < %s -O0 -mtriple=x86_64-unknown-unknown -mattr=+avx512f,+amx-tile,+amx-fp16,+amx-bf16,+amx-int8,+amx-transpose,+amx-avx512,+amx-tile-evex,+amx-int8-evex,+amx-bf16-evex,+amx-memory | FileCheck %s

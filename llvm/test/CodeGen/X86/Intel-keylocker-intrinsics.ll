...
; RUN: llc < %s -mtriple=x86_64-unkown-unknown -mattr=+keylocker | FileCheck %s --check-prefix=X64
; RUN: llc < %s -mtriple=i386-unkown-unknown -mattr=+keylocker -mattr=+avx2 | FileCheck %s --check-prefix=X32
...
declare <2 x i64> @llvm.x86.aesenc128kl(<2 x i64>, i8*)
declare <2 x i64> @llvm.x86.aesdec128kl(<2 x i64>, i8*)
declare <2 x i64> @llvm.x86.aesenc256kl(<2 x i64>, i8*)
declare <2 x i64> @llvm.x86.aesdec256kl(<2 x i64>, i8*)
...
define <2 x i64> @test_mm_aesenc128kl_si128(<2 x i64> %data, i8* %h) {
; X64-LABEL: test_mm_aesenc128kl_si128:
; X64:       # %bb.0: # %entry
; X64-NEXT:    aesenc128kl     (%rdi), %xmm0
; X64-NEXT:    retq
;
; X32-LABEL: test_mm_aesenc128kl_si128:
; X32:       # %bb.0: # %entry
; X32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X32-NEXT:    aesenc128kl     (%eax), %xmm0
; X32-NEXT:    retl
entry:
  %0 = tail call <2 x i64> @llvm.x86.aesenc128kl(<2 x i64> %data, i8* %h)
  ret <2 x i64> %0
}

define <2 x i64> @test_mm_aesdec128kl_si128(<2 x i64> %data, i8* %h) {
; X64-LABEL: test_mm_aesdec128kl_si128:
; X64:       # %bb.0: # %entry
; X64-NEXT:    aesdec128kl     (%rdi), %xmm0
; X64-NEXT:    retq
;
; X32-LABEL: test_mm_aesdec128kl_si128:
; X32:       # %bb.0: # %entry
; X32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X32-NEXT:    aesdec128kl     (%eax), %xmm0
; X32-NEXT:    retl
entry:
  %0 = tail call <2 x i64> @llvm.x86.aesdec128kl(<2 x i64> %data, i8* %h)
  ret <2 x i64> %0
}

define <2 x i64> @test_mm_aesenc256kl_si128(<2 x i64> %data, i8* %h) {
; X64-LABEL: test_mm_aesenc256kl_si128:
; X64:       # %bb.0: # %entry
; X64-NEXT:    aesenc256kl     (%rdi), %xmm0
; X64-NEXT:    retq
;
; X32-LABEL: test_mm_aesenc256kl_si128:
; X32:       # %bb.0: # %entry
; X32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X32-NEXT:    aesenc256kl     (%eax), %xmm0
; X32-NEXT:    retl
entry:
  %0 = tail call <2 x i64> @llvm.x86.aesenc256kl(<2 x i64> %data, i8* %h)
  ret <2 x i64> %0
}

define <2 x i64> @test_mm_aesdec256kl_si128(<2 x i64> %data, i8* %h) {
; X64-LABEL: test_mm_aesdec256kl_si128:
; X64:       # %bb.0: # %entry
; X64-NEXT:    aesdec256kl     (%rdi), %xmm0
; X64-NEXT:    retq
;
; X32-LABEL: test_mm_aesdec256kl_si128:
; X32:       # %bb.0: # %entry
; X32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X32-NEXT:    aesdec256kl     (%eax), %xmm0
; X32-NEXT:    retl
entry:
  %0 = tail call <2 x i64> @llvm.x86.aesdec256kl(<2 x i64> %data, i8* %h)
  ret <2 x i64> %0
}

define i8 @test_mm_aesencwide256kl_si128(i8* %p, <2 x i64> %v0, <2 x i64> %v1, <2 x i64> %v2, <2 x i64> %v3, <2 x i64> %v4, <2 x i64> %v5, <2 x i64> %v6, <2 x i64> %v7) {
; X64-LABEL: test_mm_aesencwide256kl_si128:
; X64:       # %bb.0: # %entry
; X64-NEXT:    aesenc128widekl (%rdi)
; X64-NEXT:    setb %al
; X64-NEXT:    retq
;
; X32-LABEL: test_mm_aesencwide256kl_si128:
; X32:       # %bb.0: # %entry
; X32-NEXT:    pushl %ebp
; X32-NEXT:    .cfi_def_cfa_offset 8
; X32-NEXT:    .cfi_offset %ebp, -8

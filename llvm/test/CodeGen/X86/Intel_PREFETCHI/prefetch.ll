...
; RUN: llc < %s -mtriple=i686-- -mattr=+sse,+prefetchwt1,+prefetchi | FileCheck %s -check-prefix=PREFETCHI
; RUN: llc < %s -mtriple=i686-- -mattr=-sse,+prefetchwt1,+prefetchi | FileCheck %s -check-prefix=PREFETCHI
...
; PREFETCHI-NEXT:    movl {{[0-9]+}}(%esp), %eax
; PREFETCHI-NEXT:    prefetcht2 (%eax)
; PREFETCHI-NEXT:    prefetcht1 (%eax)
; PREFETCHI-NEXT:    prefetcht0 (%eax)
; PREFETCHI-NEXT:    prefetchnta (%eax)
; PREFETCHI-NEXT:    prefetchwt1 (%eax)
; PREFETCHI-NEXT:    prefetchwt1 (%eax)
; PREFETCHI-NEXT:    prefetchw (%eax)
; PREFETCHI-NEXT:    prefetchwt1 (%eax)
; PREFETCHI-NEXT:    prefetchit0 (%eax)
; PREFETCHI-NEXT:    prefetchit1 (%eax)
; PREFETCHI-NEXT:    retl
entry:
	...
	tail call void @llvm.prefetch( i8* %ptr, i32 1, i32 3, i32 0 )
	tail call void @llvm.prefetch( i8* %ptr, i32 1, i32 2, i32 0 )
	ret void
}

...
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+x87 -enable-intel-advanced-opts -O0 | FileCheck %s --check-prefix=CHECK-NOPINIT
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+x87 -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-X87
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+cmov -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-CMOV
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+mmx -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-MMX
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+sse -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-SSE
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+sse2 -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-SSE2
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+avx -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-AVX
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+avx512f -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-AVX512
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+avx512f -mattr=+cldemote -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-AVX512
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+avx512f -mattr=+sse2 -mattr=+cldemote -mattr=-sse2 -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-AVX512
; RUN: llc < %s -mtriple=x86_64-windows-msvc -mattr=+avx512bw -mattr=+avx512f -mattr=+avx -mattr=+sse2 -mattr=+sse -mattr=+mmx -mattr=+cmov -mattr=+x87 -enable-intel-advanced-opts | FileCheck %s --check-prefix=CHECK-PINIT-MIX

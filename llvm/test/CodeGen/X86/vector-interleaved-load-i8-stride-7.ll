...
; SSE-NEXT:    movdqa %xmm8, %xmm0 ;INTEL
; SSE-NEXT:    pandn %xmm12, %xmm0 ;INTEL
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; INTEL_CUSTOMIZATION
; SSE-NEXT:    pand %xmm8, %xmm2
; SSE-NEXT:    por %xmm0, %xmm2
...
>>>>>>> 23d4254a0f16b604cb1ea64d8def94623e04d283
...
; AVX512BW-ONLY-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm16
...
; AVX512BW-ONLY-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm17
...
; AVX512BW-ONLY-FAST-NEXT:    vporq %xmm6, %xmm19, %xmm6 ;INTEL
...
; INTEL_CUSTOMIZATION
; AVX512BW-ONLY-FAST-NEXT:    vpblendmw %ymm6, %ymm5, %ymm19 {%k6}
...
; AVX512BW-ONLY-FAST-NEXT:    vpshufb {{.*#+}} xmm14 = zero,zero,zero,xmm4[6,13,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX512BW-ONLY-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm12, %zmm12
...
; AVX512BW-ONLY-FAST-NEXT:    vpshufb {{.*#+}} xmm18 = zero,zero,xmm4[0,7,14,u,u,u,u,u,u,u,u,u,u,u]
; AVX512BW-ONLY-FAST-NEXT:    vporq %xmm14, %xmm18, %xmm14
; AVX512BW-ONLY-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm13, %zmm13
...
; AVX512BW-ONLY-FAST-NEXT:    vpshufb {{.*#+}} xmm18 = zero,zero,xmm4[1,8,15,u,u,u,u,u,u,u,u,u,u,u]
; AVX512BW-ONLY-FAST-NEXT:    vporq %xmm16, %xmm18, %xmm16
; AVX512BW-ONLY-FAST-NEXT:    vinserti64x4 $1, %ymm16, %zmm14, %zmm16
...
; AVX512BW-ONLY-FAST-NEXT:    vpblendmw %ymm5, %ymm6, %ymm12 {%k4} ;INTEL
...
; AVX512BW-ONLY-FAST-NEXT:    vpblendmw %ymm5, %ymm6, %ymm12 {%k1}
; AVX512BW-ONLY-FAST-NEXT:    vextracti128 $1, %ymm12, %xmm14
; end INTEL_CUSTOMIZATION
=======
...
; AVX512BW-ONLY-FAST-NEXT:    vpblendmw %ymm5, %ymm6, %ymm12 {%k6}
...
<<<<<<< HEAD
; INTEL_CUSTOMIZATION
; AVX512BW-ONLY-FAST-NEXT:    vpblendmw %ymm6, %ymm5, %ymm12 {%k2}
...
; AVX512BW-ONLY-FAST-NEXT:    vpblendmw %ymm6, %ymm5, %ymm15 {%k4}
; AVX512BW-ONLY-FAST-NEXT:    vextracti32x4 $1, %ymm15, %xmm20
...
; AVX512BW-ONLY-FAST-NEXT:    vpshufb {{.*#+}} xmm23 = xmm4[2,9,u,u,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX512BW-ONLY-FAST-NEXT:    vpshufb {{.*#+}} xmm20 = xmm4[3,10,u,u,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX512BW-ONLY-FAST-NEXT:    vpshufb {{.*#+}} xmm4 = xmm5[u,u,u,u,2,9],zero,zero,zero,xmm5[5,12],zero,zero,xmm5[u,u,u] ;INTEL
...
; AVX512BW-ONLY-FAST-NEXT:    vpor %xmm4, %xmm5, %xmm4 ;INTEL
...
<<<<<<< HEAD
; AVX512DQBW-SLOW-NEXT:    vmovdqa64 {{.*#+}} xmm16 = <u,u,u,u,u,u,4,11,u,u,u,u,u,u,u,u> ;INTEL
; AVX512DQBW-SLOW-NEXT:    vpshufb %xmm16, %xmm11, %xmm5 ;INTEL
...
; AVX512DQBW-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm16
...
; AVX512DQBW-SLOW-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm17
...
; AVX512DQBW-FAST-NEXT:    movw $4644, %r10w # imm = 0x1224 ;INTEL
; AVX512DQBW-FAST-NEXT:    kmovd %r10d, %k4 ;INTEL
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm3, %ymm9, %ymm20 {%k4}
; AVX512DQBW-FAST-NEXT:    vextracti32x4 $1, %ymm20, %xmm21 ;INTEL
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm21 = zero,zero,zero,xmm21[6,13],zero,zero,xmm21[2,9,u,u,u,u,u,u,u] ;INTEL
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm20 = xmm20[1,8,15],zero,zero,xmm20[4,11],zero,zero,xmm20[u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vporq %xmm21, %xmm20, %xmm20 ;INTEL
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} ymm11 = ymm11[u,u,u,u,u,u,u,u,u,0,7,14,5,12,3,10,17,24,31,u,u,u,u,u,u,u,u,u,u,u,u,u] ;INTEL
; AVX512DQBW-FAST-NEXT:    movl $511, %r10d # imm = 0x1FF
; INTEL_CUSTOMIZATION
; AVX512DQBW-FAST-NEXT:    kmovd %r10d, %k7
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %ymm20, %ymm11 {%k7}
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm10, %ymm8, %ymm20 {%k6}
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm21 = xmm20[u,u,u,6,13],zero,zero,xmm20[2,9],zero,zero,zero,xmm20[u,u,u,u]
; end INTEL_CUSTOMIZATION
...
; AVX512DQBW-FAST-NEXT:    vporq %xmm21, %xmm20, %xmm20 ;INTEL
; AVX512DQBW-FAST-NEXT:    vinserti32x4 $1, %xmm20, %ymm0, %ymm12 ;INTEL
; AVX512DQBW-FAST-NEXT:    vmovdqa64 {{.*#+}} ymm20 = <u,u,u,u,1,3,4,6>
<<<<<<< HEAD
; INTEL_CUSTOMIZATION
; AVX512DQBW-FAST-NEXT:    vpermd %ymm18, %ymm20, %ymm20
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} ymm13 = ymm20[u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,u,17,20,27,30]
; AVX512DQBW-FAST-NEXT:    vpblendd {{.*#+}} ymm12 = ymm12[0,1,2,3,4,5,6],ymm13[7]
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = zero,zero,zero,xmm4[6,13,u,u,u,u,u,u,u,u,u,u,u]
; end INTEL_CUSTOMIZATION
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm20 = xmm7[1,8,15],zero,zero,xmm7[u,u,u,u,u,u,u,u,u,u,u]
; INTEL_CUSTOMIZATION
; AVX512DQBW-FAST-NEXT:    vporq %xmm13, %xmm20, %xmm13
; AVX512DQBW-FAST-NEXT:    vinserti64x4 $1, %ymm13, %zmm12, %zmm12
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %zmm12, %zmm11 {%k5}
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm3, %ymm9, %ymm12 {%k1}
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = xmm12[2,9],zero,zero,zero,xmm12[5,12],zero,zero,xmm12[u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm12, %xmm12
...
; INTEL_CUSTOMIZATION
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} ymm12 {%k5} = ymm14[u,u,u,u,u,u,u,u,u,1,8,15,6,13,4,11,18,25,u,u,u,u,u,u,u,u,u,u,u,u,u,u]
...
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm18 = zero,zero,xmm4[0,7,14,u,u,u,u,u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vporq %xmm14, %xmm18, %xmm14
; AVX512DQBW-FAST-NEXT:    vinserti64x4 $1, %ymm14, %zmm13, %zmm14
; AVX512DQBW-FAST-NEXT:    vmovdqu16 %zmm12, %zmm14 {%k7}
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm3, %ymm9, %ymm12 {%k6}
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = xmm12[3,10],zero,zero,zero,xmm12[6,13],zero,zero,xmm12[u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm12, %xmm12
...
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm8, %ymm10, %ymm13 {%k4}
; AVX512DQBW-FAST-NEXT:    vextracti32x4 $1, %ymm13, %xmm16
...
; AVX512DQBW-FAST-NEXT:    vporq %xmm16, %xmm13, %xmm13
; AVX512DQBW-FAST-NEXT:    vinserti128 $1, %xmm13, %ymm0, %ymm13
; AVX512DQBW-FAST-NEXT:    vmovdqa64 208(%rdi), %xmm20
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm16 = xmm20[u,u,u,u,u,u,u,u,u,u,u],zero,zero,zero,xmm20[5,12]
...
; INTEL_CUSTOMIZATION
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %ymm16, %ymm13 {%k2}
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm16 = xmm7[3,10],zero,zero,zero,xmm7[u,u,u,u,u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm18 = zero,zero,xmm4[1,8,15,u,u,u,u,u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vporq %xmm16, %xmm18, %xmm16
; AVX512DQBW-FAST-NEXT:    vinserti64x4 $1, %ymm16, %zmm13, %zmm16
...
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm12, %xmm13
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = xmm13[u,u,u,u,u,u,u],zero,zero,zero,xmm13[6,13],zero,zero,xmm13[2,9]
...
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %ymm12, %ymm19 {%k7}
; AVX512DQBW-FAST-NEXT:    vinserti64x4 $1, %ymm19, %zmm0, %zmm12
; end INTEL_CUSTOMIZATION
...
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm5, %ymm6, %ymm12 {%k4}
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm12, %xmm13
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = xmm13[u,u,u,u,u],zero,zero,xmm13[2,9],zero,zero,zero,xmm13[5,12,u,u]
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm12 = xmm12[u,u,u,u,u,4,11],zero,zero,xmm12[0,7,14],zero,zero,xmm12[u,u]
; AVX512DQBW-FAST-NEXT:    vpor %xmm13, %xmm12, %xmm12
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} ymm13 = ymm15[u,u,u,u,u,u,u,u,u,u,u,u,u,u,3,10,17,24,31,22,29,20,27,u,u,u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vmovdqu16 %ymm13, %ymm12 {%k3}
; AVX512DQBW-FAST-NEXT:    kmovw %k1, {{[-0-9]+}}(%r{{[sb]}}p) # 2-byte Spill
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm18, %ymm17, %ymm13 {%k1}
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm15 = xmm13[u,u,u,u,u,u,u,2,9],zero,zero,zero,xmm13[5,12],zero,zero
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm13, %xmm13
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = xmm13[u,u,u,u,u,u,u],zero,zero,xmm13[0,7,14],zero,zero,xmm13[3,10]
; AVX512DQBW-FAST-NEXT:    vpor %xmm15, %xmm13, %xmm13
; AVX512DQBW-FAST-NEXT:    vinserti128 $1, %xmm13, %ymm0, %ymm13
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %ymm13, %ymm12 {%k7}
; AVX512DQBW-FAST-NEXT:    vinserti64x4 $1, %ymm12, %zmm0, %zmm12
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %zmm12, %zmm11 {%k2}
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm5, %ymm6, %ymm12 {%k1}
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm12, %xmm13
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = xmm13[u,u,u,u,u],zero,zero,xmm13[3,10],zero,zero,zero,xmm13[6,13,u,u]
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm12 = xmm12[u,u,u,u,u,5,12],zero,zero,xmm12[1,8,15],zero,zero,xmm12[u,u]
; AVX512DQBW-FAST-NEXT:    vpor %xmm13, %xmm12, %xmm12
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} ymm13 = ymm23[u,u,u,u,u,u,u,u,u,u,u,u,u,u,4,11,18,25,16,23,30,21,28,u,u,u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vmovdqu16 %ymm13, %ymm12 {%k3}
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm18, %ymm17, %ymm13 {%k6}
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm15 = xmm13[u,u,u,u,u,u,u,3,10],zero,zero,zero,xmm13[6,13],zero,zero
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm13, %xmm13
...
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %ymm13, %ymm12 {%k7}
; AVX512DQBW-FAST-NEXT:    vinserti64x4 $1, %ymm12, %zmm0, %zmm12
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %zmm12, %zmm14 {%k2}
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm5, %ymm6, %ymm12 {%k6}
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = xmm12[u,u,u,u,u,6,13],zero,zero,xmm12[2,9],zero,zero,zero,xmm12[u,u]
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm12, %xmm12
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm12 = xmm12[u,u,u,u,u],zero,zero,xmm12[4,11],zero,zero,xmm12[0,7,14,u,u]
; AVX512DQBW-FAST-NEXT:    vpor %xmm13, %xmm12, %xmm12
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} ymm13 = ymm22[u,u,u,u,u,u,u,u,u,u,u,u,u,u,5,12,19,26,17,24,31,22,29,u,u,u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vmovdqu16 %ymm13, %ymm12 {%k3}
; AVX512DQBW-FAST-NEXT:    vpblendmw %ymm17, %ymm18, %ymm13 {%k4}
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm13, %xmm15
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm15 = xmm15[u,u,u,u,u,u,u],zero,zero,xmm15[2,9],zero,zero,zero,xmm15[5,12]
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm13 = xmm13[u,u,u,u,u,u,u,4,11],zero,zero,xmm13[0,7,14],zero,zero
; AVX512DQBW-FAST-NEXT:    vpor %xmm15, %xmm13, %xmm13
; AVX512DQBW-FAST-NEXT:    vinserti128 $1, %xmm13, %ymm0, %ymm13
; AVX512DQBW-FAST-NEXT:    vmovdqu8 %ymm13, %ymm12 {%k7}
; AVX512DQBW-FAST-NEXT:    vinserti64x4 $1, %ymm12, %zmm0, %zmm12
...
; AVX512DQBW-FAST-NEXT:    vextracti32x4 $1, %ymm19, %xmm22
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm22 = zero,zero,xmm22[2,9],zero,zero,zero,xmm22[5,12,u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm19 = xmm19[4,11],zero,zero,xmm19[0,7,14],zero,zero,xmm19[u,u,u,u,u,u,u]
; AVX512DQBW-FAST-NEXT:    vporq %xmm22, %xmm19, %xmm19
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} ymm19 {%k5} = ymm1[u,u,u,u,u,u,u,u,u,3,10,1,8,15,6,13,20,27,u,u,u,u,u,u,u,u,u,u,u,u,u,u]
; end INTEL_CUSTOMIZATION
...
; AVX512DQBW-FAST-NEXT:    vmovdqu16 %zmm9, %zmm19 {%k5}
; AVX512DQBW-FAST-NEXT:    vextracti128 $1, %ymm15, %xmm9
; end INTEL_CUSTOMIZATION
...
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm4 = xmm7[6,13,u,u,u,u,u,u,u,u,u,u,u,u,u,u] ;INTEL
; AVX512DQBW-FAST-NEXT:    vpunpcklwd {{.*#+}} xmm1 = xmm4[0],xmm1[0],xmm4[1],xmm1[1],xmm4[2],xmm1[2],xmm4[3],xmm1[3] ;INTEL
=======
...
; AVX512DQBW-FAST-NEXT:    vpshufb {{.*#+}} xmm1 = xmm5[u,u,u,u,2,9],zero,zero,zero,xmm5[5,12],zero,zero,xmm5[u,u,u] ;INTEL
...
; AVX512DQBW-FAST-NEXT:    kmovd %eax, %k1
; INTEL_CUSTOMIZATION
; AVX512DQBW-FAST-NEXT:    vinserti32x8 $1, %ymm12, %zmm0, %zmm19 {%k1}
; AVX512DQBW-FAST-NEXT:    vinserti32x8 $1, %ymm13, %zmm0, %zmm9 {%k1}

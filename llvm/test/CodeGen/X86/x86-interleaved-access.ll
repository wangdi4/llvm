...
; INTEL_CUSTOMIZATION
; AVX1-NEXT:    vmovups (%rdi), %ymm0
; AVX1-NEXT:    vshufps {{.*#+}} ymm1 = ymm0[0,0,0,0,4,4,4,4]
; AVX1-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[1,1,1,1,5,5,5,5]
; AVX1-NEXT:    vshufps {{.*#+}} ymm3 = ymm0[2,2,2,2,6,6,6,6]
; AVX1-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[3,3,3,3,7,7,7,7]
...
; AVX2-NEXT:    vbroadcastss %xmm2, %xmm3
; AVX2-NEXT:    vshufps {{.*#+}} xmm4 = xmm2[1,1,1,1]
; end INTEL_CUSTOMIZATION
; AVX2-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[2,2,3,3,6,6,7,7]
; INTEL_CUSTOMIZATION
; AVX2-NEXT:    vshufps {{.*#+}} xmm5 = xmm2[2,2,2,2]
; AVX2-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[3,3,3,3]
; AVX2-NEXT:    vmovups %xmm4, 16(%rsi)
; AVX2-NEXT:    vmovups %xmm3, (%rsi)
; AVX2-NEXT:    vmovups %xmm2, 48(%rsi)
; AVX2-NEXT:    vmovups %xmm5, 32(%rsi)
...
; AVX2-NEXT:    vmovups (%rdi), %xmm3
; AVX2-NEXT:    vshufps {{.*#+}} xmm4 = xmm3[1,1,1,1]
; end INTEL_CUSTOMIZATION
; AVX2-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[2,2,3,3,6,6,7,7]
; INTEL_CUSTOMIZATION
; AVX2-NEXT:    vmovddup {{.*#+}} xmm5 = xmm0[0,0]
; AVX2-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[3,3,3,3]
; AVX2-NEXT:    vinsertf128 $1, %xmm4, %ymm2, %ymm2
; AVX2-NEXT:    vmovups %ymm2, (%rsi)
; AVX2-NEXT:    vinsertf128 $1, %xmm3, %ymm5, %ymm2
...
; AVX512-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[2,2,3,3,6,6,7,7]
; AVX512-NEXT:    vmovddup {{.*#+}} xmm4 = xmm0[0,0]
; AVX512-NEXT:    vshufps {{.*#+}} xmm5 = xmm0[2,3,2,3]
; AVX512-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX512-NEXT:    vinsertf128 $1, %xmm3, %ymm2, %ymm2
; AVX512-NEXT:    vinsertf64x4 $1, %ymm4, %zmm2, %zmm2

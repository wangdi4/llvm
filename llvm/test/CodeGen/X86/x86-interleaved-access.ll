...
; AVX1:       # %bb.0:
; AVX1-NEXT:    vmovups (%rdi), %ymm0
; AVX1-NEXT:    vpermilps {{.*#+}} ymm1 = ymm0[0,0,0,0,4,4,4,4]
; AVX1-NEXT:    vpermilps {{.*#+}} ymm2 = ymm0[1,1,1,1,5,5,5,5]
; AVX1-NEXT:    vpermilps {{.*#+}} ymm3 = ymm0[2,2,2,2,6,6,6,6]
; AVX1-NEXT:    vpermilps {{.*#+}} ymm0 = ymm0[3,3,3,3,7,7,7,7]
; AVX1-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm4
; AVX1-NEXT:    vmovups %ymm4, (%rsi)
; AVX1-NEXT:    vinsertf128 $1, %xmm0, %ymm3, %ymm4
; AVX1-NEXT:    vmovups %ymm4, 32(%rsi)
; AVX1-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3],ymm2[2,3]
; AVX1-NEXT:    vmovups %ymm1, 64(%rsi)
; AVX1-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm3[2,3],ymm0[2,3]
; AVX1-NEXT:    vmovups %ymm0, 96(%rsi)
; AVX1-NEXT:    vzeroupper
; AVX1-NEXT:    retq
;
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vmovups (%rdi), %ymm0
; AVX2-NEXT:    vpermilps {{.*#+}} ymm1 = ymm0[0,0,0,0,4,4,4,4]
; AVX2-NEXT:    vpermilps {{.*#+}} ymm2 = ymm0[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vpermilps {{.*#+}} ymm3 = ymm0[2,2,2,2,6,6,6,6]
; AVX2-NEXT:    vpermilps {{.*#+}} ymm0 = ymm0[3,3,3,3,7,7,7,7]
; AVX2-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm4
; AVX2-NEXT:    vmovups %ymm4, (%rsi)
; AVX2-NEXT:    vinsertf128 $1, %xmm0, %ymm3, %ymm4
; AVX2-NEXT:    vmovups %ymm4, 32(%rsi)
...
; AVX512-NEXT:    vpermilps {{.*#+}} ymm1 = ymm0[0,0,1,1,4,4,5,5]
; AVX512-NEXT:    vmovddup {{.*#+}} ymm2 = ymm1[0,0,2,2]
; AVX512-NEXT:    vpermilpd {{.*#+}} xmm3 = xmm1[1,1]
; AVX512-NEXT:    vpermilps {{.*#+}} ymm0 = ymm0[2,2,3,3,6,6,7,7]
; AVX512-NEXT:    vmovddup {{.*#+}} ymm4 = ymm0[0,0,2,2]
; AVX512-NEXT:    vpermilpd {{.*#+}} xmm5 = xmm0[1,1]
...
; AVX512-NEXT:    vpermilps {{.*#+}} xmm3 = xmm1[2,3,2,3]
; AVX512-NEXT:    vpermilps {{.*#+}} ymm0 = ymm0[2,2,3,3,6,6,7,7]
; AVX512-NEXT:    vmovddup {{.*#+}} xmm4 = xmm0[0,0]
; AVX512-NEXT:    vpermilps {{.*#+}} xmm5 = xmm0[2,3,2,3]
; AVX512-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX512-NEXT:    vinsertf128 $1, %xmm3, %ymm2, %ymm2
; AVX512-NEXT:    vinsertf64x4 $1, %ymm4, %zmm2, %zmm2
; AVX512-NEXT:    vmovups %zmm2, (%rsi)
; AVX512-NEXT:    vinsertf64x4 $1, %ymm0, %zmm1, %zmm0
; AVX512-NEXT:    vpermpd {{.*#+}} zmm0 = zmm0[2,2,3,3,6,6,7,7]

; INTEL: Modified from original which was created by update_test_checks
...
; INTEL: Don't init with undef as this is obvious UB
; CHECK-NEXT:    [[I_0:%.*]] = phi i32 [ -1, [[ENTRY]] ], [ [[I_1_LCSSA:%.*]], [[FOR_COND39_PREHEADER]] ]
...
; INTEL: Don't init with undef as this is obvious UB
  %i.0 = phi i32 [ -1, %entry ], [ %i.1.lcssa, %for.cond39.preheader ]

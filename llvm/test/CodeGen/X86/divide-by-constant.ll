...
; X32-NEXT:    imull $-1431655765, %edi, %ecx # imm = 0xAAAAAAAB ;INTEL
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    popl %esi
; X32-NEXT:    popl %edi
; X32-NEXT:    popl %ebx
...
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    imull $-858993459, %edi, %ecx # imm = 0xCCCCCCCD ;INTEL
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    popl %esi
; X32-NEXT:    popl %edi
; X32-NEXT:    popl %ebx
...
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    imull $-286331153, %edi, %ecx # imm = 0xEEEEEEEF ;INTEL
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    popl %esi
; X32-NEXT:    popl %edi
; X32-NEXT:    retl
...
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    imull $-252645135, %edi, %ecx # imm = 0xF0F0F0F1 ;INTEL
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    popl %esi
; X32-NEXT:    popl %edi
; X32-NEXT:    popl %ebx
...
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    imull $-16843009, %esi, %ecx # imm = 0xFEFEFEFF ;INTEL
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    popl %esi
; X32-NEXT:    retl
;
...
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    imull $-16711935, %edi, %ecx # imm = 0xFF00FF01 ;INTEL
; X32-NEXT:    addl %ecx, %edx ;INTEL
; X32-NEXT:    popl %esi
; X32-NEXT:    popl %edi
; X32-NEXT:    popl %ebx

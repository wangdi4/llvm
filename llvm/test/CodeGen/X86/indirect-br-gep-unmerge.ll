...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    br i1 [[SKIP]], label [[LOOPHEADER:%.*]], label [[DOTSPLIT:%.*]] ;INTEL
; CHECK:       loopHeader:
...
; CHECK-NEXT:    br i1 [[ISGOODVALUE]], label [[LOOPHEADER]], label [[DOTSPLIT]] ;INTEL
; CHECK:       endBlock:
; CHECK-NEXT:    br label [[DOTSPLIT]] ;INTEL
; CHECK:       .split:
; CHECK-NEXT:    [[MERGE:%.*]] = phi ptr [ [[ELEMENTVALUEPTR]], [[ENDBLOCK:%.*]] ], [ [[ARRAY]], [[ENTRY]] ], [ [[ELEMENTVALUEPTR]], [[LOOPFOOTER]] ] ;INTEL

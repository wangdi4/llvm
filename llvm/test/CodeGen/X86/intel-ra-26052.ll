...
; CHECK-NEXT:    movl 136(%rdi), %eax
; CHECK-NEXT:    movl 144(%rdi), %r11d
; CHECK-NEXT:    movl 152(%rdi), %r15d
; CHECK-NEXT:    movq 216(%rdi), %r14
; CHECK-NEXT:    imulq 224(%rdi), %r14
; CHECK-NEXT:    imulq 232(%rdi), %r14
; CHECK-NEXT:    shlq $7, %r14
; CHECK-NEXT:    leaq (%r14,%r14,4), %r14
; CHECK-NEXT:    movq %rsp, %rsi
; CHECK-NEXT:    subq %r14, %rsi
; CHECK-NEXT:    andq $-128, %rsi
; CHECK-NEXT:    movq %rsi, %rsp
; CHECK-NEXT:    movq (%rcx), %rdx
; CHECK-NEXT:    movq %rdx, 64(%rbx) # 8-byte Spill
; CHECK-NEXT:    movq 8(%rcx), %r12
; CHECK-NEXT:    leaq 1(%rdx), %r14
; CHECK-NEXT:    xorl %edx, %edx
; CHECK-NEXT:    cmpq %r14, 264(%rdi)
; CHECK-NEXT:    sete %dl
; CHECK-NEXT:    leaq 1(%r12), %r14
; CHECK-NEXT:    xorl %r13d, %r13d
; CHECK-NEXT:    cmpq %r14, 272(%rdi)
; CHECK-NEXT:    sete %r13b
; CHECK-NEXT:    testl %r15d, %r15d
; CHECK-NEXT:    movl $1, %ecx
; CHECK-NEXT:    movl %r15d, %r8d
; CHECK-NEXT:    cmovel %ecx, %r8d
; CHECK-NEXT:    cmpl $-2147483648, %eax # imm = 0x80000000
; CHECK-NEXT:    movl %r8d, %r14d
; CHECK-NEXT:    cmovel %ecx, %r14d
; CHECK-NEXT:    cmpl $-2147483648, %r11d # imm = 0x80000000
; CHECK-NEXT:    cmovnel %r8d, %ecx
; CHECK-NEXT:    cmpl $-1, %r15d
; CHECK-NEXT:    movq 88(%rdi), %r10
; CHECK-NEXT:    movq %r10, 352(%rbx)
; CHECK-NEXT:    movq 56(%rdi), %r15
; CHECK-NEXT:    movq %r15, 344(%rbx)
; CHECK-NEXT:    leaq (%rdx,%rdx,2), %rdx
; CHECK-NEXT:    movq 216(%rdi,%rdx,8), %rdx
; CHECK-NEXT:    movq %rdx, 144(%rbx) # 8-byte Spill
; CHECK-NEXT:    leaq (%r13,%r13,2), %rdx
; CHECK-NEXT:    movq 224(%rdi,%rdx,8), %rdx
; CHECK-NEXT:    movq %rdx, 136(%rbx) # 8-byte Spill
; CHECK-NEXT:    movq 24(%rdi), %r13
; CHECK-NEXT:    movq %r13, 336(%rbx)
; CHECK-NEXT:    vxorps %xmm0, %xmm0, %xmm0
; CHECK-NEXT:    vmovups %xmm0, 360(%rbx)
; CHECK-NEXT:    cmovnel %r8d, %r14d
; CHECK-NEXT:    cmovnel %r8d, %ecx
; CHECK-NEXT:    cltd
; CHECK-NEXT:    idivl %r14d
...
; CHECK-NEXT:    addq 80(%rbx), %r13 # 8-byte Folded Reload
...
; CHECK-NEXT:    addq 16(%rbx), %r10 # 8-byte Folded Reload
; CHECK-NEXT:    movq %r10, 296(%rbx) # 8-byte Spill
; CHECK-NEXT:    movl %esi, %ecx
; CHECK-NEXT:    shll $6, %ecx
; CHECK-NEXT:    movq %rcx, 184(%rbx) # 8-byte Spill
; CHECK-NEXT:    shll $5, %r12d
; CHECK-NEXT:    movq %r12, 216(%rbx) # 8-byte Spill
...
; CHECK-NEXT:    leal (%rax,%rdx), %r10d
; CHECK-NEXT:    movl %r10d, (%r14,%rcx)
; CHECK-NEXT:    movq %r8, 104(%rbx) # 8-byte Spill
...
; CHECK-NEXT:    movl 632(%rcx,%r14), %r8d
; CHECK-NEXT:    movq 624(%rcx,%r14), %rax
; CHECK-NEXT:    vmovaps 608(%rcx,%r14), %xmm0
; CHECK-NEXT:    vmovaps 592(%rcx,%r14), %xmm1
; CHECK-NEXT:    vmovaps 576(%rcx,%r14), %xmm2
; CHECK-NEXT:    vmovaps 560(%rcx,%r14), %xmm3
; CHECK-NEXT:    vmovaps 544(%rcx,%r14), %xmm4
; CHECK-NEXT:    vmovaps 528(%rcx,%r14), %xmm5
; CHECK-NEXT:    vmovaps 512(%rcx,%r14), %xmm6
; CHECK-NEXT:    vmovaps 496(%rcx,%r14), %xmm7
; CHECK-NEXT:    vmovaps 480(%rcx,%r14), %xmm8
; CHECK-NEXT:    vmovaps 464(%rcx,%r14), %xmm9
; CHECK-NEXT:    vmovaps 448(%rcx,%r14), %xmm10
; CHECK-NEXT:    vmovaps 432(%rcx,%r14), %xmm11
; CHECK-NEXT:    vmovaps 416(%rcx,%r14), %xmm12
; CHECK-NEXT:    vmovaps 400(%rcx,%r14), %xmm13
; CHECK-NEXT:    vmovaps 384(%rcx,%r14), %xmm14
; CHECK-NEXT:    vmovaps 368(%rcx,%r14), %xmm15
; CHECK-NEXT:    movl 364(%rcx,%r14), %r10d
; CHECK-NEXT:    movq 16(%rbx), %r13 # 8-byte Reload
; CHECK-NEXT:  .LBB0_3: # Parent Loop BB0_1 Depth=1
; CHECK-NEXT:    # => This Loop Header: Depth=2
; CHECK-NEXT:    # Child Loop BB0_15 Depth 3
; CHECK-NEXT:    # Child Loop BB0_16 Depth 4
; CHECK-NEXT:    # Child Loop BB0_9 Depth 3
; CHECK-NEXT:    movl %r11d, 360(%rcx,%r14)
; CHECK-NEXT:    movl %r8d, 356(%rcx,%r14)
; CHECK-NEXT:    movl %r10d, 352(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm15, 336(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm14, 320(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm13, 304(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm12, 288(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm11, 272(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm10, 256(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm9, 240(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm8, 224(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm7, 208(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm6, 192(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm5, 176(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm4, 160(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm3, 144(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm2, 128(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm1, 112(%rcx,%r14)
; CHECK-NEXT:    vmovaps %xmm0, 96(%rcx,%r14)
; CHECK-NEXT:    movq %rax, 88(%rcx,%r14)
; CHECK-NEXT:    movq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    movq 280(%rbx), %r10 # 8-byte Reload
; CHECK-NEXT:    vmovaps (%r10,%r8), %xmm0
; CHECK-NEXT:    movq 8(%rcx,%r14), %r8
; CHECK-NEXT:    vmovaps %xmm0, (%r8)
; CHECK-NEXT:    movq 224(%rbx), %r8 # 8-byte Reload
; CHECK-NEXT:    addq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps (%r10,%r8), %xmm0
; CHECK-NEXT:    movq 16(%rcx,%r14), %r8
; CHECK-NEXT:    vmovaps %xmm0, (%r8)
; CHECK-NEXT:    movq 272(%rbx), %r8 # 8-byte Reload
; CHECK-NEXT:    addq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps (%r10,%r8), %xmm0
; CHECK-NEXT:    movq 24(%rcx,%r14), %r8
; CHECK-NEXT:    vmovaps %xmm0, (%r8)
; CHECK-NEXT:    movq 264(%rbx), %r8 # 8-byte Reload
; CHECK-NEXT:    addq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps (%r10,%r8), %xmm0
; CHECK-NEXT:    movq 32(%rcx,%r14), %r8
; CHECK-NEXT:    vmovaps %xmm0, (%r8)
; CHECK-NEXT:    movq 256(%rbx), %r8 # 8-byte Reload
; CHECK-NEXT:    addq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps (%r10,%r8), %xmm0
; CHECK-NEXT:    movq 40(%rcx,%r14), %r8
; CHECK-NEXT:    vmovaps %xmm0, (%r8)
; CHECK-NEXT:    movq 248(%rbx), %r8 # 8-byte Reload
; CHECK-NEXT:    addq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps (%r10,%r8), %xmm0
; CHECK-NEXT:    movq 48(%rcx,%r14), %r8
; CHECK-NEXT:    vmovaps %xmm0, (%r8)
; CHECK-NEXT:    movq 240(%rbx), %r8 # 8-byte Reload
; CHECK-NEXT:    addq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps (%r10,%r8), %xmm0
; CHECK-NEXT:    movq 56(%rcx,%r14), %r8
; CHECK-NEXT:    vmovaps %xmm0, (%r8)
; CHECK-NEXT:    addq 232(%rbx), %rax # 8-byte Folded Reload
; CHECK-NEXT:    shlq $4, %rax
; CHECK-NEXT:    vmovaps (%r10,%rax), %xmm0
; CHECK-NEXT:    movq 64(%rcx,%r14), %rax
; CHECK-NEXT:    vmovaps %xmm0, (%rax)
; CHECK-NEXT:    incq %rdx
; CHECK-NEXT:    cmpq 144(%rbx), %rdx # 8-byte Folded Reload
; CHECK-NEXT:    jae .LBB0_5
; CHECK-NEXT:  # %bb.4: # in Loop: Header=BB0_3 Depth=2
; CHECK-NEXT:    movq 104(%rbx), %r8 # 8-byte Reload
...
; CHECK-NEXT:    movq %rax, 152(%rbx) # 8-byte Spill
; CHECK-NEXT:    xorl %eax, %eax
...
; CHECK-NEXT:    # Child Loop BB0_16 Depth 4
; CHECK-NEXT:    movl 352(%rdx,%r14), %r12d
; CHECK-NEXT:    movq 184(%rbx), %rax # 8-byte Reload
; CHECK-NEXT:    addl %r12d, %eax
; CHECK-NEXT:    movl %eax, 364(%rdx,%r14)
; CHECK-NEXT:    movq %rdx, %rax
; CHECK-NEXT:    orq $96, %rax
; CHECK-NEXT:    vmovaps (%r14,%rax), %xmm5
; CHECK-NEXT:    movq %rdx, %rax
; CHECK-NEXT:    orq $112, %rax
; CHECK-NEXT:    vmovaps (%r14,%rax), %xmm9
; CHECK-NEXT:    vmovaps 128(%rdx,%r14), %xmm7
; CHECK-NEXT:    vmovaps 144(%rdx,%r14), %xmm8
; CHECK-NEXT:    vmovaps 160(%rdx,%r14), %xmm10
; CHECK-NEXT:    vmovaps 176(%rdx,%r14), %xmm11
; CHECK-NEXT:    vmovaps 192(%rdx,%r14), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, 16(%rbx) # 16-byte Spill
; CHECK-NEXT:    vmovaps 208(%rdx,%r14), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, 112(%rbx) # 16-byte Spill
; CHECK-NEXT:    vmovaps 224(%rdx,%r14), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, 64(%rbx) # 16-byte Spill
; CHECK-NEXT:    vmovaps 240(%rdx,%r14), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, 48(%rbx) # 16-byte Spill
; CHECK-NEXT:    vmovaps 256(%rdx,%r14), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, 80(%rbx) # 16-byte Spill
; CHECK-NEXT:    vmovaps 272(%rdx,%r14), %xmm12
; CHECK-NEXT:    vmovaps 288(%rdx,%r14), %xmm13
; CHECK-NEXT:    vmovaps 304(%rdx,%r14), %xmm14
; CHECK-NEXT:    vmovaps 320(%rdx,%r14), %xmm15
; CHECK-NEXT:    vmovaps 336(%rdx,%r14), %xmm6
; CHECK-NEXT:    movl 356(%rdx,%r14), %r10d
...
; CHECK-NEXT:    movl 44(%rbx), %edx # 4-byte Reload
; CHECK-NEXT:    .p2align 4, 0x90
...
; CHECK-NEXT:    shlq $4, %r11
; CHECK-NEXT:    movslq %r10d, %r14
; CHECK-NEXT:    movq %r14, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps (%r15,%r8), %xmm2
; CHECK-NEXT:    movq 312(%rbx), %r8 # 8-byte Reload
; CHECK-NEXT:    movq (%rcx,%r8), %r8
; CHECK-NEXT:    addq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vbroadcastss -1792(%r9,%r8), %xmm0
...
; CHECK-NEXT:    vbroadcastss -1024(%r9,%r8), %xmm0
...
; CHECK-NEXT:    vbroadcastss -768(%r9,%r8), %xmm0
; CHECK-NEXT:    vmovaps 112(%rbx), %xmm4 # 16-byte Reload
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm4 = (xmm3 * xmm0) + xmm4
; CHECK-NEXT:    vmovaps %xmm4, 112(%rbx) # 16-byte Spill
; CHECK-NEXT:    vmovaps 16(%rbx), %xmm4 # 16-byte Reload
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm4 = (xmm2 * xmm0) + xmm4
; CHECK-NEXT:    vmovaps %xmm4, 16(%rbx) # 16-byte Spill
; CHECK-NEXT:    vbroadcastss -512(%r9,%r8), %xmm0
...
; CHECK-NEXT:    movslq %r11d, %r11
; CHECK-NEXT:    shlq $4, %r11
; CHECK-NEXT:    vbroadcastss -1788(%r9,%r8), %xmm4
...
; CHECK-NEXT:    vbroadcastss -1020(%r9,%r8), %xmm4
...
; CHECK-NEXT:    vbroadcastss -764(%r9,%r8), %xmm4
...
; CHECK-NEXT:    vmovaps 16(%rbx), %xmm6 # 16-byte Reload
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm6 = (xmm0 * xmm4) + xmm6
; CHECK-NEXT:    vmovaps %xmm6, 16(%rbx) # 16-byte Spill
; CHECK-NEXT:    vbroadcastss -508(%r9,%r8), %xmm4
...
; CHECK-NEXT:    vbroadcastss -760(%r9,%r8), %xmm2
; CHECK-NEXT:    vmovaps 112(%rbx), %xmm3 # 16-byte Reload
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm3 = (xmm1 * xmm2) + xmm3
; CHECK-NEXT:    vmovaps 16(%rbx), %xmm11 # 16-byte Reload
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm11 = (xmm0 * xmm2) + xmm11
; CHECK-NEXT:    vmovaps %xmm11, 16(%rbx) # 16-byte Spill
; CHECK-NEXT:    vbroadcastss -504(%r9,%r8), %xmm2
; CHECK-NEXT:    vmovaps 192(%rbx), %xmm11 # 16-byte Reload
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm11 = (xmm1 * xmm2) + xmm11
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm10 = (xmm0 * xmm2) + xmm10
; CHECK-NEXT:    vbroadcastss -248(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm8 = (xmm1 * xmm2) + xmm8
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm7 = (xmm0 * xmm2) + xmm7
; CHECK-NEXT:    vbroadcastss 8(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm9 = (xmm2 * xmm1) + xmm9
; CHECK-NEXT:    vmovaps (%r15,%r11), %xmm1
; CHECK-NEXT:    addl %edx, %r14d
; CHECK-NEXT:    movslq %r14d, %r11
; CHECK-NEXT:    shlq $4, %r11
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm5 = (xmm0 * xmm2) + xmm5
; CHECK-NEXT:    vmovaps (%r15,%r11), %xmm0
; CHECK-NEXT:    vbroadcastss -1780(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm6 = (xmm1 * xmm2) + xmm6
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm15 = (xmm0 * xmm2) + xmm15
; CHECK-NEXT:    vbroadcastss -1524(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm14 = (xmm1 * xmm2) + xmm14
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm13 = (xmm0 * xmm2) + xmm13
; CHECK-NEXT:    vbroadcastss -1268(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm12 = (xmm1 * xmm2) + xmm12
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm4 = (xmm0 * xmm2) + xmm4
; CHECK-NEXT:    vmovaps %xmm4, 80(%rbx) # 16-byte Spill
; CHECK-NEXT:    vbroadcastss -1012(%r9,%r8), %xmm2
; CHECK-NEXT:    vmovaps 48(%rbx), %xmm4 # 16-byte Reload
...
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm4 = (xmm0 * xmm2) + xmm4
; CHECK-NEXT:    vmovaps %xmm4, 64(%rbx) # 16-byte Spill
; CHECK-NEXT:    vbroadcastss -756(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm3 = (xmm1 * xmm2) + xmm3
; CHECK-NEXT:    vmovaps %xmm3, 112(%rbx) # 16-byte Spill
; CHECK-NEXT:    vmovaps 16(%rbx), %xmm3 # 16-byte Reload
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm3 = (xmm0 * xmm2) + xmm3
; CHECK-NEXT:    vmovaps %xmm3, 16(%rbx) # 16-byte Spill
; CHECK-NEXT:    vbroadcastss -500(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm11 = (xmm1 * xmm2) + xmm11
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm10 = (xmm0 * xmm2) + xmm10
; CHECK-NEXT:    vbroadcastss -244(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm8 = (xmm1 * xmm2) + xmm8
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm7 = (xmm0 * xmm2) + xmm7
; CHECK-NEXT:    vbroadcastss 12(%r9,%r8), %xmm2
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm9 = (xmm2 * xmm1) + xmm9
; CHECK-NEXT:    vfmadd231ps {{.*#+}} xmm5 = (xmm0 * xmm2) + xmm5
; CHECK-NEXT:    addl %edi, %r12d
; CHECK-NEXT:    addl %esi, %r12d
; CHECK-NEXT:    addl %edi, %r10d
; CHECK-NEXT:    addl %esi, %r10d
; CHECK-NEXT:    incq %rax
...
; CHECK-NEXT:    vmovaps %xmm6, 368(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm15, 384(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm14, 400(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm13, 416(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm12, 432(%rcx,%rdx)
; CHECK-NEXT:    vmovaps 80(%rbx), %xmm0 # 16-byte Reload
; CHECK-NEXT:    vmovaps %xmm0, 448(%rcx,%rdx)
; CHECK-NEXT:    vmovaps 48(%rbx), %xmm0 # 16-byte Reload
; CHECK-NEXT:    vmovaps %xmm0, 464(%rcx,%rdx)
; CHECK-NEXT:    vmovaps 64(%rbx), %xmm0 # 16-byte Reload
; CHECK-NEXT:    vmovaps %xmm0, 480(%rcx,%rdx)
; CHECK-NEXT:    vmovaps 112(%rbx), %xmm0 # 16-byte Reload
; CHECK-NEXT:    vmovaps %xmm0, 496(%rcx,%rdx)
; CHECK-NEXT:    vmovaps 16(%rbx), %xmm0 # 16-byte Reload
; CHECK-NEXT:    vmovaps %xmm0, 512(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm11, 528(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm10, 544(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm8, 560(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm7, 576(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm9, 592(%rcx,%rdx)
; CHECK-NEXT:    vmovaps %xmm5, 608(%rcx,%rdx)
; CHECK-NEXT:    movq %rdx, %rax
; CHECK-NEXT:    orq $88, %rax
; CHECK-NEXT:    movq (%rcx,%rax), %rax
; CHECK-NEXT:    addq 288(%rbx), %rax # 8-byte Folded Reload
; CHECK-NEXT:    movq %rax, 624(%rcx,%rdx)
; CHECK-NEXT:    movl 356(%rcx,%rdx), %eax
; CHECK-NEXT:    addl 184(%rbx), %eax # 4-byte Folded Reload
; CHECK-NEXT:    movl %eax, 632(%rcx,%rdx)
; CHECK-NEXT:    movq 176(%rbx), %rax # 8-byte Reload
; CHECK-NEXT:    incq %rax
; CHECK-NEXT:    cmpq 144(%rbx), %rax # 8-byte Folded Reload
; CHECK-NEXT:    movq %rcx, %r14
; CHECK-NEXT:    jb .LBB0_20
; CHECK-NEXT:  # %bb.18: # in Loop: Header=BB0_15 Depth=3
; CHECK-NEXT:    movq 152(%rbx), %rcx # 8-byte Reload
; CHECK-NEXT:    incq %rcx
; CHECK-NEXT:    movq %rcx, %rax
; CHECK-NEXT:    movq %rcx, 152(%rbx) # 8-byte Spill
...
; CHECK-NEXT:    movq %r13, 16(%rbx) # 8-byte Spill
...
; CHECK-NEXT:    movq 160(%rbx), %r13 # 8-byte Reload
; CHECK-NEXT:    movl -248(%r13,%rcx), %r11d
; CHECK-NEXT:    addl %r8d, %r11d
; CHECK-NEXT:    cmpl 168(%rbx), %r11d # 4-byte Folded Reload
; CHECK-NEXT:    jl .LBB0_2
; CHECK-NEXT:  # %bb.10: # in Loop: Header=BB0_9 Depth=3
; CHECK-NEXT:    movq %r8, %r12
; CHECK-NEXT:    movslq -528(%r13,%rcx), %rax
; CHECK-NEXT:    movslq %esi, %r8
; CHECK-NEXT:    imulq %rax, %r8
; CHECK-NEXT:    movslq -608(%r13,%rcx), %r10
; CHECK-NEXT:    addq %r8, %r10
; CHECK-NEXT:    leal (%r10,%r12), %eax
; CHECK-NEXT:    leal (%r10,%rsi), %r8d
; CHECK-NEXT:    shlq $4, %r10
; CHECK-NEXT:    vmovaps -240(%r13,%rcx), %xmm0
; CHECK-NEXT:    movq 296(%rbx), %r11 # 8-byte Reload
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r10)
; CHECK-NEXT:    movslq %r8d, %r8
; CHECK-NEXT:    movq %r8, %r10
; CHECK-NEXT:    shlq $4, %r10
; CHECK-NEXT:    vmovaps -208(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r10)
; CHECK-NEXT:    addl %esi, %r8d
; CHECK-NEXT:    movslq %r8d, %r8
; CHECK-NEXT:    movq %r8, %r10
; CHECK-NEXT:    shlq $4, %r10
; CHECK-NEXT:    vmovaps -176(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r10)
; CHECK-NEXT:    addl %esi, %r8d
; CHECK-NEXT:    movslq %r8d, %r8
; CHECK-NEXT:    movq %r8, %r10
; CHECK-NEXT:    shlq $4, %r10
; CHECK-NEXT:    vmovaps -144(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r10)
; CHECK-NEXT:    addl %esi, %r8d
; CHECK-NEXT:    movslq %r8d, %r8
; CHECK-NEXT:    movq %r8, %r10
; CHECK-NEXT:    shlq $4, %r10
; CHECK-NEXT:    vmovaps -112(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r10)
; CHECK-NEXT:    addl %esi, %r8d
; CHECK-NEXT:    movslq %r8d, %r8
; CHECK-NEXT:    movq %r8, %r10
; CHECK-NEXT:    shlq $4, %r10
; CHECK-NEXT:    vmovaps -80(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r10)
; CHECK-NEXT:    addl %esi, %r8d
; CHECK-NEXT:    movslq %r8d, %r8
; CHECK-NEXT:    movq %r8, %r10
; CHECK-NEXT:    shlq $4, %r10
; CHECK-NEXT:    vmovaps -48(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r10)
; CHECK-NEXT:    addl %esi, %r8d
; CHECK-NEXT:    movslq %r8d, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps -16(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r8)
; CHECK-NEXT:    cltq
; CHECK-NEXT:    movq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps -224(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r8)
; CHECK-NEXT:    addl %esi, %eax
; CHECK-NEXT:    cltq
; CHECK-NEXT:    movq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps -192(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r8)
; CHECK-NEXT:    addl %esi, %eax
; CHECK-NEXT:    cltq
; CHECK-NEXT:    movq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps -160(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r8)
; CHECK-NEXT:    addl %esi, %eax
; CHECK-NEXT:    cltq
; CHECK-NEXT:    movq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps -128(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r8)
; CHECK-NEXT:    addl %esi, %eax
; CHECK-NEXT:    cltq
; CHECK-NEXT:    movq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps -96(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r8)
; CHECK-NEXT:    addl %esi, %eax
; CHECK-NEXT:    cltq
; CHECK-NEXT:    movq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps -64(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r8)
; CHECK-NEXT:    addl %esi, %eax
; CHECK-NEXT:    cltq
; CHECK-NEXT:    movq %rax, %r8
; CHECK-NEXT:    shlq $4, %r8
; CHECK-NEXT:    vmovaps -32(%r13,%rcx), %xmm0
; CHECK-NEXT:    vmovaps %xmm0, (%r11,%r8)
; CHECK-NEXT:    addl %esi, %eax
; CHECK-NEXT:    cltq
; CHECK-NEXT:    shlq $4, %rax
; CHECK-NEXT:    vmovaps (%r13,%rcx), %xmm0
...
; CHECK-NEXT:    incq %rax
; CHECK-NEXT:    cmpq 136(%rbx), %rax # 8-byte Folded Reload

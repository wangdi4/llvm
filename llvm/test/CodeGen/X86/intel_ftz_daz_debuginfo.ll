...
; CHECK-NOT: !dbg
; CHECK-NEXT:    call void @llvm.x86.sse.stmxcsr(i8* [[TMP1]])
; CHECK-NOT: !dbg
; CHECK-NEXT:    [[STMXCSR:%.*]] = load i32, i32* [[TMP0]], align 4
; CHECK-NOT: !dbg
; CHECK-NEXT:    [[FTZ_DAZ:%.*]] = or i32 [[STMXCSR]], 32832
; CHECK-NOT: !dbg
; CHECK-NEXT:    store i32 [[FTZ_DAZ]], i32* [[TMP0]], align 4
; CHECK-NOT: !dbg
; CHECK-NEXT:    call void @llvm.x86.sse.ldmxcsr(i8* [[TMP1]])
; CHECK-NOT: !dbg

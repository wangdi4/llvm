...
; RUN: llc < %s -disable-peephole -mtriple=i686-unknown-unknown -mattr=+avx512mpsadbw --show-mc-encoding | FileCheck %s --check-prefixes=CHECK,X86
; RUN: llc < %s -disable-peephole -mtriple=x86_64-unknown-unknown -mattr=+avx512mpsadbw --show-mc-encoding | FileCheck %s --check-prefixes=CHECK,X64
...
; X86-NEXT:    vmpsadbw $3, %zmm1, %zmm0, %zmm3 {%k1} {z} # encoding: [0x62,0xf3,0x7e,0xc9,0x42,0xd9,0x03]
...
; X64-NEXT:    vmpsadbw $3, %zmm1, %zmm0, %zmm3 {%k1} {z} # encoding: [0x62,0xf3,0x7e,0xc9,0x42,0xd9,0x03]

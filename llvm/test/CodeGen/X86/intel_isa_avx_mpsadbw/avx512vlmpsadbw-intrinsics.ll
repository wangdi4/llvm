...
; X86-NEXT:    vmpsadbw $4, %ymm1, %ymm0, %ymm0 # encoding: [0x62,0xf3,0x7e,0x28,0x42,0xc1,0x04]
...
; X64-NEXT:    vmpsadbw $4, %ymm1, %ymm0, %ymm0 # encoding: [0x62,0xf3,0x7e,0x28,0x42,0xc1,0x04]
...
; X86-NEXT:    vmpsadbw $4, %xmm1, %xmm0, %xmm0 # encoding: [0x62,0xf3,0x7e,0x08,0x42,0xc1,0x04]
...
; X64-NEXT:    vmpsadbw $4, %xmm1, %xmm0, %xmm0 # encoding: [0x62,0xf3,0x7e,0x08,0x42,0xc1,0x04]

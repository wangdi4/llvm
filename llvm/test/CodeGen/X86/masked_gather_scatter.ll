...
; KNL_32-NEXT:    kxnorw %k0, %k0, %k1
; KNL_32-NEXT:    vxorps %xmm0, %xmm0, %xmm0 ;INTEL
...
; SKX-NEXT:    kxnorw %k0, %k0, %k1
<<<<<<< HEAD
; SKX-NEXT:    vxorps %xmm0, %xmm0, %xmm0 ;INTEL

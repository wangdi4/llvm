...
; KNL_64-NEXT:    vpaddq %zmm3, %zmm2, %zmm2
...
; KNL_64-NEXT:    vbroadcastss (%rdi,%rax,4), %zmm0
; KNL_64-NEXT:    retq
;
; KNL_32-LABEL: test11:
; KNL_32:       # %bb.0:
...
; KNL_32-NEXT:    vbroadcastss (%ecx,%eax,4), %zmm0
; KNL_32-NEXT:    retl
;
; SKX-LABEL: test11:
; SKX:       # %bb.0:
; SKX-NEXT:    movslq %esi, %rax
; SKX-NEXT:    vbroadcastss (%rdi,%rax,4), %zmm0
; SKX-NEXT:    retq
;
; SKX_32-LABEL: test11:
; SKX_32:       # %bb.0:
...
; SKX_32-NEXT:    vbroadcastss (%ecx,%eax,4), %zmm0
; SKX_32-NEXT:    retl
...
; SKX_32-NEXT:    vpmovd2m %xmm1, %k1
; SKX_32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; SKX_32-NEXT:    vpmovqd %ymm2, %xmm1
; SKX_32-NEXT:    vscatterdpd %ymm0, (%eax,%xmm1,8) {%k1}
; SKX_32-NEXT:    vzeroupper
; SKX_32-NEXT:    retl
...
; SKX_32:       # %bb.0:
; SKX_32-NEXT:    vpmovqd %zmm0, %ymm1
; SKX_32-NEXT:    kxnorw %k0, %k0, %k1
; SKX_32-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; SKX_32-NEXT:    vpgatherdd glob_array(,%ymm1,4), %ymm0 {%k1}
; SKX_32-NEXT:    retl
...
; KNL_64-NEXT:    vpinsrq $1, -16(%rdi), %xmm0, %xmm0
; KNL_64-NEXT:    vzeroupper
; KNL_64-NEXT:    retq
;
...
; KNL_32-NEXT:    vpinsrd $2, -16(%eax), %xmm0, %xmm0
; KNL_32-NEXT:    vpinsrd $3, -12(%eax), %xmm0, %xmm0
; KNL_32-NEXT:    vzeroupper
; KNL_32-NEXT:    retl
;
...
; SKX_32-NEXT:    vpinsrd $2, -16(%eax), %xmm0, %xmm0
; SKX_32-NEXT:    vpinsrd $3, -12(%eax), %xmm0, %xmm0
; SKX_32-NEXT:    retl
...
; SKX-NEXT:    vpblendmd (%rdi){1to4}, %xmm1, %xmm0 {%k1}
; SKX-NEXT:    retq
;
...
; SKX_32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; SKX_32-NEXT:    vpblendmd (%eax){1to4}, %xmm1, %xmm0 {%k1}
; SKX_32-NEXT:    retl

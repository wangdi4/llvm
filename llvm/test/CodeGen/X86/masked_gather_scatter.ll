...
; Autogenerated test checks differ from llorg. ; INTEL
...
; KNL_64-LABEL: test9:
; KNL_64:       # %bb.0: # %entry
; KNL_64-NEXT:    vpbroadcastq {{.*#+}} zmm2 = [824,824,824,824,824,824,824,824] ;INTEL
; KNL_64-NEXT:    vpmuludq %zmm2, %zmm0, %zmm3 ;INTEL
; KNL_64-NEXT:    vpsrlq $32, %zmm0, %zmm0
; KNL_64-NEXT:    vpmuludq %zmm2, %zmm0, %zmm0 ;INTEL
; KNL_64-NEXT:    vpsllq $32, %zmm0, %zmm0
; KNL_64-NEXT:    vpbroadcastq %rdi, %zmm2 ;INTEL
; KNL_64-NEXT:    vpaddq %zmm3, %zmm2, %zmm2 ;INTEL
...
; KNL_32-LABEL: test9:
; KNL_32:       # %bb.0: # %entry
; KNL_32-NEXT:    vpbroadcastd {{.*#+}} ymm2 = [80,80,80,80,80,80,80,80] ;INTEL
; KNL_32-NEXT:    vpmulld %ymm2, %ymm1, %ymm1 ;INTEL
; KNL_32-NEXT:    vpmovqd %zmm0, %ymm0
; KNL_32-NEXT:    vpbroadcastd {{.*#+}} ymm2 = [820,820,820,820,820,820,820,820] ;INTEL
; KNL_32-NEXT:    vpmulld %ymm2, %ymm0, %ymm0 ;INTEL
; KNL_32-NEXT:    vpbroadcastd {{[0-9]+}}(%esp), %ymm2 ;INTEL
...
; SKX_SMALL-NEXT:    vpbroadcastq %rdi, %zmm2 ;INTEL
...
; SKX_LARGE-NEXT:    vpbroadcastq %rdi, %zmm2 ;INTEL
...
; KNL_64-NEXT:    vbroadcastss (%rdi,%rax,4), %zmm0 ;INTEL
; KNL_64-NEXT:    retq
;
; KNL_32-LABEL: test11:
; KNL_32:       # %bb.0:
; KNL_32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; KNL_32-NEXT:    movl {{[0-9]+}}(%esp), %ecx ;INTEL
; KNL_32-NEXT:    vbroadcastss (%ecx,%eax,4), %zmm0 ;INTEL
; KNL_32-NEXT:    retl
;
; SKX-LABEL: test11:
; SKX:       # %bb.0:
; SKX-NEXT:    movslq %esi, %rax
; SKX-NEXT:    vbroadcastss (%rdi,%rax,4), %zmm0 ;INTEL
; SKX-NEXT:    retq
;
; SKX_32-LABEL: test11:
; SKX_32:       # %bb.0:
; SKX_32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; SKX_32-NEXT:    movl {{[0-9]+}}(%esp), %ecx ;INTEL
; SKX_32-NEXT:    vbroadcastss (%ecx,%eax,4), %zmm0 ;INTEL
; SKX_32-NEXT:    retl
...
; KNL_32:       # %bb.0:
; INTEL_CUSTOMIZATION
; KNL_32-NEXT:    vpmovqd %zmm0, %ymm1
; KNL_32-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; KNL_32-NEXT:    movw $255, %ax
; KNL_32-NEXT:    kmovw %eax, %k1
; KNL_32-NEXT:    vpgatherdd glob_array(,%zmm1,4), %zmm0 {%k1}
; KNL_32-NEXT:    # kill: def $ymm0 killed $ymm0 killed $zmm0
...
; SKX_32:       # %bb.0:
; SKX_32-NEXT:    vpmovqd %zmm0, %ymm1 ;INTEL
; SKX_32-NEXT:    kxnorw %k0, %k0, %k1
; SKX_32-NEXT:    vpxor %xmm0, %xmm0, %xmm0 ;INTEL
; SKX_32-NEXT:    vpgatherdd glob_array(,%ymm1,4), %ymm0 {%k1} ;INTEL
; SKX_32-NEXT:    retl
...
; KNL_64-NEXT:    vpinsrq $1, -16(%rdi), %xmm0, %xmm0 ;INTEL
; KNL_64-NEXT:    vzeroupper
; KNL_64-NEXT:    retq
;
...
; KNL_32-NEXT:    vpsllq $63, %xmm0, %xmm0
; KNL_32-NEXT:    vptestmq %zmm0, %zmm0, %k0
; KNL_32-NEXT:    movl {{[0-9]+}}(%esp), %eax ;INTEL
; KNL_32-NEXT:    kmovw %k0, %ecx ;INTEL
; KNL_32-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; KNL_32-NEXT:    testb $1, %cl ;INTEL
; KNL_32-NEXT:    jne .LBB58_1
; KNL_32-NEXT:  # %bb.2: # %else
; KNL_32-NEXT:    testb $2, %cl ;INTEL
...
; KNL_32-NEXT:    vpinsrd $2, -16(%eax), %xmm0, %xmm0 ;INTEL
; KNL_32-NEXT:    vpinsrd $3, -12(%eax), %xmm0, %xmm0 ;INTEL
; KNL_32-NEXT:    vzeroupper
; KNL_32-NEXT:    retl
;
; INTEL_CUSTOMIZATION
; SKX-LABEL: gather_2i64_constant_indices:
; SKX:       # %bb.0:
; SKX-NEXT:    vpsllq $63, %xmm0, %xmm0
; SKX-NEXT:    vpmovq2m %xmm0, %k0
; SKX-NEXT:    kmovw %k0, %eax
; SKX-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; SKX-NEXT:    testb $1, %al
; SKX-NEXT:    jne .LBB58_1
; SKX-NEXT:  # %bb.2: # %else
; SKX-NEXT:    testb $2, %al
; SKX-NEXT:    jne .LBB58_3
; SKX-NEXT:  .LBB58_4: # %else2
; SKX-NEXT:    retq
; SKX-NEXT:  .LBB58_1: # %cond.load
; SKX-NEXT:    vmovq {{.*#+}} xmm0 = mem[0],zero
; SKX-NEXT:    testb $2, %al
; SKX-NEXT:    je .LBB58_4
; SKX-NEXT:  .LBB58_3: # %cond.load1
; SKX-NEXT:    vpinsrq $1, -16(%rdi), %xmm0, %xmm0
; SKX-NEXT:    retq
; end INTEL_CUSTOMIZATION
;
...
; SKX_32-NEXT:    vpsllq $63, %xmm0, %xmm0
; SKX_32-NEXT:    vpmovq2m %xmm0, %k0
; SKX_32-NEXT:    movl {{[0-9]+}}(%esp), %eax ;INTEL
; SKX_32-NEXT:    kmovw %k0, %ecx ;INTEL
; SKX_32-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; SKX_32-NEXT:    testb $1, %cl ;INTEL
; SKX_32-NEXT:    jne .LBB58_1
; SKX_32-NEXT:  # %bb.2: # %else
; SKX_32-NEXT:    testb $2, %cl ;INTEL
...
; SKX_32-NEXT:    vpinsrd $2, -16(%eax), %xmm0, %xmm0 ;INTEL
; SKX_32-NEXT:    vpinsrd $3, -12(%eax), %xmm0, %xmm0 ;INTEL
; SKX_32-NEXT:    retl
...
; KNL_64-NEXT:    vmovss %xmm1, (%rdi) ;INTEL
; KNL_64-NEXT:    testb $2, %al
; KNL_64-NEXT:    je .LBB60_4
; KNL_64-NEXT:  .LBB60_3: # %cond.store1
; KNL_64-NEXT:    vextractps $1, %xmm1, -8(%rdi) ;INTEL
; KNL_64-NEXT:    vzeroupper
; KNL_64-NEXT:    retq
;
...
; KNL_32-NEXT:    vmovss %xmm1, (%eax) ;INTEL
; KNL_32-NEXT:    testb $2, %cl ;INTEL
; KNL_32-NEXT:    je .LBB60_4
; KNL_32-NEXT:  .LBB60_3: # %cond.store1
; KNL_32-NEXT:    vextractps $1, %xmm1, -8(%eax) ;INTEL
; KNL_32-NEXT:    vzeroupper
; KNL_32-NEXT:    retl
;
; INTEL_CUSTOMIZATION
; SKX-LABEL: scatter_2i64_constant_indices:
; SKX:       # %bb.0:
; SKX-NEXT:    vpsllq $63, %xmm0, %xmm0
; SKX-NEXT:    vpmovq2m %xmm0, %k0
; SKX-NEXT:    kmovw %k0, %eax
; SKX-NEXT:    testb $1, %al
; SKX-NEXT:    jne .LBB60_1
; SKX-NEXT:  # %bb.2: # %else
; SKX-NEXT:    testb $2, %al
; SKX-NEXT:    jne .LBB60_3
; SKX-NEXT:  .LBB60_4: # %else2
; SKX-NEXT:    retq
; SKX-NEXT:  .LBB60_1: # %cond.store
; SKX-NEXT:    vmovss %xmm1, (%rdi)
; SKX-NEXT:    testb $2, %al
; SKX-NEXT:    je .LBB60_4
; SKX-NEXT:  .LBB60_3: # %cond.store1
; SKX-NEXT:    vextractps $1, %xmm1, -8(%rdi)
; SKX-NEXT:    retq
; end INTEL_CUSTOMIZATION
;
...
; SKX_32-NEXT:    vmovss %xmm1, (%eax) ;INTEL
; SKX_32-NEXT:    testb $2, %cl ;INTEL
; SKX_32-NEXT:    je .LBB60_4
; SKX_32-NEXT:  .LBB60_3: # %cond.store1
; SKX_32-NEXT:    vextractps $1, %xmm1, -8(%eax) ;INTEL
; SKX_32-NEXT:    retl

...
; RUN: llc < %s -mtriple=i386-apple-darwin -mattr=+avx -show-mc-encoding | FileCheck %s --check-prefixes=X86,AVX,X86-AVX-ONLY ;INTEL
; RUN: llc < %s -mtriple=i386-apple-darwin -mattr=+avx512f,+avx512bw,+avx512dq,+avx512vl -show-mc-encoding | FileCheck %s --check-prefixes=X86,AVX,X86-AVX512-ONLY ;INTEL
; RUN: llc < %s -mtriple=x86_64-apple-darwin -mattr=+sse3 -show-mc-encoding | FileCheck %s --check-prefixes=X64,SSE,X64-SSE
; RUN: llc < %s -mtriple=x86_64-apple-darwin -mattr=+avx -show-mc-encoding | FileCheck %s --check-prefixes=X64,AVX,X64-AVX-ONLY ;INTEL
; RUN: llc < %s -mtriple=x86_64-apple-darwin -mattr=+avx512f,+avx512bw,+avx512dq,+avx512vl -show-mc-encoding | FileCheck %s --check-prefixes=X64,AVX,X64-AVX512-ONLY ;INTEL
...
;
; INTEL_CUSTOMIZATION
; X86-AVX-ONLY-LABEL: test_x86_sse3_ldu_dq:
; X86-AVX-ONLY:       ## %bb.0:
; X86-AVX-ONLY-NEXT:    movl {{[0-9]+}}(%esp), %eax ## encoding: [0x8b,0x44,0x24,0x04]
; X86-AVX-ONLY-NEXT:    vmovups (%eax), %xmm0 ## encoding: [0xc5,0xf8,0x10,0x00]
; X86-AVX-ONLY-NEXT:    retl ## encoding: [0xc3]
;
; X86-AVX512-ONLY-LABEL: test_x86_sse3_ldu_dq:
; X86-AVX512-ONLY:       ## %bb.0:
; X86-AVX512-ONLY-NEXT:    movl {{[0-9]+}}(%esp), %eax ## encoding: [0x8b,0x44,0x24,0x04]
; X86-AVX512-ONLY-NEXT:    vmovups (%eax), %xmm0 ## EVEX TO VEX Compression encoding: [0xc5,0xf8,0x10,0x00]
; X86-AVX512-ONLY-NEXT:    retl ## encoding: [0xc3]
...
;
; INTEL_CUSTOMIZATION
; X64-AVX-ONLY-LABEL: test_x86_sse3_ldu_dq:
; X64-AVX-ONLY:       ## %bb.0:
; X64-AVX-ONLY-NEXT:    vmovups (%rdi), %xmm0 ## encoding: [0xc5,0xf8,0x10,0x07]
; X64-AVX-ONLY-NEXT:    retq ## encoding: [0xc3]
;
; X64-AVX512-ONLY-LABEL: test_x86_sse3_ldu_dq:
; X64-AVX512-ONLY:       ## %bb.0:
; X64-AVX512-ONLY-NEXT:    vmovups (%rdi), %xmm0 ## EVEX TO VEX Compression encoding: [0xc5,0xf8,0x10,0x07]
; X64-AVX512-ONLY-NEXT:    retq ## encoding: [0xc3]
; end INTEL_CUSTOMIZATION

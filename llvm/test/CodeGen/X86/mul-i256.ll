...
; X32-NEXT:    movl 12(%ecx), %esi ;INTEL
; X32-NEXT:    movl 8(%ecx), %ebx ;INTEL
...
; X32-NEXT:    addl (%esp), %eax # 4-byte Folded Reload ;INTEL
; X32-NEXT:    movl %eax, (%esp) # 4-byte Spill

...
; X86-NEXT:    movl %eax, (%esp) # 4-byte Spill ;INTEL
...
; X86-NEXT:    addl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Folded Reload ;INTEL
; X86-NEXT:    adcl (%esp), %edx # 4-byte Folded Reload ;INTEL
...
; X86-NEXT:    adcl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Folded Reload ;INTEL
; X86-NEXT:    setb {{[-0-9]+}}(%e{{[sb]}}p) # 1-byte Folded Spill ;INTEL
; X86-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X86-NEXT:    movl {{[0-9]+}}(%esp), %edi
; X86-NEXT:    mull %edi
; X86-NEXT:    movl %edx, %esi
...
; X86-NEXT:    movl %eax, %ebp
; X86-NEXT:    adcl %edi, %esi
; X86-NEXT:    setb (%esp) # 1-byte Folded Spill ;INTEL
; X86-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X86-NEXT:    mull {{[0-9]+}}(%esp)
; X86-NEXT:    addl %esi, %eax
; X86-NEXT:    movzbl (%esp), %esi # 1-byte Folded Reload ;INTEL
; X86-NEXT:    adcl %esi, %edx
; X86-NEXT:    addl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Folded Spill
; X86-NEXT:    adcl %ecx, %ebp
; X86-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NEXT:    movzbl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 1-byte Folded Reload ;INTEL
...
; X86-NEXT:    addl {{[-0-9]+}}(%e{{[sb]}}p), %ebp # 4-byte Folded Reload ;INTEL
...
; X86-NEXT:    movl %edi, %eax ;INTEL
; X86-NEXT:    mull %edx
; X86-NEXT:    addl %edx, %ecx ;INTEL
; X86-NEXT:    imull {{[0-9]+}}(%esp), %edi ;INTEL
; X86-NEXT:    addl %ecx, %edi
...
; X86-NEXT:    movl %ebx, %eax ;INTEL
; X86-NEXT:    mull %ecx
; X86-NEXT:    movl %eax, %ecx
; X86-NEXT:    addl %edx, %ebp ;INTEL
; X86-NEXT:    imull {{[0-9]+}}(%esp), %ebx ;INTEL
; X86-NEXT:    addl %ebp, %ebx
; X86-NEXT:    addl %esi, %ecx
; X86-NEXT:    adcl %edi, %ebx
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NEXT:    addl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Folded Reload ;INTEL
; X86-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NEXT:    movl (%esp), %eax # 4-byte Reload ;INTEL
; X86-NEXT:    adcl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Folded Reload ;INTEL
; X86-NEXT:    movl %eax, (%esp) # 4-byte Spill ;INTEL
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NEXT:    adcl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Folded Reload
; X86-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NEXT:    movl %eax, %edi
; X86-NEXT:    addl %edx, %ebp ;INTEL
; X86-NEXT:    imull {{[0-9]+}}(%esp), %esi ;INTEL
; X86-NEXT:    addl %ebp, %esi
; X86-NEXT:    addl %ecx, %edi
...
; X86-NEXT:    mull %edx
; X86-NEXT:    addl %edx, %ebp ;INTEL
; X86-NEXT:    imull {{[0-9]+}}(%esp), %ecx ;INTEL
...
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    movl %esi, 16(%edx) ;INTEL
; X86-NEXT:    movl (%esp), %esi # 4-byte Reload ;INTEL

...
; AVX-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1 ;INTEL
; AVX-NEXT:    vtestpd %xmm1, %xmm0 ;INTEL
...
; AVX-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1 ;INTEL
; AVX-NEXT:    vtestps %xmm1, %xmm0 ;INTEL
; AVX-NEXT:    setb %al ;INTEL
; AVX-NEXT:    retq
;
...
; AVX1-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1 ;INTEL
; AVX1-NEXT:    vtestps %xmm1, %xmm0 ;INTEL
; AVX1-NEXT:    setb %al ;INTEL
...
; AVX2-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1 ;INTEL
; AVX2-NEXT:    vtestpd %ymm1, %ymm0 ;INTEL
; AVX2-NEXT:    setb %al ;INTEL
...
; AVX2-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1 ;INTEL
; AVX2-NEXT:    vtestps %ymm1, %ymm0 ;INTEL
; AVX2-NEXT:    setb %al ;INTEL
; AVX2-NEXT:    vzeroupper
; AVX2-NEXT:    retq
;
...
;
; INTEL_CUSTOMIZATION
; AVX512-LABEL: icmp0_v16i8_v16i1:
; AVX512:       # %bb.0:
...
;
; INTEL_CUSTOMIZATION
; AVX512-LABEL: icmp0_v32i8_v32i1:
; AVX512:       # %bb.0:
...
; AVX512F-NEXT:    retq
;
; AVX512BW-LABEL: icmp1_v2i64_v2i1:
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    # kill: def $xmm0 killed $xmm0 def $zmm0
...
; AVX512BW-NEXT:    retq
;
; AVX512VL-LABEL: icmp1_v2i64_v2i1:
; AVX512VL:       # %bb.0:
...
; AVX512F-NEXT:    retq
;
; AVX512BW-LABEL: icmp1_v4i32_v4i1:
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    # kill: def $xmm0 killed $xmm0 def $zmm0
; AVX512BW-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1
...
; AVX512BW-NEXT:    retq
;
; AVX512VL-LABEL: icmp1_v4i32_v4i1:
; AVX512VL:       # %bb.0:
; AVX512VL-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1
...
;
; INTEL_CUSTOMIZATION
; AVX512-LABEL: icmp1_v16i8_v16i1:
; AVX512:       # %bb.0:
...
; AVX2-NEXT:    retq
;
; AVX512F-LABEL: icmp1_v4i64_v4i1:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    # kill: def $ymm0 killed $ymm0 def $zmm0
...
; AVX512F-NEXT:    retq
;
; AVX512BW-LABEL: icmp1_v4i64_v4i1:
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    # kill: def $ymm0 killed $ymm0 def $zmm0
...
; AVX512BW-NEXT:    retq
;
; AVX512VL-LABEL: icmp1_v4i64_v4i1:
; AVX512VL:       # %bb.0:
...
; AVX2-NEXT:    retq
;
; AVX512F-LABEL: icmp1_v16i16_v16i1:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1
; AVX512F-NEXT:    vpcmpeqw %ymm1, %ymm0, %ymm0
; AVX512F-NEXT:    vpmovsxwd %ymm0, %zmm0
...
; AVX2-NEXT:    retq
;
; AVX512F-LABEL: icmp1_v32i16_v32i1:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vextracti64x4 $1, %zmm0, %ymm1
...
; AVX2-NEXT:    retq
;
; AVX512F-LABEL: icmp1_v64i8_v64i1:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vextracti64x4 $1, %zmm0, %ymm1
; AVX512F-NEXT:    vpcmpeqd %ymm2, %ymm2, %ymm2
; AVX512F-NEXT:    vpcmpeqb %ymm2, %ymm1, %ymm1

...
; AVX-NEXT:    retq
;
; AVX512-LABEL: icmp0_v16i8_v16i1: ;INTEL
; AVX512:       # %bb.0: ;INTEL
; AVX512-NEXT:    vptest %xmm0, %xmm0 ;INTEL
...
; AVX2-NEXT:    retq
;
; AVX512F-LABEL: icmp1_v32i8_v32i1:
; AVX512F:       # %bb.0:
; AVX512F-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1
...
; AVX-NEXT:    retq
;
; AVX512-LABEL: icmp_v16i8_v16i1: ;INTEL
; AVX512:       # %bb.0: ;INTEL
; AVX512-NEXT:    vpsubb %xmm1, %xmm0, %xmm0 ;INTEL
; AVX512-NEXT:    vptest %xmm0, %xmm0 ;INTEL
; AVX512-NEXT:    sete %al ;INTEL
; AVX512-NEXT:    retq ;INTEL

...
; INTEL_CUSTOMIZATION
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+sse2 -disable-iml-trans | FileCheck %s --check-prefixes=CHECK,SSE,SSE2
...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx2 -disable-iml-trans | FileCheck %s --check-prefixes=CHECK,AVX,AVX2
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx,+xop -disable-iml-trans | FileCheck %s --check-prefixes=CHECK,XOP

...
; CHECK-NEXT:    movq %r9, %r10 # encoding: [0x4d,0x89,0xca]
; CHECK-NEXT:    movq %rcx, %r11 # encoding: [0x49,0x89,0xcb]
...
; CHECK-NEXT:    orb %r15b, %r10b # encoding: [0x45,0x08,0xfa]
...
; CHECK-NEXT:    orb %r10b, %al # encoding: [0x44,0x08,0xd0]
; CHECK-NEXT:    orb %bpl, %al # encoding: [0x40,0x08,0xe8]
; CHECK-NEXT:    kmovd %eax, %k0 # encoding: [0xc5,0xfb,0x92,0xc0]
; CHECK-NEXT:    testq %r9, %r9 # encoding: [0x4d,0x85,0xc9]
; CHECK-NEXT:    setne %al # encoding: [0x0f,0x95,0xc0]
; CHECK-NEXT:    testq %r11, %r11 # encoding: [0x4d,0x85,0xdb]
; CHECK-NEXT:    setne %r10b # encoding: [0x41,0x0f,0x95,0xc2]
; CHECK-NEXT:    andb %al, %r10b # encoding: [0x41,0x20,0xc2]
...
; CHECK-NEXT:    orb %r10b, %cl # encoding: [0x44,0x08,0xd1]

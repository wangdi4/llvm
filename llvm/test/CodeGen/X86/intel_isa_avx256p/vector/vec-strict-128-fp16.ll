...
; CHECK-LABEL: f2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vaddph %xmm1, %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7c,0x08,0x58,0xc1]
...
; CHECK-LABEL: f4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsubph %xmm1, %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7c,0x08,0x5c,0xc1]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f6:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmulph %xmm1, %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7c,0x08,0x59,0xc1]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vdivph %xmm1, %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7c,0x08,0x5e,0xc1]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f10:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsqrtph %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7c,0x08,0x51,0xc0]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f11:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtsd2sh %xmm0, %xmm0, %xmm0 # encoding: [0x62,0xf5,0xff,0x08,0x5a,0xc0]
; CHECK-NEXT:    vmovsh %xmm0, %xmm1, %xmm0 # encoding: [0x62,0xf5,0x76,0x08,0x10,0xc0]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f12:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtsh2sd %xmm1, %xmm1, %xmm1 # encoding: [0x62,0xf5,0x76,0x08,0x5a,0xc9]
; CHECK-NEXT:    vblendps $3, %xmm1, %xmm0, %xmm0 # encoding: [0xc4,0xe3,0x79,0x0c,0xc1,0x03]
; CHECK-NEXT:    # xmm0 = xmm1[0,1],xmm0[2,3]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f13:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vfmadd213ph %xmm2, %xmm1, %xmm0 # encoding: [0x62,0xf6,0x75,0x08,0xa8,0xc2]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f15:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtph2pd %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7c,0x08,0x5a,0xc0]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtpd2ph %xmm0, %xmm0 # encoding: [0x62,0xf5,0xfd,0x08,0x5a,0xc0]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f17:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtss2sh %xmm0, %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7c,0x08,0x1d,0xc0]
; CHECK-NEXT:    vmovsh %xmm0, %xmm1, %xmm0 # encoding: [0x62,0xf5,0x76,0x08,0x10,0xc0]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]
...
; CHECK-LABEL: f18:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vcvtsh2ss %xmm1, %xmm1, %xmm1 # encoding: [0x62,0xf6,0x74,0x08,0x13,0xc9]
...
; CHECK-NEXT:    vblendps $2, %xmm1, %xmm0, %xmm0 # encoding: [0xc4,0xe3,0x79,0x0c,0xc1,0x02]
; CHECK-NEXT:    # xmm0 = xmm0[0],xmm1[1],xmm0[2,3]
...
; CHECK-NEXT:    vcvtps2phx %xmm0, %xmm0 # encoding: [0x62,0xf5,0x7d,0x08,0x1d,0xc0]
; CHECK-NEXT:    ret{{[l|q]}} # encoding: [0xc3]

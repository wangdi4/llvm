...
; RUN: llc < %s -fast-isel -mtriple=i686-unknown-unknown -mattr=+avx256p | FileCheck %s
; RUN: llc < %s -fast-isel -mtriple=x86_64-unknown-unknown -mattr=+avx256p | FileCheck %s

...
; X86-NEXT:    vpaddw %xmm1, %xmm2, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xe9,0xfd,0xc9]
...
; X64-NEXT:    vpaddw %xmm1, %xmm2, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xe9,0xfd,0xc9]
...
; X86-NEXT:    vpaddw %xmm3, %xmm2, %xmm2 # EVEX TO VEX Compression encoding: [0xc5,0xe9,0xfd,0xd3]
...
; X64-NEXT:    vpaddw %xmm3, %xmm2, %xmm2 # EVEX TO VEX Compression encoding: [0xc5,0xe9,0xfd,0xd3]
...
; X86-NEXT:    vxorpd %xmm4, %xmm4, %xmm4 # EVEX TO VEX Compression encoding: [0xc5,0xd9,0x57,0xe4]
...
; X64-NEXT:    vxorpd %xmm4, %xmm4, %xmm4 # EVEX TO VEX Compression encoding: [0xc5,0xd9,0x57,0xe4]
...
; X86-NEXT:    vxorpd %xmm2, %xmm2, %xmm2 # EVEX TO VEX Compression encoding: [0xc5,0xe9,0x57,0xd2]
...
; X64-NEXT:    vxorpd %xmm2, %xmm2, %xmm2 # EVEX TO VEX Compression encoding: [0xc5,0xe9,0x57,0xd2]
...
; X86-NEXT:    vxorps %xmm4, %xmm4, %xmm4 # EVEX TO VEX Compression encoding: [0xc5,0xd8,0x57,0xe4]
...
; X64-NEXT:    vxorps %xmm4, %xmm4, %xmm4 # EVEX TO VEX Compression encoding: [0xc5,0xd8,0x57,0xe4]
...
define <4 x float> @test_mask_vfmadd128_ps_rmkz(<4 x float> %a0, <4 x float> %a1, ptr %ptr_a2) {
...
define <4 x float> @test_mask_vfmadd128_ps_rmkza(<4 x float> %a0, <4 x float> %a1, ptr %ptr_a2) {
...
define <4 x float> @test_mask_vfmadd128_ps_rmbz(<4 x float> %a0, <4 x float> %a1, ptr %ptr_a2) {
...
define <4 x float> @test_mask_vfmadd128_ps_rmbza(<4 x float> %a0, <4 x float> %a1, ptr %ptr_a2) {
...
define <2 x double> @test_mask_vfmadd128_pd_rmkz(<2 x double> %a0, <2 x double> %a1, ptr %ptr_a2) {
...
define <4 x double> @test_mask_vfmadd256_pd_rmkz(<4 x double> %a0, <4 x double> %a1, ptr %ptr_a2) {

...
; RUN: llc < %s -mtriple=x86_64-unknown-unknown -mattr=+avx256p -show-mc-encoding | FileCheck %s --check-prefixes=AVX,X64-AVX,AVX512,X64-AVX512
...
; AVX-LABEL: test1:
; AVX:       # %bb.0:
; AVX-NEXT:    vblendps $12, (%rsi), %xmm0, %xmm0 # encoding: [0xc4,0xe3,0x79,0x0c,0x06,0x0c]
...
; AVX-LABEL: test2:
; AVX:       # %bb.0:
; AVX-NEXT:    vmovaps (%rsi), %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x28,0x0e]
; AVX-NEXT:    vmovlhps %xmm0, %xmm1, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf0,0x16,0xc0]
; AVX-NEXT:    # xmm0 = xmm1[0],xmm0[0]
; AVX-NEXT:    vmovaps %xmm0, (%rdi) # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x29,0x07]
; AVX-NEXT:    retq # encoding: [0xc3]
	%tmp3 = load <2 x double>, ptr %A, align 16
	%tmp7 = insertelement <2 x double> undef, double %B, i32 0
...
; AVX-LABEL: test3:
; AVX:       # %bb.0:
; AVX-NEXT:    vmovaps (%rsi), %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x28,0x06]
; AVX-NEXT:    vunpcklps (%rdx), %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x14,0x02]
...
; AVX-LABEL: test5:
; AVX:       # %bb.0:
; AVX-NEXT:    movq (%rdi), %rax # encoding: [0x48,0x8b,0x07]
; AVX-NEXT:    vmovd (%rax), %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6e,0x00]
; AVX-NEXT:    # xmm0 = mem[0],zero,zero,zero
; AVX-NEXT:    vpmovzxbw %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc4,0xe2,0x79,0x30,0xc0]
; AVX-NEXT:    # xmm0 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero,xmm0[4],zero,xmm0[5],zero,xmm0[6],zero,xmm0[7],zero
; AVX-NEXT:    vpxor %xmm1, %xmm1, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf1,0xef,0xc9]
; AVX-NEXT:    vpunpcklwd %xmm0, %xmm1, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf1,0x61,0xc0]
; AVX-NEXT:    # xmm0 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3]
; AVX-NEXT:    retq # encoding: [0xc3]
...
; AVX-LABEL: test7:
; AVX:       # %bb.0:
; AVX-NEXT:    vxorps %xmm0, %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x57,0xc0]
; AVX-NEXT:    vmovaps %xmm0, 0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x29,0x04,0x25,0x00,0x00,0x00,0x00]
; AVX-NEXT:    retq # encoding: [0xc3]
...
; AVX-LABEL: test8:
; AVX:       # %bb.0:
; AVX-NEXT:    vmovups x(%rip), %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x10,0x05,A,A,A,A]
; AVX-NEXT:    # fixup A - offset: 4, value: x-4, kind: reloc_riprel_4byte
; AVX-NEXT:    retq # encoding: [0xc3]
...
; AVX-LABEL: test9:
; AVX:       # %bb.0:
; AVX-NEXT:    vinsertps $16, %xmm1, %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0x79,0x21,0xc1,0x10]
; AVX-NEXT:    # xmm0 = xmm0[0],xmm1[0],xmm0[2,3]
; AVX-NEXT:    vinsertps $32, %xmm2, %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0x79,0x21,0xc2,0x20]
; AVX-NEXT:    # xmm0 = xmm0[0,1],xmm2[0],xmm0[3]
; AVX-NEXT:    vinsertps $48, %xmm3, %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0x79,0x21,0xc3,0x30]
; AVX-NEXT:    # xmm0 = xmm0[0,1,2],xmm3[0]
; AVX-NEXT:    retq # encoding: [0xc3]
...
; AVX-LABEL: test11:
; AVX:       # %bb.0:
; AVX-NEXT:    vmovlhps %xmm1, %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x16,0xc1]
; AVX-NEXT:    # xmm0 = xmm0[0],xmm1[0]
; AVX-NEXT:    retq # encoding: [0xc3]
...
; AVX-LABEL: test12:
; AVX:       # %bb.0:
; AVX-NEXT:    vmovaps 0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x28,0x04,0x25,0x00,0x00,0x00,0x00]
; AVX-NEXT:    vbroadcastss {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm1 # EVEX TO VEX Compression xmm1 = [1.0E+0,1.0E+0,1.0E+0,1.0E+0]
; AVX-NEXT:    # encoding: [0xc4,0xe2,0x79,0x18,0x0d,A,A,A,A]
; AVX-NEXT:    # fixup A - offset: 5, value: {{\.?LCPI[0-9]+_[0-9]+}}-4, kind: reloc_riprel_4byte
; AVX-NEXT:    vblendps $3, %xmm0, %xmm1, %xmm1 # encoding: [0xc4,0xe3,0x71,0x0c,0xc8,0x03]
; AVX-NEXT:    # xmm1 = xmm0[0,1],xmm1[2,3]
; AVX-NEXT:    vxorps %xmm2, %xmm2, %xmm2 # EVEX TO VEX Compression encoding: [0xc5,0xe8,0x57,0xd2]
; AVX-NEXT:    vunpckhpd %xmm2, %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x15,0xc2]
; AVX-NEXT:    # xmm0 = xmm0[1],xmm2[1]
; AVX-NEXT:    vaddps %xmm0, %xmm1, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf0,0x58,0xc0]
; AVX-NEXT:    vmovaps %xmm0, 0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x29,0x04,0x25,0x00,0x00,0x00,0x00]
; AVX-NEXT:    retq # encoding: [0xc3]
...
; AVX:       # %bb.0:
; AVX-NEXT:    vmovaps (%rsi), %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x28,0x06]
; AVX-NEXT:    vmovaps (%rdi), %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x28,0x0f]
; AVX-NEXT:    vaddps %xmm0, %xmm1, %xmm2 # EVEX TO VEX Compression encoding: [0xc5,0xf0,0x58,0xd0]
; AVX-NEXT:    vsubps %xmm0, %xmm1, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf0,0x5c,0xc0]
; AVX-NEXT:    vmovlhps %xmm0, %xmm2, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xe8,0x16,0xc0]
; AVX-NEXT:    # xmm0 = xmm2[0],xmm0[0]
; AVX-NEXT:    retq # encoding: [0xc3]
...
; AVX-LABEL: test15:
; AVX:       # %bb.0: # %entry
; AVX-NEXT:    vmovaps (%rdi), %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x28,0x07]
; AVX-NEXT:    vunpckhpd (%rsi), %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x15,0x06]
; AVX-NEXT:    # xmm0 = xmm0[1],mem[1]
; AVX-NEXT:    retq # encoding: [0xc3]
entry:
...
; AVX-LABEL: test16:
; AVX:       # %bb.0:
; AVX-NEXT:    vmovaps 96(%rdi), %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x28,0x47,0x60]
; AVX-NEXT:    vunpcklpd 112(%rdi), %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x14,0x47,0x70]
...
; AVX-LABEL: test17:
; AVX:       # %bb.0: # %entry
; AVX-NEXT:    vbroadcastss {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0 # EVEX TO VEX Compression xmm0 = [32768,32768,32768,32768]
; AVX-NEXT:    # encoding: [0xc4,0xe2,0x79,0x18,0x05,A,A,A,A]
; AVX-NEXT:    # fixup A - offset: 5, value: {{\.?LCPI[0-9]+_[0-9]+}}-4, kind: reloc_riprel_4byte
; AVX-NEXT:    vmovaps %xmm0, (%rax) # EVEX TO VEX Compression encoding: [0xc5,0xf8,0x29,0x00]
; AVX-NEXT:    retq # encoding: [0xc3]
entry:
...
; AVX-LABEL: f:
; AVX:       # %bb.0: # %entry
; AVX-NEXT:    vcvtpd2ps %ymm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x5a,0xc0]
...
; AVX:       # %bb.0:
; AVX-NEXT:    vmovq %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xfa,0x7e,0xc0]
; AVX-NEXT:    # xmm0 = xmm0[0],zero
; AVX-NEXT:    retq # encoding: [0xc3]
...
; AVX-LABEL: PR19721:
; AVX:       # %bb.0:
; AVX-NEXT:    vxorps %xmm1, %xmm1, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf0,0x57,0xc9]
...
; AVX-LABEL: test_mul:
; AVX:       # %bb.0:
; AVX-NEXT:    vpmulld %xmm1, %xmm0, %xmm0 # EVEX TO VEX Compression encoding: [0xc4,0xe2,0x79,0x40,0xc1]
; AVX-NEXT:    retq # encoding: [0xc3]
  %m = mul <4 x i32> %x, %y
  ret <4 x i32> %m
}

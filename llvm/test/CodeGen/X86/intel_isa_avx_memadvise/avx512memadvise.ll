...
declare <4 x i32> @llvm.x86.avx512.vmovadvisew.load.128(i8* %a, i8 %i) nounwind readonly
declare void @llvm.x86.avx512.vmovadvisew.store.128(i8*, <4 x i32>, i8 %i) nounwind
declare <8 x i32> @llvm.x86.avx512.vmovadvisew.load.256(i8* %a, i8 %i) nounwind readonly
declare void @llvm.x86.avx512.vmovadvisew.store.256(i8*, <8 x i32>, i8 %i) nounwind
...
declare void @llvm.x86.avx512.vmemadvise.128(i8* %a, i8 %i) nounwind
declare void @llvm.x86.avx512.vmemadvise.256(i8* %a, i8 %i) nounwind
...
; CHECK-NEXT:    retq # encoding: [0xc3]
  %res = call <4 x i32> @llvm.x86.avx512.vmovadvisew.load.128(i8* %a0, i8 16)
  ret <4 x i32> %res
}
...
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.avx512.vmovadvisew.store.128(i8* %a0, <4 x i32> %a1, i8 16)
  ret void
}
...
; CHECK-NEXT:    retq # encoding: [0xc3]
  %res = call <8 x i32> @llvm.x86.avx512.vmovadvisew.load.256(i8* %a0, i8 16)
  ret <8 x i32> %res
}
...
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.avx512.vmovadvisew.store.256(i8* %a0, <8 x i32> %a1, i8 16)
  ret void
}
...
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.avx512.vmemadvise.128(i8* %a0, i8 123)
  ret void
}
...
; CHECK-NEXT:    retq # encoding: [0xc3]
  call void @llvm.x86.avx512.vmemadvise.256(i8* %a0, i8 12)
  ret void
}

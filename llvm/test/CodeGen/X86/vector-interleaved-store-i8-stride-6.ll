...
; AVX512F-FAST:       # %bb.0:
; AVX512F-FAST-NEXT:    subq $328, %rsp # imm = 0x148 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm6, %ymm19 ;INTEL
...
; AVX512F-FAST-NEXT:    vbroadcasti128 {{.*#+}} ymm4 = [0,10,0,13,0,12,0,11,0,14,0,0,0,0,0,15,0,10,0,13,0,12,0,11,0,14,0,0,0,0,0,15]
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm7, %ymm6
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm7, %ymm25
...
; AVX512F-FAST-NEXT:    vpshufb %ymm0, %ymm5, %ymm6
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} ymm6 = ymm8[8],ymm5[8],ymm8[9],ymm5[9],ymm8[10],ymm5[10],ymm8[11],ymm5[11],ymm8[12],ymm5[12],ymm8[13],ymm5[13],ymm8[14],ymm5[14],ymm8[15],ymm5[15],ymm8[24],ymm5[24],ymm8[25],ymm5[25],ymm8[26],ymm5[26],ymm8[27],ymm5[27],ymm8[28],ymm5[28],ymm8[29],ymm5[29],ymm8[30],ymm5[30],ymm8[31],ymm5[31] ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm5, %ymm30 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %ymm9, %ymm14, %ymm1
; end INTEL_CUSTOMIZATION
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm1[8],xmm2[9],xmm1[9],xmm2[10],xmm1[10],xmm2[11],xmm1[11],xmm2[12],xmm1[12],xmm2[13],xmm1[13],xmm2[14],xmm1[14],xmm2[15],xmm1[15]
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm7[0],xmm9[0],xmm7[1],xmm9[1],xmm7[2],xmm9[2],xmm7[3],xmm9[3],xmm7[4],xmm9[4],xmm7[5],xmm9[5],xmm7[6],xmm9[6],xmm7[7],xmm9[7]
...
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm10 = <u,6,u,5,u,8,u,7,u,9,u,9,u,9,u,9>
; AVX512F-FAST-NEXT:    vpshufb %xmm10, %xmm4, %xmm2
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm12 = <u,2,u,1,u,0,u,3,u,4,u,4,u,4,u,4>
; AVX512F-FAST-NEXT:    vpshufb %xmm12, %xmm4, %xmm3
...
; AVX512F-FAST-NEXT:    vpshufb %xmm0, %xmm5, %xmm4 ;INTEL
...
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm2[0],xmm5[0],xmm2[1],xmm5[1],xmm2[2],xmm5[2],xmm2[3],xmm5[3],xmm2[4],xmm5[4],xmm2[5],xmm5[5],xmm2[6],xmm5[6],xmm2[7],xmm5[7]
...
; AVX512F-FAST-NEXT:    vpshufb %xmm10, %xmm13, %xmm0 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm12, %xmm13, %xmm1 ;INTEL
...
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm18 ;INTEL
...
; AVX512F-FAST-NEXT:    # ymm1 = mem[0,1,0,1]
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm12, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm1, %ymm17 ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm22 = ymm0[2,2,2,3]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vmovdqa 32(%rcx), %xmm3
; AVX512F-FAST-NEXT:    vpbroadcastq {{.*#+}} xmm4 = [5,8,7,6,9,0,0,10,5,8,7,6,9,0,0,10]
; AVX512F-FAST-NEXT:    vpshufb %xmm4, %xmm3, %xmm10
; AVX512F-FAST-NEXT:    vmovdqa 32(%rdx), %xmm1
; AVX512F-FAST-NEXT:    vpshufb %xmm4, %xmm1, %xmm15
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm10 = xmm15[0],xmm10[0],xmm15[1],xmm10[1],xmm15[2],xmm10[2],xmm15[3],xmm10[3],xmm15[4],xmm10[4],xmm15[5],xmm10[5],xmm15[6],xmm10[6],xmm15[7],xmm10[7]
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3],xmm1[4],xmm3[4],xmm1[5],xmm3[5],xmm1[6],xmm3[6],xmm1[7],xmm3[7]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vprold $16, %xmm15, %xmm15
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm10, %zmm15, %zmm23 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa (%rcx), %xmm10 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa (%rdx), %xmm15
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %xmm4, %xmm10, %xmm0
; AVX512F-FAST-NEXT:    vpshufb %xmm4, %xmm15, %xmm4
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3],xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm15[0],xmm10[0],xmm15[1],xmm10[1],xmm15[2],xmm10[2],xmm15[3],xmm10[3],xmm15[4],xmm10[4],xmm15[5],xmm10[5],xmm15[6],xmm10[6],xmm15[7],xmm10[7]
; AVX512F-FAST-NEXT:    vprold $16, %xmm4, %xmm4
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm4, %zmm24
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} ymm0 = ymm11[0],ymm6[0],ymm11[1],ymm6[1],ymm11[2],ymm6[2],ymm11[3],ymm6[3],ymm11[4],ymm6[4],ymm11[5],ymm6[5],ymm11[6],ymm6[6],ymm11[7],ymm6[7],ymm11[16],ymm6[16],ymm11[17],ymm6[17],ymm11[18],ymm6[18],ymm11[19],ymm6[19],ymm11[20],ymm6[20],ymm11[21],ymm6[21],ymm11[22],ymm6[22],ymm11[23],ymm6[23]
; AVX512F-FAST-NEXT:    vprold $16, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm15[8],xmm10[8],xmm15[9],xmm10[9],xmm15[10],xmm10[10],xmm15[11],xmm10[11],xmm15[12],xmm10[12],xmm15[13],xmm10[13],xmm15[14],xmm10[14],xmm15[15],xmm10[15]
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm30, %ymm4
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} ymm4 = ymm8[0],ymm4[0],ymm8[1],ymm4[1],ymm8[2],ymm4[2],ymm8[3],ymm4[3],ymm8[4],ymm4[4],ymm8[5],ymm4[5],ymm8[6],ymm4[6],ymm8[7],ymm4[7],ymm8[16],ymm4[16],ymm8[17],ymm4[17],ymm8[18],ymm4[18],ymm8[19],ymm4[19],ymm8[20],ymm4[20],ymm8[21],ymm4[21],ymm8[22],ymm4[22],ymm8[23],ymm4[23]
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpshufb %ymm5, %ymm4, %ymm4 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm8 = [8,9,6,7,12,13,10,11,14,15,14,15,14,15,14,15] ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm8, %xmm2, %xmm6 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm31 = [0,0,0,1,10,10,10,11]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermt2q %zmm4, %zmm31, %zmm6
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm4 = [10,11,8,9,6,7,12,13,14,15,14,15,14,15,14,15]
; AVX512F-FAST-NEXT:    vpshufb %xmm4, %xmm10, %xmm2
; AVX512F-FAST-NEXT:    vpermt2q %zmm0, %zmm31, %zmm2
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm14, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm10 = <u,10,u,13,u,12,u,11,u,14,u,13,u,14,u,15>
; AVX512F-FAST-NEXT:    vpshufb %xmm10, %xmm13, %xmm2
; AVX512F-FAST-NEXT:    vpermt2q %zmm0, %zmm31, %zmm2
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm20, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm19, %ymm13
; AVX512F-FAST-NEXT:    vpunpcklbw {{.*#+}} ymm0 = ymm0[0],ymm13[0],ymm0[1],ymm13[1],ymm0[2],ymm13[2],ymm0[3],ymm13[3],ymm0[4],ymm13[4],ymm0[5],ymm13[5],ymm0[6],ymm13[6],ymm0[7],ymm13[7],ymm0[16],ymm13[16],ymm0[17],ymm13[17],ymm0[18],ymm13[18],ymm0[19],ymm13[19],ymm0[20],ymm13[20],ymm0[21],ymm13[21],ymm0[22],ymm13[22],ymm0[23],ymm13[23]
; AVX512F-FAST-NEXT:    vprold $16, %ymm0, %ymm0
; AVX512F-FAST-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm3[8],xmm1[9],xmm3[9],xmm1[10],xmm3[10],xmm1[11],xmm3[11],xmm1[12],xmm3[12],xmm1[13],xmm3[13],xmm1[14],xmm3[14],xmm1[15],xmm3[15]
; AVX512F-FAST-NEXT:    vpshufb %xmm4, %xmm1, %xmm3
; AVX512F-FAST-NEXT:    vpermt2q %zmm0, %zmm31, %zmm3
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpshufb %ymm0, %ymm13, %ymm0 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm17, %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm1, %ymm13, %ymm1 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm5, %ymm4, %ymm4
; AVX512F-FAST-NEXT:    vmovdqa (%r8), %xmm14 ;INTEL
...
; AVX512F-FAST-NEXT:    vpshufb %xmm8, %xmm5, %xmm5 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm15 = <6,u,5,u,8,u,7,u,9,u,9,u,9,u,9,u> ;INTEL
; AVX512F-FAST-NEXT:    vpermt2q %zmm4, %zmm31, %zmm5
; AVX512F-FAST-NEXT:    vpshufb %xmm15, %xmm7, %xmm4 ;INTEL
...
; AVX512F-FAST-NEXT:    # ymm3 = mem[0,1,0,1]
; AVX512F-FAST-NEXT:    vpshufb %ymm3, %ymm13, %ymm9 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %ymm3, %ymm12, %ymm8 ;INTEL
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm3 = <2,u,1,u,0,u,3,u,4,u,4,u,4,u,4,u>
; AVX512F-FAST-NEXT:    vpshufb %xmm15, %xmm14, %xmm12 ;INTEL
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm7, %xmm13
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpshufb %xmm3, %xmm14, %xmm3
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} xmm15 = <10,u,13,u,12,u,11,u,14,u,13,u,14,u,15,u>
; AVX512F-FAST-NEXT:    vpshufb %xmm15, %xmm14, %xmm14
; AVX512F-FAST-NEXT:    vpshufb %xmm15, %xmm7, %xmm15
; AVX512F-FAST-NEXT:    vmovdqa64 %ymm25, %ymm7
; AVX512F-FAST-NEXT:    vpshufb %ymm11, %ymm7, %ymm11
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm0 = ymm0[2,2,2,3]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm1 = ymm1[2,2,2,3]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm4 = ymm4[0,0,0,1] ;INTEL
...
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm13 = ymm14[0,0,0,1]
; AVX512F-FAST-NEXT:    vmovdqa64 %xmm16, %xmm14
; AVX512F-FAST-NEXT:    vpshufb %xmm10, %xmm14, %xmm10
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm14 = [0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0]
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm6, %ymm14, %ymm13
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vextracti64x4 $1, %zmm6, %ymm6
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm9 = ymm9[2,2,2,3]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm15 = ymm15[0,0,0,1]
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm5, %ymm14, %ymm15
; AVX512F-FAST-NEXT:    vextracti64x4 $1, %zmm5, %ymm5
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} ymm8 = ymm8[2,2,2,3]
; AVX512F-FAST-NEXT:    vpermt2q %zmm11, %zmm31, %zmm10
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm11 = [65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535]
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm5, %ymm11, %ymm8
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm8, %zmm0, %zmm5
; AVX512F-FAST-NEXT:    vshufi64x2 {{.*#+}} zmm5 = zmm15[0,1,2,3],zmm5[4,5,6,7]
...
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm6, %ymm11, %ymm9
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm9, %zmm0, %zmm5
; AVX512F-FAST-NEXT:    vshufi64x2 {{.*#+}} zmm5 = zmm13[0,1,2,3],zmm5[4,5,6,7]
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm5, %zmm8, %zmm2
; end INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm2, %zmm30, %zmm5 ;INTEL
; AVX512F-FAST-NEXT:    vpermq $234, {{[-0-9]+}}(%r{{[sb]}}p), %zmm2 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    # zmm2 = mem[2,2,2,3,6,6,6,7]
; INTEL_CUSTOMIZATION
...
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm2, %ymm14, %ymm21
; AVX512F-FAST-NEXT:    vextracti64x4 $1, %zmm6, %ymm2
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm2, %ymm14, %ymm0
; AVX512F-FAST-NEXT:    vmovdqa {{.*#+}} ymm2 = [65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535]
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm5, %ymm2, %ymm22
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm21, %zmm0, %zmm5
; AVX512F-FAST-NEXT:    vshufi64x2 {{.*#+}} zmm5 = zmm22[0,1,2,3],zmm5[4,5,6,7]
...
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm6, %ymm2, %ymm1
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm0, %zmm0, %zmm0
; AVX512F-FAST-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm1[0,1,2,3],zmm0[4,5,6,7]
; AVX512F-FAST-NEXT:    vpermq $234, {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Folded Reload
; AVX512F-FAST-NEXT:    # zmm1 = mem[2,2,2,3,6,6,6,7]
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm0, %zmm9, %zmm1
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} zmm0 = zmm23[0,0,0,1,4,4,4,5]
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} zmm5 = zmm26[0,0,0,1,4,4,4,5]
; AVX512F-FAST-NEXT:    vmovdqa64 {{.*#+}} zmm6 = [65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0,65535,65535,0] ;INTEL
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm0, %zmm6, %zmm5 ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} zmm0 = zmm24[0,0,0,1,4,4,4,5] ;INTEL
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} zmm9 = zmm28[0,0,0,1,4,4,4,5]
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vpternlogq $226, %zmm0, %zmm6, %zmm9
; AVX512F-FAST-NEXT:    vextracti64x4 $1, %zmm5, %ymm0
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm0, %ymm2, %ymm4
; AVX512F-FAST-NEXT:    vextracti64x4 $1, %zmm9, %ymm0
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm0, %ymm2, %ymm12
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm5, %ymm11, %ymm7
; AVX512F-FAST-NEXT:    vpternlogq $184, %ymm9, %ymm11, %ymm3
; end INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm0
; INTEL_CUSTOMIZATION
; AVX512F-FAST-NEXT:    vshufi64x2 {{.*#+}} zmm0 = zmm7[0,1,2,3],zmm0[4,5,6,7]
; AVX512F-FAST-NEXT:    vpermq {{.*#+}} zmm2 = zmm27[0,0,0,1,4,4,4,5]
...
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm0, %zmm4, %zmm2
...
; AVX512F-FAST-NEXT:    vpternlogq $184, %zmm0, %zmm4, %zmm3

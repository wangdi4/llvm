...
; AVX512-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1 ;INTEL
; AVX512-NEXT:    vtestpd %xmm1, %xmm0 ;INTEL
; AVX512-NEXT:    sbbq %rax, %rax ;INTEL
; AVX512-NEXT:    retq
...
; AVX512-NEXT:    xorl %eax, %eax
; AVX512-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1 ;INTEL
; AVX512-NEXT:    vtestpd %ymm1, %ymm0 ;INTEL
; AVX512-NEXT:    sbbq %rax, %rax ;INTEL
...
; AVX512-NEXT:    vmovdqa32 %xmm0, %xmm1 {%k1} {z} ;INTEL
; AVX512-NEXT:    xorl %eax, %eax
; AVX512-NEXT:    vtestps %xmm0, %xmm1 ;INTEL
; AVX512-NEXT:    sbbq %rax, %rax ;INTEL
; AVX512-NEXT:    vzeroupper
; AVX512-NEXT:    retq
  %c = fcmp ogt <4 x double> %a0, %a1
...
; AVX512-NEXT:    xorl %eax, %eax
; AVX512-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1 ;INTEL
; AVX512-NEXT:    vtestps %xmm1, %xmm0 ;INTEL
; AVX512-NEXT:    sbbl %eax, %eax ;INTEL
; AVX512-NEXT:    retq
...
; AVX512-NEXT:    xorl %eax, %eax
; AVX512-NEXT:    vpcmpeqd %ymm1, %ymm1, %ymm1 ;INTEL
; AVX512-NEXT:    vtestps %ymm1, %ymm0 ;INTEL
; AVX512-NEXT:    sbbl %eax, %eax ;INTEL
; AVX512-NEXT:    vzeroupper
; AVX512-NEXT:    retq
...
; AVX1-NEXT:    vtestpd %xmm1, %xmm0 ;INTEL
; AVX1-NEXT:    sbbq %rax, %rax ;INTEL
; AVX1-NEXT:    vzeroupper
; AVX1-NEXT:    retq
;
...
; AVX2-NEXT:    vpcmpeqd %xmm1, %xmm1, %xmm1 ;INTEL
; AVX2-NEXT:    xorl %eax, %eax
; AVX2-NEXT:    vtestps %xmm1, %xmm0 ;INTEL
; AVX2-NEXT:    sbbq %rax, %rax ;INTEL
; AVX2-NEXT:    vzeroupper
; AVX2-NEXT:    retq
;
...
; AVX512-NEXT:    vpmovmskb %ymm0, %ecx ;INTEL
; AVX512-NEXT:    cmpl $-1, %ecx ;INTEL

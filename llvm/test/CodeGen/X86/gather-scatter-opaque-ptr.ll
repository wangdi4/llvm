...
; CHECK-NEXT:    vpsllq $6, %ymm0, %ymm0 ;INTEL
; CHECK-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; CHECK-NEXT:    vscatterqpd %ymm1, (%rdi,%ymm0,8) {%k1} ;INTEL
...
; CHECK-NEXT:    vpslld $31, %xmm1, %xmm1
; CHECK-NEXT:    vpmovd2m %xmm1, %k1
; CHECK-NEXT:    vpaddq %ymm0, %ymm0, %ymm0 ;INTEL
; CHECK-NEXT:    vpxor %xmm1, %xmm1, %xmm1
; CHECK-NEXT:    vscatterqpd %ymm1, (%rdi,%ymm0,8) {%k1} ;INTEL
; CHECK-NEXT:    vzeroupper
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    vpslld $31, %xmm1, %xmm1
; CHECK-NEXT:    vpmovd2m %xmm1, %k1
; CHECK-NEXT:    vpsllq $6, %ymm0, %ymm1 ;INTEL
; CHECK-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; CHECK-NEXT:    vgatherqpd (%rdi,%ymm1,8), %ymm0 {%k1} ;INTEL
; CHECK-NEXT:    retq
  %gep = getelementptr inbounds [512 x i8], ptr %result, <4 x i64> %idx
...
; CHECK-NEXT:    vpslld $31, %xmm1, %xmm1
; CHECK-NEXT:    vpmovd2m %xmm1, %k1
; CHECK-NEXT:    vpaddq %ymm0, %ymm0, %ymm1 ;INTEL
; CHECK-NEXT:    vpxor %xmm0, %xmm0, %xmm0
; CHECK-NEXT:    vgatherqpd (%rdi,%ymm1,8), %ymm0 {%k1} ;INTEL
; CHECK-NEXT:    retq
  %gep = getelementptr inbounds [16 x i8], ptr %result, <4 x i64> %idx

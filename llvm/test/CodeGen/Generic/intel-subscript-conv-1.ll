...
; RUN: opt -S -passes=convert-to-subscript %s 2>&1 | FileCheck -check-prefix=OPAQUE %s
...
define i32 @_Z3barPA9_A8_iiii(ptr nocapture readonly %A, i32 %i, i32 %j, i32 %k) local_unnamed_addr #0 {
entry:
  %idxprom = sext i32 %i to i64
  %idxprom1 = sext i32 %j to i64
  %idxprom3 = sext i32 %k to i64
  %arrayidx4 = getelementptr inbounds [9 x [8 x i32]], ptr %A, i64 %idxprom, i64 %idxprom1, i64 %idxprom3
  %0 = load i32, ptr %arrayidx4, align 4
  ret i32 %0
}

; Function Attrs: noinline nounwind optnone uwtable
define i32 @_Z4bar1PA9_A8_iiii(ptr %A, i32 %i, i32 %j, i32 %k) local_unnamed_addr #1 {
entry:
  ...
  %arrayidx = getelementptr inbounds [9 x [8 x i32]], ptr %0, i64 %idxprom
  %2 = load i32, ptr %j.addr, align 4
  %idxprom1 = sext i32 %2 to i64
  %arrayidx2 = getelementptr inbounds [9 x [8 x i32]], ptr %arrayidx, i64 0, i64 %idxprom1
  %3 = load i32, ptr %k.addr, align 4
  %idxprom3 = sext i32 %3 to i64
  %arrayidx4 = getelementptr inbounds [8 x i32], ptr %arrayidx2, i64 0, i64 %idxprom3
...
entry:
  %0 = load i32, ptr getelementptr inbounds ([10 x [9 x [8 x i32]]], ptr @A, i64 0, i64 1, i64 2, i64 3), align 4
  %call1 = tail call i32 @_Z4bar1PA9_A8_iiii(ptr getelementptr inbounds ([10 x [9 x [8 x i32]]], ptr @A, i64 0, i64 0), i32 1, i32 2, i32 3)
  %cmp = icmp eq i32 %0, %call1
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call2 = tail call i32 @puts(ptr getelementptr inbounds ([7 x i8], ptr @.str, i64 0, i64 0))
  br label %if.end

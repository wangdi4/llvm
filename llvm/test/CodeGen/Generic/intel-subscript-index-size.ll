...
; CHECK: getelementptr inbounds i32, i32* %"foo_$A", i32


target datalayout = "e-m:m-p:40:64:64:32-i32:32-i16:16-i8:8-n32"

define void @foo_(i32* noalias nocapture %"foo_$A") {
alloca_0:
  br label %bb12
...
declare i32* @llvm.intel.subscript.p0i32.i32.i32.p0i32.i64(i8, i32, i32, i32*, i64)

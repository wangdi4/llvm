...
define dso_local void @vectorize(float* nocapture %a, float* nocapture readonly %b, float* nocapture readonly %c) local_unnamed_addr #0 !dbg !7 !llvm.loop.optreport !9 {
DIR.OMP.SIMD.118:
...
define dso_local void @complete_unroll(float* nocapture %a, float* nocapture readonly %b, float* nocapture readonly %c) local_unnamed_addr #1 !dbg !38 !llvm.loop.optreport !39 {
entry:
...
!13 = distinct !{!"intel.loop.optreport", !14, !16, !20}
...
!21 = distinct !{!"llvm.loop.optreport", !22}
!22 = distinct !{!"intel.loop.optreport", !14, !23, !25}
...
!39 = distinct !{!"llvm.loop.optreport", !40}
!40 = distinct !{!"intel.loop.optreport", !41}
!41 = !{!"intel.optreport.first_child", !42}
!42 = distinct !{!"llvm.loop.optreport", !43}
!43 = distinct !{!"intel.loop.optreport", !44, !46}
!44 = !{!"intel.optreport.debug_location", !45}
!45 = !DILocation(line: 9, column: 3, scope: !38)
!46 = !{!"intel.optreport.remarks", !47}
!47 = !{!"intel.optreport.remark", i32 25532, !"Loop completely unrolled"}

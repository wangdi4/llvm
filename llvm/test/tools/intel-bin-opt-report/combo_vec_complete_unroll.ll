...
; CHECK-DAG:  Anchor ID: 11434255b1c83efa5912c9a493c1166c
...
; CHECK-DAG:  === Loop Begin ===
; CHECK-DAG:  Anchor ID: f71babed49c67ff904e9a58f9f1ffe47
; CHECK-DAG:  Number of remarks: 0
; CHECK-DAG:  ==== Loop End ====

; CHECK-DAG:  === Loop Begin ===
; CHECK-DAG:  Anchor ID: 2882b0f7ef7d0778b6546b257ba988f6
; CHECK-DAG:  Number of remarks: 2
; CHECK-DAG:    Property: C_LOOP_VECTORIZED, Remark ID: 15300, Remark Args:
; CHECK-DAG:    Property: C_LOOP_VEC_VL, Remark ID: 15305, Remark Args: 8
; CHECK-DAG:  ==== Loop End ====
...
; CHECK-DAG:  === Loop Begin ===
; CHECK-DAG:  Anchor ID: 41b0886b652f134418f2f1e720094a00
; CHECK-DAG:  Number of remarks: 1
; CHECK-DAG:    Property: C_LOOP_COMPLETE_UNROLL, Remark ID: 25532, Remark Args:
; CHECK-DAG:  ==== Loop End ====

; CHECK-DAG:  === Loop Begin ===
; CHECK-DAG:  Anchor ID: 729dd11305a4f9af7ac6ed9a5e35bbe7
; CHECK-DAG:  Number of remarks: 0
; CHECK-DAG:  ==== Loop End ====

; CHECK-DAG:  === Loop Begin ===
; CHECK-DAG:  Anchor ID: dacfb53aba8ca35c1aea9bdf3a82c266
; CHECK-DAG:  Number of remarks: 1
; CHECK-DAG:    Property: C_LOOP_COMPLETE_UNROLL, Remark ID: 25532, Remark Args:
; CHECK-DAG:  ==== Loop End ====
...
define dso_local void @vectorize(float* nocapture %a, float* nocapture readonly %b, float* nocapture readonly %c) local_unnamed_addr #0 !dbg !6 !llvm.loop.optreport !8 {
DIR.OMP.SIMD.118:
...
define dso_local void @complete_unroll(float* nocapture %a, float* nocapture readonly %b, float* nocapture readonly %c) local_unnamed_addr #2 !dbg !37 !llvm.loop.optreport !38 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @both(float* nocapture %a, float* nocapture readonly %b, float* nocapture readonly %c) local_unnamed_addr #0 !dbg !53 !llvm.loop.optreport !54 {
DIR.OMP.SIMD.139:
...
!38 = distinct !{!"llvm.loop.optreport", !39}
!39 = distinct !{!"intel.loop.optreport", !40}
!40 = !{!"intel.optreport.first_child", !41}
!41 = distinct !{!"llvm.loop.optreport", !42}
!42 = distinct !{!"intel.loop.optreport", !43, !45}
!43 = !{!"intel.optreport.debug_location", !44}
!44 = !DILocation(line: 11, column: 3, scope: !37)
!45 = !{!"intel.optreport.remarks", !46}
!46 = !{!"intel.optreport.remark", i32 25532, !"Loop completely unrolled"}
...
!54 = distinct !{!"llvm.loop.optreport", !55}
!55 = distinct !{!"intel.loop.optreport", !56}
!56 = !{!"intel.optreport.first_child", !57}
!57 = distinct !{!"llvm.loop.optreport", !58}
!58 = distinct !{!"intel.loop.optreport", !59, !45, !61}
!59 = !{!"intel.optreport.debug_location", !60}
!60 = !DILocation(line: 21, column: 3, scope: !53)
!61 = !{!"intel.optreport.next_sibling", !62}
!62 = distinct !{!"llvm.loop.optreport", !63}
!63 = distinct !{!"intel.loop.optreport", !64, !15, !66}
!64 = !{!"intel.optreport.debug_location", !65}
!65 = !DILocation(line: 16, column: 1, scope: !53)
!66 = !{!"intel.optreport.next_sibling", !67}
!67 = distinct !{!"llvm.loop.optreport", !68}
!68 = distinct !{!"intel.loop.optreport", !64, !22, !24}

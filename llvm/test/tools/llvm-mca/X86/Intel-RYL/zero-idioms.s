...
# RUN: llvm-mca -mtriple=x86_64-unknown-unknown -mcpu=royal -timeline -register-file-stats -iterations=1 < %s | FileCheck %s
...
# CHECK-NEXT:  1      1     0.17                        subl	%eax, %eax
# CHECK-NEXT:  1      1     0.17                        subq	%rax, %rax
# CHECK-NEXT:  1      1     0.17                        xorl	%eax, %eax
# CHECK-NEXT:  1      1     0.17                        xorq	%rax, %rax
# CHECK-NEXT:  1      1     0.17                        pcmpgtb	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        pcmpgtd	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        pcmpgtw	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        pcmpgtb	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        pcmpgtd	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        pcmpgtq	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        pcmpgtw	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        vpcmpgtb	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpcmpgtd	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpcmpgtq	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpcmpgtw	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpcmpgtb	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpcmpgtd	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpcmpgtq	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpcmpgtw	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpcmpgtb	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.17                        vpcmpgtd	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.17                        vpcmpgtq	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.17                        vpcmpgtw	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.17                        vpcmpgtb	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:  1      1     0.17                        vpcmpgtd	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:  1      1     0.17                        vpcmpgtq	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:  1      1     0.17                        vpcmpgtw	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:  1      1     0.17                        psubb	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        psubd	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        psubq	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        psubw	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        psubb	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        psubd	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        psubq	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        psubw	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        vpsubb	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpsubd	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpsubq	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpsubw	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpsubb	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.17                        vpsubd	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.17                        vpsubq	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.17                        vpsubw	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.17                        vpsubb	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpsubd	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpsubq	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpsubw	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpsubb	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:  1      1     0.17                        vpsubd	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:  1      1     0.17                        vpsubq	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:  1      1     0.17                        vpsubw	%ymm3, %ymm3, %ymm5
...
# CHECK-NEXT:  1      1     0.17                        pandn	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        pandn	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        vpandn	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpandn	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.25                        vandnps	%xmm2, %xmm2, %xmm5
# CHECK-NEXT:  1      1     0.25                        vandnpd	%xmm1, %xmm1, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpandn	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.25                        vandnps	%ymm2, %ymm2, %ymm5
# CHECK-NEXT:  1      1     0.25                        vandnpd	%ymm1, %ymm1, %ymm5
# CHECK-NEXT:  1      1     0.17                        vpandn	%ymm3, %ymm3, %ymm5
...
# CHECK-NEXT:  1      1     0.17                        pxor	%mm2, %mm2
# CHECK-NEXT:  1      1     0.17                        pxor	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.17                        vpxor	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  1      1     0.17                        vpxor	%ymm3, %ymm3, %ymm3
...
# CHECK-NEXT:  1      1     0.17                        vpxor	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  1      1     0.17                        vpxor	%ymm3, %ymm3, %ymm5

# CHECK:      Register File statistics:
# CHECK-NEXT: Total number of mappings created:    87
# CHECK-NEXT: Max number of mappings used:         65
...
# CHECK-NEXT:  -      -     1.00   1.00   1.00   1.00    -      -      -      -      -      -      -      -      -      -     13.00  13.00  13.00  13.00  13.00  14.00   -      -      -      -
...
# CHECK-NEXT: [0,9]     D==eE-R   .    .    .   .   pcmpgtq	%xmm2, %xmm2
...
# CHECK-NEXT: [0,77]    .    . DeE--------------R   vxorps	%xmm4, %xmm4, %xmm5
...
# CHECK-NEXT: 6.     1     3.0    0.0    1.0       pcmpgtw	%mm2, %mm2
# CHECK-NEXT: 7.     1     1.0    1.0    3.0       pcmpgtb	%xmm2, %xmm2
# CHECK-NEXT: 8.     1     2.0    0.0    2.0       pcmpgtd	%xmm2, %xmm2
# CHECK-NEXT: 9.     1     3.0    0.0    1.0       pcmpgtq	%xmm2, %xmm2
# CHECK-NEXT: 10.    1     3.0    0.0    0.0       pcmpgtw	%xmm2, %xmm2
# CHECK-NEXT: 11.    1     1.0    1.0    2.0       vpcmpgtb	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 12.    1     2.0    0.0    1.0       vpcmpgtd	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 13.    1     3.0    0.0    0.0       vpcmpgtq	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 14.    1     4.0    0.0    0.0       vpcmpgtw	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 15.    1     5.0    0.0    0.0       vpcmpgtb	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 16.    1     5.0    0.0    0.0       vpcmpgtd	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 17.    1     5.0    0.0    0.0       vpcmpgtq	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 18.    1     5.0    0.0    0.0       vpcmpgtw	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 19.    1     5.0    0.0    0.0       vpcmpgtb	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 20.    1     5.0    0.0    0.0       vpcmpgtd	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 21.    1     6.0    0.0    0.0       vpcmpgtq	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 22.    1     7.0    0.0    0.0       vpcmpgtw	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 23.    1     8.0    0.0    0.0       vpcmpgtb	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 24.    1     8.0    0.0    0.0       vpcmpgtd	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 25.    1     8.0    0.0    0.0       vpcmpgtq	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 26.    1     8.0    0.0    0.0       vpcmpgtw	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 27.    1     2.0    0.0    6.0       psubb	%mm2, %mm2
# CHECK-NEXT: 28.    1     3.0    0.0    5.0       psubd	%mm2, %mm2
# CHECK-NEXT: 29.    1     4.0    0.0    4.0       psubq	%mm2, %mm2
# CHECK-NEXT: 30.    1     4.0    0.0    3.0       psubw	%mm2, %mm2
# CHECK-NEXT: 31.    1     2.0    0.0    5.0       psubb	%xmm2, %xmm2
# CHECK-NEXT: 32.    1     4.0    1.0    3.0       psubd	%xmm2, %xmm2
# CHECK-NEXT: 33.    1     5.0    0.0    2.0       psubq	%xmm2, %xmm2
# CHECK-NEXT: 34.    1     6.0    0.0    1.0       psubw	%xmm2, %xmm2
# CHECK-NEXT: 35.    1     7.0    0.0    0.0       vpsubb	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 36.    1     8.0    0.0    0.0       vpsubd	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 37.    1     9.0    0.0    0.0       vpsubq	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 38.    1     10.0   0.0    0.0       vpsubw	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 39.    1     11.0   0.0    0.0       vpsubb	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 40.    1     11.0   0.0    0.0       vpsubd	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 41.    1     12.0   0.0    0.0       vpsubq	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 42.    1     13.0   0.0    0.0       vpsubw	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 43.    1     14.0   0.0    0.0       vpsubb	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 44.    1     14.0   0.0    0.0       vpsubd	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 45.    1     14.0   0.0    0.0       vpsubq	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 46.    1     14.0   0.0    0.0       vpsubw	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 47.    1     14.0   0.0    0.0       vpsubb	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 48.    1     14.0   0.0    0.0       vpsubd	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 49.    1     15.0   1.0    0.0       vpsubq	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 50.    1     14.0   1.0    0.0       vpsubw	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 51.    1     2.0    2.0    12.0      andnps	%xmm0, %xmm0
# CHECK-NEXT: 52.    1     2.0    2.0    12.0      andnpd	%xmm1, %xmm1
# CHECK-NEXT: 53.    1     5.0    0.0    9.0       vandnps	%xmm2, %xmm2, %xmm2
# CHECK-NEXT: 54.    1     3.0    0.0    11.0      vandnpd	%xmm1, %xmm1, %xmm1
# CHECK-NEXT: 55.    1     6.0    0.0    8.0       vandnps	%ymm2, %ymm2, %ymm2
# CHECK-NEXT: 56.    1     4.0    0.0    10.0      vandnpd	%ymm1, %ymm1, %ymm1
# CHECK-NEXT: 57.    1     3.0    0.0    11.0      pandn	%mm2, %mm2
# CHECK-NEXT: 58.    1     7.0    0.0    7.0       pandn	%xmm2, %xmm2
# CHECK-NEXT: 59.    1     14.0   1.0    0.0       vpandn	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 60.    1     14.0   0.0    0.0       vpandn	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 61.    1     7.0    0.0    7.0       vandnps	%xmm2, %xmm2, %xmm5
# CHECK-NEXT: 62.    1     5.0    1.0    9.0       vandnpd	%xmm1, %xmm1, %xmm5
# CHECK-NEXT: 63.    1     15.0   0.0    0.0       vpandn	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 64.    1     7.0    0.0    8.0       vandnps	%ymm2, %ymm2, %ymm5
# CHECK-NEXT: 65.    1     5.0    1.0    10.0      vandnpd	%ymm1, %ymm1, %ymm5
# CHECK-NEXT: 66.    1     15.0   0.0    0.0       vpandn	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 67.    1     2.0    0.0    13.0      xorps	%xmm0, %xmm0
# CHECK-NEXT: 68.    1     5.0    1.0    10.0      xorpd	%xmm1, %xmm1
# CHECK-NEXT: 69.    1     7.0    0.0    8.0       vxorps	%xmm2, %xmm2, %xmm2
# CHECK-NEXT: 70.    1     5.0    0.0    9.0       vxorpd	%xmm1, %xmm1, %xmm1
# CHECK-NEXT: 71.    1     7.0    0.0    7.0       vxorps	%ymm2, %ymm2, %ymm2
# CHECK-NEXT: 72.    1     7.0    1.0    7.0       vxorpd	%ymm1, %ymm1, %ymm1
# CHECK-NEXT: 73.    1     2.0    0.0    12.0      pxor	%mm2, %mm2
# CHECK-NEXT: 74.    1     8.0    0.0    6.0       pxor	%xmm2, %xmm2
# CHECK-NEXT: 75.    1     14.0   0.0    0.0       vpxor	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 76.    1     15.0   0.0    0.0       vpxor	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 77.    1     1.0    1.0    14.0      vxorps	%xmm4, %xmm4, %xmm5
# CHECK-NEXT: 78.    1     8.0    0.0    7.0       vxorpd	%xmm1, %xmm1, %xmm3
# CHECK-NEXT: 79.    1     2.0    2.0    13.0      vxorps	%ymm4, %ymm4, %ymm5
# CHECK-NEXT: 80.    1     7.0    0.0    7.0       vxorpd	%ymm1, %ymm1, %ymm3
# CHECK-NEXT: 81.    1     8.0    0.0    6.0       vpxor	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 82.    1     8.0    0.0    6.0       vpxor	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:        1     6.7    0.2    3.4       <total>

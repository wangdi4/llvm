...
# CHECK-NEXT:  3      3     1.00                        blendvpd	%xmm0, %xmm0, %xmm2
# CHECK-NEXT:  4      8     1.00    *                   blendvpd	%xmm0, (%rax), %xmm2
# CHECK-NEXT:  3      3     1.00                        blendvps	%xmm0, %xmm0, %xmm2
# CHECK-NEXT:  4      8     1.00    *                   blendvps	%xmm0, (%rax), %xmm2
...
# CHECK-NEXT:  3      3     1.00                        pblendvb	%xmm0, %xmm0, %xmm2
# CHECK-NEXT:  4      8     1.00    *                   pblendvb	%xmm0, (%rax), %xmm2
# CHECK-NEXT:  1      1     0.33                        pblendw	$11, %xmm0, %xmm2
# CHECK-NEXT:  2      7     0.33    *                   pblendw	$11, (%rax), %xmm2
...
# CHECK-NEXT: 41.00  55.50  14.67  14.67  2.50   41.50   -     2.50   2.50   2.50    -     14.67   -
...
# CHECK-NEXT: 1.00   1.00    -      -      -     1.00    -      -      -      -      -      -      -     blendvpd	%xmm0, %xmm0, %xmm2
# CHECK-NEXT: 1.00   1.00   0.33   0.33    -     1.00    -      -      -      -      -     0.33    -     blendvpd	%xmm0, (%rax), %xmm2
# CHECK-NEXT: 1.00   1.00    -      -      -     1.00    -      -      -      -      -      -      -     blendvps	%xmm0, %xmm0, %xmm2
# CHECK-NEXT: 1.00   1.00   0.33   0.33    -     1.00    -      -      -      -      -     0.33    -     blendvps	%xmm0, (%rax), %xmm2
...
# CHECK-NEXT: 1.50   1.50   0.33   0.33    -     1.00    -      -      -      -      -     0.33    -     dpps	$22, (%rax), %xmm2
# CHECK-NEXT: 1.00   0.50    -      -      -     0.50    -      -      -      -      -      -      -     extractps	$1, %xmm0, %ecx
# CHECK-NEXT:  -     0.50    -      -     0.50   0.50    -     0.50   0.50   0.50    -      -      -     extractps	$1, %xmm0, (%rax)
...
# CHECK-NEXT:  -     0.50   0.33   0.33    -     0.50    -      -      -      -      -     0.33    -     packusdw	(%rax), %xmm2
# CHECK-NEXT: 1.00   1.00    -      -      -     1.00    -      -      -      -      -      -      -     pblendvb	%xmm0, %xmm0, %xmm2
# CHECK-NEXT: 1.00   1.00   0.33   0.33    -     1.00    -      -      -      -      -     0.33    -     pblendvb	%xmm0, (%rax), %xmm2

...
# CHECK-NEXT: IPC:               2.44
# CHECK-NEXT: Block RThroughput: 15.3
...
# CHECK-NEXT: 27.00  28.00   -      -      -     25.00  1.00    -      -      -     2.00    -      -
...
# CHECK-NEXT: [0,12]    . D==eER  .    .    .    .    .  .   vpcmpgtd	%xmm3, %xmm3, %xmm3
...
# CHECK-NEXT: 10.    1     4.0    0.0    0.0       pcmpgtw	%xmm2, %xmm2
# CHECK-NEXT: 11.    1     3.0    3.0    1.0       vpcmpgtb	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 12.    1     3.0    0.0    0.0       vpcmpgtd	%xmm3, %xmm3, %xmm3
...
# CHECK-NEXT: 31.    1     1.0    0.0    13.0      psubb	%xmm2, %xmm2
# CHECK-NEXT: 32.    1     2.0    0.0    12.0      psubd	%xmm2, %xmm2
# CHECK-NEXT: 33.    1     3.0    0.0    11.0      psubq	%xmm2, %xmm2
# CHECK-NEXT: 34.    1     4.0    0.0    10.0      psubw	%xmm2, %xmm2
...
# CHECK-NEXT: 52.    1     3.0    3.0    17.0      andnpd	%xmm1, %xmm1
# CHECK-NEXT: 53.    1     4.0    2.0    16.0      vandnps	%xmm2, %xmm2, %xmm2
# CHECK-NEXT: 54.    1     3.0    0.0    16.0      vandnpd	%xmm1, %xmm1, %xmm1
# CHECK-NEXT: 55.    1     4.0    0.0    15.0      vandnps	%ymm2, %ymm2, %ymm2
# CHECK-NEXT: 56.    1     4.0    0.0    15.0      vandnpd	%ymm1, %ymm1, %ymm1
# CHECK-NEXT: 57.    1     5.0    5.0    14.0      pandn	%mm2, %mm2
# CHECK-NEXT: 58.    1     5.0    0.0    14.0      pandn	%xmm2, %xmm2
# CHECK-NEXT: 59.    1     19.0   2.0    0.0       vpandn	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 60.    1     19.0   0.0    0.0       vpandn	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 61.    1     5.0    0.0    14.0      vandnps	%xmm2, %xmm2, %xmm5
# CHECK-NEXT: 62.    1     4.0    0.0    15.0      vandnpd	%xmm1, %xmm1, %xmm5
# CHECK-NEXT: 63.    1     20.0   0.0    0.0       vpandn	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 64.    1     5.0    0.0    15.0      vandnps	%ymm2, %ymm2, %ymm5
# CHECK-NEXT: 65.    1     5.0    1.0    15.0      vandnpd	%ymm1, %ymm1, %ymm5
# CHECK-NEXT: 66.    1     19.0   0.0    0.0       vpandn	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 67.    1     5.0    5.0    14.0      xorps	%xmm0, %xmm0
# CHECK-NEXT: 68.    1     5.0    2.0    14.0      xorpd	%xmm1, %xmm1
# CHECK-NEXT: 69.    1     7.0    3.0    12.0      vxorps	%xmm2, %xmm2, %xmm2
# CHECK-NEXT: 70.    1     8.0    2.0    11.0      vxorpd	%xmm1, %xmm1, %xmm1
# CHECK-NEXT: 71.    1     8.0    0.0    11.0      vxorps	%ymm2, %ymm2, %ymm2
# CHECK-NEXT: 72.    1     8.0    0.0    10.0      vxorpd	%ymm1, %ymm1, %ymm1
# CHECK-NEXT: 73.    1     8.0    5.0    10.0      pxor	%mm2, %mm2
# CHECK-NEXT: 74.    1     9.0    1.0    9.0       pxor	%xmm2, %xmm2
# CHECK-NEXT: 75.    1     18.0   0.0    0.0       vpxor	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 76.    1     19.0   0.0    0.0       vpxor	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 77.    1     10.0   10.0   9.0       vxorps	%xmm4, %xmm4, %xmm5
# CHECK-NEXT: 78.    1     9.0    1.0    9.0       vxorpd	%xmm1, %xmm1, %xmm3
# CHECK-NEXT: 79.    1     10.0   10.0   8.0       vxorps	%ymm4, %ymm4, %ymm5
# CHECK-NEXT: 80.    1     8.0    0.0    10.0      vxorpd	%ymm1, %ymm1, %ymm3
# CHECK-NEXT: 81.    1     10.0   1.0    8.0       vpxor	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 82.    1     11.0   2.0    7.0       vpxor	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:        1     9.0    0.9    5.3       <total>

...
# RUN: llvm-mca -mtriple=x86_64-unknown-unknown -mcpu=gracemont -timeline -register-file-stats -iterations=1 < %s | FileCheck %s
...
# CHECK-NEXT: Total uOps:        111

# CHECK:      Dispatch Width:    5
# CHECK-NEXT: uOps Per Cycle:    2.58
# CHECK-NEXT: IPC:               1.93
# CHECK-NEXT: Block RThroughput: 33.7
...
# CHECK-NEXT:  1      1     0.33                        pcmpgtq	%xmm2, %xmm2
...
# CHECK-NEXT:  1      4     1.00                        vpcmpgtq	%xmm3, %xmm3, %xmm3
...
# CHECK-NEXT:  1      4     1.00                        vpcmpgtq	%xmm3, %xmm3, %xmm5
...
# CHECK-NEXT:  2      4     2.00                        vpcmpgtq	%ymm3, %ymm3, %ymm3
...
# CHECK-NEXT:  2      4     2.00                        vpcmpgtq	%ymm3, %ymm3, %ymm5
...
# CHECK-NEXT:  2      1     0.67                        vandnps	%ymm2, %ymm2, %ymm2
# CHECK-NEXT:  2      1     0.67                        vandnpd	%ymm1, %ymm1, %ymm1
# CHECK-NEXT:  1      1     0.33                        pandn	%mm2, %mm2
# CHECK-NEXT:  1      1     0.33                        pandn	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.33                        vpandn	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  2      1     0.67                        vpandn	%ymm3, %ymm3, %ymm3
...
# CHECK-NEXT:  2      1     0.67                        vandnps	%ymm2, %ymm2, %ymm5
# CHECK-NEXT:  2      1     0.67                        vandnpd	%ymm1, %ymm1, %ymm5
# CHECK-NEXT:  2      1     0.67                        vpandn	%ymm3, %ymm3, %ymm5
...
# CHECK-NEXT:  2      1     0.67                        vxorps	%ymm2, %ymm2, %ymm2
# CHECK-NEXT:  2      1     0.67                        vxorpd	%ymm1, %ymm1, %ymm1
# CHECK-NEXT:  1      1     0.33                        pxor	%mm2, %mm2
# CHECK-NEXT:  1      1     0.33                        pxor	%xmm2, %xmm2
# CHECK-NEXT:  1      1     0.33                        vpxor	%xmm3, %xmm3, %xmm3
# CHECK-NEXT:  2      1     0.67                        vpxor	%ymm3, %ymm3, %ymm3
# CHECK-NEXT:  1      1     0.33                        vxorps	%xmm4, %xmm4, %xmm5
# CHECK-NEXT:  1      1     0.33                        vxorpd	%xmm1, %xmm1, %xmm3
# CHECK-NEXT:  2      1     0.67                        vxorps	%ymm4, %ymm4, %ymm5
# CHECK-NEXT:  2      1     0.67                        vxorpd	%ymm1, %ymm1, %ymm3
# CHECK-NEXT:  1      1     0.33                        vpxor	%xmm3, %xmm3, %xmm5
# CHECK-NEXT:  2      1     0.67                        vpxor	%ymm3, %ymm3, %ymm5
...
# CHECK-NEXT: 1.00   1.00   1.00   1.00    -      -      -      -      -      -     35.00  35.00  37.00   -      -      -      -      -
...
# CHECK-NEXT: [0,5]     .DeE--R   .    .    .    .    .    .    . .   pcmpgtd	%mm2, %mm2
...
# CHECK-NEXT: [0,13]    . D===eeeeER   .    .    .    .    .    . .   vpcmpgtq	%xmm3, %xmm3, %xmm3
...
# CHECK-NEXT: [0,17]    .  D========eeeeER  .    .    .    .    . .   vpcmpgtq	%xmm3, %xmm3, %xmm5
...
# CHECK-NEXT: [0,21]    .    D========eeeeER.    .    .    .    . .   vpcmpgtq	%ymm3, %ymm3, %ymm3
...
# CHECK-NEXT: [0,25]    .    . D=============eeeeER   .    .    . .   vpcmpgtq	%ymm3, %ymm3, %ymm5
...
# CHECK-NEXT: 5.     1     1.0    0.0    2.0       pcmpgtd	%mm2, %mm2
...
# CHECK-NEXT: 13.    1     4.0    1.0    0.0       vpcmpgtq	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 14.    1     8.0    0.0    0.0       vpcmpgtw	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 15.    1     8.0    0.0    0.0       vpcmpgtb	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 16.    1     8.0    0.0    0.0       vpcmpgtd	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 17.    1     9.0    1.0    0.0       vpcmpgtq	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 18.    1     9.0    1.0    3.0       vpcmpgtw	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 19.    1     7.0    0.0    4.0       vpcmpgtb	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 20.    1     9.0    1.0    2.0       vpcmpgtd	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 21.    1     9.0    0.0    0.0       vpcmpgtq	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 22.    1     13.0   0.0    0.0       vpcmpgtw	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 23.    1     13.0   0.0    0.0       vpcmpgtb	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 24.    1     13.0   0.0    0.0       vpcmpgtd	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 25.    1     14.0   2.0    0.0       vpcmpgtq	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 26.    1     13.0   1.0    4.0       vpcmpgtw	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 27.    1     1.0    1.0    16.0      psubb	%mm2, %mm2
# CHECK-NEXT: 28.    1     1.0    0.0    15.0      psubd	%mm2, %mm2
# CHECK-NEXT: 29.    1     2.0    0.0    14.0      psubq	%mm2, %mm2
# CHECK-NEXT: 30.    1     5.0    2.0    11.0      psubw	%mm2, %mm2
# CHECK-NEXT: 31.    1     1.0    1.0    15.0      psubb	%xmm2, %xmm2
# CHECK-NEXT: 32.    1     2.0    0.0    14.0      psubd	%xmm2, %xmm2
# CHECK-NEXT: 33.    1     4.0    2.0    11.0      psubq	%xmm2, %xmm2
# CHECK-NEXT: 34.    1     5.0    0.0    10.0      psubw	%xmm2, %xmm2
# CHECK-NEXT: 35.    1     12.0   2.0    3.0       vpsubb	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 36.    1     13.0   0.0    2.0       vpsubd	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 37.    1     14.0   0.0    1.0       vpsubq	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 38.    1     14.0   0.0    0.0       vpsubw	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 39.    1     15.0   0.0    0.0       vpsubb	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 40.    1     16.0   0.0    0.0       vpsubd	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 41.    1     16.0   0.0    0.0       vpsubq	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 42.    1     17.0   0.0    0.0       vpsubw	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 43.    1     18.0   0.0    0.0       vpsubb	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 44.    1     17.0   0.0    0.0       vpsubd	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 45.    1     18.0   1.0    0.0       vpsubq	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 46.    1     18.0   1.0    0.0       vpsubw	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 47.    1     18.0   1.0    0.0       vpsubb	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 48.    1     18.0   2.0    0.0       vpsubd	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 49.    1     18.0   2.0    0.0       vpsubq	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 50.    1     18.0   3.0    0.0       vpsubw	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 51.    1     1.0    1.0    17.0      andnps	%xmm0, %xmm0
# CHECK-NEXT: 52.    1     1.0    1.0    17.0      andnpd	%xmm1, %xmm1
# CHECK-NEXT: 53.    1     2.0    1.0    16.0      vandnps	%xmm2, %xmm2, %xmm2
# CHECK-NEXT: 54.    1     1.0    0.0    16.0      vandnpd	%xmm1, %xmm1, %xmm1
# CHECK-NEXT: 55.    1     2.0    0.0    15.0      vandnps	%ymm2, %ymm2, %ymm2
# CHECK-NEXT: 56.    1     2.0    0.0    15.0      vandnpd	%ymm1, %ymm1, %ymm1
# CHECK-NEXT: 57.    1     1.0    1.0    15.0      pandn	%mm2, %mm2
# CHECK-NEXT: 58.    1     6.0    4.0    10.0      pandn	%xmm2, %xmm2
# CHECK-NEXT: 59.    1     17.0   4.0    0.0       vpandn	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 60.    1     18.0   0.0    0.0       vpandn	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 61.    1     6.0    0.0    11.0      vandnps	%xmm2, %xmm2, %xmm5
# CHECK-NEXT: 62.    1     6.0    5.0    11.0      vandnpd	%xmm1, %xmm1, %xmm5
# CHECK-NEXT: 63.    1     19.0   1.0    0.0       vpandn	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 64.    1     7.0    1.0    12.0      vandnps	%ymm2, %ymm2, %ymm5
# CHECK-NEXT: 65.    1     6.0    6.0    12.0      vandnpd	%ymm1, %ymm1, %ymm5
# CHECK-NEXT: 66.    1     18.0   1.0    0.0       vpandn	%ymm3, %ymm3, %ymm5
# CHECK-NEXT: 67.    1     9.0    9.0    9.0       xorps	%xmm0, %xmm0
# CHECK-NEXT: 68.    1     7.0    7.0    10.0      xorpd	%xmm1, %xmm1
# CHECK-NEXT: 69.    1     9.0    5.0    8.0       vxorps	%xmm2, %xmm2, %xmm2
# CHECK-NEXT: 70.    1     14.0   6.0    3.0       vxorpd	%xmm1, %xmm1, %xmm1
# CHECK-NEXT: 71.    1     15.0   5.0    2.0       vxorps	%ymm2, %ymm2, %ymm2
# CHECK-NEXT: 72.    1     14.0   0.0    2.0       vxorpd	%ymm1, %ymm1, %ymm1
# CHECK-NEXT: 73.    1     16.0   16.0   0.0       pxor	%mm2, %mm2
# CHECK-NEXT: 74.    1     17.0   2.0    0.0       pxor	%xmm2, %xmm2
# CHECK-NEXT: 75.    1     17.0   2.0    0.0       vpxor	%xmm3, %xmm3, %xmm3
# CHECK-NEXT: 76.    1     17.0   0.0    0.0       vpxor	%ymm3, %ymm3, %ymm3
# CHECK-NEXT: 77.    1     17.0   17.0   0.0       vxorps	%xmm4, %xmm4, %xmm5
# CHECK-NEXT: 78.    1     18.0   4.0    0.0       vxorpd	%xmm1, %xmm1, %xmm3
# CHECK-NEXT: 79.    1     18.0   18.0   0.0       vxorps	%ymm4, %ymm4, %ymm5
# CHECK-NEXT: 80.    1     16.0   3.0    2.0       vxorpd	%ymm1, %ymm1, %ymm3
# CHECK-NEXT: 81.    1     17.0   1.0    0.0       vpxor	%xmm3, %xmm3, %xmm5
# CHECK-NEXT: 82.    1     17.0   1.0    0.0       vpxor	%ymm3, %ymm3, %ymm5
# CHECK-NEXT:        1     9.6    1.8    4.1       <total>

...
; NEG-SAME: constant { [4 x i8 addrspace(4)*] } { [4 x i8 addrspace(4)*] [
; NEG-SAME: i8 addrspace(4)* null,
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8 addrspace(1)* bitcast ({ i8 addrspace(4)*, i8 addrspace(4)*, i8 addrspace(4)* } addrspace(1)* @_ZTI7Derived to i8 addrspace(1)*) to i8 addrspace(4)*),
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8* bitcast (void (%struct.Derived addrspace(4)*)* @_ZN7DerivedD1Ev to i8*) to i8 addrspace(4)*),
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8* bitcast (void (%struct.Derived addrspace(4)*)* @_ZN7DerivedD0Ev to i8*) to i8 addrspace(4)*)] }, comdat, align 8
...
; NEG-SAME: constant { i8 addrspace(4)*, i8 addrspace(4)* } {
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8 addrspace(1)* bitcast (i8 addrspace(4)* addrspace(1)* getelementptr inbounds (i8 addrspace(4)*, i8 addrspace(4)* addrspace(1)* @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8 addrspace(1)*) to i8 addrspace(4)*),
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8 addrspace(1)* getelementptr inbounds ([6 x i8], [6 x i8] addrspace(1)* @_ZTS4Base, i32 0, i32 0) to i8 addrspace(4)*) }, comdat, align 8
...
; NEG-SAME: constant { i8 addrspace(4)*, i8 addrspace(4)*, i8 addrspace(4)* } {
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8 addrspace(1)* bitcast (i8 addrspace(4)* addrspace(1)* getelementptr inbounds (i8 addrspace(4)*, i8 addrspace(4)* addrspace(1)* @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8 addrspace(1)*) to i8 addrspace(4)*),
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8 addrspace(1)* getelementptr inbounds ([9 x i8], [9 x i8] addrspace(1)* @_ZTS7Derived, i32 0, i32 0) to i8 addrspace(4)*),
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8 addrspace(1)* bitcast ({ i8 addrspace(4)*, i8 addrspace(4)* } addrspace(1)* @_ZTI4Base to i8 addrspace(1)*) to i8 addrspace(4)*) }, comdat, align 8
...
; NEG-SAME: constant { [4 x i8 addrspace(4)*] } { [4 x i8 addrspace(4)*] [
; NEG-SAME: i8 addrspace(4)* null,
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8 addrspace(1)* bitcast ({ i8 addrspace(4)*, i8 addrspace(4)* } addrspace(1)* @_ZTI4Base to i8 addrspace(1)*) to i8 addrspace(4)*),
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8* bitcast (void (%struct.Base addrspace(4)*)* @_ZN4BaseD1Ev to i8*) to i8 addrspace(4)*),
; NEG-SAME: i8 addrspace(4)* addrspacecast (i8* bitcast (void (%struct.Base addrspace(4)*)* @_ZN4BaseD0Ev to i8*) to i8 addrspace(4)*)] }, comdat, align 8

...
entry:
  tail call spir_func void @_Z21__esimd_nbarrier_inith(i8 zeroext 7) #2
  ret void
}

!3 = !{}

declare dso_local spir_func void @_Z21__esimd_nbarrier_inith(i8 zeroext) local_unnamed_addr #1

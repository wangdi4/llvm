...
;   int __attribute__((__memory__("BLOCK_RAM"))) var_three;
;   int __attribute__((__bankwidth__(8))) var_four;
;   int __attribute__((__max_concurrency__(4))) var_five;
;   int __attribute__((__singlepump__)) var_six;
;   int __attribute__((__doublepump__)) var_seven;
; }

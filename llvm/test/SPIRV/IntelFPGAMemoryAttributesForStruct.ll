...
;   int __attribute__((__memory__("MLAB"))) f3;
;   int __attribute__((__bankwidth__(8))) f4;
;   int __attribute__((__max_concurrency__(4))) f5;
;   int __attribute__((__singlepump__)) f6;
;   int __attribute__((__doublepump__)) f7;
; };
...
; CHECK-SPIRV: MemberDecorate {{[0-9]+}} 5 SinglepumpINTEL 1
; CHECK-SPIRV: MemberDecorate {{[0-9]+}} 6 DoublepumpINTEL 1

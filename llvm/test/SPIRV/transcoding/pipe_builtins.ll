...
entry:
  ...
  %3 = tail call i32 @__write_pipe_2(%opencl.pipe_t addrspace(1)* %out_pipe, i8 addrspace(4)* %2, i32 4, i32 4) #5
  ret void
...
entry:
  ...
  %3 = tail call i32 @__read_pipe_2(%opencl.pipe_t addrspace(1)* %in_pipe, i8 addrspace(4)* %2, i32 4, i32 4) #5
  ret void
; CHECK-SPIRV-LABEL: 1 FunctionEnd
}

declare i32 @__read_pipe_2(%opencl.pipe_t addrspace(1)*, i8 addrspace(4)*, i32, i32) local_unnamed_addr
...
entry:
  ...
  %0 = tail call %opencl.reserve_id_t* @__reserve_write_pipe(%opencl.pipe_t addrspace(1)* %out_pipe, i32 1, i32 4, i32 4) #5
...
if.then:                                          ; preds = %entry
  ...
  %4 = tail call i32 @__write_pipe_4(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %0, i32 0, i8 addrspace(4)* %3, i32 4, i32 4) #5
  ; CHECK-LLVM: call{{.*}}@__commit_write_pipe
  ; CHECK-SPIRV: CommitWritePipe [[PipeArgID]] {{[0-9]+}} {{[0-9]+}}
  tail call void @__commit_write_pipe(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %0, i32 4, i32 4) #5
  br label %if.end
...
entry:
  ...
  %0 = tail call i32 @__get_pipe_max_packets(%opencl.pipe_t addrspace(1)* %out_pipe, i32 4, i32 4) #5
  ...
  %1 = tail call i32 @__get_pipe_num_packets(%opencl.pipe_t addrspace(1)* %out_pipe, i32 4, i32 4) #5
  store i32 %1, i32 addrspace(1)* %num_packets, align 4, !tbaa !24
  ret void
; CHECK-SPIRV-LABEL: 1 FunctionEnd
}

declare i32 @__get_pipe_max_packets(%opencl.pipe_t addrspace(1)*, i32, i32) local_unnamed_addr

declare i32 @__get_pipe_num_packets(%opencl.pipe_t addrspace(1)*, i32, i32) local_unnamed_addr
...
entry:
  ...
  %0 = tail call %opencl.reserve_id_t* @__reserve_read_pipe(%opencl.pipe_t addrspace(1)* %in_pipe, i32 1, i32 4, i32 4) #5
  %call1 = tail call spir_func zeroext i1 @_Z19is_valid_reserve_id13ocl_reserveid(%opencl.reserve_id_t* %0) #6
  br i1 %call1, label %if.then, label %if.end
...
if.then:                                          ; preds = %entry
  ...
  %4 = tail call i32 @__read_pipe_4(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %0, i32 0, i8 addrspace(4)* %3, i32 4, i32 4) #5
  ; CHECK-LLVM: call{{.*}}@__commit_read_pipe
  ; CHECK-SPIRV: CommitReadPipe [[PipeArgID]] {{[0-9]+}} {{[0-9]+}} {{[0-9]+}}
  tail call void @__commit_read_pipe(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %0, i32 4, i32 4) #5
  br label %if.end
...
declare %opencl.reserve_id_t* @__reserve_read_pipe(%opencl.pipe_t addrspace(1)*, i32, i32, i32) local_unnamed_addr

declare i32 @__read_pipe_4(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i8 addrspace(4)*, i32, i32) local_unnamed_addr

declare void @__commit_read_pipe(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32) local_unnamed_addr
...
entry:
  ...
  %1 = tail call %opencl.reserve_id_t* @__work_group_reserve_write_pipe(%opencl.pipe_t addrspace(1)* %out_pipe, i32 %0, i32 1, i32 1) #5
...
if.then:                                          ; preds = %entry
  ...
  %6 = tail call i32 @__write_pipe_4(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %2, i32 %5, i8 addrspace(4)* %4, i32 1, i32 1) #5
  ...
  tail call void @__work_group_commit_write_pipe(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %7, i32 1, i32 1) #5
  br label %if.end
...
declare %opencl.reserve_id_t* @__work_group_reserve_write_pipe(%opencl.pipe_t addrspace(1)*, i32, i32, i32) local_unnamed_addr

; Function Attrs: convergent nounwind readnone
declare spir_func i64 @_Z12get_local_idj(i32) local_unnamed_addr #1

declare void @__work_group_commit_write_pipe(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32) local_unnamed_addr
...
entry:
  ...
  %1 = tail call %opencl.reserve_id_t* @__work_group_reserve_read_pipe(%opencl.pipe_t addrspace(1)* %in_pipe, i32 %0, i32 1, i32 1) #5
...
if.then:                                          ; preds = %entry
  ...
  %4 = addrspacecast i8 addrspace(1)* %arrayidx to i8 addrspace(4)*
  %5 = trunc i64 %call3 to i32
  %6 = tail call i32 @__read_pipe_4(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %2, i32 %5, i8 addrspace(4)* %4, i32 1, i32 1) #5
  ...
  tail call void @__work_group_commit_read_pipe(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %7, i32 1, i32 1) #5
  br label %if.end
...
declare %opencl.reserve_id_t* @__work_group_reserve_read_pipe(%opencl.pipe_t addrspace(1)*, i32, i32, i32) local_unnamed_addr

declare void @__work_group_commit_read_pipe(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32) local_unnamed_addr
...
entry:
  ...
  ; CHECK-SPIRV: GroupReserveWritePipePackets {{[0-9]+}} {{[0-9]+}} {{[0-9]+}} [[PipeArgID]] {{[0-9]+}} {{[0-9]+}} {{[0-9]+}}
  %0 = tail call %opencl.reserve_id_t* @__sub_group_reserve_write_pipe(%opencl.pipe_t addrspace(1)* %out_pipe, i32 %call1, i32 4, i32 4) #5
...
if.then:                                          ; preds = %entry
  ...
  %2 = bitcast i32 addrspace(1)* %arrayidx to i8 addrspace(1)*
  %3 = addrspacecast i8 addrspace(1)* %2 to i8 addrspace(4)*
  %4 = tail call i32 @__write_pipe_4(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %0, i32 %call3, i8 addrspace(4)* %3, i32 4, i32 4) #5
  ; CHECK-LLVM: call{{.*}}@__sub_group_commit_write_pipe
  ; CHECK-SPIRV: GroupCommitWritePipe {{[0-9]+}} [[PipeArgID]] {{[0-9]+}} {{[0-9]+}} {{[0-9]+}}
  tail call void @__sub_group_commit_write_pipe(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %0, i32 4, i32 4) #5
  br label %if.end
...
declare %opencl.reserve_id_t* @__sub_group_reserve_write_pipe(%opencl.pipe_t addrspace(1)*, i32, i32, i32) local_unnamed_addr

; Function Attrs: convergent
declare spir_func i32 @_Z22get_sub_group_local_idv() local_unnamed_addr #2

declare void @__sub_group_commit_write_pipe(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32) local_unnamed_addr
...
entry:
  ...
  ; CHECK-SPIRV: GroupReserveReadPipePackets {{[0-9]+}} {{[0-9]+}} {{[0-9]+}} [[PipeArgID]] {{[0-9]+}} {{[0-9]+}} {{[0-9]+}}
  %0 = tail call %opencl.reserve_id_t* @__sub_group_reserve_read_pipe(%opencl.pipe_t addrspace(1)* %in_pipe, i32 %call1, i32 4, i32 4) #5
  %call2 = tail call spir_func zeroext i1 @_Z19is_valid_reserve_id13ocl_reserveid(%opencl.reserve_id_t* %0) #6
  br i1 %call2, label %if.then, label %if.end
...
if.then:                                          ; preds = %entry
  ...
  %2 = bitcast i32 addrspace(1)* %arrayidx to i8 addrspace(1)*
  %3 = addrspacecast i8 addrspace(1)* %2 to i8 addrspace(4)*
  %4 = tail call i32 @__read_pipe_4(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %0, i32 %call3, i8 addrspace(4)* %3, i32 4, i32 4) #5
  ; CHECK-LLVM: call{{.*}}@__sub_group_commit_read_pipe
  ; CHECK-SPIRV: GroupCommitReadPipe {{[0-9]+}} [[PipeArgID]] {{[0-9]+}} {{[0-9]+}} {{[0-9]+}}
  tail call void @__sub_group_commit_read_pipe(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %0, i32 4, i32 4) #5
  br label %if.end
...
declare %opencl.reserve_id_t* @__sub_group_reserve_read_pipe(%opencl.pipe_t addrspace(1)*, i32, i32, i32) local_unnamed_addr

declare void @__sub_group_commit_read_pipe(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32) local_unnamed_addr

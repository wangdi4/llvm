...
; CHECK-NEXT:       "QUAL.OMP.MAP.TOFROM:CHAIN"(ptr @y, ptr @y, i64 2, i64 281474977251331, ptr null, ptr null), ; MAP type: 281474977251331 = 0x1000000084003 = MEMBER_OF_1 (0x1000000000000) | USE_ZERO_INIT_MEM (0x4000) | FROM (0x2) | TO (0x1) | UNKNOWN (0x80000)

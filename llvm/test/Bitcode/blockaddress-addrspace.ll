...
; RUN: llvm-as -opaque-pointers %t/global-use-good.ll -o - | llvm-dis -o /dev/null
; RUN: not llvm-as -opaque-pointers %t/global-use-bad.ll -o /dev/null 2>&1 | FileCheck %t/global-use-bad.ll
; RUN: llvm-as -opaque-pointers %t/global-fwddecl-good.ll -o - | llvm-dis -o /dev/null
; RUN: not llvm-as -opaque-pointers %t/global-fwddecl-bad.ll -o /dev/null 2>&1 | FileCheck %t/global-fwddecl-bad.ll
; RUN: llvm-as -opaque-pointers %t/return-fwddecl-good.ll  -o - | llvm-dis -o /dev/null
; RUN: not llvm-as -opaque-pointers %t/return-fwddecl-bad.ll -o /dev/null 2>&1 | FileCheck %t/return-fwddecl-bad.ll
; RUN: llvm-as -opaque-pointers %t/return-self-good.ll  -o - | llvm-dis -o /dev/null
; RUN: not llvm-as -opaque-pointers %t/return-self-bad.ll -o /dev/null 2>&1 | FileCheck %t/return-self-bad.ll
; RUN: not llvm-as -opaque-pointers %t/return-self-bad-2.ll -o /dev/null 2>&1 | FileCheck %t/return-self-bad-2.ll
; RUN: not llvm-as -opaque-pointers %t/return-unknown-fn-bad.ll -o /dev/null 2>&1 | FileCheck %t/return-unknown-fn-bad.ll
...
; RUN: llvm-as -opaque-pointers %t/phi-good.ll  -o - | llvm-dis -o /dev/null
; RUN: not llvm-as -opaque-pointers %t/phi-bad.ll -o /dev/null 2>&1 | FileCheck %t/phi-bad.ll
; RUN: llvm-as -opaque-pointers %t/fwddecl-phi-good.ll  -o - | llvm-dis -o /dev/null
; RUN: not llvm-as -opaque-pointers %t/fwddecl-phi-bad.ll -o /dev/null 2>&1 | FileCheck %t/fwddecl-phi-bad.ll
; RUN: not llvm-as -opaque-pointers %t/bad-type-not-ptr.ll -o /dev/null 2>&1 | FileCheck %t/bad-type-not-ptr.ll
; RUN: not llvm-as -opaque-pointers %t/bad-type-not-i8-ptr.ll -o /dev/null 2>&1 | FileCheck %t/bad-type-not-i8-ptr.ll

...
define <64 x i32> @zoo(<128 x i32> %A, <128 x i32> %B, <64 x i32> %C) {
  ; CHECK: call <64 x i32> @llvm.experimental.matrix.uumad.v64i32.v128i32.v128i32(<128 x i32> %A, <128 x i32> %B, <64 x i32> %C, i32 8, i32 16, i32 8, metadata !"scope.subgroup")
...
; CHECK-DAG: declare <64 x i32> @llvm.experimental.matrix.mad.v64i32.v128i32.v128i32(<128 x i32>, <128 x i32>, <64 x i32>, i32, i32, i32, metadata)
...
; CHECK-DAG: declare <64 x i32> @llvm.experimental.matrix.sumad.v64i32.v128i32.v128i32(<128 x i32>, <128 x i32>, <64 x i32>, i32, i32, i32, metadata)
...
; CHECK-DAG: declare <64 x i32> @llvm.experimental.matrix.usmad.v64i32.v128i32.v128i32(<128 x i32>, <128 x i32>, <64 x i32>, i32, i32, i32, metadata)
...
; CHECK-DAG: declare <64 x i32> @llvm.experimental.matrix.uumad.v64i32.v128i32.v128i32(<128 x i32>, <128 x i32>, <64 x i32>, i32, i32, i32, metadata)

...
;            Running pass: AutoCPUClonePass on [module]
...
;CHECK-NEXT: Running analysis: LoopAnalysis on foo
;CHECK-NEXT: Running analysis: DominatorTreeAnalysis on foo
;CHECK-NEXT: Running analysis: TargetLibraryAnalysis on foo
...
;CHECK-NEXT: Invalidating analysis: PostDominatorTreeAnalysis on foo
;CHECK-NEXT: Invalidating analysis: BranchProbabilityAnalysis on foo
;CHECK-NEXT: Invalidating analysis: BlockFrequencyAnalysis on foo
;CHECK-NEXT: Invalidating analysis: ScalarEvolutionAnalysis on foo

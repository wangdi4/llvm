...
; RUN: opt -opaque-pointers=0 -disable-verify -verify-cfg-preserved=0 -eagerly-invalidate-analyses=0 -debug-pass-manager \
...
; CHECK-O23SZ-NEXT: Running pass: DeadArgumentEliminationPass ;INTEL

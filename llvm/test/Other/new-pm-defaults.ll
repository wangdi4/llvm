...
; RUN:     | FileCheck %s --check-prefixes=CHECK-O,CHECK-LTO,CHECK-O3PRELTO,CHECK-O3,%llvmcheckext,CHECK-EP-PIPELINE-START,CHECK-O23SZ
...
; CHECK-O-NEXT: Running pass: SimplifyCFGPass
; CHECK-O-NEXT: Running pass: InstCombinePass
; CHECK-O3-NEXT: AggressiveInstCombinePass ;INTEL
...
; CHECK-DEFAULT-NEXT:  Invalidating analysis: InnerAnalysisManagerProxy
; CHECK-DEFAULT-NEXT:  Running pass: AutoCPUClonePass
...
; CHECK-O-NEXT: Running pass: InlineReportMakeCurrentPass ;INTEL

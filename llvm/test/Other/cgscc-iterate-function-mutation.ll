; RUN: opt -aa-pipeline=basic-aa -passes='cgscc(function-attrs,function(loop-simplifycfg))' -S < %s | FileCheck %s
...
; loop-simplifycfg to delete call edges and this ends up splitting both the SCCs

//===- DPCPPAliasAnalysis.h - addrspace based alias analysis ----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// DPCPPAliasAnalysis pass provides alias result based on the fact that pointers
// in different address spaces are not aliased.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_TRANSFORMS_INTEL_DPCPPKERNELTRANSFORMS_DPCPPALIASANALYSIS_H
#define LLVM_TRANSFORMS_INTEL_DPCPPKERNELTRANSFORMS_DPCPPALIASANALYSIS_H
...
private:
  // AACallbackVH - A CallbackVH to arrange for DPCPPAliasAnalysis to be
  ...
  public:
    AACallbackVH(Value *V, DPCPPAAResult *AAR = nullptr);
...
class DPCPPAliasAnalysis : public AnalysisInfoMixin<DPCPPAliasAnalysis> {
  friend AnalysisInfoMixin<DPCPPAliasAnalysis>;
  static AnalysisKey Key;

public:
  using Result = DPCPPAAResult;

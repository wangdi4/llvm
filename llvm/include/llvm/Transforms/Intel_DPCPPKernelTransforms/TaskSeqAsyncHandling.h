...
#ifndef LLVM_TRANSFORMS_INTEL_DPCPP_KERNEL_TRANSFORMS_TASK_SEQ_ASYNC_HANDLING_H
#define LLVM_TRANSFORMS_INTEL_DPCPP_KERNEL_TRANSFORMS_TASK_SEQ_ASYNC_HANDLING_H
...
#endif // LLVM_TRANSFORMS_INTEL_DPCPP_KERNEL_TRANSFORMS_TASK_SEQ_ASYNC_HANDLING_H

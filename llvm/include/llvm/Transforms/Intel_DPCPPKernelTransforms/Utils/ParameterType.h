...
#ifndef INTEL_DPCPP_KERNEL_TRANSFORMS_UTILS_PARAMETER_TYPE_H
#define INTEL_DPCPP_KERNEL_TRANSFORMS_UTILS_PARAMETER_TYPE_H
...
#endif // INTEL_DPCPP_KERNEL_TRANSFORMS_UTILS_PARAMETER_TYPE_H

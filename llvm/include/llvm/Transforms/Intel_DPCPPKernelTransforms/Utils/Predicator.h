...
#ifndef LLVM_TRANSFORMS_INTEL_DPCPPKERNELTRANSFORMS_UTILS_PREDICATOR_H
#define LLVM_TRANSFORMS_INTEL_DPCPPKERNELTRANSFORMS_UTILS_PREDICATOR_H
...
#endif // LLVM_TRANSFORMS_INTEL_DPCPPKERNELTRANSFORMS_UTILS_PREDICATOR_H

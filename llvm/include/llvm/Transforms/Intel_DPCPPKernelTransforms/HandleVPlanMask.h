...
#ifndef LLVM_TRANSFORMS_INTEL_DPCPP_KERNEL_TRANSFORMS_HANDLE_VPLAN_MASK
#define LLVM_TRANSFORMS_INTEL_DPCPP_KERNEL_TRANSFORMS_HANDLE_VPLAN_MASK
...
#endif // LLVM_TRANSFORMS_INTEL_DPCPP_KERNEL_TRANSFORMS_HANDLE_VPLAN_MASK

...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_PIPE_SUPPORT_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_PIPE_SUPPORT_H
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_PIPE_SUPPORT_H

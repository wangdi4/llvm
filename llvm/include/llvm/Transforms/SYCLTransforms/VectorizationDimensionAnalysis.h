...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_VECTORIZATION_DIMENSION_ANALYSIS_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_VECTORIZATION_DIMENSION_ANALYSIS_H
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_VECTORIZATION_DIMENSION_ANALYSIS_H

...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_DPCPP_REWRITE_PIPES_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_DPCPP_REWRITE_PIPES_H
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_DPCPP_REWRITE_PIPES_H

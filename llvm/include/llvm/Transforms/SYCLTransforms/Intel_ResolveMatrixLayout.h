...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_RESOLVE_MATRIX_LAYOUT_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_RESOLVE_MATRIX_LAYOUT_H
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_RESOLVE_MATRIX_LAYOUT_H

//==------ Intel_SinCosFold.h - Fold sin(), cos() into sincos() -- C++ -*---==//
//
...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_SIN_COS_FOLD_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_SIN_COS_FOLD_H
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_SIN_COS_FOLD_H

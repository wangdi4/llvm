//==- SYCLRewritePipes.h - Rewrite SYCL pipe structs to OpenCL structs --==//
//
...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_SYCL_REWRITE_PIPES_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_SYCL_REWRITE_PIPES_H
...
/// Rewrite SYCL pipe structs to OpenCL pipe structs.
...
///
/// Following the design for OpenCL FPGA channels, SYCLRewritePipes pass
...
class SYCLRewritePipesPass : public PassInfoMixin<SYCLRewritePipesPass> {
public:
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_SYCL_REWRITE_PIPES_H

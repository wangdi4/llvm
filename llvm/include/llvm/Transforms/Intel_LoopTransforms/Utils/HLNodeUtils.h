...
private:
  ...
  static void insertAsChildImpl(HLNode* Parent,
    HLContainerTy* RemoveContainer, HLContainerTy::iterator First,
  ...
  static bool IsInPreheaderPostexitImpl(HLLoop* Loop, HLNode* Node, 
    bool Preheader);
  ...
  static void removeImpl(HLContainerTy::iterator First,
    HLContainerTy::iterator Last, HLContainerTy* MoveContainer, 
    bool Erase = false);
...
public:
  ...
  /// before Pos.
  static void moveBefore(HLNode* Pos, 
    HLContainerTy::iterator First, HLContainerTy::iterator Last);
  /// \brief Unlinks [First, Last) from their current position and inserts them
  /// after Pos.
  static void moveAfter(HLNode* Pos, 
    HLContainerTy::iterator First, HLContainerTy::iterator Last);
  ...
  static void moveAsFirstIfChildren(HLIf* If, HLContainerTy::iterator First, 
    HLContainerTy::iterator Last, bool IsThenChild = true);
  /// \brief Unlinks [First, Last) from their current position and inserts them  
  ...
  static bool IsInPreheader(HLLoop* Loop, HLNode* Node);
  /// \brief Returns true if the Node is in Loop's postexit.
  static bool IsInPostexit(HLLoop* Loop, HLNode* Node);
  /// \brief Returns true if the Node is in Loop's preheader or postexit.
  static bool IsInPreheaderOrPostexit(HLLoop* Loop, HLNode* Node);

...
# if INTEL_CUSTOMIZATION
  /// NOTIFY_LABEL - Represents an Intel Low Overhead Tool Annotation, which
  /// is generated by __notify_intrinsic or __notify_zc_intrinsic, no
  /// instructions will generated at last, its location and params will be
  /// saved to a special section. More infomation about this section please
  /// refer to X86AsmPrinter::emitNotifyTable.
  NOTIFY_LABEL,
#endif // INTEL_CUSTOMIZATION

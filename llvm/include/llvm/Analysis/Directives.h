...
///
/// \file
/// Contains the enums and maps to support directives and clauses.
/// Directives.gen is automatically generated by TableGen based on
/// the definitions in include/llvm/IR/Directives.td.
///
// ===--------------------------------------------------------------------=== //

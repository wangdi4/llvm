...
define dso_local i32 @main() {
  ...
  %t0 = load i32 ()*, i32 ()** getelementptr inbounds (%struct.MYOSTRUCT, %struct.MYOSTRUCT* @globstruct, i32 0, i32 2, i32 0), align 8
  %call = call i32 %t0()
  %t1 = load i32 ()*, i32 ()** getelementptr inbounds (%struct.MYOSTRUCT, %struct.MYOSTRUCT* @globstruct, i32 0, i32 2, i32 1), align 8
  %call1 = call i32 %t1()

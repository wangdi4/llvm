; This test verifies that MemManageTrans is not triggered because the reset
; function below is address taken in "VT" and "VT" is used in non-interface
; function (_ZN11xalanc_1_1022XStringCachedAllocator5resetEv.8911).
;
...
; CHECK: Failed: Unknown Interface function uses

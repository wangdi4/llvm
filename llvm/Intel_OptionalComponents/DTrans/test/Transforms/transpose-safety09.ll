...
%TEST01.uplevel_type = type { { i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }*, i32 }
...
define void @test01dv({ i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }* noalias nocapture readonly %MYBLOCK) {
  %uplevel_rec = alloca %TEST01.uplevel_type, align 8

  ; Load the dope vector into the uplevel var
  %ul_arg_0p.GEP = getelementptr inbounds %TEST01.uplevel_type, %TEST01.uplevel_type* %uplevel_rec, i64 0, i32 0

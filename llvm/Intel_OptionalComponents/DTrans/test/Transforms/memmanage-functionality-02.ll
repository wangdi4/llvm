...
; This is not recognized due to extra store instruction in the routine.
...
; CHECK:  Recognizing GetMemManager Functionality _ZN11xalanc_1_1014ArenaAllocatorINS_13XStringCachedENS_18ReusableArenaBlockIS1_tEEE16getMemoryManagerEv
; CHECK:   Failed: Missed processing some instructions
; CHECK:     store %MemoryManager* null, %MemoryManager** %i1, align 8
; CHECK:   Failed: Recognizing functionality
...
define internal nonnull align 8 dereferenceable(8) %"MemoryManager"* @_ZN11xalanc_1_1014ArenaAllocatorINS_13XStringCachedENS_18ReusableArenaBlockIS1_tEEE16getMemoryManagerEv(%"ArenaAllocator"* nocapture nonnull readonly dereferenceable(40) %arg) align 2 {
  ...
  store %"MemoryManager"* null, %"MemoryManager"** %i1, align 8

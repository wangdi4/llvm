...
define void @test01dv({ i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }* noalias nocapture readonly %MYBLOCK) {
  ...
  %ul_loc_1.0_var = getelementptr inbounds %TEST01.uplevel_type, %TEST01.uplevel_type* %uplevel_rec, i64 0, i32 1
  store i32 9, i32* %ul_loc_1.0_var, align 8

  call void @test01ul(%TEST01.uplevel_type* %uplevel_rec)
  ret void
}

; This checks the usage of the dope vector that gets loaded from an uplevel
; variable.
define void @test01ul(%TEST01.uplevel_type* %UL_IN_PTR) {
  %ul_arg_0p.GEP = getelementptr inbounds %TEST01.uplevel_type, %TEST01.uplevel_type* %UL_IN_PTR, i64 0, i32 0
...
;TEST_CAST:  %cast = bitcast %TEST01.uplevel_type* %UL_IN_PTR to i8*
...
; Uplevel type.
%TEST02.uplevel_type.12 = type { { i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }* }
...
define void @test02dv({ i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }* noalias nocapture readonly %MYBLOCK) {
  %uplevel_rec = alloca %TEST02.uplevel_type.12, align 8

  ; Load the dope vector into the uplevel var
  %ul_arg_0p.GEP = getelementptr inbounds %TEST02.uplevel_type.12, %TEST02.uplevel_type.12* %uplevel_rec, i64 0, i32 0
  store { i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }* %MYBLOCK, { i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }** %ul_arg_0p.GEP, align 8

  call void @test02ulfwd(%TEST02.uplevel_type.12* %uplevel_rec)
  ret void
}

; Pass the uplevel variable to another function
define void @test02ulfwd(%TEST02.uplevel_type.12* %UL_IN_PTR) {
  call void @test02ul(%TEST02.uplevel_type.12* %UL_IN_PTR)
  ret void
}

; This checks the usage of the dope vector that gets loaded from an uplevel
; variable.
define void @test02ul(%TEST02.uplevel_type.12* %UL_IN_PTR) {
  %ul_arg_0p.GEP = getelementptr inbounds %TEST02.uplevel_type.12, %TEST02.uplevel_type.12* %UL_IN_PTR, i64 0, i32 0
  %ul_arg_0.GEP = load { i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }*, { i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }** %ul_arg_0p.GEP, align 8
  ...
  store i32 0, i32* %ptr_addr, align 4
    ...
    ; Variation of test perform an unsupported operation on the uplevel to
    ; cause the candidate to be invalidated.
;TEST_CAST:  %cast = bitcast %TEST02.uplevel_type.12* %UL_IN_PTR to i8*

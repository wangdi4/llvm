; This test is same as memmanage-functionality-08.ll except for the following
; main changes.
;
;  DestroyObject (_ZN11xalanc_1_1022ReusableArenaAllocatorINS_13XStringCachedEE13destroyObjectEPS1_)
;     New %bbnew BB is created and CFG is changed due to this new BB.
;
...
bb287:                                            ; preds = %bb305, %bbnew
  %i288 = phi %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* [ %i292, %bb305 ], [ %i284, %bbnew ]
...
bb502:                                            ; preds = %bb494, %bb486, %bb476, %bb472, %bb468, %bb443, %bb305, %bb287, %bb279, %bb214
  %i503 = phi i8 [ 1, %bb443 ], [ 1, %bb468 ], [ 1, %bb472 ], [ 1, %bb476 ], [ 1, %bb486 ], [ 1, %bb494 ], [ %i255, %bb283 ], [ %i255, %bb287 ], [ %i255, %bb305 ], [ 1, %bb214 ]
  %i504 = and i8 %i503, 1

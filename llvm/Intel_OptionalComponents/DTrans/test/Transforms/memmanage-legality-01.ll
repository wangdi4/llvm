; This test verifies that MemManageTrans is not triggered since the reset
; function below is called from non-interface function
; (NonStringObjMemberFunction)
;
...
define internal void @NonStringObjMemberFunction() align 2 {
  tail call void @_ZN11xalanc_1_1014ArenaAllocatorINS_13XStringCachedENS_18ReusableArenaBlockIS1_tEEE5resetEv(%"ArenaAllocator"* null)
  ret void
}

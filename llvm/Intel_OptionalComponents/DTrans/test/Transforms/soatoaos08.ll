...
%struct.Arr = type { i32, i32**, i32, %struct.Mem*, i8 }
%struct.Arr.0 = type { i32, float**, i32, %struct.Mem*, i8 }
; CHECK-DAG: %__SOADT_class.F = type { %__SOADT_AR_struct.Arr*, i64, %struct.Mem*  }
; CHECK-DAG: %__SOADT_AR_struct.Arr = type { i32, %__SOADT_EL_class.F*, i32, %struct.Mem*, i8 }
...
entry:
  ...
  %call = call i8* @_Znwm(i64 40), !dbg !238
...
invoke.cont:                                      ; preds = %entry
  ...
  %call2 = call i8* @_Znwm(i64 40), !dbg !243
...
entry:
  ...
  %call = call i8* @_Znwm(i64 40), !dbg !286
...
invoke.cont:                                      ; preds = %entry
  ...
  %call3 = call i8* @_Znwm(i64 40), !dbg !292
...
entry:
  ...
  %size = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !313
...
entry:
  ...
  %size = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !328
...
if.end:                                           ; preds = %entry
  ...
  %idxprom3 = zext i32 %i to i64, !dbg !335
  %arrayidx4 = getelementptr inbounds float*, float** %tmp3, i64 %idxprom3, !dbg !335
  ret float** %arrayidx4, !dbg !337
}

define void @"Arr<int*>::Arr(int, struct.Mem*)"(%struct.Arr* nocapture %this, i32 %c, %struct.Mem* %m) align 2 !dbg !338 {
entry:
  ...
  %flag = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i64 0, i32 4
  store i8 0, i8* %flag
  %capacity = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 0, !dbg !343
  store i32 %c, i32* %capacity, align 8, !dbg !343
  ...
  %capacity2 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 0, !dbg !346
  %tmp1 = load i32, i32* %capacity2, align 8, !dbg !346
  %conv = zext i32 %tmp1 to i64
  %mul = mul i64 %conv, 8, !dbg !348
  %mem3 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 3
  store %struct.Mem* %m, %struct.Mem** %mem3
  ...
  %call = call i8* @malloc(i64 %mul), !dbg !349
  %tmp2 = bitcast i8* %call to i32**, !dbg !350
  store i32** %tmp2, i32*** %base, align 8, !dbg !352
  tail call void @llvm.memset.p0i8.i64(i8* align 8 %call, i8 0, i64 %mul, i1 false)
  ret void, !dbg !353
}

define void @"Arr<float*>::Arr(int, struct.Mem*)"(%struct.Arr.0* nocapture %this, i32 %c, %struct.Mem* %m) align 2 !dbg !354 {
entry:
  ...
  %flag = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i64 0, i32 4
  store i8 0, i8* %flag
  %capacity = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 0, !dbg !359
  store i32 %c, i32* %capacity, align 8, !dbg !359
  ...
  %capacity2 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 0, !dbg !362
  %tmp1 = load i32, i32* %capacity2, align 8, !dbg !362
  %conv = zext i32 %tmp1 to i64, !dbg !362
  %mul = mul i64 %conv, 8, !dbg !364
  %mem3 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 3
  store %struct.Mem* %m, %struct.Mem** %mem3
  ...
  %tt = tail call i1 @llvm.type.test(i8* %bc1, metadata !"typeId")
  tail call void @llvm.assume(i1 %tt)
  %call = call i8* @malloc(i64 %mul), !dbg !365
  %tmp2 = bitcast i8* %call to float**, !dbg !366
  store float** %tmp2, float*** %base, align 8, !dbg !368
  tail call void @llvm.memset.p0i8.i64(i8* align 8 %call, i8 0, i64 %mul, i1 false)
  ret void, !dbg !369
}
...
entry:
  ...
  %capacity = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 0, !dbg !422
...
for.cond.cleanup:                                 ; preds = %for.body, %if.end
  %base14 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i64 0, i32 1
...
entry:
  ...
  %capacity = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 0, !dbg !470
...
for.cond.cleanup:                                 ; preds = %for.body, %if.end
  %base14 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i64 0, i32 1
...
entry:
  ...
  %size = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !517
...
entry:
  ...
  %size = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !534
...
entry:
  ...
  %flag = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i64 0, i32 4, !dbg !549
  %flag2 = getelementptr inbounds %struct.Arr, %struct.Arr* %A, i64 0, i32 4
  %i = load i8, i8* %flag2, align 8
  store i8 %i, i8* %flag, align 8
  %capacity = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i64 0, i32 0
  %capacity3 = getelementptr inbounds %struct.Arr, %struct.Arr* %A, i64 0, i32 0
  ...
  %mem = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i64 0, i32 3
  %mem5 = getelementptr inbounds %struct.Arr, %struct.Arr* %A, i64 0, i32 3
...
for.body.lr.ph:                                   ; preds = %entry
  %base13 = getelementptr inbounds %struct.Arr, %struct.Arr* %A, i64 0, i32 1
...
entry:
  ...
  %flag = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i64 0, i32 4, !dbg !608
  %flag2 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %A, i64 0, i32 4
  %i = load i8, i8* %flag2, align 8
  store i8 %i, i8* %flag, align 8
  %capacity = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i64 0, i32 0
  %capacity3 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %A, i64 0, i32 0
  %i1 = load i32, i32* %capacity3, align 4
  store i32 %i1, i32* %capacity, align 4
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i64 0, i32 1
  ...
  %i2 = load i32, i32* %size4, align 8
  store i32 %i2, i32* %size, align 8
  %mem = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i64 0, i32 3
  %mem5 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %A, i64 0, i32 3
  %i3 = load %struct.Mem*, %struct.Mem** %mem5, align 8
  store %struct.Mem* %i3, %struct.Mem** %mem, align 8
  %conv = zext i32 %i1 to i64
  %mul = shl nuw nsw i64 %conv, 3
...
for.body.lr.ph:                                   ; preds = %entry
  %base13 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %A, i64 0, i32 1

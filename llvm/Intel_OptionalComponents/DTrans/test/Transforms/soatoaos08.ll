...
%struct.Arr = type { i32, i32**, i32, %struct.Mem* }
%struct.Arr.0 = type { i32, float**, i32, %struct.Mem* }
; CHECK-DAG: %__SOADT_class.F = type { %__SOADT_AR_struct.Arr*, i64, %struct.Mem* }
; CHECK-DAG: %__SOADT_AR_struct.Arr = type { i32, %__SOADT_EL_class.F*, i32, %struct.Mem* }
...
if.then:                                          ; preds = %entry
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !317
...
if.end:                                           ; preds = %entry
  %base2 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !320
...
if.then:                                          ; preds = %entry
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !332
...
if.end:                                           ; preds = %entry
  %base2 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !335
...
entry:
  ...
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !344
  store i32** null, i32*** %base, align 8, !dbg !344
  %size = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !345
  ...
  %mem = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 3
  %ld1 = load %"struct.Mem"*, %struct.Mem** %mem
  %tmp6 = bitcast %struct.Mem* %ld1 to void (%struct.Mem*, i8*)***
  %vtable = load void (%struct.Mem*, i8*)**, void (%struct.Mem*, i8*)*** %tmp6
  %bc1 = bitcast void (%struct.Mem*, i8*)** %vtable to i8*
  ...
  %base4 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !351
...
entry:
  ...
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !360
  store float** null, float*** %base, align 8, !dbg !360
  %size = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !361
  ...
  %mem = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 3
  %ld1 = load %"struct.Mem"*, %struct.Mem** %mem
  %tmp6 = bitcast %struct.Mem* %ld1 to void (%struct.Mem*, i8*)***
  %vtable = load void (%struct.Mem*, i8*)**, void (%struct.Mem*, i8*)*** %tmp6
  %bc1 = bitcast void (%struct.Mem*, i8*)** %vtable to i8*
  ...
  %base4 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !367
...
if.then:                                          ; preds = %entry
  ...
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !381
  %tmp3 = load i32**, i32*** %base, align 8, !dbg !381
  %size = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !382
...
if.else:                                          ; preds = %entry
  ...
  %base2 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !386
  %tmp7 = load i32**, i32*** %base2, align 8, !dbg !386
  %size3 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !387
...
if.end:                                           ; preds = %if.else, %if.then
  %size6 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !389
...
if.then:                                          ; preds = %entry
  ...
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !403
  %tmp3 = load float**, float*** %base, align 8, !dbg !403
  %size = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !404
...
if.else:                                          ; preds = %entry
  ...
  %base2 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !408
  %tmp7 = load float**, float*** %base2, align 8, !dbg !408
  %size3 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !409
...
if.end:                                           ; preds = %if.else, %if.then
  %size6 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !411
...
entry:
  ...
  %size = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !419
...
if.end:                                           ; preds = %entry
  %size2 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !426
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %size8 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !443
...
for.body:                                         ; preds = %for.cond
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !447
...
for.end:                                          ; preds = %for.cond
  %base14 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !457
  %tmp15 = load i32**, i32*** %base14, align 8, !dbg !457
  %tmp16 = bitcast i32** %tmp15 to i8*, !dbg !457
  call void @free(i8* %tmp16), !dbg !458
  %base15 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !459
...
entry:
  ...
  %size = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !467
...
if.end:                                           ; preds = %entry
  %size2 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !474
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %size8 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !491
  %tmp8 = load i32, i32* %size8, align 8, !dbg !491
  %cmp9 = icmp slt i32 %i.0, %tmp8, !dbg !493
  br i1 %cmp9, label %for.body, label %for.end, !dbg !494

for.body:                                         ; preds = %for.cond
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !495
...
for.end:                                          ; preds = %for.cond
  %base14 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !505
  %tmp15 = load float**, float*** %base14, align 8, !dbg !505
  %tmp16 = bitcast float** %tmp15 to i8*, !dbg !505
  call void @free(i8* %tmp16), !dbg !506
  %base15 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !507
...
if.then:                                          ; preds = %entry
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !521
...
if.else:                                          ; preds = %entry
  %base2 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !524
...
if.then:                                          ; preds = %entry
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !538
...
if.else:                                          ; preds = %entry
  %base2 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !541
...
entry:
  ...
  %size = getelementptr inbounds %struct.Arr, %struct.Arr* %A, i32 0, i32 2, !dbg !553
  %tmp3 = load i32, i32* %size, align 8, !dbg !553
  %size3 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !554
...
if.then:                                          ; preds = %entry
  ...
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !566
...
if.else:                                          ; preds = %entry
  ...
  %base13 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !572
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %size14 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 2, !dbg !579
...
if.then18:                                        ; preds = %for.body
  %base19 = getelementptr inbounds %struct.Arr, %struct.Arr* %A, i32 0, i32 1, !dbg !587
  ...
  %base21 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !590
...
if.else25:                                        ; preds = %for.body
  %base26 = getelementptr inbounds %struct.Arr, %struct.Arr* %A, i32 0, i32 1, !dbg !593
  ...
  %base29 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !595
...
entry:
  ...
  %size = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %A, i32 0, i32 2, !dbg !612
  %tmp3 = load i32, i32* %size, align 8, !dbg !612
  %size3 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !613
...
if.then:                                          ; preds = %entry
  ...
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !625
...
if.else:                                          ; preds = %entry
  ...
  %base13 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !631
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %size14 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 2, !dbg !638
...
if.then18:                                        ; preds = %for.body
  %base19 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %A, i32 0, i32 1, !dbg !646
  ...
  %base21 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !649
...
if.else25:                                        ; preds = %for.body
  %base26 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %A, i32 0, i32 1, !dbg !652
  ...
  %base29 = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !654
...
entry:
  ...
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 1, !dbg !665
...
entry:
  ...
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 1, !dbg !672

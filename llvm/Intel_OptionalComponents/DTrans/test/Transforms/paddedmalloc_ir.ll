...
; CHECK-PROP-NEXT:    [[T1:%.*]] = call i8* @llvm.ptr.annotation.p0i8(i8* [[T]], i8* getelementptr inbounds ([16 x i8], [16 x i8]* [[PADD]], i32 0, i32 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @1, i32 0, i32 0), i32 0)

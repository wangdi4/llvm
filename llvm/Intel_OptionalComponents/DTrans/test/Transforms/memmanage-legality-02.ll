; This test verifies that MemManageTrans is triggered even though the reset
; function below is address taken in "VT" but "VT" is used only in interface
; function (destroyObject), which will be fully analyzed (recognized) by
; the transformation.
;
; _ZN11xalanc_1_1014ArenaAllocatorINS_13XStringCachedENS_18ReusableArenaBlockIS1_tEEE5resetEv
...
; CHECK-NOT: Failed: Unknown Interface function uses

@VT = dso_local global void (%"ArenaAllocator"* )* @_ZN11xalanc_1_1014ArenaAllocatorINS_13XStringCachedENS_18ReusableArenaBlockIS1_tEEE5resetEv
...
define internal zeroext i1 @_ZN11xalanc_1_1022ReusableArenaAllocatorINS_13XStringCachedEE13destroyObjectEPS1_(%"ReusableArenaAllocator"* nocapture nonnull dereferenceable(41) %0, %"XStringCached"* %1) align 2 {
  %ld = load void (%"ArenaAllocator"* )*, void (%"ArenaAllocator"* )** @VT
  ret i1 false
}

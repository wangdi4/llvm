...
; possible to remap a type when the global variable is defined as an array type.
...
@var = global [ 2 x %struct.outer ] [%struct.outer { i32 4, i32 8, %struct.middle* null }, %struct.outer { i32 2, i32 4, %struct.middle* null } ]

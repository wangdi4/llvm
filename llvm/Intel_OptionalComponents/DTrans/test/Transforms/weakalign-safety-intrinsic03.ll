...
; RUN: opt < %s -S -whole-program-assume -intel-libirc-allowed -dtrans-weakalign -dtrans-weakalign-heur-override=true -debug-only=dtrans-weakalign 2>&1 | FileCheck %s

...
define %struct.test.01* @init() {
  ...
  %tp2 = getelementptr %struct.test.01, %struct.test.01* %tp1, i64 4
  %call3 = tail call noalias i8* @calloc(i64 20, i64 48)
...
; Store %tp3 in 3rd array field of @n
  ...
  store %struct.test.01* %tp3, %struct.test.01** %PN8
...
; Store %tp2 in 2nd array field of @n
  ...
  store %struct.test.01* %tp2, %struct.test.01** %PN9

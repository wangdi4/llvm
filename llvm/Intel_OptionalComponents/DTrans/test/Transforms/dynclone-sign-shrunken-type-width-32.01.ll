...
; CHECK: %__DYN_struct.test.01 = type <{ i64*, i32, i32, i32, i32, i32, i32 }>

; This routine is selected as InitRoutine.
define void @init() {
; CHECK-LABEL: @init(
; CHECK-NEXT:    [[DYN_ALLOC17:%.*]] = alloca i64, align 8
; CHECK-NEXT:    [[DYN_ALLOC:%.*]] = alloca i8*, align 8
; CHECK-NEXT:    [[DYN_SAFE:%.*]] = alloca i8, align 1
; CHECK-NEXT:    store i8 0, i8* [[DYN_SAFE]], align 1

; Initialize d_max = 0xffffffffe0000000, d_min = 0x10000000
; CHECK-NEXT:    [[D_MAX:%.*]] = alloca i64, align 8
; CHECK-NEXT:    store i64 -536870912, i64* [[D_MAX]], align 8
; CHECK-NEXT:    [[D_MIN:%.*]] = alloca i64, align 8
; CHECK-NEXT:    store i64 536870911, i64* [[D_MIN]], align 8

; CHECK:         [[CALL1:%.*]] = tail call noalias i8* @calloc(i64 10, i64 56)
  %call1 = tail call noalias i8* @calloc(i64 10, i64 56)

; CHECK:         [[TP1:%.*]] = bitcast i8* [[CALL1]] to %struct.test.01*
  %tp1 = bitcast i8* %call1 to %struct.test.01*

; CHECK-NEXT:    [[F1:%.*]] = getelementptr [[STRUCT_TEST_01:%.*]], %struct.test.01* [[TP1]], i32 0, i32 1
...
; CHECK:         [[TMP5:%.*]] = getelementptr inbounds [[STRUCT_TEST_01]], %struct.test.01* [[TMP1:%.*]], i64 [[LINDEX]], i32 1
; CHECK-NEXT:    [[TMP6:%.*]] = load i64, i64* [[TMP5]], align 8

; CHECK:         [[TMP11:%.*]] = getelementptr inbounds [[STRUCT_TEST_01]], %struct.test.01* [[TMP1]], i64 [[LINDEX]], i32 4
; CHECK-NEXT:    [[TMP12:%.*]] = load i16, i16* [[TMP11]], align 2

; CHECK:         [[TMP15:%.*]] = getelementptr inbounds [[STRUCT_TEST_01]], %struct.test.01* [[TMP1]], i64 [[LINDEX]], i32 6
; CHECK-NEXT:    [[TMP16:%.*]] = load i64, i64* [[TMP15]], align 8

; Field 1 and field 4 are packed to field 2 of %__DYN_struct.test.01.
; CHECK:         [[TMP20:%.*]] = getelementptr inbounds [[__DYN_STRUCT_TEST_01:%.*]], %__DYN_struct.test.01* [[TMP2:%.*]], i64 [[LINDEX]], i32 2
...
; CHECK-NEXT:    store i32 [[TMP25]], i32* [[TMP20]], align 4

; CHECK:         [[TMP28:%.*]] = getelementptr inbounds [[__DYN_STRUCT_TEST_01]], %__DYN_struct.test.01* [[TMP2]], i64 [[LINDEX]], i32 2
; CHECK-NEXT:    [[TMP29:%.*]] = zext i16 [[TMP12]] to i32
; CHECK-NEXT:    [[TMP30:%.*]] = load i32, i32* [[TMP28]], align 4
...
; CHECK-NEXT:    store i32 [[TMP34]], i32* [[TMP28]], align 4

; CHECK:         [[TMP36:%.*]] = getelementptr inbounds [[__DYN_STRUCT_TEST_01]], %__DYN_struct.test.01* [[TMP2]], i64 [[LINDEX]], i32 5
; CHECK-NEXT:    [[TMP37:%.*]] = trunc i64 [[TMP16]] to i32
; CHECK-NEXT:    store i32 [[TMP37]], i32* [[TMP36]], align 4
; CHECK-NEXT:    [[TMP38:%.*]] = getelementptr inbounds [[__DYN_STRUCT_TEST_01]], %__DYN_struct.test.01* [[TMP2]], i64 [[LINDEX]], i32 6
...
define void @proc1() {
; CHECK-LABEL: @proc1(
; CHECK-NEXT:    [[CALL1:%.*]] = tail call noalias i8* @calloc(i64 10, i64 32)
  %call1 = tail call noalias i8* @calloc(i64 10, i64 56)

; CHECK-NEXT:    [[TP2:%.*]] = bitcast i8* [[CALL1]] to %struct.test.01*
  %tp2 = bitcast i8* %call1 to %struct.test.01*

; CHECK-NEXT:    [[TMP1:%.*]] = bitcast %struct.test.01* [[TP2]] to %__DYN_struct.test.01*
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr [[__DYN_STRUCT_TEST_01:%.*]], %__DYN_struct.test.01* [[TMP1]], i32 0, i32 5
; CHECK-NEXT:    [[F6:%.*]] = bitcast i32* [[TMP2]] to i64*
  %F6 = getelementptr %struct.test.01, %struct.test.01* %tp2, i32 0, i32 6

; L1 = (int64_t)((int32_t)(*F6))
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast i64* [[F6]] to i32*
...
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast %struct.test.01* [[TP2]] to %__DYN_struct.test.01*
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr [[__DYN_STRUCT_TEST_01]], %__DYN_struct.test.01* [[TMP5]], i32 0, i32 2
; CHECK-NEXT:    [[F1:%.*]] = bitcast i32* [[TMP6]] to i64*
...
; CHECK-NEXT:    [[TMP8:%.*]] = bitcast i64* [[F1]] to i32*
...
; CHECK-NEXT:    store i32 [[TMP12]], i32* [[TMP8]], align 4
  store i64 %L1, i64* %F1

; L2 = sext i30 ((*F1) & (0x3fffffff)), i64;
; CHECK-NEXT:    [[TMP13:%.*]] = bitcast i64* [[F1]] to i32*
...
; CHECK-NEXT:    [[TMP17:%.*]] = bitcast %struct.test.01* [[TP2]] to %__DYN_struct.test.01*
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr [[__DYN_STRUCT_TEST_01]], %__DYN_struct.test.01* [[TMP17]], i32 0, i32 2
; CHECK-NEXT:    [[F4:%.*]] = bitcast i32* [[TMP18]] to i16*
...
; CHECK-NEXT:    [[TMP20:%.*]] = bitcast i16* [[F4]] to i32*
...
; CHECK-NEXT:    [[TMP27:%.*]] = bitcast i16* [[F4]] to i32*
; CHECK-NEXT:    [[TMP28:%.*]] = load i32, i32* [[TMP27]], align 4
...
; CHECK-NEXT:    store i32 [[TMP32]], i32* [[TMP27]], align 4
  store i16 %S1, i16* %F4

; CHECK-NEXT:    [[TMP33:%.*]] = bitcast i16* [[F4]] to i32*

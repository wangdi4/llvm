; RUN: opt -S -passes=dtransop-optbasetest -dtransop-optbasetest-typelist=struct.test01a,struct.test02a,struct.test03a < %s 2>&1 | FileCheck %s
...
@globVar01a = internal global %struct.test01a { ptr @globInt, ptr @globInt, ptr @globInt }
@globVar02a = internal global %struct.test02a { i32 1, ptr @globVar02b }
@globVar02b = internal global %struct.test02b { i32 2 }
@globVar03a = internal global %struct.test03a { i32 3 }
@globVar03b = internal global %struct.test03b { i32 4, ptr @globVar03a }
...
; CHECK-DAG: @globVar01a = internal global %__DTT_struct.test01a { ptr @globInt, ptr @globInt, ptr @globInt }
; CHECK-DAG: @globVar02a = internal global %__DTT_struct.test02a { i32 1, ptr @globVar02b }
; CHECK-DAG: @globVar02b = internal global %struct.test02b { i32 2 }
; CHECK-DAG: @globVar03a = internal global %__DTT_struct.test03a { i32 3 }
; CHECK-DAG: @globVar03b = internal global %struct.test03b { i32 4, ptr @globVar03a }

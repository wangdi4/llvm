...
;   4. A "*_branch_funnel" generated by the WholeProgramDevirt
;      pass does not inhibit the candidate recognition.
; REQUIRES: asserts
...
; Test that a *_branch_funnel function generated during whole program
; devirtualization that has no references does not inhibit candidate
; recognition, even if it does not have metadata for the types.
define hidden void @__typeid__ZTSN11xalanc_1_1011XStringBaseE_64_branch_funnel(ptr nest %0, ...) {
  ret void
}

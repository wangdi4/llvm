...
B:
  ...
  call void @llvm.lifetime.start.p0i8(i64 80, ptr nonnull %k)
  br label %D
...
declare !intel.dtrans.func.type !7 void @llvm.lifetime.start.p0i8(i64, ptr "intel_dtrans_func_index"="1" nocapture)

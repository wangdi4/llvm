...
; CHECK-OP-MOD: @_ZN3ArrIPiE3addERKS0_{{.*}}
define void @_ZN3ArrIPiE3addERKS0_(%struct.Arr* "intel_dtrans_func_index"="1" %this, i32**  "intel_dtrans_func_index"="2" nocapture readonly dereferenceable(8) %e) !intel.dtrans.func.type !9 {
entry:
...
; CHECK-OP-TRANS:      ; Arg: Load from arg
; CHECK-OP-TRANS-NEXT: %tmp = load ptr, ptr %e, align 8
; CHECK-MOD:        %copy = load float*, float** %0, align 8
; CHECK-MOD-NEXT:   %tmp = load i32*, i32** %e, align 8
; CHECK-OP-MOD:        %copy = load ptr, ptr %0, align 8
; CHECK-OP-MOD-NEXT:   %tmp = load ptr, ptr %e, align 8
...
; CHECK-OP-TRANS-NEXT: store ptr %tmp, ptr %arrayidx, align 8
; CHECK-MOD-NEXT:   store float* %copy, float** %elem, align 8
; CHECK-MOD-NEXT:   store i32* %tmp, i32** %elem1, align 8
; CHECK-OP-MOD-NEXT:   store ptr %copy, ptr %elem, align 8
; CHECK-OP-MOD-NEXT:   store ptr %tmp, ptr %elem1, align 8

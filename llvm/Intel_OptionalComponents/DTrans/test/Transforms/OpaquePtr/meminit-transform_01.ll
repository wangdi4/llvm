...
;
; CHECK-TRANS: define void @_ZN3ArrIPiEC2EiP3Mem(%struct.Arr* "intel_dtrans_func_index"="1" %this, i32 %c, %struct.Mem* "intel_dtrans_func_index"="2" %mem)
...
;CHECK-TRANS: ret void

;CHECK-TRANS: define void @_ZN1FC2Ev(%class.F* "intel_dtrans_func_index"="1" %this)
; CHECK-OP-TRANS: define void @_ZN3ArrIPiEC2EiP3Mem(ptr "intel_dtrans_func_index"="1" %this, i32 %c, ptr "intel_dtrans_func_index"="2" %mem)
...
;CHECK-OP-TRANS: ret void

;CHECK-OP-TRANS: define void @_ZN1FC2Ev(ptr "intel_dtrans_func_index"="1" %this)
; Non-constant capacity value that is passed to constructor of Arr1 vector
; in "F" function is not changed.
; CHECK-TRANS: tail call void @_ZN4Arr1IPfEC2EiP3Mem(%struct.Arr1* %2, i32 %cap1, %struct.Mem* null)
; CHECK-OP-TRANS: tail call void @_ZN4Arr1IPfEC2EiP3Mem(ptr %2, i32 %cap1, ptr null)
;
; capacity value that is passed to constructor of Arr1 vector in "F" function
; is trimmed down from 4 to 1.
;
; CHECK-TRANS: tail call void @_ZN4Arr1IPfEC2EiP3Mem(%struct.Arr1* nonnull %17, i32 1, %struct.Mem* null)
; CHECK-TRANS-NOT: tail call void @_ZN4Arr1IPfEC2EiP3Mem(%struct.Arr1* nonnull %17, i32 4, %struct.Mem* null)
; CHECK-OP-TRANS: tail call void @_ZN4Arr1IPfEC2EiP3Mem(ptr nonnull %17, i32 1, ptr null)
; CHECK-OP-TRANS-NOT: tail call void @_ZN4Arr1IPfEC2EiP3Mem(ptr nonnull %17, i32 4, ptr null)
...
!llvm.dbg.intel.emit_class_debug_always = !{!51}
!llvm.ident = !{!52}
...
!46 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus, file: !47, producer: "", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !56, nameTableKind: None)
...
!51 = !{!"true"}
!52 = !{!""}
!53 = distinct !DISubprogram(name: "na", linkageName: "na", scope: !47, file: !47, line: 1, type: !54, isLocal: false, isDefinition: true, scopeLine: 1, flags: DIFlagPrototyped, isOptimized: false, unit: !46, retainedNodes: !56)
; int(void*) type.
!54 = !DISubroutineType(types: !55)
!55 = !{!57, !58}
!57 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!58 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!59 = !DILocalVariable(name: "na", arg: 1, scope: !53, file: !47, line: 1, type: !58)
!60 = !DILocation(line: 1, column: 1, scope: !53)
!61 = !DILocation(line: 1, column: 1, scope: !53)
!62 = !DILocation(line: 1, column: 1, scope: !53)

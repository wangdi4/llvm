...
; RUN: opt < %s -S -passes=dtrans-meminittrimdownop -whole-program-assume -intel-libirc-allowed -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 2>&1 | FileCheck %s
...
entry:
  ...
  %vtable = load ptr, ptr %mem, align 8

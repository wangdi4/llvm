; REQUIRES: asserts
; RUN: opt -dtransop-allow-typed-pointers -S -whole-program-assume -dtrans-aostosoaop -dtrans-aostosoaop-index32=true -dtrans-aostosoaop-typelist=struct.test01 -dtrans-aostosoaop-qual-override=true %s 2>&1 | FileCheck %s --check-prefix=CHECK --check-prefix=CHECK-NONOPAQUE
; RUN: opt -dtransop-allow-typed-pointers -S -whole-program-assume -passes=dtrans-aostosoaop -dtrans-aostosoaop-index32=true -dtrans-aostosoaop-typelist=struct.test01 -dtrans-aostosoaop-qual-override=true %s 2>&1 | FileCheck %s --check-prefix=CHECK --check-prefix=CHECK-NONOPAQUE
; RUN: opt -opaque-pointers -S -whole-program-assume -dtrans-aostosoaop -dtrans-aostosoaop-index32=true -dtrans-aostosoaop-typelist=struct.test01 -dtrans-aostosoaop-qual-override=true %s 2>&1 | FileCheck %s --check-prefix=CHECK --check-prefix=CHECK-OPAQUE
; RUN: opt -opaque-pointers -S -whole-program-assume -passes=dtrans-aostosoaop -dtrans-aostosoaop-index32=true -dtrans-aostosoaop-typelist=struct.test01 -dtrans-aostosoaop-qual-override=true %s 2>&1 | FileCheck %s --check-prefix=CHECK --check-prefix=CHECK-OPAQUE

; Test AOS-to-SOA transformation of storing a pointer to the type being
; transformed by AOS-to-SOA.
;
; This case is the same as aostosoa-store01.ll, but is using 32-bit integers for
; the index type.
...
; CHECK-NONOPAQUE: %v0 = load i32, i32* %p0
...
; CHECK-NONOPAQUE: %v1 = load i32, i32* %p1
; CHECK-NONOPAQUE: call i32* @llvm.ptr.annotation.p0i32(i32* %p1, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__intel_dtrans_aostosoa_index, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @__intel_dtrans_aostosoa_filename, i32 0, i32 0), i32 0, i8* null)
; CHECK-NONOPAQUE: store i32 %v0, i32* %p1
; CHECK-NONOPAQUE: call i32* @llvm.ptr.annotation.p0i32(i32* %p0, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__intel_dtrans_aostosoa_index, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @__intel_dtrans_aostosoa_filename, i32 0, i32 0), i32 0, i8* null)
; CHECK-NONOPAQUE: store i32 %v1, i32* %p0
...
; CHECK-OPAQUE: %v0 = load i32, ptr %p0
...
; CHECK-OPAQUE: %v1 = load i32, ptr %p1
; CHECK-OPAQUE: call ptr @llvm.ptr.annotation.p0(ptr %p1, ptr @__intel_dtrans_aostosoa_index, ptr @__intel_dtrans_aostosoa_filename, i32 0, ptr null)
; CHECK-OPAQUE: store i32 %v0, ptr %p1
; CHECK-OPAQUE: call ptr @llvm.ptr.annotation.p0(ptr %p0, ptr @__intel_dtrans_aostosoa_index, ptr @__intel_dtrans_aostosoa_filename, i32 0, ptr null)
; CHECK-OPAQUE: store i32 %v1, ptr %p0
...
; CHECK-NONOPAQUE: %[[BASE1:[0-9]+]] = load i32*, i32** %[[ADDR1]]
; CHECK-NONOPAQUE-SAME: !invariant.load
; CHECK-NONOPAQUE: %[[ZEXT1:[0-9]+]] = zext i32 %v0 to i64
; CHECK-NONOPAQUE: %t0 = getelementptr i32, i32* %[[BASE1]], i64 %[[ZEXT1]]
; CHECK-NONOPAQUE: call i32* @llvm.ptr.annotation.p0i32(i32* %t0, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__intel_dtrans_aostosoa_index, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @__intel_dtrans_aostosoa_filename, i32 0, i32 0), i32 0, i8* null)
; CHECK-NONOPAQUE: store i32 %v0, i32* %t0
; CHECK-NONOPAQUE: ret i32 0
...
; CHECK-OPAQUE: %[[ZEXT1:[0-9]+]] = zext i32 %v0 to i64
; CHECK-OPAQUE: %t0 = getelementptr i32, ptr %[[BASE1]], i64 %[[ZEXT1]]
...
; CHECK-OPAQUE: store i32 %v0, ptr %t0
; CHECK-OPAQUE: ret i32 0

; RUN: opt -opaque-pointers -S -passes=dtransop-optbasetest -dtransop-optbasetest-typelist=struct.test01 < %s 2>&1 | FileCheck %s
...
; CHECK-LABEL: define internal void @test01.1

; RUN: opt -dtransop-allow-typed-pointers -S -dtransop-optbasetest -dtransop-optbasetest-typelist=struct.test01 < %s 2>&1 | FileCheck %s --check-prefix=CHECK-NONOPAQUE

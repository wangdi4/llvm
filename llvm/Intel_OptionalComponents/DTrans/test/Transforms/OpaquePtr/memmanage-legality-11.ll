...
; a global variable is declared as one of the types related to
; the candidate type.
;
...
; CHECK:   Global variable uses candidate related type: @foo
...
@foo = internal global %ArenaBlockBase zeroinitializer

...
define void @test01() {
  %call = call ptr @malloc(i64 64)
  %field = getelementptr %struct.type01, ptr %call, i64 0, i32 0
...
define void @test02() {
  %call = call ptr @malloc(i64 64)
  %field = getelementptr %struct.noclonetype01, ptr %call, i64 0, i32 0
  call void @free(ptr %call)
  ret void
}
...
define void @test04() {
  %local1 = alloca ptr, !intel_dtrans_type !5
...
define "intel_dtrans_func_index"="1" ptr @test05() !intel.dtrans.func.type !6 {
  %call = tail call ptr @malloc(i64 64)
  ret ptr %call
}
...
define void @test06(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !7 {
...
; CHECK:   Region 0:
; CHECK:     Complete: true
; CHECK:     Type: %struct.type01dep = type { %struct.type01*, %struct.type01* }
; CHECK:   Region 1:
; CHECK:     Complete: true
; CHECK:     Type: %struct.type01dep = type { %struct.type01*, %struct.type01* }

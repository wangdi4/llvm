; REQUIRES: asserts
; RUN: opt -opaque-pointers < %s -dva-check-dtrans-outofboundsok -dtrans-outofboundsok=true -disable-output -dtrans-transpose -dtrans-transpose-print-candidates 2>&1 | FileCheck %s
...
bb:
  ...
  store i64 200, ptr getelementptr inbounds (%"QNCA_a0$%\22MAIN$.btPHYSPROP_TYPE\22*$rank1$", ptr @"main_$PHYSPROP", i64 0, i32 1), align 8
  ...
  %i4 = tail call i32 @for_allocate_handle(i64 20000, ptr @"main_$PHYSPROP", i32 262144, ptr null) #4
  br label %bb5
...
bb5:                                              ; preds = %bb5, %bb
  ...
  %i10 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %i9, i64 %i8, ptr elementtype(%"MAIN$.btPHYSPROP_TYPE") %i7, i64 %i6)
  ...
  %i35 = getelementptr inbounds %"MAIN$.btPHYSPROP_TYPE", ptr %i10, i64 0, i32 2
...
bb65:                                             ; preds = %bb65, %bb62
  ...
  %i70 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %i69, i64 %i68, ptr elementtype(%"MAIN$.btPHYSPROP_TYPE") %i67, i64 %i61)
  %t71 = getelementptr inbounds %"MAIN$.btPHYSPROP_TYPE", ptr %i70, i64 0, i32 1
  %t72 = load i32, ptr %t71, align 4
  %t73 = add nsw i32 %t72, 2
  store i32 %t73, ptr %t71, align 4
  %i71 = getelementptr inbounds %"MAIN$.btPHYSPROP_TYPE", ptr %i70, i64 0, i32 2

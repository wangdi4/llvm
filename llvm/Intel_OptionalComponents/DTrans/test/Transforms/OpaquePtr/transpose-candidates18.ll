...
; transpose candidate even though field 1 is of type real and is
; passed down the call chain to an external C routine which treats it as a
; pointer to a character array, as long as -dtrans-outofboundsok=false.

...
; This is similar to transpose-candidates20.ll, but has the bitcast removed that feeds the call to @for_allocate_handle.
...
bb6:                                              ; preds = %bb6, %bb
  ...
  %i44 = call i32 @for_allocate_handle(i64 400, ptr nonnull %i22, i32 262144, ptr %i42) #6

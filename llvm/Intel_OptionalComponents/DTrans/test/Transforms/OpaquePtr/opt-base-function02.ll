...
; CHECK-OPAQUE: %local_ptr1a = alloca p0, align 8, !intel_dtrans_type ![[PTR_S01A:[0-9]+]]
; CHECK-OPAQUE: %local_ptrptr1a = alloca p0, align 8, !intel_dtrans_type ![[PTRPTR_S01A:[0-9]+]]
; CHECK-OPAQUE: %local_array_ptr1a = alloca [4 x p0], align 8, !intel_dtrans_type ![[ARRAY_4xPTRPTRPTR_S01A:[0-9]+]]

...
; REQUIRES: asserts
;  RUN: opt < %s -dtrans-dynclone-shrunken-type-width=16 -disable-output -dtrans-simple-dynclone-enable=false -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -whole-program-assume -intel-libirc-allowed -passes=dtrans-dyncloneop -debug-only=dtrans-dynclone-reencoding 2>&1 | FileCheck %s

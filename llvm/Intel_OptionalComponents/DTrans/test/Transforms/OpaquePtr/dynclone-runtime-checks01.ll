...
; CHECK-NEXT:  store i64 0, ptr [[ALLOC_MAX]]
; CHECK-NEXT:  [[ALLOC_MIN:%d.min[0-9]*]] = alloca i64
; CHECK-NEXT:  store i64 65535, ptr [[ALLOC_MIN]]

; CHECK: store i8 1, ptr [[ALLOC_SAFE]]
...
; CHECK:  [[MIN_LD_1:%d.ld[0-9]*]] = load i64, ptr [[ALLOC_MIN]]
...
; CHECK-NEXT:  store i64 [[MIN_SEL_1]], ptr [[ALLOC_MIN]]
;
; CHECK-NEXT:  [[MAX_LD_1:%d.ld[0-9]*]] = load i64, ptr [[ALLOC_MAX]]
...
; CHECK-NEXT:  store i64 [[MAX_SEL_1]], ptr [[ALLOC_MAX]]
...
; CHECK-NEXT:  [[MIN_LD_2:%d.ld[0-9]*]] = load i64, ptr [[ALLOC_MIN]]
...
; CHECK-NEXT:  store i64 [[MIN_SEL_2]], ptr [[ALLOC_MIN]]
;
; CHECK-NEXT:  [[MAX_LD_2:%d.ld[0-9]*]] = load i64, ptr [[ALLOC_MAX]]
...
; CHECK-NEXT:  store i64 [[MAX_SEL_2]], ptr [[ALLOC_MAX]]
...
;
; CHECK-LABEL: store i64 %g2, ptr %F6, align 8
; CHECK:  [[MIN_LD_3:%d.ld[0-9]*]] = load i64, ptr [[ALLOC_MIN]]
; CHECK-NEXT:  [[MIN_CMP_3:%d.cmp[0-9]*]] = icmp slt i64 [[MIN_LD_3]], 0
; CHECK-NEXT:  [[MAX_LD_3:%d.ld[0-9]*]] = load i64, ptr [[ALLOC_MAX]]
; CHECK-NEXT:  [[MAX_CMP_3:%d.cmp[0-9]*]] = icmp sgt i64 [[MAX_LD_3]], 65535
; CHECK-NEXT:  [[OR_1:%d.or[0-9]*]] = or i1 [[MIN_CMP_3]], [[MAX_CMP_3]]
; CHECK-NEXT:  [[MAX_LD_4:%d.ld[0-9]*]] = load i8, ptr [[ALLOC_SAFE]]

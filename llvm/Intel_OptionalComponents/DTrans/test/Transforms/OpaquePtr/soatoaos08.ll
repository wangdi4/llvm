...
define zeroext i1 @"check1(F*)"(%class.F* nocapture readonly "intel_dtrans_func_index"="1" %f) #0 !dbg !24 !intel.dtrans.func.type !719 {
entry:
...
; Function Attrs: nounwind readonly
define i32 @"F::get1(int)"(%class.F* nocapture readonly "intel_dtrans_func_index"="1" %this, i32 %i) #0 align 2 !dbg !153 !intel.dtrans.func.type !721 {
entry:
...
; Function Attrs: nounwind readonly
define float @"F::get2(int)"(%class.F* nocapture readonly "intel_dtrans_func_index"="1" %this, i32 %i) #0 align 2 !dbg !162 !intel.dtrans.func.type !722 {
entry:
...
declare !intel.dtrans.func.type !723 dso_local nonnull "intel_dtrans_func_index"="1" i8* @_Znwm(i64)

define void @"F::F()"(%class.F* nocapture "intel_dtrans_func_index"="1" %this) align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !235 !intel.dtrans.func.type !725 {
entry:
...
declare !intel.dtrans.func.type !726 void @_ZdlPv(i8* "intel_dtrans_func_index"="1")

define void @"F::put(int*, float*)"(%class.F* nocapture readonly "intel_dtrans_func_index"="1" %this, i32* "intel_dtrans_func_index"="2" %a, float* "intel_dtrans_func_index"="3" %b) align 2 !dbg !249 !intel.dtrans.func.type !727 {
entry:
  %a.addr = alloca i32*, align 8, !intel_dtrans_type !728
  %b.addr = alloca float*, align 8, !intel_dtrans_type !729
...
define void @"F::set1(int, int*)"(%class.F* nocapture readonly "intel_dtrans_func_index"="1" %this, i32 %i, i32* "intel_dtrans_func_index"="2" %a) #2 align 2 !dbg !261 !intel.dtrans.func.type !730 {
entry:
...
; Function Attrs: nounwind
define void @"F::set2(int, float*)"(%class.F* nocapture readonly "intel_dtrans_func_index"="1" %this, i32 %i, float* "intel_dtrans_func_index"="2" %b) #2 align 2 !dbg !271 !intel.dtrans.func.type !731 {
entry:
...
define void @"F::F(F const&)"(%class.F* nocapture "intel_dtrans_func_index"="1" %this, %class.F* nocapture readonly dereferenceable(16) "intel_dtrans_func_index"="2" %f) align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !281 !intel.dtrans.func.type !732 {
entry:
...
define void @"F::~F()"(%class.F* nocapture readonly "intel_dtrans_func_index"="1" %this) align 2 !dbg !299 !intel.dtrans.func.type !733 {
entry:
...
; Function Attrs: nounwind readonly
define dereferenceable(8) "intel_dtrans_func_index"="1" i32** @"Arr<int*>::get(int)"(%struct.Arr* nocapture readonly "intel_dtrans_func_index"="2" %this, i32 %i) #0 align 2 !dbg !308 !intel.dtrans.func.type !734 {
entry:
...
; Function Attrs: nounwind readonly
define dereferenceable(8) "intel_dtrans_func_index"="1" float** @"Arr<float*>::get(int)"(%struct.Arr.0* nocapture readonly "intel_dtrans_func_index"="2" %this, i32 %i) #0 align 2 !dbg !323 !intel.dtrans.func.type !735 {
entry:
...
define void @"Arr<int*>::Arr(int, struct.Mem*)"(%struct.Arr* nocapture "intel_dtrans_func_index"="1" %this, i32 %c, %struct.Mem* "intel_dtrans_func_index"="2" %m) align 2 !dbg !338 !intel.dtrans.func.type !736 {
entry:
...
define void @"Arr<float*>::Arr(int, struct.Mem*)"(%struct.Arr.0* nocapture "intel_dtrans_func_index"="1" %this, i32 %c, %struct.Mem* "intel_dtrans_func_index"="2" %m) align 2 !dbg !354 !intel.dtrans.func.type !737 {
entry:
...
declare !intel.dtrans.func.type !738 "intel_dtrans_func_index"="1" i8* @malloc(i64) #3
declare void @__cxa_rethrow()

define void @"Arr<int*>::add(int* const&)"(%struct.Arr* nocapture "intel_dtrans_func_index"="1" %this, i32** nocapture readonly dereferenceable(8) "intel_dtrans_func_index"="2" %e) align 2 !dbg !370 !intel.dtrans.func.type !739 {
entry:
...
define void @"Arr<float*>::add(float* const&)"(%struct.Arr.0* nocapture "intel_dtrans_func_index"="1" %this, float** nocapture readonly dereferenceable(8) "intel_dtrans_func_index"="2" %e) align 2 !dbg !392 !intel.dtrans.func.type !740 {
entry:
...
define void @"Arr<int*>::realloc(int)"(%struct.Arr* nocapture "intel_dtrans_func_index"="1" %this, i32 %inc) align 2 !dbg !414 !intel.dtrans.func.type !741 {
entry:
...
define void @"Arr<float*>::realloc(int)"(%struct.Arr.0* nocapture "intel_dtrans_func_index"="1" %this, i32 %inc) align 2 !dbg !462 !intel.dtrans.func.type !745 {
entry:
...
; Function Attrs: nounwind
define void @"Arr<int*>::set(int, int*)"(%struct.Arr* nocapture readonly "intel_dtrans_func_index"="1" %this, i32 %i, i32* "intel_dtrans_func_index"="2" %val) #2 align 2 !dbg !510 !intel.dtrans.func.type !747 {
entry:
...
; Function Attrs: nounwind
define void @"Arr<float*>::set(int, float*)"(%struct.Arr.0* nocapture readonly "intel_dtrans_func_index"="1" %this, i32 %i, float* "intel_dtrans_func_index"="2" %val) #2 align 2 !dbg !527 !intel.dtrans.func.type !748 {
entry:
...
define void @"Arr<int*>::Arr(Arr<int*> const&)"(%struct.Arr* nocapture "intel_dtrans_func_index"="1" %this, %struct.Arr* nocapture readonly dereferenceable(32) "intel_dtrans_func_index"="2" %A) align 2 !dbg !544 !intel.dtrans.func.type !749 {
entry:
...
define void @"Arr<float*>::Arr(Arr<float*> const&)"(%struct.Arr.0* nocapture "intel_dtrans_func_index"="1" %this, %struct.Arr.0* nocapture readonly dereferenceable(32) "intel_dtrans_func_index"="2" %A) align 2 !dbg !603 !intel.dtrans.func.type !751 {
entry:
...
define void @"Arr<int*>::~Arr()"(%struct.Arr* nocapture readonly "intel_dtrans_func_index"="1" %this) align 2 !dbg !662 !intel.dtrans.func.type !753 {
entry:
...
define void @"Arr<float*>::~Arr()"(%struct.Arr.0* nocapture readonly "intel_dtrans_func_index"="1" %this) align 2 !dbg !669 !intel.dtrans.func.type !754 {
entry:
...
!intel.dtrans.types = !{!703, !707, !713, !716}
...
!703 = !{!"S", %class.F zeroinitializer, i32 3, !704, !705, !706}
!704 = !{%struct.Arr zeroinitializer, i32 1}
!705 = !{%struct.Arr.0 zeroinitializer, i32 1}
!706 = !{%struct.Mem zeroinitializer, i32 1}
!707 = !{!"S", %struct.Arr zeroinitializer, i32 5, !708, !711, !708, !706, !710}
!708 = !{i32 0, i32 0}
!709 = !{!"A", i32 4, !710}
!710 = !{i8 0, i32 0}
!711 = !{i32 0, i32 2}
!712 = !{!"A", i32 7, !710}
!713 = !{!"S", %struct.Mem zeroinitializer, i32 1, !714}
!714 = !{!715, i32 2}
!715 = !{!"F", i1 true, i32 0, !708}
!716 = !{!"S", %struct.Arr.0 zeroinitializer, i32 5, !708, !717, !708, !706, !710}
!717 = !{float 0.000000e+00, i32 2}
!718 = !{!"Intel(R) oneAPI DPC++/C++ Compiler 2022.1.0 (2022.x.0.YYYYMMDD)"}
!719 = distinct !{!720}
!720 = !{%class.F zeroinitializer, i32 1}
!721 = distinct !{!720}
!722 = distinct !{!720}
!723 = distinct !{!724}
!724 = !{i8 0, i32 1}
!725 = distinct !{!720}
!726 = distinct !{!724}
!727 = distinct !{!720, !728, !729}
!728 = !{i32 0, i32 1}
!729 = !{float 0.000000e+00, i32 1}
!730 = distinct !{!720, !728}
!731 = distinct !{!720, !729}
!732 = distinct !{!720, !720}
!733 = distinct !{!720}
!734 = distinct !{!711, !704}
!735 = distinct !{!717, !705}
!736 = distinct !{!704, !706}
!737 = distinct !{!705, !706}
!738 = distinct !{!724}
!739 = distinct !{!704, !711}
!740 = distinct !{!705, !717}
!741 = distinct !{!704}
!742 = distinct !{!742, !743}
!743 = !{!"llvm.loop.mustprogress"}
!744 = distinct !{!724}
!745 = distinct !{!705}
!746 = distinct !{!746, !743}
!747 = distinct !{!704, !728}
!748 = distinct !{!705, !729}
!749 = distinct !{!704, !704}
!750 = distinct !{!750, !743}
!751 = distinct !{!705, !705}
!752 = distinct !{!752, !743}
!753 = distinct !{!704}
!754 = distinct !{!705}

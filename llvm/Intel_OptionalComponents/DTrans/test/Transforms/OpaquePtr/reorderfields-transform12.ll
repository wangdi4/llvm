; This test verifies that the field reorder transformation supports a limited form
; of byte-flattened GEPs on a structure that contains nested instances of the
; structure being reordered.

;  RUN: opt < %s -whole-program-assume -intel-libirc-allowed -S -passes=dtrans-reorderfieldsop -dtrans-reorderfieldop-enable-applicable-test=0 -dtrans-reorderfieldop-enable-legal-test=0 | FileCheck %s

; CHECK: %__DFR_struct.S = type { %struct.S0, i32, i64, i64, i16, i16, i32, i64, i64, ptr, ptr, ptr, i32, i32, %struct.S0, %struct.S0, %struct.S0, %struct.S0, i32, i16 }
...
define i64 @workST(ptr "intel_dtrans_func_index"="1" nocapture %s, ptr "intel_dtrans_func_index"="2" nocapture %t, i32 %UB1, i32 %UB2) !intel.dtrans.func.type !29 {
entry:
...
for.body.lr.ph:                                   ; preds = %entry
  %f3 = getelementptr inbounds %struct.S, ptr %s, i64 0, i32 3, !intel-tbaa !16
...
for.cond.cleanup:                                 ; preds = %for.cond.for.cond.cleanup_crit_edge, %entry
  ...
  ;
  %addr0= getelementptr i8, ptr %s, i64 8
  %val0 = bitcast ptr %addr0 to ptr
  store i32 %div, ptr %val0, align 8, !tbaa !17

;CHECK:  %addr0 = getelementptr i8, ptr %s, i64 16

  ;[NEW CODE SEQUENCE]
  ;[Do a byte-flatten GEP inside a Inclusive-StructType DFR struct, in DFR range]
  ;
  %addr1= getelementptr i8, ptr %t, i64 8
  %val1 = bitcast ptr %addr1 to ptr
  store i32 %div, ptr %val1, align 8, !tbaa !17

;CHECK:  %addr1 = getelementptr i8, ptr %t, i64 16

  ;[NEW CODE SEQUENCE]
  ;[Do a byte-flatten GEP inside a Inclusive-StructType DFR struct, out of DFR range]
  ;
  %addr2= getelementptr i8, ptr %t, i64 112
  %val2 = bitcast ptr %addr1 to ptr
  store i32 %div, ptr %val2, align 8, !tbaa !17

;CHECK:  %addr2 = getelementptr i8, ptr %t, i64 104

  %call = tail call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([10 x i8], ptr @.str, i64 0, i64 0), i32 %div)
  %6 = load i32, ptr %f1, align 4, !tbaa !2
  %f325 = getelementptr inbounds %struct.S, ptr %s, i64 0, i32 3, !intel-tbaa !16
  %7 = load i32, ptr %f325, align 8, !tbaa !16
  %add26 = add i32 %7, %6
  %8 = load i16, ptr %f4, align 4, !tbaa !13
  %conv28 = zext i16 %8 to i32
  %add29 = add i32 %add26, %conv28
  %9 = load i32, ptr %f7, align 8, !tbaa !14
  %add31 = add i32 %add29, %9
  %conv32 = zext i32 %add31 to i64
  %10 = load i64, ptr %f11, align 8, !tbaa !15
...
declare !intel.dtrans.func.type !30 i32 @printf(ptr "intel_dtrans_func_index"="1" nocapture readonly, ...)

; Function Attrs: nounwind uwtable
define i32 @main(i32 %argc, ptr "intel_dtrans_func_index"="1" nocapture readnone %argv) !intel.dtrans.func.type !32 {
entry:
  %call = tail call noalias ptr @malloc(i64 112) #3
  %call1 = tail call noalias ptr @malloc(i64 120) #3
  %add = add nsw i32 %argc, 100
  %call2 = tail call i64 @workST(ptr %call, ptr %call1, i32 %argc, i32 %add)
  %call3 = tail call i32 (ptr, ...) @printf(ptr getelementptr inbounds ([10 x i8], ptr @.str.1, i64 0, i64 0), i64 %call2)
  tail call void @free(ptr %call) #3
  tail call void @free(ptr %call1) #3
  ret i32 0
}

declare !intel.dtrans.func.type !33 "intel_dtrans_func_index"="1" ptr @malloc(i64)
declare !intel.dtrans.func.type !34 void @free(ptr "intel_dtrans_func_index"="1" nocapture)
...
!19 = !{%struct.S0 zeroinitializer, i32 0}  ; %struct.S0
!20 = !{i32 0, i32 0}  ; i32
!21 = !{i64 0, i32 0}  ; i64
!22 = !{i16 0, i32 0}  ; i16
!23 = !{i8 0, i32 1}  ; i8*
!24 = !{i32 0, i32 1}  ; i32*
!25 = !{i16 0, i32 1}  ; i16*
!26 = !{%struct.S zeroinitializer, i32 0}  ; %struct.S
!27 = !{%struct.S zeroinitializer, i32 1}  ; %struct.S*
!28 = !{%struct.T zeroinitializer, i32 1}  ; %struct.T*
!29 = distinct !{!27, !28}
!30 = distinct !{!23}
!31 = !{i8 0, i32 2}  ; i8**
!32 = distinct !{!31}
!33 = distinct !{!23}
!34 = distinct !{!23}
!35 = !{!"S", %struct.S zeroinitializer, i32 20, !19, !20, !21, !20, !22, !20, !22, !20, !20, !21, !21, !21, !22, !19, !19, !19, !19, !23, !24, !25} ; { %struct.S0, i32, i64, i32, i16, i32, i16, i32, i32, i64, i64, i64, i16, %struct.S0, %struct.S0, %struct.S0, %struct.S0, i8*, i32*, i16* }
!36 = !{!"S", %struct.S0 zeroinitializer, i32 1, !20} ; { i32 }
!37 = !{!"S", %struct.T zeroinitializer, i32 2, !26, !20} ; { %struct.S, i32 }

!intel.dtrans.types = !{!35, !36, !37}

...
; the "Node" type is referenced by a structure that is not one
; of the types related to the candidate. The type
; "XalanListIteratorBase" contains a pointer that can be used
; as the "Node" type based on the DTrans metadata.
;
...
; CHECK:   Unknown use by non-candidate type: %XalanListIteratorBase = type { %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* }
...
!1 = !{%"XalanList<ReusableArenaBlock<XStringCached> *>::Node" zeroinitializer, i32 1}  ; %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"*
!2 = !{%"ReusableArenaAllocator" zeroinitializer, i32 0}  ; %"ReusableArenaAllocator"
!3 = !{%"ArenaAllocator" zeroinitializer, i32 0}  ; %"ArenaAllocator"
!4 = !{i8 0, i32 0}  ; i8
!5 = !{!"A", i32 7, !4}  ; [7 x i8]
!6 = !{!"F", i1 true, i32 0, !7}  ; i32 (...)
!7 = !{i32 0, i32 0}  ; i32
!8 = !{!6, i32 2}  ; i32 (...)**
!9 = !{i16 0, i32 0}  ; i16
!10 = !{%"XalanList" zeroinitializer, i32 0}  ; %"XalanList"
!11 = !{%"MemoryManager" zeroinitializer, i32 1}  ; %"MemoryManager"*
...
!53 = distinct !{!47}
!55 = distinct !{!37}
!56 = distinct !{!16, !50, !11}
!57 = distinct !{!16}
!58 = distinct !{!37}
!59 = !{!"S", %"XalanListIteratorBase" zeroinitializer, i32 1, !1} ; { %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* }
!60 = !{!"S", %"XStringCachedAllocator" zeroinitializer, i32 1, !2} ; { %"ReusableArenaAllocator" }
!61 = !{!"S", %"ReusableArenaAllocator" zeroinitializer, i32 3, !3, !4, !5} ; <{ %"ArenaAllocator", i8, [7 x i8] }>
!62 = !{!"S", %"ArenaAllocator" zeroinitializer, i32 3, !8, !9, !10} ; { i32 (...)**, i16, %"XalanList" }
!63 = !{!"S", %"XalanList" zeroinitializer, i32 3, !11, !1, !1} ; { %"MemoryManager"*, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"*, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* }
!64 = !{!"S", %"XalanList<ReusableArenaBlock<XStringCached> *>::Node" zeroinitializer, i32 3, !12, !1, !1} ; { %"ReusableArenaBlock"*, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"*, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* }
!65 = !{!"S", %"ReusableArenaBlock" zeroinitializer, i32 4, !13, !9, !9, !14} ; <{ %"ArenaBlockBase", i16, i16, [4 x i8] }>
!66 = !{!"S", %"ArenaBlockBase" zeroinitializer, i32 4, !15, !9, !9, !16} ; { %"XalanAllocator", i16, i16, %"XStringCached"* }
!67 = !{!"S", %"XalanAllocator" zeroinitializer, i32 1, !11} ; { %"MemoryManager"* }
...
!70 = !{!"S", %"XObject" zeroinitializer, i32 3, !22, !7, !23} ; { %"XalanReferenceCountedObject.base", i32, %"XObjectFactory"* }
!71 = !{!"S", %"XalanReferenceCountedObject.base" zeroinitializer, i32 2, !8, !7} ; <{ i32 (...)**, i32 }>
...
!76 = !{!"S", %"XalanNode" zeroinitializer, i32 1, !8} ; { i32 (...)** }
!77 = !{!"S", %"XObjectResultTreeFragProxyText" zeroinitializer, i32 3, !28, !29, !11} ; { %"XalanText", %"XObject"*, %"MemoryManager"* }
...
!82 = !{!"S", %"ExecutionContext" zeroinitializer, i32 2, !8, !11} ; { i32 (...)**, %"MemoryManager"* }
!83 = !{!"S", %"XalanDOMString" zeroinitializer, i32 3, !34, !7, !14} ; <{ %"XalanVector", i32, [4 x i8] }>
!84 = !{!"S", %"XalanVector" zeroinitializer, i32 4, !11, !35, !35, !36} ; { %"MemoryManager"*, i64, i64, i16* }
!85 = !{!"S", %"MemoryManager" zeroinitializer, i32 1, !8} ; { i32 (...)** }
!86 = !{!"S", %"DeleteFunctor" zeroinitializer, i32 1, !11} ; { %"MemoryManager"* }
!87 = !{!"S", %"XalanAllocationGuard" zeroinitializer, i32 2, !11, !37} ; { %"MemoryManager"*, i8* }
!88 = !{!"S", %"ReusableArenaBlock<XStringCached>::NextBlock" zeroinitializer, i32 2, !9, !7} ; { i16, i32 }
!89 = !{!"S", %"struct.std::less" zeroinitializer, i32 1, !4} ; { i8 }
!90 = !{!"S", %"XalanDestroyFunctor" zeroinitializer, i32 1, !4} ; { i8 }

!intel.dtrans.types = !{!59, !60, !61, !62, !63, !64, !65, !66, !67, !68, !69, !70, !71, !72, !73, !74, !75, !76, !77, !78, !79, !80, !81, !82, !83, !84, !85, !86, !87, !88, !89, !90}

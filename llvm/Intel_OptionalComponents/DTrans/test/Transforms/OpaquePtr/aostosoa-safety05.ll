...
; structure that has an allocation in a loop.
;
; %struct.test01 is not supported because it is allocated within a loop.
...
; CHECK-DAG: AOS-to-SOA rejecting -- Allocation in loop: %struct.test01

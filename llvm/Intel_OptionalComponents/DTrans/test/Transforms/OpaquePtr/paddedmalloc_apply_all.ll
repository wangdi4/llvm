...
; RUN: opt -whole-program-assume -intel-libirc-allowed < %s -passes='require<dtrans-safetyanalyzer>,padded-pointer-prop-op,dtrans-paddedmallocop' -dtrans-test-paddedmalloc -debug-only=dtrans-paddedmalloc -disable-output 2>&1 | FileCheck %s

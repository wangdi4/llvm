...
; RUN: opt -opaque-pointers -whole-program-assume < %s -dtrans-safetyanalyzer -padded-pointer-prop-op -dtrans-paddedmallocop -dtrans-test-paddedmalloc -debug-only=dtrans-paddedmalloc -disable-output 2>&1 | FileCheck %s

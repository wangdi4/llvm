...
; CHECK:  [[SUB1:%[0-9]*]] = sub i32 %spec.select, %i
; CHECK:  [[SHL1:%[0-9]*]] = shl i32 [[SUB1]], 3
; CHECK:   call void @llvm.memset.p0.i32(ptr align 4 %scevgep, i8 0, i32 [[SHL1]], i1 false)
...
for.cond16.preheader:                             ; preds = %for.body, %if.end
  %cmp1741 = icmp ult i32 %i, %spec.select
...
for.body18.preheader:                             ; preds = %for.cond16.preheader
  ...
  %i5 = shl i32 %spec.select, 3
  %i6 = sub i32 %i5, %i4
  call void @llvm.memset.p0.i32(ptr align 4 %scevgep, i8 0, i32 %i6, i1 false)
  br label %for.end22

for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %index.044 = phi i32 [ 0, %for.body.lr.ph ], [ %inc15, %for.body ]
  %arrayidx = getelementptr inbounds ptr, ptr %i3, i32 %index.044
  %i8 = load i64, ptr %arrayidx, align 8
  %arrayidx14 = getelementptr inbounds ptr, ptr %call, i32 %index.044
  store i64 %i8, ptr %arrayidx14, align 8
  %inc15 = add nuw i32 %index.044, 1
  %exitcond = icmp eq i32 %inc15, %i
  br i1 %exitcond, label %for.cond16.preheader, label %for.body

for.end22:                                        ; preds = %for.body18.preheader, %for.cond16.preheader
  %base23 = getelementptr inbounds %struct.BaseArr, ptr %this, i64 0, i32 4
  %i11 = load ptr, ptr %base23, align 8
  call void @free(ptr %i11)
  store ptr %call, ptr %base23, align 8
  store i32 %spec.select, ptr %capacity, align 4
  br label %cleanup

cleanup:                                          ; preds = %for.end22, %entry
  ret void
}

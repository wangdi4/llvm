...
; Make sure peephole "transform 2" is done by converting
; from "shl, shl, sub" to "sub, shl".
; CHECK-OP:  [[SUB1:%[0-9]*]] = sub i32 %spec.select, %0
; CHECK-OP:  [[SHL1:%[0-9]*]] = shl i32 [[SUB1]], 3
; CHECK-OP:   call void @llvm.memset.p0.i32(ptr align 4 %scevgep, i8 0, i32 [[SHL1]], i1 false)

...
define internal void @test00(ptr "intel_dtrans_func_index"="1" %p) !intel.dtrans.func.type !5 {
  ...
  ; Loading pointer as a pointer-sized integer type
  %val3 = load i64, ptr %p
  ret void
}
...
; CHECK: %dtnorm1 = getelementptr %struct.test00outer, ptr %p, i64 0, i32 0, i32 0
; CHECK: %val3 = load i64, ptr %dtnorm1
...
; CHECK: %val2 = load ptr, ptr %dtnorm
; CHECK: %dtnorm1 = getelementptr %struct.test01outer, ptr %p, i64 0, i32 0, i32 0, i32 0
; CHECK: %val3 = load i64, ptr %dtnorm1
...
; CHECK: %val2 = load i64, ptr %dtnorm

...
; "NonStringObjMemberFunction" like below which has DTrans type info
; that indicates the original function type as:
;   void @foo(i8* null, %"ReusableArenaAllocator"* null)
;
...
define internal void @foo(ptr "intel_dtrans_func_index"="1" %a1, ptr "intel_dtrans_func_index"="2") !intel.dtrans.func.type !54 {
  ret void
}
...
define internal void @NonStringObjMemberFunction() align 2 {
  tail call void @foo(ptr null, ptr null)
  ret void
}

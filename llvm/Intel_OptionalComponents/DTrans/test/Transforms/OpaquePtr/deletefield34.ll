...
; CHECK: getelementptr inbounds %__DFDT_struct.A, ptr %a, i64 0, i32 0
; CHECK: getelementptr inbounds %__DFDT_struct.A, ptr %a, i64 0, i32 2
...
; CHECK: getelementptr inbounds %__DFT_struct.B, ptr %b, i64 0, i32 0

declare !intel.dtrans.func.type !10 void @llvm.memset.p0.i64(ptr "intel_dtrans_func_index"="1", i8, i64, i1)

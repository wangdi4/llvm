...
define i32 @test01() {
  ...
  %res = call %struct.test01* @test02()
  store  %struct.test01* %res, %struct.test01** %p1
  ret i32 0
}
...
; CHECK-NONOPAQUE: %res = call i64 @test02.1()
...
; CHECK-NONOPAQUE: store i64 %res, i64* %p1, align 8
; CHECK-NONOPAQUE: ret i32 0

; CHECK-OPAQUE: %p1 = getelementptr %__SOADT_struct.test01dep, ptr @var01, i64 0, i32 1
; CHECK-OPAQUE: %res = call i64 @test02.1()
; CHECK-OPAQUE: store i64 %res, ptr %p1, align 8
; CHECK-OPAQUE: ret i32 0

define "intel_dtrans_func_index"="1" %struct.test01* @test02()  !intel.dtrans.func.type !3 {
  %p1 = getelementptr %struct.test01dep, %struct.test01dep* @var01, i64 0, i32 1
  %v1 = load %struct.test01*, %struct.test01** %p1
  ret %struct.test01* %v1
}
; The function should be cloned because of the return type is changing
; CHECK-LABEL: define i64 @test02.1()
; CHECK-NONOPAQUE: %p1 = getelementptr %__SOADT_struct.test01dep, %__SOADT_struct.test01dep* @var01, i64 0, i32 1
; CHECK-NONOPAQUE: %alloc_idx = call i64* @llvm.ptr.annotation.p0i64(i64* %p1, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__intel_dtrans_aostosoa_index, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @__intel_dtrans_aostosoa_filename, i32 0, i32 0), i32 0, i8* null)

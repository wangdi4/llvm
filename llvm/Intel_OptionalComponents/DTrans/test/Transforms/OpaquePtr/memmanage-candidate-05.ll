...
; RUN: opt < %s -S -passes='module(dtrans-force-inline-op),cgscc(inline)' -dtrans-inline-heuristics -intel-libirc-allowed -inline-for-xmain -pre-lto-inline-cost 2>&1 | FileCheck %s

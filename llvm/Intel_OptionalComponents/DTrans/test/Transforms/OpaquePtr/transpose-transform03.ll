...
define void @test01() {
bb:
  %"var$01" = alloca %"QNCA_a0$i32*$rank3$", align 8
  %"var$01_$field0$" = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %"var$01", i64 0, i32 0
  %"var$01_$field1$" = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %"var$01", i64 0, i32 1
  %"var$01_$field2$" = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %"var$01", i64 0, i32 2
  %"var$01_$field3$" = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %"var$01", i64 0, i32 3
  %"var$01_$field4$" = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %"var$01", i64 0, i32 4
  %"var$01_$field6$" = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %"var$01", i64 0, i32 6, i64 0
...
entry:
  ...
  %"var$01_$field6$" = getelementptr inbounds %"QNCA_a0$i32*$rank3$", ptr %MYBLOCK, i64 0, i32 6, i64 0
  %"var$01_$field6$_$field1$" = getelementptr inbounds { i64, i64, i64 }, ptr %"var$01_$field6$", i64 0, i32 1

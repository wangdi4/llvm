...
; an @llvm.assume that the alignment is met. This is the same as
...
!12 = distinct !{!11}
!13 = !{!"S", %__SOADT_class.F zeroinitializer, i32 2, !1, !2} ; { %__SOADT_AR_struct.Arr*, i64 }
!14 = !{!"S", %__SOADT_AR_struct.Arr zeroinitializer, i32 5, !3, !4, !6, !3, !4} ; { i32, [4 x i8], %__SOADT_EL_class.F*, i32, [4 x i8] }
!15 = !{!"S", %__SOADT_EL_class.F zeroinitializer, i32 2, !7, !8} ; { i32*, float* }
!16 = !{!"S", %struct.other.outer zeroinitializer, i32 2, !9, !5} ; { %struct.other.inner, i8 }
!17 = !{!"S", %struct.other.inner zeroinitializer, i32 2, !10, !2} ; { %struct.other*, i64 }
!18 = !{!"S", %struct.other zeroinitializer, i32 2, !2, !2} ; { i64, i64 }

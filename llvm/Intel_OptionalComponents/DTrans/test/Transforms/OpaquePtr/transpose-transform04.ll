; RUN: opt -opaque-pointers < %s -S -dtrans-transpose -dtrans-transpose-print-candidates  2>&1 | FileCheck %s
...
; CHECK: %[[D1:[A-Za-z0-9]+]] = alloca %"QNCA_a0$float*$rank2$", align 8
; CHECK: %[[D2:[A-Za-z0-9]+]] = alloca %"QNCA_a0$float*$rank2$", align 8
; CHECK: %[[D8:[A-Za-z0-9]+]] = getelementptr inbounds %"QNCA_a0$float*$rank2$", ptr %[[D1]], i64 0, i32 6, i64 0
; CHECK: %[[D13:[A-Za-z0-9]+]] = getelementptr inbounds { i64, i64, i64 }, ptr %[[D8]], i64 0, i32 1
; CHECK: %[[D14:[A-Za-z0-9]+]] = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %[[D13]], i32 0)
; CHECK: store i64 4000, ptr %[[D14]], align 1
; CHECK: %[[D17:[A-Za-z0-9]+]] = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %[[D13]], i32 1)
; CHECK: store i64 4, ptr %[[D17]], align 1
; CHECK: %[[D23:[A-Za-z0-9]+]] = getelementptr inbounds %"QNCA_a0$float*$rank2$", ptr %[[D2]], i64 0, i32 6, i64 0
; CHECK: %[[D28:[A-Za-z0-9]+]] = getelementptr inbounds { i64, i64, i64 }, ptr %[[D23]], i64 0, i32 1
; CHECK: %[[D29:[A-Za-z0-9]+]] = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %[[D28]], i32 0)
; CHECK: store i64 4000, ptr %[[D29]], align 1
; CHECK: %[[D32:[A-Za-z0-9]+]] = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %[[D28]], i32 1)
; CHECK: store i64 4, ptr %[[D32]], align 1

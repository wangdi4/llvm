...
; inc = cost + 1;
; field_1 = cost;
define void @proc4(i64 %cost, ptr "intel_dtrans_func_index"="1" %tp4) !intel.dtrans.func.type !6 {
...
; CHECK: store i16 [[CALL0]], ptr %F1, align 2
...
; field_1 = cost;
define void @proc3(i64 %cost, ptr "intel_dtrans_func_index"="1" %tp4) !intel.dtrans.func.type !7 {
  %F1 = getelementptr %struct.test.01, ptr %tp4, i32 0, i32 1
  store i64 %cost, ptr %F1, align 8
; CHECK: [[BC0:%[0-9]+]] = trunc i64 %cost to i16
; CHECK:  store i16 [[BC0]], ptr %F1, align 2
  ret void
}
...
;  call proc3(field_1, %call1);
;  call proc3(30, %call1);
define void @proc1() {
  %call1 = tail call ptr @calloc(i64 10, i64 56)
  %F1 = getelementptr %struct.test.01, ptr %call1, i32 0, i32 1
  %LF1 = load i64, ptr %F1, align 8
  call void @proc3(i64 %LF1, ptr %call1);
  call void @proc3(i64 30, ptr %call1);

; CHECK: [[LD0:%[0-9]+]] = load i16, ptr %F1, align 2
; CHECK:  %LF1 = zext i16 [[LD0]] to i64
; CHECK:  call void @proc3(i64 %LF1, ptr %call1)
; CHECK:  call void @proc3(i64 30, ptr %call1)
...
declare !intel.dtrans.func.type !9 "intel_dtrans_func_index"="1" ptr @calloc(i64, i64) #1

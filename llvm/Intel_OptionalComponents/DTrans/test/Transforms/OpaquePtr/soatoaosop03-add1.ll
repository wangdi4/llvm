...
; CHECK-MOD: define internal void @_ZN3ArrIPiE3addERKS0_{{.*}}(ptr "intel_dtrans_func_index"="1" %this, ptr "intel_dtrans_func_index"="2" %e, ptr "intel_dtrans_func_index"="3" %0) !intel.dtrans.func.type {{!*}}
...
; CHECK-TRANS-NEXT: store ptr %e, ptr %arrayidx, align 8
; CHECK-MOD-NEXT:    store ptr %0, ptr %elem, align 8
; CHECK-MOD-NEXT:    store ptr %e, ptr %elem1, align 8
  store ptr %e, ptr %arrayidx, align 8
...
declare !intel.dtrans.func.type !12 void @_ZN3ArrIPiE7reallocEi(ptr "intel_dtrans_func_index"="1", i32)

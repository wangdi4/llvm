...
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -passes=dtrans-paddedmallocop -dtrans-test-paddedmalloc -debug-only=dtrans-paddedmalloc -disable-output 2>&1 | FileCheck %s

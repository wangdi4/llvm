...
; This test verifies that class.F is considered as candidate by checking
; layout and basic CFG properties.
; This test checks essential layout requirements and simple CFG properties. See comments inlined.

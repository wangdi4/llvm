...
; This is similar to transpose-candidates20.ll, but has the useless GEP(X,0,0) and bitcast removed from @myoutput.
...
bb:
  ...
  %i3 = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 1, i32 16, ptr nonnull elementtype({ ptr, i64 }) %i, i32 1)
  ...
  %i7 = call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 1, i32 16, ptr nonnull elementtype({ ptr, i64 }) %i, i32 2)
  ...
  call void @for_concat(ptr nonnull %i, i64 2, ptr nonnull %i11, i64 269) #6

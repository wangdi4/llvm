...
; field_1 = cost;
define void @proc3(i64 %cost, %struct.test.01* "intel_dtrans_func_index"="1" %tp4) !intel.dtrans.func.type !6 {
...
declare !intel.dtrans.func.type !10 "intel_dtrans_func_index"="1" i8* @calloc(i64, i64)

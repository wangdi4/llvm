...
; This is similar to transpose-candidates20.ll, but has a GEP(X,0,0) called %i22.1 that feeds a @for_allocate_handle
; and a load.
...
bb6:                                              ; preds = %bb6, %bb
  ...
  %i22.1 = getelementptr inbounds %"PHYSPROPMOD$.btPHYSPROP_TYPE", ptr %i22, i64 0, i32 0
  ...
  %i44 = call i32 @for_allocate_handle(i64 400, ptr nonnull %i22.1, i32 262144, ptr %i42) #6
  %i44.1 = load ptr, ptr %i22.1, align 1

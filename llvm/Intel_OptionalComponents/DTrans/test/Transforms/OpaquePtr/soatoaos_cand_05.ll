...
invoke.cont7:                                     ; preds = %invoke.cont4
  ...
  call void @_ZN3ArrIPiE3setEiS0_(ptr %i4, i32 0, ptr null, ptr null)
...
define void @_ZN3ArrIPiEC2EiP3Mem(ptr nocapture "intel_dtrans_func_index"="1" %this, i32 %c, ptr "intel_dtrans_func_index"="2" %mem) align 2 !intel.dtrans.func.type !30 {
entry:
...
define void @_ZN3ArrIPvEC2EiP3Mem(ptr nocapture "intel_dtrans_func_index"="1" %this, i32 %c, ptr "intel_dtrans_func_index"="2" %mem) align 2 !intel.dtrans.func.type !31 {
entry:
...
define void @_ZN3ArrIPiE3setEiS0_(ptr nocapture readonly align 8 dereferenceable(32) "intel_dtrans_func_index"="1" %this, i32 %i, ptr "intel_dtrans_func_index"="2" %val, ptr nocapture "intel_dtrans_func_index"="3" %p) align 2 !intel.dtrans.func.type !33 {
entry:
  %base = getelementptr inbounds %struct.Arr, ptr %this, i32 0, i32 3
...
define void @_ZN3ArrIPfEC2EiP3Mem(ptr nocapture "intel_dtrans_func_index"="1" %this, i32 %c, ptr "intel_dtrans_func_index"="2" %mem) align 2 !intel.dtrans.func.type !36 {
entry:
...
!32 = distinct !{!6}
!33 = distinct !{!4, !23, !34}
!34 = !{%struct.Unexpected zeroinitializer, i32 1}
!35 = distinct !{!26, !5}
!36 = distinct !{!37, !3}

...
define void @_ZN3ArrIPvEC2ERKS1_(%struct.Arr.0* "intel_dtrans_func_index"="1" %this, %struct.Arr.0* "intel_dtrans_func_index"="2" %A) !intel.dtrans.func.type !17 {
entry:
...
define internal "intel_dtrans_func_index"="1" i8* @dummyAlloc(%struct.MemImpl* "intel_dtrans_func_index"="2" %this, i32 %conv4) !intel.dtrans.func.type !19 {
entry:
  ...
  store i8* null, i8** %g3, align 8
  %g2 = getelementptr inbounds %"class.std::bad_alloc", %"class.std::bad_alloc"* %a, i64 0, i32 0, i32 0
  store i32 (...)** null, i32 (...)*** %g2, align 8
  %bc2 = bitcast %"class.std::bad_alloc"* %a to i8*
  call void @_CxxThrowException(i8* %bc2, %eh.ThrowInfo* null)
  unreachable
}

declare !intel.dtrans.func.type !21 void @_CxxThrowException(i8* "intel_dtrans_func_index"="1", %eh.ThrowInfo* "intel_dtrans_func_index"="2")

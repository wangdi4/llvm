...
%struct.test01b = type { ptr, <4 x ptr> }
...
; With opaque pointers, only structure '%struct.test01a' is changed to a new
; structure type, because the other type was just a pointer reference.
...
; CHECK: ![[S01B]] = !{!"S", %struct.test01b zeroinitializer, i32 2, ![[PTR_S01A:[0-9]+]], ![[VECT_4xPTR_S01A:[0-9]+]]}

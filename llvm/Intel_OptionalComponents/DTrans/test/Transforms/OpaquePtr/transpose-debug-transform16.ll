...
bb:
  ...
  %i4 = call i32 (ptr, i32, ...) @for_check_mult_overflow64(ptr nonnull %i, i32 2, i64 10, i64 104) #9
...
define internal void @get_hygro_rad_props_(ptr noalias nocapture readonly dereferenceable(4) %arg, ptr noalias nocapture readonly dereferenceable(96) "assumed_shape" "ptrnoalias" %arg1, ptr noalias nocapture readnone dereferenceable(4) %arg2, ptr noalias nocapture readonly dereferenceable(4) %arg3) #3 {
bb:
  %i = getelementptr inbounds %"QNCA_a0$float*$rank2$", ptr %arg1, i64 0, i32 0
  %i4 = load ptr, ptr %i, align 1
  %i5 = getelementptr inbounds %"QNCA_a0$float*$rank2$", ptr %arg1, i64 0, i32 6, i64 0
  %i6 = getelementptr inbounds { i64, i64, i64 }, ptr %i5, i64 0, i32 1
  %i7 = tail call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %i6, i32 0)
  %i8 = load i64, ptr %i7, align 1
  %i9 = tail call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %i6, i32 1)
  %i10 = load i64, ptr %i9, align 1
  br label %bb11

bb11:                                             ; preds = %bb34, %bb
  %i12 = phi i64 [ %i35, %bb34 ], [ 1, %bb ]
  %i13 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %i10, ptr elementtype(float) %i4, i64 %i12)
  %i14 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 416, ptr nonnull elementtype(float) @"main_$TAU", i64 %i12)
  br label %bb15

bb15:                                             ; preds = %bb31, %bb11
  %i16 = phi i64 [ %i32, %bb31 ], [ 1, %bb11 ]
  br label %bb17

bb17:                                             ; preds = %bb17, %bb15
  %i18 = phi i64 [ %i29, %bb17 ], [ 1, %bb15 ]
  %i19 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 16, ptr nonnull elementtype(i32) @"main_$KRH", i64 %i18)
  %i20 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(i32) %i19, i64 %i16)
  %i21 = load i32, ptr %i20, align 1
  %i22 = add nsw i32 %i21, 1
  %i23 = sext i32 %i22 to i64
  %i24 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %i8, ptr elementtype(float) %i13, i64 %i23)
  %i25 = load float, ptr %i24, align 1
  %i26 = fadd reassoc ninf nsz arcp contract afn float %i25, %i25
  %i27 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 16, ptr nonnull elementtype(float) %i14, i64 %i18)
  %i28 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %i27, i64 %i16)
  store float %i26, ptr %i28, align 1
  %i29 = add nuw nsw i64 %i18, 1
  %i30 = icmp eq i64 %i29, 27
  br i1 %i30, label %bb31, label %bb17

bb31:                                             ; preds = %bb17
  %i32 = add nuw nsw i64 %i16, 1
  %i33 = icmp eq i64 %i32, 5
  br i1 %i33, label %bb34, label %bb15

bb34:                                             ; preds = %bb31
  %i35 = add nuw nsw i64 %i12, 1
  %i36 = icmp eq i64 %i35, 20
  br i1 %i36, label %bb37, label %bb11

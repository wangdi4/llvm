...
; RUN: opt -opaque-pointers < %s -whole-program-assume -dtrans-test-paddedmalloc -dtrans-paddedmallocop -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers < %s -whole-program-assume -dtrans-test-paddedmalloc -passes=dtrans-paddedmallocop -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers < %s -whole-program-assume -dtrans-test-paddedmalloc -dtrans-paddedmallocop -padded-pointer-prop-op -S 2>&1 | FileCheck %s
; RUN: opt -opaque-pointers < %s -whole-program-assume -dtrans-test-paddedmalloc -passes="dtrans-paddedmallocop,padded-pointer-prop-op" -S 2>&1 | FileCheck %s

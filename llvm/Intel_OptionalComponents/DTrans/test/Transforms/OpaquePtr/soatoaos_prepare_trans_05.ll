...
; CHECK: define linkonce_odr dso_local void @_ZN7BaseArrIPsEC2EjbP3Mem{{.*}}{{.*}}{{.*}}(ptr nocapture "intel_dtrans_func_index"="1" %0, ptr nocapture readonly "intel_dtrans_func_index"="2" %1)

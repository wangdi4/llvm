...
define i32 @main(i32 %argc, ptr "intel_dtrans_func_index"="1" %argv) !intel.dtrans.func.type !6 {
  ...
  call void @llvm.memset.p0.i64(ptr %p, i8 0, i64 %sz, i1 false)
...
; CHECK: %p = call ptr @malloc(i64 %sz.dt)

; Ignore parameter pointer types and any type extensions to the intrinsic
; function names.

; CHECK: call void @llvm.memset.p0.i64(ptr %p, i8 0, i64 %sz, i1 false)
; CHECK: call void @llvm.memcpy.p0.p0.i64(ptr %p, ptr %p2, i64 8, i1 false)
; CHECK: call void @llvm.memmove.p0.p0.i64(ptr %p, ptr %p3, i64 16, i1 false)
...
declare !intel.dtrans.func.type !12 void @free(ptr "intel_dtrans_func_index"="1") #1

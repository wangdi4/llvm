...
; This test verifies that (GEP, 0, 0) is generated for %i1 before using it in
; %i2.

; CHECK: %i1 = tail call ptr @Alloc(i64 40, ptr null)
; CHECK: %dtnorm = getelementptr %RefVectorOf, ptr %i1, i64 0, i32 0
; CHECK: %i2 = getelementptr inbounds %BaseRefVectorOf, ptr %dtnorm, i64 0, i32 1
; CHECK: store ptr %i1, ptr %i
...
bb:
  ...
  %i2 = getelementptr inbounds %"BaseRefVectorOf", ptr %i1, i64 0, i32 1

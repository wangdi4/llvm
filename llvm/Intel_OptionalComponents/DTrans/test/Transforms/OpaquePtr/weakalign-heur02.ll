; REQUIRES: asserts
; RUN: opt < %s -disable-output -whole-program-assume -intel-libirc-allowed -passes=dtrans-weakalign -dtrans-weakalign-heur-override=false -debug-only=dtrans-weakalign 2>&1 | FileCheck %s

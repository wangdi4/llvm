...
; CHECK: [[LD1:%[0-9]+]] = load i16, i16* [[BC1]], align 2, !tbaa ![[TBAA_LD:[0-9]+]]
...
; CHECK: store i16 [[TRUNC1]], i16* [[BC2]], align 2, !tbaa ![[TBAA_ST:[0-9]+]]
...
define "intel_dtrans_func_index"="1" %struct.test.01* @init() !intel.dtrans.func.type !13 {
...
declare !intel.dtrans.func.type !15 "intel_dtrans_func_index"="1" i8* @calloc(i64, i64) #0

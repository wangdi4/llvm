...
; RUN: opt -disable-verify -enable-npm-dtrans -dtrans-opaque-pointer-pipeline -debug-pass-manager -whole-program-assume -enable-dtrans-deletefield -passes='lto<O2>,internalize'  -internalize-public-api-list main -S  %s 2>&1 | FileCheck %s

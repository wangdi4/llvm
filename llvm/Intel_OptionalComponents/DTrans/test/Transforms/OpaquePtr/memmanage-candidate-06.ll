...
; This is a negative test created by modifying memmanage-candidate-02.ll which
; checks the behavior when the DTrans metadata information is not available
; for a function. In this case, the collection of the member functions should

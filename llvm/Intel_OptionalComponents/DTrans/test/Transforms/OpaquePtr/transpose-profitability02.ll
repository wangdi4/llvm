; REQUIRES: asserts
; RUN: opt < %s -disable-output -passes=dtrans-transpose -dtrans-transpose-print-candidates -debug-only=dtrans-transpose-profitability 2>&1 | FileCheck %s

; Ensure that enough indirectly indexed references in a particular dimension
; makes that dimension ineligible as the fastest moving stride.

; CHECK: Transpose candidate: main_$MYK
; CHECK: IsValid      : false
; CHECK: IsProfitable : false

; CHECK: Indirectly Indexed: Forcing Gain[0] to 0.0
; CHECK: Gain[0] = 0.000000e+00
; CHECK: Transpose is profitable.
; CHECK: Transpose candidate: main_$MYB
; CHECK: Transposition: 1 0
; CHECK: IsValid      : true
...
bb:
  ...
  br i1 %i9, label %bb67, label %bb10
...
bb38:                                             ; preds = %bb64, %bb10
  %i39 = phi i64 [ 1, %bb10 ], [ %i65, %bb64 ]
  br i1 %i16, label %bb64, label %bb40

bb40:                                             ; preds = %bb38
  %i41 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %i24, ptr elementtype(float) %i18, i64 %i39)
  %i42 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %i31, ptr elementtype(float) %i26, i64 %i39)
  %i43 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 400, ptr nonnull elementtype(i32) @"main_$MYK", i64 %i39)
  br label %bb44

bb44:                                             ; preds = %bb44, %bb40
  %i45 = phi i64 [ 1, %bb40 ], [ %i62, %bb44 ]
  %i46 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %i22, ptr elementtype(float) %i41, i64 %i45)
  %i47 = load float, ptr %i46, align 1
  %i48 = fadd reassoc ninf nsz arcp contract afn float %i47, 3.000000e+01
  %i49 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %i29, ptr elementtype(float) %i42, i64 %i45)
  store float %i48, ptr %i49, align 1
  %i50 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %i24, ptr elementtype(float) %i18, i64 %i45)
  %i51 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %i22, ptr elementtype(float) %i50, i64 %i39)
  %i52 = load float, ptr %i51, align 1
  %i53 = fadd reassoc ninf nsz arcp contract afn float %i48, %i52
  %i54 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %i31, ptr elementtype(float) %i26, i64 %i45)
  %i55 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %i29, ptr elementtype(float) %i54, i64 %i39)
  store float %i53, ptr %i55, align 1
  %i56 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(i32) %i43, i64 %i45)
  %i57 = load i32, ptr %i56, align 1
  %i58 = sext i32 %i57 to i64
  %i59 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %i22, ptr elementtype(float) %i41, i64 %i58)
  %i60 = load float, ptr %i59, align 1
  %i61 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %i29, ptr elementtype(float) %i42, i64 %i58)
  store float %i60, ptr %i61, align 1
  %i62 = add nuw nsw i64 %i45, 1
  %i63 = icmp eq i64 %i62, %i37
  br i1 %i63, label %bb64, label %bb44

bb64:                                             ; preds = %bb44, %bb38
  %i65 = add nuw nsw i64 %i39, 1
  %i66 = icmp eq i64 %i65, %i34
  br i1 %i66, label %bb67, label %bb38

...
; CHECK-NONOPAQUE: define "intel_dtrans_func_index"="1" %__SOADT_struct.test01dep* @test01.1(%__SOADT_struct.test01dep* "intel_dtrans_func_index"="2" %in) #{{[0-9]+}} !intel.dtrans.func.type ![[FUNC1_MD:[0-9]+]]
; CHECK-OPAQUE: define "intel_dtrans_func_index"="1" ptr @test01(ptr "intel_dtrans_func_index"="2" %in) #{{[0-9]+}} !intel.dtrans.func.type ![[FUNC1_MD:[0-9]+]]
...
; CHECK-NONOPAQUE: define "intel_dtrans_func_index"="1" i64* @test02.2(i64* "intel_dtrans_func_index"="2" %in) #{{[0-9]+}} !intel.dtrans.func.type ![[FUNC2_MD:[0-9]+]]
; CHECK-OPAQUE: define "intel_dtrans_func_index"="1" ptr @test02(ptr "intel_dtrans_func_index"="2" %in) #{{[0-9]+}} !intel.dtrans.func.type ![[FUNC2_MD:[0-9]+]]
...
; CHECK-NONOPAQUE: define void @test03.3(i64* "intel_dtrans_func_index"="1" %in1, %__SOADT_struct.test01dep* "intel_dtrans_func_index"="2" %in2) #{{[0-9]+}} !intel.dtrans.func.type ![[FUNC3_MD:[0-9]+]]
; CHECK-OPAQUE: define void @test03(ptr "intel_dtrans_func_index"="1" %in1, ptr "intel_dtrans_func_index"="2" %in2) #{{[0-9]+}} !intel.dtrans.func.type ![[FUNC3_MD:[0-9]+]]

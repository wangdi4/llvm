...
define "intel_dtrans_func_index"="1" ptr @test01(ptr "intel_dtrans_func_index"="2" %in) !intel.dtrans.func.type !4 {
  ret ptr %in
}

; CHECK: define "intel_dtrans_func_index"="1" ptr @test01(ptr "intel_dtrans_func_index"="2" %in) !intel.dtrans.func.type ![[FUNC1_MD:[0-9]+]]

; The return and parameter pointer-to-pointer should change to be a pointer to an integer type.
define "intel_dtrans_func_index"="1" ptr @test02(ptr "intel_dtrans_func_index"="2" %in) !intel.dtrans.func.type !6 {
  ret ptr %in
}
; CHECK: define "intel_dtrans_func_index"="1" ptr @test02(ptr "intel_dtrans_func_index"="2" %in) !intel.dtrans.func.type ![[FUNC2_MD:[0-9]+]]

; Test with dependent types, and multiple arguments.
define void @test03(ptr "intel_dtrans_func_index"="1" %in1, ptr "intel_dtrans_func_index"="2" %in2) !intel.dtrans.func.type !7 {
  ret void
}
; CHECK: define void @test03(ptr "intel_dtrans_func_index"="1" %in1, ptr "intel_dtrans_func_index"="2" %in2) !intel.dtrans.func.type ![[FUNC3_MD:[0-9]+]]

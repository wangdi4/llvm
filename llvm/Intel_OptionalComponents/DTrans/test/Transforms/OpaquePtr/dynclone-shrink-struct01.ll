...
;  RUN: opt < %s -opaque-pointers -dtrans-dynclone-shrunken-type-width=16 -dtrans-dynclone-sign-shrunken-int-type=false -S -enable-intel-advanced-opts -mtriple=i686-- -mattr=+avx2 -whole-program-assume -intel-libirc-allowed -passes=dtrans-dyncloneop 2>&1 | FileCheck %s
...
; CHECK: %struct.test.01 = type { i32, i64, i32, i32, i16, ptr, i64, i32 }
; Shrunken type is marked as packed.
; CHECK: %__DYN_struct.test.01 = type <{ ptr, i32, i32, i32, i32, i16, i16, i16 }>

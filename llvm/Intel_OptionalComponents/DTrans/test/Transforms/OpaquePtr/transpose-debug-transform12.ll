...
; CHECK-NEXT: Before: writefield_:  %[[N0:[A-Za-z0-9]+]] = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 %[[I0:[A-Za-z0-9]+]],
; CHECK-NEXT: After : writefield_:  %[[N0]] = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4,
; CHECK-NEXT: Before: writefield_:  %[[N1:[A-Za-z0-9]+]] = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %[[I1:[A-Za-z0-9]+]],
; CHECK-NEXT: After : writefield_:  %[[N1]] = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 4000,
...
!4 = !{%"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$" zeroinitializer, %"PHYSPROPMOD$.btPHYSPROP_TYPE" zeroinitializer}

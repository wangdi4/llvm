...
define void @_ZN1FC2Ev(ptr nocapture "intel_dtrans_func_index"="1" %this) align 2 personality ptr @__gxx_personality_v0 !intel.dtrans.func.type !27 {
entry:
  %call = call ptr @_Znwm(i64 32)
  invoke void @_ZN3ArrIPiEC2EiP4Mem1(ptr %call, i32 10, ptr null)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  ...
  invoke void @_ZN3ArrIPvEC2EiP4Mem1(ptr %call2, i32 10, ptr null)
...
declare !intel.dtrans.func.type !29 void @_ZdlPv(ptr "intel_dtrans_func_index"="1")

define void @_ZN3ArrIPiEC2EiP4Mem1(ptr nocapture "intel_dtrans_func_index"="1" %this, i32 %c, ptr "intel_dtrans_func_index"="2" %mem) align 2 !intel.dtrans.func.type !30 {
entry:
...
define void @_ZN3ArrIPvEC2EiP4Mem1(ptr nocapture "intel_dtrans_func_index"="1" %this, i32 %c, ptr "intel_dtrans_func_index"="2" %mem) align 2 !intel.dtrans.func.type !31 {
entry:
...
define void @_ZN4Arr1IPfEC2Ev(ptr nocapture align 8 dereferenceable(32) "intel_dtrans_func_index"="1" %this) align 2 !intel.dtrans.func.type !32 {
entry:
  call void @_ZN3ArrIPfEC2EiP4Mem1(ptr %this, i32 1, ptr null)
  ret void
}

define void @_ZN3ArrIPiE3setEiS0_(ptr nocapture readonly align 8 dereferenceable(32) "intel_dtrans_func_index"="1" %this, i32 %i, ptr "intel_dtrans_func_index"="2" %val) align 2 !intel.dtrans.func.type !33 {
entry:
  %base = getelementptr inbounds %struct.Arr, ptr %this, i32 0, i32 3
...
define "intel_dtrans_func_index"="1" ptr @_ZN3ArrIPvE3getEi(ptr nocapture readonly align 8 dereferenceable(32) "intel_dtrans_func_index"="2" %this, i32 %i) align 2 !intel.dtrans.func.type !35 {
entry:
  %base = getelementptr inbounds %struct.Arr.0, ptr %this, i32 0, i32 3
  %i1 = load ptr, ptr %base, align 8
  %idxprom = sext i32 %i to i64
...
define void @_ZN3ArrIPfEC2EiP4Mem1(ptr nocapture "intel_dtrans_func_index"="1" %this, i32 %c, ptr "intel_dtrans_func_index"="2" %mem) align 2 !intel.dtrans.func.type !36 {
entry:
...
!35 = distinct !{!26, !5}
!36 = distinct !{!37, !12}
!37 = !{%struct.Arr.2 zeroinitializer, i32 1}

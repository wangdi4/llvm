...
; This test is same as soatoaos_cand_01.ll except different memory interface
; classes (Mem and Mem1) are used by %class.F and other array classes.
; This test verifies that %class.F is not considered as candidate due to
; different memory interface classes in %class.F & %struct.Arr*.
...
;   Only Mem1 is captured.

;   Arr(int c = 1, Mem1 *mem = nullptr)
...
; int main() { F *f = new F(); }
;
; CHECK: dtrans-soatoaos-layout: arrays and struct have different candidates for mem interface.
...
%struct.Mem = type { i32 (...)** }
%struct.Arr = type <{ %struct.Mem1*, i32, [4 x i8], i32**, i32, [4 x i8] }>
%struct.Mem1 = type { i32 (...)** }
%struct.Arr.0 = type <{ %struct.Mem1*, i32, [4 x i8], i8**, i32, [4 x i8] }>
%struct.Arr1 = type { %struct.Arr.base.3, [4 x i8] }
%struct.Arr.base.3 = type <{ %struct.Mem1*, i32, [4 x i8], float**, i32 }>
%struct.Arr.2 = type <{ %struct.Mem1*, i32, [4 x i8], float**, i32, [4 x i8] }>
...
entry:
  ...
  invoke void @_ZN3ArrIPiEC2EiP4Mem1(%struct.Arr* %0, i32 10, %struct.Mem1* null)
          to label %invoke.cont unwind label %lpad
...
invoke.cont:                                      ; preds = %entry
  ...
  invoke void @_ZN3ArrIPvEC2EiP4Mem1(%struct.Arr.0* %1, i32 10, %struct.Mem1* null)
...
define void @_ZN3ArrIPiEC2EiP4Mem1(%struct.Arr* nocapture  "intel_dtrans_func_index"="1" %this, i32 %c, %struct.Mem1* "intel_dtrans_func_index"="2" %mem) align 2 !intel.dtrans.func.type !40 {
entry:
  %mem2 = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 0
  store %struct.Mem1* %mem, %struct.Mem1** %mem2, align 8
...
define void @_ZN3ArrIPvEC2EiP4Mem1(%struct.Arr.0* nocapture "intel_dtrans_func_index"="1" %this, i32 %c, %struct.Mem1* "intel_dtrans_func_index"="2" %mem) align 2 !intel.dtrans.func.type !49 {
entry:
...
define void @_ZN4Arr1IPfEC2Ev(%struct.Arr1* nocapture align 8 dereferenceable(32)  "intel_dtrans_func_index"="1" %this) align 2 !intel.dtrans.func.type !56 {
entry:
  %0 = bitcast %struct.Arr1* %this to %struct.Arr.2*
  call void @_ZN3ArrIPfEC2EiP4Mem1(%struct.Arr.2* %0, i32 1, %struct.Mem1* null)
  ret void
}

define void @_ZN3ArrIPiE3setEiS0_(%struct.Arr* nocapture readonly align 8 dereferenceable(32) "intel_dtrans_func_index"="1" %this, i32 %i, i32* "intel_dtrans_func_index"="2" %val) align 2 !intel.dtrans.func.type !57 {
entry:
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 3
...
define "intel_dtrans_func_index"="1" i8* @_ZN3ArrIPvE3getEi(%struct.Arr.0* nocapture readonly align 8 dereferenceable(32) "intel_dtrans_func_index"="2" %this, i32 %i) align 2  !intel.dtrans.func.type !61 {
entry:
  %base = getelementptr inbounds %struct.Arr.0, %struct.Arr.0* %this, i32 0, i32 3
...
define void @_ZN3ArrIPfEC2EiP4Mem1(%struct.Arr.2* nocapture  "intel_dtrans_func_index"="1" %this, i32 %c, %struct.Mem1* "intel_dtrans_func_index"="2" %mem) align 2  !intel.dtrans.func.type !64 {
entry:
...
!intel.dtrans.types = !{!2, !7, !11, !16, !17, !19, !21, !23}
!llvm.ident = !{!24}
...
!10 = !{i32 0, i32 0}
!11 = !{!"S", %struct.Arr zeroinitializer, i32 6, !12, !10, !13, !15, !10, !13}
!12 = !{%struct.Mem1 zeroinitializer, i32 1}
!13 = !{!"A", i32 4, !14}
!14 = !{i8 0, i32 0}
!15 = !{i32 0, i32 2}
!16 = !{!"S", %struct.Mem1 zeroinitializer, i32 1, !8}
!17 = !{!"S", %struct.Arr.0 zeroinitializer, i32 6, !12, !10, !13, !18, !10, !13}
!18 = !{i8 0, i32 2}
!19 = !{!"S", %struct.Arr1 zeroinitializer, i32 2, !20, !13}
!20 = !{%struct.Arr.base.3 zeroinitializer, i32 0}
!21 = !{!"S", %struct.Arr.2 zeroinitializer, i32 6, !12, !10, !13, !22, !10, !13}
!22 = !{float 0.000000e+00, i32 2}
!23 = !{!"S", %struct.Arr.base.3 zeroinitializer, i32 5, !12, !10, !13, !22, !10}
...
!40 = distinct !{!4, !12}
!41 = !{!42, !43, i64 0}
!42 = !{!"struct@_ZTS3ArrIPiE", !43, i64 0, !44, i64 8, !45, i64 16, !44, i64 24}
!43 = !{!"pointer@_ZTSP4Mem1", !32, i64 0}
!44 = !{!"int", !32, i64 0}
!45 = !{!"pointer@_ZTSPPi", !32, i64 0}
!46 = !{!42, !44, i64 8}
!47 = !{!42, !45, i64 16}
!48 = !{!42, !44, i64 24}
!49 = distinct !{!5, !12}
!50 = !{!51, !43, i64 0}
!51 = !{!"struct@_ZTS3ArrIPvE", !43, i64 0, !44, i64 8, !52, i64 16, !44, i64 24}
!52 = !{!"pointer@_ZTSPPv", !32, i64 0}
!53 = !{!51, !44, i64 8}
!54 = !{!51, !52, i64 16}
!55 = !{!51, !44, i64 24}
!56 = distinct !{!6}
...
!58 = !{i32 0, i32 1}
!59 = !{!60, !60, i64 0}
!60 = !{!"pointer@_ZTSPi", !32, i64 0}
!61 = distinct !{!26, !5}
!62 = !{!63, !63, i64 0}
!63 = !{!"pointer@_ZTSPv", !32, i64 0}
!64 = distinct !{!65, !12}
!65 = !{%struct.Arr.2 zeroinitializer, i32 1}
!66 = !{!67, !43, i64 0}
!67 = !{!"struct@_ZTS3ArrIPfE", !43, i64 0, !44, i64 8, !68, i64 16, !44, i64 24}
!68 = !{!"pointer@_ZTSPPf", !32, i64 0}
!69 = !{!67, !44, i64 8}
!70 = !{!67, !68, i64 16}
!71 = !{!67, !44, i64 24}

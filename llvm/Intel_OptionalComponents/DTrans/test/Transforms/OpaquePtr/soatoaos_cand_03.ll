...
%class.F = type { %struct.Mem*, %struct.Arr*, %struct.Arr.0*, %struct.Arr1*, i32* }
%struct.Mem = type { i32 (...)** }
...
declare !intel.dtrans.func.type !24 dso_local nonnull "intel_dtrans_func_index"="1" i8* @_Znwm(i64)

define void @_ZN1FC2Ev(%class.F* "intel_dtrans_func_index"="1" %this) align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !intel.dtrans.func.type !26 {
entry:
  %call = call i8* @_Znwm(i64 32)
...
define void @_ZN3ArrIPiE3setEiS0_(%struct.Arr* nocapture readonly align 8 dereferenceable(32) "intel_dtrans_func_index"="1" %this, i32 %i, i32* "intel_dtrans_func_index"="2" %val) align 2 !intel.dtrans.func.type !56 {
entry:
  %base = getelementptr inbounds %struct.Arr, %struct.Arr* %this, i32 0, i32 3
...
!28 = !{!29, !33, i64 8}
!29 = !{!"struct@_ZTS1F", !30, i64 0, !33, i64 8, !34, i64 16, !35, i64 24, !36, i64 32}
...
!48 = distinct !{!5, !3}
!49 = !{!50, !30, i64 0}
!50 = !{!"struct@_ZTS3ArrIPvE", !30, i64 0, !43, i64 8, !51, i64 16, !43, i64 24}
!51 = !{!"pointer@_ZTSPPv", !31, i64 0}
!52 = !{!50, !43, i64 8}
!53 = !{!50, !51, i64 16}
!54 = !{!50, !43, i64 24}
!55 = distinct !{!6}
...
!58 = distinct !{!25, !5}
!59 = !{!60, !60, i64 0}
!60 = !{!"pointer@_ZTSPv", !31, i64 0}
!61 = distinct !{!62, !3}
!62 = !{%struct.Arr.2 zeroinitializer, i32 1}
!63 = !{!64, !30, i64 0}
!64 = !{!"struct@_ZTS3ArrIPfE", !30, i64 0, !43, i64 8, !65, i64 16, !43, i64 24}
!65 = !{!"pointer@_ZTSPPf", !31, i64 0}
!66 = !{!64, !43, i64 8}
!67 = !{!64, !65, i64 16}
!68 = !{!64, !43, i64 24}

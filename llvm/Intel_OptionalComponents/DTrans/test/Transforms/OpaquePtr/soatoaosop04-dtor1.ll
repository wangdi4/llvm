...
define hidden void @"ValueVectorOf<IC_Field*>::~ValueVectorOf()"(ptr nocapture readonly "intel_dtrans_func_index"="1" %arg) !intel.dtrans.func.type !12 {
bb:
...
bb13:                                             ; preds = %bb
  tail call void @_ZN10MemManager10deallocateEPv(ptr %tmp1, ptr %tmp4)
  br label %bb15

bb14:                                             ; preds = %bb
  tail call void @dummyDeallocateEPv(ptr %tmp1, ptr %tmp4)
  br label %bb15

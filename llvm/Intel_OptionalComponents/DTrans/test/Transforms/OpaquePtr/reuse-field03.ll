; This test try to check fields intersect function, the 1-th field's same value fields should be { 1 3 4 }, but 3-th and 4-th field's same value fields should be { 3, 4 }, so the result of intersect should be { 3, 4 }.
; REQUIRES: asserts

; REQUIRES: asserts
; RUN: opt -whole-program-assume -intel-libirc-allowed -disable-output -debug-only=dtrans-aostosoaop -passes=dtrans-aostosoaop -dtrans-aostosoaop-index32=true -dtrans-aostosoaop-typelist=struct.test01 -dtrans-aostosoaop-qual-override=true %s 2>&1 | FileCheck %s
...
define i32 @main() {
  %mem = call ptr @calloc(i64 1, i64 16)
  ...
  call void @unknown_func(ptr %mem)
  ret i32 0
}
...
declare !intel.dtrans.func.type !5 void @unknown_func(ptr "intel_dtrans_func_index"="1")

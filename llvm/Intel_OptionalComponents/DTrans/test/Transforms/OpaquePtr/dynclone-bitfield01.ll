...
; CHECK: [[PD0:%[0-9]+]] = bitcast %struct.test.01* %tp2 to %__DYN_struct.test.01*
; CHECK: [[PG5:%[0-9]+]] = getelementptr %__DYN_struct.test.01, %__DYN_struct.test.01* [[PD0]], i32 0, i32 6
;
; Storing shrunken packed field.
;
; CHECK: [[PD1:%[0-9]+]] = bitcast %struct.test.01* %tp2 to %__DYN_struct.test.01*
; CHECK: [[PG5:%[0-9]+]] = getelementptr %__DYN_struct.test.01, %__DYN_struct.test.01* [[PD1]], i32 0, i32 5

...
; transpose candidate even though field 1 is of type character(len=32) and is
; passed down the call chain, as long as -dtrans-outofboundsok=false.
...
bb:
  ...
  store i64 128, ptr getelementptr inbounds (%"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$", ptr @physpropmod_mp_physprop_, i64 0, i32 1), align 8
  ...
  store i64 128, ptr %i3, align 1
  %i4 = call i32 (ptr, i32, ...) @for_check_mult_overflow64(ptr nonnull %i, i32 2, i64 10, i64 128) #11
  ...
  %i14 = tail call i32 @for_allocate_handle(i64 %i5, ptr @physpropmod_mp_physprop_, i32 %i11, ptr %i13) #11
  br label %bb15
...
bb30:                                             ; preds = %bb30, %bb15
  %i31 = phi float [ %i69, %bb30 ], [ 1.000000e+00, %bb15 ]
  %i32 = phi i64 [ %i70, %bb30 ], [ 10, %bb15 ]
  ...
  %i61 = tail call i32 @for_allocate_handle(i64 76000, ptr %i60, i32 262144, ptr %i59) #11
  %i62 = load ptr, ptr @physpropmod_mp_physprop_, align 8
  %i63 = load i64, ptr %i3, align 1
  %i64 = load i64, ptr %i1, align 1
  %i65 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 %i64, i64 %i63, ptr elementtype(%"PHYSPROPMOD$.btPHYSPROP_TYPE") %i62, i64 %i37)
  %i66 = getelementptr inbounds %"PHYSPROPMOD$.btPHYSPROP_TYPE", ptr %i65, i64 0, i32 1
  %i67 = getelementptr [32 x i8], ptr %i66, i64 0, i64 0
  %i68 = getelementptr i8, ptr %i67, i64 5
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) %i67, ptr noundef nonnull align 1 dereferenceable(5) @strlit, i64 5, i1 false)
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(27) %i68, i8 32, i64 27, i1 false)
  %i69 = fadd reassoc ninf nsz arcp contract afn float %i31, 1.000000e+00
  %i70 = add nsw i64 %i32, -1
  %i71 = icmp sgt i64 %i32, 1
  br i1 %i71, label %bb30, label %bb72
...
define internal void @get_hygro_rad_props_(ptr noalias nocapture readonly dereferenceable(4) %arg, ptr noalias nocapture readonly dereferenceable(96) "assumed_shape" "ptrnoalias" %arg1, ptr noalias nocapture readnone dereferenceable(4) %arg2, ptr noalias nocapture readonly %arg3, i64 %arg4) #3 {
bb:
  %i = getelementptr inbounds %"QNCA_a0$float*$rank2$", ptr %arg1, i64 0, i32 0
  %i5 = load ptr, ptr %i, align 1
  ...
  %i10 = tail call ptr @llvm.intel.subscript.p0.i64.i32.p0.i32(i8 0, i64 0, i32 24, ptr nonnull elementtype(i64) %i7, i32 1)
  %i11 = load i64, ptr %i10, align 1
  br label %bb12

bb12:                                             ; preds = %bb35, %bb
  %i13 = phi i64 [ %i36, %bb35 ], [ 1, %bb ]
  %i14 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 %i11, ptr elementtype(float) %i5, i64 %i13)
  %i15 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 2, i64 1, i64 416, ptr nonnull elementtype(float) @"main_$TAU", i64 %i13)
  br label %bb16
...
bb18:                                             ; preds = %bb18, %bb16
  ...
  %i20 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 16, ptr nonnull elementtype(i32) @"main_$KRH", i64 %i19)
  %i21 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(i32) %i20, i64 %i17)
  %i22 = load i32, ptr %i21, align 1
  %i23 = add nsw i32 %i22, 1
  %i24 = sext i32 %i23 to i64
  %i25 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 %i9, ptr elementtype(float) %i14, i64 %i24)
  %i26 = load float, ptr %i25, align 1
  %i27 = fadd reassoc ninf nsz arcp contract afn float %i26, %i26
  %i28 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 1, i64 1, i64 16, ptr nonnull elementtype(float) %i15, i64 %i19)
  %i29 = tail call ptr @llvm.intel.subscript.p0.i64.i64.p0.i64(i8 0, i64 1, i64 4, ptr nonnull elementtype(float) %i28, i64 %i17)
...
bb5:                                              ; preds = %bb5, %bb
  %i6 = phi i32 [ %i7, %bb5 ], [ 1, %bb ]
  call void @physprop_get_(ptr nonnull %i, ptr nonnull %i2)
  call void @get_hygro_rad_props_(ptr nonnull @"main_$KRH", ptr nonnull %i2, ptr nonnull @"main_$TAU", ptr undef, i64 undef)
...
bb:
  %i = tail call i32 @for_set_reentrancy(ptr nonnull @anon.5b3c5dff38f14be85a38ea3af0f7d558.0) #11

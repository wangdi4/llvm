...
; Use a GEPoperator with more than 2 indices.
...
define dso_local i32 @main() {
  ...
  %t0 = load ptr, ptr getelementptr inbounds (%struct.MYOSTRUCT, ptr @globstruct, i32 0, i32 2, i32 0), align 8
  %call = call i32 %t0(), !intel_dtrans_type !1
  %t1 = load ptr, ptr getelementptr inbounds (%struct.MYOSTRUCT, ptr @globstruct, i32 0, i32 2, i32 1), align 8
...
!6 = !{!"S", %struct.MYOSTRUCT zeroinitializer, i32 3, !2, !2, !4} ; { i32, i32,  %struct.MYSTRUCT }

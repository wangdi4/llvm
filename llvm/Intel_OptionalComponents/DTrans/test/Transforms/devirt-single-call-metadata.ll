...
; CHECK-LABEL: define i32 @main
  ...
  %vtable_addr = bitcast ptr @d to ptr
  %obj = getelementptr %class.Derived, ptr @d, i64 0, i32 0
...
; CHECK: %call = tail call zeroext i1 @_ZN7Derived3fooEi(ptr %obj, i32 %argc), !_Intel.Devirt.Call

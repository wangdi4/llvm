...
; RUN: opt -whole-program-assume -intel-libirc-allowed -dtrans-deletefield -dtrans-identify-unused-values=false -S -o - %s | FileCheck %s
; RUN: opt -whole-program-assume -intel-libirc-allowed -passes=dtrans-deletefield -dtrans-identify-unused-values=false -S -o - %s | FileCheck %s

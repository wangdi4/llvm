...
; their rank 0 index is indirectly subscripted.

; CHECK-LABEL: Transform candidate: main_$MYA
; CHECK-NEXT: Before: foo_:  %[[N0:[0-9]+]] = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1,
...
; CHECK-NEXT: After :   store i64 400,
; CHECK-NEXT: Before:   store i64 100,
; CHECK-NEXT: After :   store i64 200,
; CHECK-NEXT: Before:   store i64 400,
; CHECK-NEXT: After :   store i64 4,
; CHECK-NEXT: Before:   store i64 200,
; CHECK-NEXT: After :   store i64 100,
...
42:                                               ; preds = %40
  %43 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 400, i32* nonnull getelementptr inbounds ([200 x [100 x i32]], [200 x [100 x i32]]* @"main_$MYK", i64 0, i64 0, i64 0), i64 %41)
  %44 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %26, float* %20, i64 %41)
  %45 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %33, float* %28, i64 %41)
  br label %46

46:                                               ; preds = %46, %42
  %47 = phi i64 [ 1, %42 ], [ %54, %46 ]
  %48 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %43, i64 %47)
  %49 = load i32, i32* %48, align 1
  %50 = sext i32 %49 to i64
  %51 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 %24, float* %44, i64 %50)
  %52 = load float, float* %51, align 1
  %53 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 %31, float* %45, i64 %50)

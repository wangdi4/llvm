...
define hidden void @"ValueVectorOf<IC_Field*>::~ValueVectorOf()"(%class.ValueVectorOf* nocapture readonly %arg) {
bb:
...
bb13:                                             ; preds = %bb
  tail call void bitcast (void (i8*)* @"MemoryManagerImpl::deallocate(void*)" to void (i8*)*)(i8* %tmp4)
  br label %bb15

bb14:                                             ; preds = %bb
  tail call void bitcast (void (i8*)* @"XalanDummyMemoryManager::deallocate(void*)" to void (i8*)*)(i8* %tmp4)
  br label %bb15

...
41:                                               ; preds = %39
  %42 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 76, i32* nonnull getelementptr inbounds ([1000 x [19 x i32]], [1000 x [19 x i32]]* @"main_$MYK", i64 0, i64 0, i64 0), i64 %40)
  %43 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %26, float* %20, i64 %40)
  %44 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %33, float* %28, i64 %40)
  br label %45

45:                                               ; preds = %45, %41
  %46 = phi i64 [ 2, %41 ], [ %56, %45 ]
  %47 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %42, i64 %46)
  %48 = load i32, i32* %47, align 1
  %49 = add nsw i32 %48, -1
  %50 = sext i32 %49 to i64
  %51 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 %24, float* %43, i64 %50)
  %52 = load float, float* %51, align 1
  %53 = add nsw i32 %48, 1
  %54 = sext i32 %53 to i64
  %55 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 %31, float* %44, i64 %54)

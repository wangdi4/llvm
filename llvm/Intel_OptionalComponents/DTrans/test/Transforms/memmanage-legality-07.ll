...
; %"ArenaAllocator" type is used in "bitcast" instruction in function
; "NonStringObjMemberFunction" like below.
;
;  %bc = bitcast i8* %a to %"ArenaAllocator"*
;
...
define internal void @bar() align 2 {
  tail call void @NonStringObjMemberFunction(i8* null)
  ret void
}

define internal void @NonStringObjMemberFunction(i8* %a) align 2 {
  %bc = bitcast i8* %a to %"ArenaAllocator"*
  ret void
}

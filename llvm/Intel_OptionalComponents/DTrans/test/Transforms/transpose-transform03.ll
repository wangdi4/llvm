...
define void @test01() {
  ...
  store i64 16, i64* %t5
  %t6 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"var$01_$field6$_$field1$", i32 2)
  store i64 1024, i64* %t6
  %t7 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"var$01_$field6$_$field2$", i32 2)
  store i64 1, i64* %t7
  %t8 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"var$01_$field6$_$field0$", i32 2)
  store i64 16, i64* %t8
...
; CHECK: %t0 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"var$01_$field6$_$field1$", i32 0)
; CHECK: store i64 1024, i64* %t0
; CHECK: %t3 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"var$01_$field6$_$field1$", i32 1)
; CHECK: store i64 64, i64* %t3
; CHECK: %t6 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"var$01_$field6$_$field1$", i32 2)
...
entry:
  ...
  %stride0_addr = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* %"var$01_$field6$_$field1$", i32 0)
  %stride1_addr = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* %"var$01_$field6$_$field1$", i32 1)
  %stride2_addr = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* %"var$01_$field6$_$field1$", i32 2)
...
loop3_topA:
  %ptr_part1A = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 2, i64 1, i64 %stride2, i32* %"MYBLOCK_$field0$1", i64 %loop3_cnt)
  br label %loop3_body

loop3_topB:
  %ptr_part1B = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 2, i64 1, i64 %stride2, i32* %"MYBLOCK_$field0$1", i64 %loop3_cnt)
  br label %loop3_body

loop3_body:
  ; Test using a PHINode on the subscript result.
  %ptr_part1.phi = phi i32* [ %ptr_part1A, %loop3_topA ], [ %ptr_part1B, %loop3_topB ]
  %ptr_part2 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 %stride1, i32 *%ptr_part1.phi, i64 %loop2_cnt)
  ...
  %ptr_part2b = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 %stride1, i32 *%ptr_part1.phi, i64 %loop2_cnt)
  %ptr_part2.sel = select i1 undef, i32* %ptr_part2, i32* %ptr_part2b
  %ptr.sel = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 %stride0, i32 *%ptr_part2.sel, i64 %loop1_cnt)
...
; CHECK: %ptr_part1A = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 %stride2, i32* %"MYBLOCK_$field0$1", i64 %loop3_cnt)
; CHECK: %ptr_part1B = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 %stride2, i32* %"MYBLOCK_$field0$1", i64 %loop3_cnt)

; CHECK: %ptr_part1.phi = phi i32* [ %ptr_part1A, %loop3_topA ], [ %ptr_part1B, %loop3_topB ]
; CHECK: %ptr_part2 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 %stride1, i32* %ptr_part1.phi, i64 %loop2_cnt)
...
; CHECK: %ptr_part2b = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 %stride1, i32* %ptr_part1.phi, i64 %loop2_cnt)
; CHECK: %ptr_part2.sel = select i1 undef, i32* %ptr_part2, i32* %ptr_part2b
; CHECK: %ptr.sel = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 2, i64 1, i64 %stride0, i32* %ptr_part2.sel, i64 %loop1_cnt)

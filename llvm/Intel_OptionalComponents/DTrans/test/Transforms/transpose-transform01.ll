...
define void @test01() {
  %ptr_part1 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 36, i32* getelementptr ([9 x [9 x i32]], [9 x [9 x i32]]* @test_var01, i64 0, i64 0, i64 0), i64 0)
  %ptr = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32 *%ptr_part1, i64 0)
  store i32 0, i32* %ptr
  ret void
}
; CHECK: call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* getelementptr inbounds ([9 x [9 x i32]], [9 x [9 x i32]]* @test_var01, i64 0, i64 0, i64 0), i64 0)
; CHECK: call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 36, i32* %ptr_part1, i64 0)
...
define void @test02dv({ i32*, i64, i64, i64, i64, i64, [2 x { i64, i64, i64 }] }* %MYBLOCK) {
  ...
  %test02dv_col_addr = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 %t3, i32* %"MYBLOCK_$field0$1", i64 5)
  %test02dv_ptr_addr = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 %t1, i32* %test02dv_col_addr, i64 5)
  ...
  call void @test02ul(%uplevel_type* %uplevel_rec)

  ret void
}
; Check that rank parameter was updated.
;CHECK: %test02dv_col_addr = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 %t3, i32* %"MYBLOCK_$field0$1", i64 5)
;CHECK: %test02dv_ptr_addr = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 %t1, i32* %test02dv_col_addr, i64 5)

; This checks the usage of the dope vector that gets loaded from an uplevel
; variable.
define void @test02ul(%uplevel_type* %UL_IN_PTR) {
  ...
  %stride0_addr = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"ul_arg_0.GEP_$field6$_$field1$", i32 0)
  %stride1_addr = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %"ul_arg_0.GEP_$field6$_$field1$", i32 1)
  ...
  %test02ul_col_addr = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 %stride1, i32* %"ul_arg_0.GEP_$field0$30", i64 0)
  %test02ul_ptr_addr = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 %stride0, i32* %test02ul_col_addr, i64 0)
  store i32 0, i32* %test02ul_ptr_addr, align 4

  ret void
}
; Check that rank parameter was updated.
;CHECK: %test02ul_col_addr = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 %stride1, i32* %"ul_arg_0.GEP_$field0$30", i64 0)
;CHECK: %test02ul_ptr_addr = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 %stride0, i32* %test02ul_col_addr, i64 0)

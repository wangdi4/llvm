...
; test is for a safe use of llvm.assume. This is the same as
; the weakalign-transform03.ll test, except the operands of the
; 'and' and 'icmp' instructions are reversed.
...
define internal void @test01b(%struct.other.outer* %p) {
  ...
  %masked = and i64 7, %pti
  %aligned = icmp eq i64 0, %masked

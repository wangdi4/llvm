...
; Check that neither physpropmod_mp_physprop_ field 0 nor field 2 is
; transposed, because there is a mismatch between the bounds
; of the dope vector arrays in field 0.

; CHECK-NOT: Transform candidate: physpropmod_mp_physprop_[0]
; CHECK-NOT: Transpose candidate: physpropmod_mp_physprop_[2]

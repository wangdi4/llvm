...
define i32 @main(i32 %argc, ptr %argv) local_unnamed_addr personality ptr @__gxx_personality_v0 {
; CHECK-LABEL: define i32 @main
  ...
  %call = invoke zeroext i1 %fptr(ptr %obj, i32 %argc)
          to label %invoke.cont unwind label %lpad

; CHECK-LABEL: BBDevirt__ZN7Derived3fooEi:
; CHECK: invoke zeroext i1 @_ZN7Derived3fooEi(ptr %obj, i32 %argc)
; CHECK:  to label %MergeBB unwind label %lpad, !_Intel.Devirt.Call

; CHECK-LABEL: BBDevirt__ZN8Derived23fooEi:
; CHECK: invoke zeroext i1 @_ZN8Derived23fooEi(ptr %obj, i32 %argc)
; CHECK: to label %MergeBB unwind label %lpad, !_Intel.Devirt.Call
...
lpad:
  ...
  cleanup
  catch ptr bitcast (ptr @_ZTIPKc to ptr)
  resume { ptr, i32 } %lp
}

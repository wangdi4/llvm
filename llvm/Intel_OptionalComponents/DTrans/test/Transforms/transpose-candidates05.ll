...
bb5:                                              ; preds = %bb5, %bb
  ...
  %i10 = tail call %"MAIN$.btPHYSPROP_TYPE"* @"llvm.intel.subscript.p0s_MAIN$.btPHYSPROP_TYPEs.i64.i64.p0s_MAIN$.btPHYSPROP_TYPEs.i64"(i8 0, i64 1, i64 192, %"MAIN$.btPHYSPROP_TYPE"* elementtype(%"MAIN$.btPHYSPROP_TYPE") %i7, i64 %i6)
...
bb65:                                             ; preds = %bb65, %bb62
  ...
  %i70 = tail call %"MAIN$.btPHYSPROP_TYPE"* @"llvm.intel.subscript.p0s_MAIN$.btPHYSPROP_TYPEs.i64.i64.p0s_MAIN$.btPHYSPROP_TYPEs.i64"(i8 0, i64 1, i64 192, %"MAIN$.btPHYSPROP_TYPE"* elementtype(%"MAIN$.btPHYSPROP_TYPE") %i67, i64 %i61)

...
; CHECK: Before: get_hygro_rad_props_:  %[[N0:[0-9]+]] = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %[[X0:[0-9]+]], float* %[[I0:[0-9]+]], i64 %[[J0:[0-9]+]])
; CHECK: After : get_hygro_rad_props_:  %[[N0]] = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* %[[I0]], i64 %[[J0]])
; CHECK: Before: get_hygro_rad_props_:  %[[N1:[0-9]+]] = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 %[[X1:[0-9]+]], float* %[[I1:[0-9]+]], i64 %[[J1:[0-9]+]])
; CHECK: After : get_hygro_rad_props_:  %[[N1]] = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 76, float* %[[I1]], i64 %[[J1]])
...
define internal void @physprop_init_(i32* noalias nocapture readonly dereferenceable(4) %0) #0 {
  ...
  %6 = call i32 (i64*, i32, ...) @for_check_mult_overflow64(i64* nonnull %2, i32 2, i64 10, i64 104) #10
  ...
  %16 = tail call i32 @for_allocate_handle(i64 %7, i8** bitcast (%"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$"* @physpropmod_mp_physprop_ to i8**), i32 %13, i8* %15) #10
  br label %17
...
32:                                               ; preds = %32, %17
  ...
  %63 = tail call i32 @for_allocate_handle(i64 76000, i8** %62, i32 262144, i8* %61) #10
  ...
  %68 = tail call %"PHYSPROPMOD$.btPHYSPROP_TYPE"* @"llvm.intel.subscript.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64.i64.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64"(i8 0, i64 %67, i64 %66, %"PHYSPROPMOD$.btPHYSPROP_TYPE"* %65, i64 %39)
...
define internal void @get_hygro_rad_props_(i32* noalias nocapture readonly dereferenceable(4) %0, %"QNCA_a0$float*$rank2$"* noalias nocapture readonly dereferenceable(96) "assumed_shape" "ptrnoalias" %1, float* noalias nocapture readnone dereferenceable(4) %2, float* noalias readonly dereferenceable(4) %3) #4 {
  %5 = alloca float, align 8
  call void (...) bitcast (void (i8*, i8*)* @getbytes_ to void (...)*)(float* nonnull %3, float* nonnull %5) #10
  ...
  %12 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %9, i32 1)
  %13 = load i64, i64* %12, align 1
  br label %14

14:                                               ; preds = %37, %4
  %15 = phi i64 [ %38, %37 ], [ 1, %4 ]
  %16 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %13, float* %7, i64 %15)
  %17 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 2, i64 1, i64 416, float* nonnull getelementptr inbounds ([19 x [26 x [4 x float]]], [19 x [26 x [4 x float]]]* @"main_$TAU", i64 0, i64 0, i64 0, i64 0), i64 %15)
  br label %18
...
20:                                               ; preds = %20, %18
  ...
  %22 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 16, i32* nonnull getelementptr inbounds ([26 x [4 x i32]], [26 x [4 x i32]]* @"main_$KRH", i64 0, i64 0, i64 0), i64 %21)
  %23 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* nonnull %22, i64 %19)
  %24 = load i32, i32* %23, align 1
  %25 = add nsw i32 %24, 1
  %26 = sext i32 %25 to i64
  %27 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 %11, float* %16, i64 %26)
  %28 = load float, float* %27, align 1
  %29 = fadd reassoc ninf nsz arcp contract afn float %28, %28
  %30 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 16, float* nonnull %17, i64 %21)
  %31 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* nonnull %30, i64 %19)
...
9:                                                ; preds = %9, %2
  ...
  %15 = tail call %"PHYSPROPMOD$.btPHYSPROP_TYPE"* @"llvm.intel.subscript.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64.i64.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64"(i8 0, i64 %13, i64 %12, %"PHYSPROPMOD$.btPHYSPROP_TYPE"* %11, i64 %14)
...
define dso_local void @MAIN__() #7 {
  %1 = tail call i32 @for_set_reentrancy(i32* nonnull @anon.5b3c5dff38f14be85a38ea3af0f7d558.0) #10
...
define internal void @getbytes_(i8* nocapture readonly %0, i8* nocapture %1) #8 {
  br label %4
...
4:                                                ; preds = %4, %2
  ...
  store i8 %9, i8* %6, align 1, !tbaa !7
...
declare i64 @llvm.ssa.copy.i64(i64 returned %0) #9
...
attributes #4 = { noinline nounwind uwtable "frame-pointer"="none" "intel-lang"="fortran" "min-legal-vector-width"="0" "pre_loopopt" "target-cpu"="skylake-avx512" "target-features"="+adx,+aes,+avx,+avx2,+avx512bw,+avx512cd,+avx512dq,+avx512f,+avx512vl,+bmi,+bmi2,+clflushopt,+clwb,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+pku,+popcnt,+prfchw,+rdrnd,+rdseed,+sahf,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves" }
...
attributes #6 = { noinline noreturn nounwind uwtable "frame-pointer"="none" "intel-lang"="fortran" "min-legal-vector-width"="0" "pre_loopopt" "target-cpu"="skylake-avx512" "target-features"="+adx,+aes,+avx,+avx2,+avx512bw,+avx512cd,+avx512dq,+avx512f,+avx512vl,+bmi,+bmi2,+clflushopt,+clwb,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+pku,+popcnt,+prfchw,+rdrnd,+rdseed,+sahf,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves" }
attributes #7 = { noreturn nounwind uwtable "frame-pointer"="none" "intel-lang"="fortran" "min-legal-vector-width"="0" "pre_loopopt" "target-cpu"="skylake-avx512" "target-features"="+adx,+aes,+avx,+avx2,+avx512bw,+avx512cd,+avx512dq,+avx512f,+avx512vl,+bmi,+bmi2,+clflushopt,+clwb,+cx16,+cx8,+f16c,+fma,+fsgsbase,+fxsr,+invpcid,+lzcnt,+mmx,+movbe,+pclmul,+pku,+popcnt,+prfchw,+rdrnd,+rdseed,+sahf,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87,+xsave,+xsavec,+xsaveopt,+xsaves" }

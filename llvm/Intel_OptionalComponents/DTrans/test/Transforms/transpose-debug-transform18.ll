...
; CHECK: Before: get_hygro_rad_props_:  %[[N0:[0-9]+]] = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %[[X0:[0-9]+]], float* elementtype(float) %[[I0:[0-9]+]], i64 %[[J0:[0-9]+]])
; CHECK: After : get_hygro_rad_props_:  %[[N0]] = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* elementtype(float) %[[I0]], i64 %[[J0]])
; CHECK: Before: get_hygro_rad_props_:  %[[N1:[0-9]+]] = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 %[[X1:[0-9]+]], float* elementtype(float) %[[I1:[0-9]+]], i64 %[[J1:[0-9]+]])
; CHECK: After : get_hygro_rad_props_:  %[[N1]] = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 76, float* elementtype(float) %[[I1]], i64 %[[J1]])
...
define internal void @get_hygro_rad_props_(i32* noalias nocapture readonly dereferenceable(4) %0, %"QNCA_a0$float*$rank2$"* noalias nocapture readonly dereferenceable(96) "assumed_shape" "ptrnoalias" %1, float* noalias nocapture readnone dereferenceable(4) %2, float* noalias readonly dereferenceable(4) %3) #4 {
  ...
  %12 = call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* elementtype(i64) nonnull %9, i32 1)
  %13 = load i64, i64* %12, align 1
  br label %14

14:                                               ; preds = %37, %4
  %15 = phi i64 [ %38, %37 ], [ 1, %4 ]
  %16 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 %13, float* elementtype(float) %7, i64 %15)
  %17 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 2, i64 1, i64 416, float* elementtype(float) nonnull getelementptr inbounds ([19 x [26 x [4 x float]]], [19 x [26 x [4 x float]]]* @"main_$TAU", i64 0, i64 0, i64 0, i64 0), i64 %15)
  br label %18
...
20:                                               ; preds = %20, %18
  ...
  %22 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 16, i32* elementtype(i32) nonnull getelementptr inbounds ([26 x [4 x i32]], [26 x [4 x i32]]* @"main_$KRH", i64 0, i64 0, i64 0), i64 %21)
  %23 = call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* elementtype(i32) nonnull %22, i64 %19)
  %24 = load i32, i32* %23, align 1
  %25 = add nsw i32 %24, 1
  %26 = sext i32 %25 to i64
  %27 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 %11, float* elementtype(float) %16, i64 %26)
  %28 = load float, float* %27, align 1
  %29 = fadd reassoc ninf nsz arcp contract afn float %28, %28
  %30 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 1, i64 16, float* elementtype(float) nonnull %17, i64 %21)
  %31 = call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 1, i64 4, float* elementtype(float) nonnull %30, i64 %19)

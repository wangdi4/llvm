...
entry:
  %0 = load i32*, i32** @PTR
  %1 = tail call i32* @llvm.ptr.annotation.p0i32(i32* %0, i8* getelementptr ([15 x i8], [15 x i8]* @0, i64 0, i64 0), i8* getelementptr ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i32 4)
...
entry:
  ...
  %0 = tail call i32* @llvm.ptr.annotation.p0i32(i32* %call, i8* getelementptr ([16 x i8], [16 x i8]* @1, i64 0, i64 0), i8* getelementptr ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i32 8)
  ret i32* %0
}

; REQUIRES: asserts
; RUN: opt -whole-program-assume -intel-libirc-allowed -disable-output -padded-pointer-info -passes="padded-pointer-prop-op" < %s 2>&1 | FileCheck %s
...
entry:
  %i = tail call ptr @llvm.ptr.annotation.p0.p0(ptr %p, ptr getelementptr inbounds ([15 x i8], ptr @0, i64 0, i64 0), ptr getelementptr inbounds ([9 x i8], ptr @.str, i64 0, i64 0), i32 2, ptr null)
  %i1 = tail call ptr @llvm.ptr.annotation.p0.p0(ptr %p, ptr getelementptr inbounds ([15 x i8], ptr @1, i64 0, i64 0), ptr getelementptr inbounds ([9 x i8], ptr @.str, i64 0, i64 0), i32 3, ptr null)
  %i2 = tail call ptr @llvm.ptr.annotation.p0.p0(ptr %p, ptr getelementptr inbounds ([15 x i8], ptr @2, i64 0, i64 0), ptr getelementptr inbounds ([9 x i8], ptr @.str, i64 0, i64 0), i32 4, ptr null)

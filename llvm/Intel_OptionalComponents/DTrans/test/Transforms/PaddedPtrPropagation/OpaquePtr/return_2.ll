...
define internal "intel_dtrans_func_index"="1" ptr @foo(ptr "intel_dtrans_func_index"="2" %p, i32 %i) #1 !intel.dtrans.func.type !6 {
entry:
...
sw.bb:                                            ; preds = %entry
  %i1 = tail call ptr @llvm.ptr.annotation.p0(ptr %p, ptr getelementptr inbounds ([15 x i8], ptr @2, i64 0, i64 0), ptr getelementptr inbounds ([18 x i8], ptr @.str, i64 0, i64 0), i32 8, ptr null)
  ret ptr %i1

sw.bb1:                                           ; preds = %entry
  %i2 = tail call ptr @llvm.ptr.annotation.p0(ptr %p, ptr getelementptr inbounds ([15 x i8], ptr @1, i64 0, i64 0), ptr getelementptr inbounds ([18 x i8], ptr @.str, i64 0, i64 0), i32 6, ptr null)
  ret ptr %i2

sw.bb2:                                           ; preds = %entry
  %i3 = tail call ptr @llvm.ptr.annotation.p0(ptr %p, ptr getelementptr inbounds ([15 x i8], ptr @0, i64 0, i64 0), ptr getelementptr inbounds ([18 x i8], ptr @.str, i64 0, i64 0), i32 4, ptr null)
  ret ptr %i3

sw.bb3:                                           ; preds = %entry
  %i4 = tail call ptr @llvm.ptr.annotation.p0(ptr %p, ptr getelementptr inbounds ([15 x i8], ptr @3, i64 0, i64 0), ptr getelementptr inbounds ([18 x i8], ptr @.str, i64 0, i64 0), i32 10, ptr null)
  ret ptr %i4

sw.epilog:                                        ; preds = %entry
  %i5 = tail call ptr @llvm.ptr.annotation.p0(ptr %p, ptr getelementptr inbounds ([15 x i8], ptr @4, i64 0, i64 0), ptr getelementptr inbounds ([18 x i8], ptr @.str, i64 0, i64 0), i32 12, ptr null)
  ret ptr %i5
}

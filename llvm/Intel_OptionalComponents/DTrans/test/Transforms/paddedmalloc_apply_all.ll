...
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -dtransanalysis -padded-pointer-prop -dtrans-paddedmalloc -debug-only=dtrans-paddedmalloc -disable-output 2>&1 | FileCheck %s

; This is same as soatoaos03-cctor3.ll except IR in "dummyAlloc"
...
entry:
  ...
  %g10 = getelementptr %"class.std::bad_alloc", %"class.std::bad_alloc"* %a, i64 0, i32 0
  %g11 = getelementptr inbounds %"class.std::exception", %"class.std::exception"* %g10, i64 0, i32 1
  %bc0 = bitcast %struct.__std_exception_data* %g11 to i8*
  %g12 = getelementptr inbounds i8, i8* %bc0, i64 8
  %bc1 = bitcast i8* %g12 to i64*

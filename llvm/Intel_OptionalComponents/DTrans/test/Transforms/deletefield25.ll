...
; RUN: opt -whole-program-assume -intel-libirc-allowed -internalize -dtrans-identify-unused-values=false  -dtrans-deletefield -S -o - %s | FileCheck %s
; RUN: opt -whole-program-assume -intel-libirc-allowed -dtrans-identify-unused-values=false -passes='internalize,dtrans-deletefield' -S -o - %s | FileCheck %s

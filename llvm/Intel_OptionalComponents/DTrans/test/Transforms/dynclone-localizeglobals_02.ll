...
; do not reference @opt, and that @myglobal does not get cloned becuase it
; doesn't appear in cloned functions.
...
; CHECK-NOT: @myglobal.[[S1:[0-9]+]] = dso_local local_unnamed_addr global i64 0, align 8

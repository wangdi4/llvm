...
; CHECK: define internal void @proc4(i64 %cost, %struct.test.01* %tp4)

; inc = cost + 1;
; field_1 = cost;
define void @proc4(i64 %cost, %struct.test.01* %tp4) {
...
; CHECK: define internal void @proc3(i64 %cost, %struct.test.01* %tp4)

; REQUIRES: asserts
; RUN: opt < %s -disable-output -dtrans-transpose -debug-only=dopevector-analysis 2>&1 | FileCheck %s
...
; CHECK: [BEFORE] DUMPING NESTED DOPE VECTORS: BEGIN
; CHECK-DAG: FIELD[0] [[L0:0x[0-9a-f]+]] IN MAIN__
; CHECK-DAG: FIELD[2] [[L1:0x[0-9a-f]+]] IN MAIN__
; CHECK-DAG: FIELD[0] [[L2:0x[0-9a-f]+]] IN initfield1_
; CHECK-DAG: FIELD[2] [[L2]] IN initfield1_
; CHECK-DAG: FIELD[0] [[L3:0x[0-9a-f]+]] IN initfield0_
; CHECK-DAG: FIELD[2] [[L3]] IN initfield0_
; CHECK: [BEFORE] DUMPING NESTED DOPE VECTORS: END

; CHECK: [AFTER] DUMPING NESTED DOPE VECTORS: BEGIN
; CHECK-DAG: FIELD[0] 0x0
; CHECK-DAG: FIELD[2] 0x0
; CHECK: [AFTER] DUMPING NESTED DOPE VECTORS: END
...
define internal void @initfield0_(%"PHYSPROPMOD$.btPHYSPROP_TYPE"* noalias nocapture dereferenceable(200) %0) #0 {
  ...
  %10 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %9, i32 0)
  store i64 1, i64* %10, align 1
  %11 = getelementptr inbounds { i64, i64, i64 }, { i64, i64, i64 }* %8, i64 0, i32 0
  %12 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %11, i32 0)
  store i64 19, i64* %12, align 1
  %13 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %9, i32 1)
  store i64 1, i64* %13, align 1
  %14 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %11, i32 1)
  store i64 1000, i64* %14, align 1
  %15 = getelementptr inbounds { i64, i64, i64 }, { i64, i64, i64 }* %8, i64 0, i32 1
  %16 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %15, i32 0)
  store i64 4, i64* %16, align 1
  %17 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %15, i32 1)
  ...
  %31 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %27, i32 1)
  ...
  %34 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %33, i32 0)
  store i64 4, i64* %34, align 1
  %35 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %33, i32 1)
...
5:                                                ; preds = %5, %2
  %6 = phi i64 [ %9, %5 ], [ 1, %2 ]
  %7 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 76, i32* getelementptr inbounds ([1000 x [19 x i32]], [1000 x [19 x i32]]* @"main_$MYK", i64 0, i64 0, i64 0), i64 %6)
  %8 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* %7, i64 %3)
...
14:                                               ; preds = %11
  ...
  %15 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* getelementptr inbounds (%"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$", %"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$"* @physpropmod_mp_physprop_, i64 0, i32 6, i64 0, i32 2), i32 0)
  store i64 1, i64* %15, align 1
  %16 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* getelementptr inbounds (%"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$", %"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$"* @physpropmod_mp_physprop_, i64 0, i32 6, i64 0, i32 0), i32 0)
  store i64 100, i64* %16, align 1
  %17 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* getelementptr inbounds (%"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$", %"QNCA_a0$%\22PHYSPROPMOD$.btPHYSPROP_TYPE\22*$rank1$"* @physpropmod_mp_physprop_, i64 0, i32 6, i64 0, i32 1), i32 0)
...
19:                                               ; preds = %19, %14
  ...
  %24 = tail call %"PHYSPROPMOD$.btPHYSPROP_TYPE"* @"llvm.intel.subscript.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64.i64.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64"(i8 0, i64 %23, i64 %22, %"PHYSPROPMOD$.btPHYSPROP_TYPE"* %21, i64 %20)
  ...
  %28 = tail call %"PHYSPROPMOD$.btPHYSPROP_TYPE"* @"llvm.intel.subscript.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64.i64.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64"(i8 0, i64 %27, i64 %26, %"PHYSPROPMOD$.btPHYSPROP_TYPE"* %25, i64 %20)
...
33:                                               ; preds = %91, %31
  ...
  %36 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 1, i64 1, i64 76, i32* getelementptr inbounds ([1000 x [19 x i32]], [1000 x [19 x i32]]* @"main_$MYK", i64 0, i64 0, i64 0), i64 %34)
  br label %37
...
37:                                               ; preds = %37, %33
  ...
  %45 = tail call %"PHYSPROPMOD$.btPHYSPROP_TYPE"* @"llvm.intel.subscript.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64.i64.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64"(i8 0, i64 %44, i64 %43, %"PHYSPROPMOD$.btPHYSPROP_TYPE"* %42, i64 101)
  ...
  %54 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %53, i32 0)
  %55 = load i64, i64* %54, align 1
  %56 = tail call i32* @llvm.intel.subscript.p0i32.i64.i64.p0i32.i64(i8 0, i64 1, i64 4, i32* %36, i64 %38)
  %57 = load i32, i32* %56, align 1
  %58 = add nsw i32 %57, 1
  %59 = sext i32 %58 to i64
  %60 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %50, i32 1)
  %61 = load i64, i64* %60, align 1
  %62 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %53, i32 1)
  %63 = load i64, i64* %62, align 1
  %64 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 %63, i64 %61, float* %48, i64 %34)
  %65 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 %55, i64 %52, float* %64, i64 %59)
  ...
  %69 = tail call %"PHYSPROPMOD$.btPHYSPROP_TYPE"* @"llvm.intel.subscript.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64.i64.p0s_PHYSPROPMOD$.btPHYSPROP_TYPEs.i64"(i8 0, i64 %68, i64 %67, %"PHYSPROPMOD$.btPHYSPROP_TYPE"* %66, i64 101)
  ...
  %75 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %74, i32 0)
  ...
  %80 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %74, i32 1)
  %81 = load i64, i64* %80, align 1
  %82 = tail call i64* @llvm.intel.subscript.p0i64.i64.i32.p0i64.i32(i8 0, i64 0, i32 24, i64* nonnull %77, i32 1)
  %83 = load i64, i64* %82, align 1
  %84 = load i32, i32* %56, align 1
  %85 = add nsw i32 %84, -1
  %86 = sext i32 %85 to i64
  %87 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 1, i64 %83, i64 %81, float* %72, i64 %86)
  %88 = tail call float* @llvm.intel.subscript.p0f32.i64.i64.p0f32.i64(i8 0, i64 %79, i64 %76, float* %87, i64 %34)

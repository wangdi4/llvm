; This test is same as memmanage-functionality-01.ll except for the following
; main changes.
;
;  commitAllocation: IR is completely optimized. PopFront and PushBack
;  functionalities are merged in to single basicblock.
;
;  destroyObject:
;       1. Successor of bb214 is changed from bb252 to bb502.
;       2. Conditional branch at the end of bb283 is moved to bb279 and bb258.
;
;  Reset:
...
source_filename = "memmanage-functionality-06.ll"
...
define internal void @_ZN11xalanc_1_1014ArenaAllocatorINS_13XStringCachedENS_18ReusableArenaBlockIS1_tEEED2Ev(%ArenaAllocator* nocapture nonnull dereferenceable(40) %arg) unnamed_addr align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
bb:
...
bb26:                                             ; preds = %bb15
  %i27 = invoke i8* bitcast (i8* (%MemoryManagerImpl*, i64)* @_ZN11xercesc_2_717MemoryManagerImpl8allocateEm to i8* (%MemoryManager*, i64)*)(%MemoryManager* nonnull dereferenceable(8) %i16, i64 24)
          to label %bb30 unwind label %bb58
...
bb53:                                             ; preds = %bb39
  invoke void bitcast (void (%MemoryManagerImpl*, i8*)* @_ZN11xercesc_2_717MemoryManagerImpl10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i42, i8* nonnull %i47)
          to label %bb55 unwind label %bb60
...
bb58:                                             ; preds = %bb28, %bb26
  %i59 = landingpad { i8*, i32 }
          catch i8* null
  br label %bb102

bb60:                                             ; preds = %bb54, %bb53
...
bb82:                                             ; preds = %bb71
  invoke void bitcast (void (%MemoryManagerImpl*, i8*)* @_ZN11xercesc_2_717MemoryManagerImpl10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i68, i8* nonnull %i76)
          to label %bb84 unwind label %bb85
...
bb85:                                             ; preds = %bb83, %bb82
  %i86 = landingpad { i8*, i32 }
          catch i8* null
  br label %bb102
...
bb97:                                             ; preds = %bb87
  invoke void bitcast (void (%MemoryManagerImpl*, i8*)* @_ZN11xercesc_2_717MemoryManagerImpl10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i68, i8* %i89)
          to label %bb99 unwind label %bb100
...
bb100:                                            ; preds = %bb98, %bb97
  %i101 = landingpad { i8*, i32 }
          catch i8* null
  br label %bb102

bb102:                                            ; preds = %bb100, %bb85, %bb60, %bb58
  %i103 = phi { i8*, i32 } [ %i61, %bb60 ], [ %i59, %bb58 ], [ %i86, %bb85 ], [ %i101, %bb100 ]
  %i104 = extractvalue { i8*, i32 } %i103, 0
  tail call void @__clang_call_terminate(i8* %i104)
  unreachable
...
bb131:                                            ; preds = %bb120
  %i132 = invoke i8* bitcast (i8* (%MemoryManagerImpl*, i64)* @_ZN11xercesc_2_717MemoryManagerImpl8allocateEm to i8* (%MemoryManager*, i64)*)(%MemoryManager* nonnull dereferenceable(8) %i121, i64 24)
          to label %bb135 unwind label %bb163

bb133:                                            ; preds = %bb120
  %i134 = invoke i8* bitcast (i8* (%DummyMemoryManager*, i64)* @_ZN11xalanc_1_1023XalanDummyMemoryManager8allocateEm to i8* (%MemoryManager*, i64)*)(%MemoryManager* nonnull dereferenceable(8) %i121, i64 24)
          to label %bb135 unwind label %bb163
...
bb158:                                            ; preds = %bb144
  invoke void bitcast (void (%MemoryManagerImpl*, i8*)* @_ZN11xercesc_2_717MemoryManagerImpl10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i147, i8* nonnull %i152)
          to label %bb160 unwind label %bb165

bb159:                                            ; preds = %bb144
  invoke void bitcast (void (%DummyMemoryManager*, i8*)* @_ZN11xalanc_1_1023XalanDummyMemoryManager10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i147, i8* nonnull %i152)
          to label %bb160 unwind label %bb165
...
bb163:                                            ; preds = %bb133, %bb131
  %i164 = landingpad { i8*, i32 }
          catch i8* null
  br label %bb207

bb165:                                            ; preds = %bb159, %bb158
  %i166 = landingpad { i8*, i32 }
          catch i8* null
  br label %bb207
...
bb187:                                            ; preds = %bb176
  invoke void bitcast (void (%MemoryManagerImpl*, i8*)* @_ZN11xercesc_2_717MemoryManagerImpl10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i173, i8* nonnull %i181)
          to label %bb189 unwind label %bb190

bb188:                                            ; preds = %bb176
  invoke void bitcast (void (%DummyMemoryManager*, i8*)* @_ZN11xalanc_1_1023XalanDummyMemoryManager10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i173, i8* nonnull %i181)
          to label %bb189 unwind label %bb190

bb189:                                            ; preds = %bb188, %bb187
  br label %bb170

bb190:                                            ; preds = %bb188, %bb187
  %i191 = landingpad { i8*, i32 }
          catch i8* null
  br label %bb207
...
bb202:                                            ; preds = %bb192
  invoke void bitcast (void (%MemoryManagerImpl*, i8*)* @_ZN11xercesc_2_717MemoryManagerImpl10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i173, i8* %i194)
          to label %bb204 unwind label %bb205

bb203:                                            ; preds = %bb192
  invoke void bitcast (void (%DummyMemoryManager*, i8*)* @_ZN11xalanc_1_1023XalanDummyMemoryManager10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i173, i8* %i194)
          to label %bb204 unwind label %bb205

bb204:                                            ; preds = %bb203, %bb202
  br label %bb210

bb205:                                            ; preds = %bb203, %bb202
  %i206 = landingpad { i8*, i32 }
          catch i8* null
  br label %bb207

bb207:                                            ; preds = %bb205, %bb190, %bb165, %bb163
  %i208 = phi { i8*, i32 } [ %i166, %bb165 ], [ %i164, %bb163 ], [ %i191, %bb190 ], [ %i206, %bb205 ]
  %i209 = extractvalue { i8*, i32 } %i208, 0
  tail call void @__clang_call_terminate(i8* %i209)
  unreachable

bb210:                                            ; preds = %bb204, %bb106
  %i211 = extractvalue { i8*, i32 } %i107, 0
  tail call void @__clang_call_terminate(i8* %i211)
  unreachable
}
...
define internal void @_ZN11xalanc_1_1014ArenaAllocatorINS_13XStringCachedENS_18ReusableArenaBlockIS1_tEEE5resetEv(%ArenaAllocator* nocapture nonnull dereferenceable(40) %arg) unnamed_addr align 2 personality i32 (...)* @__gxx_personality_v0 {
bb:
  %i = getelementptr inbounds %ArenaAllocator, %ArenaAllocator* %arg, i64 0, i32 2
...
bb74:                                             ; preds = %bb72, %bb71
  %i75 = landingpad { i8*, i32 }
          catch i8* null
  %i76 = extractvalue { i8*, i32 } %i75, 0
  tail call void @__clang_call_terminate(i8* %i76)
  unreachable
...
define internal %XStringCached* @_ZN11xalanc_1_1022ReusableArenaAllocatorINS_13XStringCachedEE13allocateBlockEv(%ReusableArenaAllocator* nocapture nonnull dereferenceable(41) %arg) unnamed_addr align 2 personality i32 (...)* @__gxx_personality_v0 {
bb:
  %i = getelementptr inbounds %ReusableArenaAllocator, %ReusableArenaAllocator* %arg, i64 0, i32 0
...
bb110:                                            ; preds = %bb99
  invoke void bitcast (void (%MemoryManagerImpl*, i8*)* @_ZN11xercesc_2_717MemoryManagerImpl10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i40, i8* nonnull %i57)
          to label %bb112 unwind label %bb113

bb111:                                            ; preds = %bb99
  invoke void bitcast (void (%DummyMemoryManager*, i8*)* @_ZN11xalanc_1_1023XalanDummyMemoryManager10deallocateEPv to void (%MemoryManager*, i8*)*)(%MemoryManager* nonnull dereferenceable(8) %i40, i8* nonnull %i57)
          to label %bb112 unwind label %bb113
...
bb113:                                            ; preds = %bb111, %bb110
  %i114 = landingpad { i8*, i32 }
          catch i8* null
  %i115 = extractvalue { i8*, i32 } %i114, 0
  tail call void @__clang_call_terminate(i8* %i115)
  unreachable
...
bb:
  ...
  tail call void @_ZN11xalanc_1_1022ReusableArenaAllocatorINS_13XStringCachedEEC2ERN11xercesc_2_713MemoryManagerEtb(%ReusableArenaAllocator* nonnull dereferenceable(41) %i, %MemoryManager* nonnull align 8 dereferenceable(8) %arg1, i16 zeroext %arg2, i1 zeroext false)
  ret void
}
...
define internal noalias nonnull i8* @_ZN11xercesc_2_717MemoryManagerImpl8allocateEm(%MemoryManagerImpl* nocapture nonnull readnone dereferenceable(8) %arg, i64 %arg1) unnamed_addr align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
bb:
  %i = invoke noalias nonnull i8* @_Znwm(i64 %arg1)
...
bb2:                                              ; preds = %bb
  ...
  %i5 = tail call i8* @__cxa_begin_catch(i8* %i4)
  %i6 = tail call i8* @__cxa_allocate_exception(i64 1)
  invoke void @__cxa_throw(i8* nonnull %i6, i8* null, i8* null)
...
bb11:                                             ; preds = %bb7
  %i12 = landingpad { i8*, i32 }
          catch i8* null
  %i13 = extractvalue { i8*, i32 } %i12, 0
  tail call void @__clang_call_terminate(i8* %i13)
  unreachable
...
bb:
  tail call void @_ZdlPv(i8* %arg1)
  ret void
}

define internal noalias nonnull i8* @_ZN11xalanc_1_1023XalanDummyMemoryManager8allocateEm(%DummyMemoryManager* nocapture nonnull readnone dereferenceable(8) %arg, i64 %arg1) unnamed_addr align 2 {
bb:
  %i = tail call i8* @__cxa_allocate_exception(i64 8)
  %i2 = bitcast i8* %i to %"class.std::bad_alloc"*
  %i3 = getelementptr inbounds %"class.std::bad_alloc", %"class.std::bad_alloc"* %i2, i64 0, i32 0, i32 0
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [5 x i8*] }, { [5 x i8*] }* null, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %i3, align 8
  tail call void @__cxa_throw(i8* nonnull %i, i8* null, i8* null)
  unreachable
}

define internal void @_ZN11xalanc_1_1023XalanDummyMemoryManager10deallocateEPv(%DummyMemoryManager* nocapture nonnull readnone dereferenceable(8) %arg, i8* nocapture readnone %arg1) unnamed_addr align 2 {
bb:
  %i = tail call i8* @__cxa_allocate_exception(i64 8)
  %i2 = bitcast i8* %i to %"class.std::bad_alloc"*
  %i3 = getelementptr inbounds %"class.std::bad_alloc", %"class.std::bad_alloc"* %i2, i64 0, i32 0, i32 0

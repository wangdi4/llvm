; (CMPLRLLVM-11086) This test verifies that SOAToAOSPrepare transformation
; is triggered. This test is same as soatoaos_prepare_trans_01.ll except
; IR is different for _ZN7BaseArrIPsE6resizeEi. 2nd (size) argument for
...
; Make sure transformation is triggered.
...
; Make sure peephole "transform 2" is done by converting
; from "shl, shl, sub" to "sub, shl".
; CHECK:  [[SUB1:%[0-9]*]] = sub i32 %spec.select, %0
; CHECK:  [[SHL1:%[0-9]*]] = shl i32 [[SUB1]], 3
; CHECK:   call void @llvm.memset.p0i8.i32(i8* align 4 %scevgep, i8 0, i32 [[SHL1]], i1 false)
...
if.end:                                           ; preds = %entry
  ...
  %cmp1343 = icmp eq i32 %0, 0
  br i1 %cmp1343, label %for.cond16.preheader, label %for.body.lr.ph
...
for.cond16.preheader:                             ; preds = %for.body, %if.end
  %cmp1741 = icmp ult i32 %0, %spec.select
  br i1 %cmp1741, label %for.body18.preheader, label %for.end22

for.body18.preheader:                             ; preds = %for.cond16.preheader
  %4 = shl i32 %0, 3
  %scevgep = getelementptr i8, i8* %call, i32 %4
  %5 = shl i32 %spec.select, 3
  %6 = sub i32 %5, %4
  call void @llvm.memset.p0i8.i32(i8* align 4 %scevgep, i8 0, i32 %6, i1 false)
  br label %for.end22

for.body:                                         ; preds = %for.body, %for.body.lr.ph
  %index.044 = phi i32 [ 0, %for.body.lr.ph ], [ %inc15, %for.body ]
  %arrayidx = getelementptr inbounds i16**, i16*** %3, i32 %index.044
  %7 = bitcast i16*** %arrayidx to i64*
  %8 = load i64, i64* %7
  %arrayidx14 = getelementptr inbounds i16**, i16*** %2, i32 %index.044
  %9 = bitcast i16*** %arrayidx14 to i64*
  store i64 %8, i64* %9
  %inc15 = add nuw i32 %index.044, 1
  %exitcond = icmp eq i32 %inc15, %0
  br i1 %exitcond, label %for.cond16.preheader, label %for.body

for.end22:                                        ; preds = %for.body18.preheader, %for.cond16.preheader
  %base23 = getelementptr inbounds %struct.BaseArr, %struct.BaseArr* %this, i64 0, i32 4
  %10 = bitcast i16**** %base23 to i8**
  %11 = load i8*, i8** %10

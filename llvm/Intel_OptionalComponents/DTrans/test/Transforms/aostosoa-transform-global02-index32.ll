...
; This tests the nullptr case.

target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
%struct.test01 = type { i64, i64 }
%struct.test01dep = type { i32, %struct.test01* }

@g_test01depptr = internal unnamed_addr global %struct.test01dep { i32 5, %struct.test01* null }
; CHECK: @g_test01depptr = internal unnamed_addr global %__SOADT_struct.test01dep  { i32 5, i32 0 }

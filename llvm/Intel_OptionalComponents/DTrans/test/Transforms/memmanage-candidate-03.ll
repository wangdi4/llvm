...
; RUN: opt < %s -S -passes='lto-pre-link<O3>' -enable-npm-dtrans -dtrans-inline-heuristics -intel-libirc-allowed -inline-for-xmain -inline-report=0xe807 2>&1 | FileCheck %s

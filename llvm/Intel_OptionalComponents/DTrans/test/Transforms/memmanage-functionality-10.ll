...
;
; This is the same test as memmanage-functionality-01.ll, except the order of
...
; This version of the test loads XalanList->Node prior to loading Node->Prev.
  %243 = getelementptr inbounds %XalanList, %XalanList* %4, i64 0, i32 2
  %244 = load %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"*, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %243, align 8
  %245 = getelementptr inbounds %"XalanList<ReusableArenaBlock<XStringCached> *>::Node", %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %222, i64 0, i32 1
  %246 = load %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"*, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %245, align 8
  %247 = getelementptr inbounds %"XalanList<ReusableArenaBlock<XStringCached> *>::Node", %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %246, i64 0, i32 2
  ...
  store %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %246, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %249, align 8
  store %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* null, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %245, align 8
  store %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %244, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %231, align 8
  store %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %222, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %243, align 8
  br label %254
...
; identifyFreeNode will handle this block.
; This version of the test loads XalanList->Node prior to loading Node->Prev.
  %497 = getelementptr inbounds %XalanList, %XalanList* %4, i64 0, i32 2
  %498 = load %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"*, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %497, align 8
  %499 = getelementptr inbounds %"XalanList<ReusableArenaBlock<XStringCached> *>::Node", %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %476, i64 0, i32 1
  %500 = load %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"*, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %499, align 8
  %501 = getelementptr inbounds %"XalanList<ReusableArenaBlock<XStringCached> *>::Node", %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %500, i64 0, i32 2
  ...
  store %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %500, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %503, align 8
  store %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* null, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %499, align 8
  store %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %498, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %485, align 8
  store %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"* %476, %"XalanList<ReusableArenaBlock<XStringCached> *>::Node"** %497, align 8
  br label %504

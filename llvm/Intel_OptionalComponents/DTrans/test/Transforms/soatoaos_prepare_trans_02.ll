...
; CHECK: define internal fastcc void @_ZN1FC2ERKS_{{.*}}(%_DPRE_class.F* %0, %_DPRE_class.F* %1)
...
; CHECK: tail call void @_ZN7BaseArrIPsE3addEPS0_{{.*}}{{.*}}(%_DPRE__REP_struct.RefArr* nocapture %12, i16*** %0)
...
; CHECK: define void @_ZN7BaseArrIPsEC2EjbP3Mem{{.*}}{{.*}}{{.*}}{{.*}}(%_DPRE__REP_struct.RefArr* nocapture %0, %_DPRE__REP_struct.RefArr* %1)

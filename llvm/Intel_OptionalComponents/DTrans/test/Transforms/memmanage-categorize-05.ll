; This test verifies that categorization fails to distinguish between
; the functions below:
...
; CHECK-DAG: _ZN11xalanc_1_1014ArenaAllocatorINS_13XStringCachedENS_18ReusableArenaBlockIS1_tEEE5resetEv: Destructor
; CHECK: Failed: Multiple functionality

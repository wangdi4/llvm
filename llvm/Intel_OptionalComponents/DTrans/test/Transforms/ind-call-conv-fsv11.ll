...
; RUN: opt  -whole-program-assume -intel-libirc-allowed -intel-ind-call-force-dtrans -dtransanalysis -indirectcallconv -intel-ind-call-conv-max-target=3 < %s -S 2>&1 | FileCheck %s

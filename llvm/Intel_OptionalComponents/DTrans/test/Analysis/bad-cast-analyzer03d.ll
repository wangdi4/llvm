...
; This test case tests the bad cast analyzer on a case which does not have the
; candidate field as the first field of the potential candidate root type
; (i.e. mynextcoder). It should give up with a safety violation.

target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.mynextcoder = type { i32, i8*, void (i8*)*, void (i8*)* }
...
define internal fastcc void @init_with_coder1(%struct.mynextcoder* nocapture) unnamed_addr {
  %t2 = getelementptr inbounds %struct.mynextcoder, %struct.mynextcoder* %0, i64 0, i32 1
...
t5:                                      ; preds = %t1
  ...
  %t9 = getelementptr inbounds %struct.mynextcoder, %struct.mynextcoder* %0, i64 0, i32 2
  store void (i8*)* @coder1_startup, void (i8*)** %t9, align 8
  %t10 = getelementptr inbounds %struct.mynextcoder, %struct.mynextcoder* %0, i64 0, i32 3
...
define internal void @myoperation(%struct.mynextcoder* nocapture readonly) {
  %2 = getelementptr inbounds %struct.mynextcoder, %struct.mynextcoder* %0, i64 0, i32 2
  %3 = load void (i8*)*, void (i8*)** %2, align 8
  %4 = getelementptr inbounds %struct.mynextcoder, %struct.mynextcoder* %0, i64 0, i32 1
  %5 = load i8*, i8** %4, align 8
  tail call void %3(i8* %5) #4
  %6 = getelementptr inbounds %struct.mynextcoder, %struct.mynextcoder* %0, i64 0, i32 3
...
define dso_local i32 @main() {
  store i8* null, i8** getelementptr inbounds (%struct.mynextcoder, %struct.mynextcoder* @localnextcoder1, i64 0, i32 1), align 8
  ...
  store void (i8*)* null, void (i8*)** getelementptr inbounds (%struct.mynextcoder, %struct.mynextcoder* @localnextcoder1, i64 0, i32 3), align 8
  store i8* null, i8** getelementptr inbounds (%struct.mynextcoder, %struct.mynextcoder* @localnextcoder2, i64 0, i32 1), align 8
  ...
  store void (i8*)* null, void (i8*)** getelementptr inbounds (%struct.mynextcoder, %struct.mynextcoder* @localnextcoder2, i64 0, i32 3), align 8

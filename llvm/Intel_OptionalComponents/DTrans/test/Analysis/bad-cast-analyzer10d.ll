...
; to the candidate field is bit cast and then used by a non-GEP instruction.
; It should fail with a safety violation and retain the Bad casting and
...
t11:                                     ; preds = %t5, %t1
  ...
  %t15 = ptrtoint %struct.mycoder1* %t12 to i64
...
; CHECK: dtrans-bca: (SV) [0] Non-GEP bitcast target:  %t15 = ptrtoint %struct.mycoder1* %t12 to i64
; CHECK: dtrans-bca: Bad casting (pending) -- unknown pointer cast to type of interest:

...
; which is bitcast to an inconsistent pointer type.  It should fail with a
...
; CHECK: dtrans-bca: (SF) [1] Store type != fxn ptr arg type:
; CHECK: Store Type: %struct.mycoder1*
; CHECK: Fxn ptr arg Type: %struct.mycoder2*
; CHECK: dtrans-bca: Bad casting (pending) -- unknown pointer cast to type of interest:

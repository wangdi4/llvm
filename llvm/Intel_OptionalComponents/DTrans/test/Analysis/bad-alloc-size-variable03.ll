...
; This test checks that "bad alloc size" is set for the types because the
; division is not guarded with the icmpr that checks the limits. This is the
; same test case as bad-ptr-manupulation-related-types03.ll but it checks
; for "bad alloc size".
...
bb:
  ...
  %tmp11 = invoke noalias nonnull i8* @_Znwm(i64 %tmp9)
            to label %bb2 unwind label %lpad

bb2:
  %tmp12 = bitcast i8* %tmp11 to %class.OuterClass*

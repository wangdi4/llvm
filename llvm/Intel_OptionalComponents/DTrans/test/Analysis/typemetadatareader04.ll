...
; CHECK: ERROR: Metadata type does not match expected type:   %local = alloca %struct.test01*
; CHECK: IR: %struct.test01*
; CHECK: MD: %struct.test02*
...
; CHECK: Checking function for DTrans metadata: test04
; CHECK: ERROR: Metadata type does not match expected type:   %res = call

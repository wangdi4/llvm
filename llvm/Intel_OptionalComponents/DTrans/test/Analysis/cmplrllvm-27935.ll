...
; RUN: opt -disable-output -whole-program-assume -intel-libirc-allowed -dtransanalysis -dtrans-outofboundsok=false -dtrans-usecrulecompat=true -dtrans-print-types %s 2>&1 | FileCheck %s

...
; Check a case with a memcpy. It should not invalidate Singe Value.
...
define i32 @main() {
entry:
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast (%struct.MYSTRUCT* @coxglobalstruct2 to i8*), i8* bitcast (%struct.MYSTRUCT* @coxglobalstruct1 to i8*), i64 8, i32 4, i1 false)
  ret i32 0
}

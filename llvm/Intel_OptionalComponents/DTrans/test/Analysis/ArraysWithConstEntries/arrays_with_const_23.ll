...
; for arrays with constant integers since we are using memcpy with
; an array of integers.

; NOTE: This is a conservative case and we may want to expand it in
; the future.
...
define void @copydata([4 x i32]* %0, [4 x i32]* %1) {
  %tmp0 = bitcast [4 x i32]* %0 to i8*
  %tmp1 = bitcast [4 x i32]* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 dereferenceable(32) %tmp1, i8* nonnull align 8 dereferenceable(32) %tmp0, i64 32, i1 false)
  ret void
}

declare void @llvm.memcpy.p0i8.p0i8.i64(i8*, i8*, i64, i1)

; CHECK: Disabling collection for arrays with constant entries
; CHECK:   Reason: memfunc operating over an array
; CHECK:   Instruction:   call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 8 dereferenceable(32) %tmp1, i8* nonnull align 8 dereferenceable(32) %tmp0, i64 32, i1 false)
; CHECK:   Function: copydata

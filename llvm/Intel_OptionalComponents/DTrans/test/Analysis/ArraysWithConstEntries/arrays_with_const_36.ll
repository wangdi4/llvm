...
; work since %class.TestClass is passed to a function declaration.
...
declare void @cas(%class.TestClass* %0)

define void @baz(%class.TestClass* %0) {
  call void @cas(%class.TestClass* %0)
  ret void
}
...
; CHECK: Analyzing fields that are arrays with constant entries (verbose print)

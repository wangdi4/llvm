...
; In this case we are checking that memcpy, memmove and memset doesn't
...
define void @copydata(%class.TestClass* %0, %class.TestClass* %1) {
  %tmp0 = bitcast %class.TestClass* %0 to i8*
  %tmp1 = bitcast %class.TestClass* %1 to i8*
...
define void @movedata(%class.TestClass* %0, %class.TestClass* %1) {
  %tmp0 = bitcast %class.TestClass* %0 to i8*
  %tmp1 = bitcast %class.TestClass* %1 to i8*
...
define void @setdata(%class.TestClass* %0) {
  %tmp0 = bitcast %class.TestClass* %0 to i8*
  call void @llvm.memset.p0i8.i64(i8* nonnull align 8 dereferenceable(40) %tmp0, i8 0, i64 40, i1 false)
  ret void
}

...
; for arrays with constant integers since we are using memmove with two
; different types.
...
define void @movedata(%class.TestClass* %0, %class.TestClass2* %1) {
  %tmp0 = bitcast %class.TestClass* %0 to i8*
  %tmp1 = bitcast %class.TestClass2* %1 to i8*
  call void @llvm.memmove.p0i8.p0i8.i64(i8* nonnull align 8 dereferenceable(40) %tmp1, i8* nonnull align 8 dereferenceable(40) %tmp0, i64 40, i1 false)
  ret void
}

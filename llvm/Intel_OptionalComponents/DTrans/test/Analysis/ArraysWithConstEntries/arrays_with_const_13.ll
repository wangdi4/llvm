...
; is a store to it in @baz. In this case we are checking when the field of
; interest is wrapped in another structure.
...
define void @baz(%class.TestClass* %0) {
  ...
  %tmp2 = bitcast %"class.boost::array"* %tmp1 to i8*
  store i8 8, i8* %tmp2
  ret void
}

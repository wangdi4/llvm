...
; %class.TestClass aren't marked as constants because they are
...
define void @foo(%class.TestClass* %0, i32 %var) {
  ...
  %tmp4 = getelementptr inbounds [4 x i32], [4 x i32]* %tmp1, i64 0, i32 0
  store i32 %var, i32* %tmp4
  %tmp5 = getelementptr inbounds [4 x i32], [4 x i32]* %tmp1, i64 0, i32 1

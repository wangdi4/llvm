...
; access in @baz. This test case is the same as arrays_with_const_39.ll,
; but the GEP instruction in @baz contains 2 indices only.
...
define void @baz(%class.TestClass* %0) {
  %tmp1 = getelementptr inbounds %class.TestClass, %class.TestClass* %0, i64 1, i32 1
  ret void
}

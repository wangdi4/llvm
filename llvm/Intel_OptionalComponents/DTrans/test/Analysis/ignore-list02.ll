...
@b.str = internal unnamed_addr global %struct.str zeroinitializer

%struct.str2 = type { i32, i32 }
...
define i32 @main() {
  ...
  %s = bitcast i8** getelementptr (%struct.mystruct, %struct.mystruct* @globalstruct, i64 0, i32 0) to %struct.str2*
  ret i32 0
}
...
; CHECK-LABEL:  LLVMType: %struct.str = type { i32, i32 }
; CHECK-NEXT:  Name: struct.str

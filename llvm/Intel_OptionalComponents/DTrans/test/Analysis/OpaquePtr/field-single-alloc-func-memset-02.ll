...
; CHECK: LLVMType: %struct._ZTS7test_01.test_01 = type { ptr, ptr }
...
; CHECK: DTRANS_StructInfo:
; CHECK: LLVMType: %struct._ZTS7test_02.test_02 = type { ptr, ptr }
...
%struct._ZTS7test_01.test_01 = type { ptr, ptr }
%struct._ZTS7test_02.test_02 = type { ptr, ptr }
...
entry:
  ...
  %field0 = getelementptr inbounds %struct._ZTS7test_01.test_01, ptr %a, i64 0, i32 0, !intel-tbaa !11
  store ptr %call, ptr %field0, align 8, !tbaa !11
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %a, i8 16, i64 12, i1 false)
  ret void
}
...
entry:
  %call = call align 16 dereferenceable_or_null(100) ptr @malloc(i64 100)
  %field0 = getelementptr inbounds %struct._ZTS7test_02.test_02, ptr %a, i64 0, i32 0, !intel-tbaa !11
  store ptr %call, ptr %field0, align 8, !tbaa !11
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %a, i8 0, i64 12, i1 false)
  ret void
}
...
!5 = !{!"S", %struct._ZTS7test_01.test_01 zeroinitializer, i32 2, !6, !6}
!6 = !{i8 0, i32 1}
!7 = !{!"S", %struct._ZTS7test_02.test_02 zeroinitializer, i32 2, !6, !6}
!8 = !{!"Intel(R) oneAPI DPC++/C++ Compiler 2022.1.0 (2022.x.0.YYYYMMDD)"}
!9 = distinct !{!10}
!10 = !{%struct._ZTS7test_01.test_01 zeroinitializer, i32 1}
!11 = !{!12, !13, i64 0}
!12 = !{!"struct@", !13, i64 0, !13, i64 8}

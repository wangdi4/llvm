...
; The reason is the result from the subtraction in %7 won't be a multiple of
; the expected structure's size that is being allocated (division in %8 is
; not exact to the structure's size).

...
; RUN: opt  < %s -opaque-pointers -whole-program-assume -dtrans-safetyanalyzer -dtrans-print-types -disable-output -dtrans-test-padded-structs-analyzer 2>&1 | FileCheck %s

...
@test_fcp01 = global ptr null, !intel_dtrans_type !3
; CHECK: @test_fcp01 = global ptr null
; CHECK:      Aliased types:
; CHECK:        i32**

@test_fcp02 = global ptr null, !intel_dtrans_type !4
; CHECK: @test_fcp02 = global ptr null
; CHECK:      Aliased types:
; CHECK:        double***
...
@test_arp01 = global ptr null, !intel_dtrans_type !5
; CHECK: @test_arp01 = global ptr null
; CHECK:      Aliased types:
; CHECK:        [64 x i64]**

@test_arp02 = global ptr null, !intel_dtrans_type !7
; CHECK: @test_arp02 = global ptr null
; CHECK:      Aliased types:
; CHECK:        [8 x [12 x [64 x i32]]]**

@test_arp03 = global [2 x [4 x [8 x ptr]]] zeroinitializer, !intel_dtrans_type !11
; CHECK: @test_arp03 = global [2 x [4 x [8 x ptr]]] zeroinitializer
; CHECK:      Aliased types:
; CHECK:        [2 x [4 x [8 x i32*]]]*

@test_arp04 = global [10 x ptr] zeroinitializer, !intel_dtrans_type !14
; CHECK: @test_arp04 = global [10 x ptr] zeroinitializer
; CHECK:      Aliased types:
...
@test_vecp01 = global <2 x ptr> zeroinitializer, !intel_dtrans_type !16
; CHECK: @test_vecp01 = global <2 x ptr> zeroinitializer
; CHECK:      Aliased types:
; CHECK:        <2 x i64*>*
...
@test_stp01 = global ptr null, !intel_dtrans_type !18
; CHECK: @test_stp01 = global ptr null
; CHECK:      Aliased types:
; CHECK:        %struct.type01***

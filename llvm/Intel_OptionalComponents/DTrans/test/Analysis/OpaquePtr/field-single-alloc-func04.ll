...
; Function Attrs: nounwind uwtable
define internal "intel_dtrans_func_index"="1" ptr @lzma_myzalloc(i64 %size) local_unnamed_addr #0 !intel.dtrans.func.type !10 {
entry:
  %call = call align 16 ptr @malloc(i64 %size)
  ret ptr %call
}
...
; Function Attrs: nounwind uwtable
define internal void @lzma_myfree(ptr "intel_dtrans_func_index"="1" %myptr) local_unnamed_addr #0 !intel.dtrans.func.type !11 {
entry:
...
declare !intel.dtrans.func.type !12 dso_local void @free(ptr nocapture noundef "intel_dtrans_func_index"="1") local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define dso_local i32 @main() local_unnamed_addr #0 {
entry:
  %call = call ptr @lzma_mymalloc(i64 100)
  store ptr %call, ptr getelementptr inbounds (%struct._ZTS10testStruct.testStruct, ptr @globalStruct, i64 0, i32 0), align 8, !tbaa !13
  ...
  %call1 = call ptr @lzma_myzalloc(i64 100)
  store ptr %call1, ptr getelementptr inbounds (%struct._ZTS10testStruct.testStruct, ptr @globalStruct, i64 0, i32 0), align 8, !tbaa !13
  call void @lzma_myfree(ptr %call1)
  store ptr null, ptr getelementptr inbounds (%struct._ZTS10testStruct.testStruct, ptr @globalStruct, i64 0, i32 0), align 8, !tbaa !13
  ret i32 0
}

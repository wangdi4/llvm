...
; with constant entries since there is a store for it in @baz.
...
define void @baz(ptr "intel_dtrans_func_index"="1" %ptr, ptr "intel_dtrans_func_index"="2" %arr) !intel.dtrans.func.type !6 {
  %tmp1 = getelementptr inbounds %class.TestClass, ptr %ptr, i64 0, i32 1
  store ptr %arr, ptr %tmp1
  ret void
}

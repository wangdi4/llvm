...
; RUN: opt < %s -dtransop-allow-typed-pointers -whole-program-assume  -dtrans-safetyanalyzer -dtrans-print-types -dtrans-use-block-freq=false -disable-output 2>&1 | FileCheck %s

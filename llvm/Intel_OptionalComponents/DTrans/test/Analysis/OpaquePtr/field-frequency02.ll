...
; RUN: opt < %s -whole-program-assume  -dtrans-safetyanalyzer -dtrans-print-types -dtrans-use-block-freq=false -disable-output 2>&1 | FileCheck %s
; RUN: opt < %s -whole-program-assume  -passes='require<dtrans-safetyanalyzer>' -dtrans-print-types -dtrans-use-block-freq=false -disable-output 2>&1 | FileCheck %s

...
; RUN: opt -opaque-pointers -whole-program-assume -intel-libirc-allowed -passes='require<dtrans-safetyanalyzer>' -debug-only=dtrans-safetyanalyzer-verbose -disable-output %s 2>&1 | FileCheck %s
...
define void @test02(ptr "intel_dtrans_func_index"="1" %pStruct1, ptr "intel_dtrans_func_index"="2" %pStruct2) !intel.dtrans.func.type !6 {
  %t1 = ptrtoint ptr %pStruct1 to i64
  %t2 = ptrtoint ptr %pStruct2 to i64
  %offset = sub i64 %t2, %t1
  ; Division by structure size.
...
define void @test03(ptr "intel_dtrans_func_index"="1" %ppStruct1, ptr "intel_dtrans_func_index"="2" %ppStruct2) !intel.dtrans.func.type !8 {

...
; analysis for related types found that the structures are not related.


%class.TestClass = type <{ i32, [4 x i32], [4 x i8]}>
%class.TestClass.base = type <{ i32, [4 x i32]}>

; Function @foo will load from the padded field
define void @foo(ptr "intel_dtrans_func_index"="1" %0, i32 "intel_dtrans_func_index"="2" %var) !intel.dtrans.func.type !4 {
  %tmp1 = getelementptr inbounds %class.TestClass, ptr %0, i64 0, i32 2
  %tmp2 = getelementptr inbounds [4 x i8], ptr %tmp1, i64 0, i32 %var

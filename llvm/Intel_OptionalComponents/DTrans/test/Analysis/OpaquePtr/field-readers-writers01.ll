...
define void @atest01a() {
  ...
  %ifield = getelementptr %struct.atest01, ptr %mem, i64 0, i32 0
  store i32 0, ptr %ifield
  %armem = call ptr @malloc(i64 128)
  %pfield = getelementptr %struct.atest01, ptr %mem, i64 0, i32 1
  store ptr %armem, ptr %pfield
  ret void
}
...
define void @atest02a() {
  %mem = call ptr @malloc(i64 16)
  store ptr %mem, ptr @var02
  %ifield_i8ptr = getelementptr i8, ptr %mem, i64 0
  store i32 0, ptr %ifield_i8ptr
  %armem = call ptr @malloc(i64 128)
  %pfield_i8ptr = getelementptr i8, ptr %mem, i64 8
  store ptr %armem, ptr %pfield_i8ptr
  ret void
}

define void @atest02b(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !7 {
  %ifield_i8ptr = getelementptr i8, ptr %in, i64 0
  %ival = load i32, ptr %ifield_i8ptr
  ret void
}

define void @atest02c(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !8 {
  %pfield_i8ptr = getelementptr i8, ptr %in, i64 8
  %pval = load ptr, ptr %pfield_i8ptr
  ret void
}

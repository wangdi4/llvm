...
; Test partial read and write of an inner structure with memcpy. Ensure that
...
entry:
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 getelementptr inbounds (%struct._ZTS5outer.outer, ptr @mystruct, i32 0, i32 1), ptr align 4 getelementptr inbounds (%struct._ZTS5outer.outer, ptr @mystruct, i32 0, i32 1), i64 8, i1 false)
  ret i32 0
}

...
entry:
  ...
  store ptr bitcast (ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVSt9bad_alloc, i64 0, inrange i32 0, i64 2) to ptr), ptr %gep, align 8
  tail call void @__cxa_throw(ptr nonnull %call, ptr bitcast (ptr @_ZTISt9bad_alloc to ptr), ptr bitcast (ptr @_ZNSt9bad_allocD1Ev to ptr))
  unreachable
}
...
if.then:                                     ; preds = %entry
  %alloc1 = tail call ptr bitcast (ptr @_ZN10MemManager8allocateEl to ptr)(ptr nonnull %mm, i64 %new.size)
  br label %merge

if.else:                                     ; preds = %entry
  %alloc2 = tail call ptr bitcast (ptr @dummyAlloc to ptr)(ptr nonnull %mm, i64 %new.size)
  br label %merge
...
if.then.1:                                     ; preds = %if.else
  tail call void bitcast (ptr @_ZN10MemManager10deallocateEPv to ptr)(ptr %ld1, ptr nonnull %gep1)
  br label %merge

if.else.1:                                     ; preds = %if.else
  tail call void bitcast (ptr @dummyDeallocateEPv to ptr)(ptr %ld1, ptr nonnull %gep1)
  br label %merge

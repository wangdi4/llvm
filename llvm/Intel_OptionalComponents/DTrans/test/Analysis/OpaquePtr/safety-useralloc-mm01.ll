; REQUIRES: asserts
; RUN: opt  < %s -whole-program-assume -dtrans-print-callinfo -dtrans-safetyanalyzer -disable-output 2>&1 | FileCheck %s
; RUN: opt  < %s -whole-program-assume -dtrans-print-callinfo -passes='require<dtrans-safetyanalyzer>' -disable-output 2>&1 | FileCheck %s

...
; This test case checks that "Mismatched element access (related types) --
; Type for field load/store contains related types" was set for the load
; instruction in %2 and the store instruction, but the structure
; %class.MainClass was set to "Mismatched element access" due to write in the
; padded field. The main goal of this test case is to check that "Mismatched
; element access (related types)" was reverted correctly into "Mismatched
; element access".

; CHECK: dtrans-safety: Mismatched element access (related types) -- Type for field load/store contains related types

...
; Two structs with different sized ints.
...
; CHECK: LLVMType: %struct.MYSTRUCT = type { i32, i16 }
...
%struct.MYSTRUCTX = type { i16, i32 }

@myarg = dso_local global %struct.MYSTRUCT { i32 3, i16 3 }, align 4
@fp = dso_local local_unnamed_addr global ptr null, align 8, !intel_dtrans_type !0

; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local i32 @target1(ptr nocapture readonly "intel_dtrans_func_index"="1" %arg) local_unnamed_addr #0 !intel.dtrans.func.type !13 {
entry:
  %field0 = getelementptr inbounds %struct.MYSTRUCT, ptr %arg, i64 0, i32 0, !intel-tbaa !14
  %i = load i32, ptr %field0, align 4, !tbaa !14
  ret i32 %i
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind readonly uwtable willreturn
define dso_local i32 @target2(ptr nocapture readonly "intel_dtrans_func_index"="1" %arg) local_unnamed_addr #0 !intel.dtrans.func.type !20 {
entry:
  %field1 = getelementptr inbounds %struct.MYSTRUCTX, ptr %arg, i64 0, i32 1, !intel-tbaa !22
...
entry:
  %i = load ptr, ptr @fp, align 8, !tbaa !24
...
!9 = !{!"S", %struct.MYSTRUCT zeroinitializer, i32 2, !2, !10}
!10 = !{i16 0, i32 0}
!11 = !{!"S", %struct.MYSTRUCTX zeroinitializer, i32 2, !10, !2}
!12 = !{!"Intel(R) oneAPI DPC++/C++ Compiler 2021.4.0 (2021.x.0.YYYYMMDD)"}
!13 = distinct !{!3}
!14 = !{!15, !16, i64 0}
!15 = !{!"struct@", !16, i64 0, !19, i64 4}
!16 = !{!"int", !17, i64 0}
!17 = !{!"omnipotent char", !18, i64 0}
!18 = !{!"Simple C/C++ TBAA"}
!19 = !{!"short", !17, i64 0}
!20 = distinct !{!21}
!21 = !{%struct.MYSTRUCTX zeroinitializer, i32 1}
!22 = !{!23, !16, i64 4}
!23 = !{!"struct@", !19, i64 0, !16, i64 4}
!24 = !{!25, !25, i64 0}
!25 = !{!"pointer@_ZTSPFiP8MYSTRUCTE", !17, i64 0}

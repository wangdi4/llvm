...
; @foo. The PHI node is used as a type that is not in the zero element chain of
; %class.TestClass.Outer, nor as related type.
...
br.loop:
  ...
  %1 = getelementptr inbounds %class.SimpleClass, ptr %phi, i64 0, i32 0

...
define void @test01(ptr "intel_dtrans_func_index"="1" %img ,ptr "intel_dtrans_func_index"="2" %buf) !intel.dtrans.func.type !6 {
  tail call void (ptr, i32, ptr, ...) @__kmpc_fork_call(
    ptr @.kmpc_loc.0.0.27,
    i32 6,
    ptr @GetImageChannelDepth.DIR.OMP.PARALLEL.LOOP.2.split552,
    i64 1,
    ptr %img,
    i64 75,
    ptr %buf,
...
define void @GetImageChannelDepth.DIR.OMP.PARALLEL.LOOP.2.split552(ptr "intel_dtrans_func_index"="1" %0, ptr "intel_dtrans_func_index"="2" %1, i64 %2, ptr "intel_dtrans_func_index"="3" %3, i64 %4, ptr "intel_dtrans_func_index"="4" %5, i64 %6, i64 %7) !intel.dtrans.func.type !9 {
  %load0 = load i32, ptr %0
  %load1 = load i32, ptr %1
  %load3 = load i64, ptr %5
  %use1 = getelementptr %struct.test01, ptr %3, i64 0, i32 1
  ret void
}

declare !intel.dtrans.func.type !14 !callback !0 void @__kmpc_fork_call(ptr "intel_dtrans_func_index"="1" %0, i32 %1, ptr "intel_dtrans_func_index"="2" %2, ...)

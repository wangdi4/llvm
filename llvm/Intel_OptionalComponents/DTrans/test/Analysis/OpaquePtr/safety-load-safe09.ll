...
; Verify loading element zero of a structure that is contained within an array
; using the address of the array results in the field being set as "Read" and
; "NonGEPAccess".
...
define i64 @test(i64 %idx) {
  ; Load a field from the structure using the address of the array.
  %v0 = load i64, ptr @gStructArray

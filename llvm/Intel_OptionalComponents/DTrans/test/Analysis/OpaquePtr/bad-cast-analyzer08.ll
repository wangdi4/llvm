...
; to the candidate field is bitcast through a pair of ptrtoint and inttoptr
; instructions. It should fail with a safety violation and retain the Bad
; casting, Unsafe pointer store, and Mismatched element access  violations.
...
t5:
  ...
  %t13.2 = ptrtoint ptr %call to i64
  %t13.1 = inttoptr i64 %t13.2 to ptr

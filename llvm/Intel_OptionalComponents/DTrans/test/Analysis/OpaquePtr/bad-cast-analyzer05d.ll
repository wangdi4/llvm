...
; CHECK: dtrans-bca: (L) Unmatched call:   call void @mysillyfunction(ptr %i)
...
declare !intel.dtrans.func.type !41 void @mysillyfunction(ptr "intel_dtrans_func_index"="1")
...
entry:
  ...
  call void @mysillyfunction(ptr %i)

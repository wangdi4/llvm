...
; %struct.test.a.base and %struct.test.a is NOT set because the
; pointer in field 0 mismatch.
...
%struct.test.array.a = type { [4 x i32] }
%struct.test.array.b = type { [3 x i32] }
%struct.test.b = type { ptr, [4 x i8] }
%struct.test.a = type { ptr, i32, [4 x i8] }
...
define "intel_dtrans_func_index"="1" i32 @foo(ptr "intel_dtrans_func_index"="2" %ptr) local_unnamed_addr #0 !intel.dtrans.func.type !18 {
  ...
  %boostgep = getelementptr %"struct.test.array.b", ptr %agep, i64 0, i32 0
  %arrgep = getelementptr [3 x i32], ptr %boostgep, i64 0, i32 0
...
!intel.dtrans.types = !{!4, !7, !14, !16, !19}
!llvm.ident = !{!10}
...
!6 = !{i32 0, i32 0}
!7 = !{!"S", %struct.test.a zeroinitializer, i32 3, !21, !6, !8}
!8 = !{!"A", i32 4, !9}
!9 = !{i8 0, i32 0}
...
!15 = !{%struct.test.array.a zeroinitializer, i32 1}
!16 = !{!"S", %struct.test.array.a zeroinitializer, i32 1, !17}
!17 = !{!"A", i32 4, !6}
!18 = distinct !{!6, !12}
!19 = !{!"S", %struct.test.array.b zeroinitializer, i32 1, !20}
!20 = !{!"A", i32 3, !6}
!21 = !{%struct.test.array.b zeroinitializer, i32 1}

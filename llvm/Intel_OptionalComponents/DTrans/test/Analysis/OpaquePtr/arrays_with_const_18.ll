...
; %class.TestClass are collected. The goal of this test case is to catch the
; arrays with constant entries in special structures, even if the special
; structure doesn't pass the DTrans safety violations.
...
; CHECK-NOT: Type: %boost.arr = type <{ [4 x i32] }>

...
; safety violation and retain the Bad casting, Unsafe pointer store, and
...
entry:
  ...
  %t41 = load i32, ptr @mystupidint, align 4
  %t45 = icmp eq i32 %t41, 4
  br i1 %t45, label %t11, label %t50

t50:
  %t52 = load i32, ptr @mystupidint, align 4
  %t51 = icmp eq i32 %t52, 19
  br i1 %t51, label %t20, label %t30

t20:                                     ; preds = %t50
  %t13.20 = getelementptr inbounds %struct._ZTS11mynextcoder.mynextcoder, ptr %arg0, i64 0, i32 0
  %t13.21 = load ptr, ptr %t13.20, align 8
  br label %t40

t30:
  %t13.30 = getelementptr inbounds %struct._ZTS11mynextcoder.mynextcoder, ptr %arg0, i64 0, i32 0
  %t13.31 = load ptr, ptr %t13.30, align 8
  br label %t40

t40:
  %t13.40 = phi ptr [ %t13.21, %t20 ], [ %t13.31, %t30 ]
  br label %t11

t11:
  %t12 = phi ptr [ %call, %entry ], [ %t13.40, %t40 ]
  %field03 = getelementptr inbounds %struct._ZTS8mycoder1.mycoder1, ptr %t12, i64 0, i32 0
  store i32 15, ptr %field03, align 8
  %field14 = getelementptr inbounds %struct._ZTS8mycoder1.mycoder1, ptr %t12, i64 0, i32 1

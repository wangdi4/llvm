...
; case is to check that the safety violation triggered correctly even if
; one of the incoming values is used as a related type (%1).
...
br.loop:
  ...
  %2 = getelementptr inbounds %class.TestClass.Inner, ptr %phi, i64 0, i32 0

...
; CHECK:   %out_i8 = call ptr @realloc(ptr %in_i8, i64 256)
...
define internal void @test02() {
  ...
  %v0 = load ptr, ptr %f0
  %v0_i8 = bitcast ptr %v0 to ptr
  %more = call ptr @realloc(ptr %v0_i8, i64 512)
  %more_i8 = bitcast ptr %more to ptr
  %f1 = getelementptr %struct.test02, ptr @testvar02, i64 0, i32 1
  store ptr %more_i8, ptr %f1
  ret void
}
; CHECK-LABEL: define internal void @test02
; CHECK:  %more = call ptr @realloc(ptr %v0_i8, i64 512)
; CHECK-NEXT: LocalPointerInfo:
; CHECK-NEXT:  Aliased types:

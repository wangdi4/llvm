...
@__kmpc_fork_call(%struct.ident_t* nonnull @.kmpc_loc.0.0,
  i32 0,
  void (i32*, i32*, ...)* bitcast (void (i32*, i32*, %struct.rgb*, i64, i64)* @main.DIR.OMP.PARALLEL.LOOP.2.split20 to void (i32*, i32*, ...)*),
...
define internal void @main.DIR.OMP.PARALLEL.LOOP.2.split20(i32* %tid, i32* %bid, %struct.rgb* %colors, i64 %.omp.lb.val.zext, i64 %.omp.ub.val) {
  ...
  %cast = bitcast %struct.rgb* %colors to %struct.hsl*
  %h = getelementptr %struct.hsl, %struct.hsl* %cast, i64 0, i32 0
  %s = getelementptr %struct.hsl, %struct.hsl* %cast, i64 0, i32 1
  %l = getelementptr %struct.hsl, %struct.hsl* %cast, i64 0, i32 2
  ret void
}
...
; CHECK-NONOPAQUE: %h = getelementptr %struct.hsl, %struct.hsl* %cast, i64 0, i32 0
; CHECK-OPAQUE:    %h = getelementptr %struct.hsl, ptr %cast, i64 0, i32 0
; CHECK:   LocalPointerInfo:
; CHECK-SAME: <DEPENDS ON UNHANDLED>

; CHECK-NONOPAQUE: %s = getelementptr %struct.hsl, %struct.hsl* %cast, i64 0, i32 1
; CHECK-OPAQUE:    %s = getelementptr %struct.hsl, ptr %cast, i64 0, i32 1
; CHECK:   LocalPointerInfo:
; CHECK-SAME: <DEPENDS ON UNHANDLED>

; CHECK-NONOPAQUE: %l = getelementptr %struct.hsl, %struct.hsl* %cast, i64 0, i32 2
; CHECK-OPAQUE:    %l = getelementptr %struct.hsl, ptr %cast, i64 0, i32 2
; CHECK:   LocalPointerInfo:
; CHECK-SAME: <DEPENDS ON UNHANDLED>

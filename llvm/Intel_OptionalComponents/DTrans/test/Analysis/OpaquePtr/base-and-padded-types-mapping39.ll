...
; because the size used for memset is not the same as the zero element of
; %struct.test.a.
...
; CHECK:   [test01]   call void @llvm.memset.p0.i64(ptr %ptr, i8 1, i64 6, i1 false)
...
entry:
  ...
  %1 = load i32, ptr %0
  call void @llvm.memset.p0i8.i64(ptr %ptr, i8 1, i64 6, i1 false)
  ret void
}

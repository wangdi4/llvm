...
entry:
  ...
  %i = load float, ptr %field0, align 8, !tbaa !23
...
entry:
  %i = load ptr, ptr @fp, align 8, !tbaa !25
...
!12 = !{!"S", %struct.MYSTRUCTX zeroinitializer, i32 2, !11, !10}
...
!23 = !{!24, !17, i64 8}
!24 = !{!"struct@", !20, i64 0, !17, i64 8}
!25 = !{!26, !26, i64 0}
!26 = !{!"pointer@_ZTSPFiP8MYSTRUCTE", !18, i64 0}

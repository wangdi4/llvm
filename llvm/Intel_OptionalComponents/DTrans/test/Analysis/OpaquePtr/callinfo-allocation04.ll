...
; This test currently fails because the PtrTypeAnalyzer marks
; some pointer values as 'UNHANDLED' because it does not support
; inferring a type through the array type used in the GEP.
; XFAIL: *

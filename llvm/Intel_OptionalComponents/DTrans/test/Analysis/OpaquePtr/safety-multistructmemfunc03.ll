...
; Test partial read and write of an inner structure with memmove. Ensure that
; both the outer and inner structure are marked 'Multi-struct memfunc' to
; inhibit optimizations that need to transform memfuncs.
...
entry:
  call void @llvm.memmove.p0.p0.i64(ptr align 4 getelementptr inbounds (%struct._ZTS5outer.outer, ptr @mystruct, i32 0, i32 1), ptr align 4 getelementptr inbounds (%struct._ZTS5outer.outer, ptr @mystruct, i32 0, i32 1), i64 8, i1 false)
  ret i32 0
}

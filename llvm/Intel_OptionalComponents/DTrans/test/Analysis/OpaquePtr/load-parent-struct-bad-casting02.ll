...
; when expected type is at zero offset of used type. (Special case)
...
%IC_KeyRef = type { %IdentityConstraint, ptr }
...
; CHECK:   LLVMType: %IC_KeyRef = type { %IdentityConstraint, ptr }
...
; CHECK: Safety data: Bad casting | Ambiguous GEP | Mismatched element access | Nested structure | Contains nested structure{{ *$}}
...
!intel.dtrans.types = !{!0, !2, !7, !10, !12}
...
!13 = !{%IdentityConstraint zeroinitializer, i32 0}
!14 = distinct !{!15}

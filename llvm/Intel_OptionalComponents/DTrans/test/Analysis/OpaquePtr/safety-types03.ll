; REQUIRES: asserts
; RUN: opt -dtransop-allow-typed-pointers -whole-program-assume -intel-libirc-allowed -dtrans-safetyanalyzer -dtrans-print-safetyanalyzer-ir -dtrans-print-types -disable-output %s 2>&1 | FileCheck %s
...
; RUN: opt -opaque-pointers -whole-program-assume -intel-libirc-allowed -dtrans-safetyanalyzer -dtrans-print-safetyanalyzer-ir -dtrans-print-types -disable-output %s 2>&1 | FileCheck %s

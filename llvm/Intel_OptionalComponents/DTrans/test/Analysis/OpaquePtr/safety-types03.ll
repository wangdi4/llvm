...
; RUN: opt -whole-program-assume -intel-libirc-allowed -passes='require<dtrans-safetyanalyzer>' -dtrans-print-safetyanalyzer-ir -dtrans-print-types -disable-output %s 2>&1 | FileCheck %s
...
%struct._ZTSZ19AcquireResizeFilterE3$_0.anon.0 = type { ptr, double, i32 }

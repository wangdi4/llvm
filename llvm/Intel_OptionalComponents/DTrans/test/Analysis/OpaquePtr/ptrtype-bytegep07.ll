...
; RUN: opt -disable-output -whole-program-assume -intel-libirc-allowed -passes=dtrans-ptrtypeanalyzertest -dtrans-outofboundsok=false -dtrans-print-pta-results < %s 2>&1 | FileCheck %s

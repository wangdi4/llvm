...
define void @baz(ptr "intel_dtrans_func_index"="1" %ptr) !intel.dtrans.func.type !5 {
  %tmp1 = getelementptr inbounds %class.TestClass, ptr %ptr, i64 0, i32 1
  %tmp2 = load [4 x i32], ptr %tmp1
  ret void
}

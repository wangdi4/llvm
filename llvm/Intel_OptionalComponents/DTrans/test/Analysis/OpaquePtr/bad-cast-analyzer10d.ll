...
; to the candidate field is used by a non-GEP instruction. It should fail with
; a safety violation and retain the Bad casting, Unsafe pointer store, and
; Mismatched element access violations.
...
@mysloppyint = internal global i64 50, align 4

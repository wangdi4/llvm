...
; function @test. The reason is because all the fields in structure
; %class.TestClass.Inner_vect_imp aren't the same.
...
; CHECK: dtrans-safety: Cascading pointer carried safety condition: From: %class.TestClass.Inner_vect_imp = type { %class.TestClass.Inner*, %class.TestClass.Inner*, %class.TestClass.Outer* } To: %class.TestClass.Inner = type { %class.MainClass.base, [4 x i8] } :: Bad casting
; CHECK: dtrans-safety: Cascading pointer carried safety condition: From: %class.TestClass.Inner_vect_imp = type { %class.TestClass.Inner*, %class.TestClass.Inner*, %class.TestClass.Outer* } To: %class.TestClass.Outer = type { %class.TestClass.Inner, %class.TestClass.Inner_vect } :: Bad casting
...
; %class.TestClass.Inner_vect_imp = type { %class.TestClass.Inner*, %class.TestClass.Inner*, %class.TestClass.Outer* }
...
!11 = !{!"S", %class.TestClass.Inner_vect_imp zeroinitializer, i32 3, !10, !10, !16} ; %class.TestClass.Inner_vect_imp = type { %class.TestClass.Inner*, %class.TestClass.Inner*, %class.TestClass.Outer* }

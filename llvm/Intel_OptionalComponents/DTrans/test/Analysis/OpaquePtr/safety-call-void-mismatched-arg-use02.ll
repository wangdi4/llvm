...
define i1 @test01less(ptr "intel_dtrans_func_index"="1" %p0, ptr "intel_dtrans_func_index"="2" %p1) !intel.dtrans.func.type !4 {
  %fs0 = getelementptr %struct.test01.b, ptr %p0, i64 0, i32 0
  %fs1 = getelementptr %struct.test01.b, ptr %p1, i64 0, i32 0
  %v0 = load i32, ptr %fs0
  %v1 = load i32, ptr %fs1
...
define void @test02(ptr "intel_dtrans_func_index"="1" %pStruct) !intel.dtrans.func.type !8 {
  ...
  %ps0 = load ptr, ptr %ps_addr0
  %ps1 = load ptr, ptr %ps_addr1
  %less = call i1 bitcast (ptr @test02less to
               ptr)(ptr %ps0, ptr %ps1)
  ret void
}

define i1 @test02less(ptr "intel_dtrans_func_index"="1" %p0, ptr "intel_dtrans_func_index"="2" %p1) !intel.dtrans.func.type !9 {
  %v0 = load i32, ptr %p0
  %v1 = load i32, ptr %p1
  %cmp = icmp slt i32 %v0, %v1
  ret i1 %cmp
...
define i1 @test03less(ptr "intel_dtrans_func_index"="1" %p0, ptr "intel_dtrans_func_index"="2" %p1) !intel.dtrans.func.type !10 {
  %fs0 = getelementptr %struct.test03.b, ptr %p0, i64 0, i32 0
  %fs1 = getelementptr %struct.test03.b, ptr %p1, i64 0, i32 0
  %v0 = load i32, ptr %fs0
  %v1 = load i32, ptr %fs1
  %cmp0 = icmp slt i32 %v0, %v1

  %fs2 = getelementptr %struct.test03.c, ptr %p0, i64 0, i32 2
  %fs3 = getelementptr %struct.test03.c, ptr %p1, i64 0, i32 2
  %v2 = load i64, ptr %fs2
  %v3 = load i64, ptr %fs3
...
define void @test03(ptr "intel_dtrans_func_index"="1" %pStruct) !intel.dtrans.func.type !12 {
  %ps_addr0 = getelementptr ptr, ptr %pStruct, i64 0
  %ps_addr1 = getelementptr ptr, ptr %pStruct, i64 1
  %ps0 = load ptr, ptr %ps_addr0
  %ps1 = load ptr, ptr %ps_addr1
  %less = call i1 bitcast (ptr @test03less to
               ptr)(ptr %ps0, ptr %ps1)
  ret void
}
; CHECK-LABEL: DTRANS_StructInfo:

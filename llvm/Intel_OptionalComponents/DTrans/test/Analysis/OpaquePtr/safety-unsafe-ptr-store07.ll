...
%struct.test01b = type { ptr, ptr, ptr }
...
%struct.test02b = type { ptr, ptr, ptr }
...
%struct.test03b = type { ptr, ptr, ptr }
...
%struct.test04b = type { ptr, ptr, ptr }
%struct.test04c = type { ptr, ptr }
define void @test04(ptr "intel_dtrans_func_index"="1" %pStruct) !intel.dtrans.func.type !16 {

...
; size of the new memory space allocated wasn't check with a division by the
; size of structure.
...
entry:
  ...
  %7 = sub i64 %5, %6
  %8 = icmp eq i64 %7, 0
  br i1 %8, label %invoke.good, label %is.not.zero.br

is.not.zero.br:
  %9 = icmp ugt i64 %7, 1092816592044404
  br i1 %9, label %is.out.of.bounds.br, label %call.to.new.br
...
invoke.good:
  ...
  store ptr %11, ptr %12
  %13 = getelementptr inbounds %class.MainClass, ptr %11, i64 %7
  br label %exit

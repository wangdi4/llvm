...
; Test pointer type analyzer for "cmpxchg" instruction.
...
define void @test0() {
  %var0 = alloca i64
  %r0 = cmpxchg volatile ptr %var0, i64 0, i64 1 seq_cst seq_cst
  ret void
}
...
; CHECK: %r0 = cmpxchg volatile ptr %var0, i64 0, i64 1 seq_cst seq_cst
; CHECK-NOT: UNHANDLED


; Test with pointer that is a structure field member.
;
...
; CHECK: %r0 = cmpxchg volatile ptr %f0, i64 0, i64 1 seq_cst seq_cst
; CHECK-NOT: UNHANDLED
...
define void @test2() {
  ...
  %r1 = cmpxchg volatile ptr %f1, ptr null, ptr %l seq_cst seq_cst
  ret void
}
...
; CHECK: %r1 = cmpxchg volatile ptr %f1, ptr null, ptr %l seq_cst seq_cst, align 8
; CHECK: UNHANDLED
...
define void @test3() {
  ...
  %r0 = cmpxchg volatile ptr %var3, i64 0, i64 1 seq_cst seq_cst
  ret void
}
...
; CHECK:  %r0 = cmpxchg volatile ptr %var3, i64 0, i64 1 seq_cst seq_cst
; CHECK-NOT: UNHANDLED
...
define void @test4() {
  %var4 = alloca i64
  cmpxchg volatile ptr %var4, i32 0, i32 1 seq_cst seq_cst
  ret void
}
...
; CHECK:  %1 = cmpxchg volatile ptr %var4, i32 0, i32 1 seq_cst seq_cst, align 4
; CHECK-NOT: UNHANDLED
...
%struct.test5 = type { ptr, ptr }
define void @test5() {
  %var5 = alloca ptr, !intel_dtrans_type !3
  %l = alloca ptr, !intel_dtrans_type !3
  %r1 = cmpxchg volatile ptr %var5, ptr null, ptr %l seq_cst seq_cst
  ret void
}
; CHECK-LABEL: define void @test5
; CHECK:  %var5 = alloca ptr
; CHECK: UNHANDLED

; CHECK:  %r1 = cmpxchg volatile ptr %var5, ptr null, ptr %l seq_cst seq_cst, align 8
; CHECK: UNHANDLED

!intel.dtrans.types = !{!4, !5, !6, !7}

!1 = !{i64 0, i32 0}  ; i64
!2 = !{i64 0, i32 1}  ; i64*
!3 = !{%struct.test5 zeroinitializer, i32 1}  ; %struct.test5*
!4 = !{!"S", %struct.test1 zeroinitializer, i32 2, !1, !1} ; { i64, i64 }
!5 = !{!"S", %struct.test2 zeroinitializer, i32 2, !2, !2} ; { i64*, i64* }
!6 = !{!"S", %struct.test3 zeroinitializer, i32 2, !1, !1} ; { i64, i64 }
!7 = !{!"S", %struct.test5 zeroinitializer, i32 2, !2, !2} ; { i64*, i64* }

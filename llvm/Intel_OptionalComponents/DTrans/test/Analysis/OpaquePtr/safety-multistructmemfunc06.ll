...
; of the fields of other are marked written.
...
entry:
  call void @llvm.memmove.p0.i64(ptr align 4 getelementptr inbounds (%struct._ZTS5outer.outer, ptr @mystruct, i32 0, i32 1), ptr align 4 getelementptr inbounds (%struct._ZTS5outer.outer, ptr @mystruct, i32 0, i32 1), i64 24, i1 false)
  ret i32 0
}

; Function Attrs: argmemonly mustprogress nocallback nofree nounwind willreturn writeonly
declare void @llvm.memmove.p0.i64(ptr nocapture writeonly, ptr nocapture readonly, i64, i1 immarg) #1

...
; to the candidate field is passed to a function argument which can use it as
; more than one type.  It should fail with a safety violation and retain the
; Bad casting, Unsafe pointer store, and Mismatched element access violations.
...
t11: 
  ...
  store i32 122, ptr %field1, align 8
  ret void
}

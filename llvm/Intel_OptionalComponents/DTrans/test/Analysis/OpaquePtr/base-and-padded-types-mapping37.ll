...
; because the size used in the memcpy is not the same as the zero element of
; %struct.test.a.base (6).
...
; CHECK:   [test01]   call void @llvm.memcpy.p0.p0.i64(ptr %ptr, ptr %ptr2, i64 6, i1 false)
...
entry:
  ...
  %2 = load i32, ptr %0
  %3 = load i32, ptr %1
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %ptr, ptr %ptr2, i64 6, i1 false)
  ret void
}

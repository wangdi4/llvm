...
; flattened GEP used for accessing next field" was not printed for the store in
; function @test. The reason is the language rules for out of bounds wasn't
; set.

; CHECK-NOT: dtrans-safety: Bad pointer manipulation (related types) -- Byte flattened GEP used for accessing next field

...
; since the we can't identify the dominant type for the input pointer to
; the memset's call, nor can we identify that %class.TestClass.Outer
; encapsulates all the declaration and use aliases.

; CHECK-NOT: dtrans-safety: Bad memfunc manipulation (related types) -- memset used in a structure with related type
; CHECK: dtrans-safety: Ambiguous pointer target -- memset could not identify dominant type
; CHECK:   [test01]   call void @llvm.memset.p0.i64(ptr %ptr, i8 1, i64 8, i1 false)
...
entry:
  %0 = getelementptr inbounds %class.Simple, ptr %ptr, i64 0, i32 0
  %1 = load i32, ptr %0
  call void @llvm.memset.p0.i64(ptr %ptr, i8 1, i64 8, i1 false)
  ret void
}

...
; related types" were set for the store instruction in @foo. The reason is
; because the allocated space in %0 is expected to be used as a pointer to
; %class.TestClass, but is it used in %2 as %class.MainClass, which is a
; related type of %class.MainClass.base.

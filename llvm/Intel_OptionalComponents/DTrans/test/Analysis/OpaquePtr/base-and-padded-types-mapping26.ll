...
; mapped together since there is a memcpy is not using the correct size.
; The goal of this test case is to check when a parent structure
; (%struct.test.b) encapsulates a base structure (%struct.test.a.base)
; and we use memcopy to copy data from the padded structure (%struct.test.a),

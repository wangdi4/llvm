...
; RUN: opt < %s -opaque-pointers -whole-program-assume -intel-libirc-allowed -dtrans-outofboundsok=false -dtrans-usecrulecompat -passes='require<dtrans-fieldmodrefop-analysis>' -dtrans-fieldmodref-eval -disable-output 2>&1 | FileCheck --check-prefix=CHECK %s
...
define internal void @test01() {
  ...
  tail call void (ptr, i32, ptr, ...) @broker(
    ptr @.kmpc_loc.0.0.27, i32 6, ptr bitcast
      (ptr @use01a to ptr),
    i64 1,
    ptr %st,
	  ptr @filter01a,
...
; CHECK: FieldModRefQuery: - Ref        : [test01]   store ptr %ar1_mem2, ptr %f1, align 8 --   tail call void (ptr, i32, ptr, ...) @broker(ptr @.kmpc_loc.0.0.27, i32 6, ptr @use01a, i64 1, ptr %st, ptr @filter01a, ptr @filter01b)

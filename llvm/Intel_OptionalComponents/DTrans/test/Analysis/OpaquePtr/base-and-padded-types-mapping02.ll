...
; even if we are accessing field 0 in %struct.test.b as %struct.test.a. This can
; be seen as if we were applying a bitcast to the first field of %struct.test.b.
...
entry:
  %a = getelementptr inbounds %struct.test.a, ptr %ptr, i64 0, i32 0
  %0 = load i32, ptr %a
  ret i32 %0
}

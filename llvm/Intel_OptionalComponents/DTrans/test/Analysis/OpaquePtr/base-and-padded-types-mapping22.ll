...
; This test case checks that the base-padded relationship between all the
; padded and base structures (%struct.test.a[.base] and %struct.test.b[.base])
; are set. The formal parameter for function @foo is *%struct.test.a, while
; the actual parameter is %struct.test.c, therefore the safety analyzer should
; set BadCastingForRelatedTypes. The goal of this test case is to check that
; the related types analysis works when there are multiple level of nested
; structures, and the type of the formal parameter of function @foo is the

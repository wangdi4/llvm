...
; includes related types" is NOT set for the call to new since the structure
; %class.SimpleClass is not a zero element nor a related type of
...
; CHECK:   [foo]   %1 = tail call noalias noundef nonnull ptr @_Znwm(i64 24)
...
entry:
  ...
  %3 = getelementptr inbounds %class.SimpleClass, ptr %1, i64 0, i32 0
  br label %exit

...
@_ZTVSt9exception = internal constant { [5 x ptr] } zeroinitializer, !intel_dtrans_type !4

define void @test01() {
  %res = call ptr @__cxa_allocate_exception(i64 8)
  %addr = getelementptr %"class._ZTSSt9exception.std::exception", ptr %res, i64 0, i32 0
  store ptr bitcast (ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTVSt9exception, i64 0, i32 0, i64 2) to ptr), ptr %addr
  ret void
}

...
; CHECK: Multiple Value: [ @globalStruct1, null ] <incomplete>
; CHECK: Bottom Alloc Function
; CHECK: Safety data: Bad casting | Unsafe pointer store | Global instance | Has initializer list
...
@globalStruct1 = internal global %struct._ZTS10testStruct.testStruct zeroinitializer, align 8
@globalStruct2 = internal local_unnamed_addr global %struct._ZTS10testStruct.testStruct { ptr @globalStruct1 }, align 8

; Function Attrs: nounwind uwtable
define dso_local i32 @main() local_unnamed_addr #0 {
entry:
  %call = call align 16 dereferenceable_or_null(100) ptr @malloc(i64 100)
  store ptr %call, ptr getelementptr inbounds (%struct._ZTS10testStruct.testStruct, ptr @globalStruct2, i64 0, i32 0), align 8, !tbaa !8
  call void @free(ptr %call)
  store ptr null, ptr getelementptr inbounds (%struct._ZTS10testStruct.testStruct, ptr @globalStruct2, i64 0, i32 0), align 8, !tbaa !8
  ret i32 0
}

; Function Attrs: inaccessiblememonly mustprogress nofree nounwind willreturn
declare !intel.dtrans.func.type !13 dso_local noalias noundef "intel_dtrans_func_index"="1" ptr @malloc(i64 noundef) local_unnamed_addr #1

; Function Attrs: inaccessiblemem_or_argmemonly mustprogress nounwind willreturn
declare !intel.dtrans.func.type !14 dso_local void @free(ptr nocapture noundef "intel_dtrans_func_index"="1") local_unnamed_addr #2

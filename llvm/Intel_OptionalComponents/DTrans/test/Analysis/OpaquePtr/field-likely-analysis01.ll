...
define i32 @main() {
 ; Set field values for the structures.
  ...
  store i32 1, ptr %alloc1.ptr, align 4
  store i32 5, ptr %alloc2.ptr, align 4
  ...
  %ar3.1 = getelementptr inbounds i32, ptr %alloc3.ptr, i64 1
  store i32 3, ptr %ar3.1, align 4
  %ar4.1 = getelementptr inbounds i32, ptr %alloc4.ptr, i64 1
  store i32 7, ptr %ar4.1, align 4
  %ar3.3 = getelementptr inbounds i32, ptr %alloc3.ptr, i64 3
  store i32 3, ptr %ar3.3, align 4
  %ar4.3 = getelementptr inbounds i32, ptr %alloc4.ptr, i64 3

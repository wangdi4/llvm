...
; formal parameter is expected to be a padded structure, but the actual
; parameter is a base structure.
...
; CHECK:   Arg#0:   %0 = alloca %struct.test.a.base, align 8

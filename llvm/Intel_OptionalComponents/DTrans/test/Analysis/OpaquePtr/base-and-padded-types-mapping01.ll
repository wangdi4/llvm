...
; in %struct.test.a is marked as the padded field and Top Alloc Function.
...
define dso_local noundef i32 @test(ptr noundef "intel_dtrans_func_index"="1" %ptr) local_unnamed_addr #0 !intel.dtrans.func.type !11 {
entry:
  %a = getelementptr inbounds %struct.test.b, ptr %ptr, i64 0, i32 0, i32 0
  %0 = load i32, ptr %a
  ret i32 %0
}

...
; Test that calls to @llvm.ptr.annotation.p0i64 are analyzed as producing a
; result type that matches the type of the first argument.
...
; CHECK: %p0 = getelementptr %__SOADT_struct.test01dep, %__SOADT_struct.test01dep* @var01, i64 0, i32 0
...
; CHECK:        %__SOADT_struct.test01dep @ 0
  ...
  %alloc_idx = call i64* @llvm.ptr.annotation.p0i64(i64* %p0,
                                                    ...
                                                    i32 0,
                                                    i8* null)
; CHECK:  %alloc_idx = call i64* @llvm.ptr.annotation.p0i64(i64* %p0, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__intel_dtrans_aostosoa_index, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @__intel_dtrans_aostosoa_filename, i32 0, i32 0), i32 0, i8* null)
; CHECK:        CE: i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__intel_dtrans_aostosoa_index, i32 0, i32 0)
; CHECK:          LocalPointerInfo:
; CHECK:            Aliased types:
; CHECK:              [33 x i8]*
; CHECK:              i8*
; CHECK:            Element pointees:
; CHECK:              [33 x i8] @ 0
; CHECK:        CE: i8* getelementptr inbounds ([1 x i8], [1 x i8]* @__intel_dtrans_aostosoa_filename, i32 0, i32 0)
; CHECK:          LocalPointerInfo:
; CHECK:            Aliased types:
; CHECK:              [1 x i8]*
; CHECK:              i8*

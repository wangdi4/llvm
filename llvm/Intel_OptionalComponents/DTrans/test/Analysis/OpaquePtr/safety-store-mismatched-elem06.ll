...
define void @test04(ptr "intel_dtrans_func_index"="1" %pStructA, ptr "intel_dtrans_func_index"="2" %pStructB) !intel.dtrans.func.type !13 {
  %pField = getelementptr %struct.test04a, ptr %pStructA, i64 0, i32 1
  %pStructB.as.i64 = ptrtoint ptr %pStructB to i64
  store i64 %pStructB.as.i64, ptr %pField
  ret void
}
; CHECK-LABEL: DTRANS_StructInfo:

...
; CHECK: Pointer type is not allowed in DTrans metadata

target triple = "x86_64-unknown-linux-gnu"

%struct.test = type { i32, i32 }

define void @test(ptr inalloca(<{ ptr, %struct.test }>) "intel_dtrans_func_index"="1" %arg) !intel.dtrans.func.type !2 {
  ret void
}
...
; error triggers an assertion in the builds with assertions enabled if the
; type in the metadata is 'ptr'.
!2 = distinct !{!3}
!3 = !{ptr null, i32 1}

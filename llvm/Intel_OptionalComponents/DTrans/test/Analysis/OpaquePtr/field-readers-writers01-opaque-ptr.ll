...
%struct.atest01 = type { i32, ptr }
define void @atest01a() {
  %st = call ptr @malloc(i64 16)
  %ifield = getelementptr %struct.atest01, ptr %st, i64 0, i32 0
  store i32 0, ptr %ifield
  %ar = call ptr @malloc(i64 128)
  %pfield = getelementptr %struct.atest01, ptr %st, i64 0, i32 1
  store ptr %ar, ptr %pfield
  ret void
}

define void @atest01b(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !4 {
  %ifield = getelementptr %struct.atest01, ptr %in, i64 0, i32 0
  %ival = load i32, ptr %ifield
  ret void
}

define void @atest01c(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !5 {
  %pfield = getelementptr %struct.atest01, ptr %in, i64 0, i32 1
  %pval = load ptr, ptr %pfield
  ret void
}
...
@var02 = internal global ptr zeroinitializer, !intel_dtrans_type !6

define void @atest02a() {
  %st = call ptr @malloc(i64 16)
  store ptr %st, ptr @var02
  %ifield = getelementptr i8, ptr %st, i64 0
  store i32 0, ptr %ifield
  %ar = call ptr @malloc(i64 128)
  %pfield = getelementptr i8, ptr %st, i64 8
  store ptr %ar, ptr %pfield
  ret void
}

define void @atest02b(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !7 {
  %ifield = getelementptr i8, ptr %in, i64 0
  %ival = load i32, ptr %ifield
  ret void
}

define void @atest02c(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !8 {
  %pfield = getelementptr i8, ptr %in, i64 8
  %pval = load ptr, ptr %pfield
  ret void
}
...
@var03 = internal global ptr zeroinitializer, !intel_dtrans_type !9

define void @atest03a() {
  %st = call ptr @malloc(i64 16)
  store ptr %st, ptr @var03
  call void @llvm.memset.p0i8.i64(ptr %st, i8 0, i64 16, i1 false)
  ret void
}
...
@var04 = internal global ptr zeroinitializer, !intel_dtrans_type !10

define void @atest04a() {
  %st = call ptr @malloc(i64 16)
  store ptr %st, ptr @var04
  %mem1 = getelementptr i8, ptr %st, i8 8
...
%struct.atest05 = type { i32, ptr }
@var05 = internal global ptr zeroinitializer, !intel_dtrans_type !11

define void @atest05a(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !12 {
  %st = call ptr @malloc(i64 16)
  store ptr %st, ptr @var05
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %st, ptr %in, i64 16, i1 false)
  ret void
}
...
@var06 = internal global ptr zeroinitializer, !intel_dtrans_type !13

define void @atest06a(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !14 {
  %st = call ptr @malloc(i64 16)
  store ptr %st, ptr @var06
  %field = getelementptr %struct.atest06, ptr %in, i64 0, i32 1
  %dst = getelementptr i8, ptr %st, i64 8
...
%struct.atest07 = type { i32, ptr }
@var07 = internal global ptr zeroinitializer, !intel_dtrans_type !15

define void @atest07a(ptr "intel_dtrans_func_index"="1" %in) !intel.dtrans.func.type !16 {
  %st = call ptr @malloc(i64 16)
  store ptr %st, ptr @var07
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %st, ptr %in, i64 8, i1 false)
  ret void
}
...
define void @atest09(ptr "intel_dtrans_func_index"="1" %in1, ptr "intel_dtrans_func_index"="2" %in2) !intel.dtrans.func.type !22 {
  %src = getelementptr inbounds %struct.atest09b, ptr %in1, i64 0, i32 1
  %dst = getelementptr inbounds %struct.atest09b, ptr %in2, i64 0, i32 1
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %dst, ptr %src, i64 8, i1 false)
  ret void
}
...
define void @atest10(ptr "intel_dtrans_func_index"="1" %src, ptr "intel_dtrans_func_index"="2" %in2) !intel.dtrans.func.type !26 {
  %dst = getelementptr inbounds %struct.atest10b, ptr %in2, i64 0, i32 1
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %dst, ptr %src, i64 8, i1 false)
  ret void
}
...
define void @atest11(ptr "intel_dtrans_func_index"="1" %in1, ptr "intel_dtrans_func_index"="2" %dst) !intel.dtrans.func.type !30 {
  %src = getelementptr inbounds %struct.atest11b, ptr %in1, i64 0, i32 1
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %dst, ptr %src, i64 8, i1 false)
  ret void
}

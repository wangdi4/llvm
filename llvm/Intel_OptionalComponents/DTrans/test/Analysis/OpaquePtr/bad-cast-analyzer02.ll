; REQUIRES: asserts
; RUN: opt -opaque-pointers < %s -whole-program-assume -intel-libirc-allowed -dtrans-safetyanalyzer -dtrans-print-types -disable-output 2>&1 | FileCheck %s
...
; casting, unsafe pointer stores, and mismatched element accesses, and
; does not require the addition of tests in some functions.

; CHECK: LLVMType: %struct._ZTS11mynextcoder.mynextcoder
; CHECK: Safety data: Global instance | Has function ptr{{ *$}}
...
entry:
  ...
  %field03 = getelementptr inbounds %struct._ZTS8mycoder1.mycoder1, ptr %call, i64 0, i32 0
  store i32 15, ptr %field03, align 8
  %field14 = getelementptr inbounds %struct._ZTS8mycoder1.mycoder1, ptr %call, i64 0, i32 1
...
entry:
  ...
  %field13 = getelementptr inbounds %struct._ZTS8mycoder2.mycoder2, ptr %call, i64 0, i32 1

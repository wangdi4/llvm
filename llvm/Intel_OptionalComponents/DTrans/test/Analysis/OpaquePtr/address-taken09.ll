...
; Check arrays with the same number of elements of identical underlying
; structs.
; Check that AddressTaken is set on 10 x MYSTRUCT, as 10 x MYSTRUCTX is a
; compatible type, so @target1 and @target2 are targets for @fp.
...
entry:
  %arrayidx = getelementptr inbounds [10 x %struct.MYSTRUCTX], ptr %arg, i64 0, i64 1, !intel-tbaa !27
...
!27 = !{!28, !17, i64 0}
!28 = !{!"array@_ZTSA10_9MYSTRUCTX", !17, i64 0}
!29 = !{!28, !18, i64 4}
!30 = !{!31, !31, i64 0}

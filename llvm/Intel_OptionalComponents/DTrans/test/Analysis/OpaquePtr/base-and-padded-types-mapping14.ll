...
; %struct.test.a.base and %struct.test.a is NOT set since
; %struct.test.a don't have the field reserved for padding.

; CHECK-LABEL: LLVMType: %struct.test.a = type { ptr, i32 }
...
%struct.test.a = type { ptr, i32 }
%struct.test.a.base = type { ptr, i32 }
...
!6 = !{i32 0, i32 0}
!7 = !{!"S", %struct.test.a zeroinitializer, i32 2, !15, !6}
!8 = !{!"A", i32 4, !9}
!9 = !{i8 0, i32 0}
...
!15 = !{%struct.test.array zeroinitializer, i32 1}

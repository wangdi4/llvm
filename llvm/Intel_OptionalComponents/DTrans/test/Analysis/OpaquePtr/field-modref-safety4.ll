...
@funcptr = global void (%struct.test01*)* @func_at, !intel_dtrans_type !6
...
define void @func_at(%struct.test01* "intel_dtrans_func_index"="1" %st) !intel.dtrans.func.type !7 {
  call void @read01.0(%struct.test01* %st)
  ret void
}

define void @read01.0(%struct.test01* "intel_dtrans_func_index"="1" %st) !intel.dtrans.func.type !8 {

; REQUIRES: asserts
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -passes='require<dtrans-safetyanalyzer>' -dtrans-usecrulecompat -disable-output -debug-only=dtrans-crc 2>&1 | FileCheck %s

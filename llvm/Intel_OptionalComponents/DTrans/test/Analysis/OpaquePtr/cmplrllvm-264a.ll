; REQUIRES: asserts
; RUN:  opt < %s -opaque-pointers -whole-program-assume -intel-libirc-allowed -dtrans-safetyanalyzer -dtrans-usecrulecompat -disable-output -debug-only=dtrans-crc 2>&1 | FileCheck %s
...
; CHECK: dtrans-crc: YES %struct._ZTS2S1.S1* %struct._ZTS2S2.S2*

%struct._ZTS2S1.S1 = type { ptr, ptr, ptr }
%struct._ZTS2S2.S2 = type { ptr, ptr, ptr }
%struct._ZTS2T1.T1 = type { i32, i32 }
...
entry:
  ...
  %0 = load ptr, ptr %arg.addr, align 8, !tbaa !14
  %field0 = getelementptr inbounds %struct._ZTS2S1.S1, ptr %0, i32 0, i32 0, !intel-tbaa !18
  %1 = load ptr, ptr %field0, align 8, !tbaa !18
...
entry:
  ...
  %0 = load ptr, ptr %arg.addr, align 8, !tbaa !24
  %field1 = getelementptr inbounds %struct._ZTS2S2.S2, ptr %0, i32 0, i32 1, !intel-tbaa !26
  %1 = load ptr, ptr %field1, align 8, !tbaa !26
  %cmp = icmp ne ptr %1, null
  %conv = zext i1 %cmp to i32
  ret i32 %conv
}
...
entry:
  ...
  %0 = load ptr, ptr @myfp, align 8, !tbaa !27
  %call = call i32 %0(ptr noundef @myarg), !intel_dtrans_type !1
  ret i32 %call
}
...
!6 = !{!"S", %struct._ZTS2T1.T1 zeroinitializer, i32 2, !2, !2}
...
!11 = !{!"S", %struct._ZTS2S2.S2 zeroinitializer, i32 3, !9, !10, !9}
...
!26 = !{!19, !21, i64 8}
!27 = !{!28, !28, i64 0}
!28 = !{!"pointer@_ZTSPFiP2S1E", !16, i64 0}

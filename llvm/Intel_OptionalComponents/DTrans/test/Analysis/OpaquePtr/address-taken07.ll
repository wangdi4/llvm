...
@myargx = dso_local local_unnamed_addr global %struct.MYSTRUCTX { ptr @target00, i32 10 }, align 8
...
entry:
  %field0 = getelementptr inbounds %struct.MYSTRUCTX, ptr %arg, i64 0, i32 0, !intel-tbaa !27
  %i = load ptr, ptr %field0, align 8, !tbaa !27
  %field1 = getelementptr inbounds %struct.MYSTRUCTX, ptr %arg, i64 0, i32 1, !intel-tbaa !30
  %i1 = load i32, ptr %field1, align 8, !tbaa !30

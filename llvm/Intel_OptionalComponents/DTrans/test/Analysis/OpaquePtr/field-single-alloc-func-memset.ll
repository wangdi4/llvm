...
; CHECK: LLVMType: %struct._ZTS7test_01.test_01 = type { ptr }
...
; CHECK: DTRANS_StructInfo:
; CHECK: LLVMType: %struct._ZTS7test_02.test_02 = type { ptr }
...
%struct._ZTS7test_01.test_01 = type { ptr }
%struct._ZTS7test_02.test_02 = type { ptr }
...
entry:
  ...
  %b2 = getelementptr inbounds %struct._ZTS7test_01.test_01, ptr %a, i32 0, i32 0, !intel-tbaa !11
  tail call void @llvm.memset.p0.i64(ptr nonnull align 8 %b2, i8 16, i64 8, i1 false)
  ret void
}

; Function Attrs: inaccessiblememonly mustprogress nofree nounwind willreturn
declare !intel.dtrans.func.type !16 noalias noundef "intel_dtrans_func_index"="1" ptr @malloc(i64 noundef) local_unnamed_addr #1
...
entry:
  %call = call align 16 ptr @malloc(i64 100)
  store ptr %call, ptr %a, align 8
  %b2 = getelementptr inbounds %struct._ZTS7test_02.test_02, ptr %a, i32 0, i32 0, !intel-tbaa !11
  tail call void @llvm.memset.p0.i64(ptr nonnull align 8 %b2, i8 0, i64 8, i1 false)
  ret void
}
...
!5 = !{!"S", %struct._ZTS7test_01.test_01 zeroinitializer, i32 1, !6}
!6 = !{i8 0, i32 1}
!7 = !{!"S", %struct._ZTS7test_02.test_02 zeroinitializer, i32 1, !6}

...
; fields in related types" since the offset 24 represents the access to field
; 0 in %class.TestClass.Inner_vect_imp for the pointer %0, whose type is
...
; CHECK-NEXT:   [foo]   %4 = getelementptr i8, ptr %0, i64 24

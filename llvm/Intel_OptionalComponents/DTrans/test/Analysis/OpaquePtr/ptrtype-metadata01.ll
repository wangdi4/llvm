; REQUIRES: asserts
; RUN: opt < %s -disable-output -whole-program-assume -intel-libirc-allowed -passes=dtrans-ptrtypeanalyzertest -dtrans-print-pta-results 2>&1 | FileCheck %s
...
; CHECK: %ar2 = getelementptr i8, ptr %ptr, i32 80

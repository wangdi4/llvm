...
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -dtransanalysis -debug-only=dtransanalysis -dtrans-maxcallsitecount=0 -disable-output 2>&1 | FileCheck %s
...
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -dtransanalysis -debug-only=dtransanalysis -dtrans-maxinstructioncount=0 -disable-output 2>&1 | FileCheck %s
...
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -dtransanalysis -debug-only=dtransanalysis -dtrans-maxcallsitecount=0 -dtrans-maxinstructioncount=0 -disable-output 2>&1 | FileCheck %s

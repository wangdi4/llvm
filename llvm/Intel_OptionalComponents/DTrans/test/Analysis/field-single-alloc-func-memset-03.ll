...
; Function' because they are written with a non-zero value, and field 2 is
; 'Top Alloc Function' because it is not written.

; For %struct._ZTS7test_02.test_02, field 1 is 'Single Alloc Function: ptr
; @malloc' because it is written with the return of malloc, and the other
; fields are 'Top Alloc Function' because they are written with 0 or not
; written.

; CHECK: DTRANS_StructInfo:
; CHECK: LLVMType: %struct.test_01 = type { i8*, i8*, i8* }
...
; CHECK: DTRANS_StructInfo:
; CHECK: LLVMType: %struct.test_02 = type { i8*, i8*, i8* }
...
%struct.test_01 = type { i8*, i8*, i8* }
%struct.test_02 = type { i8*, i8*, i8* }

; Function Attrs: nounwind uwtable
define internal void @foo_01(%struct.test_01* %a) local_unnamed_addr #0 {
entry:
  %call = call align 16 dereferenceable_or_null(100) i8* @malloc(i64 100)
  %field1 = getelementptr inbounds %struct.test_01, %struct.test_01* %a, i64 0, i32 1, !intel-tbaa !6
  store i8* %call, i8** %field1, align 8, !tbaa !6
  %0 = bitcast %struct.test_01* %a to i8*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(16) %0, i8 16, i64 16, i1 false)
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @foo_02(%struct.test_02* %a) local_unnamed_addr #0 {
entry:
  %call = call align 16 dereferenceable_or_null(100) i8* @malloc(i64 100)
  %field1 = getelementptr inbounds %struct.test_02, %struct.test_02* %a, i64 0, i32 1, !intel-tbaa !6
  store i8* %call, i8** %field1, align 8, !tbaa !6
...
!6 = !{!7, !8, i64 8}
!7 = !{!"struct@", !8, i64 0, !8, i64 8, !8, i64 16}

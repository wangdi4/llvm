...
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -dtrans-outofboundsok=false -dtrans-usecrulecompat -dtrans-fieldmodref-analysis -dtrans-fieldmodref-eval -disable-output 2>&1 | FileCheck %s
; RUN: opt < %s -whole-program-assume -intel-libirc-allowed -dtrans-outofboundsok=false -dtrans-usecrulecompat -passes='require<dtrans-fieldmodref-analysis>' -dtrans-fieldmodref-eval -disable-output 2>&1 | FileCheck %s
...
; CHECK: FieldModRefQuery: - Ref        : [test01]   store i32 8, i32* %f0, align 4 --   tail call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @broker(%struct.ident_t* @.kmpc_loc.0.0.27, i32 6, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, %struct.test01*, void (%struct.test01*)*, void (%struct.test01*)*)* @use01a to void (i32*, i32*, ...)*), i64 1, %struct.test01* %st, void (%struct.test01*)* @filter01a, void (%struct.test01*)* @filter01b)
; CHECK: FieldModRefQuery: - Ref        : [test01]   store i32* %ar1_mem2, i32** %f1, align 8 --   tail call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @broker(%struct.ident_t* @.kmpc_loc.0.0.27, i32 6, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, %struct.test01*, void (%struct.test01*)*, void (%struct.test01*)*)* @use01a to void (i32*, i32*, ...)*), i64 1, %struct.test01* %st, void (%struct.test01*)* @filter01a, void (%struct.test01*)* @filter01b)
; CHECK: FieldModRefQuery: - Mod        : [test01]   store i64 1, i64* %f2, align 8 --   tail call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @broker(%struct.ident_t* @.kmpc_loc.0.0.27, i32 6, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, %struct.test01*, void (%struct.test01*)*, void (%struct.test01*)*)* @use01a to void (i32*, i32*, ...)*), i64 1, %struct.test01* %st, void (%struct.test01*)* @filter01a, void (%struct.test01*)* @filter01b)

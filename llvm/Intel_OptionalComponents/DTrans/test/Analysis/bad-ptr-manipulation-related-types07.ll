...
; the fields type in %"struct.std::_Vector_impl" aren't the same.
; The test case should produce "Bad pointer manipulation" and
; "Unsafe pointer store" for these types.

%class.TestClass = type { i32, %"class.std::vector" }
%"class.std::vector" = type { %"struct.std::_Vector_base" }
%"struct.std::_Vector_base" = type { %"struct.std::_Vector_impl" }
%"struct.std::_Vector_impl" = type { %class.TestClass*, %class.TestClass*, i32 }
...
; CHECKBPTR-LABEL: LLVMType: %"struct.std::_Vector_impl" = type { %class.TestClass*, %class.TestClass*, i32 }
...
; CHECKUNSAFEPTR-LABEL: LLVMType: %"struct.std::_Vector_impl" = type { %class.TestClass*, %class.TestClass*, i32 }

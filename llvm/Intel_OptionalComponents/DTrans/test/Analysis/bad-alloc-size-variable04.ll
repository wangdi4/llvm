...
; This test checks that "bad alloc size" is set for the types since the
; constant in the division is not the same as the size of the structure.
; This is the same test case as bad-ptr-manupulation-related-types04.ll but
; it checks for "bad alloc size".

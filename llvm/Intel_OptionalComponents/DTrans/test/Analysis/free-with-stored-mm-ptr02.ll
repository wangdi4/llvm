...
; user-defined free() with stored memory manager pointer (with EH code).
...
define internal void @_ZN6MemorydlEPv(i8* %ptr) align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
if.else:                                      ; preds = %entry
...
if.then.1:                                     ; preds = %if.else
  invoke void bitcast (void (%class.MemManager*, i8*)* @_ZN10MemManager10deallocateEPv to void (%class.MemManager*, i8*)*)(%class.MemManager* %ld1, i8* nonnull %gep1)
            to label %merge unwind label %terminate

if.else.1:                                     ; preds = %if.else
  invoke void bitcast (void (%class.MemManager*, i8*)* @dummyDeallocateEPv to void (%class.MemManager*, i8*)*)(%class.MemManager* %ld1, i8* nonnull %gep1)
            to label %merge unwind label %terminate
...
terminate:                                    ; preds = %if.else.1, %if.then.1

...
; This test case tests the bad cast analyzer on a case in which a
; pointer to a Function is stored in a field of the CandidateRootType, and
; the Function is directly called. It should give up with a safety violation.
...
define dso_local i32 @main() {
  ...
  tail call void @coder1_startup(i8* null)

...
; a load of the candidate field, which is bitcast and whose value is passed
; through a complex collection of basic blocks.  It should fail with a safety
...
t16:                                     ; preds = %t5
  %t13.3 = ptrtoint %struct.mycoder1* %t13.0 to i64
  %t13.4 = inttoptr i64 %t13.3 to %struct.mycoder1*
  br label %t17

t17:                                     ; preds = %t5, %t16
  %t13.7 = phi %struct.mycoder1* [ %t13.1, %t5 ], [ %t13.4, %t16 ]
  %t13.5 = ptrtoint %struct.mycoder1* %t13.7 to i64
  %t13.6 = inttoptr i64 %t13.5 to %struct.mycoder1*
  br label %t11

t11:                                     ; preds = %1, %t17
  %t12 = phi %struct.mycoder1* [ %t13.0, %1], [ %t13.6, %t17 ]

...
; Check that we see "Bad pointer manipulation | Unsafe pointer store"
; due to x264_malloc but that we don't see 'Address Taken'; due to x264_free
...
; CHECK:  Safety data: Bad pointer manipulation | Unsafe pointer store

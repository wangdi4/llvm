; REQUIRES: asserts
; RUN: opt < %s -whole-program-assume -dtransanalysis -dtrans-merge-padded-structs=true -dtrans-test-padded-structs=true -dtrans-print-types -disable-output 2>&1 | FileCheck %s

...
; This test checks that "bad pointer manipulation for related types" is not set
; for the types since the division is not exact.

; CHECK-NOT: Safety data: {{.*}}Bad pointer manipulation (related types){{.*}}

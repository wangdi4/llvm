...
; This test checks that "bad pointer manipulation for related types" is not set for
; the types because the division is not guarded with the icmpr that checks the limits.

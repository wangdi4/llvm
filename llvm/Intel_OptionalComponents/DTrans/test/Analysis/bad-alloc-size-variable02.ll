...
; This test checks that "bad alloc size" is set for the types since
; the division is not exact. This is the same test as
; bad-ptr-manupulation-related-types02.ll but it checks for "bad alloc size".

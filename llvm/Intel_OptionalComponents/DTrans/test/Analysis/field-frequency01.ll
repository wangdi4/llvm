...
; RUN: opt < %s -dtransanalysis -dtrans-print-types -dtrans-ignore-bfi=true -disable-output 2>&1 | FileCheck %s
; RUN: opt < %s -passes='require<dtransanalysis>' -dtrans-print-types -dtrans-ignore-bfi=true -disable-output 2>&1 | FileCheck %s

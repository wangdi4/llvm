...
#error DTransOptBase.h include in an non-INTEL_FEATURE_SW_DTRANS build.
#endif
...
protected:
  ...
  // Return true if the input function is a llvm.intel.subscript intrinsic,
  // else return false.
  bool isFunctionASubscriptIntrinsic(Function *F);

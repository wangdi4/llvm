...
class VPOParoptLowerSimdDevicePass : public FunctionPass {
public:
  static char ID; // Pass identification, replacement for typeid
  VPOParoptLowerSimdDevicePass() : FunctionPass(ID) {
    initializeVPOParoptLowerSimdDevicePassPass(*PassRegistry::getPassRegistry());
  }
...
char VPOParoptLowerSimdDevicePass::ID = 0;
INITIALIZE_PASS(VPOParoptLowerSimdDevicePass, "VPOParoptLowerSimd",
...
FunctionPass *llvm::createVPOParoptLowerSimdPass() {
  return new VPOParoptLowerSimdDevicePass();
}

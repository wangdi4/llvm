...
void MockHIR::createMockHIRSimpleLoop() {
    ...
    CanonExpr *LBCE = CanonExprUtils::createCanonExpr(Int64Type, true, 1, 1, 1);
    ...
    CanonExpr *StrideCE = CanonExprUtils::createCanonExpr(Int64Type, true, 1, 1, 1);
    ...
    if (SrcGEP && DstGEP &&
        ...
        DEBUG(errs() << "The store scev is " << *SrcPtrSCEV << 
        " with type " <<  *(SrcGEP->getPointerOperandType()) << " \n"); 
    }
    ...
    BlobDDRef *StoreBlobRef = DDRefUtils::createBlobDDRef(1, StoreBlobCE, 
            StoreRef);
...
for.end:                                          ; preds = %for.body
  %1 = load i32* getelementptr inbounds ([10 x i32]* @A, i64 0, i64 2), align 8, !tbaa !1
  ret i32 %1
}
*/

...
//===----------------------------------------------------------------------===//
//
// This is the "legacy" loop unswitcher which has been replaced by the
// SimpleLoopUnswitcher in llorg. We preserve it as it currently has the
// best performance with the old PM. It does not support the new PM.
// We can remove this, when we switch completely over to the new PM and fix
// the performance regressions with SimpleLoopUnswitcher (polyhedron)
//
//===----------------------------------------------------------------------===//

...
/// cleanup can be done with some loop-simplifycfg like pass.
///
...
/// branch. Still more cleanup can be done with some loop-simplifycfg like pass.
///
/// If `SE` is not null, it will be updated based on the potential loop SCEVs
/// invalidated by this.
...
static bool unswitchAllTrivialConditions(Loop &L, DominatorTree &DT,
  ...
  do {
    ...
    // with a constant value. These should be removed by loop-simplifycfg prior
    // to running this pass.

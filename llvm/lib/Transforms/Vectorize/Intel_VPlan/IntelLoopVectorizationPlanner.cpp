...
static cl::opt<bool>
    NewCFGMergeListOnly("vplan-new-cfg-merge-list-only", cl::init(false), cl::Hidden,
                   cl::desc("Enable new CFG merger vplans list creation only."));

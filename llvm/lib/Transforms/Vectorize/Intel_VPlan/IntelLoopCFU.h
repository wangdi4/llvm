...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_TRANSFORMS_VECTORIZE_INTEL_VPLAN_INTELLOOPCFU_H 
#define LLVM_TRANSFORMS_VECTORIZE_INTEL_VPLAN_INTELLOOPCFU_H 
...
#endif // LLVM_TRANSFORMS_VECTORIZE_INTEL_VPLAN_INTELLOOPCFU_H 

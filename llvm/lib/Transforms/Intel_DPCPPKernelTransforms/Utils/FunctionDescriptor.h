//===- FunctionDescriptor.h - Function descriptor utilities ---------------===//
//
...
#ifndef INTEL_DPCPP_KERNEL_TRANSFORMS_FUNCTION_DESCRIPTOR_H
#define INTEL_DPCPP_KERNEL_TRANSFORMS_FUNCTION_DESCRIPTOR_H

...
OptReportDiag OptReportDiag::Diags[] = {
    ...
    {25419, "Number of spatial prefetches=%d, dist=%d"},
    {25420, "Number of spatial prefetches=%d"},
    {25421, "Number of indirect prefetches=%d"},
    ...
    {25534, ""},
    {25535, ""},
    {25536, "Loop has been unrolled by %d factor"},
    {25537, ""},
    {25538, ""},
    {25539, ""},
    ...
    {25457, ""},
    {25458, ""},
    {25559, "MKL call generated"},
    {25560, "Memset(with guard) generated"},
    {25561, "The memcpy idiom has been recognized"},
    ...
    {25568, "Distribute point pragma not processed"},
    {25569, "No Distribution as requested by pragma"},
    {25570, "Distribute point pragma processed"},
    {25571,
     "Distribute point pragma not processed: Unsupported constructs in loops"},
    {25572, "Distribute point pragma not processed: Loop is too complex"},
    {25573,
     "Distribute point pragma not processed: Too many Distribute points"},
    {25574, "Loop distributed (%d way)"},
    {25575, "Peeled loop after fusion"},
    {25576, "Loop lost in Fusion"},
    {25577, "Loops have been fused %s"},
    {25578, "Loopnest Interchanged: %s"},
...
const char *OptReportDiag::getMsg(unsigned Id) {
  OptReportDiag *Diag;
  unsigned LoopOffset = VecEnd - VecBegin + 1;

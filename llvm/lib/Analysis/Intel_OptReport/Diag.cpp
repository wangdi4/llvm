...
const DenseMap<unsigned, const char *> OptReportDiag::Diags = {
    ...
    {25258, "Loop peeled using condition at line %d"},
    {25259, "Loop optimized away using condition at line %d"},
    ...
    {25580, "Induction variable range split using condition at line %d"},

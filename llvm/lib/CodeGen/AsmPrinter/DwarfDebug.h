...
class DwarfDebug : public DebugHandlerBase {
  ...
  // Previous basic block containing an instruction whose source correlation
  // was emitted. This is not the same as PrevInstBB, which is not aligned
  // with the PrevInstLoc.
  const MachineBasicBlock *PrevBlockLoc;

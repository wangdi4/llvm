...
#define MAP(LLVMID, STIID) case LLVMID: stiID = STIID; break
 ...
 // MAP(0x22, STI_REGISTER_HAX);
 // MAP(0x23, STI_REGISTER_HBP);
 // MAP(0x24, STI_REGISTER_HBX);
 // MAP(0x25, STI_REGISTER_HCX);
 // MAP(0x26, STI_REGISTER_HDI);
 // MAP(0x27, STI_REGISTER_HDX);
 // MAP(0x28, STI_REGISTER_HIP);
 // MAP(0x29, STI_REGISTER_HSI);
 // MAP(0x2a, STI_REGISTER_HSP);
 // MAP(0x2b, STI_REGISTER_IP);
    MAP(0x2c, STI_REGISTER_RAX);
    MAP(0x2d, STI_REGISTER_RBP);
    MAP(0x2e, STI_REGISTER_RBX);
    MAP(0x2f, STI_REGISTER_RCX);
    MAP(0x30, STI_REGISTER_RDI);
    MAP(0x31, STI_REGISTER_RDX);
 // MAP(0x32, STI_REGISTER_RIP);
 // MAP(0x33, STI_REGISTER_RIZ);
    MAP(0x34, STI_REGISTER_RSI);
    MAP(0x35, STI_REGISTER_RSP);
    MAP(0x36, STI_REGISTER_SI);
    MAP(0x37, STI_REGISTER_SIL);
    MAP(0x38, STI_REGISTER_SP);
    MAP(0x39, STI_REGISTER_SPL);
    MAP(0x3a, STI_REGISTER_SS);
//  MAP(0x3b, STI_REGISTER_SSP);
//  MAP(0x3c, STI_REGISTER_BND0);
//  MAP(0x3d, STI_REGISTER_BND1);
//  MAP(0x3e, STI_REGISTER_BND2);
//  MAP(0x3f, STI_REGISTER_BND3);
    MAP(0x40, STI_REGISTER_CR0);
    MAP(0x41, STI_REGISTER_CR1);
    MAP(0x42, STI_REGISTER_CR2);
    MAP(0x43, STI_REGISTER_CR3);
    MAP(0x44, STI_REGISTER_CR4);
 // MAP(0x45, STI_REGISTER_CR5);
 // MAP(0x46, STI_REGISTER_CR6);
 // MAP(0x47, STI_REGISTER_CR7);
    MAP(0x48, STI_REGISTER_CR8);
 // MAP(0x49, STI_REGISTER_CR9);
 // MAP(0x4a, STI_REGISTER_CR10);
 // MAP(0x4b, STI_REGISTER_CR11);
 // MAP(0x4c, STI_REGISTER_CR12);
 // MAP(0x4d, STI_REGISTER_CR13);
 // MAP(0x4e, STI_REGISTER_CR14);
 // MAP(0x4f, STI_REGISTER_CR15);
    MAP(0x50, STI_REGISTER_DR0);
    MAP(0x51, STI_REGISTER_DR1);
    MAP(0x52, STI_REGISTER_DR2);
    MAP(0x53, STI_REGISTER_DR3);
    MAP(0x54, STI_REGISTER_DR4);
    MAP(0x55, STI_REGISTER_DR5);
    MAP(0x56, STI_REGISTER_DR6);
    MAP(0x57, STI_REGISTER_DR7);
    MAP(0x58, STI_REGISTER_DR8);
    MAP(0x59, STI_REGISTER_DR9);
    MAP(0x5a, STI_REGISTER_DR10);
    MAP(0x5b, STI_REGISTER_DR11);
    MAP(0x5c, STI_REGISTER_DR12);
    MAP(0x5d, STI_REGISTER_DR13);
    MAP(0x5e, STI_REGISTER_DR14);
    MAP(0x5f, STI_REGISTER_DR15);
 // MAP(0x60, STI_REGISTER_FP0);
 // MAP(0x61, STI_REGISTER_FP1);
 // MAP(0x62, STI_REGISTER_FP2);
 // MAP(0x63, STI_REGISTER_FP3);
 // MAP(0x64, STI_REGISTER_FP4);
 // MAP(0x65, STI_REGISTER_FP5);
 // MAP(0x66, STI_REGISTER_FP6);
 // MAP(0x67, STI_REGISTER_FP7);
 // MAP(0x68, STI_REGISTER_K0);
 // MAP(0x69, STI_REGISTER_K1);
 // MAP(0x6a, STI_REGISTER_K2);
 // MAP(0x6b, STI_REGISTER_K3);
 // MAP(0x6c, STI_REGISTER_K4);
 // MAP(0x6d, STI_REGISTER_K5);
 // MAP(0x6e, STI_REGISTER_K6);
 // MAP(0x6f, STI_REGISTER_K7);
    MAP(0x70, STI_REGISTER_MM0);
    MAP(0x71, STI_REGISTER_MM1);
    MAP(0x72, STI_REGISTER_MM2);
    MAP(0x73, STI_REGISTER_MM3);
    MAP(0x74, STI_REGISTER_MM4);
    MAP(0x75, STI_REGISTER_MM5);
    MAP(0x76, STI_REGISTER_MM6);
    MAP(0x77, STI_REGISTER_MM7);
    MAP(0x78, STI_REGISTER_R8);
    MAP(0x79, STI_REGISTER_R9);
    MAP(0x7a, STI_REGISTER_R10);
    MAP(0x7b, STI_REGISTER_R11);
    MAP(0x7c, STI_REGISTER_R12);
    MAP(0x7d, STI_REGISTER_R13);
    MAP(0x7e, STI_REGISTER_R14);
    MAP(0x7f, STI_REGISTER_R15);
    MAP(0x80, STI_REGISTER_ST0);
    MAP(0x81, STI_REGISTER_ST1);
    MAP(0x82, STI_REGISTER_ST2);
    MAP(0x83, STI_REGISTER_ST3);
    MAP(0x84, STI_REGISTER_ST4);
    MAP(0x85, STI_REGISTER_ST5);
    MAP(0x86, STI_REGISTER_ST6);
    MAP(0x87, STI_REGISTER_ST7);
    MAP(0x88, STI_REGISTER_XMM0);
    MAP(0x89, STI_REGISTER_XMM1);
    MAP(0x8a, STI_REGISTER_XMM2);
    MAP(0x8b, STI_REGISTER_XMM3);
    MAP(0x8c, STI_REGISTER_XMM4);
    MAP(0x8d, STI_REGISTER_XMM5);
    MAP(0x8e, STI_REGISTER_XMM6);
    MAP(0x8f, STI_REGISTER_XMM7);
    MAP(0x90, STI_REGISTER_XMM8);
    MAP(0x91, STI_REGISTER_XMM9);
    MAP(0x92, STI_REGISTER_XMM10);
    MAP(0x93, STI_REGISTER_XMM11);
    MAP(0x94, STI_REGISTER_XMM12);
    MAP(0x95, STI_REGISTER_XMM13);
    MAP(0x96, STI_REGISTER_XMM14);
    MAP(0x97, STI_REGISTER_XMM15);
//  MAP(0x98, STI_REGISTER_XMM16);
//  MAP(0x99, STI_REGISTER_XMM17);
//  MAP(0x9a, STI_REGISTER_XMM18);
//  MAP(0x9b, STI_REGISTER_XMM19);
//  MAP(0x9c, STI_REGISTER_XMM20);
//  MAP(0x9d, STI_REGISTER_XMM21);
//  MAP(0x9e, STI_REGISTER_XMM22);
//  MAP(0x9f, STI_REGISTER_XMM23);
//  MAP(0xa0, STI_REGISTER_XMM24);
//  MAP(0xa1, STI_REGISTER_XMM25);
//  MAP(0xa2, STI_REGISTER_XMM26);
//  MAP(0xa3, STI_REGISTER_XMM27);
//  MAP(0xa4, STI_REGISTER_XMM28);
//  MAP(0xa5, STI_REGISTER_XMM29);
//  MAP(0xa6, STI_REGISTER_XMM30);
//  MAP(0xa7, STI_REGISTER_XMM31);
//  MAP(0xa8, STI_REGISTER_YMM0);
//  MAP(0xa9, STI_REGISTER_YMM1);
//  MAP(0xaa, STI_REGISTER_YMM2);
//  MAP(0xab, STI_REGISTER_YMM3);
//  MAP(0xac, STI_REGISTER_YMM4);
//  MAP(0xad, STI_REGISTER_YMM5);
//  MAP(0xae, STI_REGISTER_YMM6);
//  MAP(0xaf, STI_REGISTER_YMM7);
//  MAP(0xb0, STI_REGISTER_YMM8);
//  MAP(0xb1, STI_REGISTER_YMM9);
//  MAP(0xb2, STI_REGISTER_YMM10);
//  MAP(0xb3, STI_REGISTER_YMM11);
//  MAP(0xb4, STI_REGISTER_YMM12);
//  MAP(0xb5, STI_REGISTER_YMM13);
//  MAP(0xb6, STI_REGISTER_YMM14);
//  MAP(0xb7, STI_REGISTER_YMM15);
//  MAP(0xb8, STI_REGISTER_YMM16);
//  MAP(0xb9, STI_REGISTER_YMM17);
//  MAP(0xba, STI_REGISTER_YMM18);
//  MAP(0xbb, STI_REGISTER_YMM19);
//  MAP(0xbc, STI_REGISTER_YMM20);
//  MAP(0xbd, STI_REGISTER_YMM21);
//  MAP(0xbe, STI_REGISTER_YMM22);
//  MAP(0xbf, STI_REGISTER_YMM23);
//  MAP(0xc0, STI_REGISTER_YMM24);
//  MAP(0xc1, STI_REGISTER_YMM25);
//  MAP(0xc2, STI_REGISTER_YMM26);
//  MAP(0xc3, STI_REGISTER_YMM27);
//  MAP(0xc4, STI_REGISTER_YMM28);
//  MAP(0xc5, STI_REGISTER_YMM29);
//  MAP(0xc6, STI_REGISTER_YMM30);
//  MAP(0xc7, STI_REGISTER_YMM31);
//  MAP(0xc8, STI_REGISTER_ZMM0);
//  MAP(0xc9, STI_REGISTER_ZMM1);
//  MAP(0xca, STI_REGISTER_ZMM2);
//  MAP(0xcb, STI_REGISTER_ZMM3);
//  MAP(0xcc, STI_REGISTER_ZMM4);
//  MAP(0xcd, STI_REGISTER_ZMM5);
//  MAP(0xce, STI_REGISTER_ZMM6);
//  MAP(0xcf, STI_REGISTER_ZMM7);
//  MAP(0xd0, STI_REGISTER_ZMM8);
//  MAP(0xd1, STI_REGISTER_ZMM9);
//  MAP(0xd2, STI_REGISTER_ZMM10);
//  MAP(0xd3, STI_REGISTER_ZMM11);
//  MAP(0xd4, STI_REGISTER_ZMM12);
//  MAP(0xd5, STI_REGISTER_ZMM13);
//  MAP(0xd6, STI_REGISTER_ZMM14);
//  MAP(0xd7, STI_REGISTER_ZMM15);
//  MAP(0xd8, STI_REGISTER_ZMM16);
//  MAP(0xd9, STI_REGISTER_ZMM17);
//  MAP(0xda, STI_REGISTER_ZMM18);
//  MAP(0xdb, STI_REGISTER_ZMM19);
//  MAP(0xdc, STI_REGISTER_ZMM20);
//  MAP(0xdd, STI_REGISTER_ZMM21);
//  MAP(0xde, STI_REGISTER_ZMM22);
//  MAP(0xdf, STI_REGISTER_ZMM23);
//  MAP(0xe0, STI_REGISTER_ZMM24);
//  MAP(0xe1, STI_REGISTER_ZMM25);
//  MAP(0xe2, STI_REGISTER_ZMM26);
//  MAP(0xe3, STI_REGISTER_ZMM27);
//  MAP(0xe4, STI_REGISTER_ZMM28);
//  MAP(0xe5, STI_REGISTER_ZMM29);
//  MAP(0xe6, STI_REGISTER_ZMM30);
//  MAP(0xe7, STI_REGISTER_ZMM31);
    MAP(0xe8, STI_REGISTER_R8B);
    MAP(0xe9, STI_REGISTER_R9B);
    MAP(0xea, STI_REGISTER_R10B);
    MAP(0xeb, STI_REGISTER_R11B);
    MAP(0xec, STI_REGISTER_R12B);
    MAP(0xed, STI_REGISTER_R13B);
    MAP(0xee, STI_REGISTER_R14B);
    MAP(0xef, STI_REGISTER_R15B);
    MAP(0xf0, STI_REGISTER_R8D);
    MAP(0xf1, STI_REGISTER_R9D);
    MAP(0xf2, STI_REGISTER_R10D);
    MAP(0xf3, STI_REGISTER_R11D);
    MAP(0xf4, STI_REGISTER_R12D);
    MAP(0xf5, STI_REGISTER_R13D);
    MAP(0xf6, STI_REGISTER_R14D);
    MAP(0xf7, STI_REGISTER_R15D);
    MAP(0xf8, STI_REGISTER_R8W);
    MAP(0xf9, STI_REGISTER_R9W);
    MAP(0xfa, STI_REGISTER_R10W);
    MAP(0xfb, STI_REGISTER_R11W);
    MAP(0xfc, STI_REGISTER_R12W);
    MAP(0xfd, STI_REGISTER_R13W);
    MAP(0xfe, STI_REGISTER_R14W);
    MAP(0xff, STI_REGISTER_R15W);

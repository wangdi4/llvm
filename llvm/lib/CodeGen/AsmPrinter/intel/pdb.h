...
//   Used under license
//
// Modifications for use in Intel Compiler
// Copyright(C)  Intel 2009-2015 Corporation. All rights reserved.
//
//
// List of changes made incorporating this file into the Intel compiler:
//
//    1. Comment out include of vcver.h
//    2. Commment out unnnecessary typedefs 
//           (e.g. typedef PdbInterface PDB PDB;)
//    3. Rename struct Mod to struct PDBMod to avoid name clash
//
...
PdbInterface PDBMod;                // a module within the DBI
...
PdbInterface DBI {             // debug information
    ...
    virtual IMPV QueryImplementationVersion() pure;
    virtual INTV QueryInterfaceVersion() pure;
    virtual BOOL OpenMod(_In_z_ const char* szModule, _In_z_ const char* szFile, OUT PDBMod** ppmod) pure;
    virtual BOOL DeleteMod(_In_z_ const char* szModule) pure;
    virtual BOOL QueryNextMod(PDBMod* pmod, PDBMod** ppmodNext) pure;
    ...
    virtual BOOL QueryModFromAddr(USHORT isect, long off, OUT PDBMod** ppmod,
    ...
    virtual BOOL OpenModW(_In_z_ const wchar_t* szModule, _In_z_ const wchar_t* szFile, OUT PDBMod** ppmod) pure;
    ...
    virtual BOOL QueryModFromAddr2(USHORT isect, long off, OUT PDBMod** ppmod,
    ...
    virtual BOOL QueryMods(PDBMod **ppmodNext, long cMods) pure;
    virtual BOOL QueryImodFromAddr(USHORT isect, long off, OUT USHORT* pimod,
                    OUT USHORT* pisect, OUT long* poff, OUT long* pcb, 
                    OUT ULONG * pdwCharacteristics) pure;
    virtual BOOL OpenModFromImod( USHORT imod, OUT PDBMod **ppmod ) pure;
...
PdbInterface PDBMod {             // info for one module within DBI
    enum { intv = PDBIntv };
    virtual INTV QueryInterfaceVersion() pure;
    virtual IMPV QueryImplementationVersion() pure;
...
typedef PdbInterface PDB PDB;
typedef PdbInterface DBI DBI;
typedef PdbInterface PDBMod PDBMod;
typedef PdbInterface TPI TPI;
typedef PdbInterface GSI GSI;
typedef PdbInterface SO SO;
typedef PdbInterface Stream Stream;
...
PDBAPI(BOOL)   DBIOpenMod(DBI* pdbi, _In_z_ const char* szModule, _In_z_ const char* szFile, OUT PDBMod** ppmod);
PDBAPI(BOOL)   DBIOpenModW(DBI* pdbi, _In_z_ const wchar_t* szModule, _In_z_ const wchar_t* szFile, OUT PDBMod** ppmod);
PDBAPI(BOOL)   DBIDeleteMod(DBI* pdbi, _In_z_ const char* szModule);
PDBAPI(BOOL)   DBIQueryNextMod(DBI* pdbi, PDBMod* pmod, PDBMod** ppmodNext);
...
#endif
PDBAPI(BOOL)   DBIQueryModFromAddr(DBI* pdbi, USHORT isect, long off, OUT PDBMod** ppmod, OUT USHORT* pisect, OUT long* poff, OUT long* pcb);
PDBAPI(BOOL)   DBIQueryModFromAddr2(DBI* pdbi, USHORT isect, long off, OUT PDBMod** ppmod, OUT USHORT* pisect, OUT long* poff, OUT long* pcb, OUT ULONG *pdwCharacteristics);
...
PDBAPI(INTV)   ModQueryInterfaceVersion(PDBMod* pmod);
PDBAPI(IMPV)   ModQueryImplementationVersion(PDBMod* pmod);
PDBAPI(BOOL)   ModAddTypes(PDBMod* pmod, BYTE* pbTypes, long cb);
PDBAPI(BOOL)   ModAddSymbols(PDBMod* pmod, BYTE* pbSym, long cb);
PDBAPI(BOOL)   ModAddPublic(PDBMod* pmod, _In_z_ const char* szPublic, USHORT isect, long off);
#if __cplusplus
PDBAPI(BOOL)   ModAddPublic2(PDBMod* pmod, _In_z_ const char* szPublic, USHORT isect, long off, CV_pubsymflag_t cvpsf=0);
#else
PDBAPI(BOOL)   ModAddPublic2(PDBMod* pmod, _In_z_ const char* szPublic, USHORT isect, long off, CV_pubsymflag_t cvpsf);
#endif
PDBAPI(BOOL)   ModAddLines(PDBMod* pmod, _In_z_ const char* szSrc, USHORT isect, long offCon, long cbCon, long doff,
                           USHORT lineStart, BYTE* pbCoff, long cbCoff);
PDBAPI(BOOL)   ModAddLinesW(PDBMod* pmod, _In_z_ const wchar_t* szSrc, USHORT isect, long offCon, long cbCon, long doff,
                            ULONG lineStart, BYTE* pbCoff, long cbCoff);
PDBAPI(BOOL)   ModAddSecContrib(PDBMod * pmod, USHORT isect, long off, long cb, ULONG dwCharacteristics);
PDBAPI(BOOL)   ModAddSecContribEx(PDBMod * pmod, USHORT isect, long off, long cb, ULONG dwCharacteristics, DWORD dwDataCrc, DWORD dwRelocCrc);
PDBAPI(BOOL)   ModQueryCBName(PDBMod* pmod, OUT long* pcb);
PDBAPI(BOOL)   ModQueryName(PDBMod* pmod, _Out_z_cap_(PDB_MAX_PATH) OUT char szName[PDB_MAX_PATH], OUT long* pcb);
PDBAPI(BOOL)   ModQuerySymbols(PDBMod* pmod, BYTE* pbSym, long* pcb);
PDBAPI(BOOL)   ModQueryLines(PDBMod* pmod, BYTE* pbLines, long* pcb);
PDBAPI(BOOL)   ModQueryLines2(PDBMod* pmod, long cb, BYTE* pbLines, long* pcb);
PDBAPI(BOOL)   ModSetPvClient(PDBMod* pmod, void *pvClient);
PDBAPI(BOOL)   ModGetPvClient(PDBMod* pmod, OUT void** ppvClient);
PDBAPI(BOOL)   ModQuerySecContrib(PDBMod* pmod, OUT USHORT* pisect, OUT long* poff, OUT long* pcb, OUT ULONG* pdwCharacteristics);
PDBAPI(BOOL)   ModQueryFirstCodeSecContrib(PDBMod* pmod, OUT USHORT* pisect, OUT long* poff, OUT long* pcb, OUT ULONG* pdwCharacteristics);
PDBAPI(BOOL)   ModQueryImod(PDBMod* pmod, OUT USHORT* pimod);
PDBAPI(BOOL)   ModQueryDBI(PDBMod* pmod, OUT DBI** ppdbi);
PDBAPI(BOOL)   ModClose(PDBMod* pmod);
PDBAPI(BOOL)   ModQueryCBFile(PDBMod* pmod, OUT long* pcb);
PDBAPI(BOOL)   ModQueryFile(PDBMod* pmod, _Out_z_cap_(PDB_MAX_PATH) OUT char szFile[PDB_MAX_PATH], OUT long* pcb);
PDBAPI(BOOL)   ModQuerySrcFile(PDBMod* pmod, _Out_z_cap_(PDB_MAX_PATH) OUT char szFile[PDB_MAX_PATH], OUT long* pcb);
PDBAPI(BOOL)   ModQueryPdbFile(PDBMod* pmod, _Out_z_cap_(PDB_MAX_PATH) OUT char szFile[PDB_MAX_PATH], OUT long* pcb);
PDBAPI(BOOL)   ModQuerySupportsEC(PDBMod* pmod);
PDBAPI(BOOL)   ModQueryTpi(PDBMod* pmod, OUT TPI** pptpi);
PDBAPI(BOOL)   ModReplaceLines(PDBMod* pmod, BYTE* pbLines, long cb);
PDBAPI(BOOL)   ModQueryCrossScopeExports(PDBMod* pmod, DWORD cb, BYTE* pb, DWORD* pcb);
PDBAPI(BOOL)   ModQueryCrossScopeImports(PDBMod* pmod, DWORD cb, BYTE* pb, DWORD* pcb);    
PDBAPI(BOOL)   ModQueryInlineeLines(PDBMod* pmod, DWORD cb, BYTE* pb, DWORD* pcb);
PDBAPI(BOOL)   ModTranslateFileId(PDBMod* pmod, DWORD id, DWORD* pid);
PDBAPI(BOOL)   ModQueryFuncMDTokenMap(PDBMod* pmod, DWORD cb, BYTE* pb, DWORD* pcb);
PDBAPI(BOOL)   ModQueryTypeMDTokenMap(PDBMod* pmod, DWORD cb, BYTE* pb, DWORD* pcb);
PDBAPI(BOOL)   ModQueryMergedAssemblyInput(PDBMod* pmod, DWORD cb, BYTE* pb, DWORD* pcb);
PDBAPI(BOOL)   ModQueryILLines(PDBMod* pmod, DWORD cb, BYTE* pb, DWORD* pcb);
PDBAPI(BOOL)   ModGetEnumILLines(PDBMod* pmod, EnumLines** ppenum);
PDBAPI(BOOL)   ModQueryILLineFlags(PDBMod* pmod, OUT DWORD* pdwFlags);

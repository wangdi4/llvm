...
public:
  ...
  static const Nios2MCExpr *create(const MCSymbol *Symbol, 
                                  Nios2MCExpr::Nios2ExprKind Kind, MCContext &Ctx);
  static const Nios2MCExpr *createGpOff(Nios2ExprKind Kind, const MCExpr *Expr,
                                       MCContext &Ctx);
  ...
  bool isGpOff(Nios2ExprKind &Kind) const;
  bool isGpOff() const {
    Nios2ExprKind Kind;
    return isGpOff(Kind);
  }

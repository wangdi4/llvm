...
#if INTEL_CUSTOMIZATION
#if INTEL_FEATURE_ISA_AVX512_DOTPROD
  X86_INTRINSIC_DATA(avx512_mask_vdpphps_128, INTR_TYPE_3OP_MASK,
                     X86ISD::VDPPHPS, 0),
  X86_INTRINSIC_DATA(avx512_mask_vdpphps_256, INTR_TYPE_3OP_MASK,
                     X86ISD::VDPPHPS, 0),
  X86_INTRINSIC_DATA(avx512_mask_vdpphps_512, INTR_TYPE_3OP_MASK,
...
#if INTEL_CUSTOMIZATION
#if INTEL_FEATURE_ISA_AVX512_DOTPROD
  X86_INTRINSIC_DATA(avx512_vpdpbssd_128,  INTR_TYPE_3OP, X86ISD::VPDPBSSD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbssd_256,  INTR_TYPE_3OP, X86ISD::VPDPBSSD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbssd_512,  INTR_TYPE_3OP, X86ISD::VPDPBSSD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbssds_128, INTR_TYPE_3OP, X86ISD::VPDPBSSDS, 0),
  X86_INTRINSIC_DATA(avx512_vpdpbssds_256, INTR_TYPE_3OP, X86ISD::VPDPBSSDS, 0),
  X86_INTRINSIC_DATA(avx512_vpdpbssds_512, INTR_TYPE_3OP, X86ISD::VPDPBSSDS, 0),
  X86_INTRINSIC_DATA(avx512_vpdpbsud_128,  INTR_TYPE_3OP, X86ISD::VPDPBSUD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbsud_256,  INTR_TYPE_3OP, X86ISD::VPDPBSUD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbsud_512,  INTR_TYPE_3OP, X86ISD::VPDPBSUD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbsuds_128, INTR_TYPE_3OP, X86ISD::VPDPBSUDS, 0),
  X86_INTRINSIC_DATA(avx512_vpdpbsuds_256, INTR_TYPE_3OP, X86ISD::VPDPBSUDS, 0),
...
#if INTEL_CUSTOMIZATION
#if INTEL_FEATURE_ISA_AVX512_DOTPROD
  X86_INTRINSIC_DATA(avx512_vpdpbuud_128,  INTR_TYPE_3OP, X86ISD::VPDPBSUD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbuud_256,  INTR_TYPE_3OP, X86ISD::VPDPBSUD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbuud_512,  INTR_TYPE_3OP, X86ISD::VPDPBSUD,  0),
  X86_INTRINSIC_DATA(avx512_vpdpbuuds_128, INTR_TYPE_3OP, X86ISD::VPDPBUUDS, 0),
  X86_INTRINSIC_DATA(avx512_vpdpbuuds_256, INTR_TYPE_3OP, X86ISD::VPDPBUUDS, 0),

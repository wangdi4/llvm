...
<<<<<<< HEAD
// INTEL_CUSTOMIZATION
// RUN: %clang_pgogen=%t.nopromo.prof/ -mllvm -do-counter-promotion=false -mllvm -simplifycfg-sink-common=false -o %t.nopromo.gen.ll -emit-llvm -S -O2 -mllvm -enable-andersen=false -Xclang -no-opaque-pointers %s
...
>>>>>>> fe0bd3e24e9c8ed886170e242a429a49407e1a75
